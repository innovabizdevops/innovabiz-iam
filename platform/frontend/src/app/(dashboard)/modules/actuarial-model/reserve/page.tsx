...
const ACCENT = "#6366f1";
const MODULE = "Actuarial Modeling";
const PAGE = "Reserving";
const KPIS = [{"l":"Total Actuarial Model","v":"2.418","t":"-0.6%","d":"down"},{"l":"Reserving Ativos","v":"6.804","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"73.2%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"77","t":"-1.3%","d":"down"}];
const COLS = ["ID","Reserving","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Actuarial Model #001","Actuarial Model #002","3.344","6.747","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Actuarial Model #002","Actuarial Model #003","7.687","5.770","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Actuarial Model #003","Actuarial Model #004","331","1.614","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Actuarial Model #004","Actuarial Model #005","5.383","3.212","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Actuarial Model #005","Actuarial Model #001","3.969","8.754","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":827},{"label":"Mar","value":596},{"label":"Abr","value":676},{"label":"Mai","value":512},{"label":"Jun","value":547},{"label":"Jul","value":856},{"label":"Ago","value":636},{"label":"Set","value":597},{"label":"Out","value":649},{"label":"Nov","value":550},{"label":"Dez","value":824}];
const MX = 856;
