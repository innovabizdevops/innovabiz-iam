...
const PAGE = "Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€38.1M","t":"-2.5%","d":"down"},{"l":"MRR (€)","v":"€86515","t":"+6.9%","d":"up"},{"l":"Churn (%)","v":"79.4%","t":"-0.1%","d":"down"},{"l":"ARPU (€)","v":"€52708","t":"+13.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2759.81","4.473","€ 1657.90","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4839.88","5.989","€ 8495.32","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 21004.50","1.670","€ 41104.71","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7560.40","3.940","€ 12244.47","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 26379.79","4.714","€ 45969.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":993},{"label":"Fev","value":743},{"label":"Mar","value":788},{"label":"Abr","value":847},{"label":"Mai","value":656},{"label":"Jun","value":724},{"label":"Jul","value":1020},{"label":"Ago","value":824},{"label":"Set","value":802},{"label":"Out","value":664},{"label":"Nov","value":931},{"label":"Dez","value":779}];
const MX = 1020;
