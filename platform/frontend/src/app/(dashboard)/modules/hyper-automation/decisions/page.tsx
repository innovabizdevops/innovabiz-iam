...
const PAGE = "Decision Tables";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.472","t":"+6.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.4%","t":"+10.0%","d":"up"},{"l":"Tempo Médio (h)","v":"109h","t":"+6.7%","d":"up"},{"l":"Rejeitadas (%)","v":"65.7%","t":"+12.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.393","€ 46442.56","7.083","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.440","€ 15117.80","2.080","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","3.633","€ 46115.36","481","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.765","€ 32780.16","7.778","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","6.691","€ 23948.08","7.664","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":692},{"label":"Mar","value":556},{"label":"Abr","value":611},{"label":"Mai","value":596},{"label":"Jun","value":708},{"label":"Jul","value":879},{"label":"Ago","value":660},{"label":"Set","value":530},{"label":"Out","value":728},{"label":"Nov","value":907},{"label":"Dez","value":841}];
const MX = 907;
