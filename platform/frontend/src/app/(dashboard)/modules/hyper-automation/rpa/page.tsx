...
const PAGE = "RPA Studio";
const KPIS = [{"l":"Total Hyper Automation","v":"5.037","t":"+2.3%","d":"up"},{"l":"RPA Studio Ativos","v":"3.920","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"91","t":"+16.8%","d":"up"}];
const COLS = ["ID","RPA Studio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hyper Automation #001","Hyper Automation #002","4.962","8.155","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Hyper Automation #002","Hyper Automation #003","2.264","8.872","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Hyper Automation #003","Hyper Automation #004","7.849","8.272","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Hyper Automation #004","Hyper Automation #005","801","7.745","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hyper Automation #005","Hyper Automation #001","7.577","3.639","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1043},{"label":"Fev","value":821},{"label":"Mar","value":920},{"label":"Abr","value":689},{"label":"Mai","value":795},{"label":"Jun","value":1032},{"label":"Jul","value":818},{"label":"Ago","value":936},{"label":"Set","value":928},{"label":"Out","value":1066},{"label":"Nov","value":695},{"label":"Dez","value":734}];
const MX = 1066;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>RPA</span></h1>
                </div>
