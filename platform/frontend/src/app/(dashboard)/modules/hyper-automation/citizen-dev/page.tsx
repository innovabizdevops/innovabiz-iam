...
const PAGE = "Citizen Developer";
const KPIS = [{"l":"Total Hyper Automation","v":"3.109","t":"+13.1%","d":"up"},{"l":"Citizen Developer Ativos","v":"8.881","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"56","t":"-3.0%","d":"down"}];
const COLS = ["ID","Citizen Developer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hyper Automation #001","Hyper Automation #002","7.741","1.702","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Hyper Automation #002","Hyper Automation #003","5.695","1.929","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Hyper Automation #003","Hyper Automation #004","7.192","7.684","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Hyper Automation #004","Hyper Automation #005","6.844","8.500","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hyper Automation #005","Hyper Automation #001","6.311","3.696","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":470},{"label":"Mar","value":580},{"label":"Abr","value":492},{"label":"Mai","value":735},{"label":"Jun","value":513},{"label":"Jul","value":716},{"label":"Ago","value":552},{"label":"Set","value":604},{"label":"Out","value":572},{"label":"Nov","value":608},{"label":"Dez","value":576}];
const MX = 735;
...
export default function CitizenDevPage() {
    return (
