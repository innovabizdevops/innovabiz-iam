...
const PAGE = "Automation Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"648","t":"+15.5%","d":"up"},{"l":"Queries/Dia","v":"2425","t":"-3.2%","d":"down"},{"l":"Dados Processados (GB)","v":"1.072","t":"+2.8%","d":"up"},{"l":"Utilizadores Analytics","v":"2.654","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3848","2026-02-22","1.052","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1163","2026-02-13","708","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4758","2026-03-05","8.983","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1282","2026-02-22","156","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4413","2026-03-16","3.582","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":519},{"label":"Mar","value":597},{"label":"Abr","value":428},{"label":"Mai","value":536},{"label":"Jun","value":523},{"label":"Jul","value":435},{"label":"Ago","value":345},{"label":"Set","value":440},{"label":"Out","value":635},{"label":"Nov","value":432},{"label":"Dez","value":266}];
const MX = 635;
