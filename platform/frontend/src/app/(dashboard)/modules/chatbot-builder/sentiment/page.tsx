...
const ACCENT = "#059669";
const MODULE = "Chatbot & Virtual Agent";
const PAGE = "Sentiment Detection";
const KPIS = [{"l":"Dashboards Ativos","v":"4.013","t":"+9.7%","d":"up"},{"l":"Queries/Dia","v":"868","t":"+0.1%","d":"up"},{"l":"Dados Processados (GB)","v":"332","t":"+0.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.764","t":"-5.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3318","2026-03-11","8.260","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2336","2026-01-22","4.052","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2565","2026-02-09","424","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1904","2026-01-17","5.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3166","2026-01-21","4.050","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":830},{"label":"Mar","value":706},{"label":"Abr","value":561},{"label":"Mai","value":646},{"label":"Jun","value":689},{"label":"Jul","value":504},{"label":"Ago","value":543},{"label":"Set","value":630},{"label":"Out","value":782},{"label":"Nov","value":806},{"label":"Dez","value":621}];
const MX = 830;
