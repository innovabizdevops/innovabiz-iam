...
const PAGE = "Channel Deploy";
const KPIS = [{"l":"Teams Ativos","v":"7.165","t":"-5.5%","d":"down"},{"l":"Reuniões/Semana","v":"939","t":"+2.4%","d":"up"},{"l":"Mensagens/Dia","v":"4459","t":"-4.6%","d":"down"},{"l":"Ficheiros Partilhados","v":"6.311","t":"+11.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.874","4287","4.819","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.203","4890","2.016","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.834","393","5.664","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","585","4379","6.941","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","169","737","5.299","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":761},{"label":"Mar","value":665},{"label":"Abr","value":507},{"label":"Mai","value":848},{"label":"Jun","value":584},{"label":"Jul","value":616},{"label":"Ago","value":631},{"label":"Set","value":533},{"label":"Out","value":514},{"label":"Nov","value":543},{"label":"Dez","value":796}];
const MX = 848;
