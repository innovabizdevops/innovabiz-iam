...
const PAGE = "Live Handoff";
const KPIS = [{"l":"Teams Ativos","v":"754","t":"+3.9%","d":"up"},{"l":"Reuniões/Semana","v":"301","t":"+8.1%","d":"up"},{"l":"Mensagens/Dia","v":"3784","t":"+16.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.417","t":"+0.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.567","4213","2.469","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.990","4107","5.868","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.419","4197","3.022","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.470","4363","6.216","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.358","4187","2.857","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":499},{"label":"Mar","value":497},{"label":"Abr","value":679},{"label":"Mai","value":387},{"label":"Jun","value":665},{"label":"Jul","value":448},{"label":"Ago","value":507},{"label":"Set","value":396},{"label":"Out","value":721},{"label":"Nov","value":379},{"label":"Dez","value":604}];
const MX = 721;
