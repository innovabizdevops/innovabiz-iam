...
const PAGE = "Bot Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"420","t":"+10.5%","d":"up"},{"l":"Queries/Dia","v":"2960","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"4.624","t":"+4.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.411","t":"+15.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4489","2026-02-13","1.075","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2230","2026-02-20","7.157","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","940","2026-03-21","1.697","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2334","2026-02-01","1.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1899","2026-01-07","3.159","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":388},{"label":"Mar","value":552},{"label":"Abr","value":536},{"label":"Mai","value":648},{"label":"Jun","value":514},{"label":"Jul","value":390},{"label":"Ago","value":439},{"label":"Set","value":586},{"label":"Out","value":492},{"label":"Nov","value":672},{"label":"Dez","value":519}];
const MX = 672;
