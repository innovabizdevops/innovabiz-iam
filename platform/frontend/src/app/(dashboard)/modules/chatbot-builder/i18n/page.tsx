...
const PAGE = "Multi-Language Bot";
const KPIS = [{"l":"Teams Ativos","v":"7.236","t":"-0.9%","d":"down"},{"l":"Reuniões/Semana","v":"624","t":"+2.6%","d":"up"},{"l":"Mensagens/Dia","v":"1961","t":"+8.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.365","t":"-4.8%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.882","4262","6.570","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.972","401","4.982","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.278","2678","3.836","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.339","3086","5.017","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.572","203","8.737","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":578},{"label":"Mar","value":828},{"label":"Abr","value":592},{"label":"Mai","value":653},{"label":"Jun","value":906},{"label":"Jul","value":590},{"label":"Ago","value":789},{"label":"Set","value":823},{"label":"Out","value":532},{"label":"Nov","value":584},{"label":"Dez","value":683}];
const MX = 906;
