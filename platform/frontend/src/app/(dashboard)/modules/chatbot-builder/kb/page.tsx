...
const KPIS = [{"l":"Artigos Publicados","v":"6.606","t":"-4.1%","d":"down"},{"l":"Views/Semana","v":"3713","t":"+3.0%","d":"up"},{"l":"Feedback Útil (%)","v":"82.5%","t":"+17.6%","d":"up"},{"l":"Artigos Desatualizados","v":"698","t":"+17.5%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.171","89.5%","8.932","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","890","78.1%","3.274","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.847","73.6%","5.805","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.862","74.9%","5.675","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","7.496","74.1%","4.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":315},{"label":"Mar","value":559},{"label":"Abr","value":596},{"label":"Mai","value":408},{"label":"Jun","value":664},{"label":"Jul","value":576},{"label":"Ago","value":670},{"label":"Set","value":411},{"label":"Out","value":706},{"label":"Nov","value":652},{"label":"Dez","value":526}];
const MX = 706;
