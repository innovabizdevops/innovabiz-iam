...
const PAGE = "Intent Training";
const KPIS = [{"l":"Teams Ativos","v":"226","t":"-1.6%","d":"down"},{"l":"Reuniões/Semana","v":"1373","t":"+17.5%","d":"up"},{"l":"Mensagens/Dia","v":"1193","t":"+15.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.963","t":"+1.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.041","3446","6.632","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.566","1043","1.867","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.933","3558","8.002","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","970","1123","5.789","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.376","4058","1.407","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1029},{"label":"Fev","value":816},{"label":"Mar","value":756},{"label":"Abr","value":979},{"label":"Mai","value":674},{"label":"Jun","value":883},{"label":"Jul","value":737},{"label":"Ago","value":772},{"label":"Set","value":806},{"label":"Out","value":714},{"label":"Nov","value":875},{"label":"Dez","value":990}];
const MX = 1029;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>NLP</span></h1>
                </div>
