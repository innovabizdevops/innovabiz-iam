...
const PAGE = "Flow Designer";
const KPIS = [{"l":"Formulários Ativos","v":"7.470","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"2656","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"7.780","t":"+10.9%","d":"up"},{"l":"Templates","v":"5.856","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.530","2026-02-01","7.384","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.206","2026-03-17","4.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.335","2026-02-20","2.596","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","652","2026-01-25","4.412","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.858","2026-01-13","3.666","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":858},{"label":"Mar","value":709},{"label":"Abr","value":653},{"label":"Mai","value":888},{"label":"Jun","value":971},{"label":"Jul","value":902},{"label":"Ago","value":879},{"label":"Set","value":749},{"label":"Out","value":990},{"label":"Nov","value":612},{"label":"Dez","value":698}];
const MX = 990;
