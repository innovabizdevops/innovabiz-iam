...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Next-Best-Action";
const PAGE = "Rank";
const KPIS = [{"l":"Total Pai Next Best","v":"1.670","t":"-4.6%","d":"down"},{"l":"Rank Ativos","v":"6.856","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"76","t":"+5.9%","d":"up"}];
const COLS = ["ID","Rank","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Next Best #001","Pai Next Best #002","923","4.237","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Next Best #002","Pai Next Best #003","8.276","5.526","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Next Best #003","Pai Next Best #004","464","3.859","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Next Best #004","Pai Next Best #005","3.061","347","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Next Best #005","Pai Next Best #001","5.725","4.977","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":911},{"label":"Mar","value":1012},{"label":"Abr","value":734},{"label":"Mai","value":885},{"label":"Jun","value":862},{"label":"Jul","value":743},{"label":"Ago","value":972},{"label":"Set","value":803},{"label":"Out","value":654},{"label":"Nov","value":739},{"label":"Dez","value":773}];
const MX = 1012;
