...
const PAGE = "Learn";
const KPIS = [{"l":"Total Pai Next Best","v":"3.895","t":"+5.1%","d":"up"},{"l":"Learn Ativos","v":"3.809","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"58","t":"+8.3%","d":"up"}];
const COLS = ["ID","Learn","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Next Best #001","Pai Next Best #002","8.725","5.799","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Next Best #002","Pai Next Best #003","8.244","3.346","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Next Best #003","Pai Next Best #004","6.155","5.824","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Next Best #004","Pai Next Best #005","7.199","3.326","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Next Best #005","Pai Next Best #001","6.473","2.745","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":359},{"label":"Mar","value":366},{"label":"Abr","value":306},{"label":"Mai","value":594},{"label":"Jun","value":462},{"label":"Jul","value":385},{"label":"Ago","value":322},{"label":"Set","value":304},{"label":"Out","value":509},{"label":"Nov","value":264},{"label":"Dez","value":611}];
const MX = 611;
