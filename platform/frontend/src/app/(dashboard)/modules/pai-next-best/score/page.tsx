...
const PAGE = "Score";
const KPIS = [{"l":"Total Pai Next Best","v":"5.751","t":"+12.8%","d":"up"},{"l":"Score Ativos","v":"89","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"77","t":"+12.2%","d":"up"}];
const COLS = ["ID","Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Next Best #001","89.4%","425","3.089","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Next Best #002","85.8%","7.059","7.752","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Next Best #003","96.5%","2.756","3.380","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Next Best #004","71.4%","1.998","6.584","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Next Best #005","97.3%","6.665","5.405","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":435},{"label":"Mar","value":439},{"label":"Abr","value":496},{"label":"Mai","value":316},{"label":"Jun","value":333},{"label":"Jul","value":504},{"label":"Ago","value":336},{"label":"Set","value":510},{"label":"Out","value":478},{"label":"Nov","value":404},{"label":"Dez","value":473}];
const MX = 578;
