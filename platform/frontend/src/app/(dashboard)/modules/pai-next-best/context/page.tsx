...
const PAGE = "Context";
const KPIS = [{"l":"Total Pai Next Best","v":"8.995","t":"+17.2%","d":"up"},{"l":"Context Ativos","v":"458","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"70","t":"+6.9%","d":"up"}];
const COLS = ["ID","Context","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Next Best #001","Pai Next Best #002","3.609","1.416","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Next Best #002","Pai Next Best #003","8.729","2.876","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Next Best #003","Pai Next Best #004","5.880","4.750","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Next Best #004","Pai Next Best #005","8.897","8.458","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Next Best #005","Pai Next Best #001","7.498","7.336","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":595},{"label":"Mar","value":376},{"label":"Abr","value":491},{"label":"Mai","value":731},{"label":"Jun","value":580},{"label":"Jul","value":684},{"label":"Ago","value":444},{"label":"Set","value":495},{"label":"Out","value":550},{"label":"Nov","value":471},{"label":"Dez","value":533}];
const MX = 731;
