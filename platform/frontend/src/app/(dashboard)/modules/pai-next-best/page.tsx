...
/* ═══ P-AI Next-Best-Action — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "3064", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2374", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€314K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1249274064", cells: ["PAI-3064", "P-AI Next-Best-Action Item 1", "25/1/2026", "€24 164"], status: "active" as const },
    { id: "1249277635", cells: ["PAI-6635", "P-AI Next-Best-Action Item 2", "12/8/2026", "€27 735"], status: "pending" as const },
    { id: "1249281206", cells: ["PAI-1206", "P-AI Next-Best-Action Item 3", "27/3/2026", "€31 306"], status: "completed" as const },
    { id: "1249284777", cells: ["PAI-4777", "P-AI Next-Best-Action Item 4", "14/10/2026", "€34 877"], status: "warning" as const },
    { id: "1249288348", cells: ["PAI-8348", "P-AI Next-Best-Action Item 5", "1/5/2026", "€38 448"], status: "active" as const },
];
...
export default function PaiNextbestactionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Next-Best-Action</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Next-Best-Action</p>
                    </div>
                </div>
