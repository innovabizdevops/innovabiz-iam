...
const PAGE = "Pit Ops";
const KPIS = [{"l":"Total Sand Gravel","v":"353","t":"-0.5%","d":"down"},{"l":"Pit Ops Ativos","v":"1.523","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"80.4%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+17.8%","d":"up"}];
const COLS = ["ID","Pit Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sand Gravel #001","Sand Gravel #002","4.990","3.176","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Sand Gravel #002","Sand Gravel #003","2.592","6.497","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Sand Gravel #003","Sand Gravel #004","6.476","6.003","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Sand Gravel #004","Sand Gravel #005","4.140","8.386","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sand Gravel #005","Sand Gravel #001","2.856","4.101","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":716},{"label":"Mar","value":841},{"label":"Abr","value":711},{"label":"Mai","value":933},{"label":"Jun","value":1019},{"label":"Jul","value":671},{"label":"Ago","value":878},{"label":"Set","value":680},{"label":"Out","value":834},{"label":"Nov","value":864},{"label":"Dez","value":811}];
const MX = 1019;
