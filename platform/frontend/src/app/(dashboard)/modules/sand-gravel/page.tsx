...
export default function SandGravelPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sand Gravel</h1><p className="text-sm text-muted-foreground">Sand Gravel • iBOS Enterprise</p></div>
