...
const ACCENT = "#6366f1";
const MODULE = "Sand & Gravel";
const PAGE = "Reclamation";
const KPIS = [{"l":"Total Sand Gravel","v":"7.291","t":"+7.4%","d":"up"},{"l":"Reclamation Ativos","v":"3.670","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+13.4%","d":"up"}];
const COLS = ["ID","Reclamation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sand Gravel #001","Sand Gravel #002","6.997","8.288","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Sand Gravel #002","Sand Gravel #003","1.360","179","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Sand Gravel #003","Sand Gravel #004","4.865","4.278","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Sand Gravel #004","Sand Gravel #005","6.495","5.621","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sand Gravel #005","Sand Gravel #001","5.470","6.971","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":877},{"label":"Mar","value":772},{"label":"Abr","value":933},{"label":"Mai","value":807},{"label":"Jun","value":1026},{"label":"Jul","value":999},{"label":"Ago","value":980},{"label":"Set","value":951},{"label":"Out","value":767},{"label":"Nov","value":818},{"label":"Dez","value":980}];
const MX = 1026;
