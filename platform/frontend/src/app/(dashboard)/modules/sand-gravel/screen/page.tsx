...
const KPIS = [{"l":"Total Sand Gravel","v":"1.068","t":"+17.1%","d":"up"},{"l":"Screening Ativos","v":"1.835","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"67.3%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"77","t":"+0.4%","d":"up"}];
const COLS = ["ID","Screening","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sand Gravel #001","Sand Gravel #002","2.152","4.375","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Sand Gravel #002","Sand Gravel #003","8.278","129","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Sand Gravel #003","Sand Gravel #004","3.573","2.369","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Sand Gravel #004","Sand Gravel #005","1.930","8.002","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sand Gravel #005","Sand Gravel #001","3.878","2.948","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":953},{"label":"Mar","value":715},{"label":"Abr","value":722},{"label":"Mai","value":1012},{"label":"Jun","value":916},{"label":"Jul","value":858},{"label":"Ago","value":716},{"label":"Set","value":802},{"label":"Out","value":884},{"label":"Nov","value":790},{"label":"Dez","value":917}];
const MX = 1012;
