...
/* ═══ Hemp Construction — Dashboard ═══ */

const ACCENT = "#0d3b1e";

const KPIS = [
    { label: "Total Registos", value: "8133", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1022", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2054406533", cells: ["HEM-4533", "Hemp Construction Item 1", "26/6/2026", "€6633"], status: "active" as const },
    { id: "2054410104", cells: ["HEM-8104", "Hemp Construction Item 2", "13/1/2026", "€10 204"], status: "pending" as const },
    { id: "2054413675", cells: ["HEM-2675", "Hemp Construction Item 3", "28/8/2026", "€13 775"], status: "completed" as const },
    { id: "2054417246", cells: ["HEM-6246", "Hemp Construction Item 4", "15/3/2026", "€17 346"], status: "warning" as const },
    { id: "2054420817", cells: ["HEM-9817", "Hemp Construction Item 5", "2/10/2026", "€20 917"], status: "active" as const },
];
...
export default function HempConstructionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hemp Construction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hemp Construction</p>
                    </div>
                </div>
