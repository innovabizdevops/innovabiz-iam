...
const PAGE = "Hempcrete";
const KPIS = [{"l":"Total Hemp Construction","v":"6.229","t":"+5.2%","d":"up"},{"l":"Hempcrete Ativos","v":"8.540","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"80","t":"-3.7%","d":"down"}];
const COLS = ["ID","Hempcrete","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hemp Construction #001","Hemp Construction #002","6.492","8.387","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Hemp Construction #002","Hemp Construction #003","4.382","185","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Hemp Construction #003","Hemp Construction #004","4.597","4.442","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Hemp Construction #004","Hemp Construction #005","8.432","4.310","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hemp Construction #005","Hemp Construction #001","8.870","6.975","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":801},{"label":"Mar","value":800},{"label":"Abr","value":824},{"label":"Mai","value":753},{"label":"Jun","value":901},{"label":"Jul","value":736},{"label":"Ago","value":638},{"label":"Set","value":718},{"label":"Out","value":872},{"label":"Nov","value":732},{"label":"Dez","value":891}];
const MX = 967;
...
export default function HempcretePage() {
    return (
