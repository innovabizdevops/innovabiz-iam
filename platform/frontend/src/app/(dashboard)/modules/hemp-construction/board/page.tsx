...
const PAGE = "Board";
const KPIS = [{"l":"Teams Ativos","v":"711","t":"+2.6%","d":"up"},{"l":"Reuniões/Semana","v":"1914","t":"-4.0%","d":"down"},{"l":"Mensagens/Dia","v":"490","t":"+2.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.984","t":"+15.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.253","2879","4.743","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.341","1211","7.845","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.782","3020","5.727","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","754","3457","7.063","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.110","3074","5.486","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":313},{"label":"Mar","value":278},{"label":"Abr","value":267},{"label":"Mai","value":291},{"label":"Jun","value":416},{"label":"Jul","value":354},{"label":"Ago","value":281},{"label":"Set","value":569},{"label":"Out","value":621},{"label":"Nov","value":354},{"label":"Dez","value":656}];
const MX = 656;
