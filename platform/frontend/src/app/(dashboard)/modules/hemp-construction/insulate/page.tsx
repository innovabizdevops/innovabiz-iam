...
const ACCENT = "#0d3b1e";
const MODULE = "Hemp Construction";
const PAGE = "Insulation";
const KPIS = [{"l":"Total Hemp Construction","v":"1.657","t":"+8.2%","d":"up"},{"l":"Insulation Ativos","v":"3.109","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.4%","d":"up"}];
const COLS = ["ID","Insulation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hemp Construction #001","Hemp Construction #002","6.343","613","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Hemp Construction #002","Hemp Construction #003","8.983","3.095","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Hemp Construction #003","Hemp Construction #004","2.620","1.697","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Hemp Construction #004","Hemp Construction #005","7.208","4.531","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hemp Construction #005","Hemp Construction #001","4.923","2.027","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":718},{"label":"Mar","value":925},{"label":"Abr","value":584},{"label":"Mai","value":909},{"label":"Jun","value":948},{"label":"Jul","value":818},{"label":"Ago","value":617},{"label":"Set","value":943},{"label":"Out","value":932},{"label":"Nov","value":814},{"label":"Dez","value":607}];
const MX = 948;
...
export default function InsulatePage() {
    return (
