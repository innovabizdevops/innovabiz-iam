...
const KPIS = [{"l":"Total Billing Telecom","v":"7.162","t":"+8.3%","d":"up"},{"l":"CDR Process Ativos","v":"3.341","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"84","t":"+15.0%","d":"up"}];
const COLS = ["ID","CDR Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Billing Telecom #001","Billing Telecom #002","7.326","4.936","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Billing Telecom #002","Billing Telecom #003","5.610","3.257","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Billing Telecom #003","Billing Telecom #004","1.768","8.797","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Billing Telecom #004","Billing Telecom #005","5.148","3.340","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Billing Telecom #005","Billing Telecom #001","7.980","9.016","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":721},{"label":"Mar","value":353},{"label":"Abr","value":638},{"label":"Mai","value":745},{"label":"Jun","value":357},{"label":"Jul","value":638},{"label":"Ago","value":390},{"label":"Set","value":437},{"label":"Out","value":413},{"label":"Nov","value":723},{"label":"Dez","value":424}];
const MX = 745;
