...
const KPIS = [{"l":"Surveys Ativos","v":"8.907","t":"-1.1%","d":"down"},{"l":"Respostas/Semana","v":"2904","t":"-4.1%","d":"down"},{"l":"NPS Médio","v":"93","t":"+14.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"93.9%","t":"+14.2%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","7.329","79","96.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","7.637","92","74.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","7.702","67","70.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.377","93","83.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","1.024","87","90.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":284},{"label":"Mar","value":353},{"label":"Abr","value":341},{"label":"Mai","value":428},{"label":"Jun","value":401},{"label":"Jul","value":662},{"label":"Ago","value":565},{"label":"Set","value":392},{"label":"Out","value":319},{"label":"Nov","value":310},{"label":"Dez","value":579}];
const MX = 662;
