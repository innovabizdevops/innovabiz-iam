...
const KPIS = [{"l":"Integrações Ativas","v":"556","t":"+10.0%","d":"up"},{"l":"Chamadas/Hora","v":"2596","t":"+12.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.0%","t":"+11.6%","d":"up"},{"l":"Latência Média (ms)","v":"94ms","t":"+12.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.806","1.010","73.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.826","4.668","73.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.286","3.121","80.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.957","7.739","92.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.978","6.939","86.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":937},{"label":"Mar","value":907},{"label":"Abr","value":638},{"label":"Mai","value":567},{"label":"Jun","value":591},{"label":"Jul","value":649},{"label":"Ago","value":930},{"label":"Set","value":632},{"label":"Out","value":556},{"label":"Nov","value":638},{"label":"Dez","value":603}];
const MX = 937;
