...
export default function BillingTelecomPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Billing Telecom</h1><p className="text-sm text-muted-foreground">Billing Telecom • iBOS Enterprise</p></div>
