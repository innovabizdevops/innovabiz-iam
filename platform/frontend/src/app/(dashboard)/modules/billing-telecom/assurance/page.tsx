...
const KPIS = [{"l":"ARR (€M)","v":"€48.6M","t":"+4.8%","d":"up"},{"l":"MRR (€)","v":"€13592","t":"+10.4%","d":"up"},{"l":"Churn (%)","v":"86.0%","t":"+13.9%","d":"up"},{"l":"ARPU (€)","v":"€48725","t":"+17.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26393.61","3.522","€ 8156.15","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24541.06","5.416","€ 581.06","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2680.07","5.134","€ 13277.20","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5564.02","8.873","€ 5839.05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 22657.06","8.166","€ 16397.54","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":555},{"label":"Mar","value":731},{"label":"Abr","value":777},{"label":"Mai","value":586},{"label":"Jun","value":510},{"label":"Jul","value":574},{"label":"Ago","value":812},{"label":"Set","value":857},{"label":"Out","value":863},{"label":"Nov","value":793},{"label":"Dez","value":686}];
const MX = 863;
