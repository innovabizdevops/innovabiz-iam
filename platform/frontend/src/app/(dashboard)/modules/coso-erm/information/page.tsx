...
const KPIS = [{"l":"Riscos Identificados","v":"1.667","t":"+14.2%","d":"up"},{"l":"Mitigações Ativas","v":"6.830","t":"+9.4%","d":"up"},{"l":"Score Risco Geral","v":"66","t":"-3.8%","d":"down"},{"l":"Incidentes YTD","v":"7.366","t":"+7.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.206","5.778","4.960","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.097","4.558","5.524","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.567","8.941","5.098","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.615","2.730","9.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.138","5.648","1.830","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":857},{"label":"Mar","value":781},{"label":"Abr","value":541},{"label":"Mai","value":779},{"label":"Jun","value":856},{"label":"Jul","value":808},{"label":"Ago","value":923},{"label":"Set","value":801},{"label":"Out","value":574},{"label":"Nov","value":578},{"label":"Dez","value":708}];
const MX = 923;
