...
const ACCENT = "#dc2626";
const MODULE = "COSO ERM Framework";
const PAGE = "Governance";
const KPIS = [{"l":"Riscos Identificados","v":"936","t":"+13.8%","d":"up"},{"l":"Mitigações Ativas","v":"2.889","t":"-5.8%","d":"down"},{"l":"Score Risco Geral","v":"55","t":"+13.6%","d":"up"},{"l":"Incidentes YTD","v":"6.094","t":"+16.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","509","809","7.674","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.106","7.171","8.230","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.706","3.828","6.361","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.998","4.078","8.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.705","2.949","7.397","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":806},{"label":"Mar","value":757},{"label":"Abr","value":777},{"label":"Mai","value":885},{"label":"Jun","value":752},{"label":"Jul","value":581},{"label":"Ago","value":810},{"label":"Set","value":869},{"label":"Out","value":866},{"label":"Nov","value":856},{"label":"Dez","value":815}];
const MX = 885;
