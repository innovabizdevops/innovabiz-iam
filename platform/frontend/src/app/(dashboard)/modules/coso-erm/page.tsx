...
/* ═══ COSO ERM Framework — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "7046", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2823", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€249K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "315302146", cells: ["COS-6146", "COSO ERM Framework Item 1", "27/11/2026", "€2246"], status: "active" as const },
    { id: "315305717", cells: ["COS-9717", "COSO ERM Framework Item 2", "14/6/2026", "€5817"], status: "pending" as const },
    { id: "315309288", cells: ["COS-4288", "COSO ERM Framework Item 3", "1/1/2026", "€9388"], status: "completed" as const },
    { id: "315312859", cells: ["COS-7859", "COSO ERM Framework Item 4", "16/8/2026", "€12 959"], status: "warning" as const },
    { id: "315316430", cells: ["COS-2430", "COSO ERM Framework Item 5", "3/3/2026", "€16 530"], status: "active" as const },
];
...
export default function CosoErmFrameworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSO ERM Framework</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSO ERM Framework</p>
                    </div>
                </div>
