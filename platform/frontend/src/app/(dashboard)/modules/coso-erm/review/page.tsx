...
const PAGE = "Review";
const KPIS = [{"l":"Riscos Identificados","v":"303","t":"+12.0%","d":"up"},{"l":"Mitigações Ativas","v":"845","t":"+11.6%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+1.4%","d":"up"},{"l":"Incidentes YTD","v":"2.892","t":"-4.8%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.105","3.698","988","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.605","3.811","1.979","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.504","5.407","2.596","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.722","6.531","4.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.906","3.680","8.747","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":381},{"label":"Mar","value":435},{"label":"Abr","value":291},{"label":"Mai","value":429},{"label":"Jun","value":440},{"label":"Jul","value":562},{"label":"Ago","value":566},{"label":"Set","value":327},{"label":"Out","value":300},{"label":"Nov","value":666},{"label":"Dez","value":497}];
const MX = 676;
