...
const KPIS = [{"l":"Riscos Identificados","v":"5.542","t":"+14.7%","d":"up"},{"l":"Mitigações Ativas","v":"2.797","t":"+4.1%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+0.9%","d":"up"},{"l":"Incidentes YTD","v":"8.707","t":"+7.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.440","5.178","3.945","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","312","399","906","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.884","6.027","5.575","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.470","1.710","1.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.526","8.345","6.598","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":534},{"label":"Mar","value":552},{"label":"Abr","value":380},{"label":"Mai","value":372},{"label":"Jun","value":632},{"label":"Jul","value":387},{"label":"Ago","value":527},{"label":"Set","value":706},{"label":"Out","value":529},{"label":"Nov","value":689},{"label":"Dez","value":731}];
const MX = 731;
