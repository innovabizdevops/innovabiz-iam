...
const PAGE = "Strategy";
const KPIS = [{"l":"Riscos Identificados","v":"2.896","t":"+9.3%","d":"up"},{"l":"Mitigações Ativas","v":"5.283","t":"+6.0%","d":"up"},{"l":"Score Risco Geral","v":"71","t":"+7.1%","d":"up"},{"l":"Incidentes YTD","v":"1.576","t":"+10.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.341","5.758","8.302","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.619","6.212","3.797","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.964","8.464","5.167","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.359","2.095","8.930","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.398","6.827","4.745","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":717},{"label":"Mar","value":519},{"label":"Abr","value":674},{"label":"Mai","value":753},{"label":"Jun","value":697},{"label":"Jul","value":554},{"label":"Ago","value":542},{"label":"Set","value":559},{"label":"Out","value":741},{"label":"Nov","value":444},{"label":"Dez","value":395}];
const MX = 753;
