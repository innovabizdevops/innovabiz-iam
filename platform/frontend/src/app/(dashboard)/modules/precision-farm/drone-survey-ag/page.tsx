...
/* ═══ Precision Farming — Drone Survey Ag ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "301", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "440", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2966", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1416033828", cells: ["PRE-1828", "Drone Survey Ag Item 1", "21/1/2026", "€33 928"], status: "active" as const },
    { id: "1416037399", cells: ["PRE-5399", "Drone Survey Ag Item 2", "8/8/2026", "€37 499"], status: "pending" as const },
    { id: "1416040970", cells: ["PRE-8970", "Drone Survey Ag Item 3", "23/3/2026", "€41 070"], status: "completed" as const },
    { id: "1416044541", cells: ["PRE-3541", "Drone Survey Ag Item 4", "10/10/2026", "€44 641"], status: "warning" as const },
    { id: "1416048112", cells: ["PRE-7112", "Drone Survey Ag Item 5", "25/5/2026", "€48 212"], status: "active" as const },
];
...
export default function PrecisionFarmingDroneSurveyAgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drone Survey Ag</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Drone Survey Ag</p>
                    </div>
                </div>
