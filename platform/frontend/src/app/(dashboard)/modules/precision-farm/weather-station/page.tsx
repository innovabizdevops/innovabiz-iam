...
/* ═══ Precision Farming — Weather Station ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3494", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2776", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1558648032", cells: ["PRE-2032", "Weather Station Item 1", "5/1/2026", "€48 132"], status: "active" as const },
    { id: "1558651603", cells: ["PRE-5603", "Weather Station Item 2", "20/8/2026", "€1703"], status: "pending" as const },
    { id: "1558655174", cells: ["PRE-9174", "Weather Station Item 3", "7/3/2026", "€5274"], status: "completed" as const },
    { id: "1558658745", cells: ["PRE-3745", "Weather Station Item 4", "22/10/2026", "€8845"], status: "warning" as const },
    { id: "1558662316", cells: ["PRE-7316", "Weather Station Item 5", "9/5/2026", "€12 416"], status: "active" as const },
];
...
export default function PrecisionFarmingWeatherStationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Weather Station</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Weather Station</p>
                    </div>
                </div>
