...
/* ═══ Precision Farming — Crop Monitor ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "1365", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "166", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2393", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "85%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1633834098", cells: ["PRE-2098", "Crop Monitor Item 1", "23/7/2026", "€34 198"], status: "active" as const },
    { id: "1633837669", cells: ["PRE-5669", "Crop Monitor Item 2", "10/2/2026", "€37 769"], status: "pending" as const },
    { id: "1633841240", cells: ["PRE-9240", "Crop Monitor Item 3", "25/9/2026", "€41 340"], status: "completed" as const },
    { id: "1633844811", cells: ["PRE-3811", "Crop Monitor Item 4", "12/4/2026", "€44 911"], status: "warning" as const },
    { id: "1633848382", cells: ["PRE-7382", "Crop Monitor Item 5", "27/11/2026", "€48 482"], status: "active" as const },
];
...
export default function PrecisionFarmingCropMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crop Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Crop Monitor</p>
                    </div>
                </div>
