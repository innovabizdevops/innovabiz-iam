...
/* ═══ Precision Farming — Pest Detect ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4393", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "303", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3909", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2020208315", cells: ["PRE-6315", "Pest Detect Item 1", "28/12/2026", "€8415"], status: "active" as const },
    { id: "2020211886", cells: ["PRE-9886", "Pest Detect Item 2", "15/7/2026", "€11 986"], status: "pending" as const },
    { id: "2020215457", cells: ["PRE-4457", "Pest Detect Item 3", "2/2/2026", "€15 557"], status: "completed" as const },
    { id: "2020219028", cells: ["PRE-8028", "Pest Detect Item 4", "17/9/2026", "€19 128"], status: "warning" as const },
    { id: "2020222599", cells: ["PRE-2599", "Pest Detect Item 5", "4/4/2026", "€22 699"], status: "active" as const },
];
...
export default function PrecisionFarmingPestDetectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pest Detect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Pest Detect</p>
                    </div>
                </div>
