...
const KPIS = [
    { label: "Total", value: "3998", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "49", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "140", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "519895853", cells: ["PRE-2853", "Soil Sensor Item 1", "2/6/2026", "€45 953"], status: "active" as const },
    { id: "519899424", cells: ["PRE-6424", "Soil Sensor Item 2", "17/1/2026", "€49 524"], status: "pending" as const },
    { id: "519902995", cells: ["PRE-9995", "Soil Sensor Item 3", "4/8/2026", "€3095"], status: "completed" as const },
    { id: "519906566", cells: ["PRE-4566", "Soil Sensor Item 4", "19/3/2026", "€6666"], status: "warning" as const },
    { id: "519910137", cells: ["PRE-8137", "Soil Sensor Item 5", "6/10/2026", "€10 237"], status: "active" as const },
];
...
export default function PrecisionFarmingSoilSensorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Soil Sensor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Soil Sensor</p>
                    </div>
                </div>
