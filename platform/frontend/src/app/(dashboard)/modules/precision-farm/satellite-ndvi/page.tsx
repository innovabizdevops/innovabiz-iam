...
/* ═══ Precision Farming — Satellite Ndvi ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "1087", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "286", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1451", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "694168170", cells: ["PRE-8170", "Satellite Ndvi Item 1", "11/7/2026", "€18 270"], status: "active" as const },
    { id: "694171741", cells: ["PRE-2741", "Satellite Ndvi Item 2", "26/2/2026", "€21 841"], status: "pending" as const },
    { id: "694175312", cells: ["PRE-6312", "Satellite Ndvi Item 3", "13/9/2026", "€25 412"], status: "completed" as const },
    { id: "694178883", cells: ["PRE-9883", "Satellite Ndvi Item 4", "28/4/2026", "€28 983"], status: "warning" as const },
    { id: "694182454", cells: ["PRE-4454", "Satellite Ndvi Item 5", "15/11/2026", "€32 554"], status: "active" as const },
];
...
export default function PrecisionFarmingSatelliteNdviPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Satellite Ndvi</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Satellite Ndvi</p>
                    </div>
                </div>
