...
/* ═══ Precision Farming — Irrigation Smart ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3853", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "35", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1954", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1033571295", cells: ["PRE-3295", "Irrigation Smart Item 1", "16/4/2026", "€21 395"], status: "active" as const },
    { id: "1033574866", cells: ["PRE-6866", "Irrigation Smart Item 2", "3/11/2026", "€24 966"], status: "pending" as const },
    { id: "1033578437", cells: ["PRE-1437", "Irrigation Smart Item 3", "18/6/2026", "€28 537"], status: "completed" as const },
    { id: "1033582008", cells: ["PRE-5008", "Irrigation Smart Item 4", "5/1/2026", "€32 108"], status: "warning" as const },
    { id: "1033585579", cells: ["PRE-8579", "Irrigation Smart Item 5", "20/8/2026", "€35 679"], status: "active" as const },
];
...
export default function PrecisionFarmingIrrigationSmartPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Irrigation Smart</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Irrigation Smart</p>
                    </div>
                </div>
