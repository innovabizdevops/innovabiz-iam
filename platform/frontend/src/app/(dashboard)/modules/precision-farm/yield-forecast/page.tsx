...
/* ═══ Precision Farming — Yield Forecast ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4222", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "410", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1484", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "97%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1810039830", cells: ["PRE-5830", "Yield Forecast Item 1", "19/7/2026", "€39 930"], status: "active" as const },
    { id: "1810043401", cells: ["PRE-9401", "Yield Forecast Item 2", "6/2/2026", "€43 501"], status: "pending" as const },
    { id: "1810046972", cells: ["PRE-3972", "Yield Forecast Item 3", "21/9/2026", "€47 072"], status: "completed" as const },
    { id: "1810050543", cells: ["PRE-7543", "Yield Forecast Item 4", "8/4/2026", "€643"], status: "warning" as const },
    { id: "1810054114", cells: ["PRE-2114", "Yield Forecast Item 5", "23/11/2026", "€4214"], status: "active" as const },
];
...
export default function PrecisionFarmingYieldForecastPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Yield Forecast</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Yield Forecast</p>
                    </div>
                </div>
