...
/* ═══ Precision Farming — Fertilizer Mgmt ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "2756", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "109", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "406", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "989612873", cells: ["PRE-9873", "Fertilizer Mgmt Item 1", "26/6/2026", "€12 973"], status: "active" as const },
    { id: "989616444", cells: ["PRE-4444", "Fertilizer Mgmt Item 2", "13/1/2026", "€16 544"], status: "pending" as const },
    { id: "989620015", cells: ["PRE-8015", "Fertilizer Mgmt Item 3", "28/8/2026", "€20 115"], status: "completed" as const },
    { id: "989623586", cells: ["PRE-2586", "Fertilizer Mgmt Item 4", "15/3/2026", "€23 686"], status: "warning" as const },
    { id: "989627157", cells: ["PRE-6157", "Fertilizer Mgmt Item 5", "2/10/2026", "€27 257"], status: "active" as const },
];
...
export default function PrecisionFarmingFertilizerMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fertilizer Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Fertilizer Mgmt</p>
                    </div>
                </div>
