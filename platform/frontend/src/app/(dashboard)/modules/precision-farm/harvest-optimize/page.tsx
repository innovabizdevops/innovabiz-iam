...
/* ═══ Precision Farming — Harvest Optimize ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "899", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "312", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3232", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1602214244", cells: ["PRE-8244", "Harvest Optimize Item 1", "9/9/2026", "€14 344"], status: "active" as const },
    { id: "1602217815", cells: ["PRE-2815", "Harvest Optimize Item 2", "24/4/2026", "€17 915"], status: "pending" as const },
    { id: "1602221386", cells: ["PRE-6386", "Harvest Optimize Item 3", "11/11/2026", "€21 486"], status: "completed" as const },
    { id: "1602224957", cells: ["PRE-9957", "Harvest Optimize Item 4", "26/6/2026", "€25 057"], status: "warning" as const },
    { id: "1602228528", cells: ["PRE-4528", "Harvest Optimize Item 5", "13/1/2026", "€28 628"], status: "active" as const },
];
...
export default function PrecisionFarmingHarvestOptimizePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Harvest Optimize</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Precision Farming • Harvest Optimize</p>
                    </div>
                </div>
