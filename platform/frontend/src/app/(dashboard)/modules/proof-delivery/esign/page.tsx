...
const PAGE = "E-Signature";
const KPIS = [{"l":"Formulários Ativos","v":"7.431","t":"+6.0%","d":"up"},{"l":"Submissões/Dia","v":"3924","t":"+7.4%","d":"up"},{"l":"Documentos Gerados","v":"8.066","t":"-3.9%","d":"down"},{"l":"Templates","v":"8.220","t":"-2.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.947","2026-03-15","6.719","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.610","2026-01-13","3.763","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.550","2026-03-22","4.112","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.007","2026-03-27","2.368","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.443","2026-03-20","1.789","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":960},{"label":"Mar","value":983},{"label":"Abr","value":986},{"label":"Mai","value":937},{"label":"Jun","value":815},{"label":"Jul","value":779},{"label":"Ago","value":1040},{"label":"Set","value":787},{"label":"Out","value":748},{"label":"Nov","value":783},{"label":"Dez","value":706}];
const MX = 1040;
