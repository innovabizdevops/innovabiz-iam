...
const PAGE = "Exceptions";
const KPIS = [{"l":"Total Proof Delivery","v":"2.215","t":"+10.6%","d":"up"},{"l":"Exceptions Ativos","v":"6.235","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.3%","d":"up"}];
const COLS = ["ID","Exceptions","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Proof Delivery #001","Proof Delivery #002","4.152","1.093","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Proof Delivery #002","Proof Delivery #003","4.309","1.537","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Proof Delivery #003","Proof Delivery #004","5.550","4.413","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Proof Delivery #004","Proof Delivery #005","6.509","5.860","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Proof Delivery #005","Proof Delivery #001","2.896","4.095","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":837},{"label":"Mar","value":897},{"label":"Abr","value":772},{"label":"Mai","value":569},{"label":"Jun","value":726},{"label":"Jul","value":679},{"label":"Ago","value":717},{"label":"Set","value":565},{"label":"Out","value":688},{"label":"Nov","value":584},{"label":"Dez","value":841}];
const MX = 897;
