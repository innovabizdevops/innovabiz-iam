...
const PAGE = "Photo Proof";
const KPIS = [{"l":"Total Proof Delivery","v":"2.462","t":"+5.1%","d":"up"},{"l":"Photo Proof Ativos","v":"3.828","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"92","t":"-3.4%","d":"down"}];
const COLS = ["ID","Photo Proof","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Proof Delivery #001","Proof Delivery #002","4.267","6.410","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Proof Delivery #002","Proof Delivery #003","1.184","1.898","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Proof Delivery #003","Proof Delivery #004","3.267","1.039","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Proof Delivery #004","Proof Delivery #005","979","4.315","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Proof Delivery #005","Proof Delivery #001","380","541","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":275},{"label":"Mar","value":442},{"label":"Abr","value":536},{"label":"Mai","value":518},{"label":"Jun","value":276},{"label":"Jul","value":471},{"label":"Ago","value":318},{"label":"Set","value":405},{"label":"Out","value":547},{"label":"Nov","value":590},{"label":"Dez","value":429}];
const MX = 603;
