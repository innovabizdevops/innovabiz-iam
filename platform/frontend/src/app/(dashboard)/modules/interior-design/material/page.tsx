...
const PAGE = "Material";
const KPIS = [{"l":"Formulários Ativos","v":"2.364","t":"-4.6%","d":"down"},{"l":"Submissões/Dia","v":"4286","t":"+5.2%","d":"up"},{"l":"Documentos Gerados","v":"1.379","t":"-4.0%","d":"down"},{"l":"Templates","v":"3.941","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.775","2026-01-15","7.382","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.924","2026-02-07","2.753","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.733","2026-02-15","7.844","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.492","2026-01-03","6.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.682","2026-02-16","1.194","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":621},{"label":"Mar","value":635},{"label":"Abr","value":726},{"label":"Mai","value":900},{"label":"Jun","value":856},{"label":"Jul","value":904},{"label":"Ago","value":938},{"label":"Set","value":670},{"label":"Out","value":768},{"label":"Nov","value":596},{"label":"Dez","value":889}];
const MX = 938;
