...
const ACCENT = "#6366f1";
const MODULE = "Interior Design";
const PAGE = "3D Render";
const KPIS = [{"l":"Formulários Ativos","v":"8.486","t":"+10.1%","d":"up"},{"l":"Submissões/Dia","v":"2188","t":"+12.4%","d":"up"},{"l":"Documentos Gerados","v":"6.142","t":"+7.1%","d":"up"},{"l":"Templates","v":"151","t":"-5.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.579","2026-03-09","4.488","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.934","2026-02-15","3.670","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.765","2026-01-01","7.420","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.553","2026-02-10","8.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.959","2026-03-09","2.282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":707},{"label":"Mar","value":614},{"label":"Abr","value":766},{"label":"Mai","value":544},{"label":"Jun","value":498},{"label":"Jul","value":572},{"label":"Ago","value":581},{"label":"Set","value":707},{"label":"Out","value":831},{"label":"Nov","value":717},{"label":"Dez","value":622}];
const MX = 844;
