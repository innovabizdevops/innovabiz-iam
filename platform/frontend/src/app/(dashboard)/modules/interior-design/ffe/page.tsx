...
const PAGE = "FF&amp;E";
const KPIS = [{"l":"Formulários Ativos","v":"4.505","t":"-3.2%","d":"down"},{"l":"Submissões/Dia","v":"2691","t":"+12.6%","d":"up"},{"l":"Documentos Gerados","v":"8.635","t":"+4.8%","d":"up"},{"l":"Templates","v":"2.049","t":"-2.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.093","2026-01-15","1.168","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","652","2026-01-11","1.676","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.178","2026-01-05","6.079","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.313","2026-01-11","7.112","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.339","2026-01-03","2.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":610},{"label":"Mar","value":650},{"label":"Abr","value":722},{"label":"Mai","value":464},{"label":"Jun","value":657},{"label":"Jul","value":580},{"label":"Ago","value":432},{"label":"Set","value":532},{"label":"Out","value":505},{"label":"Nov","value":630},{"label":"Dez","value":518}];
const MX = 722;
