...
const PAGE = "Space Plan";
const KPIS = [{"l":"Formulários Ativos","v":"7.659","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"4214","t":"+16.7%","d":"up"},{"l":"Documentos Gerados","v":"7.003","t":"-0.7%","d":"down"},{"l":"Templates","v":"4.357","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.209","2026-02-28","2.749","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","201","2026-03-08","522","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.979","2026-02-09","6.614","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.989","2026-02-04","4.855","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.342","2026-03-04","5.977","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":788},{"label":"Mar","value":642},{"label":"Abr","value":739},{"label":"Mai","value":688},{"label":"Jun","value":652},{"label":"Jul","value":543},{"label":"Ago","value":691},{"label":"Set","value":532},{"label":"Out","value":710},{"label":"Nov","value":777},{"label":"Dez","value":700}];
const MX = 788;
