...
const PAGE = "Budget";
const KPIS = [{"l":"Formulários Ativos","v":"5.881","t":"+2.8%","d":"up"},{"l":"Submissões/Dia","v":"2531","t":"-3.6%","d":"down"},{"l":"Documentos Gerados","v":"5.567","t":"-4.3%","d":"down"},{"l":"Templates","v":"4.247","t":"-6.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","657","2026-01-13","8.916","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.634","2026-01-23","4.009","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.657","2026-02-21","4.966","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.687","2026-01-20","1.182","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.421","2026-01-16","908","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":589},{"label":"Mar","value":686},{"label":"Abr","value":490},{"label":"Mai","value":504},{"label":"Jun","value":795},{"label":"Jul","value":529},{"label":"Ago","value":782},{"label":"Set","value":861},{"label":"Out","value":634},{"label":"Nov","value":778},{"label":"Dez","value":700}];
const MX = 861;
