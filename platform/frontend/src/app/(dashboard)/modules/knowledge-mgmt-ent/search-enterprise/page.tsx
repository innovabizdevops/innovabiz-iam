...
const ROWS = [
  { id: "001", c: ["Search Enterprise-001", "Search Enterprise Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Search Enterprise-002", "Search Enterprise Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Search Enterprise-003", "Search Enterprise Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Search Enterprise-004", "Search Enterprise Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Search Enterprise-005", "Search Enterprise Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Search Enterprise", ts: "Há 2min", a: "Sistema" },
...
export default function SearchEnterprisePage() {
  return (
