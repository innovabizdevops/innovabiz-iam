...
const ROWS = [
  { id: "001", c: ["Content Curate-001", "Content Curate Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Content Curate-002", "Content Curate Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Content Curate-003", "Content Curate Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Content Curate-004", "Content Curate Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Content Curate-005", "Content Curate Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Content Curate", ts: "Há 2min", a: "Sistema" },
...
export default function ContentCuratePage() {
  return (
