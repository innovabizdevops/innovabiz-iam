...
const ROWS = [
  { id: "001", c: ["Lesson Learned-001", "Lesson Learned Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Lesson Learned-002", "Lesson Learned Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Lesson Learned-003", "Lesson Learned Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Lesson Learned-004", "Lesson Learned Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Lesson Learned-005", "Lesson Learned Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Lesson Learned", ts: "Há 2min", a: "Sistema" },
...
export default function LessonLearnedPage() {
  return (
