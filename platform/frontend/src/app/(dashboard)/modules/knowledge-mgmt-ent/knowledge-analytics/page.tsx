...
const PAGE = "Knowledge Analytics";
...
const ROWS = [
  { id: "001", c: ["Knowledge Analytics-001", "Knowledge Analytics Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Knowledge Analytics-002", "Knowledge Analytics Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Knowledge Analytics-003", "Knowledge Analytics Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Knowledge Analytics-004", "Knowledge Analytics Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Knowledge Analytics-005", "Knowledge Analytics Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Knowledge Analytics", ts: "Há 2min", a: "Sistema" },
