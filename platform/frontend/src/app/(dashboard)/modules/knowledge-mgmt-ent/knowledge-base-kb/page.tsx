...
const ROWS = [
  { id: "001", c: ["Knowledge Base Kb-001", "Knowledge Base Kb Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Knowledge Base Kb-002", "Knowledge Base Kb Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Knowledge Base Kb-003", "Knowledge Base Kb Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Knowledge Base Kb-004", "Knowledge Base Kb Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Knowledge Base Kb-005", "Knowledge Base Kb Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Knowledge Base Kb", ts: "Há 2min", a: "Sistema" },
...
export default function KnowledgeBaseKbPage() {
  return (
