...
const PAGE = "Interco Elim";
const KPIS = [{"l":"Total General Ledger","v":"2.171","t":"-3.2%","d":"down"},{"l":"Interco Elim Ativos","v":"2.635","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"90.6%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"62","t":"-4.7%","d":"down"}];
const COLS = ["ID","Interco Elim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["General Ledger #001","General Ledger #002","6.810","8.110","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["General Ledger #002","General Ledger #003","7.147","8.764","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["General Ledger #003","General Ledger #004","6.201","4.765","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["General Ledger #004","General Ledger #005","8.207","3.256","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["General Ledger #005","General Ledger #001","2.346","1.690","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":663},{"label":"Mar","value":725},{"label":"Abr","value":841},{"label":"Mai","value":854},{"label":"Jun","value":838},{"label":"Jul","value":800},{"label":"Ago","value":939},{"label":"Set","value":561},{"label":"Out","value":649},{"label":"Nov","value":666},{"label":"Dez","value":613}];
const MX = 939;
...
export default function IcElimPage() {
    return (
