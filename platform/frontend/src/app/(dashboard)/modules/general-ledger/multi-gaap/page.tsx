...
const PAGE = "Multi-GAAP";
const KPIS = [{"l":"Total General Ledger","v":"5.879","t":"+16.1%","d":"up"},{"l":"Multi GAAP Ativos","v":"5.926","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"70.4%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"57","t":"+0.8%","d":"up"}];
const COLS = ["ID","Multi GAAP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["General Ledger #001","General Ledger #002","5.693","2.878","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["General Ledger #002","General Ledger #003","7.110","6.370","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["General Ledger #003","General Ledger #004","3.679","1.058","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["General Ledger #004","General Ledger #005","7.966","1.754","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["General Ledger #005","General Ledger #001","2.550","3.626","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":592},{"label":"Mar","value":839},{"label":"Abr","value":878},{"label":"Mai","value":847},{"label":"Jun","value":588},{"label":"Jul","value":560},{"label":"Ago","value":622},{"label":"Set","value":724},{"label":"Out","value":770},{"label":"Nov","value":633},{"label":"Dez","value":649}];
const MX = 878;
...
export default function MultiGaapPage() {
    return (
