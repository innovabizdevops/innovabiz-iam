...
const PAGE = "Policy Admin";
const KPIS = [{"l":"Total Insurance Mgmt","v":"190","t":"+3.7%","d":"up"},{"l":"Policy Admin Ativos","v":"1.270","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+11.2%","d":"up"}];
const COLS = ["ID","Policy Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Mgmt #001","Insurance Mgmt #002","4.973","1.632","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Mgmt #002","Insurance Mgmt #003","2.645","4.092","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Mgmt #003","Insurance Mgmt #004","8.871","6.073","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Mgmt #004","Insurance Mgmt #005","4.213","1.127","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Mgmt #005","Insurance Mgmt #001","6.448","7.146","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":384},{"label":"Fev","value":656},{"label":"Mar","value":673},{"label":"Abr","value":614},{"label":"Mai","value":421},{"label":"Jun","value":619},{"label":"Jul","value":472},{"label":"Ago","value":648},{"label":"Set","value":661},{"label":"Out","value":533},{"label":"Nov","value":556},{"label":"Dez","value":373}];
const MX = 673;
