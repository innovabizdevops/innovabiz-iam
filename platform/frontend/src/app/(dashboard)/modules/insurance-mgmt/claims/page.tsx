...
const PAGE = "Claims Processing";
const KPIS = [{"l":"Total Insurance Mgmt","v":"352","t":"+8.5%","d":"up"},{"l":"Claims Processing Ativos","v":"6.922","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.1%","d":"up"}];
const COLS = ["ID","Claims Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Mgmt #001","Insurance Mgmt #002","1.375","950","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Mgmt #002","Insurance Mgmt #003","8.485","8.107","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Mgmt #003","Insurance Mgmt #004","7.195","3.211","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Mgmt #004","Insurance Mgmt #005","2.324","4.618","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Mgmt #005","Insurance Mgmt #001","5.352","5.185","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1014},{"label":"Fev","value":1006},{"label":"Mar","value":1019},{"label":"Abr","value":780},{"label":"Mai","value":835},{"label":"Jun","value":941},{"label":"Jul","value":863},{"label":"Ago","value":804},{"label":"Set","value":638},{"label":"Out","value":870},{"label":"Nov","value":731},{"label":"Dez","value":756}];
const MX = 1019;
