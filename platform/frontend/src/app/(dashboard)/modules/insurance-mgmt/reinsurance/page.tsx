...
const PAGE = "Reinsurance";
const KPIS = [{"l":"Total Insurance Mgmt","v":"5.808","t":"-4.2%","d":"down"},{"l":"Reinsurance Ativos","v":"8.549","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.0%","d":"up"}];
const COLS = ["ID","Reinsurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Mgmt #001","Insurance Mgmt #002","2.703","3.755","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Mgmt #002","Insurance Mgmt #003","3.419","6.618","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Mgmt #003","Insurance Mgmt #004","7.952","5.251","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Mgmt #004","Insurance Mgmt #005","8.898","2.772","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Mgmt #005","Insurance Mgmt #001","5.811","2.033","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":228},{"label":"Mar","value":242},{"label":"Abr","value":392},{"label":"Mai","value":590},{"label":"Jun","value":469},{"label":"Jul","value":568},{"label":"Ago","value":538},{"label":"Set","value":491},{"label":"Out","value":262},{"label":"Nov","value":548},{"label":"Dez","value":535}];
const MX = 609;
