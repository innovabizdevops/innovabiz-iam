...
const PAGE = "Distribution Mgmt";
const KPIS = [{"l":"Total Insurance Mgmt","v":"5.838","t":"-1.8%","d":"down"},{"l":"Distribution Mgmt Ativos","v":"3.758","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"73","t":"+16.9%","d":"up"}];
const COLS = ["ID","Distribution Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Mgmt #001","Insurance Mgmt #002","7.510","1.675","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Mgmt #002","Insurance Mgmt #003","8.934","6.553","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Mgmt #003","Insurance Mgmt #004","5.068","5.055","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Mgmt #004","Insurance Mgmt #005","7.367","8.272","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Mgmt #005","Insurance Mgmt #001","3.863","7.378","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":953},{"label":"Mar","value":912},{"label":"Abr","value":858},{"label":"Mai","value":827},{"label":"Jun","value":596},{"label":"Jul","value":717},{"label":"Ago","value":879},{"label":"Set","value":780},{"label":"Out","value":892},{"label":"Nov","value":822},{"label":"Dez","value":833}];
const MX = 953;
