...
const PAGE = "Facultative Placement";
const KPIS = [{"l":"Total Insurance Mgmt","v":"2.779","t":"+8.9%","d":"up"},{"l":"Facultative Placement Ativos","v":"7.693","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"89.7%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+7.0%","d":"up"}];
const COLS = ["ID","Facultative Placement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Mgmt #001","Insurance Mgmt #002","9.086","2.009","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Mgmt #002","Insurance Mgmt #003","6.577","5.440","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Mgmt #003","Insurance Mgmt #004","6.616","3.147","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Mgmt #004","Insurance Mgmt #005","6.908","6.484","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Mgmt #005","Insurance Mgmt #001","2.843","7.250","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":653},{"label":"Mar","value":677},{"label":"Abr","value":729},{"label":"Mai","value":596},{"label":"Jun","value":759},{"label":"Jul","value":492},{"label":"Ago","value":482},{"label":"Set","value":550},{"label":"Out","value":742},{"label":"Nov","value":565},{"label":"Dez","value":683}];
const MX = 759;
