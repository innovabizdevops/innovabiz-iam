...
const PAGE = "Treaty Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.691","t":"+15.4%","d":"up"},{"l":"Savings (€)","v":"€79405","t":"+8.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.9%","t":"-2.8%","d":"down"},{"l":"Ciclos PDCA","v":"1.712","t":"-5.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.410","€ 6173.06","4.125","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.700","€ 9797.97","7.794","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.383","€ 41458.37","549","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.759","€ 7251.68","4.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.953","€ 35800.91","2.543","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":586},{"label":"Mar","value":867},{"label":"Abr","value":626},{"label":"Mai","value":798},{"label":"Jun","value":896},{"label":"Jul","value":641},{"label":"Ago","value":696},{"label":"Set","value":795},{"label":"Out","value":851},{"label":"Nov","value":654},{"label":"Dez","value":805}];
const MX = 896;
