...
const PAGE = "Underwriting AI";
const KPIS = [{"l":"Total Insurance Mgmt","v":"6.961","t":"+6.9%","d":"up"},{"l":"Underwriting AI Ativos","v":"430","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+1.2%","d":"up"}];
const COLS = ["ID","Underwriting AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Mgmt #001","Insurance Mgmt #002","6.679","648","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Mgmt #002","Insurance Mgmt #003","7.166","2.527","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Mgmt #003","Insurance Mgmt #004","947","4.864","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Mgmt #004","Insurance Mgmt #005","236","8.481","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Mgmt #005","Insurance Mgmt #001","526","1.805","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":315},{"label":"Mar","value":305},{"label":"Abr","value":598},{"label":"Mai","value":448},{"label":"Jun","value":282},{"label":"Jul","value":557},{"label":"Ago","value":434},{"label":"Set","value":246},{"label":"Out","value":541},{"label":"Nov","value":351},{"label":"Dez","value":311}];
const MX = 598;
