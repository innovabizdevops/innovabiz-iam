...
const PAGE = "IoT Risk Scoring";
const KPIS = [{"l":"Riscos Identificados","v":"3.485","t":"+10.0%","d":"up"},{"l":"Mitigações Ativas","v":"6.019","t":"+3.6%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"-0.5%","d":"down"},{"l":"Incidentes YTD","v":"7.299","t":"-0.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.473","3.296","8.900","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.812","8.017","8.555","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.505","5.719","4.218","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.793","9.019","5.751","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.512","3.810","5.921","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":242},{"label":"Fev","value":464},{"label":"Mar","value":353},{"label":"Abr","value":418},{"label":"Mai","value":511},{"label":"Jun","value":435},{"label":"Jul","value":627},{"label":"Ago","value":346},{"label":"Set","value":459},{"label":"Out","value":342},{"label":"Nov","value":278},{"label":"Dez","value":533}];
const MX = 627;
...
export default function IotRiskPage() {
    return (
