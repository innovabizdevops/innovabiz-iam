...
const ACCENT = "#4338ca";
const MODULE = "Insurance Management";
const PAGE = "Claims AI Triage";
const KPIS = [{"l":"Total Insurance Mgmt","v":"6.599","t":"-1.1%","d":"down"},{"l":"Claims AI Triage Ativos","v":"8.494","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.8%","d":"up"}];
const COLS = ["ID","Claims AI Triage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Mgmt #001","Insurance Mgmt #002","7.550","7.071","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Mgmt #002","Insurance Mgmt #003","3.854","8.808","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Mgmt #003","Insurance Mgmt #004","9.028","3.723","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Mgmt #004","Insurance Mgmt #005","5.333","5.764","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Mgmt #005","Insurance Mgmt #001","5.305","7.766","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":336},{"label":"Mar","value":227},{"label":"Abr","value":393},{"label":"Mai","value":281},{"label":"Jun","value":526},{"label":"Jul","value":368},{"label":"Ago","value":393},{"label":"Set","value":551},{"label":"Out","value":366},{"label":"Nov","value":282},{"label":"Dez","value":358}];
const MX = 551;
...
export default function ClaimsAiPage() {
    return (
