...
const PAGE = "ACORD Forms";
const KPIS = [{"l":"Formulários Ativos","v":"5.059","t":"+15.1%","d":"up"},{"l":"Submissões/Dia","v":"1289","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"1.851","t":"-5.6%","d":"down"},{"l":"Templates","v":"7.754","t":"+0.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.968","2026-01-11","2.590","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.444","2026-02-20","143","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.560","2026-03-24","1.080","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.904","2026-03-02","2.409","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.498","2026-01-07","5.341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":235},{"label":"Fev","value":229},{"label":"Mar","value":253},{"label":"Abr","value":361},{"label":"Mai","value":452},{"label":"Jun","value":522},{"label":"Jul","value":252},{"label":"Ago","value":443},{"label":"Set","value":483},{"label":"Out","value":509},{"label":"Nov","value":593},{"label":"Dez","value":437}];
const MX = 593;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>ACORD</span></h1>
                </div>
