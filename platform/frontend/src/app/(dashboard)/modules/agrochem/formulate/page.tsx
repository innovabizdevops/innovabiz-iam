...
const ACCENT = "#6366f1";
const MODULE = "Agrochemical";
const PAGE = "Formulate";
const KPIS = [{"l":"Formulários Ativos","v":"6.840","t":"+9.2%","d":"up"},{"l":"Submissões/Dia","v":"2913","t":"+15.7%","d":"up"},{"l":"Documentos Gerados","v":"3.957","t":"+0.8%","d":"up"},{"l":"Templates","v":"569","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.842","2026-02-02","1.615","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.856","2026-01-27","276","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.967","2026-02-28","2.249","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.539","2026-01-13","1.086","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","688","2026-01-19","6.352","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":425},{"label":"Mar","value":569},{"label":"Abr","value":522},{"label":"Mai","value":556},{"label":"Jun","value":390},{"label":"Jul","value":719},{"label":"Ago","value":481},{"label":"Set","value":664},{"label":"Out","value":689},{"label":"Nov","value":714},{"label":"Dez","value":640}];
const MX = 719;
