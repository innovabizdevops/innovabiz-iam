...
const PAGE = "Orbit Track";
const KPIS = [{"l":"Total Satellite Ops","v":"7.322","t":"-1.4%","d":"down"},{"l":"Orbit Track Ativos","v":"2.075","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+6.2%","d":"up"}];
const COLS = ["ID","Orbit Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Satellite Ops #001","Satellite Ops #002","2.455","7.056","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Satellite Ops #002","Satellite Ops #003","5.101","968","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Satellite Ops #003","Satellite Ops #004","8.963","4.939","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Satellite Ops #004","Satellite Ops #005","5.833","5.167","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Satellite Ops #005","Satellite Ops #001","5.357","3.455","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":835},{"label":"Mar","value":828},{"label":"Abr","value":694},{"label":"Mai","value":887},{"label":"Jun","value":534},{"label":"Jul","value":713},{"label":"Ago","value":771},{"label":"Set","value":890},{"label":"Out","value":859},{"label":"Nov","value":672},{"label":"Dez","value":815}];
const MX = 890;
