...
const PAGE = "Decommission";
const KPIS = [{"l":"Vendas YTD (€)","v":"€25743","t":"+10.1%","d":"up"},{"l":"Pipeline (€)","v":"€83189","t":"-5.2%","d":"down"},{"l":"Atingimento Quota (%)","v":"75.3%","t":"-2.4%","d":"down"},{"l":"Win Rate (%)","v":"79.4%","t":"-2.0%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 34530.91","€ 6799.23","€ 11127.79","96.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 33777.14","€ 19018.71","€ 8638.01","88.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 25743.39","€ 10118.43","€ 12586.29","96.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 36522.59","€ 12596.15","€ 30495.48","93.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 24772.23","€ 9176.88","€ 10296.86","83.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":1028},{"label":"Mar","value":902},{"label":"Abr","value":889},{"label":"Mai","value":849},{"label":"Jun","value":1018},{"label":"Jul","value":883},{"label":"Ago","value":851},{"label":"Set","value":706},{"label":"Out","value":757},{"label":"Nov","value":649},{"label":"Dez","value":794}];
const MX = 1028;
