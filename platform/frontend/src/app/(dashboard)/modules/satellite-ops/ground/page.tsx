...
const PAGE = "Ground Station";
const KPIS = [{"l":"Total Satellite Ops","v":"3.086","t":"+11.3%","d":"up"},{"l":"Ground Station Ativos","v":"7.140","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"84","t":"+14.9%","d":"up"}];
const COLS = ["ID","Ground Station","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Satellite Ops #001","Satellite Ops #002","7.637","1.372","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Satellite Ops #002","Satellite Ops #003","6.841","8.195","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Satellite Ops #003","Satellite Ops #004","6.113","6.612","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Satellite Ops #004","Satellite Ops #005","2.332","5.295","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Satellite Ops #005","Satellite Ops #001","1.131","4.569","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":454},{"label":"Mar","value":424},{"label":"Abr","value":380},{"label":"Mai","value":696},{"label":"Jun","value":683},{"label":"Jul","value":730},{"label":"Ago","value":689},{"label":"Set","value":406},{"label":"Out","value":704},{"label":"Nov","value":571},{"label":"Dez","value":540}];
const MX = 730;
