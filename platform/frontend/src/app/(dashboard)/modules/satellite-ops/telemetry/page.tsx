...
const ACCENT = "#0284c7";
const MODULE = "Satellite Operations";
const PAGE = "Telemetry";
const KPIS = [{"l":"Total Satellite Ops","v":"6.672","t":"+14.3%","d":"up"},{"l":"Telemetry Ativos","v":"5.289","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"94.4%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+14.6%","d":"up"}];
const COLS = ["ID","Telemetry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Satellite Ops #001","Satellite Ops #002","3.941","4.096","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Satellite Ops #002","Satellite Ops #003","8.766","2.143","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Satellite Ops #003","Satellite Ops #004","4.128","2.879","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Satellite Ops #004","Satellite Ops #005","6.775","6.340","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Satellite Ops #005","Satellite Ops #001","4.335","1.344","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":391},{"label":"Mar","value":462},{"label":"Abr","value":393},{"label":"Mai","value":459},{"label":"Jun","value":406},{"label":"Jul","value":575},{"label":"Ago","value":541},{"label":"Set","value":608},{"label":"Out","value":460},{"label":"Nov","value":639},{"label":"Dez","value":451}];
const MX = 639;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0284c7'}}>IoT</span></h1>
                </div>
