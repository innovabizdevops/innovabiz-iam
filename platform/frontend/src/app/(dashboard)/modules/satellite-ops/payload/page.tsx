...
const PAGE = "Payload Mgmt";
const KPIS = [{"l":"Total Satellite Ops","v":"1.604","t":"+9.9%","d":"up"},{"l":"Payload Mgmt Ativos","v":"6.482","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"76.8%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+6.4%","d":"up"}];
const COLS = ["ID","Payload Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Satellite Ops #001","Satellite Ops #002","7.989","2.673","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Satellite Ops #002","Satellite Ops #003","501","5.002","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Satellite Ops #003","Satellite Ops #004","4.955","4.650","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Satellite Ops #004","Satellite Ops #005","5.123","468","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Satellite Ops #005","Satellite Ops #001","3.597","1.492","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":957},{"label":"Mar","value":835},{"label":"Abr","value":915},{"label":"Mai","value":881},{"label":"Jun","value":704},{"label":"Jul","value":633},{"label":"Ago","value":765},{"label":"Set","value":687},{"label":"Out","value":692},{"label":"Nov","value":840},{"label":"Dez","value":612}];
const MX = 957;
