...
const PAGE = "Link Budget";
const KPIS = [{"l":"Total Satellite Ops","v":"2.367","t":"+4.0%","d":"up"},{"l":"Link Budget Ativos","v":"€40305","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.3%","d":"up"}];
const COLS = ["ID","Link Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Satellite Ops #001","€ 41344.58","4.229","1.933","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Satellite Ops #002","€ 14226.44","6.689","2.797","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Satellite Ops #003","€ 12842.40","7.499","2.335","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Satellite Ops #004","€ 13527.60","4.420","2.740","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Satellite Ops #005","€ 26498.04","2.514","1.260","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":780},{"label":"Mar","value":921},{"label":"Abr","value":593},{"label":"Mai","value":682},{"label":"Jun","value":732},{"label":"Jul","value":608},{"label":"Ago","value":874},{"label":"Set","value":617},{"label":"Out","value":967},{"label":"Nov","value":918},{"label":"Dez","value":793}];
const MX = 967;
