...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.605","t":"+2.7%","d":"up"},{"l":"Queries/Dia","v":"2748","t":"-4.1%","d":"down"},{"l":"Dados Processados (GB)","v":"4.285","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.622","t":"+4.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","450","2026-01-27","3.845","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4139","2026-01-05","5.384","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","916","2026-03-06","2.737","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4719","2026-01-01","6.389","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3727","2026-03-18","6.387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":272},{"label":"Mar","value":539},{"label":"Abr","value":298},{"label":"Mai","value":326},{"label":"Jun","value":422},{"label":"Jul","value":622},{"label":"Ago","value":565},{"label":"Set","value":604},{"label":"Out","value":662},{"label":"Nov","value":357},{"label":"Dez","value":538}];
const MX = 662;
