...
const PAGE = "Order";
const KPIS = [{"l":"Total Cannabis Wholesale","v":"266","t":"+11.8%","d":"up"},{"l":"Order Ativos","v":"3.633","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"69","t":"+9.4%","d":"up"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Wholesale #001","Cannabis Wholesale #002","4.858","7.632","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Wholesale #002","Cannabis Wholesale #003","8.998","4.954","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Wholesale #003","Cannabis Wholesale #004","7.722","4.775","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Wholesale #004","Cannabis Wholesale #005","4.207","8.382","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Wholesale #005","Cannabis Wholesale #001","864","2.476","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":982},{"label":"Mar","value":675},{"label":"Abr","value":862},{"label":"Mai","value":1018},{"label":"Jun","value":724},{"label":"Jul","value":817},{"label":"Ago","value":645},{"label":"Set","value":956},{"label":"Out","value":852},{"label":"Nov","value":870},{"label":"Dez","value":965}];
const MX = 1018;
