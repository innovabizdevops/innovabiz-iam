...
const ACCENT = "#14532d";
const MODULE = "Cannabis Wholesale";
const PAGE = "Logistics";
const KPIS = [{"l":"Total Cannabis Wholesale","v":"3.552","t":"+4.7%","d":"up"},{"l":"Logistics Ativos","v":"4.857","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"91.6%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"59","t":"+6.3%","d":"up"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Wholesale #001","Cannabis Wholesale #002","3.900","7.898","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Wholesale #002","Cannabis Wholesale #003","5.515","1.822","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Wholesale #003","Cannabis Wholesale #004","4.057","3.987","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Wholesale #004","Cannabis Wholesale #005","1.290","5.902","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Wholesale #005","Cannabis Wholesale #001","1.010","9.080","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":609},{"label":"Mar","value":695},{"label":"Abr","value":735},{"label":"Mai","value":829},{"label":"Jun","value":909},{"label":"Jul","value":872},{"label":"Ago","value":596},{"label":"Set","value":580},{"label":"Out","value":726},{"label":"Nov","value":898},{"label":"Dez","value":638}];
const MX = 909;
