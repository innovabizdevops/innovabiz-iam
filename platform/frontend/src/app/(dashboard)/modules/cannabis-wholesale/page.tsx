...
/* ═══ Cannabis Wholesale — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "5187", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2014", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€222K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "354900287", cells: ["CAN-4287", "Cannabis Wholesale Item 1", "8/12/2026", "€387"], status: "active" as const },
    { id: "354903858", cells: ["CAN-7858", "Cannabis Wholesale Item 2", "23/7/2026", "€3958"], status: "pending" as const },
    { id: "354907429", cells: ["CAN-2429", "Cannabis Wholesale Item 3", "10/2/2026", "€7529"], status: "completed" as const },
    { id: "354911000", cells: ["CAN-6000", "Cannabis Wholesale Item 4", "25/9/2026", "€11 100"], status: "warning" as const },
    { id: "354914571", cells: ["CAN-9571", "Cannabis Wholesale Item 5", "12/4/2026", "€14 671"], status: "active" as const },
];
...
export default function CannabisWholesalePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Wholesale</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Wholesale</p>
                    </div>
                </div>
