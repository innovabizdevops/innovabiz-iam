...
const PAGE = "Credit";
const KPIS = [{"l":"Integrações Ativas","v":"5.586","t":"-4.1%","d":"down"},{"l":"Chamadas/Hora","v":"1158","t":"+5.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.5%","t":"+9.3%","d":"up"},{"l":"Latência Média (ms)","v":"185ms","t":"+17.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.732","6.689","95.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","920","5.555","90.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.487","7.081","96.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.610","8.660","86.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.161","6.489","78.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1078},{"label":"Fev","value":1031},{"label":"Mar","value":978},{"label":"Abr","value":895},{"label":"Mai","value":802},{"label":"Jun","value":1089},{"label":"Jul","value":887},{"label":"Ago","value":954},{"label":"Set","value":1016},{"label":"Out","value":947},{"label":"Nov","value":958},{"label":"Dez","value":997}];
const MX = 1089;
