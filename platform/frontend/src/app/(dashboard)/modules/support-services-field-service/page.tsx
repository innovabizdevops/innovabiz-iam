...
export default function SupportServicesFieldServicePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Support Services Field Service</h1><p className="text-sm text-muted-foreground">Support Services Field Service • iBOS Enterprise</p></div>
