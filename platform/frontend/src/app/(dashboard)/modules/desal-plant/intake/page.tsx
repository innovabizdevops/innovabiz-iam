...
const PAGE = "Intake";
const KPIS = [{"l":"Total Desal Plant","v":"5.864","t":"+10.8%","d":"up"},{"l":"Intake Ativos","v":"5.500","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"67","t":"-4.2%","d":"down"}];
const COLS = ["ID","Intake","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Desal Plant #001","Desal Plant #002","1.136","4.069","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Desal Plant #002","Desal Plant #003","3.831","857","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Desal Plant #003","Desal Plant #004","5.466","9.053","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Desal Plant #004","Desal Plant #005","6.694","7.126","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Desal Plant #005","Desal Plant #001","7.798","815","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":699},{"label":"Mar","value":714},{"label":"Abr","value":708},{"label":"Mai","value":873},{"label":"Jun","value":604},{"label":"Jul","value":677},{"label":"Ago","value":845},{"label":"Set","value":717},{"label":"Out","value":924},{"label":"Nov","value":804},{"label":"Dez","value":844}];
const MX = 924;
