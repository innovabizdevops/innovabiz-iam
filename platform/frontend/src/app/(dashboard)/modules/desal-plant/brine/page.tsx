...
const PAGE = "Brine";
const KPIS = [{"l":"Total Desal Plant","v":"1.564","t":"-1.9%","d":"down"},{"l":"Brine Ativos","v":"1.754","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"84.7%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+12.5%","d":"up"}];
const COLS = ["ID","Brine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Desal Plant #001","Desal Plant #002","965","1.015","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Desal Plant #002","Desal Plant #003","1.544","1.904","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Desal Plant #003","Desal Plant #004","4.378","3.768","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Desal Plant #004","Desal Plant #005","6.634","1.301","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Desal Plant #005","Desal Plant #001","4.419","1.059","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":799},{"label":"Mar","value":599},{"label":"Abr","value":724},{"label":"Mai","value":660},{"label":"Jun","value":825},{"label":"Jul","value":693},{"label":"Ago","value":793},{"label":"Set","value":599},{"label":"Out","value":774},{"label":"Nov","value":798},{"label":"Dez","value":727}];
const MX = 825;
