...
const PAGE = "RO System";
const KPIS = [{"l":"Total Desal Plant","v":"2.173","t":"-4.1%","d":"down"},{"l":"RO System Ativos","v":"2.515","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+3.0%","d":"up"}];
const COLS = ["ID","RO System","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Desal Plant #001","Desal Plant #002","6.055","3.951","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Desal Plant #002","Desal Plant #003","6.089","498","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Desal Plant #003","Desal Plant #004","5.787","5.000","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Desal Plant #004","Desal Plant #005","6.872","4.235","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Desal Plant #005","Desal Plant #001","5.622","147","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":744},{"label":"Mar","value":524},{"label":"Abr","value":605},{"label":"Mai","value":819},{"label":"Jun","value":772},{"label":"Jul","value":738},{"label":"Ago","value":743},{"label":"Set","value":696},{"label":"Out","value":499},{"label":"Nov","value":607},{"label":"Dez","value":518}];
const MX = 819;
