...
const PAGE = "Energy";
const KPIS = [{"l":"Total Desal Plant","v":"6.680","t":"+1.4%","d":"up"},{"l":"Energy Ativos","v":"4.187","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+3.0%","d":"up"}];
const COLS = ["ID","Energy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Desal Plant #001","Desal Plant #002","1.750","2.457","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Desal Plant #002","Desal Plant #003","3.987","2.722","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Desal Plant #003","Desal Plant #004","2.059","6.437","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Desal Plant #004","Desal Plant #005","6.801","559","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Desal Plant #005","Desal Plant #001","4.766","4.843","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":554},{"label":"Mar","value":578},{"label":"Abr","value":609},{"label":"Mai","value":560},{"label":"Jun","value":653},{"label":"Jul","value":783},{"label":"Ago","value":763},{"label":"Set","value":659},{"label":"Out","value":784},{"label":"Nov","value":906},{"label":"Dez","value":865}];
const MX = 906;
