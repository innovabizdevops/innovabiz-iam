...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.753","t":"+14.9%","d":"up"},{"l":"Contratos (€M)","v":"€42.0M","t":"+0.9%","d":"up"},{"l":"On-Time Delivery (%)","v":"89.4%","t":"+8.1%","d":"up"},{"l":"Score Médio","v":"58","t":"-3.5%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","70.9%","€ 8158.23","3.378","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","92.4%","€ 24328.04","642","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","96.4%","€ 10497.71","4.927","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","96.1%","€ 20533.87","3.695","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","96.1%","€ 39538.96","4.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":833},{"label":"Mar","value":926},{"label":"Abr","value":840},{"label":"Mai","value":792},{"label":"Jun","value":661},{"label":"Jul","value":840},{"label":"Ago","value":848},{"label":"Set","value":896},{"label":"Out","value":679},{"label":"Nov","value":880},{"label":"Dez","value":732}];
const MX = 926;
