...
const ACCENT = "#6366f1";
const MODULE = "Hotel Engineering";
const PAGE = "Energy";
const KPIS = [{"l":"Quartos Ocupados","v":"4.502","t":"+13.7%","d":"up"},{"l":"RevPAR (€)","v":"€24228","t":"+3.2%","d":"up"},{"l":"Ocupação (%)","v":"94.8%","t":"+6.7%","d":"up"},{"l":"Guest Satisfaction","v":"675","t":"+3.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.018","2026-02-06","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.368","2026-02-27","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","157","2026-02-06","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.230","2026-01-02","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.122","2026-01-13","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1009},{"label":"Fev","value":1001},{"label":"Mar","value":916},{"label":"Abr","value":926},{"label":"Mai","value":908},{"label":"Jun","value":1058},{"label":"Jul","value":685},{"label":"Ago","value":1042},{"label":"Set","value":963},{"label":"Out","value":805},{"label":"Nov","value":679},{"label":"Dez","value":809}];
const MX = 1058;
