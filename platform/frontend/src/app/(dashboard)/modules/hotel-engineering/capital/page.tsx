...
const PAGE = "Capital";
const KPIS = [{"l":"Quartos Ocupados","v":"7.104","t":"+3.1%","d":"up"},{"l":"RevPAR (€)","v":"€75828","t":"-0.7%","d":"down"},{"l":"Ocupação (%)","v":"94.8%","t":"+11.8%","d":"up"},{"l":"Guest Satisfaction","v":"5.063","t":"+5.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.410","2026-01-22","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.530","2026-01-15","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.500","2026-01-15","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","862","2026-03-12","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.557","2026-01-16","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":576},{"label":"Mar","value":926},{"label":"Abr","value":853},{"label":"Mai","value":690},{"label":"Jun","value":762},{"label":"Jul","value":673},{"label":"Ago","value":653},{"label":"Set","value":758},{"label":"Out","value":892},{"label":"Nov","value":763},{"label":"Dez","value":919}];
const MX = 926;
