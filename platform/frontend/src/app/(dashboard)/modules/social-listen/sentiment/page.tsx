...
const ACCENT = "#4338ca";
const MODULE = "Social Listening";
const PAGE = "Sentiment AI";
const KPIS = [{"l":"Dashboards Ativos","v":"2.265","t":"+1.0%","d":"up"},{"l":"Queries/Dia","v":"976","t":"+2.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.879","t":"+4.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.898","t":"-2.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2526","2026-01-10","2.738","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4743","2026-01-05","7.547","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4418","2026-02-19","951","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1169","2026-02-14","1.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4859","2026-03-03","6.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":588},{"label":"Mar","value":831},{"label":"Abr","value":794},{"label":"Mai","value":732},{"label":"Jun","value":900},{"label":"Jul","value":940},{"label":"Ago","value":657},{"label":"Set","value":732},{"label":"Out","value":776},{"label":"Nov","value":940},{"label":"Dez","value":834}];
const MX = 940;
