...
const PAGE = "TikTok Track";
const KPIS = [{"l":"Total Social Listen","v":"5.486","t":"+16.1%","d":"up"},{"l":"TikTok Track Ativos","v":"2.206","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"63","t":"+2.0%","d":"up"}];
const COLS = ["ID","TikTok Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Listen #001","Social Listen #002","2.932","3.523","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Social Listen #002","Social Listen #003","1.898","8.994","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Listen #003","Social Listen #004","7.940","6.835","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Social Listen #004","Social Listen #005","4.381","7.633","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Listen #005","Social Listen #001","6.674","4.510","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":556},{"label":"Mar","value":695},{"label":"Abr","value":678},{"label":"Mai","value":609},{"label":"Jun","value":618},{"label":"Jul","value":734},{"label":"Ago","value":817},{"label":"Set","value":638},{"label":"Out","value":768},{"label":"Nov","value":593},{"label":"Dez","value":636}];
const MX = 817;
