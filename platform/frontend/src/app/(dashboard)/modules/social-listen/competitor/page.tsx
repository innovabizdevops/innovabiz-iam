...
const PAGE = "Competitor Mon";
const KPIS = [{"l":"Total Social Listen","v":"114","t":"-2.2%","d":"down"},{"l":"Competitor Mon Ativos","v":"2.667","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"55","t":"-0.9%","d":"down"}];
const COLS = ["ID","Competitor Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Listen #001","Social Listen #002","8.447","7.419","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Social Listen #002","Social Listen #003","3.029","248","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Listen #003","Social Listen #004","5.706","890","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Social Listen #004","Social Listen #005","3.373","2.750","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Listen #005","Social Listen #001","3.347","5.765","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":527},{"label":"Mar","value":458},{"label":"Abr","value":346},{"label":"Mai","value":261},{"label":"Jun","value":388},{"label":"Jul","value":417},{"label":"Ago","value":412},{"label":"Set","value":503},{"label":"Out","value":479},{"label":"Nov","value":298},{"label":"Dez","value":252}];
const MX = 527;
