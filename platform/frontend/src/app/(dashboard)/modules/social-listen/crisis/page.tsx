...
const PAGE = "Crisis Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.452","t":"-4.8%","d":"down"},{"l":"Taxa Entrega (%)","v":"86.7%","t":"+14.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"76.9%","t":"+13.2%","d":"up"},{"l":"Escalações","v":"3.355","t":"+5.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","900","72.6%","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.968","84.7%","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.256","88.7%","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","271","88.4%","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","3.679","92.5%","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":345},{"label":"Fev","value":288},{"label":"Mar","value":522},{"label":"Abr","value":508},{"label":"Mai","value":259},{"label":"Jun","value":605},{"label":"Jul","value":601},{"label":"Ago","value":430},{"label":"Set","value":481},{"label":"Out","value":366},{"label":"Nov","value":488},{"label":"Dez","value":569}];
const MX = 605;
