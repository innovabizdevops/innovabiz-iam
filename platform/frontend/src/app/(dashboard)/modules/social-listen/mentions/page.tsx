...
const PAGE = "Mention Track";
const KPIS = [{"l":"Total Social Listen","v":"2.926","t":"+7.8%","d":"up"},{"l":"Mention Track Ativos","v":"4.589","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"72","t":"-1.2%","d":"down"}];
const COLS = ["ID","Mention Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Listen #001","Social Listen #002","3.440","2.620","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Social Listen #002","Social Listen #003","8.714","451","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Listen #003","Social Listen #004","6.680","6.901","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Social Listen #004","Social Listen #005","6.780","7.760","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Listen #005","Social Listen #001","7.631","5.936","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":826},{"label":"Mar","value":730},{"label":"Abr","value":528},{"label":"Mai","value":475},{"label":"Jun","value":740},{"label":"Jul","value":551},{"label":"Ago","value":507},{"label":"Set","value":533},{"label":"Out","value":729},{"label":"Nov","value":513},{"label":"Dez","value":719}];
const MX = 826;
