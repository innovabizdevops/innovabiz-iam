...
const PAGE = "Trend Detect";
const KPIS = [{"l":"Total Social Listen","v":"4.419","t":"+1.8%","d":"up"},{"l":"Trend Detect Ativos","v":"7.920","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"68","t":"+13.5%","d":"up"}];
const COLS = ["ID","Trend Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Social Listen #001","Social Listen #002","6.446","8.601","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Social Listen #002","Social Listen #003","2.616","6.298","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Social Listen #003","Social Listen #004","3.374","1.066","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Social Listen #004","Social Listen #005","3.838","7.172","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Social Listen #005","Social Listen #001","1.091","6.624","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":342},{"label":"Mar","value":271},{"label":"Abr","value":523},{"label":"Mai","value":551},{"label":"Jun","value":540},{"label":"Jul","value":437},{"label":"Ago","value":313},{"label":"Set","value":251},{"label":"Out","value":484},{"label":"Nov","value":561},{"label":"Dez","value":438}];
const MX = 561;
