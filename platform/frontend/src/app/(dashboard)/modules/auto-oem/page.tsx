...
/* ═══ Automotive OEM Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "7344", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "230", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€145K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1011698144", cells: ["AUT-9144", "Automotive OEM Platform Item 1", "17/9/2026", "€48 244"], status: "active" as const },
    { id: "1011701715", cells: ["AUT-3715", "Automotive OEM Platform Item 2", "4/4/2026", "€1815"], status: "pending" as const },
    { id: "1011705286", cells: ["AUT-7286", "Automotive OEM Platform Item 3", "19/11/2026", "€5386"], status: "completed" as const },
    { id: "1011708857", cells: ["AUT-1857", "Automotive OEM Platform Item 4", "6/6/2026", "€8957"], status: "warning" as const },
    { id: "1011712428", cells: ["AUT-5428", "Automotive OEM Platform Item 5", "21/1/2026", "€12 528"], status: "active" as const },
];
...
export default function AutomotiveOemPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Automotive OEM Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Automotive OEM Platform</p>
                    </div>
                </div>
