...
const ACCENT = "#1e3a5f";
const MODULE = "Automotive OEM Platform";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.690","t":"+13.5%","d":"up"},{"l":"Submissões/Dia","v":"1371","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"3.810","t":"-5.3%","d":"down"},{"l":"Templates","v":"1.793","t":"+4.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.417","2026-03-21","2.099","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.011","2026-03-18","2.835","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.806","2026-02-16","2.320","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.445","2026-02-17","7.653","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.550","2026-02-25","1.171","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1042},{"label":"Fev","value":836},{"label":"Mar","value":758},{"label":"Abr","value":941},{"label":"Mai","value":1059},{"label":"Jun","value":1029},{"label":"Jul","value":756},{"label":"Ago","value":943},{"label":"Set","value":791},{"label":"Out","value":856},{"label":"Nov","value":957},{"label":"Dez","value":1009}];
const MX = 1059;
