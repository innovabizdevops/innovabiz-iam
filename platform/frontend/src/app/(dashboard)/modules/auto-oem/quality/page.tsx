...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.905","t":"+8.3%","d":"up"},{"l":"NC Abertas","v":"3.652","t":"+5.5%","d":"up"},{"l":"Conformidade (%)","v":"68.0%","t":"+10.4%","d":"up"},{"l":"CAPAs Pendentes","v":"173","t":"+4.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.501","72.7%","7.815","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.963","88.2%","5.522","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.596","75.2%","6.268","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.431","97.4%","7.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.402","84.9%","6.296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":569},{"label":"Mar","value":896},{"label":"Abr","value":913},{"label":"Mai","value":613},{"label":"Jun","value":627},{"label":"Jul","value":852},{"label":"Ago","value":909},{"label":"Set","value":786},{"label":"Out","value":879},{"label":"Nov","value":731},{"label":"Dez","value":664}];
const MX = 913;
