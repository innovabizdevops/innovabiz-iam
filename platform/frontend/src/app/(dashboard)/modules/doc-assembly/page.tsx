...
export default function DocAssemblyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Doc Assembly</h1><p className="text-sm text-muted-foreground">Doc Assembly • iBOS Enterprise</p></div>
