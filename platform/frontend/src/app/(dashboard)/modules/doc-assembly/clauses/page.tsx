...
const ACCENT = "#1e40af";
const MODULE = "Document Assembly";
const PAGE = "Clause Library";
const KPIS = [{"l":"Contratos Ativos","v":"4.724","t":"+12.2%","d":"up"},{"l":"Valor Total (€M)","v":"€3.5M","t":"+7.4%","d":"up"},{"l":"Renovações Próx. 30d","v":"7.262","t":"-5.8%","d":"down"},{"l":"Obrigações Pendentes","v":"6.041","t":"-1.3%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 18865.35","2026-03-13","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 22640.28","2026-01-10","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 18372.04","2026-01-25","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 48068.16","2026-01-26","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 35860.10","2026-01-22","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":559},{"label":"Mar","value":632},{"label":"Abr","value":641},{"label":"Mai","value":789},{"label":"Jun","value":666},{"label":"Jul","value":588},{"label":"Ago","value":677},{"label":"Set","value":719},{"label":"Out","value":748},{"label":"Nov","value":500},{"label":"Dez","value":768}];
const MX = 789;
