...
const PAGE = "Template Engine";
const KPIS = [{"l":"Formulários Ativos","v":"362","t":"+1.7%","d":"up"},{"l":"Submissões/Dia","v":"162","t":"+7.0%","d":"up"},{"l":"Documentos Gerados","v":"5.051","t":"+1.7%","d":"up"},{"l":"Templates","v":"1.647","t":"-4.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.260","2026-03-24","6.098","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.075","2026-01-14","1.623","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.953","2026-03-10","2.884","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.183","2026-01-17","474","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.087","2026-01-07","8.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":744},{"label":"Mar","value":866},{"label":"Abr","value":992},{"label":"Mai","value":804},{"label":"Jun","value":984},{"label":"Jul","value":996},{"label":"Ago","value":1002},{"label":"Set","value":802},{"label":"Out","value":917},{"label":"Nov","value":908},{"label":"Dez","value":695}];
const MX = 1002;
