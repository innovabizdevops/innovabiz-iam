...
const PAGE = "Batch Generate";
const KPIS = [{"l":"Total Doc Assembly","v":"2.932","t":"+3.8%","d":"up"},{"l":"Batch Generate Ativos","v":"2.232","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"92.0%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"58","t":"+2.2%","d":"up"}];
const COLS = ["ID","Batch Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Doc Assembly #001","Doc Assembly #002","6.326","4.015","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Doc Assembly #002","Doc Assembly #003","8.642","8.532","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Doc Assembly #003","Doc Assembly #004","7.147","503","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Doc Assembly #004","Doc Assembly #005","693","1.613","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Doc Assembly #005","Doc Assembly #001","980","6.993","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":861},{"label":"Mar","value":705},{"label":"Abr","value":773},{"label":"Mai","value":487},{"label":"Jun","value":647},{"label":"Jul","value":701},{"label":"Ago","value":746},{"label":"Set","value":790},{"label":"Out","value":834},{"label":"Nov","value":686},{"label":"Dez","value":588}];
const MX = 861;
