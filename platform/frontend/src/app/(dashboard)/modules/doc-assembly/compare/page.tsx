...
const PAGE = "Version Compare";
const KPIS = [{"l":"Formulários Ativos","v":"256","t":"+1.3%","d":"up"},{"l":"Submissões/Dia","v":"2470","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"7.556","t":"-5.5%","d":"down"},{"l":"Templates","v":"3.293","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.737","2026-02-01","4.442","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.891","2026-02-17","7.312","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.135","2026-03-10","2.265","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.831","2026-02-02","7.576","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.703","2026-01-05","6.890","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":724},{"label":"Mar","value":741},{"label":"Abr","value":497},{"label":"Mai","value":794},{"label":"Jun","value":543},{"label":"Jul","value":730},{"label":"Ago","value":791},{"label":"Set","value":828},{"label":"Out","value":632},{"label":"Nov","value":696},{"label":"Dez","value":788}];
const MX = 828;
