...
const ACCENT = "#064e3b";
const MODULE = "Plastic Recycling";
const PAGE = "Sort";
const KPIS = [{"l":"Total Plastic Recycle","v":"7.728","t":"+11.1%","d":"up"},{"l":"Sort Ativos","v":"3.742","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.8%","d":"up"}];
const COLS = ["ID","Sort","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plastic Recycle #001","Plastic Recycle #002","7.345","249","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Plastic Recycle #002","Plastic Recycle #003","7.046","186","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Plastic Recycle #003","Plastic Recycle #004","415","7.178","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Plastic Recycle #004","Plastic Recycle #005","2.511","5.429","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plastic Recycle #005","Plastic Recycle #001","8.516","8.648","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":1028},{"label":"Mar","value":674},{"label":"Abr","value":857},{"label":"Mai","value":945},{"label":"Jun","value":830},{"label":"Jul","value":1012},{"label":"Ago","value":971},{"label":"Set","value":863},{"label":"Out","value":669},{"label":"Nov","value":1002},{"label":"Dez","value":912}];
const MX = 1028;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#064e3b'}}>AI</span></h1>
                </div>
