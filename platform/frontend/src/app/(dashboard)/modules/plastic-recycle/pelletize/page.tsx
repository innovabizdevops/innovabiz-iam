...
const PAGE = "Pelletize";
const KPIS = [{"l":"Total Plastic Recycle","v":"7.669","t":"+15.2%","d":"up"},{"l":"Pelletize Ativos","v":"2.267","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"79.5%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+11.8%","d":"up"}];
const COLS = ["ID","Pelletize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plastic Recycle #001","Plastic Recycle #002","7.971","7.965","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Plastic Recycle #002","Plastic Recycle #003","350","664","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Plastic Recycle #003","Plastic Recycle #004","6.181","408","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Plastic Recycle #004","Plastic Recycle #005","1.003","2.125","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plastic Recycle #005","Plastic Recycle #001","5.673","7.590","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":619},{"label":"Mar","value":645},{"label":"Abr","value":528},{"label":"Mai","value":449},{"label":"Jun","value":757},{"label":"Jul","value":745},{"label":"Ago","value":737},{"label":"Set","value":512},{"label":"Out","value":745},{"label":"Nov","value":682},{"label":"Dez","value":378}];
const MX = 757;
...
export default function PelletizePage() {
    return (
