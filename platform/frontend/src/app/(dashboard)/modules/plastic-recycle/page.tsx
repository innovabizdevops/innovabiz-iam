...
const KPIS = [
    ...
    { label: "Ativos", value: "1997", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€338K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1300109773", cells: ["PLA-6773", "Plastic Recycling Item 1", "26/2/2026", "€9873"], status: "active" as const },
    { id: "1300113344", cells: ["PLA-1344", "Plastic Recycling Item 2", "13/9/2026", "€13 444"], status: "pending" as const },
    { id: "1300116915", cells: ["PLA-4915", "Plastic Recycling Item 3", "28/4/2026", "€17 015"], status: "completed" as const },
    { id: "1300120486", cells: ["PLA-8486", "Plastic Recycling Item 4", "15/11/2026", "€20 586"], status: "warning" as const },
    { id: "1300124057", cells: ["PLA-3057", "Plastic Recycling Item 5", "2/6/2026", "€24 157"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Plastic Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Plastic Recycling</p>
                    </div>
                </div>
