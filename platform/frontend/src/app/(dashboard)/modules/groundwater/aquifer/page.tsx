...
const PAGE = "Aquifer";
const KPIS = [{"l":"Total Groundwater","v":"134","t":"+3.5%","d":"up"},{"l":"Aquifer Ativos","v":"114","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"64","t":"-4.6%","d":"down"}];
const COLS = ["ID","Aquifer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Groundwater #001","Groundwater #002","8.835","6.367","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Groundwater #002","Groundwater #003","1.688","7.501","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Groundwater #003","Groundwater #004","909","246","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Groundwater #004","Groundwater #005","4.446","4.407","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Groundwater #005","Groundwater #001","5.429","7.792","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":809},{"label":"Mar","value":639},{"label":"Abr","value":881},{"label":"Mai","value":845},{"label":"Jun","value":805},{"label":"Jul","value":548},{"label":"Ago","value":695},{"label":"Set","value":864},{"label":"Out","value":542},{"label":"Nov","value":728},{"label":"Dez","value":601}];
const MX = 881;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#155e75'}}>GIS</span></h1>
                </div>
