...
const PAGE = "Report";
const KPIS = [{"l":"Dispositivos Online","v":"8.156","t":"+14.7%","d":"up"},{"l":"Dados/Min (MB)","v":"5.341","t":"+15.4%","d":"up"},{"l":"Alertas Ativos","v":"7.855","t":"+9.8%","d":"up"},{"l":"Uptime (%)","v":"67.2%","t":"-4.3%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.349","1.830","1.332","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","347","6.055","3.284","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.520","5.561","4.084","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.285","923","6.552","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.340","3.453","1.537","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":699},{"label":"Mar","value":655},{"label":"Abr","value":1003},{"label":"Mai","value":705},{"label":"Jun","value":689},{"label":"Jul","value":816},{"label":"Ago","value":923},{"label":"Set","value":939},{"label":"Out","value":801},{"label":"Nov","value":714},{"label":"Dez","value":1007}];
const MX = 1007;
