...
/* ═══ SCADA Platform — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "513", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1821", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€50K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1380981113", cells: ["SCA-4113", "SCADA Platform Item 1", "2/6/2026", "€31 213"], status: "active" as const },
    { id: "1380984684", cells: ["SCA-7684", "SCADA Platform Item 2", "17/1/2026", "€34 784"], status: "pending" as const },
    { id: "1380988255", cells: ["SCA-2255", "SCADA Platform Item 3", "4/8/2026", "€38 355"], status: "completed" as const },
    { id: "1380991826", cells: ["SCA-5826", "SCADA Platform Item 4", "19/3/2026", "€41 926"], status: "warning" as const },
    { id: "1380995397", cells: ["SCA-9397", "SCADA Platform Item 5", "6/10/2026", "€45 497"], status: "active" as const },
];
...
export default function ScadaPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SCADA Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SCADA Platform</p>
                    </div>
                </div>
