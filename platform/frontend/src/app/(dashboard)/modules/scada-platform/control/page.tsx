...
const PAGE = "Control";
const KPIS = [{"l":"Dispositivos Online","v":"3.088","t":"+7.4%","d":"up"},{"l":"Dados/Min (MB)","v":"1.846","t":"+7.1%","d":"up"},{"l":"Alertas Ativos","v":"1.695","t":"+9.3%","d":"up"},{"l":"Uptime (%)","v":"82.9%","t":"+1.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","382","5.544","2.820","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.379","4.505","9.066","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.783","7.645","2.128","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","153","5.029","8.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.699","3.505","1.853","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":745},{"label":"Mar","value":873},{"label":"Abr","value":768},{"label":"Mai","value":992},{"label":"Jun","value":719},{"label":"Jul","value":962},{"label":"Ago","value":994},{"label":"Set","value":832},{"label":"Out","value":850},{"label":"Nov","value":657},{"label":"Dez","value":943}];
const MX = 994;
