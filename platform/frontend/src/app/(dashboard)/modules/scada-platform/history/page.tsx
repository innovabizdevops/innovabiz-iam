...
const PAGE = "History";
const KPIS = [{"l":"Dispositivos Online","v":"3.023","t":"+15.1%","d":"up"},{"l":"Dados/Min (MB)","v":"8.840","t":"+1.3%","d":"up"},{"l":"Alertas Ativos","v":"6.803","t":"+9.3%","d":"up"},{"l":"Uptime (%)","v":"84.1%","t":"+12.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.327","2.504","7.146","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.451","1.153","668","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.720","5.744","6.877","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","9.027","5.093","5.985","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.133","2.839","8.896","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":240},{"label":"Fev","value":396},{"label":"Mar","value":578},{"label":"Abr","value":328},{"label":"Mai","value":323},{"label":"Jun","value":328},{"label":"Jul","value":220},{"label":"Ago","value":387},{"label":"Set","value":254},{"label":"Out","value":373},{"label":"Nov","value":362},{"label":"Dez","value":442}];
const MX = 578;
