...
const ACCENT = "#b45309";
const MODULE = "SCADA Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Dispositivos Online","v":"3.719","t":"+4.8%","d":"up"},{"l":"Dados/Min (MB)","v":"3.044","t":"+9.7%","d":"up"},{"l":"Alertas Ativos","v":"5.418","t":"+10.7%","d":"up"},{"l":"Uptime (%)","v":"86.0%","t":"+6.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.003","2.044","2.163","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.326","4.595","2.607","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.451","3.699","7.147","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.650","1.776","8.873","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.181","1.835","3.289","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":251},{"label":"Fev","value":560},{"label":"Mar","value":272},{"label":"Abr","value":322},{"label":"Mai","value":265},{"label":"Jun","value":294},{"label":"Jul","value":409},{"label":"Ago","value":518},{"label":"Set","value":601},{"label":"Out","value":444},{"label":"Nov","value":326},{"label":"Dez","value":610}];
const MX = 610;
