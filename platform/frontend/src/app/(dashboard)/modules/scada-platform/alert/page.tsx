...
const PAGE = "Alert";
const KPIS = [{"l":"Dispositivos Online","v":"6.434","t":"+10.1%","d":"up"},{"l":"Dados/Min (MB)","v":"7.780","t":"+14.3%","d":"up"},{"l":"Alertas Ativos","v":"5.827","t":"+1.4%","d":"up"},{"l":"Uptime (%)","v":"66.2%","t":"+11.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.323","6.371","1.545","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.853","1.228","3.100","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.268","5.788","5.964","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.060","163","3.934","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.086","617","1.905","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":587},{"label":"Mar","value":513},{"label":"Abr","value":456},{"label":"Mai","value":433},{"label":"Jun","value":482},{"label":"Jul","value":307},{"label":"Ago","value":331},{"label":"Set","value":487},{"label":"Out","value":229},{"label":"Nov","value":283},{"label":"Dez","value":217}];
const MX = 587;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>RTM</span></h1>
                </div>
