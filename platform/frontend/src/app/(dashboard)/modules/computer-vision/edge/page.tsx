...
const ACCENT = "#8b5cf6";
const MODULE = "Computer Vision Platform";
const PAGE = "Edge";
const KPIS = [{"l":"Total Computer Vision","v":"2.842","t":"+13.5%","d":"up"},{"l":"Edge Ativos","v":"1.819","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"66","t":"+6.5%","d":"up"}];
const COLS = ["ID","Edge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Computer Vision #001","Computer Vision #002","1.637","8.000","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Computer Vision #002","Computer Vision #003","4.893","5.776","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Computer Vision #003","Computer Vision #004","1.754","6.133","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Computer Vision #004","Computer Vision #005","162","4.681","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Computer Vision #005","Computer Vision #001","4.659","6.807","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":662},{"label":"Mar","value":717},{"label":"Abr","value":650},{"label":"Mai","value":1025},{"label":"Jun","value":964},{"label":"Jul","value":822},{"label":"Ago","value":922},{"label":"Set","value":703},{"label":"Out","value":657},{"label":"Nov","value":767},{"label":"Dez","value":938}];
const MX = 1025;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>EDGE3</span></h1>
                </div>
