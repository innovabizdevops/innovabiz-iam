...
/* ═══ Computer Vision Platform — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "8313", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "176", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€397K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "968513", cells: ["COM-6513", "Computer Vision Platform Item 1", "22/6/2026", "€18 613"], status: "active" as const },
    { id: "972084", cells: ["COM-1084", "Computer Vision Platform Item 2", "9/1/2026", "€22 184"], status: "pending" as const },
    { id: "975655", cells: ["COM-4655", "Computer Vision Platform Item 3", "24/8/2026", "€25 755"], status: "completed" as const },
    { id: "979226", cells: ["COM-8226", "Computer Vision Platform Item 4", "11/3/2026", "€29 326"], status: "warning" as const },
    { id: "982797", cells: ["COM-2797", "Computer Vision Platform Item 5", "26/10/2026", "€32 897"], status: "active" as const },
];
...
export default function ComputerVisionPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Computer Vision Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Computer Vision Platform</p>
                    </div>
                </div>
