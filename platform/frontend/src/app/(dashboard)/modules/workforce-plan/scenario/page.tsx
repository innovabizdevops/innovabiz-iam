...
const PAGE = "Scenario";
const KPIS = [{"l":"eNPS","v":"71","t":"+6.7%","d":"up"},{"l":"Engagement (%)","v":"70.3%","t":"+16.4%","d":"up"},{"l":"Turnover (%)","v":"85.4%","t":"-5.9%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"6.121","t":"+12.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","465","2026-02-11","57","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.244","2026-03-04","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.540","2026-02-21","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.464","2026-02-12","95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.434","2026-03-23","60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":723},{"label":"Mar","value":750},{"label":"Abr","value":756},{"label":"Mai","value":696},{"label":"Jun","value":782},{"label":"Jul","value":790},{"label":"Ago","value":460},{"label":"Set","value":515},{"label":"Out","value":730},{"label":"Nov","value":490},{"label":"Dez","value":756}];
const MX = 790;
