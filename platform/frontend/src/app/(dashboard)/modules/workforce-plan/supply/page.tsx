...
const PAGE = "Supply";
const KPIS = [{"l":"eNPS","v":"60","t":"+17.5%","d":"up"},{"l":"Engagement (%)","v":"93.5%","t":"+14.4%","d":"up"},{"l":"Turnover (%)","v":"89.5%","t":"-2.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.248","t":"+11.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.464","2026-01-15","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.940","2026-02-03","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.597","2026-01-05","92","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.480","2026-01-28","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.507","2026-01-13","80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":534},{"label":"Mar","value":848},{"label":"Abr","value":611},{"label":"Mai","value":916},{"label":"Jun","value":833},{"label":"Jul","value":558},{"label":"Ago","value":562},{"label":"Set","value":526},{"label":"Out","value":545},{"label":"Nov","value":678},{"label":"Dez","value":702}];
const MX = 916;
