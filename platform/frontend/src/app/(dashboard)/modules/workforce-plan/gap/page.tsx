...
const PAGE = "Gap";
const KPIS = [{"l":"eNPS","v":"84","t":"-5.6%","d":"down"},{"l":"Engagement (%)","v":"69.7%","t":"+5.6%","d":"up"},{"l":"Turnover (%)","v":"90.3%","t":"+1.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.181","t":"+14.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.134","2026-02-22","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.610","2026-03-26","90","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.813","2026-03-11","83","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.040","2026-01-11","55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.900","2026-02-26","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":632},{"label":"Mar","value":744},{"label":"Abr","value":617},{"label":"Mai","value":844},{"label":"Jun","value":541},{"label":"Jul","value":540},{"label":"Ago","value":859},{"label":"Set","value":580},{"label":"Out","value":876},{"label":"Nov","value":769},{"label":"Dez","value":771}];
const MX = 876;
