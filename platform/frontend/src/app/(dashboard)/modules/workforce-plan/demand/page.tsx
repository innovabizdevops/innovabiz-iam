...
const PAGE = "Demand";
const KPIS = [{"l":"eNPS","v":"82","t":"+7.0%","d":"up"},{"l":"Engagement (%)","v":"72.9%","t":"+4.3%","d":"up"},{"l":"Turnover (%)","v":"78.1%","t":"+1.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.255","t":"+5.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","657","2026-01-24","61","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.918","2026-01-11","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.304","2026-01-09","66","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.546","2026-03-15","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.256","2026-01-10","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":476},{"label":"Mar","value":461},{"label":"Abr","value":366},{"label":"Mai","value":411},{"label":"Jun","value":586},{"label":"Jul","value":389},{"label":"Ago","value":507},{"label":"Set","value":429},{"label":"Out","value":550},{"label":"Nov","value":587},{"label":"Dez","value":351}];
const MX = 624;
