...
const PAGE = "Cost";
const KPIS = [{"l":"eNPS","v":"58","t":"+4.1%","d":"up"},{"l":"Engagement (%)","v":"90.0%","t":"+7.6%","d":"up"},{"l":"Turnover (%)","v":"84.4%","t":"+9.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.140","t":"+4.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.981","2026-03-02","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","9.057","2026-01-19","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.402","2026-03-08","62","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.951","2026-01-01","77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.681","2026-01-06","67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":792},{"label":"Mar","value":644},{"label":"Abr","value":828},{"label":"Mai","value":695},{"label":"Jun","value":627},{"label":"Jul","value":656},{"label":"Ago","value":572},{"label":"Set","value":519},{"label":"Out","value":876},{"label":"Nov","value":644},{"label":"Dez","value":821}];
const MX = 876;
