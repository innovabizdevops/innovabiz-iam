...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.886","t":"+1.6%","d":"up"},{"l":"Queries/Dia","v":"373","t":"-3.0%","d":"down"},{"l":"Dados Processados (GB)","v":"4.849","t":"+2.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.796","t":"+17.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2735","2026-02-04","6.423","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3329","2026-02-25","2.653","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4538","2026-03-18","8.644","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","517","2026-01-16","9.061","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3526","2026-03-03","1.661","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1001},{"label":"Fev","value":795},{"label":"Mar","value":678},{"label":"Abr","value":1049},{"label":"Mai","value":837},{"label":"Jun","value":846},{"label":"Jul","value":815},{"label":"Ago","value":786},{"label":"Set","value":962},{"label":"Out","value":1027},{"label":"Nov","value":1060},{"label":"Dez","value":705}];
const MX = 1060;
