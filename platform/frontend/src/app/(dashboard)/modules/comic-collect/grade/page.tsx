...
const PAGE = "Grade";
const KPIS = [{"l":"Total Comic Collect","v":"1.534","t":"+13.2%","d":"up"},{"l":"Grade Ativos","v":"1.637","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"82","t":"+9.0%","d":"up"}];
const COLS = ["ID","Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comic Collect #001","Comic Collect #002","2.375","3.639","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Comic Collect #002","Comic Collect #003","8.640","601","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Comic Collect #003","Comic Collect #004","2.456","1.262","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Comic Collect #004","Comic Collect #005","9.055","478","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comic Collect #005","Comic Collect #001","4.348","5.855","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":411},{"label":"Mar","value":368},{"label":"Abr","value":514},{"label":"Mai","value":668},{"label":"Jun","value":584},{"label":"Jul","value":504},{"label":"Ago","value":560},{"label":"Set","value":567},{"label":"Out","value":719},{"label":"Nov","value":705},{"label":"Dez","value":464}];
const MX = 719;
