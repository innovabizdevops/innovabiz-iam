...
const PAGE = "Appraise";
const KPIS = [{"l":"Total Comic Collect","v":"300","t":"+5.1%","d":"up"},{"l":"Appraise Ativos","v":"9.005","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"91","t":"+8.0%","d":"up"}];
const COLS = ["ID","Appraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comic Collect #001","Comic Collect #002","5.754","7.015","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Comic Collect #002","Comic Collect #003","7.903","8.001","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Comic Collect #003","Comic Collect #004","3.166","2.970","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Comic Collect #004","Comic Collect #005","2.581","9.063","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comic Collect #005","Comic Collect #001","746","4.127","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":707},{"label":"Mar","value":615},{"label":"Abr","value":549},{"label":"Mai","value":769},{"label":"Jun","value":613},{"label":"Jul","value":705},{"label":"Ago","value":689},{"label":"Set","value":611},{"label":"Out","value":782},{"label":"Nov","value":540},{"label":"Dez","value":553}];
const MX = 782;
