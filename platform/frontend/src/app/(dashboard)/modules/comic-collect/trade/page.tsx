...
const ACCENT = "#facc15";
const MODULE = "Comic Book Collectibles";
const PAGE = "Trade";
const KPIS = [{"l":"Total Comic Collect","v":"2.448","t":"+2.5%","d":"up"},{"l":"Trade Ativos","v":"6.274","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+11.6%","d":"up"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comic Collect #001","Comic Collect #002","305","6.899","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Comic Collect #002","Comic Collect #003","4.287","5.989","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Comic Collect #003","Comic Collect #004","1.804","5.536","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Comic Collect #004","Comic Collect #005","6.002","6.006","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comic Collect #005","Comic Collect #001","8.552","7.395","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1010},{"label":"Fev","value":739},{"label":"Mar","value":704},{"label":"Abr","value":876},{"label":"Mai","value":862},{"label":"Jun","value":730},{"label":"Jul","value":707},{"label":"Ago","value":942},{"label":"Set","value":949},{"label":"Out","value":897},{"label":"Nov","value":795},{"label":"Dez","value":684}];
const MX = 1010;
