...
/* ═══ Comic Book Collectibles — Dashboard ═══ */

const ACCENT = "#facc15";

const KPIS = [
    { label: "Total Registos", value: "9851", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1777", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€391K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1630638751", cells: ["COM-1751", "Comic Book Collectibles Item 1", "8/8/2026", "€38 851"], status: "active" as const },
    { id: "1630642322", cells: ["COM-5322", "Comic Book Collectibles Item 2", "23/3/2026", "€42 422"], status: "pending" as const },
    { id: "1630645893", cells: ["COM-8893", "Comic Book Collectibles Item 3", "10/10/2026", "€45 993"], status: "completed" as const },
    { id: "1630649464", cells: ["COM-3464", "Comic Book Collectibles Item 4", "25/5/2026", "€49 564"], status: "warning" as const },
    { id: "1630653035", cells: ["COM-7035", "Comic Book Collectibles Item 5", "12/12/2026", "€3135"], status: "active" as const },
];
...
export default function ComicBookCollectiblesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Comic Book Collectibles</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Comic Book Collectibles</p>
                    </div>
                </div>
