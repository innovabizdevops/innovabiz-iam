...
const PAGE = "Slab";
const KPIS = [{"l":"Tickets Abertos","v":"1.181","t":"-6.0%","d":"down"},{"l":"SLA Cumprido (%)","v":"85.7%","t":"+2.2%","d":"up"},{"l":"MTTR (h)","v":"102h","t":"+4.2%","d":"up"},{"l":"Satisfação (%)","v":"67.2%","t":"+9.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.162","3.833","9.014","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.075","4.400","4.729","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.174","8.530","2.325","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","9.054","322","7.741","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.700","2.498","4.794","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":420},{"label":"Mar","value":654},{"label":"Abr","value":401},{"label":"Mai","value":622},{"label":"Jun","value":417},{"label":"Jul","value":724},{"label":"Ago","value":741},{"label":"Set","value":546},{"label":"Out","value":752},{"label":"Nov","value":475},{"label":"Dez","value":685}];
const MX = 757;
