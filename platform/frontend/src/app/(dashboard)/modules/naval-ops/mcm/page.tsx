...
const PAGE = "MCM";
const KPIS = [{"l":"Total Naval Ops","v":"3.877","t":"+13.8%","d":"up"},{"l":"MCM Ativos","v":"7.347","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+0.7%","d":"up"}];
const COLS = ["ID","MCM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Naval Ops #001","Naval Ops #002","3.747","4.837","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Naval Ops #002","Naval Ops #003","7.010","7.830","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Naval Ops #003","Naval Ops #004","3.403","3.508","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Naval Ops #004","Naval Ops #005","1.430","1.768","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Naval Ops #005","Naval Ops #001","4.526","7.198","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":345},{"label":"Fev","value":327},{"label":"Mar","value":538},{"label":"Abr","value":376},{"label":"Mai","value":391},{"label":"Jun","value":537},{"label":"Jul","value":646},{"label":"Ago","value":588},{"label":"Set","value":574},{"label":"Out","value":406},{"label":"Nov","value":590},{"label":"Dez","value":469}];
const MX = 646;
