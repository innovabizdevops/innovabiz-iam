...
export default function NavalOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Naval Ops</h1><p className="text-sm text-muted-foreground">Naval Ops • iBOS Enterprise</p></div>
