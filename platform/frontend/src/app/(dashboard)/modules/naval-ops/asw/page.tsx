...
const PAGE = "ASW";
const KPIS = [{"l":"Total Naval Ops","v":"8.146","t":"+3.9%","d":"up"},{"l":"ASW Ativos","v":"7.458","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"77","t":"-2.9%","d":"down"}];
const COLS = ["ID","ASW","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Naval Ops #001","Naval Ops #002","5.062","1.058","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Naval Ops #002","Naval Ops #003","6.279","9.063","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Naval Ops #003","Naval Ops #004","4.061","487","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Naval Ops #004","Naval Ops #005","8.790","4.362","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Naval Ops #005","Naval Ops #001","3.807","4.292","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":344},{"label":"Mar","value":396},{"label":"Abr","value":517},{"label":"Mai","value":273},{"label":"Jun","value":490},{"label":"Jul","value":427},{"label":"Ago","value":251},{"label":"Set","value":449},{"label":"Out","value":286},{"label":"Nov","value":245},{"label":"Dez","value":495}];
const MX = 572;
