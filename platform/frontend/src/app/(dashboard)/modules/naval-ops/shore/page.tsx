...
const PAGE = "Shore Ops";
const KPIS = [{"l":"Total Naval Ops","v":"2.014","t":"+4.7%","d":"up"},{"l":"Shore Ops Ativos","v":"3.221","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"86","t":"+5.9%","d":"up"}];
const COLS = ["ID","Shore Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Naval Ops #001","Naval Ops #002","6.420","7.155","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Naval Ops #002","Naval Ops #003","2.705","7.528","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Naval Ops #003","Naval Ops #004","1.509","3.794","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Naval Ops #004","Naval Ops #005","2.870","2.556","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Naval Ops #005","Naval Ops #001","3.621","3.655","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":678},{"label":"Mar","value":930},{"label":"Abr","value":860},{"label":"Mai","value":585},{"label":"Jun","value":700},{"label":"Jul","value":824},{"label":"Ago","value":774},{"label":"Set","value":630},{"label":"Out","value":726},{"label":"Nov","value":903},{"label":"Dez","value":870}];
const MX = 930;
