...
const PAGE = "Fleet";
const KPIS = [{"l":"Total Naval Ops","v":"2.228","t":"+1.7%","d":"up"},{"l":"Fleet Ativos","v":"5.182","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"70","t":"+3.2%","d":"up"}];
const COLS = ["ID","Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Naval Ops #001","Naval Ops #002","3.760","8.185","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Naval Ops #002","Naval Ops #003","485","7.050","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Naval Ops #003","Naval Ops #004","7.232","6.362","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Naval Ops #004","Naval Ops #005","2.998","1.391","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Naval Ops #005","Naval Ops #001","5.236","2.006","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":597},{"label":"Mar","value":505},{"label":"Abr","value":727},{"label":"Mai","value":505},{"label":"Jun","value":491},{"label":"Jul","value":413},{"label":"Ago","value":688},{"label":"Set","value":768},{"label":"Out","value":640},{"label":"Nov","value":729},{"label":"Dez","value":727}];
const MX = 777;
