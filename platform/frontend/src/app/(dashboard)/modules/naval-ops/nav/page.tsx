...
const ACCENT = "#6366f1";
const MODULE = "Naval Operations";
const PAGE = "Navigation";
const KPIS = [{"l":"Total Naval Ops","v":"1.955","t":"-5.8%","d":"down"},{"l":"Navigation Ativos","v":"1.987","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+13.0%","d":"up"}];
const COLS = ["ID","Navigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Naval Ops #001","Naval Ops #002","7.157","8.307","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Naval Ops #002","Naval Ops #003","9.051","5.365","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Naval Ops #003","Naval Ops #004","936","8.791","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Naval Ops #004","Naval Ops #005","4.545","3.032","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Naval Ops #005","Naval Ops #001","6.790","4.412","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":762},{"label":"Mar","value":543},{"label":"Abr","value":728},{"label":"Mai","value":599},{"label":"Jun","value":619},{"label":"Jul","value":690},{"label":"Ago","value":742},{"label":"Set","value":537},{"label":"Out","value":800},{"label":"Nov","value":915},{"label":"Dez","value":833}];
const MX = 915;
