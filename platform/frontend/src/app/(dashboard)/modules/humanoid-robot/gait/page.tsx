...
const PAGE = "Gait Control";
const KPIS = [{"l":"Total Humanoid Robot","v":"6.702","t":"+7.2%","d":"up"},{"l":"Gait Control Ativos","v":"167","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+11.0%","d":"up"}];
const COLS = ["ID","Gait Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Humanoid Robot #001","Humanoid Robot #002","6.628","7.594","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Humanoid Robot #002","Humanoid Robot #003","1.177","5.570","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Humanoid Robot #003","Humanoid Robot #004","3.647","6.001","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Humanoid Robot #004","Humanoid Robot #005","7.814","3.557","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Humanoid Robot #005","Humanoid Robot #001","7.826","6.524","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":345},{"label":"Mar","value":519},{"label":"Abr","value":650},{"label":"Mai","value":399},{"label":"Jun","value":405},{"label":"Jul","value":621},{"label":"Ago","value":480},{"label":"Set","value":378},{"label":"Out","value":461},{"label":"Nov","value":489},{"label":"Dez","value":562}];
const MX = 650;
