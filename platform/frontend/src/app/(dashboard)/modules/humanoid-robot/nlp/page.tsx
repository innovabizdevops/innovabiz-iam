...
const ACCENT = "#6366f1";
const MODULE = "Humanoid Robots";
const PAGE = "NLP Dialog";
const KPIS = [{"l":"Total Humanoid Robot","v":"4.712","t":"-5.9%","d":"down"},{"l":"NLP Dialog Ativos","v":"8.466","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"75","t":"-5.2%","d":"down"}];
const COLS = ["ID","NLP Dialog","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Humanoid Robot #001","Humanoid Robot #002","7.056","8.822","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Humanoid Robot #002","Humanoid Robot #003","6.172","5.576","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Humanoid Robot #003","Humanoid Robot #004","8.315","2.303","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Humanoid Robot #004","Humanoid Robot #005","1.724","4.498","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Humanoid Robot #005","Humanoid Robot #001","3.904","6.613","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":596},{"label":"Mar","value":226},{"label":"Abr","value":269},{"label":"Mai","value":579},{"label":"Jun","value":455},{"label":"Jul","value":454},{"label":"Ago","value":508},{"label":"Set","value":366},{"label":"Out","value":231},{"label":"Nov","value":309},{"label":"Dez","value":366}];
const MX = 596;
