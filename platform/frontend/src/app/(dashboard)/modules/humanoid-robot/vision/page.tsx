...
const PAGE = "Vision";
const KPIS = [{"l":"Total Humanoid Robot","v":"659","t":"+2.8%","d":"up"},{"l":"Vision Ativos","v":"2.476","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+16.2%","d":"up"}];
const COLS = ["ID","Vision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Humanoid Robot #001","Humanoid Robot #002","3.991","8.405","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Humanoid Robot #002","Humanoid Robot #003","6.602","2.531","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Humanoid Robot #003","Humanoid Robot #004","8.768","615","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Humanoid Robot #004","Humanoid Robot #005","1.632","2.554","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Humanoid Robot #005","Humanoid Robot #001","6.105","4.978","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":465},{"label":"Mar","value":796},{"label":"Abr","value":687},{"label":"Mai","value":621},{"label":"Jun","value":814},{"label":"Jul","value":503},{"label":"Ago","value":765},{"label":"Set","value":746},{"label":"Out","value":690},{"label":"Nov","value":761},{"label":"Dez","value":636}];
const MX = 814;
