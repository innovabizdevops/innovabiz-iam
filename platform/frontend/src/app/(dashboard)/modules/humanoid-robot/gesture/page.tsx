...
const PAGE = "Gesture";
const KPIS = [{"l":"Total Humanoid Robot","v":"5.974","t":"-1.0%","d":"down"},{"l":"Gesture Ativos","v":"632","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"84","t":"-5.0%","d":"down"}];
const COLS = ["ID","Gesture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Humanoid Robot #001","Humanoid Robot #002","6.100","3.167","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Humanoid Robot #002","Humanoid Robot #003","2.055","6.351","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Humanoid Robot #003","Humanoid Robot #004","3.003","7.142","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Humanoid Robot #004","Humanoid Robot #005","6.686","3.830","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Humanoid Robot #005","Humanoid Robot #001","7.338","1.371","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":953},{"label":"Mar","value":635},{"label":"Abr","value":761},{"label":"Mai","value":657},{"label":"Jun","value":708},{"label":"Jul","value":945},{"label":"Ago","value":685},{"label":"Set","value":685},{"label":"Out","value":983},{"label":"Nov","value":965},{"label":"Dez","value":834}];
const MX = 983;
