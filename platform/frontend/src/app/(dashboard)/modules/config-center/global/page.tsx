...
const ACCENT = "#059669";
const MODULE = "Configuration Center";
const PAGE = "Global";
const KPIS = [{"l":"Configurações","v":"7.788","t":"-1.1%","d":"down"},{"l":"Últimas Alterações","v":"2.953","t":"+0.6%","d":"up"},{"l":"Ambientes","v":"2.598","t":"+11.5%","d":"up"},{"l":"Versão Config","v":"3.078","t":"+16.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 30041.94","6.641","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 20223.81","8.486","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 39161.56","7.196","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 7202.16","7.799","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 45128.45","7.849","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":798},{"label":"Mar","value":676},{"label":"Abr","value":738},{"label":"Mai","value":815},{"label":"Jun","value":590},{"label":"Jul","value":915},{"label":"Ago","value":632},{"label":"Set","value":599},{"label":"Out","value":921},{"label":"Nov","value":973},{"label":"Dez","value":709}];
const MX = 973;
