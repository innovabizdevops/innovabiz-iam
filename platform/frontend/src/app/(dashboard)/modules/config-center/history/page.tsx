...
const PAGE = "History";
const KPIS = [{"l":"Configurações","v":"2.787","t":"+13.6%","d":"up"},{"l":"Últimas Alterações","v":"401","t":"+13.2%","d":"up"},{"l":"Ambientes","v":"7.605","t":"+5.4%","d":"up"},{"l":"Versão Config","v":"4.970","t":"+7.0%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 28959.05","1.855","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 10137.08","5.122","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 49672.49","2.571","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 32688.47","6.734","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 46914.56","727","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":783},{"label":"Mar","value":756},{"label":"Abr","value":584},{"label":"Mai","value":620},{"label":"Jun","value":889},{"label":"Jul","value":905},{"label":"Ago","value":660},{"label":"Set","value":894},{"label":"Out","value":928},{"label":"Nov","value":866},{"label":"Dez","value":861}];
const MX = 928;
