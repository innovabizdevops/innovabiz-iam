...
const PAGE = "Tenant";
const KPIS = [{"l":"Configurações","v":"5.559","t":"-0.4%","d":"down"},{"l":"Últimas Alterações","v":"6.014","t":"+7.0%","d":"up"},{"l":"Ambientes","v":"4.638","t":"+3.7%","d":"up"},{"l":"Versão Config","v":"6.687","t":"+7.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 29499.43","8.637","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 41817.14","338","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 23909.12","4.214","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 15544.66","5.296","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 22168.38","7.395","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":675},{"label":"Mar","value":664},{"label":"Abr","value":458},{"label":"Mai","value":742},{"label":"Jun","value":718},{"label":"Jul","value":477},{"label":"Ago","value":770},{"label":"Set","value":451},{"label":"Out","value":586},{"label":"Nov","value":568},{"label":"Dez","value":395}];
const MX = 770;
