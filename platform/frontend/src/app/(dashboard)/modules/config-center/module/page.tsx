...
const PAGE = "Module";
const KPIS = [{"l":"Configurações","v":"8.238","t":"+10.2%","d":"up"},{"l":"Últimas Alterações","v":"5.167","t":"+3.9%","d":"up"},{"l":"Ambientes","v":"7.184","t":"+1.1%","d":"up"},{"l":"Versão Config","v":"1.714","t":"+10.3%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 39599.11","6.457","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 4518.91","4.659","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 2932.08","8.045","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 33449.23","6.251","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 34475.10","3.741","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":743},{"label":"Mar","value":709},{"label":"Abr","value":617},{"label":"Mai","value":637},{"label":"Jun","value":444},{"label":"Jul","value":699},{"label":"Ago","value":637},{"label":"Set","value":671},{"label":"Out","value":510},{"label":"Nov","value":764},{"label":"Dez","value":519}];
const MX = 764;
