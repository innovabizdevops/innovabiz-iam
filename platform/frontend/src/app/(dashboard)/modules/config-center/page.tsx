...
/* ═══ Configuration Center — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8065", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4857", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€301K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1454882265", cells: ["CON-6265", "Configuration Center Item 1", "26/10/2026", "€32 365"], status: "active" as const },
    { id: "1454885836", cells: ["CON-9836", "Configuration Center Item 2", "13/5/2026", "€35 936"], status: "pending" as const },
    { id: "1454889407", cells: ["CON-4407", "Configuration Center Item 3", "28/12/2026", "€39 507"], status: "completed" as const },
    { id: "1454892978", cells: ["CON-7978", "Configuration Center Item 4", "15/7/2026", "€43 078"], status: "warning" as const },
    { id: "1454896549", cells: ["CON-2549", "Configuration Center Item 5", "2/2/2026", "€46 649"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Configuration Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Configuration Center</p>
                    </div>
                </div>
