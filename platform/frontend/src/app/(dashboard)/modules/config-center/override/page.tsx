...
const PAGE = "Override";
const KPIS = [{"l":"Configurações","v":"1.457","t":"-1.9%","d":"down"},{"l":"Últimas Alterações","v":"2.929","t":"+13.8%","d":"up"},{"l":"Ambientes","v":"5.954","t":"-1.2%","d":"down"},{"l":"Versão Config","v":"7.771","t":"+8.0%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 6960.87","5.144","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 8790.83","6.605","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 11028.56","7.872","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 36652.95","446","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 7143.75","239","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":884},{"label":"Mar","value":624},{"label":"Abr","value":846},{"label":"Mai","value":520},{"label":"Jun","value":651},{"label":"Jul","value":547},{"label":"Ago","value":858},{"label":"Set","value":917},{"label":"Out","value":628},{"label":"Nov","value":581},{"label":"Dez","value":675}];
const MX = 917;
