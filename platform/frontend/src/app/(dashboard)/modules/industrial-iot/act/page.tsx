...
const PAGE = "Act";
const KPIS = [{"l":"Dispositivos Online","v":"168","t":"-4.8%","d":"down"},{"l":"Dados/Min (MB)","v":"8.486","t":"+7.3%","d":"up"},{"l":"Alertas Ativos","v":"415","t":"+14.3%","d":"up"},{"l":"Uptime (%)","v":"66.8%","t":"+10.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.694","2.020","7.383","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","585","645","4.363","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.830","6.590","3.091","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.737","7.659","6.814","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.673","6.788","8.599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":334},{"label":"Mar","value":295},{"label":"Abr","value":536},{"label":"Mai","value":342},{"label":"Jun","value":562},{"label":"Jul","value":562},{"label":"Ago","value":506},{"label":"Set","value":572},{"label":"Out","value":338},{"label":"Nov","value":449},{"label":"Dez","value":544}];
const MX = 572;
