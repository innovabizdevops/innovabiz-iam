...
const PAGE = "Connect";
const KPIS = [{"l":"Dispositivos Online","v":"3.561","t":"-2.2%","d":"down"},{"l":"Dados/Min (MB)","v":"8.408","t":"-2.6%","d":"down"},{"l":"Alertas Ativos","v":"1.356","t":"+17.3%","d":"up"},{"l":"Uptime (%)","v":"83.8%","t":"+1.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.720","3.123","3.498","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","465","6.777","4.450","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.452","544","285","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.788","4.118","2.552","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.307","7.469","365","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":341},{"label":"Mar","value":559},{"label":"Abr","value":540},{"label":"Mai","value":261},{"label":"Jun","value":523},{"label":"Jul","value":289},{"label":"Ago","value":582},{"label":"Set","value":273},{"label":"Out","value":308},{"label":"Nov","value":602},{"label":"Dez","value":280}];
const MX = 602;
