...
/* ═══ Industrial IoT Hub (IIoT) — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "2873", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2116", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€39K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1237354273", cells: ["IND-8273", "Industrial IoT Hub (IIoT) Item 1", "2/2/2026", "€4373"], status: "active" as const },
    { id: "1237357844", cells: ["IND-2844", "Industrial IoT Hub (IIoT) Item 2", "17/9/2026", "€7944"], status: "pending" as const },
    { id: "1237361415", cells: ["IND-6415", "Industrial IoT Hub (IIoT) Item 3", "4/4/2026", "€11 515"], status: "completed" as const },
    { id: "1237364986", cells: ["IND-9986", "Industrial IoT Hub (IIoT) Item 4", "19/11/2026", "€15 086"], status: "warning" as const },
    { id: "1237368557", cells: ["IND-4557", "Industrial IoT Hub (IIoT) Item 5", "6/6/2026", "€18 657"], status: "active" as const },
];
...
export default function IndustrialIotHubIiotPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Industrial IoT Hub (IIoT)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Industrial IoT Hub (IIoT)</p>
                    </div>
                </div>
