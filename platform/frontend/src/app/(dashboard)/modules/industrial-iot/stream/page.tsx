...
const PAGE = "Stream";
const KPIS = [{"l":"Dispositivos Online","v":"7.977","t":"+17.6%","d":"up"},{"l":"Dados/Min (MB)","v":"6.606","t":"-4.0%","d":"down"},{"l":"Alertas Ativos","v":"264","t":"-4.8%","d":"down"},{"l":"Uptime (%)","v":"68.9%","t":"+16.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.949","3.598","2.593","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.898","8.530","6.210","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","814","5.690","3.201","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.828","6.508","7.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.274","4.881","1.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":874},{"label":"Mar","value":882},{"label":"Abr","value":678},{"label":"Mai","value":570},{"label":"Jun","value":601},{"label":"Jul","value":802},{"label":"Ago","value":602},{"label":"Set","value":654},{"label":"Out","value":872},{"label":"Nov","value":641},{"label":"Dez","value":917}];
const MX = 917;
