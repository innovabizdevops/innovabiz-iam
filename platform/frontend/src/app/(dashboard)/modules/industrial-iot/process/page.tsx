...
const PAGE = "Process";
const KPIS = [{"l":"Dispositivos Online","v":"2.659","t":"+0.9%","d":"up"},{"l":"Dados/Min (MB)","v":"1.256","t":"+14.0%","d":"up"},{"l":"Alertas Ativos","v":"3.247","t":"+13.9%","d":"up"},{"l":"Uptime (%)","v":"94.1%","t":"+13.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.452","8.396","8.243","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.711","5.732","2.814","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.126","7.786","5.863","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.902","3.719","8.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.236","208","1.677","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":568},{"label":"Mar","value":545},{"label":"Abr","value":768},{"label":"Mai","value":540},{"label":"Jun","value":514},{"label":"Jul","value":439},{"label":"Ago","value":617},{"label":"Set","value":470},{"label":"Out","value":648},{"label":"Nov","value":757},{"label":"Dez","value":678}];
const MX = 768;
