...
const ACCENT = "#b45309";
const MODULE = "Industrial IoT Hub (IIoT)";
const PAGE = "Analyze";
const KPIS = [{"l":"Dispositivos Online","v":"2.773","t":"+11.5%","d":"up"},{"l":"Dados/Min (MB)","v":"6.182","t":"+10.3%","d":"up"},{"l":"Alertas Ativos","v":"2.217","t":"-3.1%","d":"down"},{"l":"Uptime (%)","v":"81.4%","t":"+8.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","518","7.633","9.030","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.962","5.335","6.206","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","177","2.977","5.966","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.411","1.411","3.846","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","555","4.514","3.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":509},{"label":"Mar","value":391},{"label":"Abr","value":488},{"label":"Mai","value":462},{"label":"Jun","value":515},{"label":"Jul","value":584},{"label":"Ago","value":373},{"label":"Set","value":396},{"label":"Out","value":583},{"label":"Nov","value":491},{"label":"Dez","value":282}];
const MX = 584;
