...
const ACCENT = "#059669";
const MODULE = "Health Equity";
const PAGE = "Disparity Map";
const KPIS = [{"l":"Quartos Ocupados","v":"8.841","t":"+0.7%","d":"up"},{"l":"RevPAR (€)","v":"€19742","t":"+5.5%","d":"up"},{"l":"Ocupação (%)","v":"71.7%","t":"+3.2%","d":"up"},{"l":"Guest Satisfaction","v":"7.509","t":"-4.0%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.361","2026-01-02","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.111","2026-01-15","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","494","2026-03-23","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.242","2026-02-09","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.828","2026-03-24","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":515},{"label":"Mar","value":572},{"label":"Abr","value":462},{"label":"Mai","value":287},{"label":"Jun","value":324},{"label":"Jul","value":377},{"label":"Ago","value":557},{"label":"Set","value":245},{"label":"Out","value":436},{"label":"Nov","value":443},{"label":"Dez","value":619}];
const MX = 619;
...
export default function DisparityPage() {
    return (
