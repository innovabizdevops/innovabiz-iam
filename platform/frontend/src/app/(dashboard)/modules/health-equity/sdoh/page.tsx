...
const PAGE = "SDOH Data";
const KPIS = [{"l":"Total Health Equity","v":"7.812","t":"+16.5%","d":"up"},{"l":"SDOH Data Ativos","v":"449","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"73","t":"-4.0%","d":"down"}];
const COLS = ["ID","SDOH Data","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Equity #001","2026-02-02","4.038","2.012","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Health Equity #002","2026-01-22","3.680","6.972","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Equity #003","2026-02-20","8.644","278","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Health Equity #004","2026-03-07","8.510","1.319","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Equity #005","2026-02-18","7.164","4.158","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":964},{"label":"Mar","value":981},{"label":"Abr","value":840},{"label":"Mai","value":932},{"label":"Jun","value":939},{"label":"Jul","value":957},{"label":"Ago","value":801},{"label":"Set","value":949},{"label":"Out","value":696},{"label":"Nov","value":849},{"label":"Dez","value":869}];
const MX = 981;
