...
const PAGE = "Community HW";
const KPIS = [{"l":"Projetos Sociais","v":"6.779","t":"-2.6%","d":"down"},{"l":"Beneficiários","v":"7.999","t":"+12.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€88686","t":"-5.0%","d":"down"},{"l":"Score Impacto","v":"76","t":"-4.7%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.981","€ 46635.86","7.503","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.804","€ 22985.64","7.458","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.211","€ 7844.43","8.871","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.742","€ 45661.29","8.781","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.855","€ 49095.39","1.675","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":882},{"label":"Mar","value":679},{"label":"Abr","value":659},{"label":"Mai","value":849},{"label":"Jun","value":886},{"label":"Jul","value":994},{"label":"Ago","value":722},{"label":"Set","value":667},{"label":"Out","value":872},{"label":"Nov","value":707},{"label":"Dez","value":924}];
const MX = 994;
