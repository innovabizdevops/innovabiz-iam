...
const KPIS = [{"l":"Total Health Equity","v":"4.754","t":"+6.7%","d":"up"},{"l":"Intervention Ativos","v":"6.927","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"68.7%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+17.5%","d":"up"}];
const COLS = ["ID","Intervention","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Equity #001","Health Equity #002","774","5.381","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Health Equity #002","Health Equity #003","2.848","2.313","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Equity #003","Health Equity #004","7.141","2.590","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Health Equity #004","Health Equity #005","5.006","5.080","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Equity #005","Health Equity #001","6.798","4.471","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":407},{"label":"Mar","value":604},{"label":"Abr","value":405},{"label":"Mai","value":588},{"label":"Jun","value":634},{"label":"Jul","value":648},{"label":"Ago","value":658},{"label":"Set","value":652},{"label":"Out","value":347},{"label":"Nov","value":644},{"label":"Dez","value":525}];
const MX = 686;
