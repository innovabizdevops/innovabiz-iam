...
const KPIS = [{"l":"Total 4pl Orchestrate","v":"1.077","t":"+14.7%","d":"up"},{"l":"Orchestrate Ativos","v":"6.994","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"57","t":"+5.0%","d":"up"}];
const COLS = ["ID","Orchestrate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["4pl Orchestrate #001","4pl Orchestrate #002","7.397","2.378","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["4pl Orchestrate #002","4pl Orchestrate #003","103","634","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["4pl Orchestrate #003","4pl Orchestrate #004","4.693","7.150","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["4pl Orchestrate #004","4pl Orchestrate #005","991","7.904","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["4pl Orchestrate #005","4pl Orchestrate #001","1.729","1.711","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":453},{"label":"Mar","value":501},{"label":"Abr","value":584},{"label":"Mai","value":355},{"label":"Jun","value":497},{"label":"Jul","value":536},{"label":"Ago","value":561},{"label":"Set","value":544},{"label":"Out","value":227},{"label":"Nov","value":302},{"label":"Dez","value":411}];
const MX = 584;
