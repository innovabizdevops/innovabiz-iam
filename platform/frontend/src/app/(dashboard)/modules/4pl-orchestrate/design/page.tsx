...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.820","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"1223","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"5.837","t":"+7.1%","d":"up"},{"l":"Templates","v":"6.811","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.520","2026-03-14","1.744","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.245","2026-02-13","3.241","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.388","2026-02-05","8.948","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.537","2026-01-07","3.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.598","2026-03-28","3.669","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":529},{"label":"Mar","value":432},{"label":"Abr","value":672},{"label":"Mai","value":630},{"label":"Jun","value":542},{"label":"Jul","value":695},{"label":"Ago","value":438},{"label":"Set","value":496},{"label":"Out","value":746},{"label":"Nov","value":714},{"label":"Dez","value":531}];
const MX = 746;
