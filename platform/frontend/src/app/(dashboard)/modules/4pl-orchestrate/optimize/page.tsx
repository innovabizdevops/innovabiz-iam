...
const ACCENT = "#6366f1";
const MODULE = "4PL Orchestration";
const PAGE = "Optimize";
const KPIS = [{"l":"Total 4pl Orchestrate","v":"1.886","t":"+2.1%","d":"up"},{"l":"Optimize Ativos","v":"3.113","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"69.4%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"83","t":"+7.9%","d":"up"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["4pl Orchestrate #001","4pl Orchestrate #002","536","387","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["4pl Orchestrate #002","4pl Orchestrate #003","2.792","6.772","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["4pl Orchestrate #003","4pl Orchestrate #004","3.409","2.384","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["4pl Orchestrate #004","4pl Orchestrate #005","8.503","4.786","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["4pl Orchestrate #005","4pl Orchestrate #001","3.954","8.899","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":532},{"label":"Mar","value":347},{"label":"Abr","value":352},{"label":"Mai","value":410},{"label":"Jun","value":319},{"label":"Jul","value":548},{"label":"Ago","value":511},{"label":"Set","value":631},{"label":"Out","value":279},{"label":"Nov","value":674},{"label":"Dez","value":435}];
const MX = 674;
