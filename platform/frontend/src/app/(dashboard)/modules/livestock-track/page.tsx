...
export default function LivestockTrackPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Livestock Track</h1><p className="text-sm text-muted-foreground">Livestock Track • iBOS Enterprise</p></div>
