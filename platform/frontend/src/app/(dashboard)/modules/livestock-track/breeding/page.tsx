...
const PAGE = "Breeding Plan";
const KPIS = [{"l":"Integrações Ativas","v":"1.445","t":"+12.0%","d":"up"},{"l":"Chamadas/Hora","v":"4147","t":"+8.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.3%","t":"+5.8%","d":"up"},{"l":"Latência Média (ms)","v":"115ms","t":"-2.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.520","2.216","78.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.524","6.175","95.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.534","7.188","84.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.296","8.992","74.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.111","7.320","78.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":817},{"label":"Mar","value":755},{"label":"Abr","value":763},{"label":"Mai","value":705},{"label":"Jun","value":881},{"label":"Jul","value":761},{"label":"Ago","value":783},{"label":"Set","value":746},{"label":"Out","value":1021},{"label":"Nov","value":783},{"label":"Dez","value":666}];
const MX = 1021;
