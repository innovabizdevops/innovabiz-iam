...
const PAGE = "Exam";
const KPIS = [{"l":"Total Optician Svc","v":"3.122","t":"+10.7%","d":"up"},{"l":"Exam Ativos","v":"4.075","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"77","t":"-5.7%","d":"down"}];
const COLS = ["ID","Exam","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Optician Svc #001","Optician Svc #002","2.865","6.879","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Optician Svc #002","Optician Svc #003","7.297","8.572","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Optician Svc #003","Optician Svc #004","6.285","6.532","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Optician Svc #004","Optician Svc #005","2.404","1.712","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Optician Svc #005","Optician Svc #001","6.325","2.481","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":261},{"label":"Mar","value":362},{"label":"Abr","value":444},{"label":"Mai","value":373},{"label":"Jun","value":528},{"label":"Jul","value":475},{"label":"Ago","value":342},{"label":"Set","value":382},{"label":"Out","value":407},{"label":"Nov","value":533},{"label":"Dez","value":378}];
const MX = 569;
