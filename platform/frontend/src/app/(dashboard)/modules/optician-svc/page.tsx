...
/* ═══ Optician & Eye Care — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "7827", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2234", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€476K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2027121827", cells: ["OPT-7827", "Optician & Eye Care Item 1", "4/12/2026", "€21 927"], status: "active" as const },
    { id: "2027125398", cells: ["OPT-2398", "Optician & Eye Care Item 2", "19/7/2026", "€25 498"], status: "pending" as const },
    { id: "2027128969", cells: ["OPT-5969", "Optician & Eye Care Item 3", "6/2/2026", "€29 069"], status: "completed" as const },
    { id: "2027132540", cells: ["OPT-9540", "Optician & Eye Care Item 4", "21/9/2026", "€32 640"], status: "warning" as const },
    { id: "2027136111", cells: ["OPT-4111", "Optician & Eye Care Item 5", "8/4/2026", "€36 211"], status: "active" as const },
];
...
export default function OpticianEyeCarePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Optician & Eye Care</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Optician & Eye Care</p>
                    </div>
                </div>
