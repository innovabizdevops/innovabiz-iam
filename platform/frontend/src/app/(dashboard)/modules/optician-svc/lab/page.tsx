...
const PAGE = "Lab";
const KPIS = [{"l":"Total Optician Svc","v":"3.050","t":"-5.1%","d":"down"},{"l":"Lab Ativos","v":"7.431","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"86","t":"+17.9%","d":"up"}];
const COLS = ["ID","Lab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Optician Svc #001","Optician Svc #002","8.197","4.553","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Optician Svc #002","Optician Svc #003","3.980","4.112","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Optician Svc #003","Optician Svc #004","2.786","1.107","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Optician Svc #004","Optician Svc #005","4.716","1.451","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Optician Svc #005","Optician Svc #001","1.529","4.688","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":724},{"label":"Mar","value":653},{"label":"Abr","value":587},{"label":"Mai","value":478},{"label":"Jun","value":602},{"label":"Jul","value":676},{"label":"Ago","value":508},{"label":"Set","value":443},{"label":"Out","value":399},{"label":"Nov","value":660},{"label":"Dez","value":501}];
const MX = 724;
