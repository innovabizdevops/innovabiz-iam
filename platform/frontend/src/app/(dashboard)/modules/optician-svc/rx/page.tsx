...
const ACCENT = "#0891b2";
const MODULE = "Optician & Eye Care";
const PAGE = "Prescription";
const KPIS = [{"l":"Total Optician Svc","v":"9.051","t":"+14.1%","d":"up"},{"l":"Prescription Ativos","v":"6.572","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+8.0%","d":"up"}];
const COLS = ["ID","Prescription","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Optician Svc #001","Optician Svc #002","1.883","625","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Optician Svc #002","Optician Svc #003","5.192","4.676","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Optician Svc #003","Optician Svc #004","6.851","1.207","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Optician Svc #004","Optician Svc #005","2.511","3.269","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Optician Svc #005","Optician Svc #001","2.684","8.204","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":261},{"label":"Fev","value":538},{"label":"Mar","value":310},{"label":"Abr","value":488},{"label":"Mai","value":470},{"label":"Jun","value":406},{"label":"Jul","value":492},{"label":"Ago","value":299},{"label":"Set","value":324},{"label":"Out","value":345},{"label":"Nov","value":573},{"label":"Dez","value":297}];
const MX = 573;
