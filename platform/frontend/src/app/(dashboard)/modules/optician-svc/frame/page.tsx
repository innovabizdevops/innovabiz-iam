...
const PAGE = "Frame";
const KPIS = [{"l":"Total Optician Svc","v":"4.958","t":"+11.5%","d":"up"},{"l":"Frame Ativos","v":"2.232","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"71","t":"+10.1%","d":"up"}];
const COLS = ["ID","Frame","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Optician Svc #001","Optician Svc #002","1.681","1.723","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Optician Svc #002","Optician Svc #003","6.618","8.370","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Optician Svc #003","Optician Svc #004","5.142","2.672","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Optician Svc #004","Optician Svc #005","7.319","1.118","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Optician Svc #005","Optician Svc #001","8.101","8.364","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":662},{"label":"Mar","value":410},{"label":"Abr","value":446},{"label":"Mai","value":496},{"label":"Jun","value":658},{"label":"Jul","value":635},{"label":"Ago","value":422},{"label":"Set","value":668},{"label":"Out","value":671},{"label":"Nov","value":697},{"label":"Dez","value":464}];
const MX = 703;
