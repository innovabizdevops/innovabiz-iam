...
const KPIS = [{"l":"Total Optician Svc","v":"6.950","t":"-4.5%","d":"down"},{"l":"Insurance Ativos","v":"1.153","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+12.6%","d":"up"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Optician Svc #001","Optician Svc #002","4.692","5.238","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Optician Svc #002","Optician Svc #003","6.081","4.362","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Optician Svc #003","Optician Svc #004","5.645","8.150","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Optician Svc #004","Optician Svc #005","3.876","6.255","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Optician Svc #005","Optician Svc #001","4.124","4.606","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":1015},{"label":"Mar","value":828},{"label":"Abr","value":676},{"label":"Mai","value":979},{"label":"Jun","value":821},{"label":"Jul","value":685},{"label":"Ago","value":984},{"label":"Set","value":733},{"label":"Out","value":1036},{"label":"Nov","value":742},{"label":"Dez","value":978}];
const MX = 1036;
