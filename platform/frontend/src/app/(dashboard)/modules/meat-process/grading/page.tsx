...
const PAGE = "Grading";
const KPIS = [{"l":"Total Meat Process","v":"2.182","t":"+9.7%","d":"up"},{"l":"Grading Ativos","v":"6.504","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+1.1%","d":"up"}];
const COLS = ["ID","Grading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Meat Process #001","Meat Process #002","6.307","2.016","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Meat Process #002","Meat Process #003","4.750","958","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Meat Process #003","Meat Process #004","3.386","6.981","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Meat Process #004","Meat Process #005","2.986","5.985","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Meat Process #005","Meat Process #001","1.351","6.520","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":709},{"label":"Mar","value":980},{"label":"Abr","value":1057},{"label":"Mai","value":856},{"label":"Jun","value":929},{"label":"Jul","value":678},{"label":"Ago","value":891},{"label":"Set","value":974},{"label":"Out","value":972},{"label":"Nov","value":771},{"label":"Dez","value":799}];
const MX = 1057;
