...
const PAGE = "Cut &amp; Debone";
const KPIS = [{"l":"Total Meat Process","v":"8.973","t":"+15.1%","d":"up"},{"l":"Cut & Debone Ativos","v":"6.233","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"67.2%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"72","t":"+0.4%","d":"up"}];
const COLS = ["ID","Cut & Debone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Meat Process #001","Meat Process #002","4.810","2.836","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Meat Process #002","Meat Process #003","6.246","5.784","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Meat Process #003","Meat Process #004","1.696","6.422","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Meat Process #004","Meat Process #005","8.752","5.491","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Meat Process #005","Meat Process #001","2.421","1.862","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":552},{"label":"Mar","value":823},{"label":"Abr","value":802},{"label":"Mai","value":583},{"label":"Jun","value":824},{"label":"Jul","value":638},{"label":"Ago","value":745},{"label":"Set","value":746},{"label":"Out","value":936},{"label":"Nov","value":571},{"label":"Dez","value":930}];
const MX = 936;
