...
const PAGE = "Slaughter";
const KPIS = [{"l":"Tickets Abertos","v":"1.710","t":"+6.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.5%","t":"-0.3%","d":"down"},{"l":"MTTR (h)","v":"121h","t":"+14.6%","d":"up"},{"l":"Satisfação (%)","v":"90.0%","t":"+11.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.347","559","3.472","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.409","6.748","3.274","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.005","461","7.941","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","9.071","8.219","8.222","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.957","4.998","1.075","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1060},{"label":"Fev","value":820},{"label":"Mar","value":885},{"label":"Abr","value":864},{"label":"Mai","value":1046},{"label":"Jun","value":895},{"label":"Jul","value":835},{"label":"Ago","value":1053},{"label":"Set","value":788},{"label":"Out","value":819},{"label":"Nov","value":835},{"label":"Dez","value":909}];
const MX = 1060;
