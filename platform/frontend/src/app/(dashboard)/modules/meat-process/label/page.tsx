...
const ACCENT = "#facc15";
const MODULE = "Meat Processing";
const PAGE = "Label Comply";
const KPIS = [{"l":"Total Meat Process","v":"5.188","t":"+11.8%","d":"up"},{"l":"Label Comply Ativos","v":"3.599","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"91","t":"-4.6%","d":"down"}];
const COLS = ["ID","Label Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Meat Process #001","Meat Process #002","8.909","2.402","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Meat Process #002","Meat Process #003","8.499","6.735","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Meat Process #003","Meat Process #004","6.114","2.168","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Meat Process #004","Meat Process #005","1.646","5.921","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Meat Process #005","Meat Process #001","6.112","2.728","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":579},{"label":"Mar","value":680},{"label":"Abr","value":652},{"label":"Mai","value":733},{"label":"Jun","value":599},{"label":"Jul","value":713},{"label":"Ago","value":696},{"label":"Set","value":497},{"label":"Out","value":706},{"label":"Nov","value":585},{"label":"Dez","value":380}];
const MX = 733;
