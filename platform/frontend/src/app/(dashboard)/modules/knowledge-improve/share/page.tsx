...
const PAGE = "Share";
const KPIS = [{"l":"Projetos Melhoria","v":"1.541","t":"+17.7%","d":"up"},{"l":"Savings (€)","v":"€76414","t":"-4.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"90.5%","t":"+7.3%","d":"up"},{"l":"Ciclos PDCA","v":"250","t":"+1.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.534","€ 22250.25","1.214","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.856","€ 8312.73","440","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.920","€ 29226.23","1.689","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.298","€ 2965.99","5.774","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.165","€ 39274.72","7.688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":656},{"label":"Mar","value":762},{"label":"Abr","value":393},{"label":"Mai","value":589},{"label":"Jun","value":672},{"label":"Jul","value":514},{"label":"Ago","value":725},{"label":"Set","value":682},{"label":"Out","value":573},{"label":"Nov","value":455},{"label":"Dez","value":627}];
const MX = 762;
