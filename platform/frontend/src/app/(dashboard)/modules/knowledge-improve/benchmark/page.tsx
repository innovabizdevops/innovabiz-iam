...
const ACCENT = "#7e22ce";
const MODULE = "Knowledge & Improvement (APQC 12)";
const PAGE = "Benchmark";
const KPIS = [{"l":"Projetos Melhoria","v":"8.236","t":"+3.6%","d":"up"},{"l":"Savings (€)","v":"€54091","t":"+9.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"91.5%","t":"+13.2%","d":"up"},{"l":"Ciclos PDCA","v":"8.507","t":"+1.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.322","€ 8750.72","6.912","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","895","€ 6680.39","8.448","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.861","€ 41201.31","2.719","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.585","€ 31137.48","8.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.765","€ 18306.25","2.296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":815},{"label":"Mar","value":754},{"label":"Abr","value":783},{"label":"Mai","value":751},{"label":"Jun","value":793},{"label":"Jul","value":774},{"label":"Ago","value":989},{"label":"Set","value":1052},{"label":"Out","value":758},{"label":"Nov","value":739},{"label":"Dez","value":924}];
const MX = 1052;
