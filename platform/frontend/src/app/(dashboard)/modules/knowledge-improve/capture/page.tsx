...
const PAGE = "Capture";
const KPIS = [{"l":"Projetos Melhoria","v":"8.615","t":"+8.7%","d":"up"},{"l":"Savings (€)","v":"€19431","t":"+17.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.3%","t":"+0.0%","d":"up"},{"l":"Ciclos PDCA","v":"775","t":"-3.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.335","€ 36065.77","6.123","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.658","€ 6785.16","5.216","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.165","€ 33044.74","4.748","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.913","€ 44747.07","1.694","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.737","€ 39660.26","2.512","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":723},{"label":"Mar","value":676},{"label":"Abr","value":756},{"label":"Mai","value":519},{"label":"Jun","value":818},{"label":"Jul","value":599},{"label":"Ago","value":585},{"label":"Set","value":693},{"label":"Out","value":664},{"label":"Nov","value":829},{"label":"Dez","value":511}];
const MX = 829;
