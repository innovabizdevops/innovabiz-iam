...
const PAGE = "Measure";
const KPIS = [{"l":"Projetos Melhoria","v":"7.876","t":"+11.9%","d":"up"},{"l":"Savings (€)","v":"€49740","t":"-0.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"90.6%","t":"+13.0%","d":"up"},{"l":"Ciclos PDCA","v":"8.673","t":"+15.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.609","€ 12044.56","7.914","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.865","€ 5376.62","3.348","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.406","€ 25348.30","1.932","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.478","€ 25965.01","3.478","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.593","€ 36249.31","6.622","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":745},{"label":"Mar","value":664},{"label":"Abr","value":462},{"label":"Mai","value":581},{"label":"Jun","value":564},{"label":"Jul","value":703},{"label":"Ago","value":743},{"label":"Set","value":699},{"label":"Out","value":403},{"label":"Nov","value":429},{"label":"Dez","value":676}];
const MX = 745;
