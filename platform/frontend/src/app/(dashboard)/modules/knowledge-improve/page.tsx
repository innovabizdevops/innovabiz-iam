...
/* ═══ Knowledge & Improvement (APQC 12) — Dashboard ═══ */

const ACCENT = "#7e22ce";

const KPIS = [
    { label: "Total Registos", value: "508", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4649", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€192K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1236569808", cells: ["KNO-6808", "Knowledge & Improvement (APQC 12) Item 1", "13/1/2026", "€19 908"], status: "active" as const },
    { id: "1236573379", cells: ["KNO-1379", "Knowledge & Improvement (APQC 12) Item 2", "28/8/2026", "€23 479"], status: "pending" as const },
    { id: "1236576950", cells: ["KNO-4950", "Knowledge & Improvement (APQC 12) Item 3", "15/3/2026", "€27 050"], status: "completed" as const },
    { id: "1236580521", cells: ["KNO-8521", "Knowledge & Improvement (APQC 12) Item 4", "2/10/2026", "€30 621"], status: "warning" as const },
    { id: "1236584092", cells: ["KNO-3092", "Knowledge & Improvement (APQC 12) Item 5", "17/5/2026", "€34 192"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 68 }, { label: "Fev", value: 77 }, { label: "Mar", value: 86 }, { label: "Abr", value: 95 }, { label: "Mai", value: 24 }, { label: "Jun", value: 33 }];
...
export default function KnowledgeImprovementApqc12Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Knowledge & Improvement (APQC 12)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Knowledge & Improvement (APQC 12)</p>
                    </div>
                </div>
