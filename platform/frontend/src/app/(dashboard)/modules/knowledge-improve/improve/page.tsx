...
const PAGE = "Improve";
const KPIS = [{"l":"Projetos Melhoria","v":"436","t":"+0.6%","d":"up"},{"l":"Savings (€)","v":"€91219","t":"-3.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"80.1%","t":"+12.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.565","t":"+4.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.479","€ 30463.48","2.704","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.090","€ 34055.32","1.573","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.937","€ 25046.39","5.686","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.718","€ 29204.42","3.784","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.567","€ 29879.66","7.571","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":698},{"label":"Mar","value":587},{"label":"Abr","value":832},{"label":"Mai","value":739},{"label":"Jun","value":728},{"label":"Jul","value":805},{"label":"Ago","value":827},{"label":"Set","value":666},{"label":"Out","value":577},{"label":"Nov","value":500},{"label":"Dez","value":616}];
const MX = 832;
