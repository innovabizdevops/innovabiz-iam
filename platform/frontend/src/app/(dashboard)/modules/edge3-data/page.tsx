...
/* ═══ EDGE3 Edge Data Mgmt — Dashboard ═══ */

const ACCENT = "#0f766e";

const KPIS = [
    { label: "Total Registos", value: "2072", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2004", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€11K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "169084072", cells: ["EDG-2072", "EDGE3 Edge Data Mgmt Item 1", "25/5/2026", "€34 172"], status: "active" as const },
    { id: "169087643", cells: ["EDG-5643", "EDGE3 Edge Data Mgmt Item 2", "12/12/2026", "€37 743"], status: "pending" as const },
    { id: "169091214", cells: ["EDG-9214", "EDGE3 Edge Data Mgmt Item 3", "27/7/2026", "€41 314"], status: "completed" as const },
    { id: "169094785", cells: ["EDG-3785", "EDGE3 Edge Data Mgmt Item 4", "14/2/2026", "€44 885"], status: "warning" as const },
    { id: "169098356", cells: ["EDG-7356", "EDGE3 Edge Data Mgmt Item 5", "1/9/2026", "€48 456"], status: "active" as const },
];
...
export default function Edge3EdgeDataMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDGE3 Edge Data Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDGE3 Edge Data Mgmt</p>
                    </div>
                </div>
