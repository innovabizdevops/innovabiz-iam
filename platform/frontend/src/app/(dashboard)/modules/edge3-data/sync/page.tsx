...
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"526","t":"+15.9%","d":"up"},{"l":"Chamadas/Hora","v":"243","t":"+4.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.6%","t":"+3.0%","d":"up"},{"l":"Latência Média (ms)","v":"60ms","t":"+12.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.354","6.642","75.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.625","6.216","99.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.711","1.353","74.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.413","2.631","74.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","520","4.258","95.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":625},{"label":"Mar","value":440},{"label":"Abr","value":341},{"label":"Mai","value":336},{"label":"Jun","value":384},{"label":"Jul","value":307},{"label":"Ago","value":466},{"label":"Set","value":560},{"label":"Out","value":485},{"label":"Nov","value":645},{"label":"Dez","value":418}];
const MX = 645;
