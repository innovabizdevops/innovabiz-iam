...
const ACCENT = "#0f766e";
const MODULE = "EDGE3 Edge Data Mgmt";
const PAGE = "Conflict";
const KPIS = [{"l":"Total Edge3 Data","v":"6.854","t":"+17.1%","d":"up"},{"l":"Conflict Ativos","v":"7.238","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"80","t":"+8.5%","d":"up"}];
const COLS = ["ID","Conflict","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge3 Data #001","Edge3 Data #002","3.916","2.705","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Edge3 Data #002","Edge3 Data #003","1.010","2.571","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge3 Data #003","Edge3 Data #004","3.703","5.830","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Edge3 Data #004","Edge3 Data #005","2.627","3.311","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge3 Data #005","Edge3 Data #001","8.807","2.805","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":990},{"label":"Mar","value":1002},{"label":"Abr","value":735},{"label":"Mai","value":668},{"label":"Jun","value":921},{"label":"Jul","value":762},{"label":"Ago","value":664},{"label":"Set","value":844},{"label":"Out","value":808},{"label":"Nov","value":916},{"label":"Dez","value":932}];
const MX = 1002;
