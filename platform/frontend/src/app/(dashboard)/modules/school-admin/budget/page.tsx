...
const PAGE = "Budget";
const KPIS = [{"l":"Total School Admin","v":"3.980","t":"+16.0%","d":"up"},{"l":"Budget Ativos","v":"€65047","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"71.8%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"68","t":"+1.1%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Admin #001","€ 16045.87","7.487","570","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["School Admin #002","€ 38769.40","5.794","2.131","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["School Admin #003","€ 44398.10","3.159","1.833","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["School Admin #004","€ 46142.07","2.664","6.781","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Admin #005","€ 49014.01","162","8.256","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":710},{"label":"Mar","value":473},{"label":"Abr","value":395},{"label":"Mai","value":662},{"label":"Jun","value":681},{"label":"Jul","value":724},{"label":"Ago","value":606},{"label":"Set","value":481},{"label":"Out","value":532},{"label":"Nov","value":671},{"label":"Dez","value":722}];
const MX = 724;
