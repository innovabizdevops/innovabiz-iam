...
const ACCENT = "#6366f1";
const MODULE = "School Administration";
const PAGE = "Schedule";
const KPIS = [{"l":"Total School Admin","v":"3.104","t":"+14.6%","d":"up"},{"l":"Schedule Ativos","v":"3.100","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"85.2%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+0.9%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Admin #001","School Admin #002","6.502","8.104","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["School Admin #002","School Admin #003","2.853","121","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["School Admin #003","School Admin #004","7.728","2.690","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["School Admin #004","School Admin #005","1.792","3.443","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Admin #005","School Admin #001","7.461","4.508","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":882},{"label":"Mar","value":992},{"label":"Abr","value":993},{"label":"Mai","value":797},{"label":"Jun","value":615},{"label":"Jul","value":760},{"label":"Ago","value":643},{"label":"Set","value":681},{"label":"Out","value":841},{"label":"Nov","value":608},{"label":"Dez","value":622}];
const MX = 993;
