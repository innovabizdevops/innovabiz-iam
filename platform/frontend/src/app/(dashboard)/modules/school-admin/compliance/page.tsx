...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.500","t":"+1.4%","d":"up"},{"l":"NC Abertas","v":"1.659","t":"+8.4%","d":"up"},{"l":"Conformidade (%)","v":"93.3%","t":"+10.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.215","t":"+8.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.819","86.1%","1.275","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","921","95.3%","7.877","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.451","83.6%","6.432","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.473","87.5%","4.555","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.002","94.3%","7.904","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":433},{"label":"Mar","value":421},{"label":"Abr","value":732},{"label":"Mai","value":712},{"label":"Jun","value":537},{"label":"Jul","value":552},{"label":"Ago","value":677},{"label":"Set","value":446},{"label":"Out","value":720},{"label":"Nov","value":431},{"label":"Dez","value":388}];
const MX = 732;
