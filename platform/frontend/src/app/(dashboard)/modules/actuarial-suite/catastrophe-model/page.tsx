...
/* ═══ Actuarial Suite — Catastrophe Model ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "2676", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "393", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1267", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "82%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "717112245", cells: ["ACT-2245", "Catastrophe Model Item 1", "18/10/2026", "€12 345"], status: "active" as const },
    { id: "717115816", cells: ["ACT-5816", "Catastrophe Model Item 2", "5/5/2026", "€15 916"], status: "pending" as const },
    { id: "717119387", cells: ["ACT-9387", "Catastrophe Model Item 3", "20/12/2026", "€19 487"], status: "completed" as const },
    { id: "717122958", cells: ["ACT-3958", "Catastrophe Model Item 4", "7/7/2026", "€23 058"], status: "warning" as const },
    { id: "717126529", cells: ["ACT-7529", "Catastrophe Model Item 5", "22/2/2026", "€26 629"], status: "active" as const },
];
...
export default function ActuarialSuiteCatastropheModelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catastrophe Model</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Catastrophe Model</p>
                    </div>
                </div>
