...
/* ═══ Actuarial Suite — Profit Test ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "4257", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "96", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2076", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "965137740", cells: ["ACT-5740", "Profit Test Item 1", "1/1/2026", "€37 840"], status: "active" as const },
    { id: "965141311", cells: ["ACT-9311", "Profit Test Item 2", "16/8/2026", "€41 411"], status: "pending" as const },
    { id: "965144882", cells: ["ACT-3882", "Profit Test Item 3", "3/3/2026", "€44 982"], status: "completed" as const },
    { id: "965148453", cells: ["ACT-7453", "Profit Test Item 4", "18/10/2026", "€48 553"], status: "warning" as const },
    { id: "965152024", cells: ["ACT-2024", "Profit Test Item 5", "5/5/2026", "€2124"], status: "active" as const },
];
...
export default function ActuarialSuiteProfitTestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Profit Test</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Profit Test</p>
                    </div>
                </div>
