...
/* ═══ Actuarial Suite — Reinsurance Opt ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "3542", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "332", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1508", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "83%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "271836616", cells: ["ACT-1616", "Reinsurance Opt Item 1", "17/5/2026", "€36 716"], status: "active" as const },
    { id: "271840187", cells: ["ACT-5187", "Reinsurance Opt Item 2", "4/12/2026", "€40 287"], status: "pending" as const },
    { id: "271843758", cells: ["ACT-8758", "Reinsurance Opt Item 3", "19/7/2026", "€43 858"], status: "completed" as const },
    { id: "271847329", cells: ["ACT-3329", "Reinsurance Opt Item 4", "6/2/2026", "€47 429"], status: "warning" as const },
    { id: "271850900", cells: ["ACT-6900", "Reinsurance Opt Item 5", "21/9/2026", "€1000"], status: "active" as const },
];
...
export default function ActuarialSuiteReinsuranceOptPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reinsurance Opt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Reinsurance Opt</p>
                    </div>
                </div>
