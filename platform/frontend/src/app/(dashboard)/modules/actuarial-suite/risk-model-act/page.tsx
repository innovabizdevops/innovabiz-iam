...
/* ═══ Actuarial Suite — Risk Model Act ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "2171", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "488", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "453", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "150433332", cells: ["ACT-8332", "Risk Model Act Item 1", "1/1/2026", "€33 432"], status: "active" as const },
    { id: "150436903", cells: ["ACT-2903", "Risk Model Act Item 2", "16/8/2026", "€37 003"], status: "pending" as const },
    { id: "150440474", cells: ["ACT-6474", "Risk Model Act Item 3", "3/3/2026", "€40 574"], status: "completed" as const },
    { id: "150444045", cells: ["ACT-1045", "Risk Model Act Item 4", "18/10/2026", "€44 145"], status: "warning" as const },
    { id: "150447616", cells: ["ACT-4616", "Risk Model Act Item 5", "5/5/2026", "€47 716"], status: "active" as const },
];
...
export default function ActuarialSuiteRiskModelActPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Risk Model Act</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Risk Model Act</p>
                    </div>
                </div>
