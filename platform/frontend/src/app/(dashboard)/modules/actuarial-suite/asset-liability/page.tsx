...
/* ═══ Actuarial Suite — Asset Liability ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "673", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "335", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3557", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "72%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1653802235", cells: ["ACT-8235", "Asset Liability Item 1", "16/12/2026", "€2335"], status: "active" as const },
    { id: "1653805806", cells: ["ACT-2806", "Asset Liability Item 2", "3/7/2026", "€5906"], status: "pending" as const },
    { id: "1653809377", cells: ["ACT-6377", "Asset Liability Item 3", "18/2/2026", "€9477"], status: "completed" as const },
    { id: "1653812948", cells: ["ACT-9948", "Asset Liability Item 4", "5/9/2026", "€13 048"], status: "warning" as const },
    { id: "1653816519", cells: ["ACT-4519", "Asset Liability Item 5", "20/4/2026", "€16 619"], status: "active" as const },
];
...
export default function ActuarialSuiteAssetLiabilityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Asset Liability</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Asset Liability</p>
                    </div>
                </div>
