...
/* ═══ Actuarial Suite — Loss Reserve ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "1141", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "421", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1839", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1143479329", cells: ["ACT-3329", "Loss Reserve Item 1", "14/2/2026", "€29 429"], status: "active" as const },
    { id: "1143482900", cells: ["ACT-6900", "Loss Reserve Item 2", "1/9/2026", "€33 000"], status: "pending" as const },
    { id: "1143486471", cells: ["ACT-1471", "Loss Reserve Item 3", "16/4/2026", "€36 571"], status: "completed" as const },
    { id: "1143490042", cells: ["ACT-5042", "Loss Reserve Item 4", "3/11/2026", "€40 142"], status: "warning" as const },
    { id: "1143493613", cells: ["ACT-8613", "Loss Reserve Item 5", "18/6/2026", "€43 713"], status: "active" as const },
];
...
export default function ActuarialSuiteLossReservePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loss Reserve</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Loss Reserve</p>
                    </div>
                </div>
