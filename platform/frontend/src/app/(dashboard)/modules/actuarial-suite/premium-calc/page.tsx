...
/* ═══ Actuarial Suite — Premium Calc ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "4818", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "20", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2717", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "800282144", cells: ["ACT-3144", "Premium Calc Item 1", "5/9/2026", "€32 244"], status: "active" as const },
    { id: "800285715", cells: ["ACT-6715", "Premium Calc Item 2", "20/4/2026", "€35 815"], status: "pending" as const },
    { id: "800289286", cells: ["ACT-1286", "Premium Calc Item 3", "7/11/2026", "€39 386"], status: "completed" as const },
    { id: "800292857", cells: ["ACT-4857", "Premium Calc Item 4", "22/6/2026", "€42 957"], status: "warning" as const },
    { id: "800296428", cells: ["ACT-8428", "Premium Calc Item 5", "9/1/2026", "€46 528"], status: "active" as const },
];
...
export default function ActuarialSuitePremiumCalcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Premium Calc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Premium Calc</p>
                    </div>
                </div>
