...
/* ═══ Actuarial Suite — Solvency Calc ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "4002", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "22", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "775", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2136115794", cells: ["ACT-2794", "Solvency Calc Item 1", "23/7/2026", "€15 894"], status: "active" as const },
    { id: "2136119365", cells: ["ACT-6365", "Solvency Calc Item 2", "10/2/2026", "€19 465"], status: "pending" as const },
    { id: "2136122936", cells: ["ACT-9936", "Solvency Calc Item 3", "25/9/2026", "€23 036"], status: "completed" as const },
    { id: "2136126507", cells: ["ACT-4507", "Solvency Calc Item 4", "12/4/2026", "€26 607"], status: "warning" as const },
    { id: "2136130078", cells: ["ACT-8078", "Solvency Calc Item 5", "27/11/2026", "€30 178"], status: "active" as const },
];
...
export default function ActuarialSuiteSolvencyCalcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Solvency Calc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Solvency Calc</p>
                    </div>
                </div>
