...
/* ═══ Actuarial Suite — Stochastic Sim ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "3181", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "162", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "25", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "93%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1864814846", cells: ["ACT-6846", "Stochastic Sim Item 1", "7/3/2026", "€14 946"], status: "active" as const },
    { id: "1864818417", cells: ["ACT-1417", "Stochastic Sim Item 2", "22/10/2026", "€18 517"], status: "pending" as const },
    { id: "1864821988", cells: ["ACT-4988", "Stochastic Sim Item 3", "9/5/2026", "€22 088"], status: "completed" as const },
    { id: "1864825559", cells: ["ACT-8559", "Stochastic Sim Item 4", "24/12/2026", "€25 659"], status: "warning" as const },
    { id: "1864829130", cells: ["ACT-3130", "Stochastic Sim Item 5", "11/7/2026", "€29 230"], status: "active" as const },
];
...
export default function ActuarialSuiteStochasticSimPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stochastic Sim</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Stochastic Sim</p>
                    </div>
                </div>
