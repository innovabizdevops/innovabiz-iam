...
/* ═══ Actuarial Suite — Mortality Table ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total", value: "21", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "361", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3566", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "84%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "715849397", cells: ["ACT-8397", "Mortality Table Item 1", "26/6/2026", "€49 497"], status: "active" as const },
    { id: "715852968", cells: ["ACT-2968", "Mortality Table Item 2", "13/1/2026", "€3068"], status: "pending" as const },
    { id: "715856539", cells: ["ACT-6539", "Mortality Table Item 3", "28/8/2026", "€6639"], status: "completed" as const },
    { id: "715860110", cells: ["ACT-1110", "Mortality Table Item 4", "15/3/2026", "€10 210"], status: "warning" as const },
    { id: "715863681", cells: ["ACT-4681", "Mortality Table Item 5", "2/10/2026", "€13 781"], status: "active" as const },
];
...
export default function ActuarialSuiteMortalityTablePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mortality Table</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Actuarial Suite • Mortality Table</p>
                    </div>
                </div>
