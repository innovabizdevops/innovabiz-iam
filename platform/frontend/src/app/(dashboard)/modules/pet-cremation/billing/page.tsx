...
const ACCENT = "#0f172a";
const MODULE = "Pet Cremation";
const PAGE = "Billing";
const KPIS = [{"l":"Total Pet Cremation","v":"5.941","t":"+17.6%","d":"up"},{"l":"Billing Ativos","v":"6.742","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+4.8%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Cremation #001","Pet Cremation #002","8.027","8.123","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Cremation #002","Pet Cremation #003","3.576","6.196","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Cremation #003","Pet Cremation #004","4.529","3.751","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Cremation #004","Pet Cremation #005","8.412","8.106","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Cremation #005","Pet Cremation #001","4.350","4.201","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":479},{"label":"Mar","value":534},{"label":"Abr","value":389},{"label":"Mai","value":308},{"label":"Jun","value":432},{"label":"Jul","value":499},{"label":"Ago","value":671},{"label":"Set","value":459},{"label":"Out","value":546},{"label":"Nov","value":322},{"label":"Dez","value":505}];
const MX = 671;
