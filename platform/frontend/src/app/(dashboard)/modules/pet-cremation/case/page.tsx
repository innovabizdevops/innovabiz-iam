...
const PAGE = "Case";
const KPIS = [{"l":"Total Pet Cremation","v":"3.949","t":"+8.6%","d":"up"},{"l":"Case Ativos","v":"6.701","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.0%","d":"up"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Cremation #001","Pet Cremation #002","2.457","4.921","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Cremation #002","Pet Cremation #003","1.364","4.914","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Cremation #003","Pet Cremation #004","2.591","1.964","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Cremation #004","Pet Cremation #005","7.536","1.923","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Cremation #005","Pet Cremation #001","4.388","7.092","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":723},{"label":"Mar","value":745},{"label":"Abr","value":788},{"label":"Mai","value":472},{"label":"Jun","value":567},{"label":"Jul","value":536},{"label":"Ago","value":615},{"label":"Set","value":705},{"label":"Out","value":578},{"label":"Nov","value":423},{"label":"Dez","value":579}];
const MX = 788;
