...
const PAGE = "Urn";
const KPIS = [{"l":"Total Pet Cremation","v":"6.057","t":"+13.6%","d":"up"},{"l":"Urn Ativos","v":"3.488","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+8.7%","d":"up"}];
const COLS = ["ID","Urn","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Cremation #001","Pet Cremation #002","5.537","2.253","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Cremation #002","Pet Cremation #003","575","2.030","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Cremation #003","Pet Cremation #004","3.805","8.556","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Cremation #004","Pet Cremation #005","5.034","3.608","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Cremation #005","Pet Cremation #001","6.078","5.863","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":830},{"label":"Mar","value":846},{"label":"Abr","value":695},{"label":"Mai","value":682},{"label":"Jun","value":749},{"label":"Jul","value":790},{"label":"Ago","value":712},{"label":"Set","value":573},{"label":"Out","value":622},{"label":"Nov","value":843},{"label":"Dez","value":466}];
const MX = 846;
