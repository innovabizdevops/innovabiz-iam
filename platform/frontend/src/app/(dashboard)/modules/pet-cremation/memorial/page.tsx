...
const PAGE = "Memorial";
const KPIS = [{"l":"Total Pet Cremation","v":"2.918","t":"+2.3%","d":"up"},{"l":"Memorial Ativos","v":"4.888","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"65.0%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"87","t":"+1.5%","d":"up"}];
const COLS = ["ID","Memorial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Cremation #001","Pet Cremation #002","7.964","1.717","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Cremation #002","Pet Cremation #003","3.275","8.468","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Cremation #003","Pet Cremation #004","1.941","5.929","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Cremation #004","Pet Cremation #005","4.938","8.639","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Cremation #005","Pet Cremation #001","3.295","1.237","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":336},{"label":"Mar","value":417},{"label":"Abr","value":531},{"label":"Mai","value":491},{"label":"Jun","value":632},{"label":"Jul","value":625},{"label":"Ago","value":547},{"label":"Set","value":534},{"label":"Out","value":363},{"label":"Nov","value":412},{"label":"Dez","value":459}];
const MX = 632;
