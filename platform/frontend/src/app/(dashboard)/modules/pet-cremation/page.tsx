...
/* ═══ Pet Cremation — Dashboard ═══ */

const ACCENT = "#0f172a";

const KPIS = [
    { label: "Total Registos", value: "4777", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4007", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€363K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1748770377", cells: ["PET-8377", "Pet Cremation Item 1", "26/10/2026", "€20 477"], status: "active" as const },
    { id: "1748773948", cells: ["PET-2948", "Pet Cremation Item 2", "13/5/2026", "€24 048"], status: "pending" as const },
    { id: "1748777519", cells: ["PET-6519", "Pet Cremation Item 3", "28/12/2026", "€27 619"], status: "completed" as const },
    { id: "1748781090", cells: ["PET-1090", "Pet Cremation Item 4", "15/7/2026", "€31 190"], status: "warning" as const },
    { id: "1748784661", cells: ["PET-4661", "Pet Cremation Item 5", "2/2/2026", "€34 761"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Cremation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Cremation</p>
                    </div>
                </div>
