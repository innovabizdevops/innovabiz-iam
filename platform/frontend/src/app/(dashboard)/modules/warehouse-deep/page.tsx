...
/* ═══ Warehouse Management Deep — Dashboard ═══ */

const ACCENT = "#064e3b";

const KPIS = [
    { label: "Total Registos", value: "7647", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1582", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€140K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "259922147", cells: ["WAR-3147", "Warehouse Management Deep Item 1", "24/12/2026", "€22 247"], status: "active" as const },
    { id: "259925718", cells: ["WAR-6718", "Warehouse Management Deep Item 2", "11/7/2026", "€25 818"], status: "pending" as const },
    { id: "259929289", cells: ["WAR-1289", "Warehouse Management Deep Item 3", "26/2/2026", "€29 389"], status: "completed" as const },
    { id: "259932860", cells: ["WAR-4860", "Warehouse Management Deep Item 4", "13/9/2026", "€32 960"], status: "warning" as const },
    { id: "259936431", cells: ["WAR-8431", "Warehouse Management Deep Item 5", "28/4/2026", "€36 531"], status: "active" as const },
];
...
export default function WarehouseManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Warehouse Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Warehouse Management Deep</p>
                    </div>
                </div>
