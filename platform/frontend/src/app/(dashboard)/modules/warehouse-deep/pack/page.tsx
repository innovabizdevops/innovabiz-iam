...
const ACCENT = "#064e3b";
const MODULE = "Warehouse Management Deep";
const PAGE = "Pack";
const KPIS = [{"l":"Total Warehouse Deep","v":"1.237","t":"-1.5%","d":"down"},{"l":"Pack Ativos","v":"8.096","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+17.3%","d":"up"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Deep #001","Warehouse Deep #002","7.699","5.630","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Deep #002","Warehouse Deep #003","2.495","8.028","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Deep #003","Warehouse Deep #004","8.023","119","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Deep #004","Warehouse Deep #005","7.734","586","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Deep #005","Warehouse Deep #001","7.457","1.581","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":375},{"label":"Mar","value":304},{"label":"Abr","value":567},{"label":"Mai","value":329},{"label":"Jun","value":627},{"label":"Jul","value":278},{"label":"Ago","value":375},{"label":"Set","value":565},{"label":"Out","value":320},{"label":"Nov","value":571},{"label":"Dez","value":288}];
const MX = 627;
