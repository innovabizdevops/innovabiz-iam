...
const KPIS = [{"l":"Dispositivos Online","v":"4.113","t":"-5.2%","d":"down"},{"l":"Dados/Min (MB)","v":"686","t":"+2.9%","d":"up"},{"l":"Alertas Ativos","v":"4.996","t":"+17.1%","d":"up"},{"l":"Uptime (%)","v":"88.3%","t":"+7.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.265","6.305","2.124","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.581","2.158","7.950","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.336","2.780","6.330","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.021","3.567","151","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.767","7.717","3.768","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":774},{"label":"Mar","value":690},{"label":"Abr","value":742},{"label":"Mai","value":634},{"label":"Jun","value":748},{"label":"Jul","value":878},{"label":"Ago","value":758},{"label":"Set","value":740},{"label":"Out","value":856},{"label":"Nov","value":840},{"label":"Dez","value":888}];
const MX = 888;
