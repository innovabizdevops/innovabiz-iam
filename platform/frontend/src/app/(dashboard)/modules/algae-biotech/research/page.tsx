...
const ACCENT = "#059669";
const MODULE = "Algae Biotechnology";
const PAGE = "Research";
const KPIS = [{"l":"Dispositivos Online","v":"1.972","t":"+6.5%","d":"up"},{"l":"Dados/Min (MB)","v":"3.271","t":"+4.4%","d":"up"},{"l":"Alertas Ativos","v":"2.134","t":"-2.2%","d":"down"},{"l":"Uptime (%)","v":"91.1%","t":"+11.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.285","5.429","2.914","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.189","1.613","2.471","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.963","2.624","3.825","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.840","970","5.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.842","8.956","404","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":815},{"label":"Mar","value":643},{"label":"Abr","value":631},{"label":"Mai","value":1004},{"label":"Jun","value":709},{"label":"Jul","value":950},{"label":"Ago","value":812},{"label":"Set","value":649},{"label":"Out","value":706},{"label":"Nov","value":950},{"label":"Dez","value":642}];
const MX = 1004;
