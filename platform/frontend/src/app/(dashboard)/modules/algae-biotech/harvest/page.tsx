...
const PAGE = "Harvest";
const KPIS = [{"l":"Dispositivos Online","v":"5.486","t":"+16.7%","d":"up"},{"l":"Dados/Min (MB)","v":"4.973","t":"+14.0%","d":"up"},{"l":"Alertas Ativos","v":"2.020","t":"+11.6%","d":"up"},{"l":"Uptime (%)","v":"82.8%","t":"+4.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.561","1.496","5.235","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.372","2.907","4.760","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","848","4.022","921","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.976","4.687","1.584","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.875","5.446","6.379","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":699},{"label":"Mar","value":380},{"label":"Abr","value":476},{"label":"Mai","value":688},{"label":"Jun","value":616},{"label":"Jul","value":620},{"label":"Ago","value":493},{"label":"Set","value":673},{"label":"Out","value":681},{"label":"Nov","value":553},{"label":"Dez","value":480}];
const MX = 704;
