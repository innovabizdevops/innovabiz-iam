...
const PAGE = "Process";
const KPIS = [{"l":"Dispositivos Online","v":"3.484","t":"+2.7%","d":"up"},{"l":"Dados/Min (MB)","v":"6.590","t":"+7.2%","d":"up"},{"l":"Alertas Ativos","v":"7.519","t":"+17.8%","d":"up"},{"l":"Uptime (%)","v":"87.8%","t":"+6.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.213","9.011","126","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.127","7.599","4.670","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.330","5.933","8.177","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.346","2.871","2.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.768","2.791","3.234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":688},{"label":"Mar","value":707},{"label":"Abr","value":507},{"label":"Mai","value":803},{"label":"Jun","value":529},{"label":"Jul","value":754},{"label":"Ago","value":529},{"label":"Set","value":498},{"label":"Out","value":657},{"label":"Nov","value":810},{"label":"Dez","value":750}];
const MX = 810;
