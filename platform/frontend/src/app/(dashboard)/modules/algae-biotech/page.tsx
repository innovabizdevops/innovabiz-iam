...
/* ═══ Algae Biotechnology — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "9436", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2396", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€91K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "744449736", cells: ["ALG-6736", "Algae Biotechnology Item 1", "17/1/2026", "€49 836"], status: "active" as const },
    { id: "744453307", cells: ["ALG-1307", "Algae Biotechnology Item 2", "4/8/2026", "€3407"], status: "pending" as const },
    { id: "744456878", cells: ["ALG-4878", "Algae Biotechnology Item 3", "19/3/2026", "€6978"], status: "completed" as const },
    { id: "744460449", cells: ["ALG-8449", "Algae Biotechnology Item 4", "6/10/2026", "€10 549"], status: "warning" as const },
    { id: "744464020", cells: ["ALG-3020", "Algae Biotechnology Item 5", "21/5/2026", "€14 120"], status: "active" as const },
];
...
export default function AlgaeBiotechnologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Algae Biotechnology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Algae Biotechnology</p>
                    </div>
                </div>
