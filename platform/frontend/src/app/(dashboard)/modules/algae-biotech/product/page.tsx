...
const PAGE = "Product";
const KPIS = [{"l":"Dispositivos Online","v":"872","t":"+6.5%","d":"up"},{"l":"Dados/Min (MB)","v":"6.382","t":"+2.3%","d":"up"},{"l":"Alertas Ativos","v":"1.797","t":"+7.1%","d":"up"},{"l":"Uptime (%)","v":"77.7%","t":"+1.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.453","6.646","3.454","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.772","4.678","5.559","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.284","6.425","1.534","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.816","1.572","639","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.944","7.499","3.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":401},{"label":"Mar","value":517},{"label":"Abr","value":599},{"label":"Mai","value":605},{"label":"Jun","value":372},{"label":"Jul","value":514},{"label":"Ago","value":327},{"label":"Set","value":472},{"label":"Out","value":509},{"label":"Nov","value":415},{"label":"Dez","value":541}];
const MX = 605;
