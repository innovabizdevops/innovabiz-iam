...
const PAGE = "Telemedicine";
const KPIS = [{"l":"Integrações Ativas","v":"2.981","t":"-0.8%","d":"down"},{"l":"Chamadas/Hora","v":"2802","t":"+2.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.9%","t":"+9.8%","d":"up"},{"l":"Latência Média (ms)","v":"144ms","t":"+15.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.761","8.427","73.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","414","7.948","97.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.996","3.441","87.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.469","4.055","71.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.662","9.055","88.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":641},{"label":"Mar","value":818},{"label":"Abr","value":829},{"label":"Mai","value":807},{"label":"Jun","value":765},{"label":"Jul","value":926},{"label":"Ago","value":618},{"label":"Set","value":811},{"label":"Out","value":877},{"label":"Nov","value":693},{"label":"Dez","value":907}];
const MX = 943;
