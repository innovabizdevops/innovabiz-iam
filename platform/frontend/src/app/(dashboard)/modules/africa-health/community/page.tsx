...
const KPIS = [{"l":"Projetos Sociais","v":"7.067","t":"+8.7%","d":"up"},{"l":"Beneficiários","v":"512","t":"+2.9%","d":"up"},{"l":"Investimento CSR (€)","v":"€82442","t":"+12.8%","d":"up"},{"l":"Score Impacto","v":"67","t":"+1.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.625","€ 39082.37","7.738","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.479","€ 20556.50","429","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.425","€ 43231.02","7.793","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","635","€ 12013.91","7.479","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.237","€ 44336.12","1.550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":618},{"label":"Mar","value":694},{"label":"Abr","value":585},{"label":"Mai","value":730},{"label":"Jun","value":709},{"label":"Jul","value":496},{"label":"Ago","value":640},{"label":"Set","value":647},{"label":"Out","value":775},{"label":"Nov","value":757},{"label":"Dez","value":672}];
const MX = 775;
