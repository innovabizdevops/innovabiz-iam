...
const ACCENT = "#14532d";
const MODULE = "Africa HealthTech Hub";
const PAGE = "mHealth";
const KPIS = [{"l":"Total Africa Health","v":"8.300","t":"+12.0%","d":"up"},{"l":"MHealth Ativos","v":"2.905","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.9%","d":"up"}];
const COLS = ["ID","MHealth","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Africa Health #001","Africa Health #002","1.786","2.465","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Africa Health #002","Africa Health #003","2.385","7.105","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Africa Health #003","Africa Health #004","611","6.350","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Africa Health #004","Africa Health #005","2.039","8.004","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Africa Health #005","Africa Health #001","5.593","5.197","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":781},{"label":"Mar","value":614},{"label":"Abr","value":805},{"label":"Mai","value":697},{"label":"Jun","value":581},{"label":"Jul","value":693},{"label":"Ago","value":547},{"label":"Set","value":674},{"label":"Out","value":538},{"label":"Nov","value":766},{"label":"Dez","value":876}];
const MX = 876;
...
export default function MhealthPage() {
    return (
