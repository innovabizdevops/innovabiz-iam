...
/* ═══ Africa HealthTech Hub — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "3986", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4882", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€481K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "200746186", cells: ["AFR-2186", "Africa HealthTech Hub Item 1", "19/11/2026", "€46 286"], status: "active" as const },
    { id: "200749757", cells: ["AFR-5757", "Africa HealthTech Hub Item 2", "6/6/2026", "€49 857"], status: "pending" as const },
    { id: "200753328", cells: ["AFR-9328", "Africa HealthTech Hub Item 3", "21/1/2026", "€3428"], status: "completed" as const },
    { id: "200756899", cells: ["AFR-3899", "Africa HealthTech Hub Item 4", "8/8/2026", "€6999"], status: "warning" as const },
    { id: "200760470", cells: ["AFR-7470", "Africa HealthTech Hub Item 5", "23/3/2026", "€10 570"], status: "active" as const },
];
...
export default function AfricaHealthtechHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Africa HealthTech Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Africa HealthTech Hub</p>
                    </div>
                </div>
