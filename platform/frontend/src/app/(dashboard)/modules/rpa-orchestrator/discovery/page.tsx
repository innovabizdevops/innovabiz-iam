...
const ACCENT = "#ec4899";
const MODULE = "RPA Orchestrator";
const PAGE = "Process Discovery AI";
const KPIS = [{"l":"Total Rpa Orchestrator","v":"3.281","t":"-5.6%","d":"down"},{"l":"Process Discovery AI Ativos","v":"2.153","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"88.7%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+10.4%","d":"up"}];
const COLS = ["ID","Process Discovery AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","9.052","5.858","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","2.607","4.101","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","2.394","3.536","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","2.982","2.195","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","8.897","8.267","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":576},{"label":"Mar","value":441},{"label":"Abr","value":587},{"label":"Mai","value":684},{"label":"Jun","value":418},{"label":"Jul","value":617},{"label":"Ago","value":574},{"label":"Set","value":657},{"label":"Out","value":430},{"label":"Nov","value":432},{"label":"Dez","value":514}];
const MX = 684;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>AI</span></h1>
                </div>
