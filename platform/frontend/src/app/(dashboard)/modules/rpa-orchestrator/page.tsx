...
export default function RpaOrchestratorPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Rpa Orchestrator</h1><p className="text-sm text-muted-foreground">Rpa Orchestrator • iBOS Enterprise</p></div>
