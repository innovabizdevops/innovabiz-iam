...
const PAGE = "Bot Scheduler";
const KPIS = [{"l":"Total Rpa Orchestrator","v":"4.637","t":"-3.7%","d":"down"},{"l":"Bot Scheduler Ativos","v":"6.181","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+4.4%","d":"up"}];
const COLS = ["ID","Bot Scheduler","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","5.631","5.847","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","1.632","7.876","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","7.039","6.250","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","3.863","8.683","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","8.931","5.733","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":225},{"label":"Mar","value":440},{"label":"Abr","value":233},{"label":"Mai","value":474},{"label":"Jun","value":488},{"label":"Jul","value":462},{"label":"Ago","value":242},{"label":"Set","value":517},{"label":"Out","value":519},{"label":"Nov","value":227},{"label":"Dez","value":223}];
const MX = 525;
