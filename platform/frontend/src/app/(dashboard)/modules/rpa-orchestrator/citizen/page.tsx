...
const PAGE = "Citizen Automation";
const KPIS = [{"l":"Total Rpa Orchestrator","v":"4.151","t":"+0.1%","d":"up"},{"l":"Citizen Automation Ativos","v":"2.041","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"86.9%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+17.5%","d":"up"}];
const COLS = ["ID","Citizen Automation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","2.696","6.602","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","8.948","5.394","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","3.304","3.928","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","758","997","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","6.400","3.195","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":972},{"label":"Mar","value":880},{"label":"Abr","value":958},{"label":"Mai","value":710},{"label":"Jun","value":873},{"label":"Jul","value":632},{"label":"Ago","value":709},{"label":"Set","value":925},{"label":"Out","value":992},{"label":"Nov","value":824},{"label":"Dez","value":740}];
const MX = 992;
