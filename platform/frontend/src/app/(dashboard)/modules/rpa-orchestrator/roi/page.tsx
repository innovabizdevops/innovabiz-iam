...
const KPIS = [{"l":"Total Rpa Orchestrator","v":"5.948","t":"+14.0%","d":"up"},{"l":"ROI Calculator Ativos","v":"4.440","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+7.8%","d":"up"}];
const COLS = ["ID","ROI Calculator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","5.511","2.139","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","7.657","385","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","956","6.281","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","6.605","6.498","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","5.311","5.308","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":806},{"label":"Mar","value":757},{"label":"Abr","value":969},{"label":"Mai","value":676},{"label":"Jun","value":939},{"label":"Jul","value":745},{"label":"Ago","value":885},{"label":"Set","value":828},{"label":"Out","value":884},{"label":"Nov","value":944},{"label":"Dez","value":777}];
const MX = 969;
