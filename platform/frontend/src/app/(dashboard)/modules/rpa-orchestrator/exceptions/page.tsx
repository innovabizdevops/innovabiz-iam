...
const PAGE = "Exception Queue";
const KPIS = [{"l":"Total Rpa Orchestrator","v":"2.347","t":"+8.3%","d":"up"},{"l":"Exception Queue Ativos","v":"4.277","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"67","t":"+7.9%","d":"up"}];
const COLS = ["ID","Exception Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","8.106","7.793","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","5.277","5.041","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","4.646","7.518","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","6.606","351","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","4.579","8.062","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":360},{"label":"Mar","value":409},{"label":"Abr","value":617},{"label":"Mai","value":419},{"label":"Jun","value":475},{"label":"Jul","value":549},{"label":"Ago","value":568},{"label":"Set","value":567},{"label":"Out","value":552},{"label":"Nov","value":525},{"label":"Dez","value":592}];
const MX = 617;
