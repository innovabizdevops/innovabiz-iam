...
const PAGE = "Attended Bots";
const KPIS = [{"l":"Total Rpa Orchestrator","v":"7.180","t":"-5.5%","d":"down"},{"l":"Attended Bots Ativos","v":"6.680","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"67","t":"+9.7%","d":"up"}];
const COLS = ["ID","Attended Bots","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","5.607","2.588","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","1.963","1.512","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","8.392","5.645","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","8.922","8.824","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","475","7.033","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":578},{"label":"Mar","value":486},{"label":"Abr","value":406},{"label":"Mai","value":422},{"label":"Jun","value":579},{"label":"Jul","value":421},{"label":"Ago","value":619},{"label":"Set","value":569},{"label":"Out","value":752},{"label":"Nov","value":464},{"label":"Dez","value":748}];
const MX = 785;
