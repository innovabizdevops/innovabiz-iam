...
const PAGE = "Bot Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.571","t":"-1.7%","d":"down"},{"l":"Queries/Dia","v":"3671","t":"-4.5%","d":"down"},{"l":"Dados Processados (GB)","v":"7.119","t":"-0.7%","d":"down"},{"l":"Utilizadores Analytics","v":"4.489","t":"+8.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1140","2026-02-18","1.435","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4481","2026-03-15","8.303","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1343","2026-03-28","2.846","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2667","2026-01-04","3.159","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3925","2026-03-07","8.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":513},{"label":"Mar","value":678},{"label":"Abr","value":603},{"label":"Mai","value":521},{"label":"Jun","value":779},{"label":"Jul","value":439},{"label":"Ago","value":687},{"label":"Set","value":699},{"label":"Out","value":668},{"label":"Nov","value":686},{"label":"Dez","value":522}];
const MX = 779;
