...
const PAGE = "Execution Logs";
const KPIS = [{"l":"Total Rpa Orchestrator","v":"1.286","t":"-3.9%","d":"down"},{"l":"Execution Logs Ativos","v":"1.658","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"79.0%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"62","t":"-2.7%","d":"down"}];
const COLS = ["ID","Execution Logs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","6.823","2.032","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","1.590","7.318","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","5.705","2.630","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","6.858","7.790","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","8.821","6.948","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":565},{"label":"Mar","value":322},{"label":"Abr","value":319},{"label":"Mai","value":247},{"label":"Jun","value":252},{"label":"Jul","value":553},{"label":"Ago","value":294},{"label":"Set","value":518},{"label":"Out","value":252},{"label":"Nov","value":326},{"label":"Dez","value":569}];
const MX = 569;
