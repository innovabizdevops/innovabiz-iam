...
const PAGE = "Process Recorder";
const KPIS = [{"l":"Total Rpa Orchestrator","v":"4.236","t":"-2.6%","d":"down"},{"l":"Process Recorder Ativos","v":"1.585","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"71","t":"-5.7%","d":"down"}];
const COLS = ["ID","Process Recorder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Orchestrator #001","Rpa Orchestrator #002","6.147","1.107","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Orchestrator #002","Rpa Orchestrator #003","6.908","8.319","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Orchestrator #003","Rpa Orchestrator #004","752","7.575","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Orchestrator #004","Rpa Orchestrator #005","3.556","5.030","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Orchestrator #005","Rpa Orchestrator #001","1.594","1.157","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":894},{"label":"Mar","value":648},{"label":"Abr","value":766},{"label":"Mai","value":781},{"label":"Jun","value":875},{"label":"Jul","value":921},{"label":"Ago","value":566},{"label":"Set","value":710},{"label":"Out","value":854},{"label":"Nov","value":849},{"label":"Dez","value":765}];
const MX = 921;
