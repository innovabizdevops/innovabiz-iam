...
const PAGE = "Approval Chain";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.028","t":"+6.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.1%","t":"+0.3%","d":"up"},{"l":"Tempo Médio (h)","v":"128h","t":"-3.4%","d":"down"},{"l":"Rejeitadas (%)","v":"77.8%","t":"+7.6%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.720","€ 12402.19","9.036","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.399","€ 26123.64","6.498","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.331","€ 12759.51","4.578","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.607","€ 9794.64","3.687","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.198","€ 42965.86","7.223","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":616},{"label":"Mar","value":668},{"label":"Abr","value":471},{"label":"Mai","value":831},{"label":"Jun","value":586},{"label":"Jul","value":819},{"label":"Ago","value":543},{"label":"Set","value":769},{"label":"Out","value":473},{"label":"Nov","value":710},{"label":"Dez","value":563}];
const MX = 831;
