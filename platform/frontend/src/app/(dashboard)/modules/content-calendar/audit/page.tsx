...
const PAGE = "Content Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.030","t":"+17.9%","d":"up"},{"l":"NC Abertas","v":"467","t":"+12.4%","d":"up"},{"l":"Conformidade (%)","v":"66.3%","t":"+5.5%","d":"up"},{"l":"CAPAs Pendentes","v":"472","t":"-3.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.437","73.1%","6.674","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.129","74.3%","5.219","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.613","85.4%","7.968","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.711","89.7%","3.273","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.503","80.9%","294","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":749},{"label":"Mar","value":735},{"label":"Abr","value":592},{"label":"Mai","value":619},{"label":"Jun","value":857},{"label":"Jul","value":490},{"label":"Ago","value":788},{"label":"Set","value":840},{"label":"Out","value":580},{"label":"Nov","value":742},{"label":"Dez","value":606}];
const MX = 857;
