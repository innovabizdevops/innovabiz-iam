...
const PAGE = "Workflow";
const KPIS = [{"l":"Total Content Calendar","v":"8.017","t":"+17.7%","d":"up"},{"l":"Workflow Ativos","v":"8.332","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"58","t":"+11.1%","d":"up"}];
const COLS = ["ID","Workflow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Calendar #001","Content Calendar #002","6.043","7.867","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Content Calendar #002","Content Calendar #003","1.512","8.563","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Calendar #003","Content Calendar #004","7.383","1.049","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Content Calendar #004","Content Calendar #005","4.043","1.810","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Calendar #005","Content Calendar #001","5.902","1.650","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":1004},{"label":"Mar","value":674},{"label":"Abr","value":803},{"label":"Mai","value":872},{"label":"Jun","value":736},{"label":"Jul","value":856},{"label":"Ago","value":839},{"label":"Set","value":756},{"label":"Out","value":799},{"label":"Nov","value":842},{"label":"Dez","value":699}];
const MX = 1004;
