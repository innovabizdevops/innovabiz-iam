...
const PAGE = "Editorial Plan";
const KPIS = [{"l":"Integrações Ativas","v":"3.835","t":"+5.6%","d":"up"},{"l":"Chamadas/Hora","v":"1819","t":"+5.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.0%","t":"-3.9%","d":"down"},{"l":"Latência Média (ms)","v":"202ms","t":"+10.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.780","3.371","70.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.219","3.933","93.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.899","3.054","97.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.119","8.404","77.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.994","5.485","87.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":455},{"label":"Mar","value":335},{"label":"Abr","value":590},{"label":"Mai","value":396},{"label":"Jun","value":347},{"label":"Jul","value":291},{"label":"Ago","value":486},{"label":"Set","value":556},{"label":"Out","value":560},{"label":"Nov","value":341},{"label":"Dez","value":529}];
const MX = 590;
