...
const ACCENT = "#0e7490";
const MODULE = "Content Calendar";
const PAGE = "Channel Mix";
const KPIS = [{"l":"Total Content Calendar","v":"7.808","t":"+10.5%","d":"up"},{"l":"Channel Mix Ativos","v":"4.055","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"90","t":"+17.8%","d":"up"}];
const COLS = ["ID","Channel Mix","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Calendar #001","Content Calendar #002","7.992","4.916","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Content Calendar #002","Content Calendar #003","596","8.565","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Calendar #003","Content Calendar #004","6.160","3.818","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Content Calendar #004","Content Calendar #005","3.631","1.940","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Calendar #005","Content Calendar #001","7.605","4.838","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":703},{"label":"Mar","value":905},{"label":"Abr","value":644},{"label":"Mai","value":877},{"label":"Jun","value":736},{"label":"Jul","value":813},{"label":"Ago","value":716},{"label":"Set","value":857},{"label":"Out","value":824},{"label":"Nov","value":712},{"label":"Dez","value":620}];
const MX = 927;
