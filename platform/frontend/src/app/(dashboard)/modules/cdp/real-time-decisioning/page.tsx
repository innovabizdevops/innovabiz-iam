...
const ACCENT = "#06b6d4";
const MODULE = "Customer Data Platform";
const PAGE = "Real-Time Decisioning";
const KPIS = [{"l":"Perfis Unificados","v":"4.581","t":"+3.2%","d":"up"},{"l":"Segmentos Ativos","v":"5.807","t":"+1.5%","d":"up"},{"l":"NPS Score","v":"57","t":"+16.2%","d":"up"},{"l":"Churn Previsto (%)","v":"66.6%","t":"-0.2%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","8.551","€ 37848.28","89.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","5.184","€ 36577.55","84.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.876","€ 39717.14","79.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.024","€ 49413.40","98.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.583","€ 42571.38","74.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":822},{"label":"Mar","value":594},{"label":"Abr","value":573},{"label":"Mai","value":880},{"label":"Jun","value":795},{"label":"Jul","value":730},{"label":"Ago","value":711},{"label":"Set","value":732},{"label":"Out","value":614},{"label":"Nov","value":832},{"label":"Dez","value":648}];
const MX = 880;
...
export default function RealTimeDecisioningPage() {
    return (
