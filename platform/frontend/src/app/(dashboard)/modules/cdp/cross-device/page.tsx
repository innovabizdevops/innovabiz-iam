...
const PAGE = "Cross-Device Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.181","t":"+7.3%","d":"up"},{"l":"Sessões/Dia","v":"3861","t":"+10.3%","d":"up"},{"l":"MFA Adoção (%)","v":"87.5%","t":"+2.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.272","t":"+14.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.184","5.523","5.132","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.914","2.429","1.215","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.292","3.901","286","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.112","7.477","7.401","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.681","3.824","843","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":364},{"label":"Mar","value":491},{"label":"Abr","value":562},{"label":"Mai","value":456},{"label":"Jun","value":258},{"label":"Jul","value":544},{"label":"Ago","value":550},{"label":"Set","value":590},{"label":"Out","value":264},{"label":"Nov","value":530},{"label":"Dez","value":588}];
const MX = 590;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#06b6d4'}}>New</span></h1>
                </div>
