...
const PAGE = "Lookalike Audiences";
const KPIS = [{"l":"Perfis Unificados","v":"7.892","t":"+1.1%","d":"up"},{"l":"Segmentos Ativos","v":"2.214","t":"+2.1%","d":"up"},{"l":"NPS Score","v":"79","t":"+7.3%","d":"up"},{"l":"Churn Previsto (%)","v":"65.2%","t":"+5.2%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.853","€ 8427.01","93.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","112","€ 9642.80","90.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.392","€ 17293.31","92.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","7.849","€ 17227.04","95.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.626","€ 17475.51","97.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":721},{"label":"Mar","value":872},{"label":"Abr","value":884},{"label":"Mai","value":817},{"label":"Jun","value":826},{"label":"Jul","value":607},{"label":"Ago","value":608},{"label":"Set","value":888},{"label":"Out","value":862},{"label":"Nov","value":840},{"label":"Dez","value":580}];
const MX = 888;
