...
const PAGE = "Clinical Data Mgmt";
const KPIS = [{"l":"Total Pharma Lifesci","v":"5.502","t":"+14.5%","d":"up"},{"l":"Clinical Data Mgmt Ativos","v":"7.795","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"89.6%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"64","t":"+6.8%","d":"up"}];
const COLS = ["ID","Clinical Data Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Lifesci #001","2026-01-02","4.713","2.660","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Lifesci #002","2026-01-14","1.887","1.156","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Lifesci #003","2026-01-12","8.342","7.939","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Lifesci #004","2026-03-15","8.279","2.725","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Lifesci #005","2026-03-12","6.536","153","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":457},{"label":"Mar","value":453},{"label":"Abr","value":762},{"label":"Mai","value":682},{"label":"Jun","value":487},{"label":"Jul","value":572},{"label":"Ago","value":525},{"label":"Set","value":811},{"label":"Out","value":684},{"label":"Nov","value":588},{"label":"Dez","value":759}];
const MX = 811;
