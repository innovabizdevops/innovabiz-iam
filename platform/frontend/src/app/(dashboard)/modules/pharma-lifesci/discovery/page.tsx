...
const ACCENT = "#0e7490";
const MODULE = "Pharma & Life Sciences";
const PAGE = "Drug Discovery AI";
const KPIS = [{"l":"Total Pharma Lifesci","v":"6.362","t":"+1.9%","d":"up"},{"l":"Drug Discovery AI Ativos","v":"5.734","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"94","t":"+7.4%","d":"up"}];
const COLS = ["ID","Drug Discovery AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Lifesci #001","Pharma Lifesci #002","6.752","1.157","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Lifesci #002","Pharma Lifesci #003","2.699","1.636","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Lifesci #003","Pharma Lifesci #004","4.214","4.466","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Lifesci #004","Pharma Lifesci #005","4.214","8.660","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Lifesci #005","Pharma Lifesci #001","4.384","2.972","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":539},{"label":"Mar","value":307},{"label":"Abr","value":663},{"label":"Mai","value":614},{"label":"Jun","value":612},{"label":"Jul","value":465},{"label":"Ago","value":330},{"label":"Set","value":595},{"label":"Out","value":355},{"label":"Nov","value":445},{"label":"Dez","value":651}];
const MX = 663;
