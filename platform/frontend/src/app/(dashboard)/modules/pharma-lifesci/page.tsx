...
export default function PharmaLifesciPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pharma Lifesci</h1><p className="text-sm text-muted-foreground">Pharma Lifesci • iBOS Enterprise</p></div>
