...
const PAGE = "Medical Writing AI";
const KPIS = [{"l":"Integrações Ativas","v":"6.836","t":"-1.0%","d":"down"},{"l":"Chamadas/Hora","v":"3908","t":"+1.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.9%","t":"+3.7%","d":"up"},{"l":"Latência Média (ms)","v":"180ms","t":"+5.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","208","915","92.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.413","2.328","99.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.254","7.936","77.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.391","6.053","90.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.379","8.083","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":599},{"label":"Mar","value":506},{"label":"Abr","value":664},{"label":"Mai","value":666},{"label":"Jun","value":524},{"label":"Jul","value":385},{"label":"Ago","value":601},{"label":"Set","value":405},{"label":"Out","value":304},{"label":"Nov","value":640},{"label":"Dez","value":506}];
const MX = 666;
...
export default function MedwritePage() {
    return (
