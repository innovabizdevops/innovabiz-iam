...
const PAGE = "Pharmacovigilance";
const KPIS = [{"l":"Total Pharma Lifesci","v":"7.911","t":"+15.8%","d":"up"},{"l":"Pharmacovigilance Ativos","v":"6.379","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"81.4%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"75","t":"+12.5%","d":"up"}];
const COLS = ["ID","Pharmacovigilance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Lifesci #001","Pharma Lifesci #002","9.057","7.896","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Lifesci #002","Pharma Lifesci #003","6.478","5.851","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Lifesci #003","Pharma Lifesci #004","1.581","8.494","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Lifesci #004","Pharma Lifesci #005","1.766","3.417","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Lifesci #005","Pharma Lifesci #001","3.223","2.188","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":683},{"label":"Mar","value":664},{"label":"Abr","value":662},{"label":"Mai","value":973},{"label":"Jun","value":755},{"label":"Jul","value":741},{"label":"Ago","value":1029},{"label":"Set","value":767},{"label":"Out","value":944},{"label":"Nov","value":670},{"label":"Dez","value":967}];
const MX = 1029;
...
export default function PharmacovPage() {
    return (
