...
const PAGE = "Medical Affairs";
const KPIS = [{"l":"Integrações Ativas","v":"6.654","t":"+15.5%","d":"up"},{"l":"Chamadas/Hora","v":"3718","t":"+8.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.7%","t":"-1.6%","d":"down"},{"l":"Latência Média (ms)","v":"190ms","t":"-5.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","705","3.941","82.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.320","7.160","89.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.582","985","98.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.890","8.708","83.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.318","2.742","88.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":588},{"label":"Mar","value":529},{"label":"Abr","value":478},{"label":"Mai","value":622},{"label":"Jun","value":362},{"label":"Jul","value":520},{"label":"Ago","value":537},{"label":"Set","value":654},{"label":"Out","value":544},{"label":"Nov","value":680},{"label":"Dez","value":577}];
const MX = 680;
