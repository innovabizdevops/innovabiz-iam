...
const PAGE = "RIMS Integration";
const KPIS = [{"l":"Integrações Ativas","v":"2.063","t":"-0.2%","d":"down"},{"l":"Chamadas/Hora","v":"4432","t":"-5.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"81.3%","t":"+12.9%","d":"up"},{"l":"Latência Média (ms)","v":"148ms","t":"+2.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.217","2.093","90.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","580","2.933","92.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.701","1.584","98.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.551","5.917","83.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.680","4.328","89.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":423},{"label":"Mar","value":426},{"label":"Abr","value":704},{"label":"Mai","value":425},{"label":"Jun","value":580},{"label":"Jul","value":522},{"label":"Ago","value":590},{"label":"Set","value":599},{"label":"Out","value":407},{"label":"Nov","value":526},{"label":"Dez","value":644}];
const MX = 704;
