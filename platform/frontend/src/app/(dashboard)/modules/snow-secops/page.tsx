...
/* ═══ Security Operations (SNOW) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "8314", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3496", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€46K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "522985614", cells: ["SNO-5614", "Security Operations (SNOW) Item 1", "19/7/2026", "€35 714"], status: "active" as const },
    { id: "522989185", cells: ["SNO-9185", "Security Operations (SNOW) Item 2", "6/2/2026", "€39 285"], status: "pending" as const },
    { id: "522992756", cells: ["SNO-3756", "Security Operations (SNOW) Item 3", "21/9/2026", "€42 856"], status: "completed" as const },
    { id: "522996327", cells: ["SNO-7327", "Security Operations (SNOW) Item 4", "8/4/2026", "€46 427"], status: "warning" as const },
    { id: "522999898", cells: ["SNO-1898", "Security Operations (SNOW) Item 5", "23/11/2026", "€49 998"], status: "active" as const },
];
...
export default function SecurityOperationsSnowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Security Operations (SNOW)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Security Operations (SNOW)</p>
                    </div>
                </div>
