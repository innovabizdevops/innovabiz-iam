...
const PAGE = "SIEM";
const KPIS = [{"l":"Total Snow Secops","v":"8.287","t":"+1.9%","d":"up"},{"l":"SIEM Ativos","v":"5.161","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"77.5%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"58","t":"+17.9%","d":"up"}];
const COLS = ["ID","SIEM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Secops #001","Snow Secops #002","8.424","8.917","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Secops #002","Snow Secops #003","6.068","6.362","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Secops #003","Snow Secops #004","658","3.486","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Secops #004","Snow Secops #005","3.632","711","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Secops #005","Snow Secops #001","7.899","8.860","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":450},{"label":"Mar","value":538},{"label":"Abr","value":461},{"label":"Mai","value":505},{"label":"Jun","value":247},{"label":"Jul","value":485},{"label":"Ago","value":492},{"label":"Set","value":267},{"label":"Out","value":458},{"label":"Nov","value":358},{"label":"Dez","value":449}];
const MX = 560;
