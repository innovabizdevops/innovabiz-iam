...
const ACCENT = "#81b5a1";
const MODULE = "Security Operations (SNOW)";
const PAGE = "Threat";
const KPIS = [{"l":"Total Snow Secops","v":"2.953","t":"-3.8%","d":"down"},{"l":"Threat Ativos","v":"469","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"61","t":"+9.4%","d":"up"}];
const COLS = ["ID","Threat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Secops #001","Snow Secops #002","3.901","4.945","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Secops #002","Snow Secops #003","7.282","1.301","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Secops #003","Snow Secops #004","417","1.578","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Secops #004","Snow Secops #005","6.584","5.466","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Secops #005","Snow Secops #001","1.039","1.541","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":842},{"label":"Mar","value":663},{"label":"Abr","value":754},{"label":"Mai","value":924},{"label":"Jun","value":796},{"label":"Jul","value":767},{"label":"Ago","value":948},{"label":"Set","value":674},{"label":"Out","value":576},{"label":"Nov","value":836},{"label":"Dez","value":779}];
const MX = 948;
