...
const PAGE = "SOAR";
const KPIS = [{"l":"Total Snow Secops","v":"1.638","t":"+6.7%","d":"up"},{"l":"SOAR Ativos","v":"6.383","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"73","t":"-2.5%","d":"down"}];
const COLS = ["ID","SOAR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Secops #001","Snow Secops #002","6.094","5.123","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Secops #002","Snow Secops #003","6.034","4.258","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Secops #003","Snow Secops #004","4.265","4.606","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Secops #004","Snow Secops #005","3.063","8.558","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Secops #005","Snow Secops #001","2.906","8.142","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":853},{"label":"Mar","value":690},{"label":"Abr","value":864},{"label":"Mai","value":948},{"label":"Jun","value":824},{"label":"Jul","value":785},{"label":"Ago","value":840},{"label":"Set","value":639},{"label":"Out","value":902},{"label":"Nov","value":977},{"label":"Dez","value":762}];
const MX = 977;
