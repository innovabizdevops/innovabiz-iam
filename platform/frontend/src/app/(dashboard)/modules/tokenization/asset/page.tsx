...
const ACCENT = "#9333ea";
const MODULE = "Tokenization Platform";
const PAGE = "Asset Token";
const KPIS = [{"l":"Ativos Registados","v":"2.478","t":"+12.7%","d":"up"},{"l":"Valor Total (€M)","v":"€23.0M","t":"+15.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€48674","t":"-2.3%","d":"down"},{"l":"Ativos em Garantia","v":"7.090","t":"+14.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 43202.50","3.892","€ 8593.52","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 2337.98","3.434","€ 40989.00","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 26510.75","774","€ 16724.57","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 47927.15","2.032","€ 42375.85","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 25731.49","1.765","€ 9543.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":692},{"label":"Mar","value":917},{"label":"Abr","value":916},{"label":"Mai","value":891},{"label":"Jun","value":727},{"label":"Jul","value":1022},{"label":"Ago","value":903},{"label":"Set","value":774},{"label":"Out","value":905},{"label":"Nov","value":1009},{"label":"Dez","value":922}];
const MX = 1022;
