...
const PAGE = "Custody";
const KPIS = [{"l":"Total Tokenization","v":"1.593","t":"+11.9%","d":"up"},{"l":"Custody Ativos","v":"€55974","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"79","t":"+16.2%","d":"up"}];
const COLS = ["ID","Custody","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tokenization #001","€ 50097.12","1.261","8.882","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Tokenization #002","€ 44375.01","3.345","4.101","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Tokenization #003","€ 45454.98","2.408","940","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Tokenization #004","€ 17315.15","1.054","964","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tokenization #005","€ 24556.22","6.289","4.847","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":607},{"label":"Mar","value":731},{"label":"Abr","value":388},{"label":"Mai","value":415},{"label":"Jun","value":588},{"label":"Jul","value":523},{"label":"Ago","value":778},{"label":"Set","value":587},{"label":"Out","value":540},{"label":"Nov","value":507},{"label":"Dez","value":526}];
const MX = 778;
