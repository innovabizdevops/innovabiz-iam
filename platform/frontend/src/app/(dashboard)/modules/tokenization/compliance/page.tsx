...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.361","t":"-0.8%","d":"down"},{"l":"NC Abertas","v":"4.693","t":"+5.5%","d":"up"},{"l":"Conformidade (%)","v":"85.7%","t":"-5.3%","d":"down"},{"l":"CAPAs Pendentes","v":"7.717","t":"+5.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.429","82.7%","3.888","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.228","76.1%","251","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.866","89.2%","1.490","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.113","74.5%","450","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.162","79.8%","158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":548},{"label":"Mar","value":783},{"label":"Abr","value":897},{"label":"Mai","value":556},{"label":"Jun","value":738},{"label":"Jul","value":901},{"label":"Ago","value":924},{"label":"Set","value":592},{"label":"Out","value":700},{"label":"Nov","value":912},{"label":"Dez","value":668}];
const MX = 924;
