...
/* ═══ Tokenization Platform — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "4374", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4737", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€367K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "507042674", cells: ["TOK-1674", "Tokenization Platform Item 1", "27/3/2026", "€42 774"], status: "active" as const },
    { id: "507046245", cells: ["TOK-5245", "Tokenization Platform Item 2", "14/10/2026", "€46 345"], status: "pending" as const },
    { id: "507049816", cells: ["TOK-8816", "Tokenization Platform Item 3", "1/5/2026", "€49 916"], status: "completed" as const },
    { id: "507053387", cells: ["TOK-3387", "Tokenization Platform Item 4", "16/12/2026", "€3487"], status: "warning" as const },
    { id: "507056958", cells: ["TOK-6958", "Tokenization Platform Item 5", "3/7/2026", "€7058"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tokenization Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tokenization Platform</p>
                    </div>
                </div>
