...
const KPIS = [{"l":"Fornecedores Ativos","v":"965","t":"+5.2%","d":"up"},{"l":"Contratos (€M)","v":"€28.0M","t":"+5.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"77.6%","t":"+6.7%","d":"up"},{"l":"Score Médio","v":"67","t":"+4.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","90.4%","€ 43423.42","3.755","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","85.7%","€ 7764.65","3.258","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","78.1%","€ 660.02","8.921","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","85.7%","€ 17264.39","4.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","76.2%","€ 34982.36","6.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":725},{"label":"Mar","value":935},{"label":"Abr","value":950},{"label":"Mai","value":953},{"label":"Jun","value":848},{"label":"Jul","value":807},{"label":"Ago","value":776},{"label":"Set","value":785},{"label":"Out","value":715},{"label":"Nov","value":815},{"label":"Dez","value":611}];
const MX = 953;
