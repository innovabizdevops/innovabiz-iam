...
const ACCENT = "#6366f1";
const MODULE = "Gov Procurement";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"4.636","t":"+17.8%","d":"up"},{"l":"Valor Total (€M)","v":"€16.1M","t":"+9.3%","d":"up"},{"l":"Renovações Próx. 30d","v":"607","t":"+17.9%","d":"up"},{"l":"Obrigações Pendentes","v":"8.979","t":"+6.4%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 8931.93","2026-01-17","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 9086.54","2026-01-25","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 14330.29","2026-03-18","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 12656.84","2026-03-22","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 41327.90","2026-01-26","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":293},{"label":"Mar","value":583},{"label":"Abr","value":282},{"label":"Mai","value":279},{"label":"Jun","value":507},{"label":"Jul","value":590},{"label":"Ago","value":287},{"label":"Set","value":414},{"label":"Out","value":328},{"label":"Nov","value":293},{"label":"Dez","value":592}];
const MX = 592;
