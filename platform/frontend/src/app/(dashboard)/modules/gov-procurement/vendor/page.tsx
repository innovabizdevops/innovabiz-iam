...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"8.243","t":"+1.1%","d":"up"},{"l":"Contratos (€M)","v":"€31.4M","t":"+1.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"82.5%","t":"+1.8%","d":"up"},{"l":"Score Médio","v":"73","t":"+14.8%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.1%","€ 14098.95","5.445","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","93.6%","€ 50089.31","8.287","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","82.5%","€ 1922.68","6.077","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","91.2%","€ 6946.45","8.678","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","83.6%","€ 26831.55","2.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":623},{"label":"Mar","value":689},{"label":"Abr","value":664},{"label":"Mai","value":685},{"label":"Jun","value":395},{"label":"Jul","value":665},{"label":"Ago","value":505},{"label":"Set","value":406},{"label":"Out","value":573},{"label":"Nov","value":700},{"label":"Dez","value":417}];
const MX = 700;
