...
const PAGE = "E-Tender";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.016","t":"+10.0%","d":"up"},{"l":"Contratos (€M)","v":"€6.3M","t":"-0.1%","d":"down"},{"l":"On-Time Delivery (%)","v":"71.6%","t":"+0.6%","d":"up"},{"l":"Score Médio","v":"69","t":"+13.2%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","90.7%","€ 17858.45","1.878","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","85.4%","€ 22963.48","1.406","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","84.6%","€ 32506.62","9.010","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","75.3%","€ 40498.20","3.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","70.3%","€ 36742.80","9.041","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":832},{"label":"Mar","value":477},{"label":"Abr","value":809},{"label":"Mai","value":481},{"label":"Jun","value":621},{"label":"Jul","value":809},{"label":"Ago","value":646},{"label":"Set","value":597},{"label":"Out","value":745},{"label":"Nov","value":813},{"label":"Dez","value":684}];
const MX = 838;
