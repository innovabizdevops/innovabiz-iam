...
const ACCENT = "#3730a3";
const MODULE = "Rapid Prototyping";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.472","t":"-0.9%","d":"down"},{"l":"Submissões/Dia","v":"4209","t":"-0.7%","d":"down"},{"l":"Documentos Gerados","v":"8.917","t":"+15.0%","d":"up"},{"l":"Templates","v":"7.158","t":"-2.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.570","2026-01-23","9.062","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.052","2026-02-17","2.168","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.662","2026-03-23","6.229","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","932","2026-01-04","1.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.348","2026-02-21","8.880","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":307},{"label":"Mar","value":621},{"label":"Abr","value":339},{"label":"Mai","value":564},{"label":"Jun","value":290},{"label":"Jul","value":371},{"label":"Ago","value":605},{"label":"Set","value":505},{"label":"Out","value":549},{"label":"Nov","value":602},{"label":"Dez","value":557}];
const MX = 621;
