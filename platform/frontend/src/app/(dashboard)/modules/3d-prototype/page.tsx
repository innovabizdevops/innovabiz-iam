...
/* ═══ Rapid Prototyping — Dashboard ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total Registos", value: "9353", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4942", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€448K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1937855053", cells: ["3D-3053", "Rapid Prototyping Item 1", "2/2/2026", "€5153"], status: "active" as const },
    { id: "1937858624", cells: ["3D-6624", "Rapid Prototyping Item 2", "17/9/2026", "€8724"], status: "pending" as const },
    { id: "1937862195", cells: ["3D-1195", "Rapid Prototyping Item 3", "4/4/2026", "€12 295"], status: "completed" as const },
    { id: "1937865766", cells: ["3D-4766", "Rapid Prototyping Item 4", "19/11/2026", "€15 866"], status: "warning" as const },
    { id: "1937869337", cells: ["3D-8337", "Rapid Prototyping Item 5", "6/6/2026", "€19 437"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rapid Prototyping</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Rapid Prototyping</p>
                    </div>
                </div>
