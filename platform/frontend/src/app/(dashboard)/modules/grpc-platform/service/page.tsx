...
const ACCENT = "#0d9488";
const MODULE = "gRPC Platform";
const PAGE = "Service";
const KPIS = [{"l":"Formulários Ativos","v":"8.329","t":"+16.2%","d":"up"},{"l":"Submissões/Dia","v":"1840","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"1.894","t":"-1.6%","d":"down"},{"l":"Templates","v":"6.051","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.441","2026-01-05","6.708","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.665","2026-03-21","1.214","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.539","2026-01-03","3.257","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.129","2026-01-19","6.714","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.939","2026-01-15","1.707","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":726},{"label":"Mar","value":440},{"label":"Abr","value":572},{"label":"Mai","value":518},{"label":"Jun","value":794},{"label":"Jul","value":551},{"label":"Ago","value":425},{"label":"Set","value":496},{"label":"Out","value":519},{"label":"Nov","value":416},{"label":"Dez","value":440}];
const MX = 794;
