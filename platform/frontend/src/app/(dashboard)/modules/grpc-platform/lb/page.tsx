...
const KPIS = [{"l":"Formulários Ativos","v":"1.928","t":"+12.6%","d":"up"},{"l":"Submissões/Dia","v":"2184","t":"+14.4%","d":"up"},{"l":"Documentos Gerados","v":"5.989","t":"+9.3%","d":"up"},{"l":"Templates","v":"7.772","t":"+1.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","469","2026-02-11","664","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.580","2026-02-27","5.626","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.541","2026-02-06","230","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.812","2026-03-21","1.292","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.176","2026-03-20","3.281","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":631},{"label":"Mar","value":765},{"label":"Abr","value":702},{"label":"Mai","value":513},{"label":"Jun","value":716},{"label":"Jul","value":611},{"label":"Ago","value":684},{"label":"Set","value":669},{"label":"Out","value":830},{"label":"Nov","value":837},{"label":"Dez","value":696}];
const MX = 837;
