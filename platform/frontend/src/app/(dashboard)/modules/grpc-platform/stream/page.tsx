...
const PAGE = "Stream";
const KPIS = [{"l":"Formulários Ativos","v":"975","t":"-3.0%","d":"down"},{"l":"Submissões/Dia","v":"3175","t":"+17.7%","d":"up"},{"l":"Documentos Gerados","v":"5.211","t":"+9.8%","d":"up"},{"l":"Templates","v":"377","t":"+16.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.511","2026-03-21","7.897","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.759","2026-03-26","7.077","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.438","2026-01-15","5.818","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.610","2026-01-07","2.640","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.077","2026-02-19","4.384","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":668},{"label":"Mar","value":828},{"label":"Abr","value":694},{"label":"Mai","value":839},{"label":"Jun","value":800},{"label":"Jul","value":715},{"label":"Ago","value":629},{"label":"Set","value":838},{"label":"Out","value":819},{"label":"Nov","value":897},{"label":"Dez","value":731}];
const MX = 897;
