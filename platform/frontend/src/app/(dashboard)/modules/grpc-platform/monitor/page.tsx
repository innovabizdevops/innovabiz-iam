...
const PAGE = "Monitor";
const KPIS = [{"l":"Formulários Ativos","v":"7.883","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"3502","t":"+18.0%","d":"up"},{"l":"Documentos Gerados","v":"7.842","t":"+11.0%","d":"up"},{"l":"Templates","v":"4.373","t":"+13.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.872","2026-03-28","5.222","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.806","2026-03-03","7.171","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.335","2026-01-08","2.018","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.098","2026-03-15","4.673","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.550","2026-02-27","860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":994},{"label":"Mar","value":918},{"label":"Abr","value":937},{"label":"Mai","value":699},{"label":"Jun","value":1038},{"label":"Jul","value":770},{"label":"Ago","value":798},{"label":"Set","value":741},{"label":"Out","value":1070},{"label":"Nov","value":977},{"label":"Dez","value":869}];
const MX = 1070;
