...
const PAGE = "Proto";
const KPIS = [{"l":"Formulários Ativos","v":"438","t":"+0.0%","d":"up"},{"l":"Submissões/Dia","v":"2711","t":"+15.6%","d":"up"},{"l":"Documentos Gerados","v":"8.990","t":"+16.1%","d":"up"},{"l":"Templates","v":"7.631","t":"+12.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.698","2026-02-13","342","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.534","2026-01-08","8.104","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.921","2026-03-23","8.382","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","990","2026-03-14","7.943","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.142","2026-01-15","2.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":625},{"label":"Mar","value":699},{"label":"Abr","value":647},{"label":"Mai","value":765},{"label":"Jun","value":668},{"label":"Jul","value":745},{"label":"Ago","value":932},{"label":"Set","value":672},{"label":"Out","value":664},{"label":"Nov","value":914},{"label":"Dez","value":708}];
const MX = 932;
