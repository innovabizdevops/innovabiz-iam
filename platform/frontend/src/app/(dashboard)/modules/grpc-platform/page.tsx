...
/* ═══ gRPC Platform — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "6691", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1243", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€190K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1682709591", cells: ["GRP-7591", "gRPC Platform Item 1", "4/4/2026", "€9691"], status: "active" as const },
    { id: "1682713162", cells: ["GRP-2162", "gRPC Platform Item 2", "19/11/2026", "€13 262"], status: "pending" as const },
    { id: "1682716733", cells: ["GRP-5733", "gRPC Platform Item 3", "6/6/2026", "€16 833"], status: "completed" as const },
    { id: "1682720304", cells: ["GRP-9304", "gRPC Platform Item 4", "21/1/2026", "€20 404"], status: "warning" as const },
    { id: "1682723875", cells: ["GRP-3875", "gRPC Platform Item 5", "8/8/2026", "€23 975"], status: "active" as const },
];
...
export default function GrpcPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">gRPC Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • gRPC Platform</p>
                    </div>
                </div>
