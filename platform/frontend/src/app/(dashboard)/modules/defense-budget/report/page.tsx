...
const PAGE = "Report";
const KPIS = [{"l":"Total Defense Budget","v":"€79902","t":"-1.7%","d":"down"},{"l":"Report Ativos","v":"5.012","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"80","t":"-5.7%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Budget #001","Defense Budget #002","6.447","6.316","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Budget #002","Defense Budget #003","5.535","5.280","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Budget #003","Defense Budget #004","4.052","1.457","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Budget #004","Defense Budget #005","5.583","8.983","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Budget #005","Defense Budget #001","434","5.594","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":620},{"label":"Mar","value":876},{"label":"Abr","value":660},{"label":"Mai","value":667},{"label":"Jun","value":734},{"label":"Jul","value":588},{"label":"Ago","value":918},{"label":"Set","value":653},{"label":"Out","value":632},{"label":"Nov","value":831},{"label":"Dez","value":837}];
const MX = 918;
