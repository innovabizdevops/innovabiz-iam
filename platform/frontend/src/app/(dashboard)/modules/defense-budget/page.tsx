...
/* ═══ Defense Budget — Dashboard ═══ */

const ACCENT = "#94a3b8";

const KPIS = [
    { label: "Total Registos", value: "3849", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1130", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€297K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "895666649", cells: ["DEF-5649", "Defense Budget Item 1", "18/6/2026", "€16 749"], status: "active" as const },
    { id: "895670220", cells: ["DEF-9220", "Defense Budget Item 2", "5/1/2026", "€20 320"], status: "pending" as const },
    { id: "895673791", cells: ["DEF-3791", "Defense Budget Item 3", "20/8/2026", "€23 891"], status: "completed" as const },
    { id: "895677362", cells: ["DEF-7362", "Defense Budget Item 4", "7/3/2026", "€27 462"], status: "warning" as const },
    { id: "895680933", cells: ["DEF-1933", "Defense Budget Item 5", "22/10/2026", "€31 033"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Defense Budget</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Defense Budget</p>
                    </div>
                </div>
