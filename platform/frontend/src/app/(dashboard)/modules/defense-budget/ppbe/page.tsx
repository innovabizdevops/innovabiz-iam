...
const ACCENT = "#94a3b8";
const MODULE = "Defense Budget";
const PAGE = "PPBE";
const KPIS = [{"l":"Total Defense Budget","v":"€40121","t":"-2.7%","d":"down"},{"l":"PPBE Ativos","v":"4.151","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+0.1%","d":"up"}];
const COLS = ["ID","PPBE","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Budget #001","Defense Budget #002","2.438","8.390","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Budget #002","Defense Budget #003","2.855","7.823","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Budget #003","Defense Budget #004","6.602","7.665","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Budget #004","Defense Budget #005","263","7.706","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Budget #005","Defense Budget #001","4.329","336","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":355},{"label":"Mar","value":520},{"label":"Abr","value":260},{"label":"Mai","value":508},{"label":"Jun","value":555},{"label":"Jul","value":288},{"label":"Ago","value":430},{"label":"Set","value":537},{"label":"Out","value":324},{"label":"Nov","value":301},{"label":"Dez","value":467}];
const MX = 609;
...
export default function PpbePage() {
    return (
