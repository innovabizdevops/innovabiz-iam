...
const KPIS = [{"l":"Total Defense Budget","v":"€22455","t":"+13.9%","d":"up"},{"l":"Execution Ativos","v":"8.447","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"81","t":"-1.7%","d":"down"}];
const COLS = ["ID","Execution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Budget #001","Defense Budget #002","2.671","1.028","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Budget #002","Defense Budget #003","6.151","9.083","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Budget #003","Defense Budget #004","1.430","8.639","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Budget #004","Defense Budget #005","3.143","5.578","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Budget #005","Defense Budget #001","514","2.368","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":845},{"label":"Mar","value":727},{"label":"Abr","value":770},{"label":"Mai","value":735},{"label":"Jun","value":737},{"label":"Jul","value":625},{"label":"Ago","value":870},{"label":"Set","value":650},{"label":"Out","value":632},{"label":"Nov","value":903},{"label":"Dez","value":838}];
const MX = 903;
