...
const PAGE = "Forecast";
const KPIS = [{"l":"Total Defense Budget","v":"€33621","t":"+10.1%","d":"up"},{"l":"Forecast Ativos","v":"7.229","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"81","t":"-1.9%","d":"down"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Budget #001","Defense Budget #002","7.078","7.664","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Budget #002","Defense Budget #003","7.261","175","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Budget #003","Defense Budget #004","2.518","953","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Budget #004","Defense Budget #005","1.123","4.123","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Budget #005","Defense Budget #001","6.919","433","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":568},{"label":"Mar","value":626},{"label":"Abr","value":648},{"label":"Mai","value":460},{"label":"Jun","value":331},{"label":"Jul","value":532},{"label":"Ago","value":576},{"label":"Set","value":582},{"label":"Out","value":575},{"label":"Nov","value":392},{"label":"Dez","value":514}];
const MX = 648;
