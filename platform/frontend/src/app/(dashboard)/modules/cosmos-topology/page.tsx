...
/* ═══ COSMOS System Topology — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "6935", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4161", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€229K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1306876135", cells: ["COS-5135", "COSMOS System Topology Item 1", "20/8/2026", "€26 235"], status: "active" as const },
    { id: "1306879706", cells: ["COS-8706", "COSMOS System Topology Item 2", "7/3/2026", "€29 806"], status: "pending" as const },
    { id: "1306883277", cells: ["COS-3277", "COSMOS System Topology Item 3", "22/10/2026", "€33 377"], status: "completed" as const },
    { id: "1306886848", cells: ["COS-6848", "COSMOS System Topology Item 4", "9/5/2026", "€36 948"], status: "warning" as const },
    { id: "1306890419", cells: ["COS-1419", "COSMOS System Topology Item 5", "24/12/2026", "€40 519"], status: "active" as const },
];
...
export default function CosmosSystemTopologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS System Topology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS System Topology</p>
                    </div>
                </div>
