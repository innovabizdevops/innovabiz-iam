...
const KPIS = [{"l":"Dashboards Ativos","v":"1.458","t":"+4.0%","d":"up"},{"l":"Queries/Dia","v":"2200","t":"+10.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.483","t":"+11.0%","d":"up"},{"l":"Utilizadores Analytics","v":"749","t":"+4.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4320","2026-02-21","1.406","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4506","2026-02-10","1.788","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2749","2026-01-23","7.401","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","360","2026-02-10","6.668","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3824","2026-03-12","2.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":1015},{"label":"Mar","value":881},{"label":"Abr","value":636},{"label":"Mai","value":787},{"label":"Jun","value":895},{"label":"Jul","value":687},{"label":"Ago","value":896},{"label":"Set","value":831},{"label":"Out","value":970},{"label":"Nov","value":724},{"label":"Dez","value":768}];
const MX = 1015;
