...
const PAGE = "Plan";
const KPIS = [{"l":"Total Mission Planning","v":"619","t":"-4.4%","d":"down"},{"l":"Plan Ativos","v":"8.087","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"73.0%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"63","t":"-4.1%","d":"down"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Planning #001","Mission Planning #002","5.417","4.356","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Planning #002","Mission Planning #003","8.817","5.731","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Planning #003","Mission Planning #004","7.016","1.681","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Planning #004","Mission Planning #005","2.314","5.172","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Planning #005","Mission Planning #001","2.434","1.292","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":307},{"label":"Mar","value":475},{"label":"Abr","value":260},{"label":"Mai","value":367},{"label":"Jun","value":390},{"label":"Jul","value":420},{"label":"Ago","value":583},{"label":"Set","value":470},{"label":"Out","value":642},{"label":"Nov","value":471},{"label":"Dez","value":444}];
const MX = 642;
