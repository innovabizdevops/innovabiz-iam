...
const KPIS = [
    ...
    { label: "Ativos", value: "1300", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€76K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "961465829", cells: ["MIS-5829", "Mission Planning Item 1", "10/6/2026", "€15 929"], status: "active" as const },
    { id: "961469400", cells: ["MIS-9400", "Mission Planning Item 2", "25/1/2026", "€19 500"], status: "pending" as const },
    { id: "961472971", cells: ["MIS-3971", "Mission Planning Item 3", "12/8/2026", "€23 071"], status: "completed" as const },
    { id: "961476542", cells: ["MIS-7542", "Mission Planning Item 4", "27/3/2026", "€26 642"], status: "warning" as const },
    { id: "961480113", cells: ["MIS-2113", "Mission Planning Item 5", "14/10/2026", "€30 213"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mission Planning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mission Planning</p>
                    </div>
                </div>
