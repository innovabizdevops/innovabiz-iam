...
const PAGE = "Lessons";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.099","t":"+16.5%","d":"up"},{"l":"Sessões/Dia","v":"944","t":"+8.4%","d":"up"},{"l":"MFA Adoção (%)","v":"67.3%","t":"+10.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"133","t":"+8.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.333","5.165","1.729","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.841","4.898","2.091","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.600","689","4.025","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.410","5.977","2.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.072","2.704","6.410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":351},{"label":"Mar","value":260},{"label":"Abr","value":482},{"label":"Mai","value":355},{"label":"Jun","value":374},{"label":"Jul","value":366},{"label":"Ago","value":463},{"label":"Set","value":408},{"label":"Out","value":383},{"label":"Nov","value":609},{"label":"Dez","value":266}];
const MX = 609;
