...
const PAGE = "Virtual Try-On";
const KPIS = [{"l":"Total Fashion Luxury","v":"3.627","t":"+11.4%","d":"up"},{"l":"Virtual Try On Ativos","v":"7.073","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"76.9%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"58","t":"-3.4%","d":"down"}];
const COLS = ["ID","Virtual Try On","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion Luxury #001","Fashion Luxury #002","6.941","8.558","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion Luxury #002","Fashion Luxury #003","3.165","1.463","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion Luxury #003","Fashion Luxury #004","5.770","795","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion Luxury #004","Fashion Luxury #005","827","935","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion Luxury #005","Fashion Luxury #001","2.993","184","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":948},{"label":"Fev","value":833},{"label":"Mar","value":613},{"label":"Abr","value":795},{"label":"Mai","value":652},{"label":"Jun","value":674},{"label":"Jul","value":751},{"label":"Ago","value":931},{"label":"Set","value":890},{"label":"Out","value":717},{"label":"Nov","value":870},{"label":"Dez","value":601}];
const MX = 948;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9333ea'}}>AR</span></h1>
                </div>
