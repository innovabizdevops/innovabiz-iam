...
const PAGE = "Compassionate Use";
const KPIS = [{"l":"Total Pharma","v":"2.818","t":"+12.5%","d":"up"},{"l":"Compassionate Use Ativos","v":"922","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"81.5%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.6%","d":"down"}];
const COLS = ["ID","Compassionate Use","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","8.698","1.361","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","8.454","2.754","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","698","4.735","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","4.425","4.159","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","8.105","7.031","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":511},{"label":"Mar","value":484},{"label":"Abr","value":633},{"label":"Mai","value":586},{"label":"Jun","value":723},{"label":"Jul","value":552},{"label":"Ago","value":448},{"label":"Set","value":664},{"label":"Out","value":365},{"label":"Nov","value":368},{"label":"Dez","value":386}];
const MX = 723;
