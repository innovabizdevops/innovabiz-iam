...
const PAGE = "eCTD Submission";
const KPIS = [{"l":"Total Pharma","v":"8.288","t":"+13.4%","d":"up"},{"l":"ECTD Submission Ativos","v":"6.030","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"82.8%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"71","t":"-1.9%","d":"down"}];
const COLS = ["ID","ECTD Submission","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","1.860","8.509","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","1.672","7.839","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","5.669","8.440","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","8.887","3.530","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","1.650","7.136","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":280},{"label":"Mar","value":433},{"label":"Abr","value":508},{"label":"Mai","value":433},{"label":"Jun","value":454},{"label":"Jul","value":300},{"label":"Ago","value":291},{"label":"Set","value":414},{"label":"Out","value":486},{"label":"Nov","value":378},{"label":"Dez","value":337}];
const MX = 508;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>FDA</span></h1>
                </div>
