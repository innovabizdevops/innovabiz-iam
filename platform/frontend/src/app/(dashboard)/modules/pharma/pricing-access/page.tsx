...
const PAGE = "Drug Pricing &amp; Access";
const KPIS = [{"l":"ARR (€M)","v":"€48.8M","t":"+17.3%","d":"up"},{"l":"MRR (€)","v":"€98687","t":"-4.4%","d":"down"},{"l":"Churn (%)","v":"93.6%","t":"-4.0%","d":"down"},{"l":"ARPU (€)","v":"€47699","t":"+11.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 6790.48","1.462","€ 2050.39","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 28488.79","6.192","€ 11610.49","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28512.94","3.328","€ 21601.25","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2135.84","5.199","€ 5109.93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49818.04","7.062","€ 9060.36","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":376},{"label":"Mar","value":449},{"label":"Abr","value":654},{"label":"Mai","value":474},{"label":"Jun","value":364},{"label":"Jul","value":558},{"label":"Ago","value":560},{"label":"Set","value":625},{"label":"Out","value":361},{"label":"Nov","value":482},{"label":"Dez","value":504}];
const MX = 654;
...
export default function PricingAccessPage() {
    return (
