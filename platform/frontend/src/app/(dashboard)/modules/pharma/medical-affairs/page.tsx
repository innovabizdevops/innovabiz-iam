...
const KPIS = [{"l":"Integrações Ativas","v":"5.430","t":"+13.9%","d":"up"},{"l":"Chamadas/Hora","v":"4947","t":"+10.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.1%","t":"-5.3%","d":"down"},{"l":"Latência Média (ms)","v":"94ms","t":"+7.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.568","6.597","74.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.885","3.436","97.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.967","1.593","96.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.115","965","97.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.727","5.376","76.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":805},{"label":"Mar","value":540},{"label":"Abr","value":762},{"label":"Mai","value":907},{"label":"Jun","value":872},{"label":"Jul","value":567},{"label":"Ago","value":631},{"label":"Set","value":798},{"label":"Out","value":599},{"label":"Nov","value":598},{"label":"Dez","value":590}];
const MX = 907;
