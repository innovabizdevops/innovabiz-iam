...
const KPIS = [{"l":"Total Pharma","v":"4.261","t":"-4.5%","d":"down"},{"l":"Clinical Trials Ativos","v":"5.201","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"84","t":"+6.5%","d":"up"}];
const COLS = ["ID","Clinical Trials","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","3.457","4.531","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","9.055","8.318","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","7.843","1.089","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","8.658","6.989","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","9.073","4.399","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":609},{"label":"Mar","value":692},{"label":"Abr","value":840},{"label":"Mai","value":819},{"label":"Jun","value":783},{"label":"Jul","value":775},{"label":"Ago","value":840},{"label":"Set","value":787},{"label":"Out","value":777},{"label":"Nov","value":709},{"label":"Dez","value":595}];
const MX = 840;
