...
const PAGE = "ICH Guidelines";
const KPIS = [{"l":"Artigos Publicados","v":"4.736","t":"+1.2%","d":"up"},{"l":"Views/Semana","v":"3796","t":"+3.4%","d":"up"},{"l":"Feedback Útil (%)","v":"73.7%","t":"-0.2%","d":"down"},{"l":"Artigos Desatualizados","v":"6.145","t":"-1.2%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.505","99.9%","3.410","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","4.831","93.5%","5.445","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","2.701","90.1%","3.749","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.118","98.5%","775","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.075","93.2%","344","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":570},{"label":"Mar","value":506},{"label":"Abr","value":841},{"label":"Mai","value":805},{"label":"Jun","value":596},{"label":"Jul","value":676},{"label":"Ago","value":635},{"label":"Set","value":503},{"label":"Out","value":850},{"label":"Nov","value":564},{"label":"Dez","value":499}];
const MX = 850;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>ICH</span></h1>
                </div>
