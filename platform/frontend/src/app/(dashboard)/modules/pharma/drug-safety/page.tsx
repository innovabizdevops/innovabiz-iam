...
const PAGE = "Drug Safety";
const KPIS = [{"l":"Total Pharma","v":"5.594","t":"+4.1%","d":"up"},{"l":"Drug Safety Ativos","v":"1.798","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"70","t":"+13.0%","d":"up"}];
const COLS = ["ID","Drug Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","7.434","4.834","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","6.418","1.072","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","4.254","6.934","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","4.258","7.989","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","1.786","6.665","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":621},{"label":"Mar","value":645},{"label":"Abr","value":784},{"label":"Mai","value":536},{"label":"Jun","value":564},{"label":"Jul","value":555},{"label":"Ago","value":508},{"label":"Set","value":464},{"label":"Out","value":601},{"label":"Nov","value":518},{"label":"Dez","value":513}];
const MX = 784;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>PV</span></h1>
                </div>
