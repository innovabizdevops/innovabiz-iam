...
const PAGE = "Adverse Event Report";
const KPIS = [{"l":"Total Pharma","v":"8.096","t":"+1.0%","d":"up"},{"l":"Adverse Event Report Ativos","v":"1.784","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"93","t":"+14.3%","d":"up"}];
const COLS = ["ID","Adverse Event Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","3.385","7.750","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","4.588","1.833","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","1.846","5.838","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","6.816","5.024","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","7.536","2.032","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":372},{"label":"Fev","value":634},{"label":"Mar","value":411},{"label":"Abr","value":342},{"label":"Mai","value":564},{"label":"Jun","value":364},{"label":"Jul","value":580},{"label":"Ago","value":390},{"label":"Set","value":369},{"label":"Out","value":334},{"label":"Nov","value":375},{"label":"Dez","value":389}];
const MX = 634;
