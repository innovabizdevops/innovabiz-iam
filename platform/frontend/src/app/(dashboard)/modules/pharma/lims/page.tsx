...
const PAGE = "Lab LIMS";
const KPIS = [{"l":"Total Pharma","v":"1.170","t":"-1.3%","d":"down"},{"l":"Lab LIMS Ativos","v":"243","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+5.4%","d":"up"}];
const COLS = ["ID","Lab LIMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","5.109","7.135","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","1.378","3.608","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","8.893","6.650","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","9.010","1.145","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","4.370","5.515","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":830},{"label":"Mar","value":593},{"label":"Abr","value":846},{"label":"Mai","value":858},{"label":"Jun","value":536},{"label":"Jul","value":882},{"label":"Ago","value":508},{"label":"Set","value":690},{"label":"Out","value":561},{"label":"Nov","value":755},{"label":"Dez","value":758}];
const MX = 882;
