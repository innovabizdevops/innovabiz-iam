...
const PAGE = "GxP Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.949","t":"+3.0%","d":"up"},{"l":"NC Abertas","v":"8.698","t":"-1.3%","d":"down"},{"l":"Conformidade (%)","v":"88.1%","t":"+9.6%","d":"up"},{"l":"CAPAs Pendentes","v":"7.825","t":"+10.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.604","87.7%","5.088","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.789","75.7%","7.512","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.101","77.6%","5.826","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.452","71.3%","3.272","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.171","80.8%","5.515","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":646},{"label":"Mar","value":539},{"label":"Abr","value":323},{"label":"Mai","value":565},{"label":"Jun","value":510},{"label":"Jul","value":305},{"label":"Ago","value":528},{"label":"Set","value":312},{"label":"Out","value":444},{"label":"Nov","value":516},{"label":"Dez","value":421}];
const MX = 646;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>GxP</span></h1>
                </div>
