...
const PAGE = "Patient Recruitment AI";
const KPIS = [{"l":"Total Pharma","v":"3.523","t":"-1.5%","d":"down"},{"l":"Patient Recruitment AI Ativos","v":"1.659","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"77.5%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+7.5%","d":"up"}];
const COLS = ["ID","Patient Recruitment AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","7.214","1.150","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","5.964","4.161","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","1.192","9.095","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","7.333","6.852","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","1.105","6.325","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":675},{"label":"Mar","value":520},{"label":"Abr","value":484},{"label":"Mai","value":747},{"label":"Jun","value":676},{"label":"Jul","value":406},{"label":"Ago","value":570},{"label":"Set","value":642},{"label":"Out","value":697},{"label":"Nov","value":655},{"label":"Dez","value":632}];
const MX = 747;
...
export default function PatientRecruitmentPage() {
    return (
