...
const PAGE = "Supply Chain Serialization";
const KPIS = [{"l":"Total Pharma","v":"5.101","t":"-4.5%","d":"down"},{"l":"Supply Chain Serialization Ativos","v":"1.574","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"77.1%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"64","t":"+14.2%","d":"up"}];
const COLS = ["ID","Supply Chain Serialization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","1.036","7.799","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","8.576","4.564","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","7.665","5.935","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","710","640","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","7.166","1.849","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":530},{"label":"Mar","value":517},{"label":"Abr","value":695},{"label":"Mai","value":669},{"label":"Jun","value":675},{"label":"Jul","value":798},{"label":"Ago","value":452},{"label":"Set","value":578},{"label":"Out","value":723},{"label":"Nov","value":642},{"label":"Dez","value":433}];
const MX = 798;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>DSCSA</span></h1>
                </div>
