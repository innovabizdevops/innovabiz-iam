...
const PAGE = "Real-World Evidence AI";
const KPIS = [{"l":"Total Pharma","v":"2.755","t":"+16.3%","d":"up"},{"l":"Real World Evidence AI Ativos","v":"2.896","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+5.0%","d":"up"}];
const COLS = ["ID","Real World Evidence AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","1.897","4.735","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","6.682","3.911","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","8.882","9.076","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","8.890","8.860","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","296","6.752","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":770},{"label":"Mar","value":612},{"label":"Abr","value":674},{"label":"Mai","value":626},{"label":"Jun","value":510},{"label":"Jul","value":683},{"label":"Ago","value":725},{"label":"Set","value":764},{"label":"Out","value":415},{"label":"Nov","value":496},{"label":"Dez","value":742}];
const MX = 770;
