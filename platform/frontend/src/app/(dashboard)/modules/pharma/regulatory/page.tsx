...
const PAGE = "Regulatory Affairs";
const KPIS = [{"l":"Total Pharma","v":"6.469","t":"+6.5%","d":"up"},{"l":"Regulatory Affairs Ativos","v":"4.560","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+16.6%","d":"up"}];
const COLS = ["ID","Regulatory Affairs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","7.810","8.350","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","5.951","5.120","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","558","8.428","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","2.334","5.245","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","4.414","4.135","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":235},{"label":"Fev","value":477},{"label":"Mar","value":287},{"label":"Abr","value":599},{"label":"Mai","value":277},{"label":"Jun","value":579},{"label":"Jul","value":478},{"label":"Ago","value":258},{"label":"Set","value":362},{"label":"Out","value":510},{"label":"Nov","value":249},{"label":"Dez","value":263}];
const MX = 599;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>FDA/EMA</span></h1>
                </div>
