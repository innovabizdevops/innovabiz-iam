...
const PAGE = "eCTD Submissions";
const KPIS = [{"l":"Total Pharma","v":"8.380","t":"+17.2%","d":"up"},{"l":"ECTD Submissions Ativos","v":"6.332","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"92.9%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"65","t":"+5.7%","d":"up"}];
const COLS = ["ID","ECTD Submissions","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma #001","Pharma #002","395","3.773","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma #002","Pharma #003","7.411","2.571","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma #003","Pharma #004","4.866","7.849","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma #004","Pharma #005","6.461","2.244","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma #005","Pharma #001","7.582","4.404","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":568},{"label":"Mar","value":537},{"label":"Abr","value":478},{"label":"Mai","value":614},{"label":"Jun","value":769},{"label":"Jul","value":770},{"label":"Ago","value":828},{"label":"Set","value":744},{"label":"Out","value":563},{"label":"Nov","value":749},{"label":"Dez","value":485}];
const MX = 828;
...
export default function EctdPharmaPage() {
    return (
