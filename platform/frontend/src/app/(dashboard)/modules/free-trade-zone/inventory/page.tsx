...
const ACCENT = "#9f1239";
const MODULE = "Free Trade Zone";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Free Trade Zone","v":"6.662","t":"+8.4%","d":"up"},{"l":"Inventory Ativos","v":"5.247","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"93.9%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.6%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Free Trade Zone #001","Free Trade Zone #002","1.130","1.672","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Free Trade Zone #002","Free Trade Zone #003","8.522","8.258","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Free Trade Zone #003","Free Trade Zone #004","2.044","4.975","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trade Zone #004","Free Trade Zone #005","3.638","5.440","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Free Trade Zone #005","Free Trade Zone #001","6.376","1.233","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":946},{"label":"Mar","value":1020},{"label":"Abr","value":1038},{"label":"Mai","value":1007},{"label":"Jun","value":957},{"label":"Jul","value":952},{"label":"Ago","value":794},{"label":"Set","value":950},{"label":"Out","value":959},{"label":"Nov","value":881},{"label":"Dez","value":796}];
const MX = 1038;
