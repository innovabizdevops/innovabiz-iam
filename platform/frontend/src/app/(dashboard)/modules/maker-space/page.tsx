...
/* ═══ Maker Space — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "7084", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3516", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€390K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1483571484", cells: ["MAK-3484", "Maker Space Item 1", "25/1/2026", "€21 584"], status: "active" as const },
    { id: "1483575055", cells: ["MAK-7055", "Maker Space Item 2", "12/8/2026", "€25 155"], status: "pending" as const },
    { id: "1483578626", cells: ["MAK-1626", "Maker Space Item 3", "27/3/2026", "€28 726"], status: "completed" as const },
    { id: "1483582197", cells: ["MAK-5197", "Maker Space Item 4", "14/10/2026", "€32 297"], status: "warning" as const },
    { id: "1483585768", cells: ["MAK-8768", "Maker Space Item 5", "1/5/2026", "€35 868"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maker Space</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Maker Space</p>
                    </div>
                </div>
