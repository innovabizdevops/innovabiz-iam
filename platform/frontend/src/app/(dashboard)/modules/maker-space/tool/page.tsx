...
const PAGE = "Tool";
const KPIS = [{"l":"Quartos Ocupados","v":"7.914","t":"+16.7%","d":"up"},{"l":"RevPAR (€)","v":"€96122","t":"+5.7%","d":"up"},{"l":"Ocupação (%)","v":"72.3%","t":"+17.9%","d":"up"},{"l":"Guest Satisfaction","v":"3.858","t":"-5.0%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.640","2026-01-23","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.646","2026-02-13","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.715","2026-02-22","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.055","2026-01-28","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.911","2026-01-16","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":651},{"label":"Mar","value":423},{"label":"Abr","value":689},{"label":"Mai","value":770},{"label":"Jun","value":466},{"label":"Jul","value":768},{"label":"Ago","value":444},{"label":"Set","value":801},{"label":"Out","value":566},{"label":"Nov","value":572},{"label":"Dez","value":627}];
const MX = 801;
