...
const ACCENT = "#6366f1";
const MODULE = "Maker Space";
const PAGE = "Project";
const KPIS = [{"l":"Quartos Ocupados","v":"4.874","t":"-1.3%","d":"down"},{"l":"RevPAR (€)","v":"€64031","t":"-1.2%","d":"down"},{"l":"Ocupação (%)","v":"93.6%","t":"+7.1%","d":"up"},{"l":"Guest Satisfaction","v":"1.156","t":"-4.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.544","2026-01-12","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.668","2026-01-16","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.851","2026-01-02","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.033","2026-02-11","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.700","2026-01-01","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":307},{"label":"Fev","value":440},{"label":"Mar","value":398},{"label":"Abr","value":519},{"label":"Mai","value":359},{"label":"Jun","value":628},{"label":"Jul","value":669},{"label":"Ago","value":420},{"label":"Set","value":499},{"label":"Out","value":411},{"label":"Nov","value":492},{"label":"Dez","value":397}];
const MX = 669;
