...
const PAGE = "Class";
const KPIS = [{"l":"Quartos Ocupados","v":"3.153","t":"+13.3%","d":"up"},{"l":"RevPAR (€)","v":"€45777","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"72.5%","t":"-1.0%","d":"down"},{"l":"Guest Satisfaction","v":"556","t":"-5.7%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.239","2026-02-07","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.222","2026-01-06","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.953","2026-03-06","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.053","2026-02-09","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","256","2026-01-15","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":514},{"label":"Mar","value":645},{"label":"Abr","value":447},{"label":"Mai","value":631},{"label":"Jun","value":408},{"label":"Jul","value":466},{"label":"Ago","value":336},{"label":"Set","value":492},{"label":"Out","value":597},{"label":"Nov","value":658},{"label":"Dez","value":568}];
const MX = 658;
