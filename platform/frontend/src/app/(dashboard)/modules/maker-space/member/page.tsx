...
const PAGE = "Member";
const KPIS = [{"l":"Quartos Ocupados","v":"6.997","t":"+4.0%","d":"up"},{"l":"RevPAR (€)","v":"€14958","t":"+0.7%","d":"up"},{"l":"Ocupação (%)","v":"92.1%","t":"+13.5%","d":"up"},{"l":"Guest Satisfaction","v":"7.954","t":"-4.5%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.221","2026-01-16","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.426","2026-02-12","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.602","2026-01-09","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.582","2026-01-21","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.421","2026-03-27","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1013},{"label":"Fev","value":1073},{"label":"Mar","value":969},{"label":"Abr","value":943},{"label":"Mai","value":1061},{"label":"Jun","value":903},{"label":"Jul","value":835},{"label":"Ago","value":961},{"label":"Set","value":1016},{"label":"Out","value":919},{"label":"Nov","value":903},{"label":"Dez","value":821}];
const MX = 1073;
