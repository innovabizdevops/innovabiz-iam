...
const PAGE = "Surgery";
const KPIS = [{"l":"Total Bariatric Center","v":"4.964","t":"+11.6%","d":"up"},{"l":"Surgery Ativos","v":"3.097","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"83.4%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+8.1%","d":"up"}];
const COLS = ["ID","Surgery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bariatric Center #001","Bariatric Center #002","4.142","5.342","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Bariatric Center #002","Bariatric Center #003","930","7.616","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Bariatric Center #003","Bariatric Center #004","5.237","1.001","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Bariatric Center #004","Bariatric Center #005","6.241","4.463","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bariatric Center #005","Bariatric Center #001","8.994","1.419","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":803},{"label":"Mar","value":982},{"label":"Abr","value":838},{"label":"Mai","value":964},{"label":"Jun","value":939},{"label":"Jul","value":737},{"label":"Ago","value":738},{"label":"Set","value":751},{"label":"Out","value":1000},{"label":"Nov","value":888},{"label":"Dez","value":817}];
const MX = 1000;
