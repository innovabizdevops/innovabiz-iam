...
const ACCENT = "#db2777";
const MODULE = "Bariatric Surgery";
const PAGE = "Follow-Up";
const KPIS = [{"l":"Total Bariatric Center","v":"1.437","t":"+14.3%","d":"up"},{"l":"Follow Up Ativos","v":"8.375","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+15.4%","d":"up"}];
const COLS = ["ID","Follow Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bariatric Center #001","Bariatric Center #002","2.392","7.459","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Bariatric Center #002","Bariatric Center #003","641","1.914","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Bariatric Center #003","Bariatric Center #004","8.502","7.428","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Bariatric Center #004","Bariatric Center #005","2.436","8.403","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bariatric Center #005","Bariatric Center #001","6.692","1.744","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":441},{"label":"Mar","value":654},{"label":"Abr","value":731},{"label":"Mai","value":576},{"label":"Jun","value":629},{"label":"Jul","value":473},{"label":"Ago","value":621},{"label":"Set","value":570},{"label":"Out","value":670},{"label":"Nov","value":760},{"label":"Dez","value":673}];
const MX = 760;
