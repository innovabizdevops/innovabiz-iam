...
/* ═══ Bariatric Surgery — Dashboard ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total Registos", value: "670", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4134", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€226K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "607553670", cells: ["BAR-9670", "Bariatric Surgery Item 1", "11/7/2026", "€3770"], status: "active" as const },
    { id: "607557241", cells: ["BAR-4241", "Bariatric Surgery Item 2", "26/2/2026", "€7341"], status: "pending" as const },
    { id: "607560812", cells: ["BAR-7812", "Bariatric Surgery Item 3", "13/9/2026", "€10 912"], status: "completed" as const },
    { id: "607564383", cells: ["BAR-2383", "Bariatric Surgery Item 4", "28/4/2026", "€14 483"], status: "warning" as const },
    { id: "607567954", cells: ["BAR-5954", "Bariatric Surgery Item 5", "15/11/2026", "€18 054"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bariatric Surgery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Bariatric Surgery</p>
                    </div>
                </div>
