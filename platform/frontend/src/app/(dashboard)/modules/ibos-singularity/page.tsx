...
/* ═══ iBOS Singularity Engine — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "9598", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2471", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€484K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1029995598", cells: ["IBO-9598", "iBOS Singularity Engine Item 1", "3/7/2026", "€45 698"], status: "active" as const },
    { id: "1029999169", cells: ["IBO-4169", "iBOS Singularity Engine Item 2", "18/2/2026", "€49 269"], status: "pending" as const },
    { id: "1030002740", cells: ["IBO-7740", "iBOS Singularity Engine Item 3", "5/9/2026", "€2840"], status: "completed" as const },
    { id: "1030006311", cells: ["IBO-2311", "iBOS Singularity Engine Item 4", "20/4/2026", "€6411"], status: "warning" as const },
    { id: "1030009882", cells: ["IBO-5882", "iBOS Singularity Engine Item 5", "7/11/2026", "€9982"], status: "active" as const },
];
...
export default function IbosSingularityEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">iBOS Singularity Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • iBOS Singularity Engine</p>
                    </div>
                </div>
