...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"5.983","t":"+10.3%","d":"up"},{"l":"Submissões/Dia","v":"596","t":"+12.8%","d":"up"},{"l":"Documentos Gerados","v":"3.174","t":"-1.3%","d":"down"},{"l":"Templates","v":"6.003","t":"+10.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.501","2026-02-24","6.910","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.451","2026-02-24","955","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.378","2026-01-05","8.326","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.991","2026-02-02","1.694","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.221","2026-03-01","1.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":660},{"label":"Mar","value":431},{"label":"Abr","value":329},{"label":"Mai","value":407},{"label":"Jun","value":397},{"label":"Jul","value":413},{"label":"Ago","value":611},{"label":"Set","value":393},{"label":"Out","value":386},{"label":"Nov","value":541},{"label":"Dez","value":339}];
const MX = 660;
