...
const ACCENT = "#6366f1";
const MODULE = "International Shipping";
const PAGE = "Track";
const KPIS = [{"l":"Total International Ship","v":"2.898","t":"+10.9%","d":"up"},{"l":"Track Ativos","v":"8.302","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"79.0%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"87","t":"+14.5%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["International Ship #001","International Ship #002","1.303","4.445","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["International Ship #002","International Ship #003","7.921","7.964","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["International Ship #003","International Ship #004","3.834","8.031","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["International Ship #004","International Ship #005","7.098","7.271","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["International Ship #005","International Ship #001","1.399","2.637","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":274},{"label":"Mar","value":216},{"label":"Abr","value":221},{"label":"Mai","value":468},{"label":"Jun","value":394},{"label":"Jul","value":464},{"label":"Ago","value":426},{"label":"Set","value":421},{"label":"Out","value":515},{"label":"Nov","value":535},{"label":"Dez","value":297}];
const MX = 535;
