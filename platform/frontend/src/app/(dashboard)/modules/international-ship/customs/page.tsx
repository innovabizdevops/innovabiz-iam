...
const PAGE = "Customs";
const KPIS = [{"l":"Total International Ship","v":"8.328","t":"-2.4%","d":"down"},{"l":"Customs Ativos","v":"€16451","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"73.2%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"79","t":"-3.6%","d":"down"}];
const COLS = ["ID","Customs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["International Ship #001","€ 9714.20","7.429","2.243","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["International Ship #002","€ 13873.78","1.153","1.090","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["International Ship #003","€ 5714.26","3.029","4.145","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["International Ship #004","€ 37251.73","8.418","7.837","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["International Ship #005","€ 19701.19","7.285","4.780","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":801},{"label":"Mar","value":739},{"label":"Abr","value":869},{"label":"Mai","value":687},{"label":"Jun","value":811},{"label":"Jul","value":577},{"label":"Ago","value":581},{"label":"Set","value":652},{"label":"Out","value":506},{"label":"Nov","value":792},{"label":"Dez","value":736}];
const MX = 869;
