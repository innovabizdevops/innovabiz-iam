...
const PAGE = "Gallery";
const KPIS = [{"l":"Total Digital Memorial","v":"8.412","t":"+2.2%","d":"up"},{"l":"Gallery Ativos","v":"8.077","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"92.2%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+12.7%","d":"up"}];
const COLS = ["ID","Gallery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Memorial #001","Digital Memorial #002","220","6.215","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Memorial #002","Digital Memorial #003","8.899","8.567","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Memorial #003","Digital Memorial #004","1.592","2.343","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Memorial #004","Digital Memorial #005","3.945","4.511","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Memorial #005","Digital Memorial #001","3.960","2.684","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":645},{"label":"Mar","value":690},{"label":"Abr","value":634},{"label":"Mai","value":521},{"label":"Jun","value":703},{"label":"Jul","value":814},{"label":"Ago","value":671},{"label":"Set","value":828},{"label":"Out","value":658},{"label":"Nov","value":669},{"label":"Dez","value":785}];
const MX = 828;
