...
const PAGE = "Timeline";
const KPIS = [{"l":"Total Digital Memorial","v":"5.014","t":"+4.0%","d":"up"},{"l":"Timeline Ativos","v":"4.104","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"77","t":"+10.4%","d":"up"}];
const COLS = ["ID","Timeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Memorial #001","Digital Memorial #002","4.945","2.012","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Memorial #002","Digital Memorial #003","690","3.691","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Memorial #003","Digital Memorial #004","6.163","8.231","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Memorial #004","Digital Memorial #005","540","8.678","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Memorial #005","Digital Memorial #001","4.102","5.709","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":605},{"label":"Mar","value":545},{"label":"Abr","value":849},{"label":"Mai","value":760},{"label":"Jun","value":552},{"label":"Jul","value":776},{"label":"Ago","value":653},{"label":"Set","value":477},{"label":"Out","value":693},{"label":"Nov","value":833},{"label":"Dez","value":653}];
const MX = 849;
