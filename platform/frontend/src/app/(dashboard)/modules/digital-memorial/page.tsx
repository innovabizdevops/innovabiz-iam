...
/* ═══ Digital Memorial — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "4848", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2057", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€278K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "822506648", cells: ["DIG-6648", "Digital Memorial Item 1", "13/9/2026", "€6748"], status: "active" as const },
    { id: "822510219", cells: ["DIG-1219", "Digital Memorial Item 2", "28/4/2026", "€10 319"], status: "pending" as const },
    { id: "822513790", cells: ["DIG-4790", "Digital Memorial Item 3", "15/11/2026", "€13 890"], status: "completed" as const },
    { id: "822517361", cells: ["DIG-8361", "Digital Memorial Item 4", "2/6/2026", "€17 461"], status: "warning" as const },
    { id: "822520932", cells: ["DIG-2932", "Digital Memorial Item 5", "17/1/2026", "€21 032"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Memorial</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Memorial</p>
                    </div>
                </div>
