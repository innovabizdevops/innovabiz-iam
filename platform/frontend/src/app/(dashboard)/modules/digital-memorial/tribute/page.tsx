...
const ACCENT = "#475569";
const MODULE = "Digital Memorial";
const PAGE = "Tribute";
const KPIS = [{"l":"Total Digital Memorial","v":"6.916","t":"-0.3%","d":"down"},{"l":"Tribute Ativos","v":"7.097","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"95","t":"-5.7%","d":"down"}];
const COLS = ["ID","Tribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Memorial #001","Digital Memorial #002","3.465","7.953","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Memorial #002","Digital Memorial #003","8.993","1.773","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Memorial #003","Digital Memorial #004","4.521","4.047","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Memorial #004","Digital Memorial #005","2.165","8.502","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Memorial #005","Digital Memorial #001","4.402","919","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":549},{"label":"Mar","value":754},{"label":"Abr","value":591},{"label":"Mai","value":839},{"label":"Jun","value":802},{"label":"Jul","value":713},{"label":"Ago","value":574},{"label":"Set","value":525},{"label":"Out","value":807},{"label":"Nov","value":601},{"label":"Dez","value":836}];
const MX = 839;
