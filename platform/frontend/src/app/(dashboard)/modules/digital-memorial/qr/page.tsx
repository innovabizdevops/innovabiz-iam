...
const PAGE = "QR";
const KPIS = [{"l":"Total Digital Memorial","v":"2.444","t":"+4.4%","d":"up"},{"l":"QR Ativos","v":"312","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"93.7%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"74","t":"+11.6%","d":"up"}];
const COLS = ["ID","QR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Memorial #001","Digital Memorial #002","7.914","2.494","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Memorial #002","Digital Memorial #003","1.058","3.371","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Memorial #003","Digital Memorial #004","5.183","5.558","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Memorial #004","Digital Memorial #005","2.188","5.318","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Memorial #005","Digital Memorial #001","4.861","4.785","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":343},{"label":"Mar","value":412},{"label":"Abr","value":447},{"label":"Mai","value":671},{"label":"Jun","value":451},{"label":"Jul","value":690},{"label":"Ago","value":357},{"label":"Set","value":524},{"label":"Out","value":451},{"label":"Nov","value":447},{"label":"Dez","value":632}];
const MX = 690;
