...
/* ═══ Auto Finance Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "752", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3623", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€92K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "474824452", cells: ["AUT-3452", "Auto Finance Deep Item 1", "5/5/2026", "€24 552"], status: "active" as const },
    { id: "474828023", cells: ["AUT-7023", "Auto Finance Deep Item 2", "20/12/2026", "€28 123"], status: "pending" as const },
    { id: "474831594", cells: ["AUT-1594", "Auto Finance Deep Item 3", "7/7/2026", "€31 694"], status: "completed" as const },
    { id: "474835165", cells: ["AUT-5165", "Auto Finance Deep Item 4", "22/2/2026", "€35 265"], status: "warning" as const },
    { id: "474838736", cells: ["AUT-8736", "Auto Finance Deep Item 5", "9/9/2026", "€38 836"], status: "active" as const },
];
...
export default function AutoFinanceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Finance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auto Finance Deep</p>
                    </div>
                </div>
