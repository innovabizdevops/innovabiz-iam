...
const ACCENT = "#1e3a5f";
const MODULE = "Auto Finance Deep";
const PAGE = "Underwrite";
const KPIS = [{"l":"Total Auto Finance Deep","v":"5.518","t":"+3.8%","d":"up"},{"l":"Underwrite Ativos","v":"5.785","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"79","t":"+13.4%","d":"up"}];
const COLS = ["ID","Underwrite","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Finance Deep #001","Auto Finance Deep #002","1.275","2.535","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Finance Deep #002","Auto Finance Deep #003","8.561","4.862","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Finance Deep #003","Auto Finance Deep #004","2.621","6.121","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Finance Deep #004","Auto Finance Deep #005","4.504","8.778","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Finance Deep #005","Auto Finance Deep #001","2.117","4.960","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":626},{"label":"Mar","value":540},{"label":"Abr","value":574},{"label":"Mai","value":587},{"label":"Jun","value":300},{"label":"Jul","value":356},{"label":"Ago","value":352},{"label":"Set","value":628},{"label":"Out","value":293},{"label":"Nov","value":267},{"label":"Dez","value":377}];
const MX = 628;
