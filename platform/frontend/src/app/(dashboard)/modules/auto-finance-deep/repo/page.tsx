...
const PAGE = "Repo";
const KPIS = [{"l":"Total Auto Finance Deep","v":"5.580","t":"-3.5%","d":"down"},{"l":"Repo Ativos","v":"4.634","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"77","t":"-3.9%","d":"down"}];
const COLS = ["ID","Repo","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Finance Deep #001","Auto Finance Deep #002","6.582","7.478","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Finance Deep #002","Auto Finance Deep #003","8.548","1.932","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Finance Deep #003","Auto Finance Deep #004","6.575","2.689","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Finance Deep #004","Auto Finance Deep #005","509","7.611","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Finance Deep #005","Auto Finance Deep #001","5.267","7.988","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":536},{"label":"Mar","value":392},{"label":"Abr","value":378},{"label":"Mai","value":233},{"label":"Jun","value":377},{"label":"Jul","value":326},{"label":"Ago","value":281},{"label":"Set","value":408},{"label":"Out","value":526},{"label":"Nov","value":233},{"label":"Dez","value":490}];
const MX = 536;
