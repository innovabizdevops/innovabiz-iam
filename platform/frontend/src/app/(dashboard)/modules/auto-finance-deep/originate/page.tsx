...
const KPIS = [{"l":"Total Auto Finance Deep","v":"9.047","t":"-1.6%","d":"down"},{"l":"Originate Ativos","v":"7.691","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"69","t":"+6.7%","d":"up"}];
const COLS = ["ID","Originate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Finance Deep #001","Auto Finance Deep #002","7.755","7.585","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Finance Deep #002","Auto Finance Deep #003","3.648","1.430","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Finance Deep #003","Auto Finance Deep #004","3.976","7.357","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Finance Deep #004","Auto Finance Deep #005","6.302","5.165","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Finance Deep #005","Auto Finance Deep #001","3.088","8.260","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":772},{"label":"Mar","value":1080},{"label":"Abr","value":940},{"label":"Mai","value":948},{"label":"Jun","value":1060},{"label":"Jul","value":1079},{"label":"Ago","value":812},{"label":"Set","value":884},{"label":"Out","value":878},{"label":"Nov","value":755},{"label":"Dez","value":849}];
const MX = 1080;
