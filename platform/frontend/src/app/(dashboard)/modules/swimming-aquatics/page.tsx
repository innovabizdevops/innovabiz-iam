...
/* ═══ Swimming & Aquatics Mgmt — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "3672", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "982", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€292K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "323802872", cells: ["SWI-1872", "Swimming & Aquatics Mgmt Item 1", "9/9/2026", "€2972"], status: "active" as const },
    { id: "323806443", cells: ["SWI-5443", "Swimming & Aquatics Mgmt Item 2", "24/4/2026", "€6543"], status: "pending" as const },
    { id: "323810014", cells: ["SWI-9014", "Swimming & Aquatics Mgmt Item 3", "11/11/2026", "€10 114"], status: "completed" as const },
    { id: "323813585", cells: ["SWI-3585", "Swimming & Aquatics Mgmt Item 4", "26/6/2026", "€13 685"], status: "warning" as const },
    { id: "323817156", cells: ["SWI-7156", "Swimming & Aquatics Mgmt Item 5", "13/1/2026", "€17 256"], status: "active" as const },
];
...
export default function SwimmingAquaticsMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Swimming & Aquatics Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Swimming & Aquatics Mgmt</p>
                    </div>
                </div>
