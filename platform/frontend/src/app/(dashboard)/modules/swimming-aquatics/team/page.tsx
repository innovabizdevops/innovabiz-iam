...
const PAGE = "Swim Team";
const KPIS = [{"l":"Teams Ativos","v":"1.674","t":"+8.7%","d":"up"},{"l":"Reuniões/Semana","v":"2498","t":"+1.9%","d":"up"},{"l":"Mensagens/Dia","v":"1378","t":"+10.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.237","t":"+9.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.129","2318","2.310","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.279","4057","7.389","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.218","3570","5.168","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.402","2163","5.209","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.438","1368","3.487","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":798},{"label":"Mar","value":660},{"label":"Abr","value":928},{"label":"Mai","value":718},{"label":"Jun","value":687},{"label":"Jul","value":798},{"label":"Ago","value":784},{"label":"Set","value":801},{"label":"Out","value":627},{"label":"Nov","value":974},{"label":"Dez","value":644}];
const MX = 974;
