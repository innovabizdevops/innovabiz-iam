...
const PAGE = "Lesson";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.004","t":"+9.9%","d":"up"},{"l":"Sessões/Dia","v":"4917","t":"+8.6%","d":"up"},{"l":"MFA Adoção (%)","v":"91.7%","t":"+8.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.011","t":"+15.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.964","860","1.095","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.743","6.446","208","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.997","7.017","5.512","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.002","4.844","1.791","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.928","7.323","799","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":779},{"label":"Mar","value":613},{"label":"Abr","value":496},{"label":"Mai","value":788},{"label":"Jun","value":771},{"label":"Jul","value":624},{"label":"Ago","value":552},{"label":"Set","value":716},{"label":"Out","value":509},{"label":"Nov","value":655},{"label":"Dez","value":508}];
const MX = 788;
