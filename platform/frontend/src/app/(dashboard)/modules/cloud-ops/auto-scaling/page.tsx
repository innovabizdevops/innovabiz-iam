...
/* ═══ Cloud Ops — Auto Scaling ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "2930", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "413", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3299", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "165765609", cells: ["CLO-4609", "Auto Scaling Item 1", "10/10/2026", "€15 709"], status: "active" as const },
    { id: "165769180", cells: ["CLO-8180", "Auto Scaling Item 2", "25/5/2026", "€19 280"], status: "pending" as const },
    { id: "165772751", cells: ["CLO-2751", "Auto Scaling Item 3", "12/12/2026", "€22 851"], status: "completed" as const },
    { id: "165776322", cells: ["CLO-6322", "Auto Scaling Item 4", "27/7/2026", "€26 422"], status: "warning" as const },
    { id: "165779893", cells: ["CLO-9893", "Auto Scaling Item 5", "14/2/2026", "€29 993"], status: "active" as const },
];
...
export default function CloudOpsAutoScalingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Scaling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Auto Scaling</p>
                    </div>
                </div>
