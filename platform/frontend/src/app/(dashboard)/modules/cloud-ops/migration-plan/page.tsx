...
/* ═══ Cloud Ops — Migration Plan ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "1290", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "386", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2944", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1353199502", cells: ["CLO-5502", "Migration Plan Item 1", "19/3/2026", "€49 602"], status: "active" as const },
    { id: "1353203073", cells: ["CLO-9073", "Migration Plan Item 2", "6/10/2026", "€3173"], status: "pending" as const },
    { id: "1353206644", cells: ["CLO-3644", "Migration Plan Item 3", "21/5/2026", "€6744"], status: "completed" as const },
    { id: "1353210215", cells: ["CLO-7215", "Migration Plan Item 4", "8/12/2026", "€10 315"], status: "warning" as const },
    { id: "1353213786", cells: ["CLO-1786", "Migration Plan Item 5", "23/7/2026", "€13 886"], status: "active" as const },
];
...
export default function CloudOpsMigrationPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Migration Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Migration Plan</p>
                    </div>
                </div>
