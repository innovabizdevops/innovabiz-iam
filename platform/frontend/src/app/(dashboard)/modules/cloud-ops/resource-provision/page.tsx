...
/* ═══ Cloud Ops — Resource Provision ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "3250", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "266", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "844", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "71%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "709417174", cells: ["CLO-2174", "Resource Provision Item 1", "19/11/2026", "€17 274"], status: "active" as const },
    { id: "709420745", cells: ["CLO-5745", "Resource Provision Item 2", "6/6/2026", "€20 845"], status: "pending" as const },
    { id: "709424316", cells: ["CLO-9316", "Resource Provision Item 3", "21/1/2026", "€24 416"], status: "completed" as const },
    { id: "709427887", cells: ["CLO-3887", "Resource Provision Item 4", "8/8/2026", "€27 987"], status: "warning" as const },
    { id: "709431458", cells: ["CLO-7458", "Resource Provision Item 5", "23/3/2026", "€31 558"], status: "active" as const },
];
...
export default function CloudOpsResourceProvisionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Resource Provision</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Resource Provision</p>
                    </div>
                </div>
