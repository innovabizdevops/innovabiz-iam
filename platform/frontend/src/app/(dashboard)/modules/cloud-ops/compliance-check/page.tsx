...
/* ═══ Cloud Ops — Compliance Check ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "3017", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "238", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2439", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1334756586", cells: ["CLO-3586", "Compliance Check Item 1", "3/7/2026", "€6686"], status: "active" as const },
    { id: "1334760157", cells: ["CLO-7157", "Compliance Check Item 2", "18/2/2026", "€10 257"], status: "pending" as const },
    { id: "1334763728", cells: ["CLO-1728", "Compliance Check Item 3", "5/9/2026", "€13 828"], status: "completed" as const },
    { id: "1334767299", cells: ["CLO-5299", "Compliance Check Item 4", "20/4/2026", "€17 399"], status: "warning" as const },
    { id: "1334770870", cells: ["CLO-8870", "Compliance Check Item 5", "7/11/2026", "€20 970"], status: "active" as const },
];
...
export default function CloudOpsComplianceCheckPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Check</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Compliance Check</p>
                    </div>
                </div>
