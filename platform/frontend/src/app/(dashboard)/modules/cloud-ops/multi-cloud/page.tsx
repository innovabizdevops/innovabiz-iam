...
/* ═══ Cloud Ops — Multi Cloud ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4194", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "367", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1786", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "73927195", cells: ["CLO-2195", "Multi Cloud Item 1", "28/8/2026", "€27 295"], status: "active" as const },
    { id: "73930766", cells: ["CLO-5766", "Multi Cloud Item 2", "15/3/2026", "€30 866"], status: "pending" as const },
    { id: "73934337", cells: ["CLO-9337", "Multi Cloud Item 3", "2/10/2026", "€34 437"], status: "completed" as const },
    { id: "73937908", cells: ["CLO-3908", "Multi Cloud Item 4", "17/5/2026", "€38 008"], status: "warning" as const },
    { id: "73941479", cells: ["CLO-7479", "Multi Cloud Item 5", "4/12/2026", "€41 579"], status: "active" as const },
];
...
export default function CloudOpsMultiCloudPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi Cloud</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Multi Cloud</p>
                    </div>
                </div>
