...
/* ═══ Cloud Ops — Cost Optimize ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "2798", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "113", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3509", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1109485661", cells: ["CLO-2661", "Cost Optimize Item 1", "26/6/2026", "€35 761"], status: "active" as const },
    { id: "1109489232", cells: ["CLO-6232", "Cost Optimize Item 2", "13/1/2026", "€39 332"], status: "pending" as const },
    { id: "1109492803", cells: ["CLO-9803", "Cost Optimize Item 3", "28/8/2026", "€42 903"], status: "completed" as const },
    { id: "1109496374", cells: ["CLO-4374", "Cost Optimize Item 4", "15/3/2026", "€46 474"], status: "warning" as const },
    { id: "1109499945", cells: ["CLO-7945", "Cost Optimize Item 5", "2/10/2026", "€50 045"], status: "active" as const },
];
...
export default function CloudOpsCostOptimizePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cost Optimize</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Cost Optimize</p>
                    </div>
                </div>
