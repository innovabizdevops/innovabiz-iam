...
/* ═══ Cloud Ops — Finops Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4119", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "194", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1328", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1419544270", cells: ["CLO-2270", "Finops Dashboard Item 1", "19/11/2026", "€44 370"], status: "active" as const },
    { id: "1419547841", cells: ["CLO-5841", "Finops Dashboard Item 2", "6/6/2026", "€47 941"], status: "pending" as const },
    { id: "1419551412", cells: ["CLO-9412", "Finops Dashboard Item 3", "21/1/2026", "€1512"], status: "completed" as const },
    { id: "1419554983", cells: ["CLO-3983", "Finops Dashboard Item 4", "8/8/2026", "€5083"], status: "warning" as const },
    { id: "1419558554", cells: ["CLO-7554", "Finops Dashboard Item 5", "23/3/2026", "€8654"], status: "active" as const },
];
...
export default function CloudOpsFinopsDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Finops Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Finops Dashboard</p>
                    </div>
                </div>
