...
/* ═══ Cloud Ops — Performance Tune ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "2274", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "463", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "983", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2050864251", cells: ["CLO-8251", "Performance Tune Item 1", "24/4/2026", "€14 351"], status: "active" as const },
    { id: "2050867822", cells: ["CLO-2822", "Performance Tune Item 2", "11/11/2026", "€17 922"], status: "pending" as const },
    { id: "2050871393", cells: ["CLO-6393", "Performance Tune Item 3", "26/6/2026", "€21 493"], status: "completed" as const },
    { id: "2050874964", cells: ["CLO-9964", "Performance Tune Item 4", "13/1/2026", "€25 064"], status: "warning" as const },
    { id: "2050878535", cells: ["CLO-4535", "Performance Tune Item 5", "28/8/2026", "€28 635"], status: "active" as const },
];
...
export default function CloudOpsPerformanceTunePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Performance Tune</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Performance Tune</p>
                    </div>
                </div>
