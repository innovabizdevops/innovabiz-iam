...
/* ═══ Cloud Ops — Security Posture ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "3952", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "41", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3097", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "837315013", cells: ["CLO-1013", "Security Posture Item 1", "18/2/2026", "€15 113"], status: "active" as const },
    { id: "837318584", cells: ["CLO-4584", "Security Posture Item 2", "5/9/2026", "€18 684"], status: "pending" as const },
    { id: "837322155", cells: ["CLO-8155", "Security Posture Item 3", "20/4/2026", "€22 255"], status: "completed" as const },
    { id: "837325726", cells: ["CLO-2726", "Security Posture Item 4", "7/11/2026", "€25 826"], status: "warning" as const },
    { id: "837329297", cells: ["CLO-6297", "Security Posture Item 5", "22/6/2026", "€29 397"], status: "active" as const },
];
...
export default function CloudOpsSecurityPosturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Security Posture</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Security Posture</p>
                    </div>
                </div>
