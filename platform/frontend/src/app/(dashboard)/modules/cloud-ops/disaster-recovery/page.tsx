...
const KPIS = [
    { label: "Total", value: "4185", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "373", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2027", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "947808769", cells: ["CLO-1769", "Disaster Recovery Item 1", "6/2/2026", "€8869"], status: "active" as const },
    { id: "947812340", cells: ["CLO-5340", "Disaster Recovery Item 2", "21/9/2026", "€12 440"], status: "pending" as const },
    { id: "947815911", cells: ["CLO-8911", "Disaster Recovery Item 3", "8/4/2026", "€16 011"], status: "completed" as const },
    { id: "947819482", cells: ["CLO-3482", "Disaster Recovery Item 4", "23/11/2026", "€19 582"], status: "warning" as const },
    { id: "947823053", cells: ["CLO-7053", "Disaster Recovery Item 5", "10/6/2026", "€23 153"], status: "active" as const },
];
...
export default function CloudOpsDisasterRecoveryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Disaster Recovery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cloud Ops • Disaster Recovery</p>
                    </div>
                </div>
