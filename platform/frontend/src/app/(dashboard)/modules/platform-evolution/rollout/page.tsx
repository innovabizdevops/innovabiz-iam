...
const PAGE = "Rollout";
const KPIS = [{"l":"Formulários Ativos","v":"2.761","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"178","t":"-3.6%","d":"down"},{"l":"Documentos Gerados","v":"6.508","t":"+11.5%","d":"up"},{"l":"Templates","v":"8.271","t":"-2.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.126","2026-01-08","4.758","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.843","2026-03-28","5.138","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.056","2026-02-01","2.870","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.263","2026-03-25","307","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.105","2026-01-20","5.473","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":563},{"label":"Mar","value":515},{"label":"Abr","value":661},{"label":"Mai","value":458},{"label":"Jun","value":679},{"label":"Jul","value":438},{"label":"Ago","value":612},{"label":"Set","value":457},{"label":"Out","value":647},{"label":"Nov","value":393},{"label":"Dez","value":782}];
const MX = 782;
