...
/* ═══ Platform Evolution Engine — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "1696", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "614", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€310K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1300237896", cells: ["PLA-8896", "Platform Evolution Engine Item 1", "21/1/2026", "€37 996"], status: "active" as const },
    { id: "1300241467", cells: ["PLA-3467", "Platform Evolution Engine Item 2", "8/8/2026", "€41 567"], status: "pending" as const },
    { id: "1300245038", cells: ["PLA-7038", "Platform Evolution Engine Item 3", "23/3/2026", "€45 138"], status: "completed" as const },
    { id: "1300248609", cells: ["PLA-1609", "Platform Evolution Engine Item 4", "10/10/2026", "€48 709"], status: "warning" as const },
    { id: "1300252180", cells: ["PLA-5180", "Platform Evolution Engine Item 5", "25/5/2026", "€2280"], status: "active" as const },
];
...
export default function PlatformEvolutionEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Evolution Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Evolution Engine</p>
                    </div>
                </div>
