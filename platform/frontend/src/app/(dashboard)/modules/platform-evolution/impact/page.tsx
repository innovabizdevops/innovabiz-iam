...
const PAGE = "Impact";
const KPIS = [{"l":"Formulários Ativos","v":"6.185","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"3391","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"2.294","t":"+6.8%","d":"up"},{"l":"Templates","v":"4.793","t":"+7.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.935","2026-02-12","457","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.384","2026-01-22","4.761","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.994","2026-03-03","8.396","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.187","2026-02-09","1.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.231","2026-01-11","6.633","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":580},{"label":"Mar","value":525},{"label":"Abr","value":803},{"label":"Mai","value":756},{"label":"Jun","value":629},{"label":"Jul","value":772},{"label":"Ago","value":741},{"label":"Set","value":874},{"label":"Out","value":563},{"label":"Nov","value":581},{"label":"Dez","value":748}];
const MX = 874;
