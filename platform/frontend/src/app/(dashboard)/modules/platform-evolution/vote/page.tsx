...
const ACCENT = "#312e81";
const MODULE = "Platform Evolution Engine";
const PAGE = "Feature Vote";
const KPIS = [{"l":"Formulários Ativos","v":"5.752","t":"+9.6%","d":"up"},{"l":"Submissões/Dia","v":"984","t":"+4.7%","d":"up"},{"l":"Documentos Gerados","v":"3.230","t":"+13.0%","d":"up"},{"l":"Templates","v":"328","t":"+7.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.912","2026-01-28","6.617","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","314","2026-03-05","5.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.413","2026-01-02","6.113","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.739","2026-03-16","4.483","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.425","2026-03-19","5.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":262},{"label":"Fev","value":475},{"label":"Mar","value":291},{"label":"Abr","value":534},{"label":"Mai","value":419},{"label":"Jun","value":322},{"label":"Jul","value":472},{"label":"Ago","value":605},{"label":"Set","value":583},{"label":"Out","value":391},{"label":"Nov","value":507},{"label":"Dez","value":569}];
const MX = 605;
