...
const PAGE = "Roadmap";
const KPIS = [{"l":"Formulários Ativos","v":"5.178","t":"-3.1%","d":"down"},{"l":"Submissões/Dia","v":"3994","t":"+1.4%","d":"up"},{"l":"Documentos Gerados","v":"1.867","t":"+15.3%","d":"up"},{"l":"Templates","v":"7.607","t":"+6.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.158","2026-02-06","1.825","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.630","2026-01-25","407","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.242","2026-01-23","8.627","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","268","2026-03-14","3.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.307","2026-02-25","5.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":601},{"label":"Mar","value":395},{"label":"Abr","value":316},{"label":"Mai","value":363},{"label":"Jun","value":500},{"label":"Jul","value":550},{"label":"Ago","value":525},{"label":"Set","value":490},{"label":"Out","value":619},{"label":"Nov","value":323},{"label":"Dez","value":451}];
const MX = 619;
