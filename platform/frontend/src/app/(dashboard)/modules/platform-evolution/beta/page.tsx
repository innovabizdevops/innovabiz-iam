...
const PAGE = "Beta";
const KPIS = [{"l":"Formulários Ativos","v":"6.911","t":"+2.7%","d":"up"},{"l":"Submissões/Dia","v":"1653","t":"-4.2%","d":"down"},{"l":"Documentos Gerados","v":"5.896","t":"+12.6%","d":"up"},{"l":"Templates","v":"4.714","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.731","2026-02-18","8.146","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.535","2026-02-07","2.777","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.903","2026-02-27","1.110","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.862","2026-03-13","6.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.536","2026-02-08","2.385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":515},{"label":"Mar","value":500},{"label":"Abr","value":687},{"label":"Mai","value":796},{"label":"Jun","value":716},{"label":"Jul","value":817},{"label":"Ago","value":836},{"label":"Set","value":531},{"label":"Out","value":559},{"label":"Nov","value":474},{"label":"Dez","value":446}];
const MX = 836;
