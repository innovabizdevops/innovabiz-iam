...
/* ═══ S&OP Planning Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "8614", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3026", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€110K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1545933114", cells: ["SC-4114", "S&OP Planning Deep Item 1", "27/7/2026", "€33 214"], status: "active" as const },
    { id: "1545936685", cells: ["SC-7685", "S&OP Planning Deep Item 2", "14/2/2026", "€36 785"], status: "pending" as const },
    { id: "1545940256", cells: ["SC-2256", "S&OP Planning Deep Item 3", "1/9/2026", "€40 356"], status: "completed" as const },
    { id: "1545943827", cells: ["SC-5827", "S&OP Planning Deep Item 4", "16/4/2026", "€43 927"], status: "warning" as const },
    { id: "1545947398", cells: ["SC-9398", "S&OP Planning Deep Item 5", "3/11/2026", "€47 498"], status: "active" as const },
];
...
export default function SopPlanningDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S&OP Planning Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S&OP Planning Deep</p>
                    </div>
                </div>
