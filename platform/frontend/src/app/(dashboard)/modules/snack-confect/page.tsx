...
export default function SnackConfectPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Snack Confect</h1><p className="text-sm text-muted-foreground">Snack Confect • iBOS Enterprise</p></div>
