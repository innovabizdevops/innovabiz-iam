...
const ACCENT = "#7c3aed";
const MODULE = "Snack & Confectionery";
const PAGE = "Tempering";
const KPIS = [{"l":"Total Snack Confect","v":"3.545","t":"+12.7%","d":"up"},{"l":"Tempering Ativos","v":"8.094","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"85","t":"+5.8%","d":"up"}];
const COLS = ["ID","Tempering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snack Confect #001","Snack Confect #002","8.301","8.151","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Snack Confect #002","Snack Confect #003","7.994","5.045","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Snack Confect #003","Snack Confect #004","5.961","2.136","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Snack Confect #004","Snack Confect #005","428","558","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snack Confect #005","Snack Confect #001","7.282","3.318","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":760},{"label":"Mar","value":654},{"label":"Abr","value":910},{"label":"Mai","value":622},{"label":"Jun","value":755},{"label":"Jul","value":911},{"label":"Ago","value":964},{"label":"Set","value":606},{"label":"Out","value":979},{"label":"Nov","value":726},{"label":"Dez","value":735}];
const MX = 979;
...
export default function TemperPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>IoT</span></h1>
                </div>
