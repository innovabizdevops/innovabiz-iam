...
const PAGE = "Flavor Track";
const KPIS = [{"l":"Total Snack Confect","v":"3.311","t":"+5.1%","d":"up"},{"l":"Flavor Track Ativos","v":"4.964","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"83","t":"-2.5%","d":"down"}];
const COLS = ["ID","Flavor Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snack Confect #001","Snack Confect #002","3.615","4.179","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Snack Confect #002","Snack Confect #003","2.823","5.877","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Snack Confect #003","Snack Confect #004","7.094","7.263","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Snack Confect #004","Snack Confect #005","6.094","1.609","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snack Confect #005","Snack Confect #001","416","5.244","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":547},{"label":"Mar","value":474},{"label":"Abr","value":448},{"label":"Mai","value":553},{"label":"Jun","value":465},{"label":"Jul","value":468},{"label":"Ago","value":635},{"label":"Set","value":720},{"label":"Out","value":591},{"label":"Nov","value":531},{"label":"Dez","value":757}];
const MX = 757;
