...
const PAGE = "Schedule";
const KPIS = [{"l":"Integrações Ativas","v":"2.518","t":"+15.7%","d":"up"},{"l":"Chamadas/Hora","v":"652","t":"+5.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.4%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"116ms","t":"+6.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","111","6.458","80.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","868","6.278","84.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.514","4.014","71.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","603","6.712","85.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.030","1.043","74.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":596},{"label":"Mar","value":578},{"label":"Abr","value":902},{"label":"Mai","value":568},{"label":"Jun","value":908},{"label":"Jul","value":661},{"label":"Ago","value":809},{"label":"Set","value":877},{"label":"Out","value":745},{"label":"Nov","value":564},{"label":"Dez","value":786}];
const MX = 908;
