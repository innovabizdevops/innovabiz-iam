...
const PAGE = "Fleet";
const KPIS = [{"l":"Integrações Ativas","v":"6.986","t":"-4.9%","d":"down"},{"l":"Chamadas/Hora","v":"3838","t":"-3.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"91.4%","t":"+9.5%","d":"up"},{"l":"Latência Média (ms)","v":"170ms","t":"+0.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.651","6.136","86.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.507","8.670","70.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.155","4.851","83.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.759","4.098","76.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.463","3.056","93.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":788},{"label":"Mar","value":787},{"label":"Abr","value":1002},{"label":"Mai","value":984},{"label":"Jun","value":674},{"label":"Jul","value":747},{"label":"Ago","value":791},{"label":"Set","value":1020},{"label":"Out","value":979},{"label":"Nov","value":808},{"label":"Dez","value":797}];
const MX = 1020;
