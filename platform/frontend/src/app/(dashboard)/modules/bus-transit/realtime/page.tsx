...
const ACCENT = "#6366f1";
const MODULE = "Bus Transit";
const PAGE = "Real-Time";
const KPIS = [{"l":"Integrações Ativas","v":"3.621","t":"+6.7%","d":"up"},{"l":"Chamadas/Hora","v":"384","t":"-1.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.9%","t":"-0.5%","d":"down"},{"l":"Latência Média (ms)","v":"17ms","t":"+1.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.501","1.039","81.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.144","5.916","94.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.991","1.976","90.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.800","7.988","93.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.653","3.980","82.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":837},{"label":"Mar","value":917},{"label":"Abr","value":843},{"label":"Mai","value":759},{"label":"Jun","value":922},{"label":"Jul","value":733},{"label":"Ago","value":768},{"label":"Set","value":823},{"label":"Out","value":664},{"label":"Nov","value":819},{"label":"Dez","value":974}];
const MX = 974;
