...
const KPIS = [{"l":"Integrações Ativas","v":"6.286","t":"-0.7%","d":"down"},{"l":"Chamadas/Hora","v":"3335","t":"+17.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.4%","t":"+15.4%","d":"up"},{"l":"Latência Média (ms)","v":"186ms","t":"+14.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.526","286","88.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.339","667","87.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.660","954","74.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.284","7.458","81.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.860","8.721","92.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":631},{"label":"Mar","value":539},{"label":"Abr","value":500},{"label":"Mai","value":363},{"label":"Jun","value":428},{"label":"Jul","value":574},{"label":"Ago","value":403},{"label":"Set","value":419},{"label":"Out","value":675},{"label":"Nov","value":679},{"label":"Dez","value":725}];
const MX = 725;
