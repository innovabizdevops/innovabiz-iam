...
const PAGE = "Fare";
const KPIS = [{"l":"Integrações Ativas","v":"7.917","t":"+7.5%","d":"up"},{"l":"Chamadas/Hora","v":"303","t":"+12.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.5%","t":"-5.6%","d":"down"},{"l":"Latência Média (ms)","v":"100ms","t":"-1.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.462","4.114","81.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.904","4.193","92.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","726","6.770","73.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.715","1.907","78.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.714","4.819","90.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":274},{"label":"Fev","value":332},{"label":"Mar","value":614},{"label":"Abr","value":318},{"label":"Mai","value":497},{"label":"Jun","value":328},{"label":"Jul","value":371},{"label":"Ago","value":541},{"label":"Set","value":358},{"label":"Out","value":367},{"label":"Nov","value":390},{"label":"Dez","value":318}];
const MX = 614;
