...
const ACCENT = "#854d0e";
const MODULE = "Carbon Capture Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Carbon Capture","v":"4.223","t":"+14.2%","d":"up"},{"l":"Monitor Ativos","v":"4.815","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+13.6%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Capture #001","Carbon Capture #002","4.577","3.395","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Capture #002","Carbon Capture #003","3.917","5.246","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Capture #003","Carbon Capture #004","2.584","5.698","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Capture #004","Carbon Capture #005","2.975","6.225","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Capture #005","Carbon Capture #001","5.763","5.203","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":717},{"label":"Mar","value":550},{"label":"Abr","value":760},{"label":"Mai","value":547},{"label":"Jun","value":663},{"label":"Jul","value":639},{"label":"Ago","value":694},{"label":"Set","value":588},{"label":"Out","value":821},{"label":"Nov","value":707},{"label":"Dez","value":754}];
const MX = 821;
