...
/* ═══ Carbon Capture Platform — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "2277", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1799", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€26K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1360588877", cells: ["CAR-5877", "Carbon Capture Platform Item 1", "26/6/2026", "€38 977"], status: "active" as const },
    { id: "1360592448", cells: ["CAR-9448", "Carbon Capture Platform Item 2", "13/1/2026", "€42 548"], status: "pending" as const },
    { id: "1360596019", cells: ["CAR-4019", "Carbon Capture Platform Item 3", "28/8/2026", "€46 119"], status: "completed" as const },
    { id: "1360599590", cells: ["CAR-7590", "Carbon Capture Platform Item 4", "15/3/2026", "€49 690"], status: "warning" as const },
    { id: "1360603161", cells: ["CAR-2161", "Carbon Capture Platform Item 5", "2/10/2026", "€3261"], status: "active" as const },
];
...
export default function CarbonCapturePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carbon Capture Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Carbon Capture Platform</p>
                    </div>
                </div>
