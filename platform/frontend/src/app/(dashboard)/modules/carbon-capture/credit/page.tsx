...
const PAGE = "Credit";
const KPIS = [{"l":"Integrações Ativas","v":"2.401","t":"-5.0%","d":"down"},{"l":"Chamadas/Hora","v":"337","t":"+16.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.2%","t":"+4.2%","d":"up"},{"l":"Latência Média (ms)","v":"39ms","t":"+5.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","791","6.046","75.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.458","7.219","71.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.598","7.311","84.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.230","1.129","99.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","219","1.367","96.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":857},{"label":"Mar","value":737},{"label":"Abr","value":743},{"label":"Mai","value":911},{"label":"Jun","value":621},{"label":"Jul","value":562},{"label":"Ago","value":628},{"label":"Set","value":566},{"label":"Out","value":730},{"label":"Nov","value":603},{"label":"Dez","value":641}];
const MX = 911;
