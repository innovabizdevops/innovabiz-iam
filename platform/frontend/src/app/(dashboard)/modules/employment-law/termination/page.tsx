...
const PAGE = "Termination";
const KPIS = [{"l":"Riscos Identificados","v":"2.614","t":"+7.7%","d":"up"},{"l":"Mitigações Ativas","v":"8.990","t":"+0.1%","d":"up"},{"l":"Score Risco Geral","v":"79","t":"+10.2%","d":"up"},{"l":"Incidentes YTD","v":"3.001","t":"-5.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.301","1.828","8.464","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.636","9.039","1.672","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.219","3.650","7.786","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.835","992","3.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.536","6.812","3.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":755},{"label":"Mar","value":437},{"label":"Abr","value":778},{"label":"Mai","value":416},{"label":"Jun","value":724},{"label":"Jul","value":749},{"label":"Ago","value":448},{"label":"Set","value":747},{"label":"Out","value":445},{"label":"Nov","value":633},{"label":"Dez","value":487}];
const MX = 778;
