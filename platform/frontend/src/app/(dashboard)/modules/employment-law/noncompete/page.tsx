...
const ACCENT = "#6366f1";
const MODULE = "Employment Law";
const PAGE = "Non-Compete";
const KPIS = [{"l":"Total Employment Law","v":"4.917","t":"+11.8%","d":"up"},{"l":"Non Compete Ativos","v":"7.408","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+9.3%","d":"up"}];
const COLS = ["ID","Non Compete","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Employment Law #001","Employment Law #002","6.906","460","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Employment Law #002","Employment Law #003","820","8.028","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Employment Law #003","Employment Law #004","5.149","1.051","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Employment Law #004","Employment Law #005","5.136","6.806","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Employment Law #005","Employment Law #001","5.933","3.244","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":609},{"label":"Mar","value":616},{"label":"Abr","value":527},{"label":"Mai","value":624},{"label":"Jun","value":589},{"label":"Jul","value":540},{"label":"Ago","value":632},{"label":"Set","value":601},{"label":"Out","value":528},{"label":"Nov","value":632},{"label":"Dez","value":615}];
const MX = 700;
