...
const KPIS = [{"l":"ARR (€M)","v":"€49.5M","t":"-3.1%","d":"down"},{"l":"MRR (€)","v":"€46433","t":"-4.2%","d":"down"},{"l":"Churn (%)","v":"72.0%","t":"+16.5%","d":"up"},{"l":"ARPU (€)","v":"€67205","t":"+14.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30976.52","4.126","€ 19546.91","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 12640.06","4.806","€ 28282.41","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 8764.62","7.084","€ 6962.38","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47758.14","1.671","€ 18448.39","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5570.18","7.529","€ 21590.67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":649},{"label":"Mar","value":761},{"label":"Abr","value":701},{"label":"Mai","value":542},{"label":"Jun","value":435},{"label":"Jul","value":447},{"label":"Ago","value":536},{"label":"Set","value":439},{"label":"Out","value":525},{"label":"Nov","value":777},{"label":"Dez","value":785}];
const MX = 785;
