...
const ACCENT = "#6366f1";
const MODULE = "Finance Management";
const PAGE = "Close Automation";
const KPIS = [{"l":"Projetos Melhoria","v":"7.610","t":"-4.2%","d":"down"},{"l":"Savings (€)","v":"€12224","t":"+8.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.8%","t":"+5.8%","d":"up"},{"l":"Ciclos PDCA","v":"840","t":"+13.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.629","€ 14310.02","4.790","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.336","€ 8038.49","7.963","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.651","€ 29230.99","1.949","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.319","€ 24477.99","4.635","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","770","€ 8558.20","8.528","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":572},{"label":"Mar","value":355},{"label":"Abr","value":372},{"label":"Mai","value":547},{"label":"Jun","value":643},{"label":"Jul","value":552},{"label":"Ago","value":657},{"label":"Set","value":428},{"label":"Out","value":532},{"label":"Nov","value":585},{"label":"Dez","value":719}];
const MX = 719;
...
export default function CloseAutoPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>APQC</span></h1>
                </div>
