...
const PAGE = "IFRS 9 Financial Instruments";
const KPIS = [{"l":"Projetos Melhoria","v":"7.868","t":"+11.8%","d":"up"},{"l":"Savings (€)","v":"€68661","t":"+17.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.5%","t":"+9.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.690","t":"+5.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.760","€ 13569.52","715","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.788","€ 8130.88","4.893","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.674","€ 22031.84","3.717","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","9.049","€ 44441.24","1.617","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.927","€ 36291.21","3.423","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":407},{"label":"Mar","value":685},{"label":"Abr","value":422},{"label":"Mai","value":385},{"label":"Jun","value":682},{"label":"Jul","value":762},{"label":"Ago","value":502},{"label":"Set","value":455},{"label":"Out","value":672},{"label":"Nov","value":647},{"label":"Dez","value":771}];
const MX = 771;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>IFRS</span></h1>
                </div>
