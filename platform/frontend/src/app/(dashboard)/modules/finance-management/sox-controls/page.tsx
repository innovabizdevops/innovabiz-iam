...
const PAGE = "SOX Controls";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.607","t":"+3.9%","d":"up"},{"l":"NC Abertas","v":"2.082","t":"-5.2%","d":"down"},{"l":"Conformidade (%)","v":"74.3%","t":"+8.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.588","t":"+4.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.023","77.5%","2.896","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.219","81.3%","1.407","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","122","98.1%","736","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.829","89.8%","5.341","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.933","78.2%","1.338","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":945},{"label":"Mar","value":572},{"label":"Abr","value":891},{"label":"Mai","value":875},{"label":"Jun","value":704},{"label":"Jul","value":781},{"label":"Ago","value":843},{"label":"Set","value":848},{"label":"Out","value":745},{"label":"Nov","value":645},{"label":"Dez","value":771}];
const MX = 945;
...
export default function SoxControlsPage() {
    return (
