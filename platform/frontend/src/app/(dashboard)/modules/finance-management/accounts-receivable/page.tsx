...
const PAGE = "Account Receivable";
const KPIS = [{"l":"Projetos Melhoria","v":"7.828","t":"+17.3%","d":"up"},{"l":"Savings (€)","v":"€64175","t":"-0.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"67.7%","t":"+6.8%","d":"up"},{"l":"Ciclos PDCA","v":"2.264","t":"+1.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.528","€ 14233.65","3.594","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.030","€ 19908.31","2.459","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","130","€ 2035.77","6.317","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.698","€ 845.19","6.251","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","245","€ 46725.68","9.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":836},{"label":"Mar","value":791},{"label":"Abr","value":785},{"label":"Mai","value":703},{"label":"Jun","value":652},{"label":"Jul","value":632},{"label":"Ago","value":822},{"label":"Set","value":908},{"label":"Out","value":731},{"label":"Nov","value":859},{"label":"Dez","value":739}];
const MX = 908;
