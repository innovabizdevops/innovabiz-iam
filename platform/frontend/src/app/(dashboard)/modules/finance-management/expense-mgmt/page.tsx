...
const PAGE = "Expense Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.329","t":"+3.5%","d":"up"},{"l":"Savings (€)","v":"€73095","t":"-5.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"67.1%","t":"+1.1%","d":"up"},{"l":"Ciclos PDCA","v":"8.149","t":"-4.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.045","€ 38500.32","5.911","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.525","€ 27584.05","1.298","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.787","€ 15193.54","1.908","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.497","€ 8901.00","5.708","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.656","€ 15914.36","8.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":741},{"label":"Mar","value":528},{"label":"Abr","value":506},{"label":"Mai","value":433},{"label":"Jun","value":594},{"label":"Jul","value":691},{"label":"Ago","value":441},{"label":"Set","value":735},{"label":"Out","value":570},{"label":"Nov","value":782},{"label":"Dez","value":498}];
const MX = 782;
