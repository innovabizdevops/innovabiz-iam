...
const PAGE = "PnL Waterfall Chart";
const KPIS = [{"l":"Projetos Melhoria","v":"2.334","t":"+11.9%","d":"up"},{"l":"Savings (€)","v":"€33991","t":"+15.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.9%","t":"+2.0%","d":"up"},{"l":"Ciclos PDCA","v":"4.577","t":"+17.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.336","€ 46024.31","1.472","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.388","€ 5056.61","4.051","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.465","€ 14108.48","3.656","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.912","€ 26069.80","3.261","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.739","€ 27084.15","2.124","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":635},{"label":"Mar","value":614},{"label":"Abr","value":917},{"label":"Mai","value":691},{"label":"Jun","value":898},{"label":"Jul","value":731},{"label":"Ago","value":782},{"label":"Set","value":713},{"label":"Out","value":905},{"label":"Nov","value":898},{"label":"Dez","value":892}];
const MX = 917;
...
export default function PnlWaterfallPage() {
    return (
