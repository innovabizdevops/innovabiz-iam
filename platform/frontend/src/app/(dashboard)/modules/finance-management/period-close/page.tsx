...
const KPIS = [{"l":"Projetos Melhoria","v":"8.627","t":"+12.6%","d":"up"},{"l":"Savings (€)","v":"€21097","t":"+17.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.7%","t":"+3.5%","d":"up"},{"l":"Ciclos PDCA","v":"304","t":"+5.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.403","€ 844.39","759","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.352","€ 37770.15","503","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.784","€ 44491.19","4.182","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.010","€ 6327.51","1.089","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.999","€ 6554.57","7.133","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":867},{"label":"Mar","value":599},{"label":"Abr","value":780},{"label":"Mai","value":836},{"label":"Jun","value":530},{"label":"Jul","value":558},{"label":"Ago","value":551},{"label":"Set","value":671},{"label":"Out","value":711},{"label":"Nov","value":642},{"label":"Dez","value":648}];
const MX = 867;
