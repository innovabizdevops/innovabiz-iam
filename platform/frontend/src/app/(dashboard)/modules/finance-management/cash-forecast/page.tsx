...
const PAGE = "Cash Forecasting AI";
const KPIS = [{"l":"Projetos Melhoria","v":"788","t":"+12.5%","d":"up"},{"l":"Savings (€)","v":"€72750","t":"+12.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.5%","t":"+8.5%","d":"up"},{"l":"Ciclos PDCA","v":"6.490","t":"+10.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.897","€ 17622.99","5.954","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.285","€ 2100.48","8.215","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.333","€ 6250.44","729","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.893","€ 21429.99","8.308","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.295","€ 29638.75","2.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":832},{"label":"Mar","value":1089},{"label":"Abr","value":1087},{"label":"Mai","value":1015},{"label":"Jun","value":1013},{"label":"Jul","value":983},{"label":"Ago","value":918},{"label":"Set","value":977},{"label":"Out","value":879},{"label":"Nov","value":970},{"label":"Dez","value":806}];
const MX = 1089;
