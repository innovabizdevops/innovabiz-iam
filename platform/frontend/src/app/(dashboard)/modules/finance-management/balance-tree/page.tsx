...
const PAGE = "Balance Sheet Tree";
const KPIS = [{"l":"Projetos Melhoria","v":"8.762","t":"+6.2%","d":"up"},{"l":"Savings (€)","v":"€4359","t":"+5.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.9%","t":"+6.9%","d":"up"},{"l":"Ciclos PDCA","v":"5.326","t":"-1.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.817","€ 44784.29","6.476","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.472","€ 23149.10","3.813","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.717","€ 33010.25","3.022","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.197","€ 37328.79","7.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.587","€ 31397.41","1.616","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":627},{"label":"Mar","value":490},{"label":"Abr","value":399},{"label":"Mai","value":698},{"label":"Jun","value":671},{"label":"Jul","value":391},{"label":"Ago","value":348},{"label":"Set","value":386},{"label":"Out","value":366},{"label":"Nov","value":641},{"label":"Dez","value":713}];
const MX = 713;
...
export default function BalanceTreePage() {
    return (
