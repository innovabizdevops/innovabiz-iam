...
const PAGE = "Intercompany";
const KPIS = [{"l":"Projetos Melhoria","v":"2.603","t":"-5.4%","d":"down"},{"l":"Savings (€)","v":"€10535","t":"+16.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.0%","t":"-0.8%","d":"down"},{"l":"Ciclos PDCA","v":"4.266","t":"+7.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.992","€ 3994.93","4.087","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.830","€ 3345.43","4.177","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.969","€ 6208.72","6.357","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.104","€ 28569.01","2.810","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.360","€ 12797.41","7.459","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":983},{"label":"Mar","value":942},{"label":"Abr","value":897},{"label":"Mai","value":772},{"label":"Jun","value":814},{"label":"Jul","value":879},{"label":"Ago","value":776},{"label":"Set","value":980},{"label":"Out","value":989},{"label":"Nov","value":946},{"label":"Dez","value":677}];
const MX = 989;
...
export default function IntercompanyFinancePage() {
    return (
