...
const PAGE = "Financial Close AI";
const KPIS = [{"l":"Projetos Melhoria","v":"4.083","t":"-0.9%","d":"down"},{"l":"Savings (€)","v":"€9588","t":"-5.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"70.7%","t":"+9.4%","d":"up"},{"l":"Ciclos PDCA","v":"7.467","t":"-3.0%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.792","€ 29266.86","8.386","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.875","€ 37330.79","943","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.798","€ 30664.56","3.371","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","403","€ 7126.50","8.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.265","€ 42094.39","4.455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":730},{"label":"Mar","value":679},{"label":"Abr","value":940},{"label":"Mai","value":734},{"label":"Jun","value":665},{"label":"Jul","value":863},{"label":"Ago","value":801},{"label":"Set","value":874},{"label":"Out","value":725},{"label":"Nov","value":649},{"label":"Dez","value":919}];
const MX = 940;
