...
const KPIS = [{"l":"Ativos Registados","v":"5.981","t":"+15.6%","d":"up"},{"l":"Valor Total (€M)","v":"€25.8M","t":"+10.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€25689","t":"+16.2%","d":"up"},{"l":"Ativos em Garantia","v":"3.252","t":"+2.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 17298.08","6.793","€ 27209.89","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 16087.01","8.749","€ 26403.06","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 28232.89","6.010","€ 7991.18","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 28817.04","1.368","€ 48300.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 37315.86","8.514","€ 48198.08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":853},{"label":"Mar","value":752},{"label":"Abr","value":552},{"label":"Mai","value":597},{"label":"Jun","value":554},{"label":"Jul","value":671},{"label":"Ago","value":851},{"label":"Set","value":714},{"label":"Out","value":741},{"label":"Nov","value":608},{"label":"Dez","value":637}];
const MX = 853;
