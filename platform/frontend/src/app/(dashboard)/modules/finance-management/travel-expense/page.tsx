...
const PAGE = "Travel &amp; Expense AI";
const KPIS = [{"l":"Projetos Melhoria","v":"2.510","t":"+17.7%","d":"up"},{"l":"Savings (€)","v":"€69887","t":"+7.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.8%","t":"+14.3%","d":"up"},{"l":"Ciclos PDCA","v":"2.327","t":"+0.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.969","€ 5861.13","2.144","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.071","€ 17372.57","5.539","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.966","€ 163.34","5.455","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.626","€ 35175.19","6.812","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.165","€ 40402.96","8.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":1028},{"label":"Mar","value":802},{"label":"Abr","value":720},{"label":"Mai","value":803},{"label":"Jun","value":715},{"label":"Jul","value":977},{"label":"Ago","value":826},{"label":"Set","value":948},{"label":"Out","value":793},{"label":"Nov","value":804},{"label":"Dez","value":701}];
const MX = 1028;
