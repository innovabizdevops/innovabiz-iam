...
const KPIS = [{"l":"Projetos Melhoria","v":"1.820","t":"+8.1%","d":"up"},{"l":"Savings (€)","v":"€61166","t":"+5.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.7%","t":"+12.2%","d":"up"},{"l":"Ciclos PDCA","v":"5.733","t":"+7.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.708","€ 25983.26","4.873","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.780","€ 10707.28","905","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.160","€ 40903.67","5.376","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.458","€ 36764.80","5.127","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.897","€ 43055.11","1.226","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":901},{"label":"Mar","value":873},{"label":"Abr","value":854},{"label":"Mai","value":934},{"label":"Jun","value":895},{"label":"Jul","value":910},{"label":"Ago","value":698},{"label":"Set","value":686},{"label":"Out","value":952},{"label":"Nov","value":856},{"label":"Dez","value":763}];
const MX = 952;
