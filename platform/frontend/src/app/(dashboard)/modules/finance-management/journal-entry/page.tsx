...
const PAGE = "Journal Entry Form";
const KPIS = [{"l":"Formulários Ativos","v":"3.729","t":"+7.9%","d":"up"},{"l":"Submissões/Dia","v":"4475","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"2.100","t":"+17.2%","d":"up"},{"l":"Templates","v":"3.326","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.764","2026-02-02","3.064","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.440","2026-02-20","1.612","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.099","2026-03-27","4.351","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.785","2026-03-11","1.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.688","2026-02-23","1.729","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":280},{"label":"Fev","value":647},{"label":"Mar","value":641},{"label":"Abr","value":472},{"label":"Mai","value":367},{"label":"Jun","value":305},{"label":"Jul","value":319},{"label":"Ago","value":286},{"label":"Set","value":378},{"label":"Out","value":649},{"label":"Nov","value":501},{"label":"Dez","value":652}];
const MX = 652;
