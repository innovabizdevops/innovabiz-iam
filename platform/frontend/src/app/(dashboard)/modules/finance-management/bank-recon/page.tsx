...
const PAGE = "Bank Reconciliation";
const KPIS = [{"l":"Projetos Melhoria","v":"7.089","t":"+9.1%","d":"up"},{"l":"Savings (€)","v":"€38709","t":"+2.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.8%","t":"+16.8%","d":"up"},{"l":"Ciclos PDCA","v":"1.606","t":"-5.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.599","€ 21592.26","8.658","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.886","€ 12140.01","850","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.645","€ 2006.65","3.195","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.995","€ 39368.26","2.645","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.844","€ 4820.16","3.680","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":671},{"label":"Mar","value":481},{"label":"Abr","value":458},{"label":"Mai","value":485},{"label":"Jun","value":582},{"label":"Jul","value":454},{"label":"Ago","value":289},{"label":"Set","value":436},{"label":"Out","value":640},{"label":"Nov","value":563},{"label":"Dez","value":663}];
const MX = 671;
