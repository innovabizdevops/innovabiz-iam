...
const KPIS = [{"l":"Projetos Melhoria","v":"1.560","t":"+15.4%","d":"up"},{"l":"Savings (€)","v":"€85097","t":"-5.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.1%","t":"+12.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.581","t":"+11.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.163","€ 39061.73","5.879","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.648","€ 11943.55","960","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","907","€ 22057.23","4.480","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.170","€ 34977.90","5.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.223","€ 31507.44","3.703","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":784},{"label":"Mar","value":698},{"label":"Abr","value":1017},{"label":"Mai","value":794},{"label":"Jun","value":938},{"label":"Jul","value":951},{"label":"Ago","value":696},{"label":"Set","value":965},{"label":"Out","value":809},{"label":"Nov","value":1018},{"label":"Dez","value":831}];
const MX = 1018;
