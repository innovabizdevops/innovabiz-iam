...
const PAGE = "Variance Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"8.131","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"3263","t":"+18.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.865","t":"+9.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.894","t":"+12.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1667","2026-03-25","7.785","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1454","2026-03-11","1.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3667","2026-01-03","1.085","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1030","2026-03-11","5.016","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3588","2026-01-19","3.517","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":481},{"label":"Mar","value":382},{"label":"Abr","value":330},{"label":"Mai","value":386},{"label":"Jun","value":315},{"label":"Jul","value":332},{"label":"Ago","value":320},{"label":"Set","value":583},{"label":"Out","value":527},{"label":"Nov","value":416},{"label":"Dez","value":617}];
const MX = 617;
