...
const PAGE = "Cash Flow Diagram";
const KPIS = [{"l":"Diagramas Criados","v":"5.929","t":"+5.6%","d":"up"},{"l":"Templates","v":"3.324","t":"+11.7%","d":"up"},{"l":"Colaboradores","v":"1.862","t":"-2.4%","d":"down"},{"l":"Comentários/Semana","v":"4217","t":"+14.3%","d":"up"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","3.177","2026-02-07","1.641","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","1.705","2026-03-21","7.730","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","1.144","2026-03-17","5.581","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","3.946","2026-03-27","2.169","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","6.157","2026-01-27","8.013","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":836},{"label":"Mar","value":760},{"label":"Abr","value":846},{"label":"Mai","value":845},{"label":"Jun","value":865},{"label":"Jul","value":683},{"label":"Ago","value":566},{"label":"Set","value":590},{"label":"Out","value":893},{"label":"Nov","value":637},{"label":"Dez","value":812}];
const MX = 893;
...
export default function CashFlowDiagramPage() {
    return (
