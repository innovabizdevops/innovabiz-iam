...
const ACCENT = "#0d9488";
const MODULE = "Container Platform Deep";
const PAGE = "Deploy";
const KPIS = [{"l":"Formulários Ativos","v":"4.513","t":"+15.1%","d":"up"},{"l":"Submissões/Dia","v":"4484","t":"-2.0%","d":"down"},{"l":"Documentos Gerados","v":"230","t":"-5.9%","d":"down"},{"l":"Templates","v":"887","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.573","2026-03-11","5.976","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.771","2026-01-17","9.058","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.435","2026-02-25","2.055","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.248","2026-01-24","624","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","610","2026-01-07","3.417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":747},{"label":"Mar","value":1000},{"label":"Abr","value":827},{"label":"Mai","value":629},{"label":"Jun","value":631},{"label":"Jul","value":618},{"label":"Ago","value":694},{"label":"Set","value":776},{"label":"Out","value":820},{"label":"Nov","value":801},{"label":"Dez","value":668}];
const MX = 1000;
