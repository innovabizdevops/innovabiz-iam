...
/* ═══ Container Platform Deep — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "6730", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2211", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€36K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1187056230", cells: ["CON-2230", "Container Platform Deep Item 1", "11/7/2026", "€6330"], status: "active" as const },
    { id: "1187059801", cells: ["CON-5801", "Container Platform Deep Item 2", "26/2/2026", "€9901"], status: "pending" as const },
    { id: "1187063372", cells: ["CON-9372", "Container Platform Deep Item 3", "13/9/2026", "€13 472"], status: "completed" as const },
    { id: "1187066943", cells: ["CON-3943", "Container Platform Deep Item 4", "28/4/2026", "€17 043"], status: "warning" as const },
    { id: "1187070514", cells: ["CON-7514", "Container Platform Deep Item 5", "15/11/2026", "€20 614"], status: "active" as const },
];
...
export default function ContainerPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Container Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Container Platform Deep</p>
                    </div>
                </div>
