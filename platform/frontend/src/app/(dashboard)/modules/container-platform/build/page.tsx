...
const PAGE = "Build";
const KPIS = [{"l":"Formulários Ativos","v":"511","t":"+4.1%","d":"up"},{"l":"Submissões/Dia","v":"902","t":"+1.5%","d":"up"},{"l":"Documentos Gerados","v":"6.815","t":"+4.5%","d":"up"},{"l":"Templates","v":"1.004","t":"+2.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.280","2026-03-16","4.071","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.026","2026-01-10","281","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.605","2026-01-07","3.763","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.560","2026-02-15","101","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.110","2026-01-12","2.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":452},{"label":"Mar","value":601},{"label":"Abr","value":273},{"label":"Mai","value":362},{"label":"Jun","value":309},{"label":"Jul","value":316},{"label":"Ago","value":221},{"label":"Set","value":256},{"label":"Out","value":452},{"label":"Nov","value":577},{"label":"Dez","value":330}];
const MX = 601;
