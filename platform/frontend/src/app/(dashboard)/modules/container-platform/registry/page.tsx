...
const PAGE = "Registry";
const KPIS = [{"l":"Formulários Ativos","v":"2.477","t":"-0.6%","d":"down"},{"l":"Submissões/Dia","v":"812","t":"+12.3%","d":"up"},{"l":"Documentos Gerados","v":"3.796","t":"+14.0%","d":"up"},{"l":"Templates","v":"5.077","t":"+14.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","739","2026-02-05","5.896","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.726","2026-02-15","2.078","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.339","2026-03-05","1.341","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.387","2026-01-21","6.188","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.401","2026-03-05","1.313","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":754},{"label":"Mar","value":952},{"label":"Abr","value":923},{"label":"Mai","value":951},{"label":"Jun","value":1033},{"label":"Jul","value":806},{"label":"Ago","value":934},{"label":"Set","value":950},{"label":"Out","value":811},{"label":"Nov","value":758},{"label":"Dez","value":687}];
const MX = 1033;
