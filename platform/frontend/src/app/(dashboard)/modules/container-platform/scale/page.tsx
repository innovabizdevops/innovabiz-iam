...
const PAGE = "Scale";
const KPIS = [{"l":"Formulários Ativos","v":"5.156","t":"+12.6%","d":"up"},{"l":"Submissões/Dia","v":"3929","t":"-4.1%","d":"down"},{"l":"Documentos Gerados","v":"310","t":"+8.6%","d":"up"},{"l":"Templates","v":"1.102","t":"+17.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.430","2026-02-17","6.330","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.169","2026-03-28","967","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","864","2026-03-15","894","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","365","2026-03-19","2.861","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.217","2026-03-28","597","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":973},{"label":"Mar","value":871},{"label":"Abr","value":925},{"label":"Mai","value":1014},{"label":"Jun","value":818},{"label":"Jul","value":883},{"label":"Ago","value":1082},{"label":"Set","value":905},{"label":"Out","value":771},{"label":"Nov","value":877},{"label":"Dez","value":703}];
const MX = 1082;
