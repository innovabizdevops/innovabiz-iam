...
const PAGE = "Secure";
const KPIS = [{"l":"Formulários Ativos","v":"8.881","t":"+8.6%","d":"up"},{"l":"Submissões/Dia","v":"237","t":"+7.6%","d":"up"},{"l":"Documentos Gerados","v":"751","t":"-3.2%","d":"down"},{"l":"Templates","v":"4.315","t":"+1.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.836","2026-03-13","8.729","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.494","2026-01-13","981","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.604","2026-01-13","3.389","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","909","2026-02-25","4.251","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.079","2026-02-17","1.016","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":818},{"label":"Mar","value":569},{"label":"Abr","value":510},{"label":"Mai","value":568},{"label":"Jun","value":542},{"label":"Jul","value":863},{"label":"Ago","value":831},{"label":"Set","value":643},{"label":"Out","value":568},{"label":"Nov","value":748},{"label":"Dez","value":586}];
const MX = 863;
