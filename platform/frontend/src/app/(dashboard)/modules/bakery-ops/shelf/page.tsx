...
const PAGE = "Shelf Life";
const KPIS = [{"l":"Total Bakery Ops","v":"2.606","t":"+0.3%","d":"up"},{"l":"Shelf Life Ativos","v":"6.792","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"84","t":"-2.2%","d":"down"}];
const COLS = ["ID","Shelf Life","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bakery Ops #001","Bakery Ops #002","8.979","1.455","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Bakery Ops #002","Bakery Ops #003","5.724","2.899","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Bakery Ops #003","Bakery Ops #004","4.803","6.680","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Bakery Ops #004","Bakery Ops #005","7.946","4.722","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bakery Ops #005","Bakery Ops #001","4.039","6.811","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":583},{"label":"Mar","value":389},{"label":"Abr","value":655},{"label":"Mai","value":525},{"label":"Jun","value":467},{"label":"Jul","value":453},{"label":"Ago","value":463},{"label":"Set","value":346},{"label":"Out","value":644},{"label":"Nov","value":475},{"label":"Dez","value":563}];
const MX = 655;
