...
const PAGE = "Dough Mgmt";
const KPIS = [{"l":"Total Bakery Ops","v":"3.515","t":"+5.2%","d":"up"},{"l":"Dough Mgmt Ativos","v":"7.496","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"70.1%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+15.1%","d":"up"}];
const COLS = ["ID","Dough Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bakery Ops #001","Bakery Ops #002","8.475","7.136","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Bakery Ops #002","Bakery Ops #003","1.356","7.574","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Bakery Ops #003","Bakery Ops #004","2.765","7.722","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Bakery Ops #004","Bakery Ops #005","8.136","4.305","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bakery Ops #005","Bakery Ops #001","1.601","215","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":788},{"label":"Mar","value":868},{"label":"Abr","value":852},{"label":"Mai","value":673},{"label":"Jun","value":729},{"label":"Jul","value":975},{"label":"Ago","value":655},{"label":"Set","value":1016},{"label":"Out","value":873},{"label":"Nov","value":630},{"label":"Dez","value":807}];
const MX = 1016;
...
export default function DoughPage() {
    return (
