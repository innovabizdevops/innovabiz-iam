...
const PAGE = "Decorating";
const KPIS = [{"l":"Surveys Ativos","v":"6.565","t":"+6.1%","d":"up"},{"l":"Respostas/Semana","v":"727","t":"-4.3%","d":"down"},{"l":"NPS Médio","v":"77","t":"+13.9%","d":"up"},{"l":"Taxa Resposta (%)","v":"78.4%","t":"+6.5%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.258","64","89.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.332","75","70.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.242","79","80.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","8.676","70","88.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.810","57","96.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":725},{"label":"Mar","value":989},{"label":"Abr","value":958},{"label":"Mai","value":715},{"label":"Jun","value":879},{"label":"Jul","value":686},{"label":"Ago","value":770},{"label":"Set","value":857},{"label":"Out","value":695},{"label":"Nov","value":972},{"label":"Dez","value":837}];
const MX = 989;
