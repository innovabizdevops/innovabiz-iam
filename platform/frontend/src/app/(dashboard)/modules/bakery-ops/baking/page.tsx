...
const PAGE = "Baking Sched";
const KPIS = [{"l":"Total Bakery Ops","v":"2.396","t":"+13.9%","d":"up"},{"l":"Baking Sched Ativos","v":"1.113","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"59","t":"+12.4%","d":"up"}];
const COLS = ["ID","Baking Sched","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bakery Ops #001","Bakery Ops #002","532","2.911","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Bakery Ops #002","Bakery Ops #003","5.133","5.574","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Bakery Ops #003","Bakery Ops #004","7.566","4.087","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Bakery Ops #004","Bakery Ops #005","2.733","7.702","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bakery Ops #005","Bakery Ops #001","8.168","6.474","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":498},{"label":"Mar","value":522},{"label":"Abr","value":543},{"label":"Mai","value":546},{"label":"Jun","value":567},{"label":"Jul","value":512},{"label":"Ago","value":283},{"label":"Set","value":578},{"label":"Out","value":297},{"label":"Nov","value":443},{"label":"Dez","value":388}];
const MX = 675;
