...
const ACCENT = "#b45309";
const MODULE = "Bakery Operations";
const PAGE = "Proofing";
const KPIS = [{"l":"Total Bakery Ops","v":"5.061","t":"+4.7%","d":"up"},{"l":"Proofing Ativos","v":"6.695","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.1%","d":"up"}];
const COLS = ["ID","Proofing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bakery Ops #001","Bakery Ops #002","6.666","6.341","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Bakery Ops #002","Bakery Ops #003","6.889","7.601","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Bakery Ops #003","Bakery Ops #004","3.045","659","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Bakery Ops #004","Bakery Ops #005","6.071","6.852","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bakery Ops #005","Bakery Ops #001","4.669","2.474","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":398},{"label":"Mar","value":276},{"label":"Abr","value":360},{"label":"Mai","value":638},{"label":"Jun","value":315},{"label":"Jul","value":530},{"label":"Ago","value":546},{"label":"Set","value":385},{"label":"Out","value":347},{"label":"Nov","value":305},{"label":"Dez","value":605}];
const MX = 638;
