...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.753","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"303","t":"+1.2%","d":"up"},{"l":"Conformidade (%)","v":"75.1%","t":"-5.2%","d":"down"},{"l":"CAPAs Pendentes","v":"3.966","t":"+8.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.106","73.9%","8.904","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.114","97.8%","6.942","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.176","83.5%","3.952","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.447","74.8%","8.749","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.645","83.9%","364","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":807},{"label":"Mar","value":833},{"label":"Abr","value":824},{"label":"Mai","value":760},{"label":"Jun","value":586},{"label":"Jul","value":669},{"label":"Ago","value":820},{"label":"Set","value":800},{"label":"Out","value":828},{"label":"Nov","value":652},{"label":"Dez","value":560}];
const MX = 833;
