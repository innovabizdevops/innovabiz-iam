...
const ACCENT = "#6366f1";
const MODULE = "Screen Printing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.131","t":"+9.9%","d":"up"},{"l":"Submissões/Dia","v":"112","t":"+2.0%","d":"up"},{"l":"Documentos Gerados","v":"1.488","t":"+0.2%","d":"up"},{"l":"Templates","v":"6.971","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.784","2026-01-26","2.869","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.840","2026-01-20","1.676","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.553","2026-02-01","3.752","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.982","2026-01-18","5.218","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.623","2026-01-25","7.811","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":510},{"label":"Mar","value":616},{"label":"Abr","value":676},{"label":"Mai","value":808},{"label":"Jun","value":672},{"label":"Jul","value":622},{"label":"Ago","value":811},{"label":"Set","value":521},{"label":"Out","value":636},{"label":"Nov","value":565},{"label":"Dez","value":644}];
const MX = 868;
