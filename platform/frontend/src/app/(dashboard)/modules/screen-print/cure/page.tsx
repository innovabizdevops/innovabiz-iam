...
const PAGE = "Cure";
const KPIS = [{"l":"Total Screen Print","v":"950","t":"-2.8%","d":"down"},{"l":"Cure Ativos","v":"941","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.4%","d":"down"}];
const COLS = ["ID","Cure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Screen Print #001","Screen Print #002","6.043","1.658","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Screen Print #002","Screen Print #003","6.951","5.420","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Screen Print #003","Screen Print #004","8.701","7.039","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Screen Print #004","Screen Print #005","7.590","5.450","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Screen Print #005","Screen Print #001","8.086","8.982","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":653},{"label":"Mar","value":431},{"label":"Abr","value":781},{"label":"Mai","value":609},{"label":"Jun","value":723},{"label":"Jul","value":445},{"label":"Ago","value":661},{"label":"Set","value":594},{"label":"Out","value":711},{"label":"Nov","value":688},{"label":"Dez","value":433}];
const MX = 781;
