...
const PAGE = "Screen";
const KPIS = [{"l":"Total Screen Print","v":"225","t":"+17.4%","d":"up"},{"l":"Screen Ativos","v":"3.331","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"70.5%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"75","t":"+14.4%","d":"up"}];
const COLS = ["ID","Screen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Screen Print #001","Screen Print #002","3.672","360","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Screen Print #002","Screen Print #003","2.159","592","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Screen Print #003","Screen Print #004","7.723","5.579","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Screen Print #004","Screen Print #005","1.459","8.521","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Screen Print #005","Screen Print #001","7.094","2.960","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":856},{"label":"Mar","value":823},{"label":"Abr","value":831},{"label":"Mai","value":496},{"label":"Jun","value":710},{"label":"Jul","value":514},{"label":"Ago","value":663},{"label":"Set","value":733},{"label":"Out","value":874},{"label":"Nov","value":721},{"label":"Dez","value":612}];
const MX = 874;
