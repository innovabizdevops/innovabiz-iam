...
const ACCENT = "#6366f1";
const MODULE = "Bakery Manufacturing";
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"6.608","t":"+3.7%","d":"up"},{"l":"Viagens/Dia","v":"2713","t":"+8.2%","d":"up"},{"l":"Pontualidade (%)","v":"67.8%","t":"-5.0%","d":"down"},{"l":"Passageiros/Dia","v":"1664","t":"-1.5%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-10","2026-02-01","6.061","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-14","2026-02-05","4.242","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-09","2026-02-24","4.123","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-25","2026-01-23","7.176","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-18","2026-03-14","5.467","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":265},{"label":"Fev","value":576},{"label":"Mar","value":602},{"label":"Abr","value":437},{"label":"Mai","value":434},{"label":"Jun","value":272},{"label":"Jul","value":291},{"label":"Ago","value":589},{"label":"Set","value":293},{"label":"Out","value":515},{"label":"Nov","value":500},{"label":"Dez","value":296}];
const MX = 602;
