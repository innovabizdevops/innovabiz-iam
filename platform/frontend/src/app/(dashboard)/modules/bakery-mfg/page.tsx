...
export default function BakeryMfgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Bakery Mfg</h1><p className="text-sm text-muted-foreground">Bakery Mfg • iBOS Enterprise</p></div>
