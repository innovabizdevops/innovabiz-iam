...
const PAGE = "Recipe";
const KPIS = [{"l":"Total Bakery Mfg","v":"453","t":"-4.6%","d":"down"},{"l":"Recipe Ativos","v":"4.728","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"69.4%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+0.1%","d":"up"}];
const COLS = ["ID","Recipe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bakery Mfg #001","Bakery Mfg #002","995","8.906","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Bakery Mfg #002","Bakery Mfg #003","3.178","1.191","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Bakery Mfg #003","Bakery Mfg #004","3.978","2.346","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Bakery Mfg #004","Bakery Mfg #005","769","3.713","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bakery Mfg #005","Bakery Mfg #001","431","287","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":902},{"label":"Mar","value":1005},{"label":"Abr","value":967},{"label":"Mai","value":963},{"label":"Jun","value":687},{"label":"Jul","value":783},{"label":"Ago","value":754},{"label":"Set","value":718},{"label":"Out","value":705},{"label":"Nov","value":934},{"label":"Dez","value":688}];
const MX = 1005;
