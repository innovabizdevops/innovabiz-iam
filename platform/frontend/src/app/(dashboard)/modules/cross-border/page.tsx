...
/* ═══ Cross-Border Commerce — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "6652", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1518", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€331K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2136010752", cells: ["CRO-5752", "Cross-Border Commerce Item 1", "9/1/2026", "€10 852"], status: "active" as const },
    { id: "2136014323", cells: ["CRO-9323", "Cross-Border Commerce Item 2", "24/8/2026", "€14 423"], status: "pending" as const },
    { id: "2136017894", cells: ["CRO-3894", "Cross-Border Commerce Item 3", "11/3/2026", "€17 994"], status: "completed" as const },
    { id: "2136021465", cells: ["CRO-7465", "Cross-Border Commerce Item 4", "26/10/2026", "€21 565"], status: "warning" as const },
    { id: "2136025036", cells: ["CRO-2036", "Cross-Border Commerce Item 5", "13/5/2026", "€25 136"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cross-Border Commerce</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cross-Border Commerce</p>
                    </div>
                </div>
