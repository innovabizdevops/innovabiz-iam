...
const PAGE = "Replicate";
const KPIS = [{"l":"Dashboards Ativos","v":"3.649","t":"+4.1%","d":"up"},{"l":"Queries/Dia","v":"3517","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.547","t":"+11.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.315","t":"+0.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","428","2026-01-23","6.600","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1930","2026-01-23","3.769","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4320","2026-02-15","7.822","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1681","2026-02-12","4.483","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4118","2026-02-22","4.387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":689},{"label":"Mar","value":417},{"label":"Abr","value":516},{"label":"Mai","value":371},{"label":"Jun","value":414},{"label":"Jul","value":364},{"label":"Ago","value":570},{"label":"Set","value":428},{"label":"Out","value":516},{"label":"Nov","value":357},{"label":"Dez","value":710}];
const MX = 710;
