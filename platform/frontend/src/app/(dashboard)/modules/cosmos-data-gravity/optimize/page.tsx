...
const PAGE = "Optimize";
const KPIS = [{"l":"Dashboards Ativos","v":"2.535","t":"+11.1%","d":"up"},{"l":"Queries/Dia","v":"3778","t":"-5.4%","d":"down"},{"l":"Dados Processados (GB)","v":"6.771","t":"+9.6%","d":"up"},{"l":"Utilizadores Analytics","v":"923","t":"+14.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1075","2026-02-27","8.408","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3871","2026-03-18","6.493","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3099","2026-03-16","392","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4520","2026-01-03","5.424","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3405","2026-02-07","2.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":543},{"label":"Mar","value":776},{"label":"Abr","value":480},{"label":"Mai","value":519},{"label":"Jun","value":537},{"label":"Jul","value":510},{"label":"Ago","value":641},{"label":"Set","value":675},{"label":"Out","value":577},{"label":"Nov","value":714},{"label":"Dez","value":623}];
const MX = 799;
