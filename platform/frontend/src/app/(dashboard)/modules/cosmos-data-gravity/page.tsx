...
/* ═══ COSMOS Data Gravity Engine — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "5685", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4336", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€43K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "712518485", cells: ["COS-7485", "COSMOS Data Gravity Engine Item 1", "22/6/2026", "€18 585"], status: "active" as const },
    { id: "712522056", cells: ["COS-2056", "COSMOS Data Gravity Engine Item 2", "9/1/2026", "€22 156"], status: "pending" as const },
    { id: "712525627", cells: ["COS-5627", "COSMOS Data Gravity Engine Item 3", "24/8/2026", "€25 727"], status: "completed" as const },
    { id: "712529198", cells: ["COS-9198", "COSMOS Data Gravity Engine Item 4", "11/3/2026", "€29 298"], status: "warning" as const },
    { id: "712532769", cells: ["COS-3769", "COSMOS Data Gravity Engine Item 5", "26/10/2026", "€32 869"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 25 }, { label: "Fev", value: 34 }, { label: "Mar", value: 43 }, { label: "Abr", value: 52 }, { label: "Mai", value: 61 }, { label: "Jun", value: 70 }];
...
export default function CosmosDataGravityEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Data Gravity Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Data Gravity Engine</p>
                    </div>
                </div>
