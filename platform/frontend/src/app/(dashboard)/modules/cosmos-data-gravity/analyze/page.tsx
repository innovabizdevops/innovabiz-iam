...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"8.031","t":"-3.7%","d":"down"},{"l":"Queries/Dia","v":"2436","t":"+4.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.431","t":"+4.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.183","t":"+18.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","469","2026-02-19","3.233","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4805","2026-01-22","7.204","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4203","2026-03-23","517","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1335","2026-01-24","1.352","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2039","2026-03-03","8.757","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":362},{"label":"Mar","value":524},{"label":"Abr","value":472},{"label":"Mai","value":392},{"label":"Jun","value":448},{"label":"Jul","value":359},{"label":"Ago","value":443},{"label":"Set","value":465},{"label":"Out","value":530},{"label":"Nov","value":506},{"label":"Dez","value":564}];
const MX = 564;
