...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Data Gravity Engine";
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"4.595","t":"+7.5%","d":"up"},{"l":"Queries/Dia","v":"2812","t":"+16.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.439","t":"+8.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.791","t":"-2.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4566","2026-02-28","1.175","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3937","2026-02-17","2.034","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4383","2026-01-04","3.940","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1257","2026-01-11","8.367","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2511","2026-03-05","8.033","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":667},{"label":"Mar","value":504},{"label":"Abr","value":833},{"label":"Mai","value":724},{"label":"Jun","value":496},{"label":"Jul","value":502},{"label":"Ago","value":730},{"label":"Set","value":803},{"label":"Out","value":820},{"label":"Nov","value":502},{"label":"Dez","value":678}];
const MX = 833;
