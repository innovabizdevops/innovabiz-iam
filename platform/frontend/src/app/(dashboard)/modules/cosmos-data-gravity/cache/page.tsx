...
const PAGE = "Cache";
const KPIS = [{"l":"Dashboards Ativos","v":"4.726","t":"-0.3%","d":"down"},{"l":"Queries/Dia","v":"3725","t":"+11.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.457","t":"+9.7%","d":"up"},{"l":"Utilizadores Analytics","v":"785","t":"+4.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1334","2026-02-20","816","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2870","2026-03-04","4.140","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1422","2026-02-05","8.059","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","312","2026-02-07","4.408","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3830","2026-03-10","6.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":841},{"label":"Mar","value":820},{"label":"Abr","value":539},{"label":"Mai","value":659},{"label":"Jun","value":486},{"label":"Jul","value":677},{"label":"Ago","value":641},{"label":"Set","value":524},{"label":"Out","value":620},{"label":"Nov","value":720},{"label":"Dez","value":506}];
const MX = 841;
