...
const ACCENT = "#b45309";
const MODULE = "Opportunity Management";
const PAGE = "Probability AI";
const KPIS = [{"l":"Total Opportunity Mgmt","v":"3.383","t":"+10.3%","d":"up"},{"l":"Probability AI Ativos","v":"6.282","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"83","t":"-1.0%","d":"down"}];
const COLS = ["ID","Probability AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Opportunity Mgmt #001","Opportunity Mgmt #002","7.962","5.710","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Opportunity Mgmt #002","Opportunity Mgmt #003","6.839","2.718","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Opportunity Mgmt #003","Opportunity Mgmt #004","7.999","3.361","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Opportunity Mgmt #004","Opportunity Mgmt #005","2.518","1.427","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Opportunity Mgmt #005","Opportunity Mgmt #001","1.942","2.327","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":891},{"label":"Mar","value":811},{"label":"Abr","value":940},{"label":"Mai","value":923},{"label":"Jun","value":854},{"label":"Jul","value":786},{"label":"Ago","value":745},{"label":"Set","value":686},{"label":"Out","value":842},{"label":"Nov","value":850},{"label":"Dez","value":681}];
const MX = 940;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>AI</span></h1>
                </div>
