...
const PAGE = "Pipeline Board";
const KPIS = [{"l":"Teams Ativos","v":"8.538","t":"-1.7%","d":"down"},{"l":"Reuniões/Semana","v":"4170","t":"+3.3%","d":"up"},{"l":"Mensagens/Dia","v":"3527","t":"+15.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.170","t":"+5.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.954","185","7.055","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","622","2731","7.062","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.029","2584","4.263","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.595","4464","2.782","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.738","1689","3.990","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":543},{"label":"Mar","value":731},{"label":"Abr","value":647},{"label":"Mai","value":572},{"label":"Jun","value":692},{"label":"Jul","value":714},{"label":"Ago","value":523},{"label":"Set","value":463},{"label":"Out","value":506},{"label":"Nov","value":641},{"label":"Dez","value":413}];
const MX = 731;
