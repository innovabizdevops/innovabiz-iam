...
const PAGE = "Stage Gates";
const KPIS = [{"l":"Total Opportunity Mgmt","v":"1.698","t":"+4.0%","d":"up"},{"l":"Stage Gates Ativos","v":"6.392","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"60","t":"+15.8%","d":"up"}];
const COLS = ["ID","Stage Gates","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Opportunity Mgmt #001","Opportunity Mgmt #002","7.326","1.000","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Opportunity Mgmt #002","Opportunity Mgmt #003","4.085","5.323","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Opportunity Mgmt #003","Opportunity Mgmt #004","2.913","5.396","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Opportunity Mgmt #004","Opportunity Mgmt #005","5.292","4.390","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Opportunity Mgmt #005","Opportunity Mgmt #001","862","2.350","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":299},{"label":"Mar","value":503},{"label":"Abr","value":453},{"label":"Mai","value":531},{"label":"Jun","value":491},{"label":"Jul","value":597},{"label":"Ago","value":312},{"label":"Set","value":455},{"label":"Out","value":528},{"label":"Nov","value":334},{"label":"Dez","value":542}];
const MX = 597;
