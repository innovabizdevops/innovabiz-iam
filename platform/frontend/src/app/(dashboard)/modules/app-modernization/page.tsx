...
/* ═══ App Modernization — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "6460", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1184", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€83K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "909598560", cells: ["APP-5560", "App Modernization Item 1", "25/1/2026", "€48 660"], status: "active" as const },
    { id: "909602131", cells: ["APP-9131", "App Modernization Item 2", "12/8/2026", "€2231"], status: "pending" as const },
    { id: "909605702", cells: ["APP-3702", "App Modernization Item 3", "27/3/2026", "€5802"], status: "completed" as const },
    { id: "909609273", cells: ["APP-7273", "App Modernization Item 4", "14/10/2026", "€9373"], status: "warning" as const },
    { id: "909612844", cells: ["APP-1844", "App Modernization Item 5", "1/5/2026", "€12 944"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">App Modernization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • App Modernization</p>
                    </div>
                </div>
