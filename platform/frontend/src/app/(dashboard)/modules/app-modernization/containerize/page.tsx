...
const ACCENT = "#00bcf2";
const MODULE = "App Modernization";
const PAGE = "Containerize";
const KPIS = [{"l":"Total App Modernization","v":"1.322","t":"+2.5%","d":"up"},{"l":"Containerize Ativos","v":"4.058","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+8.0%","d":"up"}];
const COLS = ["ID","Containerize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["App Modernization #001","App Modernization #002","3.627","6.917","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["App Modernization #002","App Modernization #003","5.773","8.740","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["App Modernization #003","App Modernization #004","2.437","6.674","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["App Modernization #004","App Modernization #005","6.654","3.958","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["App Modernization #005","App Modernization #001","7.125","5.032","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":880},{"label":"Mar","value":933},{"label":"Abr","value":613},{"label":"Mai","value":803},{"label":"Jun","value":785},{"label":"Jul","value":1003},{"label":"Ago","value":658},{"label":"Set","value":922},{"label":"Out","value":914},{"label":"Nov","value":703},{"label":"Dez","value":663}];
const MX = 1003;
