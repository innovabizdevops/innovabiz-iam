...
const PAGE = "Replatform";
const KPIS = [{"l":"Formulários Ativos","v":"1.590","t":"-2.0%","d":"down"},{"l":"Submissões/Dia","v":"2437","t":"+3.5%","d":"up"},{"l":"Documentos Gerados","v":"1.196","t":"-0.1%","d":"down"},{"l":"Templates","v":"3.567","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.200","2026-01-10","1.499","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.075","2026-03-11","3.140","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.548","2026-01-01","7.558","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.598","2026-01-16","8.943","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","248","2026-01-07","4.522","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":987},{"label":"Mar","value":754},{"label":"Abr","value":853},{"label":"Mai","value":834},{"label":"Jun","value":953},{"label":"Jul","value":937},{"label":"Ago","value":876},{"label":"Set","value":889},{"label":"Out","value":947},{"label":"Nov","value":700},{"label":"Dez","value":909}];
const MX = 987;
...
export default function ReplatformPage() {
    return (
