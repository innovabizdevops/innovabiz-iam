...
const PAGE = "Cost Control";
const KPIS = [{"l":"Total Fb Ops","v":"3.655","t":"-4.0%","d":"down"},{"l":"Cost Control Ativos","v":"1.783","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"71","t":"-3.2%","d":"down"}];
const COLS = ["ID","Cost Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fb Ops #001","Fb Ops #002","676","1.229","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Fb Ops #002","Fb Ops #003","6.151","8.193","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Fb Ops #003","Fb Ops #004","6.666","1.803","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Fb Ops #004","Fb Ops #005","7.596","8.765","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fb Ops #005","Fb Ops #001","5.839","7.441","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":570},{"label":"Mar","value":825},{"label":"Abr","value":909},{"label":"Mai","value":906},{"label":"Jun","value":831},{"label":"Jul","value":659},{"label":"Ago","value":559},{"label":"Set","value":879},{"label":"Out","value":900},{"label":"Nov","value":802},{"label":"Dez","value":606}];
const MX = 909;
