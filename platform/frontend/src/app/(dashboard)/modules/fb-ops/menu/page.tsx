...
const ACCENT = "#0e7490";
const MODULE = "F&B Operations";
const PAGE = "Menu Plan";
const KPIS = [{"l":"Quartos Ocupados","v":"6.752","t":"+5.0%","d":"up"},{"l":"RevPAR (€)","v":"€88495","t":"+8.7%","d":"up"},{"l":"Ocupação (%)","v":"94.1%","t":"-0.9%","d":"down"},{"l":"Guest Satisfaction","v":"8.461","t":"+15.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.653","2026-02-14","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.376","2026-01-01","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.866","2026-01-15","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.783","2026-02-04","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","560","2026-01-12","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":503},{"label":"Mar","value":349},{"label":"Abr","value":567},{"label":"Mai","value":269},{"label":"Jun","value":253},{"label":"Jul","value":578},{"label":"Ago","value":361},{"label":"Set","value":487},{"label":"Out","value":320},{"label":"Nov","value":275},{"label":"Dez","value":516}];
const MX = 578;
