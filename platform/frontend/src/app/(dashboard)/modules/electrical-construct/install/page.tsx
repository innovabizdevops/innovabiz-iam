...
const ACCENT = "#6366f1";
const MODULE = "Electrical Construction";
const PAGE = "Install";
const KPIS = [{"l":"Total Electrical Construct","v":"1.259","t":"+10.3%","d":"up"},{"l":"Install Ativos","v":"2.931","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+11.6%","d":"up"}];
const COLS = ["ID","Install","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Electrical Construct #001","Electrical Construct #002","3.318","7.612","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Electrical Construct #002","Electrical Construct #003","7.765","3.078","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Electrical Construct #003","Electrical Construct #004","6.684","2.160","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Electrical Construct #004","Electrical Construct #005","7.792","5.582","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Electrical Construct #005","Electrical Construct #001","2.816","2.651","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":625},{"label":"Mar","value":625},{"label":"Abr","value":756},{"label":"Mai","value":802},{"label":"Jun","value":1011},{"label":"Jul","value":804},{"label":"Ago","value":762},{"label":"Set","value":881},{"label":"Out","value":919},{"label":"Nov","value":836},{"label":"Dez","value":675}];
const MX = 1011;
