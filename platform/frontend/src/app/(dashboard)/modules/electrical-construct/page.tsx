...
export default function ElectricalConstructPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Electrical Construct</h1><p className="text-sm text-muted-foreground">Electrical Construct • iBOS Enterprise</p></div>
