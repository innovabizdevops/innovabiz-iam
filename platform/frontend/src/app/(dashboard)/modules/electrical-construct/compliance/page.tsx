...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.768","t":"+9.6%","d":"up"},{"l":"NC Abertas","v":"4.292","t":"-2.6%","d":"down"},{"l":"Conformidade (%)","v":"89.3%","t":"+12.9%","d":"up"},{"l":"CAPAs Pendentes","v":"3.091","t":"+12.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.035","73.9%","4.335","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.484","92.4%","4.376","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.748","98.3%","2.987","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.614","80.8%","6.343","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","888","90.7%","5.844","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":608},{"label":"Mar","value":633},{"label":"Abr","value":661},{"label":"Mai","value":485},{"label":"Jun","value":691},{"label":"Jul","value":744},{"label":"Ago","value":555},{"label":"Set","value":816},{"label":"Out","value":841},{"label":"Nov","value":537},{"label":"Dez","value":781}];
const MX = 841;
