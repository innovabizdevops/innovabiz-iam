...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.305","t":"-1.8%","d":"down"},{"l":"Submissões/Dia","v":"3266","t":"+17.3%","d":"up"},{"l":"Documentos Gerados","v":"690","t":"-0.2%","d":"down"},{"l":"Templates","v":"1.079","t":"-4.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.642","2026-02-24","1.663","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.430","2026-02-18","1.750","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.824","2026-01-15","4.299","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.370","2026-03-23","5.796","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.816","2026-01-15","7.731","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1054},{"label":"Fev","value":706},{"label":"Mar","value":735},{"label":"Abr","value":1041},{"label":"Mai","value":938},{"label":"Jun","value":953},{"label":"Jul","value":1027},{"label":"Ago","value":1019},{"label":"Set","value":1061},{"label":"Out","value":761},{"label":"Nov","value":970},{"label":"Dez","value":861}];
const MX = 1061;
