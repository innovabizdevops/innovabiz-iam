...
const PAGE = "Cycle Counting";
const KPIS = [{"l":"Projetos Melhoria","v":"8.024","t":"+9.3%","d":"up"},{"l":"Savings (€)","v":"€50601","t":"+4.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.2%","t":"-2.8%","d":"down"},{"l":"Ciclos PDCA","v":"8.666","t":"+5.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.131","€ 8054.39","1.419","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.588","€ 31499.57","1.401","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.630","€ 10958.42","3.632","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","215","€ 23872.65","4.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.631","€ 30302.70","8.809","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":578},{"label":"Mar","value":347},{"label":"Abr","value":345},{"label":"Mai","value":559},{"label":"Jun","value":568},{"label":"Jul","value":296},{"label":"Ago","value":509},{"label":"Set","value":562},{"label":"Out","value":563},{"label":"Nov","value":552},{"label":"Dez","value":466}];
const MX = 578;
