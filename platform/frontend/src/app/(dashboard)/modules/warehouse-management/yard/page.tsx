...
const PAGE = "Yard Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.019","t":"+4.9%","d":"up"},{"l":"Savings (€)","v":"€39276","t":"+1.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.2%","t":"+16.2%","d":"up"},{"l":"Ciclos PDCA","v":"6.053","t":"+9.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.141","€ 44056.33","1.516","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.984","€ 10795.09","7.343","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.811","€ 2111.23","7.811","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.031","€ 25056.00","7.148","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.330","€ 34121.34","2.335","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":536},{"label":"Mar","value":367},{"label":"Abr","value":497},{"label":"Mai","value":444},{"label":"Jun","value":351},{"label":"Jul","value":641},{"label":"Ago","value":694},{"label":"Set","value":709},{"label":"Out","value":498},{"label":"Nov","value":402},{"label":"Dez","value":319}];
const MX = 709;
