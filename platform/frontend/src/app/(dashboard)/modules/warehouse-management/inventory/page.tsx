...
const PAGE = "Inventory Control";
const KPIS = [{"l":"Projetos Melhoria","v":"4.129","t":"+17.6%","d":"up"},{"l":"Savings (€)","v":"€73600","t":"+8.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.4%","t":"+11.0%","d":"up"},{"l":"Ciclos PDCA","v":"8.725","t":"+9.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.228","€ 14617.70","1.690","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","9.038","€ 4214.36","470","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.908","€ 33556.52","8.005","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.280","€ 37270.17","2.506","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.360","€ 45238.83","4.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":353},{"label":"Mar","value":642},{"label":"Abr","value":474},{"label":"Mai","value":688},{"label":"Jun","value":651},{"label":"Jul","value":348},{"label":"Ago","value":489},{"label":"Set","value":441},{"label":"Out","value":487},{"label":"Nov","value":522},{"label":"Dez","value":633}];
const MX = 688;
