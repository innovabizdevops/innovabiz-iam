...
const PAGE = "WMS Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.679","t":"+6.2%","d":"up"},{"l":"Queries/Dia","v":"2678","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"5.995","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"7.251","t":"-4.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","710","2026-01-06","6.052","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2060","2026-01-21","8.304","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4537","2026-02-15","7.779","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1141","2026-02-02","3.403","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4384","2026-01-02","2.830","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":705},{"label":"Mar","value":724},{"label":"Abr","value":620},{"label":"Mai","value":592},{"label":"Jun","value":984},{"label":"Jul","value":603},{"label":"Ago","value":941},{"label":"Set","value":905},{"label":"Out","value":751},{"label":"Nov","value":937},{"label":"Dez","value":655}];
const MX = 984;
