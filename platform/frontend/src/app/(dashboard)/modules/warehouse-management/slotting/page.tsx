...
const PAGE = "Slotting AI";
const KPIS = [{"l":"Projetos Melhoria","v":"6.681","t":"-0.3%","d":"down"},{"l":"Savings (€)","v":"€28879","t":"-1.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"91.8%","t":"-3.8%","d":"down"},{"l":"Ciclos PDCA","v":"3.211","t":"+14.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.157","€ 33987.63","5.768","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.173","€ 8046.22","2.767","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.346","€ 36097.77","1.462","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.341","€ 41957.97","3.941","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.211","€ 36361.86","1.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":601},{"label":"Mar","value":409},{"label":"Abr","value":426},{"label":"Mai","value":699},{"label":"Jun","value":696},{"label":"Jul","value":622},{"label":"Ago","value":426},{"label":"Set","value":456},{"label":"Out","value":425},{"label":"Nov","value":703},{"label":"Dez","value":357}];
const MX = 703;
