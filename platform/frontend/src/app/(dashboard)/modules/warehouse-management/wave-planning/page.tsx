...
const PAGE = "Wave Planning";
const KPIS = [{"l":"Projetos Melhoria","v":"5.056","t":"-0.7%","d":"down"},{"l":"Savings (€)","v":"€28534","t":"+8.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.3%","t":"+0.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.676","t":"+15.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.891","€ 40790.40","2.745","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.894","€ 9239.33","5.112","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.730","€ 39935.44","5.483","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.544","€ 45165.55","7.813","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.514","€ 35740.14","3.619","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":360},{"label":"Mar","value":528},{"label":"Abr","value":716},{"label":"Mai","value":484},{"label":"Jun","value":339},{"label":"Jul","value":527},{"label":"Ago","value":337},{"label":"Set","value":702},{"label":"Out","value":567},{"label":"Nov","value":567},{"label":"Dez","value":379}];
const MX = 716;
