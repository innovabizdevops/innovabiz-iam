...
const PAGE = "Labor Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.033","t":"-5.1%","d":"down"},{"l":"Savings (€)","v":"€29894","t":"+10.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.8%","t":"+14.7%","d":"up"},{"l":"Ciclos PDCA","v":"5.328","t":"+17.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.799","€ 908.44","409","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.644","€ 46628.84","1.479","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.075","€ 44019.74","5.316","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.382","€ 9845.54","2.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.632","€ 43108.85","4.329","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":852},{"label":"Mar","value":882},{"label":"Abr","value":813},{"label":"Mai","value":805},{"label":"Jun","value":494},{"label":"Jul","value":771},{"label":"Ago","value":507},{"label":"Set","value":602},{"label":"Out","value":877},{"label":"Nov","value":730},{"label":"Dez","value":539}];
const MX = 882;
