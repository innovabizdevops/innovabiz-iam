...
const PAGE = "Inbound &amp; Receiving";
const KPIS = [{"l":"Projetos Melhoria","v":"8.020","t":"-4.6%","d":"down"},{"l":"Savings (€)","v":"€40157","t":"+8.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.4%","t":"+7.9%","d":"up"},{"l":"Ciclos PDCA","v":"6.541","t":"-2.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.837","€ 37136.59","1.768","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.439","€ 20971.78","1.546","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","908","€ 19216.62","2.353","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.731","€ 13499.02","7.401","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.993","€ 47697.97","2.303","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":467},{"label":"Mar","value":495},{"label":"Abr","value":694},{"label":"Mai","value":441},{"label":"Jun","value":358},{"label":"Jul","value":386},{"label":"Ago","value":486},{"label":"Set","value":453},{"label":"Out","value":548},{"label":"Nov","value":742},{"label":"Dez","value":577}];
const MX = 742;
