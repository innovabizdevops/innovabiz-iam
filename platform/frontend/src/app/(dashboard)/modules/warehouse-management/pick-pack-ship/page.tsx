...
const PAGE = "Pick-Pack-Ship";
const KPIS = [{"l":"Projetos Melhoria","v":"7.145","t":"+15.3%","d":"up"},{"l":"Savings (€)","v":"€19103","t":"-3.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.6%","t":"+2.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.004","t":"+13.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.676","€ 28607.88","7.695","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.583","€ 7413.20","8.025","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.027","€ 669.71","3.722","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.367","€ 46204.18","2.697","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.123","€ 21218.57","1.322","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":801},{"label":"Mar","value":663},{"label":"Abr","value":627},{"label":"Mai","value":580},{"label":"Jun","value":423},{"label":"Jul","value":545},{"label":"Ago","value":628},{"label":"Set","value":611},{"label":"Out","value":687},{"label":"Nov","value":569},{"label":"Dez","value":669}];
const MX = 801;
...
export default function PickPackShipPage() {
    return (
