...
const KPIS = [{"l":"Projetos Melhoria","v":"8.911","t":"+6.7%","d":"up"},{"l":"Savings (€)","v":"€28060","t":"+10.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.1%","t":"+11.7%","d":"up"},{"l":"Ciclos PDCA","v":"1.431","t":"+12.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.912","€ 4326.50","6.224","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.958","€ 20652.55","1.108","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.732","€ 6660.42","4.838","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.528","€ 4122.87","2.155","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.023","€ 3830.27","7.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":488},{"label":"Mar","value":536},{"label":"Abr","value":678},{"label":"Mai","value":515},{"label":"Jun","value":535},{"label":"Jul","value":479},{"label":"Ago","value":818},{"label":"Set","value":732},{"label":"Out","value":504},{"label":"Nov","value":453},{"label":"Dez","value":753}];
const MX = 818;
