...
const PAGE = "A3 Problem Solving";
const KPIS = [{"l":"Tickets Abertos","v":"2.277","t":"+14.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.7%","t":"+15.6%","d":"up"},{"l":"MTTR (h)","v":"11h","t":"-1.2%","d":"down"},{"l":"Satisfação (%)","v":"76.8%","t":"-5.8%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.767","5.797","2.584","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.421","1.466","5.439","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.178","7.884","1.566","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.323","6.190","7.457","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.989","6.174","6.005","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":631},{"label":"Mar","value":609},{"label":"Abr","value":625},{"label":"Mai","value":670},{"label":"Jun","value":774},{"label":"Jul","value":626},{"label":"Ago","value":441},{"label":"Set","value":543},{"label":"Out","value":460},{"label":"Nov","value":661},{"label":"Dez","value":734}];
const MX = 774;
