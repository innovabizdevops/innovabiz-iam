...
const KPIS = [{"l":"Projetos Melhoria","v":"6.998","t":"-4.2%","d":"down"},{"l":"Savings (€)","v":"€74213","t":"+12.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.2%","t":"+17.8%","d":"up"},{"l":"Ciclos PDCA","v":"6.472","t":"+15.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.161","€ 8900.55","3.883","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.529","€ 49692.75","7.378","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.416","€ 19519.29","8.477","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","420","€ 31964.57","2.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.063","€ 6636.45","7.349","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":650},{"label":"Mar","value":482},{"label":"Abr","value":583},{"label":"Mai","value":466},{"label":"Jun","value":725},{"label":"Jul","value":825},{"label":"Ago","value":448},{"label":"Set","value":775},{"label":"Out","value":610},{"label":"Nov","value":769},{"label":"Dez","value":726}];
const MX = 825;
