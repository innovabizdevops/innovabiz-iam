...
const PAGE = "Baldrige Framework";
const KPIS = [{"l":"Projetos Melhoria","v":"8.499","t":"-5.1%","d":"down"},{"l":"Savings (€)","v":"€41999","t":"+6.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.2%","t":"+3.7%","d":"up"},{"l":"Ciclos PDCA","v":"8.289","t":"-1.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","9.004","€ 2839.27","6.891","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.168","€ 8482.01","794","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.032","€ 28380.13","997","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.497","€ 8902.83","7.822","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.221","€ 27801.99","685","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":949},{"label":"Mar","value":881},{"label":"Abr","value":701},{"label":"Mai","value":733},{"label":"Jun","value":872},{"label":"Jul","value":882},{"label":"Ago","value":758},{"label":"Set","value":1082},{"label":"Out","value":748},{"label":"Nov","value":956},{"label":"Dez","value":1012}];
const MX = 1082;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#14b8a6'}}>Baldrige</span></h1>
                </div>
