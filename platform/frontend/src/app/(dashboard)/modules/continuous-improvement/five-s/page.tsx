...
const PAGE = "5S Workplace";
const KPIS = [{"l":"Projetos Melhoria","v":"4.048","t":"+11.2%","d":"up"},{"l":"Savings (€)","v":"€10203","t":"+4.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.5%","t":"+7.2%","d":"up"},{"l":"Ciclos PDCA","v":"1.474","t":"+12.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.816","€ 36227.98","6.543","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.451","€ 25345.09","8.261","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.612","€ 3317.34","6.129","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.862","€ 36106.06","1.115","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.992","€ 10857.00","6.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":422},{"label":"Mar","value":496},{"label":"Abr","value":494},{"label":"Mai","value":673},{"label":"Jun","value":699},{"label":"Jul","value":573},{"label":"Ago","value":766},{"label":"Set","value":521},{"label":"Out","value":522},{"label":"Nov","value":481},{"label":"Dez","value":587}];
const MX = 766;
