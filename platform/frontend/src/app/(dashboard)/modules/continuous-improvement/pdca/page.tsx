...
const PAGE = "PDCA Cycle Tracker";
const KPIS = [{"l":"Projetos Melhoria","v":"3.631","t":"+1.9%","d":"up"},{"l":"Savings (€)","v":"€2062","t":"+9.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.5%","t":"+13.3%","d":"up"},{"l":"Ciclos PDCA","v":"9.007","t":"+4.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.088","€ 45453.75","3.712","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.749","€ 27889.99","2.781","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.676","€ 27861.03","1.254","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.784","€ 3173.36","8.769","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","527","€ 33713.76","2.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":749},{"label":"Mar","value":960},{"label":"Abr","value":875},{"label":"Mai","value":959},{"label":"Jun","value":789},{"label":"Jul","value":876},{"label":"Ago","value":940},{"label":"Set","value":620},{"label":"Out","value":706},{"label":"Nov","value":615},{"label":"Dez","value":695}];
const MX = 960;
