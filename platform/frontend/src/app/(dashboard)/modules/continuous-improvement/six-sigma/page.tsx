...
const KPIS = [{"l":"Projetos Melhoria","v":"3.557","t":"+2.0%","d":"up"},{"l":"Savings (€)","v":"€9866","t":"+9.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.5%","t":"+10.7%","d":"up"},{"l":"Ciclos PDCA","v":"8.234","t":"+13.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.156","€ 1859.83","6.862","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.357","€ 8882.91","559","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.511","€ 16556.14","6.076","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","156","€ 26193.19","4.399","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.081","€ 9641.70","3.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":777},{"label":"Mar","value":723},{"label":"Abr","value":459},{"label":"Mai","value":504},{"label":"Jun","value":802},{"label":"Jul","value":718},{"label":"Ago","value":719},{"label":"Set","value":779},{"label":"Out","value":465},{"label":"Nov","value":640},{"label":"Dez","value":750}];
const MX = 802;
