...
const PAGE = "Value Stream Mapping";
const KPIS = [{"l":"Projetos Melhoria","v":"7.171","t":"+5.6%","d":"up"},{"l":"Savings (€)","v":"€99357","t":"+1.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.2%","t":"-3.8%","d":"down"},{"l":"Ciclos PDCA","v":"1.315","t":"+0.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","964","€ 22276.59","7.938","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.451","€ 24413.65","286","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.037","€ 5787.38","2.655","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.702","€ 35485.85","1.320","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","438","€ 30914.26","5.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":355},{"label":"Mar","value":546},{"label":"Abr","value":454},{"label":"Mai","value":542},{"label":"Jun","value":316},{"label":"Jul","value":297},{"label":"Ago","value":455},{"label":"Set","value":663},{"label":"Out","value":492},{"label":"Nov","value":537},{"label":"Dez","value":313}];
const MX = 663;
