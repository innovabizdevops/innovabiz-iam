...
const PAGE = "Gemba Walks";
const KPIS = [{"l":"Projetos Melhoria","v":"7.193","t":"+7.0%","d":"up"},{"l":"Savings (€)","v":"€52603","t":"-5.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"82.2%","t":"-3.5%","d":"down"},{"l":"Ciclos PDCA","v":"4.724","t":"+3.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.733","€ 37802.57","3.471","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","498","€ 16837.50","8.451","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.934","€ 12432.77","6.278","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.475","€ 28537.37","8.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.717","€ 40123.65","124","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":773},{"label":"Mar","value":659},{"label":"Abr","value":789},{"label":"Mai","value":902},{"label":"Jun","value":789},{"label":"Jul","value":564},{"label":"Ago","value":792},{"label":"Set","value":901},{"label":"Out","value":934},{"label":"Nov","value":935},{"label":"Dez","value":626}];
const MX = 935;
