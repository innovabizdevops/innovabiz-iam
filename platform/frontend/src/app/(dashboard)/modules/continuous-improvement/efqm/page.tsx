...
const ACCENT = "#14b8a6";
const MODULE = "Continuous Improvement";
const PAGE = "EFQM Model";
const KPIS = [{"l":"Projetos Melhoria","v":"4.203","t":"+5.1%","d":"up"},{"l":"Savings (€)","v":"€40956","t":"+4.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.5%","t":"+1.3%","d":"up"},{"l":"Ciclos PDCA","v":"6.549","t":"+7.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.839","€ 38342.50","643","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.428","€ 41602.16","5.561","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.825","€ 46366.50","1.200","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.576","€ 45213.93","3.616","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.030","€ 49602.88","2.161","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":701},{"label":"Mar","value":608},{"label":"Abr","value":722},{"label":"Mai","value":734},{"label":"Jun","value":627},{"label":"Jul","value":632},{"label":"Ago","value":406},{"label":"Set","value":732},{"label":"Out","value":782},{"label":"Nov","value":490},{"label":"Dez","value":512}];
const MX = 782;
...
export default function EfqmPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#14b8a6'}}>EFQM</span></h1>
                </div>
