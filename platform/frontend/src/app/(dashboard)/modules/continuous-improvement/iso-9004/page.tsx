...
const PAGE = "ISO 9004 Sustained Success";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.163","t":"+9.0%","d":"up"},{"l":"NC Abertas","v":"4.539","t":"+7.0%","d":"up"},{"l":"Conformidade (%)","v":"67.4%","t":"+2.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.139","t":"+17.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.674","77.4%","8.686","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.507","85.0%","8.295","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.933","80.1%","2.409","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.377","92.7%","7.056","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.624","87.9%","1.944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":644},{"label":"Mar","value":768},{"label":"Abr","value":774},{"label":"Mai","value":423},{"label":"Jun","value":584},{"label":"Jul","value":691},{"label":"Ago","value":668},{"label":"Set","value":758},{"label":"Out","value":767},{"label":"Nov","value":660},{"label":"Dez","value":781}];
const MX = 781;
...
export default function Iso9004Page() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#14b8a6'}}>ISO</span></h1>
                </div>
