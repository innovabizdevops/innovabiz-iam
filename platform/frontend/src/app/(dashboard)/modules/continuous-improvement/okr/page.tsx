...
const PAGE = "OKR Tracker";
const KPIS = [{"l":"Projetos Melhoria","v":"6.807","t":"-2.7%","d":"down"},{"l":"Savings (€)","v":"€21859","t":"+14.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.2%","t":"-3.3%","d":"down"},{"l":"Ciclos PDCA","v":"5.765","t":"+2.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.867","€ 45761.71","8.811","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.090","€ 19022.68","8.805","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.372","€ 44569.65","2.611","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.108","€ 33643.99","6.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.814","€ 34569.33","3.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":743},{"label":"Mar","value":728},{"label":"Abr","value":706},{"label":"Mai","value":655},{"label":"Jun","value":593},{"label":"Jul","value":557},{"label":"Ago","value":745},{"label":"Set","value":773},{"label":"Out","value":852},{"label":"Nov","value":655},{"label":"Dez","value":783}];
const MX = 943;
