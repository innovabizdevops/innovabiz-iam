...
const PAGE = "Lean Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.015","t":"-3.7%","d":"down"},{"l":"Savings (€)","v":"€81201","t":"-4.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.3%","t":"+10.5%","d":"up"},{"l":"Ciclos PDCA","v":"5.894","t":"+0.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.410","€ 32430.80","2.028","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.136","€ 39303.65","5.641","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","9.032","€ 4565.61","8.309","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.099","€ 30790.47","4.115","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.537","€ 36901.29","6.947","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":633},{"label":"Mar","value":687},{"label":"Abr","value":510},{"label":"Mai","value":763},{"label":"Jun","value":551},{"label":"Jul","value":884},{"label":"Ago","value":846},{"label":"Set","value":693},{"label":"Out","value":686},{"label":"Nov","value":761},{"label":"Dez","value":556}];
const MX = 884;
