...
const ACCENT = "#0e7490";
const MODULE = "Internal Mobility Platform";
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"6.657","t":"+15.2%","d":"up"},{"l":"Treinos/Semana","v":"4566","t":"+0.1%","d":"up"},{"l":"Competições","v":"2.616","t":"+17.8%","d":"up"},{"l":"Performance Score","v":"79","t":"-3.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.277","6.941","7.248","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.248","4.906","1.419","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.720","4.551","334","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.864","6.524","3.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.158","5.898","7.110","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":532},{"label":"Mar","value":455},{"label":"Abr","value":773},{"label":"Mai","value":509},{"label":"Jun","value":456},{"label":"Jul","value":617},{"label":"Ago","value":456},{"label":"Set","value":832},{"label":"Out","value":702},{"label":"Nov","value":511},{"label":"Dez","value":594}];
const MX = 832;
