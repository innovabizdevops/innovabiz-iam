...
/* ═══ Internal Mobility Platform — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "9394", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4198", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€117K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "558042594", cells: ["INT-7594", "Internal Mobility Platform Item 1", "19/7/2026", "€42 694"], status: "active" as const },
    { id: "558046165", cells: ["INT-2165", "Internal Mobility Platform Item 2", "6/2/2026", "€46 265"], status: "pending" as const },
    { id: "558049736", cells: ["INT-5736", "Internal Mobility Platform Item 3", "21/9/2026", "€49 836"], status: "completed" as const },
    { id: "558053307", cells: ["INT-9307", "Internal Mobility Platform Item 4", "8/4/2026", "€3407"], status: "warning" as const },
    { id: "558056878", cells: ["INT-3878", "Internal Mobility Platform Item 5", "23/11/2026", "€6978"], status: "active" as const },
];
...
export default function InternalMobilityPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Internal Mobility Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Internal Mobility Platform</p>
                    </div>
                </div>
