...
const PAGE = "Repair";
const KPIS = [{"l":"Atletas Registados","v":"6.447","t":"+8.3%","d":"up"},{"l":"Treinos/Semana","v":"940","t":"+6.7%","d":"up"},{"l":"Competições","v":"1.090","t":"+8.8%","d":"up"},{"l":"Performance Score","v":"65","t":"-4.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.973","495","2.080","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.977","4.944","4.010","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.917","1.057","3.766","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.998","5.470","6.848","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.601","6.532","187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":747},{"label":"Mar","value":502},{"label":"Abr","value":480},{"label":"Mai","value":702},{"label":"Jun","value":746},{"label":"Jul","value":707},{"label":"Ago","value":411},{"label":"Set","value":722},{"label":"Out","value":698},{"label":"Nov","value":679},{"label":"Dez","value":807}];
const MX = 807;
