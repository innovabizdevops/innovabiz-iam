...
const ACCENT = "#059669";
const MODULE = "Digital Product Passport";
const PAGE = "End Life";
const KPIS = [{"l":"Atletas Registados","v":"7.900","t":"-1.4%","d":"down"},{"l":"Treinos/Semana","v":"5024","t":"+15.5%","d":"up"},{"l":"Competições","v":"3.436","t":"-4.9%","d":"down"},{"l":"Performance Score","v":"95","t":"-5.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.706","8.105","7.531","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.019","3.459","6.070","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.554","4.329","2.194","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.014","6.945","6.095","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.901","4.945","496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":616},{"label":"Mar","value":694},{"label":"Abr","value":439},{"label":"Mai","value":732},{"label":"Jun","value":741},{"label":"Jul","value":401},{"label":"Ago","value":413},{"label":"Set","value":366},{"label":"Out","value":500},{"label":"Nov","value":593},{"label":"Dez","value":684}];
const MX = 741;
...
export default function EndlifePage() {
    return (
