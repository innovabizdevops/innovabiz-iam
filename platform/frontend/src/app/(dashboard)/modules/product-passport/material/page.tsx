...
const PAGE = "Material";
const KPIS = [{"l":"Atletas Registados","v":"5.423","t":"+14.2%","d":"up"},{"l":"Treinos/Semana","v":"2507","t":"+6.3%","d":"up"},{"l":"Competições","v":"1.753","t":"+17.5%","d":"up"},{"l":"Performance Score","v":"69","t":"+3.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.873","5.206","8.442","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.419","1.883","6.502","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.382","1.275","7.441","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.291","8.456","2.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.310","6.071","198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":467},{"label":"Mar","value":364},{"label":"Abr","value":363},{"label":"Mai","value":347},{"label":"Jun","value":504},{"label":"Jul","value":476},{"label":"Ago","value":666},{"label":"Set","value":348},{"label":"Out","value":540},{"label":"Nov","value":335},{"label":"Dez","value":505}];
const MX = 666;
