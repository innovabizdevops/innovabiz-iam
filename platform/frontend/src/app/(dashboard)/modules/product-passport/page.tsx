...
const KPIS = [
    { label: "Total Registos", value: "3405", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3441", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€383K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "269283305", cells: ["PRO-4305", "Digital Product Passport Item 1", "26/6/2026", "€33 405"], status: "active" as const },
    { id: "269286876", cells: ["PRO-7876", "Digital Product Passport Item 2", "13/1/2026", "€36 976"], status: "pending" as const },
    { id: "269290447", cells: ["PRO-2447", "Digital Product Passport Item 3", "28/8/2026", "€40 547"], status: "completed" as const },
    { id: "269294018", cells: ["PRO-6018", "Digital Product Passport Item 4", "15/3/2026", "€44 118"], status: "warning" as const },
    { id: "269297589", cells: ["PRO-9589", "Digital Product Passport Item 5", "2/10/2026", "€47 689"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Product Passport</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Product Passport</p>
                    </div>
                </div>
