...
const PAGE = "Create";
const KPIS = [{"l":"Atletas Registados","v":"7.781","t":"+16.5%","d":"up"},{"l":"Treinos/Semana","v":"1351","t":"+10.9%","d":"up"},{"l":"Competições","v":"7.677","t":"+2.8%","d":"up"},{"l":"Performance Score","v":"73","t":"+7.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","662","8.251","3.182","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.785","787","5.990","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.980","2.604","405","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.842","7.271","2.458","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.822","974","7.974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":702},{"label":"Mar","value":733},{"label":"Abr","value":660},{"label":"Mai","value":687},{"label":"Jun","value":691},{"label":"Jul","value":509},{"label":"Ago","value":845},{"label":"Set","value":856},{"label":"Out","value":838},{"label":"Nov","value":753},{"label":"Dez","value":485}];
const MX = 856;
