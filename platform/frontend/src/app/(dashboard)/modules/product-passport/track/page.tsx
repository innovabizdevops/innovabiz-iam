...
const PAGE = "Track";
const KPIS = [{"l":"Atletas Registados","v":"7.695","t":"-1.5%","d":"down"},{"l":"Treinos/Semana","v":"1574","t":"+14.7%","d":"up"},{"l":"Competições","v":"3.194","t":"+14.7%","d":"up"},{"l":"Performance Score","v":"61","t":"+10.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.146","5.212","6.117","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.194","4.558","7.827","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","9.036","7.008","8.670","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.741","3.283","7.588","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.510","7.953","7.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":873},{"label":"Mar","value":857},{"label":"Abr","value":820},{"label":"Mai","value":851},{"label":"Jun","value":618},{"label":"Jul","value":844},{"label":"Ago","value":706},{"label":"Set","value":749},{"label":"Out","value":924},{"label":"Nov","value":693},{"label":"Dez","value":644}];
const MX = 924;
