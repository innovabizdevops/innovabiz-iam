...
const PAGE = "Budget Track";
const KPIS = [{"l":"Total Grant Tracking","v":"7.267","t":"+6.1%","d":"up"},{"l":"Budget Track Ativos","v":"€36423","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+7.4%","d":"up"}];
const COLS = ["ID","Budget Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Tracking #001","€ 44320.93","5.378","1.578","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Tracking #002","€ 8636.03","4.617","7.705","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Tracking #003","€ 7593.74","1.812","7.855","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Tracking #004","€ 25265.49","3.053","7.981","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Tracking #005","€ 28744.03","5.184","1.070","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":305},{"label":"Fev","value":568},{"label":"Mar","value":566},{"label":"Abr","value":336},{"label":"Mai","value":525},{"label":"Jun","value":377},{"label":"Jul","value":365},{"label":"Ago","value":655},{"label":"Set","value":662},{"label":"Out","value":479},{"label":"Nov","value":624},{"label":"Dez","value":424}];
const MX = 662;
