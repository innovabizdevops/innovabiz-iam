...
/* ═══ Grief Counseling — Dashboard ═══ */

const ACCENT = "#0f172a";

const KPIS = [
    { label: "Total Registos", value: "6502", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3753", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€181K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1810330302", cells: ["GRI-8302", "Grief Counseling Item 1", "19/7/2026", "€30 402"], status: "active" as const },
    { id: "1810333873", cells: ["GRI-2873", "Grief Counseling Item 2", "6/2/2026", "€33 973"], status: "pending" as const },
    { id: "1810337444", cells: ["GRI-6444", "Grief Counseling Item 3", "21/9/2026", "€37 544"], status: "completed" as const },
    { id: "1810341015", cells: ["GRI-1015", "Grief Counseling Item 4", "8/4/2026", "€41 115"], status: "warning" as const },
    { id: "1810344586", cells: ["GRI-4586", "Grief Counseling Item 5", "23/11/2026", "€44 686"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grief Counseling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Grief Counseling</p>
                    </div>
                </div>
