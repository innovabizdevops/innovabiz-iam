...
const ACCENT = "#6366f1";
const MODULE = "CDMO Operations";
const PAGE = "Tech Transfer";
const KPIS = [{"l":"Total Cdmo Ops","v":"1.679","t":"+16.1%","d":"up"},{"l":"Tech Transfer Ativos","v":"3.873","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"75","t":"+0.6%","d":"up"}];
const COLS = ["ID","Tech Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdmo Ops #001","Cdmo Ops #002","1.409","1.392","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cdmo Ops #002","Cdmo Ops #003","8.541","560","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdmo Ops #003","Cdmo Ops #004","1.183","241","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cdmo Ops #004","Cdmo Ops #005","679","6.434","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdmo Ops #005","Cdmo Ops #001","4.533","2.890","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":816},{"label":"Mar","value":743},{"label":"Abr","value":536},{"label":"Mai","value":846},{"label":"Jun","value":810},{"label":"Jul","value":814},{"label":"Ago","value":781},{"label":"Set","value":786},{"label":"Out","value":686},{"label":"Nov","value":733},{"label":"Dez","value":761}];
const MX = 846;
