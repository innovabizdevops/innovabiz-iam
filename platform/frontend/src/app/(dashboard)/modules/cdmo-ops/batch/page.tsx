...
const PAGE = "Batch";
const KPIS = [{"l":"Total Cdmo Ops","v":"3.407","t":"-0.6%","d":"down"},{"l":"Batch Ativos","v":"8.828","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"70","t":"+13.1%","d":"up"}];
const COLS = ["ID","Batch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdmo Ops #001","Cdmo Ops #002","6.095","2.929","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Cdmo Ops #002","Cdmo Ops #003","7.068","5.565","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdmo Ops #003","Cdmo Ops #004","8.857","4.241","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Cdmo Ops #004","Cdmo Ops #005","6.192","7.172","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdmo Ops #005","Cdmo Ops #001","1.254","8.281","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":816},{"label":"Mar","value":886},{"label":"Abr","value":533},{"label":"Mai","value":650},{"label":"Jun","value":581},{"label":"Jul","value":565},{"label":"Ago","value":750},{"label":"Set","value":544},{"label":"Out","value":706},{"label":"Nov","value":858},{"label":"Dez","value":858}];
const MX = 886;
