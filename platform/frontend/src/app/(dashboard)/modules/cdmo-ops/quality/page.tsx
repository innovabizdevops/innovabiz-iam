...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.896","t":"+1.0%","d":"up"},{"l":"NC Abertas","v":"2.922","t":"+0.3%","d":"up"},{"l":"Conformidade (%)","v":"82.4%","t":"+0.7%","d":"up"},{"l":"CAPAs Pendentes","v":"6.124","t":"-5.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.524","97.5%","2.227","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.930","76.5%","3.902","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.682","70.5%","5.296","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.489","79.3%","5.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.144","98.2%","1.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":469},{"label":"Mar","value":659},{"label":"Abr","value":662},{"label":"Mai","value":331},{"label":"Jun","value":478},{"label":"Jul","value":378},{"label":"Ago","value":617},{"label":"Set","value":573},{"label":"Out","value":663},{"label":"Nov","value":324},{"label":"Dez","value":423}];
const MX = 663;
