...
export default function CdmoOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cdmo Ops</h1><p className="text-sm text-muted-foreground">Cdmo Ops • iBOS Enterprise</p></div>
