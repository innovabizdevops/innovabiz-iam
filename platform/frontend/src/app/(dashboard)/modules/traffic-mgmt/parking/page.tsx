...
const PAGE = "Parking Guide";
const KPIS = [{"l":"Artigos Publicados","v":"6.313","t":"+17.1%","d":"up"},{"l":"Views/Semana","v":"1640","t":"+4.8%","d":"up"},{"l":"Feedback Útil (%)","v":"71.6%","t":"+4.7%","d":"up"},{"l":"Artigos Desatualizados","v":"8.412","t":"+17.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","6.489","73.4%","4.811","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","5.553","80.3%","5.428","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","5.900","72.9%","1.591","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.456","93.5%","6.512","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","4.737","98.2%","110","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":907},{"label":"Mar","value":1036},{"label":"Abr","value":923},{"label":"Mai","value":800},{"label":"Jun","value":804},{"label":"Jul","value":766},{"label":"Ago","value":948},{"label":"Set","value":1080},{"label":"Out","value":935},{"label":"Nov","value":803},{"label":"Dez","value":855}];
const MX = 1080;
