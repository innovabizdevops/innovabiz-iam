...
const PAGE = "V2X Comms";
const KPIS = [{"l":"Total Traffic Mgmt","v":"4.493","t":"-2.8%","d":"down"},{"l":"V2X Comms Ativos","v":"5.053","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"89.1%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"84","t":"+13.5%","d":"up"}];
const COLS = ["ID","V2X Comms","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Traffic Mgmt #001","Traffic Mgmt #002","3.591","7.934","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Traffic Mgmt #002","Traffic Mgmt #003","195","9.014","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Traffic Mgmt #003","Traffic Mgmt #004","4.118","1.807","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Traffic Mgmt #004","Traffic Mgmt #005","3.697","3.493","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Traffic Mgmt #005","Traffic Mgmt #001","1.385","6.541","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":927},{"label":"Mar","value":734},{"label":"Abr","value":691},{"label":"Mai","value":921},{"label":"Jun","value":738},{"label":"Jul","value":963},{"label":"Ago","value":683},{"label":"Set","value":628},{"label":"Out","value":964},{"label":"Nov","value":917},{"label":"Dez","value":934}];
const MX = 964;
