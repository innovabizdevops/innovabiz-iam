...
const KPIS = [{"l":"Tickets Abertos","v":"1.223","t":"-3.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"82.4%","t":"+9.7%","d":"up"},{"l":"MTTR (h)","v":"86h","t":"+13.8%","d":"up"},{"l":"Satisfação (%)","v":"74.1%","t":"+14.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.139","6.354","3.709","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.429","7.751","8.012","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.648","3.319","1.334","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.342","5.716","294","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.714","5.069","8.880","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":885},{"label":"Mar","value":758},{"label":"Abr","value":766},{"label":"Mai","value":963},{"label":"Jun","value":987},{"label":"Jul","value":999},{"label":"Ago","value":833},{"label":"Set","value":1001},{"label":"Out","value":823},{"label":"Nov","value":853},{"label":"Dez","value":934}];
const MX = 1001;
