...
const PAGE = "Flow Optimize";
const KPIS = [{"l":"Total Traffic Mgmt","v":"4.516","t":"+15.5%","d":"up"},{"l":"Flow Optimize Ativos","v":"1.169","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"88","t":"-5.3%","d":"down"}];
const COLS = ["ID","Flow Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Traffic Mgmt #001","Traffic Mgmt #002","3.203","4.800","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Traffic Mgmt #002","Traffic Mgmt #003","1.931","6.798","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Traffic Mgmt #003","Traffic Mgmt #004","3.894","1.495","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Traffic Mgmt #004","Traffic Mgmt #005","5.034","2.718","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Traffic Mgmt #005","Traffic Mgmt #001","2.205","2.931","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":504},{"label":"Mar","value":728},{"label":"Abr","value":882},{"label":"Mai","value":658},{"label":"Jun","value":569},{"label":"Jul","value":758},{"label":"Ago","value":706},{"label":"Set","value":820},{"label":"Out","value":715},{"label":"Nov","value":887},{"label":"Dez","value":834}];
const MX = 887;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#3c5a7f'}}>AI</span></h1>
                </div>
