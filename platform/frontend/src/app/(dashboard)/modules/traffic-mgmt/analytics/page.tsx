...
const KPIS = [{"l":"Dashboards Ativos","v":"8.024","t":"+5.5%","d":"up"},{"l":"Queries/Dia","v":"657","t":"-2.3%","d":"down"},{"l":"Dados Processados (GB)","v":"8.454","t":"+16.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.130","t":"-1.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2646","2026-01-28","8.577","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2154","2026-01-10","8.976","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3634","2026-02-05","5.848","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4779","2026-03-22","7.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4723","2026-02-14","5.520","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":365},{"label":"Mar","value":237},{"label":"Abr","value":315},{"label":"Mai","value":609},{"label":"Jun","value":404},{"label":"Jul","value":525},{"label":"Ago","value":421},{"label":"Set","value":350},{"label":"Out","value":397},{"label":"Nov","value":306},{"label":"Dez","value":532}];
const MX = 609;
