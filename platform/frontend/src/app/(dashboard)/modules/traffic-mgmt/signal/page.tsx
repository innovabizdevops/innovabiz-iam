...
const ACCENT = "#3c5a7f";
const MODULE = "Traffic Management";
const PAGE = "Signal Control";
const KPIS = [{"l":"Total Traffic Mgmt","v":"802","t":"+1.3%","d":"up"},{"l":"Signal Control Ativos","v":"9.064","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"81.2%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"90","t":"+14.8%","d":"up"}];
const COLS = ["ID","Signal Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Traffic Mgmt #001","Traffic Mgmt #002","3.415","9.054","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Traffic Mgmt #002","Traffic Mgmt #003","8.347","4.612","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Traffic Mgmt #003","Traffic Mgmt #004","2.719","2.346","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Traffic Mgmt #004","Traffic Mgmt #005","4.224","4.362","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Traffic Mgmt #005","Traffic Mgmt #001","1.931","4.653","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":440},{"label":"Mar","value":721},{"label":"Abr","value":681},{"label":"Mai","value":600},{"label":"Jun","value":544},{"label":"Jul","value":741},{"label":"Ago","value":413},{"label":"Set","value":556},{"label":"Out","value":535},{"label":"Nov","value":621},{"label":"Dez","value":666}];
const MX = 741;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#3c5a7f'}}>IoT</span></h1>
                </div>
