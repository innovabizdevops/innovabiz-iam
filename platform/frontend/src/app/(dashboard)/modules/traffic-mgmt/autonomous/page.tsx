...
const PAGE = "Autonomous Zone";
const KPIS = [{"l":"Total Traffic Mgmt","v":"8.832","t":"+10.0%","d":"up"},{"l":"Autonomous Zone Ativos","v":"5.929","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"87","t":"+14.4%","d":"up"}];
const COLS = ["ID","Autonomous Zone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Traffic Mgmt #001","Traffic Mgmt #002","8.705","4.939","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Traffic Mgmt #002","Traffic Mgmt #003","5.413","4.480","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Traffic Mgmt #003","Traffic Mgmt #004","186","5.893","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Traffic Mgmt #004","Traffic Mgmt #005","8.174","6.596","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Traffic Mgmt #005","Traffic Mgmt #001","8.056","3.545","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":616},{"label":"Mar","value":540},{"label":"Abr","value":624},{"label":"Mai","value":718},{"label":"Jun","value":672},{"label":"Jul","value":644},{"label":"Ago","value":746},{"label":"Set","value":456},{"label":"Out","value":380},{"label":"Nov","value":491},{"label":"Dez","value":500}];
const MX = 746;
