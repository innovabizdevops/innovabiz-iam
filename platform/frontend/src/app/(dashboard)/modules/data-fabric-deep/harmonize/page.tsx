...
const ACCENT = "#1e3a5f";
const MODULE = "Data Fabric Deep";
const PAGE = "Harmonize";
const KPIS = [{"l":"Dashboards Ativos","v":"1.106","t":"+11.1%","d":"up"},{"l":"Queries/Dia","v":"2448","t":"+12.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.844","t":"+10.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.818","t":"-1.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2340","2026-01-28","3.074","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5061","2026-03-20","2.648","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1998","2026-02-03","4.917","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1434","2026-03-26","185","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","384","2026-03-27","8.746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":639},{"label":"Mar","value":822},{"label":"Abr","value":600},{"label":"Mai","value":780},{"label":"Jun","value":532},{"label":"Jul","value":706},{"label":"Ago","value":827},{"label":"Set","value":528},{"label":"Out","value":705},{"label":"Nov","value":691},{"label":"Dez","value":632}];
const MX = 845;
