...
const KPIS = [{"l":"Dashboards Ativos","v":"8.572","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"253","t":"+16.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.582","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"402","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2474","2026-02-15","572","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","993","2026-02-01","8.124","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3789","2026-03-23","304","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3929","2026-02-25","8.439","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","407","2026-02-18","479","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":320},{"label":"Mar","value":407},{"label":"Abr","value":366},{"label":"Mai","value":344},{"label":"Jun","value":261},{"label":"Jul","value":273},{"label":"Ago","value":459},{"label":"Set","value":537},{"label":"Out","value":605},{"label":"Nov","value":445},{"label":"Dez","value":578}];
const MX = 605;
