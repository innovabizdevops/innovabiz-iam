...
const PAGE = "Serve";
const KPIS = [{"l":"Dashboards Ativos","v":"5.621","t":"+5.2%","d":"up"},{"l":"Queries/Dia","v":"4514","t":"+13.7%","d":"up"},{"l":"Dados Processados (GB)","v":"2.454","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.560","t":"+12.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4072","2026-01-11","4.801","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2905","2026-01-11","5.940","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4532","2026-02-10","3.497","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3203","2026-03-24","149","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3089","2026-01-28","4.111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":490},{"label":"Mar","value":471},{"label":"Abr","value":576},{"label":"Mai","value":440},{"label":"Jun","value":366},{"label":"Jul","value":305},{"label":"Ago","value":603},{"label":"Set","value":638},{"label":"Out","value":644},{"label":"Nov","value":273},{"label":"Dez","value":415}];
const MX = 644;
