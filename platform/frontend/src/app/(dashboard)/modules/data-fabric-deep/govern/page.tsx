...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"6.859","t":"-2.4%","d":"down"},{"l":"Queries/Dia","v":"4185","t":"-2.1%","d":"down"},{"l":"Dados Processados (GB)","v":"6.819","t":"+10.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.771","t":"-0.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4118","2026-01-17","2.228","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2201","2026-02-04","4.604","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4917","2026-02-19","3.859","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4774","2026-02-19","1.783","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3516","2026-01-08","3.276","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1075},{"label":"Fev","value":1080},{"label":"Mar","value":1018},{"label":"Abr","value":963},{"label":"Mai","value":770},{"label":"Jun","value":1038},{"label":"Jul","value":820},{"label":"Ago","value":1006},{"label":"Set","value":767},{"label":"Out","value":1057},{"label":"Nov","value":786},{"label":"Dez","value":768}];
const MX = 1080;
