...
/* ═══ Data Fabric Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "2512", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2156", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€107K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1750292712", cells: ["DAT-9712", "Data Fabric Deep Item 1", "1/1/2026", "€42 812"], status: "active" as const },
    { id: "1750296283", cells: ["DAT-4283", "Data Fabric Deep Item 2", "16/8/2026", "€46 383"], status: "pending" as const },
    { id: "1750299854", cells: ["DAT-7854", "Data Fabric Deep Item 3", "3/3/2026", "€49 954"], status: "completed" as const },
    { id: "1750303425", cells: ["DAT-2425", "Data Fabric Deep Item 4", "18/10/2026", "€3525"], status: "warning" as const },
    { id: "1750306996", cells: ["DAT-5996", "Data Fabric Deep Item 5", "5/5/2026", "€7096"], status: "active" as const },
];
...
export default function DataFabricDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Fabric Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Fabric Deep</p>
                    </div>
                </div>
