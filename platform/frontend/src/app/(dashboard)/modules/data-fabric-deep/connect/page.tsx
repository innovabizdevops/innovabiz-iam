...
const PAGE = "Connect";
const KPIS = [{"l":"Dashboards Ativos","v":"1.581","t":"+3.5%","d":"up"},{"l":"Queries/Dia","v":"1531","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.935","t":"+17.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.542","t":"-2.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3894","2026-02-01","4.546","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3546","2026-02-03","7.253","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4180","2026-03-20","1.242","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1422","2026-02-06","8.291","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1618","2026-02-22","6.502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":657},{"label":"Mar","value":512},{"label":"Abr","value":521},{"label":"Mai","value":873},{"label":"Jun","value":780},{"label":"Jul","value":854},{"label":"Ago","value":695},{"label":"Set","value":801},{"label":"Out","value":668},{"label":"Nov","value":783},{"label":"Dez","value":744}];
const MX = 873;
