...
const ACCENT = "#0070f3";
const MODULE = "Travel & Expense (Concur)";
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"496","t":"-0.3%","d":"down"},{"l":"NC Abertas","v":"2.679","t":"+8.2%","d":"up"},{"l":"Conformidade (%)","v":"89.4%","t":"+8.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.567","t":"-3.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.376","75.1%","1.027","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.867","97.3%","7.312","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.937","71.6%","6.797","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.520","74.9%","736","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.133","76.2%","1.209","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":435},{"label":"Mar","value":378},{"label":"Abr","value":366},{"label":"Mai","value":346},{"label":"Jun","value":429},{"label":"Jul","value":640},{"label":"Ago","value":417},{"label":"Set","value":408},{"label":"Out","value":467},{"label":"Nov","value":488},{"label":"Dez","value":523}];
const MX = 640;
