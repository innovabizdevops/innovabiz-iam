...
/* ═══ Travel & Expense (Concur) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "4052", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2793", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€414K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2061421552", cells: ["CON-8552", "Travel & Expense (Concur) Item 1", "9/5/2026", "€21 652"], status: "active" as const },
    { id: "2061425123", cells: ["CON-3123", "Travel & Expense (Concur) Item 2", "24/12/2026", "€25 223"], status: "pending" as const },
    { id: "2061428694", cells: ["CON-6694", "Travel & Expense (Concur) Item 3", "11/7/2026", "€28 794"], status: "completed" as const },
    { id: "2061432265", cells: ["CON-1265", "Travel & Expense (Concur) Item 4", "26/2/2026", "€32 365"], status: "warning" as const },
    { id: "2061435836", cells: ["CON-4836", "Travel & Expense (Concur) Item 5", "13/9/2026", "€35 936"], status: "active" as const },
];
...
export default function TravelExpenseConcurPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Travel & Expense (Concur)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Travel & Expense (Concur)</p>
                    </div>
                </div>
