...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.590","t":"+7.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.4%","t":"-5.3%","d":"down"},{"l":"Tempo Médio (h)","v":"110h","t":"+15.1%","d":"up"},{"l":"Rejeitadas (%)","v":"84.7%","t":"-5.0%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","272","€ 35485.24","7.126","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.452","€ 46010.19","149","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","482","€ 10899.81","112","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.219","€ 10349.77","1.389","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","1.397","€ 48817.21","5.201","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":739},{"label":"Mar","value":716},{"label":"Abr","value":796},{"label":"Mai","value":717},{"label":"Jun","value":490},{"label":"Jul","value":723},{"label":"Ago","value":636},{"label":"Set","value":555},{"label":"Out","value":622},{"label":"Nov","value":442},{"label":"Dez","value":647}];
const MX = 796;
