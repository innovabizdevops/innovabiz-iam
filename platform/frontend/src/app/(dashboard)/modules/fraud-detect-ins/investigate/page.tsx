...
const KPIS = [{"l":"Total Fraud Detect Ins","v":"188","t":"+5.1%","d":"up"},{"l":"Investigation Ativos","v":"8.309","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"75","t":"+5.2%","d":"up"}];
const COLS = ["ID","Investigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detect Ins #001","Fraud Detect Ins #002","7.344","7.767","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detect Ins #002","Fraud Detect Ins #003","2.609","6.510","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detect Ins #003","Fraud Detect Ins #004","5.783","2.189","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detect Ins #004","Fraud Detect Ins #005","7.153","4.572","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detect Ins #005","Fraud Detect Ins #001","8.378","3.700","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":557},{"label":"Mar","value":473},{"label":"Abr","value":474},{"label":"Mai","value":529},{"label":"Jun","value":756},{"label":"Jul","value":714},{"label":"Ago","value":503},{"label":"Set","value":593},{"label":"Out","value":757},{"label":"Nov","value":733},{"label":"Dez","value":781}];
const MX = 823;
