...
const ACCENT = "#6366f1";
const MODULE = "Fraud Detection";
const PAGE = "Pattern";
const KPIS = [{"l":"Total Fraud Detect Ins","v":"7.246","t":"-4.3%","d":"down"},{"l":"Pattern Ativos","v":"460","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"95","t":"-2.2%","d":"down"}];
const COLS = ["ID","Pattern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detect Ins #001","Fraud Detect Ins #002","6.364","5.401","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detect Ins #002","Fraud Detect Ins #003","3.705","2.695","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detect Ins #003","Fraud Detect Ins #004","2.650","6.479","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detect Ins #004","Fraud Detect Ins #005","4.277","5.886","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detect Ins #005","Fraud Detect Ins #001","2.369","1.404","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":620},{"label":"Mar","value":722},{"label":"Abr","value":557},{"label":"Mai","value":543},{"label":"Jun","value":567},{"label":"Jul","value":556},{"label":"Ago","value":796},{"label":"Set","value":839},{"label":"Out","value":791},{"label":"Nov","value":684},{"label":"Dez","value":684}];
const MX = 878;
