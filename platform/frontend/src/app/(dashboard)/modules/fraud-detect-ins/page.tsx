...
export default function FraudDetectInsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fraud Detect Ins</h1><p className="text-sm text-muted-foreground">Fraud Detect Ins • iBOS Enterprise</p></div>
