...
const PAGE = "Report";
const KPIS = [{"l":"Total Fraud Detect Ins","v":"8.692","t":"+11.7%","d":"up"},{"l":"Report Ativos","v":"3.519","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+6.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detect Ins #001","Fraud Detect Ins #002","3.494","7.551","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detect Ins #002","Fraud Detect Ins #003","8.571","5.686","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detect Ins #003","Fraud Detect Ins #004","5.751","5.742","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detect Ins #004","Fraud Detect Ins #005","6.885","317","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detect Ins #005","Fraud Detect Ins #001","5.306","389","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":610},{"label":"Mar","value":743},{"label":"Abr","value":637},{"label":"Mai","value":774},{"label":"Jun","value":778},{"label":"Jul","value":801},{"label":"Ago","value":836},{"label":"Set","value":919},{"label":"Out","value":754},{"label":"Nov","value":885},{"label":"Dez","value":962}];
const MX = 962;
