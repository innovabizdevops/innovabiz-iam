...
const PAGE = "SIU";
const KPIS = [{"l":"Total Fraud Detect Ins","v":"7.739","t":"-0.8%","d":"down"},{"l":"SIU Ativos","v":"7.094","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+7.0%","d":"up"}];
const COLS = ["ID","SIU","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detect Ins #001","Fraud Detect Ins #002","167","6.928","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detect Ins #002","Fraud Detect Ins #003","1.040","2.262","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detect Ins #003","Fraud Detect Ins #004","5.045","5.326","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detect Ins #004","Fraud Detect Ins #005","7.397","7.918","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detect Ins #005","Fraud Detect Ins #001","7.171","7.471","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":685},{"label":"Mar","value":609},{"label":"Abr","value":823},{"label":"Mai","value":660},{"label":"Jun","value":765},{"label":"Jul","value":634},{"label":"Ago","value":879},{"label":"Set","value":839},{"label":"Out","value":689},{"label":"Nov","value":856},{"label":"Dez","value":630}];
const MX = 895;
