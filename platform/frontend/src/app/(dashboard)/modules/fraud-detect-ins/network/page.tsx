...
const PAGE = "Network";
const KPIS = [{"l":"Total Fraud Detect Ins","v":"778","t":"-2.5%","d":"down"},{"l":"Network Ativos","v":"1.407","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"61","t":"+17.8%","d":"up"}];
const COLS = ["ID","Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detect Ins #001","Fraud Detect Ins #002","5.432","2.816","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detect Ins #002","Fraud Detect Ins #003","1.121","8.462","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detect Ins #003","Fraud Detect Ins #004","6.585","7.949","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detect Ins #004","Fraud Detect Ins #005","290","301","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detect Ins #005","Fraud Detect Ins #001","3.741","2.654","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":576},{"label":"Mar","value":717},{"label":"Abr","value":675},{"label":"Mai","value":744},{"label":"Jun","value":576},{"label":"Jul","value":851},{"label":"Ago","value":768},{"label":"Set","value":616},{"label":"Out","value":849},{"label":"Nov","value":645},{"label":"Dez","value":930}];
const MX = 930;
