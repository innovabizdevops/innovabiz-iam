...
const ACCENT = "#2563eb";
const MODULE = "Marina Management";
const PAGE = "Service";
const KPIS = [{"l":"Total Marina Mgmt","v":"7.576","t":"+2.7%","d":"up"},{"l":"Service Ativos","v":"7.755","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+11.7%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marina Mgmt #001","Marina Mgmt #002","1.768","2.874","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Marina Mgmt #002","Marina Mgmt #003","4.804","1.931","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Marina Mgmt #003","Marina Mgmt #004","6.768","9.006","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Marina Mgmt #004","Marina Mgmt #005","5.452","1.308","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marina Mgmt #005","Marina Mgmt #001","2.559","3.006","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":730},{"label":"Mar","value":783},{"label":"Abr","value":654},{"label":"Mai","value":439},{"label":"Jun","value":647},{"label":"Jul","value":534},{"label":"Ago","value":561},{"label":"Set","value":602},{"label":"Out","value":670},{"label":"Nov","value":622},{"label":"Dez","value":506}];
const MX = 783;
