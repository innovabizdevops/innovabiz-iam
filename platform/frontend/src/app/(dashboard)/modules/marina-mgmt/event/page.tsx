...
const PAGE = "Event";
const KPIS = [{"l":"Total Marina Mgmt","v":"8.668","t":"+2.7%","d":"up"},{"l":"Event Ativos","v":"6.064","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+14.9%","d":"up"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marina Mgmt #001","Marina Mgmt #002","4.457","1.413","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Marina Mgmt #002","Marina Mgmt #003","5.010","3.797","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Marina Mgmt #003","Marina Mgmt #004","3.263","2.024","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Marina Mgmt #004","Marina Mgmt #005","8.439","1.694","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marina Mgmt #005","Marina Mgmt #001","4.929","2.092","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":762},{"label":"Mar","value":731},{"label":"Abr","value":713},{"label":"Mai","value":649},{"label":"Jun","value":557},{"label":"Jul","value":895},{"label":"Ago","value":545},{"label":"Set","value":674},{"label":"Out","value":838},{"label":"Nov","value":658},{"label":"Dez","value":639}];
const MX = 895;
