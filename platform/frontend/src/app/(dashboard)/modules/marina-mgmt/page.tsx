...
/* ═══ Marina Management — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "6559", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1101", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€232K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1313667159", cells: ["MAR-1159", "Marina Management Item 1", "8/4/2026", "€17 259"], status: "active" as const },
    { id: "1313670730", cells: ["MAR-4730", "Marina Management Item 2", "23/11/2026", "€20 830"], status: "pending" as const },
    { id: "1313674301", cells: ["MAR-8301", "Marina Management Item 3", "10/6/2026", "€24 401"], status: "completed" as const },
    { id: "1313677872", cells: ["MAR-2872", "Marina Management Item 4", "25/1/2026", "€27 972"], status: "warning" as const },
    { id: "1313681443", cells: ["MAR-6443", "Marina Management Item 5", "12/8/2026", "€31 543"], status: "active" as const },
];
...
export default function MarinaManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marina Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marina Management</p>
                    </div>
                </div>
