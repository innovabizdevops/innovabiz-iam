...
const PAGE = "Fuel";
const KPIS = [{"l":"Total Marina Mgmt","v":"2.669","t":"+13.6%","d":"up"},{"l":"Fuel Ativos","v":"955","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"57","t":"+7.4%","d":"up"}];
const COLS = ["ID","Fuel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marina Mgmt #001","Marina Mgmt #002","4.589","7.804","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Marina Mgmt #002","Marina Mgmt #003","4.904","7.893","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Marina Mgmt #003","Marina Mgmt #004","5.613","4.470","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Marina Mgmt #004","Marina Mgmt #005","582","5.761","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marina Mgmt #005","Marina Mgmt #001","9.037","5.330","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":702},{"label":"Mar","value":753},{"label":"Abr","value":665},{"label":"Mai","value":396},{"label":"Jun","value":428},{"label":"Jul","value":636},{"label":"Ago","value":411},{"label":"Set","value":711},{"label":"Out","value":371},{"label":"Nov","value":528},{"label":"Dez","value":416}];
const MX = 753;
