...
const PAGE = "Slip";
const KPIS = [{"l":"Total Marina Mgmt","v":"8.734","t":"-5.0%","d":"down"},{"l":"Slip Ativos","v":"6.763","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+5.7%","d":"up"}];
const COLS = ["ID","Slip","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marina Mgmt #001","Marina Mgmt #002","7.393","6.316","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Marina Mgmt #002","Marina Mgmt #003","6.860","2.975","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Marina Mgmt #003","Marina Mgmt #004","6.748","3.636","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Marina Mgmt #004","Marina Mgmt #005","1.153","1.611","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marina Mgmt #005","Marina Mgmt #001","4.468","8.557","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":808},{"label":"Mar","value":904},{"label":"Abr","value":626},{"label":"Mai","value":831},{"label":"Jun","value":634},{"label":"Jul","value":802},{"label":"Ago","value":910},{"label":"Set","value":639},{"label":"Out","value":656},{"label":"Nov","value":827},{"label":"Dez","value":816}];
const MX = 912;
