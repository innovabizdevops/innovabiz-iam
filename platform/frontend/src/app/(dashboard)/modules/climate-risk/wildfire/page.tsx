...
const PAGE = "Wildfire Risk";
const KPIS = [{"l":"Riscos Identificados","v":"3.816","t":"+15.2%","d":"up"},{"l":"Mitigações Ativas","v":"1.298","t":"+17.9%","d":"up"},{"l":"Score Risco Geral","v":"59","t":"+12.2%","d":"up"},{"l":"Incidentes YTD","v":"1.818","t":"+12.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.999","2.740","5.941","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.256","5.884","7.360","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.442","6.623","7.300","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.276","6.371","6.660","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","480","7.077","3.601","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":409},{"label":"Fev","value":469},{"label":"Mar","value":511},{"label":"Abr","value":351},{"label":"Mai","value":381},{"label":"Jun","value":734},{"label":"Jul","value":696},{"label":"Ago","value":633},{"label":"Set","value":500},{"label":"Out","value":337},{"label":"Nov","value":568},{"label":"Dez","value":620}];
const MX = 734;
