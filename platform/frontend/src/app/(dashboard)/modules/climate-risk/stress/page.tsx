...
const KPIS = [{"l":"Riscos Identificados","v":"1.985","t":"+14.9%","d":"up"},{"l":"Mitigações Ativas","v":"8.826","t":"+8.0%","d":"up"},{"l":"Score Risco Geral","v":"62","t":"+6.9%","d":"up"},{"l":"Incidentes YTD","v":"1.040","t":"-5.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.115","1.339","8.952","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.148","8.910","1.731","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.468","8.484","5.470","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.433","771","2.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.028","2.879","8.129","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":540},{"label":"Mar","value":414},{"label":"Abr","value":489},{"label":"Mai","value":352},{"label":"Jun","value":370},{"label":"Jul","value":434},{"label":"Ago","value":569},{"label":"Set","value":447},{"label":"Out","value":407},{"label":"Nov","value":400},{"label":"Dez","value":576}];
const MX = 576;
