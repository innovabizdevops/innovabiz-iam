...
const PAGE = "Physical Risk";
const KPIS = [{"l":"Riscos Identificados","v":"2.242","t":"+5.1%","d":"up"},{"l":"Mitigações Ativas","v":"767","t":"+6.3%","d":"up"},{"l":"Score Risco Geral","v":"74","t":"-0.6%","d":"down"},{"l":"Incidentes YTD","v":"4.424","t":"+10.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.103","1.827","1.424","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.186","5.764","2.261","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","602","1.047","2.214","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.153","8.241","3.295","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","786","4.938","4.005","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":785},{"label":"Mar","value":964},{"label":"Abr","value":828},{"label":"Mai","value":955},{"label":"Jun","value":1005},{"label":"Jul","value":778},{"label":"Ago","value":761},{"label":"Set","value":1030},{"label":"Out","value":700},{"label":"Nov","value":930},{"label":"Dez","value":1017}];
const MX = 1030;
