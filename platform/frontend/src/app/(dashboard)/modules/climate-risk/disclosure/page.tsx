...
const KPIS = [{"l":"Riscos Identificados","v":"6.683","t":"+2.7%","d":"up"},{"l":"Mitigações Ativas","v":"2.046","t":"+10.8%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"-4.3%","d":"down"},{"l":"Incidentes YTD","v":"7.472","t":"-3.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.119","3.240","8.386","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.053","1.592","3.239","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.657","6.788","4.089","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.981","4.718","2.621","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.664","7.904","3.983","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":557},{"label":"Mar","value":526},{"label":"Abr","value":719},{"label":"Mai","value":639},{"label":"Jun","value":848},{"label":"Jul","value":796},{"label":"Ago","value":768},{"label":"Set","value":862},{"label":"Out","value":662},{"label":"Nov","value":906},{"label":"Dez","value":866}];
const MX = 906;
