...
const KPIS = [{"l":"Riscos Identificados","v":"426","t":"+8.9%","d":"up"},{"l":"Mitigações Ativas","v":"6.365","t":"-0.1%","d":"down"},{"l":"Score Risco Geral","v":"94","t":"+17.9%","d":"up"},{"l":"Incidentes YTD","v":"8.926","t":"+14.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.122","5.118","8.334","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.968","6.428","7.292","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.860","4.561","5.432","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.695","2.824","3.487","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.296","4.125","1.291","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":762},{"label":"Mar","value":596},{"label":"Abr","value":539},{"label":"Mai","value":780},{"label":"Jun","value":508},{"label":"Jul","value":510},{"label":"Ago","value":904},{"label":"Set","value":705},{"label":"Out","value":775},{"label":"Nov","value":639},{"label":"Dez","value":713}];
const MX = 904;
