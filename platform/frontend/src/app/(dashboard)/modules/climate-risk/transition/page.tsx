...
const PAGE = "Transition Risk";
const KPIS = [{"l":"Riscos Identificados","v":"722","t":"+-0.0%","d":"up"},{"l":"Mitigações Ativas","v":"2.837","t":"+15.6%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"-5.5%","d":"down"},{"l":"Incidentes YTD","v":"568","t":"+0.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.047","3.973","5.609","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.542","3.139","295","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.850","8.575","7.527","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.458","6.767","4.409","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.938","3.084","2.795","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":576},{"label":"Mar","value":704},{"label":"Abr","value":719},{"label":"Mai","value":629},{"label":"Jun","value":615},{"label":"Jul","value":849},{"label":"Ago","value":725},{"label":"Set","value":811},{"label":"Out","value":686},{"label":"Nov","value":662},{"label":"Dez","value":750}];
const MX = 849;
