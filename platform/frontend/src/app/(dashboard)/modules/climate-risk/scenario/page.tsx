...
const ACCENT = "#dc2626";
const MODULE = "Climate Risk";
const PAGE = "Scenario Model";
const KPIS = [{"l":"Riscos Identificados","v":"3.340","t":"+6.5%","d":"up"},{"l":"Mitigações Ativas","v":"3.855","t":"-2.1%","d":"down"},{"l":"Score Risco Geral","v":"68","t":"+13.1%","d":"up"},{"l":"Incidentes YTD","v":"6.965","t":"+7.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.080","6.291","5.070","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.650","5.376","4.986","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.269","2.119","7.716","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.823","2.676","2.667","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","267","7.699","2.624","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":784},{"label":"Mar","value":629},{"label":"Abr","value":673},{"label":"Mai","value":829},{"label":"Jun","value":958},{"label":"Jul","value":857},{"label":"Ago","value":751},{"label":"Set","value":839},{"label":"Out","value":937},{"label":"Nov","value":871},{"label":"Dez","value":982}];
const MX = 982;
