...
const PAGE = "Absence";
const KPIS = [{"l":"Total Time Attendance Deep","v":"3.161","t":"+17.0%","d":"up"},{"l":"Absence Ativos","v":"8.621","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"77.0%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+13.9%","d":"up"}];
const COLS = ["ID","Absence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Attendance Deep #001","Time Attendance Deep #002","4.365","2.833","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Time Attendance Deep #002","Time Attendance Deep #003","920","4.671","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Attendance Deep #003","Time Attendance Deep #004","1.842","4.963","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Time Attendance Deep #004","Time Attendance Deep #005","1.778","3.569","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Attendance Deep #005","Time Attendance Deep #001","5.942","4.913","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":757},{"label":"Mar","value":795},{"label":"Abr","value":1007},{"label":"Mai","value":1012},{"label":"Jun","value":810},{"label":"Jul","value":969},{"label":"Ago","value":957},{"label":"Set","value":954},{"label":"Out","value":886},{"label":"Nov","value":861},{"label":"Dez","value":1030}];
const MX = 1030;
