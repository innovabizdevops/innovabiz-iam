...
/* ═══ Time & Attendance Deep — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "2493", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "185", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€44K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1580398793", cells: ["TIM-8793", "Time & Attendance Deep Item 1", "2/6/2026", "€48 893"], status: "active" as const },
    { id: "1580402364", cells: ["TIM-3364", "Time & Attendance Deep Item 2", "17/1/2026", "€2464"], status: "pending" as const },
    { id: "1580405935", cells: ["TIM-6935", "Time & Attendance Deep Item 3", "4/8/2026", "€6035"], status: "completed" as const },
    { id: "1580409506", cells: ["TIM-1506", "Time & Attendance Deep Item 4", "19/3/2026", "€9606"], status: "warning" as const },
    { id: "1580413077", cells: ["TIM-5077", "Time & Attendance Deep Item 5", "6/10/2026", "€13 177"], status: "active" as const },
];
...
export default function TimeAttendanceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Time & Attendance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Time & Attendance Deep</p>
                    </div>
                </div>
