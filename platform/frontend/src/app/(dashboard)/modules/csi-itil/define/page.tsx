...
const PAGE = "Define";
const KPIS = [{"l":"Tickets Abertos","v":"1.734","t":"+17.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.8%","t":"+6.6%","d":"up"},{"l":"MTTR (h)","v":"75h","t":"-1.2%","d":"down"},{"l":"Satisfação (%)","v":"89.0%","t":"-2.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.029","6.821","3.411","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.839","2.474","2.649","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.047","3.299","5.528","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.137","2.534","2.708","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.227","5.929","6.549","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":463},{"label":"Mar","value":551},{"label":"Abr","value":437},{"label":"Mai","value":479},{"label":"Jun","value":673},{"label":"Jul","value":620},{"label":"Ago","value":555},{"label":"Set","value":584},{"label":"Out","value":727},{"label":"Nov","value":613},{"label":"Dez","value":555}];
const MX = 727;
