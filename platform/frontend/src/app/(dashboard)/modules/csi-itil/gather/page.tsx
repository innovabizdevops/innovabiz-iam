...
const PAGE = "Gather";
const KPIS = [{"l":"Tickets Abertos","v":"7.064","t":"+17.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.6%","t":"+6.1%","d":"up"},{"l":"MTTR (h)","v":"82h","t":"+10.1%","d":"up"},{"l":"Satisfação (%)","v":"78.6%","t":"+16.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.305","1.035","7.127","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.489","2.869","1.451","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.760","8.082","8.055","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.787","4.849","3.050","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.001","8.295","966","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":512},{"label":"Mar","value":792},{"label":"Abr","value":588},{"label":"Mai","value":746},{"label":"Jun","value":598},{"label":"Jul","value":630},{"label":"Ago","value":743},{"label":"Set","value":864},{"label":"Out","value":616},{"label":"Nov","value":840},{"label":"Dez","value":558}];
const MX = 864;
