...
const PAGE = "Identify";
const KPIS = [{"l":"Tickets Abertos","v":"3.694","t":"-2.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"82.6%","t":"+16.5%","d":"up"},{"l":"MTTR (h)","v":"12h","t":"+6.2%","d":"up"},{"l":"Satisfação (%)","v":"68.7%","t":"+15.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.391","3.858","5.982","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.362","7.289","800","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","921","407","6.730","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.910","3.716","1.803","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.206","393","2.158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":559},{"label":"Mar","value":595},{"label":"Abr","value":419},{"label":"Mai","value":717},{"label":"Jun","value":687},{"label":"Jul","value":748},{"label":"Ago","value":639},{"label":"Set","value":648},{"label":"Out","value":799},{"label":"Nov","value":502},{"label":"Dez","value":496}];
const MX = 799;
