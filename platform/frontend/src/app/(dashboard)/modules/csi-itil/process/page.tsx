...
const PAGE = "Process";
const KPIS = [{"l":"Tickets Abertos","v":"8.755","t":"+8.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.9%","t":"+14.1%","d":"up"},{"l":"MTTR (h)","v":"18h","t":"+11.4%","d":"up"},{"l":"Satisfação (%)","v":"86.9%","t":"+0.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.951","6.914","6.811","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.714","8.142","5.863","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.762","2.247","6.536","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.068","6.933","3.812","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.991","3.893","1.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":816},{"label":"Mar","value":787},{"label":"Abr","value":807},{"label":"Mai","value":1016},{"label":"Jun","value":983},{"label":"Jul","value":730},{"label":"Ago","value":1062},{"label":"Set","value":809},{"label":"Out","value":789},{"label":"Nov","value":748},{"label":"Dez","value":857}];
const MX = 1062;
