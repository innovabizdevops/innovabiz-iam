...
const KPIS = [
    { label: "Total Registos", value: "1677", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "697", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€318K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1790159177", cells: ["CSI-6177", "Continual Service Improvement Item 1", "10/6/2026", "€9277"], status: "active" as const },
    { id: "1790162748", cells: ["CSI-9748", "Continual Service Improvement Item 2", "25/1/2026", "€12 848"], status: "pending" as const },
    { id: "1790166319", cells: ["CSI-4319", "Continual Service Improvement Item 3", "12/8/2026", "€16 419"], status: "completed" as const },
    { id: "1790169890", cells: ["CSI-7890", "Continual Service Improvement Item 4", "27/3/2026", "€19 990"], status: "warning" as const },
    { id: "1790173461", cells: ["CSI-2461", "Continual Service Improvement Item 5", "14/10/2026", "€23 561"], status: "active" as const },
];
...
export default function ContinualServiceImprovementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Continual Service Improvement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Continual Service Improvement</p>
                    </div>
                </div>
