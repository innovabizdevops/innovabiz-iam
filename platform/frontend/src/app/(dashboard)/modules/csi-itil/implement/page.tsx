...
const ACCENT = "#94a3b8";
const MODULE = "Continual Service Improvement";
const PAGE = "Implement";
const KPIS = [{"l":"Tickets Abertos","v":"391","t":"+15.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.1%","t":"+13.7%","d":"up"},{"l":"MTTR (h)","v":"128h","t":"+0.1%","d":"up"},{"l":"Satisfação (%)","v":"69.1%","t":"-5.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.696","1.505","6.247","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.396","2.761","6.049","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.923","1.877","4.384","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.793","8.483","8.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.302","9.026","7.359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":643},{"label":"Mar","value":818},{"label":"Abr","value":763},{"label":"Mai","value":835},{"label":"Jun","value":794},{"label":"Jul","value":732},{"label":"Ago","value":785},{"label":"Set","value":566},{"label":"Out","value":655},{"label":"Nov","value":798},{"label":"Dez","value":744}];
const MX = 835;
