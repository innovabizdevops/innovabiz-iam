...
const PAGE = "Identity Graph";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.979","t":"+12.3%","d":"up"},{"l":"Sessões/Dia","v":"1703","t":"+1.8%","d":"up"},{"l":"MFA Adoção (%)","v":"70.4%","t":"+2.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.814","t":"+11.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.100","979","5.033","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.686","3.294","5.863","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.263","4.622","525","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.460","6.980","1.911","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.408","5.165","9.019","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":721},{"label":"Mar","value":742},{"label":"Abr","value":621},{"label":"Mai","value":589},{"label":"Jun","value":820},{"label":"Jul","value":490},{"label":"Ago","value":682},{"label":"Set","value":475},{"label":"Out","value":528},{"label":"Nov","value":704},{"label":"Dez","value":820}];
const MX = 820;
