...
export default function CdpMarketingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cdp Marketing</h1><p className="text-sm text-muted-foreground">Cdp Marketing • iBOS Enterprise</p></div>
