...
const KPIS = [{"l":"Perfis Unificados","v":"1.229","t":"+2.9%","d":"up"},{"l":"Segmentos Ativos","v":"1.889","t":"-3.6%","d":"down"},{"l":"NPS Score","v":"88","t":"+8.5%","d":"up"},{"l":"Churn Previsto (%)","v":"77.1%","t":"+16.2%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.396","€ 42148.00","90.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.188","€ 48078.51","86.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","372","€ 28076.04","75.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.723","€ 41162.01","76.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.346","€ 41421.58","88.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":735},{"label":"Mar","value":837},{"label":"Abr","value":563},{"label":"Mai","value":533},{"label":"Jun","value":861},{"label":"Jul","value":804},{"label":"Ago","value":551},{"label":"Set","value":545},{"label":"Out","value":554},{"label":"Nov","value":628},{"label":"Dez","value":807}];
const MX = 861;
