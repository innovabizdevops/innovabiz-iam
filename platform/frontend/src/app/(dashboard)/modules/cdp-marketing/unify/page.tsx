...
const ACCENT = "#b45309";
const MODULE = "CDP Marketing";
const PAGE = "Profile Unify";
const KPIS = [{"l":"Perfis Unificados","v":"3.129","t":"-2.9%","d":"down"},{"l":"Segmentos Ativos","v":"1.248","t":"-3.1%","d":"down"},{"l":"NPS Score","v":"62","t":"+14.6%","d":"up"},{"l":"Churn Previsto (%)","v":"68.9%","t":"+3.3%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.251","€ 8338.93","82.3%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.382","€ 38513.43","98.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.736","€ 19073.98","88.2%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","371","€ 37199.78","93.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","843","€ 7366.21","80.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":833},{"label":"Mar","value":517},{"label":"Abr","value":588},{"label":"Mai","value":498},{"label":"Jun","value":661},{"label":"Jul","value":500},{"label":"Ago","value":622},{"label":"Set","value":848},{"label":"Out","value":555},{"label":"Nov","value":756},{"label":"Dez","value":695}];
const MX = 848;
