...
const PAGE = "Ballot";
const KPIS = [{"l":"Total Elections Mgmt","v":"6.001","t":"+5.6%","d":"up"},{"l":"Ballot Ativos","v":"7.763","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+6.2%","d":"up"}];
const COLS = ["ID","Ballot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elections Mgmt #001","Elections Mgmt #002","7.271","7.660","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Elections Mgmt #002","Elections Mgmt #003","7.343","597","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Elections Mgmt #003","Elections Mgmt #004","8.697","4.789","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Elections Mgmt #004","Elections Mgmt #005","7.605","800","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elections Mgmt #005","Elections Mgmt #001","387","2.150","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":449},{"label":"Mar","value":572},{"label":"Abr","value":581},{"label":"Mai","value":679},{"label":"Jun","value":610},{"label":"Jul","value":456},{"label":"Ago","value":467},{"label":"Set","value":695},{"label":"Out","value":317},{"label":"Nov","value":659},{"label":"Dez","value":330}];
const MX = 695;
