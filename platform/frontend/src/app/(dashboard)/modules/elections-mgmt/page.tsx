...
const KPIS = [
    { label: "Total Registos", value: "1807", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1038", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€380K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "173172507", cells: ["ELE-4507", "Elections Management Item 1", "12/4/2026", "€22 607"], status: "active" as const },
    { id: "173176078", cells: ["ELE-8078", "Elections Management Item 2", "27/11/2026", "€26 178"], status: "pending" as const },
    { id: "173179649", cells: ["ELE-2649", "Elections Management Item 3", "14/6/2026", "€29 749"], status: "completed" as const },
    { id: "173183220", cells: ["ELE-6220", "Elections Management Item 4", "1/1/2026", "€33 320"], status: "warning" as const },
    { id: "173186791", cells: ["ELE-9791", "Elections Management Item 5", "16/8/2026", "€36 891"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Elections Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Elections Management</p>
                    </div>
                </div>
