...
const PAGE = "Count";
const KPIS = [{"l":"Total Elections Mgmt","v":"5.974","t":"-4.5%","d":"down"},{"l":"Count Ativos","v":"729","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"77.4%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"56","t":"+4.7%","d":"up"}];
const COLS = ["ID","Count","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elections Mgmt #001","Elections Mgmt #002","7.425","5.781","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Elections Mgmt #002","Elections Mgmt #003","8.633","3.116","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Elections Mgmt #003","Elections Mgmt #004","7.146","5.882","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Elections Mgmt #004","Elections Mgmt #005","158","1.612","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elections Mgmt #005","Elections Mgmt #001","6.702","7.160","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":573},{"label":"Mar","value":761},{"label":"Abr","value":703},{"label":"Mai","value":631},{"label":"Jun","value":456},{"label":"Jul","value":565},{"label":"Ago","value":517},{"label":"Set","value":754},{"label":"Out","value":728},{"label":"Nov","value":536},{"label":"Dez","value":636}];
const MX = 761;
