...
const PAGE = "Result";
const KPIS = [{"l":"Total Elections Mgmt","v":"173","t":"+3.6%","d":"up"},{"l":"Result Ativos","v":"7.775","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.2%","d":"down"}];
const COLS = ["ID","Result","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elections Mgmt #001","Elections Mgmt #002","4.616","1.393","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Elections Mgmt #002","Elections Mgmt #003","1.862","2.250","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Elections Mgmt #003","Elections Mgmt #004","567","3.446","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Elections Mgmt #004","Elections Mgmt #005","2.317","3.451","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elections Mgmt #005","Elections Mgmt #001","6.918","4.608","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":696},{"label":"Mar","value":524},{"label":"Abr","value":790},{"label":"Mai","value":742},{"label":"Jun","value":647},{"label":"Jul","value":689},{"label":"Ago","value":803},{"label":"Set","value":751},{"label":"Out","value":781},{"label":"Nov","value":733},{"label":"Dez","value":577}];
const MX = 803;
