...
const PAGE = "Vote";
const KPIS = [{"l":"Total Elections Mgmt","v":"3.956","t":"+12.5%","d":"up"},{"l":"Vote Ativos","v":"480","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.4%","d":"down"}];
const COLS = ["ID","Vote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elections Mgmt #001","Elections Mgmt #002","3.076","3.034","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Elections Mgmt #002","Elections Mgmt #003","2.679","7.367","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Elections Mgmt #003","Elections Mgmt #004","2.360","1.784","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Elections Mgmt #004","Elections Mgmt #005","223","7.040","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elections Mgmt #005","Elections Mgmt #001","8.345","7.894","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":672},{"label":"Mar","value":314},{"label":"Abr","value":595},{"label":"Mai","value":406},{"label":"Jun","value":458},{"label":"Jul","value":414},{"label":"Ago","value":543},{"label":"Set","value":393},{"label":"Out","value":403},{"label":"Nov","value":412},{"label":"Dez","value":366}];
const MX = 672;
