...
const ACCENT = "#1e3a5f";
const MODULE = "Elections Management";
const PAGE = "Register";
const KPIS = [{"l":"Total Elections Mgmt","v":"3.406","t":"+16.4%","d":"up"},{"l":"Register Ativos","v":"7.973","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"64","t":"+13.1%","d":"up"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elections Mgmt #001","Elections Mgmt #002","2.788","4.157","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Elections Mgmt #002","Elections Mgmt #003","2.509","6.963","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Elections Mgmt #003","Elections Mgmt #004","7.821","1.401","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Elections Mgmt #004","Elections Mgmt #005","4.524","8.823","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elections Mgmt #005","Elections Mgmt #001","2.815","6.146","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":618},{"label":"Mar","value":574},{"label":"Abr","value":859},{"label":"Mai","value":817},{"label":"Jun","value":553},{"label":"Jul","value":687},{"label":"Ago","value":571},{"label":"Set","value":766},{"label":"Out","value":921},{"label":"Nov","value":613},{"label":"Dez","value":553}];
const MX = 921;
