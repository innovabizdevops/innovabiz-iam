...
const PAGE = "Reward Rules";
const KPIS = [{"l":"Total Referral Program","v":"8.132","t":"+5.8%","d":"up"},{"l":"Reward Rules Ativos","v":"2.915","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"85","t":"-4.3%","d":"down"}];
const COLS = ["ID","Reward Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Referral Program #001","Referral Program #002","4.170","5.464","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Referral Program #002","Referral Program #003","3.825","8.055","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Referral Program #003","Referral Program #004","1.032","5.552","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Referral Program #004","Referral Program #005","2.944","773","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Referral Program #005","Referral Program #001","132","6.899","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":496},{"label":"Mar","value":559},{"label":"Abr","value":481},{"label":"Mai","value":605},{"label":"Jun","value":828},{"label":"Jul","value":683},{"label":"Ago","value":499},{"label":"Set","value":672},{"label":"Out","value":511},{"label":"Nov","value":588},{"label":"Dez","value":637}];
const MX = 828;
