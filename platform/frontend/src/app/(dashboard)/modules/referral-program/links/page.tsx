...
const ACCENT = "#e11d48";
const MODULE = "Referral Program";
const PAGE = "Referral Links";
const KPIS = [{"l":"Total Referral Program","v":"4.428","t":"-5.6%","d":"down"},{"l":"Referral Links Ativos","v":"3.431","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"77","t":"+8.6%","d":"up"}];
const COLS = ["ID","Referral Links","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Referral Program #001","Referral Program #002","3.888","4.682","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Referral Program #002","Referral Program #003","2.200","8.730","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Referral Program #003","Referral Program #004","7.773","3.134","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Referral Program #004","Referral Program #005","7.469","7.542","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Referral Program #005","Referral Program #001","1.655","2.679","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":729},{"label":"Mar","value":640},{"label":"Abr","value":834},{"label":"Mai","value":757},{"label":"Jun","value":880},{"label":"Jul","value":823},{"label":"Ago","value":821},{"label":"Set","value":639},{"label":"Out","value":776},{"label":"Nov","value":669},{"label":"Dez","value":601}];
const MX = 880;
