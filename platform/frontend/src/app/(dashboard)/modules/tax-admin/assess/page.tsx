...
const KPIS = [{"l":"Total Tax Admin","v":"127","t":"+14.7%","d":"up"},{"l":"Assessment Ativos","v":"2.339","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.1%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Admin #001","Tax Admin #002","2.279","8.952","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Admin #002","Tax Admin #003","6.202","3.702","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Admin #003","Tax Admin #004","7.720","5.586","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Admin #004","Tax Admin #005","3.702","6.164","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Admin #005","Tax Admin #001","4.209","1.906","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":697},{"label":"Mar","value":516},{"label":"Abr","value":683},{"label":"Mai","value":566},{"label":"Jun","value":540},{"label":"Jul","value":759},{"label":"Ago","value":709},{"label":"Set","value":765},{"label":"Out","value":764},{"label":"Nov","value":867},{"label":"Dez","value":770}];
const MX = 867;
