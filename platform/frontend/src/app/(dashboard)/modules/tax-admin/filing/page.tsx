...
const PAGE = "Filing";
const KPIS = [{"l":"Total Tax Admin","v":"452","t":"-5.5%","d":"down"},{"l":"Filing Ativos","v":"829","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"88.9%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"79","t":"-5.5%","d":"down"}];
const COLS = ["ID","Filing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Admin #001","Tax Admin #002","4.299","7.851","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Admin #002","Tax Admin #003","7.135","3.507","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Admin #003","Tax Admin #004","6.370","5.882","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Admin #004","Tax Admin #005","6.103","6.126","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Admin #005","Tax Admin #001","3.475","7.256","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":669},{"label":"Mar","value":368},{"label":"Abr","value":484},{"label":"Mai","value":605},{"label":"Jun","value":544},{"label":"Jul","value":507},{"label":"Ago","value":426},{"label":"Set","value":300},{"label":"Out","value":485},{"label":"Nov","value":286},{"label":"Dez","value":304}];
const MX = 669;
