...
const ACCENT = "#6366f1";
const MODULE = "Tax Administration";
const PAGE = "Collection";
const KPIS = [{"l":"Total Tax Admin","v":"6.618","t":"+13.3%","d":"up"},{"l":"Collection Ativos","v":"7.280","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"91","t":"-1.5%","d":"down"}];
const COLS = ["ID","Collection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Admin #001","Tax Admin #002","3.310","458","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Admin #002","Tax Admin #003","6.867","4.404","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Admin #003","Tax Admin #004","637","3.593","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Admin #004","Tax Admin #005","2.711","6.310","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Admin #005","Tax Admin #001","535","4.499","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":897},{"label":"Mar","value":753},{"label":"Abr","value":739},{"label":"Mai","value":924},{"label":"Jun","value":679},{"label":"Jul","value":970},{"label":"Ago","value":864},{"label":"Set","value":715},{"label":"Out","value":862},{"label":"Nov","value":717},{"label":"Dez","value":851}];
const MX = 970;
