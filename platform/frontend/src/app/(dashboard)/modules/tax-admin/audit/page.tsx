...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.663","t":"+15.1%","d":"up"},{"l":"NC Abertas","v":"4.661","t":"-2.9%","d":"down"},{"l":"Conformidade (%)","v":"73.7%","t":"+16.5%","d":"up"},{"l":"CAPAs Pendentes","v":"321","t":"-2.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.415","76.4%","2.162","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.217","76.4%","3.885","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.604","80.3%","3.570","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.919","75.7%","4.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.991","77.9%","511","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":429},{"label":"Mar","value":611},{"label":"Abr","value":807},{"label":"Mai","value":678},{"label":"Jun","value":518},{"label":"Jul","value":782},{"label":"Ago","value":707},{"label":"Set","value":552},{"label":"Out","value":471},{"label":"Nov","value":585},{"label":"Dez","value":785}];
const MX = 807;
