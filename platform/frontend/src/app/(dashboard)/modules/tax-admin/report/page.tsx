...
const PAGE = "Report";
const KPIS = [{"l":"Total Tax Admin","v":"3.260","t":"+10.2%","d":"up"},{"l":"Report Ativos","v":"2.792","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+3.7%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Admin #001","Tax Admin #002","7.740","5.359","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Admin #002","Tax Admin #003","5.296","5.466","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Admin #003","Tax Admin #004","1.957","4.182","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Admin #004","Tax Admin #005","7.756","5.687","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Admin #005","Tax Admin #001","5.956","7.216","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":659},{"label":"Mar","value":758},{"label":"Abr","value":761},{"label":"Mai","value":910},{"label":"Jun","value":758},{"label":"Jul","value":1005},{"label":"Ago","value":637},{"label":"Set","value":762},{"label":"Out","value":927},{"label":"Nov","value":794},{"label":"Dez","value":834}];
const MX = 1005;
