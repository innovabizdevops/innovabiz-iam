...
export default function SurgicalRobotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Surgical Robot</h1><p className="text-sm text-muted-foreground">Surgical Robot • iBOS Enterprise</p></div>
