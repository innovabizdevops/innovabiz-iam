...
const KPIS = [{"l":"Total Surgical Robot","v":"8.381","t":"+1.5%","d":"up"},{"l":"Procedure Ativos","v":"8.558","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+14.9%","d":"up"}];
const COLS = ["ID","Procedure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surgical Robot #001","Surgical Robot #002","9.089","4.326","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Surgical Robot #002","Surgical Robot #003","8.737","5.733","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Surgical Robot #003","Surgical Robot #004","674","1.712","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Surgical Robot #004","Surgical Robot #005","8.877","6.646","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surgical Robot #005","Surgical Robot #001","5.062","6.945","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":602},{"label":"Mar","value":266},{"label":"Abr","value":592},{"label":"Mai","value":267},{"label":"Jun","value":377},{"label":"Jul","value":337},{"label":"Ago","value":501},{"label":"Set","value":429},{"label":"Out","value":412},{"label":"Nov","value":393},{"label":"Dez","value":309}];
const MX = 602;
