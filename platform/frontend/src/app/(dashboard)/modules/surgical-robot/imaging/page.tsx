...
const ACCENT = "#6366f1";
const MODULE = "Surgical Robotics";
const PAGE = "Imaging";
const KPIS = [{"l":"Total Surgical Robot","v":"7.711","t":"+4.8%","d":"up"},{"l":"Imaging Ativos","v":"3.141","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"70","t":"-4.3%","d":"down"}];
const COLS = ["ID","Imaging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surgical Robot #001","Surgical Robot #002","2.284","4.925","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Surgical Robot #002","Surgical Robot #003","2.844","8.616","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Surgical Robot #003","Surgical Robot #004","3.202","136","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Surgical Robot #004","Surgical Robot #005","8.606","7.757","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surgical Robot #005","Surgical Robot #001","219","3.396","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":601},{"label":"Mar","value":612},{"label":"Abr","value":504},{"label":"Mai","value":702},{"label":"Jun","value":469},{"label":"Jul","value":506},{"label":"Ago","value":625},{"label":"Set","value":642},{"label":"Out","value":577},{"label":"Nov","value":509},{"label":"Dez","value":500}];
const MX = 743;
