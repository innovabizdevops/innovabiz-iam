...
const PAGE = "Process";
const KPIS = [{"l":"Total Poultry Deep","v":"8.772","t":"+14.7%","d":"up"},{"l":"Process Ativos","v":"3.401","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"77.6%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"64","t":"-3.2%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Deep #001","Poultry Deep #002","4.414","582","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Deep #002","Poultry Deep #003","3.894","2.814","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Deep #003","Poultry Deep #004","563","6.150","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Deep #004","Poultry Deep #005","6.229","8.899","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Deep #005","Poultry Deep #001","3.390","5.120","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":829},{"label":"Mar","value":698},{"label":"Abr","value":779},{"label":"Mai","value":642},{"label":"Jun","value":773},{"label":"Jul","value":497},{"label":"Ago","value":838},{"label":"Set","value":473},{"label":"Out","value":690},{"label":"Nov","value":711},{"label":"Dez","value":659}];
const MX = 838;
