...
const PAGE = "Health";
const KPIS = [{"l":"Total Poultry Deep","v":"2.440","t":"+13.0%","d":"up"},{"l":"Health Ativos","v":"6.699","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"83","t":"+12.2%","d":"up"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Deep #001","Poultry Deep #002","2.699","2.719","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Deep #002","Poultry Deep #003","6.707","3.054","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Deep #003","Poultry Deep #004","8.577","2.134","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Deep #004","Poultry Deep #005","8.509","4.468","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Deep #005","Poultry Deep #001","481","7.978","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":1059},{"label":"Mar","value":896},{"label":"Abr","value":1039},{"label":"Mai","value":751},{"label":"Jun","value":864},{"label":"Jul","value":724},{"label":"Ago","value":977},{"label":"Set","value":1072},{"label":"Out","value":1050},{"label":"Nov","value":782},{"label":"Dez","value":1045}];
const MX = 1072;
