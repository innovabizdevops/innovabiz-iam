...
const PAGE = "Egg";
const KPIS = [{"l":"Total Poultry Deep","v":"109","t":"+0.6%","d":"up"},{"l":"Egg Ativos","v":"5.997","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"89","t":"+9.8%","d":"up"}];
const COLS = ["ID","Egg","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Deep #001","Poultry Deep #002","939","4.115","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Deep #002","Poultry Deep #003","1.025","3.458","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Deep #003","Poultry Deep #004","3.465","3.648","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Deep #004","Poultry Deep #005","4.717","217","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Deep #005","Poultry Deep #001","2.845","3.553","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":736},{"label":"Mar","value":538},{"label":"Abr","value":708},{"label":"Mai","value":549},{"label":"Jun","value":469},{"label":"Jul","value":621},{"label":"Ago","value":475},{"label":"Set","value":412},{"label":"Out","value":490},{"label":"Nov","value":373},{"label":"Dez","value":474}];
const MX = 736;
