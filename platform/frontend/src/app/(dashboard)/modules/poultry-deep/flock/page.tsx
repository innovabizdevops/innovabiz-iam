...
const PAGE = "Flock";
const KPIS = [{"l":"Total Poultry Deep","v":"2.450","t":"+4.5%","d":"up"},{"l":"Flock Ativos","v":"6.993","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"65","t":"+13.5%","d":"up"}];
const COLS = ["ID","Flock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Deep #001","Poultry Deep #002","3.836","3.926","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Deep #002","Poultry Deep #003","7.764","5.687","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Deep #003","Poultry Deep #004","1.191","6.188","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Deep #004","Poultry Deep #005","737","5.153","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Deep #005","Poultry Deep #001","161","7.215","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1082},{"label":"Fev","value":1004},{"label":"Mar","value":1045},{"label":"Abr","value":843},{"label":"Mai","value":942},{"label":"Jun","value":708},{"label":"Jul","value":869},{"label":"Ago","value":1081},{"label":"Set","value":871},{"label":"Out","value":949},{"label":"Nov","value":711},{"label":"Dez","value":1030}];
const MX = 1082;
