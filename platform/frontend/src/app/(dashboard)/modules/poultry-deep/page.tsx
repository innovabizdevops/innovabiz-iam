...
/* ═══ Poultry Deep — Dashboard ═══ */

const ACCENT = "#fdba74";

const KPIS = [
    { label: "Total Registos", value: "2103", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1023", trend: "+23%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "72212603", cells: ["POU-6603", "Poultry Deep Item 1", "16/12/2026", "€12 703"], status: "active" as const },
    { id: "72216174", cells: ["POU-1174", "Poultry Deep Item 2", "3/7/2026", "€16 274"], status: "pending" as const },
    { id: "72219745", cells: ["POU-4745", "Poultry Deep Item 3", "18/2/2026", "€19 845"], status: "completed" as const },
    { id: "72223316", cells: ["POU-8316", "Poultry Deep Item 4", "5/9/2026", "€23 416"], status: "warning" as const },
    { id: "72226887", cells: ["POU-2887", "Poultry Deep Item 5", "20/4/2026", "€26 987"], status: "active" as const },
];
...
export default function PoultryDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Poultry Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Poultry Deep</p>
                    </div>
                </div>
