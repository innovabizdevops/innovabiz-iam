...
const ACCENT = "#fdba74";
const MODULE = "Poultry Deep";
const PAGE = "Feed";
const KPIS = [{"l":"Total Poultry Deep","v":"6.020","t":"+12.6%","d":"up"},{"l":"Feed Ativos","v":"3.018","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"68","t":"-2.7%","d":"down"}];
const COLS = ["ID","Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Poultry Deep #001","Poultry Deep #002","2.552","2.268","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Poultry Deep #002","Poultry Deep #003","1.712","1.312","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Poultry Deep #003","Poultry Deep #004","8.031","5.589","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Poultry Deep #004","Poultry Deep #005","8.741","7.017","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Poultry Deep #005","Poultry Deep #001","8.138","2.586","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":642},{"label":"Mar","value":518},{"label":"Abr","value":441},{"label":"Mai","value":573},{"label":"Jun","value":657},{"label":"Jul","value":427},{"label":"Ago","value":506},{"label":"Set","value":435},{"label":"Out","value":618},{"label":"Nov","value":395},{"label":"Dez","value":511}];
const MX = 657;
