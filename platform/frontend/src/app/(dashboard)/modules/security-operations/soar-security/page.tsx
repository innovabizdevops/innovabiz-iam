...
const PAGE = "SOAR Platform";
const KPIS = [{"l":"Formulários Ativos","v":"622","t":"+13.7%","d":"up"},{"l":"Submissões/Dia","v":"3884","t":"+17.9%","d":"up"},{"l":"Documentos Gerados","v":"3.353","t":"-0.9%","d":"down"},{"l":"Templates","v":"2.190","t":"+12.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.885","2026-03-13","1.602","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.000","2026-03-22","3.406","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.680","2026-03-07","2.317","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.902","2026-02-25","3.756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.121","2026-02-09","3.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":1063},{"label":"Mar","value":893},{"label":"Abr","value":701},{"label":"Mai","value":929},{"label":"Jun","value":908},{"label":"Jul","value":844},{"label":"Ago","value":893},{"label":"Set","value":1051},{"label":"Out","value":923},{"label":"Nov","value":956},{"label":"Dez","value":804}];
const MX = 1063;
