...
const PAGE = "PCI-DSS Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.226","t":"+16.8%","d":"up"},{"l":"NC Abertas","v":"7.511","t":"+17.7%","d":"up"},{"l":"Conformidade (%)","v":"67.9%","t":"-4.1%","d":"down"},{"l":"CAPAs Pendentes","v":"1.517","t":"+8.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.262","95.9%","2.120","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.277","93.7%","2.067","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.992","96.4%","6.391","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.921","76.4%","4.270","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","544","74.9%","7.111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":419},{"label":"Mar","value":568},{"label":"Abr","value":639},{"label":"Mai","value":645},{"label":"Jun","value":790},{"label":"Jul","value":436},{"label":"Ago","value":486},{"label":"Set","value":455},{"label":"Out","value":405},{"label":"Nov","value":537},{"label":"Dez","value":750}];
const MX = 790;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>PCI</span></h1>
                </div>
