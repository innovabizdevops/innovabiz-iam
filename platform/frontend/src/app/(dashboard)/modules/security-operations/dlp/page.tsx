...
const PAGE = "Data Loss Prevention";
const KPIS = [{"l":"Total Security Operations","v":"1.606","t":"+10.8%","d":"up"},{"l":"Data Loss Prevention Ativos","v":"8.450","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+6.1%","d":"up"}];
const COLS = ["ID","Data Loss Prevention","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","2026-01-11","1.799","2.277","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","2026-01-21","8.918","6.394","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","2026-01-13","4.710","3.889","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","2026-03-15","7.964","4.049","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","2026-03-15","2.815","5.459","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":317},{"label":"Mar","value":438},{"label":"Abr","value":528},{"label":"Mai","value":422},{"label":"Jun","value":369},{"label":"Jul","value":351},{"label":"Ago","value":400},{"label":"Set","value":404},{"label":"Out","value":366},{"label":"Nov","value":436},{"label":"Dez","value":310}];
const MX = 630;
