...
const PAGE = "Security Posture";
const KPIS = [{"l":"Pedidos/Dia","v":"878","t":"+4.8%","d":"up"},{"l":"GMV (€)","v":"€8366","t":"+3.3%","d":"up"},{"l":"Conversão (%)","v":"94.7%","t":"+1.5%","d":"up"},{"l":"AOV (€)","v":"€72662","t":"+16.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 31350.08","4.466","2.361","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 47061.29","8.507","5.358","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 27258.28","4.953","6.036","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 8799.27","4.306","4.308","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 263.81","2.914","5.979","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":719},{"label":"Mar","value":632},{"label":"Abr","value":578},{"label":"Mai","value":641},{"label":"Jun","value":398},{"label":"Jul","value":552},{"label":"Ago","value":374},{"label":"Set","value":444},{"label":"Out","value":600},{"label":"Nov","value":503},{"label":"Dez","value":714}];
const MX = 737;
