...
const PAGE = "SOC 2 Readiness";
const KPIS = [{"l":"Total Security Operations","v":"2.108","t":"+8.9%","d":"up"},{"l":"SOC 2 Readiness Ativos","v":"4.899","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"94.5%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"61","t":"+3.7%","d":"up"}];
const COLS = ["ID","SOC 2 Readiness","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","Security Operations #002","8.054","2.564","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","Security Operations #003","1.991","4.984","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","Security Operations #004","5.203","2.810","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","Security Operations #005","8.060","6.064","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","Security Operations #001","5.160","5.547","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":770},{"label":"Mar","value":815},{"label":"Abr","value":637},{"label":"Mai","value":729},{"label":"Jun","value":610},{"label":"Jul","value":773},{"label":"Ago","value":618},{"label":"Set","value":751},{"label":"Out","value":780},{"label":"Nov","value":600},{"label":"Dez","value":474}];
const MX = 815;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>SOC</span></h1>
                </div>
