...
const PAGE = "NIST CSF Framework";
const KPIS = [{"l":"Total Security Operations","v":"5.870","t":"+-0.0%","d":"up"},{"l":"NIST CSF Framework Ativos","v":"4.460","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"77","t":"+12.5%","d":"up"}];
const COLS = ["ID","NIST CSF Framework","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","Security Operations #002","1.134","7.921","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","Security Operations #003","4.905","3.663","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","Security Operations #004","5.445","4.713","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","Security Operations #005","7.058","3.721","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","Security Operations #001","8.891","3.860","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":902},{"label":"Mar","value":679},{"label":"Abr","value":875},{"label":"Mai","value":723},{"label":"Jun","value":655},{"label":"Jul","value":624},{"label":"Ago","value":891},{"label":"Set","value":936},{"label":"Out","value":937},{"label":"Nov","value":911},{"label":"Dez","value":659}];
const MX = 937;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>NIST</span></h1>
                </div>
