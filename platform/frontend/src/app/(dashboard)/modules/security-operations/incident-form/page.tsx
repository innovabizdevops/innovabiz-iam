...
const PAGE = "Incident Response Form";
const KPIS = [{"l":"Tickets Abertos","v":"3.174","t":"+1.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.3%","t":"+10.4%","d":"up"},{"l":"MTTR (h)","v":"83h","t":"-5.2%","d":"down"},{"l":"Satisfação (%)","v":"89.9%","t":"+6.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","143","3.537","3.061","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.287","483","7.563","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.642","8.867","4.688","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.859","5.389","245","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.018","921","5.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":995},{"label":"Fev","value":777},{"label":"Mar","value":911},{"label":"Abr","value":861},{"label":"Mai","value":952},{"label":"Jun","value":650},{"label":"Jul","value":708},{"label":"Ago","value":1000},{"label":"Set","value":859},{"label":"Out","value":926},{"label":"Nov","value":730},{"label":"Dez","value":717}];
const MX = 1000;
