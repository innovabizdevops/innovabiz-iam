...
const PAGE = "XDR";
const KPIS = [{"l":"Total Security Operations","v":"7.992","t":"+7.8%","d":"up"},{"l":"XDR Ativos","v":"2.644","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"82.3%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"69","t":"-2.0%","d":"down"}];
const COLS = ["ID","XDR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","Security Operations #002","4.397","5.023","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","Security Operations #003","2.088","4.743","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","Security Operations #004","1.602","3.125","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","Security Operations #005","8.123","3.427","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","Security Operations #001","8.237","1.773","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":441},{"label":"Mar","value":673},{"label":"Abr","value":418},{"label":"Mai","value":408},{"label":"Jun","value":515},{"label":"Jul","value":623},{"label":"Ago","value":399},{"label":"Set","value":551},{"label":"Out","value":500},{"label":"Nov","value":668},{"label":"Dez","value":500}];
const MX = 673;
