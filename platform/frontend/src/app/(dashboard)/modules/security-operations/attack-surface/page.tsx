...
const ACCENT = "#6366f1";
const MODULE = "Security Operations";
const PAGE = "Attack Surface Mgmt";
const KPIS = [{"l":"Total Security Operations","v":"4.878","t":"+9.0%","d":"up"},{"l":"Attack Surface Mgmt Ativos","v":"4.810","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"72.0%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"87","t":"-2.4%","d":"down"}];
const COLS = ["ID","Attack Surface Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","Security Operations #002","3.730","3.198","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","Security Operations #003","950","4.686","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","Security Operations #004","3.706","7.322","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","Security Operations #005","9.000","7.148","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","Security Operations #001","5.974","2.581","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":718},{"label":"Mar","value":825},{"label":"Abr","value":747},{"label":"Mai","value":796},{"label":"Jun","value":642},{"label":"Jul","value":667},{"label":"Ago","value":614},{"label":"Set","value":990},{"label":"Out","value":990},{"label":"Nov","value":666},{"label":"Dez","value":639}];
const MX = 990;
