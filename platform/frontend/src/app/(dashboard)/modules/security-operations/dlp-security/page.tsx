...
const PAGE = "DLP (Data Loss Prevention)";
const KPIS = [{"l":"Total Security Operations","v":"2.587","t":"+8.6%","d":"up"},{"l":"DLP (Data Loss Prevention) Ativos","v":"6.356","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"87","t":"+1.3%","d":"up"}];
const COLS = ["ID","DLP (Data Loss Prevention)","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","2026-03-17","8.747","1.238","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","2026-01-22","4.190","6.894","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","2026-03-16","223","6.244","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","2026-03-21","4.381","779","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","2026-03-22","6.105","221","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":552},{"label":"Mar","value":550},{"label":"Abr","value":250},{"label":"Mai","value":419},{"label":"Jun","value":322},{"label":"Jul","value":230},{"label":"Ago","value":497},{"label":"Set","value":335},{"label":"Out","value":419},{"label":"Nov","value":264},{"label":"Dez","value":492}];
const MX = 552;
...
export default function DlpSecurityPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>DLP</span></h1>
                </div>
