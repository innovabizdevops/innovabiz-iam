...
const PAGE = "Threat Map";
const KPIS = [{"l":"Total Security Operations","v":"2.596","t":"+3.9%","d":"up"},{"l":"Threat Map Ativos","v":"4.137","t":"+0.0%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"69","t":"+5.7%","d":"up"}];
const COLS = ["ID","Threat Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","Security Operations #002","4.689","5.212","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","Security Operations #003","7.383","162","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","Security Operations #004","3.135","3.462","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","Security Operations #005","4.035","4.945","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","Security Operations #001","231","7.098","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":878},{"label":"Mar","value":789},{"label":"Abr","value":541},{"label":"Mai","value":761},{"label":"Jun","value":620},{"label":"Jul","value":507},{"label":"Ago","value":744},{"label":"Set","value":813},{"label":"Out","value":557},{"label":"Nov","value":736},{"label":"Dez","value":709}];
const MX = 878;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>GIS</span></h1>
                </div>
