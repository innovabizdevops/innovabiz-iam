...
const KPIS = [{"l":"Total Security Operations","v":"5.473","t":"+15.3%","d":"up"},{"l":"Threat Intelligence Ativos","v":"4.394","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"58","t":"-5.4%","d":"down"}];
const COLS = ["ID","Threat Intelligence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Operations #001","Security Operations #002","6.358","1.698","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Security Operations #002","Security Operations #003","5.293","3.822","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Operations #003","Security Operations #004","669","4.049","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Security Operations #004","Security Operations #005","1.128","8.255","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Operations #005","Security Operations #001","776","8.542","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":729},{"label":"Mar","value":841},{"label":"Abr","value":797},{"label":"Mai","value":710},{"label":"Jun","value":817},{"label":"Jul","value":761},{"label":"Ago","value":619},{"label":"Set","value":653},{"label":"Out","value":671},{"label":"Nov","value":928},{"label":"Dez","value":681}];
const MX = 928;
...
export default function ThreatIntelSecurityPage() {
    return (
