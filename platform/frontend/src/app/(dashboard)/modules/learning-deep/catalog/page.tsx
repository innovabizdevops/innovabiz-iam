...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"3.286","t":"-1.7%","d":"down"},{"l":"Queries/Dia","v":"4565","t":"+15.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.430","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"4.642","t":"-4.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2254","2026-01-26","3.403","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3128","2026-01-22","8.438","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3764","2026-01-18","4.237","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2262","2026-01-07","5.459","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4052","2026-03-15","7.472","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":303},{"label":"Fev","value":313},{"label":"Mar","value":599},{"label":"Abr","value":571},{"label":"Mai","value":283},{"label":"Jun","value":319},{"label":"Jul","value":543},{"label":"Ago","value":634},{"label":"Set","value":268},{"label":"Out","value":576},{"label":"Nov","value":461},{"label":"Dez","value":589}];
const MX = 634;
