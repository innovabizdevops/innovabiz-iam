...
/* ═══ Learning & Development Deep — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "9418", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2316", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€153K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "744459618", cells: ["LEA-7618", "Learning & Development Deep Item 1", "15/7/2026", "€9718"], status: "active" as const },
    { id: "744463189", cells: ["LEA-2189", "Learning & Development Deep Item 2", "2/2/2026", "€13 289"], status: "pending" as const },
    { id: "744466760", cells: ["LEA-5760", "Learning & Development Deep Item 3", "17/9/2026", "€16 860"], status: "completed" as const },
    { id: "744470331", cells: ["LEA-9331", "Learning & Development Deep Item 4", "4/4/2026", "€20 431"], status: "warning" as const },
    { id: "744473902", cells: ["LEA-3902", "Learning & Development Deep Item 5", "19/11/2026", "€24 002"], status: "active" as const },
];
...
export default function LearningDevelopmentDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Learning & Development Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Learning & Development Deep</p>
                    </div>
                </div>
