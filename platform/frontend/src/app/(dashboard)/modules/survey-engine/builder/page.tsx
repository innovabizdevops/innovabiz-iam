...
const KPIS = [{"l":"Surveys Ativos","v":"1.322","t":"+4.5%","d":"up"},{"l":"Respostas/Semana","v":"4861","t":"+16.1%","d":"up"},{"l":"NPS Médio","v":"93","t":"+12.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"81.3%","t":"+9.1%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.169","77","71.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.995","79","97.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.143","73","92.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.532","80","86.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.130","61","80.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":380},{"label":"Mar","value":427},{"label":"Abr","value":399},{"label":"Mai","value":544},{"label":"Jun","value":511},{"label":"Jul","value":353},{"label":"Ago","value":363},{"label":"Set","value":745},{"label":"Out","value":471},{"label":"Nov","value":616},{"label":"Dez","value":730}];
const MX = 745;
