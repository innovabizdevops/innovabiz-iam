...
const KPIS = [{"l":"Surveys Ativos","v":"6.433","t":"+2.8%","d":"up"},{"l":"Respostas/Semana","v":"1618","t":"+11.3%","d":"up"},{"l":"NPS Médio","v":"75","t":"+12.4%","d":"up"},{"l":"Taxa Resposta (%)","v":"82.6%","t":"+5.9%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","8.631","68","72.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.394","94","83.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.439","65","86.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.893","75","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.753","62","76.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":406},{"label":"Mar","value":377},{"label":"Abr","value":290},{"label":"Mai","value":331},{"label":"Jun","value":578},{"label":"Jul","value":654},{"label":"Ago","value":381},{"label":"Set","value":429},{"label":"Out","value":369},{"label":"Nov","value":579},{"label":"Dez","value":295}];
const MX = 654;
