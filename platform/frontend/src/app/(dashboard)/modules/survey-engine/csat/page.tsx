...
const PAGE = "CSAT Tracker";
const KPIS = [{"l":"Surveys Ativos","v":"3.868","t":"+16.4%","d":"up"},{"l":"Respostas/Semana","v":"3973","t":"-2.9%","d":"down"},{"l":"NPS Médio","v":"71","t":"+17.0%","d":"up"},{"l":"Taxa Resposta (%)","v":"84.0%","t":"+14.9%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","826","65","91.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.372","85","80.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.288","77","98.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","2.039","67","99.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","7.705","73","75.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":399},{"label":"Mar","value":633},{"label":"Abr","value":592},{"label":"Mai","value":522},{"label":"Jun","value":404},{"label":"Jul","value":436},{"label":"Ago","value":646},{"label":"Set","value":643},{"label":"Out","value":429},{"label":"Nov","value":604},{"label":"Dez","value":316}];
const MX = 646;
