...
const PAGE = "Response Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.219","t":"+9.7%","d":"up"},{"l":"Queries/Dia","v":"4962","t":"+6.3%","d":"up"},{"l":"Dados Processados (GB)","v":"6.495","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.075","t":"+7.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3304","2026-01-02","1.917","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3097","2026-02-20","6.263","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1383","2026-03-17","5.228","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3796","2026-01-02","2.804","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2302","2026-03-10","5.183","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":968},{"label":"Fev","value":759},{"label":"Mar","value":731},{"label":"Abr","value":633},{"label":"Mai","value":648},{"label":"Jun","value":983},{"label":"Jul","value":818},{"label":"Ago","value":614},{"label":"Set","value":823},{"label":"Out","value":743},{"label":"Nov","value":994},{"label":"Dez","value":889}];
const MX = 994;
