...
const PAGE = "Branching Logic";
const KPIS = [{"l":"Surveys Ativos","v":"7.378","t":"+12.6%","d":"up"},{"l":"Respostas/Semana","v":"1277","t":"-3.6%","d":"down"},{"l":"NPS Médio","v":"60","t":"-3.2%","d":"down"},{"l":"Taxa Resposta (%)","v":"74.8%","t":"+0.2%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.555","94","75.1%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.818","62","90.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.527","67","96.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.016","89","71.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.460","81","70.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":769},{"label":"Mar","value":476},{"label":"Abr","value":817},{"label":"Mai","value":456},{"label":"Jun","value":450},{"label":"Jul","value":733},{"label":"Ago","value":559},{"label":"Set","value":490},{"label":"Out","value":577},{"label":"Nov","value":758},{"label":"Dez","value":505}];
const MX = 817;
