...
const ACCENT = "#0e7490";
const MODULE = "Survey Engine";
const PAGE = "Sentiment AI";
const KPIS = [{"l":"Dashboards Ativos","v":"3.188","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"1789","t":"+16.3%","d":"up"},{"l":"Dados Processados (GB)","v":"167","t":"+11.7%","d":"up"},{"l":"Utilizadores Analytics","v":"3.589","t":"-2.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3008","2026-01-17","6.411","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2151","2026-02-18","1.839","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2407","2026-02-10","4.282","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4429","2026-02-08","8.983","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2918","2026-02-02","2.976","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":672},{"label":"Mar","value":456},{"label":"Abr","value":574},{"label":"Mai","value":541},{"label":"Jun","value":754},{"label":"Jul","value":435},{"label":"Ago","value":673},{"label":"Set","value":522},{"label":"Out","value":739},{"label":"Nov","value":640},{"label":"Dez","value":620}];
const MX = 754;
