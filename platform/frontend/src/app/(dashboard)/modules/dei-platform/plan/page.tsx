...
const PAGE = "Plan";
const KPIS = [{"l":"Formulários Ativos","v":"1.504","t":"+6.5%","d":"up"},{"l":"Submissões/Dia","v":"3040","t":"+3.1%","d":"up"},{"l":"Documentos Gerados","v":"185","t":"+11.8%","d":"up"},{"l":"Templates","v":"5.908","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.649","2026-01-21","3.916","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.740","2026-03-09","4.828","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","353","2026-03-27","620","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.175","2026-02-25","3.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.067","2026-01-21","4.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":776},{"label":"Mar","value":849},{"label":"Abr","value":817},{"label":"Mai","value":738},{"label":"Jun","value":473},{"label":"Jul","value":525},{"label":"Ago","value":718},{"label":"Set","value":482},{"label":"Out","value":710},{"label":"Nov","value":682},{"label":"Dez","value":510}];
const MX = 849;
