...
const PAGE = "Measure";
const KPIS = [{"l":"Formulários Ativos","v":"6.091","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"630","t":"-2.4%","d":"down"},{"l":"Documentos Gerados","v":"3.768","t":"+16.5%","d":"up"},{"l":"Templates","v":"2.951","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.548","2026-01-20","6.862","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.020","2026-01-26","7.057","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.638","2026-03-03","4.388","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.082","2026-02-04","3.999","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.450","2026-02-17","6.359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":671},{"label":"Mar","value":914},{"label":"Abr","value":958},{"label":"Mai","value":910},{"label":"Jun","value":690},{"label":"Jul","value":780},{"label":"Ago","value":1034},{"label":"Set","value":914},{"label":"Out","value":717},{"label":"Nov","value":894},{"label":"Dez","value":833}];
const MX = 1034;
