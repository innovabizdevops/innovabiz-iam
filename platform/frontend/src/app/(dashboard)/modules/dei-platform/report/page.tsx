...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"7.052","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"1573","t":"+11.7%","d":"up"},{"l":"Documentos Gerados","v":"8.917","t":"+11.6%","d":"up"},{"l":"Templates","v":"1.533","t":"+4.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.857","2026-01-13","7.289","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.252","2026-01-16","6.065","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.144","2026-01-28","305","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.888","2026-01-09","5.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.096","2026-03-18","1.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":272},{"label":"Fev","value":469},{"label":"Mar","value":350},{"label":"Abr","value":257},{"label":"Mai","value":589},{"label":"Jun","value":518},{"label":"Jul","value":561},{"label":"Ago","value":436},{"label":"Set","value":418},{"label":"Out","value":375},{"label":"Nov","value":543},{"label":"Dez","value":453}];
const MX = 589;
