...
const ACCENT = "#166534";
const MODULE = "DEI Platform Deep";
const PAGE = "Analyze";
const KPIS = [{"l":"Formulários Ativos","v":"4.361","t":"-3.6%","d":"down"},{"l":"Submissões/Dia","v":"4122","t":"+16.5%","d":"up"},{"l":"Documentos Gerados","v":"2.491","t":"+6.8%","d":"up"},{"l":"Templates","v":"7.261","t":"+5.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.407","2026-02-01","6.958","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.772","2026-02-26","5.240","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.733","2026-03-07","7.567","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.634","2026-01-26","8.892","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.226","2026-02-17","3.713","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":295},{"label":"Mar","value":618},{"label":"Abr","value":617},{"label":"Mai","value":258},{"label":"Jun","value":342},{"label":"Jul","value":404},{"label":"Ago","value":415},{"label":"Set","value":355},{"label":"Out","value":342},{"label":"Nov","value":389},{"label":"Dez","value":537}];
const MX = 618;
