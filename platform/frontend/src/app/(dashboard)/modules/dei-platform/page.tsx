...
/* ═══ DEI Platform Deep — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "5919", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "511", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€116K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1235713919", cells: ["DEI-5919", "DEI Platform Deep Item 1", "28/12/2026", "€14 019"], status: "active" as const },
    { id: "1235717490", cells: ["DEI-9490", "DEI Platform Deep Item 2", "15/7/2026", "€17 590"], status: "pending" as const },
    { id: "1235721061", cells: ["DEI-4061", "DEI Platform Deep Item 3", "2/2/2026", "€21 161"], status: "completed" as const },
    { id: "1235724632", cells: ["DEI-7632", "DEI Platform Deep Item 4", "17/9/2026", "€24 732"], status: "warning" as const },
    { id: "1235728203", cells: ["DEI-2203", "DEI Platform Deep Item 5", "4/4/2026", "€28 303"], status: "active" as const },
];
...
export default function DeiPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">DEI Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • DEI Platform Deep</p>
                    </div>
                </div>
