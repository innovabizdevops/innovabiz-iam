...
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"8.038","t":"+11.9%","d":"up"},{"l":"Submissões/Dia","v":"2274","t":"+12.0%","d":"up"},{"l":"Documentos Gerados","v":"5.272","t":"+6.8%","d":"up"},{"l":"Templates","v":"4.692","t":"+13.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.580","2026-01-13","5.750","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.913","2026-02-07","2.513","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.015","2026-01-21","851","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.071","2026-03-03","3.396","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.677","2026-01-18","2.531","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":1008},{"label":"Mar","value":893},{"label":"Abr","value":794},{"label":"Mai","value":665},{"label":"Jun","value":835},{"label":"Jul","value":855},{"label":"Ago","value":707},{"label":"Set","value":787},{"label":"Out","value":836},{"label":"Nov","value":759},{"label":"Dez","value":961}];
const MX = 1008;
