...
const PAGE = "Lab";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.423","t":"+14.8%","d":"up"},{"l":"NC Abertas","v":"6.214","t":"-3.4%","d":"down"},{"l":"Conformidade (%)","v":"74.3%","t":"+8.6%","d":"up"},{"l":"CAPAs Pendentes","v":"476","t":"-2.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.222","86.7%","3.222","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.711","83.4%","9.072","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.611","87.8%","5.771","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.014","89.1%","6.120","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","764","75.0%","8.587","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":708},{"label":"Mar","value":827},{"label":"Abr","value":862},{"label":"Mai","value":725},{"label":"Jun","value":652},{"label":"Jul","value":822},{"label":"Ago","value":983},{"label":"Set","value":1015},{"label":"Out","value":856},{"label":"Nov","value":856},{"label":"Dez","value":691}];
const MX = 1015;
