...
const PAGE = "Sample";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.152","t":"-2.2%","d":"down"},{"l":"NC Abertas","v":"6.660","t":"-5.8%","d":"down"},{"l":"Conformidade (%)","v":"82.1%","t":"+3.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.701","t":"+15.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.855","96.9%","891","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.420","90.9%","6.918","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.903","82.4%","5.698","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.030","92.8%","747","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.277","94.5%","5.879","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":533},{"label":"Mar","value":652},{"label":"Abr","value":377},{"label":"Mai","value":506},{"label":"Jun","value":541},{"label":"Jul","value":464},{"label":"Ago","value":350},{"label":"Set","value":410},{"label":"Out","value":518},{"label":"Nov","value":538},{"label":"Dez","value":370}];
const MX = 652;
