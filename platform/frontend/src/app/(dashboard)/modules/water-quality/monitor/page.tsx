...
const ACCENT = "#6366f1";
const MODULE = "Water Quality";
const PAGE = "Monitor";
const KPIS = [{"l":"Auditorias Realizadas","v":"832","t":"+10.3%","d":"up"},{"l":"NC Abertas","v":"8.636","t":"+17.7%","d":"up"},{"l":"Conformidade (%)","v":"71.0%","t":"-1.2%","d":"down"},{"l":"CAPAs Pendentes","v":"8.595","t":"-5.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.945","97.1%","6.448","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.247","95.6%","704","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.317","84.5%","7.243","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.170","71.2%","3.485","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.682","98.4%","6.957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":598},{"label":"Mar","value":672},{"label":"Abr","value":763},{"label":"Mai","value":817},{"label":"Jun","value":642},{"label":"Jul","value":780},{"label":"Ago","value":641},{"label":"Set","value":762},{"label":"Out","value":569},{"label":"Nov","value":783},{"label":"Dez","value":536}];
const MX = 829;
