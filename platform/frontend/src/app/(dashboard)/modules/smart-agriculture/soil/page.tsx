...
const PAGE = "Soil IoT";
const KPIS = [{"l":"Dispositivos Online","v":"6.908","t":"+13.7%","d":"up"},{"l":"Dados/Min (MB)","v":"944","t":"-1.8%","d":"down"},{"l":"Alertas Ativos","v":"148","t":"+0.0%","d":"up"},{"l":"Uptime (%)","v":"87.4%","t":"+2.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.416","2.401","2.588","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.966","8.076","1.012","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.676","5.582","5.035","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","864","2.756","4.873","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.459","586","9.059","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":777},{"label":"Mar","value":892},{"label":"Abr","value":1042},{"label":"Mai","value":826},{"label":"Jun","value":814},{"label":"Jul","value":1062},{"label":"Ago","value":735},{"label":"Set","value":804},{"label":"Out","value":826},{"label":"Nov","value":996},{"label":"Dez","value":867}];
const MX = 1062;
