...
const ACCENT = "#475569";
const MODULE = "Land Rights";
const PAGE = "Community Land";
const KPIS = [{"l":"Projetos Sociais","v":"6.803","t":"+14.3%","d":"up"},{"l":"Beneficiários","v":"707","t":"+15.3%","d":"up"},{"l":"Investimento CSR (€)","v":"€61757","t":"+5.9%","d":"up"},{"l":"Score Impacto","v":"82","t":"+3.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.750","€ 35498.59","2.645","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.676","€ 49827.01","4.109","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","887","€ 40474.44","3.221","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","821","€ 27301.59","3.818","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.917","€ 39660.00","3.095","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":987},{"label":"Mar","value":722},{"label":"Abr","value":679},{"label":"Mai","value":772},{"label":"Jun","value":923},{"label":"Jul","value":690},{"label":"Ago","value":691},{"label":"Set","value":905},{"label":"Out","value":961},{"label":"Nov","value":884},{"label":"Dez","value":851}];
const MX = 987;
