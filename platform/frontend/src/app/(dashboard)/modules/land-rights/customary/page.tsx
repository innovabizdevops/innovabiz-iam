...
const PAGE = "Customary Law";
const KPIS = [{"l":"Total Land Rights","v":"2.837","t":"+14.3%","d":"up"},{"l":"Customary Law Ativos","v":"€1247","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+7.7%","d":"up"}];
const COLS = ["ID","Customary Law","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Land Rights #001","€ 29448.92","1.713","647","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Land Rights #002","€ 43439.50","521","6.718","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Land Rights #003","€ 19380.68","1.299","315","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Land Rights #004","€ 12241.04","4.673","742","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Land Rights #005","€ 48398.13","2.522","8.391","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":815},{"label":"Mar","value":698},{"label":"Abr","value":920},{"label":"Mai","value":908},{"label":"Jun","value":1000},{"label":"Jul","value":764},{"label":"Ago","value":684},{"label":"Set","value":742},{"label":"Out","value":694},{"label":"Nov","value":891},{"label":"Dez","value":1039}];
const MX = 1039;
