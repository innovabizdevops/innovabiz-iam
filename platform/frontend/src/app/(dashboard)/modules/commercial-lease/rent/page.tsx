...
const ACCENT = "#6366f1";
const MODULE = "Commercial Leasing";
const PAGE = "Rent Roll";
const KPIS = [{"l":"Total Commercial Lease","v":"8.540","t":"+3.2%","d":"up"},{"l":"Rent Roll Ativos","v":"2.008","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"57","t":"-5.1%","d":"down"}];
const COLS = ["ID","Rent Roll","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Commercial Lease #001","Commercial Lease #002","5.372","5.391","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Commercial Lease #002","Commercial Lease #003","8.302","8.165","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Commercial Lease #003","Commercial Lease #004","7.532","2.117","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Commercial Lease #004","Commercial Lease #005","8.153","2.397","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Commercial Lease #005","Commercial Lease #001","2.002","8.625","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":374},{"label":"Mar","value":565},{"label":"Abr","value":297},{"label":"Mai","value":392},{"label":"Jun","value":403},{"label":"Jul","value":605},{"label":"Ago","value":404},{"label":"Set","value":537},{"label":"Out","value":600},{"label":"Nov","value":283},{"label":"Dez","value":440}];
const MX = 605;
