...
const PAGE = "Tenant";
const KPIS = [{"l":"Configurações","v":"1.981","t":"+4.8%","d":"up"},{"l":"Últimas Alterações","v":"2.709","t":"+17.3%","d":"up"},{"l":"Ambientes","v":"4.873","t":"+4.3%","d":"up"},{"l":"Versão Config","v":"871","t":"+4.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 45838.19","2.924","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 16998.00","8.257","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 36973.32","4.923","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 39662.10","8.141","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 30095.18","2.672","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":490},{"label":"Mar","value":600},{"label":"Abr","value":642},{"label":"Mai","value":443},{"label":"Jun","value":565},{"label":"Jul","value":578},{"label":"Ago","value":622},{"label":"Set","value":753},{"label":"Out","value":699},{"label":"Nov","value":688},{"label":"Dez","value":544}];
const MX = 753;
