...
const KPIS = [{"l":"Total Commercial Lease","v":"7.738","t":"+9.2%","d":"up"},{"l":"Portfolio Ativos","v":"3.344","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"66.4%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"68","t":"+10.8%","d":"up"}];
const COLS = ["ID","Portfolio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Commercial Lease #001","Commercial Lease #002","3.543","4.165","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Commercial Lease #002","Commercial Lease #003","6.582","7.351","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Commercial Lease #003","Commercial Lease #004","3.049","2.790","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Commercial Lease #004","Commercial Lease #005","7.513","4.734","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Commercial Lease #005","Commercial Lease #001","1.303","1.055","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":306},{"label":"Mar","value":302},{"label":"Abr","value":612},{"label":"Mai","value":612},{"label":"Jun","value":437},{"label":"Jul","value":533},{"label":"Ago","value":549},{"label":"Set","value":474},{"label":"Out","value":265},{"label":"Nov","value":335},{"label":"Dez","value":434}];
const MX = 612;
