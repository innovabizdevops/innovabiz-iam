...
const PAGE = "Lease Admin";
const KPIS = [{"l":"Total Commercial Lease","v":"2.725","t":"+12.0%","d":"up"},{"l":"Lease Admin Ativos","v":"8.834","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+10.0%","d":"up"}];
const COLS = ["ID","Lease Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Commercial Lease #001","Commercial Lease #002","5.595","9.089","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Commercial Lease #002","Commercial Lease #003","5.895","8.855","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Commercial Lease #003","Commercial Lease #004","6.865","2.410","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Commercial Lease #004","Commercial Lease #005","5.007","3.811","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Commercial Lease #005","Commercial Lease #001","1.414","2.043","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":552},{"label":"Mar","value":628},{"label":"Abr","value":755},{"label":"Mai","value":725},{"label":"Jun","value":736},{"label":"Jul","value":843},{"label":"Ago","value":857},{"label":"Set","value":583},{"label":"Out","value":714},{"label":"Nov","value":691},{"label":"Dez","value":751}];
const MX = 857;
