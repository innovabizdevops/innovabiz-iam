...
const KPIS = [{"l":"Formulários Ativos","v":"7.475","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"1609","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"389","t":"+3.0%","d":"up"},{"l":"Templates","v":"106","t":"+14.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.175","2026-03-18","3.588","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.160","2026-02-18","6.393","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.283","2026-02-08","7.261","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.620","2026-02-07","2.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.713","2026-01-02","1.954","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":325},{"label":"Fev","value":476},{"label":"Mar","value":404},{"label":"Abr","value":519},{"label":"Mai","value":293},{"label":"Jun","value":406},{"label":"Jul","value":452},{"label":"Ago","value":593},{"label":"Set","value":392},{"label":"Out","value":337},{"label":"Nov","value":676},{"label":"Dez","value":489}];
const MX = 676;
