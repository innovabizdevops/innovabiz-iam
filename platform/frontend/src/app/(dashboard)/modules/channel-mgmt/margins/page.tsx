...
const KPIS = [{"l":"ARR (€M)","v":"€4.1M","t":"-3.5%","d":"down"},{"l":"MRR (€)","v":"€67601","t":"+1.3%","d":"up"},{"l":"Churn (%)","v":"70.4%","t":"+5.7%","d":"up"},{"l":"ARPU (€)","v":"€36119","t":"+1.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 38676.05","4.082","€ 20443.58","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 46718.50","1.716","€ 8728.61","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18030.45","4.225","€ 7806.05","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 21772.07","3.761","€ 5094.50","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40832.01","4.984","€ 35897.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":945},{"label":"Mar","value":694},{"label":"Abr","value":589},{"label":"Mai","value":833},{"label":"Jun","value":637},{"label":"Jul","value":694},{"label":"Ago","value":798},{"label":"Set","value":845},{"label":"Out","value":650},{"label":"Nov","value":741},{"label":"Dez","value":743}];
const MX = 945;
