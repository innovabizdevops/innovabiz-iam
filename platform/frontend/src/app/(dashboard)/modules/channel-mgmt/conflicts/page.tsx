...
const ACCENT = "#4338ca";
const MODULE = "Channel Management";
const PAGE = "Conflict Rules";
const KPIS = [{"l":"Total Channel Mgmt","v":"901","t":"+7.9%","d":"up"},{"l":"Conflict Rules Ativos","v":"1.884","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"76","t":"+8.9%","d":"up"}];
const COLS = ["ID","Conflict Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Mgmt #001","Channel Mgmt #002","4.996","5.364","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Mgmt #002","Channel Mgmt #003","5.113","1.230","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Mgmt #003","Channel Mgmt #004","1.871","2.323","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Mgmt #004","Channel Mgmt #005","7.163","939","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Mgmt #005","Channel Mgmt #001","5.791","7.362","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":467},{"label":"Mar","value":435},{"label":"Abr","value":509},{"label":"Mai","value":430},{"label":"Jun","value":664},{"label":"Jul","value":634},{"label":"Ago","value":503},{"label":"Set","value":505},{"label":"Out","value":492},{"label":"Nov","value":519},{"label":"Dez","value":613}];
const MX = 664;
