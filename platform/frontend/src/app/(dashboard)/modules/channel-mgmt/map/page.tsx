...
const PAGE = "Channel Map";
const KPIS = [{"l":"Total Channel Mgmt","v":"7.303","t":"+9.7%","d":"up"},{"l":"Channel Map Ativos","v":"3.595","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"87","t":"-2.9%","d":"down"}];
const COLS = ["ID","Channel Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Mgmt #001","Channel Mgmt #002","5.617","4.623","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Mgmt #002","Channel Mgmt #003","886","6.830","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Mgmt #003","Channel Mgmt #004","3.123","2.225","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Mgmt #004","Channel Mgmt #005","7.430","7.495","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Mgmt #005","Channel Mgmt #001","5.311","3.118","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":520},{"label":"Mar","value":201},{"label":"Abr","value":287},{"label":"Mai","value":389},{"label":"Jun","value":437},{"label":"Jul","value":289},{"label":"Ago","value":550},{"label":"Set","value":407},{"label":"Out","value":544},{"label":"Nov","value":314},{"label":"Dez","value":514}];
const MX = 550;
