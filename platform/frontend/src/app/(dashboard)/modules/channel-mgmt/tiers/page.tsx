...
const PAGE = "Tier Program";
const KPIS = [{"l":"ARR (€M)","v":"€29.1M","t":"+11.0%","d":"up"},{"l":"MRR (€)","v":"€69664","t":"+2.1%","d":"up"},{"l":"Churn (%)","v":"76.8%","t":"+0.7%","d":"up"},{"l":"ARPU (€)","v":"€62105","t":"+3.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2911.23","3.615","€ 40577.58","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 16957.15","3.741","€ 48293.87","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2842.78","2.637","€ 14474.58","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42168.42","6.833","€ 40227.50","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39337.61","915","€ 17950.43","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":808},{"label":"Mar","value":829},{"label":"Abr","value":687},{"label":"Mai","value":926},{"label":"Jun","value":946},{"label":"Jul","value":984},{"label":"Ago","value":801},{"label":"Set","value":701},{"label":"Out","value":730},{"label":"Nov","value":989},{"label":"Dez","value":778}];
const MX = 989;
