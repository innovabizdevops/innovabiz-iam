...
const PAGE = "Resource Capacity";
const KPIS = [{"l":"Auditorias Realizadas","v":"668","t":"-3.3%","d":"down"},{"l":"NC Abertas","v":"2.126","t":"-3.3%","d":"down"},{"l":"Conformidade (%)","v":"88.9%","t":"+10.9%","d":"up"},{"l":"CAPAs Pendentes","v":"4.815","t":"+0.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.853","81.5%","3.667","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.830","75.7%","6.925","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.291","98.6%","362","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.483","87.3%","8.958","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.748","99.3%","5.350","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":668},{"label":"Mar","value":556},{"label":"Abr","value":800},{"label":"Mai","value":902},{"label":"Jun","value":834},{"label":"Jul","value":843},{"label":"Ago","value":781},{"label":"Set","value":908},{"label":"Out","value":855},{"label":"Nov","value":532},{"label":"Dez","value":910}];
const MX = 910;
