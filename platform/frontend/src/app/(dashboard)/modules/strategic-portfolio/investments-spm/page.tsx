...
const PAGE = "Investment Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"6.183","t":"+10.4%","d":"up"},{"l":"Queries/Dia","v":"801","t":"+14.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.091","t":"+10.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.595","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2653","2026-02-25","2.641","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1724","2026-01-14","8.573","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2124","2026-02-16","7.257","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3960","2026-02-21","4.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2656","2026-01-04","2.311","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":494},{"label":"Mar","value":528},{"label":"Abr","value":509},{"label":"Mai","value":842},{"label":"Jun","value":590},{"label":"Jul","value":673},{"label":"Ago","value":515},{"label":"Set","value":742},{"label":"Out","value":602},{"label":"Nov","value":564},{"label":"Dez","value":873}];
const MX = 873;
...
export default function InvestmentsSpmPage() {
    return (
