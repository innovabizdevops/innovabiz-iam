...
const ACCENT = "#6366f1";
const MODULE = "Strategic Portfolio";
const PAGE = "MoP Portfolio Mgmt";
const KPIS = [{"l":"Total Strategic Portfolio","v":"653","t":"+4.4%","d":"up"},{"l":"MoP Portfolio Mgmt Ativos","v":"4.083","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"73.1%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+10.9%","d":"up"}];
const COLS = ["ID","MoP Portfolio Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategic Portfolio #001","Strategic Portfolio #002","2.208","3.602","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Strategic Portfolio #002","Strategic Portfolio #003","2.733","5.903","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategic Portfolio #003","Strategic Portfolio #004","6.171","4.126","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Strategic Portfolio #004","Strategic Portfolio #005","6.346","4.717","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategic Portfolio #005","Strategic Portfolio #001","1.161","8.848","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":619},{"label":"Mar","value":375},{"label":"Abr","value":323},{"label":"Mai","value":489},{"label":"Jun","value":653},{"label":"Jul","value":425},{"label":"Ago","value":487},{"label":"Set","value":460},{"label":"Out","value":454},{"label":"Nov","value":617},{"label":"Dez","value":363}];
const MX = 653;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>MoP</span></h1>
                </div>
