...
const PAGE = "Programs &amp; Epics";
const KPIS = [{"l":"Total Strategic Portfolio","v":"2.836","t":"+4.5%","d":"up"},{"l":"Programs & Epics Ativos","v":"3.437","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+0.2%","d":"up"}];
const COLS = ["ID","Programs & Epics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategic Portfolio #001","Strategic Portfolio #002","7.642","2.679","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Strategic Portfolio #002","Strategic Portfolio #003","2.835","2.936","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategic Portfolio #003","Strategic Portfolio #004","133","1.599","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Strategic Portfolio #004","Strategic Portfolio #005","3.133","9.058","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategic Portfolio #005","Strategic Portfolio #001","7.629","4.040","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":778},{"label":"Mar","value":541},{"label":"Abr","value":464},{"label":"Mai","value":569},{"label":"Jun","value":811},{"label":"Jul","value":581},{"label":"Ago","value":754},{"label":"Set","value":509},{"label":"Out","value":476},{"label":"Nov","value":783},{"label":"Dez","value":532}];
const MX = 811;
...
export default function ProgramsSpmPage() {
    return (
