...
export default function StrategicPortfolioPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Strategic Portfolio</h1><p className="text-sm text-muted-foreground">Strategic Portfolio • iBOS Enterprise</p></div>
