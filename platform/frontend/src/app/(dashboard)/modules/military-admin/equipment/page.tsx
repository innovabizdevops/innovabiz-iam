...
const KPIS = [{"l":"Total Military Admin","v":"5.355","t":"-3.0%","d":"down"},{"l":"Equipment Ativos","v":"1.509","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"91.5%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"57","t":"+10.1%","d":"up"}];
const COLS = ["ID","Equipment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Military Admin #001","Military Admin #002","6.079","3.329","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Military Admin #002","Military Admin #003","1.390","3.478","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Military Admin #003","Military Admin #004","6.593","8.917","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Military Admin #004","Military Admin #005","2.004","4.516","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Military Admin #005","Military Admin #001","234","8.444","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":472},{"label":"Mar","value":406},{"label":"Abr","value":391},{"label":"Mai","value":396},{"label":"Jun","value":394},{"label":"Jul","value":297},{"label":"Ago","value":370},{"label":"Set","value":329},{"label":"Out","value":463},{"label":"Nov","value":388},{"label":"Dez","value":350}];
const MX = 472;
