...
const KPIS = [{"l":"Total Military Admin","v":"1.381","t":"-2.9%","d":"down"},{"l":"Logistics Ativos","v":"5.018","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+9.2%","d":"up"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Military Admin #001","Military Admin #002","2.225","3.425","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Military Admin #002","Military Admin #003","8.974","6.880","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Military Admin #003","Military Admin #004","8.346","1.210","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Military Admin #004","Military Admin #005","5.679","3.279","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Military Admin #005","Military Admin #001","3.388","7.346","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":643},{"label":"Mar","value":506},{"label":"Abr","value":493},{"label":"Mai","value":645},{"label":"Jun","value":407},{"label":"Jul","value":633},{"label":"Ago","value":557},{"label":"Set","value":630},{"label":"Out","value":400},{"label":"Nov","value":444},{"label":"Dez","value":658}];
const MX = 658;
