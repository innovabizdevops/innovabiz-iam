...
const ACCENT = "#93c5fd";
const MODULE = "Military Administration";
const PAGE = "Personnel";
const KPIS = [{"l":"Total Military Admin","v":"1.529","t":"-2.8%","d":"down"},{"l":"Personnel Ativos","v":"6.062","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"92","t":"-0.7%","d":"down"}];
const COLS = ["ID","Personnel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Military Admin #001","Military Admin #002","6.008","5.134","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Military Admin #002","Military Admin #003","1.425","2.039","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Military Admin #003","Military Admin #004","6.390","6.599","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Military Admin #004","Military Admin #005","5.545","8.911","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Military Admin #005","Military Admin #001","3.296","1.685","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":784},{"label":"Mar","value":788},{"label":"Abr","value":522},{"label":"Mai","value":579},{"label":"Jun","value":464},{"label":"Jul","value":785},{"label":"Ago","value":701},{"label":"Set","value":591},{"label":"Out","value":771},{"label":"Nov","value":758},{"label":"Dez","value":565}];
const MX = 788;
