...
const ACCENT = "#06b6d4";
const MODULE = "Task Automation Hub";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Task Automation","v":"462","t":"-2.1%","d":"down"},{"l":"Monitor Ativos","v":"4.415","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"66","t":"+5.4%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Task Automation #001","Task Automation #002","4.661","2.024","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Task Automation #002","Task Automation #003","7.393","5.727","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Task Automation #003","Task Automation #004","2.992","8.089","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Task Automation #004","Task Automation #005","5.676","7.727","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Task Automation #005","Task Automation #001","2.745","8.118","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":601},{"label":"Mar","value":688},{"label":"Abr","value":473},{"label":"Mai","value":419},{"label":"Jun","value":774},{"label":"Jul","value":729},{"label":"Ago","value":774},{"label":"Set","value":536},{"label":"Out","value":467},{"label":"Nov","value":411},{"label":"Dez","value":471}];
const MX = 774;
