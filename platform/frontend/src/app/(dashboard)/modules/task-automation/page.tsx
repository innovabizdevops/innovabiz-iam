...
/* ═══ Task Automation Hub — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "7810", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2252", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€301K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1272326010", cells: ["TAS-6010", "Task Automation Hub Item 1", "19/7/2026", "€26 110"], status: "active" as const },
    { id: "1272329581", cells: ["TAS-9581", "Task Automation Hub Item 2", "6/2/2026", "€29 681"], status: "pending" as const },
    { id: "1272333152", cells: ["TAS-4152", "Task Automation Hub Item 3", "21/9/2026", "€33 252"], status: "completed" as const },
    { id: "1272336723", cells: ["TAS-7723", "Task Automation Hub Item 4", "8/4/2026", "€36 823"], status: "warning" as const },
    { id: "1272340294", cells: ["TAS-2294", "Task Automation Hub Item 5", "23/11/2026", "€40 394"], status: "active" as const },
];
...
export default function TaskAutomationHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Task Automation Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Task Automation Hub</p>
                    </div>
                </div>
