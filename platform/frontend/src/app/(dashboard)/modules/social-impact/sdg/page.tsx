...
const PAGE = "SDG Tracking";
const KPIS = [{"l":"Projetos Sociais","v":"8.317","t":"+11.4%","d":"up"},{"l":"Beneficiários","v":"6.399","t":"-2.3%","d":"down"},{"l":"Investimento CSR (€)","v":"€19344","t":"+5.4%","d":"up"},{"l":"Score Impacto","v":"85","t":"+3.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.741","€ 7342.49","1.158","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.293","€ 20587.34","6.436","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.502","€ 15285.97","7.923","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.966","€ 3845.52","363","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.304","€ 24692.66","8.797","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":723},{"label":"Mar","value":525},{"label":"Abr","value":547},{"label":"Mai","value":709},{"label":"Jun","value":594},{"label":"Jul","value":397},{"label":"Ago","value":683},{"label":"Set","value":426},{"label":"Out","value":683},{"label":"Nov","value":685},{"label":"Dez","value":718}];
const MX = 723;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>UN</span></h1>
                </div>
