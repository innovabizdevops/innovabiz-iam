...
const PAGE = "Community Projects";
const KPIS = [{"l":"Projetos Sociais","v":"7.341","t":"-4.9%","d":"down"},{"l":"Beneficiários","v":"7.874","t":"+4.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€19041","t":"+1.1%","d":"up"},{"l":"Score Impacto","v":"70","t":"+3.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","167","€ 5813.75","4.498","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.128","€ 45477.76","1.610","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.955","€ 21152.42","5.539","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.281","€ 38956.27","310","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.439","€ 6217.29","2.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":538},{"label":"Mar","value":663},{"label":"Abr","value":603},{"label":"Mai","value":649},{"label":"Jun","value":828},{"label":"Jul","value":624},{"label":"Ago","value":710},{"label":"Set","value":646},{"label":"Out","value":819},{"label":"Nov","value":734},{"label":"Dez","value":470}];
const MX = 828;
