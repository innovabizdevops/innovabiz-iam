...
const PAGE = "Impact Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"6.888","t":"+10.2%","d":"up"},{"l":"Reuniões/Semana","v":"591","t":"+12.7%","d":"up"},{"l":"Mensagens/Dia","v":"2534","t":"+1.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.114","t":"-4.7%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.530","3897","6.800","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.924","3981","456","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.264","4711","1.629","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.083","4209","1.297","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.855","4138","4.949","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":616},{"label":"Mar","value":927},{"label":"Abr","value":686},{"label":"Mai","value":864},{"label":"Jun","value":924},{"label":"Jul","value":875},{"label":"Ago","value":870},{"label":"Set","value":986},{"label":"Out","value":772},{"label":"Nov","value":770},{"label":"Dez","value":748}];
const MX = 986;
