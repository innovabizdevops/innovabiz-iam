...
const PAGE = "Impact Investing";
const KPIS = [{"l":"Projetos Sociais","v":"7.750","t":"+6.1%","d":"up"},{"l":"Beneficiários","v":"4.715","t":"+10.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€62805","t":"-2.9%","d":"down"},{"l":"Score Impacto","v":"69","t":"-4.3%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","922","€ 23019.25","4.994","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.459","€ 860.67","9.084","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.120","€ 819.54","2.686","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.702","€ 38675.23","2.423","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.361","€ 18649.97","5.906","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":315},{"label":"Fev","value":475},{"label":"Mar","value":602},{"label":"Abr","value":362},{"label":"Mai","value":421},{"label":"Jun","value":685},{"label":"Jul","value":465},{"label":"Ago","value":378},{"label":"Set","value":488},{"label":"Out","value":338},{"label":"Nov","value":323},{"label":"Dez","value":563}];
const MX = 685;
