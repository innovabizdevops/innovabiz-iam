...
const ACCENT = "#15803d";
const MODULE = "Social Impact & ESG";
const PAGE = "ESG Reporting";
const KPIS = [{"l":"Projetos Sociais","v":"2.458","t":"-3.7%","d":"down"},{"l":"Beneficiários","v":"2.272","t":"+4.5%","d":"up"},{"l":"Investimento CSR (€)","v":"€73034","t":"+9.1%","d":"up"},{"l":"Score Impacto","v":"80","t":"+10.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.856","€ 25050.56","6.983","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.199","€ 24050.93","4.517","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.176","€ 43305.01","3.891","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.456","€ 48494.61","994","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.940","€ 8125.55","6.442","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":757},{"label":"Mar","value":602},{"label":"Abr","value":917},{"label":"Mai","value":671},{"label":"Jun","value":587},{"label":"Jul","value":748},{"label":"Ago","value":766},{"label":"Set","value":759},{"label":"Out","value":653},{"label":"Nov","value":610},{"label":"Dez","value":717}];
const MX = 917;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>CSRD</span></h1>
                </div>
