...
const PAGE = "B-Corp Assessment";
const KPIS = [{"l":"Projetos Sociais","v":"7.451","t":"+4.3%","d":"up"},{"l":"Beneficiários","v":"520","t":"+12.6%","d":"up"},{"l":"Investimento CSR (€)","v":"€36422","t":"-5.0%","d":"down"},{"l":"Score Impacto","v":"66","t":"+6.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.121","€ 22123.44","8.917","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.132","€ 32767.64","6.995","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.860","€ 8645.08","6.294","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","389","€ 47907.84","8.438","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.943","€ 34510.41","8.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":776},{"label":"Mar","value":776},{"label":"Abr","value":662},{"label":"Mai","value":764},{"label":"Jun","value":689},{"label":"Jul","value":673},{"label":"Ago","value":480},{"label":"Set","value":791},{"label":"Out","value":646},{"label":"Nov","value":535},{"label":"Dez","value":455}];
const MX = 807;
