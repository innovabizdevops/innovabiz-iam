...
const PAGE = "Stakeholder Engagement";
const KPIS = [{"l":"eNPS","v":"71","t":"-5.3%","d":"down"},{"l":"Engagement (%)","v":"79.8%","t":"+14.3%","d":"up"},{"l":"Turnover (%)","v":"90.0%","t":"-3.1%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"183","t":"+5.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.130","2026-02-17","82","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.231","2026-03-01","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.073","2026-02-13","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.158","2026-02-13","92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","622","2026-02-21","91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":448},{"label":"Mar","value":519},{"label":"Abr","value":307},{"label":"Mai","value":404},{"label":"Jun","value":474},{"label":"Jul","value":574},{"label":"Ago","value":414},{"label":"Set","value":388},{"label":"Out","value":414},{"label":"Nov","value":459},{"label":"Dez","value":517}];
const MX = 587;
