...
const PAGE = "Recovery Testing";
const KPIS = [{"l":"BCP Plans Ativos","v":"874","t":"+14.6%","d":"up"},{"l":"RTO Médio (h)","v":"65h","t":"+14.4%","d":"up"},{"l":"RPO Médio (h)","v":"145h","t":"+9.2%","d":"up"},{"l":"Testes DR (YTD)","v":"8.257","t":"+5.8%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","39h","65h","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","188h","70h","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","163h","141h","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","36h","175h","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","184h","191h","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":990},{"label":"Mar","value":961},{"label":"Abr","value":922},{"label":"Mai","value":666},{"label":"Jun","value":797},{"label":"Jul","value":657},{"label":"Ago","value":681},{"label":"Set","value":814},{"label":"Out","value":636},{"label":"Nov","value":725},{"label":"Dez","value":748}];
const MX = 990;
