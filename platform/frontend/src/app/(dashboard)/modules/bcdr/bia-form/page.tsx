...
const PAGE = "BIA Form";
const KPIS = [{"l":"Formulários Ativos","v":"8.152","t":"+17.5%","d":"up"},{"l":"Submissões/Dia","v":"2420","t":"-5.1%","d":"down"},{"l":"Documentos Gerados","v":"3.368","t":"+14.6%","d":"up"},{"l":"Templates","v":"3.345","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.853","2026-02-16","2.998","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.486","2026-03-18","7.737","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.059","2026-03-18","6.094","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.050","2026-03-12","729","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.309","2026-03-02","1.171","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":314},{"label":"Mar","value":318},{"label":"Abr","value":346},{"label":"Mai","value":453},{"label":"Jun","value":609},{"label":"Jul","value":696},{"label":"Ago","value":700},{"label":"Set","value":658},{"label":"Out","value":529},{"label":"Nov","value":636},{"label":"Dez","value":678}];
const MX = 700;
