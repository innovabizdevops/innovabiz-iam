...
const PAGE = "BCP Plans";
const KPIS = [{"l":"BCP Plans Ativos","v":"8.806","t":"+0.5%","d":"up"},{"l":"RTO Médio (h)","v":"120h","t":"+7.8%","d":"up"},{"l":"RPO Médio (h)","v":"199h","t":"-2.5%","d":"down"},{"l":"Testes DR (YTD)","v":"4.487","t":"+15.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","160h","65h","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","10h","67h","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","173h","129h","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","134h","88h","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","66h","134h","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":338},{"label":"Mar","value":304},{"label":"Abr","value":277},{"label":"Mai","value":255},{"label":"Jun","value":386},{"label":"Jul","value":349},{"label":"Ago","value":424},{"label":"Set","value":595},{"label":"Out","value":269},{"label":"Nov","value":405},{"label":"Dez","value":639}];
const MX = 639;
...
export default function BcpPlansPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>ISO 22301</span></h1>
                </div>
