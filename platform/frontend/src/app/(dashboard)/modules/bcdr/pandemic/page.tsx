...
const PAGE = "Pandemic Playbook";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.084","t":"+7.7%","d":"up"},{"l":"RTO Médio (h)","v":"164h","t":"+17.5%","d":"up"},{"l":"RPO Médio (h)","v":"68h","t":"+1.5%","d":"up"},{"l":"Testes DR (YTD)","v":"4.239","t":"+17.9%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","29h","163h","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","40h","112h","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","61h","135h","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","101h","35h","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","197h","122h","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":859},{"label":"Mar","value":832},{"label":"Abr","value":924},{"label":"Mai","value":781},{"label":"Jun","value":775},{"label":"Jul","value":825},{"label":"Ago","value":632},{"label":"Set","value":986},{"label":"Out","value":816},{"label":"Nov","value":794},{"label":"Dez","value":789}];
const MX = 986;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>New</span></h1>
                </div>
