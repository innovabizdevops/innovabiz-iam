...
const PAGE = "Recovery Timeline";
const KPIS = [{"l":"BCP Plans Ativos","v":"6.453","t":"+15.3%","d":"up"},{"l":"RTO Médio (h)","v":"132h","t":"-5.4%","d":"down"},{"l":"RPO Médio (h)","v":"83h","t":"+3.8%","d":"up"},{"l":"Testes DR (YTD)","v":"8.174","t":"+6.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","172h","99h","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","50h","181h","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","133h","17h","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","82h","61h","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","124h","208h","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":900},{"label":"Mar","value":699},{"label":"Abr","value":862},{"label":"Mai","value":926},{"label":"Jun","value":818},{"label":"Jul","value":836},{"label":"Ago","value":867},{"label":"Set","value":961},{"label":"Out","value":628},{"label":"Nov","value":834},{"label":"Dez","value":767}];
const MX = 961;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>Chart</span></h1>
                </div>
