...
const ACCENT = "#b91c1c";
const MODULE = "Business Continuity & DR";
const PAGE = "Business Impact Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"494","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"2286","t":"+4.2%","d":"up"},{"l":"Dados Processados (GB)","v":"2.817","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"4.243","t":"+5.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3650","2026-01-09","5.530","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","861","2026-03-04","8.941","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4979","2026-02-28","2.080","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2183","2026-03-09","582","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","261","2026-01-22","4.544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":840},{"label":"Mar","value":689},{"label":"Abr","value":968},{"label":"Mai","value":628},{"label":"Jun","value":635},{"label":"Jul","value":966},{"label":"Ago","value":739},{"label":"Set","value":733},{"label":"Out","value":669},{"label":"Nov","value":803},{"label":"Dez","value":652}];
const MX = 968;
...
export default function BiaBcdrPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>ISO22301</span></h1>
                </div>
