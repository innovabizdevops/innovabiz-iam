...
const PAGE = "DR Runbooks";
const KPIS = [{"l":"BCP Plans Ativos","v":"8.852","t":"+13.5%","d":"up"},{"l":"RTO Médio (h)","v":"172h","t":"+2.8%","d":"up"},{"l":"RPO Médio (h)","v":"42h","t":"+9.5%","d":"up"},{"l":"Testes DR (YTD)","v":"3.172","t":"+3.5%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","59h","85h","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","102h","143h","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","112h","133h","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","195h","169h","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","36h","128h","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":438},{"label":"Mar","value":524},{"label":"Abr","value":420},{"label":"Mai","value":495},{"label":"Jun","value":574},{"label":"Jul","value":651},{"label":"Ago","value":584},{"label":"Set","value":386},{"label":"Out","value":638},{"label":"Nov","value":571},{"label":"Dez","value":711}];
const MX = 711;
