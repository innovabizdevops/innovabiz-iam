...
const PAGE = "Incident Command";
const KPIS = [{"l":"Tickets Abertos","v":"4.666","t":"+6.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.2%","t":"+13.8%","d":"up"},{"l":"MTTR (h)","v":"138h","t":"+6.5%","d":"up"},{"l":"Satisfação (%)","v":"83.9%","t":"+6.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.069","7.344","8.545","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.163","7.051","7.468","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.319","5.240","5.694","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.166","1.758","8.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.539","8.485","318","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":826},{"label":"Mar","value":1058},{"label":"Abr","value":783},{"label":"Mai","value":801},{"label":"Jun","value":1067},{"label":"Jul","value":849},{"label":"Ago","value":833},{"label":"Set","value":1088},{"label":"Out","value":1013},{"label":"Nov","value":974},{"label":"Dez","value":1058}];
const MX = 1088;
