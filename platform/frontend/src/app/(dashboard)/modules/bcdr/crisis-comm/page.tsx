...
const PAGE = "Crisis Communication";
const KPIS = [{"l":"BCP Plans Ativos","v":"637","t":"-0.6%","d":"down"},{"l":"RTO Médio (h)","v":"109h","t":"+4.9%","d":"up"},{"l":"RPO Médio (h)","v":"173h","t":"+9.8%","d":"up"},{"l":"Testes DR (YTD)","v":"5.725","t":"-5.5%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","145h","146h","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","66h","49h","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","192h","204h","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","41h","189h","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","34h","76h","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":687},{"label":"Mar","value":675},{"label":"Abr","value":680},{"label":"Mai","value":566},{"label":"Jun","value":633},{"label":"Jul","value":815},{"label":"Ago","value":900},{"label":"Set","value":785},{"label":"Out","value":730},{"label":"Nov","value":703},{"label":"Dez","value":807}];
const MX = 900;
...
export default function CrisisCommPage() {
    return (
