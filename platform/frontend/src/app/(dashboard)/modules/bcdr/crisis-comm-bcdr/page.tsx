...
const KPIS = [{"l":"BCP Plans Ativos","v":"961","t":"-5.8%","d":"down"},{"l":"RTO Médio (h)","v":"105h","t":"+17.6%","d":"up"},{"l":"RPO Médio (h)","v":"116h","t":"+16.3%","d":"up"},{"l":"Testes DR (YTD)","v":"695","t":"+11.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","149h","105h","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","162h","161h","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","96h","144h","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","93h","135h","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","157h","92h","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":786},{"label":"Mar","value":492},{"label":"Abr","value":802},{"label":"Mai","value":447},{"label":"Jun","value":776},{"label":"Jul","value":683},{"label":"Ago","value":783},{"label":"Set","value":723},{"label":"Out","value":498},{"label":"Nov","value":448},{"label":"Dez","value":631}];
const MX = 802;
...
export default function CrisisCommBcdrPage() {
    return (
