...
const PAGE = "BIA (Impact Analysis)";
const KPIS = [{"l":"Dashboards Ativos","v":"9.100","t":"+4.4%","d":"up"},{"l":"Queries/Dia","v":"3103","t":"+8.0%","d":"up"},{"l":"Dados Processados (GB)","v":"2.478","t":"-6.0%","d":"down"},{"l":"Utilizadores Analytics","v":"3.713","t":"+8.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2045","2026-01-04","7.916","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4346","2026-03-25","5.612","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","328","2026-01-15","6.100","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3461","2026-02-04","985","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4944","2026-01-26","8.299","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":680},{"label":"Mar","value":342},{"label":"Abr","value":421},{"label":"Mai","value":538},{"label":"Jun","value":610},{"label":"Jul","value":567},{"label":"Ago","value":691},{"label":"Set","value":625},{"label":"Out","value":443},{"label":"Nov","value":676},{"label":"Dez","value":415}];
const MX = 691;
