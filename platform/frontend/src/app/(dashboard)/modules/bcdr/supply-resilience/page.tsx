...
const PAGE = "Supply Chain Resilience";
const KPIS = [{"l":"BCP Plans Ativos","v":"2.997","t":"-5.2%","d":"down"},{"l":"RTO Médio (h)","v":"74h","t":"-4.9%","d":"down"},{"l":"RPO Médio (h)","v":"48h","t":"+8.2%","d":"up"},{"l":"Testes DR (YTD)","v":"402","t":"-2.2%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","103h","23h","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","44h","59h","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","192h","56h","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","170h","30h","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","121h","146h","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":815},{"label":"Mar","value":823},{"label":"Abr","value":605},{"label":"Mai","value":599},{"label":"Jun","value":586},{"label":"Jul","value":532},{"label":"Ago","value":445},{"label":"Set","value":511},{"label":"Out","value":556},{"label":"Nov","value":667},{"label":"Dez","value":644}];
const MX = 823;
...
export default function SupplyResiliencePage() {
    return (
