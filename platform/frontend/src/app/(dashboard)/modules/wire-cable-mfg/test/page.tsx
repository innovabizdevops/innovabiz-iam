...
const PAGE = "Test";
const KPIS = [{"l":"Total Wire Cable Mfg","v":"6.475","t":"-3.9%","d":"down"},{"l":"Test Ativos","v":"4.560","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"90.6%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.8%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wire Cable Mfg #001","Wire Cable Mfg #002","7.433","918","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Wire Cable Mfg #002","Wire Cable Mfg #003","2.805","7.337","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Wire Cable Mfg #003","Wire Cable Mfg #004","8.063","7.700","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Wire Cable Mfg #004","Wire Cable Mfg #005","1.076","1.970","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wire Cable Mfg #005","Wire Cable Mfg #001","8.937","262","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":751},{"label":"Mar","value":759},{"label":"Abr","value":572},{"label":"Mai","value":457},{"label":"Jun","value":459},{"label":"Jul","value":813},{"label":"Ago","value":667},{"label":"Set","value":753},{"label":"Out","value":481},{"label":"Nov","value":480},{"label":"Dez","value":833}];
const MX = 833;
