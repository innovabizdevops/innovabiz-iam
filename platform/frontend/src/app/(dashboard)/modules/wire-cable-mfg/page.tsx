...
/* ═══ Wire & Cable Mfg — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "9025", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "99", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€370K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "288217725", cells: ["WIR-2725", "Wire & Cable Mfg Item 1", "6/10/2026", "€17 825"], status: "active" as const },
    { id: "288221296", cells: ["WIR-6296", "Wire & Cable Mfg Item 2", "21/5/2026", "€21 396"], status: "pending" as const },
    { id: "288224867", cells: ["WIR-9867", "Wire & Cable Mfg Item 3", "8/12/2026", "€24 967"], status: "completed" as const },
    { id: "288228438", cells: ["WIR-4438", "Wire & Cable Mfg Item 4", "23/7/2026", "€28 538"], status: "warning" as const },
    { id: "288232009", cells: ["WIR-8009", "Wire & Cable Mfg Item 5", "10/2/2026", "€32 109"], status: "active" as const },
];
...
export default function WireCableMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wire & Cable Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wire & Cable Mfg</p>
                    </div>
                </div>
