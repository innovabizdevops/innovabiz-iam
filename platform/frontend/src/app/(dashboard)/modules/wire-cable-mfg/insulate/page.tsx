...
const ACCENT = "#7c3aed";
const MODULE = "Wire & Cable Mfg";
const PAGE = "Insulate";
const KPIS = [{"l":"Total Wire Cable Mfg","v":"4.202","t":"-0.5%","d":"down"},{"l":"Insulate Ativos","v":"6.864","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+3.9%","d":"up"}];
const COLS = ["ID","Insulate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wire Cable Mfg #001","Wire Cable Mfg #002","5.539","8.675","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Wire Cable Mfg #002","Wire Cable Mfg #003","5.720","6.181","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Wire Cable Mfg #003","Wire Cable Mfg #004","1.123","5.311","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Wire Cable Mfg #004","Wire Cable Mfg #005","306","5.912","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wire Cable Mfg #005","Wire Cable Mfg #001","1.426","7.828","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":539},{"label":"Mar","value":649},{"label":"Abr","value":560},{"label":"Mai","value":466},{"label":"Jun","value":331},{"label":"Jul","value":520},{"label":"Ago","value":590},{"label":"Set","value":373},{"label":"Out","value":321},{"label":"Nov","value":523},{"label":"Dez","value":342}];
const MX = 649;
