...
const ACCENT = "#0070f3";
const MODULE = "Material Management (SAP MM)";
const PAGE = "Invoice";
const KPIS = [{"l":"Total Material Mgmt","v":"281","t":"-4.9%","d":"down"},{"l":"Invoice Ativos","v":"3.564","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"91.1%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"70","t":"+14.8%","d":"up"}];
const COLS = ["ID","Invoice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Material Mgmt #001","Material Mgmt #002","1.486","7.453","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Material Mgmt #002","Material Mgmt #003","8.623","1.004","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Material Mgmt #003","Material Mgmt #004","3.879","8.891","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Material Mgmt #004","Material Mgmt #005","454","4.375","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Material Mgmt #005","Material Mgmt #001","7.099","3.893","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":286},{"label":"Mar","value":233},{"label":"Abr","value":527},{"label":"Mai","value":419},{"label":"Jun","value":402},{"label":"Jul","value":285},{"label":"Ago","value":364},{"label":"Set","value":384},{"label":"Out","value":486},{"label":"Nov","value":503},{"label":"Dez","value":540}];
const MX = 540;
