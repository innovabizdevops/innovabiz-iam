...
/* ═══ Material Management (SAP MM) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "5858", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "867", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1836138958", cells: ["MAT-4958", "Material Management (SAP MM) Item 1", "11/11/2026", "€39 058"], status: "active" as const },
    { id: "1836142529", cells: ["MAT-8529", "Material Management (SAP MM) Item 2", "26/6/2026", "€42 629"], status: "pending" as const },
    { id: "1836146100", cells: ["MAT-3100", "Material Management (SAP MM) Item 3", "13/1/2026", "€46 200"], status: "completed" as const },
    { id: "1836149671", cells: ["MAT-6671", "Material Management (SAP MM) Item 4", "28/8/2026", "€49 771"], status: "warning" as const },
    { id: "1836153242", cells: ["MAT-1242", "Material Management (SAP MM) Item 5", "15/3/2026", "€3342"], status: "active" as const },
];
...
export default function MaterialManagementSapMmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Material Management (SAP MM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Material Management (SAP MM)</p>
                    </div>
                </div>
