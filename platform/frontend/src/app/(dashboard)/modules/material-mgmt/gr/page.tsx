...
const PAGE = "GR";
const KPIS = [{"l":"Total Material Mgmt","v":"2.154","t":"+11.0%","d":"up"},{"l":"GR Ativos","v":"5.541","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+13.8%","d":"up"}];
const COLS = ["ID","GR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Material Mgmt #001","Material Mgmt #002","2.537","4.121","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Material Mgmt #002","Material Mgmt #003","8.386","2.574","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Material Mgmt #003","Material Mgmt #004","6.940","4.788","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Material Mgmt #004","Material Mgmt #005","2.053","4.746","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Material Mgmt #005","Material Mgmt #001","3.246","192","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":672},{"label":"Mar","value":756},{"label":"Abr","value":939},{"label":"Mai","value":674},{"label":"Jun","value":847},{"label":"Jul","value":635},{"label":"Ago","value":715},{"label":"Set","value":744},{"label":"Out","value":944},{"label":"Nov","value":837},{"label":"Dez","value":668}];
const MX = 944;
