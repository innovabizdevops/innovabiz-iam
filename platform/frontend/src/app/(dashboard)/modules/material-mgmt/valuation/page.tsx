...
const KPIS = [{"l":"Total Material Mgmt","v":"5.006","t":"-3.8%","d":"down"},{"l":"Valuation Ativos","v":"7.023","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"83.9%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"94","t":"+10.4%","d":"up"}];
const COLS = ["ID","Valuation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Material Mgmt #001","Material Mgmt #002","5.918","3.480","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Material Mgmt #002","Material Mgmt #003","924","6.155","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Material Mgmt #003","Material Mgmt #004","2.806","1.864","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Material Mgmt #004","Material Mgmt #005","1.936","5.704","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Material Mgmt #005","Material Mgmt #001","8.667","2.895","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":445},{"label":"Mar","value":503},{"label":"Abr","value":349},{"label":"Mai","value":378},{"label":"Jun","value":668},{"label":"Jul","value":566},{"label":"Ago","value":405},{"label":"Set","value":605},{"label":"Out","value":673},{"label":"Nov","value":648},{"label":"Dez","value":673}];
const MX = 673;
