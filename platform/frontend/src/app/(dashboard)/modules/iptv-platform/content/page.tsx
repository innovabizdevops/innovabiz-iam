...
const PAGE = "Content";
const KPIS = [{"l":"Formulários Ativos","v":"2.570","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"4990","t":"+3.1%","d":"up"},{"l":"Documentos Gerados","v":"8.249","t":"+17.1%","d":"up"},{"l":"Templates","v":"1.106","t":"+4.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.775","2026-02-22","1.669","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.173","2026-03-07","3.787","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.205","2026-01-12","4.460","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.833","2026-02-02","7.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.722","2026-03-25","4.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":572},{"label":"Mar","value":563},{"label":"Abr","value":820},{"label":"Mai","value":661},{"label":"Jun","value":830},{"label":"Jul","value":649},{"label":"Ago","value":694},{"label":"Set","value":758},{"label":"Out","value":485},{"label":"Nov","value":779},{"label":"Dez","value":845}];
const MX = 845;
