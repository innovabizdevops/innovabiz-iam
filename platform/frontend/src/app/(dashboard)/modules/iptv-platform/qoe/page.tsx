...
const PAGE = "QoE";
const KPIS = [{"l":"Formulários Ativos","v":"1.708","t":"+8.0%","d":"up"},{"l":"Submissões/Dia","v":"1189","t":"+4.0%","d":"up"},{"l":"Documentos Gerados","v":"7.477","t":"-3.4%","d":"down"},{"l":"Templates","v":"3.977","t":"+11.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.967","2026-01-27","2.433","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.250","2026-01-20","3.442","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.361","2026-02-26","4.899","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.929","2026-01-25","4.149","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.183","2026-01-23","179","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":463},{"label":"Mar","value":663},{"label":"Abr","value":595},{"label":"Mai","value":446},{"label":"Jun","value":517},{"label":"Jul","value":588},{"label":"Ago","value":456},{"label":"Set","value":609},{"label":"Out","value":570},{"label":"Nov","value":673},{"label":"Dez","value":500}];
const MX = 673;
