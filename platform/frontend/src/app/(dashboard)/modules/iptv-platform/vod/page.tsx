...
const PAGE = "VOD";
const KPIS = [{"l":"Formulários Ativos","v":"5.563","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"3540","t":"-4.2%","d":"down"},{"l":"Documentos Gerados","v":"8.504","t":"+16.9%","d":"up"},{"l":"Templates","v":"6.359","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.734","2026-03-27","1.882","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.620","2026-02-03","6.611","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.911","2026-03-06","3.348","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.838","2026-02-20","8.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.462","2026-01-06","7.992","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1042},{"label":"Fev","value":754},{"label":"Mar","value":953},{"label":"Abr","value":921},{"label":"Mai","value":792},{"label":"Jun","value":702},{"label":"Jul","value":699},{"label":"Ago","value":788},{"label":"Set","value":746},{"label":"Out","value":1075},{"label":"Nov","value":793},{"label":"Dez","value":1006}];
const MX = 1075;
