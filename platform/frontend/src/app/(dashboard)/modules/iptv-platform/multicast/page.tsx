...
const ACCENT = "#6366f1";
const MODULE = "IPTV Platform";
const PAGE = "Multicast";
const KPIS = [{"l":"Formulários Ativos","v":"422","t":"+10.1%","d":"up"},{"l":"Submissões/Dia","v":"4925","t":"+5.8%","d":"up"},{"l":"Documentos Gerados","v":"4.337","t":"-1.0%","d":"down"},{"l":"Templates","v":"7.895","t":"+4.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.957","2026-01-05","564","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.638","2026-01-20","1.471","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.136","2026-01-07","6.310","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","305","2026-02-21","5.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","889","2026-01-22","1.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":1046},{"label":"Mar","value":931},{"label":"Abr","value":804},{"label":"Mai","value":947},{"label":"Jun","value":754},{"label":"Jul","value":1007},{"label":"Ago","value":946},{"label":"Set","value":760},{"label":"Out","value":1063},{"label":"Nov","value":869},{"label":"Dez","value":873}];
const MX = 1063;
