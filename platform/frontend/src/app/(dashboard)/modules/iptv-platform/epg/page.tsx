...
const PAGE = "EPG";
const KPIS = [{"l":"Formulários Ativos","v":"946","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"1841","t":"+-0.0%","d":"up"},{"l":"Documentos Gerados","v":"7.450","t":"-1.4%","d":"down"},{"l":"Templates","v":"5.820","t":"+0.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.502","2026-03-04","2.159","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.274","2026-01-26","2.623","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.026","2026-01-27","6.343","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.079","2026-02-20","493","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","401","2026-01-07","6.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":641},{"label":"Mar","value":547},{"label":"Abr","value":353},{"label":"Mai","value":554},{"label":"Jun","value":342},{"label":"Jul","value":646},{"label":"Ago","value":593},{"label":"Set","value":446},{"label":"Out","value":590},{"label":"Nov","value":516},{"label":"Dez","value":502}];
const MX = 646;
