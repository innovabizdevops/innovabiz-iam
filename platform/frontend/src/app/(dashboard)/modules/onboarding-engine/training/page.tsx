...
const PAGE = "Training Assignments";
const KPIS = [{"l":"eNPS","v":"92","t":"+2.3%","d":"up"},{"l":"Engagement (%)","v":"68.2%","t":"+16.3%","d":"up"},{"l":"Turnover (%)","v":"69.6%","t":"+16.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.384","t":"+15.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.984","2026-02-15","85","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","633","2026-02-03","64","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.835","2026-03-09","65","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","755","2026-02-22","92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.004","2026-03-02","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":515},{"label":"Mar","value":383},{"label":"Abr","value":374},{"label":"Mai","value":628},{"label":"Jun","value":350},{"label":"Jul","value":684},{"label":"Ago","value":475},{"label":"Set","value":412},{"label":"Out","value":684},{"label":"Nov","value":671},{"label":"Dez","value":671}];
const MX = 684;
