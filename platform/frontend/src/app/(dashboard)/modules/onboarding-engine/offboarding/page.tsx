...
const PAGE = "Offboarding";
const KPIS = [{"l":"eNPS","v":"70","t":"+0.3%","d":"up"},{"l":"Engagement (%)","v":"82.9%","t":"+9.4%","d":"up"},{"l":"Turnover (%)","v":"85.1%","t":"+4.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.247","t":"+9.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.692","2026-01-16","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.436","2026-03-18","94","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.588","2026-01-05","60","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.947","2026-01-12","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.965","2026-03-10","58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":684},{"label":"Mar","value":1014},{"label":"Abr","value":939},{"label":"Mai","value":696},{"label":"Jun","value":711},{"label":"Jul","value":868},{"label":"Ago","value":985},{"label":"Set","value":811},{"label":"Out","value":897},{"label":"Nov","value":685},{"label":"Dez","value":844}];
const MX = 1014;
