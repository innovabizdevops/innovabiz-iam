...
const PAGE = "Buddy System";
const KPIS = [{"l":"eNPS","v":"85","t":"+2.9%","d":"up"},{"l":"Engagement (%)","v":"68.8%","t":"+9.5%","d":"up"},{"l":"Turnover (%)","v":"79.1%","t":"+10.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.897","t":"+4.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.345","2026-03-06","72","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","916","2026-02-17","59","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.169","2026-02-06","87","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.583","2026-03-27","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.196","2026-03-12","63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":776},{"label":"Mar","value":637},{"label":"Abr","value":551},{"label":"Mai","value":848},{"label":"Jun","value":634},{"label":"Jul","value":665},{"label":"Ago","value":782},{"label":"Set","value":681},{"label":"Out","value":544},{"label":"Nov","value":681},{"label":"Dez","value":551}];
const MX = 848;
