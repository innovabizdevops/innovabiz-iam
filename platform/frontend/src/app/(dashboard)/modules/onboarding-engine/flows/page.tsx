...
const PAGE = "Onboarding Flows";
const KPIS = [{"l":"eNPS","v":"83","t":"+11.0%","d":"up"},{"l":"Engagement (%)","v":"94.3%","t":"+0.8%","d":"up"},{"l":"Turnover (%)","v":"73.9%","t":"+10.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"243","t":"-5.8%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.424","2026-03-19","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.707","2026-02-02","76","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.579","2026-02-18","62","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.890","2026-02-21","70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.005","2026-03-04","93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":261},{"label":"Fev","value":261},{"label":"Mar","value":320},{"label":"Abr","value":298},{"label":"Mai","value":497},{"label":"Jun","value":274},{"label":"Jul","value":461},{"label":"Ago","value":598},{"label":"Set","value":334},{"label":"Out","value":505},{"label":"Nov","value":367},{"label":"Dez","value":596}];
const MX = 598;
