...
const PAGE = "30/60/90 Plan";
const KPIS = [{"l":"eNPS","v":"95","t":"-5.3%","d":"down"},{"l":"Engagement (%)","v":"69.1%","t":"+7.3%","d":"up"},{"l":"Turnover (%)","v":"65.3%","t":"+8.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.858","t":"+8.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.577","2026-02-05","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.466","2026-03-06","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.795","2026-03-02","62","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","276","2026-02-04","55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.678","2026-01-12","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":450},{"label":"Mar","value":455},{"label":"Abr","value":343},{"label":"Mai","value":660},{"label":"Jun","value":547},{"label":"Jul","value":408},{"label":"Ago","value":441},{"label":"Set","value":354},{"label":"Out","value":410},{"label":"Nov","value":706},{"label":"Dez","value":718}];
const MX = 718;
