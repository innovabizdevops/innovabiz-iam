...
const ACCENT = "#059669";
const MODULE = "Onboarding Engine";
const PAGE = "Document Checklist";
const KPIS = [{"l":"eNPS","v":"58","t":"+16.4%","d":"up"},{"l":"Engagement (%)","v":"76.3%","t":"+6.1%","d":"up"},{"l":"Turnover (%)","v":"84.4%","t":"+6.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.836","t":"+9.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.304","2026-01-25","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.810","2026-03-16","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.401","2026-02-22","66","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.376","2026-03-09","63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.898","2026-01-01","92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":571},{"label":"Mar","value":427},{"label":"Abr","value":400},{"label":"Mai","value":420},{"label":"Jun","value":512},{"label":"Jul","value":362},{"label":"Ago","value":381},{"label":"Set","value":230},{"label":"Out","value":443},{"label":"Nov","value":524},{"label":"Dez","value":244}];
const MX = 571;
