...
const KPIS = [{"l":"Formulários Ativos","v":"8.116","t":"+4.1%","d":"up"},{"l":"Submissões/Dia","v":"4177","t":"+3.3%","d":"up"},{"l":"Documentos Gerados","v":"5.828","t":"+2.4%","d":"up"},{"l":"Templates","v":"9.041","t":"+14.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.660","2026-03-21","2.048","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","125","2026-02-09","1.446","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.731","2026-01-03","7.284","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","164","2026-01-22","1.240","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.990","2026-02-01","2.732","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":960},{"label":"Mar","value":730},{"label":"Abr","value":743},{"label":"Mai","value":919},{"label":"Jun","value":756},{"label":"Jul","value":693},{"label":"Ago","value":737},{"label":"Set","value":812},{"label":"Out","value":766},{"label":"Nov","value":888},{"label":"Dez","value":724}];
const MX = 960;
