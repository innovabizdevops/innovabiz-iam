...
/* ═══ CX Platform (Gartner CCaaS) — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "2602", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "843", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€28K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "917782002", cells: ["CX-8002", "CX Platform (Gartner CCaaS) Item 1", "19/7/2026", "€32 102"], status: "active" as const },
    { id: "917785573", cells: ["CX-2573", "CX Platform (Gartner CCaaS) Item 2", "6/2/2026", "€35 673"], status: "pending" as const },
    { id: "917789144", cells: ["CX-6144", "CX Platform (Gartner CCaaS) Item 3", "21/9/2026", "€39 244"], status: "completed" as const },
    { id: "917792715", cells: ["CX-9715", "CX Platform (Gartner CCaaS) Item 4", "8/4/2026", "€42 815"], status: "warning" as const },
    { id: "917796286", cells: ["CX-4286", "CX Platform (Gartner CCaaS) Item 5", "23/11/2026", "€46 386"], status: "active" as const },
];
...
export default function CxPlatformGartnerCcaasPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CX Platform (Gartner CCaaS)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CX Platform (Gartner CCaaS)</p>
                    </div>
                </div>
