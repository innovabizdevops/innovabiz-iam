...
const ACCENT = "#f43f5e";
const MODULE = "CX Platform (Gartner CCaaS)";
const PAGE = "CX Score";
const KPIS = [{"l":"Formulários Ativos","v":"2.196","t":"+6.7%","d":"up"},{"l":"Submissões/Dia","v":"3329","t":"-5.5%","d":"down"},{"l":"Documentos Gerados","v":"3.620","t":"-5.6%","d":"down"},{"l":"Templates","v":"8.949","t":"+15.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.100","2026-01-26","5.521","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.956","2026-01-12","6.588","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.664","2026-02-19","6.306","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.433","2026-02-27","7.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.165","2026-02-24","1.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":906},{"label":"Mar","value":826},{"label":"Abr","value":839},{"label":"Mai","value":908},{"label":"Jun","value":1022},{"label":"Jul","value":813},{"label":"Ago","value":860},{"label":"Set","value":725},{"label":"Out","value":716},{"label":"Nov","value":763},{"label":"Dez","value":1068}];
const MX = 1068;
