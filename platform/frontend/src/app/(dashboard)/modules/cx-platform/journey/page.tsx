...
const KPIS = [{"l":"Formulários Ativos","v":"1.263","t":"+6.7%","d":"up"},{"l":"Submissões/Dia","v":"391","t":"+17.4%","d":"up"},{"l":"Documentos Gerados","v":"2.408","t":"+16.1%","d":"up"},{"l":"Templates","v":"4.132","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.724","2026-02-02","468","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.125","2026-01-08","3.169","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.819","2026-01-19","191","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.261","2026-02-25","6.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.200","2026-01-06","3.646","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":890},{"label":"Mar","value":678},{"label":"Abr","value":729},{"label":"Mai","value":704},{"label":"Jun","value":698},{"label":"Jul","value":568},{"label":"Ago","value":660},{"label":"Set","value":592},{"label":"Out","value":764},{"label":"Nov","value":749},{"label":"Dez","value":886}];
const MX = 911;
