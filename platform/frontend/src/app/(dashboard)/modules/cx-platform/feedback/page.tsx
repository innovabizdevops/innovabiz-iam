...
const PAGE = "Feedback";
const KPIS = [{"l":"Formulários Ativos","v":"1.530","t":"+9.8%","d":"up"},{"l":"Submissões/Dia","v":"810","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"4.910","t":"+17.1%","d":"up"},{"l":"Templates","v":"8.971","t":"+0.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.583","2026-03-05","5.532","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.179","2026-01-22","7.693","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.926","2026-02-03","4.605","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.953","2026-01-01","1.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.472","2026-01-02","6.564","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":778},{"label":"Mar","value":567},{"label":"Abr","value":499},{"label":"Mai","value":711},{"label":"Jun","value":681},{"label":"Jul","value":406},{"label":"Ago","value":742},{"label":"Set","value":491},{"label":"Out","value":513},{"label":"Nov","value":458},{"label":"Dez","value":428}];
const MX = 778;
