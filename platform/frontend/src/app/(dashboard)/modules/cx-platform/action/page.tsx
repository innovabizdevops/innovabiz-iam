...
const PAGE = "Action";
const KPIS = [{"l":"Formulários Ativos","v":"726","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"739","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"5.986","t":"+1.6%","d":"up"},{"l":"Templates","v":"3.847","t":"+8.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","438","2026-01-03","5.911","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.986","2026-03-13","8.730","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.332","2026-01-02","6.369","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.572","2026-01-25","8.912","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.898","2026-03-09","4.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":663},{"label":"Mar","value":475},{"label":"Abr","value":416},{"label":"Mai","value":597},{"label":"Jun","value":651},{"label":"Jul","value":425},{"label":"Ago","value":540},{"label":"Set","value":489},{"label":"Out","value":355},{"label":"Nov","value":492},{"label":"Dez","value":301}];
const MX = 663;
