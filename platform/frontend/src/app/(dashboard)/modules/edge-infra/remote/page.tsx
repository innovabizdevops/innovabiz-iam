...
const ACCENT = "#7c3aed";
const MODULE = "Edge Infrastructure";
const PAGE = "Remote Mgmt";
const KPIS = [{"l":"Total Edge Infra","v":"3.412","t":"+8.6%","d":"up"},{"l":"Remote Mgmt Ativos","v":"2.441","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"66.3%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"60","t":"+4.2%","d":"up"}];
const COLS = ["ID","Remote Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge Infra #001","Edge Infra #002","6.025","1.531","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Edge Infra #002","Edge Infra #003","191","3.181","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge Infra #003","Edge Infra #004","7.389","2.417","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Edge Infra #004","Edge Infra #005","2.726","8.668","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge Infra #005","Edge Infra #001","3.588","1.410","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":705},{"label":"Mar","value":981},{"label":"Abr","value":923},{"label":"Mai","value":600},{"label":"Jun","value":627},{"label":"Jul","value":720},{"label":"Ago","value":807},{"label":"Set","value":936},{"label":"Out","value":838},{"label":"Nov","value":759},{"label":"Dez","value":870}];
const MX = 981;
