...
const PAGE = "Edge Site";
const KPIS = [{"l":"Total Edge Infra","v":"721","t":"-1.1%","d":"down"},{"l":"Edge Site Ativos","v":"4.863","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"65","t":"-1.5%","d":"down"}];
const COLS = ["ID","Edge Site","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge Infra #001","Edge Infra #002","3.817","7.543","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Edge Infra #002","Edge Infra #003","6.124","5.139","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge Infra #003","Edge Infra #004","2.002","8.127","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Edge Infra #004","Edge Infra #005","5.072","1.025","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge Infra #005","Edge Infra #001","8.737","7.172","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":721},{"label":"Mar","value":546},{"label":"Abr","value":616},{"label":"Mai","value":615},{"label":"Jun","value":442},{"label":"Jul","value":690},{"label":"Ago","value":596},{"label":"Set","value":717},{"label":"Out","value":779},{"label":"Nov","value":578},{"label":"Dez","value":467}];
const MX = 779;
