...
const KPIS = [{"l":"Total Edge Infra","v":"6.136","t":"+1.2%","d":"up"},{"l":"Content Cache Ativos","v":"1.424","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"92","t":"+16.4%","d":"up"}];
const COLS = ["ID","Content Cache","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge Infra #001","Edge Infra #002","4.700","8.445","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Edge Infra #002","Edge Infra #003","4.586","590","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge Infra #003","Edge Infra #004","777","1.565","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Edge Infra #004","Edge Infra #005","2.315","5.348","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge Infra #005","Edge Infra #001","3.915","8.746","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1049},{"label":"Fev","value":1064},{"label":"Mar","value":680},{"label":"Abr","value":683},{"label":"Mai","value":685},{"label":"Jun","value":1050},{"label":"Jul","value":740},{"label":"Ago","value":948},{"label":"Set","value":695},{"label":"Out","value":789},{"label":"Nov","value":922},{"label":"Dez","value":918}];
const MX = 1064;
