...
const PAGE = "Rack Deploy";
const KPIS = [{"l":"Total Edge Infra","v":"1.001","t":"+13.0%","d":"up"},{"l":"Rack Deploy Ativos","v":"7.919","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"67","t":"-4.0%","d":"down"}];
const COLS = ["ID","Rack Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge Infra #001","Edge Infra #002","3.524","7.531","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Edge Infra #002","Edge Infra #003","3.789","5.487","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge Infra #003","Edge Infra #004","2.452","695","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Edge Infra #004","Edge Infra #005","8.534","1.469","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge Infra #005","Edge Infra #001","2.377","8.968","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":872},{"label":"Mar","value":906},{"label":"Abr","value":955},{"label":"Mai","value":984},{"label":"Jun","value":947},{"label":"Jul","value":630},{"label":"Ago","value":915},{"label":"Set","value":867},{"label":"Out","value":942},{"label":"Nov","value":902},{"label":"Dez","value":676}];
const MX = 984;
