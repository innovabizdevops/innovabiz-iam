...
export default function EdgeInfraPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Edge Infra</h1><p className="text-sm text-muted-foreground">Edge Infra • iBOS Enterprise</p></div>
