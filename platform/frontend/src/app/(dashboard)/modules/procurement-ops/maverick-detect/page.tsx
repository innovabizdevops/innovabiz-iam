...
/* ═══ Procurement Ops — Maverick Detect ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2182", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "205", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "504", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1926707753", cells: ["PRO-6753", "Maverick Detect Item 1", "6/6/2026", "€7853"], status: "active" as const },
    { id: "1926711324", cells: ["PRO-1324", "Maverick Detect Item 2", "21/1/2026", "€11 424"], status: "pending" as const },
    { id: "1926714895", cells: ["PRO-4895", "Maverick Detect Item 3", "8/8/2026", "€14 995"], status: "completed" as const },
    { id: "1926718466", cells: ["PRO-8466", "Maverick Detect Item 4", "23/3/2026", "€18 566"], status: "warning" as const },
    { id: "1926722037", cells: ["PRO-3037", "Maverick Detect Item 5", "10/10/2026", "€22 137"], status: "active" as const },
];
...
export default function ProcurementOpsMaverickDetectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maverick Detect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Maverick Detect</p>
                    </div>
                </div>
