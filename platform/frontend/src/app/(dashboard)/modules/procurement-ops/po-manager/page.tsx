...
/* ═══ Procurement Ops — Po Manager ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "1766", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "376", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3034", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "26032452", cells: ["PRO-5452", "Po Manager Item 1", "13/1/2026", "€32 552"], status: "active" as const },
    { id: "26036023", cells: ["PRO-9023", "Po Manager Item 2", "28/8/2026", "€36 123"], status: "pending" as const },
    { id: "26039594", cells: ["PRO-3594", "Po Manager Item 3", "15/3/2026", "€39 694"], status: "completed" as const },
    { id: "26043165", cells: ["PRO-7165", "Po Manager Item 4", "2/10/2026", "€43 265"], status: "warning" as const },
    { id: "26046736", cells: ["PRO-1736", "Po Manager Item 5", "17/5/2026", "€46 836"], status: "active" as const },
];
...
export default function ProcurementOpsPoManagerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Po Manager</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Po Manager</p>
                    </div>
                </div>
