...
/* ═══ Procurement Ops — Punch Out ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2822", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "416", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1539", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "40498332", cells: ["PRO-8332", "Punch Out Item 1", "1/1/2026", "€48 432"], status: "active" as const },
    { id: "40501903", cells: ["PRO-2903", "Punch Out Item 2", "16/8/2026", "€2003"], status: "pending" as const },
    { id: "40505474", cells: ["PRO-6474", "Punch Out Item 3", "3/3/2026", "€5574"], status: "completed" as const },
    { id: "40509045", cells: ["PRO-1045", "Punch Out Item 4", "18/10/2026", "€9145"], status: "warning" as const },
    { id: "40512616", cells: ["PRO-4616", "Punch Out Item 5", "5/5/2026", "€12 716"], status: "active" as const },
];
...
export default function ProcurementOpsPunchOutPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Punch Out</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Punch Out</p>
                    </div>
                </div>
