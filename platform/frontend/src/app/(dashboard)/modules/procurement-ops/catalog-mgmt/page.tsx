...
/* ═══ Procurement Ops — Catalog Mgmt ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2543", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "36", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1903", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1175762592", cells: ["PRO-3592", "Catalog Mgmt Item 1", "5/1/2026", "€12 692"], status: "active" as const },
    { id: "1175766163", cells: ["PRO-7163", "Catalog Mgmt Item 2", "20/8/2026", "€16 263"], status: "pending" as const },
    { id: "1175769734", cells: ["PRO-1734", "Catalog Mgmt Item 3", "7/3/2026", "€19 834"], status: "completed" as const },
    { id: "1175773305", cells: ["PRO-5305", "Catalog Mgmt Item 4", "22/10/2026", "€23 405"], status: "warning" as const },
    { id: "1175776876", cells: ["PRO-8876", "Catalog Mgmt Item 5", "9/5/2026", "€26 976"], status: "active" as const },
];
...
export default function ProcurementOpsCatalogMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catalog Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Catalog Mgmt</p>
                    </div>
                </div>
