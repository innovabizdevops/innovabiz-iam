...
/* ═══ Procurement Ops — Invoice Match ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "3002", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "42", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2485", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "13073126", cells: ["PRO-6126", "Invoice Match Item 1", "11/3/2026", "€23 226"], status: "active" as const },
    { id: "13076697", cells: ["PRO-9697", "Invoice Match Item 2", "26/10/2026", "€26 797"], status: "pending" as const },
    { id: "13080268", cells: ["PRO-4268", "Invoice Match Item 3", "13/5/2026", "€30 368"], status: "completed" as const },
    { id: "13083839", cells: ["PRO-7839", "Invoice Match Item 4", "28/12/2026", "€33 939"], status: "warning" as const },
    { id: "13087410", cells: ["PRO-2410", "Invoice Match Item 5", "15/7/2026", "€37 510"], status: "active" as const },
];
...
export default function ProcurementOpsInvoiceMatchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Invoice Match</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Invoice Match</p>
                    </div>
                </div>
