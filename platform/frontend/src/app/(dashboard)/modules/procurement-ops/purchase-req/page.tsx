...
/* ═══ Procurement Ops — Purchase Req ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "3669", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "397", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2124", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1814402633", cells: ["PRO-3633", "Purchase Req Item 1", "2/6/2026", "€2733"], status: "active" as const },
    { id: "1814406204", cells: ["PRO-7204", "Purchase Req Item 2", "17/1/2026", "€6304"], status: "pending" as const },
    { id: "1814409775", cells: ["PRO-1775", "Purchase Req Item 3", "4/8/2026", "€9875"], status: "completed" as const },
    { id: "1814413346", cells: ["PRO-5346", "Purchase Req Item 4", "19/3/2026", "€13 446"], status: "warning" as const },
    { id: "1814416917", cells: ["PRO-8917", "Purchase Req Item 5", "6/10/2026", "€17 017"], status: "active" as const },
];
...
export default function ProcurementOpsPurchaseReqPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Purchase Req</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Purchase Req</p>
                    </div>
                </div>
