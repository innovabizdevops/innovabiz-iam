...
/* ═══ Procurement Ops — Vendor Portal ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "784", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "96", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2436", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1373720716", cells: ["PRO-6716", "Vendor Portal Item 1", "5/5/2026", "€20 816"], status: "active" as const },
    { id: "1373724287", cells: ["PRO-1287", "Vendor Portal Item 2", "20/12/2026", "€24 387"], status: "pending" as const },
    { id: "1373727858", cells: ["PRO-4858", "Vendor Portal Item 3", "7/7/2026", "€27 958"], status: "completed" as const },
    { id: "1373731429", cells: ["PRO-8429", "Vendor Portal Item 4", "22/2/2026", "€31 529"], status: "warning" as const },
    { id: "1373735000", cells: ["PRO-3000", "Vendor Portal Item 5", "9/9/2026", "€35 100"], status: "active" as const },
];
...
export default function ProcurementOpsVendorPortalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vendor Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Vendor Portal</p>
                    </div>
                </div>
