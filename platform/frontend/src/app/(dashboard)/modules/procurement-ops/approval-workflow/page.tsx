...
/* ═══ Procurement Ops — Approval Workflow ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2966", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "8", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1890", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "222484292", cells: ["PRO-5292", "Approval Workflow Item 1", "17/9/2026", "€34 392"], status: "active" as const },
    { id: "222487863", cells: ["PRO-8863", "Approval Workflow Item 2", "4/4/2026", "€37 963"], status: "pending" as const },
    { id: "222491434", cells: ["PRO-3434", "Approval Workflow Item 3", "19/11/2026", "€41 534"], status: "completed" as const },
    { id: "222495005", cells: ["PRO-7005", "Approval Workflow Item 4", "6/6/2026", "€45 105"], status: "warning" as const },
    { id: "222498576", cells: ["PRO-1576", "Approval Workflow Item 5", "21/1/2026", "€48 676"], status: "active" as const },
];
...
export default function ProcurementOpsApprovalWorkflowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Approval Workflow</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Approval Workflow</p>
                    </div>
                </div>
