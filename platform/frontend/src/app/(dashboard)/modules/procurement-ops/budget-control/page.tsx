...
/* ═══ Procurement Ops — Budget Control ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "2557", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "458", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1347", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1935385030", cells: ["PRO-8030", "Budget Control Item 1", "27/11/2026", "€35 130"], status: "active" as const },
    { id: "1935388601", cells: ["PRO-2601", "Budget Control Item 2", "14/6/2026", "€38 701"], status: "pending" as const },
    { id: "1935392172", cells: ["PRO-6172", "Budget Control Item 3", "1/1/2026", "€42 272"], status: "completed" as const },
    { id: "1935395743", cells: ["PRO-9743", "Budget Control Item 4", "16/8/2026", "€45 843"], status: "warning" as const },
    { id: "1935399314", cells: ["PRO-4314", "Budget Control Item 5", "3/3/2026", "€49 414"], status: "active" as const },
];
...
export default function ProcurementOpsBudgetControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Budget Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Budget Control</p>
                    </div>
                </div>
