...
/* ═══ Procurement Ops — Goods Receipt ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total", value: "906", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "350", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2381", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1122459274", cells: ["PRO-7274", "Goods Receipt Item 1", "7/11/2026", "€9374"], status: "active" as const },
    { id: "1122462845", cells: ["PRO-1845", "Goods Receipt Item 2", "22/6/2026", "€12 945"], status: "pending" as const },
    { id: "1122466416", cells: ["PRO-5416", "Goods Receipt Item 3", "9/1/2026", "€16 516"], status: "completed" as const },
    { id: "1122469987", cells: ["PRO-8987", "Goods Receipt Item 4", "24/8/2026", "€20 087"], status: "warning" as const },
    { id: "1122473558", cells: ["PRO-3558", "Goods Receipt Item 5", "11/3/2026", "€23 658"], status: "active" as const },
];
...
export default function ProcurementOpsGoodsReceiptPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Goods Receipt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Procurement Ops • Goods Receipt</p>
                    </div>
                </div>
