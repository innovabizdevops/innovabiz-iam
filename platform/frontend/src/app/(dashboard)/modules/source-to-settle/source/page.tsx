...
const ACCENT = "#06b6d4";
const MODULE = "Source-to-Settle E2E";
const PAGE = "Source";
const KPIS = [{"l":"Total Source To Settle","v":"5.469","t":"+4.8%","d":"up"},{"l":"Source Ativos","v":"3.363","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.4%","d":"up"}];
const COLS = ["ID","Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Source To Settle #001","Source To Settle #002","3.601","1.684","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Source To Settle #002","Source To Settle #003","7.269","1.446","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Source To Settle #003","Source To Settle #004","5.189","1.840","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Source To Settle #004","Source To Settle #005","6.838","2.012","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Source To Settle #005","Source To Settle #001","3.276","3.183","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":913},{"label":"Mar","value":829},{"label":"Abr","value":547},{"label":"Mai","value":835},{"label":"Jun","value":574},{"label":"Jul","value":572},{"label":"Ago","value":616},{"label":"Set","value":811},{"label":"Out","value":924},{"label":"Nov","value":572},{"label":"Dez","value":730}];
const MX = 924;
