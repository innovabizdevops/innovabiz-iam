...
/* ═══ Source-to-Settle E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "6506", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2057", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€43K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "121271506", cells: ["SOU-6506", "Source-to-Settle E2E Item 1", "7/11/2026", "€21 606"], status: "active" as const },
    { id: "121275077", cells: ["SOU-1077", "Source-to-Settle E2E Item 2", "22/6/2026", "€25 177"], status: "pending" as const },
    { id: "121278648", cells: ["SOU-4648", "Source-to-Settle E2E Item 3", "9/1/2026", "€28 748"], status: "completed" as const },
    { id: "121282219", cells: ["SOU-8219", "Source-to-Settle E2E Item 4", "24/8/2026", "€32 319"], status: "warning" as const },
    { id: "121285790", cells: ["SOU-2790", "Source-to-Settle E2E Item 5", "11/3/2026", "€35 890"], status: "active" as const },
];
...
export default function SourcetosettleE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Source-to-Settle E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Source-to-Settle E2E</p>
                    </div>
                </div>
