...
const PAGE = "Procure";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.500","t":"+0.4%","d":"up"},{"l":"Contratos (€M)","v":"€41.7M","t":"+3.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"82.9%","t":"+11.2%","d":"up"},{"l":"Score Médio","v":"68","t":"+0.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.6%","€ 33381.86","9.008","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","71.8%","€ 34878.86","9.014","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","93.6%","€ 13665.60","6.240","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","75.6%","€ 38687.98","4.672","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","73.6%","€ 14664.45","4.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1062},{"label":"Fev","value":854},{"label":"Mar","value":686},{"label":"Abr","value":936},{"label":"Mai","value":869},{"label":"Jun","value":808},{"label":"Jul","value":704},{"label":"Ago","value":737},{"label":"Set","value":699},{"label":"Out","value":730},{"label":"Nov","value":1038},{"label":"Dez","value":874}];
const MX = 1062;
