...
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"4.003","t":"+16.4%","d":"up"},{"l":"Treinos/Semana","v":"4853","t":"+17.6%","d":"up"},{"l":"Competições","v":"7.531","t":"+1.4%","d":"up"},{"l":"Performance Score","v":"71","t":"-1.9%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.056","784","3.125","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.241","1.857","5.051","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.670","4.061","6.371","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.320","6.770","3.551","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.687","4.993","8.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":486},{"label":"Mar","value":492},{"label":"Abr","value":433},{"label":"Mai","value":775},{"label":"Jun","value":499},{"label":"Jul","value":674},{"label":"Ago","value":599},{"label":"Set","value":481},{"label":"Out","value":800},{"label":"Nov","value":554},{"label":"Dez","value":795}];
const MX = 800;
