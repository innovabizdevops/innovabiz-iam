...
const PAGE = "Two-Way Chat";
const KPIS = [{"l":"Notificações Enviadas","v":"3.715","t":"+7.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"91.9%","t":"+9.0%","d":"up"},{"l":"Taxa Abertura (%)","v":"90.4%","t":"-0.5%","d":"down"},{"l":"Escalações","v":"3.958","t":"+10.9%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.380","82.2%","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","6.993","95.7%","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.969","92.9%","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.814","94.5%","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","9.099","73.6%","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":391},{"label":"Mar","value":600},{"label":"Abr","value":500},{"label":"Mai","value":543},{"label":"Jun","value":548},{"label":"Jul","value":610},{"label":"Ago","value":377},{"label":"Set","value":675},{"label":"Out","value":479},{"label":"Nov","value":414},{"label":"Dez","value":647}];
const MX = 675;
