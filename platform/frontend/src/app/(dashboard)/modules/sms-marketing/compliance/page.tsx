...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.626","t":"-1.2%","d":"down"},{"l":"NC Abertas","v":"8.976","t":"-3.0%","d":"down"},{"l":"Conformidade (%)","v":"71.4%","t":"+17.5%","d":"up"},{"l":"CAPAs Pendentes","v":"8.041","t":"-5.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.119","80.4%","8.054","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.960","93.9%","8.678","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.508","86.0%","372","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.321","95.0%","2.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.623","76.7%","6.397","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":216},{"label":"Mar","value":430},{"label":"Abr","value":352},{"label":"Mai","value":569},{"label":"Jun","value":375},{"label":"Jul","value":566},{"label":"Ago","value":570},{"label":"Set","value":584},{"label":"Out","value":550},{"label":"Nov","value":586},{"label":"Dez","value":288}];
const MX = 586;
