...
const PAGE = "Opt-In Mgmt";
const KPIS = [{"l":"Notificações Enviadas","v":"5.135","t":"+0.3%","d":"up"},{"l":"Taxa Entrega (%)","v":"84.5%","t":"+7.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"84.9%","t":"+4.0%","d":"up"},{"l":"Escalações","v":"6.002","t":"+16.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","210","80.8%","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","300","72.9%","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.662","99.6%","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.558","85.1%","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.007","74.6%","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":994},{"label":"Mar","value":946},{"label":"Abr","value":821},{"label":"Mai","value":765},{"label":"Jun","value":1026},{"label":"Jul","value":702},{"label":"Ago","value":958},{"label":"Set","value":1049},{"label":"Out","value":832},{"label":"Nov","value":863},{"label":"Dez","value":1079}];
const MX = 1079;
