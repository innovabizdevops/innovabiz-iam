...
const PAGE = "Campaign Send";
const KPIS = [{"l":"Notificações Enviadas","v":"3.429","t":"+0.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"94.9%","t":"+6.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"83.4%","t":"+3.5%","d":"up"},{"l":"Escalações","v":"7.971","t":"+4.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","234","89.8%","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","788","90.8%","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.754","90.5%","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.781","98.6%","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","417","87.2%","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":981},{"label":"Mar","value":1050},{"label":"Abr","value":795},{"label":"Mai","value":778},{"label":"Jun","value":789},{"label":"Jul","value":823},{"label":"Ago","value":772},{"label":"Set","value":752},{"label":"Out","value":1023},{"label":"Nov","value":1073},{"label":"Dez","value":1078}];
const MX = 1078;
