...
const ACCENT = "#dc2626";
const MODULE = "SMS Marketing";
const PAGE = "Short Codes";
const KPIS = [{"l":"Notificações Enviadas","v":"7.075","t":"+5.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"66.8%","t":"+7.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"88.2%","t":"+14.5%","d":"up"},{"l":"Escalações","v":"1.748","t":"+1.3%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","8.186","93.2%","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.100","71.8%","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.644","93.9%","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.415","79.5%","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.305","80.4%","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":484},{"label":"Mar","value":584},{"label":"Abr","value":863},{"label":"Mai","value":836},{"label":"Jun","value":579},{"label":"Jul","value":529},{"label":"Ago","value":532},{"label":"Set","value":604},{"label":"Out","value":851},{"label":"Nov","value":789},{"label":"Dez","value":495}];
const MX = 863;
