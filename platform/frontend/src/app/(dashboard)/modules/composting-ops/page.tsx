...
export default function CompostingOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Composting Ops</h1><p className="text-sm text-muted-foreground">Composting Ops • iBOS Enterprise</p></div>
