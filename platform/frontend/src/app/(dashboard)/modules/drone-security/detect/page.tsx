...
const ACCENT = "#6366f1";
const MODULE = "Drone Security";
const PAGE = "Detect";
const KPIS = [{"l":"Total Drone Security","v":"5.107","t":"+16.4%","d":"up"},{"l":"Detect Ativos","v":"5.290","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"81.0%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"81","t":"+6.4%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Security #001","Drone Security #002","7.276","2.417","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Security #002","Drone Security #003","6.117","1.405","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Security #003","Drone Security #004","4.695","7.219","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Security #004","Drone Security #005","2.030","4.411","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Security #005","Drone Security #001","6.114","3.622","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":534},{"label":"Mar","value":516},{"label":"Abr","value":826},{"label":"Mai","value":799},{"label":"Jun","value":718},{"label":"Jul","value":494},{"label":"Ago","value":690},{"label":"Set","value":843},{"label":"Out","value":504},{"label":"Nov","value":730},{"label":"Dez","value":504}];
const MX = 858;
