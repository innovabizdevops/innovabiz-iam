...
/* ═══ EDGE3 Edge Inference Engine — Dashboard ═══ */

const ACCENT = "#0f766e";

const KPIS = [
    { label: "Total Registos", value: "3521", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2958", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "812605321", cells: ["EDG-5321", "EDGE3 Edge Inference Engine Item 1", "18/2/2026", "€5421"], status: "active" as const },
    { id: "812608892", cells: ["EDG-8892", "EDGE3 Edge Inference Engine Item 2", "5/9/2026", "€8992"], status: "pending" as const },
    { id: "812612463", cells: ["EDG-3463", "EDGE3 Edge Inference Engine Item 3", "20/4/2026", "€12 563"], status: "completed" as const },
    { id: "812616034", cells: ["EDG-7034", "EDGE3 Edge Inference Engine Item 4", "7/11/2026", "€16 134"], status: "warning" as const },
    { id: "812619605", cells: ["EDG-1605", "EDGE3 Edge Inference Engine Item 5", "22/6/2026", "€19 705"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 61 }, { label: "Fev", value: 70 }, { label: "Mar", value: 79 }, { label: "Abr", value: 88 }, { label: "Mai", value: 97 }, { label: "Jun", value: 26 }];
...
export default function Edge3EdgeInferenceEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDGE3 Edge Inference Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDGE3 Edge Inference Engine</p>
                    </div>
                </div>
