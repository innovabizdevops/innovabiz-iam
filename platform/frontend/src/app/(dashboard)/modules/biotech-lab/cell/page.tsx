...
const KPIS = [{"l":"Dispositivos Online","v":"5.757","t":"+10.5%","d":"up"},{"l":"Dados/Min (MB)","v":"267","t":"+4.9%","d":"up"},{"l":"Alertas Ativos","v":"989","t":"+8.6%","d":"up"},{"l":"Uptime (%)","v":"78.1%","t":"+2.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.018","5.755","2.950","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.055","955","6.506","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","605","3.195","1.334","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.156","1.530","9.053","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.612","6.496","4.021","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":693},{"label":"Mar","value":698},{"label":"Abr","value":371},{"label":"Mai","value":640},{"label":"Jun","value":353},{"label":"Jul","value":518},{"label":"Ago","value":642},{"label":"Set","value":533},{"label":"Out","value":345},{"label":"Nov","value":416},{"label":"Dez","value":699}];
const MX = 699;
