...
const PAGE = "Gene Editing";
const KPIS = [{"l":"Dispositivos Online","v":"5.412","t":"+17.1%","d":"up"},{"l":"Dados/Min (MB)","v":"5.620","t":"+7.3%","d":"up"},{"l":"Alertas Ativos","v":"2.354","t":"+16.0%","d":"up"},{"l":"Uptime (%)","v":"65.5%","t":"+11.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.550","4.372","8.024","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.268","801","5.366","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.373","6.135","5.518","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.271","771","5.348","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.166","3.130","5.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":624},{"label":"Mar","value":803},{"label":"Abr","value":438},{"label":"Mai","value":540},{"label":"Jun","value":469},{"label":"Jul","value":531},{"label":"Ago","value":571},{"label":"Set","value":415},{"label":"Out","value":710},{"label":"Nov","value":764},{"label":"Dez","value":543}];
const MX = 803;
