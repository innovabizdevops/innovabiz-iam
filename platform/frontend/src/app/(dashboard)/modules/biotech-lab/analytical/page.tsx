...
const PAGE = "Analytical";
const KPIS = [{"l":"Dispositivos Online","v":"1.394","t":"+0.5%","d":"up"},{"l":"Dados/Min (MB)","v":"7.214","t":"-5.8%","d":"down"},{"l":"Alertas Ativos","v":"7.826","t":"+12.6%","d":"up"},{"l":"Uptime (%)","v":"84.6%","t":"+0.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.382","3.278","3.297","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.990","8.356","7.049","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.425","7.073","4.313","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.590","6.665","5.623","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.094","3.065","5.619","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":734},{"label":"Mar","value":613},{"label":"Abr","value":434},{"label":"Mai","value":737},{"label":"Jun","value":643},{"label":"Jul","value":605},{"label":"Ago","value":562},{"label":"Set","value":487},{"label":"Out","value":694},{"label":"Nov","value":710},{"label":"Dez","value":618}];
const MX = 737;
