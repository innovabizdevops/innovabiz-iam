...
const ACCENT = "#059669";
const MODULE = "Biotech Laboratory";
const PAGE = "Fermentation";
const KPIS = [{"l":"Riscos Identificados","v":"6.951","t":"+1.6%","d":"up"},{"l":"Mitigações Ativas","v":"7.137","t":"+17.9%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"+4.6%","d":"up"},{"l":"Incidentes YTD","v":"4.514","t":"+8.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.875","492","8.041","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.347","3.892","1.414","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.777","7.097","175","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.350","8.743","1.427","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.126","2.616","4.937","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":585},{"label":"Mar","value":567},{"label":"Abr","value":560},{"label":"Mai","value":428},{"label":"Jun","value":501},{"label":"Jul","value":535},{"label":"Ago","value":531},{"label":"Set","value":507},{"label":"Out","value":355},{"label":"Nov","value":507},{"label":"Dez","value":510}];
const MX = 585;
