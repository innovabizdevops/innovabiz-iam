...
const KPIS = [{"l":"Dispositivos Online","v":"5.655","t":"+12.3%","d":"up"},{"l":"Dados/Min (MB)","v":"6.722","t":"-2.8%","d":"down"},{"l":"Alertas Ativos","v":"6.712","t":"+12.3%","d":"up"},{"l":"Uptime (%)","v":"87.1%","t":"+3.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.739","5.249","7.617","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.233","3.709","7.466","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.450","5.606","8.779","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.537","6.373","6.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.565","1.588","7.793","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":837},{"label":"Mar","value":668},{"label":"Abr","value":884},{"label":"Mai","value":938},{"label":"Jun","value":681},{"label":"Jul","value":921},{"label":"Ago","value":958},{"label":"Set","value":756},{"label":"Out","value":864},{"label":"Nov","value":1038},{"label":"Dez","value":729}];
const MX = 1038;
