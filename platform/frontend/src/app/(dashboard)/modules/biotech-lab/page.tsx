...
export default function BiotechLabPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Biotech Lab</h1><p className="text-sm text-muted-foreground">Biotech Lab • iBOS Enterprise</p></div>
