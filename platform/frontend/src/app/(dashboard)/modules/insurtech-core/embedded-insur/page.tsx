...
/* ═══ InsurTech Core — Embedded Insur ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "4195", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "411", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1977", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "52643383", cells: ["INS-3383", "Embedded Insur Item 1", "24/8/2026", "€43 483"], status: "active" as const },
    { id: "52646954", cells: ["INS-6954", "Embedded Insur Item 2", "11/3/2026", "€47 054"], status: "pending" as const },
    { id: "52650525", cells: ["INS-1525", "Embedded Insur Item 3", "26/10/2026", "€625"], status: "completed" as const },
    { id: "52654096", cells: ["INS-5096", "Embedded Insur Item 4", "13/5/2026", "€4196"], status: "warning" as const },
    { id: "52657667", cells: ["INS-8667", "Embedded Insur Item 5", "28/12/2026", "€7767"], status: "active" as const },
];
...
export default function InsurtechCoreEmbeddedInsurPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Embedded Insur</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Embedded Insur</p>
                    </div>
                </div>
