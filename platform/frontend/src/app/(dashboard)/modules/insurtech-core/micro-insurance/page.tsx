...
/* ═══ InsurTech Core — Micro Insurance ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "204", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "392", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2028", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "960635844", cells: ["INS-3844", "Micro Insurance Item 1", "1/1/2026", "€35 944"], status: "active" as const },
    { id: "960639415", cells: ["INS-7415", "Micro Insurance Item 2", "16/8/2026", "€39 515"], status: "pending" as const },
    { id: "960642986", cells: ["INS-1986", "Micro Insurance Item 3", "3/3/2026", "€43 086"], status: "completed" as const },
    { id: "960646557", cells: ["INS-5557", "Micro Insurance Item 4", "18/10/2026", "€46 657"], status: "warning" as const },
    { id: "960650128", cells: ["INS-9128", "Micro Insurance Item 5", "5/5/2026", "€228"], status: "active" as const },
];
...
export default function InsurtechCoreMicroInsurancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Micro Insurance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Micro Insurance</p>
                    </div>
                </div>
