...
/* ═══ InsurTech Core — Parametric Insur ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "3526", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "353", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1501", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1670426685", cells: ["INS-9685", "Parametric Insur Item 1", "26/10/2026", "€26 785"], status: "active" as const },
    { id: "1670430256", cells: ["INS-4256", "Parametric Insur Item 2", "13/5/2026", "€30 356"], status: "pending" as const },
    { id: "1670433827", cells: ["INS-7827", "Parametric Insur Item 3", "28/12/2026", "€33 927"], status: "completed" as const },
    { id: "1670437398", cells: ["INS-2398", "Parametric Insur Item 4", "15/7/2026", "€37 498"], status: "warning" as const },
    { id: "1670440969", cells: ["INS-5969", "Parametric Insur Item 5", "2/2/2026", "€41 069"], status: "active" as const },
];
...
export default function InsurtechCoreParametricInsurPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Parametric Insur</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Parametric Insur</p>
                    </div>
                </div>
