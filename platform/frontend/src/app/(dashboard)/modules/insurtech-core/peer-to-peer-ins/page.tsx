...
/* ═══ InsurTech Core — Peer To Peer Ins ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "897", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "61", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1393", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1864389177", cells: ["INS-4177", "Peer To Peer Ins Item 1", "22/10/2026", "€39 277"], status: "active" as const },
    { id: "1864392748", cells: ["INS-7748", "Peer To Peer Ins Item 2", "9/5/2026", "€42 848"], status: "pending" as const },
    { id: "1864396319", cells: ["INS-2319", "Peer To Peer Ins Item 3", "24/12/2026", "€46 419"], status: "completed" as const },
    { id: "1864399890", cells: ["INS-5890", "Peer To Peer Ins Item 4", "11/7/2026", "€49 990"], status: "warning" as const },
    { id: "1864403461", cells: ["INS-9461", "Peer To Peer Ins Item 5", "26/2/2026", "€3561"], status: "active" as const },
];
...
export default function InsurtechCorePeerToPeerInsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Peer To Peer Ins</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Peer To Peer Ins</p>
                    </div>
                </div>
