...
/* ═══ InsurTech Core — Claims Ai ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "1439", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "259", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3729", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "950077359", cells: ["INS-2359", "Claims Ai Item 1", "8/4/2026", "€27 459"], status: "active" as const },
    { id: "950080930", cells: ["INS-5930", "Claims Ai Item 2", "23/11/2026", "€31 030"], status: "pending" as const },
    { id: "950084501", cells: ["INS-9501", "Claims Ai Item 3", "10/6/2026", "€34 601"], status: "completed" as const },
    { id: "950088072", cells: ["INS-4072", "Claims Ai Item 4", "25/1/2026", "€38 172"], status: "warning" as const },
    { id: "950091643", cells: ["INS-7643", "Claims Ai Item 5", "12/8/2026", "€41 743"], status: "active" as const },
];
...
export default function InsurtechCoreClaimsAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Claims Ai</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Claims Ai</p>
                    </div>
                </div>
