...
/* ═══ InsurTech Core — Fraud Detect Ins ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "4986", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "325", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "535", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "958902257", cells: ["INS-7257", "Fraud Detect Ins Item 1", "6/6/2026", "€2357"], status: "active" as const },
    { id: "958905828", cells: ["INS-1828", "Fraud Detect Ins Item 2", "21/1/2026", "€5928"], status: "pending" as const },
    { id: "958909399", cells: ["INS-5399", "Fraud Detect Ins Item 3", "8/8/2026", "€9499"], status: "completed" as const },
    { id: "958912970", cells: ["INS-8970", "Fraud Detect Ins Item 4", "23/3/2026", "€13 070"], status: "warning" as const },
    { id: "958916541", cells: ["INS-3541", "Fraud Detect Ins Item 5", "10/10/2026", "€16 641"], status: "active" as const },
];
...
export default function InsurtechCoreFraudDetectInsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fraud Detect Ins</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Fraud Detect Ins</p>
                    </div>
                </div>
