...
/* ═══ InsurTech Core — Usage Based ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "2357", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "274", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1458", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1209274574", cells: ["INS-8574", "Usage Based Item 1", "19/3/2026", "€24 674"], status: "active" as const },
    { id: "1209278145", cells: ["INS-3145", "Usage Based Item 2", "6/10/2026", "€28 245"], status: "pending" as const },
    { id: "1209281716", cells: ["INS-6716", "Usage Based Item 3", "21/5/2026", "€31 816"], status: "completed" as const },
    { id: "1209285287", cells: ["INS-1287", "Usage Based Item 4", "8/12/2026", "€35 387"], status: "warning" as const },
    { id: "1209288858", cells: ["INS-4858", "Usage Based Item 5", "23/7/2026", "€38 958"], status: "active" as const },
];
...
export default function InsurtechCoreUsageBasedPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Usage Based</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Usage Based</p>
                    </div>
                </div>
