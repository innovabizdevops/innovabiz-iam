...
/* ═══ InsurTech Core — Wearable Insur ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "870", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "62", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "291", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "13110842", cells: ["INS-7842", "Wearable Insur Item 1", "11/3/2026", "€10 942"], status: "active" as const },
    { id: "13114413", cells: ["INS-2413", "Wearable Insur Item 2", "26/10/2026", "€14 513"], status: "pending" as const },
    { id: "13117984", cells: ["INS-5984", "Wearable Insur Item 3", "13/5/2026", "€18 084"], status: "completed" as const },
    { id: "13121555", cells: ["INS-9555", "Wearable Insur Item 4", "28/12/2026", "€21 655"], status: "warning" as const },
    { id: "13125126", cells: ["INS-4126", "Wearable Insur Item 5", "15/7/2026", "€25 226"], status: "active" as const },
];
...
export default function InsurtechCoreWearableInsurPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wearable Insur</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Wearable Insur</p>
                    </div>
                </div>
