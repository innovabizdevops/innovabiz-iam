...
/* ═══ InsurTech Core — On Demand Cover ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "1981", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "419", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3812", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "133403103", cells: ["INS-6103", "On Demand Cover Item 1", "16/4/2026", "€3203"], status: "active" as const },
    { id: "133406674", cells: ["INS-9674", "On Demand Cover Item 2", "3/11/2026", "€6774"], status: "pending" as const },
    { id: "133410245", cells: ["INS-4245", "On Demand Cover Item 3", "18/6/2026", "€10 345"], status: "completed" as const },
    { id: "133413816", cells: ["INS-7816", "On Demand Cover Item 4", "5/1/2026", "€13 916"], status: "warning" as const },
    { id: "133417387", cells: ["INS-2387", "On Demand Cover Item 5", "20/8/2026", "€17 487"], status: "active" as const },
];
...
export default function InsurtechCoreOnDemandCoverPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">On Demand Cover</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • On Demand Cover</p>
                    </div>
                </div>
