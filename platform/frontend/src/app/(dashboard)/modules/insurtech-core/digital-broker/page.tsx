...
/* ═══ InsurTech Core — Digital Broker ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "1215", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "199", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "277", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "92%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1867876195", cells: ["INS-8195", "Digital Broker Item 1", "4/8/2026", "€26 295"], status: "active" as const },
    { id: "1867879766", cells: ["INS-2766", "Digital Broker Item 2", "19/3/2026", "€29 866"], status: "pending" as const },
    { id: "1867883337", cells: ["INS-6337", "Digital Broker Item 3", "6/10/2026", "€33 437"], status: "completed" as const },
    { id: "1867886908", cells: ["INS-9908", "Digital Broker Item 4", "21/5/2026", "€37 008"], status: "warning" as const },
    { id: "1867890479", cells: ["INS-4479", "Digital Broker Item 5", "8/12/2026", "€40 579"], status: "active" as const },
];
...
export default function InsurtechCoreDigitalBrokerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Broker</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InsurTech Core • Digital Broker</p>
                    </div>
                </div>
