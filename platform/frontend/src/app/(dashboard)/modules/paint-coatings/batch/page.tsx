...
const PAGE = "Batch";
const KPIS = [{"l":"Total Paint Coatings","v":"4.905","t":"-4.2%","d":"down"},{"l":"Batch Ativos","v":"8.892","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+1.3%","d":"up"}];
const COLS = ["ID","Batch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Paint Coatings #001","Paint Coatings #002","5.755","4.125","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Paint Coatings #002","Paint Coatings #003","7.278","4.396","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Paint Coatings #003","Paint Coatings #004","3.235","3.935","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Paint Coatings #004","Paint Coatings #005","528","2.626","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Paint Coatings #005","Paint Coatings #001","231","3.419","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":680},{"label":"Mar","value":579},{"label":"Abr","value":668},{"label":"Mai","value":605},{"label":"Jun","value":917},{"label":"Jul","value":622},{"label":"Ago","value":808},{"label":"Set","value":734},{"label":"Out","value":794},{"label":"Nov","value":621},{"label":"Dez","value":833}];
const MX = 943;
