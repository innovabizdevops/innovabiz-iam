...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.712","t":"+6.3%","d":"up"},{"l":"NC Abertas","v":"2.689","t":"-0.7%","d":"down"},{"l":"Conformidade (%)","v":"86.1%","t":"+13.6%","d":"up"},{"l":"CAPAs Pendentes","v":"2.808","t":"-3.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.318","80.4%","1.250","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.295","71.1%","4.921","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","389","83.5%","7.012","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","840","87.1%","503","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.363","99.5%","8.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":925},{"label":"Mar","value":699},{"label":"Abr","value":684},{"label":"Mai","value":770},{"label":"Jun","value":715},{"label":"Jul","value":872},{"label":"Ago","value":649},{"label":"Set","value":725},{"label":"Out","value":885},{"label":"Nov","value":797},{"label":"Dez","value":626}];
const MX = 925;
