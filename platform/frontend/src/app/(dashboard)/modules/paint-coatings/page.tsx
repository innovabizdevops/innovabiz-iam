...
/* ═══ Paint & Coatings — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "5014", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3622", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€145K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2089281114", cells: ["PAI-4114", "Paint & Coatings Item 1", "19/7/2026", "€31 214"], status: "active" as const },
    { id: "2089284685", cells: ["PAI-7685", "Paint & Coatings Item 2", "6/2/2026", "€34 785"], status: "pending" as const },
    { id: "2089288256", cells: ["PAI-2256", "Paint & Coatings Item 3", "21/9/2026", "€38 356"], status: "completed" as const },
    { id: "2089291827", cells: ["PAI-5827", "Paint & Coatings Item 4", "8/4/2026", "€41 927"], status: "warning" as const },
    { id: "2089295398", cells: ["PAI-9398", "Paint & Coatings Item 5", "23/11/2026", "€45 498"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Paint & Coatings</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Paint & Coatings</p>
                    </div>
                </div>
