...
const PAGE = "Formula";
const KPIS = [{"l":"Formulários Ativos","v":"2.184","t":"+4.3%","d":"up"},{"l":"Submissões/Dia","v":"3702","t":"+11.9%","d":"up"},{"l":"Documentos Gerados","v":"6.123","t":"-3.7%","d":"down"},{"l":"Templates","v":"7.614","t":"+7.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.719","2026-02-01","4.383","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.230","2026-03-27","2.568","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.404","2026-01-21","1.813","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.670","2026-02-28","6.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.048","2026-02-18","6.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":592},{"label":"Mar","value":418},{"label":"Abr","value":359},{"label":"Mai","value":496},{"label":"Jun","value":433},{"label":"Jul","value":348},{"label":"Ago","value":532},{"label":"Set","value":492},{"label":"Out","value":517},{"label":"Nov","value":621},{"label":"Dez","value":380}];
const MX = 621;
