...
const PAGE = "Per Diem Rules";
const KPIS = [{"l":"Ideias Submetidas","v":"3.922","t":"+10.7%","d":"up"},{"l":"Patentes (YTD)","v":"8.399","t":"+2.2%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.212","t":"+10.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€16.5M","t":"-0.7%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.115","86.0%","3.736","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.143","98.9%","8.776","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.161","84.3%","1.831","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.517","99.3%","6.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.399","99.1%","7.324","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":462},{"label":"Mar","value":349},{"label":"Abr","value":646},{"label":"Mai","value":575},{"label":"Jun","value":344},{"label":"Jul","value":411},{"label":"Ago","value":628},{"label":"Set","value":507},{"label":"Out","value":370},{"label":"Nov","value":439},{"label":"Dez","value":496}];
const MX = 646;
