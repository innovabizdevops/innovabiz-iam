...
const PAGE = "Corporate Cards";
const KPIS = [{"l":"Total Expense Mgmt","v":"4.399","t":"-5.3%","d":"down"},{"l":"Corporate Cards Ativos","v":"491","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"55","t":"+1.7%","d":"up"}];
const COLS = ["ID","Corporate Cards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expense Mgmt #001","Expense Mgmt #002","676","7.831","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Expense Mgmt #002","Expense Mgmt #003","6.580","5.874","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Expense Mgmt #003","Expense Mgmt #004","5.109","8.596","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Expense Mgmt #004","Expense Mgmt #005","8.724","6.485","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expense Mgmt #005","Expense Mgmt #001","4.454","3.351","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":700},{"label":"Mar","value":741},{"label":"Abr","value":720},{"label":"Mai","value":702},{"label":"Jun","value":726},{"label":"Jul","value":916},{"label":"Ago","value":692},{"label":"Set","value":1023},{"label":"Out","value":761},{"label":"Nov","value":853},{"label":"Dez","value":827}];
const MX = 1023;
