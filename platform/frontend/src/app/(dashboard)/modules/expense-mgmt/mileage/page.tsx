...
const KPIS = [{"l":"Total Expense Mgmt","v":"3.775","t":"-3.7%","d":"down"},{"l":"Mileage Tracker Ativos","v":"8.388","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"81","t":"+3.4%","d":"up"}];
const COLS = ["ID","Mileage Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expense Mgmt #001","Expense Mgmt #002","8.794","1.462","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Expense Mgmt #002","Expense Mgmt #003","4.627","1.258","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Expense Mgmt #003","Expense Mgmt #004","6.069","3.778","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Expense Mgmt #004","Expense Mgmt #005","3.373","8.948","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expense Mgmt #005","Expense Mgmt #001","426","7.166","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":546},{"label":"Mar","value":590},{"label":"Abr","value":608},{"label":"Mai","value":492},{"label":"Jun","value":794},{"label":"Jul","value":609},{"label":"Ago","value":631},{"label":"Set","value":553},{"label":"Out","value":672},{"label":"Nov","value":618},{"label":"Dez","value":430}];
const MX = 794;
