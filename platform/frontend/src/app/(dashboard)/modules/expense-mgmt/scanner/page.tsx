...
const ACCENT = "#dc2626";
const MODULE = "Expense Management";
const PAGE = "Receipt Scanner AI";
const KPIS = [{"l":"Total Expense Mgmt","v":"3.132","t":"-5.1%","d":"down"},{"l":"Receipt Scanner AI Ativos","v":"4.318","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"60","t":"-3.6%","d":"down"}];
const COLS = ["ID","Receipt Scanner AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expense Mgmt #001","Expense Mgmt #002","6.499","3.767","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Expense Mgmt #002","Expense Mgmt #003","176","2.520","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Expense Mgmt #003","Expense Mgmt #004","5.067","1.652","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Expense Mgmt #004","Expense Mgmt #005","251","3.321","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expense Mgmt #005","Expense Mgmt #001","7.930","1.669","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":716},{"label":"Mar","value":780},{"label":"Abr","value":989},{"label":"Mai","value":815},{"label":"Jun","value":960},{"label":"Jul","value":874},{"label":"Ago","value":1023},{"label":"Set","value":903},{"label":"Out","value":716},{"label":"Nov","value":831},{"label":"Dez","value":915}];
const MX = 1023;
