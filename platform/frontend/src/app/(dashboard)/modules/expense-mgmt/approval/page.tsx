...
const PAGE = "Approval Workflow";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.462","t":"+0.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.6%","t":"+8.3%","d":"up"},{"l":"Tempo Médio (h)","v":"207h","t":"+11.5%","d":"up"},{"l":"Rejeitadas (%)","v":"65.0%","t":"-0.5%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.724","€ 29878.11","133","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.763","€ 44742.71","6.720","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.855","€ 22088.21","4.283","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.997","€ 20891.63","1.206","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.871","€ 42086.57","1.968","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":491},{"label":"Mar","value":508},{"label":"Abr","value":263},{"label":"Mai","value":369},{"label":"Jun","value":311},{"label":"Jul","value":331},{"label":"Ago","value":263},{"label":"Set","value":455},{"label":"Out","value":333},{"label":"Nov","value":522},{"label":"Dez","value":398}];
const MX = 627;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>Flow</span></h1>
                </div>
