...
const PAGE = "Expense Report Form";
const KPIS = [{"l":"Formulários Ativos","v":"7.179","t":"+14.4%","d":"up"},{"l":"Submissões/Dia","v":"1240","t":"+3.6%","d":"up"},{"l":"Documentos Gerados","v":"574","t":"+7.8%","d":"up"},{"l":"Templates","v":"473","t":"+5.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.972","2026-01-17","5.654","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.781","2026-01-08","7.613","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.914","2026-01-26","5.164","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.805","2026-03-05","4.567","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","515","2026-01-13","5.599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":448},{"label":"Mar","value":243},{"label":"Abr","value":589},{"label":"Mai","value":409},{"label":"Jun","value":359},{"label":"Jul","value":292},{"label":"Ago","value":331},{"label":"Set","value":486},{"label":"Out","value":275},{"label":"Nov","value":503},{"label":"Dez","value":502}];
const MX = 589;
