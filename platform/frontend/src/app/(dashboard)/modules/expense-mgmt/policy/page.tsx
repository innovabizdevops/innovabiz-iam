...
const PAGE = "Policy Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.681","t":"+1.7%","d":"up"},{"l":"NC Abertas","v":"8.654","t":"-4.6%","d":"down"},{"l":"Conformidade (%)","v":"73.2%","t":"+14.7%","d":"up"},{"l":"CAPAs Pendentes","v":"787","t":"+3.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.843","81.6%","2.303","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.413","75.6%","1.908","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","514","83.3%","3.520","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.500","86.4%","6.585","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.042","89.2%","1.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":216},{"label":"Mar","value":389},{"label":"Abr","value":523},{"label":"Mai","value":489},{"label":"Jun","value":250},{"label":"Jul","value":460},{"label":"Ago","value":315},{"label":"Set","value":585},{"label":"Out","value":245},{"label":"Nov","value":332},{"label":"Dez","value":587}];
const MX = 587;
