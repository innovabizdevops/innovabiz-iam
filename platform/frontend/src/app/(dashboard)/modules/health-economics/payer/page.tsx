...
const PAGE = "Payer";
const KPIS = [{"l":"Total Health Economics","v":"5.887","t":"+0.1%","d":"up"},{"l":"Payer Ativos","v":"5.108","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"73","t":"+12.2%","d":"up"}];
const COLS = ["ID","Payer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Economics #001","Health Economics #002","5.446","1.981","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Health Economics #002","Health Economics #003","636","5.639","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Economics #003","Health Economics #004","6.935","8.373","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Health Economics #004","Health Economics #005","9.089","646","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Economics #005","Health Economics #001","1.070","8.086","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":570},{"label":"Mar","value":754},{"label":"Abr","value":695},{"label":"Mai","value":727},{"label":"Jun","value":833},{"label":"Jul","value":846},{"label":"Ago","value":651},{"label":"Set","value":908},{"label":"Out","value":917},{"label":"Nov","value":845},{"label":"Dez","value":577}];
const MX = 917;
