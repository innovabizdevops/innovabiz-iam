...
const PAGE = "Budget Impact";
const KPIS = [{"l":"Projetos Sociais","v":"2.214","t":"+15.0%","d":"up"},{"l":"Beneficiários","v":"4.929","t":"+0.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€17626","t":"+2.2%","d":"up"},{"l":"Score Impacto","v":"69","t":"+12.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.295","€ 34399.45","969","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.343","€ 29713.64","4.230","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.560","€ 14545.36","1.010","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.801","€ 10827.00","2.749","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","9.034","€ 6119.04","3.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":557},{"label":"Mar","value":668},{"label":"Abr","value":386},{"label":"Mai","value":524},{"label":"Jun","value":568},{"label":"Jul","value":549},{"label":"Ago","value":534},{"label":"Set","value":604},{"label":"Out","value":655},{"label":"Nov","value":397},{"label":"Dez","value":409}];
const MX = 668;
