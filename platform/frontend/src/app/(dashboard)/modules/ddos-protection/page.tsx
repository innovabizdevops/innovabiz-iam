...
/* ═══ DDoS Protection Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "2971", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "885", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€210K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "38969271", cells: ["DDO-9271", "DDoS Protection Platform Item 1", "20/4/2026", "€19 371"], status: "active" as const },
    { id: "38972842", cells: ["DDO-3842", "DDoS Protection Platform Item 2", "7/11/2026", "€22 942"], status: "pending" as const },
    { id: "38976413", cells: ["DDO-7413", "DDoS Protection Platform Item 3", "22/6/2026", "€26 513"], status: "completed" as const },
    { id: "38979984", cells: ["DDO-1984", "DDoS Protection Platform Item 4", "9/1/2026", "€30 084"], status: "warning" as const },
    { id: "38983555", cells: ["DDO-5555", "DDoS Protection Platform Item 5", "24/8/2026", "€33 655"], status: "active" as const },
];
...
export default function DdosProtectionPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">DDoS Protection Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • DDoS Protection Platform</p>
                    </div>
                </div>
