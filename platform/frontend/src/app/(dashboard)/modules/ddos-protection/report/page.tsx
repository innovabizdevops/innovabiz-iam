...
const PAGE = "Report";
const KPIS = [{"l":"Total Ddos Protection","v":"4.051","t":"+7.6%","d":"up"},{"l":"Report Ativos","v":"8.405","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"65.3%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"74","t":"+7.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ddos Protection #001","Ddos Protection #002","7.885","1.197","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Ddos Protection #002","Ddos Protection #003","7.709","1.961","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Ddos Protection #003","Ddos Protection #004","3.143","5.400","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Ddos Protection #004","Ddos Protection #005","2.769","3.994","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ddos Protection #005","Ddos Protection #001","3.110","306","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":950},{"label":"Mar","value":923},{"label":"Abr","value":702},{"label":"Mai","value":698},{"label":"Jun","value":651},{"label":"Jul","value":1021},{"label":"Ago","value":876},{"label":"Set","value":962},{"label":"Out","value":830},{"label":"Nov","value":965},{"label":"Dez","value":662}];
const MX = 1021;
