...
const PAGE = "Plan";
const KPIS = [{"l":"Total Ddos Protection","v":"6.420","t":"+12.4%","d":"up"},{"l":"Plan Ativos","v":"1.103","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"72","t":"+5.2%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ddos Protection #001","Ddos Protection #002","4.608","4.266","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Ddos Protection #002","Ddos Protection #003","191","3.816","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Ddos Protection #003","Ddos Protection #004","5.336","1.611","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Ddos Protection #004","Ddos Protection #005","3.931","3.405","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ddos Protection #005","Ddos Protection #001","8.783","8.490","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":791},{"label":"Mar","value":694},{"label":"Abr","value":611},{"label":"Mai","value":921},{"label":"Jun","value":552},{"label":"Jul","value":814},{"label":"Ago","value":571},{"label":"Set","value":839},{"label":"Out","value":666},{"label":"Nov","value":861},{"label":"Dez","value":617}];
const MX = 921;
