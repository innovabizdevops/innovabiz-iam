...
const PAGE = "Clean";
const KPIS = [{"l":"Projetos Melhoria","v":"7.361","t":"+17.5%","d":"up"},{"l":"Savings (€)","v":"€45476","t":"+1.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.2%","t":"+5.8%","d":"up"},{"l":"Ciclos PDCA","v":"3.713","t":"+17.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","791","€ 21810.54","711","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.754","€ 20796.22","8.740","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.127","€ 4098.78","1.456","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.879","€ 1443.96","3.864","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.994","€ 9135.55","504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":566},{"label":"Mar","value":309},{"label":"Abr","value":559},{"label":"Mai","value":422},{"label":"Jun","value":389},{"label":"Jul","value":306},{"label":"Ago","value":378},{"label":"Set","value":364},{"label":"Out","value":627},{"label":"Nov","value":382},{"label":"Dez","value":548}];
const MX = 627;
