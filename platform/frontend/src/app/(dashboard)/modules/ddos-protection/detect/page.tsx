...
const ACCENT = "#7f1d1d";
const MODULE = "DDoS Protection Platform";
const PAGE = "Detect";
const KPIS = [{"l":"Total Ddos Protection","v":"3.032","t":"-0.1%","d":"down"},{"l":"Detect Ativos","v":"5.383","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"67.9%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"91","t":"+10.8%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ddos Protection #001","Ddos Protection #002","3.159","3.476","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ddos Protection #002","Ddos Protection #003","4.573","6.039","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Ddos Protection #003","Ddos Protection #004","6.339","8.880","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Ddos Protection #004","Ddos Protection #005","3.844","3.580","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ddos Protection #005","Ddos Protection #001","1.717","6.448","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":743},{"label":"Mar","value":833},{"label":"Abr","value":611},{"label":"Mai","value":801},{"label":"Jun","value":560},{"label":"Jul","value":642},{"label":"Ago","value":554},{"label":"Set","value":815},{"label":"Out","value":875},{"label":"Nov","value":885},{"label":"Dez","value":694}];
const MX = 885;
