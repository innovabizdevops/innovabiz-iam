...
const PAGE = "Mitigate";
const KPIS = [{"l":"Total Ddos Protection","v":"564","t":"+14.5%","d":"up"},{"l":"Mitigate Ativos","v":"5.822","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"89","t":"-2.2%","d":"down"}];
const COLS = ["ID","Mitigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ddos Protection #001","Ddos Protection #002","5.607","1.336","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Ddos Protection #002","Ddos Protection #003","1.186","1.455","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ddos Protection #003","Ddos Protection #004","7.104","2.127","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Ddos Protection #004","Ddos Protection #005","1.120","3.589","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ddos Protection #005","Ddos Protection #001","7.987","6.712","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":466},{"label":"Mar","value":229},{"label":"Abr","value":607},{"label":"Mai","value":584},{"label":"Jun","value":482},{"label":"Jul","value":306},{"label":"Ago","value":233},{"label":"Set","value":346},{"label":"Out","value":537},{"label":"Nov","value":341},{"label":"Dez","value":537}];
const MX = 607;
