...
/* ═══ AIX Cognitive Services — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "8376", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1446", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€363K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1993135676", cells: ["AIX-5676", "AIX Cognitive Services Item 1", "1/9/2026", "€35 776"], status: "active" as const },
    { id: "1993139247", cells: ["AIX-9247", "AIX Cognitive Services Item 2", "16/4/2026", "€39 347"], status: "pending" as const },
    { id: "1993142818", cells: ["AIX-3818", "AIX Cognitive Services Item 3", "3/11/2026", "€42 918"], status: "completed" as const },
    { id: "1993146389", cells: ["AIX-7389", "AIX Cognitive Services Item 4", "18/6/2026", "€46 489"], status: "warning" as const },
    { id: "1993149960", cells: ["AIX-1960", "AIX Cognitive Services Item 5", "5/1/2026", "€50 060"], status: "active" as const },
];
...
export default function AixCognitiveServicesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AIX Cognitive Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AIX Cognitive Services</p>
                    </div>
                </div>
