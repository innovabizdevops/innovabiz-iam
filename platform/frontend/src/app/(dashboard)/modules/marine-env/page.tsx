...
export default function MarineEnvPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Marine Env</h1><p className="text-sm text-muted-foreground">Marine Env • iBOS Enterprise</p></div>
