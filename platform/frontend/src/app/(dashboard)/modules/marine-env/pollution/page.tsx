...
const ACCENT = "#6366f1";
const MODULE = "Marine Environment";
const PAGE = "Pollution";
const KPIS = [{"l":"Surveys Ativos","v":"7.637","t":"-4.2%","d":"down"},{"l":"Respostas/Semana","v":"3951","t":"-2.2%","d":"down"},{"l":"NPS Médio","v":"69","t":"+7.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"67.5%","t":"+10.2%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","8.115","93","91.4%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.119","71","88.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","2.528","83","90.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.249","65","95.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","985","91","91.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":578},{"label":"Mar","value":679},{"label":"Abr","value":673},{"label":"Mai","value":506},{"label":"Jun","value":507},{"label":"Jul","value":715},{"label":"Ago","value":651},{"label":"Set","value":502},{"label":"Out","value":712},{"label":"Nov","value":698},{"label":"Dez","value":629}];
const MX = 715;
