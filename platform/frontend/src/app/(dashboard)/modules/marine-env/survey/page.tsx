...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"8.268","t":"-4.7%","d":"down"},{"l":"Respostas/Semana","v":"2267","t":"-0.1%","d":"down"},{"l":"NPS Médio","v":"82","t":"+10.9%","d":"up"},{"l":"Taxa Resposta (%)","v":"67.1%","t":"-4.0%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.683","91","95.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.591","60","93.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.768","75","90.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","2.552","72","97.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.681","75","96.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":339},{"label":"Mar","value":504},{"label":"Abr","value":506},{"label":"Mai","value":314},{"label":"Jun","value":415},{"label":"Jul","value":481},{"label":"Ago","value":243},{"label":"Set","value":379},{"label":"Out","value":256},{"label":"Nov","value":586},{"label":"Dez","value":315}];
const MX = 586;
