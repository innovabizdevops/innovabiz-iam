...
const PAGE = "Fisheries";
const KPIS = [{"l":"Embarcações Ativas","v":"5.745","t":"+1.2%","d":"up"},{"l":"Capturas (ton)","v":"3678","t":"+16.9%","d":"up"},{"l":"Quota Utilizada (%)","v":"90.2%","t":"-3.0%","d":"down"},{"l":"Certificações","v":"6.840","t":"+12.6%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","2472","8.245","74.1%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","4092","942","99.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3972","1.674","89.5%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","1306","1.966","74.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","4547","2.532","79.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":545},{"label":"Mar","value":347},{"label":"Abr","value":358},{"label":"Mai","value":581},{"label":"Jun","value":513},{"label":"Jul","value":658},{"label":"Ago","value":446},{"label":"Set","value":548},{"label":"Out","value":429},{"label":"Nov","value":400},{"label":"Dez","value":517}];
const MX = 658;
