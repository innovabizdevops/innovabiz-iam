...
const PAGE = "MPA";
const KPIS = [{"l":"Total Marine Env","v":"1.041","t":"+13.9%","d":"up"},{"l":"MPA Ativos","v":"1.600","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+5.3%","d":"up"}];
const COLS = ["ID","MPA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marine Env #001","Marine Env #002","1.082","9.069","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Marine Env #002","Marine Env #003","4.698","7.496","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Marine Env #003","Marine Env #004","383","7.511","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Marine Env #004","Marine Env #005","1.406","1.823","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marine Env #005","Marine Env #001","8.535","7.765","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":471},{"label":"Mar","value":430},{"label":"Abr","value":540},{"label":"Mai","value":510},{"label":"Jun","value":593},{"label":"Jul","value":449},{"label":"Ago","value":506},{"label":"Set","value":419},{"label":"Out","value":646},{"label":"Nov","value":703},{"label":"Dez","value":713}];
const MX = 713;
