...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Service Catalog";
const PAGE = "Provision";
const KPIS = [{"l":"Dashboards Ativos","v":"4.674","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"351","t":"-0.3%","d":"down"},{"l":"Dados Processados (GB)","v":"5.980","t":"+8.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.386","t":"+2.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5042","2026-01-09","7.469","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","837","2026-02-15","4.715","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4128","2026-03-02","3.872","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3416","2026-01-10","1.280","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3780","2026-02-02","8.529","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":686},{"label":"Mar","value":606},{"label":"Abr","value":703},{"label":"Mai","value":472},{"label":"Jun","value":753},{"label":"Jul","value":617},{"label":"Ago","value":474},{"label":"Set","value":548},{"label":"Out","value":419},{"label":"Nov","value":679},{"label":"Dez","value":592}];
const MX = 753;
