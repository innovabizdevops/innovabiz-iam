...
/* ═══ COSMOS Service Catalog — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "3193", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3043", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€155K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1699357893", cells: ["COS-5893", "COSMOS Service Catalog Item 1", "10/10/2026", "€7993"], status: "active" as const },
    { id: "1699361464", cells: ["COS-9464", "COSMOS Service Catalog Item 2", "25/5/2026", "€11 564"], status: "pending" as const },
    { id: "1699365035", cells: ["COS-4035", "COSMOS Service Catalog Item 3", "12/12/2026", "€15 135"], status: "completed" as const },
    { id: "1699368606", cells: ["COS-7606", "COSMOS Service Catalog Item 4", "27/7/2026", "€18 706"], status: "warning" as const },
    { id: "1699372177", cells: ["COS-2177", "COSMOS Service Catalog Item 5", "14/2/2026", "€22 277"], status: "active" as const },
];
...
export default function CosmosServiceCatalogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Service Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Service Catalog</p>
                    </div>
                </div>
