...
const PAGE = "Request";
const KPIS = [{"l":"Dashboards Ativos","v":"704","t":"+6.5%","d":"up"},{"l":"Queries/Dia","v":"1559","t":"+15.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.593","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"2.001","t":"+14.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1181","2026-01-20","4.792","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","748","2026-02-10","831","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1353","2026-01-08","5.799","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3565","2026-02-15","3.349","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2711","2026-02-07","4.330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":549},{"label":"Mar","value":817},{"label":"Abr","value":715},{"label":"Mai","value":662},{"label":"Jun","value":714},{"label":"Jul","value":588},{"label":"Ago","value":469},{"label":"Set","value":513},{"label":"Out","value":627},{"label":"Nov","value":748},{"label":"Dez","value":721}];
const MX = 817;
