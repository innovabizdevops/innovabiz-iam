...
const PAGE = "Track";
const KPIS = [{"l":"Dashboards Ativos","v":"1.049","t":"-1.4%","d":"down"},{"l":"Queries/Dia","v":"749","t":"-4.5%","d":"down"},{"l":"Dados Processados (GB)","v":"5.274","t":"+11.6%","d":"up"},{"l":"Utilizadores Analytics","v":"5.698","t":"+6.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1512","2026-03-03","7.591","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1768","2026-03-01","1.563","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2216","2026-03-27","5.174","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4893","2026-01-10","6.157","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1032","2026-03-07","5.108","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":865},{"label":"Mar","value":851},{"label":"Abr","value":772},{"label":"Mai","value":751},{"label":"Jun","value":876},{"label":"Jul","value":671},{"label":"Ago","value":917},{"label":"Set","value":623},{"label":"Out","value":724},{"label":"Nov","value":803},{"label":"Dez","value":837}];
const MX = 917;
