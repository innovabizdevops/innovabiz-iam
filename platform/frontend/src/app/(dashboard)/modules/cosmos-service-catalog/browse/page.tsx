...
const PAGE = "Browse";
const KPIS = [{"l":"Dashboards Ativos","v":"849","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"4333","t":"+2.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.901","t":"+3.0%","d":"up"},{"l":"Utilizadores Analytics","v":"7.580","t":"-0.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2277","2026-02-28","8.086","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2520","2026-02-25","7.880","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3439","2026-01-19","244","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1748","2026-02-17","1.686","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1193","2026-01-28","4.524","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":490},{"label":"Mar","value":694},{"label":"Abr","value":776},{"label":"Mai","value":810},{"label":"Jun","value":796},{"label":"Jul","value":810},{"label":"Ago","value":578},{"label":"Set","value":514},{"label":"Out","value":711},{"label":"Nov","value":705},{"label":"Dez","value":675}];
const MX = 815;
