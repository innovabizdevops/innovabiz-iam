...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"5.044","t":"+8.3%","d":"up"},{"l":"Queries/Dia","v":"3364","t":"-3.9%","d":"down"},{"l":"Dados Processados (GB)","v":"2.410","t":"+7.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.886","t":"-3.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3605","2026-03-05","2.346","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4181","2026-03-02","1.310","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3711","2026-03-03","1.917","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","451","2026-01-01","4.579","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2662","2026-01-28","8.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":715},{"label":"Mar","value":933},{"label":"Abr","value":837},{"label":"Mai","value":825},{"label":"Jun","value":851},{"label":"Jul","value":1009},{"label":"Ago","value":892},{"label":"Set","value":1023},{"label":"Out","value":804},{"label":"Nov","value":772},{"label":"Dez","value":796}];
const MX = 1023;
