...
const PAGE = "Harvest";
const KPIS = [{"l":"Total Bamboo Industry","v":"1.000","t":"+6.4%","d":"up"},{"l":"Harvest Ativos","v":"5.816","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"69","t":"+7.1%","d":"up"}];
const COLS = ["ID","Harvest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bamboo Industry #001","Bamboo Industry #002","8.033","8.175","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Bamboo Industry #002","Bamboo Industry #003","4.193","5.899","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Bamboo Industry #003","Bamboo Industry #004","4.282","4.939","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Bamboo Industry #004","Bamboo Industry #005","436","1.027","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bamboo Industry #005","Bamboo Industry #001","6.989","439","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":636},{"label":"Mar","value":720},{"label":"Abr","value":737},{"label":"Mai","value":778},{"label":"Jun","value":507},{"label":"Jul","value":695},{"label":"Ago","value":563},{"label":"Set","value":540},{"label":"Out","value":781},{"label":"Nov","value":656},{"label":"Dez","value":829}];
const MX = 829;
