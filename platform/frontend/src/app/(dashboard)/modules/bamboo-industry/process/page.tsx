...
const PAGE = "Process";
const KPIS = [{"l":"Total Bamboo Industry","v":"7.470","t":"+3.7%","d":"up"},{"l":"Process Ativos","v":"6.440","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+3.4%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bamboo Industry #001","Bamboo Industry #002","4.969","7.047","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Bamboo Industry #002","Bamboo Industry #003","6.990","3.037","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Bamboo Industry #003","Bamboo Industry #004","4.032","8.323","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Bamboo Industry #004","Bamboo Industry #005","2.056","3.905","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bamboo Industry #005","Bamboo Industry #001","2.231","8.706","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":347},{"label":"Mar","value":699},{"label":"Abr","value":447},{"label":"Mai","value":638},{"label":"Jun","value":559},{"label":"Jul","value":580},{"label":"Ago","value":466},{"label":"Set","value":684},{"label":"Out","value":522},{"label":"Nov","value":586},{"label":"Dez","value":609}];
const MX = 699;
