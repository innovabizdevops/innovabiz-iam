...
const ACCENT = "#14532d";
const MODULE = "Bamboo Industry";
const PAGE = "Plantation";
const KPIS = [{"l":"Total Bamboo Industry","v":"455","t":"+13.5%","d":"up"},{"l":"Plantation Ativos","v":"7.775","t":"+13.8%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"95","t":"+2.1%","d":"up"}];
const COLS = ["ID","Plantation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bamboo Industry #001","Bamboo Industry #002","6.231","6.204","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Bamboo Industry #002","Bamboo Industry #003","6.915","4.879","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Bamboo Industry #003","Bamboo Industry #004","7.217","5.882","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Bamboo Industry #004","Bamboo Industry #005","6.122","811","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bamboo Industry #005","Bamboo Industry #001","4.331","2.041","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":850},{"label":"Mar","value":668},{"label":"Abr","value":838},{"label":"Mai","value":709},{"label":"Jun","value":575},{"label":"Jul","value":812},{"label":"Ago","value":720},{"label":"Set","value":774},{"label":"Out","value":736},{"label":"Nov","value":821},{"label":"Dez","value":683}];
const MX = 862;
