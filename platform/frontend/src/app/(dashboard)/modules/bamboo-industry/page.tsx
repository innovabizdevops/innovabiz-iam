...
/* ═══ Bamboo Industry — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "242", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2191", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€346K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "839242942", cells: ["BAM-2942", "Bamboo Industry Item 1", "7/11/2026", "€43 042"], status: "active" as const },
    { id: "839246513", cells: ["BAM-6513", "Bamboo Industry Item 2", "22/6/2026", "€46 613"], status: "pending" as const },
    { id: "839250084", cells: ["BAM-1084", "Bamboo Industry Item 3", "9/1/2026", "€184"], status: "completed" as const },
    { id: "839253655", cells: ["BAM-4655", "Bamboo Industry Item 4", "24/8/2026", "€3755"], status: "warning" as const },
    { id: "839257226", cells: ["BAM-8226", "Bamboo Industry Item 5", "11/3/2026", "€7326"], status: "active" as const },
];
...
export default function BambooIndustryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bamboo Industry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Bamboo Industry</p>
                    </div>
                </div>
