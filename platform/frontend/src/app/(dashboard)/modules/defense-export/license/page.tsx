...
const PAGE = "License";
const KPIS = [{"l":"Total Defense Export","v":"1.078","t":"+16.6%","d":"up"},{"l":"License Ativos","v":"8.907","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"66","t":"-4.9%","d":"down"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Export #001","Defense Export #002","903","3.831","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Export #002","Defense Export #003","6.031","6.885","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Export #003","Defense Export #004","5.299","8.308","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Export #004","Defense Export #005","2.771","5.920","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Export #005","Defense Export #001","4.220","1.505","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":713},{"label":"Mar","value":716},{"label":"Abr","value":504},{"label":"Mai","value":456},{"label":"Jun","value":609},{"label":"Jul","value":689},{"label":"Ago","value":685},{"label":"Set","value":476},{"label":"Out","value":629},{"label":"Nov","value":656},{"label":"Dez","value":645}];
const MX = 716;
