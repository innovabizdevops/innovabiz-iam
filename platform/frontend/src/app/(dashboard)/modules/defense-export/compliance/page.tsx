...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.957","t":"+12.6%","d":"up"},{"l":"NC Abertas","v":"3.671","t":"-1.3%","d":"down"},{"l":"Conformidade (%)","v":"88.7%","t":"+17.9%","d":"up"},{"l":"CAPAs Pendentes","v":"9.068","t":"+10.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.806","82.1%","2.323","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.132","91.2%","6.795","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.738","84.9%","5.949","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.693","89.4%","5.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.839","81.3%","3.827","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":885},{"label":"Mar","value":732},{"label":"Abr","value":768},{"label":"Mai","value":710},{"label":"Jun","value":608},{"label":"Jul","value":743},{"label":"Ago","value":765},{"label":"Set","value":624},{"label":"Out","value":635},{"label":"Nov","value":925},{"label":"Dez","value":921}];
const MX = 925;
