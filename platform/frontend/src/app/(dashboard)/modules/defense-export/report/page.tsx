...
const PAGE = "Report";
const KPIS = [{"l":"Total Defense Export","v":"8.204","t":"+6.6%","d":"up"},{"l":"Report Ativos","v":"7.470","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"67","t":"-2.4%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Export #001","Defense Export #002","8.254","2.204","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Export #002","Defense Export #003","7.741","6.061","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Export #003","Defense Export #004","8.612","432","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Export #004","Defense Export #005","8.179","8.201","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Export #005","Defense Export #001","3.187","1.814","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":408},{"label":"Mar","value":624},{"label":"Abr","value":457},{"label":"Mai","value":321},{"label":"Jun","value":476},{"label":"Jul","value":308},{"label":"Ago","value":638},{"label":"Set","value":545},{"label":"Out","value":555},{"label":"Nov","value":652},{"label":"Dez","value":527}];
const MX = 652;
