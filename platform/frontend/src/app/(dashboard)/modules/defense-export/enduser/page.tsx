...
const PAGE = "End User";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.060","t":"-5.4%","d":"down"},{"l":"Sessões/Dia","v":"2615","t":"+12.3%","d":"up"},{"l":"MFA Adoção (%)","v":"80.3%","t":"+5.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.628","t":"+6.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.228","8.925","4.319","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.216","2.408","6.598","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.097","2.718","6.846","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.228","7.279","4.992","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.549","3.509","5.237","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":649},{"label":"Mar","value":902},{"label":"Abr","value":812},{"label":"Mai","value":739},{"label":"Jun","value":855},{"label":"Jul","value":718},{"label":"Ago","value":950},{"label":"Set","value":925},{"label":"Out","value":842},{"label":"Nov","value":719},{"label":"Dez","value":762}];
const MX = 950;
