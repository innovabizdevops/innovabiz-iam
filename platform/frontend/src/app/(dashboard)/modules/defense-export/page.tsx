...
/* ═══ Defense Export Control — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "9032", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2720", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€325K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1445834632", cells: ["DEF-3632", "Defense Export Control Item 1", "5/5/2026", "€34 732"], status: "active" as const },
    { id: "1445838203", cells: ["DEF-7203", "Defense Export Control Item 2", "20/12/2026", "€38 303"], status: "pending" as const },
    { id: "1445841774", cells: ["DEF-1774", "Defense Export Control Item 3", "7/7/2026", "€41 874"], status: "completed" as const },
    { id: "1445845345", cells: ["DEF-5345", "Defense Export Control Item 4", "22/2/2026", "€45 445"], status: "warning" as const },
    { id: "1445848916", cells: ["DEF-8916", "Defense Export Control Item 5", "9/9/2026", "€49 016"], status: "active" as const },
];
...
export default function DefenseExportControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Defense Export Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Defense Export Control</p>
                    </div>
                </div>
