...
const ACCENT = "#475569";
const MODULE = "Defense Export Control";
const PAGE = "Track";
const KPIS = [{"l":"Total Defense Export","v":"4.265","t":"+6.0%","d":"up"},{"l":"Track Ativos","v":"8.317","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+4.6%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Export #001","Defense Export #002","2.211","9.018","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Export #002","Defense Export #003","1.813","3.052","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Export #003","Defense Export #004","1.633","2.047","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Export #004","Defense Export #005","8.612","2.208","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Export #005","Defense Export #001","7.873","5.995","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":545},{"label":"Mar","value":773},{"label":"Abr","value":659},{"label":"Mai","value":687},{"label":"Jun","value":666},{"label":"Jul","value":522},{"label":"Ago","value":708},{"label":"Set","value":592},{"label":"Out","value":789},{"label":"Nov","value":441},{"label":"Dez","value":604}];
const MX = 789;
