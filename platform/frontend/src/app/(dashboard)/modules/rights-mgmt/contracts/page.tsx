...
const PAGE = "Contract Track";
const KPIS = [{"l":"Contratos Ativos","v":"4.488","t":"-5.7%","d":"down"},{"l":"Valor Total (€M)","v":"€39.8M","t":"-1.9%","d":"down"},{"l":"Renovações Próx. 30d","v":"5.394","t":"+2.9%","d":"up"},{"l":"Obrigações Pendentes","v":"7.800","t":"+6.9%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 29070.59","2026-02-26","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 29177.39","2026-01-24","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 40642.96","2026-02-11","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 31278.87","2026-02-26","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 3234.88","2026-01-04","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":638},{"label":"Mar","value":347},{"label":"Abr","value":616},{"label":"Mai","value":288},{"label":"Jun","value":405},{"label":"Jul","value":386},{"label":"Ago","value":578},{"label":"Set","value":412},{"label":"Out","value":602},{"label":"Nov","value":481},{"label":"Dez","value":460}];
const MX = 658;
