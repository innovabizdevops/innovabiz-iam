...
const PAGE = "License Mgmt";
const KPIS = [{"l":"Total Rights Mgmt","v":"7.244","t":"+12.0%","d":"up"},{"l":"License Mgmt Ativos","v":"3.600","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"70","t":"+6.2%","d":"up"}];
const COLS = ["ID","License Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rights Mgmt #001","Rights Mgmt #002","8.548","2.592","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Rights Mgmt #002","Rights Mgmt #003","7.394","8.837","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Rights Mgmt #003","Rights Mgmt #004","4.861","1.280","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Rights Mgmt #004","Rights Mgmt #005","1.994","3.152","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rights Mgmt #005","Rights Mgmt #001","7.126","8.262","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":552},{"label":"Mar","value":578},{"label":"Abr","value":462},{"label":"Mai","value":467},{"label":"Jun","value":677},{"label":"Jul","value":695},{"label":"Ago","value":348},{"label":"Set","value":360},{"label":"Out","value":335},{"label":"Nov","value":422},{"label":"Dez","value":662}];
const MX = 695;
