...
const PAGE = "Royalty Calc";
const KPIS = [{"l":"Total Rights Mgmt","v":"3.773","t":"+0.7%","d":"up"},{"l":"Royalty Calc Ativos","v":"8.754","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+2.0%","d":"up"}];
const COLS = ["ID","Royalty Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rights Mgmt #001","Rights Mgmt #002","6.696","177","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Rights Mgmt #002","Rights Mgmt #003","1.890","1.374","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Rights Mgmt #003","Rights Mgmt #004","7.991","5.546","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Rights Mgmt #004","Rights Mgmt #005","1.085","7.685","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rights Mgmt #005","Rights Mgmt #001","2.500","8.555","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":527},{"label":"Mar","value":619},{"label":"Abr","value":513},{"label":"Mai","value":628},{"label":"Jun","value":570},{"label":"Jul","value":726},{"label":"Ago","value":821},{"label":"Set","value":700},{"label":"Out","value":706},{"label":"Nov","value":454},{"label":"Dez","value":479}];
const MX = 821;
