...
const PAGE = "Holdback";
const KPIS = [{"l":"Total Rights Mgmt","v":"7.104","t":"-4.3%","d":"down"},{"l":"Holdback Ativos","v":"3.178","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"74.7%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"69","t":"+11.7%","d":"up"}];
const COLS = ["ID","Holdback","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rights Mgmt #001","Rights Mgmt #002","1.694","6.288","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Rights Mgmt #002","Rights Mgmt #003","8.818","3.375","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Rights Mgmt #003","Rights Mgmt #004","198","893","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Rights Mgmt #004","Rights Mgmt #005","4.352","7.474","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rights Mgmt #005","Rights Mgmt #001","8.884","3.289","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":1003},{"label":"Mar","value":1023},{"label":"Abr","value":713},{"label":"Mai","value":841},{"label":"Jun","value":720},{"label":"Jul","value":1055},{"label":"Ago","value":688},{"label":"Set","value":710},{"label":"Out","value":956},{"label":"Nov","value":1054},{"label":"Dez","value":723}];
const MX = 1055;
