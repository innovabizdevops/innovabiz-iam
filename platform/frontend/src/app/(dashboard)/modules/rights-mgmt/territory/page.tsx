...
const ACCENT = "#fb923c";
const MODULE = "Rights Management";
const PAGE = "Territory Map";
const KPIS = [{"l":"Vendas YTD (€)","v":"€27704","t":"+13.9%","d":"up"},{"l":"Pipeline (€)","v":"€49897","t":"+9.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"88.4%","t":"+5.1%","d":"up"},{"l":"Win Rate (%)","v":"93.2%","t":"-5.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 6179.24","€ 15169.49","€ 250.53","87.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 4972.36","€ 37123.38","€ 6773.66","89.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 40200.00","€ 3006.22","€ 25047.16","86.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 14277.24","€ 26139.29","€ 38427.73","98.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 27345.72","€ 42159.84","€ 44593.06","81.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":473},{"label":"Mar","value":480},{"label":"Abr","value":523},{"label":"Mai","value":620},{"label":"Jun","value":327},{"label":"Jul","value":398},{"label":"Ago","value":241},{"label":"Set","value":623},{"label":"Out","value":557},{"label":"Nov","value":452},{"label":"Dez","value":591}];
const MX = 624;
