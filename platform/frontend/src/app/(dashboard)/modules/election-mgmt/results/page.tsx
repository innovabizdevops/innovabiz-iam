...
const PAGE = "Results Publish";
const KPIS = [{"l":"Total Election Mgmt","v":"1.375","t":"+14.7%","d":"up"},{"l":"Results Publish Ativos","v":"8.191","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"83","t":"+16.3%","d":"up"}];
const COLS = ["ID","Results Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Election Mgmt #001","Election Mgmt #002","2.622","7.623","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Election Mgmt #002","Election Mgmt #003","7.522","8.451","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Election Mgmt #003","Election Mgmt #004","6.573","3.379","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Election Mgmt #004","Election Mgmt #005","7.511","5.920","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Election Mgmt #005","Election Mgmt #001","2.973","6.532","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":749},{"label":"Mar","value":891},{"label":"Abr","value":701},{"label":"Mai","value":693},{"label":"Jun","value":860},{"label":"Jul","value":663},{"label":"Ago","value":825},{"label":"Set","value":652},{"label":"Out","value":761},{"label":"Nov","value":754},{"label":"Dez","value":870}];
const MX = 891;
