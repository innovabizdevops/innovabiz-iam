...
const PAGE = "Voter Registry";
const KPIS = [{"l":"Total Election Mgmt","v":"4.128","t":"+5.0%","d":"up"},{"l":"Voter Registry Ativos","v":"8.979","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"91","t":"+16.6%","d":"up"}];
const COLS = ["ID","Voter Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Election Mgmt #001","Election Mgmt #002","7.093","560","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Election Mgmt #002","Election Mgmt #003","5.025","4.277","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Election Mgmt #003","Election Mgmt #004","5.634","3.728","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Election Mgmt #004","Election Mgmt #005","318","4.792","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Election Mgmt #005","Election Mgmt #001","3.050","5.701","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":807},{"label":"Mar","value":973},{"label":"Abr","value":803},{"label":"Mai","value":719},{"label":"Jun","value":1036},{"label":"Jul","value":718},{"label":"Ago","value":883},{"label":"Set","value":790},{"label":"Out","value":807},{"label":"Nov","value":787},{"label":"Dez","value":841}];
const MX = 1036;
