...
const ACCENT = "#dc2626";
const MODULE = "Election Management";
const PAGE = "Ballot Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.776","t":"-3.9%","d":"down"},{"l":"Submissões/Dia","v":"1551","t":"+11.4%","d":"up"},{"l":"Documentos Gerados","v":"5.210","t":"+12.4%","d":"up"},{"l":"Templates","v":"3.857","t":"+12.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.198","2026-01-12","2.597","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.713","2026-01-13","3.152","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.381","2026-02-25","3.128","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.822","2026-03-28","5.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.110","2026-02-14","7.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":651},{"label":"Mar","value":637},{"label":"Abr","value":538},{"label":"Mai","value":730},{"label":"Jun","value":511},{"label":"Jul","value":445},{"label":"Ago","value":554},{"label":"Set","value":686},{"label":"Out","value":786},{"label":"Nov","value":571},{"label":"Dez","value":589}];
const MX = 786;
