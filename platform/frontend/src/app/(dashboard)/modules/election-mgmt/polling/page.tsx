...
const PAGE = "Polling Station";
const KPIS = [{"l":"Surveys Ativos","v":"6.794","t":"+12.9%","d":"up"},{"l":"Respostas/Semana","v":"3061","t":"-5.6%","d":"down"},{"l":"NPS Médio","v":"85","t":"-4.1%","d":"down"},{"l":"Taxa Resposta (%)","v":"83.1%","t":"+8.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.476","56","74.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","530","74","93.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.876","79","83.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","2.038","82","88.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.069","63","76.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":835},{"label":"Mar","value":926},{"label":"Abr","value":944},{"label":"Mai","value":665},{"label":"Jun","value":982},{"label":"Jul","value":760},{"label":"Ago","value":708},{"label":"Set","value":862},{"label":"Out","value":760},{"label":"Nov","value":765},{"label":"Dez","value":800}];
const MX = 982;
