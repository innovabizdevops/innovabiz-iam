...
const PAGE = "India";
const KPIS = [{"l":"Total Brics Trade","v":"4.310","t":"+16.9%","d":"up"},{"l":"India Ativos","v":"1.042","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"81","t":"+17.6%","d":"up"}];
const COLS = ["ID","India","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brics Trade #001","Brics Trade #002","2.604","3.058","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Brics Trade #002","Brics Trade #003","3.527","6.702","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Brics Trade #003","Brics Trade #004","7.075","3.016","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Brics Trade #004","Brics Trade #005","3.003","2.660","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brics Trade #005","Brics Trade #001","6.021","3.152","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":377},{"label":"Mar","value":573},{"label":"Abr","value":543},{"label":"Mai","value":476},{"label":"Jun","value":520},{"label":"Jul","value":577},{"label":"Ago","value":454},{"label":"Set","value":685},{"label":"Out","value":703},{"label":"Nov","value":405},{"label":"Dez","value":625}];
const MX = 703;
