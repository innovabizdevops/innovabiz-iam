...
const ACCENT = "#14532d";
const MODULE = "BRICS+ Trade Hub";
const PAGE = "Africa do Sul";
const KPIS = [{"l":"Total Brics Trade","v":"6.801","t":"+4.5%","d":"up"},{"l":"Africa Do Sul Ativos","v":"8.782","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+5.6%","d":"up"}];
const COLS = ["ID","Africa Do Sul","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brics Trade #001","Brics Trade #002","4.502","6.048","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Brics Trade #002","Brics Trade #003","802","2.218","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Brics Trade #003","Brics Trade #004","7.723","1.432","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Brics Trade #004","Brics Trade #005","8.975","4.972","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brics Trade #005","Brics Trade #001","2.146","6.718","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":935},{"label":"Mar","value":744},{"label":"Abr","value":830},{"label":"Mai","value":874},{"label":"Jun","value":938},{"label":"Jul","value":849},{"label":"Ago","value":646},{"label":"Set","value":940},{"label":"Out","value":758},{"label":"Nov","value":722},{"label":"Dez","value":994}];
const MX = 994;
