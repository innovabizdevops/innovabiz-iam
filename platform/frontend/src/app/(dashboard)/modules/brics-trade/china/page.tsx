...
const PAGE = "China";
const KPIS = [{"l":"Total Brics Trade","v":"7.699","t":"+5.4%","d":"up"},{"l":"China Ativos","v":"8.797","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"69","t":"+6.0%","d":"up"}];
const COLS = ["ID","China","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brics Trade #001","Brics Trade #002","6.433","7.717","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Brics Trade #002","Brics Trade #003","7.203","2.605","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Brics Trade #003","Brics Trade #004","3.924","679","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Brics Trade #004","Brics Trade #005","5.448","992","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brics Trade #005","Brics Trade #001","5.457","3.261","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":402},{"label":"Mar","value":554},{"label":"Abr","value":427},{"label":"Mai","value":291},{"label":"Jun","value":623},{"label":"Jul","value":563},{"label":"Ago","value":281},{"label":"Set","value":392},{"label":"Out","value":370},{"label":"Nov","value":327},{"label":"Dez","value":634}];
const MX = 634;
