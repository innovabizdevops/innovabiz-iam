...
const PAGE = "México";
const KPIS = [{"l":"Total Brics Trade","v":"2.153","t":"+12.0%","d":"up"},{"l":"MéXico Ativos","v":"3.802","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"68","t":"-0.8%","d":"down"}];
const COLS = ["ID","MéXico","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brics Trade #001","Brics Trade #002","4.910","3.549","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Brics Trade #002","Brics Trade #003","6.007","810","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Brics Trade #003","Brics Trade #004","8.732","1.002","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Brics Trade #004","Brics Trade #005","5.658","3.762","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brics Trade #005","Brics Trade #001","6.418","6.516","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":604},{"label":"Mar","value":945},{"label":"Abr","value":916},{"label":"Mai","value":727},{"label":"Jun","value":567},{"label":"Jul","value":840},{"label":"Ago","value":937},{"label":"Set","value":746},{"label":"Out","value":923},{"label":"Nov","value":944},{"label":"Dez","value":771}];
const MX = 945;
