...
/* ═══ BRICS+ Trade Hub — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "7233", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1147", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€323K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "801560633", cells: ["BRI-3633", "BRICS+ Trade Hub Item 1", "14/6/2026", "€10 733"], status: "active" as const },
    { id: "801564204", cells: ["BRI-7204", "BRICS+ Trade Hub Item 2", "1/1/2026", "€14 304"], status: "pending" as const },
    { id: "801567775", cells: ["BRI-1775", "BRICS+ Trade Hub Item 3", "16/8/2026", "€17 875"], status: "completed" as const },
    { id: "801571346", cells: ["BRI-5346", "BRICS+ Trade Hub Item 4", "3/3/2026", "€21 446"], status: "warning" as const },
    { id: "801574917", cells: ["BRI-8917", "BRICS+ Trade Hub Item 5", "18/10/2026", "€25 017"], status: "active" as const },
];
...
export default function BricsTradeHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">BRICS+ Trade Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • BRICS+ Trade Hub</p>
                    </div>
                </div>
