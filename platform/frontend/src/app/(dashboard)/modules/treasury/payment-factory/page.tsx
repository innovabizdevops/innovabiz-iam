...
const PAGE = "Payment Factory";
const KPIS = [{"l":"Total Treasury","v":"8.520","t":"+0.0%","d":"up"},{"l":"Payment Factory Ativos","v":"7.475","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+17.2%","d":"up"}];
const COLS = ["ID","Payment Factory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury #001","Treasury #002","6.488","8.541","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury #002","Treasury #003","3.560","8.245","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury #003","Treasury #004","7.091","5.842","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury #004","Treasury #005","3.516","4.868","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury #005","Treasury #001","1.064","1.023","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":744},{"label":"Mar","value":701},{"label":"Abr","value":716},{"label":"Mai","value":628},{"label":"Jun","value":737},{"label":"Jul","value":748},{"label":"Ago","value":567},{"label":"Set","value":625},{"label":"Out","value":493},{"label":"Nov","value":401},{"label":"Dez","value":772}];
const MX = 772;
...
export default function PaymentFactoryPage() {
    return (
