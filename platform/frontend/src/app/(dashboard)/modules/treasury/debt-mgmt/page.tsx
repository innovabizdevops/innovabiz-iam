...
const PAGE = "Debt Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.291","t":"-1.6%","d":"down"},{"l":"Savings (€)","v":"€8214","t":"+17.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.8%","t":"-1.9%","d":"down"},{"l":"Ciclos PDCA","v":"3.368","t":"+2.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.988","€ 23916.26","1.462","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.139","€ 4773.85","8.618","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.433","€ 7811.04","2.000","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.214","€ 33290.75","6.152","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","821","€ 2698.00","3.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":513},{"label":"Mar","value":583},{"label":"Abr","value":597},{"label":"Mai","value":603},{"label":"Jun","value":464},{"label":"Jul","value":512},{"label":"Ago","value":535},{"label":"Set","value":317},{"label":"Out","value":246},{"label":"Nov","value":531},{"label":"Dez","value":411}];
const MX = 603;
...
export default function DebtMgmtPage() {
    return (
