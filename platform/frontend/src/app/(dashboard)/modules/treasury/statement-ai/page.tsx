...
const PAGE = "Bank Statement AI";
const KPIS = [{"l":"Total Treasury","v":"7.037","t":"+4.0%","d":"up"},{"l":"Bank Statement AI Ativos","v":"3.937","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"83","t":"+10.8%","d":"up"}];
const COLS = ["ID","Bank Statement AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury #001","Treasury #002","8.375","1.683","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury #002","Treasury #003","7.240","6.585","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury #003","Treasury #004","2.635","6.122","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury #004","Treasury #005","4.277","1.933","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury #005","Treasury #001","8.513","1.184","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":723},{"label":"Mar","value":1060},{"label":"Abr","value":950},{"label":"Mai","value":709},{"label":"Jun","value":731},{"label":"Jul","value":942},{"label":"Ago","value":839},{"label":"Set","value":704},{"label":"Out","value":738},{"label":"Nov","value":984},{"label":"Dez","value":752}];
const MX = 1060;
...
export default function StatementAiPage() {
    return (
