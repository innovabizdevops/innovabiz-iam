...
const KPIS = [{"l":"Total Treasury","v":"5.844","t":"+5.0%","d":"up"},{"l":"Bank Connectivity Ativos","v":"8.904","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"87.6%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"59","t":"+7.1%","d":"up"}];
const COLS = ["ID","Bank Connectivity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury #001","Treasury #002","5.137","6.258","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury #002","Treasury #003","914","232","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury #003","Treasury #004","5.193","3.265","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury #004","Treasury #005","8.078","3.823","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury #005","Treasury #001","9.044","5.034","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":607},{"label":"Mar","value":779},{"label":"Abr","value":593},{"label":"Mai","value":700},{"label":"Jun","value":667},{"label":"Jul","value":467},{"label":"Ago","value":640},{"label":"Set","value":629},{"label":"Out","value":428},{"label":"Nov","value":444},{"label":"Dez","value":535}];
const MX = 779;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>SWIFT</span></h1>
                </div>
