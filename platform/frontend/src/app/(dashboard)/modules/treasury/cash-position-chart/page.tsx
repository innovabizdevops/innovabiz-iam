...
const PAGE = "Cash Position Chart";
const KPIS = [{"l":"Pedidos/Dia","v":"188","t":"+3.0%","d":"up"},{"l":"GMV (€)","v":"€78070","t":"-4.6%","d":"down"},{"l":"Conversão (%)","v":"87.5%","t":"+7.8%","d":"up"},{"l":"AOV (€)","v":"€73623","t":"+9.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 11714.70","5.524","6.225","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 4241.21","1.576","1.911","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 38147.04","2.135","141","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 39676.58","7.525","3.448","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 25558.96","3.904","2.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":372},{"label":"Fev","value":423},{"label":"Mar","value":589},{"label":"Abr","value":635},{"label":"Mai","value":589},{"label":"Jun","value":322},{"label":"Jul","value":490},{"label":"Ago","value":315},{"label":"Set","value":479},{"label":"Out","value":392},{"label":"Nov","value":639},{"label":"Dez","value":519}];
const MX = 639;
...
export default function CashPositionChartPage() {
    return (
