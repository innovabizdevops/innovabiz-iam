...
const PAGE = "Cash Pooling";
const KPIS = [{"l":"Total Treasury","v":"1.668","t":"-2.6%","d":"down"},{"l":"Cash Pooling Ativos","v":"7.054","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"71","t":"-3.3%","d":"down"}];
const COLS = ["ID","Cash Pooling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury #001","Treasury #002","8.668","2.226","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury #002","Treasury #003","3.846","2.359","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury #003","Treasury #004","8.895","4.233","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury #004","Treasury #005","2.019","114","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury #005","Treasury #001","1.451","6.565","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":714},{"label":"Mar","value":888},{"label":"Abr","value":558},{"label":"Mai","value":599},{"label":"Jun","value":864},{"label":"Jul","value":549},{"label":"Ago","value":562},{"label":"Set","value":844},{"label":"Out","value":585},{"label":"Nov","value":564},{"label":"Dez","value":793}];
const MX = 888;
