...
const PAGE = "FX Rate Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"3.517","t":"+3.5%","d":"up"},{"l":"Reuniões/Semana","v":"163","t":"-1.8%","d":"down"},{"l":"Mensagens/Dia","v":"2257","t":"-5.7%","d":"down"},{"l":"Ficheiros Partilhados","v":"2.447","t":"+9.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.031","1840","376","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.054","942","821","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","9.065","1130","2.070","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.925","1127","1.869","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.741","474","5.129","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":758},{"label":"Mar","value":471},{"label":"Abr","value":533},{"label":"Mai","value":663},{"label":"Jun","value":776},{"label":"Jul","value":839},{"label":"Ago","value":831},{"label":"Set","value":655},{"label":"Out","value":640},{"label":"Nov","value":762},{"label":"Dez","value":744}];
const MX = 839;
