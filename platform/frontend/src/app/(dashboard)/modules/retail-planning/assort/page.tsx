...
const ACCENT = "#ea580c";
const MODULE = "Retail Planning & Allocation";
const PAGE = "Assort";
const KPIS = [{"l":"Pedidos/Dia","v":"705","t":"+2.1%","d":"up"},{"l":"GMV (€)","v":"€90804","t":"+13.8%","d":"up"},{"l":"Conversão (%)","v":"85.7%","t":"+14.8%","d":"up"},{"l":"AOV (€)","v":"€77079","t":"-5.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 10831.98","4.067","5.565","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 13325.52","5.844","5.478","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 20066.34","2.817","445","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 14901.94","1.837","8.429","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 6939.87","1.406","2.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":876},{"label":"Mar","value":689},{"label":"Abr","value":788},{"label":"Mai","value":873},{"label":"Jun","value":753},{"label":"Jul","value":756},{"label":"Ago","value":708},{"label":"Set","value":531},{"label":"Out","value":700},{"label":"Nov","value":779},{"label":"Dez","value":725}];
const MX = 876;
...
export default function AssortPage() {
    return (
