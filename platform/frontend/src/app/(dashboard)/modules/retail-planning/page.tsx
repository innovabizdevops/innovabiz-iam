...
/* ═══ Retail Planning & Allocation — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "7782", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3503", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€490K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1217242382", cells: ["RET-2382", "Retail Planning & Allocation Item 1", "7/3/2026", "€42 482"], status: "active" as const },
    { id: "1217245953", cells: ["RET-5953", "Retail Planning & Allocation Item 2", "22/10/2026", "€46 053"], status: "pending" as const },
    { id: "1217249524", cells: ["RET-9524", "Retail Planning & Allocation Item 3", "9/5/2026", "€49 624"], status: "completed" as const },
    { id: "1217253095", cells: ["RET-4095", "Retail Planning & Allocation Item 4", "24/12/2026", "€3195"], status: "warning" as const },
    { id: "1217256666", cells: ["RET-7666", "Retail Planning & Allocation Item 5", "11/7/2026", "€6766"], status: "active" as const },
];
...
export default function RetailPlanningAllocationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Retail Planning & Allocation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Retail Planning & Allocation</p>
                    </div>
                </div>
