...
const PAGE = "MiCA";
const KPIS = [{"l":"Auditorias Realizadas","v":"9.089","t":"-5.2%","d":"down"},{"l":"NC Abertas","v":"5.501","t":"+18.0%","d":"up"},{"l":"Conformidade (%)","v":"83.0%","t":"-3.5%","d":"down"},{"l":"CAPAs Pendentes","v":"260","t":"+2.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.495","85.0%","2.835","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.222","93.8%","1.338","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","936","91.1%","1.035","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.258","83.4%","3.224","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.718","78.2%","1.685","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":705},{"label":"Mar","value":906},{"label":"Abr","value":848},{"label":"Mai","value":769},{"label":"Jun","value":848},{"label":"Jul","value":998},{"label":"Ago","value":800},{"label":"Set","value":640},{"label":"Out","value":929},{"label":"Nov","value":952},{"label":"Dez","value":794}];
const MX = 998;
