...
/* ═══ EU Compliance Deep — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "6884", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4881", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€166K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1173928984", cells: ["EU-5984", "EU Compliance Deep Item 1", "5/5/2026", "€29 084"], status: "active" as const },
    { id: "1173932555", cells: ["EU-9555", "EU Compliance Deep Item 2", "20/12/2026", "€32 655"], status: "pending" as const },
    { id: "1173936126", cells: ["EU-4126", "EU Compliance Deep Item 3", "7/7/2026", "€36 226"], status: "completed" as const },
    { id: "1173939697", cells: ["EU-7697", "EU Compliance Deep Item 4", "22/2/2026", "€39 797"], status: "warning" as const },
    { id: "1173943268", cells: ["EU-2268", "EU Compliance Deep Item 5", "9/9/2026", "€43 368"], status: "active" as const },
];
...
export default function EuComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EU Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EU Compliance Deep</p>
                    </div>
                </div>
