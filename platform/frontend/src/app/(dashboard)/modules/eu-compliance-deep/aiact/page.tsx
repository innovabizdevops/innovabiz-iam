...
const PAGE = "AI Act";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.903","t":"-4.5%","d":"down"},{"l":"NC Abertas","v":"3.253","t":"+4.1%","d":"up"},{"l":"Conformidade (%)","v":"79.3%","t":"-0.2%","d":"down"},{"l":"CAPAs Pendentes","v":"5.424","t":"+1.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.155","91.1%","6.349","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.219","99.5%","5.461","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.623","76.0%","1.975","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.407","81.4%","127","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.478","91.3%","1.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":275},{"label":"Fev","value":625},{"label":"Mar","value":425},{"label":"Abr","value":287},{"label":"Mai","value":479},{"label":"Jun","value":635},{"label":"Jul","value":530},{"label":"Ago","value":613},{"label":"Set","value":428},{"label":"Out","value":342},{"label":"Nov","value":606},{"label":"Dez","value":406}];
const MX = 635;
