...
const ACCENT = "#14532d";
const MODULE = "EU Compliance Deep";
const PAGE = "DORA";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.366","t":"-4.7%","d":"down"},{"l":"NC Abertas","v":"3.730","t":"+2.9%","d":"up"},{"l":"Conformidade (%)","v":"76.5%","t":"-1.4%","d":"down"},{"l":"CAPAs Pendentes","v":"158","t":"-2.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.260","78.5%","4.742","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.926","72.8%","1.386","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.612","94.0%","2.802","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.763","71.2%","6.709","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.339","81.9%","5.047","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":869},{"label":"Mar","value":933},{"label":"Abr","value":687},{"label":"Mai","value":693},{"label":"Jun","value":921},{"label":"Jul","value":940},{"label":"Ago","value":664},{"label":"Set","value":712},{"label":"Out","value":698},{"label":"Nov","value":695},{"label":"Dez","value":794}];
const MX = 940;
