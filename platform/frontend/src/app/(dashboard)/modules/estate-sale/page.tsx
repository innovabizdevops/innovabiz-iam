...
/* ═══ Estate Sale — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3747", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1983", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€473K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "116863247", cells: ["EST-8247", "Estate Sale Item 1", "12/12/2026", "€13 347"], status: "active" as const },
    { id: "116866818", cells: ["EST-2818", "Estate Sale Item 2", "27/7/2026", "€16 918"], status: "pending" as const },
    { id: "116870389", cells: ["EST-6389", "Estate Sale Item 3", "14/2/2026", "€20 489"], status: "completed" as const },
    { id: "116873960", cells: ["EST-9960", "Estate Sale Item 4", "1/9/2026", "€24 060"], status: "warning" as const },
    { id: "116877531", cells: ["EST-4531", "Estate Sale Item 5", "16/4/2026", "€27 631"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Estate Sale</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Estate Sale</p>
                    </div>
                </div>
