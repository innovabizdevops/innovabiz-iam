...
const ACCENT = "#78350f";
const MODULE = "Estate Sale";
const PAGE = "Clean Out";
const KPIS = [{"l":"Projetos Melhoria","v":"928","t":"+13.4%","d":"up"},{"l":"Savings (€)","v":"€14037","t":"-3.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"72.4%","t":"+7.4%","d":"up"},{"l":"Ciclos PDCA","v":"1.133","t":"+3.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.100","€ 11315.11","4.878","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.100","€ 44960.68","4.545","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.026","€ 15122.33","1.604","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.393","€ 17627.83","3.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","481","€ 21571.18","8.454","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":523},{"label":"Mar","value":442},{"label":"Abr","value":490},{"label":"Mai","value":389},{"label":"Jun","value":585},{"label":"Jul","value":435},{"label":"Ago","value":454},{"label":"Set","value":350},{"label":"Out","value":572},{"label":"Nov","value":695},{"label":"Dez","value":468}];
const MX = 695;
