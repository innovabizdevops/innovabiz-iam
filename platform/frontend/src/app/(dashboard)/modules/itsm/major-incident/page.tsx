...
const ACCENT = "#0284c7";
const MODULE = "IT Service Management";
const PAGE = "Major Incident Mgmt";
const KPIS = [{"l":"Tickets Abertos","v":"1.261","t":"+16.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.7%","t":"+15.4%","d":"up"},{"l":"MTTR (h)","v":"208h","t":"-0.4%","d":"down"},{"l":"Satisfação (%)","v":"69.5%","t":"+3.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.988","368","3.386","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.661","6.232","309","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.567","7.431","1.662","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.012","2.820","5.074","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","443","3.883","954","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":540},{"label":"Mar","value":509},{"label":"Abr","value":317},{"label":"Mai","value":662},{"label":"Jun","value":379},{"label":"Jul","value":542},{"label":"Ago","value":646},{"label":"Set","value":522},{"label":"Out","value":349},{"label":"Nov","value":631},{"label":"Dez","value":401}];
const MX = 662;
...
export default function MajorIncidentPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0284c7'}}>ITIL</span></h1>
                </div>
