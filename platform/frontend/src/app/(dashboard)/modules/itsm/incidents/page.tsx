...
const PAGE = "Incident Mgmt";
const KPIS = [{"l":"Tickets Abertos","v":"3.790","t":"+9.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.8%","t":"+16.7%","d":"up"},{"l":"MTTR (h)","v":"20h","t":"+15.7%","d":"up"},{"l":"Satisfação (%)","v":"93.5%","t":"-5.2%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.007","8.685","4.364","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.890","5.484","5.504","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.684","5.437","6.457","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.806","8.985","4.725","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.817","4.757","6.577","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":809},{"label":"Mar","value":669},{"label":"Abr","value":838},{"label":"Mai","value":702},{"label":"Jun","value":822},{"label":"Jul","value":898},{"label":"Ago","value":821},{"label":"Set","value":816},{"label":"Out","value":561},{"label":"Nov","value":778},{"label":"Dez","value":832}];
const MX = 898;
