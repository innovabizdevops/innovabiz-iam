...
const PAGE = "Service Desk";
const KPIS = [{"l":"Tickets Abertos","v":"4.705","t":"+15.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.6%","t":"+1.3%","d":"up"},{"l":"MTTR (h)","v":"11h","t":"-5.5%","d":"down"},{"l":"Satisfação (%)","v":"67.2%","t":"+10.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.288","7.726","3.036","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.946","7.246","4.011","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.487","4.871","1.016","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.495","8.212","7.025","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.866","1.819","2.092","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":776},{"label":"Mar","value":628},{"label":"Abr","value":598},{"label":"Mai","value":805},{"label":"Jun","value":593},{"label":"Jul","value":512},{"label":"Ago","value":556},{"label":"Set","value":743},{"label":"Out","value":905},{"label":"Nov","value":743},{"label":"Dez","value":873}];
const MX = 905;
