...
const PAGE = "SLA Dashboard";
const KPIS = [{"l":"Tickets Abertos","v":"8.744","t":"+13.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.6%","t":"+7.6%","d":"up"},{"l":"MTTR (h)","v":"42h","t":"-0.3%","d":"down"},{"l":"Satisfação (%)","v":"83.4%","t":"+11.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","291","365","2.518","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.852","4.393","603","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.611","2.279","3.348","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.738","8.428","3.795","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.398","1.889","8.938","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":670},{"label":"Mar","value":561},{"label":"Abr","value":457},{"label":"Mai","value":771},{"label":"Jun","value":654},{"label":"Jul","value":665},{"label":"Ago","value":640},{"label":"Set","value":523},{"label":"Out","value":777},{"label":"Nov","value":773},{"label":"Dez","value":714}];
const MX = 777;
