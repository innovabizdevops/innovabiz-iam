...
const KPIS = [{"l":"Tickets Abertos","v":"4.649","t":"+2.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.1%","t":"+2.6%","d":"up"},{"l":"MTTR (h)","v":"21h","t":"-2.9%","d":"down"},{"l":"Satisfação (%)","v":"89.6%","t":"+14.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.562","5.449","3.297","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.869","6.601","7.949","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.016","6.613","2.668","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.511","4.648","6.598","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.425","1.021","8.755","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":850},{"label":"Mar","value":785},{"label":"Abr","value":807},{"label":"Mai","value":861},{"label":"Jun","value":926},{"label":"Jul","value":858},{"label":"Ago","value":861},{"label":"Set","value":699},{"label":"Out","value":676},{"label":"Nov","value":1052},{"label":"Dez","value":732}];
const MX = 1052;
