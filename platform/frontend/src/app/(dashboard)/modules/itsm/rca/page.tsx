...
const KPIS = [{"l":"Tickets Abertos","v":"8.967","t":"+6.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.6%","t":"+2.4%","d":"up"},{"l":"MTTR (h)","v":"153h","t":"-2.2%","d":"down"},{"l":"Satisfação (%)","v":"78.5%","t":"-1.5%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.181","1.838","3.350","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.035","5.819","6.074","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.424","1.983","4.775","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","372","3.730","8.030","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.021","7.009","161","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":519},{"label":"Mar","value":505},{"label":"Abr","value":590},{"label":"Mai","value":705},{"label":"Jun","value":715},{"label":"Jul","value":517},{"label":"Ago","value":714},{"label":"Set","value":585},{"label":"Out","value":388},{"label":"Nov","value":467},{"label":"Dez","value":574}];
const MX = 715;
