...
const PAGE = "Service Request Catalog";
const KPIS = [{"l":"Tickets Abertos","v":"1.388","t":"+2.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.6%","t":"-5.2%","d":"down"},{"l":"MTTR (h)","v":"97h","t":"+3.6%","d":"up"},{"l":"Satisfação (%)","v":"92.6%","t":"-0.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.796","460","5.716","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.492","3.011","1.987","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.439","1.171","2.900","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.312","5.028","1.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.587","7.458","2.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":681},{"label":"Mar","value":870},{"label":"Abr","value":744},{"label":"Mai","value":650},{"label":"Jun","value":723},{"label":"Jul","value":677},{"label":"Ago","value":604},{"label":"Set","value":539},{"label":"Out","value":617},{"label":"Nov","value":763},{"label":"Dez","value":704}];
const MX = 873;
