...
const PAGE = "Change Mgmt";
const KPIS = [{"l":"Tickets Abertos","v":"4.266","t":"+12.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.1%","t":"+9.7%","d":"up"},{"l":"MTTR (h)","v":"129h","t":"+0.2%","d":"up"},{"l":"Satisfação (%)","v":"93.9%","t":"+5.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.439","6.783","6.021","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","803","1.938","866","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.074","6.881","1.554","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.546","2.802","8.375","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.401","7.522","8.853","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":554},{"label":"Mar","value":585},{"label":"Abr","value":457},{"label":"Mai","value":341},{"label":"Jun","value":464},{"label":"Jul","value":636},{"label":"Ago","value":392},{"label":"Set","value":302},{"label":"Out","value":641},{"label":"Nov","value":517},{"label":"Dez","value":480}];
const MX = 641;
