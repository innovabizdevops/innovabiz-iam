...
const KPIS = [{"l":"Tickets Abertos","v":"7.658","t":"+17.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.4%","t":"+16.0%","d":"up"},{"l":"MTTR (h)","v":"181h","t":"+10.8%","d":"up"},{"l":"Satisfação (%)","v":"70.6%","t":"+7.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","711","6.986","7.122","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.088","2.063","2.988","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.613","6.113","240","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.683","8.183","2.230","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.003","6.888","586","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":658},{"label":"Mar","value":896},{"label":"Abr","value":565},{"label":"Mai","value":672},{"label":"Jun","value":889},{"label":"Jul","value":847},{"label":"Ago","value":878},{"label":"Set","value":573},{"label":"Out","value":528},{"label":"Nov","value":500},{"label":"Dez","value":890}];
const MX = 896;
