...
const PAGE = "SLA Management";
const KPIS = [{"l":"Tickets Abertos","v":"7.547","t":"+13.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"83.8%","t":"+11.6%","d":"up"},{"l":"MTTR (h)","v":"139h","t":"+5.4%","d":"up"},{"l":"Satisfação (%)","v":"81.2%","t":"+16.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.480","2.573","4.650","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.422","2.227","7.464","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.147","2.161","8.335","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.404","8.800","8.416","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.207","7.504","3.442","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":788},{"label":"Mar","value":588},{"label":"Abr","value":519},{"label":"Mai","value":680},{"label":"Jun","value":505},{"label":"Jul","value":507},{"label":"Ago","value":630},{"label":"Set","value":732},{"label":"Out","value":792},{"label":"Nov","value":741},{"label":"Dez","value":669}];
const MX = 792;
