...
const PAGE = "Service Catalog Form";
const KPIS = [{"l":"Tickets Abertos","v":"6.128","t":"+6.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.9%","t":"+12.7%","d":"up"},{"l":"MTTR (h)","v":"95h","t":"-5.7%","d":"down"},{"l":"Satisfação (%)","v":"89.3%","t":"+7.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.461","5.201","6.018","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.553","5.114","5.703","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.340","2.630","885","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","284","2.266","7.368","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.098","5.930","832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":654},{"label":"Mar","value":669},{"label":"Abr","value":401},{"label":"Mai","value":517},{"label":"Jun","value":631},{"label":"Jul","value":781},{"label":"Ago","value":506},{"label":"Set","value":480},{"label":"Out","value":622},{"label":"Nov","value":418},{"label":"Dez","value":701}];
const MX = 781;
