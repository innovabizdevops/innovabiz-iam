...
const PAGE = "Service Value System";
const KPIS = [{"l":"Tickets Abertos","v":"1.754","t":"+8.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.9%","t":"+8.9%","d":"up"},{"l":"MTTR (h)","v":"106h","t":"+8.9%","d":"up"},{"l":"Satisfação (%)","v":"75.8%","t":"+0.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.096","5.042","2.726","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.434","6.708","8.751","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","879","4.414","1.025","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.895","205","4.798","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.357","3.890","7.758","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":708},{"label":"Mar","value":997},{"label":"Abr","value":749},{"label":"Mai","value":857},{"label":"Jun","value":882},{"label":"Jul","value":749},{"label":"Ago","value":670},{"label":"Set","value":872},{"label":"Out","value":782},{"label":"Nov","value":943},{"label":"Dez","value":749}];
const MX = 997;
