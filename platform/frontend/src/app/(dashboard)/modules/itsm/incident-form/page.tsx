...
const PAGE = "Incident Form";
const KPIS = [{"l":"Tickets Abertos","v":"8.626","t":"+14.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"86.8%","t":"+3.3%","d":"up"},{"l":"MTTR (h)","v":"44h","t":"+3.0%","d":"up"},{"l":"Satisfação (%)","v":"73.8%","t":"+4.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","836","4.214","3.826","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.673","6.425","4.148","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.484","6.127","8.925","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.021","8.100","9.046","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.043","3.376","3.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":986},{"label":"Fev","value":791},{"label":"Mar","value":1036},{"label":"Abr","value":857},{"label":"Mai","value":894},{"label":"Jun","value":774},{"label":"Jul","value":815},{"label":"Ago","value":1036},{"label":"Set","value":899},{"label":"Out","value":858},{"label":"Nov","value":788},{"label":"Dez","value":954}];
const MX = 1036;
