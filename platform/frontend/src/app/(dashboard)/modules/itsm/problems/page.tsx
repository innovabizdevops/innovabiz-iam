...
const PAGE = "Problem Mgmt";
const KPIS = [{"l":"Tickets Abertos","v":"8.371","t":"+15.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.5%","t":"+9.9%","d":"up"},{"l":"MTTR (h)","v":"166h","t":"-1.6%","d":"down"},{"l":"Satisfação (%)","v":"72.2%","t":"+14.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.850","494","5.291","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.899","3.083","4.850","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.646","1.663","6.753","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.268","7.768","5.341","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","739","5.357","6.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":702},{"label":"Mar","value":967},{"label":"Abr","value":847},{"label":"Mai","value":802},{"label":"Jun","value":1042},{"label":"Jul","value":995},{"label":"Ago","value":1018},{"label":"Set","value":701},{"label":"Out","value":1005},{"label":"Nov","value":780},{"label":"Dez","value":926}];
const MX = 1042;
