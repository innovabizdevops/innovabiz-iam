...
const PAGE = "CMDB";
const KPIS = [{"l":"Tickets Abertos","v":"8.981","t":"-1.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"87.2%","t":"+13.6%","d":"up"},{"l":"MTTR (h)","v":"25h","t":"+13.6%","d":"up"},{"l":"Satisfação (%)","v":"74.7%","t":"+8.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.755","6.192","5.168","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.848","3.743","6.298","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.427","1.305","782","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.764","4.922","2.146","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.235","916","3.415","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":514},{"label":"Mar","value":580},{"label":"Abr","value":695},{"label":"Mai","value":532},{"label":"Jun","value":773},{"label":"Jul","value":724},{"label":"Ago","value":730},{"label":"Set","value":508},{"label":"Out","value":792},{"label":"Nov","value":721},{"label":"Dez","value":542}];
const MX = 792;
