...
const PAGE = "Known Error DB";
const KPIS = [{"l":"Tickets Abertos","v":"5.497","t":"+9.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.0%","t":"-4.0%","d":"down"},{"l":"MTTR (h)","v":"138h","t":"+10.7%","d":"up"},{"l":"Satisfação (%)","v":"84.8%","t":"-2.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.266","1.306","6.089","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.713","8.879","4.618","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.350","1.150","2.983","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.479","3.501","2.871","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","548","8.411","975","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":787},{"label":"Mar","value":749},{"label":"Abr","value":786},{"label":"Mai","value":843},{"label":"Jun","value":967},{"label":"Jul","value":765},{"label":"Ago","value":668},{"label":"Set","value":883},{"label":"Out","value":628},{"label":"Nov","value":659},{"label":"Dez","value":954}];
const MX = 967;
