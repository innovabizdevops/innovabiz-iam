...
const PAGE = "Continual Improvement";
const KPIS = [{"l":"Tickets Abertos","v":"2.807","t":"+16.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.1%","t":"+3.0%","d":"up"},{"l":"MTTR (h)","v":"52h","t":"+0.2%","d":"up"},{"l":"Satisfação (%)","v":"92.4%","t":"-3.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.032","7.298","3.512","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.164","8.164","8.701","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.101","7.376","5.551","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.806","4.036","5.959","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.150","5.984","1.624","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":967},{"label":"Mar","value":872},{"label":"Abr","value":890},{"label":"Mai","value":609},{"label":"Jun","value":712},{"label":"Jul","value":644},{"label":"Ago","value":909},{"label":"Set","value":651},{"label":"Out","value":888},{"label":"Nov","value":909},{"label":"Dez","value":905}];
const MX = 967;
