...
const PAGE = "ITIL v4 Practices";
const KPIS = [{"l":"Tickets Abertos","v":"8.631","t":"+1.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.9%","t":"+10.6%","d":"up"},{"l":"MTTR (h)","v":"146h","t":"+9.4%","d":"up"},{"l":"Satisfação (%)","v":"78.4%","t":"-5.0%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.921","4.211","1.833","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.645","3.445","3.057","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.638","585","2.379","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.732","7.299","3.826","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.032","6.924","238","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":837},{"label":"Mar","value":797},{"label":"Abr","value":598},{"label":"Mai","value":613},{"label":"Jun","value":540},{"label":"Jul","value":739},{"label":"Ago","value":781},{"label":"Set","value":481},{"label":"Out","value":642},{"label":"Nov","value":611},{"label":"Dez","value":652}];
const MX = 837;
...
export default function ItilPracticesPage() {
    return (
