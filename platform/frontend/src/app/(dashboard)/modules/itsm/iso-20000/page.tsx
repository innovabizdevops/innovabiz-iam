...
const PAGE = "ISO 20000 IT Service";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.246","t":"+16.0%","d":"up"},{"l":"NC Abertas","v":"472","t":"-3.2%","d":"down"},{"l":"Conformidade (%)","v":"69.3%","t":"+8.0%","d":"up"},{"l":"CAPAs Pendentes","v":"1.595","t":"+6.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.121","84.2%","7.151","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.228","76.4%","5.919","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.492","85.0%","293","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.427","75.9%","2.512","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.822","98.3%","6.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":711},{"label":"Mar","value":609},{"label":"Abr","value":798},{"label":"Mai","value":644},{"label":"Jun","value":628},{"label":"Jul","value":521},{"label":"Ago","value":462},{"label":"Set","value":448},{"label":"Out","value":615},{"label":"Nov","value":810},{"label":"Dez","value":755}];
const MX = 830;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0284c7'}}>ISO</span></h1>
                </div>
