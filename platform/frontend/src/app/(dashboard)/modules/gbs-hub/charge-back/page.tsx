...
const KPIS = [
    { label: "Total", value: "2481", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "318", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "428", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "486671066", cells: ["GBS-6066", "Charge Back Item 1", "15/3/2026", "€21 166"], status: "active" as const },
    { id: "486674637", cells: ["GBS-9637", "Charge Back Item 2", "2/10/2026", "€24 737"], status: "pending" as const },
    { id: "486678208", cells: ["GBS-4208", "Charge Back Item 3", "17/5/2026", "€28 308"], status: "completed" as const },
    { id: "486681779", cells: ["GBS-7779", "Charge Back Item 4", "4/12/2026", "€31 879"], status: "warning" as const },
    { id: "486685350", cells: ["GBS-2350", "Charge Back Item 5", "19/7/2026", "€35 450"], status: "active" as const },
];
...
export default function GbsHubChargeBackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Charge Back</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Charge Back</p>
                    </div>
                </div>
