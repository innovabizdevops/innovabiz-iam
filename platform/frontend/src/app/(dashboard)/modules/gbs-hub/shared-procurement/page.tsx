...
/* ═══ GBS Hub — Shared Procurement ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "4590", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "146", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "133", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "73%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "921071166", cells: ["GBS-3166", "Shared Procurement Item 1", "23/7/2026", "€21 266"], status: "active" as const },
    { id: "921074737", cells: ["GBS-6737", "Shared Procurement Item 2", "10/2/2026", "€24 837"], status: "pending" as const },
    { id: "921078308", cells: ["GBS-1308", "Shared Procurement Item 3", "25/9/2026", "€28 408"], status: "completed" as const },
    { id: "921081879", cells: ["GBS-4879", "Shared Procurement Item 4", "12/4/2026", "€31 979"], status: "warning" as const },
    { id: "921085450", cells: ["GBS-8450", "Shared Procurement Item 5", "27/11/2026", "€35 550"], status: "active" as const },
];
...
export default function GbsHubSharedProcurementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shared Procurement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Shared Procurement</p>
                    </div>
                </div>
