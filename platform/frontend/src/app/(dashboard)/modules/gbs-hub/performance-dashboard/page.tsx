...
/* ═══ GBS Hub — Performance Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "2937", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "283", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "997", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1136198903", cells: ["GBS-3903", "Performance Dashboard Item 1", "8/12/2026", "€49 003"], status: "active" as const },
    { id: "1136202474", cells: ["GBS-7474", "Performance Dashboard Item 2", "23/7/2026", "€2574"], status: "pending" as const },
    { id: "1136206045", cells: ["GBS-2045", "Performance Dashboard Item 3", "10/2/2026", "€6145"], status: "completed" as const },
    { id: "1136209616", cells: ["GBS-5616", "Performance Dashboard Item 4", "25/9/2026", "€9716"], status: "warning" as const },
    { id: "1136213187", cells: ["GBS-9187", "Performance Dashboard Item 5", "12/4/2026", "€13 287"], status: "active" as const },
];
...
export default function GbsHubPerformanceDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Performance Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Performance Dashboard</p>
                    </div>
                </div>
