...
const KPIS = [
    { label: "Total", value: "4481", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "429", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2435", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1388926425", cells: ["GBS-2425", "Shared It Item 1", "6/10/2026", "€26 525"], status: "active" as const },
    { id: "1388929996", cells: ["GBS-5996", "Shared It Item 2", "21/5/2026", "€30 096"], status: "pending" as const },
    { id: "1388933567", cells: ["GBS-9567", "Shared It Item 3", "8/12/2026", "€33 667"], status: "completed" as const },
    { id: "1388937138", cells: ["GBS-4138", "Shared It Item 4", "23/7/2026", "€37 238"], status: "warning" as const },
    { id: "1388940709", cells: ["GBS-7709", "Shared It Item 5", "10/2/2026", "€40 809"], status: "active" as const },
];
...
export default function GbsHubSharedItPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shared It</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Shared It</p>
                    </div>
                </div>
