...
export default function GbsHubPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">GBS Hub</h1><p className="text-sm text-muted-foreground">GBS Hub — iBOS Enterprise</p></div>
