...
/* ═══ GBS Hub — Service Catalog ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "2214", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "277", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "127", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "795781697", cells: ["GBS-2697", "Service Catalog Item 1", "26/6/2026", "€31 797"], status: "active" as const },
    { id: "795785268", cells: ["GBS-6268", "Service Catalog Item 2", "13/1/2026", "€35 368"], status: "pending" as const },
    { id: "795788839", cells: ["GBS-9839", "Service Catalog Item 3", "28/8/2026", "€38 939"], status: "completed" as const },
    { id: "795792410", cells: ["GBS-4410", "Service Catalog Item 4", "15/3/2026", "€42 510"], status: "warning" as const },
    { id: "795795981", cells: ["GBS-7981", "Service Catalog Item 5", "2/10/2026", "€46 081"], status: "active" as const },
];
...
export default function GbsHubServiceCatalogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Service Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Service Catalog</p>
                    </div>
                </div>
