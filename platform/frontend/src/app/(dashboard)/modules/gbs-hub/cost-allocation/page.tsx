...
/* ═══ GBS Hub — Cost Allocation ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "3200", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "154", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2260", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1530574822", cells: ["GBS-8822", "Cost Allocation Item 1", "15/11/2026", "€24 922"], status: "active" as const },
    { id: "1530578393", cells: ["GBS-3393", "Cost Allocation Item 2", "2/6/2026", "€28 493"], status: "pending" as const },
    { id: "1530581964", cells: ["GBS-6964", "Cost Allocation Item 3", "17/1/2026", "€32 064"], status: "completed" as const },
    { id: "1530585535", cells: ["GBS-1535", "Cost Allocation Item 4", "4/8/2026", "€35 635"], status: "warning" as const },
    { id: "1530589106", cells: ["GBS-5106", "Cost Allocation Item 5", "19/3/2026", "€39 206"], status: "active" as const },
];
...
export default function GbsHubCostAllocationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cost Allocation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Cost Allocation</p>
                    </div>
                </div>
