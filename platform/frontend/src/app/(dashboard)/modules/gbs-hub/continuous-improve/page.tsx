...
/* ═══ GBS Hub — Continuous Improve ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "2506", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "440", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2120", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "696575412", cells: ["GBS-3412", "Continuous Improve Item 1", "9/1/2026", "€25 512"], status: "active" as const },
    { id: "696578983", cells: ["GBS-6983", "Continuous Improve Item 2", "24/8/2026", "€29 083"], status: "pending" as const },
    { id: "696582554", cells: ["GBS-1554", "Continuous Improve Item 3", "11/3/2026", "€32 654"], status: "completed" as const },
    { id: "696586125", cells: ["GBS-5125", "Continuous Improve Item 4", "26/10/2026", "€36 225"], status: "warning" as const },
    { id: "696589696", cells: ["GBS-8696", "Continuous Improve Item 5", "13/5/2026", "€39 796"], status: "active" as const },
];
...
export default function GbsHubContinuousImprovePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Continuous Improve</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Continuous Improve</p>
                    </div>
                </div>
