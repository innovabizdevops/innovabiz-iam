...
/* ═══ GBS Hub — Shared Accounting ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "3216", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "71", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2572", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1336081731", cells: ["GBS-5731", "Shared Accounting Item 1", "20/4/2026", "€31 831"], status: "active" as const },
    { id: "1336085302", cells: ["GBS-9302", "Shared Accounting Item 2", "7/11/2026", "€35 402"], status: "pending" as const },
    { id: "1336088873", cells: ["GBS-3873", "Shared Accounting Item 3", "22/6/2026", "€38 973"], status: "completed" as const },
    { id: "1336092444", cells: ["GBS-7444", "Shared Accounting Item 4", "9/1/2026", "€42 544"], status: "warning" as const },
    { id: "1336096015", cells: ["GBS-2015", "Shared Accounting Item 5", "24/8/2026", "€46 115"], status: "active" as const },
];
...
export default function GbsHubSharedAccountingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shared Accounting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Shared Accounting</p>
                    </div>
                </div>
