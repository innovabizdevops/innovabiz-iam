...
const KPIS = [
    { label: "Total", value: "1332", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "12", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2846", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1517453000", cells: ["GBS-9000", "Sla Manager Item 1", "1/9/2026", "€3100"], status: "active" as const },
    { id: "1517456571", cells: ["GBS-3571", "Sla Manager Item 2", "16/4/2026", "€6671"], status: "pending" as const },
    { id: "1517460142", cells: ["GBS-7142", "Sla Manager Item 3", "3/11/2026", "€10 242"], status: "completed" as const },
    { id: "1517463713", cells: ["GBS-1713", "Sla Manager Item 4", "18/6/2026", "€13 813"], status: "warning" as const },
    { id: "1517467284", cells: ["GBS-5284", "Sla Manager Item 5", "5/1/2026", "€17 384"], status: "active" as const },
];
...
export default function GbsHubSlaManagerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sla Manager</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Sla Manager</p>
                    </div>
                </div>
