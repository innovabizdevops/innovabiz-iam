...
const KPIS = [
    { label: "Total", value: "4448", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "396", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2402", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1388926392", cells: ["GBS-2392", "Shared Hr Item 1", "1/1/2026", "€26 492"], status: "active" as const },
    { id: "1388929963", cells: ["GBS-5963", "Shared Hr Item 2", "16/8/2026", "€30 063"], status: "pending" as const },
    { id: "1388933534", cells: ["GBS-9534", "Shared Hr Item 3", "3/3/2026", "€33 634"], status: "completed" as const },
    { id: "1388937105", cells: ["GBS-4105", "Shared Hr Item 4", "18/10/2026", "€37 205"], status: "warning" as const },
    { id: "1388940676", cells: ["GBS-7676", "Shared Hr Item 5", "5/5/2026", "€40 776"], status: "active" as const },
];
...
export default function GbsHubSharedHrPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shared Hr</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GBS Hub • Shared Hr</p>
                    </div>
                </div>
