...
const PAGE = "PMA";
const KPIS = [{"l":"Total Aero Certification","v":"3.471","t":"+3.1%","d":"up"},{"l":"PMA Ativos","v":"5.767","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"83.0%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+1.4%","d":"up"}];
const COLS = ["ID","PMA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aero Certification #001","Aero Certification #002","3.066","7.758","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Aero Certification #002","Aero Certification #003","7.960","8.196","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Aero Certification #003","Aero Certification #004","3.055","4.644","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Aero Certification #004","Aero Certification #005","2.384","4.488","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aero Certification #005","Aero Certification #001","3.816","1.767","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":880},{"label":"Mar","value":911},{"label":"Abr","value":1017},{"label":"Mai","value":956},{"label":"Jun","value":814},{"label":"Jul","value":879},{"label":"Ago","value":683},{"label":"Set","value":1058},{"label":"Out","value":842},{"label":"Nov","value":929},{"label":"Dez","value":905}];
const MX = 1058;
