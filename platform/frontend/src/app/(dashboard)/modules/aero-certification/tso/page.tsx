...
const ACCENT = "#6366f1";
const MODULE = "Aero Certification";
const PAGE = "TSO";
const KPIS = [{"l":"Total Aero Certification","v":"2.254","t":"+4.8%","d":"up"},{"l":"TSO Ativos","v":"4.022","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"83","t":"-1.2%","d":"down"}];
const COLS = ["ID","TSO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aero Certification #001","Aero Certification #002","4.979","2.985","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Aero Certification #002","Aero Certification #003","1.799","237","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Aero Certification #003","Aero Certification #004","9.003","6.634","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Aero Certification #004","Aero Certification #005","5.558","9.019","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aero Certification #005","Aero Certification #001","6.143","5.280","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":839},{"label":"Mar","value":773},{"label":"Abr","value":597},{"label":"Mai","value":580},{"label":"Jun","value":646},{"label":"Jul","value":717},{"label":"Ago","value":626},{"label":"Set","value":593},{"label":"Out","value":847},{"label":"Nov","value":804},{"label":"Dez","value":621}];
const MX = 847;
...
export default function TsoPage() {
    return (
