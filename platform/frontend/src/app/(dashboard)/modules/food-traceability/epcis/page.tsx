...
const ACCENT = "#fef08a";
const MODULE = "Food Traceability";
const PAGE = "EPCIS Track";
const KPIS = [{"l":"Total Food Traceability","v":"4.933","t":"-1.2%","d":"down"},{"l":"EPCIS Track Ativos","v":"102","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.8%","d":"up"}];
const COLS = ["ID","EPCIS Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Traceability #001","Food Traceability #002","3.184","3.575","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Food Traceability #002","Food Traceability #003","1.122","8.769","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Traceability #003","Food Traceability #004","8.093","5.056","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Food Traceability #004","Food Traceability #005","8.754","6.676","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Traceability #005","Food Traceability #001","7.924","5.240","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":489},{"label":"Mar","value":554},{"label":"Abr","value":608},{"label":"Mai","value":592},{"label":"Jun","value":389},{"label":"Jul","value":698},{"label":"Ago","value":405},{"label":"Set","value":358},{"label":"Out","value":602},{"label":"Nov","value":374},{"label":"Dez","value":540}];
const MX = 698;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#fef08a'}}>IoT</span></h1>
                </div>
