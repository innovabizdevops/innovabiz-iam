...
const PAGE = "De-Ice";
const KPIS = [{"l":"Projetos Sociais","v":"6.455","t":"-0.3%","d":"down"},{"l":"Beneficiários","v":"630","t":"-1.0%","d":"down"},{"l":"Investimento CSR (€)","v":"€80479","t":"+8.2%","d":"up"},{"l":"Score Impacto","v":"83","t":"+10.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.219","€ 34561.21","5.102","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.276","€ 19993.96","1.412","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.376","€ 16285.88","1.678","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.638","€ 12176.79","8.027","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.309","€ 22098.09","8.328","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":412},{"label":"Mar","value":405},{"label":"Abr","value":688},{"label":"Mai","value":577},{"label":"Jun","value":528},{"label":"Jul","value":623},{"label":"Ago","value":519},{"label":"Set","value":360},{"label":"Out","value":506},{"label":"Nov","value":638},{"label":"Dez","value":447}];
const MX = 688;
...
export default function DeicePage() {
    return (
