...
export default function AirportGroundPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Airport Ground</h1><p className="text-sm text-muted-foreground">Airport Ground • iBOS Enterprise</p></div>
