...
export default function PropertyDevelopPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Property Develop</h1><p className="text-sm text-muted-foreground">Property Develop • iBOS Enterprise</p></div>
