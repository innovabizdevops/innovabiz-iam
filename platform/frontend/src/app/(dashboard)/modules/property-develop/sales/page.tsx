...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€58236","t":"-4.1%","d":"down"},{"l":"Pipeline (€)","v":"€32699","t":"-1.7%","d":"down"},{"l":"Atingimento Quota (%)","v":"80.7%","t":"+7.0%","d":"up"},{"l":"Win Rate (%)","v":"74.1%","t":"+10.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 43174.63","€ 37354.26","€ 22187.78","77.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 3148.73","€ 11951.39","€ 35721.41","73.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 46974.70","€ 16062.37","€ 27629.63","75.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 35566.60","€ 13249.23","€ 41173.92","78.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 20476.69","€ 13330.17","€ 37317.39","88.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":669},{"label":"Mar","value":376},{"label":"Abr","value":336},{"label":"Mai","value":346},{"label":"Jun","value":502},{"label":"Jul","value":409},{"label":"Ago","value":441},{"label":"Set","value":644},{"label":"Out","value":685},{"label":"Nov","value":701},{"label":"Dez","value":492}];
const MX = 719;
