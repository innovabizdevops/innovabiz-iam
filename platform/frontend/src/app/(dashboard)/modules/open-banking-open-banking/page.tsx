...
export default function OpenBankingOpenBankingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Open Banking Open Banking</h1><p className="text-sm text-muted-foreground">Open Banking Open Banking • iBOS Enterprise</p></div>
