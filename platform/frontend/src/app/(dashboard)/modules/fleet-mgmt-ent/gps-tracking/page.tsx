...
const ROWS = [
  { id: "001", c: ["Gps Tracking-001", "Gps Tracking Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Gps Tracking-002", "Gps Tracking Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Gps Tracking-003", "Gps Tracking Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Gps Tracking-004", "Gps Tracking Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Gps Tracking-005", "Gps Tracking Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Gps Tracking", ts: "Há 2min", a: "Sistema" },
