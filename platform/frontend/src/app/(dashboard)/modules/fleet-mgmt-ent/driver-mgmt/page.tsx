...
const ROWS = [
  { id: "001", c: ["Driver Mgmt-001", "Driver Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Driver Mgmt-002", "Driver Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Driver Mgmt-003", "Driver Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Driver Mgmt-004", "Driver Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Driver Mgmt-005", "Driver Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Driver Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function DriverMgmtPage() {
  return (
