...
const ROWS = [
  { id: "001", c: ["Vehicle Register-001", "Vehicle Register Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Vehicle Register-002", "Vehicle Register Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Vehicle Register-003", "Vehicle Register Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Vehicle Register-004", "Vehicle Register Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Vehicle Register-005", "Vehicle Register Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Vehicle Register", ts: "Há 2min", a: "Sistema" },
