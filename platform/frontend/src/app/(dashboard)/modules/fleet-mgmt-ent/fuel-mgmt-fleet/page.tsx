...
const ROWS = [
  { id: "001", c: ["Fuel Mgmt Fleet-001", "Fuel Mgmt Fleet Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Fuel Mgmt Fleet-002", "Fuel Mgmt Fleet Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Fuel Mgmt Fleet-003", "Fuel Mgmt Fleet Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Fuel Mgmt Fleet-004", "Fuel Mgmt Fleet Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Fuel Mgmt Fleet-005", "Fuel Mgmt Fleet Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Fuel Mgmt Fleet", ts: "Há 2min", a: "Sistema" },
...
export default function FuelMgmtFleetPage() {
  return (
