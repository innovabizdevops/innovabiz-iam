...
const ROWS = [
  { id: "001", c: ["Insurance Fleet-001", "Insurance Fleet Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Insurance Fleet-002", "Insurance Fleet Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Insurance Fleet-003", "Insurance Fleet Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Insurance Fleet-004", "Insurance Fleet Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Insurance Fleet-005", "Insurance Fleet Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Insurance Fleet", ts: "Há 2min", a: "Sistema" },
...
export default function InsuranceFleetPage() {
  return (
