...
/* ═══ Bakery Chain — Dashboard ═══ */

const ACCENT = "#f97316";

const KPIS = [
    { label: "Total Registos", value: "9981", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "183", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€349K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1215739781", cells: ["BAK-2781", "Bakery Chain Item 1", "26/6/2026", "€39 881"], status: "active" as const },
    { id: "1215743352", cells: ["BAK-6352", "Bakery Chain Item 2", "13/1/2026", "€43 452"], status: "pending" as const },
    { id: "1215746923", cells: ["BAK-9923", "Bakery Chain Item 3", "28/8/2026", "€47 023"], status: "completed" as const },
    { id: "1215750494", cells: ["BAK-4494", "Bakery Chain Item 4", "15/3/2026", "€594"], status: "warning" as const },
    { id: "1215754065", cells: ["BAK-8065", "Bakery Chain Item 5", "2/10/2026", "€4165"], status: "active" as const },
];
...
export default function BakeryChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bakery Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Bakery Chain</p>
                    </div>
                </div>
