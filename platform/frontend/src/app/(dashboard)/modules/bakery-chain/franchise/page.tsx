...
const ACCENT = "#f97316";
const MODULE = "Bakery Chain";
const PAGE = "Franchise";
const KPIS = [{"l":"Total Bakery Chain","v":"5.440","t":"+15.2%","d":"up"},{"l":"Franchise Ativos","v":"7.292","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"65.0%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"88","t":"+12.0%","d":"up"}];
const COLS = ["ID","Franchise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bakery Chain #001","Bakery Chain #002","5.526","2.374","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Bakery Chain #002","Bakery Chain #003","7.417","7.549","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Bakery Chain #003","Bakery Chain #004","3.819","6.642","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Bakery Chain #004","Bakery Chain #005","135","874","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bakery Chain #005","Bakery Chain #001","4.950","5.966","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":268},{"label":"Fev","value":453},{"label":"Mar","value":547},{"label":"Abr","value":561},{"label":"Mai","value":375},{"label":"Jun","value":339},{"label":"Jul","value":513},{"label":"Ago","value":410},{"label":"Set","value":258},{"label":"Out","value":266},{"label":"Nov","value":301},{"label":"Dez","value":488}];
const MX = 561;
