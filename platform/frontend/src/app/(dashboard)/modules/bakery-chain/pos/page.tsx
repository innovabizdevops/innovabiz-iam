...
const PAGE = "POS";
const KPIS = [{"l":"Pedidos/Dia","v":"1008","t":"+9.1%","d":"up"},{"l":"GMV (€)","v":"€33910","t":"+8.5%","d":"up"},{"l":"Conversão (%)","v":"76.7%","t":"-3.9%","d":"down"},{"l":"AOV (€)","v":"€10692","t":"+5.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 7410.88","876","1.636","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 37558.05","4.881","1.099","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 4181.18","3.589","7.626","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 7504.45","8.997","4.319","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 27847.14","2.272","5.515","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":274},{"label":"Mar","value":265},{"label":"Abr","value":410},{"label":"Mai","value":522},{"label":"Jun","value":357},{"label":"Jul","value":536},{"label":"Ago","value":623},{"label":"Set","value":606},{"label":"Out","value":592},{"label":"Nov","value":375},{"label":"Dez","value":272}];
const MX = 623;
