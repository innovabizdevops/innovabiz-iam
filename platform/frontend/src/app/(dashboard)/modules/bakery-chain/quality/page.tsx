...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.592","t":"-4.9%","d":"down"},{"l":"NC Abertas","v":"3.614","t":"+11.5%","d":"up"},{"l":"Conformidade (%)","v":"71.2%","t":"+12.3%","d":"up"},{"l":"CAPAs Pendentes","v":"7.108","t":"+15.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.519","90.8%","731","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.396","92.7%","8.441","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.198","76.1%","1.923","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.879","93.4%","8.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.574","89.3%","4.201","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":358},{"label":"Mar","value":679},{"label":"Abr","value":334},{"label":"Mai","value":307},{"label":"Jun","value":668},{"label":"Jul","value":679},{"label":"Ago","value":375},{"label":"Set","value":599},{"label":"Out","value":327},{"label":"Nov","value":676},{"label":"Dez","value":369}];
const MX = 679;
