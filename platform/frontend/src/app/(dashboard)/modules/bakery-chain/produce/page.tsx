...
const PAGE = "Produce";
const KPIS = [{"l":"Total Bakery Chain","v":"548","t":"+17.5%","d":"up"},{"l":"Produce Ativos","v":"2.005","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+15.9%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bakery Chain #001","Bakery Chain #002","5.660","1.749","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Bakery Chain #002","Bakery Chain #003","344","6.401","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Bakery Chain #003","Bakery Chain #004","7.540","2.463","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Bakery Chain #004","Bakery Chain #005","1.007","5.277","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bakery Chain #005","Bakery Chain #001","3.619","371","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":639},{"label":"Mar","value":630},{"label":"Abr","value":520},{"label":"Mai","value":776},{"label":"Jun","value":524},{"label":"Jul","value":804},{"label":"Ago","value":715},{"label":"Set","value":748},{"label":"Out","value":790},{"label":"Nov","value":636},{"label":"Dez","value":540}];
const MX = 804;
