...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"6.062","t":"+13.9%","d":"up"},{"l":"Submissões/Dia","v":"2252","t":"+13.3%","d":"up"},{"l":"Documentos Gerados","v":"361","t":"+4.5%","d":"up"},{"l":"Templates","v":"6.878","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.705","2026-01-17","1.129","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.826","2026-01-09","1.214","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.485","2026-01-21","9.097","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.926","2026-01-21","521","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.573","2026-02-22","6.604","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1008},{"label":"Fev","value":629},{"label":"Mar","value":899},{"label":"Abr","value":890},{"label":"Mai","value":786},{"label":"Jun","value":755},{"label":"Jul","value":895},{"label":"Ago","value":634},{"label":"Set","value":981},{"label":"Out","value":648},{"label":"Nov","value":886},{"label":"Dez","value":810}];
const MX = 1008;
