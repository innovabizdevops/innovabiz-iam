...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.520","t":"+14.1%","d":"up"},{"l":"Submissões/Dia","v":"3744","t":"-2.9%","d":"down"},{"l":"Documentos Gerados","v":"1.318","t":"+17.3%","d":"up"},{"l":"Templates","v":"2.096","t":"+4.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","184","2026-02-04","3.434","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.010","2026-01-12","7.874","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.716","2026-03-07","4.011","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.990","2026-01-23","5.558","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.126","2026-03-27","7.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":944},{"label":"Mar","value":790},{"label":"Abr","value":719},{"label":"Mai","value":771},{"label":"Jun","value":866},{"label":"Jul","value":680},{"label":"Ago","value":909},{"label":"Set","value":850},{"label":"Out","value":849},{"label":"Nov","value":842},{"label":"Dez","value":1029}];
const MX = 1029;
