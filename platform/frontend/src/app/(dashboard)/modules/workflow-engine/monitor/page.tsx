...
const ACCENT = "#06b6d4";
const MODULE = "Workflow Engine Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Workflow Engine","v":"7.302","t":"+9.0%","d":"up"},{"l":"Monitor Ativos","v":"948","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"84","t":"-1.3%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Workflow Engine #001","Workflow Engine #002","4.991","7.991","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Workflow Engine #002","Workflow Engine #003","3.928","863","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Workflow Engine #003","Workflow Engine #004","1.232","1.201","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Workflow Engine #004","Workflow Engine #005","8.470","8.893","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Workflow Engine #005","Workflow Engine #001","3.395","4.674","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":733},{"label":"Mar","value":483},{"label":"Abr","value":547},{"label":"Mai","value":782},{"label":"Jun","value":403},{"label":"Jul","value":472},{"label":"Ago","value":595},{"label":"Set","value":467},{"label":"Out","value":647},{"label":"Nov","value":785},{"label":"Dez","value":551}];
const MX = 785;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#06b6d4'}}>RTM</span></h1>
                </div>
