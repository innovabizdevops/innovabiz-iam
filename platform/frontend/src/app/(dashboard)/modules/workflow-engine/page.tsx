...
/* ═══ Workflow Engine Deep — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "3601", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2670", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€90K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "131841801", cells: ["WOR-1801", "Workflow Engine Deep Item 1", "22/10/2026", "€41 901"], status: "active" as const },
    { id: "131845372", cells: ["WOR-5372", "Workflow Engine Deep Item 2", "9/5/2026", "€45 472"], status: "pending" as const },
    { id: "131848943", cells: ["WOR-8943", "Workflow Engine Deep Item 3", "24/12/2026", "€49 043"], status: "completed" as const },
    { id: "131852514", cells: ["WOR-3514", "Workflow Engine Deep Item 4", "11/7/2026", "€2614"], status: "warning" as const },
    { id: "131856085", cells: ["WOR-7085", "Workflow Engine Deep Item 5", "26/2/2026", "€6185"], status: "active" as const },
];
...
export default function WorkflowEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Workflow Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Workflow Engine Deep</p>
                    </div>
                </div>
