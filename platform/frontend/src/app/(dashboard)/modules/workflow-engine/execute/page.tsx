...
const PAGE = "Execute";
const KPIS = [{"l":"Total Workflow Engine","v":"6.791","t":"+9.1%","d":"up"},{"l":"Execute Ativos","v":"611","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"67.3%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"95","t":"+0.8%","d":"up"}];
const COLS = ["ID","Execute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Workflow Engine #001","Workflow Engine #002","1.406","8.478","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Workflow Engine #002","Workflow Engine #003","4.537","7.983","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Workflow Engine #003","Workflow Engine #004","167","6.501","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Workflow Engine #004","Workflow Engine #005","6.861","8.546","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Workflow Engine #005","Workflow Engine #001","3.154","3.261","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":929},{"label":"Mar","value":957},{"label":"Abr","value":748},{"label":"Mai","value":1056},{"label":"Jun","value":774},{"label":"Jul","value":1035},{"label":"Ago","value":1032},{"label":"Set","value":883},{"label":"Out","value":966},{"label":"Nov","value":1007},{"label":"Dez","value":767}];
const MX = 1056;
