...
const PAGE = "Report";
const KPIS = [{"l":"Total Pest Control Svc","v":"1.890","t":"+12.4%","d":"up"},{"l":"Report Ativos","v":"6.140","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"86.0%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+12.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pest Control Svc #001","Pest Control Svc #002","3.597","6.784","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Pest Control Svc #002","Pest Control Svc #003","1.849","3.101","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Pest Control Svc #003","Pest Control Svc #004","1.242","1.526","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Pest Control Svc #004","Pest Control Svc #005","6.006","5.521","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pest Control Svc #005","Pest Control Svc #001","6.914","4.243","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":537},{"label":"Mar","value":607},{"label":"Abr","value":567},{"label":"Mai","value":709},{"label":"Jun","value":466},{"label":"Jul","value":697},{"label":"Ago","value":713},{"label":"Set","value":724},{"label":"Out","value":632},{"label":"Nov","value":566},{"label":"Dez","value":661}];
const MX = 724;
