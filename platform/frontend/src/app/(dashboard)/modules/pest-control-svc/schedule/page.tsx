...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Pest Control Svc","v":"4.280","t":"+1.6%","d":"up"},{"l":"Schedule Ativos","v":"4.839","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"85.8%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"64","t":"+4.9%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pest Control Svc #001","Pest Control Svc #002","6.196","3.012","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pest Control Svc #002","Pest Control Svc #003","5.530","7.130","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Pest Control Svc #003","Pest Control Svc #004","1.955","382","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pest Control Svc #004","Pest Control Svc #005","1.459","4.791","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pest Control Svc #005","Pest Control Svc #001","5.045","7.840","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":573},{"label":"Mar","value":566},{"label":"Abr","value":406},{"label":"Mai","value":556},{"label":"Jun","value":630},{"label":"Jul","value":406},{"label":"Ago","value":593},{"label":"Set","value":447},{"label":"Out","value":455},{"label":"Nov","value":575},{"label":"Dez","value":335}];
const MX = 630;
