...
const PAGE = "Treat";
const KPIS = [{"l":"Total Pest Control Svc","v":"5.202","t":"-5.9%","d":"down"},{"l":"Treat Ativos","v":"6.897","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+12.5%","d":"up"}];
const COLS = ["ID","Treat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pest Control Svc #001","Pest Control Svc #002","3.187","4.047","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Pest Control Svc #002","Pest Control Svc #003","4.887","1.920","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pest Control Svc #003","Pest Control Svc #004","8.309","887","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pest Control Svc #004","Pest Control Svc #005","3.434","7.967","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pest Control Svc #005","Pest Control Svc #001","6.992","8.693","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":921},{"label":"Mar","value":597},{"label":"Abr","value":892},{"label":"Mai","value":819},{"label":"Jun","value":894},{"label":"Jul","value":547},{"label":"Ago","value":637},{"label":"Set","value":687},{"label":"Out","value":713},{"label":"Nov","value":936},{"label":"Dez","value":644}];
const MX = 936;
