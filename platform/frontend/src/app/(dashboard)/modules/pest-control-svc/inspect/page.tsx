...
const ACCENT = "#6366f1";
const MODULE = "Pest Control";
const PAGE = "Inspect";
const KPIS = [{"l":"Total Pest Control Svc","v":"6.412","t":"+10.6%","d":"up"},{"l":"Inspect Ativos","v":"7.513","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"60","t":"+11.4%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pest Control Svc #001","Pest Control Svc #002","8.330","2.720","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Pest Control Svc #002","Pest Control Svc #003","1.548","435","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Pest Control Svc #003","Pest Control Svc #004","4.261","6.160","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Pest Control Svc #004","Pest Control Svc #005","3.720","3.548","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pest Control Svc #005","Pest Control Svc #001","1.844","4.899","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":275},{"label":"Fev","value":447},{"label":"Mar","value":455},{"label":"Abr","value":543},{"label":"Mai","value":396},{"label":"Jun","value":588},{"label":"Jul","value":408},{"label":"Ago","value":361},{"label":"Set","value":448},{"label":"Out","value":386},{"label":"Nov","value":658},{"label":"Dez","value":351}];
const MX = 658;
