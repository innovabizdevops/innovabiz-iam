...
const KPIS = [{"l":"Dashboards Ativos","v":"3.527","t":"-3.2%","d":"down"},{"l":"Queries/Dia","v":"3363","t":"+17.2%","d":"up"},{"l":"Dados Processados (GB)","v":"745","t":"+17.6%","d":"up"},{"l":"Utilizadores Analytics","v":"4.434","t":"-2.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3284","2026-03-28","2.169","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1577","2026-02-14","6.097","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2463","2026-01-14","4.989","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4860","2026-02-14","8.417","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2953","2026-02-05","729","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":333},{"label":"Fev","value":662},{"label":"Mar","value":397},{"label":"Abr","value":595},{"label":"Mai","value":511},{"label":"Jun","value":571},{"label":"Jul","value":346},{"label":"Ago","value":511},{"label":"Set","value":343},{"label":"Out","value":674},{"label":"Nov","value":422},{"label":"Dez","value":431}];
const MX = 674;
