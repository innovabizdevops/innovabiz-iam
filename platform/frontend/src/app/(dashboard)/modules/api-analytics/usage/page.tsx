...
const PAGE = "Usage Metrics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.729","t":"+11.5%","d":"up"},{"l":"Queries/Dia","v":"4805","t":"+9.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.206","t":"+4.5%","d":"up"},{"l":"Utilizadores Analytics","v":"7.361","t":"+14.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2225","2026-02-11","5.059","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1031","2026-02-19","7.946","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2476","2026-02-07","6.038","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3004","2026-01-14","4.997","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1190","2026-01-09","5.933","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":653},{"label":"Mar","value":868},{"label":"Abr","value":567},{"label":"Mai","value":887},{"label":"Jun","value":703},{"label":"Jul","value":830},{"label":"Ago","value":664},{"label":"Set","value":882},{"label":"Out","value":602},{"label":"Nov","value":612},{"label":"Dez","value":719}];
const MX = 887;
