...
const PAGE = "Consumer Insights";
const KPIS = [{"l":"Dashboards Ativos","v":"7.359","t":"+17.5%","d":"up"},{"l":"Queries/Dia","v":"4288","t":"+10.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.744","t":"+2.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.529","t":"+13.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","328","2026-02-05","308","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3684","2026-01-16","927","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1889","2026-03-27","5.304","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1278","2026-03-09","944","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2498","2026-03-07","4.962","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":676},{"label":"Mar","value":594},{"label":"Abr","value":792},{"label":"Mai","value":785},{"label":"Jun","value":773},{"label":"Jul","value":633},{"label":"Ago","value":801},{"label":"Set","value":681},{"label":"Out","value":694},{"label":"Nov","value":745},{"label":"Dez","value":615}];
const MX = 840;
