...
const PAGE = "Quota Mgmt";
const KPIS = [{"l":"Vendas YTD (€)","v":"€92202","t":"+16.2%","d":"up"},{"l":"Pipeline (€)","v":"€57132","t":"+5.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"91.9%","t":"+16.2%","d":"up"},{"l":"Win Rate (%)","v":"75.7%","t":"+8.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 20597.48","€ 9524.92","€ 41169.40","78.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 1906.64","€ 30950.58","€ 31356.04","94.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 41272.11","€ 9984.87","€ 10145.03","70.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 25844.72","€ 15436.37","€ 20258.72","96.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 43714.03","€ 18431.44","€ 40741.25","85.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":576},{"label":"Mar","value":693},{"label":"Abr","value":693},{"label":"Mai","value":722},{"label":"Jun","value":493},{"label":"Jul","value":673},{"label":"Ago","value":544},{"label":"Set","value":723},{"label":"Out","value":560},{"label":"Nov","value":688},{"label":"Dez","value":601}];
const MX = 723;
