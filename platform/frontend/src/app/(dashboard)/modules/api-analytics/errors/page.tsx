...
const PAGE = "Error Tracking";
const KPIS = [{"l":"Dashboards Ativos","v":"5.404","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"704","t":"+4.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.254","t":"+5.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.758","t":"+5.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3185","2026-01-25","614","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3981","2026-02-05","7.212","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1263","2026-01-18","4.478","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4373","2026-03-25","2.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3655","2026-03-06","6.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":884},{"label":"Mar","value":952},{"label":"Abr","value":690},{"label":"Mai","value":690},{"label":"Jun","value":808},{"label":"Jul","value":878},{"label":"Ago","value":725},{"label":"Set","value":930},{"label":"Out","value":588},{"label":"Nov","value":593},{"label":"Dez","value":793}];
const MX = 952;
