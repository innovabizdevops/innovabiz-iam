...
const PAGE = "Outage Mgmt";
const KPIS = [{"l":"Total Electric Utility","v":"3.842","t":"+17.3%","d":"up"},{"l":"Outage Mgmt Ativos","v":"5.137","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"74","t":"-4.5%","d":"down"}];
const COLS = ["ID","Outage Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Electric Utility #001","Electric Utility #002","7.890","2.817","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Electric Utility #002","Electric Utility #003","2.247","666","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Electric Utility #003","Electric Utility #004","4.546","2.304","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Electric Utility #004","Electric Utility #005","6.752","3.662","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Electric Utility #005","Electric Utility #001","3.847","8.333","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":256},{"label":"Mar","value":332},{"label":"Abr","value":273},{"label":"Mai","value":616},{"label":"Jun","value":605},{"label":"Jul","value":350},{"label":"Ago","value":541},{"label":"Set","value":488},{"label":"Out","value":536},{"label":"Nov","value":499},{"label":"Dez","value":465}];
const MX = 616;
