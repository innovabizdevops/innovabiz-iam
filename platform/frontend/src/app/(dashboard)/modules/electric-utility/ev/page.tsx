...
const PAGE = "EV Integration";
const KPIS = [{"l":"Integrações Ativas","v":"349","t":"+5.4%","d":"up"},{"l":"Chamadas/Hora","v":"1440","t":"+14.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.0%","t":"-5.6%","d":"down"},{"l":"Latência Média (ms)","v":"104ms","t":"+1.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.526","6.388","78.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.586","1.219","92.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.611","7.911","99.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.091","8.194","84.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.532","1.171","98.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":735},{"label":"Mar","value":442},{"label":"Abr","value":802},{"label":"Mai","value":486},{"label":"Jun","value":617},{"label":"Jul","value":484},{"label":"Ago","value":730},{"label":"Set","value":623},{"label":"Out","value":561},{"label":"Nov","value":611},{"label":"Dez","value":652}];
const MX = 802;
