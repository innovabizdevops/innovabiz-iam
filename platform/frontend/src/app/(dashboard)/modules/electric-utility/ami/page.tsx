...
const ACCENT = "#b45309";
const MODULE = "Electric Utility";
const PAGE = "AMI Metering";
const KPIS = [{"l":"Total Electric Utility","v":"3.958","t":"-5.4%","d":"down"},{"l":"AMI Metering Ativos","v":"6.601","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"56","t":"-6.0%","d":"down"}];
const COLS = ["ID","AMI Metering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Electric Utility #001","Electric Utility #002","3.203","5.836","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Electric Utility #002","Electric Utility #003","2.825","3.367","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Electric Utility #003","Electric Utility #004","6.322","7.301","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Electric Utility #004","Electric Utility #005","6.523","6.908","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Electric Utility #005","Electric Utility #001","2.372","3.864","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":547},{"label":"Mar","value":601},{"label":"Abr","value":434},{"label":"Mai","value":496},{"label":"Jun","value":375},{"label":"Jul","value":361},{"label":"Ago","value":431},{"label":"Set","value":616},{"label":"Out","value":531},{"label":"Nov","value":509},{"label":"Dez","value":657}];
const MX = 657;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>IoT</span></h1>
                </div>
