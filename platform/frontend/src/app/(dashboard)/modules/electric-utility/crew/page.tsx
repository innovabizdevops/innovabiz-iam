...
const PAGE = "Crew Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"1.475","t":"+1.0%","d":"up"},{"l":"Viagens/Dia","v":"2521","t":"+13.0%","d":"up"},{"l":"Pontualidade (%)","v":"81.4%","t":"+8.3%","d":"up"},{"l":"Passageiros/Dia","v":"4792","t":"-5.9%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-24","2026-02-17","2.592","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-11","2026-01-14","4.140","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-21","2026-01-06","7.577","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-05","2026-01-20","3.709","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-07","2026-01-25","6.995","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1065},{"label":"Fev","value":805},{"label":"Mar","value":952},{"label":"Abr","value":1075},{"label":"Mai","value":1086},{"label":"Jun","value":700},{"label":"Jul","value":820},{"label":"Ago","value":748},{"label":"Set","value":747},{"label":"Out","value":1045},{"label":"Nov","value":894},{"label":"Dez","value":1068}];
const MX = 1086;
