...
export default function ElectricUtilityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Electric Utility</h1><p className="text-sm text-muted-foreground">Electric Utility • iBOS Enterprise</p></div>
