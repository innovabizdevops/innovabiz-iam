...
const KPIS = [{"l":"Total Electric Utility","v":"1.905","t":"+5.8%","d":"up"},{"l":"Rate Case Ativos","v":"6.915","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"77","t":"-1.0%","d":"down"}];
const COLS = ["ID","Rate Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Electric Utility #001","Electric Utility #002","7.234","1.800","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Electric Utility #002","Electric Utility #003","8.349","3.049","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Electric Utility #003","Electric Utility #004","3.043","1.237","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Electric Utility #004","Electric Utility #005","7.891","374","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Electric Utility #005","Electric Utility #001","2.667","3.590","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":815},{"label":"Mar","value":668},{"label":"Abr","value":683},{"label":"Mai","value":905},{"label":"Jun","value":923},{"label":"Jul","value":646},{"label":"Ago","value":775},{"label":"Set","value":931},{"label":"Out","value":783},{"label":"Nov","value":606},{"label":"Dez","value":699}];
const MX = 963;
