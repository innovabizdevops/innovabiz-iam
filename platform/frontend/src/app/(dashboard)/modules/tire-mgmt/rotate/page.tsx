...
const PAGE = "Rotate";
const KPIS = [{"l":"Total Tire Mgmt","v":"313","t":"+4.1%","d":"up"},{"l":"Rotate Ativos","v":"3.941","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+8.2%","d":"up"}];
const COLS = ["ID","Rotate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tire Mgmt #001","Tire Mgmt #002","1.745","1.067","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Tire Mgmt #002","Tire Mgmt #003","925","325","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Tire Mgmt #003","Tire Mgmt #004","9.018","7.838","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Tire Mgmt #004","Tire Mgmt #005","6.506","8.482","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tire Mgmt #005","Tire Mgmt #001","513","7.043","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":540},{"label":"Mar","value":688},{"label":"Abr","value":568},{"label":"Mai","value":846},{"label":"Jun","value":852},{"label":"Jul","value":616},{"label":"Ago","value":656},{"label":"Set","value":776},{"label":"Out","value":781},{"label":"Nov","value":608},{"label":"Dez","value":742}];
const MX = 902;
