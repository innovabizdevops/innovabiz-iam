...
const KPIS = [{"l":"Total Tire Mgmt","v":"8.245","t":"+10.7%","d":"up"},{"l":"Inventory Ativos","v":"8.348","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"67","t":"+1.0%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tire Mgmt #001","Tire Mgmt #002","1.179","3.442","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Tire Mgmt #002","Tire Mgmt #003","8.389","2.630","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Tire Mgmt #003","Tire Mgmt #004","6.901","6.174","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Tire Mgmt #004","Tire Mgmt #005","4.948","3.547","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tire Mgmt #005","Tire Mgmt #001","1.298","792","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":396},{"label":"Mar","value":519},{"label":"Abr","value":424},{"label":"Mai","value":381},{"label":"Jun","value":490},{"label":"Jul","value":686},{"label":"Ago","value":393},{"label":"Set","value":621},{"label":"Out","value":719},{"label":"Nov","value":485},{"label":"Dez","value":673}];
const MX = 719;
