...
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"1.719","t":"+12.3%","d":"up"},{"l":"Treinos/Semana","v":"841","t":"+5.6%","d":"up"},{"l":"Competições","v":"3.981","t":"-0.2%","d":"down"},{"l":"Performance Score","v":"93","t":"-3.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.473","8.580","8.088","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.674","183","5.516","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.733","576","6.303","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.600","852","8.604","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.651","1.710","3.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":373},{"label":"Mar","value":633},{"label":"Abr","value":262},{"label":"Mai","value":400},{"label":"Jun","value":611},{"label":"Jul","value":393},{"label":"Ago","value":585},{"label":"Set","value":567},{"label":"Out","value":452},{"label":"Nov","value":348},{"label":"Dez","value":337}];
const MX = 633;
