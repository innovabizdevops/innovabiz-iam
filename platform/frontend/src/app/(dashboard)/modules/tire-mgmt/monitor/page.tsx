...
const ACCENT = "#6366f1";
const MODULE = "Tire Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Tire Mgmt","v":"6.683","t":"-2.8%","d":"down"},{"l":"Monitor Ativos","v":"5.693","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"77","t":"-3.2%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tire Mgmt #001","Tire Mgmt #002","1.081","3.470","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Tire Mgmt #002","Tire Mgmt #003","8.684","646","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Tire Mgmt #003","Tire Mgmt #004","5.875","4.136","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Tire Mgmt #004","Tire Mgmt #005","4.459","1.551","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tire Mgmt #005","Tire Mgmt #001","8.309","4.888","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":396},{"label":"Mar","value":395},{"label":"Abr","value":498},{"label":"Mai","value":574},{"label":"Jun","value":504},{"label":"Jul","value":548},{"label":"Ago","value":716},{"label":"Set","value":608},{"label":"Out","value":335},{"label":"Nov","value":396},{"label":"Dez","value":664}];
const MX = 716;
