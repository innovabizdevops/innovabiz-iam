...
const KPIS = [{"l":"Dashboards Ativos","v":"5.262","t":"+12.0%","d":"up"},{"l":"Queries/Dia","v":"1475","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"1.992","t":"+9.7%","d":"up"},{"l":"Utilizadores Analytics","v":"2.164","t":"+13.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1051","2026-03-11","4.416","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","765","2026-01-19","4.596","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","146","2026-01-17","221","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2862","2026-02-13","673","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4333","2026-03-06","5.777","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":593},{"label":"Mar","value":522},{"label":"Abr","value":391},{"label":"Mai","value":487},{"label":"Jun","value":298},{"label":"Jul","value":291},{"label":"Ago","value":636},{"label":"Set","value":398},{"label":"Out","value":549},{"label":"Nov","value":358},{"label":"Dez","value":609}];
const MX = 636;
