...
const PAGE = "Spray";
const KPIS = [{"l":"Total Pest Mgmt Ag","v":"7.223","t":"-4.4%","d":"down"},{"l":"Spray Ativos","v":"3.128","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"63","t":"+11.7%","d":"up"}];
const COLS = ["ID","Spray","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pest Mgmt Ag #001","Pest Mgmt Ag #002","8.307","5.780","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Pest Mgmt Ag #002","Pest Mgmt Ag #003","4.868","4.287","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Pest Mgmt Ag #003","Pest Mgmt Ag #004","4.133","3.273","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pest Mgmt Ag #004","Pest Mgmt Ag #005","2.362","8.127","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pest Mgmt Ag #005","Pest Mgmt Ag #001","4.139","6.576","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":325},{"label":"Mar","value":425},{"label":"Abr","value":376},{"label":"Mai","value":593},{"label":"Jun","value":431},{"label":"Jul","value":524},{"label":"Ago","value":621},{"label":"Set","value":474},{"label":"Out","value":438},{"label":"Nov","value":691},{"label":"Dez","value":650}];
const MX = 691;
