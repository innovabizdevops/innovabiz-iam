...
const PAGE = "IPM";
const KPIS = [{"l":"Total Pest Mgmt Ag","v":"1.143","t":"+3.4%","d":"up"},{"l":"IPM Ativos","v":"5.431","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"94.4%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+17.4%","d":"up"}];
const COLS = ["ID","IPM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pest Mgmt Ag #001","Pest Mgmt Ag #002","2.943","5.020","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Pest Mgmt Ag #002","Pest Mgmt Ag #003","4.849","7.104","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Pest Mgmt Ag #003","Pest Mgmt Ag #004","8.266","524","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Pest Mgmt Ag #004","Pest Mgmt Ag #005","794","1.210","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pest Mgmt Ag #005","Pest Mgmt Ag #001","4.526","7.077","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":827},{"label":"Mar","value":662},{"label":"Abr","value":824},{"label":"Mai","value":618},{"label":"Jun","value":739},{"label":"Jul","value":736},{"label":"Ago","value":581},{"label":"Set","value":450},{"label":"Out","value":680},{"label":"Nov","value":519},{"label":"Dez","value":625}];
const MX = 827;
