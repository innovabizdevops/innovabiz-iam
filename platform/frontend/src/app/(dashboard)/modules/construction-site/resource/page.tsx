...
const PAGE = "Resource";
const KPIS = [{"l":"Total Construction Site","v":"5.598","t":"+1.7%","d":"up"},{"l":"Resource Ativos","v":"5.121","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"70.8%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"94","t":"-3.2%","d":"down"}];
const COLS = ["ID","Resource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Site #001","Construction Site #002","4.870","3.336","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Site #002","Construction Site #003","4.646","1.783","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Site #003","Construction Site #004","671","5.177","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Site #004","Construction Site #005","4.412","7.271","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Site #005","Construction Site #001","1.702","4.238","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":507},{"label":"Mar","value":688},{"label":"Abr","value":777},{"label":"Mai","value":450},{"label":"Jun","value":554},{"label":"Jul","value":819},{"label":"Ago","value":561},{"label":"Set","value":594},{"label":"Out","value":752},{"label":"Nov","value":522},{"label":"Dez","value":513}];
const MX = 819;
