...
/* ═══ Construction Site Ops — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3514", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2346", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€12K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "108814314", cells: ["CON-5314", "Construction Site Ops Item 1", "15/7/2026", "€14 414"], status: "active" as const },
    { id: "108817885", cells: ["CON-8885", "Construction Site Ops Item 2", "2/2/2026", "€17 985"], status: "pending" as const },
    { id: "108821456", cells: ["CON-3456", "Construction Site Ops Item 3", "17/9/2026", "€21 556"], status: "completed" as const },
    { id: "108825027", cells: ["CON-7027", "Construction Site Ops Item 4", "4/4/2026", "€25 127"], status: "warning" as const },
    { id: "108828598", cells: ["CON-1598", "Construction Site Ops Item 5", "19/11/2026", "€28 698"], status: "active" as const },
];
...
export default function ConstructionSiteOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Construction Site Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Construction Site Ops</p>
                    </div>
                </div>
