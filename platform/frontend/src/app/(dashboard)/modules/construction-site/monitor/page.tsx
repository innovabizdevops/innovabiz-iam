...
const ACCENT = "#78350f";
const MODULE = "Construction Site Ops";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Construction Site","v":"4.493","t":"-1.3%","d":"down"},{"l":"Monitor Ativos","v":"8.121","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+16.7%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Site #001","Construction Site #002","8.699","5.316","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Site #002","Construction Site #003","6.153","4.814","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Site #003","Construction Site #004","5.210","5.446","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Site #004","Construction Site #005","4.233","6.003","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Site #005","Construction Site #001","5.915","4.343","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":319},{"label":"Mar","value":401},{"label":"Abr","value":637},{"label":"Mai","value":580},{"label":"Jun","value":541},{"label":"Jul","value":321},{"label":"Ago","value":560},{"label":"Set","value":286},{"label":"Out","value":373},{"label":"Nov","value":405},{"label":"Dez","value":287}];
const MX = 637;
