...
const ACCENT = "#b91c1c";
const MODULE = "Donor Management";
const PAGE = "Bequest Mgmt";
const KPIS = [{"l":"Total Donor Mgmt","v":"6.001","t":"-2.2%","d":"down"},{"l":"Bequest Mgmt Ativos","v":"8.502","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"88.0%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"60","t":"-1.3%","d":"down"}];
const COLS = ["ID","Bequest Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt #001","Donor Mgmt #002","6.827","123","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt #002","Donor Mgmt #003","1.318","7.415","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt #003","Donor Mgmt #004","6.057","6.362","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt #004","Donor Mgmt #005","6.156","9.032","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt #005","Donor Mgmt #001","7.427","2.501","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":511},{"label":"Mar","value":458},{"label":"Abr","value":417},{"label":"Mai","value":613},{"label":"Jun","value":549},{"label":"Jul","value":446},{"label":"Ago","value":430},{"label":"Set","value":380},{"label":"Out","value":274},{"label":"Nov","value":638},{"label":"Dez","value":591}];
const MX = 638;
...
export default function BequestPage() {
    return (
