...
const KPIS = [{"l":"Total Donor Mgmt","v":"2.911","t":"+10.4%","d":"up"},{"l":"Thank You Ativos","v":"1.745","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"62","t":"-1.7%","d":"down"}];
const COLS = ["ID","Thank You","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt #001","Donor Mgmt #002","2.022","7.920","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt #002","Donor Mgmt #003","284","6.870","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt #003","Donor Mgmt #004","3.882","4.149","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt #004","Donor Mgmt #005","3.142","802","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt #005","Donor Mgmt #001","1.311","5.478","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":614},{"label":"Mar","value":733},{"label":"Abr","value":854},{"label":"Mai","value":808},{"label":"Jun","value":677},{"label":"Jul","value":679},{"label":"Ago","value":768},{"label":"Set","value":776},{"label":"Out","value":646},{"label":"Nov","value":573},{"label":"Dez","value":849}];
const MX = 854;
