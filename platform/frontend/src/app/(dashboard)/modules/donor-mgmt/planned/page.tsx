...
const PAGE = "Planned Giving";
const KPIS = [{"l":"Total Donor Mgmt","v":"4.732","t":"+-0.0%","d":"up"},{"l":"Planned Giving Ativos","v":"9.004","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+6.5%","d":"up"}];
const COLS = ["ID","Planned Giving","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt #001","Donor Mgmt #002","7.716","7.044","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt #002","Donor Mgmt #003","5.063","805","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt #003","Donor Mgmt #004","7.564","4.093","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt #004","Donor Mgmt #005","3.271","1.800","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt #005","Donor Mgmt #001","6.792","6.208","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":696},{"label":"Mar","value":581},{"label":"Abr","value":742},{"label":"Mai","value":535},{"label":"Jun","value":390},{"label":"Jul","value":352},{"label":"Ago","value":513},{"label":"Set","value":538},{"label":"Out","value":351},{"label":"Nov","value":673},{"label":"Dez","value":575}];
const MX = 742;
