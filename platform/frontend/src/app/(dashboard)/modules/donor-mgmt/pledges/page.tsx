...
const PAGE = "Pledge Track";
const KPIS = [{"l":"Total Donor Mgmt","v":"1.861","t":"-5.2%","d":"down"},{"l":"Pledge Track Ativos","v":"7.074","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+6.4%","d":"up"}];
const COLS = ["ID","Pledge Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt #001","Donor Mgmt #002","6.739","4.910","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt #002","Donor Mgmt #003","8.378","5.012","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt #003","Donor Mgmt #004","7.393","2.327","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt #004","Donor Mgmt #005","5.223","722","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt #005","Donor Mgmt #001","496","5.121","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":706},{"label":"Mar","value":795},{"label":"Abr","value":702},{"label":"Mai","value":1005},{"label":"Jun","value":814},{"label":"Jul","value":905},{"label":"Ago","value":961},{"label":"Set","value":806},{"label":"Out","value":707},{"label":"Nov","value":823},{"label":"Dez","value":683}];
const MX = 1028;
