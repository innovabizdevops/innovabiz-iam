...
const PAGE = "Major Gifts";
const KPIS = [{"l":"Total Donor Mgmt","v":"7.390","t":"+4.9%","d":"up"},{"l":"Major Gifts Ativos","v":"2.239","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.1%","d":"up"}];
const COLS = ["ID","Major Gifts","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt #001","Donor Mgmt #002","9.015","4.930","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt #002","Donor Mgmt #003","4.768","111","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt #003","Donor Mgmt #004","7.854","8.719","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt #004","Donor Mgmt #005","6.695","4.518","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt #005","Donor Mgmt #001","8.092","8.032","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":827},{"label":"Mar","value":739},{"label":"Abr","value":783},{"label":"Mai","value":816},{"label":"Jun","value":485},{"label":"Jul","value":499},{"label":"Ago","value":555},{"label":"Set","value":560},{"label":"Out","value":823},{"label":"Nov","value":842},{"label":"Dez","value":795}];
const MX = 842;
