...
const PAGE = "Gift History";
const KPIS = [{"l":"Total Donor Mgmt","v":"5.557","t":"+6.7%","d":"up"},{"l":"Gift History Ativos","v":"710","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"72","t":"+2.5%","d":"up"}];
const COLS = ["ID","Gift History","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt #001","Donor Mgmt #002","260","6.574","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt #002","Donor Mgmt #003","453","7.752","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt #003","Donor Mgmt #004","6.525","5.817","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt #004","Donor Mgmt #005","2.197","952","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt #005","Donor Mgmt #001","1.920","7.758","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":732},{"label":"Mar","value":692},{"label":"Abr","value":936},{"label":"Mai","value":708},{"label":"Jun","value":883},{"label":"Jul","value":788},{"label":"Ago","value":804},{"label":"Set","value":996},{"label":"Out","value":640},{"label":"Nov","value":897},{"label":"Dez","value":739}];
const MX = 996;
