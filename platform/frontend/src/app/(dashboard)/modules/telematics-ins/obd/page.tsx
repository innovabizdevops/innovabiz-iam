...
const PAGE = "OBD Device";
const KPIS = [{"l":"Dispositivos Online","v":"436","t":"-1.8%","d":"down"},{"l":"Dados/Min (MB)","v":"7.634","t":"+7.7%","d":"up"},{"l":"Alertas Ativos","v":"7.629","t":"+4.4%","d":"up"},{"l":"Uptime (%)","v":"81.5%","t":"+17.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.394","5.913","2.128","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.106","6.092","5.324","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.034","7.059","4.907","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.356","8.521","3.105","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.027","6.882","3.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":744},{"label":"Mar","value":978},{"label":"Abr","value":869},{"label":"Mai","value":762},{"label":"Jun","value":693},{"label":"Jul","value":757},{"label":"Ago","value":849},{"label":"Set","value":697},{"label":"Out","value":708},{"label":"Nov","value":821},{"label":"Dez","value":922}];
const MX = 978;
