...
const PAGE = "Claims";
const KPIS = [{"l":"Total Telematics Ins","v":"3.913","t":"+6.8%","d":"up"},{"l":"Claims Ativos","v":"6.871","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+14.8%","d":"up"}];
const COLS = ["ID","Claims","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telematics Ins #001","Telematics Ins #002","5.261","5.012","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Telematics Ins #002","Telematics Ins #003","3.089","6.407","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Telematics Ins #003","Telematics Ins #004","5.098","4.392","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Telematics Ins #004","Telematics Ins #005","3.041","7.909","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telematics Ins #005","Telematics Ins #001","4.574","156","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":760},{"label":"Mar","value":767},{"label":"Abr","value":1024},{"label":"Mai","value":886},{"label":"Jun","value":794},{"label":"Jul","value":925},{"label":"Ago","value":770},{"label":"Set","value":879},{"label":"Out","value":801},{"label":"Nov","value":689},{"label":"Dez","value":1017}];
const MX = 1024;
