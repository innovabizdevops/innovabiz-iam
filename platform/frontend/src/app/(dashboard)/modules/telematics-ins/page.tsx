...
export default function TelematicsInsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Telematics Ins</h1><p className="text-sm text-muted-foreground">Telematics Ins • iBOS Enterprise</p></div>
