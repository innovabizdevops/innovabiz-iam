...
const PAGE = "Trip Log";
const KPIS = [{"l":"Total Telematics Ins","v":"1.651","t":"+17.9%","d":"up"},{"l":"Trip Log Ativos","v":"8.651","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"62","t":"+8.9%","d":"up"}];
const COLS = ["ID","Trip Log","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telematics Ins #001","Telematics Ins #002","7.970","3.012","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Telematics Ins #002","Telematics Ins #003","6.803","5.529","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Telematics Ins #003","Telematics Ins #004","2.770","7.422","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Telematics Ins #004","Telematics Ins #005","8.936","1.815","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telematics Ins #005","Telematics Ins #001","8.120","5.862","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":853},{"label":"Mar","value":789},{"label":"Abr","value":560},{"label":"Mai","value":694},{"label":"Jun","value":883},{"label":"Jul","value":706},{"label":"Ago","value":777},{"label":"Set","value":754},{"label":"Out","value":714},{"label":"Nov","value":656},{"label":"Dez","value":699}];
const MX = 883;
