...
const PAGE = "Premium";
const KPIS = [{"l":"Total Telematics Ins","v":"7.759","t":"+10.7%","d":"up"},{"l":"Premium Ativos","v":"4.549","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"83","t":"+5.1%","d":"up"}];
const COLS = ["ID","Premium","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telematics Ins #001","Telematics Ins #002","9.012","7.706","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Telematics Ins #002","Telematics Ins #003","7.362","8.224","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Telematics Ins #003","Telematics Ins #004","1.740","314","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Telematics Ins #004","Telematics Ins #005","7.705","3.565","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telematics Ins #005","Telematics Ins #001","2.712","2.629","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":347},{"label":"Mar","value":405},{"label":"Abr","value":418},{"label":"Mai","value":466},{"label":"Jun","value":394},{"label":"Jul","value":573},{"label":"Ago","value":392},{"label":"Set","value":362},{"label":"Out","value":393},{"label":"Nov","value":372},{"label":"Dez","value":341}];
const MX = 573;
