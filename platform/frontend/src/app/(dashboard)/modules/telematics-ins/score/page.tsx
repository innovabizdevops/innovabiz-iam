...
const ACCENT = "#6366f1";
const MODULE = "Telematics Insurance";
const PAGE = "Driving Score";
const KPIS = [{"l":"Total Telematics Ins","v":"7.935","t":"+4.1%","d":"up"},{"l":"Driving Score Ativos","v":"91","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"78","t":"+2.3%","d":"up"}];
const COLS = ["ID","Driving Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telematics Ins #001","97.0%","8.541","3.350","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Telematics Ins #002","79.8%","2.855","8.618","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Telematics Ins #003","89.9%","5.309","254","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Telematics Ins #004","91.2%","1.616","7.236","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telematics Ins #005","74.0%","5.737","7.169","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":640},{"label":"Mar","value":825},{"label":"Abr","value":474},{"label":"Mai","value":473},{"label":"Jun","value":708},{"label":"Jul","value":717},{"label":"Ago","value":457},{"label":"Set","value":444},{"label":"Out","value":668},{"label":"Nov","value":443},{"label":"Dez","value":521}];
const MX = 825;
