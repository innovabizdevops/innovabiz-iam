...
const ACCENT = "#0ea5e9";
const MODULE = "Toll Management";
const PAGE = "ETC";
const KPIS = [{"l":"Total Toll Mgmt","v":"9.093","t":"+0.3%","d":"up"},{"l":"ETC Ativos","v":"7.822","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"74","t":"+3.8%","d":"up"}];
const COLS = ["ID","ETC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Toll Mgmt #001","Toll Mgmt #002","6.921","4.209","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Toll Mgmt #002","Toll Mgmt #003","2.500","7.564","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Toll Mgmt #003","Toll Mgmt #004","1.654","2.473","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Toll Mgmt #004","Toll Mgmt #005","3.759","6.799","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Toll Mgmt #005","Toll Mgmt #001","1.491","527","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":522},{"label":"Mar","value":812},{"label":"Abr","value":681},{"label":"Mai","value":566},{"label":"Jun","value":852},{"label":"Jul","value":514},{"label":"Ago","value":670},{"label":"Set","value":641},{"label":"Out","value":570},{"label":"Nov","value":604},{"label":"Dez","value":693}];
const MX = 852;
