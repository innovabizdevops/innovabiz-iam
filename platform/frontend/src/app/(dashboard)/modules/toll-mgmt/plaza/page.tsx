...
const PAGE = "Plaza";
const KPIS = [{"l":"Total Toll Mgmt","v":"8.732","t":"+11.6%","d":"up"},{"l":"Plaza Ativos","v":"5.194","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"58","t":"-2.9%","d":"down"}];
const COLS = ["ID","Plaza","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Toll Mgmt #001","Toll Mgmt #002","7.723","8.962","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Toll Mgmt #002","Toll Mgmt #003","5.230","689","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Toll Mgmt #003","Toll Mgmt #004","5.410","6.985","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Toll Mgmt #004","Toll Mgmt #005","8.989","5.439","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Toll Mgmt #005","Toll Mgmt #001","6.782","2.635","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":771},{"label":"Mar","value":967},{"label":"Abr","value":848},{"label":"Mai","value":932},{"label":"Jun","value":707},{"label":"Jul","value":707},{"label":"Ago","value":790},{"label":"Set","value":776},{"label":"Out","value":888},{"label":"Nov","value":705},{"label":"Dez","value":759}];
const MX = 967;
