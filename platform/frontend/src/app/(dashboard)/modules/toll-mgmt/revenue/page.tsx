...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€36.9M","t":"+1.2%","d":"up"},{"l":"MRR (€)","v":"€90985","t":"+5.4%","d":"up"},{"l":"Churn (%)","v":"87.4%","t":"+14.9%","d":"up"},{"l":"ARPU (€)","v":"€7054","t":"+0.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42424.02","1.942","€ 42712.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 20228.02","1.379","€ 26339.48","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 16026.05","2.968","€ 10128.12","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 44793.58","6.703","€ 40036.21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42643.17","5.687","€ 46147.44","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":593},{"label":"Mar","value":619},{"label":"Abr","value":549},{"label":"Mai","value":320},{"label":"Jun","value":567},{"label":"Jul","value":256},{"label":"Ago","value":274},{"label":"Set","value":370},{"label":"Out","value":279},{"label":"Nov","value":515},{"label":"Dez","value":378}];
const MX = 619;
