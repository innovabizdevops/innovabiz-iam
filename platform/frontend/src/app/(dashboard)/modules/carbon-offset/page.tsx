...
/* ═══ Carbon Offset Platform — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8522", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1010", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€227K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "752477722", cells: ["CAR-6722", "Carbon Offset Platform Item 1", "11/11/2026", "€27 822"], status: "active" as const },
    { id: "752481293", cells: ["CAR-1293", "Carbon Offset Platform Item 2", "26/6/2026", "€31 393"], status: "pending" as const },
    { id: "752484864", cells: ["CAR-4864", "Carbon Offset Platform Item 3", "13/1/2026", "€34 964"], status: "completed" as const },
    { id: "752488435", cells: ["CAR-8435", "Carbon Offset Platform Item 4", "28/8/2026", "€38 535"], status: "warning" as const },
    { id: "752492006", cells: ["CAR-3006", "Carbon Offset Platform Item 5", "15/3/2026", "€42 106"], status: "active" as const },
];
...
export default function CarbonOffsetPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carbon Offset Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Carbon Offset Platform</p>
                    </div>
                </div>
