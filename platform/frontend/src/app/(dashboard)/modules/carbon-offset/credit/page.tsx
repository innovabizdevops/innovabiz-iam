...
const PAGE = "Credit";
const KPIS = [{"l":"Integrações Ativas","v":"7.187","t":"+9.5%","d":"up"},{"l":"Chamadas/Hora","v":"2095","t":"+2.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.0%","t":"-0.1%","d":"down"},{"l":"Latência Média (ms)","v":"124ms","t":"+6.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.124","7.122","73.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.136","8.028","91.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.534","7.152","92.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.822","7.170","73.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.987","1.857","98.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":650},{"label":"Mar","value":423},{"label":"Abr","value":412},{"label":"Mai","value":478},{"label":"Jun","value":471},{"label":"Jul","value":630},{"label":"Ago","value":520},{"label":"Set","value":689},{"label":"Out","value":442},{"label":"Nov","value":488},{"label":"Dez","value":694}];
const MX = 694;
