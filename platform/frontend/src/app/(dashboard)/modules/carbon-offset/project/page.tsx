...
const ACCENT = "#059669";
const MODULE = "Carbon Offset Platform";
const PAGE = "Project";
const KPIS = [{"l":"Total Carbon Offset","v":"169","t":"-0.6%","d":"down"},{"l":"Project Ativos","v":"2.199","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"70","t":"+2.2%","d":"up"}];
const COLS = ["ID","Project","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Offset #001","Carbon Offset #002","9.000","4.154","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Offset #002","Carbon Offset #003","8.044","2.875","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Offset #003","Carbon Offset #004","3.050","3.701","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Offset #004","Carbon Offset #005","4.490","4.859","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Offset #005","Carbon Offset #001","5.858","4.776","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":599},{"label":"Mar","value":451},{"label":"Abr","value":473},{"label":"Mai","value":694},{"label":"Jun","value":696},{"label":"Jul","value":468},{"label":"Ago","value":547},{"label":"Set","value":764},{"label":"Out","value":510},{"label":"Nov","value":454},{"label":"Dez","value":802}];
const MX = 802;
