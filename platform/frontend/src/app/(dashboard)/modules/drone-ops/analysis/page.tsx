...
const ACCENT = "#7c3aed";
const MODULE = "Drone Operations";
const PAGE = "Image Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"6.442","t":"+1.3%","d":"up"},{"l":"Queries/Dia","v":"2578","t":"+0.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.875","t":"+13.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.712","t":"+17.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2410","2026-02-27","638","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","124","2026-03-10","1.143","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2390","2026-03-09","4.903","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2459","2026-01-17","132","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3827","2026-03-09","2.873","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":776},{"label":"Mar","value":467},{"label":"Abr","value":484},{"label":"Mai","value":612},{"label":"Jun","value":498},{"label":"Jul","value":795},{"label":"Ago","value":460},{"label":"Set","value":454},{"label":"Out","value":781},{"label":"Nov","value":760},{"label":"Dez","value":569}];
const MX = 795;
