...
const PAGE = "Flight Plans";
const KPIS = [{"l":"Total Drone Ops","v":"1.460","t":"+13.4%","d":"up"},{"l":"Flight Plans Ativos","v":"5.152","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.2%","d":"up"}];
const COLS = ["ID","Flight Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Ops #001","Drone Ops #002","8.274","4.535","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Ops #002","Drone Ops #003","6.110","624","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Ops #003","Drone Ops #004","426","150","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Ops #004","Drone Ops #005","6.480","398","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Ops #005","Drone Ops #001","1.018","7.170","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":663},{"label":"Mar","value":654},{"label":"Abr","value":861},{"label":"Mai","value":515},{"label":"Jun","value":855},{"label":"Jul","value":529},{"label":"Ago","value":581},{"label":"Set","value":806},{"label":"Out","value":666},{"label":"Nov","value":691},{"label":"Dez","value":872}];
const MX = 872;
