...
const PAGE = "Payload Config";
const KPIS = [{"l":"Configurações","v":"569","t":"-3.4%","d":"down"},{"l":"Últimas Alterações","v":"2.767","t":"+3.7%","d":"up"},{"l":"Ambientes","v":"3.250","t":"-3.5%","d":"down"},{"l":"Versão Config","v":"8.962","t":"+2.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 13544.87","5.374","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 10456.91","2.733","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 43322.06","7.615","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 49274.34","6.265","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 36516.53","3.956","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":208},{"label":"Fev","value":524},{"label":"Mar","value":293},{"label":"Abr","value":359},{"label":"Mai","value":414},{"label":"Jun","value":277},{"label":"Jul","value":285},{"label":"Ago","value":523},{"label":"Set","value":239},{"label":"Out","value":338},{"label":"Nov","value":270},{"label":"Dez","value":509}];
const MX = 524;
