...
const PAGE = "Airspace Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"4.163","t":"+13.6%","d":"up"},{"l":"RevPAR (€)","v":"€92052","t":"+17.4%","d":"up"},{"l":"Ocupação (%)","v":"68.6%","t":"+13.5%","d":"up"},{"l":"Guest Satisfaction","v":"1.749","t":"+8.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.276","2026-01-01","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.401","2026-02-22","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.621","2026-03-21","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.137","2026-01-02","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.520","2026-01-19","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":369},{"label":"Mar","value":426},{"label":"Abr","value":380},{"label":"Mai","value":278},{"label":"Jun","value":568},{"label":"Jul","value":248},{"label":"Ago","value":255},{"label":"Set","value":535},{"label":"Out","value":420},{"label":"Nov","value":520},{"label":"Dez","value":363}];
const MX = 568;
