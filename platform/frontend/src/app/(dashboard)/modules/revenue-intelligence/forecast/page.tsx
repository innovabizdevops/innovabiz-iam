...
const PAGE = "Forecast AI";
const KPIS = [{"l":"ARR (€M)","v":"€13.9M","t":"-4.7%","d":"down"},{"l":"MRR (€)","v":"€62558","t":"+9.3%","d":"up"},{"l":"Churn (%)","v":"77.2%","t":"+12.5%","d":"up"},{"l":"ARPU (€)","v":"€41779","t":"+14.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42527.42","6.842","€ 27313.92","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 34151.40","2.965","€ 21303.44","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 24838.86","443","€ 42165.37","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16925.88","3.799","€ 26627.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29047.33","5.409","€ 15046.51","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":846},{"label":"Mar","value":845},{"label":"Abr","value":938},{"label":"Mai","value":702},{"label":"Jun","value":777},{"label":"Jul","value":567},{"label":"Ago","value":865},{"label":"Set","value":586},{"label":"Out","value":732},{"label":"Nov","value":595},{"label":"Dez","value":611}];
const MX = 938;
