...
const PAGE = "Pipeline Analytics AI";
const KPIS = [{"l":"ARR (€M)","v":"€39.0M","t":"+8.2%","d":"up"},{"l":"MRR (€)","v":"€42079","t":"-3.4%","d":"down"},{"l":"Churn (%)","v":"86.1%","t":"+9.7%","d":"up"},{"l":"ARPU (€)","v":"€94887","t":"+16.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 11162.69","295","€ 35866.40","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 31314.48","5.345","€ 40625.13","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 43874.23","8.373","€ 13748.71","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47150.51","4.387","€ 10413.26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17878.36","7.305","€ 16920.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":710},{"label":"Mar","value":847},{"label":"Abr","value":794},{"label":"Mai","value":529},{"label":"Jun","value":548},{"label":"Jul","value":640},{"label":"Ago","value":708},{"label":"Set","value":762},{"label":"Out","value":726},{"label":"Nov","value":795},{"label":"Dez","value":619}];
const MX = 847;
