...
const PAGE = "Competitive Intel";
const KPIS = [{"l":"ARR (€M)","v":"€24.8M","t":"-3.8%","d":"down"},{"l":"MRR (€)","v":"€27112","t":"+12.2%","d":"up"},{"l":"Churn (%)","v":"91.9%","t":"+17.2%","d":"up"},{"l":"ARPU (€)","v":"€84586","t":"+1.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7180.74","1.783","€ 33730.70","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41820.82","1.134","€ 18624.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46918.58","3.583","€ 7458.85","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 779.92","5.960","€ 3014.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 38781.40","6.051","€ 1596.61","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":575},{"label":"Mar","value":662},{"label":"Abr","value":848},{"label":"Mai","value":854},{"label":"Jun","value":887},{"label":"Jul","value":918},{"label":"Ago","value":879},{"label":"Set","value":560},{"label":"Out","value":568},{"label":"Nov","value":768},{"label":"Dez","value":846}];
const MX = 918;
