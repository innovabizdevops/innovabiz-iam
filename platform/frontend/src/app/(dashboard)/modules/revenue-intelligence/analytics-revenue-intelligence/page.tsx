...
const PAGE = "Revenue Analytics";
const KPIS = [{"l":"ARR (€M)","v":"€20.2M","t":"+2.7%","d":"up"},{"l":"MRR (€)","v":"€60912","t":"+1.5%","d":"up"},{"l":"Churn (%)","v":"73.1%","t":"+15.0%","d":"up"},{"l":"ARPU (€)","v":"€74919","t":"+10.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 14855.10","2.364","€ 25804.24","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9464.38","7.473","€ 18861.17","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28742.76","7.492","€ 16496.36","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 822.17","4.847","€ 12178.64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 44229.81","6.021","€ 41797.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":789},{"label":"Mar","value":806},{"label":"Abr","value":562},{"label":"Mai","value":480},{"label":"Jun","value":586},{"label":"Jul","value":626},{"label":"Ago","value":613},{"label":"Set","value":627},{"label":"Out","value":645},{"label":"Nov","value":670},{"label":"Dez","value":724}];
const MX = 806;
...
export default function AnalyticsRevenueIntelligencePage() {
    return (
