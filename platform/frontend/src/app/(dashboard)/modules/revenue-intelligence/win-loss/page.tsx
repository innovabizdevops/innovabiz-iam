...
const PAGE = "Win/Loss Analysis";
const KPIS = [{"l":"ARR (€M)","v":"€45.8M","t":"+15.0%","d":"up"},{"l":"MRR (€)","v":"€66056","t":"+15.1%","d":"up"},{"l":"Churn (%)","v":"73.2%","t":"+15.0%","d":"up"},{"l":"ARPU (€)","v":"€22241","t":"+3.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 48100.83","3.538","€ 16717.28","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41461.90","6.234","€ 3809.91","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42405.79","1.046","€ 35036.95","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 34685.43","2.184","€ 41104.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11606.85","1.210","€ 29090.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":936},{"label":"Mar","value":699},{"label":"Abr","value":828},{"label":"Mai","value":955},{"label":"Jun","value":970},{"label":"Jul","value":742},{"label":"Ago","value":959},{"label":"Set","value":892},{"label":"Out","value":875},{"label":"Nov","value":732},{"label":"Dez","value":925}];
const MX = 970;
