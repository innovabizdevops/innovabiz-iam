...
const KPIS = [{"l":"ARR (€M)","v":"€20.1M","t":"+9.1%","d":"up"},{"l":"MRR (€)","v":"€14763","t":"+2.8%","d":"up"},{"l":"Churn (%)","v":"66.2%","t":"+16.8%","d":"up"},{"l":"ARPU (€)","v":"€72425","t":"-0.8%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 6567.00","5.256","€ 42395.16","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 39135.79","3.408","€ 44570.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25592.54","2.551","€ 1802.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11232.52","2.947","€ 44117.52","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 18640.96","6.702","€ 13197.08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":543},{"label":"Mar","value":765},{"label":"Abr","value":747},{"label":"Mai","value":678},{"label":"Jun","value":648},{"label":"Jul","value":595},{"label":"Ago","value":542},{"label":"Set","value":797},{"label":"Out","value":646},{"label":"Nov","value":693},{"label":"Dez","value":565}];
const MX = 797;
