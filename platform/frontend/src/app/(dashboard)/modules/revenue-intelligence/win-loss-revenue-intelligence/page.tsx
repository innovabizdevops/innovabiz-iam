...
const KPIS = [{"l":"ARR (€M)","v":"€29.3M","t":"+10.8%","d":"up"},{"l":"MRR (€)","v":"€31347","t":"+3.6%","d":"up"},{"l":"Churn (%)","v":"71.1%","t":"-2.5%","d":"down"},{"l":"ARPU (€)","v":"€71862","t":"+13.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13299.69","1.941","€ 11412.55","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 42709.61","1.655","€ 46874.52","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37326.23","5.691","€ 41881.70","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43141.05","637","€ 13870.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 30640.22","1.628","€ 44396.92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":1025},{"label":"Mar","value":699},{"label":"Abr","value":1052},{"label":"Mai","value":983},{"label":"Jun","value":916},{"label":"Jul","value":709},{"label":"Ago","value":899},{"label":"Set","value":1010},{"label":"Out","value":724},{"label":"Nov","value":903},{"label":"Dez","value":684}];
const MX = 1052;
...
export default function WinLossRevenueIntelligencePage() {
    return (
