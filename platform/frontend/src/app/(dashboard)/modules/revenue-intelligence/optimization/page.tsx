...
const PAGE = "Revenue Optimization";
const KPIS = [{"l":"ARR (€M)","v":"€28.9M","t":"+13.4%","d":"up"},{"l":"MRR (€)","v":"€34642","t":"+9.7%","d":"up"},{"l":"Churn (%)","v":"94.6%","t":"+14.6%","d":"up"},{"l":"ARPU (€)","v":"€72982","t":"+5.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 21069.93","1.916","€ 25101.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17108.62","7.429","€ 47384.46","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 15314.50","6.331","€ 28859.57","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2587.71","8.469","€ 7134.10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 41389.81","7.348","€ 29396.99","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":768},{"label":"Mar","value":688},{"label":"Abr","value":735},{"label":"Mai","value":489},{"label":"Jun","value":803},{"label":"Jul","value":744},{"label":"Ago","value":814},{"label":"Set","value":866},{"label":"Out","value":581},{"label":"Nov","value":592},{"label":"Dez","value":508}];
const MX = 882;
