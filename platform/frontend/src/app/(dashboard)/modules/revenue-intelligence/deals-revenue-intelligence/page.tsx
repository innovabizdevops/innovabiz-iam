...
const PAGE = "Deal Insights";
const KPIS = [{"l":"ARR (€M)","v":"€19.8M","t":"+8.8%","d":"up"},{"l":"MRR (€)","v":"€45164","t":"+14.4%","d":"up"},{"l":"Churn (%)","v":"70.3%","t":"-3.9%","d":"down"},{"l":"ARPU (€)","v":"€77182","t":"+13.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 40088.51","2.875","€ 22704.42","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9153.26","6.894","€ 31097.99","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32770.44","7.100","€ 45502.34","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16814.75","6.779","€ 43581.50","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 32104.44","1.249","€ 25233.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":593},{"label":"Mar","value":706},{"label":"Abr","value":541},{"label":"Mai","value":666},{"label":"Jun","value":697},{"label":"Jul","value":440},{"label":"Ago","value":726},{"label":"Set","value":757},{"label":"Out","value":731},{"label":"Nov","value":732},{"label":"Dez","value":682}];
const MX = 770;
...
export default function DealsRevenueIntelligencePage() {
    return (
