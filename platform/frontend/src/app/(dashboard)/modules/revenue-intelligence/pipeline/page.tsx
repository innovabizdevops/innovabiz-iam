...
const PAGE = "Pipeline AI";
const KPIS = [{"l":"ARR (€M)","v":"€44.7M","t":"+6.7%","d":"up"},{"l":"MRR (€)","v":"€60840","t":"-5.5%","d":"down"},{"l":"Churn (%)","v":"87.7%","t":"-2.0%","d":"down"},{"l":"ARPU (€)","v":"€50549","t":"+9.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42040.40","6.448","€ 1648.64","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38440.08","7.913","€ 11934.46","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4573.04","6.612","€ 13157.93","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 40307.94","1.148","€ 45095.99","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40038.73","3.386","€ 22628.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":533},{"label":"Mar","value":316},{"label":"Abr","value":397},{"label":"Mai","value":653},{"label":"Jun","value":441},{"label":"Jul","value":381},{"label":"Ago","value":424},{"label":"Set","value":587},{"label":"Out","value":350},{"label":"Nov","value":518},{"label":"Dez","value":649}];
const MX = 664;
