...
const PAGE = "Conversation Intelligence";
const KPIS = [{"l":"ARR (€M)","v":"€44.8M","t":"+14.5%","d":"up"},{"l":"MRR (€)","v":"€34805","t":"+3.1%","d":"up"},{"l":"Churn (%)","v":"72.2%","t":"-5.8%","d":"down"},{"l":"ARPU (€)","v":"€30914","t":"+15.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32050.52","3.951","€ 4989.08","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 23602.83","4.850","€ 36454.14","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29961.09","7.573","€ 39978.38","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 37921.74","7.135","€ 11780.30","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 47113.87","4.398","€ 44903.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":803},{"label":"Mar","value":798},{"label":"Abr","value":824},{"label":"Mai","value":969},{"label":"Jun","value":833},{"label":"Jul","value":905},{"label":"Ago","value":982},{"label":"Set","value":908},{"label":"Out","value":702},{"label":"Nov","value":810},{"label":"Dez","value":700}];
const MX = 982;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ef4444'}}>GenAI</span></h1>
                </div>
