...
const PAGE = "Quota Attainment";
const KPIS = [{"l":"Vendas YTD (€)","v":"€42724","t":"+8.7%","d":"up"},{"l":"Pipeline (€)","v":"€97716","t":"+5.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"82.2%","t":"+12.9%","d":"up"},{"l":"Win Rate (%)","v":"92.9%","t":"+6.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 16377.31","€ 30307.62","€ 42957.67","82.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 2591.31","€ 38658.80","€ 13188.04","85.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 42120.34","€ 11058.27","€ 39448.14","77.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 33864.75","€ 2128.14","€ 41799.50","92.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 18652.83","€ 45211.72","€ 32146.77","79.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":736},{"label":"Mar","value":713},{"label":"Abr","value":582},{"label":"Mai","value":557},{"label":"Jun","value":528},{"label":"Jul","value":603},{"label":"Ago","value":704},{"label":"Set","value":598},{"label":"Out","value":552},{"label":"Nov","value":463},{"label":"Dez","value":685}];
const MX = 736;
