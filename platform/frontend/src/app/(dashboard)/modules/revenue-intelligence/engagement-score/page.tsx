...
const ACCENT = "#ef4444";
const MODULE = "Revenue Intelligence";
const PAGE = "Engagement Scoring";
const KPIS = [{"l":"eNPS","v":"65","t":"-2.6%","d":"down"},{"l":"Engagement (%)","v":"93.1%","t":"+6.0%","d":"up"},{"l":"Turnover (%)","v":"68.2%","t":"+15.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.540","t":"+9.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.613","2026-01-03","95","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.299","2026-01-21","82","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.466","2026-01-09","74","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.253","2026-03-09","82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.796","2026-02-27","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":834},{"label":"Mar","value":900},{"label":"Abr","value":869},{"label":"Mai","value":738},{"label":"Jun","value":654},{"label":"Jul","value":797},{"label":"Ago","value":693},{"label":"Set","value":759},{"label":"Out","value":762},{"label":"Nov","value":895},{"label":"Dez","value":702}];
const MX = 900;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ef4444'}}>AI</span></h1>
                </div>
