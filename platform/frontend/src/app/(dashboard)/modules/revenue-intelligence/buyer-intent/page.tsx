...
const PAGE = "Buyer Intent Signals";
const KPIS = [{"l":"ARR (€M)","v":"€38.7M","t":"+7.4%","d":"up"},{"l":"MRR (€)","v":"€4434","t":"+2.4%","d":"up"},{"l":"Churn (%)","v":"87.5%","t":"+4.9%","d":"up"},{"l":"ARPU (€)","v":"€10374","t":"-5.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 31413.70","3.899","€ 25308.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 5422.56","6.616","€ 43974.52","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40932.47","1.266","€ 49050.89","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26263.31","8.667","€ 2659.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23883.93","4.199","€ 48435.01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":596},{"label":"Mar","value":431},{"label":"Abr","value":628},{"label":"Mai","value":359},{"label":"Jun","value":386},{"label":"Jul","value":603},{"label":"Ago","value":385},{"label":"Set","value":293},{"label":"Out","value":603},{"label":"Nov","value":454},{"label":"Dez","value":584}];
const MX = 628;
