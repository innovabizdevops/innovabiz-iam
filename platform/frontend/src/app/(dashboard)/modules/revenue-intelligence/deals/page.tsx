...
const PAGE = "Deal Intelligence";
const KPIS = [{"l":"ARR (€M)","v":"€11.4M","t":"+2.2%","d":"up"},{"l":"MRR (€)","v":"€39409","t":"-3.5%","d":"down"},{"l":"Churn (%)","v":"93.8%","t":"+9.1%","d":"up"},{"l":"ARPU (€)","v":"€36401","t":"+12.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 29963.95","7.755","€ 33654.67","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38509.31","5.171","€ 11341.16","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 15757.93","176","€ 43390.43","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 25101.54","770","€ 29953.77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 47993.21","274","€ 18944.82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":891},{"label":"Mar","value":1017},{"label":"Abr","value":847},{"label":"Mai","value":677},{"label":"Jun","value":711},{"label":"Jul","value":731},{"label":"Ago","value":924},{"label":"Set","value":711},{"label":"Out","value":992},{"label":"Nov","value":818},{"label":"Dez","value":894}];
const MX = 1017;
