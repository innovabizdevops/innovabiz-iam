...
const ACCENT = "#166534";
const MODULE = "Waste Management Platform";
const PAGE = "Classify";
const KPIS = [{"l":"Total Waste Mgmt","v":"2.857","t":"+3.6%","d":"up"},{"l":"Classify Ativos","v":"7.772","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"81","t":"+17.5%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Mgmt #001","Waste Mgmt #002","7.215","3.941","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Mgmt #002","Waste Mgmt #003","5.272","362","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Mgmt #003","Waste Mgmt #004","2.357","8.191","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Mgmt #004","Waste Mgmt #005","8.616","6.873","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Mgmt #005","Waste Mgmt #001","4.186","8.709","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":915},{"label":"Mar","value":773},{"label":"Abr","value":951},{"label":"Mai","value":765},{"label":"Jun","value":911},{"label":"Jul","value":913},{"label":"Ago","value":817},{"label":"Set","value":815},{"label":"Out","value":746},{"label":"Nov","value":1080},{"label":"Dez","value":901}];
const MX = 1080;
