...
/* ═══ Waste Management Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "5623", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3102", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€167K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1220140923", cells: ["WAS-2923", "Waste Management Platform Item 1", "16/4/2026", "€41 023"], status: "active" as const },
    { id: "1220144494", cells: ["WAS-6494", "Waste Management Platform Item 2", "3/11/2026", "€44 594"], status: "pending" as const },
    { id: "1220148065", cells: ["WAS-1065", "Waste Management Platform Item 3", "18/6/2026", "€48 165"], status: "completed" as const },
    { id: "1220151636", cells: ["WAS-4636", "Waste Management Platform Item 4", "5/1/2026", "€1736"], status: "warning" as const },
    { id: "1220155207", cells: ["WAS-8207", "Waste Management Platform Item 5", "20/8/2026", "€5307"], status: "active" as const },
];
...
export default function WasteManagementPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Waste Management Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Waste Management Platform</p>
                    </div>
                </div>
