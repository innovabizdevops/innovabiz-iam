...
const PAGE = "Collect";
const KPIS = [{"l":"Total Waste Mgmt","v":"9.013","t":"+7.5%","d":"up"},{"l":"Collect Ativos","v":"6.656","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"69","t":"+12.8%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Mgmt #001","Waste Mgmt #002","5.256","5.936","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Mgmt #002","Waste Mgmt #003","7.790","8.567","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Mgmt #003","Waste Mgmt #004","4.342","500","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Mgmt #004","Waste Mgmt #005","8.554","1.234","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Mgmt #005","Waste Mgmt #001","9.023","7.432","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":672},{"label":"Mar","value":796},{"label":"Abr","value":627},{"label":"Mai","value":620},{"label":"Jun","value":592},{"label":"Jul","value":800},{"label":"Ago","value":949},{"label":"Set","value":847},{"label":"Out","value":603},{"label":"Nov","value":713},{"label":"Dez","value":955}];
const MX = 955;
