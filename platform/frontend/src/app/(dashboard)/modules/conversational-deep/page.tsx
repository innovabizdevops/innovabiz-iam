...
/* ═══ Conversational Marketing Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "7786", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "536", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€246K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "391344786", cells: ["CON-7786", "Conversational Marketing Deep Item 1", "15/7/2026", "€44 886"], status: "active" as const },
    { id: "391348357", cells: ["CON-2357", "Conversational Marketing Deep Item 2", "2/2/2026", "€48 457"], status: "pending" as const },
    { id: "391351928", cells: ["CON-5928", "Conversational Marketing Deep Item 3", "17/9/2026", "€2028"], status: "completed" as const },
    { id: "391355499", cells: ["CON-9499", "Conversational Marketing Deep Item 4", "4/4/2026", "€5599"], status: "warning" as const },
    { id: "391359070", cells: ["CON-4070", "Conversational Marketing Deep Item 5", "19/11/2026", "€9170"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 86 }, { label: "Fev", value: 95 }, { label: "Mar", value: 24 }, { label: "Abr", value: 33 }, { label: "Mai", value: 42 }, { label: "Jun", value: 51 }];
...
export default function ConversationalMarketingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conversational Marketing Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Conversational Marketing Deep</p>
                    </div>
                </div>
