...
const ACCENT = "#be185d";
const MODULE = "Conversational Marketing Deep";
const PAGE = "Chatbot";
const KPIS = [{"l":"Teams Ativos","v":"8.171","t":"+0.7%","d":"up"},{"l":"Reuniões/Semana","v":"3543","t":"-5.7%","d":"down"},{"l":"Mensagens/Dia","v":"1204","t":"+9.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.258","t":"+0.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.584","4102","2.537","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.147","3833","7.873","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.184","2304","3.016","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.714","4610","7.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.077","4048","944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":889},{"label":"Mar","value":1015},{"label":"Abr","value":899},{"label":"Mai","value":849},{"label":"Jun","value":719},{"label":"Jul","value":691},{"label":"Ago","value":863},{"label":"Set","value":863},{"label":"Out","value":862},{"label":"Nov","value":675},{"label":"Dez","value":1031}];
const MX = 1031;
