...
const PAGE = "Video Chat";
const KPIS = [{"l":"Teams Ativos","v":"6.938","t":"-1.6%","d":"down"},{"l":"Reuniões/Semana","v":"2474","t":"+6.0%","d":"up"},{"l":"Mensagens/Dia","v":"4482","t":"+4.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.487","t":"-0.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.753","478","1.225","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.006","776","2.214","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.572","2249","1.478","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.416","186","7.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.274","2397","8.068","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":574},{"label":"Mar","value":644},{"label":"Abr","value":867},{"label":"Mai","value":631},{"label":"Jun","value":850},{"label":"Jul","value":658},{"label":"Ago","value":872},{"label":"Set","value":647},{"label":"Out","value":629},{"label":"Nov","value":758},{"label":"Dez","value":708}];
const MX = 872;
