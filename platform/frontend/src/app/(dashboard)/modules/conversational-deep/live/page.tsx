...
const PAGE = "Live Chat";
const KPIS = [{"l":"Teams Ativos","v":"3.000","t":"+0.4%","d":"up"},{"l":"Reuniões/Semana","v":"2904","t":"+6.8%","d":"up"},{"l":"Mensagens/Dia","v":"4961","t":"-0.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"1.240","t":"+14.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.517","5024","2.450","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.513","2096","1.051","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.936","4337","8.798","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.605","1136","1.360","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.653","4785","4.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":501},{"label":"Mar","value":541},{"label":"Abr","value":675},{"label":"Mai","value":729},{"label":"Jun","value":486},{"label":"Jul","value":428},{"label":"Ago","value":373},{"label":"Set","value":410},{"label":"Out","value":402},{"label":"Nov","value":517},{"label":"Dez","value":489}];
const MX = 729;
