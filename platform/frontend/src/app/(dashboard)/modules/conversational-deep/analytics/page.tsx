...
const KPIS = [{"l":"Dashboards Ativos","v":"6.008","t":"+14.8%","d":"up"},{"l":"Queries/Dia","v":"4464","t":"+8.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.017","t":"+18.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.097","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2649","2026-03-11","8.712","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1637","2026-02-14","2.317","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2952","2026-01-16","2.421","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2835","2026-02-07","8.955","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1952","2026-02-19","2.939","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":294},{"label":"Mar","value":510},{"label":"Abr","value":504},{"label":"Mai","value":644},{"label":"Jun","value":649},{"label":"Jul","value":633},{"label":"Ago","value":498},{"label":"Set","value":402},{"label":"Out","value":443},{"label":"Nov","value":298},{"label":"Dez","value":653}];
const MX = 653;
