...
const PAGE = "Hit Ratio";
const KPIS = [{"l":"Total Cache Mgmt","v":"2.689","t":"+16.5%","d":"up"},{"l":"Hit Ratio Ativos","v":"874","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+4.9%","d":"up"}];
const COLS = ["ID","Hit Ratio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cache Mgmt #001","Cache Mgmt #002","6.474","2.903","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cache Mgmt #002","Cache Mgmt #003","6.432","6.929","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Cache Mgmt #003","Cache Mgmt #004","3.610","2.095","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Cache Mgmt #004","Cache Mgmt #005","1.409","2.432","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cache Mgmt #005","Cache Mgmt #001","5.993","1.591","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":534},{"label":"Mar","value":622},{"label":"Abr","value":566},{"label":"Mai","value":485},{"label":"Jun","value":521},{"label":"Jul","value":392},{"label":"Ago","value":414},{"label":"Set","value":450},{"label":"Out","value":431},{"label":"Nov","value":418},{"label":"Dez","value":514}];
const MX = 622;
