...
const ACCENT = "#ec4899";
const MODULE = "Cache Management";
const PAGE = "Invalidation";
const KPIS = [{"l":"Total Cache Mgmt","v":"3.795","t":"-1.1%","d":"down"},{"l":"Invalidation Ativos","v":"5.963","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.4%","d":"up"}];
const COLS = ["ID","Invalidation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cache Mgmt #001","Cache Mgmt #002","7.983","486","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cache Mgmt #002","Cache Mgmt #003","3.778","2.520","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Cache Mgmt #003","Cache Mgmt #004","8.860","3.610","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Cache Mgmt #004","Cache Mgmt #005","8.616","2.813","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cache Mgmt #005","Cache Mgmt #001","4.195","1.357","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":495},{"label":"Mar","value":465},{"label":"Abr","value":449},{"label":"Mai","value":637},{"label":"Jun","value":687},{"label":"Jul","value":492},{"label":"Ago","value":751},{"label":"Set","value":451},{"label":"Out","value":630},{"label":"Nov","value":629},{"label":"Dez","value":425}];
const MX = 751;
