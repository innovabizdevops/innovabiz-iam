...
const PAGE = "CDN Cache";
const KPIS = [{"l":"Total Cache Mgmt","v":"7.517","t":"-3.6%","d":"down"},{"l":"CDN Cache Ativos","v":"3.857","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"71","t":"+3.7%","d":"up"}];
const COLS = ["ID","CDN Cache","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cache Mgmt #001","Cache Mgmt #002","5.940","2.968","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Cache Mgmt #002","Cache Mgmt #003","199","3.702","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cache Mgmt #003","Cache Mgmt #004","2.158","9.098","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cache Mgmt #004","Cache Mgmt #005","7.745","7.992","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cache Mgmt #005","Cache Mgmt #001","7.742","2.839","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":959},{"label":"Mar","value":1046},{"label":"Abr","value":809},{"label":"Mai","value":707},{"label":"Jun","value":673},{"label":"Jul","value":1003},{"label":"Ago","value":656},{"label":"Set","value":811},{"label":"Out","value":681},{"label":"Nov","value":722},{"label":"Dez","value":897}];
const MX = 1046;
