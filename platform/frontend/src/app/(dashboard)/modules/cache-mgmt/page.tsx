...
export default function CacheMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cache Mgmt</h1><p className="text-sm text-muted-foreground">Cache Mgmt • iBOS Enterprise</p></div>
