...
const PAGE = "Eviction Policy";
const KPIS = [{"l":"Total Cache Mgmt","v":"6.497","t":"-5.9%","d":"down"},{"l":"Eviction Policy Ativos","v":"4.495","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"92","t":"+10.9%","d":"up"}];
const COLS = ["ID","Eviction Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cache Mgmt #001","Cache Mgmt #002","1.272","4.289","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Cache Mgmt #002","Cache Mgmt #003","8.642","8.587","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cache Mgmt #003","Cache Mgmt #004","8.831","954","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Cache Mgmt #004","Cache Mgmt #005","5.439","2.585","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cache Mgmt #005","Cache Mgmt #001","6.914","6.819","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":654},{"label":"Mar","value":646},{"label":"Abr","value":542},{"label":"Mai","value":298},{"label":"Jun","value":435},{"label":"Jul","value":304},{"label":"Ago","value":635},{"label":"Set","value":304},{"label":"Out","value":617},{"label":"Nov","value":479},{"label":"Dez","value":524}];
const MX = 654;
