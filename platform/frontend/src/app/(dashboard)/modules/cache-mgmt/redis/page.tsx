...
const PAGE = "Redis Clusters";
const KPIS = [{"l":"Integrações Ativas","v":"4.644","t":"+13.3%","d":"up"},{"l":"Chamadas/Hora","v":"3969","t":"+10.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.6%","t":"-2.5%","d":"down"},{"l":"Latência Média (ms)","v":"121ms","t":"+12.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.006","2.745","79.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.895","2.737","71.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.328","1.053","93.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.234","726","80.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.714","1.286","97.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":758},{"label":"Mar","value":646},{"label":"Abr","value":644},{"label":"Mai","value":906},{"label":"Jun","value":738},{"label":"Jul","value":727},{"label":"Ago","value":998},{"label":"Set","value":898},{"label":"Out","value":835},{"label":"Nov","value":636},{"label":"Dez","value":906}];
const MX = 998;
