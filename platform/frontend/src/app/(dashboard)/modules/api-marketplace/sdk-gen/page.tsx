...
const ACCENT = "#0891b2";
const MODULE = "API Marketplace";
const PAGE = "SDK Generator";
const KPIS = [{"l":"Pedidos/Dia","v":"4510","t":"+2.7%","d":"up"},{"l":"GMV (€)","v":"€94981","t":"+13.6%","d":"up"},{"l":"Conversão (%)","v":"69.6%","t":"+15.2%","d":"up"},{"l":"AOV (€)","v":"€8820","t":"+17.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 10892.21","2.735","2.257","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 587.08","1.261","9.096","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 14949.37","7.961","3.479","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 11071.48","755","2.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 44148.09","8.922","939","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":470},{"label":"Mar","value":529},{"label":"Abr","value":724},{"label":"Mai","value":492},{"label":"Jun","value":787},{"label":"Jul","value":565},{"label":"Ago","value":444},{"label":"Set","value":745},{"label":"Out","value":493},{"label":"Nov","value":589},{"label":"Dez","value":595}];
const MX = 820;
...
export default function SdkGenPage() {
    return (
