...
const PAGE = "API Versioning";
const KPIS = [{"l":"Pedidos/Dia","v":"3573","t":"-0.1%","d":"down"},{"l":"GMV (€)","v":"€96437","t":"+2.2%","d":"up"},{"l":"Conversão (%)","v":"71.5%","t":"+11.0%","d":"up"},{"l":"AOV (€)","v":"€2137","t":"+5.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 35260.79","2.782","2.440","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 5334.50","4.409","362","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 18611.26","7.147","2.240","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 12940.08","5.496","1.722","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 27069.83","7.154","3.933","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":446},{"label":"Mar","value":552},{"label":"Abr","value":653},{"label":"Mai","value":742},{"label":"Jun","value":525},{"label":"Jul","value":397},{"label":"Ago","value":534},{"label":"Set","value":577},{"label":"Out","value":700},{"label":"Nov","value":519},{"label":"Dez","value":575}];
const MX = 742;
