...
const PAGE = "Live Chat Transfer";
const KPIS = [{"l":"Teams Ativos","v":"9.060","t":"+10.4%","d":"up"},{"l":"Reuniões/Semana","v":"2249","t":"+7.0%","d":"up"},{"l":"Mensagens/Dia","v":"3102","t":"+14.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.887","t":"+16.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.434","4657","8.918","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.628","4425","739","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.072","1761","4.054","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.163","2541","2.781","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.311","3034","8.277","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":563},{"label":"Mar","value":598},{"label":"Abr","value":834},{"label":"Mai","value":697},{"label":"Jun","value":813},{"label":"Jul","value":623},{"label":"Ago","value":952},{"label":"Set","value":924},{"label":"Out","value":850},{"label":"Nov","value":664},{"label":"Dez","value":711}];
const MX = 952;
