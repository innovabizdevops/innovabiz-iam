...
const PAGE = "Emotion Detection";
const KPIS = [{"l":"Total Conversation Ai","v":"6.366","t":"+5.1%","d":"up"},{"l":"Emotion Detection Ativos","v":"6.901","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.7%","d":"up"}];
const COLS = ["ID","Emotion Detection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Conversation Ai #001","Conversation Ai #002","2.097","5.266","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Conversation Ai #002","Conversation Ai #003","2.660","6.804","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Conversation Ai #003","Conversation Ai #004","3.482","8.332","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Conversation Ai #004","Conversation Ai #005","6.733","6.367","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Conversation Ai #005","Conversation Ai #001","4.363","7.931","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":1019},{"label":"Mar","value":881},{"label":"Abr","value":1007},{"label":"Mai","value":675},{"label":"Jun","value":1030},{"label":"Jul","value":863},{"label":"Ago","value":759},{"label":"Set","value":898},{"label":"Out","value":885},{"label":"Nov","value":984},{"label":"Dez","value":680}];
const MX = 1030;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>AI</span></h1>
                </div>
