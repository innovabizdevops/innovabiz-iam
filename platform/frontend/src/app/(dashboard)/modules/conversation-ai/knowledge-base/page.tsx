...
const KPIS = [{"l":"Artigos Publicados","v":"2.612","t":"-2.6%","d":"down"},{"l":"Views/Semana","v":"1610","t":"+14.6%","d":"up"},{"l":"Feedback Útil (%)","v":"83.7%","t":"+10.1%","d":"up"},{"l":"Artigos Desatualizados","v":"5.242","t":"-1.5%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","184","94.5%","8.608","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","8.810","84.2%","8.089","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.967","71.4%","8.037","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.170","82.5%","274","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","5.367","96.8%","5.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":361},{"label":"Mar","value":571},{"label":"Abr","value":302},{"label":"Mai","value":298},{"label":"Jun","value":363},{"label":"Jul","value":467},{"label":"Ago","value":591},{"label":"Set","value":215},{"label":"Out","value":548},{"label":"Nov","value":455},{"label":"Dez","value":419}];
const MX = 609;
