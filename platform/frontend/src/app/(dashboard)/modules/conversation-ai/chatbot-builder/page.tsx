...
const PAGE = "Chatbot Builder";
const KPIS = [{"l":"Teams Ativos","v":"5.788","t":"+1.2%","d":"up"},{"l":"Reuniões/Semana","v":"4273","t":"+5.0%","d":"up"},{"l":"Mensagens/Dia","v":"3129","t":"+6.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.447","t":"-5.8%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.436","2839","8.126","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.619","819","4.852","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.946","4594","8.780","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.349","3769","2.298","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.881","123","1.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":890},{"label":"Mar","value":727},{"label":"Abr","value":650},{"label":"Mai","value":510},{"label":"Jun","value":759},{"label":"Jul","value":521},{"label":"Ago","value":714},{"label":"Set","value":734},{"label":"Out","value":778},{"label":"Nov","value":805},{"label":"Dez","value":641}];
const MX = 890;
