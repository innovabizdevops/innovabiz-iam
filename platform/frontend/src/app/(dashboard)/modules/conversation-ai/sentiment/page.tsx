...
const PAGE = "Sentiment Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"2.722","t":"-5.2%","d":"down"},{"l":"Queries/Dia","v":"4403","t":"-1.1%","d":"down"},{"l":"Dados Processados (GB)","v":"2.275","t":"+16.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.824","t":"-0.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4537","2026-03-09","6.141","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3015","2026-03-05","3.447","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","506","2026-01-24","8.685","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2699","2026-01-21","4.495","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1698","2026-01-17","4.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":268},{"label":"Mar","value":431},{"label":"Abr","value":439},{"label":"Mai","value":590},{"label":"Jun","value":616},{"label":"Jul","value":482},{"label":"Ago","value":588},{"label":"Set","value":613},{"label":"Out","value":476},{"label":"Nov","value":280},{"label":"Dez","value":452}];
const MX = 616;
