...
const PAGE = "Dialog Flow Designer";
const KPIS = [{"l":"Formulários Ativos","v":"6.532","t":"+12.4%","d":"up"},{"l":"Submissões/Dia","v":"2986","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"1.693","t":"-1.5%","d":"down"},{"l":"Templates","v":"3.086","t":"+15.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.355","2026-01-06","7.940","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.120","2026-02-03","6.682","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","214","2026-02-25","8.983","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.556","2026-03-14","1.165","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.635","2026-03-10","911","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":773},{"label":"Mar","value":812},{"label":"Abr","value":513},{"label":"Mai","value":573},{"label":"Jun","value":749},{"label":"Jul","value":450},{"label":"Ago","value":444},{"label":"Set","value":756},{"label":"Out","value":482},{"label":"Nov","value":597},{"label":"Dez","value":608}];
const MX = 812;
