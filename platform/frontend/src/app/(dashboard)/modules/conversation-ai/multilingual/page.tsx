...
const ACCENT = "#0891b2";
const MODULE = "Conversational AI";
const PAGE = "Multi-Language NLP";
const KPIS = [{"l":"Total Conversation Ai","v":"1.358","t":"+12.7%","d":"up"},{"l":"Multi Language NLP Ativos","v":"2.296","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"78.3%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+3.6%","d":"up"}];
const COLS = ["ID","Multi Language NLP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Conversation Ai #001","Conversation Ai #002","6.418","6.674","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Conversation Ai #002","Conversation Ai #003","3.786","8.034","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Conversation Ai #003","Conversation Ai #004","4.705","8.415","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Conversation Ai #004","Conversation Ai #005","797","7.429","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Conversation Ai #005","Conversation Ai #001","6.609","4.683","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":216},{"label":"Fev","value":237},{"label":"Mar","value":568},{"label":"Abr","value":342},{"label":"Mai","value":296},{"label":"Jun","value":271},{"label":"Jul","value":413},{"label":"Ago","value":360},{"label":"Set","value":331},{"label":"Out","value":482},{"label":"Nov","value":444},{"label":"Dez","value":229}];
const MX = 568;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>i18n</span></h1>
                </div>
