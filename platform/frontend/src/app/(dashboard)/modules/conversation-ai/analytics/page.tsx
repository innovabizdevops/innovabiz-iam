...
const PAGE = "Conversation Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.828","t":"+6.2%","d":"up"},{"l":"Queries/Dia","v":"4714","t":"+10.2%","d":"up"},{"l":"Dados Processados (GB)","v":"2.480","t":"+15.2%","d":"up"},{"l":"Utilizadores Analytics","v":"785","t":"+15.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2248","2026-03-12","1.345","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4961","2026-01-17","3.274","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4194","2026-03-18","4.204","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1717","2026-01-22","4.419","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4136","2026-03-17","5.459","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":842},{"label":"Mar","value":945},{"label":"Abr","value":673},{"label":"Mai","value":985},{"label":"Jun","value":618},{"label":"Jul","value":795},{"label":"Ago","value":613},{"label":"Set","value":783},{"label":"Out","value":695},{"label":"Nov","value":705},{"label":"Dez","value":752}];
const MX = 985;
