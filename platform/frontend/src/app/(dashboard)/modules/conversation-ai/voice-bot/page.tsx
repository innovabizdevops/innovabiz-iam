...
const PAGE = "Voice Bot";
const KPIS = [{"l":"Total Conversation Ai","v":"3.234","t":"+17.3%","d":"up"},{"l":"Voice Bot Ativos","v":"7.839","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"72.9%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"72","t":"-2.4%","d":"down"}];
const COLS = ["ID","Voice Bot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Conversation Ai #001","Conversation Ai #002","4.643","6.844","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Conversation Ai #002","Conversation Ai #003","2.571","4.494","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Conversation Ai #003","Conversation Ai #004","4.071","5.689","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Conversation Ai #004","Conversation Ai #005","9.040","7.996","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Conversation Ai #005","Conversation Ai #001","3.314","5.481","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":874},{"label":"Mar","value":563},{"label":"Abr","value":824},{"label":"Mai","value":693},{"label":"Jun","value":916},{"label":"Jul","value":691},{"label":"Ago","value":599},{"label":"Set","value":757},{"label":"Out","value":792},{"label":"Nov","value":917},{"label":"Dez","value":843}];
const MX = 917;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Voice</span></h1>
                </div>
