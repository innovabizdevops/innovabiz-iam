...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€30.4M","t":"+13.9%","d":"up"},{"l":"MRR (€)","v":"€36327","t":"+13.9%","d":"up"},{"l":"Churn (%)","v":"94.9%","t":"+5.8%","d":"up"},{"l":"ARPU (€)","v":"€40159","t":"+11.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42666.61","5.333","€ 22469.13","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8420.68","7.141","€ 23137.60","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 33158.07","8.286","€ 5874.19","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49114.52","2.335","€ 23541.06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 47549.62","4.174","€ 30139.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":979},{"label":"Mar","value":805},{"label":"Abr","value":885},{"label":"Mai","value":819},{"label":"Jun","value":884},{"label":"Jul","value":769},{"label":"Ago","value":670},{"label":"Set","value":662},{"label":"Out","value":766},{"label":"Nov","value":972},{"label":"Dez","value":900}];
const MX = 979;
