...
const PAGE = "Notif";
const KPIS = [{"l":"Notificações Enviadas","v":"8.271","t":"+17.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"67.8%","t":"+4.7%","d":"up"},{"l":"Taxa Abertura (%)","v":"75.7%","t":"+4.9%","d":"up"},{"l":"Escalações","v":"6.114","t":"+17.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","608","97.4%","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.015","85.0%","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.980","91.8%","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.878","96.4%","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.453","79.9%","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":857},{"label":"Mar","value":876},{"label":"Abr","value":543},{"label":"Mai","value":615},{"label":"Jun","value":627},{"label":"Jul","value":882},{"label":"Ago","value":836},{"label":"Set","value":609},{"label":"Out","value":669},{"label":"Nov","value":890},{"label":"Dez","value":727}];
const MX = 890;
