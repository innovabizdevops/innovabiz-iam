...
const ACCENT = "#6366f1";
const MODULE = "Parcel Locker";
const PAGE = "Assignment";
const KPIS = [{"l":"Total Parcel Locker","v":"8.865","t":"+12.4%","d":"up"},{"l":"Assignment Ativos","v":"2.502","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"88","t":"+10.9%","d":"up"}];
const COLS = ["ID","Assignment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parcel Locker #001","Parcel Locker #002","2.499","3.284","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Parcel Locker #002","Parcel Locker #003","5.223","7.394","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Parcel Locker #003","Parcel Locker #004","3.994","424","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Parcel Locker #004","Parcel Locker #005","7.112","4.337","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parcel Locker #005","Parcel Locker #001","5.227","4.952","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1004},{"label":"Fev","value":819},{"label":"Mar","value":756},{"label":"Abr","value":922},{"label":"Mai","value":784},{"label":"Jun","value":735},{"label":"Jul","value":939},{"label":"Ago","value":970},{"label":"Set","value":1001},{"label":"Out","value":905},{"label":"Nov","value":915},{"label":"Dez","value":749}];
const MX = 1004;
