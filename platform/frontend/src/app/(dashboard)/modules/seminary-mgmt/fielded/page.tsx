...
const ACCENT = "#7c3aed";
const MODULE = "Seminary / Theological";
const PAGE = "Field Ed";
const KPIS = [{"l":"Total Seminary Mgmt","v":"116","t":"+12.9%","d":"up"},{"l":"Field Ed Ativos","v":"2.137","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"78","t":"+2.2%","d":"up"}];
const COLS = ["ID","Field Ed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seminary Mgmt #001","Seminary Mgmt #002","839","8.073","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Seminary Mgmt #002","Seminary Mgmt #003","4.416","9.015","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Seminary Mgmt #003","Seminary Mgmt #004","8.475","7.448","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Seminary Mgmt #004","Seminary Mgmt #005","1.280","215","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seminary Mgmt #005","Seminary Mgmt #001","1.669","3.684","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":625},{"label":"Mar","value":510},{"label":"Abr","value":567},{"label":"Mai","value":731},{"label":"Jun","value":422},{"label":"Jul","value":478},{"label":"Ago","value":453},{"label":"Set","value":593},{"label":"Out","value":531},{"label":"Nov","value":473},{"label":"Dez","value":702}];
const MX = 731;
...
export default function FieldedPage() {
    return (
