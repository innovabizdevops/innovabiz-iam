...
/* ═══ Seminary / Theological — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "3123", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4021", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€237K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "8269523", cells: ["SEM-8523", "Seminary / Theological Item 1", "4/12/2026", "€19 623"], status: "active" as const },
    { id: "8273094", cells: ["SEM-3094", "Seminary / Theological Item 2", "19/7/2026", "€23 194"], status: "pending" as const },
    { id: "8276665", cells: ["SEM-6665", "Seminary / Theological Item 3", "6/2/2026", "€26 765"], status: "completed" as const },
    { id: "8280236", cells: ["SEM-1236", "Seminary / Theological Item 4", "21/9/2026", "€30 336"], status: "warning" as const },
    { id: "8283807", cells: ["SEM-4807", "Seminary / Theological Item 5", "8/4/2026", "€33 907"], status: "active" as const },
];
...
export default function SeminaryTheologicalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Seminary / Theological</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Seminary / Theological</p>
                    </div>
                </div>
