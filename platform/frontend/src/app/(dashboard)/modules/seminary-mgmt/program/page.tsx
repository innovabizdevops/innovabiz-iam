...
const PAGE = "Program";
const KPIS = [{"l":"Total Seminary Mgmt","v":"8.419","t":"+5.2%","d":"up"},{"l":"Program Ativos","v":"4.497","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"81","t":"+3.3%","d":"up"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seminary Mgmt #001","Seminary Mgmt #002","4.003","2.551","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Seminary Mgmt #002","Seminary Mgmt #003","350","4.836","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Seminary Mgmt #003","Seminary Mgmt #004","5.822","1.086","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Seminary Mgmt #004","Seminary Mgmt #005","1.527","3.985","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seminary Mgmt #005","Seminary Mgmt #001","4.428","7.865","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1024},{"label":"Fev","value":683},{"label":"Mar","value":700},{"label":"Abr","value":809},{"label":"Mai","value":982},{"label":"Jun","value":831},{"label":"Jul","value":785},{"label":"Ago","value":766},{"label":"Set","value":799},{"label":"Out","value":697},{"label":"Nov","value":980},{"label":"Dez","value":936}];
const MX = 1024;
