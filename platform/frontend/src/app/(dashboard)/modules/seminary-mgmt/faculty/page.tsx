...
const PAGE = "Faculty";
const KPIS = [{"l":"Total Seminary Mgmt","v":"1.498","t":"+4.4%","d":"up"},{"l":"Faculty Ativos","v":"7.559","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"87","t":"-5.4%","d":"down"}];
const COLS = ["ID","Faculty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Seminary Mgmt #001","Seminary Mgmt #002","805","8.313","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Seminary Mgmt #002","Seminary Mgmt #003","6.314","5.057","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Seminary Mgmt #003","Seminary Mgmt #004","339","3.039","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Seminary Mgmt #004","Seminary Mgmt #005","1.606","3.206","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Seminary Mgmt #005","Seminary Mgmt #001","2.226","6.392","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":612},{"label":"Mar","value":759},{"label":"Abr","value":707},{"label":"Mai","value":814},{"label":"Jun","value":561},{"label":"Jul","value":492},{"label":"Ago","value":687},{"label":"Set","value":602},{"label":"Out","value":486},{"label":"Nov","value":717},{"label":"Dez","value":633}];
const MX = 827;
