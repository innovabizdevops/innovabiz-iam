...
const PAGE = "Co-Edit";
const KPIS = [{"l":"Integrações Ativas","v":"122","t":"+16.1%","d":"up"},{"l":"Chamadas/Hora","v":"3924","t":"+15.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.9%","t":"+10.3%","d":"up"},{"l":"Latência Média (ms)","v":"21ms","t":"+5.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.171","7.057","84.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.972","2.769","90.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","523","1.261","78.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.924","287","95.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.428","4.163","74.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":473},{"label":"Mar","value":800},{"label":"Abr","value":837},{"label":"Mai","value":645},{"label":"Jun","value":796},{"label":"Jul","value":576},{"label":"Ago","value":621},{"label":"Set","value":767},{"label":"Out","value":642},{"label":"Nov","value":540},{"label":"Dez","value":597}];
const MX = 837;
