...
/* ═══ RTM Real-Time Collaboration — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "2410", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3012", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€386K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1274518410", cells: ["RTM-2410", "RTM Real-Time Collaboration Item 1", "19/7/2026", "€18 510"], status: "active" as const },
    { id: "1274521981", cells: ["RTM-5981", "RTM Real-Time Collaboration Item 2", "6/2/2026", "€22 081"], status: "pending" as const },
    { id: "1274525552", cells: ["RTM-9552", "RTM Real-Time Collaboration Item 3", "21/9/2026", "€25 652"], status: "completed" as const },
    { id: "1274529123", cells: ["RTM-4123", "RTM Real-Time Collaboration Item 4", "8/4/2026", "€29 223"], status: "warning" as const },
    { id: "1274532694", cells: ["RTM-7694", "RTM Real-Time Collaboration Item 5", "23/11/2026", "€32 794"], status: "active" as const },
];
...
export default function RtmRealtimeCollaborationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RTM Real-Time Collaboration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RTM Real-Time Collaboration</p>
                    </div>
                </div>
