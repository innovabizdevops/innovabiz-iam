...
const ACCENT = "#dc2626";
const MODULE = "RTM Real-Time Collaboration";
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"6.957","t":"+9.3%","d":"up"},{"l":"Chamadas/Hora","v":"3267","t":"+15.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.8%","t":"+13.8%","d":"up"},{"l":"Latência Média (ms)","v":"170ms","t":"+1.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.422","4.370","88.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.996","3.880","71.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.579","1.381","95.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.432","7.661","74.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.332","7.909","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":515},{"label":"Mar","value":453},{"label":"Abr","value":626},{"label":"Mai","value":497},{"label":"Jun","value":274},{"label":"Jul","value":348},{"label":"Ago","value":515},{"label":"Set","value":425},{"label":"Out","value":378},{"label":"Nov","value":535},{"label":"Dez","value":557}];
const MX = 626;
