...
const PAGE = "Presence";
const KPIS = [{"l":"Teams Ativos","v":"2.337","t":"+0.5%","d":"up"},{"l":"Reuniões/Semana","v":"4371","t":"+6.3%","d":"up"},{"l":"Mensagens/Dia","v":"4163","t":"+9.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.034","t":"+9.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.863","3978","4.208","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.283","3004","2.071","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","9.073","2485","4.906","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.164","4474","5.423","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","979","3337","8.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":368},{"label":"Mar","value":495},{"label":"Abr","value":366},{"label":"Mai","value":721},{"label":"Jun","value":568},{"label":"Jul","value":618},{"label":"Ago","value":586},{"label":"Set","value":725},{"label":"Out","value":502},{"label":"Nov","value":591},{"label":"Dez","value":642}];
const MX = 725;
