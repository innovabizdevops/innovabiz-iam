...
const PAGE = "Ensemble";
const KPIS = [{"l":"Total Pai Forecast","v":"3.581","t":"-1.5%","d":"down"},{"l":"Ensemble Ativos","v":"6.953","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"84","t":"+14.6%","d":"up"}];
const COLS = ["ID","Ensemble","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Forecast #001","Pai Forecast #002","4.371","2.673","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Forecast #002","Pai Forecast #003","909","6.248","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Forecast #003","Pai Forecast #004","7.085","6.783","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Forecast #004","Pai Forecast #005","6.459","7.187","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Forecast #005","Pai Forecast #001","7.442","3.627","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":643},{"label":"Mar","value":491},{"label":"Abr","value":399},{"label":"Mai","value":642},{"label":"Jun","value":438},{"label":"Jul","value":474},{"label":"Ago","value":648},{"label":"Set","value":442},{"label":"Out","value":563},{"label":"Nov","value":622},{"label":"Dez","value":714}];
const MX = 714;
