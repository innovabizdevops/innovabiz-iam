...
const PAGE = "Auto-Tune";
const KPIS = [{"l":"Total Pai Forecast","v":"6.023","t":"+13.1%","d":"up"},{"l":"Auto Tune Ativos","v":"2.338","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"67.9%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+13.4%","d":"up"}];
const COLS = ["ID","Auto Tune","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Forecast #001","Pai Forecast #002","8.246","2.722","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Forecast #002","Pai Forecast #003","841","4.959","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Forecast #003","Pai Forecast #004","7.401","5.280","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Forecast #004","Pai Forecast #005","776","2.632","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Forecast #005","Pai Forecast #001","2.723","8.545","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":959},{"label":"Mar","value":921},{"label":"Abr","value":792},{"label":"Mai","value":916},{"label":"Jun","value":839},{"label":"Jul","value":848},{"label":"Ago","value":831},{"label":"Set","value":936},{"label":"Out","value":742},{"label":"Nov","value":643},{"label":"Dez","value":728}];
const MX = 977;
