...
const PAGE = "Univariate";
const KPIS = [{"l":"Total Pai Forecast","v":"4.172","t":"+9.8%","d":"up"},{"l":"Univariate Ativos","v":"7.898","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"60","t":"+11.7%","d":"up"}];
const COLS = ["ID","Univariate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Forecast #001","Pai Forecast #002","4.468","6.688","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Forecast #002","Pai Forecast #003","4.386","1.430","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Forecast #003","Pai Forecast #004","1.503","2.902","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Forecast #004","Pai Forecast #005","7.162","8.201","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Forecast #005","Pai Forecast #001","8.194","1.264","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":625},{"label":"Mar","value":540},{"label":"Abr","value":543},{"label":"Mai","value":426},{"label":"Jun","value":644},{"label":"Jul","value":493},{"label":"Ago","value":787},{"label":"Set","value":485},{"label":"Out","value":481},{"label":"Nov","value":472},{"label":"Dez","value":494}];
const MX = 787;
