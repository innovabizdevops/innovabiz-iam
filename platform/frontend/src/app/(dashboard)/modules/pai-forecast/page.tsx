...
/* ═══ P-AI Forecasting Engine — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "7989", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3436", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€144K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "908689289", cells: ["PAI-5289", "P-AI Forecasting Engine Item 1", "26/6/2026", "€39 389"], status: "active" as const },
    { id: "908692860", cells: ["PAI-8860", "P-AI Forecasting Engine Item 2", "13/1/2026", "€42 960"], status: "pending" as const },
    { id: "908696431", cells: ["PAI-3431", "P-AI Forecasting Engine Item 3", "28/8/2026", "€46 531"], status: "completed" as const },
    { id: "908700002", cells: ["PAI-7002", "P-AI Forecasting Engine Item 4", "15/3/2026", "€102"], status: "warning" as const },
    { id: "908703573", cells: ["PAI-1573", "P-AI Forecasting Engine Item 5", "2/10/2026", "€3673"], status: "active" as const },
];
...
export default function PaiForecastingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Forecasting Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Forecasting Engine</p>
                    </div>
                </div>
