...
const PAGE = "Explain";
const KPIS = [{"l":"Total Pai Forecast","v":"8.351","t":"-1.4%","d":"down"},{"l":"Explain Ativos","v":"2.181","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"75.9%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.4%","d":"up"}];
const COLS = ["ID","Explain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Forecast #001","Pai Forecast #002","4.051","1.003","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Forecast #002","Pai Forecast #003","1.010","3.191","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Forecast #003","Pai Forecast #004","1.584","2.481","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Forecast #004","Pai Forecast #005","2.091","7.607","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Forecast #005","Pai Forecast #001","3.877","9.092","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":540},{"label":"Mar","value":664},{"label":"Abr","value":664},{"label":"Mai","value":824},{"label":"Jun","value":755},{"label":"Jul","value":582},{"label":"Ago","value":718},{"label":"Set","value":730},{"label":"Out","value":690},{"label":"Nov","value":719},{"label":"Dez","value":692}];
const MX = 834;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0c4a6e'}}>XAI</span></h1>
                </div>
