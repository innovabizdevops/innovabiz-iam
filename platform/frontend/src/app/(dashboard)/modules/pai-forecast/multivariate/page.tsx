...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Forecasting Engine";
const PAGE = "Multivariate";
const KPIS = [{"l":"Total Pai Forecast","v":"4.089","t":"-3.8%","d":"down"},{"l":"Multivariate Ativos","v":"5.964","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.4%","d":"up"}];
const COLS = ["ID","Multivariate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Forecast #001","Pai Forecast #002","4.828","3.965","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Forecast #002","Pai Forecast #003","3.396","4.509","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Forecast #003","Pai Forecast #004","3.611","8.493","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Forecast #004","Pai Forecast #005","1.662","5.106","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Forecast #005","Pai Forecast #001","1.521","995","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":725},{"label":"Mar","value":749},{"label":"Abr","value":888},{"label":"Mai","value":962},{"label":"Jun","value":715},{"label":"Jul","value":698},{"label":"Ago","value":702},{"label":"Set","value":726},{"label":"Out","value":862},{"label":"Nov","value":1059},{"label":"Dez","value":791}];
const MX = 1059;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0c4a6e'}}>AI</span></h1>
                </div>
