...
/* ═══ Social Listening Platform — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "9254", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "511", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€268K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1809699454", cells: ["SOC-7454", "Social Listening Platform Item 1", "11/11/2026", "€49 554"], status: "active" as const },
    { id: "1809703025", cells: ["SOC-2025", "Social Listening Platform Item 2", "26/6/2026", "€3125"], status: "pending" as const },
    { id: "1809706596", cells: ["SOC-5596", "Social Listening Platform Item 3", "13/1/2026", "€6696"], status: "completed" as const },
    { id: "1809710167", cells: ["SOC-9167", "Social Listening Platform Item 4", "28/8/2026", "€10 267"], status: "warning" as const },
    { id: "1809713738", cells: ["SOC-3738", "Social Listening Platform Item 5", "15/3/2026", "€13 838"], status: "active" as const },
];
...
export default function SocialListeningPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Social Listening Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Social Listening Platform</p>
                    </div>
                </div>
