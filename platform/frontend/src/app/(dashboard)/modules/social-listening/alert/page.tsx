...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.359","t":"+5.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"94.5%","t":"+17.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"82.6%","t":"+0.6%","d":"up"},{"l":"Escalações","v":"8.443","t":"+8.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.573","76.7%","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.630","72.1%","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.647","99.4%","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.351","74.7%","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","621","86.7%","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":598},{"label":"Mar","value":548},{"label":"Abr","value":723},{"label":"Mai","value":807},{"label":"Jun","value":705},{"label":"Jul","value":929},{"label":"Ago","value":770},{"label":"Set","value":817},{"label":"Out","value":576},{"label":"Nov","value":807},{"label":"Dez","value":713}];
const MX = 929;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f43f5e'}}>RTM</span></h1>
                </div>
