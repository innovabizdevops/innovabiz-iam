...
const KPIS = [{"l":"Dashboards Ativos","v":"8.155","t":"+14.0%","d":"up"},{"l":"Queries/Dia","v":"1209","t":"+10.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.825","t":"-1.0%","d":"down"},{"l":"Utilizadores Analytics","v":"2.336","t":"+11.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3086","2026-03-14","390","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3910","2026-02-01","2.314","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3476","2026-02-23","2.050","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2987","2026-01-23","6.215","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1647","2026-02-04","5.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":732},{"label":"Mar","value":974},{"label":"Abr","value":806},{"label":"Mai","value":777},{"label":"Jun","value":939},{"label":"Jul","value":839},{"label":"Ago","value":682},{"label":"Set","value":855},{"label":"Out","value":936},{"label":"Nov","value":947},{"label":"Dez","value":739}];
const MX = 974;
