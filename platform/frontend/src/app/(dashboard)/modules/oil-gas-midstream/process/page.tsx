...
const PAGE = "Process";
const KPIS = [{"l":"Total Oil Gas Midstream","v":"8.668","t":"-4.1%","d":"down"},{"l":"Process Ativos","v":"5.553","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"81","t":"+14.2%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Gas Midstream #001","Oil Gas Midstream #002","1.262","548","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Gas Midstream #002","Oil Gas Midstream #003","2.191","1.475","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Gas Midstream #003","Oil Gas Midstream #004","6.436","7.792","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Gas Midstream #004","Oil Gas Midstream #005","6.998","5.301","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Gas Midstream #005","Oil Gas Midstream #001","7.271","8.452","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":321},{"label":"Mar","value":507},{"label":"Abr","value":430},{"label":"Mai","value":450},{"label":"Jun","value":447},{"label":"Jul","value":343},{"label":"Ago","value":588},{"label":"Set","value":556},{"label":"Out","value":290},{"label":"Nov","value":534},{"label":"Dez","value":489}];
const MX = 594;
