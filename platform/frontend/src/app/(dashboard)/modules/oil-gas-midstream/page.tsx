...
/* ═══ Oil & Gas Midstream — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "2008", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "572", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€246K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "948748608", cells: ["OIL-5608", "Oil & Gas Midstream Item 1", "25/1/2026", "€48 708"], status: "active" as const },
    { id: "948752179", cells: ["OIL-9179", "Oil & Gas Midstream Item 2", "12/8/2026", "€2279"], status: "pending" as const },
    { id: "948755750", cells: ["OIL-3750", "Oil & Gas Midstream Item 3", "27/3/2026", "€5850"], status: "completed" as const },
    { id: "948759321", cells: ["OIL-7321", "Oil & Gas Midstream Item 4", "14/10/2026", "€9421"], status: "warning" as const },
    { id: "948762892", cells: ["OIL-1892", "Oil & Gas Midstream Item 5", "1/5/2026", "€12 992"], status: "active" as const },
];
...
export default function OilGasMidstreamPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Oil & Gas Midstream</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Oil & Gas Midstream</p>
                    </div>
                </div>
