...
const ACCENT = "#854d0e";
const MODULE = "Oil & Gas Midstream";
const PAGE = "Pipeline";
const KPIS = [{"l":"Total Oil Gas Midstream","v":"2.639","t":"+0.1%","d":"up"},{"l":"Pipeline Ativos","v":"7.348","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"92.8%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+0.8%","d":"up"}];
const COLS = ["ID","Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Gas Midstream #001","Oil Gas Midstream #002","5.904","8.716","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Gas Midstream #002","Oil Gas Midstream #003","8.371","3.084","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Gas Midstream #003","Oil Gas Midstream #004","9.045","1.762","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Gas Midstream #004","Oil Gas Midstream #005","2.212","8.816","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Gas Midstream #005","Oil Gas Midstream #001","7.828","119","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":903},{"label":"Mar","value":877},{"label":"Abr","value":668},{"label":"Mai","value":791},{"label":"Jun","value":933},{"label":"Jul","value":580},{"label":"Ago","value":930},{"label":"Set","value":607},{"label":"Out","value":656},{"label":"Nov","value":572},{"label":"Dez","value":700}];
const MX = 933;
