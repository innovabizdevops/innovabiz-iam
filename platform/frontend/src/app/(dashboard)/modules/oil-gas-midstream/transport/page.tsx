...
const KPIS = [{"l":"Atletas Registados","v":"5.648","t":"+9.0%","d":"up"},{"l":"Treinos/Semana","v":"4162","t":"+0.8%","d":"up"},{"l":"Competições","v":"5.143","t":"-4.0%","d":"down"},{"l":"Performance Score","v":"59","t":"+14.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.424","2.110","2.041","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","718","8.021","1.530","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.806","6.004","123","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.778","1.920","6.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","905","5.673","4.339","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":623},{"label":"Mar","value":787},{"label":"Abr","value":814},{"label":"Mai","value":666},{"label":"Jun","value":681},{"label":"Jul","value":726},{"label":"Ago","value":639},{"label":"Set","value":722},{"label":"Out","value":864},{"label":"Nov","value":695},{"label":"Dez","value":711}];
const MX = 864;
