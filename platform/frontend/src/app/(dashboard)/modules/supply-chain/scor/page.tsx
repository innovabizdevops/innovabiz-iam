...
const PAGE = "SCOR Model";
const KPIS = [{"l":"Total Supply Chain","v":"4.466","t":"+16.0%","d":"up"},{"l":"SCOR Model Ativos","v":"1.846","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"83.8%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+13.7%","d":"up"}];
const COLS = ["ID","SCOR Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain #001","Supply Chain #002","7.785","1.240","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain #002","Supply Chain #003","6.851","1.856","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain #003","Supply Chain #004","2.589","3.962","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain #004","Supply Chain #005","5.714","2.517","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain #005","Supply Chain #001","6.775","3.359","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":210},{"label":"Fev","value":443},{"label":"Mar","value":440},{"label":"Abr","value":255},{"label":"Mai","value":529},{"label":"Jun","value":437},{"label":"Jul","value":412},{"label":"Ago","value":322},{"label":"Set","value":227},{"label":"Out","value":240},{"label":"Nov","value":361},{"label":"Dez","value":297}];
const MX = 529;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>SCOR</span></h1>
                </div>
