...
const ACCENT = "#6366f1";
const MODULE = "Supply Chain";
const PAGE = "Demand Planning AI";
const KPIS = [{"l":"Total Supply Chain","v":"7.316","t":"+4.1%","d":"up"},{"l":"Demand Planning AI Ativos","v":"8.253","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"90","t":"-0.6%","d":"down"}];
const COLS = ["ID","Demand Planning AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain #001","Supply Chain #002","366","4.364","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain #002","Supply Chain #003","6.510","7.348","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain #003","Supply Chain #004","1.039","3.695","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain #004","Supply Chain #005","3.703","3.608","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain #005","Supply Chain #001","4.365","3.278","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":647},{"label":"Mar","value":731},{"label":"Abr","value":685},{"label":"Mai","value":360},{"label":"Jun","value":473},{"label":"Jul","value":447},{"label":"Ago","value":716},{"label":"Set","value":743},{"label":"Out","value":451},{"label":"Nov","value":492},{"label":"Dez","value":490}];
const MX = 743;
