...
const PAGE = "S&amp;OP";
const KPIS = [{"l":"Total Supply Chain","v":"5.355","t":"+17.1%","d":"up"},{"l":"S&OP Ativos","v":"2.127","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.5%","d":"up"}];
const COLS = ["ID","S&OP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain #001","Supply Chain #002","7.325","4.034","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain #002","Supply Chain #003","1.051","6.512","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain #003","Supply Chain #004","5.668","2.286","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain #004","Supply Chain #005","2.654","8.828","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain #005","Supply Chain #001","4.576","7.285","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":604},{"label":"Mar","value":873},{"label":"Abr","value":635},{"label":"Mai","value":821},{"label":"Jun","value":889},{"label":"Jul","value":899},{"label":"Ago","value":608},{"label":"Set","value":616},{"label":"Out","value":969},{"label":"Nov","value":775},{"label":"Dez","value":847}];
const MX = 969;
