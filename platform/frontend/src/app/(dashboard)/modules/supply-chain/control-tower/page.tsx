...
const PAGE = "Control Tower AI";
const KPIS = [{"l":"Total Supply Chain","v":"3.690","t":"+2.2%","d":"up"},{"l":"Control Tower AI Ativos","v":"5.753","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+2.9%","d":"up"}];
const COLS = ["ID","Control Tower AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain #001","Supply Chain #002","1.395","5.028","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain #002","Supply Chain #003","6.225","4.590","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain #003","Supply Chain #004","5.869","8.428","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain #004","Supply Chain #005","8.753","5.502","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain #005","Supply Chain #001","5.824","7.036","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":694},{"label":"Mar","value":785},{"label":"Abr","value":1006},{"label":"Mai","value":831},{"label":"Jun","value":760},{"label":"Jul","value":864},{"label":"Ago","value":1058},{"label":"Set","value":1020},{"label":"Out","value":1040},{"label":"Nov","value":1058},{"label":"Dez","value":733}];
const MX = 1058;
