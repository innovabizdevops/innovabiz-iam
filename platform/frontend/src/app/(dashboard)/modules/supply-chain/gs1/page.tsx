...
const PAGE = "GS1 Standards";
const KPIS = [{"l":"Total Supply Chain","v":"4.596","t":"+14.3%","d":"up"},{"l":"GS1 Standards Ativos","v":"4.520","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"88","t":"+8.4%","d":"up"}];
const COLS = ["ID","GS1 Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain #001","Supply Chain #002","846","368","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain #002","Supply Chain #003","8.506","3.154","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain #003","Supply Chain #004","1.150","7.807","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain #004","Supply Chain #005","826","5.673","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain #005","Supply Chain #001","229","2.882","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":998},{"label":"Mar","value":915},{"label":"Abr","value":671},{"label":"Mai","value":1009},{"label":"Jun","value":968},{"label":"Jul","value":826},{"label":"Ago","value":958},{"label":"Set","value":952},{"label":"Out","value":733},{"label":"Nov","value":965},{"label":"Dez","value":1047}];
const MX = 1047;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>GS1</span></h1>
                </div>
