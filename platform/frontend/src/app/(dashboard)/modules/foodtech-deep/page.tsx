...
/* ═══ FoodTech Platform Deep — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "6716", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2607", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€335K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "537982516", cells: ["FOO-8516", "FoodTech Platform Deep Item 1", "9/5/2026", "€32 616"], status: "active" as const },
    { id: "537986087", cells: ["FOO-3087", "FoodTech Platform Deep Item 2", "24/12/2026", "€36 187"], status: "pending" as const },
    { id: "537989658", cells: ["FOO-6658", "FoodTech Platform Deep Item 3", "11/7/2026", "€39 758"], status: "completed" as const },
    { id: "537993229", cells: ["FOO-1229", "FoodTech Platform Deep Item 4", "26/2/2026", "€43 329"], status: "warning" as const },
    { id: "537996800", cells: ["FOO-4800", "FoodTech Platform Deep Item 5", "13/9/2026", "€46 900"], status: "active" as const },
];
...
export default function FoodtechPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">FoodTech Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • FoodTech Platform Deep</p>
                    </div>
                </div>
