...
const PAGE = "Trace";
const KPIS = [{"l":"Total Foodtech Deep","v":"6.001","t":"-0.4%","d":"down"},{"l":"Trace Ativos","v":"4.138","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+3.1%","d":"up"}];
const COLS = ["ID","Trace","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foodtech Deep #001","Foodtech Deep #002","5.055","2.927","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Foodtech Deep #002","Foodtech Deep #003","1.722","5.145","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Foodtech Deep #003","Foodtech Deep #004","7.017","2.393","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Foodtech Deep #004","Foodtech Deep #005","5.483","3.920","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foodtech Deep #005","Foodtech Deep #001","6.773","2.074","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":802},{"label":"Mar","value":735},{"label":"Abr","value":944},{"label":"Mai","value":623},{"label":"Jun","value":674},{"label":"Jul","value":698},{"label":"Ago","value":748},{"label":"Set","value":758},{"label":"Out","value":697},{"label":"Nov","value":829},{"label":"Dez","value":909}];
const MX = 944;
