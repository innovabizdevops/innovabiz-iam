...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.648","t":"+5.0%","d":"up"},{"l":"NC Abertas","v":"3.663","t":"+9.0%","d":"up"},{"l":"Conformidade (%)","v":"72.7%","t":"-2.5%","d":"down"},{"l":"CAPAs Pendentes","v":"2.494","t":"+4.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.202","98.1%","4.276","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.595","78.4%","6.966","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.304","99.7%","7.528","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.494","97.8%","5.195","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.714","94.0%","2.763","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":797},{"label":"Mar","value":479},{"label":"Abr","value":816},{"label":"Mai","value":801},{"label":"Jun","value":567},{"label":"Jul","value":697},{"label":"Ago","value":862},{"label":"Set","value":847},{"label":"Out","value":693},{"label":"Nov","value":652},{"label":"Dez","value":745}];
const MX = 862;
