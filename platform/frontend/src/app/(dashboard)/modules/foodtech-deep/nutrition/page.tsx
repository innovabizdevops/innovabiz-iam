...
const ACCENT = "#f59e0b";
const MODULE = "FoodTech Platform Deep";
const PAGE = "Nutrition";
const KPIS = [{"l":"Total Foodtech Deep","v":"7.298","t":"-1.5%","d":"down"},{"l":"Nutrition Ativos","v":"3.322","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"76","t":"-1.1%","d":"down"}];
const COLS = ["ID","Nutrition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foodtech Deep #001","Foodtech Deep #002","858","2.078","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Foodtech Deep #002","Foodtech Deep #003","8.718","1.731","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Foodtech Deep #003","Foodtech Deep #004","4.701","4.174","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Foodtech Deep #004","Foodtech Deep #005","2.531","1.650","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foodtech Deep #005","Foodtech Deep #001","8.169","4.994","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":439},{"label":"Mar","value":417},{"label":"Abr","value":380},{"label":"Mai","value":417},{"label":"Jun","value":347},{"label":"Jul","value":452},{"label":"Ago","value":624},{"label":"Set","value":332},{"label":"Out","value":518},{"label":"Nov","value":451},{"label":"Dez","value":580}];
const MX = 634;
