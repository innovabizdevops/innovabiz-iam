...
const PAGE = "Infrastructure";
const KPIS = [{"l":"Total Land Development","v":"1.634","t":"+17.9%","d":"up"},{"l":"Infrastructure Ativos","v":"2.800","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"72","t":"+5.0%","d":"up"}];
const COLS = ["ID","Infrastructure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Land Development #001","Land Development #002","8.857","2.305","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Land Development #002","Land Development #003","2.570","7.978","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Land Development #003","Land Development #004","8.355","8.302","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Land Development #004","Land Development #005","1.813","7.693","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Land Development #005","Land Development #001","2.217","4.672","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":536},{"label":"Mar","value":829},{"label":"Abr","value":745},{"label":"Mai","value":790},{"label":"Jun","value":827},{"label":"Jul","value":869},{"label":"Ago","value":553},{"label":"Set","value":652},{"label":"Out","value":706},{"label":"Nov","value":876},{"label":"Dez","value":559}];
const MX = 876;
