...
const PAGE = "Entitlement";
const KPIS = [{"l":"Total Land Development","v":"6.316","t":"+3.0%","d":"up"},{"l":"Entitlement Ativos","v":"1.889","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"89","t":"+13.1%","d":"up"}];
const COLS = ["ID","Entitlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Land Development #001","Land Development #002","231","2.329","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Land Development #002","Land Development #003","4.772","9.081","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Land Development #003","Land Development #004","1.466","2.600","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Land Development #004","Land Development #005","775","262","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Land Development #005","Land Development #001","5.731","7.801","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":679},{"label":"Mar","value":458},{"label":"Abr","value":550},{"label":"Mai","value":607},{"label":"Jun","value":718},{"label":"Jul","value":602},{"label":"Ago","value":708},{"label":"Set","value":565},{"label":"Out","value":543},{"label":"Nov","value":399},{"label":"Dez","value":509}];
const MX = 718;
...
export default function EntitlePage() {
    return (
