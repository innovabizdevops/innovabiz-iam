...
const ACCENT = "#6366f1";
const MODULE = "Land Development";
const PAGE = "Subdivision";
const KPIS = [{"l":"Total Land Development","v":"4.304","t":"+11.0%","d":"up"},{"l":"Subdivision Ativos","v":"4.359","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"93","t":"+4.5%","d":"up"}];
const COLS = ["ID","Subdivision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Land Development #001","Land Development #002","3.924","8.613","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Land Development #002","Land Development #003","5.736","7.360","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Land Development #003","Land Development #004","7.002","8.828","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Land Development #004","Land Development #005","7.441","4.857","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Land Development #005","Land Development #001","8.657","1.662","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":912},{"label":"Mar","value":649},{"label":"Abr","value":747},{"label":"Mai","value":678},{"label":"Jun","value":544},{"label":"Jul","value":745},{"label":"Ago","value":669},{"label":"Set","value":695},{"label":"Out","value":722},{"label":"Nov","value":540},{"label":"Dez","value":791}];
const MX = 912;
...
export default function SubdividePage() {
    return (
