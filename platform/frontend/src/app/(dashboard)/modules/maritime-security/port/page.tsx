...
const PAGE = "Port";
const KPIS = [{"l":"Total Maritime Security","v":"8.036","t":"+5.6%","d":"up"},{"l":"Port Ativos","v":"8.002","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"74.2%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+11.9%","d":"up"}];
const COLS = ["ID","Port","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Security #001","Maritime Security #002","8.469","6.533","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Security #002","Maritime Security #003","731","915","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Security #003","Maritime Security #004","3.218","8.736","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Security #004","Maritime Security #005","7.508","4.180","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Security #005","Maritime Security #001","3.932","8.569","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":624},{"label":"Mar","value":581},{"label":"Abr","value":473},{"label":"Mai","value":475},{"label":"Jun","value":330},{"label":"Jul","value":661},{"label":"Ago","value":642},{"label":"Set","value":433},{"label":"Out","value":529},{"label":"Nov","value":700},{"label":"Dez","value":555}];
const MX = 700;
