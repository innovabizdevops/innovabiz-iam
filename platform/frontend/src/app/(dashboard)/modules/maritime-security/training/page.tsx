...
const ACCENT = "#6366f1";
const MODULE = "Maritime Security";
const PAGE = "Training";
const KPIS = [{"l":"Total Maritime Security","v":"4.913","t":"+13.6%","d":"up"},{"l":"Training Ativos","v":"564","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"55","t":"-2.0%","d":"down"}];
const COLS = ["ID","Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Security #001","Maritime Security #002","5.923","5.773","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Security #002","Maritime Security #003","6.925","2.564","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Security #003","Maritime Security #004","1.591","6.140","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Security #004","Maritime Security #005","2.741","4.070","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Security #005","Maritime Security #001","3.503","4.075","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":484},{"label":"Mar","value":412},{"label":"Abr","value":413},{"label":"Mai","value":449},{"label":"Jun","value":520},{"label":"Jul","value":575},{"label":"Ago","value":332},{"label":"Set","value":348},{"label":"Out","value":301},{"label":"Nov","value":232},{"label":"Dez","value":518}];
const MX = 575;
