...
const PAGE = "Return Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.874","t":"+0.8%","d":"up"},{"l":"Sessões/Dia","v":"190","t":"-0.7%","d":"down"},{"l":"MFA Adoção (%)","v":"67.4%","t":"-1.6%","d":"down"},{"l":"Tentativas Bloqueadas","v":"3.353","t":"-3.8%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.617","7.834","7.915","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.064","2.783","8.988","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.018","7.564","4.670","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.551","1.482","3.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.852","2.345","6.601","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":577},{"label":"Mar","value":604},{"label":"Abr","value":834},{"label":"Mai","value":706},{"label":"Jun","value":864},{"label":"Jul","value":700},{"label":"Ago","value":599},{"label":"Set","value":865},{"label":"Out","value":790},{"label":"Nov","value":575},{"label":"Dez","value":608}];
const MX = 905;
