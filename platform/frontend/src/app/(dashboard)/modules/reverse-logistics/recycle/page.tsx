...
const ACCENT = "#ec4899";
const MODULE = "Reverse Logistics";
const PAGE = "Recycle";
const KPIS = [{"l":"Total Reverse Logistics","v":"4.429","t":"+10.3%","d":"up"},{"l":"Recycle Ativos","v":"1.136","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"71","t":"+3.0%","d":"up"}];
const COLS = ["ID","Recycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reverse Logistics #001","Reverse Logistics #002","8.124","7.456","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Reverse Logistics #002","Reverse Logistics #003","6.198","7.491","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Reverse Logistics #003","Reverse Logistics #004","7.353","426","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Reverse Logistics #004","Reverse Logistics #005","1.882","4.168","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reverse Logistics #005","Reverse Logistics #001","2.007","2.179","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":710},{"label":"Mar","value":581},{"label":"Abr","value":463},{"label":"Mai","value":799},{"label":"Jun","value":756},{"label":"Jul","value":577},{"label":"Ago","value":776},{"label":"Set","value":752},{"label":"Out","value":691},{"label":"Nov","value":504},{"label":"Dez","value":558}];
const MX = 799;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>ESG</span></h1>
                </div>
