...
const PAGE = "Disposition";
const KPIS = [{"l":"Pedidos/Dia","v":"3080","t":"-1.2%","d":"down"},{"l":"GMV (€)","v":"€15957","t":"+16.5%","d":"up"},{"l":"Conversão (%)","v":"71.4%","t":"+15.3%","d":"up"},{"l":"AOV (€)","v":"€69778","t":"-3.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 5973.37","4.245","4.951","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 6718.81","3.098","3.430","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 1363.21","7.935","8.268","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 5778.96","6.313","1.828","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 19877.29","2.126","1.947","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":811},{"label":"Mar","value":713},{"label":"Abr","value":880},{"label":"Mai","value":816},{"label":"Jun","value":867},{"label":"Jul","value":706},{"label":"Ago","value":707},{"label":"Set","value":886},{"label":"Out","value":757},{"label":"Nov","value":580},{"label":"Dez","value":530}];
const MX = 886;
