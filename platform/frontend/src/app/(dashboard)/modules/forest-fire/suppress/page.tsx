...
const PAGE = "Suppress";
const KPIS = [{"l":"Total Forest Fire","v":"7.099","t":"+2.0%","d":"up"},{"l":"Suppress Ativos","v":"2.430","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"95","t":"+15.7%","d":"up"}];
const COLS = ["ID","Suppress","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Fire #001","Forest Fire #002","8.146","3.912","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Fire #002","Forest Fire #003","7.950","5.751","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Fire #003","Forest Fire #004","7.571","5.545","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Fire #004","Forest Fire #005","4.152","8.905","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Fire #005","Forest Fire #001","3.345","1.652","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":573},{"label":"Mar","value":679},{"label":"Abr","value":504},{"label":"Mai","value":884},{"label":"Jun","value":850},{"label":"Jul","value":792},{"label":"Ago","value":699},{"label":"Set","value":638},{"label":"Out","value":719},{"label":"Nov","value":651},{"label":"Dez","value":886}];
const MX = 886;
...
export default function SuppressPage() {
    return (
