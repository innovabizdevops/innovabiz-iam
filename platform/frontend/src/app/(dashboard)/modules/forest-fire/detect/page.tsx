...
const ACCENT = "#dc2626";
const MODULE = "Forest Fire Mgmt";
const PAGE = "Detect";
const KPIS = [{"l":"Total Forest Fire","v":"8.490","t":"+10.6%","d":"up"},{"l":"Detect Ativos","v":"5.881","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"57","t":"+1.1%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Fire #001","Forest Fire #002","4.124","5.564","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Fire #002","Forest Fire #003","1.236","7.815","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Fire #003","Forest Fire #004","2.054","7.394","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Fire #004","Forest Fire #005","2.488","8.280","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Fire #005","Forest Fire #001","4.498","1.355","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":566},{"label":"Mar","value":477},{"label":"Abr","value":591},{"label":"Mai","value":588},{"label":"Jun","value":306},{"label":"Jul","value":645},{"label":"Ago","value":676},{"label":"Set","value":368},{"label":"Out","value":503},{"label":"Nov","value":537},{"label":"Dez","value":420}];
const MX = 676;
