...
/* ═══ Forest Fire Mgmt — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "7183", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4090", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€88K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "52655283", cells: ["FOR-6283", "Forest Fire Mgmt Item 1", "24/4/2026", "€5383"], status: "active" as const },
    { id: "52658854", cells: ["FOR-9854", "Forest Fire Mgmt Item 2", "11/11/2026", "€8954"], status: "pending" as const },
    { id: "52662425", cells: ["FOR-4425", "Forest Fire Mgmt Item 3", "26/6/2026", "€12 525"], status: "completed" as const },
    { id: "52665996", cells: ["FOR-7996", "Forest Fire Mgmt Item 4", "13/1/2026", "€16 096"], status: "warning" as const },
    { id: "52669567", cells: ["FOR-2567", "Forest Fire Mgmt Item 5", "28/8/2026", "€19 667"], status: "active" as const },
];
...
export default function ForestFireMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forest Fire Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Forest Fire Mgmt</p>
                    </div>
                </div>
