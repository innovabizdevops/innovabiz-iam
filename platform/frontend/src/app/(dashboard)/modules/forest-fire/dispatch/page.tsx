...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"3.385","t":"+17.3%","d":"up"},{"l":"Viagens/Dia","v":"1204","t":"-1.2%","d":"down"},{"l":"Pontualidade (%)","v":"78.8%","t":"+16.5%","d":"up"},{"l":"Passageiros/Dia","v":"2548","t":"+5.9%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-26","2026-03-27","2.661","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-24","2026-01-03","7.061","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-10","2026-02-21","8.034","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-16","2026-02-01","2.560","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-23","2026-02-22","7.329","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":464},{"label":"Mar","value":278},{"label":"Abr","value":421},{"label":"Mai","value":389},{"label":"Jun","value":368},{"label":"Jul","value":393},{"label":"Ago","value":583},{"label":"Set","value":324},{"label":"Out","value":227},{"label":"Nov","value":595},{"label":"Dez","value":272}];
const MX = 595;
