...
const PAGE = "Trust";
const KPIS = [{"l":"Vendas YTD (€)","v":"€48266","t":"+8.0%","d":"up"},{"l":"Pipeline (€)","v":"€92221","t":"-2.8%","d":"down"},{"l":"Atingimento Quota (%)","v":"86.4%","t":"+4.7%","d":"up"},{"l":"Win Rate (%)","v":"74.1%","t":"+10.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 33039.88","€ 43713.12","€ 35269.45","88.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 38015.32","€ 38862.18","€ 36945.68","76.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 38081.97","€ 26732.95","€ 6595.96","83.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 13933.00","€ 2626.44","€ 41198.00","81.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 41488.10","€ 24379.16","€ 6368.01","70.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":932},{"label":"Mar","value":1026},{"label":"Abr","value":959},{"label":"Mai","value":890},{"label":"Jun","value":838},{"label":"Jul","value":959},{"label":"Ago","value":857},{"label":"Set","value":699},{"label":"Out","value":995},{"label":"Nov","value":883},{"label":"Dez","value":923}];
const MX = 1026;
