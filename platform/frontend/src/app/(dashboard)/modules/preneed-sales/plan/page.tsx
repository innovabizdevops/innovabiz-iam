...
const PAGE = "Plan";
const KPIS = [{"l":"Vendas YTD (€)","v":"€7093","t":"+6.4%","d":"up"},{"l":"Pipeline (€)","v":"€72283","t":"+8.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"77.8%","t":"+5.3%","d":"up"},{"l":"Win Rate (%)","v":"85.5%","t":"+15.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 28528.73","€ 10309.07","€ 22361.60","92.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 47107.36","€ 39098.49","€ 18350.94","83.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 41356.70","€ 30506.90","€ 28735.11","89.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 47943.47","€ 47712.53","€ 34664.61","78.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 40520.69","€ 40297.68","€ 9888.25","82.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":336},{"label":"Mar","value":571},{"label":"Abr","value":598},{"label":"Mai","value":652},{"label":"Jun","value":614},{"label":"Jul","value":425},{"label":"Ago","value":634},{"label":"Set","value":606},{"label":"Out","value":640},{"label":"Nov","value":455},{"label":"Dez","value":566}];
const MX = 652;
