...
const ACCENT = "#334155";
const MODULE = "Pre-Need Sales";
const PAGE = "Contract";
const KPIS = [{"l":"Vendas YTD (€)","v":"€54556","t":"+13.5%","d":"up"},{"l":"Pipeline (€)","v":"€43123","t":"-4.5%","d":"down"},{"l":"Atingimento Quota (%)","v":"84.7%","t":"+9.4%","d":"up"},{"l":"Win Rate (%)","v":"79.4%","t":"-2.0%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 47867.96","€ 19146.32","€ 3141.29","91.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 49860.09","€ 37449.07","€ 16267.98","90.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 47084.13","€ 14514.14","€ 36022.65","87.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 29572.03","€ 45537.65","€ 49031.78","91.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 8659.04","€ 37550.53","€ 42578.94","96.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":570},{"label":"Mar","value":502},{"label":"Abr","value":697},{"label":"Mai","value":677},{"label":"Jun","value":560},{"label":"Jul","value":719},{"label":"Ago","value":707},{"label":"Set","value":702},{"label":"Out","value":475},{"label":"Nov","value":549},{"label":"Dez","value":446}];
const MX = 719;
