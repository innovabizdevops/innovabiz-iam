...
const PAGE = "Fulfillment";
const KPIS = [{"l":"Vendas YTD (€)","v":"€54337","t":"+0.5%","d":"up"},{"l":"Pipeline (€)","v":"€82839","t":"+2.7%","d":"up"},{"l":"Atingimento Quota (%)","v":"94.7%","t":"+3.8%","d":"up"},{"l":"Win Rate (%)","v":"72.7%","t":"+9.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 8533.57","€ 32573.14","€ 22868.10","83.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 45527.66","€ 38727.84","€ 25687.93","79.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 45974.66","€ 41998.09","€ 45701.61","94.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 34801.55","€ 22644.43","€ 8827.09","77.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 37277.10","€ 24713.84","€ 24055.11","83.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":687},{"label":"Mar","value":668},{"label":"Abr","value":571},{"label":"Mai","value":851},{"label":"Jun","value":731},{"label":"Jul","value":846},{"label":"Ago","value":859},{"label":"Set","value":792},{"label":"Out","value":625},{"label":"Nov","value":629},{"label":"Dez","value":816}];
const MX = 859;
