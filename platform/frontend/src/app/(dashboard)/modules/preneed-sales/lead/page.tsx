...
const PAGE = "Lead";
const KPIS = [{"l":"Vendas YTD (€)","v":"€36918","t":"+4.4%","d":"up"},{"l":"Pipeline (€)","v":"€39769","t":"+3.1%","d":"up"},{"l":"Atingimento Quota (%)","v":"76.2%","t":"-5.6%","d":"down"},{"l":"Win Rate (%)","v":"93.8%","t":"-0.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 13242.48","€ 15257.89","€ 36947.61","91.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 19171.87","€ 33676.82","€ 20262.20","73.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 27014.82","€ 39230.92","€ 50042.39","80.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 1833.80","€ 28575.03","€ 1212.79","80.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 6954.95","€ 10400.65","€ 13714.84","92.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":497},{"label":"Mar","value":571},{"label":"Abr","value":621},{"label":"Mai","value":586},{"label":"Jun","value":502},{"label":"Jul","value":685},{"label":"Ago","value":705},{"label":"Set","value":413},{"label":"Out","value":577},{"label":"Nov","value":433},{"label":"Dez","value":491}];
const MX = 775;
