...
/* ═══ Pre-Need Sales — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "8263", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2988", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€31K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1602352863", cells: ["PRE-2863", "Pre-Need Sales Item 1", "28/4/2026", "€2963"], status: "active" as const },
    { id: "1602356434", cells: ["PRE-6434", "Pre-Need Sales Item 2", "15/11/2026", "€6534"], status: "pending" as const },
    { id: "1602360005", cells: ["PRE-1005", "Pre-Need Sales Item 3", "2/6/2026", "€10 105"], status: "completed" as const },
    { id: "1602363576", cells: ["PRE-4576", "Pre-Need Sales Item 4", "17/1/2026", "€13 676"], status: "warning" as const },
    { id: "1602367147", cells: ["PRE-8147", "Pre-Need Sales Item 5", "4/8/2026", "€17 247"], status: "active" as const },
];
...
export default function PreneedSalesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pre-Need Sales</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pre-Need Sales</p>
                    </div>
                </div>
