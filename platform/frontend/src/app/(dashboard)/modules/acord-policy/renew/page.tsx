...
const PAGE = "Renew";
const KPIS = [{"l":"Total Acord Policy","v":"6.352","t":"+5.2%","d":"up"},{"l":"Renew Ativos","v":"3.609","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"86","t":"+17.3%","d":"up"}];
const COLS = ["ID","Renew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Policy #001","Acord Policy #002","3.662","3.688","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Policy #002","Acord Policy #003","550","6.068","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Policy #003","Acord Policy #004","845","1.770","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Policy #004","Acord Policy #005","7.365","429","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Policy #005","Acord Policy #001","5.770","5.503","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":713},{"label":"Mar","value":575},{"label":"Abr","value":516},{"label":"Mai","value":774},{"label":"Jun","value":726},{"label":"Jul","value":736},{"label":"Ago","value":862},{"label":"Set","value":645},{"label":"Out","value":799},{"label":"Nov","value":691},{"label":"Dez","value":531}];
const MX = 862;
