...
const PAGE = "Issue";
const KPIS = [{"l":"Total Acord Policy","v":"6.848","t":"+16.6%","d":"up"},{"l":"Issue Ativos","v":"4.518","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"63","t":"+7.1%","d":"up"}];
const COLS = ["ID","Issue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Policy #001","Acord Policy #002","6.596","6.297","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Policy #002","Acord Policy #003","6.874","9.099","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Policy #003","Acord Policy #004","5.917","7.210","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Policy #004","Acord Policy #005","4.956","943","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Policy #005","Acord Policy #001","338","232","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":285},{"label":"Fev","value":300},{"label":"Mar","value":640},{"label":"Abr","value":530},{"label":"Mai","value":309},{"label":"Jun","value":344},{"label":"Jul","value":559},{"label":"Ago","value":487},{"label":"Set","value":588},{"label":"Out","value":394},{"label":"Nov","value":438},{"label":"Dez","value":251}];
const MX = 640;
