...
const PAGE = "Bind";
const KPIS = [{"l":"Total Acord Policy","v":"2.154","t":"+13.1%","d":"up"},{"l":"Bind Ativos","v":"9.072","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.9%","d":"up"}];
const COLS = ["ID","Bind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Policy #001","Acord Policy #002","1.697","8.660","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Policy #002","Acord Policy #003","1.280","2.297","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Policy #003","Acord Policy #004","1.267","2.384","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Policy #004","Acord Policy #005","3.516","3.965","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Policy #005","Acord Policy #001","2.968","633","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":870},{"label":"Fev","value":731},{"label":"Mar","value":854},{"label":"Abr","value":674},{"label":"Mai","value":991},{"label":"Jun","value":680},{"label":"Jul","value":773},{"label":"Ago","value":678},{"label":"Set","value":703},{"label":"Out","value":811},{"label":"Nov","value":979},{"label":"Dez","value":833}];
const MX = 991;
