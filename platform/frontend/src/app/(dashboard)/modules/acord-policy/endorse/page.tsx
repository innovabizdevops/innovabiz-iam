...
const ACCENT = "#0e7490";
const MODULE = "Policy Admin (ACORD)";
const PAGE = "Endorse";
const KPIS = [{"l":"Total Acord Policy","v":"1.864","t":"-2.9%","d":"down"},{"l":"Endorse Ativos","v":"2.759","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"56","t":"+7.9%","d":"up"}];
const COLS = ["ID","Endorse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Policy #001","Acord Policy #002","4.930","1.275","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Policy #002","Acord Policy #003","4.623","1.121","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Policy #003","Acord Policy #004","1.376","3.280","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Policy #004","Acord Policy #005","2.395","5.710","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Policy #005","Acord Policy #001","979","7.245","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":648},{"label":"Mar","value":372},{"label":"Abr","value":404},{"label":"Mai","value":594},{"label":"Jun","value":622},{"label":"Jul","value":383},{"label":"Ago","value":463},{"label":"Set","value":533},{"label":"Out","value":505},{"label":"Nov","value":308},{"label":"Dez","value":605}];
const MX = 648;
