...
/* ═══ Policy Admin (ACORD) — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "5079", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "436", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€252K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "447395879", cells: ["ACO-6879", "Policy Admin (ACORD) Item 1", "8/12/2026", "€45 979"], status: "active" as const },
    { id: "447399450", cells: ["ACO-1450", "Policy Admin (ACORD) Item 2", "23/7/2026", "€49 550"], status: "pending" as const },
    { id: "447403021", cells: ["ACO-5021", "Policy Admin (ACORD) Item 3", "10/2/2026", "€3121"], status: "completed" as const },
    { id: "447406592", cells: ["ACO-8592", "Policy Admin (ACORD) Item 4", "25/9/2026", "€6692"], status: "warning" as const },
    { id: "447410163", cells: ["ACO-3163", "Policy Admin (ACORD) Item 5", "12/4/2026", "€10 263"], status: "active" as const },
];
...
export default function PolicyAdminAcordPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Policy Admin (ACORD)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Policy Admin (ACORD)</p>
                    </div>
                </div>
