...
const PAGE = "Quote";
const KPIS = [{"l":"Total Acord Policy","v":"496","t":"-1.1%","d":"down"},{"l":"Quote Ativos","v":"5.624","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"62","t":"+6.7%","d":"up"}];
const COLS = ["ID","Quote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acord Policy #001","Acord Policy #002","500","2.255","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Acord Policy #002","Acord Policy #003","4.275","1.930","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Acord Policy #003","Acord Policy #004","5.518","3.396","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Acord Policy #004","Acord Policy #005","1.828","5.407","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acord Policy #005","Acord Policy #001","6.973","648","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":641},{"label":"Mar","value":921},{"label":"Abr","value":882},{"label":"Mai","value":716},{"label":"Jun","value":586},{"label":"Jul","value":670},{"label":"Ago","value":945},{"label":"Set","value":645},{"label":"Out","value":900},{"label":"Nov","value":909},{"label":"Dez","value":791}];
const MX = 945;
