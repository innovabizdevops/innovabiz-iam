...
const PAGE = "Enforce";
const KPIS = [{"l":"Integrações Ativas","v":"3.965","t":"+6.2%","d":"up"},{"l":"Chamadas/Hora","v":"1799","t":"+15.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.8%","t":"-0.8%","d":"down"},{"l":"Latência Média (ms)","v":"198ms","t":"+14.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.507","3.590","87.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.030","8.312","77.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","353","3.049","70.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.868","6.974","98.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.414","8.818","80.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":545},{"label":"Mar","value":929},{"label":"Abr","value":604},{"label":"Mai","value":668},{"label":"Jun","value":577},{"label":"Jul","value":855},{"label":"Ago","value":550},{"label":"Set","value":906},{"label":"Out","value":858},{"label":"Nov","value":761},{"label":"Dez","value":784}];
const MX = 929;
