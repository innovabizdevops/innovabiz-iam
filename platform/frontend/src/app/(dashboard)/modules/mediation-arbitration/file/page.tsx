...
const PAGE = "File";
const KPIS = [{"l":"Integrações Ativas","v":"557","t":"+12.3%","d":"up"},{"l":"Chamadas/Hora","v":"1381","t":"+1.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.3%","t":"+15.6%","d":"up"},{"l":"Latência Média (ms)","v":"89ms","t":"-4.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.766","6.316","84.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","219","6.464","98.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.202","4.439","77.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.911","1.153","99.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.471","3.454","96.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":555},{"label":"Mar","value":557},{"label":"Abr","value":379},{"label":"Mai","value":674},{"label":"Jun","value":686},{"label":"Jul","value":701},{"label":"Ago","value":685},{"label":"Set","value":452},{"label":"Out","value":386},{"label":"Nov","value":723},{"label":"Dez","value":476}];
const MX = 723;
