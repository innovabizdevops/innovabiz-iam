...
const PAGE = "Mediate";
const KPIS = [{"l":"Integrações Ativas","v":"4.028","t":"+12.9%","d":"up"},{"l":"Chamadas/Hora","v":"1007","t":"+4.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.5%","t":"+5.4%","d":"up"},{"l":"Latência Média (ms)","v":"144ms","t":"-1.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.224","5.954","98.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","367","1.229","95.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.554","8.180","80.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.724","2.688","91.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.185","8.921","96.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":236},{"label":"Fev","value":566},{"label":"Mar","value":403},{"label":"Abr","value":571},{"label":"Mai","value":297},{"label":"Jun","value":583},{"label":"Jul","value":463},{"label":"Ago","value":518},{"label":"Set","value":256},{"label":"Out","value":329},{"label":"Nov","value":611},{"label":"Dez","value":503}];
const MX = 611;
