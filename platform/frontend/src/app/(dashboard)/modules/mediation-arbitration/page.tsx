...
/* ═══ Mediation & Arbitration — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "3955", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3525", trend: "+25%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1623049455", cells: ["MED-8455", "Mediation & Arbitration Item 1", "28/4/2026", "€49 555"], status: "active" as const },
    { id: "1623053026", cells: ["MED-3026", "Mediation & Arbitration Item 2", "15/11/2026", "€3126"], status: "pending" as const },
    { id: "1623056597", cells: ["MED-6597", "Mediation & Arbitration Item 3", "2/6/2026", "€6697"], status: "completed" as const },
    { id: "1623060168", cells: ["MED-1168", "Mediation & Arbitration Item 4", "17/1/2026", "€10 268"], status: "warning" as const },
    { id: "1623063739", cells: ["MED-4739", "Mediation & Arbitration Item 5", "4/8/2026", "€13 839"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mediation & Arbitration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mediation & Arbitration</p>
                    </div>
                </div>
