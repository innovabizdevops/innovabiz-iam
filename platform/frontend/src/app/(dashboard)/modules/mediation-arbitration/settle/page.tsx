...
const PAGE = "Settle";
const KPIS = [{"l":"Integrações Ativas","v":"7.865","t":"+11.6%","d":"up"},{"l":"Chamadas/Hora","v":"4090","t":"+0.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.6%","t":"+2.7%","d":"up"},{"l":"Latência Média (ms)","v":"192ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.243","6.458","72.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.157","6.403","73.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.199","8.117","82.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","304","3.048","70.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.843","3.812","97.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":688},{"label":"Mar","value":541},{"label":"Abr","value":460},{"label":"Mai","value":813},{"label":"Jun","value":621},{"label":"Jul","value":612},{"label":"Ago","value":604},{"label":"Set","value":499},{"label":"Out","value":475},{"label":"Nov","value":566},{"label":"Dez","value":457}];
const MX = 813;
