...
const ACCENT = "#4c1d95";
const MODULE = "Mediation & Arbitration";
const PAGE = "Arbitrate";
const KPIS = [{"l":"Integrações Ativas","v":"6.457","t":"-1.2%","d":"down"},{"l":"Chamadas/Hora","v":"114","t":"+10.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.4%","t":"+15.6%","d":"up"},{"l":"Latência Média (ms)","v":"25ms","t":"+15.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.313","4.151","70.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","315","3.389","87.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.061","4.616","79.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.885","2.953","94.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.852","1.035","87.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":572},{"label":"Mar","value":768},{"label":"Abr","value":647},{"label":"Mai","value":677},{"label":"Jun","value":737},{"label":"Jul","value":553},{"label":"Ago","value":476},{"label":"Set","value":731},{"label":"Out","value":475},{"label":"Nov","value":745},{"label":"Dez","value":645}];
const MX = 868;
