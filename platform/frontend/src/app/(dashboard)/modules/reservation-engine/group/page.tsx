...
const ACCENT = "#059669";
const MODULE = "Reservation Engine";
const PAGE = "Group Block";
const KPIS = [{"l":"Quartos Ocupados","v":"2.818","t":"+11.2%","d":"up"},{"l":"RevPAR (€)","v":"€64966","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"93.9%","t":"+9.9%","d":"up"},{"l":"Guest Satisfaction","v":"215","t":"+15.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.276","2026-03-08","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.719","2026-03-07","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.700","2026-01-13","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.896","2026-03-19","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.457","2026-01-14","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":769},{"label":"Mar","value":689},{"label":"Abr","value":974},{"label":"Mai","value":980},{"label":"Jun","value":896},{"label":"Jul","value":1010},{"label":"Ago","value":964},{"label":"Set","value":910},{"label":"Out","value":883},{"label":"Nov","value":967},{"label":"Dez","value":669}];
const MX = 1010;
