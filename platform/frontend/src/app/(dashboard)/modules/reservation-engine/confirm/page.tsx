...
const KPIS = [{"l":"Quartos Ocupados","v":"2.060","t":"+4.4%","d":"up"},{"l":"RevPAR (€)","v":"€19351","t":"+16.4%","d":"up"},{"l":"Ocupação (%)","v":"70.1%","t":"+11.8%","d":"up"},{"l":"Guest Satisfaction","v":"4.833","t":"-5.8%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.922","2026-03-07","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.714","2026-01-15","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.768","2026-02-28","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.844","2026-03-26","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.222","2026-01-25","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":704},{"label":"Mar","value":718},{"label":"Abr","value":579},{"label":"Mai","value":699},{"label":"Jun","value":731},{"label":"Jul","value":671},{"label":"Ago","value":958},{"label":"Set","value":719},{"label":"Out","value":823},{"label":"Nov","value":793},{"label":"Dez","value":730}];
const MX = 958;
