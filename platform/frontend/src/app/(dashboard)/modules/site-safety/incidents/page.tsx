...
const ACCENT = "#059669";
const MODULE = "Site Safety";
const PAGE = "Incident Log";
const KPIS = [{"l":"Tickets Abertos","v":"3.824","t":"-3.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"93.7%","t":"+13.0%","d":"up"},{"l":"MTTR (h)","v":"18h","t":"+4.8%","d":"up"},{"l":"Satisfação (%)","v":"94.1%","t":"+16.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.394","1.802","324","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.081","6.615","3.274","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.702","4.447","2.288","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.140","4.592","8.452","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.715","7.341","112","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":594},{"label":"Mar","value":660},{"label":"Abr","value":565},{"label":"Mai","value":628},{"label":"Jun","value":472},{"label":"Jul","value":458},{"label":"Ago","value":626},{"label":"Set","value":447},{"label":"Out","value":528},{"label":"Nov","value":376},{"label":"Dez","value":398}];
const MX = 660;
