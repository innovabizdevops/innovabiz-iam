...
const ACCENT = "#312e81";
const MODULE = "Cognitive Security Fabric";
const PAGE = "GenAI Safe";
const KPIS = [{"l":"Total Cognitive Security","v":"714","t":"+17.4%","d":"up"},{"l":"GenAI Safe Ativos","v":"4.825","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"69","t":"-2.3%","d":"down"}];
const COLS = ["ID","GenAI Safe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cognitive Security #001","Cognitive Security #002","3.926","8.240","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cognitive Security #002","Cognitive Security #003","5.215","8.688","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cognitive Security #003","Cognitive Security #004","5.686","4.750","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cognitive Security #004","Cognitive Security #005","6.001","1.229","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cognitive Security #005","Cognitive Security #001","1.982","2.221","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":550},{"label":"Mar","value":725},{"label":"Abr","value":618},{"label":"Mai","value":790},{"label":"Jun","value":462},{"label":"Jul","value":436},{"label":"Ago","value":695},{"label":"Set","value":660},{"label":"Out","value":675},{"label":"Nov","value":527},{"label":"Dez","value":598}];
const MX = 790;
...
export default function GenaisafePage() {
    return (
