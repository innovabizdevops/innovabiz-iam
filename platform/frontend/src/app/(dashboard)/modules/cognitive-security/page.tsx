...
/* ═══ Cognitive Security Fabric — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "206", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "852", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€397K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "491881606", cells: ["COG-5606", "Cognitive Security Fabric Item 1", "7/11/2026", "€31 706"], status: "active" as const },
    { id: "491885177", cells: ["COG-9177", "Cognitive Security Fabric Item 2", "22/6/2026", "€35 277"], status: "pending" as const },
    { id: "491888748", cells: ["COG-3748", "Cognitive Security Fabric Item 3", "9/1/2026", "€38 848"], status: "completed" as const },
    { id: "491892319", cells: ["COG-7319", "Cognitive Security Fabric Item 4", "24/8/2026", "€42 419"], status: "warning" as const },
    { id: "491895890", cells: ["COG-1890", "Cognitive Security Fabric Item 5", "11/3/2026", "€45 990"], status: "active" as const },
];
...
export default function CognitiveSecurityFabricPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Security Fabric</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Security Fabric</p>
                    </div>
                </div>
