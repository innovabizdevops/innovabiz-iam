...
/* ═══ Carbon Market — Mrv Platform ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "3106", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "375", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1764", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "268185107", cells: ["CAR-4107", "Mrv Platform Item 1", "16/12/2026", "€35 207"], status: "active" as const },
    { id: "268188678", cells: ["CAR-7678", "Mrv Platform Item 2", "3/7/2026", "€38 778"], status: "pending" as const },
    { id: "268192249", cells: ["CAR-2249", "Mrv Platform Item 3", "18/2/2026", "€42 349"], status: "completed" as const },
    { id: "268195820", cells: ["CAR-5820", "Mrv Platform Item 4", "5/9/2026", "€45 920"], status: "warning" as const },
    { id: "268199391", cells: ["CAR-9391", "Mrv Platform Item 5", "20/4/2026", "€49 491"], status: "active" as const },
];
...
export default function CarbonMarketMrvPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mrv Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Mrv Platform</p>
                    </div>
                </div>
