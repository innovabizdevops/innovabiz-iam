...
/* ═══ Carbon Market — Carbon Accounting ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "207", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "187", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3508", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "833998903", cells: ["CAR-5903", "Carbon Accounting Item 1", "4/8/2026", "€49 003"], status: "active" as const },
    { id: "834002474", cells: ["CAR-9474", "Carbon Accounting Item 2", "19/3/2026", "€2574"], status: "pending" as const },
    { id: "834006045", cells: ["CAR-4045", "Carbon Accounting Item 3", "6/10/2026", "€6145"], status: "completed" as const },
    { id: "834009616", cells: ["CAR-7616", "Carbon Accounting Item 4", "21/5/2026", "€9716"], status: "warning" as const },
    { id: "834013187", cells: ["CAR-2187", "Carbon Accounting Item 5", "8/12/2026", "€13 287"], status: "active" as const },
];
...
export default function CarbonMarketCarbonAccountingPage() {
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Carbon Accounting</p>
                    </div>
                </div>
