...
/* ═══ Carbon Market — Credit Trading ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "2499", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "345", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1741", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "855847861", cells: ["CAR-2861", "Credit Trading Item 1", "2/2/2026", "€47 961"], status: "active" as const },
    { id: "855851432", cells: ["CAR-6432", "Credit Trading Item 2", "17/9/2026", "€1532"], status: "pending" as const },
    { id: "855855003", cells: ["CAR-1003", "Credit Trading Item 3", "4/4/2026", "€5103"], status: "completed" as const },
    { id: "855858574", cells: ["CAR-4574", "Credit Trading Item 4", "19/11/2026", "€8674"], status: "warning" as const },
    { id: "855862145", cells: ["CAR-8145", "Credit Trading Item 5", "6/6/2026", "€12 245"], status: "active" as const },
];
...
export default function CarbonMarketCreditTradingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Credit Trading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Credit Trading</p>
                    </div>
                </div>
