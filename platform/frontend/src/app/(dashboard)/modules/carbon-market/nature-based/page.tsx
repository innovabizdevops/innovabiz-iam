...
/* ═══ Carbon Market — Nature Based ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "3098", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "255", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3097", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1855091851", cells: ["CAR-3851", "Nature Based Item 1", "12/8/2026", "€41 951"], status: "active" as const },
    { id: "1855095422", cells: ["CAR-7422", "Nature Based Item 2", "27/3/2026", "€45 522"], status: "pending" as const },
    { id: "1855098993", cells: ["CAR-1993", "Nature Based Item 3", "14/10/2026", "€49 093"], status: "completed" as const },
    { id: "1855102564", cells: ["CAR-5564", "Nature Based Item 4", "1/5/2026", "€2664"], status: "warning" as const },
    { id: "1855106135", cells: ["CAR-9135", "Nature Based Item 5", "16/12/2026", "€6235"], status: "active" as const },
];
...
export default function CarbonMarketNatureBasedPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nature Based</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Nature Based</p>
                    </div>
                </div>
