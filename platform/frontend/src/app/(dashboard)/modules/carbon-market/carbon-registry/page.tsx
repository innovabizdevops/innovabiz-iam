...
/* ═══ Carbon Market — Carbon Registry ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "4194", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "179", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2817", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "786349663", cells: ["CAR-2663", "Carbon Registry Item 1", "16/8/2026", "€49 763"], status: "active" as const },
    { id: "786353234", cells: ["CAR-6234", "Carbon Registry Item 2", "3/3/2026", "€3334"], status: "pending" as const },
    { id: "786356805", cells: ["CAR-9805", "Carbon Registry Item 3", "18/10/2026", "€6905"], status: "completed" as const },
    { id: "786360376", cells: ["CAR-4376", "Carbon Registry Item 4", "5/5/2026", "€10 476"], status: "warning" as const },
    { id: "786363947", cells: ["CAR-7947", "Carbon Registry Item 5", "20/12/2026", "€14 047"], status: "active" as const },
];
...
export default function CarbonMarketCarbonRegistryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carbon Registry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Carbon Registry</p>
                    </div>
                </div>
