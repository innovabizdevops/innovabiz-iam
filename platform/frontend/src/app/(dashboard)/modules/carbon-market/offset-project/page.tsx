...
/* ═══ Carbon Market — Offset Project ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "159", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "65", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2930", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1381978589", cells: ["CAR-2589", "Offset Project Item 1", "6/6/2026", "€28 689"], status: "active" as const },
    { id: "1381982160", cells: ["CAR-6160", "Offset Project Item 2", "21/1/2026", "€32 260"], status: "pending" as const },
    { id: "1381985731", cells: ["CAR-9731", "Offset Project Item 3", "8/8/2026", "€35 831"], status: "completed" as const },
    { id: "1381989302", cells: ["CAR-4302", "Offset Project Item 4", "23/3/2026", "€39 402"], status: "warning" as const },
    { id: "1381992873", cells: ["CAR-7873", "Offset Project Item 5", "10/10/2026", "€42 973"], status: "active" as const },
];
...
export default function CarbonMarketOffsetProjectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Offset Project</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Offset Project</p>
                    </div>
                </div>
