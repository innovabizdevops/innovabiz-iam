...
/* ═══ Carbon Market — Compliance Market ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "3061", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3672", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "624754928", cells: ["CAR-2928", "Compliance Market Item 1", "1/9/2026", "€5028"], status: "active" as const },
    { id: "624758499", cells: ["CAR-6499", "Compliance Market Item 2", "16/4/2026", "€8599"], status: "pending" as const },
    { id: "624762070", cells: ["CAR-1070", "Compliance Market Item 3", "3/11/2026", "€12 170"], status: "completed" as const },
    { id: "624765641", cells: ["CAR-4641", "Compliance Market Item 4", "18/6/2026", "€15 741"], status: "warning" as const },
    { id: "624769212", cells: ["CAR-8212", "Compliance Market Item 5", "5/1/2026", "€19 312"], status: "active" as const },
];
...
export default function CarbonMarketComplianceMarketPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Market</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Compliance Market</p>
                    </div>
                </div>
