...
const KPIS = [
    { label: "Total", value: "1085", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "278", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "356", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1293810834", cells: ["CAR-7834", "Climate Finance Item 1", "23/7/2026", "€10 934"], status: "active" as const },
    { id: "1293814405", cells: ["CAR-2405", "Climate Finance Item 2", "10/2/2026", "€14 505"], status: "pending" as const },
    { id: "1293817976", cells: ["CAR-5976", "Climate Finance Item 3", "25/9/2026", "€18 076"], status: "completed" as const },
    { id: "1293821547", cells: ["CAR-9547", "Climate Finance Item 4", "12/4/2026", "€21 647"], status: "warning" as const },
    { id: "1293825118", cells: ["CAR-4118", "Climate Finance Item 5", "27/11/2026", "€25 218"], status: "active" as const },
];
...
export default function CarbonMarketClimateFinancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Climate Finance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Climate Finance</p>
                    </div>
                </div>
