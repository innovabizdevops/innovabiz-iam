...
/* ═══ Carbon Market — Tech Based Removal ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "701", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "30", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "654", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1293372122", cells: ["CAR-1122", "Tech Based Removal Item 1", "15/3/2026", "€22 222"], status: "active" as const },
    { id: "1293375693", cells: ["CAR-4693", "Tech Based Removal Item 2", "2/10/2026", "€25 793"], status: "pending" as const },
    { id: "1293379264", cells: ["CAR-8264", "Tech Based Removal Item 3", "17/5/2026", "€29 364"], status: "completed" as const },
    { id: "1293382835", cells: ["CAR-2835", "Tech Based Removal Item 4", "4/12/2026", "€32 935"], status: "warning" as const },
    { id: "1293386406", cells: ["CAR-6406", "Tech Based Removal Item 5", "19/7/2026", "€36 506"], status: "active" as const },
];
...
export default function CarbonMarketTechBasedRemovalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tech Based Removal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Tech Based Removal</p>
                    </div>
                </div>
