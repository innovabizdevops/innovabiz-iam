...
/* ═══ Carbon Market — Voluntary Market ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "867", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "369", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "164", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "52948877", cells: ["CAR-2877", "Voluntary Market Item 1", "10/6/2026", "€48 977"], status: "active" as const },
    { id: "52952448", cells: ["CAR-6448", "Voluntary Market Item 2", "25/1/2026", "€2548"], status: "pending" as const },
    { id: "52956019", cells: ["CAR-1019", "Voluntary Market Item 3", "12/8/2026", "€6119"], status: "completed" as const },
    { id: "52959590", cells: ["CAR-4590", "Voluntary Market Item 4", "27/3/2026", "€9690"], status: "warning" as const },
    { id: "52963161", cells: ["CAR-8161", "Voluntary Market Item 5", "14/10/2026", "€13 261"], status: "active" as const },
];
...
export default function CarbonMarketVoluntaryMarketPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Voluntary Market</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Carbon Market • Voluntary Market</p>
                    </div>
                </div>
