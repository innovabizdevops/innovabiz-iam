...
const PAGE = "Sourcing";
const KPIS = [{"l":"Fornecedores Ativos","v":"5.395","t":"+17.5%","d":"up"},{"l":"Contratos (€M)","v":"€27.7M","t":"+17.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"94.0%","t":"+3.8%","d":"up"},{"l":"Score Médio","v":"78","t":"+4.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","96.4%","€ 17095.04","7.843","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","88.7%","€ 28745.29","7.505","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","81.5%","€ 35547.28","1.980","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","99.3%","€ 39607.68","1.714","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","97.9%","€ 10944.84","237","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":958},{"label":"Mar","value":699},{"label":"Abr","value":840},{"label":"Mai","value":936},{"label":"Jun","value":872},{"label":"Jul","value":1011},{"label":"Ago","value":854},{"label":"Set","value":827},{"label":"Out","value":1067},{"label":"Nov","value":1013},{"label":"Dez","value":861}];
const MX = 1067;
