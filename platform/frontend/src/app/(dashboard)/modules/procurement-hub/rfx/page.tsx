...
const PAGE = "RFx";
const KPIS = [{"l":"Fornecedores Ativos","v":"9.056","t":"+10.2%","d":"up"},{"l":"Contratos (€M)","v":"€32.8M","t":"+15.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"65.4%","t":"+17.4%","d":"up"},{"l":"Score Médio","v":"93","t":"+4.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","78.0%","€ 30126.99","1.617","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","76.1%","€ 35168.02","6.501","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.4%","€ 4991.45","6.210","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","78.4%","€ 25841.66","934","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","93.0%","€ 17647.36","3.637","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":838},{"label":"Mar","value":840},{"label":"Abr","value":641},{"label":"Mai","value":559},{"label":"Jun","value":654},{"label":"Jul","value":844},{"label":"Ago","value":691},{"label":"Set","value":630},{"label":"Out","value":852},{"label":"Nov","value":785},{"label":"Dez","value":518}];
const MX = 852;
