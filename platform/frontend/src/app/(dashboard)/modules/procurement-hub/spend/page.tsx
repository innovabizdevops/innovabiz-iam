...
const ACCENT = "#6366f1";
const MODULE = "Procurement Hub";
const PAGE = "Spend";
const KPIS = [{"l":"Fornecedores Ativos","v":"335","t":"+17.3%","d":"up"},{"l":"Contratos (€M)","v":"€39.0M","t":"+11.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"70.9%","t":"+3.1%","d":"up"},{"l":"Score Médio","v":"76","t":"+0.7%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","98.1%","€ 35016.78","5.274","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","74.3%","€ 28166.96","5.088","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","96.5%","€ 15346.67","1.987","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.1%","€ 21736.17","7.945","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","84.2%","€ 43363.74","5.276","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":458},{"label":"Mar","value":621},{"label":"Abr","value":530},{"label":"Mai","value":477},{"label":"Jun","value":544},{"label":"Jul","value":732},{"label":"Ago","value":525},{"label":"Set","value":715},{"label":"Out","value":622},{"label":"Nov","value":453},{"label":"Dez","value":771}];
const MX = 792;
