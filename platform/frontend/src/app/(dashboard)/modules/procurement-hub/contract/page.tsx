...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"6.058","t":"+1.5%","d":"up"},{"l":"Valor Total (€M)","v":"€31.4M","t":"+6.6%","d":"up"},{"l":"Renovações Próx. 30d","v":"8.039","t":"+17.4%","d":"up"},{"l":"Obrigações Pendentes","v":"4.911","t":"+10.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 24399.12","2026-02-28","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 50070.12","2026-03-19","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 17323.89","2026-03-23","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 37664.58","2026-01-24","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 28734.78","2026-03-22","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":920},{"label":"Mar","value":629},{"label":"Abr","value":853},{"label":"Mai","value":958},{"label":"Jun","value":730},{"label":"Jul","value":846},{"label":"Ago","value":736},{"label":"Set","value":966},{"label":"Out","value":784},{"label":"Nov","value":832},{"label":"Dez","value":875}];
const MX = 966;
