...
const KPIS = [{"l":"Fornecedores Ativos","v":"6.696","t":"+6.0%","d":"up"},{"l":"Contratos (€M)","v":"€37.6M","t":"+11.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"79.3%","t":"-4.1%","d":"down"},{"l":"Score Médio","v":"60","t":"-3.7%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","87.7%","€ 31213.32","4.319","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","79.8%","€ 6467.26","2.220","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.3%","€ 11496.51","7.428","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","71.3%","€ 34604.75","7.759","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","92.3%","€ 38078.64","9.086","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1064},{"label":"Fev","value":867},{"label":"Mar","value":919},{"label":"Abr","value":887},{"label":"Mai","value":1081},{"label":"Jun","value":790},{"label":"Jul","value":1075},{"label":"Ago","value":773},{"label":"Set","value":1004},{"label":"Out","value":742},{"label":"Nov","value":765},{"label":"Dez","value":805}];
const MX = 1081;
