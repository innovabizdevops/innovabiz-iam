...
const ACCENT = "#4338ca";
const MODULE = "CMS Pages";
const PAGE = "Personalization";
const KPIS = [{"l":"Perfis Unificados","v":"880","t":"+1.2%","d":"up"},{"l":"Segmentos Ativos","v":"6.639","t":"+8.4%","d":"up"},{"l":"NPS Score","v":"66","t":"+8.1%","d":"up"},{"l":"Churn Previsto (%)","v":"78.9%","t":"+11.9%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.765","€ 5012.44","82.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","4.743","€ 20482.60","98.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.605","€ 36542.82","75.0%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","7.645","€ 31451.21","87.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","590","€ 4383.40","88.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":832},{"label":"Mar","value":858},{"label":"Abr","value":817},{"label":"Mai","value":618},{"label":"Jun","value":619},{"label":"Jul","value":733},{"label":"Ago","value":865},{"label":"Set","value":843},{"label":"Out","value":766},{"label":"Nov","value":878},{"label":"Dez","value":602}];
const MX = 878;
