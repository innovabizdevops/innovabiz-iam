...
const PAGE = "A/B Content";
const KPIS = [{"l":"Páginas Publicadas","v":"1.541","t":"+14.1%","d":"up"},{"l":"Visitantes/Dia","v":"4732","t":"+17.7%","d":"up"},{"l":"Conversão (%)","v":"76.7%","t":"-1.2%","d":"down"},{"l":"Performance Score","v":"77","t":"+13.7%","d":"up"}];
const COLS = ["Página","URL","Views/Dia","Bounce (%)","Conversão (%)","Estado"];
const ROWS = [{"id":"r0","cells":["/home","/products","481","94.6%","97.5%","Ativo"],"status":"active"},{"id":"r1","cells":["/products","/pricing","1877","74.6%","96.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["/pricing","/about","3302","97.3%","94.4%","Concluído"],"status":"done"},{"id":"r3","cells":["/about","/contact","829","97.1%","82.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["/contact","/home","2800","78.6%","99.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":954},{"label":"Mar","value":829},{"label":"Abr","value":758},{"label":"Mai","value":767},{"label":"Jun","value":740},{"label":"Jul","value":857},{"label":"Ago","value":797},{"label":"Set","value":773},{"label":"Out","value":983},{"label":"Nov","value":739},{"label":"Dez","value":778}];
const MX = 983;
...
export default function AbContentPage() {
    return (
