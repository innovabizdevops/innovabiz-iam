...
const KPIS = [{"l":"Formulários Ativos","v":"8.085","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"2002","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"338","t":"-1.4%","d":"down"},{"l":"Templates","v":"5.546","t":"+6.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.450","2026-01-15","4.532","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","413","2026-02-04","6.537","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.918","2026-01-22","8.218","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","184","2026-02-12","8.741","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.710","2026-01-12","7.280","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":657},{"label":"Mar","value":858},{"label":"Abr","value":883},{"label":"Mai","value":648},{"label":"Jun","value":883},{"label":"Jul","value":526},{"label":"Ago","value":586},{"label":"Set","value":654},{"label":"Out","value":799},{"label":"Nov","value":657},{"label":"Dez","value":668}];
const MX = 883;
