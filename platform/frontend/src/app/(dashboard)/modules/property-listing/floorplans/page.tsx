...
const PAGE = "Floor Plans";
const KPIS = [{"l":"Total Property Listing","v":"1.147","t":"+14.7%","d":"up"},{"l":"Floor Plans Ativos","v":"5.176","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+17.7%","d":"up"}];
const COLS = ["ID","Floor Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Listing #001","Property Listing #002","2.088","3.720","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Property Listing #002","Property Listing #003","3.642","5.340","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Listing #003","Property Listing #004","5.634","4.431","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Property Listing #004","Property Listing #005","1.108","9.004","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Listing #005","Property Listing #001","7.505","8.203","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":500},{"label":"Mar","value":591},{"label":"Abr","value":702},{"label":"Mai","value":391},{"label":"Jun","value":424},{"label":"Jul","value":382},{"label":"Ago","value":440},{"label":"Set","value":599},{"label":"Out","value":479},{"label":"Nov","value":500},{"label":"Dez","value":716}];
const MX = 716;
