...
const PAGE = "Comparable Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€37223","t":"+15.4%","d":"up"},{"l":"Pipeline (€)","v":"€49950","t":"+17.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"72.0%","t":"+9.3%","d":"up"},{"l":"Win Rate (%)","v":"67.0%","t":"+8.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7576.38","€ 46229.48","€ 18353.82","98.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 34630.41","€ 42797.11","€ 22522.92","73.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 13738.20","€ 17684.67","€ 422.84","90.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 23477.66","€ 37000.46","€ 39319.67","85.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 21783.19","€ 45878.20","€ 48941.44","77.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":655},{"label":"Mar","value":494},{"label":"Abr","value":597},{"label":"Mai","value":518},{"label":"Jun","value":669},{"label":"Jul","value":590},{"label":"Ago","value":563},{"label":"Set","value":652},{"label":"Out","value":730},{"label":"Nov","value":419},{"label":"Dez","value":534}];
const MX = 730;
