...
const PAGE = "Photo Gallery";
const KPIS = [{"l":"Total Property Listing","v":"3.691","t":"+12.2%","d":"up"},{"l":"Photo Gallery Ativos","v":"2.051","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"72.4%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"56","t":"+6.3%","d":"up"}];
const COLS = ["ID","Photo Gallery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Listing #001","Property Listing #002","967","4.168","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Property Listing #002","Property Listing #003","2.814","5.977","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Listing #003","Property Listing #004","5.580","8.513","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Property Listing #004","Property Listing #005","5.255","6.281","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Listing #005","Property Listing #001","3.443","503","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":402},{"label":"Mar","value":522},{"label":"Abr","value":549},{"label":"Mai","value":709},{"label":"Jun","value":602},{"label":"Jul","value":355},{"label":"Ago","value":541},{"label":"Set","value":569},{"label":"Out","value":384},{"label":"Nov","value":504},{"label":"Dez","value":483}];
const MX = 709;
