...
const PAGE = "MLS Integration";
const KPIS = [{"l":"Integrações Ativas","v":"6.825","t":"+9.0%","d":"up"},{"l":"Chamadas/Hora","v":"1017","t":"+6.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.7%","t":"+15.7%","d":"up"},{"l":"Latência Média (ms)","v":"168ms","t":"+9.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.314","7.207","72.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.778","8.474","74.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.150","3.198","78.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.005","5.513","96.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","209","2.213","93.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":493},{"label":"Mar","value":720},{"label":"Abr","value":717},{"label":"Mai","value":593},{"label":"Jun","value":870},{"label":"Jul","value":633},{"label":"Ago","value":682},{"label":"Set","value":833},{"label":"Out","value":543},{"label":"Nov","value":877},{"label":"Dez","value":740}];
const MX = 877;
