...
const KPIS = [{"l":"Total Property Listing","v":"5.517","t":"+12.7%","d":"up"},{"l":"Virtual Tour Ativos","v":"5.741","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+2.1%","d":"up"}];
const COLS = ["ID","Virtual Tour","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Listing #001","Property Listing #002","1.709","8.939","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Property Listing #002","Property Listing #003","5.852","3.393","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Listing #003","Property Listing #004","1.329","514","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Property Listing #004","Property Listing #005","7.705","6.847","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Listing #005","Property Listing #001","4.683","7.143","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":316},{"label":"Mar","value":499},{"label":"Abr","value":299},{"label":"Mai","value":271},{"label":"Jun","value":457},{"label":"Jul","value":589},{"label":"Ago","value":297},{"label":"Set","value":317},{"label":"Out","value":513},{"label":"Nov","value":305},{"label":"Dez","value":509}];
const MX = 589;
