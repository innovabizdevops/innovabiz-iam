...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Tv Broadcast","v":"7.149","t":"+15.2%","d":"up"},{"l":"Schedule Ativos","v":"4.270","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"74.0%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"95","t":"+15.0%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tv Broadcast #001","Tv Broadcast #002","5.109","6.363","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Tv Broadcast #002","Tv Broadcast #003","4.325","2.978","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Tv Broadcast #003","Tv Broadcast #004","1.028","7.815","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Tv Broadcast #004","Tv Broadcast #005","6.691","5.130","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tv Broadcast #005","Tv Broadcast #001","7.453","6.836","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":757},{"label":"Mar","value":535},{"label":"Abr","value":733},{"label":"Mai","value":705},{"label":"Jun","value":608},{"label":"Jul","value":527},{"label":"Ago","value":565},{"label":"Set","value":643},{"label":"Out","value":790},{"label":"Nov","value":563},{"label":"Dez","value":512}];
const MX = 790;
