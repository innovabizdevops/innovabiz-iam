...
const ACCENT = "#6366f1";
const MODULE = "TV Broadcasting";
const PAGE = "Master Control";
const KPIS = [{"l":"Total Tv Broadcast","v":"6.513","t":"+14.2%","d":"up"},{"l":"Master Control Ativos","v":"6.514","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"85","t":"+9.3%","d":"up"}];
const COLS = ["ID","Master Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tv Broadcast #001","Tv Broadcast #002","1.763","7.788","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Tv Broadcast #002","Tv Broadcast #003","4.468","1.324","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Tv Broadcast #003","Tv Broadcast #004","601","8.265","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Tv Broadcast #004","Tv Broadcast #005","2.284","7.300","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tv Broadcast #005","Tv Broadcast #001","7.369","4.133","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":650},{"label":"Mar","value":374},{"label":"Abr","value":474},{"label":"Mai","value":371},{"label":"Jun","value":363},{"label":"Jul","value":644},{"label":"Ago","value":375},{"label":"Set","value":342},{"label":"Out","value":456},{"label":"Nov","value":278},{"label":"Dez","value":300}];
const MX = 650;
