...
const PAGE = "Bind Process";
const KPIS = [{"l":"Total Underwriting","v":"5.952","t":"+10.4%","d":"up"},{"l":"Bind Process Ativos","v":"6.508","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"87.0%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"83","t":"-1.7%","d":"down"}];
const COLS = ["ID","Bind Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting #001","Underwriting #002","4.737","5.777","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting #002","Underwriting #003","6.450","2.322","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting #003","Underwriting #004","6.680","7.555","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting #004","Underwriting #005","7.832","2.604","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting #005","Underwriting #001","8.953","3.276","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":775},{"label":"Mar","value":770},{"label":"Abr","value":768},{"label":"Mai","value":704},{"label":"Jun","value":650},{"label":"Jul","value":915},{"label":"Ago","value":617},{"label":"Set","value":710},{"label":"Out","value":723},{"label":"Nov","value":864},{"label":"Dez","value":799}];
const MX = 915;
