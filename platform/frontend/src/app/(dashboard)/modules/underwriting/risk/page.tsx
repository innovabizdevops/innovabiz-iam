...
const ACCENT = "#059669";
const MODULE = "Underwriting Engine";
const PAGE = "Risk Assessment";
const KPIS = [{"l":"Riscos Identificados","v":"6.129","t":"+5.6%","d":"up"},{"l":"Mitigações Ativas","v":"4.301","t":"+8.6%","d":"up"},{"l":"Score Risco Geral","v":"57","t":"+3.8%","d":"up"},{"l":"Incidentes YTD","v":"8.138","t":"-0.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.108","9.039","5.014","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.593","8.440","5.961","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.013","3.748","1.212","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","844","2.239","2.859","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.528","5.636","8.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":378},{"label":"Mar","value":415},{"label":"Abr","value":465},{"label":"Mai","value":416},{"label":"Jun","value":447},{"label":"Jul","value":240},{"label":"Ago","value":582},{"label":"Set","value":270},{"label":"Out","value":536},{"label":"Nov","value":600},{"label":"Dez","value":374}];
const MX = 600;
