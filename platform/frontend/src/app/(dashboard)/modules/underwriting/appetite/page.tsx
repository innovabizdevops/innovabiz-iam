...
const PAGE = "Appetite Guide";
const KPIS = [{"l":"Artigos Publicados","v":"2.577","t":"+8.7%","d":"up"},{"l":"Views/Semana","v":"4099","t":"+4.0%","d":"up"},{"l":"Feedback Útil (%)","v":"75.0%","t":"-0.6%","d":"down"},{"l":"Artigos Desatualizados","v":"1.902","t":"+8.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","6.113","92.6%","8.373","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.463","81.3%","2.839","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","2.774","72.3%","8.637","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.183","71.4%","6.192","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.737","98.2%","7.351","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":303},{"label":"Mar","value":496},{"label":"Abr","value":663},{"label":"Mai","value":470},{"label":"Jun","value":523},{"label":"Jul","value":321},{"label":"Ago","value":385},{"label":"Set","value":584},{"label":"Out","value":601},{"label":"Nov","value":383},{"label":"Dez","value":555}];
const MX = 663;
