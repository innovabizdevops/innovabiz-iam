...
const PAGE = "Telematics Score";
const KPIS = [{"l":"Total Underwriting","v":"4.990","t":"+5.4%","d":"up"},{"l":"Telematics Score Ativos","v":"91","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"73.2%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+8.6%","d":"up"}];
const COLS = ["ID","Telematics Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting #001","98.7%","5.886","5.868","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting #002","77.7%","6.157","1.529","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting #003","91.1%","655","3.395","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting #004","85.9%","8.858","8.593","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting #005","90.5%","9.003","6.569","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":500},{"label":"Mar","value":276},{"label":"Abr","value":444},{"label":"Mai","value":593},{"label":"Jun","value":418},{"label":"Jul","value":365},{"label":"Ago","value":347},{"label":"Set","value":346},{"label":"Out","value":260},{"label":"Nov","value":438},{"label":"Dez","value":622}];
const MX = 622;
