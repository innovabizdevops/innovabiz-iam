...
const KPIS = [
    { label: "Total Registos", value: "8485", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2771", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€448K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1294621485", cells: ["SUS-8485", "Sustainability Scorecard Item 1", "18/10/2026", "€21 585"], status: "active" as const },
    { id: "1294625056", cells: ["SUS-3056", "Sustainability Scorecard Item 2", "5/5/2026", "€25 156"], status: "pending" as const },
    { id: "1294628627", cells: ["SUS-6627", "Sustainability Scorecard Item 3", "20/12/2026", "€28 727"], status: "completed" as const },
    { id: "1294632198", cells: ["SUS-1198", "Sustainability Scorecard Item 4", "7/7/2026", "€32 298"], status: "warning" as const },
    { id: "1294635769", cells: ["SUS-4769", "Sustainability Scorecard Item 5", "22/2/2026", "€35 869"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sustainability Scorecard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sustainability Scorecard</p>
                    </div>
                </div>
