...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"4.761","t":"-0.3%","d":"down"},{"l":"Mitigações Ativas","v":"5.389","t":"+8.0%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"8.316","t":"-5.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.046","2.981","1.479","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.527","3.912","2.906","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","872","7.696","4.598","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.028","6.756","7.194","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.393","495","8.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":642},{"label":"Mar","value":559},{"label":"Abr","value":511},{"label":"Mai","value":588},{"label":"Jun","value":448},{"label":"Jul","value":687},{"label":"Ago","value":707},{"label":"Set","value":545},{"label":"Out","value":555},{"label":"Nov","value":324},{"label":"Dez","value":682}];
const MX = 707;
