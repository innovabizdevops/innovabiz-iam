...
const PAGE = "Buy";
const KPIS = [{"l":"Total Pai Propensity","v":"589","t":"+7.0%","d":"up"},{"l":"Buy Ativos","v":"7.256","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"81.1%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"57","t":"+5.2%","d":"up"}];
const COLS = ["ID","Buy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Propensity #001","Pai Propensity #002","5.434","1.044","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Propensity #002","Pai Propensity #003","5.057","2.639","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Propensity #003","Pai Propensity #004","4.895","4.253","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Propensity #004","Pai Propensity #005","3.546","6.915","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Propensity #005","Pai Propensity #001","1.996","7.523","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":572},{"label":"Mar","value":638},{"label":"Abr","value":397},{"label":"Mai","value":406},{"label":"Jun","value":357},{"label":"Jul","value":585},{"label":"Ago","value":251},{"label":"Set","value":378},{"label":"Out","value":297},{"label":"Nov","value":605},{"label":"Dez","value":496}];
const MX = 638;
