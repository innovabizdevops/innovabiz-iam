...
const PAGE = "Churn";
const KPIS = [{"l":"ARR (€M)","v":"€41.8M","t":"-3.9%","d":"down"},{"l":"MRR (€)","v":"€2553","t":"+2.2%","d":"up"},{"l":"Churn (%)","v":"75.4%","t":"+11.0%","d":"up"},{"l":"ARPU (€)","v":"€68743","t":"+5.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 40654.14","6.639","€ 28303.99","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11648.57","8.953","€ 47812.42","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17320.22","2.136","€ 20310.23","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42753.89","4.082","€ 15827.01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13405.98","5.426","€ 32986.60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":916},{"label":"Mar","value":868},{"label":"Abr","value":1054},{"label":"Mai","value":697},{"label":"Jun","value":832},{"label":"Jul","value":794},{"label":"Ago","value":769},{"label":"Set","value":965},{"label":"Out","value":1060},{"label":"Nov","value":953},{"label":"Dez","value":729}];
const MX = 1060;
