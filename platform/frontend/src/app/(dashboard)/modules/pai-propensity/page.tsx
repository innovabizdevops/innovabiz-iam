...
/* ═══ P-AI Propensity Models — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "8619", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1114", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€337K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "522619619", cells: ["PAI-8619", "P-AI Propensity Models Item 1", "12/12/2026", "€19 719"], status: "active" as const },
    { id: "522623190", cells: ["PAI-3190", "P-AI Propensity Models Item 2", "27/7/2026", "€23 290"], status: "pending" as const },
    { id: "522626761", cells: ["PAI-6761", "P-AI Propensity Models Item 3", "14/2/2026", "€26 861"], status: "completed" as const },
    { id: "522630332", cells: ["PAI-1332", "P-AI Propensity Models Item 4", "1/9/2026", "€30 432"], status: "warning" as const },
    { id: "522633903", cells: ["PAI-4903", "P-AI Propensity Models Item 5", "16/4/2026", "€34 003"], status: "active" as const },
];
...
export default function PaiPropensityModelsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Propensity Models</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Propensity Models</p>
                    </div>
                </div>
