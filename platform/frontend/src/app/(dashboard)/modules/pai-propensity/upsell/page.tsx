...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Propensity Models";
const PAGE = "Upsell";
const KPIS = [{"l":"Total Pai Propensity","v":"7.798","t":"-2.1%","d":"down"},{"l":"Upsell Ativos","v":"4.013","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"63","t":"+3.8%","d":"up"}];
const COLS = ["ID","Upsell","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pai Propensity #001","Pai Propensity #002","2.378","2.592","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Pai Propensity #002","Pai Propensity #003","1.954","3.969","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Pai Propensity #003","Pai Propensity #004","619","4.924","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pai Propensity #004","Pai Propensity #005","8.755","7.241","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pai Propensity #005","Pai Propensity #001","6.244","8.339","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":224},{"label":"Mar","value":448},{"label":"Abr","value":425},{"label":"Mai","value":523},{"label":"Jun","value":261},{"label":"Jul","value":222},{"label":"Ago","value":255},{"label":"Set","value":392},{"label":"Out","value":493},{"label":"Nov","value":530},{"label":"Dez","value":300}];
const MX = 530;
