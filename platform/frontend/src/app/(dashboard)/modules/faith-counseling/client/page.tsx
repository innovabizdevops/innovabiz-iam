...
const PAGE = "Client";
const KPIS = [{"l":"Total Faith Counseling","v":"4.918","t":"+1.8%","d":"up"},{"l":"Client Ativos","v":"8.744","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"91","t":"+3.8%","d":"up"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Counseling #001","Faith Counseling #002","8.692","5.459","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Counseling #002","Faith Counseling #003","288","7.982","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Counseling #003","Faith Counseling #004","3.742","6.793","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Counseling #004","Faith Counseling #005","1.271","1.350","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Counseling #005","Faith Counseling #001","4.207","7.805","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":514},{"label":"Mar","value":445},{"label":"Abr","value":785},{"label":"Mai","value":567},{"label":"Jun","value":504},{"label":"Jul","value":557},{"label":"Ago","value":540},{"label":"Set","value":549},{"label":"Out","value":603},{"label":"Nov","value":805},{"label":"Dez","value":574}];
const MX = 805;
