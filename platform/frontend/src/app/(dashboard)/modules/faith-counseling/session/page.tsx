...
const PAGE = "Session";
const KPIS = [{"l":"Total Faith Counseling","v":"1.023","t":"+13.7%","d":"up"},{"l":"Session Ativos","v":"1.590","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"85","t":"+1.2%","d":"up"}];
const COLS = ["ID","Session","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Counseling #001","Faith Counseling #002","3.994","2.813","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Counseling #002","Faith Counseling #003","1.803","2.133","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Counseling #003","Faith Counseling #004","2.181","3.265","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Counseling #004","Faith Counseling #005","8.178","4.508","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Counseling #005","Faith Counseling #001","1.399","5.307","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":620},{"label":"Mar","value":642},{"label":"Abr","value":674},{"label":"Mai","value":727},{"label":"Jun","value":665},{"label":"Jul","value":706},{"label":"Ago","value":730},{"label":"Set","value":735},{"label":"Out","value":850},{"label":"Nov","value":912},{"label":"Dez","value":589}];
const MX = 912;
