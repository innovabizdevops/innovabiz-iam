...
const ACCENT = "#6d28d9";
const MODULE = "Faith-Based Counseling";
const PAGE = "Group";
const KPIS = [{"l":"Total Faith Counseling","v":"1.593","t":"-5.4%","d":"down"},{"l":"Group Ativos","v":"161","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"66","t":"+15.0%","d":"up"}];
const COLS = ["ID","Group","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Counseling #001","Faith Counseling #002","4.373","4.986","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Counseling #002","Faith Counseling #003","6.408","7.398","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Counseling #003","Faith Counseling #004","8.784","5.756","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Counseling #004","Faith Counseling #005","2.370","3.395","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Counseling #005","Faith Counseling #001","8.298","2.379","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":867},{"label":"Mar","value":1059},{"label":"Abr","value":936},{"label":"Mai","value":1059},{"label":"Jun","value":1048},{"label":"Jul","value":794},{"label":"Ago","value":800},{"label":"Set","value":911},{"label":"Out","value":1076},{"label":"Nov","value":732},{"label":"Dez","value":1015}];
const MX = 1076;
