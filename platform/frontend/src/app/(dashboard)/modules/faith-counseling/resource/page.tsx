...
const PAGE = "Resource";
const KPIS = [{"l":"Total Faith Counseling","v":"1.454","t":"-4.1%","d":"down"},{"l":"Resource Ativos","v":"6.485","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.5%","d":"up"}];
const COLS = ["ID","Resource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Counseling #001","Faith Counseling #002","3.344","6.195","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Counseling #002","Faith Counseling #003","5.940","853","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Counseling #003","Faith Counseling #004","309","5.822","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Counseling #004","Faith Counseling #005","8.335","7.286","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Counseling #005","Faith Counseling #001","1.477","2.518","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":541},{"label":"Mar","value":571},{"label":"Abr","value":624},{"label":"Mai","value":646},{"label":"Jun","value":393},{"label":"Jul","value":475},{"label":"Ago","value":507},{"label":"Set","value":686},{"label":"Out","value":428},{"label":"Nov","value":649},{"label":"Dez","value":474}];
const MX = 686;
