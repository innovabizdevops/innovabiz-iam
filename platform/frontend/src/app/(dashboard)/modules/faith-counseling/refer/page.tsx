...
const PAGE = "Refer";
const KPIS = [{"l":"Total Faith Counseling","v":"8.442","t":"+10.3%","d":"up"},{"l":"Refer Ativos","v":"939","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"87.6%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"55","t":"+2.1%","d":"up"}];
const COLS = ["ID","Refer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Counseling #001","Faith Counseling #002","5.363","7.608","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Counseling #002","Faith Counseling #003","6.045","5.764","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Counseling #003","Faith Counseling #004","8.066","8.345","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Counseling #004","Faith Counseling #005","7.985","260","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Counseling #005","Faith Counseling #001","5.300","4.119","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":687},{"label":"Mar","value":888},{"label":"Abr","value":613},{"label":"Mai","value":516},{"label":"Jun","value":635},{"label":"Jul","value":575},{"label":"Ago","value":554},{"label":"Set","value":548},{"label":"Out","value":779},{"label":"Nov","value":714},{"label":"Dez","value":682}];
const MX = 888;
