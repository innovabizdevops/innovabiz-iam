...
/* ═══ Faith-Based Counseling — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "5403", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1289", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€41K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "821923103", cells: ["FAI-8103", "Faith-Based Counseling Item 1", "16/12/2026", "€23 203"], status: "active" as const },
    { id: "821926674", cells: ["FAI-2674", "Faith-Based Counseling Item 2", "3/7/2026", "€26 774"], status: "pending" as const },
    { id: "821930245", cells: ["FAI-6245", "Faith-Based Counseling Item 3", "18/2/2026", "€30 345"], status: "completed" as const },
    { id: "821933816", cells: ["FAI-9816", "Faith-Based Counseling Item 4", "5/9/2026", "€33 916"], status: "warning" as const },
    { id: "821937387", cells: ["FAI-4387", "Faith-Based Counseling Item 5", "20/4/2026", "€37 487"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Faith-Based Counseling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Faith-Based Counseling</p>
                    </div>
                </div>
