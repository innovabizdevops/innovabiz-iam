...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"1.405","t":"-0.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"90.6%","t":"+2.0%","d":"up"},{"l":"MTTR (h)","v":"77h","t":"+15.5%","d":"up"},{"l":"Satisfação (%)","v":"92.6%","t":"-4.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.519","8.752","3.575","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.966","511","443","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.944","5.956","8.816","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.431","5.625","3.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.344","3.628","6.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":400},{"label":"Mar","value":582},{"label":"Abr","value":310},{"label":"Mai","value":415},{"label":"Jun","value":490},{"label":"Jul","value":614},{"label":"Ago","value":476},{"label":"Set","value":284},{"label":"Out","value":547},{"label":"Nov","value":572},{"label":"Dez","value":567}];
const MX = 624;
