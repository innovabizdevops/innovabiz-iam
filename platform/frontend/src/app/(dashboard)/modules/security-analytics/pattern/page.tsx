...
const PAGE = "Pattern";
const KPIS = [{"l":"Dashboards Ativos","v":"2.614","t":"-0.7%","d":"down"},{"l":"Queries/Dia","v":"693","t":"+5.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.696","t":"-5.3%","d":"down"},{"l":"Utilizadores Analytics","v":"3.134","t":"+7.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1616","2026-03-15","3.077","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4830","2026-03-20","2.723","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5001","2026-01-13","5.519","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","244","2026-03-28","2.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4896","2026-03-08","7.756","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":739},{"label":"Mar","value":379},{"label":"Abr","value":647},{"label":"Mai","value":703},{"label":"Jun","value":621},{"label":"Jul","value":398},{"label":"Ago","value":499},{"label":"Set","value":374},{"label":"Out","value":395},{"label":"Nov","value":455},{"label":"Dez","value":578}];
const MX = 739;
