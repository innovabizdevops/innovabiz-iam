...
const PAGE = "Response";
const KPIS = [{"l":"Dashboards Ativos","v":"5.058","t":"-1.5%","d":"down"},{"l":"Queries/Dia","v":"4328","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"2.190","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"6.611","t":"+10.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1694","2026-01-27","3.518","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2606","2026-01-05","578","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2756","2026-02-24","600","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2429","2026-03-28","4.756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4179","2026-01-09","403","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":935},{"label":"Mar","value":689},{"label":"Abr","value":746},{"label":"Mai","value":966},{"label":"Jun","value":973},{"label":"Jul","value":656},{"label":"Ago","value":750},{"label":"Set","value":612},{"label":"Out","value":775},{"label":"Nov","value":793},{"label":"Dez","value":596}];
const MX = 973;
