...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"7.428","t":"+14.9%","d":"up"},{"l":"Queries/Dia","v":"4952","t":"+7.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.378","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"4.905","t":"-1.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3544","2026-02-07","4.638","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3549","2026-02-26","3.702","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3561","2026-02-11","6.994","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","679","2026-03-03","1.968","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4313","2026-02-28","4.775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1011},{"label":"Fev","value":1077},{"label":"Mar","value":755},{"label":"Abr","value":722},{"label":"Mai","value":856},{"label":"Jun","value":1080},{"label":"Jul","value":764},{"label":"Ago","value":737},{"label":"Set","value":991},{"label":"Out","value":977},{"label":"Nov","value":1022},{"label":"Dez","value":765}];
const MX = 1080;
