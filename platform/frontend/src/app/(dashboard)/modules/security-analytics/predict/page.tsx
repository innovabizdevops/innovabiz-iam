...
const ACCENT = "#6366f1";
const MODULE = "Security Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"218","t":"+17.8%","d":"up"},{"l":"Queries/Dia","v":"1182","t":"-2.1%","d":"down"},{"l":"Dados Processados (GB)","v":"7.233","t":"-1.0%","d":"down"},{"l":"Utilizadores Analytics","v":"3.314","t":"+13.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","136","2026-01-28","4.561","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4441","2026-03-05","6.656","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","330","2026-03-06","5.080","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","462","2026-03-03","1.928","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2769","2026-01-03","1.109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":722},{"label":"Mar","value":631},{"label":"Abr","value":795},{"label":"Mai","value":422},{"label":"Jun","value":765},{"label":"Jul","value":491},{"label":"Ago","value":781},{"label":"Set","value":632},{"label":"Out","value":676},{"label":"Nov","value":524},{"label":"Dez","value":513}];
const MX = 795;
