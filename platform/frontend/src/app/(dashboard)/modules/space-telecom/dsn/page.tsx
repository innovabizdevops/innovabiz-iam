...
const PAGE = "Deep Space Net";
const KPIS = [{"l":"Quartos Ocupados","v":"5.214","t":"-1.5%","d":"down"},{"l":"RevPAR (€)","v":"€5488","t":"+7.0%","d":"up"},{"l":"Ocupação (%)","v":"88.3%","t":"+10.9%","d":"up"},{"l":"Guest Satisfaction","v":"3.454","t":"-0.1%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.357","2026-03-02","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.136","2026-03-09","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","9.036","2026-01-03","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.360","2026-03-07","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.628","2026-03-10","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":679},{"label":"Mar","value":655},{"label":"Abr","value":597},{"label":"Mai","value":524},{"label":"Jun","value":494},{"label":"Jul","value":779},{"label":"Ago","value":432},{"label":"Set","value":505},{"label":"Out","value":679},{"label":"Nov","value":672},{"label":"Dez","value":524}];
const MX = 779;
