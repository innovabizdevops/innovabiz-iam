...
const ACCENT = "#ec4899";
const MODULE = "Space Telecom";
const PAGE = "Quantum Key";
const KPIS = [{"l":"Quartos Ocupados","v":"8.028","t":"+2.4%","d":"up"},{"l":"RevPAR (€)","v":"€6544","t":"-1.0%","d":"down"},{"l":"Ocupação (%)","v":"68.7%","t":"+15.0%","d":"up"},{"l":"Guest Satisfaction","v":"7.281","t":"+15.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.865","2026-01-15","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.146","2026-03-02","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.759","2026-01-25","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.816","2026-02-01","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.508","2026-01-28","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":780},{"label":"Mar","value":809},{"label":"Abr","value":786},{"label":"Mai","value":952},{"label":"Jun","value":834},{"label":"Jul","value":1049},{"label":"Ago","value":790},{"label":"Set","value":722},{"label":"Out","value":846},{"label":"Nov","value":991},{"label":"Dez","value":834}];
const MX = 1049;
