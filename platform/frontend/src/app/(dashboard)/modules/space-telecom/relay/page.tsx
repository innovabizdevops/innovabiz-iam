...
const PAGE = "Relay";
const KPIS = [{"l":"Quartos Ocupados","v":"1.083","t":"+4.2%","d":"up"},{"l":"RevPAR (€)","v":"€8796","t":"+6.8%","d":"up"},{"l":"Ocupação (%)","v":"71.1%","t":"+1.1%","d":"up"},{"l":"Guest Satisfaction","v":"6.043","t":"+16.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.389","2026-02-05","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.747","2026-01-03","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.932","2026-02-20","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.218","2026-02-19","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.398","2026-01-03","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":839},{"label":"Mar","value":826},{"label":"Abr","value":771},{"label":"Mai","value":901},{"label":"Jun","value":585},{"label":"Jul","value":906},{"label":"Ago","value":646},{"label":"Set","value":697},{"label":"Out","value":824},{"label":"Nov","value":769},{"label":"Dez","value":912}];
const MX = 912;
