...
const PAGE = "Fleet";
const KPIS = [{"l":"Formulários Ativos","v":"7.444","t":"+17.9%","d":"up"},{"l":"Submissões/Dia","v":"4899","t":"+12.1%","d":"up"},{"l":"Documentos Gerados","v":"2.562","t":"+12.7%","d":"up"},{"l":"Templates","v":"6.595","t":"+3.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.879","2026-01-18","6.096","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.071","2026-02-02","3.581","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.557","2026-01-25","4.864","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.022","2026-03-07","5.743","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.154","2026-02-13","3.526","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":512},{"label":"Mar","value":786},{"label":"Abr","value":616},{"label":"Mai","value":830},{"label":"Jun","value":605},{"label":"Jul","value":565},{"label":"Ago","value":712},{"label":"Set","value":555},{"label":"Out","value":451},{"label":"Nov","value":781},{"label":"Dez","value":499}];
const MX = 830;
