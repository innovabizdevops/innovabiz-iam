...
const KPIS = [{"l":"Formulários Ativos","v":"1.107","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"4786","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"1.588","t":"-1.5%","d":"down"},{"l":"Templates","v":"2.021","t":"-5.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.713","2026-01-14","4.891","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.162","2026-03-04","938","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.466","2026-02-22","547","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.423","2026-02-22","5.383","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","650","2026-03-08","7.050","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":690},{"label":"Mar","value":721},{"label":"Abr","value":604},{"label":"Mai","value":880},{"label":"Jun","value":607},{"label":"Jul","value":918},{"label":"Ago","value":744},{"label":"Set","value":866},{"label":"Out","value":708},{"label":"Nov","value":895},{"label":"Dez","value":636}];
const MX = 932;
