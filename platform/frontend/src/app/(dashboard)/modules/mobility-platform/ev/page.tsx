...
const PAGE = "EV";
const KPIS = [{"l":"Formulários Ativos","v":"806","t":"+7.9%","d":"up"},{"l":"Submissões/Dia","v":"3615","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"6.959","t":"-0.4%","d":"down"},{"l":"Templates","v":"6.107","t":"-0.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.555","2026-01-08","5.787","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.921","2026-02-14","774","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","662","2026-02-23","1.192","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.138","2026-03-03","7.155","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","449","2026-01-06","2.562","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":227},{"label":"Fev","value":584},{"label":"Mar","value":213},{"label":"Abr","value":366},{"label":"Mai","value":493},{"label":"Jun","value":332},{"label":"Jul","value":587},{"label":"Ago","value":386},{"label":"Set","value":245},{"label":"Out","value":236},{"label":"Nov","value":382},{"label":"Dez","value":528}];
const MX = 587;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#06b6d4'}}>IoT</span></h1>
                </div>
