...
const PAGE = "MaaS";
const KPIS = [{"l":"Formulários Ativos","v":"5.312","t":"-4.7%","d":"down"},{"l":"Submissões/Dia","v":"745","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"2.632","t":"+1.6%","d":"up"},{"l":"Templates","v":"4.113","t":"-4.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.028","2026-01-19","2.987","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.209","2026-03-28","1.724","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.909","2026-01-22","4.269","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.708","2026-01-28","7.293","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.000","2026-02-08","4.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":505},{"label":"Mar","value":736},{"label":"Abr","value":754},{"label":"Mai","value":646},{"label":"Jun","value":736},{"label":"Jul","value":648},{"label":"Ago","value":722},{"label":"Set","value":826},{"label":"Out","value":615},{"label":"Nov","value":586},{"label":"Dez","value":667}];
const MX = 826;
