...
/* ═══ Mobility Platform — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "3512", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3614", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€187K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1708862212", cells: ["MOB-6212", "Mobility Platform Item 1", "9/5/2026", "€12 312"], status: "active" as const },
    { id: "1708865783", cells: ["MOB-9783", "Mobility Platform Item 2", "24/12/2026", "€15 883"], status: "pending" as const },
    { id: "1708869354", cells: ["MOB-4354", "Mobility Platform Item 3", "11/7/2026", "€19 454"], status: "completed" as const },
    { id: "1708872925", cells: ["MOB-7925", "Mobility Platform Item 4", "26/2/2026", "€23 025"], status: "warning" as const },
    { id: "1708876496", cells: ["MOB-2496", "Mobility Platform Item 5", "13/9/2026", "€26 596"], status: "active" as const },
];
...
export default function MobilityPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mobility Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mobility Platform</p>
                    </div>
                </div>
