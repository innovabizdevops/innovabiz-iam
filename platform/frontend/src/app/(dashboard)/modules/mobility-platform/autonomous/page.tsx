...
const ACCENT = "#06b6d4";
const MODULE = "Mobility Platform";
const PAGE = "Autonomous";
const KPIS = [{"l":"Formulários Ativos","v":"8.953","t":"+16.3%","d":"up"},{"l":"Submissões/Dia","v":"2656","t":"+11.1%","d":"up"},{"l":"Documentos Gerados","v":"6.038","t":"-2.3%","d":"down"},{"l":"Templates","v":"6.867","t":"+1.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.220","2026-01-09","4.854","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.031","2026-03-14","169","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.538","2026-02-28","1.407","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.655","2026-03-01","8.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.779","2026-03-13","3.079","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":745},{"label":"Mar","value":663},{"label":"Abr","value":674},{"label":"Mai","value":842},{"label":"Jun","value":919},{"label":"Jul","value":799},{"label":"Ago","value":898},{"label":"Set","value":830},{"label":"Out","value":1028},{"label":"Nov","value":1009},{"label":"Dez","value":842}];
const MX = 1028;
