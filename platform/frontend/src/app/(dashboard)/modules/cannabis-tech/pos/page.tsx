...
const PAGE = "POS Tech";
const KPIS = [{"l":"Pedidos/Dia","v":"3746","t":"+15.9%","d":"up"},{"l":"GMV (€)","v":"€99672","t":"-1.6%","d":"down"},{"l":"Conversão (%)","v":"70.9%","t":"+8.6%","d":"up"},{"l":"AOV (€)","v":"€4153","t":"-3.8%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 32296.47","3.887","173","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 14562.95","4.942","6.563","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 22050.15","5.923","5.331","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 11081.60","4.657","9.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 48610.35","3.734","1.691","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":783},{"label":"Mar","value":488},{"label":"Abr","value":579},{"label":"Mai","value":763},{"label":"Jun","value":536},{"label":"Jul","value":473},{"label":"Ago","value":747},{"label":"Set","value":787},{"label":"Out","value":484},{"label":"Nov","value":450},{"label":"Dez","value":644}];
const MX = 787;
