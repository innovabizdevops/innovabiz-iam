...
const ACCENT = "#166534";
const MODULE = "Cannabis Technology";
const PAGE = "Grow Tech";
const KPIS = [{"l":"Total Cannabis Tech","v":"6.884","t":"+1.1%","d":"up"},{"l":"Grow Tech Ativos","v":"4.546","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"67.3%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"90","t":"+13.4%","d":"up"}];
const COLS = ["ID","Grow Tech","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Tech #001","Cannabis Tech #002","4.428","5.728","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Tech #002","Cannabis Tech #003","609","2.964","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Tech #003","Cannabis Tech #004","2.858","6.128","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Tech #004","Cannabis Tech #005","2.234","1.033","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Tech #005","Cannabis Tech #001","5.799","3.836","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":678},{"label":"Mar","value":965},{"label":"Abr","value":672},{"label":"Mai","value":815},{"label":"Jun","value":912},{"label":"Jul","value":680},{"label":"Ago","value":942},{"label":"Set","value":652},{"label":"Out","value":753},{"label":"Nov","value":655},{"label":"Dez","value":874}];
const MX = 965;
