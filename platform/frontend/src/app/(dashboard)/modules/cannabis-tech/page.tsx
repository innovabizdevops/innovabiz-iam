...
/* ═══ Cannabis Technology — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "9245", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "855", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€213K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "284950945", cells: ["CAN-2945", "Cannabis Technology Item 1", "14/2/2026", "€1045"], status: "active" as const },
    { id: "284954516", cells: ["CAN-6516", "Cannabis Technology Item 2", "1/9/2026", "€4616"], status: "pending" as const },
    { id: "284958087", cells: ["CAN-1087", "Cannabis Technology Item 3", "16/4/2026", "€8187"], status: "completed" as const },
    { id: "284961658", cells: ["CAN-4658", "Cannabis Technology Item 4", "3/11/2026", "€11 758"], status: "warning" as const },
    { id: "284965229", cells: ["CAN-8229", "Cannabis Technology Item 5", "18/6/2026", "€15 329"], status: "active" as const },
];
...
export default function CannabisTechnologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Technology</p>
                    </div>
                </div>
