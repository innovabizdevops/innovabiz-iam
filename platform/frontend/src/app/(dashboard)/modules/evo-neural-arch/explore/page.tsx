...
const ACCENT = "#059669";
const MODULE = "EVO Neural Architecture Search";
const PAGE = "Explore";
const KPIS = [{"l":"Total Evo Neural Arch","v":"6.066","t":"+0.0%","d":"up"},{"l":"Explore Ativos","v":"763","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+0.0%","d":"up"}];
const COLS = ["ID","Explore","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Evo Neural Arch #001","Evo Neural Arch #002","7.241","153","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Evo Neural Arch #002","Evo Neural Arch #003","6.700","4.280","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Evo Neural Arch #003","Evo Neural Arch #004","1.901","3.224","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Evo Neural Arch #004","Evo Neural Arch #005","6.120","8.381","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Evo Neural Arch #005","Evo Neural Arch #001","1.387","106","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":928},{"label":"Mar","value":907},{"label":"Abr","value":614},{"label":"Mai","value":685},{"label":"Jun","value":828},{"label":"Jul","value":643},{"label":"Ago","value":786},{"label":"Set","value":687},{"label":"Out","value":900},{"label":"Nov","value":747},{"label":"Dez","value":968}];
const MX = 983;
