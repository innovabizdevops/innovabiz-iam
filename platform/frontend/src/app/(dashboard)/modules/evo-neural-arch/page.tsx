...
/* ═══ EVO Neural Architecture Search — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "9232", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "679", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€463K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1720589532", cells: ["EVO-6532", "EVO Neural Architecture Search Item 1", "5/1/2026", "€39 632"], status: "active" as const },
    { id: "1720593103", cells: ["EVO-1103", "EVO Neural Architecture Search Item 2", "20/8/2026", "€43 203"], status: "pending" as const },
    { id: "1720596674", cells: ["EVO-4674", "EVO Neural Architecture Search Item 3", "7/3/2026", "€46 774"], status: "completed" as const },
    { id: "1720600245", cells: ["EVO-8245", "EVO Neural Architecture Search Item 4", "22/10/2026", "€345"], status: "warning" as const },
    { id: "1720603816", cells: ["EVO-2816", "EVO Neural Architecture Search Item 5", "9/5/2026", "€3916"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 32 }, { label: "Fev", value: 41 }, { label: "Mar", value: 50 }, { label: "Abr", value: 59 }, { label: "Mai", value: 68 }, { label: "Jun", value: 77 }];
...
export default function EvoNeuralArchitectureSearchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EVO Neural Architecture Search</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EVO Neural Architecture Search</p>
                    </div>
                </div>
