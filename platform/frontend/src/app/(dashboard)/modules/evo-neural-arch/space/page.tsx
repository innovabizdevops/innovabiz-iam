...
const PAGE = "Search Space";
const KPIS = [{"l":"Quartos Ocupados","v":"1.734","t":"+16.9%","d":"up"},{"l":"RevPAR (€)","v":"€92900","t":"+2.5%","d":"up"},{"l":"Ocupação (%)","v":"88.4%","t":"+5.0%","d":"up"},{"l":"Guest Satisfaction","v":"4.331","t":"-0.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.100","2026-01-21","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.952","2026-01-05","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.778","2026-03-07","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","289","2026-02-11","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","152","2026-03-27","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1067},{"label":"Fev","value":950},{"label":"Mar","value":890},{"label":"Abr","value":1080},{"label":"Mai","value":790},{"label":"Jun","value":868},{"label":"Jul","value":969},{"label":"Ago","value":1044},{"label":"Set","value":702},{"label":"Out","value":827},{"label":"Nov","value":808},{"label":"Dez","value":777}];
const MX = 1080;
