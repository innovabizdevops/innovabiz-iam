...
const KPIS = [{"l":"Total Timeshare","v":"8.875","t":"+10.3%","d":"up"},{"l":"Ownership Ativos","v":"920","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"80","t":"-0.6%","d":"down"}];
const COLS = ["ID","Ownership","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timeshare #001","Timeshare #002","8.007","6.569","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Timeshare #002","Timeshare #003","1.703","5.205","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Timeshare #003","Timeshare #004","7.322","5.429","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Timeshare #004","Timeshare #005","1.306","6.785","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timeshare #005","Timeshare #001","4.087","5.361","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":836},{"label":"Mar","value":911},{"label":"Abr","value":887},{"label":"Mai","value":707},{"label":"Jun","value":699},{"label":"Jul","value":610},{"label":"Ago","value":797},{"label":"Set","value":632},{"label":"Out","value":690},{"label":"Nov","value":944},{"label":"Dez","value":708}];
const MX = 944;
