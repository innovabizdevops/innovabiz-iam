...
const PAGE = "Exchange";
const KPIS = [{"l":"Total Timeshare","v":"5.799","t":"-1.4%","d":"down"},{"l":"Exchange Ativos","v":"8.737","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+8.8%","d":"up"}];
const COLS = ["ID","Exchange","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timeshare #001","Timeshare #002","6.252","3.460","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Timeshare #002","Timeshare #003","5.250","7.704","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Timeshare #003","Timeshare #004","3.330","2.676","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Timeshare #004","Timeshare #005","4.424","6.472","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timeshare #005","Timeshare #001","2.443","5.655","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":510},{"label":"Mar","value":557},{"label":"Abr","value":783},{"label":"Mai","value":783},{"label":"Jun","value":466},{"label":"Jul","value":502},{"label":"Ago","value":690},{"label":"Set","value":466},{"label":"Out","value":548},{"label":"Nov","value":725},{"label":"Dez","value":729}];
const MX = 783;
