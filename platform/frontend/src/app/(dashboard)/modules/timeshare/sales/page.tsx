...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€81348","t":"+9.7%","d":"up"},{"l":"Pipeline (€)","v":"€29066","t":"+5.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"79.1%","t":"+4.2%","d":"up"},{"l":"Win Rate (%)","v":"78.3%","t":"+10.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7765.56","€ 46945.70","€ 12118.42","84.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 43878.72","€ 40540.82","€ 41815.12","86.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 1762.46","€ 2312.49","€ 43463.64","77.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 19934.83","€ 43177.57","€ 4517.63","84.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 19740.18","€ 41096.22","€ 5822.23","76.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":723},{"label":"Mar","value":663},{"label":"Abr","value":432},{"label":"Mai","value":633},{"label":"Jun","value":737},{"label":"Jul","value":663},{"label":"Ago","value":640},{"label":"Set","value":720},{"label":"Out","value":594},{"label":"Nov","value":614},{"label":"Dez","value":572}];
const MX = 737;
