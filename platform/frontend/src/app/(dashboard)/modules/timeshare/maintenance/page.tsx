...
const KPIS = [{"l":"Total Timeshare","v":"2.447","t":"+6.4%","d":"up"},{"l":"Maintenance Ativos","v":"8.801","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"87.5%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"61","t":"+7.3%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timeshare #001","Timeshare #002","8.069","1.681","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Timeshare #002","Timeshare #003","1.550","245","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Timeshare #003","Timeshare #004","6.760","3.580","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Timeshare #004","Timeshare #005","6.149","3.219","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timeshare #005","Timeshare #001","1.893","5.691","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":657},{"label":"Mar","value":606},{"label":"Abr","value":553},{"label":"Mai","value":539},{"label":"Jun","value":689},{"label":"Jul","value":647},{"label":"Ago","value":583},{"label":"Set","value":641},{"label":"Out","value":472},{"label":"Nov","value":659},{"label":"Dez","value":715}];
const MX = 715;
