...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"961","t":"+0.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"89.4%","t":"+2.6%","d":"up"},{"l":"Taxa Abertura (%)","v":"85.7%","t":"-0.5%","d":"down"},{"l":"Escalações","v":"2.162","t":"+17.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.969","79.5%","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.365","83.3%","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.360","97.6%","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.293","92.9%","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.747","84.6%","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":522},{"label":"Mar","value":434},{"label":"Abr","value":739},{"label":"Mai","value":404},{"label":"Jun","value":397},{"label":"Jul","value":390},{"label":"Ago","value":396},{"label":"Set","value":692},{"label":"Out","value":548},{"label":"Nov","value":527},{"label":"Dez","value":758}];
const MX = 758;
