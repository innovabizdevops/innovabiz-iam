...
const PAGE = "Cluster";
const KPIS = [{"l":"Total Neura Detect","v":"8.462","t":"+9.6%","d":"up"},{"l":"Cluster Ativos","v":"7.312","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.4%","d":"up"}];
const COLS = ["ID","Cluster","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neura Detect #001","Neura Detect #002","5.151","1.462","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Neura Detect #002","Neura Detect #003","6.532","6.631","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Neura Detect #003","Neura Detect #004","789","3.661","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Neura Detect #004","Neura Detect #005","4.396","519","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neura Detect #005","Neura Detect #001","4.780","1.972","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":708},{"label":"Mar","value":616},{"label":"Abr","value":628},{"label":"Mai","value":793},{"label":"Jun","value":878},{"label":"Jul","value":860},{"label":"Ago","value":632},{"label":"Set","value":881},{"label":"Out","value":677},{"label":"Nov","value":524},{"label":"Dez","value":693}];
const MX = 881;
