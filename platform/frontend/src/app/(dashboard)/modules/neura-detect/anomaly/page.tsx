...
const PAGE = "Anomaly";
const KPIS = [{"l":"Total Neura Detect","v":"407","t":"-2.2%","d":"down"},{"l":"Anomaly Ativos","v":"5.616","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"77.0%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+14.8%","d":"up"}];
const COLS = ["ID","Anomaly","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neura Detect #001","Neura Detect #002","1.783","527","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Neura Detect #002","Neura Detect #003","4.425","7.473","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Neura Detect #003","Neura Detect #004","7.672","6.550","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Neura Detect #004","Neura Detect #005","2.611","320","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neura Detect #005","Neura Detect #001","4.388","751","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":633},{"label":"Mar","value":927},{"label":"Abr","value":731},{"label":"Mai","value":907},{"label":"Jun","value":873},{"label":"Jul","value":874},{"label":"Ago","value":963},{"label":"Set","value":975},{"label":"Out","value":737},{"label":"Nov","value":878},{"label":"Dez","value":588}];
const MX = 975;
