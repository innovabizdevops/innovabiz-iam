...
const PAGE = "Trend";
const KPIS = [{"l":"Total Neura Detect","v":"8.493","t":"+2.7%","d":"up"},{"l":"Trend Ativos","v":"7.359","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"89.6%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"83","t":"-2.5%","d":"down"}];
const COLS = ["ID","Trend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neura Detect #001","Neura Detect #002","5.112","7.790","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Neura Detect #002","Neura Detect #003","4.859","3.948","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Neura Detect #003","Neura Detect #004","2.643","1.923","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Neura Detect #004","Neura Detect #005","7.695","5.584","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neura Detect #005","Neura Detect #001","2.141","8.037","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":268},{"label":"Mar","value":313},{"label":"Abr","value":373},{"label":"Mai","value":524},{"label":"Jun","value":440},{"label":"Jul","value":441},{"label":"Ago","value":626},{"label":"Set","value":496},{"label":"Out","value":549},{"label":"Nov","value":551},{"label":"Dez","value":638}];
const MX = 649;
