...
const ACCENT = "#4c1d95";
const MODULE = "NEURA Pattern Detection";
const PAGE = "Sequence";
const KPIS = [{"l":"Total Neura Detect","v":"3.791","t":"-4.0%","d":"down"},{"l":"Sequence Ativos","v":"8.871","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"92","t":"-0.3%","d":"down"}];
const COLS = ["ID","Sequence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neura Detect #001","Neura Detect #002","5.881","3.937","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Neura Detect #002","Neura Detect #003","5.312","2.455","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Neura Detect #003","Neura Detect #004","2.022","7.927","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Neura Detect #004","Neura Detect #005","4.891","579","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neura Detect #005","Neura Detect #001","3.358","1.411","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":896},{"label":"Mar","value":641},{"label":"Abr","value":680},{"label":"Mai","value":938},{"label":"Jun","value":849},{"label":"Jul","value":833},{"label":"Ago","value":1003},{"label":"Set","value":815},{"label":"Out","value":719},{"label":"Nov","value":969},{"label":"Dez","value":753}];
const MX = 1003;
