...
/* ═══ NEURA Pattern Detection — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "9086", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3769", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€452K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2143200586", cells: ["NEU-4586", "NEURA Pattern Detection Item 1", "3/11/2026", "€686"], status: "active" as const },
    { id: "2143204157", cells: ["NEU-8157", "NEURA Pattern Detection Item 2", "18/6/2026", "€4257"], status: "pending" as const },
    { id: "2143207728", cells: ["NEU-2728", "NEURA Pattern Detection Item 3", "5/1/2026", "€7828"], status: "completed" as const },
    { id: "2143211299", cells: ["NEU-6299", "NEURA Pattern Detection Item 4", "20/8/2026", "€11 399"], status: "warning" as const },
    { id: "2143214870", cells: ["NEU-9870", "NEURA Pattern Detection Item 5", "7/3/2026", "€14 970"], status: "active" as const },
];
...
export default function NeuraPatternDetectionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NEURA Pattern Detection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NEURA Pattern Detection</p>
                    </div>
                </div>
