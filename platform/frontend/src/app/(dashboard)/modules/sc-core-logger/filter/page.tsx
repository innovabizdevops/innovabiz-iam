...
const PAGE = "Filter";
const KPIS = [{"l":"Total Sc Core Logger","v":"7.065","t":"+5.4%","d":"up"},{"l":"Filter Ativos","v":"6.253","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"85.2%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"57","t":"-4.0%","d":"down"}];
const COLS = ["ID","Filter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Logger #001","Sc Core Logger #002","7.424","8.645","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Logger #002","Sc Core Logger #003","2.084","1.977","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Logger #003","Sc Core Logger #004","4.577","4.185","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Logger #004","Sc Core Logger #005","4.853","2.147","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Logger #005","Sc Core Logger #001","4.657","8.793","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":715},{"label":"Mar","value":661},{"label":"Abr","value":373},{"label":"Mai","value":389},{"label":"Jun","value":465},{"label":"Jul","value":461},{"label":"Ago","value":717},{"label":"Set","value":490},{"label":"Out","value":479},{"label":"Nov","value":351},{"label":"Dez","value":636}];
const MX = 717;
