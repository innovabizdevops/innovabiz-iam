...
const PAGE = "Query";
const KPIS = [{"l":"Total Sc Core Logger","v":"6.862","t":"-2.1%","d":"down"},{"l":"Query Ativos","v":"6.111","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"94.1%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.2%","d":"up"}];
const COLS = ["ID","Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Logger #001","Sc Core Logger #002","8.755","8.753","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Logger #002","Sc Core Logger #003","4.084","7.268","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Logger #003","Sc Core Logger #004","7.464","1.402","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Logger #004","Sc Core Logger #005","2.126","1.679","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Logger #005","Sc Core Logger #001","426","7.325","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":365},{"label":"Mar","value":680},{"label":"Abr","value":480},{"label":"Mai","value":576},{"label":"Jun","value":711},{"label":"Jul","value":386},{"label":"Ago","value":344},{"label":"Set","value":465},{"label":"Out","value":439},{"label":"Nov","value":376},{"label":"Dez","value":522}];
const MX = 711;
