...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Logger";
const PAGE = "Configure";
const KPIS = [{"l":"Configurações","v":"2.241","t":"-3.0%","d":"down"},{"l":"Últimas Alterações","v":"7.809","t":"+5.5%","d":"up"},{"l":"Ambientes","v":"6.349","t":"+8.8%","d":"up"},{"l":"Versão Config","v":"2.396","t":"-2.7%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 36197.33","5.169","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 1647.46","5.673","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 13902.12","3.258","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 16757.00","8.499","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 7816.70","2.388","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":540},{"label":"Mar","value":382},{"label":"Abr","value":470},{"label":"Mai","value":494},{"label":"Jun","value":651},{"label":"Jul","value":372},{"label":"Ago","value":466},{"label":"Set","value":721},{"label":"Out","value":536},{"label":"Nov","value":587},{"label":"Dez","value":444}];
const MX = 721;
