...
const KPIS = [{"l":"Atletas Registados","v":"3.439","t":"-4.3%","d":"down"},{"l":"Treinos/Semana","v":"2789","t":"-1.0%","d":"down"},{"l":"Competições","v":"6.220","t":"+12.7%","d":"up"},{"l":"Performance Score","v":"87","t":"-6.0%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.070","939","5.868","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.691","3.319","6.879","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.669","5.435","2.911","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.887","188","9.082","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.287","3.114","5.417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":628},{"label":"Mar","value":540},{"label":"Abr","value":537},{"label":"Mai","value":747},{"label":"Jun","value":688},{"label":"Jul","value":546},{"label":"Ago","value":466},{"label":"Set","value":562},{"label":"Out","value":724},{"label":"Nov","value":842},{"label":"Dez","value":502}];
const MX = 842;
