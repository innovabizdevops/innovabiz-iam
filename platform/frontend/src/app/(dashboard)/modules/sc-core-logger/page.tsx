...
/* ═══ SC: Core Logger — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "3300", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4811", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€260K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1569450200", cells: ["SC-4200", "SC: Core Logger Item 1", "25/9/2026", "€300"], status: "active" as const },
    { id: "1569453771", cells: ["SC-7771", "SC: Core Logger Item 2", "12/4/2026", "€3871"], status: "pending" as const },
    { id: "1569457342", cells: ["SC-2342", "SC: Core Logger Item 3", "27/11/2026", "€7442"], status: "completed" as const },
    { id: "1569460913", cells: ["SC-5913", "SC: Core Logger Item 4", "14/6/2026", "€11 013"], status: "warning" as const },
    { id: "1569464484", cells: ["SC-9484", "SC: Core Logger Item 5", "1/1/2026", "€14 584"], status: "active" as const },
];
...
export default function ScCoreLoggerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Logger</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Logger</p>
                    </div>
                </div>
