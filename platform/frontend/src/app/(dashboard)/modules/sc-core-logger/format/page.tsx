...
const PAGE = "Format";
const KPIS = [{"l":"Formulários Ativos","v":"5.032","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"2940","t":"+1.7%","d":"up"},{"l":"Documentos Gerados","v":"6.603","t":"+15.5%","d":"up"},{"l":"Templates","v":"3.265","t":"+10.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.393","2026-03-09","8.581","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.170","2026-03-01","3.589","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.054","2026-02-09","2.746","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.842","2026-01-24","4.495","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.127","2026-01-03","7.549","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":366},{"label":"Mar","value":392},{"label":"Abr","value":665},{"label":"Mai","value":602},{"label":"Jun","value":466},{"label":"Jul","value":486},{"label":"Ago","value":380},{"label":"Set","value":516},{"label":"Out","value":475},{"label":"Nov","value":660},{"label":"Dez","value":433}];
const MX = 665;
