...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Risk Dashboard";
const PAGE = "Financial";
const KPIS = [{"l":"Riscos Identificados","v":"6.427","t":"+10.8%","d":"up"},{"l":"Mitigações Ativas","v":"5.120","t":"+4.3%","d":"up"},{"l":"Score Risco Geral","v":"79","t":"+2.0%","d":"up"},{"l":"Incidentes YTD","v":"7.001","t":"+1.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.463","7.514","4.297","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.968","8.625","4.058","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.155","2.581","7.047","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.331","2.836","5.911","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.302","3.077","2.826","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":1012},{"label":"Mar","value":731},{"label":"Abr","value":688},{"label":"Mai","value":906},{"label":"Jun","value":1060},{"label":"Jul","value":819},{"label":"Ago","value":992},{"label":"Set","value":1016},{"label":"Out","value":784},{"label":"Nov","value":765},{"label":"Dez","value":893}];
const MX = 1060;
