...
const KPIS = [{"l":"Riscos Identificados","v":"6.430","t":"+4.0%","d":"up"},{"l":"Mitigações Ativas","v":"7.164","t":"-2.9%","d":"down"},{"l":"Score Risco Geral","v":"95","t":"-2.6%","d":"down"},{"l":"Incidentes YTD","v":"2.770","t":"-2.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.925","7.550","872","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.233","8.187","5.053","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.790","2.975","4.646","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","839","6.940","4.461","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.044","1.146","6.936","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":770},{"label":"Mar","value":756},{"label":"Abr","value":707},{"label":"Mai","value":831},{"label":"Jun","value":750},{"label":"Jul","value":583},{"label":"Ago","value":780},{"label":"Set","value":684},{"label":"Out","value":712},{"label":"Nov","value":763},{"label":"Dez","value":578}];
const MX = 831;
