...
/* ═══ Multi-Risk Dashboard — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "2870", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2347", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€471K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1401159670", cells: ["MUL-4670", "Multi-Risk Dashboard Item 1", "23/11/2026", "€9770"], status: "active" as const },
    { id: "1401163241", cells: ["MUL-8241", "Multi-Risk Dashboard Item 2", "10/6/2026", "€13 341"], status: "pending" as const },
    { id: "1401166812", cells: ["MUL-2812", "Multi-Risk Dashboard Item 3", "25/1/2026", "€16 912"], status: "completed" as const },
    { id: "1401170383", cells: ["MUL-6383", "Multi-Risk Dashboard Item 4", "12/8/2026", "€20 483"], status: "warning" as const },
    { id: "1401173954", cells: ["MUL-9954", "Multi-Risk Dashboard Item 5", "27/3/2026", "€24 054"], status: "active" as const },
];
...
export default function MultiriskDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Risk Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Risk Dashboard</p>
                    </div>
                </div>
