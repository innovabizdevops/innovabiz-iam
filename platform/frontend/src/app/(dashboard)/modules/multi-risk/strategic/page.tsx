...
const KPIS = [{"l":"Riscos Identificados","v":"7.589","t":"+5.7%","d":"up"},{"l":"Mitigações Ativas","v":"4.891","t":"-3.1%","d":"down"},{"l":"Score Risco Geral","v":"71","t":"+11.2%","d":"up"},{"l":"Incidentes YTD","v":"7.874","t":"+2.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.570","821","4.707","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.306","6.884","8.939","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.332","2.589","7.501","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.661","5.208","2.200","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.765","3.698","2.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":749},{"label":"Mar","value":841},{"label":"Abr","value":878},{"label":"Mai","value":746},{"label":"Jun","value":1063},{"label":"Jul","value":1058},{"label":"Ago","value":757},{"label":"Set","value":675},{"label":"Out","value":701},{"label":"Nov","value":758},{"label":"Dez","value":674}];
const MX = 1063;
