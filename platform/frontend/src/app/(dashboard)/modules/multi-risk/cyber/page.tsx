...
const PAGE = "Cyber";
const KPIS = [{"l":"Riscos Identificados","v":"4.106","t":"+11.2%","d":"up"},{"l":"Mitigações Ativas","v":"1.646","t":"+7.3%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"-2.6%","d":"down"},{"l":"Incidentes YTD","v":"902","t":"+11.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.240","4.841","3.606","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.107","4.100","6.195","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.872","7.276","303","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.047","3.607","4.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.782","1.447","3.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":884},{"label":"Mar","value":628},{"label":"Abr","value":983},{"label":"Mai","value":615},{"label":"Jun","value":683},{"label":"Jul","value":992},{"label":"Ago","value":800},{"label":"Set","value":979},{"label":"Out","value":946},{"label":"Nov","value":829},{"label":"Dez","value":880}];
const MX = 992;
