...
const KPIS = [{"l":"Riscos Identificados","v":"7.966","t":"-5.8%","d":"down"},{"l":"Mitigações Ativas","v":"6.741","t":"+0.8%","d":"up"},{"l":"Score Risco Geral","v":"74","t":"-0.5%","d":"down"},{"l":"Incidentes YTD","v":"2.714","t":"+16.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.024","2.042","5.413","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","789","5.920","2.485","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.585","7.890","5.760","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","566","565","1.714","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.255","8.105","6.777","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":407},{"label":"Mar","value":599},{"label":"Abr","value":681},{"label":"Mai","value":712},{"label":"Jun","value":765},{"label":"Jul","value":643},{"label":"Ago","value":538},{"label":"Set","value":405},{"label":"Out","value":626},{"label":"Nov","value":630},{"label":"Dez","value":545}];
const MX = 765;
