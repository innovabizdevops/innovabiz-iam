...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"3.044","t":"+16.6%","d":"up"},{"l":"Queries/Dia","v":"1668","t":"+12.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.871","t":"+14.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.446","t":"+11.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1107","2026-02-25","1.285","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1533","2026-02-08","8.667","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1665","2026-02-05","3.331","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1805","2026-02-04","4.609","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1673","2026-02-13","3.759","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":565},{"label":"Mar","value":595},{"label":"Abr","value":919},{"label":"Mai","value":898},{"label":"Jun","value":604},{"label":"Jul","value":609},{"label":"Ago","value":770},{"label":"Set","value":795},{"label":"Out","value":849},{"label":"Nov","value":570},{"label":"Dez","value":716}];
const MX = 919;
