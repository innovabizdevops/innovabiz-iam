...
const ACCENT = "#6366f1";
const MODULE = "O&G Analytics";
const PAGE = "Reservoir";
const KPIS = [{"l":"Dashboards Ativos","v":"799","t":"+0.9%","d":"up"},{"l":"Queries/Dia","v":"4235","t":"+10.7%","d":"up"},{"l":"Dados Processados (GB)","v":"1.841","t":"+7.6%","d":"up"},{"l":"Utilizadores Analytics","v":"663","t":"+4.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2969","2026-02-28","7.100","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1743","2026-01-02","4.780","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2944","2026-03-08","8.695","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2327","2026-02-10","663","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2670","2026-02-02","1.080","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":677},{"label":"Mar","value":722},{"label":"Abr","value":547},{"label":"Mai","value":546},{"label":"Jun","value":756},{"label":"Jul","value":678},{"label":"Ago","value":677},{"label":"Set","value":672},{"label":"Out","value":637},{"label":"Nov","value":572},{"label":"Dez","value":690}];
const MX = 854;
