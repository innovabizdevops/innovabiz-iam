...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"5.147","t":"+1.8%","d":"up"},{"l":"Queries/Dia","v":"1254","t":"+3.4%","d":"up"},{"l":"Dados Processados (GB)","v":"373","t":"+0.7%","d":"up"},{"l":"Utilizadores Analytics","v":"2.682","t":"+5.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3416","2026-03-24","7.343","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2757","2026-01-17","6.434","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","639","2026-03-09","7.640","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1094","2026-03-14","6.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3951","2026-02-14","7.250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":1039},{"label":"Mar","value":897},{"label":"Abr","value":957},{"label":"Mai","value":980},{"label":"Jun","value":991},{"label":"Jul","value":982},{"label":"Ago","value":953},{"label":"Set","value":832},{"label":"Out","value":898},{"label":"Nov","value":822},{"label":"Dez","value":879}];
const MX = 1039;
