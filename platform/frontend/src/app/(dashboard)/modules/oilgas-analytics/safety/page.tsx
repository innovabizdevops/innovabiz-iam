...
const PAGE = "Safety";
const KPIS = [{"l":"Dashboards Ativos","v":"3.570","t":"+0.7%","d":"up"},{"l":"Queries/Dia","v":"4607","t":"-3.7%","d":"down"},{"l":"Dados Processados (GB)","v":"7.903","t":"+13.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.372","t":"+16.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2879","2026-02-24","6.396","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","955","2026-03-20","5.034","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4718","2026-01-10","3.042","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","360","2026-02-23","2.411","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","206","2026-03-24","6.969","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":1032},{"label":"Mar","value":917},{"label":"Abr","value":873},{"label":"Mai","value":722},{"label":"Jun","value":994},{"label":"Jul","value":901},{"label":"Ago","value":983},{"label":"Set","value":1013},{"label":"Out","value":691},{"label":"Nov","value":1012},{"label":"Dez","value":735}];
const MX = 1032;
