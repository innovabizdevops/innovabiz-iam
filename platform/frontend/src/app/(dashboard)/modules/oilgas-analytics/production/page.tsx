...
const KPIS = [{"l":"Dashboards Ativos","v":"6.817","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"3177","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.786","t":"-0.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.069","t":"+13.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4346","2026-02-13","5.169","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4787","2026-02-08","2.825","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1756","2026-01-25","2.126","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4552","2026-03-14","8.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","715","2026-02-17","8.473","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":505},{"label":"Mar","value":645},{"label":"Abr","value":413},{"label":"Mai","value":586},{"label":"Jun","value":459},{"label":"Jul","value":524},{"label":"Ago","value":478},{"label":"Set","value":586},{"label":"Out","value":395},{"label":"Nov","value":508},{"label":"Dez","value":630}];
const MX = 645;
