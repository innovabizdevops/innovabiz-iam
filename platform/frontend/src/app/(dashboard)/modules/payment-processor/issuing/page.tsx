...
const PAGE = "Issuing";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.109","t":"+8.9%","d":"up"},{"l":"Sessões/Dia","v":"202","t":"+17.1%","d":"up"},{"l":"MFA Adoção (%)","v":"79.8%","t":"-0.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.561","t":"-1.2%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.166","4.895","1.739","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.400","3.359","7.623","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.389","4.144","5.958","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.932","7.054","5.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.250","7.520","8.964","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":729},{"label":"Mar","value":700},{"label":"Abr","value":861},{"label":"Mai","value":839},{"label":"Jun","value":906},{"label":"Jul","value":964},{"label":"Ago","value":1057},{"label":"Set","value":1008},{"label":"Out","value":858},{"label":"Nov","value":889},{"label":"Dez","value":1019}];
const MX = 1057;
