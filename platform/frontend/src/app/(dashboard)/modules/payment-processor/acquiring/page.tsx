...
const PAGE = "Acquiring";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.192","t":"-1.0%","d":"down"},{"l":"Sessões/Dia","v":"743","t":"+3.2%","d":"up"},{"l":"MFA Adoção (%)","v":"80.5%","t":"+10.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.833","t":"+0.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.647","3.540","4.762","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.732","2.006","5.734","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.760","1.579","7.337","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.926","3.989","2.480","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.192","7.249","7.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":802},{"label":"Mar","value":865},{"label":"Abr","value":801},{"label":"Mai","value":659},{"label":"Jun","value":627},{"label":"Jul","value":511},{"label":"Ago","value":509},{"label":"Set","value":664},{"label":"Out","value":871},{"label":"Nov","value":871},{"label":"Dez","value":554}];
const MX = 871;
