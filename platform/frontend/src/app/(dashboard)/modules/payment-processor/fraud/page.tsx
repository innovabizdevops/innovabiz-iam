...
const ACCENT = "#6366f1";
const MODULE = "Payment Processor";
const PAGE = "Fraud";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.127","t":"+15.1%","d":"up"},{"l":"Sessões/Dia","v":"3752","t":"+6.8%","d":"up"},{"l":"MFA Adoção (%)","v":"77.6%","t":"-2.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"7.225","t":"+1.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.127","6.095","5.161","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.293","8.147","2.444","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.329","6.243","4.685","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.940","2.721","3.723","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.110","950","6.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":666},{"label":"Mar","value":700},{"label":"Abr","value":983},{"label":"Mai","value":669},{"label":"Jun","value":632},{"label":"Jul","value":922},{"label":"Ago","value":654},{"label":"Set","value":930},{"label":"Out","value":972},{"label":"Nov","value":763},{"label":"Dez","value":738}];
const MX = 983;
