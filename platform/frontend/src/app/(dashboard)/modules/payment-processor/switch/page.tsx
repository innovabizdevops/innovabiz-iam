...
const PAGE = "Switch";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.213","t":"-2.3%","d":"down"},{"l":"Sessões/Dia","v":"241","t":"+13.7%","d":"up"},{"l":"MFA Adoção (%)","v":"74.9%","t":"+2.3%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.548","t":"+6.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.436","2.879","5.538","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.059","5.765","7.374","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.547","5.876","2.787","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.293","4.245","1.983","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.032","8.110","5.728","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":618},{"label":"Mar","value":333},{"label":"Abr","value":301},{"label":"Mai","value":382},{"label":"Jun","value":432},{"label":"Jul","value":590},{"label":"Ago","value":378},{"label":"Set","value":423},{"label":"Out","value":366},{"label":"Nov","value":566},{"label":"Dez","value":450}];
const MX = 618;
