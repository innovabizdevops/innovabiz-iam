...
const KPIS = [{"l":"Utilizadores Ativos","v":"3.389","t":"+16.9%","d":"up"},{"l":"Sessões/Dia","v":"1913","t":"+4.3%","d":"up"},{"l":"MFA Adoção (%)","v":"68.9%","t":"+11.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.068","t":"+15.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.826","3.993","2.926","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.223","8.773","6.248","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.006","136","508","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.831","743","2.649","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.323","4.074","9.048","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":818},{"label":"Mar","value":681},{"label":"Abr","value":637},{"label":"Mai","value":553},{"label":"Jun","value":507},{"label":"Jul","value":771},{"label":"Ago","value":683},{"label":"Set","value":586},{"label":"Out","value":697},{"label":"Nov","value":674},{"label":"Dez","value":552}];
const MX = 818;
