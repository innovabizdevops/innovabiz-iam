...
const ACCENT = "#b45309";
const MODULE = "Autonomous Driving";
const PAGE = "Sensor Fusion";
const KPIS = [{"l":"Dispositivos Online","v":"8.441","t":"-0.8%","d":"down"},{"l":"Dados/Min (MB)","v":"4.066","t":"-5.6%","d":"down"},{"l":"Alertas Ativos","v":"4.875","t":"+15.1%","d":"up"},{"l":"Uptime (%)","v":"78.7%","t":"+4.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.923","2.013","1.420","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","930","8.627","8.721","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.911","6.313","2.875","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.885","1.417","7.751","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","937","4.773","3.284","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":938},{"label":"Mar","value":1015},{"label":"Abr","value":692},{"label":"Mai","value":710},{"label":"Jun","value":799},{"label":"Jul","value":886},{"label":"Ago","value":909},{"label":"Set","value":766},{"label":"Out","value":866},{"label":"Nov","value":680},{"label":"Dez","value":1010}];
const MX = 1015;
