...
const KPIS = [{"l":"Twins Ativos","v":"1.947","t":"+10.3%","d":"up"},{"l":"Simulações/Dia","v":"3816","t":"-5.7%","d":"down"},{"l":"Precisão Modelo (%)","v":"74.5%","t":"-5.9%","d":"down"},{"l":"Latência Sync (ms)","v":"134ms","t":"-0.8%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","96.8%","2026-01-20","1.096","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","73.5%","2026-01-10","3.149","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","73.5%","2026-02-21","8.122","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","73.4%","2026-03-15","4.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","80.6%","2026-01-07","1.992","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":304},{"label":"Mar","value":413},{"label":"Abr","value":567},{"label":"Mai","value":367},{"label":"Jun","value":465},{"label":"Jul","value":253},{"label":"Ago","value":482},{"label":"Set","value":295},{"label":"Out","value":298},{"label":"Nov","value":246},{"label":"Dez","value":236}];
const MX = 567;
