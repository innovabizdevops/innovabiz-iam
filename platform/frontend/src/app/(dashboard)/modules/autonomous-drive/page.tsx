...
export default function AutonomousDrivePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Autonomous Drive</h1><p className="text-sm text-muted-foreground">Autonomous Drive • iBOS Enterprise</p></div>
