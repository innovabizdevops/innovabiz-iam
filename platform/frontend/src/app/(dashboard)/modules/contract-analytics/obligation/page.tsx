...
const ACCENT = "#4c1d95";
const MODULE = "Contract Analytics (AI)";
const PAGE = "Obligation";
const KPIS = [{"l":"Dashboards Ativos","v":"4.689","t":"+4.2%","d":"up"},{"l":"Queries/Dia","v":"2916","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.504","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.273","t":"-5.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1061","2026-03-14","5.916","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3503","2026-03-09","5.932","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","624","2026-03-01","8.220","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2516","2026-03-11","2.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3309","2026-01-06","6.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":1036},{"label":"Mar","value":917},{"label":"Abr","value":996},{"label":"Mai","value":655},{"label":"Jun","value":793},{"label":"Jul","value":726},{"label":"Ago","value":1030},{"label":"Set","value":925},{"label":"Out","value":969},{"label":"Nov","value":748},{"label":"Dez","value":960}];
const MX = 1036;
