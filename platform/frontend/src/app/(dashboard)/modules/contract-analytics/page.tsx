...
/* ═══ Contract Analytics (AI) — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "8550", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "722", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€70K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1034083250", cells: ["CON-2250", "Contract Analytics (AI) Item 1", "19/3/2026", "€33 350"], status: "active" as const },
    { id: "1034086821", cells: ["CON-5821", "Contract Analytics (AI) Item 2", "6/10/2026", "€36 921"], status: "pending" as const },
    { id: "1034090392", cells: ["CON-9392", "Contract Analytics (AI) Item 3", "21/5/2026", "€40 492"], status: "completed" as const },
    { id: "1034093963", cells: ["CON-3963", "Contract Analytics (AI) Item 4", "8/12/2026", "€44 063"], status: "warning" as const },
    { id: "1034097534", cells: ["CON-7534", "Contract Analytics (AI) Item 5", "23/7/2026", "€47 634"], status: "active" as const },
];
...
export default function ContractAnalyticsAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contract Analytics (AI)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Contract Analytics (AI)</p>
                    </div>
                </div>
