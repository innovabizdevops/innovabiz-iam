...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"6.847","t":"+10.1%","d":"up"},{"l":"Mitigações Ativas","v":"2.912","t":"+17.0%","d":"up"},{"l":"Score Risco Geral","v":"85","t":"+6.9%","d":"up"},{"l":"Incidentes YTD","v":"612","t":"+17.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.218","5.595","2.082","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.865","6.593","8.464","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.495","7.268","200","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.560","8.376","7.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.463","8.788","8.233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":908},{"label":"Mar","value":727},{"label":"Abr","value":979},{"label":"Mai","value":737},{"label":"Jun","value":935},{"label":"Jul","value":749},{"label":"Ago","value":830},{"label":"Set","value":1069},{"label":"Out","value":1071},{"label":"Nov","value":919},{"label":"Dez","value":1020}];
const MX = 1071;
