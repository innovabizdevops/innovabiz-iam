...
const PAGE = "Alert";
const KPIS = [{"l":"Dashboards Ativos","v":"4.583","t":"+6.8%","d":"up"},{"l":"Queries/Dia","v":"2764","t":"+10.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.936","t":"+6.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.088","t":"+13.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","962","2026-03-25","5.225","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3065","2026-01-22","2.973","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2993","2026-01-15","5.188","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","181","2026-03-14","1.850","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1182","2026-01-12","4.142","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":623},{"label":"Mar","value":621},{"label":"Abr","value":661},{"label":"Mai","value":654},{"label":"Jun","value":750},{"label":"Jul","value":880},{"label":"Ago","value":693},{"label":"Set","value":602},{"label":"Out","value":633},{"label":"Nov","value":868},{"label":"Dez","value":635}];
const MX = 880;
