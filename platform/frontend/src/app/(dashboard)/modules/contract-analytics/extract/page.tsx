...
const PAGE = "Extract";
const KPIS = [{"l":"Dashboards Ativos","v":"8.907","t":"-5.0%","d":"down"},{"l":"Queries/Dia","v":"4915","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.995","t":"+13.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.925","t":"+17.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2409","2026-02-01","7.453","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2718","2026-02-25","3.804","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1104","2026-01-14","976","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","466","2026-01-25","2.069","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1839","2026-02-02","1.811","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":777},{"label":"Mar","value":939},{"label":"Abr","value":883},{"label":"Mai","value":676},{"label":"Jun","value":669},{"label":"Jul","value":921},{"label":"Ago","value":798},{"label":"Set","value":829},{"label":"Out","value":907},{"label":"Nov","value":889},{"label":"Dez","value":721}];
const MX = 939;
