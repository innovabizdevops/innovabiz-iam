...
const KPIS = [{"l":"Dashboards Ativos","v":"5.763","t":"-4.4%","d":"down"},{"l":"Queries/Dia","v":"3561","t":"+6.3%","d":"up"},{"l":"Dados Processados (GB)","v":"5.704","t":"+14.5%","d":"up"},{"l":"Utilizadores Analytics","v":"353","t":"+0.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1612","2026-03-07","905","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1021","2026-01-12","1.280","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1985","2026-01-11","7.170","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4223","2026-03-18","2.640","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2986","2026-01-03","7.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":555},{"label":"Mar","value":407},{"label":"Abr","value":698},{"label":"Mai","value":350},{"label":"Jun","value":448},{"label":"Jul","value":454},{"label":"Ago","value":395},{"label":"Set","value":338},{"label":"Out","value":535},{"label":"Nov","value":537},{"label":"Dez","value":535}];
const MX = 698;
