...
const PAGE = "Vein-to-Vein";
const KPIS = [{"l":"Total Cell Therapy","v":"1.958","t":"-2.2%","d":"down"},{"l":"Vein To Vein Ativos","v":"8.367","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"70","t":"+5.1%","d":"up"}];
const COLS = ["ID","Vein To Vein","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cell Therapy #001","Cell Therapy #002","6.888","1.602","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cell Therapy #002","Cell Therapy #003","8.033","6.808","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Cell Therapy #003","Cell Therapy #004","527","2.385","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Cell Therapy #004","Cell Therapy #005","621","2.367","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cell Therapy #005","Cell Therapy #001","3.949","7.687","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":410},{"label":"Mar","value":675},{"label":"Abr","value":359},{"label":"Mai","value":401},{"label":"Jun","value":557},{"label":"Jul","value":621},{"label":"Ago","value":547},{"label":"Set","value":675},{"label":"Out","value":525},{"label":"Nov","value":616},{"label":"Dez","value":484}];
const MX = 675;
...
export default function VeintoveinPage() {
    return (
