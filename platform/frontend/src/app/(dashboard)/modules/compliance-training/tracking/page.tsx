...
const ACCENT = "#78350f";
const MODULE = "Compliance Training";
const PAGE = "Completion Track";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.946","t":"-3.2%","d":"down"},{"l":"NC Abertas","v":"3.653","t":"-3.7%","d":"down"},{"l":"Conformidade (%)","v":"79.9%","t":"+8.9%","d":"up"},{"l":"CAPAs Pendentes","v":"6.402","t":"+17.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.948","99.8%","6.968","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","9.058","74.7%","4.586","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","143","82.1%","454","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.775","87.7%","1.429","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.166","91.5%","3.435","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":989},{"label":"Mar","value":830},{"label":"Abr","value":953},{"label":"Mai","value":874},{"label":"Jun","value":611},{"label":"Jul","value":1003},{"label":"Ago","value":869},{"label":"Set","value":896},{"label":"Out","value":837},{"label":"Nov","value":618},{"label":"Dez","value":907}];
const MX = 1003;
