...
const PAGE = "Audit Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.140","t":"+17.9%","d":"up"},{"l":"NC Abertas","v":"6.528","t":"+5.3%","d":"up"},{"l":"Conformidade (%)","v":"80.5%","t":"-1.1%","d":"down"},{"l":"CAPAs Pendentes","v":"2.931","t":"+9.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.684","96.4%","5.493","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","739","88.9%","6.249","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","308","79.3%","3.568","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.847","93.4%","6.240","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.037","70.9%","6.787","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":793},{"label":"Mar","value":940},{"label":"Abr","value":815},{"label":"Mai","value":877},{"label":"Jun","value":1050},{"label":"Jul","value":1074},{"label":"Ago","value":752},{"label":"Set","value":974},{"label":"Out","value":751},{"label":"Nov","value":967},{"label":"Dez","value":746}];
const MX = 1074;
