...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.693","t":"+6.9%","d":"up"},{"l":"NC Abertas","v":"8.616","t":"+7.8%","d":"up"},{"l":"Conformidade (%)","v":"65.4%","t":"+10.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.876","t":"-4.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.933","88.3%","2.670","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.113","96.4%","8.853","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","9.086","83.8%","3.651","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.656","83.3%","5.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.064","71.6%","1.989","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":474},{"label":"Mar","value":736},{"label":"Abr","value":368},{"label":"Mai","value":508},{"label":"Jun","value":466},{"label":"Jul","value":367},{"label":"Ago","value":408},{"label":"Set","value":513},{"label":"Out","value":464},{"label":"Nov","value":702},{"label":"Dez","value":689}];
const MX = 736;
