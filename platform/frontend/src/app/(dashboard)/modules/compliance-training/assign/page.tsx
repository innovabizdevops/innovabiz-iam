...
const PAGE = "Course Assign";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.134","t":"+7.3%","d":"up"},{"l":"NC Abertas","v":"3.689","t":"-1.4%","d":"down"},{"l":"Conformidade (%)","v":"76.1%","t":"+12.0%","d":"up"},{"l":"CAPAs Pendentes","v":"8.680","t":"-3.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.468","83.7%","4.696","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.258","98.7%","5.587","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.629","90.4%","4.343","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.306","85.6%","6.956","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.852","97.5%","1.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":943},{"label":"Mar","value":553},{"label":"Abr","value":899},{"label":"Mai","value":713},{"label":"Jun","value":852},{"label":"Jul","value":740},{"label":"Ago","value":696},{"label":"Set","value":886},{"label":"Out","value":702},{"label":"Nov","value":727},{"label":"Dez","value":834}];
const MX = 943;
