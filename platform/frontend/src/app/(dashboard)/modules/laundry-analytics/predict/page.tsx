...
const ACCENT = "#083344";
const MODULE = "Laundry Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"6.541","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"922","t":"+16.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.531","t":"+17.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.725","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4958","2026-02-22","5.209","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4178","2026-01-10","908","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5032","2026-03-26","2.558","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1613","2026-03-06","2.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1251","2026-01-19","7.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":884},{"label":"Mar","value":697},{"label":"Abr","value":1056},{"label":"Mai","value":797},{"label":"Jun","value":681},{"label":"Jul","value":898},{"label":"Ago","value":1032},{"label":"Set","value":763},{"label":"Out","value":1023},{"label":"Nov","value":855},{"label":"Dez","value":1003}];
const MX = 1056;
