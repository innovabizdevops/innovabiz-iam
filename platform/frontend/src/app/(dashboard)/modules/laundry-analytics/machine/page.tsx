...
const PAGE = "Machine";
const KPIS = [{"l":"Dashboards Ativos","v":"4.455","t":"+1.3%","d":"up"},{"l":"Queries/Dia","v":"3921","t":"+15.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.746","t":"-5.4%","d":"down"},{"l":"Utilizadores Analytics","v":"4.038","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","607","2026-02-21","6.498","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4558","2026-02-07","2.326","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2932","2026-01-16","6.986","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1469","2026-03-19","731","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4932","2026-03-15","6.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":707},{"label":"Mar","value":655},{"label":"Abr","value":797},{"label":"Mai","value":810},{"label":"Jun","value":600},{"label":"Jul","value":609},{"label":"Ago","value":838},{"label":"Set","value":864},{"label":"Out","value":785},{"label":"Nov","value":581},{"label":"Dez","value":782}];
const MX = 864;
