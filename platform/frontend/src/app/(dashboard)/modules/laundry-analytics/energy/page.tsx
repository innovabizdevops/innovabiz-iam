...
const PAGE = "Energy";
const KPIS = [{"l":"Dashboards Ativos","v":"3.470","t":"-5.7%","d":"down"},{"l":"Queries/Dia","v":"5062","t":"+15.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.963","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.453","t":"+3.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3147","2026-01-10","3.018","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1354","2026-02-06","2.922","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","109","2026-01-15","7.333","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3719","2026-02-05","6.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1437","2026-02-11","8.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":540},{"label":"Mar","value":417},{"label":"Abr","value":503},{"label":"Mai","value":641},{"label":"Jun","value":396},{"label":"Jul","value":650},{"label":"Ago","value":452},{"label":"Set","value":407},{"label":"Out","value":459},{"label":"Nov","value":483},{"label":"Dez","value":693}];
const MX = 693;
