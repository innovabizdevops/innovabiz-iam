...
const PAGE = "Chemical";
const KPIS = [{"l":"Dashboards Ativos","v":"7.746","t":"+9.0%","d":"up"},{"l":"Queries/Dia","v":"3858","t":"+8.7%","d":"up"},{"l":"Dados Processados (GB)","v":"7.617","t":"+7.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.621","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1187","2026-02-08","5.324","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3474","2026-01-14","4.383","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2967","2026-02-17","7.263","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4190","2026-02-24","8.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1011","2026-03-14","4.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":885},{"label":"Mar","value":688},{"label":"Abr","value":548},{"label":"Mai","value":526},{"label":"Jun","value":746},{"label":"Jul","value":684},{"label":"Ago","value":767},{"label":"Set","value":670},{"label":"Out","value":885},{"label":"Nov","value":851},{"label":"Dez","value":683}];
const MX = 885;
