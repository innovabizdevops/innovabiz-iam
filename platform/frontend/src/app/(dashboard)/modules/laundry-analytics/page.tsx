...
const KPIS = [
    { label: "Total Registos", value: "4099", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3044", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€391K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "329109699", cells: ["LAU-7699", "Laundry Analytics Item 1", "24/4/2026", "€9799"], status: "active" as const },
    { id: "329113270", cells: ["LAU-2270", "Laundry Analytics Item 2", "11/11/2026", "€13 370"], status: "pending" as const },
    { id: "329116841", cells: ["LAU-5841", "Laundry Analytics Item 3", "26/6/2026", "€16 941"], status: "completed" as const },
    { id: "329120412", cells: ["LAU-9412", "Laundry Analytics Item 4", "13/1/2026", "€20 512"], status: "warning" as const },
    { id: "329123983", cells: ["LAU-3983", "Laundry Analytics Item 5", "28/8/2026", "€24 083"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laundry Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laundry Analytics</p>
                    </div>
                </div>
