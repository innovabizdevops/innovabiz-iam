...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€38.5M","t":"+3.0%","d":"up"},{"l":"MRR (€)","v":"€44291","t":"+3.3%","d":"up"},{"l":"Churn (%)","v":"73.9%","t":"-4.5%","d":"down"},{"l":"ARPU (€)","v":"€49645","t":"+17.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18870.13","3.815","€ 14467.70","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 46336.64","1.563","€ 35588.56","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7746.69","6.439","€ 21168.48","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 15657.89","8.775","€ 44460.65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 12524.18","6.959","€ 32972.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":724},{"label":"Mar","value":560},{"label":"Abr","value":869},{"label":"Mai","value":832},{"label":"Jun","value":595},{"label":"Jul","value":671},{"label":"Ago","value":881},{"label":"Set","value":875},{"label":"Out","value":705},{"label":"Nov","value":948},{"label":"Dez","value":598}];
const MX = 948;
