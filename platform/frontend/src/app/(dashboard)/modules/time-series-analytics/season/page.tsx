...
const PAGE = "Season";
const KPIS = [{"l":"Dashboards Ativos","v":"8.225","t":"+1.5%","d":"up"},{"l":"Queries/Dia","v":"2282","t":"+5.0%","d":"up"},{"l":"Dados Processados (GB)","v":"4.809","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.664","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","189","2026-03-17","1.738","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3522","2026-03-13","4.000","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3731","2026-02-05","3.428","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1952","2026-03-07","5.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2069","2026-02-16","5.164","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":868},{"label":"Mar","value":933},{"label":"Abr","value":714},{"label":"Mai","value":722},{"label":"Jun","value":813},{"label":"Jul","value":631},{"label":"Ago","value":654},{"label":"Set","value":737},{"label":"Out","value":844},{"label":"Nov","value":781},{"label":"Dez","value":919}];
const MX = 933;
