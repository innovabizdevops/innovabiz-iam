...
const PAGE = "Correlation";
const KPIS = [{"l":"Dashboards Ativos","v":"2.479","t":"+14.0%","d":"up"},{"l":"Queries/Dia","v":"1539","t":"-2.0%","d":"down"},{"l":"Dados Processados (GB)","v":"4.351","t":"+2.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.311","t":"+0.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4895","2026-03-14","2.338","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4470","2026-03-08","7.201","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1237","2026-03-19","3.114","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4920","2026-01-21","2.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2390","2026-01-07","3.440","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":360},{"label":"Mar","value":405},{"label":"Abr","value":360},{"label":"Mai","value":405},{"label":"Jun","value":617},{"label":"Jul","value":280},{"label":"Ago","value":507},{"label":"Set","value":263},{"label":"Out","value":301},{"label":"Nov","value":361},{"label":"Dez","value":241}];
const MX = 617;
