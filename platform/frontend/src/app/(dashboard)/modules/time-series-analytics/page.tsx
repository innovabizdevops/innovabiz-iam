...
const KPIS = [
    { label: "Total Registos", value: "759", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2416", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€452K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1276734359", cells: ["TIM-4359", "Time Series Analytics Item 1", "20/12/2026", "€34 459"], status: "active" as const },
    { id: "1276737930", cells: ["TIM-7930", "Time Series Analytics Item 2", "7/7/2026", "€38 030"], status: "pending" as const },
    { id: "1276741501", cells: ["TIM-2501", "Time Series Analytics Item 3", "22/2/2026", "€41 601"], status: "completed" as const },
    { id: "1276745072", cells: ["TIM-6072", "Time Series Analytics Item 4", "9/9/2026", "€45 172"], status: "warning" as const },
    { id: "1276748643", cells: ["TIM-9643", "Time Series Analytics Item 5", "24/4/2026", "€48 743"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Time Series Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Time Series Analytics</p>
                    </div>
                </div>
