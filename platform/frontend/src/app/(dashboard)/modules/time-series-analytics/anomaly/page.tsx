...
const ACCENT = "#4338ca";
const MODULE = "Time Series Analytics";
const PAGE = "Anomaly";
const KPIS = [{"l":"Dashboards Ativos","v":"2.510","t":"-4.7%","d":"down"},{"l":"Queries/Dia","v":"4580","t":"+4.7%","d":"up"},{"l":"Dados Processados (GB)","v":"7.839","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"4.128","t":"+4.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","415","2026-01-02","4.421","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4741","2026-02-18","7.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","990","2026-03-06","593","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2711","2026-01-19","5.086","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4483","2026-01-20","6.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":475},{"label":"Mar","value":714},{"label":"Abr","value":707},{"label":"Mai","value":737},{"label":"Jun","value":590},{"label":"Jul","value":492},{"label":"Ago","value":418},{"label":"Set","value":524},{"label":"Out","value":764},{"label":"Nov","value":632},{"label":"Dez","value":401}];
const MX = 772;
