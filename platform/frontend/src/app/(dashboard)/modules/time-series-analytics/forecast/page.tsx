...
const PAGE = "Forecast";
const KPIS = [{"l":"Dashboards Ativos","v":"8.114","t":"+8.1%","d":"up"},{"l":"Queries/Dia","v":"2661","t":"+13.5%","d":"up"},{"l":"Dados Processados (GB)","v":"4.961","t":"+1.6%","d":"up"},{"l":"Utilizadores Analytics","v":"4.163","t":"+13.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2106","2026-02-17","8.439","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2732","2026-01-03","1.025","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3818","2026-02-25","183","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2264","2026-03-27","6.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","535","2026-01-21","5.226","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":541},{"label":"Mar","value":613},{"label":"Abr","value":855},{"label":"Mai","value":677},{"label":"Jun","value":623},{"label":"Jul","value":629},{"label":"Ago","value":764},{"label":"Set","value":637},{"label":"Out","value":561},{"label":"Nov","value":680},{"label":"Dez","value":855}];
const MX = 855;
