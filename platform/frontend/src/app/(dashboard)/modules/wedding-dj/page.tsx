...
/* ═══ Wedding DJ & Entertainment — Dashboard ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total Registos", value: "7050", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4001", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€374K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "601441850", cells: ["WED-8850", "Wedding DJ & Entertainment Item 1", "3/3/2026", "€41 950"], status: "active" as const },
    { id: "601445421", cells: ["WED-3421", "Wedding DJ & Entertainment Item 2", "18/10/2026", "€45 521"], status: "pending" as const },
    { id: "601448992", cells: ["WED-6992", "Wedding DJ & Entertainment Item 3", "5/5/2026", "€49 092"], status: "completed" as const },
    { id: "601452563", cells: ["WED-1563", "Wedding DJ & Entertainment Item 4", "20/12/2026", "€2663"], status: "warning" as const },
    { id: "601456134", cells: ["WED-5134", "Wedding DJ & Entertainment Item 5", "7/7/2026", "€6234"], status: "active" as const },
];
...
export default function WeddingDjEntertainmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding DJ & Entertainment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding DJ & Entertainment</p>
                    </div>
                </div>
