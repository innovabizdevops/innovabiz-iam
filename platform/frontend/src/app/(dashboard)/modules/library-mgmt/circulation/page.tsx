...
const KPIS = [{"l":"Total Library Mgmt","v":"4.430","t":"+14.5%","d":"up"},{"l":"Circulation Ativos","v":"6.034","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"83.9%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"72","t":"+2.0%","d":"up"}];
const COLS = ["ID","Circulation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Library Mgmt #001","Library Mgmt #002","8.917","5.388","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Library Mgmt #002","Library Mgmt #003","5.580","7.193","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Library Mgmt #003","Library Mgmt #004","4.650","1.740","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Library Mgmt #004","Library Mgmt #005","1.738","6.530","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Library Mgmt #005","Library Mgmt #001","2.172","6.832","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":520},{"label":"Mar","value":817},{"label":"Abr","value":577},{"label":"Mai","value":815},{"label":"Jun","value":668},{"label":"Jul","value":734},{"label":"Ago","value":593},{"label":"Set","value":850},{"label":"Out","value":758},{"label":"Nov","value":638},{"label":"Dez","value":776}];
const MX = 850;
