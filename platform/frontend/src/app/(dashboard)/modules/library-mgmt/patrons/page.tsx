...
const PAGE = "Patron Mgmt";
const KPIS = [{"l":"Total Library Mgmt","v":"352","t":"+4.9%","d":"up"},{"l":"Patron Mgmt Ativos","v":"1.865","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"56","t":"+6.8%","d":"up"}];
const COLS = ["ID","Patron Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Library Mgmt #001","Library Mgmt #002","6.618","3.810","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Library Mgmt #002","Library Mgmt #003","4.903","7.087","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Library Mgmt #003","Library Mgmt #004","1.334","2.224","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Library Mgmt #004","Library Mgmt #005","2.143","1.020","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Library Mgmt #005","Library Mgmt #001","4.339","2.661","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":795},{"label":"Mar","value":494},{"label":"Abr","value":751},{"label":"Mai","value":530},{"label":"Jun","value":759},{"label":"Jul","value":800},{"label":"Ago","value":518},{"label":"Set","value":457},{"label":"Out","value":506},{"label":"Nov","value":549},{"label":"Dez","value":480}];
const MX = 800;
