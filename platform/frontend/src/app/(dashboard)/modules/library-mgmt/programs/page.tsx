...
const PAGE = "Community Programs";
const KPIS = [{"l":"Projetos Sociais","v":"893","t":"-3.3%","d":"down"},{"l":"Beneficiários","v":"8.175","t":"+13.1%","d":"up"},{"l":"Investimento CSR (€)","v":"€22590","t":"+5.1%","d":"up"},{"l":"Score Impacto","v":"61","t":"+2.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.819","€ 23901.88","654","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.261","€ 45787.16","7.154","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.442","€ 29042.98","7.553","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.275","€ 35957.90","3.684","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.607","€ 23796.17","2.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":779},{"label":"Mar","value":715},{"label":"Abr","value":517},{"label":"Mai","value":511},{"label":"Jun","value":681},{"label":"Jul","value":623},{"label":"Ago","value":654},{"label":"Set","value":549},{"label":"Out","value":725},{"label":"Nov","value":687},{"label":"Dez","value":780}];
const MX = 780;
