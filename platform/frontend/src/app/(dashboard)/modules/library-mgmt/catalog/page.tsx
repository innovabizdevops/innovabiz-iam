...
const PAGE = "Catalog &amp; MARC";
const KPIS = [{"l":"Dashboards Ativos","v":"5.572","t":"+8.9%","d":"up"},{"l":"Queries/Dia","v":"2484","t":"-2.1%","d":"down"},{"l":"Dados Processados (GB)","v":"958","t":"+12.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.950","t":"+0.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1543","2026-03-05","4.519","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3008","2026-01-24","1.792","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3209","2026-01-15","1.499","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3991","2026-01-20","8.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1788","2026-03-21","2.707","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":780},{"label":"Mar","value":802},{"label":"Abr","value":706},{"label":"Mai","value":610},{"label":"Jun","value":488},{"label":"Jul","value":789},{"label":"Ago","value":555},{"label":"Set","value":601},{"label":"Out","value":604},{"label":"Nov","value":479},{"label":"Dez","value":762}];
const MX = 802;
