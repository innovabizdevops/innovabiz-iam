...
const PAGE = "Reading Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.665","t":"+1.2%","d":"up"},{"l":"Queries/Dia","v":"868","t":"+3.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.623","t":"+8.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.347","t":"+4.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4425","2026-03-26","7.778","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3412","2026-02-03","4.970","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4715","2026-02-23","8.221","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","103","2026-03-27","4.066","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4039","2026-02-15","7.242","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":615},{"label":"Mar","value":702},{"label":"Abr","value":725},{"label":"Mai","value":663},{"label":"Jun","value":665},{"label":"Jul","value":776},{"label":"Ago","value":504},{"label":"Set","value":797},{"label":"Out","value":867},{"label":"Nov","value":849},{"label":"Dez","value":755}];
const MX = 867;
