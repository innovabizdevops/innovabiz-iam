...
const PAGE = "ILL Network";
const KPIS = [{"l":"Total Library Mgmt","v":"5.199","t":"+6.4%","d":"up"},{"l":"ILL Network Ativos","v":"2.976","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"55","t":"+16.2%","d":"up"}];
const COLS = ["ID","ILL Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Library Mgmt #001","Library Mgmt #002","1.187","2.619","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Library Mgmt #002","Library Mgmt #003","8.240","4.115","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Library Mgmt #003","Library Mgmt #004","8.656","7.247","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Library Mgmt #004","Library Mgmt #005","1.621","5.571","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Library Mgmt #005","Library Mgmt #001","3.880","6.351","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":535},{"label":"Mar","value":555},{"label":"Abr","value":488},{"label":"Mai","value":326},{"label":"Jun","value":525},{"label":"Jul","value":492},{"label":"Ago","value":529},{"label":"Set","value":617},{"label":"Out","value":324},{"label":"Nov","value":451},{"label":"Dez","value":525}];
const MX = 617;
