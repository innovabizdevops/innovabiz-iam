...
const ACCENT = "#0369a1";
const MODULE = "Library Management";
const PAGE = "RFID Tracking";
const KPIS = [{"l":"Total Library Mgmt","v":"8.468","t":"-5.4%","d":"down"},{"l":"RFID Tracking Ativos","v":"3.143","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"80.2%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"75","t":"-4.9%","d":"down"}];
const COLS = ["ID","RFID Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Library Mgmt #001","Library Mgmt #002","5.691","3.527","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Library Mgmt #002","Library Mgmt #003","4.303","640","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Library Mgmt #003","Library Mgmt #004","6.147","1.624","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Library Mgmt #004","Library Mgmt #005","3.413","5.463","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Library Mgmt #005","Library Mgmt #001","7.045","8.477","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":723},{"label":"Mar","value":898},{"label":"Abr","value":762},{"label":"Mai","value":708},{"label":"Jun","value":606},{"label":"Jul","value":914},{"label":"Ago","value":672},{"label":"Set","value":874},{"label":"Out","value":893},{"label":"Nov","value":640},{"label":"Dez","value":570}];
const MX = 936;
