...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"4.398","t":"-5.4%","d":"down"},{"l":"Mitigações Ativas","v":"3.609","t":"-1.6%","d":"down"},{"l":"Score Risco Geral","v":"73","t":"+2.9%","d":"up"},{"l":"Incidentes YTD","v":"381","t":"-4.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","940","5.945","6.462","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.931","1.713","8.898","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.165","7.265","8.826","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.647","2.057","7.287","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","142","7.583","7.135","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":656},{"label":"Mar","value":448},{"label":"Abr","value":478},{"label":"Mai","value":832},{"label":"Jun","value":450},{"label":"Jul","value":787},{"label":"Ago","value":609},{"label":"Set","value":574},{"label":"Out","value":781},{"label":"Nov","value":492},{"label":"Dez","value":578}];
const MX = 834;
