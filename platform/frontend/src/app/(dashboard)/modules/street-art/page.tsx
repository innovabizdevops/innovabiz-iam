...
/* ═══ Street Art Management — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "8748", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4417", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€369K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1931478848", cells: ["STR-7848", "Street Art Management Item 1", "13/9/2026", "€28 948"], status: "active" as const },
    { id: "1931482419", cells: ["STR-2419", "Street Art Management Item 2", "28/4/2026", "€32 519"], status: "pending" as const },
    { id: "1931485990", cells: ["STR-5990", "Street Art Management Item 3", "15/11/2026", "€36 090"], status: "completed" as const },
    { id: "1931489561", cells: ["STR-9561", "Street Art Management Item 4", "2/6/2026", "€39 661"], status: "warning" as const },
    { id: "1931493132", cells: ["STR-4132", "Street Art Management Item 5", "17/1/2026", "€43 232"], status: "active" as const },
];
...
export default function StreetArtManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Street Art Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Street Art Management</p>
                    </div>
                </div>
