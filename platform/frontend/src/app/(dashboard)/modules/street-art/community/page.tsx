...
const KPIS = [{"l":"Projetos Sociais","v":"5.422","t":"-1.5%","d":"down"},{"l":"Beneficiários","v":"4.164","t":"-4.2%","d":"down"},{"l":"Investimento CSR (€)","v":"€20824","t":"-3.3%","d":"down"},{"l":"Score Impacto","v":"70","t":"+3.7%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.350","€ 41934.09","5.976","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.214","€ 24105.46","3.677","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.969","€ 10788.03","2.313","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.627","€ 36350.19","3.170","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.206","€ 37245.65","4.432","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":912},{"label":"Mar","value":885},{"label":"Abr","value":698},{"label":"Mai","value":825},{"label":"Jun","value":863},{"label":"Jul","value":686},{"label":"Ago","value":741},{"label":"Set","value":582},{"label":"Out","value":905},{"label":"Nov","value":897},{"label":"Dez","value":586}];
const MX = 912;
