...
const ACCENT = "#5b21b6";
const MODULE = "Street Art Management";
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"7.550","t":"-4.6%","d":"down"},{"l":"Submissões/Dia","v":"4501","t":"+9.5%","d":"up"},{"l":"Documentos Gerados","v":"312","t":"-1.7%","d":"down"},{"l":"Templates","v":"4.747","t":"+4.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.497","2026-01-05","5.018","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.315","2026-02-27","7.415","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.040","2026-01-23","8.420","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.857","2026-03-28","579","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.739","2026-01-11","3.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":491},{"label":"Mar","value":320},{"label":"Abr","value":301},{"label":"Mai","value":495},{"label":"Jun","value":284},{"label":"Jul","value":596},{"label":"Ago","value":586},{"label":"Set","value":261},{"label":"Out","value":594},{"label":"Nov","value":477},{"label":"Dez","value":364}];
const MX = 596;
