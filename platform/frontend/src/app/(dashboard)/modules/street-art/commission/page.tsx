...
const KPIS = [{"l":"Vendas YTD (€)","v":"€9854","t":"+12.9%","d":"up"},{"l":"Pipeline (€)","v":"€10268","t":"+8.1%","d":"up"},{"l":"Atingimento Quota (%)","v":"68.0%","t":"+16.8%","d":"up"},{"l":"Win Rate (%)","v":"83.5%","t":"+7.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 40366.25","€ 1947.53","€ 26129.75","82.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 48062.03","€ 37602.12","€ 40615.23","73.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 16348.53","€ 10431.45","€ 27280.93","72.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 24141.22","€ 43643.13","€ 27068.15","75.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 41957.95","€ 42149.22","€ 21670.23","92.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":636},{"label":"Mar","value":790},{"label":"Abr","value":762},{"label":"Mai","value":731},{"label":"Jun","value":733},{"label":"Jul","value":696},{"label":"Ago","value":627},{"label":"Set","value":551},{"label":"Out","value":754},{"label":"Nov","value":730},{"label":"Dez","value":725}];
const MX = 790;
