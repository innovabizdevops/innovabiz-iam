...
const PAGE = "Tour";
const KPIS = [{"l":"Total Street Art","v":"2.325","t":"+2.4%","d":"up"},{"l":"Tour Ativos","v":"5.842","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+7.0%","d":"up"}];
const COLS = ["ID","Tour","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Street Art #001","Street Art #002","4.176","3.509","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Street Art #002","Street Art #003","2.868","1.650","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Street Art #003","Street Art #004","5.668","3.936","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Street Art #004","Street Art #005","6.826","4.539","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Street Art #005","Street Art #001","6.900","5.265","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":342},{"label":"Mar","value":371},{"label":"Abr","value":615},{"label":"Mai","value":344},{"label":"Jun","value":643},{"label":"Jul","value":314},{"label":"Ago","value":372},{"label":"Set","value":286},{"label":"Out","value":490},{"label":"Nov","value":552},{"label":"Dez","value":569}];
const MX = 647;
