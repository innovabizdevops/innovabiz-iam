...
const KPIS = [{"l":"Total Gov Budgeting","v":"€87416","t":"-3.9%","d":"down"},{"l":"Execution Ativos","v":"3.776","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.8%","d":"up"}];
const COLS = ["ID","Execution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gov Budgeting #001","Gov Budgeting #002","644","7.474","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Gov Budgeting #002","Gov Budgeting #003","4.278","8.793","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Gov Budgeting #003","Gov Budgeting #004","123","8.867","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Gov Budgeting #004","Gov Budgeting #005","1.065","7.566","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gov Budgeting #005","Gov Budgeting #001","3.471","3.070","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":220},{"label":"Mar","value":594},{"label":"Abr","value":224},{"label":"Mai","value":492},{"label":"Jun","value":334},{"label":"Jul","value":212},{"label":"Ago","value":489},{"label":"Set","value":468},{"label":"Out","value":337},{"label":"Nov","value":462},{"label":"Dez","value":370}];
const MX = 594;
