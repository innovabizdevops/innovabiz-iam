...
const KPIS = [{"l":"Total Gov Budgeting","v":"€85027","t":"-0.6%","d":"down"},{"l":"Preparation Ativos","v":"4.569","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"85.8%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"64","t":"+15.7%","d":"up"}];
const COLS = ["ID","Preparation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gov Budgeting #001","Gov Budgeting #002","6.544","2.108","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Gov Budgeting #002","Gov Budgeting #003","7.485","6.807","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Gov Budgeting #003","Gov Budgeting #004","5.452","6.489","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Gov Budgeting #004","Gov Budgeting #005","1.044","1.673","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gov Budgeting #005","Gov Budgeting #001","5.487","553","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1045},{"label":"Fev","value":843},{"label":"Mar","value":1062},{"label":"Abr","value":1046},{"label":"Mai","value":697},{"label":"Jun","value":1064},{"label":"Jul","value":971},{"label":"Ago","value":951},{"label":"Set","value":756},{"label":"Out","value":792},{"label":"Nov","value":825},{"label":"Dez","value":1048}];
const MX = 1064;
