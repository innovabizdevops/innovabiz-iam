...
export default function GovBudgetingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Gov Budgeting</h1><p className="text-sm text-muted-foreground">Gov Budgeting • iBOS Enterprise</p></div>
