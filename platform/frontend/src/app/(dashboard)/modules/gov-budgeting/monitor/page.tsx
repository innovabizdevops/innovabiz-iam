...
const ACCENT = "#6366f1";
const MODULE = "Gov Budgeting";
const PAGE = "Monitoring";
const KPIS = [{"l":"Total Gov Budgeting","v":"€82835","t":"+6.3%","d":"up"},{"l":"Monitoring Ativos","v":"6.957","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"93.9%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"62","t":"+7.0%","d":"up"}];
const COLS = ["ID","Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gov Budgeting #001","Gov Budgeting #002","8.087","4.551","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Gov Budgeting #002","Gov Budgeting #003","4.340","1.592","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Gov Budgeting #003","Gov Budgeting #004","1.326","3.093","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Gov Budgeting #004","Gov Budgeting #005","1.522","1.427","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gov Budgeting #005","Gov Budgeting #001","1.970","1.642","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":806},{"label":"Mar","value":600},{"label":"Abr","value":957},{"label":"Mai","value":627},{"label":"Jun","value":867},{"label":"Jul","value":778},{"label":"Ago","value":709},{"label":"Set","value":875},{"label":"Out","value":873},{"label":"Nov","value":813},{"label":"Dez","value":658}];
const MX = 957;
