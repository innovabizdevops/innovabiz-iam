...
const PAGE = "Pad Mgmt";
const KPIS = [{"l":"Total Vertiport","v":"4.303","t":"+3.7%","d":"up"},{"l":"Pad Mgmt Ativos","v":"2.716","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+7.6%","d":"up"}];
const COLS = ["ID","Pad Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertiport #001","Vertiport #002","4.131","7.476","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Vertiport #002","Vertiport #003","4.990","5.130","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertiport #003","Vertiport #004","3.531","4.585","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Vertiport #004","Vertiport #005","2.937","8.404","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertiport #005","Vertiport #001","4.477","2.704","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":444},{"label":"Mar","value":415},{"label":"Abr","value":375},{"label":"Mai","value":417},{"label":"Jun","value":453},{"label":"Jul","value":618},{"label":"Ago","value":309},{"label":"Set","value":394},{"label":"Out","value":638},{"label":"Nov","value":305},{"label":"Dez","value":521}];
const MX = 638;
