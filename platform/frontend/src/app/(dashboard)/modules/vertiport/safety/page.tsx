...
const KPIS = [{"l":"Total Vertiport","v":"5.749","t":"-2.1%","d":"down"},{"l":"Safety Case Ativos","v":"4.705","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"77","t":"+15.1%","d":"up"}];
const COLS = ["ID","Safety Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertiport #001","Vertiport #002","1.316","3.527","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Vertiport #002","Vertiport #003","1.663","5.412","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertiport #003","Vertiport #004","5.340","5.366","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Vertiport #004","Vertiport #005","8.213","1.638","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertiport #005","Vertiport #001","2.661","4.705","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":649},{"label":"Mar","value":583},{"label":"Abr","value":350},{"label":"Mai","value":465},{"label":"Jun","value":456},{"label":"Jul","value":647},{"label":"Ago","value":659},{"label":"Set","value":305},{"label":"Out","value":442},{"label":"Nov","value":377},{"label":"Dez","value":309}];
const MX = 659;
