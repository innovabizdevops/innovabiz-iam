...
const PAGE = "UAM Route";
const KPIS = [{"l":"Total Vertiport","v":"4.831","t":"+3.6%","d":"up"},{"l":"UAM Route Ativos","v":"2.697","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"74","t":"+7.4%","d":"up"}];
const COLS = ["ID","UAM Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertiport #001","Vertiport #002","5.873","795","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Vertiport #002","Vertiport #003","2.485","4.403","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertiport #003","Vertiport #004","7.280","2.885","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Vertiport #004","Vertiport #005","5.783","4.199","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertiport #005","Vertiport #001","6.387","2.041","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":666},{"label":"Mar","value":576},{"label":"Abr","value":429},{"label":"Mai","value":577},{"label":"Jun","value":666},{"label":"Jul","value":433},{"label":"Ago","value":637},{"label":"Set","value":374},{"label":"Out","value":576},{"label":"Nov","value":278},{"label":"Dez","value":276}];
const MX = 666;
