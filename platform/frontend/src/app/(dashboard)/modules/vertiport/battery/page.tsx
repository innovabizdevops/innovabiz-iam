...
const ACCENT = "#7c3aed";
const MODULE = "Vertiport (eVTOL)";
const PAGE = "Battery Swap";
const KPIS = [{"l":"Total Vertiport","v":"5.539","t":"+6.6%","d":"up"},{"l":"Battery Swap Ativos","v":"2.627","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"92.4%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+9.5%","d":"up"}];
const COLS = ["ID","Battery Swap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertiport #001","Vertiport #002","3.797","6.759","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Vertiport #002","Vertiport #003","4.848","632","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertiport #003","Vertiport #004","1.361","7.505","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Vertiport #004","Vertiport #005","649","7.912","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertiport #005","Vertiport #001","7.694","7.282","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":509},{"label":"Mar","value":849},{"label":"Abr","value":812},{"label":"Mai","value":827},{"label":"Jun","value":544},{"label":"Jul","value":855},{"label":"Ago","value":743},{"label":"Set","value":785},{"label":"Out","value":534},{"label":"Nov","value":753},{"label":"Dez","value":736}];
const MX = 855;
