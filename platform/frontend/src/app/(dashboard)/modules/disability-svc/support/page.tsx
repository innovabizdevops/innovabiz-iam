...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"1.267","t":"+3.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.4%","t":"-4.7%","d":"down"},{"l":"MTTR (h)","v":"160h","t":"+-0.0%","d":"up"},{"l":"Satisfação (%)","v":"76.4%","t":"+12.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.655","2.736","453","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.133","4.131","1.686","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.354","364","7.399","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.930","2.546","5.790","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.439","4.440","7.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":734},{"label":"Mar","value":564},{"label":"Abr","value":920},{"label":"Mai","value":680},{"label":"Jun","value":573},{"label":"Jul","value":907},{"label":"Ago","value":753},{"label":"Set","value":570},{"label":"Out","value":714},{"label":"Nov","value":867},{"label":"Dez","value":878}];
const MX = 920;
