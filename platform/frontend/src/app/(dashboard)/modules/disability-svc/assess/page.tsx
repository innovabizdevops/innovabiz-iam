...
const KPIS = [{"l":"Total Disability Svc","v":"1.282","t":"+8.2%","d":"up"},{"l":"Assessment Ativos","v":"2.281","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"94","t":"-1.9%","d":"down"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Svc #001","Disability Svc #002","5.850","1.498","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Svc #002","Disability Svc #003","8.389","2.229","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Svc #003","Disability Svc #004","2.002","4.400","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Svc #004","Disability Svc #005","563","8.562","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Svc #005","Disability Svc #001","5.099","5.635","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":986},{"label":"Fev","value":635},{"label":"Mar","value":607},{"label":"Abr","value":593},{"label":"Mai","value":811},{"label":"Jun","value":957},{"label":"Jul","value":783},{"label":"Ago","value":877},{"label":"Set","value":707},{"label":"Out","value":711},{"label":"Nov","value":593},{"label":"Dez","value":894}];
const MX = 986;
