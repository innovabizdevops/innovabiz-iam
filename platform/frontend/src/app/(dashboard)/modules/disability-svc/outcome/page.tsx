...
const PAGE = "Outcome";
const KPIS = [{"l":"Total Disability Svc","v":"2.568","t":"-5.7%","d":"down"},{"l":"Outcome Ativos","v":"3.379","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+1.2%","d":"up"}];
const COLS = ["ID","Outcome","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Svc #001","Disability Svc #002","303","5.262","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Svc #002","Disability Svc #003","3.157","3.022","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Svc #003","Disability Svc #004","6.831","1.709","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Svc #004","Disability Svc #005","5.966","4.214","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Svc #005","Disability Svc #001","6.468","553","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":950},{"label":"Mar","value":931},{"label":"Abr","value":770},{"label":"Mai","value":957},{"label":"Jun","value":820},{"label":"Jul","value":945},{"label":"Ago","value":936},{"label":"Set","value":896},{"label":"Out","value":781},{"label":"Nov","value":981},{"label":"Dez","value":719}];
const MX = 981;
