...
export default function DisabilitySvcPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Disability Svc</h1><p className="text-sm text-muted-foreground">Disability Svc • iBOS Enterprise</p></div>
