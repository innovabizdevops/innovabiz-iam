...
const PAGE = "Plan";
const KPIS = [{"l":"Total Disability Svc","v":"5.054","t":"+14.2%","d":"up"},{"l":"Plan Ativos","v":"7.208","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"91","t":"+4.6%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Svc #001","Disability Svc #002","6.475","5.417","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Svc #002","Disability Svc #003","3.089","6.298","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Svc #003","Disability Svc #004","6.618","8.890","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Svc #004","Disability Svc #005","6.976","2.548","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Svc #005","Disability Svc #001","2.789","7.310","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":800},{"label":"Mar","value":606},{"label":"Abr","value":906},{"label":"Mai","value":862},{"label":"Jun","value":870},{"label":"Jul","value":701},{"label":"Ago","value":771},{"label":"Set","value":578},{"label":"Out","value":658},{"label":"Nov","value":565},{"label":"Dez","value":862}];
const MX = 906;
