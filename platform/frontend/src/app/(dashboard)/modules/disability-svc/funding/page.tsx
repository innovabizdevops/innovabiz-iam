...
const PAGE = "Funding";
const KPIS = [{"l":"Total Disability Svc","v":"6.514","t":"+4.8%","d":"up"},{"l":"Funding Ativos","v":"4.105","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"76.8%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"89","t":"-4.6%","d":"down"}];
const COLS = ["ID","Funding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Svc #001","Disability Svc #002","6.182","7.648","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Svc #002","Disability Svc #003","6.470","4.733","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Svc #003","Disability Svc #004","5.755","3.115","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Svc #004","Disability Svc #005","4.711","1.969","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Svc #005","Disability Svc #001","6.070","4.572","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1055},{"label":"Fev","value":1053},{"label":"Mar","value":959},{"label":"Abr","value":1031},{"label":"Mai","value":827},{"label":"Jun","value":974},{"label":"Jul","value":1050},{"label":"Ago","value":827},{"label":"Set","value":687},{"label":"Out","value":962},{"label":"Nov","value":1048},{"label":"Dez","value":1015}];
const MX = 1055;
