...
const PAGE = "Security";
const KPIS = [{"l":"Total Stadium Mgmt","v":"8.845","t":"+6.1%","d":"up"},{"l":"Security Ativos","v":"4.089","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"91.6%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"73","t":"-2.1%","d":"down"}];
const COLS = ["ID","Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Mgmt #001","Stadium Mgmt #002","3.798","3.316","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Mgmt #002","Stadium Mgmt #003","6.344","4.267","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Mgmt #003","Stadium Mgmt #004","8.717","7.635","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Mgmt #004","Stadium Mgmt #005","3.023","943","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Mgmt #005","Stadium Mgmt #001","8.768","613","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":637},{"label":"Mar","value":557},{"label":"Abr","value":444},{"label":"Mai","value":492},{"label":"Jun","value":437},{"label":"Jul","value":448},{"label":"Ago","value":606},{"label":"Set","value":774},{"label":"Out","value":498},{"label":"Nov","value":673},{"label":"Dez","value":559}];
const MX = 774;
