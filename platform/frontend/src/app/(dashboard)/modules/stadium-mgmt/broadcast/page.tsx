...
const KPIS = [{"l":"Total Stadium Mgmt","v":"4.452","t":"+10.4%","d":"up"},{"l":"Broadcast Ativos","v":"281","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"86.9%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"63","t":"+5.0%","d":"up"}];
const COLS = ["ID","Broadcast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Mgmt #001","Stadium Mgmt #002","5.272","1.362","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Mgmt #002","Stadium Mgmt #003","2.987","8.607","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Mgmt #003","Stadium Mgmt #004","947","7.443","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Mgmt #004","Stadium Mgmt #005","7.869","6.604","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Mgmt #005","Stadium Mgmt #001","5.012","5.156","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":526},{"label":"Mar","value":588},{"label":"Abr","value":312},{"label":"Mai","value":316},{"label":"Jun","value":494},{"label":"Jul","value":426},{"label":"Ago","value":434},{"label":"Set","value":264},{"label":"Out","value":595},{"label":"Nov","value":381},{"label":"Dez","value":407}];
const MX = 595;
