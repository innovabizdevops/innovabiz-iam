...
const ACCENT = "#6366f1";
const MODULE = "Stadium Management";
const PAGE = "Concession";
const KPIS = [{"l":"Total Stadium Mgmt","v":"1.952","t":"-3.0%","d":"down"},{"l":"Concession Ativos","v":"3.426","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+10.8%","d":"up"}];
const COLS = ["ID","Concession","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Mgmt #001","Stadium Mgmt #002","6.599","8.116","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Mgmt #002","Stadium Mgmt #003","6.271","4.815","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Mgmt #003","Stadium Mgmt #004","8.625","7.127","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Mgmt #004","Stadium Mgmt #005","7.595","6.582","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Mgmt #005","Stadium Mgmt #001","4.975","1.752","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":544},{"label":"Mar","value":488},{"label":"Abr","value":323},{"label":"Mai","value":404},{"label":"Jun","value":591},{"label":"Jul","value":294},{"label":"Ago","value":484},{"label":"Set","value":412},{"label":"Out","value":290},{"label":"Nov","value":478},{"label":"Dez","value":584}];
const MX = 591;
