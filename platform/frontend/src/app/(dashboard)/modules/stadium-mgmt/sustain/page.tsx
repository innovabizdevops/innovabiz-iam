...
const KPIS = [{"l":"Total Stadium Mgmt","v":"2.324","t":"+2.4%","d":"up"},{"l":"Sustainability Ativos","v":"7.686","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+8.3%","d":"up"}];
const COLS = ["ID","Sustainability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Mgmt #001","Stadium Mgmt #002","8.529","2.151","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Mgmt #002","Stadium Mgmt #003","5.752","269","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Mgmt #003","Stadium Mgmt #004","2.303","6.346","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Mgmt #004","Stadium Mgmt #005","3.839","8.753","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Mgmt #005","Stadium Mgmt #001","1.190","5.015","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":831},{"label":"Mar","value":869},{"label":"Abr","value":735},{"label":"Mai","value":826},{"label":"Jun","value":582},{"label":"Jul","value":865},{"label":"Ago","value":688},{"label":"Set","value":915},{"label":"Out","value":867},{"label":"Nov","value":825},{"label":"Dez","value":782}];
const MX = 915;
