...
const KPIS = [{"l":"Total Stadium Mgmt","v":"4.549","t":"-1.0%","d":"down"},{"l":"Operations Ativos","v":"2.696","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+2.0%","d":"up"}];
const COLS = ["ID","Operations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stadium Mgmt #001","Stadium Mgmt #002","952","5.323","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Stadium Mgmt #002","Stadium Mgmt #003","8.665","1.327","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Stadium Mgmt #003","Stadium Mgmt #004","6.981","7.397","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Stadium Mgmt #004","Stadium Mgmt #005","2.081","7.763","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stadium Mgmt #005","Stadium Mgmt #001","2.694","2.650","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":842},{"label":"Mar","value":787},{"label":"Abr","value":522},{"label":"Mai","value":796},{"label":"Jun","value":581},{"label":"Jul","value":772},{"label":"Ago","value":544},{"label":"Set","value":767},{"label":"Out","value":494},{"label":"Nov","value":820},{"label":"Dez","value":784}];
const MX = 842;
