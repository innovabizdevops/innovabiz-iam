...
const PAGE = "Discover";
const KPIS = [{"l":"Total Attack Surface","v":"5.575","t":"-0.1%","d":"down"},{"l":"Discover Ativos","v":"7.817","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"75","t":"+10.9%","d":"up"}];
const COLS = ["ID","Discover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Attack Surface #001","Attack Surface #002","7.422","1.110","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Attack Surface #002","Attack Surface #003","6.243","6.812","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Attack Surface #003","Attack Surface #004","6.759","6.754","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Attack Surface #004","Attack Surface #005","6.917","7.451","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Attack Surface #005","Attack Surface #001","8.874","5.677","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":978},{"label":"Mar","value":934},{"label":"Abr","value":880},{"label":"Mai","value":740},{"label":"Jun","value":959},{"label":"Jul","value":909},{"label":"Ago","value":973},{"label":"Set","value":746},{"label":"Out","value":867},{"label":"Nov","value":943},{"label":"Dez","value":848}];
const MX = 978;
