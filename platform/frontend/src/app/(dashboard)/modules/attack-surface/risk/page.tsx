...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"8.548","t":"+8.3%","d":"up"},{"l":"Mitigações Ativas","v":"5.101","t":"+14.2%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"-5.4%","d":"down"},{"l":"Incidentes YTD","v":"1.350","t":"-5.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.593","6.769","4.399","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.464","1.321","2.180","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.981","6.666","8.525","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.677","7.763","8.261","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.134","2.346","1.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":721},{"label":"Mar","value":938},{"label":"Abr","value":749},{"label":"Mai","value":591},{"label":"Jun","value":680},{"label":"Jul","value":741},{"label":"Ago","value":899},{"label":"Set","value":843},{"label":"Out","value":781},{"label":"Nov","value":682},{"label":"Dez","value":827}];
const MX = 938;
