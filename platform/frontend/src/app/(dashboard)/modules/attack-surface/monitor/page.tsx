...
const ACCENT = "#dc2626";
const MODULE = "Attack Surface Mgmt";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Attack Surface","v":"5.566","t":"+12.7%","d":"up"},{"l":"Monitor Ativos","v":"8.399","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.6%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Attack Surface #001","Attack Surface #002","8.668","654","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Attack Surface #002","Attack Surface #003","3.022","8.315","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Attack Surface #003","Attack Surface #004","5.013","1.746","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Attack Surface #004","Attack Surface #005","6.209","4.707","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Attack Surface #005","Attack Surface #001","6.580","4.471","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":239},{"label":"Fev","value":287},{"label":"Mar","value":527},{"label":"Abr","value":593},{"label":"Mai","value":333},{"label":"Jun","value":565},{"label":"Jul","value":494},{"label":"Ago","value":534},{"label":"Set","value":260},{"label":"Out","value":549},{"label":"Nov","value":399},{"label":"Dez","value":514}];
const MX = 593;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>RTM</span></h1>
                </div>
