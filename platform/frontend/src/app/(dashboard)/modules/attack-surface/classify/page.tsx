...
const PAGE = "Classify";
const KPIS = [{"l":"Total Attack Surface","v":"254","t":"-0.7%","d":"down"},{"l":"Classify Ativos","v":"5.829","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+3.8%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Attack Surface #001","Attack Surface #002","3.769","1.991","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Attack Surface #002","Attack Surface #003","2.383","6.338","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Attack Surface #003","Attack Surface #004","1.795","8.897","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Attack Surface #004","Attack Surface #005","7.786","8.864","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Attack Surface #005","Attack Surface #001","1.137","8.600","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":924},{"label":"Mar","value":836},{"label":"Abr","value":869},{"label":"Mai","value":896},{"label":"Jun","value":863},{"label":"Jul","value":669},{"label":"Ago","value":543},{"label":"Set","value":584},{"label":"Out","value":824},{"label":"Nov","value":638},{"label":"Dez","value":865}];
const MX = 924;
