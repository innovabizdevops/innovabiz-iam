...
/* ═══ Attack Surface Mgmt — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "4269", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "389", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€79K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2070589169", cells: ["ATT-5169", "Attack Surface Mgmt Item 1", "6/6/2026", "€39 269"], status: "active" as const },
    { id: "2070592740", cells: ["ATT-8740", "Attack Surface Mgmt Item 2", "21/1/2026", "€42 840"], status: "pending" as const },
    { id: "2070596311", cells: ["ATT-3311", "Attack Surface Mgmt Item 3", "8/8/2026", "€46 411"], status: "completed" as const },
    { id: "2070599882", cells: ["ATT-6882", "Attack Surface Mgmt Item 4", "23/3/2026", "€49 982"], status: "warning" as const },
    { id: "2070603453", cells: ["ATT-1453", "Attack Surface Mgmt Item 5", "10/10/2026", "€3553"], status: "active" as const },
];
...
export default function AttackSurfaceMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Attack Surface Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Attack Surface Mgmt</p>
                    </div>
                </div>
