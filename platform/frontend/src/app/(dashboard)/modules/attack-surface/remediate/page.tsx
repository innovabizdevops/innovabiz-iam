...
const KPIS = [{"l":"Integrações Ativas","v":"3.747","t":"+16.3%","d":"up"},{"l":"Chamadas/Hora","v":"3949","t":"+0.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.2%","t":"-0.2%","d":"down"},{"l":"Latência Média (ms)","v":"58ms","t":"+15.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.474","741","70.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.793","2.157","88.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.265","7.777","71.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.911","1.766","94.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.384","1.674","89.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":680},{"label":"Mar","value":621},{"label":"Abr","value":554},{"label":"Mai","value":638},{"label":"Jun","value":515},{"label":"Jul","value":660},{"label":"Ago","value":706},{"label":"Set","value":570},{"label":"Out","value":702},{"label":"Nov","value":863},{"label":"Dez","value":530}];
const MX = 863;
