...
const KPIS = [{"l":"Dashboards Ativos","v":"4.823","t":"+6.8%","d":"up"},{"l":"Queries/Dia","v":"3741","t":"+9.5%","d":"up"},{"l":"Dados Processados (GB)","v":"7.737","t":"-0.1%","d":"down"},{"l":"Utilizadores Analytics","v":"232","t":"+17.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4255","2026-03-23","1.709","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2227","2026-03-16","7.307","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2498","2026-03-10","711","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1264","2026-03-10","3.772","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","489","2026-02-23","2.547","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":571},{"label":"Mar","value":583},{"label":"Abr","value":930},{"label":"Mai","value":688},{"label":"Jun","value":942},{"label":"Jul","value":869},{"label":"Ago","value":805},{"label":"Set","value":599},{"label":"Out","value":837},{"label":"Nov","value":740},{"label":"Dez","value":669}];
const MX = 942;
