...
const ACCENT = "#bfdbfe";
const MODULE = "Customs Administration";
const PAGE = "Tariff";
const KPIS = [{"l":"Total Customs Admin","v":"€44418","t":"+7.6%","d":"up"},{"l":"Tariff Ativos","v":"1.034","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"88","t":"-5.3%","d":"down"}];
const COLS = ["ID","Tariff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Admin #001","Customs Admin #002","2.222","5.260","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Admin #002","Customs Admin #003","4.384","4.140","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Admin #003","Customs Admin #004","3.910","2.237","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Admin #004","Customs Admin #005","8.197","7.804","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Admin #005","Customs Admin #001","703","2.824","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":791},{"label":"Mar","value":438},{"label":"Abr","value":730},{"label":"Mai","value":553},{"label":"Jun","value":498},{"label":"Jul","value":639},{"label":"Ago","value":646},{"label":"Set","value":754},{"label":"Out","value":572},{"label":"Nov","value":633},{"label":"Dez","value":493}];
const MX = 814;
