...
const KPIS = [{"l":"Total Customs Admin","v":"€92682","t":"+8.9%","d":"up"},{"l":"Declaration Ativos","v":"1.023","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"83","t":"+13.9%","d":"up"}];
const COLS = ["ID","Declaration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Admin #001","Customs Admin #002","1.571","4.036","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Admin #002","Customs Admin #003","7.873","249","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Admin #003","Customs Admin #004","1.828","8.438","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Admin #004","Customs Admin #005","2.970","1.937","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Admin #005","Customs Admin #001","1.402","1.398","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":877},{"label":"Mar","value":842},{"label":"Abr","value":805},{"label":"Mai","value":866},{"label":"Jun","value":794},{"label":"Jul","value":737},{"label":"Ago","value":803},{"label":"Set","value":796},{"label":"Out","value":681},{"label":"Nov","value":702},{"label":"Dez","value":817}];
const MX = 943;
