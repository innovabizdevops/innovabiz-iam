...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Customs Admin","v":"€27514","t":"+8.4%","d":"up"},{"l":"Inspect Ativos","v":"8.028","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"71.8%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"86","t":"+9.9%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Admin #001","Customs Admin #002","1.876","3.018","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Admin #002","Customs Admin #003","5.187","1.976","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Admin #003","Customs Admin #004","4.994","4.478","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Admin #004","Customs Admin #005","2.767","2.058","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Admin #005","Customs Admin #001","397","1.013","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":957},{"label":"Mar","value":902},{"label":"Abr","value":846},{"label":"Mai","value":675},{"label":"Jun","value":804},{"label":"Jul","value":879},{"label":"Ago","value":1068},{"label":"Set","value":1038},{"label":"Out","value":675},{"label":"Nov","value":911},{"label":"Dez","value":1011}];
const MX = 1068;
