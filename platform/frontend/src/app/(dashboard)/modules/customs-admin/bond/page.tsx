...
const PAGE = "Bond";
const KPIS = [{"l":"Total Customs Admin","v":"€32631","t":"+15.0%","d":"up"},{"l":"Bond Ativos","v":"4.625","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"86","t":"+3.3%","d":"up"}];
const COLS = ["ID","Bond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Admin #001","Customs Admin #002","3.925","7.223","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Admin #002","Customs Admin #003","5.114","8.258","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Admin #003","Customs Admin #004","7.571","7.927","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Admin #004","Customs Admin #005","5.698","8.446","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Admin #005","Customs Admin #001","7.056","8.964","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":633},{"label":"Mar","value":758},{"label":"Abr","value":628},{"label":"Mai","value":679},{"label":"Jun","value":845},{"label":"Jul","value":835},{"label":"Ago","value":856},{"label":"Set","value":916},{"label":"Out","value":909},{"label":"Nov","value":989},{"label":"Dez","value":900}];
const MX = 989;
