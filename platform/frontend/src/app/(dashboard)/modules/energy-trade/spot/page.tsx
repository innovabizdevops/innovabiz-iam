...
const ACCENT = "#6366f1";
const MODULE = "Energy Trading";
const PAGE = "Spot Market";
const KPIS = [{"l":"Total Energy Trade","v":"4.729","t":"+10.0%","d":"up"},{"l":"Spot Market Ativos","v":"5.014","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.3%","d":"up"}];
const COLS = ["ID","Spot Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Trade #001","Energy Trade #002","8.002","6.941","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Trade #002","Energy Trade #003","6.550","1.502","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Trade #003","Energy Trade #004","1.435","6.192","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Trade #004","Energy Trade #005","6.451","985","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Trade #005","Energy Trade #001","5.659","586","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":527},{"label":"Mar","value":601},{"label":"Abr","value":320},{"label":"Mai","value":588},{"label":"Jun","value":362},{"label":"Jul","value":637},{"label":"Ago","value":500},{"label":"Set","value":381},{"label":"Out","value":550},{"label":"Nov","value":330},{"label":"Dez","value":603}];
const MX = 637;
