...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.863","t":"+15.7%","d":"up"},{"l":"Mitigações Ativas","v":"2.870","t":"+14.7%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"+0.8%","d":"up"},{"l":"Incidentes YTD","v":"6.031","t":"+10.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.338","132","5.128","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.982","5.089","5.391","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.360","7.910","8.912","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.359","6.164","453","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","806","6.955","7.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":358},{"label":"Mar","value":512},{"label":"Abr","value":399},{"label":"Mai","value":320},{"label":"Jun","value":235},{"label":"Jul","value":352},{"label":"Ago","value":239},{"label":"Set","value":281},{"label":"Out","value":522},{"label":"Nov","value":304},{"label":"Dez","value":308}];
const MX = 579;
