...
const KPIS = [{"l":"Total Energy Trade","v":"1.886","t":"-0.9%","d":"down"},{"l":"Settlement Ativos","v":"6.757","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+9.2%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Trade #001","Energy Trade #002","8.721","6.664","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Trade #002","Energy Trade #003","1.263","4.414","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Trade #003","Energy Trade #004","6.007","6.163","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Trade #004","Energy Trade #005","1.418","3.822","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Trade #005","Energy Trade #001","1.140","1.506","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":410},{"label":"Mar","value":486},{"label":"Abr","value":516},{"label":"Mai","value":333},{"label":"Jun","value":306},{"label":"Jul","value":331},{"label":"Ago","value":457},{"label":"Set","value":380},{"label":"Out","value":322},{"label":"Nov","value":304},{"label":"Dez","value":472}];
const MX = 516;
