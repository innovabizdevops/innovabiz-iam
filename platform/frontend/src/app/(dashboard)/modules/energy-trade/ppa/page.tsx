...
const PAGE = "PPA";
const KPIS = [{"l":"Total Energy Trade","v":"2.186","t":"+12.6%","d":"up"},{"l":"PPA Ativos","v":"2.405","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+7.2%","d":"up"}];
const COLS = ["ID","PPA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Trade #001","Energy Trade #002","4.441","3.170","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Trade #002","Energy Trade #003","1.750","1.558","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Trade #003","Energy Trade #004","4.683","447","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Trade #004","Energy Trade #005","5.203","5.612","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Trade #005","Energy Trade #001","5.101","5.574","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":824},{"label":"Mar","value":631},{"label":"Abr","value":745},{"label":"Mai","value":632},{"label":"Jun","value":791},{"label":"Jul","value":881},{"label":"Ago","value":924},{"label":"Set","value":905},{"label":"Out","value":916},{"label":"Nov","value":974},{"label":"Dez","value":763}];
const MX = 974;
