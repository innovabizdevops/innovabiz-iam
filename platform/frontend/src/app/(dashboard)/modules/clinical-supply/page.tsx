...
export default function ClinicalSupplyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Clinical Supply</h1><p className="text-sm text-muted-foreground">Clinical Supply • iBOS Enterprise</p></div>
