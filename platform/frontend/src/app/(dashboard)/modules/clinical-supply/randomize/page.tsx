...
const PAGE = "Randomization";
const KPIS = [{"l":"Total Clinical Supply","v":"7.303","t":"+14.3%","d":"up"},{"l":"Randomization Ativos","v":"5.396","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+8.7%","d":"up"}];
const COLS = ["ID","Randomization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Supply #001","Clinical Supply #002","5.266","913","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Supply #002","Clinical Supply #003","8.435","917","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Supply #003","Clinical Supply #004","3.616","995","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Supply #004","Clinical Supply #005","1.569","4.062","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Supply #005","Clinical Supply #001","2.826","7.706","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":595},{"label":"Mar","value":618},{"label":"Abr","value":442},{"label":"Mai","value":371},{"label":"Jun","value":352},{"label":"Jul","value":713},{"label":"Ago","value":450},{"label":"Set","value":643},{"label":"Out","value":604},{"label":"Nov","value":413},{"label":"Dez","value":392}];
const MX = 713;
