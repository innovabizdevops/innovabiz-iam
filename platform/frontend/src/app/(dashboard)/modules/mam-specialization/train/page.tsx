...
const ACCENT = "#0369a1";
const MODULE = "MAM Agent Specialization";
const PAGE = "Domain Train";
const KPIS = [{"l":"Total Mam Specialization","v":"7.213","t":"+3.3%","d":"up"},{"l":"Domain Train Ativos","v":"3.516","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.1%","d":"up"}];
const COLS = ["ID","Domain Train","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Specialization #001","Mam Specialization #002","4.548","3.560","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Specialization #002","Mam Specialization #003","4.875","1.444","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Specialization #003","Mam Specialization #004","1.311","5.493","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Specialization #004","Mam Specialization #005","7.694","8.795","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Specialization #005","Mam Specialization #001","2.131","4.311","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":659},{"label":"Mar","value":915},{"label":"Abr","value":764},{"label":"Mai","value":815},{"label":"Jun","value":621},{"label":"Jul","value":922},{"label":"Ago","value":1002},{"label":"Set","value":889},{"label":"Out","value":735},{"label":"Nov","value":728},{"label":"Dez","value":866}];
const MX = 1002;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>AI</span></h1>
                </div>
