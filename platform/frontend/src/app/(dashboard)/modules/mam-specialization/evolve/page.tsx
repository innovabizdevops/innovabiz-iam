...
const PAGE = "Evolve";
const KPIS = [{"l":"Total Mam Specialization","v":"170","t":"+4.5%","d":"up"},{"l":"Evolve Ativos","v":"1.870","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"70","t":"+12.6%","d":"up"}];
const COLS = ["ID","Evolve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Specialization #001","Mam Specialization #002","5.230","982","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Specialization #002","Mam Specialization #003","1.721","7.257","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Specialization #003","Mam Specialization #004","4.969","6.183","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Specialization #004","Mam Specialization #005","1.402","8.790","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Specialization #005","Mam Specialization #001","4.444","3.997","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":862},{"label":"Mar","value":788},{"label":"Abr","value":897},{"label":"Mai","value":851},{"label":"Jun","value":795},{"label":"Jul","value":707},{"label":"Ago","value":813},{"label":"Set","value":540},{"label":"Out","value":774},{"label":"Nov","value":795},{"label":"Dez","value":544}];
const MX = 897;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>EVO</span></h1>
                </div>
