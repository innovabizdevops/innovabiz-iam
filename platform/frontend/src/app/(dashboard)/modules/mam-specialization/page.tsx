...
/* ═══ MAM Agent Specialization — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "1374", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "439", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€285K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "122295974", cells: ["MAM-4974", "MAM Agent Specialization Item 1", "11/3/2026", "€46 074"], status: "active" as const },
    { id: "122299545", cells: ["MAM-8545", "MAM Agent Specialization Item 2", "26/10/2026", "€49 645"], status: "pending" as const },
    { id: "122303116", cells: ["MAM-3116", "MAM Agent Specialization Item 3", "13/5/2026", "€3216"], status: "completed" as const },
    { id: "122306687", cells: ["MAM-6687", "MAM Agent Specialization Item 4", "28/12/2026", "€6787"], status: "warning" as const },
    { id: "122310258", cells: ["MAM-1258", "MAM Agent Specialization Item 5", "15/7/2026", "€10 358"], status: "active" as const },
];
...
export default function MamAgentSpecializationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MAM Agent Specialization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MAM Agent Specialization</p>
                    </div>
                </div>
