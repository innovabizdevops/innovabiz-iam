...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Access Control","v":"3.443","t":"-0.2%","d":"down"},{"l":"Schedule Ativos","v":"502","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"94","t":"-5.9%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Access Control #001","Access Control #002","3.716","2.596","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Access Control #002","Access Control #003","6.807","5.694","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Access Control #003","Access Control #004","3.894","6.080","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Access Control #004","Access Control #005","229","5.542","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Access Control #005","Access Control #001","3.619","3.837","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":838},{"label":"Mar","value":834},{"label":"Abr","value":718},{"label":"Mai","value":968},{"label":"Jun","value":839},{"label":"Jul","value":817},{"label":"Ago","value":862},{"label":"Set","value":812},{"label":"Out","value":742},{"label":"Nov","value":911},{"label":"Dez","value":734}];
const MX = 968;
