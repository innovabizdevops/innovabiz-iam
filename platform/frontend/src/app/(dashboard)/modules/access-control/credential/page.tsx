...
const ACCENT = "#64748b";
const MODULE = "Access Control System";
const PAGE = "Credential";
const KPIS = [{"l":"Total Access Control","v":"7.308","t":"+1.4%","d":"up"},{"l":"Credential Ativos","v":"7.169","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"63","t":"+14.1%","d":"up"}];
const COLS = ["ID","Credential","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Access Control #001","Access Control #002","8.287","2.823","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Access Control #002","Access Control #003","8.807","387","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Access Control #003","Access Control #004","6.631","4.460","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Access Control #004","Access Control #005","3.110","4.616","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Access Control #005","Access Control #001","1.754","3.251","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":312},{"label":"Mar","value":578},{"label":"Abr","value":473},{"label":"Mai","value":249},{"label":"Jun","value":524},{"label":"Jul","value":548},{"label":"Ago","value":445},{"label":"Set","value":271},{"label":"Out","value":541},{"label":"Nov","value":481},{"label":"Dez","value":337}];
const MX = 578;
