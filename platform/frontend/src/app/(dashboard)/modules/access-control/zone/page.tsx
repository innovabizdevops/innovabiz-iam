...
const PAGE = "Zone";
const KPIS = [{"l":"Total Access Control","v":"1.731","t":"+4.2%","d":"up"},{"l":"Zone Ativos","v":"3.993","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"66.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"90","t":"+0.4%","d":"up"}];
const COLS = ["ID","Zone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Access Control #001","Access Control #002","6.015","3.213","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Access Control #002","Access Control #003","3.350","6.591","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Access Control #003","Access Control #004","8.072","1.733","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Access Control #004","Access Control #005","7.245","7.803","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Access Control #005","Access Control #001","3.575","7.286","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":676},{"label":"Mar","value":915},{"label":"Abr","value":810},{"label":"Mai","value":879},{"label":"Jun","value":760},{"label":"Jul","value":831},{"label":"Ago","value":788},{"label":"Set","value":887},{"label":"Out","value":836},{"label":"Nov","value":894},{"label":"Dez","value":733}];
const MX = 915;
