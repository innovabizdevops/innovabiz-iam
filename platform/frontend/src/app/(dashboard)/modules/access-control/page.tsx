...
/* ═══ Access Control System — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "3873", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3973", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€152K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1506843173", cells: ["ACC-1173", "Access Control System Item 1", "18/6/2026", "€43 273"], status: "active" as const },
    { id: "1506846744", cells: ["ACC-4744", "Access Control System Item 2", "5/1/2026", "€46 844"], status: "pending" as const },
    { id: "1506850315", cells: ["ACC-8315", "Access Control System Item 3", "20/8/2026", "€415"], status: "completed" as const },
    { id: "1506853886", cells: ["ACC-2886", "Access Control System Item 4", "7/3/2026", "€3986"], status: "warning" as const },
    { id: "1506857457", cells: ["ACC-6457", "Access Control System Item 5", "22/10/2026", "€7557"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Access Control System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Access Control System</p>
                    </div>
                </div>
