...
const KPIS = [{"l":"Integrações Ativas","v":"4.170","t":"+0.4%","d":"up"},{"l":"Chamadas/Hora","v":"1161","t":"+18.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.4%","t":"+15.8%","d":"up"},{"l":"Latência Média (ms)","v":"84ms","t":"+14.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.526","584","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.327","2.845","77.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","829","2.828","76.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","691","5.850","87.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.170","4.913","75.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":895},{"label":"Mar","value":1081},{"label":"Abr","value":963},{"label":"Mai","value":813},{"label":"Jun","value":765},{"label":"Jul","value":1077},{"label":"Ago","value":974},{"label":"Set","value":963},{"label":"Out","value":725},{"label":"Nov","value":995},{"label":"Dez","value":771}];
const MX = 1081;
