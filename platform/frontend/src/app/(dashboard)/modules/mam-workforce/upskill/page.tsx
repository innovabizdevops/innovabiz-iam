...
const ACCENT = "#0369a1";
const MODULE = "MAM Digital Workforce";
const PAGE = "Upskill";
const KPIS = [{"l":"eNPS","v":"86","t":"+7.9%","d":"up"},{"l":"Engagement (%)","v":"70.6%","t":"-4.7%","d":"down"},{"l":"Turnover (%)","v":"87.8%","t":"-4.1%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"9.028","t":"+11.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.148","2026-01-02","57","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.482","2026-02-07","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.524","2026-02-06","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.782","2026-02-07","71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.655","2026-03-24","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":520},{"label":"Mar","value":537},{"label":"Abr","value":509},{"label":"Mai","value":385},{"label":"Jun","value":568},{"label":"Jul","value":278},{"label":"Ago","value":259},{"label":"Set","value":560},{"label":"Out","value":396},{"label":"Nov","value":258},{"label":"Dez","value":333}];
const MX = 568;
