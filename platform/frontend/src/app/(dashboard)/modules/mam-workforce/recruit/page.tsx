...
const PAGE = "Recruit";
const KPIS = [{"l":"eNPS","v":"91","t":"+5.0%","d":"up"},{"l":"Engagement (%)","v":"66.0%","t":"-0.7%","d":"down"},{"l":"Turnover (%)","v":"76.0%","t":"+7.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.863","t":"-5.9%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.807","2026-02-10","66","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.963","2026-03-12","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","830","2026-03-07","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.635","2026-01-14","92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.876","2026-02-02","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":795},{"label":"Mar","value":1052},{"label":"Abr","value":846},{"label":"Mai","value":892},{"label":"Jun","value":1006},{"label":"Jul","value":981},{"label":"Ago","value":906},{"label":"Set","value":936},{"label":"Out","value":829},{"label":"Nov","value":1038},{"label":"Dez","value":1057}];
const MX = 1057;
