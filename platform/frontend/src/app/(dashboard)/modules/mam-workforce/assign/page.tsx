...
const PAGE = "Assign";
const KPIS = [{"l":"eNPS","v":"72","t":"-0.3%","d":"down"},{"l":"Engagement (%)","v":"92.7%","t":"+10.0%","d":"up"},{"l":"Turnover (%)","v":"68.3%","t":"+2.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.132","t":"+13.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.678","2026-03-02","79","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.419","2026-02-08","75","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.785","2026-02-07","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.830","2026-03-11","55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.244","2026-03-11","60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":674},{"label":"Mar","value":571},{"label":"Abr","value":427},{"label":"Mai","value":724},{"label":"Jun","value":643},{"label":"Jul","value":530},{"label":"Ago","value":664},{"label":"Set","value":550},{"label":"Out","value":486},{"label":"Nov","value":488},{"label":"Dez","value":717}];
const MX = 757;
