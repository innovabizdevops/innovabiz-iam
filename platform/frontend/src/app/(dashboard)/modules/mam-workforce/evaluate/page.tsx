...
const PAGE = "Evaluate";
const KPIS = [{"l":"eNPS","v":"67","t":"+9.7%","d":"up"},{"l":"Engagement (%)","v":"92.4%","t":"+10.8%","d":"up"},{"l":"Turnover (%)","v":"93.6%","t":"+16.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.524","t":"+16.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.345","2026-02-01","71","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.886","2026-03-22","74","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.223","2026-01-15","76","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.504","2026-03-23","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.407","2026-03-08","81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":975},{"label":"Mar","value":966},{"label":"Abr","value":727},{"label":"Mai","value":861},{"label":"Jun","value":705},{"label":"Jul","value":866},{"label":"Ago","value":706},{"label":"Set","value":861},{"label":"Out","value":731},{"label":"Nov","value":827},{"label":"Dez","value":860}];
const MX = 975;
