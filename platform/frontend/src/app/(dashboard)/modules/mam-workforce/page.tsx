...
/* ═══ MAM Digital Workforce — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "7563", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1571", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€447K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2110697363", cells: ["MAM-9363", "MAM Digital Workforce Item 1", "20/12/2026", "€47 463"], status: "active" as const },
    { id: "2110700934", cells: ["MAM-3934", "MAM Digital Workforce Item 2", "7/7/2026", "€1034"], status: "pending" as const },
    { id: "2110704505", cells: ["MAM-7505", "MAM Digital Workforce Item 3", "22/2/2026", "€4605"], status: "completed" as const },
    { id: "2110708076", cells: ["MAM-2076", "MAM Digital Workforce Item 4", "9/9/2026", "€8176"], status: "warning" as const },
    { id: "2110711647", cells: ["MAM-5647", "MAM Digital Workforce Item 5", "24/4/2026", "€11 747"], status: "active" as const },
];
...
export default function MamDigitalWorkforcePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MAM Digital Workforce</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MAM Digital Workforce</p>
                    </div>
                </div>
