...
const PAGE = "Retire";
const KPIS = [{"l":"eNPS","v":"85","t":"+2.9%","d":"up"},{"l":"Engagement (%)","v":"67.7%","t":"-4.9%","d":"down"},{"l":"Turnover (%)","v":"72.7%","t":"+5.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.373","t":"-1.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","362","2026-02-26","57","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.124","2026-02-06","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.082","2026-01-05","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.514","2026-03-04","85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","367","2026-01-05","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":612},{"label":"Mar","value":782},{"label":"Abr","value":889},{"label":"Mai","value":993},{"label":"Jun","value":749},{"label":"Jul","value":730},{"label":"Ago","value":765},{"label":"Set","value":636},{"label":"Out","value":985},{"label":"Nov","value":805},{"label":"Dez","value":633}];
const MX = 993;
