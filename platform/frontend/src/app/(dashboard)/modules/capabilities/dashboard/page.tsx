...
const ACCENT = "#6366f1";
const MODULE = "Capability Explorer";
const PAGE = "Dashboard";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.265","t":"-4.3%","d":"down"},{"l":"NC Abertas","v":"3.674","t":"+3.7%","d":"up"},{"l":"Conformidade (%)","v":"80.4%","t":"-2.2%","d":"down"},{"l":"CAPAs Pendentes","v":"6.656","t":"+16.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.872","99.0%","581","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","458","77.9%","2.486","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.837","89.4%","8.088","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.321","88.2%","1.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.793","73.7%","2.686","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":909},{"label":"Mar","value":666},{"label":"Abr","value":836},{"label":"Mai","value":539},{"label":"Jun","value":536},{"label":"Jul","value":758},{"label":"Ago","value":829},{"label":"Set","value":792},{"label":"Out","value":641},{"label":"Nov","value":812},{"label":"Dez","value":743}];
const MX = 909;
