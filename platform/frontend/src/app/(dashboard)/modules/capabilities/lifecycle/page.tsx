...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.532","t":"+7.9%","d":"up"},{"l":"NC Abertas","v":"2.964","t":"+14.6%","d":"up"},{"l":"Conformidade (%)","v":"94.3%","t":"+12.4%","d":"up"},{"l":"CAPAs Pendentes","v":"8.910","t":"-0.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.300","86.7%","4.769","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","982","72.8%","5.727","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.766","75.4%","664","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.049","74.1%","2.590","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","570","79.3%","792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":641},{"label":"Mar","value":667},{"label":"Abr","value":927},{"label":"Mai","value":561},{"label":"Jun","value":658},{"label":"Jul","value":611},{"label":"Ago","value":748},{"label":"Set","value":934},{"label":"Out","value":917},{"label":"Nov","value":697},{"label":"Dez","value":700}];
const MX = 934;
