...
const PAGE = "Cheese Making";
const KPIS = [{"l":"Total Dairy Ops","v":"3.886","t":"-4.2%","d":"down"},{"l":"Cheese Making Ativos","v":"8.873","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"55","t":"+1.3%","d":"up"}];
const COLS = ["ID","Cheese Making","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Ops #001","Dairy Ops #002","1.664","6.505","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Ops #002","Dairy Ops #003","2.217","8.918","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Ops #003","Dairy Ops #004","871","3.221","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Ops #004","Dairy Ops #005","5.478","6.726","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Ops #005","Dairy Ops #001","4.264","2.480","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":528},{"label":"Mar","value":639},{"label":"Abr","value":335},{"label":"Mai","value":451},{"label":"Jun","value":601},{"label":"Jul","value":359},{"label":"Ago","value":410},{"label":"Set","value":660},{"label":"Out","value":379},{"label":"Nov","value":595},{"label":"Dez","value":469}];
const MX = 660;
