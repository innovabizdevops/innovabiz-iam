...
const PAGE = "Culture Mgmt";
const KPIS = [{"l":"Total Dairy Ops","v":"189","t":"-5.4%","d":"down"},{"l":"Culture Mgmt Ativos","v":"3.481","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"55","t":"+13.3%","d":"up"}];
const COLS = ["ID","Culture Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Ops #001","Dairy Ops #002","8.250","6.342","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Ops #002","Dairy Ops #003","1.718","608","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Ops #003","Dairy Ops #004","2.591","8.237","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Ops #004","Dairy Ops #005","6.214","6.556","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Ops #005","Dairy Ops #001","1.178","2.360","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":690},{"label":"Mar","value":760},{"label":"Abr","value":434},{"label":"Mai","value":642},{"label":"Jun","value":500},{"label":"Jul","value":785},{"label":"Ago","value":543},{"label":"Set","value":622},{"label":"Out","value":476},{"label":"Nov","value":444},{"label":"Dez","value":744}];
const MX = 785;
