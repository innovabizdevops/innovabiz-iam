...
const KPIS = [{"l":"Total Dairy Ops","v":"8.538","t":"-4.1%","d":"down"},{"l":"Pasteurize Ativos","v":"2.693","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"78","t":"-3.7%","d":"down"}];
const COLS = ["ID","Pasteurize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Ops #001","Dairy Ops #002","7.660","7.756","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Ops #002","Dairy Ops #003","399","3.910","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Ops #003","Dairy Ops #004","187","7.506","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Ops #004","Dairy Ops #005","5.400","8.265","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Ops #005","Dairy Ops #001","8.301","2.956","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":469},{"label":"Mar","value":599},{"label":"Abr","value":499},{"label":"Mai","value":348},{"label":"Jun","value":364},{"label":"Jul","value":264},{"label":"Ago","value":602},{"label":"Set","value":597},{"label":"Out","value":220},{"label":"Nov","value":305},{"label":"Dez","value":605}];
const MX = 605;
