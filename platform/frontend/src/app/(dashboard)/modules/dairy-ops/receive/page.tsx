...
const ACCENT = "#0e7490";
const MODULE = "Dairy Operations";
const PAGE = "Milk Receive";
const KPIS = [{"l":"Total Dairy Ops","v":"4.420","t":"+7.3%","d":"up"},{"l":"Milk Receive Ativos","v":"7.069","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+0.3%","d":"up"}];
const COLS = ["ID","Milk Receive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dairy Ops #001","Dairy Ops #002","633","6.411","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Dairy Ops #002","Dairy Ops #003","4.914","1.113","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Dairy Ops #003","Dairy Ops #004","6.201","1.830","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Dairy Ops #004","Dairy Ops #005","4.414","4.246","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dairy Ops #005","Dairy Ops #001","7.168","6.988","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":896},{"label":"Mar","value":668},{"label":"Abr","value":900},{"label":"Mai","value":800},{"label":"Jun","value":909},{"label":"Jul","value":809},{"label":"Ago","value":793},{"label":"Set","value":927},{"label":"Out","value":682},{"label":"Nov","value":650},{"label":"Dez","value":810}];
const MX = 927;
