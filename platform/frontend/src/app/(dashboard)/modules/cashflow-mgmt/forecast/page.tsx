...
const PAGE = "Forecast 13-Week";
const KPIS = [{"l":"Total Cashflow Mgmt","v":"2.040","t":"-5.0%","d":"down"},{"l":"Forecast 13 Week Ativos","v":"5.158","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+10.2%","d":"up"}];
const COLS = ["ID","Forecast 13 Week","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cashflow Mgmt #001","Cashflow Mgmt #002","9.009","4.905","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Cashflow Mgmt #002","Cashflow Mgmt #003","7.010","2.096","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cashflow Mgmt #003","Cashflow Mgmt #004","3.969","2.306","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Cashflow Mgmt #004","Cashflow Mgmt #005","7.874","1.026","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cashflow Mgmt #005","Cashflow Mgmt #001","5.719","5.023","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":574},{"label":"Mar","value":711},{"label":"Abr","value":429},{"label":"Mai","value":601},{"label":"Jun","value":647},{"label":"Jul","value":507},{"label":"Ago","value":430},{"label":"Set","value":421},{"label":"Out","value":467},{"label":"Nov","value":392},{"label":"Dez","value":677}];
const MX = 711;
