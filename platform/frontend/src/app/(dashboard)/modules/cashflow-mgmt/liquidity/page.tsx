...
const PAGE = "Liquidity Pool";
const KPIS = [{"l":"Total Cashflow Mgmt","v":"5.952","t":"+13.0%","d":"up"},{"l":"Liquidity Pool Ativos","v":"1.725","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+7.3%","d":"up"}];
const COLS = ["ID","Liquidity Pool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cashflow Mgmt #001","Cashflow Mgmt #002","2.890","2.602","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cashflow Mgmt #002","Cashflow Mgmt #003","7.388","1.072","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cashflow Mgmt #003","Cashflow Mgmt #004","1.896","7.844","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Cashflow Mgmt #004","Cashflow Mgmt #005","4.343","7.365","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cashflow Mgmt #005","Cashflow Mgmt #001","1.925","396","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":343},{"label":"Mar","value":475},{"label":"Abr","value":493},{"label":"Mai","value":304},{"label":"Jun","value":414},{"label":"Jul","value":432},{"label":"Ago","value":335},{"label":"Set","value":639},{"label":"Out","value":470},{"label":"Nov","value":528},{"label":"Dez","value":509}];
const MX = 639;
