...
const PAGE = "Cash Sweep";
const KPIS = [{"l":"Total Cashflow Mgmt","v":"1.559","t":"-3.5%","d":"down"},{"l":"Cash Sweep Ativos","v":"4.882","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"69","t":"+17.8%","d":"up"}];
const COLS = ["ID","Cash Sweep","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cashflow Mgmt #001","Cashflow Mgmt #002","1.394","2.459","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cashflow Mgmt #002","Cashflow Mgmt #003","834","218","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Cashflow Mgmt #003","Cashflow Mgmt #004","7.643","8.411","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cashflow Mgmt #004","Cashflow Mgmt #005","7.115","8.664","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cashflow Mgmt #005","Cashflow Mgmt #001","1.206","8.721","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":491},{"label":"Mar","value":698},{"label":"Abr","value":401},{"label":"Mai","value":539},{"label":"Jun","value":634},{"label":"Jul","value":467},{"label":"Ago","value":741},{"label":"Set","value":461},{"label":"Out","value":449},{"label":"Nov","value":615},{"label":"Dez","value":435}];
const MX = 741;
