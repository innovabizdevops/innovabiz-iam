...
const ACCENT = "#0e7490";
const MODULE = "Cash Flow Management";
const PAGE = "Scenario Model";
const KPIS = [{"l":"Total Cashflow Mgmt","v":"8.141","t":"+1.1%","d":"up"},{"l":"Scenario Model Ativos","v":"5.614","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"82","t":"+2.9%","d":"up"}];
const COLS = ["ID","Scenario Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cashflow Mgmt #001","Cashflow Mgmt #002","2.944","5.601","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cashflow Mgmt #002","Cashflow Mgmt #003","1.784","5.759","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cashflow Mgmt #003","Cashflow Mgmt #004","5.922","7.981","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Cashflow Mgmt #004","Cashflow Mgmt #005","6.279","4.503","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cashflow Mgmt #005","Cashflow Mgmt #001","8.875","3.650","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":800},{"label":"Mar","value":473},{"label":"Abr","value":667},{"label":"Mai","value":771},{"label":"Jun","value":743},{"label":"Jul","value":477},{"label":"Ago","value":645},{"label":"Set","value":787},{"label":"Out","value":805},{"label":"Nov","value":767},{"label":"Dez","value":503}];
const MX = 805;
