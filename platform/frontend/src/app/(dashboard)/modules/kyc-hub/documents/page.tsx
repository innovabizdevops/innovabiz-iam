...
const ACCENT = "#059669";
const MODULE = "KYC Hub";
const PAGE = "Document Check";
const KPIS = [{"l":"Formulários Ativos","v":"8.937","t":"+0.3%","d":"up"},{"l":"Submissões/Dia","v":"4985","t":"+13.5%","d":"up"},{"l":"Documentos Gerados","v":"3.337","t":"+3.8%","d":"up"},{"l":"Templates","v":"1.772","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.902","2026-01-28","5.540","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.744","2026-03-12","7.136","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.421","2026-01-26","364","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.411","2026-03-14","4.350","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.309","2026-01-13","7.679","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":745},{"label":"Mar","value":954},{"label":"Abr","value":907},{"label":"Mai","value":886},{"label":"Jun","value":1042},{"label":"Jul","value":1025},{"label":"Ago","value":845},{"label":"Set","value":819},{"label":"Out","value":713},{"label":"Nov","value":983},{"label":"Dez","value":775}];
const MX = 1042;
