...
const KPIS = [{"l":"Riscos Identificados","v":"4.069","t":"+13.3%","d":"up"},{"l":"Mitigações Ativas","v":"525","t":"-2.9%","d":"down"},{"l":"Score Risco Geral","v":"72","t":"+8.7%","d":"up"},{"l":"Incidentes YTD","v":"3.806","t":"-6.0%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.717","3.648","2.028","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.602","5.912","1.992","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.235","8.056","2.748","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.330","5.891","6.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.210","3.573","1.963","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":639},{"label":"Mar","value":455},{"label":"Abr","value":531},{"label":"Mai","value":752},{"label":"Jun","value":839},{"label":"Jul","value":507},{"label":"Ago","value":718},{"label":"Set","value":531},{"label":"Out","value":679},{"label":"Nov","value":641},{"label":"Dez","value":765}];
const MX = 839;
