...
const PAGE = "PEP Screening";
const KPIS = [{"l":"Total Kyc Hub","v":"7.533","t":"+16.3%","d":"up"},{"l":"PEP Screening Ativos","v":"5.708","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.0%","d":"up"}];
const COLS = ["ID","PEP Screening","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kyc Hub #001","Kyc Hub #002","570","8.182","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Kyc Hub #002","Kyc Hub #003","4.189","7.158","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Kyc Hub #003","Kyc Hub #004","5.155","284","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Kyc Hub #004","Kyc Hub #005","2.680","8.031","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kyc Hub #005","Kyc Hub #001","6.625","2.028","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":603},{"label":"Mar","value":373},{"label":"Abr","value":428},{"label":"Mai","value":318},{"label":"Jun","value":624},{"label":"Jul","value":601},{"label":"Ago","value":372},{"label":"Set","value":657},{"label":"Out","value":443},{"label":"Nov","value":523},{"label":"Dez","value":464}];
const MX = 657;
