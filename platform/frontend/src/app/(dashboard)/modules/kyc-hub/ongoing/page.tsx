...
const PAGE = "Ongoing Monitor";
const KPIS = [{"l":"Total Kyc Hub","v":"214","t":"+4.2%","d":"up"},{"l":"Ongoing Monitor Ativos","v":"6.547","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"63","t":"+6.9%","d":"up"}];
const COLS = ["ID","Ongoing Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kyc Hub #001","Kyc Hub #002","5.995","7.299","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Kyc Hub #002","Kyc Hub #003","1.512","4.156","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Kyc Hub #003","Kyc Hub #004","4.944","1.193","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Kyc Hub #004","Kyc Hub #005","3.137","947","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kyc Hub #005","Kyc Hub #001","3.484","4.407","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":547},{"label":"Mar","value":555},{"label":"Abr","value":421},{"label":"Mai","value":737},{"label":"Jun","value":604},{"label":"Jul","value":498},{"label":"Ago","value":462},{"label":"Set","value":426},{"label":"Out","value":620},{"label":"Nov","value":499},{"label":"Dez","value":433}];
const MX = 737;
