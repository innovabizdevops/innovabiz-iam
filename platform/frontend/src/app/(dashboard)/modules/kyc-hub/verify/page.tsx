...
const KPIS = [{"l":"Utilizadores Ativos","v":"1.596","t":"+14.0%","d":"up"},{"l":"Sessões/Dia","v":"4998","t":"+12.3%","d":"up"},{"l":"MFA Adoção (%)","v":"68.5%","t":"+5.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.018","t":"+6.8%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.701","7.577","6.423","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.783","591","120","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.579","4.714","852","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.920","804","2.935","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.298","351","8.445","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":405},{"label":"Mar","value":309},{"label":"Abr","value":439},{"label":"Mai","value":388},{"label":"Jun","value":633},{"label":"Jul","value":352},{"label":"Ago","value":443},{"label":"Set","value":381},{"label":"Out","value":286},{"label":"Nov","value":607},{"label":"Dez","value":475}];
const MX = 633;
