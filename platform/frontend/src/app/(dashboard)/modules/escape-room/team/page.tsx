...
const PAGE = "Team";
const KPIS = [{"l":"Teams Ativos","v":"2.027","t":"+7.0%","d":"up"},{"l":"Reuniões/Semana","v":"4139","t":"+10.3%","d":"up"},{"l":"Mensagens/Dia","v":"406","t":"-0.7%","d":"down"},{"l":"Ficheiros Partilhados","v":"3.509","t":"+12.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.680","3786","1.455","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.127","3505","4.778","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","556","2779","1.195","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","452","1043","725","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.446","2374","6.243","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":804},{"label":"Mar","value":618},{"label":"Abr","value":656},{"label":"Mai","value":517},{"label":"Jun","value":772},{"label":"Jul","value":751},{"label":"Ago","value":823},{"label":"Set","value":492},{"label":"Out","value":490},{"label":"Nov","value":640},{"label":"Dez","value":677}];
const MX = 823;
