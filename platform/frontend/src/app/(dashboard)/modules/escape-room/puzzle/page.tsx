...
const PAGE = "Puzzle";
const KPIS = [{"l":"Total Escape Room","v":"5.403","t":"-5.8%","d":"down"},{"l":"Puzzle Ativos","v":"3.395","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"91.1%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Puzzle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Escape Room #001","Escape Room #002","912","8.356","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Escape Room #002","Escape Room #003","1.729","1.704","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Escape Room #003","Escape Room #004","8.143","6.999","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Escape Room #004","Escape Room #005","7.330","2.667","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Escape Room #005","Escape Room #001","432","6.666","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":830},{"label":"Mar","value":713},{"label":"Abr","value":877},{"label":"Mai","value":573},{"label":"Jun","value":830},{"label":"Jul","value":868},{"label":"Ago","value":706},{"label":"Set","value":767},{"label":"Out","value":736},{"label":"Nov","value":708},{"label":"Dez","value":872}];
const MX = 877;
