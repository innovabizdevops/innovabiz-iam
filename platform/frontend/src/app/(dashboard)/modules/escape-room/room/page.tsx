...
const PAGE = "Room";
const KPIS = [{"l":"Total Escape Room","v":"7.167","t":"-4.3%","d":"down"},{"l":"Room Ativos","v":"8.572","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"64","t":"+4.4%","d":"up"}];
const COLS = ["ID","Room","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Escape Room #001","Escape Room #002","3.158","3.993","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Escape Room #002","Escape Room #003","3.311","2.672","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Escape Room #003","Escape Room #004","3.249","2.161","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Escape Room #004","Escape Room #005","5.612","3.414","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Escape Room #005","Escape Room #001","3.372","3.839","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":761},{"label":"Mar","value":641},{"label":"Abr","value":772},{"label":"Mai","value":839},{"label":"Jun","value":730},{"label":"Jul","value":848},{"label":"Ago","value":732},{"label":"Set","value":594},{"label":"Out","value":595},{"label":"Nov","value":773},{"label":"Dez","value":847}];
const MX = 848;
