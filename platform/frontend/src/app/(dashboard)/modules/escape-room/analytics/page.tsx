...
const ACCENT = "#7899bf";
const MODULE = "Escape Room";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.276","t":"+2.7%","d":"up"},{"l":"Queries/Dia","v":"2845","t":"-5.7%","d":"down"},{"l":"Dados Processados (GB)","v":"741","t":"+3.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.381","t":"+4.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2940","2026-02-25","900","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2501","2026-03-18","5.407","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3691","2026-02-13","7.891","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1958","2026-03-19","434","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","442","2026-01-20","5.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":512},{"label":"Mar","value":741},{"label":"Abr","value":656},{"label":"Mai","value":582},{"label":"Jun","value":637},{"label":"Jul","value":624},{"label":"Ago","value":498},{"label":"Set","value":685},{"label":"Out","value":642},{"label":"Nov","value":590},{"label":"Dez","value":457}];
const MX = 741;
