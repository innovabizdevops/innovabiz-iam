...
const PAGE = "Quality Check";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.626","t":"+4.4%","d":"up"},{"l":"NC Abertas","v":"3.643","t":"-5.9%","d":"down"},{"l":"Conformidade (%)","v":"84.1%","t":"+16.6%","d":"up"},{"l":"CAPAs Pendentes","v":"3.716","t":"+10.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.567","72.2%","4.574","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.817","82.1%","6.857","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.619","83.2%","976","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.724","92.9%","2.796","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.158","76.7%","7.212","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":550},{"label":"Mar","value":741},{"label":"Abr","value":823},{"label":"Mai","value":643},{"label":"Jun","value":905},{"label":"Jul","value":806},{"label":"Ago","value":768},{"label":"Set","value":768},{"label":"Out","value":718},{"label":"Nov","value":567},{"label":"Dez","value":772}];
const MX = 905;
