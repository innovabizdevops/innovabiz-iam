...
const KPIS = [{"l":"Total Print On Demand","v":"8.659","t":"+1.6%","d":"up"},{"l":"Cost Track Ativos","v":"7.701","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+7.4%","d":"up"}];
const COLS = ["ID","Cost Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print On Demand #001","Print On Demand #002","8.531","5.203","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Print On Demand #002","Print On Demand #003","3.265","592","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Print On Demand #003","Print On Demand #004","3.246","3.183","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Print On Demand #004","Print On Demand #005","873","3.368","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print On Demand #005","Print On Demand #001","1.448","5.501","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":842},{"label":"Mar","value":858},{"label":"Abr","value":696},{"label":"Mai","value":636},{"label":"Jun","value":696},{"label":"Jul","value":718},{"label":"Ago","value":688},{"label":"Set","value":995},{"label":"Out","value":703},{"label":"Nov","value":746},{"label":"Dez","value":728}];
const MX = 995;
