...
const KPIS = [{"l":"Total Print On Demand","v":"6.645","t":"+3.0%","d":"up"},{"l":"Print Queue Ativos","v":"2.939","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"69.1%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"93","t":"-5.1%","d":"down"}];
const COLS = ["ID","Print Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print On Demand #001","Print On Demand #002","2.960","6.923","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Print On Demand #002","Print On Demand #003","4.621","634","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Print On Demand #003","Print On Demand #004","5.270","2.571","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Print On Demand #004","Print On Demand #005","5.859","4.116","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print On Demand #005","Print On Demand #001","8.990","3.265","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":374},{"label":"Mar","value":270},{"label":"Abr","value":580},{"label":"Mai","value":314},{"label":"Jun","value":529},{"label":"Jul","value":604},{"label":"Ago","value":323},{"label":"Set","value":628},{"label":"Out","value":341},{"label":"Nov","value":415},{"label":"Dez","value":261}];
const MX = 628;
