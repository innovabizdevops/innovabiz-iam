...
const ACCENT = "#b45309";
const MODULE = "Print on Demand";
const PAGE = "Order Receive";
const KPIS = [{"l":"Total Print On Demand","v":"6.449","t":"+13.8%","d":"up"},{"l":"Order Receive Ativos","v":"214","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"78","t":"-4.5%","d":"down"}];
const COLS = ["ID","Order Receive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print On Demand #001","Print On Demand #002","2.247","5.258","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Print On Demand #002","Print On Demand #003","5.961","4.912","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Print On Demand #003","Print On Demand #004","8.016","276","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Print On Demand #004","Print On Demand #005","4.958","3.416","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print On Demand #005","Print On Demand #001","2.638","8.928","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":495},{"label":"Mar","value":371},{"label":"Abr","value":633},{"label":"Mai","value":413},{"label":"Jun","value":412},{"label":"Jul","value":400},{"label":"Ago","value":381},{"label":"Set","value":542},{"label":"Out","value":619},{"label":"Nov","value":347},{"label":"Dez","value":339}];
const MX = 675;
