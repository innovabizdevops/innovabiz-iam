...
/* ═══ MAM Agent Economy — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "7383", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "895", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€282K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1913528783", cells: ["MAM-3783", "MAM Agent Economy Item 1", "20/12/2026", "€28 883"], status: "active" as const },
    { id: "1913532354", cells: ["MAM-7354", "MAM Agent Economy Item 2", "7/7/2026", "€32 454"], status: "pending" as const },
    { id: "1913535925", cells: ["MAM-1925", "MAM Agent Economy Item 3", "22/2/2026", "€36 025"], status: "completed" as const },
    { id: "1913539496", cells: ["MAM-5496", "MAM Agent Economy Item 4", "9/9/2026", "€39 596"], status: "warning" as const },
    { id: "1913543067", cells: ["MAM-9067", "MAM Agent Economy Item 5", "24/4/2026", "€43 167"], status: "active" as const },
];
...
export default function MamAgentEconomyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MAM Agent Economy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MAM Agent Economy</p>
                    </div>
                </div>
