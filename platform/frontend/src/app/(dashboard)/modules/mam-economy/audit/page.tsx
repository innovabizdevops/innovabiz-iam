...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.307","t":"+14.3%","d":"up"},{"l":"NC Abertas","v":"7.071","t":"+6.1%","d":"up"},{"l":"Conformidade (%)","v":"70.7%","t":"+10.2%","d":"up"},{"l":"CAPAs Pendentes","v":"7.385","t":"+17.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","631","99.6%","8.661","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.462","93.1%","4.079","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.830","70.7%","6.158","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.014","89.3%","3.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.166","71.5%","5.780","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":355},{"label":"Mar","value":368},{"label":"Abr","value":288},{"label":"Mai","value":299},{"label":"Jun","value":482},{"label":"Jul","value":398},{"label":"Ago","value":577},{"label":"Set","value":603},{"label":"Out","value":547},{"label":"Nov","value":344},{"label":"Dez","value":487}];
const MX = 603;
