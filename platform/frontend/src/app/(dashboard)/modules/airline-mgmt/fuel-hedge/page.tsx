...
/* ═══ Airline Mgmt — Fuel Hedge ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "2002", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "300", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2793", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1501245496", cells: ["AIR-1496", "Fuel Hedge Item 1", "17/5/2026", "€45 596"], status: "active" as const },
    { id: "1501249067", cells: ["AIR-5067", "Fuel Hedge Item 2", "4/12/2026", "€49 167"], status: "pending" as const },
    { id: "1501252638", cells: ["AIR-8638", "Fuel Hedge Item 3", "19/7/2026", "€2738"], status: "completed" as const },
    { id: "1501256209", cells: ["AIR-3209", "Fuel Hedge Item 4", "6/2/2026", "€6309"], status: "warning" as const },
    { id: "1501259780", cells: ["AIR-6780", "Fuel Hedge Item 5", "21/9/2026", "€9880"], status: "active" as const },
];
...
export default function AirlineMgmtFuelHedgePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fuel Hedge</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Fuel Hedge</p>
                    </div>
                </div>
