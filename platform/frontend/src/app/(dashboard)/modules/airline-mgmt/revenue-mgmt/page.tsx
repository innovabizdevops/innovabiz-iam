...
/* ═══ Airline Mgmt — Revenue Mgmt ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "3622", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "294", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3003", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "264514626", cells: ["AIR-5626", "Revenue Mgmt Item 1", "27/7/2026", "€14 726"], status: "active" as const },
    { id: "264518197", cells: ["AIR-9197", "Revenue Mgmt Item 2", "14/2/2026", "€18 297"], status: "pending" as const },
    { id: "264521768", cells: ["AIR-3768", "Revenue Mgmt Item 3", "1/9/2026", "€21 868"], status: "completed" as const },
    { id: "264525339", cells: ["AIR-7339", "Revenue Mgmt Item 4", "16/4/2026", "€25 439"], status: "warning" as const },
    { id: "264528910", cells: ["AIR-1910", "Revenue Mgmt Item 5", "3/11/2026", "€29 010"], status: "active" as const },
];
...
export default function AirlineMgmtRevenueMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Revenue Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Revenue Mgmt</p>
                    </div>
                </div>
