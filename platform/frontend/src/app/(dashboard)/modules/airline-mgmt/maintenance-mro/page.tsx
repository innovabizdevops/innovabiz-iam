...
/* ═══ Airline Mgmt — Maintenance Mro ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "3165", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "484", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2956", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "927958464", cells: ["AIR-5464", "Maintenance Mro Item 1", "21/1/2026", "€8564"], status: "active" as const },
    { id: "927962035", cells: ["AIR-9035", "Maintenance Mro Item 2", "8/8/2026", "€12 135"], status: "pending" as const },
    { id: "927965606", cells: ["AIR-3606", "Maintenance Mro Item 3", "23/3/2026", "€15 706"], status: "completed" as const },
    { id: "927969177", cells: ["AIR-7177", "Maintenance Mro Item 4", "10/10/2026", "€19 277"], status: "warning" as const },
    { id: "927972748", cells: ["AIR-1748", "Maintenance Mro Item 5", "25/5/2026", "€22 848"], status: "active" as const },
];
...
export default function AirlineMgmtMaintenanceMroPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maintenance Mro</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Maintenance Mro</p>
                    </div>
                </div>
