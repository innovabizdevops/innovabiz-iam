...
/* ═══ Airline Mgmt — Crew Schedule ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "2794", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "347", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1924", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1229776807", cells: ["AIR-8807", "Crew Schedule Item 1", "8/8/2026", "€26 907"], status: "active" as const },
    { id: "1229780378", cells: ["AIR-3378", "Crew Schedule Item 2", "23/3/2026", "€30 478"], status: "pending" as const },
    { id: "1229783949", cells: ["AIR-6949", "Crew Schedule Item 3", "10/10/2026", "€34 049"], status: "completed" as const },
    { id: "1229787520", cells: ["AIR-1520", "Crew Schedule Item 4", "25/5/2026", "€37 620"], status: "warning" as const },
    { id: "1229791091", cells: ["AIR-5091", "Crew Schedule Item 5", "12/12/2026", "€41 191"], status: "active" as const },
];
...
export default function AirlineMgmtCrewSchedulePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crew Schedule</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Crew Schedule</p>
                    </div>
                </div>
