...
/* ═══ Airline Mgmt — Route Network ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "2708", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "378", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3006", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "198515462", cells: ["AIR-3462", "Route Network Item 1", "27/3/2026", "€15 562"], status: "active" as const },
    { id: "198519033", cells: ["AIR-7033", "Route Network Item 2", "14/10/2026", "€19 133"], status: "pending" as const },
    { id: "198522604", cells: ["AIR-1604", "Route Network Item 3", "1/5/2026", "€22 704"], status: "completed" as const },
    { id: "198526175", cells: ["AIR-5175", "Route Network Item 4", "16/12/2026", "€26 275"], status: "warning" as const },
    { id: "198529746", cells: ["AIR-8746", "Route Network Item 5", "3/7/2026", "€29 846"], status: "active" as const },
];
...
export default function AirlineMgmtRouteNetworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Route Network</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Route Network</p>
                    </div>
                </div>
