...
/* ═══ Airline Mgmt — Fleet Plan ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "2961", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "300", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2842", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1038197752", cells: ["AIR-3752", "Fleet Plan Item 1", "5/5/2026", "€47 852"], status: "active" as const },
    { id: "1038201323", cells: ["AIR-7323", "Fleet Plan Item 2", "20/12/2026", "€1423"], status: "pending" as const },
    { id: "1038204894", cells: ["AIR-1894", "Fleet Plan Item 3", "7/7/2026", "€4994"], status: "completed" as const },
    { id: "1038208465", cells: ["AIR-5465", "Fleet Plan Item 4", "22/2/2026", "€8565"], status: "warning" as const },
    { id: "1038212036", cells: ["AIR-9036", "Fleet Plan Item 5", "9/9/2026", "€12 136"], status: "active" as const },
];
...
export default function AirlineMgmtFleetPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fleet Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Fleet Plan</p>
                    </div>
                </div>
