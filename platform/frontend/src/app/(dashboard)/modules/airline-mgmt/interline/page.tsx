...
/* ═══ Airline Mgmt — Interline ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "3252", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "497", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3513", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2029347309", cells: ["AIR-1309", "Interline Item 1", "18/10/2026", "€47 409"], status: "active" as const },
    { id: "2029350880", cells: ["AIR-4880", "Interline Item 2", "5/5/2026", "€980"], status: "pending" as const },
    { id: "2029354451", cells: ["AIR-8451", "Interline Item 3", "20/12/2026", "€4551"], status: "completed" as const },
    { id: "2029358022", cells: ["AIR-3022", "Interline Item 4", "7/7/2026", "€8122"], status: "warning" as const },
    { id: "2029361593", cells: ["AIR-6593", "Interline Item 5", "22/2/2026", "€11 693"], status: "active" as const },
];
...
export default function AirlineMgmtInterlinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Interline</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Interline</p>
                    </div>
                </div>
