...
/* ═══ Airline Mgmt — Catering Ops ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "2950", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "342", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1071", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1742795058", cells: ["AIR-9058", "Catering Ops Item 1", "19/7/2026", "€45 158"], status: "active" as const },
    { id: "1742798629", cells: ["AIR-3629", "Catering Ops Item 2", "6/2/2026", "€48 729"], status: "pending" as const },
    { id: "1742802200", cells: ["AIR-7200", "Catering Ops Item 3", "21/9/2026", "€2300"], status: "completed" as const },
    { id: "1742805771", cells: ["AIR-1771", "Catering Ops Item 4", "8/4/2026", "€5871"], status: "warning" as const },
    { id: "1742809342", cells: ["AIR-5342", "Catering Ops Item 5", "23/11/2026", "€9442"], status: "active" as const },
];
...
export default function AirlineMgmtCateringOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catering Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Catering Ops</p>
                    </div>
                </div>
