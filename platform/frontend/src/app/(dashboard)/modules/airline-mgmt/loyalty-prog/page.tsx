...
/* ═══ Airline Mgmt — Loyalty Prog ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "48", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "437", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3069", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1540209905", cells: ["AIR-4905", "Loyalty Prog Item 1", "18/6/2026", "€10 005"], status: "active" as const },
    { id: "1540213476", cells: ["AIR-8476", "Loyalty Prog Item 2", "5/1/2026", "€13 576"], status: "pending" as const },
    { id: "1540217047", cells: ["AIR-3047", "Loyalty Prog Item 3", "20/8/2026", "€17 147"], status: "completed" as const },
    { id: "1540220618", cells: ["AIR-6618", "Loyalty Prog Item 4", "7/3/2026", "€20 718"], status: "warning" as const },
    { id: "1540224189", cells: ["AIR-1189", "Loyalty Prog Item 5", "22/10/2026", "€24 289"], status: "active" as const },
];
...
export default function AirlineMgmtLoyaltyProgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loyalty Prog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Loyalty Prog</p>
                    </div>
                </div>
