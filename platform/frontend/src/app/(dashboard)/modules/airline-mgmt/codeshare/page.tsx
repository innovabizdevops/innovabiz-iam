...
/* ═══ Airline Mgmt — Codeshare ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "4280", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "329", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1459", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "653894997", cells: ["AIR-9997", "Codeshare Item 1", "22/10/2026", "€45 097"], status: "active" as const },
    { id: "653898568", cells: ["AIR-4568", "Codeshare Item 2", "9/5/2026", "€48 668"], status: "pending" as const },
    { id: "653902139", cells: ["AIR-8139", "Codeshare Item 3", "24/12/2026", "€2239"], status: "completed" as const },
    { id: "653905710", cells: ["AIR-2710", "Codeshare Item 4", "11/7/2026", "€5810"], status: "warning" as const },
    { id: "653909281", cells: ["AIR-6281", "Codeshare Item 5", "26/2/2026", "€9381"], status: "active" as const },
];
...
export default function AirlineMgmtCodesharePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Codeshare</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Airline Mgmt • Codeshare</p>
                    </div>
                </div>
