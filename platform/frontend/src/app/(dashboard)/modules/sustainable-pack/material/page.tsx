...
const ACCENT = "#ca8a04";
const MODULE = "Sustainable Packaging";
const PAGE = "Material";
const KPIS = [{"l":"Total Sustainable Pack","v":"1.906","t":"+16.0%","d":"up"},{"l":"Material Ativos","v":"6.152","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"78.8%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+8.6%","d":"up"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sustainable Pack #001","Sustainable Pack #002","8.971","2.290","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Sustainable Pack #002","Sustainable Pack #003","7.898","1.187","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Sustainable Pack #003","Sustainable Pack #004","8.317","2.083","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Sustainable Pack #004","Sustainable Pack #005","8.547","5.759","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sustainable Pack #005","Sustainable Pack #001","1.864","5.447","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":751},{"label":"Mar","value":478},{"label":"Abr","value":383},{"label":"Mai","value":739},{"label":"Jun","value":614},{"label":"Jul","value":487},{"label":"Ago","value":604},{"label":"Set","value":389},{"label":"Out","value":753},{"label":"Nov","value":400},{"label":"Dez","value":382}];
const MX = 771;
