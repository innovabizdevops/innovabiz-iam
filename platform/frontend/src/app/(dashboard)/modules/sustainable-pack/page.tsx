...
/* ═══ Sustainable Packaging — Dashboard ═══ */

const ACCENT = "#ca8a04";

const KPIS = [
    { label: "Total Registos", value: "752", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1312", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€167K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1272932752", cells: ["SUS-9752", "Sustainable Packaging Item 1", "1/5/2026", "€32 852"], status: "active" as const },
    { id: "1272936323", cells: ["SUS-4323", "Sustainable Packaging Item 2", "16/12/2026", "€36 423"], status: "pending" as const },
    { id: "1272939894", cells: ["SUS-7894", "Sustainable Packaging Item 3", "3/7/2026", "€39 994"], status: "completed" as const },
    { id: "1272943465", cells: ["SUS-2465", "Sustainable Packaging Item 4", "18/2/2026", "€43 565"], status: "warning" as const },
    { id: "1272947036", cells: ["SUS-6036", "Sustainable Packaging Item 5", "5/9/2026", "€47 136"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sustainable Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sustainable Packaging</p>
                    </div>
                </div>
