...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.292","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"4669","t":"+4.7%","d":"up"},{"l":"Documentos Gerados","v":"5.495","t":"+12.1%","d":"up"},{"l":"Templates","v":"3.279","t":"-5.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.821","2026-01-03","658","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.023","2026-01-18","2.766","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.628","2026-02-24","1.980","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","910","2026-02-09","7.424","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.964","2026-03-13","6.996","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":831},{"label":"Mar","value":674},{"label":"Abr","value":689},{"label":"Mai","value":697},{"label":"Jun","value":864},{"label":"Jul","value":853},{"label":"Ago","value":856},{"label":"Set","value":906},{"label":"Out","value":780},{"label":"Nov","value":584},{"label":"Dez","value":868}];
const MX = 906;
