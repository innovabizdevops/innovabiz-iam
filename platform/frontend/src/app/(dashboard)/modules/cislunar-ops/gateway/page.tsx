...
const PAGE = "Lunar Gateway";
const KPIS = [{"l":"Integrações Ativas","v":"1.950","t":"+7.4%","d":"up"},{"l":"Chamadas/Hora","v":"177","t":"+4.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.0%","t":"-5.6%","d":"down"},{"l":"Latência Média (ms)","v":"155ms","t":"+5.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.467","2.853","91.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.552","1.951","71.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","727","6.319","96.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.137","3.165","71.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.091","8.224","90.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":810},{"label":"Mar","value":595},{"label":"Abr","value":611},{"label":"Mai","value":478},{"label":"Jun","value":627},{"label":"Jul","value":607},{"label":"Ago","value":603},{"label":"Set","value":434},{"label":"Out","value":667},{"label":"Nov","value":559},{"label":"Dez","value":558}];
const MX = 810;
