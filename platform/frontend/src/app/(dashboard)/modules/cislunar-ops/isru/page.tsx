...
const PAGE = "Resource ISRU";
const KPIS = [{"l":"Total Cislunar Ops","v":"2.642","t":"-3.3%","d":"down"},{"l":"Resource ISRU Ativos","v":"177","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"92","t":"+14.1%","d":"up"}];
const COLS = ["ID","Resource ISRU","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cislunar Ops #001","Cislunar Ops #002","3.303","333","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cislunar Ops #002","Cislunar Ops #003","2.254","584","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cislunar Ops #003","Cislunar Ops #004","769","2.641","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Cislunar Ops #004","Cislunar Ops #005","2.985","7.980","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cislunar Ops #005","Cislunar Ops #001","2.001","5.816","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":677},{"label":"Mar","value":469},{"label":"Abr","value":544},{"label":"Mai","value":515},{"label":"Jun","value":581},{"label":"Jul","value":575},{"label":"Ago","value":453},{"label":"Set","value":602},{"label":"Out","value":633},{"label":"Nov","value":611},{"label":"Dez","value":417}];
const MX = 677;
