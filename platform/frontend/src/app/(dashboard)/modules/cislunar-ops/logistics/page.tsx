...
const KPIS = [{"l":"Total Cislunar Ops","v":"8.137","t":"-2.6%","d":"down"},{"l":"Logistics Ativos","v":"4.598","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+4.6%","d":"up"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cislunar Ops #001","Cislunar Ops #002","8.801","6.412","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Cislunar Ops #002","Cislunar Ops #003","1.724","607","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Cislunar Ops #003","Cislunar Ops #004","5.317","3.557","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Cislunar Ops #004","Cislunar Ops #005","7.151","9.054","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cislunar Ops #005","Cislunar Ops #001","9.020","6.961","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":690},{"label":"Mar","value":567},{"label":"Abr","value":729},{"label":"Mai","value":590},{"label":"Jun","value":651},{"label":"Jul","value":590},{"label":"Ago","value":614},{"label":"Set","value":477},{"label":"Out","value":395},{"label":"Nov","value":695},{"label":"Dez","value":660}];
const MX = 729;
