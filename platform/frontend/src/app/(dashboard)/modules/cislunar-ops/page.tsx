...
export default function CislunarOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cislunar Ops</h1><p className="text-sm text-muted-foreground">Cislunar Ops • iBOS Enterprise</p></div>
