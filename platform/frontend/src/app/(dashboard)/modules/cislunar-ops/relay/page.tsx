...
const ACCENT = "#059669";
const MODULE = "Cislunar Operations";
const PAGE = "Comm Relay";
const KPIS = [{"l":"Total Cislunar Ops","v":"3.050","t":"-5.4%","d":"down"},{"l":"Comm Relay Ativos","v":"921","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"57","t":"+0.8%","d":"up"}];
const COLS = ["ID","Comm Relay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cislunar Ops #001","Cislunar Ops #002","6.728","6.951","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cislunar Ops #002","Cislunar Ops #003","3.053","1.652","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Cislunar Ops #003","Cislunar Ops #004","5.517","8.643","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Cislunar Ops #004","Cislunar Ops #005","4.393","1.651","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cislunar Ops #005","Cislunar Ops #001","4.112","758","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1002},{"label":"Fev","value":897},{"label":"Mar","value":740},{"label":"Abr","value":937},{"label":"Mai","value":986},{"label":"Jun","value":679},{"label":"Jul","value":745},{"label":"Ago","value":1050},{"label":"Set","value":978},{"label":"Out","value":969},{"label":"Nov","value":819},{"label":"Dez","value":703}];
const MX = 1050;
