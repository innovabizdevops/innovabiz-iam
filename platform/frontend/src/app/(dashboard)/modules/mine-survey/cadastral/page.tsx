...
const ACCENT = "#6366f1";
const MODULE = "Mine Surveying";
const PAGE = "Cadastral";
const KPIS = [{"l":"Surveys Ativos","v":"7.773","t":"+11.5%","d":"up"},{"l":"Respostas/Semana","v":"2879","t":"-4.3%","d":"down"},{"l":"NPS Médio","v":"79","t":"+3.5%","d":"up"},{"l":"Taxa Resposta (%)","v":"70.6%","t":"+7.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.128","69","81.9%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.503","79","96.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.176","66","74.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.283","85","84.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.100","88","74.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":493},{"label":"Mar","value":704},{"label":"Abr","value":543},{"label":"Mai","value":334},{"label":"Jun","value":685},{"label":"Jul","value":479},{"label":"Ago","value":581},{"label":"Set","value":627},{"label":"Out","value":331},{"label":"Nov","value":491},{"label":"Dez","value":502}];
const MX = 704;
...
export default function CadastralPage() {
    return (
