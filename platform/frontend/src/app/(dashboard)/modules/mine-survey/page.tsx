...
export default function MineSurveyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mine Survey</h1><p className="text-sm text-muted-foreground">Mine Survey • iBOS Enterprise</p></div>
