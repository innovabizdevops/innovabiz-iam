...
const PAGE = "Drone";
const KPIS = [{"l":"Surveys Ativos","v":"8.522","t":"-3.1%","d":"down"},{"l":"Respostas/Semana","v":"3346","t":"+11.4%","d":"up"},{"l":"NPS Médio","v":"57","t":"+4.9%","d":"up"},{"l":"Taxa Resposta (%)","v":"74.6%","t":"+14.8%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","4.850","77","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.032","86","85.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.919","77","86.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.825","63","77.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.354","62","95.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":804},{"label":"Mar","value":867},{"label":"Abr","value":693},{"label":"Mai","value":797},{"label":"Jun","value":906},{"label":"Jul","value":817},{"label":"Ago","value":696},{"label":"Set","value":918},{"label":"Out","value":729},{"label":"Nov","value":834},{"label":"Dez","value":734}];
const MX = 918;
