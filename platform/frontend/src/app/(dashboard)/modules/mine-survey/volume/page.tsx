...
const PAGE = "Volume";
const KPIS = [{"l":"Surveys Ativos","v":"8.607","t":"+8.8%","d":"up"},{"l":"Respostas/Semana","v":"4436","t":"-5.2%","d":"down"},{"l":"NPS Médio","v":"66","t":"+8.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"93.9%","t":"+16.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.946","70","83.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.757","94","78.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.217","66","71.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.936","95","80.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","912","68","84.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":898},{"label":"Mar","value":805},{"label":"Abr","value":906},{"label":"Mai","value":927},{"label":"Jun","value":964},{"label":"Jul","value":991},{"label":"Ago","value":815},{"label":"Set","value":1026},{"label":"Out","value":984},{"label":"Nov","value":789},{"label":"Dez","value":821}];
const MX = 1026;
