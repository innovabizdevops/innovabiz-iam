...
const PAGE = "LiDAR";
const KPIS = [{"l":"Surveys Ativos","v":"1.915","t":"+1.3%","d":"up"},{"l":"Respostas/Semana","v":"391","t":"+12.4%","d":"up"},{"l":"NPS Médio","v":"93","t":"+13.6%","d":"up"},{"l":"Taxa Resposta (%)","v":"83.7%","t":"+8.5%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","8.295","70","76.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.458","75","71.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.746","67","71.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.033","78","70.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","956","66","96.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":859},{"label":"Mar","value":636},{"label":"Abr","value":845},{"label":"Mai","value":936},{"label":"Jun","value":936},{"label":"Jul","value":890},{"label":"Ago","value":674},{"label":"Set","value":601},{"label":"Out","value":920},{"label":"Nov","value":742},{"label":"Dez","value":692}];
const MX = 936;
