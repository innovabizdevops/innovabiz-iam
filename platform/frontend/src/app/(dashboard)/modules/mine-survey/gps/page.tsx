...
const PAGE = "GPS/GNSS";
const KPIS = [{"l":"Surveys Ativos","v":"7.908","t":"+10.4%","d":"up"},{"l":"Respostas/Semana","v":"5040","t":"+17.2%","d":"up"},{"l":"NPS Médio","v":"79","t":"-3.1%","d":"down"},{"l":"Taxa Resposta (%)","v":"76.3%","t":"+8.1%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.122","72","71.1%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","156","90","73.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.385","76","87.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","273","81","88.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.516","83","81.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":733},{"label":"Mar","value":716},{"label":"Abr","value":889},{"label":"Mai","value":783},{"label":"Jun","value":812},{"label":"Jul","value":929},{"label":"Ago","value":723},{"label":"Set","value":659},{"label":"Out","value":554},{"label":"Nov","value":711},{"label":"Dez","value":926}];
const MX = 929;
