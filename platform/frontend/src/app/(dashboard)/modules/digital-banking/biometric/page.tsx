...
const PAGE = "Biometric Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.991","t":"-3.6%","d":"down"},{"l":"Sessões/Dia","v":"691","t":"+9.9%","d":"up"},{"l":"MFA Adoção (%)","v":"65.5%","t":"+16.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.574","t":"+5.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.806","6.149","1.190","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.909","5.859","1.621","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.227","4.421","8.971","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","109","5.873","5.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.164","8.673","3.995","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":350},{"label":"Mar","value":355},{"label":"Abr","value":589},{"label":"Mai","value":353},{"label":"Jun","value":547},{"label":"Jul","value":294},{"label":"Ago","value":536},{"label":"Set","value":528},{"label":"Out","value":360},{"label":"Nov","value":453},{"label":"Dez","value":499}];
const MX = 589;
