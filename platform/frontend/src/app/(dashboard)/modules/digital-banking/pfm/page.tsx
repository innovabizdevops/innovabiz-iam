...
const ACCENT = "#ec4899";
const MODULE = "Digital Banking";
const PAGE = "PFM Tools";
const KPIS = [{"l":"Total Digital Banking","v":"4.510","t":"+16.7%","d":"up"},{"l":"PFM Tools Ativos","v":"8.687","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"58","t":"+5.4%","d":"up"}];
const COLS = ["ID","PFM Tools","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Banking #001","Digital Banking #002","6.236","8.012","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Banking #002","Digital Banking #003","4.984","5.962","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Banking #003","Digital Banking #004","6.929","3.989","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Banking #004","Digital Banking #005","4.646","1.128","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Banking #005","Digital Banking #001","7.083","699","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":927},{"label":"Mar","value":758},{"label":"Abr","value":1070},{"label":"Mai","value":740},{"label":"Jun","value":945},{"label":"Jul","value":878},{"label":"Ago","value":804},{"label":"Set","value":806},{"label":"Out","value":912},{"label":"Nov","value":985},{"label":"Dez","value":1002}];
const MX = 1070;
