...
const PAGE = "BNPL Engine";
const KPIS = [{"l":"Total Digital Banking","v":"1.309","t":"-4.6%","d":"down"},{"l":"BNPL Engine Ativos","v":"3.871","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"82","t":"+3.3%","d":"up"}];
const COLS = ["ID","BNPL Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Banking #001","Digital Banking #002","1.666","8.174","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Banking #002","Digital Banking #003","5.395","745","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Banking #003","Digital Banking #004","8.951","7.923","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Banking #004","Digital Banking #005","6.552","628","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Banking #005","Digital Banking #001","7.782","1.151","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":485},{"label":"Mar","value":401},{"label":"Abr","value":417},{"label":"Mai","value":216},{"label":"Jun","value":584},{"label":"Jul","value":324},{"label":"Ago","value":508},{"label":"Set","value":607},{"label":"Out","value":514},{"label":"Nov","value":376},{"label":"Dez","value":387}];
const MX = 607;
