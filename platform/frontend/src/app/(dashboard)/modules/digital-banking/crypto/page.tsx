...
const PAGE = "Crypto Custody";
const KPIS = [{"l":"Total Digital Banking","v":"5.870","t":"+17.6%","d":"up"},{"l":"Crypto Custody Ativos","v":"€39283","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"58","t":"-0.3%","d":"down"}];
const COLS = ["ID","Crypto Custody","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Banking #001","€ 48706.36","5.131","8.647","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Banking #002","€ 33634.45","7.512","4.554","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Banking #003","€ 18165.27","6.992","4.887","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Banking #004","€ 30706.52","7.864","156","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Banking #005","€ 45620.62","3.015","2.996","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":580},{"label":"Mar","value":339},{"label":"Abr","value":289},{"label":"Mai","value":390},{"label":"Jun","value":470},{"label":"Jul","value":289},{"label":"Ago","value":357},{"label":"Set","value":652},{"label":"Out","value":426},{"label":"Nov","value":361},{"label":"Dez","value":660}];
const MX = 660;
