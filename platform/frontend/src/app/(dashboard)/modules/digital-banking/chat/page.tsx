...
const PAGE = "Chat Support";
const KPIS = [{"l":"Tickets Abertos","v":"1.455","t":"+12.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.3%","t":"-4.6%","d":"down"},{"l":"MTTR (h)","v":"163h","t":"-4.6%","d":"down"},{"l":"Satisfação (%)","v":"91.9%","t":"+10.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.514","8.484","1.299","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","247","4.225","545","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.240","7.499","2.916","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.941","3.960","1.667","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.793","6.825","5.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":582},{"label":"Mar","value":709},{"label":"Abr","value":815},{"label":"Mai","value":787},{"label":"Jun","value":829},{"label":"Jul","value":617},{"label":"Ago","value":504},{"label":"Set","value":674},{"label":"Out","value":662},{"label":"Nov","value":723},{"label":"Dez","value":763}];
const MX = 829;
