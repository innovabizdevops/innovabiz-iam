...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Edge Deployment";
const PAGE = "Deploy";
const KPIS = [{"l":"Total Genai Edge","v":"704","t":"+14.4%","d":"up"},{"l":"Deploy Ativos","v":"7.577","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"91","t":"+5.6%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Edge #001","Genai Edge #002","6.536","726","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Edge #002","Genai Edge #003","5.136","6.876","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Edge #003","Genai Edge #004","7.472","3.676","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Edge #004","Genai Edge #005","615","5.721","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Edge #005","Genai Edge #001","8.117","5.249","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":387},{"label":"Mar","value":307},{"label":"Abr","value":392},{"label":"Mai","value":695},{"label":"Jun","value":484},{"label":"Jul","value":447},{"label":"Ago","value":683},{"label":"Set","value":409},{"label":"Out","value":456},{"label":"Nov","value":425},{"label":"Dez","value":385}];
const MX = 695;
