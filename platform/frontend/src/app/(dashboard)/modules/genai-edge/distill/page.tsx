...
const PAGE = "Distill";
const KPIS = [{"l":"Total Genai Edge","v":"2.388","t":"+10.5%","d":"up"},{"l":"Distill Ativos","v":"1.499","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+8.3%","d":"up"}];
const COLS = ["ID","Distill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Edge #001","Genai Edge #002","501","9.004","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Edge #002","Genai Edge #003","1.155","7.693","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Edge #003","Genai Edge #004","681","881","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Edge #004","Genai Edge #005","5.018","9.057","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Edge #005","Genai Edge #001","8.568","5.183","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":430},{"label":"Mar","value":461},{"label":"Abr","value":437},{"label":"Mai","value":568},{"label":"Jun","value":722},{"label":"Jul","value":546},{"label":"Ago","value":479},{"label":"Set","value":391},{"label":"Out","value":651},{"label":"Nov","value":700},{"label":"Dez","value":456}];
const MX = 722;
