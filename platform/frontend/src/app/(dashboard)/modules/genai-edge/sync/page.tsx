...
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"7.087","t":"+17.3%","d":"up"},{"l":"Chamadas/Hora","v":"3545","t":"-2.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"67.8%","t":"-3.7%","d":"down"},{"l":"Latência Média (ms)","v":"134ms","t":"+7.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.655","3.156","75.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.452","2.202","98.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.989","2.266","79.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.325","8.272","94.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.750","7.514","91.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":611},{"label":"Mar","value":697},{"label":"Abr","value":957},{"label":"Mai","value":748},{"label":"Jun","value":610},{"label":"Jul","value":987},{"label":"Ago","value":687},{"label":"Set","value":905},{"label":"Out","value":995},{"label":"Nov","value":957},{"label":"Dez","value":726}];
const MX = 995;
