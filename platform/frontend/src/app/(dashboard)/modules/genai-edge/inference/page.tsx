...
const KPIS = [{"l":"Total Genai Edge","v":"7.841","t":"-4.6%","d":"down"},{"l":"Inference Ativos","v":"4.444","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"78","t":"-3.3%","d":"down"}];
const COLS = ["ID","Inference","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Edge #001","Genai Edge #002","7.065","7.460","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Edge #002","Genai Edge #003","1.302","2.863","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Edge #003","Genai Edge #004","6.220","7.948","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Edge #004","Genai Edge #005","1.580","3.356","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Edge #005","Genai Edge #001","8.888","2.215","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":820},{"label":"Mar","value":695},{"label":"Abr","value":862},{"label":"Mai","value":908},{"label":"Jun","value":730},{"label":"Jul","value":771},{"label":"Ago","value":818},{"label":"Set","value":857},{"label":"Out","value":740},{"label":"Nov","value":1010},{"label":"Dez","value":879}];
const MX = 1010;
