...
/* ═══ GenAI Edge Deployment — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "1543", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1660", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€93K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "166667943", cells: ["GEN-6943", "GenAI Edge Deployment Item 1", "16/4/2026", "€18 043"], status: "active" as const },
    { id: "166671514", cells: ["GEN-1514", "GenAI Edge Deployment Item 2", "3/11/2026", "€21 614"], status: "pending" as const },
    { id: "166675085", cells: ["GEN-5085", "GenAI Edge Deployment Item 3", "18/6/2026", "€25 185"], status: "completed" as const },
    { id: "166678656", cells: ["GEN-8656", "GenAI Edge Deployment Item 4", "5/1/2026", "€28 756"], status: "warning" as const },
    { id: "166682227", cells: ["GEN-3227", "GenAI Edge Deployment Item 5", "20/8/2026", "€32 327"], status: "active" as const },
];
...
export default function GenaiEdgeDeploymentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Edge Deployment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Edge Deployment</p>
                    </div>
                </div>
