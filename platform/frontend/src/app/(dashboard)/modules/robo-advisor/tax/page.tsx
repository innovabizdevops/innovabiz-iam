...
const PAGE = "Tax Harvest";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.155","t":"+7.8%","d":"up"},{"l":"NC Abertas","v":"4.133","t":"+4.2%","d":"up"},{"l":"Conformidade (%)","v":"69.5%","t":"+16.5%","d":"up"},{"l":"CAPAs Pendentes","v":"941","t":"+12.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.515","80.6%","7.818","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.945","85.1%","5.098","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.013","73.7%","6.898","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.448","71.1%","7.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","741","77.0%","4.941","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":509},{"label":"Mar","value":855},{"label":"Abr","value":595},{"label":"Mai","value":746},{"label":"Jun","value":826},{"label":"Jul","value":575},{"label":"Ago","value":838},{"label":"Set","value":872},{"label":"Out","value":556},{"label":"Nov","value":693},{"label":"Dez","value":822}];
const MX = 872;
