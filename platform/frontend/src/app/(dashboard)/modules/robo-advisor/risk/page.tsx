...
const PAGE = "Risk Profile";
const KPIS = [{"l":"Riscos Identificados","v":"3.057","t":"+0.1%","d":"up"},{"l":"Mitigações Ativas","v":"8.465","t":"-2.7%","d":"down"},{"l":"Score Risco Geral","v":"82","t":"+14.3%","d":"up"},{"l":"Incidentes YTD","v":"1.671","t":"+15.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.808","109","3.688","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.168","8.317","8.396","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.882","8.150","7.794","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.520","7.416","7.769","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.876","630","8.398","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":617},{"label":"Mar","value":666},{"label":"Abr","value":846},{"label":"Mai","value":767},{"label":"Jun","value":975},{"label":"Jul","value":713},{"label":"Ago","value":977},{"label":"Set","value":949},{"label":"Out","value":928},{"label":"Nov","value":860},{"label":"Dez","value":995}];
const MX = 995;
