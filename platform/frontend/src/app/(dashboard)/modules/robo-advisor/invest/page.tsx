...
const ACCENT = "#16a34a";
const MODULE = "Robo-Advisor";
const PAGE = "Auto Invest";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.677","t":"+5.4%","d":"up"},{"l":"NC Abertas","v":"7.859","t":"+7.1%","d":"up"},{"l":"Conformidade (%)","v":"65.1%","t":"+12.3%","d":"up"},{"l":"CAPAs Pendentes","v":"7.095","t":"-0.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","563","87.3%","3.215","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","163","73.3%","2.535","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","467","93.1%","8.478","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.993","92.0%","8.140","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.949","81.6%","7.419","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":759},{"label":"Mar","value":865},{"label":"Abr","value":958},{"label":"Mai","value":883},{"label":"Jun","value":678},{"label":"Jul","value":668},{"label":"Ago","value":615},{"label":"Set","value":597},{"label":"Out","value":865},{"label":"Nov","value":979},{"label":"Dez","value":946}];
const MX = 979;
