...
const ACCENT = "#4338ca";
const MODULE = "Search Engine";
const PAGE = "Vector Search";
const KPIS = [{"l":"Total Search Engine","v":"4.678","t":"+7.6%","d":"up"},{"l":"Vector Search Ativos","v":"3.670","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"56","t":"+1.0%","d":"up"}];
const COLS = ["ID","Vector Search","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Search Engine #001","Search Engine #002","4.647","4.550","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Search Engine #002","Search Engine #003","8.652","6.474","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Search Engine #003","Search Engine #004","6.026","2.764","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Search Engine #004","Search Engine #005","5.738","6.232","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Search Engine #005","Search Engine #001","7.678","6.630","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":662},{"label":"Mar","value":336},{"label":"Abr","value":355},{"label":"Mai","value":501},{"label":"Jun","value":399},{"label":"Jul","value":516},{"label":"Ago","value":433},{"label":"Set","value":413},{"label":"Out","value":625},{"label":"Nov","value":393},{"label":"Dez","value":624}];
const MX = 662;
