...
const ACCENT = "#1e40af";
const MODULE = "Sustainable Finance";
const PAGE = "Social Bond";
const KPIS = [{"l":"Total Sustainable Finance","v":"895","t":"+6.3%","d":"up"},{"l":"Social Bond Ativos","v":"4.002","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"65","t":"-0.6%","d":"down"}];
const COLS = ["ID","Social Bond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sustainable Finance #001","Sustainable Finance #002","8.554","5.392","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Sustainable Finance #002","Sustainable Finance #003","5.132","7.942","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Sustainable Finance #003","Sustainable Finance #004","6.510","5.818","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sustainable Finance #004","Sustainable Finance #005","188","8.920","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sustainable Finance #005","Sustainable Finance #001","5.032","7.361","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":627},{"label":"Mar","value":903},{"label":"Abr","value":623},{"label":"Mai","value":618},{"label":"Jun","value":632},{"label":"Jul","value":780},{"label":"Ago","value":611},{"label":"Set","value":537},{"label":"Out","value":868},{"label":"Nov","value":583},{"label":"Dez","value":886}];
const MX = 903;
