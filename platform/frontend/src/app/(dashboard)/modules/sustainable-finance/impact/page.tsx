...
const PAGE = "Impact Fund";
const KPIS = [{"l":"Projetos Sociais","v":"1.123","t":"-2.4%","d":"down"},{"l":"Beneficiários","v":"5.302","t":"+16.9%","d":"up"},{"l":"Investimento CSR (€)","v":"€47766","t":"+2.3%","d":"up"},{"l":"Score Impacto","v":"71","t":"-5.0%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.935","€ 32650.93","3.108","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","8.054","€ 12390.77","6.764","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.486","€ 33469.27","4.523","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.823","€ 21773.87","4.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.668","€ 14935.54","3.227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":658},{"label":"Mar","value":914},{"label":"Abr","value":706},{"label":"Mai","value":866},{"label":"Jun","value":669},{"label":"Jul","value":649},{"label":"Ago","value":716},{"label":"Set","value":673},{"label":"Out","value":656},{"label":"Nov","value":816},{"label":"Dez","value":893}];
const MX = 914;
