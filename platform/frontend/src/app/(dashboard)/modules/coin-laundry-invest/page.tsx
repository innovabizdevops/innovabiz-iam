...
/* ═══ Coin Laundry Investment — Dashboard ═══ */

const ACCENT = "#083344";

const KPIS = [
    { label: "Total Registos", value: "8916", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4090", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€225K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "701146616", cells: ["COI-2616", "Coin Laundry Investment Item 1", "17/9/2026", "€46 716"], status: "active" as const },
    { id: "701150187", cells: ["COI-6187", "Coin Laundry Investment Item 2", "4/4/2026", "€287"], status: "pending" as const },
    { id: "701153758", cells: ["COI-9758", "Coin Laundry Investment Item 3", "19/11/2026", "€3858"], status: "completed" as const },
    { id: "701157329", cells: ["COI-4329", "Coin Laundry Investment Item 4", "6/6/2026", "€7429"], status: "warning" as const },
    { id: "701160900", cells: ["COI-7900", "Coin Laundry Investment Item 5", "21/1/2026", "€11 000"], status: "active" as const },
];
...
export default function CoinLaundryInvestmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coin Laundry Investment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Coin Laundry Investment</p>
                    </div>
                </div>
