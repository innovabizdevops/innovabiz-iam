...
const PAGE = "Payment";
const KPIS = [{"l":"Pedidos/Dia","v":"2898","t":"+8.7%","d":"up"},{"l":"GMV (€)","v":"€39485","t":"-4.1%","d":"down"},{"l":"Conversão (%)","v":"81.3%","t":"+4.0%","d":"up"},{"l":"AOV (€)","v":"€26342","t":"+10.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 8149.93","7.636","4.355","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 19686.54","7.285","5.005","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 47293.46","599","1.427","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 10955.73","6.530","982","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 26149.36","3.174","5.974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":736},{"label":"Mar","value":538},{"label":"Abr","value":782},{"label":"Mai","value":605},{"label":"Jun","value":470},{"label":"Jul","value":780},{"label":"Ago","value":788},{"label":"Set","value":805},{"label":"Out","value":674},{"label":"Nov","value":607},{"label":"Dez","value":549}];
const MX = 805;
