...
const ACCENT = "#6366f1";
const MODULE = "Self Checkout";
const PAGE = "Loss Prevent";
const KPIS = [{"l":"Pedidos/Dia","v":"2640","t":"-4.7%","d":"down"},{"l":"GMV (€)","v":"€64612","t":"-2.1%","d":"down"},{"l":"Conversão (%)","v":"70.7%","t":"+6.8%","d":"up"},{"l":"AOV (€)","v":"€15661","t":"-5.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 4486.06","7.241","5.151","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 14446.83","6.229","5.468","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 3775.63","705","7.711","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 1481.99","4.697","3.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 43257.58","1.740","2.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":588},{"label":"Mar","value":764},{"label":"Abr","value":478},{"label":"Mai","value":393},{"label":"Jun","value":648},{"label":"Jul","value":392},{"label":"Ago","value":598},{"label":"Set","value":682},{"label":"Out","value":670},{"label":"Nov","value":481},{"label":"Dez","value":566}];
const MX = 764;
