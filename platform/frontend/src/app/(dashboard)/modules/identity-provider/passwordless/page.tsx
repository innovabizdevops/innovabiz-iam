...
const PAGE = "Passwordless";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.914","t":"+13.6%","d":"up"},{"l":"Sessões/Dia","v":"2936","t":"+11.2%","d":"up"},{"l":"MFA Adoção (%)","v":"76.7%","t":"+7.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.002","t":"+8.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.015","1.933","8.384","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.001","3.594","6.053","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.637","8.093","6.091","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.198","7.495","7.343","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","615","1.300","7.287","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":479},{"label":"Mar","value":506},{"label":"Abr","value":389},{"label":"Mai","value":484},{"label":"Jun","value":419},{"label":"Jul","value":389},{"label":"Ago","value":376},{"label":"Set","value":487},{"label":"Out","value":521},{"label":"Nov","value":625},{"label":"Dez","value":409}];
const MX = 682;
