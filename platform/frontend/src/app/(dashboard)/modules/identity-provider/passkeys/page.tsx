...
const PAGE = "Passkeys";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.283","t":"+5.4%","d":"up"},{"l":"Sessões/Dia","v":"1158","t":"+7.3%","d":"up"},{"l":"MFA Adoção (%)","v":"94.3%","t":"-0.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.562","t":"+11.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","292","4.841","3.315","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.677","183","2.481","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.296","2.953","6.112","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.061","8.949","7.745","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.546","8.071","3.860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":1035},{"label":"Mar","value":991},{"label":"Abr","value":764},{"label":"Mai","value":1015},{"label":"Jun","value":956},{"label":"Jul","value":936},{"label":"Ago","value":837},{"label":"Set","value":920},{"label":"Out","value":858},{"label":"Nov","value":807},{"label":"Dez","value":673}];
const MX = 1035;
