...
const PAGE = "Social Login";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.319","t":"+6.8%","d":"up"},{"l":"Sessões/Dia","v":"4623","t":"+13.9%","d":"up"},{"l":"MFA Adoção (%)","v":"82.3%","t":"+12.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.865","t":"+17.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.452","983","1.688","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.401","5.690","1.144","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.252","6.617","1.085","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.058","7.934","3.015","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.331","8.735","6.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":677},{"label":"Mar","value":647},{"label":"Abr","value":651},{"label":"Mai","value":786},{"label":"Jun","value":769},{"label":"Jul","value":852},{"label":"Ago","value":896},{"label":"Set","value":530},{"label":"Out","value":754},{"label":"Nov","value":785},{"label":"Dez","value":724}];
const MX = 896;
