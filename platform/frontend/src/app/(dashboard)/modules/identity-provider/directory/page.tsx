...
const PAGE = "User Directory";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.021","t":"+13.7%","d":"up"},{"l":"Sessões/Dia","v":"225","t":"+6.0%","d":"up"},{"l":"MFA Adoção (%)","v":"92.9%","t":"+16.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.965","t":"+6.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.164","570","8.324","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.701","8.058","2.128","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","526","6.823","1.898","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.042","8.640","4.536","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.340","5.697","7.285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":309},{"label":"Fev","value":447},{"label":"Mar","value":418},{"label":"Abr","value":213},{"label":"Mai","value":563},{"label":"Jun","value":599},{"label":"Jul","value":455},{"label":"Ago","value":456},{"label":"Set","value":583},{"label":"Out","value":377},{"label":"Nov","value":389},{"label":"Dez","value":487}];
const MX = 599;
