...
const PAGE = "MFA Policies";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.370","t":"+9.1%","d":"up"},{"l":"Sessões/Dia","v":"2835","t":"-1.1%","d":"down"},{"l":"MFA Adoção (%)","v":"76.7%","t":"+16.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.315","t":"+2.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.495","6.615","5.957","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.137","7.284","7.383","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.426","7.254","7.255","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.490","3.292","742","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.179","7.252","8.399","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":466},{"label":"Mar","value":400},{"label":"Abr","value":531},{"label":"Mai","value":522},{"label":"Jun","value":553},{"label":"Jul","value":726},{"label":"Ago","value":426},{"label":"Set","value":477},{"label":"Out","value":489},{"label":"Nov","value":477},{"label":"Dez","value":423}];
const MX = 726;
