...
const KPIS = [
    { label: "Total Registos", value: "8355", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "979", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1964574155", cells: ["RET-1155", "Retail Execution Item 1", "20/12/2026", "€24 255"], status: "active" as const },
    { id: "1964577726", cells: ["RET-4726", "Retail Execution Item 2", "7/7/2026", "€27 826"], status: "pending" as const },
    { id: "1964581297", cells: ["RET-8297", "Retail Execution Item 3", "22/2/2026", "€31 397"], status: "completed" as const },
    { id: "1964584868", cells: ["RET-2868", "Retail Execution Item 4", "9/9/2026", "€34 968"], status: "warning" as const },
    { id: "1964588439", cells: ["RET-6439", "Retail Execution Item 5", "24/4/2026", "€38 539"], status: "active" as const },
];
...
export default function RetailExecutionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Retail Execution</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Retail Execution</p>
                    </div>
                </div>
