...
const ACCENT = "#ea580c";
const MODULE = "Retail Execution";
const PAGE = "Execute";
const KPIS = [{"l":"Pedidos/Dia","v":"4092","t":"+14.9%","d":"up"},{"l":"GMV (€)","v":"€25784","t":"-1.3%","d":"down"},{"l":"Conversão (%)","v":"81.4%","t":"+15.7%","d":"up"},{"l":"AOV (€)","v":"€75261","t":"+11.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 38432.35","2.786","2.917","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 35674.16","7.308","7.950","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 10419.60","5.102","1.148","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 24172.27","5.623","4.459","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 45767.81","1.149","6.608","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":719},{"label":"Mar","value":684},{"label":"Abr","value":1036},{"label":"Mai","value":981},{"label":"Jun","value":777},{"label":"Jul","value":923},{"label":"Ago","value":879},{"label":"Set","value":982},{"label":"Out","value":1028},{"label":"Nov","value":1010},{"label":"Dez","value":1012}];
const MX = 1036;
