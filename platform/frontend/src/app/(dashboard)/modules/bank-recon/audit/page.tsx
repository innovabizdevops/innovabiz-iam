...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.528","t":"-2.8%","d":"down"},{"l":"NC Abertas","v":"7.431","t":"+17.7%","d":"up"},{"l":"Conformidade (%)","v":"91.0%","t":"+5.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.079","t":"-2.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.611","83.7%","1.729","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","731","95.4%","1.216","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.913","75.4%","5.641","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.092","77.8%","7.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.683","99.0%","3.476","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":617},{"label":"Mar","value":489},{"label":"Abr","value":627},{"label":"Mai","value":714},{"label":"Jun","value":509},{"label":"Jul","value":587},{"label":"Ago","value":837},{"label":"Set","value":461},{"label":"Out","value":696},{"label":"Nov","value":843},{"label":"Dez","value":786}];
const MX = 843;
