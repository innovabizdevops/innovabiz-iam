...
const PAGE = "Multi-Bank";
const KPIS = [{"l":"Total Bank Recon","v":"4.277","t":"+12.1%","d":"up"},{"l":"Multi Bank Ativos","v":"2.566","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"83.2%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+7.8%","d":"up"}];
const COLS = ["ID","Multi Bank","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bank Recon #001","Bank Recon #002","7.154","5.313","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Bank Recon #002","Bank Recon #003","2.931","2.014","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Bank Recon #003","Bank Recon #004","228","5.291","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Bank Recon #004","Bank Recon #005","7.548","4.691","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bank Recon #005","Bank Recon #001","863","6.357","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":362},{"label":"Mar","value":267},{"label":"Abr","value":457},{"label":"Mai","value":562},{"label":"Jun","value":394},{"label":"Jul","value":401},{"label":"Ago","value":504},{"label":"Set","value":410},{"label":"Out","value":444},{"label":"Nov","value":523},{"label":"Dez","value":358}];
const MX = 562;
