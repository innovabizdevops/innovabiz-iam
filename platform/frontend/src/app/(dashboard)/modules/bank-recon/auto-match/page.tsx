...
const ACCENT = "#059669";
const MODULE = "Bank Reconciliation";
const PAGE = "Auto-Match";
const KPIS = [{"l":"Atletas Registados","v":"8.742","t":"-5.2%","d":"down"},{"l":"Treinos/Semana","v":"4584","t":"+12.8%","d":"up"},{"l":"Competições","v":"708","t":"-4.5%","d":"down"},{"l":"Performance Score","v":"79","t":"-0.4%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.041","919","5.659","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.803","5.146","6.081","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.151","6.035","5.390","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.114","3.874","5.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.049","6.758","1.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":588},{"label":"Mar","value":596},{"label":"Abr","value":383},{"label":"Mai","value":363},{"label":"Jun","value":588},{"label":"Jul","value":425},{"label":"Ago","value":526},{"label":"Set","value":483},{"label":"Out","value":620},{"label":"Nov","value":738},{"label":"Dez","value":492}];
const MX = 738;
