...
const PAGE = "Unmatched Items";
const KPIS = [{"l":"Atletas Registados","v":"2.425","t":"+0.7%","d":"up"},{"l":"Treinos/Semana","v":"2677","t":"-1.4%","d":"down"},{"l":"Competições","v":"376","t":"+17.7%","d":"up"},{"l":"Performance Score","v":"83","t":"+11.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.791","4.423","2.945","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.490","7.825","1.137","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.733","1.093","985","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.580","1.197","1.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.795","5.201","5.620","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":833},{"label":"Mar","value":661},{"label":"Abr","value":683},{"label":"Mai","value":663},{"label":"Jun","value":794},{"label":"Jul","value":900},{"label":"Ago","value":802},{"label":"Set","value":848},{"label":"Out","value":933},{"label":"Nov","value":950},{"label":"Dez","value":758}];
const MX = 950;
