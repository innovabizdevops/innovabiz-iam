...
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"5.995","t":"+2.6%","d":"up"},{"l":"Submissões/Dia","v":"137","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"8.779","t":"+2.7%","d":"up"},{"l":"Templates","v":"8.368","t":"+4.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.878","2026-02-12","6.433","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.336","2026-02-21","5.781","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.002","2026-03-08","7.317","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.128","2026-02-04","4.010","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.865","2026-03-24","1.325","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":919},{"label":"Mar","value":971},{"label":"Abr","value":901},{"label":"Mai","value":815},{"label":"Jun","value":925},{"label":"Jul","value":590},{"label":"Ago","value":738},{"label":"Set","value":944},{"label":"Out","value":729},{"label":"Nov","value":783},{"label":"Dez","value":886}];
const MX = 971;
