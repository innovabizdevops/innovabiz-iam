...
/* ═══ Legal Document Generation — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "5474", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "394", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€67K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1870352974", cells: ["LEG-9974", "Legal Document Generation Item 1", "15/11/2026", "€3074"], status: "active" as const },
    { id: "1870356545", cells: ["LEG-4545", "Legal Document Generation Item 2", "2/6/2026", "€6645"], status: "pending" as const },
    { id: "1870360116", cells: ["LEG-8116", "Legal Document Generation Item 3", "17/1/2026", "€10 216"], status: "completed" as const },
    { id: "1870363687", cells: ["LEG-2687", "Legal Document Generation Item 4", "4/8/2026", "€13 787"], status: "warning" as const },
    { id: "1870367258", cells: ["LEG-6258", "Legal Document Generation Item 5", "19/3/2026", "€17 358"], status: "active" as const },
];
...
export default function LegalDocumentGenerationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Legal Document Generation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Legal Document Generation</p>
                    </div>
                </div>
