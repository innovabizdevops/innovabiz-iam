...
const PAGE = "In-App Feedback";
const KPIS = [{"l":"Surveys Ativos","v":"7.394","t":"-4.2%","d":"down"},{"l":"Respostas/Semana","v":"3236","t":"+13.1%","d":"up"},{"l":"NPS Médio","v":"73","t":"+2.0%","d":"up"},{"l":"Taxa Resposta (%)","v":"90.9%","t":"-4.5%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.681","72","81.6%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.514","81","75.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","5.588","65","75.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.685","79","88.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.988","68","86.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":693},{"label":"Mar","value":736},{"label":"Abr","value":915},{"label":"Mai","value":797},{"label":"Jun","value":926},{"label":"Jul","value":687},{"label":"Ago","value":814},{"label":"Set","value":899},{"label":"Out","value":728},{"label":"Nov","value":879},{"label":"Dez","value":911}];
const MX = 926;
