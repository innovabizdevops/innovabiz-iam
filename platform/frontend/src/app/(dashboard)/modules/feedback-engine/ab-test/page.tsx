...
const PAGE = "A/B Testing";
const KPIS = [{"l":"Surveys Ativos","v":"2.685","t":"-5.4%","d":"down"},{"l":"Respostas/Semana","v":"758","t":"+10.6%","d":"up"},{"l":"NPS Médio","v":"62","t":"-2.1%","d":"down"},{"l":"Taxa Resposta (%)","v":"92.6%","t":"+17.3%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.718","86","71.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.521","87","78.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.851","78","87.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","8.711","92","89.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.764","76","91.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":880},{"label":"Mar","value":986},{"label":"Abr","value":980},{"label":"Mai","value":737},{"label":"Jun","value":808},{"label":"Jul","value":765},{"label":"Ago","value":657},{"label":"Set","value":897},{"label":"Out","value":891},{"label":"Nov","value":983},{"label":"Dez","value":1003}];
const MX = 1003;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>Exp</span></h1>
                </div>
