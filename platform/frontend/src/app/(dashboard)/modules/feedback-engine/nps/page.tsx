...
const PAGE = "NPS Tracker";
const KPIS = [{"l":"Perfis Unificados","v":"4.005","t":"+16.4%","d":"up"},{"l":"Segmentos Ativos","v":"7.051","t":"+6.7%","d":"up"},{"l":"NPS Score","v":"87","t":"+13.7%","d":"up"},{"l":"Churn Previsto (%)","v":"71.1%","t":"+10.3%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","5.907","€ 48803.49","91.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","5.163","€ 9911.79","88.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.480","€ 29417.85","89.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","2.901","€ 24853.20","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.679","€ 22668.73","86.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":703},{"label":"Mar","value":733},{"label":"Abr","value":455},{"label":"Mai","value":554},{"label":"Jun","value":428},{"label":"Jul","value":599},{"label":"Ago","value":690},{"label":"Set","value":479},{"label":"Out","value":458},{"label":"Nov","value":709},{"label":"Dez","value":500}];
const MX = 733;
