...
const KPIS = [{"l":"Surveys Ativos","v":"7.888","t":"+5.8%","d":"up"},{"l":"Respostas/Semana","v":"3674","t":"+11.5%","d":"up"},{"l":"NPS Médio","v":"90","t":"-5.2%","d":"down"},{"l":"Taxa Resposta (%)","v":"77.7%","t":"+2.4%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.674","83","91.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","961","73","84.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.646","93","73.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.599","66","90.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.617","93","92.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":297},{"label":"Mar","value":399},{"label":"Abr","value":586},{"label":"Mai","value":425},{"label":"Jun","value":368},{"label":"Jul","value":541},{"label":"Ago","value":307},{"label":"Set","value":374},{"label":"Out","value":598},{"label":"Nov","value":361},{"label":"Dez","value":225}];
const MX = 598;
