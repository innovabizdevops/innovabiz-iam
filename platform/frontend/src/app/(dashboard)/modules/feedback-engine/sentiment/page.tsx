...
const ACCENT = "#be185d";
const MODULE = "Feedback & NPS Engine";
const PAGE = "Sentiment AI";
const KPIS = [{"l":"Dashboards Ativos","v":"3.770","t":"+14.3%","d":"up"},{"l":"Queries/Dia","v":"2817","t":"+6.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.377","t":"+14.5%","d":"up"},{"l":"Utilizadores Analytics","v":"502","t":"+0.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2714","2026-02-15","9.060","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3372","2026-01-16","1.587","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1431","2026-02-13","4.643","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2781","2026-01-23","7.138","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","826","2026-01-15","7.369","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":874},{"label":"Mar","value":587},{"label":"Abr","value":836},{"label":"Mai","value":663},{"label":"Jun","value":766},{"label":"Jul","value":675},{"label":"Ago","value":557},{"label":"Set","value":819},{"label":"Out","value":542},{"label":"Nov","value":575},{"label":"Dez","value":844}];
const MX = 874;
