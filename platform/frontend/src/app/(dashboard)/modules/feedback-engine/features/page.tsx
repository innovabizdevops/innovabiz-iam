...
const PAGE = "Feature Requests";
const KPIS = [{"l":"Surveys Ativos","v":"1.128","t":"-4.2%","d":"down"},{"l":"Respostas/Semana","v":"3298","t":"-4.6%","d":"down"},{"l":"NPS Médio","v":"73","t":"+2.6%","d":"up"},{"l":"Taxa Resposta (%)","v":"66.5%","t":"+10.2%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.057","88","94.4%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.141","58","93.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","5.281","87","81.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.669","70","76.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.555","70","80.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":780},{"label":"Mar","value":631},{"label":"Abr","value":480},{"label":"Mai","value":667},{"label":"Jun","value":714},{"label":"Jul","value":684},{"label":"Ago","value":436},{"label":"Set","value":510},{"label":"Out","value":508},{"label":"Nov","value":732},{"label":"Dez","value":653}];
const MX = 780;
