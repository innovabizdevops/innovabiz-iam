...
const PAGE = "Close Loop";
const KPIS = [{"l":"Surveys Ativos","v":"8.504","t":"-3.8%","d":"down"},{"l":"Respostas/Semana","v":"4177","t":"+11.5%","d":"up"},{"l":"NPS Médio","v":"82","t":"+6.0%","d":"up"},{"l":"Taxa Resposta (%)","v":"69.2%","t":"+11.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","7.914","81","96.8%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.285","93","74.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.521","69","90.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","245","93","98.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.871","82","85.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":767},{"label":"Mar","value":532},{"label":"Abr","value":619},{"label":"Mai","value":816},{"label":"Jun","value":543},{"label":"Jul","value":545},{"label":"Ago","value":752},{"label":"Set","value":693},{"label":"Out","value":704},{"label":"Nov","value":864},{"label":"Dez","value":545}];
const MX = 864;
