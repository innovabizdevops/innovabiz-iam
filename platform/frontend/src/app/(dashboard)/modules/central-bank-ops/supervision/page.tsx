...
const KPIS = [{"l":"Total Central Bank Ops","v":"7.975","t":"+7.3%","d":"up"},{"l":"SupervisãO Ativos","v":"7.358","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"94","t":"-4.4%","d":"down"}];
const COLS = ["ID","SupervisãO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Central Bank Ops #001","Central Bank Ops #002","4.326","5.712","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Central Bank Ops #002","Central Bank Ops #003","8.465","5.526","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Central Bank Ops #003","Central Bank Ops #004","1.510","3.291","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Central Bank Ops #004","Central Bank Ops #005","568","8.331","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Central Bank Ops #005","Central Bank Ops #001","5.739","1.692","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":311},{"label":"Mar","value":484},{"label":"Abr","value":531},{"label":"Mai","value":586},{"label":"Jun","value":470},{"label":"Jul","value":421},{"label":"Ago","value":338},{"label":"Set","value":514},{"label":"Out","value":282},{"label":"Nov","value":266},{"label":"Dez","value":590}];
const MX = 590;
