...
const ACCENT = "#6366f1";
const MODULE = "Operações Banco Central";
const PAGE = "Estabilidade";
const KPIS = [{"l":"Total Central Bank Ops","v":"3.306","t":"+8.4%","d":"up"},{"l":"Estabilidade Ativos","v":"5.033","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"87.4%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+16.7%","d":"up"}];
const COLS = ["ID","Estabilidade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Central Bank Ops #001","Central Bank Ops #002","4.340","6.769","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Central Bank Ops #002","Central Bank Ops #003","4.243","8.316","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Central Bank Ops #003","Central Bank Ops #004","4.267","4.742","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Central Bank Ops #004","Central Bank Ops #005","8.034","5.352","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Central Bank Ops #005","Central Bank Ops #001","6.176","982","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":766},{"label":"Mar","value":873},{"label":"Abr","value":673},{"label":"Mai","value":582},{"label":"Jun","value":786},{"label":"Jul","value":802},{"label":"Ago","value":559},{"label":"Set","value":819},{"label":"Out","value":665},{"label":"Nov","value":681},{"label":"Dez","value":840}];
const MX = 873;
