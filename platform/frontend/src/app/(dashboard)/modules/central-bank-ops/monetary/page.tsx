...
const PAGE = "Política Monetária";
const KPIS = [{"l":"Total Central Bank Ops","v":"2.168","t":"+2.0%","d":"up"},{"l":"PolíTica MonetáRia Ativos","v":"5.274","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"64","t":"+6.6%","d":"up"}];
const COLS = ["ID","PolíTica MonetáRia","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Central Bank Ops #001","Central Bank Ops #002","4.408","686","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Central Bank Ops #002","Central Bank Ops #003","7.234","6.927","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Central Bank Ops #003","Central Bank Ops #004","8.598","7.484","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Central Bank Ops #004","Central Bank Ops #005","502","4.817","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Central Bank Ops #005","Central Bank Ops #001","7.606","1.565","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":742},{"label":"Mar","value":477},{"label":"Abr","value":484},{"label":"Mai","value":701},{"label":"Jun","value":617},{"label":"Jul","value":505},{"label":"Ago","value":350},{"label":"Set","value":641},{"label":"Out","value":505},{"label":"Nov","value":473},{"label":"Dez","value":579}];
const MX = 742;
