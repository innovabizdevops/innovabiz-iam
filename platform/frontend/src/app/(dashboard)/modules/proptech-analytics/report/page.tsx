...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"2.826","t":"+10.0%","d":"up"},{"l":"Queries/Dia","v":"2001","t":"+0.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.681","t":"+12.8%","d":"up"},{"l":"Utilizadores Analytics","v":"2.420","t":"+14.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2691","2026-02-19","6.470","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2299","2026-03-01","121","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2675","2026-01-14","600","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3196","2026-01-08","1.398","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","598","2026-01-19","2.578","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":515},{"label":"Mar","value":503},{"label":"Abr","value":300},{"label":"Mai","value":517},{"label":"Jun","value":231},{"label":"Jul","value":473},{"label":"Ago","value":361},{"label":"Set","value":391},{"label":"Out","value":268},{"label":"Nov","value":384},{"label":"Dez","value":533}];
const MX = 533;
