...
const PAGE = "Rent Comp";
const KPIS = [{"l":"Dashboards Ativos","v":"2.741","t":"+12.6%","d":"up"},{"l":"Queries/Dia","v":"2929","t":"+17.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.280","t":"+13.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.670","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1899","2026-01-18","3.318","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","320","2026-03-12","8.356","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","746","2026-03-02","1.327","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4844","2026-02-12","3.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2403","2026-02-05","1.676","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":624},{"label":"Mar","value":659},{"label":"Abr","value":730},{"label":"Mai","value":678},{"label":"Jun","value":583},{"label":"Jul","value":573},{"label":"Ago","value":566},{"label":"Set","value":910},{"label":"Out","value":863},{"label":"Nov","value":784},{"label":"Dez","value":764}];
const MX = 910;
