...
const ACCENT = "#6366f1";
const MODULE = "PropTech Analytics";
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"394","t":"-5.6%","d":"down"},{"l":"Queries/Dia","v":"2748","t":"+4.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.404","t":"+16.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.105","t":"+5.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4537","2026-03-21","2.527","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4973","2026-03-08","4.702","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1593","2026-01-07","1.476","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3792","2026-02-07","1.646","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4071","2026-02-12","3.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":891},{"label":"Mar","value":653},{"label":"Abr","value":905},{"label":"Mai","value":761},{"label":"Jun","value":607},{"label":"Jul","value":882},{"label":"Ago","value":931},{"label":"Set","value":684},{"label":"Out","value":625},{"label":"Nov","value":638},{"label":"Dez","value":947}];
const MX = 957;
