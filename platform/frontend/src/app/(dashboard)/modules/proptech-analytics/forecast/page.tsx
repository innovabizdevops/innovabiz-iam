...
const PAGE = "Forecast";
const KPIS = [{"l":"Dashboards Ativos","v":"8.358","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"1991","t":"+10.6%","d":"up"},{"l":"Dados Processados (GB)","v":"7.427","t":"+8.9%","d":"up"},{"l":"Utilizadores Analytics","v":"9.034","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3080","2026-01-22","6.785","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","736","2026-03-26","717","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","304","2026-02-14","127","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1720","2026-02-07","253","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2646","2026-02-17","6.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":346},{"label":"Mar","value":404},{"label":"Abr","value":413},{"label":"Mai","value":490},{"label":"Jun","value":358},{"label":"Jul","value":651},{"label":"Ago","value":656},{"label":"Set","value":571},{"label":"Out","value":723},{"label":"Nov","value":672},{"label":"Dez","value":642}];
const MX = 723;
