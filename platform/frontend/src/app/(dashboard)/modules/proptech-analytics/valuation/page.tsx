...
const KPIS = [{"l":"Dashboards Ativos","v":"414","t":"+12.1%","d":"up"},{"l":"Queries/Dia","v":"4985","t":"+6.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.455","t":"+6.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.052","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4551","2026-01-05","7.797","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1467","2026-02-19","4.333","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1713","2026-03-20","1.216","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","317","2026-02-12","5.482","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1064","2026-03-06","4.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":799},{"label":"Mar","value":761},{"label":"Abr","value":847},{"label":"Mai","value":782},{"label":"Jun","value":726},{"label":"Jul","value":628},{"label":"Ago","value":867},{"label":"Set","value":938},{"label":"Out","value":911},{"label":"Nov","value":845},{"label":"Dez","value":710}];
const MX = 938;
