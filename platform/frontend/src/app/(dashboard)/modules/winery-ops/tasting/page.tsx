...
const PAGE = "Tasting";
const KPIS = [{"l":"Total Winery Ops","v":"338","t":"+11.7%","d":"up"},{"l":"Tasting Ativos","v":"3.621","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"86.2%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"79","t":"-4.2%","d":"down"}];
const COLS = ["ID","Tasting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Winery Ops #001","Winery Ops #002","2.013","753","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Winery Ops #002","Winery Ops #003","4.726","6.038","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Winery Ops #003","Winery Ops #004","4.161","5.777","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Winery Ops #004","Winery Ops #005","3.522","3.072","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Winery Ops #005","Winery Ops #001","7.063","728","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":793},{"label":"Mar","value":659},{"label":"Abr","value":737},{"label":"Mai","value":617},{"label":"Jun","value":813},{"label":"Jul","value":883},{"label":"Ago","value":642},{"label":"Set","value":579},{"label":"Out","value":746},{"label":"Nov","value":918},{"label":"Dez","value":542}];
const MX = 918;
