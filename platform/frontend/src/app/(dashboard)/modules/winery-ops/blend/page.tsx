...
const ACCENT = "#6366f1";
const MODULE = "Winery Operations";
const PAGE = "Blend";
const KPIS = [{"l":"Total Winery Ops","v":"4.626","t":"+5.8%","d":"up"},{"l":"Blend Ativos","v":"4.049","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"67.9%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+2.3%","d":"up"}];
const COLS = ["ID","Blend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Winery Ops #001","Winery Ops #002","2.309","5.282","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Winery Ops #002","Winery Ops #003","4.978","5.129","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Winery Ops #003","Winery Ops #004","7.749","5.652","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Winery Ops #004","Winery Ops #005","2.962","5.720","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Winery Ops #005","Winery Ops #001","5.478","3.971","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":340},{"label":"Mar","value":528},{"label":"Abr","value":260},{"label":"Mai","value":322},{"label":"Jun","value":553},{"label":"Jul","value":385},{"label":"Ago","value":378},{"label":"Set","value":528},{"label":"Out","value":545},{"label":"Nov","value":291},{"label":"Dez","value":331}];
const MX = 553;
