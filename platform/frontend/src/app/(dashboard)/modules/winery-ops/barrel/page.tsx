...
const PAGE = "Barrel";
const KPIS = [{"l":"ARR (€M)","v":"€16.3M","t":"-5.9%","d":"down"},{"l":"MRR (€)","v":"€38236","t":"-1.5%","d":"down"},{"l":"Churn (%)","v":"86.2%","t":"+5.3%","d":"up"},{"l":"ARPU (€)","v":"€60719","t":"+17.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 34777.06","7.658","€ 26172.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 3497.56","4.456","€ 17680.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45677.70","5.785","€ 7363.25","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 48307.07","3.209","€ 40645.14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 44806.01","7.830","€ 20916.71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":655},{"label":"Mar","value":858},{"label":"Abr","value":831},{"label":"Mai","value":1004},{"label":"Jun","value":919},{"label":"Jul","value":653},{"label":"Ago","value":932},{"label":"Set","value":974},{"label":"Out","value":907},{"label":"Nov","value":660},{"label":"Dez","value":831}];
const MX = 1004;
