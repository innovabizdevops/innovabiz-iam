...
const PAGE = "Crush";
const KPIS = [{"l":"Total Winery Ops","v":"2.890","t":"-1.8%","d":"down"},{"l":"Crush Ativos","v":"972","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"88.7%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"82","t":"+16.6%","d":"up"}];
const COLS = ["ID","Crush","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Winery Ops #001","Winery Ops #002","5.242","1.538","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Winery Ops #002","Winery Ops #003","3.903","6.877","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Winery Ops #003","Winery Ops #004","5.546","525","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Winery Ops #004","Winery Ops #005","6.072","8.004","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Winery Ops #005","Winery Ops #001","4.245","4.253","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":804},{"label":"Mar","value":501},{"label":"Abr","value":614},{"label":"Mai","value":518},{"label":"Jun","value":715},{"label":"Jul","value":715},{"label":"Ago","value":835},{"label":"Set","value":842},{"label":"Out","value":575},{"label":"Nov","value":466},{"label":"Dez","value":688}];
const MX = 842;
