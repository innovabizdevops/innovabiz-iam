...
const PAGE = "Vineyard";
const KPIS = [{"l":"Total Winery Ops","v":"7.812","t":"+12.7%","d":"up"},{"l":"Vineyard Ativos","v":"277","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"91.0%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+4.5%","d":"up"}];
const COLS = ["ID","Vineyard","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Winery Ops #001","Winery Ops #002","5.458","447","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Winery Ops #002","Winery Ops #003","1.670","6.215","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Winery Ops #003","Winery Ops #004","8.323","541","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Winery Ops #004","Winery Ops #005","2.570","8.334","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Winery Ops #005","Winery Ops #001","2.115","5.274","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":870},{"label":"Mar","value":696},{"label":"Abr","value":890},{"label":"Mai","value":586},{"label":"Jun","value":804},{"label":"Jul","value":807},{"label":"Ago","value":828},{"label":"Set","value":783},{"label":"Out","value":923},{"label":"Nov","value":841},{"label":"Dez","value":879}];
const MX = 923;
