...
export default function OffshoreOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Offshore Ops</h1><p className="text-sm text-muted-foreground">Offshore Ops • iBOS Enterprise</p></div>
