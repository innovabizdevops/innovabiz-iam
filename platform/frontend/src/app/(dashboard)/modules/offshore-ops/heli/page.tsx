...
const PAGE = "Heli Ops";
const KPIS = [{"l":"Total Offshore Ops","v":"8.274","t":"+17.9%","d":"up"},{"l":"Heli Ops Ativos","v":"8.681","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+8.7%","d":"up"}];
const COLS = ["ID","Heli Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Offshore Ops #001","Offshore Ops #002","7.544","3.540","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Offshore Ops #002","Offshore Ops #003","7.043","6.442","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Offshore Ops #003","Offshore Ops #004","3.285","1.726","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Offshore Ops #004","Offshore Ops #005","7.732","6.028","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Offshore Ops #005","Offshore Ops #001","479","2.196","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":349},{"label":"Mar","value":442},{"label":"Abr","value":484},{"label":"Mai","value":720},{"label":"Jun","value":593},{"label":"Jul","value":545},{"label":"Ago","value":565},{"label":"Set","value":439},{"label":"Out","value":484},{"label":"Nov","value":355},{"label":"Dez","value":434}];
const MX = 720;
...
export default function HeliPage() {
    return (
