...
const ACCENT = "#1e293b";
const MODULE = "Monument & Engraving";
const PAGE = "Material";
const KPIS = [{"l":"Total Monument Engrave","v":"1.915","t":"+13.0%","d":"up"},{"l":"Material Ativos","v":"7.395","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+16.8%","d":"up"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Monument Engrave #001","Monument Engrave #002","2.226","8.626","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Monument Engrave #002","Monument Engrave #003","2.878","3.603","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Monument Engrave #003","Monument Engrave #004","4.052","4.265","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Monument Engrave #004","Monument Engrave #005","8.377","1.664","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Monument Engrave #005","Monument Engrave #001","3.580","4.609","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":591},{"label":"Mar","value":610},{"label":"Abr","value":914},{"label":"Mai","value":708},{"label":"Jun","value":811},{"label":"Jul","value":924},{"label":"Ago","value":789},{"label":"Set","value":703},{"label":"Out","value":597},{"label":"Nov","value":764},{"label":"Dez","value":563}];
const MX = 924;
