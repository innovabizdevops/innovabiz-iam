...
const PAGE = "Install";
const KPIS = [{"l":"Total Monument Engrave","v":"4.034","t":"+11.6%","d":"up"},{"l":"Install Ativos","v":"7.133","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"82","t":"-4.9%","d":"down"}];
const COLS = ["ID","Install","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Monument Engrave #001","Monument Engrave #002","8.316","3.368","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Monument Engrave #002","Monument Engrave #003","5.386","524","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Monument Engrave #003","Monument Engrave #004","7.679","6.574","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Monument Engrave #004","Monument Engrave #005","1.492","6.049","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Monument Engrave #005","Monument Engrave #001","3.482","2.922","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":872},{"label":"Mar","value":923},{"label":"Abr","value":544},{"label":"Mai","value":736},{"label":"Jun","value":917},{"label":"Jul","value":851},{"label":"Ago","value":565},{"label":"Set","value":829},{"label":"Out","value":681},{"label":"Nov","value":787},{"label":"Dez","value":544}];
const MX = 923;
