...
/* ═══ Monument & Engraving — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "3373", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2990", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€343K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "551700573", cells: ["MON-1573", "Monument & Engraving Item 1", "26/10/2026", "€673"], status: "active" as const },
    { id: "551704144", cells: ["MON-5144", "Monument & Engraving Item 2", "13/5/2026", "€4244"], status: "pending" as const },
    { id: "551707715", cells: ["MON-8715", "Monument & Engraving Item 3", "28/12/2026", "€7815"], status: "completed" as const },
    { id: "551711286", cells: ["MON-3286", "Monument & Engraving Item 4", "15/7/2026", "€11 386"], status: "warning" as const },
    { id: "551714857", cells: ["MON-6857", "Monument & Engraving Item 5", "2/2/2026", "€14 957"], status: "active" as const },
];
...
export default function MonumentEngravingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Monument & Engraving</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Monument & Engraving</p>
                    </div>
                </div>
