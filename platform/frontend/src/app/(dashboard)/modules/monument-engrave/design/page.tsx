...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.438","t":"+0.0%","d":"up"},{"l":"Submissões/Dia","v":"2475","t":"+9.3%","d":"up"},{"l":"Documentos Gerados","v":"8.894","t":"+14.3%","d":"up"},{"l":"Templates","v":"9.094","t":"+10.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.588","2026-02-16","3.754","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.042","2026-01-27","739","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.372","2026-02-05","3.994","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.848","2026-01-03","265","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","311","2026-02-28","3.523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":949},{"label":"Mar","value":1049},{"label":"Abr","value":864},{"label":"Mai","value":935},{"label":"Jun","value":1060},{"label":"Jul","value":832},{"label":"Ago","value":1065},{"label":"Set","value":964},{"label":"Out","value":841},{"label":"Nov","value":844},{"label":"Dez","value":707}];
const MX = 1065;
