...
const ACCENT = "#6366f1";
const MODULE = "Hotel F&B";
const PAGE = "Recipe Cost";
const KPIS = [{"l":"Quartos Ocupados","v":"4.790","t":"-4.1%","d":"down"},{"l":"RevPAR (€)","v":"€37321","t":"+12.2%","d":"up"},{"l":"Ocupação (%)","v":"81.0%","t":"-1.8%","d":"down"},{"l":"Guest Satisfaction","v":"8.080","t":"+10.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.485","2026-03-11","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.945","2026-03-10","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.062","2026-01-17","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.101","2026-03-26","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","209","2026-03-11","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":810},{"label":"Mar","value":1039},{"label":"Abr","value":1044},{"label":"Mai","value":1068},{"label":"Jun","value":933},{"label":"Jul","value":876},{"label":"Ago","value":1003},{"label":"Set","value":798},{"label":"Out","value":752},{"label":"Nov","value":994},{"label":"Dez","value":713}];
const MX = 1068;
