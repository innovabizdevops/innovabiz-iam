...
export default function HotelFnbPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Hotel Fnb</h1><p className="text-sm text-muted-foreground">Hotel Fnb • iBOS Enterprise</p></div>
