...
const PAGE = "Bar";
const KPIS = [{"l":"Quartos Ocupados","v":"8.959","t":"+7.6%","d":"up"},{"l":"RevPAR (€)","v":"€84485","t":"+3.8%","d":"up"},{"l":"Ocupação (%)","v":"87.2%","t":"+17.4%","d":"up"},{"l":"Guest Satisfaction","v":"6.111","t":"+10.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","652","2026-03-25","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.290","2026-02-26","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","150","2026-01-02","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.906","2026-02-21","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.574","2026-01-15","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":448},{"label":"Mar","value":646},{"label":"Abr","value":782},{"label":"Mai","value":613},{"label":"Jun","value":783},{"label":"Jul","value":646},{"label":"Ago","value":649},{"label":"Set","value":780},{"label":"Out","value":453},{"label":"Nov","value":441},{"label":"Dez","value":415}];
const MX = 783;
