...
const PAGE = "Asset Mgmt";
const KPIS = [{"l":"Ativos Registados","v":"5.778","t":"+7.5%","d":"up"},{"l":"Valor Total (€M)","v":"€27.9M","t":"+15.0%","d":"up"},{"l":"Depreciação Anual (€)","v":"€91923","t":"-3.5%","d":"down"},{"l":"Ativos em Garantia","v":"1.791","t":"+8.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 18146.02","6.859","€ 36728.49","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 20984.01","5.506","€ 3520.12","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 21514.47","3.826","€ 20246.10","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 11545.19","7.004","€ 20151.74","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 25387.71","6.485","€ 3109.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":720},{"label":"Mar","value":828},{"label":"Abr","value":763},{"label":"Mai","value":799},{"label":"Jun","value":492},{"label":"Jul","value":807},{"label":"Ago","value":592},{"label":"Set","value":627},{"label":"Out","value":820},{"label":"Nov","value":698},{"label":"Dez","value":534}];
const MX = 828;
