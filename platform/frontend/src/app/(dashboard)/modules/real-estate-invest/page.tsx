...
export default function RealEstateInvestPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Real Estate Invest</h1><p className="text-sm text-muted-foreground">Real Estate Invest • iBOS Enterprise</p></div>
