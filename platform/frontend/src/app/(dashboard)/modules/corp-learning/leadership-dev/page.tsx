...
/* ═══ Corporate Learning — Leadership Dev ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "683", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "174", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2699", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "203180634", cells: ["COR-6634", "Leadership Dev Item 1", "7/7/2026", "€30 734"], status: "active" as const },
    { id: "203184205", cells: ["COR-1205", "Leadership Dev Item 2", "22/2/2026", "€34 305"], status: "pending" as const },
    { id: "203187776", cells: ["COR-4776", "Leadership Dev Item 3", "9/9/2026", "€37 876"], status: "completed" as const },
    { id: "203191347", cells: ["COR-8347", "Leadership Dev Item 4", "24/4/2026", "€41 447"], status: "warning" as const },
    { id: "203194918", cells: ["COR-2918", "Leadership Dev Item 5", "11/11/2026", "€45 018"], status: "active" as const },
];
...
export default function CorporateLearningLeadershipDevPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Leadership Dev</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Leadership Dev</p>
                    </div>
                </div>
