...
/* ═══ Corporate Learning — Sales Enablement ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "3166", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "115", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2459", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1624690783", cells: ["COR-2783", "Sales Enablement Item 1", "24/8/2026", "€40 883"], status: "active" as const },
    { id: "1624694354", cells: ["COR-6354", "Sales Enablement Item 2", "11/3/2026", "€44 454"], status: "pending" as const },
    { id: "1624697925", cells: ["COR-9925", "Sales Enablement Item 3", "26/10/2026", "€48 025"], status: "completed" as const },
    { id: "1624701496", cells: ["COR-4496", "Sales Enablement Item 4", "13/5/2026", "€1596"], status: "warning" as const },
    { id: "1624705067", cells: ["COR-8067", "Sales Enablement Item 5", "28/12/2026", "€5167"], status: "active" as const },
];
...
export default function CorporateLearningSalesEnablementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sales Enablement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Sales Enablement</p>
                    </div>
                </div>
