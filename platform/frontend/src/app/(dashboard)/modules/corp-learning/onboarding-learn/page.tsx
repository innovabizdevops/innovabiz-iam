...
/* ═══ Corporate Learning — Onboarding Learn ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "4207", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "425", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "181", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "82%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "911816085", cells: ["COR-9085", "Onboarding Learn Item 1", "6/10/2026", "€16 185"], status: "active" as const },
    { id: "911819656", cells: ["COR-3656", "Onboarding Learn Item 2", "21/5/2026", "€19 756"], status: "pending" as const },
    { id: "911823227", cells: ["COR-7227", "Onboarding Learn Item 3", "8/12/2026", "€23 327"], status: "completed" as const },
    { id: "911826798", cells: ["COR-1798", "Onboarding Learn Item 4", "23/7/2026", "€26 898"], status: "warning" as const },
    { id: "911830369", cells: ["COR-5369", "Onboarding Learn Item 5", "10/2/2026", "€30 469"], status: "active" as const },
];
...
export default function CorporateLearningOnboardingLearnPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Onboarding Learn</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Onboarding Learn</p>
                    </div>
                </div>
