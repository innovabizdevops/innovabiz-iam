...
/* ═══ Corporate Learning — Certification Path ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "2566", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "363", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1260", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "74%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1489127287", cells: ["COR-6287", "Certification Path Item 1", "12/8/2026", "€27 387"], status: "active" as const },
    { id: "1489130858", cells: ["COR-9858", "Certification Path Item 2", "27/3/2026", "€30 958"], status: "pending" as const },
    { id: "1489134429", cells: ["COR-4429", "Certification Path Item 3", "14/10/2026", "€34 529"], status: "completed" as const },
    { id: "1489138000", cells: ["COR-8000", "Certification Path Item 4", "1/5/2026", "€38 100"], status: "warning" as const },
    { id: "1489141571", cells: ["COR-2571", "Certification Path Item 5", "16/12/2026", "€41 671"], status: "active" as const },
];
...
export default function CorporateLearningCertificationPathPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Certification Path</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Certification Path</p>
                    </div>
                </div>
