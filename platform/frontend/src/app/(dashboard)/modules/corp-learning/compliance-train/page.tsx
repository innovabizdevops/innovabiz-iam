...
/* ═══ Corporate Learning — Compliance Train ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "2286", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "451", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "105", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "96%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1959094319", cells: ["COR-2319", "Compliance Train Item 1", "8/12/2026", "€44 419"], status: "active" as const },
    { id: "1959097890", cells: ["COR-5890", "Compliance Train Item 2", "23/7/2026", "€47 990"], status: "pending" as const },
    { id: "1959101461", cells: ["COR-9461", "Compliance Train Item 3", "10/2/2026", "€1561"], status: "completed" as const },
    { id: "1959105032", cells: ["COR-4032", "Compliance Train Item 4", "25/9/2026", "€5132"], status: "warning" as const },
    { id: "1959108603", cells: ["COR-7603", "Compliance Train Item 5", "12/4/2026", "€8703"], status: "active" as const },
];
...
export default function CorporateLearningComplianceTrainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Train</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Compliance Train</p>
                    </div>
                </div>
