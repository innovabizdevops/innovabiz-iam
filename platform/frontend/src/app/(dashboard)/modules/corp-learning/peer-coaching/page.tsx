...
/* ═══ Corporate Learning — Peer Coaching ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "4495", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "10", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2412", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "198123750", cells: ["COR-7750", "Peer Coaching Item 1", "7/7/2026", "€23 850"], status: "active" as const },
    { id: "198127321", cells: ["COR-2321", "Peer Coaching Item 2", "22/2/2026", "€27 421"], status: "pending" as const },
    { id: "198130892", cells: ["COR-5892", "Peer Coaching Item 3", "9/9/2026", "€30 992"], status: "completed" as const },
    { id: "198134463", cells: ["COR-9463", "Peer Coaching Item 4", "24/4/2026", "€34 563"], status: "warning" as const },
    { id: "198138034", cells: ["COR-4034", "Peer Coaching Item 5", "11/11/2026", "€38 134"], status: "active" as const },
];
...
export default function CorporateLearningPeerCoachingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Peer Coaching</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Peer Coaching</p>
                    </div>
                </div>
