...
/* ═══ Corporate Learning — Simulation Train ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "1852", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "159", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3372", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1793834267", cells: ["COR-9267", "Simulation Train Item 1", "16/12/2026", "€34 367"], status: "active" as const },
    { id: "1793837838", cells: ["COR-3838", "Simulation Train Item 2", "3/7/2026", "€37 938"], status: "pending" as const },
    { id: "1793841409", cells: ["COR-7409", "Simulation Train Item 3", "18/2/2026", "€41 509"], status: "completed" as const },
    { id: "1793844980", cells: ["COR-1980", "Simulation Train Item 4", "5/9/2026", "€45 080"], status: "warning" as const },
    { id: "1793848551", cells: ["COR-5551", "Simulation Train Item 5", "20/4/2026", "€48 651"], status: "active" as const },
];
...
export default function CorporateLearningSimulationTrainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Simulation Train</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Simulation Train</p>
                    </div>
                </div>
