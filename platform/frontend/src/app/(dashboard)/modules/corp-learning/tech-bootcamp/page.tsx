...
/* ═══ Corporate Learning — Tech Bootcamp ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "4797", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "339", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2270", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1434124335", cells: ["COR-2335", "Tech Bootcamp Item 1", "8/4/2026", "€24 435"], status: "active" as const },
    { id: "1434127906", cells: ["COR-5906", "Tech Bootcamp Item 2", "23/11/2026", "€28 006"], status: "pending" as const },
    { id: "1434131477", cells: ["COR-9477", "Tech Bootcamp Item 3", "10/6/2026", "€31 577"], status: "completed" as const },
    { id: "1434135048", cells: ["COR-4048", "Tech Bootcamp Item 4", "25/1/2026", "€35 148"], status: "warning" as const },
    { id: "1434138619", cells: ["COR-7619", "Tech Bootcamp Item 5", "12/8/2026", "€38 719"], status: "active" as const },
];
...
export default function CorporateLearningTechBootcampPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tech Bootcamp</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Tech Bootcamp</p>
                    </div>
                </div>
