...
/* ═══ Corporate Learning — Micro Learning ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "4362", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "314", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2675", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "77%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1363045030", cells: ["COR-5030", "Micro Learning Item 1", "19/11/2026", "€45 130"], status: "active" as const },
    { id: "1363048601", cells: ["COR-8601", "Micro Learning Item 2", "6/6/2026", "€48 701"], status: "pending" as const },
    { id: "1363052172", cells: ["COR-3172", "Micro Learning Item 3", "21/1/2026", "€2272"], status: "completed" as const },
    { id: "1363055743", cells: ["COR-6743", "Micro Learning Item 4", "8/8/2026", "€5843"], status: "warning" as const },
    { id: "1363059314", cells: ["COR-1314", "Micro Learning Item 5", "23/3/2026", "€9414"], status: "active" as const },
];
...
export default function CorporateLearningMicroLearningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Micro Learning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Micro Learning</p>
                    </div>
                </div>
