...
/* ═══ Corporate Learning — Vr Training ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total", value: "1000", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "18", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "736", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1909766190", cells: ["COR-3190", "Vr Training Item 1", "11/7/2026", "€16 290"], status: "active" as const },
    { id: "1909769761", cells: ["COR-6761", "Vr Training Item 2", "26/2/2026", "€19 861"], status: "pending" as const },
    { id: "1909773332", cells: ["COR-1332", "Vr Training Item 3", "13/9/2026", "€23 432"], status: "completed" as const },
    { id: "1909776903", cells: ["COR-4903", "Vr Training Item 4", "28/4/2026", "€27 003"], status: "warning" as const },
    { id: "1909780474", cells: ["COR-8474", "Vr Training Item 5", "15/11/2026", "€30 574"], status: "active" as const },
];
...
export default function CorporateLearningVrTrainingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vr Training</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Corporate Learning • Vr Training</p>
                    </div>
                </div>
