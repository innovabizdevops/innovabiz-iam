...
const PAGE = "Recruit";
const KPIS = [{"l":"Ideias Submetidas","v":"8.432","t":"-4.8%","d":"down"},{"l":"Patentes (YTD)","v":"1.109","t":"-4.7%","d":"down"},{"l":"Projetos Innovation Lab","v":"4.510","t":"+8.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€40.4M","t":"-3.7%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.837","98.7%","8.561","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.228","90.0%","7.069","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.919","83.9%","4.149","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.226","92.2%","4.080","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.351","93.8%","1.865","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":968},{"label":"Fev","value":737},{"label":"Mar","value":703},{"label":"Abr","value":903},{"label":"Mai","value":687},{"label":"Jun","value":794},{"label":"Jul","value":658},{"label":"Ago","value":868},{"label":"Set","value":824},{"label":"Out","value":1013},{"label":"Nov","value":769},{"label":"Dez","value":958}];
const MX = 1013;
