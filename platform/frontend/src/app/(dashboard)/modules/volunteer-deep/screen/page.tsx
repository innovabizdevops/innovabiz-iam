...
const PAGE = "Screen";
const KPIS = [{"l":"Ideias Submetidas","v":"5.291","t":"+4.1%","d":"up"},{"l":"Patentes (YTD)","v":"1.770","t":"+5.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"107","t":"+1.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€47.5M","t":"+17.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.490","76.9%","4.253","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","270","73.5%","6.298","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.032","73.5%","5.828","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.391","93.8%","5.288","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.051","97.0%","6.975","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":540},{"label":"Mar","value":862},{"label":"Abr","value":762},{"label":"Mai","value":532},{"label":"Jun","value":768},{"label":"Jul","value":686},{"label":"Ago","value":608},{"label":"Set","value":515},{"label":"Out","value":819},{"label":"Nov","value":531},{"label":"Dez","value":772}];
const MX = 862;
