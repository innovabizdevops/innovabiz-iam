...
const ACCENT = "#9333ea";
const MODULE = "Volunteer Management Deep";
const PAGE = "Schedule";
const KPIS = [{"l":"Ideias Submetidas","v":"5.463","t":"+13.1%","d":"up"},{"l":"Patentes (YTD)","v":"6.477","t":"+1.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.416","t":"+3.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€21.0M","t":"+17.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.736","79.6%","4.537","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.939","80.6%","7.990","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.100","76.0%","7.377","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.102","80.0%","2.982","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.559","72.6%","7.370","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":738},{"label":"Mar","value":511},{"label":"Abr","value":471},{"label":"Mai","value":661},{"label":"Jun","value":530},{"label":"Jul","value":721},{"label":"Ago","value":529},{"label":"Set","value":497},{"label":"Out","value":675},{"label":"Nov","value":434},{"label":"Dez","value":542}];
const MX = 738;
