...
const KPIS = [{"l":"Ideias Submetidas","v":"2.287","t":"+0.7%","d":"up"},{"l":"Patentes (YTD)","v":"6.467","t":"+3.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.298","t":"+5.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€22.6M","t":"+9.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.269","85.0%","2.528","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.721","99.9%","8.962","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.878","82.2%","6.905","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.834","71.1%","1.816","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.733","75.0%","8.220","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":935},{"label":"Fev","value":877},{"label":"Mar","value":848},{"label":"Abr","value":766},{"label":"Mai","value":924},{"label":"Jun","value":872},{"label":"Jul","value":967},{"label":"Ago","value":644},{"label":"Set","value":740},{"label":"Out","value":922},{"label":"Nov","value":901},{"label":"Dez","value":806}];
const MX = 967;
