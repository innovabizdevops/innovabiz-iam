...
/* ═══ Volunteer Management Deep — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "7018", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1795", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€442K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "641556618", cells: ["VOL-1618", "Volunteer Management Deep Item 1", "11/7/2026", "€6718"], status: "active" as const },
    { id: "641560189", cells: ["VOL-5189", "Volunteer Management Deep Item 2", "26/2/2026", "€10 289"], status: "pending" as const },
    { id: "641563760", cells: ["VOL-8760", "Volunteer Management Deep Item 3", "13/9/2026", "€13 860"], status: "completed" as const },
    { id: "641567331", cells: ["VOL-3331", "Volunteer Management Deep Item 4", "28/4/2026", "€17 431"], status: "warning" as const },
    { id: "641570902", cells: ["VOL-6902", "Volunteer Management Deep Item 5", "15/11/2026", "€21 002"], status: "active" as const },
];
...
export default function VolunteerManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Volunteer Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Volunteer Management Deep</p>
                    </div>
                </div>
