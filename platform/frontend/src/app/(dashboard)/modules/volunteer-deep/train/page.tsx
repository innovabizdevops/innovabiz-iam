...
const PAGE = "Train";
const KPIS = [{"l":"Ideias Submetidas","v":"7.015","t":"+2.6%","d":"up"},{"l":"Patentes (YTD)","v":"3.659","t":"+8.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.516","t":"+8.0%","d":"up"},{"l":"Budget I&D (€M)","v":"€24.8M","t":"+10.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.891","70.4%","1.571","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.376","95.8%","6.073","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.866","77.5%","7.815","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.553","90.3%","1.117","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.167","90.4%","7.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":808},{"label":"Mar","value":861},{"label":"Abr","value":743},{"label":"Mai","value":691},{"label":"Jun","value":628},{"label":"Jul","value":795},{"label":"Ago","value":605},{"label":"Set","value":745},{"label":"Out","value":864},{"label":"Nov","value":820},{"label":"Dez","value":662}];
const MX = 890;
