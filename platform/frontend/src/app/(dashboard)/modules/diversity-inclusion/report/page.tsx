...
const ACCENT = "#6366f1";
const MODULE = "Diversity & Inclusion";
const PAGE = "Report";
const KPIS = [{"l":"Total Diversity Inclusion","v":"7.866","t":"-4.7%","d":"down"},{"l":"Report Ativos","v":"6.517","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"83","t":"+12.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Diversity Inclusion #001","Diversity Inclusion #002","2.269","6.351","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Diversity Inclusion #002","Diversity Inclusion #003","6.971","3.090","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Diversity Inclusion #003","Diversity Inclusion #004","5.300","1.581","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Diversity Inclusion #004","Diversity Inclusion #005","2.069","1.142","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Diversity Inclusion #005","Diversity Inclusion #001","8.623","799","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":829},{"label":"Mar","value":623},{"label":"Abr","value":948},{"label":"Mai","value":763},{"label":"Jun","value":806},{"label":"Jul","value":842},{"label":"Ago","value":886},{"label":"Set","value":764},{"label":"Out","value":740},{"label":"Nov","value":666},{"label":"Dez","value":810}];
const MX = 948;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>DEI</span></h1>
                </div>
