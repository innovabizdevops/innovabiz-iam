...
const PAGE = "Switching Ops";
const KPIS = [{"l":"Total Grid Mgmt","v":"7.887","t":"-4.9%","d":"down"},{"l":"Switching Ops Ativos","v":"8.793","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+14.4%","d":"up"}];
const COLS = ["ID","Switching Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Mgmt #001","Grid Mgmt #002","3.996","3.075","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Mgmt #002","Grid Mgmt #003","209","5.989","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Mgmt #003","Grid Mgmt #004","2.669","934","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Mgmt #004","Grid Mgmt #005","866","4.283","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Mgmt #005","Grid Mgmt #001","8.013","2.861","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":637},{"label":"Mar","value":640},{"label":"Abr","value":664},{"label":"Mai","value":571},{"label":"Jun","value":530},{"label":"Jul","value":519},{"label":"Ago","value":658},{"label":"Set","value":665},{"label":"Out","value":514},{"label":"Nov","value":648},{"label":"Dez","value":485}];
const MX = 665;
