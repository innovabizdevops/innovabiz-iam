...
const KPIS = [{"l":"Total Grid Mgmt","v":"192","t":"+16.1%","d":"up"},{"l":"Load Balance Ativos","v":"2.145","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"93","t":"-5.8%","d":"down"}];
const COLS = ["ID","Load Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Mgmt #001","Grid Mgmt #002","8.340","5.060","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Mgmt #002","Grid Mgmt #003","8.188","3.272","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Mgmt #003","Grid Mgmt #004","1.408","1.556","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Mgmt #004","Grid Mgmt #005","3.457","3.713","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Mgmt #005","Grid Mgmt #001","8.029","7.016","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":827},{"label":"Mar","value":731},{"label":"Abr","value":721},{"label":"Mai","value":541},{"label":"Jun","value":748},{"label":"Jul","value":491},{"label":"Ago","value":690},{"label":"Set","value":583},{"label":"Out","value":627},{"label":"Nov","value":555},{"label":"Dez","value":692}];
const MX = 827;
