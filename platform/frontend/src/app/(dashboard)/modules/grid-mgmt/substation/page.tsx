...
const PAGE = "Substation";
const KPIS = [{"l":"Total Grid Mgmt","v":"3.450","t":"-5.2%","d":"down"},{"l":"Substation Ativos","v":"8.450","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"91","t":"+16.2%","d":"up"}];
const COLS = ["ID","Substation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Mgmt #001","Grid Mgmt #002","2.956","6.794","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Mgmt #002","Grid Mgmt #003","5.934","9.065","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Mgmt #003","Grid Mgmt #004","937","6.593","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Mgmt #004","Grid Mgmt #005","3.150","3.576","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Mgmt #005","Grid Mgmt #001","3.936","5.862","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":248},{"label":"Fev","value":470},{"label":"Mar","value":373},{"label":"Abr","value":565},{"label":"Mai","value":584},{"label":"Jun","value":382},{"label":"Jul","value":347},{"label":"Ago","value":332},{"label":"Set","value":444},{"label":"Out","value":314},{"label":"Nov","value":389},{"label":"Dez","value":292}];
const MX = 584;
