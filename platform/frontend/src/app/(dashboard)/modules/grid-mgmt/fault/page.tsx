...
const ACCENT = "#1e40af";
const MODULE = "Grid Management";
const PAGE = "Fault Detect";
const KPIS = [{"l":"Total Grid Mgmt","v":"3.970","t":"+2.6%","d":"up"},{"l":"Fault Detect Ativos","v":"7.856","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"65.0%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+9.1%","d":"up"}];
const COLS = ["ID","Fault Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Mgmt #001","Grid Mgmt #002","5.047","2.575","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Mgmt #002","Grid Mgmt #003","8.924","1.994","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Mgmt #003","Grid Mgmt #004","4.531","8.234","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Mgmt #004","Grid Mgmt #005","4.637","1.332","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Mgmt #005","Grid Mgmt #001","997","8.132","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":368},{"label":"Mar","value":493},{"label":"Abr","value":494},{"label":"Mai","value":622},{"label":"Jun","value":451},{"label":"Jul","value":274},{"label":"Ago","value":564},{"label":"Set","value":662},{"label":"Out","value":298},{"label":"Nov","value":523},{"label":"Dez","value":533}];
const MX = 662;
