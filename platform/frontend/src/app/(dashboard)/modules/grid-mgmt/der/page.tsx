...
const PAGE = "DER Mgmt";
const KPIS = [{"l":"Total Grid Mgmt","v":"947","t":"-2.9%","d":"down"},{"l":"DER Mgmt Ativos","v":"1.509","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+5.3%","d":"up"}];
const COLS = ["ID","DER Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Mgmt #001","Grid Mgmt #002","4.111","8.611","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Mgmt #002","Grid Mgmt #003","5.605","2.124","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Mgmt #003","Grid Mgmt #004","125","6.910","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Mgmt #004","Grid Mgmt #005","4.518","519","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Mgmt #005","Grid Mgmt #001","7.916","8.851","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":540},{"label":"Mar","value":709},{"label":"Abr","value":704},{"label":"Mai","value":714},{"label":"Jun","value":817},{"label":"Jul","value":557},{"label":"Ago","value":815},{"label":"Set","value":625},{"label":"Out","value":538},{"label":"Nov","value":745},{"label":"Dez","value":790}];
const MX = 817;
