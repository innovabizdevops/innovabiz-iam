...
const PAGE = "Report";
const KPIS = [{"l":"Projetos Melhoria","v":"8.145","t":"+2.7%","d":"up"},{"l":"Savings (€)","v":"€67714","t":"+8.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.4%","t":"+15.2%","d":"up"},{"l":"Ciclos PDCA","v":"4.223","t":"+3.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.618","€ 31661.50","964","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.838","€ 49455.78","8.229","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.914","€ 50063.47","6.997","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.312","€ 17951.83","1.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.464","€ 25113.41","4.607","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":681},{"label":"Mar","value":874},{"label":"Abr","value":982},{"label":"Mai","value":991},{"label":"Jun","value":857},{"label":"Jul","value":705},{"label":"Ago","value":859},{"label":"Set","value":921},{"label":"Out","value":888},{"label":"Nov","value":702},{"label":"Dez","value":807}];
const MX = 991;
