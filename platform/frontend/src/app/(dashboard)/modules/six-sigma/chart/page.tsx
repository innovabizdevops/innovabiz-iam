...
const ACCENT = "#6366f1";
const MODULE = "Six Sigma";
const PAGE = "Control Chart";
const KPIS = [{"l":"Projetos Melhoria","v":"2.043","t":"+1.1%","d":"up"},{"l":"Savings (€)","v":"€77096","t":"-0.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"91.0%","t":"+8.9%","d":"up"},{"l":"Ciclos PDCA","v":"664","t":"+6.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.954","€ 3038.59","977","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.160","€ 47422.98","8.444","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.021","€ 20614.59","7.047","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.580","€ 45827.53","4.597","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.223","€ 28088.34","2.585","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":600},{"label":"Mar","value":661},{"label":"Abr","value":646},{"label":"Mai","value":638},{"label":"Jun","value":550},{"label":"Jul","value":334},{"label":"Ago","value":391},{"label":"Set","value":562},{"label":"Out","value":437},{"label":"Nov","value":548},{"label":"Dez","value":521}];
const MX = 661;
