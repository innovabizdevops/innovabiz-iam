...
const PAGE = "DOE";
const KPIS = [{"l":"Projetos Melhoria","v":"4.291","t":"-5.5%","d":"down"},{"l":"Savings (€)","v":"€56493","t":"+17.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.6%","t":"+16.6%","d":"up"},{"l":"Ciclos PDCA","v":"3.390","t":"+8.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.121","€ 41052.87","4.599","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.788","€ 14765.83","565","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.401","€ 14422.84","1.060","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.173","€ 45906.25","1.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.729","€ 28329.31","4.935","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":529},{"label":"Mar","value":519},{"label":"Abr","value":474},{"label":"Mai","value":287},{"label":"Jun","value":373},{"label":"Jul","value":512},{"label":"Ago","value":409},{"label":"Set","value":569},{"label":"Out","value":310},{"label":"Nov","value":443},{"label":"Dez","value":236}];
const MX = 569;
