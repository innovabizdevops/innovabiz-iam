...
const PAGE = "DMAIC";
const KPIS = [{"l":"Projetos Melhoria","v":"1.432","t":"+13.8%","d":"up"},{"l":"Savings (€)","v":"€12266","t":"-4.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.1%","t":"+7.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.782","t":"+12.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.655","€ 32570.69","5.058","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.186","€ 33726.81","3.976","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.119","€ 31847.66","1.294","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.173","€ 828.69","3.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.570","€ 44489.05","3.904","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":887},{"label":"Mar","value":936},{"label":"Abr","value":858},{"label":"Mai","value":693},{"label":"Jun","value":943},{"label":"Jul","value":872},{"label":"Ago","value":671},{"label":"Set","value":856},{"label":"Out","value":744},{"label":"Nov","value":934},{"label":"Dez","value":794}];
const MX = 943;
