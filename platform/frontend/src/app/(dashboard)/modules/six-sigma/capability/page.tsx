...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.614","t":"-0.9%","d":"down"},{"l":"NC Abertas","v":"8.584","t":"+3.7%","d":"up"},{"l":"Conformidade (%)","v":"72.4%","t":"+9.2%","d":"up"},{"l":"CAPAs Pendentes","v":"138","t":"+14.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.713","86.8%","7.577","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.049","78.0%","4.016","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.591","87.9%","7.203","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.202","89.5%","157","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.376","85.9%","8.093","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":413},{"label":"Mar","value":701},{"label":"Abr","value":541},{"label":"Mai","value":527},{"label":"Jun","value":736},{"label":"Jul","value":641},{"label":"Ago","value":774},{"label":"Set","value":728},{"label":"Out","value":724},{"label":"Nov","value":476},{"label":"Dez","value":514}];
const MX = 774;
