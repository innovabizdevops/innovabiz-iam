...
/* ═══ GenAI Enterprise Suite — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "6239", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "819", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€147K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "566028739", cells: ["GEN-1739", "GenAI Enterprise Suite Item 1", "4/8/2026", "€28 839"], status: "active" as const },
    { id: "566032310", cells: ["GEN-5310", "GenAI Enterprise Suite Item 2", "19/3/2026", "€32 410"], status: "pending" as const },
    { id: "566035881", cells: ["GEN-8881", "GenAI Enterprise Suite Item 3", "6/10/2026", "€35 981"], status: "completed" as const },
    { id: "566039452", cells: ["GEN-3452", "GenAI Enterprise Suite Item 4", "21/5/2026", "€39 552"], status: "warning" as const },
    { id: "566043023", cells: ["GEN-7023", "GenAI Enterprise Suite Item 5", "8/12/2026", "€43 123"], status: "active" as const },
];
...
export default function GenaiEnterpriseSuitePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Enterprise Suite</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Enterprise Suite</p>
                    </div>
                </div>
