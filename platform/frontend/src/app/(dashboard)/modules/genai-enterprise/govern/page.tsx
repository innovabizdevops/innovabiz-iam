...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Enterprise Suite";
const PAGE = "Govern";
const KPIS = [{"l":"Total Genai Enterprise","v":"1.765","t":"+10.4%","d":"up"},{"l":"Govern Ativos","v":"1.544","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"83.1%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"58","t":"-3.3%","d":"down"}];
const COLS = ["ID","Govern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Enterprise #001","Genai Enterprise #002","4.359","2.738","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Enterprise #002","Genai Enterprise #003","3.999","116","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Enterprise #003","Genai Enterprise #004","4.738","7.064","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Enterprise #004","Genai Enterprise #005","2.070","2.755","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Enterprise #005","Genai Enterprise #001","3.476","984","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":758},{"label":"Mar","value":907},{"label":"Abr","value":964},{"label":"Mai","value":869},{"label":"Jun","value":688},{"label":"Jul","value":715},{"label":"Ago","value":732},{"label":"Set","value":857},{"label":"Out","value":575},{"label":"Nov","value":692},{"label":"Dez","value":846}];
const MX = 964;
