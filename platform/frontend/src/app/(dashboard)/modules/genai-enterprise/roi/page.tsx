...
const PAGE = "ROI";
const KPIS = [{"l":"Total Genai Enterprise","v":"3.616","t":"+17.0%","d":"up"},{"l":"ROI Ativos","v":"2.301","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"85","t":"+1.3%","d":"up"}];
const COLS = ["ID","ROI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Enterprise #001","Genai Enterprise #002","8.675","682","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Enterprise #002","Genai Enterprise #003","6.975","4.109","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Enterprise #003","Genai Enterprise #004","3.950","7.390","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Enterprise #004","Genai Enterprise #005","5.067","2.011","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Enterprise #005","Genai Enterprise #001","4.019","6.242","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":972},{"label":"Mar","value":655},{"label":"Abr","value":689},{"label":"Mai","value":617},{"label":"Jun","value":695},{"label":"Jul","value":727},{"label":"Ago","value":687},{"label":"Set","value":748},{"label":"Out","value":939},{"label":"Nov","value":664},{"label":"Dez","value":999}];
const MX = 999;
