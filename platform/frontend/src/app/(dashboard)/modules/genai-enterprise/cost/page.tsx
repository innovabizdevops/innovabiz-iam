...
const PAGE = "Cost";
const KPIS = [{"l":"Total Genai Enterprise","v":"7.091","t":"-1.4%","d":"down"},{"l":"Cost Ativos","v":"7.030","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"94","t":"+15.6%","d":"up"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Enterprise #001","Genai Enterprise #002","1.277","8.437","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Enterprise #002","Genai Enterprise #003","7.988","7.108","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Enterprise #003","Genai Enterprise #004","364","6.422","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Enterprise #004","Genai Enterprise #005","5.626","2.486","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Enterprise #005","Genai Enterprise #001","5.415","6.073","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":720},{"label":"Mar","value":721},{"label":"Abr","value":647},{"label":"Mai","value":756},{"label":"Jun","value":976},{"label":"Jul","value":989},{"label":"Ago","value":672},{"label":"Set","value":881},{"label":"Out","value":695},{"label":"Nov","value":986},{"label":"Dez","value":701}];
const MX = 989;
