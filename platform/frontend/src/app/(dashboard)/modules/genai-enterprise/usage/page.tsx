...
const PAGE = "Usage";
const KPIS = [{"l":"Total Genai Enterprise","v":"7.390","t":"-5.8%","d":"down"},{"l":"Usage Ativos","v":"5.550","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"69","t":"-5.2%","d":"down"}];
const COLS = ["ID","Usage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Enterprise #001","Genai Enterprise #002","127","4.219","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Enterprise #002","Genai Enterprise #003","3.124","8.910","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Enterprise #003","Genai Enterprise #004","3.111","9.041","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Enterprise #004","Genai Enterprise #005","2.038","8.042","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Enterprise #005","Genai Enterprise #001","3.989","2.399","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":813},{"label":"Mar","value":682},{"label":"Abr","value":582},{"label":"Mai","value":598},{"label":"Jun","value":779},{"label":"Jul","value":578},{"label":"Ago","value":537},{"label":"Set","value":479},{"label":"Out","value":677},{"label":"Nov","value":612},{"label":"Dez","value":679}];
const MX = 813;
