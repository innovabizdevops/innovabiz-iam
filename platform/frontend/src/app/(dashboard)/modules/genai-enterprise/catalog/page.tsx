...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.637","t":"+5.7%","d":"up"},{"l":"Queries/Dia","v":"4994","t":"+10.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.537","t":"+11.9%","d":"up"},{"l":"Utilizadores Analytics","v":"6.167","t":"+6.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","670","2026-03-07","1.510","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1436","2026-01-13","6.890","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3370","2026-01-13","7.847","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1626","2026-02-15","4.579","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1800","2026-02-04","7.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":1025},{"label":"Mar","value":653},{"label":"Abr","value":964},{"label":"Mai","value":871},{"label":"Jun","value":761},{"label":"Jul","value":784},{"label":"Ago","value":704},{"label":"Set","value":669},{"label":"Out","value":955},{"label":"Nov","value":952},{"label":"Dez","value":1024}];
const MX = 1025;
