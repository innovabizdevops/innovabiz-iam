...
const PAGE = "Space Occupancy";
const KPIS = [{"l":"Quartos Ocupados","v":"2.870","t":"+9.5%","d":"up"},{"l":"RevPAR (€)","v":"€53766","t":"-0.9%","d":"down"},{"l":"Ocupação (%)","v":"78.4%","t":"+1.0%","d":"up"},{"l":"Guest Satisfaction","v":"3.751","t":"-3.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.013","2026-03-13","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.180","2026-02-23","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.862","2026-02-01","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.364","2026-03-23","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.136","2026-03-25","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":827},{"label":"Mar","value":863},{"label":"Abr","value":749},{"label":"Mai","value":714},{"label":"Jun","value":884},{"label":"Jul","value":733},{"label":"Ago","value":963},{"label":"Set","value":916},{"label":"Out","value":994},{"label":"Nov","value":748},{"label":"Dez","value":758}];
const MX = 994;
