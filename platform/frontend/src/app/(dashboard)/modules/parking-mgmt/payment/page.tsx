...
const PAGE = "Payment Gateway";
const KPIS = [{"l":"Integrações Ativas","v":"2.510","t":"+13.3%","d":"up"},{"l":"Chamadas/Hora","v":"2683","t":"+4.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.3%","t":"-2.7%","d":"down"},{"l":"Latência Média (ms)","v":"170ms","t":"+7.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.220","5.314","87.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.803","8.779","75.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.394","8.833","71.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.506","1.853","94.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.198","8.482","80.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":289},{"label":"Fev","value":309},{"label":"Mar","value":492},{"label":"Abr","value":266},{"label":"Mai","value":597},{"label":"Jun","value":408},{"label":"Jul","value":555},{"label":"Ago","value":329},{"label":"Set","value":289},{"label":"Out","value":263},{"label":"Nov","value":413},{"label":"Dez","value":441}];
const MX = 597;
