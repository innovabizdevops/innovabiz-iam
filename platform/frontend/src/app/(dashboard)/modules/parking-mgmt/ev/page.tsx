...
const ACCENT = "#7c3aed";
const MODULE = "Parking Management";
const PAGE = "EV Charging";
const KPIS = [{"l":"Total Parking Mgmt","v":"6.671","t":"+9.4%","d":"up"},{"l":"EV Charging Ativos","v":"1.864","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"85.7%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.6%","d":"up"}];
const COLS = ["ID","EV Charging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parking Mgmt #001","Parking Mgmt #002","7.038","5.145","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Parking Mgmt #002","Parking Mgmt #003","4.216","754","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Parking Mgmt #003","Parking Mgmt #004","8.651","8.301","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Parking Mgmt #004","Parking Mgmt #005","2.106","4.553","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parking Mgmt #005","Parking Mgmt #001","6.838","4.263","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":712},{"label":"Mar","value":748},{"label":"Abr","value":681},{"label":"Mai","value":831},{"label":"Jun","value":675},{"label":"Jul","value":836},{"label":"Ago","value":779},{"label":"Set","value":864},{"label":"Out","value":751},{"label":"Nov","value":958},{"label":"Dez","value":722}];
const MX = 958;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>EV</span></h1>
                </div>
