...
const PAGE = "Dynamic Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€2.9M","t":"-2.2%","d":"down"},{"l":"MRR (€)","v":"€55996","t":"+11.4%","d":"up"},{"l":"Churn (%)","v":"91.1%","t":"+8.6%","d":"up"},{"l":"ARPU (€)","v":"€64531","t":"+16.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25129.94","3.358","€ 2696.09","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 1499.52","2.109","€ 1783.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37337.44","791","€ 47228.63","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 37227.53","4.228","€ 2579.28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46311.85","3.978","€ 11864.50","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":294},{"label":"Mar","value":315},{"label":"Abr","value":316},{"label":"Mai","value":293},{"label":"Jun","value":309},{"label":"Jul","value":378},{"label":"Ago","value":628},{"label":"Set","value":287},{"label":"Out","value":317},{"label":"Nov","value":568},{"label":"Dez","value":479}];
const MX = 628;
