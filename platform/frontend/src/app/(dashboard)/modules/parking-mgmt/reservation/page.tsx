...
const KPIS = [{"l":"Quartos Ocupados","v":"5.896","t":"+5.4%","d":"up"},{"l":"RevPAR (€)","v":"€16260","t":"+17.8%","d":"up"},{"l":"Ocupação (%)","v":"78.6%","t":"+3.6%","d":"up"},{"l":"Guest Satisfaction","v":"2.870","t":"+16.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.951","2026-02-23","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.884","2026-01-19","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.397","2026-01-13","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.953","2026-03-04","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.521","2026-02-04","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":659},{"label":"Mar","value":867},{"label":"Abr","value":960},{"label":"Mai","value":885},{"label":"Jun","value":835},{"label":"Jul","value":899},{"label":"Ago","value":744},{"label":"Set","value":965},{"label":"Out","value":924},{"label":"Nov","value":925},{"label":"Dez","value":920}];
const MX = 965;
