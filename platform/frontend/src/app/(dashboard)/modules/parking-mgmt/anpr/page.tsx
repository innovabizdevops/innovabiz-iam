...
const PAGE = "ANPR Camera";
const KPIS = [{"l":"Total Parking Mgmt","v":"4.627","t":"-2.9%","d":"down"},{"l":"ANPR Camera Ativos","v":"1.538","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"74","t":"+3.9%","d":"up"}];
const COLS = ["ID","ANPR Camera","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Parking Mgmt #001","Parking Mgmt #002","3.558","8.154","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Parking Mgmt #002","Parking Mgmt #003","606","7.764","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Parking Mgmt #003","Parking Mgmt #004","3.463","3.893","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Parking Mgmt #004","Parking Mgmt #005","6.879","1.999","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Parking Mgmt #005","Parking Mgmt #001","6.254","7.922","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":716},{"label":"Mar","value":630},{"label":"Abr","value":473},{"label":"Mai","value":378},{"label":"Jun","value":648},{"label":"Jul","value":348},{"label":"Ago","value":604},{"label":"Set","value":550},{"label":"Out","value":448},{"label":"Nov","value":735},{"label":"Dez","value":699}];
const MX = 735;
