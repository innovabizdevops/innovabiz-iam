...
const PAGE = "Revenue Report";
const KPIS = [{"l":"ARR (€M)","v":"€36.1M","t":"+8.4%","d":"up"},{"l":"MRR (€)","v":"€1120","t":"+3.8%","d":"up"},{"l":"Churn (%)","v":"78.6%","t":"-1.6%","d":"down"},{"l":"ARPU (€)","v":"€43105","t":"+2.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 22142.51","8.239","€ 37692.57","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41483.93","8.139","€ 2618.80","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29362.44","3.686","€ 44776.21","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31430.73","2.993","€ 1699.47","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9633.47","7.820","€ 49975.42","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":985},{"label":"Mar","value":833},{"label":"Abr","value":776},{"label":"Mai","value":922},{"label":"Jun","value":784},{"label":"Jul","value":812},{"label":"Ago","value":836},{"label":"Set","value":608},{"label":"Out","value":896},{"label":"Nov","value":794},{"label":"Dez","value":815}];
const MX = 985;
