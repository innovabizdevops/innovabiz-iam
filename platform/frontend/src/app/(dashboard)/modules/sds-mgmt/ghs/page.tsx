...
const PAGE = "GHS Classify";
const KPIS = [{"l":"Total Sds Mgmt","v":"1.875","t":"+5.9%","d":"up"},{"l":"GHS Classify Ativos","v":"7.370","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"84","t":"+9.6%","d":"up"}];
const COLS = ["ID","GHS Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sds Mgmt #001","Sds Mgmt #002","8.172","5.259","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Sds Mgmt #002","Sds Mgmt #003","2.687","3.609","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Sds Mgmt #003","Sds Mgmt #004","1.527","3.081","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Sds Mgmt #004","Sds Mgmt #005","2.475","3.407","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sds Mgmt #005","Sds Mgmt #001","4.346","2.936","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":467},{"label":"Mar","value":701},{"label":"Abr","value":559},{"label":"Mai","value":596},{"label":"Jun","value":427},{"label":"Jul","value":403},{"label":"Ago","value":331},{"label":"Set","value":324},{"label":"Out","value":609},{"label":"Nov","value":464},{"label":"Dez","value":605}];
const MX = 701;
