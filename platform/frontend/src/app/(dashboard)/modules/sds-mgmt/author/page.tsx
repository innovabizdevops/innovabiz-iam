...
const ACCENT = "#dc2626";
const MODULE = "SDS Management";
const PAGE = "SDS Author";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.705","t":"+13.0%","d":"up"},{"l":"Sessões/Dia","v":"3664","t":"+0.5%","d":"up"},{"l":"MFA Adoção (%)","v":"69.1%","t":"+11.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"491","t":"+12.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.652","3.861","2.196","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.556","5.768","271","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.980","7.180","2.715","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","753","1.543","6.925","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.395","3.592","3.720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":384},{"label":"Mar","value":478},{"label":"Abr","value":319},{"label":"Mai","value":458},{"label":"Jun","value":336},{"label":"Jul","value":480},{"label":"Ago","value":573},{"label":"Set","value":385},{"label":"Out","value":473},{"label":"Nov","value":398},{"label":"Dez","value":556}];
const MX = 573;
