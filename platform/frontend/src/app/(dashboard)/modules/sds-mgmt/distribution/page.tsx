...
const KPIS = [{"l":"Total Sds Mgmt","v":"3.131","t":"+16.8%","d":"up"},{"l":"Distribution Ativos","v":"7.363","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"89","t":"-5.6%","d":"down"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sds Mgmt #001","Sds Mgmt #002","5.965","402","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Sds Mgmt #002","Sds Mgmt #003","6.554","6.990","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Sds Mgmt #003","Sds Mgmt #004","4.685","4.692","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Sds Mgmt #004","Sds Mgmt #005","8.696","1.662","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sds Mgmt #005","Sds Mgmt #001","1.137","2.849","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":704},{"label":"Mar","value":442},{"label":"Abr","value":728},{"label":"Mai","value":568},{"label":"Jun","value":465},{"label":"Jul","value":689},{"label":"Ago","value":703},{"label":"Set","value":545},{"label":"Out","value":604},{"label":"Nov","value":502},{"label":"Dez","value":808}];
const MX = 808;
