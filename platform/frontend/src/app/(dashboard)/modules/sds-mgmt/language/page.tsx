...
const KPIS = [{"l":"Total Sds Mgmt","v":"2.404","t":"+16.4%","d":"up"},{"l":"Multi Language Ativos","v":"1.650","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"74","t":"+5.1%","d":"up"}];
const COLS = ["ID","Multi Language","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sds Mgmt #001","Sds Mgmt #002","7.168","4.589","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sds Mgmt #002","Sds Mgmt #003","7.649","4.956","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Sds Mgmt #003","Sds Mgmt #004","3.781","420","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sds Mgmt #004","Sds Mgmt #005","2.119","6.585","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sds Mgmt #005","Sds Mgmt #001","3.456","1.992","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1026},{"label":"Fev","value":987},{"label":"Mar","value":711},{"label":"Abr","value":704},{"label":"Mai","value":1000},{"label":"Jun","value":818},{"label":"Jul","value":1017},{"label":"Ago","value":741},{"label":"Set","value":1036},{"label":"Out","value":756},{"label":"Nov","value":754},{"label":"Dez","value":1025}];
const MX = 1036;
