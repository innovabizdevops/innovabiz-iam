...
const KPIS = [{"l":"Total Sds Mgmt","v":"7.996","t":"+1.0%","d":"up"},{"l":"Regulatory Ativos","v":"2.951","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"92.2%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+2.4%","d":"up"}];
const COLS = ["ID","Regulatory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sds Mgmt #001","Sds Mgmt #002","7.366","5.924","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Sds Mgmt #002","Sds Mgmt #003","1.995","4.404","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Sds Mgmt #003","Sds Mgmt #004","1.054","3.352","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Sds Mgmt #004","Sds Mgmt #005","1.148","532","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sds Mgmt #005","Sds Mgmt #001","7.092","612","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":743},{"label":"Mar","value":678},{"label":"Abr","value":787},{"label":"Mai","value":881},{"label":"Jun","value":956},{"label":"Jul","value":595},{"label":"Ago","value":909},{"label":"Set","value":942},{"label":"Out","value":751},{"label":"Nov","value":934},{"label":"Dez","value":761}];
const MX = 956;
