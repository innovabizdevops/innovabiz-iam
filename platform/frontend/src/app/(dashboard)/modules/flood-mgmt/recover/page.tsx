...
const PAGE = "Recover";
const KPIS = [{"l":"Total Flood Mgmt","v":"7.041","t":"-2.7%","d":"down"},{"l":"Recover Ativos","v":"6.479","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"80","t":"+4.0%","d":"up"}];
const COLS = ["ID","Recover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flood Mgmt #001","Flood Mgmt #002","5.915","4.165","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Flood Mgmt #002","Flood Mgmt #003","2.080","5.070","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Flood Mgmt #003","Flood Mgmt #004","787","4.156","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Flood Mgmt #004","Flood Mgmt #005","4.344","6.088","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flood Mgmt #005","Flood Mgmt #001","620","4.575","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":652},{"label":"Mar","value":1013},{"label":"Abr","value":706},{"label":"Mai","value":735},{"label":"Jun","value":930},{"label":"Jul","value":955},{"label":"Ago","value":972},{"label":"Set","value":666},{"label":"Out","value":757},{"label":"Nov","value":949},{"label":"Dez","value":930}];
const MX = 1013;
