...
const PAGE = "Response";
const KPIS = [{"l":"Total Flood Mgmt","v":"5.614","t":"+3.0%","d":"up"},{"l":"Response Ativos","v":"5.185","t":"-4.0%","d":"down"},{"l":"Eficiência (%)","v":"86.6%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"71","t":"+13.1%","d":"up"}];
const COLS = ["ID","Response","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flood Mgmt #001","Flood Mgmt #002","5.377","3.034","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Flood Mgmt #002","Flood Mgmt #003","1.190","1.952","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Flood Mgmt #003","Flood Mgmt #004","1.337","2.854","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Flood Mgmt #004","Flood Mgmt #005","8.406","5.455","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flood Mgmt #005","Flood Mgmt #001","1.554","6.125","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":578},{"label":"Mar","value":335},{"label":"Abr","value":397},{"label":"Mai","value":458},{"label":"Jun","value":516},{"label":"Jul","value":349},{"label":"Ago","value":347},{"label":"Set","value":513},{"label":"Out","value":499},{"label":"Nov","value":491},{"label":"Dez","value":275}];
const MX = 578;
