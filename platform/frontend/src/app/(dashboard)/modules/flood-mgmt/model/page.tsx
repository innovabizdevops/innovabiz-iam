...
const PAGE = "Model";
const KPIS = [{"l":"Total Flood Mgmt","v":"1.727","t":"+10.3%","d":"up"},{"l":"Model Ativos","v":"7.543","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+3.7%","d":"up"}];
const COLS = ["ID","Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flood Mgmt #001","Flood Mgmt #002","5.303","4.042","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Flood Mgmt #002","Flood Mgmt #003","2.074","4.563","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Flood Mgmt #003","Flood Mgmt #004","248","6.182","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Flood Mgmt #004","Flood Mgmt #005","585","4.668","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flood Mgmt #005","Flood Mgmt #001","6.222","7.804","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":732},{"label":"Mar","value":545},{"label":"Abr","value":850},{"label":"Mai","value":597},{"label":"Jun","value":664},{"label":"Jul","value":832},{"label":"Ago","value":643},{"label":"Set","value":809},{"label":"Out","value":527},{"label":"Nov","value":624},{"label":"Dez","value":747}];
const MX = 850;
