...
const ACCENT = "#083344";
const MODULE = "Flood Management";
const PAGE = "Warning";
const KPIS = [{"l":"Total Flood Mgmt","v":"1.523","t":"+10.8%","d":"up"},{"l":"Warning Ativos","v":"5.005","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"78.1%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"60","t":"+13.3%","d":"up"}];
const COLS = ["ID","Warning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flood Mgmt #001","Flood Mgmt #002","6.559","4.124","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Flood Mgmt #002","Flood Mgmt #003","8.320","3.478","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Flood Mgmt #003","Flood Mgmt #004","1.970","8.627","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Flood Mgmt #004","Flood Mgmt #005","8.989","7.323","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flood Mgmt #005","Flood Mgmt #001","6.236","2.676","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":255},{"label":"Mar","value":543},{"label":"Abr","value":489},{"label":"Mai","value":241},{"label":"Jun","value":240},{"label":"Jul","value":490},{"label":"Ago","value":452},{"label":"Set","value":483},{"label":"Out","value":441},{"label":"Nov","value":437},{"label":"Dez","value":500}];
const MX = 543;
