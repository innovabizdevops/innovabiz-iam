...
const ACCENT = "#6366f1";
const MODULE = "Intermodal Transport";
const PAGE = "Rail-Road";
const KPIS = [{"l":"Riscos Identificados","v":"8.151","t":"+10.0%","d":"up"},{"l":"Mitigações Ativas","v":"4.808","t":"+4.3%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"+14.7%","d":"up"},{"l":"Incidentes YTD","v":"7.694","t":"+13.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.607","4.048","7.304","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.148","3.170","5.571","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.704","802","1.637","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.858","4.132","8.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.685","299","2.617","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":723},{"label":"Mar","value":605},{"label":"Abr","value":398},{"label":"Mai","value":381},{"label":"Jun","value":696},{"label":"Jul","value":546},{"label":"Ago","value":665},{"label":"Set","value":549},{"label":"Out","value":554},{"label":"Nov","value":610},{"label":"Dez","value":694}];
const MX = 723;
