...
export default function IntermodalTransportPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Intermodal Transport</h1><p className="text-sm text-muted-foreground">Intermodal Transport • iBOS Enterprise</p></div>
