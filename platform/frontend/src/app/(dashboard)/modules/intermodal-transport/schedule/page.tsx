...
const PAGE = "Schedule";
const KPIS = [{"l":"Riscos Identificados","v":"756","t":"+12.4%","d":"up"},{"l":"Mitigações Ativas","v":"6.394","t":"+4.3%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"+7.8%","d":"up"},{"l":"Incidentes YTD","v":"2.096","t":"+0.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.332","7.223","8.974","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.048","308","6.703","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.572","1.732","8.820","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","732","2.464","1.389","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.878","9.002","7.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":619},{"label":"Mar","value":455},{"label":"Abr","value":380},{"label":"Mai","value":605},{"label":"Jun","value":398},{"label":"Jul","value":368},{"label":"Ago","value":445},{"label":"Set","value":557},{"label":"Out","value":663},{"label":"Nov","value":697},{"label":"Dez","value":390}];
const MX = 697;
