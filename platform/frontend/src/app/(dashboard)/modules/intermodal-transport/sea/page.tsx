...
const PAGE = "Sea-Rail";
const KPIS = [{"l":"Riscos Identificados","v":"2.711","t":"+11.8%","d":"up"},{"l":"Mitigações Ativas","v":"5.057","t":"-5.9%","d":"down"},{"l":"Score Risco Geral","v":"90","t":"+16.0%","d":"up"},{"l":"Incidentes YTD","v":"4.098","t":"+4.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.660","2.009","3.109","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.270","6.273","8.202","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.066","5.966","7.808","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.746","3.477","4.320","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.618","439","8.437","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":879},{"label":"Mar","value":748},{"label":"Abr","value":990},{"label":"Mai","value":874},{"label":"Jun","value":924},{"label":"Jul","value":959},{"label":"Ago","value":912},{"label":"Set","value":953},{"label":"Out","value":1023},{"label":"Nov","value":842},{"label":"Dez","value":820}];
const MX = 1023;
