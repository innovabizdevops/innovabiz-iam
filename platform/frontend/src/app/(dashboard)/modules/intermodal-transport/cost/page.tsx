...
const PAGE = "Cost";
const KPIS = [{"l":"Riscos Identificados","v":"1.293","t":"+6.0%","d":"up"},{"l":"Mitigações Ativas","v":"6.431","t":"+6.2%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"+1.9%","d":"up"},{"l":"Incidentes YTD","v":"7.782","t":"+14.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.824","491","5.644","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.989","486","7.185","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.522","6.597","8.600","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.527","3.612","7.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.215","594","883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":751},{"label":"Mar","value":705},{"label":"Abr","value":805},{"label":"Mai","value":869},{"label":"Jun","value":599},{"label":"Jul","value":874},{"label":"Ago","value":705},{"label":"Set","value":775},{"label":"Out","value":700},{"label":"Nov","value":735},{"label":"Dez","value":680}];
const MX = 874;
