...
const PAGE = "Terminal";
const KPIS = [{"l":"Riscos Identificados","v":"3.291","t":"+2.6%","d":"up"},{"l":"Mitigações Ativas","v":"2.776","t":"+13.1%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+14.7%","d":"up"},{"l":"Incidentes YTD","v":"6.223","t":"+1.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.576","764","7.020","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.146","1.604","8.642","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.361","8.483","5.734","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.443","274","6.872","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.686","1.359","6.782","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":632},{"label":"Mar","value":350},{"label":"Abr","value":641},{"label":"Mai","value":615},{"label":"Jun","value":362},{"label":"Jul","value":429},{"label":"Ago","value":605},{"label":"Set","value":453},{"label":"Out","value":555},{"label":"Nov","value":373},{"label":"Dez","value":625}];
const MX = 641;
