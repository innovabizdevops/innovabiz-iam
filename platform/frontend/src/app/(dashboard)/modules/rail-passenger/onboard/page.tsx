...
const PAGE = "On-Board";
const KPIS = [{"l":"eNPS","v":"55","t":"+7.0%","d":"up"},{"l":"Engagement (%)","v":"80.9%","t":"+7.5%","d":"up"},{"l":"Turnover (%)","v":"81.6%","t":"+9.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.197","t":"+0.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.229","2026-03-20","81","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.328","2026-02-24","64","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","802","2026-03-04","60","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.626","2026-02-24","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.070","2026-02-23","73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":635},{"label":"Mar","value":733},{"label":"Abr","value":549},{"label":"Mai","value":848},{"label":"Jun","value":531},{"label":"Jul","value":652},{"label":"Ago","value":660},{"label":"Set","value":676},{"label":"Out","value":608},{"label":"Nov","value":766},{"label":"Dez","value":752}];
const MX = 848;
