...
const PAGE = "Booking";
const KPIS = [{"l":"Veículos Operação","v":"444","t":"+9.0%","d":"up"},{"l":"Viagens/Dia","v":"4818","t":"-3.1%","d":"down"},{"l":"Pontualidade (%)","v":"94.2%","t":"-2.5%","d":"down"},{"l":"Passageiros/Dia","v":"5077","t":"+4.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-16","2026-02-28","558","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-25","2026-01-06","5.162","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-24","2026-01-19","6.902","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-25","2026-01-26","2.969","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-24","2026-03-05","3.541","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":714},{"label":"Mar","value":448},{"label":"Abr","value":608},{"label":"Mai","value":712},{"label":"Jun","value":485},{"label":"Jul","value":430},{"label":"Ago","value":625},{"label":"Set","value":521},{"label":"Out","value":512},{"label":"Nov","value":411},{"label":"Dez","value":712}];
const MX = 714;
