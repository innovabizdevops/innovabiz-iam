...
const PAGE = "Schedule";
const KPIS = [{"l":"Veículos Operação","v":"7.190","t":"+4.0%","d":"up"},{"l":"Viagens/Dia","v":"925","t":"+13.3%","d":"up"},{"l":"Pontualidade (%)","v":"67.5%","t":"+4.8%","d":"up"},{"l":"Passageiros/Dia","v":"4871","t":"+5.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-09","2026-01-27","6.186","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-19","2026-01-21","4.997","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-01","2026-02-03","3.517","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-16","2026-01-24","8.045","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-07","2026-02-12","3.037","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1010},{"label":"Fev","value":926},{"label":"Mar","value":1015},{"label":"Abr","value":964},{"label":"Mai","value":1045},{"label":"Jun","value":855},{"label":"Jul","value":847},{"label":"Ago","value":813},{"label":"Set","value":720},{"label":"Out","value":828},{"label":"Nov","value":899},{"label":"Dez","value":830}];
const MX = 1045;
