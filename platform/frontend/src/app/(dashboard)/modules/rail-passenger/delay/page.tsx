...
const ACCENT = "#6366f1";
const MODULE = "Rail Passenger";
const PAGE = "Delay Mgmt";
const KPIS = [{"l":"Veículos Operação","v":"2.005","t":"+6.9%","d":"up"},{"l":"Viagens/Dia","v":"2403","t":"+11.5%","d":"up"},{"l":"Pontualidade (%)","v":"66.9%","t":"-3.6%","d":"down"},{"l":"Passageiros/Dia","v":"4394","t":"+13.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-14","2026-02-28","2.148","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-25","2026-01-17","3.419","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-16","2026-03-28","4.826","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-08","2026-03-05","2.814","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-01","2026-02-18","6.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":562},{"label":"Mar","value":453},{"label":"Abr","value":428},{"label":"Mai","value":580},{"label":"Jun","value":542},{"label":"Jul","value":391},{"label":"Ago","value":576},{"label":"Set","value":287},{"label":"Out","value":392},{"label":"Nov","value":354},{"label":"Dez","value":656}];
const MX = 656;
