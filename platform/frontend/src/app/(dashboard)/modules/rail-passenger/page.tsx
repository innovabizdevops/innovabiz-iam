...
export default function RailPassengerPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Rail Passenger</h1><p className="text-sm text-muted-foreground">Rail Passenger • iBOS Enterprise</p></div>
