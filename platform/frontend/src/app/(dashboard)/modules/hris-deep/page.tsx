...
/* ═══ HRIS Platform Deep — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "4536", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1792", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€186K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "145653236", cells: ["HRI-7236", "HRIS Platform Deep Item 1", "9/9/2026", "€3336"], status: "active" as const },
    { id: "145656807", cells: ["HRI-1807", "HRIS Platform Deep Item 2", "24/4/2026", "€6907"], status: "pending" as const },
    { id: "145660378", cells: ["HRI-5378", "HRIS Platform Deep Item 3", "11/11/2026", "€10 478"], status: "completed" as const },
    { id: "145663949", cells: ["HRI-8949", "HRIS Platform Deep Item 4", "26/6/2026", "€14 049"], status: "warning" as const },
    { id: "145667520", cells: ["HRI-3520", "HRIS Platform Deep Item 5", "13/1/2026", "€17 620"], status: "active" as const },
];
...
export default function HrisPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HRIS Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HRIS Platform Deep</p>
                    </div>
                </div>
