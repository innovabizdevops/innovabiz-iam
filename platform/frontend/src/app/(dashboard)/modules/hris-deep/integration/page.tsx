...
const KPIS = [{"l":"Integrações Ativas","v":"1.806","t":"-3.0%","d":"down"},{"l":"Chamadas/Hora","v":"4210","t":"+5.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.5%","t":"+16.7%","d":"up"},{"l":"Latência Média (ms)","v":"13ms","t":"-3.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","915","7.028","99.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.209","596","84.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.971","4.635","72.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.840","6.000","86.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.521","5.187","78.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":859},{"label":"Mar","value":954},{"label":"Abr","value":1042},{"label":"Mai","value":738},{"label":"Jun","value":899},{"label":"Jul","value":1056},{"label":"Ago","value":1092},{"label":"Set","value":1036},{"label":"Out","value":696},{"label":"Nov","value":790},{"label":"Dez","value":834}];
const MX = 1092;
