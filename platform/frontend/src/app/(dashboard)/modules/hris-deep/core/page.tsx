...
const PAGE = "Core HR";
const KPIS = [{"l":"Total Hris Deep","v":"896","t":"+9.8%","d":"up"},{"l":"Core HR Ativos","v":"7.481","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+8.1%","d":"up"}];
const COLS = ["ID","Core HR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hris Deep #001","Hris Deep #002","5.892","1.186","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Hris Deep #002","Hris Deep #003","350","7.333","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Hris Deep #003","Hris Deep #004","4.519","6.786","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Hris Deep #004","Hris Deep #005","2.265","1.873","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hris Deep #005","Hris Deep #001","2.140","2.685","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":584},{"label":"Mar","value":837},{"label":"Abr","value":475},{"label":"Mai","value":760},{"label":"Jun","value":561},{"label":"Jul","value":537},{"label":"Ago","value":851},{"label":"Set","value":803},{"label":"Out","value":841},{"label":"Nov","value":754},{"label":"Dez","value":491}];
const MX = 851;
