...
const ACCENT = "#0e7490";
const MODULE = "HRIS Platform Deep";
const PAGE = "Org Chart";
const KPIS = [{"l":"Total Hris Deep","v":"8.668","t":"+2.8%","d":"up"},{"l":"Org Chart Ativos","v":"4.238","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+6.0%","d":"up"}];
const COLS = ["ID","Org Chart","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hris Deep #001","Hris Deep #002","3.512","122","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Hris Deep #002","Hris Deep #003","3.365","7.284","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Hris Deep #003","Hris Deep #004","8.270","8.989","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Hris Deep #004","Hris Deep #005","2.925","670","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hris Deep #005","Hris Deep #001","623","676","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":565},{"label":"Mar","value":569},{"label":"Abr","value":311},{"label":"Mai","value":339},{"label":"Jun","value":579},{"label":"Jul","value":594},{"label":"Ago","value":513},{"label":"Set","value":511},{"label":"Out","value":532},{"label":"Nov","value":609},{"label":"Dez","value":525}];
const MX = 609;
