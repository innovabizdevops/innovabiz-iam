...
const PAGE = "Right-Sizing AI";
const KPIS = [{"l":"Total Finops","v":"1.826","t":"-1.3%","d":"down"},{"l":"Right Sizing AI Ativos","v":"993","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"83","t":"+14.3%","d":"up"}];
const COLS = ["ID","Right Sizing AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Finops #001","Finops #002","7.690","113","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Finops #002","Finops #003","6.744","4.532","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Finops #003","Finops #004","8.887","1.961","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Finops #004","Finops #005","7.097","738","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Finops #005","Finops #001","1.986","3.615","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":263},{"label":"Fev","value":575},{"label":"Mar","value":482},{"label":"Abr","value":450},{"label":"Mai","value":499},{"label":"Jun","value":569},{"label":"Jul","value":460},{"label":"Ago","value":242},{"label":"Set","value":373},{"label":"Out","value":612},{"label":"Nov","value":507},{"label":"Dez","value":391}];
const MX = 612;
