...
const ACCENT = "#15803d";
const MODULE = "FinOps & Cloud Cost";
const PAGE = "Carbon Footprint";
const KPIS = [{"l":"Total Finops","v":"6.729","t":"-5.7%","d":"down"},{"l":"Carbon Footprint Ativos","v":"7.648","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"89","t":"-2.7%","d":"down"}];
const COLS = ["ID","Carbon Footprint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Finops #001","Finops #002","5.671","4.982","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Finops #002","Finops #003","2.666","8.144","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Finops #003","Finops #004","3.693","3.575","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Finops #004","Finops #005","4.282","6.257","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Finops #005","Finops #001","1.033","7.930","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":683},{"label":"Mar","value":869},{"label":"Abr","value":847},{"label":"Mai","value":600},{"label":"Jun","value":666},{"label":"Jul","value":970},{"label":"Ago","value":690},{"label":"Set","value":848},{"label":"Out","value":607},{"label":"Nov","value":648},{"label":"Dez","value":684}];
const MX = 970;
