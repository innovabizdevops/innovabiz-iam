...
const PAGE = "Showback/Chargeback";
const KPIS = [{"l":"Total Finops","v":"2.527","t":"+4.4%","d":"up"},{"l":"Showback/Chargeback Ativos","v":"3.743","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"81","t":"+16.2%","d":"up"}];
const COLS = ["ID","Showback/Chargeback","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Finops #001","Finops #002","736","8.277","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Finops #002","Finops #003","4.210","4.041","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Finops #003","Finops #004","4.626","7.573","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Finops #004","Finops #005","8.636","8.479","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Finops #005","Finops #001","4.623","6.410","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":414},{"label":"Mar","value":597},{"label":"Abr","value":430},{"label":"Mai","value":519},{"label":"Jun","value":422},{"label":"Jul","value":472},{"label":"Ago","value":660},{"label":"Set","value":678},{"label":"Out","value":534},{"label":"Nov","value":456},{"label":"Dez","value":528}];
const MX = 678;
