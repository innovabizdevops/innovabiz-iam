...
const PAGE = "Cloud Cost Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.535","t":"+16.0%","d":"up"},{"l":"Queries/Dia","v":"1505","t":"+2.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.441","t":"+13.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.422","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4938","2026-01-05","957","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3664","2026-02-21","4.682","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4296","2026-01-22","5.919","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4484","2026-03-14","4.849","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2922","2026-02-07","1.613","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":690},{"label":"Mar","value":580},{"label":"Abr","value":566},{"label":"Mai","value":691},{"label":"Jun","value":754},{"label":"Jul","value":707},{"label":"Ago","value":450},{"label":"Set","value":404},{"label":"Out","value":713},{"label":"Nov","value":524},{"label":"Dez","value":759}];
const MX = 759;
