...
const PAGE = "Budget Alerts";
const KPIS = [{"l":"Notificações Enviadas","v":"2.926","t":"+10.6%","d":"up"},{"l":"Taxa Entrega (%)","v":"91.0%","t":"+14.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"91.6%","t":"+17.1%","d":"up"},{"l":"Escalações","v":"1.501","t":"-5.3%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.578","75.6%","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.608","94.2%","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.672","82.1%","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","9.048","92.1%","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.629","84.1%","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":683},{"label":"Mar","value":824},{"label":"Abr","value":850},{"label":"Mai","value":1043},{"label":"Jun","value":813},{"label":"Jul","value":697},{"label":"Ago","value":824},{"label":"Set","value":860},{"label":"Out","value":746},{"label":"Nov","value":827},{"label":"Dez","value":949}];
const MX = 1043;
