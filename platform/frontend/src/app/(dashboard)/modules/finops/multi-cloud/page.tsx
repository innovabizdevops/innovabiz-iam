...
const PAGE = "Multi-Cloud Compare";
const KPIS = [{"l":"Total Finops","v":"2.488","t":"+17.3%","d":"up"},{"l":"Multi Cloud Compare Ativos","v":"754","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"84","t":"+2.9%","d":"up"}];
const COLS = ["ID","Multi Cloud Compare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Finops #001","Finops #002","3.556","7.471","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Finops #002","Finops #003","7.226","3.216","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Finops #003","Finops #004","8.197","8.567","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Finops #004","Finops #005","6.441","8.405","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Finops #005","Finops #001","7.171","6.002","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":712},{"label":"Mar","value":617},{"label":"Abr","value":600},{"label":"Mai","value":768},{"label":"Jun","value":772},{"label":"Jul","value":648},{"label":"Ago","value":564},{"label":"Set","value":759},{"label":"Out","value":610},{"label":"Nov","value":586},{"label":"Dez","value":526}];
const MX = 772;
