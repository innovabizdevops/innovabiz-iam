...
const PAGE = "Reserved Instances";
const KPIS = [{"l":"Quartos Ocupados","v":"6.148","t":"+3.9%","d":"up"},{"l":"RevPAR (€)","v":"€90771","t":"+16.7%","d":"up"},{"l":"Ocupação (%)","v":"84.1%","t":"-4.7%","d":"down"},{"l":"Guest Satisfaction","v":"4.187","t":"-0.5%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.234","2026-01-25","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.397","2026-01-10","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.502","2026-03-09","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.069","2026-03-22","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.199","2026-02-10","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":699},{"label":"Mar","value":735},{"label":"Abr","value":951},{"label":"Mai","value":900},{"label":"Jun","value":816},{"label":"Jul","value":753},{"label":"Ago","value":729},{"label":"Set","value":1046},{"label":"Out","value":979},{"label":"Nov","value":851},{"label":"Dez","value":1005}];
const MX = 1046;
