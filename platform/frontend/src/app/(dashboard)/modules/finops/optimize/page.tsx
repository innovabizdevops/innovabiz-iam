...
const KPIS = [{"l":"Total Finops","v":"2.919","t":"-0.7%","d":"down"},{"l":"Cost Optimization Ativos","v":"6.735","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"60","t":"+2.6%","d":"up"}];
const COLS = ["ID","Cost Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Finops #001","Finops #002","5.856","5.313","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Finops #002","Finops #003","517","4.885","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Finops #003","Finops #004","6.963","3.108","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Finops #004","Finops #005","7.846","3.554","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Finops #005","Finops #001","6.803","5.131","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":555},{"label":"Mar","value":647},{"label":"Abr","value":577},{"label":"Mai","value":535},{"label":"Jun","value":733},{"label":"Jul","value":438},{"label":"Ago","value":393},{"label":"Set","value":726},{"label":"Out","value":635},{"label":"Nov","value":404},{"label":"Dez","value":496}];
const MX = 733;
