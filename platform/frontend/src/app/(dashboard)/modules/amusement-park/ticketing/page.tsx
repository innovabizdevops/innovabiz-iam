...
const ACCENT = "#15803d";
const MODULE = "Amusement Park";
const PAGE = "Ticketing";
const KPIS = [{"l":"Tickets Abertos","v":"1.136","t":"+4.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.2%","t":"+4.4%","d":"up"},{"l":"MTTR (h)","v":"120h","t":"-5.0%","d":"down"},{"l":"Satisfação (%)","v":"68.8%","t":"-3.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.473","2.777","7.114","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.105","5.360","5.838","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.541","6.322","4.509","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.862","3.507","4.285","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.008","1.083","8.408","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":572},{"label":"Mar","value":357},{"label":"Abr","value":388},{"label":"Mai","value":424},{"label":"Jun","value":434},{"label":"Jul","value":508},{"label":"Ago","value":279},{"label":"Set","value":433},{"label":"Out","value":236},{"label":"Nov","value":445},{"label":"Dez","value":334}];
const MX = 572;
