...
const PAGE = "Yield";
const KPIS = [{"l":"Vendas YTD (€)","v":"€53800","t":"+6.1%","d":"up"},{"l":"Pipeline (€)","v":"€20664","t":"+0.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"84.4%","t":"+17.4%","d":"up"},{"l":"Win Rate (%)","v":"75.3%","t":"+13.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 11045.96","€ 20432.24","€ 22948.76","80.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 1723.46","€ 49895.82","€ 5603.98","87.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 36106.08","€ 4906.46","€ 35323.13","73.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 38051.24","€ 47771.13","€ 6670.95","95.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 41935.33","€ 49679.07","€ 3315.75","80.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":486},{"label":"Mar","value":747},{"label":"Abr","value":545},{"label":"Mai","value":820},{"label":"Jun","value":533},{"label":"Jul","value":597},{"label":"Ago","value":580},{"label":"Set","value":673},{"label":"Out","value":606},{"label":"Nov","value":780},{"label":"Dez","value":733}];
const MX = 820;
