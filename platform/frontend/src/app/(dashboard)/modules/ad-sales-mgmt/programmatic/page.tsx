...
const ACCENT = "#6366f1";
const MODULE = "Ad Sales Mgmt";
const PAGE = "Programmatic";
const KPIS = [{"l":"Vendas YTD (€)","v":"€57038","t":"+14.5%","d":"up"},{"l":"Pipeline (€)","v":"€68747","t":"+14.1%","d":"up"},{"l":"Atingimento Quota (%)","v":"66.6%","t":"+5.1%","d":"up"},{"l":"Win Rate (%)","v":"83.9%","t":"+7.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 21423.69","€ 3881.25","€ 1908.99","75.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 10735.59","€ 2763.77","€ 7554.34","78.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29744.24","€ 23637.29","€ 18437.79","80.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 45491.19","€ 32048.19","€ 14596.82","72.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 48929.55","€ 20796.54","€ 42085.92","99.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":716},{"label":"Mar","value":839},{"label":"Abr","value":594},{"label":"Mai","value":534},{"label":"Jun","value":841},{"label":"Jul","value":771},{"label":"Ago","value":767},{"label":"Set","value":930},{"label":"Out","value":634},{"label":"Nov","value":910},{"label":"Dez","value":772}];
const MX = 930;
