...
export default function AdSalesMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ad Sales Mgmt</h1><p className="text-sm text-muted-foreground">Ad Sales Mgmt • iBOS Enterprise</p></div>
