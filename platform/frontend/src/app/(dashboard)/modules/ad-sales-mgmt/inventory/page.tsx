...
const KPIS = [{"l":"Vendas YTD (€)","v":"€17587","t":"+6.9%","d":"up"},{"l":"Pipeline (€)","v":"€8652","t":"+11.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"78.0%","t":"+16.1%","d":"up"},{"l":"Win Rate (%)","v":"81.5%","t":"+5.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 25784.26","€ 36787.39","€ 11736.50","72.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 26076.72","€ 24947.52","€ 5666.05","96.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 6627.11","€ 6357.16","€ 11990.94","72.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 6841.13","€ 37833.27","€ 5370.39","75.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 28105.88","€ 5382.47","€ 45929.33","89.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":894},{"label":"Mar","value":812},{"label":"Abr","value":654},{"label":"Mai","value":732},{"label":"Jun","value":678},{"label":"Jul","value":571},{"label":"Ago","value":722},{"label":"Set","value":712},{"label":"Out","value":645},{"label":"Nov","value":612},{"label":"Dez","value":784}];
const MX = 894;
