...
const PAGE = "Campaign";
const KPIS = [{"l":"Vendas YTD (€)","v":"€30385","t":"+11.3%","d":"up"},{"l":"Pipeline (€)","v":"€48911","t":"-2.5%","d":"down"},{"l":"Atingimento Quota (%)","v":"90.6%","t":"+2.4%","d":"up"},{"l":"Win Rate (%)","v":"91.3%","t":"-4.1%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 22072.72","€ 10313.93","€ 11763.95","91.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36339.67","€ 32332.49","€ 25342.83","93.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22993.20","€ 12492.78","€ 7104.88","86.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 48089.59","€ 3950.74","€ 28715.56","84.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 13631.31","€ 25508.11","€ 35957.97","99.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":605},{"label":"Mar","value":419},{"label":"Abr","value":731},{"label":"Mai","value":724},{"label":"Jun","value":443},{"label":"Jul","value":719},{"label":"Ago","value":616},{"label":"Set","value":557},{"label":"Out","value":655},{"label":"Nov","value":426},{"label":"Dez","value":497}];
const MX = 731;
