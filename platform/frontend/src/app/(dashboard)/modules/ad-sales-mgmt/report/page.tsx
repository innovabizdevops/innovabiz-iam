...
const PAGE = "Report";
const KPIS = [{"l":"Vendas YTD (€)","v":"€31622","t":"+12.8%","d":"up"},{"l":"Pipeline (€)","v":"€14464","t":"-2.5%","d":"down"},{"l":"Atingimento Quota (%)","v":"80.1%","t":"+11.8%","d":"up"},{"l":"Win Rate (%)","v":"83.0%","t":"+8.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 19922.95","€ 41347.58","€ 19556.80","84.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 10199.28","€ 41774.51","€ 43713.33","79.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 17533.07","€ 26248.54","€ 35208.15","78.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 49776.22","€ 38626.44","€ 48664.09","73.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 39284.96","€ 45251.88","€ 26059.57","88.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":766},{"label":"Mar","value":774},{"label":"Abr","value":666},{"label":"Mai","value":730},{"label":"Jun","value":675},{"label":"Jul","value":660},{"label":"Ago","value":598},{"label":"Set","value":452},{"label":"Out","value":586},{"label":"Nov","value":497},{"label":"Dez","value":835}];
const MX = 835;
