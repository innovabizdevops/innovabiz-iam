...
const PAGE = "Task Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.588","t":"+10.8%","d":"up"},{"l":"Savings (€)","v":"€62184","t":"+5.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.5%","t":"-1.3%","d":"down"},{"l":"Ciclos PDCA","v":"9.078","t":"+8.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.430","€ 1587.14","7.857","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.062","€ 46703.60","4.980","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.962","€ 14595.37","8.304","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.687","€ 23490.06","6.426","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.880","€ 43787.99","3.837","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":787},{"label":"Mar","value":997},{"label":"Abr","value":789},{"label":"Mai","value":741},{"label":"Jun","value":1059},{"label":"Jul","value":796},{"label":"Ago","value":731},{"label":"Set","value":868},{"label":"Out","value":955},{"label":"Nov","value":939},{"label":"Dez","value":855}];
const MX = 1059;
