...
const PAGE = "Calendar Scheduling";
const KPIS = [{"l":"eNPS","v":"65","t":"+7.4%","d":"up"},{"l":"Engagement (%)","v":"89.0%","t":"-3.4%","d":"down"},{"l":"Turnover (%)","v":"82.3%","t":"+17.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.997","t":"-1.5%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.007","2026-01-28","76","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.358","2026-01-07","78","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.456","2026-01-05","86","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","578","2026-03-13","79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.568","2026-03-17","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":414},{"label":"Mar","value":440},{"label":"Abr","value":478},{"label":"Mai","value":472},{"label":"Jun","value":507},{"label":"Jul","value":465},{"label":"Ago","value":515},{"label":"Set","value":638},{"label":"Out","value":624},{"label":"Nov","value":445},{"label":"Dez","value":695}];
const MX = 695;
