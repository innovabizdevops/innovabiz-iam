...
const PAGE = "Task Board";
const KPIS = [{"l":"Teams Ativos","v":"3.686","t":"-2.5%","d":"down"},{"l":"Reuniões/Semana","v":"2892","t":"+3.1%","d":"up"},{"l":"Mensagens/Dia","v":"1669","t":"+7.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.538","t":"+5.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.888","2736","7.647","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.148","5064","1.075","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.645","3814","1.243","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.546","4816","8.517","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","113","1398","4.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":428},{"label":"Mar","value":733},{"label":"Abr","value":545},{"label":"Mai","value":557},{"label":"Jun","value":619},{"label":"Jul","value":736},{"label":"Ago","value":425},{"label":"Set","value":462},{"label":"Out","value":417},{"label":"Nov","value":636},{"label":"Dez","value":648}];
const MX = 736;
...
export default function TasksCollaborationHubPage() {
    return (
