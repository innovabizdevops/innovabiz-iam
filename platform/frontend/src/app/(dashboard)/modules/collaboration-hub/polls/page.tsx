...
const PAGE = "Polls &amp; Surveys";
const KPIS = [{"l":"Surveys Ativos","v":"108","t":"+11.5%","d":"up"},{"l":"Respostas/Semana","v":"4080","t":"+4.7%","d":"up"},{"l":"NPS Médio","v":"84","t":"+7.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"81.4%","t":"+12.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.923","84","86.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.814","61","91.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.268","69","78.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","504","74","92.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.437","60","77.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":584},{"label":"Mar","value":630},{"label":"Abr","value":723},{"label":"Mai","value":530},{"label":"Jun","value":787},{"label":"Jul","value":523},{"label":"Ago","value":754},{"label":"Set","value":489},{"label":"Out","value":801},{"label":"Nov","value":614},{"label":"Dez","value":681}];
const MX = 801;
