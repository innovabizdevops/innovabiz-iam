...
const PAGE = "Shared Workspaces";
const KPIS = [{"l":"eNPS","v":"56","t":"+14.4%","d":"up"},{"l":"Engagement (%)","v":"92.0%","t":"+11.7%","d":"up"},{"l":"Turnover (%)","v":"69.9%","t":"+8.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"733","t":"+6.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.167","2026-01-12","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","830","2026-03-22","75","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","687","2026-02-25","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.354","2026-03-12","71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.466","2026-03-14","73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":364},{"label":"Fev","value":501},{"label":"Mar","value":403},{"label":"Abr","value":427},{"label":"Mai","value":425},{"label":"Jun","value":575},{"label":"Jul","value":399},{"label":"Ago","value":391},{"label":"Set","value":532},{"label":"Out","value":338},{"label":"Nov","value":416},{"label":"Dez","value":406}];
const MX = 575;
