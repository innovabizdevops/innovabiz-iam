...
const PAGE = "Team Spaces";
const KPIS = [{"l":"Teams Ativos","v":"5.994","t":"+2.1%","d":"up"},{"l":"Reuniões/Semana","v":"4017","t":"+12.4%","d":"up"},{"l":"Mensagens/Dia","v":"344","t":"+7.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.771","t":"-4.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","953","290","316","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.417","1184","7.574","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","589","862","3.244","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.389","2703","8.878","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.003","2726","6.220","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":423},{"label":"Mar","value":717},{"label":"Abr","value":645},{"label":"Mai","value":471},{"label":"Jun","value":610},{"label":"Jul","value":689},{"label":"Ago","value":623},{"label":"Set","value":682},{"label":"Out","value":538},{"label":"Nov","value":657},{"label":"Dez","value":783}];
const MX = 783;
