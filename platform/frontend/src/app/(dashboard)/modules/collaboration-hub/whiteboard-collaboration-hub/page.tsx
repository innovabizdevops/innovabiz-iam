...
const PAGE = "Whiteboard";
const KPIS = [{"l":"Teams Ativos","v":"827","t":"-5.6%","d":"down"},{"l":"Reuniões/Semana","v":"3892","t":"+10.6%","d":"up"},{"l":"Mensagens/Dia","v":"1142","t":"+14.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.615","t":"+6.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.884","1022","5.674","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.269","2879","1.559","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.986","3753","440","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.871","1299","2.358","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.812","2956","2.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":679},{"label":"Mar","value":698},{"label":"Abr","value":805},{"label":"Mai","value":704},{"label":"Jun","value":667},{"label":"Jul","value":624},{"label":"Ago","value":875},{"label":"Set","value":664},{"label":"Out","value":584},{"label":"Nov","value":556},{"label":"Dez","value":554}];
const MX = 875;
...
export default function WhiteboardCollaborationHubPage() {
    return (
