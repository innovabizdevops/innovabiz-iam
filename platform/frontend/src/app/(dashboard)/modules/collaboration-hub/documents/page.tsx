...
const PAGE = "Document Collab";
const KPIS = [{"l":"Formulários Ativos","v":"2.387","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"3384","t":"-4.4%","d":"down"},{"l":"Documentos Gerados","v":"8.792","t":"-2.3%","d":"down"},{"l":"Templates","v":"5.629","t":"-4.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.140","2026-03-03","2.191","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.712","2026-03-07","7.774","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","108","2026-02-06","4.585","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.126","2026-03-26","3.699","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.286","2026-01-04","8.176","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":476},{"label":"Mar","value":373},{"label":"Abr","value":449},{"label":"Mai","value":685},{"label":"Jun","value":528},{"label":"Jul","value":622},{"label":"Ago","value":357},{"label":"Set","value":520},{"label":"Out","value":419},{"label":"Nov","value":393},{"label":"Dez","value":753}];
const MX = 753;
