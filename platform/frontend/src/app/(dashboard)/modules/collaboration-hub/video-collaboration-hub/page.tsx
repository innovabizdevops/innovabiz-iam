...
const PAGE = "Video Conference";
const KPIS = [{"l":"Teams Ativos","v":"8.277","t":"-0.6%","d":"down"},{"l":"Reuniões/Semana","v":"4095","t":"+11.5%","d":"up"},{"l":"Mensagens/Dia","v":"4369","t":"+2.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.753","t":"+2.0%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.235","2368","3.544","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.714","1224","3.509","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.238","2100","6.421","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.089","4206","3.132","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.516","2370","4.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":651},{"label":"Mar","value":487},{"label":"Abr","value":338},{"label":"Mai","value":663},{"label":"Jun","value":403},{"label":"Jul","value":508},{"label":"Ago","value":574},{"label":"Set","value":380},{"label":"Out","value":292},{"label":"Nov","value":299},{"label":"Dez","value":313}];
const MX = 663;
...
export default function VideoCollaborationHubPage() {
    return (
