...
const PAGE = "Chat &amp; Messaging";
const KPIS = [{"l":"Notificações Enviadas","v":"7.041","t":"+12.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"80.8%","t":"+3.6%","d":"up"},{"l":"Taxa Abertura (%)","v":"65.6%","t":"+17.8%","d":"up"},{"l":"Escalações","v":"4.460","t":"+2.1%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.312","90.4%","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.512","79.1%","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.698","84.6%","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.488","81.6%","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.504","71.6%","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":382},{"label":"Mar","value":508},{"label":"Abr","value":743},{"label":"Mai","value":670},{"label":"Jun","value":707},{"label":"Jul","value":504},{"label":"Ago","value":729},{"label":"Set","value":443},{"label":"Out","value":745},{"label":"Nov","value":381},{"label":"Dez","value":522}];
const MX = 745;
