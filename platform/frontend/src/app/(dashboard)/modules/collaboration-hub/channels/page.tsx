...
const PAGE = "Channels &amp; Threads";
const KPIS = [{"l":"Teams Ativos","v":"2.761","t":"+15.0%","d":"up"},{"l":"Reuniões/Semana","v":"3188","t":"+11.3%","d":"up"},{"l":"Mensagens/Dia","v":"1673","t":"+8.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.532","t":"-1.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.828","3123","240","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.689","1020","8.335","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.857","2667","1.954","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.039","4264","4.970","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.448","740","5.406","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":841},{"label":"Mar","value":648},{"label":"Abr","value":936},{"label":"Mai","value":792},{"label":"Jun","value":817},{"label":"Jul","value":942},{"label":"Ago","value":914},{"label":"Set","value":666},{"label":"Out","value":894},{"label":"Nov","value":890},{"label":"Dez","value":715}];
const MX = 942;
