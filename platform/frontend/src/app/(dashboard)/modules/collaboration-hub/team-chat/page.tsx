...
const PAGE = "Team Chat";
const KPIS = [{"l":"Teams Ativos","v":"6.480","t":"-0.9%","d":"down"},{"l":"Reuniões/Semana","v":"599","t":"-1.5%","d":"down"},{"l":"Mensagens/Dia","v":"2742","t":"+10.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.356","t":"-1.2%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","941","133","6.779","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.970","3543","1.613","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.903","2729","968","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.053","4800","3.577","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.887","1875","378","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":453},{"label":"Mar","value":328},{"label":"Abr","value":340},{"label":"Mai","value":554},{"label":"Jun","value":291},{"label":"Jul","value":511},{"label":"Ago","value":607},{"label":"Set","value":530},{"label":"Out","value":503},{"label":"Nov","value":497},{"label":"Dez","value":390}];
const MX = 607;
