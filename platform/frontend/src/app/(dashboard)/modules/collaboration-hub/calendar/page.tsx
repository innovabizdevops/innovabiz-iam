...
const PAGE = "Calendar Hub";
const KPIS = [{"l":"Teams Ativos","v":"5.019","t":"-0.9%","d":"down"},{"l":"Reuniões/Semana","v":"1292","t":"+10.4%","d":"up"},{"l":"Mensagens/Dia","v":"4146","t":"+3.3%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.491","t":"+13.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.257","619","714","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","200","4654","8.857","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.943","3413","8.756","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.776","3353","4.112","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.885","1386","3.871","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":541},{"label":"Mar","value":545},{"label":"Abr","value":779},{"label":"Mai","value":528},{"label":"Jun","value":754},{"label":"Jul","value":763},{"label":"Ago","value":758},{"label":"Set","value":671},{"label":"Out","value":541},{"label":"Nov","value":623},{"label":"Dez","value":654}];
const MX = 779;
