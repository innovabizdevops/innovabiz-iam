...
const PAGE = "AI Meeting Summary";
const KPIS = [{"l":"Teams Ativos","v":"256","t":"+6.6%","d":"up"},{"l":"Reuniões/Semana","v":"864","t":"-2.1%","d":"down"},{"l":"Mensagens/Dia","v":"3887","t":"-0.8%","d":"down"},{"l":"Ficheiros Partilhados","v":"9.029","t":"-3.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.362","4895","1.844","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.212","1968","6.655","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.548","550","4.368","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.703","2240","5.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.331","3556","1.746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":800},{"label":"Mar","value":438},{"label":"Abr","value":693},{"label":"Mai","value":548},{"label":"Jun","value":754},{"label":"Jul","value":531},{"label":"Ago","value":551},{"label":"Set","value":799},{"label":"Out","value":470},{"label":"Nov","value":522},{"label":"Dez","value":567}];
const MX = 800;
