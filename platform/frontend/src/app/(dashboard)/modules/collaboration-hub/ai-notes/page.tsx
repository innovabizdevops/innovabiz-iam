...
const PAGE = "AI Meeting Notes";
const KPIS = [{"l":"Teams Ativos","v":"5.407","t":"+16.2%","d":"up"},{"l":"Reuniões/Semana","v":"3619","t":"+6.4%","d":"up"},{"l":"Mensagens/Dia","v":"3742","t":"+1.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.888","t":"-3.2%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.397","596","2.915","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.401","3419","3.738","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.617","2641","2.817","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","395","397","8.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.851","4022","1.399","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":542},{"label":"Mar","value":667},{"label":"Abr","value":486},{"label":"Mai","value":855},{"label":"Jun","value":817},{"label":"Jul","value":477},{"label":"Ago","value":839},{"label":"Set","value":784},{"label":"Out","value":543},{"label":"Nov","value":842},{"label":"Dez","value":739}];
const MX = 855;
