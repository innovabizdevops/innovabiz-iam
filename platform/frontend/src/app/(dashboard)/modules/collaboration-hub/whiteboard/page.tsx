...
const PAGE = "Whiteboard Collab";
const KPIS = [{"l":"Teams Ativos","v":"755","t":"-5.2%","d":"down"},{"l":"Reuniões/Semana","v":"1244","t":"+12.0%","d":"up"},{"l":"Mensagens/Dia","v":"3457","t":"+11.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.337","t":"-5.7%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","504","1514","6.102","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.633","2212","1.667","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.185","2979","4.494","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.900","4143","5.438","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.013","3869","5.022","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":578},{"label":"Mar","value":453},{"label":"Abr","value":682},{"label":"Mai","value":610},{"label":"Jun","value":614},{"label":"Jul","value":467},{"label":"Ago","value":578},{"label":"Set","value":753},{"label":"Out","value":598},{"label":"Nov","value":577},{"label":"Dez","value":629}];
const MX = 753;
