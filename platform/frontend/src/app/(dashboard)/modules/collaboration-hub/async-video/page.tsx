...
const PAGE = "Async Video";
const KPIS = [{"l":"Integrações Ativas","v":"7.486","t":"+3.6%","d":"up"},{"l":"Chamadas/Hora","v":"3923","t":"+4.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.0%","t":"+4.7%","d":"up"},{"l":"Latência Média (ms)","v":"188ms","t":"-5.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.018","7.062","82.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.640","4.410","71.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.441","8.360","85.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.518","2.196","90.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.102","7.932","78.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":771},{"label":"Mar","value":799},{"label":"Abr","value":485},{"label":"Mai","value":660},{"label":"Jun","value":532},{"label":"Jul","value":461},{"label":"Ago","value":627},{"label":"Set","value":496},{"label":"Out","value":749},{"label":"Nov","value":581},{"label":"Dez","value":463}];
const MX = 827;
...
export default function AsyncVideoPage() {
    return (
