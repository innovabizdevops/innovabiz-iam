...
const ACCENT = "#7c3aed";
const MODULE = "Collaboration Hub";
const PAGE = "Video Conferencing";
const KPIS = [{"l":"Teams Ativos","v":"8.956","t":"+10.4%","d":"up"},{"l":"Reuniões/Semana","v":"759","t":"+2.2%","d":"up"},{"l":"Mensagens/Dia","v":"4269","t":"-2.9%","d":"down"},{"l":"Ficheiros Partilhados","v":"5.957","t":"+4.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.831","2166","1.355","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.791","2643","7.902","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.659","4671","6.431","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.358","749","4.468","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.648","2215","1.096","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":491},{"label":"Mar","value":504},{"label":"Abr","value":556},{"label":"Mai","value":298},{"label":"Jun","value":508},{"label":"Jul","value":669},{"label":"Ago","value":619},{"label":"Set","value":566},{"label":"Out","value":536},{"label":"Nov","value":606},{"label":"Dez","value":640}];
const MX = 669;
...
export default function VideoCollabPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>New</span></h1>
                </div>
