...
/* ═══ EVO Adaptive Learning — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8868", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1221", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€419K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "578317268", cells: ["EVO-5268", "EVO Adaptive Learning Item 1", "5/9/2026", "€17 368"], status: "active" as const },
    { id: "578320839", cells: ["EVO-8839", "EVO Adaptive Learning Item 2", "20/4/2026", "€20 939"], status: "pending" as const },
    { id: "578324410", cells: ["EVO-3410", "EVO Adaptive Learning Item 3", "7/11/2026", "€24 510"], status: "completed" as const },
    { id: "578327981", cells: ["EVO-6981", "EVO Adaptive Learning Item 4", "22/6/2026", "€28 081"], status: "warning" as const },
    { id: "578331552", cells: ["EVO-1552", "EVO Adaptive Learning Item 5", "9/1/2026", "€31 652"], status: "active" as const },
];
...
export default function EvoAdaptiveLearningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EVO Adaptive Learning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EVO Adaptive Learning</p>
                    </div>
                </div>
