...
const PAGE = "Register";
const KPIS = [{"l":"Total India Gst","v":"5.766","t":"+7.9%","d":"up"},{"l":"Register Ativos","v":"1.441","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"91","t":"-5.9%","d":"down"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["India Gst #001","India Gst #002","7.933","5.631","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["India Gst #002","India Gst #003","3.112","207","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["India Gst #003","India Gst #004","473","6.062","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["India Gst #004","India Gst #005","1.394","5.043","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["India Gst #005","India Gst #001","3.833","8.681","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":1014},{"label":"Mar","value":632},{"label":"Abr","value":1003},{"label":"Mai","value":626},{"label":"Jun","value":991},{"label":"Jul","value":701},{"label":"Ago","value":684},{"label":"Set","value":824},{"label":"Out","value":861},{"label":"Nov","value":1016},{"label":"Dez","value":679}];
const MX = 1016;
