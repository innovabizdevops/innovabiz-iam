...
/* ═══ India GST Compliance — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "8055", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "241", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€483K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1511292455", cells: ["IND-4455", "India GST Compliance Item 1", "16/12/2026", "€42 555"], status: "active" as const },
    { id: "1511296026", cells: ["IND-8026", "India GST Compliance Item 2", "3/7/2026", "€46 126"], status: "pending" as const },
    { id: "1511299597", cells: ["IND-2597", "India GST Compliance Item 3", "18/2/2026", "€49 697"], status: "completed" as const },
    { id: "1511303168", cells: ["IND-6168", "India GST Compliance Item 4", "5/9/2026", "€3268"], status: "warning" as const },
    { id: "1511306739", cells: ["IND-9739", "India GST Compliance Item 5", "20/4/2026", "€6839"], status: "active" as const },
];
...
export default function IndiaGstCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">India GST Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • India GST Compliance</p>
                    </div>
                </div>
