...
const PAGE = "Return";
const KPIS = [{"l":"Total India Gst","v":"4.744","t":"+18.0%","d":"up"},{"l":"Return Ativos","v":"788","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"66.5%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"70","t":"-2.8%","d":"down"}];
const COLS = ["ID","Return","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["India Gst #001","India Gst #002","8.795","5.496","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["India Gst #002","India Gst #003","2.915","8.660","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["India Gst #003","India Gst #004","4.221","6.333","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["India Gst #004","India Gst #005","5.794","1.073","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["India Gst #005","India Gst #001","5.289","3.529","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":756},{"label":"Mar","value":741},{"label":"Abr","value":828},{"label":"Mai","value":772},{"label":"Jun","value":672},{"label":"Jul","value":690},{"label":"Ago","value":525},{"label":"Set","value":482},{"label":"Out","value":493},{"label":"Nov","value":590},{"label":"Dez","value":831}];
const MX = 831;
