...
const ACCENT = "#14532d";
const MODULE = "India GST Compliance";
const PAGE = "Reconcile";
const KPIS = [{"l":"Total India Gst","v":"5.545","t":"+12.7%","d":"up"},{"l":"Reconcile Ativos","v":"7.528","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"81.2%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"57","t":"+2.3%","d":"up"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["India Gst #001","India Gst #002","4.496","8.825","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["India Gst #002","India Gst #003","2.516","1.924","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["India Gst #003","India Gst #004","7.633","5.771","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["India Gst #004","India Gst #005","2.687","7.072","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["India Gst #005","India Gst #001","7.666","8.774","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":768},{"label":"Mar","value":906},{"label":"Abr","value":766},{"label":"Mai","value":765},{"label":"Jun","value":832},{"label":"Jul","value":887},{"label":"Ago","value":847},{"label":"Set","value":693},{"label":"Out","value":819},{"label":"Nov","value":898},{"label":"Dez","value":651}];
const MX = 906;
