...
const PAGE = "Settle";
const KPIS = [{"l":"Formulários Ativos","v":"559","t":"-0.6%","d":"down"},{"l":"Submissões/Dia","v":"1506","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"3.149","t":"-5.8%","d":"down"},{"l":"Templates","v":"8.690","t":"+4.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.269","2026-03-14","6.107","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.451","2026-01-07","7.513","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","464","2026-01-02","1.763","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.760","2026-01-05","412","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.288","2026-01-23","8.606","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":398},{"label":"Mar","value":430},{"label":"Abr","value":575},{"label":"Mai","value":432},{"label":"Jun","value":538},{"label":"Jul","value":565},{"label":"Ago","value":537},{"label":"Set","value":382},{"label":"Out","value":337},{"label":"Nov","value":205},{"label":"Dez","value":519}];
const MX = 575;
