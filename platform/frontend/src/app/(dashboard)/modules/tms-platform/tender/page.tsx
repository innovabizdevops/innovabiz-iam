...
const PAGE = "Tender";
const KPIS = [{"l":"Formulários Ativos","v":"1.163","t":"+2.0%","d":"up"},{"l":"Submissões/Dia","v":"942","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"3.309","t":"+13.2%","d":"up"},{"l":"Templates","v":"129","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","460","2026-03-28","1.169","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","783","2026-02-13","8.645","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.624","2026-01-05","5.068","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.291","2026-01-07","5.010","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.790","2026-02-21","2.822","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":741},{"label":"Mar","value":388},{"label":"Abr","value":753},{"label":"Mai","value":764},{"label":"Jun","value":417},{"label":"Jul","value":473},{"label":"Ago","value":746},{"label":"Set","value":745},{"label":"Out","value":706},{"label":"Nov","value":758},{"label":"Dez","value":618}];
const MX = 764;
