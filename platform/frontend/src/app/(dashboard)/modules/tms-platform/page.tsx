...
/* ═══ TMS Platform Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "7417", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1862", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€323K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "589116717", cells: ["TMS-4717", "TMS Platform Deep Item 1", "22/10/2026", "€16 817"], status: "active" as const },
    { id: "589120288", cells: ["TMS-8288", "TMS Platform Deep Item 2", "9/5/2026", "€20 388"], status: "pending" as const },
    { id: "589123859", cells: ["TMS-2859", "TMS Platform Deep Item 3", "24/12/2026", "€23 959"], status: "completed" as const },
    { id: "589127430", cells: ["TMS-6430", "TMS Platform Deep Item 4", "11/7/2026", "€27 530"], status: "warning" as const },
    { id: "589131001", cells: ["TMS-1001", "TMS Platform Deep Item 5", "26/2/2026", "€31 101"], status: "active" as const },
];
...
export default function TmsPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">TMS Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • TMS Platform Deep</p>
                    </div>
                </div>
