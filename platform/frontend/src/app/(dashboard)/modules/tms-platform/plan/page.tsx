...
const PAGE = "Plan";
const KPIS = [{"l":"Formulários Ativos","v":"778","t":"+10.5%","d":"up"},{"l":"Submissões/Dia","v":"4595","t":"-5.1%","d":"down"},{"l":"Documentos Gerados","v":"7.842","t":"-2.8%","d":"down"},{"l":"Templates","v":"1.020","t":"+17.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.294","2026-02-11","4.885","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.165","2026-02-19","1.804","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.601","2026-01-17","4.470","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.506","2026-03-19","8.476","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.188","2026-01-06","4.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":496},{"label":"Mar","value":359},{"label":"Abr","value":492},{"label":"Mai","value":668},{"label":"Jun","value":384},{"label":"Jul","value":526},{"label":"Ago","value":371},{"label":"Set","value":670},{"label":"Out","value":316},{"label":"Nov","value":645},{"label":"Dez","value":687}];
const MX = 687;
