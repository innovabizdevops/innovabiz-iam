...
const PAGE = "Execute";
const KPIS = [{"l":"Formulários Ativos","v":"8.424","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"2024","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"7.651","t":"+8.0%","d":"up"},{"l":"Templates","v":"661","t":"+9.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.145","2026-01-11","3.412","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.828","2026-02-07","4.379","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.420","2026-02-23","1.570","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.498","2026-01-07","6.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.245","2026-02-21","4.819","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":983},{"label":"Mar","value":650},{"label":"Abr","value":608},{"label":"Mai","value":661},{"label":"Jun","value":791},{"label":"Jul","value":898},{"label":"Ago","value":971},{"label":"Set","value":698},{"label":"Out","value":693},{"label":"Nov","value":879},{"label":"Dez","value":666}];
const MX = 983;
