...
const ACCENT = "#1e3a5f";
const MODULE = "TMS Platform Deep";
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"5.604","t":"+15.2%","d":"up"},{"l":"Submissões/Dia","v":"3778","t":"+0.0%","d":"up"},{"l":"Documentos Gerados","v":"1.038","t":"-0.7%","d":"down"},{"l":"Templates","v":"8.903","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.648","2026-01-24","3.255","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.816","2026-01-18","5.395","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.845","2026-01-11","712","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.102","2026-01-13","5.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.939","2026-02-03","3.242","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":679},{"label":"Mar","value":541},{"label":"Abr","value":503},{"label":"Mai","value":768},{"label":"Jun","value":695},{"label":"Jul","value":746},{"label":"Ago","value":844},{"label":"Set","value":781},{"label":"Out","value":600},{"label":"Nov","value":558},{"label":"Dez","value":708}];
const MX = 844;
