...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"2.679","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"1572","t":"+15.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.854","t":"+9.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.385","t":"+4.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1487","2026-02-14","7.398","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","813","2026-02-15","8.876","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3288","2026-03-04","2.938","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3662","2026-01-24","2.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1010","2026-03-03","4.440","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":643},{"label":"Mar","value":644},{"label":"Abr","value":513},{"label":"Mai","value":464},{"label":"Jun","value":628},{"label":"Jul","value":342},{"label":"Ago","value":460},{"label":"Set","value":638},{"label":"Out","value":423},{"label":"Nov","value":372},{"label":"Dez","value":413}];
const MX = 644;
