...
const PAGE = "Donor";
const KPIS = [{"l":"Dashboards Ativos","v":"3.602","t":"-5.5%","d":"down"},{"l":"Queries/Dia","v":"4238","t":"+17.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.072","t":"+12.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.859","t":"+15.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","100","2026-02-24","3.414","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4018","2026-03-22","7.566","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","336","2026-02-25","3.052","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3967","2026-01-19","6.109","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2326","2026-03-22","4.975","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":626},{"label":"Mar","value":682},{"label":"Abr","value":425},{"label":"Mai","value":382},{"label":"Jun","value":728},{"label":"Jul","value":422},{"label":"Ago","value":764},{"label":"Set","value":659},{"label":"Out","value":525},{"label":"Nov","value":644},{"label":"Dez","value":444}];
const MX = 764;
