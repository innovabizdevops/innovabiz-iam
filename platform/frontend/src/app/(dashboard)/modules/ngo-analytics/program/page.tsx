...
const PAGE = "Program";
const KPIS = [{"l":"Dashboards Ativos","v":"6.739","t":"+6.7%","d":"up"},{"l":"Queries/Dia","v":"2208","t":"+17.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.364","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"3.123","t":"-2.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1510","2026-01-17","1.298","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2126","2026-03-27","8.920","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1899","2026-03-19","2.634","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3026","2026-01-13","221","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","477","2026-02-23","9.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":440},{"label":"Mar","value":666},{"label":"Abr","value":411},{"label":"Mai","value":578},{"label":"Jun","value":576},{"label":"Jul","value":671},{"label":"Ago","value":544},{"label":"Set","value":459},{"label":"Out","value":687},{"label":"Nov","value":408},{"label":"Dez","value":335}];
const MX = 687;
