...
const ACCENT = "#6366f1";
const MODULE = "NGO Analytics";
const PAGE = "Impact";
const KPIS = [{"l":"Dashboards Ativos","v":"5.102","t":"-3.6%","d":"down"},{"l":"Queries/Dia","v":"1375","t":"+14.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.017","t":"+12.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.962","t":"+8.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4896","2026-03-28","2.664","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3439","2026-02-27","1.435","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","260","2026-01-09","2.892","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4740","2026-01-04","8.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1284","2026-03-04","5.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":851},{"label":"Mar","value":791},{"label":"Abr","value":790},{"label":"Mai","value":709},{"label":"Jun","value":727},{"label":"Jul","value":702},{"label":"Ago","value":578},{"label":"Set","value":708},{"label":"Out","value":907},{"label":"Nov","value":657},{"label":"Dez","value":653}];
const MX = 907;
