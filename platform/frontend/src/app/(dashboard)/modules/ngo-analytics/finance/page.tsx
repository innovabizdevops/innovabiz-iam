...
const PAGE = "Finance";
const KPIS = [{"l":"Dashboards Ativos","v":"7.920","t":"-2.1%","d":"down"},{"l":"Queries/Dia","v":"1585","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.699","t":"-6.0%","d":"down"},{"l":"Utilizadores Analytics","v":"6.492","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","578","2026-03-08","4.858","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2033","2026-03-23","8.484","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","842","2026-02-18","5.487","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2447","2026-02-12","6.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","455","2026-03-23","3.512","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":422},{"label":"Mar","value":422},{"label":"Abr","value":744},{"label":"Mai","value":504},{"label":"Jun","value":690},{"label":"Jul","value":724},{"label":"Ago","value":755},{"label":"Set","value":398},{"label":"Out","value":554},{"label":"Nov","value":644},{"label":"Dez","value":689}];
const MX = 755;
