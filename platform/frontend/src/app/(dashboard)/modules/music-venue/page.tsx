...
/* ═══ Music Venue — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "794", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1802", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€267K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2045944594", cells: ["MUS-2594", "Music Venue Item 1", "23/11/2026", "€44 694"], status: "active" as const },
    { id: "2045948165", cells: ["MUS-6165", "Music Venue Item 2", "10/6/2026", "€48 265"], status: "pending" as const },
    { id: "2045951736", cells: ["MUS-9736", "Music Venue Item 3", "25/1/2026", "€1836"], status: "completed" as const },
    { id: "2045955307", cells: ["MUS-4307", "Music Venue Item 4", "12/8/2026", "€5407"], status: "warning" as const },
    { id: "2045958878", cells: ["MUS-7878", "Music Venue Item 5", "27/3/2026", "€8978"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Music Venue</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Music Venue</p>
                    </div>
                </div>
