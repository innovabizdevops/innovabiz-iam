...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"4.381","t":"+2.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.3%","t":"+11.7%","d":"up"},{"l":"MTTR (h)","v":"165h","t":"+13.6%","d":"up"},{"l":"Satisfação (%)","v":"93.0%","t":"+0.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.173","3.305","6.274","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.038","6.256","5.093","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.453","2.867","2.719","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.851","6.845","806","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.664","7.091","6.133","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":427},{"label":"Mar","value":524},{"label":"Abr","value":551},{"label":"Mai","value":413},{"label":"Jun","value":634},{"label":"Jul","value":675},{"label":"Ago","value":431},{"label":"Set","value":490},{"label":"Out","value":609},{"label":"Nov","value":513},{"label":"Dez","value":578}];
const MX = 675;
