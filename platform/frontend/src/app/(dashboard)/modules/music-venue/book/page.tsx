...
const ACCENT = "#5b21b6";
const MODULE = "Music Venue";
const PAGE = "Book";
const KPIS = [{"l":"Total Music Venue","v":"5.726","t":"+15.9%","d":"up"},{"l":"Book Ativos","v":"3.466","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"58","t":"-3.6%","d":"down"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Music Venue #001","Music Venue #002","7.048","1.823","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Music Venue #002","Music Venue #003","3.559","8.560","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Music Venue #003","Music Venue #004","4.389","6.037","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Music Venue #004","Music Venue #005","7.800","4.386","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Music Venue #005","Music Venue #001","3.243","8.510","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":334},{"label":"Mar","value":343},{"label":"Abr","value":533},{"label":"Mai","value":669},{"label":"Jun","value":674},{"label":"Jul","value":620},{"label":"Ago","value":498},{"label":"Set","value":372},{"label":"Out","value":365},{"label":"Nov","value":301},{"label":"Dez","value":424}];
const MX = 674;
