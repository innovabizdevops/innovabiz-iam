...
const PAGE = "Sound";
const KPIS = [{"l":"Total Music Venue","v":"4.231","t":"-0.6%","d":"down"},{"l":"Sound Ativos","v":"6.702","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"79.3%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.7%","d":"up"}];
const COLS = ["ID","Sound","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Music Venue #001","Music Venue #002","8.880","527","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Music Venue #002","Music Venue #003","7.562","1.979","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Music Venue #003","Music Venue #004","6.140","2.945","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Music Venue #004","Music Venue #005","5.929","1.728","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Music Venue #005","Music Venue #001","8.162","4.278","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":759},{"label":"Mar","value":1037},{"label":"Abr","value":736},{"label":"Mai","value":957},{"label":"Jun","value":742},{"label":"Jul","value":802},{"label":"Ago","value":872},{"label":"Set","value":1050},{"label":"Out","value":833},{"label":"Nov","value":866},{"label":"Dez","value":991}];
const MX = 1050;
