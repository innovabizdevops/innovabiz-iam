...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€37.8M","t":"+8.4%","d":"up"},{"l":"MRR (€)","v":"€1354","t":"+3.2%","d":"up"},{"l":"Churn (%)","v":"75.8%","t":"-1.8%","d":"down"},{"l":"ARPU (€)","v":"€19002","t":"+12.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 15283.38","4.943","€ 15000.51","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 34786.25","6.686","€ 41680.98","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12823.53","8.467","€ 1804.96","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 44439.11","917","€ 4996.84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23451.89","3.484","€ 12335.58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":675},{"label":"Mar","value":500},{"label":"Abr","value":428},{"label":"Mai","value":371},{"label":"Jun","value":535},{"label":"Jul","value":406},{"label":"Ago","value":407},{"label":"Set","value":597},{"label":"Out","value":461},{"label":"Nov","value":496},{"label":"Dez","value":435}];
const MX = 675;
