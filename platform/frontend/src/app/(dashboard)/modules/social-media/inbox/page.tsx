...
const PAGE = "Engagement Inbox";
const KPIS = [{"l":"eNPS","v":"81","t":"-5.1%","d":"down"},{"l":"Engagement (%)","v":"89.0%","t":"+4.4%","d":"up"},{"l":"Turnover (%)","v":"76.1%","t":"+12.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.629","t":"+8.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.149","2026-01-08","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.579","2026-03-13","89","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.807","2026-03-16","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.814","2026-02-18","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","442","2026-03-07","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":980},{"label":"Mar","value":856},{"label":"Abr","value":767},{"label":"Mai","value":673},{"label":"Jun","value":771},{"label":"Jul","value":818},{"label":"Ago","value":889},{"label":"Set","value":998},{"label":"Out","value":745},{"label":"Nov","value":986},{"label":"Dez","value":901}];
const MX = 998;
