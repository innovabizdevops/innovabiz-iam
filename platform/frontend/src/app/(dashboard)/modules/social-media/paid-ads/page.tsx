...
const PAGE = "Paid Ads Manager";
const KPIS = [{"l":"Integrações Ativas","v":"1.328","t":"-3.6%","d":"down"},{"l":"Chamadas/Hora","v":"4220","t":"-2.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"82.4%","t":"+11.9%","d":"up"},{"l":"Latência Média (ms)","v":"42ms","t":"+4.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.268","1.213","84.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.220","1.512","79.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","652","8.508","94.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.644","8.398","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.898","5.006","81.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":760},{"label":"Mar","value":828},{"label":"Abr","value":665},{"label":"Mai","value":696},{"label":"Jun","value":693},{"label":"Jul","value":986},{"label":"Ago","value":624},{"label":"Set","value":932},{"label":"Out","value":689},{"label":"Nov","value":837},{"label":"Dez","value":930}];
const MX = 986;
