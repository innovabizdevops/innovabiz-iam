...
const PAGE = "Social Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.247","t":"+0.9%","d":"up"},{"l":"Queries/Dia","v":"3097","t":"+9.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.139","t":"+12.4%","d":"up"},{"l":"Utilizadores Analytics","v":"5.164","t":"+3.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4926","2026-02-13","2.449","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2886","2026-02-05","7.236","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4395","2026-03-24","3.083","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2565","2026-03-12","7.230","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4147","2026-01-05","4.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":621},{"label":"Mar","value":652},{"label":"Abr","value":852},{"label":"Mai","value":724},{"label":"Jun","value":768},{"label":"Jul","value":864},{"label":"Ago","value":752},{"label":"Set","value":650},{"label":"Out","value":864},{"label":"Nov","value":668},{"label":"Dez","value":670}];
const MX = 864;
