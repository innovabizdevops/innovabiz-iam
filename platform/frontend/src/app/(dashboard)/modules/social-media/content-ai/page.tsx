...
const PAGE = "Content Creator AI";
const KPIS = [{"l":"Integrações Ativas","v":"637","t":"+7.7%","d":"up"},{"l":"Chamadas/Hora","v":"3611","t":"+1.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.3%","t":"+1.1%","d":"up"},{"l":"Latência Média (ms)","v":"108ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.974","8.543","95.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.030","437","82.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.152","8.522","91.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.309","4.458","85.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.792","6.063","77.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":862},{"label":"Mar","value":785},{"label":"Abr","value":771},{"label":"Mai","value":608},{"label":"Jun","value":615},{"label":"Jul","value":870},{"label":"Ago","value":742},{"label":"Set","value":707},{"label":"Out","value":905},{"label":"Nov","value":692},{"label":"Dez","value":567}];
const MX = 905;
