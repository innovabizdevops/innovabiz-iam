...
const PAGE = "Brand Monitoring";
const KPIS = [{"l":"Integrações Ativas","v":"3.546","t":"+0.9%","d":"up"},{"l":"Chamadas/Hora","v":"4004","t":"+8.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.4%","t":"+1.6%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"+7.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","172","7.905","96.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","953","1.447","78.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.531","441","99.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.005","7.007","88.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.418","6.284","70.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":692},{"label":"Mar","value":490},{"label":"Abr","value":590},{"label":"Mai","value":631},{"label":"Jun","value":659},{"label":"Jul","value":711},{"label":"Ago","value":736},{"label":"Set","value":680},{"label":"Out","value":723},{"label":"Nov","value":581},{"label":"Dez","value":547}];
const MX = 736;
