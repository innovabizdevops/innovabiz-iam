...
const PAGE = "Crisis Management";
const KPIS = [{"l":"Integrações Ativas","v":"4.120","t":"-3.9%","d":"down"},{"l":"Chamadas/Hora","v":"2561","t":"+10.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.3%","t":"-2.5%","d":"down"},{"l":"Latência Média (ms)","v":"121ms","t":"-1.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.145","6.216","94.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.844","8.147","77.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.370","4.000","85.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.869","3.239","76.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.917","2.713","87.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":681},{"label":"Mar","value":688},{"label":"Abr","value":1012},{"label":"Mai","value":731},{"label":"Jun","value":886},{"label":"Jul","value":818},{"label":"Ago","value":806},{"label":"Set","value":830},{"label":"Out","value":690},{"label":"Nov","value":844},{"label":"Dez","value":968}];
const MX = 1012;
