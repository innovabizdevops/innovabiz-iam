...
const PAGE = "Hashtag Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.979","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"3043","t":"+8.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.684","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"629","t":"+11.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4168","2026-03-26","1.417","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3108","2026-02-06","2.340","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1841","2026-02-13","6.416","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2405","2026-03-10","8.939","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4610","2026-02-04","8.397","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":696},{"label":"Mar","value":401},{"label":"Abr","value":488},{"label":"Mai","value":602},{"label":"Jun","value":552},{"label":"Jul","value":574},{"label":"Ago","value":705},{"label":"Set","value":716},{"label":"Out","value":472},{"label":"Nov","value":594},{"label":"Dez","value":712}];
const MX = 716;
