...
const PAGE = "UGC Moderation AI";
const KPIS = [{"l":"Integrações Ativas","v":"2.938","t":"-4.4%","d":"down"},{"l":"Chamadas/Hora","v":"320","t":"+4.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.3%","t":"+0.5%","d":"up"},{"l":"Latência Média (ms)","v":"25ms","t":"-6.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.317","1.671","77.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.359","1.693","90.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.542","331","87.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.483","3.105","74.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.746","7.873","97.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":457},{"label":"Mar","value":757},{"label":"Abr","value":439},{"label":"Mai","value":717},{"label":"Jun","value":653},{"label":"Jul","value":607},{"label":"Ago","value":515},{"label":"Set","value":484},{"label":"Out","value":753},{"label":"Nov","value":618},{"label":"Dez","value":691}];
const MX = 757;
