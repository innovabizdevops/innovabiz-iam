...
const PAGE = "Competitor Tracking";
const KPIS = [{"l":"Integrações Ativas","v":"1.247","t":"+16.4%","d":"up"},{"l":"Chamadas/Hora","v":"445","t":"+17.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.4%","t":"-2.5%","d":"down"},{"l":"Latência Média (ms)","v":"9ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.798","3.327","94.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","9.070","7.632","99.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.404","1.497","80.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.258","6.923","72.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.776","685","85.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":684},{"label":"Mar","value":654},{"label":"Abr","value":547},{"label":"Mai","value":772},{"label":"Jun","value":726},{"label":"Jul","value":714},{"label":"Ago","value":797},{"label":"Set","value":548},{"label":"Out","value":793},{"label":"Nov","value":729},{"label":"Dez","value":533}];
const MX = 797;
