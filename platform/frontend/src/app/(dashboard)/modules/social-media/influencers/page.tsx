...
const PAGE = "Influencer Tracker";
const KPIS = [{"l":"Integrações Ativas","v":"5.309","t":"+16.0%","d":"up"},{"l":"Chamadas/Hora","v":"1176","t":"-5.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.8%","t":"-1.6%","d":"down"},{"l":"Latência Média (ms)","v":"171ms","t":"+16.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.029","158","80.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.081","3.364","100.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.475","2.896","79.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.396","813","76.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.452","1.655","89.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":965},{"label":"Mar","value":770},{"label":"Abr","value":864},{"label":"Mai","value":675},{"label":"Jun","value":718},{"label":"Jul","value":768},{"label":"Ago","value":803},{"label":"Set","value":833},{"label":"Out","value":649},{"label":"Nov","value":687},{"label":"Dez","value":734}];
const MX = 965;
