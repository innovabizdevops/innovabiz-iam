...
const PAGE = "Publishing Calendar";
const KPIS = [{"l":"Integrações Ativas","v":"7.408","t":"+3.9%","d":"up"},{"l":"Chamadas/Hora","v":"1017","t":"+3.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.7%","t":"-0.5%","d":"down"},{"l":"Latência Média (ms)","v":"90ms","t":"+4.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.500","1.587","83.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.220","7.829","86.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","726","4.102","93.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.786","304","74.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.614","2.685","76.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":1043},{"label":"Mar","value":715},{"label":"Abr","value":969},{"label":"Mai","value":937},{"label":"Jun","value":727},{"label":"Jul","value":961},{"label":"Ago","value":782},{"label":"Set","value":683},{"label":"Out","value":800},{"label":"Nov","value":691},{"label":"Dez","value":698}];
const MX = 1043;
