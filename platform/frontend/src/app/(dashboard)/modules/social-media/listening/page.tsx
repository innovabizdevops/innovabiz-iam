...
const ACCENT = "#e11d48";
const MODULE = "Social Media Management";
const PAGE = "Social Listening AI";
const KPIS = [{"l":"Integrações Ativas","v":"1.945","t":"-1.3%","d":"down"},{"l":"Chamadas/Hora","v":"2092","t":"-0.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"81.3%","t":"-0.1%","d":"down"},{"l":"Latência Média (ms)","v":"98ms","t":"-4.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.051","1.168","94.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.659","5.609","87.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.726","262","78.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.460","6.843","80.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.275","203","82.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":766},{"label":"Mar","value":716},{"label":"Abr","value":637},{"label":"Mai","value":865},{"label":"Jun","value":741},{"label":"Jul","value":869},{"label":"Ago","value":948},{"label":"Set","value":996},{"label":"Out","value":751},{"label":"Nov","value":854},{"label":"Dez","value":929}];
const MX = 996;
