...
const PAGE = "API Keys";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.805","t":"+4.3%","d":"up"},{"l":"Sessões/Dia","v":"3112","t":"-5.4%","d":"down"},{"l":"MFA Adoção (%)","v":"67.1%","t":"+10.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.730","t":"+5.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.100","3.652","8.846","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.702","4.008","8.937","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.326","6.092","1.046","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.115","7.000","5.390","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.575","6.069","7.421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":437},{"label":"Mar","value":680},{"label":"Abr","value":504},{"label":"Mai","value":581},{"label":"Jun","value":603},{"label":"Jul","value":630},{"label":"Ago","value":338},{"label":"Set","value":453},{"label":"Out","value":563},{"label":"Nov","value":636},{"label":"Dez","value":664}];
const MX = 688;
