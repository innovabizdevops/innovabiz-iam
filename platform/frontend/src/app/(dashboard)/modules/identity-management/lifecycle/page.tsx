...
const PAGE = "Identity Management";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.707","t":"+14.1%","d":"up"},{"l":"Sessões/Dia","v":"4263","t":"-5.6%","d":"down"},{"l":"MFA Adoção (%)","v":"93.6%","t":"+17.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.194","t":"+16.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.323","1.145","2.316","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.663","8.358","620","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.763","7.246","7.765","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.272","8.159","4.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.252","6.359","3.425","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":871},{"label":"Mar","value":1002},{"label":"Abr","value":911},{"label":"Mai","value":916},{"label":"Jun","value":880},{"label":"Jul","value":888},{"label":"Ago","value":935},{"label":"Set","value":810},{"label":"Out","value":732},{"label":"Nov","value":1062},{"label":"Dez","value":741}];
const MX = 1062;
