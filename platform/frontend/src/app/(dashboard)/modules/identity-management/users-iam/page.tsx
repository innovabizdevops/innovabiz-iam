...
const KPIS = [{"l":"Utilizadores Ativos","v":"4.762","t":"+14.1%","d":"up"},{"l":"Sessões/Dia","v":"3969","t":"-3.8%","d":"down"},{"l":"MFA Adoção (%)","v":"82.0%","t":"-2.9%","d":"down"},{"l":"Tentativas Bloqueadas","v":"1.008","t":"-4.4%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.220","2.908","3.375","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.269","2.508","2.835","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.198","1.563","5.336","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.000","5.565","5.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.716","7.005","5.121","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":323},{"label":"Mar","value":469},{"label":"Abr","value":528},{"label":"Mai","value":457},{"label":"Jun","value":690},{"label":"Jul","value":619},{"label":"Ago","value":330},{"label":"Set","value":358},{"label":"Out","value":333},{"label":"Nov","value":657},{"label":"Dez","value":593}];
const MX = 690;
