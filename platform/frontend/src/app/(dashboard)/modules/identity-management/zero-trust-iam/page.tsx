...
const ACCENT = "#6366f1";
const MODULE = "Identity Management";
const PAGE = "Zero Trust Architecture";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.851","t":"+4.2%","d":"up"},{"l":"Sessões/Dia","v":"2005","t":"+17.1%","d":"up"},{"l":"MFA Adoção (%)","v":"89.1%","t":"+14.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.291","t":"+16.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.297","7.771","3.480","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.577","1.006","1.751","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.813","2.647","1.577","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","821","7.290","1.866","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.427","3.786","2.688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":864},{"label":"Mar","value":763},{"label":"Abr","value":883},{"label":"Mai","value":694},{"label":"Jun","value":1007},{"label":"Jul","value":900},{"label":"Ago","value":1051},{"label":"Set","value":906},{"label":"Out","value":726},{"label":"Nov","value":941},{"label":"Dez","value":1073}];
const MX = 1073;
