...
const PAGE = "SSO &amp; MFA";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.561","t":"+4.2%","d":"up"},{"l":"Sessões/Dia","v":"1753","t":"+3.8%","d":"up"},{"l":"MFA Adoção (%)","v":"67.0%","t":"+0.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.253","t":"+16.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","9.045","821","4.451","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.384","5.059","7.570","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.619","4.054","6.801","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.078","7.375","2.007","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.132","1.497","283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":797},{"label":"Mar","value":486},{"label":"Abr","value":497},{"label":"Mai","value":619},{"label":"Jun","value":618},{"label":"Jul","value":721},{"label":"Ago","value":627},{"label":"Set","value":598},{"label":"Out","value":827},{"label":"Nov","value":679},{"label":"Dez","value":715}];
const MX = 827;
