...
const PAGE = "Roles Mgmt";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.478","t":"+0.5%","d":"up"},{"l":"Sessões/Dia","v":"349","t":"-2.2%","d":"down"},{"l":"MFA Adoção (%)","v":"71.5%","t":"+12.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.807","t":"+8.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.706","8.492","1.114","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","446","8.472","5.153","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.395","3.250","6.599","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","9.026","125","8.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","835","7.035","1.079","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":789},{"label":"Mar","value":572},{"label":"Abr","value":493},{"label":"Mai","value":425},{"label":"Jun","value":779},{"label":"Jul","value":452},{"label":"Ago","value":732},{"label":"Set","value":712},{"label":"Out","value":627},{"label":"Nov","value":798},{"label":"Dez","value":673}];
const MX = 798;
