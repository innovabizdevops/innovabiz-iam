...
const PAGE = "IAM Governance";
const KPIS = [{"l":"Riscos Identificados","v":"3.661","t":"+16.0%","d":"up"},{"l":"Mitigações Ativas","v":"4.797","t":"+0.6%","d":"up"},{"l":"Score Risco Geral","v":"79","t":"+12.2%","d":"up"},{"l":"Incidentes YTD","v":"1.678","t":"+17.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.882","1.495","2.165","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.824","1.185","526","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","457","284","1.524","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.631","1.167","6.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.020","8.411","8.142","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":576},{"label":"Mar","value":834},{"label":"Abr","value":843},{"label":"Mai","value":629},{"label":"Jun","value":511},{"label":"Jul","value":631},{"label":"Ago","value":722},{"label":"Set","value":562},{"label":"Out","value":703},{"label":"Nov","value":750},{"label":"Dez","value":569}];
const MX = 843;
...
export default function GovernanceIamPage() {
    return (
