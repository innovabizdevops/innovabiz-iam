...
const PAGE = "MFA Hub";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.941","t":"-4.5%","d":"down"},{"l":"Sessões/Dia","v":"1330","t":"-5.1%","d":"down"},{"l":"MFA Adoção (%)","v":"82.5%","t":"-3.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.519","t":"+5.8%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.508","7.069","890","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.842","2.172","6.447","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.581","4.525","8.005","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.233","5.210","8.130","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.770","4.767","4.966","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":980},{"label":"Mar","value":753},{"label":"Abr","value":941},{"label":"Mai","value":830},{"label":"Jun","value":606},{"label":"Jul","value":656},{"label":"Ago","value":904},{"label":"Set","value":866},{"label":"Out","value":794},{"label":"Nov","value":989},{"label":"Dez","value":889}];
const MX = 989;
