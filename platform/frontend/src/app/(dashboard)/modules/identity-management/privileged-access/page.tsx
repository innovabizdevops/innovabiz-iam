...
const PAGE = "PAM";
const KPIS = [{"l":"Utilizadores Ativos","v":"321","t":"+15.4%","d":"up"},{"l":"Sessões/Dia","v":"588","t":"+11.0%","d":"up"},{"l":"MFA Adoção (%)","v":"82.1%","t":"+9.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.468","t":"+13.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.450","3.276","1.197","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.052","2.605","8.779","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.033","7.101","5.764","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.241","7.957","4.458","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.104","5.706","1.317","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":834},{"label":"Mar","value":732},{"label":"Abr","value":643},{"label":"Mai","value":756},{"label":"Jun","value":964},{"label":"Jul","value":744},{"label":"Ago","value":638},{"label":"Set","value":867},{"label":"Out","value":750},{"label":"Nov","value":683},{"label":"Dez","value":708}];
const MX = 964;
