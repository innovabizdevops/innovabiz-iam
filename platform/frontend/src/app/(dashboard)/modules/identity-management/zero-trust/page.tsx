...
const PAGE = "Zero Trust";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.613","t":"+4.4%","d":"up"},{"l":"Sessões/Dia","v":"2025","t":"+14.7%","d":"up"},{"l":"MFA Adoção (%)","v":"78.6%","t":"+1.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.596","t":"+9.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.121","1.194","1.541","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.525","6.635","1.572","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.796","3.858","4.929","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.654","2.768","1.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.684","4.379","6.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":280},{"label":"Fev","value":582},{"label":"Mar","value":446},{"label":"Abr","value":475},{"label":"Mai","value":401},{"label":"Jun","value":444},{"label":"Jul","value":376},{"label":"Ago","value":367},{"label":"Set","value":342},{"label":"Out","value":384},{"label":"Nov","value":640},{"label":"Dez","value":355}];
const MX = 640;
