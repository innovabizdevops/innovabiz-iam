...
const KPIS = [{"l":"Utilizadores Ativos","v":"6.023","t":"-1.4%","d":"down"},{"l":"Sessões/Dia","v":"750","t":"+9.1%","d":"up"},{"l":"MFA Adoção (%)","v":"68.8%","t":"+16.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"768","t":"-0.4%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.696","2.566","2.837","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.309","2.305","7.568","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.571","8.575","814","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.922","8.195","1.925","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.515","3.453","1.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":286},{"label":"Fev","value":464},{"label":"Mar","value":416},{"label":"Abr","value":327},{"label":"Mai","value":466},{"label":"Jun","value":391},{"label":"Jul","value":289},{"label":"Ago","value":346},{"label":"Set","value":271},{"label":"Out","value":285},{"label":"Nov","value":506},{"label":"Dez","value":332}];
const MX = 506;
