...
const PAGE = "RBAC";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.365","t":"+4.0%","d":"up"},{"l":"Sessões/Dia","v":"1244","t":"+3.4%","d":"up"},{"l":"MFA Adoção (%)","v":"70.9%","t":"-0.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"2.583","t":"+6.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","226","9.013","4.858","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.197","1.240","5.975","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","426","4.669","7.245","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.880","223","1.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.695","6.545","6.385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":806},{"label":"Mar","value":679},{"label":"Abr","value":619},{"label":"Mai","value":652},{"label":"Jun","value":753},{"label":"Jul","value":474},{"label":"Ago","value":548},{"label":"Set","value":571},{"label":"Out","value":643},{"label":"Nov","value":725},{"label":"Dez","value":530}];
const MX = 806;
