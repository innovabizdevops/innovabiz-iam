...
const KPIS = [{"l":"Utilizadores Ativos","v":"6.493","t":"-4.1%","d":"down"},{"l":"Sessões/Dia","v":"4628","t":"-1.6%","d":"down"},{"l":"MFA Adoção (%)","v":"71.4%","t":"+6.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.239","t":"+11.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.288","2.892","6.547","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.060","8.143","1.964","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.928","4.199","6.764","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.010","7.086","8.712","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.491","8.173","6.660","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":483},{"label":"Mar","value":624},{"label":"Abr","value":450},{"label":"Mai","value":324},{"label":"Jun","value":478},{"label":"Jul","value":361},{"label":"Ago","value":517},{"label":"Set","value":315},{"label":"Out","value":293},{"label":"Nov","value":558},{"label":"Dez","value":291}];
const MX = 624;
