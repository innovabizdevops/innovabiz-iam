...
const PAGE = "Passwordless Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.392","t":"+4.8%","d":"up"},{"l":"Sessões/Dia","v":"2268","t":"+2.9%","d":"up"},{"l":"MFA Adoção (%)","v":"87.1%","t":"-2.3%","d":"down"},{"l":"Tentativas Bloqueadas","v":"6.254","t":"+17.8%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.453","1.228","8.537","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.179","6.231","6.495","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.576","2.906","3.153","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.113","2.672","6.785","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.065","851","5.409","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":745},{"label":"Mar","value":455},{"label":"Abr","value":768},{"label":"Mai","value":509},{"label":"Jun","value":633},{"label":"Jul","value":554},{"label":"Ago","value":585},{"label":"Set","value":633},{"label":"Out","value":436},{"label":"Nov","value":507},{"label":"Dez","value":641}];
const MX = 768;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>FIDO2</span></h1>
                </div>
