...
const PAGE = "Governance &amp; Security";
const KPIS = [{"l":"Riscos Identificados","v":"7.045","t":"+12.6%","d":"up"},{"l":"Mitigações Ativas","v":"3.121","t":"+2.0%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+6.9%","d":"up"},{"l":"Incidentes YTD","v":"5.557","t":"+8.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.936","5.091","1.809","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.114","6.040","2.287","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.892","8.112","5.911","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.342","1.189","3.842","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.356","5.663","5.653","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":654},{"label":"Mar","value":302},{"label":"Abr","value":680},{"label":"Mai","value":487},{"label":"Jun","value":623},{"label":"Jul","value":304},{"label":"Ago","value":535},{"label":"Set","value":484},{"label":"Out","value":475},{"label":"Nov","value":597},{"label":"Dez","value":428}];
const MX = 680;
