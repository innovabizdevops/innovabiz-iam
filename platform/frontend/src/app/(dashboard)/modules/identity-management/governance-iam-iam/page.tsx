...
const PAGE = "Identity Governance";
const KPIS = [{"l":"Riscos Identificados","v":"7.045","t":"+11.6%","d":"up"},{"l":"Mitigações Ativas","v":"7.375","t":"+5.1%","d":"up"},{"l":"Score Risco Geral","v":"94","t":"+9.9%","d":"up"},{"l":"Incidentes YTD","v":"2.879","t":"-4.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.932","3.817","3.393","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.913","7.138","8.532","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.294","2.176","3.554","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.491","4.183","5.769","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.872","8.996","1.300","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":383},{"label":"Mar","value":272},{"label":"Abr","value":245},{"label":"Mai","value":323},{"label":"Jun","value":403},{"label":"Jul","value":292},{"label":"Ago","value":437},{"label":"Set","value":412},{"label":"Out","value":209},{"label":"Nov","value":465},{"label":"Dez","value":579}];
const MX = 579;
...
export default function GovernanceIamIamPage() {
    return (
