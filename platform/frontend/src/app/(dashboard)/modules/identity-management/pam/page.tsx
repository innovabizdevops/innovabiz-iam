...
const PAGE = "Privileged Access";
const KPIS = [{"l":"Utilizadores Ativos","v":"961","t":"+14.6%","d":"up"},{"l":"Sessões/Dia","v":"3599","t":"+4.7%","d":"up"},{"l":"MFA Adoção (%)","v":"92.3%","t":"+11.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.897","t":"+17.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.488","521","1.220","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.212","1.150","4.362","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.396","6.956","8.576","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.224","4.783","5.311","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.182","294","4.600","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":347},{"label":"Mar","value":589},{"label":"Abr","value":293},{"label":"Mai","value":535},{"label":"Jun","value":485},{"label":"Jul","value":417},{"label":"Ago","value":452},{"label":"Set","value":589},{"label":"Out","value":385},{"label":"Nov","value":384},{"label":"Dez","value":377}];
const MX = 589;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>PAM</span></h1>
                </div>
