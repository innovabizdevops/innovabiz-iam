...
const PAGE = "Sessions";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.483","t":"-2.9%","d":"down"},{"l":"Sessões/Dia","v":"1828","t":"+10.8%","d":"up"},{"l":"MFA Adoção (%)","v":"82.4%","t":"+15.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.327","t":"-1.6%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.663","3.147","3.498","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.870","5.739","594","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.089","4.630","4.070","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.846","7.312","153","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.227","6.340","3.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":715},{"label":"Mar","value":788},{"label":"Abr","value":814},{"label":"Mai","value":857},{"label":"Jun","value":839},{"label":"Jul","value":833},{"label":"Ago","value":903},{"label":"Set","value":630},{"label":"Out","value":729},{"label":"Nov","value":674},{"label":"Dez","value":734}];
const MX = 903;
