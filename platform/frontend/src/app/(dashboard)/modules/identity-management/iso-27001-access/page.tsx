...
const PAGE = "ISO 27001 Access Control";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.019","t":"+10.6%","d":"up"},{"l":"NC Abertas","v":"4.795","t":"+17.9%","d":"up"},{"l":"Conformidade (%)","v":"92.6%","t":"+9.9%","d":"up"},{"l":"CAPAs Pendentes","v":"8.635","t":"-5.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.877","79.5%","6.692","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.616","91.6%","8.984","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.962","83.6%","4.958","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.180","95.2%","4.759","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.985","90.1%","8.688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":710},{"label":"Mar","value":510},{"label":"Abr","value":477},{"label":"Mai","value":405},{"label":"Jun","value":548},{"label":"Jul","value":505},{"label":"Ago","value":384},{"label":"Set","value":663},{"label":"Out","value":707},{"label":"Nov","value":366},{"label":"Dez","value":588}];
const MX = 713;
...
export default function Iso27001AccessPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ISO</span></h1>
                </div>
