...
const PAGE = "API Security";
const KPIS = [{"l":"Utilizadores Ativos","v":"763","t":"+1.3%","d":"up"},{"l":"Sessões/Dia","v":"1599","t":"-2.2%","d":"down"},{"l":"MFA Adoção (%)","v":"75.8%","t":"+15.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.404","t":"+1.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","9.045","4.938","1.214","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.122","4.971","1.154","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.254","4.312","6.115","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.739","6.349","983","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.075","3.439","2.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":622},{"label":"Mar","value":483},{"label":"Abr","value":601},{"label":"Mai","value":683},{"label":"Jun","value":497},{"label":"Jul","value":614},{"label":"Ago","value":707},{"label":"Set","value":481},{"label":"Out","value":511},{"label":"Nov","value":503},{"label":"Dez","value":658}];
const MX = 707;
