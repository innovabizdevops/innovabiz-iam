...
const PAGE = "User Lifecycle";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.567","t":"-4.0%","d":"down"},{"l":"Sessões/Dia","v":"883","t":"-3.9%","d":"down"},{"l":"MFA Adoção (%)","v":"92.8%","t":"+11.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.977","t":"-4.8%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.248","222","3.299","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.460","2.297","6.493","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.035","8.752","8.813","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.034","9.035","6.710","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.313","5.518","734","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":704},{"label":"Mar","value":558},{"label":"Abr","value":733},{"label":"Mai","value":647},{"label":"Jun","value":829},{"label":"Jul","value":456},{"label":"Ago","value":709},{"label":"Set","value":770},{"label":"Out","value":507},{"label":"Nov","value":459},{"label":"Dez","value":562}];
const MX = 829;
...
export default function LifecycleIamPage() {
    return (
