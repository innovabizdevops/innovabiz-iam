...
const PAGE = "CIAM";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.362","t":"-0.7%","d":"down"},{"l":"Sessões/Dia","v":"3778","t":"-0.5%","d":"down"},{"l":"MFA Adoção (%)","v":"86.7%","t":"+4.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.212","t":"+13.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.795","2.053","8.288","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.093","1.362","2.530","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.255","7.559","4.853","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.051","620","5.752","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.785","2.941","7.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":367},{"label":"Mar","value":361},{"label":"Abr","value":491},{"label":"Mai","value":229},{"label":"Jun","value":415},{"label":"Jul","value":408},{"label":"Ago","value":606},{"label":"Set","value":400},{"label":"Out","value":596},{"label":"Nov","value":529},{"label":"Dez","value":537}];
const MX = 606;
