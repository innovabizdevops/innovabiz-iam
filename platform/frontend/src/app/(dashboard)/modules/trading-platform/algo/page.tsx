...
const ACCENT = "#dc2626";
const MODULE = "Trading Platform";
const PAGE = "Algo Trading";
const KPIS = [{"l":"Formulários Ativos","v":"8.886","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"1855","t":"+15.8%","d":"up"},{"l":"Documentos Gerados","v":"4.535","t":"-2.4%","d":"down"},{"l":"Templates","v":"6.207","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.822","2026-01-11","9.048","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.636","2026-01-24","4.379","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","914","2026-02-22","4.125","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.205","2026-03-28","3.164","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.637","2026-02-14","7.565","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":624},{"label":"Mar","value":569},{"label":"Abr","value":711},{"label":"Mai","value":383},{"label":"Jun","value":646},{"label":"Jul","value":557},{"label":"Ago","value":647},{"label":"Set","value":704},{"label":"Out","value":669},{"label":"Nov","value":717},{"label":"Dez","value":518}];
const MX = 717;
