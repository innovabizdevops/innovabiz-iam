...
const PAGE = "FIX Protocol";
const KPIS = [{"l":"Formulários Ativos","v":"4.352","t":"+8.7%","d":"up"},{"l":"Submissões/Dia","v":"4043","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"5.653","t":"+8.9%","d":"up"},{"l":"Templates","v":"8.166","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.318","2026-02-21","491","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","224","2026-02-08","759","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.772","2026-01-15","1.116","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.506","2026-02-19","4.747","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.241","2026-03-26","1.448","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":301},{"label":"Fev","value":619},{"label":"Mar","value":301},{"label":"Abr","value":429},{"label":"Mai","value":690},{"label":"Jun","value":659},{"label":"Jul","value":605},{"label":"Ago","value":442},{"label":"Set","value":562},{"label":"Out","value":679},{"label":"Nov","value":328},{"label":"Dez","value":315}];
const MX = 690;
