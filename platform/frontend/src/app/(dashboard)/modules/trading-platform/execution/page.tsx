...
const KPIS = [{"l":"Formulários Ativos","v":"3.519","t":"+1.3%","d":"up"},{"l":"Submissões/Dia","v":"1028","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"180","t":"+8.7%","d":"up"},{"l":"Templates","v":"5.784","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","990","2026-01-25","764","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.134","2026-03-02","8.940","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.108","2026-02-08","7.857","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.035","2026-01-20","4.501","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","655","2026-01-19","3.639","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":1031},{"label":"Mar","value":657},{"label":"Abr","value":764},{"label":"Mai","value":832},{"label":"Jun","value":682},{"label":"Jul","value":777},{"label":"Ago","value":758},{"label":"Set","value":989},{"label":"Out","value":932},{"label":"Nov","value":832},{"label":"Dez","value":848}];
const MX = 1031;
