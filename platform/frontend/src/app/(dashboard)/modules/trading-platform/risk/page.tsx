...
const PAGE = "Risk Limits";
const KPIS = [{"l":"Riscos Identificados","v":"8.782","t":"+6.2%","d":"up"},{"l":"Mitigações Ativas","v":"1.776","t":"+12.0%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"-1.5%","d":"down"},{"l":"Incidentes YTD","v":"8.778","t":"+8.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.377","2.651","1.822","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.818","4.066","7.994","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.461","6.679","1.771","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.962","7.674","8.185","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.297","2.332","5.278","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":914},{"label":"Mar","value":677},{"label":"Abr","value":962},{"label":"Mai","value":622},{"label":"Jun","value":881},{"label":"Jul","value":922},{"label":"Ago","value":792},{"label":"Set","value":788},{"label":"Out","value":607},{"label":"Nov","value":757},{"label":"Dez","value":967}];
const MX = 967;
