...
const KPIS = [{"l":"Formulários Ativos","v":"7.909","t":"-0.7%","d":"down"},{"l":"Submissões/Dia","v":"2565","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"3.910","t":"+3.6%","d":"up"},{"l":"Templates","v":"573","t":"-3.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.594","2026-01-09","1.970","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","386","2026-03-05","5.375","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","811","2026-03-14","7.777","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","9.096","2026-02-22","2.085","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.888","2026-01-09","8.625","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":931},{"label":"Mar","value":741},{"label":"Abr","value":705},{"label":"Mai","value":783},{"label":"Jun","value":835},{"label":"Jul","value":1032},{"label":"Ago","value":741},{"label":"Set","value":727},{"label":"Out","value":875},{"label":"Nov","value":1032},{"label":"Dez","value":784}];
const MX = 1032;
