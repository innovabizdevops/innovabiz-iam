...
const PAGE = "Dark Pool";
const KPIS = [{"l":"Formulários Ativos","v":"6.550","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"4539","t":"+14.9%","d":"up"},{"l":"Documentos Gerados","v":"3.693","t":"-1.5%","d":"down"},{"l":"Templates","v":"8.106","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","203","2026-03-21","4.623","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.712","2026-02-03","7.594","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.662","2026-02-18","5.045","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.702","2026-03-15","8.619","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.218","2026-01-17","1.670","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":333},{"label":"Fev","value":304},{"label":"Mar","value":412},{"label":"Abr","value":387},{"label":"Mai","value":230},{"label":"Jun","value":328},{"label":"Jul","value":522},{"label":"Ago","value":545},{"label":"Set","value":385},{"label":"Out","value":491},{"label":"Nov","value":587},{"label":"Dez","value":384}];
const MX = 587;
