...
const PAGE = "Order Book";
const KPIS = [{"l":"Formulários Ativos","v":"1.004","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"781","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"5.309","t":"+6.6%","d":"up"},{"l":"Templates","v":"8.394","t":"+15.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.728","2026-02-04","6.024","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.768","2026-03-28","1.434","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.964","2026-01-25","1.427","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.193","2026-01-16","1.863","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.625","2026-01-08","4.065","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":537},{"label":"Mar","value":775},{"label":"Abr","value":762},{"label":"Mai","value":393},{"label":"Jun","value":665},{"label":"Jul","value":576},{"label":"Ago","value":688},{"label":"Set","value":718},{"label":"Out","value":572},{"label":"Nov","value":575},{"label":"Dez","value":525}];
const MX = 775;
