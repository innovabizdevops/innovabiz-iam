...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.554","t":"-2.0%","d":"down"},{"l":"NC Abertas","v":"7.817","t":"+8.0%","d":"up"},{"l":"Conformidade (%)","v":"93.6%","t":"+8.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.841","t":"+7.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.860","87.4%","265","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.530","94.7%","1.108","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.986","80.1%","5.559","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.689","95.7%","7.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.479","82.6%","7.267","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":640},{"label":"Mar","value":345},{"label":"Abr","value":392},{"label":"Mai","value":595},{"label":"Jun","value":647},{"label":"Jul","value":461},{"label":"Ago","value":376},{"label":"Set","value":547},{"label":"Out","value":290},{"label":"Nov","value":597},{"label":"Dez","value":595}];
const MX = 647;
