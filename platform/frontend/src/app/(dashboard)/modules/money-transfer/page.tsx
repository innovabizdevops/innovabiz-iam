...
const KPIS = [
    { label: "Total Registos", value: "8265", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4915", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€445K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "228470465", cells: ["MON-6465", "Money Transfer Item 1", "14/6/2026", "€20 565"], status: "active" as const },
    { id: "228474036", cells: ["MON-1036", "Money Transfer Item 2", "1/1/2026", "€24 136"], status: "pending" as const },
    { id: "228477607", cells: ["MON-4607", "Money Transfer Item 3", "16/8/2026", "€27 707"], status: "completed" as const },
    { id: "228481178", cells: ["MON-8178", "Money Transfer Item 4", "3/3/2026", "€31 278"], status: "warning" as const },
    { id: "228484749", cells: ["MON-2749", "Money Transfer Item 5", "18/10/2026", "€34 849"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Money Transfer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Money Transfer</p>
                    </div>
                </div>
