...
const PAGE = "Rate";
const KPIS = [{"l":"Total Money Transfer","v":"7.077","t":"+7.1%","d":"up"},{"l":"Rate Ativos","v":"5.062","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"72","t":"+6.6%","d":"up"}];
const COLS = ["ID","Rate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Money Transfer #001","Money Transfer #002","3.988","4.458","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Money Transfer #002","Money Transfer #003","285","5.702","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Money Transfer #003","Money Transfer #004","3.995","485","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Money Transfer #004","Money Transfer #005","3.162","7.053","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Money Transfer #005","Money Transfer #001","2.508","200","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":417},{"label":"Mar","value":633},{"label":"Abr","value":648},{"label":"Mai","value":719},{"label":"Jun","value":516},{"label":"Jul","value":594},{"label":"Ago","value":500},{"label":"Set","value":735},{"label":"Out","value":676},{"label":"Nov","value":406},{"label":"Dez","value":454}];
const MX = 735;
