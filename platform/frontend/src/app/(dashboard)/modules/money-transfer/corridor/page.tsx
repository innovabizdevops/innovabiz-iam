...
const ACCENT = "#0d9488";
const MODULE = "Money Transfer";
const PAGE = "Corridor";
const KPIS = [{"l":"Total Money Transfer","v":"5.839","t":"+12.6%","d":"up"},{"l":"Corridor Ativos","v":"1.917","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"66","t":"+11.3%","d":"up"}];
const COLS = ["ID","Corridor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Money Transfer #001","Money Transfer #002","1.430","7.125","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Money Transfer #002","Money Transfer #003","7.686","4.418","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Money Transfer #003","Money Transfer #004","4.325","531","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Money Transfer #004","Money Transfer #005","1.773","2.223","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Money Transfer #005","Money Transfer #001","4.225","215","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":508},{"label":"Mar","value":347},{"label":"Abr","value":639},{"label":"Mai","value":525},{"label":"Jun","value":377},{"label":"Jul","value":629},{"label":"Ago","value":533},{"label":"Set","value":581},{"label":"Out","value":481},{"label":"Nov","value":287},{"label":"Dez","value":576}];
const MX = 639;
