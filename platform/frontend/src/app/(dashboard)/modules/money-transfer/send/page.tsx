...
const PAGE = "Send";
const KPIS = [{"l":"Total Money Transfer","v":"6.000","t":"-4.6%","d":"down"},{"l":"Send Ativos","v":"6.029","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.1%","d":"up"}];
const COLS = ["ID","Send","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Money Transfer #001","Money Transfer #002","1.395","1.552","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Money Transfer #002","Money Transfer #003","6.338","7.116","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Money Transfer #003","Money Transfer #004","4.068","7.150","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Money Transfer #004","Money Transfer #005","7.932","2.891","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Money Transfer #005","Money Transfer #001","9.089","6.462","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":520},{"label":"Mar","value":520},{"label":"Abr","value":581},{"label":"Mai","value":659},{"label":"Jun","value":334},{"label":"Jul","value":658},{"label":"Ago","value":688},{"label":"Set","value":663},{"label":"Out","value":546},{"label":"Nov","value":545},{"label":"Dez","value":447}];
const MX = 688;
