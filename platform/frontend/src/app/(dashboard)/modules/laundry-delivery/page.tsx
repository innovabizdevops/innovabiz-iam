...
/* ═══ Laundry Delivery App — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "753", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3943", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€471K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2074228853", cells: ["LAU-8853", "Laundry Delivery App Item 1", "26/6/2026", "€28 953"], status: "active" as const },
    { id: "2074232424", cells: ["LAU-3424", "Laundry Delivery App Item 2", "13/1/2026", "€32 524"], status: "pending" as const },
    { id: "2074235995", cells: ["LAU-6995", "Laundry Delivery App Item 3", "28/8/2026", "€36 095"], status: "completed" as const },
    { id: "2074239566", cells: ["LAU-1566", "Laundry Delivery App Item 4", "15/3/2026", "€39 666"], status: "warning" as const },
    { id: "2074243137", cells: ["LAU-5137", "Laundry Delivery App Item 5", "2/10/2026", "€43 237"], status: "active" as const },
];
...
export default function LaundryDeliveryAppPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laundry Delivery App</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laundry Delivery App</p>
                    </div>
                </div>
