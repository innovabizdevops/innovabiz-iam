...
const PAGE = "Pathway Map";
const KPIS = [{"l":"Total Proteomics","v":"6.947","t":"+13.8%","d":"up"},{"l":"Pathway Map Ativos","v":"6.933","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"93","t":"+0.8%","d":"up"}];
const COLS = ["ID","Pathway Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Proteomics #001","Proteomics #002","745","1.660","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Proteomics #002","Proteomics #003","5.448","1.258","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Proteomics #003","Proteomics #004","1.155","8.594","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Proteomics #004","Proteomics #005","4.635","7.979","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Proteomics #005","Proteomics #001","6.272","5.015","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":942},{"label":"Fev","value":692},{"label":"Mar","value":973},{"label":"Abr","value":662},{"label":"Mai","value":655},{"label":"Jun","value":682},{"label":"Jul","value":1012},{"label":"Ago","value":935},{"label":"Set","value":673},{"label":"Out","value":908},{"label":"Nov","value":972},{"label":"Dez","value":767}];
const MX = 1012;
