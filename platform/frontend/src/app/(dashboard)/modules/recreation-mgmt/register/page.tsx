...
const KPIS = [{"l":"Eventos Planeados","v":"6.865","t":"-1.6%","d":"down"},{"l":"Participantes","v":"5.970","t":"+15.9%","d":"up"},{"l":"NPS Evento","v":"80","t":"+9.3%","d":"up"},{"l":"Receita (€)","v":"€89344","t":"+9.6%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-24","1.053","4.126","€ 32531.18","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-19","7.005","1.236","€ 45044.65","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-07","4.864","3.191","€ 26287.45","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-11","1.849","951","€ 4575.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-15","4.757","7.288","€ 35544.33","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":856},{"label":"Mar","value":595},{"label":"Abr","value":878},{"label":"Mai","value":828},{"label":"Jun","value":548},{"label":"Jul","value":860},{"label":"Ago","value":613},{"label":"Set","value":717},{"label":"Out","value":644},{"label":"Nov","value":657},{"label":"Dez","value":601}];
const MX = 878;
