...
const PAGE = "Facility";
const KPIS = [{"l":"Total Recreation Mgmt","v":"8.788","t":"+1.4%","d":"up"},{"l":"Facility Ativos","v":"6.606","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"82.3%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"73","t":"-5.5%","d":"down"}];
const COLS = ["ID","Facility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recreation Mgmt #001","Recreation Mgmt #002","568","6.816","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Recreation Mgmt #002","Recreation Mgmt #003","6.754","2.079","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Recreation Mgmt #003","Recreation Mgmt #004","5.564","8.714","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Recreation Mgmt #004","Recreation Mgmt #005","5.526","8.702","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recreation Mgmt #005","Recreation Mgmt #001","7.545","7.629","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":784},{"label":"Mar","value":770},{"label":"Abr","value":425},{"label":"Mai","value":455},{"label":"Jun","value":733},{"label":"Jul","value":540},{"label":"Ago","value":752},{"label":"Set","value":424},{"label":"Out","value":458},{"label":"Nov","value":781},{"label":"Dez","value":452}];
const MX = 784;
