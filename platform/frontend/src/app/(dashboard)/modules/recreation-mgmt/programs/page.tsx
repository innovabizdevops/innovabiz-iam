...
const ACCENT = "#6366f1";
const MODULE = "Recreation Mgmt";
const PAGE = "Programs";
const KPIS = [{"l":"Total Recreation Mgmt","v":"8.646","t":"-3.3%","d":"down"},{"l":"Programs Ativos","v":"1.009","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"57","t":"+2.5%","d":"up"}];
const COLS = ["ID","Programs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recreation Mgmt #001","Recreation Mgmt #002","1.531","6.814","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Recreation Mgmt #002","Recreation Mgmt #003","2.693","2.634","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Recreation Mgmt #003","Recreation Mgmt #004","3.389","2.113","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Recreation Mgmt #004","Recreation Mgmt #005","582","187","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recreation Mgmt #005","Recreation Mgmt #001","2.290","6.317","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":540},{"label":"Mar","value":476},{"label":"Abr","value":273},{"label":"Mai","value":592},{"label":"Jun","value":345},{"label":"Jul","value":504},{"label":"Ago","value":522},{"label":"Set","value":531},{"label":"Out","value":582},{"label":"Nov","value":402},{"label":"Dez","value":456}];
const MX = 592;
