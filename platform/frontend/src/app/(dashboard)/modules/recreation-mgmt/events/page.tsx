...
const PAGE = "Events";
const KPIS = [{"l":"Total Recreation Mgmt","v":"4.841","t":"+3.1%","d":"up"},{"l":"Events Ativos","v":"6.830","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"84.0%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"72","t":"+3.4%","d":"up"}];
const COLS = ["ID","Events","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recreation Mgmt #001","Recreation Mgmt #002","4.619","4.572","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Recreation Mgmt #002","Recreation Mgmt #003","5.809","7.048","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Recreation Mgmt #003","Recreation Mgmt #004","160","3.827","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Recreation Mgmt #004","Recreation Mgmt #005","2.025","6.953","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recreation Mgmt #005","Recreation Mgmt #001","5.616","5.821","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":683},{"label":"Mar","value":552},{"label":"Abr","value":753},{"label":"Mai","value":832},{"label":"Jun","value":765},{"label":"Jul","value":814},{"label":"Ago","value":805},{"label":"Set","value":469},{"label":"Out","value":639},{"label":"Nov","value":799},{"label":"Dez","value":850}];
const MX = 850;
