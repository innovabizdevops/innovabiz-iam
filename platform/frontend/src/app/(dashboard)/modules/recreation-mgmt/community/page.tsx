...
const KPIS = [{"l":"Projetos Sociais","v":"5.020","t":"+14.3%","d":"up"},{"l":"Beneficiários","v":"7.859","t":"+8.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€31609","t":"-1.7%","d":"down"},{"l":"Score Impacto","v":"82","t":"-3.2%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.054","€ 1041.24","3.133","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.780","€ 45864.97","5.108","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.147","€ 1483.45","6.779","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.626","€ 47092.48","5.072","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.250","€ 17629.07","6.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":545},{"label":"Mar","value":771},{"label":"Abr","value":581},{"label":"Mai","value":840},{"label":"Jun","value":801},{"label":"Jul","value":615},{"label":"Ago","value":742},{"label":"Set","value":517},{"label":"Out","value":536},{"label":"Nov","value":540},{"label":"Dez","value":831}];
const MX = 840;
