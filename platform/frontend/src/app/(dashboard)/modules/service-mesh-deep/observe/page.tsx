...
const ACCENT = "#0d9488";
const MODULE = "Service Mesh Deep";
const PAGE = "Observe";
const KPIS = [{"l":"Total Service Mesh Deep","v":"4.088","t":"-3.9%","d":"down"},{"l":"Observe Ativos","v":"2.439","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"61","t":"+8.3%","d":"up"}];
const COLS = ["ID","Observe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Mesh Deep #001","Service Mesh Deep #002","7.055","7.910","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Service Mesh Deep #002","Service Mesh Deep #003","5.946","6.421","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Mesh Deep #003","Service Mesh Deep #004","6.875","7.974","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Service Mesh Deep #004","Service Mesh Deep #005","9.039","8.092","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Mesh Deep #005","Service Mesh Deep #001","2.346","3.549","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":757},{"label":"Mar","value":942},{"label":"Abr","value":567},{"label":"Mai","value":753},{"label":"Jun","value":580},{"label":"Jul","value":587},{"label":"Ago","value":738},{"label":"Set","value":693},{"label":"Out","value":574},{"label":"Nov","value":617},{"label":"Dez","value":928}];
const MX = 942;
