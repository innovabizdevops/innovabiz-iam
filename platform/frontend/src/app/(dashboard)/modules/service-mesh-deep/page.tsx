...
/* ═══ Service Mesh Deep — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "3043", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "151", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€117K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "433593243", cells: ["SER-1243", "Service Mesh Deep Item 1", "28/4/2026", "€43 343"], status: "active" as const },
    { id: "433596814", cells: ["SER-4814", "Service Mesh Deep Item 2", "15/11/2026", "€46 914"], status: "pending" as const },
    { id: "433600385", cells: ["SER-8385", "Service Mesh Deep Item 3", "2/6/2026", "€485"], status: "completed" as const },
    { id: "433603956", cells: ["SER-2956", "Service Mesh Deep Item 4", "17/1/2026", "€4056"], status: "warning" as const },
    { id: "433607527", cells: ["SER-6527", "Service Mesh Deep Item 5", "4/8/2026", "€7627"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Service Mesh Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Service Mesh Deep</p>
                    </div>
                </div>
