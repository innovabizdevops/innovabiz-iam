...
const PAGE = "Master Plan";
const KPIS = [{"l":"Total Urban Planning","v":"6.842","t":"+3.6%","d":"up"},{"l":"Master Plan Ativos","v":"8.901","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+13.4%","d":"up"}];
const COLS = ["ID","Master Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Planning #001","Urban Planning #002","710","3.821","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Planning #002","Urban Planning #003","567","5.156","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Planning #003","Urban Planning #004","6.113","1.205","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Planning #004","Urban Planning #005","8.239","7.456","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Planning #005","Urban Planning #001","2.242","8.749","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":999},{"label":"Fev","value":867},{"label":"Mar","value":918},{"label":"Abr","value":750},{"label":"Mai","value":990},{"label":"Jun","value":959},{"label":"Jul","value":753},{"label":"Ago","value":627},{"label":"Set","value":744},{"label":"Out","value":849},{"label":"Nov","value":715},{"label":"Dez","value":909}];
const MX = 999;
