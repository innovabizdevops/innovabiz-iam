...
const ACCENT = "#60a5fa";
const MODULE = "Urban Planning";
const PAGE = "AI Simulation";
const KPIS = [{"l":"Twins Ativos","v":"4.079","t":"-3.4%","d":"down"},{"l":"Simulações/Dia","v":"591","t":"-6.0%","d":"down"},{"l":"Precisão Modelo (%)","v":"86.7%","t":"+16.6%","d":"up"},{"l":"Latência Sync (ms)","v":"122ms","t":"+4.1%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","73.3%","2026-01-03","8.071","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","82.9%","2026-03-04","592","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","72.4%","2026-02-24","5.774","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","76.3%","2026-01-12","1.017","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","94.6%","2026-01-22","277","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":464},{"label":"Mar","value":740},{"label":"Abr","value":426},{"label":"Mai","value":352},{"label":"Jun","value":571},{"label":"Jul","value":587},{"label":"Ago","value":560},{"label":"Set","value":613},{"label":"Out","value":444},{"label":"Nov","value":523},{"label":"Dez","value":423}];
const MX = 740;
