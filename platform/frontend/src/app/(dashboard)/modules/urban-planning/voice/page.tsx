...
const PAGE = "Citizen Voice";
const KPIS = [{"l":"Total Urban Planning","v":"4.563","t":"-1.2%","d":"down"},{"l":"Citizen Voice Ativos","v":"3.146","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+1.4%","d":"up"}];
const COLS = ["ID","Citizen Voice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Planning #001","Urban Planning #002","2.976","155","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Planning #002","Urban Planning #003","8.603","7.768","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Planning #003","Urban Planning #004","5.887","6.662","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Planning #004","Urban Planning #005","6.802","1.484","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Planning #005","Urban Planning #001","754","3.975","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":394},{"label":"Mar","value":500},{"label":"Abr","value":446},{"label":"Mai","value":501},{"label":"Jun","value":714},{"label":"Jul","value":417},{"label":"Ago","value":506},{"label":"Set","value":364},{"label":"Out","value":342},{"label":"Nov","value":651},{"label":"Dez","value":416}];
const MX = 714;
