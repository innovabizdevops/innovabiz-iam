...
const PAGE = "Traffic Study";
const KPIS = [{"l":"Total Urban Planning","v":"2.822","t":"+0.9%","d":"up"},{"l":"Traffic Study Ativos","v":"9.075","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"64","t":"-5.9%","d":"down"}];
const COLS = ["ID","Traffic Study","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Planning #001","Urban Planning #002","8.533","4.833","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Planning #002","Urban Planning #003","7.367","498","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Planning #003","Urban Planning #004","5.860","6.894","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Planning #004","Urban Planning #005","4.098","3.096","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Planning #005","Urban Planning #001","2.926","8.932","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":578},{"label":"Mar","value":604},{"label":"Abr","value":839},{"label":"Mai","value":668},{"label":"Jun","value":655},{"label":"Jul","value":772},{"label":"Ago","value":638},{"label":"Set","value":556},{"label":"Out","value":730},{"label":"Nov","value":575},{"label":"Dez","value":741}];
const MX = 839;
