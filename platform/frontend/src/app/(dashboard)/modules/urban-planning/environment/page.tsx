...
const PAGE = "Environment Rev";
const KPIS = [{"l":"Total Urban Planning","v":"2.276","t":"-3.1%","d":"down"},{"l":"Environment Rev Ativos","v":"1.869","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.5%","d":"up"}];
const COLS = ["ID","Environment Rev","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Urban Planning #001","Urban Planning #002","3.346","371","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Urban Planning #002","Urban Planning #003","8.360","8.683","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Urban Planning #003","Urban Planning #004","7.031","3.553","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Urban Planning #004","Urban Planning #005","759","3.460","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Urban Planning #005","Urban Planning #001","4.553","6.388","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":749},{"label":"Mar","value":852},{"label":"Abr","value":589},{"label":"Mai","value":705},{"label":"Jun","value":900},{"label":"Jul","value":617},{"label":"Ago","value":748},{"label":"Set","value":540},{"label":"Out","value":640},{"label":"Nov","value":850},{"label":"Dez","value":559}];
const MX = 900;
