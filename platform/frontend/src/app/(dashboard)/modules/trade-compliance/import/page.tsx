...
const PAGE = "Import";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.772","t":"+5.8%","d":"up"},{"l":"NC Abertas","v":"5.891","t":"+10.2%","d":"up"},{"l":"Conformidade (%)","v":"85.3%","t":"+2.5%","d":"up"},{"l":"CAPAs Pendentes","v":"2.052","t":"-1.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.393","72.7%","4.819","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.901","86.9%","1.207","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.218","76.7%","8.925","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.158","84.9%","5.518","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.322","72.1%","4.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":471},{"label":"Mar","value":652},{"label":"Abr","value":776},{"label":"Mai","value":486},{"label":"Jun","value":706},{"label":"Jul","value":738},{"label":"Ago","value":681},{"label":"Set","value":692},{"label":"Out","value":777},{"label":"Nov","value":827},{"label":"Dez","value":779}];
const MX = 827;
