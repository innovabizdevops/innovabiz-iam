...
const PAGE = "Tariff";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.717","t":"+4.4%","d":"up"},{"l":"NC Abertas","v":"4.797","t":"+15.9%","d":"up"},{"l":"Conformidade (%)","v":"74.2%","t":"+15.4%","d":"up"},{"l":"CAPAs Pendentes","v":"5.808","t":"+5.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.207","95.7%","4.422","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","937","91.7%","6.211","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.287","86.1%","3.864","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.202","92.1%","6.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.803","70.6%","1.842","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":482},{"label":"Mar","value":358},{"label":"Abr","value":669},{"label":"Mai","value":643},{"label":"Jun","value":555},{"label":"Jul","value":444},{"label":"Ago","value":350},{"label":"Set","value":333},{"label":"Out","value":487},{"label":"Nov","value":497},{"label":"Dez","value":306}];
const MX = 669;
