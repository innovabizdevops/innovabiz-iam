...
const KPIS = [
    { label: "Total Registos", value: "5487", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4198", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€485K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "707736587", cells: ["TRA-4587", "Trade Compliance Item 1", "20/12/2026", "€36 687"], status: "active" as const },
    { id: "707740158", cells: ["TRA-8158", "Trade Compliance Item 2", "7/7/2026", "€40 258"], status: "pending" as const },
    { id: "707743729", cells: ["TRA-2729", "Trade Compliance Item 3", "22/2/2026", "€43 829"], status: "completed" as const },
    { id: "707747300", cells: ["TRA-6300", "Trade Compliance Item 4", "9/9/2026", "€47 400"], status: "warning" as const },
    { id: "707750871", cells: ["TRA-9871", "Trade Compliance Item 5", "24/4/2026", "€971"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trade Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Trade Compliance</p>
                    </div>
                </div>
