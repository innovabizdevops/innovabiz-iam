...
const KPIS = [{"l":"eNPS","v":"75","t":"+9.0%","d":"up"},{"l":"Engagement (%)","v":"84.6%","t":"+7.6%","d":"up"},{"l":"Turnover (%)","v":"90.2%","t":"+3.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.090","t":"+0.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.293","2026-03-15","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.579","2026-01-26","67","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","203","2026-03-04","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.025","2026-02-28","70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.382","2026-03-17","82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":895},{"label":"Mar","value":714},{"label":"Abr","value":807},{"label":"Mai","value":692},{"label":"Jun","value":1037},{"label":"Jul","value":1049},{"label":"Ago","value":935},{"label":"Set","value":1047},{"label":"Out","value":882},{"label":"Nov","value":928},{"label":"Dez","value":1022}];
const MX = 1049;
