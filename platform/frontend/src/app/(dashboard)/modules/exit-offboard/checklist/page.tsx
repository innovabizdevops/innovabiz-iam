...
const KPIS = [{"l":"eNPS","v":"89","t":"-1.1%","d":"down"},{"l":"Engagement (%)","v":"67.6%","t":"+11.1%","d":"up"},{"l":"Turnover (%)","v":"74.6%","t":"+2.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.069","t":"+7.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.244","2026-03-26","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","677","2026-01-08","90","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.702","2026-02-01","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","122","2026-01-17","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.997","2026-01-08","95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":706},{"label":"Mar","value":915},{"label":"Abr","value":832},{"label":"Mai","value":776},{"label":"Jun","value":805},{"label":"Jul","value":683},{"label":"Ago","value":879},{"label":"Set","value":1035},{"label":"Out","value":979},{"label":"Nov","value":738},{"label":"Dez","value":691}];
const MX = 1035;
