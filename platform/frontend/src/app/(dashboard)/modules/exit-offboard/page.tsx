...
export default function ExitOffboardPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Exit Offboard</h1><p className="text-sm text-muted-foreground">Exit Offboard • iBOS Enterprise</p></div>
