...
const PAGE = "Alumni";
const KPIS = [{"l":"eNPS","v":"58","t":"+14.8%","d":"up"},{"l":"Engagement (%)","v":"78.4%","t":"+0.8%","d":"up"},{"l":"Turnover (%)","v":"70.3%","t":"+8.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"656","t":"+2.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.919","2026-02-07","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.903","2026-03-07","66","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.737","2026-01-04","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.282","2026-03-16","55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.097","2026-01-24","65","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":740},{"label":"Mar","value":649},{"label":"Abr","value":596},{"label":"Mai","value":585},{"label":"Jun","value":722},{"label":"Jul","value":493},{"label":"Ago","value":700},{"label":"Set","value":746},{"label":"Out","value":787},{"label":"Nov","value":716},{"label":"Dez","value":780}];
const MX = 787;
