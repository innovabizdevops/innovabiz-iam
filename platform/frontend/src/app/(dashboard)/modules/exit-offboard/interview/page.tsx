...
const ACCENT = "#6366f1";
const MODULE = "Exit & Offboarding";
const PAGE = "Interview";
const KPIS = [{"l":"eNPS","v":"62","t":"-5.0%","d":"down"},{"l":"Engagement (%)","v":"75.0%","t":"-5.1%","d":"down"},{"l":"Turnover (%)","v":"87.1%","t":"-3.7%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"167","t":"+5.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.587","2026-01-11","95","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.216","2026-03-10","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.109","2026-03-01","90","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.227","2026-01-11","63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.771","2026-01-26","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":753},{"label":"Mar","value":725},{"label":"Abr","value":424},{"label":"Mai","value":574},{"label":"Jun","value":505},{"label":"Jul","value":574},{"label":"Ago","value":489},{"label":"Set","value":639},{"label":"Out","value":569},{"label":"Nov","value":658},{"label":"Dez","value":400}];
const MX = 753;
