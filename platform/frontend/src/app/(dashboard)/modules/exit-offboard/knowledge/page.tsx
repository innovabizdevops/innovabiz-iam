...
const KPIS = [{"l":"eNPS","v":"68","t":"+17.1%","d":"up"},{"l":"Engagement (%)","v":"81.3%","t":"+15.3%","d":"up"},{"l":"Turnover (%)","v":"89.9%","t":"+14.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.349","t":"+6.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.602","2026-02-20","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.196","2026-01-06","55","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.521","2026-03-22","75","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.886","2026-01-06","93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.107","2026-03-28","81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":428},{"label":"Mar","value":433},{"label":"Abr","value":626},{"label":"Mai","value":628},{"label":"Jun","value":391},{"label":"Jul","value":532},{"label":"Ago","value":319},{"label":"Set","value":564},{"label":"Out","value":537},{"label":"Nov","value":475},{"label":"Dez","value":676}];
const MX = 676;
