...
const PAGE = "Golden Records";
const KPIS = [{"l":"Dashboards Ativos","v":"1.414","t":"+14.6%","d":"up"},{"l":"Queries/Dia","v":"237","t":"+11.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.082","t":"-2.3%","d":"down"},{"l":"Utilizadores Analytics","v":"5.218","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4794","2026-01-06","1.886","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2005","2026-03-20","576","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2796","2026-02-11","1.047","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1741","2026-01-05","1.043","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3240","2026-02-02","240","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":753},{"label":"Mar","value":678},{"label":"Abr","value":800},{"label":"Mai","value":636},{"label":"Jun","value":755},{"label":"Jul","value":819},{"label":"Ago","value":973},{"label":"Set","value":727},{"label":"Out","value":891},{"label":"Nov","value":596},{"label":"Dez","value":978}];
const MX = 978;
