...
const KPIS = [{"l":"Dashboards Ativos","v":"7.539","t":"-5.4%","d":"down"},{"l":"Queries/Dia","v":"4829","t":"+12.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.526","t":"+13.2%","d":"up"},{"l":"Utilizadores Analytics","v":"4.565","t":"+14.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2669","2026-02-17","3.125","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4918","2026-01-15","3.319","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","931","2026-01-09","8.884","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2959","2026-02-22","8.736","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4942","2026-02-01","7.751","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":909},{"label":"Mar","value":865},{"label":"Abr","value":702},{"label":"Mai","value":937},{"label":"Jun","value":843},{"label":"Jul","value":584},{"label":"Ago","value":704},{"label":"Set","value":558},{"label":"Out","value":665},{"label":"Nov","value":775},{"label":"Dez","value":903}];
const MX = 937;
