...
const PAGE = "Survivorship Rules";
const KPIS = [{"l":"Ideias Submetidas","v":"8.434","t":"+14.1%","d":"up"},{"l":"Patentes (YTD)","v":"7.268","t":"-0.1%","d":"down"},{"l":"Projetos Innovation Lab","v":"519","t":"+6.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€14.1M","t":"+3.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.869","97.1%","3.873","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.546","75.7%","2.991","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.687","94.0%","6.081","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.427","85.6%","6.221","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.136","96.3%","5.948","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":327},{"label":"Mar","value":437},{"label":"Abr","value":509},{"label":"Mai","value":663},{"label":"Jun","value":352},{"label":"Jul","value":330},{"label":"Ago","value":572},{"label":"Set","value":556},{"label":"Out","value":619},{"label":"Nov","value":383},{"label":"Dez","value":368}];
const MX = 663;
