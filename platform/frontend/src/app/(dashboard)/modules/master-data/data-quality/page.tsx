...
const PAGE = "Data Quality AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"629","t":"+7.8%","d":"up"},{"l":"NC Abertas","v":"6.980","t":"+17.3%","d":"up"},{"l":"Conformidade (%)","v":"78.0%","t":"+13.1%","d":"up"},{"l":"CAPAs Pendentes","v":"5.994","t":"-3.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","702","80.1%","3.176","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.963","76.6%","3.877","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.213","75.4%","2.979","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","977","92.4%","6.539","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.700","88.4%","7.252","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":562},{"label":"Mar","value":358},{"label":"Abr","value":545},{"label":"Mai","value":406},{"label":"Jun","value":360},{"label":"Jul","value":550},{"label":"Ago","value":523},{"label":"Set","value":591},{"label":"Out","value":448},{"label":"Nov","value":572},{"label":"Dez","value":612}];
const MX = 612;
