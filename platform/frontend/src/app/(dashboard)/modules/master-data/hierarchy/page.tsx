...
const PAGE = "Hierarchy Mgmt";
const KPIS = [{"l":"Ideias Submetidas","v":"1.099","t":"+7.4%","d":"up"},{"l":"Patentes (YTD)","v":"7.555","t":"+2.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.358","t":"+5.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€3.3M","t":"+11.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.297","80.6%","4.039","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","886","83.3%","1.829","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.549","73.1%","2.072","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.019","97.9%","5.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.327","96.8%","7.095","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":561},{"label":"Mar","value":266},{"label":"Abr","value":585},{"label":"Mai","value":625},{"label":"Jun","value":259},{"label":"Jul","value":431},{"label":"Ago","value":601},{"label":"Set","value":560},{"label":"Out","value":400},{"label":"Nov","value":277},{"label":"Dez","value":300}];
const MX = 625;
