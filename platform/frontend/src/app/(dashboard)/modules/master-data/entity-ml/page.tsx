...
const PAGE = "ML Entity Resolution";
const KPIS = [{"l":"Ideias Submetidas","v":"5.043","t":"-1.4%","d":"down"},{"l":"Patentes (YTD)","v":"8.561","t":"+2.5%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.714","t":"-0.2%","d":"down"},{"l":"Budget I&D (€M)","v":"€22.4M","t":"-1.2%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.755","89.3%","6.195","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.652","83.1%","3.375","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.000","76.5%","5.215","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.144","71.6%","2.771","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.878","90.8%","538","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":570},{"label":"Mar","value":677},{"label":"Abr","value":688},{"label":"Mai","value":495},{"label":"Jun","value":456},{"label":"Jul","value":515},{"label":"Ago","value":827},{"label":"Set","value":629},{"label":"Out","value":752},{"label":"Nov","value":782},{"label":"Dez","value":475}];
const MX = 827;
...
export default function EntityMlPage() {
    return (
