...
const KPIS = [{"l":"Ideias Submetidas","v":"8.342","t":"+7.2%","d":"up"},{"l":"Patentes (YTD)","v":"5.735","t":"+5.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.117","t":"+13.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€46.2M","t":"+7.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.741","74.0%","5.848","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","122","91.1%","7.723","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.556","87.9%","3.498","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.927","72.7%","6.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.252","76.7%","5.613","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":959},{"label":"Fev","value":897},{"label":"Mar","value":787},{"label":"Abr","value":837},{"label":"Mai","value":704},{"label":"Jun","value":1057},{"label":"Jul","value":915},{"label":"Ago","value":1003},{"label":"Set","value":933},{"label":"Out","value":747},{"label":"Nov","value":735},{"label":"Dez","value":734}];
const MX = 1057;
