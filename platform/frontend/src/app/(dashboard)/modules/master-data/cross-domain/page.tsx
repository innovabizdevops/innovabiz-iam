...
const PAGE = "Cross-Domain Mgmt";
const KPIS = [{"l":"Ideias Submetidas","v":"5.566","t":"+12.5%","d":"up"},{"l":"Patentes (YTD)","v":"6.361","t":"-3.7%","d":"down"},{"l":"Projetos Innovation Lab","v":"8.468","t":"+0.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€18.3M","t":"-0.6%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.408","93.9%","1.076","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.929","70.8%","5.578","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.105","94.8%","2.397","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.904","90.6%","7.451","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.461","79.2%","772","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":460},{"label":"Mar","value":283},{"label":"Abr","value":250},{"label":"Mai","value":402},{"label":"Jun","value":598},{"label":"Jul","value":569},{"label":"Ago","value":261},{"label":"Set","value":378},{"label":"Out","value":489},{"label":"Nov","value":327},{"label":"Dez","value":444}];
const MX = 598;
