...
const PAGE = "ISO 8000 Data Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"793","t":"+13.1%","d":"up"},{"l":"NC Abertas","v":"7.205","t":"-2.6%","d":"down"},{"l":"Conformidade (%)","v":"78.6%","t":"+7.4%","d":"up"},{"l":"CAPAs Pendentes","v":"2.760","t":"+16.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.711","75.0%","7.381","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.126","76.6%","4.278","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.361","87.6%","3.729","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.323","87.9%","6.019","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.916","74.2%","307","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":463},{"label":"Mar","value":492},{"label":"Abr","value":418},{"label":"Mai","value":572},{"label":"Jun","value":732},{"label":"Jul","value":686},{"label":"Ago","value":681},{"label":"Set","value":655},{"label":"Out","value":596},{"label":"Nov","value":440},{"label":"Dez","value":372}];
const MX = 732;
...
export default function Iso8000Page() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>ISO</span></h1>
                </div>
