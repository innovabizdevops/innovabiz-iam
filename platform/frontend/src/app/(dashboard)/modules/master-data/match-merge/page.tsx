...
const ACCENT = "#dc2626";
const MODULE = "Master Data Mgmt";
const PAGE = "Match &amp; Merge";
const KPIS = [{"l":"Dashboards Ativos","v":"7.644","t":"+4.2%","d":"up"},{"l":"Queries/Dia","v":"4558","t":"+14.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.523","t":"+5.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.390","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3023","2026-01-01","6.772","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","430","2026-03-26","6.048","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","718","2026-03-01","5.825","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4231","2026-01-21","2.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","626","2026-01-05","6.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":604},{"label":"Mar","value":628},{"label":"Abr","value":564},{"label":"Mai","value":617},{"label":"Jun","value":606},{"label":"Jul","value":518},{"label":"Ago","value":816},{"label":"Set","value":464},{"label":"Out","value":578},{"label":"Nov","value":773},{"label":"Dez","value":644}];
const MX = 816;
