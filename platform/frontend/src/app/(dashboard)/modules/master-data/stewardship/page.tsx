...
const PAGE = "Data Stewardship";
const KPIS = [{"l":"Ideias Submetidas","v":"3.456","t":"+15.3%","d":"up"},{"l":"Patentes (YTD)","v":"7.624","t":"+9.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.861","t":"+13.9%","d":"up"},{"l":"Budget I&D (€M)","v":"€45.8M","t":"+15.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.061","77.0%","8.314","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.035","75.0%","462","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.630","97.1%","5.340","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.355","78.6%","8.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.408","71.3%","6.972","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":668},{"label":"Mar","value":903},{"label":"Abr","value":714},{"label":"Mai","value":801},{"label":"Jun","value":619},{"label":"Jul","value":653},{"label":"Ago","value":827},{"label":"Set","value":817},{"label":"Out","value":619},{"label":"Nov","value":820},{"label":"Dez","value":645}];
const MX = 903;
