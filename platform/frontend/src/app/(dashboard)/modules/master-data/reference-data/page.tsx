...
const PAGE = "Reference Data";
const KPIS = [{"l":"Ideias Submetidas","v":"7.231","t":"-1.8%","d":"down"},{"l":"Patentes (YTD)","v":"5.611","t":"+16.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.656","t":"+7.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€7.6M","t":"+10.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.222","74.9%","2.327","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.312","71.7%","6.982","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.185","85.1%","9.058","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.674","78.6%","5.411","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.830","71.0%","5.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":755},{"label":"Mar","value":529},{"label":"Abr","value":453},{"label":"Mai","value":635},{"label":"Jun","value":661},{"label":"Jul","value":423},{"label":"Ago","value":378},{"label":"Set","value":428},{"label":"Out","value":441},{"label":"Nov","value":577},{"label":"Dez","value":474}];
const MX = 755;
