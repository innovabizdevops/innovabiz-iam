...
const KPIS = [{"l":"Ideias Submetidas","v":"4.992","t":"+15.6%","d":"up"},{"l":"Patentes (YTD)","v":"2.813","t":"+9.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.323","t":"+8.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€2.5M","t":"+14.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.834","82.5%","1.541","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.781","83.1%","1.993","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.647","81.7%","8.003","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.917","88.2%","2.193","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","753","87.1%","1.155","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":526},{"label":"Mar","value":543},{"label":"Abr","value":418},{"label":"Mai","value":501},{"label":"Jun","value":306},{"label":"Jul","value":556},{"label":"Ago","value":412},{"label":"Set","value":628},{"label":"Out","value":309},{"label":"Nov","value":301},{"label":"Dez","value":307}];
const MX = 628;
