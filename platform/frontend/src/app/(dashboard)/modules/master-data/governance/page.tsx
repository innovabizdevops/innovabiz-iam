...
const PAGE = "Data Governance";
const KPIS = [{"l":"Riscos Identificados","v":"2.892","t":"+3.1%","d":"up"},{"l":"Mitigações Ativas","v":"268","t":"+1.8%","d":"up"},{"l":"Score Risco Geral","v":"76","t":"+7.3%","d":"up"},{"l":"Incidentes YTD","v":"1.033","t":"+1.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.676","4.370","1.033","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.173","6.721","4.662","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.733","271","155","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.661","844","219","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","826","7.060","6.485","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":799},{"label":"Mar","value":497},{"label":"Abr","value":426},{"label":"Mai","value":733},{"label":"Jun","value":457},{"label":"Jul","value":661},{"label":"Ago","value":614},{"label":"Set","value":773},{"label":"Out","value":763},{"label":"Nov","value":752},{"label":"Dez","value":696}];
const MX = 799;
