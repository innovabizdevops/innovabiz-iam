...
const KPIS = [
    { label: "Total Registos", value: "5263", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4990", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€295K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "962087163", cells: ["PHA-6163", "Pharma Manufacturing Item 1", "24/4/2026", "€37 263"], status: "active" as const },
    { id: "962090734", cells: ["PHA-9734", "Pharma Manufacturing Item 2", "11/11/2026", "€40 834"], status: "pending" as const },
    { id: "962094305", cells: ["PHA-4305", "Pharma Manufacturing Item 3", "26/6/2026", "€44 405"], status: "completed" as const },
    { id: "962097876", cells: ["PHA-7876", "Pharma Manufacturing Item 4", "13/1/2026", "€47 976"], status: "warning" as const },
    { id: "962101447", cells: ["PHA-2447", "Pharma Manufacturing Item 5", "28/8/2026", "€1547"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Manufacturing</p>
                    </div>
                </div>
