...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.166","t":"-0.9%","d":"down"},{"l":"NC Abertas","v":"6.789","t":"+10.5%","d":"up"},{"l":"Conformidade (%)","v":"65.7%","t":"+10.5%","d":"up"},{"l":"CAPAs Pendentes","v":"7.524","t":"+0.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.051","91.6%","8.035","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.961","77.1%","2.796","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.274","77.8%","670","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.789","84.6%","4.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.914","86.5%","8.381","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":464},{"label":"Mar","value":661},{"label":"Abr","value":598},{"label":"Mai","value":337},{"label":"Jun","value":316},{"label":"Jul","value":341},{"label":"Ago","value":655},{"label":"Set","value":347},{"label":"Out","value":434},{"label":"Nov","value":406},{"label":"Dez","value":373}];
const MX = 661;
