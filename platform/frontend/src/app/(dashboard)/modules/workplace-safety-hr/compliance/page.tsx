...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.015","t":"+4.1%","d":"up"},{"l":"NC Abertas","v":"5.194","t":"+9.8%","d":"up"},{"l":"Conformidade (%)","v":"89.1%","t":"-5.4%","d":"down"},{"l":"CAPAs Pendentes","v":"967","t":"+0.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.314","92.6%","4.322","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.376","86.0%","7.797","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.808","88.5%","374","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.935","73.8%","6.529","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.217","91.1%","7.635","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":589},{"label":"Mar","value":798},{"label":"Abr","value":631},{"label":"Mai","value":733},{"label":"Jun","value":711},{"label":"Jul","value":794},{"label":"Ago","value":484},{"label":"Set","value":699},{"label":"Out","value":415},{"label":"Nov","value":512},{"label":"Dez","value":733}];
const MX = 798;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>OSHA</span></h1>
                </div>
