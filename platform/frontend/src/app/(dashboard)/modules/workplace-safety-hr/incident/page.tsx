...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"2.864","t":"+11.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.8%","t":"+3.7%","d":"up"},{"l":"MTTR (h)","v":"30h","t":"+1.4%","d":"up"},{"l":"Satisfação (%)","v":"88.3%","t":"+8.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.934","7.389","9.086","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.487","8.341","602","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.947","7.107","1.448","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.942","6.396","2.352","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","621","5.387","3.964","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":581},{"label":"Mar","value":876},{"label":"Abr","value":823},{"label":"Mai","value":597},{"label":"Jun","value":585},{"label":"Jul","value":599},{"label":"Ago","value":909},{"label":"Set","value":833},{"label":"Out","value":920},{"label":"Nov","value":631},{"label":"Dez","value":880}];
const MX = 920;
