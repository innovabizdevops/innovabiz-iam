...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.063","t":"+7.4%","d":"up"},{"l":"NC Abertas","v":"1.986","t":"+17.6%","d":"up"},{"l":"Conformidade (%)","v":"77.2%","t":"+15.4%","d":"up"},{"l":"CAPAs Pendentes","v":"7.097","t":"+10.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.845","95.2%","3.982","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.639","95.3%","1.158","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.154","72.0%","1.313","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.020","96.7%","5.249","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.000","71.9%","8.255","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":528},{"label":"Mar","value":724},{"label":"Abr","value":655},{"label":"Mai","value":554},{"label":"Jun","value":515},{"label":"Jul","value":545},{"label":"Ago","value":726},{"label":"Set","value":750},{"label":"Out","value":445},{"label":"Nov","value":639},{"label":"Dez","value":437}];
const MX = 772;
