...
export default function WorkplaceSafetyHrPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Workplace Safety Hr</h1><p className="text-sm text-muted-foreground">Workplace Safety Hr • iBOS Enterprise</p></div>
