...
const PAGE = "Sub-Consolidation";
const KPIS = [{"l":"Total Consolidation","v":"6.127","t":"+6.5%","d":"up"},{"l":"Sub Consolidation Ativos","v":"3.289","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"62","t":"+14.2%","d":"up"}];
const COLS = ["ID","Sub Consolidation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consolidation #001","Consolidation #002","3.670","5.340","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Consolidation #002","Consolidation #003","7.543","4.491","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Consolidation #003","Consolidation #004","1.423","1.367","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Consolidation #004","Consolidation #005","8.004","7.732","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consolidation #005","Consolidation #001","736","7.591","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":680},{"label":"Mar","value":617},{"label":"Abr","value":780},{"label":"Mai","value":1011},{"label":"Jun","value":792},{"label":"Jul","value":862},{"label":"Ago","value":920},{"label":"Set","value":733},{"label":"Out","value":914},{"label":"Nov","value":657},{"label":"Dez","value":711}];
const MX = 1011;
...
export default function SubConsolPage() {
    return (
