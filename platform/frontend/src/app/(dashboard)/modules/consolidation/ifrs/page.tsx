...
const ACCENT = "#4338ca";
const MODULE = "Financial Consolidation";
const PAGE = "IFRS Reporting";
const KPIS = [{"l":"Total Consolidation","v":"6.930","t":"-2.8%","d":"down"},{"l":"IFRS Reporting Ativos","v":"3.584","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+2.3%","d":"up"}];
const COLS = ["ID","IFRS Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consolidation #001","Consolidation #002","2.382","2.298","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Consolidation #002","Consolidation #003","8.367","8.059","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Consolidation #003","Consolidation #004","2.965","6.461","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Consolidation #004","Consolidation #005","7.698","6.899","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consolidation #005","Consolidation #001","1.850","3.977","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":764},{"label":"Mar","value":774},{"label":"Abr","value":536},{"label":"Mai","value":508},{"label":"Jun","value":826},{"label":"Jul","value":538},{"label":"Ago","value":450},{"label":"Set","value":576},{"label":"Out","value":647},{"label":"Nov","value":506},{"label":"Dez","value":647}];
const MX = 826;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>IFRS</span></h1>
                </div>
