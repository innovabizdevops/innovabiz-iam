...
const PAGE = "Minority Interest";
const KPIS = [{"l":"Total Consolidation","v":"1.156","t":"+15.3%","d":"up"},{"l":"Minority Interest Ativos","v":"3.228","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"86","t":"+12.5%","d":"up"}];
const COLS = ["ID","Minority Interest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consolidation #001","Consolidation #002","939","293","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Consolidation #002","Consolidation #003","3.042","8.628","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Consolidation #003","Consolidation #004","799","1.645","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Consolidation #004","Consolidation #005","120","8.547","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consolidation #005","Consolidation #001","4.290","7.475","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":909},{"label":"Mar","value":767},{"label":"Abr","value":711},{"label":"Mai","value":881},{"label":"Jun","value":921},{"label":"Jul","value":692},{"label":"Ago","value":998},{"label":"Set","value":872},{"label":"Out","value":839},{"label":"Nov","value":754},{"label":"Dez","value":848}];
const MX = 998;
...
export default function MinorityPage() {
    return (
