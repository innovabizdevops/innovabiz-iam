...
const KPIS = [{"l":"Tickets Abertos","v":"3.080","t":"-4.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"75.6%","t":"+7.3%","d":"up"},{"l":"MTTR (h)","v":"131h","t":"+11.3%","d":"up"},{"l":"Satisfação (%)","v":"80.3%","t":"+6.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.837","8.353","4.299","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.821","8.243","8.926","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","254","7.974","1.009","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.010","8.242","6.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.516","6.203","3.942","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":518},{"label":"Mar","value":627},{"label":"Abr","value":394},{"label":"Mai","value":237},{"label":"Jun","value":392},{"label":"Jul","value":398},{"label":"Ago","value":235},{"label":"Set","value":483},{"label":"Out","value":521},{"label":"Nov","value":557},{"label":"Dez","value":445}];
const MX = 627;
