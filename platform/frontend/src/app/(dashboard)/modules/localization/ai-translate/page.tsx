...
const PAGE = "AI Translation";
const KPIS = [{"l":"Tickets Abertos","v":"3.708","t":"+4.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"75.6%","t":"+0.3%","d":"up"},{"l":"MTTR (h)","v":"17h","t":"+2.5%","d":"up"},{"l":"Satisfação (%)","v":"84.9%","t":"+14.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.067","1.809","8.919","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.710","7.370","5.039","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.389","1.323","3.735","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","499","6.877","5.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.999","3.664","3.775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":330},{"label":"Mar","value":386},{"label":"Abr","value":643},{"label":"Mai","value":622},{"label":"Jun","value":456},{"label":"Jul","value":255},{"label":"Ago","value":463},{"label":"Set","value":493},{"label":"Out","value":600},{"label":"Nov","value":272},{"label":"Dez","value":627}];
const MX = 643;
