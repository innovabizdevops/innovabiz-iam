...
const PAGE = "Translation Mgmt";
const KPIS = [{"l":"Tickets Abertos","v":"5.613","t":"-3.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"68.6%","t":"+12.0%","d":"up"},{"l":"MTTR (h)","v":"191h","t":"-5.8%","d":"down"},{"l":"Satisfação (%)","v":"75.6%","t":"+10.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","150","7.645","4.098","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","925","3.387","4.002","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.651","1.613","6.769","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.396","2.826","5.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.070","3.205","7.410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":846},{"label":"Mar","value":577},{"label":"Abr","value":595},{"label":"Mai","value":488},{"label":"Jun","value":528},{"label":"Jul","value":538},{"label":"Ago","value":847},{"label":"Set","value":536},{"label":"Out","value":509},{"label":"Nov","value":845},{"label":"Dez","value":830}];
const MX = 847;
