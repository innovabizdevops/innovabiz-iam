...
const ACCENT = "#a16207";
const MODULE = "Localization & i18n";
const PAGE = "Machine Translation AI";
const KPIS = [{"l":"Tickets Abertos","v":"5.722","t":"+3.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.1%","t":"+16.7%","d":"up"},{"l":"MTTR (h)","v":"17h","t":"+4.0%","d":"up"},{"l":"Satisfação (%)","v":"67.3%","t":"+4.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.345","1.366","2.197","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.334","6.951","5.077","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.737","5.608","6.302","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.493","2.531","5.774","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.423","6.178","932","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":269},{"label":"Mar","value":546},{"label":"Abr","value":375},{"label":"Mai","value":512},{"label":"Jun","value":339},{"label":"Jul","value":298},{"label":"Ago","value":354},{"label":"Set","value":450},{"label":"Out","value":427},{"label":"Nov","value":572},{"label":"Dez","value":426}];
const MX = 572;
...
export default function MtAiPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a16207'}}>AI</span></h1>
                </div>
