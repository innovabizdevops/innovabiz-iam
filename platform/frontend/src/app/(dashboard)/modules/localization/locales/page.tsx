...
const PAGE = "Locale Manager";
const KPIS = [{"l":"Configurações","v":"3.365","t":"+14.7%","d":"up"},{"l":"Últimas Alterações","v":"260","t":"+7.4%","d":"up"},{"l":"Ambientes","v":"7.153","t":"-1.3%","d":"down"},{"l":"Versão Config","v":"8.398","t":"-1.8%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 37444.24","8.073","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 43260.98","5.714","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 23971.52","3.284","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 28946.54","7.268","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 27421.21","557","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":534},{"label":"Mar","value":796},{"label":"Abr","value":664},{"label":"Mai","value":566},{"label":"Jun","value":614},{"label":"Jul","value":698},{"label":"Ago","value":786},{"label":"Set","value":461},{"label":"Out","value":787},{"label":"Nov","value":802},{"label":"Dez","value":643}];
const MX = 802;
