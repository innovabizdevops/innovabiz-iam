...
const PAGE = "Client Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"5.674","t":"+4.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.0%","t":"+1.7%","d":"up"},{"l":"Tempo Médio (h)","v":"127h","t":"+7.5%","d":"up"},{"l":"Rejeitadas (%)","v":"85.7%","t":"+5.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.042","€ 24914.35","5.803","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","1.587","€ 26570.46","5.433","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","5.431","€ 2526.24","6.693","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.107","€ 1310.01","3.256","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","4.987","€ 45639.46","156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":281},{"label":"Mar","value":275},{"label":"Abr","value":531},{"label":"Mai","value":275},{"label":"Jun","value":296},{"label":"Jul","value":289},{"label":"Ago","value":305},{"label":"Set","value":353},{"label":"Out","value":388},{"label":"Nov","value":542},{"label":"Dez","value":532}];
const MX = 542;
