...
const PAGE = "Quality Gate";
const KPIS = [{"l":"Auditorias Realizadas","v":"466","t":"+8.0%","d":"up"},{"l":"NC Abertas","v":"4.980","t":"+12.0%","d":"up"},{"l":"Conformidade (%)","v":"72.2%","t":"-0.1%","d":"down"},{"l":"CAPAs Pendentes","v":"8.875","t":"+12.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.840","93.0%","1.509","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.497","85.0%","3.654","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.497","78.4%","6.539","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.844","74.1%","2.304","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.999","74.9%","7.626","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":753},{"label":"Mar","value":884},{"label":"Abr","value":888},{"label":"Mai","value":757},{"label":"Jun","value":700},{"label":"Jul","value":764},{"label":"Ago","value":821},{"label":"Set","value":663},{"label":"Out","value":940},{"label":"Nov","value":898},{"label":"Dez","value":997}];
const MX = 997;
