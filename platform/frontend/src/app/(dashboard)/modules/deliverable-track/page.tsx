...
export default function DeliverableTrackPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Deliverable Track</h1><p className="text-sm text-muted-foreground">Deliverable Track • iBOS Enterprise</p></div>
