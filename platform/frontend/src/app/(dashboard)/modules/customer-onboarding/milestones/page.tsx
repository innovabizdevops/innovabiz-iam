...
const PAGE = "Milestone Track";
const KPIS = [{"l":"eNPS","v":"57","t":"+14.5%","d":"up"},{"l":"Engagement (%)","v":"65.4%","t":"+14.6%","d":"up"},{"l":"Turnover (%)","v":"72.2%","t":"+4.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.392","t":"-5.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.801","2026-03-23","72","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.911","2026-03-09","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.661","2026-03-11","74","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.068","2026-03-22","90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.962","2026-02-03","78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":722},{"label":"Mar","value":722},{"label":"Abr","value":889},{"label":"Mai","value":757},{"label":"Jun","value":584},{"label":"Jul","value":890},{"label":"Ago","value":808},{"label":"Set","value":602},{"label":"Out","value":923},{"label":"Nov","value":967},{"label":"Dez","value":872}];
const MX = 967;
