...
const KPIS = [{"l":"eNPS","v":"85","t":"+12.6%","d":"up"},{"l":"Engagement (%)","v":"82.6%","t":"+3.0%","d":"up"},{"l":"Turnover (%)","v":"73.3%","t":"+10.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.521","t":"+12.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.669","2026-01-20","74","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.853","2026-02-08","89","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.483","2026-03-19","65","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.326","2026-02-21","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.243","2026-03-01","75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":851},{"label":"Mar","value":670},{"label":"Abr","value":821},{"label":"Mai","value":719},{"label":"Jun","value":609},{"label":"Jul","value":623},{"label":"Ago","value":838},{"label":"Set","value":686},{"label":"Out","value":890},{"label":"Nov","value":911},{"label":"Dez","value":709}];
const MX = 911;
