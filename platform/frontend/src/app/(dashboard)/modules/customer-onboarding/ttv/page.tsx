...
const PAGE = "Time-to-Value";
const KPIS = [{"l":"eNPS","v":"81","t":"+8.6%","d":"up"},{"l":"Engagement (%)","v":"72.9%","t":"-0.9%","d":"down"},{"l":"Turnover (%)","v":"91.7%","t":"+14.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.218","t":"+2.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.408","2026-03-19","76","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","9.082","2026-01-01","64","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.748","2026-01-16","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.810","2026-02-17","90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.167","2026-01-07","63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":939},{"label":"Mar","value":719},{"label":"Abr","value":623},{"label":"Mai","value":608},{"label":"Jun","value":895},{"label":"Jul","value":657},{"label":"Ago","value":750},{"label":"Set","value":656},{"label":"Out","value":572},{"label":"Nov","value":748},{"label":"Dez","value":852}];
const MX = 939;
