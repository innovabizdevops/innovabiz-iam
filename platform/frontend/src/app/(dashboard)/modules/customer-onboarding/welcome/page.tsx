...
const ACCENT = "#475569";
const MODULE = "Customer Onboarding";
const PAGE = "Welcome Flow";
const KPIS = [{"l":"eNPS","v":"79","t":"+2.7%","d":"up"},{"l":"Engagement (%)","v":"83.3%","t":"+9.1%","d":"up"},{"l":"Turnover (%)","v":"67.6%","t":"+16.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.526","t":"+13.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.820","2026-03-17","78","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.506","2026-01-28","94","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.164","2026-03-17","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.830","2026-03-17","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.260","2026-02-09","76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1011},{"label":"Fev","value":817},{"label":"Mar","value":649},{"label":"Abr","value":960},{"label":"Mai","value":1034},{"label":"Jun","value":690},{"label":"Jul","value":900},{"label":"Ago","value":829},{"label":"Set","value":709},{"label":"Out","value":1028},{"label":"Nov","value":787},{"label":"Dez","value":886}];
const MX = 1034;
