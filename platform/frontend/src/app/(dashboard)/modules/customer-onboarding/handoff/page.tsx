...
const PAGE = "Handoff Rules";
const KPIS = [{"l":"eNPS","v":"85","t":"+8.3%","d":"up"},{"l":"Engagement (%)","v":"84.2%","t":"+11.9%","d":"up"},{"l":"Turnover (%)","v":"90.7%","t":"+18.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.634","t":"+0.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.301","2026-02-23","77","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.292","2026-01-13","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.228","2026-03-18","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.714","2026-01-21","76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.685","2026-02-11","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":690},{"label":"Mar","value":786},{"label":"Abr","value":899},{"label":"Mai","value":817},{"label":"Jun","value":806},{"label":"Jul","value":833},{"label":"Ago","value":900},{"label":"Set","value":721},{"label":"Out","value":822},{"label":"Nov","value":644},{"label":"Dez","value":798}];
const MX = 900;
