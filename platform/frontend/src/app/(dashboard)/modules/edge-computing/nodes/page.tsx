...
const PAGE = "Node Deploy";
const KPIS = [{"l":"Total Edge Computing","v":"458","t":"+7.6%","d":"up"},{"l":"Node Deploy Ativos","v":"6.735","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"68.2%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"80","t":"+14.4%","d":"up"}];
const COLS = ["ID","Node Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge Computing #001","Edge Computing #002","4.343","7.084","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Edge Computing #002","Edge Computing #003","6.366","5.998","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge Computing #003","Edge Computing #004","8.566","1.190","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Edge Computing #004","Edge Computing #005","597","2.597","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge Computing #005","Edge Computing #001","5.532","3.935","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":953},{"label":"Mar","value":1052},{"label":"Abr","value":764},{"label":"Mai","value":949},{"label":"Jun","value":787},{"label":"Jul","value":1029},{"label":"Ago","value":696},{"label":"Set","value":957},{"label":"Out","value":750},{"label":"Nov","value":735},{"label":"Dez","value":1052}];
const MX = 1052;
