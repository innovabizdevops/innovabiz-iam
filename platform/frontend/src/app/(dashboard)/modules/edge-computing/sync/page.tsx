...
const PAGE = "Sync Policy";
const KPIS = [{"l":"Integrações Ativas","v":"6.934","t":"+8.0%","d":"up"},{"l":"Chamadas/Hora","v":"1494","t":"+11.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.2%","t":"+5.7%","d":"up"},{"l":"Latência Média (ms)","v":"77ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","111","4.415","92.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.290","4.774","98.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.976","7.871","99.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.775","1.317","96.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.730","2.395","82.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":815},{"label":"Mar","value":627},{"label":"Abr","value":747},{"label":"Mai","value":815},{"label":"Jun","value":599},{"label":"Jul","value":637},{"label":"Ago","value":845},{"label":"Set","value":933},{"label":"Out","value":879},{"label":"Nov","value":861},{"label":"Dez","value":952}];
const MX = 952;
