...
const KPIS = [{"l":"Total Edge Computing","v":"7.000","t":"-0.8%","d":"down"},{"l":"Offline Mode Ativos","v":"8.205","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"89.9%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"92","t":"+9.7%","d":"up"}];
const COLS = ["ID","Offline Mode","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge Computing #001","Edge Computing #002","4.819","7.555","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Edge Computing #002","Edge Computing #003","8.886","3.390","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge Computing #003","Edge Computing #004","1.222","370","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Edge Computing #004","Edge Computing #005","6.817","6.241","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge Computing #005","Edge Computing #001","6.613","1.969","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":583},{"label":"Mar","value":488},{"label":"Abr","value":611},{"label":"Mai","value":528},{"label":"Jun","value":494},{"label":"Jul","value":416},{"label":"Ago","value":455},{"label":"Set","value":304},{"label":"Out","value":274},{"label":"Nov","value":404},{"label":"Dez","value":271}];
const MX = 611;
