...
const ACCENT = "#1e40af";
const MODULE = "Environment Management";
const PAGE = "Decommission";
const KPIS = [{"l":"Vendas YTD (€)","v":"€3101","t":"+5.4%","d":"up"},{"l":"Pipeline (€)","v":"€10608","t":"+15.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"68.7%","t":"+8.0%","d":"up"},{"l":"Win Rate (%)","v":"80.3%","t":"+14.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 49442.17","€ 10281.05","€ 40851.19","85.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 8946.74","€ 38090.29","€ 2726.51","82.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22974.89","€ 7886.00","€ 44625.90","91.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 1572.22","€ 16099.57","€ 6407.05","85.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 45954.95","€ 16434.64","€ 2861.40","79.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":441},{"label":"Mar","value":378},{"label":"Abr","value":319},{"label":"Mai","value":449},{"label":"Jun","value":600},{"label":"Jul","value":418},{"label":"Ago","value":500},{"label":"Set","value":328},{"label":"Out","value":415},{"label":"Nov","value":360},{"label":"Dez","value":278}];
const MX = 600;
