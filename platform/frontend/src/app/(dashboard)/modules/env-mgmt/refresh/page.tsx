...
const PAGE = "Refresh";
const KPIS = [{"l":"Total Env Mgmt","v":"5.582","t":"+9.7%","d":"up"},{"l":"Refresh Ativos","v":"1.920","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"69","t":"-1.8%","d":"down"}];
const COLS = ["ID","Refresh","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Mgmt #001","Env Mgmt #002","2.358","5.838","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Env Mgmt #002","Env Mgmt #003","1.867","3.395","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Mgmt #003","Env Mgmt #004","1.944","6.191","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Env Mgmt #004","Env Mgmt #005","8.680","4.571","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Mgmt #005","Env Mgmt #001","6.201","4.918","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":847},{"label":"Mar","value":820},{"label":"Abr","value":730},{"label":"Mai","value":829},{"label":"Jun","value":761},{"label":"Jul","value":555},{"label":"Ago","value":801},{"label":"Set","value":602},{"label":"Out","value":538},{"label":"Nov","value":687},{"label":"Dez","value":791}];
const MX = 847;
