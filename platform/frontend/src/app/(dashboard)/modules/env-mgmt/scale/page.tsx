...
const PAGE = "Scale";
const KPIS = [{"l":"Total Env Mgmt","v":"3.508","t":"+0.9%","d":"up"},{"l":"Scale Ativos","v":"3.964","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"66.3%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"62","t":"-3.0%","d":"down"}];
const COLS = ["ID","Scale","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Mgmt #001","Env Mgmt #002","9.076","5.877","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Env Mgmt #002","Env Mgmt #003","6.494","8.030","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Mgmt #003","Env Mgmt #004","5.026","6.919","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Env Mgmt #004","Env Mgmt #005","4.750","1.446","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Mgmt #005","Env Mgmt #001","4.040","6.647","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":424},{"label":"Mar","value":744},{"label":"Abr","value":387},{"label":"Mai","value":661},{"label":"Jun","value":558},{"label":"Jul","value":595},{"label":"Ago","value":487},{"label":"Set","value":603},{"label":"Out","value":774},{"label":"Nov","value":610},{"label":"Dez","value":572}];
const MX = 774;
