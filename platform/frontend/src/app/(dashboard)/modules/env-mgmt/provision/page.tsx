...
const KPIS = [{"l":"Total Env Mgmt","v":"4.997","t":"+8.5%","d":"up"},{"l":"Provision Ativos","v":"5.037","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"85","t":"+10.9%","d":"up"}];
const COLS = ["ID","Provision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Mgmt #001","Env Mgmt #002","6.724","6.837","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Env Mgmt #002","Env Mgmt #003","3.873","969","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Mgmt #003","Env Mgmt #004","1.062","2.407","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Env Mgmt #004","Env Mgmt #005","7.211","7.183","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Mgmt #005","Env Mgmt #001","1.524","7.063","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":635},{"label":"Mar","value":651},{"label":"Abr","value":547},{"label":"Mai","value":657},{"label":"Jun","value":433},{"label":"Jul","value":666},{"label":"Ago","value":817},{"label":"Set","value":602},{"label":"Out","value":442},{"label":"Nov","value":573},{"label":"Dez","value":683}];
const MX = 817;
