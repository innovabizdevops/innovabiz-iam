...
const KPIS = [
    { label: "Total Registos", value: "256", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "591", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€448K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "95050056", cells: ["ENV-2056", "Environment Management Item 1", "25/1/2026", "€156"], status: "active" as const },
    { id: "95053627", cells: ["ENV-5627", "Environment Management Item 2", "12/8/2026", "€3727"], status: "pending" as const },
    { id: "95057198", cells: ["ENV-9198", "Environment Management Item 3", "27/3/2026", "€7298"], status: "completed" as const },
    { id: "95060769", cells: ["ENV-3769", "Environment Management Item 4", "14/10/2026", "€10 869"], status: "warning" as const },
    { id: "95064340", cells: ["ENV-7340", "Environment Management Item 5", "1/5/2026", "€14 440"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Environment Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Environment Management</p>
                    </div>
                </div>
