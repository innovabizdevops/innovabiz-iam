...
const PAGE = "Config";
const KPIS = [{"l":"Configurações","v":"8.468","t":"+1.7%","d":"up"},{"l":"Últimas Alterações","v":"5.487","t":"+16.5%","d":"up"},{"l":"Ambientes","v":"2.061","t":"+2.9%","d":"up"},{"l":"Versão Config","v":"412","t":"+2.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 49405.88","1.722","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 26530.83","4.834","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 12478.59","6.463","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 505.06","4.535","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 6967.57","3.805","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":645},{"label":"Mar","value":998},{"label":"Abr","value":744},{"label":"Mai","value":957},{"label":"Jun","value":707},{"label":"Jul","value":913},{"label":"Ago","value":939},{"label":"Set","value":753},{"label":"Out","value":793},{"label":"Nov","value":714},{"label":"Dez","value":990}];
const MX = 998;
