...
const PAGE = "Medical App";
const KPIS = [{"l":"Integrações Ativas","v":"2.290","t":"+10.9%","d":"up"},{"l":"Chamadas/Hora","v":"1550","t":"-2.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"85.5%","t":"+14.4%","d":"up"},{"l":"Latência Média (ms)","v":"114ms","t":"-5.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.452","7.341","84.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.202","5.374","91.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.473","7.174","83.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.571","4.712","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.880","1.958","96.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":773},{"label":"Mar","value":894},{"label":"Abr","value":731},{"label":"Mai","value":847},{"label":"Jun","value":935},{"label":"Jul","value":832},{"label":"Ago","value":652},{"label":"Set","value":924},{"label":"Out","value":1013},{"label":"Nov","value":725},{"label":"Dez","value":770}];
const MX = 1013;
