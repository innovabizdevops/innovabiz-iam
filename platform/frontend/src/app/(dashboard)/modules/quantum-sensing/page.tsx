...
export default function QuantumSensingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Quantum Sensing</h1><p className="text-sm text-muted-foreground">Quantum Sensing • iBOS Enterprise</p></div>
