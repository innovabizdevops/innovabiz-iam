...
const ACCENT = "#059669";
const MODULE = "Quantum Sensing";
const PAGE = "Clock Sync";
const KPIS = [{"l":"Integrações Ativas","v":"6.129","t":"+9.1%","d":"up"},{"l":"Chamadas/Hora","v":"1923","t":"-3.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.1%","t":"+4.1%","d":"up"},{"l":"Latência Média (ms)","v":"143ms","t":"+11.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.035","1.724","79.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.700","3.587","87.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.518","7.479","74.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.340","6.705","93.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.599","5.639","71.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":610},{"label":"Mar","value":814},{"label":"Abr","value":638},{"label":"Mai","value":833},{"label":"Jun","value":638},{"label":"Jul","value":928},{"label":"Ago","value":749},{"label":"Set","value":889},{"label":"Out","value":795},{"label":"Nov","value":907},{"label":"Dez","value":924}];
const MX = 962;
