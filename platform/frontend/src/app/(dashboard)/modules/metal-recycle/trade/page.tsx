...
const ACCENT = "#065f46";
const MODULE = "Metal Recycling";
const PAGE = "Trade";
const KPIS = [{"l":"Total Metal Recycle","v":"3.310","t":"+2.4%","d":"up"},{"l":"Trade Ativos","v":"6.665","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"79","t":"-2.6%","d":"down"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Metal Recycle #001","Metal Recycle #002","6.026","4.705","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Metal Recycle #002","Metal Recycle #003","5.698","6.195","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Metal Recycle #003","Metal Recycle #004","7.791","2.320","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Metal Recycle #004","Metal Recycle #005","7.616","2.503","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Metal Recycle #005","Metal Recycle #001","3.107","4.204","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":678},{"label":"Mar","value":603},{"label":"Abr","value":825},{"label":"Mai","value":736},{"label":"Jun","value":643},{"label":"Jul","value":843},{"label":"Ago","value":918},{"label":"Set","value":827},{"label":"Out","value":622},{"label":"Nov","value":570},{"label":"Dez","value":656}];
const MX = 918;
