...
const KPIS = [
    ...
    { label: "Receita Mensal", value: "€146K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1151720052", cells: ["MET-9052", "Metal Recycling Item 1", "1/1/2026", "€20 152"], status: "active" as const },
    { id: "1151723623", cells: ["MET-3623", "Metal Recycling Item 2", "16/8/2026", "€23 723"], status: "pending" as const },
    { id: "1151727194", cells: ["MET-7194", "Metal Recycling Item 3", "3/3/2026", "€27 294"], status: "completed" as const },
    { id: "1151730765", cells: ["MET-1765", "Metal Recycling Item 4", "18/10/2026", "€30 865"], status: "warning" as const },
    { id: "1151734336", cells: ["MET-5336", "Metal Recycling Item 5", "5/5/2026", "€34 436"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metal Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Metal Recycling</p>
                    </div>
                </div>
