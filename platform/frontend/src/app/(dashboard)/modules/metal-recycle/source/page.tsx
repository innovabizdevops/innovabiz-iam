...
const PAGE = "Source";
const KPIS = [{"l":"Total Metal Recycle","v":"6.116","t":"+4.1%","d":"up"},{"l":"Source Ativos","v":"1.663","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"84.5%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"82","t":"+12.0%","d":"up"}];
const COLS = ["ID","Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Metal Recycle #001","Metal Recycle #002","1.045","5.331","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Metal Recycle #002","Metal Recycle #003","4.350","6.939","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Metal Recycle #003","Metal Recycle #004","1.592","1.131","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Metal Recycle #004","Metal Recycle #005","8.681","7.617","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Metal Recycle #005","Metal Recycle #001","2.735","1.600","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":463},{"label":"Mar","value":528},{"label":"Abr","value":582},{"label":"Mai","value":728},{"label":"Jun","value":745},{"label":"Jul","value":738},{"label":"Ago","value":492},{"label":"Set","value":547},{"label":"Out","value":798},{"label":"Nov","value":751},{"label":"Dez","value":758}];
const MX = 798;
