...
const ACCENT = "#059669";
const MODULE = "A/B Testing Platform Deep";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.390","t":"-2.0%","d":"down"},{"l":"Submissões/Dia","v":"960","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"2.419","t":"-4.3%","d":"down"},{"l":"Templates","v":"5.182","t":"+9.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","288","2026-02-05","4.142","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.152","2026-03-22","2.118","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.837","2026-03-08","5.657","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.018","2026-02-07","5.155","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.585","2026-03-20","6.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":840},{"label":"Mar","value":790},{"label":"Abr","value":882},{"label":"Mai","value":733},{"label":"Jun","value":750},{"label":"Jul","value":658},{"label":"Ago","value":1017},{"label":"Set","value":1005},{"label":"Out","value":804},{"label":"Nov","value":739},{"label":"Dez","value":820}];
const MX = 1017;
