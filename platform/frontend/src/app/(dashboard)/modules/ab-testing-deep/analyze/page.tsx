...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"491","t":"+12.5%","d":"up"},{"l":"Queries/Dia","v":"3527","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.717","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"6.024","t":"+2.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1006","2026-02-26","5.912","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2454","2026-02-26","5.899","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3603","2026-01-03","8.498","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2209","2026-02-16","5.871","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4725","2026-03-10","946","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":302},{"label":"Mar","value":300},{"label":"Abr","value":248},{"label":"Mai","value":502},{"label":"Jun","value":349},{"label":"Jul","value":512},{"label":"Ago","value":594},{"label":"Set","value":472},{"label":"Out","value":634},{"label":"Nov","value":425},{"label":"Dez","value":598}];
const MX = 634;
