...
/* ═══ A/B Testing Platform Deep — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8316", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1690", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€54K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1189780316", cells: ["AB-8316", "A/B Testing Platform Deep Item 1", "5/9/2026", "€30 416"], status: "active" as const },
    { id: "1189783887", cells: ["AB-2887", "A/B Testing Platform Deep Item 2", "20/4/2026", "€33 987"], status: "pending" as const },
    { id: "1189787458", cells: ["AB-6458", "A/B Testing Platform Deep Item 3", "7/11/2026", "€37 558"], status: "completed" as const },
    { id: "1189791029", cells: ["AB-1029", "A/B Testing Platform Deep Item 4", "22/6/2026", "€41 129"], status: "warning" as const },
    { id: "1189794600", cells: ["AB-4600", "A/B Testing Platform Deep Item 5", "9/1/2026", "€44 700"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 96 }, { label: "Fev", value: 25 }, { label: "Mar", value: 34 }, { label: "Abr", value: 43 }, { label: "Mai", value: 52 }, { label: "Jun", value: 61 }];
...
export default function AbTestingPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">A/B Testing Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • A/B Testing Platform Deep</p>
                    </div>
                </div>
