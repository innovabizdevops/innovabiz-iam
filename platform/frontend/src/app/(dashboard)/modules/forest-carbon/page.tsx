...
export default function ForestCarbonPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Forest Carbon</h1><p className="text-sm text-muted-foreground">Forest Carbon • iBOS Enterprise</p></div>
