...
const PAGE = "Credit Trade";
const KPIS = [{"l":"Integrações Ativas","v":"941","t":"+0.7%","d":"up"},{"l":"Chamadas/Hora","v":"3919","t":"+10.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.7%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"117ms","t":"+17.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.416","1.866","86.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.101","1.552","77.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","9.070","3.315","75.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.886","2.004","80.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.067","4.395","84.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":590},{"label":"Mar","value":798},{"label":"Abr","value":516},{"label":"Mai","value":827},{"label":"Jun","value":888},{"label":"Jul","value":570},{"label":"Ago","value":525},{"label":"Set","value":546},{"label":"Out","value":691},{"label":"Nov","value":852},{"label":"Dez","value":686}];
const MX = 888;
