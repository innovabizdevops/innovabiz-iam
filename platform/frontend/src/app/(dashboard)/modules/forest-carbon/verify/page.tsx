...
const KPIS = [{"l":"Total Forest Carbon","v":"1.426","t":"+11.3%","d":"up"},{"l":"Verification Ativos","v":"4.488","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"74.7%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+2.5%","d":"up"}];
const COLS = ["ID","Verification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Carbon #001","Forest Carbon #002","2.605","1.821","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Carbon #002","Forest Carbon #003","2.973","8.085","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Carbon #003","Forest Carbon #004","5.914","6.464","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Carbon #004","Forest Carbon #005","7.408","5.672","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Carbon #005","Forest Carbon #001","5.849","6.891","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":456},{"label":"Mar","value":671},{"label":"Abr","value":323},{"label":"Mai","value":508},{"label":"Jun","value":354},{"label":"Jul","value":589},{"label":"Ago","value":530},{"label":"Set","value":554},{"label":"Out","value":446},{"label":"Nov","value":500},{"label":"Dez","value":339}];
const MX = 671;
