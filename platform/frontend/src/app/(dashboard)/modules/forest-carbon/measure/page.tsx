...
const KPIS = [{"l":"Total Forest Carbon","v":"8.798","t":"+9.7%","d":"up"},{"l":"Measurement Ativos","v":"2.153","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"75","t":"-1.8%","d":"down"}];
const COLS = ["ID","Measurement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Carbon #001","Forest Carbon #002","7.069","6.021","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Carbon #002","Forest Carbon #003","2.664","3.564","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Carbon #003","Forest Carbon #004","6.459","6.601","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Carbon #004","Forest Carbon #005","8.987","2.918","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Carbon #005","Forest Carbon #001","5.012","8.030","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":689},{"label":"Mar","value":556},{"label":"Abr","value":603},{"label":"Mai","value":470},{"label":"Jun","value":586},{"label":"Jul","value":692},{"label":"Ago","value":579},{"label":"Set","value":757},{"label":"Out","value":556},{"label":"Nov","value":741},{"label":"Dez","value":432}];
const MX = 757;
