...
const ACCENT = "#059669";
const MODULE = "Forest Carbon Offset";
const PAGE = "Monitoring";
const KPIS = [{"l":"Total Forest Carbon","v":"3.198","t":"+9.1%","d":"up"},{"l":"Monitoring Ativos","v":"4.195","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"83","t":"+10.2%","d":"up"}];
const COLS = ["ID","Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Carbon #001","Forest Carbon #002","7.132","672","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Carbon #002","Forest Carbon #003","4.578","1.378","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Carbon #003","Forest Carbon #004","5.284","7.738","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Carbon #004","Forest Carbon #005","870","5.178","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Carbon #005","Forest Carbon #001","7.639","356","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":774},{"label":"Mar","value":763},{"label":"Abr","value":624},{"label":"Mai","value":801},{"label":"Jun","value":739},{"label":"Jul","value":835},{"label":"Ago","value":537},{"label":"Set","value":759},{"label":"Out","value":886},{"label":"Nov","value":721},{"label":"Dez","value":504}];
const MX = 886;
