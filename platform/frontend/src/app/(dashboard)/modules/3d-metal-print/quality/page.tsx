...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.309","t":"+11.9%","d":"up"},{"l":"NC Abertas","v":"3.851","t":"+7.4%","d":"up"},{"l":"Conformidade (%)","v":"74.4%","t":"-0.5%","d":"down"},{"l":"CAPAs Pendentes","v":"181","t":"+0.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.874","95.6%","2.965","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.902","89.5%","824","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.122","85.7%","3.598","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.061","74.5%","2.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.008","76.3%","2.818","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":729},{"label":"Mar","value":566},{"label":"Abr","value":851},{"label":"Mai","value":702},{"label":"Jun","value":688},{"label":"Jul","value":647},{"label":"Ago","value":701},{"label":"Set","value":655},{"label":"Out","value":609},{"label":"Nov","value":785},{"label":"Dez","value":887}];
const MX = 887;
