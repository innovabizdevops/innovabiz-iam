...
const ACCENT = "#4338ca";
const MODULE = "Metal 3D Printing";
const PAGE = "DMLS";
const KPIS = [{"l":"Total 3d Metal Print","v":"679","t":"-1.5%","d":"down"},{"l":"DMLS Ativos","v":"312","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"76","t":"-4.0%","d":"down"}];
const COLS = ["ID","DMLS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Metal Print #001","3d Metal Print #002","8.652","8.348","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["3d Metal Print #002","3d Metal Print #003","2.401","5.059","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Metal Print #003","3d Metal Print #004","2.131","5.667","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["3d Metal Print #004","3d Metal Print #005","4.050","3.396","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Metal Print #005","3d Metal Print #001","564","460","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":475},{"label":"Mar","value":623},{"label":"Abr","value":428},{"label":"Mai","value":477},{"label":"Jun","value":498},{"label":"Jul","value":587},{"label":"Ago","value":436},{"label":"Set","value":775},{"label":"Out","value":678},{"label":"Nov","value":455},{"label":"Dez","value":631}];
const MX = 775;
...
export default function DmlsPage() {
    return (
