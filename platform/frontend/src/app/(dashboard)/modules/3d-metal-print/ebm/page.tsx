...
const PAGE = "EBM";
const KPIS = [{"l":"Total 3d Metal Print","v":"8.421","t":"+9.0%","d":"up"},{"l":"EBM Ativos","v":"4.541","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"67.9%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"88","t":"-3.9%","d":"down"}];
const COLS = ["ID","EBM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Metal Print #001","3d Metal Print #002","4.178","8.375","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["3d Metal Print #002","3d Metal Print #003","5.161","5.038","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Metal Print #003","3d Metal Print #004","4.278","7.517","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["3d Metal Print #004","3d Metal Print #005","5.595","6.884","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Metal Print #005","3d Metal Print #001","3.478","6.925","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":703},{"label":"Mar","value":640},{"label":"Abr","value":804},{"label":"Mai","value":574},{"label":"Jun","value":481},{"label":"Jul","value":725},{"label":"Ago","value":606},{"label":"Set","value":426},{"label":"Out","value":474},{"label":"Nov","value":468},{"label":"Dez","value":578}];
const MX = 804;
