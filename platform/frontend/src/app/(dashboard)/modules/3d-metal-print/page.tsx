...
/* ═══ Metal 3D Printing — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "3126", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4977", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€246K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1739601326", cells: ["3D-1326", "Metal 3D Printing Item 1", "23/3/2026", "€1426"], status: "active" as const },
    { id: "1739604897", cells: ["3D-4897", "Metal 3D Printing Item 2", "10/10/2026", "€4997"], status: "pending" as const },
    { id: "1739608468", cells: ["3D-8468", "Metal 3D Printing Item 3", "25/5/2026", "€8568"], status: "completed" as const },
    { id: "1739612039", cells: ["3D-3039", "Metal 3D Printing Item 4", "12/12/2026", "€12 139"], status: "warning" as const },
    { id: "1739615610", cells: ["3D-6610", "Metal 3D Printing Item 5", "27/7/2026", "€15 710"], status: "active" as const },
];
...
export default function Metal3dPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metal 3D Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Metal 3D Printing</p>
                    </div>
                </div>
