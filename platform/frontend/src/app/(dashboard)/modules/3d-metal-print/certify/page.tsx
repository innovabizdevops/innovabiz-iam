...
const PAGE = "Certify";
const KPIS = [{"l":"Total 3d Metal Print","v":"7.100","t":"+5.2%","d":"up"},{"l":"Certify Ativos","v":"4.700","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"70","t":"+6.8%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Metal Print #001","3d Metal Print #002","7.497","955","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["3d Metal Print #002","3d Metal Print #003","3.422","1.100","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Metal Print #003","3d Metal Print #004","249","614","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["3d Metal Print #004","3d Metal Print #005","2.383","7.350","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Metal Print #005","3d Metal Print #001","3.392","1.134","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":331},{"label":"Mar","value":604},{"label":"Abr","value":472},{"label":"Mai","value":585},{"label":"Jun","value":489},{"label":"Jul","value":467},{"label":"Ago","value":696},{"label":"Set","value":702},{"label":"Out","value":500},{"label":"Nov","value":346},{"label":"Dez","value":434}];
const MX = 702;
