...
/* ═══ Cognitive Health Monitor — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "8098", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2659", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€354K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "668634198", cells: ["COG-7198", "Cognitive Health Monitor Item 1", "23/7/2026", "€34 298"], status: "active" as const },
    { id: "668637769", cells: ["COG-1769", "Cognitive Health Monitor Item 2", "10/2/2026", "€37 869"], status: "pending" as const },
    { id: "668641340", cells: ["COG-5340", "Cognitive Health Monitor Item 3", "25/9/2026", "€41 440"], status: "completed" as const },
    { id: "668644911", cells: ["COG-8911", "Cognitive Health Monitor Item 4", "12/4/2026", "€45 011"], status: "warning" as const },
    { id: "668648482", cells: ["COG-3482", "Cognitive Health Monitor Item 5", "27/11/2026", "€48 582"], status: "active" as const },
];
...
export default function CognitiveHealthMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Health Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Health Monitor</p>
                    </div>
                </div>
