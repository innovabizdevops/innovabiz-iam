...
const ACCENT = "#312e81";
const MODULE = "Cognitive Health Monitor";
const PAGE = "Layer Health";
const KPIS = [{"l":"Total Cognitive Health","v":"1.228","t":"+14.3%","d":"up"},{"l":"Layer Health Ativos","v":"1.646","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"69","t":"-3.0%","d":"down"}];
const COLS = ["ID","Layer Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cognitive Health #001","Cognitive Health #002","262","1.968","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cognitive Health #002","Cognitive Health #003","6.247","4.216","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Cognitive Health #003","Cognitive Health #004","8.395","5.022","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Cognitive Health #004","Cognitive Health #005","8.775","5.973","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cognitive Health #005","Cognitive Health #001","7.666","7.792","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":934},{"label":"Mar","value":994},{"label":"Abr","value":682},{"label":"Mai","value":742},{"label":"Jun","value":757},{"label":"Jul","value":727},{"label":"Ago","value":969},{"label":"Set","value":720},{"label":"Out","value":802},{"label":"Nov","value":679},{"label":"Dez","value":973}];
const MX = 994;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#312e81'}}>RTM</span></h1>
                </div>
