...
const PAGE = "Evolve";
const KPIS = [{"l":"Total Cognitive Health","v":"3.280","t":"+0.7%","d":"up"},{"l":"Evolve Ativos","v":"6.285","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"66","t":"+3.4%","d":"up"}];
const COLS = ["ID","Evolve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cognitive Health #001","Cognitive Health #002","4.352","2.090","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Cognitive Health #002","Cognitive Health #003","3.894","1.041","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Cognitive Health #003","Cognitive Health #004","1.070","2.223","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Cognitive Health #004","Cognitive Health #005","3.723","1.803","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cognitive Health #005","Cognitive Health #001","1.717","3.420","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1002},{"label":"Fev","value":835},{"label":"Mar","value":670},{"label":"Abr","value":750},{"label":"Mai","value":703},{"label":"Jun","value":980},{"label":"Jul","value":756},{"label":"Ago","value":842},{"label":"Set","value":802},{"label":"Out","value":845},{"label":"Nov","value":1006},{"label":"Dez","value":875}];
const MX = 1006;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#312e81'}}>EVO</span></h1>
                </div>
