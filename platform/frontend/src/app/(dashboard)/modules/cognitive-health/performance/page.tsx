...
const KPIS = [{"l":"Formulários Ativos","v":"3.280","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"1546","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"6.816","t":"+9.7%","d":"up"},{"l":"Templates","v":"5.182","t":"+7.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","470","2026-03-16","1.344","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.825","2026-03-15","6.388","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.394","2026-01-25","9.087","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.261","2026-02-19","7.761","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.755","2026-02-13","8.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":956},{"label":"Mar","value":590},{"label":"Abr","value":787},{"label":"Mai","value":687},{"label":"Jun","value":869},{"label":"Jul","value":886},{"label":"Ago","value":593},{"label":"Set","value":699},{"label":"Out","value":978},{"label":"Nov","value":702},{"label":"Dez","value":633}];
const MX = 978;
