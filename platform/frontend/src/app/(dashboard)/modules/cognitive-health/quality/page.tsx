...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.139","t":"-4.4%","d":"down"},{"l":"NC Abertas","v":"8.290","t":"-1.7%","d":"down"},{"l":"Conformidade (%)","v":"91.7%","t":"+5.8%","d":"up"},{"l":"CAPAs Pendentes","v":"5.500","t":"+5.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.732","88.3%","5.209","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.407","86.7%","396","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.618","91.0%","3.857","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.247","84.6%","6.859","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.934","89.9%","8.284","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":803},{"label":"Mar","value":492},{"label":"Abr","value":690},{"label":"Mai","value":816},{"label":"Jun","value":487},{"label":"Jul","value":713},{"label":"Ago","value":738},{"label":"Set","value":628},{"label":"Out","value":684},{"label":"Nov","value":798},{"label":"Dez","value":581}];
const MX = 816;
