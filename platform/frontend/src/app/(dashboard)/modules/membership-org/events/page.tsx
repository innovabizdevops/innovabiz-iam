...
const PAGE = "Event Mgmt";
const KPIS = [{"l":"Total Membership Org","v":"3.199","t":"+10.1%","d":"up"},{"l":"Event Mgmt Ativos","v":"3.111","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"81.4%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"88","t":"+3.2%","d":"up"}];
const COLS = ["ID","Event Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Membership Org #001","Membership Org #002","8.762","2.838","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Membership Org #002","Membership Org #003","7.251","4.646","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Membership Org #003","Membership Org #004","6.214","1.695","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Membership Org #004","Membership Org #005","7.478","4.172","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Membership Org #005","Membership Org #001","3.803","3.935","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":582},{"label":"Mar","value":396},{"label":"Abr","value":733},{"label":"Mai","value":501},{"label":"Jun","value":712},{"label":"Jul","value":692},{"label":"Ago","value":592},{"label":"Set","value":447},{"label":"Out","value":412},{"label":"Nov","value":347},{"label":"Dez","value":468}];
const MX = 733;
