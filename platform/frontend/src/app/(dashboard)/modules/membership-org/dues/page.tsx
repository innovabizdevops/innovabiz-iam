...
const ACCENT = "#78350f";
const MODULE = "Membership Organization";
const PAGE = "Dues Billing";
const KPIS = [{"l":"Total Membership Org","v":"1.245","t":"+17.5%","d":"up"},{"l":"Dues Billing Ativos","v":"3.726","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"65","t":"+7.6%","d":"up"}];
const COLS = ["ID","Dues Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Membership Org #001","Membership Org #002","3.397","4.848","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Membership Org #002","Membership Org #003","1.501","5.159","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Membership Org #003","Membership Org #004","5.664","1.328","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Membership Org #004","Membership Org #005","2.704","4.740","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Membership Org #005","Membership Org #001","6.180","1.832","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":674},{"label":"Mar","value":858},{"label":"Abr","value":675},{"label":"Mai","value":689},{"label":"Jun","value":842},{"label":"Jul","value":781},{"label":"Ago","value":814},{"label":"Set","value":763},{"label":"Out","value":820},{"label":"Nov","value":664},{"label":"Dez","value":665}];
const MX = 894;
