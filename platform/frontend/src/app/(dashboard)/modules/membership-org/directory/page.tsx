...
const PAGE = "Member Dir";
const KPIS = [{"l":"Total Membership Org","v":"7.245","t":"+8.5%","d":"up"},{"l":"Member Dir Ativos","v":"1.838","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"75","t":"+0.5%","d":"up"}];
const COLS = ["ID","Member Dir","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Membership Org #001","Membership Org #002","991","5.735","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Membership Org #002","Membership Org #003","1.335","4.222","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Membership Org #003","Membership Org #004","7.947","5.155","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Membership Org #004","Membership Org #005","3.086","3.474","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Membership Org #005","Membership Org #001","405","3.758","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":214},{"label":"Mar","value":298},{"label":"Abr","value":546},{"label":"Mai","value":402},{"label":"Jun","value":481},{"label":"Jul","value":461},{"label":"Ago","value":470},{"label":"Set","value":492},{"label":"Out","value":557},{"label":"Nov","value":436},{"label":"Dez","value":397}];
const MX = 557;
