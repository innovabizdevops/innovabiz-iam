...
const KPIS = [{"l":"Total Membership Org","v":"367","t":"+3.4%","d":"up"},{"l":"Directory Ativos","v":"3.430","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"91.6%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"75","t":"+3.1%","d":"up"}];
const COLS = ["ID","Directory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Membership Org #001","Membership Org #002","4.558","8.892","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Membership Org #002","Membership Org #003","3.051","8.073","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Membership Org #003","Membership Org #004","6.632","4.367","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Membership Org #004","Membership Org #005","8.328","6.775","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Membership Org #005","Membership Org #001","2.530","4.232","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":650},{"label":"Mar","value":751},{"label":"Abr","value":876},{"label":"Mai","value":791},{"label":"Jun","value":910},{"label":"Jul","value":761},{"label":"Ago","value":602},{"label":"Set","value":875},{"label":"Out","value":561},{"label":"Nov","value":566},{"label":"Dez","value":670}];
const MX = 910;
