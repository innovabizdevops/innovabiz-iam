...
const KPIS = [{"l":"Total Membership Org","v":"1.338","t":"-4.1%","d":"down"},{"l":"Committee Ativos","v":"7.124","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"62","t":"-1.7%","d":"down"}];
const COLS = ["ID","Committee","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Membership Org #001","Membership Org #002","4.076","6.838","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Membership Org #002","Membership Org #003","8.752","1.103","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Membership Org #003","Membership Org #004","2.509","6.958","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Membership Org #004","Membership Org #005","8.024","5.429","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Membership Org #005","Membership Org #001","2.656","3.858","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":427},{"label":"Mar","value":423},{"label":"Abr","value":288},{"label":"Mai","value":548},{"label":"Jun","value":300},{"label":"Jul","value":373},{"label":"Ago","value":548},{"label":"Set","value":565},{"label":"Out","value":584},{"label":"Nov","value":383},{"label":"Dez","value":474}];
const MX = 684;
