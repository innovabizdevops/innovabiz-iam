...
export default function MembershipOrgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Membership Org</h1><p className="text-sm text-muted-foreground">Membership Org • iBOS Enterprise</p></div>
