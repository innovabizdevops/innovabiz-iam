...
const ACCENT = "#4c1d95";
const MODULE = "Vaccine Development";
const PAGE = "Cold Chain";
const KPIS = [{"l":"Total Vaccine Dev","v":"3.261","t":"+2.2%","d":"up"},{"l":"Cold Chain Ativos","v":"7.478","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+10.3%","d":"up"}];
const COLS = ["ID","Cold Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vaccine Dev #001","Vaccine Dev #002","1.208","5.278","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Vaccine Dev #002","Vaccine Dev #003","3.276","2.831","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Vaccine Dev #003","Vaccine Dev #004","7.955","4.753","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Vaccine Dev #004","Vaccine Dev #005","4.150","5.946","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vaccine Dev #005","Vaccine Dev #001","836","3.851","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":223},{"label":"Mar","value":355},{"label":"Abr","value":332},{"label":"Mai","value":585},{"label":"Jun","value":510},{"label":"Jul","value":457},{"label":"Ago","value":606},{"label":"Set","value":259},{"label":"Out","value":413},{"label":"Nov","value":221},{"label":"Dez","value":578}];
const MX = 618;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4c1d95'}}>IoT</span></h1>
                </div>
