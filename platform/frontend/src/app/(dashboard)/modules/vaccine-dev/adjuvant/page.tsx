...
const PAGE = "Adjuvant";
const KPIS = [{"l":"Total Vaccine Dev","v":"3.889","t":"+15.4%","d":"up"},{"l":"Adjuvant Ativos","v":"7.442","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.8%","d":"up"}];
const COLS = ["ID","Adjuvant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vaccine Dev #001","Vaccine Dev #002","1.242","6.945","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Vaccine Dev #002","Vaccine Dev #003","8.345","4.653","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Vaccine Dev #003","Vaccine Dev #004","502","1.226","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Vaccine Dev #004","Vaccine Dev #005","6.180","1.262","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vaccine Dev #005","Vaccine Dev #001","5.404","709","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":719},{"label":"Mar","value":409},{"label":"Abr","value":366},{"label":"Mai","value":651},{"label":"Jun","value":451},{"label":"Jul","value":373},{"label":"Ago","value":623},{"label":"Set","value":648},{"label":"Out","value":326},{"label":"Nov","value":718},{"label":"Dez","value":654}];
const MX = 719;
...
export default function AdjuvantPage() {
    return (
