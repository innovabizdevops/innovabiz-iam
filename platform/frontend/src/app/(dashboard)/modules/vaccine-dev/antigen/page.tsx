...
const PAGE = "Antigen";
const KPIS = [{"l":"Total Vaccine Dev","v":"7.540","t":"+5.5%","d":"up"},{"l":"Antigen Ativos","v":"205","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+16.5%","d":"up"}];
const COLS = ["ID","Antigen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vaccine Dev #001","Vaccine Dev #002","2.734","8.402","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Vaccine Dev #002","Vaccine Dev #003","2.494","8.696","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Vaccine Dev #003","Vaccine Dev #004","4.816","7.340","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Vaccine Dev #004","Vaccine Dev #005","4.289","429","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vaccine Dev #005","Vaccine Dev #001","5.662","4.663","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":477},{"label":"Mar","value":572},{"label":"Abr","value":406},{"label":"Mai","value":242},{"label":"Jun","value":583},{"label":"Jul","value":502},{"label":"Ago","value":455},{"label":"Set","value":371},{"label":"Out","value":350},{"label":"Nov","value":401},{"label":"Dez","value":458}];
const MX = 583;
...
export default function AntigenPage() {
    return (
