...
/* ═══ Vaccine Development — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "3740", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2424", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€22K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1235058340", cells: ["VAC-7340", "Vaccine Development Item 1", "13/5/2026", "€8440"], status: "active" as const },
    { id: "1235061911", cells: ["VAC-1911", "Vaccine Development Item 2", "28/12/2026", "€12 011"], status: "pending" as const },
    { id: "1235065482", cells: ["VAC-5482", "Vaccine Development Item 3", "15/7/2026", "€15 582"], status: "completed" as const },
    { id: "1235069053", cells: ["VAC-9053", "Vaccine Development Item 4", "2/2/2026", "€19 153"], status: "warning" as const },
    { id: "1235072624", cells: ["VAC-3624", "Vaccine Development Item 5", "17/9/2026", "€22 724"], status: "active" as const },
];
...
export default function VaccineDevelopmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vaccine Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vaccine Development</p>
                    </div>
                </div>
