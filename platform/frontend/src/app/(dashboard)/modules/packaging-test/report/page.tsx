...
const PAGE = "Report";
const KPIS = [{"l":"Total Packaging Test","v":"3.795","t":"+4.3%","d":"up"},{"l":"Report Ativos","v":"7.282","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"75.9%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"77","t":"+5.4%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Test #001","Packaging Test #002","8.998","6.395","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Test #002","Packaging Test #003","2.925","8.775","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Test #003","Packaging Test #004","9.066","7.566","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Test #004","Packaging Test #005","5.754","3.620","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Test #005","Packaging Test #001","935","3.198","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":490},{"label":"Mar","value":320},{"label":"Abr","value":379},{"label":"Mai","value":665},{"label":"Jun","value":650},{"label":"Jul","value":402},{"label":"Ago","value":637},{"label":"Set","value":658},{"label":"Out","value":526},{"label":"Nov","value":349},{"label":"Dez","value":358}];
const MX = 665;
