...
const PAGE = "Compression";
const KPIS = [{"l":"Total Packaging Test","v":"7.698","t":"-5.3%","d":"down"},{"l":"Compression Ativos","v":"2.324","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"84","t":"-1.1%","d":"down"}];
const COLS = ["ID","Compression","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Test #001","Packaging Test #002","6.495","4.511","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Test #002","Packaging Test #003","9.099","5.016","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Test #003","Packaging Test #004","9.076","7.854","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Test #004","Packaging Test #005","5.548","3.772","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Test #005","Packaging Test #001","8.116","6.016","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":717},{"label":"Mar","value":656},{"label":"Abr","value":758},{"label":"Mai","value":666},{"label":"Jun","value":704},{"label":"Jul","value":879},{"label":"Ago","value":949},{"label":"Set","value":962},{"label":"Out","value":652},{"label":"Nov","value":1021},{"label":"Dez","value":969}];
const MX = 1021;
