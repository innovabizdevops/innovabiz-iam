...
/* ═══ Packaging Testing Lab — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "8061", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3133", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€58K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1986452861", cells: ["PAC-9861", "Packaging Testing Lab Item 1", "2/6/2026", "€2961"], status: "active" as const },
    { id: "1986456432", cells: ["PAC-4432", "Packaging Testing Lab Item 2", "17/1/2026", "€6532"], status: "pending" as const },
    { id: "1986460003", cells: ["PAC-8003", "Packaging Testing Lab Item 3", "4/8/2026", "€10 103"], status: "completed" as const },
    { id: "1986463574", cells: ["PAC-2574", "Packaging Testing Lab Item 4", "19/3/2026", "€13 674"], status: "warning" as const },
    { id: "1986467145", cells: ["PAC-6145", "Packaging Testing Lab Item 5", "6/10/2026", "€17 245"], status: "active" as const },
];
...
export default function PackagingTestingLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Packaging Testing Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Packaging Testing Lab</p>
                    </div>
                </div>
