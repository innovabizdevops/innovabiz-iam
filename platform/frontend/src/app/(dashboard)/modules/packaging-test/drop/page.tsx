...
const PAGE = "Drop Test";
const KPIS = [{"l":"Total Packaging Test","v":"1.146","t":"+16.4%","d":"up"},{"l":"Drop Test Ativos","v":"3.193","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"59","t":"+2.9%","d":"up"}];
const COLS = ["ID","Drop Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Test #001","Packaging Test #002","7.982","7.821","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Test #002","Packaging Test #003","9.067","3.265","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Test #003","Packaging Test #004","6.323","5.926","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Test #004","Packaging Test #005","4.358","8.122","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Test #005","Packaging Test #001","3.156","2.615","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":363},{"label":"Mar","value":417},{"label":"Abr","value":410},{"label":"Mai","value":509},{"label":"Jun","value":462},{"label":"Jul","value":279},{"label":"Ago","value":660},{"label":"Set","value":341},{"label":"Out","value":665},{"label":"Nov","value":482},{"label":"Dez","value":369}];
const MX = 665;
