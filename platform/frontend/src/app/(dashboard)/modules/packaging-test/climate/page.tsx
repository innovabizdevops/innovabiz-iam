...
const PAGE = "Climate";
const KPIS = [{"l":"Total Packaging Test","v":"3.004","t":"+11.8%","d":"up"},{"l":"Climate Ativos","v":"6.754","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"83","t":"+12.9%","d":"up"}];
const COLS = ["ID","Climate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Test #001","Packaging Test #002","8.363","1.165","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Test #002","Packaging Test #003","3.760","5.928","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Test #003","Packaging Test #004","4.178","6.309","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Test #004","Packaging Test #005","5.714","201","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Test #005","Packaging Test #001","3.968","4.039","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":227},{"label":"Mar","value":451},{"label":"Abr","value":585},{"label":"Mai","value":569},{"label":"Jun","value":352},{"label":"Jul","value":271},{"label":"Ago","value":404},{"label":"Set","value":279},{"label":"Out","value":459},{"label":"Nov","value":545},{"label":"Dez","value":405}];
const MX = 585;
