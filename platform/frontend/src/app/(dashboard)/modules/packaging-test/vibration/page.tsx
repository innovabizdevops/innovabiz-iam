...
const ACCENT = "#78350f";
const MODULE = "Packaging Testing Lab";
const PAGE = "Vibration";
const KPIS = [{"l":"Total Packaging Test","v":"7.853","t":"+0.8%","d":"up"},{"l":"Vibration Ativos","v":"5.497","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+11.1%","d":"up"}];
const COLS = ["ID","Vibration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Test #001","Packaging Test #002","1.495","6.149","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Test #002","Packaging Test #003","4.940","109","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Test #003","Packaging Test #004","6.384","1.113","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Test #004","Packaging Test #005","2.437","6.385","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Test #005","Packaging Test #001","1.635","2.633","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":469},{"label":"Mar","value":236},{"label":"Abr","value":420},{"label":"Mai","value":231},{"label":"Jun","value":314},{"label":"Jul","value":293},{"label":"Ago","value":503},{"label":"Set","value":213},{"label":"Out","value":575},{"label":"Nov","value":473},{"label":"Dez","value":519}];
const MX = 575;
