...
const PAGE = "Certify";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.261","t":"+15.2%","d":"up"},{"l":"NC Abertas","v":"1.005","t":"+13.0%","d":"up"},{"l":"Conformidade (%)","v":"66.8%","t":"+6.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.000","t":"+16.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.106","74.6%","8.887","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.791","95.2%","5.553","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.698","81.1%","303","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.974","99.7%","6.277","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.160","95.6%","2.624","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":764},{"label":"Mar","value":666},{"label":"Abr","value":704},{"label":"Mai","value":695},{"label":"Jun","value":656},{"label":"Jul","value":628},{"label":"Ago","value":913},{"label":"Set","value":1011},{"label":"Out","value":683},{"label":"Nov","value":920},{"label":"Dez","value":640}];
const MX = 1011;
