...
const ACCENT = "#1e3a5f";
const MODULE = "Vehicle Inspection Platform";
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.723","t":"-2.7%","d":"down"},{"l":"NC Abertas","v":"7.089","t":"+1.8%","d":"up"},{"l":"Conformidade (%)","v":"76.7%","t":"+5.9%","d":"up"},{"l":"CAPAs Pendentes","v":"6.399","t":"+16.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.067","86.1%","8.961","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.823","88.1%","7.529","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","961","85.3%","8.857","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.649","85.4%","7.704","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.179","86.9%","8.347","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":578},{"label":"Mar","value":237},{"label":"Abr","value":474},{"label":"Mai","value":556},{"label":"Jun","value":440},{"label":"Jul","value":579},{"label":"Ago","value":345},{"label":"Set","value":552},{"label":"Out","value":523},{"label":"Nov","value":269},{"label":"Dez","value":515}];
const MX = 579;
