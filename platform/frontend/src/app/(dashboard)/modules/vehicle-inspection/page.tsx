...
/* ═══ Vehicle Inspection Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "760", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4811", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€259K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "35601060", cells: ["VEH-7060", "Vehicle Inspection Platform Item 1", "13/1/2026", "€1160"], status: "active" as const },
    { id: "35604631", cells: ["VEH-1631", "Vehicle Inspection Platform Item 2", "28/8/2026", "€4731"], status: "pending" as const },
    { id: "35608202", cells: ["VEH-5202", "Vehicle Inspection Platform Item 3", "15/3/2026", "€8302"], status: "completed" as const },
    { id: "35611773", cells: ["VEH-8773", "Vehicle Inspection Platform Item 4", "2/10/2026", "€11 873"], status: "warning" as const },
    { id: "35615344", cells: ["VEH-3344", "Vehicle Inspection Platform Item 5", "17/5/2026", "€15 444"], status: "active" as const },
];
...
export default function VehicleInspectionPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vehicle Inspection Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vehicle Inspection Platform</p>
                    </div>
                </div>
