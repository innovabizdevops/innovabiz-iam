...
const PAGE = "Inspect";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.154","t":"+2.2%","d":"up"},{"l":"NC Abertas","v":"8.811","t":"+3.1%","d":"up"},{"l":"Conformidade (%)","v":"65.3%","t":"+8.7%","d":"up"},{"l":"CAPAs Pendentes","v":"919","t":"+14.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.605","73.1%","1.380","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.921","95.1%","6.810","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.254","97.6%","4.911","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.281","94.9%","4.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.615","95.0%","2.219","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1025},{"label":"Fev","value":1004},{"label":"Mar","value":909},{"label":"Abr","value":953},{"label":"Mai","value":810},{"label":"Jun","value":929},{"label":"Jul","value":855},{"label":"Ago","value":1060},{"label":"Set","value":863},{"label":"Out","value":985},{"label":"Nov","value":920},{"label":"Dez","value":865}];
const MX = 1060;
