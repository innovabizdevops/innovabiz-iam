...
/* ═══ GenAI Data Synthesis — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "825", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3285", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€301K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "529769525", cells: ["GEN-3525", "GenAI Data Synthesis Item 1", "6/6/2026", "€19 625"], status: "active" as const },
    { id: "529773096", cells: ["GEN-7096", "GenAI Data Synthesis Item 2", "21/1/2026", "€23 196"], status: "pending" as const },
    { id: "529776667", cells: ["GEN-1667", "GenAI Data Synthesis Item 3", "8/8/2026", "€26 767"], status: "completed" as const },
    { id: "529780238", cells: ["GEN-5238", "GenAI Data Synthesis Item 4", "23/3/2026", "€30 338"], status: "warning" as const },
    { id: "529783809", cells: ["GEN-8809", "GenAI Data Synthesis Item 5", "10/10/2026", "€33 909"], status: "active" as const },
];
...
export default function GenaiDataSynthesisPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Data Synthesis</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Data Synthesis</p>
                    </div>
                </div>
