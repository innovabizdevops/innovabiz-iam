...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Data Synthesis";
const PAGE = "Tabular";
const KPIS = [{"l":"Dashboards Ativos","v":"1.155","t":"+15.9%","d":"up"},{"l":"Queries/Dia","v":"5071","t":"+9.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.768","t":"+10.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.833","t":"+11.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3599","2026-01-16","4.323","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4928","2026-02-08","7.632","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1189","2026-03-11","2.760","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1767","2026-01-17","3.676","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4055","2026-01-26","1.104","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":330},{"label":"Mar","value":360},{"label":"Abr","value":346},{"label":"Mai","value":573},{"label":"Jun","value":470},{"label":"Jul","value":435},{"label":"Ago","value":401},{"label":"Set","value":521},{"label":"Out","value":276},{"label":"Nov","value":276},{"label":"Dez","value":538}];
const MX = 573;
