...
const PAGE = "Time Series";
const KPIS = [{"l":"Dashboards Ativos","v":"9.075","t":"+7.3%","d":"up"},{"l":"Queries/Dia","v":"2064","t":"-2.3%","d":"down"},{"l":"Dados Processados (GB)","v":"398","t":"-3.7%","d":"down"},{"l":"Utilizadores Analytics","v":"3.364","t":"+15.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1661","2026-01-02","5.764","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3849","2026-02-26","4.976","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","929","2026-02-21","599","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","221","2026-01-01","6.474","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2127","2026-02-27","7.386","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":418},{"label":"Mar","value":439},{"label":"Abr","value":622},{"label":"Mai","value":550},{"label":"Jun","value":669},{"label":"Jul","value":512},{"label":"Ago","value":409},{"label":"Set","value":406},{"label":"Out","value":540},{"label":"Nov","value":696},{"label":"Dez","value":360}];
const MX = 696;
