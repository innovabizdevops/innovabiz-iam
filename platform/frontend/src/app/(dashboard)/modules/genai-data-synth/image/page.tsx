...
const PAGE = "Image";
const KPIS = [{"l":"Dashboards Ativos","v":"6.836","t":"+15.9%","d":"up"},{"l":"Queries/Dia","v":"248","t":"+1.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.497","t":"-4.1%","d":"down"},{"l":"Utilizadores Analytics","v":"2.303","t":"+14.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3434","2026-01-06","8.033","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4205","2026-01-25","3.327","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","892","2026-03-08","2.167","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4076","2026-02-04","267","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4462","2026-03-23","6.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":523},{"label":"Mar","value":555},{"label":"Abr","value":322},{"label":"Mai","value":627},{"label":"Jun","value":466},{"label":"Jul","value":641},{"label":"Ago","value":384},{"label":"Set","value":461},{"label":"Out","value":518},{"label":"Nov","value":623},{"label":"Dez","value":383}];
const MX = 641;
