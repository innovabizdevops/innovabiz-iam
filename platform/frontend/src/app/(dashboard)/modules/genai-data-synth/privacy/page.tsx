...
const PAGE = "Privacy";
const KPIS = [{"l":"Dashboards Ativos","v":"9.037","t":"+4.3%","d":"up"},{"l":"Queries/Dia","v":"3910","t":"+12.9%","d":"up"},{"l":"Dados Processados (GB)","v":"8.526","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"6.405","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","404","2026-02-25","4.963","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","548","2026-02-20","6.980","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1575","2026-03-15","1.377","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","784","2026-01-10","4.686","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","999","2026-01-16","382","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":822},{"label":"Mar","value":874},{"label":"Abr","value":593},{"label":"Mai","value":609},{"label":"Jun","value":544},{"label":"Jul","value":534},{"label":"Ago","value":845},{"label":"Set","value":864},{"label":"Out","value":589},{"label":"Nov","value":636},{"label":"Dez","value":492}];
const MX = 874;
