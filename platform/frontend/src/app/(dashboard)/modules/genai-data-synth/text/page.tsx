...
const PAGE = "Text";
const KPIS = [{"l":"Dashboards Ativos","v":"2.587","t":"-1.9%","d":"down"},{"l":"Queries/Dia","v":"4983","t":"-0.3%","d":"down"},{"l":"Dados Processados (GB)","v":"8.017","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.058","t":"+13.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1538","2026-02-19","7.795","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3454","2026-01-11","6.682","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2700","2026-03-08","5.046","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4614","2026-01-24","4.219","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","736","2026-01-17","3.052","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":731},{"label":"Mar","value":1029},{"label":"Abr","value":969},{"label":"Mai","value":699},{"label":"Jun","value":778},{"label":"Jul","value":867},{"label":"Ago","value":765},{"label":"Set","value":1023},{"label":"Out","value":944},{"label":"Nov","value":715},{"label":"Dez","value":842}];
const MX = 1029;
