...
const ACCENT = "#be185d";
const MODULE = "Voice of Customer Deep";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"1.836","t":"+13.2%","d":"up"},{"l":"Queries/Dia","v":"4901","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"5.664","t":"-5.2%","d":"down"},{"l":"Utilizadores Analytics","v":"2.543","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2595","2026-03-18","4.988","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3507","2026-02-02","3.112","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3826","2026-03-17","6.463","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2820","2026-01-09","2.026","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2331","2026-03-02","8.384","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":651},{"label":"Mar","value":703},{"label":"Abr","value":692},{"label":"Mai","value":570},{"label":"Jun","value":649},{"label":"Jul","value":570},{"label":"Ago","value":786},{"label":"Set","value":648},{"label":"Out","value":594},{"label":"Nov","value":816},{"label":"Dez","value":835}];
const MX = 835;
