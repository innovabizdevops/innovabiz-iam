...
/* ═══ Voice of Customer Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "2828", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2326", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€301K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1549887328", cells: ["VOI-7328", "Voice of Customer Deep Item 1", "25/5/2026", "€37 428"], status: "active" as const },
    { id: "1549890899", cells: ["VOI-1899", "Voice of Customer Deep Item 2", "12/12/2026", "€40 999"], status: "pending" as const },
    { id: "1549894470", cells: ["VOI-5470", "Voice of Customer Deep Item 3", "27/7/2026", "€44 570"], status: "completed" as const },
    { id: "1549898041", cells: ["VOI-9041", "Voice of Customer Deep Item 4", "14/2/2026", "€48 141"], status: "warning" as const },
    { id: "1549901612", cells: ["VOI-3612", "Voice of Customer Deep Item 5", "1/9/2026", "€1712"], status: "active" as const },
];
...
export default function VoiceOfCustomerDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Voice of Customer Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Voice of Customer Deep</p>
                    </div>
                </div>
