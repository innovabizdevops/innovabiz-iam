...
const PAGE = "Close";
const KPIS = [{"l":"Perfis Unificados","v":"3.922","t":"+5.3%","d":"up"},{"l":"Segmentos Ativos","v":"7.780","t":"-3.8%","d":"down"},{"l":"NPS Score","v":"71","t":"-0.1%","d":"down"},{"l":"Churn Previsto (%)","v":"80.5%","t":"+5.2%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.296","€ 30390.42","93.7%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","5.968","€ 20079.49","79.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.329","€ 2298.12","89.6%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","529","€ 22868.80","96.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","7.164","€ 12318.63","71.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1003},{"label":"Fev","value":715},{"label":"Mar","value":847},{"label":"Abr","value":988},{"label":"Mai","value":681},{"label":"Jun","value":904},{"label":"Jul","value":803},{"label":"Ago","value":998},{"label":"Set","value":894},{"label":"Out","value":1024},{"label":"Nov","value":816},{"label":"Dez","value":665}];
const MX = 1024;
