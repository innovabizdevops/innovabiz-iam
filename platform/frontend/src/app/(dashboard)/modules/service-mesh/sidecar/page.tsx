...
const PAGE = "Sidecar Proxy";
const KPIS = [{"l":"Total Service Mesh","v":"2.767","t":"+14.6%","d":"up"},{"l":"Sidecar Proxy Ativos","v":"5.489","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.5%","d":"up"}];
const COLS = ["ID","Sidecar Proxy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Mesh #001","Service Mesh #002","9.053","678","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Service Mesh #002","Service Mesh #003","151","8.194","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Mesh #003","Service Mesh #004","3.588","6.119","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Service Mesh #004","Service Mesh #005","2.943","4.587","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Mesh #005","Service Mesh #001","2.782","7.960","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":713},{"label":"Mar","value":771},{"label":"Abr","value":974},{"label":"Mai","value":868},{"label":"Jun","value":1036},{"label":"Jul","value":696},{"label":"Ago","value":820},{"label":"Set","value":993},{"label":"Out","value":985},{"label":"Nov","value":735},{"label":"Dez","value":986}];
const MX = 1036;
