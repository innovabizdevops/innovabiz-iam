...
const ACCENT = "#7c3aed";
const MODULE = "Service Mesh";
const PAGE = "Circuit Breaker";
const KPIS = [{"l":"Total Service Mesh","v":"3.278","t":"-2.2%","d":"down"},{"l":"Circuit Breaker Ativos","v":"3.500","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"76","t":"+17.9%","d":"up"}];
const COLS = ["ID","Circuit Breaker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Mesh #001","Service Mesh #002","2.204","640","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Service Mesh #002","Service Mesh #003","7.005","340","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Mesh #003","Service Mesh #004","6.177","8.865","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Service Mesh #004","Service Mesh #005","7.379","8.193","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Mesh #005","Service Mesh #001","3.612","1.662","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":618},{"label":"Mar","value":612},{"label":"Abr","value":536},{"label":"Mai","value":491},{"label":"Jun","value":369},{"label":"Jul","value":660},{"label":"Ago","value":527},{"label":"Set","value":588},{"label":"Out","value":390},{"label":"Nov","value":315},{"label":"Dez","value":485}];
const MX = 660;
