...
const PAGE = "Traffic Rules";
const KPIS = [{"l":"Total Service Mesh","v":"9.070","t":"-2.3%","d":"down"},{"l":"Traffic Rules Ativos","v":"2.326","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"62","t":"+6.3%","d":"up"}];
const COLS = ["ID","Traffic Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Mesh #001","Service Mesh #002","4.032","3.836","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Service Mesh #002","Service Mesh #003","8.370","3.893","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Mesh #003","Service Mesh #004","4.103","6.751","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Service Mesh #004","Service Mesh #005","4.659","1.616","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Mesh #005","Service Mesh #001","2.457","6.731","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":474},{"label":"Mar","value":596},{"label":"Abr","value":779},{"label":"Mai","value":713},{"label":"Jun","value":442},{"label":"Jul","value":760},{"label":"Ago","value":660},{"label":"Set","value":641},{"label":"Out","value":716},{"label":"Nov","value":670},{"label":"Dez","value":773}];
const MX = 779;
