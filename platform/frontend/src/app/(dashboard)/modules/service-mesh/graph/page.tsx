...
const KPIS = [{"l":"Total Service Mesh","v":"6.416","t":"+2.3%","d":"up"},{"l":"Service Graph Ativos","v":"7.547","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"74.9%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.0%","d":"down"}];
const COLS = ["ID","Service Graph","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Mesh #001","Service Mesh #002","1.786","349","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Service Mesh #002","Service Mesh #003","3.272","5.335","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Mesh #003","Service Mesh #004","4.342","1.515","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Service Mesh #004","Service Mesh #005","315","3.527","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Mesh #005","Service Mesh #001","7.433","7.724","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":626},{"label":"Mar","value":838},{"label":"Abr","value":586},{"label":"Mai","value":833},{"label":"Jun","value":751},{"label":"Jul","value":624},{"label":"Ago","value":455},{"label":"Set","value":746},{"label":"Out","value":564},{"label":"Nov","value":455},{"label":"Dez","value":829}];
const MX = 838;
