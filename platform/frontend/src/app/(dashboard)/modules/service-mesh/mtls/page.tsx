...
const PAGE = "mTLS";
const KPIS = [{"l":"Total Service Mesh","v":"1.360","t":"+1.2%","d":"up"},{"l":"MTLS Ativos","v":"5.736","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"69","t":"-5.9%","d":"down"}];
const COLS = ["ID","MTLS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Mesh #001","Service Mesh #002","6.816","6.216","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Service Mesh #002","Service Mesh #003","8.483","7.814","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Mesh #003","Service Mesh #004","1.550","8.991","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Service Mesh #004","Service Mesh #005","913","5.916","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Mesh #005","Service Mesh #001","2.232","4.274","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":560},{"label":"Mar","value":475},{"label":"Abr","value":397},{"label":"Mai","value":385},{"label":"Jun","value":632},{"label":"Jul","value":711},{"label":"Ago","value":623},{"label":"Set","value":558},{"label":"Out","value":401},{"label":"Nov","value":630},{"label":"Dez","value":661}];
const MX = 711;
