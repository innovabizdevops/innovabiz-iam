...
const PAGE = "Journey Orchestration AI";
const KPIS = [{"l":"Perfis Unificados","v":"4.244","t":"+0.1%","d":"up"},{"l":"Segmentos Ativos","v":"1.215","t":"-2.4%","d":"down"},{"l":"NPS Score","v":"79","t":"+8.2%","d":"up"},{"l":"Churn Previsto (%)","v":"92.8%","t":"+4.3%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.524","€ 28334.46","71.0%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.167","€ 22409.52","72.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","2.356","€ 20844.55","93.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","2.823","€ 22824.53","80.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.258","€ 17063.19","92.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":823},{"label":"Mar","value":842},{"label":"Abr","value":971},{"label":"Mai","value":831},{"label":"Jun","value":886},{"label":"Jul","value":793},{"label":"Ago","value":612},{"label":"Set","value":869},{"label":"Out","value":743},{"label":"Nov","value":778},{"label":"Dez","value":857}];
const MX = 971;
