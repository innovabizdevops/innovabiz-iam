...
const PAGE = "Emotion Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"1.964","t":"+11.0%","d":"up"},{"l":"Queries/Dia","v":"4966","t":"+9.8%","d":"up"},{"l":"Dados Processados (GB)","v":"2.162","t":"+0.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.101","t":"+16.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2534","2026-03-17","6.850","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1476","2026-02-01","8.832","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4005","2026-03-03","7.465","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","248","2026-02-28","4.802","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1080","2026-03-15","821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":903},{"label":"Mar","value":757},{"label":"Abr","value":670},{"label":"Mai","value":811},{"label":"Jun","value":796},{"label":"Jul","value":826},{"label":"Ago","value":670},{"label":"Set","value":1015},{"label":"Out","value":827},{"label":"Nov","value":911},{"label":"Dez","value":796}];
const MX = 1015;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#db2777'}}>AI</span></h1>
                </div>
