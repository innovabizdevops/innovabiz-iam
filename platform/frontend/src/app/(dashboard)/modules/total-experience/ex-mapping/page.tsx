...
const PAGE = "EX Mapping";
const KPIS = [{"l":"Perfis Unificados","v":"6.541","t":"+2.8%","d":"up"},{"l":"Segmentos Ativos","v":"5.006","t":"-4.0%","d":"down"},{"l":"NPS Score","v":"60","t":"+11.0%","d":"up"},{"l":"Churn Previsto (%)","v":"66.8%","t":"+-0.0%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.865","€ 28398.27","88.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","2.167","€ 22533.51","87.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","5.344","€ 22420.11","82.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.033","€ 15976.16","87.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.636","€ 41548.90","79.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":632},{"label":"Mar","value":702},{"label":"Abr","value":784},{"label":"Mai","value":814},{"label":"Jun","value":686},{"label":"Jul","value":643},{"label":"Ago","value":756},{"label":"Set","value":974},{"label":"Out","value":1001},{"label":"Nov","value":764},{"label":"Dez","value":981}];
const MX = 1001;
...
export default function ExMappingPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#db2777'}}>EX</span></h1>
                </div>
