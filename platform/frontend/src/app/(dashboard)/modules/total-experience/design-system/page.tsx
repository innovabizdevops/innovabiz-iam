...
const PAGE = "Design System Studio";
const KPIS = [{"l":"Formulários Ativos","v":"8.015","t":"+11.9%","d":"up"},{"l":"Submissões/Dia","v":"3098","t":"+9.8%","d":"up"},{"l":"Documentos Gerados","v":"4.841","t":"+1.1%","d":"up"},{"l":"Templates","v":"196","t":"+10.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.656","2026-03-03","4.202","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.131","2026-03-07","2.459","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.093","2026-03-04","4.449","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.805","2026-01-01","4.967","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.197","2026-03-28","1.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1013},{"label":"Fev","value":1012},{"label":"Mar","value":732},{"label":"Abr","value":955},{"label":"Mai","value":963},{"label":"Jun","value":765},{"label":"Jul","value":821},{"label":"Ago","value":1031},{"label":"Set","value":756},{"label":"Out","value":809},{"label":"Nov","value":702},{"label":"Dez","value":785}];
const MX = 1031;
