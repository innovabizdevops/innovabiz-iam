...
const ACCENT = "#db2777";
const MODULE = "Total Experience (TX)";
const PAGE = "UX Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.342","t":"+0.1%","d":"up"},{"l":"Queries/Dia","v":"1232","t":"-3.8%","d":"down"},{"l":"Dados Processados (GB)","v":"8.624","t":"+13.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.504","t":"+3.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2474","2026-03-22","6.522","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","263","2026-01-27","5.327","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3644","2026-02-15","3.104","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1289","2026-01-21","2.558","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5034","2026-01-06","9.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":765},{"label":"Mar","value":585},{"label":"Abr","value":418},{"label":"Mai","value":498},{"label":"Jun","value":566},{"label":"Jul","value":546},{"label":"Ago","value":463},{"label":"Set","value":491},{"label":"Out","value":652},{"label":"Nov","value":457},{"label":"Dez","value":743}];
const MX = 765;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#db2777'}}>UX</span></h1>
                </div>
