...
const PAGE = "Voice of Everything";
const KPIS = [{"l":"Perfis Unificados","v":"8.706","t":"-5.3%","d":"down"},{"l":"Segmentos Ativos","v":"5.925","t":"+2.7%","d":"up"},{"l":"NPS Score","v":"61","t":"+2.5%","d":"up"},{"l":"Churn Previsto (%)","v":"65.8%","t":"+16.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.844","€ 1657.64","70.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","2.002","€ 30209.50","87.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","895","€ 3415.80","83.6%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","2.921","€ 38580.35","99.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.003","€ 12394.14","80.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":444},{"label":"Mar","value":279},{"label":"Abr","value":491},{"label":"Mai","value":491},{"label":"Jun","value":470},{"label":"Jul","value":258},{"label":"Ago","value":441},{"label":"Set","value":603},{"label":"Out","value":621},{"label":"Nov","value":566},{"label":"Dez","value":464}];
const MX = 621;
