...
const PAGE = "CX Mapping";
const KPIS = [{"l":"Perfis Unificados","v":"6.062","t":"+9.5%","d":"up"},{"l":"Segmentos Ativos","v":"292","t":"-1.6%","d":"down"},{"l":"NPS Score","v":"77","t":"-1.1%","d":"down"},{"l":"Churn Previsto (%)","v":"94.2%","t":"-0.1%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","853","€ 12580.41","73.1%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.470","€ 9637.57","77.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.635","€ 1419.83","95.2%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","7.886","€ 8374.47","97.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","7.464","€ 48112.07","98.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":352},{"label":"Fev","value":330},{"label":"Mar","value":517},{"label":"Abr","value":545},{"label":"Mai","value":586},{"label":"Jun","value":614},{"label":"Jul","value":243},{"label":"Ago","value":629},{"label":"Set","value":282},{"label":"Out","value":263},{"label":"Nov","value":557},{"label":"Dez","value":540}];
const MX = 629;
...
export default function CxMappingPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#db2777'}}>CX</span></h1>
                </div>
