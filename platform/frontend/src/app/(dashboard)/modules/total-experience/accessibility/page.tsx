...
const PAGE = "Accessibility (WCAG)";
const KPIS = [{"l":"Perfis Unificados","v":"1.145","t":"+1.3%","d":"up"},{"l":"Segmentos Ativos","v":"8.047","t":"-4.4%","d":"down"},{"l":"NPS Score","v":"80","t":"-3.7%","d":"down"},{"l":"Churn Previsto (%)","v":"69.5%","t":"+5.2%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.145","€ 42689.57","70.2%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.960","€ 509.51","77.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","8.082","€ 22589.85","97.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","2.475","€ 24721.98","96.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","4.618","€ 26530.11","90.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":763},{"label":"Mar","value":910},{"label":"Abr","value":916},{"label":"Mai","value":966},{"label":"Jun","value":959},{"label":"Jul","value":876},{"label":"Ago","value":1057},{"label":"Set","value":983},{"label":"Out","value":967},{"label":"Nov","value":688},{"label":"Dez","value":785}];
const MX = 1057;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#db2777'}}>WCAG</span></h1>
                </div>
