...
const ACCENT = "#dc2626";
const MODULE = "Report Designer";
const PAGE = "Financial Reports";
const KPIS = [{"l":"Formulários Ativos","v":"8.922","t":"+16.3%","d":"up"},{"l":"Submissões/Dia","v":"3235","t":"+11.6%","d":"up"},{"l":"Documentos Gerados","v":"358","t":"+3.2%","d":"up"},{"l":"Templates","v":"7.955","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.196","2026-01-13","4.774","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.027","2026-03-08","4.627","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.571","2026-03-11","1.078","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.492","2026-01-02","850","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.466","2026-01-15","3.954","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":461},{"label":"Mar","value":780},{"label":"Abr","value":768},{"label":"Mai","value":526},{"label":"Jun","value":817},{"label":"Jul","value":539},{"label":"Ago","value":662},{"label":"Set","value":555},{"label":"Out","value":500},{"label":"Nov","value":495},{"label":"Dez","value":744}];
const MX = 817;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>IFRS</span></h1>
                </div>
