...
const PAGE = "Regulatory Reports";
const KPIS = [{"l":"Formulários Ativos","v":"5.868","t":"+8.6%","d":"up"},{"l":"Submissões/Dia","v":"3387","t":"+12.3%","d":"up"},{"l":"Documentos Gerados","v":"3.510","t":"-1.4%","d":"down"},{"l":"Templates","v":"4.715","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.121","2026-03-26","7.122","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.136","2026-03-06","2.571","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.960","2026-02-17","8.083","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","278","2026-03-12","4.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","976","2026-01-03","6.717","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":285},{"label":"Mar","value":302},{"label":"Abr","value":268},{"label":"Mai","value":299},{"label":"Jun","value":580},{"label":"Jul","value":258},{"label":"Ago","value":580},{"label":"Set","value":324},{"label":"Out","value":406},{"label":"Nov","value":294},{"label":"Dez","value":403}];
const MX = 580;
