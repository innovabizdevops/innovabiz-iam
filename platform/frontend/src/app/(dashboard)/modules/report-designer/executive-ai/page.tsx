...
const PAGE = "Executive Summaries AI";
const KPIS = [{"l":"Formulários Ativos","v":"2.121","t":"+17.7%","d":"up"},{"l":"Submissões/Dia","v":"2317","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"2.465","t":"+9.1%","d":"up"},{"l":"Templates","v":"4.631","t":"+13.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.651","2026-02-01","1.165","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.127","2026-03-16","3.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","736","2026-01-26","1.058","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.988","2026-03-07","4.538","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.412","2026-01-24","4.724","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1030},{"label":"Fev","value":1016},{"label":"Mar","value":977},{"label":"Abr","value":777},{"label":"Mai","value":713},{"label":"Jun","value":875},{"label":"Jul","value":803},{"label":"Ago","value":1010},{"label":"Set","value":953},{"label":"Out","value":847},{"label":"Nov","value":852},{"label":"Dez","value":799}];
const MX = 1030;
