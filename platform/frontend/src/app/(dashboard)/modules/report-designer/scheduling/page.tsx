...
const PAGE = "Scheduled Distribution";
const KPIS = [{"l":"eNPS","v":"82","t":"+1.9%","d":"up"},{"l":"Engagement (%)","v":"78.0%","t":"+9.3%","d":"up"},{"l":"Turnover (%)","v":"89.0%","t":"+10.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.466","t":"+10.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.207","2026-03-03","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.177","2026-03-14","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.554","2026-03-14","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.784","2026-01-22","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.780","2026-02-15","95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":779},{"label":"Mar","value":703},{"label":"Abr","value":736},{"label":"Mai","value":682},{"label":"Jun","value":650},{"label":"Jul","value":404},{"label":"Ago","value":590},{"label":"Set","value":486},{"label":"Out","value":508},{"label":"Nov","value":481},{"label":"Dez","value":724}];
const MX = 779;
