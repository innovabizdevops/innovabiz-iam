...
const PAGE = "White-Label Reports";
const KPIS = [{"l":"Formulários Ativos","v":"4.037","t":"+11.9%","d":"up"},{"l":"Submissões/Dia","v":"448","t":"-5.3%","d":"down"},{"l":"Documentos Gerados","v":"1.363","t":"+11.7%","d":"up"},{"l":"Templates","v":"8.556","t":"-4.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.115","2026-03-23","5.106","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.483","2026-02-12","3.043","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.487","2026-03-13","8.593","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.218","2026-02-27","116","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.282","2026-03-18","6.515","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":339},{"label":"Mar","value":574},{"label":"Abr","value":509},{"label":"Mai","value":527},{"label":"Jun","value":481},{"label":"Jul","value":361},{"label":"Ago","value":559},{"label":"Set","value":319},{"label":"Out","value":555},{"label":"Nov","value":548},{"label":"Dez","value":379}];
const MX = 574;
