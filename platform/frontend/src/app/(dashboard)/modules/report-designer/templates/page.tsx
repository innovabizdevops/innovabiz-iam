...
const KPIS = [{"l":"Formulários Ativos","v":"3.739","t":"+4.0%","d":"up"},{"l":"Submissões/Dia","v":"1670","t":"+16.7%","d":"up"},{"l":"Documentos Gerados","v":"2.490","t":"+4.1%","d":"up"},{"l":"Templates","v":"2.936","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.267","2026-03-27","1.115","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.989","2026-02-24","8.395","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.473","2026-03-18","2.742","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.371","2026-01-02","606","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.568","2026-02-01","3.457","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":517},{"label":"Mar","value":719},{"label":"Abr","value":736},{"label":"Mai","value":552},{"label":"Jun","value":567},{"label":"Jul","value":787},{"label":"Ago","value":749},{"label":"Set","value":651},{"label":"Out","value":642},{"label":"Nov","value":676},{"label":"Dez","value":581}];
const MX = 787;
