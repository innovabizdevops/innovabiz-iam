...
const PAGE = "Board Deck AI";
const KPIS = [{"l":"Formulários Ativos","v":"7.548","t":"+9.2%","d":"up"},{"l":"Submissões/Dia","v":"4250","t":"-3.0%","d":"down"},{"l":"Documentos Gerados","v":"7.911","t":"-4.0%","d":"down"},{"l":"Templates","v":"5.786","t":"+10.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.605","2026-03-07","237","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.496","2026-01-09","6.814","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.045","2026-01-04","2.359","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.702","2026-02-12","702","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.303","2026-02-07","6.624","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":598},{"label":"Mar","value":481},{"label":"Abr","value":391},{"label":"Mai","value":342},{"label":"Jun","value":493},{"label":"Jul","value":378},{"label":"Ago","value":331},{"label":"Set","value":346},{"label":"Out","value":480},{"label":"Nov","value":516},{"label":"Dez","value":512}];
const MX = 598;
