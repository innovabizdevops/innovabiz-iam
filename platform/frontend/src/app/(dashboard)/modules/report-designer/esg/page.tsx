...
const PAGE = "ESG Reports";
const KPIS = [{"l":"Formulários Ativos","v":"1.747","t":"+5.7%","d":"up"},{"l":"Submissões/Dia","v":"4181","t":"-4.4%","d":"down"},{"l":"Documentos Gerados","v":"705","t":"+16.2%","d":"up"},{"l":"Templates","v":"3.978","t":"+14.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.026","2026-03-13","6.990","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.675","2026-02-03","4.866","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.190","2026-01-25","4.249","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.136","2026-01-04","8.312","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.170","2026-03-17","6.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":818},{"label":"Mar","value":659},{"label":"Abr","value":770},{"label":"Mai","value":808},{"label":"Jun","value":563},{"label":"Jul","value":508},{"label":"Ago","value":619},{"label":"Set","value":666},{"label":"Out","value":680},{"label":"Nov","value":595},{"label":"Dez","value":752}];
const MX = 818;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>GRI</span></h1>
                </div>
