...
const PAGE = "Visual Report Builder";
const KPIS = [{"l":"Formulários Ativos","v":"3.370","t":"-3.1%","d":"down"},{"l":"Submissões/Dia","v":"4806","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"2.903","t":"+4.7%","d":"up"},{"l":"Templates","v":"437","t":"+11.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.060","2026-01-11","7.701","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.875","2026-02-18","2.897","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","662","2026-03-26","8.414","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.842","2026-02-22","6.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.406","2026-01-07","282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":375},{"label":"Mar","value":408},{"label":"Abr","value":750},{"label":"Mai","value":613},{"label":"Jun","value":703},{"label":"Jul","value":559},{"label":"Ago","value":715},{"label":"Set","value":752},{"label":"Out","value":476},{"label":"Nov","value":713},{"label":"Dez","value":539}];
const MX = 752;
