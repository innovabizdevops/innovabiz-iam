...
const PAGE = "PDF/Excel Export";
const KPIS = [{"l":"Formulários Ativos","v":"5.547","t":"+12.4%","d":"up"},{"l":"Submissões/Dia","v":"673","t":"-5.8%","d":"down"},{"l":"Documentos Gerados","v":"5.533","t":"+17.1%","d":"up"},{"l":"Templates","v":"2.586","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.155","2026-02-24","3.649","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.665","2026-03-19","8.236","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.709","2026-01-21","2.391","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","294","2026-03-23","6.706","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","799","2026-01-19","5.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":673},{"label":"Mar","value":924},{"label":"Abr","value":903},{"label":"Mai","value":843},{"label":"Jun","value":820},{"label":"Jul","value":835},{"label":"Ago","value":794},{"label":"Set","value":995},{"label":"Out","value":777},{"label":"Nov","value":664},{"label":"Dez","value":854}];
const MX = 995;
