...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.022","t":"+15.3%","d":"up"},{"l":"NC Abertas","v":"2.285","t":"+0.9%","d":"up"},{"l":"Conformidade (%)","v":"75.8%","t":"+6.9%","d":"up"},{"l":"CAPAs Pendentes","v":"3.411","t":"-4.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.091","84.2%","4.847","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.456","95.0%","887","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.483","99.5%","3.441","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","287","82.9%","6.353","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.981","75.1%","1.363","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":579},{"label":"Mar","value":658},{"label":"Abr","value":811},{"label":"Mai","value":829},{"label":"Jun","value":772},{"label":"Jul","value":645},{"label":"Ago","value":463},{"label":"Set","value":811},{"label":"Out","value":572},{"label":"Nov","value":495},{"label":"Dez","value":495}];
const MX = 829;
