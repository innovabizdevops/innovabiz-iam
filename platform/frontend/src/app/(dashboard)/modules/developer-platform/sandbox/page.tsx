...
const PAGE = "API Sandbox";
const KPIS = [{"l":"Formulários Ativos","v":"5.986","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"569","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"7.435","t":"-5.5%","d":"down"},{"l":"Templates","v":"3.797","t":"+11.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","187","2026-02-19","2.302","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.467","2026-02-24","6.232","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.893","2026-03-12","2.035","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.083","2026-02-16","6.745","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.576","2026-01-14","2.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":669},{"label":"Mar","value":907},{"label":"Abr","value":637},{"label":"Mai","value":603},{"label":"Jun","value":558},{"label":"Jul","value":695},{"label":"Ago","value":930},{"label":"Set","value":783},{"label":"Out","value":806},{"label":"Nov","value":868},{"label":"Dez","value":645}];
const MX = 930;
