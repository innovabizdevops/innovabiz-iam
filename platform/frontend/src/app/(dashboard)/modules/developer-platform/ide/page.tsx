...
const PAGE = "IDE Extensions";
const KPIS = [{"l":"Formulários Ativos","v":"226","t":"-2.2%","d":"down"},{"l":"Submissões/Dia","v":"2726","t":"+17.9%","d":"up"},{"l":"Documentos Gerados","v":"7.892","t":"+8.9%","d":"up"},{"l":"Templates","v":"2.813","t":"+3.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.418","2026-03-15","7.436","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.148","2026-03-05","3.871","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.263","2026-03-11","1.436","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.446","2026-01-23","615","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.527","2026-03-06","3.681","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":466},{"label":"Mar","value":291},{"label":"Abr","value":364},{"label":"Mai","value":296},{"label":"Jun","value":238},{"label":"Jul","value":424},{"label":"Ago","value":576},{"label":"Set","value":468},{"label":"Out","value":349},{"label":"Nov","value":254},{"label":"Dez","value":469}];
const MX = 576;
