...
const PAGE = "Package Registry";
const KPIS = [{"l":"Formulários Ativos","v":"1.188","t":"-2.0%","d":"down"},{"l":"Submissões/Dia","v":"4364","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"1.223","t":"+13.5%","d":"up"},{"l":"Templates","v":"8.378","t":"+4.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.646","2026-03-23","2.627","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.736","2026-01-16","3.791","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.221","2026-02-26","3.822","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.116","2026-01-20","8.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.029","2026-01-26","2.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":599},{"label":"Mar","value":471},{"label":"Abr","value":483},{"label":"Mai","value":265},{"label":"Jun","value":551},{"label":"Jul","value":520},{"label":"Ago","value":480},{"label":"Set","value":525},{"label":"Out","value":516},{"label":"Nov","value":583},{"label":"Dez","value":328}];
const MX = 631;
