...
const ACCENT = "#1e3a5f";
const MODULE = "Developer Platform";
const PAGE = "Changelog AI";
const KPIS = [{"l":"Formulários Ativos","v":"8.550","t":"-2.9%","d":"down"},{"l":"Submissões/Dia","v":"4353","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"575","t":"+4.9%","d":"up"},{"l":"Templates","v":"1.370","t":"+11.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.699","2026-01-02","7.493","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.104","2026-02-01","5.298","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.532","2026-02-17","5.460","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.200","2026-03-04","7.535","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.201","2026-02-27","1.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":516},{"label":"Mar","value":433},{"label":"Abr","value":679},{"label":"Mai","value":674},{"label":"Jun","value":635},{"label":"Jul","value":501},{"label":"Ago","value":582},{"label":"Set","value":681},{"label":"Out","value":577},{"label":"Nov","value":832},{"label":"Dez","value":532}];
const MX = 832;
