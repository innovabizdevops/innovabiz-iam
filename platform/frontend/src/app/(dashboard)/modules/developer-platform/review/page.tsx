...
const KPIS = [{"l":"Formulários Ativos","v":"608","t":"-4.5%","d":"down"},{"l":"Submissões/Dia","v":"901","t":"-4.6%","d":"down"},{"l":"Documentos Gerados","v":"6.019","t":"+13.3%","d":"up"},{"l":"Templates","v":"4.213","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.696","2026-02-07","4.641","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.481","2026-01-06","5.347","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.798","2026-03-28","4.895","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.063","2026-02-24","4.984","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.734","2026-02-13","2.538","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":718},{"label":"Mar","value":795},{"label":"Abr","value":740},{"label":"Mai","value":628},{"label":"Jun","value":916},{"label":"Jul","value":904},{"label":"Ago","value":855},{"label":"Set","value":829},{"label":"Out","value":798},{"label":"Nov","value":971},{"label":"Dez","value":795}];
const MX = 971;
