...
const PAGE = "Feature Preview";
const KPIS = [{"l":"Formulários Ativos","v":"5.439","t":"+6.8%","d":"up"},{"l":"Submissões/Dia","v":"3184","t":"-3.3%","d":"down"},{"l":"Documentos Gerados","v":"8.494","t":"+12.2%","d":"up"},{"l":"Templates","v":"5.592","t":"-1.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.713","2026-02-10","6.326","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","849","2026-02-06","2.990","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.335","2026-03-22","7.038","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.842","2026-02-17","1.832","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.192","2026-02-12","3.333","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":330},{"label":"Mar","value":576},{"label":"Abr","value":479},{"label":"Mai","value":666},{"label":"Jun","value":359},{"label":"Jul","value":542},{"label":"Ago","value":513},{"label":"Set","value":507},{"label":"Out","value":646},{"label":"Nov","value":335},{"label":"Dez","value":479}];
const MX = 666;
