...
const PAGE = "Dev Documentation";
const KPIS = [{"l":"Formulários Ativos","v":"1.623","t":"+16.4%","d":"up"},{"l":"Submissões/Dia","v":"439","t":"+14.3%","d":"up"},{"l":"Documentos Gerados","v":"4.105","t":"+15.9%","d":"up"},{"l":"Templates","v":"2.273","t":"-4.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.564","2026-03-05","9.031","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.122","2026-03-12","5.102","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","189","2026-01-27","4.406","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.484","2026-02-16","3.147","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.222","2026-02-12","2.254","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":487},{"label":"Mar","value":563},{"label":"Abr","value":587},{"label":"Mai","value":522},{"label":"Jun","value":543},{"label":"Jul","value":344},{"label":"Ago","value":472},{"label":"Set","value":451},{"label":"Out","value":592},{"label":"Nov","value":684},{"label":"Dez","value":319}];
const MX = 684;
