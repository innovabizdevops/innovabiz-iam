...
const PAGE = "CI/CD Pipeline";
const KPIS = [{"l":"Formulários Ativos","v":"3.779","t":"+8.0%","d":"up"},{"l":"Submissões/Dia","v":"1492","t":"+14.6%","d":"up"},{"l":"Documentos Gerados","v":"6.864","t":"-4.6%","d":"down"},{"l":"Templates","v":"1.384","t":"+10.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.277","2026-01-13","4.434","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.475","2026-03-14","7.413","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.316","2026-03-21","8.524","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.375","2026-02-02","3.496","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.128","2026-01-18","8.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":605},{"label":"Mar","value":519},{"label":"Abr","value":304},{"label":"Mai","value":618},{"label":"Jun","value":337},{"label":"Jul","value":262},{"label":"Ago","value":364},{"label":"Set","value":474},{"label":"Out","value":580},{"label":"Nov","value":600},{"label":"Dez","value":425}];
const MX = 618;
