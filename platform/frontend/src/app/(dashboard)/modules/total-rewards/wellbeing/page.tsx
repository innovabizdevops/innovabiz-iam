...
const PAGE = "Wellbeing";
const KPIS = [{"l":"eNPS","v":"70","t":"+11.8%","d":"up"},{"l":"Engagement (%)","v":"73.4%","t":"+3.0%","d":"up"},{"l":"Turnover (%)","v":"90.5%","t":"+8.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.263","t":"+0.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.779","2026-01-08","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.641","2026-03-01","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.185","2026-01-04","64","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.649","2026-03-16","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.327","2026-02-03","75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":846},{"label":"Mar","value":809},{"label":"Abr","value":952},{"label":"Mai","value":721},{"label":"Jun","value":995},{"label":"Jul","value":838},{"label":"Ago","value":811},{"label":"Set","value":878},{"label":"Out","value":817},{"label":"Nov","value":730},{"label":"Dez","value":758}];
const MX = 995;
