...
/* ═══ Total Rewards Platform — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "4126", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1980", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€268K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1177925826", cells: ["TOT-6826", "Total Rewards Platform Item 1", "15/7/2026", "€25 926"], status: "active" as const },
    { id: "1177929397", cells: ["TOT-1397", "Total Rewards Platform Item 2", "2/2/2026", "€29 497"], status: "pending" as const },
    { id: "1177932968", cells: ["TOT-4968", "Total Rewards Platform Item 3", "17/9/2026", "€33 068"], status: "completed" as const },
    { id: "1177936539", cells: ["TOT-8539", "Total Rewards Platform Item 4", "4/4/2026", "€36 639"], status: "warning" as const },
    { id: "1177940110", cells: ["TOT-3110", "Total Rewards Platform Item 5", "19/11/2026", "€40 210"], status: "active" as const },
];
...
export default function TotalRewardsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Total Rewards Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Total Rewards Platform</p>
                    </div>
                </div>
