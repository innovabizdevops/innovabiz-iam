...
const ACCENT = "#0891b2";
const MODULE = "Total Rewards Platform";
const PAGE = "Recognition";
const KPIS = [{"l":"Total Total Rewards","v":"7.691","t":"+12.9%","d":"up"},{"l":"Recognition Ativos","v":"1.086","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"83.1%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"81","t":"+10.0%","d":"up"}];
const COLS = ["ID","Recognition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Total Rewards #001","Total Rewards #002","3.567","4.767","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Total Rewards #002","Total Rewards #003","3.814","2.663","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Total Rewards #003","Total Rewards #004","1.750","5.687","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Total Rewards #004","Total Rewards #005","1.221","1.109","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Total Rewards #005","Total Rewards #001","3.554","2.481","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":871},{"label":"Mar","value":763},{"label":"Abr","value":944},{"label":"Mai","value":570},{"label":"Jun","value":877},{"label":"Jul","value":701},{"label":"Ago","value":867},{"label":"Set","value":792},{"label":"Out","value":895},{"label":"Nov","value":577},{"label":"Dez","value":751}];
const MX = 944;
