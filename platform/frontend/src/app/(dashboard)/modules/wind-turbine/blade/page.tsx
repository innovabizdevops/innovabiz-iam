...
const PAGE = "Blade Inspect";
const KPIS = [{"l":"Total Wind Turbine","v":"4.958","t":"+8.3%","d":"up"},{"l":"Blade Inspect Ativos","v":"6.108","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"66","t":"+16.2%","d":"up"}];
const COLS = ["ID","Blade Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wind Turbine #001","Wind Turbine #002","565","7.483","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Wind Turbine #002","Wind Turbine #003","2.274","2.523","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Wind Turbine #003","Wind Turbine #004","7.994","475","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Wind Turbine #004","Wind Turbine #005","5.792","6.891","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wind Turbine #005","Wind Turbine #001","4.759","5.823","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":575},{"label":"Mar","value":548},{"label":"Abr","value":638},{"label":"Mai","value":718},{"label":"Jun","value":563},{"label":"Jul","value":520},{"label":"Ago","value":609},{"label":"Set","value":569},{"label":"Out","value":566},{"label":"Nov","value":709},{"label":"Dez","value":752}];
const MX = 752;
