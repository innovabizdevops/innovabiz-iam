...
const PAGE = "SCADA";
const KPIS = [{"l":"Dispositivos Online","v":"2.978","t":"+4.2%","d":"up"},{"l":"Dados/Min (MB)","v":"7.427","t":"+5.8%","d":"up"},{"l":"Alertas Ativos","v":"8.501","t":"+5.8%","d":"up"},{"l":"Uptime (%)","v":"92.7%","t":"-5.0%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.453","4.112","3.457","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.114","392","112","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.616","2.064","8.482","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.666","3.462","6.824","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.701","5.998","1.807","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":684},{"label":"Mar","value":422},{"label":"Abr","value":751},{"label":"Mai","value":608},{"label":"Jun","value":523},{"label":"Jul","value":414},{"label":"Ago","value":552},{"label":"Set","value":459},{"label":"Out","value":509},{"label":"Nov","value":561},{"label":"Dez","value":700}];
const MX = 751;
