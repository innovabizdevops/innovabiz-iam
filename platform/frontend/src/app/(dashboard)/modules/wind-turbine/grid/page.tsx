...
const PAGE = "Grid Feed";
const KPIS = [{"l":"Total Wind Turbine","v":"7.961","t":"-5.0%","d":"down"},{"l":"Grid Feed Ativos","v":"4.963","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"92.1%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+3.4%","d":"up"}];
const COLS = ["ID","Grid Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wind Turbine #001","Wind Turbine #002","2.811","8.983","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Wind Turbine #002","Wind Turbine #003","2.461","8.411","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Wind Turbine #003","Wind Turbine #004","557","8.901","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Wind Turbine #004","Wind Turbine #005","2.160","1.987","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wind Turbine #005","Wind Turbine #001","311","6.747","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":270},{"label":"Mar","value":536},{"label":"Abr","value":303},{"label":"Mai","value":381},{"label":"Jun","value":532},{"label":"Jul","value":513},{"label":"Ago","value":593},{"label":"Set","value":542},{"label":"Out","value":628},{"label":"Nov","value":419},{"label":"Dez","value":458}];
const MX = 628;
