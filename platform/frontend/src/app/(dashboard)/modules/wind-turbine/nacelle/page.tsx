...
const PAGE = "Nacelle";
const KPIS = [{"l":"Total Wind Turbine","v":"2.322","t":"+16.9%","d":"up"},{"l":"Nacelle Ativos","v":"8.967","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+16.5%","d":"up"}];
const COLS = ["ID","Nacelle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wind Turbine #001","Wind Turbine #002","4.207","7.510","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Wind Turbine #002","Wind Turbine #003","1.469","3.899","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Wind Turbine #003","Wind Turbine #004","6.057","4.946","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Wind Turbine #004","Wind Turbine #005","2.719","3.439","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wind Turbine #005","Wind Turbine #001","6.898","1.995","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":629},{"label":"Mar","value":595},{"label":"Abr","value":680},{"label":"Mai","value":651},{"label":"Jun","value":550},{"label":"Jul","value":589},{"label":"Ago","value":635},{"label":"Set","value":696},{"label":"Out","value":773},{"label":"Nov","value":911},{"label":"Dez","value":616}];
const MX = 911;
...
export default function NacellePage() {
    return (
