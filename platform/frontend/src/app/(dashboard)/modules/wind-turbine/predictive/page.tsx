...
const ACCENT = "#6366f1";
const MODULE = "Wind Turbine Ops";
const PAGE = "Predictive";
const KPIS = [{"l":"Integrações Ativas","v":"5.495","t":"+16.3%","d":"up"},{"l":"Chamadas/Hora","v":"2349","t":"+2.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.7%","t":"+7.0%","d":"up"},{"l":"Latência Média (ms)","v":"150ms","t":"+17.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.481","1.495","88.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.370","3.575","88.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.051","5.237","77.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.233","1.684","97.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.897","1.819","84.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":278},{"label":"Mar","value":433},{"label":"Abr","value":633},{"label":"Mai","value":542},{"label":"Jun","value":439},{"label":"Jul","value":455},{"label":"Ago","value":628},{"label":"Set","value":487},{"label":"Out","value":485},{"label":"Nov","value":449},{"label":"Dez","value":431}];
const MX = 633;
