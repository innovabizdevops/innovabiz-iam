...
const KPIS = [{"l":"Total Facility Mgmt","v":"6.864","t":"+7.9%","d":"up"},{"l":"Preventive Ativos","v":"2.994","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"83","t":"-0.8%","d":"down"}];
const COLS = ["ID","Preventive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Mgmt #001","Facility Mgmt #002","706","5.696","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Mgmt #002","Facility Mgmt #003","1.290","1.963","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Mgmt #003","Facility Mgmt #004","8.907","3.894","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Mgmt #004","Facility Mgmt #005","1.900","2.692","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Mgmt #005","Facility Mgmt #001","2.425","1.690","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":941},{"label":"Mar","value":740},{"label":"Abr","value":646},{"label":"Mai","value":958},{"label":"Jun","value":923},{"label":"Jul","value":732},{"label":"Ago","value":700},{"label":"Set","value":727},{"label":"Out","value":992},{"label":"Nov","value":602},{"label":"Dez","value":737}];
const MX = 992;
