...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.333","t":"+17.1%","d":"up"},{"l":"Contratos (€M)","v":"€26.3M","t":"+6.9%","d":"up"},{"l":"On-Time Delivery (%)","v":"77.6%","t":"+13.4%","d":"up"},{"l":"Score Médio","v":"81","t":"+16.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.3%","€ 47645.68","6.826","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","73.8%","€ 48563.51","1.900","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.0%","€ 40970.17","790","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","93.4%","€ 30138.95","2.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","94.6%","€ 34925.04","3.905","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":690},{"label":"Mar","value":755},{"label":"Abr","value":606},{"label":"Mai","value":557},{"label":"Jun","value":713},{"label":"Jul","value":460},{"label":"Ago","value":835},{"label":"Set","value":728},{"label":"Out","value":754},{"label":"Nov","value":746},{"label":"Dez","value":458}];
const MX = 835;
