...
const KPIS = [{"l":"Total Facility Mgmt","v":"3.425","t":"-4.6%","d":"down"},{"l":"Work Order Ativos","v":"3.260","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"65","t":"-5.2%","d":"down"}];
const COLS = ["ID","Work Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Mgmt #001","Facility Mgmt #002","4.297","7.721","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Mgmt #002","Facility Mgmt #003","2.598","1.985","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Mgmt #003","Facility Mgmt #004","1.902","5.991","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Mgmt #004","Facility Mgmt #005","2.501","5.531","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Mgmt #005","Facility Mgmt #001","8.855","3.630","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":498},{"label":"Mar","value":698},{"label":"Abr","value":493},{"label":"Mai","value":564},{"label":"Jun","value":714},{"label":"Jul","value":421},{"label":"Ago","value":666},{"label":"Set","value":710},{"label":"Out","value":760},{"label":"Nov","value":736},{"label":"Dez","value":560}];
const MX = 760;
