...
const ACCENT = "#6366f1";
const MODULE = "Facility Mgmt";
const PAGE = "CAFM";
const KPIS = [{"l":"Total Facility Mgmt","v":"6.566","t":"+6.1%","d":"up"},{"l":"CAFM Ativos","v":"2.453","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"82","t":"-5.5%","d":"down"}];
const COLS = ["ID","CAFM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Mgmt #001","Facility Mgmt #002","4.911","3.283","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Mgmt #002","Facility Mgmt #003","7.555","5.502","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Mgmt #003","Facility Mgmt #004","1.834","6.902","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Mgmt #004","Facility Mgmt #005","6.420","1.902","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Mgmt #005","Facility Mgmt #001","7.566","1.331","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":634},{"label":"Mar","value":478},{"label":"Abr","value":707},{"label":"Mai","value":646},{"label":"Jun","value":570},{"label":"Jul","value":405},{"label":"Ago","value":357},{"label":"Set","value":386},{"label":"Out","value":368},{"label":"Nov","value":601},{"label":"Dez","value":671}];
const MX = 707;
...
export default function CafmPage() {
    return (
