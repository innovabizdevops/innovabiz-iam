...
const ACCENT = "#059669";
const MODULE = "Developer Portal Deep";
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"3.651","t":"+4.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.3%","t":"+16.4%","d":"up"},{"l":"MTTR (h)","v":"188h","t":"-2.5%","d":"down"},{"l":"Satisfação (%)","v":"81.2%","t":"+13.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.328","6.377","1.552","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.361","2.934","8.373","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.370","417","3.557","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","9.050","6.665","4.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.225","1.133","5.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":741},{"label":"Mar","value":744},{"label":"Abr","value":1037},{"label":"Mai","value":964},{"label":"Jun","value":753},{"label":"Jul","value":788},{"label":"Ago","value":953},{"label":"Set","value":789},{"label":"Out","value":956},{"label":"Nov","value":958},{"label":"Dez","value":708}];
const MX = 1037;
