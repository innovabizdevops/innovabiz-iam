...
/* ═══ Developer Portal Deep — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "190", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "808", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€362K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "375764490", cells: ["DEV-6490", "Developer Portal Deep Item 1", "11/7/2026", "€14 590"], status: "active" as const },
    { id: "375768061", cells: ["DEV-1061", "Developer Portal Deep Item 2", "26/2/2026", "€18 161"], status: "pending" as const },
    { id: "375771632", cells: ["DEV-4632", "Developer Portal Deep Item 3", "13/9/2026", "€21 732"], status: "completed" as const },
    { id: "375775203", cells: ["DEV-8203", "Developer Portal Deep Item 4", "28/4/2026", "€25 303"], status: "warning" as const },
    { id: "375778774", cells: ["DEV-2774", "Developer Portal Deep Item 5", "15/11/2026", "€28 874"], status: "active" as const },
];
...
export default function DeveloperPortalDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Developer Portal Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Developer Portal Deep</p>
                    </div>
                </div>
