...
const ACCENT = "#6366f1";
const MODULE = "Earthwork Management";
const PAGE = "GPS Machine";
const KPIS = [{"l":"Total Earthwork Mgmt","v":"2.548","t":"+2.0%","d":"up"},{"l":"GPS Machine Ativos","v":"4.266","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"62","t":"+10.5%","d":"up"}];
const COLS = ["ID","GPS Machine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Earthwork Mgmt #001","Earthwork Mgmt #002","1.407","2.574","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Earthwork Mgmt #002","Earthwork Mgmt #003","6.361","7.580","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Earthwork Mgmt #003","Earthwork Mgmt #004","3.589","7.899","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Earthwork Mgmt #004","Earthwork Mgmt #005","8.513","2.540","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Earthwork Mgmt #005","Earthwork Mgmt #001","4.629","2.132","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1010},{"label":"Fev","value":919},{"label":"Mar","value":927},{"label":"Abr","value":769},{"label":"Mai","value":901},{"label":"Jun","value":922},{"label":"Jul","value":895},{"label":"Ago","value":897},{"label":"Set","value":823},{"label":"Out","value":770},{"label":"Nov","value":1019},{"label":"Dez","value":762}];
const MX = 1019;
