...
const PAGE = "Volume";
const KPIS = [{"l":"Total Earthwork Mgmt","v":"5.092","t":"-3.8%","d":"down"},{"l":"Volume Ativos","v":"3.910","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"90","t":"+16.5%","d":"up"}];
const COLS = ["ID","Volume","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Earthwork Mgmt #001","Earthwork Mgmt #002","1.263","2.990","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Earthwork Mgmt #002","Earthwork Mgmt #003","4.846","2.271","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Earthwork Mgmt #003","Earthwork Mgmt #004","9.043","973","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Earthwork Mgmt #004","Earthwork Mgmt #005","9.006","4.229","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Earthwork Mgmt #005","Earthwork Mgmt #001","7.974","4.150","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":512},{"label":"Mar","value":475},{"label":"Abr","value":713},{"label":"Mai","value":469},{"label":"Jun","value":489},{"label":"Jul","value":697},{"label":"Ago","value":527},{"label":"Set","value":713},{"label":"Out","value":704},{"label":"Nov","value":473},{"label":"Dez","value":650}];
const MX = 713;
