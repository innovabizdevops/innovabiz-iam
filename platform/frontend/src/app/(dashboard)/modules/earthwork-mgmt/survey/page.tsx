...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"7.419","t":"-3.0%","d":"down"},{"l":"Respostas/Semana","v":"415","t":"+8.2%","d":"up"},{"l":"NPS Médio","v":"57","t":"+5.9%","d":"up"},{"l":"Taxa Resposta (%)","v":"92.7%","t":"+10.1%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","634","94","96.1%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","201","77","83.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.956","62","90.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","5.063","67","83.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.123","60","94.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":818},{"label":"Mar","value":699},{"label":"Abr","value":713},{"label":"Mai","value":614},{"label":"Jun","value":772},{"label":"Jul","value":817},{"label":"Ago","value":771},{"label":"Set","value":809},{"label":"Out","value":795},{"label":"Nov","value":700},{"label":"Dez","value":942}];
const MX = 942;
