...
const PAGE = "Excavate";
const KPIS = [{"l":"Total Earthwork Mgmt","v":"8.212","t":"-2.5%","d":"down"},{"l":"Excavate Ativos","v":"4.445","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+17.7%","d":"up"}];
const COLS = ["ID","Excavate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Earthwork Mgmt #001","Earthwork Mgmt #002","8.666","7.662","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Earthwork Mgmt #002","Earthwork Mgmt #003","1.208","6.476","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Earthwork Mgmt #003","Earthwork Mgmt #004","3.697","7.363","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Earthwork Mgmt #004","Earthwork Mgmt #005","3.415","2.242","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Earthwork Mgmt #005","Earthwork Mgmt #001","8.757","4.743","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":655},{"label":"Mar","value":583},{"label":"Abr","value":712},{"label":"Mai","value":774},{"label":"Jun","value":804},{"label":"Jul","value":657},{"label":"Ago","value":495},{"label":"Set","value":849},{"label":"Out","value":485},{"label":"Nov","value":596},{"label":"Dez","value":716}];
const MX = 849;
