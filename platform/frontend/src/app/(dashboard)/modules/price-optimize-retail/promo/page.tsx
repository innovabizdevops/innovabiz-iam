...
const PAGE = "Promo Sim";
const KPIS = [{"l":"Pedidos/Dia","v":"2177","t":"+6.3%","d":"up"},{"l":"GMV (€)","v":"€63891","t":"+14.5%","d":"up"},{"l":"Conversão (%)","v":"67.5%","t":"+17.3%","d":"up"},{"l":"AOV (€)","v":"€27590","t":"-5.8%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 28315.87","3.826","1.119","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 3450.92","1.818","7.989","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 17978.27","6.840","1.366","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 44923.24","2.684","805","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 17255.36","1.064","2.336","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":740},{"label":"Mar","value":958},{"label":"Abr","value":756},{"label":"Mai","value":824},{"label":"Jun","value":670},{"label":"Jul","value":967},{"label":"Ago","value":911},{"label":"Set","value":922},{"label":"Out","value":813},{"label":"Nov","value":833},{"label":"Dez","value":902}];
const MX = 1000;
