...
const PAGE = "Margin Guard";
const KPIS = [{"l":"Pedidos/Dia","v":"2206","t":"+7.1%","d":"up"},{"l":"GMV (€)","v":"€9076","t":"+8.4%","d":"up"},{"l":"Conversão (%)","v":"93.0%","t":"-0.2%","d":"down"},{"l":"AOV (€)","v":"€7413","t":"-1.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 40715.04","2.578","3.039","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 12498.48","4.169","2.139","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 17039.89","6.534","4.555","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 25006.08","7.295","7.808","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 6810.11","6.513","6.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":798},{"label":"Mar","value":600},{"label":"Abr","value":735},{"label":"Mai","value":567},{"label":"Jun","value":790},{"label":"Jul","value":541},{"label":"Ago","value":575},{"label":"Set","value":489},{"label":"Out","value":555},{"label":"Nov","value":584},{"label":"Dez","value":470}];
const MX = 798;
