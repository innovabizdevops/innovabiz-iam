...
const PAGE = "Duty";
const KPIS = [{"l":"Total Import Mgmt","v":"3.810","t":"+0.5%","d":"up"},{"l":"Duty Ativos","v":"3.323","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"89","t":"+3.4%","d":"up"}];
const COLS = ["ID","Duty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Import Mgmt #001","Import Mgmt #002","3.111","4.395","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Import Mgmt #002","Import Mgmt #003","7.122","5.259","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Import Mgmt #003","Import Mgmt #004","6.355","6.674","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Import Mgmt #004","Import Mgmt #005","1.728","3.941","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Import Mgmt #005","Import Mgmt #001","1.447","2.877","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":976},{"label":"Mar","value":892},{"label":"Abr","value":817},{"label":"Mai","value":959},{"label":"Jun","value":983},{"label":"Jul","value":751},{"label":"Ago","value":896},{"label":"Set","value":791},{"label":"Out","value":810},{"label":"Nov","value":732},{"label":"Dez","value":671}];
const MX = 983;
