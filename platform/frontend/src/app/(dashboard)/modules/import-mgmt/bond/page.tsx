...
const PAGE = "Bond";
const KPIS = [{"l":"Total Import Mgmt","v":"6.706","t":"-1.4%","d":"down"},{"l":"Bond Ativos","v":"2.090","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"72","t":"+14.8%","d":"up"}];
const COLS = ["ID","Bond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Import Mgmt #001","Import Mgmt #002","8.892","6.598","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Import Mgmt #002","Import Mgmt #003","6.014","6.578","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Import Mgmt #003","Import Mgmt #004","5.217","1.739","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Import Mgmt #004","Import Mgmt #005","6.012","1.243","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Import Mgmt #005","Import Mgmt #001","1.521","4.822","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":367},{"label":"Fev","value":554},{"label":"Mar","value":367},{"label":"Abr","value":433},{"label":"Mai","value":448},{"label":"Jun","value":582},{"label":"Jul","value":629},{"label":"Ago","value":483},{"label":"Set","value":659},{"label":"Out","value":622},{"label":"Nov","value":434},{"label":"Dez","value":633}];
const MX = 659;
