...
const PAGE = "Report";
const KPIS = [{"l":"Total Import Mgmt","v":"4.656","t":"+8.3%","d":"up"},{"l":"Report Ativos","v":"2.176","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"62","t":"-3.4%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Import Mgmt #001","Import Mgmt #002","5.030","370","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Import Mgmt #002","Import Mgmt #003","5.296","1.114","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Import Mgmt #003","Import Mgmt #004","8.824","6.589","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Import Mgmt #004","Import Mgmt #005","328","2.054","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Import Mgmt #005","Import Mgmt #001","6.483","7.919","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":507},{"label":"Mar","value":725},{"label":"Abr","value":706},{"label":"Mai","value":678},{"label":"Jun","value":540},{"label":"Jul","value":830},{"label":"Ago","value":533},{"label":"Set","value":837},{"label":"Out","value":758},{"label":"Nov","value":859},{"label":"Dez","value":508}];
const MX = 859;
