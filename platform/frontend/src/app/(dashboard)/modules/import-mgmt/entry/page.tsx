...
const PAGE = "Entry";
const KPIS = [{"l":"Total Import Mgmt","v":"3.720","t":"-0.2%","d":"down"},{"l":"Entry Ativos","v":"1.697","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+7.5%","d":"up"}];
const COLS = ["ID","Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Import Mgmt #001","Import Mgmt #002","700","3.463","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Import Mgmt #002","Import Mgmt #003","8.216","5.038","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Import Mgmt #003","Import Mgmt #004","545","3.077","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Import Mgmt #004","Import Mgmt #005","5.889","9.048","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Import Mgmt #005","Import Mgmt #001","3.292","2.748","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":1015},{"label":"Mar","value":806},{"label":"Abr","value":1006},{"label":"Mai","value":958},{"label":"Jun","value":893},{"label":"Jul","value":1085},{"label":"Ago","value":727},{"label":"Set","value":878},{"label":"Out","value":831},{"label":"Nov","value":950},{"label":"Dez","value":841}];
const MX = 1085;
