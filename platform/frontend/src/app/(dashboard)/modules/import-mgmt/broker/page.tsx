...
const ACCENT = "#6366f1";
const MODULE = "Import Management";
const PAGE = "Broker";
const KPIS = [{"l":"Total Import Mgmt","v":"5.789","t":"-5.2%","d":"down"},{"l":"Broker Ativos","v":"6.639","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"94","t":"+16.2%","d":"up"}];
const COLS = ["ID","Broker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Import Mgmt #001","Import Mgmt #002","7.554","5.707","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Import Mgmt #002","Import Mgmt #003","6.011","4.115","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Import Mgmt #003","Import Mgmt #004","4.622","3.112","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Import Mgmt #004","Import Mgmt #005","5.113","8.620","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Import Mgmt #005","Import Mgmt #001","3.366","252","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":610},{"label":"Mar","value":657},{"label":"Abr","value":749},{"label":"Mai","value":535},{"label":"Jun","value":656},{"label":"Jul","value":857},{"label":"Ago","value":792},{"label":"Set","value":474},{"label":"Out","value":655},{"label":"Nov","value":573},{"label":"Dez","value":551}];
const MX = 857;
