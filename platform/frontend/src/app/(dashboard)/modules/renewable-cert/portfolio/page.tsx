...
const KPIS = [{"l":"Total Renewable Cert","v":"5.371","t":"+9.7%","d":"up"},{"l":"Portfolio Ativos","v":"8.228","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"88.1%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.6%","d":"up"}];
const COLS = ["ID","Portfolio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Cert #001","Renewable Cert #002","2.792","7.097","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Cert #002","Renewable Cert #003","4.853","4.171","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Cert #003","Renewable Cert #004","1.752","3.177","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Cert #004","Renewable Cert #005","4.550","414","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Cert #005","Renewable Cert #001","4.544","129","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":836},{"label":"Mar","value":607},{"label":"Abr","value":534},{"label":"Mai","value":548},{"label":"Jun","value":511},{"label":"Jul","value":813},{"label":"Ago","value":756},{"label":"Set","value":574},{"label":"Out","value":747},{"label":"Nov","value":820},{"label":"Dez","value":548}];
const MX = 836;
