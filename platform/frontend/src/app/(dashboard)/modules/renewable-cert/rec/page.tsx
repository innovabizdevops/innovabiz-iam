...
const ACCENT = "#65a30d";
const MODULE = "Renewable Certificates";
const PAGE = "REC Tracking";
const KPIS = [{"l":"Total Renewable Cert","v":"3.842","t":"+14.9%","d":"up"},{"l":"REC Tracking Ativos","v":"7.790","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"83.7%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"65","t":"-3.8%","d":"down"}];
const COLS = ["ID","REC Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Cert #001","Renewable Cert #002","3.230","7.955","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Cert #002","Renewable Cert #003","4.931","5.796","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Cert #003","Renewable Cert #004","948","8.326","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Cert #004","Renewable Cert #005","5.519","1.413","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Cert #005","Renewable Cert #001","5.336","7.560","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":753},{"label":"Mar","value":698},{"label":"Abr","value":878},{"label":"Mai","value":897},{"label":"Jun","value":725},{"label":"Jul","value":938},{"label":"Ago","value":915},{"label":"Set","value":972},{"label":"Out","value":783},{"label":"Nov","value":699},{"label":"Dez","value":761}];
const MX = 972;
