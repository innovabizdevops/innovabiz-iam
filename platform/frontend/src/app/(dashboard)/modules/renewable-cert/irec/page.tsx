...
const PAGE = "I-REC";
const KPIS = [{"l":"Total Renewable Cert","v":"8.095","t":"+0.2%","d":"up"},{"l":"I REC Ativos","v":"5.996","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"78.2%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"81","t":"+10.0%","d":"up"}];
const COLS = ["ID","I REC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Cert #001","Renewable Cert #002","5.935","1.513","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Cert #002","Renewable Cert #003","4.277","4.692","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Cert #003","Renewable Cert #004","8.953","5.845","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Cert #004","Renewable Cert #005","2.217","1.112","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Cert #005","Renewable Cert #001","8.363","4.678","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":554},{"label":"Mar","value":481},{"label":"Abr","value":487},{"label":"Mai","value":730},{"label":"Jun","value":744},{"label":"Jul","value":569},{"label":"Ago","value":667},{"label":"Set","value":437},{"label":"Out","value":704},{"label":"Nov","value":738},{"label":"Dez","value":455}];
const MX = 744;
