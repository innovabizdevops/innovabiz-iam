...
const PAGE = "Retirement";
const KPIS = [{"l":"Total Renewable Cert","v":"3.265","t":"+14.4%","d":"up"},{"l":"Retirement Ativos","v":"1.537","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+2.9%","d":"up"}];
const COLS = ["ID","Retirement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Cert #001","Renewable Cert #002","1.944","7.131","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Cert #002","Renewable Cert #003","2.555","3.564","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Cert #003","Renewable Cert #004","6.635","1.073","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Cert #004","Renewable Cert #005","8.113","8.828","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Cert #005","Renewable Cert #001","8.572","3.794","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":454},{"label":"Mar","value":517},{"label":"Abr","value":558},{"label":"Mai","value":305},{"label":"Jun","value":650},{"label":"Jul","value":606},{"label":"Ago","value":391},{"label":"Set","value":681},{"label":"Out","value":451},{"label":"Nov","value":542},{"label":"Dez","value":494}];
const MX = 681;
