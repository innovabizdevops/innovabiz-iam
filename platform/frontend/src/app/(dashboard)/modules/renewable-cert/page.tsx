...
export default function RenewableCertPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Renewable Cert</h1><p className="text-sm text-muted-foreground">Renewable Cert • iBOS Enterprise</p></div>
