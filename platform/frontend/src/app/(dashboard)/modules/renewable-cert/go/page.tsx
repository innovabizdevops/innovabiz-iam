...
const PAGE = "GO Registry";
const KPIS = [{"l":"Total Renewable Cert","v":"1.048","t":"+17.2%","d":"up"},{"l":"GO Registry Ativos","v":"7.014","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.6%","d":"up"}];
const COLS = ["ID","GO Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renewable Cert #001","Renewable Cert #002","2.187","7.811","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Renewable Cert #002","Renewable Cert #003","645","602","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Renewable Cert #003","Renewable Cert #004","904","5.521","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Renewable Cert #004","Renewable Cert #005","6.438","2.708","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renewable Cert #005","Renewable Cert #001","7.488","4.519","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":928},{"label":"Mar","value":968},{"label":"Abr","value":839},{"label":"Mai","value":816},{"label":"Jun","value":769},{"label":"Jul","value":921},{"label":"Ago","value":793},{"label":"Set","value":734},{"label":"Out","value":630},{"label":"Nov","value":643},{"label":"Dez","value":966}];
const MX = 968;
