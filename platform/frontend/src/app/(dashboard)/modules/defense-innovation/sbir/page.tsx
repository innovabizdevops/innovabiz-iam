...
const PAGE = "SBIR";
const KPIS = [{"l":"Ideias Submetidas","v":"6.811","t":"+9.2%","d":"up"},{"l":"Patentes (YTD)","v":"1.612","t":"+11.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.705","t":"+4.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€4.5M","t":"+3.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","351","89.1%","1.457","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.550","80.3%","5.661","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.415","98.7%","5.420","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.515","82.1%","4.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.204","81.4%","7.115","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":746},{"label":"Mar","value":691},{"label":"Abr","value":518},{"label":"Mai","value":542},{"label":"Jun","value":638},{"label":"Jul","value":438},{"label":"Ago","value":781},{"label":"Set","value":485},{"label":"Out","value":583},{"label":"Nov","value":559},{"label":"Dez","value":771}];
const MX = 781;
