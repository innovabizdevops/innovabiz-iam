...
const KPIS = [{"l":"Ideias Submetidas","v":"4.461","t":"+17.9%","d":"up"},{"l":"Patentes (YTD)","v":"8.963","t":"+5.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.971","t":"+17.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€11.9M","t":"+11.0%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.903","83.2%","2.238","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.847","76.5%","4.076","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.398","80.4%","2.392","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","227","79.9%","4.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.688","86.9%","5.460","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1046},{"label":"Fev","value":972},{"label":"Mar","value":988},{"label":"Abr","value":822},{"label":"Mai","value":725},{"label":"Jun","value":989},{"label":"Jul","value":937},{"label":"Ago","value":750},{"label":"Set","value":863},{"label":"Out","value":841},{"label":"Nov","value":852},{"label":"Dez","value":741}];
const MX = 1046;
