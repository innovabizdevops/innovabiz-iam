...
const ACCENT = "#6366f1";
const MODULE = "Defense Innovation";
const PAGE = "Tech Scout";
const KPIS = [{"l":"Ideias Submetidas","v":"5.888","t":"+2.8%","d":"up"},{"l":"Patentes (YTD)","v":"1.891","t":"+3.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.203","t":"+12.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€40.6M","t":"+0.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.959","77.3%","617","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.343","87.7%","6.744","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.431","90.0%","4.264","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.955","79.7%","6.993","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.053","98.8%","6.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":611},{"label":"Mar","value":372},{"label":"Abr","value":419},{"label":"Mai","value":464},{"label":"Jun","value":451},{"label":"Jul","value":437},{"label":"Ago","value":432},{"label":"Set","value":373},{"label":"Out","value":374},{"label":"Nov","value":341},{"label":"Dez","value":622}];
const MX = 622;
