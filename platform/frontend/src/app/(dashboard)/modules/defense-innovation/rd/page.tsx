...
const PAGE = "R&amp;D";
const KPIS = [{"l":"Ideias Submetidas","v":"3.996","t":"+-0.0%","d":"up"},{"l":"Patentes (YTD)","v":"6.494","t":"-3.2%","d":"down"},{"l":"Projetos Innovation Lab","v":"1.929","t":"-1.5%","d":"down"},{"l":"Budget I&D (€M)","v":"€37.7M","t":"+11.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.762","72.3%","7.966","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.283","95.9%","8.240","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.269","98.6%","5.376","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.248","90.5%","8.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.455","70.6%","877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":649},{"label":"Mar","value":739},{"label":"Abr","value":387},{"label":"Mai","value":417},{"label":"Jun","value":525},{"label":"Jul","value":655},{"label":"Ago","value":510},{"label":"Set","value":709},{"label":"Out","value":653},{"label":"Nov","value":632},{"label":"Dez","value":463}];
const MX = 739;
