...
const KPIS = [{"l":"Ideias Submetidas","v":"3.744","t":"+15.1%","d":"up"},{"l":"Patentes (YTD)","v":"2.794","t":"+9.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.661","t":"+16.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€46.1M","t":"+1.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.852","70.3%","3.930","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.986","73.1%","5.245","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","376","91.0%","3.398","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.058","91.4%","2.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.401","81.2%","2.978","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":636},{"label":"Mar","value":959},{"label":"Abr","value":807},{"label":"Mai","value":822},{"label":"Jun","value":790},{"label":"Jul","value":672},{"label":"Ago","value":763},{"label":"Set","value":651},{"label":"Out","value":968},{"label":"Nov","value":712},{"label":"Dez","value":987}];
const MX = 987;
