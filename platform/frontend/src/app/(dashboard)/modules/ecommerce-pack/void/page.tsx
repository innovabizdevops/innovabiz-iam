...
const ACCENT = "#713f12";
const MODULE = "E-Commerce Packaging";
const PAGE = "Void Fill";
const KPIS = [{"l":"Pedidos/Dia","v":"939","t":"+8.6%","d":"up"},{"l":"GMV (€)","v":"€71677","t":"+7.9%","d":"up"},{"l":"Conversão (%)","v":"76.0%","t":"+9.5%","d":"up"},{"l":"AOV (€)","v":"€16149","t":"-2.3%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 36815.32","7.433","7.787","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 35169.36","5.246","1.065","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 8477.17","3.970","1.582","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20997.72","6.450","4.727","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 1832.65","8.433","8.784","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":962},{"label":"Mar","value":760},{"label":"Abr","value":882},{"label":"Mai","value":877},{"label":"Jun","value":935},{"label":"Jul","value":998},{"label":"Ago","value":922},{"label":"Set","value":1018},{"label":"Out","value":813},{"label":"Nov","value":864},{"label":"Dez","value":681}];
const MX = 1018;
