...
const PAGE = "Sustain";
const KPIS = [{"l":"Pedidos/Dia","v":"2264","t":"-0.1%","d":"down"},{"l":"GMV (€)","v":"€99497","t":"+1.0%","d":"up"},{"l":"Conversão (%)","v":"77.5%","t":"+8.5%","d":"up"},{"l":"AOV (€)","v":"€60989","t":"+10.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 49412.36","2.479","5.889","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20413.98","1.201","8.495","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 25008.47","8.327","6.632","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17598.74","7.678","1.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 22250.57","4.329","8.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":386},{"label":"Mar","value":497},{"label":"Abr","value":638},{"label":"Mai","value":658},{"label":"Jun","value":582},{"label":"Jul","value":680},{"label":"Ago","value":640},{"label":"Set","value":416},{"label":"Out","value":642},{"label":"Nov","value":646},{"label":"Dez","value":596}];
const MX = 717;
