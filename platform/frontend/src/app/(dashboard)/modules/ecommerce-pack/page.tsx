...
/* ═══ E-Commerce Packaging — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "2179", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4046", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€212K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1481903379", cells: ["ECO-9379", "E-Commerce Packaging Item 1", "20/4/2026", "€3479"], status: "active" as const },
    { id: "1481906950", cells: ["ECO-3950", "E-Commerce Packaging Item 2", "7/11/2026", "€7050"], status: "pending" as const },
    { id: "1481910521", cells: ["ECO-7521", "E-Commerce Packaging Item 3", "22/6/2026", "€10 621"], status: "completed" as const },
    { id: "1481914092", cells: ["ECO-2092", "E-Commerce Packaging Item 4", "9/1/2026", "€14 192"], status: "warning" as const },
    { id: "1481917663", cells: ["ECO-5663", "E-Commerce Packaging Item 5", "24/8/2026", "€17 763"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">E-Commerce Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • E-Commerce Packaging</p>
                    </div>
                </div>
