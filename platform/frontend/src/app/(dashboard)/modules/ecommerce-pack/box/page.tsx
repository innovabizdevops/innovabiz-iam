...
const PAGE = "Box";
const KPIS = [{"l":"Pedidos/Dia","v":"4708","t":"+9.0%","d":"up"},{"l":"GMV (€)","v":"€91436","t":"+2.1%","d":"up"},{"l":"Conversão (%)","v":"87.9%","t":"+17.2%","d":"up"},{"l":"AOV (€)","v":"€58941","t":"-0.4%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 36300.28","8.820","3.976","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 27664.29","4.212","8.255","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 12890.00","826","2.335","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 48190.08","8.377","8.318","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 49845.89","1.442","5.376","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":233},{"label":"Fev","value":601},{"label":"Mar","value":214},{"label":"Abr","value":432},{"label":"Mai","value":356},{"label":"Jun","value":584},{"label":"Jul","value":447},{"label":"Ago","value":536},{"label":"Set","value":284},{"label":"Out","value":429},{"label":"Nov","value":236},{"label":"Dez","value":288}];
const MX = 601;
