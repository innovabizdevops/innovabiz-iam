...
const PAGE = "Brand";
const KPIS = [{"l":"Dashboards Ativos","v":"1.623","t":"+1.0%","d":"up"},{"l":"Queries/Dia","v":"4501","t":"+11.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.258","t":"-3.6%","d":"down"},{"l":"Utilizadores Analytics","v":"2.587","t":"+13.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3941","2026-01-10","996","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3439","2026-03-04","9.016","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1294","2026-03-14","3.534","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","173","2026-02-14","6.095","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1201","2026-03-03","2.945","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":707},{"label":"Mar","value":538},{"label":"Abr","value":780},{"label":"Mai","value":813},{"label":"Jun","value":733},{"label":"Jul","value":448},{"label":"Ago","value":690},{"label":"Set","value":490},{"label":"Out","value":558},{"label":"Nov","value":724},{"label":"Dez","value":645}];
const MX = 813;
