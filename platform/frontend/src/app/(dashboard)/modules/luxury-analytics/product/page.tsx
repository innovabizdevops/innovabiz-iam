...
const PAGE = "Product";
const KPIS = [{"l":"Dashboards Ativos","v":"3.154","t":"+4.1%","d":"up"},{"l":"Queries/Dia","v":"732","t":"-1.9%","d":"down"},{"l":"Dados Processados (GB)","v":"2.807","t":"+11.1%","d":"up"},{"l":"Utilizadores Analytics","v":"1.792","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4966","2026-02-07","6.701","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3113","2026-01-25","5.830","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4200","2026-03-26","8.543","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1258","2026-02-13","6.962","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1576","2026-01-09","3.724","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":516},{"label":"Mar","value":769},{"label":"Abr","value":532},{"label":"Mai","value":628},{"label":"Jun","value":761},{"label":"Jul","value":683},{"label":"Ago","value":643},{"label":"Set","value":578},{"label":"Out","value":426},{"label":"Nov","value":487},{"label":"Dez","value":631}];
const MX = 769;
