...
const PAGE = "Channel";
const KPIS = [{"l":"Dashboards Ativos","v":"4.988","t":"+11.8%","d":"up"},{"l":"Queries/Dia","v":"4219","t":"+9.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.274","t":"+2.1%","d":"up"},{"l":"Utilizadores Analytics","v":"672","t":"+4.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","258","2026-01-24","8.659","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","556","2026-03-17","981","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3931","2026-03-09","8.030","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4038","2026-02-07","7.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3679","2026-03-07","3.007","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":700},{"label":"Mar","value":459},{"label":"Abr","value":526},{"label":"Mai","value":657},{"label":"Jun","value":580},{"label":"Jul","value":713},{"label":"Ago","value":594},{"label":"Set","value":578},{"label":"Out","value":559},{"label":"Nov","value":591},{"label":"Dez","value":601}];
const MX = 713;
