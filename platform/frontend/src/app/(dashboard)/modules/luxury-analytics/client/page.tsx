...
const PAGE = "Client";
const KPIS = [{"l":"Dashboards Ativos","v":"8.997","t":"-0.2%","d":"down"},{"l":"Queries/Dia","v":"4906","t":"+0.6%","d":"up"},{"l":"Dados Processados (GB)","v":"1.311","t":"+16.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.381","t":"+10.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","642","2026-02-27","7.615","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4191","2026-02-20","2.362","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2100","2026-02-07","1.916","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1059","2026-03-28","219","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4325","2026-01-03","6.653","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":495},{"label":"Mar","value":548},{"label":"Abr","value":818},{"label":"Mai","value":821},{"label":"Jun","value":648},{"label":"Jul","value":536},{"label":"Ago","value":486},{"label":"Set","value":753},{"label":"Out","value":842},{"label":"Nov","value":790},{"label":"Dez","value":558}];
const MX = 842;
