...
const ACCENT = "#713f12";
const MODULE = "Luxury Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"2.779","t":"+17.9%","d":"up"},{"l":"Queries/Dia","v":"3282","t":"+14.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.003","t":"+5.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.546","t":"+1.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2986","2026-02-09","8.320","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","870","2026-02-09","5.472","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4416","2026-02-12","2.211","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3316","2026-02-01","3.720","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3429","2026-02-09","4.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":397},{"label":"Mar","value":614},{"label":"Abr","value":322},{"label":"Mai","value":479},{"label":"Jun","value":592},{"label":"Jul","value":601},{"label":"Ago","value":480},{"label":"Set","value":355},{"label":"Out","value":528},{"label":"Nov","value":658},{"label":"Dez","value":455}];
const MX = 658;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#713f12'}}>AI</span></h1>
                </div>
