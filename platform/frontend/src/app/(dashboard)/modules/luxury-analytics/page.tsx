...
const KPIS = [
    ...
    { label: "Ativos", value: "4873", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€65K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1746898387", cells: ["LUX-8387", "Luxury Analytics Item 1", "4/8/2026", "€48 487"], status: "active" as const },
    { id: "1746901958", cells: ["LUX-2958", "Luxury Analytics Item 2", "19/3/2026", "€2058"], status: "pending" as const },
    { id: "1746905529", cells: ["LUX-6529", "Luxury Analytics Item 3", "6/10/2026", "€5629"], status: "completed" as const },
    { id: "1746909100", cells: ["LUX-1100", "Luxury Analytics Item 4", "21/5/2026", "€9200"], status: "warning" as const },
    { id: "1746912671", cells: ["LUX-4671", "Luxury Analytics Item 5", "8/12/2026", "€12 771"], status: "active" as const },
];
...
export default function LuxuryAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Luxury Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Luxury Analytics</p>
                    </div>
                </div>
