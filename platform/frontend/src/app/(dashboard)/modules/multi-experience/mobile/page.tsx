...
const PAGE = "Mobile";
const KPIS = [{"l":"Perfis Unificados","v":"1.097","t":"+0.8%","d":"up"},{"l":"Segmentos Ativos","v":"4.299","t":"-3.7%","d":"down"},{"l":"NPS Score","v":"79","t":"-3.9%","d":"down"},{"l":"Churn Previsto (%)","v":"81.3%","t":"+17.7%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","5.512","€ 41361.89","84.1%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","4.420","€ 21441.83","93.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.154","€ 30561.52","89.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.344","€ 18781.29","75.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.376","€ 3080.77","83.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":593},{"label":"Mar","value":531},{"label":"Abr","value":571},{"label":"Mai","value":475},{"label":"Jun","value":652},{"label":"Jul","value":677},{"label":"Ago","value":646},{"label":"Set","value":779},{"label":"Out","value":724},{"label":"Nov","value":555},{"label":"Dez","value":485}];
const MX = 808;
