...
/* ═══ Multi-Experience Platform — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "8035", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1274", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€132K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "325252635", cells: ["MUL-2635", "Multi-Experience Platform Item 1", "16/4/2026", "€2735"], status: "active" as const },
    { id: "325256206", cells: ["MUL-6206", "Multi-Experience Platform Item 2", "3/11/2026", "€6306"], status: "pending" as const },
    { id: "325259777", cells: ["MUL-9777", "Multi-Experience Platform Item 3", "18/6/2026", "€9877"], status: "completed" as const },
    { id: "325263348", cells: ["MUL-4348", "Multi-Experience Platform Item 4", "5/1/2026", "€13 448"], status: "warning" as const },
    { id: "325266919", cells: ["MUL-7919", "Multi-Experience Platform Item 5", "20/8/2026", "€17 019"], status: "active" as const },
];
...
export default function MultiexperiencePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Experience Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Experience Platform</p>
                    </div>
                </div>
