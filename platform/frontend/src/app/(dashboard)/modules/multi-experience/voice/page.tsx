...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Experience Platform";
const PAGE = "Voice";
const KPIS = [{"l":"Perfis Unificados","v":"5.360","t":"-1.5%","d":"down"},{"l":"Segmentos Ativos","v":"7.045","t":"+10.6%","d":"up"},{"l":"NPS Score","v":"83","t":"-1.3%","d":"down"},{"l":"Churn Previsto (%)","v":"88.7%","t":"-3.0%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","5.633","€ 14198.62","78.3%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","3.916","€ 4754.60","99.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","7.468","€ 32962.18","92.0%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.873","€ 14698.97","97.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","4.907","€ 14166.87","85.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":711},{"label":"Mar","value":665},{"label":"Abr","value":887},{"label":"Mai","value":569},{"label":"Jun","value":797},{"label":"Jul","value":945},{"label":"Ago","value":614},{"label":"Set","value":638},{"label":"Out","value":746},{"label":"Nov","value":630},{"label":"Dez","value":867}];
const MX = 945;
