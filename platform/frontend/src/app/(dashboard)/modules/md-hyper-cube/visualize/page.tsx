...
const KPIS = [{"l":"Dashboards Ativos","v":"3.056","t":"+4.2%","d":"up"},{"l":"Queries/Dia","v":"821","t":"+10.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.546","t":"-3.8%","d":"down"},{"l":"Utilizadores Analytics","v":"5.227","t":"+1.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3960","2026-02-22","3.794","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","513","2026-02-04","2.846","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","699","2026-02-25","6.455","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4552","2026-03-11","4.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4963","2026-03-10","3.659","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":507},{"label":"Mar","value":627},{"label":"Abr","value":630},{"label":"Mai","value":528},{"label":"Jun","value":691},{"label":"Jul","value":608},{"label":"Ago","value":677},{"label":"Set","value":604},{"label":"Out","value":807},{"label":"Nov","value":768},{"label":"Dez","value":541}];
const MX = 807;
