...
const PAGE = "Reduce";
const KPIS = [{"l":"Total Md Hyper Cube","v":"4.540","t":"-3.2%","d":"down"},{"l":"Reduce Ativos","v":"476","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+12.7%","d":"up"}];
const COLS = ["ID","Reduce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Hyper Cube #001","Md Hyper Cube #002","2.767","2.603","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Md Hyper Cube #002","Md Hyper Cube #003","6.808","1.322","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Hyper Cube #003","Md Hyper Cube #004","7.853","1.812","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Md Hyper Cube #004","Md Hyper Cube #005","2.079","2.062","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Hyper Cube #005","Md Hyper Cube #001","8.614","833","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":568},{"label":"Mar","value":481},{"label":"Abr","value":451},{"label":"Mai","value":743},{"label":"Jun","value":588},{"label":"Jul","value":736},{"label":"Ago","value":642},{"label":"Set","value":584},{"label":"Out","value":701},{"label":"Nov","value":453},{"label":"Dez","value":690}];
const MX = 743;
