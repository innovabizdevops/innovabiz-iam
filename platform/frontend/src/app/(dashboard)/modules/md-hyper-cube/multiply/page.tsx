...
const ACCENT = "#312e81";
const MODULE = "MD: Hyper-Cube Multiplier";
const PAGE = "Multiply";
const KPIS = [{"l":"Total Md Hyper Cube","v":"7.054","t":"+2.3%","d":"up"},{"l":"Multiply Ativos","v":"2.708","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"81","t":"+12.7%","d":"up"}];
const COLS = ["ID","Multiply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Hyper Cube #001","Md Hyper Cube #002","683","1.212","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Md Hyper Cube #002","Md Hyper Cube #003","4.481","5.758","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Hyper Cube #003","Md Hyper Cube #004","8.876","3.871","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Md Hyper Cube #004","Md Hyper Cube #005","1.255","701","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Hyper Cube #005","Md Hyper Cube #001","6.934","1.188","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":980},{"label":"Fev","value":807},{"label":"Mar","value":767},{"label":"Abr","value":978},{"label":"Mai","value":826},{"label":"Jun","value":971},{"label":"Jul","value":719},{"label":"Ago","value":971},{"label":"Set","value":724},{"label":"Out","value":970},{"label":"Nov","value":694},{"label":"Dez","value":891}];
const MX = 980;
