...
/* ═══ MD: Hyper-Cube Multiplier — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "8225", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4150", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€417K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "273921325", cells: ["MD-7325", "MD: Hyper-Cube Multiplier Item 1", "14/2/2026", "€21 425"], status: "active" as const },
    { id: "273924896", cells: ["MD-1896", "MD: Hyper-Cube Multiplier Item 2", "1/9/2026", "€24 996"], status: "pending" as const },
    { id: "273928467", cells: ["MD-5467", "MD: Hyper-Cube Multiplier Item 3", "16/4/2026", "€28 567"], status: "completed" as const },
    { id: "273932038", cells: ["MD-9038", "MD: Hyper-Cube Multiplier Item 4", "3/11/2026", "€32 138"], status: "warning" as const },
    { id: "273935609", cells: ["MD-3609", "MD: Hyper-Cube Multiplier Item 5", "18/6/2026", "€35 709"], status: "active" as const },
];
...
export default function MdHypercubeMultiplierPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Hyper-Cube Multiplier</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Hyper-Cube Multiplier</p>
                    </div>
                </div>
