...
const KPIS = [
    ...
    { label: "Ativos", value: "3335", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€222K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "190294501", cells: ["INT-8501", "Internal Developer Portal Item 1", "6/2/2026", "€44 601"], status: "active" as const },
    { id: "190298072", cells: ["INT-3072", "Internal Developer Portal Item 2", "21/9/2026", "€48 172"], status: "pending" as const },
    { id: "190301643", cells: ["INT-6643", "Internal Developer Portal Item 3", "8/4/2026", "€1743"], status: "completed" as const },
    { id: "190305214", cells: ["INT-1214", "Internal Developer Portal Item 4", "23/11/2026", "€5314"], status: "warning" as const },
    { id: "190308785", cells: ["INT-4785", "Internal Developer Portal Item 5", "10/6/2026", "€8885"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Internal Developer Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Internal Developer Portal</p>
                    </div>
                </div>
