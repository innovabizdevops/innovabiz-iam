...
const ACCENT = "#1e40af";
const MODULE = "Internal Developer Portal";
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"6.763","t":"+3.4%","d":"up"},{"l":"Submissões/Dia","v":"2760","t":"+2.8%","d":"up"},{"l":"Documentos Gerados","v":"1.433","t":"+7.5%","d":"up"},{"l":"Templates","v":"6.515","t":"+15.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.866","2026-03-28","2.400","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.329","2026-02-01","3.972","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.280","2026-01-27","478","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.113","2026-02-08","6.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.286","2026-01-10","1.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":604},{"label":"Mar","value":617},{"label":"Abr","value":351},{"label":"Mai","value":687},{"label":"Jun","value":705},{"label":"Jul","value":363},{"label":"Ago","value":356},{"label":"Set","value":582},{"label":"Out","value":526},{"label":"Nov","value":389},{"label":"Dez","value":676}];
const MX = 705;
