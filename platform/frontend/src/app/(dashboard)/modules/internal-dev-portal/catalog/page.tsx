...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"5.434","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"2975","t":"+6.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.228","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"7.222","t":"+13.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4420","2026-02-14","8.752","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4415","2026-01-22","7.273","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1411","2026-01-28","4.794","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5048","2026-03-14","7.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4464","2026-01-26","502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":867},{"label":"Mar","value":713},{"label":"Abr","value":481},{"label":"Mai","value":579},{"label":"Jun","value":553},{"label":"Jul","value":496},{"label":"Ago","value":786},{"label":"Set","value":502},{"label":"Out","value":510},{"label":"Nov","value":475},{"label":"Dez","value":817}];
const MX = 867;
