...
const ACCENT = "#0891b2";
const MODULE = "Self-Service Laundry";
const PAGE = "Machine";
const KPIS = [{"l":"Total Self Service Laundry","v":"6.798","t":"+12.6%","d":"up"},{"l":"Machine Ativos","v":"8.665","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.9%","d":"up"}];
const COLS = ["ID","Machine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Self Service Laundry #001","Self Service Laundry #002","7.496","2.298","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Self Service Laundry #002","Self Service Laundry #003","4.225","423","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Self Service Laundry #003","Self Service Laundry #004","6.613","7.008","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Self Service Laundry #004","Self Service Laundry #005","907","345","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Self Service Laundry #005","Self Service Laundry #001","3.047","7.326","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":684},{"label":"Mar","value":610},{"label":"Abr","value":655},{"label":"Mai","value":494},{"label":"Jun","value":627},{"label":"Jul","value":515},{"label":"Ago","value":471},{"label":"Set","value":700},{"label":"Out","value":444},{"label":"Nov","value":480},{"label":"Dez","value":716}];
const MX = 716;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>IoT</span></h1>
                </div>
