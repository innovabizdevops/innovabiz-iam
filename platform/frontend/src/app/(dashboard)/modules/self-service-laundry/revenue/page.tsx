...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€45.7M","t":"+9.3%","d":"up"},{"l":"MRR (€)","v":"€33299","t":"-2.6%","d":"down"},{"l":"Churn (%)","v":"83.2%","t":"+17.4%","d":"up"},{"l":"ARPU (€)","v":"€76169","t":"+2.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 44522.24","2.942","€ 43719.68","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 7107.30","306","€ 832.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 19240.87","8.941","€ 30917.31","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42820.54","4.298","€ 42345.78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5820.91","6.236","€ 33635.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":581},{"label":"Mar","value":463},{"label":"Abr","value":386},{"label":"Mai","value":528},{"label":"Jun","value":557},{"label":"Jul","value":350},{"label":"Ago","value":556},{"label":"Set","value":701},{"label":"Out","value":521},{"label":"Nov","value":359},{"label":"Dez","value":530}];
const MX = 701;
