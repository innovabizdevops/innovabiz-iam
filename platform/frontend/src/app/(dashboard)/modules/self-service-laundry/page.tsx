...
/* ═══ Self-Service Laundry — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "9603", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "845", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€337K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1724599403", cells: ["SEL-2403", "Self-Service Laundry Item 1", "24/12/2026", "€49 503"], status: "active" as const },
    { id: "1724602974", cells: ["SEL-5974", "Self-Service Laundry Item 2", "11/7/2026", "€3074"], status: "pending" as const },
    { id: "1724606545", cells: ["SEL-9545", "Self-Service Laundry Item 3", "26/2/2026", "€6645"], status: "completed" as const },
    { id: "1724610116", cells: ["SEL-4116", "Self-Service Laundry Item 4", "13/9/2026", "€10 216"], status: "warning" as const },
    { id: "1724613687", cells: ["SEL-7687", "Self-Service Laundry Item 5", "28/4/2026", "€13 787"], status: "active" as const },
];
...
export default function SelfserviceLaundryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Self-Service Laundry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Self-Service Laundry</p>
                    </div>
                </div>
