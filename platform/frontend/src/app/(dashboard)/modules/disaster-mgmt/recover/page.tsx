...
const PAGE = "Recover";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.863","t":"-3.2%","d":"down"},{"l":"RTO Médio (h)","v":"124h","t":"+1.0%","d":"up"},{"l":"RPO Médio (h)","v":"93h","t":"+6.0%","d":"up"},{"l":"Testes DR (YTD)","v":"4.074","t":"+13.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","56h","19h","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","27h","42h","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","76h","190h","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","127h","21h","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","188h","32h","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":445},{"label":"Mar","value":657},{"label":"Abr","value":438},{"label":"Mai","value":422},{"label":"Jun","value":598},{"label":"Jul","value":777},{"label":"Ago","value":441},{"label":"Set","value":638},{"label":"Out","value":567},{"label":"Nov","value":601},{"label":"Dez","value":699}];
const MX = 777;
