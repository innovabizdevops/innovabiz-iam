...
const KPIS = [
    ...
    { label: "Ativos", value: "2014", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€475K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "650258644", cells: ["DIS-9644", "Disaster Management Item 1", "1/5/2026", "€8744"], status: "active" as const },
    { id: "650262215", cells: ["DIS-4215", "Disaster Management Item 2", "16/12/2026", "€12 315"], status: "pending" as const },
    { id: "650265786", cells: ["DIS-7786", "Disaster Management Item 3", "3/7/2026", "€15 886"], status: "completed" as const },
    { id: "650269357", cells: ["DIS-2357", "Disaster Management Item 4", "18/2/2026", "€19 457"], status: "warning" as const },
    { id: "650272928", cells: ["DIS-5928", "Disaster Management Item 5", "5/9/2026", "€23 028"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Disaster Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Disaster Management</p>
                    </div>
                </div>
