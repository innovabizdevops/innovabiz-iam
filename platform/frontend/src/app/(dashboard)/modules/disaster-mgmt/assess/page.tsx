...
const PAGE = "Assess";
const KPIS = [{"l":"BCP Plans Ativos","v":"5.914","t":"+17.5%","d":"up"},{"l":"RTO Médio (h)","v":"192h","t":"-1.1%","d":"down"},{"l":"RPO Médio (h)","v":"143h","t":"+5.5%","d":"up"},{"l":"Testes DR (YTD)","v":"3.888","t":"+17.4%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","70h","82h","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","112h","168h","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","76h","149h","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","56h","133h","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","51h","22h","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":561},{"label":"Mar","value":317},{"label":"Abr","value":427},{"label":"Mai","value":523},{"label":"Jun","value":344},{"label":"Jul","value":270},{"label":"Ago","value":576},{"label":"Set","value":285},{"label":"Out","value":612},{"label":"Nov","value":365},{"label":"Dez","value":263}];
const MX = 612;
