...
const PAGE = "Prepare";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.663","t":"+16.0%","d":"up"},{"l":"RTO Médio (h)","v":"134h","t":"+2.5%","d":"up"},{"l":"RPO Médio (h)","v":"153h","t":"+17.5%","d":"up"},{"l":"Testes DR (YTD)","v":"8.296","t":"+14.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","142h","17h","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","62h","21h","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","16h","148h","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","137h","12h","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","132h","138h","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":512},{"label":"Mar","value":762},{"label":"Abr","value":618},{"label":"Mai","value":575},{"label":"Jun","value":760},{"label":"Jul","value":577},{"label":"Ago","value":693},{"label":"Set","value":512},{"label":"Out","value":769},{"label":"Nov","value":815},{"label":"Dez","value":765}];
const MX = 815;
