...
const PAGE = "Respond";
const KPIS = [{"l":"BCP Plans Ativos","v":"6.292","t":"-2.2%","d":"down"},{"l":"RTO Médio (h)","v":"57h","t":"+2.3%","d":"up"},{"l":"RPO Médio (h)","v":"160h","t":"+8.5%","d":"up"},{"l":"Testes DR (YTD)","v":"387","t":"+4.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","201h","43h","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","169h","93h","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","100h","192h","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","96h","140h","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","83h","104h","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":564},{"label":"Mar","value":812},{"label":"Abr","value":568},{"label":"Mai","value":809},{"label":"Jun","value":781},{"label":"Jul","value":806},{"label":"Ago","value":677},{"label":"Set","value":611},{"label":"Out","value":512},{"label":"Nov","value":775},{"label":"Dez","value":665}];
const MX = 830;
