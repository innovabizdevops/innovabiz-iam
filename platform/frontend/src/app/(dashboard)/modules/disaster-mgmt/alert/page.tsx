...
const ACCENT = "#1e3a5f";
const MODULE = "Disaster Management";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.103","t":"+3.8%","d":"up"},{"l":"Taxa Entrega (%)","v":"82.4%","t":"+5.0%","d":"up"},{"l":"Taxa Abertura (%)","v":"82.1%","t":"+14.5%","d":"up"},{"l":"Escalações","v":"4.161","t":"+17.3%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.025","98.4%","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.865","80.6%","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.401","90.9%","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.338","81.1%","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","826","73.0%","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":660},{"label":"Mar","value":614},{"label":"Abr","value":668},{"label":"Mai","value":514},{"label":"Jun","value":571},{"label":"Jul","value":453},{"label":"Ago","value":460},{"label":"Set","value":578},{"label":"Out","value":609},{"label":"Nov","value":365},{"label":"Dez","value":403}];
const MX = 668;
