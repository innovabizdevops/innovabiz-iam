...
const ACCENT = "#6366f1";
const MODULE = "Social Commerce";
const PAGE = "Social Feed";
const KPIS = [{"l":"Pedidos/Dia","v":"137","t":"+11.0%","d":"up"},{"l":"GMV (€)","v":"€63898","t":"+6.3%","d":"up"},{"l":"Conversão (%)","v":"74.5%","t":"+10.5%","d":"up"},{"l":"AOV (€)","v":"€6549","t":"-4.9%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 42722.09","4.702","6.932","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 15047.84","5.196","5.928","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 6144.30","4.429","2.829","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17868.19","3.803","2.087","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 32163.03","2.332","1.444","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":381},{"label":"Mar","value":638},{"label":"Abr","value":566},{"label":"Mai","value":691},{"label":"Jun","value":656},{"label":"Jul","value":414},{"label":"Ago","value":659},{"label":"Set","value":714},{"label":"Out","value":686},{"label":"Nov","value":453},{"label":"Dez","value":749}];
const MX = 749;
