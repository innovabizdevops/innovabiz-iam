...
const ACCENT = "#1e3a5f";
const MODULE = "Forex & FX Platform";
const PAGE = "Quote";
const KPIS = [{"l":"Formulários Ativos","v":"5.351","t":"+13.4%","d":"up"},{"l":"Submissões/Dia","v":"510","t":"+8.5%","d":"up"},{"l":"Documentos Gerados","v":"1.799","t":"+14.5%","d":"up"},{"l":"Templates","v":"7.285","t":"-1.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.412","2026-02-15","4.658","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.613","2026-01-28","5.927","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.502","2026-03-18","4.123","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.468","2026-03-14","7.616","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.714","2026-03-11","6.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":559},{"label":"Mar","value":425},{"label":"Abr","value":324},{"label":"Mai","value":596},{"label":"Jun","value":430},{"label":"Jul","value":395},{"label":"Ago","value":484},{"label":"Set","value":294},{"label":"Out","value":630},{"label":"Nov","value":541},{"label":"Dez","value":293}];
const MX = 630;
