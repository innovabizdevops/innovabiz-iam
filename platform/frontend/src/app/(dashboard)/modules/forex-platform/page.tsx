...
/* ═══ Forex & FX Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "825", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4589", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€345K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "879516725", cells: ["FOR-1725", "Forex & FX Platform Item 1", "18/6/2026", "€16 825"], status: "active" as const },
    { id: "879520296", cells: ["FOR-5296", "Forex & FX Platform Item 2", "5/1/2026", "€20 396"], status: "pending" as const },
    { id: "879523867", cells: ["FOR-8867", "Forex & FX Platform Item 3", "20/8/2026", "€23 967"], status: "completed" as const },
    { id: "879527438", cells: ["FOR-3438", "Forex & FX Platform Item 4", "7/3/2026", "€27 538"], status: "warning" as const },
    { id: "879531009", cells: ["FOR-7009", "Forex & FX Platform Item 5", "22/10/2026", "€31 109"], status: "active" as const },
];
...
export default function ForexFxPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forex & FX Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Forex & FX Platform</p>
                    </div>
                </div>
