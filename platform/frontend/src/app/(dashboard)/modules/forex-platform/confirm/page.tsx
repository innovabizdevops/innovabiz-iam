...
const PAGE = "Confirm";
const KPIS = [{"l":"Formulários Ativos","v":"8.612","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"4580","t":"+6.5%","d":"up"},{"l":"Documentos Gerados","v":"296","t":"+17.2%","d":"up"},{"l":"Templates","v":"7.202","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.242","2026-02-08","7.946","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.239","2026-01-01","6.334","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","122","2026-01-03","3.088","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.698","2026-01-20","4.329","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.129","2026-01-20","7.458","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":762},{"label":"Mar","value":754},{"label":"Abr","value":870},{"label":"Mai","value":736},{"label":"Jun","value":680},{"label":"Jul","value":980},{"label":"Ago","value":785},{"label":"Set","value":889},{"label":"Out","value":640},{"label":"Nov","value":995},{"label":"Dez","value":635}];
const MX = 1012;
