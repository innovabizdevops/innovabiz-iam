...
const PAGE = "Trade";
const KPIS = [{"l":"Formulários Ativos","v":"8.432","t":"+15.2%","d":"up"},{"l":"Submissões/Dia","v":"2226","t":"+13.2%","d":"up"},{"l":"Documentos Gerados","v":"4.128","t":"+7.5%","d":"up"},{"l":"Templates","v":"1.416","t":"+11.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.302","2026-02-09","3.267","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.160","2026-03-25","4.529","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.026","2026-01-23","3.446","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.881","2026-02-05","380","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.187","2026-03-10","3.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":487},{"label":"Mar","value":662},{"label":"Abr","value":606},{"label":"Mai","value":770},{"label":"Jun","value":772},{"label":"Jul","value":468},{"label":"Ago","value":660},{"label":"Set","value":715},{"label":"Out","value":779},{"label":"Nov","value":775},{"label":"Dez","value":762}];
const MX = 779;
