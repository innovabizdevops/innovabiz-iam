...
const PAGE = "Settle";
const KPIS = [{"l":"Formulários Ativos","v":"4.870","t":"+15.0%","d":"up"},{"l":"Submissões/Dia","v":"4631","t":"+10.3%","d":"up"},{"l":"Documentos Gerados","v":"2.450","t":"+1.1%","d":"up"},{"l":"Templates","v":"4.206","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.764","2026-03-15","5.656","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.591","2026-03-06","6.880","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.303","2026-02-01","5.756","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.916","2026-02-10","2.618","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.743","2026-01-25","7.486","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":907},{"label":"Mar","value":551},{"label":"Abr","value":901},{"label":"Mai","value":684},{"label":"Jun","value":832},{"label":"Jul","value":884},{"label":"Ago","value":863},{"label":"Set","value":895},{"label":"Out","value":904},{"label":"Nov","value":602},{"label":"Dez","value":747}];
const MX = 924;
