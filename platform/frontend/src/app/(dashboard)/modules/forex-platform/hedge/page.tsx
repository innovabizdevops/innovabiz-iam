...
const PAGE = "Hedge";
const KPIS = [{"l":"Formulários Ativos","v":"4.013","t":"-1.5%","d":"down"},{"l":"Submissões/Dia","v":"308","t":"+7.1%","d":"up"},{"l":"Documentos Gerados","v":"3.978","t":"+16.6%","d":"up"},{"l":"Templates","v":"4.549","t":"+11.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.503","2026-02-08","2.044","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.700","2026-02-19","4.070","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.375","2026-02-04","3.912","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.224","2026-01-04","603","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.504","2026-02-10","5.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":559},{"label":"Mar","value":359},{"label":"Abr","value":467},{"label":"Mai","value":365},{"label":"Jun","value":391},{"label":"Jul","value":371},{"label":"Ago","value":621},{"label":"Set","value":450},{"label":"Out","value":511},{"label":"Nov","value":498},{"label":"Dez","value":646}];
const MX = 646;
