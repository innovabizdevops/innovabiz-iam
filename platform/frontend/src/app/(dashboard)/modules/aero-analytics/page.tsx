...
export default function AeroAnalyticsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Aero Analytics</h1><p className="text-sm text-muted-foreground">Aero Analytics • iBOS Enterprise</p></div>
