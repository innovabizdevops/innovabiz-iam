...
const KPIS = [{"l":"Dashboards Ativos","v":"7.082","t":"+8.2%","d":"up"},{"l":"Queries/Dia","v":"4153","t":"-3.6%","d":"down"},{"l":"Dados Processados (GB)","v":"3.605","t":"+16.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.619","t":"+8.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1995","2026-01-14","2.928","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2780","2026-03-07","2.153","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2161","2026-02-27","877","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3117","2026-02-14","7.752","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3681","2026-03-03","8.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":575},{"label":"Mar","value":542},{"label":"Abr","value":695},{"label":"Mai","value":603},{"label":"Jun","value":540},{"label":"Jul","value":599},{"label":"Ago","value":779},{"label":"Set","value":773},{"label":"Out","value":851},{"label":"Nov","value":685},{"label":"Dez","value":798}];
const MX = 851;
