...
const PAGE = "Fleet";
const KPIS = [{"l":"Dashboards Ativos","v":"3.597","t":"+2.9%","d":"up"},{"l":"Queries/Dia","v":"234","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"6.388","t":"+16.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.810","t":"-2.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1488","2026-03-06","1.192","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","686","2026-02-09","7.723","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","119","2026-02-17","6.794","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","349","2026-03-25","6.115","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4453","2026-02-16","7.361","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":766},{"label":"Mar","value":769},{"label":"Abr","value":978},{"label":"Mai","value":1005},{"label":"Jun","value":899},{"label":"Jul","value":835},{"label":"Ago","value":996},{"label":"Set","value":782},{"label":"Out","value":930},{"label":"Nov","value":1024},{"label":"Dez","value":1043}];
const MX = 1043;
