...
const ACCENT = "#6366f1";
const MODULE = "Aerospace Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.890","t":"+12.1%","d":"up"},{"l":"Queries/Dia","v":"4110","t":"+14.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.555","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"3.944","t":"+2.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3880","2026-02-03","2.473","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4790","2026-01-20","2.615","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1137","2026-02-03","1.248","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","612","2026-02-01","2.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2563","2026-02-18","8.756","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":702},{"label":"Mar","value":721},{"label":"Abr","value":930},{"label":"Mai","value":750},{"label":"Jun","value":793},{"label":"Jul","value":918},{"label":"Ago","value":699},{"label":"Set","value":802},{"label":"Out","value":975},{"label":"Nov","value":933},{"label":"Dez","value":986}];
const MX = 986;
