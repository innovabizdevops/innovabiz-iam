...
const PAGE = "Dispatch";
const KPIS = [{"l":"Dashboards Ativos","v":"113","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"282","t":"+14.7%","d":"up"},{"l":"Dados Processados (GB)","v":"2.164","t":"+1.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.732","t":"-1.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4657","2026-02-08","1.663","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5099","2026-03-01","6.909","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","429","2026-01-14","7.050","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2901","2026-01-06","4.564","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1969","2026-02-28","3.771","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":574},{"label":"Mar","value":511},{"label":"Abr","value":364},{"label":"Mai","value":440},{"label":"Jun","value":693},{"label":"Jul","value":476},{"label":"Ago","value":475},{"label":"Set","value":675},{"label":"Out","value":479},{"label":"Nov","value":626},{"label":"Dez","value":581}];
const MX = 693;
