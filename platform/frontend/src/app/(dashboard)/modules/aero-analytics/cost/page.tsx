...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"6.693","t":"+11.5%","d":"up"},{"l":"Queries/Dia","v":"1547","t":"+11.0%","d":"up"},{"l":"Dados Processados (GB)","v":"439","t":"+11.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.647","t":"-0.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","294","2026-03-08","1.509","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4365","2026-01-26","8.311","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1398","2026-01-17","2.091","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1864","2026-01-04","7.048","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2546","2026-01-25","8.860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":709},{"label":"Mar","value":611},{"label":"Abr","value":503},{"label":"Mai","value":380},{"label":"Jun","value":652},{"label":"Jul","value":478},{"label":"Ago","value":443},{"label":"Set","value":531},{"label":"Out","value":532},{"label":"Nov","value":558},{"label":"Dez","value":506}];
const MX = 709;
