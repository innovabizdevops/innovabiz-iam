...
const PAGE = "Safety Training";
const KPIS = [{"l":"Incidentes (YTD)","v":"3.008","t":"+15.6%","d":"up"},{"l":"LTIR","v":"4.140","t":"+8.1%","d":"up"},{"l":"Formações HSE","v":"2.752","t":"+4.6%","d":"up"},{"l":"Inspeções Realizadas","v":"1.644","t":"+4.2%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","2.954","6.577","7.379","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","997","369","6.284","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","4.898","3.989","7.381","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","2.382","5.503","5.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","1.231","4.584","6.145","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":805},{"label":"Mar","value":775},{"label":"Abr","value":859},{"label":"Mai","value":586},{"label":"Jun","value":851},{"label":"Jul","value":941},{"label":"Ago","value":944},{"label":"Set","value":573},{"label":"Out","value":805},{"label":"Nov","value":800},{"label":"Dez","value":764}];
const MX = 944;
