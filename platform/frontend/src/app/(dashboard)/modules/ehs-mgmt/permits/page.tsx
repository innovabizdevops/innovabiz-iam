...
const ACCENT = "#dc2626";
const MODULE = "EHS Management";
const PAGE = "Permit to Work";
const KPIS = [{"l":"Riscos Identificados","v":"8.646","t":"+17.0%","d":"up"},{"l":"Mitigações Ativas","v":"4.583","t":"+0.4%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+7.3%","d":"up"},{"l":"Incidentes YTD","v":"717","t":"+16.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.999","3.617","3.475","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","9.096","8.788","5.182","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.028","675","5.397","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.847","6.606","4.545","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.573","5.581","4.889","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":786},{"label":"Mar","value":596},{"label":"Abr","value":668},{"label":"Mai","value":687},{"label":"Jun","value":866},{"label":"Jul","value":674},{"label":"Ago","value":829},{"label":"Set","value":562},{"label":"Out","value":663},{"label":"Nov","value":504},{"label":"Dez","value":649}];
const MX = 866;
