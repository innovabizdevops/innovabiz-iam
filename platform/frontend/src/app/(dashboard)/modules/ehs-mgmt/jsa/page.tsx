...
const PAGE = "JSA/JHA";
const KPIS = [{"l":"Incidentes (YTD)","v":"4.774","t":"+17.2%","d":"up"},{"l":"LTIR","v":"6.491","t":"-5.3%","d":"down"},{"l":"Formações HSE","v":"1.447","t":"+9.6%","d":"up"},{"l":"Inspeções Realizadas","v":"471","t":"-0.8%","d":"down"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","362","8.222","7.177","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","6.945","2.896","1.053","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","5.512","3.593","5.976","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","7.314","7.508","3.038","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","7.082","4.268","3.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1025},{"label":"Fev","value":720},{"label":"Mar","value":773},{"label":"Abr","value":756},{"label":"Mai","value":780},{"label":"Jun","value":1013},{"label":"Jul","value":703},{"label":"Ago","value":1000},{"label":"Set","value":957},{"label":"Out","value":1051},{"label":"Nov","value":743},{"label":"Dez","value":1073}];
const MX = 1073;
