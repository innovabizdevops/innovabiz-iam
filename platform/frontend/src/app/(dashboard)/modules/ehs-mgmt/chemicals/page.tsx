...
const KPIS = [{"l":"Incidentes (YTD)","v":"8.449","t":"+16.6%","d":"up"},{"l":"LTIR","v":"7.745","t":"+4.1%","d":"up"},{"l":"Formações HSE","v":"1.713","t":"+14.2%","d":"up"},{"l":"Inspeções Realizadas","v":"3.802","t":"+11.0%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","2.296","3.121","2.936","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","2.263","5.784","3.373","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","5.129","5.123","616","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","2.190","7.972","579","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","2.714","4.731","4.234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":578},{"label":"Mar","value":652},{"label":"Abr","value":380},{"label":"Mai","value":548},{"label":"Jun","value":656},{"label":"Jul","value":459},{"label":"Ago","value":484},{"label":"Set","value":619},{"label":"Out","value":378},{"label":"Nov","value":508},{"label":"Dez","value":675}];
const MX = 675;
