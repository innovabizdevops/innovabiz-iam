...
const PAGE = "Incident Report";
const KPIS = [{"l":"Tickets Abertos","v":"3.242","t":"-5.0%","d":"down"},{"l":"SLA Cumprido (%)","v":"87.7%","t":"-4.5%","d":"down"},{"l":"MTTR (h)","v":"73h","t":"+2.4%","d":"up"},{"l":"Satisfação (%)","v":"66.2%","t":"-5.5%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.409","6.071","3.356","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.904","1.361","3.203","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.130","346","7.716","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.691","8.689","8.970","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.645","2.253","3.143","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":574},{"label":"Mar","value":528},{"label":"Abr","value":846},{"label":"Mai","value":798},{"label":"Jun","value":852},{"label":"Jul","value":511},{"label":"Ago","value":822},{"label":"Set","value":684},{"label":"Out","value":540},{"label":"Nov","value":804},{"label":"Dez","value":799}];
const MX = 852;
