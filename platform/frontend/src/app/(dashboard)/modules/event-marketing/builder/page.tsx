...
const KPIS = [{"l":"Eventos Planeados","v":"3.934","t":"+7.2%","d":"up"},{"l":"Participantes","v":"8.978","t":"+17.7%","d":"up"},{"l":"NPS Evento","v":"85","t":"+1.9%","d":"up"},{"l":"Receita (€)","v":"€54132","t":"+1.6%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-19","6.261","491","€ 7485.87","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-04","814","2.285","€ 38636.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-27","1.881","3.753","€ 15364.88","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-06","1.297","2.552","€ 28198.89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-10","6.971","7.262","€ 8649.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":485},{"label":"Mar","value":724},{"label":"Abr","value":494},{"label":"Mai","value":853},{"label":"Jun","value":544},{"label":"Jul","value":528},{"label":"Ago","value":816},{"label":"Set","value":845},{"label":"Out","value":599},{"label":"Nov","value":772},{"label":"Dez","value":577}];
const MX = 853;
