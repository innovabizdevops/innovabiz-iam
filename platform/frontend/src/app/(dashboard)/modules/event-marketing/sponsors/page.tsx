...
const PAGE = "Sponsor Mgmt";
const KPIS = [{"l":"Eventos Planeados","v":"5.053","t":"+14.2%","d":"up"},{"l":"Participantes","v":"2.042","t":"+2.4%","d":"up"},{"l":"NPS Evento","v":"71","t":"-3.4%","d":"down"},{"l":"Receita (€)","v":"€20548","t":"+18.0%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-28","5.367","5.516","€ 556.08","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-24","2.522","2.047","€ 44622.69","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-06","8.920","7.455","€ 28855.28","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-16","4.490","5.850","€ 41652.59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-19","1.646","3.357","€ 32436.72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":531},{"label":"Mar","value":568},{"label":"Abr","value":658},{"label":"Mai","value":734},{"label":"Jun","value":781},{"label":"Jul","value":529},{"label":"Ago","value":591},{"label":"Set","value":795},{"label":"Out","value":666},{"label":"Nov","value":736},{"label":"Dez","value":574}];
const MX = 795;
