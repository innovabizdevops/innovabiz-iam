...
const PAGE = "Check-In App";
const KPIS = [{"l":"Eventos Planeados","v":"7.165","t":"-4.0%","d":"down"},{"l":"Participantes","v":"177","t":"+2.9%","d":"up"},{"l":"NPS Evento","v":"72","t":"+5.9%","d":"up"},{"l":"Receita (€)","v":"€9696","t":"-4.3%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-13","3.323","5.716","€ 20522.74","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-19","910","1.287","€ 30269.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-14","4.743","1.837","€ 22821.97","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-06","801","2.635","€ 28955.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-04","7.756","241","€ 40307.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":622},{"label":"Mar","value":656},{"label":"Abr","value":733},{"label":"Mai","value":594},{"label":"Jun","value":546},{"label":"Jul","value":782},{"label":"Ago","value":615},{"label":"Set","value":742},{"label":"Out","value":446},{"label":"Nov","value":598},{"label":"Dez","value":674}];
const MX = 782;
