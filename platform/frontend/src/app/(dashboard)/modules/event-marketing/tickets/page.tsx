...
const ACCENT = "#059669";
const MODULE = "Event Marketing";
const PAGE = "Ticketing";
const KPIS = [{"l":"Tickets Abertos","v":"2.272","t":"+16.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"68.8%","t":"+12.7%","d":"up"},{"l":"MTTR (h)","v":"127h","t":"-2.7%","d":"down"},{"l":"Satisfação (%)","v":"84.4%","t":"+1.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.951","8.232","5.736","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.875","1.957","3.747","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.156","1.650","6.527","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","327","3.667","261","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","635","6.317","4.819","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":499},{"label":"Mar","value":505},{"label":"Abr","value":271},{"label":"Mai","value":580},{"label":"Jun","value":268},{"label":"Jul","value":529},{"label":"Ago","value":347},{"label":"Set","value":240},{"label":"Out","value":429},{"label":"Nov","value":463},{"label":"Dez","value":339}];
const MX = 580;
