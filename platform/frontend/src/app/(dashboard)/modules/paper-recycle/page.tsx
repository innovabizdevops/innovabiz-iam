...
/* ═══ Paper Recycling — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "7777", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3675", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€48K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1195739577", cells: ["PAP-9577", "Paper Recycling Item 1", "26/10/2026", "€39 677"], status: "active" as const },
    { id: "1195743148", cells: ["PAP-4148", "Paper Recycling Item 2", "13/5/2026", "€43 248"], status: "pending" as const },
    { id: "1195746719", cells: ["PAP-7719", "Paper Recycling Item 3", "28/12/2026", "€46 819"], status: "completed" as const },
    { id: "1195750290", cells: ["PAP-2290", "Paper Recycling Item 4", "15/7/2026", "€390"], status: "warning" as const },
    { id: "1195753861", cells: ["PAP-5861", "Paper Recycling Item 5", "2/2/2026", "€3961"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Paper Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Paper Recycling</p>
                    </div>
                </div>
