...
const ACCENT = "#059669";
const MODULE = "Paper Recycling";
const PAGE = "Deink";
const KPIS = [{"l":"Projetos Sociais","v":"4.113","t":"-1.9%","d":"down"},{"l":"Beneficiários","v":"3.586","t":"-3.9%","d":"down"},{"l":"Investimento CSR (€)","v":"€27349","t":"+15.3%","d":"up"},{"l":"Score Impacto","v":"69","t":"+16.7%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","606","€ 33707.47","4.174","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.174","€ 18023.95","4.509","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.606","€ 32812.25","958","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.620","€ 31332.04","2.746","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.240","€ 30889.57","863","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":693},{"label":"Mar","value":966},{"label":"Abr","value":1006},{"label":"Mai","value":830},{"label":"Jun","value":874},{"label":"Jul","value":960},{"label":"Ago","value":969},{"label":"Set","value":993},{"label":"Out","value":860},{"label":"Nov","value":935},{"label":"Dez","value":1049}];
const MX = 1049;
