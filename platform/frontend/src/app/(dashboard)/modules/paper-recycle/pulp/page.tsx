...
const PAGE = "Pulp";
const KPIS = [{"l":"Total Paper Recycle","v":"2.851","t":"+0.6%","d":"up"},{"l":"Pulp Ativos","v":"464","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"92.7%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"87","t":"-5.5%","d":"down"}];
const COLS = ["ID","Pulp","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Paper Recycle #001","Paper Recycle #002","706","6.963","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Paper Recycle #002","Paper Recycle #003","5.270","2.475","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Paper Recycle #003","Paper Recycle #004","9.027","3.401","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Paper Recycle #004","Paper Recycle #005","6.093","2.407","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Paper Recycle #005","Paper Recycle #001","930","2.592","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":759},{"label":"Mar","value":649},{"label":"Abr","value":702},{"label":"Mai","value":672},{"label":"Jun","value":851},{"label":"Jul","value":836},{"label":"Ago","value":761},{"label":"Set","value":698},{"label":"Out","value":699},{"label":"Nov","value":769},{"label":"Dez","value":718}];
const MX = 851;
