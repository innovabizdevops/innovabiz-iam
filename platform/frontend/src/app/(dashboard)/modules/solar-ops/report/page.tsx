...
const PAGE = "Report";
const KPIS = [{"l":"Total Solar Ops","v":"5.674","t":"+1.0%","d":"up"},{"l":"Report Ativos","v":"6.776","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"75.2%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"57","t":"+3.8%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solar Ops #001","Solar Ops #002","940","5.323","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Solar Ops #002","Solar Ops #003","3.418","6.393","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Solar Ops #003","Solar Ops #004","5.544","685","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Solar Ops #004","Solar Ops #005","4.098","8.494","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solar Ops #005","Solar Ops #001","3.587","3.300","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":356},{"label":"Mar","value":411},{"label":"Abr","value":461},{"label":"Mai","value":561},{"label":"Jun","value":330},{"label":"Jul","value":590},{"label":"Ago","value":506},{"label":"Set","value":614},{"label":"Out","value":659},{"label":"Nov","value":460},{"label":"Dez","value":494}];
const MX = 659;
