...
const KPIS = [{"l":"Formulários Ativos","v":"5.861","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"1184","t":"+9.1%","d":"up"},{"l":"Documentos Gerados","v":"5.423","t":"+0.5%","d":"up"},{"l":"Templates","v":"279","t":"-4.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.872","2026-02-15","7.768","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.337","2026-03-04","1.293","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.556","2026-03-12","1.822","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.812","2026-02-24","5.259","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.271","2026-03-19","1.444","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":399},{"label":"Mar","value":438},{"label":"Abr","value":644},{"label":"Mai","value":426},{"label":"Jun","value":453},{"label":"Jul","value":486},{"label":"Ago","value":472},{"label":"Set","value":383},{"label":"Out","value":463},{"label":"Nov","value":637},{"label":"Dez","value":728}];
const MX = 728;
