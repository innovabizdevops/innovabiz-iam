...
const ACCENT = "#6366f1";
const MODULE = "Solar Operations";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Solar Ops","v":"1.127","t":"+3.6%","d":"up"},{"l":"Monitor Ativos","v":"6.952","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"66","t":"+1.6%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solar Ops #001","Solar Ops #002","4.443","6.545","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Solar Ops #002","Solar Ops #003","4.660","1.369","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Solar Ops #003","Solar Ops #004","4.988","5.317","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Solar Ops #004","Solar Ops #005","2.496","5.509","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solar Ops #005","Solar Ops #001","1.998","8.150","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":748},{"label":"Mar","value":679},{"label":"Abr","value":481},{"label":"Mai","value":582},{"label":"Jun","value":739},{"label":"Jul","value":508},{"label":"Ago","value":563},{"label":"Set","value":408},{"label":"Out","value":683},{"label":"Nov","value":443},{"label":"Dez","value":453}];
const MX = 748;
