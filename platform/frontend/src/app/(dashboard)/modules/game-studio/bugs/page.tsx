...
const PAGE = "Bug Track";
const KPIS = [{"l":"Total Game Studio","v":"7.406","t":"+5.0%","d":"up"},{"l":"Bug Track Ativos","v":"3.995","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"87.6%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+1.6%","d":"up"}];
const COLS = ["ID","Bug Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Studio #001","Game Studio #002","2.307","7.836","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Game Studio #002","Game Studio #003","5.943","794","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Studio #003","Game Studio #004","4.662","3.769","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Game Studio #004","Game Studio #005","1.354","4.884","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Studio #005","Game Studio #001","3.033","2.281","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":930},{"label":"Mar","value":929},{"label":"Abr","value":1018},{"label":"Mai","value":978},{"label":"Jun","value":1043},{"label":"Jul","value":959},{"label":"Ago","value":707},{"label":"Set","value":874},{"label":"Out","value":997},{"label":"Nov","value":745},{"label":"Dez","value":696}];
const MX = 1043;
