...
const KPIS = [{"l":"Dashboards Ativos","v":"8.641","t":"-2.7%","d":"down"},{"l":"Queries/Dia","v":"4778","t":"-0.8%","d":"down"},{"l":"Dados Processados (GB)","v":"7.284","t":"+11.2%","d":"up"},{"l":"Utilizadores Analytics","v":"9.078","t":"+3.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3061","2026-02-04","6.161","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","871","2026-02-20","1.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1514","2026-03-22","8.365","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2181","2026-02-09","1.310","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3151","2026-03-02","8.836","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":752},{"label":"Mar","value":443},{"label":"Abr","value":446},{"label":"Mai","value":422},{"label":"Jun","value":371},{"label":"Jul","value":417},{"label":"Ago","value":391},{"label":"Set","value":595},{"label":"Out","value":610},{"label":"Nov","value":518},{"label":"Dez","value":471}];
const MX = 752;
