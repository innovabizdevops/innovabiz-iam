...
const ACCENT = "#7c3aed";
const MODULE = "Game Studio";
const PAGE = "Asset Pipeline";
const KPIS = [{"l":"Ativos Registados","v":"5.097","t":"+10.7%","d":"up"},{"l":"Valor Total (€M)","v":"€42.3M","t":"+15.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€12716","t":"+10.8%","d":"up"},{"l":"Ativos em Garantia","v":"6.985","t":"+7.7%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 14848.73","8.159","€ 49602.72","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 34971.66","7.863","€ 7264.84","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 24539.19","6.174","€ 12742.47","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 16144.28","4.741","€ 16080.48","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 35727.81","5.368","€ 34849.85","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":609},{"label":"Mar","value":421},{"label":"Abr","value":716},{"label":"Mai","value":708},{"label":"Jun","value":485},{"label":"Jul","value":709},{"label":"Ago","value":513},{"label":"Set","value":555},{"label":"Out","value":333},{"label":"Nov","value":548},{"label":"Dez","value":469}];
const MX = 716;
