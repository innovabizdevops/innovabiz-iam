...
const PAGE = "Unreal Engine";
const KPIS = [{"l":"Total Game Studio","v":"775","t":"+9.6%","d":"up"},{"l":"Unreal Engine Ativos","v":"9.015","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"75.4%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"64","t":"+17.1%","d":"up"}];
const COLS = ["ID","Unreal Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Studio #001","Game Studio #002","5.573","7.193","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Game Studio #002","Game Studio #003","4.425","4.285","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Studio #003","Game Studio #004","2.476","6.721","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Game Studio #004","Game Studio #005","164","3.991","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Studio #005","Game Studio #001","7.114","8.550","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":682},{"label":"Mar","value":884},{"label":"Abr","value":538},{"label":"Mai","value":721},{"label":"Jun","value":746},{"label":"Jul","value":916},{"label":"Ago","value":570},{"label":"Set","value":842},{"label":"Out","value":621},{"label":"Nov","value":849},{"label":"Dez","value":697}];
const MX = 916;
