...
const PAGE = "Sprint Board";
const KPIS = [{"l":"Teams Ativos","v":"6.771","t":"+5.4%","d":"up"},{"l":"Reuniões/Semana","v":"3654","t":"+0.8%","d":"up"},{"l":"Mensagens/Dia","v":"4232","t":"+8.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.429","t":"+11.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.055","2708","4.232","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.257","3410","925","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.788","1463","1.276","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.314","1920","8.802","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.770","1943","2.278","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":274},{"label":"Fev","value":611},{"label":"Mar","value":572},{"label":"Abr","value":473},{"label":"Mai","value":611},{"label":"Jun","value":357},{"label":"Jul","value":447},{"label":"Ago","value":607},{"label":"Set","value":485},{"label":"Out","value":306},{"label":"Nov","value":567},{"label":"Dez","value":314}];
const MX = 611;
