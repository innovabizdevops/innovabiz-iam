...
const PAGE = "Contractor Pool";
const KPIS = [{"l":"Contratos Ativos","v":"8.061","t":"+12.8%","d":"up"},{"l":"Valor Total (€M)","v":"€4.2M","t":"+17.3%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.824","t":"+11.2%","d":"up"},{"l":"Obrigações Pendentes","v":"7.636","t":"+13.7%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 11921.66","2026-03-22","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 40254.01","2026-01-15","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 49306.93","2026-03-10","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 19618.06","2026-02-24","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 24548.95","2026-02-10","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":603},{"label":"Mar","value":484},{"label":"Abr","value":366},{"label":"Mai","value":395},{"label":"Jun","value":444},{"label":"Jul","value":592},{"label":"Ago","value":556},{"label":"Set","value":342},{"label":"Out","value":739},{"label":"Nov","value":558},{"label":"Dez","value":698}];
const MX = 739;
