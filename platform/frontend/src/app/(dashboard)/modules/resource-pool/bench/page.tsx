...
const PAGE = "Bench Report";
const KPIS = [{"l":"Total Resource Pool","v":"5.490","t":"+15.4%","d":"up"},{"l":"Bench Report Ativos","v":"1.312","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"63","t":"-5.8%","d":"down"}];
const COLS = ["ID","Bench Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Resource Pool #001","Resource Pool #002","1.470","1.682","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Resource Pool #002","Resource Pool #003","8.422","5.110","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Resource Pool #003","Resource Pool #004","8.862","2.958","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Resource Pool #004","Resource Pool #005","5.841","4.761","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Resource Pool #005","Resource Pool #001","4.854","7.614","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":694},{"label":"Mar","value":839},{"label":"Abr","value":635},{"label":"Mai","value":743},{"label":"Jun","value":661},{"label":"Jul","value":519},{"label":"Ago","value":669},{"label":"Set","value":736},{"label":"Out","value":683},{"label":"Nov","value":507},{"label":"Dez","value":847}];
const MX = 847;
