...
const KPIS = [{"l":"Total Resource Pool","v":"5.519","t":"+3.8%","d":"up"},{"l":"Availability Ativos","v":"1.638","t":"+13.8%","d":"up"},{"l":"Eficiência (%)","v":"67.3%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"81","t":"+0.6%","d":"up"}];
const COLS = ["ID","Availability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Resource Pool #001","Resource Pool #002","8.183","7.100","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Resource Pool #002","Resource Pool #003","4.812","8.472","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Resource Pool #003","Resource Pool #004","2.493","2.458","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Resource Pool #004","Resource Pool #005","5.014","7.355","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Resource Pool #005","Resource Pool #001","4.266","7.320","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":754},{"label":"Mar","value":730},{"label":"Abr","value":701},{"label":"Mai","value":536},{"label":"Jun","value":595},{"label":"Jul","value":507},{"label":"Ago","value":526},{"label":"Set","value":625},{"label":"Out","value":509},{"label":"Nov","value":399},{"label":"Dez","value":626}];
const MX = 754;
