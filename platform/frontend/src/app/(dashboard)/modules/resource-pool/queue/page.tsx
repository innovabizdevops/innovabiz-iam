...
const PAGE = "Request Queue";
const KPIS = [{"l":"Total Resource Pool","v":"4.005","t":"+10.7%","d":"up"},{"l":"Request Queue Ativos","v":"5.522","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"78","t":"+10.8%","d":"up"}];
const COLS = ["ID","Request Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Resource Pool #001","Resource Pool #002","5.868","7.634","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Resource Pool #002","Resource Pool #003","8.048","1.812","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Resource Pool #003","Resource Pool #004","7.439","5.885","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Resource Pool #004","Resource Pool #005","2.936","5.790","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Resource Pool #005","Resource Pool #001","6.465","6.128","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":861},{"label":"Mar","value":642},{"label":"Abr","value":873},{"label":"Mai","value":651},{"label":"Jun","value":840},{"label":"Jul","value":801},{"label":"Ago","value":700},{"label":"Set","value":830},{"label":"Out","value":690},{"label":"Nov","value":938},{"label":"Dez","value":620}];
const MX = 938;
