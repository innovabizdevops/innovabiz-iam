...
const PAGE = "Global Mobility";
const KPIS = [{"l":"Total Resource Pool","v":"8.449","t":"+9.8%","d":"up"},{"l":"Global Mobility Ativos","v":"644","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"85.3%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+11.5%","d":"up"}];
const COLS = ["ID","Global Mobility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Resource Pool #001","Resource Pool #002","4.233","5.865","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Resource Pool #002","Resource Pool #003","1.363","1.977","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Resource Pool #003","Resource Pool #004","6.262","9.037","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Resource Pool #004","Resource Pool #005","4.189","3.747","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Resource Pool #005","Resource Pool #001","8.357","8.622","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":824},{"label":"Mar","value":791},{"label":"Abr","value":722},{"label":"Mai","value":887},{"label":"Jun","value":619},{"label":"Jul","value":664},{"label":"Ago","value":892},{"label":"Set","value":644},{"label":"Out","value":554},{"label":"Nov","value":791},{"label":"Dez","value":824}];
const MX = 892;
