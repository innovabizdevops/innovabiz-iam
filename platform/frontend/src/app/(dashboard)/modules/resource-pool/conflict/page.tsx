...
const PAGE = "Conflict Check";
const KPIS = [{"l":"Total Resource Pool","v":"2.874","t":"+9.9%","d":"up"},{"l":"Conflict Check Ativos","v":"1.376","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"87.2%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"70","t":"+7.0%","d":"up"}];
const COLS = ["ID","Conflict Check","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Resource Pool #001","2026-01-19","2.384","8.443","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Resource Pool #002","2026-01-23","8.895","667","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Resource Pool #003","2026-01-04","301","5.931","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Resource Pool #004","2026-03-03","2.954","8.300","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Resource Pool #005","2026-03-05","8.736","3.781","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":582},{"label":"Mar","value":535},{"label":"Abr","value":530},{"label":"Mai","value":554},{"label":"Jun","value":699},{"label":"Jul","value":539},{"label":"Ago","value":375},{"label":"Set","value":487},{"label":"Out","value":692},{"label":"Nov","value":390},{"label":"Dez","value":520}];
const MX = 699;
