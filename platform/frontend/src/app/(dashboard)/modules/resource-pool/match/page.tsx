...
const ACCENT = "#059669";
const MODULE = "Resource Pool";
const PAGE = "Skill Match";
const KPIS = [{"l":"Atletas Registados","v":"1.675","t":"+10.1%","d":"up"},{"l":"Treinos/Semana","v":"4044","t":"+5.5%","d":"up"},{"l":"Competições","v":"7.732","t":"-3.7%","d":"down"},{"l":"Performance Score","v":"64","t":"+5.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.705","6.443","6.042","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.081","1.669","3.554","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.257","2.399","6.032","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.080","4.765","952","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.591","2.029","5.105","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":916},{"label":"Mar","value":1042},{"label":"Abr","value":839},{"label":"Mai","value":823},{"label":"Jun","value":805},{"label":"Jul","value":938},{"label":"Ago","value":686},{"label":"Set","value":855},{"label":"Out","value":831},{"label":"Nov","value":1013},{"label":"Dez","value":787}];
const MX = 1042;
