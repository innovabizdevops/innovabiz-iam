...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"1.027","t":"+11.2%","d":"up"},{"l":"Chamadas/Hora","v":"4237","t":"+9.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.0%","t":"+0.7%","d":"up"},{"l":"Latência Média (ms)","v":"136ms","t":"-1.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.268","8.097","92.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.226","3.770","91.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.664","8.467","84.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.324","3.394","82.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.108","8.431","70.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":469},{"label":"Mar","value":608},{"label":"Abr","value":456},{"label":"Mai","value":637},{"label":"Jun","value":721},{"label":"Jul","value":680},{"label":"Ago","value":635},{"label":"Set","value":418},{"label":"Out","value":548},{"label":"Nov","value":395},{"label":"Dez","value":482}];
const MX = 721;
