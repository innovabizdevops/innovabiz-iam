...
/* ═══ Wedding Videography — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "1387", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4885", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€141K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "540739287", cells: ["WED-2287", "Wedding Videography Item 1", "12/4/2026", "€39 387"], status: "active" as const },
    { id: "540742858", cells: ["WED-5858", "Wedding Videography Item 2", "27/11/2026", "€42 958"], status: "pending" as const },
    { id: "540746429", cells: ["WED-9429", "Wedding Videography Item 3", "14/6/2026", "€46 529"], status: "completed" as const },
    { id: "540750000", cells: ["WED-4000", "Wedding Videography Item 4", "1/1/2026", "€100"], status: "warning" as const },
    { id: "540753571", cells: ["WED-7571", "Wedding Videography Item 5", "16/8/2026", "€3671"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Videography</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Videography</p>
                    </div>
                </div>
