...
const PAGE = "Color";
const KPIS = [{"l":"Total Print Workflow","v":"7.176","t":"+1.7%","d":"up"},{"l":"Color Ativos","v":"4.140","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"82.2%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"95","t":"+5.1%","d":"up"}];
const COLS = ["ID","Color","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Workflow #001","Print Workflow #002","3.402","5.625","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Print Workflow #002","Print Workflow #003","235","510","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Workflow #003","Print Workflow #004","6.728","2.473","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Print Workflow #004","Print Workflow #005","2.929","4.056","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Workflow #005","Print Workflow #001","5.993","1.903","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":630},{"label":"Mar","value":378},{"label":"Abr","value":660},{"label":"Mai","value":658},{"label":"Jun","value":583},{"label":"Jul","value":578},{"label":"Ago","value":377},{"label":"Set","value":415},{"label":"Out","value":505},{"label":"Nov","value":292},{"label":"Dez","value":430}];
const MX = 660;
