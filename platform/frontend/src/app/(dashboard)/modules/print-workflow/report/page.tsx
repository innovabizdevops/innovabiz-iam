...
const PAGE = "Report";
const KPIS = [{"l":"Total Print Workflow","v":"5.921","t":"+14.4%","d":"up"},{"l":"Report Ativos","v":"451","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"73","t":"+15.8%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Workflow #001","Print Workflow #002","6.462","111","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Print Workflow #002","Print Workflow #003","3.408","6.497","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Workflow #003","Print Workflow #004","8.562","6.243","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Print Workflow #004","Print Workflow #005","3.799","689","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Workflow #005","Print Workflow #001","3.005","2.915","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":696},{"label":"Mar","value":660},{"label":"Abr","value":766},{"label":"Mai","value":677},{"label":"Jun","value":677},{"label":"Jul","value":448},{"label":"Ago","value":704},{"label":"Set","value":627},{"label":"Out","value":600},{"label":"Nov","value":504},{"label":"Dez","value":770}];
const MX = 770;
