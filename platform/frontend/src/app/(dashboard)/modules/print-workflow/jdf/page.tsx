...
const ACCENT = "#6366f1";
const MODULE = "Print Workflow";
const PAGE = "JDF/JMF";
const KPIS = [{"l":"Total Print Workflow","v":"7.442","t":"+10.5%","d":"up"},{"l":"JDF/JMF Ativos","v":"8.347","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"80","t":"-0.7%","d":"down"}];
const COLS = ["ID","JDF/JMF","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Workflow #001","Print Workflow #002","4.255","7.049","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Print Workflow #002","Print Workflow #003","1.831","3.978","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Workflow #003","Print Workflow #004","5.231","1.752","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Print Workflow #004","Print Workflow #005","7.036","7.804","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Workflow #005","Print Workflow #001","8.711","6.579","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":705},{"label":"Mar","value":1022},{"label":"Abr","value":928},{"label":"Mai","value":821},{"label":"Jun","value":951},{"label":"Jul","value":823},{"label":"Ago","value":736},{"label":"Set","value":935},{"label":"Out","value":793},{"label":"Nov","value":1021},{"label":"Dez","value":669}];
const MX = 1022;
...
export default function JdfPage() {
    return (
