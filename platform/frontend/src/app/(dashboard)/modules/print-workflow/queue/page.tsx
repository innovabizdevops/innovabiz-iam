...
const PAGE = "Queue";
const KPIS = [{"l":"Total Print Workflow","v":"6.183","t":"+12.8%","d":"up"},{"l":"Queue Ativos","v":"6.781","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"91.1%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.9%","d":"up"}];
const COLS = ["ID","Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Print Workflow #001","Print Workflow #002","3.770","3.848","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Print Workflow #002","Print Workflow #003","833","387","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Print Workflow #003","Print Workflow #004","1.891","2.232","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Print Workflow #004","Print Workflow #005","974","8.265","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Print Workflow #005","Print Workflow #001","7.466","8.550","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":736},{"label":"Mar","value":581},{"label":"Abr","value":705},{"label":"Mai","value":512},{"label":"Jun","value":838},{"label":"Jul","value":531},{"label":"Ago","value":736},{"label":"Set","value":532},{"label":"Out","value":529},{"label":"Nov","value":471},{"label":"Dez","value":559}];
const MX = 838;
