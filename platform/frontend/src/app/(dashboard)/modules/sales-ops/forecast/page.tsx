...
const ACCENT = "#1e40af";
const MODULE = "Sales Operations (APQC 3.4)";
const PAGE = "Forecast";
const KPIS = [{"l":"Vendas YTD (€)","v":"€24331","t":"+2.3%","d":"up"},{"l":"Pipeline (€)","v":"€63488","t":"-0.1%","d":"down"},{"l":"Atingimento Quota (%)","v":"89.9%","t":"-5.9%","d":"down"},{"l":"Win Rate (%)","v":"67.7%","t":"+11.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 22137.98","€ 44706.33","€ 24998.27","97.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 47622.17","€ 22332.84","€ 16058.31","78.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 36960.52","€ 10922.01","€ 16848.73","92.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 38187.32","€ 37766.20","€ 21277.20","96.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 5271.80","€ 10542.05","€ 11385.28","95.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":693},{"label":"Mar","value":506},{"label":"Abr","value":511},{"label":"Mai","value":667},{"label":"Jun","value":555},{"label":"Jul","value":541},{"label":"Ago","value":504},{"label":"Set","value":661},{"label":"Out","value":689},{"label":"Nov","value":505},{"label":"Dez","value":797}];
const MX = 797;
