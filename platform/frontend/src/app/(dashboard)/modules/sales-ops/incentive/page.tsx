...
const KPIS = [{"l":"Vendas YTD (€)","v":"€9244","t":"+13.8%","d":"up"},{"l":"Pipeline (€)","v":"€13594","t":"+6.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"68.4%","t":"+17.4%","d":"up"},{"l":"Win Rate (%)","v":"72.6%","t":"-5.6%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 17055.23","€ 46880.85","€ 32678.19","95.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 49788.18","€ 49618.70","€ 47782.19","86.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 36809.74","€ 31401.57","€ 41857.68","95.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 49700.45","€ 47407.70","€ 47902.00","76.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 26102.41","€ 33121.40","€ 10841.66","98.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":628},{"label":"Mar","value":431},{"label":"Abr","value":576},{"label":"Mai","value":705},{"label":"Jun","value":491},{"label":"Jul","value":619},{"label":"Ago","value":506},{"label":"Set","value":401},{"label":"Out","value":644},{"label":"Nov","value":472},{"label":"Dez","value":379}];
const MX = 705;
