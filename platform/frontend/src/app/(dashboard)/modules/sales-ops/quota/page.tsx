...
const PAGE = "Quota";
const KPIS = [{"l":"Vendas YTD (€)","v":"€61563","t":"-2.4%","d":"down"},{"l":"Pipeline (€)","v":"€73950","t":"-5.4%","d":"down"},{"l":"Atingimento Quota (%)","v":"80.4%","t":"+16.2%","d":"up"},{"l":"Win Rate (%)","v":"76.7%","t":"+8.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 43724.42","€ 24121.44","€ 12378.97","71.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36967.53","€ 18748.71","€ 8422.62","73.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 5542.29","€ 15909.53","€ 6573.41","80.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 12858.20","€ 18538.72","€ 2198.96","85.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 16887.98","€ 33149.55","€ 4518.34","84.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":783},{"label":"Mar","value":583},{"label":"Abr","value":827},{"label":"Mai","value":492},{"label":"Jun","value":821},{"label":"Jul","value":638},{"label":"Ago","value":694},{"label":"Set","value":671},{"label":"Out","value":460},{"label":"Nov","value":488},{"label":"Dez","value":622}];
const MX = 827;
