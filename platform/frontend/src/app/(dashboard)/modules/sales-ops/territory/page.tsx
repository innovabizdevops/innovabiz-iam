...
const PAGE = "Territory";
const KPIS = [{"l":"Vendas YTD (€)","v":"€89132","t":"-0.7%","d":"down"},{"l":"Pipeline (€)","v":"€99954","t":"+6.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"89.2%","t":"+12.9%","d":"up"},{"l":"Win Rate (%)","v":"76.4%","t":"+11.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 36198.36","€ 40473.23","€ 30148.94","77.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 47059.59","€ 29349.67","€ 37772.31","99.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 48481.05","€ 28055.92","€ 8620.93","77.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 25296.04","€ 17298.40","€ 34902.12","80.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 21545.97","€ 35617.75","€ 49132.63","76.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":581},{"label":"Mar","value":395},{"label":"Abr","value":456},{"label":"Mai","value":308},{"label":"Jun","value":423},{"label":"Jul","value":625},{"label":"Ago","value":554},{"label":"Set","value":393},{"label":"Out","value":382},{"label":"Nov","value":532},{"label":"Dez","value":469}];
const MX = 625;
