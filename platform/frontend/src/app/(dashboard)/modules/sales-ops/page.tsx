...
/* ═══ Sales Operations (APQC 3.4) — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "3344", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4730", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€355K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "876717544", cells: ["SAL-1544", "Sales Operations (APQC 3.4) Item 1", "25/5/2026", "€17 644"], status: "active" as const },
    { id: "876721115", cells: ["SAL-5115", "Sales Operations (APQC 3.4) Item 2", "12/12/2026", "€21 215"], status: "pending" as const },
    { id: "876724686", cells: ["SAL-8686", "Sales Operations (APQC 3.4) Item 3", "27/7/2026", "€24 786"], status: "completed" as const },
    { id: "876728257", cells: ["SAL-3257", "Sales Operations (APQC 3.4) Item 4", "14/2/2026", "€28 357"], status: "warning" as const },
    { id: "876731828", cells: ["SAL-6828", "Sales Operations (APQC 3.4) Item 5", "1/9/2026", "€31 928"], status: "active" as const },
];
...
export default function SalesOperationsApqc34Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sales Operations (APQC 3.4)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sales Operations (APQC 3.4)</p>
                    </div>
                </div>
