...
const PAGE = "Pipeline";
const KPIS = [{"l":"Vendas YTD (€)","v":"€75393","t":"+17.4%","d":"up"},{"l":"Pipeline (€)","v":"€80532","t":"+2.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"71.9%","t":"+5.2%","d":"up"},{"l":"Win Rate (%)","v":"70.1%","t":"+7.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 17049.00","€ 22344.23","€ 14221.64","93.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 32507.68","€ 35862.18","€ 36701.23","77.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 32223.34","€ 29525.24","€ 25345.86","84.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 39542.39","€ 43626.72","€ 3367.04","88.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31797.39","€ 16190.62","€ 20506.19","71.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":593},{"label":"Mar","value":530},{"label":"Abr","value":867},{"label":"Mai","value":812},{"label":"Jun","value":737},{"label":"Jul","value":621},{"label":"Ago","value":523},{"label":"Set","value":719},{"label":"Out","value":587},{"label":"Nov","value":582},{"label":"Dez","value":610}];
const MX = 867;
