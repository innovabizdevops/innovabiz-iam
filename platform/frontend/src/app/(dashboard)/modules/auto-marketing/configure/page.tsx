...
const KPIS = [{"l":"Configurações","v":"7.720","t":"+0.4%","d":"up"},{"l":"Últimas Alterações","v":"4.674","t":"-0.3%","d":"down"},{"l":"Ambientes","v":"7.169","t":"+6.3%","d":"up"},{"l":"Versão Config","v":"868","t":"+2.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 43185.19","3.600","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 6855.08","8.295","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 7189.05","7.427","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 27511.79","7.723","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 1518.84","3.622","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":574},{"label":"Mar","value":711},{"label":"Abr","value":715},{"label":"Mai","value":701},{"label":"Jun","value":436},{"label":"Jul","value":701},{"label":"Ago","value":366},{"label":"Set","value":363},{"label":"Out","value":402},{"label":"Nov","value":532},{"label":"Dez","value":707}];
const MX = 715;
