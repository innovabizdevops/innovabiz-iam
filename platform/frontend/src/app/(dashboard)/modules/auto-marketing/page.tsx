...
const KPIS = [
    { label: "Total Registos", value: "5965", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3925", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€437K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "937714065", cells: ["AUT-5065", "Automotive Marketing Item 1", "2/10/2026", "€14 165"], status: "active" as const },
    { id: "937717636", cells: ["AUT-8636", "Automotive Marketing Item 2", "17/5/2026", "€17 736"], status: "pending" as const },
    { id: "937721207", cells: ["AUT-3207", "Automotive Marketing Item 3", "4/12/2026", "€21 307"], status: "completed" as const },
    { id: "937724778", cells: ["AUT-6778", "Automotive Marketing Item 4", "19/7/2026", "€24 878"], status: "warning" as const },
    { id: "937728349", cells: ["AUT-1349", "Automotive Marketing Item 5", "6/2/2026", "€28 449"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Automotive Marketing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Automotive Marketing</p>
                    </div>
                </div>
