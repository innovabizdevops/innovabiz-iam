...
const ACCENT = "#1e3a5f";
const MODULE = "Automotive Marketing";
const PAGE = "Incentive";
const KPIS = [{"l":"Vendas YTD (€)","v":"€33333","t":"-0.3%","d":"down"},{"l":"Pipeline (€)","v":"€9730","t":"+4.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"94.0%","t":"-2.9%","d":"down"},{"l":"Win Rate (%)","v":"76.0%","t":"+1.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7798.00","€ 17551.63","€ 2012.48","87.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 35365.53","€ 17156.33","€ 28322.64","94.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 9310.96","€ 12866.55","€ 43475.70","74.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 11969.32","€ 15244.79","€ 40927.19","97.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4047.29","€ 45446.58","€ 2977.10","86.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":697},{"label":"Mar","value":735},{"label":"Abr","value":924},{"label":"Mai","value":630},{"label":"Jun","value":720},{"label":"Jul","value":788},{"label":"Ago","value":735},{"label":"Set","value":644},{"label":"Out","value":897},{"label":"Nov","value":944},{"label":"Dez","value":730}];
const MX = 944;
