...
const PAGE = "Improve";
const KPIS = [{"l":"Projetos Melhoria","v":"5.716","t":"+0.6%","d":"up"},{"l":"Savings (€)","v":"€29502","t":"-2.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"67.5%","t":"+9.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.351","t":"+0.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.198","€ 13044.95","8.442","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.640","€ 910.70","180","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.822","€ 27305.82","2.646","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.940","€ 32057.28","4.163","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.298","€ 45354.86","8.478","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":387},{"label":"Mar","value":526},{"label":"Abr","value":379},{"label":"Mai","value":407},{"label":"Jun","value":619},{"label":"Jul","value":691},{"label":"Ago","value":612},{"label":"Set","value":505},{"label":"Out","value":455},{"label":"Nov","value":675},{"label":"Dez","value":580}];
const MX = 691;
