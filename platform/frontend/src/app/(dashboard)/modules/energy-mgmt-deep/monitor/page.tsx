...
const ACCENT = "#065f46";
const MODULE = "Energy Management (ISO 50001)";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Energy Mgmt Deep","v":"4.232","t":"+4.4%","d":"up"},{"l":"Monitor Ativos","v":"2.774","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"69.3%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"63","t":"+13.6%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt Deep #001","Energy Mgmt Deep #002","3.121","4.222","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt Deep #002","Energy Mgmt Deep #003","7.947","1.378","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt Deep #003","Energy Mgmt Deep #004","2.650","8.215","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt Deep #004","Energy Mgmt Deep #005","7.230","5.838","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt Deep #005","Energy Mgmt Deep #001","173","8.693","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":490},{"label":"Mar","value":424},{"label":"Abr","value":243},{"label":"Mai","value":618},{"label":"Jun","value":280},{"label":"Jul","value":563},{"label":"Ago","value":302},{"label":"Set","value":616},{"label":"Out","value":270},{"label":"Nov","value":566},{"label":"Dez","value":533}];
const MX = 618;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#065f46'}}>IoT</span></h1>
                </div>
