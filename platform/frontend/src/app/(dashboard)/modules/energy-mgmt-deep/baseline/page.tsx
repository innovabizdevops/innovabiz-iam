...
const PAGE = "Baseline";
const KPIS = [{"l":"Total Energy Mgmt Deep","v":"1.538","t":"+16.6%","d":"up"},{"l":"Baseline Ativos","v":"6.555","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"85","t":"+16.7%","d":"up"}];
const COLS = ["ID","Baseline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt Deep #001","Energy Mgmt Deep #002","7.547","6.975","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt Deep #002","Energy Mgmt Deep #003","6.925","5.830","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt Deep #003","Energy Mgmt Deep #004","7.238","6.809","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt Deep #004","Energy Mgmt Deep #005","8.489","2.555","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt Deep #005","Energy Mgmt Deep #001","7.314","7.660","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":740},{"label":"Mar","value":612},{"label":"Abr","value":988},{"label":"Mai","value":716},{"label":"Jun","value":959},{"label":"Jul","value":852},{"label":"Ago","value":939},{"label":"Set","value":921},{"label":"Out","value":596},{"label":"Nov","value":808},{"label":"Dez","value":697}];
const MX = 988;
