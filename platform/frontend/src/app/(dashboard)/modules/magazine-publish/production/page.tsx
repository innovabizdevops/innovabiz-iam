...
const ACCENT = "#6366f1";
const MODULE = "Magazine Publishing";
const PAGE = "Production";
const KPIS = [{"l":"Total Magazine Publish","v":"6.102","t":"+10.5%","d":"up"},{"l":"Production Ativos","v":"1.238","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"79","t":"-2.8%","d":"down"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Magazine Publish #001","Magazine Publish #002","7.830","8.471","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Magazine Publish #002","Magazine Publish #003","3.490","491","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Magazine Publish #003","Magazine Publish #004","7.867","1.598","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Magazine Publish #004","Magazine Publish #005","4.648","368","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Magazine Publish #005","Magazine Publish #001","6.271","6.195","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":921},{"label":"Fev","value":887},{"label":"Mar","value":802},{"label":"Abr","value":739},{"label":"Mai","value":808},{"label":"Jun","value":978},{"label":"Jul","value":900},{"label":"Ago","value":771},{"label":"Set","value":655},{"label":"Out","value":921},{"label":"Nov","value":808},{"label":"Dez","value":1001}];
const MX = 1001;
