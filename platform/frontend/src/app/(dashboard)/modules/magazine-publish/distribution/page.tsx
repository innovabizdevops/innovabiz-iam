...
const KPIS = [{"l":"Total Magazine Publish","v":"450","t":"+7.4%","d":"up"},{"l":"Distribution Ativos","v":"558","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"56","t":"-2.3%","d":"down"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Magazine Publish #001","Magazine Publish #002","4.613","8.599","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Magazine Publish #002","Magazine Publish #003","1.425","1.797","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Magazine Publish #003","Magazine Publish #004","7.776","420","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Magazine Publish #004","Magazine Publish #005","4.655","3.892","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Magazine Publish #005","Magazine Publish #001","731","201","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":707},{"label":"Mar","value":879},{"label":"Abr","value":840},{"label":"Mai","value":768},{"label":"Jun","value":732},{"label":"Jul","value":884},{"label":"Ago","value":656},{"label":"Set","value":926},{"label":"Out","value":682},{"label":"Nov","value":721},{"label":"Dez","value":763}];
const MX = 926;
