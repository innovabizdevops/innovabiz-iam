...
const KPIS = [{"l":"Integrações Ativas","v":"1.924","t":"-0.2%","d":"down"},{"l":"Chamadas/Hora","v":"1542","t":"+9.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.3%","t":"+15.4%","d":"up"},{"l":"Latência Média (ms)","v":"164ms","t":"+7.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.378","6.680","90.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.655","2.063","92.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.849","1.076","83.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","815","6.833","76.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.004","6.874","90.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":672},{"label":"Mar","value":413},{"label":"Abr","value":443},{"label":"Mai","value":676},{"label":"Jun","value":387},{"label":"Jul","value":307},{"label":"Ago","value":364},{"label":"Set","value":582},{"label":"Out","value":572},{"label":"Nov","value":677},{"label":"Dez","value":383}];
const MX = 677;
