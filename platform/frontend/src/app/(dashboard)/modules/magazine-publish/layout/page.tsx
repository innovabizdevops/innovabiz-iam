...
const PAGE = "Layout";
const KPIS = [{"l":"Total Magazine Publish","v":"634","t":"-5.3%","d":"down"},{"l":"Layout Ativos","v":"701","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"61","t":"-5.7%","d":"down"}];
const COLS = ["ID","Layout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Magazine Publish #001","Magazine Publish #002","933","5.784","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Magazine Publish #002","Magazine Publish #003","3.551","7.273","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Magazine Publish #003","Magazine Publish #004","6.928","8.343","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Magazine Publish #004","Magazine Publish #005","717","8.167","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Magazine Publish #005","Magazine Publish #001","3.948","7.358","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":407},{"label":"Mar","value":571},{"label":"Abr","value":457},{"label":"Mai","value":575},{"label":"Jun","value":695},{"label":"Jul","value":460},{"label":"Ago","value":661},{"label":"Set","value":471},{"label":"Out","value":395},{"label":"Nov","value":472},{"label":"Dez","value":500}];
const MX = 695;
