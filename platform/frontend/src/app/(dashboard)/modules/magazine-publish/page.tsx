...
export default function MagazinePublishPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Magazine Publish</h1><p className="text-sm text-muted-foreground">Magazine Publish • iBOS Enterprise</p></div>
