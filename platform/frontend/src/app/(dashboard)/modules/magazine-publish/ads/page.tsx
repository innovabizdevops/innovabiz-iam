...
const PAGE = "Ad Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€47640","t":"+0.3%","d":"up"},{"l":"Pipeline (€)","v":"€13353","t":"-4.9%","d":"down"},{"l":"Atingimento Quota (%)","v":"86.0%","t":"-5.0%","d":"down"},{"l":"Win Rate (%)","v":"80.9%","t":"+5.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 27508.75","€ 16684.75","€ 30381.75","76.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 23759.88","€ 37767.38","€ 27850.21","90.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 16113.48","€ 14768.72","€ 6450.50","71.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 2906.41","€ 19021.99","€ 13469.50","86.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 29387.73","€ 2759.05","€ 22011.85","79.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":372},{"label":"Mar","value":699},{"label":"Abr","value":636},{"label":"Mai","value":659},{"label":"Jun","value":658},{"label":"Jul","value":453},{"label":"Ago","value":679},{"label":"Set","value":440},{"label":"Out","value":720},{"label":"Nov","value":527},{"label":"Dez","value":357}];
const MX = 720;
