...
const ACCENT = "#6366f1";
const MODULE = "Green Supply Chain";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Green Supply","v":"4.224","t":"+15.2%","d":"up"},{"l":"Optimize Ativos","v":"3.518","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"58","t":"-0.1%","d":"down"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Supply #001","Green Supply #002","4.970","3.894","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Green Supply #002","Green Supply #003","570","4.012","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Supply #003","Green Supply #004","3.519","4.196","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Green Supply #004","Green Supply #005","8.354","6.076","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Supply #005","Green Supply #001","783","5.300","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":497},{"label":"Mar","value":420},{"label":"Abr","value":576},{"label":"Mai","value":535},{"label":"Jun","value":365},{"label":"Jul","value":658},{"label":"Ago","value":590},{"label":"Set","value":647},{"label":"Out","value":661},{"label":"Nov","value":429},{"label":"Dez","value":302}];
const MX = 661;
