...
const PAGE = "Carbon";
const KPIS = [{"l":"Total Green Supply","v":"212","t":"+9.4%","d":"up"},{"l":"Carbon Ativos","v":"2.223","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+6.1%","d":"up"}];
const COLS = ["ID","Carbon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Supply #001","Green Supply #002","3.524","4.108","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Green Supply #002","Green Supply #003","8.981","2.672","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Supply #003","Green Supply #004","4.645","1.312","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Green Supply #004","Green Supply #005","2.677","1.226","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Supply #005","Green Supply #001","2.751","7.845","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":649},{"label":"Mar","value":700},{"label":"Abr","value":427},{"label":"Mai","value":681},{"label":"Jun","value":533},{"label":"Jul","value":646},{"label":"Ago","value":447},{"label":"Set","value":349},{"label":"Out","value":670},{"label":"Nov","value":352},{"label":"Dez","value":405}];
const MX = 700;
