...
export default function GreenSupplyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Green Supply</h1><p className="text-sm text-muted-foreground">Green Supply • iBOS Enterprise</p></div>
