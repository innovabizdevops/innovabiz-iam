...
const ACCENT = "#059669";
const MODULE = "Fabric Sourcing";
const PAGE = "Sustainability";
const KPIS = [{"l":"Total Fabric Source","v":"6.431","t":"-2.5%","d":"down"},{"l":"Sustainability Ativos","v":"727","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"95","t":"-5.1%","d":"down"}];
const COLS = ["ID","Sustainability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fabric Source #001","Fabric Source #002","2.355","6.968","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Fabric Source #002","Fabric Source #003","5.945","1.459","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Fabric Source #003","Fabric Source #004","1.482","2.694","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Fabric Source #004","Fabric Source #005","6.622","6.331","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fabric Source #005","Fabric Source #001","2.546","1.805","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":1048},{"label":"Mar","value":840},{"label":"Abr","value":848},{"label":"Mai","value":1014},{"label":"Jun","value":878},{"label":"Jul","value":936},{"label":"Ago","value":994},{"label":"Set","value":873},{"label":"Out","value":1008},{"label":"Nov","value":832},{"label":"Dez","value":705}];
const MX = 1048;
