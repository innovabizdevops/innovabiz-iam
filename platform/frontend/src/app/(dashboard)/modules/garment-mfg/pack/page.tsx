...
const PAGE = "Pack";
const KPIS = [{"l":"Total Garment Mfg","v":"510","t":"+16.1%","d":"up"},{"l":"Pack Ativos","v":"5.781","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"79","t":"-3.7%","d":"down"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Garment Mfg #001","Garment Mfg #002","4.755","2.880","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Garment Mfg #002","Garment Mfg #003","1.717","850","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Garment Mfg #003","Garment Mfg #004","7.347","4.165","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Garment Mfg #004","Garment Mfg #005","1.662","439","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Garment Mfg #005","Garment Mfg #001","324","1.827","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":877},{"label":"Mar","value":641},{"label":"Abr","value":869},{"label":"Mai","value":610},{"label":"Jun","value":547},{"label":"Jul","value":600},{"label":"Ago","value":874},{"label":"Set","value":778},{"label":"Out","value":706},{"label":"Nov","value":723},{"label":"Dez","value":687}];
const MX = 877;
