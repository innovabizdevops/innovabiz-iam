...
const PAGE = "Sew";
const KPIS = [{"l":"Total Garment Mfg","v":"392","t":"+6.5%","d":"up"},{"l":"Sew Ativos","v":"6.573","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"69.9%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"95","t":"+10.2%","d":"up"}];
const COLS = ["ID","Sew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Garment Mfg #001","Garment Mfg #002","1.388","7.490","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Garment Mfg #002","Garment Mfg #003","7.930","2.149","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Garment Mfg #003","Garment Mfg #004","4.769","1.308","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Garment Mfg #004","Garment Mfg #005","6.125","3.463","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Garment Mfg #005","Garment Mfg #001","3.027","5.927","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":347},{"label":"Mar","value":385},{"label":"Abr","value":306},{"label":"Mai","value":570},{"label":"Jun","value":669},{"label":"Jul","value":462},{"label":"Ago","value":308},{"label":"Set","value":454},{"label":"Out","value":605},{"label":"Nov","value":321},{"label":"Dez","value":517}];
const MX = 669;
...
export default function SewPage() {
    return (
