...
const ACCENT = "#6366f1";
const MODULE = "Garment Manufacturing";
const PAGE = "Pattern";
const KPIS = [{"l":"Total Garment Mfg","v":"6.071","t":"-4.0%","d":"down"},{"l":"Pattern Ativos","v":"4.736","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"69","t":"+2.8%","d":"up"}];
const COLS = ["ID","Pattern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Garment Mfg #001","Garment Mfg #002","6.960","5.080","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Garment Mfg #002","Garment Mfg #003","3.101","5.556","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Garment Mfg #003","Garment Mfg #004","6.016","564","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Garment Mfg #004","Garment Mfg #005","2.043","6.142","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Garment Mfg #005","Garment Mfg #001","4.101","4.681","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":574},{"label":"Mar","value":483},{"label":"Abr","value":352},{"label":"Mai","value":700},{"label":"Jun","value":378},{"label":"Jul","value":348},{"label":"Ago","value":701},{"label":"Set","value":372},{"label":"Out","value":608},{"label":"Nov","value":372},{"label":"Dez","value":488}];
const MX = 701;
