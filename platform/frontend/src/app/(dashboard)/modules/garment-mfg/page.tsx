...
export default function GarmentMfgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Garment Mfg</h1><p className="text-sm text-muted-foreground">Garment Mfg • iBOS Enterprise</p></div>
