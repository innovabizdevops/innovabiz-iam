...
const PAGE = "Lobby";
const KPIS = [{"l":"Formulários Ativos","v":"195","t":"+7.3%","d":"up"},{"l":"Submissões/Dia","v":"1054","t":"+3.0%","d":"up"},{"l":"Documentos Gerados","v":"8.970","t":"-2.8%","d":"down"},{"l":"Templates","v":"1.166","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.272","2026-02-19","8.154","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","700","2026-03-10","8.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.042","2026-02-19","7.319","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.750","2026-03-04","7.576","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","847","2026-01-12","1.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":699},{"label":"Mar","value":569},{"label":"Abr","value":861},{"label":"Mai","value":539},{"label":"Jun","value":674},{"label":"Jul","value":748},{"label":"Ago","value":886},{"label":"Set","value":898},{"label":"Out","value":565},{"label":"Nov","value":739},{"label":"Dez","value":705}];
const MX = 898;
