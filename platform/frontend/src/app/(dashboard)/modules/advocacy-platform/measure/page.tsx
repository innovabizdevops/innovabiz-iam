...
const ACCENT = "#9333ea";
const MODULE = "Advocacy & Campaigns";
const PAGE = "Measure";
const KPIS = [{"l":"Formulários Ativos","v":"3.148","t":"-5.8%","d":"down"},{"l":"Submissões/Dia","v":"2791","t":"+9.6%","d":"up"},{"l":"Documentos Gerados","v":"6.997","t":"+5.0%","d":"up"},{"l":"Templates","v":"6.142","t":"-3.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.359","2026-03-11","2.299","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.915","2026-02-23","3.740","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.422","2026-02-08","7.683","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.905","2026-02-02","8.875","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.855","2026-03-13","5.430","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":564},{"label":"Mar","value":571},{"label":"Abr","value":457},{"label":"Mai","value":638},{"label":"Jun","value":662},{"label":"Jul","value":578},{"label":"Ago","value":514},{"label":"Set","value":400},{"label":"Out","value":433},{"label":"Nov","value":621},{"label":"Dez","value":701}];
const MX = 701;
