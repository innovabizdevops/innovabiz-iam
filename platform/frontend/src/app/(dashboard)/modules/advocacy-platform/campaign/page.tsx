...
const PAGE = "Campaign";
const KPIS = [{"l":"Formulários Ativos","v":"2.641","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"3991","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"5.982","t":"+16.3%","d":"up"},{"l":"Templates","v":"2.318","t":"+10.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.096","2026-03-26","325","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.703","2026-03-21","661","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.530","2026-03-09","1.809","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.597","2026-03-28","5.274","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.882","2026-03-21","631","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":680},{"label":"Mar","value":599},{"label":"Abr","value":521},{"label":"Mai","value":440},{"label":"Jun","value":388},{"label":"Jul","value":448},{"label":"Ago","value":358},{"label":"Set","value":667},{"label":"Out","value":571},{"label":"Nov","value":519},{"label":"Dez","value":492}];
const MX = 727;
