...
const PAGE = "Petition";
const KPIS = [{"l":"Formulários Ativos","v":"3.951","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"2809","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"6.718","t":"+9.0%","d":"up"},{"l":"Templates","v":"6.606","t":"-4.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.075","2026-03-12","2.408","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.659","2026-01-19","488","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.693","2026-01-05","3.984","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.870","2026-02-14","5.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.256","2026-01-18","8.974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":720},{"label":"Mar","value":649},{"label":"Abr","value":821},{"label":"Mai","value":816},{"label":"Jun","value":928},{"label":"Jul","value":909},{"label":"Ago","value":538},{"label":"Set","value":604},{"label":"Out","value":728},{"label":"Nov","value":561},{"label":"Dez","value":710}];
const MX = 928;
