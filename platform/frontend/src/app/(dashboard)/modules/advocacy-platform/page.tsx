...
/* ═══ Advocacy & Campaigns — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "1339", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1317", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€205K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1807503639", cells: ["ADV-7639", "Advocacy & Campaigns Item 1", "12/4/2026", "€3739"], status: "active" as const },
    { id: "1807507210", cells: ["ADV-2210", "Advocacy & Campaigns Item 2", "27/11/2026", "€7310"], status: "pending" as const },
    { id: "1807510781", cells: ["ADV-5781", "Advocacy & Campaigns Item 3", "14/6/2026", "€10 881"], status: "completed" as const },
    { id: "1807514352", cells: ["ADV-9352", "Advocacy & Campaigns Item 4", "1/1/2026", "€14 452"], status: "warning" as const },
    { id: "1807517923", cells: ["ADV-3923", "Advocacy & Campaigns Item 5", "16/8/2026", "€18 023"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Advocacy & Campaigns</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Advocacy & Campaigns</p>
                    </div>
                </div>
