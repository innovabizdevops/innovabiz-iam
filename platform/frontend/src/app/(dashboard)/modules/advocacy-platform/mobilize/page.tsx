...
const PAGE = "Mobilize";
const KPIS = [{"l":"Formulários Ativos","v":"816","t":"+13.7%","d":"up"},{"l":"Submissões/Dia","v":"2503","t":"+7.2%","d":"up"},{"l":"Documentos Gerados","v":"1.897","t":"+7.5%","d":"up"},{"l":"Templates","v":"7.921","t":"-4.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.496","2026-01-12","401","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.550","2026-01-18","5.896","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.968","2026-01-18","4.934","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","460","2026-01-19","396","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.638","2026-03-28","2.706","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":826},{"label":"Mar","value":574},{"label":"Abr","value":742},{"label":"Mai","value":869},{"label":"Jun","value":860},{"label":"Jul","value":671},{"label":"Ago","value":664},{"label":"Set","value":900},{"label":"Out","value":610},{"label":"Nov","value":874},{"label":"Dez","value":818}];
const MX = 911;
