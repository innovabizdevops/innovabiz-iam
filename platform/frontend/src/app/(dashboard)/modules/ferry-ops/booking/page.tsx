...
const ACCENT = "#6366f1";
const MODULE = "Ferry Operations";
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"4.340","t":"+15.8%","d":"up"},{"l":"RevPAR (€)","v":"€89283","t":"-5.6%","d":"down"},{"l":"Ocupação (%)","v":"69.3%","t":"+2.5%","d":"up"},{"l":"Guest Satisfaction","v":"7.889","t":"+4.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.705","2026-02-08","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.897","2026-03-24","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.751","2026-01-13","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.088","2026-01-08","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.532","2026-02-09","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":999},{"label":"Fev","value":835},{"label":"Mar","value":1015},{"label":"Abr","value":854},{"label":"Mai","value":703},{"label":"Jun","value":744},{"label":"Jul","value":926},{"label":"Ago","value":720},{"label":"Set","value":881},{"label":"Out","value":1020},{"label":"Nov","value":691},{"label":"Dez","value":841}];
const MX = 1020;
