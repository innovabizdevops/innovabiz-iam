...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Ferry Ops","v":"8.900","t":"-2.9%","d":"down"},{"l":"Schedule Ativos","v":"6.069","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"75.2%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"90","t":"+0.7%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ferry Ops #001","Ferry Ops #002","5.292","2.418","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ferry Ops #002","Ferry Ops #003","4.293","6.165","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Ferry Ops #003","Ferry Ops #004","8.098","1.196","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ferry Ops #004","Ferry Ops #005","3.804","5.905","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ferry Ops #005","Ferry Ops #001","8.862","1.968","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":452},{"label":"Mar","value":472},{"label":"Abr","value":649},{"label":"Mai","value":520},{"label":"Jun","value":688},{"label":"Jul","value":484},{"label":"Ago","value":600},{"label":"Set","value":638},{"label":"Out","value":479},{"label":"Nov","value":468},{"label":"Dez","value":485}];
const MX = 688;
