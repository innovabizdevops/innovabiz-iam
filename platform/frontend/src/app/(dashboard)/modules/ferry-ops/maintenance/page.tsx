...
const KPIS = [{"l":"Total Ferry Ops","v":"4.757","t":"+7.8%","d":"up"},{"l":"Maintenance Ativos","v":"4.314","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"83","t":"+9.0%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ferry Ops #001","Ferry Ops #002","5.926","7.898","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Ferry Ops #002","Ferry Ops #003","4.887","5.806","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ferry Ops #003","Ferry Ops #004","5.387","7.009","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Ferry Ops #004","Ferry Ops #005","6.574","1.265","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ferry Ops #005","Ferry Ops #001","8.244","3.767","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":763},{"label":"Mar","value":623},{"label":"Abr","value":839},{"label":"Mai","value":816},{"label":"Jun","value":530},{"label":"Jul","value":520},{"label":"Ago","value":773},{"label":"Set","value":671},{"label":"Out","value":629},{"label":"Nov","value":766},{"label":"Dez","value":532}];
const MX = 839;
