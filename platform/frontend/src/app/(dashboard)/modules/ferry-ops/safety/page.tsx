...
const PAGE = "Safety";
const KPIS = [{"l":"Total Ferry Ops","v":"7.071","t":"-4.4%","d":"down"},{"l":"Safety Ativos","v":"8.612","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"93","t":"+8.1%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ferry Ops #001","Ferry Ops #002","5.978","2.165","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ferry Ops #002","Ferry Ops #003","3.139","4.961","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Ferry Ops #003","Ferry Ops #004","3.296","7.159","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Ferry Ops #004","Ferry Ops #005","1.598","4.948","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ferry Ops #005","Ferry Ops #001","2.167","7.336","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":988},{"label":"Mar","value":1003},{"label":"Abr","value":733},{"label":"Mai","value":987},{"label":"Jun","value":792},{"label":"Jul","value":830},{"label":"Ago","value":999},{"label":"Set","value":942},{"label":"Out","value":992},{"label":"Nov","value":760},{"label":"Dez","value":744}];
const MX = 1003;
