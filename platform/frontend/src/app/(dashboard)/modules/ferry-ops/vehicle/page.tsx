...
const PAGE = "Vehicle";
const KPIS = [{"l":"Total Ferry Ops","v":"8.867","t":"-5.1%","d":"down"},{"l":"Vehicle Ativos","v":"8.919","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"85.6%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"86","t":"+13.0%","d":"up"}];
const COLS = ["ID","Vehicle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ferry Ops #001","Ferry Ops #002","5.685","4.198","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Ferry Ops #002","Ferry Ops #003","7.682","2.961","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Ferry Ops #003","Ferry Ops #004","4.614","7.354","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Ferry Ops #004","Ferry Ops #005","342","7.559","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ferry Ops #005","Ferry Ops #001","6.555","8.962","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":846},{"label":"Mar","value":690},{"label":"Abr","value":616},{"label":"Mai","value":548},{"label":"Jun","value":524},{"label":"Jul","value":722},{"label":"Ago","value":862},{"label":"Set","value":510},{"label":"Out","value":867},{"label":"Nov","value":743},{"label":"Dez","value":705}];
const MX = 867;
