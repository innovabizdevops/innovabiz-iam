...
const KPIS = [
    { label: "Total Registos", value: "7766", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2918", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€311K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1289710366", cells: ["OPE-2366", "Operational Excellence Item 1", "15/11/2026", "€10 466"], status: "active" as const },
    { id: "1289713937", cells: ["OPE-5937", "Operational Excellence Item 2", "2/6/2026", "€14 037"], status: "pending" as const },
    { id: "1289717508", cells: ["OPE-9508", "Operational Excellence Item 3", "17/1/2026", "€17 608"], status: "completed" as const },
    { id: "1289721079", cells: ["OPE-4079", "Operational Excellence Item 4", "4/8/2026", "€21 179"], status: "warning" as const },
    { id: "1289724650", cells: ["OPE-7650", "Operational Excellence Item 5", "19/3/2026", "€24 750"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Operational Excellence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Operational Excellence</p>
                    </div>
                </div>
