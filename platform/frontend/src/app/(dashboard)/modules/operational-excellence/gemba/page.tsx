...
const PAGE = "Gemba";
const KPIS = [{"l":"Projetos Melhoria","v":"8.398","t":"-5.6%","d":"down"},{"l":"Savings (€)","v":"€87446","t":"+9.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.5%","t":"+8.1%","d":"up"},{"l":"Ciclos PDCA","v":"7.695","t":"+9.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.078","€ 12575.97","2.038","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.566","€ 47741.12","1.707","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.030","€ 24386.45","7.322","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.084","€ 470.09","7.652","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.207","€ 30716.55","1.465","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":661},{"label":"Mar","value":680},{"label":"Abr","value":422},{"label":"Mai","value":572},{"label":"Jun","value":650},{"label":"Jul","value":570},{"label":"Ago","value":492},{"label":"Set","value":637},{"label":"Out","value":719},{"label":"Nov","value":589},{"label":"Dez","value":472}];
const MX = 719;
