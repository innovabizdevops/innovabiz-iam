...
/* ═══ GovTech Suite — Census Platform ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "1801", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "452", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1034", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1962032624", cells: ["GOV-6624", "Census Platform Item 1", "21/9/2026", "€32 724"], status: "active" as const },
    { id: "1962036195", cells: ["GOV-1195", "Census Platform Item 2", "8/4/2026", "€36 295"], status: "pending" as const },
    { id: "1962039766", cells: ["GOV-4766", "Census Platform Item 3", "23/11/2026", "€39 866"], status: "completed" as const },
    { id: "1962043337", cells: ["GOV-8337", "Census Platform Item 4", "10/6/2026", "€43 437"], status: "warning" as const },
    { id: "1962046908", cells: ["GOV-2908", "Census Platform Item 5", "25/1/2026", "€47 008"], status: "active" as const },
];
...
export default function GovtechSuiteCensusPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Census Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Census Platform</p>
                    </div>
                </div>
