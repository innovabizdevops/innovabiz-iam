...
/* ═══ GovTech Suite — Prison Mgmt ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "2805", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "252", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2619", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1248575112", cells: ["GOV-6112", "Prison Mgmt Item 1", "9/1/2026", "€25 212"], status: "active" as const },
    { id: "1248578683", cells: ["GOV-9683", "Prison Mgmt Item 2", "24/8/2026", "€28 783"], status: "pending" as const },
    { id: "1248582254", cells: ["GOV-4254", "Prison Mgmt Item 3", "11/3/2026", "€32 354"], status: "completed" as const },
    { id: "1248585825", cells: ["GOV-7825", "Prison Mgmt Item 4", "26/10/2026", "€35 925"], status: "warning" as const },
    { id: "1248589396", cells: ["GOV-2396", "Prison Mgmt Item 5", "13/5/2026", "€39 496"], status: "active" as const },
];
...
export default function GovtechSuitePrisonMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Prison Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Prison Mgmt</p>
                    </div>
                </div>
