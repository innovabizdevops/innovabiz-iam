...
/* ═══ GovTech Suite — Citizen Id ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "3165", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "195", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3048", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "401421935", cells: ["GOV-4935", "Citizen Id Item 1", "20/12/2026", "€22 035"], status: "active" as const },
    { id: "401425506", cells: ["GOV-8506", "Citizen Id Item 2", "7/7/2026", "€25 606"], status: "pending" as const },
    { id: "401429077", cells: ["GOV-3077", "Citizen Id Item 3", "22/2/2026", "€29 177"], status: "completed" as const },
    { id: "401432648", cells: ["GOV-6648", "Citizen Id Item 4", "9/9/2026", "€32 748"], status: "warning" as const },
    { id: "401436219", cells: ["GOV-1219", "Citizen Id Item 5", "24/4/2026", "€36 319"], status: "active" as const },
];
...
export default function GovtechSuiteCitizenIdPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Citizen Id</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Citizen Id</p>
                    </div>
                </div>
