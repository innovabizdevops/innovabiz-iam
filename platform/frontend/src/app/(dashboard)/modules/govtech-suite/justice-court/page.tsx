...
/* ═══ GovTech Suite — Justice Court ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "777", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "296", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2234", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "372833588", cells: ["GOV-9588", "Justice Court Item 1", "9/9/2026", "€33 688"], status: "active" as const },
    { id: "372837159", cells: ["GOV-4159", "Justice Court Item 2", "24/4/2026", "€37 259"], status: "pending" as const },
    { id: "372840730", cells: ["GOV-7730", "Justice Court Item 3", "11/11/2026", "€40 830"], status: "completed" as const },
    { id: "372844301", cells: ["GOV-2301", "Justice Court Item 4", "26/6/2026", "€44 401"], status: "warning" as const },
    { id: "372847872", cells: ["GOV-5872", "Justice Court Item 5", "13/1/2026", "€47 972"], status: "active" as const },
];
...
export default function GovtechSuiteJusticeCourtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Justice Court</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Justice Court</p>
                    </div>
                </div>
