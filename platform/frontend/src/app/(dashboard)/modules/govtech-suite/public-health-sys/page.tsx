...
/* ═══ GovTech Suite — Public Health Sys ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "788", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "82", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3466", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "89%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "427838782", cells: ["GOV-6782", "Public Health Sys Item 1", "15/11/2026", "€38 882"], status: "active" as const },
    { id: "427842353", cells: ["GOV-1353", "Public Health Sys Item 2", "2/6/2026", "€42 453"], status: "pending" as const },
    { id: "427845924", cells: ["GOV-4924", "Public Health Sys Item 3", "17/1/2026", "€46 024"], status: "completed" as const },
    { id: "427849495", cells: ["GOV-8495", "Public Health Sys Item 4", "4/8/2026", "€49 595"], status: "warning" as const },
    { id: "427853066", cells: ["GOV-3066", "Public Health Sys Item 5", "19/3/2026", "€3166"], status: "active" as const },
];
...
export default function GovtechSuitePublicHealthSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Public Health Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Public Health Sys</p>
                    </div>
                </div>
