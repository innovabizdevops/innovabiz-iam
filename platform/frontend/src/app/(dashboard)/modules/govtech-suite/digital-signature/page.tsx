...
/* ═══ GovTech Suite — Digital Signature ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "1881", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "242", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "872", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1622318542", cells: ["GOV-6542", "Digital Signature Item 1", "27/11/2026", "€18 642"], status: "active" as const },
    { id: "1622322113", cells: ["GOV-1113", "Digital Signature Item 2", "14/6/2026", "€22 213"], status: "pending" as const },
    { id: "1622325684", cells: ["GOV-4684", "Digital Signature Item 3", "1/1/2026", "€25 784"], status: "completed" as const },
    { id: "1622329255", cells: ["GOV-8255", "Digital Signature Item 4", "16/8/2026", "€29 355"], status: "warning" as const },
    { id: "1622332826", cells: ["GOV-2826", "Digital Signature Item 5", "3/3/2026", "€32 926"], status: "active" as const },
];
...
export default function GovtechSuiteDigitalSignaturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Signature</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Digital Signature</p>
                    </div>
                </div>
