...
/* ═══ GovTech Suite — E Procurement Gov ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "186", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "489", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1716", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "84%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "21373637", cells: ["GOV-8637", "E Procurement Gov Item 1", "6/6/2026", "€23 737"], status: "active" as const },
    { id: "21377208", cells: ["GOV-3208", "E Procurement Gov Item 2", "21/1/2026", "€27 308"], status: "pending" as const },
    { id: "21380779", cells: ["GOV-6779", "E Procurement Gov Item 3", "8/8/2026", "€30 879"], status: "completed" as const },
    { id: "21384350", cells: ["GOV-1350", "E Procurement Gov Item 4", "23/3/2026", "€34 450"], status: "warning" as const },
    { id: "21387921", cells: ["GOV-4921", "E Procurement Gov Item 5", "10/10/2026", "€38 021"], status: "active" as const },
];
...
export default function GovtechSuiteEProcurementGovPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">E Procurement Gov</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • E Procurement Gov</p>
                    </div>
                </div>
