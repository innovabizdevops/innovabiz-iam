...
/* ═══ GovTech Suite — Welfare Mgmt ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "274", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "337", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1307", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1860837101", cells: ["GOV-7101", "Welfare Mgmt Item 1", "26/6/2026", "€37 201"], status: "active" as const },
    { id: "1860840672", cells: ["GOV-1672", "Welfare Mgmt Item 2", "13/1/2026", "€40 772"], status: "pending" as const },
    { id: "1860844243", cells: ["GOV-5243", "Welfare Mgmt Item 3", "28/8/2026", "€44 343"], status: "completed" as const },
    { id: "1860847814", cells: ["GOV-8814", "Welfare Mgmt Item 4", "15/3/2026", "€47 914"], status: "warning" as const },
    { id: "1860851385", cells: ["GOV-3385", "Welfare Mgmt Item 5", "2/10/2026", "€1485"], status: "active" as const },
];
...
export default function GovtechSuiteWelfareMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Welfare Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Welfare Mgmt</p>
                    </div>
                </div>
