...
/* ═══ GovTech Suite — Customs Border ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "1837", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "188", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "397", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1393023144", cells: ["GOV-4144", "Customs Border Item 1", "17/1/2026", "€23 244"], status: "active" as const },
    { id: "1393026715", cells: ["GOV-7715", "Customs Border Item 2", "4/8/2026", "€26 815"], status: "pending" as const },
    { id: "1393030286", cells: ["GOV-2286", "Customs Border Item 3", "19/3/2026", "€30 386"], status: "completed" as const },
    { id: "1393033857", cells: ["GOV-5857", "Customs Border Item 4", "6/10/2026", "€33 957"], status: "warning" as const },
    { id: "1393037428", cells: ["GOV-9428", "Customs Border Item 5", "21/5/2026", "€37 528"], status: "active" as const },
];
...
export default function GovtechSuiteCustomsBorderPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customs Border</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Customs Border</p>
                    </div>
                </div>
