...
/* ═══ GovTech Suite — Social Benefit ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total", value: "4207", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "98", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "439", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1663852446", cells: ["GOV-5446", "Social Benefit Item 1", "19/7/2026", "€2546"], status: "active" as const },
    { id: "1663856017", cells: ["GOV-9017", "Social Benefit Item 2", "6/2/2026", "€6117"], status: "pending" as const },
    { id: "1663859588", cells: ["GOV-3588", "Social Benefit Item 3", "21/9/2026", "€9688"], status: "completed" as const },
    { id: "1663863159", cells: ["GOV-7159", "Social Benefit Item 4", "8/4/2026", "€13 259"], status: "warning" as const },
    { id: "1663866730", cells: ["GOV-1730", "Social Benefit Item 5", "23/11/2026", "€16 830"], status: "active" as const },
];
...
export default function GovtechSuiteSocialBenefitPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Social Benefit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">GovTech Suite • Social Benefit</p>
                    </div>
                </div>
