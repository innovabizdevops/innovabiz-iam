...
const KPIS = [
    { label: "Total Registos", value: "5150", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2677", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€79K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1679846950", cells: ["NET-6950", "Network Security Item 1", "27/11/2026", "€47 050"], status: "active" as const },
    { id: "1679850521", cells: ["NET-1521", "Network Security Item 2", "14/6/2026", "€621"], status: "pending" as const },
    { id: "1679854092", cells: ["NET-5092", "Network Security Item 3", "1/1/2026", "€4192"], status: "completed" as const },
    { id: "1679857663", cells: ["NET-8663", "Network Security Item 4", "16/8/2026", "€7763"], status: "warning" as const },
    { id: "1679861234", cells: ["NET-3234", "Network Security Item 5", "3/3/2026", "€11 334"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Network Security</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Network Security</p>
                    </div>
                </div>
