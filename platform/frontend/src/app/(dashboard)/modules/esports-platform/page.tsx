...
const KPIS = [
    { label: "Total Registos", value: "5289", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1122", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€226K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "153039389", cells: ["ESP-4389", "Esports Management Item 1", "14/6/2026", "€39 489"], status: "active" as const },
    { id: "153042960", cells: ["ESP-7960", "Esports Management Item 2", "1/1/2026", "€43 060"], status: "pending" as const },
    { id: "153046531", cells: ["ESP-2531", "Esports Management Item 3", "16/8/2026", "€46 631"], status: "completed" as const },
    { id: "153050102", cells: ["ESP-6102", "Esports Management Item 4", "3/3/2026", "€202"], status: "warning" as const },
    { id: "153053673", cells: ["ESP-9673", "Esports Management Item 5", "18/10/2026", "€3773"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Esports Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Esports Management</p>
                    </div>
                </div>
