...
const KPIS = [{"l":"Formulários Ativos","v":"4.236","t":"+16.9%","d":"up"},{"l":"Submissões/Dia","v":"1320","t":"+8.3%","d":"up"},{"l":"Documentos Gerados","v":"1.742","t":"-5.7%","d":"down"},{"l":"Templates","v":"1.720","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.699","2026-03-12","2.863","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.551","2026-02-20","6.053","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.642","2026-01-23","5.369","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.623","2026-02-23","7.061","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.837","2026-01-02","4.451","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":700},{"label":"Mar","value":1029},{"label":"Abr","value":862},{"label":"Mai","value":846},{"label":"Jun","value":875},{"label":"Jul","value":1015},{"label":"Ago","value":794},{"label":"Set","value":832},{"label":"Out","value":779},{"label":"Nov","value":973},{"label":"Dez","value":718}];
const MX = 1029;
