...
const PAGE = "Team";
const KPIS = [{"l":"Formulários Ativos","v":"7.531","t":"+2.5%","d":"up"},{"l":"Submissões/Dia","v":"1596","t":"+4.7%","d":"up"},{"l":"Documentos Gerados","v":"1.591","t":"+2.0%","d":"up"},{"l":"Templates","v":"5.082","t":"+15.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.646","2026-01-10","8.656","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.647","2026-01-16","3.805","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.581","2026-03-18","7.919","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.210","2026-01-02","6.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.848","2026-02-23","1.368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":749},{"label":"Mar","value":731},{"label":"Abr","value":552},{"label":"Mai","value":471},{"label":"Jun","value":635},{"label":"Jul","value":621},{"label":"Ago","value":498},{"label":"Set","value":607},{"label":"Out","value":739},{"label":"Nov","value":586},{"label":"Dez","value":503}];
const MX = 749;
