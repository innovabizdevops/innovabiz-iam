...
const ACCENT = "#6d28d9";
const MODULE = "Esports Management";
const PAGE = "Tournament";
const KPIS = [{"l":"Formulários Ativos","v":"7.908","t":"+12.5%","d":"up"},{"l":"Submissões/Dia","v":"2951","t":"+15.2%","d":"up"},{"l":"Documentos Gerados","v":"3.583","t":"+10.6%","d":"up"},{"l":"Templates","v":"8.842","t":"+3.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.825","2026-01-15","8.131","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.720","2026-02-24","7.986","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.345","2026-03-20","1.894","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.930","2026-03-09","1.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.395","2026-01-06","2.240","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":918},{"label":"Mar","value":713},{"label":"Abr","value":705},{"label":"Mai","value":863},{"label":"Jun","value":913},{"label":"Jul","value":589},{"label":"Ago","value":774},{"label":"Set","value":760},{"label":"Out","value":805},{"label":"Nov","value":943},{"label":"Dez","value":877}];
const MX = 943;
