...
const PAGE = "Stream";
const KPIS = [{"l":"Formulários Ativos","v":"5.894","t":"+7.2%","d":"up"},{"l":"Submissões/Dia","v":"3932","t":"+16.5%","d":"up"},{"l":"Documentos Gerados","v":"5.210","t":"+13.4%","d":"up"},{"l":"Templates","v":"8.684","t":"-4.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.423","2026-03-24","7.916","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.430","2026-02-13","6.668","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.176","2026-02-13","4.147","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.018","2026-02-26","3.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.743","2026-02-21","327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":484},{"label":"Mar","value":640},{"label":"Abr","value":353},{"label":"Mai","value":542},{"label":"Jun","value":480},{"label":"Jul","value":629},{"label":"Ago","value":510},{"label":"Set","value":617},{"label":"Out","value":483},{"label":"Nov","value":301},{"label":"Dez","value":305}];
const MX = 640;
