...
const PAGE = "Sponsor";
const KPIS = [{"l":"Formulários Ativos","v":"3.447","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"4498","t":"+7.5%","d":"up"},{"l":"Documentos Gerados","v":"7.590","t":"+8.4%","d":"up"},{"l":"Templates","v":"5.196","t":"+15.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.679","2026-01-09","308","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.077","2026-01-15","1.287","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.599","2026-03-10","5.820","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.078","2026-01-11","3.068","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.403","2026-03-20","448","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":539},{"label":"Mar","value":432},{"label":"Abr","value":371},{"label":"Mai","value":472},{"label":"Jun","value":238},{"label":"Jul","value":502},{"label":"Ago","value":323},{"label":"Set","value":222},{"label":"Out","value":334},{"label":"Nov","value":405},{"label":"Dez","value":231}];
const MX = 539;
