...
const ACCENT = "#6366f1";
const MODULE = "Nuclear Power";
const PAGE = "Decommission";
const KPIS = [{"l":"Vendas YTD (€)","v":"€76393","t":"-3.1%","d":"down"},{"l":"Pipeline (€)","v":"€33855","t":"+2.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"84.5%","t":"+12.6%","d":"up"},{"l":"Win Rate (%)","v":"86.0%","t":"-5.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 27795.35","€ 43955.99","€ 12888.02","81.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 19402.81","€ 27713.51","€ 29940.70","90.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 42271.65","€ 36167.54","€ 10445.34","98.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 36308.23","€ 2390.08","€ 44773.64","92.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36061.67","€ 34173.04","€ 16825.96","77.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":940},{"label":"Mar","value":619},{"label":"Abr","value":916},{"label":"Mai","value":960},{"label":"Jun","value":803},{"label":"Jul","value":638},{"label":"Ago","value":626},{"label":"Set","value":868},{"label":"Out","value":720},{"label":"Nov","value":967},{"label":"Dez","value":720}];
const MX = 967;
