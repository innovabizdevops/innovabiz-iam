...
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"285","t":"-1.5%","d":"down"},{"l":"RTO Médio (h)","v":"30h","t":"+14.1%","d":"up"},{"l":"RPO Médio (h)","v":"109h","t":"+4.2%","d":"up"},{"l":"Testes DR (YTD)","v":"3.898","t":"+13.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","132h","51h","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","58h","24h","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","119h","106h","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","30h","93h","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","201h","125h","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":705},{"label":"Mar","value":639},{"label":"Abr","value":732},{"label":"Mai","value":765},{"label":"Jun","value":432},{"label":"Jul","value":653},{"label":"Ago","value":393},{"label":"Set","value":747},{"label":"Out","value":442},{"label":"Nov","value":692},{"label":"Dez","value":759}];
const MX = 765;
