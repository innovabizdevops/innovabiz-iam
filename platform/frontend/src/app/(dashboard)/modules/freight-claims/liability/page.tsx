...
const PAGE = "Carrier Liability";
const KPIS = [{"l":"ARR (€M)","v":"€2.1M","t":"+7.1%","d":"up"},{"l":"MRR (€)","v":"€2881","t":"-2.5%","d":"down"},{"l":"Churn (%)","v":"66.3%","t":"+4.0%","d":"up"},{"l":"ARPU (€)","v":"€3992","t":"+13.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2658.33","8.073","€ 33395.89","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38472.28","1.460","€ 49849.00","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26145.07","5.121","€ 1255.38","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1860.38","6.729","€ 893.06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 41992.50","836","€ 25244.47","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":701},{"label":"Mar","value":840},{"label":"Abr","value":798},{"label":"Mai","value":773},{"label":"Jun","value":935},{"label":"Jul","value":1003},{"label":"Ago","value":922},{"label":"Set","value":932},{"label":"Out","value":952},{"label":"Nov","value":737},{"label":"Dez","value":775}];
const MX = 1003;
