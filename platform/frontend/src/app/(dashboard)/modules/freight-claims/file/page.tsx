...
const PAGE = "Claim File";
const KPIS = [{"l":"Total Freight Claims","v":"335","t":"+0.4%","d":"up"},{"l":"Claim File Ativos","v":"969","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"72","t":"-5.3%","d":"down"}];
const COLS = ["ID","Claim File","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Claims #001","Freight Claims #002","8.650","6.574","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Claims #002","Freight Claims #003","4.255","4.871","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Claims #003","Freight Claims #004","825","4.043","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Claims #004","Freight Claims #005","3.804","1.780","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Claims #005","Freight Claims #001","3.922","7.814","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":459},{"label":"Mar","value":545},{"label":"Abr","value":359},{"label":"Mai","value":525},{"label":"Jun","value":539},{"label":"Jul","value":666},{"label":"Ago","value":400},{"label":"Set","value":278},{"label":"Out","value":401},{"label":"Nov","value":298},{"label":"Dez","value":404}];
const MX = 666;
