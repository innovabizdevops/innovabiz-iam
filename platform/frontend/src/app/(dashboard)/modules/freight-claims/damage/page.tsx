...
const ACCENT = "#dc2626";
const MODULE = "Freight Claims";
const PAGE = "Damage Report";
const KPIS = [{"l":"Total Freight Claims","v":"5.335","t":"-3.6%","d":"down"},{"l":"Damage Report Ativos","v":"5.789","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+3.2%","d":"up"}];
const COLS = ["ID","Damage Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Claims #001","Freight Claims #002","4.810","7.878","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Claims #002","Freight Claims #003","1.069","2.197","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Claims #003","Freight Claims #004","7.968","2.364","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Claims #004","Freight Claims #005","3.506","3.322","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Claims #005","Freight Claims #001","4.770","6.587","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":843},{"label":"Mar","value":871},{"label":"Abr","value":658},{"label":"Mai","value":883},{"label":"Jun","value":609},{"label":"Jul","value":782},{"label":"Ago","value":684},{"label":"Set","value":646},{"label":"Out","value":673},{"label":"Nov","value":965},{"label":"Dez","value":972}];
const MX = 972;
