...
const KPIS = [{"l":"Total Freight Claims","v":"4.970","t":"+13.3%","d":"up"},{"l":"Settlement Ativos","v":"3.311","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"60","t":"+12.0%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Claims #001","Freight Claims #002","5.827","7.765","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Claims #002","Freight Claims #003","5.780","3.154","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Claims #003","Freight Claims #004","6.510","6.160","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Claims #004","Freight Claims #005","3.584","476","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Claims #005","Freight Claims #001","1.756","7.986","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":295},{"label":"Mar","value":303},{"label":"Abr","value":506},{"label":"Mai","value":642},{"label":"Jun","value":388},{"label":"Jul","value":347},{"label":"Ago","value":296},{"label":"Set","value":561},{"label":"Out","value":536},{"label":"Nov","value":354},{"label":"Dez","value":318}];
const MX = 642;
