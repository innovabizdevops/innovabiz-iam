...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.843","t":"-5.5%","d":"down"},{"l":"NC Abertas","v":"5.753","t":"+4.9%","d":"up"},{"l":"Conformidade (%)","v":"77.1%","t":"+4.4%","d":"up"},{"l":"CAPAs Pendentes","v":"9.005","t":"+12.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","359","86.0%","4.636","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.389","72.8%","3.064","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.120","84.3%","5.375","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.757","89.1%","5.799","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.624","82.5%","8.493","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":378},{"label":"Mar","value":390},{"label":"Abr","value":438},{"label":"Mai","value":597},{"label":"Jun","value":262},{"label":"Jul","value":450},{"label":"Ago","value":232},{"label":"Set","value":254},{"label":"Out","value":264},{"label":"Nov","value":378},{"label":"Dez","value":574}];
const MX = 597;
