...
export default function WeavingMillPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Weaving Mill</h1><p className="text-sm text-muted-foreground">Weaving Mill • iBOS Enterprise</p></div>
