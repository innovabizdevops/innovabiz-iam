...
const ACCENT = "#6366f1";
const MODULE = "Weaving Mill";
const PAGE = "Production";
const KPIS = [{"l":"Total Weaving Mill","v":"3.374","t":"+15.4%","d":"up"},{"l":"Production Ativos","v":"8.521","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"61","t":"+7.6%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weaving Mill #001","Weaving Mill #002","675","1.646","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Weaving Mill #002","Weaving Mill #003","4.057","719","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Weaving Mill #003","Weaving Mill #004","4.479","388","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Weaving Mill #004","Weaving Mill #005","1.945","4.348","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weaving Mill #005","Weaving Mill #001","456","7.415","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":686},{"label":"Mar","value":855},{"label":"Abr","value":794},{"label":"Mai","value":789},{"label":"Jun","value":893},{"label":"Jul","value":1017},{"label":"Ago","value":912},{"label":"Set","value":789},{"label":"Out","value":1006},{"label":"Nov","value":992},{"label":"Dez","value":769}];
const MX = 1017;
