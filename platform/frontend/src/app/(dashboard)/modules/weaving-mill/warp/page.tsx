...
const PAGE = "Warp";
const KPIS = [{"l":"Total Weaving Mill","v":"6.516","t":"+3.4%","d":"up"},{"l":"Warp Ativos","v":"2.567","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+11.2%","d":"up"}];
const COLS = ["ID","Warp","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weaving Mill #001","Weaving Mill #002","7.186","4.213","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Weaving Mill #002","Weaving Mill #003","8.363","9.055","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Weaving Mill #003","Weaving Mill #004","6.640","1.069","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Weaving Mill #004","Weaving Mill #005","5.880","6.646","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weaving Mill #005","Weaving Mill #001","8.657","7.686","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":897},{"label":"Mar","value":690},{"label":"Abr","value":907},{"label":"Mai","value":620},{"label":"Jun","value":629},{"label":"Jul","value":533},{"label":"Ago","value":670},{"label":"Set","value":829},{"label":"Out","value":690},{"label":"Nov","value":669},{"label":"Dez","value":655}];
const MX = 907;
