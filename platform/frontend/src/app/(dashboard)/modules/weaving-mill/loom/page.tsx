...
const PAGE = "Loom";
const KPIS = [{"l":"Total Weaving Mill","v":"476","t":"+11.7%","d":"up"},{"l":"Loom Ativos","v":"4.386","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"58","t":"+9.1%","d":"up"}];
const COLS = ["ID","Loom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weaving Mill #001","Weaving Mill #002","981","6.582","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Weaving Mill #002","Weaving Mill #003","999","7.382","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Weaving Mill #003","Weaving Mill #004","2.137","1.560","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Weaving Mill #004","Weaving Mill #005","5.974","2.043","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weaving Mill #005","Weaving Mill #001","6.193","5.744","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":867},{"label":"Mar","value":915},{"label":"Abr","value":758},{"label":"Mai","value":890},{"label":"Jun","value":852},{"label":"Jul","value":739},{"label":"Ago","value":866},{"label":"Set","value":869},{"label":"Out","value":936},{"label":"Nov","value":1050},{"label":"Dez","value":727}];
const MX = 1050;
