...
const PAGE = "Pattern";
const KPIS = [{"l":"Total Weaving Mill","v":"8.388","t":"+14.9%","d":"up"},{"l":"Pattern Ativos","v":"6.236","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"63","t":"+12.6%","d":"up"}];
const COLS = ["ID","Pattern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weaving Mill #001","Weaving Mill #002","7.432","8.401","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Weaving Mill #002","Weaving Mill #003","5.827","7.735","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Weaving Mill #003","Weaving Mill #004","175","2.510","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Weaving Mill #004","Weaving Mill #005","3.967","2.119","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weaving Mill #005","Weaving Mill #001","2.449","4.856","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":641},{"label":"Mar","value":486},{"label":"Abr","value":815},{"label":"Mai","value":709},{"label":"Jun","value":707},{"label":"Jul","value":772},{"label":"Ago","value":740},{"label":"Set","value":824},{"label":"Out","value":466},{"label":"Nov","value":709},{"label":"Dez","value":790}];
const MX = 824;
