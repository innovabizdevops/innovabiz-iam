...
const PAGE = "Ingestion";
const KPIS = [{"l":"Dashboards Ativos","v":"263","t":"+7.9%","d":"up"},{"l":"Queries/Dia","v":"2560","t":"+14.3%","d":"up"},{"l":"Dados Processados (GB)","v":"471","t":"+4.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.014","t":"-0.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1247","2026-02-04","3.685","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3613","2026-03-17","2.437","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","860","2026-03-25","8.153","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4669","2026-03-22","1.006","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2659","2026-01-04","4.537","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":810},{"label":"Mar","value":668},{"label":"Abr","value":701},{"label":"Mai","value":780},{"label":"Jun","value":726},{"label":"Jul","value":798},{"label":"Ago","value":949},{"label":"Set","value":633},{"label":"Out","value":690},{"label":"Nov","value":620},{"label":"Dez","value":883}];
const MX = 949;
