...
const KPIS = [{"l":"Riscos Identificados","v":"7.558","t":"+10.9%","d":"up"},{"l":"Mitigações Ativas","v":"4.843","t":"+3.7%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"-0.9%","d":"down"},{"l":"Incidentes YTD","v":"6.496","t":"+2.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.263","5.674","6.285","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.687","692","6.734","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.690","6.035","757","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.392","4.118","3.960","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","950","6.544","1.885","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":650},{"label":"Mar","value":619},{"label":"Abr","value":553},{"label":"Mai","value":426},{"label":"Jun","value":539},{"label":"Jul","value":437},{"label":"Ago","value":637},{"label":"Set","value":743},{"label":"Out","value":464},{"label":"Nov","value":728},{"label":"Dez","value":596}];
const MX = 743;
