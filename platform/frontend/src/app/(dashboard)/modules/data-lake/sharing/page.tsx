...
const PAGE = "Sharing";
const KPIS = [{"l":"Dashboards Ativos","v":"8.350","t":"+15.1%","d":"up"},{"l":"Queries/Dia","v":"274","t":"+6.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.081","t":"-3.6%","d":"down"},{"l":"Utilizadores Analytics","v":"3.712","t":"+13.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3711","2026-03-18","986","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4275","2026-02-08","1.559","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4260","2026-02-18","6.080","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2919","2026-01-19","3.535","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5100","2026-01-16","1.726","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":633},{"label":"Mar","value":559},{"label":"Abr","value":898},{"label":"Mai","value":684},{"label":"Jun","value":554},{"label":"Jul","value":820},{"label":"Ago","value":933},{"label":"Set","value":583},{"label":"Out","value":789},{"label":"Nov","value":941},{"label":"Dez","value":731}];
const MX = 941;
