...
const PAGE = "Query Engine";
const KPIS = [{"l":"Dashboards Ativos","v":"245","t":"+13.5%","d":"up"},{"l":"Queries/Dia","v":"305","t":"-3.9%","d":"down"},{"l":"Dados Processados (GB)","v":"6.305","t":"+3.5%","d":"up"},{"l":"Utilizadores Analytics","v":"458","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3295","2026-03-20","9.068","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2960","2026-02-03","749","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4352","2026-01-28","3.972","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3353","2026-02-04","5.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3648","2026-01-26","937","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":834},{"label":"Mar","value":804},{"label":"Abr","value":581},{"label":"Mai","value":724},{"label":"Jun","value":634},{"label":"Jul","value":831},{"label":"Ago","value":808},{"label":"Set","value":691},{"label":"Out","value":584},{"label":"Nov","value":539},{"label":"Dez","value":800}];
const MX = 834;
