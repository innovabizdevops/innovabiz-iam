...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"6.324","t":"+12.4%","d":"up"},{"l":"Queries/Dia","v":"3560","t":"-3.5%","d":"down"},{"l":"Dados Processados (GB)","v":"5.666","t":"-4.7%","d":"down"},{"l":"Utilizadores Analytics","v":"6.946","t":"+13.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2908","2026-01-17","6.156","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3933","2026-02-22","3.415","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2860","2026-02-01","4.544","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3479","2026-01-01","3.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4268","2026-03-10","8.759","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":614},{"label":"Mar","value":525},{"label":"Abr","value":613},{"label":"Mai","value":505},{"label":"Jun","value":743},{"label":"Jul","value":738},{"label":"Ago","value":779},{"label":"Set","value":515},{"label":"Out","value":516},{"label":"Nov","value":693},{"label":"Dez","value":500}];
const MX = 779;
