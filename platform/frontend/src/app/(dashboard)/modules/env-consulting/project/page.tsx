...
const PAGE = "Project";
const KPIS = [{"l":"Total Env Consulting","v":"843","t":"+3.1%","d":"up"},{"l":"Project Ativos","v":"3.811","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"75","t":"-5.1%","d":"down"}];
const COLS = ["ID","Project","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Consulting #001","Env Consulting #002","641","8.756","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Env Consulting #002","Env Consulting #003","1.289","6.235","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Consulting #003","Env Consulting #004","3.226","2.078","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Env Consulting #004","Env Consulting #005","3.413","3.933","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Consulting #005","Env Consulting #001","201","3.669","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":546},{"label":"Mar","value":669},{"label":"Abr","value":895},{"label":"Mai","value":852},{"label":"Jun","value":833},{"label":"Jul","value":648},{"label":"Ago","value":610},{"label":"Set","value":591},{"label":"Out","value":873},{"label":"Nov","value":648},{"label":"Dez","value":558}];
const MX = 895;
