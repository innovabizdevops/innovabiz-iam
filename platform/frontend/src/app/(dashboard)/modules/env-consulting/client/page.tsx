...
const PAGE = "Client";
const KPIS = [{"l":"Total Env Consulting","v":"2.968","t":"+7.6%","d":"up"},{"l":"Client Ativos","v":"3.392","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"94.4%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"86","t":"+8.7%","d":"up"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Consulting #001","Env Consulting #002","3.563","2.353","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Env Consulting #002","Env Consulting #003","177","1.603","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Consulting #003","Env Consulting #004","5.278","6.460","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Env Consulting #004","Env Consulting #005","7.303","4.137","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Consulting #005","Env Consulting #001","2.593","1.117","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":696},{"label":"Mar","value":628},{"label":"Abr","value":647},{"label":"Mai","value":409},{"label":"Jun","value":584},{"label":"Jul","value":652},{"label":"Ago","value":598},{"label":"Set","value":545},{"label":"Out","value":395},{"label":"Nov","value":734},{"label":"Dez","value":732}];
const MX = 734;
