...
const PAGE = "Report";
const KPIS = [{"l":"Total Env Consulting","v":"1.934","t":"-5.4%","d":"down"},{"l":"Report Ativos","v":"6.348","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"56","t":"-5.1%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Consulting #001","Env Consulting #002","7.926","6.322","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Env Consulting #002","Env Consulting #003","8.834","6.850","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Consulting #003","Env Consulting #004","6.391","3.251","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Env Consulting #004","Env Consulting #005","2.190","7.292","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Consulting #005","Env Consulting #001","2.037","9.091","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":622},{"label":"Mar","value":784},{"label":"Abr","value":865},{"label":"Mai","value":611},{"label":"Jun","value":765},{"label":"Jul","value":917},{"label":"Ago","value":909},{"label":"Set","value":648},{"label":"Out","value":761},{"label":"Nov","value":570},{"label":"Dez","value":797}];
const MX = 925;
