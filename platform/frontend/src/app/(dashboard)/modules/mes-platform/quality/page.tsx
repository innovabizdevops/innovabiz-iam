...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.953","t":"+2.1%","d":"up"},{"l":"NC Abertas","v":"6.674","t":"+1.1%","d":"up"},{"l":"Conformidade (%)","v":"89.7%","t":"-4.0%","d":"down"},{"l":"CAPAs Pendentes","v":"3.490","t":"+0.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.658","98.6%","4.734","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.719","93.3%","8.828","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.222","93.1%","4.194","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","993","80.5%","7.329","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.960","90.3%","5.850","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":479},{"label":"Mar","value":694},{"label":"Abr","value":400},{"label":"Mai","value":501},{"label":"Jun","value":401},{"label":"Jul","value":542},{"label":"Ago","value":656},{"label":"Set","value":643},{"label":"Out","value":471},{"label":"Nov","value":559},{"label":"Dez","value":661}];
const MX = 694;
