...
const PAGE = "OEE";
const KPIS = [{"l":"Formulários Ativos","v":"9.071","t":"+8.0%","d":"up"},{"l":"Submissões/Dia","v":"2399","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"3.662","t":"+5.4%","d":"up"},{"l":"Templates","v":"5.828","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.344","2026-01-17","2.751","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.509","2026-02-04","4.488","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.554","2026-03-04","244","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.242","2026-01-18","587","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.760","2026-01-28","8.922","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":818},{"label":"Mar","value":662},{"label":"Abr","value":699},{"label":"Mai","value":780},{"label":"Jun","value":652},{"label":"Jul","value":992},{"label":"Ago","value":831},{"label":"Set","value":905},{"label":"Out","value":769},{"label":"Nov","value":810},{"label":"Dez","value":785}];
const MX = 992;
