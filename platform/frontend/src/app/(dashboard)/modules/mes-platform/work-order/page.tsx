...
const KPIS = [{"l":"Formulários Ativos","v":"6.600","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"1571","t":"-5.0%","d":"down"},{"l":"Documentos Gerados","v":"1.022","t":"-3.1%","d":"down"},{"l":"Templates","v":"8.707","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.610","2026-01-09","7.435","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.880","2026-02-12","2.340","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.666","2026-02-19","3.880","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","270","2026-01-13","4.484","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.577","2026-03-14","1.307","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":555},{"label":"Mar","value":317},{"label":"Abr","value":400},{"label":"Mai","value":526},{"label":"Jun","value":478},{"label":"Jul","value":453},{"label":"Ago","value":265},{"label":"Set","value":209},{"label":"Out","value":313},{"label":"Nov","value":551},{"label":"Dez","value":212}];
const MX = 598;
