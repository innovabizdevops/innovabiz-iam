...
const PAGE = "Schedule";
const KPIS = [{"l":"Formulários Ativos","v":"8.697","t":"-2.6%","d":"down"},{"l":"Submissões/Dia","v":"1270","t":"-5.7%","d":"down"},{"l":"Documentos Gerados","v":"8.216","t":"+16.6%","d":"up"},{"l":"Templates","v":"6.535","t":"+2.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.703","2026-02-17","8.021","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.054","2026-03-11","2.122","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.882","2026-03-26","8.612","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","680","2026-02-11","6.559","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.100","2026-03-12","5.010","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":1010},{"label":"Mar","value":690},{"label":"Abr","value":725},{"label":"Mai","value":781},{"label":"Jun","value":1012},{"label":"Jul","value":798},{"label":"Ago","value":750},{"label":"Set","value":775},{"label":"Out","value":744},{"label":"Nov","value":1012},{"label":"Dez","value":642}];
const MX = 1012;
