...
const ACCENT = "#6366f1";
const MODULE = "MES Platform";
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"4.558","t":"-1.7%","d":"down"},{"l":"Submissões/Dia","v":"1096","t":"+15.1%","d":"up"},{"l":"Documentos Gerados","v":"3.996","t":"-1.1%","d":"down"},{"l":"Templates","v":"3.315","t":"+16.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.925","2026-03-26","6.907","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.235","2026-01-05","1.186","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.480","2026-01-01","3.118","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.463","2026-01-02","2.071","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.508","2026-01-19","1.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":792},{"label":"Mar","value":580},{"label":"Abr","value":841},{"label":"Mai","value":783},{"label":"Jun","value":702},{"label":"Jul","value":564},{"label":"Ago","value":584},{"label":"Set","value":654},{"label":"Out","value":760},{"label":"Nov","value":816},{"label":"Dez","value":474}];
const MX = 841;
