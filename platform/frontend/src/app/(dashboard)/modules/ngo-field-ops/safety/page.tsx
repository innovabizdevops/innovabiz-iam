...
const PAGE = "Safety";
const KPIS = [{"l":"Total Ngo Field Ops","v":"8.285","t":"+0.7%","d":"up"},{"l":"Safety Ativos","v":"189","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"68","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ngo Field Ops #001","Ngo Field Ops #002","6.765","5.496","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Ngo Field Ops #002","Ngo Field Ops #003","8.466","5.232","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Ngo Field Ops #003","Ngo Field Ops #004","5.534","2.259","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ngo Field Ops #004","Ngo Field Ops #005","696","2.393","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ngo Field Ops #005","Ngo Field Ops #001","3.081","1.650","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":709},{"label":"Mar","value":828},{"label":"Abr","value":894},{"label":"Mai","value":868},{"label":"Jun","value":735},{"label":"Jul","value":654},{"label":"Ago","value":616},{"label":"Set","value":913},{"label":"Out","value":796},{"label":"Nov","value":809},{"label":"Dez","value":937}];
const MX = 937;
