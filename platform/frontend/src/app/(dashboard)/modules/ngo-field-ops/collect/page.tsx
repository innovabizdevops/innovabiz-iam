...
const ACCENT = "#6366f1";
const MODULE = "Field Operations";
const PAGE = "Collect";
const KPIS = [{"l":"Total Ngo Field Ops","v":"6.728","t":"+3.6%","d":"up"},{"l":"Collect Ativos","v":"5.294","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+3.9%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ngo Field Ops #001","Ngo Field Ops #002","5.620","6.683","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ngo Field Ops #002","Ngo Field Ops #003","126","6.094","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ngo Field Ops #003","Ngo Field Ops #004","1.038","2.370","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ngo Field Ops #004","Ngo Field Ops #005","8.318","2.755","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ngo Field Ops #005","Ngo Field Ops #001","7.423","2.032","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":588},{"label":"Mar","value":714},{"label":"Abr","value":576},{"label":"Mai","value":749},{"label":"Jun","value":828},{"label":"Jul","value":558},{"label":"Ago","value":755},{"label":"Set","value":558},{"label":"Out","value":646},{"label":"Nov","value":750},{"label":"Dez","value":787}];
const MX = 897;
