...
export default function NgoFieldOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ngo Field Ops</h1><p className="text-sm text-muted-foreground">Ngo Field Ops • iBOS Enterprise</p></div>
