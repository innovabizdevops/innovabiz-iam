...
const ACCENT = "#ec4899";
const MODULE = "Airline MRO";
const PAGE = "Hangar Plan";
const KPIS = [{"l":"Total Mro Airline","v":"7.330","t":"+14.0%","d":"up"},{"l":"Hangar Plan Ativos","v":"3.627","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"92.4%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"85","t":"-0.1%","d":"down"}];
const COLS = ["ID","Hangar Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mro Airline #001","Mro Airline #002","2.166","6.200","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Mro Airline #002","Mro Airline #003","7.144","7.992","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Mro Airline #003","Mro Airline #004","4.474","4.469","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Mro Airline #004","Mro Airline #005","3.262","4.862","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mro Airline #005","Mro Airline #001","1.284","6.899","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":682},{"label":"Mar","value":753},{"label":"Abr","value":561},{"label":"Mai","value":800},{"label":"Jun","value":641},{"label":"Jul","value":436},{"label":"Ago","value":807},{"label":"Set","value":748},{"label":"Out","value":480},{"label":"Nov","value":503},{"label":"Dez","value":468}];
const MX = 807;
