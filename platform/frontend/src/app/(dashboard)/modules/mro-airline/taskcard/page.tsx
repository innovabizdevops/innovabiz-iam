...
const PAGE = "Task Card";
const KPIS = [{"l":"Total Mro Airline","v":"622","t":"+17.5%","d":"up"},{"l":"Task Card Ativos","v":"8.138","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"91.3%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"92","t":"-5.2%","d":"down"}];
const COLS = ["ID","Task Card","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mro Airline #001","Mro Airline #002","4.380","6.639","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Mro Airline #002","Mro Airline #003","1.446","4.343","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mro Airline #003","Mro Airline #004","7.984","2.225","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Mro Airline #004","Mro Airline #005","5.953","364","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mro Airline #005","Mro Airline #001","6.064","7.912","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":850},{"label":"Mar","value":950},{"label":"Abr","value":909},{"label":"Mai","value":865},{"label":"Jun","value":930},{"label":"Jul","value":773},{"label":"Ago","value":792},{"label":"Set","value":909},{"label":"Out","value":917},{"label":"Nov","value":582},{"label":"Dez","value":584}];
const MX = 950;
