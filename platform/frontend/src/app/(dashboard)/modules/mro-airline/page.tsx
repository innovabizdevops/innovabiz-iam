...
export default function MroAirlinePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mro Airline</h1><p className="text-sm text-muted-foreground">Mro Airline • iBOS Enterprise</p></div>
