...
const KPIS = [{"l":"Formulários Ativos","v":"7.525","t":"+3.8%","d":"up"},{"l":"Submissões/Dia","v":"1304","t":"+10.1%","d":"up"},{"l":"Documentos Gerados","v":"6.515","t":"+11.3%","d":"up"},{"l":"Templates","v":"305","t":"+8.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.124","2026-03-16","8.374","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.688","2026-02-15","5.455","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.586","2026-03-23","4.442","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.102","2026-02-21","7.978","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","257","2026-03-08","8.569","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":661},{"label":"Mar","value":818},{"label":"Abr","value":866},{"label":"Mai","value":961},{"label":"Jun","value":644},{"label":"Jul","value":797},{"label":"Ago","value":841},{"label":"Set","value":999},{"label":"Out","value":1038},{"label":"Nov","value":729},{"label":"Dez","value":743}];
const MX = 1038;
