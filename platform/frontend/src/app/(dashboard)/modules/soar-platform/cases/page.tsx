...
const KPIS = [{"l":"Formulários Ativos","v":"5.639","t":"+13.6%","d":"up"},{"l":"Submissões/Dia","v":"2628","t":"+7.8%","d":"up"},{"l":"Documentos Gerados","v":"7.438","t":"+12.1%","d":"up"},{"l":"Templates","v":"5.687","t":"-1.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.033","2026-03-08","612","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.563","2026-01-06","1.752","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","400","2026-01-16","2.994","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.127","2026-02-28","2.861","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.804","2026-01-27","6.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":618},{"label":"Mar","value":909},{"label":"Abr","value":834},{"label":"Mai","value":736},{"label":"Jun","value":783},{"label":"Jul","value":794},{"label":"Ago","value":847},{"label":"Set","value":705},{"label":"Out","value":881},{"label":"Nov","value":762},{"label":"Dez","value":935}];
const MX = 935;
