...
const PAGE = "Metrics";
const KPIS = [{"l":"Formulários Ativos","v":"6.814","t":"+17.7%","d":"up"},{"l":"Submissões/Dia","v":"4047","t":"-5.8%","d":"down"},{"l":"Documentos Gerados","v":"1.207","t":"+5.1%","d":"up"},{"l":"Templates","v":"6.716","t":"-2.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.801","2026-02-07","3.543","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","619","2026-02-17","8.137","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.815","2026-02-23","6.887","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.173","2026-02-16","3.822","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.827","2026-01-11","3.451","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":765},{"label":"Mar","value":440},{"label":"Abr","value":462},{"label":"Mai","value":592},{"label":"Jun","value":609},{"label":"Jul","value":636},{"label":"Ago","value":417},{"label":"Set","value":367},{"label":"Out","value":722},{"label":"Nov","value":689},{"label":"Dez","value":421}];
const MX = 765;
