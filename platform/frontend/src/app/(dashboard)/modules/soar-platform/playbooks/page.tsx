...
const PAGE = "Playbook Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"4.725","t":"+12.7%","d":"up"},{"l":"Submissões/Dia","v":"4160","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"5.391","t":"+12.7%","d":"up"},{"l":"Templates","v":"132","t":"+3.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.464","2026-03-11","1.212","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.282","2026-01-04","1.731","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.035","2026-03-13","8.187","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.485","2026-01-07","297","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.646","2026-03-23","3.059","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":807},{"label":"Mar","value":892},{"label":"Abr","value":822},{"label":"Mai","value":892},{"label":"Jun","value":980},{"label":"Jul","value":852},{"label":"Ago","value":827},{"label":"Set","value":820},{"label":"Out","value":809},{"label":"Nov","value":1083},{"label":"Dez","value":803}];
const MX = 1083;
