...
const ACCENT = "#7c3aed";
const MODULE = "SOAR Platform";
const PAGE = "Auto Response";
const KPIS = [{"l":"Formulários Ativos","v":"2.058","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"4626","t":"+16.5%","d":"up"},{"l":"Documentos Gerados","v":"295","t":"+11.2%","d":"up"},{"l":"Templates","v":"3.126","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.744","2026-01-11","7.533","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.298","2026-03-10","5.526","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.738","2026-03-21","2.248","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.298","2026-03-05","229","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.726","2026-02-19","6.423","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":974},{"label":"Fev","value":924},{"label":"Mar","value":1037},{"label":"Abr","value":1041},{"label":"Mai","value":787},{"label":"Jun","value":766},{"label":"Jul","value":860},{"label":"Ago","value":1063},{"label":"Set","value":900},{"label":"Out","value":861},{"label":"Nov","value":1000},{"label":"Dez","value":733}];
const MX = 1063;
