...
const PAGE = "Replanting";
const KPIS = [{"l":"Total Forest Mgmt","v":"2.430","t":"-0.2%","d":"down"},{"l":"Replanting Ativos","v":"4.890","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+2.7%","d":"up"}];
const COLS = ["ID","Replanting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Mgmt #001","Forest Mgmt #002","1.573","4.298","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Mgmt #002","Forest Mgmt #003","8.541","7.693","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Mgmt #003","Forest Mgmt #004","3.903","5.291","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Mgmt #004","Forest Mgmt #005","6.604","8.425","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Mgmt #005","Forest Mgmt #001","7.947","4.100","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":434},{"label":"Mar","value":525},{"label":"Abr","value":688},{"label":"Mai","value":638},{"label":"Jun","value":415},{"label":"Jul","value":464},{"label":"Ago","value":730},{"label":"Set","value":753},{"label":"Out","value":663},{"label":"Nov","value":583},{"label":"Dez","value":543}];
const MX = 753;
