...
export default function ForestMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Forest Mgmt</h1><p className="text-sm text-muted-foreground">Forest Mgmt • iBOS Enterprise</p></div>
