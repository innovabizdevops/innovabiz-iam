...
const PAGE = "Harvest";
const KPIS = [{"l":"Total Forest Mgmt","v":"1.690","t":"+8.4%","d":"up"},{"l":"Harvest Ativos","v":"2.138","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+5.5%","d":"up"}];
const COLS = ["ID","Harvest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Mgmt #001","Forest Mgmt #002","1.948","3.476","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Mgmt #002","Forest Mgmt #003","3.982","5.186","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Mgmt #003","Forest Mgmt #004","5.470","3.555","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Mgmt #004","Forest Mgmt #005","4.276","5.897","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Mgmt #005","Forest Mgmt #001","5.491","2.900","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":537},{"label":"Mar","value":506},{"label":"Abr","value":402},{"label":"Mai","value":641},{"label":"Jun","value":583},{"label":"Jul","value":505},{"label":"Ago","value":513},{"label":"Set","value":467},{"label":"Out","value":562},{"label":"Nov","value":664},{"label":"Dez","value":387}];
const MX = 664;
