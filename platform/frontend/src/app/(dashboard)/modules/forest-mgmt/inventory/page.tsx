...
const KPIS = [{"l":"Total Forest Mgmt","v":"535","t":"+12.0%","d":"up"},{"l":"Inventory Ativos","v":"670","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"93.1%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"74","t":"+16.4%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Mgmt #001","Forest Mgmt #002","3.638","5.535","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Mgmt #002","Forest Mgmt #003","1.481","2.619","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Mgmt #003","Forest Mgmt #004","6.415","1.344","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Mgmt #004","Forest Mgmt #005","5.735","1.273","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Mgmt #005","Forest Mgmt #001","3.030","5.517","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":980},{"label":"Mar","value":954},{"label":"Abr","value":722},{"label":"Mai","value":990},{"label":"Jun","value":1008},{"label":"Jul","value":896},{"label":"Ago","value":808},{"label":"Set","value":911},{"label":"Out","value":704},{"label":"Nov","value":685},{"label":"Dez","value":940}];
const MX = 1008;
