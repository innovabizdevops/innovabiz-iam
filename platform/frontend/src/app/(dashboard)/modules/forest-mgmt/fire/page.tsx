...
const PAGE = "Fire";
const KPIS = [{"l":"Total Forest Mgmt","v":"990","t":"+8.2%","d":"up"},{"l":"Fire Ativos","v":"6.176","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"89.5%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"80","t":"+15.1%","d":"up"}];
const COLS = ["ID","Fire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Mgmt #001","Forest Mgmt #002","8.941","5.459","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Mgmt #002","Forest Mgmt #003","6.000","1.042","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Mgmt #003","Forest Mgmt #004","3.803","3.785","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Mgmt #004","Forest Mgmt #005","1.744","363","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Mgmt #005","Forest Mgmt #001","4.151","3.870","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":576},{"label":"Mar","value":541},{"label":"Abr","value":561},{"label":"Mai","value":744},{"label":"Jun","value":566},{"label":"Jul","value":681},{"label":"Ago","value":569},{"label":"Set","value":878},{"label":"Out","value":573},{"label":"Nov","value":795},{"label":"Dez","value":649}];
const MX = 878;
