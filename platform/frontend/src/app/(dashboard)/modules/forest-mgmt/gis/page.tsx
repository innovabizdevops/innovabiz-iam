...
const ACCENT = "#6366f1";
const MODULE = "Forest Management";
const PAGE = "GIS";
const KPIS = [{"l":"Total Forest Mgmt","v":"1.033","t":"+5.4%","d":"up"},{"l":"GIS Ativos","v":"8.913","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"83","t":"+15.6%","d":"up"}];
const COLS = ["ID","GIS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Mgmt #001","Forest Mgmt #002","7.712","4.389","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Mgmt #002","Forest Mgmt #003","897","1.538","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Mgmt #003","Forest Mgmt #004","5.459","443","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Mgmt #004","Forest Mgmt #005","2.372","6.361","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Mgmt #005","Forest Mgmt #001","6.248","7.785","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":989},{"label":"Fev","value":737},{"label":"Mar","value":1000},{"label":"Abr","value":948},{"label":"Mai","value":782},{"label":"Jun","value":898},{"label":"Jul","value":834},{"label":"Ago","value":1027},{"label":"Set","value":1038},{"label":"Out","value":1045},{"label":"Nov","value":773},{"label":"Dez","value":736}];
const MX = 1045;
