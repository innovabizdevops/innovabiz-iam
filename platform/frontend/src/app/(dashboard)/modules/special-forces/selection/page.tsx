...
const KPIS = [{"l":"Total Special Forces","v":"4.577","t":"+17.1%","d":"up"},{"l":"Selection Ativos","v":"1.015","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"72.0%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"82","t":"+10.2%","d":"up"}];
const COLS = ["ID","Selection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Special Forces #001","Special Forces #002","1.410","7.966","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Special Forces #002","Special Forces #003","7.656","3.391","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Special Forces #003","Special Forces #004","6.823","4.393","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Special Forces #004","Special Forces #005","6.480","7.699","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Special Forces #005","Special Forces #001","305","1.255","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":623},{"label":"Mar","value":691},{"label":"Abr","value":510},{"label":"Mai","value":559},{"label":"Jun","value":321},{"label":"Jul","value":653},{"label":"Ago","value":458},{"label":"Set","value":506},{"label":"Out","value":715},{"label":"Nov","value":568},{"label":"Dez","value":666}];
const MX = 715;
