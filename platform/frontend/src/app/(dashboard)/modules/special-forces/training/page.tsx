...
const PAGE = "Training";
const KPIS = [{"l":"Total Special Forces","v":"6.698","t":"-5.1%","d":"down"},{"l":"Training Ativos","v":"2.145","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"56","t":"-4.1%","d":"down"}];
const COLS = ["ID","Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Special Forces #001","Special Forces #002","1.071","7.461","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Special Forces #002","Special Forces #003","4.513","3.370","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Special Forces #003","Special Forces #004","1.867","2.446","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Special Forces #004","Special Forces #005","7.896","3.022","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Special Forces #005","Special Forces #001","7.104","1.442","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1027},{"label":"Fev","value":847},{"label":"Mar","value":1093},{"label":"Abr","value":997},{"label":"Mai","value":770},{"label":"Jun","value":1057},{"label":"Jul","value":907},{"label":"Ago","value":1055},{"label":"Set","value":1091},{"label":"Out","value":1037},{"label":"Nov","value":740},{"label":"Dez","value":768}];
const MX = 1093;
