...
const ACCENT = "#94a3b8";
const MODULE = "Special Forces";
const PAGE = "Intel";
const KPIS = [{"l":"Total Special Forces","v":"4.009","t":"+5.4%","d":"up"},{"l":"Intel Ativos","v":"2.095","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"73","t":"-4.2%","d":"down"}];
const COLS = ["ID","Intel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Special Forces #001","Special Forces #002","1.553","5.136","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Special Forces #002","Special Forces #003","4.521","1.812","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Special Forces #003","Special Forces #004","6.876","4.291","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Special Forces #004","Special Forces #005","3.285","5.835","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Special Forces #005","Special Forces #001","810","1.337","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":558},{"label":"Mar","value":514},{"label":"Abr","value":675},{"label":"Mai","value":640},{"label":"Jun","value":607},{"label":"Jul","value":505},{"label":"Ago","value":597},{"label":"Set","value":557},{"label":"Out","value":574},{"label":"Nov","value":565},{"label":"Dez","value":362}];
const MX = 675;
