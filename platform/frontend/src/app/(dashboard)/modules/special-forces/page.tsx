...
/* ═══ Special Forces — Dashboard ═══ */

const ACCENT = "#94a3b8";

const KPIS = [
    { label: "Total Registos", value: "5523", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4641", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€319K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1678797923", cells: ["SPE-1923", "Special Forces Item 1", "20/12/2026", "€48 023"], status: "active" as const },
    { id: "1678801494", cells: ["SPE-5494", "Special Forces Item 2", "7/7/2026", "€1594"], status: "pending" as const },
    { id: "1678805065", cells: ["SPE-9065", "Special Forces Item 3", "22/2/2026", "€5165"], status: "completed" as const },
    { id: "1678808636", cells: ["SPE-3636", "Special Forces Item 4", "9/9/2026", "€8736"], status: "warning" as const },
    { id: "1678812207", cells: ["SPE-7207", "Special Forces Item 5", "24/4/2026", "€12 307"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Special Forces</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Special Forces</p>
                    </div>
                </div>
