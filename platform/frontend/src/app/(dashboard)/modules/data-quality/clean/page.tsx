...
const ACCENT = "#06b6d4";
const MODULE = "Data Quality Engine";
const PAGE = "Clean";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.061","t":"+16.5%","d":"up"},{"l":"NC Abertas","v":"6.277","t":"+14.4%","d":"up"},{"l":"Conformidade (%)","v":"93.6%","t":"+8.6%","d":"up"},{"l":"CAPAs Pendentes","v":"8.577","t":"-4.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.451","75.2%","5.103","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.899","77.9%","217","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","818","88.8%","1.766","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.641","86.8%","820","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.990","94.6%","7.339","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":652},{"label":"Mar","value":446},{"label":"Abr","value":452},{"label":"Mai","value":316},{"label":"Jun","value":457},{"label":"Jul","value":526},{"label":"Ago","value":339},{"label":"Set","value":391},{"label":"Out","value":627},{"label":"Nov","value":507},{"label":"Dez","value":699}];
const MX = 699;
