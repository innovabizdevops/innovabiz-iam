...
const PAGE = "Profile";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.922","t":"+4.1%","d":"up"},{"l":"NC Abertas","v":"6.612","t":"+6.3%","d":"up"},{"l":"Conformidade (%)","v":"65.0%","t":"+13.8%","d":"up"},{"l":"CAPAs Pendentes","v":"7.131","t":"-1.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.947","98.7%","7.412","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.997","90.4%","3.820","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.818","91.8%","4.142","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","818","95.2%","7.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.262","86.6%","6.351","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":741},{"label":"Mar","value":746},{"label":"Abr","value":471},{"label":"Mai","value":445},{"label":"Jun","value":748},{"label":"Jul","value":621},{"label":"Ago","value":537},{"label":"Set","value":683},{"label":"Out","value":393},{"label":"Nov","value":570},{"label":"Dez","value":696}];
const MX = 748;
