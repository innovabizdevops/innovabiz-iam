...
/* ═══ Data Quality Engine — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "385", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3240", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€330K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1521511485", cells: ["DAT-8485", "Data Quality Engine Item 1", "26/10/2026", "€11 585"], status: "active" as const },
    { id: "1521515056", cells: ["DAT-3056", "Data Quality Engine Item 2", "13/5/2026", "€15 156"], status: "pending" as const },
    { id: "1521518627", cells: ["DAT-6627", "Data Quality Engine Item 3", "28/12/2026", "€18 727"], status: "completed" as const },
    { id: "1521522198", cells: ["DAT-1198", "Data Quality Engine Item 4", "15/7/2026", "€22 298"], status: "warning" as const },
    { id: "1521525769", cells: ["DAT-4769", "Data Quality Engine Item 5", "2/2/2026", "€25 869"], status: "active" as const },
];
...
export default function DataQualityEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Quality Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Quality Engine</p>
                    </div>
                </div>
