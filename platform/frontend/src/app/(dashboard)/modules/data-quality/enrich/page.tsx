...
const PAGE = "Enrich";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.565","t":"+5.2%","d":"up"},{"l":"NC Abertas","v":"4.466","t":"-0.1%","d":"down"},{"l":"Conformidade (%)","v":"81.7%","t":"+5.5%","d":"up"},{"l":"CAPAs Pendentes","v":"3.026","t":"+13.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.251","79.0%","8.402","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.782","81.3%","4.063","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.511","77.6%","1.396","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.842","96.7%","6.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.178","90.2%","8.779","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":578},{"label":"Mar","value":852},{"label":"Abr","value":593},{"label":"Mai","value":554},{"label":"Jun","value":617},{"label":"Jul","value":830},{"label":"Ago","value":782},{"label":"Set","value":758},{"label":"Out","value":605},{"label":"Nov","value":577},{"label":"Dez","value":766}];
const MX = 852;
