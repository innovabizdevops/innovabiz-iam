...
const PAGE = "Monitor";
const KPIS = [{"l":"Auditorias Realizadas","v":"738","t":"+9.3%","d":"up"},{"l":"NC Abertas","v":"3.293","t":"+6.1%","d":"up"},{"l":"Conformidade (%)","v":"74.0%","t":"-2.5%","d":"down"},{"l":"CAPAs Pendentes","v":"4.053","t":"+16.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.730","83.1%","6.199","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","315","92.3%","7.125","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.583","71.0%","2.450","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.184","91.2%","6.590","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.999","73.1%","8.825","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":579},{"label":"Mar","value":473},{"label":"Abr","value":535},{"label":"Mai","value":579},{"label":"Jun","value":572},{"label":"Jul","value":333},{"label":"Ago","value":353},{"label":"Set","value":614},{"label":"Out","value":340},{"label":"Nov","value":694},{"label":"Dez","value":602}];
const MX = 694;
