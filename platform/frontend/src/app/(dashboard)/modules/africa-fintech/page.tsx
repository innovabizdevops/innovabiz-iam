...
/* ═══ Africa FinTech Hub — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "3871", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4949", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€384K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2065024971", cells: ["AFR-2971", "Africa FinTech Hub Item 1", "24/4/2026", "€25 071"], status: "active" as const },
    { id: "2065028542", cells: ["AFR-6542", "Africa FinTech Hub Item 2", "11/11/2026", "€28 642"], status: "pending" as const },
    { id: "2065032113", cells: ["AFR-1113", "Africa FinTech Hub Item 3", "26/6/2026", "€32 213"], status: "completed" as const },
    { id: "2065035684", cells: ["AFR-4684", "Africa FinTech Hub Item 4", "13/1/2026", "€35 784"], status: "warning" as const },
    { id: "2065039255", cells: ["AFR-8255", "Africa FinTech Hub Item 5", "28/8/2026", "€39 355"], status: "active" as const },
];
...
export default function AfricaFintechHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Africa FinTech Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Africa FinTech Hub</p>
                    </div>
                </div>
