...
const PAGE = "Decision Engine";
const KPIS = [{"l":"Integrações Ativas","v":"4.072","t":"+10.3%","d":"up"},{"l":"Chamadas/Hora","v":"4416","t":"+9.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.6%","t":"+5.5%","d":"up"},{"l":"Latência Média (ms)","v":"29ms","t":"+4.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.283","1.794","79.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.727","8.492","80.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.920","8.949","81.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.211","8.869","70.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.851","4.377","94.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":669},{"label":"Mar","value":594},{"label":"Abr","value":529},{"label":"Mai","value":629},{"label":"Jun","value":590},{"label":"Jul","value":608},{"label":"Ago","value":408},{"label":"Set","value":574},{"label":"Out","value":651},{"label":"Nov","value":587},{"label":"Dez","value":775}];
const MX = 775;
