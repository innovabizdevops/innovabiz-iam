...
const KPIS = [{"l":"Integrações Ativas","v":"1.811","t":"-3.5%","d":"down"},{"l":"Chamadas/Hora","v":"3348","t":"+16.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.8%","t":"+11.8%","d":"up"},{"l":"Latência Média (ms)","v":"87ms","t":"+-0.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.900","2.963","72.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","836","3.092","85.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","9.028","1.608","70.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.825","762","83.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.100","8.359","92.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":475},{"label":"Mar","value":340},{"label":"Abr","value":597},{"label":"Mai","value":388},{"label":"Jun","value":621},{"label":"Jul","value":524},{"label":"Ago","value":673},{"label":"Set","value":487},{"label":"Out","value":695},{"label":"Nov","value":350},{"label":"Dez","value":686}];
const MX = 695;
