...
const ACCENT = "#7c3aed";
const MODULE = "Credit Scoring";
const PAGE = "Explainability";
const KPIS = [{"l":"Integrações Ativas","v":"762","t":"+10.0%","d":"up"},{"l":"Chamadas/Hora","v":"2128","t":"+2.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.3%","t":"+1.7%","d":"up"},{"l":"Latência Média (ms)","v":"19ms","t":"+0.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.456","7.899","84.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.350","6.732","81.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.602","6.369","70.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.651","614","84.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.836","7.188","78.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":686},{"label":"Mar","value":448},{"label":"Abr","value":409},{"label":"Mai","value":464},{"label":"Jun","value":720},{"label":"Jul","value":689},{"label":"Ago","value":582},{"label":"Set","value":478},{"label":"Out","value":678},{"label":"Nov","value":483},{"label":"Dez","value":440}];
const MX = 779;
