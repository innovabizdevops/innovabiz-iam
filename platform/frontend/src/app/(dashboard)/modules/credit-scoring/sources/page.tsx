...
const KPIS = [{"l":"Integrações Ativas","v":"4.398","t":"+14.4%","d":"up"},{"l":"Chamadas/Hora","v":"2735","t":"+-0.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.5%","t":"+12.2%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"+4.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.688","8.552","79.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.982","875","77.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.650","6.396","81.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.873","5.524","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.470","5.449","93.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":784},{"label":"Mar","value":657},{"label":"Abr","value":768},{"label":"Mai","value":621},{"label":"Jun","value":670},{"label":"Jul","value":573},{"label":"Ago","value":879},{"label":"Set","value":919},{"label":"Out","value":662},{"label":"Nov","value":735},{"label":"Dez","value":692}];
const MX = 919;
