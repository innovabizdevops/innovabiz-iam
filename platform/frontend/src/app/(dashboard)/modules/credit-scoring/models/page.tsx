...
const KPIS = [{"l":"Integrações Ativas","v":"5.145","t":"+14.4%","d":"up"},{"l":"Chamadas/Hora","v":"3308","t":"+16.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.3%","t":"+6.2%","d":"up"},{"l":"Latência Média (ms)","v":"205ms","t":"-1.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.220","1.704","79.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.822","452","94.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.920","3.578","77.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","340","9.096","81.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.420","1.064","88.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":754},{"label":"Mar","value":604},{"label":"Abr","value":398},{"label":"Mai","value":740},{"label":"Jun","value":398},{"label":"Jul","value":709},{"label":"Ago","value":723},{"label":"Set","value":632},{"label":"Out","value":426},{"label":"Nov","value":688},{"label":"Dez","value":664}];
const MX = 754;
