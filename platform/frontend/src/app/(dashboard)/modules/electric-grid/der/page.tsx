...
const PAGE = "DER";
const KPIS = [{"l":"Total Electric Grid","v":"7.543","t":"-2.1%","d":"down"},{"l":"DER Ativos","v":"5.699","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+3.4%","d":"up"}];
const COLS = ["ID","DER","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Electric Grid #001","Electric Grid #002","8.322","8.742","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Electric Grid #002","Electric Grid #003","4.008","3.807","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Electric Grid #003","Electric Grid #004","6.421","8.642","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Electric Grid #004","Electric Grid #005","5.373","1.934","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Electric Grid #005","Electric Grid #001","7.971","1.654","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":685},{"label":"Mar","value":728},{"label":"Abr","value":950},{"label":"Mai","value":760},{"label":"Jun","value":685},{"label":"Jul","value":599},{"label":"Ago","value":733},{"label":"Set","value":814},{"label":"Out","value":644},{"label":"Nov","value":990},{"label":"Dez","value":611}];
const MX = 990;
