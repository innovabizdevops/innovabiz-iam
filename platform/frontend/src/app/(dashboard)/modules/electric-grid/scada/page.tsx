...
const PAGE = "SCADA";
const KPIS = [{"l":"Dispositivos Online","v":"5.593","t":"+9.0%","d":"up"},{"l":"Dados/Min (MB)","v":"3.325","t":"+0.7%","d":"up"},{"l":"Alertas Ativos","v":"8.527","t":"+12.3%","d":"up"},{"l":"Uptime (%)","v":"87.6%","t":"+8.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.201","2.117","7.982","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.307","5.301","3.016","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.354","3.935","8.756","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.286","215","3.801","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.713","2.783","7.478","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":548},{"label":"Mar","value":451},{"label":"Abr","value":380},{"label":"Mai","value":577},{"label":"Jun","value":637},{"label":"Jul","value":506},{"label":"Ago","value":356},{"label":"Set","value":695},{"label":"Out","value":389},{"label":"Nov","value":370},{"label":"Dez","value":547}];
const MX = 695;
