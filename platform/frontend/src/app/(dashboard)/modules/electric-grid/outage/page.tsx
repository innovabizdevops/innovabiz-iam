...
const PAGE = "Outage";
const KPIS = [{"l":"Total Electric Grid","v":"8.341","t":"+1.3%","d":"up"},{"l":"Outage Ativos","v":"8.224","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"81","t":"+15.3%","d":"up"}];
const COLS = ["ID","Outage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Electric Grid #001","Electric Grid #002","8.671","4.020","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Electric Grid #002","Electric Grid #003","4.901","5.296","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Electric Grid #003","Electric Grid #004","6.311","435","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Electric Grid #004","Electric Grid #005","4.223","6.895","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Electric Grid #005","Electric Grid #001","6.043","7.364","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":479},{"label":"Mar","value":297},{"label":"Abr","value":654},{"label":"Mai","value":646},{"label":"Jun","value":431},{"label":"Jul","value":439},{"label":"Ago","value":654},{"label":"Set","value":327},{"label":"Out","value":455},{"label":"Nov","value":569},{"label":"Dez","value":590}];
const MX = 654;
