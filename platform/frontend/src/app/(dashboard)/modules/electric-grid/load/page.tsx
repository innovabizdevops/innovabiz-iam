...
const ACCENT = "#6366f1";
const MODULE = "Electric Grid Ops";
const PAGE = "Load Mgmt";
const KPIS = [{"l":"Total Electric Grid","v":"8.668","t":"+3.7%","d":"up"},{"l":"Load Mgmt Ativos","v":"6.479","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+0.4%","d":"up"}];
const COLS = ["ID","Load Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Electric Grid #001","Electric Grid #002","1.277","2.639","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Electric Grid #002","Electric Grid #003","7.975","3.662","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Electric Grid #003","Electric Grid #004","2.208","972","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Electric Grid #004","Electric Grid #005","4.428","2.607","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Electric Grid #005","Electric Grid #001","5.240","6.642","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":231},{"label":"Fev","value":610},{"label":"Mar","value":331},{"label":"Abr","value":290},{"label":"Mai","value":252},{"label":"Jun","value":592},{"label":"Jul","value":241},{"label":"Ago","value":408},{"label":"Set","value":275},{"label":"Out","value":238},{"label":"Nov","value":591},{"label":"Dez","value":276}];
const MX = 610;
