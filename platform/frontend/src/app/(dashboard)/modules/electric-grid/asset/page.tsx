...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"5.981","t":"+11.7%","d":"up"},{"l":"Valor Total (€M)","v":"€31.5M","t":"-5.9%","d":"down"},{"l":"Depreciação Anual (€)","v":"€69011","t":"-6.0%","d":"down"},{"l":"Ativos em Garantia","v":"8.756","t":"+16.2%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 43636.88","3.626","€ 40295.70","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 24532.07","6.970","€ 28877.65","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 10181.41","8.296","€ 36665.94","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 41963.83","7.762","€ 44133.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 13925.08","5.859","€ 30904.39","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":510},{"label":"Mar","value":675},{"label":"Abr","value":622},{"label":"Mai","value":435},{"label":"Jun","value":392},{"label":"Jul","value":711},{"label":"Ago","value":457},{"label":"Set","value":682},{"label":"Out","value":529},{"label":"Nov","value":659},{"label":"Dez","value":680}];
const MX = 711;
