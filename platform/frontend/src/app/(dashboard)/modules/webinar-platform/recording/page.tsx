...
const KPIS = [{"l":"Formulários Ativos","v":"9.049","t":"+16.9%","d":"up"},{"l":"Submissões/Dia","v":"2099","t":"-2.1%","d":"down"},{"l":"Documentos Gerados","v":"767","t":"+7.1%","d":"up"},{"l":"Templates","v":"1.946","t":"+10.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.242","2026-02-17","4.192","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.807","2026-02-22","674","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.789","2026-01-26","8.293","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.133","2026-02-18","5.021","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.205","2026-01-23","4.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":468},{"label":"Mar","value":521},{"label":"Abr","value":450},{"label":"Mai","value":502},{"label":"Jun","value":422},{"label":"Jul","value":686},{"label":"Ago","value":462},{"label":"Set","value":574},{"label":"Out","value":433},{"label":"Nov","value":727},{"label":"Dez","value":517}];
const MX = 727;
