...
const ACCENT = "#7c3aed";
const MODULE = "Webinar Platform";
const PAGE = "Q&amp;A Panel";
const KPIS = [{"l":"Formulários Ativos","v":"1.209","t":"+1.0%","d":"up"},{"l":"Submissões/Dia","v":"4188","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"6.745","t":"+9.7%","d":"up"},{"l":"Templates","v":"5.576","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.013","2026-03-23","6.152","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.619","2026-03-28","3.175","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.190","2026-03-17","8.044","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.289","2026-02-09","6.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.119","2026-03-15","981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":599},{"label":"Mar","value":551},{"label":"Abr","value":680},{"label":"Mai","value":633},{"label":"Jun","value":879},{"label":"Jul","value":587},{"label":"Ago","value":743},{"label":"Set","value":728},{"label":"Out","value":805},{"label":"Nov","value":879},{"label":"Dez","value":625}];
const MX = 879;
