...
const KPIS = [{"l":"Formulários Ativos","v":"961","t":"+1.2%","d":"up"},{"l":"Submissões/Dia","v":"3510","t":"+16.8%","d":"up"},{"l":"Documentos Gerados","v":"8.933","t":"+11.8%","d":"up"},{"l":"Templates","v":"3.768","t":"+15.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","769","2026-03-05","4.804","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.194","2026-01-23","1.662","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.239","2026-03-27","2.790","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.606","2026-03-18","268","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.817","2026-01-17","5.737","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":285},{"label":"Fev","value":346},{"label":"Mar","value":303},{"label":"Abr","value":578},{"label":"Mai","value":271},{"label":"Jun","value":382},{"label":"Jul","value":264},{"label":"Ago","value":586},{"label":"Set","value":291},{"label":"Out","value":262},{"label":"Nov","value":298},{"label":"Dez","value":374}];
const MX = 586;
