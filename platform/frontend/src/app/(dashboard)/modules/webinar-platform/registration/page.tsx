...
const KPIS = [{"l":"Formulários Ativos","v":"6.413","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"4846","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"5.159","t":"+14.2%","d":"up"},{"l":"Templates","v":"8.448","t":"+15.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.427","2026-02-21","398","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.833","2026-01-09","3.378","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.071","2026-01-14","4.237","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.722","2026-01-19","5.159","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","983","2026-02-01","6.695","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":991},{"label":"Mar","value":657},{"label":"Abr","value":974},{"label":"Mai","value":624},{"label":"Jun","value":594},{"label":"Jul","value":954},{"label":"Ago","value":741},{"label":"Set","value":771},{"label":"Out","value":707},{"label":"Nov","value":732},{"label":"Dez","value":649}];
const MX = 991;
