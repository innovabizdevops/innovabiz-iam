...
const PAGE = "Live Stream";
const KPIS = [{"l":"Formulários Ativos","v":"4.583","t":"+3.3%","d":"up"},{"l":"Submissões/Dia","v":"3615","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"6.577","t":"+15.6%","d":"up"},{"l":"Templates","v":"1.377","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.341","2026-02-02","3.941","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.531","2026-02-03","6.711","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.348","2026-01-15","6.672","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.736","2026-02-12","5.044","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","652","2026-03-02","4.308","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":926},{"label":"Mar","value":928},{"label":"Abr","value":571},{"label":"Mai","value":598},{"label":"Jun","value":937},{"label":"Jul","value":703},{"label":"Ago","value":830},{"label":"Set","value":837},{"label":"Out","value":689},{"label":"Nov","value":821},{"label":"Dez","value":599}];
const MX = 937;
