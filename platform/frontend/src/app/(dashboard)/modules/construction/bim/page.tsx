...
const KPIS = [{"l":"Integrações Ativas","v":"476","t":"+1.1%","d":"up"},{"l":"Chamadas/Hora","v":"4204","t":"+7.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"69.5%","t":"+5.5%","d":"up"},{"l":"Latência Média (ms)","v":"188ms","t":"+4.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","930","1.525","84.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.445","5.864","89.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.287","876","85.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.605","3.593","99.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.857","2.522","95.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":756},{"label":"Mar","value":695},{"label":"Abr","value":635},{"label":"Mai","value":867},{"label":"Jun","value":843},{"label":"Jul","value":856},{"label":"Ago","value":763},{"label":"Set","value":910},{"label":"Out","value":868},{"label":"Nov","value":574},{"label":"Dez","value":736}];
const MX = 910;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>3D</span></h1>
                </div>
