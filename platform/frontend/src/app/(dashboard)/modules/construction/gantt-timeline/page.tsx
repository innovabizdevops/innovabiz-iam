...
const PAGE = "Gantt Timeline";
const KPIS = [{"l":"Total Construction","v":"2.485","t":"+7.1%","d":"up"},{"l":"Gantt Timeline Ativos","v":"7.202","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"82.4%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"93","t":"+5.0%","d":"up"}];
const COLS = ["ID","Gantt Timeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction #001","Construction #002","9.092","3.341","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Construction #002","Construction #003","787","3.123","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction #003","Construction #004","651","6.423","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Construction #004","Construction #005","4.940","7.088","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction #005","Construction #001","2.515","1.819","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":278},{"label":"Mar","value":320},{"label":"Abr","value":610},{"label":"Mai","value":294},{"label":"Jun","value":654},{"label":"Jul","value":403},{"label":"Ago","value":452},{"label":"Set","value":633},{"label":"Out","value":631},{"label":"Nov","value":560},{"label":"Dez","value":627}];
const MX = 654;
