...
const PAGE = "Work Order Form";
const KPIS = [{"l":"Formulários Ativos","v":"8.745","t":"-5.8%","d":"down"},{"l":"Submissões/Dia","v":"3696","t":"+8.7%","d":"up"},{"l":"Documentos Gerados","v":"1.931","t":"+13.8%","d":"up"},{"l":"Templates","v":"7.732","t":"+12.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.574","2026-03-12","1.124","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","197","2026-01-10","1.739","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.406","2026-02-02","1.665","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.134","2026-01-07","1.903","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.947","2026-03-27","1.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1005},{"label":"Fev","value":665},{"label":"Mar","value":673},{"label":"Abr","value":869},{"label":"Mai","value":658},{"label":"Jun","value":825},{"label":"Jul","value":652},{"label":"Ago","value":782},{"label":"Set","value":999},{"label":"Out","value":677},{"label":"Nov","value":660},{"label":"Dez","value":726}];
const MX = 1005;
