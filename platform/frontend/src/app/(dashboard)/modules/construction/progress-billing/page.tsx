...
const PAGE = "Progress Billing";
const KPIS = [{"l":"Total Construction","v":"2.267","t":"+11.3%","d":"up"},{"l":"Progress Billing Ativos","v":"1.744","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.1%","d":"up"}];
const COLS = ["ID","Progress Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction #001","Construction #002","2.846","3.493","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Construction #002","Construction #003","1.577","3.901","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction #003","Construction #004","4.838","2.520","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Construction #004","Construction #005","6.860","3.818","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction #005","Construction #001","4.885","4.942","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":721},{"label":"Mar","value":682},{"label":"Abr","value":518},{"label":"Mai","value":572},{"label":"Jun","value":719},{"label":"Jul","value":384},{"label":"Ago","value":583},{"label":"Set","value":704},{"label":"Out","value":735},{"label":"Nov","value":469},{"label":"Dez","value":751}];
const MX = 751;
