...
const PAGE = "ISO 19650 BIM";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.731","t":"+10.0%","d":"up"},{"l":"NC Abertas","v":"1.169","t":"+9.8%","d":"up"},{"l":"Conformidade (%)","v":"67.6%","t":"-5.8%","d":"down"},{"l":"CAPAs Pendentes","v":"2.618","t":"+4.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.472","84.5%","4.959","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","749","72.9%","8.184","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.679","98.7%","359","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.657","84.9%","2.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.630","94.0%","5.985","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":647},{"label":"Mar","value":857},{"label":"Abr","value":686},{"label":"Mai","value":802},{"label":"Jun","value":790},{"label":"Jul","value":950},{"label":"Ago","value":889},{"label":"Set","value":641},{"label":"Out","value":749},{"label":"Nov","value":715},{"label":"Dez","value":701}];
const MX = 950;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>ISO</span></h1>
                </div>
