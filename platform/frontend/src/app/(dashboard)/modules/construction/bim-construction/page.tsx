...
const PAGE = "BIM Integration";
const KPIS = [{"l":"Integrações Ativas","v":"411","t":"+2.1%","d":"up"},{"l":"Chamadas/Hora","v":"3400","t":"+1.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.0%","t":"-3.5%","d":"down"},{"l":"Latência Média (ms)","v":"80ms","t":"+11.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.031","2.789","76.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.053","1.285","90.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.450","4.921","94.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.279","2.523","95.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.469","6.975","71.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":627},{"label":"Mar","value":1004},{"label":"Abr","value":1003},{"label":"Mai","value":768},{"label":"Jun","value":795},{"label":"Jul","value":653},{"label":"Ago","value":829},{"label":"Set","value":786},{"label":"Out","value":640},{"label":"Nov","value":925},{"label":"Dez","value":999}];
const MX = 1004;
...
export default function BimConstructionPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>BIM</span></h1>
                </div>
