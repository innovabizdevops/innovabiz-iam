...
const PAGE = "Bid Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.181","t":"+9.1%","d":"up"},{"l":"Savings (€)","v":"€13953","t":"-4.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.4%","t":"+15.3%","d":"up"},{"l":"Ciclos PDCA","v":"6.775","t":"-5.0%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.915","€ 35901.62","2.713","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.335","€ 26410.35","3.406","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.544","€ 176.39","7.782","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.617","€ 48533.20","5.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.119","€ 30443.68","5.556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":625},{"label":"Mar","value":754},{"label":"Abr","value":508},{"label":"Mai","value":464},{"label":"Jun","value":460},{"label":"Jul","value":432},{"label":"Ago","value":727},{"label":"Set","value":691},{"label":"Out","value":630},{"label":"Nov","value":393},{"label":"Dez","value":721}];
const MX = 754;
...
export default function BidMgmtPage() {
    return (
