...
const PAGE = "Subcontractor Mgmt";
const KPIS = [{"l":"Contratos Ativos","v":"338","t":"-1.8%","d":"down"},{"l":"Valor Total (€M)","v":"€24.4M","t":"+17.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.963","t":"+6.9%","d":"up"},{"l":"Obrigações Pendentes","v":"3.601","t":"-3.7%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 45568.87","2026-01-13","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 48986.13","2026-01-11","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 22037.61","2026-02-03","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 17409.28","2026-03-02","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 14784.92","2026-01-12","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":372},{"label":"Mar","value":574},{"label":"Abr","value":299},{"label":"Mai","value":300},{"label":"Jun","value":524},{"label":"Jul","value":268},{"label":"Ago","value":529},{"label":"Set","value":572},{"label":"Out","value":269},{"label":"Nov","value":624},{"label":"Dez","value":554}];
const MX = 624;
...
export default function SubcontractorsConstructionPage() {
    return (
