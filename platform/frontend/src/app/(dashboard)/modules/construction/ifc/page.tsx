...
const PAGE = "IFC Data Exchange";
const KPIS = [{"l":"Total Construction","v":"1.453","t":"+3.2%","d":"up"},{"l":"IFC Data Exchange Ativos","v":"3.728","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"65.6%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.6%","d":"down"}];
const COLS = ["ID","IFC Data Exchange","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction #001","2026-01-18","3.490","7.283","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Construction #002","2026-02-09","2.898","5.283","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction #003","2026-02-08","3.298","1.809","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Construction #004","2026-01-21","9.018","3.755","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction #005","2026-02-21","8.852","1.053","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":526},{"label":"Mar","value":742},{"label":"Abr","value":781},{"label":"Mai","value":671},{"label":"Jun","value":824},{"label":"Jul","value":465},{"label":"Ago","value":800},{"label":"Set","value":596},{"label":"Out","value":819},{"label":"Nov","value":744},{"label":"Dez","value":591}];
const MX = 824;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>IFC</span></h1>
                </div>
