...
const KPIS = [{"l":"eNPS","v":"83","t":"-0.8%","d":"down"},{"l":"Engagement (%)","v":"94.1%","t":"+3.0%","d":"up"},{"l":"Turnover (%)","v":"73.5%","t":"+12.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.219","t":"+16.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.368","2026-02-01","82","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.669","2026-03-17","85","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","568","2026-02-10","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.397","2026-01-10","75","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.942","2026-03-25","74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":595},{"label":"Mar","value":743},{"label":"Abr","value":926},{"label":"Mai","value":580},{"label":"Jun","value":841},{"label":"Jul","value":825},{"label":"Ago","value":713},{"label":"Set","value":912},{"label":"Out","value":760},{"label":"Nov","value":860},{"label":"Dez","value":755}];
const MX = 926;
