...
const PAGE = "Drone Surveys AI";
const KPIS = [{"l":"Surveys Ativos","v":"5.039","t":"-1.6%","d":"down"},{"l":"Respostas/Semana","v":"250","t":"+11.6%","d":"up"},{"l":"NPS Médio","v":"57","t":"+16.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"71.6%","t":"-0.7%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.387","73","83.1%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","5.045","82","87.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","8.097","69","97.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.540","57","85.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.957","63","98.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":1064},{"label":"Mar","value":1018},{"label":"Abr","value":753},{"label":"Mai","value":1010},{"label":"Jun","value":913},{"label":"Jul","value":1045},{"label":"Ago","value":924},{"label":"Set","value":964},{"label":"Out","value":912},{"label":"Nov","value":816},{"label":"Dez","value":813}];
const MX = 1064;
