...
export default function AnalyticsManagementPlatformKernelPage() {
    const max = Math.max(...DATA.map(d => d.v1));
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold">Analytics Management Platform Kernel</h1>
                    <p className="text-sm text-muted-foreground">Analytics Management Platform Kernel • Análise Visual</p>
                </div>
