...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"7.859","t":"+11.7%","d":"up"},{"l":"Queries/Dia","v":"1075","t":"+6.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.265","t":"+4.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.848","t":"-0.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1073","2026-01-10","235","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","224","2026-03-12","3.182","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2188","2026-03-18","7.022","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2495","2026-02-18","8.120","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4835","2026-03-26","7.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":582},{"label":"Mar","value":418},{"label":"Abr","value":647},{"label":"Mai","value":759},{"label":"Jun","value":665},{"label":"Jul","value":392},{"label":"Ago","value":531},{"label":"Set","value":411},{"label":"Out","value":699},{"label":"Nov","value":757},{"label":"Dez","value":731}];
const MX = 759;
