...
/* ═══ Cloud Cost Engineering — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "6198", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3477", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€342K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1137456698", cells: ["COS-1698", "Cloud Cost Engineering Item 1", "15/3/2026", "€6798"], status: "active" as const },
    { id: "1137460269", cells: ["COS-5269", "Cloud Cost Engineering Item 2", "2/10/2026", "€10 369"], status: "pending" as const },
    { id: "1137463840", cells: ["COS-8840", "Cloud Cost Engineering Item 3", "17/5/2026", "€13 940"], status: "completed" as const },
    { id: "1137467411", cells: ["COS-3411", "Cloud Cost Engineering Item 4", "4/12/2026", "€17 511"], status: "warning" as const },
    { id: "1137470982", cells: ["COS-6982", "Cloud Cost Engineering Item 5", "19/7/2026", "€21 082"], status: "active" as const },
];
...
export default function CloudCostEngineeringPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cloud Cost Engineering</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cloud Cost Engineering</p>
                    </div>
                </div>
