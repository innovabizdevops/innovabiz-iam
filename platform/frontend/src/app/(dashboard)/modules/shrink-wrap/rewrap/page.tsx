...
const ACCENT = "#eab308";
const MODULE = "Shrink Wrap & Film";
const PAGE = "Rewrap";
const KPIS = [{"l":"Total Shrink Wrap","v":"107","t":"+0.0%","d":"up"},{"l":"Rewrap Ativos","v":"6.489","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"62","t":"+2.7%","d":"up"}];
const COLS = ["ID","Rewrap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shrink Wrap #001","Shrink Wrap #002","1.323","1.200","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Shrink Wrap #002","Shrink Wrap #003","3.466","1.641","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Shrink Wrap #003","Shrink Wrap #004","5.386","6.314","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Shrink Wrap #004","Shrink Wrap #005","6.114","7.468","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shrink Wrap #005","Shrink Wrap #001","424","1.738","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":816},{"label":"Mar","value":935},{"label":"Abr","value":798},{"label":"Mai","value":676},{"label":"Jun","value":605},{"label":"Jul","value":762},{"label":"Ago","value":849},{"label":"Set","value":930},{"label":"Out","value":572},{"label":"Nov","value":729},{"label":"Dez","value":843}];
const MX = 935;
...
export default function RewrapPage() {
    return (
