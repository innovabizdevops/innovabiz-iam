...
/* ═══ Shrink Wrap & Film — Dashboard ═══ */

const ACCENT = "#eab308";

const KPIS = [
    { label: "Total Registos", value: "9865", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4918", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€399K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "560389365", cells: ["SHR-5365", "Shrink Wrap & Film Item 1", "26/10/2026", "€39 465"], status: "active" as const },
    { id: "560392936", cells: ["SHR-8936", "Shrink Wrap & Film Item 2", "13/5/2026", "€43 036"], status: "pending" as const },
    { id: "560396507", cells: ["SHR-3507", "Shrink Wrap & Film Item 3", "28/12/2026", "€46 607"], status: "completed" as const },
    { id: "560400078", cells: ["SHR-7078", "Shrink Wrap & Film Item 4", "15/7/2026", "€178"], status: "warning" as const },
    { id: "560403649", cells: ["SHR-1649", "Shrink Wrap & Film Item 5", "2/2/2026", "€3749"], status: "active" as const },
];
...
export default function ShrinkWrapFilmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shrink Wrap & Film</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Shrink Wrap & Film</p>
                    </div>
                </div>
