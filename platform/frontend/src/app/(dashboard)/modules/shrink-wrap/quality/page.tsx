...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"196","t":"+12.8%","d":"up"},{"l":"NC Abertas","v":"2.028","t":"+9.3%","d":"up"},{"l":"Conformidade (%)","v":"75.2%","t":"+15.8%","d":"up"},{"l":"CAPAs Pendentes","v":"533","t":"-2.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.636","92.5%","695","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.266","93.8%","8.626","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.158","82.1%","3.863","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.784","99.7%","1.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.479","99.2%","7.514","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":545},{"label":"Mar","value":309},{"label":"Abr","value":495},{"label":"Mai","value":399},{"label":"Jun","value":621},{"label":"Jul","value":455},{"label":"Ago","value":324},{"label":"Set","value":417},{"label":"Out","value":436},{"label":"Nov","value":671},{"label":"Dez","value":383}];
const MX = 671;
