...
const ACCENT = "#6366f1";
const MODULE = "Solar Farm Mgmt";
const PAGE = "Inverter";
const KPIS = [{"l":"Total Solar Farm","v":"8.511","t":"-4.0%","d":"down"},{"l":"Inverter Ativos","v":"1.041","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"94.6%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"82","t":"+8.0%","d":"up"}];
const COLS = ["ID","Inverter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solar Farm #001","Solar Farm #002","5.369","8.725","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Solar Farm #002","Solar Farm #003","7.094","5.876","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Solar Farm #003","Solar Farm #004","6.858","6.553","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Solar Farm #004","Solar Farm #005","1.006","825","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solar Farm #005","Solar Farm #001","2.126","3.968","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":874},{"label":"Mar","value":765},{"label":"Abr","value":936},{"label":"Mai","value":615},{"label":"Jun","value":594},{"label":"Jul","value":907},{"label":"Ago","value":958},{"label":"Set","value":694},{"label":"Out","value":868},{"label":"Nov","value":821},{"label":"Dez","value":685}];
const MX = 958;
