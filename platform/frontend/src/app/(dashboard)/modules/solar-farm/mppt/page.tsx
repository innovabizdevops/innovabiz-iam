...
const PAGE = "MPPT";
const KPIS = [{"l":"Total Solar Farm","v":"2.225","t":"+13.6%","d":"up"},{"l":"MPPT Ativos","v":"2.137","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+5.1%","d":"up"}];
const COLS = ["ID","MPPT","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solar Farm #001","Solar Farm #002","1.770","8.729","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Solar Farm #002","Solar Farm #003","3.471","5.048","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Solar Farm #003","Solar Farm #004","1.954","9.097","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Solar Farm #004","Solar Farm #005","1.964","3.901","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solar Farm #005","Solar Farm #001","6.803","240","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":568},{"label":"Mar","value":518},{"label":"Abr","value":634},{"label":"Mai","value":797},{"label":"Jun","value":675},{"label":"Jul","value":814},{"label":"Ago","value":577},{"label":"Set","value":466},{"label":"Out","value":701},{"label":"Nov","value":803},{"label":"Dez","value":797}];
const MX = 814;
