...
const PAGE = "Panel Array";
const KPIS = [{"l":"ARR (€M)","v":"€12.9M","t":"+7.2%","d":"up"},{"l":"MRR (€)","v":"€16304","t":"-5.7%","d":"down"},{"l":"Churn (%)","v":"73.5%","t":"-1.0%","d":"down"},{"l":"ARPU (€)","v":"€89933","t":"-2.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 16596.98","1.529","€ 31107.03","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38189.47","4.735","€ 9974.10","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7521.97","6.988","€ 44524.81","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46482.06","3.960","€ 23706.69","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 36989.31","7.611","€ 20433.84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":704},{"label":"Mar","value":639},{"label":"Abr","value":560},{"label":"Mai","value":537},{"label":"Jun","value":778},{"label":"Jul","value":661},{"label":"Ago","value":448},{"label":"Set","value":531},{"label":"Out","value":533},{"label":"Nov","value":682},{"label":"Dez","value":562}];
const MX = 820;
