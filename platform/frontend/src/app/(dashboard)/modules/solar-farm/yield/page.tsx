...
const PAGE = "Yield";
const KPIS = [{"l":"Total Solar Farm","v":"5.656","t":"+9.1%","d":"up"},{"l":"Yield Ativos","v":"3.067","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"77.0%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"69","t":"+9.1%","d":"up"}];
const COLS = ["ID","Yield","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solar Farm #001","Solar Farm #002","8.671","6.387","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Solar Farm #002","Solar Farm #003","6.499","8.533","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Solar Farm #003","Solar Farm #004","4.215","3.095","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Solar Farm #004","Solar Farm #005","4.531","4.634","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solar Farm #005","Solar Farm #001","695","4.850","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":768},{"label":"Mar","value":749},{"label":"Abr","value":674},{"label":"Mai","value":841},{"label":"Jun","value":638},{"label":"Jul","value":894},{"label":"Ago","value":825},{"label":"Set","value":1022},{"label":"Out","value":674},{"label":"Nov","value":798},{"label":"Dez","value":779}];
const MX = 1022;
