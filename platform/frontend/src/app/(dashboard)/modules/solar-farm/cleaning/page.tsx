...
const PAGE = "Cleaning";
const KPIS = [{"l":"Projetos Melhoria","v":"9.013","t":"-1.7%","d":"down"},{"l":"Savings (€)","v":"€66466","t":"+11.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.6%","t":"+6.5%","d":"up"},{"l":"Ciclos PDCA","v":"3.549","t":"+0.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.755","€ 50099.88","5.746","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.511","€ 31450.70","5.041","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.322","€ 23005.64","8.010","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.712","€ 35447.40","3.747","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.388","€ 31213.43","4.317","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":887},{"label":"Mar","value":902},{"label":"Abr","value":861},{"label":"Mai","value":854},{"label":"Jun","value":1055},{"label":"Jul","value":962},{"label":"Ago","value":966},{"label":"Set","value":758},{"label":"Out","value":757},{"label":"Nov","value":1068},{"label":"Dez","value":1045}];
const MX = 1068;
