...
/* ═══ Green IT Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1560", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4627", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€62K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "942461660", cells: ["GRE-9660", "Green IT Platform Item 1", "1/9/2026", "€11 760"], status: "active" as const },
    { id: "942465231", cells: ["GRE-4231", "Green IT Platform Item 2", "16/4/2026", "€15 331"], status: "pending" as const },
    { id: "942468802", cells: ["GRE-7802", "Green IT Platform Item 3", "3/11/2026", "€18 902"], status: "completed" as const },
    { id: "942472373", cells: ["GRE-2373", "Green IT Platform Item 4", "18/6/2026", "€22 473"], status: "warning" as const },
    { id: "942475944", cells: ["GRE-5944", "Green IT Platform Item 5", "5/1/2026", "€26 044"], status: "active" as const },
];
...
export default function GreenItPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Green IT Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Green IT Platform</p>
                    </div>
                </div>
