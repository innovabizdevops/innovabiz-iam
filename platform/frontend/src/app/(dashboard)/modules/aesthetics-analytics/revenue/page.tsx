...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€17.5M","t":"+11.6%","d":"up"},{"l":"MRR (€)","v":"€79623","t":"+17.4%","d":"up"},{"l":"Churn (%)","v":"86.5%","t":"+4.6%","d":"up"},{"l":"ARPU (€)","v":"€44938","t":"+15.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 19589.87","7.528","€ 49993.71","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 21486.77","274","€ 2077.24","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37875.20","7.635","€ 46984.84","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 9664.58","7.975","€ 16132.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35438.28","8.234","€ 29780.65","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":708},{"label":"Mar","value":656},{"label":"Abr","value":729},{"label":"Mai","value":794},{"label":"Jun","value":637},{"label":"Jul","value":872},{"label":"Ago","value":845},{"label":"Set","value":805},{"label":"Out","value":923},{"label":"Nov","value":771},{"label":"Dez","value":661}];
const MX = 923;
