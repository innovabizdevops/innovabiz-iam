...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"957","t":"+16.4%","d":"up"},{"l":"Queries/Dia","v":"1188","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.710","t":"-4.9%","d":"down"},{"l":"Utilizadores Analytics","v":"5.032","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1974","2026-03-10","1.448","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4441","2026-03-14","6.749","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3810","2026-03-25","8.945","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3967","2026-01-22","609","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2013","2026-01-04","5.703","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":478},{"label":"Mar","value":381},{"label":"Abr","value":561},{"label":"Mai","value":601},{"label":"Jun","value":540},{"label":"Jul","value":453},{"label":"Ago","value":703},{"label":"Set","value":549},{"label":"Out","value":551},{"label":"Nov","value":583},{"label":"Dez","value":391}];
const MX = 703;
