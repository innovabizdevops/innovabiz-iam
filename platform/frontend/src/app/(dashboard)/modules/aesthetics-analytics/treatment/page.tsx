...
const KPIS = [{"l":"Dashboards Ativos","v":"4.793","t":"+5.5%","d":"up"},{"l":"Queries/Dia","v":"4265","t":"+1.3%","d":"up"},{"l":"Dados Processados (GB)","v":"6.429","t":"+16.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.515","t":"-5.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","321","2026-02-14","2.447","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4154","2026-02-20","6.245","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","854","2026-03-07","6.873","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1343","2026-01-19","5.915","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","505","2026-03-03","796","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":601},{"label":"Mar","value":670},{"label":"Abr","value":654},{"label":"Mai","value":763},{"label":"Jun","value":749},{"label":"Jul","value":393},{"label":"Ago","value":575},{"label":"Set","value":411},{"label":"Out","value":424},{"label":"Nov","value":396},{"label":"Dez","value":409}];
const MX = 763;
