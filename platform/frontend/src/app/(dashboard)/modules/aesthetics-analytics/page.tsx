...
/* ═══ Aesthetics Analytics — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "6767", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1299", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€447K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1782927367", cells: ["AES-1367", "Aesthetics Analytics Item 1", "12/8/2026", "€27 467"], status: "active" as const },
    { id: "1782930938", cells: ["AES-4938", "Aesthetics Analytics Item 2", "27/3/2026", "€31 038"], status: "pending" as const },
    { id: "1782934509", cells: ["AES-8509", "Aesthetics Analytics Item 3", "14/10/2026", "€34 609"], status: "completed" as const },
    { id: "1782938080", cells: ["AES-3080", "Aesthetics Analytics Item 4", "1/5/2026", "€38 180"], status: "warning" as const },
    { id: "1782941651", cells: ["AES-6651", "Aesthetics Analytics Item 5", "16/12/2026", "€41 751"], status: "active" as const },
];
...
export default function AestheticsAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aesthetics Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aesthetics Analytics</p>
                    </div>
                </div>
