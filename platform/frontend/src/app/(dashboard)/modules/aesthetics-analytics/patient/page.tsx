...
const PAGE = "Patient";
const KPIS = [{"l":"Dashboards Ativos","v":"2.225","t":"-3.1%","d":"down"},{"l":"Queries/Dia","v":"4880","t":"+7.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.958","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.559","t":"+15.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3098","2026-03-06","3.492","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1215","2026-02-25","8.989","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","419","2026-01-09","1.887","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2149","2026-02-11","7.015","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","448","2026-03-24","4.565","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":857},{"label":"Mar","value":776},{"label":"Abr","value":799},{"label":"Mai","value":842},{"label":"Jun","value":634},{"label":"Jul","value":857},{"label":"Ago","value":815},{"label":"Set","value":833},{"label":"Out","value":820},{"label":"Nov","value":898},{"label":"Dez","value":534}];
const MX = 898;
