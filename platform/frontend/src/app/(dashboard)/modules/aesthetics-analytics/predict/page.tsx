...
const ACCENT = "#831843";
const MODULE = "Aesthetics Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"8.346","t":"+18.0%","d":"up"},{"l":"Queries/Dia","v":"4722","t":"+1.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.187","t":"+0.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.312","t":"+4.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1516","2026-02-08","1.113","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","807","2026-01-20","3.825","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2833","2026-01-17","8.059","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2259","2026-02-12","7.751","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3073","2026-01-02","6.499","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":729},{"label":"Mar","value":512},{"label":"Abr","value":690},{"label":"Mai","value":485},{"label":"Jun","value":549},{"label":"Jul","value":616},{"label":"Ago","value":763},{"label":"Set","value":667},{"label":"Out","value":656},{"label":"Nov","value":622},{"label":"Dez","value":724}];
const MX = 763;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#831843'}}>AI</span></h1>
                </div>
