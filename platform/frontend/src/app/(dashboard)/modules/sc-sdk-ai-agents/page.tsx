...
/* ═══ SC: SDK AI Agents — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "4030", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "446", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€351K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1741265430", cells: ["SC-9430", "SC: SDK AI Agents Item 1", "3/7/2026", "€15 530"], status: "active" as const },
    { id: "1741269001", cells: ["SC-4001", "SC: SDK AI Agents Item 2", "18/2/2026", "€19 101"], status: "pending" as const },
    { id: "1741272572", cells: ["SC-7572", "SC: SDK AI Agents Item 3", "5/9/2026", "€22 672"], status: "completed" as const },
    { id: "1741276143", cells: ["SC-2143", "SC: SDK AI Agents Item 4", "20/4/2026", "€26 243"], status: "warning" as const },
    { id: "1741279714", cells: ["SC-5714", "SC: SDK AI Agents Item 5", "7/11/2026", "€29 814"], status: "active" as const },
];
...
export default function ScSdkAiAgentsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: SDK AI Agents</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: SDK AI Agents</p>
                    </div>
                </div>
