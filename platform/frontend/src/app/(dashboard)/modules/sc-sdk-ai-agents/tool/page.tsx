...
const ACCENT = "#0284c7";
const MODULE = "SC: SDK AI Agents";
const PAGE = "Tool";
const KPIS = [{"l":"Total Sc Sdk Ai Agents","v":"8.267","t":"+15.9%","d":"up"},{"l":"Tool Ativos","v":"5.266","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"57","t":"-6.0%","d":"down"}];
const COLS = ["ID","Tool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Sdk Ai Agents #001","Sc Sdk Ai Agents #002","2.821","8.089","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Sdk Ai Agents #002","Sc Sdk Ai Agents #003","4.060","8.805","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Sdk Ai Agents #003","Sc Sdk Ai Agents #004","4.294","5.423","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Sdk Ai Agents #004","Sc Sdk Ai Agents #005","1.969","514","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Sdk Ai Agents #005","Sc Sdk Ai Agents #001","2.536","4.076","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":978},{"label":"Mar","value":830},{"label":"Abr","value":977},{"label":"Mai","value":994},{"label":"Jun","value":871},{"label":"Jul","value":940},{"label":"Ago","value":668},{"label":"Set","value":788},{"label":"Out","value":777},{"label":"Nov","value":855},{"label":"Dez","value":787}];
const MX = 994;
