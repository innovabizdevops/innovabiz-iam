...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"579","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"2093","t":"+5.7%","d":"up"},{"l":"Documentos Gerados","v":"404","t":"+9.3%","d":"up"},{"l":"Templates","v":"8.889","t":"+14.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.796","2026-03-04","2.229","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","498","2026-01-16","3.324","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.725","2026-03-09","4.791","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.710","2026-01-27","6.993","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.144","2026-01-01","104","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":743},{"label":"Mar","value":789},{"label":"Abr","value":716},{"label":"Mai","value":609},{"label":"Jun","value":627},{"label":"Jul","value":764},{"label":"Ago","value":897},{"label":"Set","value":668},{"label":"Out","value":881},{"label":"Nov","value":741},{"label":"Dez","value":724}];
const MX = 897;
