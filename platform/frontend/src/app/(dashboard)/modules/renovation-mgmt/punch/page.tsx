...
const ACCENT = "#6366f1";
const MODULE = "Renovation Mgmt";
const PAGE = "Punch List";
const KPIS = [{"l":"Total Renovation Mgmt","v":"815","t":"+10.3%","d":"up"},{"l":"Punch List Ativos","v":"8.795","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"92","t":"-4.1%","d":"down"}];
const COLS = ["ID","Punch List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renovation Mgmt #001","Renovation Mgmt #002","3.929","2.870","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Renovation Mgmt #002","Renovation Mgmt #003","1.399","7.096","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Renovation Mgmt #003","Renovation Mgmt #004","8.811","5.860","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Renovation Mgmt #004","Renovation Mgmt #005","2.951","7.528","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renovation Mgmt #005","Renovation Mgmt #001","3.004","2.577","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":1066},{"label":"Mar","value":723},{"label":"Abr","value":739},{"label":"Mai","value":904},{"label":"Jun","value":842},{"label":"Jul","value":1024},{"label":"Ago","value":709},{"label":"Set","value":957},{"label":"Out","value":956},{"label":"Nov","value":929},{"label":"Dez","value":858}];
const MX = 1066;
