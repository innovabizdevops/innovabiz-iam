...
const PAGE = "Assess";
const KPIS = [{"l":"Total Renovation Mgmt","v":"3.061","t":"+3.8%","d":"up"},{"l":"Assess Ativos","v":"4.781","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"56","t":"-0.3%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renovation Mgmt #001","Renovation Mgmt #002","4.119","1.892","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Renovation Mgmt #002","Renovation Mgmt #003","6.496","6.225","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Renovation Mgmt #003","Renovation Mgmt #004","2.402","6.591","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Renovation Mgmt #004","Renovation Mgmt #005","7.875","1.905","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renovation Mgmt #005","Renovation Mgmt #001","1.934","5.357","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":619},{"label":"Mar","value":562},{"label":"Abr","value":509},{"label":"Mai","value":716},{"label":"Jun","value":667},{"label":"Jul","value":446},{"label":"Ago","value":645},{"label":"Set","value":417},{"label":"Out","value":367},{"label":"Nov","value":692},{"label":"Dez","value":733}];
const MX = 733;
