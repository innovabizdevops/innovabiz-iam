...
const PAGE = "Demo";
const KPIS = [{"l":"Total Renovation Mgmt","v":"6.717","t":"+15.6%","d":"up"},{"l":"Demo Ativos","v":"7.071","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+12.6%","d":"up"}];
const COLS = ["ID","Demo","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renovation Mgmt #001","Renovation Mgmt #002","4.091","5.487","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Renovation Mgmt #002","Renovation Mgmt #003","5.101","553","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Renovation Mgmt #003","Renovation Mgmt #004","4.510","1.585","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Renovation Mgmt #004","Renovation Mgmt #005","5.738","997","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renovation Mgmt #005","Renovation Mgmt #001","7.738","6.999","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":767},{"label":"Mar","value":748},{"label":"Abr","value":717},{"label":"Mai","value":526},{"label":"Jun","value":568},{"label":"Jul","value":507},{"label":"Ago","value":681},{"label":"Set","value":794},{"label":"Out","value":806},{"label":"Nov","value":547},{"label":"Dez","value":812}];
const MX = 812;
