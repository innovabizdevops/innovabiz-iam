...
const PAGE = "Build";
const KPIS = [{"l":"Total Renovation Mgmt","v":"3.051","t":"+4.3%","d":"up"},{"l":"Build Ativos","v":"4.245","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+0.2%","d":"up"}];
const COLS = ["ID","Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Renovation Mgmt #001","Renovation Mgmt #002","4.537","8.462","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Renovation Mgmt #002","Renovation Mgmt #003","6.862","7.199","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Renovation Mgmt #003","Renovation Mgmt #004","4.751","7.647","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Renovation Mgmt #004","Renovation Mgmt #005","7.730","5.326","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Renovation Mgmt #005","Renovation Mgmt #001","1.516","2.078","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":647},{"label":"Mar","value":373},{"label":"Abr","value":709},{"label":"Mai","value":604},{"label":"Jun","value":574},{"label":"Jul","value":408},{"label":"Ago","value":691},{"label":"Set","value":678},{"label":"Out","value":682},{"label":"Nov","value":376},{"label":"Dez","value":603}];
const MX = 709;
