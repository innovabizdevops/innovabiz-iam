...
const PAGE = "Paint";
const KPIS = [{"l":"Total Body Paint","v":"1.497","t":"+7.7%","d":"up"},{"l":"Paint Ativos","v":"6.389","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"63","t":"+5.9%","d":"up"}];
const COLS = ["ID","Paint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Paint #001","Body Paint #002","5.948","8.952","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Body Paint #002","Body Paint #003","877","2.521","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Paint #003","Body Paint #004","4.284","7.111","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Body Paint #004","Body Paint #005","8.952","7.775","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Paint #005","Body Paint #001","3.542","6.116","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":443},{"label":"Mar","value":282},{"label":"Abr","value":621},{"label":"Mai","value":392},{"label":"Jun","value":580},{"label":"Jul","value":294},{"label":"Ago","value":482},{"label":"Set","value":418},{"label":"Out","value":320},{"label":"Nov","value":308},{"label":"Dez","value":460}];
const MX = 621;
