...
const PAGE = "Trim";
const KPIS = [{"l":"Total Body Paint","v":"2.641","t":"+9.2%","d":"up"},{"l":"Trim Ativos","v":"8.914","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+13.9%","d":"up"}];
const COLS = ["ID","Trim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Paint #001","Body Paint #002","4.640","8.081","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Body Paint #002","Body Paint #003","7.614","897","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Paint #003","Body Paint #004","5.866","1.573","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Body Paint #004","Body Paint #005","6.788","7.814","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Paint #005","Body Paint #001","1.040","7.032","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":661},{"label":"Mar","value":864},{"label":"Abr","value":730},{"label":"Mai","value":856},{"label":"Jun","value":866},{"label":"Jul","value":844},{"label":"Ago","value":889},{"label":"Set","value":603},{"label":"Out","value":755},{"label":"Nov","value":661},{"label":"Dez","value":901}];
const MX = 901;
