...
const ACCENT = "#6366f1";
const MODULE = "Body & Paint";
const PAGE = "Welding";
const KPIS = [{"l":"Total Body Paint","v":"1.408","t":"-2.9%","d":"down"},{"l":"Welding Ativos","v":"3.124","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"82","t":"+10.5%","d":"up"}];
const COLS = ["ID","Welding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Paint #001","Body Paint #002","6.450","7.213","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Body Paint #002","Body Paint #003","3.347","3.655","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Paint #003","Body Paint #004","7.429","3.418","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Body Paint #004","Body Paint #005","3.326","7.975","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Paint #005","Body Paint #001","1.097","7.264","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":616},{"label":"Mar","value":778},{"label":"Abr","value":572},{"label":"Mai","value":649},{"label":"Jun","value":827},{"label":"Jul","value":793},{"label":"Ago","value":758},{"label":"Set","value":614},{"label":"Out","value":775},{"label":"Nov","value":869},{"label":"Dez","value":741}];
const MX = 885;
