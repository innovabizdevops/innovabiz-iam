...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.703","t":"+6.7%","d":"up"},{"l":"NC Abertas","v":"8.536","t":"+-0.0%","d":"up"},{"l":"Conformidade (%)","v":"84.3%","t":"+15.7%","d":"up"},{"l":"CAPAs Pendentes","v":"6.651","t":"-4.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.067","91.6%","9.023","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.856","89.1%","4.143","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.161","72.8%","4.707","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.190","75.8%","2.178","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.234","86.2%","3.042","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":642},{"label":"Mar","value":664},{"label":"Abr","value":733},{"label":"Mai","value":389},{"label":"Jun","value":448},{"label":"Jul","value":636},{"label":"Ago","value":615},{"label":"Set","value":379},{"label":"Out","value":399},{"label":"Nov","value":702},{"label":"Dez","value":648}];
const MX = 733;
