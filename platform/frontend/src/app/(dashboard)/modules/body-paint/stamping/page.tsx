...
const PAGE = "Stamping";
const KPIS = [{"l":"Total Body Paint","v":"6.232","t":"+11.2%","d":"up"},{"l":"Stamping Ativos","v":"910","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"62","t":"+6.9%","d":"up"}];
const COLS = ["ID","Stamping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Paint #001","Body Paint #002","7.579","888","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Body Paint #002","Body Paint #003","661","2.394","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Paint #003","Body Paint #004","4.617","404","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Body Paint #004","Body Paint #005","7.352","605","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Paint #005","Body Paint #001","4.012","5.823","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":602},{"label":"Mar","value":570},{"label":"Abr","value":437},{"label":"Mai","value":436},{"label":"Jun","value":593},{"label":"Jul","value":670},{"label":"Ago","value":741},{"label":"Set","value":431},{"label":"Out","value":411},{"label":"Nov","value":673},{"label":"Dez","value":401}];
const MX = 741;
