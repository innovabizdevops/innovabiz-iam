...
const PAGE = "Network Slicing";
const KPIS = [{"l":"Total Telecom Ops","v":"7.840","t":"+6.4%","d":"up"},{"l":"Network Slicing Ativos","v":"430","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"94","t":"-5.5%","d":"down"}];
const COLS = ["ID","Network Slicing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Ops #001","Telecom Ops #002","8.763","1.177","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Ops #002","Telecom Ops #003","7.998","6.124","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Ops #003","Telecom Ops #004","3.058","6.141","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Ops #004","Telecom Ops #005","4.387","7.531","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Ops #005","Telecom Ops #001","933","6.676","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":614},{"label":"Mar","value":462},{"label":"Abr","value":729},{"label":"Mai","value":660},{"label":"Jun","value":590},{"label":"Jul","value":755},{"label":"Ago","value":557},{"label":"Set","value":746},{"label":"Out","value":716},{"label":"Nov","value":665},{"label":"Dez","value":735}];
const MX = 755;
