...
const PAGE = "Churn Prevention";
const KPIS = [{"l":"ARR (€M)","v":"€21.7M","t":"-4.4%","d":"down"},{"l":"MRR (€)","v":"€57835","t":"+9.3%","d":"up"},{"l":"Churn (%)","v":"65.2%","t":"+17.6%","d":"up"},{"l":"ARPU (€)","v":"€56626","t":"+11.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27734.30","2.149","€ 17475.52","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 29400.59","8.297","€ 13271.00","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38563.39","7.426","€ 37881.12","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31846.36","1.265","€ 35618.09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24257.91","1.795","€ 1028.96","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":656},{"label":"Mar","value":506},{"label":"Abr","value":726},{"label":"Mai","value":708},{"label":"Jun","value":389},{"label":"Jul","value":449},{"label":"Ago","value":362},{"label":"Set","value":364},{"label":"Out","value":456},{"label":"Nov","value":341},{"label":"Dez","value":514}];
const MX = 726;
