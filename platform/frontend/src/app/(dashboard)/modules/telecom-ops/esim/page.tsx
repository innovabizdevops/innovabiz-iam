...
const KPIS = [{"l":"Projetos Melhoria","v":"625","t":"+6.5%","d":"up"},{"l":"Savings (€)","v":"€51368","t":"-0.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"83.2%","t":"+2.1%","d":"up"},{"l":"Ciclos PDCA","v":"4.296","t":"-4.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.711","€ 4772.65","323","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","432","€ 7265.04","365","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.635","€ 31937.09","6.920","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.682","€ 10200.01","6.754","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.323","€ 2483.07","1.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":644},{"label":"Mar","value":521},{"label":"Abr","value":450},{"label":"Mai","value":362},{"label":"Jun","value":687},{"label":"Jul","value":557},{"label":"Ago","value":441},{"label":"Set","value":317},{"label":"Out","value":350},{"label":"Nov","value":558},{"label":"Dez","value":601}];
const MX = 687;
