...
const ACCENT = "#0369a1";
const MODULE = "Telecom Operations";
const PAGE = "5G Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.052","t":"+16.9%","d":"up"},{"l":"Savings (€)","v":"€99820","t":"+4.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.1%","t":"+12.5%","d":"up"},{"l":"Ciclos PDCA","v":"7.181","t":"+2.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.650","€ 33209.38","3.429","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.075","€ 8883.43","4.291","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.531","€ 43041.18","4.473","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.895","€ 11515.57","6.341","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.337","€ 38274.93","4.785","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":544},{"label":"Mar","value":408},{"label":"Abr","value":502},{"label":"Mai","value":469},{"label":"Jun","value":667},{"label":"Jul","value":460},{"label":"Ago","value":432},{"label":"Set","value":473},{"label":"Out","value":438},{"label":"Nov","value":535},{"label":"Dez","value":331}];
const MX = 667;
...
export default function 5gPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>5G</span></h1>
                </div>
