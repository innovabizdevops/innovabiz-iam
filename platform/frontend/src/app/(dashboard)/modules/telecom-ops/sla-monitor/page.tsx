...
const KPIS = [{"l":"Tickets Abertos","v":"7.360","t":"+3.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.4%","t":"+13.6%","d":"up"},{"l":"MTTR (h)","v":"20h","t":"-4.8%","d":"down"},{"l":"Satisfação (%)","v":"90.1%","t":"+10.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.934","4.585","569","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.571","5.594","249","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.558","8.175","7.665","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.854","4.255","2.565","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.649","6.420","8.395","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":845},{"label":"Mar","value":781},{"label":"Abr","value":952},{"label":"Mai","value":927},{"label":"Jun","value":701},{"label":"Jul","value":960},{"label":"Ago","value":718},{"label":"Set","value":770},{"label":"Out","value":617},{"label":"Nov","value":679},{"label":"Dez","value":919}];
const MX = 960;
