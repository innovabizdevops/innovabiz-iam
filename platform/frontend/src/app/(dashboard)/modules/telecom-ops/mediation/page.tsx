...
const PAGE = "Billing Mediation";
const KPIS = [{"l":"Integrações Ativas","v":"8.838","t":"+8.8%","d":"up"},{"l":"Chamadas/Hora","v":"3552","t":"+8.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.0%","t":"+1.7%","d":"up"},{"l":"Latência Média (ms)","v":"57ms","t":"+13.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.437","6.027","72.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","664","1.323","87.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.862","6.880","94.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.689","132","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.848","543","84.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":690},{"label":"Mar","value":590},{"label":"Abr","value":622},{"label":"Mai","value":534},{"label":"Jun","value":618},{"label":"Jul","value":718},{"label":"Ago","value":763},{"label":"Set","value":649},{"label":"Out","value":508},{"label":"Nov","value":541},{"label":"Dez","value":689}];
const MX = 763;
