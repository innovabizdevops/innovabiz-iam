...
const PAGE = "Network Inventory";
const KPIS = [{"l":"Total Telecom Ops","v":"5.242","t":"+14.1%","d":"up"},{"l":"Network Inventory Ativos","v":"578","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"78","t":"-2.6%","d":"down"}];
const COLS = ["ID","Network Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Ops #001","Telecom Ops #002","7.518","5.165","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Ops #002","Telecom Ops #003","4.494","8.411","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Ops #003","Telecom Ops #004","5.541","1.085","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Ops #004","Telecom Ops #005","1.603","7.723","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Ops #005","Telecom Ops #001","8.586","2.227","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":837},{"label":"Mar","value":862},{"label":"Abr","value":1060},{"label":"Mai","value":811},{"label":"Jun","value":863},{"label":"Jul","value":1029},{"label":"Ago","value":1082},{"label":"Set","value":852},{"label":"Out","value":994},{"label":"Nov","value":879},{"label":"Dez","value":1041}];
const MX = 1082;
