...
const PAGE = "Subscriber Mgmt";
const KPIS = [{"l":"Total Telecom Ops","v":"4.232","t":"-2.1%","d":"down"},{"l":"Subscriber Mgmt Ativos","v":"5.262","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"94","t":"+12.9%","d":"up"}];
const COLS = ["ID","Subscriber Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Ops #001","Telecom Ops #002","3.046","7.727","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Ops #002","Telecom Ops #003","1.550","5.358","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Ops #003","Telecom Ops #004","8.318","1.734","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Ops #004","Telecom Ops #005","2.200","3.630","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Ops #005","Telecom Ops #001","8.091","4.052","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":410},{"label":"Mar","value":607},{"label":"Abr","value":607},{"label":"Mai","value":300},{"label":"Jun","value":605},{"label":"Jul","value":557},{"label":"Ago","value":354},{"label":"Set","value":337},{"label":"Out","value":618},{"label":"Nov","value":440},{"label":"Dez","value":334}];
const MX = 618;
