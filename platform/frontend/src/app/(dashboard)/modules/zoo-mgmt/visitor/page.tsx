...
const PAGE = "Visitor";
const KPIS = [{"l":"Total Zoo Mgmt","v":"1.060","t":"+2.0%","d":"up"},{"l":"Visitor Ativos","v":"1.627","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"68","t":"+7.3%","d":"up"}];
const COLS = ["ID","Visitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Mgmt #001","Zoo Mgmt #002","7.175","827","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Mgmt #002","Zoo Mgmt #003","1.414","3.157","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Mgmt #003","Zoo Mgmt #004","4.753","6.502","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Mgmt #004","Zoo Mgmt #005","2.125","6.782","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Mgmt #005","Zoo Mgmt #001","1.661","7.019","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":727},{"label":"Mar","value":708},{"label":"Abr","value":782},{"label":"Mai","value":791},{"label":"Jun","value":884},{"label":"Jul","value":618},{"label":"Ago","value":959},{"label":"Set","value":873},{"label":"Out","value":794},{"label":"Nov","value":924},{"label":"Dez","value":839}];
const MX = 959;
