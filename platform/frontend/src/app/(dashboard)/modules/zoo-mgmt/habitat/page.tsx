...
const PAGE = "Habitat";
const KPIS = [{"l":"Total Zoo Mgmt","v":"5.870","t":"+8.1%","d":"up"},{"l":"Habitat Ativos","v":"7.605","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"71","t":"+4.8%","d":"up"}];
const COLS = ["ID","Habitat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Mgmt #001","Zoo Mgmt #002","1.604","4.815","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Mgmt #002","Zoo Mgmt #003","8.583","7.977","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Mgmt #003","Zoo Mgmt #004","8.198","3.945","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Mgmt #004","Zoo Mgmt #005","6.209","762","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Mgmt #005","Zoo Mgmt #001","2.908","2.610","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":751},{"label":"Mar","value":509},{"label":"Abr","value":403},{"label":"Mai","value":437},{"label":"Jun","value":465},{"label":"Jul","value":588},{"label":"Ago","value":486},{"label":"Set","value":499},{"label":"Out","value":582},{"label":"Nov","value":413},{"label":"Dez","value":523}];
const MX = 751;
