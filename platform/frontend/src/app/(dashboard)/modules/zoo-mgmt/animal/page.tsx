...
const PAGE = "Animal";
const KPIS = [{"l":"Total Zoo Mgmt","v":"3.606","t":"+2.6%","d":"up"},{"l":"Animal Ativos","v":"8.115","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"91","t":"+6.1%","d":"up"}];
const COLS = ["ID","Animal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Mgmt #001","Zoo Mgmt #002","5.616","7.368","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Mgmt #002","Zoo Mgmt #003","124","3.289","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Mgmt #003","Zoo Mgmt #004","825","1.652","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Mgmt #004","Zoo Mgmt #005","2.533","6.555","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Mgmt #005","Zoo Mgmt #001","7.838","6.375","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":1055},{"label":"Mar","value":662},{"label":"Abr","value":891},{"label":"Mai","value":942},{"label":"Jun","value":743},{"label":"Jul","value":1040},{"label":"Ago","value":1005},{"label":"Set","value":833},{"label":"Out","value":698},{"label":"Nov","value":858},{"label":"Dez","value":772}];
const MX = 1055;
