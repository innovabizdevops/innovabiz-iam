...
const PAGE = "Vet";
const KPIS = [{"l":"Total Zoo Mgmt","v":"5.601","t":"+4.9%","d":"up"},{"l":"Vet Ativos","v":"9.094","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+11.7%","d":"up"}];
const COLS = ["ID","Vet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Mgmt #001","Zoo Mgmt #002","8.716","270","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Mgmt #002","Zoo Mgmt #003","3.622","3.141","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Mgmt #003","Zoo Mgmt #004","8.899","1.200","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Mgmt #004","Zoo Mgmt #005","5.439","143","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Mgmt #005","Zoo Mgmt #001","8.816","2.610","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":535},{"label":"Mar","value":356},{"label":"Abr","value":449},{"label":"Mai","value":456},{"label":"Jun","value":523},{"label":"Jul","value":613},{"label":"Ago","value":456},{"label":"Set","value":370},{"label":"Out","value":367},{"label":"Nov","value":415},{"label":"Dez","value":470}];
const MX = 613;
