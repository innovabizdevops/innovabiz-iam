...
const KPIS = [
    { label: "Total Registos", value: "963", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1147", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€334K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1263448763", cells: ["ZOO-2763", "Zoo Management Item 1", "4/12/2026", "€48 863"], status: "active" as const },
    { id: "1263452334", cells: ["ZOO-6334", "Zoo Management Item 2", "19/7/2026", "€2434"], status: "pending" as const },
    { id: "1263455905", cells: ["ZOO-9905", "Zoo Management Item 3", "6/2/2026", "€6005"], status: "completed" as const },
    { id: "1263459476", cells: ["ZOO-4476", "Zoo Management Item 4", "21/9/2026", "€9576"], status: "warning" as const },
    { id: "1263463047", cells: ["ZOO-8047", "Zoo Management Item 5", "8/4/2026", "€13 147"], status: "active" as const },
];
...
export default function ZooManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Zoo Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Zoo Management</p>
                    </div>
                </div>
