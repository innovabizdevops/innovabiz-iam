...
const ACCENT = "#ea580c";
const MODULE = "Zoo Management";
const PAGE = "Conservation";
const KPIS = [{"l":"Total Zoo Mgmt","v":"7.835","t":"+4.3%","d":"up"},{"l":"Conservation Ativos","v":"2.712","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"83","t":"+11.7%","d":"up"}];
const COLS = ["ID","Conservation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Mgmt #001","Zoo Mgmt #002","5.699","6.928","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Mgmt #002","Zoo Mgmt #003","7.804","9.006","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Mgmt #003","Zoo Mgmt #004","4.348","458","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Mgmt #004","Zoo Mgmt #005","7.504","171","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Mgmt #005","Zoo Mgmt #001","2.175","7.303","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":528},{"label":"Mar","value":406},{"label":"Abr","value":752},{"label":"Mai","value":465},{"label":"Jun","value":767},{"label":"Jul","value":555},{"label":"Ago","value":636},{"label":"Set","value":449},{"label":"Out","value":594},{"label":"Nov","value":447},{"label":"Dez","value":550}];
const MX = 767;
