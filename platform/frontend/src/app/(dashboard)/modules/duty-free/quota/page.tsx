...
const ACCENT = "#1e40af";
const MODULE = "Duty Free Retail";
const PAGE = "Quota Check";
const KPIS = [{"l":"Vendas YTD (€)","v":"€97637","t":"+1.5%","d":"up"},{"l":"Pipeline (€)","v":"€71222","t":"-2.2%","d":"down"},{"l":"Atingimento Quota (%)","v":"74.0%","t":"+4.6%","d":"up"},{"l":"Win Rate (%)","v":"72.7%","t":"+17.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 50031.47","€ 2125.67","€ 20796.82","89.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 14527.08","€ 13312.85","€ 9798.77","83.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 25650.29","€ 37279.24","€ 15299.24","85.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 28345.05","€ 43743.51","€ 13138.12","73.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 10403.05","€ 40857.22","€ 9422.81","98.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":762},{"label":"Mar","value":465},{"label":"Abr","value":708},{"label":"Mai","value":452},{"label":"Jun","value":439},{"label":"Jul","value":471},{"label":"Ago","value":800},{"label":"Set","value":579},{"label":"Out","value":687},{"label":"Nov","value":437},{"label":"Dez","value":770}];
const MX = 808;
