...
const KPIS = [{"l":"Atletas Registados","v":"2.562","t":"+7.2%","d":"up"},{"l":"Treinos/Semana","v":"1336","t":"-2.0%","d":"down"},{"l":"Competições","v":"5.026","t":"+2.8%","d":"up"},{"l":"Performance Score","v":"81","t":"+2.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.968","8.705","303","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.368","2.542","8.821","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","672","1.212","1.000","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.605","1.485","8.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.449","8.344","3.144","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":573},{"label":"Mar","value":780},{"label":"Abr","value":891},{"label":"Mai","value":805},{"label":"Jun","value":921},{"label":"Jul","value":766},{"label":"Ago","value":844},{"label":"Set","value":761},{"label":"Out","value":543},{"label":"Nov","value":665},{"label":"Dez","value":572}];
const MX = 921;
