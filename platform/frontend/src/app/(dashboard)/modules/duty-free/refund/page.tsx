...
const PAGE = "Tax Refund";
const KPIS = [{"l":"Total Duty Free","v":"6.647","t":"+9.1%","d":"up"},{"l":"Tax Refund Ativos","v":"258","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"90.4%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.5%","d":"up"}];
const COLS = ["ID","Tax Refund","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Duty Free #001","Duty Free #002","4.143","818","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Duty Free #002","Duty Free #003","1.619","3.827","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Duty Free #003","Duty Free #004","6.072","6.347","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Duty Free #004","Duty Free #005","6.871","4.037","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Duty Free #005","Duty Free #001","7.783","6.482","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":994},{"label":"Mar","value":652},{"label":"Abr","value":629},{"label":"Mai","value":789},{"label":"Jun","value":1008},{"label":"Jul","value":934},{"label":"Ago","value":987},{"label":"Set","value":857},{"label":"Out","value":983},{"label":"Nov","value":956},{"label":"Dez","value":966}];
const MX = 1008;
