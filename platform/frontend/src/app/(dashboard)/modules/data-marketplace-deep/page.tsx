...
/* ═══ Data Marketplace Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "7656", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1535", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€56K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1753604456", cells: ["DAT-9456", "Data Marketplace Deep Item 1", "17/9/2026", "€4556"], status: "active" as const },
    { id: "1753608027", cells: ["DAT-4027", "Data Marketplace Deep Item 2", "4/4/2026", "€8127"], status: "pending" as const },
    { id: "1753611598", cells: ["DAT-7598", "Data Marketplace Deep Item 3", "19/11/2026", "€11 698"], status: "completed" as const },
    { id: "1753615169", cells: ["DAT-2169", "Data Marketplace Deep Item 4", "6/6/2026", "€15 269"], status: "warning" as const },
    { id: "1753618740", cells: ["DAT-5740", "Data Marketplace Deep Item 5", "21/1/2026", "€18 840"], status: "active" as const },
];
...
export default function DataMarketplaceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Marketplace Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Marketplace Deep</p>
                    </div>
                </div>
