...
const ACCENT = "#1e3a5f";
const MODULE = "Data Marketplace Deep";
const PAGE = "Monetize";
const KPIS = [{"l":"Pedidos/Dia","v":"1244","t":"-1.0%","d":"down"},{"l":"GMV (€)","v":"€45631","t":"-3.3%","d":"down"},{"l":"Conversão (%)","v":"72.4%","t":"+13.2%","d":"up"},{"l":"AOV (€)","v":"€52470","t":"+15.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 22090.41","6.886","6.016","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 16937.74","3.225","7.557","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 10724.86","4.519","3.332","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 26127.22","7.075","8.610","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 23731.65","8.671","906","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":989},{"label":"Fev","value":831},{"label":"Mar","value":669},{"label":"Abr","value":927},{"label":"Mai","value":1006},{"label":"Jun","value":759},{"label":"Jul","value":809},{"label":"Ago","value":914},{"label":"Set","value":673},{"label":"Out","value":820},{"label":"Nov","value":642},{"label":"Dez","value":648}];
const MX = 1006;
