...
const PAGE = "Share";
const KPIS = [{"l":"Pedidos/Dia","v":"3411","t":"+1.9%","d":"up"},{"l":"GMV (€)","v":"€13766","t":"-5.0%","d":"down"},{"l":"Conversão (%)","v":"82.5%","t":"+2.4%","d":"up"},{"l":"AOV (€)","v":"€71471","t":"-3.5%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 17379.03","8.060","8.321","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 39722.55","5.613","713","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 35103.33","2.290","4.424","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 5826.38","3.022","6.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 31872.16","3.179","464","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":403},{"label":"Mar","value":369},{"label":"Abr","value":292},{"label":"Mai","value":489},{"label":"Jun","value":600},{"label":"Jul","value":574},{"label":"Ago","value":497},{"label":"Set","value":447},{"label":"Out","value":263},{"label":"Nov","value":628},{"label":"Dez","value":258}];
const MX = 628;
