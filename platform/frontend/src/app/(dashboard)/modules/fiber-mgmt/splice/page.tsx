...
const PAGE = "Splice";
const KPIS = [{"l":"Total Fiber Mgmt","v":"5.250","t":"+13.3%","d":"up"},{"l":"Splice Ativos","v":"5.520","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"58","t":"+15.7%","d":"up"}];
const COLS = ["ID","Splice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Mgmt #001","Fiber Mgmt #002","4.064","7.624","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Mgmt #002","Fiber Mgmt #003","7.927","1.776","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Mgmt #003","Fiber Mgmt #004","654","3.799","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Mgmt #004","Fiber Mgmt #005","7.273","7.197","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Mgmt #005","Fiber Mgmt #001","5.808","5.582","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":988},{"label":"Mar","value":857},{"label":"Abr","value":796},{"label":"Mai","value":843},{"label":"Jun","value":1005},{"label":"Jul","value":663},{"label":"Ago","value":956},{"label":"Set","value":662},{"label":"Out","value":655},{"label":"Nov","value":1021},{"label":"Dez","value":846}];
const MX = 1021;
