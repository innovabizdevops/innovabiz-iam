...
const ACCENT = "#f97316";
const MODULE = "Fiber Management";
const PAGE = "Route";
const KPIS = [{"l":"Total Fiber Mgmt","v":"2.305","t":"+7.8%","d":"up"},{"l":"Route Ativos","v":"4.873","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+3.9%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Mgmt #001","Fiber Mgmt #002","6.916","161","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Mgmt #002","Fiber Mgmt #003","8.183","3.798","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Mgmt #003","Fiber Mgmt #004","2.996","1.320","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Mgmt #004","Fiber Mgmt #005","2.552","4.735","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Mgmt #005","Fiber Mgmt #001","6.643","4.182","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":805},{"label":"Mar","value":779},{"label":"Abr","value":949},{"label":"Mai","value":768},{"label":"Jun","value":878},{"label":"Jul","value":932},{"label":"Ago","value":721},{"label":"Set","value":797},{"label":"Out","value":915},{"label":"Nov","value":828},{"label":"Dez","value":995}];
const MX = 995;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f97316'}}>GIS</span></h1>
                </div>
