...
const PAGE = "OTDR";
const KPIS = [{"l":"Total Fiber Mgmt","v":"2.519","t":"+0.4%","d":"up"},{"l":"OTDR Ativos","v":"2.602","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"56","t":"+7.6%","d":"up"}];
const COLS = ["ID","OTDR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Mgmt #001","Fiber Mgmt #002","1.974","3.918","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Mgmt #002","Fiber Mgmt #003","1.165","4.449","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Mgmt #003","Fiber Mgmt #004","8.704","5.557","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Mgmt #004","Fiber Mgmt #005","7.634","1.261","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Mgmt #005","Fiber Mgmt #001","1.641","307","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":574},{"label":"Mar","value":549},{"label":"Abr","value":353},{"label":"Mai","value":403},{"label":"Jun","value":631},{"label":"Jul","value":298},{"label":"Ago","value":624},{"label":"Set","value":647},{"label":"Out","value":281},{"label":"Nov","value":308},{"label":"Dez","value":329}];
const MX = 647;
