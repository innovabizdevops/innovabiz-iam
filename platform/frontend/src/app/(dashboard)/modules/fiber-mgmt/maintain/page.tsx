...
const PAGE = "Maintain";
const KPIS = [{"l":"Total Fiber Mgmt","v":"6.624","t":"+7.4%","d":"up"},{"l":"Maintain Ativos","v":"5.609","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"58","t":"+17.5%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Mgmt #001","Fiber Mgmt #002","2.060","2.131","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Mgmt #002","Fiber Mgmt #003","3.507","1.234","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Mgmt #003","Fiber Mgmt #004","7.114","3.332","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Mgmt #004","Fiber Mgmt #005","1.336","173","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Mgmt #005","Fiber Mgmt #001","3.501","3.602","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":515},{"label":"Mar","value":613},{"label":"Abr","value":483},{"label":"Mai","value":748},{"label":"Jun","value":557},{"label":"Jul","value":735},{"label":"Ago","value":498},{"label":"Set","value":689},{"label":"Out","value":762},{"label":"Nov","value":469},{"label":"Dez","value":615}];
const MX = 762;
