...
const PAGE = "Capacity";
const KPIS = [{"l":"Auditorias Realizadas","v":"513","t":"-5.3%","d":"down"},{"l":"NC Abertas","v":"7.563","t":"+11.6%","d":"up"},{"l":"Conformidade (%)","v":"89.5%","t":"+17.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.020","t":"-3.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","780","88.8%","5.952","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.309","73.7%","7.727","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.234","82.7%","4.429","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.622","92.2%","6.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.887","80.3%","3.930","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":752},{"label":"Mar","value":695},{"label":"Abr","value":853},{"label":"Mai","value":800},{"label":"Jun","value":907},{"label":"Jul","value":839},{"label":"Ago","value":720},{"label":"Set","value":770},{"label":"Out","value":686},{"label":"Nov","value":617},{"label":"Dez","value":647}];
const MX = 907;
