...
const PAGE = "Route Replay";
const KPIS = [{"l":"Total Fleet Telematics","v":"6.421","t":"+12.0%","d":"up"},{"l":"Route Replay Ativos","v":"7.935","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"68.6%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"90","t":"-1.9%","d":"down"}];
const COLS = ["ID","Route Replay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Telematics #001","Fleet Telematics #002","8.492","2.692","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Telematics #002","Fleet Telematics #003","4.305","657","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Telematics #003","Fleet Telematics #004","5.585","5.022","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Telematics #004","Fleet Telematics #005","9.021","5.768","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Telematics #005","Fleet Telematics #001","6.384","1.895","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":519},{"label":"Mar","value":630},{"label":"Abr","value":577},{"label":"Mai","value":319},{"label":"Jun","value":438},{"label":"Jul","value":627},{"label":"Ago","value":372},{"label":"Set","value":454},{"label":"Out","value":357},{"label":"Nov","value":621},{"label":"Dez","value":386}];
const MX = 647;
