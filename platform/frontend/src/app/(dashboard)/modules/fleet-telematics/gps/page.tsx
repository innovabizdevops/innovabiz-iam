...
const ACCENT = "#78350f";
const MODULE = "Fleet Telematics";
const PAGE = "GPS Tracking";
const KPIS = [{"l":"Total Fleet Telematics","v":"3.668","t":"-4.9%","d":"down"},{"l":"GPS Tracking Ativos","v":"6.611","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+2.5%","d":"up"}];
const COLS = ["ID","GPS Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Telematics #001","Fleet Telematics #002","2.108","8.863","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Telematics #002","Fleet Telematics #003","6.009","3.804","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Telematics #003","Fleet Telematics #004","3.953","5.078","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Telematics #004","Fleet Telematics #005","9.000","3.971","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Telematics #005","Fleet Telematics #001","253","483","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":692},{"label":"Mar","value":514},{"label":"Abr","value":602},{"label":"Mai","value":450},{"label":"Jun","value":468},{"label":"Jul","value":629},{"label":"Ago","value":718},{"label":"Set","value":655},{"label":"Out","value":724},{"label":"Nov","value":698},{"label":"Dez","value":578}];
const MX = 724;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78350f'}}>IoT</span></h1>
                </div>
