...
const PAGE = "Driver Behavior";
const KPIS = [{"l":"Total Fleet Telematics","v":"8.375","t":"+11.2%","d":"up"},{"l":"Driver Behavior Ativos","v":"1.787","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"84","t":"+5.3%","d":"up"}];
const COLS = ["ID","Driver Behavior","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Telematics #001","Fleet Telematics #002","4.709","6.015","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Telematics #002","Fleet Telematics #003","3.948","4.875","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Telematics #003","Fleet Telematics #004","2.043","8.621","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Telematics #004","Fleet Telematics #005","2.485","3.438","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Telematics #005","Fleet Telematics #001","749","555","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":597},{"label":"Mar","value":349},{"label":"Abr","value":485},{"label":"Mai","value":413},{"label":"Jun","value":614},{"label":"Jul","value":320},{"label":"Ago","value":609},{"label":"Set","value":560},{"label":"Out","value":277},{"label":"Nov","value":296},{"label":"Dez","value":604}];
const MX = 614;
