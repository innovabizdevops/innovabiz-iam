...
const PAGE = "Fuel Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.577","t":"+8.9%","d":"up"},{"l":"Queries/Dia","v":"5092","t":"-3.0%","d":"down"},{"l":"Dados Processados (GB)","v":"713","t":"+9.5%","d":"up"},{"l":"Utilizadores Analytics","v":"310","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2896","2026-02-06","6.520","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2653","2026-02-04","6.781","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","863","2026-01-01","7.115","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3601","2026-03-23","3.360","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2886","2026-03-13","379","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":847},{"label":"Mar","value":819},{"label":"Abr","value":900},{"label":"Mai","value":847},{"label":"Jun","value":879},{"label":"Jul","value":660},{"label":"Ago","value":762},{"label":"Set","value":988},{"label":"Out","value":633},{"label":"Nov","value":618},{"label":"Dez","value":927}];
const MX = 988;
