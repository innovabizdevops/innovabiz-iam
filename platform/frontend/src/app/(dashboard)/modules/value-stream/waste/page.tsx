...
const ACCENT = "#4338ca";
const MODULE = "Value Stream Mapping";
const PAGE = "Waste Identification";
const KPIS = [{"l":"Total Value Stream","v":"560","t":"-3.3%","d":"down"},{"l":"Waste Identification Ativos","v":"5.185","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"76","t":"+2.8%","d":"up"}];
const COLS = ["ID","Waste Identification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Value Stream #001","Value Stream #002","5.302","1.171","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Value Stream #002","Value Stream #003","6.372","3.034","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Value Stream #003","Value Stream #004","4.898","6.425","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Value Stream #004","Value Stream #005","9.095","3.873","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Value Stream #005","Value Stream #001","3.147","3.291","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":419},{"label":"Mar","value":580},{"label":"Abr","value":306},{"label":"Mai","value":491},{"label":"Jun","value":559},{"label":"Jul","value":690},{"label":"Ago","value":564},{"label":"Set","value":545},{"label":"Out","value":565},{"label":"Nov","value":681},{"label":"Dez","value":394}];
const MX = 690;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>Lean</span></h1>
                </div>
