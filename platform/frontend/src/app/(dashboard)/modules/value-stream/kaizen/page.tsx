...
const PAGE = "Kaizen Events";
const KPIS = [{"l":"Projetos Melhoria","v":"6.921","t":"-0.2%","d":"down"},{"l":"Savings (€)","v":"€92961","t":"+16.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.7%","t":"+14.1%","d":"up"},{"l":"Ciclos PDCA","v":"146","t":"+7.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.531","€ 27699.08","8.865","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.825","€ 31988.20","7.568","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.498","€ 36099.51","5.103","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.282","€ 33492.99","5.480","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","467","€ 6835.16","5.550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":523},{"label":"Mar","value":854},{"label":"Abr","value":543},{"label":"Mai","value":529},{"label":"Jun","value":665},{"label":"Jul","value":793},{"label":"Ago","value":732},{"label":"Set","value":585},{"label":"Out","value":602},{"label":"Nov","value":611},{"label":"Dez","value":802}];
const MX = 854;
