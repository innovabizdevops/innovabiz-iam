...
const PAGE = "Lead Time Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"7.576","t":"+4.6%","d":"up"},{"l":"Queries/Dia","v":"3103","t":"+2.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.008","t":"-1.9%","d":"down"},{"l":"Utilizadores Analytics","v":"2.713","t":"+14.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1443","2026-01-25","1.974","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4464","2026-02-12","739","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4454","2026-02-14","4.119","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3553","2026-03-22","4.604","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2248","2026-02-07","708","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":622},{"label":"Mar","value":514},{"label":"Abr","value":443},{"label":"Mai","value":674},{"label":"Jun","value":725},{"label":"Jul","value":586},{"label":"Ago","value":733},{"label":"Set","value":755},{"label":"Out","value":612},{"label":"Nov","value":651},{"label":"Dez","value":671}];
const MX = 755;
