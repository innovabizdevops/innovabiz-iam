...
const PAGE = "Value/Non-Value Map";
const KPIS = [{"l":"Total Value Stream","v":"2.955","t":"+5.1%","d":"up"},{"l":"Value/Non Value Map Ativos","v":"3.729","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"88.5%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"71","t":"-0.7%","d":"down"}];
const COLS = ["ID","Value/Non Value Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Value Stream #001","Value Stream #002","6.621","3.487","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Value Stream #002","Value Stream #003","4.651","8.374","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Value Stream #003","Value Stream #004","4.832","4.637","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Value Stream #004","Value Stream #005","5.994","5.441","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Value Stream #005","Value Stream #001","4.119","8.845","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":889},{"label":"Mar","value":709},{"label":"Abr","value":905},{"label":"Mai","value":710},{"label":"Jun","value":983},{"label":"Jul","value":782},{"label":"Ago","value":926},{"label":"Set","value":1039},{"label":"Out","value":805},{"label":"Nov","value":1056},{"label":"Dez","value":972}];
const MX = 1056;
...
export default function VnvMapPage() {
    return (
