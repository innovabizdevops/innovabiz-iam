...
const PAGE = "Stream Designer";
const KPIS = [{"l":"Formulários Ativos","v":"2.129","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"3760","t":"+4.5%","d":"up"},{"l":"Documentos Gerados","v":"1.214","t":"-4.1%","d":"down"},{"l":"Templates","v":"5.301","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","136","2026-03-28","7.803","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.112","2026-01-04","2.332","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.817","2026-01-02","564","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.421","2026-03-23","2.954","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.549","2026-02-20","7.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":704},{"label":"Mar","value":770},{"label":"Abr","value":511},{"label":"Mai","value":631},{"label":"Jun","value":485},{"label":"Jul","value":832},{"label":"Ago","value":536},{"label":"Set","value":782},{"label":"Out","value":642},{"label":"Nov","value":758},{"label":"Dez","value":786}];
const MX = 832;
