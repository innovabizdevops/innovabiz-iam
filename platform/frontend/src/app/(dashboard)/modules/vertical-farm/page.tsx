...
export default function VerticalFarmPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vertical Farm</h1><p className="text-sm text-muted-foreground">Vertical Farm • iBOS Enterprise</p></div>
