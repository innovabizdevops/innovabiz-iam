...
const ACCENT = "#6366f1";
const MODULE = "Vertical Farming";
const PAGE = "Climate";
const KPIS = [{"l":"Total Vertical Farm","v":"6.793","t":"+16.2%","d":"up"},{"l":"Climate Ativos","v":"1.646","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"92.7%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+0.1%","d":"up"}];
const COLS = ["ID","Climate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vertical Farm #001","Vertical Farm #002","2.795","5.745","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Vertical Farm #002","Vertical Farm #003","3.174","2.718","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Vertical Farm #003","Vertical Farm #004","3.887","1.864","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Vertical Farm #004","Vertical Farm #005","3.142","5.089","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vertical Farm #005","Vertical Farm #001","4.003","5.974","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":557},{"label":"Mar","value":269},{"label":"Abr","value":524},{"label":"Mai","value":581},{"label":"Jun","value":235},{"label":"Jul","value":357},{"label":"Ago","value":367},{"label":"Set","value":434},{"label":"Out","value":552},{"label":"Nov","value":566},{"label":"Dez","value":417}];
const MX = 581;
