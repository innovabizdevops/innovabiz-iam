...
const PAGE = "Mint";
const KPIS = [{"l":"Total Nft Collect","v":"4.829","t":"+4.7%","d":"up"},{"l":"Mint Ativos","v":"5.051","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"58","t":"-2.8%","d":"down"}];
const COLS = ["ID","Mint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nft Collect #001","Nft Collect #002","8.915","7.860","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Nft Collect #002","Nft Collect #003","7.319","2.963","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Nft Collect #003","Nft Collect #004","3.127","6.234","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Nft Collect #004","Nft Collect #005","8.457","6.323","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nft Collect #005","Nft Collect #001","383","7.287","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":338},{"label":"Mar","value":326},{"label":"Abr","value":424},{"label":"Mai","value":264},{"label":"Jun","value":542},{"label":"Jul","value":386},{"label":"Ago","value":525},{"label":"Set","value":463},{"label":"Out","value":390},{"label":"Nov","value":500},{"label":"Dez","value":266}];
const MX = 565;
