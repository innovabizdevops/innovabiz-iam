...
/* ═══ NFT Collectibles — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "1376", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2263", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€297K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1510691776", cells: ["NFT-6776", "NFT Collectibles Item 1", "21/5/2026", "€41 876"], status: "active" as const },
    { id: "1510695347", cells: ["NFT-1347", "NFT Collectibles Item 2", "8/12/2026", "€45 447"], status: "pending" as const },
    { id: "1510698918", cells: ["NFT-4918", "NFT Collectibles Item 3", "23/7/2026", "€49 018"], status: "completed" as const },
    { id: "1510702489", cells: ["NFT-8489", "NFT Collectibles Item 4", "10/2/2026", "€2589"], status: "warning" as const },
    { id: "1510706060", cells: ["NFT-3060", "NFT Collectibles Item 5", "25/9/2026", "€6160"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NFT Collectibles</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NFT Collectibles</p>
                    </div>
                </div>
