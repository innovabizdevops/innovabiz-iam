...
const ACCENT = "#854d0e";
const MODULE = "NFT Collectibles";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.934","t":"+4.6%","d":"up"},{"l":"Queries/Dia","v":"4583","t":"+6.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.738","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"3.002","t":"+1.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2932","2026-03-13","4.546","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3540","2026-02-18","934","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","444","2026-03-01","5.145","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4304","2026-02-19","1.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2777","2026-03-24","5.169","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":379},{"label":"Mar","value":371},{"label":"Abr","value":570},{"label":"Mai","value":296},{"label":"Jun","value":262},{"label":"Jul","value":551},{"label":"Ago","value":537},{"label":"Set","value":326},{"label":"Out","value":383},{"label":"Nov","value":575},{"label":"Dez","value":444}];
const MX = 598;
