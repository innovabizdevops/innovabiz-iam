...
const PAGE = "Trade";
const KPIS = [{"l":"Total Nft Collect","v":"451","t":"-2.7%","d":"down"},{"l":"Trade Ativos","v":"3.946","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.7%","d":"up"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nft Collect #001","Nft Collect #002","5.372","3.172","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Nft Collect #002","Nft Collect #003","7.608","5.085","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Nft Collect #003","Nft Collect #004","5.109","584","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Nft Collect #004","Nft Collect #005","6.724","6.229","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nft Collect #005","Nft Collect #001","2.878","2.511","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":520},{"label":"Mar","value":614},{"label":"Abr","value":551},{"label":"Mai","value":606},{"label":"Jun","value":752},{"label":"Jul","value":358},{"label":"Ago","value":491},{"label":"Set","value":753},{"label":"Out","value":383},{"label":"Nov","value":560},{"label":"Dez","value":660}];
const MX = 753;
