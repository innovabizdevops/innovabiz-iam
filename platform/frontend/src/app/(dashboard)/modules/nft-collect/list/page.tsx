...
const PAGE = "List";
const KPIS = [{"l":"Total Nft Collect","v":"379","t":"+2.8%","d":"up"},{"l":"List Ativos","v":"4.275","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"95","t":"+7.2%","d":"up"}];
const COLS = ["ID","List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nft Collect #001","Nft Collect #002","614","6.595","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Nft Collect #002","Nft Collect #003","8.707","4.694","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Nft Collect #003","Nft Collect #004","6.896","5.565","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Nft Collect #004","Nft Collect #005","2.860","4.042","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nft Collect #005","Nft Collect #001","2.097","1.311","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":596},{"label":"Mar","value":521},{"label":"Abr","value":597},{"label":"Mai","value":672},{"label":"Jun","value":628},{"label":"Jul","value":533},{"label":"Ago","value":671},{"label":"Set","value":751},{"label":"Out","value":869},{"label":"Nov","value":545},{"label":"Dez","value":777}];
const MX = 869;
