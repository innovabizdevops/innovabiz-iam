...
const PAGE = "Royalty";
const KPIS = [{"l":"Total Nft Collect","v":"8.743","t":"+9.3%","d":"up"},{"l":"Royalty Ativos","v":"2.593","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"68","t":"+12.4%","d":"up"}];
const COLS = ["ID","Royalty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nft Collect #001","Nft Collect #002","3.834","5.695","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Nft Collect #002","Nft Collect #003","8.803","3.047","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Nft Collect #003","Nft Collect #004","2.332","969","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Nft Collect #004","Nft Collect #005","5.050","4.676","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nft Collect #005","Nft Collect #001","6.031","4.995","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":353},{"label":"Mar","value":470},{"label":"Abr","value":601},{"label":"Mai","value":314},{"label":"Jun","value":329},{"label":"Jul","value":572},{"label":"Ago","value":344},{"label":"Set","value":252},{"label":"Out","value":607},{"label":"Nov","value":512},{"label":"Dez","value":333}];
const MX = 607;
