...
const PAGE = "Capture";
const KPIS = [{"l":"Dashboards Ativos","v":"1.626","t":"-4.0%","d":"down"},{"l":"Queries/Dia","v":"795","t":"+5.0%","d":"up"},{"l":"Dados Processados (GB)","v":"4.613","t":"+2.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.593","t":"+-0.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4253","2026-01-19","8.137","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3518","2026-02-24","7.368","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","425","2026-03-01","7.643","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2430","2026-02-14","6.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2171","2026-02-20","2.387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":742},{"label":"Mar","value":707},{"label":"Abr","value":610},{"label":"Mai","value":744},{"label":"Jun","value":888},{"label":"Jul","value":919},{"label":"Ago","value":859},{"label":"Set","value":771},{"label":"Out","value":668},{"label":"Nov","value":807},{"label":"Dez","value":690}];
const MX = 919;
