...
const ACCENT = "#1e3a5f";
const MODULE = "Data Lineage Deep";
const PAGE = "Visualize";
const KPIS = [{"l":"Dashboards Ativos","v":"6.970","t":"+1.6%","d":"up"},{"l":"Queries/Dia","v":"2207","t":"+14.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.530","t":"+8.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.780","t":"+3.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2000","2026-01-25","979","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3856","2026-03-11","5.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4331","2026-01-19","589","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","212","2026-01-21","4.514","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1699","2026-03-10","8.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":1039},{"label":"Mar","value":892},{"label":"Abr","value":945},{"label":"Mai","value":1029},{"label":"Jun","value":759},{"label":"Jul","value":1021},{"label":"Ago","value":812},{"label":"Set","value":811},{"label":"Out","value":1026},{"label":"Nov","value":1030},{"label":"Dez","value":1041}];
const MX = 1041;
