...
const PAGE = "Search";
const KPIS = [{"l":"Dashboards Ativos","v":"2.083","t":"+2.5%","d":"up"},{"l":"Queries/Dia","v":"4059","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.142","t":"+9.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.065","t":"-0.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3198","2026-03-23","4.451","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","217","2026-01-07","4.500","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4594","2026-03-25","8.193","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2307","2026-02-24","1.861","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1278","2026-03-08","7.929","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1067},{"label":"Fev","value":907},{"label":"Mar","value":869},{"label":"Abr","value":1000},{"label":"Mai","value":1016},{"label":"Jun","value":855},{"label":"Jul","value":846},{"label":"Ago","value":935},{"label":"Set","value":816},{"label":"Out","value":956},{"label":"Nov","value":964},{"label":"Dez","value":820}];
const MX = 1067;
