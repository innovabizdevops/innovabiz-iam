...
const PAGE = "Impact";
const KPIS = [{"l":"Dashboards Ativos","v":"4.330","t":"-1.3%","d":"down"},{"l":"Queries/Dia","v":"884","t":"+9.9%","d":"up"},{"l":"Dados Processados (GB)","v":"190","t":"+12.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.433","t":"+6.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4449","2026-02-25","4.134","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2311","2026-03-03","1.225","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2615","2026-03-01","8.166","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3847","2026-03-18","8.729","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4253","2026-02-17","6.758","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":761},{"label":"Mar","value":1093},{"label":"Abr","value":870},{"label":"Mai","value":780},{"label":"Jun","value":1058},{"label":"Jul","value":959},{"label":"Ago","value":894},{"label":"Set","value":835},{"label":"Out","value":932},{"label":"Nov","value":954},{"label":"Dez","value":1055}];
const MX = 1093;
