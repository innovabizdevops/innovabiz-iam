...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"4.240","t":"+1.5%","d":"up"},{"l":"Queries/Dia","v":"2924","t":"+16.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.580","t":"+17.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.008","t":"+8.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1660","2026-02-02","6.154","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1893","2026-02-01","7.849","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","464","2026-03-20","4.938","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1771","2026-01-14","6.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","881","2026-03-26","4.764","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":883},{"label":"Mar","value":594},{"label":"Abr","value":721},{"label":"Mai","value":874},{"label":"Jun","value":656},{"label":"Jul","value":826},{"label":"Ago","value":575},{"label":"Set","value":606},{"label":"Out","value":682},{"label":"Nov","value":854},{"label":"Dez","value":921}];
const MX = 921;
