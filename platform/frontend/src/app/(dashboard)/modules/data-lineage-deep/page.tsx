...
/* ═══ Data Lineage Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8228", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "307", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€499K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2143615528", cells: ["DAT-5528", "Data Lineage Deep Item 1", "13/5/2026", "€15 628"], status: "active" as const },
    { id: "2143619099", cells: ["DAT-9099", "Data Lineage Deep Item 2", "28/12/2026", "€19 199"], status: "pending" as const },
    { id: "2143622670", cells: ["DAT-3670", "Data Lineage Deep Item 3", "15/7/2026", "€22 770"], status: "completed" as const },
    { id: "2143626241", cells: ["DAT-7241", "Data Lineage Deep Item 4", "2/2/2026", "€26 341"], status: "warning" as const },
    { id: "2143629812", cells: ["DAT-1812", "Data Lineage Deep Item 5", "17/9/2026", "€29 912"], status: "active" as const },
];
...
export default function DataLineageDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Lineage Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Lineage Deep</p>
                    </div>
                </div>
