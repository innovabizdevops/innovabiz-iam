...
const PAGE = "EMS Ops";
const KPIS = [{"l":"Total Heliport Ops","v":"4.334","t":"+4.0%","d":"up"},{"l":"EMS Ops Ativos","v":"3.347","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"72.2%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+9.6%","d":"up"}];
const COLS = ["ID","EMS Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Heliport Ops #001","Heliport Ops #002","8.531","3.927","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Heliport Ops #002","Heliport Ops #003","3.704","6.714","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Heliport Ops #003","Heliport Ops #004","2.362","6.039","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Heliport Ops #004","Heliport Ops #005","2.456","7.882","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Heliport Ops #005","Heliport Ops #001","7.289","1.428","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":626},{"label":"Mar","value":1017},{"label":"Abr","value":673},{"label":"Mai","value":898},{"label":"Jun","value":652},{"label":"Jul","value":927},{"label":"Ago","value":754},{"label":"Set","value":656},{"label":"Out","value":860},{"label":"Nov","value":981},{"label":"Dez","value":834}];
const MX = 1017;
