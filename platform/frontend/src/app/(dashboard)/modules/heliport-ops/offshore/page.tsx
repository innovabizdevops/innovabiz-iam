...
const ACCENT = "#1e40af";
const MODULE = "Heliport Operations";
const PAGE = "Offshore Base";
const KPIS = [{"l":"Total Heliport Ops","v":"2.750","t":"-1.3%","d":"down"},{"l":"Offshore Base Ativos","v":"3.537","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"68","t":"+14.5%","d":"up"}];
const COLS = ["ID","Offshore Base","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Heliport Ops #001","Heliport Ops #002","3.006","4.128","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Heliport Ops #002","Heliport Ops #003","297","8.903","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Heliport Ops #003","Heliport Ops #004","3.686","8.383","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Heliport Ops #004","Heliport Ops #005","6.315","7.703","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Heliport Ops #005","Heliport Ops #001","1.790","5.181","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":985},{"label":"Mar","value":650},{"label":"Abr","value":910},{"label":"Mai","value":878},{"label":"Jun","value":654},{"label":"Jul","value":702},{"label":"Ago","value":785},{"label":"Set","value":1012},{"label":"Out","value":873},{"label":"Nov","value":994},{"label":"Dez","value":996}];
const MX = 1012;
