...
const KPIS = [{"l":"Total Border Security","v":"1.898","t":"+9.2%","d":"up"},{"l":"Checkpoint Ativos","v":"5.414","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"93","t":"+11.9%","d":"up"}];
const COLS = ["ID","Checkpoint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Border Security #001","2026-01-28","6.181","4.676","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Border Security #002","2026-01-21","2.125","123","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Border Security #003","2026-01-27","2.169","3.786","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Border Security #004","2026-03-27","7.155","3.962","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Border Security #005","2026-02-21","7.956","1.371","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":582},{"label":"Mar","value":835},{"label":"Abr","value":606},{"label":"Mai","value":724},{"label":"Jun","value":672},{"label":"Jul","value":592},{"label":"Ago","value":629},{"label":"Set","value":493},{"label":"Out","value":710},{"label":"Nov","value":635},{"label":"Dez","value":455}];
const MX = 835;
