...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"8.156","t":"+8.9%","d":"up"},{"l":"Submissões/Dia","v":"2992","t":"+17.9%","d":"up"},{"l":"Documentos Gerados","v":"3.300","t":"+12.9%","d":"up"},{"l":"Templates","v":"3.676","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.010","2026-01-24","991","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.414","2026-02-04","5.461","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.531","2026-02-28","4.293","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.900","2026-01-17","6.629","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.419","2026-01-12","4.852","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":465},{"label":"Mar","value":651},{"label":"Abr","value":429},{"label":"Mai","value":539},{"label":"Jun","value":454},{"label":"Jul","value":623},{"label":"Ago","value":398},{"label":"Set","value":741},{"label":"Out","value":499},{"label":"Nov","value":376},{"label":"Dez","value":462}];
const MX = 747;
