...
const KPIS = [{"l":"Dashboards Ativos","v":"3.084","t":"+8.0%","d":"up"},{"l":"Queries/Dia","v":"4010","t":"+3.7%","d":"up"},{"l":"Dados Processados (GB)","v":"7.530","t":"+9.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.137","t":"-4.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2696","2026-01-12","7.143","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3891","2026-03-21","8.109","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","164","2026-03-27","2.125","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3922","2026-02-22","8.677","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2478","2026-02-09","5.523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":714},{"label":"Mar","value":588},{"label":"Abr","value":721},{"label":"Mai","value":662},{"label":"Jun","value":530},{"label":"Jul","value":400},{"label":"Ago","value":598},{"label":"Set","value":357},{"label":"Out","value":596},{"label":"Nov","value":650},{"label":"Dez","value":645}];
const MX = 721;
