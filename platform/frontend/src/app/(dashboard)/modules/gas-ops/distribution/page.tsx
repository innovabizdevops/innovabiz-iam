...
const KPIS = [{"l":"Total Gas Ops","v":"5.476","t":"+4.2%","d":"up"},{"l":"Distribution Ativos","v":"5.995","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+8.9%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Ops #001","Gas Ops #002","3.518","1.700","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Ops #002","Gas Ops #003","7.389","6.249","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Ops #003","Gas Ops #004","7.464","3.559","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Ops #004","Gas Ops #005","2.971","5.032","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Ops #005","Gas Ops #001","8.012","7.364","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":681},{"label":"Mar","value":1063},{"label":"Abr","value":853},{"label":"Mai","value":950},{"label":"Jun","value":748},{"label":"Jul","value":1074},{"label":"Ago","value":830},{"label":"Set","value":954},{"label":"Out","value":823},{"label":"Nov","value":716},{"label":"Dez","value":827}];
const MX = 1074;
