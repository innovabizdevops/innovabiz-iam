...
const ACCENT = "#6366f1";
const MODULE = "Gas Operations";
const PAGE = "Leak Detect";
const KPIS = [{"l":"Total Gas Ops","v":"7.383","t":"+10.3%","d":"up"},{"l":"Leak Detect Ativos","v":"7.179","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"70","t":"-0.8%","d":"down"}];
const COLS = ["ID","Leak Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Ops #001","Gas Ops #002","1.857","8.325","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Ops #002","Gas Ops #003","4.592","3.722","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Ops #003","Gas Ops #004","6.453","3.524","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Ops #004","Gas Ops #005","8.958","1.073","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Ops #005","Gas Ops #001","1.802","6.012","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":590},{"label":"Mar","value":510},{"label":"Abr","value":795},{"label":"Mai","value":668},{"label":"Jun","value":632},{"label":"Jul","value":839},{"label":"Ago","value":764},{"label":"Set","value":683},{"label":"Out","value":622},{"label":"Nov","value":617},{"label":"Dez","value":509}];
const MX = 839;
