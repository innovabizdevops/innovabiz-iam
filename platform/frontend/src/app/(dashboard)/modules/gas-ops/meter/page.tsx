...
const PAGE = "Meter";
const KPIS = [{"l":"Total Gas Ops","v":"4.906","t":"+6.5%","d":"up"},{"l":"Meter Ativos","v":"131","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"68.7%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"68","t":"+13.7%","d":"up"}];
const COLS = ["ID","Meter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Ops #001","Gas Ops #002","8.471","3.207","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Ops #002","Gas Ops #003","1.967","3.847","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Ops #003","Gas Ops #004","6.576","6.226","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Ops #004","Gas Ops #005","7.261","5.081","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Ops #005","Gas Ops #001","4.628","5.350","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":843},{"label":"Mar","value":745},{"label":"Abr","value":793},{"label":"Mai","value":496},{"label":"Jun","value":646},{"label":"Jul","value":772},{"label":"Ago","value":872},{"label":"Set","value":679},{"label":"Out","value":698},{"label":"Nov","value":497},{"label":"Dez","value":688}];
const MX = 872;
