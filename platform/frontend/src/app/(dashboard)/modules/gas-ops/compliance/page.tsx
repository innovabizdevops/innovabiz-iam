...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.121","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"4.876","t":"+13.2%","d":"up"},{"l":"Conformidade (%)","v":"85.3%","t":"-5.1%","d":"down"},{"l":"CAPAs Pendentes","v":"2.880","t":"-3.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.644","77.0%","6.449","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.433","70.9%","8.844","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.642","77.8%","4.064","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.232","84.1%","7.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.903","72.5%","3.348","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":905},{"label":"Mar","value":735},{"label":"Abr","value":754},{"label":"Mai","value":890},{"label":"Jun","value":799},{"label":"Jul","value":793},{"label":"Ago","value":755},{"label":"Set","value":681},{"label":"Out","value":813},{"label":"Nov","value":789},{"label":"Dez","value":748}];
const MX = 905;
