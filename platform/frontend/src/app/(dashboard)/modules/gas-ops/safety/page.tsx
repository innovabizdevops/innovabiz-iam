...
const PAGE = "Safety";
const KPIS = [{"l":"Total Gas Ops","v":"1.116","t":"-3.6%","d":"down"},{"l":"Safety Ativos","v":"326","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"91","t":"-2.6%","d":"down"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Ops #001","Gas Ops #002","7.097","5.624","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Ops #002","Gas Ops #003","1.982","3.305","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Ops #003","Gas Ops #004","8.269","343","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Ops #004","Gas Ops #005","2.021","3.656","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Ops #005","Gas Ops #001","3.391","742","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":978},{"label":"Mar","value":1014},{"label":"Abr","value":738},{"label":"Mai","value":821},{"label":"Jun","value":781},{"label":"Jul","value":683},{"label":"Ago","value":875},{"label":"Set","value":696},{"label":"Out","value":726},{"label":"Nov","value":713},{"label":"Dez","value":743}];
const MX = 1014;
