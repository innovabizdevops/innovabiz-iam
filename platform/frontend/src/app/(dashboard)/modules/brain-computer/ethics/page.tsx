...
const PAGE = "Ethics Board";
const KPIS = [{"l":"Teams Ativos","v":"1.656","t":"-2.9%","d":"down"},{"l":"Reuniões/Semana","v":"4534","t":"+17.4%","d":"up"},{"l":"Mensagens/Dia","v":"2206","t":"+12.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.098","t":"+1.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.721","2221","616","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.078","2493","6.777","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.077","1008","8.600","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","209","3357","8.701","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.569","2179","4.235","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":746},{"label":"Mar","value":854},{"label":"Abr","value":803},{"label":"Mai","value":966},{"label":"Jun","value":633},{"label":"Jul","value":932},{"label":"Ago","value":845},{"label":"Set","value":684},{"label":"Out","value":858},{"label":"Nov","value":913},{"label":"Dez","value":901}];
const MX = 966;
