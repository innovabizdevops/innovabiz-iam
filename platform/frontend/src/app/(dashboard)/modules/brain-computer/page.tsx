...
export default function BrainComputerPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Brain Computer</h1><p className="text-sm text-muted-foreground">Brain Computer • iBOS Enterprise</p></div>
