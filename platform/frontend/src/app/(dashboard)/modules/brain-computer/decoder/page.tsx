...
const ACCENT = "#78350f";
const MODULE = "Brain-Computer Interface";
const PAGE = "Decoder Model";
const KPIS = [{"l":"Total Brain Computer","v":"7.785","t":"+5.9%","d":"up"},{"l":"Decoder Model Ativos","v":"7.866","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"82","t":"+3.8%","d":"up"}];
const COLS = ["ID","Decoder Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brain Computer #001","Brain Computer #002","7.897","1.265","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Brain Computer #002","Brain Computer #003","7.881","3.113","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Brain Computer #003","Brain Computer #004","4.250","3.197","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Brain Computer #004","Brain Computer #005","3.090","7.354","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brain Computer #005","Brain Computer #001","7.108","3.012","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":272},{"label":"Fev","value":400},{"label":"Mar","value":350},{"label":"Abr","value":352},{"label":"Mai","value":626},{"label":"Jun","value":623},{"label":"Jul","value":605},{"label":"Ago","value":597},{"label":"Set","value":368},{"label":"Out","value":519},{"label":"Nov","value":568},{"label":"Dez","value":640}];
const MX = 640;
