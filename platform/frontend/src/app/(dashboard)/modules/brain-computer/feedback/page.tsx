...
const PAGE = "Neurofeedback";
const KPIS = [{"l":"Surveys Ativos","v":"6.094","t":"+5.2%","d":"up"},{"l":"Respostas/Semana","v":"4551","t":"+6.0%","d":"up"},{"l":"NPS Médio","v":"65","t":"+10.6%","d":"up"},{"l":"Taxa Resposta (%)","v":"77.9%","t":"+14.5%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.307","60","74.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.874","59","86.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","416","92","90.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","2.324","55","78.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.879","62","74.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":764},{"label":"Mar","value":551},{"label":"Abr","value":429},{"label":"Mai","value":433},{"label":"Jun","value":513},{"label":"Jul","value":639},{"label":"Ago","value":629},{"label":"Set","value":500},{"label":"Out","value":741},{"label":"Nov","value":711},{"label":"Dez","value":435}];
const MX = 764;
