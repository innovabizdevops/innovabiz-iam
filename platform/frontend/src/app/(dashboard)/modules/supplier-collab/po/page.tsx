...
const PAGE = "PO";
const KPIS = [{"l":"Total Supplier Collab","v":"3.665","t":"+10.8%","d":"up"},{"l":"PO Ativos","v":"4.791","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"68","t":"+1.1%","d":"up"}];
const COLS = ["ID","PO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supplier Collab #001","Supplier Collab #002","2.039","2.588","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Supplier Collab #002","Supplier Collab #003","5.342","1.716","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Supplier Collab #003","Supplier Collab #004","4.787","2.806","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Supplier Collab #004","Supplier Collab #005","6.651","5.938","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supplier Collab #005","Supplier Collab #001","1.130","5.485","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":602},{"label":"Mar","value":449},{"label":"Abr","value":275},{"label":"Mai","value":613},{"label":"Jun","value":407},{"label":"Jul","value":540},{"label":"Ago","value":230},{"label":"Set","value":422},{"label":"Out","value":517},{"label":"Nov","value":560},{"label":"Dez","value":627}];
const MX = 627;
