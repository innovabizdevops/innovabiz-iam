...
const KPIS = [
    ...
    { label: "Ativos", value: "4653", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€115K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "968298133", cells: ["SUP-7133", "Supplier Collaboration Item 1", "6/2/2026", "€48 233"], status: "active" as const },
    { id: "968301704", cells: ["SUP-1704", "Supplier Collaboration Item 2", "21/9/2026", "€1804"], status: "pending" as const },
    { id: "968305275", cells: ["SUP-5275", "Supplier Collaboration Item 3", "8/4/2026", "€5375"], status: "completed" as const },
    { id: "968308846", cells: ["SUP-8846", "Supplier Collaboration Item 4", "23/11/2026", "€8946"], status: "warning" as const },
    { id: "968312417", cells: ["SUP-3417", "Supplier Collaboration Item 5", "10/6/2026", "€12 517"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supplier Collaboration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supplier Collaboration</p>
                    </div>
                </div>
