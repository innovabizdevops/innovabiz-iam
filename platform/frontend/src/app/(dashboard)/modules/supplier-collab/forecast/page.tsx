...
const ACCENT = "#0891b2";
const MODULE = "Supplier Collaboration";
const PAGE = "Forecast";
const KPIS = [{"l":"Total Supplier Collab","v":"7.766","t":"+3.0%","d":"up"},{"l":"Forecast Ativos","v":"8.178","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"59","t":"-0.8%","d":"down"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supplier Collab #001","Supplier Collab #002","1.338","276","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Supplier Collab #002","Supplier Collab #003","3.789","3.354","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Supplier Collab #003","Supplier Collab #004","2.561","3.744","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Supplier Collab #004","Supplier Collab #005","5.545","848","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supplier Collab #005","Supplier Collab #001","7.891","1.844","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":986},{"label":"Fev","value":776},{"label":"Mar","value":757},{"label":"Abr","value":992},{"label":"Mai","value":905},{"label":"Jun","value":1009},{"label":"Jul","value":679},{"label":"Ago","value":733},{"label":"Set","value":998},{"label":"Out","value":979},{"label":"Nov","value":1030},{"label":"Dez","value":901}];
const MX = 1030;
