...
const PAGE = "Invoice";
const KPIS = [{"l":"Total Supplier Collab","v":"5.361","t":"+7.8%","d":"up"},{"l":"Invoice Ativos","v":"359","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"67.4%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"59","t":"+1.4%","d":"up"}];
const COLS = ["ID","Invoice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supplier Collab #001","Supplier Collab #002","5.307","2.043","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Supplier Collab #002","Supplier Collab #003","2.079","1.541","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Supplier Collab #003","Supplier Collab #004","4.566","4.902","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Supplier Collab #004","Supplier Collab #005","8.039","2.445","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supplier Collab #005","Supplier Collab #001","8.459","3.134","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":695},{"label":"Mar","value":909},{"label":"Abr","value":819},{"label":"Mai","value":869},{"label":"Jun","value":905},{"label":"Jul","value":904},{"label":"Ago","value":894},{"label":"Set","value":652},{"label":"Out","value":803},{"label":"Nov","value":577},{"label":"Dez","value":868}];
const MX = 909;
