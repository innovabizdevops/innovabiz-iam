...
const ACCENT = "#0e7490";
const MODULE = "Airline Crew Planning";
const PAGE = "Disruption";
const KPIS = [{"l":"Total Airline Crew","v":"4.314","t":"-3.8%","d":"down"},{"l":"Disruption Ativos","v":"8.579","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"59","t":"+13.8%","d":"up"}];
const COLS = ["ID","Disruption","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Crew #001","Airline Crew #002","757","8.105","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Crew #002","Airline Crew #003","8.446","1.993","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Crew #003","Airline Crew #004","5.901","8.860","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Crew #004","Airline Crew #005","6.489","6.380","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Crew #005","Airline Crew #001","9.015","7.681","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":455},{"label":"Mar","value":524},{"label":"Abr","value":551},{"label":"Mai","value":408},{"label":"Jun","value":451},{"label":"Jul","value":558},{"label":"Ago","value":625},{"label":"Set","value":516},{"label":"Out","value":684},{"label":"Nov","value":380},{"label":"Dez","value":438}];
const MX = 684;
