...
const PAGE = "Pairing Build";
const KPIS = [{"l":"Total Airline Crew","v":"7.405","t":"+3.3%","d":"up"},{"l":"Pairing Build Ativos","v":"684","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"89.9%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"92","t":"-0.5%","d":"down"}];
const COLS = ["ID","Pairing Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Crew #001","Airline Crew #002","1.589","2.521","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Crew #002","Airline Crew #003","7.684","7.050","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Crew #003","Airline Crew #004","5.151","6.304","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Crew #004","Airline Crew #005","3.658","4.543","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Crew #005","Airline Crew #001","5.294","2.967","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":772},{"label":"Mar","value":655},{"label":"Abr","value":613},{"label":"Mai","value":722},{"label":"Jun","value":561},{"label":"Jul","value":614},{"label":"Ago","value":747},{"label":"Set","value":790},{"label":"Out","value":504},{"label":"Nov","value":653},{"label":"Dez","value":608}];
const MX = 790;
