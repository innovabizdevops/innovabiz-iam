...
const PAGE = "PDF Accessibility";
const KPIS = [{"l":"Formulários Ativos","v":"7.947","t":"-0.9%","d":"down"},{"l":"Submissões/Dia","v":"3897","t":"+8.5%","d":"up"},{"l":"Documentos Gerados","v":"7.410","t":"+15.7%","d":"up"},{"l":"Templates","v":"8.023","t":"+0.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.155","2026-01-04","3.576","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.007","2026-02-07","972","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.492","2026-02-14","230","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.551","2026-03-06","3.244","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.202","2026-03-24","1.485","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":838},{"label":"Mar","value":726},{"label":"Abr","value":827},{"label":"Mai","value":737},{"label":"Jun","value":487},{"label":"Jul","value":569},{"label":"Ago","value":822},{"label":"Set","value":526},{"label":"Out","value":524},{"label":"Nov","value":721},{"label":"Dez","value":703}];
const MX = 838;
