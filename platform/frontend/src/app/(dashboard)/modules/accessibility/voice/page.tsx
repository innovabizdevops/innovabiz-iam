...
const PAGE = "Voice Navigation";
const KPIS = [{"l":"Total Accessibility","v":"5.490","t":"+2.1%","d":"up"},{"l":"Voice Navigation Ativos","v":"8.870","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"65","t":"+10.7%","d":"up"}];
const COLS = ["ID","Voice Navigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accessibility #001","Accessibility #002","1.108","6.878","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Accessibility #002","Accessibility #003","7.709","2.490","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Accessibility #003","Accessibility #004","6.615","6.970","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Accessibility #004","Accessibility #005","7.771","5.595","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accessibility #005","Accessibility #001","3.312","8.273","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":1004},{"label":"Mar","value":967},{"label":"Abr","value":1037},{"label":"Mai","value":723},{"label":"Jun","value":905},{"label":"Jul","value":661},{"label":"Ago","value":890},{"label":"Set","value":653},{"label":"Out","value":792},{"label":"Nov","value":754},{"label":"Dez","value":672}];
const MX = 1037;
