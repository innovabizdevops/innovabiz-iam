...
const PAGE = "Screen Reader Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.377","t":"+9.0%","d":"up"},{"l":"NC Abertas","v":"8.571","t":"+12.4%","d":"up"},{"l":"Conformidade (%)","v":"94.6%","t":"+9.0%","d":"up"},{"l":"CAPAs Pendentes","v":"1.419","t":"-4.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.344","92.4%","1.433","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","212","78.0%","2.543","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.211","92.3%","2.791","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.926","88.9%","4.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.194","98.4%","824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":405},{"label":"Mar","value":522},{"label":"Abr","value":502},{"label":"Mai","value":673},{"label":"Jun","value":599},{"label":"Jul","value":590},{"label":"Ago","value":693},{"label":"Set","value":617},{"label":"Out","value":664},{"label":"Nov","value":457},{"label":"Dez","value":465}];
const MX = 693;
