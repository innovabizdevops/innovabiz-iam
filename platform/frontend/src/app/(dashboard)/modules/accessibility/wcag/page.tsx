...
const PAGE = "WCAG Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.691","t":"-3.5%","d":"down"},{"l":"NC Abertas","v":"8.849","t":"+2.6%","d":"up"},{"l":"Conformidade (%)","v":"80.3%","t":"+6.4%","d":"up"},{"l":"CAPAs Pendentes","v":"4.895","t":"+17.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.229","93.0%","6.044","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.852","76.2%","5.350","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.366","97.4%","3.764","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.456","96.0%","3.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.642","96.3%","5.300","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":839},{"label":"Mar","value":528},{"label":"Abr","value":881},{"label":"Mai","value":609},{"label":"Jun","value":632},{"label":"Jul","value":773},{"label":"Ago","value":640},{"label":"Set","value":758},{"label":"Out","value":772},{"label":"Nov","value":903},{"label":"Dez","value":590}];
const MX = 903;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>WCAG</span></h1>
                </div>
