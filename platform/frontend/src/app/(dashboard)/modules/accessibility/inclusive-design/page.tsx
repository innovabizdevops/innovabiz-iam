...
const PAGE = "Inclusive Design Guide";
const KPIS = [{"l":"Formulários Ativos","v":"7.104","t":"+8.5%","d":"up"},{"l":"Submissões/Dia","v":"2473","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"4.085","t":"+8.6%","d":"up"},{"l":"Templates","v":"4.796","t":"-3.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.242","2026-01-17","2.187","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.762","2026-02-21","6.523","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.192","2026-02-25","3.748","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.272","2026-03-10","1.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.603","2026-02-25","4.313","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":920},{"label":"Mar","value":926},{"label":"Abr","value":902},{"label":"Mai","value":847},{"label":"Jun","value":763},{"label":"Jul","value":872},{"label":"Ago","value":895},{"label":"Set","value":908},{"label":"Out","value":892},{"label":"Nov","value":765},{"label":"Dez","value":690}];
const MX = 1012;
