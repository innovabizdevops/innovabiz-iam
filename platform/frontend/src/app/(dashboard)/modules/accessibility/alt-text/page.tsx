...
const ACCENT = "#0891b2";
const MODULE = "Accessibility & Inclusion";
const PAGE = "Alt-Text Generator AI";
const KPIS = [{"l":"Total Accessibility","v":"1.239","t":"+5.6%","d":"up"},{"l":"Alt Text Generator AI Ativos","v":"2.045","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"81","t":"+11.3%","d":"up"}];
const COLS = ["ID","Alt Text Generator AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accessibility #001","Accessibility #002","5.739","8.651","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Accessibility #002","Accessibility #003","3.658","2.666","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Accessibility #003","Accessibility #004","1.876","2.211","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Accessibility #004","Accessibility #005","4.495","6.477","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accessibility #005","Accessibility #001","6.088","5.942","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":747},{"label":"Mar","value":609},{"label":"Abr","value":554},{"label":"Mai","value":680},{"label":"Jun","value":529},{"label":"Jul","value":622},{"label":"Ago","value":790},{"label":"Set","value":448},{"label":"Out","value":685},{"label":"Nov","value":581},{"label":"Dez","value":519}];
const MX = 790;
