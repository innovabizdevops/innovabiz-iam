...
const PAGE = "RTL Support";
const KPIS = [{"l":"Tickets Abertos","v":"3.281","t":"+17.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.5%","t":"+16.8%","d":"up"},{"l":"MTTR (h)","v":"53h","t":"-0.3%","d":"down"},{"l":"Satisfação (%)","v":"92.8%","t":"+15.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.803","6.759","4.026","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.774","7.708","8.042","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.039","4.940","2.800","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.260","8.198","7.740","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.636","5.763","2.887","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":572},{"label":"Mar","value":846},{"label":"Abr","value":923},{"label":"Mai","value":817},{"label":"Jun","value":641},{"label":"Jul","value":561},{"label":"Ago","value":771},{"label":"Set","value":741},{"label":"Out","value":614},{"label":"Nov","value":662},{"label":"Dez","value":705}];
const MX = 923;
