...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.602","t":"+11.6%","d":"up"},{"l":"NC Abertas","v":"7.582","t":"+1.1%","d":"up"},{"l":"Conformidade (%)","v":"83.6%","t":"+10.1%","d":"up"},{"l":"CAPAs Pendentes","v":"1.639","t":"-0.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.903","97.2%","6.249","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.876","98.7%","1.355","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.584","91.8%","4.309","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.222","88.5%","2.536","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","9.078","77.0%","3.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":638},{"label":"Mar","value":650},{"label":"Abr","value":563},{"label":"Mai","value":564},{"label":"Jun","value":428},{"label":"Jul","value":485},{"label":"Ago","value":635},{"label":"Set","value":360},{"label":"Out","value":419},{"label":"Nov","value":634},{"label":"Dez","value":591}];
const MX = 650;
