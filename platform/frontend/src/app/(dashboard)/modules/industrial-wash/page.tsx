...
/* ═══ Industrial Washing — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "3714", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3524", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€368K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "913555814", cells: ["IND-2814", "Industrial Washing Item 1", "11/3/2026", "€5914"], status: "active" as const },
    { id: "913559385", cells: ["IND-6385", "Industrial Washing Item 2", "26/10/2026", "€9485"], status: "pending" as const },
    { id: "913562956", cells: ["IND-9956", "Industrial Washing Item 3", "13/5/2026", "€13 056"], status: "completed" as const },
    { id: "913566527", cells: ["IND-4527", "Industrial Washing Item 4", "28/12/2026", "€16 627"], status: "warning" as const },
    { id: "913570098", cells: ["IND-8098", "Industrial Washing Item 5", "15/7/2026", "€20 198"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Industrial Washing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Industrial Washing</p>
                    </div>
                </div>
