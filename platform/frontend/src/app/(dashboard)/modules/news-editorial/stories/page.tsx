...
const PAGE = "Story Board";
const KPIS = [{"l":"Integrações Ativas","v":"7.191","t":"+6.2%","d":"up"},{"l":"Chamadas/Hora","v":"108","t":"-2.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"94.3%","t":"-1.7%","d":"down"},{"l":"Latência Média (ms)","v":"74ms","t":"-5.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","176","4.168","74.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.589","4.738","78.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.598","626","94.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","255","1.280","72.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.318","5.157","93.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":228},{"label":"Fev","value":572},{"label":"Mar","value":561},{"label":"Abr","value":251},{"label":"Mai","value":461},{"label":"Jun","value":450},{"label":"Jul","value":294},{"label":"Ago","value":261},{"label":"Set","value":520},{"label":"Out","value":522},{"label":"Nov","value":517},{"label":"Dez","value":338}];
const MX = 572;
