...
export default function NewsEditorialPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">News Editorial</h1><p className="text-sm text-muted-foreground">News Editorial • iBOS Enterprise</p></div>
