...
const PAGE = "Wire Service";
const KPIS = [{"l":"Integrações Ativas","v":"8.610","t":"+12.8%","d":"up"},{"l":"Chamadas/Hora","v":"213","t":"+12.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.1%","t":"-1.3%","d":"down"},{"l":"Latência Média (ms)","v":"68ms","t":"+5.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.556","5.528","78.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.233","4.480","97.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.076","8.893","83.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.079","5.322","84.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.909","7.408","77.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":693},{"label":"Mar","value":659},{"label":"Abr","value":933},{"label":"Mai","value":943},{"label":"Jun","value":954},{"label":"Jul","value":744},{"label":"Ago","value":803},{"label":"Set","value":908},{"label":"Out","value":884},{"label":"Nov","value":872},{"label":"Dez","value":760}];
const MX = 954;
