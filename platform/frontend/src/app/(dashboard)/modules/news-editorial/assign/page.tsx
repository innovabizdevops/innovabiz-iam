...
const KPIS = [{"l":"Integrações Ativas","v":"1.982","t":"+0.7%","d":"up"},{"l":"Chamadas/Hora","v":"968","t":"+11.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.0%","t":"+4.6%","d":"up"},{"l":"Latência Média (ms)","v":"26ms","t":"+10.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","229","3.774","84.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.166","1.465","73.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.520","7.304","94.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.842","6.972","99.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.898","422","98.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":858},{"label":"Mar","value":971},{"label":"Abr","value":763},{"label":"Mai","value":693},{"label":"Jun","value":964},{"label":"Jul","value":670},{"label":"Ago","value":902},{"label":"Set","value":870},{"label":"Out","value":868},{"label":"Nov","value":947},{"label":"Dez","value":764}];
const MX = 971;
