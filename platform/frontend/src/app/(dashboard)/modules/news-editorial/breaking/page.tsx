...
const ACCENT = "#be123c";
const MODULE = "News Editorial";
const PAGE = "Breaking News";
const KPIS = [{"l":"Integrações Ativas","v":"6.275","t":"-5.7%","d":"down"},{"l":"Chamadas/Hora","v":"4681","t":"+14.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.3%","t":"+2.3%","d":"up"},{"l":"Latência Média (ms)","v":"110ms","t":"-2.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.240","628","94.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.917","805","94.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.801","9.038","83.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.236","5.772","96.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.082","3.381","71.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":389},{"label":"Mar","value":680},{"label":"Abr","value":517},{"label":"Mai","value":486},{"label":"Jun","value":613},{"label":"Jul","value":391},{"label":"Ago","value":416},{"label":"Set","value":328},{"label":"Out","value":344},{"label":"Nov","value":430},{"label":"Dez","value":335}];
const MX = 680;
