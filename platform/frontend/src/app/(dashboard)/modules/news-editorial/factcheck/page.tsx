...
const PAGE = "Fact Check";
const KPIS = [{"l":"Integrações Ativas","v":"8.881","t":"+14.7%","d":"up"},{"l":"Chamadas/Hora","v":"140","t":"+4.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.9%","t":"+13.2%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"+9.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.326","4.663","99.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.829","5.925","90.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.134","2.704","82.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.444","7.222","81.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.070","8.068","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":709},{"label":"Mar","value":712},{"label":"Abr","value":648},{"label":"Mai","value":630},{"label":"Jun","value":844},{"label":"Jul","value":731},{"label":"Ago","value":596},{"label":"Set","value":843},{"label":"Out","value":852},{"label":"Nov","value":832},{"label":"Dez","value":823}];
const MX = 975;
