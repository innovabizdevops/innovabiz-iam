...
const KPIS = [{"l":"Quartos Ocupados","v":"2.450","t":"-5.0%","d":"down"},{"l":"RevPAR (€)","v":"€70997","t":"+6.1%","d":"up"},{"l":"Ocupação (%)","v":"85.2%","t":"-3.6%","d":"down"},{"l":"Guest Satisfaction","v":"2.235","t":"+9.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.768","2026-01-25","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.991","2026-02-05","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","542","2026-01-14","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.685","2026-03-10","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.803","2026-01-22","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":380},{"label":"Mar","value":358},{"label":"Abr","value":419},{"label":"Mai","value":678},{"label":"Jun","value":324},{"label":"Jul","value":366},{"label":"Ago","value":322},{"label":"Set","value":499},{"label":"Out","value":625},{"label":"Nov","value":667},{"label":"Dez","value":376}];
const MX = 678;
