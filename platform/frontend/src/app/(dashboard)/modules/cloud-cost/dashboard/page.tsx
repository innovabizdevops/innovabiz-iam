...
const PAGE = "Cost Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"6.327","t":"+13.0%","d":"up"},{"l":"Reuniões/Semana","v":"1324","t":"+6.7%","d":"up"},{"l":"Mensagens/Dia","v":"783","t":"+15.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.705","t":"+17.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.923","4984","3.714","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.868","1725","5.747","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","829","1047","7.686","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.001","1053","392","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.922","1975","2.554","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":614},{"label":"Mar","value":898},{"label":"Abr","value":878},{"label":"Mai","value":918},{"label":"Jun","value":845},{"label":"Jul","value":895},{"label":"Ago","value":812},{"label":"Set","value":755},{"label":"Out","value":911},{"label":"Nov","value":621},{"label":"Dez","value":590}];
const MX = 918;
