...
const ACCENT = "#7c3aed";
const MODULE = "Cloud Cost Management";
const PAGE = "Right-Size";
const KPIS = [{"l":"Total Cloud Cost","v":"7.915","t":"+9.7%","d":"up"},{"l":"Right Size Ativos","v":"3.657","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+7.1%","d":"up"}];
const COLS = ["ID","Right Size","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Cost #001","Cloud Cost #002","592","5.216","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Cost #002","Cloud Cost #003","8.335","5.768","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Cost #003","Cloud Cost #004","592","4.234","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Cost #004","Cloud Cost #005","8.678","6.399","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Cost #005","Cloud Cost #001","1.491","4.766","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":608},{"label":"Mar","value":256},{"label":"Abr","value":529},{"label":"Mai","value":614},{"label":"Jun","value":573},{"label":"Jul","value":284},{"label":"Ago","value":365},{"label":"Set","value":575},{"label":"Out","value":452},{"label":"Nov","value":568},{"label":"Dez","value":292}];
const MX = 614;
...
export default function RightsizePage() {
    return (
