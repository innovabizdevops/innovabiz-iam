...
const PAGE = "Showback";
const KPIS = [{"l":"Total Cloud Cost","v":"8.012","t":"+14.1%","d":"up"},{"l":"Showback Ativos","v":"5.743","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"72","t":"+5.2%","d":"up"}];
const COLS = ["ID","Showback","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Cost #001","Cloud Cost #002","6.374","1.933","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Cost #002","Cloud Cost #003","2.038","7.991","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Cost #003","Cloud Cost #004","5.638","3.549","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Cost #004","Cloud Cost #005","2.884","7.666","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Cost #005","Cloud Cost #001","4.183","7.658","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":988},{"label":"Fev","value":858},{"label":"Mar","value":670},{"label":"Abr","value":698},{"label":"Mai","value":797},{"label":"Jun","value":924},{"label":"Jul","value":655},{"label":"Ago","value":980},{"label":"Set","value":755},{"label":"Out","value":765},{"label":"Nov","value":692},{"label":"Dez","value":736}];
const MX = 988;
