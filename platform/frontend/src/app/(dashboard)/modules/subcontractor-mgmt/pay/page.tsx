...
const PAGE = "Pay";
const KPIS = [{"l":"Contratos Ativos","v":"3.741","t":"+0.3%","d":"up"},{"l":"Valor Total (€M)","v":"€32.3M","t":"+15.9%","d":"up"},{"l":"Renovações Próx. 30d","v":"893","t":"+13.0%","d":"up"},{"l":"Obrigações Pendentes","v":"1.909","t":"+16.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 11621.85","2026-01-02","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 6662.72","2026-02-25","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 41610.48","2026-03-28","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 29489.56","2026-01-24","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 12572.09","2026-03-20","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":459},{"label":"Mar","value":638},{"label":"Abr","value":479},{"label":"Mai","value":563},{"label":"Jun","value":509},{"label":"Jul","value":622},{"label":"Ago","value":443},{"label":"Set","value":695},{"label":"Out","value":734},{"label":"Nov","value":540},{"label":"Dez","value":635}];
const MX = 734;
