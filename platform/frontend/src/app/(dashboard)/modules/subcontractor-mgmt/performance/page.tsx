...
const KPIS = [{"l":"Formulários Ativos","v":"6.195","t":"-1.8%","d":"down"},{"l":"Submissões/Dia","v":"1377","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"3.940","t":"+13.4%","d":"up"},{"l":"Templates","v":"1.495","t":"-3.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.075","2026-01-06","7.636","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.366","2026-01-28","1.125","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.541","2026-03-04","6.341","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.611","2026-02-25","308","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.574","2026-01-28","2.424","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":287},{"label":"Mar","value":286},{"label":"Abr","value":511},{"label":"Mai","value":560},{"label":"Jun","value":296},{"label":"Jul","value":451},{"label":"Ago","value":295},{"label":"Set","value":540},{"label":"Out","value":497},{"label":"Nov","value":297},{"label":"Dez","value":449}];
const MX = 560;
