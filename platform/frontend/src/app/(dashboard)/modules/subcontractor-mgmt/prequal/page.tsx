...
const PAGE = "Pre-Qual";
const KPIS = [{"l":"Contratos Ativos","v":"3.009","t":"+10.1%","d":"up"},{"l":"Valor Total (€M)","v":"€27.8M","t":"-2.7%","d":"down"},{"l":"Renovações Próx. 30d","v":"1.935","t":"-3.0%","d":"down"},{"l":"Obrigações Pendentes","v":"6.864","t":"-4.1%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 30017.51","2026-02-17","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 29432.26","2026-01-21","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 31125.71","2026-02-14","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 49844.88","2026-02-24","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 24262.41","2026-01-28","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":497},{"label":"Mar","value":426},{"label":"Abr","value":559},{"label":"Mai","value":617},{"label":"Jun","value":323},{"label":"Jul","value":610},{"label":"Ago","value":435},{"label":"Set","value":572},{"label":"Out","value":598},{"label":"Nov","value":449},{"label":"Dez","value":578}];
const MX = 617;
