...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"6.164","t":"+10.2%","d":"up"},{"l":"Valor Total (€M)","v":"€47.2M","t":"-5.0%","d":"down"},{"l":"Renovações Próx. 30d","v":"7.492","t":"-1.1%","d":"down"},{"l":"Obrigações Pendentes","v":"7.217","t":"+0.9%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 24214.76","2026-03-01","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 15339.00","2026-02-23","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 35242.33","2026-03-05","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 20220.42","2026-01-17","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 48771.52","2026-03-06","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":542},{"label":"Mar","value":651},{"label":"Abr","value":475},{"label":"Mai","value":783},{"label":"Jun","value":599},{"label":"Jul","value":449},{"label":"Ago","value":823},{"label":"Set","value":481},{"label":"Out","value":592},{"label":"Nov","value":580},{"label":"Dez","value":686}];
const MX = 823;
