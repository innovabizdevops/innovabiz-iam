...
const PAGE = "Release";
const KPIS = [{"l":"Total Quarantine Mgmt","v":"8.782","t":"-0.2%","d":"down"},{"l":"Release Ativos","v":"2.352","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+12.3%","d":"up"}];
const COLS = ["ID","Release","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quarantine Mgmt #001","Quarantine Mgmt #002","5.054","1.258","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Quarantine Mgmt #002","Quarantine Mgmt #003","2.696","4.754","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Quarantine Mgmt #003","Quarantine Mgmt #004","4.907","7.229","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Quarantine Mgmt #004","Quarantine Mgmt #005","6.733","4.565","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quarantine Mgmt #005","Quarantine Mgmt #001","6.380","3.741","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":400},{"label":"Mar","value":429},{"label":"Abr","value":352},{"label":"Mai","value":527},{"label":"Jun","value":417},{"label":"Jul","value":256},{"label":"Ago","value":213},{"label":"Set","value":603},{"label":"Out","value":502},{"label":"Nov","value":335},{"label":"Dez","value":344}];
const MX = 603;
