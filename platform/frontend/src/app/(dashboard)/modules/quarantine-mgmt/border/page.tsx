...
const PAGE = "Border";
const KPIS = [{"l":"Total Quarantine Mgmt","v":"7.232","t":"+12.5%","d":"up"},{"l":"Border Ativos","v":"6.143","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"80","t":"+17.8%","d":"up"}];
const COLS = ["ID","Border","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quarantine Mgmt #001","Quarantine Mgmt #002","1.369","6.639","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Quarantine Mgmt #002","Quarantine Mgmt #003","8.739","887","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Quarantine Mgmt #003","Quarantine Mgmt #004","843","6.144","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Quarantine Mgmt #004","Quarantine Mgmt #005","8.475","1.105","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quarantine Mgmt #005","Quarantine Mgmt #001","6.246","135","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":597},{"label":"Mar","value":480},{"label":"Abr","value":334},{"label":"Mai","value":568},{"label":"Jun","value":474},{"label":"Jul","value":493},{"label":"Ago","value":494},{"label":"Set","value":520},{"label":"Out","value":525},{"label":"Nov","value":568},{"label":"Dez","value":563}];
const MX = 597;
