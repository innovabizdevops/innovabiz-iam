...
const PAGE = "Lab";
const KPIS = [{"l":"Total Quarantine Mgmt","v":"612","t":"-0.1%","d":"down"},{"l":"Lab Ativos","v":"8.439","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"61","t":"-0.2%","d":"down"}];
const COLS = ["ID","Lab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quarantine Mgmt #001","Quarantine Mgmt #002","4.314","5.779","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Quarantine Mgmt #002","Quarantine Mgmt #003","707","4.248","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Quarantine Mgmt #003","Quarantine Mgmt #004","8.916","3.425","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Quarantine Mgmt #004","Quarantine Mgmt #005","8.451","1.711","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quarantine Mgmt #005","Quarantine Mgmt #001","5.637","3.638","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":649},{"label":"Mar","value":538},{"label":"Abr","value":502},{"label":"Mai","value":539},{"label":"Jun","value":542},{"label":"Jul","value":737},{"label":"Ago","value":672},{"label":"Set","value":584},{"label":"Out","value":500},{"label":"Nov","value":758},{"label":"Dez","value":677}];
const MX = 758;
