...
const ACCENT = "#dc2626";
const MODULE = "Quarantine Management";
const PAGE = "Inspect";
const KPIS = [{"l":"Total Quarantine Mgmt","v":"4.653","t":"+12.3%","d":"up"},{"l":"Inspect Ativos","v":"3.157","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"78","t":"+13.4%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quarantine Mgmt #001","Quarantine Mgmt #002","7.275","2.122","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Quarantine Mgmt #002","Quarantine Mgmt #003","5.109","4.312","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Quarantine Mgmt #003","Quarantine Mgmt #004","494","7.777","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Quarantine Mgmt #004","Quarantine Mgmt #005","8.160","8.760","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quarantine Mgmt #005","Quarantine Mgmt #001","1.376","1.183","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":633},{"label":"Mar","value":473},{"label":"Abr","value":653},{"label":"Mai","value":625},{"label":"Jun","value":297},{"label":"Jul","value":339},{"label":"Ago","value":463},{"label":"Set","value":380},{"label":"Out","value":652},{"label":"Nov","value":269},{"label":"Dez","value":596}];
const MX = 653;
