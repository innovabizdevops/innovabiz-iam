...
const KPIS = [
    { label: "Total Registos", value: "9539", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4172", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€291K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "643172839", cells: ["QUA-6839", "Quarantine Management Item 1", "16/8/2026", "€22 939"], status: "active" as const },
    { id: "643176410", cells: ["QUA-1410", "Quarantine Management Item 2", "3/3/2026", "€26 510"], status: "pending" as const },
    { id: "643179981", cells: ["QUA-4981", "Quarantine Management Item 3", "18/10/2026", "€30 081"], status: "completed" as const },
    { id: "643183552", cells: ["QUA-8552", "Quarantine Management Item 4", "5/5/2026", "€33 652"], status: "warning" as const },
    { id: "643187123", cells: ["QUA-3123", "Quarantine Management Item 5", "20/12/2026", "€37 223"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quarantine Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Quarantine Management</p>
                    </div>
                </div>
