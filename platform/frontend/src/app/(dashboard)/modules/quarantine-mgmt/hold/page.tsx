...
const PAGE = "Hold";
const KPIS = [{"l":"Total Quarantine Mgmt","v":"2.985","t":"+4.4%","d":"up"},{"l":"Hold Ativos","v":"6.058","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"68","t":"+11.5%","d":"up"}];
const COLS = ["ID","Hold","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quarantine Mgmt #001","Quarantine Mgmt #002","5.050","7.848","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Quarantine Mgmt #002","Quarantine Mgmt #003","8.796","8.572","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Quarantine Mgmt #003","Quarantine Mgmt #004","3.767","7.137","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Quarantine Mgmt #004","Quarantine Mgmt #005","5.285","117","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quarantine Mgmt #005","Quarantine Mgmt #001","920","3.600","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":541},{"label":"Mar","value":640},{"label":"Abr","value":396},{"label":"Mai","value":488},{"label":"Jun","value":587},{"label":"Jul","value":377},{"label":"Ago","value":683},{"label":"Set","value":487},{"label":"Out","value":308},{"label":"Nov","value":603},{"label":"Dez","value":607}];
const MX = 683;
