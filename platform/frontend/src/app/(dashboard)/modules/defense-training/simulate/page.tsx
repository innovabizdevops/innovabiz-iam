...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"184","t":"-3.6%","d":"down"},{"l":"Simulações/Dia","v":"3314","t":"+6.7%","d":"up"},{"l":"Precisão Modelo (%)","v":"77.3%","t":"+15.0%","d":"up"},{"l":"Latência Sync (ms)","v":"104ms","t":"+7.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","72.3%","2026-03-03","419","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","93.9%","2026-03-10","4.468","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","79.5%","2026-03-14","838","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","98.2%","2026-03-28","994","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","88.0%","2026-03-10","2.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":772},{"label":"Mar","value":825},{"label":"Abr","value":883},{"label":"Mai","value":900},{"label":"Jun","value":845},{"label":"Jul","value":675},{"label":"Ago","value":656},{"label":"Set","value":680},{"label":"Out","value":646},{"label":"Nov","value":621},{"label":"Dez","value":916}];
const MX = 916;
