...
const PAGE = "Train";
const KPIS = [{"l":"Total Defense Training","v":"6.087","t":"+1.3%","d":"up"},{"l":"Train Ativos","v":"7.601","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.1%","d":"down"}];
const COLS = ["ID","Train","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Training #001","Defense Training #002","2.588","8.027","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Training #002","Defense Training #003","8.633","5.010","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Training #003","Defense Training #004","5.685","5.663","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Training #004","Defense Training #005","4.293","475","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Training #005","Defense Training #001","3.703","1.568","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":641},{"label":"Mar","value":546},{"label":"Abr","value":741},{"label":"Mai","value":796},{"label":"Jun","value":689},{"label":"Jul","value":697},{"label":"Ago","value":902},{"label":"Set","value":765},{"label":"Out","value":926},{"label":"Nov","value":548},{"label":"Dez","value":801}];
const MX = 926;
