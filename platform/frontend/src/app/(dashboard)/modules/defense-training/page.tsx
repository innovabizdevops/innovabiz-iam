...
/* ═══ Defense Training & Simulation — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "1434", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1151", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€289K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "543729134", cells: ["DEF-4134", "Defense Training & Simulation Item 1", "19/3/2026", "€29 234"], status: "active" as const },
    { id: "543732705", cells: ["DEF-7705", "Defense Training & Simulation Item 2", "6/10/2026", "€32 805"], status: "pending" as const },
    { id: "543736276", cells: ["DEF-2276", "Defense Training & Simulation Item 3", "21/5/2026", "€36 376"], status: "completed" as const },
    { id: "543739847", cells: ["DEF-5847", "Defense Training & Simulation Item 4", "8/12/2026", "€39 947"], status: "warning" as const },
    { id: "543743418", cells: ["DEF-9418", "Defense Training & Simulation Item 5", "23/7/2026", "€43 518"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 34 }, { label: "Fev", value: 43 }, { label: "Mar", value: 52 }, { label: "Abr", value: 61 }, { label: "Mai", value: 70 }, { label: "Jun", value: 79 }];
...
export default function DefenseTrainingSimulationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Defense Training & Simulation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Defense Training & Simulation</p>
                    </div>
                </div>
