...
const ACCENT = "#1e3a5f";
const MODULE = "Defense Training & Simulation";
const PAGE = "After Action";
const KPIS = [{"l":"Total Defense Training","v":"758","t":"+4.7%","d":"up"},{"l":"After Action Ativos","v":"2.590","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"79.7%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"65","t":"-2.7%","d":"down"}];
const COLS = ["ID","After Action","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Training #001","Defense Training #002","3.502","2.883","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Training #002","Defense Training #003","7.098","2.008","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Training #003","Defense Training #004","2.674","4.471","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Training #004","Defense Training #005","8.719","3.891","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Training #005","Defense Training #001","1.096","9.094","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":720},{"label":"Mar","value":853},{"label":"Abr","value":977},{"label":"Mai","value":633},{"label":"Jun","value":620},{"label":"Jul","value":874},{"label":"Ago","value":743},{"label":"Set","value":642},{"label":"Out","value":968},{"label":"Nov","value":834},{"label":"Dez","value":930}];
const MX = 977;
