...
const KPIS = [{"l":"Total Legal Case","v":"7.360","t":"+14.4%","d":"up"},{"l":"Conflict Check Ativos","v":"4.401","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"65","t":"+5.6%","d":"up"}];
const COLS = ["ID","Conflict Check","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Case #001","2026-02-04","2.631","2.533","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Case #002","2026-03-23","6.786","6.295","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Case #003","2026-02-07","2.174","2.721","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Case #004","2026-02-14","7.591","503","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Case #005","2026-01-08","8.426","8.177","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":424},{"label":"Mar","value":269},{"label":"Abr","value":542},{"label":"Mai","value":327},{"label":"Jun","value":354},{"label":"Jul","value":662},{"label":"Ago","value":614},{"label":"Set","value":662},{"label":"Out","value":316},{"label":"Nov","value":303},{"label":"Dez","value":596}];
const MX = 662;
