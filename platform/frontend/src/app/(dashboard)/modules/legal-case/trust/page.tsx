...
const PAGE = "Trust Account";
const KPIS = [{"l":"Total Legal Case","v":"6.868","t":"+0.3%","d":"up"},{"l":"Trust Account Ativos","v":"5.430","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"88.8%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+3.3%","d":"up"}];
const COLS = ["ID","Trust Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Case #001","Legal Case #002","2.194","7.509","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Case #002","Legal Case #003","2.073","1.254","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Case #003","Legal Case #004","4.476","906","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Case #004","Legal Case #005","1.236","252","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Case #005","Legal Case #001","8.472","486","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":893},{"label":"Mar","value":691},{"label":"Abr","value":914},{"label":"Mai","value":823},{"label":"Jun","value":771},{"label":"Jul","value":866},{"label":"Ago","value":1025},{"label":"Set","value":990},{"label":"Out","value":874},{"label":"Nov","value":876},{"label":"Dez","value":799}];
const MX = 1025;
