...
const PAGE = "Deadline Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.576","t":"+13.6%","d":"up"},{"l":"Taxa Entrega (%)","v":"92.9%","t":"+9.2%","d":"up"},{"l":"Taxa Abertura (%)","v":"67.5%","t":"-2.6%","d":"down"},{"l":"Escalações","v":"2.052","t":"+3.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.240","93.9%","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.101","78.9%","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.430","96.4%","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","514","80.3%","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.772","73.8%","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":633},{"label":"Mar","value":539},{"label":"Abr","value":641},{"label":"Mai","value":579},{"label":"Jun","value":434},{"label":"Jul","value":765},{"label":"Ago","value":500},{"label":"Set","value":470},{"label":"Out","value":448},{"label":"Nov","value":602},{"label":"Dez","value":539}];
const MX = 765;
