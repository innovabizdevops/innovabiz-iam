...
const PAGE = "Case Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"8.467","t":"-3.1%","d":"down"},{"l":"Reuniões/Semana","v":"327","t":"+13.0%","d":"up"},{"l":"Mensagens/Dia","v":"2854","t":"-0.8%","d":"down"},{"l":"Ficheiros Partilhados","v":"5.936","t":"-2.2%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.234","279","7.218","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.129","2002","5.286","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","558","1040","7.651","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.307","3465","5.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.205","3662","1.457","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":909},{"label":"Mar","value":708},{"label":"Abr","value":773},{"label":"Mai","value":653},{"label":"Jun","value":886},{"label":"Jul","value":721},{"label":"Ago","value":713},{"label":"Set","value":736},{"label":"Out","value":853},{"label":"Nov","value":627},{"label":"Dez","value":792}];
const MX = 925;
