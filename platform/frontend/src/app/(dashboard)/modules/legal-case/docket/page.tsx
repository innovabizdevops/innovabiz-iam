...
const ACCENT = "#475569";
const MODULE = "Legal Case Management";
const PAGE = "Docket Track";
const KPIS = [{"l":"Total Legal Case","v":"5.652","t":"+2.6%","d":"up"},{"l":"Docket Track Ativos","v":"1.818","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"62","t":"-4.9%","d":"down"}];
const COLS = ["ID","Docket Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Case #001","Legal Case #002","5.668","770","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Case #002","Legal Case #003","2.603","6.914","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Case #003","Legal Case #004","3.941","6.424","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Case #004","Legal Case #005","1.496","7.219","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Case #005","Legal Case #001","7.295","7.132","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":666},{"label":"Mar","value":573},{"label":"Abr","value":421},{"label":"Mai","value":724},{"label":"Jun","value":686},{"label":"Jul","value":716},{"label":"Ago","value":464},{"label":"Set","value":793},{"label":"Out","value":496},{"label":"Nov","value":553},{"label":"Dez","value":553}];
const MX = 793;
