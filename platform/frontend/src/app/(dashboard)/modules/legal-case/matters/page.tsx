...
const PAGE = "Matter Mgmt";
const KPIS = [{"l":"Total Legal Case","v":"1.983","t":"+5.0%","d":"up"},{"l":"Matter Mgmt Ativos","v":"2.997","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"75","t":"+16.6%","d":"up"}];
const COLS = ["ID","Matter Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Case #001","Legal Case #002","1.431","6.995","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Case #002","Legal Case #003","6.922","8.658","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Case #003","Legal Case #004","7.690","1.259","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Case #004","Legal Case #005","1.202","610","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Case #005","Legal Case #001","8.744","2.794","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":344},{"label":"Mar","value":366},{"label":"Abr","value":352},{"label":"Mai","value":314},{"label":"Jun","value":483},{"label":"Jul","value":481},{"label":"Ago","value":612},{"label":"Set","value":422},{"label":"Out","value":587},{"label":"Nov","value":464},{"label":"Dez","value":409}];
const MX = 638;
