...
const PAGE = "Archive";
const KPIS = [{"l":"Formulários Ativos","v":"3.403","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"4112","t":"+4.9%","d":"up"},{"l":"Documentos Gerados","v":"2.958","t":"+3.7%","d":"up"},{"l":"Templates","v":"7.115","t":"+15.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.988","2026-03-03","2.528","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.190","2026-02-15","4.934","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.794","2026-02-03","7.247","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.399","2026-01-22","2.351","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.263","2026-03-27","3.102","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":727},{"label":"Mar","value":704},{"label":"Abr","value":657},{"label":"Mai","value":837},{"label":"Jun","value":862},{"label":"Jul","value":722},{"label":"Ago","value":633},{"label":"Set","value":739},{"label":"Out","value":664},{"label":"Nov","value":802},{"label":"Dez","value":858}];
const MX = 862;
