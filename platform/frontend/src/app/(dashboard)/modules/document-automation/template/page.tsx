...
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"6.673","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"1373","t":"+8.9%","d":"up"},{"l":"Documentos Gerados","v":"6.826","t":"+16.4%","d":"up"},{"l":"Templates","v":"6.006","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.509","2026-02-02","6.606","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","537","2026-03-26","4.811","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.206","2026-01-07","8.049","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.218","2026-01-25","4.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.583","2026-03-07","324","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":434},{"label":"Mar","value":707},{"label":"Abr","value":468},{"label":"Mai","value":737},{"label":"Jun","value":476},{"label":"Jul","value":633},{"label":"Ago","value":560},{"label":"Set","value":394},{"label":"Out","value":674},{"label":"Nov","value":412},{"label":"Dez","value":528}];
const MX = 737;
