...
const PAGE = "Route";
const KPIS = [{"l":"Formulários Ativos","v":"4.426","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"3338","t":"+5.4%","d":"up"},{"l":"Documentos Gerados","v":"360","t":"-2.6%","d":"down"},{"l":"Templates","v":"1.329","t":"+11.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.960","2026-01-18","1.701","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.899","2026-01-26","7.509","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.562","2026-01-15","1.697","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.490","2026-03-27","5.820","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","747","2026-02-12","8.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":805},{"label":"Mar","value":828},{"label":"Abr","value":877},{"label":"Mai","value":662},{"label":"Jun","value":971},{"label":"Jul","value":913},{"label":"Ago","value":731},{"label":"Set","value":722},{"label":"Out","value":993},{"label":"Nov","value":770},{"label":"Dez","value":853}];
const MX = 993;
