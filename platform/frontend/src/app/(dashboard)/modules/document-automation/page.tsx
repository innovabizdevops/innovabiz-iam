...
const KPIS = [
    { label: "Total Registos", value: "200", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4674", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€276K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "551717200", cells: ["DOC-9200", "Document Automation Item 1", "21/5/2026", "€17 300"], status: "active" as const },
    { id: "551720771", cells: ["DOC-3771", "Document Automation Item 2", "8/12/2026", "€20 871"], status: "pending" as const },
    { id: "551724342", cells: ["DOC-7342", "Document Automation Item 3", "23/7/2026", "€24 442"], status: "completed" as const },
    { id: "551727913", cells: ["DOC-1913", "Document Automation Item 4", "10/2/2026", "€28 013"], status: "warning" as const },
    { id: "551731484", cells: ["DOC-5484", "Document Automation Item 5", "25/9/2026", "€31 584"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Document Automation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Document Automation</p>
                    </div>
                </div>
