...
const ACCENT = "#06b6d4";
const MODULE = "Document Automation";
const PAGE = "Merge";
const KPIS = [{"l":"Formulários Ativos","v":"6.444","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"4711","t":"+12.2%","d":"up"},{"l":"Documentos Gerados","v":"4.033","t":"-5.3%","d":"down"},{"l":"Templates","v":"4.355","t":"-4.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.182","2026-01-21","1.021","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.457","2026-03-28","1.505","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.378","2026-02-28","4.180","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.691","2026-03-10","6.000","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.261","2026-01-16","3.492","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":889},{"label":"Mar","value":832},{"label":"Abr","value":695},{"label":"Mai","value":767},{"label":"Jun","value":544},{"label":"Jul","value":733},{"label":"Ago","value":853},{"label":"Set","value":627},{"label":"Out","value":814},{"label":"Nov","value":903},{"label":"Dez","value":723}];
const MX = 903;
