...
const PAGE = "Sign";
const KPIS = [{"l":"Formulários Ativos","v":"3.411","t":"+10.3%","d":"up"},{"l":"Submissões/Dia","v":"4473","t":"-1.6%","d":"down"},{"l":"Documentos Gerados","v":"7.157","t":"+10.5%","d":"up"},{"l":"Templates","v":"4.265","t":"+9.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","436","2026-03-13","3.510","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.632","2026-03-08","8.352","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.423","2026-02-16","1.814","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.829","2026-03-04","179","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.811","2026-03-13","7.529","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":965},{"label":"Mar","value":738},{"label":"Abr","value":801},{"label":"Mai","value":767},{"label":"Jun","value":1008},{"label":"Jul","value":703},{"label":"Ago","value":953},{"label":"Set","value":930},{"label":"Out","value":856},{"label":"Nov","value":780},{"label":"Dez","value":765}];
const MX = 1008;
