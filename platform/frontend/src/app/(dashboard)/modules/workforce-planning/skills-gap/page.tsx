...
const KPIS = [{"l":"eNPS","v":"87","t":"-4.8%","d":"down"},{"l":"Engagement (%)","v":"94.5%","t":"-1.8%","d":"down"},{"l":"Turnover (%)","v":"78.3%","t":"+14.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.610","t":"+9.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.108","2026-02-06","77","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.467","2026-03-01","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.244","2026-01-09","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.339","2026-03-07","61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.930","2026-01-02","72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":722},{"label":"Mar","value":670},{"label":"Abr","value":756},{"label":"Mai","value":795},{"label":"Jun","value":855},{"label":"Jul","value":768},{"label":"Ago","value":912},{"label":"Set","value":805},{"label":"Out","value":718},{"label":"Nov","value":978},{"label":"Dez","value":869}];
const MX = 996;
