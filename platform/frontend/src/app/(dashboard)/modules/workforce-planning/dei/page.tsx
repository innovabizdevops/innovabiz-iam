...
const KPIS = [{"l":"eNPS","v":"71","t":"+9.2%","d":"up"},{"l":"Engagement (%)","v":"84.7%","t":"+17.4%","d":"up"},{"l":"Turnover (%)","v":"89.4%","t":"+16.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.972","t":"+1.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.216","2026-02-11","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.643","2026-03-21","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","136","2026-02-08","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.568","2026-03-17","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.094","2026-02-06","73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":296},{"label":"Fev","value":414},{"label":"Mar","value":424},{"label":"Abr","value":300},{"label":"Mai","value":376},{"label":"Jun","value":569},{"label":"Jul","value":545},{"label":"Ago","value":246},{"label":"Set","value":564},{"label":"Out","value":274},{"label":"Nov","value":586},{"label":"Dez","value":354}];
const MX = 586;
