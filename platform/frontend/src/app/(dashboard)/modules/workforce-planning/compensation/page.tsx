...
const PAGE = "Compensation Bench";
const KPIS = [{"l":"eNPS","v":"57","t":"+8.6%","d":"up"},{"l":"Engagement (%)","v":"79.4%","t":"+11.7%","d":"up"},{"l":"Turnover (%)","v":"92.0%","t":"+17.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.825","t":"+1.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.846","2026-03-10","63","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.803","2026-01-16","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.496","2026-02-12","93","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.651","2026-03-20","68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.664","2026-02-17","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":476},{"label":"Mar","value":795},{"label":"Abr","value":497},{"label":"Mai","value":648},{"label":"Jun","value":715},{"label":"Jul","value":837},{"label":"Ago","value":600},{"label":"Set","value":578},{"label":"Out","value":464},{"label":"Nov","value":664},{"label":"Dez","value":691}];
const MX = 837;
