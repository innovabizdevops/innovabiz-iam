...
const PAGE = "Scenario Planning AI";
const KPIS = [{"l":"eNPS","v":"65","t":"+3.8%","d":"up"},{"l":"Engagement (%)","v":"74.8%","t":"-3.4%","d":"down"},{"l":"Turnover (%)","v":"90.1%","t":"+16.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.095","t":"+8.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.805","2026-03-16","59","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.142","2026-02-06","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.871","2026-02-06","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.808","2026-03-06","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.219","2026-03-03","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":1013},{"label":"Mar","value":724},{"label":"Abr","value":916},{"label":"Mai","value":1050},{"label":"Jun","value":716},{"label":"Jul","value":940},{"label":"Ago","value":708},{"label":"Set","value":733},{"label":"Out","value":874},{"label":"Nov","value":750},{"label":"Dez","value":825}];
const MX = 1050;
