...
const PAGE = "Career Pathing";
const KPIS = [{"l":"eNPS","v":"60","t":"-3.6%","d":"down"},{"l":"Engagement (%)","v":"68.6%","t":"-0.8%","d":"down"},{"l":"Turnover (%)","v":"83.1%","t":"+1.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.972","t":"-1.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.203","2026-01-26","82","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.003","2026-01-02","59","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.100","2026-03-04","83","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.706","2026-03-16","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.829","2026-02-05","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":955},{"label":"Mar","value":904},{"label":"Abr","value":636},{"label":"Mai","value":755},{"label":"Jun","value":882},{"label":"Jul","value":686},{"label":"Ago","value":817},{"label":"Set","value":803},{"label":"Out","value":789},{"label":"Nov","value":770},{"label":"Dez","value":605}];
const MX = 955;
