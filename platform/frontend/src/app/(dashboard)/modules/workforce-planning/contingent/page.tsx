...
const PAGE = "Contingent Workforce";
const KPIS = [{"l":"eNPS","v":"75","t":"+2.8%","d":"up"},{"l":"Engagement (%)","v":"86.1%","t":"+10.1%","d":"up"},{"l":"Turnover (%)","v":"67.5%","t":"+4.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.798","t":"+0.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.970","2026-01-13","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.543","2026-02-18","89","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.278","2026-01-26","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.320","2026-01-15","61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.038","2026-02-18","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":446},{"label":"Mar","value":617},{"label":"Abr","value":555},{"label":"Mai","value":470},{"label":"Jun","value":710},{"label":"Jul","value":407},{"label":"Ago","value":698},{"label":"Set","value":586},{"label":"Out","value":522},{"label":"Nov","value":533},{"label":"Dez","value":488}];
const MX = 710;
