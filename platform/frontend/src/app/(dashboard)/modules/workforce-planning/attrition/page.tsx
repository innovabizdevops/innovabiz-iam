...
const PAGE = "Attrition Forecast";
const KPIS = [{"l":"eNPS","v":"58","t":"-3.2%","d":"down"},{"l":"Engagement (%)","v":"80.1%","t":"+17.8%","d":"up"},{"l":"Turnover (%)","v":"78.8%","t":"-0.6%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.544","t":"-2.1%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.853","2026-03-02","76","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.083","2026-03-17","81","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","257","2026-02-08","75","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.348","2026-03-28","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.445","2026-01-02","67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":769},{"label":"Mar","value":627},{"label":"Abr","value":915},{"label":"Mai","value":638},{"label":"Jun","value":626},{"label":"Jul","value":932},{"label":"Ago","value":621},{"label":"Set","value":757},{"label":"Out","value":616},{"label":"Nov","value":662},{"label":"Dez","value":955}];
const MX = 955;
