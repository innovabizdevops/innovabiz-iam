...
const PAGE = "Headcount Model";
const KPIS = [{"l":"eNPS","v":"85","t":"+15.9%","d":"up"},{"l":"Engagement (%)","v":"93.5%","t":"+10.6%","d":"up"},{"l":"Turnover (%)","v":"91.6%","t":"+1.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.300","t":"+0.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.898","2026-03-22","58","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","462","2026-01-13","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.304","2026-02-11","92","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.208","2026-02-06","59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.185","2026-01-17","91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":692},{"label":"Mar","value":701},{"label":"Abr","value":692},{"label":"Mai","value":695},{"label":"Jun","value":999},{"label":"Jul","value":674},{"label":"Ago","value":1034},{"label":"Set","value":913},{"label":"Out","value":665},{"label":"Nov","value":864},{"label":"Dez","value":860}];
const MX = 1034;
