...
const KPIS = [{"l":"eNPS","v":"56","t":"+1.0%","d":"up"},{"l":"Engagement (%)","v":"73.7%","t":"+9.4%","d":"up"},{"l":"Turnover (%)","v":"82.6%","t":"+3.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.005","t":"-1.5%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.833","2026-01-28","58","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.784","2026-03-18","72","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","329","2026-02-19","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.522","2026-02-09","61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.422","2026-01-08","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":522},{"label":"Mar","value":554},{"label":"Abr","value":459},{"label":"Mai","value":536},{"label":"Jun","value":385},{"label":"Jul","value":517},{"label":"Ago","value":549},{"label":"Set","value":610},{"label":"Out","value":662},{"label":"Nov","value":677},{"label":"Dez","value":437}];
const MX = 677;
