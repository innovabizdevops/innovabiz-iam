...
const PAGE = "Outcome";
const KPIS = [{"l":"Dashboards Ativos","v":"5.365","t":"+11.1%","d":"up"},{"l":"Queries/Dia","v":"2002","t":"+12.8%","d":"up"},{"l":"Dados Processados (GB)","v":"779","t":"-3.0%","d":"down"},{"l":"Utilizadores Analytics","v":"3.622","t":"+14.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2738","2026-01-22","8.283","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4492","2026-02-13","6.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1789","2026-01-15","2.159","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3243","2026-03-03","1.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3420","2026-03-15","6.181","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":510},{"label":"Mar","value":712},{"label":"Abr","value":466},{"label":"Mai","value":831},{"label":"Jun","value":748},{"label":"Jul","value":500},{"label":"Ago","value":638},{"label":"Set","value":509},{"label":"Out","value":535},{"label":"Nov","value":713},{"label":"Dez","value":623}];
const MX = 831;
