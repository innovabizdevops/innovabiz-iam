...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"2.959","t":"+2.5%","d":"up"},{"l":"Queries/Dia","v":"4197","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.215","t":"+14.4%","d":"up"},{"l":"Utilizadores Analytics","v":"654","t":"+4.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2103","2026-03-14","1.345","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1680","2026-02-12","8.343","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1660","2026-02-27","333","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2418","2026-03-02","3.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4486","2026-01-02","3.872","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":585},{"label":"Mar","value":846},{"label":"Abr","value":901},{"label":"Mai","value":937},{"label":"Jun","value":683},{"label":"Jul","value":652},{"label":"Ago","value":687},{"label":"Set","value":890},{"label":"Out","value":632},{"label":"Nov","value":749},{"label":"Dez","value":586}];
const MX = 937;
