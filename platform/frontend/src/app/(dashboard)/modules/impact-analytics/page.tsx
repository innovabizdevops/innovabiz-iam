...
const KPIS = [
    { label: "Total Registos", value: "3870", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1298", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€136K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1542265370", cells: ["IMP-8370", "Impact Analytics Item 1", "3/3/2026", "€15 470"], status: "active" as const },
    { id: "1542268941", cells: ["IMP-2941", "Impact Analytics Item 2", "18/10/2026", "€19 041"], status: "pending" as const },
    { id: "1542272512", cells: ["IMP-6512", "Impact Analytics Item 3", "5/5/2026", "€22 612"], status: "completed" as const },
    { id: "1542276083", cells: ["IMP-1083", "Impact Analytics Item 4", "20/12/2026", "€26 183"], status: "warning" as const },
    { id: "1542279654", cells: ["IMP-4654", "Impact Analytics Item 5", "7/7/2026", "€29 754"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Impact Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Impact Analytics</p>
                    </div>
                </div>
