...
const PAGE = "Social ROI";
const KPIS = [{"l":"Dashboards Ativos","v":"8.591","t":"+14.7%","d":"up"},{"l":"Queries/Dia","v":"4936","t":"+3.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.068","t":"-3.2%","d":"down"},{"l":"Utilizadores Analytics","v":"4.114","t":"+0.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1786","2026-01-25","1.556","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","610","2026-01-17","5.635","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2273","2026-02-10","6.011","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3079","2026-03-09","8.467","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1434","2026-01-18","7.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":581},{"label":"Mar","value":728},{"label":"Abr","value":805},{"label":"Mai","value":805},{"label":"Jun","value":682},{"label":"Jul","value":599},{"label":"Ago","value":769},{"label":"Set","value":578},{"label":"Out","value":532},{"label":"Nov","value":627},{"label":"Dez","value":757}];
const MX = 805;
