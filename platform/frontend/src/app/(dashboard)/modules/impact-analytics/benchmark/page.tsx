...
const KPIS = [{"l":"Dashboards Ativos","v":"8.210","t":"+16.7%","d":"up"},{"l":"Queries/Dia","v":"3983","t":"+7.1%","d":"up"},{"l":"Dados Processados (GB)","v":"6.242","t":"-5.9%","d":"down"},{"l":"Utilizadores Analytics","v":"7.292","t":"+11.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4333","2026-02-09","4.047","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","100","2026-02-05","5.793","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4981","2026-01-09","2.569","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3267","2026-01-07","1.512","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4606","2026-01-01","952","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":948},{"label":"Mar","value":815},{"label":"Abr","value":845},{"label":"Mai","value":936},{"label":"Jun","value":763},{"label":"Jul","value":995},{"label":"Ago","value":1026},{"label":"Set","value":657},{"label":"Out","value":765},{"label":"Nov","value":885},{"label":"Dez","value":1027}];
const MX = 1027;
