...
const ACCENT = "#9d174d";
const MODULE = "Impact Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.348","t":"+12.2%","d":"up"},{"l":"Queries/Dia","v":"3135","t":"-2.8%","d":"down"},{"l":"Dados Processados (GB)","v":"5.364","t":"+5.2%","d":"up"},{"l":"Utilizadores Analytics","v":"1.956","t":"+8.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1501","2026-02-14","3.014","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4435","2026-03-22","2.512","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1877","2026-02-23","5.250","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5084","2026-02-20","8.655","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1959","2026-01-07","7.968","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":498},{"label":"Mar","value":651},{"label":"Abr","value":461},{"label":"Mai","value":663},{"label":"Jun","value":448},{"label":"Jul","value":727},{"label":"Ago","value":543},{"label":"Set","value":720},{"label":"Out","value":377},{"label":"Nov","value":618},{"label":"Dez","value":508}];
const MX = 727;
