...
const PAGE = "eSIM Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.559","t":"+17.2%","d":"up"},{"l":"Savings (€)","v":"€80340","t":"-0.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"88.1%","t":"+13.4%","d":"up"},{"l":"Ciclos PDCA","v":"6.431","t":"+12.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.544","€ 29555.71","455","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.485","€ 33421.41","1.068","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.517","€ 14369.96","6.798","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.964","€ 41371.93","1.680","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.590","€ 37908.52","7.419","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":854},{"label":"Mar","value":686},{"label":"Abr","value":913},{"label":"Mai","value":706},{"label":"Jun","value":940},{"label":"Jul","value":768},{"label":"Ago","value":804},{"label":"Set","value":891},{"label":"Out","value":977},{"label":"Nov","value":824},{"label":"Dez","value":966}];
const MX = 977;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>New</span></h1>
                </div>
