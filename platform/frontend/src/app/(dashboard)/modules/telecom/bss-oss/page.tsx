...
const PAGE = "BSS/OSS";
const KPIS = [{"l":"Total Telecom","v":"4.736","t":"+6.2%","d":"up"},{"l":"BSS/OSS Ativos","v":"3.006","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"82","t":"+14.6%","d":"up"}];
const COLS = ["ID","BSS/OSS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom #001","Telecom #002","8.871","7.350","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom #002","Telecom #003","1.640","6.019","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom #003","Telecom #004","7.641","7.453","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom #004","Telecom #005","3.622","4.650","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom #005","Telecom #001","7.613","5.061","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1041},{"label":"Fev","value":947},{"label":"Mar","value":939},{"label":"Abr","value":815},{"label":"Mai","value":1046},{"label":"Jun","value":709},{"label":"Jul","value":833},{"label":"Ago","value":1081},{"label":"Set","value":712},{"label":"Out","value":745},{"label":"Nov","value":898},{"label":"Dez","value":704}];
const MX = 1081;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>TM Forum</span></h1>
                </div>
