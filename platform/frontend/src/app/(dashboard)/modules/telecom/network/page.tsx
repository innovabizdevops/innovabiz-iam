...
const KPIS = [{"l":"Total Telecom","v":"7.149","t":"+11.3%","d":"up"},{"l":"Network Mgmt Ativos","v":"7.129","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"73.9%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+3.5%","d":"up"}];
const COLS = ["ID","Network Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom #001","Telecom #002","6.169","1.194","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom #002","Telecom #003","1.340","7.199","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom #003","Telecom #004","6.481","182","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom #004","Telecom #005","8.809","8.953","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom #005","Telecom #001","3.952","7.787","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":748},{"label":"Mar","value":769},{"label":"Abr","value":742},{"label":"Mai","value":731},{"label":"Jun","value":675},{"label":"Jul","value":935},{"label":"Ago","value":1049},{"label":"Set","value":1042},{"label":"Out","value":738},{"label":"Nov","value":1042},{"label":"Dez","value":667}];
const MX = 1049;
