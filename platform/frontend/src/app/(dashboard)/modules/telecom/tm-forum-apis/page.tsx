...
const ACCENT = "#0369a1";
const MODULE = "Telecom & Communications";
const PAGE = "TM Forum APIs";
const KPIS = [{"l":"Total Telecom","v":"9.091","t":"+0.5%","d":"up"},{"l":"TM Forum APIs Ativos","v":"5.015","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"74","t":"+14.6%","d":"up"}];
const COLS = ["ID","TM Forum APIs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom #001","Telecom #002","5.194","6.222","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom #002","Telecom #003","4.260","4.761","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom #003","Telecom #004","7.843","3.490","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom #004","Telecom #005","5.572","960","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom #005","Telecom #001","5.262","4.876","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":1049},{"label":"Mar","value":813},{"label":"Abr","value":651},{"label":"Mai","value":680},{"label":"Jun","value":986},{"label":"Jul","value":940},{"label":"Ago","value":805},{"label":"Set","value":712},{"label":"Out","value":900},{"label":"Nov","value":739},{"label":"Dez","value":907}];
const MX = 1049;
...
export default function TmForumApisPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>TMF</span></h1>
                </div>
