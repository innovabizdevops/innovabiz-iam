...
const PAGE = "Billing &amp; Rating";
const KPIS = [{"l":"Surveys Ativos","v":"5.111","t":"+16.5%","d":"up"},{"l":"Respostas/Semana","v":"3561","t":"-5.5%","d":"down"},{"l":"NPS Médio","v":"70","t":"+6.6%","d":"up"},{"l":"Taxa Resposta (%)","v":"78.4%","t":"+3.4%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.127","94","94.9%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","754","73","96.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","405","67","82.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.306","87","95.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.454","94","77.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":660},{"label":"Mar","value":672},{"label":"Abr","value":790},{"label":"Mai","value":825},{"label":"Jun","value":585},{"label":"Jul","value":458},{"label":"Ago","value":672},{"label":"Set","value":820},{"label":"Out","value":784},{"label":"Nov","value":590},{"label":"Dez","value":460}];
const MX = 825;
