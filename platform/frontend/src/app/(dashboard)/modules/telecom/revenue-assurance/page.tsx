...
const PAGE = "Revenue Assurance";
const KPIS = [{"l":"ARR (€M)","v":"€41.5M","t":"+9.4%","d":"up"},{"l":"MRR (€)","v":"€41849","t":"+16.5%","d":"up"},{"l":"Churn (%)","v":"65.7%","t":"+4.5%","d":"up"},{"l":"ARPU (€)","v":"€36978","t":"-3.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 12004.92","1.602","€ 46061.58","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9620.15","815","€ 18697.83","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 8236.79","3.845","€ 3103.56","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 34646.54","4.172","€ 15799.06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 18675.47","7.534","€ 4102.99","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":848},{"label":"Mar","value":804},{"label":"Abr","value":639},{"label":"Mai","value":832},{"label":"Jun","value":638},{"label":"Jul","value":770},{"label":"Ago","value":569},{"label":"Set","value":670},{"label":"Out","value":528},{"label":"Nov","value":645},{"label":"Dez","value":807}];
const MX = 848;
