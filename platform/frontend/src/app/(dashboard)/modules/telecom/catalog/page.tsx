...
const KPIS = [{"l":"Dashboards Ativos","v":"5.846","t":"+7.2%","d":"up"},{"l":"Queries/Dia","v":"3355","t":"-5.2%","d":"down"},{"l":"Dados Processados (GB)","v":"4.102","t":"+15.2%","d":"up"},{"l":"Utilizadores Analytics","v":"783","t":"+17.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2561","2026-03-10","7.309","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1922","2026-01-18","2.234","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1439","2026-03-09","3.176","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","393","2026-01-08","5.895","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","746","2026-01-26","6.024","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":648},{"label":"Mar","value":634},{"label":"Abr","value":532},{"label":"Mai","value":533},{"label":"Jun","value":581},{"label":"Jul","value":513},{"label":"Ago","value":571},{"label":"Set","value":350},{"label":"Out","value":548},{"label":"Nov","value":337},{"label":"Dez","value":649}];
const MX = 649;
