...
const PAGE = "CPQ Telecom";
const KPIS = [{"l":"Total Telecom","v":"1.664","t":"-4.0%","d":"down"},{"l":"CPQ Telecom Ativos","v":"5.376","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"71.0%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"68","t":"+15.2%","d":"up"}];
const COLS = ["ID","CPQ Telecom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom #001","Telecom #002","5.979","6.000","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom #002","Telecom #003","630","5.025","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom #003","Telecom #004","3.948","3.668","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom #004","Telecom #005","2.589","5.227","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom #005","Telecom #001","5.048","3.093","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":252},{"label":"Fev","value":411},{"label":"Mar","value":528},{"label":"Abr","value":507},{"label":"Mai","value":429},{"label":"Jun","value":280},{"label":"Jul","value":431},{"label":"Ago","value":537},{"label":"Set","value":540},{"label":"Out","value":252},{"label":"Nov","value":302},{"label":"Dez","value":639}];
const MX = 639;
...
export default function CpqTelecomPage() {
    return (
