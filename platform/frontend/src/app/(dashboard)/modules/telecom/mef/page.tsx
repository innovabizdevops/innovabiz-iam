...
const PAGE = "MEF Standards";
const KPIS = [{"l":"Total Telecom","v":"4.219","t":"+6.9%","d":"up"},{"l":"MEF Standards Ativos","v":"771","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+2.2%","d":"up"}];
const COLS = ["ID","MEF Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom #001","Telecom #002","1.872","6.531","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom #002","Telecom #003","3.872","6.794","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom #003","Telecom #004","4.048","3.408","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom #004","Telecom #005","1.017","863","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom #005","Telecom #001","5.084","8.915","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":695},{"label":"Mar","value":478},{"label":"Abr","value":378},{"label":"Mai","value":733},{"label":"Jun","value":712},{"label":"Jul","value":589},{"label":"Ago","value":666},{"label":"Set","value":385},{"label":"Out","value":520},{"label":"Nov","value":694},{"label":"Dez","value":584}];
const MX = 733;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>MEF</span></h1>
                </div>
