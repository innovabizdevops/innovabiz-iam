...
const KPIS = [{"l":"Total Telecom","v":"6.655","t":"-4.3%","d":"down"},{"l":"Network Slicing Ativos","v":"2.629","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"91","t":"+8.7%","d":"up"}];
const COLS = ["ID","Network Slicing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom #001","Telecom #002","4.286","7.593","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom #002","Telecom #003","8.171","1.911","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom #003","Telecom #004","9.095","4.532","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom #004","Telecom #005","9.033","6.318","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom #005","Telecom #001","6.626","7.102","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":540},{"label":"Mar","value":583},{"label":"Abr","value":695},{"label":"Mai","value":503},{"label":"Jun","value":646},{"label":"Jul","value":823},{"label":"Ago","value":514},{"label":"Set","value":838},{"label":"Out","value":510},{"label":"Nov","value":742},{"label":"Dez","value":774}];
const MX = 838;
