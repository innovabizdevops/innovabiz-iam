...
const PAGE = "Field Ops";
const KPIS = [{"l":"Total Telecom","v":"6.721","t":"+10.3%","d":"up"},{"l":"Field Ops Ativos","v":"1.686","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"55","t":"+6.2%","d":"up"}];
const COLS = ["ID","Field Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom #001","Telecom #002","4.500","6.282","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom #002","Telecom #003","1.584","8.084","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom #003","Telecom #004","5.553","4.050","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom #004","Telecom #005","5.912","4.073","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom #005","Telecom #001","2.648","623","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":722},{"label":"Mar","value":920},{"label":"Abr","value":756},{"label":"Mai","value":787},{"label":"Jun","value":852},{"label":"Jul","value":956},{"label":"Ago","value":1024},{"label":"Set","value":705},{"label":"Out","value":765},{"label":"Nov","value":912},{"label":"Dez","value":782}];
const MX = 1024;
