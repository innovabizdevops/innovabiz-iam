...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Document Intelligence";
const PAGE = "Generate";
const KPIS = [{"l":"Formulários Ativos","v":"7.404","t":"+10.5%","d":"up"},{"l":"Submissões/Dia","v":"3041","t":"+15.4%","d":"up"},{"l":"Documentos Gerados","v":"7.809","t":"+11.7%","d":"up"},{"l":"Templates","v":"5.383","t":"+11.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.554","2026-03-19","3.945","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.075","2026-01-15","3.451","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.014","2026-01-08","3.667","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.428","2026-02-03","4.741","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.638","2026-02-07","6.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":771},{"label":"Mar","value":707},{"label":"Abr","value":632},{"label":"Mai","value":634},{"label":"Jun","value":899},{"label":"Jul","value":539},{"label":"Ago","value":579},{"label":"Set","value":701},{"label":"Out","value":585},{"label":"Nov","value":773},{"label":"Dez","value":542}];
const MX = 899;
