...
const PAGE = "Extract";
const KPIS = [{"l":"Formulários Ativos","v":"7.298","t":"+0.4%","d":"up"},{"l":"Submissões/Dia","v":"587","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"5.318","t":"-1.6%","d":"down"},{"l":"Templates","v":"4.793","t":"+1.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","755","2026-03-24","8.045","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.932","2026-03-22","5.301","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.599","2026-01-23","2.123","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.413","2026-03-02","5.029","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.722","2026-01-18","542","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":476},{"label":"Mar","value":450},{"label":"Abr","value":350},{"label":"Mai","value":512},{"label":"Jun","value":370},{"label":"Jul","value":454},{"label":"Ago","value":508},{"label":"Set","value":394},{"label":"Out","value":483},{"label":"Nov","value":605},{"label":"Dez","value":358}];
const MX = 605;
