...
const KPIS = [{"l":"Formulários Ativos","v":"2.299","t":"+0.8%","d":"up"},{"l":"Submissões/Dia","v":"5079","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"4.842","t":"+7.4%","d":"up"},{"l":"Templates","v":"999","t":"-1.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.213","2026-02-14","4.210","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.456","2026-01-02","6.733","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.656","2026-03-01","3.847","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.769","2026-01-06","5.120","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.339","2026-02-27","1.200","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":526},{"label":"Mar","value":538},{"label":"Abr","value":354},{"label":"Mai","value":498},{"label":"Jun","value":615},{"label":"Jul","value":311},{"label":"Ago","value":592},{"label":"Set","value":519},{"label":"Out","value":520},{"label":"Nov","value":615},{"label":"Dez","value":643}];
const MX = 643;
