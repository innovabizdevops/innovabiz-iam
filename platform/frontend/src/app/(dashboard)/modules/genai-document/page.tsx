...
/* ═══ GenAI Document Intelligence — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "1417", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "889", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€115K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1438540617", cells: ["GEN-8617", "GenAI Document Intelligence Item 1", "18/10/2026", "€40 717"], status: "active" as const },
    { id: "1438544188", cells: ["GEN-3188", "GenAI Document Intelligence Item 2", "5/5/2026", "€44 288"], status: "pending" as const },
    { id: "1438547759", cells: ["GEN-6759", "GenAI Document Intelligence Item 3", "20/12/2026", "€47 859"], status: "completed" as const },
    { id: "1438551330", cells: ["GEN-1330", "GenAI Document Intelligence Item 4", "7/7/2026", "€1430"], status: "warning" as const },
    { id: "1438554901", cells: ["GEN-4901", "GenAI Document Intelligence Item 5", "22/2/2026", "€5001"], status: "active" as const },
];
...
export default function GenaiDocumentIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Document Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Document Intelligence</p>
                    </div>
                </div>
