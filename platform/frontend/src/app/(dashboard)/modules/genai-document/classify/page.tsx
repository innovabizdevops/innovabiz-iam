...
const PAGE = "Classify";
const KPIS = [{"l":"Formulários Ativos","v":"9.053","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"1035","t":"+12.4%","d":"up"},{"l":"Documentos Gerados","v":"7.014","t":"+9.5%","d":"up"},{"l":"Templates","v":"5.202","t":"+9.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.632","2026-02-25","137","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.247","2026-01-05","5.535","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.651","2026-02-04","5.450","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.527","2026-03-06","8.960","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.236","2026-02-15","3.896","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":744},{"label":"Mar","value":931},{"label":"Abr","value":909},{"label":"Mai","value":619},{"label":"Jun","value":586},{"label":"Jul","value":777},{"label":"Ago","value":728},{"label":"Set","value":823},{"label":"Out","value":784},{"label":"Nov","value":836},{"label":"Dez","value":759}];
const MX = 931;
