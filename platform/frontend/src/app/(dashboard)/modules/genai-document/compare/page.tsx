...
const PAGE = "Compare";
const KPIS = [{"l":"Formulários Ativos","v":"5.373","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"2621","t":"-5.7%","d":"down"},{"l":"Documentos Gerados","v":"5.884","t":"+7.8%","d":"up"},{"l":"Templates","v":"1.018","t":"+12.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.430","2026-01-14","5.299","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.427","2026-01-16","7.545","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.461","2026-01-03","7.653","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.604","2026-02-24","612","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.400","2026-02-05","423","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":386},{"label":"Mar","value":697},{"label":"Abr","value":476},{"label":"Mai","value":488},{"label":"Jun","value":650},{"label":"Jul","value":550},{"label":"Ago","value":551},{"label":"Set","value":615},{"label":"Out","value":575},{"label":"Nov","value":616},{"label":"Dez","value":613}];
const MX = 697;
