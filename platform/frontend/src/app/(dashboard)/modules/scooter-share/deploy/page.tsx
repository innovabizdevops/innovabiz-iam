...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Scooter Share","v":"1.627","t":"-3.2%","d":"down"},{"l":"Deploy Ativos","v":"1.045","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+12.5%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scooter Share #001","Scooter Share #002","3.405","1.180","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Scooter Share #002","Scooter Share #003","4.054","241","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Scooter Share #003","Scooter Share #004","8.748","3.052","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Scooter Share #004","Scooter Share #005","2.372","4.330","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scooter Share #005","Scooter Share #001","5.435","7.676","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":433},{"label":"Mar","value":485},{"label":"Abr","value":796},{"label":"Mai","value":510},{"label":"Jun","value":663},{"label":"Jul","value":738},{"label":"Ago","value":418},{"label":"Set","value":603},{"label":"Out","value":574},{"label":"Nov","value":614},{"label":"Dez","value":632}];
const MX = 796;
