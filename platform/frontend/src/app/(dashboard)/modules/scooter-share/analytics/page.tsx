...
const KPIS = [{"l":"Dashboards Ativos","v":"5.348","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"1855","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.119","t":"+6.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.407","t":"-3.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","201","2026-01-25","3.502","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4778","2026-02-01","484","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4069","2026-03-05","448","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3343","2026-02-24","2.823","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1747","2026-02-07","837","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":316},{"label":"Mar","value":401},{"label":"Abr","value":442},{"label":"Mai","value":645},{"label":"Jun","value":333},{"label":"Jul","value":298},{"label":"Ago","value":409},{"label":"Set","value":539},{"label":"Out","value":290},{"label":"Nov","value":627},{"label":"Dez","value":535}];
const MX = 645;
