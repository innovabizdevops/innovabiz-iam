...
const ACCENT = "#6366f1";
const MODULE = "Scooter Share";
const PAGE = "Geo-Fence";
const KPIS = [{"l":"Total Scooter Share","v":"8.811","t":"+8.7%","d":"up"},{"l":"Geo Fence Ativos","v":"5.707","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"85","t":"-2.0%","d":"down"}];
const COLS = ["ID","Geo Fence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scooter Share #001","Scooter Share #002","4.565","8.509","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Scooter Share #002","Scooter Share #003","6.943","322","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Scooter Share #003","Scooter Share #004","836","6.332","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Scooter Share #004","Scooter Share #005","3.429","5.026","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scooter Share #005","Scooter Share #001","4.376","9.042","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":630},{"label":"Mar","value":313},{"label":"Abr","value":268},{"label":"Mai","value":323},{"label":"Jun","value":536},{"label":"Jul","value":384},{"label":"Ago","value":578},{"label":"Set","value":521},{"label":"Out","value":380},{"label":"Nov","value":612},{"label":"Dez","value":450}];
const MX = 657;
