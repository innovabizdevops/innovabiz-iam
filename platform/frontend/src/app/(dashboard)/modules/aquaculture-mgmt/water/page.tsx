...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.862","t":"+14.5%","d":"up"},{"l":"NC Abertas","v":"7.485","t":"-5.5%","d":"down"},{"l":"Conformidade (%)","v":"77.1%","t":"+16.2%","d":"up"},{"l":"CAPAs Pendentes","v":"1.564","t":"+16.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.520","83.8%","5.513","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.302","84.9%","4.375","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.873","89.8%","657","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.242","79.5%","5.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.221","84.5%","4.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":513},{"label":"Mar","value":794},{"label":"Abr","value":617},{"label":"Mai","value":586},{"label":"Jun","value":463},{"label":"Jul","value":754},{"label":"Ago","value":564},{"label":"Set","value":600},{"label":"Out","value":519},{"label":"Nov","value":529},{"label":"Dez","value":678}];
const MX = 794;
