...
const PAGE = "Health";
const KPIS = [{"l":"Embarcações Ativas","v":"4.984","t":"+3.8%","d":"up"},{"l":"Capturas (ton)","v":"3100","t":"+13.2%","d":"up"},{"l":"Quota Utilizada (%)","v":"72.7%","t":"+7.5%","d":"up"},{"l":"Certificações","v":"4.315","t":"+12.0%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","1965","5.946","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1064","4.789","78.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3387","877","95.2%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","2426","4.372","81.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","3057","5.999","99.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":519},{"label":"Mar","value":513},{"label":"Abr","value":629},{"label":"Mai","value":466},{"label":"Jun","value":376},{"label":"Jul","value":486},{"label":"Ago","value":314},{"label":"Set","value":349},{"label":"Out","value":667},{"label":"Nov","value":625},{"label":"Dez","value":634}];
const MX = 667;
