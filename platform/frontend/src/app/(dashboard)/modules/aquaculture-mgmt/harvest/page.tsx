...
const PAGE = "Harvest";
const KPIS = [{"l":"Embarcações Ativas","v":"4.674","t":"+0.9%","d":"up"},{"l":"Capturas (ton)","v":"3282","t":"+16.4%","d":"up"},{"l":"Quota Utilizada (%)","v":"72.5%","t":"+5.6%","d":"up"},{"l":"Certificações","v":"1.018","t":"+17.6%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","1633","7.919","91.1%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1017","5.074","76.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3829","8.542","88.5%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","1624","7.408","76.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","3741","2.477","71.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":385},{"label":"Mar","value":488},{"label":"Abr","value":412},{"label":"Mai","value":654},{"label":"Jun","value":341},{"label":"Jul","value":271},{"label":"Ago","value":461},{"label":"Set","value":331},{"label":"Out","value":356},{"label":"Nov","value":336},{"label":"Dez","value":653}];
const MX = 654;
