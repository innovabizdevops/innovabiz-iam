...
const PAGE = "Pond";
const KPIS = [{"l":"Embarcações Ativas","v":"6.925","t":"-3.6%","d":"down"},{"l":"Capturas (ton)","v":"1425","t":"-4.0%","d":"down"},{"l":"Quota Utilizada (%)","v":"78.0%","t":"-1.9%","d":"down"},{"l":"Certificações","v":"7.214","t":"+17.2%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","4837","5.672","97.3%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","3398","1.846","87.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","4900","3.922","76.5%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","401","1.982","89.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","3039","2.093","85.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":968},{"label":"Mar","value":785},{"label":"Abr","value":831},{"label":"Mai","value":995},{"label":"Jun","value":992},{"label":"Jul","value":900},{"label":"Ago","value":826},{"label":"Set","value":990},{"label":"Out","value":916},{"label":"Nov","value":897},{"label":"Dez","value":858}];
const MX = 995;
