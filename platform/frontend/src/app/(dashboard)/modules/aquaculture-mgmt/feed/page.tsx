...
const ACCENT = "#6366f1";
const MODULE = "Aquaculture";
const PAGE = "Feed";
const KPIS = [{"l":"Embarcações Ativas","v":"4.913","t":"-4.1%","d":"down"},{"l":"Capturas (ton)","v":"687","t":"+16.6%","d":"up"},{"l":"Quota Utilizada (%)","v":"74.1%","t":"-5.7%","d":"down"},{"l":"Certificações","v":"7.088","t":"-4.6%","d":"down"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","2900","4.043","73.7%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","3284","6.854","88.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","582","3.105","89.9%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","793","3.429","89.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","2815","7.539","72.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":308},{"label":"Mar","value":354},{"label":"Abr","value":572},{"label":"Mai","value":358},{"label":"Jun","value":582},{"label":"Jul","value":387},{"label":"Ago","value":560},{"label":"Set","value":336},{"label":"Out","value":500},{"label":"Nov","value":549},{"label":"Dez","value":486}];
const MX = 582;
