...
const PAGE = "Deploy";
const KPIS = [{"l":"Dashboards Ativos","v":"2.182","t":"+8.4%","d":"up"},{"l":"Queries/Dia","v":"3721","t":"+16.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.649","t":"+0.5%","d":"up"},{"l":"Utilizadores Analytics","v":"4.741","t":"+4.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1147","2026-01-05","7.390","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1485","2026-02-26","6.783","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2441","2026-02-03","8.289","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1735","2026-03-11","3.184","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4724","2026-01-06","8.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":726},{"label":"Mar","value":808},{"label":"Abr","value":697},{"label":"Mai","value":777},{"label":"Jun","value":658},{"label":"Jul","value":788},{"label":"Ago","value":821},{"label":"Set","value":719},{"label":"Out","value":875},{"label":"Nov","value":895},{"label":"Dez","value":633}];
const MX = 895;
