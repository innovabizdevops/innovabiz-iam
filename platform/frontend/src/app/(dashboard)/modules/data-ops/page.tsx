...
/* ═══ DataOps Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "1118", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4565", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€199K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "616305718", cells: ["DAT-4718", "DataOps Platform Item 1", "15/11/2026", "€5818"], status: "active" as const },
    { id: "616309289", cells: ["DAT-8289", "DataOps Platform Item 2", "2/6/2026", "€9389"], status: "pending" as const },
    { id: "616312860", cells: ["DAT-2860", "DataOps Platform Item 3", "17/1/2026", "€12 960"], status: "completed" as const },
    { id: "616316431", cells: ["DAT-6431", "DataOps Platform Item 4", "4/8/2026", "€16 531"], status: "warning" as const },
    { id: "616320002", cells: ["DAT-1002", "DataOps Platform Item 5", "19/3/2026", "€20 102"], status: "active" as const },
];
...
export default function DataopsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">DataOps Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • DataOps Platform</p>
                    </div>
                </div>
