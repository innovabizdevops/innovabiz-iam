...
const PAGE = "Test";
const KPIS = [{"l":"Dashboards Ativos","v":"407","t":"-2.1%","d":"down"},{"l":"Queries/Dia","v":"4068","t":"+6.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.161","t":"+2.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.923","t":"+14.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","141","2026-02-08","5.141","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2999","2026-03-24","6.787","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","954","2026-02-06","5.825","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","161","2026-01-25","4.273","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3661","2026-03-09","1.346","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":577},{"label":"Mar","value":749},{"label":"Abr","value":675},{"label":"Mai","value":707},{"label":"Jun","value":701},{"label":"Jul","value":869},{"label":"Ago","value":863},{"label":"Set","value":856},{"label":"Out","value":677},{"label":"Nov","value":662},{"label":"Dez","value":578}];
const MX = 869;
