...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"1.954","t":"+17.9%","d":"up"},{"l":"Queries/Dia","v":"180","t":"-1.8%","d":"down"},{"l":"Dados Processados (GB)","v":"4.559","t":"+2.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.512","t":"-1.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","184","2026-03-10","8.762","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2222","2026-01-25","6.884","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2032","2026-03-28","4.139","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1727","2026-01-18","6.132","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","955","2026-01-02","4.445","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":514},{"label":"Mar","value":253},{"label":"Abr","value":387},{"label":"Mai","value":493},{"label":"Jun","value":421},{"label":"Jul","value":446},{"label":"Ago","value":571},{"label":"Set","value":445},{"label":"Out","value":448},{"label":"Nov","value":554},{"label":"Dez","value":389}];
const MX = 571;
