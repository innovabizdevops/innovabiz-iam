...
const PAGE = "Pipeline";
const KPIS = [{"l":"Dashboards Ativos","v":"1.044","t":"+3.9%","d":"up"},{"l":"Queries/Dia","v":"3705","t":"+12.3%","d":"up"},{"l":"Dados Processados (GB)","v":"7.409","t":"+10.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.903","t":"+16.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","155","2026-01-06","9.060","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4128","2026-02-24","4.770","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2509","2026-01-06","4.647","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","876","2026-02-26","6.102","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1335","2026-02-25","1.995","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1011},{"label":"Fev","value":710},{"label":"Mar","value":994},{"label":"Abr","value":634},{"label":"Mai","value":712},{"label":"Jun","value":706},{"label":"Jul","value":946},{"label":"Ago","value":664},{"label":"Set","value":703},{"label":"Out","value":633},{"label":"Nov","value":972},{"label":"Dez","value":764}];
const MX = 1011;
