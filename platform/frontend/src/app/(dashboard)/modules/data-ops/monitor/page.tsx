...
const ACCENT = "#1e3a5f";
const MODULE = "DataOps Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"4.119","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"3449","t":"+6.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.522","t":"+4.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.189","t":"+10.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2409","2026-02-21","852","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2074","2026-03-08","7.908","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4341","2026-01-07","7.448","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3750","2026-02-27","768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","852","2026-02-25","870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":695},{"label":"Mar","value":472},{"label":"Abr","value":696},{"label":"Mai","value":404},{"label":"Jun","value":612},{"label":"Jul","value":703},{"label":"Ago","value":551},{"label":"Set","value":567},{"label":"Out","value":366},{"label":"Nov","value":558},{"label":"Dez","value":330}];
const MX = 703;
