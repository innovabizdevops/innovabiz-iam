...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.965","t":"+-0.0%","d":"up"},{"l":"NC Abertas","v":"2.477","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"85.6%","t":"+8.2%","d":"up"},{"l":"CAPAs Pendentes","v":"4.239","t":"+5.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.801","83.9%","9.091","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.007","84.3%","5.025","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.469","78.3%","9.014","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","471","95.8%","8.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.037","85.2%","1.915","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":939},{"label":"Mar","value":995},{"label":"Abr","value":958},{"label":"Mai","value":781},{"label":"Jun","value":671},{"label":"Jul","value":737},{"label":"Ago","value":736},{"label":"Set","value":789},{"label":"Out","value":1011},{"label":"Nov","value":668},{"label":"Dez","value":1022}];
const MX = 1022;
