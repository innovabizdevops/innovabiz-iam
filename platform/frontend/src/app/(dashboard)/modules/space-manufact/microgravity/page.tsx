...
const ACCENT = "#059669";
const MODULE = "Space Manufacturing";
const PAGE = "Microgravity";
const KPIS = [{"l":"Quartos Ocupados","v":"6.244","t":"+16.0%","d":"up"},{"l":"RevPAR (€)","v":"€46027","t":"-0.1%","d":"down"},{"l":"Ocupação (%)","v":"66.6%","t":"+15.9%","d":"up"},{"l":"Guest Satisfaction","v":"3.074","t":"+10.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.563","2026-02-17","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.585","2026-02-02","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.362","2026-03-06","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.966","2026-02-15","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.192","2026-03-27","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":909},{"label":"Mar","value":599},{"label":"Abr","value":907},{"label":"Mai","value":589},{"label":"Jun","value":898},{"label":"Jul","value":752},{"label":"Ago","value":573},{"label":"Set","value":734},{"label":"Out","value":712},{"label":"Nov","value":724},{"label":"Dez","value":589}];
const MX = 910;
...
export default function MicrogravityPage() {
    return (
