...
const ACCENT = "#4338ca";
const MODULE = "Prescriptive Analytics";
const PAGE = "Optimize";
const KPIS = [{"l":"Dashboards Ativos","v":"5.678","t":"+7.2%","d":"up"},{"l":"Queries/Dia","v":"3312","t":"-3.4%","d":"down"},{"l":"Dados Processados (GB)","v":"7.986","t":"+16.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.165","t":"-0.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3803","2026-01-17","1.405","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3673","2026-03-25","5.844","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4393","2026-02-27","4.009","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","668","2026-01-18","1.736","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1743","2026-03-26","2.016","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":570},{"label":"Mar","value":531},{"label":"Abr","value":544},{"label":"Mai","value":516},{"label":"Jun","value":400},{"label":"Jul","value":521},{"label":"Ago","value":724},{"label":"Set","value":490},{"label":"Out","value":581},{"label":"Nov","value":653},{"label":"Dez","value":386}];
const MX = 728;
