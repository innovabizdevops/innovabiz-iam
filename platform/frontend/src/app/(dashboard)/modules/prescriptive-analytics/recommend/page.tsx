...
const KPIS = [{"l":"Dashboards Ativos","v":"961","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"2429","t":"+11.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.058","t":"+12.1%","d":"up"},{"l":"Utilizadores Analytics","v":"4.037","t":"+5.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2403","2026-02-21","7.887","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1126","2026-01-15","7.527","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","739","2026-02-07","6.995","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","563","2026-02-20","3.702","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1283","2026-02-27","8.109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":571},{"label":"Mar","value":622},{"label":"Abr","value":887},{"label":"Mai","value":818},{"label":"Jun","value":784},{"label":"Jul","value":883},{"label":"Ago","value":900},{"label":"Set","value":927},{"label":"Out","value":653},{"label":"Nov","value":854},{"label":"Dez","value":729}];
const MX = 930;
