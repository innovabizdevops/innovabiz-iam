...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"5.755","t":"+4.0%","d":"up"},{"l":"Simulações/Dia","v":"814","t":"+8.9%","d":"up"},{"l":"Precisão Modelo (%)","v":"88.6%","t":"+12.8%","d":"up"},{"l":"Latência Sync (ms)","v":"40ms","t":"+8.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","87.8%","2026-03-05","2.404","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","83.9%","2026-01-01","930","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","99.1%","2026-02-15","2.268","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","91.9%","2026-01-08","3.322","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","98.4%","2026-01-21","4.259","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":631},{"label":"Mar","value":935},{"label":"Abr","value":868},{"label":"Mai","value":567},{"label":"Jun","value":817},{"label":"Jul","value":620},{"label":"Ago","value":587},{"label":"Set","value":849},{"label":"Out","value":829},{"label":"Nov","value":878},{"label":"Dez","value":927}];
const MX = 935;
