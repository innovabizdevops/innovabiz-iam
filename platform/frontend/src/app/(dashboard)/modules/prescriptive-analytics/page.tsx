...
const KPIS = [
    { label: "Total Registos", value: "4686", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1166", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€184K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "266670986", cells: ["PRE-1986", "Prescriptive Analytics Item 1", "23/3/2026", "€21 086"], status: "active" as const },
    { id: "266674557", cells: ["PRE-5557", "Prescriptive Analytics Item 2", "10/10/2026", "€24 657"], status: "pending" as const },
    { id: "266678128", cells: ["PRE-9128", "Prescriptive Analytics Item 3", "25/5/2026", "€28 228"], status: "completed" as const },
    { id: "266681699", cells: ["PRE-3699", "Prescriptive Analytics Item 4", "12/12/2026", "€31 799"], status: "warning" as const },
    { id: "266685270", cells: ["PRE-7270", "Prescriptive Analytics Item 5", "27/7/2026", "€35 370"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Prescriptive Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Prescriptive Analytics</p>
                    </div>
                </div>
