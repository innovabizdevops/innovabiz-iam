...
const KPIS = [{"l":"Dashboards Ativos","v":"2.625","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"493","t":"+2.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.004","t":"-0.8%","d":"down"},{"l":"Utilizadores Analytics","v":"3.535","t":"+2.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2010","2026-03-05","3.457","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3988","2026-01-11","615","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3870","2026-03-24","347","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1530","2026-01-28","8.428","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2528","2026-01-03","1.235","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":689},{"label":"Mar","value":718},{"label":"Abr","value":503},{"label":"Mai","value":510},{"label":"Jun","value":383},{"label":"Jul","value":547},{"label":"Ago","value":652},{"label":"Set","value":650},{"label":"Out","value":572},{"label":"Nov","value":377},{"label":"Dez","value":715}];
const MX = 744;
