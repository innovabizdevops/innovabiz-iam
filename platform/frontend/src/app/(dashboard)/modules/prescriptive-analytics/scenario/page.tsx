...
const PAGE = "Scenario";
const KPIS = [{"l":"Dashboards Ativos","v":"6.074","t":"-5.8%","d":"down"},{"l":"Queries/Dia","v":"3855","t":"+12.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.066","t":"+1.0%","d":"up"},{"l":"Utilizadores Analytics","v":"246","t":"+17.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","918","2026-02-27","202","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1554","2026-03-03","9.018","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1723","2026-03-28","8.077","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1419","2026-03-02","8.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4059","2026-01-13","6.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":439},{"label":"Mar","value":601},{"label":"Abr","value":532},{"label":"Mai","value":416},{"label":"Jun","value":649},{"label":"Jul","value":467},{"label":"Ago","value":367},{"label":"Set","value":418},{"label":"Out","value":341},{"label":"Nov","value":628},{"label":"Dez","value":582}];
const MX = 649;
