...
const KPIS = [{"l":"Dashboards Ativos","v":"4.238","t":"-0.3%","d":"down"},{"l":"Queries/Dia","v":"4498","t":"+10.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.280","t":"+14.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.944","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4960","2026-03-16","6.476","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2025","2026-01-11","269","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2334","2026-01-19","5.876","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2259","2026-01-17","1.030","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","961","2026-01-25","5.260","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":527},{"label":"Mar","value":715},{"label":"Abr","value":652},{"label":"Mai","value":651},{"label":"Jun","value":868},{"label":"Jul","value":903},{"label":"Ago","value":659},{"label":"Set","value":570},{"label":"Out","value":689},{"label":"Nov","value":823},{"label":"Dez","value":720}];
const MX = 903;
