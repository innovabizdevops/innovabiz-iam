...
const KPIS = [{"l":"Artigos Publicados","v":"935","t":"+2.2%","d":"up"},{"l":"Views/Semana","v":"1121","t":"-4.3%","d":"down"},{"l":"Feedback Útil (%)","v":"67.6%","t":"+12.8%","d":"up"},{"l":"Artigos Desatualizados","v":"1.048","t":"+2.3%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","2.318","75.2%","5.143","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","7.898","88.7%","7.917","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","5.222","92.4%","2.967","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.014","90.1%","6.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","1.894","73.8%","2.543","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1038},{"label":"Fev","value":714},{"label":"Mar","value":883},{"label":"Abr","value":774},{"label":"Mai","value":947},{"label":"Jun","value":776},{"label":"Jul","value":890},{"label":"Ago","value":1033},{"label":"Set","value":908},{"label":"Out","value":841},{"label":"Nov","value":721},{"label":"Dez","value":983}];
const MX = 1038;
