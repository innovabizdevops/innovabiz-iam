...
const PAGE = "Case";
const KPIS = [{"l":"Total Dynamics Service","v":"3.392","t":"+6.2%","d":"up"},{"l":"Case Ativos","v":"3.539","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"75","t":"+7.2%","d":"up"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dynamics Service #001","Dynamics Service #002","1.324","1.391","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Dynamics Service #002","Dynamics Service #003","5.504","4.463","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Dynamics Service #003","Dynamics Service #004","3.869","4.347","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Dynamics Service #004","Dynamics Service #005","629","1.327","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dynamics Service #005","Dynamics Service #001","7.565","7.708","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":601},{"label":"Mar","value":543},{"label":"Abr","value":429},{"label":"Mai","value":547},{"label":"Jun","value":554},{"label":"Jul","value":457},{"label":"Ago","value":266},{"label":"Set","value":392},{"label":"Out","value":419},{"label":"Nov","value":374},{"label":"Dez","value":550}];
const MX = 601;
