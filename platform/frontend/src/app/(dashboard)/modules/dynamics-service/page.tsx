...
/* ═══ Customer Service Hub (D365) — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "8813", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "648", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€332K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1610768413", cells: ["DYN-3413", "Customer Service Hub (D365) Item 1", "10/2/2026", "€18 513"], status: "active" as const },
    { id: "1610771984", cells: ["DYN-6984", "Customer Service Hub (D365) Item 2", "25/9/2026", "€22 084"], status: "pending" as const },
    { id: "1610775555", cells: ["DYN-1555", "Customer Service Hub (D365) Item 3", "12/4/2026", "€25 655"], status: "completed" as const },
    { id: "1610779126", cells: ["DYN-5126", "Customer Service Hub (D365) Item 4", "27/11/2026", "€29 226"], status: "warning" as const },
    { id: "1610782697", cells: ["DYN-8697", "Customer Service Hub (D365) Item 5", "14/6/2026", "€32 797"], status: "active" as const },
];
...
export default function CustomerServiceHubD365Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customer Service Hub (D365)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Customer Service Hub (D365)</p>
                    </div>
                </div>
