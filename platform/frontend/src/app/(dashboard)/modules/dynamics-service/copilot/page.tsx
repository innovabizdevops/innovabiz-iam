...
const ACCENT = "#00bcf2";
const MODULE = "Customer Service Hub (D365)";
const PAGE = "Copilot";
const KPIS = [{"l":"Total Dynamics Service","v":"6.240","t":"-2.8%","d":"down"},{"l":"Copilot Ativos","v":"2.116","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"91","t":"-0.4%","d":"down"}];
const COLS = ["ID","Copilot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dynamics Service #001","Dynamics Service #002","7.760","8.989","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Dynamics Service #002","Dynamics Service #003","6.384","8.727","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Dynamics Service #003","Dynamics Service #004","4.523","364","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Dynamics Service #004","Dynamics Service #005","2.525","8.985","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dynamics Service #005","Dynamics Service #001","2.932","4.150","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":992},{"label":"Mar","value":993},{"label":"Abr","value":821},{"label":"Mai","value":1089},{"label":"Jun","value":871},{"label":"Jul","value":963},{"label":"Ago","value":785},{"label":"Set","value":1054},{"label":"Out","value":1003},{"label":"Nov","value":944},{"label":"Dez","value":911}];
const MX = 1089;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#00bcf2'}}>AI</span></h1>
                </div>
