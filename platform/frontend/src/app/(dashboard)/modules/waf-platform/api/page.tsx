...
const PAGE = "API";
const KPIS = [{"l":"Formulários Ativos","v":"730","t":"+7.5%","d":"up"},{"l":"Submissões/Dia","v":"1203","t":"-5.5%","d":"down"},{"l":"Documentos Gerados","v":"5.604","t":"+13.8%","d":"up"},{"l":"Templates","v":"7.669","t":"+16.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","839","2026-02-27","893","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.262","2026-02-02","2.007","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.696","2026-01-03","8.477","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.629","2026-03-09","6.291","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.951","2026-02-25","371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":812},{"label":"Mar","value":939},{"label":"Abr","value":842},{"label":"Mai","value":663},{"label":"Jun","value":950},{"label":"Jul","value":960},{"label":"Ago","value":705},{"label":"Set","value":805},{"label":"Out","value":764},{"label":"Nov","value":1024},{"label":"Dez","value":887}];
const MX = 1024;
