...
const PAGE = "Rule";
const KPIS = [{"l":"Formulários Ativos","v":"8.707","t":"+13.0%","d":"up"},{"l":"Submissões/Dia","v":"1283","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"783","t":"-4.6%","d":"down"},{"l":"Templates","v":"8.502","t":"+0.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.773","2026-01-04","8.532","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.253","2026-02-02","1.800","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.259","2026-01-22","6.239","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.640","2026-02-02","1.623","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.049","2026-01-17","2.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":577},{"label":"Mar","value":546},{"label":"Abr","value":500},{"label":"Mai","value":474},{"label":"Jun","value":566},{"label":"Jul","value":616},{"label":"Ago","value":404},{"label":"Set","value":565},{"label":"Out","value":407},{"label":"Nov","value":709},{"label":"Dez","value":473}];
const MX = 709;
