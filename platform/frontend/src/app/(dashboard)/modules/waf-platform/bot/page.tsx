...
const ACCENT = "#7f1d1d";
const MODULE = "WAF Platform Deep";
const PAGE = "Bot";
const KPIS = [{"l":"Formulários Ativos","v":"1.793","t":"+10.6%","d":"up"},{"l":"Submissões/Dia","v":"3761","t":"+7.0%","d":"up"},{"l":"Documentos Gerados","v":"6.807","t":"-0.3%","d":"down"},{"l":"Templates","v":"6.984","t":"+3.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.018","2026-01-25","9.069","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.188","2026-02-06","6.920","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.005","2026-02-25","1.078","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","9.015","2026-01-13","188","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.577","2026-02-22","567","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":630},{"label":"Mar","value":431},{"label":"Abr","value":487},{"label":"Mai","value":484},{"label":"Jun","value":549},{"label":"Jul","value":461},{"label":"Ago","value":680},{"label":"Set","value":589},{"label":"Out","value":400},{"label":"Nov","value":637},{"label":"Dez","value":536}];
const MX = 680;
