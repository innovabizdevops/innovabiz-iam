...
/* ═══ WAF Platform Deep — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "9715", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3508", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€178K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1548419115", cells: ["WAF-6115", "WAF Platform Deep Item 1", "20/4/2026", "€19 215"], status: "active" as const },
    { id: "1548422686", cells: ["WAF-9686", "WAF Platform Deep Item 2", "7/11/2026", "€22 786"], status: "pending" as const },
    { id: "1548426257", cells: ["WAF-4257", "WAF Platform Deep Item 3", "22/6/2026", "€26 357"], status: "completed" as const },
    { id: "1548429828", cells: ["WAF-7828", "WAF Platform Deep Item 4", "9/1/2026", "€29 928"], status: "warning" as const },
    { id: "1548433399", cells: ["WAF-2399", "WAF Platform Deep Item 5", "24/8/2026", "€33 499"], status: "active" as const },
];
...
export default function WafPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">WAF Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • WAF Platform Deep</p>
                    </div>
                </div>
