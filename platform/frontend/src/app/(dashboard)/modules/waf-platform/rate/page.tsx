...
const PAGE = "Rate";
const KPIS = [{"l":"Formulários Ativos","v":"7.768","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"2005","t":"+16.8%","d":"up"},{"l":"Documentos Gerados","v":"3.952","t":"-0.2%","d":"down"},{"l":"Templates","v":"4.142","t":"+12.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.159","2026-03-04","3.222","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","314","2026-01-08","2.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.044","2026-02-25","6.043","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","964","2026-01-03","7.430","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.438","2026-02-06","570","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":988},{"label":"Fev","value":836},{"label":"Mar","value":813},{"label":"Abr","value":976},{"label":"Mai","value":788},{"label":"Jun","value":1027},{"label":"Jul","value":938},{"label":"Ago","value":644},{"label":"Set","value":677},{"label":"Out","value":770},{"label":"Nov","value":957},{"label":"Dez","value":1017}];
const MX = 1027;
