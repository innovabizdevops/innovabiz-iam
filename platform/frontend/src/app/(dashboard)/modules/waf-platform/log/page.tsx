...
const PAGE = "Log";
const KPIS = [{"l":"Formulários Ativos","v":"7.676","t":"+7.9%","d":"up"},{"l":"Submissões/Dia","v":"4780","t":"+7.6%","d":"up"},{"l":"Documentos Gerados","v":"8.691","t":"+5.7%","d":"up"},{"l":"Templates","v":"7.334","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.038","2026-03-14","859","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.252","2026-02-06","1.591","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.449","2026-01-26","545","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.190","2026-03-06","1.446","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.910","2026-01-21","8.883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":902},{"label":"Mar","value":761},{"label":"Abr","value":800},{"label":"Mai","value":723},{"label":"Jun","value":716},{"label":"Jul","value":664},{"label":"Ago","value":570},{"label":"Set","value":862},{"label":"Out","value":605},{"label":"Nov","value":925},{"label":"Dez","value":671}];
const MX = 925;
