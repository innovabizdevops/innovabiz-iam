...
const PAGE = "Sewing";
const KPIS = [{"l":"Total Garment Mgmt","v":"5.064","t":"+7.8%","d":"up"},{"l":"Sewing Ativos","v":"5.583","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"70","t":"+17.6%","d":"up"}];
const COLS = ["ID","Sewing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Garment Mgmt #001","Garment Mgmt #002","6.209","6.203","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Garment Mgmt #002","Garment Mgmt #003","8.212","7.085","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Garment Mgmt #003","Garment Mgmt #004","174","2.685","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Garment Mgmt #004","Garment Mgmt #005","5.127","8.940","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Garment Mgmt #005","Garment Mgmt #001","7.152","4.737","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":910},{"label":"Mar","value":895},{"label":"Abr","value":767},{"label":"Mai","value":767},{"label":"Jun","value":820},{"label":"Jul","value":1006},{"label":"Ago","value":1002},{"label":"Set","value":870},{"label":"Out","value":952},{"label":"Nov","value":743},{"label":"Dez","value":897}];
const MX = 1006;
