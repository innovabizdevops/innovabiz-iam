...
const PAGE = "Cutting";
const KPIS = [{"l":"Total Garment Mgmt","v":"5.117","t":"+1.4%","d":"up"},{"l":"Cutting Ativos","v":"8.282","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"63","t":"+1.8%","d":"up"}];
const COLS = ["ID","Cutting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Garment Mgmt #001","Garment Mgmt #002","3.461","354","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Garment Mgmt #002","Garment Mgmt #003","8.270","1.449","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Garment Mgmt #003","Garment Mgmt #004","1.055","1.978","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Garment Mgmt #004","Garment Mgmt #005","2.035","2.174","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Garment Mgmt #005","Garment Mgmt #001","5.758","5.949","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":736},{"label":"Mar","value":762},{"label":"Abr","value":836},{"label":"Mai","value":591},{"label":"Jun","value":609},{"label":"Jul","value":596},{"label":"Ago","value":912},{"label":"Set","value":719},{"label":"Out","value":889},{"label":"Nov","value":848},{"label":"Dez","value":797}];
const MX = 912;
