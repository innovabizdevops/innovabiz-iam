...
const PAGE = "QC";
const KPIS = [{"l":"Total Garment Mgmt","v":"1.809","t":"-5.3%","d":"down"},{"l":"QC Ativos","v":"8.550","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"68.3%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"63","t":"-1.2%","d":"down"}];
const COLS = ["ID","QC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Garment Mgmt #001","Garment Mgmt #002","8.386","6.540","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Garment Mgmt #002","Garment Mgmt #003","3.351","2.052","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Garment Mgmt #003","Garment Mgmt #004","4.001","6.010","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Garment Mgmt #004","Garment Mgmt #005","6.657","1.355","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Garment Mgmt #005","Garment Mgmt #001","302","3.892","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":745},{"label":"Mar","value":1005},{"label":"Abr","value":1015},{"label":"Mai","value":835},{"label":"Jun","value":683},{"label":"Jul","value":671},{"label":"Ago","value":687},{"label":"Set","value":707},{"label":"Out","value":968},{"label":"Nov","value":967},{"label":"Dez","value":904}];
const MX = 1015;
