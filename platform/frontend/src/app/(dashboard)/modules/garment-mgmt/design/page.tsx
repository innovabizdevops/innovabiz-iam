...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.888","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"3188","t":"+6.6%","d":"up"},{"l":"Documentos Gerados","v":"6.068","t":"+11.2%","d":"up"},{"l":"Templates","v":"4.501","t":"-5.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.405","2026-01-14","5.466","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.462","2026-03-25","6.126","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.473","2026-02-12","3.689","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.799","2026-02-03","4.978","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.126","2026-02-02","3.873","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":826},{"label":"Mar","value":721},{"label":"Abr","value":847},{"label":"Mai","value":546},{"label":"Jun","value":487},{"label":"Jul","value":837},{"label":"Ago","value":881},{"label":"Set","value":751},{"label":"Out","value":871},{"label":"Nov","value":584},{"label":"Dez","value":800}];
const MX = 881;
