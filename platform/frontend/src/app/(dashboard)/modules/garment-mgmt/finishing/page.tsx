...
const ACCENT = "#6366f1";
const MODULE = "Garment Management";
const PAGE = "Finishing";
const KPIS = [{"l":"Total Garment Mgmt","v":"5.514","t":"+7.2%","d":"up"},{"l":"Finishing Ativos","v":"7.495","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.2%","d":"up"}];
const COLS = ["ID","Finishing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Garment Mgmt #001","Garment Mgmt #002","8.513","3.893","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Garment Mgmt #002","Garment Mgmt #003","4.553","7.723","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Garment Mgmt #003","Garment Mgmt #004","8.114","8.491","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Garment Mgmt #004","Garment Mgmt #005","7.513","263","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Garment Mgmt #005","Garment Mgmt #001","262","7.138","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":466},{"label":"Mar","value":809},{"label":"Abr","value":637},{"label":"Mai","value":851},{"label":"Jun","value":799},{"label":"Jul","value":556},{"label":"Ago","value":712},{"label":"Set","value":633},{"label":"Out","value":839},{"label":"Nov","value":552},{"label":"Dez","value":664}];
const MX = 851;
