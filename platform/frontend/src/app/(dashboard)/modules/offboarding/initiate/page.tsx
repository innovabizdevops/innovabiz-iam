...
const PAGE = "Initiate";
const KPIS = [{"l":"eNPS","v":"75","t":"+13.7%","d":"up"},{"l":"Engagement (%)","v":"76.8%","t":"+12.0%","d":"up"},{"l":"Turnover (%)","v":"68.0%","t":"+12.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.271","t":"+14.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.941","2026-03-05","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.010","2026-01-17","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.779","2026-03-23","95","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.694","2026-03-03","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.238","2026-02-14","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":653},{"label":"Mar","value":704},{"label":"Abr","value":974},{"label":"Mai","value":839},{"label":"Jun","value":714},{"label":"Jul","value":1021},{"label":"Ago","value":964},{"label":"Set","value":677},{"label":"Out","value":639},{"label":"Nov","value":981},{"label":"Dez","value":924}];
const MX = 1021;
