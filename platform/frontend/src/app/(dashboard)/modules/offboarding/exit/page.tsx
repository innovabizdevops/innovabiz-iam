...
const PAGE = "Exit";
const KPIS = [{"l":"eNPS","v":"84","t":"+8.3%","d":"up"},{"l":"Engagement (%)","v":"82.2%","t":"+0.3%","d":"up"},{"l":"Turnover (%)","v":"91.2%","t":"+4.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.984","t":"+11.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","550","2026-02-15","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.763","2026-03-02","72","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.642","2026-03-14","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.711","2026-03-09","87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.321","2026-02-08","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":693},{"label":"Mar","value":428},{"label":"Abr","value":399},{"label":"Mai","value":583},{"label":"Jun","value":616},{"label":"Jul","value":667},{"label":"Ago","value":568},{"label":"Set","value":699},{"label":"Out","value":651},{"label":"Nov","value":342},{"label":"Dez","value":567}];
const MX = 699;
