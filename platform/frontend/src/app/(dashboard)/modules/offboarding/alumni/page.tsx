...
const PAGE = "Alumni";
const KPIS = [{"l":"eNPS","v":"73","t":"+4.9%","d":"up"},{"l":"Engagement (%)","v":"69.4%","t":"+9.0%","d":"up"},{"l":"Turnover (%)","v":"93.0%","t":"+17.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.111","t":"-5.1%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.818","2026-02-09","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.708","2026-02-06","74","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","376","2026-03-25","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.972","2026-02-08","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.646","2026-03-04","58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":1008},{"label":"Mar","value":710},{"label":"Abr","value":931},{"label":"Mai","value":797},{"label":"Jun","value":1061},{"label":"Jul","value":705},{"label":"Ago","value":718},{"label":"Set","value":984},{"label":"Out","value":868},{"label":"Nov","value":1067},{"label":"Dez","value":684}];
const MX = 1067;
