...
const PAGE = "Access";
const KPIS = [{"l":"eNPS","v":"67","t":"+5.6%","d":"up"},{"l":"Engagement (%)","v":"69.2%","t":"+6.1%","d":"up"},{"l":"Turnover (%)","v":"76.0%","t":"-3.8%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.357","t":"-5.0%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.420","2026-02-01","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.058","2026-02-25","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.584","2026-02-11","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.427","2026-01-12","85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","9.094","2026-01-27","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":786},{"label":"Mar","value":524},{"label":"Abr","value":677},{"label":"Mai","value":777},{"label":"Jun","value":424},{"label":"Jul","value":598},{"label":"Ago","value":552},{"label":"Set","value":457},{"label":"Out","value":391},{"label":"Nov","value":654},{"label":"Dez","value":436}];
const MX = 786;
