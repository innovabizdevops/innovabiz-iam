...
const ACCENT = "#0e7490";
const MODULE = "Offboarding Platform Deep";
const PAGE = "Knowledge";
const KPIS = [{"l":"eNPS","v":"78","t":"+17.3%","d":"up"},{"l":"Engagement (%)","v":"69.0%","t":"-1.0%","d":"down"},{"l":"Turnover (%)","v":"94.1%","t":"-1.2%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.558","t":"+7.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.406","2026-02-23","57","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.038","2026-02-06","68","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.714","2026-02-10","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.638","2026-03-12","74","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.828","2026-01-25","61","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":589},{"label":"Mar","value":527},{"label":"Abr","value":674},{"label":"Mai","value":597},{"label":"Jun","value":446},{"label":"Jul","value":508},{"label":"Ago","value":450},{"label":"Set","value":443},{"label":"Out","value":373},{"label":"Nov","value":656},{"label":"Dez","value":612}];
const MX = 674;
