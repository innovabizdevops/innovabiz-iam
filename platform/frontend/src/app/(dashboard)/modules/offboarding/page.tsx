...
/* ═══ Offboarding Platform Deep — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "5762", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2296", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€188K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "691382062", cells: ["OFF-3062", "Offboarding Platform Deep Item 1", "15/11/2026", "€32 162"], status: "active" as const },
    { id: "691385633", cells: ["OFF-6633", "Offboarding Platform Deep Item 2", "2/6/2026", "€35 733"], status: "pending" as const },
    { id: "691389204", cells: ["OFF-1204", "Offboarding Platform Deep Item 3", "17/1/2026", "€39 304"], status: "completed" as const },
    { id: "691392775", cells: ["OFF-4775", "Offboarding Platform Deep Item 4", "4/8/2026", "€42 875"], status: "warning" as const },
    { id: "691396346", cells: ["OFF-8346", "Offboarding Platform Deep Item 5", "19/3/2026", "€46 446"], status: "active" as const },
];
...
export default function OffboardingPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Offboarding Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Offboarding Platform Deep</p>
                    </div>
                </div>
