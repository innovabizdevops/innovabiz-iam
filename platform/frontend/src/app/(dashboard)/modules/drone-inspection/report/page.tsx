...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.576","t":"+15.6%","d":"up"},{"l":"NC Abertas","v":"8.128","t":"+8.5%","d":"up"},{"l":"Conformidade (%)","v":"85.6%","t":"+10.0%","d":"up"},{"l":"CAPAs Pendentes","v":"1.781","t":"+13.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.882","82.3%","5.925","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.566","93.9%","5.061","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.278","99.1%","6.487","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.918","82.1%","3.215","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.983","93.0%","2.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":456},{"label":"Mar","value":503},{"label":"Abr","value":452},{"label":"Mai","value":399},{"label":"Jun","value":373},{"label":"Jul","value":619},{"label":"Ago","value":318},{"label":"Set","value":247},{"label":"Out","value":286},{"label":"Nov","value":386},{"label":"Dez","value":606}];
const MX = 619;
