...
const ACCENT = "#6366f1";
const MODULE = "Drone Inspection";
const PAGE = "Analyze";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.444","t":"+10.8%","d":"up"},{"l":"NC Abertas","v":"1.168","t":"-5.0%","d":"down"},{"l":"Conformidade (%)","v":"65.6%","t":"-0.3%","d":"down"},{"l":"CAPAs Pendentes","v":"4.502","t":"+14.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.365","87.6%","8.976","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.354","78.8%","413","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.168","95.0%","1.558","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.892","95.4%","4.963","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.606","92.0%","7.076","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":598},{"label":"Mar","value":927},{"label":"Abr","value":944},{"label":"Mai","value":834},{"label":"Jun","value":689},{"label":"Jul","value":988},{"label":"Ago","value":727},{"label":"Set","value":894},{"label":"Out","value":616},{"label":"Nov","value":689},{"label":"Dez","value":921}];
const MX = 988;
