...
const PAGE = "Capture";
const KPIS = [{"l":"Auditorias Realizadas","v":"527","t":"+1.9%","d":"up"},{"l":"NC Abertas","v":"2.727","t":"+16.3%","d":"up"},{"l":"Conformidade (%)","v":"79.4%","t":"+15.1%","d":"up"},{"l":"CAPAs Pendentes","v":"1.912","t":"-5.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.513","76.9%","7.394","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.957","76.8%","6.789","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","684","84.6%","7.837","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.721","82.2%","3.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.169","95.9%","1.860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":320},{"label":"Mar","value":522},{"label":"Abr","value":596},{"label":"Mai","value":489},{"label":"Jun","value":673},{"label":"Jul","value":336},{"label":"Ago","value":590},{"label":"Set","value":345},{"label":"Out","value":634},{"label":"Nov","value":339},{"label":"Dez","value":335}];
const MX = 673;
