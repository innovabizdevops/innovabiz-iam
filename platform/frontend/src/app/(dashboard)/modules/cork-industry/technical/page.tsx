...
const ACCENT = "#15803d";
const MODULE = "Cork Industry";
const PAGE = "Technical";
const KPIS = [{"l":"Total Cork Industry","v":"6.051","t":"-3.3%","d":"down"},{"l":"Technical Ativos","v":"3.105","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"69","t":"-0.5%","d":"down"}];
const COLS = ["ID","Technical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cork Industry #001","Cork Industry #002","6.655","2.258","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Cork Industry #002","Cork Industry #003","6.331","1.837","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Cork Industry #003","Cork Industry #004","5.087","880","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cork Industry #004","Cork Industry #005","6.737","3.023","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cork Industry #005","Cork Industry #001","1.626","4.873","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":745},{"label":"Mar","value":650},{"label":"Abr","value":518},{"label":"Mai","value":707},{"label":"Jun","value":808},{"label":"Jul","value":764},{"label":"Ago","value":624},{"label":"Set","value":480},{"label":"Out","value":588},{"label":"Nov","value":453},{"label":"Dez","value":561}];
const MX = 808;
