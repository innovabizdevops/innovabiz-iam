...
/* ═══ Cork Industry — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "3267", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "250", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€114K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1861272467", cells: ["COR-1467", "Cork Industry Item 1", "20/12/2026", "€22 567"], status: "active" as const },
    { id: "1861276038", cells: ["COR-5038", "Cork Industry Item 2", "7/7/2026", "€26 138"], status: "pending" as const },
    { id: "1861279609", cells: ["COR-8609", "Cork Industry Item 3", "22/2/2026", "€29 709"], status: "completed" as const },
    { id: "1861283180", cells: ["COR-3180", "Cork Industry Item 4", "9/9/2026", "€33 280"], status: "warning" as const },
    { id: "1861286751", cells: ["COR-6751", "Cork Industry Item 5", "24/4/2026", "€36 851"], status: "active" as const },
];
...
export default function CorkIndustryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cork Industry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cork Industry</p>
                    </div>
                </div>
