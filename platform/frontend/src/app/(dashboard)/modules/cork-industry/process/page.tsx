...
const PAGE = "Process";
const KPIS = [{"l":"Total Cork Industry","v":"7.562","t":"-1.4%","d":"down"},{"l":"Process Ativos","v":"5.580","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"92","t":"+3.8%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cork Industry #001","Cork Industry #002","7.165","6.250","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cork Industry #002","Cork Industry #003","5.771","5.904","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Cork Industry #003","Cork Industry #004","5.133","2.067","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cork Industry #004","Cork Industry #005","2.561","5.128","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cork Industry #005","Cork Industry #001","6.420","5.318","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":814},{"label":"Mar","value":653},{"label":"Abr","value":606},{"label":"Mai","value":702},{"label":"Jun","value":700},{"label":"Jul","value":640},{"label":"Ago","value":639},{"label":"Set","value":626},{"label":"Out","value":565},{"label":"Nov","value":508},{"label":"Dez","value":654}];
const MX = 887;
