...
/* ═══ Hotel Mgmt — Housekeeping ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4176", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "68", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "95", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1197854960", cells: ["HOT-9960", "Housekeeping Item 1", "9/9/2026", "€5060"], status: "active" as const },
    { id: "1197858531", cells: ["HOT-4531", "Housekeeping Item 2", "24/4/2026", "€8631"], status: "pending" as const },
    { id: "1197862102", cells: ["HOT-8102", "Housekeeping Item 3", "11/11/2026", "€12 202"], status: "completed" as const },
    { id: "1197865673", cells: ["HOT-2673", "Housekeeping Item 4", "26/6/2026", "€15 773"], status: "warning" as const },
    { id: "1197869244", cells: ["HOT-6244", "Housekeeping Item 5", "13/1/2026", "€19 344"], status: "active" as const },
];
...
export default function HotelMgmtHousekeepingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Housekeeping</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Housekeeping</p>
                    </div>
                </div>
