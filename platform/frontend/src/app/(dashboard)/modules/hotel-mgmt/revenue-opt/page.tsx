...
/* ═══ Hotel Mgmt — Revenue Opt ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "2713", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "32", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2011", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "181844060", cells: ["HOT-9060", "Revenue Opt Item 1", "21/9/2026", "€44 160"], status: "active" as const },
    { id: "181847631", cells: ["HOT-3631", "Revenue Opt Item 2", "8/4/2026", "€47 731"], status: "pending" as const },
    { id: "181851202", cells: ["HOT-7202", "Revenue Opt Item 3", "23/11/2026", "€1302"], status: "completed" as const },
    { id: "181854773", cells: ["HOT-1773", "Revenue Opt Item 4", "10/6/2026", "€4873"], status: "warning" as const },
    { id: "181858344", cells: ["HOT-5344", "Revenue Opt Item 5", "25/1/2026", "€8444"], status: "active" as const },
];
...
export default function HotelMgmtRevenueOptPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Revenue Opt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Revenue Opt</p>
                    </div>
                </div>
