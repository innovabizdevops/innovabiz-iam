...
/* ═══ Hotel Mgmt — Reservation Sys ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3812", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "442", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1839", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1951908262", cells: ["HOT-7262", "Reservation Sys Item 1", "11/11/2026", "€8362"], status: "active" as const },
    { id: "1951911833", cells: ["HOT-1833", "Reservation Sys Item 2", "26/6/2026", "€11 933"], status: "pending" as const },
    { id: "1951915404", cells: ["HOT-5404", "Reservation Sys Item 3", "13/1/2026", "€15 504"], status: "completed" as const },
    { id: "1951918975", cells: ["HOT-8975", "Reservation Sys Item 4", "28/8/2026", "€19 075"], status: "warning" as const },
    { id: "1951922546", cells: ["HOT-3546", "Reservation Sys Item 5", "15/3/2026", "€22 646"], status: "active" as const },
];
...
export default function HotelMgmtReservationSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reservation Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Reservation Sys</p>
                    </div>
                </div>
