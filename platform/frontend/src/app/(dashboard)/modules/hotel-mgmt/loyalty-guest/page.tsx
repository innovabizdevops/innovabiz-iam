...
/* ═══ Hotel Mgmt — Loyalty Guest ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3967", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "41", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "481", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "460019221", cells: ["HOT-3221", "Loyalty Guest Item 1", "26/2/2026", "€19 321"], status: "active" as const },
    { id: "460022792", cells: ["HOT-6792", "Loyalty Guest Item 2", "13/9/2026", "€22 892"], status: "pending" as const },
    { id: "460026363", cells: ["HOT-1363", "Loyalty Guest Item 3", "28/4/2026", "€26 463"], status: "completed" as const },
    { id: "460029934", cells: ["HOT-4934", "Loyalty Guest Item 4", "15/11/2026", "€30 034"], status: "warning" as const },
    { id: "460033505", cells: ["HOT-8505", "Loyalty Guest Item 5", "2/6/2026", "€33 605"], status: "active" as const },
];
...
export default function HotelMgmtLoyaltyGuestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loyalty Guest</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Loyalty Guest</p>
                    </div>
                </div>
