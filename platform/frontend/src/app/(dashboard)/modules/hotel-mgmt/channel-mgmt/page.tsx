...
/* ═══ Hotel Mgmt — Channel Mgmt ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3417", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "99", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "643", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2060154959", cells: ["HOT-1959", "Channel Mgmt Item 1", "24/12/2026", "€5059"], status: "active" as const },
    { id: "2060158530", cells: ["HOT-5530", "Channel Mgmt Item 2", "11/7/2026", "€8630"], status: "pending" as const },
    { id: "2060162101", cells: ["HOT-9101", "Channel Mgmt Item 3", "26/2/2026", "€12 201"], status: "completed" as const },
    { id: "2060165672", cells: ["HOT-3672", "Channel Mgmt Item 4", "13/9/2026", "€15 772"], status: "warning" as const },
    { id: "2060169243", cells: ["HOT-7243", "Channel Mgmt Item 5", "28/4/2026", "€19 343"], status: "active" as const },
];
...
export default function HotelMgmtChannelMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Channel Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Channel Mgmt</p>
                    </div>
                </div>
