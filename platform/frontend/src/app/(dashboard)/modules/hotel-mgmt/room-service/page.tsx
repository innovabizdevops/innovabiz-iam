...
/* ═══ Hotel Mgmt — Room Service ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "2769", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "471", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2971", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1819691555", cells: ["HOT-9555", "Room Service Item 1", "4/12/2026", "€41 655"], status: "active" as const },
    { id: "1819695126", cells: ["HOT-4126", "Room Service Item 2", "19/7/2026", "€45 226"], status: "pending" as const },
    { id: "1819698697", cells: ["HOT-7697", "Room Service Item 3", "6/2/2026", "€48 797"], status: "completed" as const },
    { id: "1819702268", cells: ["HOT-2268", "Room Service Item 4", "21/9/2026", "€2368"], status: "warning" as const },
    { id: "1819705839", cells: ["HOT-5839", "Room Service Item 5", "8/4/2026", "€5939"], status: "active" as const },
];
...
export default function HotelMgmtRoomServicePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Room Service</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Room Service</p>
                    </div>
                </div>
