...
/* ═══ Hotel Mgmt — Event Banquet ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1867", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "331", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3551", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "91174071", cells: ["HOT-5071", "Event Banquet Item 1", "24/4/2026", "€24 171"], status: "active" as const },
    { id: "91177642", cells: ["HOT-8642", "Event Banquet Item 2", "11/11/2026", "€27 742"], status: "pending" as const },
    { id: "91181213", cells: ["HOT-3213", "Event Banquet Item 3", "26/6/2026", "€31 313"], status: "completed" as const },
    { id: "91184784", cells: ["HOT-6784", "Event Banquet Item 4", "13/1/2026", "€34 884"], status: "warning" as const },
    { id: "91188355", cells: ["HOT-1355", "Event Banquet Item 5", "28/8/2026", "€38 455"], status: "active" as const },
];
...
export default function HotelMgmtEventBanquetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Banquet</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Event Banquet</p>
                    </div>
                </div>
