...
/* ═══ Hotel Mgmt — Guest Feedback ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1994", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2324", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2017117696", cells: ["HOT-2696", "Guest Feedback Item 1", "21/5/2026", "€17 796"], status: "active" as const },
    { id: "2017121267", cells: ["HOT-6267", "Guest Feedback Item 2", "8/12/2026", "€21 367"], status: "pending" as const },
    { id: "2017124838", cells: ["HOT-9838", "Guest Feedback Item 3", "23/7/2026", "€24 938"], status: "completed" as const },
    { id: "2017128409", cells: ["HOT-4409", "Guest Feedback Item 4", "10/2/2026", "€28 509"], status: "warning" as const },
    { id: "2017131980", cells: ["HOT-7980", "Guest Feedback Item 5", "25/9/2026", "€32 080"], status: "active" as const },
];
...
export default function HotelMgmtGuestFeedbackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Guest Feedback</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Guest Feedback</p>
                    </div>
                </div>
