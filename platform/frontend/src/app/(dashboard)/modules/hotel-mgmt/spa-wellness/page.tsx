...
/* ═══ Hotel Mgmt — Spa Wellness ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4374", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "184", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1477", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "698191124", cells: ["HOT-8124", "Spa Wellness Item 1", "9/9/2026", "€41 224"], status: "active" as const },
    { id: "698194695", cells: ["HOT-2695", "Spa Wellness Item 2", "24/4/2026", "€44 795"], status: "pending" as const },
    { id: "698198266", cells: ["HOT-6266", "Spa Wellness Item 3", "11/11/2026", "€48 366"], status: "completed" as const },
    { id: "698201837", cells: ["HOT-9837", "Spa Wellness Item 4", "26/6/2026", "€1937"], status: "warning" as const },
    { id: "698205408", cells: ["HOT-4408", "Spa Wellness Item 5", "13/1/2026", "€5508"], status: "active" as const },
];
...
export default function HotelMgmtSpaWellnessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Spa Wellness</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Spa Wellness</p>
                    </div>
                </div>
