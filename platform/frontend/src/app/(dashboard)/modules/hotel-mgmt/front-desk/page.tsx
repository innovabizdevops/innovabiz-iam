...
/* ═══ Hotel Mgmt — Front Desk ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3552", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "433", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2173", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1283970845", cells: ["HOT-4845", "Front Desk Item 1", "18/6/2026", "€20 945"], status: "active" as const },
    { id: "1283974416", cells: ["HOT-8416", "Front Desk Item 2", "5/1/2026", "€24 516"], status: "pending" as const },
    { id: "1283977987", cells: ["HOT-2987", "Front Desk Item 3", "20/8/2026", "€28 087"], status: "completed" as const },
    { id: "1283981558", cells: ["HOT-6558", "Front Desk Item 4", "7/3/2026", "€31 658"], status: "warning" as const },
    { id: "1283985129", cells: ["HOT-1129", "Front Desk Item 5", "22/10/2026", "€35 229"], status: "active" as const },
];
...
export default function HotelMgmtFrontDeskPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Front Desk</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Hotel Mgmt • Front Desk</p>
                    </div>
                </div>
