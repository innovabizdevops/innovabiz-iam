...
/* ═══ Veteran Services Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8445", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3178", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€301K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "931073645", cells: ["VET-6645", "Veteran Services Platform Item 1", "6/6/2026", "€23 745"], status: "active" as const },
    { id: "931077216", cells: ["VET-1216", "Veteran Services Platform Item 2", "21/1/2026", "€27 316"], status: "pending" as const },
    { id: "931080787", cells: ["VET-4787", "Veteran Services Platform Item 3", "8/8/2026", "€30 887"], status: "completed" as const },
    { id: "931084358", cells: ["VET-8358", "Veteran Services Platform Item 4", "23/3/2026", "€34 458"], status: "warning" as const },
    { id: "931087929", cells: ["VET-2929", "Veteran Services Platform Item 5", "10/10/2026", "€38 029"], status: "active" as const },
];
...
export default function VeteranServicesPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Veteran Services Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Veteran Services Platform</p>
                    </div>
                </div>
