...
const PAGE = "Housing";
const KPIS = [{"l":"Total Veteran Services","v":"8.336","t":"+11.3%","d":"up"},{"l":"Housing Ativos","v":"610","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"76","t":"+3.5%","d":"up"}];
const COLS = ["ID","Housing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Services #001","Veteran Services #002","4.696","1.204","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Services #002","Veteran Services #003","9.087","5.407","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Services #003","Veteran Services #004","7.989","7.773","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Services #004","Veteran Services #005","8.099","7.281","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Services #005","Veteran Services #001","4.860","2.702","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":579},{"label":"Mar","value":785},{"label":"Abr","value":574},{"label":"Mai","value":744},{"label":"Jun","value":845},{"label":"Jul","value":821},{"label":"Ago","value":647},{"label":"Set","value":692},{"label":"Out","value":832},{"label":"Nov","value":676},{"label":"Dez","value":652}];
const MX = 845;
