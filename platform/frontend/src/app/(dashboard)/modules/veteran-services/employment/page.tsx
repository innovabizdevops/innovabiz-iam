...
const ACCENT = "#1e3a5f";
const MODULE = "Veteran Services Platform";
const PAGE = "Employment";
const KPIS = [{"l":"Total Veteran Services","v":"4.775","t":"-5.6%","d":"down"},{"l":"Employment Ativos","v":"4.254","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"78","t":"+3.9%","d":"up"}];
const COLS = ["ID","Employment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Services #001","Veteran Services #002","2.835","8.430","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Services #002","Veteran Services #003","5.761","2.694","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Services #003","Veteran Services #004","8.323","2.049","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Services #004","Veteran Services #005","549","6.766","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Services #005","Veteran Services #001","5.108","3.869","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":750},{"label":"Mar","value":687},{"label":"Abr","value":747},{"label":"Mai","value":715},{"label":"Jun","value":518},{"label":"Jul","value":590},{"label":"Ago","value":755},{"label":"Set","value":704},{"label":"Out","value":555},{"label":"Nov","value":717},{"label":"Dez","value":701}];
const MX = 755;
