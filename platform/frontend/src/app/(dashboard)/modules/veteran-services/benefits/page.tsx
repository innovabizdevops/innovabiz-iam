...
const PAGE = "Benefits";
const KPIS = [{"l":"Total Veteran Services","v":"2.384","t":"+0.9%","d":"up"},{"l":"Benefits Ativos","v":"6.570","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"79.7%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.2%","d":"up"}];
const COLS = ["ID","Benefits","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Services #001","Veteran Services #002","2.504","157","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Services #002","Veteran Services #003","2.313","6.242","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Services #003","Veteran Services #004","6.982","4.686","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Services #004","Veteran Services #005","9.005","6.753","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Services #005","Veteran Services #001","1.391","4.900","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":965},{"label":"Fev","value":862},{"label":"Mar","value":738},{"label":"Abr","value":825},{"label":"Mai","value":715},{"label":"Jun","value":826},{"label":"Jul","value":943},{"label":"Ago","value":853},{"label":"Set","value":824},{"label":"Out","value":745},{"label":"Nov","value":918},{"label":"Dez","value":706}];
const MX = 965;
