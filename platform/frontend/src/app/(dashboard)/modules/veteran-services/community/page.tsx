...
const KPIS = [{"l":"Projetos Sociais","v":"3.952","t":"-3.2%","d":"down"},{"l":"Beneficiários","v":"3.039","t":"+14.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€97718","t":"-4.4%","d":"down"},{"l":"Score Impacto","v":"58","t":"-1.9%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.173","€ 16277.63","3.827","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.721","€ 4259.39","4.625","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","697","€ 6476.87","4.089","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.644","€ 18315.76","1.875","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.327","€ 32376.10","6.717","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":264},{"label":"Mar","value":428},{"label":"Abr","value":387},{"label":"Mai","value":363},{"label":"Jun","value":411},{"label":"Jul","value":370},{"label":"Ago","value":530},{"label":"Set","value":378},{"label":"Out","value":540},{"label":"Nov","value":488},{"label":"Dez","value":387}];
const MX = 540;
