...
const PAGE = "Health";
const KPIS = [{"l":"Total Veteran Services","v":"4.955","t":"-5.0%","d":"down"},{"l":"Health Ativos","v":"3.164","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"58","t":"+2.9%","d":"up"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Services #001","Veteran Services #002","1.307","2.310","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Services #002","Veteran Services #003","7.368","8.630","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Services #003","Veteran Services #004","3.362","8.244","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Services #004","Veteran Services #005","7.668","1.953","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Services #005","Veteran Services #001","5.517","1.361","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":795},{"label":"Mar","value":758},{"label":"Abr","value":573},{"label":"Mai","value":533},{"label":"Jun","value":680},{"label":"Jul","value":819},{"label":"Ago","value":756},{"label":"Set","value":573},{"label":"Out","value":544},{"label":"Nov","value":647},{"label":"Dez","value":643}];
const MX = 819;
