...
/* ═══ Insurance Distribution — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "8698", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4117", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€86K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "52894398", cells: ["INS-2398", "Insurance Distribution Item 1", "19/7/2026", "€44 498"], status: "active" as const },
    { id: "52897969", cells: ["INS-5969", "Insurance Distribution Item 2", "6/2/2026", "€48 069"], status: "pending" as const },
    { id: "52901540", cells: ["INS-9540", "Insurance Distribution Item 3", "21/9/2026", "€1640"], status: "completed" as const },
    { id: "52905111", cells: ["INS-4111", "Insurance Distribution Item 4", "8/4/2026", "€5211"], status: "warning" as const },
    { id: "52908682", cells: ["INS-7682", "Insurance Distribution Item 5", "23/11/2026", "€8782"], status: "active" as const },
];
...
export default function InsuranceDistributionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insurance Distribution</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Insurance Distribution</p>
                    </div>
                </div>
