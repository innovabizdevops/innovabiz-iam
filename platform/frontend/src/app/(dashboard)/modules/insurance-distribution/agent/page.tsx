...
const PAGE = "Agent";
const KPIS = [{"l":"Total Insurance Distribution","v":"1.790","t":"+14.2%","d":"up"},{"l":"Agent Ativos","v":"2.530","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"94","t":"-3.9%","d":"down"}];
const COLS = ["ID","Agent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Distribution #001","Insurance Distribution #002","2.015","7.897","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Distribution #002","Insurance Distribution #003","5.991","249","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Distribution #003","Insurance Distribution #004","4.999","8.447","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Distribution #004","Insurance Distribution #005","8.922","2.094","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Distribution #005","Insurance Distribution #001","8.873","7.820","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":923},{"label":"Mar","value":664},{"label":"Abr","value":813},{"label":"Mai","value":628},{"label":"Jun","value":674},{"label":"Jul","value":903},{"label":"Ago","value":881},{"label":"Set","value":860},{"label":"Out","value":906},{"label":"Nov","value":788},{"label":"Dez","value":830}];
const MX = 923;
