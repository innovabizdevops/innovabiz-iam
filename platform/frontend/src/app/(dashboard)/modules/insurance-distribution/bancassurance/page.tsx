...
const ACCENT = "#92400e";
const MODULE = "Insurance Distribution";
const PAGE = "Bancassurance";
const KPIS = [{"l":"Total Insurance Distribution","v":"1.533","t":"+16.8%","d":"up"},{"l":"Bancassurance Ativos","v":"5.596","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+0.3%","d":"up"}];
const COLS = ["ID","Bancassurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurance Distribution #001","Insurance Distribution #002","4.022","8.743","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Insurance Distribution #002","Insurance Distribution #003","3.764","2.882","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurance Distribution #003","Insurance Distribution #004","5.987","4.163","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Insurance Distribution #004","Insurance Distribution #005","8.701","2.365","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurance Distribution #005","Insurance Distribution #001","6.406","4.697","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":479},{"label":"Mar","value":519},{"label":"Abr","value":434},{"label":"Mai","value":382},{"label":"Jun","value":489},{"label":"Jul","value":301},{"label":"Ago","value":658},{"label":"Set","value":628},{"label":"Out","value":659},{"label":"Nov","value":511},{"label":"Dez","value":341}];
const MX = 659;
...
export default function BancassurancePage() {
    return (
