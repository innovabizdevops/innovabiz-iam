...
const KPIS = [{"l":"Vendas YTD (€)","v":"€57928","t":"-5.5%","d":"down"},{"l":"Pipeline (€)","v":"€37833","t":"+0.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.0%","t":"+5.4%","d":"up"},{"l":"Win Rate (%)","v":"68.4%","t":"+11.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 41718.59","€ 12665.80","€ 43071.00","85.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 43006.71","€ 5382.10","€ 9083.34","73.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 10907.79","€ 11165.13","€ 33999.92","81.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 48589.61","€ 23707.41","€ 12235.33","78.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 33786.80","€ 42406.31","€ 15870.01","77.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":611},{"label":"Mar","value":808},{"label":"Abr","value":693},{"label":"Mai","value":737},{"label":"Jun","value":837},{"label":"Jul","value":603},{"label":"Ago","value":571},{"label":"Set","value":465},{"label":"Out","value":636},{"label":"Nov","value":747},{"label":"Dez","value":511}];
const MX = 837;
