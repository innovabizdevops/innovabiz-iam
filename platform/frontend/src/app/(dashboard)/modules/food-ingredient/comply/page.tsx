...
const ACCENT = "#6366f1";
const MODULE = "Food Ingredients";
const PAGE = "Comply";
const KPIS = [{"l":"Integrações Ativas","v":"360","t":"+10.3%","d":"up"},{"l":"Chamadas/Hora","v":"4852","t":"+5.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.7%","t":"+16.0%","d":"up"},{"l":"Latência Média (ms)","v":"198ms","t":"-0.1%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.520","6.844","78.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.927","1.700","99.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.506","1.170","97.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.180","2.231","87.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.736","2.405","86.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":683},{"label":"Mar","value":926},{"label":"Abr","value":823},{"label":"Mai","value":726},{"label":"Jun","value":672},{"label":"Jul","value":945},{"label":"Ago","value":607},{"label":"Set","value":617},{"label":"Out","value":894},{"label":"Nov","value":778},{"label":"Dez","value":823}];
const MX = 945;
