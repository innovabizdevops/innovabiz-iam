...
const PAGE = "Source";
const KPIS = [{"l":"Integrações Ativas","v":"5.559","t":"+3.3%","d":"up"},{"l":"Chamadas/Hora","v":"4057","t":"+5.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.1%","t":"-2.9%","d":"down"},{"l":"Latência Média (ms)","v":"184ms","t":"+16.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.031","1.486","82.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.962","264","71.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.037","2.667","87.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.765","7.649","91.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.581","1.850","84.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":482},{"label":"Mar","value":348},{"label":"Abr","value":687},{"label":"Mai","value":660},{"label":"Jun","value":599},{"label":"Jul","value":511},{"label":"Ago","value":481},{"label":"Set","value":670},{"label":"Out","value":505},{"label":"Nov","value":682},{"label":"Dez","value":459}];
const MX = 687;
