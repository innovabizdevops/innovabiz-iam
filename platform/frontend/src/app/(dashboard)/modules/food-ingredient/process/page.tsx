...
const PAGE = "Process";
const KPIS = [{"l":"Integrações Ativas","v":"6.693","t":"+15.8%","d":"up"},{"l":"Chamadas/Hora","v":"467","t":"+2.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.6%","t":"+16.9%","d":"up"},{"l":"Latência Média (ms)","v":"204ms","t":"-4.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.098","8.494","76.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.650","1.585","88.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.190","2.514","89.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.850","3.438","96.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.788","1.162","71.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":748},{"label":"Mar","value":703},{"label":"Abr","value":605},{"label":"Mai","value":580},{"label":"Jun","value":887},{"label":"Jul","value":633},{"label":"Ago","value":798},{"label":"Set","value":740},{"label":"Out","value":681},{"label":"Nov","value":785},{"label":"Dez","value":735}];
const MX = 887;
