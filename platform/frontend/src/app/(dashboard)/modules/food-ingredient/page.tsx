...
export default function FoodIngredientPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Food Ingredient</h1><p className="text-sm text-muted-foreground">Food Ingredient • iBOS Enterprise</p></div>
