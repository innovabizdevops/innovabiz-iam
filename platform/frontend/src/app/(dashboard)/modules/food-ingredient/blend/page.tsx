...
const PAGE = "Blend";
const KPIS = [{"l":"Integrações Ativas","v":"1.333","t":"-5.9%","d":"down"},{"l":"Chamadas/Hora","v":"4436","t":"-5.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"70.4%","t":"-1.8%","d":"down"},{"l":"Latência Média (ms)","v":"41ms","t":"+9.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.855","3.837","99.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.461","6.174","79.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.473","4.044","98.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","994","7.425","92.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.034","8.669","74.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":253},{"label":"Fev","value":373},{"label":"Mar","value":497},{"label":"Abr","value":578},{"label":"Mai","value":255},{"label":"Jun","value":320},{"label":"Jul","value":358},{"label":"Ago","value":554},{"label":"Set","value":549},{"label":"Out","value":258},{"label":"Nov","value":246},{"label":"Dez","value":432}];
const MX = 578;
