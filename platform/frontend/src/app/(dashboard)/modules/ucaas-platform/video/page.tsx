...
const PAGE = "Video";
const KPIS = [{"l":"Formulários Ativos","v":"1.564","t":"+4.0%","d":"up"},{"l":"Submissões/Dia","v":"3236","t":"-0.2%","d":"down"},{"l":"Documentos Gerados","v":"473","t":"+12.5%","d":"up"},{"l":"Templates","v":"5.166","t":"-0.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.243","2026-02-04","869","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.073","2026-03-22","2.479","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.671","2026-02-10","590","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.787","2026-01-24","4.812","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.359","2026-01-17","5.836","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":704},{"label":"Mar","value":438},{"label":"Abr","value":589},{"label":"Mai","value":569},{"label":"Jun","value":409},{"label":"Jul","value":316},{"label":"Ago","value":562},{"label":"Set","value":701},{"label":"Out","value":632},{"label":"Nov","value":684},{"label":"Dez","value":708}];
const MX = 708;
