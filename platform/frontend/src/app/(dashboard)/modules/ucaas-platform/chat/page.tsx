...
const PAGE = "Chat";
const KPIS = [{"l":"Formulários Ativos","v":"1.901","t":"+15.2%","d":"up"},{"l":"Submissões/Dia","v":"2541","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"516","t":"+5.4%","d":"up"},{"l":"Templates","v":"8.964","t":"-4.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.562","2026-01-17","7.508","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.214","2026-02-01","718","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.202","2026-02-27","8.297","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.121","2026-03-19","3.513","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","427","2026-02-10","180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":684},{"label":"Mar","value":892},{"label":"Abr","value":714},{"label":"Mai","value":830},{"label":"Jun","value":763},{"label":"Jul","value":1023},{"label":"Ago","value":764},{"label":"Set","value":782},{"label":"Out","value":905},{"label":"Nov","value":650},{"label":"Dez","value":636}];
const MX = 1023;
