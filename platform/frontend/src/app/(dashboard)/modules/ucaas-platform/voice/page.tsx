...
const PAGE = "Voice";
const KPIS = [{"l":"Formulários Ativos","v":"1.721","t":"+14.7%","d":"up"},{"l":"Submissões/Dia","v":"1953","t":"+1.2%","d":"up"},{"l":"Documentos Gerados","v":"5.759","t":"-1.3%","d":"down"},{"l":"Templates","v":"2.183","t":"+14.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.559","2026-02-16","5.166","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.707","2026-01-13","2.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.979","2026-02-15","2.909","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.851","2026-01-09","3.531","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.335","2026-01-24","7.806","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":481},{"label":"Mar","value":412},{"label":"Abr","value":668},{"label":"Mai","value":663},{"label":"Jun","value":728},{"label":"Jul","value":475},{"label":"Ago","value":589},{"label":"Set","value":582},{"label":"Out","value":623},{"label":"Nov","value":583},{"label":"Dez","value":509}];
const MX = 728;
