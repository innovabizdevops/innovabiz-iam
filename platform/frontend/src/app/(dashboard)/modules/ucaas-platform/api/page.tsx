...
const PAGE = "API";
const KPIS = [{"l":"Formulários Ativos","v":"4.266","t":"+3.5%","d":"up"},{"l":"Submissões/Dia","v":"1422","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"2.629","t":"+16.2%","d":"up"},{"l":"Templates","v":"2.276","t":"+8.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.551","2026-02-05","4.721","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.889","2026-02-11","6.141","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.964","2026-02-09","5.300","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.421","2026-02-21","8.493","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.163","2026-01-26","6.660","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":465},{"label":"Mar","value":689},{"label":"Abr","value":698},{"label":"Mai","value":532},{"label":"Jun","value":328},{"label":"Jul","value":476},{"label":"Ago","value":474},{"label":"Set","value":479},{"label":"Out","value":588},{"label":"Nov","value":387},{"label":"Dez","value":530}];
const MX = 698;
