...
const ACCENT = "#ea580c";
const MODULE = "UCaaS Platform";
const PAGE = "Collaborate";
const KPIS = [{"l":"Formulários Ativos","v":"7.434","t":"+17.5%","d":"up"},{"l":"Submissões/Dia","v":"1800","t":"+4.7%","d":"up"},{"l":"Documentos Gerados","v":"3.132","t":"+10.2%","d":"up"},{"l":"Templates","v":"6.072","t":"+9.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.462","2026-01-12","5.700","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.244","2026-02-17","8.121","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","405","2026-02-18","4.129","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.813","2026-03-20","7.017","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.836","2026-01-26","8.761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":946},{"label":"Mar","value":862},{"label":"Abr","value":770},{"label":"Mai","value":722},{"label":"Jun","value":666},{"label":"Jul","value":704},{"label":"Ago","value":866},{"label":"Set","value":991},{"label":"Out","value":976},{"label":"Nov","value":742},{"label":"Dez","value":910}];
const MX = 991;
