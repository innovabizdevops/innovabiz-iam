...
const PAGE = "Lead Opt";
const KPIS = [{"l":"Total Drug Discovery","v":"7.530","t":"+2.8%","d":"up"},{"l":"Lead Opt Ativos","v":"4.248","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+15.5%","d":"up"}];
const COLS = ["ID","Lead Opt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Discovery #001","Drug Discovery #002","4.873","6.257","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Discovery #002","Drug Discovery #003","2.060","4.179","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Discovery #003","Drug Discovery #004","2.950","9.095","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Discovery #004","Drug Discovery #005","3.141","5.859","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Discovery #005","Drug Discovery #001","1.208","2.474","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":726},{"label":"Mar","value":784},{"label":"Abr","value":638},{"label":"Mai","value":593},{"label":"Jun","value":550},{"label":"Jul","value":413},{"label":"Ago","value":604},{"label":"Set","value":525},{"label":"Out","value":777},{"label":"Nov","value":639},{"label":"Dez","value":556}];
const MX = 784;
