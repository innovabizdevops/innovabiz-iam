...
const ACCENT = "#6366f1";
const MODULE = "Drug Discovery";
const PAGE = "In Silico";
const KPIS = [{"l":"Total Drug Discovery","v":"2.408","t":"+1.4%","d":"up"},{"l":"In Silico Ativos","v":"3.475","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"90","t":"-1.2%","d":"down"}];
const COLS = ["ID","In Silico","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Discovery #001","Drug Discovery #002","7.385","7.392","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Discovery #002","Drug Discovery #003","3.691","3.884","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Discovery #003","Drug Discovery #004","2.298","6.859","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Discovery #004","Drug Discovery #005","5.223","7.729","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Discovery #005","Drug Discovery #001","4.176","1.960","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":650},{"label":"Mar","value":713},{"label":"Abr","value":522},{"label":"Mai","value":333},{"label":"Jun","value":567},{"label":"Jul","value":415},{"label":"Ago","value":617},{"label":"Set","value":604},{"label":"Out","value":670},{"label":"Nov","value":430},{"label":"Dez","value":411}];
const MX = 713;
...
export default function SilicoPage() {
    return (
