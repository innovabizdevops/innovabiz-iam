...
const PAGE = "HTS";
const KPIS = [{"l":"Total Drug Discovery","v":"7.179","t":"+9.8%","d":"up"},{"l":"HTS Ativos","v":"8.176","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"68","t":"-0.7%","d":"down"}];
const COLS = ["ID","HTS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Discovery #001","Drug Discovery #002","7.300","3.629","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Discovery #002","Drug Discovery #003","1.191","4.873","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Discovery #003","Drug Discovery #004","1.538","8.022","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Discovery #004","Drug Discovery #005","7.150","594","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Discovery #005","Drug Discovery #001","5.955","1.212","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":939},{"label":"Mar","value":880},{"label":"Abr","value":740},{"label":"Mai","value":954},{"label":"Jun","value":578},{"label":"Jul","value":920},{"label":"Ago","value":589},{"label":"Set","value":760},{"label":"Out","value":776},{"label":"Nov","value":587},{"label":"Dez","value":914}];
const MX = 954;
