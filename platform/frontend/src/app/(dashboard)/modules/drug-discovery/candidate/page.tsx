...
const KPIS = [{"l":"Total Drug Discovery","v":"2.923","t":"+4.3%","d":"up"},{"l":"Candidate Ativos","v":"8.191","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"94","t":"+0.3%","d":"up"}];
const COLS = ["ID","Candidate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Discovery #001","Drug Discovery #002","4.754","4.048","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Discovery #002","Drug Discovery #003","6.618","484","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Discovery #003","Drug Discovery #004","5.281","8.916","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Discovery #004","Drug Discovery #005","8.424","6.024","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Discovery #005","Drug Discovery #001","4.139","5.387","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":313},{"label":"Fev","value":470},{"label":"Mar","value":519},{"label":"Abr","value":318},{"label":"Mai","value":298},{"label":"Jun","value":347},{"label":"Jul","value":282},{"label":"Ago","value":532},{"label":"Set","value":234},{"label":"Out","value":476},{"label":"Nov","value":440},{"label":"Dez","value":459}];
const MX = 532;
