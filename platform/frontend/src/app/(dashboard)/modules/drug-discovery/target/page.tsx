...
const KPIS = [{"l":"Total Drug Discovery","v":"6.819","t":"+0.9%","d":"up"},{"l":"Target ID Ativos","v":"2.462","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"77.2%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"58","t":"+13.0%","d":"up"}];
const COLS = ["ID","Target ID","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Discovery #001","Drug Discovery #002","2.370","2.621","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Discovery #002","Drug Discovery #003","6.670","6.859","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Discovery #003","Drug Discovery #004","2.623","2.066","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Discovery #004","Drug Discovery #005","859","7.485","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Discovery #005","Drug Discovery #001","4.217","5.504","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":351},{"label":"Mar","value":725},{"label":"Abr","value":386},{"label":"Mai","value":506},{"label":"Jun","value":470},{"label":"Jul","value":681},{"label":"Ago","value":430},{"label":"Set","value":551},{"label":"Out","value":372},{"label":"Nov","value":546},{"label":"Dez","value":573}];
const MX = 725;
