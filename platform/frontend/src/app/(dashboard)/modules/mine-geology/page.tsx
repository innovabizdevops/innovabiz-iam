...
export default function MineGeologyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mine Geology</h1><p className="text-sm text-muted-foreground">Mine Geology • iBOS Enterprise</p></div>
