...
const ACCENT = "#6366f1";
const MODULE = "Mine Geology";
const PAGE = "Resource Est";
const KPIS = [{"l":"Total Mine Geology","v":"246","t":"-5.0%","d":"down"},{"l":"Resource Est Ativos","v":"8.246","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"93.7%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"60","t":"-0.9%","d":"down"}];
const COLS = ["ID","Resource Est","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Geology #001","Mine Geology #002","4.399","8.638","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Geology #002","Mine Geology #003","5.604","6.172","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Geology #003","Mine Geology #004","3.749","1.646","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Geology #004","Mine Geology #005","4.945","6.556","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Geology #005","Mine Geology #001","4.782","831","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":597},{"label":"Mar","value":642},{"label":"Abr","value":538},{"label":"Mai","value":581},{"label":"Jun","value":703},{"label":"Jul","value":574},{"label":"Ago","value":434},{"label":"Set","value":590},{"label":"Out","value":598},{"label":"Nov","value":792},{"label":"Dez","value":722}];
const MX = 792;
