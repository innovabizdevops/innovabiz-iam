...
const PAGE = "Core Log";
const KPIS = [{"l":"Total Mine Geology","v":"7.721","t":"-1.3%","d":"down"},{"l":"Core Log Ativos","v":"635","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"76","t":"-4.8%","d":"down"}];
const COLS = ["ID","Core Log","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Geology #001","Mine Geology #002","7.529","8.376","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Geology #002","Mine Geology #003","5.803","7.182","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Geology #003","Mine Geology #004","2.193","5.469","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Geology #004","Mine Geology #005","3.455","3.909","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Geology #005","Mine Geology #001","2.537","4.008","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":417},{"label":"Mar","value":371},{"label":"Abr","value":303},{"label":"Mai","value":299},{"label":"Jun","value":264},{"label":"Jul","value":503},{"label":"Ago","value":639},{"label":"Set","value":454},{"label":"Out","value":540},{"label":"Nov","value":385},{"label":"Dez","value":509}];
const MX = 639;
