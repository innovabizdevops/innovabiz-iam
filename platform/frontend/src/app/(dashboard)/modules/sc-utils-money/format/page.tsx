...
const PAGE = "Format";
const KPIS = [{"l":"Formulários Ativos","v":"3.015","t":"+9.6%","d":"up"},{"l":"Submissões/Dia","v":"2937","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"4.417","t":"+13.7%","d":"up"},{"l":"Templates","v":"2.687","t":"+4.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.482","2026-02-03","8.864","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.697","2026-01-24","4.785","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.212","2026-03-15","3.774","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.422","2026-03-15","7.795","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.934","2026-03-14","4.599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":617},{"label":"Mar","value":486},{"label":"Abr","value":466},{"label":"Mai","value":340},{"label":"Jun","value":553},{"label":"Jul","value":552},{"label":"Ago","value":351},{"label":"Set","value":309},{"label":"Out","value":380},{"label":"Nov","value":422},{"label":"Dez","value":612}];
const MX = 658;
