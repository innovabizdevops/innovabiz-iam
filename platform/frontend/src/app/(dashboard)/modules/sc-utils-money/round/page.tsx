...
const ACCENT = "#0284c7";
const MODULE = "SC: Utils Money & Currency";
const PAGE = "Round";
const KPIS = [{"l":"Total Sc Utils Money","v":"7.738","t":"-0.3%","d":"down"},{"l":"Round Ativos","v":"2.524","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"79.2%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"63","t":"+10.0%","d":"up"}];
const COLS = ["ID","Round","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Utils Money #001","Sc Utils Money #002","6.699","6.683","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Utils Money #002","Sc Utils Money #003","7.392","2.404","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Utils Money #003","Sc Utils Money #004","8.030","1.250","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Utils Money #004","Sc Utils Money #005","5.829","1.904","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Utils Money #005","Sc Utils Money #001","3.563","5.504","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":888},{"label":"Mar","value":742},{"label":"Abr","value":924},{"label":"Mai","value":820},{"label":"Jun","value":733},{"label":"Jul","value":972},{"label":"Ago","value":672},{"label":"Set","value":967},{"label":"Out","value":782},{"label":"Nov","value":789},{"label":"Dez","value":962}];
const MX = 972;
