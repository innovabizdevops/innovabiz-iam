...
const PAGE = "Locale";
const KPIS = [{"l":"Configurações","v":"1.822","t":"+10.9%","d":"up"},{"l":"Últimas Alterações","v":"4.350","t":"+10.7%","d":"up"},{"l":"Ambientes","v":"5.259","t":"+13.1%","d":"up"},{"l":"Versão Config","v":"1.220","t":"+4.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 42210.03","5.136","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 43415.15","555","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 19999.26","5.487","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 15339.70","7.012","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 26470.65","2.971","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":470},{"label":"Mar","value":629},{"label":"Abr","value":700},{"label":"Mai","value":525},{"label":"Jun","value":511},{"label":"Jul","value":519},{"label":"Ago","value":415},{"label":"Set","value":572},{"label":"Out","value":597},{"label":"Nov","value":475},{"label":"Dez","value":471}];
const MX = 700;
