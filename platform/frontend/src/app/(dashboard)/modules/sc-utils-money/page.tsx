...
/* ═══ SC: Utils Money & Currency — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "9662", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1619", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€346K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1359418162", cells: ["SC-5162", "SC: Utils Money & Currency Item 1", "19/11/2026", "€18 262"], status: "active" as const },
    { id: "1359421733", cells: ["SC-8733", "SC: Utils Money & Currency Item 2", "6/6/2026", "€21 833"], status: "pending" as const },
    { id: "1359425304", cells: ["SC-3304", "SC: Utils Money & Currency Item 3", "21/1/2026", "€25 404"], status: "completed" as const },
    { id: "1359428875", cells: ["SC-6875", "SC: Utils Money & Currency Item 4", "8/8/2026", "€28 975"], status: "warning" as const },
    { id: "1359432446", cells: ["SC-1446", "SC: Utils Money & Currency Item 5", "23/3/2026", "€32 546"], status: "active" as const },
];
...
export default function ScUtilsMoneyCurrencyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Utils Money & Currency</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Utils Money & Currency</p>
                    </div>
                </div>
