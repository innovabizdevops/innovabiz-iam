...
const PAGE = "Convert";
const KPIS = [{"l":"Total Sc Utils Money","v":"8.015","t":"+9.0%","d":"up"},{"l":"Convert Ativos","v":"6.862","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"60","t":"+5.0%","d":"up"}];
const COLS = ["ID","Convert","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Utils Money #001","Sc Utils Money #002","4.708","5.781","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Utils Money #002","Sc Utils Money #003","4.930","4.785","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Utils Money #003","Sc Utils Money #004","1.030","5.974","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Utils Money #004","Sc Utils Money #005","3.027","3.354","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Utils Money #005","Sc Utils Money #001","3.643","326","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":477},{"label":"Mar","value":604},{"label":"Abr","value":409},{"label":"Mai","value":310},{"label":"Jun","value":376},{"label":"Jul","value":372},{"label":"Ago","value":300},{"label":"Set","value":543},{"label":"Out","value":339},{"label":"Nov","value":603},{"label":"Dez","value":513}];
const MX = 604;
