...
const PAGE = "Type Rating";
const KPIS = [{"l":"Surveys Ativos","v":"684","t":"+5.3%","d":"up"},{"l":"Respostas/Semana","v":"995","t":"-0.5%","d":"down"},{"l":"NPS Médio","v":"58","t":"+12.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"75.4%","t":"+0.5%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","373","80","81.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.763","70","78.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.983","91","80.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","8.263","80","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","7.193","71","95.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":612},{"label":"Mar","value":859},{"label":"Abr","value":642},{"label":"Mai","value":577},{"label":"Jun","value":691},{"label":"Jul","value":633},{"label":"Ago","value":562},{"label":"Set","value":768},{"label":"Out","value":713},{"label":"Nov","value":886},{"label":"Dez","value":773}];
const MX = 886;
