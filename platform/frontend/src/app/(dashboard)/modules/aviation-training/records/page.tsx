...
const PAGE = "Records";
const KPIS = [{"l":"Total Aviation Training","v":"8.911","t":"+15.0%","d":"up"},{"l":"Records Ativos","v":"8.543","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"89","t":"+4.6%","d":"up"}];
const COLS = ["ID","Records","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Training #001","Aviation Training #002","5.500","2.562","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Training #002","Aviation Training #003","7.359","4.582","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Training #003","Aviation Training #004","3.021","5.776","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Training #004","Aviation Training #005","8.422","8.322","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Training #005","Aviation Training #001","4.987","629","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":643},{"label":"Mar","value":678},{"label":"Abr","value":793},{"label":"Mai","value":538},{"label":"Jun","value":634},{"label":"Jul","value":799},{"label":"Ago","value":773},{"label":"Set","value":839},{"label":"Out","value":466},{"label":"Nov","value":502},{"label":"Dez","value":599}];
const MX = 839;
