...
const KPIS = [{"l":"Twins Ativos","v":"5.300","t":"+3.2%","d":"up"},{"l":"Simulações/Dia","v":"652","t":"+16.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"71.8%","t":"+6.6%","d":"up"},{"l":"Latência Sync (ms)","v":"36ms","t":"-0.4%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","86.9%","2026-03-21","7.267","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.3%","2026-01-17","8.100","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","99.0%","2026-02-06","4.413","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","73.0%","2026-03-27","2.915","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","71.5%","2026-01-02","6.251","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":730},{"label":"Mar","value":749},{"label":"Abr","value":968},{"label":"Mai","value":965},{"label":"Jun","value":820},{"label":"Jul","value":717},{"label":"Ago","value":913},{"label":"Set","value":706},{"label":"Out","value":778},{"label":"Nov","value":748},{"label":"Dez","value":1008}];
const MX = 1008;
