...
export default function AviationTrainingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Aviation Training</h1><p className="text-sm text-muted-foreground">Aviation Training • iBOS Enterprise</p></div>
