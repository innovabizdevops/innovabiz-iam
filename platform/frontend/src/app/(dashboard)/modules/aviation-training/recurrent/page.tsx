...
const ACCENT = "#475569";
const MODULE = "Aviation Training";
const PAGE = "Recurrent";
const KPIS = [{"l":"Total Aviation Training","v":"1.561","t":"+2.6%","d":"up"},{"l":"Recurrent Ativos","v":"8.504","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"66.7%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+16.4%","d":"up"}];
const COLS = ["ID","Recurrent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Training #001","Aviation Training #002","3.775","2.220","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Training #002","Aviation Training #003","4.123","6.170","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Training #003","Aviation Training #004","2.740","2.916","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Training #004","Aviation Training #005","7.075","3.095","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Training #005","Aviation Training #001","3.833","2.197","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":551},{"label":"Mar","value":796},{"label":"Abr","value":493},{"label":"Mai","value":585},{"label":"Jun","value":623},{"label":"Jul","value":603},{"label":"Ago","value":737},{"label":"Set","value":585},{"label":"Out","value":677},{"label":"Nov","value":612},{"label":"Dez","value":671}];
const MX = 796;
