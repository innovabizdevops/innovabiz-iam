...
export default function FleetMgmtAutoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fleet Mgmt Auto</h1><p className="text-sm text-muted-foreground">Fleet Mgmt Auto • iBOS Enterprise</p></div>
