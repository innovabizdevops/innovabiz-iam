...
const KPIS = [{"l":"Quartos Ocupados","v":"7.805","t":"+10.6%","d":"up"},{"l":"RevPAR (€)","v":"€27989","t":"+13.1%","d":"up"},{"l":"Ocupação (%)","v":"91.9%","t":"+6.0%","d":"up"},{"l":"Guest Satisfaction","v":"3.804","t":"+7.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.849","2026-03-18","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.352","2026-03-20","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.024","2026-02-20","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.956","2026-03-19","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.332","2026-01-17","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":963},{"label":"Mar","value":868},{"label":"Abr","value":962},{"label":"Mai","value":825},{"label":"Jun","value":1038},{"label":"Jul","value":911},{"label":"Ago","value":731},{"label":"Set","value":1051},{"label":"Out","value":924},{"label":"Nov","value":1065},{"label":"Dez","value":1090}];
const MX = 1090;
