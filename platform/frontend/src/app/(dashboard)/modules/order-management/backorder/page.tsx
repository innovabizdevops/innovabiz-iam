...
const PAGE = "Backorder Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"1.632","t":"+11.4%","d":"up"},{"l":"Savings (€)","v":"€83530","t":"+17.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.0%","t":"-5.0%","d":"down"},{"l":"Ciclos PDCA","v":"7.778","t":"-5.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.912","€ 38484.52","7.402","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","445","€ 3603.67","7.007","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.309","€ 49163.25","3.394","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.622","€ 20618.20","3.790","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.312","€ 21646.46","7.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":668},{"label":"Mar","value":613},{"label":"Abr","value":913},{"label":"Mai","value":822},{"label":"Jun","value":977},{"label":"Jul","value":681},{"label":"Ago","value":641},{"label":"Set","value":629},{"label":"Out","value":778},{"label":"Nov","value":998},{"label":"Dez","value":666}];
const MX = 998;
