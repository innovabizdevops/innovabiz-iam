...
const PAGE = "Fulfillment Engine";
const KPIS = [{"l":"Projetos Melhoria","v":"8.657","t":"+10.1%","d":"up"},{"l":"Savings (€)","v":"€32315","t":"+15.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.3%","t":"+1.8%","d":"up"},{"l":"Ciclos PDCA","v":"7.522","t":"+8.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","181","€ 18446.85","5.440","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.062","€ 7667.81","5.968","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.419","€ 13801.57","6.839","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.981","€ 34285.53","3.605","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","278","€ 26645.64","1.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":597},{"label":"Mar","value":559},{"label":"Abr","value":648},{"label":"Mai","value":584},{"label":"Jun","value":335},{"label":"Jul","value":280},{"label":"Ago","value":331},{"label":"Set","value":345},{"label":"Out","value":324},{"label":"Nov","value":374},{"label":"Dez","value":587}];
const MX = 648;
