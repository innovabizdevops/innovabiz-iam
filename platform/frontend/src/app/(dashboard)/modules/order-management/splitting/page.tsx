...
const PAGE = "Order Splitting Rules";
const KPIS = [{"l":"Projetos Melhoria","v":"1.069","t":"+11.9%","d":"up"},{"l":"Savings (€)","v":"€58204","t":"+16.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.6%","t":"-3.3%","d":"down"},{"l":"Ciclos PDCA","v":"3.659","t":"-0.3%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.068","€ 1400.91","6.221","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.893","€ 14847.96","2.157","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.660","€ 2254.51","2.028","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.737","€ 27946.05","4.159","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.238","€ 47232.09","8.557","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":630},{"label":"Mar","value":595},{"label":"Abr","value":343},{"label":"Mai","value":321},{"label":"Jun","value":626},{"label":"Jul","value":562},{"label":"Ago","value":477},{"label":"Set","value":484},{"label":"Out","value":602},{"label":"Nov","value":503},{"label":"Dez","value":424}];
const MX = 630;
