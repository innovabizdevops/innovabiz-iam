...
const PAGE = "Order-to-Cash";
const KPIS = [{"l":"Projetos Melhoria","v":"667","t":"-2.6%","d":"down"},{"l":"Savings (€)","v":"€79447","t":"-5.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"77.7%","t":"+9.0%","d":"up"},{"l":"Ciclos PDCA","v":"3.550","t":"+16.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.035","€ 6256.16","3.925","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.529","€ 23501.47","5.225","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.566","€ 34156.30","4.945","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.620","€ 10899.71","6.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.362","€ 38119.41","8.364","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":759},{"label":"Mar","value":563},{"label":"Abr","value":682},{"label":"Mai","value":469},{"label":"Jun","value":641},{"label":"Jul","value":716},{"label":"Ago","value":730},{"label":"Set","value":737},{"label":"Out","value":437},{"label":"Nov","value":466},{"label":"Dez","value":700}];
const MX = 759;
