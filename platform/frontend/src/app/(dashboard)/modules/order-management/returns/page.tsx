...
const PAGE = "Returns &amp; Exchanges";
const KPIS = [{"l":"Projetos Melhoria","v":"3.839","t":"+6.6%","d":"up"},{"l":"Savings (€)","v":"€8276","t":"+15.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"85.2%","t":"+10.3%","d":"up"},{"l":"Ciclos PDCA","v":"437","t":"+5.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.199","€ 11943.69","1.138","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.071","€ 43411.35","3.134","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.614","€ 11985.71","654","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.450","€ 30134.27","3.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.175","€ 9928.31","3.131","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":850},{"label":"Mar","value":971},{"label":"Abr","value":787},{"label":"Mai","value":782},{"label":"Jun","value":583},{"label":"Jul","value":749},{"label":"Ago","value":589},{"label":"Set","value":926},{"label":"Out","value":584},{"label":"Nov","value":948},{"label":"Dez","value":893}];
const MX = 971;
