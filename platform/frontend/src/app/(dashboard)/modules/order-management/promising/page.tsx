...
const PAGE = "Order Promising AI";
const KPIS = [{"l":"Projetos Melhoria","v":"4.453","t":"+3.1%","d":"up"},{"l":"Savings (€)","v":"€78789","t":"-2.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.0%","t":"+0.6%","d":"up"},{"l":"Ciclos PDCA","v":"6.257","t":"-0.2%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","242","€ 8395.00","1.300","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","807","€ 12514.12","8.660","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.775","€ 49709.14","7.651","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.118","€ 39283.89","7.157","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.222","€ 24420.06","9.066","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":675},{"label":"Mar","value":350},{"label":"Abr","value":523},{"label":"Mai","value":621},{"label":"Jun","value":343},{"label":"Jul","value":394},{"label":"Ago","value":478},{"label":"Set","value":392},{"label":"Out","value":383},{"label":"Nov","value":298},{"label":"Dez","value":587}];
const MX = 675;
