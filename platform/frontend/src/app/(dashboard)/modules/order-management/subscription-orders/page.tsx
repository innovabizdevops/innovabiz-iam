...
const PAGE = "Subscription Orders";
const KPIS = [{"l":"ARR (€M)","v":"€12.4M","t":"+5.9%","d":"up"},{"l":"MRR (€)","v":"€65784","t":"+0.8%","d":"up"},{"l":"Churn (%)","v":"91.6%","t":"+18.0%","d":"up"},{"l":"ARPU (€)","v":"€98462","t":"-3.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27177.98","3.908","€ 4337.31","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 40564.25","1.888","€ 38370.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 13301.32","4.664","€ 43030.19","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4468.79","6.900","€ 44633.36","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45882.27","6.490","€ 24369.00","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":504},{"label":"Mar","value":728},{"label":"Abr","value":567},{"label":"Mai","value":692},{"label":"Jun","value":795},{"label":"Jul","value":505},{"label":"Ago","value":632},{"label":"Set","value":567},{"label":"Out","value":765},{"label":"Nov","value":451},{"label":"Dez","value":433}];
const MX = 795;
