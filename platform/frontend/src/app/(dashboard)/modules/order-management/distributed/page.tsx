...
const PAGE = "Distributed Order";
const KPIS = [{"l":"Projetos Melhoria","v":"4.870","t":"-5.3%","d":"down"},{"l":"Savings (€)","v":"€69285","t":"-3.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"87.4%","t":"+5.7%","d":"up"},{"l":"Ciclos PDCA","v":"856","t":"+9.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.075","€ 11795.85","2.946","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","159","€ 33207.04","6.658","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.610","€ 15870.62","2.002","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.819","€ 4718.41","3.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.056","€ 41516.88","2.252","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":568},{"label":"Mar","value":602},{"label":"Abr","value":630},{"label":"Mai","value":637},{"label":"Jun","value":678},{"label":"Jul","value":707},{"label":"Ago","value":526},{"label":"Set","value":532},{"label":"Out","value":642},{"label":"Nov","value":454},{"label":"Dez","value":441}];
const MX = 707;
