...
const PAGE = "Dropship Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.898","t":"+11.9%","d":"up"},{"l":"Savings (€)","v":"€17699","t":"+2.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.4%","t":"+9.8%","d":"up"},{"l":"Ciclos PDCA","v":"6.680","t":"+17.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","957","€ 35223.77","4.264","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.815","€ 16862.08","4.296","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.092","€ 7582.25","3.019","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.482","€ 47204.40","6.104","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.472","€ 48729.21","8.266","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":950},{"label":"Mar","value":1007},{"label":"Abr","value":820},{"label":"Mai","value":635},{"label":"Jun","value":815},{"label":"Jul","value":676},{"label":"Ago","value":665},{"label":"Set","value":981},{"label":"Out","value":848},{"label":"Nov","value":835},{"label":"Dez","value":637}];
const MX = 1007;
