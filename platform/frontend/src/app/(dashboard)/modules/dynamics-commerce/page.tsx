...
/* ═══ Commerce Hub (D365) — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "4713", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1252", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€363K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "456751013", cells: ["DYN-2013", "Commerce Hub (D365) Item 1", "6/6/2026", "€1113"], status: "active" as const },
    { id: "456754584", cells: ["DYN-5584", "Commerce Hub (D365) Item 2", "21/1/2026", "€4684"], status: "pending" as const },
    { id: "456758155", cells: ["DYN-9155", "Commerce Hub (D365) Item 3", "8/8/2026", "€8255"], status: "completed" as const },
    { id: "456761726", cells: ["DYN-3726", "Commerce Hub (D365) Item 4", "23/3/2026", "€11 826"], status: "warning" as const },
    { id: "456765297", cells: ["DYN-7297", "Commerce Hub (D365) Item 5", "10/10/2026", "€15 397"], status: "active" as const },
];
...
export default function CommerceHubD365Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commerce Hub (D365)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Commerce Hub (D365)</p>
                    </div>
                </div>
