...
const ACCENT = "#00bcf2";
const MODULE = "Commerce Hub (D365)";
const PAGE = "Call Center";
const KPIS = [{"l":"Pedidos/Dia","v":"2326","t":"-2.1%","d":"down"},{"l":"GMV (€)","v":"€60309","t":"-5.0%","d":"down"},{"l":"Conversão (%)","v":"73.4%","t":"-3.5%","d":"down"},{"l":"AOV (€)","v":"€22464","t":"+7.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 4888.97","2.306","1.018","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 7537.45","7.894","7.498","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 10643.65","3.468","3.351","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 30037.49","1.114","7.042","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 123.51","6.478","1.188","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":994},{"label":"Mar","value":698},{"label":"Abr","value":953},{"label":"Mai","value":779},{"label":"Jun","value":826},{"label":"Jul","value":877},{"label":"Ago","value":918},{"label":"Set","value":753},{"label":"Out","value":1053},{"label":"Nov","value":810},{"label":"Dez","value":938}];
const MX = 1053;
