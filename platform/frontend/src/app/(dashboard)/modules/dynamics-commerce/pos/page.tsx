...
const PAGE = "POS";
const KPIS = [{"l":"Pedidos/Dia","v":"1513","t":"-0.4%","d":"down"},{"l":"GMV (€)","v":"€8148","t":"+1.3%","d":"up"},{"l":"Conversão (%)","v":"87.4%","t":"+4.4%","d":"up"},{"l":"AOV (€)","v":"€29668","t":"+3.9%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 33117.64","4.040","8.540","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 32791.59","7.809","4.438","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 23689.77","5.104","5.744","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 42990.16","7.461","266","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 32632.99","6.174","4.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":1036},{"label":"Mar","value":743},{"label":"Abr","value":814},{"label":"Mai","value":1064},{"label":"Jun","value":893},{"label":"Jul","value":998},{"label":"Ago","value":827},{"label":"Set","value":760},{"label":"Out","value":1006},{"label":"Nov","value":1070},{"label":"Dez","value":836}];
const MX = 1070;
