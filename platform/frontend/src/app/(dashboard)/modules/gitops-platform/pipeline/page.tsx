...
const ACCENT = "#0d9488";
const MODULE = "GitOps Platform";
const PAGE = "Pipeline";
const KPIS = [{"l":"Formulários Ativos","v":"1.408","t":"+13.5%","d":"up"},{"l":"Submissões/Dia","v":"4944","t":"-1.4%","d":"down"},{"l":"Documentos Gerados","v":"4.059","t":"-1.3%","d":"down"},{"l":"Templates","v":"5.041","t":"-1.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.378","2026-03-20","7.097","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.012","2026-02-27","1.388","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.802","2026-03-09","6.005","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.631","2026-03-24","328","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.977","2026-02-13","3.678","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":1017},{"label":"Mar","value":817},{"label":"Abr","value":908},{"label":"Mai","value":951},{"label":"Jun","value":801},{"label":"Jul","value":863},{"label":"Ago","value":877},{"label":"Set","value":847},{"label":"Out","value":802},{"label":"Nov","value":694},{"label":"Dez","value":958}];
const MX = 1017;
