...
const PAGE = "Repo";
const KPIS = [{"l":"Formulários Ativos","v":"4.031","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"3976","t":"+11.7%","d":"up"},{"l":"Documentos Gerados","v":"3.126","t":"+9.8%","d":"up"},{"l":"Templates","v":"6.476","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.532","2026-02-28","3.436","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.332","2026-02-10","2.207","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.089","2026-03-01","5.299","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.875","2026-02-14","4.459","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.695","2026-03-03","6.953","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":281},{"label":"Mar","value":288},{"label":"Abr","value":382},{"label":"Mai","value":311},{"label":"Jun","value":476},{"label":"Jul","value":447},{"label":"Ago","value":538},{"label":"Set","value":458},{"label":"Out","value":381},{"label":"Nov","value":416},{"label":"Dez","value":288}];
const MX = 538;
