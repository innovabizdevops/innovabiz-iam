...
const KPIS = [
    { label: "Total Registos", value: "4157", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4191", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€226K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "757631257", cells: ["GIT-3257", "GitOps Platform Item 1", "6/2/2026", "€31 357"], status: "active" as const },
    { id: "757634828", cells: ["GIT-6828", "GitOps Platform Item 2", "21/9/2026", "€34 928"], status: "pending" as const },
    { id: "757638399", cells: ["GIT-1399", "GitOps Platform Item 3", "8/4/2026", "€38 499"], status: "completed" as const },
    { id: "757641970", cells: ["GIT-4970", "GitOps Platform Item 4", "23/11/2026", "€42 070"], status: "warning" as const },
    { id: "757645541", cells: ["GIT-8541", "GitOps Platform Item 5", "10/6/2026", "€45 641"], status: "active" as const },
];
...
export default function GitopsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GitOps Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GitOps Platform</p>
                    </div>
                </div>
