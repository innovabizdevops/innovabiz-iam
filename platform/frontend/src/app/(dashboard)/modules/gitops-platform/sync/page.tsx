...
const PAGE = "Sync";
const KPIS = [{"l":"Formulários Ativos","v":"4.665","t":"+9.0%","d":"up"},{"l":"Submissões/Dia","v":"2470","t":"+9.8%","d":"up"},{"l":"Documentos Gerados","v":"3.106","t":"-4.1%","d":"down"},{"l":"Templates","v":"8.557","t":"+11.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.974","2026-03-12","1.599","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.799","2026-02-25","3.011","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.865","2026-01-23","7.005","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.865","2026-01-09","2.986","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.493","2026-01-21","7.068","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":630},{"label":"Mar","value":845},{"label":"Abr","value":513},{"label":"Mai","value":839},{"label":"Jun","value":813},{"label":"Jul","value":807},{"label":"Ago","value":773},{"label":"Set","value":824},{"label":"Out","value":807},{"label":"Nov","value":531},{"label":"Dez","value":730}];
const MX = 845;
