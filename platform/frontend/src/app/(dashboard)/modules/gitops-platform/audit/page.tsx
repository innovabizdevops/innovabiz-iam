...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.625","t":"+16.7%","d":"up"},{"l":"NC Abertas","v":"501","t":"-0.9%","d":"down"},{"l":"Conformidade (%)","v":"70.7%","t":"+10.5%","d":"up"},{"l":"CAPAs Pendentes","v":"3.814","t":"-4.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.557","86.6%","4.749","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.758","71.5%","3.119","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.031","70.9%","5.907","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.629","75.2%","2.946","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","288","87.0%","2.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":533},{"label":"Mar","value":439},{"label":"Abr","value":565},{"label":"Mai","value":356},{"label":"Jun","value":358},{"label":"Jul","value":317},{"label":"Ago","value":481},{"label":"Set","value":591},{"label":"Out","value":331},{"label":"Nov","value":569},{"label":"Dez","value":514}];
const MX = 591;
