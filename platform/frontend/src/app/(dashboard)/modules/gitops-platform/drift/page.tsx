...
const PAGE = "Drift";
const KPIS = [{"l":"Formulários Ativos","v":"6.051","t":"-3.8%","d":"down"},{"l":"Submissões/Dia","v":"4290","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"1.253","t":"+15.0%","d":"up"},{"l":"Templates","v":"7.184","t":"+2.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.211","2026-01-22","1.961","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.102","2026-01-12","950","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","823","2026-03-22","576","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.354","2026-03-04","6.304","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.951","2026-02-10","5.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":703},{"label":"Mar","value":502},{"label":"Abr","value":527},{"label":"Mai","value":427},{"label":"Jun","value":394},{"label":"Jul","value":463},{"label":"Ago","value":658},{"label":"Set","value":411},{"label":"Out","value":446},{"label":"Nov","value":650},{"label":"Dez","value":532}];
const MX = 703;
