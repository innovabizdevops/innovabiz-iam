...
const KPIS = [{"l":"Dashboards Ativos","v":"6.163","t":"+0.4%","d":"up"},{"l":"Queries/Dia","v":"1552","t":"+1.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.273","t":"+4.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.362","t":"+6.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5028","2026-01-08","4.114","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4931","2026-03-18","3.961","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5093","2026-03-03","2.747","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3742","2026-01-27","5.903","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4572","2026-01-25","5.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":438},{"label":"Mar","value":582},{"label":"Abr","value":564},{"label":"Mai","value":646},{"label":"Jun","value":610},{"label":"Jul","value":512},{"label":"Ago","value":291},{"label":"Set","value":336},{"label":"Out","value":638},{"label":"Nov","value":367},{"label":"Dez","value":502}];
const MX = 646;
