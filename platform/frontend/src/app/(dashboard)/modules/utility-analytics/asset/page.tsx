...
const PAGE = "Asset";
const KPIS = [{"l":"Dashboards Ativos","v":"6.317","t":"-5.0%","d":"down"},{"l":"Queries/Dia","v":"596","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.008","t":"+10.4%","d":"up"},{"l":"Utilizadores Analytics","v":"309","t":"-1.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4697","2026-01-23","8.057","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","625","2026-03-06","8.043","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","441","2026-01-06","1.841","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4681","2026-03-13","4.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2729","2026-01-27","1.164","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":646},{"label":"Mar","value":888},{"label":"Abr","value":735},{"label":"Mai","value":827},{"label":"Jun","value":911},{"label":"Jul","value":576},{"label":"Ago","value":724},{"label":"Set","value":672},{"label":"Out","value":675},{"label":"Nov","value":832},{"label":"Dez","value":878}];
const MX = 911;
