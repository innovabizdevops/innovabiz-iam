...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€22.9M","t":"-2.4%","d":"down"},{"l":"MRR (€)","v":"€86414","t":"-0.5%","d":"down"},{"l":"Churn (%)","v":"71.8%","t":"-1.8%","d":"down"},{"l":"ARPU (€)","v":"€55372","t":"+12.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 48657.49","8.788","€ 26462.89","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13626.02","2.104","€ 28691.30","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 13205.83","5.989","€ 16017.59","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1409.66","8.461","€ 49880.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40876.26","1.250","€ 39719.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":769},{"label":"Mar","value":842},{"label":"Abr","value":652},{"label":"Mai","value":708},{"label":"Jun","value":719},{"label":"Jul","value":660},{"label":"Ago","value":566},{"label":"Set","value":628},{"label":"Out","value":708},{"label":"Nov","value":760},{"label":"Dez","value":655}];
const MX = 842;
