...
const ACCENT = "#6366f1";
const MODULE = "Utility Analytics";
const PAGE = "Load";
const KPIS = [{"l":"Dashboards Ativos","v":"3.219","t":"-2.4%","d":"down"},{"l":"Queries/Dia","v":"3501","t":"+16.5%","d":"up"},{"l":"Dados Processados (GB)","v":"122","t":"+1.6%","d":"up"},{"l":"Utilizadores Analytics","v":"972","t":"+2.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1935","2026-01-03","4.679","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","749","2026-03-07","3.287","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3999","2026-03-10","6.360","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1446","2026-01-22","5.971","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","852","2026-02-07","1.361","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":756},{"label":"Mar","value":598},{"label":"Abr","value":904},{"label":"Mai","value":669},{"label":"Jun","value":912},{"label":"Jul","value":675},{"label":"Ago","value":668},{"label":"Set","value":620},{"label":"Out","value":694},{"label":"Nov","value":540},{"label":"Dez","value":635}];
const MX = 912;
