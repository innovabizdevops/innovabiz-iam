...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"1.990","t":"-0.1%","d":"down"},{"l":"Queries/Dia","v":"2209","t":"+9.5%","d":"up"},{"l":"Dados Processados (GB)","v":"4.984","t":"+6.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.091","t":"-0.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4171","2026-02-15","1.408","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3233","2026-03-16","8.093","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3023","2026-01-04","3.970","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2510","2026-03-11","2.006","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1092","2026-03-13","8.178","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":602},{"label":"Mar","value":549},{"label":"Abr","value":859},{"label":"Mai","value":694},{"label":"Jun","value":800},{"label":"Jul","value":606},{"label":"Ago","value":541},{"label":"Set","value":624},{"label":"Out","value":549},{"label":"Nov","value":537},{"label":"Dez","value":717}];
const MX = 859;
