...
const PAGE = "Cost";
const KPIS = [{"l":"Total Multi Cloud","v":"6.948","t":"+3.4%","d":"up"},{"l":"Cost Ativos","v":"6.615","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"83.0%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+9.0%","d":"up"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Cloud #001","Multi Cloud #002","4.621","2.931","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Cloud #002","Multi Cloud #003","3.400","1.495","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Cloud #003","Multi Cloud #004","6.141","8.058","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Cloud #004","Multi Cloud #005","5.735","2.696","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Cloud #005","Multi Cloud #001","6.695","7.064","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":718},{"label":"Mar","value":695},{"label":"Abr","value":496},{"label":"Mai","value":829},{"label":"Jun","value":647},{"label":"Jul","value":689},{"label":"Ago","value":834},{"label":"Set","value":777},{"label":"Out","value":501},{"label":"Nov","value":790},{"label":"Dez","value":823}];
const MX = 834;
