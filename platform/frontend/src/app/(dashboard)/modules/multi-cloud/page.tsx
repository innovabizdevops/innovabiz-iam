...
const KPIS = [
    ...
    { label: "Ativos", value: "2001", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€409K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "403345480", cells: ["MUL-2480", "Multi-Cloud Management Item 1", "21/5/2026", "€45 580"], status: "active" as const },
    { id: "403349051", cells: ["MUL-6051", "Multi-Cloud Management Item 2", "8/12/2026", "€49 151"], status: "pending" as const },
    { id: "403352622", cells: ["MUL-9622", "Multi-Cloud Management Item 3", "23/7/2026", "€2722"], status: "completed" as const },
    { id: "403356193", cells: ["MUL-4193", "Multi-Cloud Management Item 4", "10/2/2026", "€6293"], status: "warning" as const },
    { id: "403359764", cells: ["MUL-7764", "Multi-Cloud Management Item 5", "25/9/2026", "€9864"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Cloud Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Cloud Management</p>
                    </div>
                </div>
