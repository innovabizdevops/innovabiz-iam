...
const ACCENT = "#0d9488";
const MODULE = "Multi-Cloud Management";
const PAGE = "Provision";
const KPIS = [{"l":"Total Multi Cloud","v":"3.257","t":"+5.5%","d":"up"},{"l":"Provision Ativos","v":"523","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+15.3%","d":"up"}];
const COLS = ["ID","Provision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Cloud #001","Multi Cloud #002","3.337","2.942","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Cloud #002","Multi Cloud #003","6.586","3.146","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Cloud #003","Multi Cloud #004","6.526","7.256","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Cloud #004","Multi Cloud #005","8.053","7.949","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Cloud #005","Multi Cloud #001","2.766","7.562","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":968},{"label":"Mar","value":1024},{"label":"Abr","value":1015},{"label":"Mai","value":894},{"label":"Jun","value":658},{"label":"Jul","value":834},{"label":"Ago","value":673},{"label":"Set","value":791},{"label":"Out","value":808},{"label":"Nov","value":715},{"label":"Dez","value":801}];
const MX = 1024;
