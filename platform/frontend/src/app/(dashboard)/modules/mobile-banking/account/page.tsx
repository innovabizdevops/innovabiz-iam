...
const PAGE = "Account";
const KPIS = [{"l":"Total Mobile Banking","v":"6.045","t":"+17.8%","d":"up"},{"l":"Account Ativos","v":"4.005","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"79.5%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"62","t":"+10.1%","d":"up"}];
const COLS = ["ID","Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mobile Banking #001","Mobile Banking #002","3.747","5.216","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mobile Banking #002","Mobile Banking #003","2.401","4.781","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Mobile Banking #003","Mobile Banking #004","979","5.459","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mobile Banking #004","Mobile Banking #005","4.066","1.325","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mobile Banking #005","Mobile Banking #001","5.171","3.545","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":588},{"label":"Mar","value":897},{"label":"Abr","value":921},{"label":"Mai","value":598},{"label":"Jun","value":671},{"label":"Jul","value":792},{"label":"Ago","value":838},{"label":"Set","value":827},{"label":"Out","value":856},{"label":"Nov","value":964},{"label":"Dez","value":951}];
const MX = 964;
