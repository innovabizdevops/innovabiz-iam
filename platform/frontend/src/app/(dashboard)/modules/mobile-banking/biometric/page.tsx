...
const KPIS = [{"l":"Total Mobile Banking","v":"6.774","t":"+8.7%","d":"up"},{"l":"Biometric Ativos","v":"5.989","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"78.7%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"72","t":"+12.1%","d":"up"}];
const COLS = ["ID","Biometric","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mobile Banking #001","Mobile Banking #002","2.883","8.745","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Mobile Banking #002","Mobile Banking #003","3.345","7.266","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Mobile Banking #003","Mobile Banking #004","5.445","1.096","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mobile Banking #004","Mobile Banking #005","4.326","5.067","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mobile Banking #005","Mobile Banking #001","8.840","5.001","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":347},{"label":"Mar","value":512},{"label":"Abr","value":551},{"label":"Mai","value":324},{"label":"Jun","value":298},{"label":"Jul","value":294},{"label":"Ago","value":524},{"label":"Set","value":415},{"label":"Out","value":628},{"label":"Nov","value":542},{"label":"Dez","value":479}];
const MX = 642;
