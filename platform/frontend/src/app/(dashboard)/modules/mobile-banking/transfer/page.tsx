...
const PAGE = "Transfer";
const KPIS = [{"l":"Total Mobile Banking","v":"1.543","t":"+14.4%","d":"up"},{"l":"Transfer Ativos","v":"4.875","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"81.6%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+7.9%","d":"up"}];
const COLS = ["ID","Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mobile Banking #001","Mobile Banking #002","5.515","4.003","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Mobile Banking #002","Mobile Banking #003","8.959","4.278","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Mobile Banking #003","Mobile Banking #004","8.185","7.917","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mobile Banking #004","Mobile Banking #005","1.256","7.714","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mobile Banking #005","Mobile Banking #001","8.392","2.619","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":780},{"label":"Mar","value":897},{"label":"Abr","value":826},{"label":"Mai","value":685},{"label":"Jun","value":927},{"label":"Jul","value":844},{"label":"Ago","value":904},{"label":"Set","value":855},{"label":"Out","value":642},{"label":"Nov","value":854},{"label":"Dez","value":724}];
const MX = 927;
