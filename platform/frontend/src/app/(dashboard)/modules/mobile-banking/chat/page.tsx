...
const ACCENT = "#6366f1";
const MODULE = "Mobile Banking";
const PAGE = "Chat";
const KPIS = [{"l":"Teams Ativos","v":"4.188","t":"+3.4%","d":"up"},{"l":"Reuniões/Semana","v":"1556","t":"+0.2%","d":"up"},{"l":"Mensagens/Dia","v":"1486","t":"+14.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"909","t":"+8.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.768","4313","6.447","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","917","1694","5.006","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.251","4831","8.772","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.539","4124","3.695","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.662","336","2.424","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":665},{"label":"Mar","value":779},{"label":"Abr","value":599},{"label":"Mai","value":616},{"label":"Jun","value":773},{"label":"Jul","value":836},{"label":"Ago","value":881},{"label":"Set","value":558},{"label":"Out","value":778},{"label":"Nov","value":767},{"label":"Dez","value":590}];
const MX = 881;
