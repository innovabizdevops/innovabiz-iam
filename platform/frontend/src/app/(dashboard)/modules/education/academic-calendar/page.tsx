...
const PAGE = "Academic Calendar";
const KPIS = [{"l":"Total Education","v":"246","t":"+13.7%","d":"up"},{"l":"Academic Calendar Ativos","v":"2.084","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"57","t":"+6.0%","d":"up"}];
const COLS = ["ID","Academic Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","5.052","2.345","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","4.847","1.551","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","7.271","637","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","2.855","3.167","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","2.637","4.658","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":399},{"label":"Fev","value":568},{"label":"Mar","value":273},{"label":"Abr","value":595},{"label":"Mai","value":246},{"label":"Jun","value":385},{"label":"Jul","value":236},{"label":"Ago","value":241},{"label":"Set","value":595},{"label":"Out","value":383},{"label":"Nov","value":346},{"label":"Dez","value":261}];
const MX = 595;
