...
const PAGE = "Campus Management";
const KPIS = [{"l":"Projetos Melhoria","v":"1.956","t":"-5.4%","d":"down"},{"l":"Savings (€)","v":"€33751","t":"+16.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.3%","t":"+13.5%","d":"up"},{"l":"Ciclos PDCA","v":"5.814","t":"+1.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","816","€ 9769.01","3.928","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.382","€ 3361.52","5.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.573","€ 16470.84","8.523","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.133","€ 6044.95","8.994","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.726","€ 6676.64","7.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":830},{"label":"Mar","value":873},{"label":"Abr","value":852},{"label":"Mai","value":733},{"label":"Jun","value":801},{"label":"Jul","value":876},{"label":"Ago","value":839},{"label":"Set","value":780},{"label":"Out","value":649},{"label":"Nov","value":724},{"label":"Dez","value":761}];
const MX = 876;
