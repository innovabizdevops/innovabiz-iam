...
const PAGE = "Micro-Credentials";
const KPIS = [{"l":"Total Education","v":"2.930","t":"+15.7%","d":"up"},{"l":"Micro Credentials Ativos","v":"3.788","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+11.5%","d":"up"}];
const COLS = ["ID","Micro Credentials","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","959","7.296","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","5.067","7.579","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","8.194","1.350","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","5.125","6.124","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","1.016","8.994","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":614},{"label":"Mar","value":886},{"label":"Abr","value":958},{"label":"Mai","value":818},{"label":"Jun","value":951},{"label":"Jul","value":858},{"label":"Ago","value":646},{"label":"Set","value":780},{"label":"Out","value":981},{"label":"Nov","value":642},{"label":"Dez","value":717}];
const MX = 981;
