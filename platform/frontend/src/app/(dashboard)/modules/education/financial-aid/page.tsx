...
const KPIS = [{"l":"Total Education","v":"5.564","t":"-5.6%","d":"down"},{"l":"Financial Aid Ativos","v":"5.996","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+5.1%","d":"up"}];
const COLS = ["ID","Financial Aid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","2.228","2.783","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","2.116","6.324","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","7.631","5.974","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","3.269","3.928","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","3.276","676","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":464},{"label":"Mar","value":775},{"label":"Abr","value":595},{"label":"Mai","value":449},{"label":"Jun","value":769},{"label":"Jul","value":758},{"label":"Ago","value":441},{"label":"Set","value":438},{"label":"Out","value":608},{"label":"Nov","value":601},{"label":"Dez","value":770}];
const MX = 775;
