...
const PAGE = "Student Enrollment";
const KPIS = [{"l":"Formulários Ativos","v":"4.971","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"1894","t":"+12.0%","d":"up"},{"l":"Documentos Gerados","v":"6.912","t":"-2.0%","d":"down"},{"l":"Templates","v":"247","t":"-0.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.116","2026-01-04","5.934","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.793","2026-03-25","8.956","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.798","2026-03-11","473","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.618","2026-03-05","8.475","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.203","2026-02-16","429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":489},{"label":"Mar","value":725},{"label":"Abr","value":498},{"label":"Mai","value":431},{"label":"Jun","value":524},{"label":"Jul","value":540},{"label":"Ago","value":747},{"label":"Set","value":748},{"label":"Out","value":456},{"label":"Nov","value":456},{"label":"Dez","value":659}];
const MX = 748;
