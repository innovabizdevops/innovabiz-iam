...
const PAGE = "Curriculum Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.011","t":"+11.7%","d":"up"},{"l":"Submissões/Dia","v":"4310","t":"+7.9%","d":"up"},{"l":"Documentos Gerados","v":"8.013","t":"-3.2%","d":"down"},{"l":"Templates","v":"695","t":"+6.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","519","2026-03-26","1.468","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.955","2026-02-16","7.408","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.171","2026-02-27","5.363","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.018","2026-01-03","5.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.047","2026-03-28","2.968","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":589},{"label":"Mar","value":645},{"label":"Abr","value":617},{"label":"Mai","value":936},{"label":"Jun","value":708},{"label":"Jul","value":756},{"label":"Ago","value":633},{"label":"Set","value":692},{"label":"Out","value":666},{"label":"Nov","value":702},{"label":"Dez","value":573}];
const MX = 936;
...
export default function CurriculumEducationPage() {
    return (
