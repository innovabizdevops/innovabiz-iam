...
const ACCENT = "#2563eb";
const MODULE = "Education & EdTech";
const PAGE = "SCORM / xAPI";
const KPIS = [{"l":"Total Education","v":"3.270","t":"+10.1%","d":"up"},{"l":"SCORM / XAPI Ativos","v":"6.553","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"75.0%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"77","t":"+1.2%","d":"up"}];
const COLS = ["ID","SCORM / XAPI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","8.768","5.341","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","7.989","3.033","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","3.165","4.655","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","1.619","7.009","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","5.397","5.520","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":560},{"label":"Mar","value":796},{"label":"Abr","value":888},{"label":"Mai","value":664},{"label":"Jun","value":522},{"label":"Jul","value":705},{"label":"Ago","value":699},{"label":"Set","value":670},{"label":"Out","value":571},{"label":"Nov","value":656},{"label":"Dez","value":690}];
const MX = 888;
...
export default function ScormXapiPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>SCORM</span></h1>
                </div>
