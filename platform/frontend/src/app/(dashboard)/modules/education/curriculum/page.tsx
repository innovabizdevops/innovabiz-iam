...
const PAGE = "Academic &amp; Learning";
const KPIS = [{"l":"Total Education","v":"1.713","t":"-4.3%","d":"down"},{"l":"Academic & Learning Ativos","v":"2.624","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"67","t":"-0.3%","d":"down"}];
const COLS = ["ID","Academic & Learning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","8.953","8.691","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","451","2.554","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","3.005","1.397","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","6.440","4.606","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","6.983","705","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":320},{"label":"Mar","value":336},{"label":"Abr","value":423},{"label":"Mai","value":412},{"label":"Jun","value":637},{"label":"Jul","value":345},{"label":"Ago","value":429},{"label":"Set","value":597},{"label":"Out","value":311},{"label":"Nov","value":321},{"label":"Dez","value":312}];
const MX = 637;
