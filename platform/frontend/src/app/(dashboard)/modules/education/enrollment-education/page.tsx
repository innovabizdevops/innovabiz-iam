...
const KPIS = [{"l":"Total Education","v":"6.497","t":"+9.0%","d":"up"},{"l":"Enrollment Ativos","v":"1.562","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"57","t":"+3.2%","d":"up"}];
const COLS = ["ID","Enrollment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","4.259","673","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","4.360","4.146","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","5.418","1.908","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","6.396","910","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","1.109","647","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":569},{"label":"Mar","value":433},{"label":"Abr","value":633},{"label":"Mai","value":434},{"label":"Jun","value":513},{"label":"Jul","value":488},{"label":"Ago","value":749},{"label":"Set","value":561},{"label":"Out","value":446},{"label":"Nov","value":640},{"label":"Dez","value":434}];
const MX = 749;
...
export default function EnrollmentEducationPage() {
    return (
