...
const PAGE = "Adaptive Learning AI";
const KPIS = [{"l":"Total Education","v":"679","t":"+7.8%","d":"up"},{"l":"Adaptive Learning AI Ativos","v":"2.919","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"93.3%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"66","t":"+5.0%","d":"up"}];
const COLS = ["ID","Adaptive Learning AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","137","8.750","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","6.544","610","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","7.721","2.347","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","3.227","635","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","7.996","3.878","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":608},{"label":"Mar","value":676},{"label":"Abr","value":652},{"label":"Mai","value":506},{"label":"Jun","value":626},{"label":"Jul","value":847},{"label":"Ago","value":805},{"label":"Set","value":602},{"label":"Out","value":550},{"label":"Nov","value":742},{"label":"Dez","value":793}];
const MX = 847;
