...
const PAGE = "Assessment Engine";
const KPIS = [{"l":"Total Education","v":"7.400","t":"+10.8%","d":"up"},{"l":"Assessment Engine Ativos","v":"5.498","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"79","t":"-4.8%","d":"down"}];
const COLS = ["ID","Assessment Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","904","7.274","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","3.907","8.632","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","1.736","437","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","3.842","3.935","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","5.039","7.451","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":1010},{"label":"Mar","value":739},{"label":"Abr","value":771},{"label":"Mai","value":890},{"label":"Jun","value":781},{"label":"Jul","value":855},{"label":"Ago","value":927},{"label":"Set","value":697},{"label":"Out","value":1011},{"label":"Nov","value":896},{"label":"Dez","value":964}];
const MX = 1011;
