...
const PAGE = "Virtual Classroom";
const KPIS = [{"l":"Total Education","v":"1.899","t":"+8.2%","d":"up"},{"l":"Virtual Classroom Ativos","v":"6.358","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"93.0%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"71","t":"+11.5%","d":"up"}];
const COLS = ["ID","Virtual Classroom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","3.817","8.226","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","7.450","5.127","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","834","8.964","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","2.329","5.003","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","3.156","6.126","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":302},{"label":"Mar","value":583},{"label":"Abr","value":326},{"label":"Mai","value":637},{"label":"Jun","value":666},{"label":"Jul","value":626},{"label":"Ago","value":697},{"label":"Set","value":648},{"label":"Out","value":604},{"label":"Nov","value":694},{"label":"Dez","value":481}];
const MX = 697;
