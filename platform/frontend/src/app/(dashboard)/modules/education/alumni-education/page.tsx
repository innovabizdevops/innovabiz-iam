...
const PAGE = "Alumni CRM";
const KPIS = [{"l":"Total Education","v":"2.620","t":"+11.2%","d":"up"},{"l":"Alumni CRM Ativos","v":"6.080","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"58","t":"+5.2%","d":"up"}];
const COLS = ["ID","Alumni CRM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","2.787","4.677","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","2.686","4.828","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","4.672","364","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","5.846","4.208","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","5.595","141","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":824},{"label":"Mar","value":680},{"label":"Abr","value":882},{"label":"Mai","value":701},{"label":"Jun","value":930},{"label":"Jul","value":716},{"label":"Ago","value":793},{"label":"Set","value":679},{"label":"Out","value":903},{"label":"Nov","value":624},{"label":"Dez","value":805}];
const MX = 930;
...
export default function AlumniEducationPage() {
    return (
