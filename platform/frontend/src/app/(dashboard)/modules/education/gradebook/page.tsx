...
const KPIS = [{"l":"Total Education","v":"4.151","t":"-3.4%","d":"down"},{"l":"Grade Book Ativos","v":"7.679","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"88.8%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+16.3%","d":"up"}];
const COLS = ["ID","Grade Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","4.133","3.960","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","4.128","7.442","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","2.160","1.752","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","288","8.891","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","421","8.665","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":395},{"label":"Mar","value":404},{"label":"Abr","value":428},{"label":"Mai","value":555},{"label":"Jun","value":535},{"label":"Jul","value":701},{"label":"Ago","value":589},{"label":"Set","value":526},{"label":"Out","value":578},{"label":"Nov","value":697},{"label":"Dez","value":558}];
const MX = 701;
