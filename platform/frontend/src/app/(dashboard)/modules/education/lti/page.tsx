...
const PAGE = "LTI Integration";
const KPIS = [{"l":"Integrações Ativas","v":"1.217","t":"+15.3%","d":"up"},{"l":"Chamadas/Hora","v":"2492","t":"+12.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.8%","t":"-1.5%","d":"down"},{"l":"Latência Média (ms)","v":"79ms","t":"+15.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.074","5.140","76.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.239","628","78.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.926","8.446","75.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.907","4.351","79.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.726","991","85.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":911},{"label":"Mar","value":922},{"label":"Abr","value":792},{"label":"Mai","value":936},{"label":"Jun","value":774},{"label":"Jul","value":958},{"label":"Ago","value":963},{"label":"Set","value":897},{"label":"Out","value":824},{"label":"Nov","value":754},{"label":"Dez","value":887}];
const MX = 963;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>LTI</span></h1>
                </div>
