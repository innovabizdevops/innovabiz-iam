...
const PAGE = "Academic Records";
const KPIS = [{"l":"Total Education","v":"3.068","t":"+11.2%","d":"up"},{"l":"Academic Records Ativos","v":"8.843","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"78","t":"-5.9%","d":"down"}];
const COLS = ["ID","Academic Records","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","5.273","3.567","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","3.576","7.130","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","9.059","1.051","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","3.349","1.771","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","8.128","5.463","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":643},{"label":"Mar","value":400},{"label":"Abr","value":736},{"label":"Mai","value":696},{"label":"Jun","value":724},{"label":"Jul","value":426},{"label":"Ago","value":451},{"label":"Set","value":710},{"label":"Out","value":632},{"label":"Nov","value":689},{"label":"Dez","value":706}];
const MX = 736;
