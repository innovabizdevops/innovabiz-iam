...
const PAGE = "Student Management";
const KPIS = [{"l":"Projetos Melhoria","v":"960","t":"+11.6%","d":"up"},{"l":"Savings (€)","v":"€9021","t":"+4.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.4%","t":"+14.2%","d":"up"},{"l":"Ciclos PDCA","v":"3.411","t":"+8.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.133","€ 38005.27","6.676","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.819","€ 38788.28","885","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.864","€ 38982.82","6.641","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.589","€ 50084.54","2.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.264","€ 20501.47","2.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":546},{"label":"Mar","value":890},{"label":"Abr","value":793},{"label":"Mai","value":895},{"label":"Jun","value":624},{"label":"Jul","value":633},{"label":"Ago","value":633},{"label":"Set","value":721},{"label":"Out","value":643},{"label":"Nov","value":908},{"label":"Dez","value":652}];
const MX = 908;
