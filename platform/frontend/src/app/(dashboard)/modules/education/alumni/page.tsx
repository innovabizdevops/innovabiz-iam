...
const PAGE = "Alumni Relations";
const KPIS = [{"l":"Total Education","v":"410","t":"-2.2%","d":"down"},{"l":"Alumni Relations Ativos","v":"5.364","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"83","t":"+15.6%","d":"up"}];
const COLS = ["ID","Alumni Relations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education #001","Education #002","5.415","8.954","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Education #002","Education #003","1.867","1.927","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Education #003","Education #004","5.346","6.237","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Education #004","Education #005","5.566","7.812","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education #005","Education #001","1.895","6.844","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":404},{"label":"Mar","value":626},{"label":"Abr","value":461},{"label":"Mai","value":432},{"label":"Jun","value":385},{"label":"Jul","value":356},{"label":"Ago","value":565},{"label":"Set","value":684},{"label":"Out","value":591},{"label":"Nov","value":382},{"label":"Dez","value":588}];
const MX = 684;
