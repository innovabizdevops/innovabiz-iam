...
const PAGE = "Research Grants";
const KPIS = [{"l":"Ideias Submetidas","v":"823","t":"+2.6%","d":"up"},{"l":"Patentes (YTD)","v":"1.424","t":"+14.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.025","t":"-0.6%","d":"down"},{"l":"Budget I&D (€M)","v":"€7.0M","t":"-3.6%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.775","75.0%","3.717","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.073","85.1%","6.360","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.378","75.5%","6.809","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.685","85.6%","5.699","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.890","96.0%","2.544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":380},{"label":"Mar","value":450},{"label":"Abr","value":368},{"label":"Mai","value":333},{"label":"Jun","value":392},{"label":"Jul","value":525},{"label":"Ago","value":351},{"label":"Set","value":390},{"label":"Out","value":636},{"label":"Nov","value":632},{"label":"Dez","value":305}];
const MX = 636;
