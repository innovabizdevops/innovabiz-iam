...
const PAGE = "Collect";
const KPIS = [{"l":"Total Esg Report","v":"8.661","t":"+15.8%","d":"up"},{"l":"Collect Ativos","v":"2.271","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+15.8%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Report #001","Esg Report #002","6.515","5.321","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Report #002","Esg Report #003","1.287","912","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Report #003","Esg Report #004","4.094","4.600","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Report #004","Esg Report #005","2.869","6.249","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Report #005","Esg Report #001","2.125","5.233","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":717},{"label":"Mar","value":447},{"label":"Abr","value":531},{"label":"Mai","value":563},{"label":"Jun","value":598},{"label":"Jul","value":471},{"label":"Ago","value":399},{"label":"Set","value":702},{"label":"Out","value":660},{"label":"Nov","value":644},{"label":"Dez","value":413}];
const MX = 717;
