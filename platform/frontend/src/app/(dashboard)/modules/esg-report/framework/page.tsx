...
const KPIS = [{"l":"Total Esg Report","v":"3.968","t":"+17.8%","d":"up"},{"l":"Framework Ativos","v":"7.403","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"76","t":"-4.9%","d":"down"}];
const COLS = ["ID","Framework","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Report #001","Esg Report #002","5.608","4.781","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Report #002","Esg Report #003","8.673","4.283","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Report #003","Esg Report #004","8.773","1.750","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Report #004","Esg Report #005","196","4.624","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Report #005","Esg Report #001","6.729","3.223","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":415},{"label":"Mar","value":603},{"label":"Abr","value":496},{"label":"Mai","value":610},{"label":"Jun","value":442},{"label":"Jul","value":567},{"label":"Ago","value":498},{"label":"Set","value":509},{"label":"Out","value":679},{"label":"Nov","value":691},{"label":"Dez","value":732}];
const MX = 732;
