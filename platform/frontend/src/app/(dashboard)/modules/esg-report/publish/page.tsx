...
const PAGE = "Publish";
const KPIS = [{"l":"Total Esg Report","v":"457","t":"+7.2%","d":"up"},{"l":"Publish Ativos","v":"1.106","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.6%","d":"up"}];
const COLS = ["ID","Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Report #001","Esg Report #002","3.124","920","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Report #002","Esg Report #003","5.819","8.302","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Report #003","Esg Report #004","5.710","1.624","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Report #004","Esg Report #005","2.103","5.732","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Report #005","Esg Report #001","7.575","4.588","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":755},{"label":"Mar","value":649},{"label":"Abr","value":693},{"label":"Mai","value":767},{"label":"Jun","value":814},{"label":"Jul","value":920},{"label":"Ago","value":612},{"label":"Set","value":673},{"label":"Out","value":920},{"label":"Nov","value":918},{"label":"Dez","value":662}];
const MX = 920;
