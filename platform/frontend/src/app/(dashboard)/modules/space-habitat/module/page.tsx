...
const ACCENT = "#78350f";
const MODULE = "Space Habitat Design";
const PAGE = "Module Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.384","t":"+15.2%","d":"up"},{"l":"Submissões/Dia","v":"722","t":"+14.2%","d":"up"},{"l":"Documentos Gerados","v":"989","t":"+11.1%","d":"up"},{"l":"Templates","v":"3.881","t":"-1.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.936","2026-02-27","8.226","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.219","2026-01-25","4.849","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.989","2026-02-26","6.154","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.150","2026-02-26","6.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.346","2026-03-18","6.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":634},{"label":"Mar","value":469},{"label":"Abr","value":317},{"label":"Mai","value":656},{"label":"Jun","value":586},{"label":"Jul","value":490},{"label":"Ago","value":419},{"label":"Set","value":561},{"label":"Out","value":498},{"label":"Nov","value":445},{"label":"Dez","value":375}];
const MX = 699;
