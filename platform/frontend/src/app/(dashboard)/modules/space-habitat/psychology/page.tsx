...
const PAGE = "Psychology";
const KPIS = [{"l":"Quartos Ocupados","v":"926","t":"+10.1%","d":"up"},{"l":"RevPAR (€)","v":"€34322","t":"+1.4%","d":"up"},{"l":"Ocupação (%)","v":"75.0%","t":"+2.3%","d":"up"},{"l":"Guest Satisfaction","v":"520","t":"+12.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.468","2026-02-04","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.678","2026-01-22","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.409","2026-02-20","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.137","2026-01-05","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","110","2026-01-24","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":610},{"label":"Mar","value":604},{"label":"Abr","value":505},{"label":"Mai","value":371},{"label":"Jun","value":340},{"label":"Jul","value":410},{"label":"Ago","value":717},{"label":"Set","value":538},{"label":"Out","value":374},{"label":"Nov","value":547},{"label":"Dez","value":354}];
const MX = 717;
