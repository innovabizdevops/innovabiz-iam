...
export default function SpaceHabitatPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Space Habitat</h1><p className="text-sm text-muted-foreground">Space Habitat • iBOS Enterprise</p></div>
