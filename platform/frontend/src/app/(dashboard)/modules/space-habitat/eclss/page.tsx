...
const PAGE = "ECLSS";
const KPIS = [{"l":"Quartos Ocupados","v":"3.943","t":"+3.4%","d":"up"},{"l":"RevPAR (€)","v":"€88939","t":"+16.0%","d":"up"},{"l":"Ocupação (%)","v":"67.1%","t":"+6.1%","d":"up"},{"l":"Guest Satisfaction","v":"7.104","t":"+9.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","587","2026-02-06","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.051","2026-03-15","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.590","2026-03-11","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.528","2026-02-03","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.005","2026-01-05","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1034},{"label":"Fev","value":829},{"label":"Mar","value":1029},{"label":"Abr","value":846},{"label":"Mai","value":972},{"label":"Jun","value":914},{"label":"Jul","value":708},{"label":"Ago","value":1025},{"label":"Set","value":1073},{"label":"Out","value":1069},{"label":"Nov","value":707},{"label":"Dez","value":787}];
const MX = 1073;
