...
/* ═══ IT Asset Mgmt (ITAM) — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "469", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2894", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€415K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "298326969", cells: ["IT-4969", "IT Asset Mgmt (ITAM) Item 1", "18/10/2026", "€27 069"], status: "active" as const },
    { id: "298330540", cells: ["IT-8540", "IT Asset Mgmt (ITAM) Item 2", "5/5/2026", "€30 640"], status: "pending" as const },
    { id: "298334111", cells: ["IT-3111", "IT Asset Mgmt (ITAM) Item 3", "20/12/2026", "€34 211"], status: "completed" as const },
    { id: "298337682", cells: ["IT-6682", "IT Asset Mgmt (ITAM) Item 4", "7/7/2026", "€37 782"], status: "warning" as const },
    { id: "298341253", cells: ["IT-1253", "IT Asset Mgmt (ITAM) Item 5", "22/2/2026", "€41 353"], status: "active" as const },
];
...
export default function ItAssetMgmtItamPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IT Asset Mgmt (ITAM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IT Asset Mgmt (ITAM)</p>
                    </div>
                </div>
