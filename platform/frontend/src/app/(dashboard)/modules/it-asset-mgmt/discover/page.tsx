...
const PAGE = "Discover";
const KPIS = [{"l":"Ativos Registados","v":"4.187","t":"-4.7%","d":"down"},{"l":"Valor Total (€M)","v":"€33.6M","t":"+8.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€66253","t":"+14.9%","d":"up"},{"l":"Ativos em Garantia","v":"6.899","t":"-5.0%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 15831.37","6.833","€ 44933.05","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 4570.22","976","€ 1009.41","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 21983.63","4.450","€ 30278.30","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 7209.86","1.522","€ 20324.11","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 32287.01","4.889","€ 42267.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":827},{"label":"Mar","value":862},{"label":"Abr","value":743},{"label":"Mai","value":961},{"label":"Jun","value":796},{"label":"Jul","value":804},{"label":"Ago","value":807},{"label":"Set","value":748},{"label":"Out","value":914},{"label":"Nov","value":627},{"label":"Dez","value":804}];
const MX = 961;
