...
const ACCENT = "#1e293b";
const MODULE = "IT Asset Mgmt (ITAM)";
const PAGE = "License";
const KPIS = [{"l":"Ativos Registados","v":"8.123","t":"+17.6%","d":"up"},{"l":"Valor Total (€M)","v":"€27.8M","t":"-3.0%","d":"down"},{"l":"Depreciação Anual (€)","v":"€22833","t":"-5.5%","d":"down"},{"l":"Ativos em Garantia","v":"6.838","t":"+7.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 25134.78","7.131","€ 32575.18","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 48523.45","4.690","€ 43164.96","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 22125.53","3.681","€ 21563.84","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 33151.72","7.570","€ 20889.58","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 22483.12","5.161","€ 43328.40","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":417},{"label":"Mar","value":763},{"label":"Abr","value":775},{"label":"Mai","value":696},{"label":"Jun","value":437},{"label":"Jul","value":711},{"label":"Ago","value":490},{"label":"Set","value":634},{"label":"Out","value":651},{"label":"Nov","value":673},{"label":"Dez","value":502}];
const MX = 775;
