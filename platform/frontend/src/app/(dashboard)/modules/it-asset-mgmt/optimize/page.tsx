...
const PAGE = "Optimize";
const KPIS = [{"l":"Ativos Registados","v":"8.843","t":"+13.4%","d":"up"},{"l":"Valor Total (€M)","v":"€41.2M","t":"-0.2%","d":"down"},{"l":"Depreciação Anual (€)","v":"€11433","t":"-4.6%","d":"down"},{"l":"Ativos em Garantia","v":"754","t":"+16.6%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 43728.52","304","€ 20500.55","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 47132.90","537","€ 31863.19","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 9567.53","1.536","€ 14677.24","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 34607.64","8.095","€ 41283.16","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 36294.42","5.833","€ 40396.21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":570},{"label":"Mar","value":588},{"label":"Abr","value":677},{"label":"Mai","value":755},{"label":"Jun","value":879},{"label":"Jul","value":579},{"label":"Ago","value":656},{"label":"Set","value":930},{"label":"Out","value":606},{"label":"Nov","value":731},{"label":"Dez","value":647}];
const MX = 930;
