...
const PAGE = "Track";
const KPIS = [{"l":"Ativos Registados","v":"1.936","t":"+6.7%","d":"up"},{"l":"Valor Total (€M)","v":"€48.1M","t":"+15.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€34655","t":"+9.1%","d":"up"},{"l":"Ativos em Garantia","v":"789","t":"+11.0%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 29646.05","124","€ 29123.07","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 43830.06","4.911","€ 17713.96","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 4693.49","4.278","€ 24865.56","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 825.85","1.385","€ 49238.79","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 34300.33","7.765","€ 6631.28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":695},{"label":"Mar","value":945},{"label":"Abr","value":994},{"label":"Mai","value":930},{"label":"Jun","value":651},{"label":"Jul","value":990},{"label":"Ago","value":879},{"label":"Set","value":776},{"label":"Out","value":746},{"label":"Nov","value":625},{"label":"Dez","value":868}];
const MX = 994;
