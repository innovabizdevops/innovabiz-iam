...
const PAGE = "Listings";
const KPIS = [{"l":"Total Property Mgmt","v":"1.322","t":"+15.8%","d":"up"},{"l":"Listings Ativos","v":"7.063","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"92","t":"-3.8%","d":"down"}];
const COLS = ["ID","Listings","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Mgmt #001","Property Mgmt #002","6.444","3.580","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Property Mgmt #002","Property Mgmt #003","7.642","6.347","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Mgmt #003","Property Mgmt #004","4.010","1.342","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Property Mgmt #004","Property Mgmt #005","3.029","2.046","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Mgmt #005","Property Mgmt #001","348","970","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":283},{"label":"Mar","value":414},{"label":"Abr","value":261},{"label":"Mai","value":487},{"label":"Jun","value":421},{"label":"Jul","value":395},{"label":"Ago","value":566},{"label":"Set","value":563},{"label":"Out","value":489},{"label":"Nov","value":440},{"label":"Dez","value":253}];
const MX = 566;
