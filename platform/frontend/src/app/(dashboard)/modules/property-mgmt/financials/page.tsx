...
const ACCENT = "#6366f1";
const MODULE = "Property Management";
const PAGE = "Financials";
const KPIS = [{"l":"Total Property Mgmt","v":"5.571","t":"-3.2%","d":"down"},{"l":"Financials Ativos","v":"1.782","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"67.1%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"78","t":"-0.1%","d":"down"}];
const COLS = ["ID","Financials","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Mgmt #001","Property Mgmt #002","5.588","8.105","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Property Mgmt #002","Property Mgmt #003","8.766","1.543","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Mgmt #003","Property Mgmt #004","8.111","7.617","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Property Mgmt #004","Property Mgmt #005","6.904","6.344","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Mgmt #005","Property Mgmt #001","121","3.620","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":260},{"label":"Fev","value":589},{"label":"Mar","value":560},{"label":"Abr","value":252},{"label":"Mai","value":564},{"label":"Jun","value":406},{"label":"Jul","value":397},{"label":"Ago","value":620},{"label":"Set","value":482},{"label":"Out","value":346},{"label":"Nov","value":430},{"label":"Dez","value":615}];
const MX = 620;
