...
const PAGE = "Lease";
const KPIS = [{"l":"Total Property Mgmt","v":"4.775","t":"+0.8%","d":"up"},{"l":"Lease Ativos","v":"1.226","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+9.4%","d":"up"}];
const COLS = ["ID","Lease","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Mgmt #001","Property Mgmt #002","8.374","5.535","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Property Mgmt #002","Property Mgmt #003","7.021","8.222","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Mgmt #003","Property Mgmt #004","7.197","7.111","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Property Mgmt #004","Property Mgmt #005","9.049","6.759","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Mgmt #005","Property Mgmt #001","7.157","6.542","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":316},{"label":"Mar","value":517},{"label":"Abr","value":601},{"label":"Mai","value":531},{"label":"Jun","value":406},{"label":"Jul","value":693},{"label":"Ago","value":528},{"label":"Set","value":433},{"label":"Out","value":597},{"label":"Nov","value":457},{"label":"Dez","value":540}];
const MX = 693;
