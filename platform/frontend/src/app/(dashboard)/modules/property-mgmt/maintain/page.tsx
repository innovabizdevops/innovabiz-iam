...
const KPIS = [{"l":"Total Property Mgmt","v":"2.754","t":"+-0.0%","d":"up"},{"l":"Maintenance Ativos","v":"6.286","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"85.2%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+1.3%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Mgmt #001","Property Mgmt #002","6.288","6.378","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Property Mgmt #002","Property Mgmt #003","5.318","5.497","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Mgmt #003","Property Mgmt #004","1.131","6.471","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Property Mgmt #004","Property Mgmt #005","2.496","2.545","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Mgmt #005","Property Mgmt #001","7.644","4.081","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":909},{"label":"Mar","value":672},{"label":"Abr","value":995},{"label":"Mai","value":881},{"label":"Jun","value":682},{"label":"Jul","value":641},{"label":"Ago","value":777},{"label":"Set","value":702},{"label":"Out","value":934},{"label":"Nov","value":839},{"label":"Dez","value":610}];
const MX = 995;
