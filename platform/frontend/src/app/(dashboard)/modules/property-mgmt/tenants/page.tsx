...
const PAGE = "Tenants";
const KPIS = [{"l":"Configurações","v":"7.300","t":"+10.9%","d":"up"},{"l":"Últimas Alterações","v":"3.752","t":"-5.2%","d":"down"},{"l":"Ambientes","v":"1.521","t":"+17.2%","d":"up"},{"l":"Versão Config","v":"7.257","t":"+13.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 12389.97","2.235","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 828.04","8.947","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 11802.92","445","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 35715.98","3.819","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 41501.81","8.502","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":707},{"label":"Mar","value":713},{"label":"Abr","value":806},{"label":"Mai","value":639},{"label":"Jun","value":763},{"label":"Jul","value":786},{"label":"Ago","value":570},{"label":"Set","value":534},{"label":"Out","value":755},{"label":"Nov","value":594},{"label":"Dez","value":869}];
const MX = 877;
