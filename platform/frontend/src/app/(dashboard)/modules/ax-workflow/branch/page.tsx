...
const PAGE = "Branch";
const KPIS = [{"l":"Total Ax Workflow","v":"3.824","t":"+11.8%","d":"up"},{"l":"Branch Ativos","v":"6.111","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"60","t":"-3.9%","d":"down"}];
const COLS = ["ID","Branch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Workflow #001","Ax Workflow #002","8.287","8.632","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Workflow #002","Ax Workflow #003","3.571","6.375","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Workflow #003","Ax Workflow #004","849","1.347","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Workflow #004","Ax Workflow #005","3.022","4.567","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Workflow #005","Ax Workflow #001","2.311","8.206","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":906},{"label":"Mar","value":901},{"label":"Abr","value":665},{"label":"Mai","value":786},{"label":"Jun","value":947},{"label":"Jul","value":947},{"label":"Ago","value":956},{"label":"Set","value":929},{"label":"Out","value":990},{"label":"Nov","value":884},{"label":"Dez","value":713}];
const MX = 990;
