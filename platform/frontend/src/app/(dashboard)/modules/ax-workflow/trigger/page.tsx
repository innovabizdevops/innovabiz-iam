...
const PAGE = "Trigger";
const KPIS = [{"l":"Total Ax Workflow","v":"8.347","t":"+4.6%","d":"up"},{"l":"Trigger Ativos","v":"4.542","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"57","t":"-5.2%","d":"down"}];
const COLS = ["ID","Trigger","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Workflow #001","Ax Workflow #002","3.876","7.774","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Workflow #002","Ax Workflow #003","3.315","2.976","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Workflow #003","Ax Workflow #004","3.518","3.896","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Workflow #004","Ax Workflow #005","2.291","8.640","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Workflow #005","Ax Workflow #001","278","3.139","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":682},{"label":"Mar","value":664},{"label":"Abr","value":790},{"label":"Mai","value":804},{"label":"Jun","value":599},{"label":"Jul","value":921},{"label":"Ago","value":745},{"label":"Set","value":545},{"label":"Out","value":728},{"label":"Nov","value":835},{"label":"Dez","value":688}];
const MX = 921;
