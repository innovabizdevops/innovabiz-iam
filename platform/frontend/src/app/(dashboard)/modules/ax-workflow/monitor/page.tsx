...
const ACCENT = "#4f46e5";
const MODULE = "AX Workflow Automation";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Ax Workflow","v":"8.024","t":"+8.5%","d":"up"},{"l":"Monitor Ativos","v":"5.341","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.0%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Workflow #001","Ax Workflow #002","728","5.191","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Workflow #002","Ax Workflow #003","6.118","3.123","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Workflow #003","Ax Workflow #004","3.494","7.589","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Workflow #004","Ax Workflow #005","5.838","1.458","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Workflow #005","Ax Workflow #001","3.666","6.782","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":605},{"label":"Mar","value":575},{"label":"Abr","value":831},{"label":"Mai","value":752},{"label":"Jun","value":864},{"label":"Jul","value":583},{"label":"Ago","value":621},{"label":"Set","value":912},{"label":"Out","value":805},{"label":"Nov","value":637},{"label":"Dez","value":944}];
const MX = 944;
