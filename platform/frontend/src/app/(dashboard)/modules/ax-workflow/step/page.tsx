...
const PAGE = "Step";
const KPIS = [{"l":"Total Ax Workflow","v":"2.447","t":"+11.2%","d":"up"},{"l":"Step Ativos","v":"3.392","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.1%","d":"up"}];
const COLS = ["ID","Step","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Workflow #001","Ax Workflow #002","6.842","4.487","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Workflow #002","Ax Workflow #003","4.360","4.552","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Workflow #003","Ax Workflow #004","4.681","9.023","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Workflow #004","Ax Workflow #005","8.529","5.164","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Workflow #005","Ax Workflow #001","4.729","3.954","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1039},{"label":"Fev","value":660},{"label":"Mar","value":1000},{"label":"Abr","value":854},{"label":"Mai","value":668},{"label":"Jun","value":1006},{"label":"Jul","value":966},{"label":"Ago","value":750},{"label":"Set","value":862},{"label":"Out","value":790},{"label":"Nov","value":822},{"label":"Dez","value":961}];
const MX = 1039;
