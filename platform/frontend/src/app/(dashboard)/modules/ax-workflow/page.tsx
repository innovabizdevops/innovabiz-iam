...
/* ═══ AX Workflow Automation — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "2540", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1311", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€209K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "801575740", cells: ["AX-9740", "AX Workflow Automation Item 1", "1/5/2026", "€25 840"], status: "active" as const },
    { id: "801579311", cells: ["AX-4311", "AX Workflow Automation Item 2", "16/12/2026", "€29 411"], status: "pending" as const },
    { id: "801582882", cells: ["AX-7882", "AX Workflow Automation Item 3", "3/7/2026", "€32 982"], status: "completed" as const },
    { id: "801586453", cells: ["AX-2453", "AX Workflow Automation Item 4", "18/2/2026", "€36 553"], status: "warning" as const },
    { id: "801590024", cells: ["AX-6024", "AX Workflow Automation Item 5", "5/9/2026", "€40 124"], status: "active" as const },
];
...
export default function AxWorkflowAutomationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Workflow Automation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Workflow Automation</p>
                    </div>
                </div>
