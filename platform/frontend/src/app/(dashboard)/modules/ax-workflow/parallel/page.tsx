...
const PAGE = "Parallel";
const KPIS = [{"l":"Total Ax Workflow","v":"7.615","t":"+8.4%","d":"up"},{"l":"Parallel Ativos","v":"816","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"70","t":"+2.9%","d":"up"}];
const COLS = ["ID","Parallel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Workflow #001","Ax Workflow #002","5.522","5.363","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Workflow #002","Ax Workflow #003","432","3.508","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Workflow #003","Ax Workflow #004","3.503","257","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Workflow #004","Ax Workflow #005","4.507","4.835","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Workflow #005","Ax Workflow #001","246","4.227","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":855},{"label":"Mar","value":555},{"label":"Abr","value":692},{"label":"Mai","value":544},{"label":"Jun","value":586},{"label":"Jul","value":723},{"label":"Ago","value":794},{"label":"Set","value":851},{"label":"Out","value":892},{"label":"Nov","value":553},{"label":"Dez","value":803}];
const MX = 892;
