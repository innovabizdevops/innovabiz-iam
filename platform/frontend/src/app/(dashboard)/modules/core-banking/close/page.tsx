...
const PAGE = "Close Account";
const KPIS = [{"l":"Total Core Banking","v":"6.795","t":"-1.9%","d":"down"},{"l":"Close Account Ativos","v":"6.727","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"62","t":"+10.8%","d":"up"}];
const COLS = ["ID","Close Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Banking #001","Core Banking #002","8.483","6.630","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Core Banking #002","Core Banking #003","3.628","4.041","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Banking #003","Core Banking #004","3.890","6.559","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Core Banking #004","Core Banking #005","2.139","5.410","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Banking #005","Core Banking #001","4.235","3.339","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":943},{"label":"Mar","value":844},{"label":"Abr","value":963},{"label":"Mai","value":945},{"label":"Jun","value":797},{"label":"Jul","value":907},{"label":"Ago","value":979},{"label":"Set","value":1001},{"label":"Out","value":695},{"label":"Nov","value":964},{"label":"Dez","value":898}];
const MX = 1001;
