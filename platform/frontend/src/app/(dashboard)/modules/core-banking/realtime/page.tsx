...
const ACCENT = "#1e40af";
const MODULE = "Core Banking";
const PAGE = "Real-Time Ledger";
const KPIS = [{"l":"Total Core Banking","v":"6.595","t":"+5.3%","d":"up"},{"l":"Real Time Ledger Ativos","v":"5.735","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"89.5%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"89","t":"+10.4%","d":"up"}];
const COLS = ["ID","Real Time Ledger","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Banking #001","Core Banking #002","4.529","7.186","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Core Banking #002","Core Banking #003","1.688","4.701","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Banking #003","Core Banking #004","3.359","4.976","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Core Banking #004","Core Banking #005","7.192","3.258","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Banking #005","Core Banking #001","537","4.916","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":592},{"label":"Mar","value":600},{"label":"Abr","value":481},{"label":"Mai","value":409},{"label":"Jun","value":519},{"label":"Jul","value":541},{"label":"Ago","value":517},{"label":"Set","value":237},{"label":"Out","value":496},{"label":"Nov","value":318},{"label":"Dez","value":491}];
const MX = 600;
