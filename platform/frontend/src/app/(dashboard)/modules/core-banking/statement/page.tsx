...
const KPIS = [{"l":"Total Core Banking","v":"1.594","t":"-3.1%","d":"down"},{"l":"Statement Ativos","v":"1.096","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+15.2%","d":"up"}];
const COLS = ["ID","Statement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Banking #001","Core Banking #002","2.941","2.642","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Core Banking #002","Core Banking #003","7.714","4.252","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Banking #003","Core Banking #004","4.411","1.769","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Core Banking #004","Core Banking #005","913","8.806","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Banking #005","Core Banking #001","3.276","6.070","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":631},{"label":"Mar","value":861},{"label":"Abr","value":997},{"label":"Mai","value":943},{"label":"Jun","value":853},{"label":"Jul","value":674},{"label":"Ago","value":841},{"label":"Set","value":701},{"label":"Out","value":802},{"label":"Nov","value":922},{"label":"Dez","value":749}];
const MX = 997;
