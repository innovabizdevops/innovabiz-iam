...
const PAGE = "Account Open";
const KPIS = [{"l":"Total Core Banking","v":"4.388","t":"+16.2%","d":"up"},{"l":"Account Open Ativos","v":"8.322","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"62","t":"-1.1%","d":"down"}];
const COLS = ["ID","Account Open","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Banking #001","Core Banking #002","1.970","8.266","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Core Banking #002","Core Banking #003","4.480","5.531","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Banking #003","Core Banking #004","6.156","3.172","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Core Banking #004","Core Banking #005","5.787","6.708","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Banking #005","Core Banking #001","973","1.071","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":955},{"label":"Mar","value":912},{"label":"Abr","value":936},{"label":"Mai","value":801},{"label":"Jun","value":790},{"label":"Jul","value":800},{"label":"Ago","value":887},{"label":"Set","value":798},{"label":"Out","value":1015},{"label":"Nov","value":1014},{"label":"Dez","value":866}];
const MX = 1015;
