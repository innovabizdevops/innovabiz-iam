...
const PAGE = "Interest Calc";
const KPIS = [{"l":"Total Core Banking","v":"4.416","t":"-3.2%","d":"down"},{"l":"Interest Calc Ativos","v":"2.532","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"83","t":"+9.8%","d":"up"}];
const COLS = ["ID","Interest Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Banking #001","Core Banking #002","2.003","2.809","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Core Banking #002","Core Banking #003","861","5.094","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Banking #003","Core Banking #004","5.176","2.451","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Core Banking #004","Core Banking #005","6.673","6.037","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Banking #005","Core Banking #001","7.839","2.201","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":704},{"label":"Mar","value":592},{"label":"Abr","value":517},{"label":"Mai","value":813},{"label":"Jun","value":757},{"label":"Jul","value":769},{"label":"Ago","value":709},{"label":"Set","value":769},{"label":"Out","value":456},{"label":"Nov","value":689},{"label":"Dez","value":796}];
const MX = 813;
