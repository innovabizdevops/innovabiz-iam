...
const KPIS = [{"l":"Total Core Banking","v":"1.214","t":"+8.0%","d":"up"},{"l":"Multi Currency Ativos","v":"6.628","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"78.8%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"75","t":"+17.4%","d":"up"}];
const COLS = ["ID","Multi Currency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Banking #001","Core Banking #002","3.283","208","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Core Banking #002","Core Banking #003","1.585","7.368","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Banking #003","Core Banking #004","117","8.162","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Core Banking #004","Core Banking #005","2.686","376","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Banking #005","Core Banking #001","6.982","6.929","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":690},{"label":"Mar","value":753},{"label":"Abr","value":582},{"label":"Mai","value":768},{"label":"Jun","value":647},{"label":"Jul","value":840},{"label":"Ago","value":685},{"label":"Set","value":631},{"label":"Out","value":714},{"label":"Nov","value":730},{"label":"Dez","value":719}];
const MX = 840;
