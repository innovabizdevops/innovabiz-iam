...
const PAGE = "Multi-Drop";
const KPIS = [{"l":"Total Load Planning","v":"2.860","t":"+0.4%","d":"up"},{"l":"Multi Drop Ativos","v":"4.746","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"91","t":"-1.8%","d":"down"}];
const COLS = ["ID","Multi Drop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Load Planning #001","Load Planning #002","4.895","182","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Load Planning #002","Load Planning #003","8.050","1.103","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Load Planning #003","Load Planning #004","5.598","3.184","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Load Planning #004","Load Planning #005","2.079","642","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Load Planning #005","Load Planning #001","8.104","3.443","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":846},{"label":"Mar","value":800},{"label":"Abr","value":526},{"label":"Mai","value":776},{"label":"Jun","value":507},{"label":"Jul","value":834},{"label":"Ago","value":871},{"label":"Set","value":517},{"label":"Out","value":582},{"label":"Nov","value":855},{"label":"Dez","value":698}];
const MX = 871;
...
export default function MultidropPage() {
    return (
