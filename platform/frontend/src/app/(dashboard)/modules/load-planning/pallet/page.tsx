...
const PAGE = "Pallet Config";
const KPIS = [{"l":"Configurações","v":"5.125","t":"+5.4%","d":"up"},{"l":"Últimas Alterações","v":"8.710","t":"+5.8%","d":"up"},{"l":"Ambientes","v":"2.481","t":"+7.1%","d":"up"},{"l":"Versão Config","v":"314","t":"-1.1%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 35906.18","8.306","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 24868.25","5.180","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 17104.93","428","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 19515.26","7.246","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 13255.14","2.554","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":519},{"label":"Mar","value":803},{"label":"Abr","value":701},{"label":"Mai","value":706},{"label":"Jun","value":854},{"label":"Jul","value":702},{"label":"Ago","value":763},{"label":"Set","value":772},{"label":"Out","value":742},{"label":"Nov","value":770},{"label":"Dez","value":915}];
const MX = 915;
