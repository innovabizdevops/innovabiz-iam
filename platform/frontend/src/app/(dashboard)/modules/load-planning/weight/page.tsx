...
const PAGE = "Weight Distrib";
const KPIS = [{"l":"Total Load Planning","v":"4.678","t":"+7.1%","d":"up"},{"l":"Weight Distrib Ativos","v":"6.930","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"74","t":"-3.9%","d":"down"}];
const COLS = ["ID","Weight Distrib","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Load Planning #001","Load Planning #002","1.039","922","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Load Planning #002","Load Planning #003","5.293","1.852","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Load Planning #003","Load Planning #004","5.523","2.759","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Load Planning #004","Load Planning #005","3.032","5.503","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Load Planning #005","Load Planning #001","3.178","1.794","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":801},{"label":"Mar","value":715},{"label":"Abr","value":477},{"label":"Mai","value":680},{"label":"Jun","value":642},{"label":"Jul","value":616},{"label":"Ago","value":689},{"label":"Set","value":653},{"label":"Out","value":449},{"label":"Nov","value":573},{"label":"Dez","value":616}];
const MX = 801;
