...
const ACCENT = "#1e3a5f";
const MODULE = "Load Planning";
const PAGE = "Cube Optimize";
const KPIS = [{"l":"Total Load Planning","v":"7.844","t":"+12.7%","d":"up"},{"l":"Cube Optimize Ativos","v":"2.412","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"89.1%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"56","t":"-2.7%","d":"down"}];
const COLS = ["ID","Cube Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Load Planning #001","Load Planning #002","1.243","4.534","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Load Planning #002","Load Planning #003","8.703","8.605","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Load Planning #003","Load Planning #004","1.197","280","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Load Planning #004","Load Planning #005","8.219","674","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Load Planning #005","Load Planning #001","2.898","2.382","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":490},{"label":"Mar","value":301},{"label":"Abr","value":560},{"label":"Mai","value":377},{"label":"Jun","value":445},{"label":"Jul","value":359},{"label":"Ago","value":349},{"label":"Set","value":384},{"label":"Out","value":565},{"label":"Nov","value":355},{"label":"Dez","value":538}];
const MX = 565;
