...
const PAGE = "3D Visualize";
const KPIS = [{"l":"Dashboards Ativos","v":"8.120","t":"-4.4%","d":"down"},{"l":"Queries/Dia","v":"3774","t":"+8.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.727","t":"+1.6%","d":"up"},{"l":"Utilizadores Analytics","v":"6.108","t":"+7.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2624","2026-03-19","123","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1117","2026-01-13","1.392","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1153","2026-01-22","3.963","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1182","2026-01-02","1.526","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4847","2026-03-27","5.936","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":814},{"label":"Mar","value":607},{"label":"Abr","value":779},{"label":"Mai","value":648},{"label":"Jun","value":668},{"label":"Jul","value":815},{"label":"Ago","value":589},{"label":"Set","value":770},{"label":"Out","value":764},{"label":"Nov","value":753},{"label":"Dez","value":714}];
const MX = 815;
