...
const PAGE = "Dual Use";
const KPIS = [{"l":"Total Trade Compliance Adv","v":"3632","d":"+4.4%","u":true},{"l":"Trade Compliance Adv Ativos","v":"1393","d":"+2.5%","u":true},{"l":"Pendentes","v":"182","d":"-4.1%","u":false},{"l":"Performance (%)","v":"89.2%","d":"+1.1%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Dual Use-001", "Dual Use Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Dual Use-002", "Dual Use Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Dual Use-003", "Dual Use Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Dual Use-004", "Dual Use Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Dual Use-005", "Dual Use Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Dual Use", ts: "Há 2min", a: "Sistema" },
