...
const PAGE = "License Mgmt Trade";
const KPIS = [{"l":"Total Trade Compliance Adv","v":"2378","d":"+14.1%","u":true},{"l":"Trade Compliance Adv Ativos","v":"557","d":"+2.2%","u":true},{"l":"Pendentes","v":"149","d":"-8.7%","u":false},{"l":"Performance (%)","v":"88.6%","d":"+1.9%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["License Mgmt Trade-001", "License Mgmt Trade Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["License Mgmt Trade-002", "License Mgmt Trade Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["License Mgmt Trade-003", "License Mgmt Trade Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["License Mgmt Trade-004", "License Mgmt Trade Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["License Mgmt Trade-005", "License Mgmt Trade Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em License Mgmt Trade", ts: "Há 2min", a: "Sistema" },
...
export default function LicenseMgmtTradePage() {
  return (
