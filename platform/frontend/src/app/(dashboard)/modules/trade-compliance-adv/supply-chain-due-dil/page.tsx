...
const PAGE = "Supply Chain Due Dil";
const KPIS = [{"l":"Total Trade Compliance Adv","v":"1281","d":"+8.4%","u":true},{"l":"Trade Compliance Adv Ativos","v":"2096","d":"+2.3%","u":true},{"l":"Pendentes","v":"196","d":"-3.1%","u":false},{"l":"Performance (%)","v":"99.0%","d":"+2.7%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Supply Chain Due Dil-001", "Supply Chain Due Dil Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Supply Chain Due Dil-002", "Supply Chain Due Dil Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Supply Chain Due Dil-003", "Supply Chain Due Dil Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Supply Chain Due Dil-004", "Supply Chain Due Dil Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Supply Chain Due Dil-005", "Supply Chain Due Dil Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Supply Chain Due Dil", ts: "Há 2min", a: "Sistema" },
...
export default function SupplyChainDueDilPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Trade Compliance Adv — iBOS Enterprise</p>
        </div>
