...
const PAGE = "Sanction Screen Tr";
const KPIS = [{"l":"Total Trade Compliance Adv","v":"4395","d":"+12.7%","u":true},{"l":"Trade Compliance Adv Ativos","v":"2239","d":"+4.7%","u":true},{"l":"Pendentes","v":"184","d":"-6.3%","u":false},{"l":"Performance (%)","v":"94.3%","d":"+3.2%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Sanction Screen Tr-001", "Sanction Screen Tr Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Sanction Screen Tr-002", "Sanction Screen Tr Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Sanction Screen Tr-003", "Sanction Screen Tr Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Sanction Screen Tr-004", "Sanction Screen Tr Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Sanction Screen Tr-005", "Sanction Screen Tr Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Sanction Screen Tr", ts: "Há 2min", a: "Sistema" },
...
export default function SanctionScreenTrPage() {
  return (
