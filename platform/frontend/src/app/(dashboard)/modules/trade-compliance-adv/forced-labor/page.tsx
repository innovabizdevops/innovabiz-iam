...
const PAGE = "Forced Labor";
const KPIS = [{"l":"Total Trade Compliance Adv","v":"3560","d":"+8.6%","u":true},{"l":"Trade Compliance Adv Ativos","v":"1240","d":"+4.9%","u":true},{"l":"Pendentes","v":"100","d":"-2.8%","u":false},{"l":"Performance (%)","v":"88.6%","d":"+0.7%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Forced Labor-001", "Forced Labor Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Forced Labor-002", "Forced Labor Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Forced Labor-003", "Forced Labor Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Forced Labor-004", "Forced Labor Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Forced Labor-005", "Forced Labor Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Forced Labor", ts: "Há 2min", a: "Sistema" },
...
export default function ForcedLaborPage() {
  return (
