...
const KPIS = [{"l":"Total Trade Compliance Adv","v":"4664","d":"+1.7%","u":true},{"l":"Trade Compliance Adv Ativos","v":"2149","d":"+1.0%","u":true},{"l":"Pendentes","v":"187","d":"-9.4%","u":false},{"l":"Performance (%)","v":"88.6%","d":"+1.8%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Conflict Mineral-001", "Conflict Mineral Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Conflict Mineral-002", "Conflict Mineral Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Conflict Mineral-003", "Conflict Mineral Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Conflict Mineral-004", "Conflict Mineral Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Conflict Mineral-005", "Conflict Mineral Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Conflict Mineral", ts: "Há 2min", a: "Sistema" },
...
export default function ConflictMineralPage() {
  return (
