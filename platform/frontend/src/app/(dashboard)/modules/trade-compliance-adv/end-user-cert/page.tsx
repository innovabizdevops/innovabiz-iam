...
const PAGE = "End User Cert";
const KPIS = [{"l":"Total Trade Compliance Adv","v":"4605","d":"+10.5%","u":true},{"l":"Trade Compliance Adv Ativos","v":"1596","d":"+1.5%","u":true},{"l":"Pendentes","v":"110","d":"-3.5%","u":false},{"l":"Performance (%)","v":"91.1%","d":"+1.6%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["End User Cert-001", "End User Cert Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["End User Cert-002", "End User Cert Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["End User Cert-003", "End User Cert Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["End User Cert-004", "End User Cert Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["End User Cert-005", "End User Cert Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em End User Cert", ts: "Há 2min", a: "Sistema" },
...
export default function EndUserCertPage() {
  return (
