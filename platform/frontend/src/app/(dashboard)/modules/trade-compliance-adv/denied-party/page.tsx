...
const KPIS = [{"l":"Total Trade Compliance Adv","v":"2081","d":"+11.3%","u":true},{"l":"Trade Compliance Adv Ativos","v":"2255","d":"+6.5%","u":true},{"l":"Pendentes","v":"152","d":"-6.5%","u":false},{"l":"Performance (%)","v":"89.5%","d":"+3.2%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Denied Party-001", "Denied Party Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Denied Party-002", "Denied Party Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Denied Party-003", "Denied Party Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Denied Party-004", "Denied Party Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Denied Party-005", "Denied Party Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Denied Party", ts: "Há 2min", a: "Sistema" },
