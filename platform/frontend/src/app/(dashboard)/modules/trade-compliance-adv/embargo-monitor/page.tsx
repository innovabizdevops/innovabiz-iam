...
const PAGE = "Embargo Monitor";
const KPIS = [{"l":"Total Trade Compliance Adv","v":"3997","d":"+0.2%","u":true},{"l":"Trade Compliance Adv Ativos","v":"506","d":"+1.9%","u":true},{"l":"Pendentes","v":"169","d":"-7.1%","u":false},{"l":"Performance (%)","v":"95.0%","d":"+3.8%","u":true}];
const COLS = ["ID","Trade Compliance Adv","Categoria","Responsável","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Embargo Monitor-001", "Embargo Monitor Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Embargo Monitor-002", "Embargo Monitor Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Embargo Monitor-003", "Embargo Monitor Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Embargo Monitor-004", "Embargo Monitor Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Embargo Monitor-005", "Embargo Monitor Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Embargo Monitor", ts: "Há 2min", a: "Sistema" },
...
export default function EmbargoMonitorPage() {
  return (
