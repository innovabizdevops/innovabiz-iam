...
const KPIS = [
    { label: "Total Registos", value: "851", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "420", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€204K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1275477151", cells: ["CON-7151", "Content Moderation (AI) Item 1", "12/8/2026", "€27 251"], status: "active" as const },
    { id: "1275480722", cells: ["CON-1722", "Content Moderation (AI) Item 2", "27/3/2026", "€30 822"], status: "pending" as const },
    { id: "1275484293", cells: ["CON-5293", "Content Moderation (AI) Item 3", "14/10/2026", "€34 393"], status: "completed" as const },
    { id: "1275487864", cells: ["CON-8864", "Content Moderation (AI) Item 4", "1/5/2026", "€37 964"], status: "warning" as const },
    { id: "1275491435", cells: ["CON-3435", "Content Moderation (AI) Item 5", "16/12/2026", "€41 535"], status: "active" as const },
];
...
export default function ContentModerationAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Content Moderation (AI)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Content Moderation (AI)</p>
                    </div>
                </div>
