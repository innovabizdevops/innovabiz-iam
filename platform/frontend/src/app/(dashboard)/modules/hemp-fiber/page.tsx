...
/* ═══ Hemp Fiber Processing — Dashboard ═══ */

const ACCENT = "#0d3b1e";

const KPIS = [
    { label: "Total Registos", value: "986", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4513", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€314K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "560618086", cells: ["HEM-9086", "Hemp Fiber Processing Item 1", "15/11/2026", "€18 186"], status: "active" as const },
    { id: "560621657", cells: ["HEM-3657", "Hemp Fiber Processing Item 2", "2/6/2026", "€21 757"], status: "pending" as const },
    { id: "560625228", cells: ["HEM-7228", "Hemp Fiber Processing Item 3", "17/1/2026", "€25 328"], status: "completed" as const },
    { id: "560628799", cells: ["HEM-1799", "Hemp Fiber Processing Item 4", "4/8/2026", "€28 899"], status: "warning" as const },
    { id: "560632370", cells: ["HEM-5370", "Hemp Fiber Processing Item 5", "19/3/2026", "€32 470"], status: "active" as const },
];
...
export default function HempFiberProcessingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hemp Fiber Processing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hemp Fiber Processing</p>
                    </div>
                </div>
