...
const PAGE = "Ret";
const KPIS = [{"l":"Total Hemp Fiber","v":"6.715","t":"+9.8%","d":"up"},{"l":"Ret Ativos","v":"670","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"68.9%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+3.6%","d":"up"}];
const COLS = ["ID","Ret","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hemp Fiber #001","Hemp Fiber #002","4.107","475","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Hemp Fiber #002","Hemp Fiber #003","7.357","676","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Hemp Fiber #003","Hemp Fiber #004","6.865","5.229","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Hemp Fiber #004","Hemp Fiber #005","6.868","8.337","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hemp Fiber #005","Hemp Fiber #001","582","8.510","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":325},{"label":"Fev","value":640},{"label":"Mar","value":245},{"label":"Abr","value":533},{"label":"Mai","value":602},{"label":"Jun","value":369},{"label":"Jul","value":581},{"label":"Ago","value":258},{"label":"Set","value":640},{"label":"Out","value":309},{"label":"Nov","value":373},{"label":"Dez","value":643}];
const MX = 643;
