...
const ACCENT = "#0d3b1e";
const MODULE = "Hemp Fiber Processing";
const PAGE = "Decorticate";
const KPIS = [{"l":"Total Hemp Fiber","v":"5.996","t":"+6.2%","d":"up"},{"l":"Decorticate Ativos","v":"5.416","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"89.3%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"78","t":"+3.8%","d":"up"}];
const COLS = ["ID","Decorticate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hemp Fiber #001","Hemp Fiber #002","3.334","3.976","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Hemp Fiber #002","Hemp Fiber #003","8.459","5.154","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Hemp Fiber #003","Hemp Fiber #004","2.710","154","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Hemp Fiber #004","Hemp Fiber #005","6.807","2.810","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hemp Fiber #005","Hemp Fiber #001","5.077","3.094","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":710},{"label":"Mar","value":774},{"label":"Abr","value":600},{"label":"Mai","value":676},{"label":"Jun","value":799},{"label":"Jul","value":629},{"label":"Ago","value":762},{"label":"Set","value":898},{"label":"Out","value":562},{"label":"Nov","value":738},{"label":"Dez","value":783}];
const MX = 898;
...
export default function DecortPage() {
    return (
