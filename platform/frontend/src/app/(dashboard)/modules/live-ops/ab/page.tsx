...
const KPIS = [{"l":"Total Live Ops","v":"4.348","t":"+13.8%","d":"up"},{"l":"A/B Testing Ativos","v":"4.121","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"91","t":"+6.0%","d":"up"}];
const COLS = ["ID","A/B Testing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Ops #001","Live Ops #002","7.764","3.509","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Live Ops #002","Live Ops #003","8.892","2.138","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Ops #003","Live Ops #004","1.745","2.812","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Live Ops #004","Live Ops #005","7.216","4.385","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Ops #005","Live Ops #001","6.936","4.196","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":683},{"label":"Mar","value":619},{"label":"Abr","value":700},{"label":"Mai","value":802},{"label":"Jun","value":811},{"label":"Jul","value":706},{"label":"Ago","value":645},{"label":"Set","value":588},{"label":"Out","value":764},{"label":"Nov","value":747},{"label":"Dez","value":652}];
const MX = 896;
