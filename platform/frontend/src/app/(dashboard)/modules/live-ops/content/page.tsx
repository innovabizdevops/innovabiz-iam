...
const ACCENT = "#dc2626";
const MODULE = "Live Operations";
const PAGE = "Content Drop";
const KPIS = [{"l":"Total Live Ops","v":"3.240","t":"+9.6%","d":"up"},{"l":"Content Drop Ativos","v":"7.422","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"84","t":"-0.3%","d":"down"}];
const COLS = ["ID","Content Drop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Ops #001","Live Ops #002","8.142","8.508","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Live Ops #002","Live Ops #003","8.741","7.143","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Ops #003","Live Ops #004","3.975","9.038","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Live Ops #004","Live Ops #005","2.295","8.540","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Ops #005","Live Ops #001","1.485","1.107","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":674},{"label":"Mar","value":788},{"label":"Abr","value":547},{"label":"Mai","value":670},{"label":"Jun","value":797},{"label":"Jul","value":606},{"label":"Ago","value":524},{"label":"Set","value":823},{"label":"Out","value":577},{"label":"Nov","value":816},{"label":"Dez","value":517}];
const MX = 823;
