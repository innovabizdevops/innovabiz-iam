...
const PAGE = "Feature Flag";
const KPIS = [{"l":"Total Live Ops","v":"5.941","t":"+6.7%","d":"up"},{"l":"Feature Flag Ativos","v":"4.808","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"61","t":"+0.4%","d":"up"}];
const COLS = ["ID","Feature Flag","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Ops #001","Live Ops #002","3.512","3.031","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Live Ops #002","Live Ops #003","2.534","8.266","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Ops #003","Live Ops #004","8.895","8.003","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Live Ops #004","Live Ops #005","7.524","3.799","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Ops #005","Live Ops #001","5.857","4.780","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":801},{"label":"Mar","value":900},{"label":"Abr","value":751},{"label":"Mai","value":797},{"label":"Jun","value":648},{"label":"Jul","value":939},{"label":"Ago","value":777},{"label":"Set","value":737},{"label":"Out","value":899},{"label":"Nov","value":716},{"label":"Dez","value":808}];
const MX = 939;
