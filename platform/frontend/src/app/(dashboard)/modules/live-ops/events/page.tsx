...
const PAGE = "Event Calendar";
const KPIS = [{"l":"Total Live Ops","v":"5.716","t":"-0.9%","d":"down"},{"l":"Event Calendar Ativos","v":"4.657","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+5.8%","d":"up"}];
const COLS = ["ID","Event Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Ops #001","Live Ops #002","1.283","2.602","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Live Ops #002","Live Ops #003","553","7.140","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Ops #003","Live Ops #004","3.063","257","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Live Ops #004","Live Ops #005","4.890","606","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Ops #005","Live Ops #001","2.035","6.492","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":570},{"label":"Mar","value":727},{"label":"Abr","value":718},{"label":"Mai","value":402},{"label":"Jun","value":758},{"label":"Jul","value":431},{"label":"Ago","value":719},{"label":"Set","value":387},{"label":"Out","value":599},{"label":"Nov","value":498},{"label":"Dez","value":412}];
const MX = 758;
