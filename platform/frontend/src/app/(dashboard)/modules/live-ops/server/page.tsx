...
const PAGE = "Server Scale";
const KPIS = [{"l":"Total Live Ops","v":"6.291","t":"+1.0%","d":"up"},{"l":"Server Scale Ativos","v":"8.259","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"74","t":"+16.9%","d":"up"}];
const COLS = ["ID","Server Scale","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Live Ops #001","Live Ops #002","9.064","294","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Live Ops #002","Live Ops #003","3.874","4.228","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Live Ops #003","Live Ops #004","7.586","4.428","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Live Ops #004","Live Ops #005","3.945","2.798","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Live Ops #005","Live Ops #001","2.162","1.940","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":1078},{"label":"Mar","value":761},{"label":"Abr","value":890},{"label":"Mai","value":695},{"label":"Jun","value":946},{"label":"Jul","value":909},{"label":"Ago","value":1020},{"label":"Set","value":706},{"label":"Out","value":1038},{"label":"Nov","value":687},{"label":"Dez","value":760}];
const MX = 1078;
