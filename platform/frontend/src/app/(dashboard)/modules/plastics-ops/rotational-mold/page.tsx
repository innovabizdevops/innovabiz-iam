...
/* ═══ Plastics Ops — Rotational Mold ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4295", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "296", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3656", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1006470116", cells: ["PLA-1116", "Rotational Mold Item 1", "9/9/2026", "€20 216"], status: "active" as const },
    { id: "1006473687", cells: ["PLA-4687", "Rotational Mold Item 2", "24/4/2026", "€23 787"], status: "pending" as const },
    { id: "1006477258", cells: ["PLA-8258", "Rotational Mold Item 3", "11/11/2026", "€27 358"], status: "completed" as const },
    { id: "1006480829", cells: ["PLA-2829", "Rotational Mold Item 4", "26/6/2026", "€30 929"], status: "warning" as const },
    { id: "1006484400", cells: ["PLA-6400", "Rotational Mold Item 5", "13/1/2026", "€34 500"], status: "active" as const },
];
...
export default function PlasticsOpsRotationalMoldPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rotational Mold</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Rotational Mold</p>
                    </div>
                </div>
