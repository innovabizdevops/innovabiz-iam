...
/* ═══ Plastics Ops — Extrusion ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3602", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "256", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3356", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "850389788", cells: ["PLA-7788", "Extrusion Item 1", "25/9/2026", "€39 888"], status: "active" as const },
    { id: "850393359", cells: ["PLA-2359", "Extrusion Item 2", "12/4/2026", "€43 459"], status: "pending" as const },
    { id: "850396930", cells: ["PLA-5930", "Extrusion Item 3", "27/11/2026", "€47 030"], status: "completed" as const },
    { id: "850400501", cells: ["PLA-9501", "Extrusion Item 4", "14/6/2026", "€601"], status: "warning" as const },
    { id: "850404072", cells: ["PLA-4072", "Extrusion Item 5", "1/1/2026", "€4172"], status: "active" as const },
];
...
export default function PlasticsOpsExtrusionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Extrusion</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Extrusion</p>
                    </div>
                </div>
