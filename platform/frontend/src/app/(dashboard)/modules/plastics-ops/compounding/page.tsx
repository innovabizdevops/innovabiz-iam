...
/* ═══ Plastics Ops — Compounding ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1768", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "34", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3927", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "505124958", cells: ["PLA-9958", "Compounding Item 1", "3/7/2026", "€25 058"], status: "active" as const },
    { id: "505128529", cells: ["PLA-4529", "Compounding Item 2", "18/2/2026", "€28 629"], status: "pending" as const },
    { id: "505132100", cells: ["PLA-8100", "Compounding Item 3", "5/9/2026", "€32 200"], status: "completed" as const },
    { id: "505135671", cells: ["PLA-2671", "Compounding Item 4", "20/4/2026", "€35 771"], status: "warning" as const },
    { id: "505139242", cells: ["PLA-6242", "Compounding Item 5", "7/11/2026", "€39 342"], status: "active" as const },
];
...
export default function PlasticsOpsCompoundingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compounding</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Compounding</p>
                    </div>
                </div>
