...
/* ═══ Plastics Ops — Quality Plastics ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2594", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "157", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3515", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1817305481", cells: ["PLA-8481", "Quality Plastics Item 1", "6/6/2026", "€5581"], status: "active" as const },
    { id: "1817309052", cells: ["PLA-3052", "Quality Plastics Item 2", "21/1/2026", "€9152"], status: "pending" as const },
    { id: "1817312623", cells: ["PLA-6623", "Quality Plastics Item 3", "8/8/2026", "€12 723"], status: "completed" as const },
    { id: "1817316194", cells: ["PLA-1194", "Quality Plastics Item 4", "23/3/2026", "€16 294"], status: "warning" as const },
    { id: "1817319765", cells: ["PLA-4765", "Quality Plastics Item 5", "10/10/2026", "€19 865"], status: "active" as const },
];
...
export default function PlasticsOpsQualityPlasticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Plastics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Quality Plastics</p>
                    </div>
                </div>
