...
/* ═══ Plastics Ops — Blow Mold ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3275", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "391", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3406", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "759087731", cells: ["PLA-1731", "Blow Mold Item 1", "4/12/2026", "€37 831"], status: "active" as const },
    { id: "759091302", cells: ["PLA-5302", "Blow Mold Item 2", "19/7/2026", "€41 402"], status: "pending" as const },
    { id: "759094873", cells: ["PLA-8873", "Blow Mold Item 3", "6/2/2026", "€44 973"], status: "completed" as const },
    { id: "759098444", cells: ["PLA-3444", "Blow Mold Item 4", "21/9/2026", "€48 544"], status: "warning" as const },
    { id: "759102015", cells: ["PLA-7015", "Blow Mold Item 5", "8/4/2026", "€2115"], status: "active" as const },
];
...
export default function PlasticsOpsBlowMoldPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Blow Mold</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Blow Mold</p>
                    </div>
                </div>
