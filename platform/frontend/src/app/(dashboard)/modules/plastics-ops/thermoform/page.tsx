...
/* ═══ Plastics Ops — Thermoform ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "320", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "456", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3489", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "995682276", cells: ["PLA-4276", "Thermoform Item 1", "9/1/2026", "€32 376"], status: "active" as const },
    { id: "995685847", cells: ["PLA-7847", "Thermoform Item 2", "24/8/2026", "€35 947"], status: "pending" as const },
    { id: "995689418", cells: ["PLA-2418", "Thermoform Item 3", "11/3/2026", "€39 518"], status: "completed" as const },
    { id: "995692989", cells: ["PLA-5989", "Thermoform Item 4", "26/10/2026", "€43 089"], status: "warning" as const },
    { id: "995696560", cells: ["PLA-9560", "Thermoform Item 5", "13/5/2026", "€46 660"], status: "active" as const },
];
...
export default function PlasticsOpsThermoformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Thermoform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Thermoform</p>
                    </div>
                </div>
