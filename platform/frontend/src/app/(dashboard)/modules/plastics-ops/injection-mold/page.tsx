...
/* ═══ Plastics Ops — Injection Mold ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1330", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "92", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2902", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1836764984", cells: ["PLA-9984", "Injection Mold Item 1", "13/9/2026", "€15 084"], status: "active" as const },
    { id: "1836768555", cells: ["PLA-4555", "Injection Mold Item 2", "28/4/2026", "€18 655"], status: "pending" as const },
    { id: "1836772126", cells: ["PLA-8126", "Injection Mold Item 3", "15/11/2026", "€22 226"], status: "completed" as const },
    { id: "1836775697", cells: ["PLA-2697", "Injection Mold Item 4", "2/6/2026", "€25 797"], status: "warning" as const },
    { id: "1836779268", cells: ["PLA-6268", "Injection Mold Item 5", "17/1/2026", "€29 368"], status: "active" as const },
];
...
export default function PlasticsOpsInjectionMoldPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Injection Mold</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Injection Mold</p>
                    </div>
                </div>
