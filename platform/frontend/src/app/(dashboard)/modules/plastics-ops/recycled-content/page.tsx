...
/* ═══ Plastics Ops — Recycled Content ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2182", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "227", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2305", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "70%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "741777663", cells: ["PLA-7663", "Recycled Content Item 1", "12/4/2026", "€27 763"], status: "active" as const },
    { id: "741781234", cells: ["PLA-2234", "Recycled Content Item 2", "27/11/2026", "€31 334"], status: "pending" as const },
    { id: "741784805", cells: ["PLA-5805", "Recycled Content Item 3", "14/6/2026", "€34 905"], status: "completed" as const },
    { id: "741788376", cells: ["PLA-9376", "Recycled Content Item 4", "1/1/2026", "€38 476"], status: "warning" as const },
    { id: "741791947", cells: ["PLA-3947", "Recycled Content Item 5", "16/8/2026", "€42 047"], status: "active" as const },
];
...
export default function PlasticsOpsRecycledContentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Recycled Content</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Recycled Content</p>
                    </div>
                </div>
