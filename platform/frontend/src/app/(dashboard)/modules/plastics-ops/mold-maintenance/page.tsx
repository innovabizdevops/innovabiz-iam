...
/* ═══ Plastics Ops — Mold Maintenance ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4581", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "470", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "255", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "71%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1703969794", cells: ["PLA-9794", "Mold Maintenance Item 1", "3/11/2026", "€19 894"], status: "active" as const },
    { id: "1703973365", cells: ["PLA-4365", "Mold Maintenance Item 2", "18/6/2026", "€23 465"], status: "pending" as const },
    { id: "1703976936", cells: ["PLA-7936", "Mold Maintenance Item 3", "5/1/2026", "€27 036"], status: "completed" as const },
    { id: "1703980507", cells: ["PLA-2507", "Mold Maintenance Item 4", "20/8/2026", "€30 607"], status: "warning" as const },
    { id: "1703984078", cells: ["PLA-6078", "Mold Maintenance Item 5", "7/3/2026", "€34 178"], status: "active" as const },
];
...
export default function PlasticsOpsMoldMaintenancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mold Maintenance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Mold Maintenance</p>
                    </div>
                </div>
