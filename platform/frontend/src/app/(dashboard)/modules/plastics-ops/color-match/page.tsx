...
/* ═══ Plastics Ops — Color Match ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1092", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "81", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "574", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "242002957", cells: ["PLA-2957", "Color Match Item 1", "22/2/2026", "€3057"], status: "active" as const },
    { id: "242006528", cells: ["PLA-6528", "Color Match Item 2", "9/9/2026", "€6628"], status: "pending" as const },
    { id: "242010099", cells: ["PLA-1099", "Color Match Item 3", "24/4/2026", "€10 199"], status: "completed" as const },
    { id: "242013670", cells: ["PLA-4670", "Color Match Item 4", "11/11/2026", "€13 770"], status: "warning" as const },
    { id: "242017241", cells: ["PLA-8241", "Color Match Item 5", "26/6/2026", "€17 341"], status: "active" as const },
];
...
export default function PlasticsOpsColorMatchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Color Match</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Plastics Ops • Color Match</p>
                    </div>
                </div>
