...
/* ═══ Catastrophe Modeling — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "5679", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2629", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€468K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1141485479", cells: ["CAT-7479", "Catastrophe Modeling Item 1", "16/12/2026", "€35 579"], status: "active" as const },
    { id: "1141489050", cells: ["CAT-2050", "Catastrophe Modeling Item 2", "3/7/2026", "€39 150"], status: "pending" as const },
    { id: "1141492621", cells: ["CAT-5621", "Catastrophe Modeling Item 3", "18/2/2026", "€42 721"], status: "completed" as const },
    { id: "1141496192", cells: ["CAT-9192", "Catastrophe Modeling Item 4", "5/9/2026", "€46 292"], status: "warning" as const },
    { id: "1141499763", cells: ["CAT-3763", "Catastrophe Modeling Item 5", "20/4/2026", "€49 863"], status: "active" as const },
];
...
export default function CatastropheModelingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catastrophe Modeling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Catastrophe Modeling</p>
                    </div>
                </div>
