...
const PAGE = "Hazard";
const KPIS = [{"l":"Total Catastrophe Model","v":"2.030","t":"+10.2%","d":"up"},{"l":"Hazard Ativos","v":"262","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.8%","d":"up"}];
const COLS = ["ID","Hazard","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Catastrophe Model #001","Catastrophe Model #002","3.367","7.596","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Catastrophe Model #002","Catastrophe Model #003","2.554","2.862","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Catastrophe Model #003","Catastrophe Model #004","1.898","914","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Catastrophe Model #004","Catastrophe Model #005","1.479","8.854","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Catastrophe Model #005","Catastrophe Model #001","966","6.353","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":562},{"label":"Mar","value":732},{"label":"Abr","value":457},{"label":"Mai","value":794},{"label":"Jun","value":700},{"label":"Jul","value":741},{"label":"Ago","value":566},{"label":"Set","value":736},{"label":"Out","value":695},{"label":"Nov","value":715},{"label":"Dez","value":603}];
const MX = 794;
