...
const ACCENT = "#92400e";
const MODULE = "Catastrophe Modeling";
const PAGE = "Loss";
const KPIS = [{"l":"Total Catastrophe Model","v":"3.023","t":"+10.8%","d":"up"},{"l":"Loss Ativos","v":"4.378","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+1.5%","d":"up"},{"l":"Score Performance","v":"87","t":"-2.4%","d":"down"}];
const COLS = ["ID","Loss","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Catastrophe Model #001","Catastrophe Model #002","5.821","605","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Catastrophe Model #002","Catastrophe Model #003","6.854","6.632","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Catastrophe Model #003","Catastrophe Model #004","6.284","4.038","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Catastrophe Model #004","Catastrophe Model #005","3.423","7.407","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Catastrophe Model #005","Catastrophe Model #001","204","7.842","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":923},{"label":"Mar","value":738},{"label":"Abr","value":682},{"label":"Mai","value":638},{"label":"Jun","value":580},{"label":"Jul","value":858},{"label":"Ago","value":815},{"label":"Set","value":935},{"label":"Out","value":616},{"label":"Nov","value":890},{"label":"Dez","value":813}];
const MX = 935;
