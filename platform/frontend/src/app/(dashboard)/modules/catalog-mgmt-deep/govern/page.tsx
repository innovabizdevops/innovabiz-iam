...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"7.719","t":"+12.2%","d":"up"},{"l":"Queries/Dia","v":"151","t":"+16.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.176","t":"+4.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.887","t":"+17.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4852","2026-03-14","3.526","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2111","2026-03-16","7.603","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3147","2026-03-18","2.178","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","422","2026-02-22","7.386","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3260","2026-01-25","1.967","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":684},{"label":"Mar","value":819},{"label":"Abr","value":814},{"label":"Mai","value":540},{"label":"Jun","value":492},{"label":"Jul","value":470},{"label":"Ago","value":490},{"label":"Set","value":704},{"label":"Out","value":541},{"label":"Nov","value":636},{"label":"Dez","value":557}];
const MX = 819;
