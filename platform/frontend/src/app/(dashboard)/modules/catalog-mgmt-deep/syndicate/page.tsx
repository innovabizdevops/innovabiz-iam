...
const ACCENT = "#78350f";
const MODULE = "Catalog Management Deep";
const PAGE = "Syndicate";
const KPIS = [{"l":"Dashboards Ativos","v":"1.273","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"4864","t":"+12.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.268","t":"+4.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.444","t":"+10.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","558","2026-03-24","7.696","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","148","2026-03-04","7.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","124","2026-02-25","494","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2583","2026-01-10","2.484","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4585","2026-03-07","3.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":559},{"label":"Mar","value":706},{"label":"Abr","value":531},{"label":"Mai","value":845},{"label":"Jun","value":459},{"label":"Jul","value":667},{"label":"Ago","value":498},{"label":"Set","value":506},{"label":"Out","value":621},{"label":"Nov","value":607},{"label":"Dez","value":698}];
const MX = 845;
