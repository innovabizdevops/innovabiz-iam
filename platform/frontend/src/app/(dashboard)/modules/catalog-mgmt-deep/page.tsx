...
/* ═══ Catalog Management Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "2107", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3184", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€51K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1470894507", cells: ["CAT-7507", "Catalog Management Deep Item 1", "20/4/2026", "€44 607"], status: "active" as const },
    { id: "1470898078", cells: ["CAT-2078", "Catalog Management Deep Item 2", "7/11/2026", "€48 178"], status: "pending" as const },
    { id: "1470901649", cells: ["CAT-5649", "Catalog Management Deep Item 3", "22/6/2026", "€1749"], status: "completed" as const },
    { id: "1470905220", cells: ["CAT-9220", "Catalog Management Deep Item 4", "9/1/2026", "€5320"], status: "warning" as const },
    { id: "1470908791", cells: ["CAT-3791", "Catalog Management Deep Item 5", "24/8/2026", "€8891"], status: "active" as const },
];
...
export default function CatalogManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catalog Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Catalog Management Deep</p>
                    </div>
                </div>
