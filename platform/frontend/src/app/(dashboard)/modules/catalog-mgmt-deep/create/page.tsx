...
const PAGE = "Create";
const KPIS = [{"l":"Dashboards Ativos","v":"4.944","t":"+12.3%","d":"up"},{"l":"Queries/Dia","v":"729","t":"+5.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.122","t":"+4.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.081","t":"+12.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4258","2026-01-23","4.363","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","412","2026-03-04","5.711","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2272","2026-03-15","4.605","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4332","2026-01-28","7.431","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2136","2026-02-04","3.145","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":728},{"label":"Mar","value":506},{"label":"Abr","value":468},{"label":"Mai","value":491},{"label":"Jun","value":806},{"label":"Jul","value":552},{"label":"Ago","value":499},{"label":"Set","value":557},{"label":"Out","value":598},{"label":"Nov","value":546},{"label":"Dez","value":632}];
const MX = 806;
