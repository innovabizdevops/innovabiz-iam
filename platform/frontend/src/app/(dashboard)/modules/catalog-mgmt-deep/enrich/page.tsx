...
const PAGE = "Enrich";
const KPIS = [{"l":"Dashboards Ativos","v":"6.577","t":"-3.1%","d":"down"},{"l":"Queries/Dia","v":"4226","t":"+0.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.551","t":"+10.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.428","t":"-5.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4581","2026-01-02","3.132","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4210","2026-01-20","819","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2130","2026-03-24","3.812","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3273","2026-01-22","6.543","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","542","2026-01-24","3.972","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":463},{"label":"Mar","value":332},{"label":"Abr","value":285},{"label":"Mai","value":426},{"label":"Jun","value":297},{"label":"Jul","value":447},{"label":"Ago","value":509},{"label":"Set","value":382},{"label":"Out","value":587},{"label":"Nov","value":605},{"label":"Dez","value":225}];
const MX = 605;
