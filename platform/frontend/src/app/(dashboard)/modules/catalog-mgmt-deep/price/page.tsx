...
const PAGE = "Price";
const KPIS = [{"l":"Dashboards Ativos","v":"811","t":"+10.8%","d":"up"},{"l":"Queries/Dia","v":"477","t":"+3.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.957","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"851","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1450","2026-03-24","6.380","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4378","2026-02-08","7.144","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4855","2026-03-19","7.799","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4697","2026-01-19","8.436","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2242","2026-03-24","7.924","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":453},{"label":"Mar","value":421},{"label":"Abr","value":388},{"label":"Mai","value":588},{"label":"Jun","value":502},{"label":"Jul","value":582},{"label":"Ago","value":532},{"label":"Set","value":325},{"label":"Out","value":328},{"label":"Nov","value":565},{"label":"Dez","value":611}];
const MX = 611;
