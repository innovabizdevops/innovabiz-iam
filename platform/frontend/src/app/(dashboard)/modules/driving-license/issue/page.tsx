...
const PAGE = "Issue";
const KPIS = [{"l":"Total Driving License","v":"2.628","t":"-4.6%","d":"down"},{"l":"Issue Ativos","v":"8.401","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"94.8%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"72","t":"+18.0%","d":"up"}];
const COLS = ["ID","Issue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Driving License #001","Driving License #002","157","4.913","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Driving License #002","Driving License #003","4.559","6.928","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Driving License #003","Driving License #004","4.965","600","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Driving License #004","Driving License #005","6.370","4.530","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Driving License #005","Driving License #001","195","1.234","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":461},{"label":"Mar","value":643},{"label":"Abr","value":525},{"label":"Mai","value":456},{"label":"Jun","value":702},{"label":"Jul","value":707},{"label":"Ago","value":532},{"label":"Set","value":528},{"label":"Out","value":700},{"label":"Nov","value":433},{"label":"Dez","value":573}];
const MX = 752;
