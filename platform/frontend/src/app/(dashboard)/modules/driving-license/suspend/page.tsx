...
const ACCENT = "#0369a1";
const MODULE = "Driving License";
const PAGE = "Suspend";
const KPIS = [{"l":"Total Driving License","v":"1.283","t":"+14.2%","d":"up"},{"l":"Suspend Ativos","v":"5.589","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"84","t":"-2.5%","d":"down"}];
const COLS = ["ID","Suspend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Driving License #001","Driving License #002","4.235","2.640","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Driving License #002","Driving License #003","1.456","8.630","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Driving License #003","Driving License #004","7.512","4.102","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Driving License #004","Driving License #005","3.166","540","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Driving License #005","Driving License #001","4.608","968","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":999},{"label":"Mar","value":860},{"label":"Abr","value":1026},{"label":"Mai","value":821},{"label":"Jun","value":703},{"label":"Jul","value":717},{"label":"Ago","value":719},{"label":"Set","value":634},{"label":"Out","value":936},{"label":"Nov","value":986},{"label":"Dez","value":722}];
const MX = 1026;
