...
const PAGE = "Terminal";
const KPIS = [{"l":"Riscos Identificados","v":"8.213","t":"+14.0%","d":"up"},{"l":"Mitigações Ativas","v":"281","t":"+15.4%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+17.9%","d":"up"},{"l":"Incidentes YTD","v":"4.275","t":"+2.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.094","581","4.449","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.973","6.109","1.893","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.298","5.954","2.933","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.853","7.252","5.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.045","4.584","4.046","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":785},{"label":"Mar","value":650},{"label":"Abr","value":739},{"label":"Mai","value":920},{"label":"Jun","value":555},{"label":"Jul","value":859},{"label":"Ago","value":708},{"label":"Set","value":792},{"label":"Out","value":805},{"label":"Nov","value":652},{"label":"Dez","value":800}];
const MX = 920;
