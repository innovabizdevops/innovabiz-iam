...
export default function SatelliteBroadbandPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Satellite Broadband</h1><p className="text-sm text-muted-foreground">Satellite Broadband • iBOS Enterprise</p></div>
