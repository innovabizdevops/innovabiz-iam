...
export default function JournalPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Journal Platform</h1><p className="text-sm text-muted-foreground">Journal Platform • iBOS Enterprise</p></div>
