...
const PAGE = "Open Access";
const KPIS = [{"l":"Formulários Ativos","v":"5.998","t":"-5.5%","d":"down"},{"l":"Submissões/Dia","v":"1073","t":"-0.3%","d":"down"},{"l":"Documentos Gerados","v":"8.785","t":"+13.9%","d":"up"},{"l":"Templates","v":"910","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.589","2026-03-02","4.127","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","348","2026-01-28","5.337","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.336","2026-02-05","4.974","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.012","2026-02-04","1.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.563","2026-02-26","1.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":662},{"label":"Mar","value":506},{"label":"Abr","value":564},{"label":"Mai","value":446},{"label":"Jun","value":625},{"label":"Jul","value":739},{"label":"Ago","value":453},{"label":"Set","value":524},{"label":"Out","value":560},{"label":"Nov","value":648},{"label":"Dez","value":681}];
const MX = 739;
