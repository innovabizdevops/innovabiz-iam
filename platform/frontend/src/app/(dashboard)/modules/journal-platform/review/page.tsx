...
const PAGE = "Peer Review";
const KPIS = [{"l":"Formulários Ativos","v":"7.747","t":"-2.1%","d":"down"},{"l":"Submissões/Dia","v":"1702","t":"+10.7%","d":"up"},{"l":"Documentos Gerados","v":"5.523","t":"+9.1%","d":"up"},{"l":"Templates","v":"5.278","t":"+13.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.261","2026-01-26","8.103","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","577","2026-01-16","7.902","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.336","2026-02-02","3.063","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.019","2026-02-19","1.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.173","2026-01-18","8.287","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":877},{"label":"Mar","value":600},{"label":"Abr","value":761},{"label":"Mai","value":817},{"label":"Jun","value":806},{"label":"Jul","value":594},{"label":"Ago","value":611},{"label":"Set","value":867},{"label":"Out","value":837},{"label":"Nov","value":892},{"label":"Dez","value":748}];
const MX = 892;
