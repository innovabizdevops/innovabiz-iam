...
const KPIS = [{"l":"Formulários Ativos","v":"4.552","t":"-4.8%","d":"down"},{"l":"Submissões/Dia","v":"2923","t":"+4.9%","d":"up"},{"l":"Documentos Gerados","v":"6.596","t":"+4.1%","d":"up"},{"l":"Templates","v":"5.540","t":"+12.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.901","2026-01-16","4.230","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.016","2026-01-17","6.429","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.188","2026-03-05","2.692","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.291","2026-01-05","6.208","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.773","2026-03-27","7.604","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":741},{"label":"Mar","value":697},{"label":"Abr","value":724},{"label":"Mai","value":759},{"label":"Jun","value":960},{"label":"Jul","value":693},{"label":"Ago","value":862},{"label":"Set","value":832},{"label":"Out","value":830},{"label":"Nov","value":676},{"label":"Dez","value":808}];
const MX = 960;
