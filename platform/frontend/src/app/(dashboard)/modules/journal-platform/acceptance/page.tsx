...
const KPIS = [{"l":"Formulários Ativos","v":"7.502","t":"+7.4%","d":"up"},{"l":"Submissões/Dia","v":"2836","t":"+15.5%","d":"up"},{"l":"Documentos Gerados","v":"7.507","t":"+10.1%","d":"up"},{"l":"Templates","v":"7.388","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","887","2026-02-06","8.393","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.771","2026-02-23","7.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.541","2026-02-09","1.201","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","792","2026-01-21","7.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.612","2026-02-17","4.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":301},{"label":"Fev","value":386},{"label":"Mar","value":452},{"label":"Abr","value":399},{"label":"Mai","value":592},{"label":"Jun","value":438},{"label":"Jul","value":336},{"label":"Ago","value":617},{"label":"Set","value":627},{"label":"Out","value":260},{"label":"Nov","value":362},{"label":"Dez","value":283}];
const MX = 627;
