...
const ACCENT = "#1e40af";
const MODULE = "Journal Platform";
const PAGE = "DOI Register";
const KPIS = [{"l":"Formulários Ativos","v":"4.952","t":"-0.4%","d":"down"},{"l":"Submissões/Dia","v":"5065","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"7.967","t":"+0.2%","d":"up"},{"l":"Templates","v":"2.806","t":"+1.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.958","2026-01-28","604","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.910","2026-01-28","2.948","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.910","2026-02-03","5.941","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.664","2026-02-25","3.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.431","2026-01-11","5.502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":324},{"label":"Fev","value":689},{"label":"Mar","value":509},{"label":"Abr","value":328},{"label":"Mai","value":365},{"label":"Jun","value":521},{"label":"Jul","value":484},{"label":"Ago","value":667},{"label":"Set","value":563},{"label":"Out","value":468},{"label":"Nov","value":598},{"label":"Dez","value":528}];
const MX = 689;
