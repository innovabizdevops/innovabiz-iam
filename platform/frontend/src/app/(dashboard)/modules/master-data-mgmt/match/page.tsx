...
const ACCENT = "#0070f3";
const MODULE = "Master Data Management";
const PAGE = "Match";
const KPIS = [{"l":"Dashboards Ativos","v":"5.046","t":"-0.6%","d":"down"},{"l":"Queries/Dia","v":"3787","t":"+0.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.386","t":"+14.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.147","t":"-4.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2828","2026-01-06","8.578","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2762","2026-01-05","2.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1346","2026-03-02","2.815","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4634","2026-01-27","5.512","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2670","2026-03-03","2.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":761},{"label":"Mar","value":851},{"label":"Abr","value":835},{"label":"Mai","value":723},{"label":"Jun","value":730},{"label":"Jul","value":779},{"label":"Ago","value":781},{"label":"Set","value":709},{"label":"Out","value":918},{"label":"Nov","value":835},{"label":"Dez","value":745}];
const MX = 918;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0070f3'}}>AI</span></h1>
                </div>
