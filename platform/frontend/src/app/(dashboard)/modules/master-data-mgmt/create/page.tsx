...
const PAGE = "Create";
const KPIS = [{"l":"Dashboards Ativos","v":"3.550","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"1933","t":"+7.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.342","t":"+11.5%","d":"up"},{"l":"Utilizadores Analytics","v":"7.583","t":"+0.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3215","2026-03-08","7.446","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2470","2026-02-17","1.786","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3756","2026-03-18","1.658","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3045","2026-02-25","5.955","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4133","2026-03-26","2.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":525},{"label":"Mar","value":695},{"label":"Abr","value":634},{"label":"Mai","value":395},{"label":"Jun","value":605},{"label":"Jul","value":416},{"label":"Ago","value":453},{"label":"Set","value":622},{"label":"Out","value":455},{"label":"Nov","value":663},{"label":"Dez","value":516}];
const MX = 695;
