...
const KPIS = [{"l":"Dashboards Ativos","v":"4.619","t":"+-0.0%","d":"up"},{"l":"Queries/Dia","v":"2973","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"5.967","t":"+16.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.817","t":"+3.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","572","2026-02-22","1.635","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4539","2026-01-05","7.067","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2206","2026-02-13","7.410","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","408","2026-02-28","3.467","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1576","2026-02-15","1.560","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":445},{"label":"Mar","value":572},{"label":"Abr","value":466},{"label":"Mai","value":318},{"label":"Jun","value":695},{"label":"Jul","value":525},{"label":"Ago","value":495},{"label":"Set","value":688},{"label":"Out","value":533},{"label":"Nov","value":417},{"label":"Dez","value":403}];
const MX = 695;
