...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"8.436","t":"+6.8%","d":"up"},{"l":"Queries/Dia","v":"2808","t":"+17.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.099","t":"-3.9%","d":"down"},{"l":"Utilizadores Analytics","v":"1.597","t":"+8.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","304","2026-01-04","7.929","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3668","2026-02-14","169","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1740","2026-01-01","3.614","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3805","2026-01-06","9.019","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1644","2026-01-04","124","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":854},{"label":"Mar","value":869},{"label":"Abr","value":964},{"label":"Mai","value":864},{"label":"Jun","value":870},{"label":"Jul","value":650},{"label":"Ago","value":850},{"label":"Set","value":726},{"label":"Out","value":613},{"label":"Nov","value":656},{"label":"Dez","value":783}];
const MX = 964;
