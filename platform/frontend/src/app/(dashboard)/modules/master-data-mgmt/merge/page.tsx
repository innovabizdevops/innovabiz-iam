...
const PAGE = "Merge";
const KPIS = [{"l":"Dashboards Ativos","v":"6.391","t":"+4.9%","d":"up"},{"l":"Queries/Dia","v":"4050","t":"+13.0%","d":"up"},{"l":"Dados Processados (GB)","v":"547","t":"-5.2%","d":"down"},{"l":"Utilizadores Analytics","v":"639","t":"+15.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","694","2026-01-06","3.520","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3582","2026-01-04","5.038","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2256","2026-03-04","6.699","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","755","2026-02-21","9.020","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2524","2026-01-11","3.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":545},{"label":"Mar","value":600},{"label":"Abr","value":462},{"label":"Mai","value":698},{"label":"Jun","value":707},{"label":"Jul","value":551},{"label":"Ago","value":679},{"label":"Set","value":578},{"label":"Out","value":647},{"label":"Nov","value":468},{"label":"Dez","value":474}];
const MX = 707;
