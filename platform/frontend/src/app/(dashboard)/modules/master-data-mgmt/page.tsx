...
const KPIS = [
    { label: "Total Registos", value: "172", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1183", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€283K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "968239872", cells: ["MAS-2872", "Master Data Management Item 1", "13/1/2026", "€39 972"], status: "active" as const },
    { id: "968243443", cells: ["MAS-6443", "Master Data Management Item 2", "28/8/2026", "€43 543"], status: "pending" as const },
    { id: "968247014", cells: ["MAS-1014", "Master Data Management Item 3", "15/3/2026", "€47 114"], status: "completed" as const },
    { id: "968250585", cells: ["MAS-4585", "Master Data Management Item 4", "2/10/2026", "€685"], status: "warning" as const },
    { id: "968254156", cells: ["MAS-8156", "Master Data Management Item 5", "17/5/2026", "€4256"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Master Data Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Master Data Management</p>
                    </div>
                </div>
