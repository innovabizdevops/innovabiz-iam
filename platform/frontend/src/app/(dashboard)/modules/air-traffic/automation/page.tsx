...
const ACCENT = "#6366f1";
const MODULE = "Air Traffic Mgmt";
const PAGE = "Automation";
const KPIS = [{"l":"Total Air Traffic","v":"8.538","t":"+14.3%","d":"up"},{"l":"Automation Ativos","v":"8.744","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.8%","d":"up"}];
const COLS = ["ID","Automation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Traffic #001","Air Traffic #002","3.631","6.656","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Air Traffic #002","Air Traffic #003","4.447","7.435","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Traffic #003","Air Traffic #004","7.796","3.758","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Air Traffic #004","Air Traffic #005","977","7.846","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Traffic #005","Air Traffic #001","7.833","4.809","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":798},{"label":"Mar","value":649},{"label":"Abr","value":540},{"label":"Mai","value":688},{"label":"Jun","value":709},{"label":"Jul","value":719},{"label":"Ago","value":545},{"label":"Set","value":549},{"label":"Out","value":697},{"label":"Nov","value":654},{"label":"Dez","value":669}];
const MX = 798;
