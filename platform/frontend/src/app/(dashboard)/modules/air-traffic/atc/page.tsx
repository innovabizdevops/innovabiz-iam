...
const PAGE = "ATC";
const KPIS = [{"l":"Total Air Traffic","v":"6.028","t":"-4.7%","d":"down"},{"l":"ATC Ativos","v":"3.620","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"76","t":"+13.6%","d":"up"}];
const COLS = ["ID","ATC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Traffic #001","Air Traffic #002","7.673","5.890","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Air Traffic #002","Air Traffic #003","512","1.964","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Traffic #003","Air Traffic #004","7.639","1.465","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Air Traffic #004","Air Traffic #005","4.861","7.921","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Traffic #005","Air Traffic #001","7.699","4.434","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":574},{"label":"Mar","value":668},{"label":"Abr","value":439},{"label":"Mai","value":308},{"label":"Jun","value":662},{"label":"Jul","value":331},{"label":"Ago","value":490},{"label":"Set","value":561},{"label":"Out","value":589},{"label":"Nov","value":422},{"label":"Dez","value":627}];
const MX = 668;
