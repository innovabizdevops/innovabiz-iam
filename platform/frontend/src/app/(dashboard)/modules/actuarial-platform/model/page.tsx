...
const ACCENT = "#92400e";
const MODULE = "Actuarial Platform Deep";
const PAGE = "Model";
const KPIS = [{"l":"Formulários Ativos","v":"8.289","t":"+0.6%","d":"up"},{"l":"Submissões/Dia","v":"2973","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"9.059","t":"-2.4%","d":"down"},{"l":"Templates","v":"3.858","t":"-0.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","290","2026-02-27","7.954","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.962","2026-01-06","3.971","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.382","2026-01-17","8.371","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.836","2026-01-13","1.451","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.791","2026-03-20","8.290","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":638},{"label":"Mar","value":845},{"label":"Abr","value":605},{"label":"Mai","value":770},{"label":"Jun","value":841},{"label":"Jul","value":842},{"label":"Ago","value":852},{"label":"Set","value":658},{"label":"Out","value":830},{"label":"Nov","value":915},{"label":"Dez","value":675}];
const MX = 919;
