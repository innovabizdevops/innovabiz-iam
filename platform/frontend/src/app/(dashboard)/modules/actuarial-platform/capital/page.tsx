...
const PAGE = "Capital";
const KPIS = [{"l":"Formulários Ativos","v":"8.107","t":"+11.4%","d":"up"},{"l":"Submissões/Dia","v":"2374","t":"+6.8%","d":"up"},{"l":"Documentos Gerados","v":"3.107","t":"+8.0%","d":"up"},{"l":"Templates","v":"8.861","t":"+10.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.504","2026-03-21","422","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.831","2026-01-10","3.770","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","446","2026-01-06","3.889","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.571","2026-01-28","5.607","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.688","2026-03-26","1.361","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":522},{"label":"Mar","value":559},{"label":"Abr","value":396},{"label":"Mai","value":558},{"label":"Jun","value":225},{"label":"Jul","value":405},{"label":"Ago","value":432},{"label":"Set","value":501},{"label":"Out","value":266},{"label":"Nov","value":519},{"label":"Dez","value":325}];
const MX = 559;
