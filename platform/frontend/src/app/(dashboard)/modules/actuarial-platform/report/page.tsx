...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"3.277","t":"+9.8%","d":"up"},{"l":"Submissões/Dia","v":"532","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"7.599","t":"+14.4%","d":"up"},{"l":"Templates","v":"2.415","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.793","2026-02-22","8.707","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.668","2026-02-06","7.727","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.182","2026-03-20","751","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.765","2026-03-02","6.375","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.978","2026-03-10","5.556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":643},{"label":"Mar","value":788},{"label":"Abr","value":930},{"label":"Mai","value":845},{"label":"Jun","value":876},{"label":"Jul","value":886},{"label":"Ago","value":793},{"label":"Set","value":1016},{"label":"Out","value":654},{"label":"Nov","value":831},{"label":"Dez","value":958}];
const MX = 1016;
