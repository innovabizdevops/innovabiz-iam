...
const PAGE = "Price";
const KPIS = [{"l":"Formulários Ativos","v":"6.359","t":"+10.4%","d":"up"},{"l":"Submissões/Dia","v":"3645","t":"+2.6%","d":"up"},{"l":"Documentos Gerados","v":"1.605","t":"+17.2%","d":"up"},{"l":"Templates","v":"7.238","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.399","2026-03-10","3.386","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.461","2026-02-18","8.062","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.235","2026-02-22","6.309","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.882","2026-01-06","6.498","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.292","2026-01-15","6.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":650},{"label":"Mar","value":642},{"label":"Abr","value":626},{"label":"Mai","value":759},{"label":"Jun","value":776},{"label":"Jul","value":838},{"label":"Ago","value":815},{"label":"Set","value":697},{"label":"Out","value":524},{"label":"Nov","value":846},{"label":"Dez","value":742}];
const MX = 846;
