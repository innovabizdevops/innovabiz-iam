...
const PAGE = "Reserve";
const KPIS = [{"l":"Formulários Ativos","v":"7.879","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"3511","t":"+11.2%","d":"up"},{"l":"Documentos Gerados","v":"1.231","t":"+5.8%","d":"up"},{"l":"Templates","v":"5.746","t":"-5.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.507","2026-02-07","6.795","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.371","2026-01-25","3.742","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.873","2026-01-10","6.631","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.337","2026-03-14","8.465","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.792","2026-02-24","7.238","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":511},{"label":"Mar","value":472},{"label":"Abr","value":357},{"label":"Mai","value":538},{"label":"Jun","value":527},{"label":"Jul","value":551},{"label":"Ago","value":499},{"label":"Set","value":291},{"label":"Out","value":348},{"label":"Nov","value":369},{"label":"Dez","value":584}];
const MX = 584;
