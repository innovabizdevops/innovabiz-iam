...
/* ═══ Actuarial Platform Deep — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "2601", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3099", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€121K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1618127801", cells: ["ACT-9801", "Actuarial Platform Deep Item 1", "18/6/2026", "€27 901"], status: "active" as const },
    { id: "1618131372", cells: ["ACT-4372", "Actuarial Platform Deep Item 2", "5/1/2026", "€31 472"], status: "pending" as const },
    { id: "1618134943", cells: ["ACT-7943", "Actuarial Platform Deep Item 3", "20/8/2026", "€35 043"], status: "completed" as const },
    { id: "1618138514", cells: ["ACT-2514", "Actuarial Platform Deep Item 4", "7/3/2026", "€38 614"], status: "warning" as const },
    { id: "1618142085", cells: ["ACT-6085", "Actuarial Platform Deep Item 5", "22/10/2026", "€42 185"], status: "active" as const },
];
...
export default function ActuarialPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Actuarial Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Actuarial Platform Deep</p>
                    </div>
                </div>
