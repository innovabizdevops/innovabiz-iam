...
const PAGE = "Impacto";
const KPIS = [{"l":"Projetos Sociais","v":"8.346","t":"+16.5%","d":"up"},{"l":"Beneficiários","v":"4.351","t":"+13.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€10805","t":"+6.4%","d":"up"},{"l":"Score Impacto","v":"92","t":"+16.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.157","€ 4598.20","4.394","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.008","€ 27084.78","5.971","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","239","€ 25778.52","1.587","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.601","€ 12735.85","4.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","145","€ 21686.17","8.286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":738},{"label":"Mar","value":839},{"label":"Abr","value":985},{"label":"Mai","value":781},{"label":"Jun","value":896},{"label":"Jul","value":744},{"label":"Ago","value":968},{"label":"Set","value":708},{"label":"Out","value":890},{"label":"Nov","value":860},{"label":"Dez","value":992}];
const MX = 992;
