...
const PAGE = "Financiamento";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.572","t":"+12.0%","d":"up"},{"l":"Sessões/Dia","v":"4594","t":"+11.0%","d":"up"},{"l":"MFA Adoção (%)","v":"72.3%","t":"+14.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.074","t":"+0.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","288","6.085","2.178","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.121","543","8.039","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.236","7.844","4.902","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.354","3.223","4.315","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.177","6.966","6.295","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":566},{"label":"Mar","value":485},{"label":"Abr","value":451},{"label":"Mai","value":478},{"label":"Jun","value":482},{"label":"Jul","value":765},{"label":"Ago","value":476},{"label":"Set","value":609},{"label":"Out","value":625},{"label":"Nov","value":390},{"label":"Dez","value":547}];
const MX = 765;
