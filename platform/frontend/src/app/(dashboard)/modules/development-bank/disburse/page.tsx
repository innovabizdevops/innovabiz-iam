...
const ACCENT = "#6366f1";
const MODULE = "Banco Desenvolvimento";
const PAGE = "Desembolso";
const KPIS = [{"l":"Total Development Bank","v":"2.487","t":"+16.8%","d":"up"},{"l":"Desembolso Ativos","v":"2.580","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"79.8%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+12.1%","d":"up"}];
const COLS = ["ID","Desembolso","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Development Bank #001","Development Bank #002","3.972","5.379","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Development Bank #002","Development Bank #003","7.669","1.584","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Development Bank #003","Development Bank #004","8.140","8.652","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Development Bank #004","Development Bank #005","6.484","8.595","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Development Bank #005","Development Bank #001","4.344","6.240","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":560},{"label":"Mar","value":550},{"label":"Abr","value":543},{"label":"Mai","value":600},{"label":"Jun","value":546},{"label":"Jul","value":592},{"label":"Ago","value":633},{"label":"Set","value":479},{"label":"Out","value":647},{"label":"Nov","value":480},{"label":"Dez","value":630}];
const MX = 647;
