...
const KPIS = [{"l":"Formulários Ativos","v":"3.956","t":"+11.5%","d":"up"},{"l":"Submissões/Dia","v":"2863","t":"+10.3%","d":"up"},{"l":"Documentos Gerados","v":"1.780","t":"+8.4%","d":"up"},{"l":"Templates","v":"7.734","t":"+12.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.673","2026-03-09","2.142","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.981","2026-03-22","7.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","717","2026-01-20","5.722","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.607","2026-02-15","6.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.258","2026-01-19","2.244","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":446},{"label":"Mar","value":517},{"label":"Abr","value":634},{"label":"Mai","value":608},{"label":"Jun","value":567},{"label":"Jul","value":520},{"label":"Ago","value":692},{"label":"Set","value":424},{"label":"Out","value":628},{"label":"Nov","value":526},{"label":"Dez","value":694}];
const MX = 700;
