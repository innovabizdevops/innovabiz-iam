...
const ACCENT = "#312e81";
const MODULE = "Platform Command Center";
const PAGE = "Health";
const KPIS = [{"l":"Formulários Ativos","v":"1.381","t":"+16.7%","d":"up"},{"l":"Submissões/Dia","v":"3898","t":"+14.2%","d":"up"},{"l":"Documentos Gerados","v":"5.676","t":"+3.6%","d":"up"},{"l":"Templates","v":"876","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.272","2026-01-04","6.052","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.511","2026-03-03","4.713","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.473","2026-03-28","2.072","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.405","2026-01-27","8.166","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.142","2026-03-27","1.234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":586},{"label":"Mar","value":694},{"label":"Abr","value":637},{"label":"Mai","value":500},{"label":"Jun","value":418},{"label":"Jul","value":534},{"label":"Ago","value":497},{"label":"Set","value":428},{"label":"Out","value":664},{"label":"Nov","value":539},{"label":"Dez","value":648}];
const MX = 694;
