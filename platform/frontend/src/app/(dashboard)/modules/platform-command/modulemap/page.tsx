...
const PAGE = "Module Map";
const KPIS = [{"l":"Formulários Ativos","v":"6.707","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"636","t":"+9.0%","d":"up"},{"l":"Documentos Gerados","v":"728","t":"+10.9%","d":"up"},{"l":"Templates","v":"6.372","t":"+2.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.235","2026-01-11","4.185","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.507","2026-02-13","1.273","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.881","2026-03-02","3.891","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.814","2026-03-12","5.935","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.540","2026-03-14","8.638","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":802},{"label":"Mar","value":731},{"label":"Abr","value":897},{"label":"Mai","value":804},{"label":"Jun","value":997},{"label":"Jul","value":729},{"label":"Ago","value":987},{"label":"Set","value":699},{"label":"Out","value":1008},{"label":"Nov","value":830},{"label":"Dez","value":872}];
const MX = 1008;
