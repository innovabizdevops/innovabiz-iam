...
const KPIS = [
    { label: "Total Registos", value: "7428", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "777", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€355K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1919122328", cells: ["PLA-8328", "Platform Command Center Item 1", "5/9/2026", "€22 428"], status: "active" as const },
    { id: "1919125899", cells: ["PLA-2899", "Platform Command Center Item 2", "20/4/2026", "€25 999"], status: "pending" as const },
    { id: "1919129470", cells: ["PLA-6470", "Platform Command Center Item 3", "7/11/2026", "€29 570"], status: "completed" as const },
    { id: "1919133041", cells: ["PLA-1041", "Platform Command Center Item 4", "22/6/2026", "€33 141"], status: "warning" as const },
    { id: "1919136612", cells: ["PLA-4612", "Platform Command Center Item 5", "9/1/2026", "€36 712"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Command Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Command Center</p>
                    </div>
                </div>
