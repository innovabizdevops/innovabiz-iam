...
const PAGE = "Overview";
const KPIS = [{"l":"Formulários Ativos","v":"2.796","t":"-2.7%","d":"down"},{"l":"Submissões/Dia","v":"3118","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"2.466","t":"+8.0%","d":"up"},{"l":"Templates","v":"6.801","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.279","2026-03-06","6.241","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.136","2026-01-11","6.008","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.505","2026-02-23","804","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.632","2026-03-07","2.187","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.994","2026-02-15","6.158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":629},{"label":"Mar","value":540},{"label":"Abr","value":396},{"label":"Mai","value":484},{"label":"Jun","value":694},{"label":"Jul","value":510},{"label":"Ago","value":400},{"label":"Set","value":534},{"label":"Out","value":417},{"label":"Nov","value":379},{"label":"Dez","value":516}];
const MX = 694;
