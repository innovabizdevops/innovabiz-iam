...
const PAGE = "Deploy";
const KPIS = [{"l":"Formulários Ativos","v":"1.031","t":"-0.5%","d":"down"},{"l":"Submissões/Dia","v":"4014","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"2.038","t":"+2.0%","d":"up"},{"l":"Templates","v":"5.494","t":"-1.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.531","2026-03-14","1.741","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.094","2026-03-11","592","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","840","2026-03-19","6.069","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.098","2026-02-27","6.761","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.415","2026-03-12","2.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":496},{"label":"Mar","value":336},{"label":"Abr","value":328},{"label":"Mai","value":449},{"label":"Jun","value":357},{"label":"Jul","value":559},{"label":"Ago","value":546},{"label":"Set","value":404},{"label":"Out","value":580},{"label":"Nov","value":633},{"label":"Dez","value":355}];
const MX = 633;
