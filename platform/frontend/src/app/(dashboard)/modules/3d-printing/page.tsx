...
export default function P3dPrintingPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">3d Printing</h1><p className="text-sm text-muted-foreground">3d Printing • iBOS</p></div>
