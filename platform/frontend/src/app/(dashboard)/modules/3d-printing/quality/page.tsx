...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.880","t":"+13.8%","d":"up"},{"l":"NC Abertas","v":"8.961","t":"+11.3%","d":"up"},{"l":"Conformidade (%)","v":"80.2%","t":"+7.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.239","t":"+17.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.047","78.3%","1.457","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.406","85.1%","7.830","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.943","76.8%","4.892","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.447","86.9%","1.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.645","79.9%","227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":738},{"label":"Mar","value":826},{"label":"Abr","value":780},{"label":"Mai","value":635},{"label":"Jun","value":948},{"label":"Jul","value":1011},{"label":"Ago","value":1002},{"label":"Set","value":630},{"label":"Out","value":684},{"label":"Nov","value":791},{"label":"Dez","value":881}];
const MX = 1011;
