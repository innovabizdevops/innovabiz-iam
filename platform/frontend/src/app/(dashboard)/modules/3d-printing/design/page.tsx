...
const ACCENT = "#7c3aed";
const MODULE = "3D Printing Hub";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.274","t":"-4.9%","d":"down"},{"l":"Submissões/Dia","v":"1894","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"7.926","t":"+11.9%","d":"up"},{"l":"Templates","v":"1.177","t":"+4.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.925","2026-02-27","2.924","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.991","2026-02-14","3.640","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.045","2026-02-15","6.276","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.231","2026-03-02","7.858","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.830","2026-03-15","2.067","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":954},{"label":"Mar","value":948},{"label":"Abr","value":884},{"label":"Mai","value":1051},{"label":"Jun","value":694},{"label":"Jul","value":961},{"label":"Ago","value":1020},{"label":"Set","value":888},{"label":"Out","value":723},{"label":"Nov","value":1015},{"label":"Dez","value":905}];
const MX = 1051;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>3D</span></h1>
                </div>
