...
const PAGE = "Report";
const KPIS = [{"l":"ARR (€M)","v":"€16.8M","t":"+0.1%","d":"up"},{"l":"MRR (€)","v":"€33907","t":"+4.5%","d":"up"},{"l":"Churn (%)","v":"73.8%","t":"+8.1%","d":"up"},{"l":"ARPU (€)","v":"€28190","t":"+7.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26382.87","4.383","€ 19240.28","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4248.46","5.783","€ 9387.12","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 33126.18","2.974","€ 45582.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26912.47","7.419","€ 6183.57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 22763.70","3.462","€ 5417.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":729},{"label":"Mar","value":449},{"label":"Abr","value":551},{"label":"Mai","value":416},{"label":"Jun","value":618},{"label":"Jul","value":469},{"label":"Ago","value":676},{"label":"Set","value":515},{"label":"Out","value":442},{"label":"Nov","value":528},{"label":"Dez","value":366}];
const MX = 729;
