...
const PAGE = "Claim";
const KPIS = [{"l":"ARR (€M)","v":"€29.2M","t":"+12.1%","d":"up"},{"l":"MRR (€)","v":"€58498","t":"+13.9%","d":"up"},{"l":"Churn (%)","v":"90.6%","t":"+14.8%","d":"up"},{"l":"ARPU (€)","v":"€44109","t":"+1.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25162.18","3.632","€ 16867.03","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19537.61","7.431","€ 31770.42","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37534.35","1.339","€ 4310.90","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 19044.74","7.487","€ 25577.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 41837.71","7.863","€ 2352.50","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":795},{"label":"Mar","value":860},{"label":"Abr","value":686},{"label":"Mai","value":919},{"label":"Jun","value":700},{"label":"Jul","value":661},{"label":"Ago","value":712},{"label":"Set","value":614},{"label":"Out","value":903},{"label":"Nov","value":710},{"label":"Dez","value":820}];
const MX = 919;
