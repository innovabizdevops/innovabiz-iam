...
const PAGE = "Register";
const KPIS = [{"l":"ARR (€M)","v":"€49.2M","t":"-5.3%","d":"down"},{"l":"MRR (€)","v":"€82693","t":"+3.0%","d":"up"},{"l":"Churn (%)","v":"85.4%","t":"+16.4%","d":"up"},{"l":"ARPU (€)","v":"€42289","t":"+13.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 21733.89","2.210","€ 23088.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 35590.32","1.476","€ 13041.82","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4650.40","8.689","€ 20666.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49300.53","2.068","€ 41063.52","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11540.59","6.236","€ 12047.74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":372},{"label":"Mar","value":285},{"label":"Abr","value":488},{"label":"Mai","value":289},{"label":"Jun","value":466},{"label":"Jul","value":396},{"label":"Ago","value":523},{"label":"Set","value":560},{"label":"Out","value":377},{"label":"Nov","value":244},{"label":"Dez","value":524}];
const MX = 560;
