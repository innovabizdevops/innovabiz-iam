...
const PAGE = "Product";
const KPIS = [{"l":"ARR (€M)","v":"€7.7M","t":"+11.8%","d":"up"},{"l":"MRR (€)","v":"€28894","t":"+5.3%","d":"up"},{"l":"Churn (%)","v":"91.8%","t":"+5.3%","d":"up"},{"l":"ARPU (€)","v":"€39095","t":"+11.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 47843.67","1.262","€ 22447.30","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 27037.25","2.253","€ 39201.80","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 5370.07","3.633","€ 14949.53","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43830.35","7.251","€ 22814.22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 36257.52","6.800","€ 9969.18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":328},{"label":"Mar","value":307},{"label":"Abr","value":453},{"label":"Mai","value":422},{"label":"Jun","value":612},{"label":"Jul","value":693},{"label":"Ago","value":375},{"label":"Set","value":534},{"label":"Out","value":437},{"label":"Nov","value":494},{"label":"Dez","value":345}];
const MX = 693;
