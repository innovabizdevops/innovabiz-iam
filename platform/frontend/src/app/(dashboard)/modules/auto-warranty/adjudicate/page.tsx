...
const ACCENT = "#1e3a5f";
const MODULE = "Auto Warranty Platform";
const PAGE = "Adjudicate";
const KPIS = [{"l":"ARR (€M)","v":"€10.9M","t":"+14.2%","d":"up"},{"l":"MRR (€)","v":"€60046","t":"+3.9%","d":"up"},{"l":"Churn (%)","v":"71.9%","t":"-5.1%","d":"down"},{"l":"ARPU (€)","v":"€68846","t":"-4.4%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13844.70","2.265","€ 47576.63","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 28325.95","5.510","€ 13092.34","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 5414.09","8.764","€ 29440.32","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42342.10","6.958","€ 21511.64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 48950.78","4.481","€ 1282.08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":592},{"label":"Mar","value":448},{"label":"Abr","value":244},{"label":"Mai","value":500},{"label":"Jun","value":406},{"label":"Jul","value":349},{"label":"Ago","value":411},{"label":"Set","value":484},{"label":"Out","value":515},{"label":"Nov","value":321},{"label":"Dez","value":519}];
const MX = 592;
