...
/* ═══ Auto Warranty Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8637", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4413", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1644339137", cells: ["AUT-4137", "Auto Warranty Platform Item 1", "22/6/2026", "€39 237"], status: "active" as const },
    { id: "1644342708", cells: ["AUT-7708", "Auto Warranty Platform Item 2", "9/1/2026", "€42 808"], status: "pending" as const },
    { id: "1644346279", cells: ["AUT-2279", "Auto Warranty Platform Item 3", "24/8/2026", "€46 379"], status: "completed" as const },
    { id: "1644349850", cells: ["AUT-5850", "Auto Warranty Platform Item 4", "11/3/2026", "€49 950"], status: "warning" as const },
    { id: "1644353421", cells: ["AUT-9421", "Auto Warranty Platform Item 5", "26/10/2026", "€3521"], status: "active" as const },
];
...
export default function AutoWarrantyPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Warranty Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auto Warranty Platform</p>
                    </div>
                </div>
