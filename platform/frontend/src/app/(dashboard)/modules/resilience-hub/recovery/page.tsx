...
const KPIS = [{"l":"BCP Plans Ativos","v":"3.042","t":"+4.7%","d":"up"},{"l":"RTO Médio (h)","v":"74h","t":"+9.1%","d":"up"},{"l":"RPO Médio (h)","v":"65h","t":"+16.2%","d":"up"},{"l":"Testes DR (YTD)","v":"1.177","t":"-1.3%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","27h","107h","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","19h","56h","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","173h","164h","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","149h","208h","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","155h","67h","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":699},{"label":"Mar","value":665},{"label":"Abr","value":661},{"label":"Mai","value":405},{"label":"Jun","value":520},{"label":"Jul","value":599},{"label":"Ago","value":702},{"label":"Set","value":503},{"label":"Out","value":560},{"label":"Nov","value":545},{"label":"Dez","value":618}];
const MX = 702;
