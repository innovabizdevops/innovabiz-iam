...
const PAGE = "Detect";
const KPIS = [{"l":"Total Genai Vision","v":"7.652","t":"+0.5%","d":"up"},{"l":"Detect Ativos","v":"2.441","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"86","t":"-3.1%","d":"down"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Vision #001","Genai Vision #002","5.153","7.446","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Vision #002","Genai Vision #003","3.059","7.684","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Vision #003","Genai Vision #004","3.411","3.896","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Vision #004","Genai Vision #005","6.546","5.245","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Vision #005","Genai Vision #001","7.985","7.354","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":598},{"label":"Mar","value":742},{"label":"Abr","value":931},{"label":"Mai","value":736},{"label":"Jun","value":833},{"label":"Jul","value":906},{"label":"Ago","value":857},{"label":"Set","value":776},{"label":"Out","value":545},{"label":"Nov","value":894},{"label":"Dez","value":619}];
const MX = 931;
