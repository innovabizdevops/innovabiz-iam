...
/* ═══ GenAI Vision Pipeline — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "9472", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4335", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€224K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "205691772", cells: ["GEN-6772", "GenAI Vision Pipeline Item 1", "21/1/2026", "€41 872"], status: "active" as const },
    { id: "205695343", cells: ["GEN-1343", "GenAI Vision Pipeline Item 2", "8/8/2026", "€45 443"], status: "pending" as const },
    { id: "205698914", cells: ["GEN-4914", "GenAI Vision Pipeline Item 3", "23/3/2026", "€49 014"], status: "completed" as const },
    { id: "205702485", cells: ["GEN-8485", "GenAI Vision Pipeline Item 4", "10/10/2026", "€2585"], status: "warning" as const },
    { id: "205706056", cells: ["GEN-3056", "GenAI Vision Pipeline Item 5", "25/5/2026", "€6156"], status: "active" as const },
];
...
export default function GenaiVisionPipelinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Vision Pipeline</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Vision Pipeline</p>
                    </div>
                </div>
