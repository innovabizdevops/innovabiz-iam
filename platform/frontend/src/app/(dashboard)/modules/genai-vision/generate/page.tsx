...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Vision Pipeline";
const PAGE = "Generate";
const KPIS = [{"l":"Total Genai Vision","v":"8.839","t":"+10.4%","d":"up"},{"l":"Generate Ativos","v":"4.583","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+16.3%","d":"up"}];
const COLS = ["ID","Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Vision #001","Genai Vision #002","3.836","462","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Vision #002","Genai Vision #003","6.202","5.356","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Vision #003","Genai Vision #004","1.892","8.000","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Vision #004","Genai Vision #005","170","1.308","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Vision #005","Genai Vision #001","1.339","1.865","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":973},{"label":"Mar","value":876},{"label":"Abr","value":1025},{"label":"Mai","value":761},{"label":"Jun","value":838},{"label":"Jul","value":791},{"label":"Ago","value":841},{"label":"Set","value":751},{"label":"Out","value":725},{"label":"Nov","value":815},{"label":"Dez","value":1070}];
const MX = 1070;
