...
const PAGE = "Alert";
const KPIS = [{"l":"Dashboards Ativos","v":"7.063","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"1905","t":"-1.7%","d":"down"},{"l":"Dados Processados (GB)","v":"1.647","t":"-3.7%","d":"down"},{"l":"Utilizadores Analytics","v":"6.414","t":"-2.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3611","2026-03-19","2.918","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4926","2026-03-01","5.413","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","268","2026-01-26","4.596","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2352","2026-01-06","6.883","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4674","2026-02-14","8.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":617},{"label":"Mar","value":651},{"label":"Abr","value":640},{"label":"Mai","value":546},{"label":"Jun","value":608},{"label":"Jul","value":426},{"label":"Ago","value":584},{"label":"Set","value":559},{"label":"Out","value":531},{"label":"Nov","value":582},{"label":"Dez","value":767}];
const MX = 767;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>RTM</span></h1>
                </div>
