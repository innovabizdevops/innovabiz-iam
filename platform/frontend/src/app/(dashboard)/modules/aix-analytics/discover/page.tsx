...
const ACCENT = "#4f46e5";
const MODULE = "AIX Analytics Intelligence";
const PAGE = "Auto Discover";
const KPIS = [{"l":"Dashboards Ativos","v":"5.296","t":"+0.2%","d":"up"},{"l":"Queries/Dia","v":"2331","t":"+2.8%","d":"up"},{"l":"Dados Processados (GB)","v":"2.233","t":"-3.5%","d":"down"},{"l":"Utilizadores Analytics","v":"8.599","t":"-0.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1460","2026-01-21","8.431","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1033","2026-02-25","8.747","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","799","2026-02-01","6.702","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2004","2026-02-16","5.972","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2923","2026-01-15","2.017","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":481},{"label":"Mar","value":318},{"label":"Abr","value":422},{"label":"Mai","value":599},{"label":"Jun","value":355},{"label":"Jul","value":618},{"label":"Ago","value":621},{"label":"Set","value":326},{"label":"Out","value":378},{"label":"Nov","value":680},{"label":"Dez","value":430}];
const MX = 680;
