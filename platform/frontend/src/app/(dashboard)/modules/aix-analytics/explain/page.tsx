...
const PAGE = "Explain";
const KPIS = [{"l":"Dashboards Ativos","v":"7.028","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"397","t":"+9.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.369","t":"+1.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.965","t":"+2.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1451","2026-03-14","4.120","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3242","2026-01-14","6.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1315","2026-03-25","4.538","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3263","2026-03-02","991","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2522","2026-01-08","319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":368},{"label":"Mar","value":542},{"label":"Abr","value":633},{"label":"Mai","value":510},{"label":"Jun","value":592},{"label":"Jul","value":523},{"label":"Ago","value":481},{"label":"Set","value":464},{"label":"Out","value":463},{"label":"Nov","value":554},{"label":"Dez","value":273}];
const MX = 633;
