...
const PAGE = "Action";
const KPIS = [{"l":"Dashboards Ativos","v":"8.083","t":"+4.0%","d":"up"},{"l":"Queries/Dia","v":"461","t":"+17.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.164","t":"-4.9%","d":"down"},{"l":"Utilizadores Analytics","v":"3.862","t":"+8.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4007","2026-03-28","6.585","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4886","2026-03-09","7.868","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1529","2026-03-02","9.066","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3990","2026-01-15","916","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","298","2026-03-17","3.073","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":484},{"label":"Mar","value":720},{"label":"Abr","value":527},{"label":"Mai","value":766},{"label":"Jun","value":802},{"label":"Jul","value":580},{"label":"Ago","value":841},{"label":"Set","value":496},{"label":"Out","value":563},{"label":"Nov","value":618},{"label":"Dez","value":640}];
const MX = 841;
