...
/* ═══ AIX Analytics Intelligence — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "8760", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2575", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€431K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1305036560", cells: ["AIX-1560", "AIX Analytics Intelligence Item 1", "17/9/2026", "€36 660"], status: "active" as const },
    { id: "1305040131", cells: ["AIX-5131", "AIX Analytics Intelligence Item 2", "4/4/2026", "€40 231"], status: "pending" as const },
    { id: "1305043702", cells: ["AIX-8702", "AIX Analytics Intelligence Item 3", "19/11/2026", "€43 802"], status: "completed" as const },
    { id: "1305047273", cells: ["AIX-3273", "AIX Analytics Intelligence Item 4", "6/6/2026", "€47 373"], status: "warning" as const },
    { id: "1305050844", cells: ["AIX-6844", "AIX Analytics Intelligence Item 5", "21/1/2026", "€944"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 20 }, { label: "Fev", value: 29 }, { label: "Mar", value: 38 }, { label: "Abr", value: 47 }, { label: "Mai", value: 56 }, { label: "Jun", value: 65 }];
...
export default function AixAnalyticsIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AIX Analytics Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AIX Analytics Intelligence</p>
                    </div>
                </div>
