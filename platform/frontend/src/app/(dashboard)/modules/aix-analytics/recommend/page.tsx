...
const KPIS = [{"l":"Dashboards Ativos","v":"3.574","t":"+6.5%","d":"up"},{"l":"Queries/Dia","v":"2955","t":"-3.4%","d":"down"},{"l":"Dados Processados (GB)","v":"8.531","t":"+12.8%","d":"up"},{"l":"Utilizadores Analytics","v":"2.006","t":"+4.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2251","2026-02-01","6.446","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3360","2026-01-15","2.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3267","2026-01-06","594","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3044","2026-02-24","6.432","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1406","2026-03-02","747","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":682},{"label":"Mar","value":677},{"label":"Abr","value":639},{"label":"Mai","value":632},{"label":"Jun","value":564},{"label":"Jul","value":509},{"label":"Ago","value":817},{"label":"Set","value":666},{"label":"Out","value":802},{"label":"Nov","value":548},{"label":"Dez","value":608}];
const MX = 817;
