...
const PAGE = "Compliance OFSTED";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.793","t":"+10.3%","d":"up"},{"l":"NC Abertas","v":"5.749","t":"+15.8%","d":"up"},{"l":"Conformidade (%)","v":"76.4%","t":"+8.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.154","t":"+7.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.492","79.5%","6.683","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.201","94.9%","7.178","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.065","95.2%","8.269","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.067","76.9%","8.751","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.783","91.1%","8.203","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":532},{"label":"Mar","value":719},{"label":"Abr","value":602},{"label":"Mai","value":722},{"label":"Jun","value":602},{"label":"Jul","value":408},{"label":"Ago","value":393},{"label":"Set","value":431},{"label":"Out","value":509},{"label":"Nov","value":704},{"label":"Dez","value":590}];
const MX = 722;
