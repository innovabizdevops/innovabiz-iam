...
const PAGE = "Daily Reports";
const KPIS = [{"l":"Total Childcare","v":"8.226","t":"+8.1%","d":"up"},{"l":"Daily Reports Ativos","v":"1.718","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"56","t":"-0.7%","d":"down"}];
const COLS = ["ID","Daily Reports","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Childcare #001","Childcare #002","5.794","780","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Childcare #002","Childcare #003","1.247","3.919","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Childcare #003","Childcare #004","409","5.890","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Childcare #004","Childcare #005","4.445","6.791","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Childcare #005","Childcare #001","753","3.332","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":454},{"label":"Mar","value":544},{"label":"Abr","value":360},{"label":"Mai","value":627},{"label":"Jun","value":299},{"label":"Jul","value":679},{"label":"Ago","value":514},{"label":"Set","value":423},{"label":"Out","value":535},{"label":"Nov","value":500},{"label":"Dez","value":480}];
const MX = 679;
