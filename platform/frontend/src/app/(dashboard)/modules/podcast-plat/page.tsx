...
export default function PodcastPlatPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Podcast Plat</h1><p className="text-sm text-muted-foreground">Podcast Plat • iBOS Enterprise</p></div>
