...
const KPIS = [{"l":"Dashboards Ativos","v":"1.125","t":"+16.6%","d":"up"},{"l":"Queries/Dia","v":"3242","t":"-6.0%","d":"down"},{"l":"Dados Processados (GB)","v":"4.396","t":"-5.0%","d":"down"},{"l":"Utilizadores Analytics","v":"5.884","t":"+15.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1291","2026-01-04","646","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4838","2026-03-02","5.209","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4253","2026-03-16","3.493","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2243","2026-03-25","3.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3151","2026-01-05","5.924","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":717},{"label":"Mar","value":628},{"label":"Abr","value":561},{"label":"Mai","value":441},{"label":"Jun","value":498},{"label":"Jul","value":638},{"label":"Ago","value":661},{"label":"Set","value":562},{"label":"Out","value":602},{"label":"Nov","value":653},{"label":"Dez","value":664}];
const MX = 717;
