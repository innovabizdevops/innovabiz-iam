...
const KPIS = [{"l":"ARR (€M)","v":"€12.5M","t":"+4.5%","d":"up"},{"l":"MRR (€)","v":"€3253","t":"+15.8%","d":"up"},{"l":"Churn (%)","v":"69.9%","t":"+0.8%","d":"up"},{"l":"ARPU (€)","v":"€71853","t":"+15.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 35657.82","3.673","€ 26315.67","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 910.07","6.828","€ 16989.14","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26642.33","1.975","€ 20631.27","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 14621.28","7.809","€ 48292.71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23188.84","8.219","€ 1741.13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":581},{"label":"Mar","value":527},{"label":"Abr","value":403},{"label":"Mai","value":386},{"label":"Jun","value":558},{"label":"Jul","value":562},{"label":"Ago","value":436},{"label":"Set","value":256},{"label":"Out","value":423},{"label":"Nov","value":253},{"label":"Dez","value":494}];
const MX = 581;
