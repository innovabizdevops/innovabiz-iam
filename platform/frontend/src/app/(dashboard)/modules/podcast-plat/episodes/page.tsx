...
const PAGE = "Episode Mgmt";
const KPIS = [{"l":"Auditorias Realizadas","v":"119","t":"+13.6%","d":"up"},{"l":"NC Abertas","v":"8.159","t":"+11.6%","d":"up"},{"l":"Conformidade (%)","v":"73.1%","t":"+15.9%","d":"up"},{"l":"CAPAs Pendentes","v":"443","t":"-4.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.120","89.3%","3.738","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.095","79.4%","5.232","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.920","85.2%","4.118","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.302","92.6%","9.093","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.051","70.9%","2.251","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":489},{"label":"Mar","value":424},{"label":"Abr","value":595},{"label":"Mai","value":436},{"label":"Jun","value":600},{"label":"Jul","value":548},{"label":"Ago","value":628},{"label":"Set","value":495},{"label":"Out","value":479},{"label":"Nov","value":480},{"label":"Dez","value":350}];
const MX = 628;
