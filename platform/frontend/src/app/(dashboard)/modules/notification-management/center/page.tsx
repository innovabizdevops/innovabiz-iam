...
const PAGE = "Center";
const KPIS = [{"l":"Notificações Enviadas","v":"5.548","t":"+0.9%","d":"up"},{"l":"Taxa Entrega (%)","v":"83.0%","t":"+1.1%","d":"up"},{"l":"Taxa Abertura (%)","v":"75.8%","t":"+15.1%","d":"up"},{"l":"Escalações","v":"2.019","t":"+15.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.812","85.9%","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.384","84.1%","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","800","78.3%","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.594","82.6%","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.770","74.1%","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":688},{"label":"Mar","value":693},{"label":"Abr","value":596},{"label":"Mai","value":581},{"label":"Jun","value":840},{"label":"Jul","value":908},{"label":"Ago","value":888},{"label":"Set","value":960},{"label":"Out","value":682},{"label":"Nov","value":881},{"label":"Dez","value":817}];
const MX = 960;
