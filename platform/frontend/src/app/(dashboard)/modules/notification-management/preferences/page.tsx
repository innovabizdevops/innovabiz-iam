...
const KPIS = [{"l":"Notificações Enviadas","v":"4.379","t":"-3.8%","d":"down"},{"l":"Taxa Entrega (%)","v":"77.0%","t":"+10.1%","d":"up"},{"l":"Taxa Abertura (%)","v":"86.4%","t":"+15.3%","d":"up"},{"l":"Escalações","v":"5.346","t":"+5.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.140","74.8%","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.583","71.3%","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","979","98.5%","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.782","77.1%","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.619","73.4%","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":554},{"label":"Mar","value":455},{"label":"Abr","value":631},{"label":"Mai","value":588},{"label":"Jun","value":733},{"label":"Jul","value":661},{"label":"Ago","value":761},{"label":"Set","value":612},{"label":"Out","value":425},{"label":"Nov","value":543},{"label":"Dez","value":680}];
const MX = 761;
