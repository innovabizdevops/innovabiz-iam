...
const KPIS = [{"l":"Formulários Ativos","v":"726","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"1247","t":"+9.0%","d":"up"},{"l":"Documentos Gerados","v":"8.020","t":"+2.6%","d":"up"},{"l":"Templates","v":"8.174","t":"+8.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.457","2026-02-21","4.168","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.895","2026-03-15","6.273","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.020","2026-02-20","6.587","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.285","2026-02-14","3.169","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.759","2026-03-14","7.246","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":643},{"label":"Mar","value":709},{"label":"Abr","value":690},{"label":"Mai","value":688},{"label":"Jun","value":825},{"label":"Jul","value":685},{"label":"Ago","value":488},{"label":"Set","value":734},{"label":"Out","value":494},{"label":"Nov","value":539},{"label":"Dez","value":557}];
const MX = 825;
