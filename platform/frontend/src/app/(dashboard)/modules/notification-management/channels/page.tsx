...
const PAGE = "Push &amp; Email";
const KPIS = [{"l":"Notificações Enviadas","v":"4.143","t":"+7.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"73.6%","t":"-2.2%","d":"down"},{"l":"Taxa Abertura (%)","v":"82.1%","t":"+11.1%","d":"up"},{"l":"Escalações","v":"3.116","t":"+5.9%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.154","81.4%","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.465","75.4%","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.375","96.0%","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.985","98.3%","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.404","83.5%","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":725},{"label":"Mar","value":640},{"label":"Abr","value":998},{"label":"Mai","value":983},{"label":"Jun","value":632},{"label":"Jul","value":765},{"label":"Ago","value":951},{"label":"Set","value":843},{"label":"Out","value":795},{"label":"Nov","value":750},{"label":"Dez","value":789}];
const MX = 998;
