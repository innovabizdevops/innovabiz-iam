...
const ACCENT = "#6366f1";
const MODULE = "Notification Management";
const PAGE = "Rules Engine";
const KPIS = [{"l":"Notificações Enviadas","v":"733","t":"+14.8%","d":"up"},{"l":"Taxa Entrega (%)","v":"90.1%","t":"+16.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"73.6%","t":"+3.0%","d":"up"},{"l":"Escalações","v":"6.165","t":"+16.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.243","70.8%","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.974","94.7%","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.865","96.2%","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.249","92.2%","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","336","76.8%","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":493},{"label":"Mar","value":692},{"label":"Abr","value":774},{"label":"Mai","value":480},{"label":"Jun","value":651},{"label":"Jul","value":741},{"label":"Ago","value":706},{"label":"Set","value":476},{"label":"Out","value":670},{"label":"Nov","value":756},{"label":"Dez","value":675}];
const MX = 774;
