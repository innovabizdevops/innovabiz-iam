...
const PAGE = "Material";
const KPIS = [{"l":"Dashboards Ativos","v":"964","t":"+9.7%","d":"up"},{"l":"Queries/Dia","v":"4321","t":"+2.3%","d":"up"},{"l":"Dados Processados (GB)","v":"9.080","t":"+10.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.871","t":"+8.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2043","2026-03-11","6.516","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5093","2026-01-08","8.387","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3157","2026-03-19","8.961","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","540","2026-01-03","7.751","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2481","2026-01-07","2.694","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":528},{"label":"Mar","value":662},{"label":"Abr","value":606},{"label":"Mai","value":488},{"label":"Jun","value":584},{"label":"Jul","value":661},{"label":"Ago","value":715},{"label":"Set","value":566},{"label":"Out","value":662},{"label":"Nov","value":566},{"label":"Dez","value":681}];
const MX = 723;
