...
const KPIS = [{"l":"Dashboards Ativos","v":"3.550","t":"+3.4%","d":"up"},{"l":"Queries/Dia","v":"4899","t":"+13.5%","d":"up"},{"l":"Dados Processados (GB)","v":"7.768","t":"+11.4%","d":"up"},{"l":"Utilizadores Analytics","v":"5.589","t":"+6.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3708","2026-01-24","5.531","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1161","2026-02-04","4.896","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4548","2026-02-25","3.594","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3614","2026-01-13","6.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1531","2026-02-17","2.215","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":696},{"label":"Mar","value":603},{"label":"Abr","value":444},{"label":"Mai","value":430},{"label":"Jun","value":670},{"label":"Jul","value":711},{"label":"Ago","value":395},{"label":"Set","value":716},{"label":"Out","value":583},{"label":"Nov","value":723},{"label":"Dez","value":385}];
const MX = 723;
