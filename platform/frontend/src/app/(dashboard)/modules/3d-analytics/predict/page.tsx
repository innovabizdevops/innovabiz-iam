...
const ACCENT = "#312e81";
const MODULE = "3D Print Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"4.857","t":"-2.5%","d":"down"},{"l":"Queries/Dia","v":"3654","t":"+17.3%","d":"up"},{"l":"Dados Processados (GB)","v":"3.695","t":"+10.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.380","t":"-5.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2735","2026-01-03","1.941","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3973","2026-02-16","7.364","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3192","2026-01-03","750","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3605","2026-02-01","8.988","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1372","2026-02-03","4.375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":724},{"label":"Mar","value":778},{"label":"Abr","value":888},{"label":"Mai","value":817},{"label":"Jun","value":699},{"label":"Jul","value":861},{"label":"Ago","value":750},{"label":"Set","value":675},{"label":"Out","value":735},{"label":"Nov","value":889},{"label":"Dez","value":974}];
const MX = 996;
