...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"3.628","t":"+1.5%","d":"up"},{"l":"Queries/Dia","v":"841","t":"+14.1%","d":"up"},{"l":"Dados Processados (GB)","v":"5.741","t":"+6.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.313","t":"+12.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3137","2026-01-10","1.784","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1262","2026-01-16","1.215","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2239","2026-01-06","5.793","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3536","2026-03-06","9.083","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4578","2026-03-21","4.097","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":958},{"label":"Mar","value":1012},{"label":"Abr","value":1006},{"label":"Mai","value":803},{"label":"Jun","value":987},{"label":"Jul","value":877},{"label":"Ago","value":1064},{"label":"Set","value":831},{"label":"Out","value":986},{"label":"Nov","value":904},{"label":"Dez","value":820}];
const MX = 1064;
