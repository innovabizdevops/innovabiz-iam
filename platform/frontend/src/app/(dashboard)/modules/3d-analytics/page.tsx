...
/* ═══ 3D Print Analytics — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "3413", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1858", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€11K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "960699313", cells: ["3D-4313", "3D Print Analytics Item 1", "22/2/2026", "€49 413"], status: "active" as const },
    { id: "960702884", cells: ["3D-7884", "3D Print Analytics Item 2", "9/9/2026", "€2984"], status: "pending" as const },
    { id: "960706455", cells: ["3D-2455", "3D Print Analytics Item 3", "24/4/2026", "€6555"], status: "completed" as const },
    { id: "960710026", cells: ["3D-6026", "3D Print Analytics Item 4", "11/11/2026", "€10 126"], status: "warning" as const },
    { id: "960713597", cells: ["3D-9597", "3D Print Analytics Item 5", "26/6/2026", "€13 697"], status: "active" as const },
];
...
export default function P3dPrintAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Print Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Print Analytics</p>
                    </div>
                </div>
