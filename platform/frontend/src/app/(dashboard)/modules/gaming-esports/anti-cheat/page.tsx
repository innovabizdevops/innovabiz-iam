...
const KPIS = [{"l":"Atletas Registados","v":"6.178","t":"-0.8%","d":"down"},{"l":"Treinos/Semana","v":"117","t":"+4.8%","d":"up"},{"l":"Competições","v":"7.916","t":"+17.5%","d":"up"},{"l":"Performance Score","v":"92","t":"-5.5%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.675","1.162","7.094","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","886","6.770","3.060","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.739","7.891","8.341","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.728","4.582","4.872","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.077","3.675","3.661","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":729},{"label":"Mar","value":714},{"label":"Abr","value":479},{"label":"Mai","value":646},{"label":"Jun","value":451},{"label":"Jul","value":336},{"label":"Ago","value":365},{"label":"Set","value":412},{"label":"Out","value":490},{"label":"Nov","value":565},{"label":"Dez","value":565}];
const MX = 729;
