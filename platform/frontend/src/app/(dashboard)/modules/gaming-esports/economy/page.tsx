...
const PAGE = "In-Game Economy";
const KPIS = [{"l":"Atletas Registados","v":"8.087","t":"-2.3%","d":"down"},{"l":"Treinos/Semana","v":"4351","t":"+14.2%","d":"up"},{"l":"Competições","v":"5.909","t":"-4.3%","d":"down"},{"l":"Performance Score","v":"85","t":"-2.8%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.858","6.289","4.858","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.495","6.870","2.111","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.657","4.888","6.839","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.909","1.374","8.211","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.629","5.007","1.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":256},{"label":"Fev","value":456},{"label":"Mar","value":459},{"label":"Abr","value":582},{"label":"Mai","value":243},{"label":"Jun","value":392},{"label":"Jul","value":295},{"label":"Ago","value":257},{"label":"Set","value":515},{"label":"Out","value":527},{"label":"Nov","value":379},{"label":"Dez","value":295}];
const MX = 582;
