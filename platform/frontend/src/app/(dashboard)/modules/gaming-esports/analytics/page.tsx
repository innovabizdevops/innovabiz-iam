...
const ACCENT = "#7c3aed";
const MODULE = "Gaming & Esports";
const PAGE = "Player Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.046","t":"+16.2%","d":"up"},{"l":"Queries/Dia","v":"3230","t":"-3.8%","d":"down"},{"l":"Dados Processados (GB)","v":"3.959","t":"+0.1%","d":"up"},{"l":"Utilizadores Analytics","v":"5.480","t":"+14.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2656","2026-02-16","600","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1628","2026-03-28","1.320","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4197","2026-01-06","6.952","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4118","2026-01-14","8.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3222","2026-02-22","4.989","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":636},{"label":"Mar","value":719},{"label":"Abr","value":546},{"label":"Mai","value":807},{"label":"Jun","value":654},{"label":"Jul","value":650},{"label":"Ago","value":707},{"label":"Set","value":559},{"label":"Out","value":598},{"label":"Nov","value":829},{"label":"Dez","value":863}];
const MX = 863;
