...
const PAGE = "Matchmaking AI";
const KPIS = [{"l":"Atletas Registados","v":"2.037","t":"+16.8%","d":"up"},{"l":"Treinos/Semana","v":"4716","t":"+7.9%","d":"up"},{"l":"Competições","v":"5.262","t":"-0.2%","d":"down"},{"l":"Performance Score","v":"63","t":"+6.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.540","7.232","4.116","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.401","6.154","2.448","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.414","8.695","6.663","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.939","4.249","575","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.253","6.633","3.987","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":797},{"label":"Mar","value":801},{"label":"Abr","value":679},{"label":"Mai","value":928},{"label":"Jun","value":930},{"label":"Jul","value":681},{"label":"Ago","value":844},{"label":"Set","value":619},{"label":"Out","value":930},{"label":"Nov","value":837},{"label":"Dez","value":654}];
const MX = 930;
