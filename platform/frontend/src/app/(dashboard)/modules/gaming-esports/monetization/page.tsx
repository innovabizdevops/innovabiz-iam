...
const KPIS = [{"l":"ARR (€M)","v":"€3.7M","t":"+1.4%","d":"up"},{"l":"MRR (€)","v":"€89744","t":"-5.5%","d":"down"},{"l":"Churn (%)","v":"91.5%","t":"+13.4%","d":"up"},{"l":"ARPU (€)","v":"€1645","t":"+8.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17895.10","1.742","€ 18334.31","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 36320.55","6.877","€ 20101.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25362.18","5.936","€ 32682.63","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2101.86","6.126","€ 39512.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11682.17","8.656","€ 18548.80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":980},{"label":"Fev","value":838},{"label":"Mar","value":793},{"label":"Abr","value":792},{"label":"Mai","value":692},{"label":"Jun","value":957},{"label":"Jul","value":861},{"label":"Ago","value":694},{"label":"Set","value":753},{"label":"Out","value":795},{"label":"Nov","value":1011},{"label":"Dez","value":832}];
const MX = 1011;
