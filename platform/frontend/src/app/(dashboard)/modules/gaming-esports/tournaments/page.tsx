...
const PAGE = "Tournament Mgmt";
const KPIS = [{"l":"Atletas Registados","v":"2.756","t":"+5.5%","d":"up"},{"l":"Treinos/Semana","v":"204","t":"+13.5%","d":"up"},{"l":"Competições","v":"730","t":"-0.2%","d":"down"},{"l":"Performance Score","v":"84","t":"+3.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.050","8.713","3.552","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.735","5.526","1.767","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.459","5.328","3.451","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.481","4.506","5.085","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.546","3.802","2.479","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":843},{"label":"Mar","value":930},{"label":"Abr","value":625},{"label":"Mai","value":675},{"label":"Jun","value":601},{"label":"Jul","value":597},{"label":"Ago","value":788},{"label":"Set","value":739},{"label":"Out","value":783},{"label":"Nov","value":917},{"label":"Dez","value":779}];
const MX = 930;
