...
const PAGE = "LiveOps";
const KPIS = [{"l":"Atletas Registados","v":"2.965","t":"+10.7%","d":"up"},{"l":"Treinos/Semana","v":"201","t":"+13.7%","d":"up"},{"l":"Competições","v":"5.422","t":"+1.2%","d":"up"},{"l":"Performance Score","v":"81","t":"-4.8%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.508","7.377","5.522","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.128","1.455","6.660","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.621","7.747","2.477","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","254","1.498","4.214","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.718","287","2.646","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":660},{"label":"Mar","value":632},{"label":"Abr","value":740},{"label":"Mai","value":938},{"label":"Jun","value":766},{"label":"Jul","value":754},{"label":"Ago","value":601},{"label":"Set","value":566},{"label":"Out","value":901},{"label":"Nov","value":855},{"label":"Dez","value":693}];
const MX = 938;
