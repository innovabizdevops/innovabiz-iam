...
const KPIS = [{"l":"Projetos Sociais","v":"2.523","t":"+3.1%","d":"up"},{"l":"Beneficiários","v":"5.967","t":"+3.1%","d":"up"},{"l":"Investimento CSR (€)","v":"€99408","t":"+11.2%","d":"up"},{"l":"Score Impacto","v":"56","t":"+10.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.149","€ 32667.39","6.306","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.386","€ 10222.52","178","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.313","€ 10884.52","3.246","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.177","€ 5173.54","2.008","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.755","€ 19281.28","5.763","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":618},{"label":"Mar","value":488},{"label":"Abr","value":649},{"label":"Mai","value":694},{"label":"Jun","value":623},{"label":"Jul","value":422},{"label":"Ago","value":439},{"label":"Set","value":679},{"label":"Out","value":642},{"label":"Nov","value":576},{"label":"Dez","value":705}];
const MX = 705;
