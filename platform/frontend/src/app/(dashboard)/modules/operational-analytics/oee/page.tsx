...
const PAGE = "OEE";
const KPIS = [{"l":"Dashboards Ativos","v":"748","t":"-1.4%","d":"down"},{"l":"Queries/Dia","v":"1162","t":"+6.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.569","t":"+4.8%","d":"up"},{"l":"Utilizadores Analytics","v":"3.922","t":"+4.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1202","2026-01-22","7.524","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","360","2026-01-06","894","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3461","2026-01-13","6.716","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3851","2026-03-24","5.582","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3590","2026-03-18","1.935","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":731},{"label":"Mar","value":553},{"label":"Abr","value":844},{"label":"Mai","value":631},{"label":"Jun","value":700},{"label":"Jul","value":870},{"label":"Ago","value":824},{"label":"Set","value":795},{"label":"Out","value":557},{"label":"Nov","value":664},{"label":"Dez","value":835}];
const MX = 870;
