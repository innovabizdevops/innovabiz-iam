...
const PAGE = "Downtime";
const KPIS = [{"l":"Dashboards Ativos","v":"508","t":"+9.4%","d":"up"},{"l":"Queries/Dia","v":"3095","t":"+16.2%","d":"up"},{"l":"Dados Processados (GB)","v":"7.031","t":"+10.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.920","t":"+3.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3712","2026-02-15","7.328","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3112","2026-03-17","8.950","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4095","2026-01-21","4.901","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","286","2026-03-07","1.854","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2590","2026-03-25","4.328","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":896},{"label":"Mar","value":1054},{"label":"Abr","value":946},{"label":"Mai","value":981},{"label":"Jun","value":847},{"label":"Jul","value":956},{"label":"Ago","value":1019},{"label":"Set","value":876},{"label":"Out","value":1023},{"label":"Nov","value":962},{"label":"Dez","value":1061}];
const MX = 1061;
