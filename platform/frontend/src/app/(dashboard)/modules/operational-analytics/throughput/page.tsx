...
const ACCENT = "#4338ca";
const MODULE = "Operational Analytics";
const PAGE = "Throughput";
const KPIS = [{"l":"Dashboards Ativos","v":"6.994","t":"-5.9%","d":"down"},{"l":"Queries/Dia","v":"2405","t":"-1.0%","d":"down"},{"l":"Dados Processados (GB)","v":"257","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"944","t":"-0.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4417","2026-03-23","6.768","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2790","2026-01-07","6.170","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4218","2026-02-15","5.767","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","391","2026-03-16","1.292","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4061","2026-01-01","7.938","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":815},{"label":"Mar","value":511},{"label":"Abr","value":715},{"label":"Mai","value":699},{"label":"Jun","value":777},{"label":"Jul","value":591},{"label":"Ago","value":846},{"label":"Set","value":696},{"label":"Out","value":690},{"label":"Nov","value":493},{"label":"Dez","value":521}];
const MX = 846;
