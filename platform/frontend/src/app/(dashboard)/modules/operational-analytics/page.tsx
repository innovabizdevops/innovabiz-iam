...
const KPIS = [
    { label: "Total Registos", value: "1506", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2214", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1675358606", cells: ["OPE-9606", "Operational Analytics Item 1", "27/3/2026", "€8706"], status: "active" as const },
    { id: "1675362177", cells: ["OPE-4177", "Operational Analytics Item 2", "14/10/2026", "€12 277"], status: "pending" as const },
    { id: "1675365748", cells: ["OPE-7748", "Operational Analytics Item 3", "1/5/2026", "€15 848"], status: "completed" as const },
    { id: "1675369319", cells: ["OPE-2319", "Operational Analytics Item 4", "16/12/2026", "€19 419"], status: "warning" as const },
    { id: "1675372890", cells: ["OPE-5890", "Operational Analytics Item 5", "3/7/2026", "€22 990"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Operational Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Operational Analytics</p>
                    </div>
                </div>
