...
const PAGE = "Energy";
const KPIS = [{"l":"Dashboards Ativos","v":"6.754","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"4609","t":"+16.6%","d":"up"},{"l":"Dados Processados (GB)","v":"9.067","t":"+8.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.210","t":"+13.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","772","2026-03-24","8.686","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1919","2026-01-05","7.534","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1627","2026-02-28","2.601","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3698","2026-02-17","8.025","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4015","2026-02-14","2.265","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":516},{"label":"Mar","value":395},{"label":"Abr","value":541},{"label":"Mai","value":667},{"label":"Jun","value":362},{"label":"Jul","value":531},{"label":"Ago","value":633},{"label":"Set","value":311},{"label":"Out","value":571},{"label":"Nov","value":406},{"label":"Dez","value":322}];
const MX = 667;
