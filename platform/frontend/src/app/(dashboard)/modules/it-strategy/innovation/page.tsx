...
const KPIS = [{"l":"Ideias Submetidas","v":"9.038","t":"+17.7%","d":"up"},{"l":"Patentes (YTD)","v":"6.106","t":"-3.4%","d":"down"},{"l":"Projetos Innovation Lab","v":"8.335","t":"+7.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€39.0M","t":"+14.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.372","84.5%","2.799","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.582","76.8%","2.007","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.516","98.5%","1.605","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.106","71.1%","4.572","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.123","76.9%","4.738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":664},{"label":"Mar","value":688},{"label":"Abr","value":516},{"label":"Mai","value":727},{"label":"Jun","value":628},{"label":"Jul","value":743},{"label":"Ago","value":692},{"label":"Set","value":669},{"label":"Out","value":563},{"label":"Nov","value":556},{"label":"Dez","value":559}];
const MX = 744;
