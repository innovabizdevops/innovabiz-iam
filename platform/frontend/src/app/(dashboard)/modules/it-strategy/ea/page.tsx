...
const PAGE = "EA";
const KPIS = [{"l":"Total It Strategy","v":"8.191","t":"-0.9%","d":"down"},{"l":"EA Ativos","v":"107","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"91","t":"+3.1%","d":"up"}];
const COLS = ["ID","EA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["It Strategy #001","It Strategy #002","5.643","6.554","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["It Strategy #002","It Strategy #003","6.743","8.364","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["It Strategy #003","It Strategy #004","2.561","8.766","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["It Strategy #004","It Strategy #005","4.139","4.291","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["It Strategy #005","It Strategy #001","3.953","980","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":901},{"label":"Mar","value":618},{"label":"Abr","value":880},{"label":"Mai","value":807},{"label":"Jun","value":633},{"label":"Jul","value":614},{"label":"Ago","value":782},{"label":"Set","value":524},{"label":"Out","value":768},{"label":"Nov","value":891},{"label":"Dez","value":812}];
const MX = 901;
