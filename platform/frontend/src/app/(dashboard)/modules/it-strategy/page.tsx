...
/* ═══ IT Strategy & Planning (COBIT APO) — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "2828", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4744", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€417K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1253629828", cells: ["IT-2828", "IT Strategy & Planning (COBIT APO) Item 1", "25/5/2026", "€29 928"], status: "active" as const },
    { id: "1253633399", cells: ["IT-6399", "IT Strategy & Planning (COBIT APO) Item 2", "12/12/2026", "€33 499"], status: "pending" as const },
    { id: "1253636970", cells: ["IT-9970", "IT Strategy & Planning (COBIT APO) Item 3", "27/7/2026", "€37 070"], status: "completed" as const },
    { id: "1253640541", cells: ["IT-4541", "IT Strategy & Planning (COBIT APO) Item 4", "14/2/2026", "€40 641"], status: "warning" as const },
    { id: "1253644112", cells: ["IT-8112", "IT Strategy & Planning (COBIT APO) Item 5", "1/9/2026", "€44 212"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 88 }, { label: "Fev", value: 97 }, { label: "Mar", value: 26 }, { label: "Abr", value: 35 }, { label: "Mai", value: 44 }, { label: "Jun", value: 53 }];
...
export default function ItStrategyPlanningCobitApoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IT Strategy & Planning (COBIT APO)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IT Strategy & Planning (COBIT APO)</p>
                    </div>
                </div>
