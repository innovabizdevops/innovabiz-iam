...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"167","t":"-1.9%","d":"down"},{"l":"Contratos (€M)","v":"€49.7M","t":"+10.7%","d":"up"},{"l":"On-Time Delivery (%)","v":"85.6%","t":"+9.0%","d":"up"},{"l":"Score Médio","v":"80","t":"-1.4%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.6%","€ 49222.62","6.694","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","77.3%","€ 46923.41","7.475","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","85.2%","€ 4311.78","5.259","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","82.9%","€ 5790.14","5.757","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","95.3%","€ 22426.58","920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":558},{"label":"Mar","value":434},{"label":"Abr","value":406},{"label":"Mai","value":599},{"label":"Jun","value":320},{"label":"Jul","value":449},{"label":"Ago","value":308},{"label":"Set","value":519},{"label":"Out","value":411},{"label":"Nov","value":565},{"label":"Dez","value":243}];
const MX = 599;
