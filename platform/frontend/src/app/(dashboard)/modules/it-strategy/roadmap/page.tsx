...
const ACCENT = "#334155";
const MODULE = "IT Strategy & Planning (COBIT APO)";
const PAGE = "Roadmap";
const KPIS = [{"l":"Total It Strategy","v":"6.271","t":"+4.1%","d":"up"},{"l":"Roadmap Ativos","v":"1.488","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"92","t":"-3.9%","d":"down"}];
const COLS = ["ID","Roadmap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["It Strategy #001","It Strategy #002","1.627","6.575","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["It Strategy #002","It Strategy #003","8.025","1.906","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["It Strategy #003","It Strategy #004","1.492","6.053","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["It Strategy #004","It Strategy #005","8.531","2.441","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["It Strategy #005","It Strategy #001","852","6.483","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":753},{"label":"Mar","value":574},{"label":"Abr","value":726},{"label":"Mai","value":656},{"label":"Jun","value":753},{"label":"Jul","value":723},{"label":"Ago","value":770},{"label":"Set","value":886},{"label":"Out","value":589},{"label":"Nov","value":933},{"label":"Dez","value":733}];
const MX = 933;
