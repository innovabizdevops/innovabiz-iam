...
const PAGE = "Episodic";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.637","t":"+18.0%","d":"up"},{"l":"NC Abertas","v":"730","t":"+10.1%","d":"up"},{"l":"Conformidade (%)","v":"65.0%","t":"-2.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.859","t":"+4.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.303","82.9%","8.561","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.687","79.7%","837","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","642","96.3%","4.620","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.389","79.0%","7.801","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","811","81.4%","7.407","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":582},{"label":"Mar","value":835},{"label":"Abr","value":518},{"label":"Mai","value":471},{"label":"Jun","value":486},{"label":"Jul","value":553},{"label":"Ago","value":717},{"label":"Set","value":469},{"label":"Out","value":622},{"label":"Nov","value":653},{"label":"Dez","value":491}];
const MX = 835;
