...
const PAGE = "Semantic";
const KPIS = [{"l":"Total Ax Memory","v":"2.849","t":"+16.1%","d":"up"},{"l":"Semantic Ativos","v":"8.076","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"83","t":"-2.1%","d":"down"}];
const COLS = ["ID","Semantic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Memory #001","Ax Memory #002","1.184","5.411","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Memory #002","Ax Memory #003","8.667","8.856","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Memory #003","Ax Memory #004","343","7.448","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Memory #004","Ax Memory #005","1.238","8.705","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Memory #005","Ax Memory #001","1.578","7.009","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":887},{"label":"Mar","value":685},{"label":"Abr","value":631},{"label":"Mai","value":653},{"label":"Jun","value":662},{"label":"Jul","value":773},{"label":"Ago","value":940},{"label":"Set","value":909},{"label":"Out","value":979},{"label":"Nov","value":949},{"label":"Dez","value":836}];
const MX = 979;
