...
const PAGE = "Working";
const KPIS = [{"l":"Total Ax Memory","v":"3.022","t":"+13.4%","d":"up"},{"l":"Working Ativos","v":"873","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"88","t":"+0.7%","d":"up"}];
const COLS = ["ID","Working","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Memory #001","Ax Memory #002","8.177","1.150","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Memory #002","Ax Memory #003","4.799","7.521","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Memory #003","Ax Memory #004","1.608","7.653","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Memory #004","Ax Memory #005","1.974","835","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Memory #005","Ax Memory #001","4.556","6.966","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":684},{"label":"Mar","value":508},{"label":"Abr","value":483},{"label":"Mai","value":592},{"label":"Jun","value":552},{"label":"Jul","value":734},{"label":"Ago","value":516},{"label":"Set","value":676},{"label":"Out","value":510},{"label":"Nov","value":638},{"label":"Dez","value":410}];
const MX = 734;
