...
const ACCENT = "#4f46e5";
const MODULE = "AX Memory & Context";
const PAGE = "Short-Term";
const KPIS = [{"l":"Riscos Identificados","v":"7.854","t":"+8.9%","d":"up"},{"l":"Mitigações Ativas","v":"4.308","t":"+6.0%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"-4.9%","d":"down"},{"l":"Incidentes YTD","v":"5.577","t":"-0.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.288","1.936","3.144","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.617","5.020","3.398","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.981","5.918","7.767","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.485","2.403","4.553","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.487","6.740","6.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":674},{"label":"Mar","value":571},{"label":"Abr","value":518},{"label":"Mai","value":688},{"label":"Jun","value":495},{"label":"Jul","value":589},{"label":"Ago","value":705},{"label":"Set","value":431},{"label":"Out","value":477},{"label":"Nov","value":690},{"label":"Dez","value":535}];
const MX = 705;
