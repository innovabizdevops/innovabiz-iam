...
/* ═══ AX Memory & Context — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "4094", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "148", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€397K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1272064894", cells: ["AX-5894", "AX Memory & Context Item 1", "3/11/2026", "€14 994"], status: "active" as const },
    { id: "1272068465", cells: ["AX-9465", "AX Memory & Context Item 2", "18/6/2026", "€18 565"], status: "pending" as const },
    { id: "1272072036", cells: ["AX-4036", "AX Memory & Context Item 3", "5/1/2026", "€22 136"], status: "completed" as const },
    { id: "1272075607", cells: ["AX-7607", "AX Memory & Context Item 4", "20/8/2026", "€25 707"], status: "warning" as const },
    { id: "1272079178", cells: ["AX-2178", "AX Memory & Context Item 5", "7/3/2026", "€29 278"], status: "active" as const },
];
...
export default function AxMemoryContextPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Memory & Context</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Memory & Context</p>
                    </div>
                </div>
