...
const PAGE = "Long-Term";
const KPIS = [{"l":"Riscos Identificados","v":"9.071","t":"+5.1%","d":"up"},{"l":"Mitigações Ativas","v":"6.647","t":"+10.8%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"-2.4%","d":"down"},{"l":"Incidentes YTD","v":"1.518","t":"+9.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.327","6.088","7.212","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.370","2.460","7.710","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.109","291","8.274","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.980","3.555","585","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.067","6.307","5.684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":475},{"label":"Mar","value":704},{"label":"Abr","value":437},{"label":"Mai","value":616},{"label":"Jun","value":375},{"label":"Jul","value":696},{"label":"Ago","value":551},{"label":"Set","value":447},{"label":"Out","value":521},{"label":"Nov","value":363},{"label":"Dez","value":412}];
const MX = 704;
