...
/* ═══ COSMOS Governance Layer — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "3092", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1937", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€278K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1175380492", cells: ["COS-8492", "COSMOS Governance Layer Item 1", "21/5/2026", "€30 592"], status: "active" as const },
    { id: "1175384063", cells: ["COS-3063", "COSMOS Governance Layer Item 2", "8/12/2026", "€34 163"], status: "pending" as const },
    { id: "1175387634", cells: ["COS-6634", "COSMOS Governance Layer Item 3", "23/7/2026", "€37 734"], status: "completed" as const },
    { id: "1175391205", cells: ["COS-1205", "COSMOS Governance Layer Item 4", "10/2/2026", "€41 305"], status: "warning" as const },
    { id: "1175394776", cells: ["COS-4776", "COSMOS Governance Layer Item 5", "25/9/2026", "€44 876"], status: "active" as const },
];
...
export default function CosmosGovernanceLayerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Governance Layer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Governance Layer</p>
                    </div>
                </div>
