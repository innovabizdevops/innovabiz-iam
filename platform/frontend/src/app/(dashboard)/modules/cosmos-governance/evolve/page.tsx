...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Governance Layer";
const PAGE = "Evolve";
const KPIS = [{"l":"Riscos Identificados","v":"2.103","t":"+4.8%","d":"up"},{"l":"Mitigações Ativas","v":"3.478","t":"-3.9%","d":"down"},{"l":"Score Risco Geral","v":"59","t":"-1.3%","d":"down"},{"l":"Incidentes YTD","v":"5.769","t":"-1.8%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.730","6.776","4.590","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.797","5.960","683","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","219","1.720","5.726","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.527","8.452","6.549","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.103","6.233","2.284","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":611},{"label":"Mar","value":464},{"label":"Abr","value":640},{"label":"Mai","value":515},{"label":"Jun","value":741},{"label":"Jul","value":737},{"label":"Ago","value":472},{"label":"Set","value":477},{"label":"Out","value":490},{"label":"Nov","value":578},{"label":"Dez","value":735}];
const MX = 741;
