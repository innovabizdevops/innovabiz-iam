...
const PAGE = "Audit";
const KPIS = [{"l":"Riscos Identificados","v":"8.557","t":"+14.8%","d":"up"},{"l":"Mitigações Ativas","v":"3.742","t":"+16.2%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+4.3%","d":"up"},{"l":"Incidentes YTD","v":"1.241","t":"+10.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.428","6.493","5.962","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.014","5.749","6.283","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.907","827","7.868","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.971","3.598","8.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.332","3.556","852","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":526},{"label":"Mar","value":556},{"label":"Abr","value":267},{"label":"Mai","value":306},{"label":"Jun","value":483},{"label":"Jul","value":466},{"label":"Ago","value":654},{"label":"Set","value":590},{"label":"Out","value":356},{"label":"Nov","value":447},{"label":"Dez","value":340}];
const MX = 654;
