...
const PAGE = "Policy";
const KPIS = [{"l":"Riscos Identificados","v":"6.426","t":"+3.2%","d":"up"},{"l":"Mitigações Ativas","v":"635","t":"-3.4%","d":"down"},{"l":"Score Risco Geral","v":"67","t":"+16.5%","d":"up"},{"l":"Incidentes YTD","v":"8.142","t":"+8.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.534","4.703","4.577","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.756","8.681","3.823","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.598","1.913","8.169","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.871","2.688","333","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.420","3.274","974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":872},{"label":"Mar","value":848},{"label":"Abr","value":619},{"label":"Mai","value":994},{"label":"Jun","value":734},{"label":"Jul","value":651},{"label":"Ago","value":673},{"label":"Set","value":712},{"label":"Out","value":855},{"label":"Nov","value":999},{"label":"Dez","value":1006}];
const MX = 1006;
