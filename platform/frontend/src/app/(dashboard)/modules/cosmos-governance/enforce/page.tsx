...
const PAGE = "Enforce";
const KPIS = [{"l":"Riscos Identificados","v":"6.413","t":"-5.7%","d":"down"},{"l":"Mitigações Ativas","v":"1.855","t":"+10.3%","d":"up"},{"l":"Score Risco Geral","v":"95","t":"+13.6%","d":"up"},{"l":"Incidentes YTD","v":"2.169","t":"+8.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.812","1.864","580","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.219","8.553","901","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.847","8.899","6.724","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.593","865","4.235","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.763","8.805","6.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":456},{"label":"Mar","value":676},{"label":"Abr","value":471},{"label":"Mai","value":619},{"label":"Jun","value":502},{"label":"Jul","value":748},{"label":"Ago","value":644},{"label":"Set","value":555},{"label":"Out","value":686},{"label":"Nov","value":707},{"label":"Dez","value":770}];
const MX = 770;
