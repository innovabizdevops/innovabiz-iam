...
const PAGE = "Comply";
const KPIS = [{"l":"Riscos Identificados","v":"6.407","t":"+3.9%","d":"up"},{"l":"Mitigações Ativas","v":"7.133","t":"+17.1%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"-0.1%","d":"down"},{"l":"Incidentes YTD","v":"585","t":"+7.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.829","6.338","8.920","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.885","7.302","949","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.684","6.152","4.587","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.851","2.583","5.134","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.863","4.462","6.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":901},{"label":"Mar","value":666},{"label":"Abr","value":671},{"label":"Mai","value":609},{"label":"Jun","value":896},{"label":"Jul","value":835},{"label":"Ago","value":729},{"label":"Set","value":936},{"label":"Out","value":642},{"label":"Nov","value":737},{"label":"Dez","value":823}];
const MX = 936;
