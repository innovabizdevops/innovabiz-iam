...
const ACCENT = "#4f46e5";
const MODULE = "Cowork IoT Platform";
const PAGE = "Occupy";
const KPIS = [{"l":"Dispositivos Online","v":"4.515","t":"-4.1%","d":"down"},{"l":"Dados/Min (MB)","v":"2.978","t":"+12.6%","d":"up"},{"l":"Alertas Ativos","v":"1.991","t":"-2.8%","d":"down"},{"l":"Uptime (%)","v":"85.3%","t":"+11.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.038","1.648","130","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.282","1.927","410","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.357","1.912","3.681","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.141","4.059","4.041","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.700","5.025","3.313","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":397},{"label":"Mar","value":767},{"label":"Abr","value":457},{"label":"Mai","value":474},{"label":"Jun","value":613},{"label":"Jul","value":681},{"label":"Ago","value":733},{"label":"Set","value":633},{"label":"Out","value":785},{"label":"Nov","value":505},{"label":"Dez","value":654}];
const MX = 785;
