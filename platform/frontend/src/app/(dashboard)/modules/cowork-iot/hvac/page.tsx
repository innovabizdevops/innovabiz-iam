...
const PAGE = "HVAC";
const KPIS = [{"l":"Dispositivos Online","v":"6.147","t":"+0.1%","d":"up"},{"l":"Dados/Min (MB)","v":"5.232","t":"+12.8%","d":"up"},{"l":"Alertas Ativos","v":"7.222","t":"+10.6%","d":"up"},{"l":"Uptime (%)","v":"86.4%","t":"+5.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.548","1.717","1.395","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.226","2.208","3.887","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.801","652","1.121","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","280","5.010","1.460","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.265","3.270","108","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":877},{"label":"Mar","value":667},{"label":"Abr","value":862},{"label":"Mai","value":796},{"label":"Jun","value":805},{"label":"Jul","value":567},{"label":"Ago","value":860},{"label":"Set","value":774},{"label":"Out","value":688},{"label":"Nov","value":826},{"label":"Dez","value":578}];
const MX = 877;
