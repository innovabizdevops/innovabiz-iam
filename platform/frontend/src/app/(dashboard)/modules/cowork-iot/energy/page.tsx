...
const PAGE = "Energy";
const KPIS = [{"l":"Dispositivos Online","v":"6.446","t":"+0.7%","d":"up"},{"l":"Dados/Min (MB)","v":"7.486","t":"+5.8%","d":"up"},{"l":"Alertas Ativos","v":"6.851","t":"+5.6%","d":"up"},{"l":"Uptime (%)","v":"81.3%","t":"+12.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.337","1.493","1.943","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.165","5.600","4.830","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.556","2.713","7.505","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.549","7.442","1.343","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.776","3.212","1.445","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":847},{"label":"Mar","value":750},{"label":"Abr","value":856},{"label":"Mai","value":722},{"label":"Jun","value":719},{"label":"Jul","value":739},{"label":"Ago","value":542},{"label":"Set","value":706},{"label":"Out","value":762},{"label":"Nov","value":827},{"label":"Dez","value":788}];
const MX = 866;
