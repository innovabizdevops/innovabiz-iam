...
const KPIS = [{"l":"Dispositivos Online","v":"6.181","t":"-0.2%","d":"down"},{"l":"Dados/Min (MB)","v":"9.032","t":"+14.5%","d":"up"},{"l":"Alertas Ativos","v":"3.167","t":"+16.3%","d":"up"},{"l":"Uptime (%)","v":"82.0%","t":"+15.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.611","1.313","6.140","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.529","1.134","7.378","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","974","246","7.137","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.836","2.958","4.100","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.026","2.227","8.188","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":707},{"label":"Mar","value":779},{"label":"Abr","value":765},{"label":"Mai","value":606},{"label":"Jun","value":743},{"label":"Jul","value":747},{"label":"Ago","value":575},{"label":"Set","value":682},{"label":"Out","value":464},{"label":"Nov","value":794},{"label":"Dez","value":607}];
const MX = 794;
