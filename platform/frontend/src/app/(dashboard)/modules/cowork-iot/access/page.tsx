...
const PAGE = "Access";
const KPIS = [{"l":"Dispositivos Online","v":"477","t":"+10.1%","d":"up"},{"l":"Dados/Min (MB)","v":"8.110","t":"+0.0%","d":"up"},{"l":"Alertas Ativos","v":"2.902","t":"-1.4%","d":"down"},{"l":"Uptime (%)","v":"74.9%","t":"+1.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.842","2.915","819","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.685","1.331","5.934","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.304","122","4.974","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.005","3.279","2.507","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.660","601","1.366","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":737},{"label":"Mar","value":721},{"label":"Abr","value":1043},{"label":"Mai","value":828},{"label":"Jun","value":688},{"label":"Jul","value":660},{"label":"Ago","value":863},{"label":"Set","value":754},{"label":"Out","value":729},{"label":"Nov","value":862},{"label":"Dez","value":819}];
const MX = 1043;
