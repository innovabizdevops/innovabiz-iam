...
/* ═══ Cowork IoT Platform — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "9387", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1506", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€392K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1696621787", cells: ["COW-5787", "Cowork IoT Platform Item 1", "8/12/2026", "€21 887"], status: "active" as const },
    { id: "1696625358", cells: ["COW-9358", "Cowork IoT Platform Item 2", "23/7/2026", "€25 458"], status: "pending" as const },
    { id: "1696628929", cells: ["COW-3929", "Cowork IoT Platform Item 3", "10/2/2026", "€29 029"], status: "completed" as const },
    { id: "1696632500", cells: ["COW-7500", "Cowork IoT Platform Item 4", "25/9/2026", "€32 600"], status: "warning" as const },
    { id: "1696636071", cells: ["COW-2071", "Cowork IoT Platform Item 5", "12/4/2026", "€36 171"], status: "active" as const },
];
...
export default function CoworkIotPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cowork IoT Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cowork IoT Platform</p>
                    </div>
                </div>
