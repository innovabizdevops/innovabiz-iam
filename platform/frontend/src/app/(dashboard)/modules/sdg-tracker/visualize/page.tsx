...
const ACCENT = "#831843";
const MODULE = "SDG Tracker";
const PAGE = "Visualize";
const KPIS = [{"l":"Dashboards Ativos","v":"2.350","t":"+6.9%","d":"up"},{"l":"Queries/Dia","v":"1152","t":"+0.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.330","t":"+16.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.920","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1082","2026-02-09","2.177","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2086","2026-01-22","7.037","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","973","2026-02-01","672","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3186","2026-01-11","7.316","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1884","2026-03-01","6.554","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":428},{"label":"Mar","value":358},{"label":"Abr","value":222},{"label":"Mai","value":266},{"label":"Jun","value":553},{"label":"Jul","value":457},{"label":"Ago","value":308},{"label":"Set","value":268},{"label":"Out","value":255},{"label":"Nov","value":335},{"label":"Dez","value":246}];
const MX = 553;
