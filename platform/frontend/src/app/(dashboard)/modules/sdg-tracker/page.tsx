...
/* ═══ SDG Tracker — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "5296", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1738", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€447K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "126695496", cells: ["SDG-3496", "SDG Tracker Item 1", "5/1/2026", "€45 596"], status: "active" as const },
    { id: "126699067", cells: ["SDG-7067", "SDG Tracker Item 2", "20/8/2026", "€49 167"], status: "pending" as const },
    { id: "126702638", cells: ["SDG-1638", "SDG Tracker Item 3", "7/3/2026", "€2738"], status: "completed" as const },
    { id: "126706209", cells: ["SDG-5209", "SDG Tracker Item 4", "22/10/2026", "€6309"], status: "warning" as const },
    { id: "126709780", cells: ["SDG-8780", "SDG Tracker Item 5", "9/5/2026", "€9880"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SDG Tracker</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SDG Tracker</p>
                    </div>
                </div>
