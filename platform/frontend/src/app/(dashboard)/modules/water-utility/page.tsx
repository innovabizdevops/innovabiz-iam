...
export default function WaterUtilityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Water Utility</h1><p className="text-sm text-muted-foreground">Water Utility • iBOS Enterprise</p></div>
