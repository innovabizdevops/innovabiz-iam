...
const ACCENT = "#6366f1";
const MODULE = "Water Utility Deep";
const PAGE = "Meter";
const KPIS = [{"l":"Total Water Utility","v":"5.767","t":"+10.6%","d":"up"},{"l":"Meter Ativos","v":"8.389","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.9%","d":"down"}];
const COLS = ["ID","Meter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Utility #001","Water Utility #002","4.183","7.322","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Water Utility #002","Water Utility #003","1.113","2.132","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Utility #003","Water Utility #004","5.464","4.839","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Water Utility #004","Water Utility #005","2.864","3.458","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Utility #005","Water Utility #001","1.547","1.221","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":632},{"label":"Mar","value":505},{"label":"Abr","value":559},{"label":"Mai","value":467},{"label":"Jun","value":539},{"label":"Jul","value":620},{"label":"Ago","value":678},{"label":"Set","value":575},{"label":"Out","value":653},{"label":"Nov","value":533},{"label":"Dez","value":583}];
const MX = 748;
