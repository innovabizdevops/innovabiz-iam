...
const KPIS = [{"l":"Total Water Utility","v":"3.889","t":"+11.4%","d":"up"},{"l":"Distribution Ativos","v":"7.707","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"72.9%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"76","t":"+9.7%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Utility #001","Water Utility #002","4.963","7.924","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Water Utility #002","Water Utility #003","3.630","205","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Utility #003","Water Utility #004","5.289","4.470","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Water Utility #004","Water Utility #005","8.298","2.863","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Utility #005","Water Utility #001","2.081","7.392","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":960},{"label":"Mar","value":618},{"label":"Abr","value":768},{"label":"Mai","value":827},{"label":"Jun","value":706},{"label":"Jul","value":635},{"label":"Ago","value":843},{"label":"Set","value":661},{"label":"Out","value":828},{"label":"Nov","value":591},{"label":"Dez","value":886}];
const MX = 960;
