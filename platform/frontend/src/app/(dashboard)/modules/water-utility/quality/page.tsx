...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.863","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"1.350","t":"+10.2%","d":"up"},{"l":"Conformidade (%)","v":"84.2%","t":"+16.2%","d":"up"},{"l":"CAPAs Pendentes","v":"6.873","t":"+2.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.608","97.1%","3.159","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.614","94.7%","3.626","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.243","93.5%","6.068","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.925","79.7%","8.842","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.597","85.7%","2.124","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":540},{"label":"Mar","value":398},{"label":"Abr","value":418},{"label":"Mai","value":529},{"label":"Jun","value":254},{"label":"Jul","value":432},{"label":"Ago","value":551},{"label":"Set","value":500},{"label":"Out","value":226},{"label":"Nov","value":247},{"label":"Dez","value":527}];
const MX = 551;
