...
const PAGE = "Fall Detection";
const KPIS = [{"l":"Total Elder Care","v":"1.955","t":"-4.8%","d":"down"},{"l":"Fall Detection Ativos","v":"1.335","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+9.5%","d":"up"}];
const COLS = ["ID","Fall Detection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elder Care #001","Elder Care #002","8.508","1.578","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Elder Care #002","Elder Care #003","4.014","5.594","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Elder Care #003","Elder Care #004","2.618","6.396","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Elder Care #004","Elder Care #005","6.085","1.915","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elder Care #005","Elder Care #001","5.206","4.586","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":959},{"label":"Fev","value":914},{"label":"Mar","value":1022},{"label":"Abr","value":724},{"label":"Mai","value":876},{"label":"Jun","value":655},{"label":"Jul","value":903},{"label":"Ago","value":731},{"label":"Set","value":761},{"label":"Out","value":722},{"label":"Nov","value":897},{"label":"Dez","value":966}];
const MX = 1022;
