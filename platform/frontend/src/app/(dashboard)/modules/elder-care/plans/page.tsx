...
const PAGE = "Care Plans";
const KPIS = [{"l":"Total Elder Care","v":"6.518","t":"-1.9%","d":"down"},{"l":"Care Plans Ativos","v":"3.525","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"77","t":"-0.5%","d":"down"}];
const COLS = ["ID","Care Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elder Care #001","Elder Care #002","6.126","7.160","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Elder Care #002","Elder Care #003","4.152","6.416","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Elder Care #003","Elder Care #004","2.157","4.430","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Elder Care #004","Elder Care #005","8.172","3.148","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elder Care #005","Elder Care #001","8.199","2.154","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":584},{"label":"Mar","value":489},{"label":"Abr","value":680},{"label":"Mai","value":436},{"label":"Jun","value":678},{"label":"Jul","value":433},{"label":"Ago","value":482},{"label":"Set","value":437},{"label":"Out","value":688},{"label":"Nov","value":693},{"label":"Dez","value":547}];
const MX = 693;
