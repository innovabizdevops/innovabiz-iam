...
const PAGE = "Medication Tracker";
const KPIS = [{"l":"Integrações Ativas","v":"3.736","t":"-0.9%","d":"down"},{"l":"Chamadas/Hora","v":"2225","t":"-1.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"81.4%","t":"+8.6%","d":"up"},{"l":"Latência Média (ms)","v":"72ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.774","5.906","89.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.152","809","94.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.796","2.574","80.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.531","7.114","83.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","250","8.383","85.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":942},{"label":"Fev","value":941},{"label":"Mar","value":820},{"label":"Abr","value":1008},{"label":"Mai","value":742},{"label":"Jun","value":743},{"label":"Jul","value":689},{"label":"Ago","value":958},{"label":"Set","value":756},{"label":"Out","value":947},{"label":"Nov","value":925},{"label":"Dez","value":797}];
const MX = 1008;
