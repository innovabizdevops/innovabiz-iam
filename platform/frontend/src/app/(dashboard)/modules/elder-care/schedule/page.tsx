...
const PAGE = "Caregiver Schedule";
const KPIS = [{"l":"Total Elder Care","v":"396","t":"+11.6%","d":"up"},{"l":"Caregiver Schedule Ativos","v":"1.892","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"60","t":"+8.0%","d":"up"}];
const COLS = ["ID","Caregiver Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elder Care #001","Elder Care #002","7.085","4.347","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Elder Care #002","Elder Care #003","339","3.834","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Elder Care #003","Elder Care #004","1.040","8.544","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Elder Care #004","Elder Care #005","9.072","7.584","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elder Care #005","Elder Care #001","7.879","8.242","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":600},{"label":"Mar","value":661},{"label":"Abr","value":761},{"label":"Mai","value":661},{"label":"Jun","value":442},{"label":"Jul","value":446},{"label":"Ago","value":617},{"label":"Set","value":508},{"label":"Out","value":607},{"label":"Nov","value":420},{"label":"Dez","value":549}];
const MX = 761;
