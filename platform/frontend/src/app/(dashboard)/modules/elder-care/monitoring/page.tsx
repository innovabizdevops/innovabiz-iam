...
const ACCENT = "#6366f1";
const MODULE = "Elder & Home Care";
const PAGE = "Remote Monitoring";
const KPIS = [{"l":"Total Elder Care","v":"6.123","t":"+13.0%","d":"up"},{"l":"Remote Monitoring Ativos","v":"8.023","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"78","t":"+5.6%","d":"up"}];
const COLS = ["ID","Remote Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elder Care #001","Elder Care #002","2.233","7.061","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Elder Care #002","Elder Care #003","6.226","5.965","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Elder Care #003","Elder Care #004","2.522","7.754","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Elder Care #004","Elder Care #005","7.244","4.840","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elder Care #005","Elder Care #001","3.509","2.819","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":482},{"label":"Mar","value":377},{"label":"Abr","value":327},{"label":"Mai","value":577},{"label":"Jun","value":506},{"label":"Jul","value":536},{"label":"Ago","value":336},{"label":"Set","value":474},{"label":"Out","value":250},{"label":"Nov","value":519},{"label":"Dez","value":515}];
const MX = 577;
