...
const PAGE = "Memory Care";
const KPIS = [{"l":"Total Elder Care","v":"7.897","t":"+17.9%","d":"up"},{"l":"Memory Care Ativos","v":"6.329","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+2.9%","d":"up"}];
const COLS = ["ID","Memory Care","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elder Care #001","Elder Care #002","8.018","3.854","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Elder Care #002","Elder Care #003","1.448","4.822","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Elder Care #003","Elder Care #004","489","5.382","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Elder Care #004","Elder Care #005","6.564","1.160","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elder Care #005","Elder Care #001","1.122","7.835","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":740},{"label":"Mar","value":1046},{"label":"Abr","value":843},{"label":"Mai","value":826},{"label":"Jun","value":986},{"label":"Jul","value":868},{"label":"Ago","value":1025},{"label":"Set","value":848},{"label":"Out","value":871},{"label":"Nov","value":1052},{"label":"Dez","value":1057}];
const MX = 1057;
