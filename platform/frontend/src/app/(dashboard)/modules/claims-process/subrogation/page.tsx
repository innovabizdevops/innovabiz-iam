...
const ACCENT = "#6366f1";
const MODULE = "Claims Processing";
const PAGE = "Subrogation";
const KPIS = [{"l":"Total Claims Process","v":"4.264","t":"+14.8%","d":"up"},{"l":"Subrogation Ativos","v":"1.759","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-1.8%","d":"down"}];
const COLS = ["ID","Subrogation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Process #001","Claims Process #002","1.258","8.777","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Process #002","Claims Process #003","1.985","8.906","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Process #003","Claims Process #004","6.362","2.785","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Process #004","Claims Process #005","4.602","1.294","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Process #005","Claims Process #001","3.278","7.331","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":676},{"label":"Mar","value":664},{"label":"Abr","value":698},{"label":"Mai","value":994},{"label":"Jun","value":841},{"label":"Jul","value":776},{"label":"Ago","value":690},{"label":"Set","value":949},{"label":"Out","value":983},{"label":"Nov","value":887},{"label":"Dez","value":956}];
const MX = 1000;
...
export default function SubrogationPage() {
    return (
