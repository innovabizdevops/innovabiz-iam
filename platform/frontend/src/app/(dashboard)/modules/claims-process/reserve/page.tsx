...
const PAGE = "Reserve";
const KPIS = [{"l":"Total Claims Process","v":"5.470","t":"+17.6%","d":"up"},{"l":"Reserve Ativos","v":"6.735","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"64","t":"-3.1%","d":"down"}];
const COLS = ["ID","Reserve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Process #001","Claims Process #002","3.395","6.479","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Process #002","Claims Process #003","6.310","6.872","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Process #003","Claims Process #004","1.992","857","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Process #004","Claims Process #005","1.259","4.355","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Process #005","Claims Process #001","1.190","8.059","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":858},{"label":"Mar","value":700},{"label":"Abr","value":991},{"label":"Mai","value":669},{"label":"Jun","value":865},{"label":"Jul","value":986},{"label":"Ago","value":797},{"label":"Set","value":779},{"label":"Out","value":775},{"label":"Nov","value":600},{"label":"Dez","value":688}];
const MX = 991;
