...
const KPIS = [{"l":"Total Claims Process","v":"7.046","t":"-3.4%","d":"down"},{"l":"Settlement Ativos","v":"9.064","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"73.0%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+6.7%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Process #001","Claims Process #002","5.450","2.270","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Process #002","Claims Process #003","1.686","6.366","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Process #003","Claims Process #004","3.160","8.846","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Process #004","Claims Process #005","415","2.969","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Process #005","Claims Process #001","5.570","5.690","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":956},{"label":"Mar","value":978},{"label":"Abr","value":764},{"label":"Mai","value":875},{"label":"Jun","value":1034},{"label":"Jul","value":731},{"label":"Ago","value":881},{"label":"Set","value":865},{"label":"Out","value":721},{"label":"Nov","value":987},{"label":"Dez","value":921}];
const MX = 1034;
