...
const KPIS = [{"l":"Total Claims Process","v":"3.180","t":"+7.1%","d":"up"},{"l":"Adjudicate Ativos","v":"7.382","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+11.4%","d":"up"}];
const COLS = ["ID","Adjudicate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Process #001","Claims Process #002","4.555","5.228","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Process #002","Claims Process #003","4.249","8.248","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Process #003","Claims Process #004","5.126","7.232","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Process #004","Claims Process #005","8.809","1.020","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Process #005","Claims Process #001","3.110","3.061","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":1011},{"label":"Mar","value":790},{"label":"Abr","value":957},{"label":"Mai","value":723},{"label":"Jun","value":915},{"label":"Jul","value":882},{"label":"Ago","value":949},{"label":"Set","value":843},{"label":"Out","value":921},{"label":"Nov","value":926},{"label":"Dez","value":946}];
const MX = 1011;
