...
const PAGE = "Certify";
const KPIS = [{"l":"Total B Corp Mgmt","v":"8.304","t":"+10.0%","d":"up"},{"l":"Certify Ativos","v":"2.860","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"87.5%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"88","t":"+13.4%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["B Corp Mgmt #001","B Corp Mgmt #002","6.197","5.862","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["B Corp Mgmt #002","B Corp Mgmt #003","4.751","2.007","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["B Corp Mgmt #003","B Corp Mgmt #004","4.276","1.641","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["B Corp Mgmt #004","B Corp Mgmt #005","437","1.855","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["B Corp Mgmt #005","B Corp Mgmt #001","2.275","6.198","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":729},{"label":"Mar","value":725},{"label":"Abr","value":779},{"label":"Mai","value":777},{"label":"Jun","value":713},{"label":"Jul","value":744},{"label":"Ago","value":662},{"label":"Set","value":679},{"label":"Out","value":660},{"label":"Nov","value":626},{"label":"Dez","value":504}];
const MX = 779;
