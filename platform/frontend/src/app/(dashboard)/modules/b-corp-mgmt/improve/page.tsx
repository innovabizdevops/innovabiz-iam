...
const PAGE = "Improve";
const KPIS = [{"l":"Projetos Melhoria","v":"5.109","t":"-1.1%","d":"down"},{"l":"Savings (€)","v":"€57285","t":"+0.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.5%","t":"+14.5%","d":"up"},{"l":"Ciclos PDCA","v":"8.151","t":"-4.2%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.484","€ 47269.43","116","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.627","€ 15743.64","4.485","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","564","€ 20199.43","9.056","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.250","€ 3789.03","1.582","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.226","€ 28922.97","152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":903},{"label":"Mar","value":988},{"label":"Abr","value":1034},{"label":"Mai","value":921},{"label":"Jun","value":734},{"label":"Jul","value":869},{"label":"Ago","value":986},{"label":"Set","value":1015},{"label":"Out","value":1042},{"label":"Nov","value":719},{"label":"Dez","value":850}];
const MX = 1042;
