...
const ACCENT = "#be185d";
const MODULE = "B-Corp Management";
const PAGE = "Benchmark";
const KPIS = [{"l":"Total B Corp Mgmt","v":"1.878","t":"+6.5%","d":"up"},{"l":"Benchmark Ativos","v":"3.577","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"74.1%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+11.5%","d":"up"}];
const COLS = ["ID","Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["B Corp Mgmt #001","B Corp Mgmt #002","8.737","188","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["B Corp Mgmt #002","B Corp Mgmt #003","8.324","7.130","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["B Corp Mgmt #003","B Corp Mgmt #004","1.893","558","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["B Corp Mgmt #004","B Corp Mgmt #005","3.929","2.802","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["B Corp Mgmt #005","B Corp Mgmt #001","6.399","5.419","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":558},{"label":"Mar","value":842},{"label":"Abr","value":662},{"label":"Mai","value":559},{"label":"Jun","value":551},{"label":"Jul","value":753},{"label":"Ago","value":563},{"label":"Set","value":818},{"label":"Out","value":877},{"label":"Nov","value":888},{"label":"Dez","value":645}];
const MX = 888;
