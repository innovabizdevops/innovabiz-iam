...
/* ═══ B-Corp Management — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "8880", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3139", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€397K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1082266880", cells: ["B-8880", "B-Corp Management Item 1", "17/9/2026", "€16 980"], status: "active" as const },
    { id: "1082270451", cells: ["B-3451", "B-Corp Management Item 2", "4/4/2026", "€20 551"], status: "pending" as const },
    { id: "1082274022", cells: ["B-7022", "B-Corp Management Item 3", "19/11/2026", "€24 122"], status: "completed" as const },
    { id: "1082277593", cells: ["B-1593", "B-Corp Management Item 4", "6/6/2026", "€27 693"], status: "warning" as const },
    { id: "1082281164", cells: ["B-5164", "B-Corp Management Item 5", "21/1/2026", "€31 264"], status: "active" as const },
];
...
export default function BcorpManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">B-Corp Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • B-Corp Management</p>
                    </div>
                </div>
