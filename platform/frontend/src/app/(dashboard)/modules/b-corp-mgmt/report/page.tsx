...
const PAGE = "Report";
const KPIS = [{"l":"Total B Corp Mgmt","v":"1.495","t":"+15.2%","d":"up"},{"l":"Report Ativos","v":"3.393","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.9%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["B Corp Mgmt #001","B Corp Mgmt #002","4.202","3.249","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["B Corp Mgmt #002","B Corp Mgmt #003","7.403","6.823","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["B Corp Mgmt #003","B Corp Mgmt #004","5.073","1.456","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["B Corp Mgmt #004","B Corp Mgmt #005","2.052","3.049","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["B Corp Mgmt #005","B Corp Mgmt #001","6.079","6.234","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":709},{"label":"Mar","value":692},{"label":"Abr","value":599},{"label":"Mai","value":551},{"label":"Jun","value":689},{"label":"Jul","value":863},{"label":"Ago","value":943},{"label":"Set","value":866},{"label":"Out","value":739},{"label":"Nov","value":729},{"label":"Dez","value":584}];
const MX = 943;
