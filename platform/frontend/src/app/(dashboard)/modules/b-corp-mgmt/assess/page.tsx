...
const PAGE = "Assess";
const KPIS = [{"l":"Total B Corp Mgmt","v":"4.971","t":"+16.3%","d":"up"},{"l":"Assess Ativos","v":"8.332","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"91.6%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"75","t":"-5.1%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["B Corp Mgmt #001","B Corp Mgmt #002","6.135","627","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["B Corp Mgmt #002","B Corp Mgmt #003","7.024","237","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["B Corp Mgmt #003","B Corp Mgmt #004","5.757","2.348","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["B Corp Mgmt #004","B Corp Mgmt #005","8.371","7.263","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["B Corp Mgmt #005","B Corp Mgmt #001","234","961","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":441},{"label":"Mar","value":355},{"label":"Abr","value":624},{"label":"Mai","value":455},{"label":"Jun","value":602},{"label":"Jul","value":355},{"label":"Ago","value":335},{"label":"Set","value":568},{"label":"Out","value":494},{"label":"Nov","value":701},{"label":"Dez","value":512}];
const MX = 701;
