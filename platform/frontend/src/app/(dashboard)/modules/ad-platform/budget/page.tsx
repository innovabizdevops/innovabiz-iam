...
const PAGE = "Budget Alloc";
const KPIS = [{"l":"Formulários Ativos","v":"8.949","t":"+3.0%","d":"up"},{"l":"Submissões/Dia","v":"5014","t":"+3.4%","d":"up"},{"l":"Documentos Gerados","v":"5.434","t":"-4.0%","d":"down"},{"l":"Templates","v":"7.049","t":"+3.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.973","2026-01-21","2.150","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.004","2026-01-16","984","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.522","2026-01-19","1.455","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.737","2026-01-07","3.772","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.581","2026-03-02","8.512","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":233},{"label":"Mar","value":413},{"label":"Abr","value":427},{"label":"Mai","value":300},{"label":"Jun","value":348},{"label":"Jul","value":530},{"label":"Ago","value":535},{"label":"Set","value":293},{"label":"Out","value":434},{"label":"Nov","value":388},{"label":"Dez","value":250}];
const MX = 535;
