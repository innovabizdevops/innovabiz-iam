...
const PAGE = "Campaign Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"1.811","t":"+11.0%","d":"up"},{"l":"Submissões/Dia","v":"3485","t":"-4.5%","d":"down"},{"l":"Documentos Gerados","v":"2.961","t":"+8.6%","d":"up"},{"l":"Templates","v":"7.650","t":"+17.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.684","2026-02-28","2.468","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.337","2026-01-04","7.771","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.431","2026-01-23","7.463","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.567","2026-03-03","5.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.049","2026-03-25","3.455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":476},{"label":"Mar","value":568},{"label":"Abr","value":502},{"label":"Mai","value":676},{"label":"Jun","value":404},{"label":"Jul","value":364},{"label":"Ago","value":591},{"label":"Set","value":451},{"label":"Out","value":332},{"label":"Nov","value":382},{"label":"Dez","value":545}];
const MX = 676;
