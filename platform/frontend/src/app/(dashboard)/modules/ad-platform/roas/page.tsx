...
const PAGE = "ROAS Dashboard";
const KPIS = [{"l":"Formulários Ativos","v":"1.439","t":"+2.2%","d":"up"},{"l":"Submissões/Dia","v":"2596","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"925","t":"+17.4%","d":"up"},{"l":"Templates","v":"3.308","t":"-0.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.085","2026-03-20","1.645","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","831","2026-02-12","3.938","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.461","2026-02-16","7.715","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.754","2026-01-24","1.683","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","111","2026-03-07","2.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":595},{"label":"Mar","value":875},{"label":"Abr","value":643},{"label":"Mai","value":856},{"label":"Jun","value":659},{"label":"Jul","value":638},{"label":"Ago","value":804},{"label":"Set","value":616},{"label":"Out","value":627},{"label":"Nov","value":590},{"label":"Dez","value":662}];
const MX = 875;
