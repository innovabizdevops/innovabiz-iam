...
const ACCENT = "#dc2626";
const MODULE = "Ad Platform";
const PAGE = "Bid Optimizer";
const KPIS = [{"l":"Formulários Ativos","v":"525","t":"+14.6%","d":"up"},{"l":"Submissões/Dia","v":"1844","t":"-1.5%","d":"down"},{"l":"Documentos Gerados","v":"1.107","t":"+13.7%","d":"up"},{"l":"Templates","v":"6.092","t":"+10.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.619","2026-02-18","1.505","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.876","2026-01-26","6.712","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.758","2026-03-03","3.673","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","921","2026-03-12","2.472","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.878","2026-01-04","4.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":291},{"label":"Mar","value":493},{"label":"Abr","value":269},{"label":"Mai","value":322},{"label":"Jun","value":236},{"label":"Jul","value":598},{"label":"Ago","value":249},{"label":"Set","value":335},{"label":"Out","value":472},{"label":"Nov","value":498},{"label":"Dez","value":617}];
const MX = 617;
