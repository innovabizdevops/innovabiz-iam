...
const PAGE = "Creative Studio";
const KPIS = [{"l":"Formulários Ativos","v":"357","t":"+2.5%","d":"up"},{"l":"Submissões/Dia","v":"2803","t":"-5.0%","d":"down"},{"l":"Documentos Gerados","v":"2.296","t":"+7.6%","d":"up"},{"l":"Templates","v":"2.272","t":"+8.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","468","2026-02-05","7.993","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","844","2026-01-20","216","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","105","2026-01-15","1.344","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.654","2026-03-20","1.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.842","2026-02-02","5.312","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":715},{"label":"Mar","value":679},{"label":"Abr","value":881},{"label":"Mai","value":612},{"label":"Jun","value":610},{"label":"Jul","value":847},{"label":"Ago","value":655},{"label":"Set","value":795},{"label":"Out","value":610},{"label":"Nov","value":840},{"label":"Dez","value":713}];
const MX = 881;
