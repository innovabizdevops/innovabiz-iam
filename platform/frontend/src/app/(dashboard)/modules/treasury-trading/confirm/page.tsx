...
const ACCENT = "#1e40af";
const MODULE = "Treasury & Trading";
const PAGE = "Confirm";
const KPIS = [{"l":"Total Treasury Trading","v":"6.572","t":"-2.1%","d":"down"},{"l":"Confirm Ativos","v":"2.620","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"82.8%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"69","t":"+3.0%","d":"up"}];
const COLS = ["ID","Confirm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Trading #001","Treasury Trading #002","2.351","7.107","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Trading #002","Treasury Trading #003","6.917","6.433","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Trading #003","Treasury Trading #004","8.546","2.940","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Trading #004","Treasury Trading #005","7.612","2.370","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Trading #005","Treasury Trading #001","2.320","4.410","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":877},{"label":"Mar","value":753},{"label":"Abr","value":723},{"label":"Mai","value":637},{"label":"Jun","value":905},{"label":"Jul","value":811},{"label":"Ago","value":719},{"label":"Set","value":885},{"label":"Out","value":635},{"label":"Nov","value":862},{"label":"Dez","value":985}];
const MX = 985;
