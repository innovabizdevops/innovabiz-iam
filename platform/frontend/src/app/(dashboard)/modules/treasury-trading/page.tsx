...
/* ═══ Treasury & Trading — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "2046", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4881", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€375K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "783428546", cells: ["TRE-6546", "Treasury & Trading Item 1", "27/3/2026", "€28 646"], status: "active" as const },
    { id: "783432117", cells: ["TRE-1117", "Treasury & Trading Item 2", "14/10/2026", "€32 217"], status: "pending" as const },
    { id: "783435688", cells: ["TRE-4688", "Treasury & Trading Item 3", "1/5/2026", "€35 788"], status: "completed" as const },
    { id: "783439259", cells: ["TRE-8259", "Treasury & Trading Item 4", "16/12/2026", "€39 359"], status: "warning" as const },
    { id: "783442830", cells: ["TRE-2830", "Treasury & Trading Item 5", "3/7/2026", "€42 930"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Treasury & Trading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Treasury & Trading</p>
                    </div>
                </div>
