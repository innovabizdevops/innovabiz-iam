...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"5.829","t":"-4.4%","d":"down"},{"l":"Mitigações Ativas","v":"7.730","t":"-3.2%","d":"down"},{"l":"Score Risco Geral","v":"69","t":"+0.8%","d":"up"},{"l":"Incidentes YTD","v":"706","t":"+7.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.313","7.431","7.961","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.314","6.761","2.662","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.598","3.567","266","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.360","5.312","7.344","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.335","2.357","1.618","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":603},{"label":"Mar","value":805},{"label":"Abr","value":642},{"label":"Mai","value":575},{"label":"Jun","value":798},{"label":"Jul","value":625},{"label":"Ago","value":755},{"label":"Set","value":707},{"label":"Out","value":462},{"label":"Nov","value":648},{"label":"Dez","value":754}];
const MX = 805;
