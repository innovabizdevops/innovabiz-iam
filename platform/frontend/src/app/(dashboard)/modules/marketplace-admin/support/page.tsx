...
const ACCENT = "#22c55e";
const MODULE = "Marketplace Administration";
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"3.223","t":"+0.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.8%","t":"+13.5%","d":"up"},{"l":"MTTR (h)","v":"70h","t":"+12.1%","d":"up"},{"l":"Satisfação (%)","v":"74.1%","t":"+0.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.664","7.207","5.795","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.006","2.535","8.606","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.066","1.329","2.044","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.408","2.494","1.021","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.791","1.142","2.659","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":541},{"label":"Mar","value":522},{"label":"Abr","value":556},{"label":"Mai","value":575},{"label":"Jun","value":633},{"label":"Jul","value":702},{"label":"Ago","value":369},{"label":"Set","value":374},{"label":"Out","value":444},{"label":"Nov","value":544},{"label":"Dez","value":731}];
const MX = 731;
