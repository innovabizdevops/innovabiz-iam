...
const KPIS = [
    { label: "Total Registos", value: "7308", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4725", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€35K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1318776308", cells: ["MAR-7308", "Marketplace Administration Item 1", "25/9/2026", "€26 408"], status: "active" as const },
    { id: "1318779879", cells: ["MAR-1879", "Marketplace Administration Item 2", "12/4/2026", "€29 979"], status: "pending" as const },
    { id: "1318783450", cells: ["MAR-5450", "Marketplace Administration Item 3", "27/11/2026", "€33 550"], status: "completed" as const },
    { id: "1318787021", cells: ["MAR-9021", "Marketplace Administration Item 4", "14/6/2026", "€37 121"], status: "warning" as const },
    { id: "1318790592", cells: ["MAR-3592", "Marketplace Administration Item 5", "1/1/2026", "€40 692"], status: "active" as const },
];
...
export default function MarketplaceAdministrationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marketplace Administration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marketplace Administration</p>
                    </div>
                </div>
