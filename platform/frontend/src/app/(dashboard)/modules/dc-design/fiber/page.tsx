...
const PAGE = "Fiber Path";
const KPIS = [{"l":"Formulários Ativos","v":"4.615","t":"+11.8%","d":"up"},{"l":"Submissões/Dia","v":"5095","t":"+8.7%","d":"up"},{"l":"Documentos Gerados","v":"650","t":"-5.8%","d":"down"},{"l":"Templates","v":"6.253","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.296","2026-02-04","7.496","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.282","2026-01-18","3.330","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.483","2026-03-02","142","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.028","2026-03-01","946","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.069","2026-03-09","205","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":622},{"label":"Mar","value":478},{"label":"Abr","value":661},{"label":"Mai","value":803},{"label":"Jun","value":764},{"label":"Jul","value":548},{"label":"Ago","value":478},{"label":"Set","value":497},{"label":"Out","value":804},{"label":"Nov","value":639},{"label":"Dez","value":592}];
const MX = 804;
