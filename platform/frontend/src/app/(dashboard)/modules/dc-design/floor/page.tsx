...
const KPIS = [{"l":"Formulários Ativos","v":"7.770","t":"+3.8%","d":"up"},{"l":"Submissões/Dia","v":"2923","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"1.198","t":"-2.9%","d":"down"},{"l":"Templates","v":"2.128","t":"+5.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.231","2026-02-28","1.131","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.461","2026-03-04","377","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.346","2026-01-03","8.533","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","176","2026-03-15","4.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.280","2026-03-14","1.501","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":358},{"label":"Mar","value":662},{"label":"Abr","value":599},{"label":"Mai","value":521},{"label":"Jun","value":566},{"label":"Jul","value":658},{"label":"Ago","value":673},{"label":"Set","value":498},{"label":"Out","value":380},{"label":"Nov","value":384},{"label":"Dez","value":357}];
const MX = 673;
