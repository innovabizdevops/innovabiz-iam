...
const PAGE = "Power Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.223","t":"+15.5%","d":"up"},{"l":"Submissões/Dia","v":"3451","t":"+5.2%","d":"up"},{"l":"Documentos Gerados","v":"6.911","t":"+4.1%","d":"up"},{"l":"Templates","v":"5.862","t":"+15.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.283","2026-01-04","2.998","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.144","2026-01-06","3.271","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.879","2026-02-28","8.784","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.037","2026-02-18","5.678","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.664","2026-03-17","4.435","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":720},{"label":"Mar","value":402},{"label":"Abr","value":404},{"label":"Mai","value":526},{"label":"Jun","value":389},{"label":"Jul","value":470},{"label":"Ago","value":583},{"label":"Set","value":401},{"label":"Out","value":402},{"label":"Nov","value":432},{"label":"Dez","value":581}];
const MX = 720;
