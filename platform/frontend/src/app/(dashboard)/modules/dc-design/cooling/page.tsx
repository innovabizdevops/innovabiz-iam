...
const ACCENT = "#475569";
const MODULE = "Data Center Design";
const PAGE = "Cooling Model";
const KPIS = [{"l":"Formulários Ativos","v":"9.084","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"2712","t":"+14.0%","d":"up"},{"l":"Documentos Gerados","v":"4.576","t":"+5.5%","d":"up"},{"l":"Templates","v":"6.698","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.210","2026-01-03","4.152","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.809","2026-01-21","8.198","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.088","2026-02-03","3.702","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.053","2026-01-13","3.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.860","2026-02-15","7.016","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":418},{"label":"Mar","value":441},{"label":"Abr","value":640},{"label":"Mai","value":732},{"label":"Jun","value":393},{"label":"Jul","value":541},{"label":"Ago","value":467},{"label":"Set","value":512},{"label":"Out","value":367},{"label":"Nov","value":721},{"label":"Dez","value":591}];
const MX = 732;
