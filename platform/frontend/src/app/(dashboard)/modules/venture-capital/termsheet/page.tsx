...
const PAGE = "Term Sheet";
const KPIS = [{"l":"Riscos Identificados","v":"6.618","t":"+0.6%","d":"up"},{"l":"Mitigações Ativas","v":"6.654","t":"+7.1%","d":"up"},{"l":"Score Risco Geral","v":"83","t":"-2.9%","d":"down"},{"l":"Incidentes YTD","v":"9.097","t":"+5.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.658","1.583","443","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.457","8.356","1.427","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.814","3.675","7.525","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.394","1.751","5.002","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.677","8.935","8.408","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":723},{"label":"Mar","value":902},{"label":"Abr","value":832},{"label":"Mai","value":630},{"label":"Jun","value":550},{"label":"Jul","value":795},{"label":"Ago","value":750},{"label":"Set","value":777},{"label":"Out","value":608},{"label":"Nov","value":568},{"label":"Dez","value":524}];
const MX = 902;
