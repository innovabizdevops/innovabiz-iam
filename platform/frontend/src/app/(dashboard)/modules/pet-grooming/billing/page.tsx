...
const ACCENT = "#f97316";
const MODULE = "Pet Grooming";
const PAGE = "Billing";
const KPIS = [{"l":"Total Pet Grooming","v":"895","t":"-5.9%","d":"down"},{"l":"Billing Ativos","v":"3.761","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"58","t":"+5.7%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Grooming #001","Pet Grooming #002","2.096","8.799","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Grooming #002","Pet Grooming #003","5.943","2.962","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Grooming #003","Pet Grooming #004","4.042","4.224","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Grooming #004","Pet Grooming #005","1.083","2.703","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Grooming #005","Pet Grooming #001","8.750","4.684","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":947},{"label":"Mar","value":875},{"label":"Abr","value":802},{"label":"Mai","value":915},{"label":"Jun","value":826},{"label":"Jul","value":858},{"label":"Ago","value":933},{"label":"Set","value":907},{"label":"Out","value":746},{"label":"Nov","value":1045},{"label":"Dez","value":824}];
const MX = 1045;
