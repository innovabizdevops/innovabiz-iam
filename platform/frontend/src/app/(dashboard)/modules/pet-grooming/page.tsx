...
const KPIS = [
    { label: "Total Registos", value: "4041", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2667", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€324K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "356997941", cells: ["PET-4941", "Pet Grooming Item 1", "14/6/2026", "€48 041"], status: "active" as const },
    { id: "357001512", cells: ["PET-8512", "Pet Grooming Item 2", "1/1/2026", "€1612"], status: "pending" as const },
    { id: "357005083", cells: ["PET-3083", "Pet Grooming Item 3", "16/8/2026", "€5183"], status: "completed" as const },
    { id: "357008654", cells: ["PET-6654", "Pet Grooming Item 4", "3/3/2026", "€8754"], status: "warning" as const },
    { id: "357012225", cells: ["PET-1225", "Pet Grooming Item 5", "18/10/2026", "€12 325"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Grooming</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Grooming</p>
                    </div>
                </div>
