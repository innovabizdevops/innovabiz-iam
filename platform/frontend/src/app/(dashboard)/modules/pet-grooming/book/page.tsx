...
const PAGE = "Book";
const KPIS = [{"l":"Total Pet Grooming","v":"1.574","t":"+6.6%","d":"up"},{"l":"Book Ativos","v":"8.903","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"88","t":"+8.7%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Grooming #001","Pet Grooming #002","444","4.532","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Grooming #002","Pet Grooming #003","7.808","5.776","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Grooming #003","Pet Grooming #004","980","6.193","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Grooming #004","Pet Grooming #005","8.753","3.475","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Grooming #005","Pet Grooming #001","2.931","6.867","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":327},{"label":"Mar","value":350},{"label":"Abr","value":383},{"label":"Mai","value":396},{"label":"Jun","value":494},{"label":"Jul","value":417},{"label":"Ago","value":520},{"label":"Set","value":576},{"label":"Out","value":379},{"label":"Nov","value":557},{"label":"Dez","value":581}];
const MX = 581;
