...
const KPIS = [{"l":"Integrações Ativas","v":"2.987","t":"+3.3%","d":"up"},{"l":"Chamadas/Hora","v":"4995","t":"+5.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"95.0%","t":"+15.0%","d":"up"},{"l":"Latência Média (ms)","v":"186ms","t":"+1.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.359","5.373","76.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.740","7.825","99.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.707","7.339","76.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","572","1.415","85.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.745","878","70.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":625},{"label":"Mar","value":727},{"label":"Abr","value":611},{"label":"Mai","value":755},{"label":"Jun","value":414},{"label":"Jul","value":747},{"label":"Ago","value":714},{"label":"Set","value":450},{"label":"Out","value":614},{"label":"Nov","value":762},{"label":"Dez","value":618}];
const MX = 762;
