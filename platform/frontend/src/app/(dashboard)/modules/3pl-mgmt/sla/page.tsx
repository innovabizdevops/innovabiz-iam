...
const ACCENT = "#6366f1";
const MODULE = "3PL Management";
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"1.446","t":"-4.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"93.4%","t":"-1.4%","d":"down"},{"l":"MTTR (h)","v":"75h","t":"+11.0%","d":"up"},{"l":"Satisfação (%)","v":"90.2%","t":"+0.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.682","8.462","8.406","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.593","8.252","2.046","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.404","408","8.043","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.473","5.507","5.997","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.049","6.071","3.140","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":918},{"label":"Mar","value":992},{"label":"Abr","value":680},{"label":"Mai","value":846},{"label":"Jun","value":961},{"label":"Jul","value":948},{"label":"Ago","value":805},{"label":"Set","value":778},{"label":"Out","value":1003},{"label":"Nov","value":832},{"label":"Dez","value":891}];
const MX = 1003;
