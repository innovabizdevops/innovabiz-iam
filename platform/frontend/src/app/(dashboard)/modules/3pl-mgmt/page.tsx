...
export default function P3plMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">3pl Mgmt</h1><p className="text-sm text-muted-foreground">3pl Mgmt • iBOS Enterprise</p></div>
