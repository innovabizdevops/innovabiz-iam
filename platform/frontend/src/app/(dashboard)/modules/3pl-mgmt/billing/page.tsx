...
const PAGE = "Billing";
const KPIS = [{"l":"Total 3pl Mgmt","v":"1.756","t":"+4.2%","d":"up"},{"l":"Billing Ativos","v":"1.403","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"65","t":"-5.2%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3pl Mgmt #001","3pl Mgmt #002","3.680","4.910","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["3pl Mgmt #002","3pl Mgmt #003","1.494","3.502","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["3pl Mgmt #003","3pl Mgmt #004","1.347","2.390","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["3pl Mgmt #004","3pl Mgmt #005","644","8.877","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["3pl Mgmt #005","3pl Mgmt #001","1.143","6.482","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":501},{"label":"Mar","value":393},{"label":"Abr","value":603},{"label":"Mai","value":320},{"label":"Jun","value":380},{"label":"Jul","value":657},{"label":"Ago","value":627},{"label":"Set","value":604},{"label":"Out","value":495},{"label":"Nov","value":468},{"label":"Dez","value":277}];
const MX = 657;
