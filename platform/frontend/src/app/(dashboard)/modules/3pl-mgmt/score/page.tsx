...
const KPIS = [{"l":"Total 3pl Mgmt","v":"7.353","t":"+11.5%","d":"up"},{"l":"Scorecard Ativos","v":"89","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"84","t":"-5.8%","d":"down"}];
const COLS = ["ID","Scorecard","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3pl Mgmt #001","74.2%","4.670","5.005","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["3pl Mgmt #002","95.7%","3.883","9.100","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["3pl Mgmt #003","92.1%","1.019","3.227","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["3pl Mgmt #004","84.9%","3.940","2.711","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["3pl Mgmt #005","76.4%","4.169","4.394","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":682},{"label":"Mar","value":789},{"label":"Abr","value":895},{"label":"Mai","value":850},{"label":"Jun","value":878},{"label":"Jul","value":798},{"label":"Ago","value":713},{"label":"Set","value":960},{"label":"Out","value":805},{"label":"Nov","value":708},{"label":"Dez","value":723}];
const MX = 960;
