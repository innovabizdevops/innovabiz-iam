...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"61","t":"+18.0%","d":"up"},{"l":"Engagement (%)","v":"76.5%","t":"+2.2%","d":"up"},{"l":"Turnover (%)","v":"79.9%","t":"+9.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.651","t":"-3.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","862","2026-03-24","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.738","2026-02-21","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.209","2026-02-24","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.238","2026-02-17","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.786","2026-02-21","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":959},{"label":"Fev","value":1028},{"label":"Mar","value":734},{"label":"Abr","value":817},{"label":"Mai","value":799},{"label":"Jun","value":704},{"label":"Jul","value":1053},{"label":"Ago","value":900},{"label":"Set","value":900},{"label":"Out","value":837},{"label":"Nov","value":867},{"label":"Dez","value":765}];
const MX = 1053;
