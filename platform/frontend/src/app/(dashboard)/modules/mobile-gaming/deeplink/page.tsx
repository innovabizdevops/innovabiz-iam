...
const ACCENT = "#059669";
const MODULE = "Mobile Gaming";
const PAGE = "Deep Link";
const KPIS = [{"l":"Total Mobile Gaming","v":"8.813","t":"+4.7%","d":"up"},{"l":"Deep Link Ativos","v":"8.850","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"61","t":"+2.6%","d":"up"}];
const COLS = ["ID","Deep Link","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mobile Gaming #001","Mobile Gaming #002","3.180","5.577","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Mobile Gaming #002","Mobile Gaming #003","4.468","8.895","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Mobile Gaming #003","Mobile Gaming #004","1.879","6.792","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mobile Gaming #004","Mobile Gaming #005","6.625","8.706","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mobile Gaming #005","Mobile Gaming #001","5.003","6.687","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":1048},{"label":"Mar","value":989},{"label":"Abr","value":718},{"label":"Mai","value":965},{"label":"Jun","value":913},{"label":"Jul","value":808},{"label":"Ago","value":960},{"label":"Set","value":923},{"label":"Out","value":994},{"label":"Nov","value":944},{"label":"Dez","value":943}];
const MX = 1048;
