...
const PAGE = "Push Notify";
const KPIS = [{"l":"Notificações Enviadas","v":"6.627","t":"+2.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"69.5%","t":"-5.1%","d":"down"},{"l":"Taxa Abertura (%)","v":"87.6%","t":"+13.6%","d":"up"},{"l":"Escalações","v":"6.351","t":"+17.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.781","87.5%","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.702","87.5%","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.529","87.6%","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.400","88.5%","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.197","77.7%","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":685},{"label":"Mar","value":571},{"label":"Abr","value":649},{"label":"Mai","value":607},{"label":"Jun","value":661},{"label":"Jul","value":667},{"label":"Ago","value":554},{"label":"Set","value":608},{"label":"Out","value":784},{"label":"Nov","value":814},{"label":"Dez","value":717}];
const MX = 814;
