...
const PAGE = "Ad Mediation";
const KPIS = [{"l":"Integrações Ativas","v":"355","t":"+1.5%","d":"up"},{"l":"Chamadas/Hora","v":"4335","t":"+9.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.0%","t":"+4.8%","d":"up"},{"l":"Latência Média (ms)","v":"141ms","t":"-4.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.952","7.504","84.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.428","8.636","90.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.422","5.961","91.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.790","3.060","81.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.828","3.579","83.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":657},{"label":"Mar","value":538},{"label":"Abr","value":819},{"label":"Mai","value":640},{"label":"Jun","value":682},{"label":"Jul","value":807},{"label":"Ago","value":882},{"label":"Set","value":743},{"label":"Out","value":880},{"label":"Nov","value":742},{"label":"Dez","value":773}];
const MX = 882;
