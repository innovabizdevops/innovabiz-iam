...
const PAGE = "Nurse";
const KPIS = [{"l":"Tickets Abertos","v":"1.185","t":"+3.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.3%","t":"-5.7%","d":"down"},{"l":"MTTR (h)","v":"152h","t":"+14.8%","d":"up"},{"l":"Satisfação (%)","v":"82.6%","t":"+5.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.042","4.406","5.925","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.804","5.619","6.912","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.245","2.849","6.356","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.965","4.141","8.643","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.883","1.678","2.050","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":592},{"label":"Mar","value":349},{"label":"Abr","value":580},{"label":"Mai","value":597},{"label":"Jun","value":285},{"label":"Jul","value":381},{"label":"Ago","value":569},{"label":"Set","value":546},{"label":"Out","value":590},{"label":"Nov","value":549},{"label":"Dez","value":369}];
const MX = 597;
