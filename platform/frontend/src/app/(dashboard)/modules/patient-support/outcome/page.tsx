...
const PAGE = "Outcome";
const KPIS = [{"l":"Tickets Abertos","v":"5.844","t":"+3.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.4%","t":"+13.7%","d":"up"},{"l":"MTTR (h)","v":"142h","t":"+7.1%","d":"up"},{"l":"Satisfação (%)","v":"68.2%","t":"-5.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.501","2.024","8.577","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.655","6.081","4.580","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.846","6.680","3.345","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.893","301","7.385","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.782","174","6.474","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":754},{"label":"Mar","value":581},{"label":"Abr","value":615},{"label":"Mai","value":506},{"label":"Jun","value":816},{"label":"Jul","value":616},{"label":"Ago","value":644},{"label":"Set","value":750},{"label":"Out","value":701},{"label":"Nov","value":848},{"label":"Dez","value":628}];
const MX = 848;
