...
const ACCENT = "#6366f1";
const MODULE = "Patient Support";
const PAGE = "Hub Service";
const KPIS = [{"l":"Tickets Abertos","v":"4.433","t":"-0.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"77.9%","t":"+5.6%","d":"up"},{"l":"MTTR (h)","v":"91h","t":"+14.3%","d":"up"},{"l":"Satisfação (%)","v":"79.9%","t":"+12.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.762","1.023","6.724","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.128","2.053","4.702","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.899","8.738","230","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","402","8.859","1.515","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","9.057","1.691","4.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":648},{"label":"Mar","value":570},{"label":"Abr","value":598},{"label":"Mai","value":740},{"label":"Jun","value":744},{"label":"Jul","value":646},{"label":"Ago","value":443},{"label":"Set","value":792},{"label":"Out","value":749},{"label":"Nov","value":817},{"label":"Dez","value":800}];
const MX = 817;
