...
const PAGE = "Copay";
const KPIS = [{"l":"Tickets Abertos","v":"5.440","t":"+8.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.1%","t":"+15.1%","d":"up"},{"l":"MTTR (h)","v":"23h","t":"+5.3%","d":"up"},{"l":"Satisfação (%)","v":"69.3%","t":"+14.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.095","7.215","3.948","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.710","487","2.337","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.480","7.181","1.276","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.392","4.063","7.292","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.165","823","7.896","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":564},{"label":"Mar","value":661},{"label":"Abr","value":540},{"label":"Mai","value":431},{"label":"Jun","value":520},{"label":"Jul","value":711},{"label":"Ago","value":515},{"label":"Set","value":622},{"label":"Out","value":660},{"label":"Nov","value":656},{"label":"Dez","value":624}];
const MX = 711;
