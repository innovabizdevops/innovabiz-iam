...
const KPIS = [{"l":"Tickets Abertos","v":"8.061","t":"+7.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.1%","t":"+6.4%","d":"up"},{"l":"MTTR (h)","v":"176h","t":"+13.9%","d":"up"},{"l":"Satisfação (%)","v":"83.5%","t":"+7.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.255","2.543","2.705","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.225","3.416","685","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.941","4.291","3.353","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.880","1.911","7.186","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.475","2.362","4.396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":793},{"label":"Mar","value":831},{"label":"Abr","value":639},{"label":"Mai","value":651},{"label":"Jun","value":744},{"label":"Jul","value":781},{"label":"Ago","value":993},{"label":"Set","value":806},{"label":"Out","value":752},{"label":"Nov","value":801},{"label":"Dez","value":1014}];
const MX = 1014;
