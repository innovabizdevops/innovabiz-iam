...
const PAGE = "Remediation";
const KPIS = [{"l":"Integrações Ativas","v":"1.487","t":"+8.5%","d":"up"},{"l":"Chamadas/Hora","v":"2055","t":"+11.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.6%","t":"+8.2%","d":"up"},{"l":"Latência Média (ms)","v":"155ms","t":"+3.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.524","3.832","76.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.499","2.686","73.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.009","7.897","99.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.079","8.688","94.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.252","4.247","77.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":661},{"label":"Mar","value":843},{"label":"Abr","value":841},{"label":"Mai","value":654},{"label":"Jun","value":758},{"label":"Jul","value":973},{"label":"Ago","value":627},{"label":"Set","value":803},{"label":"Out","value":974},{"label":"Nov","value":956},{"label":"Dez","value":866}];
const MX = 978;
