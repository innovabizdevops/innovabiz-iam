...
const KPIS = [{"l":"Riscos Identificados","v":"7.951","t":"+5.9%","d":"up"},{"l":"Mitigações Ativas","v":"7.953","t":"+7.3%","d":"up"},{"l":"Score Risco Geral","v":"70","t":"+2.1%","d":"up"},{"l":"Incidentes YTD","v":"4.066","t":"+10.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.262","6.513","6.272","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.871","6.663","419","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.577","4.110","4.088","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.850","1.873","8.745","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.068","3.782","3.282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":246},{"label":"Fev","value":271},{"label":"Mar","value":598},{"label":"Abr","value":213},{"label":"Mai","value":277},{"label":"Jun","value":399},{"label":"Jul","value":478},{"label":"Ago","value":544},{"label":"Set","value":499},{"label":"Out","value":421},{"label":"Nov","value":600},{"label":"Dez","value":559}];
const MX = 600;
