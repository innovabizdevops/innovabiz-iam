...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.554","t":"-1.9%","d":"down"},{"l":"NC Abertas","v":"2.480","t":"+0.4%","d":"up"},{"l":"Conformidade (%)","v":"88.6%","t":"+1.0%","d":"up"},{"l":"CAPAs Pendentes","v":"5.526","t":"-3.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.329","81.8%","1.149","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.132","91.7%","8.590","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.806","71.5%","5.070","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","501","79.5%","7.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.966","83.6%","2.923","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":239},{"label":"Fev","value":610},{"label":"Mar","value":569},{"label":"Abr","value":322},{"label":"Mai","value":598},{"label":"Jun","value":630},{"label":"Jul","value":603},{"label":"Ago","value":285},{"label":"Set","value":520},{"label":"Out","value":277},{"label":"Nov","value":451},{"label":"Dez","value":460}];
const MX = 630;
