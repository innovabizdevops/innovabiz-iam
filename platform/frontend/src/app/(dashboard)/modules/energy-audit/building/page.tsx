...
const PAGE = "Building";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.986","t":"+1.5%","d":"up"},{"l":"NC Abertas","v":"3.592","t":"+2.3%","d":"up"},{"l":"Conformidade (%)","v":"86.6%","t":"+3.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.611","t":"+8.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","306","98.7%","4.753","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.254","87.4%","503","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","888","81.3%","625","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.701","77.0%","7.288","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.215","73.7%","3.774","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":852},{"label":"Mar","value":771},{"label":"Abr","value":708},{"label":"Mai","value":768},{"label":"Jun","value":612},{"label":"Jul","value":874},{"label":"Ago","value":909},{"label":"Set","value":796},{"label":"Out","value":774},{"label":"Nov","value":648},{"label":"Dez","value":694}];
const MX = 963;
