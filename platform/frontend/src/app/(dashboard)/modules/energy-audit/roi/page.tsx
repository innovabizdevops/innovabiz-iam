...
const PAGE = "ROI";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.366","t":"+15.8%","d":"up"},{"l":"NC Abertas","v":"7.064","t":"-1.4%","d":"down"},{"l":"Conformidade (%)","v":"65.8%","t":"+13.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.788","t":"+10.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.426","83.9%","2.466","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.745","76.9%","6.625","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.735","90.2%","4.857","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","188","71.7%","388","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.028","82.2%","8.935","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":725},{"label":"Mar","value":508},{"label":"Abr","value":509},{"label":"Mai","value":719},{"label":"Jun","value":524},{"label":"Jul","value":766},{"label":"Ago","value":692},{"label":"Set","value":657},{"label":"Out","value":662},{"label":"Nov","value":444},{"label":"Dez","value":772}];
const MX = 772;
