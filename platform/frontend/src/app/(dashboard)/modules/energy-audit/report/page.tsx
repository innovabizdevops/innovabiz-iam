...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.769","t":"+17.6%","d":"up"},{"l":"NC Abertas","v":"3.428","t":"+8.0%","d":"up"},{"l":"Conformidade (%)","v":"72.2%","t":"+12.6%","d":"up"},{"l":"CAPAs Pendentes","v":"8.851","t":"-0.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","328","72.4%","2.471","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.566","75.9%","7.088","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.733","98.3%","3.531","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.702","78.9%","4.187","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","125","92.6%","971","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":511},{"label":"Mar","value":619},{"label":"Abr","value":512},{"label":"Mai","value":713},{"label":"Jun","value":459},{"label":"Jul","value":508},{"label":"Ago","value":403},{"label":"Set","value":397},{"label":"Out","value":564},{"label":"Nov","value":669},{"label":"Dez","value":512}];
const MX = 713;
