...
const ACCENT = "#6366f1";
const MODULE = "Energy Audit";
const PAGE = "Recommend";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.106","t":"+7.2%","d":"up"},{"l":"NC Abertas","v":"2.954","t":"+13.0%","d":"up"},{"l":"Conformidade (%)","v":"76.8%","t":"+7.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.702","t":"+15.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.067","85.3%","408","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.928","71.4%","8.474","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.310","81.1%","2.388","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.292","79.1%","3.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.040","96.6%","6.286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":760},{"label":"Mar","value":828},{"label":"Abr","value":759},{"label":"Mai","value":610},{"label":"Jun","value":662},{"label":"Jul","value":655},{"label":"Ago","value":819},{"label":"Set","value":517},{"label":"Out","value":623},{"label":"Nov","value":828},{"label":"Dez","value":574}];
const MX = 828;
