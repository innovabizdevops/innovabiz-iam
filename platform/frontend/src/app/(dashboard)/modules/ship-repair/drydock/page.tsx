...
const PAGE = "Drydock Sched";
const KPIS = [{"l":"Total Ship Repair","v":"4.168","t":"+12.5%","d":"up"},{"l":"Drydock Sched Ativos","v":"5.702","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"59","t":"+10.6%","d":"up"}];
const COLS = ["ID","Drydock Sched","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Repair #001","Ship Repair #002","2.047","1.482","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Repair #002","Ship Repair #003","6.382","583","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Repair #003","Ship Repair #004","5.137","1.709","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Repair #004","Ship Repair #005","844","775","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Repair #005","Ship Repair #001","574","3.274","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":616},{"label":"Mar","value":687},{"label":"Abr","value":500},{"label":"Mai","value":629},{"label":"Jun","value":837},{"label":"Jul","value":678},{"label":"Ago","value":696},{"label":"Set","value":625},{"label":"Out","value":558},{"label":"Nov","value":766},{"label":"Dez","value":822}];
const MX = 837;
