...
const PAGE = "Painting";
const KPIS = [{"l":"Total Ship Repair","v":"2.226","t":"+6.2%","d":"up"},{"l":"Painting Ativos","v":"8.280","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"78","t":"-6.0%","d":"down"}];
const COLS = ["ID","Painting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Repair #001","Ship Repair #002","690","1.153","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Repair #002","Ship Repair #003","6.463","2.432","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Repair #003","Ship Repair #004","8.737","4.674","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Repair #004","Ship Repair #005","1.333","840","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Repair #005","Ship Repair #001","470","5.649","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":665},{"label":"Mar","value":762},{"label":"Abr","value":633},{"label":"Mai","value":532},{"label":"Jun","value":474},{"label":"Jul","value":601},{"label":"Ago","value":569},{"label":"Set","value":829},{"label":"Out","value":612},{"label":"Nov","value":811},{"label":"Dez","value":552}];
const MX = 829;
