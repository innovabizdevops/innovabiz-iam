...
const PAGE = "Steel Work";
const KPIS = [{"l":"Total Ship Repair","v":"8.965","t":"+9.8%","d":"up"},{"l":"Steel Work Ativos","v":"4.150","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"82.6%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"81","t":"-4.2%","d":"down"}];
const COLS = ["ID","Steel Work","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Repair #001","Ship Repair #002","999","5.293","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Repair #002","Ship Repair #003","2.572","1.132","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Repair #003","Ship Repair #004","6.094","921","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Repair #004","Ship Repair #005","7.542","6.639","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Repair #005","Ship Repair #001","5.728","3.321","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":598},{"label":"Mar","value":636},{"label":"Abr","value":892},{"label":"Mai","value":709},{"label":"Jun","value":806},{"label":"Jul","value":778},{"label":"Ago","value":743},{"label":"Set","value":651},{"label":"Out","value":926},{"label":"Nov","value":918},{"label":"Dez","value":594}];
const MX = 926;
