...
const ACCENT = "#78350f";
const MODULE = "Ship Repair Yard";
const PAGE = "Work Scope";
const KPIS = [{"l":"Total Ship Repair","v":"2.698","t":"+3.9%","d":"up"},{"l":"Work Scope Ativos","v":"7.015","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"88","t":"+16.7%","d":"up"}];
const COLS = ["ID","Work Scope","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Repair #001","Ship Repair #002","2.182","4.474","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Repair #002","Ship Repair #003","2.647","8.103","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Repair #003","Ship Repair #004","5.881","4.064","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Repair #004","Ship Repair #005","7.250","8.284","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Repair #005","Ship Repair #001","272","1.105","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":698},{"label":"Mar","value":567},{"label":"Abr","value":730},{"label":"Mai","value":876},{"label":"Jun","value":515},{"label":"Jul","value":846},{"label":"Ago","value":796},{"label":"Set","value":574},{"label":"Out","value":661},{"label":"Nov","value":740},{"label":"Dez","value":549}];
const MX = 876;
