...
const PAGE = "Sea Trial";
const KPIS = [{"l":"Total Ship Repair","v":"6.496","t":"+0.5%","d":"up"},{"l":"Sea Trial Ativos","v":"724","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"94.0%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"82","t":"+0.4%","d":"up"}];
const COLS = ["ID","Sea Trial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ship Repair #001","Ship Repair #002","6.679","6.950","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ship Repair #002","Ship Repair #003","626","7.472","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Ship Repair #003","Ship Repair #004","1.981","936","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Ship Repair #004","Ship Repair #005","6.490","8.005","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ship Repair #005","Ship Repair #001","1.225","3.176","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":524},{"label":"Mar","value":426},{"label":"Abr","value":613},{"label":"Mai","value":324},{"label":"Jun","value":436},{"label":"Jul","value":448},{"label":"Ago","value":496},{"label":"Set","value":589},{"label":"Out","value":632},{"label":"Nov","value":543},{"label":"Dez","value":339}];
const MX = 632;
