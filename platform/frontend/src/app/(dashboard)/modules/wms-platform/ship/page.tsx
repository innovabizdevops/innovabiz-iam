...
const PAGE = "Ship";
const KPIS = [{"l":"Formulários Ativos","v":"7.899","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"597","t":"+15.5%","d":"up"},{"l":"Documentos Gerados","v":"8.115","t":"-4.1%","d":"down"},{"l":"Templates","v":"1.456","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.309","2026-01-04","3.234","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.099","2026-03-13","1.934","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","358","2026-03-08","8.821","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.202","2026-02-14","1.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.948","2026-03-19","4.871","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":606},{"label":"Mar","value":521},{"label":"Abr","value":727},{"label":"Mai","value":549},{"label":"Jun","value":732},{"label":"Jul","value":365},{"label":"Ago","value":671},{"label":"Set","value":558},{"label":"Out","value":430},{"label":"Nov","value":500},{"label":"Dez","value":427}];
const MX = 732;
