...
const ACCENT = "#1e3a5f";
const MODULE = "WMS Platform Deep";
const PAGE = "Pick";
const KPIS = [{"l":"Formulários Ativos","v":"9.053","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"4548","t":"+17.8%","d":"up"},{"l":"Documentos Gerados","v":"5.204","t":"+16.8%","d":"up"},{"l":"Templates","v":"1.652","t":"+2.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.167","2026-03-11","889","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.620","2026-01-06","431","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.008","2026-03-15","2.972","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.760","2026-01-02","5.059","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.033","2026-02-11","3.603","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":610},{"label":"Mar","value":308},{"label":"Abr","value":433},{"label":"Mai","value":398},{"label":"Jun","value":610},{"label":"Jul","value":639},{"label":"Ago","value":461},{"label":"Set","value":639},{"label":"Out","value":408},{"label":"Nov","value":634},{"label":"Dez","value":468}];
const MX = 645;
