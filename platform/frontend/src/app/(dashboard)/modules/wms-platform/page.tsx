...
/* ═══ WMS Platform Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "9954", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4957", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€366K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1230084854", cells: ["WMS-1854", "WMS Platform Deep Item 1", "27/3/2026", "€34 954"], status: "active" as const },
    { id: "1230088425", cells: ["WMS-5425", "WMS Platform Deep Item 2", "14/10/2026", "€38 525"], status: "pending" as const },
    { id: "1230091996", cells: ["WMS-8996", "WMS Platform Deep Item 3", "1/5/2026", "€42 096"], status: "completed" as const },
    { id: "1230095567", cells: ["WMS-3567", "WMS Platform Deep Item 4", "16/12/2026", "€45 667"], status: "warning" as const },
    { id: "1230099138", cells: ["WMS-7138", "WMS Platform Deep Item 5", "3/7/2026", "€49 238"], status: "active" as const },
];
...
export default function WmsPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">WMS Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • WMS Platform Deep</p>
                    </div>
                </div>
