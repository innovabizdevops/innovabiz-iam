...
const PAGE = "Receive";
const KPIS = [{"l":"Formulários Ativos","v":"7.470","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"3783","t":"+15.2%","d":"up"},{"l":"Documentos Gerados","v":"4.022","t":"-4.0%","d":"down"},{"l":"Templates","v":"1.855","t":"+13.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.603","2026-01-24","2.849","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","776","2026-02-05","8.098","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.723","2026-01-02","8.195","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.894","2026-01-11","3.489","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.198","2026-01-24","6.861","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":734},{"label":"Mar","value":955},{"label":"Abr","value":828},{"label":"Mai","value":897},{"label":"Jun","value":756},{"label":"Jul","value":915},{"label":"Ago","value":767},{"label":"Set","value":969},{"label":"Out","value":785},{"label":"Nov","value":854},{"label":"Dez","value":664}];
const MX = 969;
