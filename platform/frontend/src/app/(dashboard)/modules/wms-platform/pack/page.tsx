...
const PAGE = "Pack";
const KPIS = [{"l":"Formulários Ativos","v":"4.001","t":"+17.9%","d":"up"},{"l":"Submissões/Dia","v":"5016","t":"+4.9%","d":"up"},{"l":"Documentos Gerados","v":"900","t":"+17.3%","d":"up"},{"l":"Templates","v":"1.525","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","677","2026-03-13","6.346","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.852","2026-03-09","8.655","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.169","2026-02-01","1.711","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","915","2026-02-08","3.738","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.781","2026-02-04","6.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":818},{"label":"Mar","value":753},{"label":"Abr","value":567},{"label":"Mai","value":601},{"label":"Jun","value":544},{"label":"Jul","value":574},{"label":"Ago","value":531},{"label":"Set","value":507},{"label":"Out","value":480},{"label":"Nov","value":482},{"label":"Dez","value":639}];
const MX = 818;
