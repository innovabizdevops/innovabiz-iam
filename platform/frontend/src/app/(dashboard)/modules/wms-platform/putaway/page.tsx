...
const PAGE = "Put Away";
const KPIS = [{"l":"Formulários Ativos","v":"5.321","t":"+6.0%","d":"up"},{"l":"Submissões/Dia","v":"4376","t":"-1.4%","d":"down"},{"l":"Documentos Gerados","v":"4.290","t":"+8.9%","d":"up"},{"l":"Templates","v":"4.139","t":"+3.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.356","2026-01-16","8.980","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.848","2026-03-01","787","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.442","2026-03-27","1.375","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.628","2026-02-24","7.844","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.819","2026-01-27","8.646","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":687},{"label":"Mar","value":639},{"label":"Abr","value":700},{"label":"Mai","value":979},{"label":"Jun","value":876},{"label":"Jul","value":661},{"label":"Ago","value":683},{"label":"Set","value":732},{"label":"Out","value":1018},{"label":"Nov","value":802},{"label":"Dez","value":1030}];
const MX = 1030;
