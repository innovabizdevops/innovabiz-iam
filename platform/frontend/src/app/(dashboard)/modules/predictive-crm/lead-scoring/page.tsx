...
const PAGE = "Lead Scoring AI";
const KPIS = [{"l":"Integrações Ativas","v":"3.935","t":"+12.5%","d":"up"},{"l":"Chamadas/Hora","v":"3148","t":"+13.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.1%","t":"+10.2%","d":"up"},{"l":"Latência Média (ms)","v":"71ms","t":"-1.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.175","5.179","85.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.338","650","93.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.544","803","92.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.301","3.362","98.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.399","2.479","82.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":542},{"label":"Mar","value":449},{"label":"Abr","value":443},{"label":"Mai","value":742},{"label":"Jun","value":713},{"label":"Jul","value":573},{"label":"Ago","value":409},{"label":"Set","value":613},{"label":"Out","value":622},{"label":"Nov","value":384},{"label":"Dez","value":711}];
const MX = 742;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>ML</span></h1>
                </div>
