...
const ACCENT = "#f59e0b";
const MODULE = "Predictive CRM AI";
const PAGE = "Opportunity Insights";
const KPIS = [{"l":"Integrações Ativas","v":"5.371","t":"-2.3%","d":"down"},{"l":"Chamadas/Hora","v":"3423","t":"+17.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.2%","t":"+8.6%","d":"up"},{"l":"Latência Média (ms)","v":"8ms","t":"+12.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.623","2.710","75.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.973","2.896","74.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.419","4.866","99.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.154","4.307","70.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.704","4.030","70.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":586},{"label":"Mar","value":547},{"label":"Abr","value":588},{"label":"Mai","value":599},{"label":"Jun","value":486},{"label":"Jul","value":478},{"label":"Ago","value":628},{"label":"Set","value":808},{"label":"Out","value":801},{"label":"Nov","value":853},{"label":"Dez","value":587}];
const MX = 853;
...
export default function OppInsightsPage() {
    return (
