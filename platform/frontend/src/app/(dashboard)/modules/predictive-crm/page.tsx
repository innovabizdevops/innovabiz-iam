...
export default function PredictiveCrmPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Predictive Crm</h1><p className="text-sm text-muted-foreground">Predictive Crm • iBOS Enterprise</p></div>
