...
const PAGE = "Account Health";
const KPIS = [{"l":"Integrações Ativas","v":"3.890","t":"+15.8%","d":"up"},{"l":"Chamadas/Hora","v":"2693","t":"-0.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"70.4%","t":"+3.4%","d":"up"},{"l":"Latência Média (ms)","v":"172ms","t":"+7.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.850","598","81.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.611","7.378","72.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","832","3.426","70.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.170","1.692","81.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.186","3.515","91.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":593},{"label":"Mar","value":503},{"label":"Abr","value":594},{"label":"Mai","value":642},{"label":"Jun","value":438},{"label":"Jul","value":448},{"label":"Ago","value":536},{"label":"Set","value":732},{"label":"Out","value":600},{"label":"Nov","value":610},{"label":"Dez","value":677}];
const MX = 732;
