...
const KPIS = [{"l":"Integrações Ativas","v":"2.427","t":"+16.7%","d":"up"},{"l":"Chamadas/Hora","v":"2417","t":"+10.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.0%","t":"+6.1%","d":"up"},{"l":"Latência Média (ms)","v":"81ms","t":"+4.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.867","1.850","84.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.934","5.243","96.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.297","2.528","80.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.777","484","79.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.550","9.063","77.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":746},{"label":"Mar","value":401},{"label":"Abr","value":677},{"label":"Mai","value":691},{"label":"Jun","value":767},{"label":"Jul","value":739},{"label":"Ago","value":639},{"label":"Set","value":597},{"label":"Out","value":606},{"label":"Nov","value":572},{"label":"Dez","value":578}];
const MX = 767;
