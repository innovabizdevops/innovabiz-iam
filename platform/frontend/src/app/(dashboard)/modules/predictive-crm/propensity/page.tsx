...
const PAGE = "Propensity Models";
const KPIS = [{"l":"Integrações Ativas","v":"2.889","t":"+1.6%","d":"up"},{"l":"Chamadas/Hora","v":"3589","t":"+7.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.5%","t":"-4.7%","d":"down"},{"l":"Latência Média (ms)","v":"98ms","t":"+13.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.691","2.273","79.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.564","2.940","94.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.455","8.376","80.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.339","3.944","83.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.677","6.351","83.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":617},{"label":"Mar","value":676},{"label":"Abr","value":732},{"label":"Mai","value":464},{"label":"Jun","value":472},{"label":"Jul","value":708},{"label":"Ago","value":555},{"label":"Set","value":753},{"label":"Out","value":534},{"label":"Nov","value":599},{"label":"Dez","value":818}];
const MX = 818;
