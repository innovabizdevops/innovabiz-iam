...
const PAGE = "Revenue Forecast AI";
const KPIS = [{"l":"ARR (€M)","v":"€15.2M","t":"+5.9%","d":"up"},{"l":"MRR (€)","v":"€63135","t":"+17.6%","d":"up"},{"l":"Churn (%)","v":"78.1%","t":"+0.8%","d":"up"},{"l":"ARPU (€)","v":"€13171","t":"-5.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32758.53","6.081","€ 22775.07","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 7777.47","7.589","€ 32956.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12935.22","5.841","€ 2404.49","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 10102.78","2.921","€ 20407.36","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45131.70","2.540","€ 9368.14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":745},{"label":"Mar","value":797},{"label":"Abr","value":819},{"label":"Mai","value":646},{"label":"Jun","value":571},{"label":"Jul","value":873},{"label":"Ago","value":548},{"label":"Set","value":748},{"label":"Out","value":683},{"label":"Nov","value":556},{"label":"Dez","value":701}];
const MX = 873;
