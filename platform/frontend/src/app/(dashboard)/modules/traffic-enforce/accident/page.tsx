...
const PAGE = "Accident";
const KPIS = [{"l":"Incidentes (YTD)","v":"8.647","t":"+4.4%","d":"up"},{"l":"LTIR","v":"6.209","t":"-6.0%","d":"down"},{"l":"Formações HSE","v":"7.122","t":"+13.8%","d":"up"},{"l":"Inspeções Realizadas","v":"8.628","t":"-5.3%","d":"down"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","4.552","5.905","4.023","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","2.367","8.144","9.096","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","7.277","2.472","3.789","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","4.901","1.943","7.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","1.624","4.719","8.556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":362},{"label":"Mar","value":673},{"label":"Abr","value":678},{"label":"Mai","value":372},{"label":"Jun","value":501},{"label":"Jul","value":616},{"label":"Ago","value":516},{"label":"Set","value":660},{"label":"Out","value":624},{"label":"Nov","value":397},{"label":"Dez","value":638}];
const MX = 690;
