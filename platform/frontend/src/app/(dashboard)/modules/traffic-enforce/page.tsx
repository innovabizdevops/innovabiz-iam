...
export default function TrafficEnforcePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Traffic Enforce</h1><p className="text-sm text-muted-foreground">Traffic Enforce • iBOS Enterprise</p></div>
