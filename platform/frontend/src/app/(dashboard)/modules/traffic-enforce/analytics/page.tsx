...
const KPIS = [{"l":"Dashboards Ativos","v":"7.836","t":"+0.9%","d":"up"},{"l":"Queries/Dia","v":"3200","t":"+1.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.108","t":"+7.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.125","t":"+14.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2218","2026-02-02","5.132","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4415","2026-02-08","6.143","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1784","2026-01-25","6.902","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2856","2026-02-15","5.483","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1916","2026-03-03","1.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":461},{"label":"Mar","value":613},{"label":"Abr","value":404},{"label":"Mai","value":425},{"label":"Jun","value":452},{"label":"Jul","value":740},{"label":"Ago","value":543},{"label":"Set","value":532},{"label":"Out","value":598},{"label":"Nov","value":480},{"label":"Dez","value":438}];
const MX = 740;
