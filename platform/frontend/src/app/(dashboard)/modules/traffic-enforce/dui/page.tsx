...
const PAGE = "DUI";
const KPIS = [{"l":"Total Traffic Enforce","v":"926","t":"-3.9%","d":"down"},{"l":"DUI Ativos","v":"8.433","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"64","t":"+9.5%","d":"up"}];
const COLS = ["ID","DUI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Traffic Enforce #001","Traffic Enforce #002","3.566","4.139","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Traffic Enforce #002","Traffic Enforce #003","8.661","6.420","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Traffic Enforce #003","Traffic Enforce #004","7.112","2.050","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Traffic Enforce #004","Traffic Enforce #005","5.945","1.955","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Traffic Enforce #005","Traffic Enforce #001","8.036","458","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":911},{"label":"Mar","value":780},{"label":"Abr","value":951},{"label":"Mai","value":784},{"label":"Jun","value":700},{"label":"Jul","value":834},{"label":"Ago","value":864},{"label":"Set","value":685},{"label":"Out","value":702},{"label":"Nov","value":1072},{"label":"Dez","value":808}];
const MX = 1072;
