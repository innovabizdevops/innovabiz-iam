...
const PAGE = "Citation";
const KPIS = [{"l":"Total Traffic Enforce","v":"6.487","t":"+13.9%","d":"up"},{"l":"Citation Ativos","v":"4.012","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+1.9%","d":"up"}];
const COLS = ["ID","Citation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Traffic Enforce #001","Traffic Enforce #002","6.450","162","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Traffic Enforce #002","Traffic Enforce #003","6.209","8.658","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Traffic Enforce #003","Traffic Enforce #004","2.665","6.886","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Traffic Enforce #004","Traffic Enforce #005","2.560","4.210","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Traffic Enforce #005","Traffic Enforce #001","5.191","5.033","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":631},{"label":"Mar","value":474},{"label":"Abr","value":360},{"label":"Mai","value":725},{"label":"Jun","value":538},{"label":"Jul","value":593},{"label":"Ago","value":686},{"label":"Set","value":610},{"label":"Out","value":598},{"label":"Nov","value":699},{"label":"Dez","value":412}];
const MX = 725;
