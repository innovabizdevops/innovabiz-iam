...
const ACCENT = "#6366f1";
const MODULE = "Traffic Enforcement";
const PAGE = "Speed Camera";
const KPIS = [{"l":"Total Traffic Enforce","v":"8.145","t":"+6.6%","d":"up"},{"l":"Speed Camera Ativos","v":"8.332","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"58","t":"+17.8%","d":"up"}];
const COLS = ["ID","Speed Camera","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Traffic Enforce #001","Traffic Enforce #002","7.757","1.714","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Traffic Enforce #002","Traffic Enforce #003","2.870","7.804","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Traffic Enforce #003","Traffic Enforce #004","223","1.929","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Traffic Enforce #004","Traffic Enforce #005","6.720","6.008","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Traffic Enforce #005","Traffic Enforce #001","3.498","6.961","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":287},{"label":"Fev","value":577},{"label":"Mar","value":258},{"label":"Abr","value":561},{"label":"Mai","value":384},{"label":"Jun","value":328},{"label":"Jul","value":244},{"label":"Ago","value":507},{"label":"Set","value":265},{"label":"Out","value":265},{"label":"Nov","value":519},{"label":"Dez","value":302}];
const MX = 577;
