...
const KPIS = [{"l":"eNPS","v":"93","t":"+3.3%","d":"up"},{"l":"Engagement (%)","v":"94.0%","t":"+0.6%","d":"up"},{"l":"Turnover (%)","v":"85.6%","t":"+11.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.104","t":"+9.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.258","2026-01-09","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.735","2026-01-15","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.284","2026-03-19","88","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.972","2026-03-15","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.624","2026-03-05","93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":546},{"label":"Mar","value":734},{"label":"Abr","value":729},{"label":"Mai","value":748},{"label":"Jun","value":600},{"label":"Jul","value":683},{"label":"Ago","value":825},{"label":"Set","value":551},{"label":"Out","value":831},{"label":"Nov","value":705},{"label":"Dez","value":559}];
const MX = 831;
