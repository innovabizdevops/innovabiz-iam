...
const KPIS = [{"l":"Total Aml Kyc","v":"3.074","t":"+12.5%","d":"up"},{"l":"Monitoring Ativos","v":"6.068","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"89","t":"+10.3%","d":"up"}];
const COLS = ["ID","Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aml Kyc #001","Aml Kyc #002","4.122","6.968","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Aml Kyc #002","Aml Kyc #003","861","1.061","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aml Kyc #003","Aml Kyc #004","4.260","6.710","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Aml Kyc #004","Aml Kyc #005","715","6.283","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aml Kyc #005","Aml Kyc #001","7.562","4.710","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1027},{"label":"Fev","value":977},{"label":"Mar","value":768},{"label":"Abr","value":967},{"label":"Mai","value":951},{"label":"Jun","value":927},{"label":"Jul","value":786},{"label":"Ago","value":973},{"label":"Set","value":957},{"label":"Out","value":734},{"label":"Nov","value":735},{"label":"Dez","value":770}];
const MX = 1027;
