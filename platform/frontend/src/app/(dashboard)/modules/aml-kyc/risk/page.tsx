...
const PAGE = "Risk Rate";
const KPIS = [{"l":"Riscos Identificados","v":"4.573","t":"+0.1%","d":"up"},{"l":"Mitigações Ativas","v":"5.720","t":"+15.2%","d":"up"},{"l":"Score Risco Geral","v":"62","t":"-4.4%","d":"down"},{"l":"Incidentes YTD","v":"4.758","t":"+0.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.415","619","5.041","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.443","1.961","5.368","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","536","5.017","4.998","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.730","7.265","7.825","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.935","4.513","5.860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":422},{"label":"Mar","value":535},{"label":"Abr","value":604},{"label":"Mai","value":571},{"label":"Jun","value":653},{"label":"Jul","value":579},{"label":"Ago","value":447},{"label":"Set","value":310},{"label":"Out","value":503},{"label":"Nov","value":590},{"label":"Dez","value":309}];
const MX = 653;
