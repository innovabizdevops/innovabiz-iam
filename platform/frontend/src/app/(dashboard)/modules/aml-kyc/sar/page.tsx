...
const PAGE = "SAR";
const KPIS = [{"l":"Total Aml Kyc","v":"6.765","t":"+14.1%","d":"up"},{"l":"SAR Ativos","v":"7.009","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"75","t":"-2.9%","d":"down"}];
const COLS = ["ID","SAR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aml Kyc #001","Aml Kyc #002","6.401","6.843","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Aml Kyc #002","Aml Kyc #003","1.676","3.157","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Aml Kyc #003","Aml Kyc #004","7.978","4.651","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Aml Kyc #004","Aml Kyc #005","7.561","1.671","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aml Kyc #005","Aml Kyc #001","5.254","4.497","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":918},{"label":"Mar","value":815},{"label":"Abr","value":807},{"label":"Mai","value":922},{"label":"Jun","value":690},{"label":"Jul","value":1001},{"label":"Ago","value":1007},{"label":"Set","value":895},{"label":"Out","value":657},{"label":"Nov","value":1032},{"label":"Dez","value":757}];
const MX = 1032;
