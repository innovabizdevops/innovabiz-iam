...
const ACCENT = "#6366f1";
const MODULE = "AML & KYC";
const PAGE = "Screening";
const KPIS = [{"l":"Total Aml Kyc","v":"783","t":"+11.0%","d":"up"},{"l":"Screening Ativos","v":"3.680","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"81.0%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"64","t":"+15.7%","d":"up"}];
const COLS = ["ID","Screening","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aml Kyc #001","Aml Kyc #002","572","3.177","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Aml Kyc #002","Aml Kyc #003","5.257","8.434","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Aml Kyc #003","Aml Kyc #004","7.378","6.189","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Aml Kyc #004","Aml Kyc #005","657","6.460","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aml Kyc #005","Aml Kyc #001","4.229","4.351","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":764},{"label":"Mar","value":629},{"label":"Abr","value":746},{"label":"Mai","value":699},{"label":"Jun","value":857},{"label":"Jul","value":963},{"label":"Ago","value":952},{"label":"Set","value":1006},{"label":"Out","value":797},{"label":"Nov","value":652},{"label":"Dez","value":848}];
const MX = 1006;
