...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"510","t":"+8.5%","d":"up"},{"l":"NC Abertas","v":"6.210","t":"+6.0%","d":"up"},{"l":"Conformidade (%)","v":"76.9%","t":"-2.3%","d":"down"},{"l":"CAPAs Pendentes","v":"898","t":"+17.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","976","96.4%","8.708","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.680","77.5%","8.890","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.396","78.8%","2.729","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.504","93.5%","5.666","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.378","77.8%","1.493","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":711},{"label":"Mar","value":762},{"label":"Abr","value":913},{"label":"Mai","value":546},{"label":"Jun","value":867},{"label":"Jul","value":722},{"label":"Ago","value":853},{"label":"Set","value":671},{"label":"Out","value":914},{"label":"Nov","value":574},{"label":"Dez","value":912}];
const MX = 914;
