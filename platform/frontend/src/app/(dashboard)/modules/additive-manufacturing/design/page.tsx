...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"892","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"3970","t":"+9.3%","d":"up"},{"l":"Documentos Gerados","v":"4.570","t":"-4.4%","d":"down"},{"l":"Templates","v":"7.368","t":"-3.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.433","2026-03-15","3.430","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.680","2026-02-27","5.764","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.085","2026-01-28","1.125","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.858","2026-03-06","561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.332","2026-02-20","8.918","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":797},{"label":"Mar","value":697},{"label":"Abr","value":870},{"label":"Mai","value":701},{"label":"Jun","value":673},{"label":"Jul","value":842},{"label":"Ago","value":534},{"label":"Set","value":487},{"label":"Out","value":508},{"label":"Nov","value":760},{"label":"Dez","value":564}];
const MX = 870;
