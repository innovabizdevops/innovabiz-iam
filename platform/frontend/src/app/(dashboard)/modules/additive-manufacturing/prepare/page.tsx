...
const PAGE = "Prepare";
const KPIS = [{"l":"Total Additive Manufacturing","v":"1.729","t":"+8.0%","d":"up"},{"l":"Prepare Ativos","v":"6.400","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"89.1%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"86","t":"-1.8%","d":"down"}];
const COLS = ["ID","Prepare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Additive Manufacturing #001","Additive Manufacturing #002","716","3.478","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Additive Manufacturing #002","Additive Manufacturing #003","4.776","2.991","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Additive Manufacturing #003","Additive Manufacturing #004","5.851","8.948","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Additive Manufacturing #004","Additive Manufacturing #005","6.697","4.310","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Additive Manufacturing #005","Additive Manufacturing #001","6.313","8.304","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":650},{"label":"Mar","value":782},{"label":"Abr","value":786},{"label":"Mai","value":482},{"label":"Jun","value":499},{"label":"Jul","value":777},{"label":"Ago","value":767},{"label":"Set","value":649},{"label":"Out","value":559},{"label":"Nov","value":528},{"label":"Dez","value":580}];
const MX = 786;
