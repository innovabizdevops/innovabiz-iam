...
const ACCENT = "#b45309";
const MODULE = "Additive Manufacturing (3D)";
const PAGE = "Print";
const KPIS = [{"l":"Total Additive Manufacturing","v":"6.409","t":"+11.6%","d":"up"},{"l":"Print Ativos","v":"3.074","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"84","t":"-3.9%","d":"down"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Additive Manufacturing #001","Additive Manufacturing #002","2.756","4.664","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Additive Manufacturing #002","Additive Manufacturing #003","6.364","3.038","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Additive Manufacturing #003","Additive Manufacturing #004","4.429","1.392","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Additive Manufacturing #004","Additive Manufacturing #005","5.454","8.771","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Additive Manufacturing #005","Additive Manufacturing #001","4.860","663","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":444},{"label":"Mar","value":636},{"label":"Abr","value":441},{"label":"Mai","value":547},{"label":"Jun","value":605},{"label":"Jul","value":490},{"label":"Ago","value":280},{"label":"Set","value":355},{"label":"Out","value":514},{"label":"Nov","value":560},{"label":"Dez","value":471}];
const MX = 636;
