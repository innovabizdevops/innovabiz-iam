...
const PAGE = "Post-Process";
const KPIS = [{"l":"Pedidos/Dia","v":"1052","t":"+6.7%","d":"up"},{"l":"GMV (€)","v":"€31391","t":"-4.4%","d":"down"},{"l":"Conversão (%)","v":"78.0%","t":"+7.7%","d":"up"},{"l":"AOV (€)","v":"€19371","t":"+2.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 44594.48","8.378","8.648","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 31840.12","8.107","1.921","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 48453.26","1.082","3.820","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 37399.66","4.008","1.612","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 9424.87","372","1.940","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1055},{"label":"Fev","value":788},{"label":"Mar","value":871},{"label":"Abr","value":902},{"label":"Mai","value":797},{"label":"Jun","value":987},{"label":"Jul","value":711},{"label":"Ago","value":870},{"label":"Set","value":832},{"label":"Out","value":874},{"label":"Nov","value":1010},{"label":"Dez","value":778}];
const MX = 1055;
