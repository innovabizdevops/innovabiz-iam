...
/* ═══ Additive Manufacturing (3D) — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "6820", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "306", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€241K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1851494820", cells: ["ADD-6820", "Additive Manufacturing (3D) Item 1", "1/1/2026", "€44 920"], status: "active" as const },
    { id: "1851498391", cells: ["ADD-1391", "Additive Manufacturing (3D) Item 2", "16/8/2026", "€48 491"], status: "pending" as const },
    { id: "1851501962", cells: ["ADD-4962", "Additive Manufacturing (3D) Item 3", "3/3/2026", "€2062"], status: "completed" as const },
    { id: "1851505533", cells: ["ADD-8533", "Additive Manufacturing (3D) Item 4", "18/10/2026", "€5633"], status: "warning" as const },
    { id: "1851509104", cells: ["ADD-3104", "Additive Manufacturing (3D) Item 5", "5/5/2026", "€9204"], status: "active" as const },
];
...
export default function AdditiveManufacturing3dPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Additive Manufacturing (3D)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Additive Manufacturing (3D)</p>
                    </div>
                </div>
