...
/* ═══ Rubber & Plastics — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "4719", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "647", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€362K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1168689719", cells: ["RUB-4719", "Rubber & Plastics Item 1", "16/12/2026", "€39 819"], status: "active" as const },
    { id: "1168693290", cells: ["RUB-8290", "Rubber & Plastics Item 2", "3/7/2026", "€43 390"], status: "pending" as const },
    { id: "1168696861", cells: ["RUB-2861", "Rubber & Plastics Item 3", "18/2/2026", "€46 961"], status: "completed" as const },
    { id: "1168700432", cells: ["RUB-6432", "Rubber & Plastics Item 4", "5/9/2026", "€532"], status: "warning" as const },
    { id: "1168704003", cells: ["RUB-1003", "Rubber & Plastics Item 5", "20/4/2026", "€4103"], status: "active" as const },
];
...
export default function RubberPlasticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rubber & Plastics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Rubber & Plastics</p>
                    </div>
                </div>
