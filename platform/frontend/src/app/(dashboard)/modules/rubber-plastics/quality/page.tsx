...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"271","t":"+13.9%","d":"up"},{"l":"NC Abertas","v":"8.854","t":"+9.2%","d":"up"},{"l":"Conformidade (%)","v":"91.4%","t":"+12.9%","d":"up"},{"l":"CAPAs Pendentes","v":"1.769","t":"-5.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.403","97.9%","8.747","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.866","73.5%","2.328","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.244","90.8%","8.168","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.637","84.0%","7.625","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.324","99.8%","8.937","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":844},{"label":"Mar","value":679},{"label":"Abr","value":793},{"label":"Mai","value":804},{"label":"Jun","value":887},{"label":"Jul","value":669},{"label":"Ago","value":845},{"label":"Set","value":828},{"label":"Out","value":670},{"label":"Nov","value":873},{"label":"Dez","value":820}];
const MX = 923;
