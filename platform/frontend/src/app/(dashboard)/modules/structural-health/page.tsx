...
const KPIS = [
    { label: "Total Registos", value: "9989", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3337", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€62K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1522243789", cells: ["STR-2789", "Structural Health Monitoring Item 1", "18/2/2026", "€43 889"], status: "active" as const },
    { id: "1522247360", cells: ["STR-6360", "Structural Health Monitoring Item 2", "5/9/2026", "€47 460"], status: "pending" as const },
    { id: "1522250931", cells: ["STR-9931", "Structural Health Monitoring Item 3", "20/4/2026", "€1031"], status: "completed" as const },
    { id: "1522254502", cells: ["STR-4502", "Structural Health Monitoring Item 4", "7/11/2026", "€4602"], status: "warning" as const },
    { id: "1522258073", cells: ["STR-8073", "Structural Health Monitoring Item 5", "22/6/2026", "€8173"], status: "active" as const },
];
...
export default function StructuralHealthMonitoringPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Structural Health Monitoring</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Structural Health Monitoring</p>
                    </div>
                </div>
