...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"3.212","t":"-3.9%","d":"down"},{"l":"Taxa Entrega (%)","v":"83.0%","t":"+1.6%","d":"up"},{"l":"Taxa Abertura (%)","v":"78.5%","t":"+6.6%","d":"up"},{"l":"Escalações","v":"3.703","t":"+9.7%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.696","87.2%","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.773","89.0%","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.134","96.7%","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.963","98.6%","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.361","74.6%","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":756},{"label":"Mar","value":532},{"label":"Abr","value":681},{"label":"Mai","value":493},{"label":"Jun","value":435},{"label":"Jul","value":646},{"label":"Ago","value":811},{"label":"Set","value":639},{"label":"Out","value":614},{"label":"Nov","value":801},{"label":"Dez","value":490}];
const MX = 811;
