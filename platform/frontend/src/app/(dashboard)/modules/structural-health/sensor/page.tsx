...
const PAGE = "Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"6.865","t":"+15.5%","d":"up"},{"l":"Dados/Min (MB)","v":"7.206","t":"+3.2%","d":"up"},{"l":"Alertas Ativos","v":"2.021","t":"-2.2%","d":"down"},{"l":"Uptime (%)","v":"78.2%","t":"+15.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.111","5.428","195","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.400","6.663","7.221","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.147","1.423","737","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.304","6.423","7.373","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.348","8.859","8.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":405},{"label":"Mar","value":361},{"label":"Abr","value":489},{"label":"Mai","value":302},{"label":"Jun","value":378},{"label":"Jul","value":332},{"label":"Ago","value":556},{"label":"Set","value":438},{"label":"Out","value":425},{"label":"Nov","value":380},{"label":"Dez","value":634}];
const MX = 634;
