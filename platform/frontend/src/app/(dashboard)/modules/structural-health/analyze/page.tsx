...
const ACCENT = "#0369a1";
const MODULE = "Structural Health Monitoring";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"3.987","t":"-2.3%","d":"down"},{"l":"Queries/Dia","v":"4977","t":"+14.2%","d":"up"},{"l":"Dados Processados (GB)","v":"944","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"6.159","t":"-5.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2608","2026-01-18","4.686","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4782","2026-02-21","2.317","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4072","2026-01-27","6.944","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","450","2026-01-15","4.281","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2414","2026-03-01","5.769","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":738},{"label":"Mar","value":544},{"label":"Abr","value":697},{"label":"Mai","value":862},{"label":"Jun","value":540},{"label":"Jul","value":792},{"label":"Ago","value":681},{"label":"Set","value":593},{"label":"Out","value":510},{"label":"Nov","value":663},{"label":"Dez","value":802}];
const MX = 862;
