...
const PAGE = "BIA";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.929","t":"-3.2%","d":"down"},{"l":"RTO Médio (h)","v":"210h","t":"-0.1%","d":"down"},{"l":"RPO Médio (h)","v":"193h","t":"+12.9%","d":"up"},{"l":"Testes DR (YTD)","v":"5.042","t":"+9.2%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","31h","128h","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","81h","65h","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","39h","68h","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","124h","175h","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","54h","151h","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":596},{"label":"Mar","value":777},{"label":"Abr","value":765},{"label":"Mai","value":753},{"label":"Jun","value":798},{"label":"Jul","value":763},{"label":"Ago","value":650},{"label":"Set","value":647},{"label":"Out","value":539},{"label":"Nov","value":530},{"label":"Dez","value":873}];
const MX = 873;
