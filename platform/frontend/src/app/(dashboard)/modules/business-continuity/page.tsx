...
/* ═══ Business Continuity (ISO 22301) — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "6264", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1139", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€218K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1910923964", cells: ["BUS-8964", "Business Continuity (ISO 22301) Item 1", "13/9/2026", "€24 064"], status: "active" as const },
    { id: "1910927535", cells: ["BUS-3535", "Business Continuity (ISO 22301) Item 2", "28/4/2026", "€27 635"], status: "pending" as const },
    { id: "1910931106", cells: ["BUS-7106", "Business Continuity (ISO 22301) Item 3", "15/11/2026", "€31 206"], status: "completed" as const },
    { id: "1910934677", cells: ["BUS-1677", "Business Continuity (ISO 22301) Item 4", "2/6/2026", "€34 777"], status: "warning" as const },
    { id: "1910938248", cells: ["BUS-5248", "Business Continuity (ISO 22301) Item 5", "17/1/2026", "€38 348"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 64 }, { label: "Fev", value: 73 }, { label: "Mar", value: 82 }, { label: "Abr", value: 91 }, { label: "Mai", value: 20 }, { label: "Jun", value: 29 }];
...
export default function BusinessContinuityIso22301Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Business Continuity (ISO 22301)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Business Continuity (ISO 22301)</p>
                    </div>
                </div>
