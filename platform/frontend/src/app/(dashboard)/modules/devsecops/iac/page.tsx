...
const PAGE = "IaC Scan";
const KPIS = [{"l":"Total Devsecops","v":"4.459","t":"+17.5%","d":"up"},{"l":"IaC Scan Ativos","v":"8.566","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+8.0%","d":"up"}];
const COLS = ["ID","IaC Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops #001","Devsecops #002","8.613","2.097","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops #002","Devsecops #003","5.065","3.178","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops #003","Devsecops #004","5.753","5.687","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops #004","Devsecops #005","4.374","5.655","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops #005","Devsecops #001","3.472","4.904","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":855},{"label":"Mar","value":858},{"label":"Abr","value":736},{"label":"Mai","value":952},{"label":"Jun","value":668},{"label":"Jul","value":632},{"label":"Ago","value":636},{"label":"Set","value":816},{"label":"Out","value":885},{"label":"Nov","value":708},{"label":"Dez","value":838}];
const MX = 952;
