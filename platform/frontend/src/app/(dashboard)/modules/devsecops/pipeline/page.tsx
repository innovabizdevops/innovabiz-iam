...
const PAGE = "Pipeline Gate";
const KPIS = [{"l":"Total Devsecops","v":"4.803","t":"+8.1%","d":"up"},{"l":"Pipeline Gate Ativos","v":"7.418","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"94.0%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"67","t":"+8.4%","d":"up"}];
const COLS = ["ID","Pipeline Gate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops #001","Devsecops #002","3.617","2.659","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops #002","Devsecops #003","7.488","1.130","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops #003","Devsecops #004","4.035","5.134","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops #004","Devsecops #005","2.077","7.091","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops #005","Devsecops #001","5.151","2.662","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1063},{"label":"Fev","value":1020},{"label":"Mar","value":863},{"label":"Abr","value":758},{"label":"Mai","value":686},{"label":"Jun","value":751},{"label":"Jul","value":1008},{"label":"Ago","value":1064},{"label":"Set","value":860},{"label":"Out","value":834},{"label":"Nov","value":985},{"label":"Dez","value":979}];
const MX = 1064;
