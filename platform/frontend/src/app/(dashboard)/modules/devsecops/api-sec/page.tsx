...
const KPIS = [{"l":"Integrações Ativas","v":"6.719","t":"+8.2%","d":"up"},{"l":"Chamadas/Hora","v":"1585","t":"+17.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.5%","t":"+6.5%","d":"up"},{"l":"Latência Média (ms)","v":"53ms","t":"+9.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.032","1.572","93.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.926","5.853","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.439","8.410","77.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.264","429","71.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.673","5.725","75.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":698},{"label":"Mar","value":604},{"label":"Abr","value":974},{"label":"Mai","value":718},{"label":"Jun","value":849},{"label":"Jul","value":782},{"label":"Ago","value":721},{"label":"Set","value":633},{"label":"Out","value":631},{"label":"Nov","value":983},{"label":"Dez","value":759}];
const MX = 983;
