...
const ACCENT = "#059669";
const MODULE = "DevSecOps";
const PAGE = "Supply Chain Sec";
const KPIS = [{"l":"Total Devsecops","v":"5.283","t":"+13.0%","d":"up"},{"l":"Supply Chain Sec Ativos","v":"7.752","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"58","t":"+6.2%","d":"up"}];
const COLS = ["ID","Supply Chain Sec","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops #001","Devsecops #002","4.696","1.490","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops #002","Devsecops #003","4.695","3.265","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops #003","Devsecops #004","3.960","5.869","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops #004","Devsecops #005","2.923","3.975","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops #005","Devsecops #001","1.217","6.214","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":533},{"label":"Mar","value":784},{"label":"Abr","value":432},{"label":"Mai","value":707},{"label":"Jun","value":602},{"label":"Jul","value":560},{"label":"Ago","value":515},{"label":"Set","value":595},{"label":"Out","value":667},{"label":"Nov","value":702},{"label":"Dez","value":515}];
const MX = 784;
