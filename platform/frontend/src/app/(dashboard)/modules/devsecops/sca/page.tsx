...
const PAGE = "SCA Scan";
const KPIS = [{"l":"Total Devsecops","v":"1.981","t":"-1.7%","d":"down"},{"l":"SCA Scan Ativos","v":"5.401","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.0%","d":"down"}];
const COLS = ["ID","SCA Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops #001","Devsecops #002","5.914","3.015","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops #002","Devsecops #003","6.744","6.772","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops #003","Devsecops #004","5.929","7.417","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops #004","Devsecops #005","5.457","7.790","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops #005","Devsecops #001","4.032","2.311","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":667},{"label":"Mar","value":554},{"label":"Abr","value":566},{"label":"Mai","value":889},{"label":"Jun","value":672},{"label":"Jul","value":640},{"label":"Ago","value":661},{"label":"Set","value":641},{"label":"Out","value":670},{"label":"Nov","value":522},{"label":"Dez","value":732}];
const MX = 889;
