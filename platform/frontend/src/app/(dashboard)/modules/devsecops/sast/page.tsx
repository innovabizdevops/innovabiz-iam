...
const PAGE = "SAST/DAST";
const KPIS = [{"l":"Total Devsecops","v":"5.697","t":"+0.1%","d":"up"},{"l":"SAST/DAST Ativos","v":"2.450","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+13.9%","d":"up"}];
const COLS = ["ID","SAST/DAST","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops #001","Devsecops #002","7.286","7.649","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops #002","Devsecops #003","7.863","4.519","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops #003","Devsecops #004","5.806","4.509","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops #004","Devsecops #005","4.917","2.584","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops #005","Devsecops #001","5.009","4.409","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":934},{"label":"Mar","value":844},{"label":"Abr","value":829},{"label":"Mai","value":760},{"label":"Jun","value":898},{"label":"Jul","value":675},{"label":"Ago","value":719},{"label":"Set","value":700},{"label":"Out","value":714},{"label":"Nov","value":902},{"label":"Dez","value":775}];
const MX = 954;
