...
const PAGE = "Container Sec";
const KPIS = [{"l":"Total Devsecops","v":"8.869","t":"-4.8%","d":"down"},{"l":"Container Sec Ativos","v":"3.531","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"82.2%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+5.6%","d":"up"}];
const COLS = ["ID","Container Sec","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Devsecops #001","Devsecops #002","2.330","3.998","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Devsecops #002","Devsecops #003","1.255","6.590","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Devsecops #003","Devsecops #004","4.497","6.186","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Devsecops #004","Devsecops #005","6.891","1.373","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Devsecops #005","Devsecops #001","6.800","5.110","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":526},{"label":"Mar","value":559},{"label":"Abr","value":569},{"label":"Mai","value":414},{"label":"Jun","value":391},{"label":"Jul","value":738},{"label":"Ago","value":769},{"label":"Set","value":633},{"label":"Out","value":733},{"label":"Nov","value":642},{"label":"Dez","value":438}];
const MX = 769;
