...
const PAGE = "ULD Control";
const KPIS = [{"l":"Total Air Cargo","v":"129","t":"-0.6%","d":"down"},{"l":"ULD Control Ativos","v":"6.075","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"74.6%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"67","t":"+0.9%","d":"up"}];
const COLS = ["ID","ULD Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Cargo #001","Air Cargo #002","1.331","1.101","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Air Cargo #002","Air Cargo #003","4.859","8.451","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Cargo #003","Air Cargo #004","8.323","7.598","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Air Cargo #004","Air Cargo #005","9.067","6.013","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Cargo #005","Air Cargo #001","1.597","1.192","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":853},{"label":"Mar","value":1045},{"label":"Abr","value":819},{"label":"Mai","value":899},{"label":"Jun","value":925},{"label":"Jul","value":954},{"label":"Ago","value":1001},{"label":"Set","value":924},{"label":"Out","value":954},{"label":"Nov","value":785},{"label":"Dez","value":882}];
const MX = 1045;
