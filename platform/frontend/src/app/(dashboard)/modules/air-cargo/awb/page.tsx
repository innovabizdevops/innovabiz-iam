...
const PAGE = "AWB Mgmt";
const KPIS = [{"l":"Total Air Cargo","v":"1.403","t":"+2.8%","d":"up"},{"l":"AWB Mgmt Ativos","v":"5.969","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"84.4%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"62","t":"-1.2%","d":"down"}];
const COLS = ["ID","AWB Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Cargo #001","Air Cargo #002","8.757","4.944","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Air Cargo #002","Air Cargo #003","4.570","3.120","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Cargo #003","Air Cargo #004","4.336","2.291","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Air Cargo #004","Air Cargo #005","4.033","1.324","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Cargo #005","Air Cargo #001","4.390","179","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":842},{"label":"Mar","value":788},{"label":"Abr","value":841},{"label":"Mai","value":538},{"label":"Jun","value":643},{"label":"Jul","value":535},{"label":"Ago","value":598},{"label":"Set","value":515},{"label":"Out","value":683},{"label":"Nov","value":661},{"label":"Dez","value":517}];
const MX = 842;
