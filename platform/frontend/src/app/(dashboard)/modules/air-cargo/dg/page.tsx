...
const ACCENT = "#96b9df";
const MODULE = "Air Cargo";
const PAGE = "Dangerous Goods";
const KPIS = [{"l":"Total Air Cargo","v":"6.351","t":"+11.5%","d":"up"},{"l":"Dangerous Goods Ativos","v":"4.112","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"89","t":"-2.6%","d":"down"}];
const COLS = ["ID","Dangerous Goods","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Cargo #001","Air Cargo #002","6.447","7.509","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Air Cargo #002","Air Cargo #003","1.212","4.720","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Cargo #003","Air Cargo #004","2.900","1.242","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Air Cargo #004","Air Cargo #005","2.215","4.444","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Cargo #005","Air Cargo #001","1.459","8.457","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":491},{"label":"Mar","value":605},{"label":"Abr","value":305},{"label":"Mai","value":498},{"label":"Jun","value":547},{"label":"Jul","value":298},{"label":"Ago","value":596},{"label":"Set","value":606},{"label":"Out","value":252},{"label":"Nov","value":481},{"label":"Dez","value":612}];
const MX = 612;
