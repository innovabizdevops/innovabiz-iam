...
const PAGE = "Screen Check";
const KPIS = [{"l":"Total Air Cargo","v":"2.825","t":"+3.8%","d":"up"},{"l":"Screen Check Ativos","v":"2.071","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"76","t":"+3.9%","d":"up"}];
const COLS = ["ID","Screen Check","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Cargo #001","2026-03-27","2.792","1.912","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Air Cargo #002","2026-02-27","1.991","2.028","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Cargo #003","2026-01-03","1.282","7.982","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Air Cargo #004","2026-01-11","1.622","8.423","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Cargo #005","2026-02-05","3.674","6.393","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":654},{"label":"Mar","value":814},{"label":"Abr","value":877},{"label":"Mai","value":752},{"label":"Jun","value":591},{"label":"Jul","value":693},{"label":"Ago","value":552},{"label":"Set","value":690},{"label":"Out","value":827},{"label":"Nov","value":829},{"label":"Dez","value":733}];
const MX = 877;
