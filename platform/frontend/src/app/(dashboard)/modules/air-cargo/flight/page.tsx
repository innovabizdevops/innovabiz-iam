...
const PAGE = "Flight Alloc";
const KPIS = [{"l":"Total Air Cargo","v":"6.193","t":"+17.1%","d":"up"},{"l":"Flight Alloc Ativos","v":"3.639","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"65.0%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+1.9%","d":"up"}];
const COLS = ["ID","Flight Alloc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Air Cargo #001","Air Cargo #002","5.856","5.373","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Air Cargo #002","Air Cargo #003","3.539","2.136","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Air Cargo #003","Air Cargo #004","2.582","7.959","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Air Cargo #004","Air Cargo #005","2.162","8.691","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Air Cargo #005","Air Cargo #001","8.424","6.339","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":627},{"label":"Mar","value":712},{"label":"Abr","value":526},{"label":"Mai","value":639},{"label":"Jun","value":633},{"label":"Jul","value":584},{"label":"Ago","value":434},{"label":"Set","value":371},{"label":"Out","value":582},{"label":"Nov","value":540},{"label":"Dez","value":552}];
const MX = 712;
