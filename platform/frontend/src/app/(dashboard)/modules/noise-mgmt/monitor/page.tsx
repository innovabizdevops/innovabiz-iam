...
const ACCENT = "#6366f1";
const MODULE = "Noise Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Noise Mgmt","v":"3.533","t":"+8.3%","d":"up"},{"l":"Monitor Ativos","v":"8.578","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+0.7%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Noise Mgmt #001","Noise Mgmt #002","1.745","1.270","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Noise Mgmt #002","Noise Mgmt #003","7.199","6.841","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Noise Mgmt #003","Noise Mgmt #004","5.442","4.267","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Noise Mgmt #004","Noise Mgmt #005","2.777","1.841","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Noise Mgmt #005","Noise Mgmt #001","4.057","5.526","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":895},{"label":"Mar","value":631},{"label":"Abr","value":636},{"label":"Mai","value":667},{"label":"Jun","value":682},{"label":"Jul","value":835},{"label":"Ago","value":516},{"label":"Set","value":787},{"label":"Out","value":883},{"label":"Nov","value":667},{"label":"Dez","value":835}];
const MX = 895;
