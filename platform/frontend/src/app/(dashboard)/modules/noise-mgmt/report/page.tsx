...
const PAGE = "Report";
const KPIS = [{"l":"Total Noise Mgmt","v":"8.318","t":"-2.8%","d":"down"},{"l":"Report Ativos","v":"3.315","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Noise Mgmt #001","Noise Mgmt #002","8.509","8.203","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Noise Mgmt #002","Noise Mgmt #003","6.604","1.583","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Noise Mgmt #003","Noise Mgmt #004","1.824","9.088","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Noise Mgmt #004","Noise Mgmt #005","2.478","1.773","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Noise Mgmt #005","Noise Mgmt #001","8.548","6.941","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":684},{"label":"Mar","value":738},{"label":"Abr","value":928},{"label":"Mai","value":741},{"label":"Jun","value":764},{"label":"Jul","value":979},{"label":"Ago","value":1048},{"label":"Set","value":765},{"label":"Out","value":879},{"label":"Nov","value":818},{"label":"Dez","value":819}];
const MX = 1048;
