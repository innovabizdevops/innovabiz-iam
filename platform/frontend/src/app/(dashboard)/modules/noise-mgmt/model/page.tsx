...
const PAGE = "Model";
const KPIS = [{"l":"Total Noise Mgmt","v":"477","t":"-1.8%","d":"down"},{"l":"Model Ativos","v":"368","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+4.6%","d":"up"}];
const COLS = ["ID","Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Noise Mgmt #001","Noise Mgmt #002","691","4.655","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Noise Mgmt #002","Noise Mgmt #003","4.685","5.404","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Noise Mgmt #003","Noise Mgmt #004","8.779","432","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Noise Mgmt #004","Noise Mgmt #005","1.545","278","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Noise Mgmt #005","Noise Mgmt #001","3.359","8.191","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":672},{"label":"Mar","value":650},{"label":"Abr","value":721},{"label":"Mai","value":656},{"label":"Jun","value":480},{"label":"Jul","value":671},{"label":"Ago","value":465},{"label":"Set","value":637},{"label":"Out","value":530},{"label":"Nov","value":665},{"label":"Dez","value":492}];
const MX = 773;
