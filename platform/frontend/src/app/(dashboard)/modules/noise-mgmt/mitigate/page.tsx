...
const PAGE = "Mitigate";
const KPIS = [{"l":"Total Noise Mgmt","v":"8.939","t":"+13.9%","d":"up"},{"l":"Mitigate Ativos","v":"5.900","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+9.2%","d":"up"}];
const COLS = ["ID","Mitigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Noise Mgmt #001","Noise Mgmt #002","1.096","3.536","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Noise Mgmt #002","Noise Mgmt #003","4.190","178","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Noise Mgmt #003","Noise Mgmt #004","9.001","1.703","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Noise Mgmt #004","Noise Mgmt #005","6.349","5.421","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Noise Mgmt #005","Noise Mgmt #001","2.209","2.795","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":660},{"label":"Mar","value":621},{"label":"Abr","value":501},{"label":"Mai","value":711},{"label":"Jun","value":808},{"label":"Jul","value":568},{"label":"Ago","value":506},{"label":"Set","value":679},{"label":"Out","value":630},{"label":"Nov","value":471},{"label":"Dez","value":523}];
const MX = 808;
