...
const PAGE = "Local";
const KPIS = [{"l":"Quartos Ocupados","v":"4.262","t":"+2.5%","d":"up"},{"l":"RevPAR (€)","v":"€81512","t":"+5.7%","d":"up"},{"l":"Ocupação (%)","v":"84.8%","t":"+7.4%","d":"up"},{"l":"Guest Satisfaction","v":"4.139","t":"+10.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.941","2026-02-14","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.179","2026-02-08","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.652","2026-03-03","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.743","2026-03-18","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.517","2026-02-25","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":611},{"label":"Mar","value":585},{"label":"Abr","value":443},{"label":"Mai","value":786},{"label":"Jun","value":599},{"label":"Jul","value":702},{"label":"Ago","value":767},{"label":"Set","value":538},{"label":"Out","value":440},{"label":"Nov","value":623},{"label":"Dez","value":574}];
const MX = 793;
