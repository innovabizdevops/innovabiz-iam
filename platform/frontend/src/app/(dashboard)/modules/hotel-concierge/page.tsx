...
export default function HotelConciergePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Hotel Concierge</h1><p className="text-sm text-muted-foreground">Hotel Concierge • iBOS Enterprise</p></div>
