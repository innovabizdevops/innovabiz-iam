...
const ACCENT = "#6366f1";
const MODULE = "Hotel Concierge";
const PAGE = "AI Concierge";
const KPIS = [{"l":"Quartos Ocupados","v":"8.128","t":"+13.6%","d":"up"},{"l":"RevPAR (€)","v":"€49434","t":"+17.7%","d":"up"},{"l":"Ocupação (%)","v":"75.7%","t":"+0.8%","d":"up"},{"l":"Guest Satisfaction","v":"4.142","t":"-1.2%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.522","2026-03-12","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.245","2026-03-25","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.588","2026-02-05","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.683","2026-01-09","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.640","2026-02-05","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":833},{"label":"Mar","value":806},{"label":"Abr","value":796},{"label":"Mai","value":683},{"label":"Jun","value":596},{"label":"Jul","value":764},{"label":"Ago","value":853},{"label":"Set","value":930},{"label":"Out","value":839},{"label":"Nov","value":910},{"label":"Dez","value":862}];
const MX = 930;
