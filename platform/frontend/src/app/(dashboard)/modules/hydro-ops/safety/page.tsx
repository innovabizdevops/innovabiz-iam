...
const PAGE = "Safety";
const KPIS = [{"l":"Total Hydro Ops","v":"7.458","t":"+3.2%","d":"up"},{"l":"Safety Ativos","v":"1.665","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"57","t":"+14.1%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydro Ops #001","Hydro Ops #002","7.013","985","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Hydro Ops #002","Hydro Ops #003","968","8.981","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydro Ops #003","Hydro Ops #004","3.357","466","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Hydro Ops #004","Hydro Ops #005","8.143","6.978","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydro Ops #005","Hydro Ops #001","3.962","6.670","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":697},{"label":"Mar","value":918},{"label":"Abr","value":886},{"label":"Mai","value":691},{"label":"Jun","value":562},{"label":"Jul","value":602},{"label":"Ago","value":787},{"label":"Set","value":863},{"label":"Out","value":912},{"label":"Nov","value":762},{"label":"Dez","value":813}];
const MX = 918;
