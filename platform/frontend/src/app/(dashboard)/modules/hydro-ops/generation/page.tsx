...
const KPIS = [{"l":"Total Hydro Ops","v":"1.723","t":"+16.4%","d":"up"},{"l":"Generation Ativos","v":"2.057","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-2.3%","d":"down"}];
const COLS = ["ID","Generation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydro Ops #001","Hydro Ops #002","1.514","3.338","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Hydro Ops #002","Hydro Ops #003","2.380","4.795","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydro Ops #003","Hydro Ops #004","7.924","5.759","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Hydro Ops #004","Hydro Ops #005","5.569","1.298","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydro Ops #005","Hydro Ops #001","3.988","7.259","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":574},{"label":"Mar","value":480},{"label":"Abr","value":350},{"label":"Mai","value":572},{"label":"Jun","value":702},{"label":"Jul","value":474},{"label":"Ago","value":411},{"label":"Set","value":404},{"label":"Out","value":484},{"label":"Nov","value":535},{"label":"Dez","value":667}];
const MX = 702;
