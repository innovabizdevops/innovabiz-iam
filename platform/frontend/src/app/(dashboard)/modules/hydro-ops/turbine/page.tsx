...
const ACCENT = "#6366f1";
const MODULE = "Hydro Operations";
const PAGE = "Turbine";
const KPIS = [{"l":"Total Hydro Ops","v":"5.069","t":"+15.3%","d":"up"},{"l":"Turbine Ativos","v":"6.299","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"71","t":"-5.9%","d":"down"}];
const COLS = ["ID","Turbine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydro Ops #001","Hydro Ops #002","6.086","3.780","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Hydro Ops #002","Hydro Ops #003","1.969","5.456","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydro Ops #003","Hydro Ops #004","7.792","4.743","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Hydro Ops #004","Hydro Ops #005","6.294","2.848","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydro Ops #005","Hydro Ops #001","2.780","245","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":311},{"label":"Fev","value":344},{"label":"Mar","value":505},{"label":"Abr","value":600},{"label":"Mai","value":277},{"label":"Jun","value":356},{"label":"Jul","value":420},{"label":"Ago","value":389},{"label":"Set","value":246},{"label":"Out","value":254},{"label":"Nov","value":372},{"label":"Dez","value":424}];
const MX = 600;
