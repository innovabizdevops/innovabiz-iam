...
const PAGE = "Advisory";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.316","t":"+7.3%","d":"up"},{"l":"NC Abertas","v":"1.604","t":"+8.8%","d":"up"},{"l":"Conformidade (%)","v":"93.7%","t":"+0.3%","d":"up"},{"l":"CAPAs Pendentes","v":"1.112","t":"+2.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.003","76.8%","7.314","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.945","71.2%","2.264","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.546","92.4%","7.888","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","524","72.9%","6.051","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.519","76.3%","7.236","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":519},{"label":"Mar","value":508},{"label":"Abr","value":729},{"label":"Mai","value":588},{"label":"Jun","value":498},{"label":"Jul","value":748},{"label":"Ago","value":578},{"label":"Set","value":463},{"label":"Out","value":593},{"label":"Nov","value":656},{"label":"Dez","value":461}];
const MX = 748;
