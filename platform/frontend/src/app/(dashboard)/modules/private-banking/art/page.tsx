...
const PAGE = "Art Advisory";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.484","t":"+10.2%","d":"up"},{"l":"NC Abertas","v":"548","t":"+9.5%","d":"up"},{"l":"Conformidade (%)","v":"87.2%","t":"+4.9%","d":"up"},{"l":"CAPAs Pendentes","v":"7.276","t":"+12.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.937","84.3%","7.692","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.018","84.1%","5.518","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.911","84.4%","2.700","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.298","80.9%","5.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.199","96.4%","3.944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":381},{"label":"Mar","value":427},{"label":"Abr","value":503},{"label":"Mai","value":548},{"label":"Jun","value":287},{"label":"Jul","value":644},{"label":"Ago","value":662},{"label":"Set","value":457},{"label":"Out","value":405},{"label":"Nov","value":310},{"label":"Dez","value":646}];
const MX = 662;
