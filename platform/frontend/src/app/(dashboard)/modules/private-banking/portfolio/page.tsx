...
const ACCENT = "#96b9df";
const MODULE = "Private Banking";
const PAGE = "Portfolio View";
const KPIS = [{"l":"Total Private Banking","v":"7.129","t":"+9.4%","d":"up"},{"l":"Portfolio View Ativos","v":"5.570","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"93.7%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"72","t":"-5.2%","d":"down"}];
const COLS = ["ID","Portfolio View","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Banking #001","Private Banking #002","4.710","5.448","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Private Banking #002","Private Banking #003","1.485","7.471","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Banking #003","Private Banking #004","8.556","1.320","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Private Banking #004","Private Banking #005","8.394","485","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Banking #005","Private Banking #001","4.373","7.463","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":711},{"label":"Mar","value":673},{"label":"Abr","value":749},{"label":"Mai","value":613},{"label":"Jun","value":640},{"label":"Jul","value":829},{"label":"Ago","value":815},{"label":"Set","value":797},{"label":"Out","value":861},{"label":"Nov","value":585},{"label":"Dez","value":690}];
const MX = 861;
