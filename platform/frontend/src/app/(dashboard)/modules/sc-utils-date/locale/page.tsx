...
const ACCENT = "#0284c7";
const MODULE = "SC: Utils Date & Time";
const PAGE = "Locale";
const KPIS = [{"l":"Configurações","v":"3.725","t":"+16.3%","d":"up"},{"l":"Últimas Alterações","v":"7.497","t":"+5.2%","d":"up"},{"l":"Ambientes","v":"6.994","t":"+10.8%","d":"up"},{"l":"Versão Config","v":"3.905","t":"+1.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 34609.35","2.136","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 33890.71","8.367","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 33410.87","5.895","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 46943.01","2.134","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 42094.48","8.033","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":681},{"label":"Mar","value":806},{"label":"Abr","value":524},{"label":"Mai","value":759},{"label":"Jun","value":572},{"label":"Jul","value":679},{"label":"Ago","value":451},{"label":"Set","value":640},{"label":"Out","value":733},{"label":"Nov","value":611},{"label":"Dez","value":476}];
const MX = 806;
