...
const PAGE = "Format";
const KPIS = [{"l":"Formulários Ativos","v":"8.890","t":"+10.9%","d":"up"},{"l":"Submissões/Dia","v":"1487","t":"+17.3%","d":"up"},{"l":"Documentos Gerados","v":"4.554","t":"+5.3%","d":"up"},{"l":"Templates","v":"1.029","t":"+16.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.309","2026-02-24","6.896","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.596","2026-03-19","6.459","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.861","2026-01-03","6.788","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","600","2026-02-19","6.234","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.800","2026-02-25","4.162","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":555},{"label":"Mar","value":656},{"label":"Abr","value":692},{"label":"Mai","value":762},{"label":"Jun","value":558},{"label":"Jul","value":767},{"label":"Ago","value":558},{"label":"Set","value":463},{"label":"Out","value":606},{"label":"Nov","value":577},{"label":"Dez","value":540}];
const MX = 767;
