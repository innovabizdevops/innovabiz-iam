...
const PAGE = "Duration";
const KPIS = [{"l":"Total Sc Utils Date","v":"2.692","t":"+14.2%","d":"up"},{"l":"Duration Ativos","v":"7.094","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+10.5%","d":"up"}];
const COLS = ["ID","Duration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Utils Date #001","Sc Utils Date #002","5.000","6.413","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Utils Date #002","Sc Utils Date #003","894","7.535","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Utils Date #003","Sc Utils Date #004","1.040","6.597","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Utils Date #004","Sc Utils Date #005","5.985","8.178","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Utils Date #005","Sc Utils Date #001","954","6.362","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":836},{"label":"Mar","value":1033},{"label":"Abr","value":983},{"label":"Mai","value":786},{"label":"Jun","value":1003},{"label":"Jul","value":855},{"label":"Ago","value":740},{"label":"Set","value":794},{"label":"Out","value":893},{"label":"Nov","value":974},{"label":"Dez","value":987}];
const MX = 1033;
