...
/* ═══ SC: Utils Date & Time — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "5238", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2651", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€164K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1703725838", cells: ["SC-8838", "SC: Utils Date & Time Item 1", "11/3/2026", "€25 938"], status: "active" as const },
    { id: "1703729409", cells: ["SC-3409", "SC: Utils Date & Time Item 2", "26/10/2026", "€29 509"], status: "pending" as const },
    { id: "1703732980", cells: ["SC-6980", "SC: Utils Date & Time Item 3", "13/5/2026", "€33 080"], status: "completed" as const },
    { id: "1703736551", cells: ["SC-1551", "SC: Utils Date & Time Item 4", "28/12/2026", "€36 651"], status: "warning" as const },
    { id: "1703740122", cells: ["SC-5122", "SC: Utils Date & Time Item 5", "15/7/2026", "€40 222"], status: "active" as const },
];
...
export default function ScUtilsDateTimePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Utils Date & Time</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Utils Date & Time</p>
                    </div>
                </div>
