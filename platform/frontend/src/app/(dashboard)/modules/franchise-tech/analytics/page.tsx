...
const KPIS = [{"l":"Dashboards Ativos","v":"3.644","t":"-4.4%","d":"down"},{"l":"Queries/Dia","v":"2774","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"9.090","t":"+11.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.668","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2404","2026-01-06","3.326","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3222","2026-02-07","4.203","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1574","2026-02-12","3.552","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2649","2026-02-26","7.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4453","2026-02-01","6.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":707},{"label":"Mar","value":706},{"label":"Abr","value":507},{"label":"Mai","value":535},{"label":"Jun","value":721},{"label":"Jul","value":712},{"label":"Ago","value":645},{"label":"Set","value":637},{"label":"Out","value":787},{"label":"Nov","value":568},{"label":"Dez","value":454}];
const MX = 787;
