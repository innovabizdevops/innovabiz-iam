...
/* ═══ Franchise Technology — Dashboard ═══ */

const ACCENT = "#93c5fd";

const KPIS = [
    { label: "Total Registos", value: "2067", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2478", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€186K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1361242067", cells: ["FRA-2067", "Franchise Technology Item 1", "4/12/2026", "€42 167"], status: "active" as const },
    { id: "1361245638", cells: ["FRA-5638", "Franchise Technology Item 2", "19/7/2026", "€45 738"], status: "pending" as const },
    { id: "1361249209", cells: ["FRA-9209", "Franchise Technology Item 3", "6/2/2026", "€49 309"], status: "completed" as const },
    { id: "1361252780", cells: ["FRA-3780", "Franchise Technology Item 4", "21/9/2026", "€2880"], status: "warning" as const },
    { id: "1361256351", cells: ["FRA-7351", "Franchise Technology Item 5", "8/4/2026", "€6451"], status: "active" as const },
];
...
export default function FranchiseTechnologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Technology</p>
                    </div>
                </div>
