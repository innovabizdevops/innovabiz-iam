...
const PAGE = "Ad Copy";
const KPIS = [{"l":"Total Sem Ppc","v":"6.160","t":"+8.7%","d":"up"},{"l":"Ad Copy Ativos","v":"2.726","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"89","t":"+17.0%","d":"up"}];
const COLS = ["ID","Ad Copy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sem Ppc #001","Sem Ppc #002","4.466","1.583","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Sem Ppc #002","Sem Ppc #003","1.518","5.411","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Sem Ppc #003","Sem Ppc #004","8.462","3.962","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Sem Ppc #004","Sem Ppc #005","8.217","3.885","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sem Ppc #005","Sem Ppc #001","6.198","8.866","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":718},{"label":"Mar","value":704},{"label":"Abr","value":800},{"label":"Mai","value":1067},{"label":"Jun","value":687},{"label":"Jul","value":862},{"label":"Ago","value":913},{"label":"Set","value":1022},{"label":"Out","value":905},{"label":"Nov","value":1057},{"label":"Dez","value":911}];
const MX = 1067;
