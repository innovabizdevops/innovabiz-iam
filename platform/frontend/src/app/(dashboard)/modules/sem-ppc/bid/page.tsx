...
const ACCENT = "#6366f1";
const MODULE = "SEM & PPC";
const PAGE = "Keyword Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.494","t":"+9.5%","d":"up"},{"l":"Contratos (€M)","v":"€22.9M","t":"+8.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"67.7%","t":"+7.5%","d":"up"},{"l":"Score Médio","v":"94","t":"+12.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","82.1%","€ 34538.31","3.465","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","81.8%","€ 49642.93","6.274","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","74.4%","€ 22674.68","1.718","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","99.4%","€ 39955.89","4.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.8%","€ 1602.52","369","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":657},{"label":"Mar","value":1039},{"label":"Abr","value":966},{"label":"Mai","value":657},{"label":"Jun","value":752},{"label":"Jul","value":923},{"label":"Ago","value":699},{"label":"Set","value":987},{"label":"Out","value":732},{"label":"Nov","value":733},{"label":"Dez","value":763}];
const MX = 1039;
