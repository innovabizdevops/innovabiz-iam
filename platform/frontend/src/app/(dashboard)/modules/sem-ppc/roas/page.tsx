...
const PAGE = "ROAS";
const KPIS = [{"l":"Total Sem Ppc","v":"432","t":"+16.7%","d":"up"},{"l":"ROAS Ativos","v":"3.093","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"90.3%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+4.0%","d":"up"}];
const COLS = ["ID","ROAS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sem Ppc #001","Sem Ppc #002","5.893","7.461","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Sem Ppc #002","Sem Ppc #003","6.490","8.728","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sem Ppc #003","Sem Ppc #004","3.568","707","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Sem Ppc #004","Sem Ppc #005","7.741","8.879","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sem Ppc #005","Sem Ppc #001","3.371","447","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":878},{"label":"Mar","value":748},{"label":"Abr","value":782},{"label":"Mai","value":746},{"label":"Jun","value":646},{"label":"Jul","value":746},{"label":"Ago","value":574},{"label":"Set","value":711},{"label":"Out","value":630},{"label":"Nov","value":837},{"label":"Dez","value":869}];
const MX = 910;
