...
const PAGE = "Profile";
const KPIS = [{"l":"Perfis Unificados","v":"7.041","t":"+2.1%","d":"up"},{"l":"Segmentos Ativos","v":"2.760","t":"+10.6%","d":"up"},{"l":"NPS Score","v":"94","t":"+11.7%","d":"up"},{"l":"Churn Previsto (%)","v":"90.1%","t":"-3.3%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.800","€ 31150.98","85.7%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","3.546","€ 29067.37","88.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","5.725","€ 13217.00","74.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","2.541","€ 20066.24","81.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","5.162","€ 13316.99","78.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":705},{"label":"Mar","value":717},{"label":"Abr","value":684},{"label":"Mai","value":509},{"label":"Jun","value":462},{"label":"Jul","value":456},{"label":"Ago","value":670},{"label":"Set","value":461},{"label":"Out","value":698},{"label":"Nov","value":552},{"label":"Dez","value":613}];
const MX = 717;
