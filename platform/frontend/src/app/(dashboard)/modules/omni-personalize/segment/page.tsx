...
const ACCENT = "#2563eb";
const MODULE = "OMNI Personalization";
const PAGE = "Segment";
const KPIS = [{"l":"Perfis Unificados","v":"4.746","t":"+10.2%","d":"up"},{"l":"Segmentos Ativos","v":"2.301","t":"+4.9%","d":"up"},{"l":"NPS Score","v":"94","t":"+17.7%","d":"up"},{"l":"Churn Previsto (%)","v":"71.6%","t":"+15.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.522","€ 33811.52","73.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","5.951","€ 30843.33","74.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","2.445","€ 35098.55","81.7%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.579","€ 36133.98","86.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","3.330","€ 27906.30","87.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":853},{"label":"Mar","value":850},{"label":"Abr","value":594},{"label":"Mai","value":913},{"label":"Jun","value":952},{"label":"Jul","value":782},{"label":"Ago","value":957},{"label":"Set","value":841},{"label":"Out","value":972},{"label":"Nov","value":711},{"label":"Dez","value":808}];
const MX = 972;
