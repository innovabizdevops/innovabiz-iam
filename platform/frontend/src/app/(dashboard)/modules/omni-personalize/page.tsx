...
/* ═══ OMNI Personalization — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "2857", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "456", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€455K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "569520057", cells: ["OMN-1057", "OMNI Personalization Item 1", "2/10/2026", "€20 157"], status: "active" as const },
    { id: "569523628", cells: ["OMN-4628", "OMNI Personalization Item 2", "17/5/2026", "€23 728"], status: "pending" as const },
    { id: "569527199", cells: ["OMN-8199", "OMNI Personalization Item 3", "4/12/2026", "€27 299"], status: "completed" as const },
    { id: "569530770", cells: ["OMN-2770", "OMNI Personalization Item 4", "19/7/2026", "€30 870"], status: "warning" as const },
    { id: "569534341", cells: ["OMN-6341", "OMNI Personalization Item 5", "6/2/2026", "€34 441"], status: "active" as const },
];
...
export default function OmniPersonalizationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">OMNI Personalization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • OMNI Personalization</p>
                    </div>
                </div>
