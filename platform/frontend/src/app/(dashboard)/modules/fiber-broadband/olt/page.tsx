...
const PAGE = "OLT Config";
const KPIS = [{"l":"Configurações","v":"5.460","t":"-2.9%","d":"down"},{"l":"Últimas Alterações","v":"2.745","t":"-4.2%","d":"down"},{"l":"Ambientes","v":"3.248","t":"+8.2%","d":"up"},{"l":"Versão Config","v":"3.474","t":"+16.0%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 44645.84","2.793","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 34500.28","7.952","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 2144.38","1.178","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 9193.03","8.916","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 32576.27","1.533","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1020},{"label":"Fev","value":679},{"label":"Mar","value":893},{"label":"Abr","value":750},{"label":"Mai","value":672},{"label":"Jun","value":778},{"label":"Jul","value":1031},{"label":"Ago","value":966},{"label":"Set","value":700},{"label":"Out","value":927},{"label":"Nov","value":801},{"label":"Dez","value":775}];
const MX = 1031;
