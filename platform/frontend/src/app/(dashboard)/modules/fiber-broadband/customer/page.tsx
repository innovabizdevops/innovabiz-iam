...
const PAGE = "Customer";
const KPIS = [{"l":"Total Fiber Broadband","v":"7.779","t":"+0.3%","d":"up"},{"l":"Customer Ativos","v":"€60913","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"65","t":"-0.2%","d":"down"}];
const COLS = ["ID","Customer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fiber Broadband #001","€ 36764.28","5.984","6.613","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Fiber Broadband #002","€ 29956.56","1.407","328","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Fiber Broadband #003","€ 42809.87","8.977","371","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Fiber Broadband #004","€ 28523.09","8.254","5.756","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fiber Broadband #005","€ 16535.31","765","2.534","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":726},{"label":"Mar","value":1000},{"label":"Abr","value":983},{"label":"Mai","value":984},{"label":"Jun","value":925},{"label":"Jul","value":844},{"label":"Ago","value":683},{"label":"Set","value":792},{"label":"Out","value":801},{"label":"Nov","value":984},{"label":"Dez","value":992}];
const MX = 1000;
