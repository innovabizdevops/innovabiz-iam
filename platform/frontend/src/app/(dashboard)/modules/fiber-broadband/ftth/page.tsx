...
const PAGE = "FTTH Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.370","t":"-4.2%","d":"down"},{"l":"Submissões/Dia","v":"1024","t":"+1.8%","d":"up"},{"l":"Documentos Gerados","v":"6.373","t":"+1.9%","d":"up"},{"l":"Templates","v":"4.439","t":"+7.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.079","2026-01-16","4.024","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.981","2026-02-26","7.656","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.012","2026-01-14","7.938","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.760","2026-03-25","6.305","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","264","2026-02-16","4.073","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":875},{"label":"Mar","value":615},{"label":"Abr","value":675},{"label":"Mai","value":479},{"label":"Jun","value":555},{"label":"Jul","value":614},{"label":"Ago","value":753},{"label":"Set","value":865},{"label":"Out","value":676},{"label":"Nov","value":832},{"label":"Dez","value":566}];
const MX = 875;
