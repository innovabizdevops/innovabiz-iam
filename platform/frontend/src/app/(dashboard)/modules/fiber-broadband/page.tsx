...
export default function FiberBroadbandPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fiber Broadband</h1><p className="text-sm text-muted-foreground">Fiber Broadband • iBOS Enterprise</p></div>
