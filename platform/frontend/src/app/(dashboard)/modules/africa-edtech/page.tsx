...
const KPIS = [
    ...
    { label: "Receita Mensal", value: "€131K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1332959921", cells: ["AFR-6921", "Africa EdTech Hub Item 1", "14/6/2026", "€10 021"], status: "active" as const },
    { id: "1332963492", cells: ["AFR-1492", "Africa EdTech Hub Item 2", "1/1/2026", "€13 592"], status: "pending" as const },
    { id: "1332967063", cells: ["AFR-5063", "Africa EdTech Hub Item 3", "16/8/2026", "€17 163"], status: "completed" as const },
    { id: "1332970634", cells: ["AFR-8634", "Africa EdTech Hub Item 4", "3/3/2026", "€20 734"], status: "warning" as const },
    { id: "1332974205", cells: ["AFR-3205", "Africa EdTech Hub Item 5", "18/10/2026", "€24 305"], status: "active" as const },
];
...
export default function AfricaEdtechHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Africa EdTech Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Africa EdTech Hub</p>
                    </div>
                </div>
