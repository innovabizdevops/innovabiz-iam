...
const ACCENT = "#14532d";
const MODULE = "Africa EdTech Hub";
const PAGE = "Mobile LMS";
const KPIS = [{"l":"Total Africa Edtech","v":"8.863","t":"+3.5%","d":"up"},{"l":"Mobile LMS Ativos","v":"6.102","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"76.4%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"88","t":"+5.4%","d":"up"}];
const COLS = ["ID","Mobile LMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Africa Edtech #001","Africa Edtech #002","6.939","5.706","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Africa Edtech #002","Africa Edtech #003","5.490","6.729","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Africa Edtech #003","Africa Edtech #004","1.053","5.970","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Africa Edtech #004","Africa Edtech #005","8.253","7.036","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Africa Edtech #005","Africa Edtech #001","1.897","7.878","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":957},{"label":"Mar","value":922},{"label":"Abr","value":628},{"label":"Mai","value":662},{"label":"Jun","value":924},{"label":"Jul","value":635},{"label":"Ago","value":752},{"label":"Set","value":630},{"label":"Out","value":946},{"label":"Nov","value":946},{"label":"Dez","value":825}];
const MX = 957;
