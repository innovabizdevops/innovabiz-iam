...
const PAGE = "Source";
const KPIS = [{"l":"Quartos Ocupados","v":"1.326","t":"+4.1%","d":"up"},{"l":"RevPAR (€)","v":"€89706","t":"+10.5%","d":"up"},{"l":"Ocupação (%)","v":"89.4%","t":"+16.9%","d":"up"},{"l":"Guest Satisfaction","v":"1.076","t":"+4.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.418","2026-03-22","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.145","2026-01-04","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.490","2026-02-07","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.165","2026-03-06","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.027","2026-01-21","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":299},{"label":"Mar","value":513},{"label":"Abr","value":552},{"label":"Mai","value":342},{"label":"Jun","value":625},{"label":"Jul","value":602},{"label":"Ago","value":419},{"label":"Set","value":526},{"label":"Out","value":499},{"label":"Nov","value":574},{"label":"Dez","value":333}];
const MX = 625;
