...
/* ═══ Aerospace Supply Chain — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8842", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3343", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€280K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1856902242", cells: ["AER-5242", "Aerospace Supply Chain Item 1", "7/7/2026", "€2342"], status: "active" as const },
    { id: "1856905813", cells: ["AER-8813", "Aerospace Supply Chain Item 2", "22/2/2026", "€5913"], status: "pending" as const },
    { id: "1856909384", cells: ["AER-3384", "Aerospace Supply Chain Item 3", "9/9/2026", "€9484"], status: "completed" as const },
    { id: "1856912955", cells: ["AER-6955", "Aerospace Supply Chain Item 4", "24/4/2026", "€13 055"], status: "warning" as const },
    { id: "1856916526", cells: ["AER-1526", "Aerospace Supply Chain Item 5", "11/11/2026", "€16 626"], status: "active" as const },
];
...
export default function AerospaceSupplyChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aerospace Supply Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aerospace Supply Chain</p>
                    </div>
                </div>
