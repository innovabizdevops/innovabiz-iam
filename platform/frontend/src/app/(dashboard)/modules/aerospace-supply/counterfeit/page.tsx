...
const ACCENT = "#1e3a5f";
const MODULE = "Aerospace Supply Chain";
const PAGE = "Counterfeit";
const KPIS = [{"l":"Quartos Ocupados","v":"7.769","t":"+7.7%","d":"up"},{"l":"RevPAR (€)","v":"€77218","t":"+1.1%","d":"up"},{"l":"Ocupação (%)","v":"85.7%","t":"+15.5%","d":"up"},{"l":"Guest Satisfaction","v":"1.455","t":"+2.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.862","2026-01-02","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.521","2026-02-28","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.417","2026-03-27","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.188","2026-01-18","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.702","2026-03-18","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":957},{"label":"Mar","value":854},{"label":"Abr","value":830},{"label":"Mai","value":960},{"label":"Jun","value":842},{"label":"Jul","value":762},{"label":"Ago","value":969},{"label":"Set","value":870},{"label":"Out","value":1085},{"label":"Nov","value":843},{"label":"Dez","value":828}];
const MX = 1085;
