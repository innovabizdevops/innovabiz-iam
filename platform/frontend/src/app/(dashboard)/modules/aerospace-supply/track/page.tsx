...
const PAGE = "Track";
const KPIS = [{"l":"Quartos Ocupados","v":"2.181","t":"+17.0%","d":"up"},{"l":"RevPAR (€)","v":"€5387","t":"+15.1%","d":"up"},{"l":"Ocupação (%)","v":"94.1%","t":"-3.9%","d":"down"},{"l":"Guest Satisfaction","v":"4.071","t":"-5.9%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.018","2026-01-07","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","715","2026-02-15","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.730","2026-03-05","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.536","2026-01-03","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.582","2026-02-02","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":605},{"label":"Mar","value":442},{"label":"Abr","value":640},{"label":"Mai","value":465},{"label":"Jun","value":461},{"label":"Jul","value":327},{"label":"Ago","value":389},{"label":"Set","value":342},{"label":"Out","value":653},{"label":"Nov","value":717},{"label":"Dez","value":478}];
const MX = 717;
