...
const PAGE = "Billing";
const KPIS = [{"l":"Configurações","v":"2.966","t":"+10.2%","d":"up"},{"l":"Últimas Alterações","v":"2.300","t":"-5.7%","d":"down"},{"l":"Ambientes","v":"1.678","t":"-3.4%","d":"down"},{"l":"Versão Config","v":"1.082","t":"+6.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 23138.46","7.602","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 44596.76","5.881","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 39086.97","2.939","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 6607.09","1.751","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 41540.26","8.306","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":312},{"label":"Mar","value":415},{"label":"Abr","value":561},{"label":"Mai","value":459},{"label":"Jun","value":424},{"label":"Jul","value":312},{"label":"Ago","value":578},{"label":"Set","value":373},{"label":"Out","value":327},{"label":"Nov","value":502},{"label":"Dez","value":649}];
const MX = 649;
