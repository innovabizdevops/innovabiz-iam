...
const ACCENT = "#22c55e";
const MODULE = "Tenant Administration";
const PAGE = "Feature";
const KPIS = [{"l":"Configurações","v":"5.718","t":"+17.2%","d":"up"},{"l":"Últimas Alterações","v":"6.586","t":"+10.5%","d":"up"},{"l":"Ambientes","v":"384","t":"+4.8%","d":"up"},{"l":"Versão Config","v":"8.376","t":"-3.8%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 41941.70","8.935","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 17712.96","5.661","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 39444.37","2.937","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 23444.40","1.334","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 20939.90","311","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":567},{"label":"Mar","value":495},{"label":"Abr","value":272},{"label":"Mai","value":590},{"label":"Jun","value":333},{"label":"Jul","value":381},{"label":"Ago","value":278},{"label":"Set","value":378},{"label":"Out","value":360},{"label":"Nov","value":399},{"label":"Dez","value":389}];
const MX = 590;
