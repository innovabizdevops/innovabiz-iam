...
const KPIS = [
    { label: "Total Registos", value: "8063", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2391", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€428K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "753774163", cells: ["TEN-7163", "Tenant Administration Item 1", "24/8/2026", "€24 263"], status: "active" as const },
    { id: "753777734", cells: ["TEN-1734", "Tenant Administration Item 2", "11/3/2026", "€27 834"], status: "pending" as const },
    { id: "753781305", cells: ["TEN-5305", "Tenant Administration Item 3", "26/10/2026", "€31 405"], status: "completed" as const },
    { id: "753784876", cells: ["TEN-8876", "Tenant Administration Item 4", "13/5/2026", "€34 976"], status: "warning" as const },
    { id: "753788447", cells: ["TEN-3447", "Tenant Administration Item 5", "28/12/2026", "€38 547"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tenant Administration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tenant Administration</p>
                    </div>
                </div>
