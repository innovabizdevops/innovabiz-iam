...
const PAGE = "Role";
const KPIS = [{"l":"Configurações","v":"6.917","t":"+9.3%","d":"up"},{"l":"Últimas Alterações","v":"7.284","t":"+1.3%","d":"up"},{"l":"Ambientes","v":"1.375","t":"+0.2%","d":"up"},{"l":"Versão Config","v":"8.531","t":"+0.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 25009.53","6.928","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 35047.77","1.987","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 28475.02","8.909","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 42498.31","6.333","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 28621.42","3.576","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":675},{"label":"Mar","value":675},{"label":"Abr","value":658},{"label":"Mai","value":607},{"label":"Jun","value":296},{"label":"Jul","value":537},{"label":"Ago","value":285},{"label":"Set","value":612},{"label":"Out","value":392},{"label":"Nov","value":664},{"label":"Dez","value":562}];
const MX = 675;
