...
const PAGE = "User";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.336","t":"+14.5%","d":"up"},{"l":"Sessões/Dia","v":"547","t":"+0.7%","d":"up"},{"l":"MFA Adoção (%)","v":"76.4%","t":"+8.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.075","t":"+10.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.310","8.367","3.510","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.938","8.259","3.499","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.245","4.962","1.128","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.191","961","4.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","631","2.195","9.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":755},{"label":"Mar","value":885},{"label":"Abr","value":1005},{"label":"Mai","value":697},{"label":"Jun","value":947},{"label":"Jul","value":925},{"label":"Ago","value":778},{"label":"Set","value":793},{"label":"Out","value":1010},{"label":"Nov","value":803},{"label":"Dez","value":891}];
const MX = 1010;
