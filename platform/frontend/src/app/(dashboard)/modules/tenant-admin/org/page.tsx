...
const PAGE = "Org";
const KPIS = [{"l":"Configurações","v":"9.045","t":"-0.2%","d":"down"},{"l":"Últimas Alterações","v":"4.941","t":"+9.0%","d":"up"},{"l":"Ambientes","v":"3.551","t":"+7.2%","d":"up"},{"l":"Versão Config","v":"6.329","t":"+15.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 46426.25","7.239","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 33308.48","3.784","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 22195.19","2.368","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 5691.40","4.215","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 49602.28","279","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":571},{"label":"Mar","value":532},{"label":"Abr","value":589},{"label":"Mai","value":233},{"label":"Jun","value":410},{"label":"Jul","value":514},{"label":"Ago","value":570},{"label":"Set","value":463},{"label":"Out","value":516},{"label":"Nov","value":526},{"label":"Dez","value":335}];
const MX = 589;
