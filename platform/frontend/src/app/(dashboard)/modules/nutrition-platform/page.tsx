...
/* ═══ Nutrition & Diet Platform — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "3439", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3382", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€331K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1230880239", cells: ["NUT-5239", "Nutrition & Diet Platform Item 1", "16/4/2026", "€30 339"], status: "active" as const },
    { id: "1230883810", cells: ["NUT-8810", "Nutrition & Diet Platform Item 2", "3/11/2026", "€33 910"], status: "pending" as const },
    { id: "1230887381", cells: ["NUT-3381", "Nutrition & Diet Platform Item 3", "18/6/2026", "€37 481"], status: "completed" as const },
    { id: "1230890952", cells: ["NUT-6952", "Nutrition & Diet Platform Item 4", "5/1/2026", "€41 052"], status: "warning" as const },
    { id: "1230894523", cells: ["NUT-1523", "Nutrition & Diet Platform Item 5", "20/8/2026", "€44 623"], status: "active" as const },
];
...
export default function NutritionDietPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nutrition & Diet Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Nutrition & Diet Platform</p>
                    </div>
                </div>
