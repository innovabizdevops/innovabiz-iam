...
const PAGE = "Recipe";
const KPIS = [{"l":"Formulários Ativos","v":"7.744","t":"+4.9%","d":"up"},{"l":"Submissões/Dia","v":"3922","t":"+7.6%","d":"up"},{"l":"Documentos Gerados","v":"4.617","t":"+17.8%","d":"up"},{"l":"Templates","v":"8.837","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.981","2026-01-03","7.503","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.181","2026-01-12","6.605","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","924","2026-03-09","3.016","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.035","2026-03-09","8.083","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.106","2026-01-17","4.752","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":485},{"label":"Mar","value":669},{"label":"Abr","value":830},{"label":"Mai","value":627},{"label":"Jun","value":665},{"label":"Jul","value":664},{"label":"Ago","value":707},{"label":"Set","value":604},{"label":"Out","value":755},{"label":"Nov","value":753},{"label":"Dez","value":801}];
const MX = 830;
