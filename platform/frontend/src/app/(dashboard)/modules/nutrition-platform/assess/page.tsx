...
const PAGE = "Assess";
const KPIS = [{"l":"Formulários Ativos","v":"2.059","t":"+5.6%","d":"up"},{"l":"Submissões/Dia","v":"2735","t":"+14.6%","d":"up"},{"l":"Documentos Gerados","v":"1.223","t":"+-0.0%","d":"up"},{"l":"Templates","v":"3.084","t":"-1.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.624","2026-02-27","7.461","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.363","2026-02-08","1.870","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.084","2026-03-22","3.191","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.959","2026-03-25","741","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.933","2026-02-27","7.755","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":305},{"label":"Mar","value":431},{"label":"Abr","value":457},{"label":"Mai","value":301},{"label":"Jun","value":321},{"label":"Jul","value":346},{"label":"Ago","value":479},{"label":"Set","value":363},{"label":"Out","value":426},{"label":"Nov","value":542},{"label":"Dez","value":646}];
const MX = 646;
