...
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"856","t":"-0.8%","d":"down"},{"l":"Submissões/Dia","v":"2192","t":"+15.0%","d":"up"},{"l":"Documentos Gerados","v":"4.875","t":"-1.7%","d":"down"},{"l":"Templates","v":"7.148","t":"+6.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.686","2026-02-17","8.998","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.482","2026-02-22","6.185","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.081","2026-02-04","1.365","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","478","2026-03-25","7.321","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.506","2026-02-01","3.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":847},{"label":"Mar","value":778},{"label":"Abr","value":978},{"label":"Mai","value":681},{"label":"Jun","value":1031},{"label":"Jul","value":852},{"label":"Ago","value":883},{"label":"Set","value":951},{"label":"Out","value":932},{"label":"Nov","value":744},{"label":"Dez","value":790}];
const MX = 1031;
