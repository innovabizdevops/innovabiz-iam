...
const ACCENT = "#b91c1c";
const MODULE = "Nutrition & Diet Platform";
const PAGE = "Plan";
const KPIS = [{"l":"Formulários Ativos","v":"5.948","t":"-1.8%","d":"down"},{"l":"Submissões/Dia","v":"220","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"6.469","t":"-5.3%","d":"down"},{"l":"Templates","v":"2.235","t":"+1.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.010","2026-01-02","7.661","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.455","2026-01-12","1.308","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.310","2026-03-03","8.334","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.894","2026-03-21","2.152","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.865","2026-02-27","3.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":620},{"label":"Mar","value":571},{"label":"Abr","value":487},{"label":"Mai","value":385},{"label":"Jun","value":582},{"label":"Jul","value":343},{"label":"Ago","value":686},{"label":"Set","value":325},{"label":"Out","value":633},{"label":"Nov","value":405},{"label":"Dez","value":459}];
const MX = 686;
