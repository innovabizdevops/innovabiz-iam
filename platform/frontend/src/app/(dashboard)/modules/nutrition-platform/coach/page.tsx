...
const PAGE = "Coach";
const KPIS = [{"l":"Formulários Ativos","v":"8.378","t":"-3.9%","d":"down"},{"l":"Submissões/Dia","v":"4780","t":"+7.5%","d":"up"},{"l":"Documentos Gerados","v":"329","t":"+10.4%","d":"up"},{"l":"Templates","v":"1.091","t":"+15.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.716","2026-03-01","6.272","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.122","2026-02-09","6.320","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","408","2026-01-15","3.091","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.555","2026-01-14","5.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.289","2026-02-01","1.162","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":817},{"label":"Mar","value":986},{"label":"Abr","value":1020},{"label":"Mai","value":706},{"label":"Jun","value":928},{"label":"Jul","value":877},{"label":"Ago","value":906},{"label":"Set","value":824},{"label":"Out","value":1060},{"label":"Nov","value":897},{"label":"Dez","value":879}];
const MX = 1060;
