...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Security Engine";
const PAGE = "Encrypt";
const KPIS = [{"l":"Total Md Security Engine","v":"3.138","t":"+1.0%","d":"up"},{"l":"Encrypt Ativos","v":"2.339","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"62","t":"+7.1%","d":"up"}];
const COLS = ["ID","Encrypt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Security Engine #001","Md Security Engine #002","4.949","2.696","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Md Security Engine #002","Md Security Engine #003","2.345","8.806","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Security Engine #003","Md Security Engine #004","4.227","8.898","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Md Security Engine #004","Md Security Engine #005","1.632","1.518","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Security Engine #005","Md Security Engine #001","1.987","1.727","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":649},{"label":"Mar","value":590},{"label":"Abr","value":461},{"label":"Mai","value":832},{"label":"Jun","value":815},{"label":"Jul","value":710},{"label":"Ago","value":624},{"label":"Set","value":660},{"label":"Out","value":500},{"label":"Nov","value":841},{"label":"Dez","value":501}];
const MX = 841;
