...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.318","t":"+3.1%","d":"up"},{"l":"NC Abertas","v":"2.223","t":"-2.2%","d":"down"},{"l":"Conformidade (%)","v":"76.3%","t":"+9.0%","d":"up"},{"l":"CAPAs Pendentes","v":"4.870","t":"+3.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.263","80.5%","6.354","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.825","94.9%","8.743","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.263","79.6%","7.072","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.981","87.4%","4.254","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.933","91.5%","7.812","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1053},{"label":"Fev","value":895},{"label":"Mar","value":1011},{"label":"Abr","value":943},{"label":"Mai","value":744},{"label":"Jun","value":955},{"label":"Jul","value":710},{"label":"Ago","value":935},{"label":"Set","value":882},{"label":"Out","value":1063},{"label":"Nov","value":698},{"label":"Dez","value":926}];
const MX = 1063;
