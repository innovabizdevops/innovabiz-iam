...
/* ═══ MD: Multi-Security Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "2188", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3948", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€153K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1522483488", cells: ["MD-8488", "MD: Multi-Security Engine Item 1", "9/1/2026", "€33 588"], status: "active" as const },
    { id: "1522487059", cells: ["MD-3059", "MD: Multi-Security Engine Item 2", "24/8/2026", "€37 159"], status: "pending" as const },
    { id: "1522490630", cells: ["MD-6630", "MD: Multi-Security Engine Item 3", "11/3/2026", "€40 730"], status: "completed" as const },
    { id: "1522494201", cells: ["MD-1201", "MD: Multi-Security Engine Item 4", "26/10/2026", "€44 301"], status: "warning" as const },
    { id: "1522497772", cells: ["MD-4772", "MD: Multi-Security Engine Item 5", "13/5/2026", "€47 872"], status: "active" as const },
];
...
export default function MdMultisecurityEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Security Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Security Engine</p>
                    </div>
                </div>
