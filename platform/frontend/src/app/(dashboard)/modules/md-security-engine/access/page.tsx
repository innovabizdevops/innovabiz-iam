...
const PAGE = "Access";
const KPIS = [{"l":"Total Md Security Engine","v":"3.401","t":"+15.8%","d":"up"},{"l":"Access Ativos","v":"2.530","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+11.0%","d":"up"}];
const COLS = ["ID","Access","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Security Engine #001","Md Security Engine #002","3.259","6.289","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Md Security Engine #002","Md Security Engine #003","5.040","8.348","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Security Engine #003","Md Security Engine #004","3.678","5.279","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Md Security Engine #004","Md Security Engine #005","1.738","1.333","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Security Engine #005","Md Security Engine #001","1.324","3.641","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":832},{"label":"Mar","value":1042},{"label":"Abr","value":841},{"label":"Mai","value":1004},{"label":"Jun","value":955},{"label":"Jul","value":786},{"label":"Ago","value":698},{"label":"Set","value":935},{"label":"Out","value":709},{"label":"Nov","value":1022},{"label":"Dez","value":1000}];
const MX = 1042;
