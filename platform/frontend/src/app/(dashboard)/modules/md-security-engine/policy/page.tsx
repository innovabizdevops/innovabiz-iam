...
const PAGE = "Policy";
const KPIS = [{"l":"Total Md Security Engine","v":"5.662","t":"+2.2%","d":"up"},{"l":"Policy Ativos","v":"8.400","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"77.7%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+10.5%","d":"up"}];
const COLS = ["ID","Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Security Engine #001","Md Security Engine #002","7.032","4.299","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Md Security Engine #002","Md Security Engine #003","5.100","3.651","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Security Engine #003","Md Security Engine #004","7.670","6.441","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Md Security Engine #004","Md Security Engine #005","5.950","6.396","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Security Engine #005","Md Security Engine #001","468","5.943","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":787},{"label":"Mar","value":986},{"label":"Abr","value":784},{"label":"Mai","value":1062},{"label":"Jun","value":857},{"label":"Jul","value":780},{"label":"Ago","value":749},{"label":"Set","value":924},{"label":"Out","value":730},{"label":"Nov","value":929},{"label":"Dez","value":703}];
const MX = 1062;
