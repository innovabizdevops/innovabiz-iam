...
const KPIS = [{"l":"Ativos Registados","v":"7.528","t":"+10.4%","d":"up"},{"l":"Valor Total (€M)","v":"€36.6M","t":"-5.9%","d":"down"},{"l":"Depreciação Anual (€)","v":"€95655","t":"+13.5%","d":"up"},{"l":"Ativos em Garantia","v":"6.356","t":"+10.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 32195.81","3.259","€ 17863.99","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 1383.90","2.238","€ 41806.47","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 49925.10","1.321","€ 20933.87","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 10249.19","3.316","€ 9885.03","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 19419.90","5.604","€ 5556.62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":758},{"label":"Mar","value":470},{"label":"Abr","value":764},{"label":"Mai","value":801},{"label":"Jun","value":806},{"label":"Jul","value":525},{"label":"Ago","value":713},{"label":"Set","value":477},{"label":"Out","value":482},{"label":"Nov","value":523},{"label":"Dez","value":628}];
const MX = 806;
