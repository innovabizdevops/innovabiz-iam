...
const ACCENT = "#4338ca";
const MODULE = "Fixed Assets";
const PAGE = "IFRS 16 Leases";
const KPIS = [{"l":"Ativos Registados","v":"1.833","t":"+14.8%","d":"up"},{"l":"Valor Total (€M)","v":"€3.1M","t":"+2.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€62488","t":"+8.6%","d":"up"},{"l":"Ativos em Garantia","v":"7.692","t":"+8.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 3669.19","5.038","€ 10206.87","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 45074.20","8.424","€ 6256.14","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 10811.78","2.343","€ 17601.21","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 45618.16","184","€ 11038.79","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 13587.59","3.917","€ 41323.30","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":424},{"label":"Mar","value":533},{"label":"Abr","value":430},{"label":"Mai","value":620},{"label":"Jun","value":316},{"label":"Jul","value":325},{"label":"Ago","value":374},{"label":"Set","value":399},{"label":"Out","value":585},{"label":"Nov","value":345},{"label":"Dez","value":546}];
const MX = 620;
