...
const PAGE = "Barcode Scan";
const KPIS = [{"l":"Ativos Registados","v":"8.097","t":"+10.9%","d":"up"},{"l":"Valor Total (€M)","v":"€3.0M","t":"+4.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€12324","t":"+11.6%","d":"up"},{"l":"Ativos em Garantia","v":"7.573","t":"+6.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 16316.95","5.030","€ 21628.93","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 24670.86","919","€ 47204.14","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 25124.90","5.464","€ 10754.99","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 47949.87","6.148","€ 49166.48","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 25977.00","916","€ 44327.76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":410},{"label":"Mar","value":507},{"label":"Abr","value":300},{"label":"Mai","value":358},{"label":"Jun","value":425},{"label":"Jul","value":627},{"label":"Ago","value":597},{"label":"Set","value":560},{"label":"Out","value":413},{"label":"Nov","value":416},{"label":"Dez","value":307}];
const MX = 627;
