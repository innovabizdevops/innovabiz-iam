...
const PAGE = "Impairment Test";
const KPIS = [{"l":"Ativos Registados","v":"2.575","t":"+5.5%","d":"up"},{"l":"Valor Total (€M)","v":"€46.9M","t":"+14.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€28050","t":"+17.1%","d":"up"},{"l":"Ativos em Garantia","v":"682","t":"+16.6%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 42841.15","8.741","€ 2665.74","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 25058.83","5.490","€ 43574.16","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 35156.73","871","€ 31452.25","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 6179.03","6.249","€ 2365.88","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 9733.12","2.151","€ 17482.59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":757},{"label":"Mar","value":646},{"label":"Abr","value":598},{"label":"Mai","value":814},{"label":"Jun","value":729},{"label":"Jul","value":873},{"label":"Ago","value":955},{"label":"Set","value":767},{"label":"Out","value":598},{"label":"Nov","value":651},{"label":"Dez","value":602}];
const MX = 955;
