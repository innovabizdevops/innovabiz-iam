...
const KPIS = [{"l":"Ativos Registados","v":"5.354","t":"-0.7%","d":"down"},{"l":"Valor Total (€M)","v":"€16.0M","t":"+1.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€76204","t":"-0.3%","d":"down"},{"l":"Ativos em Garantia","v":"5.190","t":"+9.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 36547.95","8.685","€ 16331.92","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 15444.79","7.200","€ 5679.56","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 40038.99","3.802","€ 49398.34","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 2380.38","4.586","€ 44876.01","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 40381.48","2.452","€ 13345.94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":255},{"label":"Mar","value":589},{"label":"Abr","value":533},{"label":"Mai","value":377},{"label":"Jun","value":354},{"label":"Jul","value":466},{"label":"Ago","value":480},{"label":"Set","value":281},{"label":"Out","value":593},{"label":"Nov","value":243},{"label":"Dez","value":306}];
const MX = 593;
