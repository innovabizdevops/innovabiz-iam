...
const PAGE = "Asset Register";
const KPIS = [{"l":"Ativos Registados","v":"7.306","t":"-2.0%","d":"down"},{"l":"Valor Total (€M)","v":"€3.5M","t":"+13.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€32396","t":"+11.3%","d":"up"},{"l":"Ativos em Garantia","v":"5.511","t":"-4.8%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 45546.51","4.594","€ 37026.42","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 26680.73","4.893","€ 25001.54","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 14848.40","6.989","€ 10451.47","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 23475.90","7.632","€ 22162.77","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 14641.71","7.736","€ 36617.24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":770},{"label":"Mar","value":911},{"label":"Abr","value":745},{"label":"Mai","value":638},{"label":"Jun","value":686},{"label":"Jul","value":867},{"label":"Ago","value":901},{"label":"Set","value":760},{"label":"Out","value":540},{"label":"Nov","value":855},{"label":"Dez","value":801}];
const MX = 911;
