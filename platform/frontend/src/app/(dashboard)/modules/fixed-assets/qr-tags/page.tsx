...
const PAGE = "Asset Tagging QR";
const KPIS = [{"l":"Ativos Registados","v":"7.470","t":"+11.6%","d":"up"},{"l":"Valor Total (€M)","v":"€15.9M","t":"+2.7%","d":"up"},{"l":"Depreciação Anual (€)","v":"€52306","t":"+8.0%","d":"up"},{"l":"Ativos em Garantia","v":"3.597","t":"+11.1%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 816.55","5.398","€ 28333.30","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 24632.39","7.819","€ 6149.12","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 998.60","474","€ 33770.76","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 42796.31","5.849","€ 43837.51","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 23329.75","4.632","€ 9401.92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":495},{"label":"Mar","value":410},{"label":"Abr","value":533},{"label":"Mai","value":456},{"label":"Jun","value":426},{"label":"Jul","value":386},{"label":"Ago","value":613},{"label":"Set","value":663},{"label":"Out","value":347},{"label":"Nov","value":393},{"label":"Dez","value":627}];
const MX = 708;
