...
/* ═══ Forestry Management — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "9515", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "273", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€374K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1210878415", cells: ["FOR-1415", "Forestry Management Item 1", "20/8/2026", "€28 515"], status: "active" as const },
    { id: "1210881986", cells: ["FOR-4986", "Forestry Management Item 2", "7/3/2026", "€32 086"], status: "pending" as const },
    { id: "1210885557", cells: ["FOR-8557", "Forestry Management Item 3", "22/10/2026", "€35 657"], status: "completed" as const },
    { id: "1210889128", cells: ["FOR-3128", "Forestry Management Item 4", "9/5/2026", "€39 228"], status: "warning" as const },
    { id: "1210892699", cells: ["FOR-6699", "Forestry Management Item 5", "24/12/2026", "€42 799"], status: "active" as const },
];
...
export default function ForestryManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forestry Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Forestry Management</p>
                    </div>
                </div>
