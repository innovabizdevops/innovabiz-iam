...
const PAGE = "Replant";
const KPIS = [{"l":"Total Forestry Mgmt","v":"1.017","t":"+2.7%","d":"up"},{"l":"Replant Ativos","v":"5.839","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.6%","d":"up"}];
const COLS = ["ID","Replant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forestry Mgmt #001","Forestry Mgmt #002","4.794","3.174","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Forestry Mgmt #002","Forestry Mgmt #003","1.591","4.929","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Forestry Mgmt #003","Forestry Mgmt #004","2.171","4.232","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Forestry Mgmt #004","Forestry Mgmt #005","8.798","8.361","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forestry Mgmt #005","Forestry Mgmt #001","8.035","2.159","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":742},{"label":"Mar","value":784},{"label":"Abr","value":761},{"label":"Mai","value":845},{"label":"Jun","value":868},{"label":"Jul","value":742},{"label":"Ago","value":665},{"label":"Set","value":679},{"label":"Out","value":854},{"label":"Nov","value":800},{"label":"Dez","value":684}];
const MX = 955;
...
export default function ReplantPage() {
    return (
