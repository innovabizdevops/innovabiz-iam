...
const ACCENT = "#166534";
const MODULE = "Forestry Management";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Forestry Mgmt","v":"6.266","t":"+0.3%","d":"up"},{"l":"Inventory Ativos","v":"7.759","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"91","t":"+14.4%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forestry Mgmt #001","Forestry Mgmt #002","7.962","4.153","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Forestry Mgmt #002","Forestry Mgmt #003","5.071","6.893","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Forestry Mgmt #003","Forestry Mgmt #004","6.704","1.214","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Forestry Mgmt #004","Forestry Mgmt #005","5.807","4.997","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forestry Mgmt #005","Forestry Mgmt #001","6.063","4.322","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":745},{"label":"Mar","value":863},{"label":"Abr","value":724},{"label":"Mai","value":907},{"label":"Jun","value":1000},{"label":"Jul","value":679},{"label":"Ago","value":715},{"label":"Set","value":638},{"label":"Out","value":800},{"label":"Nov","value":812},{"label":"Dez","value":690}];
const MX = 1000;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#166534'}}>GIS</span></h1>
                </div>
