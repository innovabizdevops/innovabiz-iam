...
const PAGE = "Strategy";
const KPIS = [{"l":"Total National Defense","v":"3.876","t":"+6.8%","d":"up"},{"l":"Strategy Ativos","v":"3.344","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"67","t":"+12.9%","d":"up"}];
const COLS = ["ID","Strategy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["National Defense #001","National Defense #002","7.595","6.743","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["National Defense #002","National Defense #003","8.406","6.965","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["National Defense #003","National Defense #004","8.997","2.990","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["National Defense #004","National Defense #005","6.964","8.885","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["National Defense #005","National Defense #001","4.061","8.316","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":626},{"label":"Mar","value":627},{"label":"Abr","value":488},{"label":"Mai","value":333},{"label":"Jun","value":392},{"label":"Jul","value":638},{"label":"Ago","value":569},{"label":"Set","value":327},{"label":"Out","value":276},{"label":"Nov","value":531},{"label":"Dez","value":357}];
const MX = 638;
