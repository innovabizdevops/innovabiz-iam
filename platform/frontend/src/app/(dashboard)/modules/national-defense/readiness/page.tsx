...
const KPIS = [{"l":"Total National Defense","v":"5.929","t":"+3.2%","d":"up"},{"l":"Readiness Ativos","v":"4.859","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"86","t":"+9.4%","d":"up"}];
const COLS = ["ID","Readiness","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["National Defense #001","National Defense #002","5.314","710","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["National Defense #002","National Defense #003","4.877","5.866","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["National Defense #003","National Defense #004","2.816","1.401","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["National Defense #004","National Defense #005","1.142","8.972","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["National Defense #005","National Defense #001","8.649","6.986","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":435},{"label":"Mar","value":423},{"label":"Abr","value":703},{"label":"Mai","value":440},{"label":"Jun","value":431},{"label":"Jul","value":629},{"label":"Ago","value":608},{"label":"Set","value":600},{"label":"Out","value":371},{"label":"Nov","value":389},{"label":"Dez","value":532}];
const MX = 703;
