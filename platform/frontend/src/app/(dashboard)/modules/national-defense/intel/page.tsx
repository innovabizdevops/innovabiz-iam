...
const ACCENT = "#6366f1";
const MODULE = "National Defense";
const PAGE = "Intelligence";
const KPIS = [{"l":"Total National Defense","v":"1.957","t":"+2.5%","d":"up"},{"l":"Intelligence Ativos","v":"4.063","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"71.7%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"62","t":"+3.0%","d":"up"}];
const COLS = ["ID","Intelligence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["National Defense #001","National Defense #002","6.658","7.848","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["National Defense #002","National Defense #003","8.015","3.849","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["National Defense #003","National Defense #004","6.510","1.793","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["National Defense #004","National Defense #005","4.765","5.628","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["National Defense #005","National Defense #001","4.166","7.472","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":228},{"label":"Fev","value":559},{"label":"Mar","value":453},{"label":"Abr","value":380},{"label":"Mai","value":519},{"label":"Jun","value":384},{"label":"Jul","value":521},{"label":"Ago","value":588},{"label":"Set","value":601},{"label":"Out","value":594},{"label":"Nov","value":454},{"label":"Dez","value":250}];
const MX = 601;
