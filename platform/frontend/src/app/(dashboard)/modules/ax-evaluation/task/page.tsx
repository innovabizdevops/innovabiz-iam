...
const PAGE = "Task Eval";
const KPIS = [{"l":"Total Ax Evaluation","v":"3.031","t":"+3.4%","d":"up"},{"l":"Task Eval Ativos","v":"8.010","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"81.4%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"84","t":"+2.8%","d":"up"}];
const COLS = ["ID","Task Eval","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Evaluation #001","Ax Evaluation #002","2.302","7.989","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Evaluation #002","Ax Evaluation #003","4.455","2.623","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Evaluation #003","Ax Evaluation #004","4.048","4.596","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Evaluation #004","Ax Evaluation #005","3.679","5.622","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Evaluation #005","Ax Evaluation #001","1.674","8.404","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":1091},{"label":"Mar","value":971},{"label":"Abr","value":903},{"label":"Mai","value":871},{"label":"Jun","value":882},{"label":"Jul","value":872},{"label":"Ago","value":798},{"label":"Set","value":808},{"label":"Out","value":836},{"label":"Nov","value":803},{"label":"Dez","value":775}];
const MX = 1091;
