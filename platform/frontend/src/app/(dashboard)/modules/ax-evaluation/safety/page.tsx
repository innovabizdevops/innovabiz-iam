...
const ACCENT = "#4f46e5";
const MODULE = "AX Agent Evaluation";
const PAGE = "Safety Eval";
const KPIS = [{"l":"Total Ax Evaluation","v":"7.661","t":"+14.0%","d":"up"},{"l":"Safety Eval Ativos","v":"1.486","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"56","t":"+10.7%","d":"up"}];
const COLS = ["ID","Safety Eval","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Evaluation #001","Ax Evaluation #002","4.222","4.108","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Evaluation #002","Ax Evaluation #003","3.797","7.834","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Evaluation #003","Ax Evaluation #004","5.980","5.007","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Evaluation #004","Ax Evaluation #005","6.606","3.863","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Evaluation #005","Ax Evaluation #001","5.998","4.433","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":443},{"label":"Mar","value":587},{"label":"Abr","value":430},{"label":"Mai","value":519},{"label":"Jun","value":670},{"label":"Jul","value":577},{"label":"Ago","value":497},{"label":"Set","value":405},{"label":"Out","value":467},{"label":"Nov","value":741},{"label":"Dez","value":722}];
const MX = 741;
