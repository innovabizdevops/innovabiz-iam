...
const PAGE = "Report";
const KPIS = [{"l":"Total Ax Evaluation","v":"8.225","t":"+17.7%","d":"up"},{"l":"Report Ativos","v":"228","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"66.0%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"72","t":"-1.2%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Evaluation #001","Ax Evaluation #002","5.328","5.027","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Evaluation #002","Ax Evaluation #003","5.723","6.088","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Evaluation #003","Ax Evaluation #004","5.630","8.945","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Evaluation #004","Ax Evaluation #005","7.328","1.098","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Evaluation #005","Ax Evaluation #001","8.545","5.670","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":1068},{"label":"Mar","value":1011},{"label":"Abr","value":1017},{"label":"Mai","value":837},{"label":"Jun","value":760},{"label":"Jul","value":904},{"label":"Ago","value":844},{"label":"Set","value":895},{"label":"Out","value":715},{"label":"Nov","value":949},{"label":"Dez","value":894}];
const MX = 1068;
