...
const KPIS = [{"l":"Total Ax Evaluation","v":"3.453","t":"-3.0%","d":"down"},{"l":"Benchmark Ativos","v":"592","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"63","t":"-5.2%","d":"down"}];
const COLS = ["ID","Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Evaluation #001","Ax Evaluation #002","3.044","3.741","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Evaluation #002","Ax Evaluation #003","4.418","4.122","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Evaluation #003","Ax Evaluation #004","1.427","2.704","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Evaluation #004","Ax Evaluation #005","8.314","4.815","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Evaluation #005","Ax Evaluation #001","3.522","5.245","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":847},{"label":"Mar","value":820},{"label":"Abr","value":689},{"label":"Mai","value":697},{"label":"Jun","value":632},{"label":"Jul","value":896},{"label":"Ago","value":780},{"label":"Set","value":730},{"label":"Out","value":744},{"label":"Nov","value":860},{"label":"Dez","value":787}];
const MX = 896;
