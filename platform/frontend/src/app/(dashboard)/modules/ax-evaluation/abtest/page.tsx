...
const PAGE = "A/B Test";
const KPIS = [{"l":"Total Ax Evaluation","v":"1.935","t":"+10.6%","d":"up"},{"l":"A/B Test Ativos","v":"4.895","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"80","t":"+12.1%","d":"up"}];
const COLS = ["ID","A/B Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Evaluation #001","Ax Evaluation #002","7.568","8.724","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Evaluation #002","Ax Evaluation #003","8.238","2.913","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Evaluation #003","Ax Evaluation #004","8.171","4.464","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Evaluation #004","Ax Evaluation #005","8.915","2.726","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Evaluation #005","Ax Evaluation #001","4.891","6.059","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":743},{"label":"Mar","value":975},{"label":"Abr","value":898},{"label":"Mai","value":1018},{"label":"Jun","value":728},{"label":"Jul","value":833},{"label":"Ago","value":894},{"label":"Set","value":792},{"label":"Out","value":667},{"label":"Nov","value":629},{"label":"Dez","value":785}];
const MX = 1018;
