...
/* ═══ AX Agent Evaluation — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "1575", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1028", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€406K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "554906375", cells: ["AX-3375", "AX Agent Evaluation Item 1", "24/12/2026", "€6475"], status: "active" as const },
    { id: "554909946", cells: ["AX-6946", "AX Agent Evaluation Item 2", "11/7/2026", "€10 046"], status: "pending" as const },
    { id: "554913517", cells: ["AX-1517", "AX Agent Evaluation Item 3", "26/2/2026", "€13 617"], status: "completed" as const },
    { id: "554917088", cells: ["AX-5088", "AX Agent Evaluation Item 4", "13/9/2026", "€17 188"], status: "warning" as const },
    { id: "554920659", cells: ["AX-8659", "AX Agent Evaluation Item 5", "28/4/2026", "€20 759"], status: "active" as const },
];
...
export default function AxAgentEvaluationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Agent Evaluation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Agent Evaluation</p>
                    </div>
                </div>
