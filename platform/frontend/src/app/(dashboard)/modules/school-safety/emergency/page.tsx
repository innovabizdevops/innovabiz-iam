...
const KPIS = [{"l":"Total School Safety","v":"4.983","t":"+9.5%","d":"up"},{"l":"Emergency Ativos","v":"4.144","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+10.5%","d":"up"}];
const COLS = ["ID","Emergency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Safety #001","School Safety #002","6.785","6.441","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["School Safety #002","School Safety #003","4.008","2.535","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["School Safety #003","School Safety #004","1.160","3.469","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["School Safety #004","School Safety #005","7.173","6.981","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Safety #005","School Safety #001","7.262","5.675","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":842},{"label":"Mar","value":539},{"label":"Abr","value":568},{"label":"Mai","value":624},{"label":"Jun","value":487},{"label":"Jul","value":610},{"label":"Ago","value":457},{"label":"Set","value":453},{"label":"Out","value":724},{"label":"Nov","value":513},{"label":"Dez","value":531}];
const MX = 842;
