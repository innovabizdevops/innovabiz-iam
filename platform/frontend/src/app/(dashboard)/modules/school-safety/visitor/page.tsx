...
const PAGE = "Visitor";
const KPIS = [{"l":"Total School Safety","v":"7.044","t":"+14.9%","d":"up"},{"l":"Visitor Ativos","v":"966","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"91","t":"+6.8%","d":"up"}];
const COLS = ["ID","Visitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Safety #001","School Safety #002","5.524","5.145","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["School Safety #002","School Safety #003","3.468","7.109","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["School Safety #003","School Safety #004","1.952","6.693","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["School Safety #004","School Safety #005","9.086","5.662","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Safety #005","School Safety #001","7.676","1.052","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":843},{"label":"Mar","value":649},{"label":"Abr","value":784},{"label":"Mai","value":600},{"label":"Jun","value":620},{"label":"Jul","value":824},{"label":"Ago","value":735},{"label":"Set","value":701},{"label":"Out","value":720},{"label":"Nov","value":880},{"label":"Dez","value":959}];
const MX = 959;
