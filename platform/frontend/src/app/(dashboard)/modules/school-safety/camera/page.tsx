...
const ACCENT = "#6366f1";
const MODULE = "School Safety";
const PAGE = "Camera";
const KPIS = [{"l":"Total School Safety","v":"2.717","t":"-2.2%","d":"down"},{"l":"Camera Ativos","v":"1.845","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.8%","d":"up"}];
const COLS = ["ID","Camera","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Safety #001","School Safety #002","2.995","3.890","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["School Safety #002","School Safety #003","1.926","7.661","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["School Safety #003","School Safety #004","4.131","1.908","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["School Safety #004","School Safety #005","3.574","5.016","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Safety #005","School Safety #001","9.076","3.464","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":744},{"label":"Mar","value":732},{"label":"Abr","value":556},{"label":"Mai","value":580},{"label":"Jun","value":659},{"label":"Jul","value":893},{"label":"Ago","value":675},{"label":"Set","value":800},{"label":"Out","value":664},{"label":"Nov","value":538},{"label":"Dez","value":779}];
const MX = 893;
