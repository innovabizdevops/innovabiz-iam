...
const PAGE = "Drill";
const KPIS = [{"l":"Total School Safety","v":"4.971","t":"+2.5%","d":"up"},{"l":"Drill Ativos","v":"1.308","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+6.5%","d":"up"}];
const COLS = ["ID","Drill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Safety #001","School Safety #002","1.304","6.035","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["School Safety #002","School Safety #003","2.380","2.152","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["School Safety #003","School Safety #004","3.031","1.615","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["School Safety #004","School Safety #005","3.788","4.474","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Safety #005","School Safety #001","827","2.215","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":590},{"label":"Mar","value":838},{"label":"Abr","value":761},{"label":"Mai","value":838},{"label":"Jun","value":587},{"label":"Jul","value":616},{"label":"Ago","value":899},{"label":"Set","value":743},{"label":"Out","value":740},{"label":"Nov","value":869},{"label":"Dez","value":731}];
const MX = 899;
