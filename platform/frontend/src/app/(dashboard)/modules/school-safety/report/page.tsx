...
const PAGE = "Report";
const KPIS = [{"l":"Total School Safety","v":"1.743","t":"+2.2%","d":"up"},{"l":"Report Ativos","v":"1.174","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"93.8%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+0.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Safety #001","School Safety #002","1.690","366","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["School Safety #002","School Safety #003","7.296","2.810","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["School Safety #003","School Safety #004","900","368","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["School Safety #004","School Safety #005","6.282","160","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Safety #005","School Safety #001","7.515","4.358","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":778},{"label":"Mar","value":874},{"label":"Abr","value":936},{"label":"Mai","value":755},{"label":"Jun","value":837},{"label":"Jul","value":645},{"label":"Ago","value":846},{"label":"Set","value":560},{"label":"Out","value":582},{"label":"Nov","value":579},{"label":"Dez","value":778}];
const MX = 936;
