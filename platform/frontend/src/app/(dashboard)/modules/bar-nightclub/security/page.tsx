...
const ACCENT = "#6366f1";
const MODULE = "Bar & Nightclub";
const PAGE = "Security";
const KPIS = [{"l":"Total Bar Nightclub","v":"6.211","t":"+17.5%","d":"up"},{"l":"Security Ativos","v":"2.362","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"76.8%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+14.2%","d":"up"}];
const COLS = ["ID","Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bar Nightclub #001","Bar Nightclub #002","8.940","7.481","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Bar Nightclub #002","Bar Nightclub #003","8.200","3.923","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Bar Nightclub #003","Bar Nightclub #004","3.775","4.886","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Bar Nightclub #004","Bar Nightclub #005","3.350","5.728","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bar Nightclub #005","Bar Nightclub #001","1.348","6.528","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":511},{"label":"Mar","value":698},{"label":"Abr","value":664},{"label":"Mai","value":601},{"label":"Jun","value":602},{"label":"Jul","value":600},{"label":"Ago","value":469},{"label":"Set","value":574},{"label":"Out","value":649},{"label":"Nov","value":773},{"label":"Dez","value":831}];
const MX = 831;
