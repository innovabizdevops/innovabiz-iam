...
const KPIS = [{"l":"Total Bar Nightclub","v":"1.546","t":"+1.1%","d":"up"},{"l":"Inventory Ativos","v":"1.681","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"56","t":"+15.5%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bar Nightclub #001","Bar Nightclub #002","942","221","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Bar Nightclub #002","Bar Nightclub #003","3.060","3.022","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Bar Nightclub #003","Bar Nightclub #004","3.370","4.917","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Bar Nightclub #004","Bar Nightclub #005","6.162","183","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bar Nightclub #005","Bar Nightclub #001","6.512","4.237","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":737},{"label":"Mar","value":552},{"label":"Abr","value":583},{"label":"Mai","value":755},{"label":"Jun","value":546},{"label":"Jul","value":406},{"label":"Ago","value":705},{"label":"Set","value":514},{"label":"Out","value":746},{"label":"Nov","value":657},{"label":"Dez","value":632}];
const MX = 755;
