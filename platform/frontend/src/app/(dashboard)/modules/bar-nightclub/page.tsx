...
export default function BarNightclubPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Bar Nightclub</h1><p className="text-sm text-muted-foreground">Bar Nightclub • iBOS Enterprise</p></div>
