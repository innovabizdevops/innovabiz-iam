...
const PAGE = "VIP";
const KPIS = [{"l":"Total Bar Nightclub","v":"2.790","t":"-3.4%","d":"down"},{"l":"VIP Ativos","v":"1.221","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"73.0%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"68","t":"+12.6%","d":"up"}];
const COLS = ["ID","VIP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bar Nightclub #001","Bar Nightclub #002","853","1.851","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Bar Nightclub #002","Bar Nightclub #003","9.033","6.158","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Bar Nightclub #003","Bar Nightclub #004","8.225","1.144","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Bar Nightclub #004","Bar Nightclub #005","6.506","8.489","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bar Nightclub #005","Bar Nightclub #001","5.078","1.855","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":850},{"label":"Mar","value":683},{"label":"Abr","value":819},{"label":"Mai","value":731},{"label":"Jun","value":952},{"label":"Jul","value":717},{"label":"Ago","value":733},{"label":"Set","value":972},{"label":"Out","value":672},{"label":"Nov","value":595},{"label":"Dez","value":718}];
const MX = 972;
