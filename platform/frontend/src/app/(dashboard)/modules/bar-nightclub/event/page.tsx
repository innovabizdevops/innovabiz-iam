...
const PAGE = "Event";
const KPIS = [{"l":"Total Bar Nightclub","v":"5.750","t":"-1.3%","d":"down"},{"l":"Event Ativos","v":"8.225","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"81.0%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"67","t":"-3.2%","d":"down"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bar Nightclub #001","Bar Nightclub #002","1.613","6.628","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Bar Nightclub #002","Bar Nightclub #003","3.437","7.014","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Bar Nightclub #003","Bar Nightclub #004","5.435","6.147","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Bar Nightclub #004","Bar Nightclub #005","7.634","4.082","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bar Nightclub #005","Bar Nightclub #001","2.591","5.121","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":928},{"label":"Mar","value":735},{"label":"Abr","value":677},{"label":"Mai","value":788},{"label":"Jun","value":781},{"label":"Jul","value":870},{"label":"Ago","value":667},{"label":"Set","value":918},{"label":"Out","value":699},{"label":"Nov","value":974},{"label":"Dez","value":831}];
const MX = 974;
