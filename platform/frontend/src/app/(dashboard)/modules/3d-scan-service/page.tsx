...
/* ═══ 3D Scanning Service — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "4428", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1974", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€60K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "541692728", cells: ["3D-1728", "3D Scanning Service Item 1", "25/9/2026", "€42 828"], status: "active" as const },
    { id: "541696299", cells: ["3D-5299", "3D Scanning Service Item 2", "12/4/2026", "€46 399"], status: "pending" as const },
    { id: "541699870", cells: ["3D-8870", "3D Scanning Service Item 3", "27/11/2026", "€49 970"], status: "completed" as const },
    { id: "541703441", cells: ["3D-3441", "3D Scanning Service Item 4", "14/6/2026", "€3541"], status: "warning" as const },
    { id: "541707012", cells: ["3D-7012", "3D Scanning Service Item 5", "1/1/2026", "€7112"], status: "active" as const },
];
...
export default function P3dScanningServicePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Scanning Service</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Scanning Service</p>
                    </div>
                </div>
