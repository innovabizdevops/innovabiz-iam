...
const PAGE = "Scan";
const KPIS = [{"l":"Total 3d Scan Service","v":"4.930","t":"+15.4%","d":"up"},{"l":"Scan Ativos","v":"1.967","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+7.7%","d":"up"}];
const COLS = ["ID","Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Scan Service #001","3d Scan Service #002","8.389","6.581","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["3d Scan Service #002","3d Scan Service #003","5.699","1.396","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Scan Service #003","3d Scan Service #004","1.831","5.417","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["3d Scan Service #004","3d Scan Service #005","2.008","4.930","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Scan Service #005","3d Scan Service #001","4.997","9.068","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":727},{"label":"Mar","value":794},{"label":"Abr","value":524},{"label":"Mai","value":797},{"label":"Jun","value":629},{"label":"Jul","value":716},{"label":"Ago","value":488},{"label":"Set","value":793},{"label":"Out","value":668},{"label":"Nov","value":712},{"label":"Dez","value":662}];
const MX = 797;
