...
const PAGE = "Deliver";
const KPIS = [{"l":"Total 3d Scan Service","v":"964","t":"-5.8%","d":"down"},{"l":"Deliver Ativos","v":"7.186","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+0.8%","d":"up"}];
const COLS = ["ID","Deliver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Scan Service #001","3d Scan Service #002","7.891","3.222","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["3d Scan Service #002","3d Scan Service #003","5.624","6.852","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Scan Service #003","3d Scan Service #004","8.217","7.127","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["3d Scan Service #004","3d Scan Service #005","1.130","3.915","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Scan Service #005","3d Scan Service #001","445","4.805","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":1035},{"label":"Mar","value":1016},{"label":"Abr","value":1017},{"label":"Mai","value":1078},{"label":"Jun","value":869},{"label":"Jul","value":829},{"label":"Ago","value":714},{"label":"Set","value":857},{"label":"Out","value":953},{"label":"Nov","value":924},{"label":"Dez","value":712}];
const MX = 1078;
