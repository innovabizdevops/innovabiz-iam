...
const PAGE = "Process";
const KPIS = [{"l":"Total 3d Scan Service","v":"6.086","t":"+3.0%","d":"up"},{"l":"Process Ativos","v":"2.540","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"75","t":"+0.2%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Scan Service #001","3d Scan Service #002","4.288","7.855","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["3d Scan Service #002","3d Scan Service #003","7.258","5.685","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Scan Service #003","3d Scan Service #004","4.295","1.370","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["3d Scan Service #004","3d Scan Service #005","833","7.818","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Scan Service #005","3d Scan Service #001","1.550","5.169","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":731},{"label":"Mar","value":682},{"label":"Abr","value":725},{"label":"Mai","value":594},{"label":"Jun","value":637},{"label":"Jul","value":546},{"label":"Ago","value":495},{"label":"Set","value":627},{"label":"Out","value":673},{"label":"Nov","value":711},{"label":"Dez","value":450}];
const MX = 731;
