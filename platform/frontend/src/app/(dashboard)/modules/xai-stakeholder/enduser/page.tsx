...
const PAGE = "End User";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.302","t":"+14.2%","d":"up"},{"l":"Sessões/Dia","v":"2868","t":"+10.5%","d":"up"},{"l":"MFA Adoção (%)","v":"91.8%","t":"+9.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.235","t":"+8.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.459","6.302","521","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.655","527","5.746","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.407","3.978","2.665","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","393","2.626","4.261","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.691","497","5.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":604},{"label":"Mar","value":397},{"label":"Abr","value":511},{"label":"Mai","value":464},{"label":"Jun","value":375},{"label":"Jul","value":539},{"label":"Ago","value":457},{"label":"Set","value":330},{"label":"Out","value":373},{"label":"Nov","value":605},{"label":"Dez","value":640}];
const MX = 640;
