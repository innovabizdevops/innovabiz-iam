...
const KPIS = [{"l":"Total Xai Stakeholder","v":"4.081","t":"+14.7%","d":"up"},{"l":"Executive Ativos","v":"5.335","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"55","t":"+2.5%","d":"up"}];
const COLS = ["ID","Executive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Xai Stakeholder #001","Xai Stakeholder #002","6.420","8.856","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Xai Stakeholder #002","Xai Stakeholder #003","4.411","1.618","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Xai Stakeholder #003","Xai Stakeholder #004","3.451","3.310","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Xai Stakeholder #004","Xai Stakeholder #005","901","4.096","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Xai Stakeholder #005","Xai Stakeholder #001","775","4.192","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":461},{"label":"Mar","value":660},{"label":"Abr","value":522},{"label":"Mai","value":454},{"label":"Jun","value":781},{"label":"Jul","value":422},{"label":"Ago","value":579},{"label":"Set","value":652},{"label":"Out","value":699},{"label":"Nov","value":498},{"label":"Dez","value":691}];
const MX = 781;
