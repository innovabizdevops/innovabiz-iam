...
const ACCENT = "#d97706";
const MODULE = "XAI Stakeholder Reports";
const PAGE = "Regulator";
const KPIS = [{"l":"Total Xai Stakeholder","v":"1.325","t":"-0.6%","d":"down"},{"l":"Regulator Ativos","v":"2.528","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+11.9%","d":"up"}];
const COLS = ["ID","Regulator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Xai Stakeholder #001","Xai Stakeholder #002","6.397","3.880","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Xai Stakeholder #002","Xai Stakeholder #003","1.690","9.066","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Xai Stakeholder #003","Xai Stakeholder #004","7.146","3.922","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Xai Stakeholder #004","Xai Stakeholder #005","2.716","7.611","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Xai Stakeholder #005","Xai Stakeholder #001","5.052","6.618","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":879},{"label":"Mar","value":660},{"label":"Abr","value":812},{"label":"Mai","value":744},{"label":"Jun","value":1035},{"label":"Jul","value":839},{"label":"Ago","value":665},{"label":"Set","value":769},{"label":"Out","value":886},{"label":"Nov","value":653},{"label":"Dez","value":931}];
const MX = 1035;
