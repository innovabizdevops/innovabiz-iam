...
const PAGE = "Public";
const KPIS = [{"l":"Total Xai Stakeholder","v":"3.136","t":"-0.9%","d":"down"},{"l":"Public Ativos","v":"1.840","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"69.4%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"84","t":"-2.5%","d":"down"}];
const COLS = ["ID","Public","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Xai Stakeholder #001","Xai Stakeholder #002","4.041","7.344","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Xai Stakeholder #002","Xai Stakeholder #003","4.081","3.466","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Xai Stakeholder #003","Xai Stakeholder #004","6.429","239","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Xai Stakeholder #004","Xai Stakeholder #005","4.370","2.982","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Xai Stakeholder #005","Xai Stakeholder #001","4.711","4.890","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":578},{"label":"Mar","value":640},{"label":"Abr","value":808},{"label":"Mai","value":742},{"label":"Jun","value":780},{"label":"Jul","value":774},{"label":"Ago","value":819},{"label":"Set","value":777},{"label":"Out","value":787},{"label":"Nov","value":688},{"label":"Dez","value":687}];
const MX = 819;
