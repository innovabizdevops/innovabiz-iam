...
const PAGE = "Technical";
const KPIS = [{"l":"Total Xai Stakeholder","v":"4.112","t":"+13.9%","d":"up"},{"l":"Technical Ativos","v":"1.968","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"94","t":"-4.6%","d":"down"}];
const COLS = ["ID","Technical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Xai Stakeholder #001","Xai Stakeholder #002","3.395","314","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Xai Stakeholder #002","Xai Stakeholder #003","5.216","7.875","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Xai Stakeholder #003","Xai Stakeholder #004","8.169","1.151","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Xai Stakeholder #004","Xai Stakeholder #005","6.138","2.844","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Xai Stakeholder #005","Xai Stakeholder #001","2.720","1.028","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":591},{"label":"Mar","value":882},{"label":"Abr","value":567},{"label":"Mai","value":578},{"label":"Jun","value":646},{"label":"Jul","value":731},{"label":"Ago","value":558},{"label":"Set","value":648},{"label":"Out","value":563},{"label":"Nov","value":719},{"label":"Dez","value":892}];
const MX = 892;
