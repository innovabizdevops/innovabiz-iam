...
/* ═══ XAI Stakeholder Reports — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "856", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "582", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€154K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1650063456", cells: ["XAI-4456", "XAI Stakeholder Reports Item 1", "21/1/2026", "€13 556"], status: "active" as const },
    { id: "1650067027", cells: ["XAI-8027", "XAI Stakeholder Reports Item 2", "8/8/2026", "€17 127"], status: "pending" as const },
    { id: "1650070598", cells: ["XAI-2598", "XAI Stakeholder Reports Item 3", "23/3/2026", "€20 698"], status: "completed" as const },
    { id: "1650074169", cells: ["XAI-6169", "XAI Stakeholder Reports Item 4", "10/10/2026", "€24 269"], status: "warning" as const },
    { id: "1650077740", cells: ["XAI-9740", "XAI Stakeholder Reports Item 5", "25/5/2026", "€27 840"], status: "active" as const },
];
...
export default function XaiStakeholderReportsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XAI Stakeholder Reports</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XAI Stakeholder Reports</p>
                    </div>
                </div>
