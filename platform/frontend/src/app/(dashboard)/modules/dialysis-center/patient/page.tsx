...
const ACCENT = "#0891b2";
const MODULE = "Dialysis Center";
const PAGE = "Patient";
const KPIS = [{"l":"Total Dialysis Center","v":"6.324","t":"+3.3%","d":"up"},{"l":"Patient Ativos","v":"7.383","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"92","t":"-0.6%","d":"down"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dialysis Center #001","Dialysis Center #002","4.113","4.017","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Dialysis Center #002","Dialysis Center #003","6.713","3.723","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Dialysis Center #003","Dialysis Center #004","7.476","8.518","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Dialysis Center #004","Dialysis Center #005","8.580","6.149","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dialysis Center #005","Dialysis Center #001","1.651","1.135","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1080},{"label":"Fev","value":941},{"label":"Mar","value":734},{"label":"Abr","value":761},{"label":"Mai","value":949},{"label":"Jun","value":800},{"label":"Jul","value":808},{"label":"Ago","value":757},{"label":"Set","value":1003},{"label":"Out","value":862},{"label":"Nov","value":925},{"label":"Dez","value":925}];
const MX = 1080;
