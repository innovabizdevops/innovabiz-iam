...
const KPIS = [
    { label: "Total Registos", value: "3745", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "441", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€65K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "91657845", cells: ["DIA-2845", "Dialysis Center Item 1", "14/10/2026", "€7945"], status: "active" as const },
    { id: "91661416", cells: ["DIA-6416", "Dialysis Center Item 2", "1/5/2026", "€11 516"], status: "pending" as const },
    { id: "91664987", cells: ["DIA-9987", "Dialysis Center Item 3", "16/12/2026", "€15 087"], status: "completed" as const },
    { id: "91668558", cells: ["DIA-4558", "Dialysis Center Item 4", "3/7/2026", "€18 658"], status: "warning" as const },
    { id: "91672129", cells: ["DIA-8129", "Dialysis Center Item 5", "18/2/2026", "€22 229"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dialysis Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dialysis Center</p>
                    </div>
                </div>
