...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Dialysis Center","v":"2.052","t":"+2.3%","d":"up"},{"l":"Schedule Ativos","v":"1.664","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"89.1%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"78","t":"-1.3%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dialysis Center #001","Dialysis Center #002","5.393","6.219","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Dialysis Center #002","Dialysis Center #003","5.681","2.497","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Dialysis Center #003","Dialysis Center #004","5.764","6.846","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Dialysis Center #004","Dialysis Center #005","856","2.022","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dialysis Center #005","Dialysis Center #001","7.763","1.151","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":952},{"label":"Mar","value":915},{"label":"Abr","value":939},{"label":"Mai","value":734},{"label":"Jun","value":608},{"label":"Jul","value":981},{"label":"Ago","value":976},{"label":"Set","value":599},{"label":"Out","value":844},{"label":"Nov","value":775},{"label":"Dez","value":811}];
const MX = 981;
