...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.511","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"3223","t":"+12.4%","d":"up"},{"l":"Documentos Gerados","v":"4.319","t":"+7.5%","d":"up"},{"l":"Templates","v":"1.686","t":"+9.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.344","2026-03-20","3.545","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.248","2026-01-18","5.189","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.501","2026-03-17","5.852","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.164","2026-01-15","1.848","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.684","2026-02-17","4.684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":752},{"label":"Mar","value":717},{"label":"Abr","value":697},{"label":"Mai","value":513},{"label":"Jun","value":556},{"label":"Jul","value":477},{"label":"Ago","value":596},{"label":"Set","value":395},{"label":"Out","value":594},{"label":"Nov","value":569},{"label":"Dez","value":410}];
const MX = 752;
