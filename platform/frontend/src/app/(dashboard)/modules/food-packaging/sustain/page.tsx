...
const ACCENT = "#6366f1";
const MODULE = "Food Packaging";
const PAGE = "Sustainability";
const KPIS = [{"l":"Total Food Packaging","v":"2.064","t":"+3.1%","d":"up"},{"l":"Sustainability Ativos","v":"4.026","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"61","t":"+0.9%","d":"up"}];
const COLS = ["ID","Sustainability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Packaging #001","Food Packaging #002","322","5.325","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Food Packaging #002","Food Packaging #003","2.669","8.406","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Packaging #003","Food Packaging #004","4.203","1.489","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Food Packaging #004","Food Packaging #005","4.684","7.840","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Packaging #005","Food Packaging #001","8.850","7.217","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":426},{"label":"Mar","value":392},{"label":"Abr","value":580},{"label":"Mai","value":423},{"label":"Jun","value":322},{"label":"Jul","value":686},{"label":"Ago","value":537},{"label":"Set","value":569},{"label":"Out","value":469},{"label":"Nov","value":430},{"label":"Dez","value":486}];
const MX = 686;
