...
const PAGE = "Material";
const KPIS = [{"l":"Total Food Packaging","v":"1.684","t":"+2.4%","d":"up"},{"l":"Material Ativos","v":"3.753","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"66","t":"-2.3%","d":"down"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Packaging #001","Food Packaging #002","7.956","8.309","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Food Packaging #002","Food Packaging #003","3.340","4.911","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Packaging #003","Food Packaging #004","2.537","2.666","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Food Packaging #004","Food Packaging #005","4.246","5.452","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Packaging #005","Food Packaging #001","4.183","413","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":699},{"label":"Mar","value":518},{"label":"Abr","value":532},{"label":"Mai","value":381},{"label":"Jun","value":731},{"label":"Jul","value":733},{"label":"Ago","value":606},{"label":"Set","value":564},{"label":"Out","value":540},{"label":"Nov","value":615},{"label":"Dez","value":617}];
const MX = 733;
