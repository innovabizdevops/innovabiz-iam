...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.834","t":"-5.0%","d":"down"},{"l":"NC Abertas","v":"792","t":"+11.4%","d":"up"},{"l":"Conformidade (%)","v":"80.9%","t":"+13.1%","d":"up"},{"l":"CAPAs Pendentes","v":"924","t":"+6.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.247","84.0%","5.061","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.501","96.4%","6.848","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.429","94.2%","636","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.036","73.3%","6.864","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.371","74.4%","4.900","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":598},{"label":"Mar","value":548},{"label":"Abr","value":708},{"label":"Mai","value":408},{"label":"Jun","value":689},{"label":"Jul","value":512},{"label":"Ago","value":536},{"label":"Set","value":435},{"label":"Out","value":481},{"label":"Nov","value":573},{"label":"Dez","value":563}];
const MX = 708;
