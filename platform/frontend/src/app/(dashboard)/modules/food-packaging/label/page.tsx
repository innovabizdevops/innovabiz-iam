...
const PAGE = "Labeling";
const KPIS = [{"l":"Total Food Packaging","v":"4.318","t":"-4.9%","d":"down"},{"l":"Labeling Ativos","v":"5.686","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"62","t":"-5.0%","d":"down"}];
const COLS = ["ID","Labeling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Packaging #001","Food Packaging #002","3.964","7.658","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Food Packaging #002","Food Packaging #003","2.862","4.078","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Packaging #003","Food Packaging #004","3.816","7.086","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Food Packaging #004","Food Packaging #005","7.944","8.727","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Packaging #005","Food Packaging #001","6.985","2.769","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":948},{"label":"Fev","value":957},{"label":"Mar","value":938},{"label":"Abr","value":849},{"label":"Mai","value":773},{"label":"Jun","value":1036},{"label":"Jul","value":904},{"label":"Ago","value":1015},{"label":"Set","value":721},{"label":"Out","value":943},{"label":"Nov","value":1016},{"label":"Dez","value":933}];
const MX = 1036;
