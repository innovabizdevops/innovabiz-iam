...
const PAGE = "Habitat";
const KPIS = [{"l":"Total Zoo Aquarium","v":"4.448","t":"+0.8%","d":"up"},{"l":"Habitat Ativos","v":"3.761","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"94","t":"+10.8%","d":"up"}];
const COLS = ["ID","Habitat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Aquarium #001","Zoo Aquarium #002","6.788","3.956","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Aquarium #002","Zoo Aquarium #003","2.659","5.525","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Aquarium #003","Zoo Aquarium #004","1.482","8.312","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Aquarium #004","Zoo Aquarium #005","6.662","2.324","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Aquarium #005","Zoo Aquarium #001","6.849","4.854","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":734},{"label":"Mar","value":591},{"label":"Abr","value":386},{"label":"Mai","value":747},{"label":"Jun","value":396},{"label":"Jul","value":494},{"label":"Ago","value":649},{"label":"Set","value":752},{"label":"Out","value":402},{"label":"Nov","value":572},{"label":"Dez","value":502}];
const MX = 752;
