...
const PAGE = "Veterinary";
const KPIS = [{"l":"Total Zoo Aquarium","v":"5.481","t":"+7.3%","d":"up"},{"l":"Veterinary Ativos","v":"1.439","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"80.9%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"69","t":"+2.1%","d":"up"}];
const COLS = ["ID","Veterinary","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Aquarium #001","Zoo Aquarium #002","1.989","7.874","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Aquarium #002","Zoo Aquarium #003","3.908","5.328","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Aquarium #003","Zoo Aquarium #004","1.767","2.266","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Aquarium #004","Zoo Aquarium #005","5.773","5.241","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Aquarium #005","Zoo Aquarium #001","1.285","1.924","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":614},{"label":"Mar","value":628},{"label":"Abr","value":969},{"label":"Mai","value":942},{"label":"Jun","value":961},{"label":"Jul","value":687},{"label":"Ago","value":676},{"label":"Set","value":743},{"label":"Out","value":619},{"label":"Nov","value":885},{"label":"Dez","value":583}];
const MX = 969;
