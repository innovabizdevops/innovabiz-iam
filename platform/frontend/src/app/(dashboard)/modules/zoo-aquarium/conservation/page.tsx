...
const ACCENT = "#9333ea";
const MODULE = "Zoo & Aquarium";
const PAGE = "Conservation";
const KPIS = [{"l":"Total Zoo Aquarium","v":"1.190","t":"+4.2%","d":"up"},{"l":"Conservation Ativos","v":"8.396","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"81","t":"+13.5%","d":"up"}];
const COLS = ["ID","Conservation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Aquarium #001","Zoo Aquarium #002","3.687","5.142","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Aquarium #002","Zoo Aquarium #003","4.731","1.308","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Aquarium #003","Zoo Aquarium #004","2.469","7.270","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Aquarium #004","Zoo Aquarium #005","8.109","2.850","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Aquarium #005","Zoo Aquarium #001","4.669","6.037","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":592},{"label":"Mar","value":916},{"label":"Abr","value":592},{"label":"Mai","value":656},{"label":"Jun","value":651},{"label":"Jul","value":948},{"label":"Ago","value":943},{"label":"Set","value":640},{"label":"Out","value":888},{"label":"Nov","value":857},{"label":"Dez","value":942}];
const MX = 948;
