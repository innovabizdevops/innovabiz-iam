...
const PAGE = "Animal";
const KPIS = [{"l":"Total Zoo Aquarium","v":"3.350","t":"+9.4%","d":"up"},{"l":"Animal Ativos","v":"698","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"77","t":"+3.6%","d":"up"}];
const COLS = ["ID","Animal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Aquarium #001","Zoo Aquarium #002","2.571","2.846","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Aquarium #002","Zoo Aquarium #003","5.847","7.171","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Aquarium #003","Zoo Aquarium #004","1.844","8.391","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Aquarium #004","Zoo Aquarium #005","5.849","6.147","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Aquarium #005","Zoo Aquarium #001","3.364","880","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":886},{"label":"Mar","value":795},{"label":"Abr","value":841},{"label":"Mai","value":930},{"label":"Jun","value":910},{"label":"Jul","value":662},{"label":"Ago","value":680},{"label":"Set","value":998},{"label":"Out","value":901},{"label":"Nov","value":935},{"label":"Dez","value":753}];
const MX = 998;
