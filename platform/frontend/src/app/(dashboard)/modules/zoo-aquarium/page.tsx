...
/* ═══ Zoo & Aquarium — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "251", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3512", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€275K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "567022651", cells: ["ZOO-5651", "Zoo & Aquarium Item 1", "28/8/2026", "€22 751"], status: "active" as const },
    { id: "567026222", cells: ["ZOO-9222", "Zoo & Aquarium Item 2", "15/3/2026", "€26 322"], status: "pending" as const },
    { id: "567029793", cells: ["ZOO-3793", "Zoo & Aquarium Item 3", "2/10/2026", "€29 893"], status: "completed" as const },
    { id: "567033364", cells: ["ZOO-7364", "Zoo & Aquarium Item 4", "17/5/2026", "€33 464"], status: "warning" as const },
    { id: "567036935", cells: ["ZOO-1935", "Zoo & Aquarium Item 5", "4/12/2026", "€37 035"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Zoo & Aquarium</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Zoo & Aquarium</p>
                    </div>
                </div>
