...
const PAGE = "Visitor";
const KPIS = [{"l":"Total Zoo Aquarium","v":"2.316","t":"+2.3%","d":"up"},{"l":"Visitor Ativos","v":"7.994","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"91.3%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"93","t":"+4.0%","d":"up"}];
const COLS = ["ID","Visitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zoo Aquarium #001","Zoo Aquarium #002","8.225","966","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Zoo Aquarium #002","Zoo Aquarium #003","3.187","3.567","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Zoo Aquarium #003","Zoo Aquarium #004","2.724","1.975","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Zoo Aquarium #004","Zoo Aquarium #005","3.425","4.005","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zoo Aquarium #005","Zoo Aquarium #001","1.916","8.880","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":438},{"label":"Mar","value":574},{"label":"Abr","value":743},{"label":"Mai","value":554},{"label":"Jun","value":603},{"label":"Jul","value":567},{"label":"Ago","value":758},{"label":"Set","value":629},{"label":"Out","value":423},{"label":"Nov","value":494},{"label":"Dez","value":473}];
const MX = 758;
