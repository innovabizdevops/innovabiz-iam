...
const PAGE = "Weather";
const KPIS = [{"l":"Total Route Intel","v":"1.551","t":"+4.5%","d":"up"},{"l":"Weather Ativos","v":"5.245","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"79","t":"+10.5%","d":"up"}];
const COLS = ["ID","Weather","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Intel #001","Route Intel #002","5.162","2.594","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Route Intel #002","Route Intel #003","654","3.183","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Intel #003","Route Intel #004","1.641","7.847","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Route Intel #004","Route Intel #005","8.062","3.706","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Intel #005","Route Intel #001","2.971","4.025","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":608},{"label":"Mar","value":642},{"label":"Abr","value":288},{"label":"Mai","value":504},{"label":"Jun","value":464},{"label":"Jul","value":493},{"label":"Ago","value":605},{"label":"Set","value":434},{"label":"Out","value":655},{"label":"Nov","value":291},{"label":"Dez","value":380}];
const MX = 655;
