...
const ACCENT = "#6366f1";
const MODULE = "Route Intelligence";
const PAGE = "Real-Time";
const KPIS = [{"l":"Total Route Intel","v":"2.329","t":"+3.7%","d":"up"},{"l":"Real Time Ativos","v":"5.466","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"62","t":"-1.0%","d":"down"}];
const COLS = ["ID","Real Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Intel #001","Route Intel #002","1.804","1.139","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Route Intel #002","Route Intel #003","6.282","3.870","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Intel #003","Route Intel #004","4.209","2.635","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Route Intel #004","Route Intel #005","4.649","958","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Intel #005","Route Intel #001","5.494","515","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":526},{"label":"Mar","value":479},{"label":"Abr","value":685},{"label":"Mai","value":738},{"label":"Jun","value":420},{"label":"Jul","value":638},{"label":"Ago","value":701},{"label":"Set","value":558},{"label":"Out","value":712},{"label":"Nov","value":650},{"label":"Dez","value":516}];
const MX = 738;
