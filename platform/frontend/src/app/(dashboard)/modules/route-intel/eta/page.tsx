...
const PAGE = "ETA";
const KPIS = [{"l":"Total Route Intel","v":"8.207","t":"+13.7%","d":"up"},{"l":"ETA Ativos","v":"307","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"62","t":"-4.2%","d":"down"}];
const COLS = ["ID","ETA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Intel #001","2026-01-22","4.664","6.194","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Route Intel #002","2026-02-02","792","1.581","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Intel #003","2026-03-05","7.746","8.063","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Route Intel #004","2026-02-26","4.475","1.586","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Intel #005","2026-03-01","2.920","6.832","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":707},{"label":"Mar","value":848},{"label":"Abr","value":778},{"label":"Mai","value":569},{"label":"Jun","value":658},{"label":"Jul","value":716},{"label":"Ago","value":505},{"label":"Set","value":706},{"label":"Out","value":724},{"label":"Nov","value":653},{"label":"Dez","value":757}];
const MX = 848;
