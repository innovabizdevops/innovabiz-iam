...
const PAGE = "Carbon";
const KPIS = [{"l":"Total Route Intel","v":"3.954","t":"+11.4%","d":"up"},{"l":"Carbon Ativos","v":"8.486","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"84","t":"+14.1%","d":"up"}];
const COLS = ["ID","Carbon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Intel #001","Route Intel #002","185","4.582","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Route Intel #002","Route Intel #003","8.179","7.467","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Intel #003","Route Intel #004","8.184","8.737","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Route Intel #004","Route Intel #005","4.813","7.325","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Intel #005","Route Intel #001","4.029","6.443","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":729},{"label":"Mar","value":582},{"label":"Abr","value":430},{"label":"Mai","value":732},{"label":"Jun","value":441},{"label":"Jul","value":775},{"label":"Ago","value":746},{"label":"Set","value":764},{"label":"Out","value":797},{"label":"Nov","value":780},{"label":"Dez","value":460}];
const MX = 797;
