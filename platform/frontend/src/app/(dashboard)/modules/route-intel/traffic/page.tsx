...
const PAGE = "Traffic";
const KPIS = [{"l":"Total Route Intel","v":"7.136","t":"+7.6%","d":"up"},{"l":"Traffic Ativos","v":"5.915","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"65.4%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"68","t":"+16.0%","d":"up"}];
const COLS = ["ID","Traffic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Intel #001","Route Intel #002","5.552","2.600","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Route Intel #002","Route Intel #003","2.940","1.175","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Intel #003","Route Intel #004","3.127","8.267","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Route Intel #004","Route Intel #005","7.491","2.792","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Intel #005","Route Intel #001","7.893","7.895","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":813},{"label":"Mar","value":640},{"label":"Abr","value":976},{"label":"Mai","value":879},{"label":"Jun","value":925},{"label":"Jul","value":703},{"label":"Ago","value":611},{"label":"Set","value":887},{"label":"Out","value":959},{"label":"Nov","value":774},{"label":"Dez","value":920}];
const MX = 976;
