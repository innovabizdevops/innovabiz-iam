...
const PAGE = "Remote Assist AR";
const KPIS = [{"l":"Quartos Ocupados","v":"6.883","t":"+5.9%","d":"up"},{"l":"RevPAR (€)","v":"€62048","t":"+3.2%","d":"up"},{"l":"Ocupação (%)","v":"78.0%","t":"+5.3%","d":"up"},{"l":"Guest Satisfaction","v":"2.031","t":"-4.4%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","170","2026-01-06","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.324","2026-03-16","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.012","2026-02-27","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.289","2026-03-07","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.714","2026-02-05","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":709},{"label":"Mar","value":815},{"label":"Abr","value":548},{"label":"Mai","value":675},{"label":"Jun","value":587},{"label":"Jul","value":568},{"label":"Ago","value":540},{"label":"Set","value":681},{"label":"Out","value":844},{"label":"Nov","value":802},{"label":"Dez","value":538}];
const MX = 844;
