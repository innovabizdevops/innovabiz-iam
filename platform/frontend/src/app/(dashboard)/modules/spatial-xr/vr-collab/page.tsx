...
const PAGE = "VR Collaboration";
const KPIS = [{"l":"Teams Ativos","v":"374","t":"+11.3%","d":"up"},{"l":"Reuniões/Semana","v":"2719","t":"-4.3%","d":"down"},{"l":"Mensagens/Dia","v":"4904","t":"+5.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.607","t":"-5.6%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.199","2906","3.090","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.332","1269","1.004","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","718","277","1.383","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.814","4359","1.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.521","381","8.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":459},{"label":"Mar","value":677},{"label":"Abr","value":606},{"label":"Mai","value":599},{"label":"Jun","value":720},{"label":"Jul","value":460},{"label":"Ago","value":668},{"label":"Set","value":639},{"label":"Out","value":415},{"label":"Nov","value":443},{"label":"Dez","value":539}];
const MX = 720;
...
export default function VrCollabPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>VR</span></h1>
                </div>
