...
const PAGE = "AR Product Viewer";
const KPIS = [{"l":"Quartos Ocupados","v":"2.514","t":"+14.6%","d":"up"},{"l":"RevPAR (€)","v":"€35273","t":"+11.6%","d":"up"},{"l":"Ocupação (%)","v":"94.6%","t":"+17.4%","d":"up"},{"l":"Guest Satisfaction","v":"5.036","t":"-0.9%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.379","2026-02-10","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.509","2026-01-05","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.010","2026-03-28","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.564","2026-01-12","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","524","2026-03-03","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":882},{"label":"Mar","value":486},{"label":"Abr","value":879},{"label":"Mai","value":701},{"label":"Jun","value":746},{"label":"Jul","value":657},{"label":"Ago","value":493},{"label":"Set","value":539},{"label":"Out","value":729},{"label":"Nov","value":797},{"label":"Dez","value":732}];
const MX = 882;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>AR</span></h1>
                </div>
