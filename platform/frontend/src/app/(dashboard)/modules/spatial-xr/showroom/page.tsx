...
const PAGE = "Digital Showroom XR";
const KPIS = [{"l":"Quartos Ocupados","v":"7.745","t":"+4.4%","d":"up"},{"l":"RevPAR (€)","v":"€47923","t":"-4.3%","d":"down"},{"l":"Ocupação (%)","v":"77.0%","t":"-0.7%","d":"down"},{"l":"Guest Satisfaction","v":"4.126","t":"-0.6%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.781","2026-02-16","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.521","2026-03-10","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.418","2026-01-26","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.559","2026-03-24","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.834","2026-01-17","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":589},{"label":"Mar","value":773},{"label":"Abr","value":788},{"label":"Mai","value":812},{"label":"Jun","value":599},{"label":"Jul","value":454},{"label":"Ago","value":615},{"label":"Set","value":801},{"label":"Out","value":466},{"label":"Nov","value":437},{"label":"Dez","value":555}];
const MX = 812;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>XR</span></h1>
                </div>
