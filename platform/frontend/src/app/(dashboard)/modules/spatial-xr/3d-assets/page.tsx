...
const ACCENT = "#8b5cf6";
const MODULE = "Spatial Computing & XR";
const PAGE = "3D Asset Manager";
const KPIS = [{"l":"Ativos Registados","v":"7.730","t":"-2.3%","d":"down"},{"l":"Valor Total (€M)","v":"€4.3M","t":"+6.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€98574","t":"-0.6%","d":"down"},{"l":"Ativos em Garantia","v":"4.931","t":"+16.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 34773.55","2.566","€ 45275.17","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 31856.42","2.541","€ 28808.64","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 25355.15","4.834","€ 27872.74","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 16054.90","1.575","€ 37429.22","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 48434.51","9.025","€ 16632.08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":931},{"label":"Mar","value":872},{"label":"Abr","value":866},{"label":"Mai","value":881},{"label":"Jun","value":842},{"label":"Jul","value":812},{"label":"Ago","value":1036},{"label":"Set","value":931},{"label":"Out","value":965},{"label":"Nov","value":853},{"label":"Dez","value":776}];
const MX = 1036;
...
export default function 3dAssetsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>3D</span></h1>
                </div>
