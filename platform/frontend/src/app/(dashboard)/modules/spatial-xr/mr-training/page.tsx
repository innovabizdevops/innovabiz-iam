...
const PAGE = "Mixed Reality Training";
const KPIS = [{"l":"Quartos Ocupados","v":"1.175","t":"+2.4%","d":"up"},{"l":"RevPAR (€)","v":"€16442","t":"-3.6%","d":"down"},{"l":"Ocupação (%)","v":"84.6%","t":"-2.6%","d":"down"},{"l":"Guest Satisfaction","v":"7.745","t":"+7.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.204","2026-01-26","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.586","2026-02-01","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.284","2026-03-02","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.665","2026-02-14","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.717","2026-03-18","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":205},{"label":"Fev","value":464},{"label":"Mar","value":340},{"label":"Abr","value":233},{"label":"Mai","value":462},{"label":"Jun","value":285},{"label":"Jul","value":479},{"label":"Ago","value":285},{"label":"Set","value":230},{"label":"Out","value":266},{"label":"Nov","value":483},{"label":"Dez","value":396}];
const MX = 483;
...
export default function MrTrainingPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>MR</span></h1>
                </div>
