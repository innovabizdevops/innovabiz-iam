...
const PAGE = "Spatial Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"706","t":"-3.6%","d":"down"},{"l":"Queries/Dia","v":"1310","t":"+9.4%","d":"up"},{"l":"Dados Processados (GB)","v":"2.874","t":"+15.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.639","t":"+14.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","527","2026-02-06","4.014","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","425","2026-02-10","5.543","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3148","2026-02-16","4.059","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","295","2026-02-25","3.115","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4584","2026-02-10","7.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":606},{"label":"Mar","value":584},{"label":"Abr","value":674},{"label":"Mai","value":612},{"label":"Jun","value":460},{"label":"Jul","value":552},{"label":"Ago","value":579},{"label":"Set","value":723},{"label":"Out","value":480},{"label":"Nov","value":438},{"label":"Dez","value":765}];
const MX = 765;
