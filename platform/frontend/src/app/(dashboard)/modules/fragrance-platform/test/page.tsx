...
const PAGE = "Test";
const KPIS = [{"l":"Formulários Ativos","v":"4.413","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"3071","t":"+10.1%","d":"up"},{"l":"Documentos Gerados","v":"5.947","t":"+0.3%","d":"up"},{"l":"Templates","v":"2.117","t":"-0.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.039","2026-03-09","432","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.952","2026-01-17","3.035","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.116","2026-02-10","7.675","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.623","2026-03-23","848","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.667","2026-03-19","640","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":986},{"label":"Mar","value":755},{"label":"Abr","value":720},{"label":"Mai","value":847},{"label":"Jun","value":992},{"label":"Jul","value":902},{"label":"Ago","value":626},{"label":"Set","value":656},{"label":"Out","value":853},{"label":"Nov","value":848},{"label":"Dez","value":938}];
const MX = 992;
