...
const PAGE = "Produce";
const KPIS = [{"l":"Formulários Ativos","v":"3.654","t":"+13.5%","d":"up"},{"l":"Submissões/Dia","v":"4638","t":"-2.2%","d":"down"},{"l":"Documentos Gerados","v":"173","t":"+7.6%","d":"up"},{"l":"Templates","v":"8.606","t":"-0.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.844","2026-02-10","322","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.357","2026-03-27","8.707","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.106","2026-03-04","3.079","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.018","2026-02-06","279","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.020","2026-02-14","4.183","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":571},{"label":"Mar","value":608},{"label":"Abr","value":638},{"label":"Mai","value":715},{"label":"Jun","value":625},{"label":"Jul","value":471},{"label":"Ago","value":821},{"label":"Set","value":690},{"label":"Out","value":514},{"label":"Nov","value":739},{"label":"Dez","value":743}];
const MX = 821;
