...
const ACCENT = "#be185d";
const MODULE = "Fragrance Management";
const PAGE = "Package";
const KPIS = [{"l":"Formulários Ativos","v":"5.925","t":"+2.8%","d":"up"},{"l":"Submissões/Dia","v":"3350","t":"-3.1%","d":"down"},{"l":"Documentos Gerados","v":"1.524","t":"-2.8%","d":"down"},{"l":"Templates","v":"570","t":"+2.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.333","2026-02-15","5.213","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.863","2026-01-24","2.758","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.780","2026-03-01","6.016","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.969","2026-03-13","1.675","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.856","2026-01-16","8.416","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":1011},{"label":"Mar","value":869},{"label":"Abr","value":677},{"label":"Mai","value":782},{"label":"Jun","value":779},{"label":"Jul","value":781},{"label":"Ago","value":794},{"label":"Set","value":730},{"label":"Out","value":802},{"label":"Nov","value":841},{"label":"Dez","value":768}];
const MX = 1011;
