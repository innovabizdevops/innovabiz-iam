...
const PAGE = "Create";
const KPIS = [{"l":"Formulários Ativos","v":"1.597","t":"+9.3%","d":"up"},{"l":"Submissões/Dia","v":"1706","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"1.698","t":"+5.8%","d":"up"},{"l":"Templates","v":"795","t":"+1.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.167","2026-01-07","7.234","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.160","2026-03-03","2.365","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.920","2026-01-20","3.190","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.972","2026-01-04","5.280","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","198","2026-03-09","8.582","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":612},{"label":"Mar","value":796},{"label":"Abr","value":549},{"label":"Mai","value":774},{"label":"Jun","value":842},{"label":"Jul","value":725},{"label":"Ago","value":495},{"label":"Set","value":698},{"label":"Out","value":823},{"label":"Nov","value":770},{"label":"Dez","value":872}];
const MX = 872;
