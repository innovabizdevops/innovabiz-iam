...
const PAGE = "Launch";
const KPIS = [{"l":"Formulários Ativos","v":"9.059","t":"+17.8%","d":"up"},{"l":"Submissões/Dia","v":"2489","t":"-3.3%","d":"down"},{"l":"Documentos Gerados","v":"6.589","t":"+16.0%","d":"up"},{"l":"Templates","v":"6.289","t":"+15.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.689","2026-02-10","3.078","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.918","2026-01-12","8.916","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.824","2026-03-06","8.040","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","693","2026-02-04","8.595","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","979","2026-02-18","1.512","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":303},{"label":"Fev","value":431},{"label":"Mar","value":413},{"label":"Abr","value":240},{"label":"Mai","value":382},{"label":"Jun","value":284},{"label":"Jul","value":272},{"label":"Ago","value":497},{"label":"Set","value":238},{"label":"Out","value":399},{"label":"Nov","value":611},{"label":"Dez","value":454}];
const MX = 611;
