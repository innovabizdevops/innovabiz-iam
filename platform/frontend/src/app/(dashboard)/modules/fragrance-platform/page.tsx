...
/* ═══ Fragrance Management — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "6212", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "739", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€420K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2066868712", cells: ["FRA-1712", "Fragrance Management Item 1", "21/5/2026", "€18 812"], status: "active" as const },
    { id: "2066872283", cells: ["FRA-5283", "Fragrance Management Item 2", "8/12/2026", "€22 383"], status: "pending" as const },
    { id: "2066875854", cells: ["FRA-8854", "Fragrance Management Item 3", "23/7/2026", "€25 954"], status: "completed" as const },
    { id: "2066879425", cells: ["FRA-3425", "Fragrance Management Item 4", "10/2/2026", "€29 525"], status: "warning" as const },
    { id: "2066882996", cells: ["FRA-6996", "Fragrance Management Item 5", "25/9/2026", "€33 096"], status: "active" as const },
];
...
export default function FragranceManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fragrance Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fragrance Management</p>
                    </div>
                </div>
