...
const ACCENT = "#7c3aed";
const MODULE = "Digital Twin Factory";
const PAGE = "Sync Engine";
const KPIS = [{"l":"Twins Ativos","v":"5.387","t":"-5.1%","d":"down"},{"l":"Simulações/Dia","v":"1457","t":"+7.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"77.8%","t":"+2.4%","d":"up"},{"l":"Latência Sync (ms)","v":"91ms","t":"+16.5%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","96.6%","2026-03-02","2.518","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","97.9%","2026-01-10","1.881","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.6%","2026-03-23","1.639","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","88.8%","2026-01-05","1.406","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","92.3%","2026-02-24","2.204","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":692},{"label":"Mar","value":556},{"label":"Abr","value":710},{"label":"Mai","value":859},{"label":"Jun","value":743},{"label":"Jul","value":700},{"label":"Ago","value":884},{"label":"Set","value":798},{"label":"Out","value":939},{"label":"Nov","value":757},{"label":"Dez","value":751}];
const MX = 939;
