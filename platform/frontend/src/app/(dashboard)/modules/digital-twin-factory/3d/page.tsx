...
const PAGE = "3D Model";
const KPIS = [{"l":"Twins Ativos","v":"2.987","t":"+15.3%","d":"up"},{"l":"Simulações/Dia","v":"1364","t":"+11.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"82.5%","t":"-4.9%","d":"down"},{"l":"Latência Sync (ms)","v":"190ms","t":"-2.3%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","83.4%","2026-02-28","6.404","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","82.6%","2026-02-17","8.817","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","82.0%","2026-03-10","278","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","75.3%","2026-01-09","3.573","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","83.9%","2026-01-17","2.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":413},{"label":"Mar","value":527},{"label":"Abr","value":550},{"label":"Mai","value":681},{"label":"Jun","value":332},{"label":"Jul","value":660},{"label":"Ago","value":454},{"label":"Set","value":546},{"label":"Out","value":302},{"label":"Nov","value":339},{"label":"Dez","value":359}];
const MX = 681;
