...
const KPIS = [{"l":"Twins Ativos","v":"3.696","t":"-3.7%","d":"down"},{"l":"Simulações/Dia","v":"149","t":"-0.4%","d":"down"},{"l":"Precisão Modelo (%)","v":"93.2%","t":"+12.9%","d":"up"},{"l":"Latência Sync (ms)","v":"175ms","t":"+14.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","85.5%","2026-01-13","8.506","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.9%","2026-02-02","1.141","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.7%","2026-03-09","4.347","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","95.9%","2026-02-02","3.565","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","89.4%","2026-01-11","2.327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":806},{"label":"Mar","value":593},{"label":"Abr","value":733},{"label":"Mai","value":612},{"label":"Jun","value":822},{"label":"Jul","value":781},{"label":"Ago","value":518},{"label":"Set","value":823},{"label":"Out","value":555},{"label":"Nov","value":767},{"label":"Dez","value":521}];
const MX = 823;
