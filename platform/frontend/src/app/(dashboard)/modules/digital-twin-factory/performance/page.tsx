...
const KPIS = [{"l":"Twins Ativos","v":"229","t":"+15.2%","d":"up"},{"l":"Simulações/Dia","v":"3167","t":"+1.7%","d":"up"},{"l":"Precisão Modelo (%)","v":"84.4%","t":"+14.9%","d":"up"},{"l":"Latência Sync (ms)","v":"67ms","t":"+10.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","82.9%","2026-01-10","7.001","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.6%","2026-03-20","1.348","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","99.0%","2026-03-01","3.561","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","95.7%","2026-02-17","6.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","72.8%","2026-01-04","8.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":249},{"label":"Fev","value":326},{"label":"Mar","value":277},{"label":"Abr","value":460},{"label":"Mai","value":292},{"label":"Jun","value":445},{"label":"Jul","value":227},{"label":"Ago","value":595},{"label":"Set","value":242},{"label":"Out","value":570},{"label":"Nov","value":226},{"label":"Dez","value":549}];
const MX = 595;
