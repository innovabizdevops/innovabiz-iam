...
const PAGE = "What-If";
const KPIS = [{"l":"Twins Ativos","v":"4.157","t":"+1.1%","d":"up"},{"l":"Simulações/Dia","v":"4380","t":"+4.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"75.5%","t":"+1.1%","d":"up"},{"l":"Latência Sync (ms)","v":"19ms","t":"+12.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","93.1%","2026-01-18","8.720","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.8%","2026-01-03","2.212","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","78.9%","2026-03-28","2.017","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","98.4%","2026-02-08","6.252","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","72.1%","2026-01-16","2.062","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1011},{"label":"Fev","value":857},{"label":"Mar","value":953},{"label":"Abr","value":721},{"label":"Mai","value":967},{"label":"Jun","value":861},{"label":"Jul","value":837},{"label":"Ago","value":973},{"label":"Set","value":681},{"label":"Out","value":695},{"label":"Nov","value":781},{"label":"Dez","value":709}];
const MX = 1011;
