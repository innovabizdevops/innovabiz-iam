...
const PAGE = "Artist Relations";
const KPIS = [{"l":"Total Arts Culture","v":"3.731","t":"+10.0%","d":"up"},{"l":"Artist Relations Ativos","v":"1.021","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"62","t":"+8.4%","d":"up"}];
const COLS = ["ID","Artist Relations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Culture #001","Arts Culture #002","6.234","8.948","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Culture #002","Arts Culture #003","3.404","3.384","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Culture #003","Arts Culture #004","3.071","6.954","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Culture #004","Arts Culture #005","6.637","3.196","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Culture #005","Arts Culture #001","5.178","8.231","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1041},{"label":"Fev","value":1031},{"label":"Mar","value":997},{"label":"Abr","value":879},{"label":"Mai","value":980},{"label":"Jun","value":1004},{"label":"Jul","value":763},{"label":"Ago","value":889},{"label":"Set","value":714},{"label":"Out","value":832},{"label":"Nov","value":913},{"label":"Dez","value":802}];
const MX = 1041;
