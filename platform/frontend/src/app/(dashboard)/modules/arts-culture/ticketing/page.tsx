...
const PAGE = "Ticketing &amp; Membership";
const KPIS = [{"l":"Tickets Abertos","v":"8.282","t":"+0.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.2%","t":"+3.3%","d":"up"},{"l":"MTTR (h)","v":"196h","t":"+3.5%","d":"up"},{"l":"Satisfação (%)","v":"87.1%","t":"+15.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.232","3.626","2.603","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.717","8.023","5.667","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.248","7.031","5.068","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.417","5.450","3.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.415","7.992","6.059","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":659},{"label":"Mar","value":932},{"label":"Abr","value":729},{"label":"Mai","value":931},{"label":"Jun","value":751},{"label":"Jul","value":635},{"label":"Ago","value":550},{"label":"Set","value":585},{"label":"Out","value":831},{"label":"Nov","value":730},{"label":"Dez","value":602}];
const MX = 932;
