...
const PAGE = "Collection Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.922","t":"+4.2%","d":"up"},{"l":"Queries/Dia","v":"149","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.088","t":"-5.0%","d":"down"},{"l":"Utilizadores Analytics","v":"8.503","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2171","2026-03-08","5.456","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4807","2026-02-04","3.945","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2647","2026-03-18","7.467","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1135","2026-03-14","165","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","561","2026-03-14","7.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":476},{"label":"Mar","value":468},{"label":"Abr","value":550},{"label":"Mai","value":489},{"label":"Jun","value":439},{"label":"Jul","value":368},{"label":"Ago","value":592},{"label":"Set","value":349},{"label":"Out","value":392},{"label":"Nov","value":587},{"label":"Dez","value":355}];
const MX = 592;
