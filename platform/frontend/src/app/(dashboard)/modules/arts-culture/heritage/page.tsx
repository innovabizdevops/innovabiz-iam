...
const ACCENT = "#c026d3";
const MODULE = "Arts, Culture & Recreation";
const PAGE = "Cultural Heritage Digital";
const KPIS = [{"l":"Total Arts Culture","v":"6.305","t":"+2.3%","d":"up"},{"l":"Cultural Heritage Digital Ativos","v":"319","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"55","t":"+7.0%","d":"up"}];
const COLS = ["ID","Cultural Heritage Digital","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Culture #001","Arts Culture #002","7.609","5.248","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Culture #002","Arts Culture #003","5.547","5.102","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Culture #003","Arts Culture #004","731","2.749","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Culture #004","Arts Culture #005","1.453","2.137","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Culture #005","Arts Culture #001","868","2.279","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":741},{"label":"Mar","value":458},{"label":"Abr","value":393},{"label":"Mai","value":417},{"label":"Jun","value":402},{"label":"Jul","value":626},{"label":"Ago","value":497},{"label":"Set","value":621},{"label":"Out","value":408},{"label":"Nov","value":588},{"label":"Dez","value":629}];
const MX = 744;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c026d3'}}>3D</span></h1>
                </div>
