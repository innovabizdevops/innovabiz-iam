...
const PAGE = "Programming Calendar";
const KPIS = [{"l":"Total Arts Culture","v":"4.334","t":"+3.1%","d":"up"},{"l":"Programming Calendar Ativos","v":"4.621","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"68.6%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"74","t":"+11.1%","d":"up"}];
const COLS = ["ID","Programming Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Culture #001","Arts Culture #002","6.484","187","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Culture #002","Arts Culture #003","1.182","1.781","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Culture #003","Arts Culture #004","7.001","3.107","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Culture #004","Arts Culture #005","2.861","8.447","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Culture #005","Arts Culture #001","8.074","699","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":970},{"label":"Fev","value":960},{"label":"Mar","value":785},{"label":"Abr","value":1034},{"label":"Mai","value":823},{"label":"Jun","value":820},{"label":"Jul","value":1049},{"label":"Ago","value":871},{"label":"Set","value":957},{"label":"Out","value":736},{"label":"Nov","value":880},{"label":"Dez","value":714}];
const MX = 1049;
