...
const PAGE = "Exhibition Management";
const KPIS = [{"l":"Projetos Melhoria","v":"6.353","t":"-3.5%","d":"down"},{"l":"Savings (€)","v":"€14299","t":"+8.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.7%","t":"-0.3%","d":"down"},{"l":"Ciclos PDCA","v":"1.680","t":"+15.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.156","€ 42446.85","2.250","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.837","€ 7765.83","2.059","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.503","€ 34410.41","2.193","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.789","€ 19841.03","8.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.136","€ 46580.26","8.767","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":836},{"label":"Mar","value":713},{"label":"Abr","value":625},{"label":"Mai","value":732},{"label":"Jun","value":741},{"label":"Jul","value":667},{"label":"Ago","value":562},{"label":"Set","value":589},{"label":"Out","value":573},{"label":"Nov","value":556},{"label":"Dez","value":545}];
const MX = 836;
