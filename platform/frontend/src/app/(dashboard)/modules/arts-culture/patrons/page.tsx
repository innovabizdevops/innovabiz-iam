...
const PAGE = "Patron &amp; Donor CRM";
const KPIS = [{"l":"Total Arts Culture","v":"8.204","t":"+12.0%","d":"up"},{"l":"Patron & Donor CRM Ativos","v":"3.411","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"73","t":"+3.8%","d":"up"}];
const COLS = ["ID","Patron & Donor CRM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arts Culture #001","Arts Culture #002","2.155","8.352","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Arts Culture #002","Arts Culture #003","7.680","5.782","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Arts Culture #003","Arts Culture #004","7.191","5.741","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Arts Culture #004","Arts Culture #005","7.410","1.602","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arts Culture #005","Arts Culture #001","9.070","8.144","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":729},{"label":"Mar","value":706},{"label":"Abr","value":351},{"label":"Mai","value":698},{"label":"Jun","value":627},{"label":"Jul","value":741},{"label":"Ago","value":423},{"label":"Set","value":693},{"label":"Out","value":583},{"label":"Nov","value":379},{"label":"Dez","value":683}];
const MX = 741;
