...
export default function WeatherOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Weather Ops</h1><p className="text-sm text-muted-foreground">Weather Ops • iBOS</p></div>
