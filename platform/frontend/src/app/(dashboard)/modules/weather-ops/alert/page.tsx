...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"3.634","t":"+7.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"80.1%","t":"+16.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"73.8%","t":"+11.1%","d":"up"},{"l":"Escalações","v":"3.214","t":"+11.2%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","8.043","95.0%","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.745","83.0%","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.346","80.3%","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.944","86.8%","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.837","95.5%","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":893},{"label":"Mar","value":915},{"label":"Abr","value":689},{"label":"Mai","value":935},{"label":"Jun","value":616},{"label":"Jul","value":738},{"label":"Ago","value":923},{"label":"Set","value":878},{"label":"Out","value":980},{"label":"Nov","value":907},{"label":"Dez","value":748}];
const MX = 980;
