...
const PAGE = "API";
const KPIS = [{"l":"Total Weather Ops","v":"5.616","t":"+0.7%","d":"up"},{"l":"API Ativos","v":"6.185","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"70","t":"+3.0%","d":"up"}];
const COLS = ["ID","API","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Weather Ops #001","Weather Ops #002","5.864","6.967","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Weather Ops #002","Weather Ops #003","1.796","6.001","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Weather Ops #003","Weather Ops #004","2.008","4.950","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Weather Ops #004","Weather Ops #005","9.003","8.728","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Weather Ops #005","Weather Ops #001","6.121","4.190","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":362},{"label":"Mar","value":284},{"label":"Abr","value":228},{"label":"Mai","value":589},{"label":"Jun","value":410},{"label":"Jul","value":490},{"label":"Ago","value":257},{"label":"Set","value":527},{"label":"Out","value":259},{"label":"Nov","value":377},{"label":"Dez","value":383}];
const MX = 589;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>API</span></h1>
                </div>
