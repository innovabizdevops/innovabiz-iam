...
const PAGE = "Trophy Asset";
const KPIS = [{"l":"Ativos Registados","v":"5.357","t":"+7.5%","d":"up"},{"l":"Valor Total (€M)","v":"€20.5M","t":"-5.7%","d":"down"},{"l":"Depreciação Anual (€)","v":"€85123","t":"+17.7%","d":"up"},{"l":"Ativos em Garantia","v":"671","t":"-1.9%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 27362.04","4.296","€ 27639.23","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 25437.91","572","€ 45522.81","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 17066.26","6.702","€ 40182.09","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 40883.47","1.979","€ 791.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 17362.12","6.266","€ 4721.17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":526},{"label":"Mar","value":679},{"label":"Abr","value":575},{"label":"Mai","value":621},{"label":"Jun","value":483},{"label":"Jul","value":773},{"label":"Ago","value":599},{"label":"Set","value":568},{"label":"Out","value":468},{"label":"Nov","value":598},{"label":"Dez","value":620}];
const MX = 773;
