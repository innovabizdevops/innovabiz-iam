...
export default function PremiumRealEstatePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Premium Real Estate</h1><p className="text-sm text-muted-foreground">Premium Real Estate • iBOS Enterprise</p></div>
