...
/* ═══ Ocean Conservation Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "9479", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3670", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€357K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1166585779", cells: ["OCE-6779", "Ocean Conservation Platform Item 1", "24/8/2026", "€35 879"], status: "active" as const },
    { id: "1166589350", cells: ["OCE-1350", "Ocean Conservation Platform Item 2", "11/3/2026", "€39 450"], status: "pending" as const },
    { id: "1166592921", cells: ["OCE-4921", "Ocean Conservation Platform Item 3", "26/10/2026", "€43 021"], status: "completed" as const },
    { id: "1166596492", cells: ["OCE-8492", "Ocean Conservation Platform Item 4", "13/5/2026", "€46 592"], status: "warning" as const },
    { id: "1166600063", cells: ["OCE-3063", "Ocean Conservation Platform Item 5", "28/12/2026", "€163"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 39 }, { label: "Fev", value: 48 }, { label: "Mar", value: 57 }, { label: "Abr", value: 66 }, { label: "Mai", value: 75 }, { label: "Jun", value: 84 }];
...
export default function OceanConservationPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ocean Conservation Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Ocean Conservation Platform</p>
                    </div>
                </div>
