...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"5.467","t":"+16.3%","d":"up"},{"l":"Patentes (YTD)","v":"1.874","t":"+16.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.864","t":"+4.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€41.3M","t":"+0.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.918","76.0%","7.931","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.647","84.0%","2.815","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.617","73.7%","5.000","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.199","95.2%","884","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","955","88.7%","824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":825},{"label":"Mar","value":695},{"label":"Abr","value":915},{"label":"Mai","value":1008},{"label":"Jun","value":923},{"label":"Jul","value":918},{"label":"Ago","value":1064},{"label":"Set","value":975},{"label":"Out","value":1017},{"label":"Nov","value":767},{"label":"Dez","value":767}];
const MX = 1064;
