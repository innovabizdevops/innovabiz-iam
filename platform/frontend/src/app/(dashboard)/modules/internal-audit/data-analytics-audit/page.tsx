...
const PAGE = "Data Analytics Audit";
...
const ROWS = [
  { id: "001", c: ["Data Analytics Audit-001", "Data Analytics Audit Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Data Analytics Audit-002", "Data Analytics Audit Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Data Analytics Audit-003", "Data Analytics Audit Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Data Analytics Audit-004", "Data Analytics Audit Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Data Analytics Audit-005", "Data Analytics Audit Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Data Analytics Audit", ts: "Há 2min", a: "Sistema" },
...
export default function DataAnalyticsAuditPage() {
  return (
