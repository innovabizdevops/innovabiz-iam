...
const ROWS = [
  { id: "001", c: ["Risk Assess Audit-001", "Risk Assess Audit Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Risk Assess Audit-002", "Risk Assess Audit Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Risk Assess Audit-003", "Risk Assess Audit Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Risk Assess Audit-004", "Risk Assess Audit Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Risk Assess Audit-005", "Risk Assess Audit Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Risk Assess Audit", ts: "Há 2min", a: "Sistema" },
...
export default function RiskAssessAuditPage() {
  return (
