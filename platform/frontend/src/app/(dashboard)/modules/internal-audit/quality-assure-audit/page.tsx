...
const PAGE = "Quality Assure Audit";
const KPIS = [{"l":"Auditorias Planeadas","v":"48","d":"+6.2%","u":true},{"l":"Concluídas","v":"36","d":"+8.3%","u":true},{"l":"Findings Abertos","v":"127","d":"-15.2%","u":false},{"l":"Remediação (%)","v":"82.4%","d":"+4.1%","u":true}];
const COLS = ["Auditoria","Área","Risco","Findings","Auditor","Estado"];
const ROWS = [
  { id: "001", c: ["Quality Assure Audit-001", "Quality Assure Audit Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Quality Assure Audit-002", "Quality Assure Audit Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Quality Assure Audit-003", "Quality Assure Audit Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Quality Assure Audit-004", "Quality Assure Audit Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Quality Assure Audit-005", "Quality Assure Audit Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Quality Assure Audit", ts: "Há 2min", a: "Sistema" },
...
export default function QualityAssureAuditPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Internal Audit — iBOS Enterprise</p>
        </div>
