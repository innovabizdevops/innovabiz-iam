...
const ROWS = [
  { id: "001", c: ["Finding Track-001", "Finding Track Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Finding Track-002", "Finding Track Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Finding Track-003", "Finding Track Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Finding Track-004", "Finding Track Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Finding Track-005", "Finding Track Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Finding Track", ts: "Há 2min", a: "Sistema" },
...
export default function FindingTrackPage() {
  return (
