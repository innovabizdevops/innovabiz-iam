...
const PAGE = "FBO Mgmt";
const KPIS = [{"l":"Total Private Aviation","v":"690","t":"+9.6%","d":"up"},{"l":"FBO Mgmt Ativos","v":"671","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"81.9%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"64","t":"+15.3%","d":"up"}];
const COLS = ["ID","FBO Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Aviation #001","Private Aviation #002","1.072","6.371","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Private Aviation #002","Private Aviation #003","775","315","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Aviation #003","Private Aviation #004","8.284","2.221","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Private Aviation #004","Private Aviation #005","5.489","4.601","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Aviation #005","Private Aviation #001","6.975","5.546","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":683},{"label":"Mar","value":838},{"label":"Abr","value":1057},{"label":"Mai","value":742},{"label":"Jun","value":687},{"label":"Jul","value":806},{"label":"Ago","value":884},{"label":"Set","value":673},{"label":"Out","value":986},{"label":"Nov","value":782},{"label":"Dez","value":746}];
const MX = 1057;
