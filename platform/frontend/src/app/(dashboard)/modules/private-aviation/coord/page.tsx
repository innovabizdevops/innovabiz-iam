...
const PAGE = "Flight Coord";
const KPIS = [{"l":"Total Private Aviation","v":"6.307","t":"-2.1%","d":"down"},{"l":"Flight Coord Ativos","v":"457","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+15.5%","d":"up"}];
const COLS = ["ID","Flight Coord","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Private Aviation #001","Private Aviation #002","5.303","7.257","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Private Aviation #002","Private Aviation #003","2.890","8.856","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Private Aviation #003","Private Aviation #004","6.491","5.554","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Private Aviation #004","Private Aviation #005","7.435","7.023","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Private Aviation #005","Private Aviation #001","330","346","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":792},{"label":"Mar","value":649},{"label":"Abr","value":790},{"label":"Mai","value":861},{"label":"Jun","value":735},{"label":"Jul","value":704},{"label":"Ago","value":736},{"label":"Set","value":645},{"label":"Out","value":650},{"label":"Nov","value":793},{"label":"Dez","value":666}];
const MX = 861;
