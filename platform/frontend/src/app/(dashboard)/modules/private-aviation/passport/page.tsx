...
const PAGE = "Passport";
const KPIS = [{"l":"Atletas Registados","v":"4.741","t":"-3.4%","d":"down"},{"l":"Treinos/Semana","v":"1282","t":"+13.5%","d":"up"},{"l":"Competições","v":"2.282","t":"-1.0%","d":"down"},{"l":"Performance Score","v":"60","t":"-2.6%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.616","833","1.666","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.491","6.314","4.295","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.400","914","5.983","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.666","2.847","3.631","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.335","9.086","6.966","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":204},{"label":"Fev","value":443},{"label":"Mar","value":547},{"label":"Abr","value":228},{"label":"Mai","value":234},{"label":"Jun","value":264},{"label":"Jul","value":552},{"label":"Ago","value":274},{"label":"Set","value":560},{"label":"Out","value":300},{"label":"Nov","value":567},{"label":"Dez","value":342}];
const MX = 567;
