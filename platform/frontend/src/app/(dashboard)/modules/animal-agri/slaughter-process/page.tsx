...
/* ═══ Animal Agriculture — Slaughter Process ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "2491", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "65", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3941", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "782607229", cells: ["ANI-4229", "Slaughter Process Item 1", "6/2/2026", "€7329"], status: "active" as const },
    { id: "782610800", cells: ["ANI-7800", "Slaughter Process Item 2", "21/9/2026", "€10 900"], status: "pending" as const },
    { id: "782614371", cells: ["ANI-2371", "Slaughter Process Item 3", "8/4/2026", "€14 471"], status: "completed" as const },
    { id: "782617942", cells: ["ANI-5942", "Slaughter Process Item 4", "23/11/2026", "€18 042"], status: "warning" as const },
    { id: "782621513", cells: ["ANI-9513", "Slaughter Process Item 5", "10/6/2026", "€21 613"], status: "active" as const },
];
...
export default function AnimalAgricultureSlaughterProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Slaughter Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Slaughter Process</p>
                    </div>
                </div>
