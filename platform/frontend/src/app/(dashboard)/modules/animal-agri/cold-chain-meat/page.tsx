...
/* ═══ Animal Agriculture — Cold Chain Meat ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "143", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "333", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2636", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1928513817", cells: ["ANI-3817", "Cold Chain Meat Item 1", "14/10/2026", "€13 917"], status: "active" as const },
    { id: "1928517388", cells: ["ANI-7388", "Cold Chain Meat Item 2", "1/5/2026", "€17 488"], status: "pending" as const },
    { id: "1928520959", cells: ["ANI-1959", "Cold Chain Meat Item 3", "16/12/2026", "€21 059"], status: "completed" as const },
    { id: "1928524530", cells: ["ANI-5530", "Cold Chain Meat Item 4", "3/7/2026", "€24 630"], status: "warning" as const },
    { id: "1928528101", cells: ["ANI-9101", "Cold Chain Meat Item 5", "18/2/2026", "€28 201"], status: "active" as const },
];
...
export default function AnimalAgricultureColdChainMeatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cold Chain Meat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Cold Chain Meat</p>
                    </div>
                </div>
