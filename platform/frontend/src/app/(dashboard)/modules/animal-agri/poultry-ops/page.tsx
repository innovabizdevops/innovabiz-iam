...
/* ═══ Animal Agriculture — Poultry Ops ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "2844", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "252", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1349", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "347158600", cells: ["ANI-2600", "Poultry Ops Item 1", "13/5/2026", "€8700"], status: "active" as const },
    { id: "347162171", cells: ["ANI-6171", "Poultry Ops Item 2", "28/12/2026", "€12 271"], status: "pending" as const },
    { id: "347165742", cells: ["ANI-9742", "Poultry Ops Item 3", "15/7/2026", "€15 842"], status: "completed" as const },
    { id: "347169313", cells: ["ANI-4313", "Poultry Ops Item 4", "2/2/2026", "€19 413"], status: "warning" as const },
    { id: "347172884", cells: ["ANI-7884", "Poultry Ops Item 5", "17/9/2026", "€22 984"], status: "active" as const },
];
...
export default function AnimalAgriculturePoultryOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Poultry Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Poultry Ops</p>
                    </div>
                </div>
