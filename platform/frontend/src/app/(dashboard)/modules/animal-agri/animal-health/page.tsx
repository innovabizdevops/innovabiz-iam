...
const KPIS = [
    { label: "Total", value: "1325", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "419", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3391", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1141317759", cells: ["ANI-1759", "Animal Health Item 1", "16/4/2026", "€17 859"], status: "active" as const },
    { id: "1141321330", cells: ["ANI-5330", "Animal Health Item 2", "3/11/2026", "€21 430"], status: "pending" as const },
    { id: "1141324901", cells: ["ANI-8901", "Animal Health Item 3", "18/6/2026", "€25 001"], status: "completed" as const },
    { id: "1141328472", cells: ["ANI-3472", "Animal Health Item 4", "5/1/2026", "€28 572"], status: "warning" as const },
    { id: "1141332043", cells: ["ANI-7043", "Animal Health Item 5", "20/8/2026", "€32 143"], status: "active" as const },
];
...
export default function AnimalAgricultureAnimalHealthPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Animal Health</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Animal Health</p>
                    </div>
                </div>
