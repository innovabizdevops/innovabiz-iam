...
/* ═══ Animal Agriculture — Dairy Farm ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "1611", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "418", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "741", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1587600702", cells: ["ANI-1702", "Dairy Farm Item 1", "3/7/2026", "€802"], status: "active" as const },
    { id: "1587604273", cells: ["ANI-5273", "Dairy Farm Item 2", "18/2/2026", "€4373"], status: "pending" as const },
    { id: "1587607844", cells: ["ANI-8844", "Dairy Farm Item 3", "5/9/2026", "€7944"], status: "completed" as const },
    { id: "1587611415", cells: ["ANI-3415", "Dairy Farm Item 4", "20/4/2026", "€11 515"], status: "warning" as const },
    { id: "1587614986", cells: ["ANI-6986", "Dairy Farm Item 5", "7/11/2026", "€15 086"], status: "active" as const },
];
...
export default function AnimalAgricultureDairyFarmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dairy Farm</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Dairy Farm</p>
                    </div>
                </div>
