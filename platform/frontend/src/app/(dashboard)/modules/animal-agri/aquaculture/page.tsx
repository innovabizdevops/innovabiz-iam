...
const KPIS = [
    { label: "Total", value: "1288", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "119", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2248", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "621963795", cells: ["ANI-1795", "Aquaculture Item 1", "20/4/2026", "€13 895"], status: "active" as const },
    { id: "621967366", cells: ["ANI-5366", "Aquaculture Item 2", "7/11/2026", "€17 466"], status: "pending" as const },
    { id: "621970937", cells: ["ANI-8937", "Aquaculture Item 3", "22/6/2026", "€21 037"], status: "completed" as const },
    { id: "621974508", cells: ["ANI-3508", "Aquaculture Item 4", "9/1/2026", "€24 608"], status: "warning" as const },
    { id: "621978079", cells: ["ANI-7079", "Aquaculture Item 5", "24/8/2026", "€28 179"], status: "active" as const },
];
...
export default function AnimalAgricultureAquaculturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aquaculture</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Aquaculture</p>
                    </div>
                </div>
