...
/* ═══ Animal Agriculture — Traceability Animal ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4004", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "188", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1046", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "73%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "966278136", cells: ["ANI-3136", "Traceability Animal Item 1", "13/1/2026", "€28 236"], status: "active" as const },
    { id: "966281707", cells: ["ANI-6707", "Traceability Animal Item 2", "28/8/2026", "€31 807"], status: "pending" as const },
    { id: "966285278", cells: ["ANI-1278", "Traceability Animal Item 3", "15/3/2026", "€35 378"], status: "completed" as const },
    { id: "966288849", cells: ["ANI-4849", "Traceability Animal Item 4", "2/10/2026", "€38 949"], status: "warning" as const },
    { id: "966292420", cells: ["ANI-8420", "Traceability Animal Item 5", "17/5/2026", "€42 520"], status: "active" as const },
];
...
export default function AnimalAgricultureTraceabilityAnimalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Traceability Animal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Traceability Animal</p>
                    </div>
                </div>
