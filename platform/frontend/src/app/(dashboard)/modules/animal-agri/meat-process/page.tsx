...
/* ═══ Animal Agriculture — Meat Process ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4525", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "395", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1640", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "18444167", cells: ["ANI-4167", "Meat Process Item 1", "8/12/2026", "€44 267"], status: "active" as const },
    { id: "18447738", cells: ["ANI-7738", "Meat Process Item 2", "23/7/2026", "€47 838"], status: "pending" as const },
    { id: "18451309", cells: ["ANI-2309", "Meat Process Item 3", "10/2/2026", "€1409"], status: "completed" as const },
    { id: "18454880", cells: ["ANI-5880", "Meat Process Item 4", "25/9/2026", "€4980"], status: "warning" as const },
    { id: "18458451", cells: ["ANI-9451", "Meat Process Item 5", "12/4/2026", "€8551"], status: "active" as const },
];
...
export default function AnimalAgricultureMeatProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Meat Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Meat Process</p>
                    </div>
                </div>
