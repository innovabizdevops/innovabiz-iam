...
/* ═══ Animal Agriculture — Breed Registry ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4729", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "364", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2363", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "71%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1114030264", cells: ["ANI-2264", "Breed Registry Item 1", "5/5/2026", "€30 364"], status: "active" as const },
    { id: "1114033835", cells: ["ANI-5835", "Breed Registry Item 2", "20/12/2026", "€33 935"], status: "pending" as const },
    { id: "1114037406", cells: ["ANI-9406", "Breed Registry Item 3", "7/7/2026", "€37 506"], status: "completed" as const },
    { id: "1114040977", cells: ["ANI-3977", "Breed Registry Item 4", "22/2/2026", "€41 077"], status: "warning" as const },
    { id: "1114044548", cells: ["ANI-7548", "Breed Registry Item 5", "9/9/2026", "€44 648"], status: "active" as const },
];
...
export default function AnimalAgricultureBreedRegistryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Breed Registry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Breed Registry</p>
                    </div>
                </div>
