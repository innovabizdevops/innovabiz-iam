...
/* ═══ Animal Agriculture — Livestock Feed ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "584", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "375", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1876", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "77958195", cells: ["ANI-1195", "Livestock Feed Item 1", "8/4/2026", "€8295"], status: "active" as const },
    { id: "77961766", cells: ["ANI-4766", "Livestock Feed Item 2", "23/11/2026", "€11 866"], status: "pending" as const },
    { id: "77965337", cells: ["ANI-8337", "Livestock Feed Item 3", "10/6/2026", "€15 437"], status: "completed" as const },
    { id: "77968908", cells: ["ANI-2908", "Livestock Feed Item 4", "25/1/2026", "€19 008"], status: "warning" as const },
    { id: "77972479", cells: ["ANI-6479", "Livestock Feed Item 5", "12/8/2026", "€22 579"], status: "active" as const },
];
...
export default function AnimalAgricultureLivestockFeedPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Livestock Feed</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Animal Agriculture • Livestock Feed</p>
                    </div>
                </div>
