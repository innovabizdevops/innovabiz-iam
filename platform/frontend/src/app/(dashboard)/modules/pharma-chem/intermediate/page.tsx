...
const PAGE = "Intermediate";
const KPIS = [{"l":"Riscos Identificados","v":"5.162","t":"+4.8%","d":"up"},{"l":"Mitigações Ativas","v":"666","t":"+7.0%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"-3.4%","d":"down"},{"l":"Incidentes YTD","v":"8.632","t":"+0.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.683","571","3.747","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.547","7.203","1.538","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.122","9.001","8.418","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.232","6.599","5.416","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.912","6.805","984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":954},{"label":"Mar","value":762},{"label":"Abr","value":650},{"label":"Mai","value":1014},{"label":"Jun","value":997},{"label":"Jul","value":643},{"label":"Ago","value":766},{"label":"Set","value":905},{"label":"Out","value":1022},{"label":"Nov","value":1009},{"label":"Dez","value":977}];
const MX = 1022;
