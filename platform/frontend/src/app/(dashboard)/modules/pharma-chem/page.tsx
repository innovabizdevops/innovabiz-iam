...
export default function PharmaChemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pharma Chem</h1><p className="text-sm text-muted-foreground">Pharma Chem • iBOS Enterprise</p></div>
