...
const ACCENT = "#6366f1";
const MODULE = "Pharma Chemical";
const PAGE = "Validation";
const KPIS = [{"l":"Total Pharma Chem","v":"936","t":"+12.6%","d":"up"},{"l":"Validation Ativos","v":"7.746","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"66.7%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"79","t":"-1.0%","d":"down"}];
const COLS = ["ID","Validation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Chem #001","Pharma Chem #002","3.666","7.785","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Chem #002","Pharma Chem #003","5.496","3.212","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Chem #003","Pharma Chem #004","5.117","4.754","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Chem #004","Pharma Chem #005","4.157","2.611","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Chem #005","Pharma Chem #001","4.907","643","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":595},{"label":"Mar","value":581},{"label":"Abr","value":550},{"label":"Mai","value":516},{"label":"Jun","value":660},{"label":"Jul","value":537},{"label":"Ago","value":475},{"label":"Set","value":842},{"label":"Out","value":716},{"label":"Nov","value":773},{"label":"Dez","value":521}];
const MX = 842;
