...
const ACCENT = "#14532d";
const MODULE = "Cannabis Extraction";
const PAGE = "Batch";
const KPIS = [{"l":"Total Cannabis Extract","v":"7.784","t":"-4.9%","d":"down"},{"l":"Batch Ativos","v":"3.775","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"89","t":"+5.2%","d":"up"}];
const COLS = ["ID","Batch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Extract #001","Cannabis Extract #002","8.480","8.715","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Extract #002","Cannabis Extract #003","5.548","2.055","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Extract #003","Cannabis Extract #004","8.478","2.411","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Extract #004","Cannabis Extract #005","5.185","6.930","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Extract #005","Cannabis Extract #001","6.929","6.126","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":691},{"label":"Mar","value":863},{"label":"Abr","value":697},{"label":"Mai","value":557},{"label":"Jun","value":575},{"label":"Jul","value":782},{"label":"Ago","value":763},{"label":"Set","value":745},{"label":"Out","value":510},{"label":"Nov","value":751},{"label":"Dez","value":707}];
const MX = 863;
