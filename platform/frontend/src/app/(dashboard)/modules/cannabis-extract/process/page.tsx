...
const PAGE = "Process";
const KPIS = [{"l":"Total Cannabis Extract","v":"4.353","t":"+11.0%","d":"up"},{"l":"Process Ativos","v":"1.464","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"57","t":"-2.8%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Extract #001","Cannabis Extract #002","7.850","753","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Extract #002","Cannabis Extract #003","2.635","482","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Extract #003","Cannabis Extract #004","3.306","8.161","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Extract #004","Cannabis Extract #005","408","4.668","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Extract #005","Cannabis Extract #001","8.847","8.178","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":822},{"label":"Mar","value":931},{"label":"Abr","value":895},{"label":"Mai","value":541},{"label":"Jun","value":887},{"label":"Jul","value":655},{"label":"Ago","value":725},{"label":"Set","value":654},{"label":"Out","value":907},{"label":"Nov","value":572},{"label":"Dez","value":847}];
const MX = 931;
