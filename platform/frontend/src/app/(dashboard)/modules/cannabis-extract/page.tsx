...
/* ═══ Cannabis Extraction — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "2904", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "401", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€275K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1953451004", cells: ["CAN-2004", "Cannabis Extraction Item 1", "9/9/2026", "€1104"], status: "active" as const },
    { id: "1953454575", cells: ["CAN-5575", "Cannabis Extraction Item 2", "24/4/2026", "€4675"], status: "pending" as const },
    { id: "1953458146", cells: ["CAN-9146", "Cannabis Extraction Item 3", "11/11/2026", "€8246"], status: "completed" as const },
    { id: "1953461717", cells: ["CAN-3717", "Cannabis Extraction Item 4", "26/6/2026", "€11 817"], status: "warning" as const },
    { id: "1953465288", cells: ["CAN-7288", "Cannabis Extraction Item 5", "13/1/2026", "€15 388"], status: "active" as const },
];
...
export default function CannabisExtractionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Extraction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Extraction</p>
                    </div>
                </div>
