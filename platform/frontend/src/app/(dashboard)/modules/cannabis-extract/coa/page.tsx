...
const PAGE = "COA";
const KPIS = [{"l":"Total Cannabis Extract","v":"101","t":"+3.1%","d":"up"},{"l":"COA Ativos","v":"2.191","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"84","t":"+2.3%","d":"up"}];
const COLS = ["ID","COA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Extract #001","Cannabis Extract #002","814","7.414","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Extract #002","Cannabis Extract #003","8.554","4.140","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Extract #003","Cannabis Extract #004","2.829","2.794","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Extract #004","Cannabis Extract #005","9.096","7.964","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Extract #005","Cannabis Extract #001","2.884","7.050","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":552},{"label":"Mar","value":679},{"label":"Abr","value":667},{"label":"Mai","value":641},{"label":"Jun","value":666},{"label":"Jul","value":346},{"label":"Ago","value":629},{"label":"Set","value":673},{"label":"Out","value":650},{"label":"Nov","value":725},{"label":"Dez","value":441}];
const MX = 725;
