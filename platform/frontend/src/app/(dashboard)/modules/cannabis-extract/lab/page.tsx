...
const PAGE = "Lab Test";
const KPIS = [{"l":"Total Cannabis Extract","v":"6.917","t":"-2.3%","d":"down"},{"l":"Lab Test Ativos","v":"3.965","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"91","t":"+5.7%","d":"up"}];
const COLS = ["ID","Lab Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Extract #001","Cannabis Extract #002","195","1.770","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Extract #002","Cannabis Extract #003","8.324","808","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Extract #003","Cannabis Extract #004","7.321","986","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Extract #004","Cannabis Extract #005","8.862","3.041","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Extract #005","Cannabis Extract #001","7.211","881","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":599},{"label":"Mar","value":351},{"label":"Abr","value":346},{"label":"Mai","value":692},{"label":"Jun","value":339},{"label":"Jul","value":429},{"label":"Ago","value":534},{"label":"Set","value":530},{"label":"Out","value":484},{"label":"Nov","value":493},{"label":"Dez","value":507}];
const MX = 692;
