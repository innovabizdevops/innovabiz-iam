...
/* ═══ NEURA Cognitive Mapping — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "5341", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2441", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€307K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "661067841", cells: ["NEU-9841", "NEURA Cognitive Mapping Item 1", "22/10/2026", "€17 941"], status: "active" as const },
    { id: "661071412", cells: ["NEU-4412", "NEURA Cognitive Mapping Item 2", "9/5/2026", "€21 512"], status: "pending" as const },
    { id: "661074983", cells: ["NEU-7983", "NEURA Cognitive Mapping Item 3", "24/12/2026", "€25 083"], status: "completed" as const },
    { id: "661078554", cells: ["NEU-2554", "NEURA Cognitive Mapping Item 4", "11/7/2026", "€28 654"], status: "warning" as const },
    { id: "661082125", cells: ["NEU-6125", "NEURA Cognitive Mapping Item 5", "26/2/2026", "€32 225"], status: "active" as const },
];
...
export default function NeuraCognitiveMappingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NEURA Cognitive Mapping</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NEURA Cognitive Mapping</p>
                    </div>
                </div>
