...
const KPIS = [{"l":"Dashboards Ativos","v":"6.830","t":"+7.6%","d":"up"},{"l":"Queries/Dia","v":"4466","t":"+14.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.546","t":"+9.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.047","t":"+3.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5031","2026-03-14","6.258","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2846","2026-01-22","5.731","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3215","2026-01-15","3.775","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4352","2026-02-18","320","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","812","2026-02-10","5.281","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":921},{"label":"Fev","value":836},{"label":"Mar","value":985},{"label":"Abr","value":827},{"label":"Mai","value":793},{"label":"Jun","value":628},{"label":"Jul","value":648},{"label":"Ago","value":905},{"label":"Set","value":660},{"label":"Out","value":972},{"label":"Nov","value":828},{"label":"Dez","value":869}];
const MX = 985;
