...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"6.914","t":"+4.9%","d":"up"},{"l":"Chamadas/Hora","v":"4194","t":"+4.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.3%","t":"-5.1%","d":"down"},{"l":"Latência Média (ms)","v":"160ms","t":"-5.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.884","4.777","87.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.557","3.989","75.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.879","3.449","75.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.221","7.805","77.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.632","2.520","92.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":452},{"label":"Mar","value":778},{"label":"Abr","value":673},{"label":"Mai","value":414},{"label":"Jun","value":464},{"label":"Jul","value":473},{"label":"Ago","value":704},{"label":"Set","value":416},{"label":"Out","value":741},{"label":"Nov","value":548},{"label":"Dez","value":795}];
const MX = 795;
