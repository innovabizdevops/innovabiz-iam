...
const PAGE = "Flag State";
const KPIS = [{"l":"Total Vessel Mgmt","v":"1.916","t":"+2.4%","d":"up"},{"l":"Flag State Ativos","v":"6.405","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+5.3%","d":"up"}];
const COLS = ["ID","Flag State","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vessel Mgmt #001","Vessel Mgmt #002","1.680","3.696","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Vessel Mgmt #002","Vessel Mgmt #003","4.759","1.045","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Vessel Mgmt #003","Vessel Mgmt #004","4.360","196","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Vessel Mgmt #004","Vessel Mgmt #005","2.412","8.662","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vessel Mgmt #005","Vessel Mgmt #001","222","2.119","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":456},{"label":"Mar","value":642},{"label":"Abr","value":613},{"label":"Mai","value":460},{"label":"Jun","value":664},{"label":"Jul","value":745},{"label":"Ago","value":633},{"label":"Set","value":619},{"label":"Out","value":395},{"label":"Nov","value":542},{"label":"Dez","value":716}];
const MX = 745;
