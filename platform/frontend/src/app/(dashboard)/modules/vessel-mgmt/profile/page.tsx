...
const PAGE = "Vessel Profile";
const KPIS = [{"l":"Perfis Unificados","v":"6.734","t":"+5.3%","d":"up"},{"l":"Segmentos Ativos","v":"137","t":"+17.0%","d":"up"},{"l":"NPS Score","v":"60","t":"+1.0%","d":"up"},{"l":"Churn Previsto (%)","v":"78.1%","t":"+9.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.604","€ 31942.24","90.5%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.839","€ 8116.40","75.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.788","€ 27423.86","90.7%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.762","€ 16614.71","81.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.930","€ 5568.07","77.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":698},{"label":"Mar","value":694},{"label":"Abr","value":757},{"label":"Mai","value":941},{"label":"Jun","value":814},{"label":"Jul","value":699},{"label":"Ago","value":992},{"label":"Set","value":876},{"label":"Out","value":677},{"label":"Nov","value":663},{"label":"Dez","value":943}];
const MX = 992;
