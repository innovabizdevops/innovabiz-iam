...
const ACCENT = "#1e40af";
const MODULE = "Vessel Management";
const PAGE = "Autonomous Ship";
const KPIS = [{"l":"Total Vessel Mgmt","v":"7.329","t":"+0.5%","d":"up"},{"l":"Autonomous Ship Ativos","v":"1.186","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"78","t":"-1.7%","d":"down"}];
const COLS = ["ID","Autonomous Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vessel Mgmt #001","Vessel Mgmt #002","3.585","780","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Vessel Mgmt #002","Vessel Mgmt #003","4.617","2.571","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Vessel Mgmt #003","Vessel Mgmt #004","5.128","425","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Vessel Mgmt #004","Vessel Mgmt #005","1.937","4.309","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vessel Mgmt #005","Vessel Mgmt #001","6.307","2.835","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":594},{"label":"Mar","value":690},{"label":"Abr","value":709},{"label":"Mai","value":637},{"label":"Jun","value":583},{"label":"Jul","value":673},{"label":"Ago","value":535},{"label":"Set","value":587},{"label":"Out","value":710},{"label":"Nov","value":775},{"label":"Dez","value":895}];
const MX = 895;
