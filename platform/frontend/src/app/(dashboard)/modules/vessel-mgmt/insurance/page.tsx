...
const KPIS = [{"l":"Total Vessel Mgmt","v":"1.624","t":"+13.0%","d":"up"},{"l":"Insurance Ativos","v":"4.451","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"90","t":"+6.1%","d":"up"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vessel Mgmt #001","Vessel Mgmt #002","7.199","4.837","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Vessel Mgmt #002","Vessel Mgmt #003","1.453","1.196","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Vessel Mgmt #003","Vessel Mgmt #004","8.421","3.939","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Vessel Mgmt #004","Vessel Mgmt #005","1.358","828","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vessel Mgmt #005","Vessel Mgmt #001","280","715","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":670},{"label":"Mar","value":627},{"label":"Abr","value":517},{"label":"Mai","value":787},{"label":"Jun","value":790},{"label":"Jul","value":603},{"label":"Ago","value":681},{"label":"Set","value":772},{"label":"Out","value":456},{"label":"Nov","value":583},{"label":"Dez","value":679}];
const MX = 790;
