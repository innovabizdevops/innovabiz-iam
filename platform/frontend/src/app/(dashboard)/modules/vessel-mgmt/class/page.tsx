...
const PAGE = "Classification";
const KPIS = [{"l":"Total Vessel Mgmt","v":"6.775","t":"-5.4%","d":"down"},{"l":"Classification Ativos","v":"812","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"69","t":"+16.6%","d":"up"}];
const COLS = ["ID","Classification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vessel Mgmt #001","Vessel Mgmt #002","4.396","2.444","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Vessel Mgmt #002","Vessel Mgmt #003","7.564","3.758","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Vessel Mgmt #003","Vessel Mgmt #004","4.585","7.918","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Vessel Mgmt #004","Vessel Mgmt #005","494","931","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vessel Mgmt #005","Vessel Mgmt #001","6.706","776","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":750},{"label":"Mar","value":792},{"label":"Abr","value":652},{"label":"Mai","value":609},{"label":"Jun","value":756},{"label":"Jul","value":753},{"label":"Ago","value":860},{"label":"Set","value":915},{"label":"Out","value":880},{"label":"Nov","value":730},{"label":"Dez","value":848}];
const MX = 915;
