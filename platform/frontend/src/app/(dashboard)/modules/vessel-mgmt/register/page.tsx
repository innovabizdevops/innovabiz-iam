...
const PAGE = "Fleet Register";
const KPIS = [{"l":"Total Vessel Mgmt","v":"3.214","t":"-1.8%","d":"down"},{"l":"Fleet Register Ativos","v":"4.783","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"60","t":"-4.5%","d":"down"}];
const COLS = ["ID","Fleet Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vessel Mgmt #001","Vessel Mgmt #002","8.644","6.139","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Vessel Mgmt #002","Vessel Mgmt #003","3.663","2.010","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Vessel Mgmt #003","Vessel Mgmt #004","6.950","3.890","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Vessel Mgmt #004","Vessel Mgmt #005","6.787","4.332","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vessel Mgmt #005","Vessel Mgmt #001","5.723","8.658","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":959},{"label":"Fev","value":995},{"label":"Mar","value":878},{"label":"Abr","value":962},{"label":"Mai","value":1006},{"label":"Jun","value":786},{"label":"Jul","value":981},{"label":"Ago","value":833},{"label":"Set","value":692},{"label":"Out","value":774},{"label":"Nov","value":748},{"label":"Dez","value":950}];
const MX = 1006;
