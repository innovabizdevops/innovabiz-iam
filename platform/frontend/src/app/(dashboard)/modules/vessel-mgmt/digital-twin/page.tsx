...
const KPIS = [{"l":"Twins Ativos","v":"5.694","t":"-1.0%","d":"down"},{"l":"Simulações/Dia","v":"3105","t":"-2.2%","d":"down"},{"l":"Precisão Modelo (%)","v":"72.3%","t":"-4.8%","d":"down"},{"l":"Latência Sync (ms)","v":"29ms","t":"-2.1%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","72.7%","2026-03-17","1.177","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.6%","2026-03-18","9.097","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","70.3%","2026-03-26","187","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","91.0%","2026-02-09","1.263","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","79.0%","2026-02-10","9.005","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":590},{"label":"Mar","value":714},{"label":"Abr","value":843},{"label":"Mai","value":583},{"label":"Jun","value":611},{"label":"Jul","value":670},{"label":"Ago","value":628},{"label":"Set","value":529},{"label":"Out","value":608},{"label":"Nov","value":698},{"label":"Dez","value":713}];
const MX = 843;
