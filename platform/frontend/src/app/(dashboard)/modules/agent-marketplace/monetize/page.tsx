...
const PAGE = "Monetize";
const KPIS = [{"l":"Pedidos/Dia","v":"3494","t":"-4.8%","d":"down"},{"l":"GMV (€)","v":"€74005","t":"+17.9%","d":"up"},{"l":"Conversão (%)","v":"70.4%","t":"+3.5%","d":"up"},{"l":"AOV (€)","v":"€49488","t":"+3.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 18363.16","1.720","5.848","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 6802.18","2.248","2.364","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 32050.84","6.403","1.627","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 46092.56","273","6.427","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 15292.79","3.292","4.271","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":673},{"label":"Mar","value":926},{"label":"Abr","value":697},{"label":"Mai","value":628},{"label":"Jun","value":565},{"label":"Jul","value":592},{"label":"Ago","value":945},{"label":"Set","value":697},{"label":"Out","value":583},{"label":"Nov","value":799},{"label":"Dez","value":911}];
const MX = 945;
