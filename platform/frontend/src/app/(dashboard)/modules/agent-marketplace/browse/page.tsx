...
const ACCENT = "#7c3aed";
const MODULE = "AI Agent Marketplace";
const PAGE = "Browse";
const KPIS = [{"l":"Pedidos/Dia","v":"3573","t":"+11.1%","d":"up"},{"l":"GMV (€)","v":"€69083","t":"-0.6%","d":"down"},{"l":"Conversão (%)","v":"85.9%","t":"+17.5%","d":"up"},{"l":"AOV (€)","v":"€33708","t":"+6.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 25486.66","4.788","6.271","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 40999.74","3.512","6.095","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 30671.24","5.116","3.018","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40649.32","5.056","8.691","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 25339.77","5.221","6.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":749},{"label":"Mar","value":676},{"label":"Abr","value":658},{"label":"Mai","value":865},{"label":"Jun","value":620},{"label":"Jul","value":567},{"label":"Ago","value":615},{"label":"Set","value":667},{"label":"Out","value":613},{"label":"Nov","value":630},{"label":"Dez","value":845}];
const MX = 865;
