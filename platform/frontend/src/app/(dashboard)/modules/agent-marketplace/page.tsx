...
const KPIS = [
    { label: "Total Registos", value: "7394", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4052", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€410K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "296868694", cells: ["AGE-4694", "AI Agent Marketplace Item 1", "11/11/2026", "€18 794"], status: "active" as const },
    { id: "296872265", cells: ["AGE-8265", "AI Agent Marketplace Item 2", "26/6/2026", "€22 365"], status: "pending" as const },
    { id: "296875836", cells: ["AGE-2836", "AI Agent Marketplace Item 3", "13/1/2026", "€25 936"], status: "completed" as const },
    { id: "296879407", cells: ["AGE-6407", "AI Agent Marketplace Item 4", "28/8/2026", "€29 507"], status: "warning" as const },
    { id: "296882978", cells: ["AGE-9978", "AI Agent Marketplace Item 5", "15/3/2026", "€33 078"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Agent Marketplace</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Agent Marketplace</p>
                    </div>
                </div>
