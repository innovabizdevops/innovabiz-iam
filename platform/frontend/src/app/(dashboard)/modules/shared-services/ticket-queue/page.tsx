...
const PAGE = "Ticket Queue";
const KPIS = [{"l":"Tickets Abertos","v":"4.742","t":"+13.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.7%","t":"+15.2%","d":"up"},{"l":"MTTR (h)","v":"57h","t":"-5.7%","d":"down"},{"l":"Satisfação (%)","v":"75.6%","t":"-5.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.602","4.966","7.985","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","780","5.958","3.735","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.452","4.180","5.120","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.193","3.357","1.303","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.240","3.570","4.080","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":1075},{"label":"Mar","value":831},{"label":"Abr","value":833},{"label":"Mai","value":939},{"label":"Jun","value":985},{"label":"Jul","value":1018},{"label":"Ago","value":862},{"label":"Set","value":1056},{"label":"Out","value":826},{"label":"Nov","value":710},{"label":"Dez","value":967}];
const MX = 1075;
