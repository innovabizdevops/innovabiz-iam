...
const PAGE = "SSC Operations";
const KPIS = [{"l":"Total Shared Services","v":"5.725","t":"+11.0%","d":"up"},{"l":"SSC Operations Ativos","v":"4.994","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"65.4%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"94","t":"-1.7%","d":"down"}];
const COLS = ["ID","SSC Operations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Services #001","Shared Services #002","3.125","1.635","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Services #002","Shared Services #003","4.054","7.426","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Services #003","Shared Services #004","7.729","5.712","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Services #004","Shared Services #005","1.717","2.711","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Services #005","Shared Services #001","3.021","7.457","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":645},{"label":"Mar","value":688},{"label":"Abr","value":396},{"label":"Mai","value":506},{"label":"Jun","value":382},{"label":"Jul","value":646},{"label":"Ago","value":615},{"label":"Set","value":366},{"label":"Out","value":579},{"label":"Nov","value":556},{"label":"Dez","value":513}];
const MX = 688;
