...
const PAGE = "Transition Planning";
const KPIS = [{"l":"Total Shared Services","v":"8.374","t":"-5.7%","d":"down"},{"l":"Transition Planning Ativos","v":"6.853","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"58","t":"+4.1%","d":"up"}];
const COLS = ["ID","Transition Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Services #001","Shared Services #002","2.390","3.885","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Services #002","Shared Services #003","4.990","6.823","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Services #003","Shared Services #004","2.738","146","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Services #004","Shared Services #005","2.471","7.695","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Services #005","Shared Services #001","6.006","1.515","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":579},{"label":"Mar","value":642},{"label":"Abr","value":713},{"label":"Mai","value":536},{"label":"Jun","value":735},{"label":"Jul","value":807},{"label":"Ago","value":547},{"label":"Set","value":807},{"label":"Out","value":459},{"label":"Nov","value":573},{"label":"Dez","value":432}];
const MX = 807;
