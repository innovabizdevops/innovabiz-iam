...
const ACCENT = "#64748b";
const MODULE = "Shared Services Center";
const PAGE = "Process Robotics RPA";
const KPIS = [{"l":"Total Shared Services","v":"8.854","t":"+4.7%","d":"up"},{"l":"Process Robotics RPA Ativos","v":"8.795","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.4%","d":"down"}];
const COLS = ["ID","Process Robotics RPA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Services #001","Shared Services #002","2.327","2.105","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Services #002","Shared Services #003","4.181","2.276","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Services #003","Shared Services #004","1.435","539","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Services #004","Shared Services #005","7.378","1.526","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Services #005","Shared Services #001","4.761","6.391","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":650},{"label":"Mar","value":880},{"label":"Abr","value":900},{"label":"Mai","value":710},{"label":"Jun","value":873},{"label":"Jul","value":732},{"label":"Ago","value":863},{"label":"Set","value":829},{"label":"Out","value":676},{"label":"Nov","value":779},{"label":"Dez","value":992}];
const MX = 992;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#64748b'}}>RPA</span></h1>
                </div>
