...
const PAGE = "Performance Metrics";
const KPIS = [{"l":"Formulários Ativos","v":"539","t":"+6.1%","d":"up"},{"l":"Submissões/Dia","v":"4061","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"6.140","t":"-3.7%","d":"down"},{"l":"Templates","v":"3.821","t":"+2.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.336","2026-01-01","7.864","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.029","2026-01-15","1.417","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.944","2026-01-23","7.615","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.707","2026-02-11","8.271","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.974","2026-02-25","362","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":738},{"label":"Mar","value":796},{"label":"Abr","value":780},{"label":"Mai","value":558},{"label":"Jun","value":866},{"label":"Jul","value":830},{"label":"Ago","value":678},{"label":"Set","value":856},{"label":"Out","value":654},{"label":"Nov","value":834},{"label":"Dez","value":500}];
const MX = 866;
