...
const PAGE = "SLA Tracking";
const KPIS = [{"l":"Tickets Abertos","v":"8.773","t":"+12.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.8%","t":"+16.7%","d":"up"},{"l":"MTTR (h)","v":"77h","t":"+1.8%","d":"up"},{"l":"Satisfação (%)","v":"78.3%","t":"+8.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.497","2.030","1.288","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.118","5.393","349","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.330","2.970","6.124","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.051","1.867","7.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.203","2.851","7.686","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":969},{"label":"Fev","value":962},{"label":"Mar","value":844},{"label":"Abr","value":777},{"label":"Mai","value":826},{"label":"Jun","value":832},{"label":"Jul","value":1003},{"label":"Ago","value":923},{"label":"Set","value":806},{"label":"Out","value":673},{"label":"Nov","value":771},{"label":"Dez","value":742}];
const MX = 1003;
