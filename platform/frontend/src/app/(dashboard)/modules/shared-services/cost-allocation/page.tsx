...
const PAGE = "Cost Allocation";
const KPIS = [{"l":"Total Shared Services","v":"8.589","t":"+10.9%","d":"up"},{"l":"Cost Allocation Ativos","v":"153","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"91","t":"+15.3%","d":"up"}];
const COLS = ["ID","Cost Allocation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Services #001","Shared Services #002","118","596","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Services #002","Shared Services #003","8.920","6.005","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Services #003","Shared Services #004","503","2.417","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Services #004","Shared Services #005","6.534","8.174","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Services #005","Shared Services #001","673","4.744","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":791},{"label":"Mar","value":502},{"label":"Abr","value":760},{"label":"Mai","value":706},{"label":"Jun","value":536},{"label":"Jul","value":787},{"label":"Ago","value":713},{"label":"Set","value":738},{"label":"Out","value":564},{"label":"Nov","value":482},{"label":"Dez","value":673}];
const MX = 791;
