...
const KPIS = [{"l":"Dashboards Ativos","v":"4.727","t":"-4.4%","d":"down"},{"l":"Queries/Dia","v":"3612","t":"+5.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.845","t":"+13.8%","d":"up"},{"l":"Utilizadores Analytics","v":"3.203","t":"+11.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2202","2026-01-09","4.347","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1941","2026-03-24","1.366","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1949","2026-02-18","6.836","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3373","2026-01-22","4.717","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4818","2026-03-02","156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":612},{"label":"Mar","value":464},{"label":"Abr","value":608},{"label":"Mai","value":335},{"label":"Jun","value":488},{"label":"Jul","value":450},{"label":"Ago","value":282},{"label":"Set","value":566},{"label":"Out","value":582},{"label":"Nov","value":241},{"label":"Dez","value":582}];
const MX = 612;
