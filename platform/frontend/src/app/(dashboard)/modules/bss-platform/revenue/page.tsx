...
const KPIS = [{"l":"ARR (€M)","v":"€3.3M","t":"+5.6%","d":"up"},{"l":"MRR (€)","v":"€79514","t":"+6.3%","d":"up"},{"l":"Churn (%)","v":"69.9%","t":"+16.9%","d":"up"},{"l":"ARPU (€)","v":"€77809","t":"+5.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2637.12","1.625","€ 25023.36","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 42706.77","7.740","€ 35498.54","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39966.48","5.976","€ 44999.94","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 44039.34","2.245","€ 19683.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 2900.65","7.035","€ 15410.27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":305},{"label":"Fev","value":405},{"label":"Mar","value":272},{"label":"Abr","value":465},{"label":"Mai","value":444},{"label":"Jun","value":555},{"label":"Jul","value":569},{"label":"Ago","value":545},{"label":"Set","value":261},{"label":"Out","value":335},{"label":"Nov","value":387},{"label":"Dez","value":601}];
const MX = 601;
