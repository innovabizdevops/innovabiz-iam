...
const PAGE = "Billing Engine";
const KPIS = [{"l":"Formulários Ativos","v":"3.894","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"677","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"2.399","t":"-5.9%","d":"down"},{"l":"Templates","v":"3.836","t":"+2.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.563","2026-01-01","8.036","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.480","2026-03-24","7.421","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.795","2026-02-13","4.193","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.862","2026-02-14","6.692","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.637","2026-02-23","964","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":666},{"label":"Mar","value":794},{"label":"Abr","value":846},{"label":"Mai","value":880},{"label":"Jun","value":529},{"label":"Jul","value":542},{"label":"Ago","value":873},{"label":"Set","value":862},{"label":"Out","value":877},{"label":"Nov","value":607},{"label":"Dez","value":671}];
const MX = 880;
