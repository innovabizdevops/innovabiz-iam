...
const PAGE = "CRM Telecom";
const KPIS = [{"l":"Formulários Ativos","v":"508","t":"+0.2%","d":"up"},{"l":"Submissões/Dia","v":"3770","t":"+13.6%","d":"up"},{"l":"Documentos Gerados","v":"5.651","t":"+14.8%","d":"up"},{"l":"Templates","v":"727","t":"-3.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.484","2026-01-07","922","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.765","2026-01-27","7.646","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.713","2026-03-26","8.258","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.528","2026-03-27","2.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.754","2026-02-03","636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1033},{"label":"Fev","value":760},{"label":"Mar","value":679},{"label":"Abr","value":907},{"label":"Mai","value":719},{"label":"Jun","value":751},{"label":"Jul","value":735},{"label":"Ago","value":973},{"label":"Set","value":710},{"label":"Out","value":808},{"label":"Nov","value":879},{"label":"Dez","value":966}];
const MX = 1033;
