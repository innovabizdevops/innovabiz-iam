...
const ACCENT = "#9a3412";
const MODULE = "BSS Platform";
const PAGE = "Product Catalog";
const KPIS = [{"l":"Formulários Ativos","v":"8.361","t":"+1.2%","d":"up"},{"l":"Submissões/Dia","v":"2997","t":"+1.2%","d":"up"},{"l":"Documentos Gerados","v":"9.050","t":"+2.6%","d":"up"},{"l":"Templates","v":"7.702","t":"-3.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.538","2026-01-10","6.208","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.016","2026-02-10","1.995","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.727","2026-02-16","1.000","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","166","2026-03-16","8.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.783","2026-01-13","5.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":621},{"label":"Mar","value":557},{"label":"Abr","value":826},{"label":"Mai","value":630},{"label":"Jun","value":624},{"label":"Jul","value":443},{"label":"Ago","value":530},{"label":"Set","value":494},{"label":"Out","value":500},{"label":"Nov","value":485},{"label":"Dez","value":475}];
const MX = 826;
