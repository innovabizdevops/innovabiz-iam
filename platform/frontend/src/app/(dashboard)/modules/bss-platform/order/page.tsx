...
const PAGE = "Order Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"5.714","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"2078","t":"+17.1%","d":"up"},{"l":"Documentos Gerados","v":"218","t":"+7.5%","d":"up"},{"l":"Templates","v":"5.386","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.002","2026-01-05","1.485","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.656","2026-01-12","5.793","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.660","2026-03-10","1.264","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.016","2026-01-06","6.985","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","883","2026-03-03","2.528","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":470},{"label":"Mar","value":570},{"label":"Abr","value":642},{"label":"Mai","value":515},{"label":"Jun","value":675},{"label":"Jul","value":549},{"label":"Ago","value":436},{"label":"Set","value":384},{"label":"Out","value":396},{"label":"Nov","value":400},{"label":"Dez","value":586}];
const MX = 675;
