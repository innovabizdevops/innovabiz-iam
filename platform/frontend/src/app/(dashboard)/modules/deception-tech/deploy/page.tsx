...
const ACCENT = "#dc2626";
const MODULE = "Deception Technology";
const PAGE = "Deploy";
const KPIS = [{"l":"Total Deception Tech","v":"3.910","t":"-4.1%","d":"down"},{"l":"Deploy Ativos","v":"5.459","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"78.5%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.4%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deception Tech #001","Deception Tech #002","3.777","4.208","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Deception Tech #002","Deception Tech #003","3.092","1.750","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Deception Tech #003","Deception Tech #004","7.280","4.155","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Deception Tech #004","Deception Tech #005","8.646","6.206","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deception Tech #005","Deception Tech #001","8.616","8.692","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":871},{"label":"Mar","value":665},{"label":"Abr","value":658},{"label":"Mai","value":711},{"label":"Jun","value":698},{"label":"Jul","value":835},{"label":"Ago","value":951},{"label":"Set","value":1012},{"label":"Out","value":941},{"label":"Nov","value":993},{"label":"Dez","value":659}];
const MX = 1012;
