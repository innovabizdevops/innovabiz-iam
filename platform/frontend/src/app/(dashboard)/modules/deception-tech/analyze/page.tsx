...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"5.634","t":"+9.7%","d":"up"},{"l":"Queries/Dia","v":"1244","t":"+17.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.324","t":"+15.8%","d":"up"},{"l":"Utilizadores Analytics","v":"1.990","t":"-2.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","733","2026-03-14","347","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2325","2026-03-04","7.827","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","168","2026-01-12","3.059","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4566","2026-03-26","722","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3314","2026-02-10","1.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":879},{"label":"Mar","value":902},{"label":"Abr","value":807},{"label":"Mai","value":713},{"label":"Jun","value":825},{"label":"Jul","value":795},{"label":"Ago","value":760},{"label":"Set","value":800},{"label":"Out","value":921},{"label":"Nov","value":736},{"label":"Dez","value":883}];
const MX = 921;
