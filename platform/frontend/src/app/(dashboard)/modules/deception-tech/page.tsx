...
/* ═══ Deception Technology — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "4911", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4285", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€368K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1599221111", cells: ["DEC-3111", "Deception Technology Item 1", "20/12/2026", "€21 211"], status: "active" as const },
    { id: "1599224682", cells: ["DEC-6682", "Deception Technology Item 2", "7/7/2026", "€24 782"], status: "pending" as const },
    { id: "1599228253", cells: ["DEC-1253", "Deception Technology Item 3", "22/2/2026", "€28 353"], status: "completed" as const },
    { id: "1599231824", cells: ["DEC-4824", "Deception Technology Item 4", "9/9/2026", "€31 924"], status: "warning" as const },
    { id: "1599235395", cells: ["DEC-8395", "Deception Technology Item 5", "24/4/2026", "€35 495"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Deception Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Deception Technology</p>
                    </div>
                </div>
