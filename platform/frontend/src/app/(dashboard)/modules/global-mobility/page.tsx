...
/* ═══ Global Mobility Platform — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "700", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1984", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€128K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "731976900", cells: ["GLO-7900", "Global Mobility Platform Item 1", "5/1/2026", "€27 000"], status: "active" as const },
    { id: "731980471", cells: ["GLO-2471", "Global Mobility Platform Item 2", "20/8/2026", "€30 571"], status: "pending" as const },
    { id: "731984042", cells: ["GLO-6042", "Global Mobility Platform Item 3", "7/3/2026", "€34 142"], status: "completed" as const },
    { id: "731987613", cells: ["GLO-9613", "Global Mobility Platform Item 4", "22/10/2026", "€37 713"], status: "warning" as const },
    { id: "731991184", cells: ["GLO-4184", "Global Mobility Platform Item 5", "9/5/2026", "€41 284"], status: "active" as const },
];
...
export default function GlobalMobilityPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Global Mobility Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Global Mobility Platform</p>
                    </div>
                </div>
