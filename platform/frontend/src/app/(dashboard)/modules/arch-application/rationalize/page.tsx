...
const ACCENT = "#164e63";
const MODULE = "Application Architecture (TOGAF)";
const PAGE = "Rationalize";
const KPIS = [{"l":"Total Arch Application","v":"119","t":"+17.3%","d":"up"},{"l":"Rationalize Ativos","v":"5.765","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+14.0%","d":"up"}];
const COLS = ["ID","Rationalize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Application #001","Arch Application #002","3.270","2.150","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Application #002","Arch Application #003","6.225","5.842","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Application #003","Arch Application #004","2.593","7.374","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Application #004","Arch Application #005","7.558","3.147","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Application #005","Arch Application #001","3.789","5.435","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":683},{"label":"Mar","value":656},{"label":"Abr","value":505},{"label":"Mai","value":423},{"label":"Jun","value":424},{"label":"Jul","value":643},{"label":"Ago","value":626},{"label":"Set","value":423},{"label":"Out","value":473},{"label":"Nov","value":448},{"label":"Dez","value":717}];
const MX = 717;
