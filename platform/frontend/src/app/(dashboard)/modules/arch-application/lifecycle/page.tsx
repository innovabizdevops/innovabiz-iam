...
const KPIS = [{"l":"Total Arch Application","v":"8.317","t":"+0.3%","d":"up"},{"l":"Lifecycle Ativos","v":"4.014","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"72.7%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"78","t":"-5.8%","d":"down"}];
const COLS = ["ID","Lifecycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Application #001","Arch Application #002","530","5.889","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Application #002","Arch Application #003","3.444","1.992","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Application #003","Arch Application #004","2.644","1.265","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Application #004","Arch Application #005","2.463","159","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Application #005","Arch Application #001","4.824","4.810","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":361},{"label":"Mar","value":542},{"label":"Abr","value":247},{"label":"Mai","value":305},{"label":"Jun","value":343},{"label":"Jul","value":582},{"label":"Ago","value":330},{"label":"Set","value":369},{"label":"Out","value":294},{"label":"Nov","value":421},{"label":"Dez","value":346}];
const MX = 582;
