...
const KPIS = [{"l":"Total Arch Application","v":"4.116","t":"+17.1%","d":"up"},{"l":"Portfolio Ativos","v":"2.593","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"84","t":"+11.4%","d":"up"}];
const COLS = ["ID","Portfolio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Application #001","Arch Application #002","7.586","5.792","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Application #002","Arch Application #003","2.715","5.194","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Application #003","Arch Application #004","7.467","1.036","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Application #004","Arch Application #005","3.080","2.443","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Application #005","Arch Application #001","945","6.557","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":322},{"label":"Mar","value":517},{"label":"Abr","value":274},{"label":"Mai","value":646},{"label":"Jun","value":275},{"label":"Jul","value":429},{"label":"Ago","value":389},{"label":"Set","value":538},{"label":"Out","value":382},{"label":"Nov","value":277},{"label":"Dez","value":363}];
const MX = 646;
