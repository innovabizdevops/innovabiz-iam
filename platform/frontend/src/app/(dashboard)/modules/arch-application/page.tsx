...
/* ═══ Application Architecture (TOGAF) — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "3732", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1893", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€219K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "677599232", cells: ["ARC-8232", "Application Architecture (TOGAF) Item 1", "17/9/2026", "€49 332"], status: "active" as const },
    { id: "677602803", cells: ["ARC-2803", "Application Architecture (TOGAF) Item 2", "4/4/2026", "€2903"], status: "pending" as const },
    { id: "677606374", cells: ["ARC-6374", "Application Architecture (TOGAF) Item 3", "19/11/2026", "€6474"], status: "completed" as const },
    { id: "677609945", cells: ["ARC-9945", "Application Architecture (TOGAF) Item 4", "6/6/2026", "€10 045"], status: "warning" as const },
    { id: "677613516", cells: ["ARC-4516", "Application Architecture (TOGAF) Item 5", "21/1/2026", "€13 616"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 52 }, { label: "Fev", value: 61 }, { label: "Mar", value: 70 }, { label: "Abr", value: 79 }, { label: "Mai", value: 88 }, { label: "Jun", value: 97 }];
...
export default function ApplicationArchitectureTogafPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Application Architecture (TOGAF)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Application Architecture (TOGAF)</p>
                    </div>
                </div>
