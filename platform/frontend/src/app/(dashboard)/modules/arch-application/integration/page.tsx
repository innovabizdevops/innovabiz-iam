...
const KPIS = [{"l":"Integrações Ativas","v":"6.593","t":"+0.5%","d":"up"},{"l":"Chamadas/Hora","v":"3418","t":"+5.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.1%","t":"+17.7%","d":"up"},{"l":"Latência Média (ms)","v":"43ms","t":"+11.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.319","5.381","74.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.762","7.562","96.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.486","3.774","79.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.286","5.950","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.492","989","95.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":417},{"label":"Mar","value":574},{"label":"Abr","value":711},{"label":"Mai","value":617},{"label":"Jun","value":397},{"label":"Jul","value":452},{"label":"Ago","value":439},{"label":"Set","value":432},{"label":"Out","value":666},{"label":"Nov","value":657},{"label":"Dez","value":381}];
const MX = 711;
