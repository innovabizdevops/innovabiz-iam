...
const PAGE = "Roadmap";
const KPIS = [{"l":"Total Arch Application","v":"2.472","t":"-5.9%","d":"down"},{"l":"Roadmap Ativos","v":"5.750","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"89.2%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"80","t":"-4.7%","d":"down"}];
const COLS = ["ID","Roadmap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Application #001","Arch Application #002","879","100","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Application #002","Arch Application #003","7.401","4.493","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Application #003","Arch Application #004","3.172","8.182","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Application #004","Arch Application #005","1.511","7.857","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Application #005","Arch Application #001","7.019","4.997","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":958},{"label":"Mar","value":603},{"label":"Abr","value":876},{"label":"Mai","value":919},{"label":"Jun","value":790},{"label":"Jul","value":638},{"label":"Ago","value":875},{"label":"Set","value":698},{"label":"Out","value":602},{"label":"Nov","value":604},{"label":"Dez","value":830}];
const MX = 997;
