...
const PAGE = "Report";
const KPIS = [{"l":"Total Donor Mgmt Deep","v":"8.905","t":"+17.8%","d":"up"},{"l":"Report Ativos","v":"5.934","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"68.4%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"73","t":"+6.5%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt Deep #001","Donor Mgmt Deep #002","8.187","4.400","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt Deep #002","Donor Mgmt Deep #003","4.628","5.756","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt Deep #003","Donor Mgmt Deep #004","6.490","1.009","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt Deep #004","Donor Mgmt Deep #005","785","2.379","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt Deep #005","Donor Mgmt Deep #001","5.483","8.612","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":518},{"label":"Mar","value":640},{"label":"Abr","value":293},{"label":"Mai","value":378},{"label":"Jun","value":334},{"label":"Jul","value":622},{"label":"Ago","value":631},{"label":"Set","value":648},{"label":"Out","value":486},{"label":"Nov","value":374},{"label":"Dez","value":461}];
const MX = 648;
