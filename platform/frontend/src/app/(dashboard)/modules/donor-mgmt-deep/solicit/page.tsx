...
const PAGE = "Solicit";
const KPIS = [{"l":"Total Donor Mgmt Deep","v":"4.288","t":"+17.8%","d":"up"},{"l":"Solicit Ativos","v":"7.009","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"67.7%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-0.9%","d":"down"}];
const COLS = ["ID","Solicit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt Deep #001","Donor Mgmt Deep #002","8.586","364","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt Deep #002","Donor Mgmt Deep #003","7.844","5.845","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt Deep #003","Donor Mgmt Deep #004","6.196","3.144","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt Deep #004","Donor Mgmt Deep #005","1.993","1.750","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt Deep #005","Donor Mgmt Deep #001","5.816","3.993","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":999},{"label":"Mar","value":964},{"label":"Abr","value":801},{"label":"Mai","value":1000},{"label":"Jun","value":909},{"label":"Jul","value":1031},{"label":"Ago","value":667},{"label":"Set","value":1031},{"label":"Out","value":825},{"label":"Nov","value":797},{"label":"Dez","value":715}];
const MX = 1031;
