...
const ACCENT = "#9333ea";
const MODULE = "Donor Management Deep";
const PAGE = "Cultivate";
const KPIS = [{"l":"Total Donor Mgmt Deep","v":"5.850","t":"+14.5%","d":"up"},{"l":"Cultivate Ativos","v":"433","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"66","t":"+8.9%","d":"up"}];
const COLS = ["ID","Cultivate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt Deep #001","Donor Mgmt Deep #002","4.808","3.533","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt Deep #002","Donor Mgmt Deep #003","2.683","5.085","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt Deep #003","Donor Mgmt Deep #004","6.031","8.094","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt Deep #004","Donor Mgmt Deep #005","4.575","2.289","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt Deep #005","Donor Mgmt Deep #001","3.075","6.283","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":642},{"label":"Mar","value":548},{"label":"Abr","value":573},{"label":"Mai","value":758},{"label":"Jun","value":564},{"label":"Jul","value":715},{"label":"Ago","value":536},{"label":"Set","value":801},{"label":"Out","value":469},{"label":"Nov","value":803},{"label":"Dez","value":625}];
const MX = 803;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9333ea'}}>AI</span></h1>
                </div>
