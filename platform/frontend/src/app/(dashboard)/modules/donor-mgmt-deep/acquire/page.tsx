...
const PAGE = "Acquire";
const KPIS = [{"l":"Total Donor Mgmt Deep","v":"8.886","t":"+13.1%","d":"up"},{"l":"Acquire Ativos","v":"6.573","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"95","t":"+1.5%","d":"up"}];
const COLS = ["ID","Acquire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt Deep #001","Donor Mgmt Deep #002","3.255","9.073","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt Deep #002","Donor Mgmt Deep #003","8.538","8.956","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt Deep #003","Donor Mgmt Deep #004","2.511","2.828","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt Deep #004","Donor Mgmt Deep #005","5.627","5.485","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt Deep #005","Donor Mgmt Deep #001","7.375","6.704","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":778},{"label":"Mar","value":745},{"label":"Abr","value":717},{"label":"Mai","value":750},{"label":"Jun","value":540},{"label":"Jul","value":756},{"label":"Ago","value":589},{"label":"Set","value":742},{"label":"Out","value":731},{"label":"Nov","value":655},{"label":"Dez","value":535}];
const MX = 787;
