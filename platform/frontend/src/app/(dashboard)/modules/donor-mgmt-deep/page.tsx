...
/* ═══ Donor Management Deep — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "6240", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4700", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€49K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "503371640", cells: ["DON-2640", "Donor Management Deep Item 1", "17/9/2026", "€21 740"], status: "active" as const },
    { id: "503375211", cells: ["DON-6211", "Donor Management Deep Item 2", "4/4/2026", "€25 311"], status: "pending" as const },
    { id: "503378782", cells: ["DON-9782", "Donor Management Deep Item 3", "19/11/2026", "€28 882"], status: "completed" as const },
    { id: "503382353", cells: ["DON-4353", "Donor Management Deep Item 4", "6/6/2026", "€32 453"], status: "warning" as const },
    { id: "503385924", cells: ["DON-7924", "Donor Management Deep Item 5", "21/1/2026", "€36 024"], status: "active" as const },
];
...
export default function DonorManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Donor Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Donor Management Deep</p>
                    </div>
                </div>
