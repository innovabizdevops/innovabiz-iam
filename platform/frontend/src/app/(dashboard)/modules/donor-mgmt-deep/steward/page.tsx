...
const PAGE = "Steward";
const KPIS = [{"l":"Total Donor Mgmt Deep","v":"5.134","t":"+5.1%","d":"up"},{"l":"Steward Ativos","v":"2.600","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+0.9%","d":"up"}];
const COLS = ["ID","Steward","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Donor Mgmt Deep #001","Donor Mgmt Deep #002","1.332","8.347","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Donor Mgmt Deep #002","Donor Mgmt Deep #003","3.251","1.537","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Donor Mgmt Deep #003","Donor Mgmt Deep #004","3.244","5.924","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Donor Mgmt Deep #004","Donor Mgmt Deep #005","7.905","2.481","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Donor Mgmt Deep #005","Donor Mgmt Deep #001","4.235","1.659","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":401},{"label":"Mar","value":483},{"label":"Abr","value":391},{"label":"Mai","value":293},{"label":"Jun","value":358},{"label":"Jul","value":532},{"label":"Ago","value":408},{"label":"Set","value":331},{"label":"Out","value":322},{"label":"Nov","value":253},{"label":"Dez","value":261}];
const MX = 532;
