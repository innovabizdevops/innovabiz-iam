...
const PAGE = "Customs Bond";
const KPIS = [{"l":"Total Bonded Warehouse","v":"4.420","t":"+12.8%","d":"up"},{"l":"Customs Bond Ativos","v":"€84858","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"89.5%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"66","t":"-2.4%","d":"down"}];
const COLS = ["ID","Customs Bond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bonded Warehouse #001","€ 22403.71","1.438","1.644","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Bonded Warehouse #002","€ 4673.61","8.531","8.023","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Bonded Warehouse #003","€ 30413.34","5.306","4.928","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Bonded Warehouse #004","€ 39996.84","6.921","6.308","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bonded Warehouse #005","€ 2405.05","1.195","965","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":887},{"label":"Mar","value":712},{"label":"Abr","value":836},{"label":"Mai","value":871},{"label":"Jun","value":519},{"label":"Jul","value":831},{"label":"Ago","value":756},{"label":"Set","value":670},{"label":"Out","value":828},{"label":"Nov","value":594},{"label":"Dez","value":567}];
const MX = 887;
