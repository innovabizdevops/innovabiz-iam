...
const PAGE = "Trail";
const KPIS = [{"l":"Veículos Operação","v":"2.562","t":"+8.1%","d":"up"},{"l":"Viagens/Dia","v":"2260","t":"+7.2%","d":"up"},{"l":"Pontualidade (%)","v":"80.0%","t":"+11.4%","d":"up"},{"l":"Passageiros/Dia","v":"620","t":"+7.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-09","2026-02-21","8.973","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-07","2026-03-17","1.944","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-17","2026-01-25","2.237","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-23","2026-02-22","6.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-21","2026-01-24","1.086","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":577},{"label":"Mar","value":617},{"label":"Abr","value":381},{"label":"Mai","value":514},{"label":"Jun","value":616},{"label":"Jul","value":569},{"label":"Ago","value":454},{"label":"Set","value":600},{"label":"Out","value":605},{"label":"Nov","value":609},{"label":"Dez","value":680}];
const MX = 680;
