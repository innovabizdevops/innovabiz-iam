...
const ACCENT = "#16a34a";
const MODULE = "National Park Mgmt";
const PAGE = "Conservation";
const KPIS = [{"l":"Total National Park","v":"4.859","t":"-3.9%","d":"down"},{"l":"Conservation Ativos","v":"4.689","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"91","t":"-0.2%","d":"down"}];
const COLS = ["ID","Conservation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["National Park #001","National Park #002","7.983","2.708","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["National Park #002","National Park #003","9.085","1.593","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["National Park #003","National Park #004","3.584","8.046","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["National Park #004","National Park #005","4.809","184","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["National Park #005","National Park #001","2.984","4.839","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":462},{"label":"Mar","value":656},{"label":"Abr","value":701},{"label":"Mai","value":724},{"label":"Jun","value":521},{"label":"Jul","value":714},{"label":"Ago","value":826},{"label":"Set","value":697},{"label":"Out","value":481},{"label":"Nov","value":457},{"label":"Dez","value":542}];
const MX = 826;
