...
const PAGE = "Wildlife";
const KPIS = [{"l":"Total National Park","v":"3.524","t":"+11.0%","d":"up"},{"l":"Wildlife Ativos","v":"3.063","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"62","t":"+14.0%","d":"up"}];
const COLS = ["ID","Wildlife","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["National Park #001","National Park #002","5.155","3.048","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["National Park #002","National Park #003","564","6.051","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["National Park #003","National Park #004","2.564","8.957","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["National Park #004","National Park #005","7.582","3.140","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["National Park #005","National Park #001","2.309","7.791","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":995},{"label":"Mar","value":911},{"label":"Abr","value":753},{"label":"Mai","value":647},{"label":"Jun","value":815},{"label":"Jul","value":983},{"label":"Ago","value":779},{"label":"Set","value":782},{"label":"Out","value":1023},{"label":"Nov","value":805},{"label":"Dez","value":786}];
const MX = 1023;
