...
/* ═══ National Park Mgmt — Dashboard ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total Registos", value: "9304", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3126", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€285K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1124490804", cells: ["NAT-4804", "National Park Mgmt Item 1", "25/1/2026", "€40 904"], status: "active" as const },
    { id: "1124494375", cells: ["NAT-8375", "National Park Mgmt Item 2", "12/8/2026", "€44 475"], status: "pending" as const },
    { id: "1124497946", cells: ["NAT-2946", "National Park Mgmt Item 3", "27/3/2026", "€48 046"], status: "completed" as const },
    { id: "1124501517", cells: ["NAT-6517", "National Park Mgmt Item 4", "14/10/2026", "€1617"], status: "warning" as const },
    { id: "1124505088", cells: ["NAT-1088", "National Park Mgmt Item 5", "1/5/2026", "€5188"], status: "active" as const },
];
...
export default function NationalParkMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">National Park Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • National Park Mgmt</p>
                    </div>
                </div>
