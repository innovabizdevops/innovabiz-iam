...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"5.164","t":"-2.0%","d":"down"},{"l":"Mitigações Ativas","v":"8.817","t":"-3.2%","d":"down"},{"l":"Score Risco Geral","v":"89","t":"-3.5%","d":"down"},{"l":"Incidentes YTD","v":"3.585","t":"+7.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.555","8.672","834","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.257","2.045","6.721","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.602","2.573","6.749","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.561","3.411","3.593","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.721","1.151","5.874","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":704},{"label":"Mar","value":613},{"label":"Abr","value":735},{"label":"Mai","value":690},{"label":"Jun","value":857},{"label":"Jul","value":825},{"label":"Ago","value":666},{"label":"Set","value":733},{"label":"Out","value":804},{"label":"Nov","value":844},{"label":"Dez","value":838}];
const MX = 877;
