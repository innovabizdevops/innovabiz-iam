...
const KPIS = [{"l":"Total Child Protect","v":"8.530","t":"+13.7%","d":"up"},{"l":"Outcome Track Ativos","v":"935","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"65","t":"+17.4%","d":"up"}];
const COLS = ["ID","Outcome Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Protect #001","Child Protect #002","1.210","6.070","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Child Protect #002","Child Protect #003","3.169","7.082","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Protect #003","Child Protect #004","6.759","4.703","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Child Protect #004","Child Protect #005","6.865","1.322","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Protect #005","Child Protect #001","8.690","5.239","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":948},{"label":"Mar","value":678},{"label":"Abr","value":879},{"label":"Mai","value":893},{"label":"Jun","value":770},{"label":"Jul","value":849},{"label":"Ago","value":1008},{"label":"Set","value":858},{"label":"Out","value":669},{"label":"Nov","value":831},{"label":"Dez","value":804}];
const MX = 1008;
