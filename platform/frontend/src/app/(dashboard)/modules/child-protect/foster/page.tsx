...
const PAGE = "Foster Care";
const KPIS = [{"l":"Total Child Protect","v":"1.092","t":"+0.3%","d":"up"},{"l":"Foster Care Ativos","v":"2.458","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"74.7%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"67","t":"-1.5%","d":"down"}];
const COLS = ["ID","Foster Care","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Protect #001","Child Protect #002","2.842","2.004","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Child Protect #002","Child Protect #003","8.651","3.163","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Protect #003","Child Protect #004","7.630","1.129","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Child Protect #004","Child Protect #005","4.905","2.524","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Protect #005","Child Protect #001","623","7.689","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":512},{"label":"Mar","value":436},{"label":"Abr","value":390},{"label":"Mai","value":261},{"label":"Jun","value":343},{"label":"Jul","value":305},{"label":"Ago","value":326},{"label":"Set","value":531},{"label":"Out","value":393},{"label":"Nov","value":597},{"label":"Dez","value":577}];
const MX = 597;
