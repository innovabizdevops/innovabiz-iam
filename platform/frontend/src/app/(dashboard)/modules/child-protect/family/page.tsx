...
const PAGE = "Family Support";
const KPIS = [{"l":"Tickets Abertos","v":"2.486","t":"+14.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.7%","t":"+16.5%","d":"up"},{"l":"MTTR (h)","v":"29h","t":"-5.6%","d":"down"},{"l":"Satisfação (%)","v":"70.9%","t":"+11.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.640","8.219","488","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.351","7.888","7.303","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.206","7.052","8.312","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.501","2.815","6.766","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.464","7.718","7.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":489},{"label":"Mar","value":638},{"label":"Abr","value":657},{"label":"Mai","value":626},{"label":"Jun","value":567},{"label":"Jul","value":797},{"label":"Ago","value":583},{"label":"Set","value":491},{"label":"Out","value":701},{"label":"Nov","value":648},{"label":"Dez","value":586}];
const MX = 797;
