...
export default function ChildProtectPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Child Protect</h1><p className="text-sm text-muted-foreground">Child Protect • iBOS Enterprise</p></div>
