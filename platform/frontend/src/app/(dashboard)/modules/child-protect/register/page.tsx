...
const ACCENT = "#dc2626";
const MODULE = "Child Protection";
const PAGE = "Case Register";
const KPIS = [{"l":"Total Child Protect","v":"6.929","t":"+10.9%","d":"up"},{"l":"Case Register Ativos","v":"1.354","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"61","t":"+1.5%","d":"up"}];
const COLS = ["ID","Case Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Child Protect #001","Child Protect #002","9.083","6.081","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Child Protect #002","Child Protect #003","1.022","3.910","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Child Protect #003","Child Protect #004","1.803","1.362","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Child Protect #004","Child Protect #005","7.541","5.184","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Child Protect #005","Child Protect #001","584","8.897","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":988},{"label":"Fev","value":907},{"label":"Mar","value":1021},{"label":"Abr","value":714},{"label":"Mai","value":785},{"label":"Jun","value":709},{"label":"Jul","value":694},{"label":"Ago","value":1060},{"label":"Set","value":950},{"label":"Out","value":747},{"label":"Nov","value":941},{"label":"Dez","value":714}];
const MX = 1060;
