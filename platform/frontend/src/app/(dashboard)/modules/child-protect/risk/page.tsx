...
const KPIS = [{"l":"Riscos Identificados","v":"8.478","t":"+8.9%","d":"up"},{"l":"Mitigações Ativas","v":"1.874","t":"+14.2%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"-0.4%","d":"down"},{"l":"Incidentes YTD","v":"7.694","t":"-1.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","406","5.689","889","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.362","3.032","4.715","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.769","4.877","352","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.053","6.567","2.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.191","155","8.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":394},{"label":"Mar","value":713},{"label":"Abr","value":601},{"label":"Mai","value":680},{"label":"Jun","value":499},{"label":"Jul","value":598},{"label":"Ago","value":532},{"label":"Set","value":751},{"label":"Out","value":695},{"label":"Nov","value":727},{"label":"Dez","value":591}];
const MX = 751;
