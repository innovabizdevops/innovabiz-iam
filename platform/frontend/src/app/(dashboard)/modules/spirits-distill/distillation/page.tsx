...
const ACCENT = "#78350f";
const MODULE = "Spirits Distillery";
const PAGE = "Distillation";
const KPIS = [{"l":"Total Spirits Distill","v":"3.480","t":"+14.7%","d":"up"},{"l":"Distillation Ativos","v":"3.443","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"80.9%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"58","t":"+12.2%","d":"up"}];
const COLS = ["ID","Distillation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Spirits Distill #001","Spirits Distill #002","7.419","8.893","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Spirits Distill #002","Spirits Distill #003","2.139","3.171","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Spirits Distill #003","Spirits Distill #004","954","3.913","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Spirits Distill #004","Spirits Distill #005","5.787","8.616","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Spirits Distill #005","Spirits Distill #001","3.845","6.849","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":824},{"label":"Mar","value":990},{"label":"Abr","value":1010},{"label":"Mai","value":1010},{"label":"Jun","value":709},{"label":"Jul","value":677},{"label":"Ago","value":940},{"label":"Set","value":793},{"label":"Out","value":846},{"label":"Nov","value":939},{"label":"Dez","value":638}];
const MX = 1010;
