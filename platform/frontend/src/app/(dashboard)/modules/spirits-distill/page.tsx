...
export default function SpiritsDistillPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Spirits Distill</h1><p className="text-sm text-muted-foreground">Spirits Distill • iBOS Enterprise</p></div>
