...
const PAGE = "Barrel Aging";
const KPIS = [{"l":"ARR (€M)","v":"€13.4M","t":"-1.2%","d":"down"},{"l":"MRR (€)","v":"€46365","t":"-3.3%","d":"down"},{"l":"Churn (%)","v":"70.5%","t":"-1.2%","d":"down"},{"l":"ARPU (€)","v":"€71174","t":"-3.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2331.83","6.064","€ 38780.23","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38099.60","8.645","€ 37371.45","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25756.10","6.761","€ 5886.59","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 12825.14","2.437","€ 48127.72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5522.32","3.337","€ 26714.28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":303},{"label":"Mar","value":350},{"label":"Abr","value":355},{"label":"Mai","value":427},{"label":"Jun","value":239},{"label":"Jul","value":287},{"label":"Ago","value":462},{"label":"Set","value":511},{"label":"Out","value":588},{"label":"Nov","value":213},{"label":"Dez","value":335}];
const MX = 588;
