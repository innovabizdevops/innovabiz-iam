...
const ACCENT = "#6366f1";
const MODULE = "Agri Compliance";
const PAGE = "GlobalGAP";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.668","t":"+3.8%","d":"up"},{"l":"NC Abertas","v":"8.917","t":"+7.2%","d":"up"},{"l":"Conformidade (%)","v":"66.3%","t":"-3.8%","d":"down"},{"l":"CAPAs Pendentes","v":"1.486","t":"+10.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.987","96.1%","5.465","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.529","94.8%","8.452","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.122","93.8%","3.559","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.421","74.7%","1.376","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.352","87.4%","8.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":389},{"label":"Mar","value":382},{"label":"Abr","value":680},{"label":"Mai","value":350},{"label":"Jun","value":333},{"label":"Jul","value":510},{"label":"Ago","value":362},{"label":"Set","value":615},{"label":"Out","value":548},{"label":"Nov","value":531},{"label":"Dez","value":542}];
const MX = 680;
