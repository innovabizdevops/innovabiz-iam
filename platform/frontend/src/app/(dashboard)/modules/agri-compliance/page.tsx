...
export default function AgriCompliancePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Agri Compliance</h1><p className="text-sm text-muted-foreground">Agri Compliance • iBOS Enterprise</p></div>
