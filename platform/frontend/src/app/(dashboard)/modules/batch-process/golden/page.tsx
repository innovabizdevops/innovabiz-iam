...
const PAGE = "Golden Batch";
const KPIS = [{"l":"Dashboards Ativos","v":"4.859","t":"+7.0%","d":"up"},{"l":"Queries/Dia","v":"2357","t":"+2.7%","d":"up"},{"l":"Dados Processados (GB)","v":"4.516","t":"+17.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.550","t":"+16.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3935","2026-02-17","3.675","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3627","2026-03-19","5.107","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2501","2026-03-11","3.896","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2163","2026-02-02","795","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","930","2026-01-15","8.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":643},{"label":"Mar","value":303},{"label":"Abr","value":654},{"label":"Mai","value":679},{"label":"Jun","value":370},{"label":"Jul","value":464},{"label":"Ago","value":439},{"label":"Set","value":303},{"label":"Out","value":607},{"label":"Nov","value":600},{"label":"Dez","value":469}];
const MX = 679;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#fdba74'}}>AI</span></h1>
                </div>
