...
const ACCENT = "#fdba74";
const MODULE = "Batch Processing";
const PAGE = "PAT Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"531","t":"+1.7%","d":"up"},{"l":"Queries/Dia","v":"4788","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.568","t":"-5.7%","d":"down"},{"l":"Utilizadores Analytics","v":"9.079","t":"+14.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4703","2026-01-12","4.506","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","412","2026-03-15","6.139","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","305","2026-03-11","7.889","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","664","2026-01-26","5.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4599","2026-01-09","1.738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":684},{"label":"Mar","value":317},{"label":"Abr","value":666},{"label":"Mai","value":639},{"label":"Jun","value":459},{"label":"Jul","value":643},{"label":"Ago","value":332},{"label":"Set","value":389},{"label":"Out","value":383},{"label":"Nov","value":687},{"label":"Dez","value":662}];
const MX = 687;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#fdba74'}}>IoT</span></h1>
                </div>
