...
const ACCENT = "#be185d";
const MODULE = "Fashion Supply Chain";
const PAGE = "Track";
const KPIS = [{"l":"Total Fashion Supply","v":"1.320","t":"-1.4%","d":"down"},{"l":"Track Ativos","v":"4.109","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"85","t":"+12.3%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion Supply #001","Fashion Supply #002","8.371","392","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion Supply #002","Fashion Supply #003","3.798","3.754","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion Supply #003","Fashion Supply #004","2.371","4.801","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion Supply #004","Fashion Supply #005","130","6.594","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion Supply #005","Fashion Supply #001","800","7.537","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":666},{"label":"Mar","value":469},{"label":"Abr","value":434},{"label":"Mai","value":668},{"label":"Jun","value":574},{"label":"Jul","value":767},{"label":"Ago","value":477},{"label":"Set","value":741},{"label":"Out","value":522},{"label":"Nov","value":660},{"label":"Dez","value":763}];
const MX = 767;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>RTM</span></h1>
                </div>
