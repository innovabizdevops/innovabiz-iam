...
const KPIS = [
    { label: "Total Registos", value: "3043", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1828", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€225K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1032226443", cells: ["FAS-8443", "Fashion Supply Chain Item 1", "4/4/2026", "€26 543"], status: "active" as const },
    { id: "1032230014", cells: ["FAS-3014", "Fashion Supply Chain Item 2", "19/11/2026", "€30 114"], status: "pending" as const },
    { id: "1032233585", cells: ["FAS-6585", "Fashion Supply Chain Item 3", "6/6/2026", "€33 685"], status: "completed" as const },
    { id: "1032237156", cells: ["FAS-1156", "Fashion Supply Chain Item 4", "21/1/2026", "€37 256"], status: "warning" as const },
    { id: "1032240727", cells: ["FAS-4727", "Fashion Supply Chain Item 5", "8/8/2026", "€40 827"], status: "active" as const },
];
...
export default function FashionSupplyChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion Supply Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion Supply Chain</p>
                    </div>
                </div>
