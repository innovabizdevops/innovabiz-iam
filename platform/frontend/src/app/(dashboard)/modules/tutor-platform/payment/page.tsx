...
const PAGE = "Payment";
const KPIS = [{"l":"Formulários Ativos","v":"7.032","t":"+4.7%","d":"up"},{"l":"Submissões/Dia","v":"1094","t":"+17.6%","d":"up"},{"l":"Documentos Gerados","v":"5.804","t":"-2.1%","d":"down"},{"l":"Templates","v":"8.233","t":"+17.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.823","2026-02-27","6.196","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","828","2026-03-15","6.096","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","410","2026-02-23","7.810","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.245","2026-01-22","3.065","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.907","2026-02-18","4.159","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":915},{"label":"Mar","value":682},{"label":"Abr","value":781},{"label":"Mai","value":801},{"label":"Jun","value":844},{"label":"Jul","value":859},{"label":"Ago","value":838},{"label":"Set","value":954},{"label":"Out","value":1003},{"label":"Nov","value":864},{"label":"Dez","value":888}];
const MX = 1003;
