...
const ACCENT = "#6366f1";
const MODULE = "Tutoring Platform";
const PAGE = "Match";
const KPIS = [{"l":"Formulários Ativos","v":"380","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"3060","t":"+9.2%","d":"up"},{"l":"Documentos Gerados","v":"6.847","t":"-3.5%","d":"down"},{"l":"Templates","v":"1.466","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.964","2026-03-14","2.270","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.743","2026-02-04","7.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","616","2026-03-08","3.102","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.089","2026-02-20","9.074","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","440","2026-02-25","4.650","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":649},{"label":"Mar","value":655},{"label":"Abr","value":976},{"label":"Mai","value":1007},{"label":"Jun","value":788},{"label":"Jul","value":913},{"label":"Ago","value":882},{"label":"Set","value":774},{"label":"Out","value":1001},{"label":"Nov","value":821},{"label":"Dez","value":645}];
const MX = 1007;
