...
const PAGE = "Review";
const KPIS = [{"l":"Formulários Ativos","v":"824","t":"-3.9%","d":"down"},{"l":"Submissões/Dia","v":"3834","t":"+6.6%","d":"up"},{"l":"Documentos Gerados","v":"2.044","t":"+3.4%","d":"up"},{"l":"Templates","v":"878","t":"-0.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.515","2026-01-17","8.372","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.755","2026-02-07","8.475","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.002","2026-03-07","3.596","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","547","2026-03-21","2.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.087","2026-02-21","7.683","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":481},{"label":"Mar","value":538},{"label":"Abr","value":364},{"label":"Mai","value":353},{"label":"Jun","value":493},{"label":"Jul","value":561},{"label":"Ago","value":403},{"label":"Set","value":540},{"label":"Out","value":640},{"label":"Nov","value":650},{"label":"Dez","value":424}];
const MX = 650;
