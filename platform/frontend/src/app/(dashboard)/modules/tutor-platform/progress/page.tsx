...
const PAGE = "Progress";
const KPIS = [{"l":"Formulários Ativos","v":"8.368","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"4203","t":"-5.7%","d":"down"},{"l":"Documentos Gerados","v":"5.746","t":"+12.0%","d":"up"},{"l":"Templates","v":"7.578","t":"+8.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.944","2026-03-21","7.477","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.034","2026-02-15","1.751","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.307","2026-02-13","9.063","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.424","2026-02-27","3.485","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","810","2026-01-14","7.416","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":393},{"label":"Mar","value":473},{"label":"Abr","value":594},{"label":"Mai","value":254},{"label":"Jun","value":407},{"label":"Jul","value":578},{"label":"Ago","value":408},{"label":"Set","value":283},{"label":"Out","value":392},{"label":"Nov","value":536},{"label":"Dez","value":463}];
const MX = 594;
