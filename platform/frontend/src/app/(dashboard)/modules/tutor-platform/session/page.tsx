...
const PAGE = "Session";
const KPIS = [{"l":"Formulários Ativos","v":"8.948","t":"+14.2%","d":"up"},{"l":"Submissões/Dia","v":"119","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"7.745","t":"+1.2%","d":"up"},{"l":"Templates","v":"6.199","t":"+3.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.384","2026-01-08","4.348","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.936","2026-02-18","1.996","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.199","2026-03-26","4.115","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.044","2026-02-18","8.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.073","2026-02-22","3.014","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":480},{"label":"Mar","value":690},{"label":"Abr","value":468},{"label":"Mai","value":468},{"label":"Jun","value":685},{"label":"Jul","value":631},{"label":"Ago","value":718},{"label":"Set","value":576},{"label":"Out","value":719},{"label":"Nov","value":637},{"label":"Dez","value":387}];
const MX = 719;
