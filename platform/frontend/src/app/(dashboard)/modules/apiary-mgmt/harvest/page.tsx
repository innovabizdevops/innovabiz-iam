...
const PAGE = "Harvest";
const KPIS = [{"l":"Total Apiary Mgmt","v":"6.548","t":"+8.1%","d":"up"},{"l":"Harvest Ativos","v":"3.107","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+6.7%","d":"up"}];
const COLS = ["ID","Harvest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apiary Mgmt #001","Apiary Mgmt #002","3.129","4.415","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Apiary Mgmt #002","Apiary Mgmt #003","4.554","2.637","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Apiary Mgmt #003","Apiary Mgmt #004","856","7.803","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Apiary Mgmt #004","Apiary Mgmt #005","7.661","2.751","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apiary Mgmt #005","Apiary Mgmt #001","5.457","5.139","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":887},{"label":"Mar","value":831},{"label":"Abr","value":878},{"label":"Mai","value":790},{"label":"Jun","value":799},{"label":"Jul","value":882},{"label":"Ago","value":903},{"label":"Set","value":834},{"label":"Out","value":741},{"label":"Nov","value":630},{"label":"Dez","value":740}];
const MX = 903;
