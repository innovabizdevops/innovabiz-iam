...
const PAGE = "Hive";
const KPIS = [{"l":"Total Apiary Mgmt","v":"8.513","t":"+1.2%","d":"up"},{"l":"Hive Ativos","v":"4.938","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+8.3%","d":"up"}];
const COLS = ["ID","Hive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apiary Mgmt #001","Apiary Mgmt #002","6.598","1.842","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Apiary Mgmt #002","Apiary Mgmt #003","4.611","3.500","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Apiary Mgmt #003","Apiary Mgmt #004","5.990","8.059","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Apiary Mgmt #004","Apiary Mgmt #005","2.094","931","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apiary Mgmt #005","Apiary Mgmt #001","7.431","4.376","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":612},{"label":"Mar","value":470},{"label":"Abr","value":664},{"label":"Mai","value":648},{"label":"Jun","value":649},{"label":"Jul","value":589},{"label":"Ago","value":788},{"label":"Set","value":624},{"label":"Out","value":508},{"label":"Nov","value":790},{"label":"Dez","value":576}];
const MX = 790;
