...
const ACCENT = "#f59e0b";
const MODULE = "Apiary Management";
const PAGE = "Product";
const KPIS = [{"l":"Total Apiary Mgmt","v":"3.776","t":"-0.8%","d":"down"},{"l":"Product Ativos","v":"1.124","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.2%","d":"down"}];
const COLS = ["ID","Product","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apiary Mgmt #001","Apiary Mgmt #002","5.572","8.828","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Apiary Mgmt #002","Apiary Mgmt #003","5.910","3.872","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Apiary Mgmt #003","Apiary Mgmt #004","953","2.855","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Apiary Mgmt #004","Apiary Mgmt #005","1.025","6.330","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apiary Mgmt #005","Apiary Mgmt #001","1.914","2.685","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":564},{"label":"Mar","value":468},{"label":"Abr","value":482},{"label":"Mai","value":582},{"label":"Jun","value":538},{"label":"Jul","value":288},{"label":"Ago","value":487},{"label":"Set","value":293},{"label":"Out","value":450},{"label":"Nov","value":545},{"label":"Dez","value":465}];
const MX = 582;
