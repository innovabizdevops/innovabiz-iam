...
/* ═══ Apiary Management — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "131", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2907", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€317K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1382337031", cells: ["API-1031", "Apiary Management Item 1", "20/8/2026", "€37 131"], status: "active" as const },
    { id: "1382340602", cells: ["API-4602", "Apiary Management Item 2", "7/3/2026", "€40 702"], status: "pending" as const },
    { id: "1382344173", cells: ["API-8173", "Apiary Management Item 3", "22/10/2026", "€44 273"], status: "completed" as const },
    { id: "1382347744", cells: ["API-2744", "Apiary Management Item 4", "9/5/2026", "€47 844"], status: "warning" as const },
    { id: "1382351315", cells: ["API-6315", "Apiary Management Item 5", "24/12/2026", "€1415"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Apiary Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Apiary Management</p>
                    </div>
                </div>
