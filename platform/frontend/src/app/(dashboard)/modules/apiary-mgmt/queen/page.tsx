...
const PAGE = "Queen";
const KPIS = [{"l":"Total Apiary Mgmt","v":"5.735","t":"+6.0%","d":"up"},{"l":"Queen Ativos","v":"4.751","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"79.7%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+15.3%","d":"up"}];
const COLS = ["ID","Queen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apiary Mgmt #001","Apiary Mgmt #002","7.718","5.249","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Apiary Mgmt #002","Apiary Mgmt #003","3.562","3.223","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Apiary Mgmt #003","Apiary Mgmt #004","8.700","4.324","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Apiary Mgmt #004","Apiary Mgmt #005","4.933","7.498","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apiary Mgmt #005","Apiary Mgmt #001","7.998","5.214","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":457},{"label":"Mar","value":750},{"label":"Abr","value":495},{"label":"Mai","value":690},{"label":"Jun","value":755},{"label":"Jul","value":563},{"label":"Ago","value":691},{"label":"Set","value":589},{"label":"Out","value":747},{"label":"Nov","value":636},{"label":"Dez","value":794}];
const MX = 794;
