...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Apiary Mgmt","v":"7.207","t":"+16.0%","d":"up"},{"l":"Inspect Ativos","v":"1.320","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"76.8%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"81","t":"-0.8%","d":"down"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apiary Mgmt #001","Apiary Mgmt #002","2.438","1.718","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Apiary Mgmt #002","Apiary Mgmt #003","4.273","7.697","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Apiary Mgmt #003","Apiary Mgmt #004","2.420","3.489","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Apiary Mgmt #004","Apiary Mgmt #005","5.491","5.773","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apiary Mgmt #005","Apiary Mgmt #001","4.984","5.966","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":928},{"label":"Mar","value":960},{"label":"Abr","value":750},{"label":"Mai","value":761},{"label":"Jun","value":939},{"label":"Jul","value":1071},{"label":"Ago","value":1005},{"label":"Set","value":865},{"label":"Out","value":802},{"label":"Nov","value":885},{"label":"Dez","value":1039}];
const MX = 1071;
