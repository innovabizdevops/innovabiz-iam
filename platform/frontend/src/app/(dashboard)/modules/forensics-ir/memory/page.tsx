...
const PAGE = "Memory Dump";
const KPIS = [{"l":"Total Forensics Ir","v":"9.000","t":"-2.6%","d":"down"},{"l":"Memory Dump Ativos","v":"6.591","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"89.7%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"82","t":"+8.4%","d":"up"}];
const COLS = ["ID","Memory Dump","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forensics Ir #001","Forensics Ir #002","2.838","3.697","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Forensics Ir #002","Forensics Ir #003","2.066","2.389","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Forensics Ir #003","Forensics Ir #004","1.962","6.981","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Forensics Ir #004","Forensics Ir #005","4.221","7.008","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forensics Ir #005","Forensics Ir #001","8.051","7.570","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":504},{"label":"Mar","value":636},{"label":"Abr","value":399},{"label":"Mai","value":770},{"label":"Jun","value":488},{"label":"Jul","value":717},{"label":"Ago","value":477},{"label":"Set","value":607},{"label":"Out","value":611},{"label":"Nov","value":666},{"label":"Dez","value":663}];
const MX = 770;
