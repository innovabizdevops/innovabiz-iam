...
export default function ForensicsIrPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Forensics Ir</h1><p className="text-sm text-muted-foreground">Forensics Ir • iBOS Enterprise</p></div>
