...
const ACCENT = "#b45309";
const MODULE = "Digital Forensics";
const PAGE = "Evidence Chain";
const KPIS = [{"l":"Total Forensics Ir","v":"8.345","t":"+11.0%","d":"up"},{"l":"Evidence Chain Ativos","v":"4.660","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"93","t":"+13.4%","d":"up"}];
const COLS = ["ID","Evidence Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forensics Ir #001","Forensics Ir #002","7.973","7.607","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Forensics Ir #002","Forensics Ir #003","286","6.985","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Forensics Ir #003","Forensics Ir #004","6.294","2.302","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Forensics Ir #004","Forensics Ir #005","4.128","1.063","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forensics Ir #005","Forensics Ir #001","8.310","6.800","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":624},{"label":"Mar","value":685},{"label":"Abr","value":973},{"label":"Mai","value":657},{"label":"Jun","value":742},{"label":"Jul","value":941},{"label":"Ago","value":630},{"label":"Set","value":954},{"label":"Out","value":646},{"label":"Nov","value":664},{"label":"Dez","value":944}];
const MX = 973;
