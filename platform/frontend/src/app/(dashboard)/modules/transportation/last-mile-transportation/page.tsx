...
const ACCENT = "#1d4ed8";
const MODULE = "Transportation & Logistics";
const PAGE = "Last-Mile Delivery AI";
const KPIS = [{"l":"Atletas Registados","v":"5.256","t":"+16.6%","d":"up"},{"l":"Treinos/Semana","v":"5062","t":"-3.5%","d":"down"},{"l":"Competições","v":"5.387","t":"+8.8%","d":"up"},{"l":"Performance Score","v":"92","t":"+6.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.806","605","1.318","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.694","7.599","4.840","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.345","4.129","6.565","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.516","5.740","3.381","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.142","6.529","5.348","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":638},{"label":"Mar","value":494},{"label":"Abr","value":520},{"label":"Mai","value":590},{"label":"Jun","value":561},{"label":"Jul","value":536},{"label":"Ago","value":592},{"label":"Set","value":405},{"label":"Out","value":379},{"label":"Nov","value":695},{"label":"Dez","value":406}];
const MX = 695;
...
export default function LastMileTransportationPage() {
    return (
