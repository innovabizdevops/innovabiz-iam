...
const KPIS = [{"l":"Atletas Registados","v":"227","t":"+6.4%","d":"up"},{"l":"Treinos/Semana","v":"3801","t":"+11.1%","d":"up"},{"l":"Competições","v":"5.944","t":"-2.0%","d":"down"},{"l":"Performance Score","v":"91","t":"+12.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.027","2.778","4.666","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.554","7.457","6.468","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.910","3.634","4.064","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.699","7.649","5.193","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.738","2.845","5.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":849},{"label":"Mar","value":799},{"label":"Abr","value":966},{"label":"Mai","value":717},{"label":"Jun","value":727},{"label":"Jul","value":914},{"label":"Ago","value":741},{"label":"Set","value":659},{"label":"Out","value":1017},{"label":"Nov","value":958},{"label":"Dez","value":996}];
const MX = 1017;
