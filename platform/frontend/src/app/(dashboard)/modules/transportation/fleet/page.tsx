...
const PAGE = "Fleet Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.343","t":"+9.5%","d":"up"},{"l":"Savings (€)","v":"€62118","t":"+11.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.9%","t":"+10.4%","d":"up"},{"l":"Ciclos PDCA","v":"6.944","t":"+12.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.393","€ 12448.58","1.903","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.769","€ 39209.10","1.443","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.410","€ 19848.38","3.367","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.298","€ 14423.17","530","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.380","€ 37622.05","4.151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":481},{"label":"Mar","value":834},{"label":"Abr","value":818},{"label":"Mai","value":645},{"label":"Jun","value":772},{"label":"Jul","value":624},{"label":"Ago","value":474},{"label":"Set","value":523},{"label":"Out","value":513},{"label":"Nov","value":600},{"label":"Dez","value":795}];
const MX = 834;
