...
const PAGE = "Freight &amp; Cargo";
const KPIS = [{"l":"Atletas Registados","v":"759","t":"+16.8%","d":"up"},{"l":"Treinos/Semana","v":"3463","t":"+14.2%","d":"up"},{"l":"Competições","v":"2.314","t":"-4.0%","d":"down"},{"l":"Performance Score","v":"83","t":"+0.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.821","2.655","2.377","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","930","6.395","3.892","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.590","6.260","5.780","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.164","1.640","957","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.363","2.213","2.896","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":605},{"label":"Mar","value":532},{"label":"Abr","value":574},{"label":"Mai","value":311},{"label":"Jun","value":284},{"label":"Jul","value":487},{"label":"Ago","value":335},{"label":"Set","value":440},{"label":"Out","value":345},{"label":"Nov","value":568},{"label":"Dez","value":372}];
const MX = 605;
