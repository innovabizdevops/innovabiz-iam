...
const PAGE = "TMS";
const KPIS = [{"l":"Atletas Registados","v":"7.711","t":"+0.6%","d":"up"},{"l":"Treinos/Semana","v":"3150","t":"-4.1%","d":"down"},{"l":"Competições","v":"7.850","t":"+0.5%","d":"up"},{"l":"Performance Score","v":"93","t":"+8.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.338","1.780","4.643","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","886","6.709","7.473","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.624","3.564","5.977","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.310","6.682","1.869","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.781","5.379","7.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":971},{"label":"Mar","value":976},{"label":"Abr","value":628},{"label":"Mai","value":672},{"label":"Jun","value":847},{"label":"Jul","value":837},{"label":"Ago","value":732},{"label":"Set","value":888},{"label":"Out","value":964},{"label":"Nov","value":907},{"label":"Dez","value":695}];
const MX = 976;
