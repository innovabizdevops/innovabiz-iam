...
const KPIS = [{"l":"Atletas Registados","v":"4.113","t":"+1.5%","d":"up"},{"l":"Treinos/Semana","v":"4870","t":"+5.7%","d":"up"},{"l":"Competições","v":"3.559","t":"+7.5%","d":"up"},{"l":"Performance Score","v":"81","t":"+9.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.142","5.610","2.390","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.838","7.244","3.366","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.640","6.500","7.047","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.062","4.116","7.973","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.422","4.508","7.712","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":826},{"label":"Mar","value":943},{"label":"Abr","value":855},{"label":"Mai","value":749},{"label":"Jun","value":1044},{"label":"Jul","value":890},{"label":"Ago","value":823},{"label":"Set","value":943},{"label":"Out","value":913},{"label":"Nov","value":1003},{"label":"Dez","value":724}];
const MX = 1044;
