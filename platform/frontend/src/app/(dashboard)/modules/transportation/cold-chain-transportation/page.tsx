...
const PAGE = "Cold Chain Monitoring";
const KPIS = [{"l":"Atletas Registados","v":"2.809","t":"+12.0%","d":"up"},{"l":"Treinos/Semana","v":"2724","t":"-4.2%","d":"down"},{"l":"Competições","v":"5.418","t":"+13.0%","d":"up"},{"l":"Performance Score","v":"58","t":"+17.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.772","7.798","196","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","760","8.280","6.382","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.335","8.196","7.911","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.994","7.522","871","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.594","1.434","609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":659},{"label":"Mar","value":611},{"label":"Abr","value":649},{"label":"Mai","value":874},{"label":"Jun","value":781},{"label":"Jul","value":627},{"label":"Ago","value":694},{"label":"Set","value":767},{"label":"Out","value":800},{"label":"Nov","value":712},{"label":"Dez","value":841}];
const MX = 874;
...
export default function ColdChainTransportationPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1d4ed8'}}>IoT</span></h1>
                </div>
