...
const KPIS = [{"l":"Atletas Registados","v":"4.840","t":"+9.6%","d":"up"},{"l":"Treinos/Semana","v":"3778","t":"+12.4%","d":"up"},{"l":"Competições","v":"798","t":"+2.0%","d":"up"},{"l":"Performance Score","v":"79","t":"+1.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.309","3.074","1.143","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.443","6.177","1.390","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.780","6.246","4.786","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.363","3.951","8.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.296","8.098","2.290","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":671},{"label":"Mar","value":560},{"label":"Abr","value":780},{"label":"Mai","value":580},{"label":"Jun","value":804},{"label":"Jul","value":671},{"label":"Ago","value":591},{"label":"Set","value":791},{"label":"Out","value":664},{"label":"Nov","value":681},{"label":"Dez","value":750}];
const MX = 804;
