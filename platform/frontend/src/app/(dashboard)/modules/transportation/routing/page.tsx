...
const KPIS = [{"l":"Atletas Registados","v":"1.246","t":"-0.6%","d":"down"},{"l":"Treinos/Semana","v":"3626","t":"+11.4%","d":"up"},{"l":"Competições","v":"5.276","t":"+6.0%","d":"up"},{"l":"Performance Score","v":"65","t":"+5.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.612","5.469","3.856","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.574","2.757","7.937","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.430","5.751","6.908","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.857","5.407","2.619","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.305","4.717","3.455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":619},{"label":"Mar","value":723},{"label":"Abr","value":736},{"label":"Mai","value":807},{"label":"Jun","value":688},{"label":"Jul","value":731},{"label":"Ago","value":892},{"label":"Set","value":653},{"label":"Out","value":527},{"label":"Nov","value":591},{"label":"Dez","value":667}];
const MX = 892;
