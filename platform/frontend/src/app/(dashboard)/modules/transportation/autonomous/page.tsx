...
const PAGE = "Autonomous Logistics AI";
const KPIS = [{"l":"Atletas Registados","v":"2.861","t":"+10.1%","d":"up"},{"l":"Treinos/Semana","v":"4038","t":"+0.2%","d":"up"},{"l":"Competições","v":"818","t":"+2.9%","d":"up"},{"l":"Performance Score","v":"80","t":"+9.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.094","7.387","415","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","411","5.515","2.627","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.477","8.470","7.866","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.228","6.090","3.177","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.434","8.080","8.893","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":865},{"label":"Mar","value":631},{"label":"Abr","value":845},{"label":"Mai","value":817},{"label":"Jun","value":562},{"label":"Jul","value":821},{"label":"Ago","value":548},{"label":"Set","value":710},{"label":"Out","value":585},{"label":"Nov","value":740},{"label":"Dez","value":867}];
const MX = 867;
