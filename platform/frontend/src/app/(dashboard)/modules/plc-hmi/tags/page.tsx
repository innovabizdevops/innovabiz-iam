...
const PAGE = "Tag Database";
const KPIS = [{"l":"Dispositivos Online","v":"5.143","t":"+0.4%","d":"up"},{"l":"Dados/Min (MB)","v":"7.873","t":"+9.7%","d":"up"},{"l":"Alertas Ativos","v":"1.778","t":"+7.9%","d":"up"},{"l":"Uptime (%)","v":"89.5%","t":"+2.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.071","2.108","6.003","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.058","6.011","7.957","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.926","4.295","1.697","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.902","1.535","5.578","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.480","3.090","7.024","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":355},{"label":"Mar","value":341},{"label":"Abr","value":565},{"label":"Mai","value":705},{"label":"Jun","value":345},{"label":"Jul","value":549},{"label":"Ago","value":661},{"label":"Set","value":391},{"label":"Out","value":497},{"label":"Nov","value":443},{"label":"Dez","value":627}];
const MX = 705;
