...
const ACCENT = "#1e40af";
const MODULE = "PLC & HMI";
const PAGE = "HMI Designer";
const KPIS = [{"l":"Dispositivos Online","v":"4.052","t":"+2.3%","d":"up"},{"l":"Dados/Min (MB)","v":"3.403","t":"-1.3%","d":"down"},{"l":"Alertas Ativos","v":"431","t":"+12.1%","d":"up"},{"l":"Uptime (%)","v":"76.7%","t":"+14.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.249","2.778","4.148","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","287","6.619","4.746","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.159","5.154","3.218","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.203","2.641","2.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","531","3.639","3.928","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":246},{"label":"Fev","value":311},{"label":"Mar","value":243},{"label":"Abr","value":540},{"label":"Mai","value":259},{"label":"Jun","value":411},{"label":"Jul","value":514},{"label":"Ago","value":259},{"label":"Set","value":459},{"label":"Out","value":272},{"label":"Nov","value":518},{"label":"Dez","value":482}];
const MX = 540;
