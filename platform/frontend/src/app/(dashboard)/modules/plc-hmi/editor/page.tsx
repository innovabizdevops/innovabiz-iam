...
const PAGE = "Program Editor";
const KPIS = [{"l":"Dispositivos Online","v":"6.747","t":"+7.3%","d":"up"},{"l":"Dados/Min (MB)","v":"6.902","t":"-5.7%","d":"down"},{"l":"Alertas Ativos","v":"4.684","t":"+2.0%","d":"up"},{"l":"Uptime (%)","v":"82.2%","t":"+3.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.784","6.947","8.668","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.475","5.936","8.911","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.538","8.996","1.100","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.889","2.538","3.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.434","1.464","5.282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":616},{"label":"Mar","value":500},{"label":"Abr","value":602},{"label":"Mai","value":616},{"label":"Jun","value":311},{"label":"Jul","value":458},{"label":"Ago","value":657},{"label":"Set","value":508},{"label":"Out","value":507},{"label":"Nov","value":496},{"label":"Dez","value":392}];
const MX = 657;
