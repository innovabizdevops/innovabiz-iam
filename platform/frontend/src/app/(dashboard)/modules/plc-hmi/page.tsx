...
export default function PlcHmiPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Plc Hmi</h1><p className="text-sm text-muted-foreground">Plc Hmi • iBOS Enterprise</p></div>
