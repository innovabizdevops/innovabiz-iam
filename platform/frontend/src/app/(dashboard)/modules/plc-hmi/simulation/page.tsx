...
const KPIS = [{"l":"Dispositivos Online","v":"1.149","t":"+7.5%","d":"up"},{"l":"Dados/Min (MB)","v":"5.915","t":"+10.2%","d":"up"},{"l":"Alertas Ativos","v":"7.778","t":"-2.9%","d":"down"},{"l":"Uptime (%)","v":"69.9%","t":"+2.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.044","5.061","7.193","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.402","3.572","6.314","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.276","6.389","472","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.858","7.650","2.924","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","721","8.943","168","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":505},{"label":"Mar","value":476},{"label":"Abr","value":552},{"label":"Mai","value":662},{"label":"Jun","value":603},{"label":"Jul","value":401},{"label":"Ago","value":711},{"label":"Set","value":354},{"label":"Out","value":458},{"label":"Nov","value":573},{"label":"Dez","value":478}];
const MX = 711;
