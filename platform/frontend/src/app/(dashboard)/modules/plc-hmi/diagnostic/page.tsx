...
const KPIS = [{"l":"Dispositivos Online","v":"3.216","t":"+5.6%","d":"up"},{"l":"Dados/Min (MB)","v":"2.852","t":"+10.4%","d":"up"},{"l":"Alertas Ativos","v":"3.239","t":"+12.1%","d":"up"},{"l":"Uptime (%)","v":"81.4%","t":"+8.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.318","356","2.430","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.099","518","2.069","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.227","1.594","7.066","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.012","743","4.000","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.054","889","2.822","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":763},{"label":"Mar","value":645},{"label":"Abr","value":766},{"label":"Mai","value":603},{"label":"Jun","value":685},{"label":"Jul","value":531},{"label":"Ago","value":500},{"label":"Set","value":583},{"label":"Out","value":670},{"label":"Nov","value":767},{"label":"Dez","value":830}];
const MX = 835;
