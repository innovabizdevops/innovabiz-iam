...
const ACCENT = "#14532d";
const MODULE = "Humanitarian Operations";
const PAGE = "Satellite Image";
const KPIS = [{"l":"Total Humanitarian Ops","v":"5.701","t":"+9.9%","d":"up"},{"l":"Satellite Image Ativos","v":"2.676","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"90.6%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"80","t":"+2.4%","d":"up"}];
const COLS = ["ID","Satellite Image","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Humanitarian Ops #001","Humanitarian Ops #002","3.611","1.231","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Humanitarian Ops #002","Humanitarian Ops #003","5.143","3.553","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Humanitarian Ops #003","Humanitarian Ops #004","4.690","3.153","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Humanitarian Ops #004","Humanitarian Ops #005","496","3.575","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Humanitarian Ops #005","Humanitarian Ops #001","7.230","4.850","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":964},{"label":"Mar","value":707},{"label":"Abr","value":1052},{"label":"Mai","value":1018},{"label":"Jun","value":825},{"label":"Jul","value":922},{"label":"Ago","value":871},{"label":"Set","value":1056},{"label":"Out","value":832},{"label":"Nov","value":994},{"label":"Dez","value":1029}];
const MX = 1056;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#14532d'}}>AI</span></h1>
                </div>
