...
const KPIS = [{"l":"Total Humanitarian Ops","v":"5.983","t":"+6.3%","d":"up"},{"l":"Distribution Ativos","v":"1.479","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"87","t":"-3.1%","d":"down"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Humanitarian Ops #001","Humanitarian Ops #002","7.402","5.064","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Humanitarian Ops #002","Humanitarian Ops #003","3.587","1.895","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Humanitarian Ops #003","Humanitarian Ops #004","5.254","9.039","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Humanitarian Ops #004","Humanitarian Ops #005","4.602","1.809","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Humanitarian Ops #005","Humanitarian Ops #001","8.484","7.183","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1030},{"label":"Fev","value":918},{"label":"Mar","value":946},{"label":"Abr","value":875},{"label":"Mai","value":744},{"label":"Jun","value":789},{"label":"Jul","value":897},{"label":"Ago","value":741},{"label":"Set","value":1082},{"label":"Out","value":777},{"label":"Nov","value":1047},{"label":"Dez","value":869}];
const MX = 1082;
