...
const PAGE = "Pit Ops";
const KPIS = [{"l":"Total Iron Ore","v":"3.415","t":"+6.7%","d":"up"},{"l":"Pit Ops Ativos","v":"311","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+3.6%","d":"up"}];
const COLS = ["ID","Pit Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Iron Ore #001","Iron Ore #002","7.224","3.613","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Iron Ore #002","Iron Ore #003","6.122","4.177","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Iron Ore #003","Iron Ore #004","8.689","2.426","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Iron Ore #004","Iron Ore #005","3.877","8.267","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Iron Ore #005","Iron Ore #001","7.485","493","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":1019},{"label":"Mar","value":838},{"label":"Abr","value":792},{"label":"Mai","value":854},{"label":"Jun","value":1043},{"label":"Jul","value":800},{"label":"Ago","value":994},{"label":"Set","value":1007},{"label":"Out","value":718},{"label":"Nov","value":1011},{"label":"Dez","value":925}];
const MX = 1043;
