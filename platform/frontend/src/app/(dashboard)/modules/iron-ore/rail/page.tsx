...
const ACCENT = "#6366f1";
const MODULE = "Iron Ore Operations";
const PAGE = "Rail/Port";
const KPIS = [{"l":"Veículos Operação","v":"4.767","t":"+10.3%","d":"up"},{"l":"Viagens/Dia","v":"3167","t":"+11.7%","d":"up"},{"l":"Pontualidade (%)","v":"70.9%","t":"+0.7%","d":"up"},{"l":"Passageiros/Dia","v":"4120","t":"+15.3%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-05","2026-02-01","7.046","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-07","2026-02-06","2.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-06","2026-02-17","7.712","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-04","2026-01-08","400","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-23","2026-01-05","1.928","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":995},{"label":"Mar","value":739},{"label":"Abr","value":702},{"label":"Mai","value":756},{"label":"Jun","value":786},{"label":"Jul","value":767},{"label":"Ago","value":683},{"label":"Set","value":1007},{"label":"Out","value":650},{"label":"Nov","value":890},{"label":"Dez","value":840}];
const MX = 1007;
