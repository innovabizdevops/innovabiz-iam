...
const PAGE = "Beneficiation";
const KPIS = [{"l":"Total Iron Ore","v":"6.328","t":"+3.2%","d":"up"},{"l":"Beneficiation Ativos","v":"2.658","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"73","t":"+2.1%","d":"up"}];
const COLS = ["ID","Beneficiation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Iron Ore #001","Iron Ore #002","7.956","2.809","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Iron Ore #002","Iron Ore #003","8.010","1.540","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Iron Ore #003","Iron Ore #004","5.666","7.768","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Iron Ore #004","Iron Ore #005","5.101","2.414","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Iron Ore #005","Iron Ore #001","2.467","2.442","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":329},{"label":"Mar","value":489},{"label":"Abr","value":472},{"label":"Mai","value":588},{"label":"Jun","value":714},{"label":"Jul","value":403},{"label":"Ago","value":645},{"label":"Set","value":372},{"label":"Out","value":549},{"label":"Nov","value":507},{"label":"Dez","value":453}];
const MX = 714;
