...
const PAGE = "Pellet";
const KPIS = [{"l":"Total Iron Ore","v":"3.528","t":"+14.1%","d":"up"},{"l":"Pellet Ativos","v":"7.882","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+7.2%","d":"up"}];
const COLS = ["ID","Pellet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Iron Ore #001","Iron Ore #002","9.024","1.585","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Iron Ore #002","Iron Ore #003","9.084","6.863","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Iron Ore #003","Iron Ore #004","8.538","1.371","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Iron Ore #004","Iron Ore #005","1.035","8.125","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Iron Ore #005","Iron Ore #001","6.426","7.564","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":939},{"label":"Mar","value":1060},{"label":"Abr","value":1003},{"label":"Mai","value":976},{"label":"Jun","value":995},{"label":"Jul","value":854},{"label":"Ago","value":673},{"label":"Set","value":987},{"label":"Out","value":882},{"label":"Nov","value":675},{"label":"Dez","value":754}];
const MX = 1060;
