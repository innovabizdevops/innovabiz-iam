...
const PAGE = "Market";
const KPIS = [{"l":"Total Iron Ore","v":"4.449","t":"+12.5%","d":"up"},{"l":"Market Ativos","v":"8.733","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+5.1%","d":"up"}];
const COLS = ["ID","Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Iron Ore #001","Iron Ore #002","5.307","151","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Iron Ore #002","Iron Ore #003","7.108","3.005","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Iron Ore #003","Iron Ore #004","4.742","4.786","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Iron Ore #004","Iron Ore #005","5.800","4.668","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Iron Ore #005","Iron Ore #001","6.948","1.238","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":655},{"label":"Mar","value":943},{"label":"Abr","value":585},{"label":"Mai","value":970},{"label":"Jun","value":862},{"label":"Jul","value":748},{"label":"Ago","value":605},{"label":"Set","value":934},{"label":"Out","value":770},{"label":"Nov","value":851},{"label":"Dez","value":850}];
const MX = 970;
