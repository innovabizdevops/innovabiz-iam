...
/* ═══ Vendor Management Deep — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "8142", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2579", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€34K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1704203942", cells: ["VEN-9942", "Vendor Management Deep Item 1", "15/3/2026", "€4042"], status: "active" as const },
    { id: "1704207513", cells: ["VEN-4513", "Vendor Management Deep Item 2", "2/10/2026", "€7613"], status: "pending" as const },
    { id: "1704211084", cells: ["VEN-8084", "Vendor Management Deep Item 3", "17/5/2026", "€11 184"], status: "completed" as const },
    { id: "1704214655", cells: ["VEN-2655", "Vendor Management Deep Item 4", "4/12/2026", "€14 755"], status: "warning" as const },
    { id: "1704218226", cells: ["VEN-6226", "Vendor Management Deep Item 5", "19/7/2026", "€18 326"], status: "active" as const },
];
...
export default function VendorManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vendor Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vendor Management Deep</p>
                    </div>
                </div>
