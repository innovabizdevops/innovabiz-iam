...
const PAGE = "Qualify";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.946","t":"+6.7%","d":"up"},{"l":"Contratos (€M)","v":"€29.0M","t":"+4.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"77.1%","t":"+6.6%","d":"up"},{"l":"Score Médio","v":"91","t":"+9.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","80.8%","€ 25886.52","8.674","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","98.4%","€ 18358.29","8.601","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","92.7%","€ 3297.18","741","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","74.9%","€ 5812.53","7.082","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","71.2%","€ 35266.08","8.532","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":813},{"label":"Mar","value":658},{"label":"Abr","value":818},{"label":"Mai","value":495},{"label":"Jun","value":618},{"label":"Jul","value":599},{"label":"Ago","value":760},{"label":"Set","value":526},{"label":"Out","value":495},{"label":"Nov","value":850},{"label":"Dez","value":485}];
const MX = 855;
