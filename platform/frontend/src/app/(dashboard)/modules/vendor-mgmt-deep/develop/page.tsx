...
const PAGE = "Develop";
const KPIS = [{"l":"Fornecedores Ativos","v":"585","t":"-3.8%","d":"down"},{"l":"Contratos (€M)","v":"€48.1M","t":"+4.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"68.6%","t":"-2.8%","d":"down"},{"l":"Score Médio","v":"64","t":"+11.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","71.4%","€ 30340.63","626","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","71.5%","€ 28774.90","2.421","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","84.5%","€ 24541.33","8.452","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","96.1%","€ 33946.88","235","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","70.5%","€ 33373.79","1.957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":687},{"label":"Mar","value":847},{"label":"Abr","value":610},{"label":"Mai","value":732},{"label":"Jun","value":687},{"label":"Jul","value":604},{"label":"Ago","value":758},{"label":"Set","value":831},{"label":"Out","value":530},{"label":"Nov","value":526},{"label":"Dez","value":790}];
const MX = 847;
