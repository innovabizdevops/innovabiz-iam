...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"84","t":"+0.6%","d":"up"},{"l":"Engagement (%)","v":"73.2%","t":"-5.1%","d":"down"},{"l":"Turnover (%)","v":"83.9%","t":"+10.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.727","t":"+15.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.015","2026-01-15","79","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.776","2026-03-27","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.641","2026-02-17","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.893","2026-03-03","76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.438","2026-01-01","92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":703},{"label":"Mar","value":708},{"label":"Abr","value":713},{"label":"Mai","value":754},{"label":"Jun","value":1022},{"label":"Jul","value":1040},{"label":"Ago","value":845},{"label":"Set","value":805},{"label":"Out","value":925},{"label":"Nov","value":798},{"label":"Dez","value":893}];
const MX = 1040;
