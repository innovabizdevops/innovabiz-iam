...
const PAGE = "Exit";
const KPIS = [{"l":"Fornecedores Ativos","v":"5.837","t":"-1.1%","d":"down"},{"l":"Contratos (€M)","v":"€38.3M","t":"+14.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"71.0%","t":"+12.0%","d":"up"},{"l":"Score Médio","v":"90","t":"+12.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","72.8%","€ 15298.94","179","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","94.0%","€ 19772.77","6.320","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","84.4%","€ 5357.25","546","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","71.6%","€ 42540.70","5.844","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.5%","€ 23080.54","6.324","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":369},{"label":"Mar","value":551},{"label":"Abr","value":583},{"label":"Mai","value":505},{"label":"Jun","value":475},{"label":"Jul","value":560},{"label":"Ago","value":378},{"label":"Set","value":417},{"label":"Out","value":397},{"label":"Nov","value":629},{"label":"Dez","value":363}];
const MX = 629;
