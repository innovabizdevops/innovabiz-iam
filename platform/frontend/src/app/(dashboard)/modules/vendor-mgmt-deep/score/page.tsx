...
const ACCENT = "#047857";
const MODULE = "Vendor Management Deep";
const PAGE = "Score";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.474","t":"+1.4%","d":"up"},{"l":"Contratos (€M)","v":"€40.7M","t":"-5.7%","d":"down"},{"l":"On-Time Delivery (%)","v":"67.7%","t":"+17.2%","d":"up"},{"l":"Score Médio","v":"89","t":"+13.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","70.2%","€ 229.45","6.420","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","72.5%","€ 26819.79","7.575","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","78.7%","€ 27216.73","3.974","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","72.1%","€ 49721.46","2.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","77.5%","€ 44359.75","7.278","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":539},{"label":"Mar","value":672},{"label":"Abr","value":499},{"label":"Mai","value":615},{"label":"Jun","value":476},{"label":"Jul","value":367},{"label":"Ago","value":442},{"label":"Set","value":348},{"label":"Out","value":381},{"label":"Nov","value":339},{"label":"Dez","value":705}];
const MX = 705;
