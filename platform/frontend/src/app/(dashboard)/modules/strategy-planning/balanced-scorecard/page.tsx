...
const KPIS = [{"l":"Total Strategy Planning","v":"3.996","t":"+14.6%","d":"up"},{"l":"Balanced Scorecard Ativos","v":"85","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"70","t":"+3.1%","d":"up"}];
const COLS = ["ID","Balanced Scorecard","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","78.1%","2.990","1.108","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","96.3%","6.703","5.410","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","86.9%","3.759","3.595","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","83.9%","6.207","2.334","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","98.5%","3.944","5.674","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":316},{"label":"Mar","value":447},{"label":"Abr","value":500},{"label":"Mai","value":282},{"label":"Jun","value":541},{"label":"Jul","value":256},{"label":"Ago","value":331},{"label":"Set","value":386},{"label":"Out","value":551},{"label":"Nov","value":595},{"label":"Dez","value":345}];
const MX = 595;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>BSC</span></h1>
                </div>
