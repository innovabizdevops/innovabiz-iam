...
const ACCENT = "#6366f1";
const MODULE = "Strategy Planning";
const PAGE = "Competitive Intel AI";
const KPIS = [{"l":"Total Strategy Planning","v":"6.475","t":"+12.4%","d":"up"},{"l":"Competitive Intel AI Ativos","v":"1.106","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+14.4%","d":"up"}];
const COLS = ["ID","Competitive Intel AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","2.249","8.851","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","6.705","8.351","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","8.905","3.884","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","7.971","4.526","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","6.984","7.636","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":792},{"label":"Mar","value":718},{"label":"Abr","value":932},{"label":"Mai","value":895},{"label":"Jun","value":751},{"label":"Jul","value":669},{"label":"Ago","value":649},{"label":"Set","value":903},{"label":"Out","value":730},{"label":"Nov","value":815},{"label":"Dez","value":795}];
const MX = 932;
