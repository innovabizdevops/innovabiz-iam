...
const PAGE = "Porter 5 Forces";
const KPIS = [{"l":"Total Strategy Planning","v":"4.248","t":"+5.1%","d":"up"},{"l":"Porter 5 Forces Ativos","v":"8.291","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"88.0%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"78","t":"-0.1%","d":"down"}];
const COLS = ["ID","Porter 5 Forces","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","8.290","1.305","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","6.255","669","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","3.352","3.685","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","3.517","6.027","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","5.172","6.907","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":722},{"label":"Mar","value":943},{"label":"Abr","value":910},{"label":"Mai","value":987},{"label":"Jun","value":836},{"label":"Jul","value":835},{"label":"Ago","value":970},{"label":"Set","value":815},{"label":"Out","value":875},{"label":"Nov","value":913},{"label":"Dez","value":670}];
const MX = 987;
...
export default function Porter5ForcesPage() {
    return (
