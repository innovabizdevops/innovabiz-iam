...
const PAGE = "Scenario Planning";
const KPIS = [{"l":"Total Strategy Planning","v":"3.562","t":"+12.5%","d":"up"},{"l":"Scenario Planning Ativos","v":"4.316","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+12.4%","d":"up"}];
const COLS = ["ID","Scenario Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","8.660","8.819","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","329","1.641","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","2.852","8.592","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","1.234","1.986","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","2.974","8.089","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":714},{"label":"Mar","value":815},{"label":"Abr","value":873},{"label":"Mai","value":747},{"label":"Jun","value":756},{"label":"Jul","value":979},{"label":"Ago","value":861},{"label":"Set","value":890},{"label":"Out","value":852},{"label":"Nov","value":939},{"label":"Dez","value":648}];
const MX = 979;
