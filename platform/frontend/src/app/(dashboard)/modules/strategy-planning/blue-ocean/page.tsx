...
const PAGE = "Blue Ocean Canvas";
const KPIS = [{"l":"Total Strategy Planning","v":"5.868","t":"+6.0%","d":"up"},{"l":"Blue Ocean Canvas Ativos","v":"6.347","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"75.7%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+11.1%","d":"up"}];
const COLS = ["ID","Blue Ocean Canvas","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","487","8.408","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","1.232","2.127","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","3.760","6.820","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","271","5.837","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","4.333","5.267","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":409},{"label":"Mar","value":491},{"label":"Abr","value":457},{"label":"Mai","value":734},{"label":"Jun","value":674},{"label":"Jul","value":703},{"label":"Ago","value":607},{"label":"Set","value":567},{"label":"Out","value":387},{"label":"Nov","value":475},{"label":"Dez","value":468}];
const MX = 761;
