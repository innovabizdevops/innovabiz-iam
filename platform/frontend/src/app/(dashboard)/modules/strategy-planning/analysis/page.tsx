...
const PAGE = "SWOT &amp; PESTEL";
const KPIS = [{"l":"Dashboards Ativos","v":"1.333","t":"+16.7%","d":"up"},{"l":"Queries/Dia","v":"3000","t":"+3.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.049","t":"+15.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.726","t":"-1.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5016","2026-02-04","6.791","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2198","2026-02-14","3.411","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","167","2026-02-14","6.146","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3547","2026-03-10","8.098","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4140","2026-03-22","8.581","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":654},{"label":"Mar","value":774},{"label":"Abr","value":547},{"label":"Mai","value":719},{"label":"Jun","value":834},{"label":"Jul","value":862},{"label":"Ago","value":652},{"label":"Set","value":864},{"label":"Out","value":807},{"label":"Nov","value":710},{"label":"Dez","value":536}];
const MX = 864;
