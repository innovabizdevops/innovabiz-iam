...
const KPIS = [{"l":"Total Strategy Planning","v":"2.171","t":"+5.8%","d":"up"},{"l":"Strategy Map Ativos","v":"7.861","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"91","t":"+6.5%","d":"up"}];
const COLS = ["ID","Strategy Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","3.789","7.973","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","3.553","5.386","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","4.393","1.316","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","4.439","3.379","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","4.530","4.209","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":362},{"label":"Mar","value":632},{"label":"Abr","value":384},{"label":"Mai","value":405},{"label":"Jun","value":514},{"label":"Jul","value":531},{"label":"Ago","value":322},{"label":"Set","value":569},{"label":"Out","value":314},{"label":"Nov","value":507},{"label":"Dez","value":516}];
const MX = 632;
