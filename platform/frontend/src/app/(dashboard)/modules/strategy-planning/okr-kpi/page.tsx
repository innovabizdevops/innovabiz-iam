...
const PAGE = "OKR &amp; KPI Framework";
const KPIS = [{"l":"Total Strategy Planning","v":"6.335","t":"+11.6%","d":"up"},{"l":"OKR & KPI Framework Ativos","v":"9.057","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.6%","d":"up"}];
const COLS = ["ID","OKR & KPI Framework","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","1.561","4.217","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","5.803","827","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","5.159","3.952","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","5.790","2.082","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","535","3.906","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":969},{"label":"Mar","value":904},{"label":"Abr","value":845},{"label":"Mai","value":1010},{"label":"Jun","value":929},{"label":"Jul","value":1033},{"label":"Ago","value":742},{"label":"Set","value":710},{"label":"Out","value":808},{"label":"Nov","value":879},{"label":"Dez","value":757}];
const MX = 1033;
