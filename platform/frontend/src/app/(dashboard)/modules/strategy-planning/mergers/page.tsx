...
const PAGE = "M&amp;A Pipeline";
const KPIS = [{"l":"Total Strategy Planning","v":"5.326","t":"+5.5%","d":"up"},{"l":"M&A Pipeline Ativos","v":"5.184","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"61","t":"+14.3%","d":"up"}];
const COLS = ["ID","M&A Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","6.526","6.898","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","2.940","1.579","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","2.463","8.313","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","5.187","3.977","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","4.930","3.353","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":761},{"label":"Mar","value":797},{"label":"Abr","value":900},{"label":"Mai","value":969},{"label":"Jun","value":706},{"label":"Jul","value":823},{"label":"Ago","value":806},{"label":"Set","value":762},{"label":"Out","value":1047},{"label":"Nov","value":930},{"label":"Dez","value":864}];
const MX = 1047;
