...
const PAGE = "Corporate Strategy";
const KPIS = [{"l":"Total Strategy Planning","v":"5.204","t":"+5.7%","d":"up"},{"l":"Corporate Strategy Ativos","v":"5.378","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+13.5%","d":"up"}];
const COLS = ["ID","Corporate Strategy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategy Planning #001","Strategy Planning #002","2.314","6.826","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Strategy Planning #002","Strategy Planning #003","6.317","5.291","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategy Planning #003","Strategy Planning #004","5.935","2.607","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Strategy Planning #004","Strategy Planning #005","2.508","6.760","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategy Planning #005","Strategy Planning #001","7.003","2.386","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":765},{"label":"Mar","value":611},{"label":"Abr","value":853},{"label":"Mai","value":723},{"label":"Jun","value":724},{"label":"Jul","value":662},{"label":"Ago","value":925},{"label":"Set","value":884},{"label":"Out","value":679},{"label":"Nov","value":768},{"label":"Dez","value":819}];
const MX = 925;
