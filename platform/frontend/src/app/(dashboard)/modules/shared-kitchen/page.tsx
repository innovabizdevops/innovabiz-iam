...
/* ═══ Shared Commercial Kitchen — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "3025", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4230", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1825602525", cells: ["SHA-7525", "Shared Commercial Kitchen Item 1", "6/10/2026", "€2625"], status: "active" as const },
    { id: "1825606096", cells: ["SHA-2096", "Shared Commercial Kitchen Item 2", "21/5/2026", "€6196"], status: "pending" as const },
    { id: "1825609667", cells: ["SHA-5667", "Shared Commercial Kitchen Item 3", "8/12/2026", "€9767"], status: "completed" as const },
    { id: "1825613238", cells: ["SHA-9238", "Shared Commercial Kitchen Item 4", "23/7/2026", "€13 338"], status: "warning" as const },
    { id: "1825616809", cells: ["SHA-3809", "Shared Commercial Kitchen Item 5", "10/2/2026", "€16 909"], status: "active" as const },
];
...
export default function SharedCommercialKitchenPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shared Commercial Kitchen</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Shared Commercial Kitchen</p>
                    </div>
                </div>
