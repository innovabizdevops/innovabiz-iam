...
const ACCENT = "#312e81";
const MODULE = "Shared Commercial Kitchen";
const PAGE = "Comply";
const KPIS = [{"l":"Quartos Ocupados","v":"2.531","t":"-3.3%","d":"down"},{"l":"RevPAR (€)","v":"€1758","t":"+10.6%","d":"up"},{"l":"Ocupação (%)","v":"89.2%","t":"-4.5%","d":"down"},{"l":"Guest Satisfaction","v":"7.200","t":"+10.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","527","2026-03-20","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.143","2026-01-21","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.676","2026-01-13","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.652","2026-03-01","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.832","2026-02-06","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":722},{"label":"Mar","value":778},{"label":"Abr","value":759},{"label":"Mai","value":639},{"label":"Jun","value":433},{"label":"Jul","value":463},{"label":"Ago","value":698},{"label":"Set","value":567},{"label":"Out","value":701},{"label":"Nov","value":529},{"label":"Dez","value":680}];
const MX = 778;
