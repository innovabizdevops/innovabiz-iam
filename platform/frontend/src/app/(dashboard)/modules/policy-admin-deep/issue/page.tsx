...
const PAGE = "Issue";
const KPIS = [{"l":"Total Policy Admin Deep","v":"5.747","t":"+1.1%","d":"up"},{"l":"Issue Ativos","v":"3.675","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"80.0%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+8.3%","d":"up"}];
const COLS = ["ID","Issue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Admin Deep #001","Policy Admin Deep #002","900","5.521","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Admin Deep #002","Policy Admin Deep #003","4.395","4.579","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Admin Deep #003","Policy Admin Deep #004","8.003","1.352","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Admin Deep #004","Policy Admin Deep #005","2.170","6.707","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Admin Deep #005","Policy Admin Deep #001","8.668","5.585","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":701},{"label":"Mar","value":439},{"label":"Abr","value":395},{"label":"Mai","value":427},{"label":"Jun","value":711},{"label":"Jul","value":672},{"label":"Ago","value":413},{"label":"Set","value":767},{"label":"Out","value":684},{"label":"Nov","value":411},{"label":"Dez","value":642}];
const MX = 769;
