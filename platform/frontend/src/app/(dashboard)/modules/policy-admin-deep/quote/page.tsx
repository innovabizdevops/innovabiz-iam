...
const ACCENT = "#92400e";
const MODULE = "Policy Admin System Deep";
const PAGE = "Quote";
const KPIS = [{"l":"Total Policy Admin Deep","v":"5.371","t":"+3.3%","d":"up"},{"l":"Quote Ativos","v":"1.901","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"88.7%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+7.1%","d":"up"}];
const COLS = ["ID","Quote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Admin Deep #001","Policy Admin Deep #002","7.791","4.785","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Admin Deep #002","Policy Admin Deep #003","4.635","1.711","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Admin Deep #003","Policy Admin Deep #004","7.730","2.161","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Admin Deep #004","Policy Admin Deep #005","8.311","1.571","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Admin Deep #005","Policy Admin Deep #001","2.921","2.438","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":371},{"label":"Mar","value":330},{"label":"Abr","value":465},{"label":"Mai","value":330},{"label":"Jun","value":475},{"label":"Jul","value":508},{"label":"Ago","value":462},{"label":"Set","value":667},{"label":"Out","value":613},{"label":"Nov","value":522},{"label":"Dez","value":584}];
const MX = 667;
