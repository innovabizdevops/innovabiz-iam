...
/* ═══ Policy Admin System Deep — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "6964", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "397", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€59K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "985363764", cells: ["POL-8764", "Policy Admin System Deep Item 1", "1/1/2026", "€13 864"], status: "active" as const },
    { id: "985367335", cells: ["POL-3335", "Policy Admin System Deep Item 2", "16/8/2026", "€17 435"], status: "pending" as const },
    { id: "985370906", cells: ["POL-6906", "Policy Admin System Deep Item 3", "3/3/2026", "€21 006"], status: "completed" as const },
    { id: "985374477", cells: ["POL-1477", "Policy Admin System Deep Item 4", "18/10/2026", "€24 577"], status: "warning" as const },
    { id: "985378048", cells: ["POL-5048", "Policy Admin System Deep Item 5", "5/5/2026", "€28 148"], status: "active" as const },
];
...
export default function PolicyAdminSystemDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Policy Admin System Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Policy Admin System Deep</p>
                    </div>
                </div>
