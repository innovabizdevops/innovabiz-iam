...
const PAGE = "Product";
const KPIS = [{"l":"Total Policy Admin Deep","v":"1.186","t":"-5.5%","d":"down"},{"l":"Product Ativos","v":"6.778","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"70","t":"-4.1%","d":"down"}];
const COLS = ["ID","Product","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Admin Deep #001","Policy Admin Deep #002","2.918","3.265","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Admin Deep #002","Policy Admin Deep #003","9.044","3.453","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Admin Deep #003","Policy Admin Deep #004","3.144","5.907","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Admin Deep #004","Policy Admin Deep #005","1.926","3.717","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Admin Deep #005","Policy Admin Deep #001","1.896","7.749","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":680},{"label":"Mar","value":710},{"label":"Abr","value":683},{"label":"Mai","value":764},{"label":"Jun","value":546},{"label":"Jul","value":718},{"label":"Ago","value":707},{"label":"Set","value":664},{"label":"Out","value":391},{"label":"Nov","value":460},{"label":"Dez","value":692}];
const MX = 764;
