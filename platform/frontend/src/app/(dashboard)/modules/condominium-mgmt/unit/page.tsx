...
const PAGE = "Unit";
const KPIS = [{"l":"Total Condominium Mgmt","v":"1.572","t":"-1.2%","d":"down"},{"l":"Unit Ativos","v":"3.689","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+16.5%","d":"up"}];
const COLS = ["ID","Unit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Condominium Mgmt #001","Condominium Mgmt #002","7.922","5.980","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Condominium Mgmt #002","Condominium Mgmt #003","271","5.963","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Condominium Mgmt #003","Condominium Mgmt #004","4.852","9.030","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Condominium Mgmt #004","Condominium Mgmt #005","5.213","4.456","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Condominium Mgmt #005","Condominium Mgmt #001","1.382","252","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":603},{"label":"Mar","value":768},{"label":"Abr","value":515},{"label":"Mai","value":484},{"label":"Jun","value":706},{"label":"Jul","value":626},{"label":"Ago","value":736},{"label":"Set","value":811},{"label":"Out","value":436},{"label":"Nov","value":738},{"label":"Dez","value":573}];
const MX = 811;
