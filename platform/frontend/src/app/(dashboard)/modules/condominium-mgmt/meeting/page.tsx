...
const PAGE = "Meeting";
const KPIS = [{"l":"Teams Ativos","v":"5.602","t":"-3.6%","d":"down"},{"l":"Reuniões/Semana","v":"2491","t":"-4.3%","d":"down"},{"l":"Mensagens/Dia","v":"2467","t":"+17.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"370","t":"+14.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.727","2269","7.262","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.854","1242","1.372","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.005","2573","5.729","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.093","4819","1.468","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.728","599","379","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":963},{"label":"Mar","value":1009},{"label":"Abr","value":864},{"label":"Mai","value":938},{"label":"Jun","value":805},{"label":"Jul","value":802},{"label":"Ago","value":634},{"label":"Set","value":879},{"label":"Out","value":922},{"label":"Nov","value":902},{"label":"Dez","value":920}];
const MX = 1009;
