...
const PAGE = "Reserve";
const KPIS = [{"l":"Total Condominium Mgmt","v":"1.858","t":"+1.6%","d":"up"},{"l":"Reserve Ativos","v":"5.562","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"57","t":"+9.3%","d":"up"}];
const COLS = ["ID","Reserve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Condominium Mgmt #001","Condominium Mgmt #002","1.786","194","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Condominium Mgmt #002","Condominium Mgmt #003","2.009","5.730","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Condominium Mgmt #003","Condominium Mgmt #004","8.285","2.232","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Condominium Mgmt #004","Condominium Mgmt #005","5.431","5.273","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Condominium Mgmt #005","Condominium Mgmt #001","2.601","7.737","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":816},{"label":"Mar","value":639},{"label":"Abr","value":488},{"label":"Mai","value":593},{"label":"Jun","value":589},{"label":"Jul","value":570},{"label":"Ago","value":513},{"label":"Set","value":750},{"label":"Out","value":790},{"label":"Nov","value":582},{"label":"Dez","value":571}];
const MX = 816;
