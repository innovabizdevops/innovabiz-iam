...
const ACCENT = "#6366f1";
const MODULE = "Condominium Mgmt";
const PAGE = "Violations";
const KPIS = [{"l":"Total Condominium Mgmt","v":"2.135","t":"+6.2%","d":"up"},{"l":"Violations Ativos","v":"6.852","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+17.4%","d":"up"}];
const COLS = ["ID","Violations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Condominium Mgmt #001","Condominium Mgmt #002","653","7.045","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Condominium Mgmt #002","Condominium Mgmt #003","2.374","4.432","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Condominium Mgmt #003","Condominium Mgmt #004","1.397","2.663","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Condominium Mgmt #004","Condominium Mgmt #005","269","7.272","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Condominium Mgmt #005","Condominium Mgmt #001","6.775","8.480","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":490},{"label":"Mar","value":876},{"label":"Abr","value":494},{"label":"Mai","value":774},{"label":"Jun","value":700},{"label":"Jul","value":838},{"label":"Ago","value":744},{"label":"Set","value":827},{"label":"Out","value":530},{"label":"Nov","value":701},{"label":"Dez","value":532}];
const MX = 876;
