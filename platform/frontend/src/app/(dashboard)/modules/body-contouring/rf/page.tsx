...
const PAGE = "RF";
const KPIS = [{"l":"Total Body Contouring","v":"3.936","t":"+2.3%","d":"up"},{"l":"RF Ativos","v":"2.105","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"73","t":"+8.0%","d":"up"}];
const COLS = ["ID","RF","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Contouring #001","Body Contouring #002","7.841","1.996","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Body Contouring #002","Body Contouring #003","5.072","4.648","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Contouring #003","Body Contouring #004","6.001","1.397","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Body Contouring #004","Body Contouring #005","1.539","6.111","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Contouring #005","Body Contouring #001","2.206","101","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":543},{"label":"Mar","value":673},{"label":"Abr","value":649},{"label":"Mai","value":781},{"label":"Jun","value":530},{"label":"Jul","value":751},{"label":"Ago","value":486},{"label":"Set","value":449},{"label":"Out","value":800},{"label":"Nov","value":764},{"label":"Dez","value":701}];
const MX = 800;
