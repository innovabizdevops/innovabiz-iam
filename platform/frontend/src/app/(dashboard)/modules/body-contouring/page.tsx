...
/* ═══ Body Contouring — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "4454", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "212", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€357K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "319279354", cells: ["BOD-5354", "Body Contouring Item 1", "3/11/2026", "€29 454"], status: "active" as const },
    { id: "319282925", cells: ["BOD-8925", "Body Contouring Item 2", "18/6/2026", "€33 025"], status: "pending" as const },
    { id: "319286496", cells: ["BOD-3496", "Body Contouring Item 3", "5/1/2026", "€36 596"], status: "completed" as const },
    { id: "319290067", cells: ["BOD-7067", "Body Contouring Item 4", "20/8/2026", "€40 167"], status: "warning" as const },
    { id: "319293638", cells: ["BOD-1638", "Body Contouring Item 5", "7/3/2026", "€43 738"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Body Contouring</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Body Contouring</p>
                    </div>
                </div>
