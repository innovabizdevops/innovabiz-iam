...
const ACCENT = "#9d174d";
const MODULE = "Body Contouring";
const PAGE = "Assess";
const KPIS = [{"l":"Total Body Contouring","v":"3.157","t":"+14.2%","d":"up"},{"l":"Assess Ativos","v":"641","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"61","t":"+2.4%","d":"up"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Contouring #001","Body Contouring #002","3.705","4.607","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Body Contouring #002","Body Contouring #003","4.866","5.728","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Contouring #003","Body Contouring #004","8.571","1.259","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Body Contouring #004","Body Contouring #005","5.209","6.079","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Contouring #005","Body Contouring #001","2.021","1.701","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":427},{"label":"Mar","value":567},{"label":"Abr","value":645},{"label":"Mai","value":430},{"label":"Jun","value":403},{"label":"Jul","value":697},{"label":"Ago","value":449},{"label":"Set","value":736},{"label":"Out","value":555},{"label":"Nov","value":720},{"label":"Dez","value":438}];
const MX = 736;
