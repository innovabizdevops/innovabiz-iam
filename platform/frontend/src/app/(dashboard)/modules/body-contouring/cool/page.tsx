...
const PAGE = "Cool";
const KPIS = [{"l":"Total Body Contouring","v":"6.422","t":"-0.9%","d":"down"},{"l":"Cool Ativos","v":"9.047","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"84.9%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.1%","d":"down"}];
const COLS = ["ID","Cool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Contouring #001","Body Contouring #002","2.516","4.626","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Body Contouring #002","Body Contouring #003","2.184","7.957","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Contouring #003","Body Contouring #004","326","6.429","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Body Contouring #004","Body Contouring #005","6.923","8.967","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Contouring #005","Body Contouring #001","7.508","7.076","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":231},{"label":"Fev","value":421},{"label":"Mar","value":483},{"label":"Abr","value":437},{"label":"Mai","value":453},{"label":"Jun","value":521},{"label":"Jul","value":325},{"label":"Ago","value":485},{"label":"Set","value":350},{"label":"Out","value":270},{"label":"Nov","value":502},{"label":"Dez","value":313}];
const MX = 521;
