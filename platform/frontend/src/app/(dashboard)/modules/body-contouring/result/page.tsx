...
const PAGE = "Result";
const KPIS = [{"l":"Total Body Contouring","v":"6.333","t":"+3.1%","d":"up"},{"l":"Result Ativos","v":"1.301","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"77","t":"+7.4%","d":"up"}];
const COLS = ["ID","Result","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Contouring #001","Body Contouring #002","314","6.023","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Body Contouring #002","Body Contouring #003","1.156","4.733","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Contouring #003","Body Contouring #004","6.379","7.269","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Body Contouring #004","Body Contouring #005","7.425","4.765","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Contouring #005","Body Contouring #001","157","3.186","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":1057},{"label":"Mar","value":1066},{"label":"Abr","value":799},{"label":"Mai","value":851},{"label":"Jun","value":728},{"label":"Jul","value":785},{"label":"Ago","value":800},{"label":"Set","value":1094},{"label":"Out","value":761},{"label":"Nov","value":1024},{"label":"Dez","value":750}];
const MX = 1094;
