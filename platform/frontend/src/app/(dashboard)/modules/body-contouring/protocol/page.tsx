...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"1.577","t":"+3.0%","d":"up"},{"l":"Chamadas/Hora","v":"2458","t":"-0.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"71.6%","t":"-0.9%","d":"down"},{"l":"Latência Média (ms)","v":"49ms","t":"-0.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.041","3.985","75.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.749","5.768","73.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.620","2.456","87.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","880","4.455","71.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.234","5.051","88.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":743},{"label":"Mar","value":441},{"label":"Abr","value":498},{"label":"Mai","value":443},{"label":"Jun","value":519},{"label":"Jul","value":558},{"label":"Ago","value":421},{"label":"Set","value":731},{"label":"Out","value":552},{"label":"Nov","value":490},{"label":"Dez","value":738}];
const MX = 743;
