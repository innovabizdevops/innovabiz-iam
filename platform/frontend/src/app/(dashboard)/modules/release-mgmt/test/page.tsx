...
const PAGE = "Test";
const KPIS = [{"l":"Total Release Mgmt","v":"3.110","t":"-2.8%","d":"down"},{"l":"Test Ativos","v":"2.143","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"73.2%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+5.9%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Release Mgmt #001","Release Mgmt #002","1.827","1.794","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Release Mgmt #002","Release Mgmt #003","4.935","4.040","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Release Mgmt #003","Release Mgmt #004","8.472","6.897","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Release Mgmt #004","Release Mgmt #005","309","642","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Release Mgmt #005","Release Mgmt #001","1.486","5.185","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":508},{"label":"Mar","value":604},{"label":"Abr","value":545},{"label":"Mai","value":522},{"label":"Jun","value":360},{"label":"Jul","value":522},{"label":"Ago","value":434},{"label":"Set","value":629},{"label":"Out","value":579},{"label":"Nov","value":657},{"label":"Dez","value":525}];
const MX = 657;
