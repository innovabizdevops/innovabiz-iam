...
const PAGE = "Plan";
const KPIS = [{"l":"Total Release Mgmt","v":"5.293","t":"+8.6%","d":"up"},{"l":"Plan Ativos","v":"7.671","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"63","t":"-3.0%","d":"down"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Release Mgmt #001","Release Mgmt #002","3.203","2.581","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Release Mgmt #002","Release Mgmt #003","9.079","1.085","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Release Mgmt #003","Release Mgmt #004","1.922","8.297","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Release Mgmt #004","Release Mgmt #005","5.358","8.841","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Release Mgmt #005","Release Mgmt #001","3.819","7.468","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":592},{"label":"Mar","value":261},{"label":"Abr","value":435},{"label":"Mai","value":574},{"label":"Jun","value":278},{"label":"Jul","value":594},{"label":"Ago","value":556},{"label":"Set","value":243},{"label":"Out","value":378},{"label":"Nov","value":310},{"label":"Dez","value":337}];
const MX = 594;
