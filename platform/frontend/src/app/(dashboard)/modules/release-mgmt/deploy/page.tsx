...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Release Mgmt","v":"6.320","t":"+9.3%","d":"up"},{"l":"Deploy Ativos","v":"5.338","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"87.5%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"68","t":"-3.4%","d":"down"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Release Mgmt #001","Release Mgmt #002","7.831","8.724","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Release Mgmt #002","Release Mgmt #003","389","8.190","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Release Mgmt #003","Release Mgmt #004","3.800","7.770","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Release Mgmt #004","Release Mgmt #005","3.136","5.440","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Release Mgmt #005","Release Mgmt #001","348","3.908","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":544},{"label":"Mar","value":533},{"label":"Abr","value":704},{"label":"Mai","value":551},{"label":"Jun","value":814},{"label":"Jul","value":568},{"label":"Ago","value":803},{"label":"Set","value":518},{"label":"Out","value":582},{"label":"Nov","value":640},{"label":"Dez","value":493}];
const MX = 814;
