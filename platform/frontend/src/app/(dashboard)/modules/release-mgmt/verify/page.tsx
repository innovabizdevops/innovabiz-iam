...
const ACCENT = "#64748b";
const MODULE = "Release Management (ITIL)";
const PAGE = "Verify";
const KPIS = [{"l":"Total Release Mgmt","v":"8.342","t":"+17.9%","d":"up"},{"l":"Verify Ativos","v":"916","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.8%","d":"up"}];
const COLS = ["ID","Verify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Release Mgmt #001","Release Mgmt #002","8.481","6.518","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Release Mgmt #002","Release Mgmt #003","5.681","5.787","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Release Mgmt #003","Release Mgmt #004","7.765","1.681","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Release Mgmt #004","Release Mgmt #005","4.682","9.096","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Release Mgmt #005","Release Mgmt #001","8.314","3.277","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":657},{"label":"Mar","value":366},{"label":"Abr","value":589},{"label":"Mai","value":738},{"label":"Jun","value":601},{"label":"Jul","value":430},{"label":"Ago","value":495},{"label":"Set","value":635},{"label":"Out","value":724},{"label":"Nov","value":389},{"label":"Dez","value":638}];
const MX = 738;
