...
const PAGE = "Build";
const KPIS = [{"l":"Total Release Mgmt","v":"4.279","t":"+9.9%","d":"up"},{"l":"Build Ativos","v":"4.701","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"87.7%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"91","t":"+12.5%","d":"up"}];
const COLS = ["ID","Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Release Mgmt #001","Release Mgmt #002","8.017","3.058","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Release Mgmt #002","Release Mgmt #003","5.545","717","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Release Mgmt #003","Release Mgmt #004","8.510","3.038","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Release Mgmt #004","Release Mgmt #005","4.442","7.695","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Release Mgmt #005","Release Mgmt #001","6.272","4.892","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":802},{"label":"Mar","value":796},{"label":"Abr","value":637},{"label":"Mai","value":672},{"label":"Jun","value":923},{"label":"Jul","value":664},{"label":"Ago","value":828},{"label":"Set","value":752},{"label":"Out","value":943},{"label":"Nov","value":624},{"label":"Dez","value":761}];
const MX = 943;
