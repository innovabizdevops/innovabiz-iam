...
/* ═══ Release Management (ITIL) — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "7558", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3216", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€215K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1214866158", cells: ["REL-2158", "Release Management (ITIL) Item 1", "3/7/2026", "€16 258"], status: "active" as const },
    { id: "1214869729", cells: ["REL-5729", "Release Management (ITIL) Item 2", "18/2/2026", "€19 829"], status: "pending" as const },
    { id: "1214873300", cells: ["REL-9300", "Release Management (ITIL) Item 3", "5/9/2026", "€23 400"], status: "completed" as const },
    { id: "1214876871", cells: ["REL-3871", "Release Management (ITIL) Item 4", "20/4/2026", "€26 971"], status: "warning" as const },
    { id: "1214880442", cells: ["REL-7442", "Release Management (ITIL) Item 5", "7/11/2026", "€30 542"], status: "active" as const },
];
...
export default function ReleaseManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Release Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Release Management (ITIL)</p>
                    </div>
                </div>
