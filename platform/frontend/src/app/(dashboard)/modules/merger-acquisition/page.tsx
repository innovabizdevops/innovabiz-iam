...
/* ═══ M&A Management — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "3389", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4940", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€500K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "678648289", cells: ["MER-4289", "M&A Management Item 1", "26/2/2026", "€48 389"], status: "active" as const },
    { id: "678651860", cells: ["MER-7860", "M&A Management Item 2", "13/9/2026", "€1960"], status: "pending" as const },
    { id: "678655431", cells: ["MER-2431", "M&A Management Item 3", "28/4/2026", "€5531"], status: "completed" as const },
    { id: "678659002", cells: ["MER-6002", "M&A Management Item 4", "15/11/2026", "€9102"], status: "warning" as const },
    { id: "678662573", cells: ["MER-9573", "M&A Management Item 5", "2/6/2026", "€12 673"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">M&A Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • M&A Management</p>
                    </div>
                </div>
