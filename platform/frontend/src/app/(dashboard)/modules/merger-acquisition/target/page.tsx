...
const PAGE = "Target";
const KPIS = [{"l":"Total Merger Acquisition","v":"745","t":"+5.3%","d":"up"},{"l":"Target Ativos","v":"4.013","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"79","t":"-5.7%","d":"down"}];
const COLS = ["ID","Target","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Merger Acquisition #001","Merger Acquisition #002","3.752","2.485","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Merger Acquisition #002","Merger Acquisition #003","8.959","7.412","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Merger Acquisition #003","Merger Acquisition #004","5.906","326","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Merger Acquisition #004","Merger Acquisition #005","1.706","9.022","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Merger Acquisition #005","Merger Acquisition #001","7.919","1.350","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":792},{"label":"Mar","value":862},{"label":"Abr","value":744},{"label":"Mai","value":918},{"label":"Jun","value":984},{"label":"Jul","value":1024},{"label":"Ago","value":738},{"label":"Set","value":788},{"label":"Out","value":997},{"label":"Nov","value":944},{"label":"Dez","value":1057}];
const MX = 1057;
