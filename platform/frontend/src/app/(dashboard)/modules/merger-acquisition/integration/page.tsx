...
const KPIS = [{"l":"Integrações Ativas","v":"4.850","t":"+11.3%","d":"up"},{"l":"Chamadas/Hora","v":"899","t":"-5.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"68.1%","t":"+7.0%","d":"up"},{"l":"Latência Média (ms)","v":"64ms","t":"+14.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.292","9.001","80.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.916","5.770","80.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.577","8.783","86.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.508","6.560","96.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.934","6.659","83.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":991},{"label":"Mar","value":1031},{"label":"Abr","value":744},{"label":"Mai","value":677},{"label":"Jun","value":769},{"label":"Jul","value":771},{"label":"Ago","value":684},{"label":"Set","value":938},{"label":"Out","value":767},{"label":"Nov","value":679},{"label":"Dez","value":870}];
const MX = 1031;
