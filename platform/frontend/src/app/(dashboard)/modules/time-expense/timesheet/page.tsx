...
const PAGE = "Time Sheet";
const KPIS = [{"l":"Total Time Expense","v":"5.301","t":"+14.4%","d":"up"},{"l":"Time Sheet Ativos","v":"3.174","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"81","t":"+6.6%","d":"up"}];
const COLS = ["ID","Time Sheet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Expense #001","Time Expense #002","3.790","3.056","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Time Expense #002","Time Expense #003","1.967","8.077","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Expense #003","Time Expense #004","6.424","1.019","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Time Expense #004","Time Expense #005","4.688","7.106","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Expense #005","Time Expense #001","1.613","6.740","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":688},{"label":"Mar","value":800},{"label":"Abr","value":729},{"label":"Mai","value":722},{"label":"Jun","value":973},{"label":"Jul","value":918},{"label":"Ago","value":808},{"label":"Set","value":877},{"label":"Out","value":921},{"label":"Nov","value":691},{"label":"Dez","value":956}];
const MX = 973;
