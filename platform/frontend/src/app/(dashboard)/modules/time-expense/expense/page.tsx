...
const ACCENT = "#b45309";
const MODULE = "Time & Expense";
const PAGE = "Expense Report";
const KPIS = [{"l":"Total Time Expense","v":"2.795","t":"-3.1%","d":"down"},{"l":"Expense Report Ativos","v":"6.839","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"68.7%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"68","t":"+3.9%","d":"up"}];
const COLS = ["ID","Expense Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Expense #001","Time Expense #002","4.315","1.684","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Time Expense #002","Time Expense #003","8.333","8.766","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Expense #003","Time Expense #004","6.915","8.847","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Time Expense #004","Time Expense #005","6.386","7.831","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Expense #005","Time Expense #001","3.217","1.033","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":842},{"label":"Mar","value":731},{"label":"Abr","value":777},{"label":"Mai","value":555},{"label":"Jun","value":554},{"label":"Jul","value":706},{"label":"Ago","value":515},{"label":"Set","value":593},{"label":"Out","value":852},{"label":"Nov","value":721},{"label":"Dez","value":761}];
const MX = 852;
