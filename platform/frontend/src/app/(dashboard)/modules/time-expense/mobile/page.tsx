...
const PAGE = "Mobile Entry";
const KPIS = [{"l":"Total Time Expense","v":"2.152","t":"+14.4%","d":"up"},{"l":"Mobile Entry Ativos","v":"4.910","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+15.6%","d":"up"}];
const COLS = ["ID","Mobile Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Expense #001","Time Expense #002","7.288","7.545","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Time Expense #002","Time Expense #003","3.902","3.701","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Expense #003","Time Expense #004","2.653","2.406","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Time Expense #004","Time Expense #005","3.262","188","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Expense #005","Time Expense #001","8.363","4.790","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":460},{"label":"Mar","value":506},{"label":"Abr","value":734},{"label":"Mai","value":641},{"label":"Jun","value":461},{"label":"Jul","value":377},{"label":"Ago","value":519},{"label":"Set","value":461},{"label":"Out","value":360},{"label":"Nov","value":713},{"label":"Dez","value":672}];
const MX = 734;
