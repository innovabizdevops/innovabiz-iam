...
const KPIS = [{"l":"Aprovações Pendentes","v":"3.165","t":"+10.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.4%","t":"+6.9%","d":"up"},{"l":"Tempo Médio (h)","v":"189h","t":"+0.6%","d":"up"},{"l":"Rejeitadas (%)","v":"68.3%","t":"-3.4%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","856","€ 12990.56","4.814","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","4.920","€ 31447.27","2.987","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","1.748","€ 13984.00","7.791","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.869","€ 44067.22","3.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.908","€ 40661.04","4.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":981},{"label":"Mar","value":1066},{"label":"Abr","value":885},{"label":"Mai","value":877},{"label":"Jun","value":805},{"label":"Jul","value":743},{"label":"Ago","value":818},{"label":"Set","value":690},{"label":"Out","value":852},{"label":"Nov","value":908},{"label":"Dez","value":1024}];
const MX = 1066;
