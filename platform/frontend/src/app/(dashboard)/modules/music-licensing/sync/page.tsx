...
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"8.181","t":"+6.8%","d":"up"},{"l":"Chamadas/Hora","v":"838","t":"+13.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.5%","t":"+12.9%","d":"up"},{"l":"Latência Média (ms)","v":"46ms","t":"-3.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.858","2.056","73.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.061","7.716","89.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.058","395","96.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.508","2.191","84.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.793","4.446","83.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":809},{"label":"Mar","value":532},{"label":"Abr","value":570},{"label":"Mai","value":703},{"label":"Jun","value":811},{"label":"Jul","value":744},{"label":"Ago","value":587},{"label":"Set","value":880},{"label":"Out","value":554},{"label":"Nov","value":643},{"label":"Dez","value":841}];
const MX = 880;
