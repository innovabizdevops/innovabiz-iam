...
/* ═══ Music Licensing — Dashboard ═══ */

const ACCENT = "#1d4ed8";

const KPIS = [
    { label: "Total Registos", value: "9601", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3372", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€50K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1742488701", cells: ["MUS-8701", "Music Licensing Item 1", "10/10/2026", "€38 801"], status: "active" as const },
    { id: "1742492272", cells: ["MUS-3272", "Music Licensing Item 2", "25/5/2026", "€42 372"], status: "pending" as const },
    { id: "1742495843", cells: ["MUS-6843", "Music Licensing Item 3", "12/12/2026", "€45 943"], status: "completed" as const },
    { id: "1742499414", cells: ["MUS-1414", "Music Licensing Item 4", "27/7/2026", "€49 514"], status: "warning" as const },
    { id: "1742502985", cells: ["MUS-4985", "Music Licensing Item 5", "14/2/2026", "€3085"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Music Licensing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Music Licensing</p>
                    </div>
                </div>
