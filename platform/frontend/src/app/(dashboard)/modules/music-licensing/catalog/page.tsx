...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"7.592","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"405","t":"+6.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.878","t":"+16.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.601","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","604","2026-02-02","9.025","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4046","2026-01-26","160","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1338","2026-03-08","424","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4664","2026-01-27","4.798","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3606","2026-03-06","753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":447},{"label":"Mar","value":418},{"label":"Abr","value":279},{"label":"Mai","value":578},{"label":"Jun","value":322},{"label":"Jul","value":552},{"label":"Ago","value":460},{"label":"Set","value":318},{"label":"Out","value":479},{"label":"Nov","value":289},{"label":"Dez","value":256}];
const MX = 578;
