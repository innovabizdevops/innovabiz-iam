...
const ACCENT = "#475569";
const MODULE = "SOX Compliance";
const PAGE = "Deficiency";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.709","t":"+5.1%","d":"up"},{"l":"NC Abertas","v":"2.819","t":"+17.6%","d":"up"},{"l":"Conformidade (%)","v":"76.6%","t":"+7.5%","d":"up"},{"l":"CAPAs Pendentes","v":"2.170","t":"+11.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.795","84.1%","6.583","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.033","71.2%","6.538","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.462","85.9%","6.148","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.284","81.9%","4.727","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.233","89.6%","7.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":643},{"label":"Mar","value":712},{"label":"Abr","value":761},{"label":"Mai","value":764},{"label":"Jun","value":783},{"label":"Jul","value":797},{"label":"Ago","value":662},{"label":"Set","value":710},{"label":"Out","value":480},{"label":"Nov","value":546},{"label":"Dez","value":637}];
const MX = 816;
