...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.055","t":"+17.1%","d":"up"},{"l":"NC Abertas","v":"2.297","t":"+6.8%","d":"up"},{"l":"Conformidade (%)","v":"65.9%","t":"-5.6%","d":"down"},{"l":"CAPAs Pendentes","v":"3.789","t":"+17.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.894","89.0%","2.087","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.118","82.2%","8.565","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","106","80.1%","2.180","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.005","76.5%","5.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.987","78.1%","6.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":620},{"label":"Mar","value":578},{"label":"Abr","value":561},{"label":"Mai","value":345},{"label":"Jun","value":375},{"label":"Jul","value":364},{"label":"Ago","value":366},{"label":"Set","value":567},{"label":"Out","value":565},{"label":"Nov","value":392},{"label":"Dez","value":566}];
const MX = 620;
