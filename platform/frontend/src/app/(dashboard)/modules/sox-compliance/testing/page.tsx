...
const PAGE = "Testing";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.325","t":"+17.6%","d":"up"},{"l":"NC Abertas","v":"6.691","t":"+11.4%","d":"up"},{"l":"Conformidade (%)","v":"78.1%","t":"-2.9%","d":"down"},{"l":"CAPAs Pendentes","v":"1.242","t":"+7.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.670","74.4%","4.390","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.071","90.3%","7.023","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.019","82.8%","988","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.247","89.1%","788","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","778","97.7%","9.060","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":1026},{"label":"Mar","value":892},{"label":"Abr","value":681},{"label":"Mai","value":745},{"label":"Jun","value":659},{"label":"Jul","value":660},{"label":"Ago","value":782},{"label":"Set","value":845},{"label":"Out","value":854},{"label":"Nov","value":1019},{"label":"Dez","value":944}];
const MX = 1026;
