...
const PAGE = "Control Matrix";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.243","t":"-4.6%","d":"down"},{"l":"NC Abertas","v":"8.117","t":"+3.2%","d":"up"},{"l":"Conformidade (%)","v":"79.5%","t":"+16.7%","d":"up"},{"l":"CAPAs Pendentes","v":"5.309","t":"+4.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.918","99.2%","5.864","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.809","70.5%","4.673","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.387","81.5%","7.864","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.450","74.9%","910","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.019","71.0%","679","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":967},{"label":"Mar","value":740},{"label":"Abr","value":818},{"label":"Mai","value":792},{"label":"Jun","value":795},{"label":"Jul","value":851},{"label":"Ago","value":911},{"label":"Set","value":797},{"label":"Out","value":927},{"label":"Nov","value":927},{"label":"Dez","value":749}];
const MX = 967;
