...
const PAGE = "Trading";
const KPIS = [{"l":"Total Energy Services","v":"1.487","t":"+4.2%","d":"up"},{"l":"Trading Ativos","v":"8.643","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"89","t":"-6.0%","d":"down"}];
const COLS = ["ID","Trading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","8.758","8.164","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","3.345","6.443","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","8.999","2.404","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","8.408","2.124","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","8.604","4.922","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":689},{"label":"Mar","value":557},{"label":"Abr","value":733},{"label":"Mai","value":730},{"label":"Jun","value":697},{"label":"Jul","value":847},{"label":"Ago","value":563},{"label":"Set","value":882},{"label":"Out","value":874},{"label":"Nov","value":761},{"label":"Dez","value":622}];
const MX = 882;
