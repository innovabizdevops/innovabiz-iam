...
const KPIS = [{"l":"Total Energy Services","v":"3.283","t":"-4.9%","d":"down"},{"l":"Renewables Ativos","v":"3.949","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"87.8%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"94","t":"+9.1%","d":"up"}];
const COLS = ["ID","Renewables","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","4.282","8.051","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","9.021","8.038","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","5.313","3.609","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","7.880","2.128","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","1.084","1.015","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":741},{"label":"Mar","value":588},{"label":"Abr","value":543},{"label":"Mai","value":406},{"label":"Jun","value":764},{"label":"Jul","value":750},{"label":"Ago","value":521},{"label":"Set","value":602},{"label":"Out","value":773},{"label":"Nov","value":435},{"label":"Dez","value":704}];
const MX = 773;
