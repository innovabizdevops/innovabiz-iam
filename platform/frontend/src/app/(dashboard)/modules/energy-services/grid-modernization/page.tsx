...
const PAGE = "Grid Modernization";
const KPIS = [{"l":"Total Energy Services","v":"603","t":"+12.5%","d":"up"},{"l":"Grid Modernization Ativos","v":"1.069","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"79","t":"+10.4%","d":"up"}];
const COLS = ["ID","Grid Modernization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","6.283","7.374","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","6.251","1.423","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","331","5.230","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","4.062","8.511","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","7.031","9.012","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":668},{"label":"Mar","value":515},{"label":"Abr","value":701},{"label":"Mai","value":555},{"label":"Jun","value":693},{"label":"Jul","value":545},{"label":"Ago","value":735},{"label":"Set","value":520},{"label":"Out","value":664},{"label":"Nov","value":580},{"label":"Dez","value":674}];
const MX = 772;
