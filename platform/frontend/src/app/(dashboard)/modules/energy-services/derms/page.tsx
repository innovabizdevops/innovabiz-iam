...
const PAGE = "DERMS";
const KPIS = [{"l":"Riscos Identificados","v":"7.789","t":"+6.1%","d":"up"},{"l":"Mitigações Ativas","v":"1.176","t":"-0.8%","d":"down"},{"l":"Score Risco Geral","v":"57","t":"-4.3%","d":"down"},{"l":"Incidentes YTD","v":"8.701","t":"+6.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.919","6.342","5.928","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.434","5.179","5.253","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","841","2.020","2.211","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.094","247","2.855","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.712","4.217","5.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":928},{"label":"Fev","value":877},{"label":"Mar","value":671},{"label":"Abr","value":978},{"label":"Mai","value":771},{"label":"Jun","value":803},{"label":"Jul","value":680},{"label":"Ago","value":748},{"label":"Set","value":838},{"label":"Out","value":826},{"label":"Nov","value":634},{"label":"Dez","value":945}];
const MX = 978;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>DER</span></h1>
                </div>
