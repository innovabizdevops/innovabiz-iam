...
const ACCENT = "#6366f1";
const MODULE = "Energy Services";
const PAGE = "IEC 61850 Grid";
const KPIS = [{"l":"Total Energy Services","v":"7.561","t":"+17.5%","d":"up"},{"l":"IEC 61850 Grid Ativos","v":"4.521","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"91","t":"+7.6%","d":"up"}];
const COLS = ["ID","IEC 61850 Grid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","2.391","4.498","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","6.471","967","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","6.626","8.300","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","1.748","8.260","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","1.637","599","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":661},{"label":"Mar","value":672},{"label":"Abr","value":614},{"label":"Mai","value":467},{"label":"Jun","value":296},{"label":"Jul","value":346},{"label":"Ago","value":514},{"label":"Set","value":434},{"label":"Out","value":452},{"label":"Nov","value":335},{"label":"Dez","value":342}];
const MX = 672;
...
export default function Iec61850Page() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>IEC</span></h1>
                </div>
