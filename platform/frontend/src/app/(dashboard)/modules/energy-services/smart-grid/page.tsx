...
const PAGE = "Smart Grid";
const KPIS = [{"l":"Total Energy Services","v":"1.859","t":"+15.5%","d":"up"},{"l":"Smart Grid Ativos","v":"5.673","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"91","t":"+2.6%","d":"up"}];
const COLS = ["ID","Smart Grid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","885","5.602","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","4.631","5.423","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","2.398","3.749","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","6.240","4.240","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","2.172","4.709","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":676},{"label":"Mar","value":698},{"label":"Abr","value":795},{"label":"Mai","value":491},{"label":"Jun","value":762},{"label":"Jul","value":843},{"label":"Ago","value":864},{"label":"Set","value":820},{"label":"Out","value":666},{"label":"Nov","value":825},{"label":"Dez","value":786}];
const MX = 864;
