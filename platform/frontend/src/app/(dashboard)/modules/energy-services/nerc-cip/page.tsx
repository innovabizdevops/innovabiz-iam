...
const PAGE = "NERC CIP Security";
const KPIS = [{"l":"Total Energy Services","v":"4.721","t":"+10.8%","d":"up"},{"l":"NERC CIP Security Ativos","v":"442","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"56","t":"-4.6%","d":"down"}];
const COLS = ["ID","NERC CIP Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","3.149","4.849","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","4.841","7.896","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","1.356","8.200","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","2.196","8.260","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","3.064","3.494","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":659},{"label":"Mar","value":677},{"label":"Abr","value":912},{"label":"Mai","value":1009},{"label":"Jun","value":973},{"label":"Jul","value":643},{"label":"Ago","value":968},{"label":"Set","value":748},{"label":"Out","value":867},{"label":"Nov","value":788},{"label":"Dez","value":829}];
const MX = 1009;
...
export default function NercCipPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>NERC</span></h1>
                </div>
