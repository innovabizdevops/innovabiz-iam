...
const PAGE = "Metering";
const KPIS = [{"l":"Total Energy Services","v":"3.140","t":"-1.7%","d":"down"},{"l":"Metering Ativos","v":"6.685","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+15.4%","d":"up"}];
const COLS = ["ID","Metering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","1.786","4.837","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","685","7.586","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","8.252","6.426","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","6.315","8.443","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","6.146","8.704","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":516},{"label":"Mar","value":561},{"label":"Abr","value":443},{"label":"Mai","value":364},{"label":"Jun","value":694},{"label":"Jul","value":593},{"label":"Ago","value":315},{"label":"Set","value":353},{"label":"Out","value":574},{"label":"Nov","value":679},{"label":"Dez","value":358}];
const MX = 694;
