...
const PAGE = "Load Forecasting AI";
const KPIS = [{"l":"Total Energy Services","v":"2.169","t":"+12.0%","d":"up"},{"l":"Load Forecasting AI Ativos","v":"4.836","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+14.4%","d":"up"}];
const COLS = ["ID","Load Forecasting AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","2.221","1.372","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","4.316","5.324","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","6.193","4.960","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","3.908","2.925","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","2.258","2.652","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":590},{"label":"Mar","value":565},{"label":"Abr","value":364},{"label":"Mai","value":506},{"label":"Jun","value":553},{"label":"Jul","value":315},{"label":"Ago","value":242},{"label":"Set","value":316},{"label":"Out","value":234},{"label":"Nov","value":311},{"label":"Dez","value":538}];
const MX = 590;
