...
const PAGE = "Outage Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.311","t":"-0.4%","d":"down"},{"l":"Savings (€)","v":"€39164","t":"+13.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.3%","t":"-0.4%","d":"down"},{"l":"Ciclos PDCA","v":"4.320","t":"+10.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.154","€ 15885.07","8.287","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.751","€ 25879.75","3.854","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","733","€ 48788.41","6.599","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.852","€ 20113.45","2.411","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.976","€ 22402.77","8.417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":872},{"label":"Mar","value":869},{"label":"Abr","value":685},{"label":"Mai","value":920},{"label":"Jun","value":613},{"label":"Jul","value":920},{"label":"Ago","value":810},{"label":"Set","value":815},{"label":"Out","value":664},{"label":"Nov","value":777},{"label":"Dez","value":681}];
const MX = 920;
...
export default function OutageMgmtPage() {
    return (
