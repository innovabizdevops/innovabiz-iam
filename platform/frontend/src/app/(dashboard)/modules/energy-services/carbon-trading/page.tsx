...
const PAGE = "Carbon Trading";
const KPIS = [{"l":"Total Energy Services","v":"6.877","t":"+10.7%","d":"up"},{"l":"Carbon Trading Ativos","v":"5.590","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+14.5%","d":"up"}];
const COLS = ["ID","Carbon Trading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Services #001","Energy Services #002","927","3.063","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Services #002","Energy Services #003","1.281","5.457","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Services #003","Energy Services #004","5.295","2.342","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Services #004","Energy Services #005","377","2.943","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Services #005","Energy Services #001","519","719","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":352},{"label":"Mar","value":434},{"label":"Abr","value":632},{"label":"Mai","value":424},{"label":"Jun","value":593},{"label":"Jul","value":624},{"label":"Ago","value":321},{"label":"Set","value":461},{"label":"Out","value":358},{"label":"Nov","value":416},{"label":"Dez","value":404}];
const MX = 632;
