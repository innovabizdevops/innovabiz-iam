...
const PAGE = "Produce";
const KPIS = [{"l":"Total Oil Gas Upstream","v":"6.199","t":"-2.5%","d":"down"},{"l":"Produce Ativos","v":"4.334","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"85.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+6.6%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Gas Upstream #001","Oil Gas Upstream #002","5.880","7.811","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Gas Upstream #002","Oil Gas Upstream #003","3.750","451","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Gas Upstream #003","Oil Gas Upstream #004","7.310","1.304","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Gas Upstream #004","Oil Gas Upstream #005","8.660","9.078","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Gas Upstream #005","Oil Gas Upstream #001","6.725","1.858","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":514},{"label":"Mar","value":535},{"label":"Abr","value":483},{"label":"Mai","value":551},{"label":"Jun","value":545},{"label":"Jul","value":493},{"label":"Ago","value":822},{"label":"Set","value":717},{"label":"Out","value":762},{"label":"Nov","value":800},{"label":"Dez","value":697}];
const MX = 822;
