...
/* ═══ Oil & Gas Upstream — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "4159", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4607", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€61K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "808467759", cells: ["OIL-7759", "Oil & Gas Upstream Item 1", "16/4/2026", "€17 859"], status: "active" as const },
    { id: "808471330", cells: ["OIL-2330", "Oil & Gas Upstream Item 2", "3/11/2026", "€21 430"], status: "pending" as const },
    { id: "808474901", cells: ["OIL-5901", "Oil & Gas Upstream Item 3", "18/6/2026", "€25 001"], status: "completed" as const },
    { id: "808478472", cells: ["OIL-9472", "Oil & Gas Upstream Item 4", "5/1/2026", "€28 572"], status: "warning" as const },
    { id: "808482043", cells: ["OIL-4043", "Oil & Gas Upstream Item 5", "20/8/2026", "€32 143"], status: "active" as const },
];
...
export default function OilGasUpstreamPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Oil & Gas Upstream</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Oil & Gas Upstream</p>
                    </div>
                </div>
