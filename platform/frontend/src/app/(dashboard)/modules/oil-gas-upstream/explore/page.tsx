...
const ACCENT = "#854d0e";
const MODULE = "Oil & Gas Upstream";
const PAGE = "Explore";
const KPIS = [{"l":"Total Oil Gas Upstream","v":"8.829","t":"+6.3%","d":"up"},{"l":"Explore Ativos","v":"4.640","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"78.1%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"77","t":"-3.0%","d":"down"}];
const COLS = ["ID","Explore","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Gas Upstream #001","Oil Gas Upstream #002","2.926","5.525","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Gas Upstream #002","Oil Gas Upstream #003","5.817","4.307","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Gas Upstream #003","Oil Gas Upstream #004","1.786","2.592","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Gas Upstream #004","Oil Gas Upstream #005","8.835","2.769","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Gas Upstream #005","Oil Gas Upstream #001","3.930","153","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":600},{"label":"Mar","value":519},{"label":"Abr","value":856},{"label":"Mai","value":756},{"label":"Jun","value":792},{"label":"Jul","value":799},{"label":"Ago","value":511},{"label":"Set","value":872},{"label":"Out","value":742},{"label":"Nov","value":845},{"label":"Dez","value":632}];
const MX = 872;
