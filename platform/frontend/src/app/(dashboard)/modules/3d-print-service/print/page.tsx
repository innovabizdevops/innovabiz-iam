...
const PAGE = "Print";
const KPIS = [{"l":"Total 3d Print Service","v":"5.963","t":"+0.1%","d":"up"},{"l":"Print Ativos","v":"5.389","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"58","t":"+7.1%","d":"up"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Service #001","3d Print Service #002","6.660","4.937","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Service #002","3d Print Service #003","8.212","8.068","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Service #003","3d Print Service #004","4.179","8.805","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Service #004","3d Print Service #005","5.837","1.488","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Service #005","3d Print Service #001","1.200","8.383","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":627},{"label":"Mar","value":690},{"label":"Abr","value":544},{"label":"Mai","value":733},{"label":"Jun","value":501},{"label":"Jul","value":499},{"label":"Ago","value":453},{"label":"Set","value":599},{"label":"Out","value":437},{"label":"Nov","value":403},{"label":"Dez","value":528}];
const MX = 733;
