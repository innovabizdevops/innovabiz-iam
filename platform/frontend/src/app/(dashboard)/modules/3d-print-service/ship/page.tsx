...
const PAGE = "Ship";
const KPIS = [{"l":"Total 3d Print Service","v":"2.451","t":"-5.4%","d":"down"},{"l":"Ship Ativos","v":"1.853","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+13.7%","d":"up"}];
const COLS = ["ID","Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Service #001","3d Print Service #002","5.158","1.835","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Service #002","3d Print Service #003","4.592","8.298","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Service #003","3d Print Service #004","5.665","5.427","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Service #004","3d Print Service #005","6.847","3.184","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Service #005","3d Print Service #001","6.771","7.192","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":746},{"label":"Mar","value":719},{"label":"Abr","value":675},{"label":"Mai","value":762},{"label":"Jun","value":704},{"label":"Jul","value":805},{"label":"Ago","value":627},{"label":"Set","value":761},{"label":"Out","value":852},{"label":"Nov","value":632},{"label":"Dez","value":926}];
const MX = 926;
