...
/* ═══ 3D Print Service Bureau — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "9260", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3252", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€371K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "741103360", cells: ["3D-8360", "3D Print Service Bureau Item 1", "5/5/2026", "€3460"], status: "active" as const },
    { id: "741106931", cells: ["3D-2931", "3D Print Service Bureau Item 2", "20/12/2026", "€7031"], status: "pending" as const },
    { id: "741110502", cells: ["3D-6502", "3D Print Service Bureau Item 3", "7/7/2026", "€10 602"], status: "completed" as const },
    { id: "741114073", cells: ["3D-1073", "3D Print Service Bureau Item 4", "22/2/2026", "€14 173"], status: "warning" as const },
    { id: "741117644", cells: ["3D-4644", "3D Print Service Bureau Item 5", "9/9/2026", "€17 744"], status: "active" as const },
];
...
export default function P3dPrintServiceBureauPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">3D Print Service Bureau</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 3D Print Service Bureau</p>
                    </div>
                </div>
