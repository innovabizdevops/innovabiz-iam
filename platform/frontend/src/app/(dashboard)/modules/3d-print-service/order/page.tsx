...
const ACCENT = "#6366f1";
const MODULE = "3D Print Service Bureau";
const PAGE = "Order";
const KPIS = [{"l":"Total 3d Print Service","v":"2.775","t":"+13.9%","d":"up"},{"l":"Order Ativos","v":"4.053","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"78.8%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"80","t":"-1.7%","d":"down"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Print Service #001","3d Print Service #002","6.328","4.712","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["3d Print Service #002","3d Print Service #003","5.210","7.723","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Print Service #003","3d Print Service #004","5.872","4.080","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["3d Print Service #004","3d Print Service #005","637","4.569","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Print Service #005","3d Print Service #001","2.166","4.950","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":798},{"label":"Mar","value":942},{"label":"Abr","value":740},{"label":"Mai","value":780},{"label":"Jun","value":735},{"label":"Jul","value":939},{"label":"Ago","value":903},{"label":"Set","value":694},{"label":"Out","value":729},{"label":"Nov","value":766},{"label":"Dez","value":675}];
const MX = 942;
