...
const PAGE = "Alert System";
const KPIS = [{"l":"Notificações Enviadas","v":"5.513","t":"+15.3%","d":"up"},{"l":"Taxa Entrega (%)","v":"77.0%","t":"+10.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"83.4%","t":"-1.5%","d":"down"},{"l":"Escalações","v":"3.384","t":"+16.9%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.344","76.7%","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.444","81.0%","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.307","99.7%","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.958","91.2%","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.434","78.5%","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":322},{"label":"Mar","value":335},{"label":"Abr","value":399},{"label":"Mai","value":599},{"label":"Jun","value":492},{"label":"Jul","value":547},{"label":"Ago","value":557},{"label":"Set","value":457},{"label":"Out","value":621},{"label":"Nov","value":308},{"label":"Dez","value":397}];
const MX = 621;
