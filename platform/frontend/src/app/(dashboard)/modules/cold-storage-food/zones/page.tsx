...
const PAGE = "Zone Mgmt";
const KPIS = [{"l":"Total Cold Storage Food","v":"584","t":"+1.7%","d":"up"},{"l":"Zone Mgmt Ativos","v":"4.372","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"91.3%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+4.9%","d":"up"}];
const COLS = ["ID","Zone Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cold Storage Food #001","Cold Storage Food #002","4.491","4.864","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Cold Storage Food #002","Cold Storage Food #003","4.507","1.425","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Cold Storage Food #003","Cold Storage Food #004","530","8.030","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Cold Storage Food #004","Cold Storage Food #005","3.840","4.011","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cold Storage Food #005","Cold Storage Food #001","2.651","8.417","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":748},{"label":"Mar","value":572},{"label":"Abr","value":861},{"label":"Mai","value":844},{"label":"Jun","value":815},{"label":"Jul","value":718},{"label":"Ago","value":831},{"label":"Set","value":842},{"label":"Out","value":589},{"label":"Nov","value":713},{"label":"Dez","value":697}];
const MX = 861;
