...
const ACCENT = "#0e7490";
const MODULE = "Cold Storage Food";
const PAGE = "Temp Monitor";
const KPIS = [{"l":"Total Cold Storage Food","v":"2.354","t":"+3.0%","d":"up"},{"l":"Temp Monitor Ativos","v":"8.150","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"69","t":"+17.3%","d":"up"}];
const COLS = ["ID","Temp Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cold Storage Food #001","Cold Storage Food #002","6.912","9.054","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cold Storage Food #002","Cold Storage Food #003","3.966","5.261","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cold Storage Food #003","Cold Storage Food #004","2.291","2.406","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Cold Storage Food #004","Cold Storage Food #005","2.959","8.015","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cold Storage Food #005","Cold Storage Food #001","3.951","2.991","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1020},{"label":"Fev","value":686},{"label":"Mar","value":820},{"label":"Abr","value":959},{"label":"Mai","value":804},{"label":"Jun","value":840},{"label":"Jul","value":726},{"label":"Ago","value":694},{"label":"Set","value":661},{"label":"Out","value":996},{"label":"Nov","value":786},{"label":"Dez","value":679}];
const MX = 1020;
