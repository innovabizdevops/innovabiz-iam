...
export default function ColdStorageFoodPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cold Storage Food</h1><p className="text-sm text-muted-foreground">Cold Storage Food • iBOS Enterprise</p></div>
