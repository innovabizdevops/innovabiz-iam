...
const KPIS = [{"l":"Vendas YTD (€)","v":"€46191","t":"+9.9%","d":"up"},{"l":"Pipeline (€)","v":"€80014","t":"+16.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"74.2%","t":"+5.9%","d":"up"},{"l":"Win Rate (%)","v":"66.0%","t":"+14.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 37957.66","€ 16419.04","€ 36330.64","92.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 43643.98","€ 30167.03","€ 10245.02","73.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 48205.53","€ 46436.86","€ 30074.83","90.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 30340.12","€ 34909.96","€ 35222.57","100.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 15471.63","€ 4015.59","€ 3345.85","91.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":763},{"label":"Mar","value":458},{"label":"Abr","value":440},{"label":"Mai","value":687},{"label":"Jun","value":696},{"label":"Jul","value":527},{"label":"Ago","value":651},{"label":"Set","value":609},{"label":"Out","value":785},{"label":"Nov","value":595},{"label":"Dez","value":702}];
const MX = 785;
