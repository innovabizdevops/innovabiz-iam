...
const PAGE = "DR Event";
const KPIS = [{"l":"Total Demand Response","v":"3.732","t":"-5.9%","d":"down"},{"l":"DR Event Ativos","v":"4.605","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"80","t":"+3.1%","d":"up"}];
const COLS = ["ID","DR Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Response #001","Demand Response #002","560","2.182","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Response #002","Demand Response #003","649","7.511","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Response #003","Demand Response #004","5.488","8.045","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Response #004","Demand Response #005","3.106","8.069","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Response #005","Demand Response #001","4.685","6.629","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":743},{"label":"Mar","value":894},{"label":"Abr","value":911},{"label":"Mai","value":1019},{"label":"Jun","value":829},{"label":"Jul","value":720},{"label":"Ago","value":859},{"label":"Set","value":818},{"label":"Out","value":936},{"label":"Nov","value":1046},{"label":"Dez","value":816}];
const MX = 1046;
