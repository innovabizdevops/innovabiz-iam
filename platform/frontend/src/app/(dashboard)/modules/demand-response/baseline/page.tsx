...
const PAGE = "Baseline";
const KPIS = [{"l":"Total Demand Response","v":"7.031","t":"+16.0%","d":"up"},{"l":"Baseline Ativos","v":"6.443","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"58","t":"-2.5%","d":"down"}];
const COLS = ["ID","Baseline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Response #001","Demand Response #002","8.982","4.086","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Response #002","Demand Response #003","8.901","6.496","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Response #003","Demand Response #004","2.572","488","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Response #004","Demand Response #005","4.684","4.264","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Response #005","Demand Response #001","8.517","8.124","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":710},{"label":"Mar","value":792},{"label":"Abr","value":696},{"label":"Mai","value":691},{"label":"Jun","value":806},{"label":"Jul","value":856},{"label":"Ago","value":807},{"label":"Set","value":658},{"label":"Out","value":746},{"label":"Nov","value":777},{"label":"Dez","value":851}];
const MX = 866;
