...
const PAGE = "Curtailment";
const KPIS = [{"l":"Total Demand Response","v":"1.143","t":"+17.3%","d":"up"},{"l":"Curtailment Ativos","v":"240","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"66","t":"+2.8%","d":"up"}];
const COLS = ["ID","Curtailment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Response #001","Demand Response #002","3.965","2.724","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Response #002","Demand Response #003","8.309","1.281","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Response #003","Demand Response #004","6.220","8.348","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Response #004","Demand Response #005","5.681","3.147","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Response #005","Demand Response #001","1.458","6.506","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":636},{"label":"Mar","value":762},{"label":"Abr","value":717},{"label":"Mai","value":642},{"label":"Jun","value":699},{"label":"Jul","value":455},{"label":"Ago","value":494},{"label":"Set","value":713},{"label":"Out","value":503},{"label":"Nov","value":753},{"label":"Dez","value":654}];
const MX = 821;
...
export default function CurtailPage() {
    return (
