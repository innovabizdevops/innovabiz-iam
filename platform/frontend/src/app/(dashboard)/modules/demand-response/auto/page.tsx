...
const ACCENT = "#7c3aed";
const MODULE = "Demand Response";
const PAGE = "Auto-DR";
const KPIS = [{"l":"Total Demand Response","v":"7.378","t":"+15.8%","d":"up"},{"l":"Auto DR Ativos","v":"4.391","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+15.3%","d":"up"}];
const COLS = ["ID","Auto DR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Response #001","Demand Response #002","8.874","3.016","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Response #002","Demand Response #003","5.600","2.604","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Response #003","Demand Response #004","5.396","9.081","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Response #004","Demand Response #005","6.809","6.527","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Response #005","Demand Response #001","664","7.636","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":540},{"label":"Mar","value":719},{"label":"Abr","value":686},{"label":"Mai","value":442},{"label":"Jun","value":600},{"label":"Jul","value":477},{"label":"Ago","value":370},{"label":"Set","value":746},{"label":"Out","value":500},{"label":"Nov","value":578},{"label":"Dez","value":612}];
const MX = 746;
