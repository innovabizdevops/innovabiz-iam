...
const PAGE = "Wallet";
const KPIS = [{"l":"Total E Money","v":"5.335","t":"+14.2%","d":"up"},{"l":"Wallet Ativos","v":"5.694","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"80","t":"-3.0%","d":"down"}];
const COLS = ["ID","Wallet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["E Money #001","E Money #002","8.875","2.321","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["E Money #002","E Money #003","1.847","3.667","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["E Money #003","E Money #004","3.363","8.541","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["E Money #004","E Money #005","6.947","7.840","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["E Money #005","E Money #001","1.055","6.562","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":763},{"label":"Mar","value":723},{"label":"Abr","value":861},{"label":"Mai","value":792},{"label":"Jun","value":883},{"label":"Jul","value":895},{"label":"Ago","value":985},{"label":"Set","value":995},{"label":"Out","value":910},{"label":"Nov","value":1000},{"label":"Dez","value":778}];
const MX = 1000;
