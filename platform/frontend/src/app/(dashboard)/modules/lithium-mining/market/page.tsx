...
const PAGE = "Market";
const KPIS = [{"l":"Total Lithium Mining","v":"8.963","t":"-3.2%","d":"down"},{"l":"Market Ativos","v":"2.221","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"79","t":"+4.3%","d":"up"}];
const COLS = ["ID","Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lithium Mining #001","Lithium Mining #002","8.325","1.564","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Lithium Mining #002","Lithium Mining #003","1.364","710","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Lithium Mining #003","Lithium Mining #004","7.264","1.806","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Lithium Mining #004","Lithium Mining #005","4.307","4.609","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lithium Mining #005","Lithium Mining #001","8.826","3.124","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":455},{"label":"Mar","value":220},{"label":"Abr","value":569},{"label":"Mai","value":344},{"label":"Jun","value":400},{"label":"Jul","value":509},{"label":"Ago","value":383},{"label":"Set","value":481},{"label":"Out","value":233},{"label":"Nov","value":325},{"label":"Dez","value":230}];
const MX = 572;
