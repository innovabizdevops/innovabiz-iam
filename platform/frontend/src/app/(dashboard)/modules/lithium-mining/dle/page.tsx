...
const ACCENT = "#6366f1";
const MODULE = "Lithium Mining";
const PAGE = "DLE";
const KPIS = [{"l":"Total Lithium Mining","v":"5.010","t":"+15.5%","d":"up"},{"l":"DLE Ativos","v":"5.002","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+10.4%","d":"up"}];
const COLS = ["ID","DLE","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lithium Mining #001","Lithium Mining #002","3.164","1.837","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Lithium Mining #002","Lithium Mining #003","8.279","7.232","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Lithium Mining #003","Lithium Mining #004","5.163","7.840","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Lithium Mining #004","Lithium Mining #005","2.666","7.358","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lithium Mining #005","Lithium Mining #001","6.319","7.447","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":495},{"label":"Mar","value":609},{"label":"Abr","value":697},{"label":"Mai","value":754},{"label":"Jun","value":546},{"label":"Jul","value":748},{"label":"Ago","value":819},{"label":"Set","value":808},{"label":"Out","value":683},{"label":"Nov","value":658},{"label":"Dez","value":677}];
const MX = 819;
