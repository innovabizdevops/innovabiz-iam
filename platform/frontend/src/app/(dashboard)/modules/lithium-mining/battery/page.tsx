...
const PAGE = "Battery Grade";
const KPIS = [{"l":"Total Lithium Mining","v":"2.722","t":"+16.4%","d":"up"},{"l":"Battery Grade Ativos","v":"3.069","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"87","t":"+0.8%","d":"up"}];
const COLS = ["ID","Battery Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lithium Mining #001","Lithium Mining #002","9.055","1.537","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Lithium Mining #002","Lithium Mining #003","2.165","1.772","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Lithium Mining #003","Lithium Mining #004","5.043","5.373","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Lithium Mining #004","Lithium Mining #005","3.411","8.004","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lithium Mining #005","Lithium Mining #001","6.578","2.118","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":625},{"label":"Mar","value":675},{"label":"Abr","value":824},{"label":"Mai","value":676},{"label":"Jun","value":776},{"label":"Jul","value":896},{"label":"Ago","value":872},{"label":"Set","value":714},{"label":"Out","value":897},{"label":"Nov","value":678},{"label":"Dez","value":917}];
const MX = 917;
