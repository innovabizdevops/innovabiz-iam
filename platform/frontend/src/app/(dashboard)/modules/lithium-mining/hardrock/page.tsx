...
const PAGE = "Hard Rock";
const KPIS = [{"l":"Total Lithium Mining","v":"3.624","t":"+0.3%","d":"up"},{"l":"Hard Rock Ativos","v":"7.514","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"77","t":"+10.6%","d":"up"}];
const COLS = ["ID","Hard Rock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lithium Mining #001","Lithium Mining #002","5.212","474","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Lithium Mining #002","Lithium Mining #003","1.948","4.292","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Lithium Mining #003","Lithium Mining #004","8.309","7.316","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Lithium Mining #004","Lithium Mining #005","5.959","8.937","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lithium Mining #005","Lithium Mining #001","4.691","6.384","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":487},{"label":"Mar","value":593},{"label":"Abr","value":319},{"label":"Mai","value":582},{"label":"Jun","value":393},{"label":"Jul","value":422},{"label":"Ago","value":450},{"label":"Set","value":382},{"label":"Out","value":697},{"label":"Nov","value":561},{"label":"Dez","value":600}];
const MX = 702;
...
export default function HardrockPage() {
    return (
