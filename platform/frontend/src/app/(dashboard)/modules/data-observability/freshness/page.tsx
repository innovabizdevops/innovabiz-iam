...
const KPIS = [{"l":"Dashboards Ativos","v":"8.935","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"2056","t":"+10.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.803","t":"-1.2%","d":"down"},{"l":"Utilizadores Analytics","v":"1.814","t":"+11.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3634","2026-02-23","2.546","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","174","2026-03-06","2.923","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1295","2026-01-07","806","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4227","2026-03-17","1.828","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","396","2026-01-24","6.624","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":717},{"label":"Mar","value":692},{"label":"Abr","value":568},{"label":"Mai","value":728},{"label":"Jun","value":669},{"label":"Jul","value":771},{"label":"Ago","value":716},{"label":"Set","value":542},{"label":"Out","value":629},{"label":"Nov","value":680},{"label":"Dez","value":497}];
const MX = 771;
