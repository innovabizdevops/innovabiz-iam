...
/* ═══ Data Observability Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8759", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3461", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€415K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "758487259", cells: ["DAT-4259", "Data Observability Platform Item 1", "20/8/2026", "€37 359"], status: "active" as const },
    { id: "758490830", cells: ["DAT-7830", "Data Observability Platform Item 2", "7/3/2026", "€40 930"], status: "pending" as const },
    { id: "758494401", cells: ["DAT-2401", "Data Observability Platform Item 3", "22/10/2026", "€44 501"], status: "completed" as const },
    { id: "758497972", cells: ["DAT-5972", "Data Observability Platform Item 4", "9/5/2026", "€48 072"], status: "warning" as const },
    { id: "758501543", cells: ["DAT-9543", "Data Observability Platform Item 5", "24/12/2026", "€1643"], status: "active" as const },
];
...
export default function DataObservabilityPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Observability Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Observability Platform</p>
                    </div>
                </div>
