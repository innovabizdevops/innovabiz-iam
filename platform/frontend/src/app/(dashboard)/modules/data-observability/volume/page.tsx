...
const PAGE = "Volume";
const KPIS = [{"l":"Dashboards Ativos","v":"5.620","t":"+15.9%","d":"up"},{"l":"Queries/Dia","v":"2843","t":"+4.8%","d":"up"},{"l":"Dados Processados (GB)","v":"1.354","t":"+3.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.514","t":"+0.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","492","2026-01-01","7.551","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4473","2026-02-14","3.927","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2563","2026-03-22","3.355","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4935","2026-02-09","299","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4818","2026-02-19","144","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":287},{"label":"Fev","value":561},{"label":"Mar","value":279},{"label":"Abr","value":402},{"label":"Mai","value":502},{"label":"Jun","value":362},{"label":"Jul","value":596},{"label":"Ago","value":540},{"label":"Set","value":348},{"label":"Out","value":315},{"label":"Nov","value":494},{"label":"Dez","value":605}];
const MX = 605;
