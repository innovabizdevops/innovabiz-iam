...
const PAGE = "Schema";
const KPIS = [{"l":"Dashboards Ativos","v":"8.152","t":"+15.6%","d":"up"},{"l":"Queries/Dia","v":"615","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"1.410","t":"-3.1%","d":"down"},{"l":"Utilizadores Analytics","v":"4.825","t":"-4.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4439","2026-01-17","9.012","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","943","2026-02-05","811","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1606","2026-03-17","6.212","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2779","2026-03-20","2.162","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2498","2026-01-02","1.561","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":643},{"label":"Mar","value":718},{"label":"Abr","value":681},{"label":"Mai","value":555},{"label":"Jun","value":552},{"label":"Jul","value":723},{"label":"Ago","value":466},{"label":"Set","value":758},{"label":"Out","value":604},{"label":"Nov","value":751},{"label":"Dez","value":733}];
const MX = 758;
