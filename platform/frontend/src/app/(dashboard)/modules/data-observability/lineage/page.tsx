...
const ACCENT = "#1e3a5f";
const MODULE = "Data Observability Platform";
const PAGE = "Lineage";
const KPIS = [{"l":"Dashboards Ativos","v":"5.734","t":"+2.3%","d":"up"},{"l":"Queries/Dia","v":"3585","t":"-3.7%","d":"down"},{"l":"Dados Processados (GB)","v":"3.515","t":"+16.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.562","t":"+7.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3821","2026-02-08","8.287","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3040","2026-03-06","7.216","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1954","2026-02-15","5.270","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2975","2026-02-16","826","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3724","2026-03-03","2.573","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":557},{"label":"Mar","value":582},{"label":"Abr","value":551},{"label":"Mai","value":528},{"label":"Jun","value":575},{"label":"Jul","value":548},{"label":"Ago","value":622},{"label":"Set","value":590},{"label":"Out","value":778},{"label":"Nov","value":596},{"label":"Dez","value":819}];
const MX = 819;
