...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.828","t":"-2.4%","d":"down"},{"l":"Queries/Dia","v":"5056","t":"+4.1%","d":"up"},{"l":"Dados Processados (GB)","v":"6.774","t":"-2.8%","d":"down"},{"l":"Utilizadores Analytics","v":"6.349","t":"+12.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2797","2026-03-06","4.176","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1953","2026-01-09","434","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","527","2026-02-05","6.448","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","637","2026-01-12","5.694","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","694","2026-01-24","1.936","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":548},{"label":"Mar","value":590},{"label":"Abr","value":595},{"label":"Mai","value":517},{"label":"Jun","value":640},{"label":"Jul","value":670},{"label":"Ago","value":594},{"label":"Set","value":764},{"label":"Out","value":627},{"label":"Nov","value":468},{"label":"Dez","value":636}];
const MX = 764;
