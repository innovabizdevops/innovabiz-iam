...
const ACCENT = "#6366f1";
const MODULE = "School Library";
const PAGE = "Digital";
const KPIS = [{"l":"Total School Library","v":"7.215","t":"+3.6%","d":"up"},{"l":"Digital Ativos","v":"5.817","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"60","t":"+3.1%","d":"up"}];
const COLS = ["ID","Digital","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Library #001","School Library #002","3.946","5.579","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["School Library #002","School Library #003","5.650","6.042","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["School Library #003","School Library #004","7.963","3.796","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["School Library #004","School Library #005","1.898","7.996","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Library #005","School Library #001","8.544","7.837","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":890},{"label":"Mar","value":880},{"label":"Abr","value":1056},{"label":"Mai","value":929},{"label":"Jun","value":852},{"label":"Jul","value":995},{"label":"Ago","value":804},{"label":"Set","value":697},{"label":"Out","value":720},{"label":"Nov","value":770},{"label":"Dez","value":924}];
const MX = 1056;
