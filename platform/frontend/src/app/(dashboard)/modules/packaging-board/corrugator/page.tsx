...
const ACCENT = "#b45309";
const MODULE = "Packaging Board";
const PAGE = "Corrugator";
const KPIS = [{"l":"Teams Ativos","v":"4.864","t":"+3.5%","d":"up"},{"l":"Reuniões/Semana","v":"865","t":"-3.0%","d":"down"},{"l":"Mensagens/Dia","v":"3245","t":"-2.9%","d":"down"},{"l":"Ficheiros Partilhados","v":"811","t":"+1.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.352","3682","797","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.442","3271","3.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.037","1885","5.307","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.041","2313","5.756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.880","4336","7.556","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":709},{"label":"Mar","value":706},{"label":"Abr","value":666},{"label":"Mai","value":773},{"label":"Jun","value":634},{"label":"Jul","value":722},{"label":"Ago","value":800},{"label":"Set","value":902},{"label":"Out","value":869},{"label":"Nov","value":823},{"label":"Dez","value":926}];
const MX = 926;
...
export default function CorrugatorPage() {
    return (
