...
const PAGE = "Die Cut";
const KPIS = [{"l":"Teams Ativos","v":"1.827","t":"+6.5%","d":"up"},{"l":"Reuniões/Semana","v":"2277","t":"+3.1%","d":"up"},{"l":"Mensagens/Dia","v":"112","t":"+11.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"6.806","t":"-4.8%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.101","4065","3.781","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.101","756","2.672","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","294","5058","4.687","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.805","1285","4.695","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","680","4490","3.648","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":867},{"label":"Mar","value":770},{"label":"Abr","value":1044},{"label":"Mai","value":770},{"label":"Jun","value":778},{"label":"Jul","value":827},{"label":"Ago","value":901},{"label":"Set","value":796},{"label":"Out","value":761},{"label":"Nov","value":885},{"label":"Dez","value":723}];
const MX = 1044;
