...
const PAGE = "Print Flexo";
const KPIS = [{"l":"Teams Ativos","v":"6.670","t":"+10.6%","d":"up"},{"l":"Reuniões/Semana","v":"4856","t":"-3.7%","d":"down"},{"l":"Mensagens/Dia","v":"362","t":"+5.0%","d":"up"},{"l":"Ficheiros Partilhados","v":"606","t":"+10.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.435","1926","6.941","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.340","1421","3.285","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","524","242","5.224","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.992","618","1.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.082","474","4.616","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":684},{"label":"Mar","value":810},{"label":"Abr","value":767},{"label":"Mai","value":854},{"label":"Jun","value":649},{"label":"Jul","value":713},{"label":"Ago","value":810},{"label":"Set","value":619},{"label":"Out","value":669},{"label":"Nov","value":936},{"label":"Dez","value":748}];
const MX = 936;
...
export default function FlexoPage() {
    return (
