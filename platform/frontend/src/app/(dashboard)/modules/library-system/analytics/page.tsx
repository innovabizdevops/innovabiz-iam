...
const KPIS = [{"l":"Dashboards Ativos","v":"8.152","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"846","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"7.255","t":"+9.3%","d":"up"},{"l":"Utilizadores Analytics","v":"3.497","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3267","2026-01-20","189","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4736","2026-03-13","523","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2298","2026-01-06","6.561","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1783","2026-02-04","5.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4796","2026-02-14","8.785","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":976},{"label":"Mar","value":667},{"label":"Abr","value":837},{"label":"Mai","value":945},{"label":"Jun","value":824},{"label":"Jul","value":975},{"label":"Ago","value":690},{"label":"Set","value":939},{"label":"Out","value":902},{"label":"Nov","value":772},{"label":"Dez","value":681}];
const MX = 985;
