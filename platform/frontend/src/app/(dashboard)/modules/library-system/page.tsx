...
const KPIS = [
    { label: "Total Registos", value: "8084", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2655", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€378K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "988364584", cells: ["LIB-3584", "Library System Item 1", "5/5/2026", "€14 684"], status: "active" as const },
    { id: "988368155", cells: ["LIB-7155", "Library System Item 2", "20/12/2026", "€18 255"], status: "pending" as const },
    { id: "988371726", cells: ["LIB-1726", "Library System Item 3", "7/7/2026", "€21 826"], status: "completed" as const },
    { id: "988375297", cells: ["LIB-5297", "Library System Item 4", "22/2/2026", "€25 397"], status: "warning" as const },
    { id: "988378868", cells: ["LIB-8868", "Library System Item 5", "9/9/2026", "€28 968"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Library System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Library System</p>
                    </div>
                </div>
