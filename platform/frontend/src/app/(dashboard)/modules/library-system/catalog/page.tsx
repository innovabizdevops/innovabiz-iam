...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"2.521","t":"+2.9%","d":"up"},{"l":"Queries/Dia","v":"2347","t":"-1.6%","d":"down"},{"l":"Dados Processados (GB)","v":"7.852","t":"+11.1%","d":"up"},{"l":"Utilizadores Analytics","v":"299","t":"+17.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1718","2026-03-07","2.911","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3983","2026-01-02","6.486","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4111","2026-01-14","661","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1551","2026-02-08","1.256","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2237","2026-03-21","8.304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":648},{"label":"Mar","value":801},{"label":"Abr","value":782},{"label":"Mai","value":736},{"label":"Jun","value":979},{"label":"Jul","value":907},{"label":"Ago","value":851},{"label":"Set","value":979},{"label":"Out","value":706},{"label":"Nov","value":691},{"label":"Dez","value":992}];
const MX = 992;
