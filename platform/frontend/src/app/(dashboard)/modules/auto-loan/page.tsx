...
const KPIS = [
    { label: "Total Registos", value: "7635", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3878", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€230K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1377820235", cells: ["AUT-2235", "Auto Loan Item 1", "16/12/2026", "€20 335"], status: "active" as const },
    { id: "1377823806", cells: ["AUT-5806", "Auto Loan Item 2", "3/7/2026", "€23 906"], status: "pending" as const },
    { id: "1377827377", cells: ["AUT-9377", "Auto Loan Item 3", "18/2/2026", "€27 477"], status: "completed" as const },
    { id: "1377830948", cells: ["AUT-3948", "Auto Loan Item 4", "5/9/2026", "€31 048"], status: "warning" as const },
    { id: "1377834519", cells: ["AUT-7519", "Auto Loan Item 5", "20/4/2026", "€34 619"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Loan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auto Loan</p>
                    </div>
                </div>
