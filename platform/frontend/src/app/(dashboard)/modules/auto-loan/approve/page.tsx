...
const ACCENT = "#1e3a5f";
const MODULE = "Auto Loan";
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"4.361","t":"+17.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.4%","t":"+16.3%","d":"up"},{"l":"Tempo Médio (h)","v":"49h","t":"+10.7%","d":"up"},{"l":"Rejeitadas (%)","v":"86.2%","t":"+5.4%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.708","€ 40888.60","3.002","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","3.557","€ 20904.89","4.780","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","1.314","€ 37021.51","5.064","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","2.496","€ 11761.52","2.278","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.742","€ 43791.70","4.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":657},{"label":"Mar","value":953},{"label":"Abr","value":795},{"label":"Mai","value":951},{"label":"Jun","value":983},{"label":"Jul","value":934},{"label":"Ago","value":774},{"label":"Set","value":885},{"label":"Out","value":1023},{"label":"Nov","value":695},{"label":"Dez","value":960}];
const MX = 1023;
