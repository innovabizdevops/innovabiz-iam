...
const PAGE = "Carbon";
const KPIS = [{"l":"Dashboards Ativos","v":"1.444","t":"+4.5%","d":"up"},{"l":"Queries/Dia","v":"3423","t":"-3.0%","d":"down"},{"l":"Dados Processados (GB)","v":"4.449","t":"+0.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.443","t":"+11.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","777","2026-01-17","974","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3357","2026-02-11","4.157","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4851","2026-03-02","1.889","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4746","2026-02-02","3.138","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3492","2026-01-18","1.664","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":439},{"label":"Mar","value":519},{"label":"Abr","value":507},{"label":"Mai","value":455},{"label":"Jun","value":470},{"label":"Jul","value":542},{"label":"Ago","value":387},{"label":"Set","value":282},{"label":"Out","value":462},{"label":"Nov","value":247},{"label":"Dez","value":249}];
const MX = 542;
