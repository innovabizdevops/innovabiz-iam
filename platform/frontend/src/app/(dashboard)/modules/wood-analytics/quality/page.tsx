...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.816","t":"+14.5%","d":"up"},{"l":"NC Abertas","v":"6.687","t":"+2.2%","d":"up"},{"l":"Conformidade (%)","v":"69.1%","t":"-5.1%","d":"down"},{"l":"CAPAs Pendentes","v":"7.382","t":"-1.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.833","90.0%","2.191","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.204","96.0%","4.238","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.355","85.5%","4.896","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.526","85.7%","5.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.852","94.5%","3.753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":575},{"label":"Mar","value":478},{"label":"Abr","value":596},{"label":"Mai","value":503},{"label":"Jun","value":490},{"label":"Jul","value":504},{"label":"Ago","value":574},{"label":"Set","value":256},{"label":"Out","value":541},{"label":"Nov","value":582},{"label":"Dez","value":375}];
const MX = 596;
