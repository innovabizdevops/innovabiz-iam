...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"2.112","t":"+13.2%","d":"up"},{"l":"Queries/Dia","v":"1400","t":"+14.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.366","t":"-5.4%","d":"down"},{"l":"Utilizadores Analytics","v":"2.958","t":"+8.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5073","2026-02-24","7.919","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4018","2026-03-19","6.439","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2146","2026-01-04","240","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4368","2026-03-14","8.750","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","481","2026-03-08","7.464","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":828},{"label":"Mar","value":1052},{"label":"Abr","value":942},{"label":"Mai","value":983},{"label":"Jun","value":868},{"label":"Jul","value":957},{"label":"Ago","value":1066},{"label":"Set","value":1095},{"label":"Out","value":997},{"label":"Nov","value":712},{"label":"Dez","value":702}];
const MX = 1095;
