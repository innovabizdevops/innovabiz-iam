...
/* ═══ Wood Analytics — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "4165", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1499", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€425K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "282441165", cells: ["WOO-4165", "Wood Analytics Item 1", "14/10/2026", "€41 265"], status: "active" as const },
    { id: "282444736", cells: ["WOO-7736", "Wood Analytics Item 2", "1/5/2026", "€44 836"], status: "pending" as const },
    { id: "282448307", cells: ["WOO-2307", "Wood Analytics Item 3", "16/12/2026", "€48 407"], status: "completed" as const },
    { id: "282451878", cells: ["WOO-5878", "Wood Analytics Item 4", "3/7/2026", "€1978"], status: "warning" as const },
    { id: "282455449", cells: ["WOO-9449", "Wood Analytics Item 5", "18/2/2026", "€5549"], status: "active" as const },
];
...
export default function WoodAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wood Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wood Analytics</p>
                    </div>
                </div>
