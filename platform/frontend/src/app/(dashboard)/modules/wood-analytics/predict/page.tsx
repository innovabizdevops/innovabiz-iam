...
const ACCENT = "#15803d";
const MODULE = "Wood Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"1.956","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"1463","t":"-2.8%","d":"down"},{"l":"Dados Processados (GB)","v":"7.495","t":"+4.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.506","t":"-1.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1488","2026-03-23","5.699","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4019","2026-01-06","7.241","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3752","2026-02-16","570","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1050","2026-03-14","4.023","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2795","2026-01-19","7.053","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":293},{"label":"Fev","value":379},{"label":"Mar","value":430},{"label":"Abr","value":411},{"label":"Mai","value":656},{"label":"Jun","value":366},{"label":"Jul","value":471},{"label":"Ago","value":672},{"label":"Set","value":672},{"label":"Out","value":384},{"label":"Nov","value":453},{"label":"Dez","value":422}];
const MX = 672;
