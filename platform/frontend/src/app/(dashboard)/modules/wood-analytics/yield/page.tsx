...
const PAGE = "Yield";
const KPIS = [{"l":"Dashboards Ativos","v":"4.187","t":"+15.1%","d":"up"},{"l":"Queries/Dia","v":"4589","t":"+5.1%","d":"up"},{"l":"Dados Processados (GB)","v":"478","t":"-5.7%","d":"down"},{"l":"Utilizadores Analytics","v":"3.833","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4240","2026-02-27","8.794","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4398","2026-01-20","2.857","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3369","2026-02-07","2.186","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2671","2026-02-09","452","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1678","2026-03-08","5.517","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":338},{"label":"Mar","value":490},{"label":"Abr","value":550},{"label":"Mai","value":221},{"label":"Jun","value":495},{"label":"Jul","value":410},{"label":"Ago","value":564},{"label":"Set","value":354},{"label":"Out","value":359},{"label":"Nov","value":522},{"label":"Dez","value":539}];
const MX = 564;
