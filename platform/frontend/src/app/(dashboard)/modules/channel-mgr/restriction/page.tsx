...
const PAGE = "Restriction";
const KPIS = [{"l":"Total Channel Mgr","v":"6.858","t":"-0.3%","d":"down"},{"l":"Restriction Ativos","v":"6.346","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"78","t":"-5.0%","d":"down"}];
const COLS = ["ID","Restriction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Mgr #001","Channel Mgr #002","7.336","2.195","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Mgr #002","Channel Mgr #003","6.150","8.717","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Mgr #003","Channel Mgr #004","7.316","8.395","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Mgr #004","Channel Mgr #005","8.659","3.936","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Mgr #005","Channel Mgr #001","4.482","1.384","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":663},{"label":"Mar","value":482},{"label":"Abr","value":627},{"label":"Mai","value":513},{"label":"Jun","value":474},{"label":"Jul","value":530},{"label":"Ago","value":552},{"label":"Set","value":862},{"label":"Out","value":847},{"label":"Nov","value":819},{"label":"Dez","value":862}];
const MX = 862;
