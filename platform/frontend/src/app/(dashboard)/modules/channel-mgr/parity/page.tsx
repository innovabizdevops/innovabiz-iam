...
const PAGE = "Rate Parity";
const KPIS = [{"l":"Total Channel Mgr","v":"974","t":"+14.3%","d":"up"},{"l":"Rate Parity Ativos","v":"8.202","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"60","t":"-0.5%","d":"down"}];
const COLS = ["ID","Rate Parity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Mgr #001","Channel Mgr #002","4.511","676","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Mgr #002","Channel Mgr #003","8.061","2.072","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Mgr #003","Channel Mgr #004","5.731","2.511","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Mgr #004","Channel Mgr #005","7.014","1.139","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Mgr #005","Channel Mgr #001","2.927","8.228","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":828},{"label":"Mar","value":788},{"label":"Abr","value":837},{"label":"Mai","value":584},{"label":"Jun","value":809},{"label":"Jul","value":657},{"label":"Ago","value":802},{"label":"Set","value":559},{"label":"Out","value":833},{"label":"Nov","value":544},{"label":"Dez","value":596}];
const MX = 837;
