...
const PAGE = "Inventory Sync";
const KPIS = [{"l":"Integrações Ativas","v":"2.189","t":"+1.6%","d":"up"},{"l":"Chamadas/Hora","v":"5074","t":"+10.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.4%","t":"-0.2%","d":"down"},{"l":"Latência Média (ms)","v":"195ms","t":"+8.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.903","6.497","95.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.298","2.346","74.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.750","6.868","89.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.449","1.144","78.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","112","5.397","87.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":619},{"label":"Mar","value":538},{"label":"Abr","value":693},{"label":"Mai","value":400},{"label":"Jun","value":656},{"label":"Jul","value":563},{"label":"Ago","value":673},{"label":"Set","value":548},{"label":"Out","value":368},{"label":"Nov","value":474},{"label":"Dez","value":623}];
const MX = 693;
