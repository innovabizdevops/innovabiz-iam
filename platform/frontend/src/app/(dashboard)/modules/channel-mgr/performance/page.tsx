...
const KPIS = [{"l":"Formulários Ativos","v":"8.531","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"4785","t":"+8.6%","d":"up"},{"l":"Documentos Gerados","v":"2.837","t":"+17.1%","d":"up"},{"l":"Templates","v":"4.173","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.908","2026-03-26","8.501","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.033","2026-03-03","3.625","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.988","2026-02-24","1.033","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","538","2026-03-01","3.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.443","2026-02-13","4.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":714},{"label":"Mar","value":938},{"label":"Abr","value":851},{"label":"Mai","value":635},{"label":"Jun","value":913},{"label":"Jul","value":655},{"label":"Ago","value":683},{"label":"Set","value":592},{"label":"Out","value":754},{"label":"Nov","value":575},{"label":"Dez","value":672}];
const MX = 938;
