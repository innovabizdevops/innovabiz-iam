...
const PAGE = "OTA Connect";
const KPIS = [{"l":"Total Channel Mgr","v":"6.223","t":"+3.1%","d":"up"},{"l":"OTA Connect Ativos","v":"4.663","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"85","t":"-3.6%","d":"down"}];
const COLS = ["ID","OTA Connect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Mgr #001","Channel Mgr #002","334","5.908","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Mgr #002","Channel Mgr #003","3.162","8.994","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Mgr #003","Channel Mgr #004","5.383","8.555","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Mgr #004","Channel Mgr #005","8.003","1.236","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Mgr #005","Channel Mgr #001","8.774","8.200","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":659},{"label":"Mar","value":779},{"label":"Abr","value":670},{"label":"Mai","value":629},{"label":"Jun","value":741},{"label":"Jul","value":840},{"label":"Ago","value":698},{"label":"Set","value":617},{"label":"Out","value":862},{"label":"Nov","value":628},{"label":"Dez","value":815}];
const MX = 862;
