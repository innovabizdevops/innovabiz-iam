...
const PAGE = "Gap Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"6.654","t":"+10.5%","d":"up"},{"l":"Queries/Dia","v":"3041","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.899","t":"+8.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.555","t":"-3.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1200","2026-03-21","6.012","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3683","2026-02-23","1.563","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4376","2026-03-05","5.056","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","738","2026-03-12","4.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1399","2026-03-11","5.222","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":701},{"label":"Mar","value":558},{"label":"Abr","value":650},{"label":"Mai","value":687},{"label":"Jun","value":558},{"label":"Jul","value":559},{"label":"Ago","value":862},{"label":"Set","value":826},{"label":"Out","value":866},{"label":"Nov","value":535},{"label":"Dez","value":713}];
const MX = 866;
