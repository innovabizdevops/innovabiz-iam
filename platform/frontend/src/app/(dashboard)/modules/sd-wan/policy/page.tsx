...
const MODULE = "SD-WAN";
const PAGE = "Policy";
const KPIS = [{"l":"Total Sd Wan","v":"6.895","t":"+16.8%","d":"up"},{"l":"Policy Ativos","v":"5.284","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.8%","d":"down"}];
const COLS = ["ID","Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sd Wan #001","Sd Wan #002","6.015","6.542","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Sd Wan #002","Sd Wan #003","8.589","5.470","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Sd Wan #003","Sd Wan #004","1.017","6.237","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Sd Wan #004","Sd Wan #005","2.811","9.042","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sd Wan #005","Sd Wan #001","3.690","669","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1027},{"label":"Fev","value":857},{"label":"Mar","value":913},{"label":"Abr","value":867},{"label":"Mai","value":788},{"label":"Jun","value":695},{"label":"Jul","value":844},{"label":"Ago","value":833},{"label":"Set","value":1000},{"label":"Out","value":896},{"label":"Nov","value":673},{"label":"Dez","value":838}];
const MX = 1027;
