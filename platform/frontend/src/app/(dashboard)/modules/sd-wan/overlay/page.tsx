...
const MODULE = "SD-WAN";
const PAGE = "Overlay";
const KPIS = [{"l":"Total Sd Wan","v":"8.023","t":"+14.3%","d":"up"},{"l":"Overlay Ativos","v":"8.860","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"74","t":"+0.3%","d":"up"}];
const COLS = ["ID","Overlay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sd Wan #001","Sd Wan #002","7.062","8.334","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Sd Wan #002","Sd Wan #003","2.304","7.804","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Sd Wan #003","Sd Wan #004","6.408","5.578","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Sd Wan #004","Sd Wan #005","3.638","1.551","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sd Wan #005","Sd Wan #001","8.965","4.175","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":647},{"label":"Mar","value":612},{"label":"Abr","value":633},{"label":"Mai","value":496},{"label":"Jun","value":467},{"label":"Jul","value":515},{"label":"Ago","value":777},{"label":"Set","value":388},{"label":"Out","value":536},{"label":"Nov","value":747},{"label":"Dez","value":638}];
const MX = 777;
