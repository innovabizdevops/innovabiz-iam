...
const MODULE = "SD-WAN";
const PAGE = "WAN Opt";
const KPIS = [{"l":"Total Sd Wan","v":"5.503","t":"-1.8%","d":"down"},{"l":"WAN Opt Ativos","v":"7.793","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"84.1%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"72","t":"+13.5%","d":"up"}];
const COLS = ["ID","WAN Opt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sd Wan #001","Sd Wan #002","4.017","6.707","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Sd Wan #002","Sd Wan #003","442","6.393","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Sd Wan #003","Sd Wan #004","4.902","8.283","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Sd Wan #004","Sd Wan #005","2.366","6.476","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sd Wan #005","Sd Wan #001","7.633","5.127","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":928},{"label":"Mar","value":943},{"label":"Abr","value":743},{"label":"Mai","value":747},{"label":"Jun","value":1004},{"label":"Jul","value":996},{"label":"Ago","value":847},{"label":"Set","value":955},{"label":"Out","value":664},{"label":"Nov","value":746},{"label":"Dez","value":868}];
const MX = 1004;
