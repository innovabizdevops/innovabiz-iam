...
const MODULE = "SD-WAN";
const PAGE = "Security";
const KPIS = [{"l":"Total Sd Wan","v":"8.548","t":"+12.0%","d":"up"},{"l":"Security Ativos","v":"8.493","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+7.6%","d":"up"}];
const COLS = ["ID","Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sd Wan #001","Sd Wan #002","3.167","2.892","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Sd Wan #002","Sd Wan #003","7.847","8.086","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sd Wan #003","Sd Wan #004","2.852","277","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Sd Wan #004","Sd Wan #005","5.594","4.749","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sd Wan #005","Sd Wan #001","1.598","7.023","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":766},{"label":"Mar","value":774},{"label":"Abr","value":818},{"label":"Mai","value":487},{"label":"Jun","value":860},{"label":"Jul","value":684},{"label":"Ago","value":634},{"label":"Set","value":582},{"label":"Out","value":531},{"label":"Nov","value":827},{"label":"Dez","value":824}];
const MX = 860;
