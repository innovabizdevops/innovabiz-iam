...
const KPIS = [{"l":"Dashboards Ativos","v":"2.281","t":"-0.4%","d":"down"},{"l":"Queries/Dia","v":"3728","t":"+9.9%","d":"up"},{"l":"Dados Processados (GB)","v":"645","t":"+8.1%","d":"up"},{"l":"Utilizadores Analytics","v":"6.428","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3164","2026-03-27","8.097","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1827","2026-03-11","8.250","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4658","2026-03-07","3.861","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4057","2026-02-07","7.265","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3176","2026-02-09","2.902","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":629},{"label":"Mar","value":382},{"label":"Abr","value":728},{"label":"Mai","value":639},{"label":"Jun","value":734},{"label":"Jul","value":450},{"label":"Ago","value":481},{"label":"Set","value":408},{"label":"Out","value":695},{"label":"Nov","value":633},{"label":"Dez","value":431}];
const MX = 734;
