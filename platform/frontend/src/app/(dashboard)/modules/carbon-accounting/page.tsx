...
const KPIS = [
    { label: "Total Registos", value: "5792", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4220", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€464K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "279086692", cells: ["CAR-6692", "Carbon Accounting Item 1", "25/5/2026", "€36 792"], status: "active" as const },
    { id: "279090263", cells: ["CAR-1263", "Carbon Accounting Item 2", "12/12/2026", "€40 363"], status: "pending" as const },
    { id: "279093834", cells: ["CAR-4834", "Carbon Accounting Item 3", "27/7/2026", "€43 934"], status: "completed" as const },
    { id: "279097405", cells: ["CAR-8405", "Carbon Accounting Item 4", "14/2/2026", "€47 505"], status: "warning" as const },
    { id: "279100976", cells: ["CAR-2976", "Carbon Accounting Item 5", "1/9/2026", "€1076"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carbon Accounting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Carbon Accounting</p>
                    </div>
                </div>
