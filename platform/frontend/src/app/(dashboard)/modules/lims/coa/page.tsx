...
const PAGE = "CoA Generator";
const KPIS = [{"l":"Total Lims","v":"7.410","t":"+10.0%","d":"up"},{"l":"CoA Generator Ativos","v":"2.105","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"67","t":"+0.5%","d":"up"}];
const COLS = ["ID","CoA Generator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims #001","Lims #002","8.264","7.395","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Lims #002","Lims #003","3.086","3.923","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims #003","Lims #004","5.564","7.130","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Lims #004","Lims #005","7.555","4.182","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims #005","Lims #001","1.959","6.590","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":608},{"label":"Mar","value":799},{"label":"Abr","value":912},{"label":"Mai","value":621},{"label":"Jun","value":721},{"label":"Jul","value":899},{"label":"Ago","value":666},{"label":"Set","value":670},{"label":"Out","value":846},{"label":"Nov","value":689},{"label":"Dez","value":867}];
const MX = 912;
