...
const PAGE = "Instruments";
const KPIS = [{"l":"Total Lims","v":"8.925","t":"+14.4%","d":"up"},{"l":"Instruments Ativos","v":"2.555","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+14.4%","d":"up"}];
const COLS = ["ID","Instruments","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims #001","Lims #002","639","1.827","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Lims #002","Lims #003","5.041","2.940","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims #003","Lims #004","1.903","4.469","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Lims #004","Lims #005","6.302","2.664","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims #005","Lims #001","6.785","6.456","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":577},{"label":"Mar","value":794},{"label":"Abr","value":617},{"label":"Mai","value":450},{"label":"Jun","value":504},{"label":"Jul","value":746},{"label":"Ago","value":671},{"label":"Set","value":670},{"label":"Out","value":447},{"label":"Nov","value":790},{"label":"Dez","value":824}];
const MX = 824;
