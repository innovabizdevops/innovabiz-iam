...
const PAGE = "Test Methods";
const KPIS = [{"l":"Total Lims","v":"2.354","t":"+12.3%","d":"up"},{"l":"Test Methods Ativos","v":"8.972","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"69.9%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"87","t":"+10.4%","d":"up"}];
const COLS = ["ID","Test Methods","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims #001","Lims #002","1.818","1.703","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lims #002","Lims #003","8.352","3.377","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims #003","Lims #004","3.340","2.474","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Lims #004","Lims #005","4.814","4.452","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims #005","Lims #001","3.840","5.053","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":610},{"label":"Mar","value":538},{"label":"Abr","value":523},{"label":"Mai","value":399},{"label":"Jun","value":551},{"label":"Jul","value":438},{"label":"Ago","value":527},{"label":"Set","value":605},{"label":"Out","value":680},{"label":"Nov","value":585},{"label":"Dez","value":643}];
const MX = 680;
