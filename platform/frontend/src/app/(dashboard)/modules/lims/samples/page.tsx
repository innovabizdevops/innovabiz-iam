...
const PAGE = "Samples";
const KPIS = [{"l":"Total Lims","v":"6.071","t":"+4.2%","d":"up"},{"l":"Samples Ativos","v":"8.874","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+2.8%","d":"up"}];
const COLS = ["ID","Samples","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims #001","Lims #002","2.419","4.329","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Lims #002","Lims #003","2.398","5.555","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims #003","Lims #004","3.929","5.363","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Lims #004","Lims #005","6.954","7.144","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims #005","Lims #001","3.821","2.602","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":449},{"label":"Mar","value":546},{"label":"Abr","value":550},{"label":"Mai","value":380},{"label":"Jun","value":488},{"label":"Jul","value":444},{"label":"Ago","value":563},{"label":"Set","value":615},{"label":"Out","value":620},{"label":"Nov","value":445},{"label":"Dez","value":378}];
const MX = 620;
