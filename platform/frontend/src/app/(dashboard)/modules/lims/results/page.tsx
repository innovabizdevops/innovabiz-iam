...
const ACCENT = "#ec4899";
const MODULE = "Lab LIMS";
const PAGE = "Results Entry";
const KPIS = [{"l":"Total Lims","v":"936","t":"-2.4%","d":"down"},{"l":"Results Entry Ativos","v":"264","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"84","t":"+12.5%","d":"up"}];
const COLS = ["ID","Results Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims #001","Lims #002","8.060","4.286","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lims #002","Lims #003","4.630","7.999","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims #003","Lims #004","2.055","8.485","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Lims #004","Lims #005","4.569","9.100","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims #005","Lims #001","4.686","1.839","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1062},{"label":"Fev","value":1072},{"label":"Mar","value":1037},{"label":"Abr","value":890},{"label":"Mai","value":1020},{"label":"Jun","value":1048},{"label":"Jul","value":897},{"label":"Ago","value":817},{"label":"Set","value":1026},{"label":"Out","value":779},{"label":"Nov","value":789},{"label":"Dez","value":716}];
const MX = 1072;
