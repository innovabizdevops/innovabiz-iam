...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"8.827","t":"+5.8%","d":"up"},{"l":"Beneficiários","v":"6.527","t":"-1.8%","d":"down"},{"l":"Investimento CSR (€)","v":"€14110","t":"+9.8%","d":"up"},{"l":"Score Impacto","v":"65","t":"+12.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.398","€ 17204.42","618","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","9.066","€ 7960.20","7.192","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.202","€ 22291.19","4.367","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.971","€ 45737.00","140","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.479","€ 4683.33","3.810","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":469},{"label":"Mar","value":795},{"label":"Abr","value":835},{"label":"Mai","value":804},{"label":"Jun","value":626},{"label":"Jul","value":541},{"label":"Ago","value":511},{"label":"Set","value":772},{"label":"Out","value":631},{"label":"Nov","value":577},{"label":"Dez","value":525}];
const MX = 835;
