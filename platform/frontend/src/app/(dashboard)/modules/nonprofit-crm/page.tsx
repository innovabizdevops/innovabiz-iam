...
export default function NonprofitCrmPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Nonprofit Crm</h1><p className="text-sm text-muted-foreground">Nonprofit Crm • iBOS Enterprise</p></div>
