...
const PAGE = "FMEA";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.079","t":"+9.6%","d":"up"},{"l":"NC Abertas","v":"4.157","t":"+5.9%","d":"up"},{"l":"Conformidade (%)","v":"88.2%","t":"+10.9%","d":"up"},{"l":"CAPAs Pendentes","v":"562","t":"+11.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.258","83.2%","5.299","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.161","85.3%","7.059","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.382","92.8%","4.707","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.355","97.4%","3.740","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","745","83.8%","3.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":654},{"label":"Mar","value":1006},{"label":"Abr","value":658},{"label":"Mai","value":857},{"label":"Jun","value":992},{"label":"Jul","value":796},{"label":"Ago","value":849},{"label":"Set","value":961},{"label":"Out","value":632},{"label":"Nov","value":631},{"label":"Dez","value":868}];
const MX = 1006;
