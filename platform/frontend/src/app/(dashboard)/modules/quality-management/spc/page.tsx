...
const PAGE = "SPC (Stat Process Control)";
const KPIS = [{"l":"Auditorias Realizadas","v":"683","t":"+5.1%","d":"up"},{"l":"NC Abertas","v":"3.341","t":"-5.8%","d":"down"},{"l":"Conformidade (%)","v":"71.5%","t":"+9.5%","d":"up"},{"l":"CAPAs Pendentes","v":"6.290","t":"+13.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.725","95.7%","440","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.205","97.8%","5.590","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.563","93.6%","3.503","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.342","70.4%","7.469","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.729","71.7%","1.162","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":852},{"label":"Mar","value":621},{"label":"Abr","value":791},{"label":"Mai","value":558},{"label":"Jun","value":718},{"label":"Jul","value":718},{"label":"Ago","value":805},{"label":"Set","value":642},{"label":"Out","value":911},{"label":"Nov","value":846},{"label":"Dez","value":817}];
const MX = 911;
