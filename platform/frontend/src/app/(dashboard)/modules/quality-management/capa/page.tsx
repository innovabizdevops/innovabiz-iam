...
const PAGE = "CAPA";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.115","t":"+11.0%","d":"up"},{"l":"NC Abertas","v":"2.269","t":"+5.7%","d":"up"},{"l":"Conformidade (%)","v":"93.5%","t":"+4.7%","d":"up"},{"l":"CAPAs Pendentes","v":"1.325","t":"-1.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.741","85.7%","1.823","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.269","73.7%","3.458","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.854","85.6%","7.094","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.622","84.9%","8.555","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.443","96.9%","5.476","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":649},{"label":"Mar","value":704},{"label":"Abr","value":747},{"label":"Mai","value":574},{"label":"Jun","value":493},{"label":"Jul","value":443},{"label":"Ago","value":789},{"label":"Set","value":653},{"label":"Out","value":546},{"label":"Nov","value":439},{"label":"Dez","value":806}];
const MX = 806;
