...
const PAGE = "Control Chart SPC";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.513","t":"+6.2%","d":"up"},{"l":"NC Abertas","v":"9.008","t":"+11.1%","d":"up"},{"l":"Conformidade (%)","v":"86.2%","t":"+9.7%","d":"up"},{"l":"CAPAs Pendentes","v":"6.586","t":"-4.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.874","71.6%","8.605","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.187","97.9%","1.882","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.417","87.3%","8.425","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.871","83.1%","7.279","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.558","81.1%","831","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":659},{"label":"Mar","value":639},{"label":"Abr","value":873},{"label":"Mai","value":687},{"label":"Jun","value":666},{"label":"Jul","value":910},{"label":"Ago","value":824},{"label":"Set","value":621},{"label":"Out","value":795},{"label":"Nov","value":776},{"label":"Dez","value":658}];
const MX = 910;
