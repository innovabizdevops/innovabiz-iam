...
const PAGE = "Complaints Mgmt";
const KPIS = [{"l":"Auditorias Realizadas","v":"128","t":"+0.7%","d":"up"},{"l":"NC Abertas","v":"2.746","t":"-4.2%","d":"down"},{"l":"Conformidade (%)","v":"92.0%","t":"+12.8%","d":"up"},{"l":"CAPAs Pendentes","v":"517","t":"-4.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.705","84.7%","4.616","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.420","98.4%","5.056","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.029","73.5%","3.337","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.012","96.8%","2.813","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.853","92.8%","513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":352},{"label":"Fev","value":467},{"label":"Mar","value":306},{"label":"Abr","value":357},{"label":"Mai","value":435},{"label":"Jun","value":297},{"label":"Jul","value":484},{"label":"Ago","value":468},{"label":"Set","value":625},{"label":"Out","value":319},{"label":"Nov","value":448},{"label":"Dez","value":607}];
const MX = 625;
