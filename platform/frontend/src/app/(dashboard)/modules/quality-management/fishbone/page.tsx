...
const PAGE = "Fishbone Diagram";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.447","t":"+3.1%","d":"up"},{"l":"NC Abertas","v":"8.365","t":"+15.1%","d":"up"},{"l":"Conformidade (%)","v":"81.7%","t":"-4.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.442","t":"+5.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.625","87.9%","1.584","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.121","81.5%","3.966","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.363","84.7%","4.202","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.188","82.2%","2.956","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.702","72.7%","7.173","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":585},{"label":"Mar","value":662},{"label":"Abr","value":830},{"label":"Mai","value":663},{"label":"Jun","value":536},{"label":"Jul","value":582},{"label":"Ago","value":650},{"label":"Set","value":756},{"label":"Out","value":717},{"label":"Nov","value":802},{"label":"Dez","value":833}];
const MX = 865;
