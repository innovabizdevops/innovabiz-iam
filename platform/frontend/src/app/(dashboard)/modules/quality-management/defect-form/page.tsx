...
const PAGE = "Defect Report Form";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.981","t":"-5.2%","d":"down"},{"l":"NC Abertas","v":"2.702","t":"+14.9%","d":"up"},{"l":"Conformidade (%)","v":"85.1%","t":"+6.6%","d":"up"},{"l":"CAPAs Pendentes","v":"504","t":"+10.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.955","77.4%","4.291","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.095","73.4%","1.327","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.924","72.1%","7.953","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.437","73.2%","3.661","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.442","86.9%","2.942","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":259},{"label":"Fev","value":601},{"label":"Mar","value":451},{"label":"Abr","value":290},{"label":"Mai","value":340},{"label":"Jun","value":417},{"label":"Jul","value":390},{"label":"Ago","value":357},{"label":"Set","value":595},{"label":"Out","value":602},{"label":"Nov","value":301},{"label":"Dez","value":464}];
const MX = 602;
