...
const PAGE = "Supplier Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.135","t":"-1.2%","d":"down"},{"l":"NC Abertas","v":"8.151","t":"+8.1%","d":"up"},{"l":"Conformidade (%)","v":"92.3%","t":"+6.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.958","t":"+6.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.711","80.4%","8.496","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.272","75.8%","724","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.795","97.8%","3.583","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.756","82.5%","1.586","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.540","95.7%","7.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":868},{"label":"Mar","value":818},{"label":"Abr","value":651},{"label":"Mai","value":730},{"label":"Jun","value":920},{"label":"Jul","value":663},{"label":"Ago","value":900},{"label":"Set","value":637},{"label":"Out","value":749},{"label":"Nov","value":782},{"label":"Dez","value":932}];
const MX = 932;
