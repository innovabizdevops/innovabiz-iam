...
const PAGE = "CAPA Tracking";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.184","t":"+12.9%","d":"up"},{"l":"NC Abertas","v":"1.844","t":"+8.5%","d":"up"},{"l":"Conformidade (%)","v":"86.2%","t":"+15.3%","d":"up"},{"l":"CAPAs Pendentes","v":"390","t":"+0.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","9.020","99.2%","530","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.217","71.1%","9.052","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.944","92.2%","4.987","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.481","94.5%","3.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.284","77.0%","429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":385},{"label":"Mar","value":368},{"label":"Abr","value":298},{"label":"Mai","value":447},{"label":"Jun","value":630},{"label":"Jul","value":531},{"label":"Ago","value":389},{"label":"Set","value":327},{"label":"Out","value":293},{"label":"Nov","value":322},{"label":"Dez","value":485}];
const MX = 630;
...
export default function CapaQualityPage() {
    return (
