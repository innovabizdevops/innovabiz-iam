...
const PAGE = "ISO 9001 QMS";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.311","t":"+10.8%","d":"up"},{"l":"NC Abertas","v":"4.395","t":"-4.6%","d":"down"},{"l":"Conformidade (%)","v":"70.9%","t":"+3.0%","d":"up"},{"l":"CAPAs Pendentes","v":"8.252","t":"+5.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.219","90.0%","1.434","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.490","72.6%","8.265","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.125","88.0%","7.720","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.333","82.2%","872","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.511","87.1%","2.627","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":826},{"label":"Mar","value":853},{"label":"Abr","value":462},{"label":"Mai","value":471},{"label":"Jun","value":681},{"label":"Jul","value":847},{"label":"Ago","value":515},{"label":"Set","value":619},{"label":"Out","value":859},{"label":"Nov","value":822},{"label":"Dez","value":475}];
const MX = 859;
