...
const ACCENT = "#6366f1";
const MODULE = "Quality Management";
const PAGE = "SPC (Statistical)";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.216","t":"+5.2%","d":"up"},{"l":"NC Abertas","v":"5.045","t":"-4.6%","d":"down"},{"l":"Conformidade (%)","v":"71.3%","t":"+16.2%","d":"up"},{"l":"CAPAs Pendentes","v":"4.373","t":"+7.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.447","79.7%","8.085","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.765","78.3%","8.446","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.420","90.5%","2.227","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.891","76.9%","8.736","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.723","98.9%","5.283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":712},{"label":"Mar","value":823},{"label":"Abr","value":630},{"label":"Mai","value":639},{"label":"Jun","value":886},{"label":"Jul","value":624},{"label":"Ago","value":739},{"label":"Set","value":885},{"label":"Out","value":646},{"label":"Nov","value":842},{"label":"Dez","value":696}];
const MX = 886;
...
export default function SpcQualityPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>SPC</span></h1>
                </div>
