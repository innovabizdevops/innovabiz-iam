...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.079","t":"+17.9%","d":"up"},{"l":"NC Abertas","v":"3.155","t":"+16.0%","d":"up"},{"l":"Conformidade (%)","v":"73.4%","t":"+0.9%","d":"up"},{"l":"CAPAs Pendentes","v":"1.045","t":"-3.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.495","100.0%","1.036","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.433","96.1%","2.176","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.572","91.9%","8.017","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","619","95.5%","3.193","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.614","88.4%","8.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":626},{"label":"Mar","value":863},{"label":"Abr","value":563},{"label":"Mai","value":818},{"label":"Jun","value":832},{"label":"Jul","value":628},{"label":"Ago","value":853},{"label":"Set","value":827},{"label":"Out","value":877},{"label":"Nov","value":840},{"label":"Dez","value":488}];
const MX = 877;
