...
const PAGE = "ISO 13485 Medical";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.843","t":"+14.1%","d":"up"},{"l":"NC Abertas","v":"8.204","t":"+12.3%","d":"up"},{"l":"Conformidade (%)","v":"94.9%","t":"+13.7%","d":"up"},{"l":"CAPAs Pendentes","v":"5.059","t":"+2.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.855","93.7%","8.360","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.705","84.0%","533","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.852","72.8%","4.347","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.954","88.1%","8.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","772","81.2%","1.138","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":1018},{"label":"Mar","value":1006},{"label":"Abr","value":788},{"label":"Mai","value":863},{"label":"Jun","value":984},{"label":"Jul","value":868},{"label":"Ago","value":1024},{"label":"Set","value":736},{"label":"Out","value":753},{"label":"Nov","value":989},{"label":"Dez","value":762}];
const MX = 1024;
