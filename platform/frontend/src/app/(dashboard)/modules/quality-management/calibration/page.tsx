...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.485","t":"-2.8%","d":"down"},{"l":"NC Abertas","v":"7.653","t":"+12.3%","d":"up"},{"l":"Conformidade (%)","v":"70.9%","t":"+17.3%","d":"up"},{"l":"CAPAs Pendentes","v":"5.410","t":"+16.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.614","74.1%","3.033","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.077","86.9%","4.605","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.679","87.5%","4.156","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.663","88.5%","5.195","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.533","80.5%","3.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":769},{"label":"Mar","value":562},{"label":"Abr","value":668},{"label":"Mai","value":534},{"label":"Jun","value":626},{"label":"Jul","value":738},{"label":"Ago","value":465},{"label":"Set","value":689},{"label":"Out","value":498},{"label":"Nov","value":550},{"label":"Dez","value":526}];
const MX = 769;
