...
const PAGE = "Pareto Chart";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.965","t":"+17.2%","d":"up"},{"l":"NC Abertas","v":"2.925","t":"+16.6%","d":"up"},{"l":"Conformidade (%)","v":"76.5%","t":"+1.2%","d":"up"},{"l":"CAPAs Pendentes","v":"3.647","t":"-2.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.652","77.6%","8.585","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.483","90.0%","2.699","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.709","83.9%","5.499","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.613","74.1%","4.543","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.013","92.3%","286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":830},{"label":"Mar","value":803},{"label":"Abr","value":672},{"label":"Mai","value":988},{"label":"Jun","value":953},{"label":"Jul","value":661},{"label":"Ago","value":704},{"label":"Set","value":841},{"label":"Out","value":774},{"label":"Nov","value":663},{"label":"Dez","value":759}];
const MX = 988;
