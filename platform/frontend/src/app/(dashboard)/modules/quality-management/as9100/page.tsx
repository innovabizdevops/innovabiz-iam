...
const PAGE = "AS9100 Aerospace";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.116","t":"-3.5%","d":"down"},{"l":"NC Abertas","v":"7.044","t":"-4.0%","d":"down"},{"l":"Conformidade (%)","v":"75.4%","t":"+15.1%","d":"up"},{"l":"CAPAs Pendentes","v":"3.288","t":"+15.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.732","78.3%","2.052","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","198","80.1%","6.500","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.614","75.2%","1.705","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.261","72.4%","7.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.492","91.3%","8.529","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":926},{"label":"Fev","value":658},{"label":"Mar","value":994},{"label":"Abr","value":871},{"label":"Mai","value":929},{"label":"Jun","value":837},{"label":"Jul","value":882},{"label":"Ago","value":898},{"label":"Set","value":971},{"label":"Out","value":1023},{"label":"Nov","value":862},{"label":"Dez","value":837}];
const MX = 1023;
...
export default function As9100Page() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>AS</span></h1>
                </div>
