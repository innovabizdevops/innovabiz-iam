...
const PAGE = "Six Sigma DMAIC";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.805","t":"+6.1%","d":"up"},{"l":"NC Abertas","v":"2.724","t":"+16.6%","d":"up"},{"l":"Conformidade (%)","v":"73.9%","t":"+8.3%","d":"up"},{"l":"CAPAs Pendentes","v":"5.875","t":"+8.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","581","76.9%","3.929","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.831","93.1%","8.182","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","641","96.0%","1.751","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.229","79.4%","2.640","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.621","86.9%","7.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":876},{"label":"Mar","value":640},{"label":"Abr","value":961},{"label":"Mai","value":723},{"label":"Jun","value":669},{"label":"Jul","value":799},{"label":"Ago","value":810},{"label":"Set","value":777},{"label":"Out","value":839},{"label":"Nov","value":796},{"label":"Dez","value":765}];
const MX = 961;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>6σ</span></h1>
                </div>
