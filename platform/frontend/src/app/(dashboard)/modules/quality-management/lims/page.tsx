...
const PAGE = "Lab Mgmt (LIMS)";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.592","t":"+5.4%","d":"up"},{"l":"NC Abertas","v":"2.737","t":"+4.7%","d":"up"},{"l":"Conformidade (%)","v":"91.8%","t":"+2.8%","d":"up"},{"l":"CAPAs Pendentes","v":"6.913","t":"+0.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.856","95.5%","5.369","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.838","85.3%","3.356","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.207","87.0%","2.802","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.975","89.3%","804","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","719","75.5%","6.803","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":397},{"label":"Mar","value":717},{"label":"Abr","value":640},{"label":"Mai","value":446},{"label":"Jun","value":633},{"label":"Jul","value":462},{"label":"Ago","value":477},{"label":"Set","value":372},{"label":"Out","value":532},{"label":"Nov","value":504},{"label":"Dez","value":532}];
const MX = 717;
