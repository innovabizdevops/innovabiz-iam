...
const PAGE = "ISO Standards";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.542","t":"-3.8%","d":"down"},{"l":"NC Abertas","v":"6.844","t":"+8.6%","d":"up"},{"l":"Conformidade (%)","v":"75.7%","t":"-2.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.614","t":"-3.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.376","74.4%","768","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.825","72.3%","7.317","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","328","98.8%","4.410","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.415","79.2%","4.020","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.093","87.3%","367","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":654},{"label":"Mar","value":766},{"label":"Abr","value":902},{"label":"Mai","value":665},{"label":"Jun","value":786},{"label":"Jul","value":629},{"label":"Ago","value":807},{"label":"Set","value":967},{"label":"Out","value":729},{"label":"Nov","value":856},{"label":"Dez","value":710}];
const MX = 967;
