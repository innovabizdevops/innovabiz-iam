...
const PAGE = "IATF 16949 Automotive";
const KPIS = [{"l":"Auditorias Realizadas","v":"919","t":"+0.0%","d":"up"},{"l":"NC Abertas","v":"6.045","t":"+17.8%","d":"up"},{"l":"Conformidade (%)","v":"78.8%","t":"+11.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.912","t":"-3.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.908","93.9%","2.052","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.973","85.6%","6.765","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.082","89.4%","4.493","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.402","83.8%","3.674","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.701","86.8%","3.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":1005},{"label":"Mar","value":872},{"label":"Abr","value":962},{"label":"Mai","value":874},{"label":"Jun","value":669},{"label":"Jul","value":645},{"label":"Ago","value":781},{"label":"Set","value":875},{"label":"Out","value":896},{"label":"Nov","value":752},{"label":"Dez","value":866}];
const MX = 1005;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>IATF</span></h1>
                </div>
