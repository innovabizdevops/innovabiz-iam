...
const PAGE = "Testing";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.827","t":"+12.0%","d":"up"},{"l":"NC Abertas","v":"745","t":"+13.3%","d":"up"},{"l":"Conformidade (%)","v":"74.3%","t":"+14.2%","d":"up"},{"l":"CAPAs Pendentes","v":"7.749","t":"+4.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.050","77.1%","5.797","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.224","85.8%","5.279","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.321","99.2%","4.914","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.666","89.1%","891","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.088","96.8%","163","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":565},{"label":"Mar","value":694},{"label":"Abr","value":492},{"label":"Mai","value":450},{"label":"Jun","value":811},{"label":"Jul","value":441},{"label":"Ago","value":624},{"label":"Set","value":513},{"label":"Out","value":632},{"label":"Nov","value":602},{"label":"Dez","value":443}];
const MX = 811;
