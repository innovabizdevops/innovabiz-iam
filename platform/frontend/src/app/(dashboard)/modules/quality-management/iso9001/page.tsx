...
const PAGE = "ISO 9001 Register";
const KPIS = [{"l":"Auditorias Realizadas","v":"760","t":"-0.1%","d":"down"},{"l":"NC Abertas","v":"8.583","t":"+17.2%","d":"up"},{"l":"Conformidade (%)","v":"77.7%","t":"-5.0%","d":"down"},{"l":"CAPAs Pendentes","v":"5.768","t":"+1.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.120","90.2%","7.536","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.958","77.0%","4.804","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.304","73.1%","1.367","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.082","71.8%","5.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.599","78.7%","9.037","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":885},{"label":"Mar","value":826},{"label":"Abr","value":903},{"label":"Mai","value":713},{"label":"Jun","value":791},{"label":"Jul","value":779},{"label":"Ago","value":713},{"label":"Set","value":775},{"label":"Out","value":665},{"label":"Nov","value":912},{"label":"Dez","value":794}];
const MX = 912;
