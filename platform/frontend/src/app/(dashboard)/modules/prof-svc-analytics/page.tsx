...
export default function ProfSvcAnalyticsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Prof Svc Analytics</h1><p className="text-sm text-muted-foreground">Prof Svc Analytics • iBOS Enterprise</p></div>
