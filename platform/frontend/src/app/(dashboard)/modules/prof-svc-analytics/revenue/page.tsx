...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€27.3M","t":"-3.9%","d":"down"},{"l":"MRR (€)","v":"€70664","t":"+8.9%","d":"up"},{"l":"Churn (%)","v":"74.5%","t":"+14.7%","d":"up"},{"l":"ARPU (€)","v":"€9574","t":"+6.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18387.58","7.264","€ 13803.88","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48889.27","373","€ 9203.48","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1900.82","4.033","€ 41037.18","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 8376.02","5.299","€ 40037.65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17909.13","4.270","€ 2210.97","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":824},{"label":"Mar","value":868},{"label":"Abr","value":701},{"label":"Mai","value":975},{"label":"Jun","value":741},{"label":"Jul","value":931},{"label":"Ago","value":846},{"label":"Set","value":762},{"label":"Out","value":881},{"label":"Nov","value":746},{"label":"Dez","value":666}];
const MX = 975;
