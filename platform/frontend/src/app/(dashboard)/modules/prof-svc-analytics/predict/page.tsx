...
const ACCENT = "#6366f1";
const MODULE = "Prof Services Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"4.951","t":"+2.1%","d":"up"},{"l":"Queries/Dia","v":"3282","t":"+12.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.654","t":"-2.1%","d":"down"},{"l":"Utilizadores Analytics","v":"7.144","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1195","2026-01-20","4.350","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4709","2026-02-25","1.293","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","224","2026-03-02","502","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3000","2026-03-26","2.295","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3360","2026-01-22","5.102","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":323},{"label":"Mar","value":534},{"label":"Abr","value":466},{"label":"Mai","value":542},{"label":"Jun","value":654},{"label":"Jul","value":427},{"label":"Ago","value":374},{"label":"Set","value":437},{"label":"Out","value":563},{"label":"Nov","value":313},{"label":"Dez","value":385}];
const MX = 654;
