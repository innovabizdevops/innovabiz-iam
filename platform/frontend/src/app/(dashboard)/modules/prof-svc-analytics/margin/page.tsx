...
const PAGE = "Margin";
const KPIS = [{"l":"ARR (€M)","v":"€8.6M","t":"+8.5%","d":"up"},{"l":"MRR (€)","v":"€90991","t":"-2.0%","d":"down"},{"l":"Churn (%)","v":"71.5%","t":"+13.9%","d":"up"},{"l":"ARPU (€)","v":"€65005","t":"-4.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 46424.88","7.902","€ 3425.20","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13410.67","1.220","€ 2407.76","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 49847.93","1.613","€ 44547.82","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26547.13","5.964","€ 40091.89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37403.63","1.775","€ 27487.39","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":787},{"label":"Mar","value":649},{"label":"Abr","value":839},{"label":"Mai","value":610},{"label":"Jun","value":847},{"label":"Jul","value":648},{"label":"Ago","value":895},{"label":"Set","value":776},{"label":"Out","value":519},{"label":"Nov","value":640},{"label":"Dez","value":512}];
const MX = 895;
