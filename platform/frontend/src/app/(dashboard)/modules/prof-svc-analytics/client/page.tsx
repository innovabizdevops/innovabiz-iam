...
const PAGE = "Client";
const KPIS = [{"l":"Dashboards Ativos","v":"3.509","t":"+2.8%","d":"up"},{"l":"Queries/Dia","v":"1045","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.800","t":"+7.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.973","t":"+4.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1940","2026-02-14","3.374","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","927","2026-01-05","3.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1347","2026-02-21","7.077","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","663","2026-03-09","3.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3180","2026-02-17","8.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":788},{"label":"Mar","value":625},{"label":"Abr","value":715},{"label":"Mai","value":969},{"label":"Jun","value":942},{"label":"Jul","value":975},{"label":"Ago","value":965},{"label":"Set","value":877},{"label":"Out","value":713},{"label":"Nov","value":873},{"label":"Dez","value":904}];
const MX = 975;
