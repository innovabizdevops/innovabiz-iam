...
const KPIS = [{"l":"Dashboards Ativos","v":"7.824","t":"+6.7%","d":"up"},{"l":"Queries/Dia","v":"1221","t":"-4.6%","d":"down"},{"l":"Dados Processados (GB)","v":"8.792","t":"-5.0%","d":"down"},{"l":"Utilizadores Analytics","v":"7.546","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2522","2026-02-21","5.318","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","204","2026-03-06","5.183","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","717","2026-01-18","3.048","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3794","2026-01-17","446","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1355","2026-03-06","8.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":751},{"label":"Mar","value":681},{"label":"Abr","value":662},{"label":"Mai","value":739},{"label":"Jun","value":717},{"label":"Jul","value":570},{"label":"Ago","value":525},{"label":"Set","value":732},{"label":"Out","value":757},{"label":"Nov","value":760},{"label":"Dez","value":848}];
const MX = 879;
