...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"3.337","t":"+11.1%","d":"up"},{"l":"Beneficiários","v":"4.725","t":"-1.0%","d":"down"},{"l":"Investimento CSR (€)","v":"€87465","t":"+10.4%","d":"up"},{"l":"Score Impacto","v":"60","t":"+2.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.438","€ 28272.68","6.504","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.911","€ 12637.82","4.201","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.309","€ 13755.56","691","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.640","€ 30438.62","7.859","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.918","€ 30008.98","4.500","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":388},{"label":"Mar","value":293},{"label":"Abr","value":389},{"label":"Mai","value":250},{"label":"Jun","value":422},{"label":"Jul","value":329},{"label":"Ago","value":291},{"label":"Set","value":543},{"label":"Out","value":453},{"label":"Nov","value":552},{"label":"Dez","value":345}];
const MX = 552;
