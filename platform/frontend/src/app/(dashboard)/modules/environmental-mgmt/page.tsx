...
/* ═══ Environmental Mgmt (ISO 14001) — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8693", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2745", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€210K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1475999593", cells: ["ENV-9593", "Environmental Mgmt (ISO 14001) Item 1", "6/2/2026", "€49 693"], status: "active" as const },
    { id: "1476003164", cells: ["ENV-4164", "Environmental Mgmt (ISO 14001) Item 2", "21/9/2026", "€3264"], status: "pending" as const },
    { id: "1476006735", cells: ["ENV-7735", "Environmental Mgmt (ISO 14001) Item 3", "8/4/2026", "€6835"], status: "completed" as const },
    { id: "1476010306", cells: ["ENV-2306", "Environmental Mgmt (ISO 14001) Item 4", "23/11/2026", "€10 406"], status: "warning" as const },
    { id: "1476013877", cells: ["ENV-5877", "Environmental Mgmt (ISO 14001) Item 5", "10/6/2026", "€13 977"], status: "active" as const },
];
...
export default function EnvironmentalMgmtIso14001Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Environmental Mgmt (ISO 14001)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Environmental Mgmt (ISO 14001)</p>
                    </div>
                </div>
