...
const ACCENT = "#059669";
const MODULE = "Environmental Mgmt (ISO 14001)";
const PAGE = "Aspect";
const KPIS = [{"l":"Total Environmental Mgmt","v":"1.673","t":"+11.6%","d":"up"},{"l":"Aspect Ativos","v":"7.002","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"78.9%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+13.2%","d":"up"}];
const COLS = ["ID","Aspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Environmental Mgmt #001","Environmental Mgmt #002","2.466","8.087","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Environmental Mgmt #002","Environmental Mgmt #003","6.437","109","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Environmental Mgmt #003","Environmental Mgmt #004","7.858","7.223","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Environmental Mgmt #004","Environmental Mgmt #005","869","3.243","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Environmental Mgmt #005","Environmental Mgmt #001","6.765","3.684","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":823},{"label":"Mar","value":750},{"label":"Abr","value":737},{"label":"Mai","value":805},{"label":"Jun","value":876},{"label":"Jul","value":904},{"label":"Ago","value":776},{"label":"Set","value":758},{"label":"Out","value":673},{"label":"Nov","value":711},{"label":"Dez","value":728}];
const MX = 904;
