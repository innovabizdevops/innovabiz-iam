...
const KPIS = [{"l":"Riscos Identificados","v":"381","t":"+12.5%","d":"up"},{"l":"Mitigações Ativas","v":"4.168","t":"+9.4%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+9.2%","d":"up"},{"l":"Incidentes YTD","v":"566","t":"+0.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.977","2.707","8.424","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.475","7.553","1.897","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.164","727","1.937","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.838","8.066","4.636","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.647","5.409","7.472","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":662},{"label":"Mar","value":448},{"label":"Abr","value":587},{"label":"Mai","value":589},{"label":"Jun","value":630},{"label":"Jul","value":514},{"label":"Ago","value":606},{"label":"Set","value":454},{"label":"Out","value":374},{"label":"Nov","value":612},{"label":"Dez","value":646}];
const MX = 668;
