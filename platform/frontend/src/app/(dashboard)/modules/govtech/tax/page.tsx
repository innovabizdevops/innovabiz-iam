...
const PAGE = "Tax Administration";
const KPIS = [{"l":"Total Govtech","v":"3.270","t":"-5.5%","d":"down"},{"l":"Tax Administration Ativos","v":"8.687","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"95","t":"-4.5%","d":"down"}];
const COLS = ["ID","Tax Administration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Govtech #001","Govtech #002","6.073","7.369","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Govtech #002","Govtech #003","5.021","599","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Govtech #003","Govtech #004","6.867","4.027","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Govtech #004","Govtech #005","1.977","8.109","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Govtech #005","Govtech #001","5.462","4.685","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":845},{"label":"Mar","value":908},{"label":"Abr","value":980},{"label":"Mai","value":939},{"label":"Jun","value":682},{"label":"Jul","value":859},{"label":"Ago","value":914},{"label":"Set","value":833},{"label":"Out","value":938},{"label":"Nov","value":741},{"label":"Dez","value":1044}];
const MX = 1044;
