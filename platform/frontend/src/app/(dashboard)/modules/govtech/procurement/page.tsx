...
const PAGE = "Public Procurement";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.881","t":"+10.7%","d":"up"},{"l":"Contratos (€M)","v":"€23.3M","t":"-0.9%","d":"down"},{"l":"On-Time Delivery (%)","v":"87.4%","t":"-0.8%","d":"down"},{"l":"Score Médio","v":"74","t":"+4.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","80.6%","€ 46280.68","6.503","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","83.6%","€ 47202.93","4.116","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","89.4%","€ 44448.09","7.776","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","90.4%","€ 48122.17","3.549","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","93.7%","€ 5908.15","6.257","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":604},{"label":"Mar","value":948},{"label":"Abr","value":710},{"label":"Mai","value":713},{"label":"Jun","value":718},{"label":"Jul","value":757},{"label":"Ago","value":651},{"label":"Set","value":734},{"label":"Out","value":863},{"label":"Nov","value":608},{"label":"Dez","value":644}];
const MX = 991;
