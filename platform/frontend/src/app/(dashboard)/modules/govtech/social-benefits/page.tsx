...
const PAGE = "Social Benefits";
const KPIS = [{"l":"Total Govtech","v":"6.693","t":"+14.1%","d":"up"},{"l":"Social Benefits Ativos","v":"2.174","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+0.3%","d":"up"}];
const COLS = ["ID","Social Benefits","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Govtech #001","Govtech #002","6.352","9.072","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Govtech #002","Govtech #003","2.983","4.406","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Govtech #003","Govtech #004","3.195","840","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Govtech #004","Govtech #005","8.749","181","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Govtech #005","Govtech #001","4.824","9.042","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":689},{"label":"Mar","value":491},{"label":"Abr","value":503},{"label":"Mai","value":800},{"label":"Jun","value":882},{"label":"Jul","value":548},{"label":"Ago","value":658},{"label":"Set","value":731},{"label":"Out","value":535},{"label":"Nov","value":727},{"label":"Dez","value":515}];
const MX = 882;
...
export default function SocialBenefitsPage() {
    return (
