...
const PAGE = "Budget Transparency";
const KPIS = [{"l":"Quartos Ocupados","v":"2.341","t":"+1.0%","d":"up"},{"l":"RevPAR (€)","v":"€98158","t":"+10.5%","d":"up"},{"l":"Ocupação (%)","v":"87.0%","t":"+10.0%","d":"up"},{"l":"Guest Satisfaction","v":"1.578","t":"+3.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.575","2026-01-04","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","956","2026-03-01","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.788","2026-01-09","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.383","2026-01-10","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.110","2026-01-23","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":604},{"label":"Mar","value":794},{"label":"Abr","value":667},{"label":"Mai","value":947},{"label":"Jun","value":904},{"label":"Jul","value":775},{"label":"Ago","value":870},{"label":"Set","value":742},{"label":"Out","value":775},{"label":"Nov","value":934},{"label":"Dez","value":825}];
const MX = 947;
