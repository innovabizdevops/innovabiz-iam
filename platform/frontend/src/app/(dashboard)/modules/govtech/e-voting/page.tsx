...
const PAGE = "e-Voting";
const KPIS = [{"l":"Total Govtech","v":"8.831","t":"-1.0%","d":"down"},{"l":"E Voting Ativos","v":"3.623","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"89","t":"+16.6%","d":"up"}];
const COLS = ["ID","E Voting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Govtech #001","Govtech #002","823","5.364","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Govtech #002","Govtech #003","1.708","1.122","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Govtech #003","Govtech #004","4.986","6.539","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Govtech #004","Govtech #005","6.139","8.517","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Govtech #005","Govtech #001","2.394","2.162","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":975},{"label":"Mar","value":617},{"label":"Abr","value":608},{"label":"Mai","value":687},{"label":"Jun","value":796},{"label":"Jul","value":662},{"label":"Ago","value":888},{"label":"Set","value":969},{"label":"Out","value":741},{"label":"Nov","value":976},{"label":"Dez","value":735}];
const MX = 976;
