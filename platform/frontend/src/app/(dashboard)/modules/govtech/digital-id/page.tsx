...
const ACCENT = "#1e3a5f";
const MODULE = "GovTech & Civic Tech";
const PAGE = "Digital Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.274","t":"+3.8%","d":"up"},{"l":"Sessões/Dia","v":"1021","t":"+13.2%","d":"up"},{"l":"MFA Adoção (%)","v":"95.0%","t":"+0.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"799","t":"+13.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","364","5.753","3.874","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.585","2.381","6.565","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.939","7.480","2.801","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.384","8.284","7.268","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.068","5.971","8.707","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":856},{"label":"Mar","value":749},{"label":"Abr","value":929},{"label":"Mai","value":780},{"label":"Jun","value":997},{"label":"Jul","value":735},{"label":"Ago","value":994},{"label":"Set","value":759},{"label":"Out","value":1062},{"label":"Nov","value":794},{"label":"Dez","value":953}];
const MX = 1062;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>eIDAS</span></h1>
                </div>
