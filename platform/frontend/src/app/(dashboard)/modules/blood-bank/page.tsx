...
const KPIS = [
    { label: "Total Registos", value: "4758", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2512", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€443K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "396905558", cells: ["BLO-6558", "Blood Bank Management Item 1", "15/3/2026", "€5658"], status: "active" as const },
    { id: "396909129", cells: ["BLO-1129", "Blood Bank Management Item 2", "2/10/2026", "€9229"], status: "pending" as const },
    { id: "396912700", cells: ["BLO-4700", "Blood Bank Management Item 3", "17/5/2026", "€12 800"], status: "completed" as const },
    { id: "396916271", cells: ["BLO-8271", "Blood Bank Management Item 4", "4/12/2026", "€16 371"], status: "warning" as const },
    { id: "396919842", cells: ["BLO-2842", "Blood Bank Management Item 5", "19/7/2026", "€19 942"], status: "active" as const },
];
...
export default function BloodBankManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Blood Bank Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Blood Bank Management</p>
                    </div>
                </div>
