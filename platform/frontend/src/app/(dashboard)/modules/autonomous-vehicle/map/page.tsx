...
const PAGE = "Map";
const KPIS = [{"l":"Total Autonomous Vehicle","v":"8.860","t":"+16.7%","d":"up"},{"l":"Map Ativos","v":"7.176","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+7.7%","d":"up"}];
const COLS = ["ID","Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Autonomous Vehicle #001","Autonomous Vehicle #002","1.400","3.830","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Autonomous Vehicle #002","Autonomous Vehicle #003","5.335","3.899","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Autonomous Vehicle #003","Autonomous Vehicle #004","5.351","6.447","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Autonomous Vehicle #004","Autonomous Vehicle #005","4.080","8.014","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Autonomous Vehicle #005","Autonomous Vehicle #001","3.804","1.712","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":779},{"label":"Mar","value":712},{"label":"Abr","value":703},{"label":"Mai","value":705},{"label":"Jun","value":520},{"label":"Jul","value":701},{"label":"Ago","value":592},{"label":"Set","value":613},{"label":"Out","value":507},{"label":"Nov","value":586},{"label":"Dez","value":441}];
const MX = 779;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#bae6fd'}}>AI</span></h1>
                </div>
