...
const ACCENT = "#bae6fd";
const MODULE = "Autonomous Vehicle";
const PAGE = "Telemetry";
const KPIS = [{"l":"Total Autonomous Vehicle","v":"4.274","t":"+14.4%","d":"up"},{"l":"Telemetry Ativos","v":"4.030","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.7%","d":"up"}];
const COLS = ["ID","Telemetry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Autonomous Vehicle #001","Autonomous Vehicle #002","9.098","5.153","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Autonomous Vehicle #002","Autonomous Vehicle #003","5.545","4.831","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Autonomous Vehicle #003","Autonomous Vehicle #004","270","2.324","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Autonomous Vehicle #004","Autonomous Vehicle #005","6.605","2.023","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Autonomous Vehicle #005","Autonomous Vehicle #001","1.840","3.587","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":832},{"label":"Mar","value":733},{"label":"Abr","value":616},{"label":"Mai","value":741},{"label":"Jun","value":559},{"label":"Jul","value":544},{"label":"Ago","value":628},{"label":"Set","value":590},{"label":"Out","value":773},{"label":"Nov","value":861},{"label":"Dez","value":601}];
const MX = 861;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#bae6fd'}}>RTM</span></h1>
                </div>
