...
const PAGE = "Unwind";
const KPIS = [{"l":"Total Tissue Convert","v":"8.961","t":"+0.4%","d":"up"},{"l":"Unwind Ativos","v":"4.765","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"81","t":"+17.1%","d":"up"}];
const COLS = ["ID","Unwind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tissue Convert #001","Tissue Convert #002","3.207","202","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Tissue Convert #002","Tissue Convert #003","8.740","8.703","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Tissue Convert #003","Tissue Convert #004","3.716","2.232","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Tissue Convert #004","Tissue Convert #005","777","7.554","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tissue Convert #005","Tissue Convert #001","7.610","2.246","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":289},{"label":"Mar","value":529},{"label":"Abr","value":394},{"label":"Mai","value":553},{"label":"Jun","value":249},{"label":"Jul","value":273},{"label":"Ago","value":300},{"label":"Set","value":539},{"label":"Out","value":557},{"label":"Nov","value":468},{"label":"Dez","value":364}];
const MX = 557;
