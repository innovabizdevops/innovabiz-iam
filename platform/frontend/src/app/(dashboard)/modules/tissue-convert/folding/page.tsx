...
const PAGE = "Folding";
const KPIS = [{"l":"Total Tissue Convert","v":"6.405","t":"+1.1%","d":"up"},{"l":"Folding Ativos","v":"3.949","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"75","t":"-2.2%","d":"down"}];
const COLS = ["ID","Folding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tissue Convert #001","Tissue Convert #002","4.367","5.896","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Tissue Convert #002","Tissue Convert #003","5.432","2.899","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Tissue Convert #003","Tissue Convert #004","8.198","8.779","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Tissue Convert #004","Tissue Convert #005","7.522","2.733","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tissue Convert #005","Tissue Convert #001","654","3.056","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":539},{"label":"Mar","value":413},{"label":"Abr","value":513},{"label":"Mai","value":268},{"label":"Jun","value":428},{"label":"Jul","value":373},{"label":"Ago","value":257},{"label":"Set","value":281},{"label":"Out","value":343},{"label":"Nov","value":501},{"label":"Dez","value":352}];
const MX = 539;
