...
const PAGE = "Wrapping";
const KPIS = [{"l":"Total Tissue Convert","v":"1.147","t":"-5.4%","d":"down"},{"l":"Wrapping Ativos","v":"2.905","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"68.9%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"75","t":"+7.5%","d":"up"}];
const COLS = ["ID","Wrapping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tissue Convert #001","Tissue Convert #002","3.247","3.848","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Tissue Convert #002","Tissue Convert #003","8.530","8.225","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Tissue Convert #003","Tissue Convert #004","1.431","181","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Tissue Convert #004","Tissue Convert #005","910","6.458","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tissue Convert #005","Tissue Convert #001","3.769","8.552","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1051},{"label":"Fev","value":772},{"label":"Mar","value":705},{"label":"Abr","value":674},{"label":"Mai","value":1051},{"label":"Jun","value":750},{"label":"Jul","value":721},{"label":"Ago","value":771},{"label":"Set","value":735},{"label":"Out","value":865},{"label":"Nov","value":687},{"label":"Dez","value":1030}];
const MX = 1051;
