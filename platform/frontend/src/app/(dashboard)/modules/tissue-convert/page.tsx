...
export default function TissueConvertPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Tissue Convert</h1><p className="text-sm text-muted-foreground">Tissue Convert • iBOS Enterprise</p></div>
