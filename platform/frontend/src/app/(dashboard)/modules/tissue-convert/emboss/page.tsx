...
const ACCENT = "#7c3aed";
const MODULE = "Tissue Converting";
const PAGE = "Embossing";
const KPIS = [{"l":"Total Tissue Convert","v":"5.812","t":"+-0.0%","d":"up"},{"l":"Embossing Ativos","v":"6.806","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"62","t":"-4.8%","d":"down"}];
const COLS = ["ID","Embossing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tissue Convert #001","Tissue Convert #002","4.473","7.978","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Tissue Convert #002","Tissue Convert #003","5.251","342","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Tissue Convert #003","Tissue Convert #004","3.710","3.891","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Tissue Convert #004","Tissue Convert #005","1.050","5.756","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tissue Convert #005","Tissue Convert #001","2.608","6.014","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":866},{"label":"Mar","value":949},{"label":"Abr","value":832},{"label":"Mai","value":851},{"label":"Jun","value":992},{"label":"Jul","value":675},{"label":"Ago","value":708},{"label":"Set","value":696},{"label":"Out","value":741},{"label":"Nov","value":943},{"label":"Dez","value":1011}];
const MX = 1011;
