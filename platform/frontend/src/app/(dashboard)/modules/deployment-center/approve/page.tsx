...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.425","t":"+2.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.6%","t":"-4.9%","d":"down"},{"l":"Tempo Médio (h)","v":"51h","t":"-3.8%","d":"down"},{"l":"Rejeitadas (%)","v":"89.6%","t":"+16.2%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.412","€ 27516.01","2.582","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","2.937","€ 26508.87","6.774","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.777","€ 49681.43","5.379","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.986","€ 22112.21","3.967","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.294","€ 19218.73","920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":544},{"label":"Mar","value":429},{"label":"Abr","value":487},{"label":"Mai","value":347},{"label":"Jun","value":403},{"label":"Jul","value":636},{"label":"Ago","value":697},{"label":"Set","value":683},{"label":"Out","value":645},{"label":"Nov","value":636},{"label":"Dez","value":455}];
const MX = 697;
