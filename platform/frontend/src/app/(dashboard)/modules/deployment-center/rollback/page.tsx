...
const ACCENT = "#059669";
const MODULE = "Deployment Center";
const PAGE = "Rollback";
const KPIS = [{"l":"Total Deployment Center","v":"7.980","t":"+10.8%","d":"up"},{"l":"Rollback Ativos","v":"3.393","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"81.3%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"70","t":"+13.7%","d":"up"}];
const COLS = ["ID","Rollback","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deployment Center #001","Deployment Center #002","3.298","7.907","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Deployment Center #002","Deployment Center #003","1.586","241","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Deployment Center #003","Deployment Center #004","4.217","816","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Deployment Center #004","Deployment Center #005","8.493","4.584","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deployment Center #005","Deployment Center #001","1.390","2.953","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":741},{"label":"Mar","value":658},{"label":"Abr","value":401},{"label":"Mai","value":448},{"label":"Jun","value":467},{"label":"Jul","value":560},{"label":"Ago","value":562},{"label":"Set","value":659},{"label":"Out","value":449},{"label":"Nov","value":553},{"label":"Dez","value":380}];
const MX = 741;
