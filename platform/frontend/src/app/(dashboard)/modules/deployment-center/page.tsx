...
const KPIS = [
    { label: "Total Registos", value: "3400", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1849", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€232K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1266114300", cells: ["DEP-4300", "Deployment Center Item 1", "25/1/2026", "€14 400"], status: "active" as const },
    { id: "1266117871", cells: ["DEP-7871", "Deployment Center Item 2", "12/8/2026", "€17 971"], status: "pending" as const },
    { id: "1266121442", cells: ["DEP-2442", "Deployment Center Item 3", "27/3/2026", "€21 542"], status: "completed" as const },
    { id: "1266125013", cells: ["DEP-6013", "Deployment Center Item 4", "14/10/2026", "€25 113"], status: "warning" as const },
    { id: "1266128584", cells: ["DEP-9584", "Deployment Center Item 5", "1/5/2026", "€28 684"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Deployment Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Deployment Center</p>
                    </div>
                </div>
