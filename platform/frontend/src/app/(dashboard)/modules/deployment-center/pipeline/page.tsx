...
const PAGE = "Pipeline";
const KPIS = [{"l":"Total Deployment Center","v":"6.130","t":"+11.8%","d":"up"},{"l":"Pipeline Ativos","v":"787","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"82.9%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+3.9%","d":"up"}];
const COLS = ["ID","Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deployment Center #001","Deployment Center #002","3.007","3.260","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Deployment Center #002","Deployment Center #003","2.184","6.778","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Deployment Center #003","Deployment Center #004","1.220","5.882","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Deployment Center #004","Deployment Center #005","1.508","4.913","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deployment Center #005","Deployment Center #001","1.847","620","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":827},{"label":"Mar","value":679},{"label":"Abr","value":617},{"label":"Mai","value":601},{"label":"Jun","value":857},{"label":"Jul","value":582},{"label":"Ago","value":734},{"label":"Set","value":555},{"label":"Out","value":636},{"label":"Nov","value":624},{"label":"Dez","value":765}];
const MX = 857;
