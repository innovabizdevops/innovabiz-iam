...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Deployment Center","v":"487","t":"-2.4%","d":"down"},{"l":"Deploy Ativos","v":"711","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+11.3%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deployment Center #001","Deployment Center #002","2.197","5.626","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Deployment Center #002","Deployment Center #003","8.602","4.575","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Deployment Center #003","Deployment Center #004","4.460","2.773","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Deployment Center #004","Deployment Center #005","1.044","353","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deployment Center #005","Deployment Center #001","2.030","8.280","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":749},{"label":"Mar","value":573},{"label":"Abr","value":921},{"label":"Mai","value":889},{"label":"Jun","value":702},{"label":"Jul","value":606},{"label":"Ago","value":754},{"label":"Set","value":552},{"label":"Out","value":863},{"label":"Nov","value":867},{"label":"Dez","value":721}];
const MX = 921;
