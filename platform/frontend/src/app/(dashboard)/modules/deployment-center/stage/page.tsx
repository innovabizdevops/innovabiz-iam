...
const PAGE = "Stage";
const KPIS = [{"l":"Total Deployment Center","v":"8.732","t":"+14.4%","d":"up"},{"l":"Stage Ativos","v":"9.036","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"58","t":"+8.2%","d":"up"}];
const COLS = ["ID","Stage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deployment Center #001","Deployment Center #002","2.376","8.372","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Deployment Center #002","Deployment Center #003","6.097","923","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Deployment Center #003","Deployment Center #004","1.527","461","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Deployment Center #004","Deployment Center #005","5.554","3.209","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deployment Center #005","Deployment Center #001","7.656","7.827","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":598},{"label":"Mar","value":713},{"label":"Abr","value":378},{"label":"Mai","value":351},{"label":"Jun","value":466},{"label":"Jul","value":492},{"label":"Ago","value":599},{"label":"Set","value":581},{"label":"Out","value":357},{"label":"Nov","value":622},{"label":"Dez","value":500}];
const MX = 713;
