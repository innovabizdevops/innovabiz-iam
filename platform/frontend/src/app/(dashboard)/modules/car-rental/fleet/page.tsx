...
const PAGE = "Fleet Inventory";
const KPIS = [{"l":"Total Car Rental","v":"5.205","t":"+14.1%","d":"up"},{"l":"Fleet Inventory Ativos","v":"2.095","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"81","t":"-5.9%","d":"down"}];
const COLS = ["ID","Fleet Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Car Rental #001","Car Rental #002","6.749","7.599","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Car Rental #002","Car Rental #003","3.828","5.623","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Car Rental #003","Car Rental #004","2.212","9.038","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Car Rental #004","Car Rental #005","8.535","7.557","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Car Rental #005","Car Rental #001","8.104","532","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":595},{"label":"Mar","value":736},{"label":"Abr","value":507},{"label":"Mai","value":550},{"label":"Jun","value":406},{"label":"Jul","value":460},{"label":"Ago","value":447},{"label":"Set","value":466},{"label":"Out","value":735},{"label":"Nov","value":714},{"label":"Dez","value":517}];
const MX = 736;
