...
const ACCENT = "#b45309";
const MODULE = "Car Rental";
const PAGE = "GPS Track";
const KPIS = [{"l":"Total Car Rental","v":"5.747","t":"+0.1%","d":"up"},{"l":"GPS Track Ativos","v":"4.851","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"81","t":"-2.3%","d":"down"}];
const COLS = ["ID","GPS Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Car Rental #001","Car Rental #002","8.827","1.777","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Car Rental #002","Car Rental #003","5.633","3.365","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Car Rental #003","Car Rental #004","251","6.738","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Car Rental #004","Car Rental #005","3.563","7.086","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Car Rental #005","Car Rental #001","1.865","7.723","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":305},{"label":"Fev","value":605},{"label":"Mar","value":490},{"label":"Abr","value":464},{"label":"Mai","value":653},{"label":"Jun","value":553},{"label":"Jul","value":390},{"label":"Ago","value":635},{"label":"Set","value":257},{"label":"Out","value":368},{"label":"Nov","value":570},{"label":"Dez","value":592}];
const MX = 653;
