...
const KPIS = [{"l":"Total Car Rental","v":"8.263","t":"-5.1%","d":"down"},{"l":"Damage Report Ativos","v":"4.410","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"67","t":"-4.2%","d":"down"}];
const COLS = ["ID","Damage Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Car Rental #001","Car Rental #002","5.527","5.022","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Car Rental #002","Car Rental #003","5.769","4.368","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Car Rental #003","Car Rental #004","3.061","4.548","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Car Rental #004","Car Rental #005","3.981","1.563","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Car Rental #005","Car Rental #001","6.791","2.599","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":693},{"label":"Mar","value":731},{"label":"Abr","value":784},{"label":"Mai","value":795},{"label":"Jun","value":821},{"label":"Jul","value":775},{"label":"Ago","value":829},{"label":"Set","value":712},{"label":"Out","value":816},{"label":"Nov","value":867},{"label":"Dez","value":598}];
const MX = 867;
