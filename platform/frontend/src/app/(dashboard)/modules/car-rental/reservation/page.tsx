...
const KPIS = [{"l":"Quartos Ocupados","v":"3.466","t":"-4.9%","d":"down"},{"l":"RevPAR (€)","v":"€42888","t":"-1.2%","d":"down"},{"l":"Ocupação (%)","v":"70.5%","t":"+11.3%","d":"up"},{"l":"Guest Satisfaction","v":"3.793","t":"+9.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.411","2026-02-25","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.251","2026-02-12","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.094","2026-02-06","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.761","2026-02-01","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.070","2026-01-17","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":869},{"label":"Mar","value":762},{"label":"Abr","value":709},{"label":"Mai","value":877},{"label":"Jun","value":497},{"label":"Jul","value":777},{"label":"Ago","value":530},{"label":"Set","value":780},{"label":"Out","value":554},{"label":"Nov","value":535},{"label":"Dez","value":628}];
const MX = 877;
