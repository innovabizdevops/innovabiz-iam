...
const ACCENT = "#6366f1";
const MODULE = "Process Safety Mgmt";
const PAGE = "Emergency";
const KPIS = [{"l":"Total Process Safety","v":"2.979","t":"-2.4%","d":"down"},{"l":"Emergency Ativos","v":"5.949","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"63","t":"+1.8%","d":"up"}];
const COLS = ["ID","Emergency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Safety #001","Process Safety #002","1.748","4.400","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Process Safety #002","Process Safety #003","6.863","8.034","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Safety #003","Process Safety #004","4.498","7.483","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Process Safety #004","Process Safety #005","7.606","2.019","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Safety #005","Process Safety #001","1.254","6.596","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":442},{"label":"Mar","value":621},{"label":"Abr","value":452},{"label":"Mai","value":564},{"label":"Jun","value":380},{"label":"Jul","value":422},{"label":"Ago","value":645},{"label":"Set","value":597},{"label":"Out","value":333},{"label":"Nov","value":524},{"label":"Dez","value":413}];
const MX = 670;
