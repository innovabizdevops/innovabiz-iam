...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"7.273","t":"+10.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.8%","t":"-5.0%","d":"down"},{"l":"MTTR (h)","v":"48h","t":"+14.8%","d":"up"},{"l":"Satisfação (%)","v":"77.1%","t":"+8.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","798","7.589","6.143","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.254","9.091","8.537","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.890","7.081","5.222","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.576","8.662","6.551","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","159","8.156","5.936","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":639},{"label":"Mar","value":534},{"label":"Abr","value":743},{"label":"Mai","value":410},{"label":"Jun","value":656},{"label":"Jul","value":516},{"label":"Ago","value":592},{"label":"Set","value":585},{"label":"Out","value":558},{"label":"Nov","value":534},{"label":"Dez","value":686}];
const MX = 743;
