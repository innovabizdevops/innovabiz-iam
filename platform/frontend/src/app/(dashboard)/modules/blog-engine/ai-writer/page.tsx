...
const ACCENT = "#059669";
const MODULE = "Blog Engine";
const PAGE = "AI Writer";
const KPIS = [{"l":"Total Blog Engine","v":"6.765","t":"+14.5%","d":"up"},{"l":"AI Writer Ativos","v":"2.955","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"84.7%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"70","t":"-1.7%","d":"down"}];
const COLS = ["ID","AI Writer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blog Engine #001","Blog Engine #002","5.185","6.649","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Blog Engine #002","Blog Engine #003","8.933","5.973","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Blog Engine #003","Blog Engine #004","7.271","7.659","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Blog Engine #004","Blog Engine #005","6.423","603","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blog Engine #005","Blog Engine #001","1.100","6.836","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":812},{"label":"Mar","value":604},{"label":"Abr","value":711},{"label":"Mai","value":807},{"label":"Jun","value":663},{"label":"Jul","value":803},{"label":"Ago","value":621},{"label":"Set","value":730},{"label":"Out","value":619},{"label":"Nov","value":584},{"label":"Dez","value":651}];
const MX = 812;
