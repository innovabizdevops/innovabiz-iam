...
const KPIS = [{"l":"Total Email Security","v":"7.555","t":"+4.8%","d":"up"},{"l":"Investigate Ativos","v":"5.971","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"90","t":"+7.0%","d":"up"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Email Security #001","Email Security #002","2.401","1.900","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Email Security #002","Email Security #003","5.198","5.121","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Email Security #003","Email Security #004","5.156","7.453","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Email Security #004","Email Security #005","5.008","5.463","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Email Security #005","Email Security #001","3.243","8.860","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":587},{"label":"Mar","value":360},{"label":"Abr","value":438},{"label":"Mai","value":469},{"label":"Jun","value":468},{"label":"Jul","value":332},{"label":"Ago","value":352},{"label":"Set","value":408},{"label":"Out","value":544},{"label":"Nov","value":407},{"label":"Dez","value":537}];
const MX = 587;
