...
/* ═══ Email Security Platform — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "7580", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4837", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "493225480", cells: ["EMA-8480", "Email Security Platform Item 1", "21/5/2026", "€25 580"], status: "active" as const },
    { id: "493229051", cells: ["EMA-3051", "Email Security Platform Item 2", "8/12/2026", "€29 151"], status: "pending" as const },
    { id: "493232622", cells: ["EMA-6622", "Email Security Platform Item 3", "23/7/2026", "€32 722"], status: "completed" as const },
    { id: "493236193", cells: ["EMA-1193", "Email Security Platform Item 4", "10/2/2026", "€36 293"], status: "warning" as const },
    { id: "493239764", cells: ["EMA-4764", "Email Security Platform Item 5", "25/9/2026", "€39 864"], status: "active" as const },
];
...
export default function EmailSecurityPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Email Security Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Email Security Platform</p>
                    </div>
                </div>
