...
const KPIS = [{"l":"eNPS","v":"62","t":"+17.5%","d":"up"},{"l":"Engagement (%)","v":"72.9%","t":"+0.4%","d":"up"},{"l":"Turnover (%)","v":"71.6%","t":"-1.8%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"4.557","t":"+9.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.528","2026-01-16","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.734","2026-03-27","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.483","2026-01-02","94","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.113","2026-01-28","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.845","2026-01-03","93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":803},{"label":"Mar","value":746},{"label":"Abr","value":861},{"label":"Mai","value":814},{"label":"Jun","value":867},{"label":"Jul","value":903},{"label":"Ago","value":769},{"label":"Set","value":1069},{"label":"Out","value":1080},{"label":"Nov","value":916},{"label":"Dez","value":1073}];
const MX = 1080;
