...
const KPIS = [{"l":"Total Aviation","v":"2.054","t":"+11.6%","d":"up"},{"l":"Parts Inventory Ativos","v":"4.471","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"68","t":"+17.0%","d":"up"}];
const COLS = ["ID","Parts Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation #001","Aviation #002","763","4.653","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation #002","Aviation #003","5.224","3.949","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation #003","Aviation #004","1.890","3.937","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation #004","Aviation #005","1.775","5.777","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation #005","Aviation #001","4.316","5.782","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":905},{"label":"Mar","value":733},{"label":"Abr","value":817},{"label":"Mai","value":947},{"label":"Jun","value":996},{"label":"Jul","value":1036},{"label":"Ago","value":1025},{"label":"Set","value":1036},{"label":"Out","value":858},{"label":"Nov","value":719},{"label":"Dez","value":910}];
const MX = 1036;
