...
const PAGE = "Flight Operations";
const KPIS = [{"l":"Total Aviation","v":"5.208","t":"+2.5%","d":"up"},{"l":"Flight Operations Ativos","v":"4.271","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"71","t":"-4.9%","d":"down"}];
const COLS = ["ID","Flight Operations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation #001","Aviation #002","6.373","2.300","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation #002","Aviation #003","4.004","1.189","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation #003","Aviation #004","7.467","3.529","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation #004","Aviation #005","5.003","7.406","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation #005","Aviation #001","5.907","5.676","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":739},{"label":"Mar","value":422},{"label":"Abr","value":678},{"label":"Mai","value":658},{"label":"Jun","value":712},{"label":"Jul","value":621},{"label":"Ago","value":421},{"label":"Set","value":490},{"label":"Out","value":478},{"label":"Nov","value":464},{"label":"Dez","value":556}];
const MX = 739;
