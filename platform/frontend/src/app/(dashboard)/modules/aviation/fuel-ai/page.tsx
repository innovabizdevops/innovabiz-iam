...
const ACCENT = "#4338ca";
const MODULE = "Aviation & Aerospace";
const PAGE = "Fuel Optimization";
const KPIS = [{"l":"Total Aviation","v":"1.895","t":"+7.3%","d":"up"},{"l":"Fuel Optimization Ativos","v":"1.063","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"58","t":"+15.9%","d":"up"}];
const COLS = ["ID","Fuel Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation #001","Aviation #002","2.239","4.293","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation #002","Aviation #003","3.720","7.621","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation #003","Aviation #004","8.406","4.306","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation #004","Aviation #005","962","4.016","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation #005","Aviation #001","891","352","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":527},{"label":"Mar","value":791},{"label":"Abr","value":745},{"label":"Mai","value":565},{"label":"Jun","value":785},{"label":"Jul","value":722},{"label":"Ago","value":492},{"label":"Set","value":604},{"label":"Out","value":853},{"label":"Nov","value":782},{"label":"Dez","value":863}];
const MX = 863;
...
export default function FuelAiPage() {
    return (
