...
const PAGE = "Passenger Experience";
const KPIS = [{"l":"Perfis Unificados","v":"7.385","t":"+2.3%","d":"up"},{"l":"Segmentos Ativos","v":"3.494","t":"+1.0%","d":"up"},{"l":"NPS Score","v":"88","t":"+15.1%","d":"up"},{"l":"Churn Previsto (%)","v":"75.8%","t":"-5.3%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.213","€ 37676.88","99.5%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","4.005","€ 15817.73","83.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","7.611","€ 41070.26","74.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.127","€ 7014.48","95.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.016","€ 1233.70","97.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":649},{"label":"Mar","value":421},{"label":"Abr","value":493},{"label":"Mai","value":470},{"label":"Jun","value":554},{"label":"Jul","value":319},{"label":"Ago","value":575},{"label":"Set","value":539},{"label":"Out","value":629},{"label":"Nov","value":511},{"label":"Dez","value":649}];
const MX = 649;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>CX</span></h1>
                </div>
