...
const KPIS = [{"l":"ARR (€M)","v":"€24.0M","t":"-5.2%","d":"down"},{"l":"MRR (€)","v":"€65481","t":"+18.0%","d":"up"},{"l":"Churn (%)","v":"76.1%","t":"+7.1%","d":"up"},{"l":"ARPU (€)","v":"€90819","t":"-4.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28236.98","5.548","€ 40824.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24968.48","1.303","€ 44259.61","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28282.54","4.639","€ 25774.34","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 23770.24","2.186","€ 34460.16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 36279.97","6.746","€ 21684.69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":332},{"label":"Mar","value":243},{"label":"Abr","value":590},{"label":"Mai","value":569},{"label":"Jun","value":444},{"label":"Jul","value":568},{"label":"Ago","value":530},{"label":"Set","value":265},{"label":"Out","value":281},{"label":"Nov","value":522},{"label":"Dez","value":357}];
const MX = 590;
