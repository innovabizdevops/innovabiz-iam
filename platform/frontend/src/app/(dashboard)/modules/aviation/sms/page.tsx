...
const PAGE = "Safety (SMS)";
const KPIS = [{"l":"Total Aviation","v":"437","t":"+5.5%","d":"up"},{"l":"Safety (SMS) Ativos","v":"6.046","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"87.3%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.4%","d":"up"}];
const COLS = ["ID","Safety (SMS)","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation #001","Aviation #002","6.365","796","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation #002","Aviation #003","8.306","1.184","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation #003","Aviation #004","4.503","3.388","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation #004","Aviation #005","8.862","8.275","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation #005","Aviation #001","7.930","8.761","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":636},{"label":"Mar","value":681},{"label":"Abr","value":539},{"label":"Mai","value":585},{"label":"Jun","value":709},{"label":"Jul","value":778},{"label":"Ago","value":770},{"label":"Set","value":534},{"label":"Out","value":588},{"label":"Nov","value":603},{"label":"Dez","value":713}];
const MX = 778;
