...
const KPIS = [{"l":"Total Aviation","v":"3.522","t":"-5.0%","d":"down"},{"l":"MRO (Maintenance) Ativos","v":"7.624","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"67.2%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"83","t":"+5.7%","d":"up"}];
const COLS = ["ID","MRO (Maintenance)","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation #001","Aviation #002","2.122","7.652","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation #002","Aviation #003","862","6.452","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation #003","Aviation #004","4.030","2.790","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation #004","Aviation #005","7.656","8.672","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation #005","Aviation #001","1.148","8.347","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":473},{"label":"Mar","value":485},{"label":"Abr","value":566},{"label":"Mai","value":492},{"label":"Jun","value":443},{"label":"Jul","value":389},{"label":"Ago","value":559},{"label":"Set","value":534},{"label":"Out","value":239},{"label":"Nov","value":458},{"label":"Dez","value":280}];
const MX = 566;
