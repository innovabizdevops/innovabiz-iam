...
export default function OrbitalServicePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Orbital Service</h1><p className="text-sm text-muted-foreground">Orbital Service • iBOS Enterprise</p></div>
