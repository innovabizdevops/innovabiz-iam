...
const PAGE = "Refuel";
const KPIS = [{"l":"Total Orbital Service","v":"6.478","t":"+1.5%","d":"up"},{"l":"Refuel Ativos","v":"3.379","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.4%","d":"down"}];
const COLS = ["ID","Refuel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Orbital Service #001","Orbital Service #002","7.755","1.505","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Orbital Service #002","Orbital Service #003","2.889","6.837","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Orbital Service #003","Orbital Service #004","829","7.613","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Orbital Service #004","Orbital Service #005","4.291","1.866","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Orbital Service #005","Orbital Service #001","2.697","5.420","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":502},{"label":"Mar","value":595},{"label":"Abr","value":486},{"label":"Mai","value":759},{"label":"Jun","value":684},{"label":"Jul","value":545},{"label":"Ago","value":728},{"label":"Set","value":863},{"label":"Out","value":706},{"label":"Nov","value":713},{"label":"Dez","value":825}];
const MX = 863;
