...
const PAGE = "Relocate";
const KPIS = [{"l":"Total Orbital Service","v":"7.519","t":"+1.9%","d":"up"},{"l":"Relocate Ativos","v":"7.138","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"67.4%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"58","t":"-2.4%","d":"down"}];
const COLS = ["ID","Relocate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Orbital Service #001","Orbital Service #002","6.461","7.156","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Orbital Service #002","Orbital Service #003","4.685","3.233","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Orbital Service #003","Orbital Service #004","750","1.641","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Orbital Service #004","Orbital Service #005","2.426","655","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Orbital Service #005","Orbital Service #001","7.071","2.345","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":384},{"label":"Mar","value":507},{"label":"Abr","value":456},{"label":"Mai","value":317},{"label":"Jun","value":668},{"label":"Jul","value":560},{"label":"Ago","value":286},{"label":"Set","value":623},{"label":"Out","value":493},{"label":"Nov","value":459},{"label":"Dez","value":323}];
const MX = 668;
