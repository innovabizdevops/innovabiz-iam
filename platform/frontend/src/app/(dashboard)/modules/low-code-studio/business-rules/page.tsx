...
const PAGE = "Business Rules Engine";
const KPIS = [{"l":"Total Low Code Studio","v":"7.640","t":"-1.5%","d":"down"},{"l":"Business Rules Engine Ativos","v":"6.306","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"60","t":"+11.8%","d":"up"}];
const COLS = ["ID","Business Rules Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code Studio #001","Low Code Studio #002","3.043","1.586","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code Studio #002","Low Code Studio #003","7.661","5.476","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code Studio #003","Low Code Studio #004","3.008","4.436","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code Studio #004","Low Code Studio #005","5.300","7.489","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code Studio #005","Low Code Studio #001","4.425","7.917","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":282},{"label":"Fev","value":356},{"label":"Mar","value":622},{"label":"Abr","value":526},{"label":"Mai","value":399},{"label":"Jun","value":554},{"label":"Jul","value":392},{"label":"Ago","value":270},{"label":"Set","value":379},{"label":"Out","value":419},{"label":"Nov","value":556},{"label":"Dez","value":587}];
const MX = 622;
