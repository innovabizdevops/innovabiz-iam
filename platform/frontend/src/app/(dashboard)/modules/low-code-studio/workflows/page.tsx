...
const ACCENT = "#6366f1";
const MODULE = "Low Code Studio";
const PAGE = "Workflow Automation";
const KPIS = [{"l":"Total Low Code Studio","v":"3.717","t":"+8.2%","d":"up"},{"l":"Workflow Automation Ativos","v":"1.983","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"68","t":"+12.4%","d":"up"}];
const COLS = ["ID","Workflow Automation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code Studio #001","Low Code Studio #002","2.342","1.985","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code Studio #002","Low Code Studio #003","4.973","4.975","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code Studio #003","Low Code Studio #004","213","5.365","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code Studio #004","Low Code Studio #005","6.909","1.553","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code Studio #005","Low Code Studio #001","4.640","1.920","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":354},{"label":"Mar","value":531},{"label":"Abr","value":672},{"label":"Mai","value":547},{"label":"Jun","value":491},{"label":"Jul","value":470},{"label":"Ago","value":497},{"label":"Set","value":538},{"label":"Out","value":572},{"label":"Nov","value":642},{"label":"Dez","value":718}];
const MX = 718;
