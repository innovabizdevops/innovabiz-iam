...
const PAGE = "Data Model Designer";
const KPIS = [{"l":"Formulários Ativos","v":"4.410","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"815","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"2.813","t":"+8.8%","d":"up"},{"l":"Templates","v":"4.530","t":"+6.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.659","2026-02-12","4.089","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.661","2026-01-25","5.155","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.910","2026-02-24","1.686","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.224","2026-03-23","8.022","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.036","2026-02-05","2.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":859},{"label":"Mar","value":734},{"label":"Abr","value":725},{"label":"Mai","value":658},{"label":"Jun","value":583},{"label":"Jul","value":881},{"label":"Ago","value":834},{"label":"Set","value":886},{"label":"Out","value":586},{"label":"Nov","value":934},{"label":"Dez","value":885}];
const MX = 934;
