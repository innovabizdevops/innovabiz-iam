...
const PAGE = "API Composer";
const KPIS = [{"l":"Pedidos/Dia","v":"531","t":"+8.1%","d":"up"},{"l":"GMV (€)","v":"€34330","t":"+16.6%","d":"up"},{"l":"Conversão (%)","v":"87.1%","t":"+16.3%","d":"up"},{"l":"AOV (€)","v":"€99734","t":"-4.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 16784.70","6.170","1.337","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 36850.96","9.074","1.145","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 25802.72","5.187","5.220","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 27038.02","4.239","3.785","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 47817.51","6.626","3.005","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":433},{"label":"Mar","value":414},{"label":"Abr","value":654},{"label":"Mai","value":392},{"label":"Jun","value":463},{"label":"Jul","value":652},{"label":"Ago","value":488},{"label":"Set","value":573},{"label":"Out","value":536},{"label":"Nov","value":676},{"label":"Dez","value":493}];
const MX = 676;
...
export default function ApiComposerPage() {
    return (
