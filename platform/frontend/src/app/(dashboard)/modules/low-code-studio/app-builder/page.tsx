...
const KPIS = [{"l":"Total Low Code Studio","v":"6.838","t":"+4.2%","d":"up"},{"l":"App Builder Ativos","v":"2.820","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+10.5%","d":"up"}];
const COLS = ["ID","App Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code Studio #001","Low Code Studio #002","7.413","1.854","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code Studio #002","Low Code Studio #003","7.852","8.118","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code Studio #003","Low Code Studio #004","7.859","5.412","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code Studio #004","Low Code Studio #005","7.552","4.663","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code Studio #005","Low Code Studio #001","3.146","5.542","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":810},{"label":"Mar","value":965},{"label":"Abr","value":824},{"label":"Mai","value":1006},{"label":"Jun","value":895},{"label":"Jul","value":682},{"label":"Ago","value":999},{"label":"Set","value":947},{"label":"Out","value":728},{"label":"Nov","value":887},{"label":"Dez","value":935}];
const MX = 1006;
