...
const PAGE = "Form Designer";
const KPIS = [{"l":"Formulários Ativos","v":"8.198","t":"+4.4%","d":"up"},{"l":"Submissões/Dia","v":"756","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"8.042","t":"+11.9%","d":"up"},{"l":"Templates","v":"6.733","t":"+13.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.114","2026-02-14","4.158","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","650","2026-02-28","8.148","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.126","2026-03-06","2.132","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.616","2026-03-26","2.604","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.392","2026-01-05","5.918","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":577},{"label":"Mar","value":542},{"label":"Abr","value":724},{"label":"Mai","value":393},{"label":"Jun","value":383},{"label":"Jul","value":364},{"label":"Ago","value":731},{"label":"Set","value":593},{"label":"Out","value":407},{"label":"Nov","value":694},{"label":"Dez","value":407}];
const MX = 731;
