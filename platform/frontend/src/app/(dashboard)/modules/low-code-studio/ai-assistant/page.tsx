...
const PAGE = "AI Code Assistant";
const KPIS = [{"l":"Total Low Code Studio","v":"5.271","t":"+3.4%","d":"up"},{"l":"AI Code Assistant Ativos","v":"6.846","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"67","t":"+5.5%","d":"up"}];
const COLS = ["ID","AI Code Assistant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code Studio #001","Low Code Studio #002","2.507","3.573","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code Studio #002","Low Code Studio #003","4.270","5.867","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code Studio #003","Low Code Studio #004","3.879","3.085","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code Studio #004","Low Code Studio #005","2.050","1.214","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code Studio #005","Low Code Studio #001","1.365","6.467","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":722},{"label":"Mar","value":922},{"label":"Abr","value":848},{"label":"Mai","value":947},{"label":"Jun","value":763},{"label":"Jul","value":702},{"label":"Ago","value":864},{"label":"Set","value":722},{"label":"Out","value":582},{"label":"Nov","value":674},{"label":"Dez","value":929}];
const MX = 947;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>GenAI</span></h1>
                </div>
