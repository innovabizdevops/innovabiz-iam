...
export default function LowCodeStudioPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Low Code Studio</h1><p className="text-sm text-muted-foreground">Low Code Studio • iBOS Enterprise</p></div>
