...
const PAGE = "API Builder";
const KPIS = [{"l":"Integrações Ativas","v":"3.832","t":"-2.9%","d":"down"},{"l":"Chamadas/Hora","v":"957","t":"-1.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"78.9%","t":"+0.2%","d":"up"},{"l":"Latência Média (ms)","v":"185ms","t":"-5.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.941","4.689","94.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.566","3.283","98.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.484","7.620","77.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","423","5.556","81.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.294","7.382","82.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":657},{"label":"Mar","value":379},{"label":"Abr","value":439},{"label":"Mai","value":477},{"label":"Jun","value":381},{"label":"Jul","value":753},{"label":"Ago","value":643},{"label":"Set","value":522},{"label":"Out","value":535},{"label":"Nov","value":388},{"label":"Dez","value":512}];
const MX = 753;
