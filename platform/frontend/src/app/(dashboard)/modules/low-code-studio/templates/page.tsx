...
const PAGE = "App Templates";
const KPIS = [{"l":"Formulários Ativos","v":"1.297","t":"+10.6%","d":"up"},{"l":"Submissões/Dia","v":"1293","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"1.364","t":"+10.3%","d":"up"},{"l":"Templates","v":"1.079","t":"-4.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.756","2026-01-02","2.739","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.786","2026-03-20","1.645","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.838","2026-01-27","4.296","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.452","2026-03-08","7.406","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.702","2026-03-11","1.327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":608},{"label":"Mar","value":492},{"label":"Abr","value":588},{"label":"Mai","value":247},{"label":"Jun","value":280},{"label":"Jul","value":493},{"label":"Ago","value":480},{"label":"Set","value":471},{"label":"Out","value":326},{"label":"Nov","value":579},{"label":"Dez","value":379}];
const MX = 608;
