...
const KPIS = [{"l":"Dashboards Ativos","v":"4.297","t":"+11.9%","d":"up"},{"l":"Queries/Dia","v":"3889","t":"+13.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.387","t":"-5.1%","d":"down"},{"l":"Utilizadores Analytics","v":"6.246","t":"+8.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2744","2026-01-05","6.438","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4654","2026-03-10","7.675","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1576","2026-01-11","122","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2255","2026-02-21","3.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2279","2026-02-04","1.911","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":509},{"label":"Mar","value":241},{"label":"Abr","value":393},{"label":"Mai","value":476},{"label":"Jun","value":582},{"label":"Jul","value":446},{"label":"Ago","value":348},{"label":"Set","value":580},{"label":"Out","value":473},{"label":"Nov","value":464},{"label":"Dez","value":507}];
const MX = 582;
