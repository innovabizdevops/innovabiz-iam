...
const PAGE = "Leak";
const KPIS = [{"l":"Dashboards Ativos","v":"2.490","t":"+15.7%","d":"up"},{"l":"Queries/Dia","v":"1936","t":"+4.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.846","t":"+12.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.715","t":"+1.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2477","2026-03-05","5.275","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1079","2026-01-24","1.804","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2034","2026-03-27","6.044","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","502","2026-02-28","8.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3264","2026-03-10","5.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":1072},{"label":"Mar","value":702},{"label":"Abr","value":795},{"label":"Mai","value":1026},{"label":"Jun","value":717},{"label":"Jul","value":1057},{"label":"Ago","value":1064},{"label":"Set","value":902},{"label":"Out","value":770},{"label":"Nov","value":953},{"label":"Dez","value":957}];
const MX = 1072;
