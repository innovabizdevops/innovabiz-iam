...
const ACCENT = "#083344";
const MODULE = "Water Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.931","t":"-0.1%","d":"down"},{"l":"Queries/Dia","v":"465","t":"+10.8%","d":"up"},{"l":"Dados Processados (GB)","v":"2.950","t":"+16.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.601","t":"-5.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5045","2026-02-25","2.975","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3409","2026-02-12","2.445","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1262","2026-01-16","3.716","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3376","2026-02-10","2.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2122","2026-03-02","589","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":298},{"label":"Mar","value":324},{"label":"Abr","value":639},{"label":"Mai","value":454},{"label":"Jun","value":392},{"label":"Jul","value":491},{"label":"Ago","value":429},{"label":"Set","value":485},{"label":"Out","value":419},{"label":"Nov","value":337},{"label":"Dez","value":423}];
const MX = 639;
