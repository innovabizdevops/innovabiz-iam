...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€33.6M","t":"+10.1%","d":"up"},{"l":"MRR (€)","v":"€91387","t":"+1.0%","d":"up"},{"l":"Churn (%)","v":"74.9%","t":"+15.5%","d":"up"},{"l":"ARPU (€)","v":"€76155","t":"+13.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32209.08","5.184","€ 29428.39","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 21802.48","1.463","€ 42514.88","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1162.33","1.739","€ 14225.57","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5186.57","4.673","€ 19194.00","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1190.91","6.808","€ 36135.23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":916},{"label":"Mar","value":681},{"label":"Abr","value":943},{"label":"Mai","value":859},{"label":"Jun","value":600},{"label":"Jul","value":734},{"label":"Ago","value":778},{"label":"Set","value":900},{"label":"Out","value":947},{"label":"Nov","value":839},{"label":"Dez","value":572}];
const MX = 947;
