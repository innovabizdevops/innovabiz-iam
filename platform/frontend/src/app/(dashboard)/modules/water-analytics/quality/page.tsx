...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.575","t":"+15.3%","d":"up"},{"l":"NC Abertas","v":"2.371","t":"+9.0%","d":"up"},{"l":"Conformidade (%)","v":"77.5%","t":"+14.4%","d":"up"},{"l":"CAPAs Pendentes","v":"5.233","t":"+17.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.276","97.4%","5.846","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.458","73.9%","3.170","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.670","77.8%","6.257","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.162","80.0%","5.404","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.105","74.5%","4.142","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":790},{"label":"Mar","value":842},{"label":"Abr","value":994},{"label":"Mai","value":651},{"label":"Jun","value":887},{"label":"Jul","value":929},{"label":"Ago","value":944},{"label":"Set","value":773},{"label":"Out","value":796},{"label":"Nov","value":748},{"label":"Dez","value":801}];
const MX = 994;
