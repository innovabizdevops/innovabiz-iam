...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.313","t":"-5.2%","d":"down"},{"l":"NC Abertas","v":"139","t":"-3.1%","d":"down"},{"l":"Conformidade (%)","v":"67.4%","t":"+3.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.845","t":"+0.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.668","80.7%","1.951","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.028","70.2%","1.501","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.790","78.0%","2.661","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","655","91.3%","2.228","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.017","96.8%","4.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":414},{"label":"Mar","value":390},{"label":"Abr","value":671},{"label":"Mai","value":654},{"label":"Jun","value":369},{"label":"Jul","value":431},{"label":"Ago","value":496},{"label":"Set","value":609},{"label":"Out","value":462},{"label":"Nov","value":585},{"label":"Dez","value":420}];
const MX = 692;
