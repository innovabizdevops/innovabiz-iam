...
const ACCENT = "#6366f1";
const MODULE = "Food Processing";
const PAGE = "Processing";
const KPIS = [{"l":"Total Food Process","v":"1.126","t":"+0.5%","d":"up"},{"l":"Processing Ativos","v":"6.450","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"82","t":"+16.2%","d":"up"}];
const COLS = ["ID","Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Process #001","Food Process #002","8.958","8.896","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Food Process #002","Food Process #003","7.978","1.851","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Process #003","Food Process #004","6.675","6.930","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Food Process #004","Food Process #005","558","5.427","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Process #005","Food Process #001","7.368","6.286","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":674},{"label":"Mar","value":390},{"label":"Abr","value":456},{"label":"Mai","value":426},{"label":"Jun","value":497},{"label":"Jul","value":543},{"label":"Ago","value":679},{"label":"Set","value":624},{"label":"Out","value":394},{"label":"Nov","value":441},{"label":"Dez","value":502}];
const MX = 679;
