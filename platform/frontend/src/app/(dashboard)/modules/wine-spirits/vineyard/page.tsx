...
const PAGE = "Vineyard Mgmt";
const KPIS = [{"l":"Total Wine Spirits","v":"3.439","t":"+16.1%","d":"up"},{"l":"Vineyard Mgmt Ativos","v":"5.771","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"75.7%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"72","t":"+10.7%","d":"up"}];
const COLS = ["ID","Vineyard Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Spirits #001","Wine Spirits #002","972","8.968","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Spirits #002","Wine Spirits #003","6.844","2.774","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Spirits #003","Wine Spirits #004","1.953","6.315","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Spirits #004","Wine Spirits #005","5.397","5.455","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Spirits #005","Wine Spirits #001","3.794","6.598","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":957},{"label":"Mar","value":751},{"label":"Abr","value":856},{"label":"Mai","value":895},{"label":"Jun","value":882},{"label":"Jul","value":1063},{"label":"Ago","value":671},{"label":"Set","value":801},{"label":"Out","value":830},{"label":"Nov","value":708},{"label":"Dez","value":867}];
const MX = 1063;
