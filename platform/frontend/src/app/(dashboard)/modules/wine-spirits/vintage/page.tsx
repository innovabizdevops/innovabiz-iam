...
const PAGE = "Vintage Tracking";
const KPIS = [{"l":"Total Wine Spirits","v":"1.657","t":"+11.6%","d":"up"},{"l":"Vintage Tracking Ativos","v":"711","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"86","t":"+1.4%","d":"up"}];
const COLS = ["ID","Vintage Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Spirits #001","Wine Spirits #002","7.692","5.010","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Spirits #002","Wine Spirits #003","6.061","7.675","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Spirits #003","Wine Spirits #004","7.059","1.243","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Spirits #004","Wine Spirits #005","9.010","571","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Spirits #005","Wine Spirits #001","544","6.088","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":450},{"label":"Mar","value":662},{"label":"Abr","value":738},{"label":"Mai","value":778},{"label":"Jun","value":583},{"label":"Jul","value":746},{"label":"Ago","value":639},{"label":"Set","value":738},{"label":"Out","value":587},{"label":"Nov","value":402},{"label":"Dez","value":442}];
const MX = 778;
