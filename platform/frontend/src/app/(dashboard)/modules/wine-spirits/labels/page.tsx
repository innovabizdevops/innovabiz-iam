...
const PAGE = "Label Designer";
const KPIS = [{"l":"Formulários Ativos","v":"5.839","t":"+2.6%","d":"up"},{"l":"Submissões/Dia","v":"3786","t":"+4.6%","d":"up"},{"l":"Documentos Gerados","v":"3.393","t":"+17.4%","d":"up"},{"l":"Templates","v":"492","t":"+3.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.430","2026-02-26","5.662","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.896","2026-02-24","3.012","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.334","2026-03-22","389","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.024","2026-02-19","7.718","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.441","2026-02-16","1.632","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1026},{"label":"Fev","value":1027},{"label":"Mar","value":749},{"label":"Abr","value":687},{"label":"Mai","value":942},{"label":"Jun","value":688},{"label":"Jul","value":979},{"label":"Ago","value":827},{"label":"Set","value":1054},{"label":"Out","value":927},{"label":"Nov","value":1036},{"label":"Dez","value":808}];
const MX = 1054;
