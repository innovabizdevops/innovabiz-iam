...
const ACCENT = "#7f1d1d";
const MODULE = "Wine & Spirits";
const PAGE = "Sommelier AI";
const KPIS = [{"l":"Total Wine Spirits","v":"5.955","t":"+15.7%","d":"up"},{"l":"Sommelier AI Ativos","v":"5.784","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"85","t":"-0.3%","d":"down"}];
const COLS = ["ID","Sommelier AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Spirits #001","Wine Spirits #002","3.672","1.933","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Spirits #002","Wine Spirits #003","9.043","3.916","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Spirits #003","Wine Spirits #004","2.750","3.461","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Spirits #004","Wine Spirits #005","4.629","4.273","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Spirits #005","Wine Spirits #001","320","1.281","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":506},{"label":"Mar","value":666},{"label":"Abr","value":604},{"label":"Mai","value":586},{"label":"Jun","value":651},{"label":"Jul","value":405},{"label":"Ago","value":682},{"label":"Set","value":541},{"label":"Out","value":371},{"label":"Nov","value":469},{"label":"Dez","value":376}];
const MX = 682;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7f1d1d'}}>AI</span></h1>
                </div>
