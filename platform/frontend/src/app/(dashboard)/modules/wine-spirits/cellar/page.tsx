...
const PAGE = "Cellar Inventory";
const KPIS = [{"l":"Total Wine Spirits","v":"486","t":"-0.7%","d":"down"},{"l":"Cellar Inventory Ativos","v":"3.378","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+13.1%","d":"up"}];
const COLS = ["ID","Cellar Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wine Spirits #001","Wine Spirits #002","7.669","6.713","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Wine Spirits #002","Wine Spirits #003","7.531","2.320","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Wine Spirits #003","Wine Spirits #004","7.905","3.966","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Wine Spirits #004","Wine Spirits #005","5.802","6.707","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wine Spirits #005","Wine Spirits #001","936","3.553","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":943},{"label":"Mar","value":572},{"label":"Abr","value":674},{"label":"Mai","value":582},{"label":"Jun","value":773},{"label":"Jul","value":576},{"label":"Ago","value":894},{"label":"Set","value":863},{"label":"Out","value":725},{"label":"Nov","value":637},{"label":"Dez","value":850}];
const MX = 943;
