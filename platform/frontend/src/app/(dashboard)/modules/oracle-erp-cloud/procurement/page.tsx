...
const KPIS = [{"l":"Fornecedores Ativos","v":"372","t":"+3.3%","d":"up"},{"l":"Contratos (€M)","v":"€36.0M","t":"+6.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"83.4%","t":"+11.0%","d":"up"},{"l":"Score Médio","v":"60","t":"-5.0%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","91.1%","€ 17736.73","4.901","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","76.5%","€ 43816.18","5.689","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","83.4%","€ 48497.62","743","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.2%","€ 7644.26","4.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","89.2%","€ 33872.82","3.157","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":503},{"label":"Mar","value":400},{"label":"Abr","value":608},{"label":"Mai","value":272},{"label":"Jun","value":568},{"label":"Jul","value":311},{"label":"Ago","value":396},{"label":"Set","value":406},{"label":"Out","value":237},{"label":"Nov","value":247},{"label":"Dez","value":378}];
const MX = 608;
