...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.647","t":"+5.1%","d":"up"},{"l":"Mitigações Ativas","v":"7.448","t":"+2.7%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"-2.1%","d":"down"},{"l":"Incidentes YTD","v":"6.859","t":"+10.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.643","4.295","5.813","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","878","7.664","8.032","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.655","4.115","2.053","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.772","209","4.680","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.169","8.781","8.771","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":574},{"label":"Mar","value":585},{"label":"Abr","value":499},{"label":"Mai","value":733},{"label":"Jun","value":673},{"label":"Jul","value":610},{"label":"Ago","value":568},{"label":"Set","value":734},{"label":"Out","value":657},{"label":"Nov","value":655},{"label":"Dez","value":627}];
const MX = 805;
