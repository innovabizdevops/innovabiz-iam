...
/* ═══ ERP Cloud (Oracle) — Dashboard ═══ */

const ACCENT = "#c74634";

const KPIS = [
    { label: "Total Registos", value: "8227", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2987", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€328K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "847557027", cells: ["ORA-1027", "ERP Cloud (Oracle) Item 1", "24/4/2026", "€7127"], status: "active" as const },
    { id: "847560598", cells: ["ORA-4598", "ERP Cloud (Oracle) Item 2", "11/11/2026", "€10 698"], status: "pending" as const },
    { id: "847564169", cells: ["ORA-8169", "ERP Cloud (Oracle) Item 3", "26/6/2026", "€14 269"], status: "completed" as const },
    { id: "847567740", cells: ["ORA-2740", "ERP Cloud (Oracle) Item 4", "13/1/2026", "€17 840"], status: "warning" as const },
    { id: "847571311", cells: ["ORA-6311", "ERP Cloud (Oracle) Item 5", "28/8/2026", "€21 411"], status: "active" as const },
];
...
export default function ErpCloudOraclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">ERP Cloud (Oracle)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • ERP Cloud (Oracle)</p>
                    </div>
                </div>
