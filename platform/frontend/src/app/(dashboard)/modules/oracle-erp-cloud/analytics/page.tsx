...
const ACCENT = "#c74634";
const MODULE = "ERP Cloud (Oracle)";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.853","t":"-2.0%","d":"down"},{"l":"Queries/Dia","v":"745","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.262","t":"+6.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.761","t":"+5.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1279","2026-03-12","318","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1306","2026-02-10","881","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","464","2026-03-17","6.816","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4407","2026-02-25","5.377","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","363","2026-01-01","967","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":785},{"label":"Mar","value":719},{"label":"Abr","value":919},{"label":"Mai","value":880},{"label":"Jun","value":859},{"label":"Jul","value":671},{"label":"Ago","value":673},{"label":"Set","value":847},{"label":"Out","value":777},{"label":"Nov","value":747},{"label":"Dez","value":660}];
const MX = 919;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c74634'}}>AI</span></h1>
                </div>
