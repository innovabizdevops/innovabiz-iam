...
const ACCENT = "#6366f1";
const MODULE = "Construction Schedule";
const PAGE = "Critical Path";
const KPIS = [{"l":"Total Construction Schedule","v":"2.624","t":"+2.8%","d":"up"},{"l":"Critical Path Ativos","v":"3.642","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"83","t":"+11.5%","d":"up"}];
const COLS = ["ID","Critical Path","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Schedule #001","Construction Schedule #002","7.339","2.637","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Schedule #002","Construction Schedule #003","6.694","1.349","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Schedule #003","Construction Schedule #004","5.463","2.341","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Schedule #004","Construction Schedule #005","5.684","8.123","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Schedule #005","Construction Schedule #001","8.344","8.030","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":667},{"label":"Mar","value":889},{"label":"Abr","value":854},{"label":"Mai","value":727},{"label":"Jun","value":888},{"label":"Jul","value":696},{"label":"Ago","value":936},{"label":"Set","value":593},{"label":"Out","value":963},{"label":"Nov","value":728},{"label":"Dez","value":944}];
const MX = 963;
