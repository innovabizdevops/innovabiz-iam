...
const ACCENT = "#854d0e";
const MODULE = "Luxury Packaging";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.568","t":"+14.9%","d":"up"},{"l":"Submissões/Dia","v":"1854","t":"+1.6%","d":"up"},{"l":"Documentos Gerados","v":"2.655","t":"-4.6%","d":"down"},{"l":"Templates","v":"2.356","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","967","2026-02-07","5.917","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.891","2026-02-08","1.817","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.561","2026-01-07","1.083","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.591","2026-03-02","6.395","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.007","2026-02-04","7.335","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":527},{"label":"Mar","value":507},{"label":"Abr","value":488},{"label":"Mai","value":645},{"label":"Jun","value":525},{"label":"Jul","value":486},{"label":"Ago","value":607},{"label":"Set","value":606},{"label":"Out","value":582},{"label":"Nov","value":626},{"label":"Dez","value":600}];
const MX = 687;
