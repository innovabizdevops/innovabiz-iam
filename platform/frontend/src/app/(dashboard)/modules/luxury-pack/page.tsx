...
/* ═══ Luxury Packaging — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "3616", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2497", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€184K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1359897216", cells: ["LUX-7216", "Luxury Packaging Item 1", "21/1/2026", "€47 316"], status: "active" as const },
    { id: "1359900787", cells: ["LUX-1787", "Luxury Packaging Item 2", "8/8/2026", "€887"], status: "pending" as const },
    { id: "1359904358", cells: ["LUX-5358", "Luxury Packaging Item 3", "23/3/2026", "€4458"], status: "completed" as const },
    { id: "1359907929", cells: ["LUX-8929", "Luxury Packaging Item 4", "10/10/2026", "€8029"], status: "warning" as const },
    { id: "1359911500", cells: ["LUX-3500", "Luxury Packaging Item 5", "25/5/2026", "€11 600"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Luxury Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Luxury Packaging</p>
                    </div>
                </div>
