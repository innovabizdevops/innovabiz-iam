...
const PAGE = "Treaty";
const KPIS = [{"l":"Total Arms Control","v":"7.588","t":"+15.8%","d":"up"},{"l":"Treaty Ativos","v":"8.261","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"67","t":"+6.2%","d":"up"}];
const COLS = ["ID","Treaty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arms Control #001","Arms Control #002","1.360","8.226","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Arms Control #002","Arms Control #003","6.626","8.328","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Arms Control #003","Arms Control #004","254","6.729","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Arms Control #004","Arms Control #005","6.352","5.462","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arms Control #005","Arms Control #001","5.965","6.773","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":437},{"label":"Mar","value":653},{"label":"Abr","value":627},{"label":"Mai","value":576},{"label":"Jun","value":622},{"label":"Jul","value":694},{"label":"Ago","value":722},{"label":"Set","value":466},{"label":"Out","value":490},{"label":"Nov","value":455},{"label":"Dez","value":352}];
const MX = 722;
