...
const PAGE = "Report";
const KPIS = [{"l":"Total Arms Control","v":"7.334","t":"+0.2%","d":"up"},{"l":"Report Ativos","v":"1.821","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+14.7%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arms Control #001","Arms Control #002","2.797","6.464","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Arms Control #002","Arms Control #003","3.049","1.358","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Arms Control #003","Arms Control #004","3.138","1.003","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Arms Control #004","Arms Control #005","5.591","7.235","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arms Control #005","Arms Control #001","5.402","806","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":929},{"label":"Mar","value":804},{"label":"Abr","value":800},{"label":"Mai","value":740},{"label":"Jun","value":729},{"label":"Jul","value":806},{"label":"Ago","value":638},{"label":"Set","value":707},{"label":"Out","value":972},{"label":"Nov","value":954},{"label":"Dez","value":665}];
const MX = 972;
