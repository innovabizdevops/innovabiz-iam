...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.562","t":"+0.4%","d":"up"},{"l":"NC Abertas","v":"4.880","t":"-1.5%","d":"down"},{"l":"Conformidade (%)","v":"68.4%","t":"-5.6%","d":"down"},{"l":"CAPAs Pendentes","v":"5.041","t":"+0.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.617","77.5%","839","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.535","77.8%","260","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.566","98.2%","4.387","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.107","99.2%","7.074","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.809","85.1%","8.183","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":439},{"label":"Mar","value":735},{"label":"Abr","value":634},{"label":"Mai","value":430},{"label":"Jun","value":541},{"label":"Jul","value":439},{"label":"Ago","value":586},{"label":"Set","value":793},{"label":"Out","value":631},{"label":"Nov","value":479},{"label":"Dez","value":614}];
const MX = 793;
