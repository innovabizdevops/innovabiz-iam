...
const ACCENT = "#6366f1";
const MODULE = "Arms Control";
const PAGE = "Export Ctrl";
const KPIS = [{"l":"Total Arms Control","v":"8.144","t":"+14.0%","d":"up"},{"l":"Export Ctrl Ativos","v":"328","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"75","t":"+8.5%","d":"up"}];
const COLS = ["ID","Export Ctrl","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arms Control #001","Arms Control #002","2.918","1.543","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Arms Control #002","Arms Control #003","8.733","5.452","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Arms Control #003","Arms Control #004","2.191","1.636","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Arms Control #004","Arms Control #005","5.434","2.707","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arms Control #005","Arms Control #001","8.522","6.951","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":254},{"label":"Mar","value":550},{"label":"Abr","value":529},{"label":"Mai","value":400},{"label":"Jun","value":625},{"label":"Jul","value":472},{"label":"Ago","value":551},{"label":"Set","value":486},{"label":"Out","value":395},{"label":"Nov","value":495},{"label":"Dez","value":407}];
const MX = 625;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ITAR</span></h1>
                </div>
