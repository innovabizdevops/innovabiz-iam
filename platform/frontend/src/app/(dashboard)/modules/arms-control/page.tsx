...
export default function ArmsControlPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Arms Control</h1><p className="text-sm text-muted-foreground">Arms Control • iBOS Enterprise</p></div>
