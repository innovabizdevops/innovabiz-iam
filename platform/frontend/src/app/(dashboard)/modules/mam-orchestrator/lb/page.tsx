...
const PAGE = "Load Balance";
const KPIS = [{"l":"Total Mam Orchestrator","v":"4.075","t":"+15.5%","d":"up"},{"l":"Load Balance Ativos","v":"3.970","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"69","t":"+12.0%","d":"up"}];
const COLS = ["ID","Load Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Orchestrator #001","Mam Orchestrator #002","7.439","7.569","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Orchestrator #002","Mam Orchestrator #003","4.883","2.434","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Orchestrator #003","Mam Orchestrator #004","1.119","5.109","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Orchestrator #004","Mam Orchestrator #005","1.266","6.919","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Orchestrator #005","Mam Orchestrator #001","7.922","117","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":599},{"label":"Mar","value":365},{"label":"Abr","value":425},{"label":"Mai","value":655},{"label":"Jun","value":545},{"label":"Jul","value":319},{"label":"Ago","value":466},{"label":"Set","value":701},{"label":"Out","value":619},{"label":"Nov","value":371},{"label":"Dez","value":359}];
const MX = 701;
