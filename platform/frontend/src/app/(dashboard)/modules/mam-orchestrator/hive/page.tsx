...
const PAGE = "Agent Hive";
const KPIS = [{"l":"Total Mam Orchestrator","v":"5.522","t":"+6.6%","d":"up"},{"l":"Agent Hive Ativos","v":"7.353","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"74.7%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+2.3%","d":"up"}];
const COLS = ["ID","Agent Hive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Orchestrator #001","Mam Orchestrator #002","2.742","7.808","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Orchestrator #002","Mam Orchestrator #003","3.553","5.614","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Orchestrator #003","Mam Orchestrator #004","9.042","4.155","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Orchestrator #004","Mam Orchestrator #005","6.218","1.757","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Orchestrator #005","Mam Orchestrator #001","8.524","4.306","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":837},{"label":"Mar","value":896},{"label":"Abr","value":797},{"label":"Mai","value":570},{"label":"Jun","value":725},{"label":"Jul","value":763},{"label":"Ago","value":655},{"label":"Set","value":791},{"label":"Out","value":648},{"label":"Nov","value":649},{"label":"Dez","value":527}];
const MX = 896;
