...
const ACCENT = "#0369a1";
const MODULE = "MAM Orchestration Engine";
const PAGE = "Task Alloc";
const KPIS = [{"l":"Total Mam Orchestrator","v":"7.363","t":"+7.0%","d":"up"},{"l":"Task Alloc Ativos","v":"8.646","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"92","t":"+0.6%","d":"up"}];
const COLS = ["ID","Task Alloc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Orchestrator #001","Mam Orchestrator #002","5.447","8.431","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Orchestrator #002","Mam Orchestrator #003","1.943","5.094","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Orchestrator #003","Mam Orchestrator #004","5.652","4.327","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Orchestrator #004","Mam Orchestrator #005","5.912","4.141","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Orchestrator #005","Mam Orchestrator #001","4.712","9.009","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":621},{"label":"Mar","value":655},{"label":"Abr","value":829},{"label":"Mai","value":1006},{"label":"Jun","value":703},{"label":"Jul","value":961},{"label":"Ago","value":702},{"label":"Set","value":939},{"label":"Out","value":931},{"label":"Nov","value":865},{"label":"Dez","value":824}];
const MX = 1006;
