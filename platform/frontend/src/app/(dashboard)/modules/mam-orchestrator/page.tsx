...
/* ═══ MAM Orchestration Engine — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "5351", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4801", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€196K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1040871451", cells: ["MAM-4451", "MAM Orchestration Engine Item 1", "12/8/2026", "€21 551"], status: "active" as const },
    { id: "1040875022", cells: ["MAM-8022", "MAM Orchestration Engine Item 2", "27/3/2026", "€25 122"], status: "pending" as const },
    { id: "1040878593", cells: ["MAM-2593", "MAM Orchestration Engine Item 3", "14/10/2026", "€28 693"], status: "completed" as const },
    { id: "1040882164", cells: ["MAM-6164", "MAM Orchestration Engine Item 4", "1/5/2026", "€32 264"], status: "warning" as const },
    { id: "1040885735", cells: ["MAM-9735", "MAM Orchestration Engine Item 5", "16/12/2026", "€35 835"], status: "active" as const },
];
...
export default function MamOrchestrationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MAM Orchestration Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MAM Orchestration Engine</p>
                    </div>
                </div>
