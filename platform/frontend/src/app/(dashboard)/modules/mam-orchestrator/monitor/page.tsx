...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Mam Orchestrator","v":"2.824","t":"+0.1%","d":"up"},{"l":"Monitor Ativos","v":"8.952","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"57","t":"+9.0%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Orchestrator #001","Mam Orchestrator #002","3.102","8.832","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Orchestrator #002","Mam Orchestrator #003","9.070","5.874","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Orchestrator #003","Mam Orchestrator #004","5.347","7.375","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Orchestrator #004","Mam Orchestrator #005","3.905","5.966","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Orchestrator #005","Mam Orchestrator #001","5.520","4.976","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":430},{"label":"Mar","value":466},{"label":"Abr","value":806},{"label":"Mai","value":637},{"label":"Jun","value":662},{"label":"Jul","value":603},{"label":"Ago","value":650},{"label":"Set","value":771},{"label":"Out","value":500},{"label":"Nov","value":739},{"label":"Dez","value":656}];
const MX = 806;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>RTM</span></h1>
                </div>
