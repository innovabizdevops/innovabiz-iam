...
const PAGE = "Failover";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.712","t":"-2.9%","d":"down"},{"l":"RTO Médio (h)","v":"118h","t":"+12.5%","d":"up"},{"l":"RPO Médio (h)","v":"143h","t":"+17.4%","d":"up"},{"l":"Testes DR (YTD)","v":"6.107","t":"+8.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","31h","134h","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","156h","72h","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","94h","157h","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","35h","45h","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","64h","43h","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":317},{"label":"Mar","value":252},{"label":"Abr","value":379},{"label":"Mai","value":557},{"label":"Jun","value":471},{"label":"Jul","value":228},{"label":"Ago","value":571},{"label":"Set","value":292},{"label":"Out","value":402},{"label":"Nov","value":562},{"label":"Dez","value":348}];
const MX = 571;
