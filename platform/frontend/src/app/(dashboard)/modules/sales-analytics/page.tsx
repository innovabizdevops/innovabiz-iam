...
/* ═══ Sales Analytics Deep — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "9824", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "720", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€237K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1737380524", cells: ["SAL-3524", "Sales Analytics Deep Item 1", "13/5/2026", "€30 624"], status: "active" as const },
    { id: "1737384095", cells: ["SAL-7095", "Sales Analytics Deep Item 2", "28/12/2026", "€34 195"], status: "pending" as const },
    { id: "1737387666", cells: ["SAL-1666", "Sales Analytics Deep Item 3", "15/7/2026", "€37 766"], status: "completed" as const },
    { id: "1737391237", cells: ["SAL-5237", "Sales Analytics Deep Item 4", "2/2/2026", "€41 337"], status: "warning" as const },
    { id: "1737394808", cells: ["SAL-8808", "Sales Analytics Deep Item 5", "17/9/2026", "€44 908"], status: "active" as const },
];
...
export default function SalesAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sales Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sales Analytics Deep</p>
                    </div>
                </div>
