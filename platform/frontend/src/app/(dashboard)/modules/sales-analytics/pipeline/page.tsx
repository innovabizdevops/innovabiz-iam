...
const PAGE = "Pipeline";
const KPIS = [{"l":"Vendas YTD (€)","v":"€78275","t":"+5.9%","d":"up"},{"l":"Pipeline (€)","v":"€67936","t":"-1.4%","d":"down"},{"l":"Atingimento Quota (%)","v":"88.4%","t":"+2.1%","d":"up"},{"l":"Win Rate (%)","v":"82.0%","t":"-0.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 30984.84","€ 6458.60","€ 4025.29","89.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 25761.83","€ 46434.95","€ 8318.60","94.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 21706.78","€ 38610.81","€ 31777.45","91.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 43449.58","€ 28311.36","€ 8074.96","86.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36384.67","€ 10619.68","€ 8489.24","85.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":606},{"label":"Mar","value":493},{"label":"Abr","value":327},{"label":"Mai","value":315},{"label":"Jun","value":511},{"label":"Jul","value":324},{"label":"Ago","value":576},{"label":"Set","value":422},{"label":"Out","value":452},{"label":"Nov","value":289},{"label":"Dez","value":434}];
const MX = 606;
