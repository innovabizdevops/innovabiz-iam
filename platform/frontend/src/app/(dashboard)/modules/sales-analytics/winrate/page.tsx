...
const PAGE = "Win Rate";
const KPIS = [{"l":"Vendas YTD (€)","v":"€22051","t":"+6.3%","d":"up"},{"l":"Pipeline (€)","v":"€6771","t":"+0.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"78.0%","t":"+12.0%","d":"up"},{"l":"Win Rate (%)","v":"87.4%","t":"+17.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 23074.40","€ 43833.94","€ 6997.58","98.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 42413.12","€ 11044.07","€ 36043.53","75.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 43600.64","€ 16804.04","€ 44938.45","81.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 38681.06","€ 40621.50","€ 1717.83","79.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 50059.41","€ 14756.15","€ 44979.78","88.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":844},{"label":"Mar","value":859},{"label":"Abr","value":965},{"label":"Mai","value":702},{"label":"Jun","value":970},{"label":"Jul","value":976},{"label":"Ago","value":775},{"label":"Set","value":957},{"label":"Out","value":744},{"label":"Nov","value":739},{"label":"Dez","value":721}];
const MX = 976;
