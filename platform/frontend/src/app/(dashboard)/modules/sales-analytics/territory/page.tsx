...
const KPIS = [{"l":"Vendas YTD (€)","v":"€86235","t":"+4.6%","d":"up"},{"l":"Pipeline (€)","v":"€19253","t":"+6.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"69.2%","t":"-5.5%","d":"down"},{"l":"Win Rate (%)","v":"71.4%","t":"-4.2%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 5918.70","€ 15249.82","€ 20471.30","93.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 41377.10","€ 41642.60","€ 38899.14","89.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29982.12","€ 25879.66","€ 35802.94","84.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 29546.93","€ 40455.79","€ 7654.25","92.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 18639.98","€ 49096.65","€ 26941.83","80.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":631},{"label":"Mar","value":586},{"label":"Abr","value":671},{"label":"Mai","value":602},{"label":"Jun","value":656},{"label":"Jul","value":493},{"label":"Ago","value":538},{"label":"Set","value":608},{"label":"Out","value":604},{"label":"Nov","value":765},{"label":"Dez","value":678}];
const MX = 765;
