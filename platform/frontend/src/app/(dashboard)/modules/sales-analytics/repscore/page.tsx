...
const PAGE = "Rep Score";
const KPIS = [{"l":"Vendas YTD (€)","v":"€24541","t":"+2.7%","d":"up"},{"l":"Pipeline (€)","v":"€25327","t":"+10.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"70.8%","t":"+9.9%","d":"up"},{"l":"Win Rate (%)","v":"69.8%","t":"+15.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 910.88","€ 12316.29","€ 5610.93","82.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 41346.05","€ 24092.43","€ 39214.47","89.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29865.55","€ 37991.02","€ 50004.64","75.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 8205.43","€ 29851.42","€ 29536.03","71.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 44217.24","€ 20043.43","€ 42306.00","91.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":1014},{"label":"Mar","value":896},{"label":"Abr","value":926},{"label":"Mai","value":960},{"label":"Jun","value":967},{"label":"Jul","value":1057},{"label":"Ago","value":704},{"label":"Set","value":1053},{"label":"Out","value":1032},{"label":"Nov","value":1044},{"label":"Dez","value":898}];
const MX = 1057;
...
export default function RepscorePage() {
    return (
