...
const ACCENT = "#4338ca";
const MODULE = "Sales Analytics Deep";
const PAGE = "Forecast";
const KPIS = [{"l":"Vendas YTD (€)","v":"€26783","t":"+12.6%","d":"up"},{"l":"Pipeline (€)","v":"€74197","t":"-4.5%","d":"down"},{"l":"Atingimento Quota (%)","v":"86.6%","t":"-4.1%","d":"down"},{"l":"Win Rate (%)","v":"78.7%","t":"+15.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 3060.24","€ 13878.51","€ 8087.28","86.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36623.08","€ 37578.28","€ 21940.74","83.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22540.56","€ 28602.22","€ 11752.15","82.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 12768.24","€ 30419.00","€ 11069.51","72.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 11225.70","€ 45928.91","€ 35950.91","76.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":377},{"label":"Mar","value":363},{"label":"Abr","value":392},{"label":"Mai","value":722},{"label":"Jun","value":483},{"label":"Jul","value":546},{"label":"Ago","value":733},{"label":"Set","value":571},{"label":"Out","value":735},{"label":"Nov","value":474},{"label":"Dez","value":491}];
const MX = 735;
