...
export default function ErrorCorrectPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Error Correct</h1><p className="text-sm text-muted-foreground">Quantum Compute • iBOS Enterprise</p></div>
