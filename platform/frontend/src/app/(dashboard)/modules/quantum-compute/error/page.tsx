...
const PAGE = "Error Correct";
const KPIS = [{"l":"Total Quantum Compute","v":"7.979","t":"+6.9%","d":"up"},{"l":"Error Correct Ativos","v":"6.384","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+8.6%","d":"up"}];
const COLS = ["ID","Error Correct","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quantum Compute #001","Quantum Compute #002","5.087","4.547","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Quantum Compute #002","Quantum Compute #003","7.686","8.695","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Quantum Compute #003","Quantum Compute #004","5.513","6.138","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Quantum Compute #004","Quantum Compute #005","6.764","3.447","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quantum Compute #005","Quantum Compute #001","8.793","7.790","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":888},{"label":"Mar","value":789},{"label":"Abr","value":745},{"label":"Mai","value":846},{"label":"Jun","value":567},{"label":"Jul","value":845},{"label":"Ago","value":601},{"label":"Set","value":518},{"label":"Out","value":602},{"label":"Nov","value":638},{"label":"Dez","value":855}];
const MX = 888;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f97316'}}>AI</span></h1>
                </div>
