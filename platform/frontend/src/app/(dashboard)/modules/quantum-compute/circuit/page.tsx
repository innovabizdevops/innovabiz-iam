...
const PAGE = "Circuit Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.596","t":"+17.7%","d":"up"},{"l":"Submissões/Dia","v":"1702","t":"-0.3%","d":"down"},{"l":"Documentos Gerados","v":"9.023","t":"+11.4%","d":"up"},{"l":"Templates","v":"3.854","t":"-4.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.668","2026-02-06","6.731","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.597","2026-02-15","1.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.959","2026-02-18","7.630","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.619","2026-02-15","5.636","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.307","2026-02-12","584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":901},{"label":"Mar","value":718},{"label":"Abr","value":707},{"label":"Mai","value":673},{"label":"Jun","value":655},{"label":"Jul","value":655},{"label":"Ago","value":606},{"label":"Set","value":620},{"label":"Out","value":988},{"label":"Nov","value":709},{"label":"Dez","value":963}];
const MX = 988;
