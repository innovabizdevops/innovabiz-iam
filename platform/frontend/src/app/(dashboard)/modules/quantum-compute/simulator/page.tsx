...
const KPIS = [{"l":"Twins Ativos","v":"2.782","t":"+3.1%","d":"up"},{"l":"Simulações/Dia","v":"2419","t":"+14.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"78.7%","t":"-1.7%","d":"down"},{"l":"Latência Sync (ms)","v":"195ms","t":"-3.8%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","73.3%","2026-02-25","1.351","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","80.4%","2026-03-04","112","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","75.9%","2026-03-06","8.245","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","99.8%","2026-01-06","8.931","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","96.7%","2026-02-25","842","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":680},{"label":"Mar","value":890},{"label":"Abr","value":645},{"label":"Mai","value":1018},{"label":"Jun","value":742},{"label":"Jul","value":901},{"label":"Ago","value":925},{"label":"Set","value":791},{"label":"Out","value":912},{"label":"Nov","value":906},{"label":"Dez","value":710}];
const MX = 1018;
