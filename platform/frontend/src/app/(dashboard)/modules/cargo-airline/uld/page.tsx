...
const PAGE = "ULD";
const KPIS = [{"l":"Total Cargo Airline","v":"4.062","t":"+1.6%","d":"up"},{"l":"ULD Ativos","v":"289","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"76","t":"-3.5%","d":"down"}];
const COLS = ["ID","ULD","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Airline #001","Cargo Airline #002","4.619","7.942","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Airline #002","Cargo Airline #003","892","7.233","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Airline #003","Cargo Airline #004","2.621","4.688","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Airline #004","Cargo Airline #005","3.506","4.207","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Airline #005","Cargo Airline #001","4.500","6.104","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":321},{"label":"Mar","value":548},{"label":"Abr","value":424},{"label":"Mai","value":274},{"label":"Jun","value":582},{"label":"Jul","value":568},{"label":"Ago","value":547},{"label":"Set","value":243},{"label":"Out","value":294},{"label":"Nov","value":441},{"label":"Dez","value":432}];
const MX = 582;
