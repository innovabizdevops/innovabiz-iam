...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€33.1M","t":"-0.1%","d":"down"},{"l":"MRR (€)","v":"€56154","t":"+9.7%","d":"up"},{"l":"Churn (%)","v":"83.4%","t":"+17.6%","d":"up"},{"l":"ARPU (€)","v":"€82022","t":"+4.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 9757.93","3.260","€ 12714.30","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 16076.18","3.559","€ 8675.25","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 15952.89","2.067","€ 19402.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4621.04","5.367","€ 22421.95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 852.45","126","€ 16204.67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":818},{"label":"Mar","value":911},{"label":"Abr","value":764},{"label":"Mai","value":815},{"label":"Jun","value":917},{"label":"Jul","value":743},{"label":"Ago","value":646},{"label":"Set","value":854},{"label":"Out","value":638},{"label":"Nov","value":952},{"label":"Dez","value":942}];
const MX = 952;
