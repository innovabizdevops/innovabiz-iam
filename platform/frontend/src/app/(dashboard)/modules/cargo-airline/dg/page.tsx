...
const ACCENT = "#6366f1";
const MODULE = "Cargo Airline";
const PAGE = "DG";
const KPIS = [{"l":"Total Cargo Airline","v":"5.557","t":"+0.6%","d":"up"},{"l":"DG Ativos","v":"5.427","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"67","t":"+5.6%","d":"up"}];
const COLS = ["ID","DG","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Airline #001","Cargo Airline #002","7.625","1.703","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Airline #002","Cargo Airline #003","5.341","1.218","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Airline #003","Cargo Airline #004","8.526","6.372","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Airline #004","Cargo Airline #005","3.438","8.772","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Airline #005","Cargo Airline #001","493","5.720","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":274},{"label":"Mar","value":650},{"label":"Abr","value":459},{"label":"Mai","value":475},{"label":"Jun","value":409},{"label":"Jul","value":431},{"label":"Ago","value":604},{"label":"Set","value":486},{"label":"Out","value":282},{"label":"Nov","value":490},{"label":"Dez","value":610}];
const MX = 650;
