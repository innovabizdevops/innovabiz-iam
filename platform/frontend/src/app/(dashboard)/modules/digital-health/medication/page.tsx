...
const KPIS = [{"l":"Integrações Ativas","v":"2.133","t":"+12.5%","d":"up"},{"l":"Chamadas/Hora","v":"3368","t":"+16.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.3%","t":"+7.2%","d":"up"},{"l":"Latência Média (ms)","v":"39ms","t":"-5.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.579","4.871","73.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.748","1.779","96.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.693","8.191","91.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.999","6.767","78.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.557","7.343","99.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":938},{"label":"Mar","value":792},{"label":"Abr","value":821},{"label":"Mai","value":734},{"label":"Jun","value":687},{"label":"Jul","value":930},{"label":"Ago","value":639},{"label":"Set","value":647},{"label":"Out","value":600},{"label":"Nov","value":912},{"label":"Dez","value":916}];
const MX = 944;
