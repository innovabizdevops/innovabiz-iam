...
const ACCENT = "#dc2626";
const MODULE = "Digital Health";
const PAGE = "Wearable";
const KPIS = [{"l":"Total Digital Health","v":"2.251","t":"+3.4%","d":"up"},{"l":"Wearable Ativos","v":"7.004","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"84","t":"-5.3%","d":"down"}];
const COLS = ["ID","Wearable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Health #001","Digital Health #002","8.976","6.367","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Health #002","Digital Health #003","5.780","9.019","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Health #003","Digital Health #004","1.194","3.488","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Health #004","Digital Health #005","4.776","765","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Health #005","Digital Health #001","3.197","3.444","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":559},{"label":"Mar","value":296},{"label":"Abr","value":553},{"label":"Mai","value":300},{"label":"Jun","value":238},{"label":"Jul","value":475},{"label":"Ago","value":444},{"label":"Set","value":397},{"label":"Out","value":270},{"label":"Nov","value":407},{"label":"Dez","value":241}];
const MX = 559;
