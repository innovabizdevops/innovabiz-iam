...
const KPIS = [
    { label: "Total Registos", value: "1572", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3789", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€160K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1774536872", cells: ["DIG-7872", "Digital Health Item 1", "25/9/2026", "€36 972"], status: "active" as const },
    { id: "1774540443", cells: ["DIG-2443", "Digital Health Item 2", "12/4/2026", "€40 543"], status: "pending" as const },
    { id: "1774544014", cells: ["DIG-6014", "Digital Health Item 3", "27/11/2026", "€44 114"], status: "completed" as const },
    { id: "1774547585", cells: ["DIG-9585", "Digital Health Item 4", "14/6/2026", "€47 685"], status: "warning" as const },
    { id: "1774551156", cells: ["DIG-4156", "Digital Health Item 5", "1/1/2026", "€1256"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Health</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Health</p>
                    </div>
                </div>
