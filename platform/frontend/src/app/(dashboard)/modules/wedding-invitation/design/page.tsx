...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.420","t":"+0.8%","d":"up"},{"l":"Submissões/Dia","v":"3811","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"8.863","t":"+0.3%","d":"up"},{"l":"Templates","v":"2.502","t":"+16.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","402","2026-03-09","785","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.776","2026-02-14","3.444","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.967","2026-02-02","2.969","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.380","2026-02-11","7.127","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.814","2026-03-07","8.588","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":800},{"label":"Mar","value":733},{"label":"Abr","value":620},{"label":"Mai","value":820},{"label":"Jun","value":599},{"label":"Jul","value":694},{"label":"Ago","value":499},{"label":"Set","value":724},{"label":"Out","value":655},{"label":"Nov","value":769},{"label":"Dez","value":582}];
const MX = 820;
