...
const KPIS = [
    { label: "Total Registos", value: "2121", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2459", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€330K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2025373721", cells: ["WED-5721", "Wedding Invitation Item 1", "22/6/2026", "€23 821"], status: "active" as const },
    { id: "2025377292", cells: ["WED-9292", "Wedding Invitation Item 2", "9/1/2026", "€27 392"], status: "pending" as const },
    { id: "2025380863", cells: ["WED-3863", "Wedding Invitation Item 3", "24/8/2026", "€30 963"], status: "completed" as const },
    { id: "2025384434", cells: ["WED-7434", "Wedding Invitation Item 4", "11/3/2026", "€34 534"], status: "warning" as const },
    { id: "2025388005", cells: ["WED-2005", "Wedding Invitation Item 5", "26/10/2026", "€38 105"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Invitation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Invitation</p>
                    </div>
                </div>
