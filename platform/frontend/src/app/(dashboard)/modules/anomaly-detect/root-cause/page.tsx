...
const PAGE = "Root Cause";
const KPIS = [{"l":"Projetos Melhoria","v":"8.166","t":"+10.6%","d":"up"},{"l":"Savings (€)","v":"€2937","t":"+10.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"91.3%","t":"+11.1%","d":"up"},{"l":"Ciclos PDCA","v":"8.774","t":"+5.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.359","€ 37852.04","3.222","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.919","€ 24439.63","2.691","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.694","€ 18130.37","3.643","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.597","€ 11694.03","1.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.587","€ 13621.84","6.623","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":293},{"label":"Mar","value":417},{"label":"Abr","value":524},{"label":"Mai","value":454},{"label":"Jun","value":636},{"label":"Jul","value":416},{"label":"Ago","value":432},{"label":"Set","value":470},{"label":"Out","value":377},{"label":"Nov","value":350},{"label":"Dez","value":504}];
const MX = 636;
