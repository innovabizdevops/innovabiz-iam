...
const PAGE = "Forecast Anomaly";
const KPIS = [{"l":"Total Anomaly Detect","v":"1.237","t":"+9.6%","d":"up"},{"l":"Forecast Anomaly Ativos","v":"1.398","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"92","t":"-0.2%","d":"down"}];
const COLS = ["ID","Forecast Anomaly","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Anomaly Detect #001","Anomaly Detect #002","3.487","6.707","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Anomaly Detect #002","Anomaly Detect #003","2.331","2.910","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Anomaly Detect #003","Anomaly Detect #004","3.047","1.227","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Anomaly Detect #004","Anomaly Detect #005","6.059","8.621","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Anomaly Detect #005","Anomaly Detect #001","3.224","2.770","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":698},{"label":"Mar","value":836},{"label":"Abr","value":608},{"label":"Mai","value":613},{"label":"Jun","value":697},{"label":"Jul","value":531},{"label":"Ago","value":877},{"label":"Set","value":574},{"label":"Out","value":613},{"label":"Nov","value":866},{"label":"Dez","value":700}];
const MX = 877;
