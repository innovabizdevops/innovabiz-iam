...
const PAGE = "Alert Stream";
const KPIS = [{"l":"Notificações Enviadas","v":"3.386","t":"+4.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"73.1%","t":"+2.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"69.4%","t":"+16.2%","d":"up"},{"l":"Escalações","v":"2.882","t":"+7.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.350","74.6%","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.008","82.5%","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.849","71.1%","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","195","72.6%","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.315","90.2%","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":416},{"label":"Mar","value":453},{"label":"Abr","value":532},{"label":"Mai","value":437},{"label":"Jun","value":491},{"label":"Jul","value":614},{"label":"Ago","value":426},{"label":"Set","value":513},{"label":"Out","value":583},{"label":"Nov","value":500},{"label":"Dez","value":483}];
const MX = 614;
