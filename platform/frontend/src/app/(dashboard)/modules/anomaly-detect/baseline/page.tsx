...
const PAGE = "Baseline Config";
const KPIS = [{"l":"Configurações","v":"3.820","t":"+10.1%","d":"up"},{"l":"Últimas Alterações","v":"8.593","t":"+9.3%","d":"up"},{"l":"Ambientes","v":"6.656","t":"+13.8%","d":"up"},{"l":"Versão Config","v":"4.709","t":"-4.0%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 29638.77","5.096","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 39400.56","2.474","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 23866.57","6.061","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 3224.52","7.042","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 27771.53","2.880","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":387},{"label":"Mar","value":347},{"label":"Abr","value":279},{"label":"Mai","value":295},{"label":"Jun","value":233},{"label":"Jul","value":504},{"label":"Ago","value":359},{"label":"Set","value":410},{"label":"Out","value":343},{"label":"Nov","value":394},{"label":"Dez","value":412}];
const MX = 516;
