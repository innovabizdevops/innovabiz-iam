...
const KPIS = [{"l":"Total Anomaly Detect","v":"7.941","t":"+5.9%","d":"up"},{"l":"Time Series Ativos","v":"1.751","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.7%","d":"up"}];
const COLS = ["ID","Time Series","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Anomaly Detect #001","Anomaly Detect #002","4.576","5.646","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Anomaly Detect #002","Anomaly Detect #003","8.765","5.141","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Anomaly Detect #003","Anomaly Detect #004","2.103","7.101","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Anomaly Detect #004","Anomaly Detect #005","5.202","5.122","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Anomaly Detect #005","Anomaly Detect #001","1.009","2.153","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":954},{"label":"Mar","value":810},{"label":"Abr","value":748},{"label":"Mai","value":1052},{"label":"Jun","value":701},{"label":"Jul","value":919},{"label":"Ago","value":1032},{"label":"Set","value":1036},{"label":"Out","value":850},{"label":"Nov","value":830},{"label":"Dez","value":710}];
const MX = 1052;
