...
const ACCENT = "#dc2626";
const MODULE = "Anomaly Detection";
const PAGE = "Detectors";
const KPIS = [{"l":"Total Anomaly Detect","v":"5.920","t":"+13.1%","d":"up"},{"l":"Detectors Ativos","v":"8.647","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"68","t":"+9.7%","d":"up"}];
const COLS = ["ID","Detectors","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Anomaly Detect #001","Anomaly Detect #002","520","1.543","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Anomaly Detect #002","Anomaly Detect #003","2.912","4.370","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Anomaly Detect #003","Anomaly Detect #004","5.792","5.561","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Anomaly Detect #004","Anomaly Detect #005","3.854","5.497","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Anomaly Detect #005","Anomaly Detect #001","6.724","977","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":456},{"label":"Mar","value":315},{"label":"Abr","value":522},{"label":"Mai","value":589},{"label":"Jun","value":408},{"label":"Jul","value":424},{"label":"Ago","value":313},{"label":"Set","value":210},{"label":"Out","value":501},{"label":"Nov","value":498},{"label":"Dez","value":566}];
const MX = 589;
