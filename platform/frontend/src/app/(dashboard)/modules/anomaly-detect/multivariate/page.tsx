...
const PAGE = "Multi-Variate";
const KPIS = [{"l":"Total Anomaly Detect","v":"4.499","t":"-2.3%","d":"down"},{"l":"Multi Variate Ativos","v":"4.446","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.5%","d":"up"}];
const COLS = ["ID","Multi Variate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Anomaly Detect #001","Anomaly Detect #002","7.334","2.338","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Anomaly Detect #002","Anomaly Detect #003","499","7.090","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Anomaly Detect #003","Anomaly Detect #004","6.021","5.088","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Anomaly Detect #004","Anomaly Detect #005","1.598","4.775","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Anomaly Detect #005","Anomaly Detect #001","556","7.295","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":650},{"label":"Mar","value":658},{"label":"Abr","value":577},{"label":"Mai","value":462},{"label":"Jun","value":561},{"label":"Jul","value":412},{"label":"Ago","value":772},{"label":"Set","value":689},{"label":"Out","value":661},{"label":"Nov","value":690},{"label":"Dez","value":388}];
const MX = 772;
