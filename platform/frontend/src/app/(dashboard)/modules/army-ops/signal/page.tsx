...
const PAGE = "Signal";
const KPIS = [{"l":"Total Army Ops","v":"6.419","t":"+7.3%","d":"up"},{"l":"Signal Ativos","v":"2.398","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"77.3%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"76","t":"+10.5%","d":"up"}];
const COLS = ["ID","Signal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Army Ops #001","Army Ops #002","181","2.020","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Army Ops #002","Army Ops #003","1.685","2.263","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Army Ops #003","Army Ops #004","8.782","5.661","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Army Ops #004","Army Ops #005","4.033","3.906","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Army Ops #005","Army Ops #001","5.340","8.694","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":885},{"label":"Mar","value":682},{"label":"Abr","value":914},{"label":"Mai","value":727},{"label":"Jun","value":847},{"label":"Jul","value":948},{"label":"Ago","value":885},{"label":"Set","value":954},{"label":"Out","value":995},{"label":"Nov","value":622},{"label":"Dez","value":614}];
const MX = 995;
