...
const PAGE = "Medical";
const KPIS = [{"l":"Integrações Ativas","v":"1.823","t":"-3.6%","d":"down"},{"l":"Chamadas/Hora","v":"2973","t":"+1.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.7%","t":"+5.0%","d":"up"},{"l":"Latência Média (ms)","v":"31ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.951","822","71.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.694","3.000","80.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.018","8.365","95.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.170","6.201","91.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","410","4.449","73.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":403},{"label":"Mar","value":725},{"label":"Abr","value":615},{"label":"Mai","value":651},{"label":"Jun","value":396},{"label":"Jul","value":496},{"label":"Ago","value":716},{"label":"Set","value":452},{"label":"Out","value":440},{"label":"Nov","value":377},{"label":"Dez","value":651}];
const MX = 725;
