...
const ACCENT = "#64748b";
const MODULE = "Army Operations";
const PAGE = "Maneuver";
const KPIS = [{"l":"Total Army Ops","v":"2.678","t":"+12.2%","d":"up"},{"l":"Maneuver Ativos","v":"6.506","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+0.4%","d":"up"}];
const COLS = ["ID","Maneuver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Army Ops #001","Army Ops #002","5.675","1.233","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Army Ops #002","Army Ops #003","5.002","3.883","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Army Ops #003","Army Ops #004","5.714","2.840","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Army Ops #004","Army Ops #005","4.753","4.575","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Army Ops #005","Army Ops #001","438","944","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":292},{"label":"Mar","value":435},{"label":"Abr","value":643},{"label":"Mai","value":659},{"label":"Jun","value":607},{"label":"Jul","value":446},{"label":"Ago","value":680},{"label":"Set","value":395},{"label":"Out","value":352},{"label":"Nov","value":439},{"label":"Dez","value":420}];
const MX = 680;
