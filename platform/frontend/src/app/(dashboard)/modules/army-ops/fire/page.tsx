...
const PAGE = "Fire Support";
const KPIS = [{"l":"Tickets Abertos","v":"6.766","t":"+14.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"86.4%","t":"+10.9%","d":"up"},{"l":"MTTR (h)","v":"70h","t":"+3.3%","d":"up"},{"l":"Satisfação (%)","v":"68.5%","t":"+9.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.264","7.874","4.066","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.416","6.478","3.316","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.343","2.634","4.830","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.942","7.707","4.380","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.949","8.524","7.465","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":946},{"label":"Mar","value":858},{"label":"Abr","value":1018},{"label":"Mai","value":1051},{"label":"Jun","value":742},{"label":"Jul","value":894},{"label":"Ago","value":853},{"label":"Set","value":919},{"label":"Out","value":737},{"label":"Nov","value":1040},{"label":"Dez","value":858}];
const MX = 1051;
