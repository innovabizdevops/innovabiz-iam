...
/* ═══ Army Operations — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "9841", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "183", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€159K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1944260841", cells: ["ARM-9841", "Army Operations Item 1", "6/10/2026", "€10 941"], status: "active" as const },
    { id: "1944264412", cells: ["ARM-4412", "Army Operations Item 2", "21/5/2026", "€14 512"], status: "pending" as const },
    { id: "1944267983", cells: ["ARM-7983", "Army Operations Item 3", "8/12/2026", "€18 083"], status: "completed" as const },
    { id: "1944271554", cells: ["ARM-2554", "Army Operations Item 4", "23/7/2026", "€21 654"], status: "warning" as const },
    { id: "1944275125", cells: ["ARM-6125", "Army Operations Item 5", "10/2/2026", "€25 225"], status: "active" as const },
];
...
export default function ArmyOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Army Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Army Operations</p>
                    </div>
                </div>
