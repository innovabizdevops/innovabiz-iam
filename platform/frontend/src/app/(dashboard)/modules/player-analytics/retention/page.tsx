...
const KPIS = [{"l":"Dashboards Ativos","v":"3.713","t":"-3.0%","d":"down"},{"l":"Queries/Dia","v":"1231","t":"+14.1%","d":"up"},{"l":"Dados Processados (GB)","v":"4.512","t":"+5.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.189","t":"+5.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1721","2026-01-16","6.306","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","804","2026-02-22","6.551","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2168","2026-03-01","4.266","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4058","2026-03-19","791","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2413","2026-01-12","2.101","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":573},{"label":"Mar","value":514},{"label":"Abr","value":397},{"label":"Mai","value":551},{"label":"Jun","value":545},{"label":"Jul","value":559},{"label":"Ago","value":611},{"label":"Set","value":461},{"label":"Out","value":568},{"label":"Nov","value":316},{"label":"Dez","value":363}];
const MX = 634;
