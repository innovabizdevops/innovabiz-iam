...
const KPIS = [{"l":"ARR (€M)","v":"€12.6M","t":"+0.3%","d":"up"},{"l":"MRR (€)","v":"€87450","t":"+7.5%","d":"up"},{"l":"Churn (%)","v":"78.5%","t":"+4.1%","d":"up"},{"l":"ARPU (€)","v":"€18087","t":"+11.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 20830.24","7.487","€ 46194.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44512.98","2.405","€ 1678.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46886.67","7.177","€ 8172.88","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 12543.49","8.812","€ 48192.00","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13598.12","446","€ 3184.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":652},{"label":"Mar","value":525},{"label":"Abr","value":886},{"label":"Mai","value":534},{"label":"Jun","value":500},{"label":"Jul","value":672},{"label":"Ago","value":860},{"label":"Set","value":496},{"label":"Out","value":537},{"label":"Nov","value":791},{"label":"Dez","value":631}];
const MX = 886;
