...
const PAGE = "Cohort";
const KPIS = [{"l":"Dashboards Ativos","v":"2.535","t":"-1.9%","d":"down"},{"l":"Queries/Dia","v":"3296","t":"-5.5%","d":"down"},{"l":"Dados Processados (GB)","v":"3.997","t":"+10.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.142","t":"+3.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3976","2026-02-13","3.744","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1411","2026-01-18","4.123","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1466","2026-01-08","561","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3656","2026-03-11","6.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2381","2026-01-18","7.878","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":543},{"label":"Mar","value":445},{"label":"Abr","value":726},{"label":"Mai","value":680},{"label":"Jun","value":516},{"label":"Jul","value":830},{"label":"Ago","value":639},{"label":"Set","value":725},{"label":"Out","value":826},{"label":"Nov","value":621},{"label":"Dez","value":749}];
const MX = 830;
