...
const ACCENT = "#059669";
const MODULE = "Player Analytics";
const PAGE = "Churn Predict";
const KPIS = [{"l":"ARR (€M)","v":"€50.9M","t":"+8.5%","d":"up"},{"l":"MRR (€)","v":"€23562","t":"-2.1%","d":"down"},{"l":"Churn (%)","v":"88.5%","t":"+4.3%","d":"up"},{"l":"ARPU (€)","v":"€61504","t":"+14.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17959.33","4.213","€ 40618.12","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 34372.87","3.222","€ 21067.70","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32002.48","8.114","€ 13966.09","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26921.11","3.028","€ 23249.13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16172.78","3.252","€ 38538.30","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":510},{"label":"Mar","value":526},{"label":"Abr","value":682},{"label":"Mai","value":520},{"label":"Jun","value":856},{"label":"Jul","value":868},{"label":"Ago","value":753},{"label":"Set","value":595},{"label":"Out","value":840},{"label":"Nov","value":864},{"label":"Dez","value":885}];
const MX = 885;
