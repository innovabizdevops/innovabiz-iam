...
const PAGE = "DAU/MAU";
const KPIS = [{"l":"Dashboards Ativos","v":"1.123","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"4993","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"893","t":"+12.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.166","t":"+2.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5008","2026-01-07","2.429","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3455","2026-01-24","407","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4857","2026-01-12","5.767","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4327","2026-02-14","4.030","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","176","2026-01-01","1.691","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":730},{"label":"Mar","value":558},{"label":"Abr","value":633},{"label":"Mai","value":547},{"label":"Jun","value":819},{"label":"Jul","value":497},{"label":"Ago","value":660},{"label":"Set","value":700},{"label":"Out","value":832},{"label":"Nov","value":505},{"label":"Dez","value":540}];
const MX = 832;
