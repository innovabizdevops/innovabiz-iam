...
const PAGE = "MSL";
const KPIS = [{"l":"Integrações Ativas","v":"5.549","t":"+15.7%","d":"up"},{"l":"Chamadas/Hora","v":"1493","t":"+5.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.5%","t":"+10.6%","d":"up"},{"l":"Latência Média (ms)","v":"10ms","t":"+9.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.601","8.578","91.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.853","5.943","79.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.917","6.170","90.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.775","7.256","75.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.980","4.797","89.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":853},{"label":"Mar","value":722},{"label":"Abr","value":714},{"label":"Mai","value":790},{"label":"Jun","value":550},{"label":"Jul","value":767},{"label":"Ago","value":875},{"label":"Set","value":714},{"label":"Out","value":591},{"label":"Nov","value":849},{"label":"Dez","value":836}];
const MX = 875;
