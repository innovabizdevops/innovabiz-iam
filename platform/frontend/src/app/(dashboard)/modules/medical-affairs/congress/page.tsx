...
const PAGE = "Congress";
const KPIS = [{"l":"Integrações Ativas","v":"6.440","t":"+16.9%","d":"up"},{"l":"Chamadas/Hora","v":"4573","t":"+5.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.5%","t":"+9.4%","d":"up"},{"l":"Latência Média (ms)","v":"197ms","t":"+16.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.403","2.184","99.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.510","6.067","71.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.194","6.451","73.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.233","8.682","93.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.177","1.146","79.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":818},{"label":"Mar","value":730},{"label":"Abr","value":730},{"label":"Mai","value":648},{"label":"Jun","value":836},{"label":"Jul","value":856},{"label":"Ago","value":799},{"label":"Set","value":657},{"label":"Out","value":854},{"label":"Nov","value":762},{"label":"Dez","value":641}];
const MX = 856;
