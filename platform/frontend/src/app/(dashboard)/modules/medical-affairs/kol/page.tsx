...
const PAGE = "KOL";
const KPIS = [{"l":"Integrações Ativas","v":"4.994","t":"+0.7%","d":"up"},{"l":"Chamadas/Hora","v":"3348","t":"+2.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.7%","t":"-0.4%","d":"down"},{"l":"Latência Média (ms)","v":"51ms","t":"-3.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.796","3.449","96.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.691","4.476","75.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.339","6.347","71.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.134","1.274","86.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.989","4.273","93.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1003},{"label":"Fev","value":923},{"label":"Mar","value":884},{"label":"Abr","value":822},{"label":"Mai","value":1015},{"label":"Jun","value":877},{"label":"Jul","value":985},{"label":"Ago","value":701},{"label":"Set","value":690},{"label":"Out","value":686},{"label":"Nov","value":1043},{"label":"Dez","value":1040}];
const MX = 1043;
