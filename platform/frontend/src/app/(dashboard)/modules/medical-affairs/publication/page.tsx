...
const KPIS = [{"l":"Integrações Ativas","v":"3.806","t":"+14.3%","d":"up"},{"l":"Chamadas/Hora","v":"2227","t":"-5.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.1%","t":"+1.2%","d":"up"},{"l":"Latência Média (ms)","v":"116ms","t":"+7.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.052","1.601","90.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.384","5.290","70.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.965","5.363","71.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.091","5.142","97.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.395","7.810","95.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":919},{"label":"Mar","value":687},{"label":"Abr","value":917},{"label":"Mai","value":669},{"label":"Jun","value":851},{"label":"Jul","value":649},{"label":"Ago","value":782},{"label":"Set","value":779},{"label":"Out","value":926},{"label":"Nov","value":1008},{"label":"Dez","value":980}];
const MX = 1008;
