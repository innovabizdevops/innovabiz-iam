...
const KPIS = [
    ...
    { label: "Ativos", value: "960", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€329K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "221019915", cells: ["MED-7915", "Medical Affairs Item 1", "12/4/2026", "€20 015"], status: "active" as const },
    { id: "221023486", cells: ["MED-2486", "Medical Affairs Item 2", "27/11/2026", "€23 586"], status: "pending" as const },
    { id: "221027057", cells: ["MED-6057", "Medical Affairs Item 3", "14/6/2026", "€27 157"], status: "completed" as const },
    { id: "221030628", cells: ["MED-9628", "Medical Affairs Item 4", "1/1/2026", "€30 728"], status: "warning" as const },
    { id: "221034199", cells: ["MED-4199", "Medical Affairs Item 5", "16/8/2026", "€34 299"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical Affairs</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical Affairs</p>
                    </div>
                </div>
