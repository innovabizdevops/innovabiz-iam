...
/* ═══ Procure-to-Pay (APQC 4.2) — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "8828", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3907", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€425K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1510035928", cells: ["PRO-7928", "Procure-to-Pay (APQC 4.2) Item 1", "17/5/2026", "€36 028"], status: "active" as const },
    { id: "1510039499", cells: ["PRO-2499", "Procure-to-Pay (APQC 4.2) Item 2", "4/12/2026", "€39 599"], status: "pending" as const },
    { id: "1510043070", cells: ["PRO-6070", "Procure-to-Pay (APQC 4.2) Item 3", "19/7/2026", "€43 170"], status: "completed" as const },
    { id: "1510046641", cells: ["PRO-9641", "Procure-to-Pay (APQC 4.2) Item 4", "6/2/2026", "€46 741"], status: "warning" as const },
    { id: "1510050212", cells: ["PRO-4212", "Procure-to-Pay (APQC 4.2) Item 5", "21/9/2026", "€312"], status: "active" as const },
];
...
export default function ProcuretopayApqc42Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Procure-to-Pay (APQC 4.2)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Procure-to-Pay (APQC 4.2)</p>
                    </div>
                </div>
