...
const PAGE = "Source";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.690","t":"-4.8%","d":"down"},{"l":"Contratos (€M)","v":"€27.1M","t":"-0.8%","d":"down"},{"l":"On-Time Delivery (%)","v":"77.8%","t":"+6.1%","d":"up"},{"l":"Score Médio","v":"70","t":"+14.4%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","86.3%","€ 46015.05","5.174","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","75.8%","€ 8830.97","5.820","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","83.5%","€ 27660.63","5.632","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","97.2%","€ 14713.42","6.924","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","89.5%","€ 26516.10","8.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":393},{"label":"Mar","value":586},{"label":"Abr","value":614},{"label":"Mai","value":457},{"label":"Jun","value":521},{"label":"Jul","value":452},{"label":"Ago","value":675},{"label":"Set","value":652},{"label":"Out","value":587},{"label":"Nov","value":652},{"label":"Dez","value":489}];
const MX = 675;
