...
const PAGE = "PO";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.217","t":"+15.9%","d":"up"},{"l":"Contratos (€M)","v":"€14.7M","t":"+10.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"85.5%","t":"+0.2%","d":"up"},{"l":"Score Médio","v":"73","t":"-2.5%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","83.4%","€ 15089.03","3.494","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","87.3%","€ 22945.33","3.941","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","94.7%","€ 20891.31","8.106","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","79.3%","€ 48234.37","8.428","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","99.0%","€ 6820.52","8.499","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":844},{"label":"Mar","value":744},{"label":"Abr","value":632},{"label":"Mai","value":927},{"label":"Jun","value":679},{"label":"Jul","value":614},{"label":"Ago","value":624},{"label":"Set","value":894},{"label":"Out","value":851},{"label":"Nov","value":904},{"label":"Dez","value":951}];
const MX = 951;
