...
const ACCENT = "#047857";
const MODULE = "Procure-to-Pay (APQC 4.2)";
const PAGE = "Requisition";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.580","t":"+16.9%","d":"up"},{"l":"Contratos (€M)","v":"€18.6M","t":"+17.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"75.7%","t":"-2.5%","d":"down"},{"l":"Score Médio","v":"89","t":"-4.0%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","87.4%","€ 33908.47","5.127","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","77.3%","€ 38883.83","3.616","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","75.9%","€ 39811.62","3.373","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","96.8%","€ 37519.67","2.399","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.0%","€ 48234.76","2.515","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":857},{"label":"Mar","value":869},{"label":"Abr","value":654},{"label":"Mai","value":860},{"label":"Jun","value":822},{"label":"Jul","value":650},{"label":"Ago","value":547},{"label":"Set","value":741},{"label":"Out","value":604},{"label":"Nov","value":736},{"label":"Dez","value":604}];
const MX = 869;
