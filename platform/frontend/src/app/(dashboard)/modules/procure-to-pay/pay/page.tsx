...
const PAGE = "Pay";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.955","t":"+3.3%","d":"up"},{"l":"Contratos (€M)","v":"€32.8M","t":"+6.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"71.9%","t":"+5.7%","d":"up"},{"l":"Score Médio","v":"71","t":"+10.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","70.8%","€ 7855.74","4.334","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","85.1%","€ 24214.22","1.304","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","86.0%","€ 8815.33","8.167","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","78.9%","€ 8270.77","8.184","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","98.6%","€ 37603.32","2.742","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":690},{"label":"Mar","value":697},{"label":"Abr","value":601},{"label":"Mai","value":543},{"label":"Jun","value":413},{"label":"Jul","value":585},{"label":"Ago","value":716},{"label":"Set","value":647},{"label":"Out","value":533},{"label":"Nov","value":503},{"label":"Dez","value":684}];
const MX = 716;
