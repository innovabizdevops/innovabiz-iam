...
const PAGE = "Receive";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.380","t":"+5.3%","d":"up"},{"l":"Contratos (€M)","v":"€8.3M","t":"+14.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"82.6%","t":"+13.3%","d":"up"},{"l":"Score Médio","v":"78","t":"+5.4%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","75.5%","€ 13104.11","2.120","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","72.7%","€ 20159.35","2.425","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","98.4%","€ 21781.61","7.944","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.1%","€ 45781.56","5.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","91.0%","€ 1095.84","859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":567},{"label":"Mar","value":507},{"label":"Abr","value":433},{"label":"Mai","value":411},{"label":"Jun","value":605},{"label":"Jul","value":367},{"label":"Ago","value":321},{"label":"Set","value":529},{"label":"Out","value":396},{"label":"Nov","value":389},{"label":"Dez","value":590}];
const MX = 605;
