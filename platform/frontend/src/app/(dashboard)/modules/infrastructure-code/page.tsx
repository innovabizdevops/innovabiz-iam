...
/* ═══ Infrastructure as Code — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "6146", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3561", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€218K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1511250946", cells: ["INF-7946", "Infrastructure as Code Item 1", "3/11/2026", "€1046"], status: "active" as const },
    { id: "1511254517", cells: ["INF-2517", "Infrastructure as Code Item 2", "18/6/2026", "€4617"], status: "pending" as const },
    { id: "1511258088", cells: ["INF-6088", "Infrastructure as Code Item 3", "5/1/2026", "€8188"], status: "completed" as const },
    { id: "1511261659", cells: ["INF-9659", "Infrastructure as Code Item 4", "20/8/2026", "€11 759"], status: "warning" as const },
    { id: "1511265230", cells: ["INF-4230", "Infrastructure as Code Item 5", "7/3/2026", "€15 330"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Infrastructure as Code</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Infrastructure as Code</p>
                    </div>
                </div>
