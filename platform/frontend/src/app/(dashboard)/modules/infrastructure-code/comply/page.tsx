...
const ACCENT = "#0d9488";
const MODULE = "Infrastructure as Code";
const PAGE = "Comply";
const KPIS = [{"l":"Total Infrastructure Code","v":"6.269","t":"-1.9%","d":"down"},{"l":"Comply Ativos","v":"6.092","t":"-4.0%","d":"down"},{"l":"Eficiência (%)","v":"95.0%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+4.0%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Infrastructure Code #001","Infrastructure Code #002","7.249","4.407","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Infrastructure Code #002","Infrastructure Code #003","6.075","5.429","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Infrastructure Code #003","Infrastructure Code #004","5.300","7.199","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Infrastructure Code #004","Infrastructure Code #005","7.133","2.089","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Infrastructure Code #005","Infrastructure Code #001","1.564","2.489","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":648},{"label":"Mar","value":887},{"label":"Abr","value":946},{"label":"Mai","value":749},{"label":"Jun","value":939},{"label":"Jul","value":938},{"label":"Ago","value":887},{"label":"Set","value":932},{"label":"Out","value":791},{"label":"Nov","value":690},{"label":"Dez","value":866}];
const MX = 946;
