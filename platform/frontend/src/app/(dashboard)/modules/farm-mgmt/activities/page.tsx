...
const PAGE = "Activity Log";
const KPIS = [{"l":"Total Farm Mgmt","v":"1.204","t":"+9.3%","d":"up"},{"l":"Activity Log Ativos","v":"5.864","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"62","t":"-3.0%","d":"down"}];
const COLS = ["ID","Activity Log","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Mgmt #001","Farm Mgmt #002","5.904","2.609","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Mgmt #002","Farm Mgmt #003","7.397","3.951","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Mgmt #003","Farm Mgmt #004","6.554","1.043","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Mgmt #004","Farm Mgmt #005","931","6.595","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Mgmt #005","Farm Mgmt #001","2.609","3.081","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":407},{"label":"Mar","value":517},{"label":"Abr","value":523},{"label":"Mai","value":609},{"label":"Jun","value":462},{"label":"Jul","value":647},{"label":"Ago","value":641},{"label":"Set","value":390},{"label":"Out","value":313},{"label":"Nov","value":572},{"label":"Dez","value":463}];
const MX = 647;
