...
const KPIS = [{"l":"Total Farm Mgmt","v":"5.041","t":"+12.7%","d":"up"},{"l":"Cost Track Ativos","v":"3.930","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"75","t":"-4.1%","d":"down"}];
const COLS = ["ID","Cost Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Mgmt #001","Farm Mgmt #002","8.650","386","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Mgmt #002","Farm Mgmt #003","5.358","5.145","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Mgmt #003","Farm Mgmt #004","2.920","7.533","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Mgmt #004","Farm Mgmt #005","3.342","6.423","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Mgmt #005","Farm Mgmt #001","4.147","4.264","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":721},{"label":"Mar","value":678},{"label":"Abr","value":946},{"label":"Mai","value":839},{"label":"Jun","value":813},{"label":"Jul","value":906},{"label":"Ago","value":960},{"label":"Set","value":846},{"label":"Out","value":751},{"label":"Nov","value":925},{"label":"Dez","value":779}];
const MX = 960;
