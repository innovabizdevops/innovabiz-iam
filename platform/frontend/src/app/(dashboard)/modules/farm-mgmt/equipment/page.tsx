...
const KPIS = [{"l":"Total Farm Mgmt","v":"4.926","t":"+15.5%","d":"up"},{"l":"Equipment Ativos","v":"8.837","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"82","t":"+17.1%","d":"up"}];
const COLS = ["ID","Equipment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Mgmt #001","Farm Mgmt #002","8.861","1.839","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Mgmt #002","Farm Mgmt #003","1.127","5.763","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Mgmt #003","Farm Mgmt #004","8.501","4.893","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Mgmt #004","Farm Mgmt #005","4.155","3.432","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Mgmt #005","Farm Mgmt #001","2.529","1.584","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":461},{"label":"Mar","value":456},{"label":"Abr","value":605},{"label":"Mai","value":565},{"label":"Jun","value":745},{"label":"Jul","value":774},{"label":"Ago","value":440},{"label":"Set","value":633},{"label":"Out","value":674},{"label":"Nov","value":438},{"label":"Dez","value":421}];
const MX = 774;
