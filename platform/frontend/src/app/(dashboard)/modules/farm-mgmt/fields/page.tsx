...
const PAGE = "Field Map";
const KPIS = [{"l":"Total Farm Mgmt","v":"109","t":"-0.7%","d":"down"},{"l":"Field Map Ativos","v":"2.149","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+2.0%","d":"up"}];
const COLS = ["ID","Field Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Mgmt #001","Farm Mgmt #002","5.166","8.791","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Mgmt #002","Farm Mgmt #003","8.405","7.777","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Mgmt #003","Farm Mgmt #004","7.845","1.857","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Mgmt #004","Farm Mgmt #005","5.082","4.000","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Mgmt #005","Farm Mgmt #001","797","6.107","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":842},{"label":"Mar","value":611},{"label":"Abr","value":573},{"label":"Mai","value":784},{"label":"Jun","value":597},{"label":"Jul","value":777},{"label":"Ago","value":820},{"label":"Set","value":604},{"label":"Out","value":902},{"label":"Nov","value":917},{"label":"Dez","value":600}];
const MX = 917;
