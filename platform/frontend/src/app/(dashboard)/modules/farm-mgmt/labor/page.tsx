...
const ACCENT = "#78350f";
const MODULE = "Farm Management";
const PAGE = "Labor Schedule";
const KPIS = [{"l":"Total Farm Mgmt","v":"1.828","t":"-1.7%","d":"down"},{"l":"Labor Schedule Ativos","v":"8.072","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+10.5%","d":"up"}];
const COLS = ["ID","Labor Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Mgmt #001","Farm Mgmt #002","7.534","2.867","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Mgmt #002","Farm Mgmt #003","1.323","3.001","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Mgmt #003","Farm Mgmt #004","2.278","1.019","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Mgmt #004","Farm Mgmt #005","2.183","8.731","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Mgmt #005","Farm Mgmt #001","4.407","2.178","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":814},{"label":"Mar","value":700},{"label":"Abr","value":634},{"label":"Mai","value":734},{"label":"Jun","value":759},{"label":"Jul","value":681},{"label":"Ago","value":847},{"label":"Set","value":725},{"label":"Out","value":764},{"label":"Nov","value":691},{"label":"Dez","value":601}];
const MX = 847;
