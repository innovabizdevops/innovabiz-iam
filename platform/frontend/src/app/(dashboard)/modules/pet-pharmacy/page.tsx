...
/* ═══ Pet Pharmacy — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "5144", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3090", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€92K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1052246344", cells: ["PET-3344", "Pet Pharmacy Item 1", "17/5/2026", "€46 444"], status: "active" as const },
    { id: "1052249915", cells: ["PET-6915", "Pet Pharmacy Item 2", "4/12/2026", "€50 015"], status: "pending" as const },
    { id: "1052253486", cells: ["PET-1486", "Pet Pharmacy Item 3", "19/7/2026", "€3586"], status: "completed" as const },
    { id: "1052257057", cells: ["PET-5057", "Pet Pharmacy Item 4", "6/2/2026", "€7157"], status: "warning" as const },
    { id: "1052260628", cells: ["PET-8628", "Pet Pharmacy Item 5", "21/9/2026", "€10 728"], status: "active" as const },
];
...
export default function PetPharmacyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Pharmacy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Pharmacy</p>
                    </div>
                </div>
