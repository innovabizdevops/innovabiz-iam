...
const PAGE = "Autoship";
const KPIS = [{"l":"Total Pet Pharmacy","v":"964","t":"+12.5%","d":"up"},{"l":"Autoship Ativos","v":"6.387","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"89","t":"-0.4%","d":"down"}];
const COLS = ["ID","Autoship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Pharmacy #001","Pet Pharmacy #002","4.487","7.610","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Pharmacy #002","Pet Pharmacy #003","5.508","4.007","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Pharmacy #003","Pet Pharmacy #004","5.080","1.277","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Pharmacy #004","Pet Pharmacy #005","7.256","8.034","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Pharmacy #005","Pet Pharmacy #001","2.288","8.633","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":825},{"label":"Mar","value":632},{"label":"Abr","value":490},{"label":"Mai","value":853},{"label":"Jun","value":576},{"label":"Jul","value":720},{"label":"Ago","value":854},{"label":"Set","value":552},{"label":"Out","value":884},{"label":"Nov","value":622},{"label":"Dez","value":768}];
const MX = 884;
