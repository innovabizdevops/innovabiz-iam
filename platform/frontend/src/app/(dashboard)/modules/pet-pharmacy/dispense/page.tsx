...
const PAGE = "Dispense";
const KPIS = [{"l":"Total Pet Pharmacy","v":"2.702","t":"+10.9%","d":"up"},{"l":"Dispense Ativos","v":"1.096","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"67","t":"+13.7%","d":"up"}];
const COLS = ["ID","Dispense","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Pharmacy #001","Pet Pharmacy #002","2.525","8.625","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Pharmacy #002","Pet Pharmacy #003","3.799","5.429","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Pharmacy #003","Pet Pharmacy #004","6.975","8.255","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Pharmacy #004","Pet Pharmacy #005","374","3.761","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Pharmacy #005","Pet Pharmacy #001","4.387","2.524","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":626},{"label":"Mar","value":739},{"label":"Abr","value":611},{"label":"Mai","value":638},{"label":"Jun","value":745},{"label":"Jul","value":484},{"label":"Ago","value":717},{"label":"Set","value":405},{"label":"Out","value":677},{"label":"Nov","value":570},{"label":"Dez","value":609}];
const MX = 745;
