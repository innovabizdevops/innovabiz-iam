...
const ACCENT = "#ea580c";
const MODULE = "Pet Pharmacy";
const PAGE = "Prescription";
const KPIS = [{"l":"Total Pet Pharmacy","v":"1.053","t":"+11.4%","d":"up"},{"l":"Prescription Ativos","v":"4.774","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+0.2%","d":"up"}];
const COLS = ["ID","Prescription","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Pharmacy #001","Pet Pharmacy #002","1.524","8.606","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Pharmacy #002","Pet Pharmacy #003","1.048","129","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Pharmacy #003","Pet Pharmacy #004","1.258","463","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Pharmacy #004","Pet Pharmacy #005","7.253","189","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Pharmacy #005","Pet Pharmacy #001","8.815","8.722","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":487},{"label":"Mar","value":634},{"label":"Abr","value":593},{"label":"Mai","value":712},{"label":"Jun","value":599},{"label":"Jul","value":463},{"label":"Ago","value":719},{"label":"Set","value":829},{"label":"Out","value":736},{"label":"Nov","value":805},{"label":"Dez","value":578}];
const MX = 829;
