...
const PAGE = "Comply";
const KPIS = [{"l":"Total Pet Pharmacy","v":"7.640","t":"+6.9%","d":"up"},{"l":"Comply Ativos","v":"2.264","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"83.1%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"89","t":"+6.6%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Pharmacy #001","Pet Pharmacy #002","7.530","540","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Pharmacy #002","Pet Pharmacy #003","8.647","4.702","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Pharmacy #003","Pet Pharmacy #004","8.145","2.035","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Pharmacy #004","Pet Pharmacy #005","1.108","6.322","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Pharmacy #005","Pet Pharmacy #001","3.222","8.976","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":700},{"label":"Mar","value":1092},{"label":"Abr","value":780},{"label":"Mai","value":729},{"label":"Jun","value":1007},{"label":"Jul","value":1078},{"label":"Ago","value":1036},{"label":"Set","value":713},{"label":"Out","value":761},{"label":"Nov","value":1032},{"label":"Dez","value":969}];
const MX = 1092;
