...
const ACCENT = "#7c3aed";
const MODULE = "Câmara Compensação";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"4.435","t":"-5.3%","d":"down"},{"l":"Mitigações Ativas","v":"4.260","t":"+10.3%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+3.7%","d":"up"},{"l":"Incidentes YTD","v":"6.725","t":"+13.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.966","7.406","1.596","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","152","6.743","2.516","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.574","7.882","3.293","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.813","3.052","319","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.030","3.797","6.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":404},{"label":"Mar","value":740},{"label":"Abr","value":668},{"label":"Mai","value":518},{"label":"Jun","value":649},{"label":"Jul","value":783},{"label":"Ago","value":508},{"label":"Set","value":765},{"label":"Out","value":658},{"label":"Nov","value":705},{"label":"Dez","value":423}];
const MX = 783;
