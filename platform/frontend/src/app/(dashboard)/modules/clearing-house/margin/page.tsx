...
const PAGE = "Margin";
const KPIS = [{"l":"ARR (€M)","v":"€9.5M","t":"+4.8%","d":"up"},{"l":"MRR (€)","v":"€15599","t":"+16.7%","d":"up"},{"l":"Churn (%)","v":"94.7%","t":"+15.6%","d":"up"},{"l":"ARPU (€)","v":"€50508","t":"+12.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 12789.87","5.833","€ 30351.67","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 20639.64","546","€ 44872.20","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 41967.12","538","€ 44355.49","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 48157.62","2.725","€ 22525.80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 34188.69","2.803","€ 10207.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":683},{"label":"Mar","value":620},{"label":"Abr","value":441},{"label":"Mai","value":386},{"label":"Jun","value":612},{"label":"Jul","value":712},{"label":"Ago","value":734},{"label":"Set","value":474},{"label":"Out","value":531},{"label":"Nov","value":463},{"label":"Dez","value":594}];
const MX = 734;
