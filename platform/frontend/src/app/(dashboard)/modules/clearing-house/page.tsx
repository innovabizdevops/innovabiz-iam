...
/* ═══ Câmara Compensação — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "711", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2374", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€253K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2080040111", cells: ["CLE-6111", "Câmara Compensação Item 1", "24/12/2026", "€40 211"], status: "active" as const },
    { id: "2080043682", cells: ["CLE-9682", "Câmara Compensação Item 2", "11/7/2026", "€43 782"], status: "pending" as const },
    { id: "2080047253", cells: ["CLE-4253", "Câmara Compensação Item 3", "26/2/2026", "€47 353"], status: "completed" as const },
    { id: "2080050824", cells: ["CLE-7824", "Câmara Compensação Item 4", "13/9/2026", "€924"], status: "warning" as const },
    { id: "2080054395", cells: ["CLE-2395", "Câmara Compensação Item 5", "28/4/2026", "€4495"], status: "active" as const },
];
...
export default function CmaraCompensaoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Câmara Compensação</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Câmara Compensação</p>
                    </div>
                </div>
