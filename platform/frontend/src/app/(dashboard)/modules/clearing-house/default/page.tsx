...
const PAGE = "Default";
const KPIS = [{"l":"Total Clearing House","v":"3.379","t":"-4.1%","d":"down"},{"l":"Default Ativos","v":"4.344","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"86.7%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"77","t":"-3.6%","d":"down"}];
const COLS = ["ID","Default","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clearing House #001","Clearing House #002","5.781","4.888","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Clearing House #002","Clearing House #003","8.801","8.214","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Clearing House #003","Clearing House #004","7.121","7.749","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Clearing House #004","Clearing House #005","316","4.048","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clearing House #005","Clearing House #001","4.982","246","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":451},{"label":"Mar","value":610},{"label":"Abr","value":595},{"label":"Mai","value":431},{"label":"Jun","value":574},{"label":"Jul","value":467},{"label":"Ago","value":253},{"label":"Set","value":379},{"label":"Out","value":530},{"label":"Nov","value":401},{"label":"Dez","value":467}];
const MX = 610;
