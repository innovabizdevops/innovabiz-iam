...
const ACCENT = "#6366f1";
const MODULE = "Hotel Loyalty";
const PAGE = "Redeem";
const KPIS = [{"l":"Quartos Ocupados","v":"5.103","t":"+4.2%","d":"up"},{"l":"RevPAR (€)","v":"€99316","t":"+4.2%","d":"up"},{"l":"Ocupação (%)","v":"87.9%","t":"+0.5%","d":"up"},{"l":"Guest Satisfaction","v":"8.957","t":"+9.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.529","2026-02-28","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.258","2026-01-21","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.908","2026-03-07","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.907","2026-02-23","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.185","2026-01-06","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":920},{"label":"Mar","value":822},{"label":"Abr","value":698},{"label":"Mai","value":723},{"label":"Jun","value":734},{"label":"Jul","value":882},{"label":"Ago","value":697},{"label":"Set","value":990},{"label":"Out","value":919},{"label":"Nov","value":935},{"label":"Dez","value":1006}];
const MX = 1006;
