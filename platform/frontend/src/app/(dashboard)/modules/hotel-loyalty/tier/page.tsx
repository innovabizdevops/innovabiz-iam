...
const PAGE = "Tier";
const KPIS = [{"l":"ARR (€M)","v":"€10.2M","t":"+3.0%","d":"up"},{"l":"MRR (€)","v":"€43607","t":"+7.3%","d":"up"},{"l":"Churn (%)","v":"85.1%","t":"+2.2%","d":"up"},{"l":"ARPU (€)","v":"€16866","t":"-2.1%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26989.45","8.543","€ 22764.31","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 10807.14","966","€ 8602.41","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12118.96","5.679","€ 5184.44","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3861.66","2.601","€ 39688.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8816.63","4.824","€ 4924.39","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":596},{"label":"Mar","value":591},{"label":"Abr","value":818},{"label":"Mai","value":798},{"label":"Jun","value":713},{"label":"Jul","value":835},{"label":"Ago","value":620},{"label":"Set","value":665},{"label":"Out","value":836},{"label":"Nov","value":867},{"label":"Dez","value":814}];
const MX = 867;
