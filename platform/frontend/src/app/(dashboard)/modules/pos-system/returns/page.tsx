...
const PAGE = "Returns";
const KPIS = [{"l":"Pedidos/Dia","v":"145","t":"+6.0%","d":"up"},{"l":"GMV (€)","v":"€85401","t":"+2.4%","d":"up"},{"l":"Conversão (%)","v":"74.6%","t":"-3.8%","d":"down"},{"l":"AOV (€)","v":"€66638","t":"-1.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 24339.44","1.262","4.067","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 35638.68","7.290","3.134","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 31880.58","8.030","1.339","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 21417.78","325","6.797","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 49131.99","8.481","2.213","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":426},{"label":"Mar","value":607},{"label":"Abr","value":381},{"label":"Mai","value":491},{"label":"Jun","value":531},{"label":"Jul","value":634},{"label":"Ago","value":640},{"label":"Set","value":521},{"label":"Out","value":427},{"label":"Nov","value":572},{"label":"Dez","value":559}];
const MX = 640;
