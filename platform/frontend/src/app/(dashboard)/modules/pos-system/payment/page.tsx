...
const ACCENT = "#6366f1";
const MODULE = "POS System";
const PAGE = "Payment";
const KPIS = [{"l":"Pedidos/Dia","v":"2508","t":"+3.1%","d":"up"},{"l":"GMV (€)","v":"€43774","t":"+2.5%","d":"up"},{"l":"Conversão (%)","v":"74.1%","t":"-5.9%","d":"down"},{"l":"AOV (€)","v":"€13789","t":"+17.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 21868.38","5.956","1.698","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2633.55","2.882","9.098","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 27092.54","4.766","1.753","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 16469.97","4.566","2.303","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 24579.74","5.046","853","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":744},{"label":"Mar","value":1028},{"label":"Abr","value":824},{"label":"Mai","value":1080},{"label":"Jun","value":763},{"label":"Jul","value":706},{"label":"Ago","value":792},{"label":"Set","value":1070},{"label":"Out","value":1086},{"label":"Nov","value":964},{"label":"Dez","value":713}];
const MX = 1086;
