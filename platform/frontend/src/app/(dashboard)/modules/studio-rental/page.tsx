...
/* ═══ Studio Rental — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "2630", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2560", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€73K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "903991330", cells: ["STU-5330", "Studio Rental Item 1", "19/11/2026", "€41 430"], status: "active" as const },
    { id: "903994901", cells: ["STU-8901", "Studio Rental Item 2", "6/6/2026", "€45 001"], status: "pending" as const },
    { id: "903998472", cells: ["STU-3472", "Studio Rental Item 3", "21/1/2026", "€48 572"], status: "completed" as const },
    { id: "904002043", cells: ["STU-7043", "Studio Rental Item 4", "8/8/2026", "€2143"], status: "warning" as const },
    { id: "904005614", cells: ["STU-1614", "Studio Rental Item 5", "23/3/2026", "€5714"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Studio Rental</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Studio Rental</p>
                    </div>
                </div>
