...
const PAGE = "Book";
const KPIS = [{"l":"Total Studio Rental","v":"6.073","t":"+9.6%","d":"up"},{"l":"Book Ativos","v":"166","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"80","t":"+12.7%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Studio Rental #001","Studio Rental #002","1.658","8.528","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Studio Rental #002","Studio Rental #003","1.103","437","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Studio Rental #003","Studio Rental #004","4.385","8.875","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Studio Rental #004","Studio Rental #005","2.765","4.810","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Studio Rental #005","Studio Rental #001","8.848","305","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":521},{"label":"Mar","value":387},{"label":"Abr","value":253},{"label":"Mai","value":456},{"label":"Jun","value":331},{"label":"Jul","value":584},{"label":"Ago","value":388},{"label":"Set","value":495},{"label":"Out","value":232},{"label":"Nov","value":267},{"label":"Dez","value":381}];
const MX = 584;
