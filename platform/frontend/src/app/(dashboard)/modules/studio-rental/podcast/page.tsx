...
const PAGE = "Podcast";
const KPIS = [{"l":"Total Studio Rental","v":"6.669","t":"+0.5%","d":"up"},{"l":"Podcast Ativos","v":"5.695","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"93.9%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"73","t":"-5.4%","d":"down"}];
const COLS = ["ID","Podcast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Studio Rental #001","Studio Rental #002","877","320","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Studio Rental #002","Studio Rental #003","7.192","7.571","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Studio Rental #003","Studio Rental #004","4.037","1.168","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Studio Rental #004","Studio Rental #005","594","5.552","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Studio Rental #005","Studio Rental #001","1.553","2.541","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":497},{"label":"Mar","value":519},{"label":"Abr","value":403},{"label":"Mai","value":548},{"label":"Jun","value":788},{"label":"Jul","value":720},{"label":"Ago","value":495},{"label":"Set","value":790},{"label":"Out","value":449},{"label":"Nov","value":438},{"label":"Dez","value":693}];
const MX = 790;
