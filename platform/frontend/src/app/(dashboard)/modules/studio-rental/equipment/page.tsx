...
const KPIS = [{"l":"Total Studio Rental","v":"4.596","t":"-5.5%","d":"down"},{"l":"Equipment Ativos","v":"6.448","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.4%","d":"down"}];
const COLS = ["ID","Equipment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Studio Rental #001","Studio Rental #002","6.880","7.634","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Studio Rental #002","Studio Rental #003","4.851","2.309","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Studio Rental #003","Studio Rental #004","3.523","4.268","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Studio Rental #004","Studio Rental #005","5.801","7.359","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Studio Rental #005","Studio Rental #001","2.666","982","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":698},{"label":"Mar","value":757},{"label":"Abr","value":664},{"label":"Mai","value":795},{"label":"Jun","value":724},{"label":"Jul","value":978},{"label":"Ago","value":968},{"label":"Set","value":676},{"label":"Out","value":715},{"label":"Nov","value":874},{"label":"Dez","value":649}];
const MX = 978;
