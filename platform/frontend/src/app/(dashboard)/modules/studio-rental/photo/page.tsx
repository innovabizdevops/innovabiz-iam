...
const ACCENT = "#6366f1";
const MODULE = "Studio Rental";
const PAGE = "Photo";
const KPIS = [{"l":"Total Studio Rental","v":"2.186","t":"+10.3%","d":"up"},{"l":"Photo Ativos","v":"3.272","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"80","t":"-2.2%","d":"down"}];
const COLS = ["ID","Photo","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Studio Rental #001","Studio Rental #002","8.489","4.509","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Studio Rental #002","Studio Rental #003","2.050","1.908","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Studio Rental #003","Studio Rental #004","1.951","4.651","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Studio Rental #004","Studio Rental #005","2.786","5.450","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Studio Rental #005","Studio Rental #001","5.827","7.032","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":780},{"label":"Mar","value":581},{"label":"Abr","value":584},{"label":"Mai","value":689},{"label":"Jun","value":647},{"label":"Jul","value":691},{"label":"Ago","value":691},{"label":"Set","value":859},{"label":"Out","value":934},{"label":"Nov","value":801},{"label":"Dez","value":906}];
const MX = 934;
