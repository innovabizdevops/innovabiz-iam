...
const PAGE = "Video";
const KPIS = [{"l":"Total Studio Rental","v":"713","t":"+5.3%","d":"up"},{"l":"Video Ativos","v":"666","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"95.0%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"91","t":"-0.8%","d":"down"}];
const COLS = ["ID","Video","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Studio Rental #001","Studio Rental #002","7.946","5.925","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Studio Rental #002","Studio Rental #003","6.720","4.226","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Studio Rental #003","Studio Rental #004","5.734","3.504","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Studio Rental #004","Studio Rental #005","905","9.022","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Studio Rental #005","Studio Rental #001","5.851","5.156","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":719},{"label":"Mar","value":833},{"label":"Abr","value":872},{"label":"Mai","value":1025},{"label":"Jun","value":762},{"label":"Jul","value":743},{"label":"Ago","value":857},{"label":"Set","value":781},{"label":"Out","value":1008},{"label":"Nov","value":796},{"label":"Dez","value":667}];
const MX = 1032;
