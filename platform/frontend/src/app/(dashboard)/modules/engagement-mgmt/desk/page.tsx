...
const PAGE = "Deal Desk";
const KPIS = [{"l":"eNPS","v":"76","t":"+9.5%","d":"up"},{"l":"Engagement (%)","v":"94.4%","t":"-5.7%","d":"down"},{"l":"Turnover (%)","v":"94.1%","t":"+4.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.778","t":"-1.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.568","2026-01-02","92","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.555","2026-02-25","83","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.781","2026-03-28","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.215","2026-02-09","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.487","2026-03-23","60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":377},{"label":"Mar","value":438},{"label":"Abr","value":594},{"label":"Mai","value":373},{"label":"Jun","value":520},{"label":"Jul","value":618},{"label":"Ago","value":430},{"label":"Set","value":515},{"label":"Out","value":424},{"label":"Nov","value":618},{"label":"Dez","value":657}];
const MX = 657;
