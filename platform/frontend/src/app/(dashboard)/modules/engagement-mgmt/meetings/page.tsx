...
const PAGE = "Client Meet";
const KPIS = [{"l":"eNPS","v":"80","t":"+13.1%","d":"up"},{"l":"Engagement (%)","v":"72.2%","t":"+11.8%","d":"up"},{"l":"Turnover (%)","v":"80.2%","t":"+4.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"716","t":"+11.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.139","2026-02-26","74","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.218","2026-03-24","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.149","2026-01-27","65","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","411","2026-03-28","63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.541","2026-03-13","78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":670},{"label":"Mar","value":331},{"label":"Abr","value":346},{"label":"Mai","value":367},{"label":"Jun","value":665},{"label":"Jul","value":298},{"label":"Ago","value":598},{"label":"Set","value":594},{"label":"Out","value":470},{"label":"Nov","value":458},{"label":"Dez","value":446}];
const MX = 670;
