...
const PAGE = "Pricing Model";
const KPIS = [{"l":"eNPS","v":"66","t":"-3.9%","d":"down"},{"l":"Engagement (%)","v":"75.5%","t":"+8.3%","d":"up"},{"l":"Turnover (%)","v":"75.0%","t":"-4.0%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"2.849","t":"+5.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","459","2026-02-24","57","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.490","2026-02-15","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.276","2026-03-24","64","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.043","2026-02-01","58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.273","2026-03-14","78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":463},{"label":"Mar","value":370},{"label":"Abr","value":561},{"label":"Mai","value":607},{"label":"Jun","value":422},{"label":"Jul","value":569},{"label":"Ago","value":581},{"label":"Set","value":553},{"label":"Out","value":534},{"label":"Nov","value":686},{"label":"Dez","value":645}];
const MX = 686;
