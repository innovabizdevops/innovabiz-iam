...
const ACCENT = "#78350f";
const MODULE = "Engagement Management";
const PAGE = "Win Strategy";
const KPIS = [{"l":"eNPS","v":"86","t":"+14.1%","d":"up"},{"l":"Engagement (%)","v":"68.8%","t":"+15.6%","d":"up"},{"l":"Turnover (%)","v":"88.0%","t":"+4.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.057","t":"+0.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.367","2026-01-02","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.722","2026-02-15","62","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.152","2026-03-03","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.505","2026-01-16","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.786","2026-03-02","80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":699},{"label":"Mar","value":505},{"label":"Abr","value":635},{"label":"Mai","value":420},{"label":"Jun","value":373},{"label":"Jul","value":425},{"label":"Ago","value":698},{"label":"Set","value":479},{"label":"Out","value":629},{"label":"Nov","value":621},{"label":"Dez","value":668}];
const MX = 699;
