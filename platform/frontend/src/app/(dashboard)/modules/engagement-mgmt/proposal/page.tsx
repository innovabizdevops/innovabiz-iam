...
const PAGE = "Proposal Build";
const KPIS = [{"l":"Pedidos/Dia","v":"3599","t":"+1.8%","d":"up"},{"l":"GMV (€)","v":"€78069","t":"-4.6%","d":"down"},{"l":"Conversão (%)","v":"92.1%","t":"+0.8%","d":"up"},{"l":"AOV (€)","v":"€44276","t":"+11.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 24628.95","2.518","6.732","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 1539.99","8.562","208","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 38652.89","2.964","162","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17229.82","2.486","8.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 14110.23","1.876","7.458","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":689},{"label":"Mar","value":673},{"label":"Abr","value":786},{"label":"Mai","value":877},{"label":"Jun","value":747},{"label":"Jul","value":742},{"label":"Ago","value":939},{"label":"Set","value":824},{"label":"Out","value":838},{"label":"Nov","value":885},{"label":"Dez","value":749}];
const MX = 939;
