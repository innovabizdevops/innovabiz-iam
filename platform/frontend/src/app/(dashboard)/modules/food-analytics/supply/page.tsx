...
const PAGE = "Supply";
const KPIS = [{"l":"Dashboards Ativos","v":"981","t":"+5.3%","d":"up"},{"l":"Queries/Dia","v":"722","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.973","t":"+5.8%","d":"up"},{"l":"Utilizadores Analytics","v":"5.490","t":"-1.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2333","2026-03-17","8.063","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3185","2026-03-16","1.573","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4084","2026-02-14","608","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2105","2026-03-15","2.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5037","2026-03-21","5.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":647},{"label":"Mar","value":462},{"label":"Abr","value":676},{"label":"Mai","value":528},{"label":"Jun","value":552},{"label":"Jul","value":515},{"label":"Ago","value":487},{"label":"Set","value":775},{"label":"Out","value":751},{"label":"Nov","value":647},{"label":"Dez","value":608}];
const MX = 805;
