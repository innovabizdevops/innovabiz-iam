...
const ACCENT = "#6366f1";
const MODULE = "Food & Bev Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"7.143","t":"+16.9%","d":"up"},{"l":"Queries/Dia","v":"4733","t":"+12.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.469","t":"+12.1%","d":"up"},{"l":"Utilizadores Analytics","v":"1.014","t":"+12.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3341","2026-01-12","5.955","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3886","2026-01-12","5.381","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1945","2026-01-04","8.180","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1299","2026-03-28","768","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4299","2026-02-24","6.158","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":889},{"label":"Mar","value":1002},{"label":"Abr","value":817},{"label":"Mai","value":1021},{"label":"Jun","value":1031},{"label":"Jul","value":702},{"label":"Ago","value":870},{"label":"Set","value":908},{"label":"Out","value":888},{"label":"Nov","value":759},{"label":"Dez","value":858}];
const MX = 1031;
