...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.370","t":"-1.0%","d":"down"},{"l":"NC Abertas","v":"7.903","t":"+10.0%","d":"up"},{"l":"Conformidade (%)","v":"77.6%","t":"-4.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.683","t":"+10.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.610","84.6%","1.705","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.483","81.4%","2.480","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","313","76.4%","3.695","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","850","81.1%","8.446","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.279","78.5%","6.499","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":666},{"label":"Mar","value":919},{"label":"Abr","value":685},{"label":"Mai","value":636},{"label":"Jun","value":640},{"label":"Jul","value":608},{"label":"Ago","value":888},{"label":"Set","value":955},{"label":"Out","value":896},{"label":"Nov","value":921},{"label":"Dez","value":803}];
const MX = 955;
