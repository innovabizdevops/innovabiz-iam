...
const KPIS = [{"l":"Dashboards Ativos","v":"2.549","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"5080","t":"+16.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.183","t":"+15.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.989","t":"+15.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3317","2026-01-13","4.069","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4457","2026-02-08","8.880","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4324","2026-02-26","5.048","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1915","2026-02-08","4.840","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","492","2026-03-04","1.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":1042},{"label":"Mar","value":736},{"label":"Abr","value":963},{"label":"Mai","value":815},{"label":"Jun","value":1033},{"label":"Jul","value":1048},{"label":"Ago","value":938},{"label":"Set","value":964},{"label":"Out","value":795},{"label":"Nov","value":777},{"label":"Dez","value":921}];
const MX = 1048;
