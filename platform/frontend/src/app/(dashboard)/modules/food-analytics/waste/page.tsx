...
const PAGE = "Waste";
const KPIS = [{"l":"Dashboards Ativos","v":"7.631","t":"+10.2%","d":"up"},{"l":"Queries/Dia","v":"4859","t":"-2.4%","d":"down"},{"l":"Dados Processados (GB)","v":"2.948","t":"+12.5%","d":"up"},{"l":"Utilizadores Analytics","v":"4.388","t":"-2.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1631","2026-03-14","4.302","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2612","2026-01-25","6.072","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","370","2026-01-01","6.459","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1252","2026-01-27","7.427","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2773","2026-02-04","6.773","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":492},{"label":"Mar","value":551},{"label":"Abr","value":443},{"label":"Mai","value":275},{"label":"Jun","value":509},{"label":"Jul","value":290},{"label":"Ago","value":276},{"label":"Set","value":423},{"label":"Out","value":526},{"label":"Nov","value":389},{"label":"Dez","value":443}];
const MX = 595;
