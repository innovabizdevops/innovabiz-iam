...
const PAGE = "Compliance &amp; Audit";
const KPIS = [{"l":"Riscos Identificados","v":"950","t":"+12.8%","d":"up"},{"l":"Mitigações Ativas","v":"2.055","t":"-4.2%","d":"down"},{"l":"Score Risco Geral","v":"61","t":"+17.7%","d":"up"},{"l":"Incidentes YTD","v":"2.910","t":"+6.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.475","444","3.955","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.131","429","6.299","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","467","1.632","4.699","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.026","2.224","5.622","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.165","3.484","6.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":478},{"label":"Mar","value":496},{"label":"Abr","value":658},{"label":"Mai","value":545},{"label":"Jun","value":399},{"label":"Jul","value":759},{"label":"Ago","value":402},{"label":"Set","value":600},{"label":"Out","value":731},{"label":"Nov","value":393},{"label":"Dez","value":511}];
const MX = 759;
