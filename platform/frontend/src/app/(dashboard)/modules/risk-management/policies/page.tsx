...
const PAGE = "Policy Mgmt";
const KPIS = [{"l":"Riscos Identificados","v":"458","t":"+5.0%","d":"up"},{"l":"Mitigações Ativas","v":"6.955","t":"+5.3%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+16.5%","d":"up"},{"l":"Incidentes YTD","v":"493","t":"+16.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.200","4.403","5.279","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.551","8.929","8.595","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.060","4.208","6.512","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.052","8.414","6.401","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.588","8.143","9.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":566},{"label":"Mar","value":592},{"label":"Abr","value":422},{"label":"Mai","value":775},{"label":"Jun","value":424},{"label":"Jul","value":634},{"label":"Ago","value":515},{"label":"Set","value":514},{"label":"Out","value":585},{"label":"Nov","value":603},{"label":"Dez","value":438}];
const MX = 775;
