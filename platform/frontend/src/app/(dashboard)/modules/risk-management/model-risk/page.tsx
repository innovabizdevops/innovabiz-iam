...
const PAGE = "Model Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.366","t":"+10.0%","d":"up"},{"l":"Mitigações Ativas","v":"8.596","t":"+17.3%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+12.1%","d":"up"},{"l":"Incidentes YTD","v":"7.569","t":"+11.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.362","2.687","7.256","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.979","750","4.616","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.568","369","5.166","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.558","843","3.577","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.168","7.327","6.366","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":356},{"label":"Mar","value":680},{"label":"Abr","value":563},{"label":"Mai","value":685},{"label":"Jun","value":702},{"label":"Jul","value":462},{"label":"Ago","value":492},{"label":"Set","value":503},{"label":"Out","value":411},{"label":"Nov","value":695},{"label":"Dez","value":416}];
const MX = 702;
