...
const PAGE = "Operational Risk";
const KPIS = [{"l":"Riscos Identificados","v":"621","t":"+17.2%","d":"up"},{"l":"Mitigações Ativas","v":"2.770","t":"+10.4%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+9.8%","d":"up"},{"l":"Incidentes YTD","v":"8.525","t":"+3.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","764","3.461","492","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.723","4.727","8.705","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.254","4.874","695","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.843","2.252","8.480","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.480","4.747","6.281","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":594},{"label":"Mar","value":470},{"label":"Abr","value":481},{"label":"Mai","value":506},{"label":"Jun","value":481},{"label":"Jul","value":338},{"label":"Ago","value":674},{"label":"Set","value":321},{"label":"Out","value":622},{"label":"Nov","value":438},{"label":"Dez","value":349}];
const MX = 674;
