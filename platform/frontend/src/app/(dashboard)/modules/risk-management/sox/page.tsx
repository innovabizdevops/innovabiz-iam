...
const PAGE = "SOX Compliance";
const KPIS = [{"l":"Riscos Identificados","v":"3.488","t":"+2.1%","d":"up"},{"l":"Mitigações Ativas","v":"1.082","t":"+2.5%","d":"up"},{"l":"Score Risco Geral","v":"55","t":"+4.6%","d":"up"},{"l":"Incidentes YTD","v":"1.051","t":"-4.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.345","6.291","3.530","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.744","2.651","402","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.920","4.980","470","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.497","814","4.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.342","2.172","6.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":300},{"label":"Fev","value":663},{"label":"Mar","value":480},{"label":"Abr","value":662},{"label":"Mai","value":545},{"label":"Jun","value":625},{"label":"Jul","value":589},{"label":"Ago","value":447},{"label":"Set","value":524},{"label":"Out","value":674},{"label":"Nov","value":579},{"label":"Dez","value":439}];
const MX = 674;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>SOX</span></h1>
                </div>
