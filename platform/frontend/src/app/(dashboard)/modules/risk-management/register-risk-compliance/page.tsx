...
const PAGE = "Risk Register";
const KPIS = [{"l":"Riscos Identificados","v":"8.448","t":"+0.5%","d":"up"},{"l":"Mitigações Ativas","v":"8.792","t":"+5.7%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"+8.8%","d":"up"},{"l":"Incidentes YTD","v":"1.025","t":"+14.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","320","7.467","2.172","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.734","8.518","8.251","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.028","2.578","8.677","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.375","3.319","5.297","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.790","1.677","3.182","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":581},{"label":"Mar","value":513},{"label":"Abr","value":828},{"label":"Mai","value":789},{"label":"Jun","value":534},{"label":"Jul","value":683},{"label":"Ago","value":842},{"label":"Set","value":527},{"label":"Out","value":628},{"label":"Nov","value":586},{"label":"Dez","value":671}];
const MX = 842;
...
export default function RegisterRiskCompliancePage() {
    return (
