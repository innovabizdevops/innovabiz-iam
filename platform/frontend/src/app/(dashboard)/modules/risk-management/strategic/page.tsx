...
const PAGE = "Strategic Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.183","t":"+5.6%","d":"up"},{"l":"Mitigações Ativas","v":"534","t":"+0.4%","d":"up"},{"l":"Score Risco Geral","v":"58","t":"-3.1%","d":"down"},{"l":"Incidentes YTD","v":"1.990","t":"+10.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.171","3.134","8.038","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.882","787","1.865","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.731","1.980","8.589","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.971","7.341","2.822","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.038","172","1.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":678},{"label":"Mar","value":957},{"label":"Abr","value":884},{"label":"Mai","value":610},{"label":"Jun","value":586},{"label":"Jul","value":715},{"label":"Ago","value":801},{"label":"Set","value":885},{"label":"Out","value":846},{"label":"Nov","value":959},{"label":"Dez","value":607}];
const MX = 959;
