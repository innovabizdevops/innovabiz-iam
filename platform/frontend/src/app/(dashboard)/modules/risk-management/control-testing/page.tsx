...
const PAGE = "Control Testing Form";
const KPIS = [{"l":"Riscos Identificados","v":"7.517","t":"+2.3%","d":"up"},{"l":"Mitigações Ativas","v":"2.035","t":"+10.5%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"+1.1%","d":"up"},{"l":"Incidentes YTD","v":"4.230","t":"+16.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","9.032","1.983","6.084","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.773","4.550","4.220","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.861","7.795","6.100","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.713","6.073","7.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.506","4.028","8.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":273},{"label":"Mar","value":279},{"label":"Abr","value":472},{"label":"Mai","value":610},{"label":"Jun","value":392},{"label":"Jul","value":544},{"label":"Ago","value":426},{"label":"Set","value":381},{"label":"Out","value":490},{"label":"Nov","value":379},{"label":"Dez","value":302}];
const MX = 610;
