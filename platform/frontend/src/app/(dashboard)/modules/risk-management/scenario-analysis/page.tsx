...
const PAGE = "Scenario Analysis";
const KPIS = [{"l":"Riscos Identificados","v":"1.259","t":"+3.9%","d":"up"},{"l":"Mitigações Ativas","v":"8.678","t":"-2.1%","d":"down"},{"l":"Score Risco Geral","v":"86","t":"-1.7%","d":"down"},{"l":"Incidentes YTD","v":"1.621","t":"+16.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.163","7.251","8.895","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.832","4.483","7.254","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.678","1.982","5.241","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.163","5.669","5.431","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.470","4.633","9.061","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":637},{"label":"Mar","value":746},{"label":"Abr","value":625},{"label":"Mai","value":435},{"label":"Jun","value":626},{"label":"Jul","value":611},{"label":"Ago","value":593},{"label":"Set","value":508},{"label":"Out","value":768},{"label":"Nov","value":431},{"label":"Dez","value":741}];
const MX = 768;
