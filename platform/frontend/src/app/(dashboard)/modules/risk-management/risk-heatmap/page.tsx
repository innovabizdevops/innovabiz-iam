...
const PAGE = "Risk Matrix Heatmap";
const KPIS = [{"l":"Riscos Identificados","v":"8.347","t":"+3.1%","d":"up"},{"l":"Mitigações Ativas","v":"7.095","t":"+14.3%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"-3.0%","d":"down"},{"l":"Incidentes YTD","v":"5.592","t":"+1.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.076","1.562","8.546","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","994","3.019","5.136","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.845","6.896","1.846","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.569","8.875","501","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.865","5.600","4.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":633},{"label":"Mar","value":789},{"label":"Abr","value":583},{"label":"Mai","value":842},{"label":"Jun","value":683},{"label":"Jul","value":547},{"label":"Ago","value":644},{"label":"Set","value":612},{"label":"Out","value":680},{"label":"Nov","value":548},{"label":"Dez","value":556}];
const MX = 842;
