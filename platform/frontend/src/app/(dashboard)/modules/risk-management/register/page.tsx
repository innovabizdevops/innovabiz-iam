...
const KPIS = [{"l":"Riscos Identificados","v":"5.860","t":"-2.1%","d":"down"},{"l":"Mitigações Ativas","v":"3.286","t":"+13.2%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"-4.9%","d":"down"},{"l":"Incidentes YTD","v":"7.087","t":"+3.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.728","5.745","1.621","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.005","2.575","3.800","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.269","7.571","1.919","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.070","5.047","3.251","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.148","1.199","4.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":528},{"label":"Mar","value":558},{"label":"Abr","value":427},{"label":"Mai","value":378},{"label":"Jun","value":749},{"label":"Jul","value":392},{"label":"Ago","value":707},{"label":"Set","value":408},{"label":"Out","value":440},{"label":"Nov","value":735},{"label":"Dez","value":499}];
const MX = 749;
