...
const PAGE = "Regulatory Change";
const KPIS = [{"l":"Riscos Identificados","v":"9.024","t":"+1.0%","d":"up"},{"l":"Mitigações Ativas","v":"2.366","t":"+12.8%","d":"up"},{"l":"Score Risco Geral","v":"66","t":"+0.8%","d":"up"},{"l":"Incidentes YTD","v":"7.788","t":"-5.0%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.739","1.225","5.823","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.594","6.818","8.984","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.409","8.131","7.635","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.108","5.069","8.746","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.062","8.196","4.099","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":526},{"label":"Mar","value":536},{"label":"Abr","value":247},{"label":"Mai","value":489},{"label":"Jun","value":317},{"label":"Jul","value":389},{"label":"Ago","value":580},{"label":"Set","value":279},{"label":"Out","value":592},{"label":"Nov","value":318},{"label":"Dez","value":546}];
const MX = 592;
