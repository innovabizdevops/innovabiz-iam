...
const PAGE = "ISO 31000 Framework";
const KPIS = [{"l":"Riscos Identificados","v":"3.521","t":"+11.9%","d":"up"},{"l":"Mitigações Ativas","v":"5.725","t":"-2.8%","d":"down"},{"l":"Score Risco Geral","v":"81","t":"-3.6%","d":"down"},{"l":"Incidentes YTD","v":"5.304","t":"+14.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.299","5.825","7.024","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.869","6.615","7.816","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","605","6.356","1.890","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.382","3.067","6.608","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.876","2.950","8.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":481},{"label":"Mar","value":385},{"label":"Abr","value":302},{"label":"Mai","value":355},{"label":"Jun","value":418},{"label":"Jul","value":593},{"label":"Ago","value":620},{"label":"Set","value":503},{"label":"Out","value":309},{"label":"Nov","value":548},{"label":"Dez","value":533}];
const MX = 620;
