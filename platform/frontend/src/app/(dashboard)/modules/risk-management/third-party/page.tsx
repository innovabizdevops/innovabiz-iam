...
const ACCENT = "#6366f1";
const MODULE = "Risk Management";
const PAGE = "Third-Party Risk";
const KPIS = [{"l":"Riscos Identificados","v":"4.465","t":"-4.3%","d":"down"},{"l":"Mitigações Ativas","v":"5.871","t":"-3.1%","d":"down"},{"l":"Score Risco Geral","v":"74","t":"-4.5%","d":"down"},{"l":"Incidentes YTD","v":"6.784","t":"-5.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.792","7.637","4.757","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","9.042","7.682","3.901","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.330","1.882","2.674","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.733","5.147","852","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.382","4.258","2.638","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":628},{"label":"Mar","value":686},{"label":"Abr","value":403},{"label":"Mai","value":708},{"label":"Jun","value":458},{"label":"Jul","value":390},{"label":"Ago","value":430},{"label":"Set","value":759},{"label":"Out","value":398},{"label":"Nov","value":599},{"label":"Dez","value":687}];
const MX = 759;
