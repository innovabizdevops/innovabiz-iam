...
const PAGE = "ISO 22301 BCM";
const KPIS = [{"l":"Riscos Identificados","v":"5.551","t":"+13.3%","d":"up"},{"l":"Mitigações Ativas","v":"343","t":"-1.8%","d":"down"},{"l":"Score Risco Geral","v":"82","t":"+13.4%","d":"up"},{"l":"Incidentes YTD","v":"8.394","t":"+14.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.688","2.142","4.680","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.508","353","6.164","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.476","6.300","856","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.937","5.993","1.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.716","2.660","8.484","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":458},{"label":"Mar","value":393},{"label":"Abr","value":378},{"label":"Mai","value":312},{"label":"Jun","value":572},{"label":"Jul","value":516},{"label":"Ago","value":317},{"label":"Set","value":429},{"label":"Out","value":582},{"label":"Nov","value":496},{"label":"Dez","value":558}];
const MX = 582;
