...
const PAGE = "Vendor Risk AI";
const KPIS = [{"l":"Riscos Identificados","v":"4.691","t":"+12.9%","d":"up"},{"l":"Mitigações Ativas","v":"5.945","t":"+14.9%","d":"up"},{"l":"Score Risco Geral","v":"63","t":"+9.3%","d":"up"},{"l":"Incidentes YTD","v":"4.379","t":"+4.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.760","5.740","6.756","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.782","3.389","1.662","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.992","6.433","4.301","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.615","5.476","8.374","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.784","5.874","4.615","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":426},{"label":"Mar","value":508},{"label":"Abr","value":401},{"label":"Mai","value":331},{"label":"Jun","value":370},{"label":"Jul","value":360},{"label":"Ago","value":242},{"label":"Set","value":247},{"label":"Out","value":445},{"label":"Nov","value":297},{"label":"Dez","value":394}];
const MX = 620;
