...
const PAGE = "Risk Register Form";
const KPIS = [{"l":"Riscos Identificados","v":"4.032","t":"+16.3%","d":"up"},{"l":"Mitigações Ativas","v":"7.517","t":"+11.6%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+12.2%","d":"up"},{"l":"Incidentes YTD","v":"2.925","t":"+14.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.811","2.547","8.181","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.640","2.095","8.434","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.356","7.570","5.884","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.706","7.032","8.639","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.394","1.031","4.447","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":818},{"label":"Mar","value":862},{"label":"Abr","value":718},{"label":"Mai","value":877},{"label":"Jun","value":901},{"label":"Jul","value":810},{"label":"Ago","value":834},{"label":"Set","value":674},{"label":"Out","value":781},{"label":"Nov","value":585},{"label":"Dez","value":547}];
const MX = 901;
