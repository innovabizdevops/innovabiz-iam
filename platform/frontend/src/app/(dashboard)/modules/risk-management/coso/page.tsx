...
const PAGE = "COSO ERM Framework";
const KPIS = [{"l":"Riscos Identificados","v":"516","t":"+3.8%","d":"up"},{"l":"Mitigações Ativas","v":"272","t":"-0.1%","d":"down"},{"l":"Score Risco Geral","v":"92","t":"-4.7%","d":"down"},{"l":"Incidentes YTD","v":"2.118","t":"+2.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.492","8.659","3.542","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.150","3.296","6.393","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","135","5.059","3.360","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.518","2.172","269","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","378","1.427","1.965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":652},{"label":"Mar","value":639},{"label":"Abr","value":713},{"label":"Mai","value":531},{"label":"Jun","value":510},{"label":"Jul","value":382},{"label":"Ago","value":528},{"label":"Set","value":521},{"label":"Out","value":477},{"label":"Nov","value":588},{"label":"Dez","value":722}];
const MX = 736;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>COSO</span></h1>
                </div>
