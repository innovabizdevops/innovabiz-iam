...
const PAGE = "Quantitative Risk";
const KPIS = [{"l":"Riscos Identificados","v":"2.660","t":"-4.9%","d":"down"},{"l":"Mitigações Ativas","v":"8.775","t":"+1.6%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"-3.1%","d":"down"},{"l":"Incidentes YTD","v":"2.714","t":"+1.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.665","5.836","2.699","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","534","7.632","2.673","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.065","1.858","1.128","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.008","1.870","8.492","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.028","8.706","8.122","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":639},{"label":"Mar","value":911},{"label":"Abr","value":888},{"label":"Mai","value":616},{"label":"Jun","value":853},{"label":"Jul","value":716},{"label":"Ago","value":619},{"label":"Set","value":868},{"label":"Out","value":888},{"label":"Nov","value":630},{"label":"Dez","value":756}];
const MX = 911;
