...
const PAGE = "Audit";
const KPIS = [{"l":"Riscos Identificados","v":"2.762","t":"+8.1%","d":"up"},{"l":"Mitigações Ativas","v":"2.888","t":"+16.5%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+13.2%","d":"up"},{"l":"Incidentes YTD","v":"3.160","t":"+14.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.286","5.312","5.613","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.662","7.688","196","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.369","3.318","3.088","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.160","2.544","4.796","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.622","7.799","7.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1002},{"label":"Fev","value":1001},{"label":"Mar","value":812},{"label":"Abr","value":701},{"label":"Mai","value":1055},{"label":"Jun","value":807},{"label":"Jul","value":741},{"label":"Ago","value":917},{"label":"Set","value":1020},{"label":"Out","value":1045},{"label":"Nov","value":905},{"label":"Dez","value":967}];
const MX = 1055;
