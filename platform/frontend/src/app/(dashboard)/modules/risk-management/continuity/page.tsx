...
const PAGE = "BCP/DRP";
const KPIS = [{"l":"Riscos Identificados","v":"733","t":"+8.1%","d":"up"},{"l":"Mitigações Ativas","v":"5.417","t":"+12.8%","d":"up"},{"l":"Score Risco Geral","v":"79","t":"-1.7%","d":"down"},{"l":"Incidentes YTD","v":"4.576","t":"-0.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","579","1.957","6.543","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.198","5.592","2.541","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.247","3.684","2.010","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","142","549","8.266","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.111","8.210","6.373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":509},{"label":"Mar","value":511},{"label":"Abr","value":773},{"label":"Mai","value":517},{"label":"Jun","value":770},{"label":"Jul","value":653},{"label":"Ago","value":527},{"label":"Set","value":629},{"label":"Out","value":655},{"label":"Nov","value":781},{"label":"Dez","value":731}];
const MX = 861;
