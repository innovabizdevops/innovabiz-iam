...
const KPIS = [{"l":"Riscos Identificados","v":"2.826","t":"-4.2%","d":"down"},{"l":"Mitigações Ativas","v":"6.120","t":"+13.7%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"8.009","t":"-0.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.431","4.641","3.810","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.660","3.232","153","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.793","961","1.753","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.542","8.714","1.455","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.198","8.457","8.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":579},{"label":"Mar","value":746},{"label":"Abr","value":744},{"label":"Mai","value":748},{"label":"Jun","value":779},{"label":"Jul","value":670},{"label":"Ago","value":547},{"label":"Set","value":650},{"label":"Out","value":686},{"label":"Nov","value":541},{"label":"Dez","value":763}];
const MX = 830;
...
export default function ComplianceRiskCompliancePage() {
    return (
