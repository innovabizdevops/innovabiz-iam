...
const PAGE = "Change Ctrl";
const KPIS = [{"l":"Total Sow Builder","v":"6.336","t":"+11.1%","d":"up"},{"l":"Change Ctrl Ativos","v":"7.605","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"56","t":"-2.9%","d":"down"}];
const COLS = ["ID","Change Ctrl","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sow Builder #001","Sow Builder #002","7.279","6.993","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Sow Builder #002","Sow Builder #003","8.334","2.310","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Sow Builder #003","Sow Builder #004","3.450","5.658","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Sow Builder #004","Sow Builder #005","6.792","4.540","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sow Builder #005","Sow Builder #001","4.728","1.481","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":357},{"label":"Mar","value":743},{"label":"Abr","value":482},{"label":"Mai","value":357},{"label":"Jun","value":573},{"label":"Jul","value":699},{"label":"Ago","value":522},{"label":"Set","value":534},{"label":"Out","value":536},{"label":"Nov","value":584},{"label":"Dez","value":734}];
const MX = 743;
