...
const PAGE = "Deliverables";
const KPIS = [{"l":"Total Sow Builder","v":"1.373","t":"+7.6%","d":"up"},{"l":"Deliverables Ativos","v":"7.486","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"67.5%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"88","t":"+14.3%","d":"up"}];
const COLS = ["ID","Deliverables","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sow Builder #001","Sow Builder #002","107","5.772","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Sow Builder #002","Sow Builder #003","7.120","1.993","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Sow Builder #003","Sow Builder #004","486","8.960","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Sow Builder #004","Sow Builder #005","6.523","7.491","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sow Builder #005","Sow Builder #001","8.546","2.870","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":907},{"label":"Mar","value":781},{"label":"Abr","value":679},{"label":"Mai","value":863},{"label":"Jun","value":894},{"label":"Jul","value":963},{"label":"Ago","value":751},{"label":"Set","value":909},{"label":"Out","value":727},{"label":"Nov","value":999},{"label":"Dez","value":718}];
const MX = 999;
