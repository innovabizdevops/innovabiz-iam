...
const ACCENT = "#4338ca";
const MODULE = "SOW Builder";
const PAGE = "Template Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"6.556","t":"+2.9%","d":"up"},{"l":"Submissões/Dia","v":"2164","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"2.671","t":"+3.6%","d":"up"},{"l":"Templates","v":"8.727","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.347","2026-02-03","2.109","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.346","2026-02-15","1.826","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.846","2026-03-03","5.363","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.437","2026-02-12","7.345","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.075","2026-03-17","2.046","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":744},{"label":"Mar","value":550},{"label":"Abr","value":809},{"label":"Mai","value":712},{"label":"Jun","value":786},{"label":"Jul","value":637},{"label":"Ago","value":708},{"label":"Set","value":435},{"label":"Out","value":679},{"label":"Nov","value":464},{"label":"Dez","value":611}];
const MX = 814;
