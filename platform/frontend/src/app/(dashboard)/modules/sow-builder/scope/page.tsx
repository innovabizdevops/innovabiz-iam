...
const PAGE = "Scope Define";
const KPIS = [{"l":"Total Sow Builder","v":"2.036","t":"-3.6%","d":"down"},{"l":"Scope Define Ativos","v":"658","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"84","t":"+3.3%","d":"up"}];
const COLS = ["ID","Scope Define","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sow Builder #001","Sow Builder #002","8.813","4.608","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Sow Builder #002","Sow Builder #003","4.166","7.111","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Sow Builder #003","Sow Builder #004","3.311","651","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Sow Builder #004","Sow Builder #005","1.710","7.184","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sow Builder #005","Sow Builder #001","3.876","1.231","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":791},{"label":"Mar","value":831},{"label":"Abr","value":1067},{"label":"Mai","value":830},{"label":"Jun","value":1067},{"label":"Jul","value":755},{"label":"Ago","value":773},{"label":"Set","value":1065},{"label":"Out","value":1045},{"label":"Nov","value":693},{"label":"Dez","value":1014}];
const MX = 1067;
