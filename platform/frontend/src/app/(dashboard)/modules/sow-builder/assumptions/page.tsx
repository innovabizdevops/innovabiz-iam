...
const PAGE = "Assumptions";
const KPIS = [{"l":"Total Sow Builder","v":"4.524","t":"+17.2%","d":"up"},{"l":"Assumptions Ativos","v":"7.277","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+17.6%","d":"up"}];
const COLS = ["ID","Assumptions","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sow Builder #001","Sow Builder #002","6.872","6.819","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Sow Builder #002","Sow Builder #003","1.982","7.512","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sow Builder #003","Sow Builder #004","4.227","2.374","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sow Builder #004","Sow Builder #005","5.767","4.275","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sow Builder #005","Sow Builder #001","1.284","3.520","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":577},{"label":"Mar","value":589},{"label":"Abr","value":730},{"label":"Mai","value":701},{"label":"Jun","value":673},{"label":"Jul","value":732},{"label":"Ago","value":869},{"label":"Set","value":608},{"label":"Out","value":846},{"label":"Nov","value":783},{"label":"Dez","value":857}];
const MX = 869;
