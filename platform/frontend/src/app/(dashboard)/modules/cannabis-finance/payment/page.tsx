...
const PAGE = "Payment";
const KPIS = [{"l":"Total Cannabis Finance","v":"6.949","t":"+15.5%","d":"up"},{"l":"Payment Ativos","v":"5.983","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"61","t":"+2.6%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Finance #001","Cannabis Finance #002","1.525","5.658","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Finance #002","Cannabis Finance #003","6.148","7.242","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Finance #003","Cannabis Finance #004","4.181","1.167","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Finance #004","Cannabis Finance #005","3.167","5.841","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Finance #005","Cannabis Finance #001","5.232","4.816","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":634},{"label":"Mar","value":618},{"label":"Abr","value":988},{"label":"Mai","value":674},{"label":"Jun","value":726},{"label":"Jul","value":612},{"label":"Ago","value":873},{"label":"Set","value":814},{"label":"Out","value":650},{"label":"Nov","value":961},{"label":"Dez","value":659}];
const MX = 988;
