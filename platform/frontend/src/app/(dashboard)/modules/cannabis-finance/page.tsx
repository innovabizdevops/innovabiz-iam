...
/* ═══ Cannabis Finance — Dashboard ═══ */

const ACCENT = "#0d3b1e";

const KPIS = [
    { label: "Total Registos", value: "1659", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2418", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€394K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "317682659", cells: ["CAN-1659", "Cannabis Finance Item 1", "8/12/2026", "€32 759"], status: "active" as const },
    { id: "317686230", cells: ["CAN-5230", "Cannabis Finance Item 2", "23/7/2026", "€36 330"], status: "pending" as const },
    { id: "317689801", cells: ["CAN-8801", "Cannabis Finance Item 3", "10/2/2026", "€39 901"], status: "completed" as const },
    { id: "317693372", cells: ["CAN-3372", "Cannabis Finance Item 4", "25/9/2026", "€43 472"], status: "warning" as const },
    { id: "317696943", cells: ["CAN-6943", "Cannabis Finance Item 5", "12/4/2026", "€47 043"], status: "active" as const },
];
...
export default function CannabisFinancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Finance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Finance</p>
                    </div>
                </div>
