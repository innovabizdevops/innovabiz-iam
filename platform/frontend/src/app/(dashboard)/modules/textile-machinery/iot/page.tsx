...
const ACCENT = "#6366f1";
const MODULE = "Textile Machinery";
const PAGE = "IoT";
const KPIS = [{"l":"Dispositivos Online","v":"5.115","t":"+10.6%","d":"up"},{"l":"Dados/Min (MB)","v":"2.871","t":"+5.4%","d":"up"},{"l":"Alertas Ativos","v":"5.257","t":"+0.1%","d":"up"},{"l":"Uptime (%)","v":"86.5%","t":"+10.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.871","5.555","5.972","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.117","686","4.718","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.963","6.250","5.781","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.524","8.043","160","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.539","7.217","5.095","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":364},{"label":"Mar","value":271},{"label":"Abr","value":287},{"label":"Mai","value":417},{"label":"Jun","value":305},{"label":"Jul","value":565},{"label":"Ago","value":507},{"label":"Set","value":327},{"label":"Out","value":257},{"label":"Nov","value":356},{"label":"Dez","value":413}];
const MX = 565;
