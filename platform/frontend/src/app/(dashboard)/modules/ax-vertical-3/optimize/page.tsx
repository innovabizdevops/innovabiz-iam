...
const ACCENT = "#4f46e5";
const MODULE = "AX Manufacturing Agent Hub";
const PAGE = "Optimize";
const KPIS = [{"l":"Total Ax Vertical 3","v":"1.085","t":"+11.7%","d":"up"},{"l":"Optimize Ativos","v":"2.342","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"69","t":"+6.0%","d":"up"}];
const COLS = ["ID","Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 3 #001","Ax Vertical 3 #002","2.506","4.880","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 3 #002","Ax Vertical 3 #003","6.117","3.202","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 3 #003","Ax Vertical 3 #004","3.319","803","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 3 #004","Ax Vertical 3 #005","5.301","1.397","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 3 #005","Ax Vertical 3 #001","2.152","6.933","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":672},{"label":"Mar","value":897},{"label":"Abr","value":781},{"label":"Mai","value":610},{"label":"Jun","value":735},{"label":"Jul","value":822},{"label":"Ago","value":791},{"label":"Set","value":660},{"label":"Out","value":782},{"label":"Nov","value":723},{"label":"Dez","value":721}];
const MX = 897;
