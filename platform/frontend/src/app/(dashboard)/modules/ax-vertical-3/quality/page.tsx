...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.234","t":"-5.0%","d":"down"},{"l":"NC Abertas","v":"4.150","t":"+11.3%","d":"up"},{"l":"Conformidade (%)","v":"69.2%","t":"+8.3%","d":"up"},{"l":"CAPAs Pendentes","v":"559","t":"-0.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.806","73.1%","6.709","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.871","92.7%","5.806","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.872","74.6%","6.401","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.620","92.3%","2.596","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.290","77.6%","2.625","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":450},{"label":"Mar","value":712},{"label":"Abr","value":624},{"label":"Mai","value":532},{"label":"Jun","value":761},{"label":"Jul","value":633},{"label":"Ago","value":429},{"label":"Set","value":747},{"label":"Out","value":643},{"label":"Nov","value":595},{"label":"Dez","value":575}];
const MX = 761;
