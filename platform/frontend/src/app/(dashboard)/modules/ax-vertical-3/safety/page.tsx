...
const PAGE = "Safety";
const KPIS = [{"l":"Total Ax Vertical 3","v":"3.192","t":"-4.0%","d":"down"},{"l":"Safety Ativos","v":"2.242","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"56","t":"+1.8%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 3 #001","Ax Vertical 3 #002","1.262","4.214","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 3 #002","Ax Vertical 3 #003","384","8.713","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 3 #003","Ax Vertical 3 #004","5.744","5.211","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 3 #004","Ax Vertical 3 #005","4.351","1.839","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 3 #005","Ax Vertical 3 #001","8.239","6.981","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":770},{"label":"Mar","value":866},{"label":"Abr","value":715},{"label":"Mai","value":633},{"label":"Jun","value":865},{"label":"Jul","value":758},{"label":"Ago","value":795},{"label":"Set","value":697},{"label":"Out","value":772},{"label":"Nov","value":671},{"label":"Dez","value":706}];
const MX = 866;
