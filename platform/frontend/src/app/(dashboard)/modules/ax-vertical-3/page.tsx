...
/* ═══ AX Manufacturing Agent Hub — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "5013", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "506", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€136K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "130823513", cells: ["AX-9513", "AX Manufacturing Agent Hub Item 1", "10/6/2026", "€23 613"], status: "active" as const },
    { id: "130827084", cells: ["AX-4084", "AX Manufacturing Agent Hub Item 2", "25/1/2026", "€27 184"], status: "pending" as const },
    { id: "130830655", cells: ["AX-7655", "AX Manufacturing Agent Hub Item 3", "12/8/2026", "€30 755"], status: "completed" as const },
    { id: "130834226", cells: ["AX-2226", "AX Manufacturing Agent Hub Item 4", "27/3/2026", "€34 326"], status: "warning" as const },
    { id: "130837797", cells: ["AX-5797", "AX Manufacturing Agent Hub Item 5", "14/10/2026", "€37 897"], status: "active" as const },
];
...
export default function AxManufacturingAgentHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Manufacturing Agent Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Manufacturing Agent Hub</p>
                    </div>
                </div>
