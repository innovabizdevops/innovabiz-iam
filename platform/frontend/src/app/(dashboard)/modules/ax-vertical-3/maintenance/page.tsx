...
const KPIS = [{"l":"Total Ax Vertical 3","v":"4.592","t":"+14.9%","d":"up"},{"l":"Maintenance Ativos","v":"996","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"55","t":"-5.5%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 3 #001","Ax Vertical 3 #002","1.428","7.999","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 3 #002","Ax Vertical 3 #003","4.584","1.561","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 3 #003","Ax Vertical 3 #004","1.407","759","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 3 #004","Ax Vertical 3 #005","6.195","6.839","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 3 #005","Ax Vertical 3 #001","3.171","5.917","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":605},{"label":"Mar","value":350},{"label":"Abr","value":628},{"label":"Mai","value":675},{"label":"Jun","value":552},{"label":"Jul","value":542},{"label":"Ago","value":526},{"label":"Set","value":339},{"label":"Out","value":621},{"label":"Nov","value":515},{"label":"Dez","value":512}];
const MX = 675;
