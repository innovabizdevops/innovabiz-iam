...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Ax Vertical 3","v":"2.155","t":"-3.0%","d":"down"},{"l":"Schedule Ativos","v":"7.000","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"90","t":"-1.3%","d":"down"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 3 #001","Ax Vertical 3 #002","3.173","7.383","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 3 #002","Ax Vertical 3 #003","4.928","3.140","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 3 #003","Ax Vertical 3 #004","431","863","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 3 #004","Ax Vertical 3 #005","3.192","5.706","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 3 #005","Ax Vertical 3 #001","8.914","882","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":705},{"label":"Mar","value":464},{"label":"Abr","value":683},{"label":"Mai","value":601},{"label":"Jun","value":815},{"label":"Jul","value":764},{"label":"Ago","value":478},{"label":"Set","value":697},{"label":"Out","value":539},{"label":"Nov","value":832},{"label":"Dez","value":790}];
const MX = 832;
