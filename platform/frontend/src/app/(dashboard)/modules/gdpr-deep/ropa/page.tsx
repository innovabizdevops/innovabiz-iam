...
const PAGE = "ROPA";
const KPIS = [{"l":"Ideias Submetidas","v":"7.207","t":"+15.1%","d":"up"},{"l":"Patentes (YTD)","v":"2.327","t":"+11.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.285","t":"+0.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€40.3M","t":"-3.4%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.741","81.2%","4.081","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.208","84.5%","2.812","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.881","79.5%","865","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.830","84.2%","6.208","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.658","70.7%","3.874","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":370},{"label":"Mar","value":414},{"label":"Abr","value":551},{"label":"Mai","value":315},{"label":"Jun","value":449},{"label":"Jul","value":322},{"label":"Ago","value":375},{"label":"Set","value":552},{"label":"Out","value":368},{"label":"Nov","value":616},{"label":"Dez","value":585}];
const MX = 616;
