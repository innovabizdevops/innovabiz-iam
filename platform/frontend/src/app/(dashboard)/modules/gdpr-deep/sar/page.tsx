...
const PAGE = "SAR";
const KPIS = [{"l":"Ideias Submetidas","v":"4.565","t":"+3.7%","d":"up"},{"l":"Patentes (YTD)","v":"7.324","t":"+8.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.371","t":"+9.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€42.0M","t":"+3.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.213","81.7%","8.230","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.181","89.5%","299","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","492","96.9%","5.210","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","8.674","82.0%","7.554","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.715","99.3%","996","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":379},{"label":"Mar","value":371},{"label":"Abr","value":446},{"label":"Mai","value":519},{"label":"Jun","value":396},{"label":"Jul","value":723},{"label":"Ago","value":749},{"label":"Set","value":380},{"label":"Out","value":363},{"label":"Nov","value":480},{"label":"Dez","value":372}];
const MX = 749;
