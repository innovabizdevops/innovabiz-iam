...
const ACCENT = "#164e63";
const MODULE = "GDPR Compliance Deep";
const PAGE = "Breach";
const KPIS = [{"l":"Ideias Submetidas","v":"827","t":"+1.2%","d":"up"},{"l":"Patentes (YTD)","v":"8.821","t":"-1.3%","d":"down"},{"l":"Projetos Innovation Lab","v":"1.233","t":"+10.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€15.9M","t":"-2.2%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.431","83.9%","4.795","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.060","70.9%","3.083","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.314","84.3%","3.615","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.245","86.8%","8.916","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.499","94.7%","7.243","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":781},{"label":"Mar","value":952},{"label":"Abr","value":958},{"label":"Mai","value":735},{"label":"Jun","value":911},{"label":"Jul","value":766},{"label":"Ago","value":690},{"label":"Set","value":1039},{"label":"Out","value":1047},{"label":"Nov","value":659},{"label":"Dez","value":952}];
const MX = 1047;
