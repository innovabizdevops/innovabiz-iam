...
const PAGE = "DPIA";
const KPIS = [{"l":"Ideias Submetidas","v":"3.345","t":"-1.3%","d":"down"},{"l":"Patentes (YTD)","v":"3.253","t":"+2.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.761","t":"-5.4%","d":"down"},{"l":"Budget I&D (€M)","v":"€10.6M","t":"-5.6%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.181","70.4%","8.981","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.167","93.4%","6.654","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.621","95.7%","7.067","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.557","83.9%","3.044","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.896","82.0%","2.819","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":709},{"label":"Mar","value":509},{"label":"Abr","value":513},{"label":"Mai","value":636},{"label":"Jun","value":589},{"label":"Jul","value":611},{"label":"Ago","value":729},{"label":"Set","value":632},{"label":"Out","value":785},{"label":"Nov","value":817},{"label":"Dez","value":571}];
const MX = 817;
