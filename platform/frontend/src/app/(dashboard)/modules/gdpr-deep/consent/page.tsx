...
const PAGE = "Consent";
const KPIS = [{"l":"Ideias Submetidas","v":"5.932","t":"-1.3%","d":"down"},{"l":"Patentes (YTD)","v":"331","t":"+4.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.949","t":"+11.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€8.1M","t":"+12.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.891","91.3%","2.213","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.393","95.4%","464","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.975","87.6%","1.536","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","447","97.7%","4.764","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.418","80.5%","6.923","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":367},{"label":"Mar","value":368},{"label":"Abr","value":465},{"label":"Mai","value":729},{"label":"Jun","value":381},{"label":"Jul","value":409},{"label":"Ago","value":565},{"label":"Set","value":630},{"label":"Out","value":358},{"label":"Nov","value":415},{"label":"Dez","value":590}];
const MX = 729;
