...
/* ═══ GDPR Compliance Deep — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "6843", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1886", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€397K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1128270143", cells: ["GDP-4143", "GDPR Compliance Deep Item 1", "8/12/2026", "€20 243"], status: "active" as const },
    { id: "1128273714", cells: ["GDP-7714", "GDPR Compliance Deep Item 2", "23/7/2026", "€23 814"], status: "pending" as const },
    { id: "1128277285", cells: ["GDP-2285", "GDPR Compliance Deep Item 3", "10/2/2026", "€27 385"], status: "completed" as const },
    { id: "1128280856", cells: ["GDP-5856", "GDPR Compliance Deep Item 4", "25/9/2026", "€30 956"], status: "warning" as const },
    { id: "1128284427", cells: ["GDP-9427", "GDPR Compliance Deep Item 5", "12/4/2026", "€34 527"], status: "active" as const },
];
...
export default function GdprComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GDPR Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GDPR Compliance Deep</p>
                    </div>
                </div>
