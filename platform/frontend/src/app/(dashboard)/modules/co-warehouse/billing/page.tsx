...
const PAGE = "Billing";
const KPIS = [{"l":"Total Co Warehouse","v":"3.917","t":"+6.0%","d":"up"},{"l":"Billing Ativos","v":"3.913","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"80","t":"-3.7%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Warehouse #001","Co Warehouse #002","7.623","9.051","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Co Warehouse #002","Co Warehouse #003","5.655","1.360","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Warehouse #003","Co Warehouse #004","6.589","5.069","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Co Warehouse #004","Co Warehouse #005","8.648","5.853","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Warehouse #005","Co Warehouse #001","1.783","6.952","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":926},{"label":"Mar","value":752},{"label":"Abr","value":974},{"label":"Mai","value":651},{"label":"Jun","value":761},{"label":"Jul","value":904},{"label":"Ago","value":785},{"label":"Set","value":679},{"label":"Out","value":944},{"label":"Nov","value":762},{"label":"Dez","value":909}];
const MX = 974;
