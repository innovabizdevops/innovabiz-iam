...
const ACCENT = "#312e81";
const MODULE = "Co-Warehousing";
const PAGE = "Shipping";
const KPIS = [{"l":"Total Co Warehouse","v":"6.758","t":"+17.3%","d":"up"},{"l":"Shipping Ativos","v":"8.709","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+7.9%","d":"up"}];
const COLS = ["ID","Shipping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Warehouse #001","Co Warehouse #002","8.984","7.281","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Co Warehouse #002","Co Warehouse #003","6.426","7.901","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Warehouse #003","Co Warehouse #004","7.171","5.528","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Co Warehouse #004","Co Warehouse #005","7.147","6.388","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Warehouse #005","Co Warehouse #001","1.903","490","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":636},{"label":"Mar","value":588},{"label":"Abr","value":626},{"label":"Mai","value":743},{"label":"Jun","value":730},{"label":"Jul","value":566},{"label":"Ago","value":423},{"label":"Set","value":652},{"label":"Out","value":659},{"label":"Nov","value":443},{"label":"Dez","value":714}];
const MX = 743;
