...
/* ═══ Co-Warehousing — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "8549", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2081", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€61K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "38083849", cells: ["CO-5849", "Co-Warehousing Item 1", "14/2/2026", "€33 949"], status: "active" as const },
    { id: "38087420", cells: ["CO-9420", "Co-Warehousing Item 2", "1/9/2026", "€37 520"], status: "pending" as const },
    { id: "38090991", cells: ["CO-3991", "Co-Warehousing Item 3", "16/4/2026", "€41 091"], status: "completed" as const },
    { id: "38094562", cells: ["CO-7562", "Co-Warehousing Item 4", "3/11/2026", "€44 662"], status: "warning" as const },
    { id: "38098133", cells: ["CO-2133", "Co-Warehousing Item 5", "18/6/2026", "€48 233"], status: "active" as const },
];
...
export default function CowarehousingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Co-Warehousing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Co-Warehousing</p>
                    </div>
                </div>
