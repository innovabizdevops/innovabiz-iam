...
const PAGE = "Fulfil";
const KPIS = [{"l":"Total Co Warehouse","v":"6.943","t":"+13.0%","d":"up"},{"l":"Fulfil Ativos","v":"2.135","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.6%","d":"up"}];
const COLS = ["ID","Fulfil","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Warehouse #001","Co Warehouse #002","5.284","4.162","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Co Warehouse #002","Co Warehouse #003","3.749","306","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Warehouse #003","Co Warehouse #004","3.761","8.561","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Co Warehouse #004","Co Warehouse #005","4.462","8.983","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Warehouse #005","Co Warehouse #001","7.669","2.249","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":783},{"label":"Mar","value":880},{"label":"Abr","value":787},{"label":"Mai","value":855},{"label":"Jun","value":726},{"label":"Jul","value":815},{"label":"Ago","value":663},{"label":"Set","value":727},{"label":"Out","value":624},{"label":"Nov","value":745},{"label":"Dez","value":675}];
const MX = 880;
