...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"7.046","t":"+17.5%","d":"up"},{"l":"Submissões/Dia","v":"4785","t":"+2.1%","d":"up"},{"l":"Documentos Gerados","v":"6.354","t":"+7.9%","d":"up"},{"l":"Templates","v":"2.774","t":"+6.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.464","2026-02-12","5.578","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.310","2026-03-25","830","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.573","2026-02-21","4.259","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.098","2026-01-08","3.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.894","2026-02-17","6.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":794},{"label":"Mar","value":755},{"label":"Abr","value":786},{"label":"Mai","value":553},{"label":"Jun","value":464},{"label":"Jul","value":831},{"label":"Ago","value":679},{"label":"Set","value":644},{"label":"Out","value":724},{"label":"Nov","value":513},{"label":"Dez","value":495}];
const MX = 831;
