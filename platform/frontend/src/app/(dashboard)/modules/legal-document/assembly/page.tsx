...
const ACCENT = "#6366f1";
const MODULE = "Legal Document Mgmt";
const PAGE = "Assembly";
const KPIS = [{"l":"Formulários Ativos","v":"6.236","t":"+7.7%","d":"up"},{"l":"Submissões/Dia","v":"3490","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"8.073","t":"+6.5%","d":"up"},{"l":"Templates","v":"6.472","t":"+2.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.800","2026-02-24","4.284","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.716","2026-03-07","9.079","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.605","2026-02-16","2.410","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.286","2026-02-08","832","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","512","2026-03-15","3.899","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":641},{"label":"Mar","value":739},{"label":"Abr","value":765},{"label":"Mai","value":657},{"label":"Jun","value":642},{"label":"Jul","value":1016},{"label":"Ago","value":768},{"label":"Set","value":958},{"label":"Out","value":876},{"label":"Nov","value":993},{"label":"Dez","value":667}];
const MX = 1016;
