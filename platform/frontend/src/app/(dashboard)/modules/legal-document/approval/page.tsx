...
const PAGE = "Approval";
const KPIS = [{"l":"Formulários Ativos","v":"1.032","t":"+4.6%","d":"up"},{"l":"Submissões/Dia","v":"1591","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"8.103","t":"+10.8%","d":"up"},{"l":"Templates","v":"3.305","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.032","2026-01-15","2.669","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.143","2026-03-06","1.189","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.673","2026-01-16","8.246","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.573","2026-03-15","331","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.736","2026-03-02","3.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":785},{"label":"Mar","value":774},{"label":"Abr","value":943},{"label":"Mai","value":671},{"label":"Jun","value":583},{"label":"Jul","value":783},{"label":"Ago","value":786},{"label":"Set","value":781},{"label":"Out","value":787},{"label":"Nov","value":719},{"label":"Dez","value":780}];
const MX = 943;
