...
const PAGE = "Archive";
const KPIS = [{"l":"Formulários Ativos","v":"3.721","t":"+10.8%","d":"up"},{"l":"Submissões/Dia","v":"121","t":"+16.8%","d":"up"},{"l":"Documentos Gerados","v":"6.057","t":"-4.1%","d":"down"},{"l":"Templates","v":"8.737","t":"+14.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.126","2026-02-22","3.635","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.111","2026-01-14","884","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","969","2026-02-15","8.594","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.273","2026-02-08","2.181","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.216","2026-03-19","2.206","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":301},{"label":"Mar","value":456},{"label":"Abr","value":537},{"label":"Mai","value":551},{"label":"Jun","value":301},{"label":"Jul","value":254},{"label":"Ago","value":353},{"label":"Set","value":383},{"label":"Out","value":364},{"label":"Nov","value":261},{"label":"Dez","value":344}];
const MX = 551;
