...
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"352","t":"-1.0%","d":"down"},{"l":"Submissões/Dia","v":"1887","t":"+9.5%","d":"up"},{"l":"Documentos Gerados","v":"1.996","t":"+6.5%","d":"up"},{"l":"Templates","v":"1.991","t":"+3.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.202","2026-01-28","5.526","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.966","2026-01-19","1.245","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.036","2026-03-27","4.065","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.483","2026-02-28","6.989","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","208","2026-03-27","239","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":797},{"label":"Mar","value":808},{"label":"Abr","value":504},{"label":"Mai","value":677},{"label":"Jun","value":480},{"label":"Jul","value":522},{"label":"Ago","value":519},{"label":"Set","value":846},{"label":"Out","value":508},{"label":"Nov","value":760},{"label":"Dez","value":586}];
const MX = 846;
