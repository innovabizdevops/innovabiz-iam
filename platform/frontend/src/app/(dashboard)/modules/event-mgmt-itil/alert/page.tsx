...
const PAGE = "Alert";
const KPIS = [{"l":"Tickets Abertos","v":"1.491","t":"-1.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"68.4%","t":"+16.7%","d":"up"},{"l":"MTTR (h)","v":"57h","t":"-3.7%","d":"down"},{"l":"Satisfação (%)","v":"65.3%","t":"+0.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.894","4.918","2.480","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.839","5.268","3.809","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.463","8.819","4.407","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.630","8.470","883","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.589","1.999","5.754","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":548},{"label":"Mar","value":335},{"label":"Abr","value":645},{"label":"Mai","value":560},{"label":"Jun","value":576},{"label":"Jul","value":558},{"label":"Ago","value":625},{"label":"Set","value":607},{"label":"Out","value":445},{"label":"Nov","value":295},{"label":"Dez","value":640}];
const MX = 645;
