...
const PAGE = "Filter";
const KPIS = [{"l":"Tickets Abertos","v":"8.947","t":"+12.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.9%","t":"+5.9%","d":"up"},{"l":"MTTR (h)","v":"21h","t":"+5.3%","d":"up"},{"l":"Satisfação (%)","v":"75.2%","t":"+11.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.268","4.213","3.206","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.682","585","5.910","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.446","6.839","540","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.221","8.190","5.996","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.713","5.418","7.155","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":621},{"label":"Mar","value":798},{"label":"Abr","value":574},{"label":"Mai","value":734},{"label":"Jun","value":673},{"label":"Jul","value":953},{"label":"Ago","value":598},{"label":"Set","value":950},{"label":"Out","value":764},{"label":"Nov","value":956},{"label":"Dez","value":779}];
const MX = 956;
