...
/* ═══ Event Management (ITIL) — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "5714", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3194", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€32K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1419774514", cells: ["EVE-7514", "Event Management (ITIL) Item 1", "19/11/2026", "€24 614"], status: "active" as const },
    { id: "1419778085", cells: ["EVE-2085", "Event Management (ITIL) Item 2", "6/6/2026", "€28 185"], status: "pending" as const },
    { id: "1419781656", cells: ["EVE-5656", "Event Management (ITIL) Item 3", "21/1/2026", "€31 756"], status: "completed" as const },
    { id: "1419785227", cells: ["EVE-9227", "Event Management (ITIL) Item 4", "8/8/2026", "€35 327"], status: "warning" as const },
    { id: "1419788798", cells: ["EVE-3798", "Event Management (ITIL) Item 5", "23/3/2026", "€38 898"], status: "active" as const },
];
...
export default function EventManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Management (ITIL)</p>
                    </div>
                </div>
