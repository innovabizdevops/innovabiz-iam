...
const PAGE = "Auto-Resolve";
const KPIS = [{"l":"Tickets Abertos","v":"2.238","t":"+3.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.2%","t":"+16.5%","d":"up"},{"l":"MTTR (h)","v":"21h","t":"+5.8%","d":"up"},{"l":"Satisfação (%)","v":"85.7%","t":"+16.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.707","2.851","334","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.698","1.031","8.617","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.663","982","7.442","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.943","2.030","5.566","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.845","2.645","3.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":812},{"label":"Mar","value":680},{"label":"Abr","value":850},{"label":"Mai","value":570},{"label":"Jun","value":703},{"label":"Jul","value":598},{"label":"Ago","value":578},{"label":"Set","value":552},{"label":"Out","value":756},{"label":"Nov","value":555},{"label":"Dez","value":831}];
const MX = 850;
