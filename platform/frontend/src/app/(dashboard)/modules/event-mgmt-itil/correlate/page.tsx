...
const ACCENT = "#64748b";
const MODULE = "Event Management (ITIL)";
const PAGE = "Correlate";
const KPIS = [{"l":"Tickets Abertos","v":"2.856","t":"-4.5%","d":"down"},{"l":"SLA Cumprido (%)","v":"85.3%","t":"-3.2%","d":"down"},{"l":"MTTR (h)","v":"204h","t":"-5.1%","d":"down"},{"l":"Satisfação (%)","v":"91.5%","t":"+17.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.140","5.721","332","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.050","2.008","7.589","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.498","598","143","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.204","602","4.231","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.073","7.098","399","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":858},{"label":"Mar","value":1063},{"label":"Abr","value":738},{"label":"Mai","value":1012},{"label":"Jun","value":755},{"label":"Jul","value":865},{"label":"Ago","value":843},{"label":"Set","value":1006},{"label":"Out","value":981},{"label":"Nov","value":674},{"label":"Dez","value":762}];
const MX = 1063;
