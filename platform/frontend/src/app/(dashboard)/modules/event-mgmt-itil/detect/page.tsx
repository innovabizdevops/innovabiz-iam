...
const PAGE = "Detect";
const KPIS = [{"l":"Tickets Abertos","v":"8.582","t":"+9.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.8%","t":"+14.7%","d":"up"},{"l":"MTTR (h)","v":"209h","t":"+7.9%","d":"up"},{"l":"Satisfação (%)","v":"87.0%","t":"+3.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.297","9.073","1.020","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.396","3.584","7.615","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.617","8.228","4.384","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.509","1.474","7.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","208","6.291","1.092","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":972},{"label":"Fev","value":627},{"label":"Mar","value":871},{"label":"Abr","value":888},{"label":"Mai","value":710},{"label":"Jun","value":872},{"label":"Jul","value":884},{"label":"Ago","value":862},{"label":"Set","value":648},{"label":"Out","value":795},{"label":"Nov","value":582},{"label":"Dez","value":899}];
const MX = 972;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#64748b'}}>IoT</span></h1>
                </div>
