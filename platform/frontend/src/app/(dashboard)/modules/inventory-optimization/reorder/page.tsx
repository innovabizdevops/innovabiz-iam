...
const ACCENT = "#059669";
const MODULE = "Inventory Optimization";
const PAGE = "Reorder";
const KPIS = [{"l":"Total Inventory Optimization","v":"1.062","t":"+2.8%","d":"up"},{"l":"Reorder Ativos","v":"678","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"75","t":"+17.7%","d":"up"}];
const COLS = ["ID","Reorder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inventory Optimization #001","Inventory Optimization #002","4.900","1.287","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Inventory Optimization #002","Inventory Optimization #003","4.966","2.888","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Inventory Optimization #003","Inventory Optimization #004","7.005","2.615","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Inventory Optimization #004","Inventory Optimization #005","2.862","3.926","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inventory Optimization #005","Inventory Optimization #001","3.459","6.888","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":525},{"label":"Mar","value":557},{"label":"Abr","value":576},{"label":"Mai","value":639},{"label":"Jun","value":703},{"label":"Jul","value":523},{"label":"Ago","value":545},{"label":"Set","value":876},{"label":"Out","value":860},{"label":"Nov","value":566},{"label":"Dez","value":817}];
const MX = 876;
