...
const KPIS = [
    { label: "Total Registos", value: "2131", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1063", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€146K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "643274331", cells: ["INV-9331", "Inventory Optimization Item 1", "8/4/2026", "€24 431"], status: "active" as const },
    { id: "643277902", cells: ["INV-3902", "Inventory Optimization Item 2", "23/11/2026", "€28 002"], status: "pending" as const },
    { id: "643281473", cells: ["INV-7473", "Inventory Optimization Item 3", "10/6/2026", "€31 573"], status: "completed" as const },
    { id: "643285044", cells: ["INV-2044", "Inventory Optimization Item 4", "25/1/2026", "€35 144"], status: "warning" as const },
    { id: "643288615", cells: ["INV-5615", "Inventory Optimization Item 5", "12/8/2026", "€38 715"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Inventory Optimization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Inventory Optimization</p>
                    </div>
                </div>
