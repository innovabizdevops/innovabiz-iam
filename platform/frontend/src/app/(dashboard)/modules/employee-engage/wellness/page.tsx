...
const PAGE = "Wellness";
const KPIS = [{"l":"eNPS","v":"74","t":"+4.5%","d":"up"},{"l":"Engagement (%)","v":"69.2%","t":"+15.2%","d":"up"},{"l":"Turnover (%)","v":"84.1%","t":"+17.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.223","t":"-4.9%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.660","2026-01-24","83","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.746","2026-02-28","66","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.533","2026-01-11","61","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","447","2026-03-24","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.338","2026-03-14","82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":618},{"label":"Mar","value":563},{"label":"Abr","value":306},{"label":"Mai","value":325},{"label":"Jun","value":423},{"label":"Jul","value":626},{"label":"Ago","value":443},{"label":"Set","value":644},{"label":"Out","value":487},{"label":"Nov","value":506},{"label":"Dez","value":577}];
const MX = 644;
