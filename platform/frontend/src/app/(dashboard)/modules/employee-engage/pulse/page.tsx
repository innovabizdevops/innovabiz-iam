...
const PAGE = "Pulse Survey";
const KPIS = [{"l":"eNPS","v":"76","t":"+5.7%","d":"up"},{"l":"Engagement (%)","v":"91.1%","t":"+3.3%","d":"up"},{"l":"Turnover (%)","v":"80.5%","t":"+-0.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"421","t":"+0.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.998","2026-03-17","92","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","343","2026-01-20","55","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.349","2026-03-08","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.513","2026-01-21","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.188","2026-03-01","58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":642},{"label":"Mar","value":426},{"label":"Abr","value":572},{"label":"Mai","value":449},{"label":"Jun","value":601},{"label":"Jul","value":660},{"label":"Ago","value":720},{"label":"Set","value":346},{"label":"Out","value":387},{"label":"Nov","value":709},{"label":"Dez","value":370}];
const MX = 720;
