...
const KPIS = [{"l":"eNPS","v":"69","t":"+14.6%","d":"up"},{"l":"Engagement (%)","v":"85.6%","t":"+11.5%","d":"up"},{"l":"Turnover (%)","v":"69.4%","t":"+7.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.779","t":"+8.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.639","2026-01-11","79","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.193","2026-02-13","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.474","2026-01-19","83","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.289","2026-01-15","73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.076","2026-02-20","69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":739},{"label":"Mar","value":672},{"label":"Abr","value":669},{"label":"Mai","value":773},{"label":"Jun","value":606},{"label":"Jul","value":513},{"label":"Ago","value":512},{"label":"Set","value":695},{"label":"Out","value":546},{"label":"Nov","value":468},{"label":"Dez","value":732}];
const MX = 773;
