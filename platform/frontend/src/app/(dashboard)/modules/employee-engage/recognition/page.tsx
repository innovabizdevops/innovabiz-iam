...
const KPIS = [{"l":"eNPS","v":"66","t":"+11.5%","d":"up"},{"l":"Engagement (%)","v":"88.3%","t":"+16.3%","d":"up"},{"l":"Turnover (%)","v":"85.8%","t":"-5.3%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"8.233","t":"+1.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.989","2026-01-03","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.138","2026-03-08","75","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.331","2026-03-24","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.915","2026-01-03","58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.770","2026-01-03","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":575},{"label":"Mar","value":857},{"label":"Abr","value":596},{"label":"Mai","value":730},{"label":"Jun","value":730},{"label":"Jul","value":821},{"label":"Ago","value":909},{"label":"Set","value":550},{"label":"Out","value":912},{"label":"Nov","value":819},{"label":"Dez","value":664}];
const MX = 912;
