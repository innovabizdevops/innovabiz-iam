...
export default function EmployeeEngagePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Employee Engage</h1><p className="text-sm text-muted-foreground">Employee Engage • iBOS Enterprise</p></div>
