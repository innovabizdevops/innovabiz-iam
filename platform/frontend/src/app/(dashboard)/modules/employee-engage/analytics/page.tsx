...
const ACCENT = "#6366f1";
const MODULE = "Employee Engagement";
const PAGE = "Analytics";
const KPIS = [{"l":"eNPS","v":"61","t":"+7.2%","d":"up"},{"l":"Engagement (%)","v":"86.1%","t":"-0.9%","d":"down"},{"l":"Turnover (%)","v":"81.4%","t":"+8.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.158","t":"-1.0%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.637","2026-01-19","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","338","2026-02-25","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.114","2026-02-14","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.433","2026-02-13","75","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.112","2026-01-03","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":317},{"label":"Fev","value":598},{"label":"Mar","value":460},{"label":"Abr","value":620},{"label":"Mai","value":416},{"label":"Jun","value":647},{"label":"Jul","value":610},{"label":"Ago","value":554},{"label":"Set","value":543},{"label":"Out","value":604},{"label":"Nov","value":594},{"label":"Dez","value":312}];
const MX = 647;
