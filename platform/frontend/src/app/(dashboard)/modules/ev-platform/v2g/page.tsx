...
const PAGE = "Grid V2G";
const KPIS = [{"l":"Formulários Ativos","v":"4.713","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"3051","t":"+13.6%","d":"up"},{"l":"Documentos Gerados","v":"8.881","t":"+6.8%","d":"up"},{"l":"Templates","v":"8.437","t":"-3.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.986","2026-02-12","7.759","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.038","2026-03-27","6.173","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.605","2026-02-10","1.468","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.074","2026-03-08","1.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","283","2026-02-22","1.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":856},{"label":"Mar","value":638},{"label":"Abr","value":797},{"label":"Mai","value":711},{"label":"Jun","value":842},{"label":"Jul","value":546},{"label":"Ago","value":678},{"label":"Set","value":830},{"label":"Out","value":736},{"label":"Nov","value":494},{"label":"Dez","value":789}];
const MX = 856;
