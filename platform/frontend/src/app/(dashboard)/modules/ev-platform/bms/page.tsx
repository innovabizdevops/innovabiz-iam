...
const ACCENT = "#6366f1";
const MODULE = "EV Platform";
const PAGE = "Battery BMS";
const KPIS = [{"l":"Formulários Ativos","v":"7.189","t":"+7.6%","d":"up"},{"l":"Submissões/Dia","v":"3849","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"8.357","t":"+9.1%","d":"up"},{"l":"Templates","v":"3.949","t":"+7.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.496","2026-03-17","6.658","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","686","2026-02-08","6.127","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.994","2026-01-11","5.017","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.541","2026-03-12","7.988","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.263","2026-01-14","3.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":455},{"label":"Mar","value":545},{"label":"Abr","value":490},{"label":"Mai","value":510},{"label":"Jun","value":314},{"label":"Jul","value":374},{"label":"Ago","value":597},{"label":"Set","value":567},{"label":"Out","value":592},{"label":"Nov","value":333},{"label":"Dez","value":407}];
const MX = 597;
