...
const PAGE = "Range";
const KPIS = [{"l":"Formulários Ativos","v":"2.806","t":"-4.5%","d":"down"},{"l":"Submissões/Dia","v":"5023","t":"+7.8%","d":"up"},{"l":"Documentos Gerados","v":"3.719","t":"-4.9%","d":"down"},{"l":"Templates","v":"5.965","t":"-3.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","446","2026-03-22","211","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.265","2026-02-05","423","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.930","2026-03-25","3.595","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.829","2026-02-18","7.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","985","2026-01-19","7.222","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":660},{"label":"Mar","value":591},{"label":"Abr","value":747},{"label":"Mai","value":548},{"label":"Jun","value":577},{"label":"Jul","value":650},{"label":"Ago","value":799},{"label":"Set","value":608},{"label":"Out","value":774},{"label":"Nov","value":768},{"label":"Dez","value":497}];
const MX = 799;
