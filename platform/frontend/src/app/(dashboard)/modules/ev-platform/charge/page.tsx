...
const PAGE = "Charge Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"1.799","t":"-1.1%","d":"down"},{"l":"Submissões/Dia","v":"2954","t":"+7.0%","d":"up"},{"l":"Documentos Gerados","v":"9.001","t":"+14.0%","d":"up"},{"l":"Templates","v":"9.070","t":"+9.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.657","2026-02-20","7.109","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.444","2026-02-06","3.201","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.797","2026-02-22","3.825","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.092","2026-03-10","3.699","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.681","2026-02-26","373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":712},{"label":"Mar","value":607},{"label":"Abr","value":689},{"label":"Mai","value":648},{"label":"Jun","value":557},{"label":"Jul","value":908},{"label":"Ago","value":619},{"label":"Set","value":778},{"label":"Out","value":840},{"label":"Nov","value":749},{"label":"Dez","value":645}];
const MX = 908;
