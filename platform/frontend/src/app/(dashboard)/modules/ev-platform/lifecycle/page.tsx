...
const KPIS = [{"l":"Formulários Ativos","v":"2.752","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"216","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"2.365","t":"+15.4%","d":"up"},{"l":"Templates","v":"7.629","t":"+7.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.716","2026-01-13","8.962","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.799","2026-01-28","2.836","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.368","2026-01-17","440","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.408","2026-03-21","6.340","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.436","2026-01-22","7.559","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":663},{"label":"Mar","value":482},{"label":"Abr","value":498},{"label":"Mai","value":612},{"label":"Jun","value":678},{"label":"Jul","value":684},{"label":"Ago","value":577},{"label":"Set","value":691},{"label":"Out","value":645},{"label":"Nov","value":633},{"label":"Dez","value":570}];
const MX = 691;
