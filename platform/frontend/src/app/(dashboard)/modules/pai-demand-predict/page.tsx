...
/* ═══ P-AI Demand Prediction — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "4967", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "182", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€185K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "453781267", cells: ["PAI-2267", "P-AI Demand Prediction Item 1", "24/8/2026", "€31 367"], status: "active" as const },
    { id: "453784838", cells: ["PAI-5838", "P-AI Demand Prediction Item 2", "11/3/2026", "€34 938"], status: "pending" as const },
    { id: "453788409", cells: ["PAI-9409", "P-AI Demand Prediction Item 3", "26/10/2026", "€38 509"], status: "completed" as const },
    { id: "453791980", cells: ["PAI-3980", "P-AI Demand Prediction Item 4", "13/5/2026", "€42 080"], status: "warning" as const },
    { id: "453795551", cells: ["PAI-7551", "P-AI Demand Prediction Item 5", "28/12/2026", "€45 651"], status: "active" as const },
];
...
export default function PaiDemandPredictionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Demand Prediction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Demand Prediction</p>
                    </div>
                </div>
