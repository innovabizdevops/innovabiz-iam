...
const PAGE = "Feature";
const KPIS = [{"l":"Integrações Ativas","v":"4.273","t":"-2.8%","d":"down"},{"l":"Chamadas/Hora","v":"3071","t":"+10.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.0%","t":"+12.9%","d":"up"},{"l":"Latência Média (ms)","v":"199ms","t":"+15.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.185","8.055","87.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.896","8.845","92.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.786","8.613","84.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.561","7.107","87.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.215","1.933","74.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":486},{"label":"Mar","value":693},{"label":"Abr","value":432},{"label":"Mai","value":566},{"label":"Jun","value":634},{"label":"Jul","value":660},{"label":"Ago","value":381},{"label":"Set","value":414},{"label":"Out","value":532},{"label":"Nov","value":461},{"label":"Dez","value":526}];
const MX = 693;
