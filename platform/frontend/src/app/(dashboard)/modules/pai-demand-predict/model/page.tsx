...
const PAGE = "Model";
const KPIS = [{"l":"Integrações Ativas","v":"402","t":"+4.2%","d":"up"},{"l":"Chamadas/Hora","v":"259","t":"+11.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.6%","t":"+8.6%","d":"up"},{"l":"Latência Média (ms)","v":"176ms","t":"+2.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.320","2.168","91.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.306","8.129","73.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.801","1.073","99.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.611","332","84.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","760","2.887","82.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":398},{"label":"Mar","value":509},{"label":"Abr","value":271},{"label":"Mai","value":338},{"label":"Jun","value":283},{"label":"Jul","value":314},{"label":"Ago","value":251},{"label":"Set","value":575},{"label":"Out","value":456},{"label":"Nov","value":565},{"label":"Dez","value":313}];
const MX = 575;
