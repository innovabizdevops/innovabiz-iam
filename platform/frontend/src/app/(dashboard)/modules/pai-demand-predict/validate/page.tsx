...
const PAGE = "Validate";
const KPIS = [{"l":"Integrações Ativas","v":"7.929","t":"-4.3%","d":"down"},{"l":"Chamadas/Hora","v":"637","t":"+4.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.1%","t":"+11.7%","d":"up"},{"l":"Latência Média (ms)","v":"27ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.237","8.219","91.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.711","7.768","92.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.682","1.519","98.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.208","3.020","88.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","950","2.011","97.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":489},{"label":"Mar","value":632},{"label":"Abr","value":753},{"label":"Mai","value":627},{"label":"Jun","value":575},{"label":"Jul","value":466},{"label":"Ago","value":729},{"label":"Set","value":375},{"label":"Out","value":480},{"label":"Nov","value":386},{"label":"Dez","value":454}];
const MX = 753;
