...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Demand Prediction";
const PAGE = "Signal";
const KPIS = [{"l":"Integrações Ativas","v":"4.984","t":"+3.1%","d":"up"},{"l":"Chamadas/Hora","v":"4484","t":"+4.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.5%","t":"+4.7%","d":"up"},{"l":"Latência Média (ms)","v":"177ms","t":"+7.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","108","2.943","71.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.153","6.476","83.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.655","665","83.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.702","2.433","82.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","890","9.042","90.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":759},{"label":"Mar","value":451},{"label":"Abr","value":661},{"label":"Mai","value":791},{"label":"Jun","value":452},{"label":"Jul","value":745},{"label":"Ago","value":724},{"label":"Set","value":488},{"label":"Out","value":684},{"label":"Nov","value":598},{"label":"Dez","value":756}];
const MX = 791;
