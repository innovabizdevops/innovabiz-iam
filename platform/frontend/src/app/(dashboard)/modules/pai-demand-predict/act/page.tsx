...
const PAGE = "Act";
const KPIS = [{"l":"Integrações Ativas","v":"7.589","t":"+16.8%","d":"up"},{"l":"Chamadas/Hora","v":"3901","t":"-5.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"75.1%","t":"+5.2%","d":"up"},{"l":"Latência Média (ms)","v":"138ms","t":"+5.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.897","8.446","95.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.085","7.878","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.559","633","85.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.066","1.231","94.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.320","1.452","70.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":767},{"label":"Mar","value":610},{"label":"Abr","value":595},{"label":"Mai","value":605},{"label":"Jun","value":754},{"label":"Jul","value":561},{"label":"Ago","value":702},{"label":"Set","value":753},{"label":"Out","value":410},{"label":"Nov","value":479},{"label":"Dez","value":648}];
const MX = 767;
