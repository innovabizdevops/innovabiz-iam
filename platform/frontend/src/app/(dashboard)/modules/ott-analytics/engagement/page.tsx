...
const KPIS = [{"l":"eNPS","v":"86","t":"+7.6%","d":"up"},{"l":"Engagement (%)","v":"74.1%","t":"-0.1%","d":"down"},{"l":"Turnover (%)","v":"76.6%","t":"+3.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"436","t":"+13.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.394","2026-03-01","78","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.669","2026-03-11","86","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.401","2026-02-19","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.569","2026-02-05","95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.248","2026-02-20","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":824},{"label":"Mar","value":678},{"label":"Abr","value":811},{"label":"Mai","value":702},{"label":"Jun","value":677},{"label":"Jul","value":554},{"label":"Ago","value":468},{"label":"Set","value":535},{"label":"Out","value":767},{"label":"Nov","value":752},{"label":"Dez","value":450}];
const MX = 824;
