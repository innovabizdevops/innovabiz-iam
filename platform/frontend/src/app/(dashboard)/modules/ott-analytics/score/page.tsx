...
const PAGE = "Content Score";
const KPIS = [{"l":"Dashboards Ativos","v":"510","t":"+15.8%","d":"up"},{"l":"Queries/Dia","v":"502","t":"+3.3%","d":"up"},{"l":"Dados Processados (GB)","v":"1.484","t":"+9.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.990","t":"+5.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1939","2026-01-13","2.387","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","708","2026-01-11","7.402","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1280","2026-03-17","3.751","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3567","2026-02-06","8.741","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4780","2026-01-19","2.593","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":300},{"label":"Fev","value":413},{"label":"Mar","value":479},{"label":"Abr","value":474},{"label":"Mai","value":328},{"label":"Jun","value":417},{"label":"Jul","value":283},{"label":"Ago","value":280},{"label":"Set","value":329},{"label":"Out","value":551},{"label":"Nov","value":377},{"label":"Dez","value":631}];
const MX = 631;
