...
const PAGE = "Viewing Data";
const KPIS = [{"l":"Dashboards Ativos","v":"2.420","t":"+14.8%","d":"up"},{"l":"Queries/Dia","v":"3886","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.806","t":"+14.4%","d":"up"},{"l":"Utilizadores Analytics","v":"5.309","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2278","2026-03-21","1.032","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2328","2026-01-02","1.674","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4739","2026-03-21","2.414","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4996","2026-03-14","7.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4522","2026-01-28","5.923","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":651},{"label":"Mar","value":538},{"label":"Abr","value":598},{"label":"Mai","value":763},{"label":"Jun","value":581},{"label":"Jul","value":458},{"label":"Ago","value":462},{"label":"Set","value":651},{"label":"Out","value":765},{"label":"Nov","value":437},{"label":"Dez","value":642}];
const MX = 765;
