...
const PAGE = "Revenue Attr";
const KPIS = [{"l":"ARR (€M)","v":"€42.5M","t":"+0.0%","d":"up"},{"l":"MRR (€)","v":"€21955","t":"-2.6%","d":"down"},{"l":"Churn (%)","v":"82.5%","t":"+17.0%","d":"up"},{"l":"ARPU (€)","v":"€41491","t":"+16.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42004.23","6.431","€ 25790.19","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9286.27","2.386","€ 42216.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39344.19","4.527","€ 33736.34","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 28785.21","8.795","€ 46147.94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 43737.17","3.398","€ 4272.55","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":629},{"label":"Mar","value":851},{"label":"Abr","value":912},{"label":"Mai","value":549},{"label":"Jun","value":541},{"label":"Jul","value":666},{"label":"Ago","value":518},{"label":"Set","value":738},{"label":"Out","value":825},{"label":"Nov","value":562},{"label":"Dez","value":757}];
const MX = 912;
