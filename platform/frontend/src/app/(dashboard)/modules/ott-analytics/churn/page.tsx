...
const ACCENT = "#b45309";
const MODULE = "OTT Analytics";
const PAGE = "Churn Predict";
const KPIS = [{"l":"ARR (€M)","v":"€15.5M","t":"+7.2%","d":"up"},{"l":"MRR (€)","v":"€19208","t":"+11.0%","d":"up"},{"l":"Churn (%)","v":"90.8%","t":"+8.7%","d":"up"},{"l":"ARPU (€)","v":"€27010","t":"+4.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 24347.22","7.478","€ 39928.10","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 18091.53","7.157","€ 26728.94","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 3717.23","6.404","€ 40345.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7716.34","7.758","€ 13882.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 34368.68","4.007","€ 32612.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":710},{"label":"Mar","value":576},{"label":"Abr","value":556},{"label":"Mai","value":693},{"label":"Jun","value":738},{"label":"Jul","value":822},{"label":"Ago","value":629},{"label":"Set","value":723},{"label":"Out","value":857},{"label":"Nov","value":614},{"label":"Dez","value":678}];
const MX = 857;
