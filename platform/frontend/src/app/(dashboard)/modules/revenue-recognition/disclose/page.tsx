...
const PAGE = "Disclose";
const KPIS = [{"l":"ARR (€M)","v":"€49.0M","t":"+4.0%","d":"up"},{"l":"MRR (€)","v":"€25465","t":"+17.7%","d":"up"},{"l":"Churn (%)","v":"75.0%","t":"+10.4%","d":"up"},{"l":"ARPU (€)","v":"€92358","t":"-4.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 23925.08","217","€ 28908.80","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8698.08","403","€ 21618.44","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46860.59","2.540","€ 27847.70","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 9378.62","6.572","€ 21745.63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 14475.09","3.234","€ 28020.95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":559},{"label":"Mar","value":453},{"label":"Abr","value":416},{"label":"Mai","value":662},{"label":"Jun","value":347},{"label":"Jul","value":579},{"label":"Ago","value":494},{"label":"Set","value":528},{"label":"Out","value":475},{"label":"Nov","value":370},{"label":"Dez","value":598}];
const MX = 662;
