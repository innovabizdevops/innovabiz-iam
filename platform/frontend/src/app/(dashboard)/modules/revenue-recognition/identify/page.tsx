...
const PAGE = "Identify";
const KPIS = [{"l":"ARR (€M)","v":"€39.5M","t":"-2.5%","d":"down"},{"l":"MRR (€)","v":"€8454","t":"+4.4%","d":"up"},{"l":"Churn (%)","v":"75.6%","t":"+5.7%","d":"up"},{"l":"ARPU (€)","v":"€35495","t":"+7.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 31251.48","603","€ 47708.42","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48305.08","4.754","€ 11746.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25322.79","8.141","€ 35302.41","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 14863.50","6.898","€ 20686.41","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49388.60","5.842","€ 20004.77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1048},{"label":"Fev","value":863},{"label":"Mar","value":781},{"label":"Abr","value":792},{"label":"Mai","value":861},{"label":"Jun","value":732},{"label":"Jul","value":822},{"label":"Ago","value":1063},{"label":"Set","value":966},{"label":"Out","value":1009},{"label":"Nov","value":889},{"label":"Dez","value":728}];
const MX = 1063;
