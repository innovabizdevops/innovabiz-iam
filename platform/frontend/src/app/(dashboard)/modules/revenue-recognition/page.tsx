...
/* ═══ Revenue Recognition (ASC 606) — Dashboard ═══ */

const ACCENT = "#c74634";

const KPIS = [
    { label: "Total Registos", value: "5957", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1111", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€125K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "406866157", cells: ["REV-4157", "Revenue Recognition (ASC 606) Item 1", "6/2/2026", "€16 257"], status: "active" as const },
    { id: "406869728", cells: ["REV-7728", "Revenue Recognition (ASC 606) Item 2", "21/9/2026", "€19 828"], status: "pending" as const },
    { id: "406873299", cells: ["REV-2299", "Revenue Recognition (ASC 606) Item 3", "8/4/2026", "€23 399"], status: "completed" as const },
    { id: "406876870", cells: ["REV-5870", "Revenue Recognition (ASC 606) Item 4", "23/11/2026", "€26 970"], status: "warning" as const },
    { id: "406880441", cells: ["REV-9441", "Revenue Recognition (ASC 606) Item 5", "10/6/2026", "€30 541"], status: "active" as const },
];
...
export default function RevenueRecognitionAsc606Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Revenue Recognition (ASC 606)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Revenue Recognition (ASC 606)</p>
                    </div>
                </div>
