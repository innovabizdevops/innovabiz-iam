...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.354","t":"+14.1%","d":"up"},{"l":"NC Abertas","v":"6.075","t":"-4.8%","d":"down"},{"l":"Conformidade (%)","v":"84.2%","t":"+0.2%","d":"up"},{"l":"CAPAs Pendentes","v":"5.441","t":"+14.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.944","75.9%","4.817","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","558","70.5%","1.087","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.479","90.7%","1.840","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.917","85.4%","2.001","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.367","92.7%","5.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":479},{"label":"Mar","value":255},{"label":"Abr","value":473},{"label":"Mai","value":607},{"label":"Jun","value":468},{"label":"Jul","value":364},{"label":"Ago","value":568},{"label":"Set","value":420},{"label":"Out","value":460},{"label":"Nov","value":505},{"label":"Dez","value":282}];
const MX = 607;
