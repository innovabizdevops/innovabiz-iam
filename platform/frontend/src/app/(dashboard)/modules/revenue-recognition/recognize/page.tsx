...
const ACCENT = "#c74634";
const MODULE = "Revenue Recognition (ASC 606)";
const PAGE = "Recognize";
const KPIS = [{"l":"ARR (€M)","v":"€27.1M","t":"+7.8%","d":"up"},{"l":"MRR (€)","v":"€23480","t":"+1.3%","d":"up"},{"l":"Churn (%)","v":"86.5%","t":"+0.7%","d":"up"},{"l":"ARPU (€)","v":"€55014","t":"+8.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28946.17","5.999","€ 25941.25","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 35072.29","5.611","€ 21596.37","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29605.28","9.036","€ 34227.00","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 20293.41","2.608","€ 42340.64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13984.13","4.246","€ 5566.15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":995},{"label":"Mar","value":946},{"label":"Abr","value":752},{"label":"Mai","value":954},{"label":"Jun","value":980},{"label":"Jul","value":1056},{"label":"Ago","value":706},{"label":"Set","value":777},{"label":"Out","value":860},{"label":"Nov","value":1011},{"label":"Dez","value":1043}];
const MX = 1056;
