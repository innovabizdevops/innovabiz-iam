...
const PAGE = "Allocate";
const KPIS = [{"l":"ARR (€M)","v":"€50.0M","t":"+17.1%","d":"up"},{"l":"MRR (€)","v":"€73191","t":"+11.1%","d":"up"},{"l":"Churn (%)","v":"81.1%","t":"+8.8%","d":"up"},{"l":"ARPU (€)","v":"€93549","t":"+7.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 20247.92","1.989","€ 15040.41","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 18715.93","3.304","€ 48954.13","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37521.26","3.980","€ 41668.71","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 20438.36","5.251","€ 1622.71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5499.25","4.688","€ 29443.24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":663},{"label":"Mar","value":359},{"label":"Abr","value":343},{"label":"Mai","value":485},{"label":"Jun","value":695},{"label":"Jul","value":535},{"label":"Ago","value":601},{"label":"Set","value":504},{"label":"Out","value":633},{"label":"Nov","value":641},{"label":"Dez","value":501}];
const MX = 695;
