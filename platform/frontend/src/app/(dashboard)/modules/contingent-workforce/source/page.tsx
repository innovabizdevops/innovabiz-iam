...
const ACCENT = "#0e7490";
const MODULE = "Contingent Workforce Mgmt";
const PAGE = "Source";
const KPIS = [{"l":"eNPS","v":"95","t":"-3.0%","d":"down"},{"l":"Engagement (%)","v":"66.2%","t":"+17.4%","d":"up"},{"l":"Turnover (%)","v":"65.5%","t":"+10.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.707","t":"+0.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.056","2026-03-22","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.345","2026-01-08","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.084","2026-02-27","87","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.343","2026-01-12","70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.116","2026-03-03","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":422},{"label":"Mar","value":674},{"label":"Abr","value":487},{"label":"Mai","value":612},{"label":"Jun","value":672},{"label":"Jul","value":418},{"label":"Ago","value":687},{"label":"Set","value":628},{"label":"Out","value":472},{"label":"Nov","value":457},{"label":"Dez","value":445}];
const MX = 714;
