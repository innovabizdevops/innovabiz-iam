...
const PAGE = "Comply";
const KPIS = [{"l":"eNPS","v":"82","t":"-4.2%","d":"down"},{"l":"Engagement (%)","v":"91.2%","t":"-4.2%","d":"down"},{"l":"Turnover (%)","v":"85.0%","t":"+15.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.482","t":"+1.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.029","2026-02-19","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.489","2026-01-16","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.274","2026-02-23","89","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.374","2026-02-14","65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","257","2026-01-26","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":818},{"label":"Mar","value":773},{"label":"Abr","value":930},{"label":"Mai","value":831},{"label":"Jun","value":705},{"label":"Jul","value":584},{"label":"Ago","value":960},{"label":"Set","value":594},{"label":"Out","value":582},{"label":"Nov","value":591},{"label":"Dez","value":818}];
const MX = 960;
