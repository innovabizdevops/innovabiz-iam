...
const PAGE = "Manage";
const KPIS = [{"l":"eNPS","v":"80","t":"-5.5%","d":"down"},{"l":"Engagement (%)","v":"81.1%","t":"+7.4%","d":"up"},{"l":"Turnover (%)","v":"85.6%","t":"-3.1%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"8.280","t":"-3.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.107","2026-03-26","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","594","2026-02-17","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.535","2026-03-26","72","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.555","2026-02-05","81","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.768","2026-01-17","87","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":641},{"label":"Mar","value":579},{"label":"Abr","value":832},{"label":"Mai","value":663},{"label":"Jun","value":637},{"label":"Jul","value":744},{"label":"Ago","value":832},{"label":"Set","value":793},{"label":"Out","value":907},{"label":"Nov","value":622},{"label":"Dez","value":667}];
const MX = 907;
