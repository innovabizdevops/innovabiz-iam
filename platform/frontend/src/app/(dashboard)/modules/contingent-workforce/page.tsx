...
/* ═══ Contingent Workforce Mgmt — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "3369", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4272", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€78K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "266758769", cells: ["CON-8769", "Contingent Workforce Mgmt Item 1", "26/6/2026", "€8869"], status: "active" as const },
    { id: "266762340", cells: ["CON-3340", "Contingent Workforce Mgmt Item 2", "13/1/2026", "€12 440"], status: "pending" as const },
    { id: "266765911", cells: ["CON-6911", "Contingent Workforce Mgmt Item 3", "28/8/2026", "€16 011"], status: "completed" as const },
    { id: "266769482", cells: ["CON-1482", "Contingent Workforce Mgmt Item 4", "15/3/2026", "€19 582"], status: "warning" as const },
    { id: "266773053", cells: ["CON-5053", "Contingent Workforce Mgmt Item 5", "2/10/2026", "€23 153"], status: "active" as const },
];
...
export default function ContingentWorkforceMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contingent Workforce Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Contingent Workforce Mgmt</p>
                    </div>
                </div>
