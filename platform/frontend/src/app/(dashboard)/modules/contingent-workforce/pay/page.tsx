...
const PAGE = "Pay";
const KPIS = [{"l":"eNPS","v":"60","t":"+11.0%","d":"up"},{"l":"Engagement (%)","v":"73.1%","t":"+5.5%","d":"up"},{"l":"Turnover (%)","v":"80.5%","t":"+16.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.370","t":"-3.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.080","2026-02-22","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.631","2026-01-24","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.124","2026-02-26","85","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.826","2026-01-10","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.582","2026-01-12","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":806},{"label":"Mar","value":782},{"label":"Abr","value":570},{"label":"Mai","value":760},{"label":"Jun","value":690},{"label":"Jul","value":689},{"label":"Ago","value":803},{"label":"Set","value":765},{"label":"Out","value":813},{"label":"Nov","value":801},{"label":"Dez","value":575}];
const MX = 813;
