...
const PAGE = "Engage";
const KPIS = [{"l":"eNPS","v":"80","t":"+5.4%","d":"up"},{"l":"Engagement (%)","v":"92.4%","t":"+2.9%","d":"up"},{"l":"Turnover (%)","v":"87.1%","t":"+13.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.776","t":"+14.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.687","2026-01-16","74","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.330","2026-01-12","89","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.872","2026-03-27","61","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.218","2026-02-26","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.485","2026-03-03","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":762},{"label":"Mar","value":1047},{"label":"Abr","value":812},{"label":"Mai","value":743},{"label":"Jun","value":732},{"label":"Jul","value":1074},{"label":"Ago","value":872},{"label":"Set","value":960},{"label":"Out","value":957},{"label":"Nov","value":1003},{"label":"Dez","value":754}];
const MX = 1074;
