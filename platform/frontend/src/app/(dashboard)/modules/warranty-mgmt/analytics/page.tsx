...
const KPIS = [{"l":"ARR (€M)","v":"€38.8M","t":"-3.5%","d":"down"},{"l":"MRR (€)","v":"€68794","t":"+2.2%","d":"up"},{"l":"Churn (%)","v":"94.6%","t":"-4.1%","d":"down"},{"l":"ARPU (€)","v":"€84813","t":"+9.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30496.68","8.819","€ 40182.11","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 42702.18","6.712","€ 11470.76","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 8579.04","3.404","€ 6628.31","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 34406.58","5.892","€ 17957.26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 27513.92","7.493","€ 23745.31","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":860},{"label":"Mar","value":630},{"label":"Abr","value":649},{"label":"Mai","value":583},{"label":"Jun","value":685},{"label":"Jul","value":539},{"label":"Ago","value":741},{"label":"Set","value":776},{"label":"Out","value":586},{"label":"Nov","value":857},{"label":"Dez","value":532}];
const MX = 860;
