...
const PAGE = "Claim";
const KPIS = [{"l":"ARR (€M)","v":"€46.7M","t":"+0.6%","d":"up"},{"l":"MRR (€)","v":"€83578","t":"+0.8%","d":"up"},{"l":"Churn (%)","v":"65.4%","t":"+5.6%","d":"up"},{"l":"ARPU (€)","v":"€30681","t":"+17.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 23387.55","7.932","€ 23625.61","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 45750.85","8.264","€ 43594.13","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 10592.62","871","€ 37785.44","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49989.40","2.596","€ 7292.08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42652.11","720","€ 9971.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":282},{"label":"Mar","value":372},{"label":"Abr","value":607},{"label":"Mai","value":240},{"label":"Jun","value":543},{"label":"Jul","value":557},{"label":"Ago","value":528},{"label":"Set","value":275},{"label":"Out","value":285},{"label":"Nov","value":568},{"label":"Dez","value":225}];
const MX = 607;
