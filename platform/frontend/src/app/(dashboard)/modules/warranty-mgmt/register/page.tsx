...
const PAGE = "Register";
const KPIS = [{"l":"ARR (€M)","v":"€7.4M","t":"-4.1%","d":"down"},{"l":"MRR (€)","v":"€87244","t":"+5.6%","d":"up"},{"l":"Churn (%)","v":"66.6%","t":"+8.6%","d":"up"},{"l":"ARPU (€)","v":"€97939","t":"+2.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49149.98","5.665","€ 21537.28","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11294.50","3.738","€ 3693.40","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 15259.31","8.598","€ 19760.64","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 8987.89","1.449","€ 48504.97","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8350.12","6.936","€ 47935.76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":357},{"label":"Mar","value":327},{"label":"Abr","value":362},{"label":"Mai","value":665},{"label":"Jun","value":355},{"label":"Jul","value":626},{"label":"Ago","value":418},{"label":"Set","value":640},{"label":"Out","value":621},{"label":"Nov","value":300},{"label":"Dez","value":363}];
const MX = 665;
