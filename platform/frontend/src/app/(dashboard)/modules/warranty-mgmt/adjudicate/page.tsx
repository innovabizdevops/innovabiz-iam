...
const ACCENT = "#047857";
const MODULE = "Warranty Management";
const PAGE = "Adjudicate";
const KPIS = [{"l":"ARR (€M)","v":"€4.4M","t":"+11.9%","d":"up"},{"l":"MRR (€)","v":"€83498","t":"-2.4%","d":"down"},{"l":"Churn (%)","v":"66.8%","t":"-3.5%","d":"down"},{"l":"ARPU (€)","v":"€14694","t":"+8.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 4589.52","6.050","€ 49750.71","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 16458.31","360","€ 18539.51","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 24385.78","4.695","€ 27345.97","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 22123.47","3.420","€ 9172.94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 3989.83","5.593","€ 46353.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":891},{"label":"Mar","value":909},{"label":"Abr","value":990},{"label":"Mai","value":789},{"label":"Jun","value":939},{"label":"Jul","value":963},{"label":"Ago","value":830},{"label":"Set","value":719},{"label":"Out","value":737},{"label":"Nov","value":809},{"label":"Dez","value":974}];
const MX = 990;
