...
const PAGE = "Reserve";
const KPIS = [{"l":"ARR (€M)","v":"€45.0M","t":"+17.7%","d":"up"},{"l":"MRR (€)","v":"€43865","t":"+13.1%","d":"up"},{"l":"Churn (%)","v":"94.8%","t":"+13.2%","d":"up"},{"l":"ARPU (€)","v":"€4377","t":"+9.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42612.03","8.767","€ 35087.77","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 47362.67","7.529","€ 6307.99","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 14473.21","4.862","€ 49058.84","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 8920.32","6.363","€ 4838.44","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39084.22","7.143","€ 43352.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":892},{"label":"Mar","value":775},{"label":"Abr","value":745},{"label":"Mai","value":796},{"label":"Jun","value":721},{"label":"Jul","value":826},{"label":"Ago","value":643},{"label":"Set","value":580},{"label":"Out","value":592},{"label":"Nov","value":844},{"label":"Dez","value":647}];
const MX = 940;
