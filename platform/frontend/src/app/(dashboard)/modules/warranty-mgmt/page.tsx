...
const KPIS = [
    { label: "Total Registos", value: "3963", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "325", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€363K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1661738663", cells: ["WAR-6663", "Warranty Management Item 1", "12/12/2026", "€38 763"], status: "active" as const },
    { id: "1661742234", cells: ["WAR-1234", "Warranty Management Item 2", "27/7/2026", "€42 334"], status: "pending" as const },
    { id: "1661745805", cells: ["WAR-4805", "Warranty Management Item 3", "14/2/2026", "€45 905"], status: "completed" as const },
    { id: "1661749376", cells: ["WAR-8376", "Warranty Management Item 4", "1/9/2026", "€49 476"], status: "warning" as const },
    { id: "1661752947", cells: ["WAR-2947", "Warranty Management Item 5", "16/4/2026", "€3047"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Warranty Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Warranty Management</p>
                    </div>
                </div>
