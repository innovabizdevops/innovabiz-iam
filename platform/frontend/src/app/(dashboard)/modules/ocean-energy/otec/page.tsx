...
const PAGE = "OTEC";
const KPIS = [{"l":"Total Ocean Energy","v":"8.971","t":"-5.6%","d":"down"},{"l":"OTEC Ativos","v":"5.614","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"92","t":"+12.8%","d":"up"}];
const COLS = ["ID","OTEC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Energy #001","Ocean Energy #002","1.548","5.192","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Energy #002","Ocean Energy #003","1.028","6.238","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Energy #003","Ocean Energy #004","8.393","7.193","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Energy #004","Ocean Energy #005","529","7.888","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Energy #005","Ocean Energy #001","6.701","6.776","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":569},{"label":"Mar","value":789},{"label":"Abr","value":470},{"label":"Mai","value":551},{"label":"Jun","value":627},{"label":"Jul","value":780},{"label":"Ago","value":503},{"label":"Set","value":651},{"label":"Out","value":421},{"label":"Nov","value":497},{"label":"Dez","value":669}];
const MX = 789;
