...
const PAGE = "Wave";
const KPIS = [{"l":"Total Ocean Energy","v":"3.846","t":"+17.1%","d":"up"},{"l":"Wave Ativos","v":"4.898","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"88","t":"+16.8%","d":"up"}];
const COLS = ["ID","Wave","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Energy #001","Ocean Energy #002","2.201","7.495","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Energy #002","Ocean Energy #003","3.409","3.410","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Energy #003","Ocean Energy #004","3.922","2.439","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Energy #004","Ocean Energy #005","1.898","7.843","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Energy #005","Ocean Energy #001","4.899","1.584","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":656},{"label":"Mar","value":807},{"label":"Abr","value":664},{"label":"Mai","value":723},{"label":"Jun","value":442},{"label":"Jul","value":612},{"label":"Ago","value":760},{"label":"Set","value":760},{"label":"Out","value":472},{"label":"Nov","value":735},{"label":"Dez","value":629}];
const MX = 807;
