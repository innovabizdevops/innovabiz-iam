...
const ACCENT = "#6366f1";
const MODULE = "Ocean Energy";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Ocean Energy","v":"514","t":"+14.2%","d":"up"},{"l":"Monitor Ativos","v":"641","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"65.9%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"72","t":"+17.9%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Energy #001","Ocean Energy #002","6.369","572","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Energy #002","Ocean Energy #003","8.037","3.873","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Energy #003","Ocean Energy #004","2.267","2.078","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Energy #004","Ocean Energy #005","1.425","4.306","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Energy #005","Ocean Energy #001","4.633","5.427","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":417},{"label":"Mar","value":284},{"label":"Abr","value":650},{"label":"Mai","value":305},{"label":"Jun","value":582},{"label":"Jul","value":344},{"label":"Ago","value":290},{"label":"Set","value":654},{"label":"Out","value":457},{"label":"Nov","value":508},{"label":"Dez","value":305}];
const MX = 665;
