...
const PAGE = "Tidal";
const KPIS = [{"l":"Total Ocean Energy","v":"8.967","t":"+0.8%","d":"up"},{"l":"Tidal Ativos","v":"7.816","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+2.6%","d":"up"}];
const COLS = ["ID","Tidal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Energy #001","Ocean Energy #002","8.497","1.016","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Energy #002","Ocean Energy #003","7.437","8.197","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Energy #003","Ocean Energy #004","2.969","8.473","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Energy #004","Ocean Energy #005","4.918","7.688","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Energy #005","Ocean Energy #001","2.856","3.142","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":526},{"label":"Mar","value":638},{"label":"Abr","value":772},{"label":"Mai","value":788},{"label":"Jun","value":844},{"label":"Jul","value":854},{"label":"Ago","value":496},{"label":"Set","value":517},{"label":"Out","value":797},{"label":"Nov","value":530},{"label":"Dez","value":804}];
const MX = 854;
