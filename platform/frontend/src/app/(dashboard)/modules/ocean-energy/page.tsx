...
export default function OceanEnergyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ocean Energy</h1><p className="text-sm text-muted-foreground">Ocean Energy • iBOS Enterprise</p></div>
