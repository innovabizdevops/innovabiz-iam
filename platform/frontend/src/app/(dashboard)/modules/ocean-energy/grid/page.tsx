...
const PAGE = "Grid";
const KPIS = [{"l":"Total Ocean Energy","v":"3.717","t":"+1.0%","d":"up"},{"l":"Grid Ativos","v":"6.428","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"83","t":"+17.8%","d":"up"}];
const COLS = ["ID","Grid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocean Energy #001","Ocean Energy #002","6.997","7.135","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ocean Energy #002","Ocean Energy #003","8.116","6.754","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocean Energy #003","Ocean Energy #004","4.539","5.725","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Ocean Energy #004","Ocean Energy #005","4.849","8.397","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocean Energy #005","Ocean Energy #001","6.220","870","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":544},{"label":"Mar","value":406},{"label":"Abr","value":488},{"label":"Mai","value":574},{"label":"Jun","value":471},{"label":"Jul","value":243},{"label":"Ago","value":462},{"label":"Set","value":580},{"label":"Out","value":546},{"label":"Nov","value":464},{"label":"Dez","value":311}];
const MX = 580;
