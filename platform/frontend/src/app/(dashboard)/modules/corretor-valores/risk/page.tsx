...
const PAGE = "Risco Mercado";
const KPIS = [{"l":"Riscos Identificados","v":"2.352","t":"+1.5%","d":"up"},{"l":"Mitigações Ativas","v":"457","t":"+2.7%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"+3.6%","d":"up"},{"l":"Incidentes YTD","v":"5.081","t":"+1.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.352","8.341","5.521","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.527","3.841","7.915","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.034","8.661","7.941","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.392","2.982","8.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.393","238","4.462","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":598},{"label":"Mar","value":377},{"label":"Abr","value":414},{"label":"Mai","value":582},{"label":"Jun","value":484},{"label":"Jul","value":569},{"label":"Ago","value":455},{"label":"Set","value":682},{"label":"Out","value":393},{"label":"Nov","value":533},{"label":"Dez","value":643}];
const MX = 682;
