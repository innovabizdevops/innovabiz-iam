...
const ACCENT = "#0891b2";
const MODULE = "Corretores Valores Mobiliários";
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"8.957","t":"+8.1%","d":"up"},{"l":"Patentes (YTD)","v":"5.343","t":"-1.6%","d":"down"},{"l":"Projetos Innovation Lab","v":"7.509","t":"+9.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€45.3M","t":"+16.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.533","76.1%","2.580","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","549","91.7%","2.745","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.796","90.3%","2.049","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.482","92.2%","3.398","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.214","83.5%","8.046","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":593},{"label":"Mar","value":727},{"label":"Abr","value":399},{"label":"Mai","value":687},{"label":"Jun","value":405},{"label":"Jul","value":496},{"label":"Ago","value":514},{"label":"Set","value":424},{"label":"Out","value":630},{"label":"Nov","value":442},{"label":"Dez","value":472}];
const MX = 727;
