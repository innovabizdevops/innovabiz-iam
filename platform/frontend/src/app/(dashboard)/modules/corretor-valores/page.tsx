...
export default function CorretorValoresPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Corretor Valores</h1><p className="text-sm text-muted-foreground">Corretor Valores • iBOS Enterprise</p></div>
