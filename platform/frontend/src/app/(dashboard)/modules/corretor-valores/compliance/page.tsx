...
const PAGE = "Compliance CMVM";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.477","t":"-4.2%","d":"down"},{"l":"NC Abertas","v":"7.625","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"77.1%","t":"+14.7%","d":"up"},{"l":"CAPAs Pendentes","v":"3.070","t":"-0.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.174","96.1%","7.467","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.881","80.7%","7.526","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.355","79.3%","3.685","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.337","90.3%","6.743","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.138","73.6%","7.257","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":539},{"label":"Mar","value":741},{"label":"Abr","value":797},{"label":"Mai","value":801},{"label":"Jun","value":763},{"label":"Jul","value":485},{"label":"Ago","value":755},{"label":"Set","value":644},{"label":"Out","value":739},{"label":"Nov","value":551},{"label":"Dez","value":564}];
const MX = 801;
