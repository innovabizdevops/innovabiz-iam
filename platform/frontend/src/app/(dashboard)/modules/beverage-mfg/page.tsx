...
export default function BeverageMfgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Beverage Mfg</h1><p className="text-sm text-muted-foreground">Beverage Mfg • iBOS Enterprise</p></div>
