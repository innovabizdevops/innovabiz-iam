...
const PAGE = "Formula";
const KPIS = [{"l":"Formulários Ativos","v":"5.651","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"2239","t":"+4.6%","d":"up"},{"l":"Documentos Gerados","v":"3.520","t":"-2.7%","d":"down"},{"l":"Templates","v":"2.832","t":"+4.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.094","2026-01-14","8.101","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.347","2026-03-17","2.079","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.906","2026-03-04","8.673","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.967","2026-02-23","2.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","801","2026-01-09","7.152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":367},{"label":"Mar","value":408},{"label":"Abr","value":360},{"label":"Mai","value":287},{"label":"Jun","value":275},{"label":"Jul","value":485},{"label":"Ago","value":454},{"label":"Set","value":444},{"label":"Out","value":383},{"label":"Nov","value":470},{"label":"Dez","value":450}];
const MX = 485;
