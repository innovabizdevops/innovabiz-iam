...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.008","t":"-1.6%","d":"down"},{"l":"NC Abertas","v":"3.611","t":"+8.3%","d":"up"},{"l":"Conformidade (%)","v":"68.4%","t":"-1.7%","d":"down"},{"l":"CAPAs Pendentes","v":"5.035","t":"+-0.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.988","74.6%","2.040","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.207","97.7%","1.493","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.283","98.2%","2.013","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.614","73.8%","6.514","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.815","93.7%","1.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":408},{"label":"Mar","value":562},{"label":"Abr","value":334},{"label":"Mai","value":475},{"label":"Jun","value":607},{"label":"Jul","value":592},{"label":"Ago","value":488},{"label":"Set","value":617},{"label":"Out","value":626},{"label":"Nov","value":308},{"label":"Dez","value":345}];
const MX = 626;
