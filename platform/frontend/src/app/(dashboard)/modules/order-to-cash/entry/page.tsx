...
const ACCENT = "#059669";
const MODULE = "Order-to-Cash (APQC 4.1)";
const PAGE = "Order Entry";
const KPIS = [{"l":"Total Order To Cash","v":"6.179","t":"-1.6%","d":"down"},{"l":"Order Entry Ativos","v":"8.640","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+17.5%","d":"up"}];
const COLS = ["ID","Order Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Order To Cash #001","Order To Cash #002","3.013","282","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Order To Cash #002","Order To Cash #003","1.496","2.081","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Order To Cash #003","Order To Cash #004","431","8.205","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Order To Cash #004","Order To Cash #005","4.966","6.833","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Order To Cash #005","Order To Cash #001","114","2.957","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":755},{"label":"Mar","value":920},{"label":"Abr","value":723},{"label":"Mai","value":734},{"label":"Jun","value":762},{"label":"Jul","value":574},{"label":"Ago","value":744},{"label":"Set","value":699},{"label":"Out","value":716},{"label":"Nov","value":646},{"label":"Dez","value":778}];
const MX = 920;
