...
const PAGE = "Invoice";
const KPIS = [{"l":"Total Order To Cash","v":"7.757","t":"+13.2%","d":"up"},{"l":"Invoice Ativos","v":"5.781","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+0.4%","d":"up"}];
const COLS = ["ID","Invoice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Order To Cash #001","Order To Cash #002","3.486","3.350","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Order To Cash #002","Order To Cash #003","2.618","2.940","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Order To Cash #003","Order To Cash #004","801","657","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Order To Cash #004","Order To Cash #005","4.159","6.955","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Order To Cash #005","Order To Cash #001","5.566","2.006","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":447},{"label":"Mar","value":320},{"label":"Abr","value":324},{"label":"Mai","value":610},{"label":"Jun","value":436},{"label":"Jul","value":237},{"label":"Ago","value":521},{"label":"Set","value":328},{"label":"Out","value":407},{"label":"Nov","value":415},{"label":"Dez","value":475}];
const MX = 610;
