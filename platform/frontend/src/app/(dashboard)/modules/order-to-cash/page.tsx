...
/* ═══ Order-to-Cash (APQC 4.1) — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "4077", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3412", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€16K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2147224877", cells: ["ORD-5877", "Order-to-Cash (APQC 4.1) Item 1", "22/6/2026", "€24 977"], status: "active" as const },
    { id: "2147228448", cells: ["ORD-9448", "Order-to-Cash (APQC 4.1) Item 2", "9/1/2026", "€28 548"], status: "pending" as const },
    { id: "2147232019", cells: ["ORD-4019", "Order-to-Cash (APQC 4.1) Item 3", "24/8/2026", "€32 119"], status: "completed" as const },
    { id: "2147235590", cells: ["ORD-7590", "Order-to-Cash (APQC 4.1) Item 4", "11/3/2026", "€35 690"], status: "warning" as const },
    { id: "2147239161", cells: ["ORD-2161", "Order-to-Cash (APQC 4.1) Item 5", "26/10/2026", "€39 261"], status: "active" as const },
];
...
export default function OrdertocashApqc41Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Order-to-Cash (APQC 4.1)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Order-to-Cash (APQC 4.1)</p>
                    </div>
                </div>
