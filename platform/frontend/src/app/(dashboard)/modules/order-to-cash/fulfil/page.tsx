...
const PAGE = "Fulfil";
const KPIS = [{"l":"Total Order To Cash","v":"7.955","t":"-5.4%","d":"down"},{"l":"Fulfil Ativos","v":"1.404","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"72.8%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"64","t":"+1.7%","d":"up"}];
const COLS = ["ID","Fulfil","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Order To Cash #001","Order To Cash #002","9.054","3.143","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Order To Cash #002","Order To Cash #003","7.319","4.427","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Order To Cash #003","Order To Cash #004","7.966","2.221","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Order To Cash #004","Order To Cash #005","2.172","7.423","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Order To Cash #005","Order To Cash #001","6.446","6.047","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":514},{"label":"Mar","value":429},{"label":"Abr","value":330},{"label":"Mai","value":444},{"label":"Jun","value":525},{"label":"Jul","value":631},{"label":"Ago","value":542},{"label":"Set","value":328},{"label":"Out","value":549},{"label":"Nov","value":283},{"label":"Dez","value":307}];
const MX = 631;
