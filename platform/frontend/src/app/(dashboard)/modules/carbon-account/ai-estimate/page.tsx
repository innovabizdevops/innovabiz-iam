...
const ACCENT = "#475569";
const MODULE = "Carbon Accounting";
const PAGE = "AI Estimation";
const KPIS = [{"l":"Total Carbon Account","v":"2.427","t":"-5.6%","d":"down"},{"l":"AI Estimation Ativos","v":"1.495","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"72","t":"+11.7%","d":"up"}];
const COLS = ["ID","AI Estimation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Account #001","Carbon Account #002","5.579","5.838","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Account #002","Carbon Account #003","8.201","4.647","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Account #003","Carbon Account #004","8.005","3.481","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Account #004","Carbon Account #005","7.103","5.801","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Account #005","Carbon Account #001","5.153","4.385","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":507},{"label":"Mar","value":278},{"label":"Abr","value":510},{"label":"Mai","value":573},{"label":"Jun","value":490},{"label":"Jul","value":280},{"label":"Ago","value":369},{"label":"Set","value":269},{"label":"Out","value":302},{"label":"Nov","value":439},{"label":"Dez","value":314}];
const MX = 573;
