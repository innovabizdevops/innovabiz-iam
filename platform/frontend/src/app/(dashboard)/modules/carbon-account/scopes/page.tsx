...
const KPIS = [{"l":"Total Carbon Account","v":"1.746","t":"+12.3%","d":"up"},{"l":"Scope 1/2/3 Ativos","v":"1.507","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"67","t":"+3.6%","d":"up"}];
const COLS = ["ID","Scope 1/2/3","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Account #001","Carbon Account #002","233","4.067","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Account #002","Carbon Account #003","1.905","8.182","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Account #003","Carbon Account #004","790","2.150","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Account #004","Carbon Account #005","7.577","1.868","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Account #005","Carbon Account #001","6.406","9.012","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":494},{"label":"Mar","value":756},{"label":"Abr","value":640},{"label":"Mai","value":685},{"label":"Jun","value":578},{"label":"Jul","value":598},{"label":"Ago","value":642},{"label":"Set","value":799},{"label":"Out","value":608},{"label":"Nov","value":655},{"label":"Dez","value":581}];
const MX = 799;
