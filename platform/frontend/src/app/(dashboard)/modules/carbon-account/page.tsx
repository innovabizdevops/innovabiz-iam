...
export default function CarbonAccountPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Carbon Account</h1><p className="text-sm text-muted-foreground">Carbon Account • iBOS Enterprise</p></div>
