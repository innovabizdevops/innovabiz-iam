...
const PAGE = "SBTi Target";
const KPIS = [{"l":"Total Carbon Account","v":"853","t":"+7.0%","d":"up"},{"l":"SBTi Target Ativos","v":"2.654","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"92.5%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.9%","d":"down"}];
const COLS = ["ID","SBTi Target","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Account #001","Carbon Account #002","8.294","5.686","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Account #002","Carbon Account #003","1.218","6.147","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Account #003","Carbon Account #004","8.301","5.013","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Account #004","Carbon Account #005","5.844","3.615","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Account #005","Carbon Account #001","3.639","7.546","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":795},{"label":"Mar","value":758},{"label":"Abr","value":835},{"label":"Mai","value":643},{"label":"Jun","value":493},{"label":"Jul","value":739},{"label":"Ago","value":512},{"label":"Set","value":747},{"label":"Out","value":492},{"label":"Nov","value":505},{"label":"Dez","value":836}];
const MX = 836;
