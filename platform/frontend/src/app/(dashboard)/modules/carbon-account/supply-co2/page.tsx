...
const PAGE = "Supply Chain CO2";
const KPIS = [{"l":"Total Carbon Account","v":"7.163","t":"-0.5%","d":"down"},{"l":"Supply Chain CO2 Ativos","v":"8.274","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"73","t":"+1.9%","d":"up"}];
const COLS = ["ID","Supply Chain CO2","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Account #001","Carbon Account #002","3.119","7.207","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Account #002","Carbon Account #003","6.747","6.473","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Account #003","Carbon Account #004","3.625","4.846","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Account #004","Carbon Account #005","8.496","3.372","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Account #005","Carbon Account #001","8.808","8.667","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":565},{"label":"Mar","value":567},{"label":"Abr","value":671},{"label":"Mai","value":645},{"label":"Jun","value":628},{"label":"Jul","value":439},{"label":"Ago","value":662},{"label":"Set","value":644},{"label":"Out","value":504},{"label":"Nov","value":382},{"label":"Dez","value":491}];
const MX = 671;
...
export default function SupplyCo2Page() {
    return (
