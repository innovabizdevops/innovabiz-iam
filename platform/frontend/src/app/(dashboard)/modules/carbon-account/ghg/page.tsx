...
const PAGE = "GHG Inventory";
const KPIS = [{"l":"Total Carbon Account","v":"5.219","t":"+8.6%","d":"up"},{"l":"GHG Inventory Ativos","v":"1.593","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+8.4%","d":"up"}];
const COLS = ["ID","GHG Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Account #001","Carbon Account #002","8.225","6.079","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Account #002","Carbon Account #003","6.707","8.380","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Account #003","Carbon Account #004","4.629","3.680","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Account #004","Carbon Account #005","7.271","3.527","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Account #005","Carbon Account #001","8.882","4.296","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":690},{"label":"Mar","value":434},{"label":"Abr","value":650},{"label":"Mai","value":388},{"label":"Jun","value":515},{"label":"Jul","value":696},{"label":"Ago","value":456},{"label":"Set","value":786},{"label":"Out","value":782},{"label":"Nov","value":669},{"label":"Dez","value":522}];
const MX = 786;
