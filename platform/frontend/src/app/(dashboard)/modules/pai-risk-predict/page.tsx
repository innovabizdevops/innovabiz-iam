...
/* ═══ P-AI Risk Prediction — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "5033", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "885", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€473K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "888737833", cells: ["PAI-6833", "P-AI Risk Prediction Item 1", "26/2/2026", "€37 933"], status: "active" as const },
    { id: "888741404", cells: ["PAI-1404", "P-AI Risk Prediction Item 2", "13/9/2026", "€41 504"], status: "pending" as const },
    { id: "888744975", cells: ["PAI-4975", "P-AI Risk Prediction Item 3", "28/4/2026", "€45 075"], status: "completed" as const },
    { id: "888748546", cells: ["PAI-8546", "P-AI Risk Prediction Item 4", "15/11/2026", "€48 646"], status: "warning" as const },
    { id: "888752117", cells: ["PAI-3117", "P-AI Risk Prediction Item 5", "2/6/2026", "€2217"], status: "active" as const },
];
...
export default function PaiRiskPredictionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Risk Prediction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Risk Prediction</p>
                    </div>
                </div>
