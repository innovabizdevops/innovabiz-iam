...
const PAGE = "Model";
const KPIS = [{"l":"Riscos Identificados","v":"7.245","t":"+11.8%","d":"up"},{"l":"Mitigações Ativas","v":"6.984","t":"+11.5%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+7.3%","d":"up"},{"l":"Incidentes YTD","v":"1.380","t":"+1.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.594","1.584","2.805","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.281","5.241","2.820","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.971","2.348","6.479","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.851","6.217","7.118","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.774","1.451","7.883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":441},{"label":"Mar","value":496},{"label":"Abr","value":307},{"label":"Mai","value":418},{"label":"Jun","value":317},{"label":"Jul","value":573},{"label":"Ago","value":291},{"label":"Set","value":559},{"label":"Out","value":372},{"label":"Nov","value":505},{"label":"Dez","value":585}];
const MX = 585;
