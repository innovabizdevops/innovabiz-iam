...
const PAGE = "Scenario";
const KPIS = [{"l":"Riscos Identificados","v":"2.850","t":"+8.7%","d":"up"},{"l":"Mitigações Ativas","v":"7.359","t":"+12.0%","d":"up"},{"l":"Score Risco Geral","v":"70","t":"+8.7%","d":"up"},{"l":"Incidentes YTD","v":"8.044","t":"+14.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.599","4.510","324","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.472","9.032","4.387","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.395","6.034","2.859","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.373","8.999","8.235","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","619","6.701","1.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":559},{"label":"Mar","value":529},{"label":"Abr","value":541},{"label":"Mai","value":554},{"label":"Jun","value":816},{"label":"Jul","value":582},{"label":"Ago","value":690},{"label":"Set","value":732},{"label":"Out","value":595},{"label":"Nov","value":803},{"label":"Dez","value":500}];
const MX = 816;
