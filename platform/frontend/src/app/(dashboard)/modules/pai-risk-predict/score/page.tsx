...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Risk Prediction";
const PAGE = "Score";
const KPIS = [{"l":"Riscos Identificados","v":"1.261","t":"+6.1%","d":"up"},{"l":"Mitigações Ativas","v":"8.188","t":"+15.4%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+9.7%","d":"up"},{"l":"Incidentes YTD","v":"5.053","t":"-4.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","656","8.593","2.088","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.075","1.481","4.428","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.166","2.445","6.708","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.997","1.098","227","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.400","7.086","3.471","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":823},{"label":"Mar","value":758},{"label":"Abr","value":907},{"label":"Mai","value":797},{"label":"Jun","value":777},{"label":"Jul","value":918},{"label":"Ago","value":817},{"label":"Set","value":796},{"label":"Out","value":1042},{"label":"Nov","value":769},{"label":"Dez","value":660}];
const MX = 1042;
