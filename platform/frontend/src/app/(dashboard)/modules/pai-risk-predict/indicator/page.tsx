...
const KPIS = [{"l":"Riscos Identificados","v":"6.320","t":"+1.4%","d":"up"},{"l":"Mitigações Ativas","v":"1.015","t":"+16.9%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+16.5%","d":"up"},{"l":"Incidentes YTD","v":"8.736","t":"+9.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.124","5.088","3.929","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.877","3.825","1.893","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.084","8.319","7.326","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","164","5.976","1.036","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","644","3.272","8.777","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":967},{"label":"Mar","value":779},{"label":"Abr","value":940},{"label":"Mai","value":1043},{"label":"Jun","value":700},{"label":"Jul","value":905},{"label":"Ago","value":814},{"label":"Set","value":907},{"label":"Out","value":1046},{"label":"Nov","value":835},{"label":"Dez","value":798}];
const MX = 1046;
