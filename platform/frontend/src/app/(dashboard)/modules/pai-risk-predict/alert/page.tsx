...
const PAGE = "Alert";
const KPIS = [{"l":"Riscos Identificados","v":"971","t":"-2.8%","d":"down"},{"l":"Mitigações Ativas","v":"2.200","t":"+16.4%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"-0.1%","d":"down"},{"l":"Incidentes YTD","v":"5.284","t":"+8.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","269","1.711","8.839","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.678","2.819","6.336","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.806","1.372","1.751","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.921","4.081","5.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.138","4.489","3.868","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":704},{"label":"Mar","value":477},{"label":"Abr","value":538},{"label":"Mai","value":508},{"label":"Jun","value":496},{"label":"Jul","value":573},{"label":"Ago","value":368},{"label":"Set","value":700},{"label":"Out","value":642},{"label":"Nov","value":704},{"label":"Dez","value":711}];
const MX = 711;
