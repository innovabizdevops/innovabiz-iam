...
/* ═══ EdTech Platform Deep — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "7759", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4002", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€120K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2117498859", cells: ["EDT-6859", "EdTech Platform Deep Item 1", "8/4/2026", "€48 959"], status: "active" as const },
    { id: "2117502430", cells: ["EDT-1430", "EdTech Platform Deep Item 2", "23/11/2026", "€2530"], status: "pending" as const },
    { id: "2117506001", cells: ["EDT-5001", "EdTech Platform Deep Item 3", "10/6/2026", "€6101"], status: "completed" as const },
    { id: "2117509572", cells: ["EDT-8572", "EdTech Platform Deep Item 4", "25/1/2026", "€9672"], status: "warning" as const },
    { id: "2117513143", cells: ["EDT-3143", "EdTech Platform Deep Item 5", "12/8/2026", "€13 243"], status: "active" as const },
];
...
export default function EdtechPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EdTech Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EdTech Platform Deep</p>
                    </div>
                </div>
