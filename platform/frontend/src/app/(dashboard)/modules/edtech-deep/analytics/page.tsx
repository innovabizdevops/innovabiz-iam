...
const KPIS = [{"l":"Dashboards Ativos","v":"5.705","t":"+2.7%","d":"up"},{"l":"Queries/Dia","v":"1304","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.535","t":"-4.2%","d":"down"},{"l":"Utilizadores Analytics","v":"1.661","t":"+3.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4167","2026-03-20","5.161","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4811","2026-03-23","4.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1346","2026-03-24","6.798","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1399","2026-03-13","3.892","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","912","2026-02-23","6.603","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":820},{"label":"Mar","value":666},{"label":"Abr","value":662},{"label":"Mai","value":704},{"label":"Jun","value":692},{"label":"Jul","value":626},{"label":"Ago","value":821},{"label":"Set","value":586},{"label":"Out","value":849},{"label":"Nov","value":823},{"label":"Dez","value":893}];
const MX = 893;
