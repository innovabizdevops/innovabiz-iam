...
const ACCENT = "#f59e0b";
const MODULE = "EdTech Platform Deep";
const PAGE = "Assessment";
const KPIS = [{"l":"Total Edtech Deep","v":"7.790","t":"+9.6%","d":"up"},{"l":"Assessment Ativos","v":"5.603","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.1%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edtech Deep #001","Edtech Deep #002","157","4.741","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Edtech Deep #002","Edtech Deep #003","5.667","4.249","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Edtech Deep #003","Edtech Deep #004","1.534","8.070","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Edtech Deep #004","Edtech Deep #005","3.131","8.898","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edtech Deep #005","Edtech Deep #001","5.447","2.610","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":862},{"label":"Mar","value":825},{"label":"Abr","value":643},{"label":"Mai","value":710},{"label":"Jun","value":773},{"label":"Jul","value":958},{"label":"Ago","value":662},{"label":"Set","value":634},{"label":"Out","value":809},{"label":"Nov","value":937},{"label":"Dez","value":960}];
const MX = 960;
