...
export default function FuelMgmtAirPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fuel Mgmt Air</h1><p className="text-sm text-muted-foreground">Fuel Mgmt Air • iBOS Enterprise</p></div>
