...
const KPIS = [{"l":"Total Fuel Mgmt Air","v":"3.335","t":"-4.3%","d":"down"},{"l":"Inventory Ativos","v":"672","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.7%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fuel Mgmt Air #001","Fuel Mgmt Air #002","5.971","4.255","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Fuel Mgmt Air #002","Fuel Mgmt Air #003","1.016","5.048","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Fuel Mgmt Air #003","Fuel Mgmt Air #004","1.295","3.520","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Fuel Mgmt Air #004","Fuel Mgmt Air #005","7.837","5.296","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fuel Mgmt Air #005","Fuel Mgmt Air #001","329","9.099","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":662},{"label":"Mar","value":351},{"label":"Abr","value":326},{"label":"Mai","value":448},{"label":"Jun","value":382},{"label":"Jul","value":579},{"label":"Ago","value":323},{"label":"Set","value":353},{"label":"Out","value":596},{"label":"Nov","value":369},{"label":"Dez","value":478}];
const MX = 662;
