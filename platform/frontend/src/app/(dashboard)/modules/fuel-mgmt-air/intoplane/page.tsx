...
const PAGE = "Into-Plane";
const KPIS = [{"l":"Total Fuel Mgmt Air","v":"2.379","t":"-4.3%","d":"down"},{"l":"Into Plane Ativos","v":"5.879","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"58","t":"+2.6%","d":"up"}];
const COLS = ["ID","Into Plane","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fuel Mgmt Air #001","Fuel Mgmt Air #002","3.875","5.097","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Fuel Mgmt Air #002","Fuel Mgmt Air #003","4.835","593","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Fuel Mgmt Air #003","Fuel Mgmt Air #004","6.645","6.345","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Fuel Mgmt Air #004","Fuel Mgmt Air #005","3.337","2.811","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fuel Mgmt Air #005","Fuel Mgmt Air #001","906","1.821","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":381},{"label":"Mar","value":385},{"label":"Abr","value":562},{"label":"Mai","value":396},{"label":"Jun","value":553},{"label":"Jul","value":409},{"label":"Ago","value":327},{"label":"Set","value":285},{"label":"Out","value":626},{"label":"Nov","value":313},{"label":"Dez","value":324}];
const MX = 626;
...
export default function IntoplanePage() {
    return (
