...
const ACCENT = "#4338ca";
const MODULE = "Aviation Fuel";
const PAGE = "SAF Track";
const KPIS = [{"l":"Total Fuel Mgmt Air","v":"2.718","t":"-3.5%","d":"down"},{"l":"SAF Track Ativos","v":"699","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"66","t":"-3.5%","d":"down"}];
const COLS = ["ID","SAF Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fuel Mgmt Air #001","Fuel Mgmt Air #002","150","8.258","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Fuel Mgmt Air #002","Fuel Mgmt Air #003","7.552","6.789","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Fuel Mgmt Air #003","Fuel Mgmt Air #004","3.665","7.323","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Fuel Mgmt Air #004","Fuel Mgmt Air #005","4.289","6.138","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fuel Mgmt Air #005","Fuel Mgmt Air #001","7.119","7.238","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":391},{"label":"Mar","value":496},{"label":"Abr","value":713},{"label":"Mai","value":611},{"label":"Jun","value":679},{"label":"Jul","value":347},{"label":"Ago","value":578},{"label":"Set","value":374},{"label":"Out","value":668},{"label":"Nov","value":582},{"label":"Dez","value":410}];
const MX = 713;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>ESG</span></h1>
                </div>
