...
const PAGE = "Fuel Farm";
const KPIS = [{"l":"Total Fuel Mgmt Air","v":"2.546","t":"+14.7%","d":"up"},{"l":"Fuel Farm Ativos","v":"6.346","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"92.4%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"72","t":"-0.2%","d":"down"}];
const COLS = ["ID","Fuel Farm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fuel Mgmt Air #001","Fuel Mgmt Air #002","6.135","694","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Fuel Mgmt Air #002","Fuel Mgmt Air #003","5.337","4.346","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Fuel Mgmt Air #003","Fuel Mgmt Air #004","8.170","1.637","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Fuel Mgmt Air #004","Fuel Mgmt Air #005","5.421","8.246","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fuel Mgmt Air #005","Fuel Mgmt Air #001","6.302","8.406","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":622},{"label":"Mar","value":663},{"label":"Abr","value":895},{"label":"Mai","value":576},{"label":"Jun","value":591},{"label":"Jul","value":815},{"label":"Ago","value":665},{"label":"Set","value":760},{"label":"Out","value":563},{"label":"Nov","value":800},{"label":"Dez","value":818}];
const MX = 895;
