...
const PAGE = "SLO Track";
const KPIS = [{"l":"Total Observability","v":"8.164","t":"-2.2%","d":"down"},{"l":"SLO Track Ativos","v":"3.292","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"72","t":"+5.9%","d":"up"}];
const COLS = ["ID","SLO Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Observability #001","Observability #002","155","2.532","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Observability #002","Observability #003","7.090","5.674","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Observability #003","Observability #004","5.423","629","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Observability #004","Observability #005","3.946","2.541","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Observability #005","Observability #001","3.717","8.978","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":774},{"label":"Mar","value":557},{"label":"Abr","value":667},{"label":"Mai","value":825},{"label":"Jun","value":496},{"label":"Jul","value":450},{"label":"Ago","value":446},{"label":"Set","value":553},{"label":"Out","value":734},{"label":"Nov","value":804},{"label":"Dez","value":485}];
const MX = 825;
