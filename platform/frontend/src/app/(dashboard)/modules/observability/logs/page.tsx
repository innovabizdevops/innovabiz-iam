...
const PAGE = "Log Aggreg";
const KPIS = [{"l":"Total Observability","v":"3.228","t":"+0.8%","d":"up"},{"l":"Log Aggreg Ativos","v":"2.754","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"55","t":"+12.1%","d":"up"}];
const COLS = ["ID","Log Aggreg","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Observability #001","Observability #002","4.775","2.061","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Observability #002","Observability #003","3.931","1.821","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Observability #003","Observability #004","7.465","3.138","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Observability #004","Observability #005","774","6.528","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Observability #005","Observability #001","1.388","1.530","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":296},{"label":"Mar","value":426},{"label":"Abr","value":436},{"label":"Mai","value":352},{"label":"Jun","value":536},{"label":"Jul","value":320},{"label":"Ago","value":556},{"label":"Set","value":278},{"label":"Out","value":644},{"label":"Nov","value":469},{"label":"Dez","value":627}];
const MX = 644;
