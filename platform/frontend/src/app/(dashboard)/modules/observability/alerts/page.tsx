...
const KPIS = [{"l":"Notificações Enviadas","v":"6.576","t":"+17.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"81.8%","t":"+5.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"73.8%","t":"+5.2%","d":"up"},{"l":"Escalações","v":"8.190","t":"+17.1%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.104","86.1%","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.742","90.0%","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.812","87.0%","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.837","75.5%","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.302","90.7%","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":279},{"label":"Fev","value":267},{"label":"Mar","value":466},{"label":"Abr","value":444},{"label":"Mai","value":257},{"label":"Jun","value":485},{"label":"Jul","value":538},{"label":"Ago","value":547},{"label":"Set","value":502},{"label":"Out","value":319},{"label":"Nov","value":509},{"label":"Dez","value":396}];
const MX = 547;
