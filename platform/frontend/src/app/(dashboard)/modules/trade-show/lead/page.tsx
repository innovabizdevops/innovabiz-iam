...
const PAGE = "Lead";
const KPIS = [{"l":"Total Trade Show","v":"4.892","t":"+3.3%","d":"up"},{"l":"Lead Ativos","v":"3.111","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"70","t":"+10.7%","d":"up"}];
const COLS = ["ID","Lead","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Show #001","Trade Show #002","4.691","1.083","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Show #002","Trade Show #003","7.502","6.902","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Show #003","Trade Show #004","8.007","8.799","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Show #004","Trade Show #005","1.489","3.412","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Show #005","Trade Show #001","3.323","6.728","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":500},{"label":"Mar","value":303},{"label":"Abr","value":304},{"label":"Mai","value":455},{"label":"Jun","value":357},{"label":"Jul","value":585},{"label":"Ago","value":666},{"label":"Set","value":551},{"label":"Out","value":614},{"label":"Nov","value":610},{"label":"Dez","value":360}];
const MX = 666;
