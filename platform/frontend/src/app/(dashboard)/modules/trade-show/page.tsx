...
/* ═══ Trade Show Mgmt — Dashboard ═══ */

const ACCENT = "#ca8a04";

const KPIS = [
    { label: "Total Registos", value: "3673", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4038", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€241K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1695299373", cells: ["TRA-6373", "Trade Show Mgmt Item 1", "6/10/2026", "€49 473"], status: "active" as const },
    { id: "1695302944", cells: ["TRA-9944", "Trade Show Mgmt Item 2", "21/5/2026", "€3044"], status: "pending" as const },
    { id: "1695306515", cells: ["TRA-4515", "Trade Show Mgmt Item 3", "8/12/2026", "€6615"], status: "completed" as const },
    { id: "1695310086", cells: ["TRA-8086", "Trade Show Mgmt Item 4", "23/7/2026", "€10 186"], status: "warning" as const },
    { id: "1695313657", cells: ["TRA-2657", "Trade Show Mgmt Item 5", "10/2/2026", "€13 757"], status: "active" as const },
];
...
export default function TradeShowMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trade Show Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Trade Show Mgmt</p>
                    </div>
                </div>
