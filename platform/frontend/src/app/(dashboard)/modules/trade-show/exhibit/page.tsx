...
const ACCENT = "#ca8a04";
const MODULE = "Trade Show Mgmt";
const PAGE = "Exhibit";
const KPIS = [{"l":"Total Trade Show","v":"4.228","t":"+12.6%","d":"up"},{"l":"Exhibit Ativos","v":"8.295","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"92","t":"-4.7%","d":"down"}];
const COLS = ["ID","Exhibit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Show #001","Trade Show #002","2.070","7.435","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Show #002","Trade Show #003","2.598","8.778","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Show #003","Trade Show #004","6.846","8.441","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Show #004","Trade Show #005","5.637","6.783","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Show #005","Trade Show #001","6.198","8.020","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":661},{"label":"Mar","value":752},{"label":"Abr","value":909},{"label":"Mai","value":681},{"label":"Jun","value":759},{"label":"Jul","value":642},{"label":"Ago","value":649},{"label":"Set","value":897},{"label":"Out","value":623},{"label":"Nov","value":799},{"label":"Dez","value":587}];
const MX = 909;
