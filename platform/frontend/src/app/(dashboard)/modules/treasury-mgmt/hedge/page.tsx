...
const PAGE = "Hedge Account";
const KPIS = [{"l":"Total Treasury Mgmt","v":"623","t":"-3.3%","d":"down"},{"l":"Hedge Account Ativos","v":"3.001","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"56","t":"-1.5%","d":"down"}];
const COLS = ["ID","Hedge Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Mgmt #001","Treasury Mgmt #002","2.095","3.112","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Mgmt #002","Treasury Mgmt #003","7.593","1.856","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Mgmt #003","Treasury Mgmt #004","5.813","286","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Mgmt #004","Treasury Mgmt #005","8.304","2.976","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Mgmt #005","Treasury Mgmt #001","3.214","1.741","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":735},{"label":"Mar","value":569},{"label":"Abr","value":554},{"label":"Mai","value":496},{"label":"Jun","value":778},{"label":"Jul","value":748},{"label":"Ago","value":866},{"label":"Set","value":491},{"label":"Out","value":640},{"label":"Nov","value":813},{"label":"Dez","value":660}];
const MX = 866;
