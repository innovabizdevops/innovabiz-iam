...
const PAGE = "FX Dealing";
const KPIS = [{"l":"Total Treasury Mgmt","v":"3.179","t":"+11.4%","d":"up"},{"l":"FX Dealing Ativos","v":"7.703","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"84","t":"+0.4%","d":"up"}];
const COLS = ["ID","FX Dealing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Mgmt #001","Treasury Mgmt #002","614","2.871","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Mgmt #002","Treasury Mgmt #003","5.272","5.398","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Mgmt #003","Treasury Mgmt #004","5.637","813","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Mgmt #004","Treasury Mgmt #005","3.209","5.706","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Mgmt #005","Treasury Mgmt #001","2.892","4.545","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":626},{"label":"Mar","value":972},{"label":"Abr","value":746},{"label":"Mai","value":840},{"label":"Jun","value":779},{"label":"Jul","value":681},{"label":"Ago","value":747},{"label":"Set","value":787},{"label":"Out","value":911},{"label":"Nov","value":992},{"label":"Dez","value":810}];
const MX = 992;
