...
const PAGE = "Derivatives";
const KPIS = [{"l":"Total Treasury Mgmt","v":"353","t":"-1.5%","d":"down"},{"l":"Derivatives Ativos","v":"1.430","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"92","t":"-2.1%","d":"down"}];
const COLS = ["ID","Derivatives","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Mgmt #001","Treasury Mgmt #002","957","2.372","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Mgmt #002","Treasury Mgmt #003","7.330","7.760","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Mgmt #003","Treasury Mgmt #004","3.906","8.048","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Mgmt #004","Treasury Mgmt #005","1.585","2.655","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Mgmt #005","Treasury Mgmt #001","9.036","7.710","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":455},{"label":"Mar","value":722},{"label":"Abr","value":446},{"label":"Mai","value":798},{"label":"Jun","value":655},{"label":"Jul","value":667},{"label":"Ago","value":822},{"label":"Set","value":568},{"label":"Out","value":636},{"label":"Nov","value":559},{"label":"Dez","value":480}];
const MX = 822;
