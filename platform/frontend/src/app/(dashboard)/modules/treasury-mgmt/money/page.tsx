...
const PAGE = "Money Market";
const KPIS = [{"l":"Total Treasury Mgmt","v":"3.602","t":"+17.4%","d":"up"},{"l":"Money Market Ativos","v":"8.367","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"72.0%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+14.0%","d":"up"}];
const COLS = ["ID","Money Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Mgmt #001","Treasury Mgmt #002","1.593","6.191","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Mgmt #002","Treasury Mgmt #003","2.012","5.076","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Mgmt #003","Treasury Mgmt #004","8.290","8.803","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Mgmt #004","Treasury Mgmt #005","5.957","6.291","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Mgmt #005","Treasury Mgmt #001","2.448","7.680","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":517},{"label":"Mar","value":381},{"label":"Abr","value":295},{"label":"Mai","value":557},{"label":"Jun","value":620},{"label":"Jul","value":503},{"label":"Ago","value":429},{"label":"Set","value":327},{"label":"Out","value":240},{"label":"Nov","value":400},{"label":"Dez","value":312}];
const MX = 620;
