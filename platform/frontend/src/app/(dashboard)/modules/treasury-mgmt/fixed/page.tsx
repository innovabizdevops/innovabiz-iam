...
const PAGE = "Fixed Income";
const KPIS = [{"l":"Total Treasury Mgmt","v":"3.205","t":"-4.4%","d":"down"},{"l":"Fixed Income Ativos","v":"7.837","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"65","t":"-5.5%","d":"down"}];
const COLS = ["ID","Fixed Income","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Mgmt #001","Treasury Mgmt #002","5.549","3.097","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Mgmt #002","Treasury Mgmt #003","3.615","7.523","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Mgmt #003","Treasury Mgmt #004","2.630","6.752","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Mgmt #004","Treasury Mgmt #005","3.432","8.018","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Mgmt #005","Treasury Mgmt #001","8.701","5.485","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":561},{"label":"Mar","value":402},{"label":"Abr","value":694},{"label":"Mai","value":340},{"label":"Jun","value":678},{"label":"Jul","value":657},{"label":"Ago","value":495},{"label":"Set","value":358},{"label":"Out","value":541},{"label":"Nov","value":393},{"label":"Dez","value":486}];
const MX = 694;
