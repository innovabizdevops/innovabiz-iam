...
const ACCENT = "#7899bf";
const MODULE = "Treasury Management";
const PAGE = "Cash Forecast AI";
const KPIS = [{"l":"Total Treasury Mgmt","v":"7.898","t":"+15.7%","d":"up"},{"l":"Cash Forecast AI Ativos","v":"8.478","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+11.1%","d":"up"}];
const COLS = ["ID","Cash Forecast AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Treasury Mgmt #001","Treasury Mgmt #002","9.051","5.552","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Treasury Mgmt #002","Treasury Mgmt #003","7.767","7.580","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Treasury Mgmt #003","Treasury Mgmt #004","1.027","1.238","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Treasury Mgmt #004","Treasury Mgmt #005","1.393","7.761","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Treasury Mgmt #005","Treasury Mgmt #001","2.977","8.424","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":604},{"label":"Mar","value":945},{"label":"Abr","value":798},{"label":"Mai","value":815},{"label":"Jun","value":700},{"label":"Jul","value":847},{"label":"Ago","value":681},{"label":"Set","value":591},{"label":"Out","value":940},{"label":"Nov","value":901},{"label":"Dez","value":662}];
const MX = 945;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7899bf'}}>AI</span></h1>
                </div>
