...
const PAGE = "Coalition Programs";
const KPIS = [{"l":"Formulários Ativos","v":"6.790","t":"-2.7%","d":"down"},{"l":"Submissões/Dia","v":"3214","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"442","t":"+4.2%","d":"up"},{"l":"Templates","v":"7.394","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.475","2026-01-23","926","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.952","2026-01-07","1.230","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.604","2026-03-14","1.652","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.755","2026-03-10","997","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.323","2026-02-24","4.202","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":1008},{"label":"Mar","value":915},{"label":"Abr","value":802},{"label":"Mai","value":770},{"label":"Jun","value":1012},{"label":"Jul","value":962},{"label":"Ago","value":909},{"label":"Set","value":743},{"label":"Out","value":836},{"label":"Nov","value":691},{"label":"Dez","value":1046}];
const MX = 1046;
