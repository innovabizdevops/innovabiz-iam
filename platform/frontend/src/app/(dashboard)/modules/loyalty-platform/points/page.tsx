...
const KPIS = [{"l":"Formulários Ativos","v":"7.634","t":"-0.1%","d":"down"},{"l":"Submissões/Dia","v":"3015","t":"+3.1%","d":"up"},{"l":"Documentos Gerados","v":"8.824","t":"+10.0%","d":"up"},{"l":"Templates","v":"1.647","t":"+2.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.419","2026-01-01","5.278","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.415","2026-01-08","5.695","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.901","2026-02-15","2.594","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.198","2026-02-26","8.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.942","2026-03-24","3.970","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":581},{"label":"Mar","value":681},{"label":"Abr","value":684},{"label":"Mai","value":713},{"label":"Jun","value":566},{"label":"Jul","value":709},{"label":"Ago","value":858},{"label":"Set","value":640},{"label":"Out","value":908},{"label":"Nov","value":860},{"label":"Dez","value":785}];
const MX = 908;
