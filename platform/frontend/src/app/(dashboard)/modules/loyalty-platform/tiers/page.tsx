...
const KPIS = [{"l":"ARR (€M)","v":"€36.0M","t":"+9.1%","d":"up"},{"l":"MRR (€)","v":"€35011","t":"-2.4%","d":"down"},{"l":"Churn (%)","v":"72.6%","t":"+5.1%","d":"up"},{"l":"ARPU (€)","v":"€34509","t":"+12.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 37859.93","6.387","€ 9944.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8333.99","9.031","€ 44067.08","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27458.09","7.602","€ 14460.74","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 35851.92","3.488","€ 24057.48","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40660.06","4.502","€ 3395.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":1037},{"label":"Mar","value":954},{"label":"Abr","value":901},{"label":"Mai","value":944},{"label":"Jun","value":889},{"label":"Jul","value":847},{"label":"Ago","value":951},{"label":"Set","value":937},{"label":"Out","value":1040},{"label":"Nov","value":673},{"label":"Dez","value":874}];
const MX = 1040;
