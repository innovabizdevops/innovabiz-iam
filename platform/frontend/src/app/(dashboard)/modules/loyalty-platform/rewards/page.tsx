...
const PAGE = "Rewards Catalog";
const KPIS = [{"l":"Formulários Ativos","v":"2.358","t":"+10.3%","d":"up"},{"l":"Submissões/Dia","v":"1886","t":"+9.2%","d":"up"},{"l":"Documentos Gerados","v":"1.979","t":"-4.4%","d":"down"},{"l":"Templates","v":"2.605","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.510","2026-02-12","8.000","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","839","2026-02-13","701","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.442","2026-02-10","3.137","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.787","2026-01-05","4.465","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.228","2026-03-24","4.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":581},{"label":"Mar","value":742},{"label":"Abr","value":911},{"label":"Mai","value":567},{"label":"Jun","value":590},{"label":"Jul","value":793},{"label":"Ago","value":862},{"label":"Set","value":675},{"label":"Out","value":704},{"label":"Nov","value":881},{"label":"Dez","value":895}];
const MX = 911;
