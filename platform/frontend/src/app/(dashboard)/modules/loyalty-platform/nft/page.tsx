...
const ACCENT = "#b45309";
const MODULE = "Loyalty Platform";
const PAGE = "NFT Rewards";
const KPIS = [{"l":"Formulários Ativos","v":"8.924","t":"-3.3%","d":"down"},{"l":"Submissões/Dia","v":"1795","t":"+2.9%","d":"up"},{"l":"Documentos Gerados","v":"3.666","t":"+14.0%","d":"up"},{"l":"Templates","v":"4.818","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.597","2026-01-08","2.023","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","893","2026-03-18","3.006","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.348","2026-02-18","8.734","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.287","2026-03-25","7.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.223","2026-02-19","565","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":732},{"label":"Mar","value":780},{"label":"Abr","value":981},{"label":"Mai","value":994},{"label":"Jun","value":881},{"label":"Jul","value":720},{"label":"Ago","value":662},{"label":"Set","value":1007},{"label":"Out","value":987},{"label":"Nov","value":804},{"label":"Dez","value":698}];
const MX = 1007;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>Web3</span></h1>
                </div>
