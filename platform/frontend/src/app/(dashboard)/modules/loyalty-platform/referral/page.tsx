...
const PAGE = "Referral Engine";
const KPIS = [{"l":"Formulários Ativos","v":"8.706","t":"+12.1%","d":"up"},{"l":"Submissões/Dia","v":"984","t":"+5.8%","d":"up"},{"l":"Documentos Gerados","v":"6.831","t":"+16.7%","d":"up"},{"l":"Templates","v":"5.358","t":"+17.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.545","2026-02-15","123","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.704","2026-01-25","5.331","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.009","2026-03-18","1.873","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","221","2026-01-20","4.201","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.746","2026-02-04","8.939","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":563},{"label":"Mar","value":748},{"label":"Abr","value":655},{"label":"Mai","value":636},{"label":"Jun","value":692},{"label":"Jul","value":625},{"label":"Ago","value":785},{"label":"Set","value":543},{"label":"Out","value":814},{"label":"Nov","value":741},{"label":"Dez","value":861}];
const MX = 861;
