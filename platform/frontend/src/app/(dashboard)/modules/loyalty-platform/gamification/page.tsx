...
const KPIS = [{"l":"Formulários Ativos","v":"4.262","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"985","t":"-5.2%","d":"down"},{"l":"Documentos Gerados","v":"3.956","t":"+3.8%","d":"up"},{"l":"Templates","v":"1.459","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.747","2026-01-27","5.522","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.364","2026-02-15","4.573","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.822","2026-02-14","104","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.216","2026-01-07","8.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.534","2026-03-14","2.967","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":826},{"label":"Mar","value":523},{"label":"Abr","value":829},{"label":"Mai","value":495},{"label":"Jun","value":633},{"label":"Jul","value":712},{"label":"Ago","value":712},{"label":"Set","value":712},{"label":"Out","value":741},{"label":"Nov","value":538},{"label":"Dez","value":603}];
const MX = 829;
