...
const PAGE = "Engagement Score";
const KPIS = [{"l":"eNPS","v":"65","t":"+16.0%","d":"up"},{"l":"Engagement (%)","v":"74.0%","t":"+9.5%","d":"up"},{"l":"Turnover (%)","v":"91.9%","t":"+10.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.978","t":"+2.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.952","2026-02-15","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.843","2026-01-09","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.467","2026-02-17","73","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.130","2026-03-28","85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.094","2026-03-24","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":671},{"label":"Mar","value":604},{"label":"Abr","value":539},{"label":"Mai","value":699},{"label":"Jun","value":508},{"label":"Jul","value":458},{"label":"Ago","value":588},{"label":"Set","value":536},{"label":"Out","value":652},{"label":"Nov","value":416},{"label":"Dez","value":364}];
const MX = 699;
