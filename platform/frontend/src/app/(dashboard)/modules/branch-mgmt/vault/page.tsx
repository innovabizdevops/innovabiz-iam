...
const PAGE = "Cash Vault";
const KPIS = [{"l":"Total Branch Mgmt","v":"4.079","t":"+6.8%","d":"up"},{"l":"Cash Vault Ativos","v":"1.248","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"80.6%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"72","t":"-1.3%","d":"down"}];
const COLS = ["ID","Cash Vault","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Branch Mgmt #001","Branch Mgmt #002","1.103","5.315","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Branch Mgmt #002","Branch Mgmt #003","5.096","3.370","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Branch Mgmt #003","Branch Mgmt #004","3.518","6.355","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Branch Mgmt #004","Branch Mgmt #005","175","843","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Branch Mgmt #005","Branch Mgmt #001","1.627","5.312","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":590},{"label":"Mar","value":703},{"label":"Abr","value":575},{"label":"Mai","value":690},{"label":"Jun","value":951},{"label":"Jul","value":857},{"label":"Ago","value":731},{"label":"Set","value":937},{"label":"Out","value":783},{"label":"Nov","value":909},{"label":"Dez","value":608}];
const MX = 951;
