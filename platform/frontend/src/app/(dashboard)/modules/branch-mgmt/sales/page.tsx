...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€22747","t":"+9.1%","d":"up"},{"l":"Pipeline (€)","v":"€12897","t":"+0.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.1%","t":"+2.7%","d":"up"},{"l":"Win Rate (%)","v":"88.3%","t":"+10.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 18818.45","€ 18810.61","€ 20902.74","72.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 35221.70","€ 34809.35","€ 31851.55","70.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 46271.26","€ 44791.01","€ 35407.27","77.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 14410.46","€ 10831.05","€ 23530.57","71.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31634.19","€ 33310.65","€ 35384.83","81.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":431},{"label":"Mar","value":646},{"label":"Abr","value":744},{"label":"Mai","value":564},{"label":"Jun","value":671},{"label":"Jul","value":555},{"label":"Ago","value":579},{"label":"Set","value":494},{"label":"Out","value":598},{"label":"Nov","value":711},{"label":"Dez","value":824}];
const MX = 824;
