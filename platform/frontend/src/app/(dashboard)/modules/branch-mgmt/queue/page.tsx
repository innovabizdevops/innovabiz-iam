...
const PAGE = "Queue";
const KPIS = [{"l":"Total Branch Mgmt","v":"8.827","t":"+1.8%","d":"up"},{"l":"Queue Ativos","v":"1.935","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"78","t":"-2.6%","d":"down"}];
const COLS = ["ID","Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Branch Mgmt #001","Branch Mgmt #002","1.541","6.429","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Branch Mgmt #002","Branch Mgmt #003","8.934","785","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Branch Mgmt #003","Branch Mgmt #004","7.900","4.806","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Branch Mgmt #004","Branch Mgmt #005","5.510","8.447","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Branch Mgmt #005","Branch Mgmt #001","3.354","1.827","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":735},{"label":"Mar","value":821},{"label":"Abr","value":900},{"label":"Mai","value":925},{"label":"Jun","value":893},{"label":"Jul","value":750},{"label":"Ago","value":946},{"label":"Set","value":776},{"label":"Out","value":952},{"label":"Nov","value":806},{"label":"Dez","value":853}];
const MX = 952;
