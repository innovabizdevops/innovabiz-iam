...
export default function BranchMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Branch Mgmt</h1><p className="text-sm text-muted-foreground">Branch Mgmt • iBOS Enterprise</p></div>
