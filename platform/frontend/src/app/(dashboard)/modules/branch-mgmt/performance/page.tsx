...
const ACCENT = "#6366f1";
const MODULE = "Branch Management";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"724","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"3671","t":"+15.6%","d":"up"},{"l":"Documentos Gerados","v":"7.264","t":"+16.4%","d":"up"},{"l":"Templates","v":"1.653","t":"+2.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.599","2026-01-24","8.353","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.583","2026-03-23","3.987","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.195","2026-01-25","5.175","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.994","2026-01-19","8.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.232","2026-03-02","8.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":694},{"label":"Mar","value":543},{"label":"Abr","value":516},{"label":"Mai","value":859},{"label":"Jun","value":861},{"label":"Jul","value":770},{"label":"Ago","value":474},{"label":"Set","value":602},{"label":"Out","value":567},{"label":"Nov","value":512},{"label":"Dez","value":748}];
const MX = 861;
