...
const ACCENT = "#db2777";
const MODULE = "Festival Operations";
const PAGE = "Logistics";
const KPIS = [{"l":"Total Festival Ops","v":"4.794","t":"-5.0%","d":"down"},{"l":"Logistics Ativos","v":"4.586","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+1.2%","d":"up"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Festival Ops #001","Festival Ops #002","8.814","5.718","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Festival Ops #002","Festival Ops #003","1.109","5.701","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Festival Ops #003","Festival Ops #004","6.777","2.588","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Festival Ops #004","Festival Ops #005","1.723","5.107","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Festival Ops #005","Festival Ops #001","494","7.805","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":675},{"label":"Mar","value":559},{"label":"Abr","value":693},{"label":"Mai","value":552},{"label":"Jun","value":846},{"label":"Jul","value":759},{"label":"Ago","value":579},{"label":"Set","value":611},{"label":"Out","value":537},{"label":"Nov","value":916},{"label":"Dez","value":574}];
const MX = 916;
