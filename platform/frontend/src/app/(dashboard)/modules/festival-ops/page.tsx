...
const KPIS = [
    { label: "Total Registos", value: "6184", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1738", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€405K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2002281084", cells: ["FES-7084", "Festival Operations Item 1", "21/1/2026", "€31 184"], status: "active" as const },
    { id: "2002284655", cells: ["FES-1655", "Festival Operations Item 2", "8/8/2026", "€34 755"], status: "pending" as const },
    { id: "2002288226", cells: ["FES-5226", "Festival Operations Item 3", "23/3/2026", "€38 326"], status: "completed" as const },
    { id: "2002291797", cells: ["FES-8797", "Festival Operations Item 4", "10/10/2026", "€41 897"], status: "warning" as const },
    { id: "2002295368", cells: ["FES-3368", "Festival Operations Item 5", "25/5/2026", "€45 468"], status: "active" as const },
];
...
export default function FestivalOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Festival Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Festival Operations</p>
                    </div>
                </div>
