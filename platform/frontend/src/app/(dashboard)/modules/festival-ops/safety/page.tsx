...
const PAGE = "Safety";
const KPIS = [{"l":"Total Festival Ops","v":"8.501","t":"+9.3%","d":"up"},{"l":"Safety Ativos","v":"4.529","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"68","t":"+17.8%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Festival Ops #001","Festival Ops #002","1.727","4.789","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Festival Ops #002","Festival Ops #003","879","2.739","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Festival Ops #003","Festival Ops #004","3.149","4.754","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Festival Ops #004","Festival Ops #005","5.306","1.170","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Festival Ops #005","Festival Ops #001","2.672","5.674","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":265},{"label":"Fev","value":569},{"label":"Mar","value":594},{"label":"Abr","value":279},{"label":"Mai","value":416},{"label":"Jun","value":336},{"label":"Jul","value":255},{"label":"Ago","value":436},{"label":"Set","value":441},{"label":"Out","value":531},{"label":"Nov","value":556},{"label":"Dez","value":516}];
const MX = 594;
