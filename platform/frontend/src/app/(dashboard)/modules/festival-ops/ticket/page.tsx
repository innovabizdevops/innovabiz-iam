...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"9.019","t":"+10.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.4%","t":"-4.8%","d":"down"},{"l":"MTTR (h)","v":"158h","t":"-0.5%","d":"down"},{"l":"Satisfação (%)","v":"65.6%","t":"+11.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","9.066","557","5.444","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.503","1.392","8.606","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.983","2.930","8.393","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.654","717","1.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.880","1.580","1.776","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":554},{"label":"Mar","value":212},{"label":"Abr","value":567},{"label":"Mai","value":452},{"label":"Jun","value":561},{"label":"Jul","value":341},{"label":"Ago","value":578},{"label":"Set","value":258},{"label":"Out","value":249},{"label":"Nov","value":378},{"label":"Dez","value":322}];
const MX = 578;
