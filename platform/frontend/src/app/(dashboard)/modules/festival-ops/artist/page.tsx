...
const PAGE = "Artist";
const KPIS = [{"l":"Total Festival Ops","v":"8.749","t":"+12.2%","d":"up"},{"l":"Artist Ativos","v":"2.535","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"70","t":"-0.6%","d":"down"}];
const COLS = ["ID","Artist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Festival Ops #001","Festival Ops #002","7.151","6.617","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Festival Ops #002","Festival Ops #003","5.576","8.014","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Festival Ops #003","Festival Ops #004","8.942","1.918","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Festival Ops #004","Festival Ops #005","6.654","604","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Festival Ops #005","Festival Ops #001","7.930","5.266","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":793},{"label":"Mar","value":831},{"label":"Abr","value":897},{"label":"Mai","value":750},{"label":"Jun","value":851},{"label":"Jul","value":960},{"label":"Ago","value":676},{"label":"Set","value":778},{"label":"Out","value":961},{"label":"Nov","value":859},{"label":"Dez","value":780}];
const MX = 961;
