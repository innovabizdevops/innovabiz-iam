...
const PAGE = "Formula";
const KPIS = [{"l":"Formulários Ativos","v":"8.848","t":"+14.0%","d":"up"},{"l":"Submissões/Dia","v":"3463","t":"-2.9%","d":"down"},{"l":"Documentos Gerados","v":"6.116","t":"+13.1%","d":"up"},{"l":"Templates","v":"4.674","t":"+7.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.183","2026-03-14","7.394","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.737","2026-02-05","135","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","583","2026-03-01","8.262","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.209","2026-01-20","8.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.923","2026-02-27","5.735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":557},{"label":"Mar","value":447},{"label":"Abr","value":752},{"label":"Mai","value":801},{"label":"Jun","value":648},{"label":"Jul","value":645},{"label":"Ago","value":505},{"label":"Set","value":675},{"label":"Out","value":506},{"label":"Nov","value":692},{"label":"Dez","value":587}];
const MX = 801;
