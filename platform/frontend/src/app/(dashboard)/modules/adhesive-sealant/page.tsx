...
/* ═══ Adhesives & Sealants — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "9831", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2332", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€237K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "339688631", cells: ["ADH-2631", "Adhesives & Sealants Item 1", "24/12/2026", "€38 731"], status: "active" as const },
    { id: "339692202", cells: ["ADH-6202", "Adhesives & Sealants Item 2", "11/7/2026", "€42 302"], status: "pending" as const },
    { id: "339695773", cells: ["ADH-9773", "Adhesives & Sealants Item 3", "26/2/2026", "€45 873"], status: "completed" as const },
    { id: "339699344", cells: ["ADH-4344", "Adhesives & Sealants Item 4", "13/9/2026", "€49 444"], status: "warning" as const },
    { id: "339702915", cells: ["ADH-7915", "Adhesives & Sealants Item 5", "28/4/2026", "€3015"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Adhesives & Sealants</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Adhesives & Sealants</p>
                    </div>
                </div>
