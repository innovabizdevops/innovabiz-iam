...
const PAGE = "Track";
const KPIS = [{"l":"Pedidos/Dia","v":"1634","t":"+5.0%","d":"up"},{"l":"GMV (€)","v":"€42099","t":"+11.5%","d":"up"},{"l":"Conversão (%)","v":"86.2%","t":"+13.9%","d":"up"},{"l":"AOV (€)","v":"€53983","t":"+7.8%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 31527.07","8.872","4.862","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 44835.18","4.474","8.021","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 12818.61","653","3.323","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 21776.99","5.704","3.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 29313.34","2.693","4.366","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":922},{"label":"Mar","value":1023},{"label":"Abr","value":799},{"label":"Mai","value":1043},{"label":"Jun","value":825},{"label":"Jul","value":959},{"label":"Ago","value":824},{"label":"Set","value":686},{"label":"Out","value":1053},{"label":"Nov","value":887},{"label":"Dez","value":780}];
const MX = 1053;
