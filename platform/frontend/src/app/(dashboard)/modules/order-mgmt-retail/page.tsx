...
export default function OrderMgmtRetailPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Order Mgmt Retail</h1><p className="text-sm text-muted-foreground">Order Mgmt Retail • iBOS Enterprise</p></div>
