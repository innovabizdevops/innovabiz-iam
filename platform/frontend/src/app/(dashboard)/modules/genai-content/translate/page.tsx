...
const KPIS = [{"l":"Tickets Abertos","v":"789","t":"+4.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.1%","t":"+2.5%","d":"up"},{"l":"MTTR (h)","v":"96h","t":"+15.0%","d":"up"},{"l":"Satisfação (%)","v":"71.1%","t":"+3.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.745","5.504","6.066","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.851","8.410","147","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.625","6.814","6.449","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.407","1.670","2.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.181","7.684","8.885","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":796},{"label":"Mar","value":666},{"label":"Abr","value":1004},{"label":"Mai","value":943},{"label":"Jun","value":976},{"label":"Jul","value":842},{"label":"Ago","value":840},{"label":"Set","value":748},{"label":"Out","value":1050},{"label":"Nov","value":683},{"label":"Dez","value":836}];
const MX = 1050;
