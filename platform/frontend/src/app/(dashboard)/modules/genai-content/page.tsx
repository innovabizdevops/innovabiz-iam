...
/* ═══ GenAI Content Studio — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "7603", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1378", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€104K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "26113803", cells: ["GEN-5803", "GenAI Content Studio Item 1", "24/4/2026", "€13 903"], status: "active" as const },
    { id: "26117374", cells: ["GEN-9374", "GenAI Content Studio Item 2", "11/11/2026", "€17 474"], status: "pending" as const },
    { id: "26120945", cells: ["GEN-3945", "GenAI Content Studio Item 3", "26/6/2026", "€21 045"], status: "completed" as const },
    { id: "26124516", cells: ["GEN-7516", "GenAI Content Studio Item 4", "13/1/2026", "€24 616"], status: "warning" as const },
    { id: "26128087", cells: ["GEN-2087", "GenAI Content Studio Item 5", "28/8/2026", "€28 187"], status: "active" as const },
];
...
export default function GenaiContentStudioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Content Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Content Studio</p>
                    </div>
                </div>
