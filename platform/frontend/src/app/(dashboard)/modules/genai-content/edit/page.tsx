...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"7.418","t":"+1.9%","d":"up"},{"l":"Chamadas/Hora","v":"3339","t":"+17.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.8%","t":"+7.7%","d":"up"},{"l":"Latência Média (ms)","v":"62ms","t":"+15.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.772","1.046","94.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.516","4.606","84.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.777","3.761","70.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.400","7.615","81.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.411","1.310","88.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":718},{"label":"Mar","value":735},{"label":"Abr","value":512},{"label":"Mai","value":707},{"label":"Jun","value":809},{"label":"Jul","value":822},{"label":"Ago","value":591},{"label":"Set","value":708},{"label":"Out","value":848},{"label":"Nov","value":616},{"label":"Dez","value":832}];
const MX = 848;
