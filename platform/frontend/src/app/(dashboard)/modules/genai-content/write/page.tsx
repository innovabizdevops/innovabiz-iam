...
const PAGE = "Write";
const KPIS = [{"l":"Total Genai Content","v":"8.863","t":"-1.3%","d":"down"},{"l":"Write Ativos","v":"6.849","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"67.3%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"86","t":"+11.9%","d":"up"}];
const COLS = ["ID","Write","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Content #001","Genai Content #002","354","7.728","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Content #002","Genai Content #003","8.386","943","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Content #003","Genai Content #004","2.010","8.944","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Content #004","Genai Content #005","2.919","3.801","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Content #005","Genai Content #001","4.409","5.242","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":225},{"label":"Fev","value":316},{"label":"Mar","value":493},{"label":"Abr","value":511},{"label":"Mai","value":457},{"label":"Jun","value":452},{"label":"Jul","value":268},{"label":"Ago","value":418},{"label":"Set","value":246},{"label":"Out","value":450},{"label":"Nov","value":324},{"label":"Dez","value":328}];
const MX = 511;
