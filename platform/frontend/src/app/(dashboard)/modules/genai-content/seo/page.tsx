...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Content Studio";
const PAGE = "SEO";
const KPIS = [{"l":"Total Genai Content","v":"2.691","t":"+4.9%","d":"up"},{"l":"SEO Ativos","v":"8.540","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"67","t":"+6.0%","d":"up"}];
const COLS = ["ID","SEO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Content #001","Genai Content #002","1.118","5.616","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Content #002","Genai Content #003","6.136","9.032","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Content #003","Genai Content #004","3.581","157","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Content #004","Genai Content #005","5.537","4.836","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Content #005","Genai Content #001","6.307","5.704","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":463},{"label":"Mar","value":388},{"label":"Abr","value":480},{"label":"Mai","value":472},{"label":"Jun","value":409},{"label":"Jul","value":738},{"label":"Ago","value":683},{"label":"Set","value":751},{"label":"Out","value":415},{"label":"Nov","value":529},{"label":"Dez","value":505}];
const MX = 751;
