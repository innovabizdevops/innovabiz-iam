...
/* ═══ Metal Casting — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "3256", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2416", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€239K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "151710756", cells: ["MET-7756", "Metal Casting Item 1", "9/1/2026", "€10 856"], status: "active" as const },
    { id: "151714327", cells: ["MET-2327", "Metal Casting Item 2", "24/8/2026", "€14 427"], status: "pending" as const },
    { id: "151717898", cells: ["MET-5898", "Metal Casting Item 3", "11/3/2026", "€17 998"], status: "completed" as const },
    { id: "151721469", cells: ["MET-9469", "Metal Casting Item 4", "26/10/2026", "€21 569"], status: "warning" as const },
    { id: "151725040", cells: ["MET-4040", "Metal Casting Item 5", "13/5/2026", "€25 140"], status: "active" as const },
];
...
export default function MetalCastingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metal Casting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Metal Casting</p>
                    </div>
                </div>
