...
const PAGE = "Clean";
const KPIS = [{"l":"Projetos Melhoria","v":"7.183","t":"+3.8%","d":"up"},{"l":"Savings (€)","v":"€45106","t":"-5.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.9%","t":"+13.5%","d":"up"},{"l":"Ciclos PDCA","v":"3.531","t":"-2.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.833","€ 48288.38","5.427","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.753","€ 31823.20","3.472","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","537","€ 48966.78","7.101","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.960","€ 49371.81","1.951","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.172","€ 42326.68","497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":537},{"label":"Mar","value":275},{"label":"Abr","value":267},{"label":"Mai","value":286},{"label":"Jun","value":276},{"label":"Jul","value":291},{"label":"Ago","value":358},{"label":"Set","value":427},{"label":"Out","value":555},{"label":"Nov","value":324},{"label":"Dez","value":432}];
const MX = 555;
