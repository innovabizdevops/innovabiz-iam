...
/* ═══ Experience Cloud (Community) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "7675", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "207", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€379K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "709520775", cells: ["EXP-6775", "Experience Cloud (Community) Item 1", "20/4/2026", "€20 875"], status: "active" as const },
    { id: "709524346", cells: ["EXP-1346", "Experience Cloud (Community) Item 2", "7/11/2026", "€24 446"], status: "pending" as const },
    { id: "709527917", cells: ["EXP-4917", "Experience Cloud (Community) Item 3", "22/6/2026", "€28 017"], status: "completed" as const },
    { id: "709531488", cells: ["EXP-8488", "Experience Cloud (Community) Item 4", "9/1/2026", "€31 588"], status: "warning" as const },
    { id: "709535059", cells: ["EXP-3059", "Experience Cloud (Community) Item 5", "24/8/2026", "€35 159"], status: "active" as const },
];
...
export default function ExperienceCloudCommunityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Experience Cloud (Community)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Experience Cloud (Community)</p>
                    </div>
                </div>
