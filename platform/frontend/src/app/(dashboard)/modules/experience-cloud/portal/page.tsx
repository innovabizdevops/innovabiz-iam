...
const PAGE = "Portal";
const KPIS = [{"l":"Perfis Unificados","v":"8.872","t":"+5.0%","d":"up"},{"l":"Segmentos Ativos","v":"2.548","t":"-4.3%","d":"down"},{"l":"NPS Score","v":"56","t":"-4.6%","d":"down"},{"l":"Churn Previsto (%)","v":"69.3%","t":"+3.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.565","€ 975.19","89.5%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","7.285","€ 4884.71","77.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","508","€ 42974.56","72.0%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.865","€ 11223.74","89.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","5.180","€ 48608.09","76.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":620},{"label":"Mar","value":416},{"label":"Abr","value":652},{"label":"Mai","value":672},{"label":"Jun","value":661},{"label":"Jul","value":633},{"label":"Ago","value":397},{"label":"Set","value":736},{"label":"Out","value":704},{"label":"Nov","value":591},{"label":"Dez","value":647}];
const MX = 736;
