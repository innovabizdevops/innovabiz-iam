...
const ACCENT = "#00a1e0";
const MODULE = "Experience Cloud (Community)";
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"4.293","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"2637","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"8.667","t":"+6.9%","d":"up"},{"l":"Templates","v":"6.858","t":"-3.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.435","2026-02-09","8.073","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.870","2026-02-27","3.768","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.463","2026-01-15","4.208","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.843","2026-03-19","1.861","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.572","2026-01-25","3.665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":418},{"label":"Mar","value":365},{"label":"Abr","value":488},{"label":"Mai","value":219},{"label":"Jun","value":441},{"label":"Jul","value":285},{"label":"Ago","value":523},{"label":"Set","value":202},{"label":"Out","value":365},{"label":"Nov","value":265},{"label":"Dez","value":457}];
const MX = 523;
