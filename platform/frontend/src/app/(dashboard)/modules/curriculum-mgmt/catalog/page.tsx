...
const KPIS = [{"l":"Dashboards Ativos","v":"5.395","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"3711","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"8.462","t":"+6.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.040","t":"+1.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3373","2026-02-26","1.376","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1957","2026-01-01","2.705","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2042","2026-03-16","819","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1785","2026-03-13","7.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4658","2026-02-01","3.955","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":749},{"label":"Mar","value":606},{"label":"Abr","value":525},{"label":"Mai","value":615},{"label":"Jun","value":475},{"label":"Jul","value":447},{"label":"Ago","value":559},{"label":"Set","value":719},{"label":"Out","value":427},{"label":"Nov","value":738},{"label":"Dez","value":563}];
const MX = 749;
