...
const PAGE = "Prerequisite Map";
const KPIS = [{"l":"Total Curriculum Mgmt","v":"4.915","t":"+4.1%","d":"up"},{"l":"Prerequisite Map Ativos","v":"5.691","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"81.8%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.0%","d":"up"}];
const COLS = ["ID","Prerequisite Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Curriculum Mgmt #001","Curriculum Mgmt #002","953","3.505","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Curriculum Mgmt #002","Curriculum Mgmt #003","1.146","6.607","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Curriculum Mgmt #003","Curriculum Mgmt #004","2.832","2.434","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Curriculum Mgmt #004","Curriculum Mgmt #005","8.999","5.878","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Curriculum Mgmt #005","Curriculum Mgmt #001","5.827","3.978","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":730},{"label":"Mar","value":649},{"label":"Abr","value":555},{"label":"Mai","value":545},{"label":"Jun","value":817},{"label":"Jul","value":782},{"label":"Ago","value":463},{"label":"Set","value":529},{"label":"Out","value":476},{"label":"Nov","value":532},{"label":"Dez","value":668}];
const MX = 817;
