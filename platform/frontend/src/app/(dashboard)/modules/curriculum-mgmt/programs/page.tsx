...
const KPIS = [{"l":"Formulários Ativos","v":"583","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"4832","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"1.670","t":"-2.1%","d":"down"},{"l":"Templates","v":"313","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.160","2026-03-05","2.588","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.036","2026-01-24","2.722","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.833","2026-02-14","6.079","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.047","2026-01-20","8.855","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.224","2026-03-15","8.589","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":491},{"label":"Mar","value":464},{"label":"Abr","value":811},{"label":"Mai","value":802},{"label":"Jun","value":613},{"label":"Jul","value":449},{"label":"Ago","value":463},{"label":"Set","value":470},{"label":"Out","value":590},{"label":"Nov","value":723},{"label":"Dez","value":438}];
const MX = 811;
