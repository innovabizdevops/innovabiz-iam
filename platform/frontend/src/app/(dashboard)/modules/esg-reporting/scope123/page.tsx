...
const PAGE = "Scope 1/2/3 Tracker";
const KPIS = [{"l":"Total Esg Reporting","v":"3.848","t":"+8.8%","d":"up"},{"l":"Scope 1/2/3 Tracker Ativos","v":"7.889","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"91.8%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"95","t":"+9.2%","d":"up"}];
const COLS = ["ID","Scope 1/2/3 Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","6.666","2.351","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","4.583","1.048","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","4.568","5.357","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","4.726","7.134","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","7.415","4.459","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":603},{"label":"Mar","value":578},{"label":"Abr","value":798},{"label":"Mai","value":549},{"label":"Jun","value":653},{"label":"Jul","value":532},{"label":"Ago","value":842},{"label":"Set","value":621},{"label":"Out","value":581},{"label":"Nov","value":552},{"label":"Dez","value":564}];
const MX = 842;
