...
const PAGE = "Board Report";
const KPIS = [{"l":"Teams Ativos","v":"8.541","t":"+5.4%","d":"up"},{"l":"Reuniões/Semana","v":"2625","t":"+3.1%","d":"up"},{"l":"Mensagens/Dia","v":"1131","t":"+17.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"8.933","t":"-0.4%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.503","658","5.649","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.651","3225","7.679","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.764","469","1.291","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.123","2526","1.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.647","2207","1.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":800},{"label":"Mar","value":570},{"label":"Abr","value":455},{"label":"Mai","value":635},{"label":"Jun","value":596},{"label":"Jul","value":592},{"label":"Ago","value":820},{"label":"Set","value":600},{"label":"Out","value":526},{"label":"Nov","value":592},{"label":"Dez","value":674}];
const MX = 820;
