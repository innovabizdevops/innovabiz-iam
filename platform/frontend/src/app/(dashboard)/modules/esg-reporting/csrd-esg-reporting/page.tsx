...
const PAGE = "CSRD Reporting";
const KPIS = [{"l":"Total Esg Reporting","v":"2.333","t":"-0.6%","d":"down"},{"l":"CSRD Reporting Ativos","v":"7.458","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"66","t":"-1.4%","d":"down"}];
const COLS = ["ID","CSRD Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","418","5.796","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","8.868","786","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","8.942","7.850","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","4.984","3.523","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","3.994","2.776","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":496},{"label":"Mar","value":516},{"label":"Abr","value":557},{"label":"Mai","value":348},{"label":"Jun","value":687},{"label":"Jul","value":492},{"label":"Ago","value":680},{"label":"Set","value":397},{"label":"Out","value":554},{"label":"Nov","value":598},{"label":"Dez","value":622}];
const MX = 687;
...
export default function CsrdEsgReportingPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>EU</span></h1>
                </div>
