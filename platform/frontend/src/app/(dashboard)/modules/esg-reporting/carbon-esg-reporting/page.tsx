...
const ACCENT = "#15803d";
const MODULE = "ESG Reporting & Carbon";
const PAGE = "Carbon Accounting";
const KPIS = [{"l":"Total Esg Reporting","v":"7.325","t":"+10.1%","d":"up"},{"l":"Carbon Accounting Ativos","v":"5.961","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"74","t":"-2.9%","d":"down"}];
const COLS = ["ID","Carbon Accounting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","7.830","6.941","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","6.395","232","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","6.594","3.579","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","4.115","6.844","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","8.086","1.022","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":635},{"label":"Mar","value":956},{"label":"Abr","value":671},{"label":"Mai","value":975},{"label":"Jun","value":716},{"label":"Jul","value":634},{"label":"Ago","value":989},{"label":"Set","value":775},{"label":"Out","value":689},{"label":"Nov","value":670},{"label":"Dez","value":708}];
const MX = 989;
...
export default function CarbonEsgReportingPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>GHG</span></h1>
                </div>
