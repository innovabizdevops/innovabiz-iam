...
const PAGE = "TCFD Report";
const KPIS = [{"l":"Total Esg Reporting","v":"8.505","t":"+14.3%","d":"up"},{"l":"TCFD Report Ativos","v":"7.376","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"90","t":"+6.9%","d":"up"}];
const COLS = ["ID","TCFD Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","7.144","3.847","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","1.379","4.156","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","8.940","2.876","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","7.059","6.970","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","3.031","3.031","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":751},{"label":"Mar","value":520},{"label":"Abr","value":605},{"label":"Mai","value":371},{"label":"Jun","value":630},{"label":"Jul","value":597},{"label":"Ago","value":628},{"label":"Set","value":378},{"label":"Out","value":553},{"label":"Nov","value":466},{"label":"Dez","value":702}];
const MX = 751;
...
export default function TcfdEsgReportingPage() {
    return (
