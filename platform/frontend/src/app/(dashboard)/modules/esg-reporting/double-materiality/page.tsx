...
const PAGE = "Double Material";
const KPIS = [{"l":"Total Esg Reporting","v":"3.562","t":"-5.4%","d":"down"},{"l":"Double Material Ativos","v":"4.146","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+9.6%","d":"up"}];
const COLS = ["ID","Double Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","4.791","5.801","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","6.489","3.639","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","5.142","424","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","2.199","5.146","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","3.908","2.133","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":444},{"label":"Mar","value":696},{"label":"Abr","value":718},{"label":"Mai","value":529},{"label":"Jun","value":411},{"label":"Jul","value":542},{"label":"Ago","value":517},{"label":"Set","value":585},{"label":"Out","value":426},{"label":"Nov","value":480},{"label":"Dez","value":513}];
const MX = 718;
