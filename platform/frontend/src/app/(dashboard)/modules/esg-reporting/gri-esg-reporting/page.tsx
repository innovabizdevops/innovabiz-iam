...
const KPIS = [{"l":"Total Esg Reporting","v":"1.624","t":"-2.6%","d":"down"},{"l":"GRI Standards Ativos","v":"1.811","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"86","t":"-1.1%","d":"down"}];
const COLS = ["ID","GRI Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","2.586","8.085","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","4.947","1.325","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","6.429","7.621","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","5.220","1.675","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","5.716","678","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":812},{"label":"Mar","value":658},{"label":"Abr","value":600},{"label":"Mai","value":679},{"label":"Jun","value":600},{"label":"Jul","value":781},{"label":"Ago","value":710},{"label":"Set","value":764},{"label":"Out","value":714},{"label":"Nov","value":465},{"label":"Dez","value":583}];
const MX = 812;
...
export default function GriEsgReportingPage() {
    return (
