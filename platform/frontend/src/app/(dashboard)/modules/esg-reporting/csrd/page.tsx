...
const PAGE = "CSRD/EU Taxonomy";
const KPIS = [{"l":"Total Esg Reporting","v":"6.994","t":"+5.0%","d":"up"},{"l":"CSRD/EU Taxonomy Ativos","v":"8.552","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"56","t":"+8.9%","d":"up"}];
const COLS = ["ID","CSRD/EU Taxonomy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","5.060","4.773","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","4.411","4.219","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","455","5.919","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","8.570","2.644","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","8.249","3.914","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":574},{"label":"Mar","value":768},{"label":"Abr","value":851},{"label":"Mai","value":642},{"label":"Jun","value":756},{"label":"Jul","value":854},{"label":"Ago","value":822},{"label":"Set","value":799},{"label":"Out","value":632},{"label":"Nov","value":650},{"label":"Dez","value":577}];
const MX = 854;
