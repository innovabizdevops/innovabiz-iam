...
const PAGE = "Carbon Calculator";
const KPIS = [{"l":"Total Esg Reporting","v":"8.376","t":"-0.2%","d":"down"},{"l":"Carbon Calculator Ativos","v":"5.874","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"62","t":"-5.2%","d":"down"}];
const COLS = ["ID","Carbon Calculator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","5.822","2.092","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","339","3.340","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","9.077","7.664","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","4.610","8.524","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","7.389","3.139","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":882},{"label":"Mar","value":730},{"label":"Abr","value":617},{"label":"Mai","value":701},{"label":"Jun","value":794},{"label":"Jul","value":601},{"label":"Ago","value":793},{"label":"Set","value":664},{"label":"Out","value":761},{"label":"Nov","value":631},{"label":"Dez","value":864}];
const MX = 882;
