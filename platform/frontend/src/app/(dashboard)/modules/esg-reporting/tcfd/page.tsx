...
const PAGE = "TCFD Disclosures";
const KPIS = [{"l":"Total Esg Reporting","v":"2.790","t":"+17.3%","d":"up"},{"l":"TCFD Disclosures Ativos","v":"4.790","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"84","t":"-1.8%","d":"down"}];
const COLS = ["ID","TCFD Disclosures","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","1.461","6.687","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","7.433","8.826","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","7.738","8.444","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","3.904","5.859","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","3.768","1.976","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":518},{"label":"Mar","value":553},{"label":"Abr","value":485},{"label":"Mai","value":234},{"label":"Jun","value":396},{"label":"Jul","value":514},{"label":"Ago","value":289},{"label":"Set","value":532},{"label":"Out","value":538},{"label":"Nov","value":244},{"label":"Dez","value":349}];
const MX = 553;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>TCFD</span></h1>
                </div>
