...
const PAGE = "Science-Based Targets";
const KPIS = [{"l":"Total Esg Reporting","v":"310","t":"+4.9%","d":"up"},{"l":"Science Based Targets Ativos","v":"4.042","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"74","t":"+3.2%","d":"up"}];
const COLS = ["ID","Science Based Targets","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","2.038","6.784","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","2.637","3.050","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","8.925","5.324","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","537","7.878","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","5.264","764","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":269},{"label":"Mar","value":530},{"label":"Abr","value":363},{"label":"Mai","value":306},{"label":"Jun","value":249},{"label":"Jul","value":400},{"label":"Ago","value":283},{"label":"Set","value":417},{"label":"Out","value":466},{"label":"Nov","value":361},{"label":"Dez","value":562}];
const MX = 562;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>SBTi</span></h1>
                </div>
