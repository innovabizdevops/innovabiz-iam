...
const PAGE = "CDP Submission";
const KPIS = [{"l":"Perfis Unificados","v":"4.620","t":"+17.7%","d":"up"},{"l":"Segmentos Ativos","v":"8.761","t":"-4.6%","d":"down"},{"l":"NPS Score","v":"63","t":"-3.4%","d":"down"},{"l":"Churn Previsto (%)","v":"69.7%","t":"+3.7%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.559","€ 18160.48","76.5%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.671","€ 26937.80","86.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","4.607","€ 26229.49","89.7%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.523","€ 34742.84","83.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.361","€ 43946.36","89.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":605},{"label":"Mar","value":400},{"label":"Abr","value":599},{"label":"Mai","value":613},{"label":"Jun","value":358},{"label":"Jul","value":559},{"label":"Ago","value":651},{"label":"Set","value":314},{"label":"Out","value":588},{"label":"Nov","value":657},{"label":"Dez","value":518}];
const MX = 657;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>CDP</span></h1>
                </div>
