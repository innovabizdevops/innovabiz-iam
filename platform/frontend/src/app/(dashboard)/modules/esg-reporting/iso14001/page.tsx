...
const PAGE = "ISO 14001 EMS";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.663","t":"+8.8%","d":"up"},{"l":"NC Abertas","v":"4.929","t":"-0.5%","d":"down"},{"l":"Conformidade (%)","v":"82.5%","t":"+11.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.566","t":"+7.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.220","77.0%","6.308","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.343","74.8%","330","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.516","75.4%","1.318","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.087","98.1%","7.137","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.398","86.5%","389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":946},{"label":"Mar","value":996},{"label":"Abr","value":852},{"label":"Mai","value":892},{"label":"Jun","value":717},{"label":"Jul","value":864},{"label":"Ago","value":696},{"label":"Set","value":879},{"label":"Out","value":927},{"label":"Nov","value":880},{"label":"Dez","value":740}];
const MX = 996;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>ISO</span></h1>
                </div>
