...
const KPIS = [{"l":"Projetos Sociais","v":"8.289","t":"-5.2%","d":"down"},{"l":"Beneficiários","v":"6.026","t":"+12.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€30305","t":"-4.2%","d":"down"},{"l":"Score Impacto","v":"61","t":"-2.1%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.256","€ 20343.14","7.371","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.601","€ 38748.03","2.619","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.906","€ 24723.69","649","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.314","€ 23667.09","3.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.594","€ 49576.74","4.370","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":666},{"label":"Mar","value":859},{"label":"Abr","value":928},{"label":"Mai","value":582},{"label":"Jun","value":880},{"label":"Jul","value":729},{"label":"Ago","value":921},{"label":"Set","value":673},{"label":"Out","value":650},{"label":"Nov","value":940},{"label":"Dez","value":861}];
const MX = 940;
