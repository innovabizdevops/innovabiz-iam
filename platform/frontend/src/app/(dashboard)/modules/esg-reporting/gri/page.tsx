...
const KPIS = [{"l":"Total Esg Reporting","v":"8.454","t":"-5.6%","d":"down"},{"l":"GRI Standards Ativos","v":"8.489","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"87.5%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"62","t":"-5.6%","d":"down"}];
const COLS = ["ID","GRI Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","3.660","1.999","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","3.546","1.747","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","382","8.446","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","4.917","2.921","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","8.028","5.109","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":480},{"label":"Mar","value":556},{"label":"Abr","value":455},{"label":"Mai","value":620},{"label":"Jun","value":406},{"label":"Jul","value":612},{"label":"Ago","value":677},{"label":"Set","value":385},{"label":"Out","value":304},{"label":"Nov","value":638},{"label":"Dez","value":326}];
const MX = 677;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>GRI</span></h1>
                </div>
