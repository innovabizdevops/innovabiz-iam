...
const PAGE = "SASB Metrics";
const KPIS = [{"l":"Total Esg Reporting","v":"5.821","t":"+15.8%","d":"up"},{"l":"SASB Metrics Ativos","v":"7.708","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"91.5%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+17.2%","d":"up"}];
const COLS = ["ID","SASB Metrics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting #001","Esg Reporting #002","7.163","2.284","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting #002","Esg Reporting #003","7.647","3.958","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting #003","Esg Reporting #004","8.047","7.406","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting #004","Esg Reporting #005","4.783","3.909","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting #005","Esg Reporting #001","3.454","7.169","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":549},{"label":"Mar","value":691},{"label":"Abr","value":882},{"label":"Mai","value":802},{"label":"Jun","value":517},{"label":"Jul","value":630},{"label":"Ago","value":494},{"label":"Set","value":688},{"label":"Out","value":871},{"label":"Nov","value":563},{"label":"Dez","value":529}];
const MX = 882;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>SASB</span></h1>
                </div>
