...
const PAGE = "ABC";
const KPIS = [{"l":"Total Inventory Optimize","v":"7.897","t":"-5.8%","d":"down"},{"l":"ABC Ativos","v":"3.990","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"68","t":"+9.7%","d":"up"}];
const COLS = ["ID","ABC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inventory Optimize #001","Inventory Optimize #002","1.561","8.634","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Inventory Optimize #002","Inventory Optimize #003","1.885","9.100","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Inventory Optimize #003","Inventory Optimize #004","6.507","6.024","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Inventory Optimize #004","Inventory Optimize #005","435","6.245","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inventory Optimize #005","Inventory Optimize #001","4.180","2.285","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":855},{"label":"Mar","value":828},{"label":"Abr","value":1029},{"label":"Mai","value":916},{"label":"Jun","value":1050},{"label":"Jul","value":829},{"label":"Ago","value":892},{"label":"Set","value":726},{"label":"Out","value":907},{"label":"Nov","value":886},{"label":"Dez","value":690}];
const MX = 1050;
