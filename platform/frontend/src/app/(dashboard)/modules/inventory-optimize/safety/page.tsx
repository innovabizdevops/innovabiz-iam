...
const KPIS = [{"l":"Total Inventory Optimize","v":"7.004","t":"+10.8%","d":"up"},{"l":"Safety Stock Ativos","v":"2.495","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"86","t":"-2.5%","d":"down"}];
const COLS = ["ID","Safety Stock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inventory Optimize #001","Inventory Optimize #002","3.970","8.360","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Inventory Optimize #002","Inventory Optimize #003","7.113","5.375","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Inventory Optimize #003","Inventory Optimize #004","1.280","2.878","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Inventory Optimize #004","Inventory Optimize #005","5.248","1.115","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inventory Optimize #005","Inventory Optimize #001","7.277","5.469","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":763},{"label":"Mar","value":760},{"label":"Abr","value":883},{"label":"Mai","value":706},{"label":"Jun","value":528},{"label":"Jul","value":653},{"label":"Ago","value":746},{"label":"Set","value":891},{"label":"Out","value":582},{"label":"Nov","value":592},{"label":"Dez","value":861}];
const MX = 891;
