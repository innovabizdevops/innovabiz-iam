...
export default function InventoryOptimizePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Inventory Optimize</h1><p className="text-sm text-muted-foreground">Inventory Optimize • iBOS Enterprise</p></div>
