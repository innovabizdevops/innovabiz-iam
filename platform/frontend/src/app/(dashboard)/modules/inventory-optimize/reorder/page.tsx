...
const PAGE = "Reorder";
const KPIS = [{"l":"Total Inventory Optimize","v":"6.664","t":"+15.5%","d":"up"},{"l":"Reorder Ativos","v":"7.415","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"70.1%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Reorder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inventory Optimize #001","Inventory Optimize #002","2.852","2.503","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Inventory Optimize #002","Inventory Optimize #003","2.708","3.494","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Inventory Optimize #003","Inventory Optimize #004","8.807","3.084","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Inventory Optimize #004","Inventory Optimize #005","4.791","1.949","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inventory Optimize #005","Inventory Optimize #001","3.114","9.011","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":586},{"label":"Mar","value":820},{"label":"Abr","value":742},{"label":"Mai","value":841},{"label":"Jun","value":725},{"label":"Jul","value":631},{"label":"Ago","value":862},{"label":"Set","value":499},{"label":"Out","value":779},{"label":"Nov","value":538},{"label":"Dez","value":835}];
const MX = 862;
