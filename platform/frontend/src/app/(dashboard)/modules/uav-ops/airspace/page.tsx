...
const ACCENT = "#6366f1";
const MODULE = "UAV Operations";
const PAGE = "Airspace";
const KPIS = [{"l":"Quartos Ocupados","v":"6.624","t":"+4.7%","d":"up"},{"l":"RevPAR (€)","v":"€97744","t":"+11.9%","d":"up"},{"l":"Ocupação (%)","v":"65.5%","t":"+7.6%","d":"up"},{"l":"Guest Satisfaction","v":"4.776","t":"+11.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.242","2026-01-04","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.030","2026-01-26","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.639","2026-03-18","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.396","2026-01-11","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.314","2026-01-01","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":791},{"label":"Mar","value":1073},{"label":"Abr","value":978},{"label":"Mai","value":1012},{"label":"Jun","value":737},{"label":"Jul","value":940},{"label":"Ago","value":934},{"label":"Set","value":841},{"label":"Out","value":991},{"label":"Nov","value":931},{"label":"Dez","value":981}];
const MX = 1073;
