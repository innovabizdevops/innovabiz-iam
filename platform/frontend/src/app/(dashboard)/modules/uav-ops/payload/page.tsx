...
const PAGE = "Payload";
const KPIS = [{"l":"Total Uav Ops","v":"107","t":"+17.1%","d":"up"},{"l":"Payload Ativos","v":"2.806","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"75","t":"-3.8%","d":"down"}];
const COLS = ["ID","Payload","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Uav Ops #001","Uav Ops #002","4.189","7.225","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Uav Ops #002","Uav Ops #003","6.405","3.983","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Uav Ops #003","Uav Ops #004","7.967","6.209","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Uav Ops #004","Uav Ops #005","2.923","4.380","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Uav Ops #005","Uav Ops #001","8.046","5.281","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":657},{"label":"Mar","value":663},{"label":"Abr","value":952},{"label":"Mai","value":732},{"label":"Jun","value":963},{"label":"Jul","value":842},{"label":"Ago","value":596},{"label":"Set","value":671},{"label":"Out","value":609},{"label":"Nov","value":968},{"label":"Dez","value":855}];
const MX = 968;
