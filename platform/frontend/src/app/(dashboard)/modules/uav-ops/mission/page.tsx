...
const PAGE = "Mission";
const KPIS = [{"l":"Total Uav Ops","v":"3.441","t":"+14.8%","d":"up"},{"l":"Mission Ativos","v":"4.980","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"89","t":"-0.2%","d":"down"}];
const COLS = ["ID","Mission","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Uav Ops #001","Uav Ops #002","1.531","3.207","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Uav Ops #002","Uav Ops #003","3.510","2.959","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Uav Ops #003","Uav Ops #004","315","4.396","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Uav Ops #004","Uav Ops #005","2.663","4.660","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Uav Ops #005","Uav Ops #001","1.288","7.323","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":720},{"label":"Mar","value":459},{"label":"Abr","value":561},{"label":"Mai","value":693},{"label":"Jun","value":451},{"label":"Jul","value":380},{"label":"Ago","value":502},{"label":"Set","value":464},{"label":"Out","value":682},{"label":"Nov","value":746},{"label":"Dez","value":674}];
const MX = 746;
