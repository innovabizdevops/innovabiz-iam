...
const PAGE = "Fleet";
const KPIS = [{"l":"Total Uav Ops","v":"3.100","t":"+14.2%","d":"up"},{"l":"Fleet Ativos","v":"7.722","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"68.7%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"83","t":"+1.8%","d":"up"}];
const COLS = ["ID","Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Uav Ops #001","Uav Ops #002","3.097","1.442","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Uav Ops #002","Uav Ops #003","8.352","354","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Uav Ops #003","Uav Ops #004","8.374","741","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Uav Ops #004","Uav Ops #005","3.919","3.319","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Uav Ops #005","Uav Ops #001","5.196","1.512","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":879},{"label":"Mar","value":799},{"label":"Abr","value":678},{"label":"Mai","value":756},{"label":"Jun","value":708},{"label":"Jul","value":806},{"label":"Ago","value":638},{"label":"Set","value":802},{"label":"Out","value":969},{"label":"Nov","value":807},{"label":"Dez","value":630}];
const MX = 969;
