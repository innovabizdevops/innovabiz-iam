...
const KPIS = [{"l":"Total Uav Ops","v":"2.235","t":"+5.5%","d":"up"},{"l":"Maintenance Ativos","v":"1.097","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"77","t":"-1.5%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Uav Ops #001","Uav Ops #002","8.348","4.128","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Uav Ops #002","Uav Ops #003","7.070","2.356","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Uav Ops #003","Uav Ops #004","6.643","3.903","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Uav Ops #004","Uav Ops #005","5.351","3.274","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Uav Ops #005","Uav Ops #001","2.552","3.474","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":577},{"label":"Mar","value":354},{"label":"Abr","value":516},{"label":"Mai","value":662},{"label":"Jun","value":679},{"label":"Jul","value":640},{"label":"Ago","value":610},{"label":"Set","value":338},{"label":"Out","value":649},{"label":"Nov","value":426},{"label":"Dez","value":517}];
const MX = 679;
