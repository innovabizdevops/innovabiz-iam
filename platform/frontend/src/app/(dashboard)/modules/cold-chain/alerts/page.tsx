...
const PAGE = "Excursion Alerts";
const KPIS = [{"l":"Notificações Enviadas","v":"2.827","t":"-4.1%","d":"down"},{"l":"Taxa Entrega (%)","v":"65.5%","t":"+14.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"92.9%","t":"+13.7%","d":"up"},{"l":"Escalações","v":"3.048","t":"-0.7%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.454","95.1%","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.644","93.0%","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.579","89.4%","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.528","82.8%","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.912","92.5%","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":465},{"label":"Mar","value":391},{"label":"Abr","value":600},{"label":"Mai","value":452},{"label":"Jun","value":526},{"label":"Jul","value":392},{"label":"Ago","value":428},{"label":"Set","value":698},{"label":"Out","value":608},{"label":"Nov","value":709},{"label":"Dez","value":485}];
const MX = 709;
