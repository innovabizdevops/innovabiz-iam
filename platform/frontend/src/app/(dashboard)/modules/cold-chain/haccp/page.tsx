...
const PAGE = "HACCP Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.447","t":"-5.1%","d":"down"},{"l":"NC Abertas","v":"2.325","t":"+5.6%","d":"up"},{"l":"Conformidade (%)","v":"89.1%","t":"+14.8%","d":"up"},{"l":"CAPAs Pendentes","v":"4.715","t":"+11.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.359","98.8%","4.148","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.016","94.3%","5.446","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.332","95.1%","1.874","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.825","94.2%","5.835","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.828","84.1%","8.850","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":564},{"label":"Mar","value":453},{"label":"Abr","value":572},{"label":"Mai","value":659},{"label":"Jun","value":727},{"label":"Jul","value":475},{"label":"Ago","value":646},{"label":"Set","value":768},{"label":"Out","value":448},{"label":"Nov","value":438},{"label":"Dez","value":595}];
const MX = 768;
