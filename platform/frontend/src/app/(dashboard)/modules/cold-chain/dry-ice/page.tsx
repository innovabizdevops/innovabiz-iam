...
const PAGE = "Dry Ice Track";
const KPIS = [{"l":"Total Cold Chain","v":"2.005","t":"+14.0%","d":"up"},{"l":"Dry Ice Track Ativos","v":"3.524","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"58","t":"-5.8%","d":"down"}];
const COLS = ["ID","Dry Ice Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cold Chain #001","Cold Chain #002","7.155","5.275","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cold Chain #002","Cold Chain #003","3.859","5.910","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Cold Chain #003","Cold Chain #004","3.302","7.008","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cold Chain #004","Cold Chain #005","1.150","1.689","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cold Chain #005","Cold Chain #001","1.815","8.718","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":899},{"label":"Mar","value":824},{"label":"Abr","value":885},{"label":"Mai","value":729},{"label":"Jun","value":782},{"label":"Jul","value":811},{"label":"Ago","value":738},{"label":"Set","value":911},{"label":"Out","value":932},{"label":"Nov","value":829},{"label":"Dez","value":854}];
const MX = 932;
