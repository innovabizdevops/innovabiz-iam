...
const PAGE = "Packaging Rules";
const KPIS = [{"l":"Total Cold Chain","v":"835","t":"+12.9%","d":"up"},{"l":"Packaging Rules Ativos","v":"3.783","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+10.3%","d":"up"}];
const COLS = ["ID","Packaging Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cold Chain #001","Cold Chain #002","1.479","4.700","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cold Chain #002","Cold Chain #003","7.996","1.434","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cold Chain #003","Cold Chain #004","4.663","5.614","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cold Chain #004","Cold Chain #005","3.241","4.933","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cold Chain #005","Cold Chain #001","2.059","4.864","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":622},{"label":"Mar","value":827},{"label":"Abr","value":966},{"label":"Mai","value":915},{"label":"Jun","value":900},{"label":"Jul","value":667},{"label":"Ago","value":724},{"label":"Set","value":639},{"label":"Out","value":602},{"label":"Nov","value":895},{"label":"Dez","value":922}];
const MX = 966;
