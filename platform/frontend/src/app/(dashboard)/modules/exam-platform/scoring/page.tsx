...
const PAGE = "Scoring";
const KPIS = [{"l":"Formulários Ativos","v":"6.681","t":"-3.3%","d":"down"},{"l":"Submissões/Dia","v":"3688","t":"+4.3%","d":"up"},{"l":"Documentos Gerados","v":"2.865","t":"+13.4%","d":"up"},{"l":"Templates","v":"861","t":"-5.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.173","2026-01-19","2.502","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.747","2026-01-05","568","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.572","2026-02-03","5.440","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.109","2026-03-26","5.042","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.550","2026-01-03","6.412","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":947},{"label":"Mar","value":852},{"label":"Abr","value":948},{"label":"Mai","value":761},{"label":"Jun","value":921},{"label":"Jul","value":743},{"label":"Ago","value":805},{"label":"Set","value":653},{"label":"Out","value":718},{"label":"Nov","value":622},{"label":"Dez","value":616}];
const MX = 948;
