...
const KPIS = [{"l":"Formulários Ativos","v":"7.357","t":"+12.9%","d":"up"},{"l":"Submissões/Dia","v":"3694","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"7.296","t":"-4.7%","d":"down"},{"l":"Templates","v":"2.378","t":"+12.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.650","2026-03-27","1.830","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.818","2026-01-07","678","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.617","2026-01-03","5.960","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.233","2026-03-18","1.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.438","2026-01-01","1.452","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":404},{"label":"Mar","value":527},{"label":"Abr","value":545},{"label":"Mai","value":700},{"label":"Jun","value":477},{"label":"Jul","value":572},{"label":"Ago","value":606},{"label":"Set","value":451},{"label":"Out","value":646},{"label":"Nov","value":598},{"label":"Dez","value":672}];
const MX = 700;
