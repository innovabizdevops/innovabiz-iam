...
export default function ExamPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Exam Platform</h1><p className="text-sm text-muted-foreground">Exam Platform • iBOS Enterprise</p></div>
