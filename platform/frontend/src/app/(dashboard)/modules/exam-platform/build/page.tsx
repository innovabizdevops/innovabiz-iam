...
const PAGE = "Exam Build";
const KPIS = [{"l":"Formulários Ativos","v":"3.372","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"3363","t":"+13.1%","d":"up"},{"l":"Documentos Gerados","v":"8.331","t":"+14.1%","d":"up"},{"l":"Templates","v":"890","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.077","2026-02-20","2.678","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.355","2026-01-14","431","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.972","2026-02-26","3.090","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.101","2026-01-14","3.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.198","2026-03-02","6.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":410},{"label":"Mar","value":324},{"label":"Abr","value":457},{"label":"Mai","value":436},{"label":"Jun","value":649},{"label":"Jul","value":450},{"label":"Ago","value":445},{"label":"Set","value":654},{"label":"Out","value":607},{"label":"Nov","value":375},{"label":"Dez","value":375}];
const MX = 692;
