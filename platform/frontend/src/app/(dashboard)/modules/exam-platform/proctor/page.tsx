...
const ACCENT = "#7c3aed";
const MODULE = "Exam Platform";
const PAGE = "Proctoring";
const KPIS = [{"l":"Formulários Ativos","v":"2.150","t":"-2.3%","d":"down"},{"l":"Submissões/Dia","v":"3135","t":"+17.7%","d":"up"},{"l":"Documentos Gerados","v":"6.444","t":"+12.2%","d":"up"},{"l":"Templates","v":"6.012","t":"+8.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.671","2026-02-20","3.263","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","510","2026-01-22","8.482","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.965","2026-01-15","7.422","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.999","2026-03-20","1.733","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.433","2026-01-14","2.443","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":482},{"label":"Mar","value":569},{"label":"Abr","value":609},{"label":"Mai","value":472},{"label":"Jun","value":621},{"label":"Jul","value":505},{"label":"Ago","value":355},{"label":"Set","value":700},{"label":"Out","value":430},{"label":"Nov","value":714},{"label":"Dez","value":364}];
const MX = 714;
