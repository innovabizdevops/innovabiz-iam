...
const PAGE = "Result Publish";
const KPIS = [{"l":"Formulários Ativos","v":"4.499","t":"+7.0%","d":"up"},{"l":"Submissões/Dia","v":"2416","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"2.265","t":"+6.7%","d":"up"},{"l":"Templates","v":"5.727","t":"+3.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.382","2026-02-23","2.058","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.718","2026-03-05","8.410","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.653","2026-03-28","6.621","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.025","2026-01-11","4.085","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.299","2026-03-09","4.713","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":560},{"label":"Mar","value":410},{"label":"Abr","value":576},{"label":"Mai","value":405},{"label":"Jun","value":374},{"label":"Jul","value":593},{"label":"Ago","value":559},{"label":"Set","value":385},{"label":"Out","value":662},{"label":"Nov","value":374},{"label":"Dez","value":468}];
const MX = 662;
