...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"4.249","t":"+5.6%","d":"up"},{"l":"Chamadas/Hora","v":"2388","t":"+17.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.1%","t":"+5.7%","d":"up"},{"l":"Latência Média (ms)","v":"102ms","t":"-2.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.684","7.288","91.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.511","4.697","84.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.009","7.903","98.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","384","3.146","89.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.874","8.652","89.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":315},{"label":"Mar","value":576},{"label":"Abr","value":359},{"label":"Mai","value":451},{"label":"Jun","value":312},{"label":"Jul","value":412},{"label":"Ago","value":628},{"label":"Set","value":292},{"label":"Out","value":474},{"label":"Nov","value":446},{"label":"Dez","value":321}];
const MX = 628;
