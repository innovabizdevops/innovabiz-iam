...
/* ═══ RegTech Deep — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "322", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "364", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€184K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "480843222", cells: ["REG-1222", "RegTech Deep Item 1", "7/7/2026", "€43 322"], status: "active" as const },
    { id: "480846793", cells: ["REG-4793", "RegTech Deep Item 2", "22/2/2026", "€46 893"], status: "pending" as const },
    { id: "480850364", cells: ["REG-8364", "RegTech Deep Item 3", "9/9/2026", "€464"], status: "completed" as const },
    { id: "480853935", cells: ["REG-2935", "RegTech Deep Item 4", "24/4/2026", "€4035"], status: "warning" as const },
    { id: "480857506", cells: ["REG-6506", "RegTech Deep Item 5", "11/11/2026", "€7606"], status: "active" as const },
];
...
export default function RegtechDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RegTech Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RegTech Deep</p>
                    </div>
                </div>
