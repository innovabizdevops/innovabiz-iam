...
const PAGE = "Turnover";
const KPIS = [{"l":"eNPS","v":"68","t":"-0.7%","d":"down"},{"l":"Engagement (%)","v":"81.1%","t":"+16.3%","d":"up"},{"l":"Turnover (%)","v":"82.6%","t":"-4.2%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"2.406","t":"+12.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.228","2026-02-26","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.706","2026-01-14","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.287","2026-01-08","94","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.368","2026-02-16","71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.562","2026-02-22","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":649},{"label":"Mar","value":809},{"label":"Abr","value":951},{"label":"Mai","value":967},{"label":"Jun","value":908},{"label":"Jul","value":934},{"label":"Ago","value":928},{"label":"Set","value":708},{"label":"Out","value":672},{"label":"Nov","value":943},{"label":"Dez","value":863}];
const MX = 967;
