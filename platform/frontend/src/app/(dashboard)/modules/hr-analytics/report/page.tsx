...
const PAGE = "Report";
const KPIS = [{"l":"eNPS","v":"62","t":"-4.7%","d":"down"},{"l":"Engagement (%)","v":"66.0%","t":"+15.1%","d":"up"},{"l":"Turnover (%)","v":"67.2%","t":"+12.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.234","t":"+17.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","486","2026-03-12","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.948","2026-01-28","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.349","2026-03-17","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.573","2026-03-02","77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.553","2026-03-16","78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":430},{"label":"Mar","value":710},{"label":"Abr","value":541},{"label":"Mai","value":643},{"label":"Jun","value":622},{"label":"Jul","value":757},{"label":"Ago","value":520},{"label":"Set","value":657},{"label":"Out","value":713},{"label":"Nov","value":393},{"label":"Dez","value":723}];
const MX = 757;
