...
const ACCENT = "#6366f1";
const MODULE = "HR Analytics";
const PAGE = "Predictive";
const KPIS = [{"l":"eNPS","v":"91","t":"+7.2%","d":"up"},{"l":"Engagement (%)","v":"68.8%","t":"+6.9%","d":"up"},{"l":"Turnover (%)","v":"92.5%","t":"-5.6%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.325","t":"+9.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.255","2026-03-21","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.199","2026-01-01","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","580","2026-01-27","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.186","2026-03-09","61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","735","2026-02-11","69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1031},{"label":"Fev","value":1073},{"label":"Mar","value":889},{"label":"Abr","value":723},{"label":"Mai","value":794},{"label":"Jun","value":937},{"label":"Jul","value":747},{"label":"Ago","value":939},{"label":"Set","value":904},{"label":"Out","value":1002},{"label":"Nov","value":940},{"label":"Dez","value":956}];
const MX = 1073;
