...
const KPIS = [{"l":"eNPS","v":"92","t":"+4.9%","d":"up"},{"l":"Engagement (%)","v":"89.9%","t":"+7.0%","d":"up"},{"l":"Turnover (%)","v":"93.2%","t":"+10.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.662","t":"+0.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","730","2026-01-07","89","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.288","2026-02-26","78","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.498","2026-01-22","73","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.106","2026-02-10","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.895","2026-02-14","91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":902},{"label":"Mar","value":645},{"label":"Abr","value":676},{"label":"Mai","value":824},{"label":"Jun","value":985},{"label":"Jul","value":670},{"label":"Ago","value":945},{"label":"Set","value":1006},{"label":"Out","value":799},{"label":"Nov","value":831},{"label":"Dez","value":953}];
const MX = 1006;
