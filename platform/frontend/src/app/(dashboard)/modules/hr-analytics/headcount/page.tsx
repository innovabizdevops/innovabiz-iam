...
const PAGE = "Headcount";
const KPIS = [{"l":"eNPS","v":"71","t":"+10.5%","d":"up"},{"l":"Engagement (%)","v":"84.5%","t":"+4.8%","d":"up"},{"l":"Turnover (%)","v":"77.9%","t":"+10.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"795","t":"-4.2%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.544","2026-03-05","94","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","426","2026-01-22","62","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.819","2026-03-01","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.062","2026-02-24","64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.635","2026-03-03","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":743},{"label":"Mar","value":829},{"label":"Abr","value":788},{"label":"Mai","value":950},{"label":"Jun","value":794},{"label":"Jul","value":906},{"label":"Ago","value":647},{"label":"Set","value":863},{"label":"Out","value":668},{"label":"Nov","value":788},{"label":"Dez","value":609}];
const MX = 984;
