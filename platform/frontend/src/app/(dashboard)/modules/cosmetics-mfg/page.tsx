...
/* ═══ Cosmetics Manufacturing — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "8056", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "242", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€406K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1757851956", cells: ["COS-8956", "Cosmetics Manufacturing Item 1", "1/1/2026", "€2056"], status: "active" as const },
    { id: "1757855527", cells: ["COS-3527", "Cosmetics Manufacturing Item 2", "16/8/2026", "€5627"], status: "pending" as const },
    { id: "1757859098", cells: ["COS-7098", "Cosmetics Manufacturing Item 3", "3/3/2026", "€9198"], status: "completed" as const },
    { id: "1757862669", cells: ["COS-1669", "Cosmetics Manufacturing Item 4", "18/10/2026", "€12 769"], status: "warning" as const },
    { id: "1757866240", cells: ["COS-5240", "Cosmetics Manufacturing Item 5", "5/5/2026", "€16 340"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cosmetics Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cosmetics Manufacturing</p>
                    </div>
                </div>
