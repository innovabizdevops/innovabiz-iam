...
const ACCENT = "#ec4899";
const MODULE = "Cosmetics Manufacturing";
const PAGE = "Regulatory";
const KPIS = [{"l":"Total Cosmetics Mfg","v":"7.347","t":"+17.1%","d":"up"},{"l":"Regulatory Ativos","v":"6.628","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"77","t":"-4.6%","d":"down"}];
const COLS = ["ID","Regulatory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetics Mfg #001","Cosmetics Mfg #002","1.007","3.631","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetics Mfg #002","Cosmetics Mfg #003","9.025","7.931","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetics Mfg #003","Cosmetics Mfg #004","243","191","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetics Mfg #004","Cosmetics Mfg #005","2.358","7.078","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetics Mfg #005","Cosmetics Mfg #001","666","2.898","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":641},{"label":"Mar","value":558},{"label":"Abr","value":776},{"label":"Mai","value":872},{"label":"Jun","value":727},{"label":"Jul","value":644},{"label":"Ago","value":515},{"label":"Set","value":866},{"label":"Out","value":547},{"label":"Nov","value":852},{"label":"Dez","value":693}];
const MX = 872;
