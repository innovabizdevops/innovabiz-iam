...
const PAGE = "Formula";
const KPIS = [{"l":"Formulários Ativos","v":"8.784","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"1947","t":"-2.9%","d":"down"},{"l":"Documentos Gerados","v":"8.955","t":"+8.0%","d":"up"},{"l":"Templates","v":"1.066","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.308","2026-01-11","2.134","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.878","2026-03-28","5.007","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.691","2026-03-25","2.734","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","392","2026-01-11","2.280","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.279","2026-02-11","4.593","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":706},{"label":"Mar","value":441},{"label":"Abr","value":598},{"label":"Mai","value":531},{"label":"Jun","value":736},{"label":"Jul","value":511},{"label":"Ago","value":614},{"label":"Set","value":492},{"label":"Out","value":699},{"label":"Nov","value":403},{"label":"Dez","value":397}];
const MX = 736;
