...
const PAGE = "OTA";
const KPIS = [{"l":"Total Channel Manager","v":"4.033","t":"-2.3%","d":"down"},{"l":"OTA Ativos","v":"6.670","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"85.4%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"93","t":"+13.3%","d":"up"}];
const COLS = ["ID","OTA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Manager #001","Channel Manager #002","1.773","6.550","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Manager #002","Channel Manager #003","7.576","3.849","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Manager #003","Channel Manager #004","1.125","1.970","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Manager #004","Channel Manager #005","3.426","3.053","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Manager #005","Channel Manager #001","428","3.786","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":492},{"label":"Mar","value":533},{"label":"Abr","value":683},{"label":"Mai","value":613},{"label":"Jun","value":720},{"label":"Jul","value":664},{"label":"Ago","value":516},{"label":"Set","value":511},{"label":"Out","value":570},{"label":"Nov","value":727},{"label":"Dez","value":707}];
const MX = 736;
