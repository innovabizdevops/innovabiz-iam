...
const PAGE = "Rate Push";
const KPIS = [{"l":"Notificações Enviadas","v":"2.861","t":"+15.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"80.3%","t":"+2.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"68.7%","t":"-5.7%","d":"down"},{"l":"Escalações","v":"3.624","t":"-2.0%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.704","87.7%","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.414","91.3%","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.939","85.4%","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.316","96.6%","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.764","71.3%","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":409},{"label":"Fev","value":576},{"label":"Mar","value":632},{"label":"Abr","value":463},{"label":"Mai","value":541},{"label":"Jun","value":658},{"label":"Jul","value":461},{"label":"Ago","value":524},{"label":"Set","value":549},{"label":"Out","value":596},{"label":"Nov","value":543},{"label":"Dez","value":622}];
const MX = 658;
