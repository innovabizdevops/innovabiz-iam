...
const ACCENT = "#6366f1";
const MODULE = "Channel Manager";
const PAGE = "Mapping";
const KPIS = [{"l":"Total Channel Manager","v":"7.417","t":"+5.6%","d":"up"},{"l":"Mapping Ativos","v":"2.241","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"72","t":"+17.7%","d":"up"}];
const COLS = ["ID","Mapping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Manager #001","Channel Manager #002","7.622","8.209","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Manager #002","Channel Manager #003","6.973","3.368","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Manager #003","Channel Manager #004","6.474","5.672","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Manager #004","Channel Manager #005","7.603","3.188","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Manager #005","Channel Manager #001","1.415","4.352","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":557},{"label":"Mar","value":524},{"label":"Abr","value":744},{"label":"Mai","value":758},{"label":"Jun","value":579},{"label":"Jul","value":852},{"label":"Ago","value":550},{"label":"Set","value":619},{"label":"Out","value":893},{"label":"Nov","value":886},{"label":"Dez","value":603}];
const MX = 893;
