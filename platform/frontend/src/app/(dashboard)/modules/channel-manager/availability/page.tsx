...
const KPIS = [{"l":"Total Channel Manager","v":"6.699","t":"+7.5%","d":"up"},{"l":"Availability Ativos","v":"3.558","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+11.8%","d":"up"}];
const COLS = ["ID","Availability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Manager #001","Channel Manager #002","3.279","1.792","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Manager #002","Channel Manager #003","1.636","3.590","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Manager #003","Channel Manager #004","3.463","4.073","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Manager #004","Channel Manager #005","5.451","3.913","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Manager #005","Channel Manager #001","1.716","5.005","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":311},{"label":"Fev","value":377},{"label":"Mar","value":582},{"label":"Abr","value":298},{"label":"Mai","value":484},{"label":"Jun","value":499},{"label":"Jul","value":469},{"label":"Ago","value":327},{"label":"Set","value":444},{"label":"Out","value":258},{"label":"Nov","value":481},{"label":"Dez","value":419}];
const MX = 582;
