...
const PAGE = "Report";
const KPIS = [{"l":"Total Channel Manager","v":"1.991","t":"+11.5%","d":"up"},{"l":"Report Ativos","v":"6.119","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"78","t":"+14.4%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Channel Manager #001","Channel Manager #002","2.939","3.988","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Channel Manager #002","Channel Manager #003","1.453","3.472","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Channel Manager #003","Channel Manager #004","5.276","3.313","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Channel Manager #004","Channel Manager #005","6.211","1.361","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Channel Manager #005","Channel Manager #001","2.823","1.770","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":705},{"label":"Mar","value":639},{"label":"Abr","value":858},{"label":"Mai","value":563},{"label":"Jun","value":809},{"label":"Jul","value":617},{"label":"Ago","value":648},{"label":"Set","value":673},{"label":"Out","value":679},{"label":"Nov","value":745},{"label":"Dez","value":834}];
const MX = 858;
