...
const PAGE = "Certify";
const KPIS = [{"l":"eNPS","v":"85","t":"+5.8%","d":"up"},{"l":"Engagement (%)","v":"76.1%","t":"+6.7%","d":"up"},{"l":"Turnover (%)","v":"90.6%","t":"-0.1%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.221","t":"-1.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.632","2026-03-17","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.140","2026-03-08","92","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.057","2026-02-21","90","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.034","2026-03-24","89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.914","2026-02-13","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":662},{"label":"Mar","value":534},{"label":"Abr","value":400},{"label":"Mai","value":653},{"label":"Jun","value":328},{"label":"Jul","value":598},{"label":"Ago","value":561},{"label":"Set","value":437},{"label":"Out","value":347},{"label":"Nov","value":509},{"label":"Dez","value":290}];
const MX = 662;
