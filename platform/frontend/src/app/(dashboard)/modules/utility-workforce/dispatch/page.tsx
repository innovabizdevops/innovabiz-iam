...
const ACCENT = "#6366f1";
const MODULE = "Utility Workforce";
const PAGE = "Dispatch";
const KPIS = [{"l":"eNPS","v":"68","t":"+1.6%","d":"up"},{"l":"Engagement (%)","v":"76.7%","t":"+8.4%","d":"up"},{"l":"Turnover (%)","v":"83.8%","t":"+6.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.247","t":"+6.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.268","2026-03-18","75","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.353","2026-03-05","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.946","2026-03-18","66","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.014","2026-02-16","87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","261","2026-02-10","90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":543},{"label":"Mar","value":335},{"label":"Abr","value":632},{"label":"Mai","value":467},{"label":"Jun","value":464},{"label":"Jul","value":448},{"label":"Ago","value":475},{"label":"Set","value":404},{"label":"Out","value":678},{"label":"Nov","value":335},{"label":"Dez","value":625}];
const MX = 678;
