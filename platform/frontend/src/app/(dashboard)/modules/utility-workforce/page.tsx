...
export default function UtilityWorkforcePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Utility Workforce</h1><p className="text-sm text-muted-foreground">Utility Workforce • iBOS Enterprise</p></div>
