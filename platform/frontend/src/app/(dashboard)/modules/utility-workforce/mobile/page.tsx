...
const PAGE = "Mobile";
const KPIS = [{"l":"eNPS","v":"62","t":"+6.8%","d":"up"},{"l":"Engagement (%)","v":"67.3%","t":"+17.3%","d":"up"},{"l":"Turnover (%)","v":"81.1%","t":"-2.5%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.357","t":"-1.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.807","2026-01-25","59","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.970","2026-01-10","82","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.739","2026-01-27","78","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.737","2026-01-28","90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.822","2026-03-14","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":674},{"label":"Mar","value":795},{"label":"Abr","value":772},{"label":"Mai","value":692},{"label":"Jun","value":929},{"label":"Jul","value":1069},{"label":"Ago","value":989},{"label":"Set","value":727},{"label":"Out","value":905},{"label":"Nov","value":699},{"label":"Dez","value":730}];
const MX = 1069;
