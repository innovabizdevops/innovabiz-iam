...
const PAGE = "Crew";
const KPIS = [{"l":"eNPS","v":"85","t":"+8.5%","d":"up"},{"l":"Engagement (%)","v":"91.1%","t":"+8.3%","d":"up"},{"l":"Turnover (%)","v":"68.5%","t":"+17.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"835","t":"-5.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.184","2026-02-27","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.254","2026-02-26","72","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","496","2026-01-03","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.148","2026-01-21","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.799","2026-01-08","85","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":675},{"label":"Mar","value":325},{"label":"Abr","value":485},{"label":"Mai","value":664},{"label":"Jun","value":576},{"label":"Jul","value":443},{"label":"Ago","value":648},{"label":"Set","value":591},{"label":"Out","value":624},{"label":"Nov","value":680},{"label":"Dez","value":382}];
const MX = 680;
