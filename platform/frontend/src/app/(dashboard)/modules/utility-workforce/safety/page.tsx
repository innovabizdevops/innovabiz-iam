...
const PAGE = "Safety";
const KPIS = [{"l":"eNPS","v":"60","t":"+10.9%","d":"up"},{"l":"Engagement (%)","v":"87.0%","t":"+16.8%","d":"up"},{"l":"Turnover (%)","v":"87.8%","t":"+7.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"394","t":"+3.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.378","2026-02-26","78","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.963","2026-03-12","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","947","2026-01-09","55","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.756","2026-02-25","59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.505","2026-03-16","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":414},{"label":"Mar","value":576},{"label":"Abr","value":588},{"label":"Mai","value":401},{"label":"Jun","value":611},{"label":"Jul","value":346},{"label":"Ago","value":473},{"label":"Set","value":635},{"label":"Out","value":570},{"label":"Nov","value":363},{"label":"Dez","value":733}];
const MX = 733;
