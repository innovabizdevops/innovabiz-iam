...
/* ═══ Webhook Engine Deep — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "6967", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3841", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€460K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2143643967", cells: ["WEB-6967", "Webhook Engine Deep Item 1", "4/4/2026", "€44 067"], status: "active" as const },
    { id: "2143647538", cells: ["WEB-1538", "Webhook Engine Deep Item 2", "19/11/2026", "€47 638"], status: "pending" as const },
    { id: "2143651109", cells: ["WEB-5109", "Webhook Engine Deep Item 3", "6/6/2026", "€1209"], status: "completed" as const },
    { id: "2143654680", cells: ["WEB-8680", "Webhook Engine Deep Item 4", "21/1/2026", "€4780"], status: "warning" as const },
    { id: "2143658251", cells: ["WEB-3251", "Webhook Engine Deep Item 5", "8/8/2026", "€8351"], status: "active" as const },
];
...
export default function WebhookEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Webhook Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Webhook Engine Deep</p>
                    </div>
                </div>
