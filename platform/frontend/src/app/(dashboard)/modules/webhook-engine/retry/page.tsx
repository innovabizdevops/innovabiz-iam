...
const PAGE = "Retry";
const KPIS = [{"l":"Integrações Ativas","v":"4.274","t":"+4.2%","d":"up"},{"l":"Chamadas/Hora","v":"2796","t":"+10.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.7%","t":"+7.2%","d":"up"},{"l":"Latência Média (ms)","v":"181ms","t":"-4.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.057","2.175","98.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.525","8.192","91.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.040","4.640","78.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.447","5.821","95.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.434","221","90.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":938},{"label":"Mar","value":679},{"label":"Abr","value":643},{"label":"Mai","value":683},{"label":"Jun","value":702},{"label":"Jul","value":635},{"label":"Ago","value":1001},{"label":"Set","value":883},{"label":"Out","value":612},{"label":"Nov","value":814},{"label":"Dez","value":997}];
const MX = 1001;
