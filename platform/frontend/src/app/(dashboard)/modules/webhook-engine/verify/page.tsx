...
const PAGE = "Verify";
const KPIS = [{"l":"Integrações Ativas","v":"1.544","t":"+7.1%","d":"up"},{"l":"Chamadas/Hora","v":"4779","t":"+12.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.0%","t":"+10.3%","d":"up"},{"l":"Latência Média (ms)","v":"68ms","t":"+3.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.831","5.520","96.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.098","8.743","70.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.996","2.899","73.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.346","1.036","71.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.886","2.799","79.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":578},{"label":"Mar","value":686},{"label":"Abr","value":743},{"label":"Mai","value":667},{"label":"Jun","value":558},{"label":"Jul","value":875},{"label":"Ago","value":799},{"label":"Set","value":787},{"label":"Out","value":685},{"label":"Nov","value":552},{"label":"Dez","value":620}];
const MX = 875;
