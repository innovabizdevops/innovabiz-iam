...
const ACCENT = "#059669";
const MODULE = "Webhook Engine Deep";
const PAGE = "Filter";
const KPIS = [{"l":"Integrações Ativas","v":"3.736","t":"+10.4%","d":"up"},{"l":"Chamadas/Hora","v":"3217","t":"+13.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.4%","t":"+5.5%","d":"up"},{"l":"Latência Média (ms)","v":"163ms","t":"+5.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.328","6.777","88.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.708","7.564","99.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.552","4.568","87.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.857","7.090","72.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.824","8.703","79.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":586},{"label":"Mar","value":602},{"label":"Abr","value":803},{"label":"Mai","value":608},{"label":"Jun","value":458},{"label":"Jul","value":759},{"label":"Ago","value":828},{"label":"Set","value":659},{"label":"Out","value":559},{"label":"Nov","value":749},{"label":"Dez","value":561}];
const MX = 828;
