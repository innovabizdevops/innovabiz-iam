...
const KPIS = [{"l":"Integrações Ativas","v":"6.688","t":"+2.3%","d":"up"},{"l":"Chamadas/Hora","v":"3701","t":"+3.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.1%","t":"+0.1%","d":"up"},{"l":"Latência Média (ms)","v":"97ms","t":"-5.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.667","4.865","97.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.999","5.762","83.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.508","6.221","84.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.885","2.437","90.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.021","7.919","93.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":629},{"label":"Mar","value":423},{"label":"Abr","value":583},{"label":"Mai","value":346},{"label":"Jun","value":434},{"label":"Jul","value":270},{"label":"Ago","value":580},{"label":"Set","value":363},{"label":"Out","value":399},{"label":"Nov","value":516},{"label":"Dez","value":624}];
const MX = 629;
