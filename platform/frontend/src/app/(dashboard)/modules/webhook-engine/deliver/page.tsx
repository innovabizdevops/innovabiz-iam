...
const PAGE = "Deliver";
const KPIS = [{"l":"Integrações Ativas","v":"7.581","t":"+4.0%","d":"up"},{"l":"Chamadas/Hora","v":"2708","t":"+11.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.3%","t":"-3.5%","d":"down"},{"l":"Latência Média (ms)","v":"75ms","t":"+2.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.848","7.220","96.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.854","5.050","87.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.557","3.557","96.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","311","2.908","92.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.448","6.210","80.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":565},{"label":"Mar","value":600},{"label":"Abr","value":821},{"label":"Mai","value":746},{"label":"Jun","value":840},{"label":"Jul","value":720},{"label":"Ago","value":725},{"label":"Set","value":828},{"label":"Out","value":759},{"label":"Nov","value":795},{"label":"Dez","value":738}];
const MX = 862;
