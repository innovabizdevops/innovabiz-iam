...
const ACCENT = "#00a1e0";
const MODULE = "Commerce B2B (Salesforce B2B)";
const PAGE = "Account";
const KPIS = [{"l":"Pedidos/Dia","v":"1270","t":"+7.9%","d":"up"},{"l":"GMV (€)","v":"€90367","t":"-6.0%","d":"down"},{"l":"Conversão (%)","v":"71.8%","t":"+2.9%","d":"up"},{"l":"AOV (€)","v":"€78013","t":"-0.6%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 1938.51","7.386","4.062","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 31586.53","5.601","8.059","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 43517.06","2.366","4.778","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 10400.22","5.354","4.422","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 33153.97","2.768","5.226","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":538},{"label":"Mar","value":426},{"label":"Abr","value":554},{"label":"Mai","value":753},{"label":"Jun","value":415},{"label":"Jul","value":513},{"label":"Ago","value":624},{"label":"Set","value":491},{"label":"Out","value":482},{"label":"Nov","value":644},{"label":"Dez","value":411}];
const MX = 753;
