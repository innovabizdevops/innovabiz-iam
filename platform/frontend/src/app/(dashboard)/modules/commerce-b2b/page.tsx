...
/* ═══ Commerce B2B (Salesforce B2B) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "3389", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2049", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€355K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2114722489", cells: ["COM-2489", "Commerce B2B (Salesforce B2B) Item 1", "6/2/2026", "€22 589"], status: "active" as const },
    { id: "2114726060", cells: ["COM-6060", "Commerce B2B (Salesforce B2B) Item 2", "21/9/2026", "€26 160"], status: "pending" as const },
    { id: "2114729631", cells: ["COM-9631", "Commerce B2B (Salesforce B2B) Item 3", "8/4/2026", "€29 731"], status: "completed" as const },
    { id: "2114733202", cells: ["COM-4202", "Commerce B2B (Salesforce B2B) Item 4", "23/11/2026", "€33 302"], status: "warning" as const },
    { id: "2114736773", cells: ["COM-7773", "Commerce B2B (Salesforce B2B) Item 5", "10/6/2026", "€36 873"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 29 }, { label: "Fev", value: 38 }, { label: "Mar", value: 47 }, { label: "Abr", value: 56 }, { label: "Mai", value: 65 }, { label: "Jun", value: 74 }];
...
export default function CommerceB2bSalesforceB2bPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commerce B2B (Salesforce B2B)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Commerce B2B (Salesforce B2B)</p>
                    </div>
                </div>
