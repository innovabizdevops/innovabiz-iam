...
const PAGE = "Customs Broker";
const KPIS = [{"l":"Total Customs Trade","v":"€63320","t":"+9.1%","d":"up"},{"l":"Customs Broker Ativos","v":"€28719","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.4%","d":"up"}];
const COLS = ["ID","Customs Broker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Trade #001","€ 20399.39","1.023","6.790","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Trade #002","€ 11543.98","713","2.933","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Trade #003","€ 26517.93","4.822","2.748","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Trade #004","€ 2145.58","5.459","4.511","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Trade #005","€ 4424.66","1.448","7.301","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":505},{"label":"Mar","value":581},{"label":"Abr","value":782},{"label":"Mai","value":540},{"label":"Jun","value":595},{"label":"Jul","value":608},{"label":"Ago","value":790},{"label":"Set","value":738},{"label":"Out","value":595},{"label":"Nov","value":772},{"label":"Dez","value":802}];
const MX = 802;
