...
const ACCENT = "#dc2626";
const MODULE = "Customs & Trade";
const PAGE = "HS Classification";
const KPIS = [{"l":"Total Customs Trade","v":"€71092","t":"+7.9%","d":"up"},{"l":"HS Classification Ativos","v":"8.905","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+5.1%","d":"up"}];
const COLS = ["ID","HS Classification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Trade #001","Customs Trade #002","3.759","3.327","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Trade #002","Customs Trade #003","5.749","128","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Trade #003","Customs Trade #004","8.805","8.016","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Trade #004","Customs Trade #005","3.688","2.798","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Trade #005","Customs Trade #001","2.003","3.395","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":516},{"label":"Mar","value":482},{"label":"Abr","value":289},{"label":"Mai","value":331},{"label":"Jun","value":255},{"label":"Jul","value":449},{"label":"Ago","value":552},{"label":"Set","value":502},{"label":"Out","value":453},{"label":"Nov","value":610},{"label":"Dez","value":355}];
const MX = 610;
...
export default function HsClassPage() {
    return (
