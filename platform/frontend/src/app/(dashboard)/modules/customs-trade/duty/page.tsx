...
const PAGE = "Duty Calculator";
const KPIS = [{"l":"Total Customs Trade","v":"€31897","t":"-0.3%","d":"down"},{"l":"Duty Calculator Ativos","v":"7.670","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"69.0%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+6.7%","d":"up"}];
const COLS = ["ID","Duty Calculator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Trade #001","Customs Trade #002","7.527","4.231","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Trade #002","Customs Trade #003","5.768","7.331","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Trade #003","Customs Trade #004","5.089","5.744","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Trade #004","Customs Trade #005","7.912","6.220","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Trade #005","Customs Trade #001","4.702","2.577","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":353},{"label":"Mar","value":429},{"label":"Abr","value":704},{"label":"Mai","value":539},{"label":"Jun","value":546},{"label":"Jul","value":514},{"label":"Ago","value":659},{"label":"Set","value":627},{"label":"Out","value":332},{"label":"Nov","value":520},{"label":"Dez","value":448}];
const MX = 704;
