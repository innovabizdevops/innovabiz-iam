...
const PAGE = "Trade Agreements";
const KPIS = [{"l":"Total Customs Trade","v":"€4208","t":"+8.4%","d":"up"},{"l":"Trade Agreements Ativos","v":"3.258","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"75.9%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"65","t":"+15.8%","d":"up"}];
const COLS = ["ID","Trade Agreements","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Trade #001","Customs Trade #002","7.599","557","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Trade #002","Customs Trade #003","1.395","5.331","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Trade #003","Customs Trade #004","4.386","7.004","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Trade #004","Customs Trade #005","2.778","8.112","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Trade #005","Customs Trade #001","4.143","8.192","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":869},{"label":"Mar","value":869},{"label":"Abr","value":606},{"label":"Mai","value":714},{"label":"Jun","value":557},{"label":"Jul","value":622},{"label":"Ago","value":576},{"label":"Set","value":785},{"label":"Out","value":568},{"label":"Nov","value":511},{"label":"Dez","value":766}];
const MX = 869;
