...
const KPIS = [{"l":"Total Customs Trade","v":"€65998","t":"-5.8%","d":"down"},{"l":"Origin Rules Ativos","v":"963","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"72.1%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"92","t":"+5.9%","d":"up"}];
const COLS = ["ID","Origin Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Trade #001","Customs Trade #002","7.919","4.248","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Trade #002","Customs Trade #003","7.436","2.143","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Trade #003","Customs Trade #004","317","3.791","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Trade #004","Customs Trade #005","7.045","6.288","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Trade #005","Customs Trade #001","7.001","2.897","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":596},{"label":"Mar","value":389},{"label":"Abr","value":592},{"label":"Mai","value":540},{"label":"Jun","value":456},{"label":"Jul","value":643},{"label":"Ago","value":381},{"label":"Set","value":373},{"label":"Out","value":709},{"label":"Nov","value":515},{"label":"Dez","value":643}];
const MX = 709;
