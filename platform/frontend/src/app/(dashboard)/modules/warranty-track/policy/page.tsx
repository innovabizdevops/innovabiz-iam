...
const ACCENT = "#dc2626";
const MODULE = "Warranty Tracking";
const PAGE = "Policy Lookup";
const KPIS = [{"l":"ARR (€M)","v":"€27.0M","t":"+4.2%","d":"up"},{"l":"MRR (€)","v":"€78416","t":"+5.4%","d":"up"},{"l":"Churn (%)","v":"85.5%","t":"-2.6%","d":"down"},{"l":"ARPU (€)","v":"€69933","t":"+9.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 8344.89","2.043","€ 2117.93","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 32655.10","7.949","€ 42601.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28164.41","8.194","€ 49553.39","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 34290.65","1.520","€ 46224.60","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 26530.78","5.701","€ 39286.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":1037},{"label":"Mar","value":1051},{"label":"Abr","value":736},{"label":"Mai","value":785},{"label":"Jun","value":975},{"label":"Jul","value":1021},{"label":"Ago","value":691},{"label":"Set","value":1006},{"label":"Out","value":1079},{"label":"Nov","value":977},{"label":"Dez","value":1052}];
const MX = 1079;
