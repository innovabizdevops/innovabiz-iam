...
const PAGE = "Part Return";
const KPIS = [{"l":"ARR (€M)","v":"€35.8M","t":"+3.7%","d":"up"},{"l":"MRR (€)","v":"€73618","t":"+2.5%","d":"up"},{"l":"Churn (%)","v":"70.8%","t":"+7.1%","d":"up"},{"l":"ARPU (€)","v":"€61335","t":"+10.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 39670.07","1.546","€ 4835.42","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4465.92","836","€ 7195.56","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 36588.61","6.147","€ 48779.89","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2333.65","5.479","€ 42642.35","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24013.91","1.377","€ 48033.83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":724},{"label":"Mar","value":638},{"label":"Abr","value":497},{"label":"Mai","value":516},{"label":"Jun","value":704},{"label":"Jul","value":516},{"label":"Ago","value":528},{"label":"Set","value":719},{"label":"Out","value":559},{"label":"Nov","value":536},{"label":"Dez","value":458}];
const MX = 724;
