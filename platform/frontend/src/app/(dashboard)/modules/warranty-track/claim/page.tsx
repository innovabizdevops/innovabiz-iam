...
const PAGE = "Claim Submit";
const KPIS = [{"l":"ARR (€M)","v":"€35.0M","t":"+10.8%","d":"up"},{"l":"MRR (€)","v":"€23456","t":"+3.6%","d":"up"},{"l":"Churn (%)","v":"90.7%","t":"+13.0%","d":"up"},{"l":"ARPU (€)","v":"€6706","t":"-1.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 469.06","2.232","€ 3605.53","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24055.97","7.050","€ 39350.91","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32460.92","5.058","€ 38016.70","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 40191.23","5.729","€ 7238.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 26465.44","1.578","€ 33500.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":315},{"label":"Mar","value":356},{"label":"Abr","value":522},{"label":"Mai","value":484},{"label":"Jun","value":558},{"label":"Jul","value":486},{"label":"Ago","value":237},{"label":"Set","value":534},{"label":"Out","value":577},{"label":"Nov","value":286},{"label":"Dez","value":386}];
const MX = 577;
