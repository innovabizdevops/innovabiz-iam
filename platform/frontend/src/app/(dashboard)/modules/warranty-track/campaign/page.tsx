...
const PAGE = "Campaign";
const KPIS = [{"l":"ARR (€M)","v":"€19.8M","t":"+2.5%","d":"up"},{"l":"MRR (€)","v":"€78057","t":"+11.9%","d":"up"},{"l":"Churn (%)","v":"75.1%","t":"-2.2%","d":"down"},{"l":"ARPU (€)","v":"€44031","t":"+4.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 36770.89","8.926","€ 24678.32","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17352.84","3.955","€ 31887.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 35096.02","8.970","€ 32044.32","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43111.95","4.741","€ 8798.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4638.68","1.361","€ 12559.42","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":488},{"label":"Mar","value":422},{"label":"Abr","value":409},{"label":"Mai","value":570},{"label":"Jun","value":489},{"label":"Jul","value":705},{"label":"Ago","value":531},{"label":"Set","value":328},{"label":"Out","value":633},{"label":"Nov","value":358},{"label":"Dez","value":380}];
const MX = 705;
