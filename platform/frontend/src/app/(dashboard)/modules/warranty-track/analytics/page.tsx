...
const KPIS = [{"l":"ARR (€M)","v":"€1.2M","t":"-1.5%","d":"down"},{"l":"MRR (€)","v":"€64287","t":"+8.2%","d":"up"},{"l":"Churn (%)","v":"93.8%","t":"+4.2%","d":"up"},{"l":"ARPU (€)","v":"€82570","t":"+12.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2845.07","5.063","€ 47804.97","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 18529.64","5.825","€ 37949.28","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9044.97","3.745","€ 41185.46","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33075.06","1.250","€ 30674.40","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45910.80","4.514","€ 18318.68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":409},{"label":"Mar","value":268},{"label":"Abr","value":394},{"label":"Mai","value":374},{"label":"Jun","value":354},{"label":"Jul","value":609},{"label":"Ago","value":531},{"label":"Set","value":479},{"label":"Out","value":606},{"label":"Nov","value":467},{"label":"Dez","value":262}];
const MX = 609;
