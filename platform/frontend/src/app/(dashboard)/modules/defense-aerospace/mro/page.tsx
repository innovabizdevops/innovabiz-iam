...
const PAGE = "MRO &amp; Maintenance";
const KPIS = [{"l":"Quartos Ocupados","v":"3.363","t":"+0.5%","d":"up"},{"l":"RevPAR (€)","v":"€42844","t":"+1.9%","d":"up"},{"l":"Ocupação (%)","v":"90.6%","t":"+12.2%","d":"up"},{"l":"Guest Satisfaction","v":"7.817","t":"-2.1%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.720","2026-01-23","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.647","2026-03-19","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.065","2026-01-02","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.359","2026-02-18","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.242","2026-02-28","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":828},{"label":"Mar","value":690},{"label":"Abr","value":845},{"label":"Mai","value":612},{"label":"Jun","value":654},{"label":"Jul","value":702},{"label":"Ago","value":847},{"label":"Set","value":594},{"label":"Out","value":723},{"label":"Nov","value":719},{"label":"Dez","value":732}];
const MX = 847;
