...
const PAGE = "ITAR Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"438","t":"+7.8%","d":"up"},{"l":"NC Abertas","v":"7.735","t":"+0.4%","d":"up"},{"l":"Conformidade (%)","v":"80.5%","t":"-3.2%","d":"down"},{"l":"CAPAs Pendentes","v":"7.414","t":"+1.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.753","80.3%","6.366","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.602","70.4%","6.433","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","578","76.7%","4.633","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","767","75.4%","6.393","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.167","99.9%","4.530","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":601},{"label":"Mar","value":520},{"label":"Abr","value":643},{"label":"Mai","value":575},{"label":"Jun","value":535},{"label":"Jul","value":875},{"label":"Ago","value":891},{"label":"Set","value":883},{"label":"Out","value":710},{"label":"Nov","value":658},{"label":"Dez","value":816}];
const MX = 891;
