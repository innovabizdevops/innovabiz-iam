...
const KPIS = [{"l":"Projetos Melhoria","v":"4.172","t":"+10.7%","d":"up"},{"l":"Savings (€)","v":"€82597","t":"-3.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"76.3%","t":"+16.2%","d":"up"},{"l":"Ciclos PDCA","v":"5.581","t":"+11.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.725","€ 17479.76","3.897","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.949","€ 44010.77","845","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.532","€ 21546.66","4.432","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.276","€ 5234.99","6.931","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.183","€ 12715.77","499","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":881},{"label":"Mar","value":881},{"label":"Abr","value":542},{"label":"Mai","value":800},{"label":"Jun","value":841},{"label":"Jul","value":632},{"label":"Ago","value":573},{"label":"Set","value":764},{"label":"Out","value":911},{"label":"Nov","value":780},{"label":"Dez","value":701}];
const MX = 911;
