...
const KPIS = [{"l":"Quartos Ocupados","v":"6.374","t":"+16.4%","d":"up"},{"l":"RevPAR (€)","v":"€80342","t":"-4.1%","d":"down"},{"l":"Ocupação (%)","v":"79.1%","t":"+12.4%","d":"up"},{"l":"Guest Satisfaction","v":"3.126","t":"+15.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.729","2026-03-14","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.847","2026-03-14","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.603","2026-01-18","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.981","2026-01-02","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","856","2026-01-04","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":589},{"label":"Mar","value":758},{"label":"Abr","value":700},{"label":"Mai","value":462},{"label":"Jun","value":578},{"label":"Jul","value":742},{"label":"Ago","value":808},{"label":"Set","value":774},{"label":"Out","value":700},{"label":"Nov","value":706},{"label":"Dez","value":528}];
const MX = 808;
