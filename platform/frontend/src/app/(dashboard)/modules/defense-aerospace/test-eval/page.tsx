...
const PAGE = "Test &amp; Eval";
const KPIS = [{"l":"Quartos Ocupados","v":"5.623","t":"-0.9%","d":"down"},{"l":"RevPAR (€)","v":"€63812","t":"+7.6%","d":"up"},{"l":"Ocupação (%)","v":"84.3%","t":"+0.7%","d":"up"},{"l":"Guest Satisfaction","v":"8.876","t":"+4.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.942","2026-01-07","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.026","2026-03-03","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.839","2026-03-01","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.571","2026-03-02","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","971","2026-03-08","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":871},{"label":"Mar","value":740},{"label":"Abr","value":565},{"label":"Mai","value":864},{"label":"Jun","value":578},{"label":"Jul","value":684},{"label":"Ago","value":680},{"label":"Set","value":821},{"label":"Out","value":552},{"label":"Nov","value":681},{"label":"Dez","value":535}];
const MX = 871;
