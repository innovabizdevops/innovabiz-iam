...
const ACCENT = "#1e3a5f";
const MODULE = "Defense & Aerospace";
const PAGE = "Configuration Mgmt";
const KPIS = [{"l":"Configurações","v":"4.829","t":"+10.6%","d":"up"},{"l":"Últimas Alterações","v":"1.674","t":"+3.8%","d":"up"},{"l":"Ambientes","v":"8.303","t":"+15.4%","d":"up"},{"l":"Versão Config","v":"2.257","t":"-1.6%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 22793.79","3.859","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 46786.33","2.210","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 43650.30","305","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 43150.56","6.626","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 16516.25","6.970","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":832},{"label":"Mar","value":893},{"label":"Abr","value":541},{"label":"Mai","value":539},{"label":"Jun","value":654},{"label":"Jul","value":743},{"label":"Ago","value":671},{"label":"Set","value":659},{"label":"Out","value":598},{"label":"Nov","value":583},{"label":"Dez","value":584}];
const MX = 893;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>CMII</span></h1>
                </div>
