...
const PAGE = "Multi-Robot";
const KPIS = [{"l":"Total Teleop Mgmt","v":"3.319","t":"-1.0%","d":"down"},{"l":"Multi Robot Ativos","v":"5.641","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"85.2%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.7%","d":"up"}];
const COLS = ["ID","Multi Robot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Teleop Mgmt #001","Teleop Mgmt #002","4.458","7.922","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Teleop Mgmt #002","Teleop Mgmt #003","6.609","2.847","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Teleop Mgmt #003","Teleop Mgmt #004","3.015","4.066","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Teleop Mgmt #004","Teleop Mgmt #005","7.783","1.816","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Teleop Mgmt #005","Teleop Mgmt #001","1.470","558","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":531},{"label":"Mar","value":661},{"label":"Abr","value":327},{"label":"Mai","value":327},{"label":"Jun","value":633},{"label":"Jul","value":617},{"label":"Ago","value":635},{"label":"Set","value":356},{"label":"Out","value":483},{"label":"Nov","value":410},{"label":"Dez","value":671}];
const MX = 671;
