...
const PAGE = "Latency";
const KPIS = [{"l":"Total Teleop Mgmt","v":"8.524","t":"+16.9%","d":"up"},{"l":"Latency Ativos","v":"2.949","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"75.9%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"63","t":"+5.2%","d":"up"}];
const COLS = ["ID","Latency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Teleop Mgmt #001","Teleop Mgmt #002","6.000","376","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Teleop Mgmt #002","Teleop Mgmt #003","1.434","2.980","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Teleop Mgmt #003","Teleop Mgmt #004","4.380","6.047","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Teleop Mgmt #004","Teleop Mgmt #005","4.396","2.844","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Teleop Mgmt #005","Teleop Mgmt #001","7.904","3.833","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":791},{"label":"Mar","value":724},{"label":"Abr","value":792},{"label":"Mai","value":682},{"label":"Jun","value":490},{"label":"Jul","value":614},{"label":"Ago","value":744},{"label":"Set","value":597},{"label":"Out","value":644},{"label":"Nov","value":563},{"label":"Dez","value":543}];
const MX = 792;
