...
const PAGE = "Force Feed";
const KPIS = [{"l":"Total Teleop Mgmt","v":"3.161","t":"+12.9%","d":"up"},{"l":"Force Feed Ativos","v":"6.608","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+5.8%","d":"up"}];
const COLS = ["ID","Force Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Teleop Mgmt #001","Teleop Mgmt #002","1.700","930","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Teleop Mgmt #002","Teleop Mgmt #003","5.760","3.394","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Teleop Mgmt #003","Teleop Mgmt #004","4.304","662","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Teleop Mgmt #004","Teleop Mgmt #005","1.469","4.793","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Teleop Mgmt #005","Teleop Mgmt #001","6.474","2.690","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":664},{"label":"Mar","value":869},{"label":"Abr","value":900},{"label":"Mai","value":878},{"label":"Jun","value":824},{"label":"Jul","value":751},{"label":"Ago","value":936},{"label":"Set","value":799},{"label":"Out","value":897},{"label":"Nov","value":840},{"label":"Dez","value":712}];
const MX = 936;
