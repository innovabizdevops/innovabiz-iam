...
const ACCENT = "#6366f1";
const MODULE = "Teleoperation";
const PAGE = "VR Cockpit";
const KPIS = [{"l":"Total Teleop Mgmt","v":"5.612","t":"+0.1%","d":"up"},{"l":"VR Cockpit Ativos","v":"143","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"71.6%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"61","t":"+5.3%","d":"up"}];
const COLS = ["ID","VR Cockpit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Teleop Mgmt #001","Teleop Mgmt #002","1.415","5.980","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Teleop Mgmt #002","Teleop Mgmt #003","3.936","4.193","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Teleop Mgmt #003","Teleop Mgmt #004","6.248","2.352","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Teleop Mgmt #004","Teleop Mgmt #005","2.391","5.418","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Teleop Mgmt #005","Teleop Mgmt #001","1.089","1.138","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":822},{"label":"Mar","value":1000},{"label":"Abr","value":854},{"label":"Mai","value":880},{"label":"Jun","value":1009},{"label":"Jul","value":951},{"label":"Ago","value":794},{"label":"Set","value":667},{"label":"Out","value":936},{"label":"Nov","value":638},{"label":"Dez","value":771}];
const MX = 1009;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>VR</span></h1>
                </div>
