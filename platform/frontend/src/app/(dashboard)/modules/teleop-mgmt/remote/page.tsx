...
const PAGE = "Remote Control";
const KPIS = [{"l":"Total Teleop Mgmt","v":"7.109","t":"+14.3%","d":"up"},{"l":"Remote Control Ativos","v":"7.786","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"78.1%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+12.4%","d":"up"}];
const COLS = ["ID","Remote Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Teleop Mgmt #001","Teleop Mgmt #002","6.757","1.370","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Teleop Mgmt #002","Teleop Mgmt #003","8.952","4.124","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Teleop Mgmt #003","Teleop Mgmt #004","1.238","2.932","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Teleop Mgmt #004","Teleop Mgmt #005","2.267","5.364","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Teleop Mgmt #005","Teleop Mgmt #001","8.632","5.920","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1050},{"label":"Fev","value":1005},{"label":"Mar","value":858},{"label":"Abr","value":795},{"label":"Mai","value":935},{"label":"Jun","value":937},{"label":"Jul","value":876},{"label":"Ago","value":980},{"label":"Set","value":924},{"label":"Out","value":659},{"label":"Nov","value":706},{"label":"Dez","value":1019}];
const MX = 1050;
