...
const PAGE = "Seafarer";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.066","t":"+16.2%","d":"up"},{"l":"Sessões/Dia","v":"4406","t":"+10.5%","d":"up"},{"l":"MFA Adoção (%)","v":"77.2%","t":"-5.8%","d":"down"},{"l":"Tentativas Bloqueadas","v":"6.323","t":"+9.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.539","2.010","8.158","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.689","2.918","7.221","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.353","4.173","2.418","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.357","6.905","2.658","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.822","189","1.535","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":627},{"label":"Mar","value":389},{"label":"Abr","value":490},{"label":"Mai","value":472},{"label":"Jun","value":644},{"label":"Jul","value":595},{"label":"Ago","value":537},{"label":"Set","value":516},{"label":"Out","value":480},{"label":"Nov","value":761},{"label":"Dez","value":410}];
const MX = 761;
