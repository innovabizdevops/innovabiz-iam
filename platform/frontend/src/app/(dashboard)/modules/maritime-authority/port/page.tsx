...
const ACCENT = "#0c4a6e";
const MODULE = "Maritime Authority";
const PAGE = "Port State";
const KPIS = [{"l":"Utilizadores Ativos","v":"587","t":"-4.9%","d":"down"},{"l":"Sessões/Dia","v":"4644","t":"+11.3%","d":"up"},{"l":"MFA Adoção (%)","v":"76.7%","t":"-4.2%","d":"down"},{"l":"Tentativas Bloqueadas","v":"4.313","t":"+1.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","465","1.270","5.930","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.002","3.925","1.264","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.200","5.971","5.471","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.442","3.221","3.970","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.096","7.206","5.427","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":969},{"label":"Mar","value":948},{"label":"Abr","value":745},{"label":"Mai","value":683},{"label":"Jun","value":760},{"label":"Jul","value":668},{"label":"Ago","value":612},{"label":"Set","value":782},{"label":"Out","value":810},{"label":"Nov","value":886},{"label":"Dez","value":811}];
const MX = 969;
