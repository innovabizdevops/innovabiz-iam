...
const PAGE = "Safety";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.916","t":"+13.5%","d":"up"},{"l":"Sessões/Dia","v":"3057","t":"+14.8%","d":"up"},{"l":"MFA Adoção (%)","v":"73.7%","t":"+3.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"7.854","t":"-4.6%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.861","828","8.217","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.907","1.358","8.252","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.173","8.627","4.918","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.873","700","1.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.863","307","4.535","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":751},{"label":"Mar","value":937},{"label":"Abr","value":750},{"label":"Mai","value":981},{"label":"Jun","value":689},{"label":"Jul","value":976},{"label":"Ago","value":791},{"label":"Set","value":841},{"label":"Out","value":874},{"label":"Nov","value":845},{"label":"Dez","value":860}];
const MX = 981;
