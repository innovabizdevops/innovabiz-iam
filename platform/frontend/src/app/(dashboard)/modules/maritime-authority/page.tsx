...
/* ═══ Maritime Authority — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "421", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4043", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€53K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "984525621", cells: ["MAR-7621", "Maritime Authority Item 1", "10/10/2026", "€25 721"], status: "active" as const },
    { id: "984529192", cells: ["MAR-2192", "Maritime Authority Item 2", "25/5/2026", "€29 292"], status: "pending" as const },
    { id: "984532763", cells: ["MAR-5763", "Maritime Authority Item 3", "12/12/2026", "€32 863"], status: "completed" as const },
    { id: "984536334", cells: ["MAR-9334", "Maritime Authority Item 4", "27/7/2026", "€36 434"], status: "warning" as const },
    { id: "984539905", cells: ["MAR-3905", "Maritime Authority Item 5", "14/2/2026", "€40 005"], status: "active" as const },
];
...
export default function MaritimeAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maritime Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Maritime Authority</p>
                    </div>
                </div>
