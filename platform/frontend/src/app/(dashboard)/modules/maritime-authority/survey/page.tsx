...
const PAGE = "Survey";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.088","t":"+14.2%","d":"up"},{"l":"Sessões/Dia","v":"3403","t":"+17.5%","d":"up"},{"l":"MFA Adoção (%)","v":"74.8%","t":"+6.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.728","t":"+14.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.707","2.552","6.794","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.395","7.081","1.966","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.610","3.346","8.805","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.371","8.195","3.107","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.876","2.000","1.323","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":666},{"label":"Mar","value":791},{"label":"Abr","value":538},{"label":"Mai","value":506},{"label":"Jun","value":813},{"label":"Jul","value":652},{"label":"Ago","value":545},{"label":"Set","value":755},{"label":"Out","value":708},{"label":"Nov","value":577},{"label":"Dez","value":616}];
const MX = 813;
