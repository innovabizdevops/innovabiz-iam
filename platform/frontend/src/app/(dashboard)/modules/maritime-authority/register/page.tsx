...
const PAGE = "Register";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.046","t":"+9.3%","d":"up"},{"l":"Sessões/Dia","v":"2865","t":"-1.7%","d":"down"},{"l":"MFA Adoção (%)","v":"91.2%","t":"-1.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"2.963","t":"-0.1%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.140","8.963","203","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.454","1.658","8.777","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.776","6.867","5.755","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.972","6.026","8.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.013","1.241","6.555","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":587},{"label":"Mar","value":541},{"label":"Abr","value":494},{"label":"Mai","value":400},{"label":"Jun","value":344},{"label":"Jul","value":605},{"label":"Ago","value":528},{"label":"Set","value":720},{"label":"Out","value":697},{"label":"Nov","value":697},{"label":"Dez","value":535}];
const MX = 720;
