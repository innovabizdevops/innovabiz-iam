...
/* ═══ Food Manufacturing — Cooking Process ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "4145", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "41", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1151", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "80%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1653735973", cells: ["FOO-4973", "Cooking Process Item 1", "2/2/2026", "€36 073"], status: "active" as const },
    { id: "1653739544", cells: ["FOO-8544", "Cooking Process Item 2", "17/9/2026", "€39 644"], status: "pending" as const },
    { id: "1653743115", cells: ["FOO-3115", "Cooking Process Item 3", "4/4/2026", "€43 215"], status: "completed" as const },
    { id: "1653746686", cells: ["FOO-6686", "Cooking Process Item 4", "19/11/2026", "€46 786"], status: "warning" as const },
    { id: "1653750257", cells: ["FOO-1257", "Cooking Process Item 5", "6/6/2026", "€357"], status: "active" as const },
];
...
export default function FoodManufacturingCookingProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cooking Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Cooking Process</p>
                    </div>
                </div>
