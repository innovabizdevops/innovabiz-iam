...
/* ═══ Food Manufacturing — Filling Seal ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "4506", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "448", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "616", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "231989580", cells: ["FOO-6580", "Filling Seal Item 1", "5/1/2026", "€39 680"], status: "active" as const },
    { id: "231993151", cells: ["FOO-1151", "Filling Seal Item 2", "20/8/2026", "€43 251"], status: "pending" as const },
    { id: "231996722", cells: ["FOO-4722", "Filling Seal Item 3", "7/3/2026", "€46 822"], status: "completed" as const },
    { id: "232000293", cells: ["FOO-8293", "Filling Seal Item 4", "22/10/2026", "€393"], status: "warning" as const },
    { id: "232003864", cells: ["FOO-2864", "Filling Seal Item 5", "9/5/2026", "€3964"], status: "active" as const },
];
...
export default function FoodManufacturingFillingSealPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Filling Seal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Filling Seal</p>
                    </div>
                </div>
