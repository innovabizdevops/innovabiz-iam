...
/* ═══ Food Manufacturing — Warehouse Food ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3954", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "13", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "645", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "532368233", cells: ["FOO-1233", "Warehouse Food Item 1", "6/6/2026", "€18 333"], status: "active" as const },
    { id: "532371804", cells: ["FOO-4804", "Warehouse Food Item 2", "21/1/2026", "€21 904"], status: "pending" as const },
    { id: "532375375", cells: ["FOO-8375", "Warehouse Food Item 3", "8/8/2026", "€25 475"], status: "completed" as const },
    { id: "532378946", cells: ["FOO-2946", "Warehouse Food Item 4", "23/3/2026", "€29 046"], status: "warning" as const },
    { id: "532382517", cells: ["FOO-6517", "Warehouse Food Item 5", "10/10/2026", "€32 617"], status: "active" as const },
];
...
export default function FoodManufacturingWarehouseFoodPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Warehouse Food</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Warehouse Food</p>
                    </div>
                </div>
