...
/* ═══ Food Manufacturing — Freeze Dry ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "1243", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "420", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2436", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "179342128", cells: ["FOO-9128", "Freeze Dry Item 1", "1/5/2026", "€42 228"], status: "active" as const },
    { id: "179345699", cells: ["FOO-3699", "Freeze Dry Item 2", "16/12/2026", "€45 799"], status: "pending" as const },
    { id: "179349270", cells: ["FOO-7270", "Freeze Dry Item 3", "3/7/2026", "€49 370"], status: "completed" as const },
    { id: "179352841", cells: ["FOO-1841", "Freeze Dry Item 4", "18/2/2026", "€2941"], status: "warning" as const },
    { id: "179356412", cells: ["FOO-5412", "Freeze Dry Item 5", "5/9/2026", "€6512"], status: "active" as const },
];
...
export default function FoodManufacturingFreezeDryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Freeze Dry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Freeze Dry</p>
                    </div>
                </div>
