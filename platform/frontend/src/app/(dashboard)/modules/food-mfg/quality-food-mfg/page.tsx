...
/* ═══ Food Manufacturing — Quality Food Mfg ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3769", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "479", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2250", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "88%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "315111771", cells: ["FOO-4771", "Quality Food Mfg Item 1", "24/4/2026", "€11 871"], status: "active" as const },
    { id: "315115342", cells: ["FOO-8342", "Quality Food Mfg Item 2", "11/11/2026", "€15 442"], status: "pending" as const },
    { id: "315118913", cells: ["FOO-2913", "Quality Food Mfg Item 3", "26/6/2026", "€19 013"], status: "completed" as const },
    { id: "315122484", cells: ["FOO-6484", "Quality Food Mfg Item 4", "13/1/2026", "€22 584"], status: "warning" as const },
    { id: "315126055", cells: ["FOO-1055", "Quality Food Mfg Item 5", "28/8/2026", "€26 155"], status: "active" as const },
];
...
export default function FoodManufacturingQualityFoodMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Food Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Quality Food Mfg</p>
                    </div>
                </div>
