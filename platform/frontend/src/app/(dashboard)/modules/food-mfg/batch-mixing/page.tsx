...
/* ═══ Food Manufacturing — Batch Mixing ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3738", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "190", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "160", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "91992826", cells: ["FOO-4826", "Batch Mixing Item 1", "3/11/2026", "€42 926"], status: "active" as const },
    { id: "91996397", cells: ["FOO-8397", "Batch Mixing Item 2", "18/6/2026", "€46 497"], status: "pending" as const },
    { id: "91999968", cells: ["FOO-2968", "Batch Mixing Item 3", "5/1/2026", "€50 068"], status: "completed" as const },
    { id: "92003539", cells: ["FOO-6539", "Batch Mixing Item 4", "20/8/2026", "€3639"], status: "warning" as const },
    { id: "92007110", cells: ["FOO-1110", "Batch Mixing Item 5", "7/3/2026", "€7210"], status: "active" as const },
];
...
export default function FoodManufacturingBatchMixingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Batch Mixing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Batch Mixing</p>
                    </div>
                </div>
