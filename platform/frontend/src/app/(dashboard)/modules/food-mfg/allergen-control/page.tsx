...
/* ═══ Food Manufacturing — Allergen Control ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "1280", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "177", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "943", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "86%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1247388109", cells: ["FOO-7109", "Allergen Control Item 1", "10/2/2026", "€38 209"], status: "active" as const },
    { id: "1247391680", cells: ["FOO-1680", "Allergen Control Item 2", "25/9/2026", "€41 780"], status: "pending" as const },
    { id: "1247395251", cells: ["FOO-5251", "Allergen Control Item 3", "12/4/2026", "€45 351"], status: "completed" as const },
    { id: "1247398822", cells: ["FOO-8822", "Allergen Control Item 4", "27/11/2026", "€48 922"], status: "warning" as const },
    { id: "1247402393", cells: ["FOO-3393", "Allergen Control Item 5", "14/6/2026", "€2493"], status: "active" as const },
];
...
export default function FoodManufacturingAllergenControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Allergen Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Allergen Control</p>
                    </div>
                </div>
