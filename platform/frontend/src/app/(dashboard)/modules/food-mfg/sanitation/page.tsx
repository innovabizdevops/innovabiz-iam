...
const KPIS = [
    { label: "Total", value: "3970", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "252", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2101", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "169128824", cells: ["FOO-1824", "Sanitation Item 1", "5/9/2026", "€28 924"], status: "active" as const },
    { id: "169132395", cells: ["FOO-5395", "Sanitation Item 2", "20/4/2026", "€32 495"], status: "pending" as const },
    { id: "169135966", cells: ["FOO-8966", "Sanitation Item 3", "7/11/2026", "€36 066"], status: "completed" as const },
    { id: "169139537", cells: ["FOO-3537", "Sanitation Item 4", "22/6/2026", "€39 637"], status: "warning" as const },
    { id: "169143108", cells: ["FOO-7108", "Sanitation Item 5", "9/1/2026", "€43 208"], status: "active" as const },
];
...
export default function FoodManufacturingSanitationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sanitation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Sanitation</p>
                    </div>
                </div>
