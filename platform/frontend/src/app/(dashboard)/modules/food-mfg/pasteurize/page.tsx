...
/* ═══ Food Manufacturing — Pasteurize ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "3659", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "230", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2272", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1644366226", cells: ["FOO-4226", "Pasteurize Item 1", "7/11/2026", "€16 326"], status: "active" as const },
    { id: "1644369797", cells: ["FOO-7797", "Pasteurize Item 2", "22/6/2026", "€19 897"], status: "pending" as const },
    { id: "1644373368", cells: ["FOO-2368", "Pasteurize Item 3", "9/1/2026", "€23 468"], status: "completed" as const },
    { id: "1644376939", cells: ["FOO-5939", "Pasteurize Item 4", "24/8/2026", "€27 039"], status: "warning" as const },
    { id: "1644380510", cells: ["FOO-9510", "Pasteurize Item 5", "11/3/2026", "€30 610"], status: "active" as const },
];
...
export default function FoodManufacturingPasteurizePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pasteurize</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Pasteurize</p>
                    </div>
                </div>
