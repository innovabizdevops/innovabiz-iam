...
/* ═══ Food Manufacturing — Raw Receiving ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total", value: "1141", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "366", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2093", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "664292186", cells: ["FOO-3186", "Raw Receiving Item 1", "27/3/2026", "€42 286"], status: "active" as const },
    { id: "664295757", cells: ["FOO-6757", "Raw Receiving Item 2", "14/10/2026", "€45 857"], status: "pending" as const },
    { id: "664299328", cells: ["FOO-1328", "Raw Receiving Item 3", "1/5/2026", "€49 428"], status: "completed" as const },
    { id: "664302899", cells: ["FOO-4899", "Raw Receiving Item 4", "16/12/2026", "€2999"], status: "warning" as const },
    { id: "664306470", cells: ["FOO-8470", "Raw Receiving Item 5", "3/7/2026", "€6570"], status: "active" as const },
];
...
export default function FoodManufacturingRawReceivingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Raw Receiving</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Manufacturing • Raw Receiving</p>
                    </div>
                </div>
