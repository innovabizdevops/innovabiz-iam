...
const KPIS = [{"l":"Vendas YTD (€)","v":"€83696","t":"+1.7%","d":"up"},{"l":"Pipeline (€)","v":"€91845","t":"+4.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"73.0%","t":"+9.6%","d":"up"},{"l":"Win Rate (%)","v":"90.3%","t":"+4.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 20879.69","€ 36342.14","€ 46592.05","94.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 44725.35","€ 42762.07","€ 5696.76","83.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 6627.71","€ 40660.85","€ 1201.60","82.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 15909.63","€ 29247.87","€ 14363.14","88.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 18593.60","€ 36404.49","€ 31967.86","95.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":598},{"label":"Mar","value":681},{"label":"Abr","value":851},{"label":"Mai","value":701},{"label":"Jun","value":725},{"label":"Jul","value":769},{"label":"Ago","value":928},{"label":"Set","value":919},{"label":"Out","value":627},{"label":"Nov","value":918},{"label":"Dez","value":891}];
const MX = 928;
