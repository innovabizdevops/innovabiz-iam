...
const PAGE = "Brand Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.336","t":"-5.8%","d":"down"},{"l":"NC Abertas","v":"1.857","t":"-5.9%","d":"down"},{"l":"Conformidade (%)","v":"93.1%","t":"-4.7%","d":"down"},{"l":"CAPAs Pendentes","v":"5.888","t":"+2.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.997","93.1%","6.375","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.005","84.7%","6.621","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.994","75.7%","631","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.574","82.6%","5.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.888","72.3%","4.220","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":481},{"label":"Mar","value":780},{"label":"Abr","value":668},{"label":"Mai","value":451},{"label":"Jun","value":822},{"label":"Jul","value":756},{"label":"Ago","value":809},{"label":"Set","value":467},{"label":"Out","value":640},{"label":"Nov","value":460},{"label":"Dez","value":563}];
const MX = 822;
