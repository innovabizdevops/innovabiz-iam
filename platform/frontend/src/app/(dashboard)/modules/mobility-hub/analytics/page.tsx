...
const ACCENT = "#6366f1";
const MODULE = "Mobility Hub";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"5.664","t":"+7.2%","d":"up"},{"l":"Queries/Dia","v":"4100","t":"+17.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.567","t":"+14.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.615","t":"+11.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","955","2026-01-10","1.096","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4278","2026-01-06","3.961","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","172","2026-02-17","1.818","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3999","2026-02-10","6.277","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3794","2026-02-03","8.132","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":570},{"label":"Mar","value":815},{"label":"Abr","value":642},{"label":"Mai","value":550},{"label":"Jun","value":850},{"label":"Jul","value":808},{"label":"Ago","value":559},{"label":"Set","value":650},{"label":"Out","value":763},{"label":"Nov","value":610},{"label":"Dez","value":870}];
const MX = 870;
