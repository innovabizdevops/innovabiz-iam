...
const KPIS = [{"l":"Integrações Ativas","v":"2.527","t":"+11.5%","d":"up"},{"l":"Chamadas/Hora","v":"4015","t":"-2.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"94.0%","t":"-4.6%","d":"down"},{"l":"Latência Média (ms)","v":"114ms","t":"-2.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.981","5.859","92.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.916","4.375","81.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.388","7.684","80.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.366","4.652","98.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.491","2.075","94.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":471},{"label":"Mar","value":662},{"label":"Abr","value":610},{"label":"Mai","value":752},{"label":"Jun","value":729},{"label":"Jul","value":455},{"label":"Ago","value":762},{"label":"Set","value":803},{"label":"Out","value":720},{"label":"Nov","value":524},{"label":"Dez","value":795}];
const MX = 803;
