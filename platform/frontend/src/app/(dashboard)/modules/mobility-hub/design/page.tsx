...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.551","t":"+16.4%","d":"up"},{"l":"Submissões/Dia","v":"3749","t":"+9.2%","d":"up"},{"l":"Documentos Gerados","v":"7.154","t":"+16.1%","d":"up"},{"l":"Templates","v":"8.626","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.240","2026-03-25","290","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.020","2026-02-09","6.377","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.057","2026-02-22","641","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.303","2026-02-27","1.018","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.638","2026-02-01","608","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":634},{"label":"Mar","value":380},{"label":"Abr","value":616},{"label":"Mai","value":571},{"label":"Jun","value":352},{"label":"Jul","value":375},{"label":"Ago","value":525},{"label":"Set","value":494},{"label":"Out","value":383},{"label":"Nov","value":304},{"label":"Dez","value":405}];
const MX = 634;
