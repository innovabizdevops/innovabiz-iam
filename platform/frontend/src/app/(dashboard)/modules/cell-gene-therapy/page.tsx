...
/* ═══ Cell & Gene Therapy — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "1973", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3884", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€257K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "699268573", cells: ["CEL-5573", "Cell & Gene Therapy Item 1", "18/2/2026", "€18 673"], status: "active" as const },
    { id: "699272144", cells: ["CEL-9144", "Cell & Gene Therapy Item 2", "5/9/2026", "€22 244"], status: "pending" as const },
    { id: "699275715", cells: ["CEL-3715", "Cell & Gene Therapy Item 3", "20/4/2026", "€25 815"], status: "completed" as const },
    { id: "699279286", cells: ["CEL-7286", "Cell & Gene Therapy Item 4", "7/11/2026", "€29 386"], status: "warning" as const },
    { id: "699282857", cells: ["CEL-1857", "Cell & Gene Therapy Item 5", "22/6/2026", "€32 957"], status: "active" as const },
];
...
export default function CellGeneTherapyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cell & Gene Therapy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cell & Gene Therapy</p>
                    </div>
                </div>
