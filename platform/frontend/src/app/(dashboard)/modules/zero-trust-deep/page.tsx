...
/* ═══ Zero Trust Architecture Deep — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "2773", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4676", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€411K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1271924973", cells: ["ZER-9973", "Zero Trust Architecture Deep Item 1", "26/10/2026", "€25 073"], status: "active" as const },
    { id: "1271928544", cells: ["ZER-4544", "Zero Trust Architecture Deep Item 2", "13/5/2026", "€28 644"], status: "pending" as const },
    { id: "1271932115", cells: ["ZER-8115", "Zero Trust Architecture Deep Item 3", "28/12/2026", "€32 215"], status: "completed" as const },
    { id: "1271935686", cells: ["ZER-2686", "Zero Trust Architecture Deep Item 4", "15/7/2026", "€35 786"], status: "warning" as const },
    { id: "1271939257", cells: ["ZER-6257", "Zero Trust Architecture Deep Item 5", "2/2/2026", "€39 357"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 33 }, { label: "Fev", value: 42 }, { label: "Mar", value: 51 }, { label: "Abr", value: 60 }, { label: "Mai", value: 69 }, { label: "Jun", value: 78 }];
...
export default function ZeroTrustArchitectureDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Zero Trust Architecture Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Zero Trust Architecture Deep</p>
                    </div>
                </div>
