...
const PAGE = "Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.233","t":"+11.6%","d":"up"},{"l":"Sessões/Dia","v":"2342","t":"-0.4%","d":"down"},{"l":"MFA Adoção (%)","v":"65.7%","t":"+13.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.712","t":"+4.8%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.310","1.817","2.365","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.392","7.239","7.832","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.744","1.794","7.847","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.517","4.983","8.661","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.232","4.932","8.309","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":543},{"label":"Mar","value":828},{"label":"Abr","value":854},{"label":"Mai","value":807},{"label":"Jun","value":596},{"label":"Jul","value":862},{"label":"Ago","value":798},{"label":"Set","value":583},{"label":"Out","value":803},{"label":"Nov","value":858},{"label":"Dez","value":615}];
const MX = 862;
