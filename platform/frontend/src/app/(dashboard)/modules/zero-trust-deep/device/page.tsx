...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"3.208","t":"-2.5%","d":"down"},{"l":"Dados/Min (MB)","v":"5.695","t":"+17.6%","d":"up"},{"l":"Alertas Ativos","v":"1.497","t":"+1.8%","d":"up"},{"l":"Uptime (%)","v":"78.4%","t":"+9.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.505","4.800","3.135","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.318","6.910","2.319","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.322","6.782","8.660","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.056","6.089","4.439","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.869","1.742","5.642","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":658},{"label":"Mar","value":513},{"label":"Abr","value":656},{"label":"Mai","value":510},{"label":"Jun","value":479},{"label":"Jul","value":493},{"label":"Ago","value":637},{"label":"Set","value":439},{"label":"Out","value":639},{"label":"Nov","value":443},{"label":"Dez","value":469}];
const MX = 658;
