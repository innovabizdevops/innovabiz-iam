...
const ACCENT = "#0891b2";
const MODULE = "Zero Trust Architecture Deep";
const PAGE = "Network";
const KPIS = [{"l":"Total Zero Trust Deep","v":"3.231","t":"+5.7%","d":"up"},{"l":"Network Ativos","v":"1.922","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"74.7%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"63","t":"+14.0%","d":"up"}];
const COLS = ["ID","Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Zero Trust Deep #001","Zero Trust Deep #002","3.480","6.407","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Zero Trust Deep #002","Zero Trust Deep #003","292","6.378","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Zero Trust Deep #003","Zero Trust Deep #004","4.872","4.443","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Zero Trust Deep #004","Zero Trust Deep #005","4.377","494","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Zero Trust Deep #005","Zero Trust Deep #001","8.144","896","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":735},{"label":"Mar","value":877},{"label":"Abr","value":898},{"label":"Mai","value":620},{"label":"Jun","value":653},{"label":"Jul","value":600},{"label":"Ago","value":850},{"label":"Set","value":912},{"label":"Out","value":564},{"label":"Nov","value":704},{"label":"Dez","value":787}];
const MX = 912;
