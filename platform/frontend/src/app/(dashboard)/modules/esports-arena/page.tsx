...
export default function EsportsArenaPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Esports Arena</h1><p className="text-sm text-muted-foreground">Esports Arena • iBOS</p></div>
