...
const KPIS = [{"l":"Atletas Registados","v":"2.454","t":"+12.4%","d":"up"},{"l":"Treinos/Semana","v":"1572","t":"-1.4%","d":"down"},{"l":"Competições","v":"7.891","t":"+8.6%","d":"up"},{"l":"Performance Score","v":"73","t":"-4.1%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.395","5.755","3.441","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.410","8.493","2.656","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.230","8.338","2.487","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.040","5.574","1.525","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","396","5.109","965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":768},{"label":"Mar","value":978},{"label":"Abr","value":717},{"label":"Mai","value":1052},{"label":"Jun","value":868},{"label":"Jul","value":962},{"label":"Ago","value":942},{"label":"Set","value":954},{"label":"Out","value":731},{"label":"Nov","value":1007},{"label":"Dez","value":705}];
const MX = 1052;
