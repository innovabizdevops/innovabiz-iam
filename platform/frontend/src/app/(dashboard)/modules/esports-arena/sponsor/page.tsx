...
const PAGE = "Sponsor";
const KPIS = [{"l":"Eventos Planeados","v":"5.842","t":"+3.2%","d":"up"},{"l":"Participantes","v":"8.568","t":"+14.0%","d":"up"},{"l":"NPS Evento","v":"75","t":"+16.8%","d":"up"},{"l":"Receita (€)","v":"€92014","t":"+6.7%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-07","3.970","4.084","€ 37357.44","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-20","3.181","4.451","€ 13773.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-12","2.281","3.363","€ 16144.12","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-02","1.258","3.075","€ 41607.51","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-04","8.094","6.777","€ 21236.13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":666},{"label":"Mar","value":693},{"label":"Abr","value":330},{"label":"Mai","value":584},{"label":"Jun","value":305},{"label":"Jul","value":561},{"label":"Ago","value":495},{"label":"Set","value":300},{"label":"Out","value":496},{"label":"Nov","value":648},{"label":"Dez","value":575}];
const MX = 693;
