...
const ACCENT = "#ec4899";
const MODULE = "Esports Arena";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.500","t":"+2.3%","d":"up"},{"l":"Queries/Dia","v":"2926","t":"+4.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.036","t":"-4.2%","d":"down"},{"l":"Utilizadores Analytics","v":"2.598","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2305","2026-02-27","6.378","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1285","2026-01-09","5.635","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2078","2026-02-01","4.926","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3982","2026-01-19","3.649","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3445","2026-02-02","6.702","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":377},{"label":"Mar","value":241},{"label":"Abr","value":414},{"label":"Mai","value":361},{"label":"Jun","value":338},{"label":"Jul","value":422},{"label":"Ago","value":291},{"label":"Set","value":322},{"label":"Out","value":557},{"label":"Nov","value":257},{"label":"Dez","value":318}];
const MX = 599;
