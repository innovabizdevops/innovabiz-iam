...
const PAGE = "Venue";
const KPIS = [{"l":"Atletas Registados","v":"6.480","t":"+11.4%","d":"up"},{"l":"Treinos/Semana","v":"1479","t":"+10.7%","d":"up"},{"l":"Competições","v":"6.327","t":"+9.7%","d":"up"},{"l":"Performance Score","v":"67","t":"+17.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.859","8.472","5.993","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.987","1.671","3.961","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.186","768","3.309","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.436","2.725","8.919","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.428","4.809","7.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":694},{"label":"Mar","value":885},{"label":"Abr","value":899},{"label":"Mai","value":952},{"label":"Jun","value":777},{"label":"Jul","value":746},{"label":"Ago","value":916},{"label":"Set","value":1013},{"label":"Out","value":1002},{"label":"Nov","value":778},{"label":"Dez","value":756}];
const MX = 1013;
