...
const PAGE = "Stream";
const KPIS = [{"l":"Atletas Registados","v":"7.666","t":"+17.5%","d":"up"},{"l":"Treinos/Semana","v":"5066","t":"-0.2%","d":"down"},{"l":"Competições","v":"1.506","t":"-1.9%","d":"down"},{"l":"Performance Score","v":"66","t":"+16.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.503","3.746","7.138","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.762","4.278","6.750","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.566","5.928","2.061","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","922","2.572","5.452","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.414","4.484","8.683","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":455},{"label":"Mar","value":621},{"label":"Abr","value":554},{"label":"Mai","value":442},{"label":"Jun","value":338},{"label":"Jul","value":615},{"label":"Ago","value":458},{"label":"Set","value":290},{"label":"Out","value":622},{"label":"Nov","value":624},{"label":"Dez","value":490}];
const MX = 624;
