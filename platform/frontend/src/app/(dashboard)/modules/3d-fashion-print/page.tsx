...
/* ═══ Fashion 3D Printing — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "6227", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3341", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€293K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "645159427", cells: ["3D-4427", "Fashion 3D Printing Item 1", "4/8/2026", "€9527"], status: "active" as const },
    { id: "645162998", cells: ["3D-7998", "Fashion 3D Printing Item 2", "19/3/2026", "€13 098"], status: "pending" as const },
    { id: "645166569", cells: ["3D-2569", "Fashion 3D Printing Item 3", "6/10/2026", "€16 669"], status: "completed" as const },
    { id: "645170140", cells: ["3D-6140", "Fashion 3D Printing Item 4", "21/5/2026", "€20 240"], status: "warning" as const },
    { id: "645173711", cells: ["3D-9711", "Fashion 3D Printing Item 5", "8/12/2026", "€23 811"], status: "active" as const },
];
...
export default function Fashion3dPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion 3D Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion 3D Printing</p>
                    </div>
                </div>
