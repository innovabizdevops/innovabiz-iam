...
const PAGE = "Print";
const KPIS = [{"l":"Total 3d Fashion Print","v":"4.782","t":"+10.3%","d":"up"},{"l":"Print Ativos","v":"3.351","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"80","t":"+17.6%","d":"up"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Fashion Print #001","3d Fashion Print #002","1.790","7.241","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["3d Fashion Print #002","3d Fashion Print #003","3.612","296","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Fashion Print #003","3d Fashion Print #004","793","5.894","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["3d Fashion Print #004","3d Fashion Print #005","4.722","5.543","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Fashion Print #005","3d Fashion Print #001","5.343","5.003","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":929},{"label":"Mar","value":626},{"label":"Abr","value":813},{"label":"Mai","value":863},{"label":"Jun","value":921},{"label":"Jul","value":662},{"label":"Ago","value":926},{"label":"Set","value":682},{"label":"Out","value":903},{"label":"Nov","value":790},{"label":"Dez","value":611}];
const MX = 929;
