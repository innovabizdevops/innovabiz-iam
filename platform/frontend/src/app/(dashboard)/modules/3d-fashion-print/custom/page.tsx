...
const PAGE = "Custom";
const KPIS = [{"l":"Total 3d Fashion Print","v":"6.758","t":"-3.5%","d":"down"},{"l":"Custom Ativos","v":"€34271","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"56","t":"+5.5%","d":"up"}];
const COLS = ["ID","Custom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Fashion Print #001","€ 32288.37","2.383","7.799","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["3d Fashion Print #002","€ 9495.19","4.722","4.173","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Fashion Print #003","€ 44982.62","4.529","5.814","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["3d Fashion Print #004","€ 29210.85","2.482","2.089","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Fashion Print #005","€ 20829.52","9.047","1.279","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":248},{"label":"Mar","value":385},{"label":"Abr","value":473},{"label":"Mai","value":432},{"label":"Jun","value":349},{"label":"Jul","value":417},{"label":"Ago","value":245},{"label":"Set","value":260},{"label":"Out","value":294},{"label":"Nov","value":532},{"label":"Dez","value":267}];
const MX = 532;
