...
const ACCENT = "#6366f1";
const MODULE = "Fashion 3D Printing";
const PAGE = "Finish";
const KPIS = [{"l":"Total 3d Fashion Print","v":"4.494","t":"+6.5%","d":"up"},{"l":"Finish Ativos","v":"7.672","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+11.3%","d":"up"}];
const COLS = ["ID","Finish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Fashion Print #001","3d Fashion Print #002","5.713","1.104","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["3d Fashion Print #002","3d Fashion Print #003","4.756","3.144","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Fashion Print #003","3d Fashion Print #004","3.660","5.217","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["3d Fashion Print #004","3d Fashion Print #005","4.267","7.031","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Fashion Print #005","3d Fashion Print #001","1.976","401","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":666},{"label":"Mar","value":483},{"label":"Abr","value":697},{"label":"Mai","value":476},{"label":"Jun","value":818},{"label":"Jul","value":700},{"label":"Ago","value":642},{"label":"Set","value":749},{"label":"Out","value":556},{"label":"Nov","value":501},{"label":"Dez","value":573}];
const MX = 818;
