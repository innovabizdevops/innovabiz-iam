...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.365","t":"+14.2%","d":"up"},{"l":"Submissões/Dia","v":"4913","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"998","t":"+9.7%","d":"up"},{"l":"Templates","v":"7.375","t":"-2.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.080","2026-01-02","150","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.231","2026-03-12","4.521","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.955","2026-02-20","8.777","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.346","2026-03-04","1.119","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.208","2026-02-11","1.672","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":211},{"label":"Fev","value":230},{"label":"Mar","value":405},{"label":"Abr","value":367},{"label":"Mai","value":271},{"label":"Jun","value":586},{"label":"Jul","value":323},{"label":"Ago","value":495},{"label":"Set","value":263},{"label":"Out","value":488},{"label":"Nov","value":555},{"label":"Dez","value":433}];
const MX = 586;
