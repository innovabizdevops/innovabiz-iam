...
const PAGE = "Case";
const KPIS = [{"l":"Total Snow Csm","v":"678","t":"+17.8%","d":"up"},{"l":"Case Ativos","v":"311","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"81.0%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"94","t":"+8.6%","d":"up"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Csm #001","Snow Csm #002","5.833","8.383","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Csm #002","Snow Csm #003","5.943","1.346","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Csm #003","Snow Csm #004","5.208","2.569","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Csm #004","Snow Csm #005","1.707","6.902","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Csm #005","Snow Csm #001","509","1.296","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":493},{"label":"Mar","value":494},{"label":"Abr","value":756},{"label":"Mai","value":510},{"label":"Jun","value":658},{"label":"Jul","value":727},{"label":"Ago","value":670},{"label":"Set","value":463},{"label":"Out","value":603},{"label":"Nov","value":735},{"label":"Dez","value":553}];
const MX = 756;
