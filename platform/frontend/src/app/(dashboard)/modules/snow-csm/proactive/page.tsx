...
const ACCENT = "#81b5a1";
const MODULE = "Customer Service Mgmt (SNOW)";
const PAGE = "Proactive";
const KPIS = [{"l":"Total Snow Csm","v":"1.774","t":"-2.6%","d":"down"},{"l":"Proactive Ativos","v":"1.866","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.0%","d":"down"}];
const COLS = ["ID","Proactive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Csm #001","Snow Csm #002","4.221","2.352","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Csm #002","Snow Csm #003","3.989","3.712","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Csm #003","Snow Csm #004","6.643","6.014","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Csm #004","Snow Csm #005","659","759","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Csm #005","Snow Csm #001","6.990","1.617","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":1008},{"label":"Mar","value":672},{"label":"Abr","value":889},{"label":"Mai","value":770},{"label":"Jun","value":941},{"label":"Jul","value":1033},{"label":"Ago","value":931},{"label":"Set","value":969},{"label":"Out","value":1045},{"label":"Nov","value":715},{"label":"Dez","value":739}];
const MX = 1045;
