...
const PAGE = "Account";
const KPIS = [{"l":"Total Snow Csm","v":"2.601","t":"-2.8%","d":"down"},{"l":"Account Ativos","v":"4.487","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"72.1%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.7%","d":"up"}];
const COLS = ["ID","Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Csm #001","Snow Csm #002","1.337","3.107","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Csm #002","Snow Csm #003","7.736","6.676","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Csm #003","Snow Csm #004","3.019","1.466","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Csm #004","Snow Csm #005","3.686","7.228","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Csm #005","Snow Csm #001","1.040","1.024","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1033},{"label":"Fev","value":917},{"label":"Mar","value":1071},{"label":"Abr","value":927},{"label":"Mai","value":861},{"label":"Jun","value":798},{"label":"Jul","value":892},{"label":"Ago","value":749},{"label":"Set","value":738},{"label":"Out","value":810},{"label":"Nov","value":1065},{"label":"Dez","value":917}];
const MX = 1071;
