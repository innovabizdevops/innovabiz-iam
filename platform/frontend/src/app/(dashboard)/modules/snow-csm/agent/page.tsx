...
const PAGE = "Agent";
const KPIS = [{"l":"Total Snow Csm","v":"5.431","t":"+10.9%","d":"up"},{"l":"Agent Ativos","v":"6.936","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"83","t":"-0.7%","d":"down"}];
const COLS = ["ID","Agent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Csm #001","Snow Csm #002","1.089","4.238","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Csm #002","Snow Csm #003","1.625","3.115","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Csm #003","Snow Csm #004","3.584","2.086","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Csm #004","Snow Csm #005","3.397","1.018","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Csm #005","Snow Csm #001","7.524","6.738","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":514},{"label":"Mar","value":709},{"label":"Abr","value":577},{"label":"Mai","value":374},{"label":"Jun","value":599},{"label":"Jul","value":470},{"label":"Ago","value":444},{"label":"Set","value":570},{"label":"Out","value":533},{"label":"Nov","value":509},{"label":"Dez","value":655}];
const MX = 713;
