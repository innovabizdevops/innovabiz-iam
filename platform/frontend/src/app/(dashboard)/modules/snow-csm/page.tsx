...
/* ═══ Customer Service Mgmt (SNOW) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "8810", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "260", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€211K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2122242010", cells: ["SNO-7010", "Customer Service Mgmt (SNOW) Item 1", "15/11/2026", "€42 110"], status: "active" as const },
    { id: "2122245581", cells: ["SNO-1581", "Customer Service Mgmt (SNOW) Item 2", "2/6/2026", "€45 681"], status: "pending" as const },
    { id: "2122249152", cells: ["SNO-5152", "Customer Service Mgmt (SNOW) Item 3", "17/1/2026", "€49 252"], status: "completed" as const },
    { id: "2122252723", cells: ["SNO-8723", "Customer Service Mgmt (SNOW) Item 4", "4/8/2026", "€2823"], status: "warning" as const },
    { id: "2122256294", cells: ["SNO-3294", "Customer Service Mgmt (SNOW) Item 5", "19/3/2026", "€6394"], status: "active" as const },
];
...
export default function CustomerServiceMgmtSnowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customer Service Mgmt (SNOW)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Customer Service Mgmt (SNOW)</p>
                    </div>
                </div>
