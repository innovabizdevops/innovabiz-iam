...
const PAGE = "Intra-Op";
const KPIS = [{"l":"Total Surgery Mgmt","v":"4.784","t":"+9.9%","d":"up"},{"l":"Intra Op Ativos","v":"6.570","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"87","t":"-4.7%","d":"down"}];
const COLS = ["ID","Intra Op","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surgery Mgmt #001","Surgery Mgmt #002","8.407","5.093","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Surgery Mgmt #002","Surgery Mgmt #003","5.914","1.559","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Surgery Mgmt #003","Surgery Mgmt #004","5.447","858","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Surgery Mgmt #004","Surgery Mgmt #005","8.096","1.241","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surgery Mgmt #005","Surgery Mgmt #001","4.159","2.826","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":774},{"label":"Mar","value":538},{"label":"Abr","value":551},{"label":"Mai","value":486},{"label":"Jun","value":563},{"label":"Jul","value":710},{"label":"Ago","value":761},{"label":"Set","value":660},{"label":"Out","value":782},{"label":"Nov","value":801},{"label":"Dez","value":595}];
const MX = 801;
