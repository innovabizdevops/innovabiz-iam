...
const ACCENT = "#6366f1";
const MODULE = "Surgery Management";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Surgery Mgmt","v":"3.447","t":"-3.0%","d":"down"},{"l":"Inventory Ativos","v":"891","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+10.8%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surgery Mgmt #001","Surgery Mgmt #002","4.166","1.379","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Surgery Mgmt #002","Surgery Mgmt #003","4.666","7.225","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Surgery Mgmt #003","Surgery Mgmt #004","2.456","3.257","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Surgery Mgmt #004","Surgery Mgmt #005","4.874","1.179","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surgery Mgmt #005","Surgery Mgmt #001","3.736","1.872","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":481},{"label":"Mar","value":599},{"label":"Abr","value":690},{"label":"Mai","value":723},{"label":"Jun","value":568},{"label":"Jul","value":688},{"label":"Ago","value":555},{"label":"Set","value":703},{"label":"Out","value":843},{"label":"Nov","value":726},{"label":"Dez","value":840}];
const MX = 843;
