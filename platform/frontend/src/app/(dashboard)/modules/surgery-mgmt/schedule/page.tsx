...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Surgery Mgmt","v":"6.736","t":"+11.1%","d":"up"},{"l":"Schedule Ativos","v":"5.728","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"86.6%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"66","t":"+8.8%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surgery Mgmt #001","Surgery Mgmt #002","7.866","3.891","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Surgery Mgmt #002","Surgery Mgmt #003","7.560","6.147","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Surgery Mgmt #003","Surgery Mgmt #004","693","2.599","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Surgery Mgmt #004","Surgery Mgmt #005","5.753","2.081","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surgery Mgmt #005","Surgery Mgmt #001","6.829","8.331","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":625},{"label":"Mar","value":619},{"label":"Abr","value":437},{"label":"Mai","value":775},{"label":"Jun","value":412},{"label":"Jul","value":786},{"label":"Ago","value":705},{"label":"Set","value":789},{"label":"Out","value":565},{"label":"Nov","value":484},{"label":"Dez","value":545}];
const MX = 789;
