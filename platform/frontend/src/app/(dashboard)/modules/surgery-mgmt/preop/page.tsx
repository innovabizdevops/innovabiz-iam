...
const PAGE = "Pre-Op";
const KPIS = [{"l":"Total Surgery Mgmt","v":"4.337","t":"+14.8%","d":"up"},{"l":"Pre Op Ativos","v":"3.422","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"82","t":"+10.4%","d":"up"}];
const COLS = ["ID","Pre Op","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surgery Mgmt #001","Surgery Mgmt #002","2.193","6.170","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Surgery Mgmt #002","Surgery Mgmt #003","1.921","1.864","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Surgery Mgmt #003","Surgery Mgmt #004","3.047","6.905","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Surgery Mgmt #004","Surgery Mgmt #005","498","4.918","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surgery Mgmt #005","Surgery Mgmt #001","7.823","8.131","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":664},{"label":"Mar","value":844},{"label":"Abr","value":968},{"label":"Mai","value":858},{"label":"Jun","value":1026},{"label":"Jul","value":825},{"label":"Ago","value":753},{"label":"Set","value":914},{"label":"Out","value":688},{"label":"Nov","value":786},{"label":"Dez","value":899}];
const MX = 1026;
