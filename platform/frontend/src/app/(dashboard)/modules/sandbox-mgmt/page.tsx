...
const KPIS = [
    ...
    { label: "Ativos", value: "2911", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€172K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "572361682", cells: ["SAN-7682", "Sandbox Management Item 1", "19/11/2026", "€11 782"], status: "active" as const },
    { id: "572365253", cells: ["SAN-2253", "Sandbox Management Item 2", "6/6/2026", "€15 353"], status: "pending" as const },
    { id: "572368824", cells: ["SAN-5824", "Sandbox Management Item 3", "21/1/2026", "€18 924"], status: "completed" as const },
    { id: "572372395", cells: ["SAN-9395", "Sandbox Management Item 4", "8/8/2026", "€22 495"], status: "warning" as const },
    { id: "572375966", cells: ["SAN-3966", "Sandbox Management Item 5", "23/3/2026", "€26 066"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sandbox Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sandbox Management</p>
                    </div>
                </div>
