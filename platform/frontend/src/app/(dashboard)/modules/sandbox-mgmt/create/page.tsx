...
const ACCENT = "#059669";
const MODULE = "Sandbox Management";
const PAGE = "Create";
const KPIS = [{"l":"Total Sandbox Mgmt","v":"1.117","t":"-2.4%","d":"down"},{"l":"Create Ativos","v":"6.199","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"85","t":"+12.1%","d":"up"}];
const COLS = ["ID","Create","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sandbox Mgmt #001","Sandbox Mgmt #002","385","1.706","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Sandbox Mgmt #002","Sandbox Mgmt #003","1.870","2.319","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Sandbox Mgmt #003","Sandbox Mgmt #004","3.716","2.989","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Sandbox Mgmt #004","Sandbox Mgmt #005","8.446","8.684","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sandbox Mgmt #005","Sandbox Mgmt #001","6.818","1.603","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":265},{"label":"Fev","value":256},{"label":"Mar","value":291},{"label":"Abr","value":267},{"label":"Mai","value":634},{"label":"Jun","value":446},{"label":"Jul","value":501},{"label":"Ago","value":583},{"label":"Set","value":475},{"label":"Out","value":472},{"label":"Nov","value":253},{"label":"Dez","value":632}];
const MX = 634;
