...
const PAGE = "Route";
const KPIS = [{"l":"Veículos Operação","v":"3.759","t":"+12.3%","d":"up"},{"l":"Viagens/Dia","v":"2947","t":"-3.2%","d":"down"},{"l":"Pontualidade (%)","v":"81.0%","t":"+3.1%","d":"up"},{"l":"Passageiros/Dia","v":"1113","t":"+8.6%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-10","2026-03-24","3.075","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-06","2026-01-04","2.156","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-17","2026-01-07","8.398","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-18","2026-01-10","5.717","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-16","2026-02-03","351","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":528},{"label":"Mar","value":689},{"label":"Abr","value":597},{"label":"Mai","value":643},{"label":"Jun","value":496},{"label":"Jul","value":605},{"label":"Ago","value":696},{"label":"Set","value":539},{"label":"Out","value":603},{"label":"Nov","value":699},{"label":"Dez","value":710}];
const MX = 710;
