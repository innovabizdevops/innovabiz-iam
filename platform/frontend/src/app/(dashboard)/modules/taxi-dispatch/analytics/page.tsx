...
const KPIS = [{"l":"Dashboards Ativos","v":"7.408","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"2875","t":"+5.7%","d":"up"},{"l":"Dados Processados (GB)","v":"2.311","t":"+0.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.441","t":"-4.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1310","2026-03-24","1.284","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","337","2026-02-14","4.428","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2106","2026-03-12","5.996","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1854","2026-02-19","1.719","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4876","2026-02-07","3.381","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":684},{"label":"Mar","value":539},{"label":"Abr","value":615},{"label":"Mai","value":633},{"label":"Jun","value":565},{"label":"Jul","value":674},{"label":"Ago","value":355},{"label":"Set","value":450},{"label":"Out","value":538},{"label":"Nov","value":385},{"label":"Dez","value":649}];
const MX = 684;
