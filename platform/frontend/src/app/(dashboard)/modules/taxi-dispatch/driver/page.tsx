...
const PAGE = "Driver";
const KPIS = [{"l":"Veículos Operação","v":"4.276","t":"+14.7%","d":"up"},{"l":"Viagens/Dia","v":"779","t":"-0.2%","d":"down"},{"l":"Pontualidade (%)","v":"78.3%","t":"+12.2%","d":"up"},{"l":"Passageiros/Dia","v":"3839","t":"+16.9%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-23","2026-01-25","4.012","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-27","2026-03-18","7.506","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-09","2026-01-20","7.954","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-11","2026-03-08","8.496","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-01","2026-02-20","6.536","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":740},{"label":"Mar","value":691},{"label":"Abr","value":613},{"label":"Mai","value":455},{"label":"Jun","value":679},{"label":"Jul","value":455},{"label":"Ago","value":727},{"label":"Set","value":499},{"label":"Out","value":818},{"label":"Nov","value":473},{"label":"Dez","value":784}];
const MX = 818;
