...
const PAGE = "Payment";
const KPIS = [{"l":"Veículos Operação","v":"1.734","t":"+4.3%","d":"up"},{"l":"Viagens/Dia","v":"1982","t":"-5.7%","d":"down"},{"l":"Pontualidade (%)","v":"83.0%","t":"+16.5%","d":"up"},{"l":"Passageiros/Dia","v":"1969","t":"-3.4%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-24","2026-01-18","2.290","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-16","2026-01-23","5.666","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-22","2026-03-28","3.295","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-14","2026-03-09","6.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-02","2026-02-20","285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":549},{"label":"Mar","value":562},{"label":"Abr","value":630},{"label":"Mai","value":763},{"label":"Jun","value":794},{"label":"Jul","value":560},{"label":"Ago","value":409},{"label":"Set","value":631},{"label":"Out","value":598},{"label":"Nov","value":644},{"label":"Dez","value":528}];
const MX = 794;
