...
const ACCENT = "#0d9488";
const MODULE = "Taxi Dispatch";
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"505","t":"+4.9%","d":"up"},{"l":"Viagens/Dia","v":"5012","t":"+17.5%","d":"up"},{"l":"Pontualidade (%)","v":"86.4%","t":"+3.0%","d":"up"},{"l":"Passageiros/Dia","v":"1713","t":"+6.7%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-04","2026-01-21","1.834","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-02","2026-02-11","2.564","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-24","2026-02-22","8.631","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-25","2026-02-26","3.680","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-03","2026-02-08","8.712","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":879},{"label":"Mar","value":606},{"label":"Abr","value":703},{"label":"Mai","value":918},{"label":"Jun","value":606},{"label":"Jul","value":797},{"label":"Ago","value":740},{"label":"Set","value":922},{"label":"Out","value":631},{"label":"Nov","value":846},{"label":"Dez","value":605}];
const MX = 922;
