...
/* ═══ Taxi Dispatch — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "1696", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2595", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€493K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1933818096", cells: ["TAX-7096", "Taxi Dispatch Item 1", "1/1/2026", "€18 196"], status: "active" as const },
    { id: "1933821667", cells: ["TAX-1667", "Taxi Dispatch Item 2", "16/8/2026", "€21 767"], status: "pending" as const },
    { id: "1933825238", cells: ["TAX-5238", "Taxi Dispatch Item 3", "3/3/2026", "€25 338"], status: "completed" as const },
    { id: "1933828809", cells: ["TAX-8809", "Taxi Dispatch Item 4", "18/10/2026", "€28 909"], status: "warning" as const },
    { id: "1933832380", cells: ["TAX-3380", "Taxi Dispatch Item 5", "5/5/2026", "€32 480"], status: "active" as const },
];
...
export default function TaxiDispatchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Taxi Dispatch</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Taxi Dispatch</p>
                    </div>
                </div>
