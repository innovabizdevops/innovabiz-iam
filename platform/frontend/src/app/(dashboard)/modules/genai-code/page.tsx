...
/* ═══ GenAI Code Generation — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "6769", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4417", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€308K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1524735369", cells: ["GEN-1369", "GenAI Code Generation Item 1", "18/10/2026", "€35 469"], status: "active" as const },
    { id: "1524738940", cells: ["GEN-4940", "GenAI Code Generation Item 2", "5/5/2026", "€39 040"], status: "pending" as const },
    { id: "1524742511", cells: ["GEN-8511", "GenAI Code Generation Item 3", "20/12/2026", "€42 611"], status: "completed" as const },
    { id: "1524746082", cells: ["GEN-3082", "GenAI Code Generation Item 4", "7/7/2026", "€46 182"], status: "warning" as const },
    { id: "1524749653", cells: ["GEN-6653", "GenAI Code Generation Item 5", "22/2/2026", "€49 753"], status: "active" as const },
];
...
export default function GenaiCodeGenerationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Code Generation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Code Generation</p>
                    </div>
                </div>
