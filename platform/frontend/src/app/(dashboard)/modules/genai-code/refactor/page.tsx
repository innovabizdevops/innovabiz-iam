...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Code Generation";
const PAGE = "Refactor";
const KPIS = [{"l":"Total Genai Code","v":"3.691","t":"+0.4%","d":"up"},{"l":"Refactor Ativos","v":"8.574","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"78","t":"+12.0%","d":"up"}];
const COLS = ["ID","Refactor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Code #001","Genai Code #002","7.479","5.222","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Code #002","Genai Code #003","5.495","4.010","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Code #003","Genai Code #004","5.664","6.876","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Code #004","Genai Code #005","935","7.086","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Code #005","Genai Code #001","3.751","258","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":947},{"label":"Mar","value":693},{"label":"Abr","value":1001},{"label":"Mai","value":825},{"label":"Jun","value":818},{"label":"Jul","value":913},{"label":"Ago","value":1032},{"label":"Set","value":984},{"label":"Out","value":1064},{"label":"Nov","value":762},{"label":"Dez","value":1025}];
const MX = 1064;
