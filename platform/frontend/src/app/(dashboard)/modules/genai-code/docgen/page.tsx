...
const PAGE = "Doc Gen";
const KPIS = [{"l":"Total Genai Code","v":"6.603","t":"+8.5%","d":"up"},{"l":"Doc Gen Ativos","v":"107","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"88.5%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+4.5%","d":"up"}];
const COLS = ["ID","Doc Gen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Code #001","Genai Code #002","7.238","2.448","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Code #002","Genai Code #003","5.476","7.771","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Code #003","Genai Code #004","4.686","4.588","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Code #004","Genai Code #005","3.039","6.772","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Code #005","Genai Code #001","1.237","4.415","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":631},{"label":"Mar","value":594},{"label":"Abr","value":704},{"label":"Mai","value":682},{"label":"Jun","value":585},{"label":"Jul","value":603},{"label":"Ago","value":740},{"label":"Set","value":585},{"label":"Out","value":824},{"label":"Nov","value":548},{"label":"Dez","value":682}];
const MX = 824;
