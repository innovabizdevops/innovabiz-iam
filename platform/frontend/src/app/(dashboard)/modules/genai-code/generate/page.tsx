...
const PAGE = "Generate";
const KPIS = [{"l":"Total Genai Code","v":"227","t":"-5.1%","d":"down"},{"l":"Generate Ativos","v":"3.867","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"76","t":"+5.1%","d":"up"}];
const COLS = ["ID","Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Code #001","Genai Code #002","1.599","8.794","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Code #002","Genai Code #003","2.769","560","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Code #003","Genai Code #004","5.859","869","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Code #004","Genai Code #005","4.176","3.871","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Code #005","Genai Code #001","9.092","7.996","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":780},{"label":"Mar","value":635},{"label":"Abr","value":850},{"label":"Mai","value":641},{"label":"Jun","value":585},{"label":"Jul","value":524},{"label":"Ago","value":819},{"label":"Set","value":602},{"label":"Out","value":539},{"label":"Nov","value":826},{"label":"Dez","value":864}];
const MX = 864;
