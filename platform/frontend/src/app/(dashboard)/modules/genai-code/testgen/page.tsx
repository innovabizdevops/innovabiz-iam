...
const PAGE = "Test Gen";
const KPIS = [{"l":"Total Genai Code","v":"341","t":"+10.5%","d":"up"},{"l":"Test Gen Ativos","v":"3.207","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"87.0%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"69","t":"+3.8%","d":"up"}];
const COLS = ["ID","Test Gen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Code #001","Genai Code #002","219","3.932","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Code #002","Genai Code #003","629","6.504","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Code #003","Genai Code #004","3.176","3.840","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Code #004","Genai Code #005","8.095","5.403","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Code #005","Genai Code #001","843","479","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":555},{"label":"Mar","value":526},{"label":"Abr","value":418},{"label":"Mai","value":737},{"label":"Jun","value":540},{"label":"Jul","value":450},{"label":"Ago","value":403},{"label":"Set","value":766},{"label":"Out","value":391},{"label":"Nov","value":707},{"label":"Dez","value":594}];
const MX = 766;
