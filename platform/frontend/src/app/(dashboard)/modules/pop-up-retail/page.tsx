...
/* ═══ Pop-Up Retail Space — Dashboard ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total Registos", value: "2108", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2071", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€180K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "243047008", cells: ["POP-3008", "Pop-Up Retail Space Item 1", "9/5/2026", "€47 108"], status: "active" as const },
    { id: "243050579", cells: ["POP-6579", "Pop-Up Retail Space Item 2", "24/12/2026", "€679"], status: "pending" as const },
    { id: "243054150", cells: ["POP-1150", "Pop-Up Retail Space Item 3", "11/7/2026", "€4250"], status: "completed" as const },
    { id: "243057721", cells: ["POP-4721", "Pop-Up Retail Space Item 4", "26/2/2026", "€7821"], status: "warning" as const },
    { id: "243061292", cells: ["POP-8292", "Pop-Up Retail Space Item 5", "13/9/2026", "€11 392"], status: "active" as const },
];
...
export default function PopupRetailSpacePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pop-Up Retail Space</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pop-Up Retail Space</p>
                    </div>
                </div>
