...
const ACCENT = "#3730a3";
const MODULE = "Pop-Up Retail Space";
const PAGE = "Analytics";
const KPIS = [{"l":"Pedidos/Dia","v":"1999","t":"-2.2%","d":"down"},{"l":"GMV (€)","v":"€54893","t":"+17.9%","d":"up"},{"l":"Conversão (%)","v":"74.9%","t":"-3.6%","d":"down"},{"l":"AOV (€)","v":"€42193","t":"+8.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 39456.78","1.176","6.848","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 14945.82","2.423","3.204","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 25974.96","453","5.708","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40687.29","1.785","7.725","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 22667.82","2.839","5.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":575},{"label":"Mar","value":396},{"label":"Abr","value":510},{"label":"Mai","value":703},{"label":"Jun","value":515},{"label":"Jul","value":684},{"label":"Ago","value":323},{"label":"Set","value":396},{"label":"Out","value":714},{"label":"Nov","value":614},{"label":"Dez","value":570}];
const MX = 714;
