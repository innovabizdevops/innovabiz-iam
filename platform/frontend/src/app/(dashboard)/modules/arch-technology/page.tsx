...
/* ═══ Technology Architecture (TOGAF) — Dashboard ═══ */

const ACCENT = "#083344";

const KPIS = [
    { label: "Total Registos", value: "6398", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4627", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€243K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "100164598", cells: ["ARC-4598", "Technology Architecture (TOGAF) Item 1", "3/11/2026", "€14 698"], status: "active" as const },
    { id: "100168169", cells: ["ARC-8169", "Technology Architecture (TOGAF) Item 2", "18/6/2026", "€18 269"], status: "pending" as const },
    { id: "100171740", cells: ["ARC-2740", "Technology Architecture (TOGAF) Item 3", "5/1/2026", "€21 840"], status: "completed" as const },
    { id: "100175311", cells: ["ARC-6311", "Technology Architecture (TOGAF) Item 4", "20/8/2026", "€25 411"], status: "warning" as const },
    { id: "100178882", cells: ["ARC-9882", "Technology Architecture (TOGAF) Item 5", "7/3/2026", "€28 982"], status: "active" as const },
];
...
export default function TechnologyArchitectureTogafPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Technology Architecture (TOGAF)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Technology Architecture (TOGAF)</p>
                    </div>
                </div>
