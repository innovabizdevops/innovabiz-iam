...
const PAGE = "Platform";
const KPIS = [{"l":"Formulários Ativos","v":"1.397","t":"+17.3%","d":"up"},{"l":"Submissões/Dia","v":"547","t":"+8.2%","d":"up"},{"l":"Documentos Gerados","v":"8.359","t":"+4.8%","d":"up"},{"l":"Templates","v":"9.079","t":"+4.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.653","2026-02-12","2.335","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.332","2026-03-20","5.664","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.250","2026-01-27","6.444","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.970","2026-02-14","3.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.605","2026-03-09","3.750","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":343},{"label":"Mar","value":478},{"label":"Abr","value":462},{"label":"Mai","value":614},{"label":"Jun","value":634},{"label":"Jul","value":528},{"label":"Ago","value":358},{"label":"Set","value":311},{"label":"Out","value":497},{"label":"Nov","value":588},{"label":"Dez","value":655}];
const MX = 655;
