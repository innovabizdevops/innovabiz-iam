...
const PAGE = "SALI Standards";
const KPIS = [{"l":"Total Legal Operations","v":"7.254","t":"-3.9%","d":"down"},{"l":"SALI Standards Ativos","v":"8.005","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"82.3%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"68","t":"+7.5%","d":"up"}];
const COLS = ["ID","SALI Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Operations #001","Legal Operations #002","6.088","8.150","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Operations #002","Legal Operations #003","875","2.087","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Operations #003","Legal Operations #004","8.724","1.760","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Operations #004","Legal Operations #005","3.046","5.989","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Operations #005","Legal Operations #001","1.188","2.116","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":282},{"label":"Fev","value":378},{"label":"Mar","value":454},{"label":"Abr","value":473},{"label":"Mai","value":397},{"label":"Jun","value":416},{"label":"Jul","value":577},{"label":"Ago","value":301},{"label":"Set","value":286},{"label":"Out","value":587},{"label":"Nov","value":306},{"label":"Dez","value":425}];
const MX = 587;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>SALI</span></h1>
                </div>
