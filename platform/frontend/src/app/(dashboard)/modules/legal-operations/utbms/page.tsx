...
const ACCENT = "#6366f1";
const MODULE = "Legal Operations";
const PAGE = "UTBMS Codes";
const KPIS = [{"l":"Total Legal Operations","v":"1.078","t":"-1.5%","d":"down"},{"l":"UTBMS Codes Ativos","v":"8.236","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"58","t":"-2.3%","d":"down"}];
const COLS = ["ID","UTBMS Codes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Operations #001","Legal Operations #002","3.594","7.036","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Operations #002","Legal Operations #003","4.472","5.061","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Operations #003","Legal Operations #004","7.504","4.736","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Operations #004","Legal Operations #005","8.202","909","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Operations #005","Legal Operations #001","293","135","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":601},{"label":"Mar","value":871},{"label":"Abr","value":924},{"label":"Mai","value":924},{"label":"Jun","value":613},{"label":"Jul","value":661},{"label":"Ago","value":753},{"label":"Set","value":965},{"label":"Out","value":945},{"label":"Nov","value":628},{"label":"Dez","value":885}];
const MX = 965;
...
export default function UtbmsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>UTBMS</span></h1>
                </div>
