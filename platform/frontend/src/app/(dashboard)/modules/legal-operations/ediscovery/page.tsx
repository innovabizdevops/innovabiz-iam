...
const PAGE = "eDiscovery AI";
const KPIS = [{"l":"Integrações Ativas","v":"3.629","t":"+2.6%","d":"up"},{"l":"Chamadas/Hora","v":"1216","t":"+7.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.6%","t":"+16.2%","d":"up"},{"l":"Latência Média (ms)","v":"12ms","t":"-2.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.572","8.656","86.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.265","5.385","83.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.937","105","98.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","728","941","76.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.861","6.922","87.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":861},{"label":"Mar","value":734},{"label":"Abr","value":760},{"label":"Mai","value":729},{"label":"Jun","value":622},{"label":"Jul","value":636},{"label":"Ago","value":663},{"label":"Set","value":652},{"label":"Out","value":630},{"label":"Nov","value":736},{"label":"Dez","value":791}];
const MX = 861;
