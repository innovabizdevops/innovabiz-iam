...
const KPIS = [{"l":"Projetos Melhoria","v":"187","t":"+4.8%","d":"up"},{"l":"Savings (€)","v":"€77156","t":"+1.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.8%","t":"+9.9%","d":"up"},{"l":"Ciclos PDCA","v":"2.529","t":"+1.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.753","€ 43208.32","8.519","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.217","€ 25825.43","2.890","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.316","€ 47119.12","1.351","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.085","€ 49566.07","3.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.087","€ 15443.60","1.692","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":380},{"label":"Mar","value":550},{"label":"Abr","value":291},{"label":"Mai","value":302},{"label":"Jun","value":282},{"label":"Jul","value":540},{"label":"Ago","value":424},{"label":"Set","value":465},{"label":"Out","value":286},{"label":"Nov","value":262},{"label":"Dez","value":511}];
const MX = 550;
