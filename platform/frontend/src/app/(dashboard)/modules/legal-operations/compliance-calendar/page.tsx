...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.024","t":"-0.8%","d":"down"},{"l":"NC Abertas","v":"2.161","t":"+5.7%","d":"up"},{"l":"Conformidade (%)","v":"88.7%","t":"+15.5%","d":"up"},{"l":"CAPAs Pendentes","v":"3.351","t":"+4.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.715","89.5%","8.060","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.890","89.6%","1.217","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.598","81.7%","2.074","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.348","74.3%","1.220","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.518","76.4%","419","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":979},{"label":"Mar","value":985},{"label":"Abr","value":809},{"label":"Mai","value":789},{"label":"Jun","value":656},{"label":"Jul","value":872},{"label":"Ago","value":637},{"label":"Set","value":765},{"label":"Out","value":908},{"label":"Nov","value":846},{"label":"Dez","value":828}];
const MX = 985;
