...
/* ═══ Laundry Equipment Mfg — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "5087", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3758", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€469K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "217804987", cells: ["LAU-5987", "Laundry Equipment Mfg Item 1", "16/8/2026", "€5087"], status: "active" as const },
    { id: "217808558", cells: ["LAU-9558", "Laundry Equipment Mfg Item 2", "3/3/2026", "€8658"], status: "pending" as const },
    { id: "217812129", cells: ["LAU-4129", "Laundry Equipment Mfg Item 3", "18/10/2026", "€12 229"], status: "completed" as const },
    { id: "217815700", cells: ["LAU-7700", "Laundry Equipment Mfg Item 4", "5/5/2026", "€15 800"], status: "warning" as const },
    { id: "217819271", cells: ["LAU-2271", "Laundry Equipment Mfg Item 5", "20/12/2026", "€19 371"], status: "active" as const },
];
...
export default function LaundryEquipmentMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laundry Equipment Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laundry Equipment Mfg</p>
                    </div>
                </div>
