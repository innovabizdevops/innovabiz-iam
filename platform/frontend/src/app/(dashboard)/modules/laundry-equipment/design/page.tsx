...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.874","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"4194","t":"+17.3%","d":"up"},{"l":"Documentos Gerados","v":"5.086","t":"+3.2%","d":"up"},{"l":"Templates","v":"309","t":"+2.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.490","2026-02-15","353","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.058","2026-02-22","8.025","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.090","2026-02-01","1.604","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.713","2026-03-08","2.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.404","2026-01-22","5.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":880},{"label":"Mar","value":664},{"label":"Abr","value":745},{"label":"Mai","value":730},{"label":"Jun","value":700},{"label":"Jul","value":976},{"label":"Ago","value":709},{"label":"Set","value":968},{"label":"Out","value":709},{"label":"Nov","value":846},{"label":"Dez","value":900}];
const MX = 976;
