...
const ACCENT = "#06b6d4";
const MODULE = "SportsTech Deep";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"8.834","t":"+3.7%","d":"up"},{"l":"Submissões/Dia","v":"2078","t":"-1.6%","d":"down"},{"l":"Documentos Gerados","v":"7.568","t":"+10.4%","d":"up"},{"l":"Templates","v":"3.580","t":"+15.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.130","2026-03-03","7.879","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.130","2026-03-20","5.231","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.233","2026-03-11","6.092","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","684","2026-03-11","1.580","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.096","2026-03-15","309","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":741},{"label":"Mar","value":636},{"label":"Abr","value":720},{"label":"Mai","value":639},{"label":"Jun","value":599},{"label":"Jul","value":548},{"label":"Ago","value":766},{"label":"Set","value":576},{"label":"Out","value":543},{"label":"Nov","value":658},{"label":"Dez","value":544}];
const MX = 792;
