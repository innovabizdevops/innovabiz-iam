...
const PAGE = "Fan";
const KPIS = [{"l":"Atletas Registados","v":"1.423","t":"-4.7%","d":"down"},{"l":"Treinos/Semana","v":"2450","t":"+4.6%","d":"up"},{"l":"Competições","v":"1.909","t":"+16.8%","d":"up"},{"l":"Performance Score","v":"75","t":"-5.0%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.088","7.938","6.759","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.695","2.253","1.680","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","830","8.547","6.807","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.861","8.259","2.324","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.745","6.976","1.075","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":477},{"label":"Mar","value":516},{"label":"Abr","value":540},{"label":"Mai","value":483},{"label":"Jun","value":310},{"label":"Jul","value":363},{"label":"Ago","value":243},{"label":"Set","value":233},{"label":"Out","value":219},{"label":"Nov","value":222},{"label":"Dez","value":248}];
const MX = 540;
