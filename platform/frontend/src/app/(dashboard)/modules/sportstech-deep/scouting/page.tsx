...
const PAGE = "Scouting";
const KPIS = [{"l":"Atletas Registados","v":"1.176","t":"-1.2%","d":"down"},{"l":"Treinos/Semana","v":"3590","t":"+16.4%","d":"up"},{"l":"Competições","v":"8.434","t":"-1.5%","d":"down"},{"l":"Performance Score","v":"74","t":"+1.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.039","2.080","1.024","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.748","4.962","4.863","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.603","210","3.593","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.664","6.204","183","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.072","1.949","2.824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":811},{"label":"Mar","value":666},{"label":"Abr","value":819},{"label":"Mai","value":1012},{"label":"Jun","value":704},{"label":"Jul","value":1037},{"label":"Ago","value":893},{"label":"Set","value":780},{"label":"Out","value":865},{"label":"Nov","value":922},{"label":"Dez","value":774}];
const MX = 1037;
