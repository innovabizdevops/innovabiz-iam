...
const PAGE = "Venue";
const KPIS = [{"l":"Atletas Registados","v":"2.347","t":"+17.8%","d":"up"},{"l":"Treinos/Semana","v":"722","t":"+10.5%","d":"up"},{"l":"Competições","v":"4.819","t":"-5.6%","d":"down"},{"l":"Performance Score","v":"63","t":"+2.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.135","8.494","7.487","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.281","5.005","1.081","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.184","4.823","1.980","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","498","6.232","8.902","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.490","5.388","7.395","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":806},{"label":"Mar","value":708},{"label":"Abr","value":892},{"label":"Mai","value":897},{"label":"Jun","value":1073},{"label":"Jul","value":908},{"label":"Ago","value":975},{"label":"Set","value":788},{"label":"Out","value":796},{"label":"Nov","value":824},{"label":"Dez","value":768}];
const MX = 1073;
