...
const KPIS = [{"l":"Atletas Registados","v":"7.050","t":"+5.3%","d":"up"},{"l":"Treinos/Semana","v":"4413","t":"+10.8%","d":"up"},{"l":"Competições","v":"8.217","t":"+4.4%","d":"up"},{"l":"Performance Score","v":"74","t":"+2.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","9.040","7.837","2.006","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.511","6.017","6.073","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.573","2.214","8.220","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","438","2.864","1.612","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.604","8.925","5.331","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":323},{"label":"Fev","value":341},{"label":"Mar","value":350},{"label":"Abr","value":321},{"label":"Mai","value":284},{"label":"Jun","value":600},{"label":"Jul","value":587},{"label":"Ago","value":640},{"label":"Set","value":584},{"label":"Out","value":628},{"label":"Nov","value":564},{"label":"Dez","value":402}];
const MX = 640;
