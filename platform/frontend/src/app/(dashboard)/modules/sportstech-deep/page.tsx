...
/* ═══ SportsTech Deep — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "2273", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1297", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€166K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2095574773", cells: ["SPO-6773", "SportsTech Deep Item 1", "6/2/2026", "€24 873"], status: "active" as const },
    { id: "2095578344", cells: ["SPO-1344", "SportsTech Deep Item 2", "21/9/2026", "€28 444"], status: "pending" as const },
    { id: "2095581915", cells: ["SPO-4915", "SportsTech Deep Item 3", "8/4/2026", "€32 015"], status: "completed" as const },
    { id: "2095585486", cells: ["SPO-8486", "SportsTech Deep Item 4", "23/11/2026", "€35 586"], status: "warning" as const },
    { id: "2095589057", cells: ["SPO-3057", "SportsTech Deep Item 5", "10/6/2026", "€39 157"], status: "active" as const },
];
...
export default function SportstechDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SportsTech Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SportsTech Deep</p>
                    </div>
                </div>
