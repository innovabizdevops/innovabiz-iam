...
const PAGE = "Fitness Elite";
const KPIS = [{"l":"Atletas Registados","v":"5.419","t":"+17.2%","d":"up"},{"l":"Treinos/Semana","v":"1685","t":"+0.0%","d":"up"},{"l":"Competições","v":"3.622","t":"-2.9%","d":"down"},{"l":"Performance Score","v":"71","t":"+15.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.142","2.835","3.488","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.220","210","6.512","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.348","9.059","1.421","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.325","4.819","2.410","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.108","5.554","6.912","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":653},{"label":"Mar","value":759},{"label":"Abr","value":530},{"label":"Mai","value":762},{"label":"Jun","value":765},{"label":"Jul","value":761},{"label":"Ago","value":622},{"label":"Set","value":709},{"label":"Out","value":817},{"label":"Nov","value":731},{"label":"Dez","value":803}];
const MX = 817;
