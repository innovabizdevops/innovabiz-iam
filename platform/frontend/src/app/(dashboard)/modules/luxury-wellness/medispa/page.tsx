...
const PAGE = "Medi-Spa";
const KPIS = [{"l":"Integrações Ativas","v":"3.764","t":"+1.7%","d":"up"},{"l":"Chamadas/Hora","v":"1672","t":"+4.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.6%","t":"+10.3%","d":"up"},{"l":"Latência Média (ms)","v":"46ms","t":"+9.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.116","2.759","71.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.653","3.472","92.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.808","276","89.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.440","2.488","77.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.298","5.247","77.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":987},{"label":"Fev","value":804},{"label":"Mar","value":676},{"label":"Abr","value":924},{"label":"Mai","value":772},{"label":"Jun","value":752},{"label":"Jul","value":895},{"label":"Ago","value":909},{"label":"Set","value":658},{"label":"Out","value":856},{"label":"Nov","value":789},{"label":"Dez","value":864}];
const MX = 987;
