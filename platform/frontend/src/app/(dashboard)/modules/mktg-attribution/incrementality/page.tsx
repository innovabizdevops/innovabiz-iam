...
const KPIS = [{"l":"Total Mktg Attribution","v":"6.847","t":"-0.7%","d":"down"},{"l":"Incrementality Ativos","v":"1.457","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"91.4%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"84","t":"+14.5%","d":"up"}];
const COLS = ["ID","Incrementality","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mktg Attribution #001","Mktg Attribution #002","6.183","4.289","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Mktg Attribution #002","Mktg Attribution #003","5.990","7.207","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Mktg Attribution #003","Mktg Attribution #004","7.547","6.363","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mktg Attribution #004","Mktg Attribution #005","4.157","4.727","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mktg Attribution #005","Mktg Attribution #001","3.484","7.084","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":507},{"label":"Mar","value":779},{"label":"Abr","value":496},{"label":"Mai","value":592},{"label":"Jun","value":450},{"label":"Jul","value":537},{"label":"Ago","value":666},{"label":"Set","value":622},{"label":"Out","value":722},{"label":"Nov","value":736},{"label":"Dez","value":775}];
const MX = 779;
