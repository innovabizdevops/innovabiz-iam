...
const ACCENT = "#0e7490";
const MODULE = "Marketing Attribution";
const PAGE = "Data-Driven";
const KPIS = [{"l":"Dashboards Ativos","v":"2.593","t":"-3.1%","d":"down"},{"l":"Queries/Dia","v":"2251","t":"+15.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.585","t":"+10.1%","d":"up"},{"l":"Utilizadores Analytics","v":"4.515","t":"+6.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4701","2026-03-16","4.194","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3309","2026-03-04","837","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4924","2026-02-24","1.519","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1976","2026-01-09","6.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2421","2026-01-24","3.853","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":995},{"label":"Fev","value":938},{"label":"Mar","value":895},{"label":"Abr","value":772},{"label":"Mai","value":1031},{"label":"Jun","value":896},{"label":"Jul","value":823},{"label":"Ago","value":693},{"label":"Set","value":907},{"label":"Out","value":1037},{"label":"Nov","value":986},{"label":"Dez","value":963}];
const MX = 1037;
