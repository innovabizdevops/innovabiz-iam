...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"6.868","t":"-3.4%","d":"down"},{"l":"Submissões/Dia","v":"3666","t":"+17.1%","d":"up"},{"l":"Documentos Gerados","v":"8.381","t":"+5.3%","d":"up"},{"l":"Templates","v":"396","t":"+6.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","415","2026-02-13","1.306","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.020","2026-02-18","7.843","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.040","2026-01-07","3.802","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.666","2026-01-19","2.825","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.401","2026-01-15","4.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":513},{"label":"Mar","value":454},{"label":"Abr","value":410},{"label":"Mai","value":745},{"label":"Jun","value":580},{"label":"Jul","value":452},{"label":"Ago","value":671},{"label":"Set","value":789},{"label":"Out","value":636},{"label":"Nov","value":448},{"label":"Dez","value":578}];
const MX = 799;
