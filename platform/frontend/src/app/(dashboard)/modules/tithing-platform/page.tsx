...
/* ═══ Tithing & Giving Platform — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "6478", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1350", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€161K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "276473778", cells: ["TIT-3778", "Tithing & Giving Platform Item 1", "15/7/2026", "€23 878"], status: "active" as const },
    { id: "276477349", cells: ["TIT-7349", "Tithing & Giving Platform Item 2", "2/2/2026", "€27 449"], status: "pending" as const },
    { id: "276480920", cells: ["TIT-1920", "Tithing & Giving Platform Item 3", "17/9/2026", "€31 020"], status: "completed" as const },
    { id: "276484491", cells: ["TIT-5491", "Tithing & Giving Platform Item 4", "4/4/2026", "€34 591"], status: "warning" as const },
    { id: "276488062", cells: ["TIT-9062", "Tithing & Giving Platform Item 5", "19/11/2026", "€38 162"], status: "active" as const },
];
...
export default function TithingGivingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tithing & Giving Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tithing & Giving Platform</p>
                    </div>
                </div>
