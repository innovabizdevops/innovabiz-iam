...
const KPIS = [{"l":"Formulários Ativos","v":"5.463","t":"+14.4%","d":"up"},{"l":"Submissões/Dia","v":"887","t":"+8.6%","d":"up"},{"l":"Documentos Gerados","v":"2.525","t":"-1.9%","d":"down"},{"l":"Templates","v":"5.498","t":"+7.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.519","2026-02-06","804","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.473","2026-02-26","4.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.441","2026-02-01","1.217","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.200","2026-03-26","5.039","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.025","2026-02-08","1.595","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":325},{"label":"Mar","value":449},{"label":"Abr","value":427},{"label":"Mai","value":282},{"label":"Jun","value":494},{"label":"Jul","value":318},{"label":"Ago","value":234},{"label":"Set","value":328},{"label":"Out","value":262},{"label":"Nov","value":233},{"label":"Dez","value":486}];
const MX = 494;
