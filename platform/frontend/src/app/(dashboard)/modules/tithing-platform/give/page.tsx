...
const PAGE = "Give";
const KPIS = [{"l":"Formulários Ativos","v":"808","t":"+11.4%","d":"up"},{"l":"Submissões/Dia","v":"2890","t":"-3.1%","d":"down"},{"l":"Documentos Gerados","v":"2.666","t":"+14.9%","d":"up"},{"l":"Templates","v":"6.211","t":"+9.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.067","2026-01-26","6.837","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.425","2026-03-04","8.353","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.917","2026-01-27","5.648","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.314","2026-02-19","1.165","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.167","2026-03-15","4.384","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":486},{"label":"Mar","value":417},{"label":"Abr","value":383},{"label":"Mai","value":715},{"label":"Jun","value":647},{"label":"Jul","value":608},{"label":"Ago","value":527},{"label":"Set","value":592},{"label":"Out","value":381},{"label":"Nov","value":385},{"label":"Dez","value":535}];
const MX = 715;
