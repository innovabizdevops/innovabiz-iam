...
const ACCENT = "#7c3aed";
const MODULE = "Tithing & Giving Platform";
const PAGE = "Tax";
const KPIS = [{"l":"Formulários Ativos","v":"3.353","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"4705","t":"+1.8%","d":"up"},{"l":"Documentos Gerados","v":"1.885","t":"+13.5%","d":"up"},{"l":"Templates","v":"5.359","t":"-1.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.950","2026-02-24","2.984","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.965","2026-01-22","3.785","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.634","2026-03-02","7.154","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.191","2026-02-05","7.735","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.446","2026-02-10","7.740","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":668},{"label":"Mar","value":637},{"label":"Abr","value":617},{"label":"Mai","value":997},{"label":"Jun","value":756},{"label":"Jul","value":793},{"label":"Ago","value":838},{"label":"Set","value":643},{"label":"Out","value":960},{"label":"Nov","value":925},{"label":"Dez","value":718}];
const MX = 997;
