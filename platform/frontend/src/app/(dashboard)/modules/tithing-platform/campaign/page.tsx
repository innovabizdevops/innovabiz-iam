...
const PAGE = "Campaign";
const KPIS = [{"l":"Formulários Ativos","v":"3.894","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"1808","t":"-3.2%","d":"down"},{"l":"Documentos Gerados","v":"6.284","t":"+9.5%","d":"up"},{"l":"Templates","v":"4.864","t":"+10.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.118","2026-02-05","1.844","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.017","2026-02-17","597","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.270","2026-01-22","7.778","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.924","2026-03-24","7.778","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.522","2026-02-11","5.256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":624},{"label":"Mar","value":762},{"label":"Abr","value":447},{"label":"Mai","value":510},{"label":"Jun","value":583},{"label":"Jul","value":496},{"label":"Ago","value":495},{"label":"Set","value":467},{"label":"Out","value":646},{"label":"Nov","value":454},{"label":"Dez","value":463}];
const MX = 762;
