...
const PAGE = "Assess";
const KPIS = [{"l":"Riscos Identificados","v":"5.639","t":"+13.4%","d":"up"},{"l":"Mitigações Ativas","v":"3.322","t":"-2.6%","d":"down"},{"l":"Score Risco Geral","v":"77","t":"+9.2%","d":"up"},{"l":"Incidentes YTD","v":"1.039","t":"+3.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.674","2.820","3.530","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.807","8.592","8.060","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.576","4.235","6.767","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.798","2.932","2.666","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.237","7.491","6.608","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":500},{"label":"Mar","value":357},{"label":"Abr","value":534},{"label":"Mai","value":622},{"label":"Jun","value":645},{"label":"Jul","value":463},{"label":"Ago","value":289},{"label":"Set","value":528},{"label":"Out","value":518},{"label":"Nov","value":308},{"label":"Dez","value":436}];
const MX = 645;
