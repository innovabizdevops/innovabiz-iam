...
const PAGE = "Report";
const KPIS = [{"l":"Riscos Identificados","v":"6.965","t":"+16.7%","d":"up"},{"l":"Mitigações Ativas","v":"3.957","t":"-3.1%","d":"down"},{"l":"Score Risco Geral","v":"95","t":"+11.9%","d":"up"},{"l":"Incidentes YTD","v":"3.288","t":"-3.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.821","2.579","5.431","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.806","3.674","3.376","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","814","7.350","7.270","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.025","1.140","7.056","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.543","7.347","5.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":1085},{"label":"Mar","value":878},{"label":"Abr","value":904},{"label":"Mai","value":957},{"label":"Jun","value":770},{"label":"Jul","value":754},{"label":"Ago","value":1057},{"label":"Set","value":822},{"label":"Out","value":1080},{"label":"Nov","value":700},{"label":"Dez","value":783}];
const MX = 1085;
