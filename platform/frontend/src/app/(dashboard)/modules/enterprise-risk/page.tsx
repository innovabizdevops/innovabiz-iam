...
/* ═══ Enterprise Risk Mgmt (COSO) — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "1978", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3227", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€80K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1831957278", cells: ["ENT-8278", "Enterprise Risk Mgmt (COSO) Item 1", "19/7/2026", "€7378"], status: "active" as const },
    { id: "1831960849", cells: ["ENT-2849", "Enterprise Risk Mgmt (COSO) Item 2", "6/2/2026", "€10 949"], status: "pending" as const },
    { id: "1831964420", cells: ["ENT-6420", "Enterprise Risk Mgmt (COSO) Item 3", "21/9/2026", "€14 520"], status: "completed" as const },
    { id: "1831967991", cells: ["ENT-9991", "Enterprise Risk Mgmt (COSO) Item 4", "8/4/2026", "€18 091"], status: "warning" as const },
    { id: "1831971562", cells: ["ENT-4562", "Enterprise Risk Mgmt (COSO) Item 5", "23/11/2026", "€21 662"], status: "active" as const },
];
...
export default function EnterpriseRiskMgmtCosoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Enterprise Risk Mgmt (COSO)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Enterprise Risk Mgmt (COSO)</p>
                    </div>
                </div>
