...
const PAGE = "Appetite";
const KPIS = [{"l":"Riscos Identificados","v":"4.192","t":"+1.8%","d":"up"},{"l":"Mitigações Ativas","v":"6.427","t":"+13.8%","d":"up"},{"l":"Score Risco Geral","v":"64","t":"+4.8%","d":"up"},{"l":"Incidentes YTD","v":"4.892","t":"+0.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.053","4.792","7.504","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.279","819","6.617","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.673","212","4.977","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.504","2.466","2.099","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.713","8.764","8.695","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":607},{"label":"Mar","value":752},{"label":"Abr","value":713},{"label":"Mai","value":712},{"label":"Jun","value":793},{"label":"Jul","value":672},{"label":"Ago","value":751},{"label":"Set","value":669},{"label":"Out","value":815},{"label":"Nov","value":777},{"label":"Dez","value":647}];
const MX = 815;
