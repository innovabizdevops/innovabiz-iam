...
const PAGE = "Register";
const KPIS = [{"l":"Riscos Identificados","v":"5.367","t":"+15.8%","d":"up"},{"l":"Mitigações Ativas","v":"8.066","t":"+1.8%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+12.7%","d":"up"},{"l":"Incidentes YTD","v":"4.571","t":"+15.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.033","3.116","7.012","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.120","183","4.150","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.144","539","8.086","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.005","2.020","3.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.248","4.785","8.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":655},{"label":"Mar","value":670},{"label":"Abr","value":805},{"label":"Mai","value":762},{"label":"Jun","value":772},{"label":"Jul","value":550},{"label":"Ago","value":828},{"label":"Set","value":529},{"label":"Out","value":727},{"label":"Nov","value":845},{"label":"Dez","value":529}];
const MX = 845;
