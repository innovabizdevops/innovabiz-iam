...
const ACCENT = "#059669";
const MODULE = "Enterprise Risk Mgmt (COSO)";
const PAGE = "Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"9.056","t":"+11.9%","d":"up"},{"l":"Mitigações Ativas","v":"5.726","t":"+11.7%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"+2.2%","d":"up"},{"l":"Incidentes YTD","v":"3.705","t":"+4.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","670","260","7.831","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.320","7.381","2.160","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.379","2.771","2.202","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","902","6.545","6.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.076","5.561","8.015","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":781},{"label":"Mar","value":495},{"label":"Abr","value":807},{"label":"Mai","value":809},{"label":"Jun","value":609},{"label":"Jul","value":828},{"label":"Ago","value":549},{"label":"Set","value":582},{"label":"Out","value":485},{"label":"Nov","value":761},{"label":"Dez","value":849}];
const MX = 849;
