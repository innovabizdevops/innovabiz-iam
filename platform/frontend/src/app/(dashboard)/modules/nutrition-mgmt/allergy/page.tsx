...
const ACCENT = "#65a30d";
const MODULE = "Nutrition & Dietetics";
const PAGE = "Allergy";
const KPIS = [{"l":"Total Nutrition Mgmt","v":"6.798","t":"+16.6%","d":"up"},{"l":"Allergy Ativos","v":"3.536","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"73","t":"+16.4%","d":"up"}];
const COLS = ["ID","Allergy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nutrition Mgmt #001","Nutrition Mgmt #002","4.933","4.958","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Nutrition Mgmt #002","Nutrition Mgmt #003","1.769","4.400","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Nutrition Mgmt #003","Nutrition Mgmt #004","2.575","8.592","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Nutrition Mgmt #004","Nutrition Mgmt #005","2.657","1.149","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nutrition Mgmt #005","Nutrition Mgmt #001","6.831","8.001","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":567},{"label":"Mar","value":617},{"label":"Abr","value":927},{"label":"Mai","value":565},{"label":"Jun","value":694},{"label":"Jul","value":817},{"label":"Ago","value":705},{"label":"Set","value":835},{"label":"Out","value":677},{"label":"Nov","value":732},{"label":"Dez","value":928}];
const MX = 928;
