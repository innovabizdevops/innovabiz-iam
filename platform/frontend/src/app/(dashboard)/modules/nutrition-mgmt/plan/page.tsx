...
const PAGE = "Plan";
const KPIS = [{"l":"Total Nutrition Mgmt","v":"4.526","t":"+6.7%","d":"up"},{"l":"Plan Ativos","v":"1.833","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"79","t":"+3.0%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nutrition Mgmt #001","Nutrition Mgmt #002","6.493","8.205","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Nutrition Mgmt #002","Nutrition Mgmt #003","7.116","8.964","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Nutrition Mgmt #003","Nutrition Mgmt #004","4.457","8.239","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Nutrition Mgmt #004","Nutrition Mgmt #005","6.662","2.201","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nutrition Mgmt #005","Nutrition Mgmt #001","6.063","9.084","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":632},{"label":"Mar","value":427},{"label":"Abr","value":646},{"label":"Mai","value":357},{"label":"Jun","value":688},{"label":"Jul","value":545},{"label":"Ago","value":514},{"label":"Set","value":670},{"label":"Out","value":517},{"label":"Nov","value":385},{"label":"Dez","value":371}];
const MX = 688;
