...
const PAGE = "Assess";
const KPIS = [{"l":"Total Nutrition Mgmt","v":"4.063","t":"+3.9%","d":"up"},{"l":"Assess Ativos","v":"8.971","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"88.1%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.3%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nutrition Mgmt #001","Nutrition Mgmt #002","2.431","3.056","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Nutrition Mgmt #002","Nutrition Mgmt #003","4.264","3.908","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Nutrition Mgmt #003","Nutrition Mgmt #004","5.849","6.825","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Nutrition Mgmt #004","Nutrition Mgmt #005","7.810","7.828","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nutrition Mgmt #005","Nutrition Mgmt #001","7.628","913","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":768},{"label":"Mar","value":942},{"label":"Abr","value":708},{"label":"Mai","value":961},{"label":"Jun","value":863},{"label":"Jul","value":882},{"label":"Ago","value":688},{"label":"Set","value":918},{"label":"Out","value":741},{"label":"Nov","value":890},{"label":"Dez","value":804}];
const MX = 961;
