...
/* ═══ Nutrition & Dietetics — Dashboard ═══ */

const ACCENT = "#65a30d";

const KPIS = [
    { label: "Total Registos", value: "6701", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "185", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€16K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1353603901", cells: ["NUT-4901", "Nutrition & Dietetics Item 1", "14/2/2026", "€4001"], status: "active" as const },
    { id: "1353607472", cells: ["NUT-8472", "Nutrition & Dietetics Item 2", "1/9/2026", "€7572"], status: "pending" as const },
    { id: "1353611043", cells: ["NUT-3043", "Nutrition & Dietetics Item 3", "16/4/2026", "€11 143"], status: "completed" as const },
    { id: "1353614614", cells: ["NUT-6614", "Nutrition & Dietetics Item 4", "3/11/2026", "€14 714"], status: "warning" as const },
    { id: "1353618185", cells: ["NUT-1185", "Nutrition & Dietetics Item 5", "18/6/2026", "€18 285"], status: "active" as const },
];
...
export default function NutritionDieteticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nutrition & Dietetics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Nutrition & Dietetics</p>
                    </div>
                </div>
