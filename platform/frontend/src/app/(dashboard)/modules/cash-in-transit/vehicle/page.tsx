...
const PAGE = "Vehicle";
const KPIS = [{"l":"Total Cash In Transit","v":"2.316","t":"+15.7%","d":"up"},{"l":"Vehicle Ativos","v":"2.922","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+12.2%","d":"up"}];
const COLS = ["ID","Vehicle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cash In Transit #001","Cash In Transit #002","5.805","2.490","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cash In Transit #002","Cash In Transit #003","8.104","7.256","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Cash In Transit #003","Cash In Transit #004","6.931","5.319","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cash In Transit #004","Cash In Transit #005","5.995","962","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cash In Transit #005","Cash In Transit #001","5.330","4.182","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":305},{"label":"Mar","value":387},{"label":"Abr","value":376},{"label":"Mai","value":294},{"label":"Jun","value":354},{"label":"Jul","value":366},{"label":"Ago","value":448},{"label":"Set","value":375},{"label":"Out","value":310},{"label":"Nov","value":352},{"label":"Dez","value":357}];
const MX = 604;
