...
const PAGE = "Crew";
const KPIS = [{"l":"Total Cash In Transit","v":"4.035","t":"+12.1%","d":"up"},{"l":"Crew Ativos","v":"4.694","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"90.2%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+6.8%","d":"up"}];
const COLS = ["ID","Crew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cash In Transit #001","Cash In Transit #002","6.489","1.574","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cash In Transit #002","Cash In Transit #003","3.859","5.424","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cash In Transit #003","Cash In Transit #004","8.054","2.289","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Cash In Transit #004","Cash In Transit #005","1.189","7.196","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cash In Transit #005","Cash In Transit #001","1.796","5.178","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":746},{"label":"Mar","value":857},{"label":"Abr","value":1028},{"label":"Mai","value":691},{"label":"Jun","value":822},{"label":"Jul","value":717},{"label":"Ago","value":887},{"label":"Set","value":1006},{"label":"Out","value":890},{"label":"Nov","value":858},{"label":"Dez","value":999}];
const MX = 1028;
