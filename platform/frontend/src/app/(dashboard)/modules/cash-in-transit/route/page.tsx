...
const ACCENT = "#6366f1";
const MODULE = "Cash in Transit";
const PAGE = "Route";
const KPIS = [{"l":"Total Cash In Transit","v":"8.495","t":"-3.3%","d":"down"},{"l":"Route Ativos","v":"3.473","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"80.9%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"58","t":"+12.2%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cash In Transit #001","Cash In Transit #002","3.595","869","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cash In Transit #002","Cash In Transit #003","1.168","8.091","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Cash In Transit #003","Cash In Transit #004","8.380","6.171","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Cash In Transit #004","Cash In Transit #005","3.390","8.438","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cash In Transit #005","Cash In Transit #001","7.313","3.608","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":498},{"label":"Mar","value":738},{"label":"Abr","value":686},{"label":"Mai","value":575},{"label":"Jun","value":394},{"label":"Jul","value":757},{"label":"Ago","value":720},{"label":"Set","value":409},{"label":"Out","value":460},{"label":"Nov","value":392},{"label":"Dez","value":614}];
const MX = 757;
