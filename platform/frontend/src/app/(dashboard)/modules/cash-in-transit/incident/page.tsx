...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"6.316","t":"+5.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.2%","t":"+7.3%","d":"up"},{"l":"MTTR (h)","v":"50h","t":"-2.1%","d":"down"},{"l":"Satisfação (%)","v":"76.3%","t":"-3.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.714","5.515","5.074","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","955","3.732","2.465","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.023","1.923","7.599","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.958","1.744","3.123","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.971","5.457","1.435","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":691},{"label":"Mar","value":768},{"label":"Abr","value":681},{"label":"Mai","value":949},{"label":"Jun","value":606},{"label":"Jul","value":973},{"label":"Ago","value":626},{"label":"Set","value":698},{"label":"Out","value":699},{"label":"Nov","value":975},{"label":"Dez","value":655}];
const MX = 978;
