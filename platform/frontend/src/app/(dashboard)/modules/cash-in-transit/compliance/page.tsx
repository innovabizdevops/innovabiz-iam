...
const KPIS = [{"l":"Auditorias Realizadas","v":"834","t":"+1.1%","d":"up"},{"l":"NC Abertas","v":"5.265","t":"+13.6%","d":"up"},{"l":"Conformidade (%)","v":"69.3%","t":"-4.5%","d":"down"},{"l":"CAPAs Pendentes","v":"6.713","t":"+13.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.337","83.0%","7.936","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.030","74.6%","6.983","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.819","88.0%","8.957","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.435","97.1%","433","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.973","92.2%","4.564","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":611},{"label":"Mar","value":863},{"label":"Abr","value":852},{"label":"Mai","value":835},{"label":"Jun","value":827},{"label":"Jul","value":498},{"label":"Ago","value":779},{"label":"Set","value":654},{"label":"Out","value":809},{"label":"Nov","value":558},{"label":"Dez","value":542}];
const MX = 863;
