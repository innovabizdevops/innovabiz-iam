...
const PAGE = "Charging Network";
const KPIS = [{"l":"Total Automotive","v":"1.252","t":"+14.3%","d":"up"},{"l":"Charging Network Ativos","v":"1.299","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.1%","d":"down"}];
const COLS = ["ID","Charging Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Automotive #001","Automotive #002","8.892","5.684","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Automotive #002","Automotive #003","2.240","6.374","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Automotive #003","Automotive #004","7.953","5.604","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Automotive #004","Automotive #005","1.358","7.443","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Automotive #005","Automotive #001","4.640","8.725","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":669},{"label":"Mar","value":621},{"label":"Abr","value":535},{"label":"Mai","value":503},{"label":"Jun","value":753},{"label":"Jul","value":488},{"label":"Ago","value":731},{"label":"Set","value":638},{"label":"Out","value":523},{"label":"Nov","value":729},{"label":"Dez","value":725}];
const MX = 781;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>EV</span></h1>
                </div>
