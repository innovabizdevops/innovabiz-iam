...
const KPIS = [{"l":"ARR (€M)","v":"€42.8M","t":"-3.7%","d":"down"},{"l":"MRR (€)","v":"€96031","t":"+0.9%","d":"up"},{"l":"Churn (%)","v":"74.4%","t":"+9.6%","d":"up"},{"l":"ARPU (€)","v":"€97478","t":"+0.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7632.64","1.198","€ 9367.69","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 5720.54","2.877","€ 4395.29","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 6894.24","4.624","€ 48949.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 23915.49","3.163","€ 42577.33","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37316.15","2.541","€ 9710.51","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":756},{"label":"Mar","value":673},{"label":"Abr","value":872},{"label":"Mai","value":615},{"label":"Jun","value":795},{"label":"Jul","value":564},{"label":"Ago","value":507},{"label":"Set","value":666},{"label":"Out","value":527},{"label":"Nov","value":666},{"label":"Dez","value":633}];
const MX = 872;
