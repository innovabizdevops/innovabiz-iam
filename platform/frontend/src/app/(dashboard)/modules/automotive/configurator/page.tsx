...
const ACCENT = "#1e40af";
const MODULE = "Automotive & Mobility";
const PAGE = "Vehicle Configurator";
const KPIS = [{"l":"Configurações","v":"6.083","t":"+15.1%","d":"up"},{"l":"Últimas Alterações","v":"2.049","t":"-0.7%","d":"down"},{"l":"Ambientes","v":"5.930","t":"-1.3%","d":"down"},{"l":"Versão Config","v":"3.892","t":"+2.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 32970.00","7.959","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 41101.25","8.388","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 12349.21","6.353","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 42379.63","8.267","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 32575.28","5.372","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":931},{"label":"Mar","value":902},{"label":"Abr","value":828},{"label":"Mai","value":853},{"label":"Jun","value":851},{"label":"Jul","value":716},{"label":"Ago","value":868},{"label":"Set","value":777},{"label":"Out","value":736},{"label":"Nov","value":965},{"label":"Dez","value":754}];
const MX = 965;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>3D</span></h1>
                </div>
