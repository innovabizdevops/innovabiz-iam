...
const PAGE = "EV Charging Network";
const KPIS = [{"l":"Total Automotive","v":"6.440","t":"-0.8%","d":"down"},{"l":"EV Charging Network Ativos","v":"7.576","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"89.3%","t":"+13.2%","d":"up"},{"l":"Score Performance","v":"62","t":"+13.2%","d":"up"}];
const COLS = ["ID","EV Charging Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Automotive #001","Automotive #002","7.618","7.653","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Automotive #002","Automotive #003","3.636","6.099","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Automotive #003","Automotive #004","5.085","1.275","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Automotive #004","Automotive #005","710","641","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Automotive #005","Automotive #001","8.547","3.652","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":654},{"label":"Mar","value":788},{"label":"Abr","value":541},{"label":"Mai","value":582},{"label":"Jun","value":749},{"label":"Jul","value":644},{"label":"Ago","value":455},{"label":"Set","value":819},{"label":"Out","value":617},{"label":"Nov","value":779},{"label":"Dez","value":799}];
const MX = 819;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>ESG</span></h1>
                </div>
