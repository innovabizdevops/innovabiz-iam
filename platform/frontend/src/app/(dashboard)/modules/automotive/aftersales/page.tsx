...
const PAGE = "Aftersales Service";
const KPIS = [{"l":"Vendas YTD (€)","v":"€68534","t":"-2.7%","d":"down"},{"l":"Pipeline (€)","v":"€11467","t":"-4.0%","d":"down"},{"l":"Atingimento Quota (%)","v":"73.1%","t":"+9.9%","d":"up"},{"l":"Win Rate (%)","v":"72.9%","t":"+9.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 24127.99","€ 18831.24","€ 12663.94","96.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 9812.85","€ 20097.45","€ 29791.72","91.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 1600.31","€ 41045.32","€ 38524.69","93.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 13581.13","€ 34723.76","€ 40816.92","74.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 17201.11","€ 8233.34","€ 22127.33","83.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":787},{"label":"Mar","value":679},{"label":"Abr","value":675},{"label":"Mai","value":920},{"label":"Jun","value":941},{"label":"Jul","value":985},{"label":"Ago","value":651},{"label":"Set","value":884},{"label":"Out","value":676},{"label":"Nov","value":886},{"label":"Dez","value":749}];
const MX = 985;
