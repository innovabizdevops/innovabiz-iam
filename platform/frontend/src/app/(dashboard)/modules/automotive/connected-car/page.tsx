...
const PAGE = "Connected Car IoT";
const KPIS = [{"l":"Dispositivos Online","v":"6.896","t":"+16.3%","d":"up"},{"l":"Dados/Min (MB)","v":"2.553","t":"+5.5%","d":"up"},{"l":"Alertas Ativos","v":"4.244","t":"+17.2%","d":"up"},{"l":"Uptime (%)","v":"90.8%","t":"+1.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.566","565","4.765","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.145","5.644","2.039","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.803","369","8.054","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.852","383","5.343","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.110","2.953","7.616","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1044},{"label":"Fev","value":717},{"label":"Mar","value":912},{"label":"Abr","value":696},{"label":"Mai","value":940},{"label":"Jun","value":772},{"label":"Jul","value":1045},{"label":"Ago","value":863},{"label":"Set","value":816},{"label":"Out","value":825},{"label":"Nov","value":1027},{"label":"Dez","value":864}];
const MX = 1045;
