...
const PAGE = "Recall Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.266","t":"+17.4%","d":"up"},{"l":"Savings (€)","v":"€54302","t":"+0.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"86.6%","t":"-0.3%","d":"down"},{"l":"Ciclos PDCA","v":"6.002","t":"+14.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.793","€ 45148.52","4.627","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.267","€ 45546.79","4.000","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.167","€ 36064.08","1.229","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.362","€ 40779.89","5.946","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.282","€ 36444.10","988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":670},{"label":"Mar","value":848},{"label":"Abr","value":562},{"label":"Mai","value":588},{"label":"Jun","value":643},{"label":"Jul","value":663},{"label":"Ago","value":635},{"label":"Set","value":748},{"label":"Out","value":807},{"label":"Nov","value":717},{"label":"Dez","value":849}];
const MX = 849;
