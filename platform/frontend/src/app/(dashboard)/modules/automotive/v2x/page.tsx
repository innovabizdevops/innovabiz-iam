...
const KPIS = [{"l":"Total Automotive","v":"7.843","t":"-2.1%","d":"down"},{"l":"V2X Communication Ativos","v":"1.306","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"67","t":"+17.3%","d":"up"}];
const COLS = ["ID","V2X Communication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Automotive #001","Automotive #002","6.681","2.613","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Automotive #002","Automotive #003","2.356","2.576","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Automotive #003","Automotive #004","1.366","781","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Automotive #004","Automotive #005","1.406","2.763","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Automotive #005","Automotive #001","8.692","4.862","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":1079},{"label":"Mar","value":902},{"label":"Abr","value":706},{"label":"Mai","value":718},{"label":"Jun","value":1059},{"label":"Jul","value":932},{"label":"Ago","value":978},{"label":"Set","value":1041},{"label":"Out","value":781},{"label":"Nov","value":854},{"label":"Dez","value":924}];
const MX = 1079;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>5G</span></h1>
                </div>
