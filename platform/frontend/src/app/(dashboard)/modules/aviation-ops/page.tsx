...
const KPIS = [
    { label: "Total Registos", value: "2123", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2662", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€204K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "779023123", cells: ["AVI-2123", "Aviation Operations Item 1", "12/8/2026", "€23 223"], status: "active" as const },
    { id: "779026694", cells: ["AVI-5694", "Aviation Operations Item 2", "27/3/2026", "€26 794"], status: "pending" as const },
    { id: "779030265", cells: ["AVI-9265", "Aviation Operations Item 3", "14/10/2026", "€30 365"], status: "completed" as const },
    { id: "779033836", cells: ["AVI-3836", "Aviation Operations Item 4", "1/5/2026", "€33 936"], status: "warning" as const },
    { id: "779037407", cells: ["AVI-7407", "Aviation Operations Item 5", "16/12/2026", "€37 507"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aviation Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aviation Operations</p>
                    </div>
                </div>
