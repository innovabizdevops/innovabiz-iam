...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€27.1M","t":"-1.3%","d":"down"},{"l":"MRR (€)","v":"€9405","t":"+11.7%","d":"up"},{"l":"Churn (%)","v":"85.2%","t":"+15.8%","d":"up"},{"l":"ARPU (€)","v":"€41163","t":"+5.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 19231.81","906","€ 29520.82","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9367.88","1.517","€ 34192.00","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27259.91","7.827","€ 26883.39","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31184.57","8.582","€ 43871.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 539.14","8.175","€ 34093.59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":699},{"label":"Mar","value":368},{"label":"Abr","value":483},{"label":"Mai","value":447},{"label":"Jun","value":692},{"label":"Jul","value":709},{"label":"Ago","value":443},{"label":"Set","value":413},{"label":"Out","value":514},{"label":"Nov","value":579},{"label":"Dez","value":375}];
const MX = 709;
