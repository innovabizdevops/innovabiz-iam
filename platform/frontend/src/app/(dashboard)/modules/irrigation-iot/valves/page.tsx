...
const PAGE = "Valve Control";
const KPIS = [{"l":"Dispositivos Online","v":"8.582","t":"+8.4%","d":"up"},{"l":"Dados/Min (MB)","v":"8.742","t":"+5.0%","d":"up"},{"l":"Alertas Ativos","v":"1.005","t":"-0.9%","d":"down"},{"l":"Uptime (%)","v":"91.8%","t":"+9.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.688","6.553","3.614","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.612","5.180","4.087","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.978","5.565","6.516","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.062","7.019","6.585","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.877","3.269","3.593","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":1015},{"label":"Mar","value":808},{"label":"Abr","value":801},{"label":"Mai","value":719},{"label":"Jun","value":942},{"label":"Jul","value":1013},{"label":"Ago","value":1012},{"label":"Set","value":918},{"label":"Out","value":738},{"label":"Nov","value":772},{"label":"Dez","value":705}];
const MX = 1015;
