...
export default function IrrigationIotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Irrigation Iot</h1><p className="text-sm text-muted-foreground">Irrigation Iot • iBOS Enterprise</p></div>
