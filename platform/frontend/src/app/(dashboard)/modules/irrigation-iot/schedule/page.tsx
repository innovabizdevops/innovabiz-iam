...
const ACCENT = "#0e7490";
const MODULE = "Irrigation IoT";
const PAGE = "Schedule Auto";
const KPIS = [{"l":"Dispositivos Online","v":"6.885","t":"-1.6%","d":"down"},{"l":"Dados/Min (MB)","v":"4.003","t":"+13.4%","d":"up"},{"l":"Alertas Ativos","v":"2.536","t":"+10.5%","d":"up"},{"l":"Uptime (%)","v":"69.8%","t":"+14.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.208","2.398","2.785","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.356","879","8.422","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","472","8.082","1.072","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.507","1.453","1.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.367","6.720","2.425","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1015},{"label":"Fev","value":858},{"label":"Mar","value":976},{"label":"Abr","value":689},{"label":"Mai","value":956},{"label":"Jun","value":985},{"label":"Jul","value":657},{"label":"Ago","value":985},{"label":"Set","value":966},{"label":"Out","value":748},{"label":"Nov","value":663},{"label":"Dez","value":933}];
const MX = 1015;
