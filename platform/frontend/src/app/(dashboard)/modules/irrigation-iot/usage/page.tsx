...
const PAGE = "Water Usage";
const KPIS = [{"l":"Dispositivos Online","v":"5.392","t":"+9.0%","d":"up"},{"l":"Dados/Min (MB)","v":"6.724","t":"+5.1%","d":"up"},{"l":"Alertas Ativos","v":"387","t":"+4.1%","d":"up"},{"l":"Uptime (%)","v":"69.0%","t":"+8.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","520","4.446","1.362","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.467","1.793","5.365","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.552","637","2.287","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.197","948","4.297","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.845","2.753","2.191","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":846},{"label":"Mar","value":499},{"label":"Abr","value":604},{"label":"Mai","value":739},{"label":"Jun","value":800},{"label":"Jul","value":578},{"label":"Ago","value":548},{"label":"Set","value":863},{"label":"Out","value":549},{"label":"Nov","value":539},{"label":"Dez","value":849}];
const MX = 863;
