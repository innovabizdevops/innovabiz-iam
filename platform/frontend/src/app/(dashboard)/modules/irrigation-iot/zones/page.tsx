...
const PAGE = "Zone Control";
const KPIS = [{"l":"Dispositivos Online","v":"3.756","t":"+6.0%","d":"up"},{"l":"Dados/Min (MB)","v":"6.713","t":"+11.5%","d":"up"},{"l":"Alertas Ativos","v":"8.161","t":"-2.7%","d":"down"},{"l":"Uptime (%)","v":"71.9%","t":"+8.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.676","440","6.135","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.187","7.536","5.439","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.373","8.337","458","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.250","177","5.706","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.989","4.282","1.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":628},{"label":"Mar","value":428},{"label":"Abr","value":542},{"label":"Mai","value":591},{"label":"Jun","value":519},{"label":"Jul","value":373},{"label":"Ago","value":623},{"label":"Set","value":379},{"label":"Out","value":314},{"label":"Nov","value":545},{"label":"Dez","value":672}];
const MX = 672;
