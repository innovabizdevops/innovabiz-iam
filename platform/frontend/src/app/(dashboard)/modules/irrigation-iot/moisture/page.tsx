...
const PAGE = "Moisture Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"5.197","t":"+4.5%","d":"up"},{"l":"Dados/Min (MB)","v":"6.480","t":"+2.7%","d":"up"},{"l":"Alertas Ativos","v":"2.588","t":"+0.6%","d":"up"},{"l":"Uptime (%)","v":"81.9%","t":"+13.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.638","8.694","4.944","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.222","661","1.230","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","102","1.042","4.106","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.243","8.514","7.436","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.974","7.015","6.603","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":461},{"label":"Mar","value":569},{"label":"Abr","value":586},{"label":"Mai","value":334},{"label":"Jun","value":338},{"label":"Jul","value":467},{"label":"Ago","value":567},{"label":"Set","value":363},{"label":"Out","value":273},{"label":"Nov","value":389},{"label":"Dez","value":303}];
const MX = 586;
