...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"2.531","t":"+14.7%","d":"up"},{"l":"Submissões/Dia","v":"4278","t":"+3.4%","d":"up"},{"l":"Documentos Gerados","v":"3.721","t":"-3.0%","d":"down"},{"l":"Templates","v":"5.281","t":"+4.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.098","2026-03-09","8.375","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","736","2026-01-03","2.843","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.910","2026-02-17","374","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.799","2026-02-27","1.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.458","2026-02-04","4.741","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":608},{"label":"Mar","value":589},{"label":"Abr","value":393},{"label":"Mai","value":323},{"label":"Jun","value":435},{"label":"Jul","value":377},{"label":"Ago","value":460},{"label":"Set","value":434},{"label":"Out","value":422},{"label":"Nov","value":318},{"label":"Dez","value":450}];
const MX = 608;
