...
const ACCENT = "#7f1d1d";
const MODULE = "Digital Forensics Platform";
const PAGE = "Analyze";
const KPIS = [{"l":"Formulários Ativos","v":"6.374","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"1428","t":"+8.9%","d":"up"},{"l":"Documentos Gerados","v":"2.675","t":"+5.8%","d":"up"},{"l":"Templates","v":"5.086","t":"-2.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","524","2026-03-16","2.997","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.877","2026-01-05","7.763","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.215","2026-01-05","6.353","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.968","2026-03-25","4.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.112","2026-03-07","6.796","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":833},{"label":"Mar","value":774},{"label":"Abr","value":537},{"label":"Mai","value":610},{"label":"Jun","value":717},{"label":"Jul","value":715},{"label":"Ago","value":848},{"label":"Set","value":637},{"label":"Out","value":503},{"label":"Nov","value":733},{"label":"Dez","value":808}];
const MX = 848;
