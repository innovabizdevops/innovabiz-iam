...
const PAGE = "Preserve";
const KPIS = [{"l":"Formulários Ativos","v":"5.969","t":"+13.6%","d":"up"},{"l":"Submissões/Dia","v":"4768","t":"+0.1%","d":"up"},{"l":"Documentos Gerados","v":"5.627","t":"+12.0%","d":"up"},{"l":"Templates","v":"6.166","t":"-1.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.563","2026-01-13","1.408","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.032","2026-01-08","3.372","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.528","2026-01-27","1.582","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.709","2026-02-03","6.559","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.981","2026-03-16","7.375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":1048},{"label":"Mar","value":979},{"label":"Abr","value":958},{"label":"Mai","value":823},{"label":"Jun","value":808},{"label":"Jul","value":1048},{"label":"Ago","value":878},{"label":"Set","value":718},{"label":"Out","value":919},{"label":"Nov","value":935},{"label":"Dez","value":674}];
const MX = 1048;
