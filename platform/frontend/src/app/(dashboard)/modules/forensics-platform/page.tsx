...
/* ═══ Digital Forensics Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "9731", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2675", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€31K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1100770831", cells: ["FOR-8831", "Digital Forensics Platform Item 1", "28/8/2026", "€20 931"], status: "active" as const },
    { id: "1100774402", cells: ["FOR-3402", "Digital Forensics Platform Item 2", "15/3/2026", "€24 502"], status: "pending" as const },
    { id: "1100777973", cells: ["FOR-6973", "Digital Forensics Platform Item 3", "2/10/2026", "€28 073"], status: "completed" as const },
    { id: "1100781544", cells: ["FOR-1544", "Digital Forensics Platform Item 4", "17/5/2026", "€31 644"], status: "warning" as const },
    { id: "1100785115", cells: ["FOR-5115", "Digital Forensics Platform Item 5", "4/12/2026", "€35 215"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 51 }, { label: "Fev", value: 60 }, { label: "Mar", value: 69 }, { label: "Abr", value: 78 }, { label: "Mai", value: 87 }, { label: "Jun", value: 96 }];
...
export default function DigitalForensicsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Forensics Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Forensics Platform</p>
                    </div>
                </div>
