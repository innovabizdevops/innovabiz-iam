...
const PAGE = "Acquire";
const KPIS = [{"l":"Formulários Ativos","v":"3.826","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"4235","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"3.360","t":"-5.2%","d":"down"},{"l":"Templates","v":"8.095","t":"+10.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.751","2026-03-27","4.564","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.190","2026-03-06","6.739","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.841","2026-03-21","3.661","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.413","2026-02-06","4.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.955","2026-03-27","5.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":955},{"label":"Mar","value":801},{"label":"Abr","value":807},{"label":"Mai","value":874},{"label":"Jun","value":926},{"label":"Jul","value":934},{"label":"Ago","value":672},{"label":"Set","value":715},{"label":"Out","value":776},{"label":"Nov","value":821},{"label":"Dez","value":995}];
const MX = 997;
