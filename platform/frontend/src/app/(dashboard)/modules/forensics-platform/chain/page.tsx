...
const PAGE = "Chain";
const KPIS = [{"l":"Formulários Ativos","v":"689","t":"-1.7%","d":"down"},{"l":"Submissões/Dia","v":"1560","t":"+2.1%","d":"up"},{"l":"Documentos Gerados","v":"695","t":"+13.9%","d":"up"},{"l":"Templates","v":"2.187","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.186","2026-02-20","5.905","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.936","2026-01-14","2.724","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.237","2026-01-12","1.094","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.819","2026-01-26","4.501","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","230","2026-03-01","4.916","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":599},{"label":"Mar","value":752},{"label":"Abr","value":732},{"label":"Mai","value":595},{"label":"Jun","value":562},{"label":"Jul","value":408},{"label":"Ago","value":404},{"label":"Set","value":467},{"label":"Out","value":718},{"label":"Nov","value":553},{"label":"Dez","value":745}];
const MX = 752;
