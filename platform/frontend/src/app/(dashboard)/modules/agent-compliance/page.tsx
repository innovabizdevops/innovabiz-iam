...
/* ═══ AI Compliance Agent — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "2394", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "823", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€143K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "281469194", cells: ["AGE-4194", "AI Compliance Agent Item 1", "7/3/2026", "€19 294"], status: "active" as const },
    { id: "281472765", cells: ["AGE-7765", "AI Compliance Agent Item 2", "22/10/2026", "€22 865"], status: "pending" as const },
    { id: "281476336", cells: ["AGE-2336", "AI Compliance Agent Item 3", "9/5/2026", "€26 436"], status: "completed" as const },
    { id: "281479907", cells: ["AGE-5907", "AI Compliance Agent Item 4", "24/12/2026", "€30 007"], status: "warning" as const },
    { id: "281483478", cells: ["AGE-9478", "AI Compliance Agent Item 5", "11/7/2026", "€33 578"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Compliance Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Compliance Agent</p>
                    </div>
                </div>
