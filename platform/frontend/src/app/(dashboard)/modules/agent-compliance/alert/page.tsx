...
const PAGE = "Alert";
const KPIS = [{"l":"Auditorias Realizadas","v":"646","t":"+8.8%","d":"up"},{"l":"NC Abertas","v":"1.731","t":"+10.5%","d":"up"},{"l":"Conformidade (%)","v":"88.5%","t":"-3.1%","d":"down"},{"l":"CAPAs Pendentes","v":"1.274","t":"+11.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.415","84.2%","6.768","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","944","95.2%","4.193","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.120","91.8%","3.578","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.383","82.9%","2.279","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.219","91.5%","4.053","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":716},{"label":"Mar","value":797},{"label":"Abr","value":751},{"label":"Mai","value":661},{"label":"Jun","value":706},{"label":"Jul","value":832},{"label":"Ago","value":567},{"label":"Set","value":552},{"label":"Out","value":643},{"label":"Nov","value":586},{"label":"Dez","value":727}];
const MX = 832;
