...
const KPIS = [{"l":"Auditorias Realizadas","v":"591","t":"+15.8%","d":"up"},{"l":"NC Abertas","v":"6.556","t":"+15.9%","d":"up"},{"l":"Conformidade (%)","v":"93.1%","t":"+11.1%","d":"up"},{"l":"CAPAs Pendentes","v":"7.577","t":"-3.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.570","91.0%","8.413","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.085","99.8%","4.602","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.959","80.2%","5.065","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.764","93.5%","476","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.235","86.0%","3.015","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":483},{"label":"Mar","value":719},{"label":"Abr","value":802},{"label":"Mai","value":561},{"label":"Jun","value":692},{"label":"Jul","value":608},{"label":"Ago","value":835},{"label":"Set","value":525},{"label":"Out","value":549},{"label":"Nov","value":814},{"label":"Dez","value":480}];
const MX = 835;
