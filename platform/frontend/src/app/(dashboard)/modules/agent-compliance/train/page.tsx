...
const PAGE = "Train";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.086","t":"+8.1%","d":"up"},{"l":"NC Abertas","v":"3.929","t":"+8.4%","d":"up"},{"l":"Conformidade (%)","v":"89.6%","t":"-1.4%","d":"down"},{"l":"CAPAs Pendentes","v":"5.792","t":"+7.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.461","99.4%","7.227","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.008","91.2%","2.677","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.743","97.4%","5.190","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.582","84.7%","6.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.353","97.2%","1.532","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":962},{"label":"Mar","value":669},{"label":"Abr","value":747},{"label":"Mai","value":715},{"label":"Jun","value":935},{"label":"Jul","value":1036},{"label":"Ago","value":680},{"label":"Set","value":1054},{"label":"Out","value":892},{"label":"Nov","value":713},{"label":"Dez","value":900}];
const MX = 1054;
