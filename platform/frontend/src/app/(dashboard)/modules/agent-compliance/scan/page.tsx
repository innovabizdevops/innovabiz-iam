...
const ACCENT = "#7c3aed";
const MODULE = "AI Compliance Agent";
const PAGE = "Scan";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.093","t":"+3.7%","d":"up"},{"l":"NC Abertas","v":"1.531","t":"+10.0%","d":"up"},{"l":"Conformidade (%)","v":"87.3%","t":"+11.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.488","t":"+12.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","117","98.4%","733","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.698","82.8%","387","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.214","71.4%","5.643","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.696","92.8%","175","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.311","98.7%","2.838","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":237},{"label":"Mar","value":401},{"label":"Abr","value":355},{"label":"Mai","value":294},{"label":"Jun","value":543},{"label":"Jul","value":329},{"label":"Ago","value":593},{"label":"Set","value":415},{"label":"Out","value":275},{"label":"Nov","value":489},{"label":"Dez","value":515}];
const MX = 593;
