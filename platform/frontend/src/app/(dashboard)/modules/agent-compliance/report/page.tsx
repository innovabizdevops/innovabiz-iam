...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.997","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"7.972","t":"+3.8%","d":"up"},{"l":"Conformidade (%)","v":"91.4%","t":"-1.5%","d":"down"},{"l":"CAPAs Pendentes","v":"5.670","t":"+10.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.559","79.3%","2.515","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.062","91.9%","6.319","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","878","76.5%","3.996","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.169","75.8%","5.298","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.700","96.8%","8.396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":976},{"label":"Mar","value":959},{"label":"Abr","value":1054},{"label":"Mai","value":1051},{"label":"Jun","value":1002},{"label":"Jul","value":783},{"label":"Ago","value":1056},{"label":"Set","value":1056},{"label":"Out","value":752},{"label":"Nov","value":1090},{"label":"Dez","value":724}];
const MX = 1090;
