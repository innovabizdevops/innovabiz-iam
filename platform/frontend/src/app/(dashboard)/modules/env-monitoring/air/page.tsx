...
const ACCENT = "#6366f1";
const MODULE = "Env Monitoring Station";
const PAGE = "Air";
const KPIS = [{"l":"Total Env Monitoring","v":"8.943","t":"-1.9%","d":"down"},{"l":"Air Ativos","v":"9.085","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+13.5%","d":"up"}];
const COLS = ["ID","Air","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitoring #001","Env Monitoring #002","4.220","6.303","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitoring #002","Env Monitoring #003","7.879","4.868","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitoring #003","Env Monitoring #004","1.246","517","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitoring #004","Env Monitoring #005","3.686","4.015","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitoring #005","Env Monitoring #001","6.068","4.965","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":836},{"label":"Mar","value":819},{"label":"Abr","value":917},{"label":"Mai","value":672},{"label":"Jun","value":637},{"label":"Jul","value":759},{"label":"Ago","value":794},{"label":"Set","value":785},{"label":"Out","value":860},{"label":"Nov","value":721},{"label":"Dez","value":627}];
const MX = 946;
