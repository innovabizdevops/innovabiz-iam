...
const PAGE = "Weather";
const KPIS = [{"l":"Total Env Monitoring","v":"1.994","t":"+15.5%","d":"up"},{"l":"Weather Ativos","v":"1.167","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"66","t":"+6.1%","d":"up"}];
const COLS = ["ID","Weather","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitoring #001","Env Monitoring #002","7.236","7.331","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitoring #002","Env Monitoring #003","2.329","3.452","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitoring #003","Env Monitoring #004","5.712","6.915","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitoring #004","Env Monitoring #005","6.701","7.094","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitoring #005","Env Monitoring #001","5.135","7.429","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":1034},{"label":"Mar","value":1044},{"label":"Abr","value":841},{"label":"Mai","value":895},{"label":"Jun","value":686},{"label":"Jul","value":669},{"label":"Ago","value":1053},{"label":"Set","value":745},{"label":"Out","value":925},{"label":"Nov","value":1023},{"label":"Dez","value":936}];
const MX = 1053;
