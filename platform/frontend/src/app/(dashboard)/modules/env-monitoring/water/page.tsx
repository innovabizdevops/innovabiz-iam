...
const PAGE = "Water";
const KPIS = [{"l":"Total Env Monitoring","v":"5.613","t":"-2.4%","d":"down"},{"l":"Water Ativos","v":"617","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"84","t":"+0.1%","d":"up"}];
const COLS = ["ID","Water","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitoring #001","Env Monitoring #002","6.350","8.734","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitoring #002","Env Monitoring #003","6.197","6.116","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitoring #003","Env Monitoring #004","9.100","5.723","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitoring #004","Env Monitoring #005","9.061","1.360","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitoring #005","Env Monitoring #001","5.077","8.874","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":559},{"label":"Mar","value":569},{"label":"Abr","value":429},{"label":"Mai","value":585},{"label":"Jun","value":498},{"label":"Jul","value":485},{"label":"Ago","value":372},{"label":"Set","value":548},{"label":"Out","value":470},{"label":"Nov","value":433},{"label":"Dez","value":523}];
const MX = 585;
