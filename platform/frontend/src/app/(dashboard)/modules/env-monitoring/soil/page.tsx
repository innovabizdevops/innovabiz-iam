...
const PAGE = "Soil";
const KPIS = [{"l":"Total Env Monitoring","v":"6.175","t":"+11.6%","d":"up"},{"l":"Soil Ativos","v":"7.796","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"84","t":"+2.9%","d":"up"}];
const COLS = ["ID","Soil","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Env Monitoring #001","Env Monitoring #002","4.711","4.648","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Env Monitoring #002","Env Monitoring #003","2.175","1.617","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Env Monitoring #003","Env Monitoring #004","3.193","7.845","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Env Monitoring #004","Env Monitoring #005","5.304","2.433","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Env Monitoring #005","Env Monitoring #001","4.210","8.548","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":890},{"label":"Mar","value":1016},{"label":"Abr","value":803},{"label":"Mai","value":924},{"label":"Jun","value":679},{"label":"Jul","value":879},{"label":"Ago","value":910},{"label":"Set","value":795},{"label":"Out","value":920},{"label":"Nov","value":915},{"label":"Dez","value":707}];
const MX = 1016;
