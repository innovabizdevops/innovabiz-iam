...
const PAGE = "Fund";
const KPIS = [{"l":"Ideias Submetidas","v":"4.771","t":"+10.3%","d":"up"},{"l":"Patentes (YTD)","v":"8.525","t":"+0.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.113","t":"-4.7%","d":"down"},{"l":"Budget I&D (€M)","v":"€14.5M","t":"+9.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.485","97.8%","2.756","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.595","96.6%","5.081","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.948","86.2%","5.687","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","480","85.6%","3.728","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","147","90.6%","2.861","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1034},{"label":"Fev","value":804},{"label":"Mar","value":984},{"label":"Abr","value":1001},{"label":"Mai","value":732},{"label":"Jun","value":736},{"label":"Jul","value":934},{"label":"Ago","value":1037},{"label":"Set","value":696},{"label":"Out","value":709},{"label":"Nov","value":790},{"label":"Dez","value":1040}];
const MX = 1040;
