...
const KPIS = [
    { label: "Total Registos", value: "4080", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2088", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€432K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "707052080", cells: ["INN-4080", "Innovation Management Item 1", "1/9/2026", "€2180"], status: "active" as const },
    { id: "707055651", cells: ["INN-7651", "Innovation Management Item 2", "16/4/2026", "€5751"], status: "pending" as const },
    { id: "707059222", cells: ["INN-2222", "Innovation Management Item 3", "3/11/2026", "€9322"], status: "completed" as const },
    { id: "707062793", cells: ["INN-5793", "Innovation Management Item 4", "18/6/2026", "€12 893"], status: "warning" as const },
    { id: "707066364", cells: ["INN-9364", "Innovation Management Item 5", "5/1/2026", "€16 464"], status: "active" as const },
];
...
export default function InnovationManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Innovation Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Innovation Management</p>
                    </div>
                </div>
