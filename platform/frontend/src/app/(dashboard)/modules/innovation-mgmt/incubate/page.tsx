...
const PAGE = "Incubate";
const KPIS = [{"l":"Ideias Submetidas","v":"4.349","t":"-2.3%","d":"down"},{"l":"Patentes (YTD)","v":"4.980","t":"+5.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.717","t":"+4.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€2.9M","t":"+13.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.172","98.7%","6.266","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.344","78.5%","1.170","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.490","96.5%","7.531","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.850","77.9%","6.885","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.386","74.0%","3.889","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":826},{"label":"Mar","value":601},{"label":"Abr","value":919},{"label":"Mai","value":976},{"label":"Jun","value":925},{"label":"Jul","value":891},{"label":"Ago","value":724},{"label":"Set","value":624},{"label":"Out","value":631},{"label":"Nov","value":700},{"label":"Dez","value":851}];
const MX = 976;
