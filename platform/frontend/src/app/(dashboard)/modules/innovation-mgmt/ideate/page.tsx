...
const PAGE = "Ideate";
const KPIS = [{"l":"Ideias Submetidas","v":"3.178","t":"+11.3%","d":"up"},{"l":"Patentes (YTD)","v":"5.829","t":"+0.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.889","t":"+8.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€30.6M","t":"+6.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.116","86.5%","5.825","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.971","71.6%","1.279","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.354","93.1%","3.903","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","9.024","74.9%","8.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.110","96.8%","5.689","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":631},{"label":"Mar","value":491},{"label":"Abr","value":607},{"label":"Mai","value":490},{"label":"Jun","value":394},{"label":"Jul","value":347},{"label":"Ago","value":636},{"label":"Set","value":664},{"label":"Out","value":455},{"label":"Nov","value":597},{"label":"Dez","value":403}];
const MX = 664;
