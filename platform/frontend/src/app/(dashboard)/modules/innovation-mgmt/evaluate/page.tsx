...
const PAGE = "Evaluate";
const KPIS = [{"l":"Ideias Submetidas","v":"7.755","t":"+1.2%","d":"up"},{"l":"Patentes (YTD)","v":"6.821","t":"-5.0%","d":"down"},{"l":"Projetos Innovation Lab","v":"8.362","t":"+4.0%","d":"up"},{"l":"Budget I&D (€M)","v":"€34.3M","t":"+15.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.321","77.3%","7.989","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.044","95.1%","9.081","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.041","94.3%","317","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.653","96.2%","7.569","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.119","76.0%","5.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":687},{"label":"Mar","value":998},{"label":"Abr","value":679},{"label":"Mai","value":716},{"label":"Jun","value":896},{"label":"Jul","value":957},{"label":"Ago","value":993},{"label":"Set","value":681},{"label":"Out","value":628},{"label":"Nov","value":851},{"label":"Dez","value":938}];
const MX = 998;
