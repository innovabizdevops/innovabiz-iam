...
const PAGE = "Launch";
const KPIS = [{"l":"Ideias Submetidas","v":"864","t":"+11.9%","d":"up"},{"l":"Patentes (YTD)","v":"7.571","t":"+7.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.408","t":"+9.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€4.2M","t":"+2.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","144","75.3%","6.540","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.932","97.1%","8.952","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.944","93.6%","5.964","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.714","89.8%","6.095","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.486","77.9%","5.398","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":478},{"label":"Mar","value":429},{"label":"Abr","value":517},{"label":"Mai","value":623},{"label":"Jun","value":631},{"label":"Jul","value":600},{"label":"Ago","value":310},{"label":"Set","value":485},{"label":"Out","value":625},{"label":"Nov","value":615},{"label":"Dez","value":408}];
const MX = 631;
