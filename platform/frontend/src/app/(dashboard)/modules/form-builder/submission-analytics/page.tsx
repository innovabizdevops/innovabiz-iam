...
const PAGE = "Submission Analytics";
const KPIS = [{"l":"Formulários Ativos","v":"9.091","t":"-2.3%","d":"down"},{"l":"Submissões/Dia","v":"1167","t":"+3.4%","d":"up"},{"l":"Documentos Gerados","v":"4.574","t":"+2.7%","d":"up"},{"l":"Templates","v":"2.760","t":"+14.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.598","2026-03-09","745","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","814","2026-02-10","3.293","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.945","2026-03-14","2.132","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.405","2026-03-18","4.926","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.437","2026-02-26","3.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":426},{"label":"Mar","value":568},{"label":"Abr","value":644},{"label":"Mai","value":668},{"label":"Jun","value":393},{"label":"Jul","value":603},{"label":"Ago","value":561},{"label":"Set","value":769},{"label":"Out","value":681},{"label":"Nov","value":785},{"label":"Dez","value":782}];
const MX = 785;
