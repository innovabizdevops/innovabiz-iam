...
const PAGE = "Form Templates";
const KPIS = [{"l":"Formulários Ativos","v":"4.062","t":"+6.6%","d":"up"},{"l":"Submissões/Dia","v":"5076","t":"-4.5%","d":"down"},{"l":"Documentos Gerados","v":"905","t":"-1.9%","d":"down"},{"l":"Templates","v":"6.990","t":"+0.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.894","2026-03-15","5.399","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.086","2026-03-05","7.712","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","737","2026-01-05","7.688","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.778","2026-03-25","5.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.229","2026-03-05","9.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":302},{"label":"Mar","value":644},{"label":"Abr","value":509},{"label":"Mai","value":571},{"label":"Jun","value":359},{"label":"Jul","value":410},{"label":"Ago","value":416},{"label":"Set","value":374},{"label":"Out","value":465},{"label":"Nov","value":388},{"label":"Dez","value":541}];
const MX = 644;
