...
const ACCENT = "#16a34a";
const MODULE = "Form Builder & Surveys";
const PAGE = "Response Analytics AI";
const KPIS = [{"l":"Formulários Ativos","v":"2.937","t":"+7.6%","d":"up"},{"l":"Submissões/Dia","v":"4421","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"8.824","t":"+16.8%","d":"up"},{"l":"Templates","v":"8.557","t":"+15.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","883","2026-02-08","7.633","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.147","2026-01-20","1.648","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.740","2026-03-17","3.729","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.229","2026-02-20","8.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.621","2026-01-18","7.341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":527},{"label":"Mar","value":714},{"label":"Abr","value":572},{"label":"Mai","value":706},{"label":"Jun","value":677},{"label":"Jul","value":539},{"label":"Ago","value":459},{"label":"Set","value":635},{"label":"Out","value":668},{"label":"Nov","value":639},{"label":"Dez","value":645}];
const MX = 714;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>AI</span></h1>
                </div>
