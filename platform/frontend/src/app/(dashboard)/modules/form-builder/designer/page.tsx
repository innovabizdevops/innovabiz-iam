...
const PAGE = "Drag &amp; Drop Designer";
const KPIS = [{"l":"Formulários Ativos","v":"7.479","t":"+1.5%","d":"up"},{"l":"Submissões/Dia","v":"4260","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"8.387","t":"+6.1%","d":"up"},{"l":"Templates","v":"5.429","t":"+7.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.371","2026-03-15","6.292","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.945","2026-01-08","8.350","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.086","2026-02-25","1.656","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.310","2026-02-26","2.682","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.971","2026-02-24","3.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":376},{"label":"Mar","value":352},{"label":"Abr","value":256},{"label":"Mai","value":313},{"label":"Jun","value":445},{"label":"Jul","value":626},{"label":"Ago","value":360},{"label":"Set","value":563},{"label":"Out","value":477},{"label":"Nov","value":383},{"label":"Dez","value":296}];
const MX = 626;
