...
const PAGE = "Survey Builder";
const KPIS = [{"l":"Formulários Ativos","v":"6.553","t":"+16.0%","d":"up"},{"l":"Submissões/Dia","v":"4645","t":"+12.9%","d":"up"},{"l":"Documentos Gerados","v":"2.324","t":"-1.7%","d":"down"},{"l":"Templates","v":"6.479","t":"+17.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.542","2026-01-04","3.106","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.014","2026-02-17","6.871","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.364","2026-01-10","620","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.852","2026-01-13","9.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.327","2026-03-06","5.077","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":928},{"label":"Mar","value":788},{"label":"Abr","value":734},{"label":"Mai","value":960},{"label":"Jun","value":933},{"label":"Jul","value":759},{"label":"Ago","value":929},{"label":"Set","value":1000},{"label":"Out","value":827},{"label":"Nov","value":1001},{"label":"Dez","value":890}];
const MX = 1001;
