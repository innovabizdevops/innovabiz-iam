...
const KPIS = [{"l":"Formulários Ativos","v":"7.514","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"4037","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"4.251","t":"+14.2%","d":"up"},{"l":"Templates","v":"7.829","t":"+15.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.659","2026-02-28","2.696","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.483","2026-02-13","4.471","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.781","2026-02-13","4.616","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.603","2026-03-14","645","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.949","2026-02-10","7.533","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":727},{"label":"Mar","value":838},{"label":"Abr","value":966},{"label":"Mai","value":693},{"label":"Jun","value":998},{"label":"Jul","value":895},{"label":"Ago","value":814},{"label":"Set","value":643},{"label":"Out","value":1012},{"label":"Nov","value":1033},{"label":"Dez","value":822}];
const MX = 1033;
