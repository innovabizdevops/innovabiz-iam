...
const KPIS = [{"l":"Formulários Ativos","v":"1.715","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"4876","t":"+11.2%","d":"up"},{"l":"Documentos Gerados","v":"2.805","t":"+9.4%","d":"up"},{"l":"Templates","v":"3.851","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.664","2026-01-20","4.079","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.410","2026-03-17","2.353","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.359","2026-02-20","8.818","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.258","2026-02-21","1.269","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.506","2026-03-11","5.268","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":979},{"label":"Mar","value":968},{"label":"Abr","value":957},{"label":"Mai","value":680},{"label":"Jun","value":851},{"label":"Jul","value":763},{"label":"Ago","value":815},{"label":"Set","value":1000},{"label":"Out","value":847},{"label":"Nov","value":787},{"label":"Dez","value":775}];
const MX = 1000;
