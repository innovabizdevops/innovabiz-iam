...
const PAGE = "E-Signature Fields";
const KPIS = [{"l":"Formulários Ativos","v":"910","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"1596","t":"+2.2%","d":"up"},{"l":"Documentos Gerados","v":"5.594","t":"+8.6%","d":"up"},{"l":"Templates","v":"3.672","t":"-3.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.627","2026-02-10","3.425","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.717","2026-03-16","5.945","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.613","2026-01-27","4.174","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.123","2026-02-04","1.224","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.492","2026-03-08","4.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":719},{"label":"Mar","value":478},{"label":"Abr","value":672},{"label":"Mai","value":340},{"label":"Jun","value":538},{"label":"Jul","value":723},{"label":"Ago","value":349},{"label":"Set","value":722},{"label":"Out","value":416},{"label":"Nov","value":687},{"label":"Dez","value":453}];
const MX = 723;
