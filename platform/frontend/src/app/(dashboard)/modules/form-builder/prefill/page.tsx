...
const PAGE = "Pre-Fill Rules";
const KPIS = [{"l":"Formulários Ativos","v":"8.274","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"381","t":"-0.8%","d":"down"},{"l":"Documentos Gerados","v":"2.818","t":"-1.6%","d":"down"},{"l":"Templates","v":"3.966","t":"+1.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","722","2026-02-16","942","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.882","2026-03-27","5.134","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.481","2026-01-25","262","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","805","2026-02-25","2.548","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.368","2026-02-20","276","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":716},{"label":"Mar","value":1020},{"label":"Abr","value":704},{"label":"Mai","value":990},{"label":"Jun","value":645},{"label":"Jul","value":750},{"label":"Ago","value":841},{"label":"Set","value":909},{"label":"Out","value":826},{"label":"Nov","value":670},{"label":"Dez","value":684}];
const MX = 1020;
