...
const PAGE = "Dynamic Forms";
const KPIS = [{"l":"Formulários Ativos","v":"5.710","t":"+0.0%","d":"up"},{"l":"Submissões/Dia","v":"3510","t":"+6.3%","d":"up"},{"l":"Documentos Gerados","v":"5.471","t":"-3.9%","d":"down"},{"l":"Templates","v":"7.647","t":"+4.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.823","2026-01-18","3.375","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.369","2026-02-09","7.917","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.901","2026-02-18","7.567","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.104","2026-03-28","1.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.897","2026-03-17","8.780","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":563},{"label":"Mar","value":553},{"label":"Abr","value":624},{"label":"Mai","value":624},{"label":"Jun","value":484},{"label":"Jul","value":358},{"label":"Ago","value":371},{"label":"Set","value":516},{"label":"Out","value":390},{"label":"Nov","value":608},{"label":"Dez","value":369}];
const MX = 628;
