...
const PAGE = "Multi-Step Wizard";
const KPIS = [{"l":"Formulários Ativos","v":"1.666","t":"+2.6%","d":"up"},{"l":"Submissões/Dia","v":"4656","t":"-2.8%","d":"down"},{"l":"Documentos Gerados","v":"429","t":"+12.0%","d":"up"},{"l":"Templates","v":"6.839","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.806","2026-01-22","2.958","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.088","2026-03-13","1.152","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.151","2026-02-22","4.759","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.159","2026-01-20","780","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.465","2026-03-22","6.250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":545},{"label":"Mar","value":550},{"label":"Abr","value":254},{"label":"Mai","value":263},{"label":"Jun","value":421},{"label":"Jul","value":581},{"label":"Ago","value":253},{"label":"Set","value":517},{"label":"Out","value":408},{"label":"Nov","value":309},{"label":"Dez","value":468}];
const MX = 581;
