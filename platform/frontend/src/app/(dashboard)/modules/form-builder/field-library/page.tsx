...
const PAGE = "Field Library";
const KPIS = [{"l":"Formulários Ativos","v":"5.441","t":"+10.4%","d":"up"},{"l":"Submissões/Dia","v":"3796","t":"-5.3%","d":"down"},{"l":"Documentos Gerados","v":"1.029","t":"+14.5%","d":"up"},{"l":"Templates","v":"6.464","t":"+4.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.441","2026-03-11","2.492","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.526","2026-03-13","6.212","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.100","2026-03-03","4.533","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","614","2026-02-26","1.717","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.651","2026-03-17","4.288","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":230},{"label":"Mar","value":611},{"label":"Abr","value":421},{"label":"Mai","value":486},{"label":"Jun","value":515},{"label":"Jul","value":466},{"label":"Ago","value":541},{"label":"Set","value":374},{"label":"Out","value":396},{"label":"Nov","value":500},{"label":"Dez","value":495}];
const MX = 611;
