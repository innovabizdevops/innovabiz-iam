...
const PAGE = "Conditional Logic";
const KPIS = [{"l":"Formulários Ativos","v":"568","t":"-5.4%","d":"down"},{"l":"Submissões/Dia","v":"1198","t":"+16.8%","d":"up"},{"l":"Documentos Gerados","v":"6.390","t":"+0.6%","d":"up"},{"l":"Templates","v":"1.822","t":"-3.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.213","2026-03-24","7.564","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.104","2026-03-06","6.504","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.309","2026-03-14","599","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.463","2026-03-07","7.147","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.469","2026-03-06","5.971","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":716},{"label":"Mar","value":922},{"label":"Abr","value":851},{"label":"Mai","value":885},{"label":"Jun","value":797},{"label":"Jul","value":780},{"label":"Ago","value":1038},{"label":"Set","value":902},{"label":"Out","value":949},{"label":"Nov","value":1054},{"label":"Dez","value":760}];
const MX = 1054;
...
export default function ConditionalLogicFormBuilderPage() {
    return (
