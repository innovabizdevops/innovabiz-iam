...
const PAGE = "Validation Rules";
const KPIS = [{"l":"Formulários Ativos","v":"5.473","t":"+2.3%","d":"up"},{"l":"Submissões/Dia","v":"2066","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"6.717","t":"-5.7%","d":"down"},{"l":"Templates","v":"3.081","t":"+7.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.304","2026-01-01","3.946","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.993","2026-02-15","7.611","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.340","2026-01-14","8.610","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.608","2026-02-18","7.498","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.606","2026-03-05","467","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":478},{"label":"Mar","value":614},{"label":"Abr","value":504},{"label":"Mai","value":694},{"label":"Jun","value":869},{"label":"Jul","value":488},{"label":"Ago","value":811},{"label":"Set","value":586},{"label":"Out","value":763},{"label":"Nov","value":800},{"label":"Dez","value":609}];
const MX = 869;
