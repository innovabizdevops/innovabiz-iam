...
const PAGE = "Multi-Step Wizards";
const KPIS = [{"l":"Formulários Ativos","v":"7.321","t":"-3.9%","d":"down"},{"l":"Submissões/Dia","v":"3357","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"806","t":"+4.4%","d":"up"},{"l":"Templates","v":"7.481","t":"+1.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.467","2026-02-11","5.778","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.538","2026-03-14","7.273","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.819","2026-03-07","7.725","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.210","2026-01-13","7.514","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.447","2026-03-27","1.149","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":850},{"label":"Mar","value":667},{"label":"Abr","value":818},{"label":"Mai","value":903},{"label":"Jun","value":802},{"label":"Jul","value":882},{"label":"Ago","value":915},{"label":"Set","value":941},{"label":"Out","value":889},{"label":"Nov","value":685},{"label":"Dez","value":871}];
const MX = 941;
