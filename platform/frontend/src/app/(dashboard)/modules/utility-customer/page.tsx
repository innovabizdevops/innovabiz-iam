...
export default function UtilityCustomerPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Utility Customer</h1><p className="text-sm text-muted-foreground">Utility Customer • iBOS Enterprise</p></div>
