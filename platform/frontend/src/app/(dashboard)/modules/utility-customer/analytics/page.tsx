...
const ACCENT = "#6366f1";
const MODULE = "Utility Customer";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.926","t":"+4.3%","d":"up"},{"l":"Queries/Dia","v":"4522","t":"+7.8%","d":"up"},{"l":"Dados Processados (GB)","v":"5.850","t":"+12.9%","d":"up"},{"l":"Utilizadores Analytics","v":"9.083","t":"+14.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3404","2026-01-28","949","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","202","2026-01-13","5.781","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3264","2026-01-02","1.071","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3798","2026-03-01","594","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2820","2026-03-10","4.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":506},{"label":"Mar","value":514},{"label":"Abr","value":603},{"label":"Mai","value":486},{"label":"Jun","value":744},{"label":"Jul","value":753},{"label":"Ago","value":746},{"label":"Set","value":674},{"label":"Out","value":554},{"label":"Nov","value":741},{"label":"Dez","value":471}];
const MX = 753;
