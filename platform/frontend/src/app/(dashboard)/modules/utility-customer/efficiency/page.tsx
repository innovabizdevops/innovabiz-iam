...
const PAGE = "Energy Eff";
const KPIS = [{"l":"Total Utility Customer","v":"€84946","t":"+1.1%","d":"up"},{"l":"Energy Eff Ativos","v":"4.637","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"90","t":"-5.7%","d":"down"}];
const COLS = ["ID","Energy Eff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utility Customer #001","Utility Customer #002","1.301","6.976","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Utility Customer #002","Utility Customer #003","1.431","5.683","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Utility Customer #003","Utility Customer #004","7.258","4.009","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Utility Customer #004","Utility Customer #005","4.184","1.889","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utility Customer #005","Utility Customer #001","820","8.173","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":573},{"label":"Mar","value":767},{"label":"Abr","value":628},{"label":"Mai","value":655},{"label":"Jun","value":810},{"label":"Jul","value":538},{"label":"Ago","value":605},{"label":"Set","value":794},{"label":"Out","value":766},{"label":"Nov","value":907},{"label":"Dez","value":616}];
const MX = 907;
