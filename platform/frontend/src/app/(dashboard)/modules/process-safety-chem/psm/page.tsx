...
const PAGE = "PSM Comply";
const KPIS = [{"l":"Total Process Safety Chem","v":"7.472","t":"+10.4%","d":"up"},{"l":"PSM Comply Ativos","v":"3.248","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"72","t":"+13.2%","d":"up"}];
const COLS = ["ID","PSM Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Safety Chem #001","Process Safety Chem #002","2.505","4.459","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Process Safety Chem #002","Process Safety Chem #003","1.566","6.478","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Safety Chem #003","Process Safety Chem #004","4.317","2.294","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Process Safety Chem #004","Process Safety Chem #005","7.883","6.368","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Safety Chem #005","Process Safety Chem #001","7.095","3.902","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":696},{"label":"Mar","value":715},{"label":"Abr","value":692},{"label":"Mai","value":1041},{"label":"Jun","value":751},{"label":"Jul","value":836},{"label":"Ago","value":821},{"label":"Set","value":755},{"label":"Out","value":685},{"label":"Nov","value":653},{"label":"Dez","value":819}];
const MX = 1041;
