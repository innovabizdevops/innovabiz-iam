...
const PAGE = "LOPA Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.393","t":"-1.0%","d":"down"},{"l":"Queries/Dia","v":"2459","t":"+1.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.155","t":"+2.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.636","t":"+1.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2091","2026-03-17","5.328","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1535","2026-01-16","252","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1612","2026-02-26","3.661","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1950","2026-02-06","8.990","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","497","2026-03-26","1.570","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":602},{"label":"Mar","value":628},{"label":"Abr","value":908},{"label":"Mai","value":649},{"label":"Jun","value":890},{"label":"Jul","value":817},{"label":"Ago","value":898},{"label":"Set","value":659},{"label":"Out","value":775},{"label":"Nov","value":970},{"label":"Dez","value":731}];
const MX = 970;
