...
export default function ProcessSafetyChemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Process Safety Chem</h1><p className="text-sm text-muted-foreground">Process Safety Chem • iBOS Enterprise</p></div>
