...
const ACCENT = "#dc2626";
const MODULE = "Process Safety";
const PAGE = "HAZOP Study";
const KPIS = [{"l":"Total Process Safety Chem","v":"4.669","t":"+11.3%","d":"up"},{"l":"HAZOP Study Ativos","v":"3.251","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"73","t":"-2.5%","d":"down"}];
const COLS = ["ID","HAZOP Study","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Process Safety Chem #001","Process Safety Chem #002","5.050","7.315","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Process Safety Chem #002","Process Safety Chem #003","7.876","282","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Process Safety Chem #003","Process Safety Chem #004","6.230","925","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Process Safety Chem #004","Process Safety Chem #005","6.791","5.821","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Process Safety Chem #005","Process Safety Chem #001","1.553","3.043","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":707},{"label":"Mar","value":680},{"label":"Abr","value":684},{"label":"Mai","value":734},{"label":"Jun","value":817},{"label":"Jul","value":738},{"label":"Ago","value":745},{"label":"Set","value":1002},{"label":"Out","value":919},{"label":"Nov","value":998},{"label":"Dez","value":781}];
const MX = 1002;
...
export default function HazopPage() {
    return (
