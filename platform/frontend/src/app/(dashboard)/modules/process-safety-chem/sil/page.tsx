...
const PAGE = "SIL Rating";
const KPIS = [{"l":"Surveys Ativos","v":"2.345","t":"-1.5%","d":"down"},{"l":"Respostas/Semana","v":"3487","t":"-3.0%","d":"down"},{"l":"NPS Médio","v":"74","t":"+9.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"66.8%","t":"+0.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","7.915","60","90.4%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","4.633","64","72.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.202","62","84.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.264","75","79.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.721","79","85.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1005},{"label":"Fev","value":727},{"label":"Mar","value":695},{"label":"Abr","value":830},{"label":"Mai","value":806},{"label":"Jun","value":981},{"label":"Jul","value":990},{"label":"Ago","value":901},{"label":"Set","value":640},{"label":"Out","value":827},{"label":"Nov","value":829},{"label":"Dez","value":644}];
const MX = 1005;
