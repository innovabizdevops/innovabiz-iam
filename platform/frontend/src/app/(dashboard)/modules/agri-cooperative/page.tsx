...
const KPIS = [
    { label: "Total Registos", value: "5418", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1017", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€77K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1665838718", cells: ["AGR-2718", "Cooperative Management Item 1", "27/3/2026", "€38 818"], status: "active" as const },
    { id: "1665842289", cells: ["AGR-6289", "Cooperative Management Item 2", "14/10/2026", "€42 389"], status: "pending" as const },
    { id: "1665845860", cells: ["AGR-9860", "Cooperative Management Item 3", "1/5/2026", "€45 960"], status: "completed" as const },
    { id: "1665849431", cells: ["AGR-4431", "Cooperative Management Item 4", "16/12/2026", "€49 531"], status: "warning" as const },
    { id: "1665853002", cells: ["AGR-8002", "Cooperative Management Item 5", "3/7/2026", "€3102"], status: "active" as const },
];
...
export default function CooperativeManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cooperative Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cooperative Management</p>
                    </div>
                </div>
