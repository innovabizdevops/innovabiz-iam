...
const PAGE = "Govern";
const KPIS = [{"l":"Total Agri Cooperative","v":"2.311","t":"+11.8%","d":"up"},{"l":"Govern Ativos","v":"6.754","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"88.0%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+6.3%","d":"up"}];
const COLS = ["ID","Govern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Cooperative #001","Agri Cooperative #002","2.809","4.522","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Cooperative #002","Agri Cooperative #003","4.117","3.721","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Cooperative #003","Agri Cooperative #004","7.235","6.628","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Cooperative #004","Agri Cooperative #005","1.328","5.314","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Cooperative #005","Agri Cooperative #001","1.921","566","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":822},{"label":"Mar","value":763},{"label":"Abr","value":873},{"label":"Mai","value":909},{"label":"Jun","value":667},{"label":"Jul","value":758},{"label":"Ago","value":838},{"label":"Set","value":946},{"label":"Out","value":851},{"label":"Nov","value":814},{"label":"Dez","value":657}];
const MX = 1016;
