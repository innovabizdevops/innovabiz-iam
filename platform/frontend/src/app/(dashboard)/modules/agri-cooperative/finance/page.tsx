...
const PAGE = "Finance";
const KPIS = [{"l":"Total Agri Cooperative","v":"1.152","t":"+7.2%","d":"up"},{"l":"Finance Ativos","v":"546","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"79","t":"+3.1%","d":"up"}];
const COLS = ["ID","Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Cooperative #001","Agri Cooperative #002","303","1.589","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Cooperative #002","Agri Cooperative #003","7.808","2.745","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Cooperative #003","Agri Cooperative #004","312","5.118","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Cooperative #004","Agri Cooperative #005","1.373","3.882","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Cooperative #005","Agri Cooperative #001","7.658","3.013","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":504},{"label":"Mar","value":380},{"label":"Abr","value":389},{"label":"Mai","value":365},{"label":"Jun","value":452},{"label":"Jul","value":579},{"label":"Ago","value":609},{"label":"Set","value":519},{"label":"Out","value":322},{"label":"Nov","value":393},{"label":"Dez","value":251}];
const MX = 609;
