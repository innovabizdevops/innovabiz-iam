...
const PAGE = "Market";
const KPIS = [{"l":"Total Agri Cooperative","v":"7.441","t":"+11.7%","d":"up"},{"l":"Market Ativos","v":"8.346","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"79","t":"-1.9%","d":"down"}];
const COLS = ["ID","Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Cooperative #001","Agri Cooperative #002","4.030","6.145","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Cooperative #002","Agri Cooperative #003","5.169","8.141","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Cooperative #003","Agri Cooperative #004","5.501","1.392","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Cooperative #004","Agri Cooperative #005","1.129","1.778","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Cooperative #005","Agri Cooperative #001","3.969","4.548","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":890},{"label":"Mar","value":829},{"label":"Abr","value":821},{"label":"Mai","value":848},{"label":"Jun","value":923},{"label":"Jul","value":977},{"label":"Ago","value":609},{"label":"Set","value":677},{"label":"Out","value":591},{"label":"Nov","value":841},{"label":"Dez","value":915}];
const MX = 977;
