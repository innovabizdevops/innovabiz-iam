...
const PAGE = "Pool";
const KPIS = [{"l":"Total Agri Cooperative","v":"4.454","t":"-5.4%","d":"down"},{"l":"Pool Ativos","v":"3.219","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+16.5%","d":"up"}];
const COLS = ["ID","Pool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Cooperative #001","Agri Cooperative #002","3.911","8.934","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Cooperative #002","Agri Cooperative #003","2.355","6.679","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Cooperative #003","Agri Cooperative #004","538","5.686","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Cooperative #004","Agri Cooperative #005","6.745","9.098","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Cooperative #005","Agri Cooperative #001","8.703","529","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":894},{"label":"Mar","value":761},{"label":"Abr","value":606},{"label":"Mai","value":670},{"label":"Jun","value":795},{"label":"Jul","value":887},{"label":"Ago","value":640},{"label":"Set","value":573},{"label":"Out","value":867},{"label":"Nov","value":518},{"label":"Dez","value":789}];
const MX = 894;
