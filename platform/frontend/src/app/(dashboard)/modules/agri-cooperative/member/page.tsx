...
const PAGE = "Member";
const KPIS = [{"l":"Total Agri Cooperative","v":"358","t":"+3.2%","d":"up"},{"l":"Member Ativos","v":"4.159","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"71","t":"+14.0%","d":"up"}];
const COLS = ["ID","Member","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Cooperative #001","Agri Cooperative #002","5.680","8.364","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Cooperative #002","Agri Cooperative #003","2.016","2.514","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Cooperative #003","Agri Cooperative #004","5.838","5.207","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Cooperative #004","Agri Cooperative #005","7.895","6.051","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Cooperative #005","Agri Cooperative #001","2.833","6.836","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":746},{"label":"Mar","value":951},{"label":"Abr","value":896},{"label":"Mai","value":676},{"label":"Jun","value":891},{"label":"Jul","value":831},{"label":"Ago","value":670},{"label":"Set","value":790},{"label":"Out","value":799},{"label":"Nov","value":633},{"label":"Dez","value":982}];
const MX = 982;
