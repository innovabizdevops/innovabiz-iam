...
const ACCENT = "#2563eb";
const MODULE = "Field Service";
const PAGE = "AR Remote Assist";
const KPIS = [{"l":"Total Field Service","v":"2.959","t":"+12.8%","d":"up"},{"l":"AR Remote Assist Ativos","v":"8.007","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"73.6%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"74","t":"+1.1%","d":"up"}];
const COLS = ["ID","AR Remote Assist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service #001","Field Service #002","8.791","4.313","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service #002","Field Service #003","1.559","2.281","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service #003","Field Service #004","5.460","5.479","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service #004","Field Service #005","7.955","6.654","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service #005","Field Service #001","9.042","389","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":544},{"label":"Mar","value":603},{"label":"Abr","value":745},{"label":"Mai","value":880},{"label":"Jun","value":872},{"label":"Jul","value":655},{"label":"Ago","value":780},{"label":"Set","value":768},{"label":"Out","value":668},{"label":"Nov","value":860},{"label":"Dez","value":686}];
const MX = 880;
...
export default function ArAssistFieldServicePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>AR</span></h1>
                </div>
