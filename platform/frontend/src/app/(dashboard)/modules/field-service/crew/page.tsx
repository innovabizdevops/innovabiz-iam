...
const PAGE = "Crew Scheduling";
const KPIS = [{"l":"eNPS","v":"70","t":"+12.1%","d":"up"},{"l":"Engagement (%)","v":"92.9%","t":"+17.0%","d":"up"},{"l":"Turnover (%)","v":"82.1%","t":"+17.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.778","t":"-5.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.552","2026-02-10","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.420","2026-03-25","83","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.561","2026-01-11","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.754","2026-03-19","64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.691","2026-01-24","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":713},{"label":"Mar","value":691},{"label":"Abr","value":607},{"label":"Mai","value":493},{"label":"Jun","value":782},{"label":"Jul","value":661},{"label":"Ago","value":720},{"label":"Set","value":662},{"label":"Out","value":691},{"label":"Nov","value":625},{"label":"Dez","value":488}];
const MX = 782;
