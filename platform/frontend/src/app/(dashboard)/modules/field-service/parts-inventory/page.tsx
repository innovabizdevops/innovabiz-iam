...
const PAGE = "Parts Inventory";
const KPIS = [{"l":"Total Field Service","v":"6.011","t":"+7.4%","d":"up"},{"l":"Parts Inventory Ativos","v":"4.907","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"80","t":"+14.6%","d":"up"}];
const COLS = ["ID","Parts Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service #001","Field Service #002","191","6.764","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service #002","Field Service #003","4.042","2.385","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service #003","Field Service #004","6.549","2.690","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service #004","Field Service #005","1.349","2.342","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service #005","Field Service #001","7.392","4.308","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":915},{"label":"Mar","value":624},{"label":"Abr","value":801},{"label":"Mai","value":695},{"label":"Jun","value":920},{"label":"Jul","value":736},{"label":"Ago","value":774},{"label":"Set","value":988},{"label":"Out","value":840},{"label":"Nov","value":836},{"label":"Dez","value":843}];
const MX = 988;
