...
const PAGE = "Predictive Maintenance";
const KPIS = [{"l":"Integrações Ativas","v":"8.177","t":"+4.3%","d":"up"},{"l":"Chamadas/Hora","v":"2651","t":"-3.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"93.2%","t":"+3.3%","d":"up"},{"l":"Latência Média (ms)","v":"197ms","t":"+16.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.378","8.298","94.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.493","3.132","99.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.658","6.744","84.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.311","664","84.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.434","6.844","95.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":666},{"label":"Mar","value":699},{"label":"Abr","value":677},{"label":"Mai","value":511},{"label":"Jun","value":604},{"label":"Jul","value":452},{"label":"Ago","value":485},{"label":"Set","value":523},{"label":"Out","value":428},{"label":"Nov","value":677},{"label":"Dez","value":694}];
const MX = 699;
