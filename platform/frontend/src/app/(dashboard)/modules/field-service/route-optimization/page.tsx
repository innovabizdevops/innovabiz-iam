...
const PAGE = "Route Optimization AI";
const KPIS = [{"l":"Total Field Service","v":"733","t":"+9.4%","d":"up"},{"l":"Route Optimization AI Ativos","v":"2.520","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"73","t":"-5.6%","d":"down"}];
const COLS = ["ID","Route Optimization AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service #001","Field Service #002","4.315","8.797","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service #002","Field Service #003","7.575","7.243","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service #003","Field Service #004","2.837","7.771","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service #004","Field Service #005","3.683","8.688","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service #005","Field Service #001","2.315","7.356","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":551},{"label":"Mar","value":420},{"label":"Abr","value":633},{"label":"Mai","value":600},{"label":"Jun","value":395},{"label":"Jul","value":519},{"label":"Ago","value":315},{"label":"Set","value":424},{"label":"Out","value":456},{"label":"Nov","value":488},{"label":"Dez","value":351}];
const MX = 633;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>AI</span></h1>
                </div>
