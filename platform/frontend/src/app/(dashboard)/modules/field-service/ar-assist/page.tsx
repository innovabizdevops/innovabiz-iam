...
const PAGE = "AR Assist";
const KPIS = [{"l":"Total Field Service","v":"738","t":"+7.3%","d":"up"},{"l":"AR Assist Ativos","v":"2.631","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"80","t":"-2.3%","d":"down"}];
const COLS = ["ID","AR Assist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service #001","Field Service #002","8.104","2.672","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service #002","Field Service #003","5.064","683","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service #003","Field Service #004","2.640","126","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service #004","Field Service #005","1.802","8.128","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service #005","Field Service #001","5.582","280","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":629},{"label":"Mar","value":613},{"label":"Abr","value":773},{"label":"Mai","value":859},{"label":"Jun","value":906},{"label":"Jul","value":565},{"label":"Ago","value":634},{"label":"Set","value":663},{"label":"Out","value":611},{"label":"Nov","value":773},{"label":"Dez","value":679}];
const MX = 906;
...
export default function ArAssistPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>XR</span></h1>
                </div>
