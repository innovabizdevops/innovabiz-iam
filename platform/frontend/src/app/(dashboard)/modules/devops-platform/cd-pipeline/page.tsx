...
const ROWS = [
  { id: "001", c: ["Cd Pipeline-001", "Cd Pipeline Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Cd Pipeline-002", "Cd Pipeline Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Cd Pipeline-003", "Cd Pipeline Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Cd Pipeline-004", "Cd Pipeline Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Cd Pipeline-005", "Cd Pipeline Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Cd Pipeline", ts: "Há 2min", a: "Sistema" },
...
export default function CdPipelinePage() {
  return (
