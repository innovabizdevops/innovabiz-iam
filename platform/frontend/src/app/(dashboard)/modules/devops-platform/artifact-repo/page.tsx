...
const ROWS = [
  { id: "001", c: ["Artifact Repo-001", "Artifact Repo Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Artifact Repo-002", "Artifact Repo Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Artifact Repo-003", "Artifact Repo Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Artifact Repo-004", "Artifact Repo Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Artifact Repo-005", "Artifact Repo Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Artifact Repo", ts: "Há 2min", a: "Sistema" },
...
export default function ArtifactRepoPage() {
  return (
