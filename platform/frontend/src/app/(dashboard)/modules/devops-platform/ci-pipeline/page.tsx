...
const ROWS = [
  { id: "001", c: ["Ci Pipeline-001", "Ci Pipeline Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Ci Pipeline-002", "Ci Pipeline Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Ci Pipeline-003", "Ci Pipeline Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Ci Pipeline-004", "Ci Pipeline Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Ci Pipeline-005", "Ci Pipeline Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Ci Pipeline", ts: "Há 2min", a: "Sistema" },
