...
const PAGE = "Service Catalog Devops";
...
const ROWS = [
  { id: "001", c: ["Service Catalog Devops-001", "Service Catalog Devops Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Service Catalog Devops-002", "Service Catalog Devops Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Service Catalog Devops-003", "Service Catalog Devops Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Service Catalog Devops-004", "Service Catalog Devops Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Service Catalog Devops-005", "Service Catalog Devops Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Service Catalog Devops", ts: "Há 2min", a: "Sistema" },
...
export default function ServiceCatalogDevopsPage() {
  return (
