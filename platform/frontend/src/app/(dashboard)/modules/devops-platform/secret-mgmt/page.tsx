...
const ROWS = [
  { id: "001", c: ["Secret Mgmt-001", "Secret Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Secret Mgmt-002", "Secret Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Secret Mgmt-003", "Secret Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Secret Mgmt-004", "Secret Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Secret Mgmt-005", "Secret Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Secret Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function SecretMgmtPage() {
  return (
