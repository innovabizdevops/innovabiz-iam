...
const ROWS = [
  { id: "001", c: ["Feature Toggle-001", "Feature Toggle Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Feature Toggle-002", "Feature Toggle Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Feature Toggle-003", "Feature Toggle Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Feature Toggle-004", "Feature Toggle Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Feature Toggle-005", "Feature Toggle Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Feature Toggle", ts: "Há 2min", a: "Sistema" },
