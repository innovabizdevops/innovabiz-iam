...
const ROWS = [
  { id: "001", c: ["Config Mgmt Devops-001", "Config Mgmt Devops Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Config Mgmt Devops-002", "Config Mgmt Devops Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Config Mgmt Devops-003", "Config Mgmt Devops Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Config Mgmt Devops-004", "Config Mgmt Devops Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Config Mgmt Devops-005", "Config Mgmt Devops Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Config Mgmt Devops", ts: "Há 2min", a: "Sistema" },
...
export default function ConfigMgmtDevopsPage() {
  return (
