...
const ROWS = [
  { id: "001", c: ["Self Service Infra-001", "Self Service Infra Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Self Service Infra-002", "Self Service Infra Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Self Service Infra-003", "Self Service Infra Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Self Service Infra-004", "Self Service Infra Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Self Service Infra-005", "Self Service Infra Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Self Service Infra", ts: "Há 2min", a: "Sistema" },
...
export default function SelfServiceInfraPage() {
  return (
