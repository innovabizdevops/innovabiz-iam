...
const KPIS = [{"l":"Notificações Enviadas","v":"638","t":"+2.8%","d":"up"},{"l":"Taxa Entrega (%)","v":"90.8%","t":"+17.1%","d":"up"},{"l":"Taxa Abertura (%)","v":"92.9%","t":"-4.1%","d":"down"},{"l":"Escalações","v":"7.565","t":"+17.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.416","70.4%","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.862","99.0%","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.090","87.5%","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","9.038","95.1%","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.201","79.8%","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":574},{"label":"Mar","value":459},{"label":"Abr","value":592},{"label":"Mai","value":403},{"label":"Jun","value":550},{"label":"Jul","value":297},{"label":"Ago","value":409},{"label":"Set","value":537},{"label":"Out","value":313},{"label":"Nov","value":616},{"label":"Dez","value":433}];
const MX = 616;
