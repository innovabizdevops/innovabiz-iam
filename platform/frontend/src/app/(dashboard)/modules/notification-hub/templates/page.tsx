...
const ACCENT = "#dc2626";
const MODULE = "Notification Hub";
const PAGE = "Templates";
const KPIS = [{"l":"Formulários Ativos","v":"138","t":"-0.8%","d":"down"},{"l":"Submissões/Dia","v":"2206","t":"-1.9%","d":"down"},{"l":"Documentos Gerados","v":"2.476","t":"+0.5%","d":"up"},{"l":"Templates","v":"3.919","t":"+13.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.434","2026-03-04","8.002","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.038","2026-01-10","1.271","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.946","2026-02-19","6.369","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","591","2026-03-16","6.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.623","2026-02-21","7.807","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":832},{"label":"Mar","value":915},{"label":"Abr","value":694},{"label":"Mai","value":936},{"label":"Jun","value":889},{"label":"Jul","value":675},{"label":"Ago","value":655},{"label":"Set","value":857},{"label":"Out","value":787},{"label":"Nov","value":787},{"label":"Dez","value":760}];
const MX = 936;
