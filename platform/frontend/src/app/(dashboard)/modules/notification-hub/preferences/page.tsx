...
const KPIS = [{"l":"Notificações Enviadas","v":"1.810","t":"+10.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"67.1%","t":"+10.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"70.9%","t":"+5.2%","d":"up"},{"l":"Escalações","v":"181","t":"+6.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.034","80.5%","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.489","95.2%","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.544","79.6%","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.789","84.6%","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.580","91.8%","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":549},{"label":"Mar","value":325},{"label":"Abr","value":354},{"label":"Mai","value":257},{"label":"Jun","value":453},{"label":"Jul","value":239},{"label":"Ago","value":291},{"label":"Set","value":570},{"label":"Out","value":497},{"label":"Nov","value":512},{"label":"Dez","value":292}];
const MX = 570;
