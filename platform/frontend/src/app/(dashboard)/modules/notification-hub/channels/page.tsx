...
const PAGE = "Channels";
const KPIS = [{"l":"Notificações Enviadas","v":"5.669","t":"-4.0%","d":"down"},{"l":"Taxa Entrega (%)","v":"93.9%","t":"-5.6%","d":"down"},{"l":"Taxa Abertura (%)","v":"79.4%","t":"-3.5%","d":"down"},{"l":"Escalações","v":"128","t":"+14.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.501","79.7%","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.523","92.8%","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.632","72.9%","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.104","76.3%","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.013","78.9%","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":675},{"label":"Mar","value":510},{"label":"Abr","value":704},{"label":"Mai","value":759},{"label":"Jun","value":606},{"label":"Jul","value":481},{"label":"Ago","value":481},{"label":"Set","value":779},{"label":"Out","value":475},{"label":"Nov","value":691},{"label":"Dez","value":634}];
const MX = 779;
