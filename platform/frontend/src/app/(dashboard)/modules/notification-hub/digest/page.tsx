...
const PAGE = "Digest Rules";
const KPIS = [{"l":"Notificações Enviadas","v":"5.785","t":"+18.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"78.5%","t":"+14.1%","d":"up"},{"l":"Taxa Abertura (%)","v":"73.9%","t":"-5.9%","d":"down"},{"l":"Escalações","v":"148","t":"+14.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.564","70.1%","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.804","97.7%","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.926","92.8%","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.562","82.9%","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","9.088","72.4%","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":624},{"label":"Mar","value":727},{"label":"Abr","value":812},{"label":"Mai","value":785},{"label":"Jun","value":874},{"label":"Jul","value":772},{"label":"Ago","value":941},{"label":"Set","value":796},{"label":"Out","value":665},{"label":"Nov","value":625},{"label":"Dez","value":952}];
const MX = 952;
