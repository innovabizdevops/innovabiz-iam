...
const PAGE = "Assess";
const KPIS = [{"l":"Projetos Melhoria","v":"6.719","t":"+3.1%","d":"up"},{"l":"Savings (€)","v":"€94223","t":"+8.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.4%","t":"+1.1%","d":"up"},{"l":"Ciclos PDCA","v":"652","t":"+9.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.656","€ 38636.71","4.704","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.981","€ 43588.30","2.553","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.529","€ 19948.56","5.789","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.902","€ 17084.35","3.712","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.222","€ 30427.59","704","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":1024},{"label":"Mar","value":890},{"label":"Abr","value":733},{"label":"Mai","value":804},{"label":"Jun","value":856},{"label":"Jul","value":1028},{"label":"Ago","value":873},{"label":"Set","value":1041},{"label":"Out","value":691},{"label":"Nov","value":869},{"label":"Dez","value":811}];
const MX = 1041;
