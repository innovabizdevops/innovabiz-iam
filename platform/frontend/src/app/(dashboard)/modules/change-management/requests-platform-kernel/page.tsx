...
const ACCENT = "#7e22ce";
const MODULE = "Change Management (APQC 13)";
const PAGE = "Change Requests";
const KPIS = [{"l":"Formulários Ativos","v":"4.416","t":"+6.9%","d":"up"},{"l":"Submissões/Dia","v":"2405","t":"+7.4%","d":"up"},{"l":"Documentos Gerados","v":"4.914","t":"+12.5%","d":"up"},{"l":"Templates","v":"1.983","t":"-1.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.675","2026-02-19","3.511","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.128","2026-01-01","5.884","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.252","2026-03-21","3.146","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.469","2026-02-20","4.782","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.638","2026-03-09","2.748","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":712},{"label":"Mar","value":775},{"label":"Abr","value":772},{"label":"Mai","value":750},{"label":"Jun","value":731},{"label":"Jul","value":940},{"label":"Ago","value":755},{"label":"Set","value":646},{"label":"Out","value":707},{"label":"Nov","value":971},{"label":"Dez","value":649}];
const MX = 971;
...
export default function RequestsPlatformKernelPage() {
    return (
