...
const KPIS = [{"l":"Projetos Melhoria","v":"8.420","t":"-1.9%","d":"down"},{"l":"Savings (€)","v":"€3069","t":"+0.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.2%","t":"+13.9%","d":"up"},{"l":"Ciclos PDCA","v":"8.997","t":"+16.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.097","€ 13319.32","8.313","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.784","€ 43865.37","8.205","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.380","€ 16804.49","1.995","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.327","€ 23757.24","6.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.732","€ 28294.56","907","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":554},{"label":"Mar","value":454},{"label":"Abr","value":583},{"label":"Mai","value":467},{"label":"Jun","value":621},{"label":"Jul","value":490},{"label":"Ago","value":654},{"label":"Set","value":719},{"label":"Out","value":714},{"label":"Nov","value":431},{"label":"Dez","value":429}];
const MX = 719;
