...
const PAGE = "Sustain";
const KPIS = [{"l":"Projetos Melhoria","v":"5.941","t":"-1.0%","d":"down"},{"l":"Savings (€)","v":"€63982","t":"-2.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"65.7%","t":"+14.8%","d":"up"},{"l":"Ciclos PDCA","v":"5.416","t":"+17.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.849","€ 27116.14","8.729","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.803","€ 38754.16","5.657","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.110","€ 27089.40","3.220","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.764","€ 11571.52","7.388","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.584","€ 22145.82","2.490","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":759},{"label":"Mar","value":508},{"label":"Abr","value":576},{"label":"Mai","value":729},{"label":"Jun","value":768},{"label":"Jul","value":723},{"label":"Ago","value":861},{"label":"Set","value":811},{"label":"Out","value":680},{"label":"Nov","value":686},{"label":"Dez","value":669}];
const MX = 861;
