...
const KPIS = [{"l":"Projetos Melhoria","v":"5.262","t":"+13.5%","d":"up"},{"l":"Savings (€)","v":"€75880","t":"+10.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.2%","t":"-0.8%","d":"down"},{"l":"Ciclos PDCA","v":"8.351","t":"+3.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.211","€ 10306.87","8.635","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.816","€ 32094.00","6.489","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.478","€ 14411.94","2.722","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","261","€ 39774.49","3.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.457","€ 23305.79","4.916","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":864},{"label":"Mar","value":872},{"label":"Abr","value":654},{"label":"Mai","value":923},{"label":"Jun","value":933},{"label":"Jul","value":859},{"label":"Ago","value":648},{"label":"Set","value":591},{"label":"Out","value":899},{"label":"Nov","value":886},{"label":"Dez","value":964}];
const MX = 964;
