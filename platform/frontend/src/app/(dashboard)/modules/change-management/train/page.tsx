...
const PAGE = "Train";
const KPIS = [{"l":"Projetos Melhoria","v":"4.324","t":"+5.3%","d":"up"},{"l":"Savings (€)","v":"€59777","t":"-4.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"93.8%","t":"+16.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.596","t":"+13.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.800","€ 6867.64","639","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.006","€ 36480.50","1.767","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.095","€ 16172.47","8.702","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.339","€ 18300.49","1.895","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.449","€ 1315.48","7.670","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":799},{"label":"Mar","value":676},{"label":"Abr","value":976},{"label":"Mai","value":826},{"label":"Jun","value":833},{"label":"Jul","value":994},{"label":"Ago","value":772},{"label":"Set","value":702},{"label":"Out","value":675},{"label":"Nov","value":736},{"label":"Dez","value":989}];
const MX = 994;
