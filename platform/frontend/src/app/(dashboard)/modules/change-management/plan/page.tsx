...
const PAGE = "Plan";
const KPIS = [{"l":"Projetos Melhoria","v":"5.002","t":"-4.1%","d":"down"},{"l":"Savings (€)","v":"€8772","t":"+10.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.6%","t":"+6.5%","d":"up"},{"l":"Ciclos PDCA","v":"2.800","t":"+6.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.134","€ 43255.58","4.534","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.866","€ 42040.00","5.269","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.964","€ 4579.04","6.834","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.993","€ 10065.18","2.804","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.910","€ 41653.22","3.735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":221},{"label":"Fev","value":582},{"label":"Mar","value":330},{"label":"Abr","value":250},{"label":"Mai","value":226},{"label":"Jun","value":295},{"label":"Jul","value":309},{"label":"Ago","value":307},{"label":"Set","value":484},{"label":"Out","value":339},{"label":"Nov","value":258},{"label":"Dez","value":587}];
const MX = 587;
