...
const PAGE = "Schema";
const KPIS = [{"l":"Formulários Ativos","v":"7.375","t":"+11.9%","d":"up"},{"l":"Submissões/Dia","v":"1898","t":"-0.4%","d":"down"},{"l":"Documentos Gerados","v":"234","t":"+12.6%","d":"up"},{"l":"Templates","v":"7.864","t":"+15.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.743","2026-02-09","3.671","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.619","2026-02-28","5.300","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.212","2026-01-16","5.270","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","285","2026-02-26","7.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.332","2026-03-24","1.735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":815},{"label":"Mar","value":719},{"label":"Abr","value":726},{"label":"Mai","value":671},{"label":"Jun","value":732},{"label":"Jul","value":895},{"label":"Ago","value":825},{"label":"Set","value":878},{"label":"Out","value":890},{"label":"Nov","value":929},{"label":"Dez","value":668}];
const MX = 929;
