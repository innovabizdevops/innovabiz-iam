...
const ACCENT = "#0d9488";
const MODULE = "GraphQL Platform";
const PAGE = "Resolver";
const KPIS = [{"l":"Formulários Ativos","v":"1.613","t":"+10.9%","d":"up"},{"l":"Submissões/Dia","v":"1434","t":"+16.2%","d":"up"},{"l":"Documentos Gerados","v":"816","t":"-5.3%","d":"down"},{"l":"Templates","v":"3.467","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.040","2026-01-25","6.530","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.044","2026-02-27","7.997","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.509","2026-02-20","7.193","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.115","2026-01-07","6.325","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.492","2026-03-23","4.957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":348},{"label":"Mar","value":587},{"label":"Abr","value":402},{"label":"Mai","value":344},{"label":"Jun","value":412},{"label":"Jul","value":565},{"label":"Ago","value":338},{"label":"Set","value":547},{"label":"Out","value":467},{"label":"Nov","value":576},{"label":"Dez","value":541}];
const MX = 587;
