...
/* ═══ GraphQL Platform — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "5394", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3122", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€385K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1074551294", cells: ["GRA-6294", "GraphQL Platform Item 1", "27/3/2026", "€1394"], status: "active" as const },
    { id: "1074554865", cells: ["GRA-9865", "GraphQL Platform Item 2", "14/10/2026", "€4965"], status: "pending" as const },
    { id: "1074558436", cells: ["GRA-4436", "GraphQL Platform Item 3", "1/5/2026", "€8536"], status: "completed" as const },
    { id: "1074562007", cells: ["GRA-8007", "GraphQL Platform Item 4", "16/12/2026", "€12 107"], status: "warning" as const },
    { id: "1074565578", cells: ["GRA-2578", "GraphQL Platform Item 5", "3/7/2026", "€15 678"], status: "active" as const },
];
...
export default function GraphqlPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GraphQL Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GraphQL Platform</p>
                    </div>
                </div>
