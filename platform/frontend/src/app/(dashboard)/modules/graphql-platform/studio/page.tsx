...
const PAGE = "Studio";
const KPIS = [{"l":"Formulários Ativos","v":"3.994","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"4771","t":"+10.6%","d":"up"},{"l":"Documentos Gerados","v":"4.150","t":"+10.1%","d":"up"},{"l":"Templates","v":"4.705","t":"+4.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.403","2026-03-25","3.646","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","345","2026-03-03","5.778","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","855","2026-02-11","1.906","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.247","2026-01-01","2.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.925","2026-02-04","2.021","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":818},{"label":"Mar","value":633},{"label":"Abr","value":622},{"label":"Mai","value":609},{"label":"Jun","value":577},{"label":"Jul","value":761},{"label":"Ago","value":867},{"label":"Set","value":671},{"label":"Out","value":583},{"label":"Nov","value":524},{"label":"Dez","value":704}];
const MX = 867;
