...
const KPIS = [{"l":"Formulários Ativos","v":"2.162","t":"+14.6%","d":"up"},{"l":"Submissões/Dia","v":"1038","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"7.215","t":"+12.0%","d":"up"},{"l":"Templates","v":"3.724","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","597","2026-02-01","1.792","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.809","2026-03-21","3.225","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","680","2026-02-23","474","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.059","2026-02-10","6.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.470","2026-02-07","8.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":287},{"label":"Fev","value":559},{"label":"Mar","value":321},{"label":"Abr","value":278},{"label":"Mai","value":574},{"label":"Jun","value":561},{"label":"Jul","value":282},{"label":"Ago","value":572},{"label":"Set","value":458},{"label":"Out","value":559},{"label":"Nov","value":405},{"label":"Dez","value":575}];
const MX = 575;
