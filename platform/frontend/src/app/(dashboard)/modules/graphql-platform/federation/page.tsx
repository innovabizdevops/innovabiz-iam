...
const KPIS = [{"l":"Formulários Ativos","v":"3.618","t":"+14.0%","d":"up"},{"l":"Submissões/Dia","v":"4304","t":"-4.6%","d":"down"},{"l":"Documentos Gerados","v":"1.630","t":"+9.0%","d":"up"},{"l":"Templates","v":"7.479","t":"+4.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.221","2026-02-14","1.667","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.985","2026-02-19","8.983","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.647","2026-01-24","6.814","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.100","2026-03-21","8.446","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.584","2026-02-03","8.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":826},{"label":"Mar","value":929},{"label":"Abr","value":966},{"label":"Mai","value":767},{"label":"Jun","value":689},{"label":"Jul","value":656},{"label":"Ago","value":856},{"label":"Set","value":606},{"label":"Out","value":966},{"label":"Nov","value":891},{"label":"Dez","value":845}];
const MX = 966;
