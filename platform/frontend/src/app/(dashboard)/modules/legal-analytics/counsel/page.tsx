...
const KPIS = [{"l":"Dashboards Ativos","v":"8.821","t":"-4.4%","d":"down"},{"l":"Queries/Dia","v":"1684","t":"+15.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.698","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"8.784","t":"+3.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3893","2026-01-09","5.046","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3799","2026-01-05","918","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","555","2026-03-11","2.951","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2393","2026-03-18","8.944","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2478","2026-01-16","6.816","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":271},{"label":"Fev","value":465},{"label":"Mar","value":287},{"label":"Abr","value":632},{"label":"Mai","value":474},{"label":"Jun","value":384},{"label":"Jul","value":352},{"label":"Ago","value":263},{"label":"Set","value":580},{"label":"Out","value":330},{"label":"Nov","value":442},{"label":"Dez","value":536}];
const MX = 632;
