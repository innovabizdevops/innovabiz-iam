...
const KPIS = [{"l":"Dashboards Ativos","v":"7.229","t":"+12.4%","d":"up"},{"l":"Queries/Dia","v":"2579","t":"-1.3%","d":"down"},{"l":"Dados Processados (GB)","v":"8.605","t":"+10.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.391","t":"+2.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2953","2026-02-22","4.010","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","283","2026-02-27","7.776","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","455","2026-03-25","2.131","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","423","2026-03-21","4.257","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4015","2026-01-19","2.801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":783},{"label":"Mar","value":896},{"label":"Abr","value":796},{"label":"Mai","value":587},{"label":"Jun","value":703},{"label":"Jul","value":803},{"label":"Ago","value":704},{"label":"Set","value":794},{"label":"Out","value":549},{"label":"Nov","value":602},{"label":"Dez","value":644}];
const MX = 896;
