...
const PAGE = "Spend";
const KPIS = [{"l":"Dashboards Ativos","v":"2.138","t":"+1.6%","d":"up"},{"l":"Queries/Dia","v":"3379","t":"-0.3%","d":"down"},{"l":"Dados Processados (GB)","v":"374","t":"+5.9%","d":"up"},{"l":"Utilizadores Analytics","v":"6.318","t":"+3.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2810","2026-02-20","7.280","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4808","2026-02-28","3.040","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1247","2026-02-08","6.960","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1066","2026-01-24","8.181","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","179","2026-02-16","9.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":670},{"label":"Mar","value":634},{"label":"Abr","value":410},{"label":"Mai","value":729},{"label":"Jun","value":585},{"label":"Jul","value":710},{"label":"Ago","value":574},{"label":"Set","value":713},{"label":"Out","value":583},{"label":"Nov","value":392},{"label":"Dez","value":549}];
const MX = 729;
