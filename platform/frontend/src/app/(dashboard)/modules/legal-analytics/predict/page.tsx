...
const ACCENT = "#6366f1";
const MODULE = "Legal Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"1.885","t":"-1.1%","d":"down"},{"l":"Queries/Dia","v":"631","t":"+7.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.523","t":"+11.9%","d":"up"},{"l":"Utilizadores Analytics","v":"2.936","t":"+16.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1979","2026-03-16","7.185","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2905","2026-01-28","4.529","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3109","2026-01-01","7.192","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4560","2026-03-07","8.956","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3141","2026-01-21","2.761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":664},{"label":"Mar","value":591},{"label":"Abr","value":697},{"label":"Mai","value":366},{"label":"Jun","value":617},{"label":"Jul","value":665},{"label":"Ago","value":569},{"label":"Set","value":591},{"label":"Out","value":531},{"label":"Nov","value":508},{"label":"Dez","value":667}];
const MX = 697;
