...
const PAGE = "Matter";
const KPIS = [{"l":"Dashboards Ativos","v":"1.455","t":"+2.1%","d":"up"},{"l":"Queries/Dia","v":"256","t":"+9.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.531","t":"+15.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.097","t":"-4.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1211","2026-03-28","3.720","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4762","2026-01-04","397","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4538","2026-02-19","7.613","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","823","2026-02-27","1.416","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2619","2026-03-06","408","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":630},{"label":"Mar","value":901},{"label":"Abr","value":669},{"label":"Mai","value":790},{"label":"Jun","value":687},{"label":"Jul","value":789},{"label":"Ago","value":744},{"label":"Set","value":765},{"label":"Out","value":988},{"label":"Nov","value":819},{"label":"Dez","value":628}];
const MX = 988;
