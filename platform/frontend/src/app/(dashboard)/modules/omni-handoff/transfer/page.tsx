...
const ACCENT = "#2563eb";
const MODULE = "OMNI Seamless Handoff";
const PAGE = "Transfer";
const KPIS = [{"l":"Total Omni Handoff","v":"2.096","t":"+16.8%","d":"up"},{"l":"Transfer Ativos","v":"5.241","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"71","t":"+3.6%","d":"up"}];
const COLS = ["ID","Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Omni Handoff #001","Omni Handoff #002","6.057","2.022","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Omni Handoff #002","Omni Handoff #003","3.897","7.637","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Omni Handoff #003","Omni Handoff #004","2.832","2.585","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Omni Handoff #004","Omni Handoff #005","2.027","3.590","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Omni Handoff #005","Omni Handoff #001","2.136","3.498","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":952},{"label":"Mar","value":626},{"label":"Abr","value":649},{"label":"Mai","value":676},{"label":"Jun","value":776},{"label":"Jul","value":750},{"label":"Ago","value":841},{"label":"Set","value":771},{"label":"Out","value":842},{"label":"Nov","value":585},{"label":"Dez","value":673}];
const MX = 952;
