...
/* ═══ OMNI Seamless Handoff — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "8195", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1187", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€308K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "771485395", cells: ["OMN-6395", "OMNI Seamless Handoff Item 1", "24/8/2026", "€35 495"], status: "active" as const },
    { id: "771488966", cells: ["OMN-9966", "OMNI Seamless Handoff Item 2", "11/3/2026", "€39 066"], status: "pending" as const },
    { id: "771492537", cells: ["OMN-4537", "OMNI Seamless Handoff Item 3", "26/10/2026", "€42 637"], status: "completed" as const },
    { id: "771496108", cells: ["OMN-8108", "OMNI Seamless Handoff Item 4", "13/5/2026", "€46 208"], status: "warning" as const },
    { id: "771499679", cells: ["OMN-2679", "OMNI Seamless Handoff Item 5", "28/12/2026", "€49 779"], status: "active" as const },
];
...
export default function OmniSeamlessHandoffPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">OMNI Seamless Handoff</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • OMNI Seamless Handoff</p>
                    </div>
                </div>
