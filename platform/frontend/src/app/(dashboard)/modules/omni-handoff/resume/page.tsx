...
const PAGE = "Resume";
const KPIS = [{"l":"Total Omni Handoff","v":"8.871","t":"+5.9%","d":"up"},{"l":"Resume Ativos","v":"4.314","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"71","t":"+7.8%","d":"up"}];
const COLS = ["ID","Resume","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Omni Handoff #001","Omni Handoff #002","1.990","4.303","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Omni Handoff #002","Omni Handoff #003","312","5.671","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Omni Handoff #003","Omni Handoff #004","3.782","8.685","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Omni Handoff #004","Omni Handoff #005","2.423","1.877","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Omni Handoff #005","Omni Handoff #001","246","7.887","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":527},{"label":"Mar","value":318},{"label":"Abr","value":360},{"label":"Mai","value":381},{"label":"Jun","value":460},{"label":"Jul","value":528},{"label":"Ago","value":423},{"label":"Set","value":311},{"label":"Out","value":342},{"label":"Nov","value":617},{"label":"Dez","value":701}];
const MX = 701;
