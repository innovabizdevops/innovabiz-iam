...
const ACCENT = "#854d0e";
const MODULE = "Hydrogen Economy Platform";
const PAGE = "Use";
const KPIS = [{"l":"Formulários Ativos","v":"6.990","t":"-5.6%","d":"down"},{"l":"Submissões/Dia","v":"4232","t":"-2.5%","d":"down"},{"l":"Documentos Gerados","v":"8.152","t":"+17.3%","d":"up"},{"l":"Templates","v":"376","t":"+12.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.045","2026-01-17","5.737","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.895","2026-03-01","7.536","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.041","2026-02-08","8.952","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.972","2026-03-03","3.992","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.968","2026-01-26","3.522","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":714},{"label":"Mar","value":987},{"label":"Abr","value":697},{"label":"Mai","value":712},{"label":"Jun","value":923},{"label":"Jul","value":977},{"label":"Ago","value":761},{"label":"Set","value":804},{"label":"Out","value":982},{"label":"Nov","value":983},{"label":"Dez","value":667}];
const MX = 987;
