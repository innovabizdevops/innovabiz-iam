...
/* ═══ Hydrogen Economy Platform — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "9489", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1952", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€408K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1827004889", cells: ["HYD-5889", "Hydrogen Economy Platform Item 1", "18/6/2026", "€4989"], status: "active" as const },
    { id: "1827008460", cells: ["HYD-9460", "Hydrogen Economy Platform Item 2", "5/1/2026", "€8560"], status: "pending" as const },
    { id: "1827012031", cells: ["HYD-4031", "Hydrogen Economy Platform Item 3", "20/8/2026", "€12 131"], status: "completed" as const },
    { id: "1827015602", cells: ["HYD-7602", "Hydrogen Economy Platform Item 4", "7/3/2026", "€15 702"], status: "warning" as const },
    { id: "1827019173", cells: ["HYD-2173", "Hydrogen Economy Platform Item 5", "22/10/2026", "€19 273"], status: "active" as const },
];
...
export default function HydrogenEconomyPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hydrogen Economy Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hydrogen Economy Platform</p>
                    </div>
                </div>
