...
const PAGE = "Trade";
const KPIS = [{"l":"Formulários Ativos","v":"5.172","t":"+1.9%","d":"up"},{"l":"Submissões/Dia","v":"883","t":"+17.7%","d":"up"},{"l":"Documentos Gerados","v":"1.105","t":"+2.6%","d":"up"},{"l":"Templates","v":"7.805","t":"+13.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.027","2026-02-17","7.714","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.665","2026-01-07","5.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","995","2026-03-02","7.424","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.396","2026-02-03","2.350","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.643","2026-02-09","2.864","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":383},{"label":"Mar","value":680},{"label":"Abr","value":492},{"label":"Mai","value":408},{"label":"Jun","value":675},{"label":"Jul","value":421},{"label":"Ago","value":676},{"label":"Set","value":680},{"label":"Out","value":550},{"label":"Nov","value":364},{"label":"Dez","value":408}];
const MX = 680;
