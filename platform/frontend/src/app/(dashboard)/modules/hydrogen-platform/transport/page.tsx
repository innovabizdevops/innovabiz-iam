...
const KPIS = [{"l":"Formulários Ativos","v":"4.119","t":"+5.2%","d":"up"},{"l":"Submissões/Dia","v":"4080","t":"+5.2%","d":"up"},{"l":"Documentos Gerados","v":"3.333","t":"+4.4%","d":"up"},{"l":"Templates","v":"4.337","t":"-4.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.513","2026-03-08","1.325","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.870","2026-03-19","2.778","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.048","2026-03-05","1.258","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.459","2026-03-23","2.269","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.537","2026-03-09","285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":738},{"label":"Mar","value":731},{"label":"Abr","value":625},{"label":"Mai","value":469},{"label":"Jun","value":723},{"label":"Jul","value":705},{"label":"Ago","value":468},{"label":"Set","value":434},{"label":"Out","value":545},{"label":"Nov","value":457},{"label":"Dez","value":797}];
const MX = 797;
