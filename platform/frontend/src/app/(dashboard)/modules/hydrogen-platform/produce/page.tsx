...
const PAGE = "Produce";
const KPIS = [{"l":"Formulários Ativos","v":"3.635","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"3553","t":"+0.2%","d":"up"},{"l":"Documentos Gerados","v":"2.386","t":"+11.7%","d":"up"},{"l":"Templates","v":"1.346","t":"+14.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.236","2026-03-25","3.335","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.922","2026-03-21","1.856","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.937","2026-03-07","5.811","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.435","2026-02-23","5.928","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.795","2026-02-15","3.812","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":743},{"label":"Mar","value":620},{"label":"Abr","value":663},{"label":"Mai","value":602},{"label":"Jun","value":969},{"label":"Jul","value":944},{"label":"Ago","value":620},{"label":"Set","value":603},{"label":"Out","value":941},{"label":"Nov","value":826},{"label":"Dez","value":634}];
const MX = 969;
