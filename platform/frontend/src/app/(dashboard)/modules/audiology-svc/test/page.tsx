...
const PAGE = "Test";
const KPIS = [{"l":"Total Audiology Svc","v":"8.770","t":"+5.7%","d":"up"},{"l":"Test Ativos","v":"7.396","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+15.1%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiology Svc #001","Audiology Svc #002","5.649","436","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Audiology Svc #002","Audiology Svc #003","3.019","4.992","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiology Svc #003","Audiology Svc #004","2.874","4.172","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Audiology Svc #004","Audiology Svc #005","1.462","6.560","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiology Svc #005","Audiology Svc #001","5.564","2.886","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":684},{"label":"Mar","value":626},{"label":"Abr","value":772},{"label":"Mai","value":684},{"label":"Jun","value":683},{"label":"Jul","value":779},{"label":"Ago","value":625},{"label":"Set","value":568},{"label":"Out","value":623},{"label":"Nov","value":785},{"label":"Dez","value":504}];
const MX = 785;
