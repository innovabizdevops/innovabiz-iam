...
const PAGE = "Patient";
const KPIS = [{"l":"Total Audiology Svc","v":"3.641","t":"+11.8%","d":"up"},{"l":"Patient Ativos","v":"7.063","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+12.3%","d":"up"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiology Svc #001","Audiology Svc #002","6.217","199","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Audiology Svc #002","Audiology Svc #003","1.931","3.190","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiology Svc #003","Audiology Svc #004","3.259","939","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Audiology Svc #004","Audiology Svc #005","581","408","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiology Svc #005","Audiology Svc #001","5.936","3.143","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":720},{"label":"Mar","value":660},{"label":"Abr","value":571},{"label":"Mai","value":449},{"label":"Jun","value":719},{"label":"Jul","value":598},{"label":"Ago","value":631},{"label":"Set","value":593},{"label":"Out","value":684},{"label":"Nov","value":445},{"label":"Dez","value":564}];
const MX = 720;
