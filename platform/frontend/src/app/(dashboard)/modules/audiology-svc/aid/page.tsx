...
const ACCENT = "#2563eb";
const MODULE = "Audiology Services";
const PAGE = "Hearing Aid";
const KPIS = [{"l":"Total Audiology Svc","v":"2.831","t":"+11.7%","d":"up"},{"l":"Hearing Aid Ativos","v":"6.805","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"65.8%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"70","t":"+4.6%","d":"up"}];
const COLS = ["ID","Hearing Aid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiology Svc #001","Audiology Svc #002","628","6.000","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Audiology Svc #002","Audiology Svc #003","794","3.598","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiology Svc #003","Audiology Svc #004","1.901","6.557","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Audiology Svc #004","Audiology Svc #005","4.610","8.392","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiology Svc #005","Audiology Svc #001","1.982","6.329","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":698},{"label":"Mar","value":582},{"label":"Abr","value":809},{"label":"Mai","value":731},{"label":"Jun","value":593},{"label":"Jul","value":681},{"label":"Ago","value":846},{"label":"Set","value":606},{"label":"Out","value":522},{"label":"Nov","value":572},{"label":"Dez","value":580}];
const MX = 846;
