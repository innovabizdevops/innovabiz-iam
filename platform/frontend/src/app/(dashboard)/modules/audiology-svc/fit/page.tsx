...
const PAGE = "Fit";
const KPIS = [{"l":"Total Audiology Svc","v":"934","t":"+5.8%","d":"up"},{"l":"Fit Ativos","v":"6.414","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"63","t":"+12.5%","d":"up"}];
const COLS = ["ID","Fit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiology Svc #001","Audiology Svc #002","1.196","1.249","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Audiology Svc #002","Audiology Svc #003","4.047","3.985","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiology Svc #003","Audiology Svc #004","6.753","5.962","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Audiology Svc #004","Audiology Svc #005","3.044","7.936","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiology Svc #005","Audiology Svc #001","9.047","5.837","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":511},{"label":"Mar","value":681},{"label":"Abr","value":548},{"label":"Mai","value":523},{"label":"Jun","value":403},{"label":"Jul","value":507},{"label":"Ago","value":545},{"label":"Set","value":471},{"label":"Out","value":604},{"label":"Nov","value":446},{"label":"Dez","value":389}];
const MX = 681;
