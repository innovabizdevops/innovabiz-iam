...
/* ═══ Audiology Services — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "5903", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "250", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€76K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "158049403", cells: ["AUD-1403", "Audiology Services Item 1", "16/8/2026", "€49 503"], status: "active" as const },
    { id: "158052974", cells: ["AUD-4974", "Audiology Services Item 2", "3/3/2026", "€3074"], status: "pending" as const },
    { id: "158056545", cells: ["AUD-8545", "Audiology Services Item 3", "18/10/2026", "€6645"], status: "completed" as const },
    { id: "158060116", cells: ["AUD-3116", "Audiology Services Item 4", "5/5/2026", "€10 216"], status: "warning" as const },
    { id: "158063687", cells: ["AUD-6687", "Audiology Services Item 5", "20/12/2026", "€13 787"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Audiology Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Audiology Services</p>
                    </div>
                </div>
