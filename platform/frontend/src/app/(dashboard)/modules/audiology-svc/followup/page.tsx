...
const KPIS = [{"l":"Total Audiology Svc","v":"4.548","t":"-0.7%","d":"down"},{"l":"Follow Up Ativos","v":"5.214","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"93.6%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"59","t":"-2.2%","d":"down"}];
const COLS = ["ID","Follow Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiology Svc #001","Audiology Svc #002","7.362","465","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Audiology Svc #002","Audiology Svc #003","436","8.908","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiology Svc #003","Audiology Svc #004","5.625","8.761","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Audiology Svc #004","Audiology Svc #005","1.044","7.091","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiology Svc #005","Audiology Svc #001","6.412","5.862","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":539},{"label":"Mar","value":620},{"label":"Abr","value":414},{"label":"Mai","value":498},{"label":"Jun","value":727},{"label":"Jul","value":662},{"label":"Ago","value":725},{"label":"Set","value":421},{"label":"Out","value":575},{"label":"Nov","value":646},{"label":"Dez","value":717}];
const MX = 727;
