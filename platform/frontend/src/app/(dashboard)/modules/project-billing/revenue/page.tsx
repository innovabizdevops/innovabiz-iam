...
const KPIS = [{"l":"ARR (€M)","v":"€5.5M","t":"-5.2%","d":"down"},{"l":"MRR (€)","v":"€47894","t":"+15.2%","d":"up"},{"l":"Churn (%)","v":"68.0%","t":"+11.8%","d":"up"},{"l":"ARPU (€)","v":"€60525","t":"+10.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28416.37","1.403","€ 44892.74","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 49895.83","4.202","€ 28076.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7426.46","6.168","€ 24100.18","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 34521.79","8.467","€ 9578.00","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9085.79","4.914","€ 3742.77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":622},{"label":"Mar","value":551},{"label":"Abr","value":344},{"label":"Mai","value":458},{"label":"Jun","value":668},{"label":"Jul","value":494},{"label":"Ago","value":299},{"label":"Set","value":361},{"label":"Out","value":661},{"label":"Nov","value":479},{"label":"Dez","value":487}];
const MX = 668;
