...
const ACCENT = "#0e7490";
const MODULE = "Project Billing";
const PAGE = "Contract Type";
const KPIS = [{"l":"Contratos Ativos","v":"6.738","t":"+8.0%","d":"up"},{"l":"Valor Total (€M)","v":"€47.2M","t":"+16.9%","d":"up"},{"l":"Renovações Próx. 30d","v":"2.729","t":"+13.4%","d":"up"},{"l":"Obrigações Pendentes","v":"7.774","t":"+12.3%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 24459.37","2026-01-02","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 46430.66","2026-03-25","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 5756.71","2026-03-10","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 19435.90","2026-03-14","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 19975.21","2026-03-22","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":554},{"label":"Mar","value":454},{"label":"Abr","value":367},{"label":"Mai","value":471},{"label":"Jun","value":241},{"label":"Jul","value":376},{"label":"Ago","value":478},{"label":"Set","value":248},{"label":"Out","value":392},{"label":"Nov","value":480},{"label":"Dez","value":419}];
const MX = 602;
