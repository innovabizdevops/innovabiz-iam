...
const PAGE = "Fixed Fee";
const KPIS = [{"l":"Total Project Billing","v":"1.190","t":"+15.3%","d":"up"},{"l":"Fixed Fee Ativos","v":"6.408","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"67.1%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"73","t":"+12.6%","d":"up"}];
const COLS = ["ID","Fixed Fee","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Project Billing #001","Project Billing #002","2.154","8.229","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Project Billing #002","Project Billing #003","5.092","5.383","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Project Billing #003","Project Billing #004","5.395","1.049","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Project Billing #004","Project Billing #005","6.370","706","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Project Billing #005","Project Billing #001","3.600","3.728","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":580},{"label":"Mar","value":734},{"label":"Abr","value":713},{"label":"Mai","value":401},{"label":"Jun","value":450},{"label":"Jul","value":694},{"label":"Ago","value":686},{"label":"Set","value":777},{"label":"Out","value":600},{"label":"Nov","value":416},{"label":"Dez","value":399}];
const MX = 777;
