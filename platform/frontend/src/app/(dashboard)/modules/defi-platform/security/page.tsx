...
const PAGE = "Security";
const KPIS = [{"l":"Formulários Ativos","v":"7.556","t":"+2.0%","d":"up"},{"l":"Submissões/Dia","v":"2935","t":"+15.7%","d":"up"},{"l":"Documentos Gerados","v":"6.109","t":"-2.9%","d":"down"},{"l":"Templates","v":"2.357","t":"+7.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.629","2026-01-20","1.618","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.118","2026-02-04","7.696","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.277","2026-01-19","3.847","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","913","2026-01-18","4.287","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.241","2026-02-14","4.051","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":677},{"label":"Mar","value":860},{"label":"Abr","value":567},{"label":"Mai","value":698},{"label":"Jun","value":673},{"label":"Jul","value":915},{"label":"Ago","value":538},{"label":"Set","value":837},{"label":"Out","value":728},{"label":"Nov","value":735},{"label":"Dez","value":642}];
const MX = 915;
