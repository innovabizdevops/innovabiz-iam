...
const PAGE = "Staking";
const KPIS = [{"l":"Formulários Ativos","v":"7.035","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"3925","t":"+6.6%","d":"up"},{"l":"Documentos Gerados","v":"6.947","t":"-0.1%","d":"down"},{"l":"Templates","v":"3.762","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.534","2026-03-21","5.664","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.556","2026-01-20","996","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.895","2026-02-16","2.819","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.542","2026-01-07","290","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","744","2026-01-07","5.838","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":296},{"label":"Fev","value":643},{"label":"Mar","value":393},{"label":"Abr","value":497},{"label":"Mai","value":628},{"label":"Jun","value":365},{"label":"Jul","value":487},{"label":"Ago","value":363},{"label":"Set","value":454},{"label":"Out","value":627},{"label":"Nov","value":491},{"label":"Dez","value":598}];
const MX = 643;
