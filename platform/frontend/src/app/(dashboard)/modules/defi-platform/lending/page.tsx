...
const PAGE = "Lending";
const KPIS = [{"l":"Formulários Ativos","v":"897","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"1495","t":"+7.3%","d":"up"},{"l":"Documentos Gerados","v":"7.667","t":"+9.3%","d":"up"},{"l":"Templates","v":"2.520","t":"+5.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.214","2026-03-05","1.026","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","262","2026-02-15","2.872","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.464","2026-02-24","5.496","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.380","2026-02-14","600","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.128","2026-01-28","5.783","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":505},{"label":"Mar","value":300},{"label":"Abr","value":548},{"label":"Mai","value":472},{"label":"Jun","value":450},{"label":"Jul","value":470},{"label":"Ago","value":507},{"label":"Set","value":398},{"label":"Out","value":372},{"label":"Nov","value":552},{"label":"Dez","value":254}];
const MX = 561;
