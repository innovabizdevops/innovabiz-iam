...
const ACCENT = "#6366f1";
const MODULE = "DeFi Platform";
const PAGE = "Yield";
const KPIS = [{"l":"Formulários Ativos","v":"5.836","t":"+14.1%","d":"up"},{"l":"Submissões/Dia","v":"2117","t":"-5.5%","d":"down"},{"l":"Documentos Gerados","v":"1.847","t":"-5.7%","d":"down"},{"l":"Templates","v":"2.504","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.837","2026-03-02","1.808","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.383","2026-01-12","2.328","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","871","2026-02-10","8.907","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.880","2026-02-22","1.304","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.512","2026-01-09","5.149","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":959},{"label":"Fev","value":647},{"label":"Mar","value":789},{"label":"Abr","value":697},{"label":"Mai","value":873},{"label":"Jun","value":713},{"label":"Jul","value":747},{"label":"Ago","value":928},{"label":"Set","value":927},{"label":"Out","value":1008},{"label":"Nov","value":901},{"label":"Dez","value":769}];
const MX = 1008;
