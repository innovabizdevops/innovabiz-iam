...
const KPIS = [{"l":"Riscos Identificados","v":"6.477","t":"+13.1%","d":"up"},{"l":"Mitigações Ativas","v":"3.791","t":"-4.5%","d":"down"},{"l":"Score Risco Geral","v":"84","t":"-2.6%","d":"down"},{"l":"Incidentes YTD","v":"2.347","t":"+10.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","357","7.723","5.150","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.017","2.907","7.880","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.655","2.568","3.536","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.325","6.640","1.566","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.885","5.248","4.858","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":928},{"label":"Fev","value":590},{"label":"Mar","value":729},{"label":"Abr","value":606},{"label":"Mai","value":715},{"label":"Jun","value":760},{"label":"Jul","value":595},{"label":"Ago","value":853},{"label":"Set","value":841},{"label":"Out","value":602},{"label":"Nov","value":750},{"label":"Dez","value":819}];
const MX = 928;
