...
const ACCENT = "#334155";
const MODULE = "Tool & Die Making";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.364","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"2415","t":"-3.6%","d":"down"},{"l":"Documentos Gerados","v":"8.416","t":"-5.2%","d":"down"},{"l":"Templates","v":"2.750","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.053","2026-01-18","1.154","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.962","2026-03-04","3.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.968","2026-03-04","947","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.416","2026-03-03","2.378","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.072","2026-03-05","1.536","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":355},{"label":"Mar","value":614},{"label":"Abr","value":295},{"label":"Mai","value":393},{"label":"Jun","value":529},{"label":"Jul","value":325},{"label":"Ago","value":356},{"label":"Set","value":281},{"label":"Out","value":490},{"label":"Nov","value":565},{"label":"Dez","value":616}];
const MX = 616;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#334155'}}>3D</span></h1>
                </div>
