...
/* ═══ Tool & Die Making — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "6475", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2134", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€278K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "181701075", cells: ["TOO-1075", "Tool & Die Making Item 1", "4/4/2026", "€1175"], status: "active" as const },
    { id: "181704646", cells: ["TOO-4646", "Tool & Die Making Item 2", "19/11/2026", "€4746"], status: "pending" as const },
    { id: "181708217", cells: ["TOO-8217", "Tool & Die Making Item 3", "6/6/2026", "€8317"], status: "completed" as const },
    { id: "181711788", cells: ["TOO-2788", "Tool & Die Making Item 4", "21/1/2026", "€11 888"], status: "warning" as const },
    { id: "181715359", cells: ["TOO-6359", "Tool & Die Making Item 5", "8/8/2026", "€15 459"], status: "active" as const },
];
...
export default function ToolDieMakingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tool & Die Making</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tool & Die Making</p>
                    </div>
                </div>
