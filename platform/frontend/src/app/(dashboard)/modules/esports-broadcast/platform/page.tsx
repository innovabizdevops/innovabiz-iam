...
const ACCENT = "#0e7490";
const MODULE = "Esports Broadcast";
const PAGE = "Multi-Platform";
const KPIS = [{"l":"Formulários Ativos","v":"2.705","t":"+15.4%","d":"up"},{"l":"Submissões/Dia","v":"724","t":"-4.7%","d":"down"},{"l":"Documentos Gerados","v":"3.336","t":"+0.7%","d":"up"},{"l":"Templates","v":"3.927","t":"+14.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.932","2026-03-25","9.077","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.968","2026-02-19","6.467","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.318","2026-03-20","4.061","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.330","2026-03-06","6.399","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.969","2026-03-27","6.433","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":480},{"label":"Mar","value":679},{"label":"Abr","value":704},{"label":"Mai","value":727},{"label":"Jun","value":405},{"label":"Jul","value":404},{"label":"Ago","value":655},{"label":"Set","value":691},{"label":"Out","value":573},{"label":"Nov","value":690},{"label":"Dez","value":646}];
const MX = 727;
