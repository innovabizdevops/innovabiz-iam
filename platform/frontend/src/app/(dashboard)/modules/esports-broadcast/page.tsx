...
export default function EsportsBroadcastPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Esports Broadcast</h1><p className="text-sm text-muted-foreground">Esports Broadcast • iBOS Enterprise</p></div>
