...
const PAGE = "Commentary";
const KPIS = [{"l":"Atletas Registados","v":"503","t":"+4.0%","d":"up"},{"l":"Treinos/Semana","v":"2020","t":"+16.2%","d":"up"},{"l":"Competições","v":"4.772","t":"+8.7%","d":"up"},{"l":"Performance Score","v":"69","t":"+8.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","9.020","4.731","720","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.204","5.272","2.928","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.096","7.639","2.067","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.435","1.430","7.614","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.939","3.003","6.053","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":633},{"label":"Mar","value":404},{"label":"Abr","value":320},{"label":"Mai","value":669},{"label":"Jun","value":652},{"label":"Jul","value":599},{"label":"Ago","value":313},{"label":"Set","value":687},{"label":"Out","value":561},{"label":"Nov","value":439},{"label":"Dez","value":334}];
const MX = 687;
