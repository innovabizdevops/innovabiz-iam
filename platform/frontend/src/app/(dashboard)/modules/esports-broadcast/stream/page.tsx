...
const PAGE = "Stream Mgmt";
const KPIS = [{"l":"Atletas Registados","v":"583","t":"-5.2%","d":"down"},{"l":"Treinos/Semana","v":"3032","t":"+14.4%","d":"up"},{"l":"Competições","v":"6.225","t":"-0.8%","d":"down"},{"l":"Performance Score","v":"81","t":"+4.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.620","4.619","464","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.633","4.542","4.883","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.644","2.977","8.807","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.140","8.589","733","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.467","3.284","4.615","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":352},{"label":"Mar","value":510},{"label":"Abr","value":308},{"label":"Mai","value":672},{"label":"Jun","value":394},{"label":"Jul","value":639},{"label":"Ago","value":386},{"label":"Set","value":694},{"label":"Out","value":694},{"label":"Nov","value":409},{"label":"Dez","value":521}];
const MX = 694;
