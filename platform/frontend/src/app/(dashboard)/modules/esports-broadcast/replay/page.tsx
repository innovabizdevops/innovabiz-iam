...
const PAGE = "Replay System";
const KPIS = [{"l":"Atletas Registados","v":"2.297","t":"-1.7%","d":"down"},{"l":"Treinos/Semana","v":"3797","t":"-4.5%","d":"down"},{"l":"Competições","v":"8.716","t":"+9.4%","d":"up"},{"l":"Performance Score","v":"94","t":"+3.9%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.585","3.401","6.007","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.742","5.755","6.754","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.481","6.307","2.853","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.352","1.526","3.281","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.396","4.990","7.833","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":892},{"label":"Mar","value":769},{"label":"Abr","value":550},{"label":"Mai","value":812},{"label":"Jun","value":562},{"label":"Jul","value":716},{"label":"Ago","value":887},{"label":"Set","value":777},{"label":"Out","value":843},{"label":"Nov","value":859},{"label":"Dez","value":663}];
const MX = 892;
