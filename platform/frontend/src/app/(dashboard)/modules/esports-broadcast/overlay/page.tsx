...
const PAGE = "Overlay";
const KPIS = [{"l":"Atletas Registados","v":"5.886","t":"+16.2%","d":"up"},{"l":"Treinos/Semana","v":"4164","t":"-3.3%","d":"down"},{"l":"Competições","v":"8.613","t":"+5.5%","d":"up"},{"l":"Performance Score","v":"64","t":"-2.9%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.036","1.303","6.342","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.615","296","7.154","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.571","3.142","7.721","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.892","5.241","2.068","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.681","5.205","8.716","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1043},{"label":"Fev","value":681},{"label":"Mar","value":774},{"label":"Abr","value":871},{"label":"Mai","value":684},{"label":"Jun","value":950},{"label":"Jul","value":1053},{"label":"Ago","value":763},{"label":"Set","value":904},{"label":"Out","value":731},{"label":"Nov","value":752},{"label":"Dez","value":1047}];
const MX = 1053;
