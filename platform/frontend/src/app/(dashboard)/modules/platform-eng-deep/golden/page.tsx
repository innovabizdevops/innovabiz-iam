...
const KPIS = [{"l":"Formulários Ativos","v":"6.326","t":"+14.8%","d":"up"},{"l":"Submissões/Dia","v":"4150","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"2.967","t":"+14.2%","d":"up"},{"l":"Templates","v":"3.761","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.803","2026-01-06","1.561","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.341","2026-03-06","3.434","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.166","2026-03-13","6.421","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.499","2026-03-11","8.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.863","2026-03-28","2.875","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":547},{"label":"Mar","value":885},{"label":"Abr","value":867},{"label":"Mai","value":676},{"label":"Jun","value":835},{"label":"Jul","value":717},{"label":"Ago","value":540},{"label":"Set","value":721},{"label":"Out","value":786},{"label":"Nov","value":506},{"label":"Dez","value":737}];
const MX = 885;
