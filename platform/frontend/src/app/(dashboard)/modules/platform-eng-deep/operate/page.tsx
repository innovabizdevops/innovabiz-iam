...
const PAGE = "Operate";
const KPIS = [{"l":"Formulários Ativos","v":"2.071","t":"+5.1%","d":"up"},{"l":"Submissões/Dia","v":"4867","t":"+16.4%","d":"up"},{"l":"Documentos Gerados","v":"5.841","t":"+9.3%","d":"up"},{"l":"Templates","v":"4.262","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.296","2026-01-10","1.362","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.213","2026-02-13","2.311","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.718","2026-01-16","7.400","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","147","2026-02-11","6.830","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.123","2026-02-13","5.227","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":775},{"label":"Mar","value":1002},{"label":"Abr","value":969},{"label":"Mai","value":734},{"label":"Jun","value":773},{"label":"Jul","value":769},{"label":"Ago","value":859},{"label":"Set","value":660},{"label":"Out","value":899},{"label":"Nov","value":773},{"label":"Dez","value":845}];
const MX = 1002;
