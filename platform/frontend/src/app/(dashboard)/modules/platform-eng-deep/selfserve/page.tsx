...
const PAGE = "Self-Serve";
const KPIS = [{"l":"Formulários Ativos","v":"2.437","t":"+14.6%","d":"up"},{"l":"Submissões/Dia","v":"1677","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"4.319","t":"-0.3%","d":"down"},{"l":"Templates","v":"7.204","t":"+5.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.768","2026-03-02","2.239","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","876","2026-01-23","5.230","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.030","2026-02-01","1.526","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.257","2026-01-19","4.517","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.367","2026-02-24","8.426","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":793},{"label":"Mar","value":625},{"label":"Abr","value":644},{"label":"Mai","value":598},{"label":"Jun","value":755},{"label":"Jul","value":429},{"label":"Ago","value":807},{"label":"Set","value":563},{"label":"Out","value":538},{"label":"Nov","value":617},{"label":"Dez","value":736}];
const MX = 807;
