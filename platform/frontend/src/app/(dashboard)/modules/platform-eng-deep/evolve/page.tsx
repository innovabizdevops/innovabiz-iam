...
const ACCENT = "#1e40af";
const MODULE = "Platform Engineering Deep";
const PAGE = "Evolve";
const KPIS = [{"l":"Formulários Ativos","v":"2.335","t":"-4.8%","d":"down"},{"l":"Submissões/Dia","v":"3091","t":"+6.0%","d":"up"},{"l":"Documentos Gerados","v":"934","t":"+3.0%","d":"up"},{"l":"Templates","v":"2.235","t":"+2.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.683","2026-02-13","2.446","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.891","2026-02-02","6.503","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.942","2026-02-18","6.183","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","472","2026-03-19","884","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.803","2026-01-12","5.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":682},{"label":"Mar","value":452},{"label":"Abr","value":479},{"label":"Mai","value":536},{"label":"Jun","value":468},{"label":"Jul","value":778},{"label":"Ago","value":699},{"label":"Set","value":482},{"label":"Out","value":598},{"label":"Nov","value":540},{"label":"Dez","value":493}];
const MX = 778;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>EVO</span></h1>
                </div>
