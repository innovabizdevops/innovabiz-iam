...
/* ═══ Platform Engineering Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "1500", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "650", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€242K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "670280900", cells: ["PLA-6900", "Platform Engineering Deep Item 1", "17/9/2026", "€31 000"], status: "active" as const },
    { id: "670284471", cells: ["PLA-1471", "Platform Engineering Deep Item 2", "4/4/2026", "€34 571"], status: "pending" as const },
    { id: "670288042", cells: ["PLA-5042", "Platform Engineering Deep Item 3", "19/11/2026", "€38 142"], status: "completed" as const },
    { id: "670291613", cells: ["PLA-8613", "Platform Engineering Deep Item 4", "6/6/2026", "€41 713"], status: "warning" as const },
    { id: "670295184", cells: ["PLA-3184", "Platform Engineering Deep Item 5", "21/1/2026", "€45 284"], status: "active" as const },
];
...
export default function PlatformEngineeringDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Engineering Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Engineering Deep</p>
                    </div>
                </div>
