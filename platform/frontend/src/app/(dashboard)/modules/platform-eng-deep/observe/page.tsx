...
const PAGE = "Observe";
const KPIS = [{"l":"Formulários Ativos","v":"3.449","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"4450","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"1.082","t":"+4.1%","d":"up"},{"l":"Templates","v":"7.102","t":"+5.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.298","2026-01-11","1.238","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.836","2026-03-03","6.500","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","649","2026-03-20","5.054","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.109","2026-02-24","8.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.808","2026-03-01","2.474","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":357},{"label":"Mar","value":655},{"label":"Abr","value":431},{"label":"Mai","value":467},{"label":"Jun","value":506},{"label":"Jul","value":641},{"label":"Ago","value":665},{"label":"Set","value":504},{"label":"Out","value":330},{"label":"Nov","value":407},{"label":"Dez","value":470}];
const MX = 665;
