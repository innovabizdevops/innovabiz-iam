...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.657","t":"+14.3%","d":"up"},{"l":"Contratos (€M)","v":"€14.5M","t":"-1.2%","d":"down"},{"l":"On-Time Delivery (%)","v":"93.1%","t":"+3.0%","d":"up"},{"l":"Score Médio","v":"95","t":"+11.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","70.7%","€ 38432.36","5.820","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","99.7%","€ 28112.87","6.911","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","94.7%","€ 44923.10","113","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","97.1%","€ 20468.42","2.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","77.5%","€ 37969.39","7.687","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":350},{"label":"Mar","value":684},{"label":"Abr","value":630},{"label":"Mai","value":675},{"label":"Jun","value":348},{"label":"Jul","value":658},{"label":"Ago","value":652},{"label":"Set","value":527},{"label":"Out","value":333},{"label":"Nov","value":366},{"label":"Dez","value":438}];
const MX = 684;
