...
const PAGE = "Tender";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.832","t":"+17.2%","d":"up"},{"l":"Contratos (€M)","v":"€4.4M","t":"+8.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"72.2%","t":"+11.3%","d":"up"},{"l":"Score Médio","v":"84","t":"+16.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","96.7%","€ 5651.49","6.194","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","85.3%","€ 23281.49","5.260","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","70.5%","€ 36356.82","6.120","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","87.9%","€ 3536.07","6.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","84.5%","€ 8443.73","6.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":670},{"label":"Mar","value":773},{"label":"Abr","value":698},{"label":"Mai","value":538},{"label":"Jun","value":774},{"label":"Jul","value":381},{"label":"Ago","value":525},{"label":"Set","value":692},{"label":"Out","value":667},{"label":"Nov","value":707},{"label":"Dez","value":463}];
const MX = 774;
