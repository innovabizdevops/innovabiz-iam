...
const PAGE = "Award";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.650","t":"+10.9%","d":"up"},{"l":"Contratos (€M)","v":"€28.3M","t":"+12.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"74.2%","t":"+12.1%","d":"up"},{"l":"Score Médio","v":"56","t":"+-0.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","99.2%","€ 12933.50","2.095","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","88.0%","€ 47655.04","7.493","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","77.3%","€ 49241.11","3.510","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","84.1%","€ 14079.16","9.099","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","90.4%","€ 32120.83","5.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":792},{"label":"Mar","value":592},{"label":"Abr","value":640},{"label":"Mai","value":828},{"label":"Jun","value":796},{"label":"Jul","value":585},{"label":"Ago","value":829},{"label":"Set","value":759},{"label":"Out","value":726},{"label":"Nov","value":616},{"label":"Dez","value":870}];
const MX = 870;
