...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"2.028","t":"-0.1%","d":"down"},{"l":"Valor Total (€M)","v":"€12.5M","t":"+2.7%","d":"up"},{"l":"Renovações Próx. 30d","v":"7.965","t":"+12.0%","d":"up"},{"l":"Obrigações Pendentes","v":"3.472","t":"+13.7%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 9714.39","2026-03-06","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 9222.38","2026-03-26","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 36734.17","2026-02-22","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 21649.27","2026-02-16","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 2460.73","2026-02-18","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":497},{"label":"Mar","value":664},{"label":"Abr","value":675},{"label":"Mai","value":753},{"label":"Jun","value":486},{"label":"Jul","value":532},{"label":"Ago","value":446},{"label":"Set","value":764},{"label":"Out","value":416},{"label":"Nov","value":606},{"label":"Dez","value":512}];
const MX = 764;
