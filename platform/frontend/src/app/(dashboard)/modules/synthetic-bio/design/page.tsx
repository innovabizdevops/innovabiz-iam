...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.185","t":"-5.4%","d":"down"},{"l":"Submissões/Dia","v":"2725","t":"+5.0%","d":"up"},{"l":"Documentos Gerados","v":"5.314","t":"-2.0%","d":"down"},{"l":"Templates","v":"2.758","t":"+5.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.974","2026-01-28","3.127","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.707","2026-01-26","1.160","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.666","2026-01-27","4.376","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.475","2026-01-08","8.969","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.009","2026-03-14","5.601","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":622},{"label":"Mar","value":442},{"label":"Abr","value":607},{"label":"Mai","value":542},{"label":"Jun","value":543},{"label":"Jul","value":566},{"label":"Ago","value":640},{"label":"Set","value":428},{"label":"Out","value":460},{"label":"Nov","value":372},{"label":"Dez","value":255}];
const MX = 640;
