...
const PAGE = "Build";
const KPIS = [{"l":"Total Synthetic Bio","v":"6.359","t":"+9.4%","d":"up"},{"l":"Build Ativos","v":"5.962","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"83.1%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+16.4%","d":"up"}];
const COLS = ["ID","Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Synthetic Bio #001","Synthetic Bio #002","2.292","1.012","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Synthetic Bio #002","Synthetic Bio #003","2.321","4.655","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Synthetic Bio #003","Synthetic Bio #004","5.048","7.541","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Synthetic Bio #004","Synthetic Bio #005","3.089","8.335","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Synthetic Bio #005","Synthetic Bio #001","3.667","8.578","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":939},{"label":"Mar","value":929},{"label":"Abr","value":655},{"label":"Mai","value":924},{"label":"Jun","value":946},{"label":"Jul","value":960},{"label":"Ago","value":926},{"label":"Set","value":918},{"label":"Out","value":964},{"label":"Nov","value":972},{"label":"Dez","value":829}];
const MX = 972;
