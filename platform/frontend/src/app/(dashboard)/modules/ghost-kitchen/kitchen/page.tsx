...
const PAGE = "Kitchen Ops";
const KPIS = [{"l":"Quartos Ocupados","v":"2.014","t":"+1.7%","d":"up"},{"l":"RevPAR (€)","v":"€88622","t":"+15.9%","d":"up"},{"l":"Ocupação (%)","v":"73.4%","t":"+16.4%","d":"up"},{"l":"Guest Satisfaction","v":"4.410","t":"+0.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.922","2026-02-03","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","308","2026-02-22","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.343","2026-03-16","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.469","2026-01-16","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.584","2026-02-28","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":377},{"label":"Mar","value":616},{"label":"Abr","value":324},{"label":"Mai","value":614},{"label":"Jun","value":474},{"label":"Jul","value":684},{"label":"Ago","value":376},{"label":"Set","value":397},{"label":"Out","value":618},{"label":"Nov","value":614},{"label":"Dez","value":361}];
const MX = 684;
