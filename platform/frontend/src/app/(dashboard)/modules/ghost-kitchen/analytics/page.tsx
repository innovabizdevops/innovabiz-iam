...
const ACCENT = "#6366f1";
const MODULE = "Ghost Kitchen";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.660","t":"+13.4%","d":"up"},{"l":"Queries/Dia","v":"1791","t":"+7.3%","d":"up"},{"l":"Dados Processados (GB)","v":"173","t":"-0.6%","d":"down"},{"l":"Utilizadores Analytics","v":"9.089","t":"-5.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4965","2026-03-25","8.541","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4353","2026-01-16","4.650","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2337","2026-01-13","4.180","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3906","2026-03-06","6.697","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4148","2026-03-04","3.233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":478},{"label":"Mar","value":506},{"label":"Abr","value":589},{"label":"Mai","value":667},{"label":"Jun","value":539},{"label":"Jul","value":369},{"label":"Ago","value":568},{"label":"Set","value":543},{"label":"Out","value":651},{"label":"Nov","value":398},{"label":"Dez","value":654}];
const MX = 667;
