...
const PAGE = "Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"8.188","t":"+14.4%","d":"up"},{"l":"RevPAR (€)","v":"€18419","t":"+9.3%","d":"up"},{"l":"Ocupação (%)","v":"74.9%","t":"+16.6%","d":"up"},{"l":"Guest Satisfaction","v":"648","t":"+4.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.234","2026-01-25","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","854","2026-01-04","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","483","2026-01-16","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.206","2026-03-17","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.320","2026-03-12","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":598},{"label":"Mar","value":758},{"label":"Abr","value":826},{"label":"Mai","value":781},{"label":"Jun","value":634},{"label":"Jul","value":843},{"label":"Ago","value":829},{"label":"Set","value":670},{"label":"Out","value":786},{"label":"Nov","value":734},{"label":"Dez","value":592}];
const MX = 843;
