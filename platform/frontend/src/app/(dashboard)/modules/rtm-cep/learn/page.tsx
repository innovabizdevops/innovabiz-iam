...
const PAGE = "Learn";
const KPIS = [{"l":"Total Rtm Cep","v":"8.491","t":"+6.6%","d":"up"},{"l":"Learn Ativos","v":"957","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.1%","d":"up"}];
const COLS = ["ID","Learn","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rtm Cep #001","Rtm Cep #002","6.788","3.167","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Rtm Cep #002","Rtm Cep #003","729","1.365","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Rtm Cep #003","Rtm Cep #004","2.440","1.530","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Rtm Cep #004","Rtm Cep #005","3.595","5.282","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rtm Cep #005","Rtm Cep #001","5.976","5.734","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":415},{"label":"Mar","value":470},{"label":"Abr","value":382},{"label":"Mai","value":401},{"label":"Jun","value":529},{"label":"Jul","value":427},{"label":"Ago","value":227},{"label":"Set","value":449},{"label":"Out","value":465},{"label":"Nov","value":223},{"label":"Dez","value":304}];
const MX = 529;
