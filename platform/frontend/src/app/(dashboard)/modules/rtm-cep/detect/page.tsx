...
const ACCENT = "#dc2626";
const MODULE = "RTM Complex Event Processing";
const PAGE = "Detect";
const KPIS = [{"l":"Total Rtm Cep","v":"3.532","t":"+17.7%","d":"up"},{"l":"Detect Ativos","v":"2.861","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"70","t":"-3.4%","d":"down"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rtm Cep #001","Rtm Cep #002","2.606","6.053","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Rtm Cep #002","Rtm Cep #003","3.858","6.105","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Rtm Cep #003","Rtm Cep #004","3.620","1.204","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Rtm Cep #004","Rtm Cep #005","2.179","7.464","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rtm Cep #005","Rtm Cep #001","2.732","3.492","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":302},{"label":"Mar","value":344},{"label":"Abr","value":389},{"label":"Mai","value":365},{"label":"Jun","value":531},{"label":"Jul","value":572},{"label":"Ago","value":680},{"label":"Set","value":366},{"label":"Out","value":380},{"label":"Nov","value":388},{"label":"Dez","value":287}];
const MX = 680;
