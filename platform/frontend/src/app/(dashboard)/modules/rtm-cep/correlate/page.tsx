...
const KPIS = [{"l":"Total Rtm Cep","v":"7.407","t":"+10.7%","d":"up"},{"l":"Correlate Ativos","v":"5.883","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-3.2%","d":"down"}];
const COLS = ["ID","Correlate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rtm Cep #001","Rtm Cep #002","307","3.336","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Rtm Cep #002","Rtm Cep #003","4.063","3.157","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Rtm Cep #003","Rtm Cep #004","6.651","5.893","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Rtm Cep #004","Rtm Cep #005","551","8.530","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rtm Cep #005","Rtm Cep #001","330","5.249","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":753},{"label":"Mar","value":589},{"label":"Abr","value":680},{"label":"Mai","value":644},{"label":"Jun","value":666},{"label":"Jul","value":573},{"label":"Ago","value":661},{"label":"Set","value":799},{"label":"Out","value":746},{"label":"Nov","value":679},{"label":"Dez","value":819}];
const MX = 819;
