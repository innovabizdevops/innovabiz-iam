...
const PAGE = "Action";
const KPIS = [{"l":"Total Rtm Cep","v":"6.841","t":"+16.0%","d":"up"},{"l":"Action Ativos","v":"6.105","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"72.9%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"95","t":"+17.9%","d":"up"}];
const COLS = ["ID","Action","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rtm Cep #001","Rtm Cep #002","655","3.896","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Rtm Cep #002","Rtm Cep #003","6.735","4.273","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Rtm Cep #003","Rtm Cep #004","4.550","1.266","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Rtm Cep #004","Rtm Cep #005","501","2.380","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rtm Cep #005","Rtm Cep #001","2.591","907","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":238},{"label":"Mar","value":465},{"label":"Abr","value":461},{"label":"Mai","value":294},{"label":"Jun","value":467},{"label":"Jul","value":412},{"label":"Ago","value":480},{"label":"Set","value":279},{"label":"Out","value":555},{"label":"Nov","value":349},{"label":"Dez","value":237}];
const MX = 555;
