...
/* ═══ RTM Complex Event Processing — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "6633", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "224", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€83K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1411647533", cells: ["RTM-7533", "RTM Complex Event Processing Item 1", "10/6/2026", "€47 633"], status: "active" as const },
    { id: "1411651104", cells: ["RTM-2104", "RTM Complex Event Processing Item 2", "25/1/2026", "€1204"], status: "pending" as const },
    { id: "1411654675", cells: ["RTM-5675", "RTM Complex Event Processing Item 3", "12/8/2026", "€4775"], status: "completed" as const },
    { id: "1411658246", cells: ["RTM-9246", "RTM Complex Event Processing Item 4", "27/3/2026", "€8346"], status: "warning" as const },
    { id: "1411661817", cells: ["RTM-3817", "RTM Complex Event Processing Item 5", "14/10/2026", "€11 917"], status: "active" as const },
];
...
export default function RtmComplexEventProcessingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RTM Complex Event Processing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RTM Complex Event Processing</p>
                    </div>
                </div>
