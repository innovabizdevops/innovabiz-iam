...
const PAGE = "CTP";
const KPIS = [{"l":"Total Prepress Mgmt","v":"2.115","t":"+16.3%","d":"up"},{"l":"CTP Ativos","v":"5.214","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"59","t":"+9.8%","d":"up"}];
const COLS = ["ID","CTP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Prepress Mgmt #001","Prepress Mgmt #002","2.953","4.798","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Prepress Mgmt #002","Prepress Mgmt #003","7.567","5.144","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Prepress Mgmt #003","Prepress Mgmt #004","4.147","2.441","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Prepress Mgmt #004","Prepress Mgmt #005","4.417","587","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Prepress Mgmt #005","Prepress Mgmt #001","315","2.825","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":578},{"label":"Mar","value":619},{"label":"Abr","value":775},{"label":"Mai","value":436},{"label":"Jun","value":463},{"label":"Jul","value":559},{"label":"Ago","value":453},{"label":"Set","value":537},{"label":"Out","value":700},{"label":"Nov","value":737},{"label":"Dez","value":547}];
const MX = 802;
