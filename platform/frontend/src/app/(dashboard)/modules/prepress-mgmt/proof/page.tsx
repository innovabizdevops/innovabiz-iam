...
const ACCENT = "#6366f1";
const MODULE = "Prepress Management";
const PAGE = "Color Proof";
const KPIS = [{"l":"Total Prepress Mgmt","v":"7.798","t":"-2.3%","d":"down"},{"l":"Color Proof Ativos","v":"4.883","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+6.0%","d":"up"}];
const COLS = ["ID","Color Proof","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Prepress Mgmt #001","Prepress Mgmt #002","504","8.876","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Prepress Mgmt #002","Prepress Mgmt #003","5.506","3.152","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Prepress Mgmt #003","Prepress Mgmt #004","3.855","3.924","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Prepress Mgmt #004","Prepress Mgmt #005","7.755","1.965","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Prepress Mgmt #005","Prepress Mgmt #001","6.872","6.987","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":279},{"label":"Fev","value":531},{"label":"Mar","value":649},{"label":"Abr","value":469},{"label":"Mai","value":486},{"label":"Jun","value":571},{"label":"Jul","value":279},{"label":"Ago","value":502},{"label":"Set","value":583},{"label":"Out","value":362},{"label":"Nov","value":631},{"label":"Dez","value":384}];
const MX = 649;
