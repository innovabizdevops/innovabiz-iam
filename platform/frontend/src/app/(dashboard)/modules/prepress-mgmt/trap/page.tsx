...
const PAGE = "Trap";
const KPIS = [{"l":"Total Prepress Mgmt","v":"2.901","t":"+3.8%","d":"up"},{"l":"Trap Ativos","v":"8.718","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"65","t":"+0.5%","d":"up"}];
const COLS = ["ID","Trap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Prepress Mgmt #001","Prepress Mgmt #002","5.954","739","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Prepress Mgmt #002","Prepress Mgmt #003","7.189","3.808","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Prepress Mgmt #003","Prepress Mgmt #004","3.792","6.155","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Prepress Mgmt #004","Prepress Mgmt #005","1.998","7.288","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Prepress Mgmt #005","Prepress Mgmt #001","4.637","3.784","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":545},{"label":"Mar","value":689},{"label":"Abr","value":777},{"label":"Mai","value":473},{"label":"Jun","value":649},{"label":"Jul","value":809},{"label":"Ago","value":653},{"label":"Set","value":646},{"label":"Out","value":721},{"label":"Nov","value":788},{"label":"Dez","value":551}];
const MX = 820;
