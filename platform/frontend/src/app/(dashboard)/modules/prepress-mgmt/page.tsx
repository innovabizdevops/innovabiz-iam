...
export default function PrepressMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Prepress Mgmt</h1><p className="text-sm text-muted-foreground">Prepress Mgmt • iBOS Enterprise</p></div>
