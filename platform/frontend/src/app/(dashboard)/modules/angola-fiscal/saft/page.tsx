...
const PAGE = "SAFT-AO";
const KPIS = [{"l":"Total Angola Fiscal","v":"5.853","t":"+9.3%","d":"up"},{"l":"SAFT AO Ativos","v":"3.037","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+9.1%","d":"up"}];
const COLS = ["ID","SAFT AO","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Angola Fiscal #001","Angola Fiscal #002","3.783","4.414","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Angola Fiscal #002","Angola Fiscal #003","3.340","1.021","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Angola Fiscal #003","Angola Fiscal #004","4.822","215","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Angola Fiscal #004","Angola Fiscal #005","1.136","4.532","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Angola Fiscal #005","Angola Fiscal #001","8.652","5.113","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":333},{"label":"Fev","value":304},{"label":"Mar","value":430},{"label":"Abr","value":504},{"label":"Mai","value":380},{"label":"Jun","value":509},{"label":"Jul","value":359},{"label":"Ago","value":524},{"label":"Set","value":391},{"label":"Out","value":581},{"label":"Nov","value":614},{"label":"Dez","value":563}];
const MX = 614;
