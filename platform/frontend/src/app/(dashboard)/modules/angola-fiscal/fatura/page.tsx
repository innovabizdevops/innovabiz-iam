...
const ACCENT = "#14532d";
const MODULE = "Angola Fiscal (AGT)";
const PAGE = "Fatura";
const KPIS = [{"l":"Total Angola Fiscal","v":"6.111","t":"-3.6%","d":"down"},{"l":"Fatura Ativos","v":"4.380","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"95","t":"-5.0%","d":"down"}];
const COLS = ["ID","Fatura","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Angola Fiscal #001","Angola Fiscal #002","6.699","8.358","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Angola Fiscal #002","Angola Fiscal #003","3.461","3.752","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Angola Fiscal #003","Angola Fiscal #004","1.016","480","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Angola Fiscal #004","Angola Fiscal #005","4.069","5.652","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Angola Fiscal #005","Angola Fiscal #001","1.855","3.756","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":570},{"label":"Mar","value":821},{"label":"Abr","value":508},{"label":"Mai","value":553},{"label":"Jun","value":803},{"label":"Jul","value":708},{"label":"Ago","value":764},{"label":"Set","value":710},{"label":"Out","value":671},{"label":"Nov","value":803},{"label":"Dez","value":729}];
const MX = 821;
