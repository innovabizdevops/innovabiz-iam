...
const PAGE = "SEF";
const KPIS = [{"l":"Total Angola Fiscal","v":"8.212","t":"+5.5%","d":"up"},{"l":"SEF Ativos","v":"9.005","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"92","t":"+17.9%","d":"up"}];
const COLS = ["ID","SEF","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Angola Fiscal #001","Angola Fiscal #002","1.073","1.554","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Angola Fiscal #002","Angola Fiscal #003","664","8.501","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Angola Fiscal #003","Angola Fiscal #004","2.066","6.019","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Angola Fiscal #004","Angola Fiscal #005","6.085","6.181","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Angola Fiscal #005","Angola Fiscal #001","398","6.648","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":444},{"label":"Mar","value":591},{"label":"Abr","value":376},{"label":"Mai","value":400},{"label":"Jun","value":337},{"label":"Jul","value":465},{"label":"Ago","value":331},{"label":"Set","value":289},{"label":"Out","value":373},{"label":"Nov","value":300},{"label":"Dez","value":394}];
const MX = 591;
