...
/* ═══ Angola Fiscal (AGT) — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "9540", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2801", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€89K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "722927240", cells: ["ANG-3240", "Angola Fiscal (AGT) Item 1", "1/9/2026", "€27 340"], status: "active" as const },
    { id: "722930811", cells: ["ANG-6811", "Angola Fiscal (AGT) Item 2", "16/4/2026", "€30 911"], status: "pending" as const },
    { id: "722934382", cells: ["ANG-1382", "Angola Fiscal (AGT) Item 3", "3/11/2026", "€34 482"], status: "completed" as const },
    { id: "722937953", cells: ["ANG-4953", "Angola Fiscal (AGT) Item 4", "18/6/2026", "€38 053"], status: "warning" as const },
    { id: "722941524", cells: ["ANG-8524", "Angola Fiscal (AGT) Item 5", "5/1/2026", "€41 624"], status: "active" as const },
];
...
export default function AngolaFiscalAgtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Angola Fiscal (AGT)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Angola Fiscal (AGT)</p>
                    </div>
                </div>
