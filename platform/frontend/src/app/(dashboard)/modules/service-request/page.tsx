...
/* ═══ Service Request (ITIL) — Dashboard ═══ */

const ACCENT = "#334155";

const KPIS = [
    { label: "Total Registos", value: "6154", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "863", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€256K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1218993054", cells: ["SER-7054", "Service Request (ITIL) Item 1", "7/7/2026", "€43 154"], status: "active" as const },
    { id: "1218996625", cells: ["SER-1625", "Service Request (ITIL) Item 2", "22/2/2026", "€46 725"], status: "pending" as const },
    { id: "1219000196", cells: ["SER-5196", "Service Request (ITIL) Item 3", "9/9/2026", "€296"], status: "completed" as const },
    { id: "1219003767", cells: ["SER-8767", "Service Request (ITIL) Item 4", "24/4/2026", "€3867"], status: "warning" as const },
    { id: "1219007338", cells: ["SER-3338", "Service Request (ITIL) Item 5", "11/11/2026", "€7438"], status: "active" as const },
];
...
export default function ServiceRequestItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Service Request (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Service Request (ITIL)</p>
                    </div>
                </div>
