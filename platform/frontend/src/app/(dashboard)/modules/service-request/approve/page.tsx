...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.241","t":"+5.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.4%","t":"+9.1%","d":"up"},{"l":"Tempo Médio (h)","v":"55h","t":"+11.4%","d":"up"},{"l":"Rejeitadas (%)","v":"78.8%","t":"-5.5%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","373","€ 38526.95","935","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","2.511","€ 11439.87","3.825","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.392","€ 721.43","1.582","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","108","€ 14057.05","4.404","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.316","€ 4160.54","7.192","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":644},{"label":"Mar","value":451},{"label":"Abr","value":326},{"label":"Mai","value":565},{"label":"Jun","value":451},{"label":"Jul","value":492},{"label":"Ago","value":580},{"label":"Set","value":653},{"label":"Out","value":440},{"label":"Nov","value":517},{"label":"Dez","value":350}];
const MX = 653;
