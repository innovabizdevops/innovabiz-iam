...
const PAGE = "Submit";
const KPIS = [{"l":"Total Service Request","v":"7.227","t":"-3.5%","d":"down"},{"l":"Submit Ativos","v":"2.694","t":"+13.8%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+16.4%","d":"up"}];
const COLS = ["ID","Submit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Request #001","Service Request #002","1.658","7.630","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Service Request #002","Service Request #003","8.394","8.919","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Request #003","Service Request #004","2.941","4.335","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Service Request #004","Service Request #005","6.398","4.085","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Request #005","Service Request #001","3.692","9.024","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":549},{"label":"Mar","value":715},{"label":"Abr","value":684},{"label":"Mai","value":924},{"label":"Jun","value":869},{"label":"Jul","value":610},{"label":"Ago","value":835},{"label":"Set","value":842},{"label":"Out","value":859},{"label":"Nov","value":670},{"label":"Dez","value":616}];
const MX = 924;
