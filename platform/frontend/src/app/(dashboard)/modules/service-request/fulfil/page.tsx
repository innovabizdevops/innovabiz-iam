...
const ACCENT = "#334155";
const MODULE = "Service Request (ITIL)";
const PAGE = "Fulfil";
const KPIS = [{"l":"Total Service Request","v":"7.313","t":"+3.6%","d":"up"},{"l":"Fulfil Ativos","v":"2.365","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"77.0%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"62","t":"+11.1%","d":"up"}];
const COLS = ["ID","Fulfil","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Request #001","Service Request #002","3.199","3.949","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Service Request #002","Service Request #003","8.087","571","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Request #003","Service Request #004","5.493","8.483","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Service Request #004","Service Request #005","4.392","5.268","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Request #005","Service Request #001","2.318","1.880","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":794},{"label":"Mar","value":779},{"label":"Abr","value":752},{"label":"Mai","value":767},{"label":"Jun","value":708},{"label":"Jul","value":636},{"label":"Ago","value":717},{"label":"Set","value":474},{"label":"Out","value":523},{"label":"Nov","value":613},{"label":"Dez","value":643}];
const MX = 794;
