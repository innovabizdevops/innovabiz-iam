...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.706","t":"+1.1%","d":"up"},{"l":"Queries/Dia","v":"2949","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"1.181","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"3.814","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1884","2026-02-04","915","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2558","2026-01-24","3.996","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2436","2026-01-20","7.215","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2113","2026-03-14","2.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3836","2026-01-12","405","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":596},{"label":"Mar","value":273},{"label":"Abr","value":615},{"label":"Mai","value":276},{"label":"Jun","value":323},{"label":"Jul","value":374},{"label":"Ago","value":400},{"label":"Set","value":505},{"label":"Out","value":402},{"label":"Nov","value":568},{"label":"Dez","value":414}];
const MX = 615;
