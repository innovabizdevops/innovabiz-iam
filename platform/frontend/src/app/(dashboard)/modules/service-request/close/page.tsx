...
const PAGE = "Close";
const KPIS = [{"l":"Total Service Request","v":"4.332","t":"+16.4%","d":"up"},{"l":"Close Ativos","v":"8.182","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"68.6%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"58","t":"+17.2%","d":"up"}];
const COLS = ["ID","Close","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Request #001","Service Request #002","7.902","4.362","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Service Request #002","Service Request #003","2.258","5.127","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Request #003","Service Request #004","8.528","8.942","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Service Request #004","Service Request #005","5.676","7.948","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Request #005","Service Request #001","491","8.062","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":428},{"label":"Mar","value":511},{"label":"Abr","value":490},{"label":"Mai","value":455},{"label":"Jun","value":735},{"label":"Jul","value":516},{"label":"Ago","value":381},{"label":"Set","value":698},{"label":"Out","value":509},{"label":"Nov","value":402},{"label":"Dez","value":460}];
const MX = 735;
