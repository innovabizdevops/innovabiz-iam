...
/* ═══ Pharma Regulatory — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "3723", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1501", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€309K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "404854223", cells: ["PHA-8223", "Pharma Regulatory Item 1", "12/12/2026", "€4323"], status: "active" as const },
    { id: "404857794", cells: ["PHA-2794", "Pharma Regulatory Item 2", "27/7/2026", "€7894"], status: "pending" as const },
    { id: "404861365", cells: ["PHA-6365", "Pharma Regulatory Item 3", "14/2/2026", "€11 465"], status: "completed" as const },
    { id: "404864936", cells: ["PHA-9936", "Pharma Regulatory Item 4", "1/9/2026", "€15 036"], status: "warning" as const },
    { id: "404868507", cells: ["PHA-4507", "Pharma Regulatory Item 5", "16/4/2026", "€18 607"], status: "active" as const },
];
...
export default function PharmaRegulatoryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Regulatory</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Regulatory</p>
                    </div>
                </div>
