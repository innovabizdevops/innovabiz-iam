...
const PAGE = "Optimize";
const KPIS = [{"l":"Dashboards Ativos","v":"1.964","t":"+3.5%","d":"up"},{"l":"Queries/Dia","v":"1570","t":"+6.1%","d":"up"},{"l":"Dados Processados (GB)","v":"9.028","t":"-3.6%","d":"down"},{"l":"Utilizadores Analytics","v":"4.183","t":"+2.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2456","2026-02-19","1.054","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3663","2026-01-24","3.025","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","301","2026-01-19","3.958","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","525","2026-03-27","5.946","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3949","2026-03-15","6.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":786},{"label":"Mar","value":865},{"label":"Abr","value":948},{"label":"Mai","value":759},{"label":"Jun","value":924},{"label":"Jul","value":929},{"label":"Ago","value":828},{"label":"Set","value":968},{"label":"Out","value":810},{"label":"Nov","value":978},{"label":"Dez","value":781}];
const MX = 978;
