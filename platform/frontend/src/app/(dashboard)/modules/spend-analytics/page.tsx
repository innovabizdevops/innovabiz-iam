...
const KPIS = [
    ...
    { label: "Ativos", value: "4395", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€357K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "570928638", cells: ["SPE-5638", "Spend Analytics Item 1", "15/7/2026", "€28 738"], status: "active" as const },
    { id: "570932209", cells: ["SPE-9209", "Spend Analytics Item 2", "2/2/2026", "€32 309"], status: "pending" as const },
    { id: "570935780", cells: ["SPE-3780", "Spend Analytics Item 3", "17/9/2026", "€35 880"], status: "completed" as const },
    { id: "570939351", cells: ["SPE-7351", "Spend Analytics Item 4", "4/4/2026", "€39 451"], status: "warning" as const },
    { id: "570942922", cells: ["SPE-1922", "Spend Analytics Item 5", "19/11/2026", "€43 022"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Spend Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Spend Analytics</p>
                    </div>
                </div>
