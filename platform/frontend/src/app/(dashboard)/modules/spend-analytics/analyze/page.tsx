...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"7.725","t":"+7.9%","d":"up"},{"l":"Queries/Dia","v":"4407","t":"+2.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.866","t":"+15.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.457","t":"-4.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3566","2026-01-06","6.422","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","429","2026-03-21","4.530","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1607","2026-02-03","1.917","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","909","2026-02-17","1.128","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2085","2026-03-02","241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":772},{"label":"Mar","value":805},{"label":"Abr","value":532},{"label":"Mai","value":588},{"label":"Jun","value":620},{"label":"Jul","value":603},{"label":"Ago","value":704},{"label":"Set","value":722},{"label":"Out","value":750},{"label":"Nov","value":833},{"label":"Dez","value":799}];
const MX = 843;
