...
const KPIS = [{"l":"Dashboards Ativos","v":"874","t":"+16.7%","d":"up"},{"l":"Queries/Dia","v":"3982","t":"+14.3%","d":"up"},{"l":"Dados Processados (GB)","v":"660","t":"+15.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.269","t":"-1.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2580","2026-02-19","5.560","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1439","2026-03-26","2.630","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1301","2026-03-12","814","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3327","2026-03-10","4.216","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4512","2026-02-20","4.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1054},{"label":"Fev","value":1047},{"label":"Mar","value":759},{"label":"Abr","value":728},{"label":"Mai","value":954},{"label":"Jun","value":894},{"label":"Jul","value":768},{"label":"Ago","value":1021},{"label":"Set","value":942},{"label":"Out","value":802},{"label":"Nov","value":884},{"label":"Dez","value":1043}];
const MX = 1054;
