...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"945","t":"+6.0%","d":"up"},{"l":"Queries/Dia","v":"3909","t":"+13.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.049","t":"+15.4%","d":"up"},{"l":"Utilizadores Analytics","v":"2.010","t":"+12.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4124","2026-02-23","961","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2674","2026-01-21","4.627","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4846","2026-01-21","8.569","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3311","2026-03-09","8.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1514","2026-01-18","9.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":726},{"label":"Mar","value":455},{"label":"Abr","value":428},{"label":"Mai","value":388},{"label":"Jun","value":411},{"label":"Jul","value":496},{"label":"Ago","value":669},{"label":"Set","value":493},{"label":"Out","value":508},{"label":"Nov","value":351},{"label":"Dez","value":683}];
const MX = 726;
