...
const ACCENT = "#0891b2";
const MODULE = "Spend Analytics";
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"8.636","t":"-5.5%","d":"down"},{"l":"Queries/Dia","v":"4134","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.492","t":"+1.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.656","t":"+0.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3491","2026-02-04","2.821","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2999","2026-01-08","8.828","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4770","2026-02-01","7.936","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4249","2026-02-16","1.852","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4694","2026-03-03","6.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":723},{"label":"Mar","value":398},{"label":"Abr","value":562},{"label":"Mai","value":438},{"label":"Jun","value":590},{"label":"Jul","value":496},{"label":"Ago","value":405},{"label":"Set","value":642},{"label":"Out","value":560},{"label":"Nov","value":651},{"label":"Dez","value":378}];
const MX = 723;
