...
/* ═══ Hotel Laundry — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "7985", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1207", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€199K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1566801685", cells: ["HOT-1685", "Hotel Laundry Item 1", "2/2/2026", "€1785"], status: "active" as const },
    { id: "1566805256", cells: ["HOT-5256", "Hotel Laundry Item 2", "17/9/2026", "€5356"], status: "pending" as const },
    { id: "1566808827", cells: ["HOT-8827", "Hotel Laundry Item 3", "4/4/2026", "€8927"], status: "completed" as const },
    { id: "1566812398", cells: ["HOT-3398", "Hotel Laundry Item 4", "19/11/2026", "€12 498"], status: "warning" as const },
    { id: "1566815969", cells: ["HOT-6969", "Hotel Laundry Item 5", "6/6/2026", "€16 069"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hotel Laundry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hotel Laundry</p>
                    </div>
                </div>
