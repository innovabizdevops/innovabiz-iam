...
const ACCENT = "#164e63";
const MODULE = "Hotel Laundry";
const PAGE = "Process";
const KPIS = [{"l":"Quartos Ocupados","v":"7.171","t":"-2.5%","d":"down"},{"l":"RevPAR (€)","v":"€91367","t":"+1.9%","d":"up"},{"l":"Ocupação (%)","v":"91.5%","t":"+15.0%","d":"up"},{"l":"Guest Satisfaction","v":"6.888","t":"+11.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.889","2026-01-24","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.190","2026-02-17","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.801","2026-02-16","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.594","2026-02-22","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.331","2026-03-04","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":598},{"label":"Mar","value":767},{"label":"Abr","value":719},{"label":"Mai","value":579},{"label":"Jun","value":833},{"label":"Jul","value":531},{"label":"Ago","value":643},{"label":"Set","value":568},{"label":"Out","value":723},{"label":"Nov","value":842},{"label":"Dez","value":666}];
const MX = 842;
