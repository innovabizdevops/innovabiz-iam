...
const PAGE = "Linen";
const KPIS = [{"l":"Quartos Ocupados","v":"7.681","t":"+10.8%","d":"up"},{"l":"RevPAR (€)","v":"€72921","t":"+10.8%","d":"up"},{"l":"Ocupação (%)","v":"79.1%","t":"+5.8%","d":"up"},{"l":"Guest Satisfaction","v":"1.721","t":"-5.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","983","2026-01-27","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.313","2026-02-11","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.588","2026-03-12","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.238","2026-01-17","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.114","2026-03-25","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":764},{"label":"Mar","value":689},{"label":"Abr","value":677},{"label":"Mai","value":809},{"label":"Jun","value":877},{"label":"Jul","value":616},{"label":"Ago","value":646},{"label":"Set","value":834},{"label":"Out","value":841},{"label":"Nov","value":614},{"label":"Dez","value":605}];
const MX = 877;
