...
const PAGE = "PAR";
const KPIS = [{"l":"Quartos Ocupados","v":"6.238","t":"+3.9%","d":"up"},{"l":"RevPAR (€)","v":"€7684","t":"+1.6%","d":"up"},{"l":"Ocupação (%)","v":"94.1%","t":"+13.0%","d":"up"},{"l":"Guest Satisfaction","v":"620","t":"+7.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","251","2026-03-21","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.766","2026-03-04","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.114","2026-01-12","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.903","2026-01-04","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.112","2026-02-07","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":671},{"label":"Mar","value":812},{"label":"Abr","value":802},{"label":"Mai","value":738},{"label":"Jun","value":762},{"label":"Jul","value":619},{"label":"Ago","value":653},{"label":"Set","value":572},{"label":"Out","value":611},{"label":"Nov","value":867},{"label":"Dez","value":589}];
const MX = 867;
