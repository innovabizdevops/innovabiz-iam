...
const KPIS = [{"l":"Total Job Scheduler","v":"7.363","t":"+15.1%","d":"up"},{"l":"Dependencies Ativos","v":"1.325","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"77","t":"+7.8%","d":"up"}];
const COLS = ["ID","Dependencies","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Job Scheduler #001","Job Scheduler #002","7.282","7.999","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Job Scheduler #002","Job Scheduler #003","3.294","8.322","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Job Scheduler #003","Job Scheduler #004","5.545","1.595","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Job Scheduler #004","Job Scheduler #005","1.941","1.976","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Job Scheduler #005","Job Scheduler #001","1.590","7.143","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":340},{"label":"Fev","value":325},{"label":"Mar","value":383},{"label":"Abr","value":611},{"label":"Mai","value":436},{"label":"Jun","value":324},{"label":"Jul","value":413},{"label":"Ago","value":351},{"label":"Set","value":438},{"label":"Out","value":531},{"label":"Nov","value":588},{"label":"Dez","value":498}];
const MX = 611;
