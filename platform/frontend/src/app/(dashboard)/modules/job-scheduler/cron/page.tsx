...
const PAGE = "Cron Jobs";
const KPIS = [{"l":"Total Job Scheduler","v":"8.235","t":"+8.2%","d":"up"},{"l":"Cron Jobs Ativos","v":"6.396","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"81.9%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+16.3%","d":"up"}];
const COLS = ["ID","Cron Jobs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Job Scheduler #001","Job Scheduler #002","4.369","5.049","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Job Scheduler #002","Job Scheduler #003","8.852","2.284","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Job Scheduler #003","Job Scheduler #004","8.685","8.160","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Job Scheduler #004","Job Scheduler #005","2.160","743","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Job Scheduler #005","Job Scheduler #001","6.762","3.214","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":443},{"label":"Mar","value":730},{"label":"Abr","value":713},{"label":"Mai","value":600},{"label":"Jun","value":720},{"label":"Jul","value":456},{"label":"Ago","value":392},{"label":"Set","value":636},{"label":"Out","value":594},{"label":"Nov","value":608},{"label":"Dez","value":439}];
const MX = 730;
