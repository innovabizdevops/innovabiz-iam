...
const PAGE = "Job Queue";
const KPIS = [{"l":"Total Job Scheduler","v":"1.890","t":"-3.5%","d":"down"},{"l":"Job Queue Ativos","v":"5.762","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"81","t":"+3.4%","d":"up"}];
const COLS = ["ID","Job Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Job Scheduler #001","Job Scheduler #002","2.169","2.105","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Job Scheduler #002","Job Scheduler #003","7.035","9.003","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Job Scheduler #003","Job Scheduler #004","8.082","4.243","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Job Scheduler #004","Job Scheduler #005","5.742","3.357","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Job Scheduler #005","Job Scheduler #001","7.775","1.302","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":508},{"label":"Mar","value":571},{"label":"Abr","value":365},{"label":"Mai","value":560},{"label":"Jun","value":403},{"label":"Jul","value":372},{"label":"Ago","value":391},{"label":"Set","value":705},{"label":"Out","value":423},{"label":"Nov","value":485},{"label":"Dez","value":598}];
const MX = 705;
