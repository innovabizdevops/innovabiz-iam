...
const PAGE = "Execution Log";
const KPIS = [{"l":"Total Job Scheduler","v":"2.909","t":"-1.8%","d":"down"},{"l":"Execution Log Ativos","v":"842","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+8.7%","d":"up"}];
const COLS = ["ID","Execution Log","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Job Scheduler #001","Job Scheduler #002","5.709","3.131","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Job Scheduler #002","Job Scheduler #003","2.375","8.732","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Job Scheduler #003","Job Scheduler #004","3.330","4.245","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Job Scheduler #004","Job Scheduler #005","2.219","1.621","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Job Scheduler #005","Job Scheduler #001","8.768","2.388","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":722},{"label":"Mar","value":643},{"label":"Abr","value":395},{"label":"Mai","value":686},{"label":"Jun","value":549},{"label":"Jul","value":582},{"label":"Ago","value":437},{"label":"Set","value":718},{"label":"Out","value":529},{"label":"Nov","value":340},{"label":"Dez","value":735}];
const MX = 735;
