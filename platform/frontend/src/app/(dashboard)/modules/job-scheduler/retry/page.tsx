...
const ACCENT = "#475569";
const MODULE = "Job Scheduler";
const PAGE = "Retry Policies";
const KPIS = [{"l":"Total Job Scheduler","v":"536","t":"-0.6%","d":"down"},{"l":"Retry Policies Ativos","v":"5.606","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"88","t":"+4.4%","d":"up"}];
const COLS = ["ID","Retry Policies","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Job Scheduler #001","Job Scheduler #002","4.476","7.681","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Job Scheduler #002","Job Scheduler #003","3.460","1.480","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Job Scheduler #003","Job Scheduler #004","4.636","5.463","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Job Scheduler #004","Job Scheduler #005","8.500","828","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Job Scheduler #005","Job Scheduler #001","4.070","203","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":731},{"label":"Mar","value":689},{"label":"Abr","value":613},{"label":"Mai","value":521},{"label":"Jun","value":696},{"label":"Jul","value":493},{"label":"Ago","value":547},{"label":"Set","value":541},{"label":"Out","value":567},{"label":"Nov","value":722},{"label":"Dez","value":750}];
const MX = 750;
