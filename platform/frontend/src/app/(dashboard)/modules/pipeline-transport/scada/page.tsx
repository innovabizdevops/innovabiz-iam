...
const PAGE = "SCADA";
const KPIS = [{"l":"Dispositivos Online","v":"8.231","t":"-0.6%","d":"down"},{"l":"Dados/Min (MB)","v":"2.557","t":"+3.8%","d":"up"},{"l":"Alertas Ativos","v":"9.022","t":"+14.8%","d":"up"},{"l":"Uptime (%)","v":"72.0%","t":"+10.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.210","8.595","3.142","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.675","4.480","4.507","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.628","4.856","263","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.506","560","7.594","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.561","751","1.459","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":756},{"label":"Mar","value":689},{"label":"Abr","value":551},{"label":"Mai","value":752},{"label":"Jun","value":701},{"label":"Jul","value":464},{"label":"Ago","value":750},{"label":"Set","value":499},{"label":"Out","value":809},{"label":"Nov","value":728},{"label":"Dez","value":653}];
const MX = 823;
