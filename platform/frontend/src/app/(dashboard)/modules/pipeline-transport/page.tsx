...
export default function PipelineTransportPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pipeline Transport</h1><p className="text-sm text-muted-foreground">Pipeline Transport • iBOS Enterprise</p></div>
