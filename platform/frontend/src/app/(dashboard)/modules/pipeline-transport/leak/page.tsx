...
const PAGE = "Leak";
const KPIS = [{"l":"Atletas Registados","v":"4.326","t":"-5.5%","d":"down"},{"l":"Treinos/Semana","v":"4380","t":"+7.2%","d":"up"},{"l":"Competições","v":"2.590","t":"+16.0%","d":"up"},{"l":"Performance Score","v":"66","t":"+9.9%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.669","332","6.501","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.638","4.151","7.079","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.091","8.388","2.811","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","579","9.072","3.885","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.069","616","8.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":606},{"label":"Mar","value":560},{"label":"Abr","value":348},{"label":"Mai","value":428},{"label":"Jun","value":606},{"label":"Jul","value":394},{"label":"Ago","value":666},{"label":"Set","value":416},{"label":"Out","value":531},{"label":"Nov","value":543},{"label":"Dez","value":551}];
const MX = 666;
