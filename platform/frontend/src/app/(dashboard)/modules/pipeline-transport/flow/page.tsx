...
const ACCENT = "#6366f1";
const MODULE = "Pipeline Transport";
const PAGE = "Flow";
const KPIS = [{"l":"Atletas Registados","v":"3.910","t":"-4.2%","d":"down"},{"l":"Treinos/Semana","v":"2878","t":"-1.2%","d":"down"},{"l":"Competições","v":"5.590","t":"-2.6%","d":"down"},{"l":"Performance Score","v":"78","t":"+13.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.203","895","374","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.002","5.819","815","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","127","6.273","6.063","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.294","4.535","4.153","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.238","8.720","3.812","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":521},{"label":"Mar","value":826},{"label":"Abr","value":675},{"label":"Mai","value":576},{"label":"Jun","value":722},{"label":"Jul","value":760},{"label":"Ago","value":729},{"label":"Set","value":767},{"label":"Out","value":643},{"label":"Nov","value":542},{"label":"Dez","value":504}];
const MX = 826;
