...
const PAGE = "Integrity";
const KPIS = [{"l":"Atletas Registados","v":"5.258","t":"+6.2%","d":"up"},{"l":"Treinos/Semana","v":"1305","t":"-0.7%","d":"down"},{"l":"Competições","v":"8.428","t":"+7.6%","d":"up"},{"l":"Performance Score","v":"66","t":"+12.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.578","8.347","1.314","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","379","1.563","7.280","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.087","3.847","3.043","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.348","5.269","3.286","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.642","4.374","6.356","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":634},{"label":"Mar","value":530},{"label":"Abr","value":738},{"label":"Mai","value":694},{"label":"Jun","value":788},{"label":"Jul","value":813},{"label":"Ago","value":820},{"label":"Set","value":462},{"label":"Out","value":476},{"label":"Nov","value":506},{"label":"Dez","value":678}];
const MX = 820;
