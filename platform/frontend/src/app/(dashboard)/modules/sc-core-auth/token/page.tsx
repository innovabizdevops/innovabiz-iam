...
const PAGE = "Token";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.723","t":"+8.0%","d":"up"},{"l":"Sessões/Dia","v":"1385","t":"-1.6%","d":"down"},{"l":"MFA Adoção (%)","v":"72.2%","t":"-5.3%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.759","t":"+6.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.838","5.931","2.927","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.748","2.155","4.898","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.010","1.746","7.999","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.588","725","4.587","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","985","1.871","1.409","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":339},{"label":"Mar","value":388},{"label":"Abr","value":672},{"label":"Mai","value":373},{"label":"Jun","value":535},{"label":"Jul","value":495},{"label":"Ago","value":490},{"label":"Set","value":530},{"label":"Out","value":593},{"label":"Nov","value":441},{"label":"Dez","value":704}];
const MX = 704;
