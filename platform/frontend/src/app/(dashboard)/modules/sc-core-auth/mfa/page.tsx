...
const PAGE = "MFA";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.568","t":"-5.4%","d":"down"},{"l":"Sessões/Dia","v":"4902","t":"-3.0%","d":"down"},{"l":"MFA Adoção (%)","v":"80.0%","t":"-5.2%","d":"down"},{"l":"Tentativas Bloqueadas","v":"6.565","t":"+12.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.341","7.184","2.437","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.854","4.485","8.796","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.609","8.514","6.605","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.192","4.432","581","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.251","5.977","7.978","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":254},{"label":"Mar","value":261},{"label":"Abr","value":636},{"label":"Mai","value":489},{"label":"Jun","value":328},{"label":"Jul","value":485},{"label":"Ago","value":494},{"label":"Set","value":263},{"label":"Out","value":425},{"label":"Nov","value":278},{"label":"Dez","value":433}];
const MX = 636;
