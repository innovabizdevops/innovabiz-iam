...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.075","t":"-1.7%","d":"down"},{"l":"NC Abertas","v":"141","t":"+3.6%","d":"up"},{"l":"Conformidade (%)","v":"85.6%","t":"+14.5%","d":"up"},{"l":"CAPAs Pendentes","v":"8.505","t":"+7.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.807","97.0%","4.013","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.364","94.5%","3.011","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.292","87.3%","375","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","120","99.0%","2.030","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.346","84.4%","6.242","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":650},{"label":"Mar","value":471},{"label":"Abr","value":340},{"label":"Mai","value":391},{"label":"Jun","value":601},{"label":"Jul","value":449},{"label":"Ago","value":592},{"label":"Set","value":449},{"label":"Out","value":707},{"label":"Nov","value":502},{"label":"Dez","value":487}];
const MX = 707;
