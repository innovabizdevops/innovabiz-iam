...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Auth (JWT/OAuth)";
const PAGE = "Strategy";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.685","t":"+11.7%","d":"up"},{"l":"Sessões/Dia","v":"1898","t":"+5.6%","d":"up"},{"l":"MFA Adoção (%)","v":"80.1%","t":"-4.5%","d":"down"},{"l":"Tentativas Bloqueadas","v":"3.703","t":"-1.8%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.368","1.353","8.595","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.605","5.972","8.678","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.083","8.223","2.643","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.274","2.827","5.061","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.975","3.734","7.826","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":941},{"label":"Mar","value":864},{"label":"Abr","value":754},{"label":"Mai","value":845},{"label":"Jun","value":876},{"label":"Jul","value":718},{"label":"Ago","value":718},{"label":"Set","value":788},{"label":"Out","value":727},{"label":"Nov","value":808},{"label":"Dez","value":868}];
const MX = 941;
