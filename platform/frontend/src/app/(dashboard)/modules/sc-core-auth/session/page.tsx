...
const PAGE = "Session";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.582","t":"+4.3%","d":"up"},{"l":"Sessões/Dia","v":"2694","t":"+13.4%","d":"up"},{"l":"MFA Adoção (%)","v":"92.3%","t":"+11.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.548","t":"-3.5%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.119","7.185","3.737","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.906","5.222","2.022","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.577","9.088","3.952","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.558","8.107","4.991","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.293","4.231","1.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":716},{"label":"Mar","value":690},{"label":"Abr","value":504},{"label":"Mai","value":413},{"label":"Jun","value":380},{"label":"Jul","value":711},{"label":"Ago","value":717},{"label":"Set","value":714},{"label":"Out","value":739},{"label":"Nov","value":619},{"label":"Dez","value":611}];
const MX = 739;
