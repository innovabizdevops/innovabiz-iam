...
/* ═══ SC: Core Auth (JWT/OAuth) — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "9696", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1772", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€279K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "952973696", cells: ["SC-9696", "SC: Core Auth (JWT/OAuth) Item 1", "25/9/2026", "€23 796"], status: "active" as const },
    { id: "952977267", cells: ["SC-4267", "SC: Core Auth (JWT/OAuth) Item 2", "12/4/2026", "€27 367"], status: "pending" as const },
    { id: "952980838", cells: ["SC-7838", "SC: Core Auth (JWT/OAuth) Item 3", "27/11/2026", "€30 938"], status: "completed" as const },
    { id: "952984409", cells: ["SC-2409", "SC: Core Auth (JWT/OAuth) Item 4", "14/6/2026", "€34 509"], status: "warning" as const },
    { id: "952987980", cells: ["SC-5980", "SC: Core Auth (JWT/OAuth) Item 5", "1/1/2026", "€38 080"], status: "active" as const },
];
...
export default function ScCoreAuthJwtoauthPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Auth (JWT/OAuth)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Auth (JWT/OAuth)</p>
                    </div>
                </div>
