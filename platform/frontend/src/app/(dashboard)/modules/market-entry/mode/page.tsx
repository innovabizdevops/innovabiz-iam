...
const ACCENT = "#1e40af";
const MODULE = "Market Entry Strategy";
const PAGE = "Entry Mode";
const KPIS = [{"l":"Total Market Entry","v":"6.595","t":"+0.4%","d":"up"},{"l":"Entry Mode Ativos","v":"5.471","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+4.5%","d":"up"}];
const COLS = ["ID","Entry Mode","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Market Entry #001","Market Entry #002","8.319","4.864","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Market Entry #002","Market Entry #003","7.702","7.711","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Market Entry #003","Market Entry #004","1.002","4.419","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Market Entry #004","Market Entry #005","6.854","2.828","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Market Entry #005","Market Entry #001","4.752","9.005","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":674},{"label":"Mar","value":804},{"label":"Abr","value":1005},{"label":"Mai","value":813},{"label":"Jun","value":845},{"label":"Jul","value":795},{"label":"Ago","value":816},{"label":"Set","value":796},{"label":"Out","value":885},{"label":"Nov","value":867},{"label":"Dez","value":745}];
const MX = 1005;
