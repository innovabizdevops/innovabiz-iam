...
const PAGE = "PESTEL";
const KPIS = [{"l":"Total Market Entry","v":"4.974","t":"+0.1%","d":"up"},{"l":"PESTEL Ativos","v":"1.874","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+16.4%","d":"up"}];
const COLS = ["ID","PESTEL","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Market Entry #001","Market Entry #002","7.627","5.904","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Market Entry #002","Market Entry #003","6.459","1.856","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Market Entry #003","Market Entry #004","4.409","6.669","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Market Entry #004","Market Entry #005","8.712","4.881","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Market Entry #005","Market Entry #001","7.303","1.449","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":916},{"label":"Mar","value":775},{"label":"Abr","value":788},{"label":"Mai","value":707},{"label":"Jun","value":974},{"label":"Jul","value":816},{"label":"Ago","value":838},{"label":"Set","value":906},{"label":"Out","value":645},{"label":"Nov","value":969},{"label":"Dez","value":742}];
const MX = 974;
