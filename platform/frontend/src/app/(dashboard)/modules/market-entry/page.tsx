...
const KPIS = [
    { label: "Total Registos", value: "7752", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3501", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€178K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1974414152", cells: ["MAR-4152", "Market Entry Strategy Item 1", "5/9/2026", "€14 252"], status: "active" as const },
    { id: "1974417723", cells: ["MAR-7723", "Market Entry Strategy Item 2", "20/4/2026", "€17 823"], status: "pending" as const },
    { id: "1974421294", cells: ["MAR-2294", "Market Entry Strategy Item 3", "7/11/2026", "€21 394"], status: "completed" as const },
    { id: "1974424865", cells: ["MAR-5865", "Market Entry Strategy Item 4", "22/6/2026", "€24 965"], status: "warning" as const },
    { id: "1974428436", cells: ["MAR-9436", "Market Entry Strategy Item 5", "9/1/2026", "€28 536"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Market Entry Strategy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Market Entry Strategy</p>
                    </div>
                </div>
