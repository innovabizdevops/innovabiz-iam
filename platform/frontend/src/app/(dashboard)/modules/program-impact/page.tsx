...
/* ═══ Program Impact Management — Dashboard ═══ */

const ACCENT = "#e11d48";

const KPIS = [
    { label: "Total Registos", value: "1022", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2655", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€316K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "923601622", cells: ["PRO-4622", "Program Impact Management Item 1", "7/11/2026", "€1722"], status: "active" as const },
    { id: "923605193", cells: ["PRO-8193", "Program Impact Management Item 2", "22/6/2026", "€5293"], status: "pending" as const },
    { id: "923608764", cells: ["PRO-2764", "Program Impact Management Item 3", "9/1/2026", "€8864"], status: "completed" as const },
    { id: "923612335", cells: ["PRO-6335", "Program Impact Management Item 4", "24/8/2026", "€12 435"], status: "warning" as const },
    { id: "923615906", cells: ["PRO-9906", "Program Impact Management Item 5", "11/3/2026", "€16 006"], status: "active" as const },
];
...
export default function ProgramImpactManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Program Impact Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Program Impact Management</p>
                    </div>
                </div>
