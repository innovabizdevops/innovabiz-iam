...
const KPIS = [{"l":"Projetos Sociais","v":"8.968","t":"+10.1%","d":"up"},{"l":"Beneficiários","v":"7.423","t":"+3.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€6090","t":"+2.7%","d":"up"},{"l":"Score Impacto","v":"79","t":"+4.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.184","€ 30746.93","1.362","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","8.072","€ 19248.03","9.005","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.367","€ 35104.56","6.219","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.550","€ 34977.18","1.789","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","689","€ 48011.73","5.973","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":683},{"label":"Mar","value":726},{"label":"Abr","value":1018},{"label":"Mai","value":937},{"label":"Jun","value":641},{"label":"Jul","value":851},{"label":"Ago","value":770},{"label":"Set","value":962},{"label":"Out","value":881},{"label":"Nov","value":985},{"label":"Dez","value":933}];
const MX = 1018;
