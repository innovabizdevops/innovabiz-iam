...
const PAGE = "Report";
const KPIS = [{"l":"Projetos Sociais","v":"5.157","t":"+5.6%","d":"up"},{"l":"Beneficiários","v":"1.274","t":"+8.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€12911","t":"+8.1%","d":"up"},{"l":"Score Impacto","v":"59","t":"+10.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.640","€ 26635.34","3.616","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","8.882","€ 45681.21","1.889","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.997","€ 45879.49","2.746","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.740","€ 19911.80","6.371","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.326","€ 20836.85","2.197","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":705},{"label":"Mar","value":638},{"label":"Abr","value":610},{"label":"Mai","value":678},{"label":"Jun","value":425},{"label":"Jul","value":583},{"label":"Ago","value":546},{"label":"Set","value":400},{"label":"Out","value":575},{"label":"Nov","value":642},{"label":"Dez","value":602}];
const MX = 705;
