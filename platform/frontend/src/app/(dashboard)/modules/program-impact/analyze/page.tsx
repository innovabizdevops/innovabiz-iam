...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"6.706","t":"+16.0%","d":"up"},{"l":"Queries/Dia","v":"2817","t":"+12.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.518","t":"+8.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.310","t":"+7.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4268","2026-01-23","3.600","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2720","2026-02-22","7.305","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4438","2026-02-24","2.880","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5034","2026-01-26","423","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4999","2026-03-23","7.823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":457},{"label":"Mar","value":772},{"label":"Abr","value":454},{"label":"Mai","value":447},{"label":"Jun","value":482},{"label":"Jul","value":569},{"label":"Ago","value":742},{"label":"Set","value":668},{"label":"Out","value":585},{"label":"Nov","value":435},{"label":"Dez","value":527}];
const MX = 772;
