...
const ACCENT = "#e11d48";
const MODULE = "Program Impact Management";
const PAGE = "Collect";
const KPIS = [{"l":"Projetos Sociais","v":"4.300","t":"-4.6%","d":"down"},{"l":"Beneficiários","v":"636","t":"-2.1%","d":"down"},{"l":"Investimento CSR (€)","v":"€69106","t":"-2.0%","d":"down"},{"l":"Score Impacto","v":"78","t":"+14.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.685","€ 45938.78","7.240","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.443","€ 18799.98","8.223","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.103","€ 31424.86","7.722","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.157","€ 11598.48","3.620","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.765","€ 5689.41","5.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":486},{"label":"Mar","value":618},{"label":"Abr","value":544},{"label":"Mai","value":645},{"label":"Jun","value":674},{"label":"Jul","value":619},{"label":"Ago","value":651},{"label":"Set","value":517},{"label":"Out","value":663},{"label":"Nov","value":614},{"label":"Dez","value":657}];
const MX = 674;
