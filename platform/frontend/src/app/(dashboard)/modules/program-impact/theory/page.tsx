...
const PAGE = "Theory";
const KPIS = [{"l":"Projetos Sociais","v":"4.146","t":"+7.1%","d":"up"},{"l":"Beneficiários","v":"1.598","t":"-1.8%","d":"down"},{"l":"Investimento CSR (€)","v":"€50798","t":"+0.9%","d":"up"},{"l":"Score Impacto","v":"56","t":"-4.5%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.561","€ 22848.88","3.984","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.711","€ 15685.05","4.560","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.565","€ 32376.60","4.640","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.315","€ 44788.18","5.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.262","€ 34427.02","6.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":800},{"label":"Mar","value":946},{"label":"Abr","value":960},{"label":"Mai","value":775},{"label":"Jun","value":958},{"label":"Jul","value":987},{"label":"Ago","value":904},{"label":"Set","value":966},{"label":"Out","value":938},{"label":"Nov","value":952},{"label":"Dez","value":630}];
const MX = 987;
