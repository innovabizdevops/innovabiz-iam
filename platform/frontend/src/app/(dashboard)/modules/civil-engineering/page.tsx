...
/* ═══ Civil Engineering Platform — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "2828", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1583", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€309K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "319594528", cells: ["CIV-5528", "Civil Engineering Platform Item 1", "9/5/2026", "€44 628"], status: "active" as const },
    { id: "319598099", cells: ["CIV-9099", "Civil Engineering Platform Item 2", "24/12/2026", "€48 199"], status: "pending" as const },
    { id: "319601670", cells: ["CIV-3670", "Civil Engineering Platform Item 3", "11/7/2026", "€1770"], status: "completed" as const },
    { id: "319605241", cells: ["CIV-7241", "Civil Engineering Platform Item 4", "26/2/2026", "€5341"], status: "warning" as const },
    { id: "319608812", cells: ["CIV-1812", "Civil Engineering Platform Item 5", "13/9/2026", "€8912"], status: "active" as const },
];
...
export default function CivilEngineeringPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Civil Engineering Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Civil Engineering Platform</p>
                    </div>
                </div>
