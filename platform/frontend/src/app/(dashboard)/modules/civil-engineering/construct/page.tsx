...
const ACCENT = "#78350f";
const MODULE = "Civil Engineering Platform";
const PAGE = "Construct";
const KPIS = [{"l":"Total Civil Engineering","v":"6.202","t":"+1.6%","d":"up"},{"l":"Construct Ativos","v":"7.129","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"90","t":"+5.9%","d":"up"}];
const COLS = ["ID","Construct","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Civil Engineering #001","Civil Engineering #002","5.194","4.344","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Civil Engineering #002","Civil Engineering #003","8.821","580","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Civil Engineering #003","Civil Engineering #004","3.398","5.591","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Civil Engineering #004","Civil Engineering #005","7.426","1.406","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Civil Engineering #005","Civil Engineering #001","3.346","7.387","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":736},{"label":"Mar","value":822},{"label":"Abr","value":754},{"label":"Mai","value":733},{"label":"Jun","value":774},{"label":"Jul","value":580},{"label":"Ago","value":514},{"label":"Set","value":836},{"label":"Out","value":714},{"label":"Nov","value":698},{"label":"Dez","value":734}];
const MX = 871;
