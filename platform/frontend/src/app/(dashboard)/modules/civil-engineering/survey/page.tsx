...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"7.880","t":"+8.0%","d":"up"},{"l":"Respostas/Semana","v":"2215","t":"+17.3%","d":"up"},{"l":"NPS Médio","v":"68","t":"-5.6%","d":"down"},{"l":"Taxa Resposta (%)","v":"80.2%","t":"+14.2%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.932","87","88.6%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","334","73","85.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.650","71","85.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.051","68","75.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.787","78","89.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":663},{"label":"Mar","value":775},{"label":"Abr","value":949},{"label":"Mai","value":763},{"label":"Jun","value":671},{"label":"Jul","value":619},{"label":"Ago","value":689},{"label":"Set","value":763},{"label":"Out","value":796},{"label":"Nov","value":788},{"label":"Dez","value":673}];
const MX = 949;
