...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"414","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"256","t":"+9.5%","d":"up"},{"l":"Documentos Gerados","v":"4.172","t":"-0.7%","d":"down"},{"l":"Templates","v":"6.254","t":"+9.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.422","2026-02-26","4.930","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.228","2026-03-07","5.163","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.324","2026-01-04","7.146","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.016","2026-02-03","8.364","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.840","2026-01-18","2.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":442},{"label":"Mar","value":477},{"label":"Abr","value":280},{"label":"Mai","value":435},{"label":"Jun","value":487},{"label":"Jul","value":306},{"label":"Ago","value":234},{"label":"Set","value":270},{"label":"Out","value":325},{"label":"Nov","value":501},{"label":"Dez","value":436}];
const MX = 605;
