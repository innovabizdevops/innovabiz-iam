...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"8.858","t":"+13.3%","d":"up"},{"l":"Queries/Dia","v":"4216","t":"+10.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.940","t":"+10.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.930","t":"+14.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2652","2026-03-23","4.469","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1594","2026-01-12","4.069","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2045","2026-01-21","671","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1461","2026-02-24","5.584","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3912","2026-03-28","7.604","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":1001},{"label":"Mar","value":1010},{"label":"Abr","value":818},{"label":"Mai","value":819},{"label":"Jun","value":900},{"label":"Jul","value":661},{"label":"Ago","value":651},{"label":"Set","value":950},{"label":"Out","value":733},{"label":"Nov","value":914},{"label":"Dez","value":650}];
const MX = 1010;
