...
const PAGE = "Substrate";
const KPIS = [{"l":"Total Mushroom Farm","v":"2.424","t":"+8.3%","d":"up"},{"l":"Substrate Ativos","v":"5.147","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"67.7%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+11.8%","d":"up"}];
const COLS = ["ID","Substrate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mushroom Farm #001","Mushroom Farm #002","1.995","5.741","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Mushroom Farm #002","Mushroom Farm #003","6.775","2.750","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Mushroom Farm #003","Mushroom Farm #004","8.893","7.808","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mushroom Farm #004","Mushroom Farm #005","3.257","486","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mushroom Farm #005","Mushroom Farm #001","3.931","445","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":710},{"label":"Mar","value":765},{"label":"Abr","value":626},{"label":"Mai","value":856},{"label":"Jun","value":616},{"label":"Jul","value":850},{"label":"Ago","value":709},{"label":"Set","value":659},{"label":"Out","value":815},{"label":"Nov","value":714},{"label":"Dez","value":543}];
const MX = 856;
