...
const PAGE = "Pack";
const KPIS = [{"l":"Total Mushroom Farm","v":"2.929","t":"+5.8%","d":"up"},{"l":"Pack Ativos","v":"4.153","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"70","t":"+0.5%","d":"up"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mushroom Farm #001","Mushroom Farm #002","3.382","3.369","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mushroom Farm #002","Mushroom Farm #003","3.396","2.230","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Mushroom Farm #003","Mushroom Farm #004","5.798","8.730","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Mushroom Farm #004","Mushroom Farm #005","3.202","570","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mushroom Farm #005","Mushroom Farm #001","524","6.455","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":634},{"label":"Mar","value":885},{"label":"Abr","value":863},{"label":"Mai","value":713},{"label":"Jun","value":892},{"label":"Jul","value":984},{"label":"Ago","value":653},{"label":"Set","value":882},{"label":"Out","value":814},{"label":"Nov","value":899},{"label":"Dez","value":714}];
const MX = 984;
