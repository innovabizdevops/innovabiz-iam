...
const PAGE = "Inoculate";
const KPIS = [{"l":"Total Mushroom Farm","v":"1.406","t":"+15.4%","d":"up"},{"l":"Inoculate Ativos","v":"7.145","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.3%","d":"up"}];
const COLS = ["ID","Inoculate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mushroom Farm #001","Mushroom Farm #002","3.399","8.376","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Mushroom Farm #002","Mushroom Farm #003","3.896","6.564","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Mushroom Farm #003","Mushroom Farm #004","3.609","222","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Mushroom Farm #004","Mushroom Farm #005","2.891","8.665","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mushroom Farm #005","Mushroom Farm #001","7.268","3.249","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":964},{"label":"Mar","value":853},{"label":"Abr","value":891},{"label":"Mai","value":777},{"label":"Jun","value":667},{"label":"Jul","value":679},{"label":"Ago","value":859},{"label":"Set","value":662},{"label":"Out","value":1025},{"label":"Nov","value":680},{"label":"Dez","value":827}];
const MX = 1025;
...
export default function InoculatePage() {
    return (
