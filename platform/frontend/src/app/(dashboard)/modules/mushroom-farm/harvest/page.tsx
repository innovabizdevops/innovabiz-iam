...
const PAGE = "Harvest";
const KPIS = [{"l":"Total Mushroom Farm","v":"5.245","t":"-3.2%","d":"down"},{"l":"Harvest Ativos","v":"3.258","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+17.6%","d":"up"}];
const COLS = ["ID","Harvest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mushroom Farm #001","Mushroom Farm #002","3.913","1.823","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Mushroom Farm #002","Mushroom Farm #003","3.444","8.021","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Mushroom Farm #003","Mushroom Farm #004","4.284","8.256","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mushroom Farm #004","Mushroom Farm #005","5.053","502","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mushroom Farm #005","Mushroom Farm #001","3.959","1.419","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":676},{"label":"Mar","value":589},{"label":"Abr","value":479},{"label":"Mai","value":538},{"label":"Jun","value":595},{"label":"Jul","value":488},{"label":"Ago","value":583},{"label":"Set","value":428},{"label":"Out","value":389},{"label":"Nov","value":515},{"label":"Dez","value":401}];
const MX = 676;
