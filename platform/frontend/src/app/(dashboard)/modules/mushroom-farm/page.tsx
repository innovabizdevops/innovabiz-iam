...
const KPIS = [
    ...
    { label: "Ativos", value: "1539", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€57K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "796106830", cells: ["MUS-3830", "Mushroom Farming Item 1", "23/11/2026", "€6930"], status: "active" as const },
    { id: "796110401", cells: ["MUS-7401", "Mushroom Farming Item 2", "10/6/2026", "€10 501"], status: "pending" as const },
    { id: "796113972", cells: ["MUS-1972", "Mushroom Farming Item 3", "25/1/2026", "€14 072"], status: "completed" as const },
    { id: "796117543", cells: ["MUS-5543", "Mushroom Farming Item 4", "12/8/2026", "€17 643"], status: "warning" as const },
    { id: "796121114", cells: ["MUS-9114", "Mushroom Farming Item 5", "27/3/2026", "€21 214"], status: "active" as const },
];
...
export default function MushroomFarmingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mushroom Farming</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mushroom Farming</p>
                    </div>
                </div>
