...
const PAGE = "Waitlist";
const KPIS = [{"l":"Total Table Mgmt","v":"8.566","t":"+1.1%","d":"up"},{"l":"Waitlist Ativos","v":"368","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"91.6%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"80","t":"+3.6%","d":"up"}];
const COLS = ["ID","Waitlist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Table Mgmt #001","Table Mgmt #002","2.417","1.344","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Table Mgmt #002","Table Mgmt #003","3.968","7.563","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Table Mgmt #003","Table Mgmt #004","7.539","6.921","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Table Mgmt #004","Table Mgmt #005","6.329","2.869","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Table Mgmt #005","Table Mgmt #001","4.859","3.485","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":626},{"label":"Mar","value":827},{"label":"Abr","value":490},{"label":"Mai","value":558},{"label":"Jun","value":523},{"label":"Jul","value":733},{"label":"Ago","value":617},{"label":"Set","value":675},{"label":"Out","value":640},{"label":"Nov","value":730},{"label":"Dez","value":691}];
const MX = 827;
