...
const PAGE = "Server Assign";
const KPIS = [{"l":"Total Table Mgmt","v":"3.777","t":"+4.0%","d":"up"},{"l":"Server Assign Ativos","v":"5.438","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"82.3%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"79","t":"-3.9%","d":"down"}];
const COLS = ["ID","Server Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Table Mgmt #001","Table Mgmt #002","3.136","8.017","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Table Mgmt #002","Table Mgmt #003","1.480","6.669","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Table Mgmt #003","Table Mgmt #004","8.583","5.157","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Table Mgmt #004","Table Mgmt #005","8.064","4.231","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Table Mgmt #005","Table Mgmt #001","483","4.729","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":361},{"label":"Mar","value":560},{"label":"Abr","value":426},{"label":"Mai","value":572},{"label":"Jun","value":472},{"label":"Jul","value":505},{"label":"Ago","value":583},{"label":"Set","value":513},{"label":"Out","value":406},{"label":"Nov","value":552},{"label":"Dez","value":472}];
const MX = 583;
