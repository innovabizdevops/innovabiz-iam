...
const PAGE = "Floor Layout";
const KPIS = [{"l":"Total Table Mgmt","v":"7.520","t":"+13.7%","d":"up"},{"l":"Floor Layout Ativos","v":"6.956","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"94","t":"+6.8%","d":"up"}];
const COLS = ["ID","Floor Layout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Table Mgmt #001","Table Mgmt #002","4.001","8.879","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Table Mgmt #002","Table Mgmt #003","1.695","5.219","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Table Mgmt #003","Table Mgmt #004","6.090","3.473","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Table Mgmt #004","Table Mgmt #005","7.312","4.796","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Table Mgmt #005","Table Mgmt #001","4.027","250","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":332},{"label":"Mar","value":701},{"label":"Abr","value":401},{"label":"Mai","value":483},{"label":"Jun","value":674},{"label":"Jul","value":314},{"label":"Ago","value":493},{"label":"Set","value":630},{"label":"Out","value":344},{"label":"Nov","value":672},{"label":"Dez","value":549}];
const MX = 701;
