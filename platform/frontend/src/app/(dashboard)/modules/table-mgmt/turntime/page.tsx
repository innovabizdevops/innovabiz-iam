...
const ACCENT = "#dc2626";
const MODULE = "Table Management";
const PAGE = "Turn Time";
const KPIS = [{"l":"Total Table Mgmt","v":"7.620","t":"-2.4%","d":"down"},{"l":"Turn Time Ativos","v":"3.999","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"75","t":"+11.5%","d":"up"}];
const COLS = ["ID","Turn Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Table Mgmt #001","Table Mgmt #002","3.141","5.438","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Table Mgmt #002","Table Mgmt #003","2.710","8.936","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Table Mgmt #003","Table Mgmt #004","1.401","2.669","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Table Mgmt #004","Table Mgmt #005","8.431","1.880","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Table Mgmt #005","Table Mgmt #001","8.644","554","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":724},{"label":"Mar","value":648},{"label":"Abr","value":808},{"label":"Mai","value":634},{"label":"Jun","value":820},{"label":"Jul","value":754},{"label":"Ago","value":572},{"label":"Set","value":746},{"label":"Out","value":651},{"label":"Nov","value":620},{"label":"Dez","value":774}];
const MX = 929;
...
export default function TurntimePage() {
    return (
