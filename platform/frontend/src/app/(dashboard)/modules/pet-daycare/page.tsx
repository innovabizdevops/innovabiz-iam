...
/* ═══ Pet Daycare — Dashboard ═══ */

const ACCENT = "#fdba74";

const KPIS = [
    { label: "Total Registos", value: "2902", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "134", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€441K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "630820902", cells: ["PET-2902", "Pet Daycare Item 1", "27/7/2026", "€21 002"], status: "active" as const },
    { id: "630824473", cells: ["PET-6473", "Pet Daycare Item 2", "14/2/2026", "€24 573"], status: "pending" as const },
    { id: "630828044", cells: ["PET-1044", "Pet Daycare Item 3", "1/9/2026", "€28 144"], status: "completed" as const },
    { id: "630831615", cells: ["PET-4615", "Pet Daycare Item 4", "16/4/2026", "€31 715"], status: "warning" as const },
    { id: "630835186", cells: ["PET-8186", "Pet Daycare Item 5", "3/11/2026", "€35 286"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Daycare</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Daycare</p>
                    </div>
                </div>
