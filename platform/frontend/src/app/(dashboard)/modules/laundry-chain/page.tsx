...
/* ═══ Laundry Chain Mgmt — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "1940", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "700", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€244K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1662944440", cells: ["LAU-6440", "Laundry Chain Mgmt Item 1", "25/5/2026", "€44 540"], status: "active" as const },
    { id: "1662948011", cells: ["LAU-1011", "Laundry Chain Mgmt Item 2", "12/12/2026", "€48 111"], status: "pending" as const },
    { id: "1662951582", cells: ["LAU-4582", "Laundry Chain Mgmt Item 3", "27/7/2026", "€1682"], status: "completed" as const },
    { id: "1662955153", cells: ["LAU-8153", "Laundry Chain Mgmt Item 4", "14/2/2026", "€5253"], status: "warning" as const },
    { id: "1662958724", cells: ["LAU-2724", "Laundry Chain Mgmt Item 5", "1/9/2026", "€8824"], status: "active" as const },
];
...
export default function LaundryChainMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laundry Chain Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laundry Chain Mgmt</p>
                    </div>
                </div>
