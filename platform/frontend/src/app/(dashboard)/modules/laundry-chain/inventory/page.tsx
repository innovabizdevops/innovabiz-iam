...
const ACCENT = "#0891b2";
const MODULE = "Laundry Chain Mgmt";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Laundry Chain","v":"4.191","t":"+17.6%","d":"up"},{"l":"Inventory Ativos","v":"5.719","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+14.4%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laundry Chain #001","Laundry Chain #002","3.004","6.334","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Laundry Chain #002","Laundry Chain #003","2.551","4.411","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Laundry Chain #003","Laundry Chain #004","7.019","6.388","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Laundry Chain #004","Laundry Chain #005","3.636","8.942","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laundry Chain #005","Laundry Chain #001","787","6.305","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":680},{"label":"Mar","value":843},{"label":"Abr","value":889},{"label":"Mai","value":846},{"label":"Jun","value":759},{"label":"Jul","value":667},{"label":"Ago","value":763},{"label":"Set","value":628},{"label":"Out","value":831},{"label":"Nov","value":540},{"label":"Dez","value":630}];
const MX = 889;
