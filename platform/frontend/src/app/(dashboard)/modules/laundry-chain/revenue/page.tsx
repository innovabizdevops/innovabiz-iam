...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€12.1M","t":"-1.1%","d":"down"},{"l":"MRR (€)","v":"€19873","t":"+12.4%","d":"up"},{"l":"Churn (%)","v":"75.7%","t":"+13.0%","d":"up"},{"l":"ARPU (€)","v":"€12060","t":"+2.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 24204.80","8.922","€ 7261.44","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 20485.93","8.848","€ 44117.28","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30984.39","1.362","€ 31552.82","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 26540.38","298","€ 3827.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 36577.51","2.617","€ 43578.47","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":256},{"label":"Fev","value":404},{"label":"Mar","value":435},{"label":"Abr","value":488},{"label":"Mai","value":532},{"label":"Jun","value":305},{"label":"Jul","value":617},{"label":"Ago","value":596},{"label":"Set","value":625},{"label":"Out","value":436},{"label":"Nov","value":645},{"label":"Dez","value":397}];
const MX = 645;
