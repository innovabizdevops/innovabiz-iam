...
/* ═══ Electronics Mfg — Aoi Inspection ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "572", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "6", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "249", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1004339506", cells: ["ELE-3506", "Aoi Inspection Item 1", "3/11/2026", "€39 606"], status: "active" as const },
    { id: "1004343077", cells: ["ELE-7077", "Aoi Inspection Item 2", "18/6/2026", "€43 177"], status: "pending" as const },
    { id: "1004346648", cells: ["ELE-1648", "Aoi Inspection Item 3", "5/1/2026", "€46 748"], status: "completed" as const },
    { id: "1004350219", cells: ["ELE-5219", "Aoi Inspection Item 4", "20/8/2026", "€319"], status: "warning" as const },
    { id: "1004353790", cells: ["ELE-8790", "Aoi Inspection Item 5", "7/3/2026", "€3890"], status: "active" as const },
];
...
export default function ElectronicsMfgAoiInspectionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aoi Inspection</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Aoi Inspection</p>
                    </div>
                </div>
