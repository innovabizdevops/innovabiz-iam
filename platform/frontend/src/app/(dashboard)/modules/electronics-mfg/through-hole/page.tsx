...
/* ═══ Electronics Mfg — Through Hole ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3916", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "196", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2570", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "965242000", cells: ["ELE-2000", "Through Hole Item 1", "17/5/2026", "€42 100"], status: "active" as const },
    { id: "965245571", cells: ["ELE-5571", "Through Hole Item 2", "4/12/2026", "€45 671"], status: "pending" as const },
    { id: "965249142", cells: ["ELE-9142", "Through Hole Item 3", "19/7/2026", "€49 242"], status: "completed" as const },
    { id: "965252713", cells: ["ELE-3713", "Through Hole Item 4", "6/2/2026", "€2813"], status: "warning" as const },
    { id: "965256284", cells: ["ELE-7284", "Through Hole Item 5", "21/9/2026", "€6384"], status: "active" as const },
];
...
export default function ElectronicsMfgThroughHolePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Through Hole</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Through Hole</p>
                    </div>
                </div>
