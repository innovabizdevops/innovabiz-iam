...
/* ═══ Electronics Mfg — Firmware Flash ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "3010", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "292", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1852", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "586774752", cells: ["ELE-2752", "Firmware Flash Item 1", "5/1/2026", "€24 852"], status: "active" as const },
    { id: "586778323", cells: ["ELE-6323", "Firmware Flash Item 2", "20/8/2026", "€28 423"], status: "pending" as const },
    { id: "586781894", cells: ["ELE-9894", "Firmware Flash Item 3", "7/3/2026", "€31 994"], status: "completed" as const },
    { id: "586785465", cells: ["ELE-4465", "Firmware Flash Item 4", "22/10/2026", "€35 565"], status: "warning" as const },
    { id: "586789036", cells: ["ELE-8036", "Firmware Flash Item 5", "9/5/2026", "€39 136"], status: "active" as const },
];
...
export default function ElectronicsMfgFirmwareFlashPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Firmware Flash</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Firmware Flash</p>
                    </div>
                </div>
