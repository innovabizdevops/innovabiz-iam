...
/* ═══ Electronics Mfg — Box Build ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4327", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "184", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1921", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1723255972", cells: ["ELE-8972", "Box Build Item 1", "5/5/2026", "€6072"], status: "active" as const },
    { id: "1723259543", cells: ["ELE-3543", "Box Build Item 2", "20/12/2026", "€9643"], status: "pending" as const },
    { id: "1723263114", cells: ["ELE-7114", "Box Build Item 3", "7/7/2026", "€13 214"], status: "completed" as const },
    { id: "1723266685", cells: ["ELE-1685", "Box Build Item 4", "22/2/2026", "€16 785"], status: "warning" as const },
    { id: "1723270256", cells: ["ELE-5256", "Box Build Item 5", "9/9/2026", "€20 356"], status: "active" as const },
];
...
export default function ElectronicsMfgBoxBuildPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Box Build</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Box Build</p>
                    </div>
                </div>
