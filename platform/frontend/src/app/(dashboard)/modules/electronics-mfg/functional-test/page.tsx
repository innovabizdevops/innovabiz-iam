...
/* ═══ Electronics Mfg — Functional Test ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2862", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "426", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2889", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "872016550", cells: ["ELE-7550", "Functional Test Item 1", "7/11/2026", "€16 650"], status: "active" as const },
    { id: "872020121", cells: ["ELE-2121", "Functional Test Item 2", "22/6/2026", "€20 221"], status: "pending" as const },
    { id: "872023692", cells: ["ELE-5692", "Functional Test Item 3", "9/1/2026", "€23 792"], status: "completed" as const },
    { id: "872027263", cells: ["ELE-9263", "Functional Test Item 4", "24/8/2026", "€27 363"], status: "warning" as const },
    { id: "872030834", cells: ["ELE-3834", "Functional Test Item 5", "11/3/2026", "€30 934"], status: "active" as const },
];
...
export default function ElectronicsMfgFunctionalTestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Functional Test</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Functional Test</p>
                    </div>
                </div>
