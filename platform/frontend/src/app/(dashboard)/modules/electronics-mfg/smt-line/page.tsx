...
/* ═══ Electronics Mfg — Smt Line ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4539", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "5", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1901", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1300812593", cells: ["ELE-7593", "Smt Line Item 1", "18/6/2026", "€12 693"], status: "active" as const },
    { id: "1300816164", cells: ["ELE-2164", "Smt Line Item 2", "5/1/2026", "€16 264"], status: "pending" as const },
    { id: "1300819735", cells: ["ELE-5735", "Smt Line Item 3", "20/8/2026", "€19 835"], status: "completed" as const },
    { id: "1300823306", cells: ["ELE-9306", "Smt Line Item 4", "7/3/2026", "€23 406"], status: "warning" as const },
    { id: "1300826877", cells: ["ELE-3877", "Smt Line Item 5", "22/10/2026", "€26 977"], status: "active" as const },
];
...
export default function ElectronicsMfgSmtLinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smt Line</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Smt Line</p>
                    </div>
                </div>
