...
/* ═══ Electronics Mfg — Pcb Assembly ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "65", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "248", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2997", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1538984596", cells: ["ELE-3596", "Pcb Assembly Item 1", "17/5/2026", "€34 696"], status: "active" as const },
    { id: "1538988167", cells: ["ELE-7167", "Pcb Assembly Item 2", "4/12/2026", "€38 267"], status: "pending" as const },
    { id: "1538991738", cells: ["ELE-1738", "Pcb Assembly Item 3", "19/7/2026", "€41 838"], status: "completed" as const },
    { id: "1538995309", cells: ["ELE-5309", "Pcb Assembly Item 4", "6/2/2026", "€45 409"], status: "warning" as const },
    { id: "1538998880", cells: ["ELE-8880", "Pcb Assembly Item 5", "21/9/2026", "€48 980"], status: "active" as const },
];
...
export default function ElectronicsMfgPcbAssemblyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pcb Assembly</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Pcb Assembly</p>
                    </div>
                </div>
