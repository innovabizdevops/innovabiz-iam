...
/* ═══ Electronics Mfg — Conformal Coat ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2134", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "151", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1009", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2017411715", cells: ["ELE-8715", "Conformal Coat Item 1", "12/12/2026", "€11 815"], status: "active" as const },
    { id: "2017415286", cells: ["ELE-3286", "Conformal Coat Item 2", "27/7/2026", "€15 386"], status: "pending" as const },
    { id: "2017418857", cells: ["ELE-6857", "Conformal Coat Item 3", "14/2/2026", "€18 957"], status: "completed" as const },
    { id: "2017422428", cells: ["ELE-1428", "Conformal Coat Item 4", "1/9/2026", "€22 528"], status: "warning" as const },
    { id: "2017425999", cells: ["ELE-4999", "Conformal Coat Item 5", "16/4/2026", "€26 099"], status: "active" as const },
];
...
export default function ElectronicsMfgConformalCoatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conformal Coat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Conformal Coat</p>
                    </div>
                </div>
