...
/* ═══ Electronics Mfg — Esd Control ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2907", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "6", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1077", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1180375362", cells: ["ELE-8362", "Esd Control Item 1", "27/7/2026", "€25 462"], status: "active" as const },
    { id: "1180378933", cells: ["ELE-2933", "Esd Control Item 2", "14/2/2026", "€29 033"], status: "pending" as const },
    { id: "1180382504", cells: ["ELE-6504", "Esd Control Item 3", "1/9/2026", "€32 604"], status: "completed" as const },
    { id: "1180386075", cells: ["ELE-1075", "Esd Control Item 4", "16/4/2026", "€36 175"], status: "warning" as const },
    { id: "1180389646", cells: ["ELE-4646", "Esd Control Item 5", "3/11/2026", "€39 746"], status: "active" as const },
];
...
export default function ElectronicsMfgEsdControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Esd Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Esd Control</p>
                    </div>
                </div>
