...
/* ═══ Electronics Mfg — Soldering ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1799", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "176", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2108", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "980207788", cells: ["ELE-9788", "Soldering Item 1", "1/5/2026", "€7888"], status: "active" as const },
    { id: "980211359", cells: ["ELE-4359", "Soldering Item 2", "16/12/2026", "€11 459"], status: "pending" as const },
    { id: "980214930", cells: ["ELE-7930", "Soldering Item 3", "3/7/2026", "€15 030"], status: "completed" as const },
    { id: "980218501", cells: ["ELE-2501", "Soldering Item 4", "18/2/2026", "€18 601"], status: "warning" as const },
    { id: "980222072", cells: ["ELE-6072", "Soldering Item 5", "5/9/2026", "€22 172"], status: "active" as const },
];
...
export default function ElectronicsMfgSolderingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Soldering</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Electronics Mfg • Soldering</p>
                    </div>
                </div>
