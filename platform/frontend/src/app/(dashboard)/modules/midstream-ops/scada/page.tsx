...
const PAGE = "SCADA";
const KPIS = [{"l":"Dispositivos Online","v":"1.559","t":"+3.0%","d":"up"},{"l":"Dados/Min (MB)","v":"3.397","t":"+17.4%","d":"up"},{"l":"Alertas Ativos","v":"4.433","t":"+5.5%","d":"up"},{"l":"Uptime (%)","v":"86.0%","t":"+17.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.366","2.678","5.102","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.679","4.246","5.338","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.105","4.267","8.137","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.269","4.459","4.847","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.414","5.353","8.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1021},{"label":"Fev","value":677},{"label":"Mar","value":801},{"label":"Abr","value":754},{"label":"Mai","value":871},{"label":"Jun","value":876},{"label":"Jul","value":1013},{"label":"Ago","value":805},{"label":"Set","value":883},{"label":"Out","value":970},{"label":"Nov","value":880},{"label":"Dez","value":813}];
const MX = 1021;
