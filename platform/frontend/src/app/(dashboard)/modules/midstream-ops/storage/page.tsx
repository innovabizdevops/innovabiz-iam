...
const PAGE = "Storage";
const KPIS = [{"l":"Total Midstream Ops","v":"5.884","t":"+11.4%","d":"up"},{"l":"Storage Ativos","v":"5.737","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"66","t":"+4.5%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Midstream Ops #001","Midstream Ops #002","7.070","5.848","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Midstream Ops #002","Midstream Ops #003","8.534","3.193","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Midstream Ops #003","Midstream Ops #004","8.579","1.981","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Midstream Ops #004","Midstream Ops #005","7.249","5.989","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Midstream Ops #005","Midstream Ops #001","8.628","743","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":688},{"label":"Mar","value":711},{"label":"Abr","value":559},{"label":"Mai","value":549},{"label":"Jun","value":679},{"label":"Jul","value":833},{"label":"Ago","value":496},{"label":"Set","value":661},{"label":"Out","value":808},{"label":"Nov","value":542},{"label":"Dez","value":558}];
const MX = 833;
