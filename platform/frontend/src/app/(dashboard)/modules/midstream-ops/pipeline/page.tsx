...
const ACCENT = "#6366f1";
const MODULE = "Midstream Operations";
const PAGE = "Pipeline";
const KPIS = [{"l":"Total Midstream Ops","v":"7.627","t":"-5.6%","d":"down"},{"l":"Pipeline Ativos","v":"392","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"75","t":"+5.6%","d":"up"}];
const COLS = ["ID","Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Midstream Ops #001","Midstream Ops #002","8.644","641","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Midstream Ops #002","Midstream Ops #003","5.634","7.771","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Midstream Ops #003","Midstream Ops #004","1.479","2.452","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Midstream Ops #004","Midstream Ops #005","8.850","5.821","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Midstream Ops #005","Midstream Ops #001","3.804","4.236","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":609},{"label":"Mar","value":637},{"label":"Abr","value":644},{"label":"Mai","value":698},{"label":"Jun","value":560},{"label":"Jul","value":689},{"label":"Ago","value":801},{"label":"Set","value":563},{"label":"Out","value":695},{"label":"Nov","value":905},{"label":"Dez","value":878}];
const MX = 905;
