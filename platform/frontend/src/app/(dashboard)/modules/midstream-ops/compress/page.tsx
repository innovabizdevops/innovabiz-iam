...
const PAGE = "Compressor";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.926","t":"+1.0%","d":"up"},{"l":"Sessões/Dia","v":"3949","t":"-1.3%","d":"down"},{"l":"MFA Adoção (%)","v":"78.3%","t":"+2.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.853","t":"-4.6%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.812","3.953","8.769","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.609","5.290","5.136","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.057","5.108","2.901","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.362","6.073","982","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.085","5.377","6.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":527},{"label":"Mar","value":314},{"label":"Abr","value":406},{"label":"Mai","value":370},{"label":"Jun","value":528},{"label":"Jul","value":569},{"label":"Ago","value":395},{"label":"Set","value":596},{"label":"Out","value":336},{"label":"Nov","value":376},{"label":"Dez","value":603}];
const MX = 615;
