...
const KPIS = [{"l":"Total Midstream Ops","v":"1.915","t":"+5.4%","d":"up"},{"l":"Processing Ativos","v":"7.804","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+6.3%","d":"up"}];
const COLS = ["ID","Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Midstream Ops #001","Midstream Ops #002","6.799","1.523","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Midstream Ops #002","Midstream Ops #003","6.288","900","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Midstream Ops #003","Midstream Ops #004","5.424","3.410","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Midstream Ops #004","Midstream Ops #005","5.369","3.197","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Midstream Ops #005","Midstream Ops #001","651","3.427","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":841},{"label":"Mar","value":559},{"label":"Abr","value":567},{"label":"Mai","value":821},{"label":"Jun","value":873},{"label":"Jul","value":876},{"label":"Ago","value":817},{"label":"Set","value":625},{"label":"Out","value":770},{"label":"Nov","value":702},{"label":"Dez","value":849}];
const MX = 876;
