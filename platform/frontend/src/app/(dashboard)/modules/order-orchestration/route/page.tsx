...
const ACCENT = "#ea580c";
const MODULE = "Order Orchestration";
const PAGE = "Route";
const KPIS = [{"l":"Total Order Orchestration","v":"5.387","t":"+11.7%","d":"up"},{"l":"Route Ativos","v":"6.937","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.3%","d":"down"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Order Orchestration #001","Order Orchestration #002","8.583","6.865","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Order Orchestration #002","Order Orchestration #003","3.303","771","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Order Orchestration #003","Order Orchestration #004","4.604","3.202","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Order Orchestration #004","Order Orchestration #005","3.344","6.047","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Order Orchestration #005","Order Orchestration #001","608","4.322","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":261},{"label":"Mar","value":383},{"label":"Abr","value":581},{"label":"Mai","value":534},{"label":"Jun","value":590},{"label":"Jul","value":373},{"label":"Ago","value":635},{"label":"Set","value":523},{"label":"Out","value":411},{"label":"Nov","value":527},{"label":"Dez","value":305}];
const MX = 635;
