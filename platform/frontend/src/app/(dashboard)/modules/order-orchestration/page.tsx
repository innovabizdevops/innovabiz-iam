...
/* ═══ Order Orchestration — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "9103", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4189", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€211K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1625361303", cells: ["ORD-7303", "Order Orchestration Item 1", "28/4/2026", "€11 403"], status: "active" as const },
    { id: "1625364874", cells: ["ORD-1874", "Order Orchestration Item 2", "15/11/2026", "€14 974"], status: "pending" as const },
    { id: "1625368445", cells: ["ORD-5445", "Order Orchestration Item 3", "2/6/2026", "€18 545"], status: "completed" as const },
    { id: "1625372016", cells: ["ORD-9016", "Order Orchestration Item 4", "17/1/2026", "€22 116"], status: "warning" as const },
    { id: "1625375587", cells: ["ORD-3587", "Order Orchestration Item 5", "4/8/2026", "€25 687"], status: "active" as const },
];
...
export default function OrderOrchestrationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Order Orchestration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Order Orchestration</p>
                    </div>
                </div>
