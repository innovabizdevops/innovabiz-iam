...
const PAGE = "Tag Manager";
const KPIS = [{"l":"Total Container Registry","v":"4.131","t":"-3.5%","d":"down"},{"l":"Tag Manager Ativos","v":"2.010","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"72","t":"+16.7%","d":"up"}];
const COLS = ["ID","Tag Manager","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Registry #001","Container Registry #002","8.263","3.206","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Container Registry #002","Container Registry #003","5.919","8.942","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Registry #003","Container Registry #004","7.521","8.086","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Container Registry #004","Container Registry #005","6.626","3.491","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Registry #005","Container Registry #001","6.147","8.306","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":687},{"label":"Mar","value":675},{"label":"Abr","value":843},{"label":"Mai","value":847},{"label":"Jun","value":817},{"label":"Jul","value":780},{"label":"Ago","value":899},{"label":"Set","value":711},{"label":"Out","value":611},{"label":"Nov","value":665},{"label":"Dez","value":705}];
const MX = 899;
