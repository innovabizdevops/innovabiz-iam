...
const PAGE = "SBOM Generate";
const KPIS = [{"l":"Produtos Ativos","v":"6.592","t":"+10.3%","d":"up"},{"l":"SKUs","v":"8.005","t":"-2.2%","d":"down"},{"l":"ECNs Pendentes","v":"1.871","t":"+2.2%","d":"up"},{"l":"Time-to-Market (dias)","v":"592","t":"+9.2%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","8.661","7.411","1.283","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","1.078","1.595","8.331","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","6.341","2.272","2.244","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","6.882","5.322","1.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","6.142","1.722","3.797","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":670},{"label":"Mar","value":402},{"label":"Abr","value":668},{"label":"Mai","value":540},{"label":"Jun","value":738},{"label":"Jul","value":445},{"label":"Ago","value":625},{"label":"Set","value":541},{"label":"Out","value":415},{"label":"Nov","value":444},{"label":"Dez","value":437}];
const MX = 744;
