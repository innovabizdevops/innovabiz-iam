...
const ACCENT = "#0e7490";
const MODULE = "Container Registry";
const PAGE = "Garbage Collect";
const KPIS = [{"l":"Total Container Registry","v":"4.250","t":"-1.2%","d":"down"},{"l":"Garbage Collect Ativos","v":"4.746","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"69","t":"+3.8%","d":"up"}];
const COLS = ["ID","Garbage Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Registry #001","Container Registry #002","724","7.442","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Container Registry #002","Container Registry #003","2.720","8.372","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Registry #003","Container Registry #004","938","2.842","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Container Registry #004","Container Registry #005","7.604","5.622","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Registry #005","Container Registry #001","2.928","3.608","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":438},{"label":"Mar","value":722},{"label":"Abr","value":503},{"label":"Mai","value":502},{"label":"Jun","value":675},{"label":"Jul","value":596},{"label":"Ago","value":758},{"label":"Set","value":632},{"label":"Out","value":539},{"label":"Nov","value":675},{"label":"Dez","value":553}];
const MX = 758;
