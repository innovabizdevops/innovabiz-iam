...
/* ═══ Semiconductor Fab — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "8770", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2478", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€384K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1000433370", cells: ["SEM-3370", "Semiconductor Fab Item 1", "7/7/2026", "€33 470"], status: "active" as const },
    { id: "1000436941", cells: ["SEM-6941", "Semiconductor Fab Item 2", "22/2/2026", "€37 041"], status: "pending" as const },
    { id: "1000440512", cells: ["SEM-1512", "Semiconductor Fab Item 3", "9/9/2026", "€40 612"], status: "completed" as const },
    { id: "1000444083", cells: ["SEM-5083", "Semiconductor Fab Item 4", "24/4/2026", "€44 183"], status: "warning" as const },
    { id: "1000447654", cells: ["SEM-8654", "Semiconductor Fab Item 5", "11/11/2026", "€47 754"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Semiconductor Fab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Semiconductor Fab</p>
                    </div>
                </div>
