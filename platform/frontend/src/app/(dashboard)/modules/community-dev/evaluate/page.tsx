...
const PAGE = "Evaluate";
const KPIS = [{"l":"Projetos Sociais","v":"3.535","t":"+17.8%","d":"up"},{"l":"Beneficiários","v":"2.911","t":"-1.4%","d":"down"},{"l":"Investimento CSR (€)","v":"€49660","t":"+16.7%","d":"up"},{"l":"Score Impacto","v":"64","t":"+9.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.425","€ 12085.61","140","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.715","€ 18605.58","1.662","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.206","€ 12069.09","8.354","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.237","€ 31155.67","1.606","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.860","€ 17812.90","1.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":702},{"label":"Mar","value":622},{"label":"Abr","value":726},{"label":"Mai","value":937},{"label":"Jun","value":810},{"label":"Jul","value":675},{"label":"Ago","value":918},{"label":"Set","value":840},{"label":"Out","value":913},{"label":"Nov","value":755},{"label":"Dez","value":621}];
const MX = 937;
