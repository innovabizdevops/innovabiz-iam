...
const PAGE = "Project";
const KPIS = [{"l":"Projetos Sociais","v":"280","t":"+14.5%","d":"up"},{"l":"Beneficiários","v":"2.518","t":"-2.0%","d":"down"},{"l":"Investimento CSR (€)","v":"€28177","t":"+15.9%","d":"up"},{"l":"Score Impacto","v":"69","t":"+6.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.645","€ 21960.33","7.285","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.432","€ 9347.60","8.138","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.966","€ 1844.47","1.297","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.376","€ 40492.98","8.091","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.338","€ 20773.32","3.436","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":618},{"label":"Mar","value":854},{"label":"Abr","value":591},{"label":"Mai","value":808},{"label":"Jun","value":568},{"label":"Jul","value":697},{"label":"Ago","value":698},{"label":"Set","value":807},{"label":"Out","value":628},{"label":"Nov","value":561},{"label":"Dez","value":845}];
const MX = 929;
