...
const ACCENT = "#9d174d";
const MODULE = "Community Development";
const PAGE = "Participate";
const KPIS = [{"l":"Projetos Sociais","v":"6.102","t":"-3.2%","d":"down"},{"l":"Beneficiários","v":"7.373","t":"+12.9%","d":"up"},{"l":"Investimento CSR (€)","v":"€14543","t":"+10.0%","d":"up"},{"l":"Score Impacto","v":"58","t":"-5.3%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.438","€ 28344.03","8.356","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.735","€ 38961.82","4.674","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.008","€ 12388.31","8.007","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.061","€ 20387.72","2.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.770","€ 15959.91","3.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":757},{"label":"Mar","value":679},{"label":"Abr","value":628},{"label":"Mai","value":780},{"label":"Jun","value":667},{"label":"Jul","value":644},{"label":"Ago","value":883},{"label":"Set","value":796},{"label":"Out","value":799},{"label":"Nov","value":635},{"label":"Dez","value":885}];
const MX = 885;
