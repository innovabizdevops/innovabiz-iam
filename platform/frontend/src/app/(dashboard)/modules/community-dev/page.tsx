...
const KPIS = [
    { label: "Total Registos", value: "6880", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "944", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€359K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "271831080", cells: ["COM-5080", "Community Development Item 1", "25/1/2026", "€31 180"], status: "active" as const },
    { id: "271834651", cells: ["COM-8651", "Community Development Item 2", "12/8/2026", "€34 751"], status: "pending" as const },
    { id: "271838222", cells: ["COM-3222", "Community Development Item 3", "27/3/2026", "€38 322"], status: "completed" as const },
    { id: "271841793", cells: ["COM-6793", "Community Development Item 4", "14/10/2026", "€41 893"], status: "warning" as const },
    { id: "271845364", cells: ["COM-1364", "Community Development Item 5", "1/5/2026", "€45 464"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Community Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Community Development</p>
                    </div>
                </div>
