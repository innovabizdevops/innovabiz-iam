...
const PAGE = "Plan";
const KPIS = [{"l":"Projetos Sociais","v":"8.056","t":"+17.4%","d":"up"},{"l":"Beneficiários","v":"4.451","t":"+15.3%","d":"up"},{"l":"Investimento CSR (€)","v":"€64029","t":"+9.3%","d":"up"},{"l":"Score Impacto","v":"91","t":"+8.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.386","€ 16926.36","4.595","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","257","€ 44883.80","4.519","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.891","€ 47081.85","8.304","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.602","€ 17796.86","901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.615","€ 25289.34","6.137","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":229},{"label":"Fev","value":333},{"label":"Mar","value":599},{"label":"Abr","value":493},{"label":"Mai","value":276},{"label":"Jun","value":247},{"label":"Jul","value":603},{"label":"Ago","value":381},{"label":"Set","value":238},{"label":"Out","value":324},{"label":"Nov","value":455},{"label":"Dez","value":547}];
const MX = 603;
