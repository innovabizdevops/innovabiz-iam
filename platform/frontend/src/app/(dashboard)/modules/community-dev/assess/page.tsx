...
const PAGE = "Assess";
const KPIS = [{"l":"Projetos Sociais","v":"5.313","t":"+12.1%","d":"up"},{"l":"Beneficiários","v":"2.351","t":"+1.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€16295","t":"+11.7%","d":"up"},{"l":"Score Impacto","v":"84","t":"+5.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.814","€ 13131.40","3.284","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.370","€ 14810.03","6.384","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.893","€ 4552.05","8.649","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.810","€ 28214.88","8.070","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","658","€ 25858.86","5.687","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":921},{"label":"Mar","value":919},{"label":"Abr","value":696},{"label":"Mai","value":898},{"label":"Jun","value":1001},{"label":"Jul","value":829},{"label":"Ago","value":859},{"label":"Set","value":907},{"label":"Out","value":860},{"label":"Nov","value":989},{"label":"Dez","value":892}];
const MX = 1001;
