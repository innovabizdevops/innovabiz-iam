...
const PAGE = "Route Build";
const KPIS = [{"l":"Total Flight Planning","v":"7.910","t":"-4.8%","d":"down"},{"l":"Route Build Ativos","v":"4.649","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"72.5%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+15.9%","d":"up"}];
const COLS = ["ID","Route Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flight Planning #001","Flight Planning #002","2.174","8.489","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Flight Planning #002","Flight Planning #003","2.903","8.434","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Flight Planning #003","Flight Planning #004","3.829","1.316","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Flight Planning #004","Flight Planning #005","1.058","2.881","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flight Planning #005","Flight Planning #001","3.007","6.243","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":785},{"label":"Mar","value":633},{"label":"Abr","value":789},{"label":"Mai","value":523},{"label":"Jun","value":705},{"label":"Jul","value":796},{"label":"Ago","value":711},{"label":"Set","value":439},{"label":"Out","value":775},{"label":"Nov","value":806},{"label":"Dez","value":441}];
const MX = 806;
