...
const PAGE = "Fuel Calc";
const KPIS = [{"l":"Total Flight Planning","v":"4.210","t":"+17.5%","d":"up"},{"l":"Fuel Calc Ativos","v":"5.964","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"85","t":"+7.5%","d":"up"}];
const COLS = ["ID","Fuel Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flight Planning #001","Flight Planning #002","4.727","2.893","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Flight Planning #002","Flight Planning #003","7.179","7.742","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Flight Planning #003","Flight Planning #004","2.006","1.187","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Flight Planning #004","Flight Planning #005","1.753","2.180","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flight Planning #005","Flight Planning #001","1.073","8.596","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":750},{"label":"Mar","value":818},{"label":"Abr","value":973},{"label":"Mai","value":812},{"label":"Jun","value":996},{"label":"Jul","value":991},{"label":"Ago","value":720},{"label":"Set","value":962},{"label":"Out","value":729},{"label":"Nov","value":955},{"label":"Dez","value":752}];
const MX = 996;
