...
const ACCENT = "#475569";
const MODULE = "Flight Planning";
const PAGE = "Weight Balance";
const KPIS = [{"l":"Total Flight Planning","v":"7.063","t":"+14.3%","d":"up"},{"l":"Weight Balance Ativos","v":"4.901","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"77","t":"-0.6%","d":"down"}];
const COLS = ["ID","Weight Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flight Planning #001","Flight Planning #002","1.054","5.785","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Flight Planning #002","Flight Planning #003","6.533","6.419","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Flight Planning #003","Flight Planning #004","6.982","2.235","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Flight Planning #004","Flight Planning #005","1.251","4.903","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flight Planning #005","Flight Planning #001","1.590","5.379","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":519},{"label":"Mar","value":628},{"label":"Abr","value":484},{"label":"Mai","value":467},{"label":"Jun","value":512},{"label":"Jul","value":392},{"label":"Ago","value":329},{"label":"Set","value":343},{"label":"Out","value":597},{"label":"Nov","value":601},{"label":"Dez","value":307}];
const MX = 628;
