...
const KPIS = [{"l":"Total Flight Planning","v":"3.700","t":"+12.4%","d":"up"},{"l":"NOTAM Check Ativos","v":"6.011","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"84","t":"+10.4%","d":"up"}];
const COLS = ["ID","NOTAM Check","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flight Planning #001","2026-02-03","3.190","6.702","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Flight Planning #002","2026-02-25","1.860","8.003","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Flight Planning #003","2026-02-04","6.771","4.094","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Flight Planning #004","2026-02-02","6.607","7.952","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flight Planning #005","2026-03-25","8.133","8.845","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":665},{"label":"Mar","value":1025},{"label":"Abr","value":840},{"label":"Mai","value":794},{"label":"Jun","value":887},{"label":"Jul","value":898},{"label":"Ago","value":950},{"label":"Set","value":797},{"label":"Out","value":1022},{"label":"Nov","value":861},{"label":"Dez","value":919}];
const MX = 1025;
