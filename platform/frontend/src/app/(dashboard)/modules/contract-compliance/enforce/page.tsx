...
const PAGE = "Enforce";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.096","t":"+5.9%","d":"up"},{"l":"NC Abertas","v":"2.969","t":"+6.6%","d":"up"},{"l":"Conformidade (%)","v":"89.3%","t":"-3.2%","d":"down"},{"l":"CAPAs Pendentes","v":"4.887","t":"+5.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.010","90.3%","1.584","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.363","91.6%","1.974","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.247","84.7%","8.387","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.483","98.6%","6.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.726","74.8%","1.375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":669},{"label":"Mar","value":957},{"label":"Abr","value":932},{"label":"Mai","value":1024},{"label":"Jun","value":806},{"label":"Jul","value":674},{"label":"Ago","value":944},{"label":"Set","value":1048},{"label":"Out","value":757},{"label":"Nov","value":1030},{"label":"Dez","value":1015}];
const MX = 1048;
