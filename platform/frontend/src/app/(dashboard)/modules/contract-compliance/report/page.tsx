...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.324","t":"+0.8%","d":"up"},{"l":"NC Abertas","v":"8.810","t":"+8.2%","d":"up"},{"l":"Conformidade (%)","v":"70.6%","t":"-0.7%","d":"down"},{"l":"CAPAs Pendentes","v":"4.194","t":"-4.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.699","85.0%","1.861","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.649","87.4%","3.871","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.501","86.3%","2.839","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.861","98.1%","669","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.408","87.9%","292","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":993},{"label":"Fev","value":790},{"label":"Mar","value":657},{"label":"Abr","value":734},{"label":"Mai","value":866},{"label":"Jun","value":658},{"label":"Jul","value":926},{"label":"Ago","value":1011},{"label":"Set","value":722},{"label":"Out","value":898},{"label":"Nov","value":657},{"label":"Dez","value":713}];
const MX = 1011;
