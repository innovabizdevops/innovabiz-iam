...
const ACCENT = "#78350f";
const MODULE = "Contract Compliance Engine";
const PAGE = "Obligation";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.957","t":"-1.3%","d":"down"},{"l":"NC Abertas","v":"5.463","t":"+13.8%","d":"up"},{"l":"Conformidade (%)","v":"81.4%","t":"+1.4%","d":"up"},{"l":"CAPAs Pendentes","v":"8.347","t":"-0.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.369","90.8%","1.188","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.256","75.0%","7.450","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.370","85.4%","432","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.512","88.0%","1.002","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","990","97.3%","5.581","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":687},{"label":"Mar","value":629},{"label":"Abr","value":799},{"label":"Mai","value":767},{"label":"Jun","value":808},{"label":"Jul","value":565},{"label":"Ago","value":606},{"label":"Set","value":659},{"label":"Out","value":755},{"label":"Nov","value":474},{"label":"Dez","value":465}];
const MX = 808;
