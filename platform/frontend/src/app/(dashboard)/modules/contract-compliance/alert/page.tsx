...
const PAGE = "Alert";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.351","t":"+15.5%","d":"up"},{"l":"NC Abertas","v":"8.267","t":"-2.5%","d":"down"},{"l":"Conformidade (%)","v":"91.4%","t":"+3.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.246","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.730","81.0%","7.710","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.598","75.6%","5.627","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.232","80.4%","7.191","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.215","74.4%","3.181","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.521","77.9%","1.328","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":602},{"label":"Mar","value":522},{"label":"Abr","value":752},{"label":"Mai","value":816},{"label":"Jun","value":564},{"label":"Jul","value":549},{"label":"Ago","value":633},{"label":"Set","value":709},{"label":"Out","value":654},{"label":"Nov","value":675},{"label":"Dez","value":820}];
const MX = 820;
