...
/* ═══ Contract Compliance Engine — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3543", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4527", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€396K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "953135843", cells: ["CON-9843", "Contract Compliance Engine Item 1", "24/12/2026", "€35 943"], status: "active" as const },
    { id: "953139414", cells: ["CON-4414", "Contract Compliance Engine Item 2", "11/7/2026", "€39 514"], status: "pending" as const },
    { id: "953142985", cells: ["CON-7985", "Contract Compliance Engine Item 3", "26/2/2026", "€43 085"], status: "completed" as const },
    { id: "953146556", cells: ["CON-2556", "Contract Compliance Engine Item 4", "13/9/2026", "€46 656"], status: "warning" as const },
    { id: "953150127", cells: ["CON-6127", "Contract Compliance Engine Item 5", "28/4/2026", "€227"], status: "active" as const },
];
...
export default function ContractComplianceEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contract Compliance Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Contract Compliance Engine</p>
                    </div>
                </div>
