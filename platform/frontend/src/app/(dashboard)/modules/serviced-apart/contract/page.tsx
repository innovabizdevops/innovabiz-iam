...
const ACCENT = "#6366f1";
const MODULE = "Serviced Apartments";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"8.620","t":"+16.2%","d":"up"},{"l":"Valor Total (€M)","v":"€31.1M","t":"+7.5%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.813","t":"-5.5%","d":"down"},{"l":"Obrigações Pendentes","v":"8.457","t":"+14.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 46096.58","2026-01-14","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 36821.98","2026-01-03","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 7585.30","2026-02-15","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 12395.06","2026-01-07","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 3893.74","2026-02-25","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":562},{"label":"Mar","value":652},{"label":"Abr","value":598},{"label":"Mai","value":633},{"label":"Jun","value":495},{"label":"Jul","value":794},{"label":"Ago","value":580},{"label":"Set","value":687},{"label":"Out","value":472},{"label":"Nov","value":737},{"label":"Dez","value":672}];
const MX = 794;
