...
export default function ServicedApartPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Serviced Apart</h1><p className="text-sm text-muted-foreground">Serviced Apart • iBOS Enterprise</p></div>
