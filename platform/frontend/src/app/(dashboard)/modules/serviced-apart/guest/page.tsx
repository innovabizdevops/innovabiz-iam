...
const PAGE = "Guest";
const KPIS = [{"l":"Total Serviced Apart","v":"5.039","t":"+5.3%","d":"up"},{"l":"Guest Ativos","v":"6.776","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"82","t":"-0.2%","d":"down"}];
const COLS = ["ID","Guest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serviced Apart #001","Serviced Apart #002","6.475","1.331","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Serviced Apart #002","Serviced Apart #003","6.851","467","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Serviced Apart #003","Serviced Apart #004","8.687","1.649","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Serviced Apart #004","Serviced Apart #005","8.075","5.624","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serviced Apart #005","Serviced Apart #001","134","8.449","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":655},{"label":"Mar","value":842},{"label":"Abr","value":820},{"label":"Mai","value":964},{"label":"Jun","value":724},{"label":"Jul","value":761},{"label":"Ago","value":1016},{"label":"Set","value":798},{"label":"Out","value":828},{"label":"Nov","value":994},{"label":"Dez","value":715}];
const MX = 1016;
