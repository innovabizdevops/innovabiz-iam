...
const PAGE = "Voting";
const KPIS = [{"l":"Total Cooperative Mgmt","v":"5.419","t":"+17.7%","d":"up"},{"l":"Voting Ativos","v":"7.403","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+8.5%","d":"up"}];
const COLS = ["ID","Voting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cooperative Mgmt #001","Cooperative Mgmt #002","5.964","5.207","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Cooperative Mgmt #002","Cooperative Mgmt #003","3.258","895","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cooperative Mgmt #003","Cooperative Mgmt #004","7.443","343","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Cooperative Mgmt #004","Cooperative Mgmt #005","1.683","4.404","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cooperative Mgmt #005","Cooperative Mgmt #001","3.849","6.502","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":371},{"label":"Mar","value":470},{"label":"Abr","value":548},{"label":"Mai","value":437},{"label":"Jun","value":610},{"label":"Jul","value":340},{"label":"Ago","value":518},{"label":"Set","value":503},{"label":"Out","value":366},{"label":"Nov","value":484},{"label":"Dez","value":455}];
const MX = 610;
