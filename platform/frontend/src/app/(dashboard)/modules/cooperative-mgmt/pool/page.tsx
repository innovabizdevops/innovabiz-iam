...
const PAGE = "Pool Account";
const KPIS = [{"l":"Total Cooperative Mgmt","v":"3.601","t":"-5.3%","d":"down"},{"l":"Pool Account Ativos","v":"3.997","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"85","t":"+0.4%","d":"up"}];
const COLS = ["ID","Pool Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cooperative Mgmt #001","Cooperative Mgmt #002","709","1.809","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Cooperative Mgmt #002","Cooperative Mgmt #003","1.585","7.902","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Cooperative Mgmt #003","Cooperative Mgmt #004","4.489","4.769","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cooperative Mgmt #004","Cooperative Mgmt #005","705","2.132","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cooperative Mgmt #005","Cooperative Mgmt #001","4.748","3.404","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":927},{"label":"Mar","value":641},{"label":"Abr","value":757},{"label":"Mai","value":858},{"label":"Jun","value":911},{"label":"Jul","value":962},{"label":"Ago","value":683},{"label":"Set","value":621},{"label":"Out","value":724},{"label":"Nov","value":731},{"label":"Dez","value":707}];
const MX = 962;
