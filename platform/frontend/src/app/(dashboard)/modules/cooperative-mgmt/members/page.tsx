...
const ACCENT = "#7c3aed";
const MODULE = "Cooperative Management";
const PAGE = "Member Registry";
const KPIS = [{"l":"Total Cooperative Mgmt","v":"5.193","t":"+4.0%","d":"up"},{"l":"Member Registry Ativos","v":"4.793","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"67","t":"+2.4%","d":"up"}];
const COLS = ["ID","Member Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cooperative Mgmt #001","Cooperative Mgmt #002","2.982","3.120","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Cooperative Mgmt #002","Cooperative Mgmt #003","6.817","4.289","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Cooperative Mgmt #003","Cooperative Mgmt #004","6.545","2.902","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cooperative Mgmt #004","Cooperative Mgmt #005","6.550","7.502","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cooperative Mgmt #005","Cooperative Mgmt #001","460","4.220","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":968},{"label":"Mar","value":930},{"label":"Abr","value":807},{"label":"Mai","value":1030},{"label":"Jun","value":1037},{"label":"Jul","value":1019},{"label":"Ago","value":999},{"label":"Set","value":707},{"label":"Out","value":775},{"label":"Nov","value":917},{"label":"Dez","value":753}];
const MX = 1037;
