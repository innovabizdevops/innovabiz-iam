...
const PAGE = "AGM Minutes";
const KPIS = [{"l":"Total Cooperative Mgmt","v":"1.600","t":"-3.5%","d":"down"},{"l":"AGM Minutes Ativos","v":"3.844","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"76.6%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"87","t":"-4.6%","d":"down"}];
const COLS = ["ID","AGM Minutes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cooperative Mgmt #001","Cooperative Mgmt #002","3.856","2.169","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cooperative Mgmt #002","Cooperative Mgmt #003","107","8.773","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Cooperative Mgmt #003","Cooperative Mgmt #004","8.192","2.172","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Cooperative Mgmt #004","Cooperative Mgmt #005","5.385","4.565","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cooperative Mgmt #005","Cooperative Mgmt #001","4.233","7.699","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":645},{"label":"Mar","value":653},{"label":"Abr","value":865},{"label":"Mai","value":982},{"label":"Jun","value":607},{"label":"Jul","value":948},{"label":"Ago","value":907},{"label":"Set","value":739},{"label":"Out","value":648},{"label":"Nov","value":791},{"label":"Dez","value":772}];
const MX = 982;
