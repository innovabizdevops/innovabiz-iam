...
/* ═══ Digital Custody — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "6341", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1332", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€169K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "954890941", cells: ["DIG-9941", "Digital Custody Item 1", "26/2/2026", "€41 041"], status: "active" as const },
    { id: "954894512", cells: ["DIG-4512", "Digital Custody Item 2", "13/9/2026", "€44 612"], status: "pending" as const },
    { id: "954898083", cells: ["DIG-8083", "Digital Custody Item 3", "28/4/2026", "€48 183"], status: "completed" as const },
    { id: "954901654", cells: ["DIG-2654", "Digital Custody Item 4", "15/11/2026", "€1754"], status: "warning" as const },
    { id: "954905225", cells: ["DIG-6225", "Digital Custody Item 5", "2/6/2026", "€5325"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Custody</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Custody</p>
                    </div>
                </div>
