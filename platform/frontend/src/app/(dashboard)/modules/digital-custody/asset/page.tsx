...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"2.442","t":"+7.4%","d":"up"},{"l":"Valor Total (€M)","v":"€19.3M","t":"+10.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€10345","t":"+12.5%","d":"up"},{"l":"Ativos em Garantia","v":"7.003","t":"+11.1%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 23201.84","8.530","€ 13784.63","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 8476.54","8.591","€ 12146.96","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 47419.03","3.568","€ 13932.94","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 28715.90","2.698","€ 10116.18","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 25609.87","1.096","€ 10709.65","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":834},{"label":"Mar","value":931},{"label":"Abr","value":916},{"label":"Mai","value":637},{"label":"Jun","value":643},{"label":"Jul","value":595},{"label":"Ago","value":579},{"label":"Set","value":839},{"label":"Out","value":955},{"label":"Nov","value":694},{"label":"Dez","value":648}];
const MX = 955;
