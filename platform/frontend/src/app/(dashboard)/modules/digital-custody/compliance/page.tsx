...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.827","t":"+10.1%","d":"up"},{"l":"NC Abertas","v":"4.919","t":"+14.6%","d":"up"},{"l":"Conformidade (%)","v":"71.7%","t":"-1.0%","d":"down"},{"l":"CAPAs Pendentes","v":"1.691","t":"+17.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.768","89.3%","287","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.886","92.1%","854","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.276","82.5%","2.691","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.891","90.4%","8.018","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.782","87.6%","4.277","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":697},{"label":"Mar","value":635},{"label":"Abr","value":752},{"label":"Mai","value":615},{"label":"Jun","value":626},{"label":"Jul","value":923},{"label":"Ago","value":743},{"label":"Set","value":737},{"label":"Out","value":932},{"label":"Nov","value":566},{"label":"Dez","value":860}];
const MX = 932;
