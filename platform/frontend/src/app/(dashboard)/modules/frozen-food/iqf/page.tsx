...
const PAGE = "IQF Process";
const KPIS = [{"l":"Total Frozen Food","v":"4.232","t":"-1.9%","d":"down"},{"l":"IQF Process Ativos","v":"182","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"72","t":"-0.2%","d":"down"}];
const COLS = ["ID","IQF Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Frozen Food #001","Frozen Food #002","4.132","8.313","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Frozen Food #002","Frozen Food #003","1.367","1.791","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Frozen Food #003","Frozen Food #004","4.731","2.481","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Frozen Food #004","Frozen Food #005","1.341","8.483","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Frozen Food #005","Frozen Food #001","2.794","4.891","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":373},{"label":"Mar","value":281},{"label":"Abr","value":370},{"label":"Mai","value":304},{"label":"Jun","value":355},{"label":"Jul","value":441},{"label":"Ago","value":544},{"label":"Set","value":289},{"label":"Out","value":395},{"label":"Nov","value":294},{"label":"Dez","value":538}];
const MX = 544;
...
export default function IqfPage() {
    return (
