...
const PAGE = "Thaw Control";
const KPIS = [{"l":"Total Frozen Food","v":"2.348","t":"+3.7%","d":"up"},{"l":"Thaw Control Ativos","v":"3.624","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"76.8%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"74","t":"+7.4%","d":"up"}];
const COLS = ["ID","Thaw Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Frozen Food #001","Frozen Food #002","8.228","2.993","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Frozen Food #002","Frozen Food #003","1.828","6.087","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Frozen Food #003","Frozen Food #004","9.060","730","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Frozen Food #004","Frozen Food #005","1.647","2.501","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Frozen Food #005","Frozen Food #001","7.327","3.157","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":777},{"label":"Mar","value":1026},{"label":"Abr","value":691},{"label":"Mai","value":924},{"label":"Jun","value":1022},{"label":"Jul","value":708},{"label":"Ago","value":869},{"label":"Set","value":860},{"label":"Out","value":1053},{"label":"Nov","value":788},{"label":"Dez","value":816}];
const MX = 1053;
