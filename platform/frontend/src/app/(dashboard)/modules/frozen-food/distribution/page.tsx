...
const KPIS = [{"l":"Total Frozen Food","v":"950","t":"+9.4%","d":"up"},{"l":"Distribution Ativos","v":"3.645","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"76","t":"+0.4%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Frozen Food #001","Frozen Food #002","1.028","1.745","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Frozen Food #002","Frozen Food #003","1.246","7.715","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Frozen Food #003","Frozen Food #004","4.542","6.989","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Frozen Food #004","Frozen Food #005","8.725","2.211","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Frozen Food #005","Frozen Food #001","8.097","1.902","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":777},{"label":"Mar","value":820},{"label":"Abr","value":543},{"label":"Mai","value":808},{"label":"Jun","value":618},{"label":"Jul","value":645},{"label":"Ago","value":783},{"label":"Set","value":678},{"label":"Out","value":633},{"label":"Nov","value":492},{"label":"Dez","value":799}];
const MX = 820;
