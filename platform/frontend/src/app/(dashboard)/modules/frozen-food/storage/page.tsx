...
const ACCENT = "#713f12";
const MODULE = "Frozen Food Mgmt";
const PAGE = "Cold Storage";
const KPIS = [{"l":"Total Frozen Food","v":"298","t":"-5.7%","d":"down"},{"l":"Cold Storage Ativos","v":"3.396","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"67.2%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.4%","d":"up"}];
const COLS = ["ID","Cold Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Frozen Food #001","Frozen Food #002","8.595","6.648","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Frozen Food #002","Frozen Food #003","3.768","7.098","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Frozen Food #003","Frozen Food #004","7.842","4.785","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Frozen Food #004","Frozen Food #005","7.545","1.193","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Frozen Food #005","Frozen Food #001","8.855","386","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":834},{"label":"Mar","value":836},{"label":"Abr","value":655},{"label":"Mai","value":813},{"label":"Jun","value":653},{"label":"Jul","value":734},{"label":"Ago","value":825},{"label":"Set","value":788},{"label":"Out","value":775},{"label":"Nov","value":609},{"label":"Dez","value":731}];
const MX = 930;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#713f12'}}>IoT</span></h1>
                </div>
