...
const PAGE = "Client Book";
const KPIS = [{"l":"Total Clienteling","v":"5.175","t":"+1.2%","d":"up"},{"l":"Client Book Ativos","v":"7.878","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+5.9%","d":"up"}];
const COLS = ["ID","Client Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clienteling #001","Clienteling #002","6.909","4.158","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Clienteling #002","Clienteling #003","5.031","3.928","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Clienteling #003","Clienteling #004","1.912","6.790","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Clienteling #004","Clienteling #005","7.880","3.832","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clienteling #005","Clienteling #001","1.532","3.903","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":437},{"label":"Mar","value":287},{"label":"Abr","value":449},{"label":"Mai","value":479},{"label":"Jun","value":569},{"label":"Jul","value":541},{"label":"Ago","value":625},{"label":"Set","value":601},{"label":"Out","value":334},{"label":"Nov","value":279},{"label":"Dez","value":292}];
const MX = 625;
