...
const ACCENT = "#0891b2";
const MODULE = "Clienteling Platform";
const PAGE = "Style Advice";
const KPIS = [{"l":"Total Clienteling","v":"6.081","t":"+10.4%","d":"up"},{"l":"Style Advice Ativos","v":"6.589","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"76.6%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+12.4%","d":"up"}];
const COLS = ["ID","Style Advice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clienteling #001","Clienteling #002","1.968","1.866","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Clienteling #002","Clienteling #003","3.182","5.030","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Clienteling #003","Clienteling #004","4.491","4.896","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Clienteling #004","Clienteling #005","5.780","4.235","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clienteling #005","Clienteling #001","2.855","8.362","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":492},{"label":"Mar","value":612},{"label":"Abr","value":547},{"label":"Mai","value":590},{"label":"Jun","value":625},{"label":"Jul","value":326},{"label":"Ago","value":613},{"label":"Set","value":598},{"label":"Out","value":666},{"label":"Nov","value":362},{"label":"Dez","value":543}];
const MX = 666;
