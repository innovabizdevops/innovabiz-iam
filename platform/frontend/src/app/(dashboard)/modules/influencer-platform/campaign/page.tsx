...
const PAGE = "Campaign";
const KPIS = [{"l":"Formulários Ativos","v":"8.952","t":"+17.9%","d":"up"},{"l":"Submissões/Dia","v":"2764","t":"+2.9%","d":"up"},{"l":"Documentos Gerados","v":"9.022","t":"+6.2%","d":"up"},{"l":"Templates","v":"8.491","t":"+6.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.937","2026-01-27","4.321","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.072","2026-03-23","5.107","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.155","2026-02-18","588","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.566","2026-01-04","4.678","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.740","2026-01-17","981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":462},{"label":"Mar","value":542},{"label":"Abr","value":601},{"label":"Mai","value":331},{"label":"Jun","value":339},{"label":"Jul","value":296},{"label":"Ago","value":240},{"label":"Set","value":250},{"label":"Out","value":402},{"label":"Nov","value":500},{"label":"Dez","value":300}];
const MX = 601;
