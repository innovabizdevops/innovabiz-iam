...
const ACCENT = "#6366f1";
const MODULE = "Influencer Platform";
const PAGE = "Discovery";
const KPIS = [{"l":"Formulários Ativos","v":"1.077","t":"+17.2%","d":"up"},{"l":"Submissões/Dia","v":"4063","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"6.645","t":"+4.7%","d":"up"},{"l":"Templates","v":"1.065","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.098","2026-01-14","4.908","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.884","2026-02-01","8.967","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.871","2026-01-26","3.313","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.601","2026-02-16","8.751","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.152","2026-03-01","328","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":571},{"label":"Mar","value":581},{"label":"Abr","value":914},{"label":"Mai","value":610},{"label":"Jun","value":853},{"label":"Jul","value":568},{"label":"Ago","value":910},{"label":"Set","value":624},{"label":"Out","value":687},{"label":"Nov","value":591},{"label":"Dez","value":583}];
const MX = 914;
