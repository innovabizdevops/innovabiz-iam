...
const PAGE = "Payment";
const KPIS = [{"l":"Formulários Ativos","v":"3.365","t":"+0.6%","d":"up"},{"l":"Submissões/Dia","v":"3026","t":"-4.1%","d":"down"},{"l":"Documentos Gerados","v":"4.299","t":"+14.4%","d":"up"},{"l":"Templates","v":"6.770","t":"+12.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.989","2026-03-19","3.260","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.176","2026-03-10","7.409","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.419","2026-03-01","8.610","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.505","2026-01-02","5.558","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.820","2026-01-22","5.085","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":536},{"label":"Mar","value":870},{"label":"Abr","value":563},{"label":"Mai","value":867},{"label":"Jun","value":634},{"label":"Jul","value":570},{"label":"Ago","value":535},{"label":"Set","value":757},{"label":"Out","value":793},{"label":"Nov","value":509},{"label":"Dez","value":658}];
const MX = 870;
