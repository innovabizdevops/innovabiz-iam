...
const PAGE = "Outreach";
const KPIS = [{"l":"Formulários Ativos","v":"8.576","t":"+12.6%","d":"up"},{"l":"Submissões/Dia","v":"542","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"6.684","t":"+4.6%","d":"up"},{"l":"Templates","v":"2.033","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","424","2026-03-22","3.959","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.965","2026-01-13","8.552","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.871","2026-01-17","1.240","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","702","2026-01-20","1.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.891","2026-03-02","486","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":483},{"label":"Mar","value":352},{"label":"Abr","value":520},{"label":"Mai","value":518},{"label":"Jun","value":497},{"label":"Jul","value":567},{"label":"Ago","value":454},{"label":"Set","value":326},{"label":"Out","value":332},{"label":"Nov","value":299},{"label":"Dez","value":332}];
const MX = 628;
