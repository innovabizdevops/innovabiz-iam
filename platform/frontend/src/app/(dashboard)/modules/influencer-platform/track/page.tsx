...
const PAGE = "Track";
const KPIS = [{"l":"Formulários Ativos","v":"8.383","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"4562","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"6.316","t":"+17.5%","d":"up"},{"l":"Templates","v":"7.622","t":"+4.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.424","2026-02-07","2.039","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.706","2026-03-01","5.459","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.729","2026-02-06","4.548","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.993","2026-03-01","8.871","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.400","2026-03-25","1.417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":529},{"label":"Mar","value":611},{"label":"Abr","value":375},{"label":"Mai","value":345},{"label":"Jun","value":530},{"label":"Jul","value":502},{"label":"Ago","value":554},{"label":"Set","value":441},{"label":"Out","value":387},{"label":"Nov","value":629},{"label":"Dez","value":488}];
const MX = 629;
