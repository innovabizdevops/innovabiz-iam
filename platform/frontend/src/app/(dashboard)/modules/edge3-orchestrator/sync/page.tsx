...
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"8.949","t":"-4.1%","d":"down"},{"l":"Chamadas/Hora","v":"1366","t":"+8.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.7%","t":"-0.9%","d":"down"},{"l":"Latência Média (ms)","v":"45ms","t":"-3.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.292","190","79.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.797","4.391","97.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","546","7.143","99.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.443","4.995","89.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","613","8.973","81.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":607},{"label":"Mar","value":579},{"label":"Abr","value":569},{"label":"Mai","value":903},{"label":"Jun","value":691},{"label":"Jul","value":803},{"label":"Ago","value":583},{"label":"Set","value":698},{"label":"Out","value":684},{"label":"Nov","value":754},{"label":"Dez","value":596}];
const MX = 903;
