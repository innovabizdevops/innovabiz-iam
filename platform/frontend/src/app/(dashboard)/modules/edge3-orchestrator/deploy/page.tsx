...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Edge3 Orchestrator","v":"2.529","t":"-1.7%","d":"down"},{"l":"Deploy Ativos","v":"7.870","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"65","t":"+2.9%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge3 Orchestrator #001","Edge3 Orchestrator #002","1.818","814","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Edge3 Orchestrator #002","Edge3 Orchestrator #003","1.831","7.564","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge3 Orchestrator #003","Edge3 Orchestrator #004","5.717","1.327","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Edge3 Orchestrator #004","Edge3 Orchestrator #005","7.285","4.806","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge3 Orchestrator #005","Edge3 Orchestrator #001","2.621","759","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":583},{"label":"Mar","value":837},{"label":"Abr","value":867},{"label":"Mai","value":725},{"label":"Jun","value":890},{"label":"Jul","value":514},{"label":"Ago","value":682},{"label":"Set","value":824},{"label":"Out","value":574},{"label":"Nov","value":609},{"label":"Dez","value":814}];
const MX = 890;
