...
const ACCENT = "#0f766e";
const MODULE = "EDGE3 Edge Orchestrator";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Edge3 Orchestrator","v":"5.650","t":"+6.9%","d":"up"},{"l":"Monitor Ativos","v":"5.724","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+13.3%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge3 Orchestrator #001","Edge3 Orchestrator #002","1.305","3.351","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Edge3 Orchestrator #002","Edge3 Orchestrator #003","1.486","7.151","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge3 Orchestrator #003","Edge3 Orchestrator #004","9.034","5.419","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Edge3 Orchestrator #004","Edge3 Orchestrator #005","7.370","4.024","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge3 Orchestrator #005","Edge3 Orchestrator #001","8.146","4.009","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":1052},{"label":"Mar","value":777},{"label":"Abr","value":823},{"label":"Mai","value":719},{"label":"Jun","value":1024},{"label":"Jul","value":724},{"label":"Ago","value":1004},{"label":"Set","value":713},{"label":"Out","value":1048},{"label":"Nov","value":973},{"label":"Dez","value":1077}];
const MX = 1077;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>RTM</span></h1>
                </div>
