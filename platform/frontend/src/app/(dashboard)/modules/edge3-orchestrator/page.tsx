...
/* ═══ EDGE3 Edge Orchestrator — Dashboard ═══ */

const ACCENT = "#0f766e";

const KPIS = [
    { label: "Total Registos", value: "2224", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2835", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€497K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "359065224", cells: ["EDG-2224", "EDGE3 Edge Orchestrator Item 1", "1/1/2026", "€15 324"], status: "active" as const },
    { id: "359068795", cells: ["EDG-5795", "EDGE3 Edge Orchestrator Item 2", "16/8/2026", "€18 895"], status: "pending" as const },
    { id: "359072366", cells: ["EDG-9366", "EDGE3 Edge Orchestrator Item 3", "3/3/2026", "€22 466"], status: "completed" as const },
    { id: "359075937", cells: ["EDG-3937", "EDGE3 Edge Orchestrator Item 4", "18/10/2026", "€26 037"], status: "warning" as const },
    { id: "359079508", cells: ["EDG-7508", "EDGE3 Edge Orchestrator Item 5", "5/5/2026", "€29 608"], status: "active" as const },
];
...
export default function Edge3EdgeOrchestratorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDGE3 Edge Orchestrator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDGE3 Edge Orchestrator</p>
                    </div>
                </div>
