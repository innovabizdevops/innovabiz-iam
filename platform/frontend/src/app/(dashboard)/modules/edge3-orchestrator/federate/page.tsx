...
const PAGE = "Federate";
const KPIS = [{"l":"Total Edge3 Orchestrator","v":"4.387","t":"+11.1%","d":"up"},{"l":"Federate Ativos","v":"4.113","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"83","t":"-3.3%","d":"down"}];
const COLS = ["ID","Federate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge3 Orchestrator #001","Edge3 Orchestrator #002","4.307","8.839","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Edge3 Orchestrator #002","Edge3 Orchestrator #003","3.032","672","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge3 Orchestrator #003","Edge3 Orchestrator #004","4.449","2.272","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Edge3 Orchestrator #004","Edge3 Orchestrator #005","6.396","5.662","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge3 Orchestrator #005","Edge3 Orchestrator #001","6.589","5.742","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":581},{"label":"Mar","value":597},{"label":"Abr","value":668},{"label":"Mai","value":604},{"label":"Jun","value":390},{"label":"Jul","value":572},{"label":"Ago","value":563},{"label":"Set","value":496},{"label":"Out","value":489},{"label":"Nov","value":430},{"label":"Dez","value":544}];
const MX = 668;
