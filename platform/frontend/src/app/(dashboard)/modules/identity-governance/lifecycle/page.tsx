...
const PAGE = "Lifecycle Mgmt";
const KPIS = [{"l":"Riscos Identificados","v":"1.774","t":"-3.2%","d":"down"},{"l":"Mitigações Ativas","v":"8.610","t":"+15.2%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+9.6%","d":"up"},{"l":"Incidentes YTD","v":"8.634","t":"+10.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.400","4.214","5.744","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.921","4.401","4.415","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.670","1.273","4.053","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.003","4.500","8.695","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.416","5.745","979","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":421},{"label":"Mar","value":327},{"label":"Abr","value":397},{"label":"Mai","value":473},{"label":"Jun","value":548},{"label":"Jul","value":306},{"label":"Ago","value":350},{"label":"Set","value":294},{"label":"Out","value":454},{"label":"Nov","value":517},{"label":"Dez","value":595}];
const MX = 595;
