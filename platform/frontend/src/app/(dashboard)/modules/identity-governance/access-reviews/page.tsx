...
const PAGE = "Access Reviews";
const KPIS = [{"l":"Riscos Identificados","v":"6.901","t":"+7.8%","d":"up"},{"l":"Mitigações Ativas","v":"9.025","t":"+16.8%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+0.7%","d":"up"},{"l":"Incidentes YTD","v":"7.618","t":"-4.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.015","6.417","7.283","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","982","1.036","3.039","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.607","8.376","504","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.809","8.170","5.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.861","511","8.753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":807},{"label":"Mar","value":790},{"label":"Abr","value":965},{"label":"Mai","value":796},{"label":"Jun","value":735},{"label":"Jul","value":799},{"label":"Ago","value":1068},{"label":"Set","value":882},{"label":"Out","value":1038},{"label":"Nov","value":826},{"label":"Dez","value":778}];
const MX = 1068;
