...
const PAGE = "AI Risk Scoring";
const KPIS = [{"l":"Riscos Identificados","v":"4.237","t":"+7.4%","d":"up"},{"l":"Mitigações Ativas","v":"4.217","t":"+5.3%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"+1.0%","d":"up"},{"l":"Incidentes YTD","v":"1.941","t":"+4.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","751","5.586","1.731","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.493","5.975","4.795","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.090","6.922","6.400","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.121","5.157","4.214","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.002","1.057","1.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":465},{"label":"Mar","value":505},{"label":"Abr","value":309},{"label":"Mai","value":318},{"label":"Jun","value":430},{"label":"Jul","value":615},{"label":"Ago","value":384},{"label":"Set","value":463},{"label":"Out","value":331},{"label":"Nov","value":466},{"label":"Dez","value":375}];
const MX = 615;
