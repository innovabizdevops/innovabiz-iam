...
const PAGE = "ISO 27001 Controls";
const KPIS = [{"l":"Riscos Identificados","v":"5.163","t":"+6.2%","d":"up"},{"l":"Mitigações Ativas","v":"5.377","t":"+13.0%","d":"up"},{"l":"Score Risco Geral","v":"74","t":"+10.1%","d":"up"},{"l":"Incidentes YTD","v":"8.578","t":"+-0.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.511","8.173","6.621","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.931","1.208","404","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","384","2.124","9.052","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.013","4.565","3.240","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.948","770","4.400","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":598},{"label":"Mar","value":653},{"label":"Abr","value":779},{"label":"Mai","value":526},{"label":"Jun","value":741},{"label":"Jul","value":768},{"label":"Ago","value":501},{"label":"Set","value":489},{"label":"Out","value":599},{"label":"Nov","value":483},{"label":"Dez","value":489}];
const MX = 779;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f172a'}}>ISO</span></h1>
                </div>
