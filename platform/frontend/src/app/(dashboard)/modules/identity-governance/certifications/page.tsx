...
const PAGE = "Certification Campaign";
const KPIS = [{"l":"Riscos Identificados","v":"5.422","t":"-3.9%","d":"down"},{"l":"Mitigações Ativas","v":"3.913","t":"-0.4%","d":"down"},{"l":"Score Risco Geral","v":"80","t":"+2.5%","d":"up"},{"l":"Incidentes YTD","v":"2.164","t":"+6.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.722","8.082","512","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.430","1.995","1.929","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.520","393","758","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.484","4.078","4.395","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.168","642","7.463","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":615},{"label":"Mar","value":822},{"label":"Abr","value":818},{"label":"Mai","value":846},{"label":"Jun","value":565},{"label":"Jul","value":593},{"label":"Ago","value":793},{"label":"Set","value":740},{"label":"Out","value":790},{"label":"Nov","value":563},{"label":"Dez","value":524}];
const MX = 846;
