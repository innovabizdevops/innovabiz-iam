...
const KPIS = [{"l":"Riscos Identificados","v":"2.492","t":"+2.2%","d":"up"},{"l":"Mitigações Ativas","v":"6.775","t":"+15.2%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+5.3%","d":"up"},{"l":"Incidentes YTD","v":"3.022","t":"-3.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","280","3.776","549","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.683","5.437","5.885","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","675","785","560","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.365","601","5.598","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.776","232","4.645","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":735},{"label":"Mar","value":884},{"label":"Abr","value":947},{"label":"Mai","value":1051},{"label":"Jun","value":1049},{"label":"Jul","value":991},{"label":"Ago","value":742},{"label":"Set","value":994},{"label":"Out","value":757},{"label":"Nov","value":857},{"label":"Dez","value":984}];
const MX = 1051;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f172a'}}>PAM</span></h1>
                </div>
