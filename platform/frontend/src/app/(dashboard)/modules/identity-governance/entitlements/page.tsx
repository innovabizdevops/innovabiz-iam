...
const PAGE = "Entitlement Catalog";
const KPIS = [{"l":"Riscos Identificados","v":"8.410","t":"-2.3%","d":"down"},{"l":"Mitigações Ativas","v":"2.733","t":"+9.9%","d":"up"},{"l":"Score Risco Geral","v":"95","t":"-3.9%","d":"down"},{"l":"Incidentes YTD","v":"8.244","t":"-0.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.124","7.183","6.409","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.219","3.133","3.114","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.951","5.073","7.995","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.275","5.520","1.352","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.967","1.333","241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":922},{"label":"Mar","value":712},{"label":"Abr","value":904},{"label":"Mai","value":862},{"label":"Jun","value":755},{"label":"Jul","value":799},{"label":"Ago","value":802},{"label":"Set","value":923},{"label":"Out","value":768},{"label":"Nov","value":667},{"label":"Dez","value":687}];
const MX = 923;
