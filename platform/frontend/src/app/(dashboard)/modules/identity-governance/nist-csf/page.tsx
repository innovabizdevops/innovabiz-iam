...
const PAGE = "NIST CSF Map";
const KPIS = [{"l":"Riscos Identificados","v":"7.466","t":"-5.6%","d":"down"},{"l":"Mitigações Ativas","v":"830","t":"+5.7%","d":"up"},{"l":"Score Risco Geral","v":"85","t":"-2.5%","d":"down"},{"l":"Incidentes YTD","v":"7.563","t":"-1.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.250","3.048","8.502","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.337","4.541","6.701","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.432","1.789","3.394","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","285","520","1.623","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.009","1.001","7.046","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":300},{"label":"Mar","value":512},{"label":"Abr","value":401},{"label":"Mai","value":447},{"label":"Jun","value":276},{"label":"Jul","value":667},{"label":"Ago","value":415},{"label":"Set","value":370},{"label":"Out","value":510},{"label":"Nov","value":352},{"label":"Dez","value":418}];
const MX = 667;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f172a'}}>NIST</span></h1>
                </div>
