...
const PAGE = "Separation of Duties";
const KPIS = [{"l":"Riscos Identificados","v":"4.667","t":"+14.4%","d":"up"},{"l":"Mitigações Ativas","v":"1.010","t":"-1.6%","d":"down"},{"l":"Score Risco Geral","v":"61","t":"-2.5%","d":"down"},{"l":"Incidentes YTD","v":"7.239","t":"+1.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.401","1.582","8.102","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.747","8.641","1.620","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.536","2.257","1.329","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.088","4.453","1.140","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.018","7.601","2.436","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":624},{"label":"Mar","value":439},{"label":"Abr","value":492},{"label":"Mai","value":476},{"label":"Jun","value":337},{"label":"Jul","value":346},{"label":"Ago","value":495},{"label":"Set","value":405},{"label":"Out","value":675},{"label":"Nov","value":640},{"label":"Dez","value":629}];
const MX = 675;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f172a'}}>SOD</span></h1>
                </div>
