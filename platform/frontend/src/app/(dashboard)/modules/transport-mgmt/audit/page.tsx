...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.835","t":"+16.1%","d":"up"},{"l":"NC Abertas","v":"3.819","t":"+7.0%","d":"up"},{"l":"Conformidade (%)","v":"84.2%","t":"+17.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.427","t":"+13.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.335","79.3%","1.772","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.752","79.9%","7.112","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.232","80.6%","8.854","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.483","71.1%","2.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.052","94.5%","4.549","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":721},{"label":"Mar","value":691},{"label":"Abr","value":835},{"label":"Mai","value":466},{"label":"Jun","value":735},{"label":"Jul","value":562},{"label":"Ago","value":568},{"label":"Set","value":817},{"label":"Out","value":760},{"label":"Nov","value":733},{"label":"Dez","value":687}];
const MX = 835;
