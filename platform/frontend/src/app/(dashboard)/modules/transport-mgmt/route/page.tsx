...
const ACCENT = "#6366f1";
const MODULE = "Transport Management";
const PAGE = "Route Plan";
const KPIS = [{"l":"Atletas Registados","v":"1.559","t":"+15.4%","d":"up"},{"l":"Treinos/Semana","v":"1733","t":"-2.7%","d":"down"},{"l":"Competições","v":"8.825","t":"+16.1%","d":"up"},{"l":"Performance Score","v":"70","t":"+16.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.012","4.057","6.755","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.977","2.936","221","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.197","5.122","8.766","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.051","5.891","5.403","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.352","4.571","8.642","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":955},{"label":"Mar","value":655},{"label":"Abr","value":727},{"label":"Mai","value":799},{"label":"Jun","value":957},{"label":"Jul","value":958},{"label":"Ago","value":768},{"label":"Set","value":839},{"label":"Out","value":943},{"label":"Nov","value":763},{"label":"Dez","value":707}];
const MX = 958;
