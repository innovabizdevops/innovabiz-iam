...
const PAGE = "Dock";
const KPIS = [{"l":"Atletas Registados","v":"2.454","t":"+7.2%","d":"up"},{"l":"Treinos/Semana","v":"1845","t":"+6.9%","d":"up"},{"l":"Competições","v":"1.543","t":"+16.9%","d":"up"},{"l":"Performance Score","v":"81","t":"+4.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","530","544","859","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.816","3.021","335","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.455","2.112","3.463","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.285","3.248","7.491","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.564","5.520","4.051","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":853},{"label":"Mar","value":789},{"label":"Abr","value":807},{"label":"Mai","value":780},{"label":"Jun","value":822},{"label":"Jul","value":916},{"label":"Ago","value":652},{"label":"Set","value":721},{"label":"Out","value":738},{"label":"Nov","value":829},{"label":"Dez","value":734}];
const MX = 916;
