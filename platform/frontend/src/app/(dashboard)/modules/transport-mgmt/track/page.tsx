...
const PAGE = "Track";
const KPIS = [{"l":"Atletas Registados","v":"439","t":"+14.1%","d":"up"},{"l":"Treinos/Semana","v":"3673","t":"+6.2%","d":"up"},{"l":"Competições","v":"560","t":"-0.3%","d":"down"},{"l":"Performance Score","v":"67","t":"+0.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","9.043","4.613","7.606","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.742","1.434","380","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.256","8.854","5.780","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.093","6.563","4.099","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.035","4.932","334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":524},{"label":"Mar","value":853},{"label":"Abr","value":700},{"label":"Mai","value":484},{"label":"Jun","value":589},{"label":"Jul","value":476},{"label":"Ago","value":614},{"label":"Set","value":598},{"label":"Out","value":831},{"label":"Nov","value":483},{"label":"Dez","value":486}];
const MX = 853;
