...
const PAGE = "Carrier";
const KPIS = [{"l":"ARR (€M)","v":"€18.0M","t":"+6.3%","d":"up"},{"l":"MRR (€)","v":"€11158","t":"+14.4%","d":"up"},{"l":"Churn (%)","v":"90.2%","t":"+15.4%","d":"up"},{"l":"ARPU (€)","v":"€85674","t":"+8.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45254.90","4.130","€ 23832.25","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44156.28","8.183","€ 42415.60","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 49267.51","2.159","€ 13381.18","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4875.68","2.129","€ 12550.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 25643.98","6.124","€ 9345.96","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":723},{"label":"Mar","value":937},{"label":"Abr","value":741},{"label":"Mai","value":906},{"label":"Jun","value":833},{"label":"Jul","value":704},{"label":"Ago","value":916},{"label":"Set","value":1018},{"label":"Out","value":909},{"label":"Nov","value":731},{"label":"Dez","value":1058}];
const MX = 1058;
