...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.126","t":"+7.1%","d":"up"},{"l":"NC Abertas","v":"8.552","t":"+13.4%","d":"up"},{"l":"Conformidade (%)","v":"86.7%","t":"+1.3%","d":"up"},{"l":"CAPAs Pendentes","v":"1.455","t":"+11.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.370","84.2%","8.417","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.869","79.1%","8.918","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.959","82.4%","8.373","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.893","99.0%","2.048","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.952","84.7%","7.621","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":233},{"label":"Fev","value":586},{"label":"Mar","value":534},{"label":"Abr","value":448},{"label":"Mai","value":426},{"label":"Jun","value":502},{"label":"Jul","value":602},{"label":"Ago","value":224},{"label":"Set","value":412},{"label":"Out","value":249},{"label":"Nov","value":312},{"label":"Dez","value":516}];
const MX = 602;
