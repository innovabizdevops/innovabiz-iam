...
const PAGE = "Dependents";
const KPIS = [{"l":"Total Benefits Admin","v":"5.311","t":"+17.7%","d":"up"},{"l":"Dependents Ativos","v":"4.571","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"69","t":"-0.7%","d":"down"}];
const COLS = ["ID","Dependents","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Benefits Admin #001","Benefits Admin #002","3.960","5.120","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Benefits Admin #002","Benefits Admin #003","5.240","1.950","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Benefits Admin #003","Benefits Admin #004","5.872","1.440","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Benefits Admin #004","Benefits Admin #005","3.081","1.127","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Benefits Admin #005","Benefits Admin #001","4.039","7.593","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":572},{"label":"Mar","value":551},{"label":"Abr","value":579},{"label":"Mai","value":675},{"label":"Jun","value":762},{"label":"Jul","value":725},{"label":"Ago","value":576},{"label":"Set","value":531},{"label":"Out","value":720},{"label":"Nov","value":734},{"label":"Dez","value":722}];
const MX = 762;
