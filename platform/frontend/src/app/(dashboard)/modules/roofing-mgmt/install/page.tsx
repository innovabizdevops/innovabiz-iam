...
const PAGE = "Install";
const KPIS = [{"l":"Total Roofing Mgmt","v":"886","t":"+3.9%","d":"up"},{"l":"Install Ativos","v":"6.776","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"57","t":"-1.2%","d":"down"}];
const COLS = ["ID","Install","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roofing Mgmt #001","Roofing Mgmt #002","5.035","6.480","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Roofing Mgmt #002","Roofing Mgmt #003","4.869","524","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Roofing Mgmt #003","Roofing Mgmt #004","6.423","1.532","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Roofing Mgmt #004","Roofing Mgmt #005","7.960","3.486","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roofing Mgmt #005","Roofing Mgmt #001","3.917","6.063","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":452},{"label":"Mar","value":405},{"label":"Abr","value":465},{"label":"Mai","value":560},{"label":"Jun","value":630},{"label":"Jul","value":535},{"label":"Ago","value":645},{"label":"Set","value":619},{"label":"Out","value":592},{"label":"Nov","value":462},{"label":"Dez","value":780}];
const MX = 780;
