...
const PAGE = "Warranty";
const KPIS = [{"l":"ARR (€M)","v":"€13.0M","t":"+4.9%","d":"up"},{"l":"MRR (€)","v":"€45323","t":"+14.1%","d":"up"},{"l":"Churn (%)","v":"68.7%","t":"+14.0%","d":"up"},{"l":"ARPU (€)","v":"€65754","t":"+2.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 41897.73","8.247","€ 20443.72","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17813.12","8.848","€ 30049.36","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27538.90","3.498","€ 16656.37","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16813.20","8.944","€ 42254.61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4902.87","4.640","€ 23365.58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":903},{"label":"Mar","value":905},{"label":"Abr","value":590},{"label":"Mai","value":843},{"label":"Jun","value":677},{"label":"Jul","value":703},{"label":"Ago","value":617},{"label":"Set","value":813},{"label":"Out","value":619},{"label":"Nov","value":693},{"label":"Dez","value":758}];
const MX = 905;
