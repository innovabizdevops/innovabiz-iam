...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Roofing Mgmt","v":"6.872","t":"+6.9%","d":"up"},{"l":"Inspect Ativos","v":"6.439","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"82.3%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"77","t":"+1.2%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roofing Mgmt #001","Roofing Mgmt #002","6.907","905","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Roofing Mgmt #002","Roofing Mgmt #003","973","2.574","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Roofing Mgmt #003","Roofing Mgmt #004","6.467","717","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Roofing Mgmt #004","Roofing Mgmt #005","4.357","7.346","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roofing Mgmt #005","Roofing Mgmt #001","8.797","3.997","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":575},{"label":"Mar","value":656},{"label":"Abr","value":451},{"label":"Mai","value":397},{"label":"Jun","value":750},{"label":"Jul","value":731},{"label":"Ago","value":516},{"label":"Set","value":514},{"label":"Out","value":546},{"label":"Nov","value":695},{"label":"Dez","value":606}];
const MX = 750;
