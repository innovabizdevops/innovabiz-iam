...
const ACCENT = "#6366f1";
const MODULE = "Roofing Management";
const PAGE = "Estimate";
const KPIS = [{"l":"Total Roofing Mgmt","v":"8.995","t":"+8.6%","d":"up"},{"l":"Estimate Ativos","v":"3.398","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"59","t":"-3.2%","d":"down"}];
const COLS = ["ID","Estimate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roofing Mgmt #001","Roofing Mgmt #002","6.821","1.714","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Roofing Mgmt #002","Roofing Mgmt #003","5.024","1.923","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Roofing Mgmt #003","Roofing Mgmt #004","2.288","6.020","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Roofing Mgmt #004","Roofing Mgmt #005","8.556","8.387","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roofing Mgmt #005","Roofing Mgmt #001","8.888","6.913","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":473},{"label":"Mar","value":725},{"label":"Abr","value":481},{"label":"Mai","value":486},{"label":"Jun","value":725},{"label":"Jul","value":444},{"label":"Ago","value":442},{"label":"Set","value":726},{"label":"Out","value":655},{"label":"Nov","value":404},{"label":"Dez","value":466}];
const MX = 776;
