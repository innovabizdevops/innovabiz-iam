...
const PAGE = "Material";
const KPIS = [{"l":"Total Roofing Mgmt","v":"1.620","t":"+15.4%","d":"up"},{"l":"Material Ativos","v":"6.354","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"93","t":"+10.2%","d":"up"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Roofing Mgmt #001","Roofing Mgmt #002","2.208","8.229","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Roofing Mgmt #002","Roofing Mgmt #003","2.623","533","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Roofing Mgmt #003","Roofing Mgmt #004","4.986","8.068","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Roofing Mgmt #004","Roofing Mgmt #005","5.897","6.136","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Roofing Mgmt #005","Roofing Mgmt #001","7.450","5.447","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":324},{"label":"Mar","value":616},{"label":"Abr","value":396},{"label":"Mai","value":504},{"label":"Jun","value":515},{"label":"Jul","value":467},{"label":"Ago","value":378},{"label":"Set","value":426},{"label":"Out","value":292},{"label":"Nov","value":437},{"label":"Dez","value":377}];
const MX = 616;
