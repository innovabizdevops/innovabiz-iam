...
const KPIS = [
    { label: "Total", value: "525", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "150", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1614", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "292270642", cells: ["PER-5642", "Body Wash Item 1", "7/11/2026", "€20 742"], status: "active" as const },
    { id: "292274213", cells: ["PER-9213", "Body Wash Item 2", "22/6/2026", "€24 313"], status: "pending" as const },
    { id: "292277784", cells: ["PER-3784", "Body Wash Item 3", "9/1/2026", "€27 884"], status: "completed" as const },
    { id: "292281355", cells: ["PER-7355", "Body Wash Item 4", "24/8/2026", "€31 455"], status: "warning" as const },
    { id: "292284926", cells: ["PER-1926", "Body Wash Item 5", "11/3/2026", "€35 026"], status: "active" as const },
];
...
export default function PersonalCareBodyWashPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Body Wash</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Body Wash</p>
                    </div>
                </div>
