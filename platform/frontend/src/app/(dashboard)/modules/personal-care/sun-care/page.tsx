...
const KPIS = [
    { label: "Total", value: "2952", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "208", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "280", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "735238380", cells: ["PER-2380", "Sun Care Item 1", "17/1/2026", "€38 480"], status: "active" as const },
    { id: "735241951", cells: ["PER-5951", "Sun Care Item 2", "4/8/2026", "€42 051"], status: "pending" as const },
    { id: "735245522", cells: ["PER-9522", "Sun Care Item 3", "19/3/2026", "€45 622"], status: "completed" as const },
    { id: "735249093", cells: ["PER-4093", "Sun Care Item 4", "6/10/2026", "€49 193"], status: "warning" as const },
    { id: "735252664", cells: ["PER-7664", "Sun Care Item 5", "21/5/2026", "€2764"], status: "active" as const },
];
...
export default function PersonalCareSunCarePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sun Care</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Sun Care</p>
                    </div>
                </div>
