...
/* ═══ Personal Care — Claim Substantiate ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "2007", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "66", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "201", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1570247294", cells: ["PER-9294", "Claim Substantiate Item 1", "15/3/2026", "€47 394"], status: "active" as const },
    { id: "1570250865", cells: ["PER-3865", "Claim Substantiate Item 2", "2/10/2026", "€965"], status: "pending" as const },
    { id: "1570254436", cells: ["PER-7436", "Claim Substantiate Item 3", "17/5/2026", "€4536"], status: "completed" as const },
    { id: "1570258007", cells: ["PER-2007", "Claim Substantiate Item 4", "4/12/2026", "€8107"], status: "warning" as const },
    { id: "1570261578", cells: ["PER-5578", "Claim Substantiate Item 5", "19/7/2026", "€11 678"], status: "active" as const },
];
...
export default function PersonalCareClaimSubstantiatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Claim Substantiate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Claim Substantiate</p>
                    </div>
                </div>
