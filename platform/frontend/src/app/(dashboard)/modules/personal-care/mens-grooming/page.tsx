...
const KPIS = [
    { label: "Total", value: "2443", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "304", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "942", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "706910924", cells: ["PER-6924", "Mens Grooming Item 1", "21/9/2026", "€11 024"], status: "active" as const },
    { id: "706914495", cells: ["PER-1495", "Mens Grooming Item 2", "8/4/2026", "€14 595"], status: "pending" as const },
    { id: "706918066", cells: ["PER-5066", "Mens Grooming Item 3", "23/11/2026", "€18 166"], status: "completed" as const },
    { id: "706921637", cells: ["PER-8637", "Mens Grooming Item 4", "10/6/2026", "€21 737"], status: "warning" as const },
    { id: "706925208", cells: ["PER-3208", "Mens Grooming Item 5", "25/1/2026", "€25 308"], status: "active" as const },
];
...
export default function PersonalCareMensGroomingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mens Grooming</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Mens Grooming</p>
                    </div>
                </div>
