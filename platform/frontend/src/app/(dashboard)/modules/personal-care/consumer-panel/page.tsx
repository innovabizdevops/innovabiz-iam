...
/* ═══ Personal Care — Consumer Panel ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "1733", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "93", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3190", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1386672265", cells: ["PER-7265", "Consumer Panel Item 1", "14/2/2026", "€22 365"], status: "active" as const },
    { id: "1386675836", cells: ["PER-1836", "Consumer Panel Item 2", "1/9/2026", "€25 936"], status: "pending" as const },
    { id: "1386679407", cells: ["PER-5407", "Consumer Panel Item 3", "16/4/2026", "€29 507"], status: "completed" as const },
    { id: "1386682978", cells: ["PER-8978", "Consumer Panel Item 4", "3/11/2026", "€33 078"], status: "warning" as const },
    { id: "1386686549", cells: ["PER-3549", "Consumer Panel Item 5", "18/6/2026", "€36 649"], status: "active" as const },
];
...
export default function PersonalCareConsumerPanelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Consumer Panel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Consumer Panel</p>
                    </div>
                </div>
