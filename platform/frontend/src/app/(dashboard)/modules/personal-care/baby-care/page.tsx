...
const KPIS = [
    { label: "Total", value: "77", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "72", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3370", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "697414772", cells: ["PER-5772", "Baby Care Item 1", "13/9/2026", "€14 872"], status: "active" as const },
    { id: "697418343", cells: ["PER-9343", "Baby Care Item 2", "28/4/2026", "€18 443"], status: "pending" as const },
    { id: "697421914", cells: ["PER-3914", "Baby Care Item 3", "15/11/2026", "€22 014"], status: "completed" as const },
    { id: "697425485", cells: ["PER-7485", "Baby Care Item 4", "2/6/2026", "€25 585"], status: "warning" as const },
    { id: "697429056", cells: ["PER-2056", "Baby Care Item 5", "17/1/2026", "€29 156"], status: "active" as const },
];
...
export default function PersonalCareBabyCarePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Baby Care</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Baby Care</p>
                    </div>
                </div>
