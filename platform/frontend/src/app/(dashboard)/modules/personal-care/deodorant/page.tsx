...
const KPIS = [
    { label: "Total", value: "2943", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "451", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3118", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "784709663", cells: ["PER-9663", "Deodorant Item 1", "4/12/2026", "€9763"], status: "active" as const },
    { id: "784713234", cells: ["PER-4234", "Deodorant Item 2", "19/7/2026", "€13 334"], status: "pending" as const },
    { id: "784716805", cells: ["PER-7805", "Deodorant Item 3", "6/2/2026", "€16 905"], status: "completed" as const },
    { id: "784720376", cells: ["PER-2376", "Deodorant Item 4", "21/9/2026", "€20 476"], status: "warning" as const },
    { id: "784723947", cells: ["PER-5947", "Deodorant Item 5", "8/4/2026", "€24 047"], status: "active" as const },
];
...
export default function PersonalCareDeodorantPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Deodorant</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Deodorant</p>
                    </div>
                </div>
