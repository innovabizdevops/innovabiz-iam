...
const KPIS = [
    { label: "Total", value: "4345", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "416", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2223", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "121197036", cells: ["PER-4036", "Oral Care Item 1", "17/1/2026", "€47 136"], status: "active" as const },
    { id: "121200607", cells: ["PER-7607", "Oral Care Item 2", "4/8/2026", "€707"], status: "pending" as const },
    { id: "121204178", cells: ["PER-2178", "Oral Care Item 3", "19/3/2026", "€4278"], status: "completed" as const },
    { id: "121207749", cells: ["PER-5749", "Oral Care Item 4", "6/10/2026", "€7849"], status: "warning" as const },
    { id: "121211320", cells: ["PER-9320", "Oral Care Item 5", "21/5/2026", "€11 420"], status: "active" as const },
];
...
export default function PersonalCareOralCarePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Oral Care</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Oral Care</p>
                    </div>
                </div>
