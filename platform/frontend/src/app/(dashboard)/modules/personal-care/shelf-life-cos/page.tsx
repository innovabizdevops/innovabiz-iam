...
/* ═══ Personal Care — Shelf Life Cos ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "2049", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "268", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "697", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "569584360", cells: ["PER-2360", "Shelf Life Cos Item 1", "17/5/2026", "€34 460"], status: "active" as const },
    { id: "569587931", cells: ["PER-5931", "Shelf Life Cos Item 2", "4/12/2026", "€38 031"], status: "pending" as const },
    { id: "569591502", cells: ["PER-9502", "Shelf Life Cos Item 3", "19/7/2026", "€41 602"], status: "completed" as const },
    { id: "569595073", cells: ["PER-4073", "Shelf Life Cos Item 4", "6/2/2026", "€45 173"], status: "warning" as const },
    { id: "569598644", cells: ["PER-7644", "Shelf Life Cos Item 5", "21/9/2026", "€48 744"], status: "active" as const },
];
...
export default function PersonalCareShelfLifeCosPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shelf Life Cos</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Shelf Life Cos</p>
                    </div>
                </div>
