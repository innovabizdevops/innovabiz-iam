...
/* ═══ Personal Care — Clinical Trial Cos ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total", value: "2411", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "467", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2785", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "94%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1446365247", cells: ["PER-3247", "Clinical Trial Cos Item 1", "20/4/2026", "€15 347"], status: "active" as const },
    { id: "1446368818", cells: ["PER-6818", "Clinical Trial Cos Item 2", "7/11/2026", "€18 918"], status: "pending" as const },
    { id: "1446372389", cells: ["PER-1389", "Clinical Trial Cos Item 3", "22/6/2026", "€22 489"], status: "completed" as const },
    { id: "1446375960", cells: ["PER-4960", "Clinical Trial Cos Item 4", "9/1/2026", "€26 060"], status: "warning" as const },
    { id: "1446379531", cells: ["PER-8531", "Clinical Trial Cos Item 5", "24/8/2026", "€29 631"], status: "active" as const },
];
...
export default function PersonalCareClinicalTrialCosPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Clinical Trial Cos</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Personal Care • Clinical Trial Cos</p>
                    </div>
                </div>
