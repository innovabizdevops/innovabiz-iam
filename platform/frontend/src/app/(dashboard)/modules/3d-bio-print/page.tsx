...
/* ═══ Bioprinting — Dashboard ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total Registos", value: "7975", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3840", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€297K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "328014675", cells: ["3D-1675", "Bioprinting Item 1", "24/4/2026", "€14 775"], status: "active" as const },
    { id: "328018246", cells: ["3D-5246", "Bioprinting Item 2", "11/11/2026", "€18 346"], status: "pending" as const },
    { id: "328021817", cells: ["3D-8817", "Bioprinting Item 3", "26/6/2026", "€21 917"], status: "completed" as const },
    { id: "328025388", cells: ["3D-3388", "Bioprinting Item 4", "13/1/2026", "€25 488"], status: "warning" as const },
    { id: "328028959", cells: ["3D-6959", "Bioprinting Item 5", "28/8/2026", "€29 059"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bioprinting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Bioprinting</p>
                    </div>
                </div>
