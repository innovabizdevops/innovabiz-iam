...
const PAGE = "Tissue";
const KPIS = [{"l":"Total 3d Bio Print","v":"4.367","t":"+4.5%","d":"up"},{"l":"Tissue Ativos","v":"8.642","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"62","t":"-2.6%","d":"down"}];
const COLS = ["ID","Tissue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Bio Print #001","3d Bio Print #002","5.785","4.747","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["3d Bio Print #002","3d Bio Print #003","4.929","3.258","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Bio Print #003","3d Bio Print #004","5.260","2.103","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["3d Bio Print #004","3d Bio Print #005","7.510","4.094","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Bio Print #005","3d Bio Print #001","3.143","2.568","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":615},{"label":"Mar","value":775},{"label":"Abr","value":740},{"label":"Mai","value":626},{"label":"Jun","value":638},{"label":"Jul","value":555},{"label":"Ago","value":813},{"label":"Set","value":604},{"label":"Out","value":691},{"label":"Nov","value":581},{"label":"Dez","value":637}];
const MX = 813;
