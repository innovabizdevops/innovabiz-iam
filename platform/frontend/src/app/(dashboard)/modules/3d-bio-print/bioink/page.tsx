...
const PAGE = "Bio-Ink";
const KPIS = [{"l":"Total 3d Bio Print","v":"547","t":"+4.1%","d":"up"},{"l":"Bio Ink Ativos","v":"2.961","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"67","t":"+5.8%","d":"up"}];
const COLS = ["ID","Bio Ink","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["3d Bio Print #001","3d Bio Print #002","2.437","8.667","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["3d Bio Print #002","3d Bio Print #003","6.596","8.729","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["3d Bio Print #003","3d Bio Print #004","4.478","708","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["3d Bio Print #004","3d Bio Print #005","4.730","3.984","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["3d Bio Print #005","3d Bio Print #001","7.186","5.556","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":552},{"label":"Mar","value":898},{"label":"Abr","value":575},{"label":"Mai","value":711},{"label":"Jun","value":667},{"label":"Jul","value":823},{"label":"Ago","value":691},{"label":"Set","value":909},{"label":"Out","value":701},{"label":"Nov","value":910},{"label":"Dez","value":824}];
const MX = 910;
...
export default function BioinkPage() {
    return (
