...
const ACCENT = "#3730a3";
const MODULE = "Bioprinting";
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"3.262","t":"+8.8%","d":"up"},{"l":"Patentes (YTD)","v":"8.766","t":"+7.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.133","t":"+7.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€20.9M","t":"+7.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.581","79.6%","1.983","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.515","95.0%","1.721","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.424","85.7%","8.524","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.104","90.1%","2.942","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.704","74.5%","3.290","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":440},{"label":"Mar","value":344},{"label":"Abr","value":417},{"label":"Mai","value":311},{"label":"Jun","value":347},{"label":"Jul","value":427},{"label":"Ago","value":532},{"label":"Set","value":318},{"label":"Out","value":565},{"label":"Nov","value":599},{"label":"Dez","value":648}];
const MX = 658;
