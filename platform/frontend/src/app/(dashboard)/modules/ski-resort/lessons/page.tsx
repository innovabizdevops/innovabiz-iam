...
const PAGE = "Lessons";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.911","t":"+13.1%","d":"up"},{"l":"Sessões/Dia","v":"2184","t":"+16.1%","d":"up"},{"l":"MFA Adoção (%)","v":"91.1%","t":"+10.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"581","t":"+12.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.036","905","7.613","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.257","1.827","3.478","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.739","674","5.527","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.273","3.747","5.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.224","1.803","8.059","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":926},{"label":"Fev","value":963},{"label":"Mar","value":822},{"label":"Abr","value":771},{"label":"Mai","value":918},{"label":"Jun","value":641},{"label":"Jul","value":912},{"label":"Ago","value":953},{"label":"Set","value":671},{"label":"Out","value":836},{"label":"Nov","value":656},{"label":"Dez","value":882}];
const MX = 963;
