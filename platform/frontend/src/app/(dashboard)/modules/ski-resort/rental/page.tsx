...
const ACCENT = "#7c3aed";
const MODULE = "Ski Resort Mgmt";
const PAGE = "Rental";
const KPIS = [{"l":"Quartos Ocupados","v":"2.267","t":"+11.3%","d":"up"},{"l":"RevPAR (€)","v":"€58857","t":"+5.0%","d":"up"},{"l":"Ocupação (%)","v":"86.2%","t":"-4.5%","d":"down"},{"l":"Guest Satisfaction","v":"2.439","t":"+3.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.971","2026-01-07","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.206","2026-03-17","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.626","2026-01-23","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.424","2026-03-09","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.534","2026-01-26","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":706},{"label":"Mar","value":499},{"label":"Abr","value":583},{"label":"Mai","value":498},{"label":"Jun","value":431},{"label":"Jul","value":787},{"label":"Ago","value":480},{"label":"Set","value":676},{"label":"Out","value":489},{"label":"Nov","value":502},{"label":"Dez","value":666}];
const MX = 787;
