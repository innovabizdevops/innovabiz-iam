...
const PAGE = "Lift";
const KPIS = [{"l":"Quartos Ocupados","v":"7.625","t":"+13.2%","d":"up"},{"l":"RevPAR (€)","v":"€84774","t":"+9.3%","d":"up"},{"l":"Ocupação (%)","v":"86.3%","t":"+9.8%","d":"up"},{"l":"Guest Satisfaction","v":"3.771","t":"+4.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.036","2026-02-13","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.860","2026-03-16","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.001","2026-01-07","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","680","2026-01-06","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.230","2026-03-16","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":772},{"label":"Mar","value":981},{"label":"Abr","value":764},{"label":"Mai","value":839},{"label":"Jun","value":820},{"label":"Jul","value":728},{"label":"Ago","value":1036},{"label":"Set","value":881},{"label":"Out","value":783},{"label":"Nov","value":887},{"label":"Dez","value":1036}];
const MX = 1036;
