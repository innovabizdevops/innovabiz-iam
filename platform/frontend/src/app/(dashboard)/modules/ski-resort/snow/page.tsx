...
const PAGE = "Snow";
const KPIS = [{"l":"Quartos Ocupados","v":"2.911","t":"-0.2%","d":"down"},{"l":"RevPAR (€)","v":"€22452","t":"-0.9%","d":"down"},{"l":"Ocupação (%)","v":"67.9%","t":"-1.5%","d":"down"},{"l":"Guest Satisfaction","v":"6.915","t":"+13.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.884","2026-02-20","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.900","2026-01-28","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.167","2026-01-17","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.150","2026-03-10","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.542","2026-03-08","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":286},{"label":"Mar","value":487},{"label":"Abr","value":536},{"label":"Mai","value":325},{"label":"Jun","value":338},{"label":"Jul","value":506},{"label":"Ago","value":346},{"label":"Set","value":388},{"label":"Out","value":282},{"label":"Nov","value":478},{"label":"Dez","value":458}];
const MX = 536;
