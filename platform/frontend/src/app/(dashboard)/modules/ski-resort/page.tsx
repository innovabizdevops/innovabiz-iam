...
/* ═══ Ski Resort Mgmt — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "9468", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3126", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€335K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1472881868", cells: ["SKI-5868", "Ski Resort Mgmt Item 1", "25/9/2026", "€31 968"], status: "active" as const },
    { id: "1472885439", cells: ["SKI-9439", "Ski Resort Mgmt Item 2", "12/4/2026", "€35 539"], status: "pending" as const },
    { id: "1472889010", cells: ["SKI-4010", "Ski Resort Mgmt Item 3", "27/11/2026", "€39 110"], status: "completed" as const },
    { id: "1472892581", cells: ["SKI-7581", "Ski Resort Mgmt Item 4", "14/6/2026", "€42 681"], status: "warning" as const },
    { id: "1472896152", cells: ["SKI-2152", "Ski Resort Mgmt Item 5", "1/1/2026", "€46 252"], status: "active" as const },
];
...
export default function SkiResortMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ski Resort Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Ski Resort Mgmt</p>
                    </div>
                </div>
