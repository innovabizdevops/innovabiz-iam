...
/* ═══ Death Care Analytics — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "1289", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3186", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€27K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1504167589", cells: ["DEA-7589", "Death Care Analytics Item 1", "2/2/2026", "€17 689"], status: "active" as const },
    { id: "1504171160", cells: ["DEA-2160", "Death Care Analytics Item 2", "17/9/2026", "€21 260"], status: "pending" as const },
    { id: "1504174731", cells: ["DEA-5731", "Death Care Analytics Item 3", "4/4/2026", "€24 831"], status: "completed" as const },
    { id: "1504178302", cells: ["DEA-9302", "Death Care Analytics Item 4", "19/11/2026", "€28 402"], status: "warning" as const },
    { id: "1504181873", cells: ["DEA-3873", "Death Care Analytics Item 5", "6/6/2026", "€31 973"], status: "active" as const },
];
...
export default function DeathCareAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Death Care Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Death Care Analytics</p>
                    </div>
                </div>
