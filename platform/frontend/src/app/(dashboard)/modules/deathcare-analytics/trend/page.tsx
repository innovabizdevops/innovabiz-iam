...
const ACCENT = "#1e293b";
const MODULE = "Death Care Analytics";
const PAGE = "Trend";
const KPIS = [{"l":"Dashboards Ativos","v":"6.060","t":"+15.0%","d":"up"},{"l":"Queries/Dia","v":"2395","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.138","t":"+6.0%","d":"up"},{"l":"Utilizadores Analytics","v":"6.225","t":"+14.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","330","2026-03-19","7.642","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","251","2026-03-16","6.503","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2225","2026-02-04","3.802","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3898","2026-02-01","7.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3302","2026-02-02","4.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":291},{"label":"Mar","value":486},{"label":"Abr","value":401},{"label":"Mai","value":613},{"label":"Jun","value":574},{"label":"Jul","value":561},{"label":"Ago","value":631},{"label":"Set","value":455},{"label":"Out","value":582},{"label":"Nov","value":384},{"label":"Dez","value":555}];
const MX = 631;
