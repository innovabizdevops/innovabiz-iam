...
const PAGE = "Preneed";
const KPIS = [{"l":"Dashboards Ativos","v":"7.078","t":"+6.0%","d":"up"},{"l":"Queries/Dia","v":"2064","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"904","t":"+9.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.442","t":"-1.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","322","2026-01-23","6.983","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1895","2026-03-15","112","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2609","2026-02-19","5.737","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4007","2026-02-18","7.658","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","654","2026-02-11","632","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":558},{"label":"Mar","value":919},{"label":"Abr","value":616},{"label":"Mai","value":590},{"label":"Jun","value":779},{"label":"Jul","value":794},{"label":"Ago","value":774},{"label":"Set","value":724},{"label":"Out","value":911},{"label":"Nov","value":773},{"label":"Dez","value":719}];
const MX = 919;
