...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"506","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"1514","t":"-1.6%","d":"down"},{"l":"Dados Processados (GB)","v":"7.807","t":"-5.2%","d":"down"},{"l":"Utilizadores Analytics","v":"5.994","t":"+0.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","738","2026-03-18","2.885","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5094","2026-03-06","7.322","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4394","2026-02-17","2.316","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1187","2026-01-27","195","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4944","2026-03-12","6.477","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":512},{"label":"Mar","value":239},{"label":"Abr","value":395},{"label":"Mai","value":403},{"label":"Jun","value":249},{"label":"Jul","value":331},{"label":"Ago","value":412},{"label":"Set","value":227},{"label":"Out","value":336},{"label":"Nov","value":527},{"label":"Dez","value":353}];
const MX = 561;
