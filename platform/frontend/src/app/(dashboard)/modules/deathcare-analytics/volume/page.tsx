...
const PAGE = "Volume";
const KPIS = [{"l":"Dashboards Ativos","v":"6.091","t":"+12.8%","d":"up"},{"l":"Queries/Dia","v":"520","t":"+8.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.241","t":"-0.9%","d":"down"},{"l":"Utilizadores Analytics","v":"139","t":"+12.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4589","2026-01-22","7.956","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3855","2026-03-24","2.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4375","2026-01-15","8.157","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2249","2026-01-28","7.700","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3125","2026-02-28","3.357","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":892},{"label":"Mar","value":601},{"label":"Abr","value":988},{"label":"Mai","value":658},{"label":"Jun","value":964},{"label":"Jul","value":815},{"label":"Ago","value":762},{"label":"Set","value":897},{"label":"Out","value":593},{"label":"Nov","value":618},{"label":"Dez","value":685}];
const MX = 988;
