...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€31.8M","t":"+6.4%","d":"up"},{"l":"MRR (€)","v":"€92585","t":"+14.0%","d":"up"},{"l":"Churn (%)","v":"78.7%","t":"-2.9%","d":"down"},{"l":"ARPU (€)","v":"€97672","t":"+9.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 22092.26","3.906","€ 4673.77","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48242.33","6.860","€ 33869.43","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 35750.96","8.945","€ 28847.13","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7039.62","2.504","€ 25965.66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 3757.05","695","€ 41876.76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1046},{"label":"Fev","value":917},{"label":"Mar","value":677},{"label":"Abr","value":717},{"label":"Mai","value":826},{"label":"Jun","value":872},{"label":"Jul","value":717},{"label":"Ago","value":964},{"label":"Set","value":673},{"label":"Out","value":869},{"label":"Nov","value":857},{"label":"Dez","value":890}];
const MX = 1046;
