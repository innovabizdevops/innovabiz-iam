...
/* ═══ Materials Management Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "5447", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3943", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€67K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2068620247", cells: ["MAT-7247", "Materials Management Deep Item 1", "16/8/2026", "€20 347"], status: "active" as const },
    { id: "2068623818", cells: ["MAT-1818", "Materials Management Deep Item 2", "3/3/2026", "€23 918"], status: "pending" as const },
    { id: "2068627389", cells: ["MAT-5389", "Materials Management Deep Item 3", "18/10/2026", "€27 489"], status: "completed" as const },
    { id: "2068630960", cells: ["MAT-8960", "Materials Management Deep Item 4", "5/5/2026", "€31 060"], status: "warning" as const },
    { id: "2068634531", cells: ["MAT-3531", "Materials Management Deep Item 5", "20/12/2026", "€34 631"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 27 }, { label: "Fev", value: 36 }, { label: "Mar", value: 45 }, { label: "Abr", value: 54 }, { label: "Mai", value: 63 }, { label: "Jun", value: 72 }];
...
export default function MaterialsManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Materials Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Materials Management Deep</p>
                    </div>
                </div>
