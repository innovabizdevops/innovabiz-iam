...
const PAGE = "Procure";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.581","t":"+7.4%","d":"up"},{"l":"Contratos (€M)","v":"€24.0M","t":"-4.9%","d":"down"},{"l":"On-Time Delivery (%)","v":"85.5%","t":"+7.9%","d":"up"},{"l":"Score Médio","v":"94","t":"-2.6%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","94.3%","€ 32831.58","1.824","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","93.6%","€ 50070.34","4.607","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","83.3%","€ 37757.17","3.937","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","91.8%","€ 35850.98","8.534","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","89.3%","€ 44553.73","1.036","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":456},{"label":"Mar","value":796},{"label":"Abr","value":681},{"label":"Mai","value":603},{"label":"Jun","value":657},{"label":"Jul","value":605},{"label":"Ago","value":514},{"label":"Set","value":719},{"label":"Out","value":614},{"label":"Nov","value":784},{"label":"Dez","value":638}];
const MX = 796;
