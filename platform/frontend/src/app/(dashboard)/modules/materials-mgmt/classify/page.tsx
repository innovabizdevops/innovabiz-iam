...
const PAGE = "Classify";
const KPIS = [{"l":"Total Materials Mgmt","v":"7.564","t":"+1.4%","d":"up"},{"l":"Classify Ativos","v":"2.410","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"55","t":"-3.4%","d":"down"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Materials Mgmt #001","Materials Mgmt #002","7.285","7.903","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Materials Mgmt #002","Materials Mgmt #003","7.730","2.831","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Materials Mgmt #003","Materials Mgmt #004","809","8.736","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Materials Mgmt #004","Materials Mgmt #005","6.124","1.096","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Materials Mgmt #005","Materials Mgmt #001","5.805","340","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":668},{"label":"Mar","value":919},{"label":"Abr","value":943},{"label":"Mai","value":753},{"label":"Jun","value":905},{"label":"Jul","value":833},{"label":"Ago","value":642},{"label":"Set","value":897},{"label":"Out","value":646},{"label":"Nov","value":712},{"label":"Dez","value":657}];
const MX = 943;
