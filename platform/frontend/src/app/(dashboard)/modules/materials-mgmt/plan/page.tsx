...
const ACCENT = "#78350f";
const MODULE = "Materials Management Deep";
const PAGE = "Plan";
const KPIS = [{"l":"Total Materials Mgmt","v":"1.703","t":"+6.0%","d":"up"},{"l":"Plan Ativos","v":"7.231","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"88","t":"+8.0%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Materials Mgmt #001","Materials Mgmt #002","3.166","5.980","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Materials Mgmt #002","Materials Mgmt #003","1.548","5.940","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Materials Mgmt #003","Materials Mgmt #004","8.871","8.251","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Materials Mgmt #004","Materials Mgmt #005","5.511","7.274","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Materials Mgmt #005","Materials Mgmt #001","5.968","6.697","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":628},{"label":"Mar","value":463},{"label":"Abr","value":659},{"label":"Mai","value":529},{"label":"Jun","value":353},{"label":"Jul","value":478},{"label":"Ago","value":613},{"label":"Set","value":552},{"label":"Out","value":452},{"label":"Nov","value":632},{"label":"Dez","value":599}];
const MX = 673;
