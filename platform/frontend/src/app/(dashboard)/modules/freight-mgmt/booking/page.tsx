...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"3.219","t":"+1.1%","d":"up"},{"l":"RevPAR (€)","v":"€69301","t":"+5.8%","d":"up"},{"l":"Ocupação (%)","v":"72.7%","t":"-0.1%","d":"down"},{"l":"Guest Satisfaction","v":"1.156","t":"-1.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.937","2026-02-01","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.335","2026-02-03","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.824","2026-03-07","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.377","2026-03-04","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.481","2026-02-22","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":490},{"label":"Mar","value":401},{"label":"Abr","value":556},{"label":"Mai","value":419},{"label":"Jun","value":634},{"label":"Jul","value":302},{"label":"Ago","value":392},{"label":"Set","value":512},{"label":"Out","value":344},{"label":"Nov","value":522},{"label":"Dez","value":329}];
const MX = 634;
