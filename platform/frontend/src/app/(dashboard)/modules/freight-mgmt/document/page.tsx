...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"7.876","t":"-0.4%","d":"down"},{"l":"Submissões/Dia","v":"1949","t":"+14.4%","d":"up"},{"l":"Documentos Gerados","v":"3.694","t":"-5.3%","d":"down"},{"l":"Templates","v":"1.218","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.470","2026-02-22","3.141","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.796","2026-03-12","1.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.253","2026-03-21","8.836","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.103","2026-02-18","3.872","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.872","2026-01-19","8.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":959},{"label":"Mar","value":688},{"label":"Abr","value":917},{"label":"Mai","value":960},{"label":"Jun","value":841},{"label":"Jul","value":803},{"label":"Ago","value":823},{"label":"Set","value":761},{"label":"Out","value":649},{"label":"Nov","value":642},{"label":"Dez","value":655}];
const MX = 960;
