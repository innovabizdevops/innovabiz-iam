...
const ACCENT = "#6366f1";
const MODULE = "Freight Management";
const PAGE = "Track";
const KPIS = [{"l":"Total Freight Mgmt","v":"6.899","t":"-2.0%","d":"down"},{"l":"Track Ativos","v":"9.095","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"71","t":"-1.9%","d":"down"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Mgmt #001","Freight Mgmt #002","1.050","5.991","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Mgmt #002","Freight Mgmt #003","7.179","8.507","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Mgmt #003","Freight Mgmt #004","7.100","1.448","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Mgmt #004","Freight Mgmt #005","855","6.016","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Mgmt #005","Freight Mgmt #001","3.873","2.179","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":327},{"label":"Mar","value":344},{"label":"Abr","value":577},{"label":"Mai","value":336},{"label":"Jun","value":602},{"label":"Jul","value":569},{"label":"Ago","value":397},{"label":"Set","value":323},{"label":"Out","value":427},{"label":"Nov","value":424},{"label":"Dez","value":553}];
const MX = 602;
