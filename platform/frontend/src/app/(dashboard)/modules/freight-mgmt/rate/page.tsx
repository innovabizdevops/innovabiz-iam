...
const PAGE = "Rate";
const KPIS = [{"l":"Total Freight Mgmt","v":"7.531","t":"-0.5%","d":"down"},{"l":"Rate Ativos","v":"3.900","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"83.9%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"91","t":"+6.0%","d":"up"}];
const COLS = ["ID","Rate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Mgmt #001","Freight Mgmt #002","1.432","1.685","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Mgmt #002","Freight Mgmt #003","7.299","6.536","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Mgmt #003","Freight Mgmt #004","1.695","5.029","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Mgmt #004","Freight Mgmt #005","3.469","4.163","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Mgmt #005","Freight Mgmt #001","6.180","3.452","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":702},{"label":"Mar","value":599},{"label":"Abr","value":647},{"label":"Mai","value":828},{"label":"Jun","value":929},{"label":"Jul","value":697},{"label":"Ago","value":759},{"label":"Set","value":869},{"label":"Out","value":551},{"label":"Nov","value":677},{"label":"Dez","value":754}];
const MX = 929;
