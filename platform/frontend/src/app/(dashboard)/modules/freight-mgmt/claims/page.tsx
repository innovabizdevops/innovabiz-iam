...
const PAGE = "Claims";
const KPIS = [{"l":"Total Freight Mgmt","v":"7.225","t":"+6.3%","d":"up"},{"l":"Claims Ativos","v":"7.040","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+3.0%","d":"up"}];
const COLS = ["ID","Claims","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Freight Mgmt #001","Freight Mgmt #002","3.840","1.218","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Freight Mgmt #002","Freight Mgmt #003","8.859","5.388","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Freight Mgmt #003","Freight Mgmt #004","2.160","1.664","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Freight Mgmt #004","Freight Mgmt #005","8.938","5.862","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Freight Mgmt #005","Freight Mgmt #001","1.644","6.526","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":566},{"label":"Mar","value":348},{"label":"Abr","value":561},{"label":"Mai","value":319},{"label":"Jun","value":345},{"label":"Jul","value":302},{"label":"Ago","value":543},{"label":"Set","value":405},{"label":"Out","value":533},{"label":"Nov","value":294},{"label":"Dez","value":463}];
const MX = 566;
