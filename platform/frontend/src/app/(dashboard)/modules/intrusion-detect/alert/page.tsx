...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"1.956","t":"-1.6%","d":"down"},{"l":"Taxa Entrega (%)","v":"77.2%","t":"+7.6%","d":"up"},{"l":"Taxa Abertura (%)","v":"87.4%","t":"-1.0%","d":"down"},{"l":"Escalações","v":"3.332","t":"+13.5%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.319","70.2%","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.930","88.0%","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.206","71.6%","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.347","79.6%","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.131","97.9%","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":654},{"label":"Mar","value":677},{"label":"Abr","value":458},{"label":"Mai","value":567},{"label":"Jun","value":546},{"label":"Jul","value":589},{"label":"Ago","value":707},{"label":"Set","value":736},{"label":"Out","value":502},{"label":"Nov","value":704},{"label":"Dez","value":629}];
const MX = 819;
