...
const ACCENT = "#6366f1";
const MODULE = "Intrusion Detection";
const PAGE = "Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"2.429","t":"+10.3%","d":"up"},{"l":"Dados/Min (MB)","v":"2.748","t":"-3.2%","d":"down"},{"l":"Alertas Ativos","v":"2.421","t":"+16.2%","d":"up"},{"l":"Uptime (%)","v":"75.9%","t":"-0.7%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.121","3.758","5.009","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.873","7.530","7.716","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.397","7.581","3.995","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.166","1.004","1.174","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.243","1.265","6.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":728},{"label":"Mar","value":577},{"label":"Abr","value":532},{"label":"Mai","value":732},{"label":"Jun","value":696},{"label":"Jul","value":625},{"label":"Ago","value":448},{"label":"Set","value":395},{"label":"Out","value":659},{"label":"Nov","value":486},{"label":"Dez","value":463}];
const MX = 732;
