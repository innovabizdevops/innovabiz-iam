...
const KPIS = [{"l":"Integrações Ativas","v":"2.188","t":"+12.6%","d":"up"},{"l":"Chamadas/Hora","v":"3146","t":"+3.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.5%","t":"-3.5%","d":"down"},{"l":"Latência Média (ms)","v":"73ms","t":"+10.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.633","4.215","70.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.901","4.404","80.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.305","7.626","78.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.151","4.139","93.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.960","6.289","77.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":580},{"label":"Mar","value":653},{"label":"Abr","value":592},{"label":"Mai","value":644},{"label":"Jun","value":705},{"label":"Jul","value":758},{"label":"Ago","value":544},{"label":"Set","value":719},{"label":"Out","value":528},{"label":"Nov","value":817},{"label":"Dez","value":756}];
const MX = 817;
