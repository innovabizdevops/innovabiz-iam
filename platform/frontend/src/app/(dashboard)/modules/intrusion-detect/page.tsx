...
export default function IntrusionDetectPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Intrusion Detect</h1><p className="text-sm text-muted-foreground">Intrusion Detect • iBOS Enterprise</p></div>
