...
const ACCENT = "#be185d";
const MODULE = "Jewelry Management Platform";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.243","t":"+4.9%","d":"up"},{"l":"Submissões/Dia","v":"5090","t":"-4.1%","d":"down"},{"l":"Documentos Gerados","v":"8.624","t":"+3.8%","d":"up"},{"l":"Templates","v":"5.176","t":"+5.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.407","2026-03-15","8.493","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.561","2026-03-24","6.799","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.781","2026-03-18","641","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.287","2026-02-14","3.785","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.750","2026-01-19","5.565","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":477},{"label":"Mar","value":642},{"label":"Abr","value":509},{"label":"Mai","value":675},{"label":"Jun","value":451},{"label":"Jul","value":683},{"label":"Ago","value":630},{"label":"Set","value":353},{"label":"Out","value":413},{"label":"Nov","value":638},{"label":"Dez","value":411}];
const MX = 683;
