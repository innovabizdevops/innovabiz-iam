...
const PAGE = "Sell";
const KPIS = [{"l":"Total Jewelry Mgmt","v":"1.513","t":"+16.1%","d":"up"},{"l":"Sell Ativos","v":"1.147","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"77.6%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+10.2%","d":"up"}];
const COLS = ["ID","Sell","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jewelry Mgmt #001","Jewelry Mgmt #002","4.293","6.964","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Jewelry Mgmt #002","Jewelry Mgmt #003","8.288","7.618","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Jewelry Mgmt #003","Jewelry Mgmt #004","4.078","350","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Jewelry Mgmt #004","Jewelry Mgmt #005","7.345","4.862","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jewelry Mgmt #005","Jewelry Mgmt #001","5.352","2.989","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":365},{"label":"Mar","value":540},{"label":"Abr","value":509},{"label":"Mai","value":485},{"label":"Jun","value":611},{"label":"Jul","value":459},{"label":"Ago","value":529},{"label":"Set","value":361},{"label":"Out","value":437},{"label":"Nov","value":530},{"label":"Dez","value":503}];
const MX = 611;
