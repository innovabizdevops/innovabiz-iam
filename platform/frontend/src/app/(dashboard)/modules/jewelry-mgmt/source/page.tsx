...
const PAGE = "Source";
const KPIS = [{"l":"Total Jewelry Mgmt","v":"6.242","t":"+1.3%","d":"up"},{"l":"Source Ativos","v":"7.148","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"63","t":"-5.0%","d":"down"}];
const COLS = ["ID","Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jewelry Mgmt #001","Jewelry Mgmt #002","8.524","2.144","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Jewelry Mgmt #002","Jewelry Mgmt #003","123","535","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Jewelry Mgmt #003","Jewelry Mgmt #004","1.675","2.810","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Jewelry Mgmt #004","Jewelry Mgmt #005","5.430","3.249","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jewelry Mgmt #005","Jewelry Mgmt #001","7.738","6.612","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":566},{"label":"Mar","value":568},{"label":"Abr","value":738},{"label":"Mai","value":845},{"label":"Jun","value":723},{"label":"Jul","value":670},{"label":"Ago","value":860},{"label":"Set","value":710},{"label":"Out","value":800},{"label":"Nov","value":793},{"label":"Dez","value":831}];
const MX = 860;
