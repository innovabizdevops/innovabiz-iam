...
const PAGE = "Produce";
const KPIS = [{"l":"Total Jewelry Mgmt","v":"7.500","t":"+9.7%","d":"up"},{"l":"Produce Ativos","v":"6.618","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"93","t":"+5.7%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jewelry Mgmt #001","Jewelry Mgmt #002","489","500","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Jewelry Mgmt #002","Jewelry Mgmt #003","8.804","1.422","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Jewelry Mgmt #003","Jewelry Mgmt #004","898","1.627","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Jewelry Mgmt #004","Jewelry Mgmt #005","4.710","4.530","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jewelry Mgmt #005","Jewelry Mgmt #001","7.006","7.633","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":514},{"label":"Mar","value":750},{"label":"Abr","value":711},{"label":"Mai","value":501},{"label":"Jun","value":514},{"label":"Jul","value":789},{"label":"Ago","value":482},{"label":"Set","value":679},{"label":"Out","value":773},{"label":"Nov","value":695},{"label":"Dez","value":678}];
const MX = 789;
