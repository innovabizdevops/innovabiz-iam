...
/* ═══ Jewelry Management Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "3533", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "328", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€458K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "919604533", cells: ["JEW-3533", "Jewelry Management Platform Item 1", "2/2/2026", "€4633"], status: "active" as const },
    { id: "919608104", cells: ["JEW-7104", "Jewelry Management Platform Item 2", "17/9/2026", "€8204"], status: "pending" as const },
    { id: "919611675", cells: ["JEW-1675", "Jewelry Management Platform Item 3", "4/4/2026", "€11 775"], status: "completed" as const },
    { id: "919615246", cells: ["JEW-5246", "Jewelry Management Platform Item 4", "19/11/2026", "€15 346"], status: "warning" as const },
    { id: "919618817", cells: ["JEW-8817", "Jewelry Management Platform Item 5", "6/6/2026", "€18 917"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 73 }, { label: "Fev", value: 82 }, { label: "Mar", value: 91 }, { label: "Abr", value: 20 }, { label: "Mai", value: 29 }, { label: "Jun", value: 38 }];
...
export default function JewelryManagementPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Jewelry Management Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Jewelry Management Platform</p>
                    </div>
                </div>
