...
const PAGE = "Certify";
const KPIS = [{"l":"Total Jewelry Mgmt","v":"5.868","t":"+14.5%","d":"up"},{"l":"Certify Ativos","v":"8.918","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"69.5%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+6.0%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jewelry Mgmt #001","Jewelry Mgmt #002","3.397","2.081","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Jewelry Mgmt #002","Jewelry Mgmt #003","5.837","5.801","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Jewelry Mgmt #003","Jewelry Mgmt #004","6.448","3.671","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Jewelry Mgmt #004","Jewelry Mgmt #005","2.765","5.465","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jewelry Mgmt #005","Jewelry Mgmt #001","6.316","3.329","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":507},{"label":"Mar","value":553},{"label":"Abr","value":620},{"label":"Mai","value":607},{"label":"Jun","value":543},{"label":"Jul","value":609},{"label":"Ago","value":649},{"label":"Set","value":757},{"label":"Out","value":664},{"label":"Nov","value":854},{"label":"Dez","value":727}];
const MX = 854;
