...
const PAGE = "Blood Bank";
const KPIS = [{"l":"Integrações Ativas","v":"6.582","t":"+4.3%","d":"up"},{"l":"Chamadas/Hora","v":"4260","t":"+9.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.2%","t":"-2.7%","d":"down"},{"l":"Latência Média (ms)","v":"179ms","t":"+1.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.753","3.489","84.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.588","6.545","75.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.638","7.225","99.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.329","9.038","85.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.186","3.566","90.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":440},{"label":"Mar","value":364},{"label":"Abr","value":425},{"label":"Mai","value":488},{"label":"Jun","value":392},{"label":"Jul","value":521},{"label":"Ago","value":672},{"label":"Set","value":526},{"label":"Out","value":424},{"label":"Nov","value":679},{"label":"Dez","value":424}];
const MX = 679;
