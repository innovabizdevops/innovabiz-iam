...
const PAGE = "PTSD";
const KPIS = [{"l":"Integrações Ativas","v":"1.441","t":"-3.9%","d":"down"},{"l":"Chamadas/Hora","v":"3562","t":"+2.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.2%","t":"+7.8%","d":"up"},{"l":"Latência Média (ms)","v":"71ms","t":"+14.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","503","2.564","97.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.500","2.709","72.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.006","4.942","97.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.986","2.130","70.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.448","5.733","75.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":1030},{"label":"Mar","value":984},{"label":"Abr","value":987},{"label":"Mai","value":858},{"label":"Jun","value":996},{"label":"Jul","value":702},{"label":"Ago","value":771},{"label":"Set","value":981},{"label":"Out","value":1046},{"label":"Nov","value":836},{"label":"Dez","value":923}];
const MX = 1046;
