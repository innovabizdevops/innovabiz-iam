...
const PAGE = "Field Med";
const KPIS = [{"l":"Integrações Ativas","v":"8.490","t":"-3.3%","d":"down"},{"l":"Chamadas/Hora","v":"2598","t":"+3.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.8%","t":"+6.4%","d":"up"},{"l":"Latência Média (ms)","v":"24ms","t":"+2.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.253","4.473","73.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.762","2.481","90.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.230","7.802","76.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.142","6.629","98.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.740","1.795","83.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":605},{"label":"Mar","value":288},{"label":"Abr","value":469},{"label":"Mai","value":284},{"label":"Jun","value":311},{"label":"Jul","value":349},{"label":"Ago","value":555},{"label":"Set","value":319},{"label":"Out","value":503},{"label":"Nov","value":474},{"label":"Dez","value":594}];
const MX = 605;
