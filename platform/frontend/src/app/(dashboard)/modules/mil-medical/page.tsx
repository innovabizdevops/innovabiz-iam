...
export default function MilMedicalPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mil Medical</h1><p className="text-sm text-muted-foreground">Mil Medical • iBOS Enterprise</p></div>
