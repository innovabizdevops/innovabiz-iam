...
const ACCENT = "#6366f1";
const MODULE = "Military Medical";
const PAGE = "CASEVAC";
const KPIS = [{"l":"Integrações Ativas","v":"1.897","t":"+1.6%","d":"up"},{"l":"Chamadas/Hora","v":"1742","t":"+1.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.5%","t":"+11.1%","d":"up"},{"l":"Latência Média (ms)","v":"87ms","t":"+1.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.845","1.807","76.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","159","2.258","70.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.294","7.499","92.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.424","3.989","88.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.560","5.346","87.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":423},{"label":"Mar","value":326},{"label":"Abr","value":422},{"label":"Mai","value":212},{"label":"Jun","value":334},{"label":"Jul","value":551},{"label":"Ago","value":530},{"label":"Set","value":488},{"label":"Out","value":395},{"label":"Nov","value":517},{"label":"Dez","value":579}];
const MX = 579;
...
export default function CasevacPage() {
    return (
