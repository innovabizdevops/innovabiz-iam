...
const KPIS = [{"l":"Integrações Ativas","v":"8.010","t":"+5.4%","d":"up"},{"l":"Chamadas/Hora","v":"1028","t":"+12.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.4%","t":"+2.5%","d":"up"},{"l":"Latência Média (ms)","v":"123ms","t":"+15.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.072","211","93.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.325","2.110","78.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.435","1.766","85.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.031","1.290","71.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.123","8.724","83.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":647},{"label":"Mar","value":891},{"label":"Abr","value":752},{"label":"Mai","value":755},{"label":"Jun","value":607},{"label":"Jul","value":578},{"label":"Ago","value":710},{"label":"Set","value":552},{"label":"Out","value":661},{"label":"Nov","value":857},{"label":"Dez","value":546}];
const MX = 891;
