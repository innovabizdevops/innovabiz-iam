...
const PAGE = "Kimberlite";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.673","t":"-5.2%","d":"down"},{"l":"Sessões/Dia","v":"1334","t":"+0.3%","d":"up"},{"l":"MFA Adoção (%)","v":"81.3%","t":"+0.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.185","t":"+7.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.831","3.576","5.814","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.434","8.334","5.152","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.715","7.878","8.938","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.209","7.449","5.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.667","6.811","3.188","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":473},{"label":"Mar","value":376},{"label":"Abr","value":509},{"label":"Mai","value":733},{"label":"Jun","value":740},{"label":"Jul","value":554},{"label":"Ago","value":465},{"label":"Set","value":709},{"label":"Out","value":733},{"label":"Nov","value":635},{"label":"Dez","value":651}];
const MX = 740;
...
export default function KimberlitePage() {
    return (
