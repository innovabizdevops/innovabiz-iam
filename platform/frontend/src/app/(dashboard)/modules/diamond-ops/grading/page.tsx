...
const PAGE = "Grading";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.528","t":"+-0.0%","d":"up"},{"l":"Sessões/Dia","v":"3451","t":"+16.8%","d":"up"},{"l":"MFA Adoção (%)","v":"86.9%","t":"+3.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.952","t":"-5.7%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","9.089","4.319","4.757","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.312","4.056","7.046","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.679","2.579","889","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.147","5.504","1.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.247","7.084","2.243","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":991},{"label":"Mar","value":696},{"label":"Abr","value":759},{"label":"Mai","value":728},{"label":"Jun","value":609},{"label":"Jul","value":646},{"label":"Ago","value":881},{"label":"Set","value":998},{"label":"Out","value":776},{"label":"Nov","value":836},{"label":"Dez","value":808}];
const MX = 998;
