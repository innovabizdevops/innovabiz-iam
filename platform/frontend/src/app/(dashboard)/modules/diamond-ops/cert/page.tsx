...
const KPIS = [{"l":"Utilizadores Ativos","v":"137","t":"+6.1%","d":"up"},{"l":"Sessões/Dia","v":"1592","t":"+7.3%","d":"up"},{"l":"MFA Adoção (%)","v":"65.5%","t":"+8.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.099","t":"-0.5%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.031","1.053","7.266","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.007","1.694","1.525","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.186","9.034","821","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.361","4.878","4.809","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.389","3.366","1.706","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1055},{"label":"Fev","value":915},{"label":"Mar","value":884},{"label":"Abr","value":784},{"label":"Mai","value":898},{"label":"Jun","value":857},{"label":"Jul","value":967},{"label":"Ago","value":721},{"label":"Set","value":789},{"label":"Out","value":768},{"label":"Nov","value":850},{"label":"Dez","value":833}];
const MX = 1055;
