...
const PAGE = "Alluvial";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.930","t":"+14.5%","d":"up"},{"l":"Sessões/Dia","v":"1625","t":"+17.3%","d":"up"},{"l":"MFA Adoção (%)","v":"71.6%","t":"+17.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.198","t":"+5.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.297","2.718","2.093","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.247","6.774","6.029","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.462","3.146","3.734","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.164","2.376","3.838","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.014","4.169","2.901","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":772},{"label":"Mar","value":516},{"label":"Abr","value":407},{"label":"Mai","value":518},{"label":"Jun","value":767},{"label":"Jul","value":584},{"label":"Ago","value":668},{"label":"Set","value":491},{"label":"Out","value":758},{"label":"Nov","value":673},{"label":"Dez","value":716}];
const MX = 772;
