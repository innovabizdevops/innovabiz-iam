...
const ACCENT = "#6366f1";
const MODULE = "Diamond Operations";
const PAGE = "Sorting";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.479","t":"+2.2%","d":"up"},{"l":"Sessões/Dia","v":"3523","t":"+12.8%","d":"up"},{"l":"MFA Adoção (%)","v":"68.0%","t":"-1.2%","d":"down"},{"l":"Tentativas Bloqueadas","v":"1.563","t":"+1.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.356","1.363","157","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.564","7.570","804","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.506","2.313","8.123","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.318","7.255","2.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.715","4.583","7.611","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":469},{"label":"Mar","value":482},{"label":"Abr","value":562},{"label":"Mai","value":485},{"label":"Jun","value":692},{"label":"Jul","value":619},{"label":"Ago","value":679},{"label":"Set","value":691},{"label":"Out","value":792},{"label":"Nov","value":454},{"label":"Dez","value":519}];
const MX = 792;
