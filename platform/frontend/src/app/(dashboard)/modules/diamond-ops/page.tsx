...
export default function DiamondOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Diamond Ops</h1><p className="text-sm text-muted-foreground">Diamond Ops • iBOS Enterprise</p></div>
