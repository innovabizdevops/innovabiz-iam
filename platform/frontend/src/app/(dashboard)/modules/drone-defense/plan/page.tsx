...
const PAGE = "Plan";
const KPIS = [{"l":"Total Drone Defense","v":"720","t":"-3.7%","d":"down"},{"l":"Plan Ativos","v":"2.873","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"82.2%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"70","t":"-4.9%","d":"down"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Defense #001","Drone Defense #002","6.977","337","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Defense #002","Drone Defense #003","1.904","3.575","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Defense #003","Drone Defense #004","6.493","941","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Defense #004","Drone Defense #005","655","7.755","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Defense #005","Drone Defense #001","8.775","6.546","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":812},{"label":"Mar","value":988},{"label":"Abr","value":803},{"label":"Mai","value":709},{"label":"Jun","value":872},{"label":"Jul","value":906},{"label":"Ago","value":804},{"label":"Set","value":942},{"label":"Out","value":807},{"label":"Nov","value":967},{"label":"Dez","value":694}];
const MX = 988;
