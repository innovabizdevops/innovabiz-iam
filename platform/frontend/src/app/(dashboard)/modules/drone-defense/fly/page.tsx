...
const PAGE = "Fly";
const KPIS = [{"l":"Total Drone Defense","v":"4.240","t":"+17.1%","d":"up"},{"l":"Fly Ativos","v":"3.256","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"82","t":"+1.6%","d":"up"}];
const COLS = ["ID","Fly","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Defense #001","Drone Defense #002","2.435","3.526","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Defense #002","Drone Defense #003","3.534","2.962","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Defense #003","Drone Defense #004","5.825","1.728","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Defense #004","Drone Defense #005","4.079","7.223","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Defense #005","Drone Defense #001","1.826","5.937","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":488},{"label":"Mar","value":613},{"label":"Abr","value":361},{"label":"Mai","value":317},{"label":"Jun","value":371},{"label":"Jul","value":564},{"label":"Ago","value":382},{"label":"Set","value":587},{"label":"Out","value":356},{"label":"Nov","value":252},{"label":"Dez","value":423}];
const MX = 613;
