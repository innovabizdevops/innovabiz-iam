...
const PAGE = "Counter";
const KPIS = [{"l":"Total Drone Defense","v":"3.288","t":"+3.2%","d":"up"},{"l":"Counter Ativos","v":"7.789","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.3%","d":"up"}];
const COLS = ["ID","Counter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Defense #001","Drone Defense #002","2.780","2.094","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Defense #002","Drone Defense #003","4.409","5.889","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Defense #003","Drone Defense #004","706","1.180","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Defense #004","Drone Defense #005","4.055","2.036","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Defense #005","Drone Defense #001","1.395","3.423","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":971},{"label":"Mar","value":882},{"label":"Abr","value":803},{"label":"Mai","value":974},{"label":"Jun","value":822},{"label":"Jul","value":799},{"label":"Ago","value":1042},{"label":"Set","value":874},{"label":"Out","value":708},{"label":"Nov","value":744},{"label":"Dez","value":922}];
const MX = 1042;
