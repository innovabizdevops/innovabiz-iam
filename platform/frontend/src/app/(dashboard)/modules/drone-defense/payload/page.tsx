...
const PAGE = "Payload";
const KPIS = [{"l":"Total Drone Defense","v":"7.297","t":"+10.7%","d":"up"},{"l":"Payload Ativos","v":"2.163","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"60","t":"-5.2%","d":"down"}];
const COLS = ["ID","Payload","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Defense #001","Drone Defense #002","6.274","4.898","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Defense #002","Drone Defense #003","989","3.935","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Defense #003","Drone Defense #004","5.781","5.124","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Defense #004","Drone Defense #005","3.735","3.468","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Defense #005","Drone Defense #001","155","1.905","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":488},{"label":"Mar","value":547},{"label":"Abr","value":705},{"label":"Mai","value":573},{"label":"Jun","value":655},{"label":"Jul","value":410},{"label":"Ago","value":385},{"label":"Set","value":539},{"label":"Out","value":586},{"label":"Nov","value":766},{"label":"Dez","value":625}];
const MX = 766;
