...
/* ═══ Drone & UAV Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4842", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2782", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€488K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "692747342", cells: ["DRO-9342", "Drone & UAV Platform Item 1", "15/3/2026", "€47 442"], status: "active" as const },
    { id: "692750913", cells: ["DRO-3913", "Drone & UAV Platform Item 2", "2/10/2026", "€1013"], status: "pending" as const },
    { id: "692754484", cells: ["DRO-7484", "Drone & UAV Platform Item 3", "17/5/2026", "€4584"], status: "completed" as const },
    { id: "692758055", cells: ["DRO-2055", "Drone & UAV Platform Item 4", "4/12/2026", "€8155"], status: "warning" as const },
    { id: "692761626", cells: ["DRO-5626", "Drone & UAV Platform Item 5", "19/7/2026", "€11 726"], status: "active" as const },
];
...
export default function DroneUavPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drone & UAV Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Drone & UAV Platform</p>
                    </div>
                </div>
