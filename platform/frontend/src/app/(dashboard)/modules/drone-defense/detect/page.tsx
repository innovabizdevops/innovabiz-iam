...
const ACCENT = "#1e3a5f";
const MODULE = "Drone & UAV Platform";
const PAGE = "Detect";
const KPIS = [{"l":"Total Drone Defense","v":"868","t":"+14.0%","d":"up"},{"l":"Detect Ativos","v":"6.358","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+3.6%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Defense #001","Drone Defense #002","2.854","7.464","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Defense #002","Drone Defense #003","6.829","8.795","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Defense #003","Drone Defense #004","178","2.573","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Defense #004","Drone Defense #005","1.699","5.553","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Defense #005","Drone Defense #001","8.104","7.231","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":289},{"label":"Fev","value":535},{"label":"Mar","value":444},{"label":"Abr","value":348},{"label":"Mai","value":313},{"label":"Jun","value":562},{"label":"Jul","value":317},{"label":"Ago","value":410},{"label":"Set","value":274},{"label":"Out","value":562},{"label":"Nov","value":536},{"label":"Dez","value":562}];
const MX = 562;
