...
const PAGE = "Plan Review";
const KPIS = [{"l":"Riscos Identificados","v":"1.958","t":"+2.2%","d":"up"},{"l":"Mitigações Ativas","v":"944","t":"+3.4%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"-5.7%","d":"down"},{"l":"Incidentes YTD","v":"1.576","t":"+14.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","435","5.843","203","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.120","1.563","4.930","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.595","7.127","2.688","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.305","4.274","3.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.867","2.795","5.569","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":783},{"label":"Mar","value":642},{"label":"Abr","value":593},{"label":"Mai","value":745},{"label":"Jun","value":847},{"label":"Jul","value":643},{"label":"Ago","value":627},{"label":"Set","value":860},{"label":"Out","value":687},{"label":"Nov","value":549},{"label":"Dez","value":839}];
const MX = 860;
