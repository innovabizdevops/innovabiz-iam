...
const PAGE = "Business Lic";
const KPIS = [{"l":"Riscos Identificados","v":"2.011","t":"+16.3%","d":"up"},{"l":"Mitigações Ativas","v":"2.759","t":"+1.1%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+15.4%","d":"up"},{"l":"Incidentes YTD","v":"692","t":"+3.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.897","6.731","8.811","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.322","4.532","7.624","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.206","8.973","2.657","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.552","3.702","8.551","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.686","234","6.621","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":944},{"label":"Mar","value":966},{"label":"Abr","value":672},{"label":"Mai","value":766},{"label":"Jun","value":863},{"label":"Jul","value":653},{"label":"Ago","value":908},{"label":"Set","value":689},{"label":"Out","value":840},{"label":"Nov","value":951},{"label":"Dez","value":791}];
const MX = 966;
