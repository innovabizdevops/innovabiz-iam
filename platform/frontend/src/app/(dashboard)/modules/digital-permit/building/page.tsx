...
const ACCENT = "#b45309";
const MODULE = "Digital Permitting";
const PAGE = "Building Permit";
const KPIS = [{"l":"Riscos Identificados","v":"8.546","t":"+6.0%","d":"up"},{"l":"Mitigações Ativas","v":"3.407","t":"-5.3%","d":"down"},{"l":"Score Risco Geral","v":"84","t":"+0.2%","d":"up"},{"l":"Incidentes YTD","v":"6.702","t":"+1.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.411","1.219","1.809","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.802","5.658","4.611","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.073","9.027","4.067","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","332","7.095","4.966","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.450","969","4.921","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":645},{"label":"Mar","value":582},{"label":"Abr","value":906},{"label":"Mai","value":606},{"label":"Jun","value":588},{"label":"Jul","value":831},{"label":"Ago","value":953},{"label":"Set","value":923},{"label":"Out","value":963},{"label":"Nov","value":686},{"label":"Dez","value":734}];
const MX = 963;
