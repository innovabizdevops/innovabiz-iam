...
const KPIS = [{"l":"Riscos Identificados","v":"1.694","t":"-0.1%","d":"down"},{"l":"Mitigações Ativas","v":"4.964","t":"+10.3%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+8.1%","d":"up"},{"l":"Incidentes YTD","v":"7.846","t":"+15.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.403","3.228","2.530","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.051","6.588","9.071","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.081","2.239","600","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.671","8.052","1.039","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.770","536","1.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":269},{"label":"Mar","value":545},{"label":"Abr","value":326},{"label":"Mai","value":623},{"label":"Jun","value":420},{"label":"Jul","value":510},{"label":"Ago","value":524},{"label":"Set","value":286},{"label":"Out","value":518},{"label":"Nov","value":571},{"label":"Dez","value":447}];
const MX = 623;
