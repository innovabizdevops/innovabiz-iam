...
const KPIS = [{"l":"Riscos Identificados","v":"4.092","t":"-5.5%","d":"down"},{"l":"Mitigações Ativas","v":"3.783","t":"+7.1%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"-5.0%","d":"down"},{"l":"Incidentes YTD","v":"1.524","t":"+13.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.652","7.528","7.993","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.162","7.580","2.761","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","970","231","199","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.619","4.422","8.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","981","5.017","2.758","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":680},{"label":"Mar","value":659},{"label":"Abr","value":664},{"label":"Mai","value":702},{"label":"Jun","value":975},{"label":"Jul","value":844},{"label":"Ago","value":692},{"label":"Set","value":817},{"label":"Out","value":968},{"label":"Nov","value":811},{"label":"Dez","value":734}];
const MX = 975;
