...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"3.609","t":"-6.0%","d":"down"},{"l":"Queries/Dia","v":"3803","t":"-0.6%","d":"down"},{"l":"Dados Processados (GB)","v":"7.080","t":"-0.6%","d":"down"},{"l":"Utilizadores Analytics","v":"6.975","t":"+2.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1501","2026-03-23","8.432","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4209","2026-02-14","1.672","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","759","2026-02-13","5.739","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4815","2026-02-25","8.750","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4491","2026-03-10","6.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":277},{"label":"Fev","value":356},{"label":"Mar","value":432},{"label":"Abr","value":455},{"label":"Mai","value":315},{"label":"Jun","value":314},{"label":"Jul","value":247},{"label":"Ago","value":348},{"label":"Set","value":307},{"label":"Out","value":257},{"label":"Nov","value":277},{"label":"Dez","value":243}];
const MX = 455;
