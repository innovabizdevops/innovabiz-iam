...
const ACCENT = "#6366f1";
const MODULE = "Learning & Dev";
const PAGE = "Path";
const KPIS = [{"l":"Total Learning Dev","v":"2.389","t":"+17.8%","d":"up"},{"l":"Path Ativos","v":"121","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.9%","d":"up"}];
const COLS = ["ID","Path","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Learning Dev #001","Learning Dev #002","1.003","4.673","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Learning Dev #002","Learning Dev #003","7.971","6.678","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Learning Dev #003","Learning Dev #004","1.728","8.295","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Learning Dev #004","Learning Dev #005","5.958","748","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Learning Dev #005","Learning Dev #001","3.790","3.516","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":642},{"label":"Mar","value":601},{"label":"Abr","value":572},{"label":"Mai","value":361},{"label":"Jun","value":384},{"label":"Jul","value":411},{"label":"Ago","value":505},{"label":"Set","value":664},{"label":"Out","value":732},{"label":"Nov","value":519},{"label":"Dez","value":446}];
const MX = 732;
