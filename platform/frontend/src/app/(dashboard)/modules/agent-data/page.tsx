...
/* ═══ AI Data Agent — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "7713", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3465", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€119K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1735012313", cells: ["AGE-2313", "AI Data Agent Item 1", "14/6/2026", "€12 413"], status: "active" as const },
    { id: "1735015884", cells: ["AGE-5884", "AI Data Agent Item 2", "1/1/2026", "€15 984"], status: "pending" as const },
    { id: "1735019455", cells: ["AGE-9455", "AI Data Agent Item 3", "16/8/2026", "€19 555"], status: "completed" as const },
    { id: "1735023026", cells: ["AGE-4026", "AI Data Agent Item 4", "3/3/2026", "€23 126"], status: "warning" as const },
    { id: "1735026597", cells: ["AGE-7597", "AI Data Agent Item 5", "18/10/2026", "€26 697"], status: "active" as const },
];
...
export default function AiDataAgentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Data Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Data Agent</p>
                    </div>
                </div>
