...
const PAGE = "Clean";
const KPIS = [{"l":"Projetos Melhoria","v":"3.383","t":"+8.3%","d":"up"},{"l":"Savings (€)","v":"€58307","t":"+15.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.1%","t":"+9.5%","d":"up"},{"l":"Ciclos PDCA","v":"8.122","t":"+13.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.114","€ 27348.19","1.628","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.495","€ 43919.81","8.576","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.433","€ 5704.71","7.296","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.572","€ 19738.99","7.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.038","€ 34281.50","1.781","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":539},{"label":"Mar","value":422},{"label":"Abr","value":407},{"label":"Mai","value":629},{"label":"Jun","value":527},{"label":"Jul","value":501},{"label":"Ago","value":573},{"label":"Set","value":334},{"label":"Out","value":537},{"label":"Nov","value":668},{"label":"Dez","value":303}];
const MX = 668;
