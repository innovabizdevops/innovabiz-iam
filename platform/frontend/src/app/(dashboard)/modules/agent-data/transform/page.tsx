...
const KPIS = [{"l":"Formulários Ativos","v":"8.647","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"2924","t":"-4.1%","d":"down"},{"l":"Documentos Gerados","v":"6.089","t":"+1.9%","d":"up"},{"l":"Templates","v":"6.688","t":"+8.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.308","2026-01-09","7.361","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.600","2026-01-13","7.295","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.495","2026-02-15","8.258","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.294","2026-03-26","8.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.042","2026-01-08","2.686","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":565},{"label":"Mar","value":422},{"label":"Abr","value":665},{"label":"Mai","value":445},{"label":"Jun","value":501},{"label":"Jul","value":502},{"label":"Ago","value":691},{"label":"Set","value":592},{"label":"Out","value":441},{"label":"Nov","value":508},{"label":"Dez","value":429}];
const MX = 691;
