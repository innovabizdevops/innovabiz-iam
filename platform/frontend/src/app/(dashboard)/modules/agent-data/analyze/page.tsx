...
const ACCENT = "#7c3aed";
const MODULE = "AI Data Agent";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"2.977","t":"+16.7%","d":"up"},{"l":"Queries/Dia","v":"2347","t":"+16.3%","d":"up"},{"l":"Dados Processados (GB)","v":"6.792","t":"+10.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.778","t":"-1.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1904","2026-02-06","1.979","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1012","2026-02-01","4.613","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1804","2026-02-15","2.563","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1276","2026-01-27","8.558","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2949","2026-03-12","3.768","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":474},{"label":"Mar","value":516},{"label":"Abr","value":493},{"label":"Mai","value":659},{"label":"Jun","value":333},{"label":"Jul","value":325},{"label":"Ago","value":267},{"label":"Set","value":462},{"label":"Out","value":645},{"label":"Nov","value":466},{"label":"Dez","value":634}];
const MX = 659;
