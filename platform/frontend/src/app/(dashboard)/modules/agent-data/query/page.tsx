...
const PAGE = "Query";
const KPIS = [{"l":"Total Agent Data","v":"5.051","t":"+17.4%","d":"up"},{"l":"Query Ativos","v":"1.165","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"70","t":"-0.2%","d":"down"}];
const COLS = ["ID","Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Data #001","Agent Data #002","4.779","437","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Data #002","Agent Data #003","6.653","6.253","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Data #003","Agent Data #004","345","6.700","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Data #004","Agent Data #005","3.913","7.814","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Data #005","Agent Data #001","5.612","8.159","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":323},{"label":"Fev","value":553},{"label":"Mar","value":306},{"label":"Abr","value":438},{"label":"Mai","value":420},{"label":"Jun","value":538},{"label":"Jul","value":565},{"label":"Ago","value":611},{"label":"Set","value":584},{"label":"Out","value":343},{"label":"Nov","value":237},{"label":"Dez","value":559}];
const MX = 611;
