...
export default function FleetLeaseAutoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fleet Lease Auto</h1><p className="text-sm text-muted-foreground">Fleet Lease Auto • iBOS Enterprise</p></div>
