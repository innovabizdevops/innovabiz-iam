...
const ACCENT = "#0e7490";
const MODULE = "Fleet & Leasing";
const PAGE = "Fleet Policy";
const KPIS = [{"l":"Total Fleet Lease Auto","v":"8.371","t":"+15.2%","d":"up"},{"l":"Fleet Policy Ativos","v":"7.447","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"72.1%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"58","t":"+3.7%","d":"up"}];
const COLS = ["ID","Fleet Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Lease Auto #001","Fleet Lease Auto #002","8.490","4.703","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Lease Auto #002","Fleet Lease Auto #003","8.248","2.091","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Lease Auto #003","Fleet Lease Auto #004","6.757","5.726","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Lease Auto #004","Fleet Lease Auto #005","6.554","4.103","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Lease Auto #005","Fleet Lease Auto #001","5.646","3.505","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":729},{"label":"Mar","value":412},{"label":"Abr","value":401},{"label":"Mai","value":737},{"label":"Jun","value":693},{"label":"Jul","value":628},{"label":"Ago","value":658},{"label":"Set","value":526},{"label":"Out","value":668},{"label":"Nov","value":572},{"label":"Dez","value":416}];
const MX = 737;
