...
const KPIS = [{"l":"Total Fleet Lease Auto","v":"2.616","t":"+10.1%","d":"up"},{"l":"Lease Admin Ativos","v":"3.610","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"85","t":"+4.4%","d":"up"}];
const COLS = ["ID","Lease Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Lease Auto #001","Fleet Lease Auto #002","7.837","1.042","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Lease Auto #002","Fleet Lease Auto #003","3.862","5.443","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Lease Auto #003","Fleet Lease Auto #004","7.982","5.940","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Lease Auto #004","Fleet Lease Auto #005","6.430","8.321","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Lease Auto #005","Fleet Lease Auto #001","4.357","7.408","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":615},{"label":"Mar","value":359},{"label":"Abr","value":725},{"label":"Mai","value":374},{"label":"Jun","value":356},{"label":"Jul","value":467},{"label":"Ago","value":608},{"label":"Set","value":424},{"label":"Out","value":591},{"label":"Nov","value":463},{"label":"Dez","value":648}];
const MX = 725;
