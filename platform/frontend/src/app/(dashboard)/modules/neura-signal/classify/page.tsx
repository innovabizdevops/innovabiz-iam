...
const PAGE = "Classify";
const KPIS = [{"l":"Total Neura Signal","v":"8.035","t":"-5.1%","d":"down"},{"l":"Classify Ativos","v":"2.224","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"62","t":"+8.9%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neura Signal #001","Neura Signal #002","8.218","8.631","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Neura Signal #002","Neura Signal #003","2.160","8.797","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Neura Signal #003","Neura Signal #004","6.891","5.326","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Neura Signal #004","Neura Signal #005","6.318","3.685","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neura Signal #005","Neura Signal #001","2.421","6.764","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":990},{"label":"Mar","value":745},{"label":"Abr","value":1010},{"label":"Mai","value":654},{"label":"Jun","value":846},{"label":"Jul","value":908},{"label":"Ago","value":785},{"label":"Set","value":970},{"label":"Out","value":1015},{"label":"Nov","value":983},{"label":"Dez","value":943}];
const MX = 1015;
