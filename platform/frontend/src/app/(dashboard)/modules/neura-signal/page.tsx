...
/* ═══ NEURA Signal Intelligence — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "2479", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1019", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€363K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1384606479", cells: ["NEU-2479", "NEURA Signal Intelligence Item 1", "12/4/2026", "€6579"], status: "active" as const },
    { id: "1384610050", cells: ["NEU-6050", "NEURA Signal Intelligence Item 2", "27/11/2026", "€10 150"], status: "pending" as const },
    { id: "1384613621", cells: ["NEU-9621", "NEURA Signal Intelligence Item 3", "14/6/2026", "€13 721"], status: "completed" as const },
    { id: "1384617192", cells: ["NEU-4192", "NEURA Signal Intelligence Item 4", "1/1/2026", "€17 292"], status: "warning" as const },
    { id: "1384620763", cells: ["NEU-7763", "NEURA Signal Intelligence Item 5", "16/8/2026", "€20 863"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 99 }, { label: "Fev", value: 28 }, { label: "Mar", value: 37 }, { label: "Abr", value: 46 }, { label: "Mai", value: 55 }, { label: "Jun", value: 64 }];
...
export default function NeuraSignalIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NEURA Signal Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NEURA Signal Intelligence</p>
                    </div>
                </div>
