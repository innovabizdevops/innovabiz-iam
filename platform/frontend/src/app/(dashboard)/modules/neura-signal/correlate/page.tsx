...
const ACCENT = "#4c1d95";
const MODULE = "NEURA Signal Intelligence";
const PAGE = "Correlate";
const KPIS = [{"l":"Total Neura Signal","v":"1.716","t":"-1.9%","d":"down"},{"l":"Correlate Ativos","v":"5.061","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"89.3%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"94","t":"+13.6%","d":"up"}];
const COLS = ["ID","Correlate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neura Signal #001","Neura Signal #002","4.278","8.575","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Neura Signal #002","Neura Signal #003","3.991","1.095","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Neura Signal #003","Neura Signal #004","8.785","8.309","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Neura Signal #004","Neura Signal #005","5.371","2.271","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neura Signal #005","Neura Signal #001","768","8.365","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":456},{"label":"Mar","value":549},{"label":"Abr","value":619},{"label":"Mai","value":318},{"label":"Jun","value":450},{"label":"Jul","value":451},{"label":"Ago","value":573},{"label":"Set","value":636},{"label":"Out","value":513},{"label":"Nov","value":354},{"label":"Dez","value":395}];
const MX = 636;
