...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"7.208","t":"+13.1%","d":"up"},{"l":"Viagens/Dia","v":"3500","t":"+14.3%","d":"up"},{"l":"Pontualidade (%)","v":"76.0%","t":"+7.8%","d":"up"},{"l":"Passageiros/Dia","v":"4658","t":"-4.4%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-27","2026-03-03","1.775","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-10","2026-01-21","3.688","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-06","2026-02-02","7.341","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-13","2026-03-18","1.052","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-12","2026-01-09","3.809","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":464},{"label":"Mar","value":637},{"label":"Abr","value":310},{"label":"Mai","value":631},{"label":"Jun","value":464},{"label":"Jul","value":583},{"label":"Ago","value":465},{"label":"Set","value":578},{"label":"Out","value":356},{"label":"Nov","value":289},{"label":"Dez","value":539}];
const MX = 637;
