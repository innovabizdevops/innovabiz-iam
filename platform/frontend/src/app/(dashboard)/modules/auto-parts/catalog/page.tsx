...
const ACCENT = "#6366f1";
const MODULE = "Auto Parts Mgmt";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"3.927","t":"+8.3%","d":"up"},{"l":"Queries/Dia","v":"4539","t":"+13.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.728","t":"+6.8%","d":"up"},{"l":"Utilizadores Analytics","v":"9.085","t":"+16.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1409","2026-03-17","4.566","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","503","2026-01-22","379","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4498","2026-03-17","7.946","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","241","2026-03-24","3.966","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4195","2026-01-05","8.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":653},{"label":"Mar","value":701},{"label":"Abr","value":784},{"label":"Mai","value":726},{"label":"Jun","value":777},{"label":"Jul","value":568},{"label":"Ago","value":674},{"label":"Set","value":765},{"label":"Out","value":698},{"label":"Nov","value":799},{"label":"Dez","value":807}];
const MX = 894;
