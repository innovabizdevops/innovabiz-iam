...
const ACCENT = "#4338ca";
const MODULE = "Startup Accelerator";
const PAGE = "Investment";
const KPIS = [{"l":"Total Accelerator Mgmt","v":"5.418","t":"+5.1%","d":"up"},{"l":"Investment Ativos","v":"6.489","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"63","t":"-1.1%","d":"down"}];
const COLS = ["ID","Investment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accelerator Mgmt #001","Accelerator Mgmt #002","6.170","270","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Accelerator Mgmt #002","Accelerator Mgmt #003","1.652","9.071","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Accelerator Mgmt #003","Accelerator Mgmt #004","6.694","5.200","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Accelerator Mgmt #004","Accelerator Mgmt #005","3.816","5.116","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accelerator Mgmt #005","Accelerator Mgmt #001","6.866","1.639","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":994},{"label":"Mar","value":901},{"label":"Abr","value":740},{"label":"Mai","value":787},{"label":"Jun","value":722},{"label":"Jul","value":936},{"label":"Ago","value":1041},{"label":"Set","value":799},{"label":"Out","value":1029},{"label":"Nov","value":1059},{"label":"Dez","value":707}];
const MX = 1059;
