...
const PAGE = "Demo Day";
const KPIS = [{"l":"Total Accelerator Mgmt","v":"3.335","t":"+8.7%","d":"up"},{"l":"Demo Day Ativos","v":"6.919","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"71.4%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"58","t":"+8.1%","d":"up"}];
const COLS = ["ID","Demo Day","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accelerator Mgmt #001","Accelerator Mgmt #002","8.240","5.826","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Accelerator Mgmt #002","Accelerator Mgmt #003","2.536","1.384","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Accelerator Mgmt #003","Accelerator Mgmt #004","4.140","2.030","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Accelerator Mgmt #004","Accelerator Mgmt #005","1.703","1.618","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accelerator Mgmt #005","Accelerator Mgmt #001","4.476","7.933","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":539},{"label":"Mar","value":741},{"label":"Abr","value":778},{"label":"Mai","value":757},{"label":"Jun","value":565},{"label":"Jul","value":655},{"label":"Ago","value":545},{"label":"Set","value":434},{"label":"Out","value":506},{"label":"Nov","value":392},{"label":"Dez","value":623}];
const MX = 778;
