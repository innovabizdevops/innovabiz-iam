...
const PAGE = "Program";
const KPIS = [{"l":"Total Accelerator Mgmt","v":"1.295","t":"+7.2%","d":"up"},{"l":"Program Ativos","v":"3.527","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"89","t":"+4.6%","d":"up"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Accelerator Mgmt #001","Accelerator Mgmt #002","5.478","8.973","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Accelerator Mgmt #002","Accelerator Mgmt #003","5.703","3.452","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Accelerator Mgmt #003","Accelerator Mgmt #004","7.132","7.380","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Accelerator Mgmt #004","Accelerator Mgmt #005","6.403","6.141","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Accelerator Mgmt #005","Accelerator Mgmt #001","3.712","5.395","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":750},{"label":"Mar","value":824},{"label":"Abr","value":947},{"label":"Mai","value":828},{"label":"Jun","value":844},{"label":"Jul","value":910},{"label":"Ago","value":815},{"label":"Set","value":806},{"label":"Out","value":1021},{"label":"Nov","value":905},{"label":"Dez","value":792}];
const MX = 1021;
