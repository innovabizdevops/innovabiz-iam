...
const KPIS = [
    { label: "Total Registos", value: "8206", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1519", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€289K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1389423606", cells: ["ACC-4606", "Startup Accelerator Item 1", "19/7/2026", "€23 706"], status: "active" as const },
    { id: "1389427177", cells: ["ACC-8177", "Startup Accelerator Item 2", "6/2/2026", "€27 277"], status: "pending" as const },
    { id: "1389430748", cells: ["ACC-2748", "Startup Accelerator Item 3", "21/9/2026", "€30 848"], status: "completed" as const },
    { id: "1389434319", cells: ["ACC-6319", "Startup Accelerator Item 4", "8/4/2026", "€34 419"], status: "warning" as const },
    { id: "1389437890", cells: ["ACC-9890", "Startup Accelerator Item 5", "23/11/2026", "€37 990"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Startup Accelerator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Startup Accelerator</p>
                    </div>
                </div>
