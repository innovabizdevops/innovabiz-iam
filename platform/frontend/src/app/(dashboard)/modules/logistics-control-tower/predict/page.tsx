...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"8.529","t":"+10.2%","d":"up"},{"l":"Chamadas/Hora","v":"4715","t":"-2.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"90.6%","t":"+12.6%","d":"up"},{"l":"Latência Média (ms)","v":"110ms","t":"+15.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.377","2.489","80.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","760","5.764","78.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.321","969","73.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.397","3.175","82.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","649","6.737","71.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":974},{"label":"Mar","value":792},{"label":"Abr","value":949},{"label":"Mai","value":899},{"label":"Jun","value":725},{"label":"Jul","value":927},{"label":"Ago","value":666},{"label":"Set","value":1002},{"label":"Out","value":1010},{"label":"Nov","value":719},{"label":"Dez","value":941}];
const MX = 1016;
