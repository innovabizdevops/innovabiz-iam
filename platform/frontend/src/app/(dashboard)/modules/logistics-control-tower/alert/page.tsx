...
const ACCENT = "#6366f1";
const MODULE = "Logistics Control Tower";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.351","t":"+13.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"70.2%","t":"+9.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"76.4%","t":"+8.1%","d":"up"},{"l":"Escalações","v":"8.078","t":"+17.7%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.191","98.0%","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.680","85.7%","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.850","72.8%","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.130","84.8%","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.281","71.1%","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":618},{"label":"Mar","value":486},{"label":"Abr","value":337},{"label":"Mai","value":429},{"label":"Jun","value":540},{"label":"Jul","value":470},{"label":"Ago","value":309},{"label":"Set","value":483},{"label":"Out","value":578},{"label":"Nov","value":342},{"label":"Dez","value":374}];
const MX = 618;
