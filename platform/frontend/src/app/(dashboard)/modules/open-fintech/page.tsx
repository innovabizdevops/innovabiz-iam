...
export default function OpenFintechPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Open Fintech</h1><p className="text-sm text-muted-foreground">Open Fintech • iBOS Enterprise</p></div>
