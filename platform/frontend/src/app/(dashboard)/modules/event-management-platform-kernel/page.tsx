...
export default function EventManagementPlatformKernelPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Event Management Platform Kernel</h1><p className="text-sm text-muted-foreground">Event Management Platform Kernel • iBOS Enterprise</p></div>
