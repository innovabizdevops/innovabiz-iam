...
/* ═══ Paintball & Airsoft — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "8487", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3216", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€444K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1118777687", cells: ["PAI-6687", "Paintball & Airsoft Item 1", "28/12/2026", "€27 787"], status: "active" as const },
    { id: "1118781258", cells: ["PAI-1258", "Paintball & Airsoft Item 2", "15/7/2026", "€31 358"], status: "pending" as const },
    { id: "1118784829", cells: ["PAI-4829", "Paintball & Airsoft Item 3", "2/2/2026", "€34 929"], status: "completed" as const },
    { id: "1118788400", cells: ["PAI-8400", "Paintball & Airsoft Item 4", "17/9/2026", "€38 500"], status: "warning" as const },
    { id: "1118791971", cells: ["PAI-2971", "Paintball & Airsoft Item 5", "4/4/2026", "€42 071"], status: "active" as const },
];
...
export default function PaintballAirsoftPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Paintball & Airsoft</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Paintball & Airsoft</p>
                    </div>
                </div>
