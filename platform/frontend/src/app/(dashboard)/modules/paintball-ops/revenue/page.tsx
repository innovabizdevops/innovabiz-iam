...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€12.5M","t":"+14.7%","d":"up"},{"l":"MRR (€)","v":"€15364","t":"+9.9%","d":"up"},{"l":"Churn (%)","v":"92.1%","t":"-4.9%","d":"down"},{"l":"ARPU (€)","v":"€69320","t":"+13.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 23680.00","5.103","€ 12320.13","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22225.27","9.094","€ 30593.57","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1076.05","6.479","€ 30275.57","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49902.71","4.095","€ 34765.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37302.50","3.561","€ 12583.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":287},{"label":"Mar","value":304},{"label":"Abr","value":496},{"label":"Mai","value":312},{"label":"Jun","value":416},{"label":"Jul","value":564},{"label":"Ago","value":419},{"label":"Set","value":475},{"label":"Out","value":394},{"label":"Nov","value":267},{"label":"Dez","value":517}];
const MX = 564;
