...
const PAGE = "Landing Zone";
const KPIS = [{"l":"Riscos Identificados","v":"5.909","t":"+16.1%","d":"up"},{"l":"Mitigações Ativas","v":"467","t":"+9.9%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"+6.0%","d":"up"},{"l":"Incidentes YTD","v":"8.643","t":"-0.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.340","4.935","7.480","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.150","723","3.304","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.611","2.535","1.876","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.233","6.062","2.929","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.977","1.469","573","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":515},{"label":"Mar","value":361},{"label":"Abr","value":737},{"label":"Mai","value":517},{"label":"Jun","value":372},{"label":"Jul","value":409},{"label":"Ago","value":403},{"label":"Set","value":561},{"label":"Out","value":719},{"label":"Nov","value":426},{"label":"Dez","value":507}];
const MX = 737;
