...
const PAGE = "Account Mgmt";
const KPIS = [{"l":"Riscos Identificados","v":"5.821","t":"-4.3%","d":"down"},{"l":"Mitigações Ativas","v":"6.862","t":"+7.3%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"-5.6%","d":"down"},{"l":"Incidentes YTD","v":"6.235","t":"+7.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.224","8.318","3.316","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.313","2.895","1.921","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","846","6.373","1.114","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.576","7.638","1.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.855","3.124","7.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":527},{"label":"Mar","value":572},{"label":"Abr","value":615},{"label":"Mai","value":563},{"label":"Jun","value":874},{"label":"Jul","value":862},{"label":"Ago","value":586},{"label":"Set","value":529},{"label":"Out","value":635},{"label":"Nov","value":794},{"label":"Dez","value":917}];
const MX = 917;
