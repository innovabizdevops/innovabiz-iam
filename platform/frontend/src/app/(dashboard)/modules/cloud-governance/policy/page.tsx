...
const ACCENT = "#b45309";
const MODULE = "Cloud Governance";
const PAGE = "Policy Engine";
const KPIS = [{"l":"Riscos Identificados","v":"1.885","t":"+5.6%","d":"up"},{"l":"Mitigações Ativas","v":"5.882","t":"+14.5%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"-2.2%","d":"down"},{"l":"Incidentes YTD","v":"8.492","t":"-1.0%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.151","5.088","7.819","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.200","5.450","6.426","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.790","4.817","2.186","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.975","637","416","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.008","5.951","5.625","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":789},{"label":"Mar","value":594},{"label":"Abr","value":870},{"label":"Mai","value":851},{"label":"Jun","value":671},{"label":"Jul","value":863},{"label":"Ago","value":801},{"label":"Set","value":742},{"label":"Out","value":593},{"label":"Nov","value":573},{"label":"Dez","value":592}];
const MX = 870;
