...
const KPIS = [{"l":"Riscos Identificados","v":"4.181","t":"+17.4%","d":"up"},{"l":"Mitigações Ativas","v":"199","t":"-5.2%","d":"down"},{"l":"Score Risco Geral","v":"68","t":"+16.7%","d":"up"},{"l":"Incidentes YTD","v":"5.740","t":"-4.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.256","5.732","7.565","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.449","570","5.988","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.390","2.834","6.913","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.837","7.513","4.071","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.446","1.412","2.036","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":511},{"label":"Mar","value":368},{"label":"Abr","value":520},{"label":"Mai","value":681},{"label":"Jun","value":549},{"label":"Jul","value":453},{"label":"Ago","value":610},{"label":"Set","value":342},{"label":"Out","value":669},{"label":"Nov","value":332},{"label":"Dez","value":714}];
const MX = 714;
