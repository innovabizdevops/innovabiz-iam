...
const PAGE = "Tag Mgmt";
const KPIS = [{"l":"Riscos Identificados","v":"4.578","t":"+14.6%","d":"up"},{"l":"Mitigações Ativas","v":"250","t":"+14.3%","d":"up"},{"l":"Score Risco Geral","v":"62","t":"-0.9%","d":"down"},{"l":"Incidentes YTD","v":"6.322","t":"+5.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.747","1.793","7.821","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.438","4.792","5.675","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.288","3.850","4.841","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.586","5.051","6.283","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","902","4.397","823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":952},{"label":"Fev","value":907},{"label":"Mar","value":764},{"label":"Abr","value":956},{"label":"Mai","value":606},{"label":"Jun","value":561},{"label":"Jul","value":834},{"label":"Ago","value":862},{"label":"Set","value":748},{"label":"Out","value":911},{"label":"Nov","value":880},{"label":"Dez","value":881}];
const MX = 956;
