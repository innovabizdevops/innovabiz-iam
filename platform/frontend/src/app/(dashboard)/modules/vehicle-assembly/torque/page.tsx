...
const PAGE = "Torque";
const KPIS = [{"l":"Total Vehicle Assembly","v":"8.785","t":"+17.7%","d":"up"},{"l":"Torque Ativos","v":"3.245","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"88.8%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+16.7%","d":"up"}];
const COLS = ["ID","Torque","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Assembly #001","Vehicle Assembly #002","1.371","4.128","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Assembly #002","Vehicle Assembly #003","8.611","318","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Assembly #003","Vehicle Assembly #004","2.051","6.752","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Assembly #004","Vehicle Assembly #005","4.565","8.145","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Assembly #005","Vehicle Assembly #001","5.392","932","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":681},{"label":"Mar","value":455},{"label":"Abr","value":585},{"label":"Mai","value":605},{"label":"Jun","value":469},{"label":"Jul","value":530},{"label":"Ago","value":503},{"label":"Set","value":612},{"label":"Out","value":603},{"label":"Nov","value":567},{"label":"Dez","value":315}];
const MX = 681;
