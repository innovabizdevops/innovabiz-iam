...
const ACCENT = "#6366f1";
const MODULE = "Vehicle Assembly";
const PAGE = "Sequence";
const KPIS = [{"l":"Total Vehicle Assembly","v":"5.402","t":"-5.3%","d":"down"},{"l":"Sequence Ativos","v":"2.685","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"71","t":"+6.8%","d":"up"}];
const COLS = ["ID","Sequence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Assembly #001","Vehicle Assembly #002","4.611","2.836","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Assembly #002","Vehicle Assembly #003","6.447","7.680","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Assembly #003","Vehicle Assembly #004","6.014","4.695","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Assembly #004","Vehicle Assembly #005","456","1.929","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Assembly #005","Vehicle Assembly #001","6.987","7.606","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":572},{"label":"Mar","value":308},{"label":"Abr","value":309},{"label":"Mai","value":299},{"label":"Jun","value":475},{"label":"Jul","value":250},{"label":"Ago","value":306},{"label":"Set","value":297},{"label":"Out","value":309},{"label":"Nov","value":614},{"label":"Dez","value":432}];
const MX = 614;
