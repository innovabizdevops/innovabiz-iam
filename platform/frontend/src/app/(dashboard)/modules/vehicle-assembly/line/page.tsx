...
const PAGE = "Line";
const KPIS = [{"l":"Total Vehicle Assembly","v":"8.318","t":"+1.9%","d":"up"},{"l":"Line Ativos","v":"4.941","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"73.1%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+1.9%","d":"up"}];
const COLS = ["ID","Line","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Assembly #001","Vehicle Assembly #002","7.814","8.557","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Assembly #002","Vehicle Assembly #003","624","7.857","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Assembly #003","Vehicle Assembly #004","3.695","5.401","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Assembly #004","Vehicle Assembly #005","3.784","2.578","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Assembly #005","Vehicle Assembly #001","2.086","1.810","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":461},{"label":"Mar","value":603},{"label":"Abr","value":383},{"label":"Mai","value":403},{"label":"Jun","value":378},{"label":"Jul","value":589},{"label":"Ago","value":577},{"label":"Set","value":380},{"label":"Out","value":241},{"label":"Nov","value":549},{"label":"Dez","value":469}];
const MX = 603;
