...
const PAGE = "Station";
const KPIS = [{"l":"Total Vehicle Assembly","v":"5.765","t":"+7.0%","d":"up"},{"l":"Station Ativos","v":"3.684","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"68","t":"+17.4%","d":"up"}];
const COLS = ["ID","Station","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Assembly #001","Vehicle Assembly #002","7.163","3.604","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Assembly #002","Vehicle Assembly #003","2.911","9.036","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Assembly #003","Vehicle Assembly #004","8.165","8.168","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Assembly #004","Vehicle Assembly #005","959","5.384","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Assembly #005","Vehicle Assembly #001","1.309","4.510","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":655},{"label":"Mar","value":816},{"label":"Abr","value":890},{"label":"Mai","value":762},{"label":"Jun","value":633},{"label":"Jul","value":601},{"label":"Ago","value":654},{"label":"Set","value":673},{"label":"Out","value":721},{"label":"Nov","value":681},{"label":"Dez","value":590}];
const MX = 890;
