...
const KPIS = [{"l":"Total Surety Bond","v":"4.559","t":"+10.2%","d":"up"},{"l":"Portfolio Ativos","v":"4.201","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"94.5%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+6.5%","d":"up"}];
const COLS = ["ID","Portfolio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surety Bond #001","Surety Bond #002","3.589","8.435","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Surety Bond #002","Surety Bond #003","7.973","1.607","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Surety Bond #003","Surety Bond #004","3.127","1.786","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Surety Bond #004","Surety Bond #005","4.790","7.232","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surety Bond #005","Surety Bond #001","2.447","6.876","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":706},{"label":"Mar","value":824},{"label":"Abr","value":715},{"label":"Mai","value":543},{"label":"Jun","value":725},{"label":"Jul","value":760},{"label":"Ago","value":771},{"label":"Set","value":660},{"label":"Out","value":631},{"label":"Nov","value":543},{"label":"Dez","value":763}];
const MX = 824;
