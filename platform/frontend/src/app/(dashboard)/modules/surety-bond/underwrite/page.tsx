...
const KPIS = [{"l":"Total Surety Bond","v":"8.103","t":"+4.6%","d":"up"},{"l":"Underwrite Ativos","v":"4.355","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"75","t":"+16.3%","d":"up"}];
const COLS = ["ID","Underwrite","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surety Bond #001","Surety Bond #002","8.245","576","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Surety Bond #002","Surety Bond #003","6.764","7.452","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Surety Bond #003","Surety Bond #004","8.613","121","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Surety Bond #004","Surety Bond #005","6.039","600","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surety Bond #005","Surety Bond #001","5.264","5.528","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":734},{"label":"Mar","value":660},{"label":"Abr","value":787},{"label":"Mai","value":511},{"label":"Jun","value":553},{"label":"Jul","value":573},{"label":"Ago","value":510},{"label":"Set","value":548},{"label":"Out","value":772},{"label":"Nov","value":740},{"label":"Dez","value":729}];
const MX = 833;
