...
const PAGE = "Bond Mgmt";
const KPIS = [{"l":"Total Surety Bond","v":"1.402","t":"+14.3%","d":"up"},{"l":"Bond Mgmt Ativos","v":"5.867","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"85","t":"+15.4%","d":"up"}];
const COLS = ["ID","Bond Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surety Bond #001","Surety Bond #002","2.611","3.634","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Surety Bond #002","Surety Bond #003","677","4.751","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Surety Bond #003","Surety Bond #004","595","2.177","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Surety Bond #004","Surety Bond #005","5.195","7.526","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surety Bond #005","Surety Bond #001","2.016","8.179","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":337},{"label":"Mar","value":446},{"label":"Abr","value":311},{"label":"Mai","value":327},{"label":"Jun","value":385},{"label":"Jul","value":325},{"label":"Ago","value":501},{"label":"Set","value":514},{"label":"Out","value":410},{"label":"Nov","value":213},{"label":"Dez","value":271}];
const MX = 514;
