...
const ACCENT = "#6366f1";
const MODULE = "Surety Bond";
const PAGE = "Indemnity";
const KPIS = [{"l":"Total Surety Bond","v":"509","t":"+7.9%","d":"up"},{"l":"Indemnity Ativos","v":"7.648","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"75","t":"+3.4%","d":"up"}];
const COLS = ["ID","Indemnity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Surety Bond #001","Surety Bond #002","1.529","8.234","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Surety Bond #002","Surety Bond #003","3.621","4.691","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Surety Bond #003","Surety Bond #004","8.263","6.652","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Surety Bond #004","Surety Bond #005","5.518","3.638","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Surety Bond #005","Surety Bond #001","3.903","1.171","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":726},{"label":"Mar","value":745},{"label":"Abr","value":724},{"label":"Mai","value":814},{"label":"Jun","value":895},{"label":"Jul","value":906},{"label":"Ago","value":885},{"label":"Set","value":779},{"label":"Out","value":714},{"label":"Nov","value":590},{"label":"Dez","value":748}];
const MX = 906;
