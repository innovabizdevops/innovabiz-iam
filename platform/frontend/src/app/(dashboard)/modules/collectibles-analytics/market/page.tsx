...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"649","t":"+8.4%","d":"up"},{"l":"Queries/Dia","v":"4825","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"4.676","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"6.953","t":"+13.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4640","2026-02-18","7.506","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2885","2026-01-09","1.056","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","797","2026-03-14","8.304","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1797","2026-03-26","8.107","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2858","2026-01-09","373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":246},{"label":"Fev","value":437},{"label":"Mar","value":421},{"label":"Abr","value":476},{"label":"Mai","value":220},{"label":"Jun","value":214},{"label":"Jul","value":577},{"label":"Ago","value":538},{"label":"Set","value":313},{"label":"Out","value":415},{"label":"Nov","value":432},{"label":"Dez","value":436}];
const MX = 577;
