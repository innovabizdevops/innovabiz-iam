...
/* ═══ Collectibles Analytics — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "897", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2319", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€437K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1357102697", cells: ["COL-2697", "Collectibles Analytics Item 1", "14/6/2026", "€2797"], status: "active" as const },
    { id: "1357106268", cells: ["COL-6268", "Collectibles Analytics Item 2", "1/1/2026", "€6368"], status: "pending" as const },
    { id: "1357109839", cells: ["COL-9839", "Collectibles Analytics Item 3", "16/8/2026", "€9939"], status: "completed" as const },
    { id: "1357113410", cells: ["COL-4410", "Collectibles Analytics Item 4", "3/3/2026", "€13 510"], status: "warning" as const },
    { id: "1357116981", cells: ["COL-7981", "Collectibles Analytics Item 5", "18/10/2026", "€17 081"], status: "active" as const },
];
...
export default function CollectiblesAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Collectibles Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Collectibles Analytics</p>
                    </div>
                </div>
