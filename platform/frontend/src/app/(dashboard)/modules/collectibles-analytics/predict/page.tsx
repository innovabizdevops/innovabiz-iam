...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.678","t":"+2.7%","d":"up"},{"l":"Queries/Dia","v":"1608","t":"+7.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.892","t":"+1.4%","d":"up"},{"l":"Utilizadores Analytics","v":"543","t":"+12.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","672","2026-01-17","971","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2525","2026-01-26","382","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2275","2026-02-27","7.133","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4761","2026-03-23","7.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4831","2026-02-15","8.360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":719},{"label":"Mar","value":1039},{"label":"Abr","value":801},{"label":"Mai","value":905},{"label":"Jun","value":758},{"label":"Jul","value":731},{"label":"Ago","value":814},{"label":"Set","value":728},{"label":"Out","value":999},{"label":"Nov","value":978},{"label":"Dez","value":663}];
const MX = 1039;
