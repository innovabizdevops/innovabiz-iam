...
const KPIS = [{"l":"Utilizadores Ativos","v":"1.774","t":"+16.9%","d":"up"},{"l":"Sessões/Dia","v":"1105","t":"+16.6%","d":"up"},{"l":"MFA Adoção (%)","v":"82.7%","t":"-1.5%","d":"down"},{"l":"Tentativas Bloqueadas","v":"6.837","t":"+14.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.021","4.720","2.298","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.925","2.063","2.520","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.651","2.273","2.761","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.952","7.141","5.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.734","8.611","8.326","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":729},{"label":"Mar","value":723},{"label":"Abr","value":690},{"label":"Mai","value":1016},{"label":"Jun","value":1016},{"label":"Jul","value":685},{"label":"Ago","value":726},{"label":"Set","value":909},{"label":"Out","value":858},{"label":"Nov","value":931},{"label":"Dez","value":641}];
const MX = 1016;
