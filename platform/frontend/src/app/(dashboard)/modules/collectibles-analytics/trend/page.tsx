...
const PAGE = "Trend";
const KPIS = [{"l":"Dashboards Ativos","v":"1.987","t":"-5.9%","d":"down"},{"l":"Queries/Dia","v":"2705","t":"+12.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.856","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"3.909","t":"+11.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4436","2026-01-16","621","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3610","2026-03-15","2.866","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4503","2026-03-19","1.404","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","480","2026-01-02","4.391","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","287","2026-02-03","6.024","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":430},{"label":"Mar","value":494},{"label":"Abr","value":563},{"label":"Mai","value":393},{"label":"Jun","value":599},{"label":"Jul","value":379},{"label":"Ago","value":414},{"label":"Set","value":650},{"label":"Out","value":582},{"label":"Nov","value":419},{"label":"Dez","value":318}];
const MX = 650;
