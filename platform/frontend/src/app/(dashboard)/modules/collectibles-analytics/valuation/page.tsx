...
const ACCENT = "#854d0e";
const MODULE = "Collectibles Analytics";
const PAGE = "Valuation";
const KPIS = [{"l":"Dashboards Ativos","v":"1.597","t":"-4.0%","d":"down"},{"l":"Queries/Dia","v":"3100","t":"+17.4%","d":"up"},{"l":"Dados Processados (GB)","v":"7.945","t":"-0.9%","d":"down"},{"l":"Utilizadores Analytics","v":"722","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","234","2026-03-14","1.239","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2389","2026-01-23","885","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1523","2026-01-17","8.818","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","439","2026-02-15","3.228","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3705","2026-02-10","1.188","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":606},{"label":"Mar","value":835},{"label":"Abr","value":827},{"label":"Mai","value":446},{"label":"Jun","value":484},{"label":"Jul","value":618},{"label":"Ago","value":492},{"label":"Set","value":661},{"label":"Out","value":471},{"label":"Nov","value":750},{"label":"Dez","value":784}];
const MX = 835;
