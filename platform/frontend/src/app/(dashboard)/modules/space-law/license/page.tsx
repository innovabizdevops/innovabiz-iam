...
const PAGE = "License";
const KPIS = [{"l":"Quartos Ocupados","v":"6.671","t":"-2.1%","d":"down"},{"l":"RevPAR (€)","v":"€77969","t":"-4.0%","d":"down"},{"l":"Ocupação (%)","v":"72.9%","t":"+16.8%","d":"up"},{"l":"Guest Satisfaction","v":"4.248","t":"-4.9%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.107","2026-03-09","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.965","2026-01-02","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.915","2026-02-13","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.701","2026-02-18","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.489","2026-01-19","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":860},{"label":"Mar","value":680},{"label":"Abr","value":547},{"label":"Mai","value":858},{"label":"Jun","value":779},{"label":"Jul","value":624},{"label":"Ago","value":713},{"label":"Set","value":601},{"label":"Out","value":786},{"label":"Nov","value":700},{"label":"Dez","value":536}];
const MX = 860;
