...
const ACCENT = "#7c3aed";
const MODULE = "Space Law & Policy";
const PAGE = "National Law";
const KPIS = [{"l":"Quartos Ocupados","v":"2.161","t":"+3.6%","d":"up"},{"l":"RevPAR (€)","v":"€14109","t":"+9.0%","d":"up"},{"l":"Ocupação (%)","v":"80.2%","t":"+9.6%","d":"up"},{"l":"Guest Satisfaction","v":"6.906","t":"+11.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.758","2026-03-21","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.232","2026-03-10","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.908","2026-03-14","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.195","2026-01-10","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.441","2026-03-15","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":681},{"label":"Mar","value":412},{"label":"Abr","value":591},{"label":"Mai","value":687},{"label":"Jun","value":786},{"label":"Jul","value":606},{"label":"Ago","value":786},{"label":"Set","value":673},{"label":"Out","value":725},{"label":"Nov","value":759},{"label":"Dez","value":739}];
const MX = 786;
