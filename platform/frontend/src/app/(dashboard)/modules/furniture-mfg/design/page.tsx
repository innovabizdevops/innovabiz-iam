...
const ACCENT = "#0d3b1e";
const MODULE = "Furniture Manufacturing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.783","t":"-5.8%","d":"down"},{"l":"Submissões/Dia","v":"4019","t":"+1.3%","d":"up"},{"l":"Documentos Gerados","v":"3.409","t":"+11.4%","d":"up"},{"l":"Templates","v":"907","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","336","2026-03-26","1.697","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.586","2026-02-03","7.653","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.313","2026-03-23","1.237","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.110","2026-01-10","2.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.738","2026-01-01","8.932","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":626},{"label":"Mar","value":720},{"label":"Abr","value":496},{"label":"Mai","value":775},{"label":"Jun","value":415},{"label":"Jul","value":576},{"label":"Ago","value":666},{"label":"Set","value":654},{"label":"Out","value":675},{"label":"Nov","value":656},{"label":"Dez","value":571}];
const MX = 775;
