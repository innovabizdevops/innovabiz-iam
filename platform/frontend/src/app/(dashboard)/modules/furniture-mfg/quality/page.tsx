...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.783","t":"+12.8%","d":"up"},{"l":"NC Abertas","v":"5.564","t":"+16.0%","d":"up"},{"l":"Conformidade (%)","v":"71.2%","t":"+3.8%","d":"up"},{"l":"CAPAs Pendentes","v":"5.705","t":"+8.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.161","71.3%","8.762","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.274","87.8%","355","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","467","73.7%","5.591","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.531","99.5%","8.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.009","82.2%","5.960","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":313},{"label":"Mar","value":614},{"label":"Abr","value":511},{"label":"Mai","value":651},{"label":"Jun","value":537},{"label":"Jul","value":437},{"label":"Ago","value":627},{"label":"Set","value":638},{"label":"Out","value":302},{"label":"Nov","value":493},{"label":"Dez","value":541}];
const MX = 651;
