...
/* ═══ Furniture Manufacturing — Dashboard ═══ */

const ACCENT = "#0d3b1e";

const KPIS = [
    { label: "Total Registos", value: "9910", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "106", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1004176710", cells: ["FUR-2710", "Furniture Manufacturing Item 1", "27/7/2026", "€26 810"], status: "active" as const },
    { id: "1004180281", cells: ["FUR-6281", "Furniture Manufacturing Item 2", "14/2/2026", "€30 381"], status: "pending" as const },
    { id: "1004183852", cells: ["FUR-9852", "Furniture Manufacturing Item 3", "1/9/2026", "€33 952"], status: "completed" as const },
    { id: "1004187423", cells: ["FUR-4423", "Furniture Manufacturing Item 4", "16/4/2026", "€37 523"], status: "warning" as const },
    { id: "1004190994", cells: ["FUR-7994", "Furniture Manufacturing Item 5", "3/11/2026", "€41 094"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Furniture Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Furniture Manufacturing</p>
                    </div>
                </div>
