...
const PAGE = "False Positives";
const KPIS = [{"l":"Pedidos/Dia","v":"5024","t":"-1.1%","d":"down"},{"l":"GMV (€)","v":"€59510","t":"-4.5%","d":"down"},{"l":"Conversão (%)","v":"81.9%","t":"+14.2%","d":"up"},{"l":"AOV (€)","v":"€30290","t":"+2.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 33396.09","6.298","5.553","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 24798.72","3.252","845","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 18202.07","2.223","8.074","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 14553.44","8.532","2.693","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 13649.69","7.896","2.828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":570},{"label":"Mar","value":593},{"label":"Abr","value":915},{"label":"Mai","value":714},{"label":"Jun","value":586},{"label":"Jul","value":663},{"label":"Ago","value":804},{"label":"Set","value":758},{"label":"Out","value":617},{"label":"Nov","value":747},{"label":"Dez","value":781}];
const MX = 915;
...
export default function FalsePosPage() {
    return (
