...
const ACCENT = "#dc2626";
const MODULE = "Sanctions Management";
const PAGE = "Real-Time Screen";
const KPIS = [{"l":"Total Sanctions Mgmt","v":"6.667","t":"+13.4%","d":"up"},{"l":"Real Time Screen Ativos","v":"7.871","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"69","t":"+15.6%","d":"up"}];
const COLS = ["ID","Real Time Screen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sanctions Mgmt #001","Sanctions Mgmt #002","4.614","8.427","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Sanctions Mgmt #002","Sanctions Mgmt #003","255","5.030","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Sanctions Mgmt #003","Sanctions Mgmt #004","8.329","154","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Sanctions Mgmt #004","Sanctions Mgmt #005","8.614","102","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sanctions Mgmt #005","Sanctions Mgmt #001","6.239","5.958","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":460},{"label":"Mar","value":637},{"label":"Abr","value":672},{"label":"Mai","value":479},{"label":"Jun","value":729},{"label":"Jul","value":741},{"label":"Ago","value":549},{"label":"Set","value":491},{"label":"Out","value":492},{"label":"Nov","value":519},{"label":"Dez","value":714}];
const MX = 741;
