...
const PAGE = "Match Resolution";
const KPIS = [{"l":"Atletas Registados","v":"7.735","t":"+2.4%","d":"up"},{"l":"Treinos/Semana","v":"4441","t":"-2.5%","d":"down"},{"l":"Competições","v":"1.374","t":"+10.2%","d":"up"},{"l":"Performance Score","v":"84","t":"+2.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.848","1.565","2.597","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.298","5.785","7.745","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.974","1.004","2.105","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","478","1.603","2.536","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.682","7.743","2.617","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":574},{"label":"Mar","value":457},{"label":"Abr","value":722},{"label":"Mai","value":551},{"label":"Jun","value":621},{"label":"Jul","value":454},{"label":"Ago","value":405},{"label":"Set","value":699},{"label":"Out","value":701},{"label":"Nov","value":730},{"label":"Dez","value":593}];
const MX = 730;
