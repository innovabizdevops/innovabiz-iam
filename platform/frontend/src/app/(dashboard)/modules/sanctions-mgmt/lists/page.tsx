...
const PAGE = "List Mgmt";
const KPIS = [{"l":"Total Sanctions Mgmt","v":"7.389","t":"+17.5%","d":"up"},{"l":"List Mgmt Ativos","v":"2.135","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"83.3%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"78","t":"-4.9%","d":"down"}];
const COLS = ["ID","List Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sanctions Mgmt #001","Sanctions Mgmt #002","2.469","5.717","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Sanctions Mgmt #002","Sanctions Mgmt #003","3.702","7.321","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sanctions Mgmt #003","Sanctions Mgmt #004","3.277","1.429","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Sanctions Mgmt #004","Sanctions Mgmt #005","2.568","1.022","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sanctions Mgmt #005","Sanctions Mgmt #001","4.862","6.685","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":305},{"label":"Fev","value":567},{"label":"Mar","value":663},{"label":"Abr","value":550},{"label":"Mai","value":677},{"label":"Jun","value":484},{"label":"Jul","value":431},{"label":"Ago","value":666},{"label":"Set","value":580},{"label":"Out","value":454},{"label":"Nov","value":296},{"label":"Dez","value":322}];
const MX = 677;
