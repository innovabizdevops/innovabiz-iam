...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.267","t":"-0.3%","d":"down"},{"l":"NC Abertas","v":"7.398","t":"+7.5%","d":"up"},{"l":"Conformidade (%)","v":"74.9%","t":"+9.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.801","t":"+2.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.605","86.8%","7.969","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.204","73.1%","7.466","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.264","94.6%","1.229","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.173","76.5%","771","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.224","71.3%","7.468","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":758},{"label":"Mar","value":716},{"label":"Abr","value":589},{"label":"Mai","value":792},{"label":"Jun","value":606},{"label":"Jul","value":654},{"label":"Ago","value":583},{"label":"Set","value":491},{"label":"Out","value":720},{"label":"Nov","value":760},{"label":"Dez","value":514}];
const MX = 792;
