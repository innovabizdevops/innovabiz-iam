...
const PAGE = "Policy Editor";
const KPIS = [{"l":"Integrações Ativas","v":"6.790","t":"+11.8%","d":"up"},{"l":"Chamadas/Hora","v":"1236","t":"+6.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.3%","t":"+7.0%","d":"up"},{"l":"Latência Média (ms)","v":"74ms","t":"-5.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.040","4.746","85.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.499","5.555","86.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.731","1.419","99.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.748","7.458","72.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.780","8.020","87.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":628},{"label":"Mar","value":476},{"label":"Abr","value":716},{"label":"Mai","value":541},{"label":"Jun","value":742},{"label":"Jul","value":611},{"label":"Ago","value":799},{"label":"Set","value":742},{"label":"Out","value":828},{"label":"Nov","value":850},{"label":"Dez","value":626}];
const MX = 850;
