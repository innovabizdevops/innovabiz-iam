...
const PAGE = "Review Cycle";
const KPIS = [{"l":"Total Policy Mgmt","v":"782","t":"+5.0%","d":"up"},{"l":"Review Cycle Ativos","v":"972","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+14.4%","d":"up"}];
const COLS = ["ID","Review Cycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Mgmt #001","Policy Mgmt #002","1.679","5.461","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Mgmt #002","Policy Mgmt #003","2.029","5.162","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Mgmt #003","Policy Mgmt #004","3.765","8.095","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Mgmt #004","Policy Mgmt #005","1.827","8.075","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Mgmt #005","Policy Mgmt #001","4.845","2.685","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":414},{"label":"Mar","value":392},{"label":"Abr","value":602},{"label":"Mai","value":330},{"label":"Jun","value":502},{"label":"Jul","value":553},{"label":"Ago","value":624},{"label":"Set","value":287},{"label":"Out","value":596},{"label":"Nov","value":618},{"label":"Dez","value":359}];
const MX = 624;
