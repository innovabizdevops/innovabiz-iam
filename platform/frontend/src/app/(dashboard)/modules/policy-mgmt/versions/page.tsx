...
const KPIS = [{"l":"Formulários Ativos","v":"255","t":"+0.2%","d":"up"},{"l":"Submissões/Dia","v":"2525","t":"+11.4%","d":"up"},{"l":"Documentos Gerados","v":"6.298","t":"-1.9%","d":"down"},{"l":"Templates","v":"7.410","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","759","2026-03-14","8.143","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.671","2026-02-12","4.015","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.939","2026-02-25","2.113","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","139","2026-01-06","8.645","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.088","2026-01-13","8.974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":420},{"label":"Mar","value":494},{"label":"Abr","value":683},{"label":"Mai","value":623},{"label":"Jun","value":579},{"label":"Jul","value":737},{"label":"Ago","value":518},{"label":"Set","value":626},{"label":"Out","value":583},{"label":"Nov","value":463},{"label":"Dez","value":686}];
const MX = 737;
