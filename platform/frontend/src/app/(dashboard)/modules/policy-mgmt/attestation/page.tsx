...
const ACCENT = "#1e40af";
const MODULE = "Policy Management";
const PAGE = "Attestation";
const KPIS = [{"l":"Total Policy Mgmt","v":"6.078","t":"+8.6%","d":"up"},{"l":"Attestation Ativos","v":"875","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"76.4%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"70","t":"+8.8%","d":"up"}];
const COLS = ["ID","Attestation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Mgmt #001","Policy Mgmt #002","5.947","3.618","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Mgmt #002","Policy Mgmt #003","8.136","4.469","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Mgmt #003","Policy Mgmt #004","7.211","1.182","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Mgmt #004","Policy Mgmt #005","6.494","1.631","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Mgmt #005","Policy Mgmt #001","1.268","5.975","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":459},{"label":"Mar","value":542},{"label":"Abr","value":588},{"label":"Mai","value":444},{"label":"Jun","value":362},{"label":"Jul","value":347},{"label":"Ago","value":632},{"label":"Set","value":303},{"label":"Out","value":441},{"label":"Nov","value":357},{"label":"Dez","value":639}];
const MX = 639;
