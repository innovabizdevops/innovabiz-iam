...
const KPIS = [{"l":"Total Policy Mgmt","v":"3.690","t":"+2.4%","d":"up"},{"l":"Distribution Ativos","v":"7.765","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"60","t":"+5.6%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Policy Mgmt #001","Policy Mgmt #002","5.246","8.779","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Policy Mgmt #002","Policy Mgmt #003","3.943","1.314","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Policy Mgmt #003","Policy Mgmt #004","614","8.537","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Policy Mgmt #004","Policy Mgmt #005","2.391","6.987","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Policy Mgmt #005","Policy Mgmt #001","749","3.444","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":202},{"label":"Mar","value":596},{"label":"Abr","value":403},{"label":"Mai","value":555},{"label":"Jun","value":202},{"label":"Jul","value":592},{"label":"Ago","value":453},{"label":"Set","value":229},{"label":"Out","value":561},{"label":"Nov","value":208},{"label":"Dez","value":509}];
const MX = 596;
