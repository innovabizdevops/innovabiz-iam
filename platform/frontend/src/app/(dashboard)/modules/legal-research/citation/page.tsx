...
const PAGE = "Citation";
const KPIS = [{"l":"Ideias Submetidas","v":"4.353","t":"-0.8%","d":"down"},{"l":"Patentes (YTD)","v":"681","t":"+11.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"167","t":"+7.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€2.4M","t":"-2.6%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.735","89.4%","3.619","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.298","86.2%","6.499","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","403","83.9%","7.743","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.446","71.8%","389","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.986","71.9%","3.403","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":730},{"label":"Mar","value":1070},{"label":"Abr","value":693},{"label":"Mai","value":840},{"label":"Jun","value":856},{"label":"Jul","value":922},{"label":"Ago","value":695},{"label":"Set","value":777},{"label":"Out","value":860},{"label":"Nov","value":994},{"label":"Dez","value":1058}];
const MX = 1070;
