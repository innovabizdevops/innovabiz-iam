...
const PAGE = "Case Law";
const KPIS = [{"l":"Ideias Submetidas","v":"4.737","t":"+5.2%","d":"up"},{"l":"Patentes (YTD)","v":"8.698","t":"+0.2%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.391","t":"-4.5%","d":"down"},{"l":"Budget I&D (€M)","v":"€39.9M","t":"+16.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.998","79.3%","5.859","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.291","96.1%","5.722","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.829","70.7%","7.776","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.316","72.9%","8.237","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.999","82.9%","3.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":360},{"label":"Mar","value":604},{"label":"Abr","value":642},{"label":"Mai","value":695},{"label":"Jun","value":479},{"label":"Jul","value":555},{"label":"Ago","value":629},{"label":"Set","value":569},{"label":"Out","value":395},{"label":"Nov","value":638},{"label":"Dez","value":352}];
const MX = 695;
