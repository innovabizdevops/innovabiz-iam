...
const PAGE = "Brief";
const KPIS = [{"l":"Ideias Submetidas","v":"8.283","t":"+9.9%","d":"up"},{"l":"Patentes (YTD)","v":"265","t":"-2.7%","d":"down"},{"l":"Projetos Innovation Lab","v":"8.506","t":"+3.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€2.0M","t":"-3.2%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.851","80.8%","5.771","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.359","71.5%","3.819","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.336","73.9%","6.355","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.146","87.6%","6.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.232","88.4%","152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":387},{"label":"Mar","value":652},{"label":"Abr","value":366},{"label":"Mai","value":670},{"label":"Jun","value":318},{"label":"Jul","value":297},{"label":"Ago","value":315},{"label":"Set","value":346},{"label":"Out","value":684},{"label":"Nov","value":399},{"label":"Dez","value":560}];
const MX = 684;
