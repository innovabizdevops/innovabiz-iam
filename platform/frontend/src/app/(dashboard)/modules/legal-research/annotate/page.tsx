...
const PAGE = "Annotate";
const KPIS = [{"l":"Ideias Submetidas","v":"3.022","t":"-1.1%","d":"down"},{"l":"Patentes (YTD)","v":"3.939","t":"+5.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.935","t":"+14.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€40.8M","t":"+14.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.499","77.6%","9.010","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.712","83.1%","457","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.280","75.8%","4.547","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.418","97.5%","8.320","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.788","80.0%","4.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":283},{"label":"Fev","value":300},{"label":"Mar","value":442},{"label":"Abr","value":405},{"label":"Mai","value":658},{"label":"Jun","value":262},{"label":"Jul","value":506},{"label":"Ago","value":260},{"label":"Set","value":469},{"label":"Out","value":302},{"label":"Nov","value":609},{"label":"Dez","value":379}];
const MX = 658;
