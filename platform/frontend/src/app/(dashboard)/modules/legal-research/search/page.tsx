...
const ACCENT = "#6366f1";
const MODULE = "Legal Research";
const PAGE = "AI Search";
const KPIS = [{"l":"Ideias Submetidas","v":"2.798","t":"+0.8%","d":"up"},{"l":"Patentes (YTD)","v":"5.016","t":"+1.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.935","t":"+0.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€45.2M","t":"-2.1%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.022","74.1%","7.829","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.963","89.9%","2.599","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","637","76.4%","5.116","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.748","72.9%","3.306","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.999","70.4%","7.800","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":572},{"label":"Mar","value":499},{"label":"Abr","value":433},{"label":"Mai","value":642},{"label":"Jun","value":403},{"label":"Jul","value":370},{"label":"Ago","value":523},{"label":"Set","value":668},{"label":"Out","value":497},{"label":"Nov","value":685},{"label":"Dez","value":530}];
const MX = 685;
