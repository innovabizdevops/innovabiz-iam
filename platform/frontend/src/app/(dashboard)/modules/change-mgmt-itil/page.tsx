...
/* ═══ Change Mgmt (ITIL) — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "6636", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2001", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€425K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1945841636", cells: ["CHA-6636", "Change Mgmt (ITIL) Item 1", "5/9/2026", "€41 736"], status: "active" as const },
    { id: "1945845207", cells: ["CHA-1207", "Change Mgmt (ITIL) Item 2", "20/4/2026", "€45 307"], status: "pending" as const },
    { id: "1945848778", cells: ["CHA-4778", "Change Mgmt (ITIL) Item 3", "7/11/2026", "€48 878"], status: "completed" as const },
    { id: "1945852349", cells: ["CHA-8349", "Change Mgmt (ITIL) Item 4", "22/6/2026", "€2449"], status: "warning" as const },
    { id: "1945855920", cells: ["CHA-2920", "Change Mgmt (ITIL) Item 5", "9/1/2026", "€6020"], status: "active" as const },
];
...
export default function ChangeMgmtItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Change Mgmt (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Change Mgmt (ITIL)</p>
                    </div>
                </div>
