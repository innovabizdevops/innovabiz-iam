...
const PAGE = "Assess";
const KPIS = [{"l":"Tickets Abertos","v":"2.457","t":"+17.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"83.9%","t":"+9.8%","d":"up"},{"l":"MTTR (h)","v":"103h","t":"+2.6%","d":"up"},{"l":"Satisfação (%)","v":"77.2%","t":"+13.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.690","665","3.098","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.085","3.102","2.338","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.156","1.577","8.240","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.813","8.936","7.027","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.565","821","979","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":604},{"label":"Mar","value":843},{"label":"Abr","value":575},{"label":"Mai","value":623},{"label":"Jun","value":531},{"label":"Jul","value":570},{"label":"Ago","value":663},{"label":"Set","value":666},{"label":"Out","value":608},{"label":"Nov","value":535},{"label":"Dez","value":652}];
const MX = 843;
