...
const PAGE = "CAB";
const KPIS = [{"l":"Tickets Abertos","v":"1.426","t":"+11.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"90.8%","t":"+13.2%","d":"up"},{"l":"MTTR (h)","v":"51h","t":"+5.9%","d":"up"},{"l":"Satisfação (%)","v":"84.3%","t":"-1.2%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.479","1.554","5.832","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.844","946","3.372","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.078","1.326","2.675","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.194","417","4.983","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.881","151","3.645","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":802},{"label":"Mar","value":649},{"label":"Abr","value":785},{"label":"Mai","value":919},{"label":"Jun","value":756},{"label":"Jul","value":951},{"label":"Ago","value":910},{"label":"Set","value":723},{"label":"Out","value":747},{"label":"Nov","value":726},{"label":"Dez","value":812}];
const MX = 951;
