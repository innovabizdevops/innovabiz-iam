...
const PAGE = "PIR";
const KPIS = [{"l":"Tickets Abertos","v":"1.192","t":"-2.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"88.3%","t":"-5.0%","d":"down"},{"l":"MTTR (h)","v":"141h","t":"+1.0%","d":"up"},{"l":"Satisfação (%)","v":"89.9%","t":"-1.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.467","420","3.116","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.600","6.119","1.147","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","148","3.552","1.971","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.214","1.768","1.993","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.861","3.747","9.035","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":543},{"label":"Mar","value":409},{"label":"Abr","value":502},{"label":"Mai","value":523},{"label":"Jun","value":285},{"label":"Jul","value":433},{"label":"Ago","value":285},{"label":"Set","value":344},{"label":"Out","value":639},{"label":"Nov","value":264},{"label":"Dez","value":503}];
const MX = 639;
