...
const ACCENT = "#64748b";
const MODULE = "Change Mgmt (ITIL)";
const PAGE = "Implement";
const KPIS = [{"l":"Tickets Abertos","v":"2.543","t":"+12.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"65.5%","t":"+8.5%","d":"up"},{"l":"MTTR (h)","v":"33h","t":"+6.6%","d":"up"},{"l":"Satisfação (%)","v":"76.7%","t":"-1.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.531","1.609","3.407","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.623","3.218","5.049","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.394","6.001","1.610","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.478","8.824","3.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.092","7.700","5.432","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":960},{"label":"Mar","value":705},{"label":"Abr","value":1048},{"label":"Mai","value":915},{"label":"Jun","value":805},{"label":"Jul","value":1044},{"label":"Ago","value":735},{"label":"Set","value":877},{"label":"Out","value":708},{"label":"Nov","value":1095},{"label":"Dez","value":990}];
const MX = 1095;
