...
const PAGE = "RFC";
const KPIS = [{"l":"Tickets Abertos","v":"5.469","t":"+11.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"70.4%","t":"+0.6%","d":"up"},{"l":"MTTR (h)","v":"68h","t":"+14.0%","d":"up"},{"l":"Satisfação (%)","v":"75.9%","t":"+7.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.665","3.729","8.040","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.861","3.929","1.437","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.909","642","8.856","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.277","4.922","4.171","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.662","2.065","3.784","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":671},{"label":"Mar","value":615},{"label":"Abr","value":663},{"label":"Mai","value":801},{"label":"Jun","value":674},{"label":"Jul","value":731},{"label":"Ago","value":759},{"label":"Set","value":735},{"label":"Out","value":935},{"label":"Nov","value":922},{"label":"Dez","value":759}];
const MX = 935;
