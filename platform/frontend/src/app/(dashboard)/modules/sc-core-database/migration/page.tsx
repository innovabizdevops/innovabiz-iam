...
const KPIS = [{"l":"Total Sc Core Database","v":"2.399","t":"-2.0%","d":"down"},{"l":"Migration Ativos","v":"406","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"79","t":"-0.1%","d":"down"}];
const COLS = ["ID","Migration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Database #001","Sc Core Database #002","3.483","4.197","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Database #002","Sc Core Database #003","8.477","4.893","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Database #003","Sc Core Database #004","3.628","6.687","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Database #004","Sc Core Database #005","2.565","6.084","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Database #005","Sc Core Database #001","2.270","3.234","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":999},{"label":"Fev","value":860},{"label":"Mar","value":711},{"label":"Abr","value":838},{"label":"Mai","value":613},{"label":"Jun","value":931},{"label":"Jul","value":1003},{"label":"Ago","value":764},{"label":"Set","value":883},{"label":"Out","value":619},{"label":"Nov","value":901},{"label":"Dez","value":791}];
const MX = 1003;
