...
/* ═══ SC: Core Database (ORM) — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "9903", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "208", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€172K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "968368403", cells: ["SC-5403", "SC: Core Database (ORM) Item 1", "24/12/2026", "€18 503"], status: "active" as const },
    { id: "968371974", cells: ["SC-8974", "SC: Core Database (ORM) Item 2", "11/7/2026", "€22 074"], status: "pending" as const },
    { id: "968375545", cells: ["SC-3545", "SC: Core Database (ORM) Item 3", "26/2/2026", "€25 645"], status: "completed" as const },
    { id: "968379116", cells: ["SC-7116", "SC: Core Database (ORM) Item 4", "13/9/2026", "€29 216"], status: "warning" as const },
    { id: "968382687", cells: ["SC-1687", "SC: Core Database (ORM) Item 5", "28/4/2026", "€32 787"], status: "active" as const },
];
...
export default function ScCoreDatabaseOrmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Database (ORM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Database (ORM)</p>
                    </div>
                </div>
