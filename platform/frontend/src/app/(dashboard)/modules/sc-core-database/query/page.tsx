...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Database (ORM)";
const PAGE = "Query";
const KPIS = [{"l":"Total Sc Core Database","v":"7.438","t":"+11.2%","d":"up"},{"l":"Query Ativos","v":"3.796","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"90.0%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+3.0%","d":"up"}];
const COLS = ["ID","Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Database #001","Sc Core Database #002","2.787","5.054","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Database #002","Sc Core Database #003","8.365","5.179","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Database #003","Sc Core Database #004","8.733","7.579","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Database #004","Sc Core Database #005","7.757","6.102","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Database #005","Sc Core Database #001","5.790","8.078","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":901},{"label":"Mar","value":707},{"label":"Abr","value":867},{"label":"Mai","value":656},{"label":"Jun","value":707},{"label":"Jul","value":813},{"label":"Ago","value":848},{"label":"Set","value":665},{"label":"Out","value":669},{"label":"Nov","value":675},{"label":"Dez","value":653}];
const MX = 971;
