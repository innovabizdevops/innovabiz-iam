...
const PAGE = "Model";
const KPIS = [{"l":"Total Sc Core Database","v":"4.428","t":"+12.4%","d":"up"},{"l":"Model Ativos","v":"1.764","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"76","t":"+5.5%","d":"up"}];
const COLS = ["ID","Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Database #001","Sc Core Database #002","6.576","2.268","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Database #002","Sc Core Database #003","1.442","6.128","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Database #003","Sc Core Database #004","6.313","5.402","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Database #004","Sc Core Database #005","4.033","6.311","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Database #005","Sc Core Database #001","1.394","381","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":380},{"label":"Mar","value":368},{"label":"Abr","value":515},{"label":"Mai","value":344},{"label":"Jun","value":552},{"label":"Jul","value":595},{"label":"Ago","value":553},{"label":"Set","value":341},{"label":"Out","value":351},{"label":"Nov","value":374},{"label":"Dez","value":663}];
const MX = 663;
