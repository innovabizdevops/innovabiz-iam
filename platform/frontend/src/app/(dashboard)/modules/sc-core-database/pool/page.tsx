...
const PAGE = "Pool";
const KPIS = [{"l":"Total Sc Core Database","v":"8.821","t":"+1.0%","d":"up"},{"l":"Pool Ativos","v":"4.606","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"85","t":"-4.9%","d":"down"}];
const COLS = ["ID","Pool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Database #001","Sc Core Database #002","926","7.975","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Database #002","Sc Core Database #003","6.721","6.972","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Database #003","Sc Core Database #004","4.596","1.650","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Database #004","Sc Core Database #005","5.452","128","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Database #005","Sc Core Database #001","3.535","7.075","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":665},{"label":"Mar","value":695},{"label":"Abr","value":917},{"label":"Mai","value":682},{"label":"Jun","value":664},{"label":"Jul","value":866},{"label":"Ago","value":684},{"label":"Set","value":839},{"label":"Out","value":809},{"label":"Nov","value":703},{"label":"Dez","value":854}];
const MX = 937;
