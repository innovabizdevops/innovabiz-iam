...
const PAGE = "Seed";
const KPIS = [{"l":"Total Sc Core Database","v":"7.421","t":"+14.9%","d":"up"},{"l":"Seed Ativos","v":"4.407","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"89.4%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+17.3%","d":"up"}];
const COLS = ["ID","Seed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Core Database #001","Sc Core Database #002","5.502","2.008","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Core Database #002","Sc Core Database #003","3.076","6.616","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Core Database #003","Sc Core Database #004","718","2.568","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Core Database #004","Sc Core Database #005","7.073","2.855","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Core Database #005","Sc Core Database #001","4.436","6.726","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":824},{"label":"Mar","value":663},{"label":"Abr","value":757},{"label":"Mai","value":603},{"label":"Jun","value":629},{"label":"Jul","value":856},{"label":"Ago","value":871},{"label":"Set","value":832},{"label":"Out","value":926},{"label":"Nov","value":914},{"label":"Dez","value":955}];
const MX = 955;
