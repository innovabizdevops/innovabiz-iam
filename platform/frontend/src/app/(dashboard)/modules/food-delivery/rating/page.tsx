...
const PAGE = "Rating";
const KPIS = [{"l":"Surveys Ativos","v":"7.464","t":"+5.0%","d":"up"},{"l":"Respostas/Semana","v":"3233","t":"+2.9%","d":"up"},{"l":"NPS Médio","v":"61","t":"+16.3%","d":"up"},{"l":"Taxa Resposta (%)","v":"84.2%","t":"-0.3%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.030","72","89.4%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.000","76","99.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","8.379","61","88.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","701","89","97.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","8.871","79","76.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":304},{"label":"Mar","value":544},{"label":"Abr","value":308},{"label":"Mai","value":430},{"label":"Jun","value":445},{"label":"Jul","value":438},{"label":"Ago","value":416},{"label":"Set","value":396},{"label":"Out","value":237},{"label":"Nov","value":454},{"label":"Dez","value":349}];
const MX = 544;
