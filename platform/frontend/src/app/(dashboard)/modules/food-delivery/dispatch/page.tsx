...
const ACCENT = "#6366f1";
const MODULE = "Food Delivery";
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"6.629","t":"+13.1%","d":"up"},{"l":"Viagens/Dia","v":"670","t":"+3.2%","d":"up"},{"l":"Pontualidade (%)","v":"74.5%","t":"+4.9%","d":"up"},{"l":"Passageiros/Dia","v":"4983","t":"+6.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-18","2026-03-26","8.823","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-20","2026-03-18","1.788","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-10","2026-01-09","8.877","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-14","2026-02-25","993","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-08","2026-02-23","4.019","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":953},{"label":"Mar","value":897},{"label":"Abr","value":823},{"label":"Mai","value":628},{"label":"Jun","value":835},{"label":"Jul","value":644},{"label":"Ago","value":765},{"label":"Set","value":765},{"label":"Out","value":667},{"label":"Nov","value":632},{"label":"Dez","value":953}];
const MX = 953;
