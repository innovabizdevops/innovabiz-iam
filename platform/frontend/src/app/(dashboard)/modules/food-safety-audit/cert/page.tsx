...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.982","t":"+11.1%","d":"up"},{"l":"NC Abertas","v":"6.392","t":"-2.4%","d":"down"},{"l":"Conformidade (%)","v":"76.3%","t":"+0.3%","d":"up"},{"l":"CAPAs Pendentes","v":"6.992","t":"+11.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.534","95.7%","7.272","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.992","74.0%","7.804","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.560","84.2%","1.319","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.374","96.6%","8.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.294","81.2%","3.936","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":796},{"label":"Mar","value":758},{"label":"Abr","value":831},{"label":"Mai","value":745},{"label":"Jun","value":818},{"label":"Jul","value":907},{"label":"Ago","value":626},{"label":"Set","value":736},{"label":"Out","value":692},{"label":"Nov","value":584},{"label":"Dez","value":583}];
const MX = 907;
