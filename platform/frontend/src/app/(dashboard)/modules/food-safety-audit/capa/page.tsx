...
const ACCENT = "#78350f";
const MODULE = "Food Safety Audit";
const PAGE = "CAPA Track";
const KPIS = [{"l":"Auditorias Realizadas","v":"9.029","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"6.387","t":"+1.0%","d":"up"},{"l":"Conformidade (%)","v":"75.2%","t":"-5.4%","d":"down"},{"l":"CAPAs Pendentes","v":"6.339","t":"+1.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.690","84.4%","5.647","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.003","86.2%","1.460","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.049","98.5%","314","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.490","86.6%","1.666","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.761","80.8%","5.829","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":447},{"label":"Mar","value":412},{"label":"Abr","value":396},{"label":"Mai","value":287},{"label":"Jun","value":564},{"label":"Jul","value":544},{"label":"Ago","value":584},{"label":"Set","value":379},{"label":"Out","value":461},{"label":"Nov","value":526},{"label":"Dez","value":470}];
const MX = 584;
