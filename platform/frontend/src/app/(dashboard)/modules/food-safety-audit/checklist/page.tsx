...
const KPIS = [{"l":"Auditorias Realizadas","v":"350","t":"+16.1%","d":"up"},{"l":"NC Abertas","v":"7.880","t":"-3.8%","d":"down"},{"l":"Conformidade (%)","v":"86.2%","t":"+2.7%","d":"up"},{"l":"CAPAs Pendentes","v":"485","t":"-2.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.313","90.9%","3.474","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.049","70.1%","1.420","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.216","78.7%","8.653","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.625","81.9%","7.535","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.251","97.9%","8.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":310},{"label":"Fev","value":338},{"label":"Mar","value":429},{"label":"Abr","value":323},{"label":"Mai","value":582},{"label":"Jun","value":300},{"label":"Jul","value":414},{"label":"Ago","value":410},{"label":"Set","value":492},{"label":"Out","value":463},{"label":"Nov","value":319},{"label":"Dez","value":525}];
const MX = 582;
