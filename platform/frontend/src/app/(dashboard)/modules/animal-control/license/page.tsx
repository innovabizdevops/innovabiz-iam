...
const PAGE = "License";
const KPIS = [{"l":"Total Animal Control","v":"4.957","t":"+16.9%","d":"up"},{"l":"License Ativos","v":"6.224","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"90","t":"-4.5%","d":"down"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Control #001","Animal Control #002","6.131","7.174","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Control #002","Animal Control #003","2.393","7.450","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Control #003","Animal Control #004","8.491","1.086","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Control #004","Animal Control #005","309","5.050","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Control #005","Animal Control #001","3.301","8.210","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":363},{"label":"Mar","value":697},{"label":"Abr","value":572},{"label":"Mai","value":692},{"label":"Jun","value":639},{"label":"Jul","value":540},{"label":"Ago","value":587},{"label":"Set","value":746},{"label":"Out","value":657},{"label":"Nov","value":446},{"label":"Dez","value":577}];
const MX = 746;
