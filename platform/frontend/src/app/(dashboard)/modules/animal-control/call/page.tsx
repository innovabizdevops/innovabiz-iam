...
const PAGE = "Call";
const KPIS = [{"l":"Total Animal Control","v":"7.242","t":"+9.4%","d":"up"},{"l":"Call Ativos","v":"8.558","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"77","t":"-1.5%","d":"down"}];
const COLS = ["ID","Call","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Control #001","Animal Control #002","6.957","3.376","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Control #002","Animal Control #003","5.384","7.591","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Control #003","Animal Control #004","4.042","2.242","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Control #004","Animal Control #005","7.322","8.744","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Control #005","Animal Control #001","2.110","2.695","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":619},{"label":"Mar","value":854},{"label":"Abr","value":583},{"label":"Mai","value":820},{"label":"Jun","value":725},{"label":"Jul","value":710},{"label":"Ago","value":570},{"label":"Set","value":573},{"label":"Out","value":841},{"label":"Nov","value":906},{"label":"Dez","value":561}];
const MX = 906;
