...
const ACCENT = "#6366f1";
const MODULE = "Animal Control";
const PAGE = "Bite Report";
const KPIS = [{"l":"Total Animal Control","v":"2.893","t":"+16.0%","d":"up"},{"l":"Bite Report Ativos","v":"8.485","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"73.2%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+0.9%","d":"up"}];
const COLS = ["ID","Bite Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Control #001","Animal Control #002","6.461","3.053","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Control #002","Animal Control #003","4.881","3.734","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Control #003","Animal Control #004","3.335","1.829","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Control #004","Animal Control #005","5.122","520","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Control #005","Animal Control #001","8.018","7.029","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":355},{"label":"Mar","value":501},{"label":"Abr","value":287},{"label":"Mai","value":582},{"label":"Jun","value":285},{"label":"Jul","value":587},{"label":"Ago","value":405},{"label":"Set","value":609},{"label":"Out","value":586},{"label":"Nov","value":602},{"label":"Dez","value":445}];
const MX = 609;
