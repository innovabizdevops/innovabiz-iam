...
const PAGE = "Adoption";
const KPIS = [{"l":"Configurações","v":"484","t":"+15.0%","d":"up"},{"l":"Últimas Alterações","v":"5.830","t":"+14.9%","d":"up"},{"l":"Ambientes","v":"3.501","t":"-2.2%","d":"down"},{"l":"Versão Config","v":"1.573","t":"+14.1%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 23492.39","3.154","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 9553.92","7.490","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 6063.54","5.013","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 3899.86","5.841","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 21033.65","8.153","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":1024},{"label":"Mar","value":836},{"label":"Abr","value":993},{"label":"Mai","value":1080},{"label":"Jun","value":778},{"label":"Jul","value":827},{"label":"Ago","value":912},{"label":"Set","value":921},{"label":"Out","value":720},{"label":"Nov","value":860},{"label":"Dez","value":1073}];
const MX = 1080;
