...
export default function PrCommsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pr Comms</h1><p className="text-sm text-muted-foreground">Pr Comms • iBOS Enterprise</p></div>
