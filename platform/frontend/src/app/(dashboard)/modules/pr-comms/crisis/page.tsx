...
const PAGE = "Crisis Comm";
const KPIS = [{"l":"Total Pr Comms","v":"5.757","t":"+5.7%","d":"up"},{"l":"Crisis Comm Ativos","v":"8.684","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"90.4%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"81","t":"-5.2%","d":"down"}];
const COLS = ["ID","Crisis Comm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pr Comms #001","Pr Comms #002","315","6.723","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Pr Comms #002","Pr Comms #003","6.052","8.500","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Pr Comms #003","Pr Comms #004","2.014","6.059","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Pr Comms #004","Pr Comms #005","3.180","6.825","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pr Comms #005","Pr Comms #001","326","8.567","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":857},{"label":"Mar","value":725},{"label":"Abr","value":859},{"label":"Mai","value":1027},{"label":"Jun","value":969},{"label":"Jul","value":989},{"label":"Ago","value":1043},{"label":"Set","value":1062},{"label":"Out","value":994},{"label":"Nov","value":826},{"label":"Dez","value":850}];
const MX = 1062;
