...
const ACCENT = "#3c5a7f";
const MODULE = "PR & Communications";
const PAGE = "Spokesperson";
const KPIS = [{"l":"Total Pr Comms","v":"5.303","t":"+15.0%","d":"up"},{"l":"Spokesperson Ativos","v":"133","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"68.3%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"90","t":"+6.8%","d":"up"}];
const COLS = ["ID","Spokesperson","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pr Comms #001","Pr Comms #002","6.303","7.142","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Pr Comms #002","Pr Comms #003","5.379","8.296","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Pr Comms #003","Pr Comms #004","6.817","3.795","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pr Comms #004","Pr Comms #005","2.287","3.207","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pr Comms #005","Pr Comms #001","7.702","7.061","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":488},{"label":"Mar","value":503},{"label":"Abr","value":638},{"label":"Mai","value":715},{"label":"Jun","value":519},{"label":"Jul","value":581},{"label":"Ago","value":622},{"label":"Set","value":594},{"label":"Out","value":623},{"label":"Nov","value":628},{"label":"Dez","value":715}];
const MX = 715;
