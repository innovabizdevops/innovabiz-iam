...
const PAGE = "Coverage Track";
const KPIS = [{"l":"Total Pr Comms","v":"8.824","t":"+14.2%","d":"up"},{"l":"Coverage Track Ativos","v":"6.437","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"88.0%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+14.7%","d":"up"}];
const COLS = ["ID","Coverage Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pr Comms #001","Pr Comms #002","1.139","3.480","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pr Comms #002","Pr Comms #003","4.957","2.296","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Pr Comms #003","Pr Comms #004","2.822","2.327","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Pr Comms #004","Pr Comms #005","1.296","8.619","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pr Comms #005","Pr Comms #001","6.235","1.307","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":685},{"label":"Mar","value":651},{"label":"Abr","value":594},{"label":"Mai","value":723},{"label":"Jun","value":500},{"label":"Jul","value":815},{"label":"Ago","value":724},{"label":"Set","value":678},{"label":"Out","value":723},{"label":"Nov","value":685},{"label":"Dez","value":877}];
const MX = 877;
