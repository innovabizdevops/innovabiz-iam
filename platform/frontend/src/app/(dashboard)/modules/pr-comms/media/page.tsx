...
const KPIS = [{"l":"Integrações Ativas","v":"5.842","t":"-1.8%","d":"down"},{"l":"Chamadas/Hora","v":"5095","t":"+12.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.3%","t":"+1.7%","d":"up"},{"l":"Latência Média (ms)","v":"82ms","t":"-4.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.927","4.528","75.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.450","952","72.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.098","5.348","99.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.008","7.094","93.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.301","8.651","88.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":772},{"label":"Mar","value":982},{"label":"Abr","value":862},{"label":"Mai","value":955},{"label":"Jun","value":1009},{"label":"Jul","value":708},{"label":"Ago","value":711},{"label":"Set","value":782},{"label":"Out","value":725},{"label":"Nov","value":914},{"label":"Dez","value":874}];
const MX = 1009;
