...
const ACCENT = "#6366f1";
const MODULE = "Fashion Technology";
const PAGE = "3D Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.244","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"2408","t":"-2.2%","d":"down"},{"l":"Documentos Gerados","v":"7.153","t":"+17.4%","d":"up"},{"l":"Templates","v":"5.862","t":"+14.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.210","2026-02-02","8.615","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.563","2026-01-28","5.100","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.275","2026-03-08","2.692","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.882","2026-02-12","1.995","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.402","2026-03-19","5.389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":744},{"label":"Mar","value":925},{"label":"Abr","value":805},{"label":"Mai","value":962},{"label":"Jun","value":826},{"label":"Jul","value":924},{"label":"Ago","value":856},{"label":"Set","value":962},{"label":"Out","value":764},{"label":"Nov","value":1000},{"label":"Dez","value":705}];
const MX = 1000;
