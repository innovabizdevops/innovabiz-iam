...
const PAGE = "Virtual Try";
const KPIS = [{"l":"Total Fashion Tech","v":"4.053","t":"+14.6%","d":"up"},{"l":"Virtual Try Ativos","v":"7.259","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+9.3%","d":"up"}];
const COLS = ["ID","Virtual Try","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion Tech #001","Fashion Tech #002","8.094","5.315","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion Tech #002","Fashion Tech #003","799","3.205","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion Tech #003","Fashion Tech #004","7.800","3.380","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion Tech #004","Fashion Tech #005","8.246","8.082","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion Tech #005","Fashion Tech #001","455","3.275","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":549},{"label":"Mar","value":713},{"label":"Abr","value":483},{"label":"Mai","value":646},{"label":"Jun","value":665},{"label":"Jul","value":633},{"label":"Ago","value":694},{"label":"Set","value":652},{"label":"Out","value":475},{"label":"Nov","value":440},{"label":"Dez","value":466}];
const MX = 735;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>AR</span></h1>
                </div>
