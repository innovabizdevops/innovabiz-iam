...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"4.769","t":"+2.1%","d":"up"},{"l":"Queries/Dia","v":"991","t":"+4.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.518","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"2.448","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","793","2026-02-05","6.079","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3284","2026-03-23","5.551","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4087","2026-02-19","1.440","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3714","2026-03-12","7.721","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1389","2026-01-07","4.810","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":230},{"label":"Fev","value":387},{"label":"Mar","value":249},{"label":"Abr","value":415},{"label":"Mai","value":334},{"label":"Jun","value":325},{"label":"Jul","value":310},{"label":"Ago","value":548},{"label":"Set","value":357},{"label":"Out","value":227},{"label":"Nov","value":245},{"label":"Dez","value":276}];
const MX = 548;
