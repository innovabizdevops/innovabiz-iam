...
const PAGE = "Downtime";
const KPIS = [{"l":"Dashboards Ativos","v":"8.866","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"1132","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.205","t":"+1.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.160","t":"+4.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4735","2026-03-06","2.757","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1231","2026-03-07","7.648","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1659","2026-02-03","972","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4689","2026-01-10","1.498","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4028","2026-01-22","3.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":805},{"label":"Mar","value":783},{"label":"Abr","value":797},{"label":"Mai","value":581},{"label":"Jun","value":536},{"label":"Jul","value":623},{"label":"Ago","value":706},{"label":"Set","value":868},{"label":"Out","value":861},{"label":"Nov","value":724},{"label":"Dez","value":622}];
const MX = 868;
