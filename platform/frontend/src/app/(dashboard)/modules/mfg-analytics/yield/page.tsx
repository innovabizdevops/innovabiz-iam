...
const PAGE = "Yield";
const KPIS = [{"l":"Dashboards Ativos","v":"6.209","t":"+2.7%","d":"up"},{"l":"Queries/Dia","v":"1584","t":"+16.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.780","t":"+15.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.160","t":"-3.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3817","2026-03-20","177","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2642","2026-02-20","2.266","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1329","2026-01-01","8.594","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1831","2026-03-03","6.637","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","840","2026-02-06","2.520","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":272},{"label":"Mar","value":506},{"label":"Abr","value":499},{"label":"Mai","value":460},{"label":"Jun","value":397},{"label":"Jul","value":422},{"label":"Ago","value":453},{"label":"Set","value":583},{"label":"Out","value":409},{"label":"Nov","value":647},{"label":"Dez","value":267}];
const MX = 647;
