...
const ACCENT = "#6366f1";
const MODULE = "Manufacturing Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"7.811","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"539","t":"-4.2%","d":"down"},{"l":"Dados Processados (GB)","v":"7.767","t":"+17.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.295","t":"+5.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1873","2026-03-09","8.068","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2498","2026-02-06","7.944","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3471","2026-01-20","5.822","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4245","2026-01-22","2.004","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2540","2026-01-21","1.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1049},{"label":"Fev","value":859},{"label":"Mar","value":1046},{"label":"Abr","value":998},{"label":"Mai","value":771},{"label":"Jun","value":887},{"label":"Jul","value":1002},{"label":"Ago","value":1000},{"label":"Set","value":830},{"label":"Out","value":991},{"label":"Nov","value":1007},{"label":"Dez","value":990}];
const MX = 1049;
