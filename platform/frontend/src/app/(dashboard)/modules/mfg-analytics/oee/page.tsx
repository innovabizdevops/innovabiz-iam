...
const PAGE = "OEE";
const KPIS = [{"l":"Dashboards Ativos","v":"1.163","t":"+10.9%","d":"up"},{"l":"Queries/Dia","v":"1375","t":"+2.9%","d":"up"},{"l":"Dados Processados (GB)","v":"8.103","t":"+15.2%","d":"up"},{"l":"Utilizadores Analytics","v":"6.266","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4363","2026-01-20","2.196","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2674","2026-03-14","5.404","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3366","2026-02-15","1.542","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1917","2026-02-21","5.001","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3360","2026-01-24","3.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":535},{"label":"Mar","value":864},{"label":"Abr","value":596},{"label":"Mai","value":614},{"label":"Jun","value":639},{"label":"Jul","value":499},{"label":"Ago","value":719},{"label":"Set","value":733},{"label":"Out","value":616},{"label":"Nov","value":681},{"label":"Dez","value":849}];
const MX = 864;
