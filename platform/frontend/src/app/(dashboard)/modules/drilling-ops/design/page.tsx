...
const ACCENT = "#6366f1";
const MODULE = "Drilling Operations";
const PAGE = "Well Design";
const KPIS = [{"l":"Formulários Ativos","v":"155","t":"+16.3%","d":"up"},{"l":"Submissões/Dia","v":"5091","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"2.500","t":"-2.3%","d":"down"},{"l":"Templates","v":"2.282","t":"-0.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.113","2026-03-02","6.018","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.933","2026-03-12","3.861","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.281","2026-02-15","2.035","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.127","2026-03-06","8.434","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.351","2026-01-02","5.299","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":380},{"label":"Mar","value":512},{"label":"Abr","value":640},{"label":"Mai","value":358},{"label":"Jun","value":381},{"label":"Jul","value":595},{"label":"Ago","value":516},{"label":"Set","value":395},{"label":"Out","value":369},{"label":"Nov","value":713},{"label":"Dez","value":424}];
const MX = 713;
