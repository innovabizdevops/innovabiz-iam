...
const PAGE = "Safety";
const KPIS = [{"l":"Total Drilling Ops","v":"655","t":"-1.1%","d":"down"},{"l":"Safety Ativos","v":"4.522","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"67","t":"+5.8%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drilling Ops #001","Drilling Ops #002","4.287","2.459","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Drilling Ops #002","Drilling Ops #003","4.310","6.291","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Drilling Ops #003","Drilling Ops #004","444","5.429","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Drilling Ops #004","Drilling Ops #005","3.396","5.635","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drilling Ops #005","Drilling Ops #001","7.332","8.844","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":948},{"label":"Mar","value":998},{"label":"Abr","value":788},{"label":"Mai","value":907},{"label":"Jun","value":1023},{"label":"Jul","value":787},{"label":"Ago","value":990},{"label":"Set","value":712},{"label":"Out","value":778},{"label":"Nov","value":938},{"label":"Dez","value":1004}];
const MX = 1023;
