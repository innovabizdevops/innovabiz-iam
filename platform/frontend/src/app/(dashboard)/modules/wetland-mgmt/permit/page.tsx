...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"766","t":"-3.5%","d":"down"},{"l":"Mitigações Ativas","v":"2.553","t":"-2.4%","d":"down"},{"l":"Score Risco Geral","v":"92","t":"+13.4%","d":"up"},{"l":"Incidentes YTD","v":"3.854","t":"+15.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","598","5.895","1.886","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.565","4.332","1.488","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.869","2.300","1.821","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.847","2.655","1.155","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.598","5.991","8.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":312},{"label":"Mar","value":649},{"label":"Abr","value":411},{"label":"Mai","value":462},{"label":"Jun","value":426},{"label":"Jul","value":453},{"label":"Ago","value":660},{"label":"Set","value":327},{"label":"Out","value":301},{"label":"Nov","value":400},{"label":"Dez","value":392}];
const MX = 660;
