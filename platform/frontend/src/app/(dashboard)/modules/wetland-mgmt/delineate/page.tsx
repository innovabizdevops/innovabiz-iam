...
const ACCENT = "#6366f1";
const MODULE = "Wetland Management";
const PAGE = "Delineate";
const KPIS = [{"l":"Dashboards Ativos","v":"5.589","t":"+13.0%","d":"up"},{"l":"Queries/Dia","v":"2296","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"1.920","t":"+9.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.420","t":"+9.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3585","2026-01-23","927","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4548","2026-01-25","4.529","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2565","2026-02-17","6.440","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4068","2026-02-07","5.446","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4453","2026-01-23","3.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":805},{"label":"Mar","value":744},{"label":"Abr","value":892},{"label":"Mai","value":768},{"label":"Jun","value":847},{"label":"Jul","value":596},{"label":"Ago","value":897},{"label":"Set","value":912},{"label":"Out","value":831},{"label":"Nov","value":680},{"label":"Dez","value":744}];
const MX = 912;
