...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"8.338","t":"-2.7%","d":"down"},{"l":"Queries/Dia","v":"4000","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.855","t":"+5.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.620","t":"+16.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4906","2026-01-08","6.713","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","538","2026-01-06","5.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","793","2026-02-05","6.471","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","232","2026-02-02","5.735","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3240","2026-03-04","6.535","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":532},{"label":"Mar","value":731},{"label":"Abr","value":885},{"label":"Mai","value":852},{"label":"Jun","value":616},{"label":"Jul","value":759},{"label":"Ago","value":876},{"label":"Set","value":849},{"label":"Out","value":865},{"label":"Nov","value":561},{"label":"Dez","value":570}];
const MX = 885;
