...
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"705","t":"-4.6%","d":"down"},{"l":"Queries/Dia","v":"2539","t":"-5.5%","d":"down"},{"l":"Dados Processados (GB)","v":"3.285","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"4.014","t":"+12.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","387","2026-01-18","8.732","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3749","2026-01-21","4.430","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1046","2026-03-25","2.276","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1994","2026-01-12","7.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","283","2026-03-20","8.797","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":398},{"label":"Mar","value":456},{"label":"Abr","value":600},{"label":"Mai","value":671},{"label":"Jun","value":647},{"label":"Jul","value":444},{"label":"Ago","value":391},{"label":"Set","value":398},{"label":"Out","value":694},{"label":"Nov","value":630},{"label":"Dez","value":416}];
const MX = 711;
