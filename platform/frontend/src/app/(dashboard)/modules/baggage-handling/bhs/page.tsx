...
const PAGE = "BHS Monitor";
const KPIS = [{"l":"Total Baggage Handling","v":"1.939","t":"-2.0%","d":"down"},{"l":"BHS Monitor Ativos","v":"5.433","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"76","t":"-3.8%","d":"down"}];
const COLS = ["ID","BHS Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Baggage Handling #001","Baggage Handling #002","1.537","1.754","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Baggage Handling #002","Baggage Handling #003","1.028","2.856","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Baggage Handling #003","Baggage Handling #004","6.850","6.227","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Baggage Handling #004","Baggage Handling #005","3.689","5.851","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Baggage Handling #005","Baggage Handling #001","6.206","6.925","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":551},{"label":"Mar","value":673},{"label":"Abr","value":450},{"label":"Mai","value":528},{"label":"Jun","value":623},{"label":"Jul","value":723},{"label":"Ago","value":665},{"label":"Set","value":365},{"label":"Out","value":731},{"label":"Nov","value":507},{"label":"Dez","value":467}];
const MX = 731;
