...
export default function BaggageHandlingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Baggage Handling</h1><p className="text-sm text-muted-foreground">Baggage Handling • iBOS Enterprise</p></div>
