...
const KPIS = [{"l":"Total Baggage Handling","v":"3.964","t":"-0.7%","d":"down"},{"l":"Reconcile Ativos","v":"3.123","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"88.6%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"63","t":"+8.0%","d":"up"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Baggage Handling #001","Baggage Handling #002","5.451","2.437","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Baggage Handling #002","Baggage Handling #003","8.176","5.168","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Baggage Handling #003","Baggage Handling #004","5.086","5.299","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Baggage Handling #004","Baggage Handling #005","5.408","1.766","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Baggage Handling #005","Baggage Handling #001","9.042","3.558","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":627},{"label":"Mar","value":522},{"label":"Abr","value":416},{"label":"Mai","value":614},{"label":"Jun","value":562},{"label":"Jul","value":717},{"label":"Ago","value":598},{"label":"Set","value":509},{"label":"Out","value":757},{"label":"Nov","value":759},{"label":"Dez","value":496}];
const MX = 759;
