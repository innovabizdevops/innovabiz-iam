...
const ACCENT = "#059669";
const MODULE = "Baggage Handling";
const PAGE = "Track Display";
const KPIS = [{"l":"Total Baggage Handling","v":"4.584","t":"-1.1%","d":"down"},{"l":"Track Display Ativos","v":"7.054","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"87.4%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"64","t":"-3.2%","d":"down"}];
const COLS = ["ID","Track Display","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Baggage Handling #001","Baggage Handling #002","3.865","4.594","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Baggage Handling #002","Baggage Handling #003","4.355","4.399","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Baggage Handling #003","Baggage Handling #004","4.529","5.469","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Baggage Handling #004","Baggage Handling #005","9.073","3.607","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Baggage Handling #005","Baggage Handling #001","223","4.259","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":437},{"label":"Mar","value":549},{"label":"Abr","value":581},{"label":"Mai","value":680},{"label":"Jun","value":636},{"label":"Jul","value":783},{"label":"Ago","value":722},{"label":"Set","value":564},{"label":"Out","value":595},{"label":"Nov","value":496},{"label":"Dez","value":624}];
const MX = 783;
