...
const PAGE = "Record";
const KPIS = [{"l":"Total Cemetery Mgmt","v":"7.429","t":"-0.4%","d":"down"},{"l":"Record Ativos","v":"135","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"91","t":"-0.1%","d":"down"}];
const COLS = ["ID","Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cemetery Mgmt #001","Cemetery Mgmt #002","4.578","6.954","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Cemetery Mgmt #002","Cemetery Mgmt #003","3.263","3.516","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cemetery Mgmt #003","Cemetery Mgmt #004","2.632","734","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Cemetery Mgmt #004","Cemetery Mgmt #005","5.989","8.007","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cemetery Mgmt #005","Cemetery Mgmt #001","4.398","8.354","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":791},{"label":"Mar","value":851},{"label":"Abr","value":566},{"label":"Mai","value":533},{"label":"Jun","value":659},{"label":"Jul","value":483},{"label":"Ago","value":492},{"label":"Set","value":760},{"label":"Out","value":549},{"label":"Nov","value":558},{"label":"Dez","value":758}];
const MX = 851;
