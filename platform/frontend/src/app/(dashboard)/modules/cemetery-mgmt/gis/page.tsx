...
const ACCENT = "#374151";
const MODULE = "Cemetery Management";
const PAGE = "GIS";
const KPIS = [{"l":"Total Cemetery Mgmt","v":"990","t":"+16.9%","d":"up"},{"l":"GIS Ativos","v":"8.740","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"62","t":"-1.7%","d":"down"}];
const COLS = ["ID","GIS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cemetery Mgmt #001","Cemetery Mgmt #002","5.956","8.955","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Cemetery Mgmt #002","Cemetery Mgmt #003","8.166","6.965","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Cemetery Mgmt #003","Cemetery Mgmt #004","1.929","6.320","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Cemetery Mgmt #004","Cemetery Mgmt #005","473","7.717","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cemetery Mgmt #005","Cemetery Mgmt #001","1.957","601","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":622},{"label":"Mar","value":807},{"label":"Abr","value":752},{"label":"Mai","value":800},{"label":"Jun","value":873},{"label":"Jul","value":817},{"label":"Ago","value":811},{"label":"Set","value":649},{"label":"Out","value":945},{"label":"Nov","value":703},{"label":"Dez","value":744}];
const MX = 945;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#374151'}}>GIS</span></h1>
                </div>
