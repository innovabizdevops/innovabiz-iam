...
const PAGE = "Memorial";
const KPIS = [{"l":"Total Cemetery Mgmt","v":"5.111","t":"+8.8%","d":"up"},{"l":"Memorial Ativos","v":"4.696","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"84","t":"-3.2%","d":"down"}];
const COLS = ["ID","Memorial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cemetery Mgmt #001","Cemetery Mgmt #002","8.494","3.370","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cemetery Mgmt #002","Cemetery Mgmt #003","3.277","1.164","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cemetery Mgmt #003","Cemetery Mgmt #004","1.200","8.738","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cemetery Mgmt #004","Cemetery Mgmt #005","5.183","1.696","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cemetery Mgmt #005","Cemetery Mgmt #001","1.887","5.730","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":846},{"label":"Mar","value":1039},{"label":"Abr","value":1002},{"label":"Mai","value":757},{"label":"Jun","value":973},{"label":"Jul","value":850},{"label":"Ago","value":899},{"label":"Set","value":824},{"label":"Out","value":912},{"label":"Nov","value":952},{"label":"Dez","value":760}];
const MX = 1039;
