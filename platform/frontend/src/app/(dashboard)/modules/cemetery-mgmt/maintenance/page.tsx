...
const KPIS = [{"l":"Total Cemetery Mgmt","v":"2.256","t":"+2.7%","d":"up"},{"l":"Maintenance Ativos","v":"4.673","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"81","t":"+4.1%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cemetery Mgmt #001","Cemetery Mgmt #002","5.477","4.239","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Cemetery Mgmt #002","Cemetery Mgmt #003","2.834","1.472","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cemetery Mgmt #003","Cemetery Mgmt #004","360","3.978","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Cemetery Mgmt #004","Cemetery Mgmt #005","5.125","6.809","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cemetery Mgmt #005","Cemetery Mgmt #001","2.164","3.405","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":547},{"label":"Mar","value":461},{"label":"Abr","value":607},{"label":"Mai","value":305},{"label":"Jun","value":290},{"label":"Jul","value":477},{"label":"Ago","value":623},{"label":"Set","value":448},{"label":"Out","value":435},{"label":"Nov","value":609},{"label":"Dez","value":404}];
const MX = 623;
