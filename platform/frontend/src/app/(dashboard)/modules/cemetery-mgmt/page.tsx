...
export default function CemeteryMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Cemetery Mgmt</h1><p className="text-sm text-muted-foreground">Cemetery Mgmt • iBOS</p></div>
