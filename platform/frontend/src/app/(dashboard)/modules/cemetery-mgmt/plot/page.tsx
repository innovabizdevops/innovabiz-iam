...
const PAGE = "Plot";
const KPIS = [{"l":"Total Cemetery Mgmt","v":"1.086","t":"+15.3%","d":"up"},{"l":"Plot Ativos","v":"2.076","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"92","t":"+3.8%","d":"up"}];
const COLS = ["ID","Plot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cemetery Mgmt #001","Cemetery Mgmt #002","1.305","3.920","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cemetery Mgmt #002","Cemetery Mgmt #003","6.124","3.184","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Cemetery Mgmt #003","Cemetery Mgmt #004","934","7.127","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Cemetery Mgmt #004","Cemetery Mgmt #005","3.598","3.893","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cemetery Mgmt #005","Cemetery Mgmt #001","143","3.746","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":639},{"label":"Mar","value":661},{"label":"Abr","value":713},{"label":"Mai","value":597},{"label":"Jun","value":488},{"label":"Jul","value":594},{"label":"Ago","value":531},{"label":"Set","value":658},{"label":"Out","value":608},{"label":"Nov","value":636},{"label":"Dez","value":516}];
const MX = 713;
