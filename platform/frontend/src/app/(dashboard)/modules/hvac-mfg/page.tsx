...
/* ═══ HVAC Manufacturing — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "188", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1921", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€296K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1507374088", cells: ["HVA-1088", "HVAC Manufacturing Item 1", "25/5/2026", "€24 188"], status: "active" as const },
    { id: "1507377659", cells: ["HVA-4659", "HVAC Manufacturing Item 2", "12/12/2026", "€27 759"], status: "pending" as const },
    { id: "1507381230", cells: ["HVA-8230", "HVAC Manufacturing Item 3", "27/7/2026", "€31 330"], status: "completed" as const },
    { id: "1507384801", cells: ["HVA-2801", "HVAC Manufacturing Item 4", "14/2/2026", "€34 901"], status: "warning" as const },
    { id: "1507388372", cells: ["HVA-6372", "HVAC Manufacturing Item 5", "1/9/2026", "€38 472"], status: "active" as const },
];
...
export default function HvacManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HVAC Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HVAC Manufacturing</p>
                    </div>
                </div>
