...
const ACCENT = "#0284c7";
const MODULE = "HVAC Manufacturing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.352","t":"+10.1%","d":"up"},{"l":"Submissões/Dia","v":"1538","t":"+3.2%","d":"up"},{"l":"Documentos Gerados","v":"417","t":"+8.7%","d":"up"},{"l":"Templates","v":"6.298","t":"+8.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.432","2026-03-15","864","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.287","2026-01-27","4.610","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.807","2026-02-09","6.839","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.857","2026-03-28","121","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.776","2026-02-05","8.916","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":666},{"label":"Mar","value":536},{"label":"Abr","value":798},{"label":"Mai","value":666},{"label":"Jun","value":794},{"label":"Jul","value":753},{"label":"Ago","value":779},{"label":"Set","value":593},{"label":"Out","value":821},{"label":"Nov","value":757},{"label":"Dez","value":828}];
const MX = 828;
