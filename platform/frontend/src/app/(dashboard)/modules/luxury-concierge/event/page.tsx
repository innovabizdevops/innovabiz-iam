...
const PAGE = "Event";
const KPIS = [{"l":"Quartos Ocupados","v":"7.877","t":"+1.0%","d":"up"},{"l":"RevPAR (€)","v":"€25707","t":"+10.1%","d":"up"},{"l":"Ocupação (%)","v":"66.9%","t":"+16.9%","d":"up"},{"l":"Guest Satisfaction","v":"6.201","t":"+11.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.180","2026-03-09","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","450","2026-03-15","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.195","2026-03-21","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","541","2026-01-19","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.401","2026-01-08","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":579},{"label":"Mar","value":367},{"label":"Abr","value":663},{"label":"Mai","value":520},{"label":"Jun","value":388},{"label":"Jul","value":601},{"label":"Ago","value":483},{"label":"Set","value":448},{"label":"Out","value":403},{"label":"Nov","value":674},{"label":"Dez","value":717}];
const MX = 717;
