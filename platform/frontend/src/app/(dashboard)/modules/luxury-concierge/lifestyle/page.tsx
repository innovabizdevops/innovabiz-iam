...
const KPIS = [{"l":"Quartos Ocupados","v":"2.796","t":"-0.1%","d":"down"},{"l":"RevPAR (€)","v":"€20473","t":"+2.5%","d":"up"},{"l":"Ocupação (%)","v":"81.8%","t":"+14.8%","d":"up"},{"l":"Guest Satisfaction","v":"5.264","t":"+0.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.506","2026-02-15","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.133","2026-01-08","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","460","2026-02-19","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","661","2026-01-28","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.456","2026-03-22","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":946},{"label":"Mar","value":734},{"label":"Abr","value":889},{"label":"Mai","value":945},{"label":"Jun","value":753},{"label":"Jul","value":646},{"label":"Ago","value":901},{"label":"Set","value":1022},{"label":"Out","value":747},{"label":"Nov","value":702},{"label":"Dez","value":706}];
const MX = 1022;
