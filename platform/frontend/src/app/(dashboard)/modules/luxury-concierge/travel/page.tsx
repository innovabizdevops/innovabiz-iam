...
const ACCENT = "#92400e";
const MODULE = "Luxury Concierge";
const PAGE = "Travel";
const KPIS = [{"l":"Quartos Ocupados","v":"727","t":"+4.0%","d":"up"},{"l":"RevPAR (€)","v":"€70943","t":"-0.3%","d":"down"},{"l":"Ocupação (%)","v":"66.5%","t":"+8.7%","d":"up"},{"l":"Guest Satisfaction","v":"6.754","t":"+9.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.513","2026-03-17","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.330","2026-03-01","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.517","2026-01-27","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.300","2026-01-16","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.616","2026-03-19","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":497},{"label":"Mar","value":602},{"label":"Abr","value":582},{"label":"Mai","value":713},{"label":"Jun","value":483},{"label":"Jul","value":374},{"label":"Ago","value":422},{"label":"Set","value":658},{"label":"Out","value":573},{"label":"Nov","value":718},{"label":"Dez","value":448}];
const MX = 718;
