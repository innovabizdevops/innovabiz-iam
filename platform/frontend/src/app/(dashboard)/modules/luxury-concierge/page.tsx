...
const KPIS = [
    ...
    { label: "Ativos", value: "4691", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€350K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1519311334", cells: ["LUX-4334", "Luxury Concierge Item 1", "3/11/2026", "€11 434"], status: "active" as const },
    { id: "1519314905", cells: ["LUX-7905", "Luxury Concierge Item 2", "18/6/2026", "€15 005"], status: "pending" as const },
    { id: "1519318476", cells: ["LUX-2476", "Luxury Concierge Item 3", "5/1/2026", "€18 576"], status: "completed" as const },
    { id: "1519322047", cells: ["LUX-6047", "Luxury Concierge Item 4", "20/8/2026", "€22 147"], status: "warning" as const },
    { id: "1519325618", cells: ["LUX-9618", "Luxury Concierge Item 5", "7/3/2026", "€25 718"], status: "active" as const },
];
...
export default function LuxuryConciergePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Luxury Concierge</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Luxury Concierge</p>
                    </div>
                </div>
