...
const PAGE = "Flight Board";
const KPIS = [{"l":"Teams Ativos","v":"3.407","t":"+7.8%","d":"up"},{"l":"Reuniões/Semana","v":"2210","t":"-1.6%","d":"down"},{"l":"Mensagens/Dia","v":"2532","t":"+14.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.627","t":"+8.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.742","1962","2.464","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.104","2423","5.567","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.078","4333","6.503","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.271","1985","2.054","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.104","2545","8.824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":681},{"label":"Mar","value":776},{"label":"Abr","value":525},{"label":"Mai","value":573},{"label":"Jun","value":470},{"label":"Jul","value":679},{"label":"Ago","value":506},{"label":"Set","value":821},{"label":"Out","value":498},{"label":"Nov","value":726},{"label":"Dez","value":465}];
const MX = 821;
