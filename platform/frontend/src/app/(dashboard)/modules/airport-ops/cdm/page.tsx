...
const PAGE = "CDM Platform";
const KPIS = [{"l":"Formulários Ativos","v":"4.972","t":"+1.0%","d":"up"},{"l":"Submissões/Dia","v":"4793","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"203","t":"-4.7%","d":"down"},{"l":"Templates","v":"1.430","t":"+5.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.038","2026-02-07","425","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.319","2026-02-03","9.041","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","686","2026-02-16","5.864","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.744","2026-02-14","5.908","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.616","2026-02-02","1.683","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":668},{"label":"Mar","value":521},{"label":"Abr","value":476},{"label":"Mai","value":720},{"label":"Jun","value":680},{"label":"Jul","value":759},{"label":"Ago","value":410},{"label":"Set","value":744},{"label":"Out","value":597},{"label":"Nov","value":617},{"label":"Dez","value":399}];
const MX = 759;
