...
const ACCENT = "#7dd3fc";
const MODULE = "Airport Operations";
const PAGE = "A-SMGCS";
const KPIS = [{"l":"Total Airport Ops","v":"5.107","t":"+8.0%","d":"up"},{"l":"A SMGCS Ativos","v":"7.203","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"84","t":"-0.7%","d":"down"}];
const COLS = ["ID","A SMGCS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Ops #001","Airport Ops #002","6.845","8.192","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Ops #002","Airport Ops #003","3.679","3.093","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Ops #003","Airport Ops #004","7.719","5.965","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Ops #004","Airport Ops #005","1.392","4.987","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Ops #005","Airport Ops #001","626","1.935","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":248},{"label":"Mar","value":361},{"label":"Abr","value":559},{"label":"Mai","value":353},{"label":"Jun","value":460},{"label":"Jul","value":379},{"label":"Ago","value":548},{"label":"Set","value":527},{"label":"Out","value":406},{"label":"Nov","value":490},{"label":"Dez","value":300}];
const MX = 599;
...
export default function AsmgcsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7dd3fc'}}>AI</span></h1>
                </div>
