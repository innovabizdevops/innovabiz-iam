...
const PAGE = "Feed";
const KPIS = [{"l":"Embarcações Ativas","v":"6.569","t":"+1.4%","d":"up"},{"l":"Capturas (ton)","v":"4001","t":"-5.0%","d":"down"},{"l":"Quota Utilizada (%)","v":"66.0%","t":"+13.0%","d":"up"},{"l":"Certificações","v":"7.242","t":"-0.1%","d":"down"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","4659","4.274","99.8%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","2049","6.967","71.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","329","5.494","90.6%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","3752","3.212","85.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","4080","4.256","95.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":741},{"label":"Mar","value":608},{"label":"Abr","value":752},{"label":"Mai","value":599},{"label":"Jun","value":619},{"label":"Jul","value":479},{"label":"Ago","value":540},{"label":"Set","value":706},{"label":"Out","value":548},{"label":"Nov","value":742},{"label":"Dez","value":727}];
const MX = 752;
