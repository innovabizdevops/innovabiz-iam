...
const PAGE = "Pond Mgmt";
const KPIS = [{"l":"Embarcações Ativas","v":"5.277","t":"-5.0%","d":"down"},{"l":"Capturas (ton)","v":"446","t":"+12.8%","d":"up"},{"l":"Quota Utilizada (%)","v":"77.8%","t":"+1.1%","d":"up"},{"l":"Certificações","v":"5.649","t":"+3.1%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","4147","5.927","77.5%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","5058","3.789","83.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","380","2.753","95.9%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","2160","2.762","95.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","4366","2.418","90.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":549},{"label":"Mar","value":399},{"label":"Abr","value":410},{"label":"Mai","value":604},{"label":"Jun","value":464},{"label":"Jul","value":443},{"label":"Ago","value":322},{"label":"Set","value":402},{"label":"Out","value":423},{"label":"Nov","value":367},{"label":"Dez","value":324}];
const MX = 604;
