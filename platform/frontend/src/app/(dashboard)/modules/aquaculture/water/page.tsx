...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.758","t":"+17.4%","d":"up"},{"l":"NC Abertas","v":"192","t":"+5.6%","d":"up"},{"l":"Conformidade (%)","v":"83.2%","t":"-4.9%","d":"down"},{"l":"CAPAs Pendentes","v":"1.819","t":"+1.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.499","75.8%","1.365","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.189","72.0%","2.534","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.015","86.9%","3.658","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.192","73.3%","8.869","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.551","87.3%","410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":559},{"label":"Mar","value":593},{"label":"Abr","value":828},{"label":"Mai","value":669},{"label":"Jun","value":807},{"label":"Jul","value":675},{"label":"Ago","value":857},{"label":"Set","value":739},{"label":"Out","value":539},{"label":"Nov","value":844},{"label":"Dez","value":785}];
const MX = 857;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#14532d'}}>IoT</span></h1>
                </div>
