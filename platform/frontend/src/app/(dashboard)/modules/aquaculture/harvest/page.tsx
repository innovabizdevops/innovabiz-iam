...
const PAGE = "Harvest";
const KPIS = [{"l":"Embarcações Ativas","v":"3.664","t":"-0.5%","d":"down"},{"l":"Capturas (ton)","v":"2544","t":"+2.5%","d":"up"},{"l":"Quota Utilizada (%)","v":"92.9%","t":"+10.2%","d":"up"},{"l":"Certificações","v":"248","t":"+10.6%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","3659","618","91.2%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","4415","7.510","71.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","2154","3.400","94.0%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","3482","6.935","71.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","496","7.225","71.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":601},{"label":"Mar","value":367},{"label":"Abr","value":433},{"label":"Mai","value":561},{"label":"Jun","value":473},{"label":"Jul","value":262},{"label":"Ago","value":382},{"label":"Set","value":255},{"label":"Out","value":348},{"label":"Nov","value":410},{"label":"Dez","value":554}];
const MX = 601;
