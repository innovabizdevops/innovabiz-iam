...
const PAGE = "Disease";
const KPIS = [{"l":"Embarcações Ativas","v":"7.996","t":"+15.6%","d":"up"},{"l":"Capturas (ton)","v":"818","t":"+3.3%","d":"up"},{"l":"Quota Utilizada (%)","v":"66.8%","t":"+12.3%","d":"up"},{"l":"Certificações","v":"692","t":"-2.8%","d":"down"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","4478","1.158","81.9%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","3862","7.060","98.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3585","7.004","77.3%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","4113","117","85.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","411","6.286","78.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":1006},{"label":"Mar","value":1007},{"label":"Abr","value":1019},{"label":"Mai","value":882},{"label":"Jun","value":802},{"label":"Jul","value":871},{"label":"Ago","value":664},{"label":"Set","value":781},{"label":"Out","value":681},{"label":"Nov","value":905},{"label":"Dez","value":789}];
const MX = 1019;
