...
const ACCENT = "#6366f1";
const MODULE = "Retail Media";
const PAGE = "Search Ads";
const KPIS = [{"l":"Pedidos/Dia","v":"607","t":"+15.5%","d":"up"},{"l":"GMV (€)","v":"€50088","t":"+10.5%","d":"up"},{"l":"Conversão (%)","v":"95.0%","t":"+16.8%","d":"up"},{"l":"AOV (€)","v":"€87419","t":"+3.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43271.67","1.290","8.454","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 12975.18","3.802","8.612","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 17172.71","4.755","4.398","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 32940.97","4.623","8.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 4864.20","1.609","4.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":689},{"label":"Mar","value":541},{"label":"Abr","value":551},{"label":"Mai","value":867},{"label":"Jun","value":762},{"label":"Jul","value":683},{"label":"Ago","value":640},{"label":"Set","value":867},{"label":"Out","value":604},{"label":"Nov","value":838},{"label":"Dez","value":623}];
const MX = 867;
