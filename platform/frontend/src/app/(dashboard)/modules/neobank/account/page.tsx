...
const PAGE = "Account";
const KPIS = [{"l":"Total Neobank","v":"6.081","t":"+11.0%","d":"up"},{"l":"Account Ativos","v":"189","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"63","t":"+13.8%","d":"up"}];
const COLS = ["ID","Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neobank #001","Neobank #002","8.635","7.203","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Neobank #002","Neobank #003","8.414","7.380","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Neobank #003","Neobank #004","1.570","7.353","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Neobank #004","Neobank #005","5.652","1.747","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neobank #005","Neobank #001","7.042","7.936","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":556},{"label":"Mar","value":470},{"label":"Abr","value":516},{"label":"Mai","value":514},{"label":"Jun","value":789},{"label":"Jul","value":758},{"label":"Ago","value":642},{"label":"Set","value":659},{"label":"Out","value":467},{"label":"Nov","value":588},{"label":"Dez","value":496}];
const MX = 789;
