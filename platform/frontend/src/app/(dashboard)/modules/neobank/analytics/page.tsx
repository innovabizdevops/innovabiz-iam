...
const ACCENT = "#6366f1";
const MODULE = "Neobank Platform";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.606","t":"+1.7%","d":"up"},{"l":"Queries/Dia","v":"2766","t":"+0.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.590","t":"+8.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.057","t":"+0.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2707","2026-01-02","2.906","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","277","2026-01-17","1.840","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1452","2026-02-15","5.215","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","344","2026-03-09","5.330","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","764","2026-01-20","3.987","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":662},{"label":"Mar","value":1034},{"label":"Abr","value":678},{"label":"Mai","value":990},{"label":"Jun","value":913},{"label":"Jul","value":693},{"label":"Ago","value":994},{"label":"Set","value":913},{"label":"Out","value":960},{"label":"Nov","value":842},{"label":"Dez","value":871}];
const MX = 1034;
