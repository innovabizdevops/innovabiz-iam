...
const PAGE = "Savings";
const KPIS = [{"l":"Total Neobank","v":"6.458","t":"+4.3%","d":"up"},{"l":"Savings Ativos","v":"€93714","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"81","t":"+15.5%","d":"up"}];
const COLS = ["ID","Savings","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Neobank #001","€ 32925.83","4.805","7.984","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Neobank #002","€ 40311.28","8.895","6.994","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Neobank #003","€ 30280.85","1.464","3.979","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Neobank #004","€ 10337.81","6.337","5.535","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Neobank #005","€ 24383.26","2.974","8.544","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":862},{"label":"Mar","value":851},{"label":"Abr","value":1002},{"label":"Mai","value":728},{"label":"Jun","value":899},{"label":"Jul","value":869},{"label":"Ago","value":895},{"label":"Set","value":821},{"label":"Out","value":947},{"label":"Nov","value":990},{"label":"Dez","value":758}];
const MX = 1002;
