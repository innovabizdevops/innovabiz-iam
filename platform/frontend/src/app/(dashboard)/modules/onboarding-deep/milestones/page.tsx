...
const PAGE = "30-60-90";
const KPIS = [{"l":"eNPS","v":"86","t":"+0.9%","d":"up"},{"l":"Engagement (%)","v":"94.0%","t":"+5.7%","d":"up"},{"l":"Turnover (%)","v":"94.5%","t":"+2.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.914","t":"+2.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.799","2026-03-27","90","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.912","2026-02-05","90","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","465","2026-01-28","87","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.912","2026-03-17","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.865","2026-01-02","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":464},{"label":"Mar","value":369},{"label":"Abr","value":503},{"label":"Mai","value":694},{"label":"Jun","value":599},{"label":"Jul","value":412},{"label":"Ago","value":573},{"label":"Set","value":596},{"label":"Out","value":497},{"label":"Nov","value":643},{"label":"Dez","value":418}];
const MX = 694;
