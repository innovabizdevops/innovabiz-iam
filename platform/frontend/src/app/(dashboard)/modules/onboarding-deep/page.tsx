...
/* ═══ Onboarding & Integration — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "7481", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4105", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€105K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "412995781", cells: ["ONB-4781", "Onboarding & Integration Item 1", "10/2/2026", "€45 881"], status: "active" as const },
    { id: "412999352", cells: ["ONB-8352", "Onboarding & Integration Item 2", "25/9/2026", "€49 452"], status: "pending" as const },
    { id: "413002923", cells: ["ONB-2923", "Onboarding & Integration Item 3", "12/4/2026", "€3023"], status: "completed" as const },
    { id: "413006494", cells: ["ONB-6494", "Onboarding & Integration Item 4", "27/11/2026", "€6594"], status: "warning" as const },
    { id: "413010065", cells: ["ONB-1065", "Onboarding & Integration Item 5", "14/6/2026", "€10 165"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Onboarding & Integration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Onboarding & Integration</p>
                    </div>
                </div>
