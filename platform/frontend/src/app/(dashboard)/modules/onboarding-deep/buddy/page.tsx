...
const PAGE = "Buddy";
const KPIS = [{"l":"eNPS","v":"67","t":"-2.9%","d":"down"},{"l":"Engagement (%)","v":"78.3%","t":"-0.1%","d":"down"},{"l":"Turnover (%)","v":"80.3%","t":"+11.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.382","t":"+8.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.351","2026-02-11","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.969","2026-02-26","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","9.067","2026-03-27","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.799","2026-03-13","87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.759","2026-01-22","56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":542},{"label":"Mar","value":672},{"label":"Abr","value":575},{"label":"Mai","value":427},{"label":"Jun","value":537},{"label":"Jul","value":681},{"label":"Ago","value":765},{"label":"Set","value":498},{"label":"Out","value":497},{"label":"Nov","value":676},{"label":"Dez","value":573}];
const MX = 765;
