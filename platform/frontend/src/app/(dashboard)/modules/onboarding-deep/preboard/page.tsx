...
const ACCENT = "#5b21b6";
const MODULE = "Onboarding & Integration";
const PAGE = "Pre-Board";
const KPIS = [{"l":"eNPS","v":"61","t":"+17.0%","d":"up"},{"l":"Engagement (%)","v":"72.4%","t":"+5.6%","d":"up"},{"l":"Turnover (%)","v":"87.4%","t":"-2.5%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"4.625","t":"+15.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.180","2026-03-26","75","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.520","2026-01-09","76","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.560","2026-01-22","94","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.385","2026-01-04","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.111","2026-01-16","93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":644},{"label":"Mar","value":939},{"label":"Abr","value":1001},{"label":"Mai","value":809},{"label":"Jun","value":898},{"label":"Jul","value":724},{"label":"Ago","value":746},{"label":"Set","value":938},{"label":"Out","value":924},{"label":"Nov","value":999},{"label":"Dez","value":990}];
const MX = 1001;
