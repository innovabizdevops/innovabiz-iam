...
const PAGE = "Day One";
const KPIS = [{"l":"eNPS","v":"81","t":"+0.9%","d":"up"},{"l":"Engagement (%)","v":"79.5%","t":"+13.5%","d":"up"},{"l":"Turnover (%)","v":"75.8%","t":"+13.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.911","t":"-1.2%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.533","2026-03-12","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.297","2026-02-27","89","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.992","2026-03-27","74","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.143","2026-03-22","81","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.674","2026-01-17","71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":282},{"label":"Mar","value":645},{"label":"Abr","value":500},{"label":"Mai","value":506},{"label":"Jun","value":556},{"label":"Jul","value":569},{"label":"Ago","value":556},{"label":"Set","value":562},{"label":"Out","value":344},{"label":"Nov","value":540},{"label":"Dez","value":569}];
const MX = 645;
