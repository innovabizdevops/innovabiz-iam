...
const PAGE = "Survey";
const KPIS = [{"l":"eNPS","v":"82","t":"+2.2%","d":"up"},{"l":"Engagement (%)","v":"77.7%","t":"+0.9%","d":"up"},{"l":"Turnover (%)","v":"69.7%","t":"+6.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.895","t":"+9.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","526","2026-03-15","78","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.336","2026-02-06","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.902","2026-03-20","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.373","2026-03-19","71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.469","2026-02-11","63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":664},{"label":"Mar","value":685},{"label":"Abr","value":411},{"label":"Mai","value":703},{"label":"Jun","value":473},{"label":"Jul","value":382},{"label":"Ago","value":657},{"label":"Set","value":563},{"label":"Out","value":722},{"label":"Nov","value":503},{"label":"Dez","value":370}];
const MX = 722;
