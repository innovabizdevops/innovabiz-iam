...
const PAGE = "Decision";
const KPIS = [{"l":"Aprovações Pendentes","v":"7.191","t":"+8.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"90.0%","t":"-4.0%","d":"down"},{"l":"Tempo Médio (h)","v":"209h","t":"+15.9%","d":"up"},{"l":"Rejeitadas (%)","v":"67.9%","t":"+7.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.500","€ 8620.45","8.253","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.952","€ 28447.44","4.769","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.432","€ 40176.64","4.288","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.200","€ 16479.95","695","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","7.507","€ 47942.37","7.132","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":701},{"label":"Mar","value":999},{"label":"Abr","value":962},{"label":"Mai","value":894},{"label":"Jun","value":957},{"label":"Jul","value":798},{"label":"Ago","value":853},{"label":"Set","value":1034},{"label":"Out","value":1037},{"label":"Nov","value":1031},{"label":"Dez","value":872}];
const MX = 1037;
