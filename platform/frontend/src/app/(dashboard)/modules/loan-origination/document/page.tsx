...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"1.252","t":"+17.8%","d":"up"},{"l":"Submissões/Dia","v":"1617","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"5.615","t":"+16.0%","d":"up"},{"l":"Templates","v":"934","t":"+5.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.363","2026-02-08","7.953","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.053","2026-01-25","2.983","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.112","2026-02-06","3.362","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.641","2026-03-06","8.387","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.253","2026-01-07","156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":517},{"label":"Mar","value":648},{"label":"Abr","value":544},{"label":"Mai","value":480},{"label":"Jun","value":612},{"label":"Jul","value":498},{"label":"Ago","value":598},{"label":"Set","value":660},{"label":"Out","value":627},{"label":"Nov","value":345},{"label":"Dez","value":341}];
const MX = 660;
