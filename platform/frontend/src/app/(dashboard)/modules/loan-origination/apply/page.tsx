...
const KPIS = [{"l":"Total Loan Origination","v":"8.511","t":"-3.6%","d":"down"},{"l":"Application Ativos","v":"4.284","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"80.9%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"77","t":"+11.4%","d":"up"}];
const COLS = ["ID","Application","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Loan Origination #001","Loan Origination #002","7.936","7.752","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Loan Origination #002","Loan Origination #003","3.723","4.128","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Loan Origination #003","Loan Origination #004","8.047","6.694","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Loan Origination #004","Loan Origination #005","5.731","5.347","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Loan Origination #005","Loan Origination #001","1.976","7.911","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":268},{"label":"Fev","value":290},{"label":"Mar","value":306},{"label":"Abr","value":477},{"label":"Mai","value":482},{"label":"Jun","value":572},{"label":"Jul","value":302},{"label":"Ago","value":526},{"label":"Set","value":525},{"label":"Out","value":309},{"label":"Nov","value":399},{"label":"Dez","value":204}];
const MX = 572;
