...
const PAGE = "Disbursement";
const KPIS = [{"l":"Total Loan Origination","v":"5.548","t":"+10.7%","d":"up"},{"l":"Disbursement Ativos","v":"6.457","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+12.7%","d":"up"}];
const COLS = ["ID","Disbursement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Loan Origination #001","Loan Origination #002","979","1.548","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Loan Origination #002","Loan Origination #003","4.406","1.232","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Loan Origination #003","Loan Origination #004","8.868","5.058","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Loan Origination #004","Loan Origination #005","2.720","2.307","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Loan Origination #005","Loan Origination #001","3.807","2.169","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":782},{"label":"Mar","value":826},{"label":"Abr","value":681},{"label":"Mai","value":503},{"label":"Jun","value":585},{"label":"Jul","value":833},{"label":"Ago","value":518},{"label":"Set","value":699},{"label":"Out","value":635},{"label":"Nov","value":777},{"label":"Dez","value":589}];
const MX = 851;
