...
const ACCENT = "#6366f1";
const MODULE = "Loan Origination";
const PAGE = "Credit Score";
const KPIS = [{"l":"Integrações Ativas","v":"3.931","t":"-0.4%","d":"down"},{"l":"Chamadas/Hora","v":"1216","t":"+10.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.4%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"61ms","t":"+12.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.417","6.278","72.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.567","4.208","96.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.992","8.110","98.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.080","615","76.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.613","4.090","87.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":830},{"label":"Mar","value":526},{"label":"Abr","value":676},{"label":"Mai","value":634},{"label":"Jun","value":619},{"label":"Jul","value":822},{"label":"Ago","value":765},{"label":"Set","value":721},{"label":"Out","value":445},{"label":"Nov","value":757},{"label":"Dez","value":445}];
const MX = 830;
