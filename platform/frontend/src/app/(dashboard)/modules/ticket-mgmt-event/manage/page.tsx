...
const PAGE = "Manage";
const KPIS = [{"l":"Tickets Abertos","v":"5.003","t":"+6.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.9%","t":"-5.4%","d":"down"},{"l":"MTTR (h)","v":"65h","t":"+2.9%","d":"up"},{"l":"Satisfação (%)","v":"92.1%","t":"-2.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.743","726","6.657","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.208","3.447","8.518","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","989","7.260","6.610","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.571","2.157","9.045","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.208","1.099","6.021","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":351},{"label":"Mar","value":456},{"label":"Abr","value":235},{"label":"Mai","value":528},{"label":"Jun","value":277},{"label":"Jul","value":579},{"label":"Ago","value":429},{"label":"Set","value":579},{"label":"Out","value":418},{"label":"Nov","value":279},{"label":"Dez","value":586}];
const MX = 589;
