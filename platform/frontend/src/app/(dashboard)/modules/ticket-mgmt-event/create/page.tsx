...
const PAGE = "Create";
const KPIS = [{"l":"Tickets Abertos","v":"5.728","t":"+15.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.1%","t":"-1.6%","d":"down"},{"l":"MTTR (h)","v":"38h","t":"+15.8%","d":"up"},{"l":"Satisfação (%)","v":"93.7%","t":"-3.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.883","7.901","4.990","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.573","4.216","4.399","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.084","2.034","8.205","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.605","1.010","153","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","143","4.437","5.085","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":986},{"label":"Fev","value":901},{"label":"Mar","value":825},{"label":"Abr","value":664},{"label":"Mai","value":601},{"label":"Jun","value":918},{"label":"Jul","value":880},{"label":"Ago","value":600},{"label":"Set","value":807},{"label":"Out","value":934},{"label":"Nov","value":957},{"label":"Dez","value":720}];
const MX = 986;
