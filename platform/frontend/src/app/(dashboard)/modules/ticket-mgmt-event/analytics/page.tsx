...
const KPIS = [{"l":"Tickets Abertos","v":"8.475","t":"+6.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.7%","t":"+9.7%","d":"up"},{"l":"MTTR (h)","v":"85h","t":"-3.1%","d":"down"},{"l":"Satisfação (%)","v":"94.7%","t":"+8.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.144","4.422","8.696","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.001","7.834","6.163","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.254","7.302","7.322","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","109","7.534","7.076","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","733","4.508","2.213","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":307},{"label":"Fev","value":529},{"label":"Mar","value":396},{"label":"Abr","value":246},{"label":"Mai","value":352},{"label":"Jun","value":349},{"label":"Jul","value":473},{"label":"Ago","value":571},{"label":"Set","value":582},{"label":"Out","value":552},{"label":"Nov","value":237},{"label":"Dez","value":306}];
const MX = 582;
