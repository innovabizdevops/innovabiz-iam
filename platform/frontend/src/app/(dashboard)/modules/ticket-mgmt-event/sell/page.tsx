...
const PAGE = "Sell";
const KPIS = [{"l":"Tickets Abertos","v":"1.924","t":"+1.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.1%","t":"+5.2%","d":"up"},{"l":"MTTR (h)","v":"94h","t":"+10.4%","d":"up"},{"l":"Satisfação (%)","v":"68.6%","t":"+6.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.480","5.969","7.554","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.177","5.652","6.297","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.808","3.588","1.509","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.170","2.722","6.949","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.597","8.329","5.537","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":451},{"label":"Mar","value":694},{"label":"Abr","value":389},{"label":"Mai","value":392},{"label":"Jun","value":390},{"label":"Jul","value":410},{"label":"Ago","value":610},{"label":"Set","value":736},{"label":"Out","value":480},{"label":"Nov","value":744},{"label":"Dez","value":480}];
const MX = 744;
