...
/* ═══ Event Ticketing Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "7230", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3470", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€180K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2110340630", cells: ["TIC-3630", "Event Ticketing Platform Item 1", "7/3/2026", "€40 730"], status: "active" as const },
    { id: "2110344201", cells: ["TIC-7201", "Event Ticketing Platform Item 2", "22/10/2026", "€44 301"], status: "pending" as const },
    { id: "2110347772", cells: ["TIC-1772", "Event Ticketing Platform Item 3", "9/5/2026", "€47 872"], status: "completed" as const },
    { id: "2110351343", cells: ["TIC-5343", "Event Ticketing Platform Item 4", "24/12/2026", "€1443"], status: "warning" as const },
    { id: "2110354914", cells: ["TIC-8914", "Event Ticketing Platform Item 5", "11/7/2026", "€5014"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Ticketing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Ticketing Platform</p>
                    </div>
                </div>
