...
const ACCENT = "#6d28d9";
const MODULE = "Event Ticketing Platform";
const PAGE = "Scan";
const KPIS = [{"l":"Tickets Abertos","v":"5.545","t":"+12.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.0%","t":"+11.9%","d":"up"},{"l":"MTTR (h)","v":"37h","t":"+12.4%","d":"up"},{"l":"Satisfação (%)","v":"81.5%","t":"+13.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.801","3.483","3.048","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.379","3.988","5.531","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.977","4.170","1.277","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","661","2.442","5.249","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.253","3.217","7.111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":1007},{"label":"Mar","value":899},{"label":"Abr","value":917},{"label":"Mai","value":767},{"label":"Jun","value":996},{"label":"Jul","value":830},{"label":"Ago","value":707},{"label":"Set","value":974},{"label":"Out","value":974},{"label":"Nov","value":921},{"label":"Dez","value":916}];
const MX = 1007;
