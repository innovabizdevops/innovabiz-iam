...
const KPIS = [{"l":"Total Expatriate Mgmt","v":"6.765","t":"-4.9%","d":"down"},{"l":"Relocation Ativos","v":"6.788","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"71","t":"-4.2%","d":"down"}];
const COLS = ["ID","Relocation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expatriate Mgmt #001","Expatriate Mgmt #002","4.767","4.912","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Expatriate Mgmt #002","Expatriate Mgmt #003","1.035","8.704","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Expatriate Mgmt #003","Expatriate Mgmt #004","456","2.929","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Expatriate Mgmt #004","Expatriate Mgmt #005","6.321","5.525","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expatriate Mgmt #005","Expatriate Mgmt #001","5.051","3.641","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":978},{"label":"Mar","value":926},{"label":"Abr","value":732},{"label":"Mai","value":933},{"label":"Jun","value":1016},{"label":"Jul","value":974},{"label":"Ago","value":818},{"label":"Set","value":934},{"label":"Out","value":909},{"label":"Nov","value":919},{"label":"Dez","value":677}];
const MX = 1016;
