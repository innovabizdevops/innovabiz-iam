...
const PAGE = "Immigration";
const KPIS = [{"l":"Total Expatriate Mgmt","v":"6.065","t":"+6.6%","d":"up"},{"l":"Immigration Ativos","v":"2.907","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"64","t":"+6.3%","d":"up"}];
const COLS = ["ID","Immigration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expatriate Mgmt #001","Expatriate Mgmt #002","2.525","4.540","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Expatriate Mgmt #002","Expatriate Mgmt #003","2.761","2.759","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Expatriate Mgmt #003","Expatriate Mgmt #004","290","823","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Expatriate Mgmt #004","Expatriate Mgmt #005","1.031","5.755","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expatriate Mgmt #005","Expatriate Mgmt #001","3.567","427","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":488},{"label":"Mar","value":608},{"label":"Abr","value":727},{"label":"Mai","value":537},{"label":"Jun","value":703},{"label":"Jul","value":443},{"label":"Ago","value":709},{"label":"Set","value":595},{"label":"Out","value":643},{"label":"Nov","value":522},{"label":"Dez","value":592}];
const MX = 727;
