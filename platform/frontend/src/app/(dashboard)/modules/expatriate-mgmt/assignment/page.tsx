...
const KPIS = [{"l":"Total Expatriate Mgmt","v":"2.467","t":"+0.3%","d":"up"},{"l":"Assignment Ativos","v":"5.467","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"85.0%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"72","t":"+8.2%","d":"up"}];
const COLS = ["ID","Assignment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expatriate Mgmt #001","Expatriate Mgmt #002","440","1.133","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Expatriate Mgmt #002","Expatriate Mgmt #003","5.361","8.681","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Expatriate Mgmt #003","Expatriate Mgmt #004","6.598","1.635","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Expatriate Mgmt #004","Expatriate Mgmt #005","1.152","3.757","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expatriate Mgmt #005","Expatriate Mgmt #001","4.950","6.268","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":522},{"label":"Mar","value":539},{"label":"Abr","value":433},{"label":"Mai","value":643},{"label":"Jun","value":349},{"label":"Jul","value":491},{"label":"Ago","value":262},{"label":"Set","value":336},{"label":"Out","value":441},{"label":"Nov","value":323},{"label":"Dez","value":359}];
const MX = 643;
