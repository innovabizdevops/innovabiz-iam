...
const ACCENT = "#6366f1";
const MODULE = "Expatriate Mgmt";
const PAGE = "Repatriation";
const KPIS = [{"l":"Total Expatriate Mgmt","v":"6.691","t":"+9.1%","d":"up"},{"l":"Repatriation Ativos","v":"3.344","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"80.9%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"55","t":"+5.5%","d":"up"}];
const COLS = ["ID","Repatriation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Expatriate Mgmt #001","Expatriate Mgmt #002","8.784","833","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Expatriate Mgmt #002","Expatriate Mgmt #003","3.965","4.446","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Expatriate Mgmt #003","Expatriate Mgmt #004","1.812","2.791","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Expatriate Mgmt #004","Expatriate Mgmt #005","4.950","5.352","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Expatriate Mgmt #005","Expatriate Mgmt #001","5.982","8.419","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":977},{"label":"Mar","value":828},{"label":"Abr","value":961},{"label":"Mai","value":842},{"label":"Jun","value":810},{"label":"Jul","value":788},{"label":"Ago","value":907},{"label":"Set","value":762},{"label":"Out","value":1061},{"label":"Nov","value":981},{"label":"Dez","value":793}];
const MX = 1061;
