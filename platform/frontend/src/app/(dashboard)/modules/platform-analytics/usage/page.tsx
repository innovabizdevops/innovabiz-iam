...
const PAGE = "Usage";
const KPIS = [{"l":"Formulários Ativos","v":"4.497","t":"+3.7%","d":"up"},{"l":"Submissões/Dia","v":"4403","t":"+12.2%","d":"up"},{"l":"Documentos Gerados","v":"4.841","t":"+7.3%","d":"up"},{"l":"Templates","v":"259","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","887","2026-01-23","5.635","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.729","2026-03-24","495","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.091","2026-02-19","1.167","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.008","2026-01-06","5.486","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.627","2026-03-11","8.649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":667},{"label":"Mar","value":570},{"label":"Abr","value":285},{"label":"Mai","value":495},{"label":"Jun","value":297},{"label":"Jul","value":496},{"label":"Ago","value":310},{"label":"Set","value":401},{"label":"Out","value":531},{"label":"Nov","value":529},{"label":"Dez","value":665}];
const MX = 667;
