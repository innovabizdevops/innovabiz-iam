...
/* ═══ Platform Analytics Deep — Dashboard ═══ */

const ACCENT = "#22c55e";

const KPIS = [
    { label: "Total Registos", value: "6547", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2365", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€368K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2089728147", cells: ["PLA-1147", "Platform Analytics Deep Item 1", "4/4/2026", "€28 247"], status: "active" as const },
    { id: "2089731718", cells: ["PLA-4718", "Platform Analytics Deep Item 2", "19/11/2026", "€31 818"], status: "pending" as const },
    { id: "2089735289", cells: ["PLA-8289", "Platform Analytics Deep Item 3", "6/6/2026", "€35 389"], status: "completed" as const },
    { id: "2089738860", cells: ["PLA-2860", "Platform Analytics Deep Item 4", "21/1/2026", "€38 960"], status: "warning" as const },
    { id: "2089742431", cells: ["PLA-6431", "Platform Analytics Deep Item 5", "8/8/2026", "€42 531"], status: "active" as const },
];
...
export default function PlatformAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Analytics Deep</p>
                    </div>
                </div>
