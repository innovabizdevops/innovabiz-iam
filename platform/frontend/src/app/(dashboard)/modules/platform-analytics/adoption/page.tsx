...
const PAGE = "Adoption";
const KPIS = [{"l":"Formulários Ativos","v":"7.890","t":"+11.4%","d":"up"},{"l":"Submissões/Dia","v":"1686","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"7.732","t":"+8.8%","d":"up"},{"l":"Templates","v":"8.980","t":"-1.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.528","2026-03-03","8.573","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.085","2026-01-25","3.481","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.703","2026-02-15","1.580","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.778","2026-03-26","4.854","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.055","2026-03-17","5.521","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":593},{"label":"Mar","value":502},{"label":"Abr","value":537},{"label":"Mai","value":577},{"label":"Jun","value":740},{"label":"Jul","value":635},{"label":"Ago","value":759},{"label":"Set","value":712},{"label":"Out","value":528},{"label":"Nov","value":364},{"label":"Dez","value":375}];
const MX = 759;
