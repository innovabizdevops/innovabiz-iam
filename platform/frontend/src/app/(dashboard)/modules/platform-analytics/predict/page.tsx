...
const ACCENT = "#22c55e";
const MODULE = "Platform Analytics Deep";
const PAGE = "Predict";
const KPIS = [{"l":"Formulários Ativos","v":"5.842","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"3556","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"3.937","t":"+13.5%","d":"up"},{"l":"Templates","v":"3.366","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.866","2026-03-23","3.070","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.059","2026-03-11","1.960","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.614","2026-01-16","3.326","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.692","2026-01-08","5.519","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.095","2026-01-10","2.142","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":251},{"label":"Fev","value":416},{"label":"Mar","value":577},{"label":"Abr","value":336},{"label":"Mai","value":529},{"label":"Jun","value":326},{"label":"Jul","value":593},{"label":"Ago","value":532},{"label":"Set","value":543},{"label":"Out","value":242},{"label":"Nov","value":477},{"label":"Dez","value":565}];
const MX = 593;
