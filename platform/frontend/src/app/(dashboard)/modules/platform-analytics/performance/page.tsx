...
const KPIS = [{"l":"Formulários Ativos","v":"1.088","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"4762","t":"+16.8%","d":"up"},{"l":"Documentos Gerados","v":"1.693","t":"+10.1%","d":"up"},{"l":"Templates","v":"4.161","t":"-3.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.743","2026-01-11","4.663","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.528","2026-01-01","3.048","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.325","2026-01-23","3.939","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.911","2026-03-13","3.047","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.338","2026-02-18","4.398","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":555},{"label":"Mar","value":700},{"label":"Abr","value":474},{"label":"Mai","value":510},{"label":"Jun","value":475},{"label":"Jul","value":712},{"label":"Ago","value":601},{"label":"Set","value":463},{"label":"Out","value":630},{"label":"Nov","value":619},{"label":"Dez","value":587}];
const MX = 712;
