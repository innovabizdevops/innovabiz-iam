...
const PAGE = "Value";
const KPIS = [{"l":"Formulários Ativos","v":"4.915","t":"+0.5%","d":"up"},{"l":"Submissões/Dia","v":"4729","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"7.654","t":"+0.5%","d":"up"},{"l":"Templates","v":"6.921","t":"+12.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.773","2026-01-26","1.121","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.645","2026-01-26","3.760","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.041","2026-02-20","9.048","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.419","2026-02-05","7.337","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.288","2026-01-20","2.061","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":371},{"label":"Mar","value":475},{"label":"Abr","value":613},{"label":"Mai","value":550},{"label":"Jun","value":506},{"label":"Jul","value":651},{"label":"Ago","value":598},{"label":"Set","value":710},{"label":"Out","value":504},{"label":"Nov","value":604},{"label":"Dez","value":363}];
const MX = 710;
