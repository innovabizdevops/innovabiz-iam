...
const ACCENT = "#7c2d12";
const MODULE = "Credit & Lending";
const PAGE = "Credit Scoring AI";
const KPIS = [{"l":"Integrações Ativas","v":"2.607","t":"+3.3%","d":"up"},{"l":"Chamadas/Hora","v":"4498","t":"+13.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.2%","t":"+1.5%","d":"up"},{"l":"Latência Média (ms)","v":"17ms","t":"+1.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.306","3.065","77.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.989","5.680","90.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.697","4.546","75.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.154","8.470","100.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.135","3.665","75.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":996},{"label":"Mar","value":910},{"label":"Abr","value":831},{"label":"Mai","value":937},{"label":"Jun","value":890},{"label":"Jul","value":732},{"label":"Ago","value":995},{"label":"Set","value":756},{"label":"Out","value":603},{"label":"Nov","value":936},{"label":"Dez","value":973}];
const MX = 996;
