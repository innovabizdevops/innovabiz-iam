...
const KPIS = [{"l":"Integrações Ativas","v":"8.382","t":"+12.0%","d":"up"},{"l":"Chamadas/Hora","v":"3300","t":"+12.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.4%","t":"+8.2%","d":"up"},{"l":"Latência Média (ms)","v":"150ms","t":"+11.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.996","6.515","81.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","9.015","153","87.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.542","2.096","87.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","612","3.790","89.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.577","5.091","78.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":755},{"label":"Mar","value":820},{"label":"Abr","value":462},{"label":"Mai","value":662},{"label":"Jun","value":447},{"label":"Jul","value":587},{"label":"Ago","value":469},{"label":"Set","value":799},{"label":"Out","value":524},{"label":"Nov","value":504},{"label":"Dez","value":443}];
const MX = 820;
