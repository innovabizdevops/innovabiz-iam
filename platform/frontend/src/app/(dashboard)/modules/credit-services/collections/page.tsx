...
const PAGE = "Collections Mgmt";
const KPIS = [{"l":"Integrações Ativas","v":"2.432","t":"-4.8%","d":"down"},{"l":"Chamadas/Hora","v":"972","t":"+8.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.2%","t":"+12.1%","d":"up"},{"l":"Latência Média (ms)","v":"127ms","t":"+6.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.069","1.545","73.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.271","8.119","73.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.519","4.780","87.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.080","6.909","88.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.952","8.850","79.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":580},{"label":"Mar","value":687},{"label":"Abr","value":696},{"label":"Mai","value":463},{"label":"Jun","value":487},{"label":"Jul","value":788},{"label":"Ago","value":596},{"label":"Set","value":725},{"label":"Out","value":720},{"label":"Nov","value":804},{"label":"Dez","value":505}];
const MX = 804;
