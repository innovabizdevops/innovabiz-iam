...
const PAGE = "Pre-Press";
const KPIS = [{"l":"Total Offset Print","v":"3.950","t":"+0.0%","d":"up"},{"l":"Pre Press Ativos","v":"7.422","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"76","t":"-1.6%","d":"down"}];
const COLS = ["ID","Pre Press","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Offset Print #001","Offset Print #002","8.210","3.079","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Offset Print #002","Offset Print #003","7.685","8.770","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Offset Print #003","Offset Print #004","8.175","3.483","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Offset Print #004","Offset Print #005","5.909","4.018","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Offset Print #005","Offset Print #001","6.643","1.605","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":366},{"label":"Mar","value":369},{"label":"Abr","value":218},{"label":"Mai","value":611},{"label":"Jun","value":612},{"label":"Jul","value":437},{"label":"Ago","value":305},{"label":"Set","value":314},{"label":"Out","value":285},{"label":"Nov","value":581},{"label":"Dez","value":248}];
const MX = 612;
