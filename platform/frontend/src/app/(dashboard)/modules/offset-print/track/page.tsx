...
const ACCENT = "#6366f1";
const MODULE = "Offset Printing";
const PAGE = "Job Track";
const KPIS = [{"l":"Total Offset Print","v":"8.049","t":"+7.6%","d":"up"},{"l":"Job Track Ativos","v":"2.182","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+15.2%","d":"up"}];
const COLS = ["ID","Job Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Offset Print #001","Offset Print #002","4.447","3.131","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Offset Print #002","Offset Print #003","6.394","8.864","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Offset Print #003","Offset Print #004","983","2.983","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Offset Print #004","Offset Print #005","7.109","1.509","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Offset Print #005","Offset Print #001","7.167","6.097","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":493},{"label":"Mar","value":558},{"label":"Abr","value":403},{"label":"Mai","value":478},{"label":"Jun","value":540},{"label":"Jul","value":360},{"label":"Ago","value":587},{"label":"Set","value":430},{"label":"Out","value":510},{"label":"Nov","value":489},{"label":"Dez","value":512}];
const MX = 645;
