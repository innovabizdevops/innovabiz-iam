...
const PAGE = "Press";
const KPIS = [{"l":"Total Offset Print","v":"8.378","t":"+6.7%","d":"up"},{"l":"Press Ativos","v":"7.213","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.9%","d":"up"}];
const COLS = ["ID","Press","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Offset Print #001","Offset Print #002","7.992","8.357","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Offset Print #002","Offset Print #003","6.869","2.665","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Offset Print #003","Offset Print #004","5.371","2.239","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Offset Print #004","Offset Print #005","1.963","8.800","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Offset Print #005","Offset Print #001","5.881","1.102","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":914},{"label":"Mar","value":658},{"label":"Abr","value":666},{"label":"Mai","value":870},{"label":"Jun","value":664},{"label":"Jul","value":785},{"label":"Ago","value":939},{"label":"Set","value":991},{"label":"Out","value":862},{"label":"Nov","value":649},{"label":"Dez","value":701}];
const MX = 991;
