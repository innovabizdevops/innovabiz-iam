...
const PAGE = "Process";
const KPIS = [{"l":"Total Insect Farm","v":"7.979","t":"+13.7%","d":"up"},{"l":"Process Ativos","v":"585","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"65.4%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"81","t":"+11.5%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insect Farm #001","Insect Farm #002","6.428","2.638","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Insect Farm #002","Insect Farm #003","2.470","5.017","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Insect Farm #003","Insect Farm #004","1.955","2.642","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Insect Farm #004","Insect Farm #005","5.214","6.959","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insect Farm #005","Insect Farm #001","3.002","2.670","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":900},{"label":"Mar","value":731},{"label":"Abr","value":888},{"label":"Mai","value":911},{"label":"Jun","value":706},{"label":"Jul","value":773},{"label":"Ago","value":820},{"label":"Set","value":699},{"label":"Out","value":835},{"label":"Nov","value":929},{"label":"Dez","value":973}];
const MX = 973;
