...
const ACCENT = "#92400e";
const MODULE = "Insect Farming";
const PAGE = "Breed";
const KPIS = [{"l":"Total Insect Farm","v":"7.086","t":"-1.1%","d":"down"},{"l":"Breed Ativos","v":"1.491","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"90.1%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"94","t":"+8.8%","d":"up"}];
const COLS = ["ID","Breed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insect Farm #001","Insect Farm #002","4.312","4.720","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Insect Farm #002","Insect Farm #003","5.718","5.103","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Insect Farm #003","Insect Farm #004","6.256","4.858","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Insect Farm #004","Insect Farm #005","1.970","8.010","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insect Farm #005","Insect Farm #001","2.325","5.600","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":528},{"label":"Mar","value":466},{"label":"Abr","value":708},{"label":"Mai","value":639},{"label":"Jun","value":617},{"label":"Jul","value":450},{"label":"Ago","value":768},{"label":"Set","value":438},{"label":"Out","value":556},{"label":"Nov","value":491},{"label":"Dez","value":454}];
const MX = 768;
