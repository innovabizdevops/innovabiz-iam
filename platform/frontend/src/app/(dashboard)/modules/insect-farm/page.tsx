...
const KPIS = [
    { label: "Total Registos", value: "1010", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2870", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€391K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "824146210", cells: ["INS-8210", "Insect Farming Item 1", "7/11/2026", "€46 310"], status: "active" as const },
    { id: "824149781", cells: ["INS-2781", "Insect Farming Item 2", "22/6/2026", "€49 881"], status: "pending" as const },
    { id: "824153352", cells: ["INS-6352", "Insect Farming Item 3", "9/1/2026", "€3452"], status: "completed" as const },
    { id: "824156923", cells: ["INS-9923", "Insect Farming Item 4", "24/8/2026", "€7023"], status: "warning" as const },
    { id: "824160494", cells: ["INS-4494", "Insect Farming Item 5", "11/3/2026", "€10 594"], status: "active" as const },
];
...
export default function InsectFarmingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insect Farming</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Insect Farming</p>
                    </div>
                </div>
