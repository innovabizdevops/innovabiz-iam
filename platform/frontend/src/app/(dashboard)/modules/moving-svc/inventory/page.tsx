...
const KPIS = [{"l":"Total Moving Svc","v":"4.688","t":"-4.6%","d":"down"},{"l":"Inventory Ativos","v":"1.090","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"89","t":"-4.9%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Svc #001","Moving Svc #002","1.265","4.729","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Svc #002","Moving Svc #003","2.581","1.901","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Svc #003","Moving Svc #004","4.094","1.853","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Svc #004","Moving Svc #005","6.453","8.252","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Svc #005","Moving Svc #001","3.641","6.902","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":820},{"label":"Mar","value":1050},{"label":"Abr","value":1030},{"label":"Mai","value":826},{"label":"Jun","value":1033},{"label":"Jul","value":756},{"label":"Ago","value":790},{"label":"Set","value":817},{"label":"Out","value":899},{"label":"Nov","value":1052},{"label":"Dez","value":1044}];
const MX = 1052;
