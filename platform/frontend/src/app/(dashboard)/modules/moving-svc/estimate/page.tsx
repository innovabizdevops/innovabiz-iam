...
const PAGE = "Estimate";
const KPIS = [{"l":"Total Moving Svc","v":"8.502","t":"+3.4%","d":"up"},{"l":"Estimate Ativos","v":"8.647","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"83.5%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"63","t":"+8.9%","d":"up"}];
const COLS = ["ID","Estimate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Svc #001","Moving Svc #002","7.020","2.794","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Svc #002","Moving Svc #003","8.620","2.827","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Svc #003","Moving Svc #004","7.346","2.846","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Svc #004","Moving Svc #005","8.687","2.608","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Svc #005","Moving Svc #001","6.631","4.061","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":562},{"label":"Mar","value":482},{"label":"Abr","value":676},{"label":"Mai","value":525},{"label":"Jun","value":383},{"label":"Jul","value":615},{"label":"Ago","value":377},{"label":"Set","value":691},{"label":"Out","value":542},{"label":"Nov","value":575},{"label":"Dez","value":615}];
const MX = 691;
