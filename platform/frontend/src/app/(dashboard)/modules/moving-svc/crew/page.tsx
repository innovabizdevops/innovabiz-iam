...
const PAGE = "Crew";
const KPIS = [{"l":"Total Moving Svc","v":"6.441","t":"+2.6%","d":"up"},{"l":"Crew Ativos","v":"1.825","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"77.3%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.6%","d":"up"}];
const COLS = ["ID","Crew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Svc #001","Moving Svc #002","8.704","6.220","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Svc #002","Moving Svc #003","1.356","989","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Svc #003","Moving Svc #004","1.676","2.220","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Svc #004","Moving Svc #005","8.219","3.595","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Svc #005","Moving Svc #001","7.503","8.794","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":682},{"label":"Mar","value":728},{"label":"Abr","value":522},{"label":"Mai","value":752},{"label":"Jun","value":622},{"label":"Jul","value":463},{"label":"Ago","value":482},{"label":"Set","value":737},{"label":"Out","value":496},{"label":"Nov","value":476},{"label":"Dez","value":596}];
const MX = 752;
