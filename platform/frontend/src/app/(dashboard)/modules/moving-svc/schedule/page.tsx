...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Moving Svc","v":"3.502","t":"+12.4%","d":"up"},{"l":"Schedule Ativos","v":"1.362","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"77.7%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+8.5%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Svc #001","Moving Svc #002","5.439","8.814","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Svc #002","Moving Svc #003","5.483","1.126","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Svc #003","Moving Svc #004","8.777","941","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Svc #004","Moving Svc #005","5.463","2.128","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Svc #005","Moving Svc #001","5.525","5.232","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":324},{"label":"Mar","value":475},{"label":"Abr","value":333},{"label":"Mai","value":662},{"label":"Jun","value":418},{"label":"Jul","value":343},{"label":"Ago","value":397},{"label":"Set","value":430},{"label":"Out","value":494},{"label":"Nov","value":504},{"label":"Dez","value":645}];
const MX = 662;
