...
const PAGE = "Track";
const KPIS = [{"l":"Total Moving Svc","v":"1.421","t":"-5.4%","d":"down"},{"l":"Track Ativos","v":"6.263","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"88","t":"+15.9%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Moving Svc #001","Moving Svc #002","4.203","2.202","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Moving Svc #002","Moving Svc #003","564","200","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Moving Svc #003","Moving Svc #004","7.145","3.954","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Moving Svc #004","Moving Svc #005","867","4.324","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Moving Svc #005","Moving Svc #001","7.374","4.690","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":742},{"label":"Mar","value":579},{"label":"Abr","value":664},{"label":"Mai","value":819},{"label":"Jun","value":771},{"label":"Jul","value":450},{"label":"Ago","value":652},{"label":"Set","value":540},{"label":"Out","value":439},{"label":"Nov","value":517},{"label":"Dez","value":782}];
const MX = 819;
