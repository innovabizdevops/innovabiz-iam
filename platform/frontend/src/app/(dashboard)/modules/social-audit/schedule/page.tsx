...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.388","t":"+3.6%","d":"up"},{"l":"NC Abertas","v":"4.873","t":"+3.7%","d":"up"},{"l":"Conformidade (%)","v":"71.9%","t":"+6.3%","d":"up"},{"l":"CAPAs Pendentes","v":"9.067","t":"-2.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.101","94.9%","2.299","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.715","92.2%","6.868","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.390","71.1%","7.671","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","639","82.6%","8.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.670","93.1%","2.116","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":666},{"label":"Mar","value":808},{"label":"Abr","value":674},{"label":"Mai","value":574},{"label":"Jun","value":525},{"label":"Jul","value":724},{"label":"Ago","value":534},{"label":"Set","value":621},{"label":"Out","value":443},{"label":"Nov","value":684},{"label":"Dez","value":750}];
const MX = 808;
