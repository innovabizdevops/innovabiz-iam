...
const PAGE = "SA8000";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.412","t":"+2.7%","d":"up"},{"l":"NC Abertas","v":"7.422","t":"+0.8%","d":"up"},{"l":"Conformidade (%)","v":"78.1%","t":"+0.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.553","t":"+5.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.689","73.3%","5.716","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.660","94.0%","8.695","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","250","90.8%","1.484","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.700","90.8%","8.863","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.687","85.1%","1.360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":749},{"label":"Mar","value":626},{"label":"Abr","value":531},{"label":"Mai","value":401},{"label":"Jun","value":463},{"label":"Jul","value":676},{"label":"Ago","value":462},{"label":"Set","value":495},{"label":"Out","value":545},{"label":"Nov","value":562},{"label":"Dez","value":696}];
const MX = 749;
