...
const PAGE = "Smeta";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.295","t":"-1.0%","d":"down"},{"l":"NC Abertas","v":"8.883","t":"+9.5%","d":"up"},{"l":"Conformidade (%)","v":"92.7%","t":"+13.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.288","t":"+15.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","250","75.4%","7.660","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","461","85.0%","8.424","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.490","96.0%","8.855","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","675","92.7%","6.277","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.957","92.9%","4.898","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":687},{"label":"Mar","value":923},{"label":"Abr","value":1083},{"label":"Mai","value":1055},{"label":"Jun","value":994},{"label":"Jul","value":1060},{"label":"Ago","value":921},{"label":"Set","value":995},{"label":"Out","value":807},{"label":"Nov","value":1010},{"label":"Dez","value":1030}];
const MX = 1083;
