...
const ACCENT = "#ec4899";
const MODULE = "Social Audit";
const PAGE = "Cert Mgmt";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.587","t":"+13.2%","d":"up"},{"l":"NC Abertas","v":"7.423","t":"-6.0%","d":"down"},{"l":"Conformidade (%)","v":"83.2%","t":"+0.5%","d":"up"},{"l":"CAPAs Pendentes","v":"2.354","t":"-3.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.310","72.9%","5.855","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.865","86.6%","143","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.490","76.0%","8.144","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.272","83.7%","7.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.051","99.8%","1.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":641},{"label":"Mar","value":800},{"label":"Abr","value":886},{"label":"Mai","value":600},{"label":"Jun","value":899},{"label":"Jul","value":712},{"label":"Ago","value":583},{"label":"Set","value":614},{"label":"Out","value":677},{"label":"Nov","value":897},{"label":"Dez","value":890}];
const MX = 899;
