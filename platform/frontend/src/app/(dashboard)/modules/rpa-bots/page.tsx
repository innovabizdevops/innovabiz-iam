...
/* ═══ RPA Bot Management — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "5803", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "660", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€267K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2114536803", cells: ["RPA-5803", "RPA Bot Management Item 1", "16/4/2026", "€36 903"], status: "active" as const },
    { id: "2114540374", cells: ["RPA-9374", "RPA Bot Management Item 2", "3/11/2026", "€40 474"], status: "pending" as const },
    { id: "2114543945", cells: ["RPA-3945", "RPA Bot Management Item 3", "18/6/2026", "€44 045"], status: "completed" as const },
    { id: "2114547516", cells: ["RPA-7516", "RPA Bot Management Item 4", "5/1/2026", "€47 616"], status: "warning" as const },
    { id: "2114551087", cells: ["RPA-2087", "RPA Bot Management Item 5", "20/8/2026", "€1187"], status: "active" as const },
];
...
export default function RpaBotManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RPA Bot Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RPA Bot Management</p>
                    </div>
                </div>
