...
const PAGE = "Build";
const KPIS = [{"l":"Total Rpa Bots","v":"5.675","t":"-4.9%","d":"down"},{"l":"Build Ativos","v":"1.320","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"91.0%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"88","t":"-1.9%","d":"down"}];
const COLS = ["ID","Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rpa Bots #001","Rpa Bots #002","8.233","7.648","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Rpa Bots #002","Rpa Bots #003","1.467","5.839","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Rpa Bots #003","Rpa Bots #004","4.371","1.328","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Rpa Bots #004","Rpa Bots #005","7.259","6.012","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rpa Bots #005","Rpa Bots #001","3.484","4.099","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":344},{"label":"Mar","value":240},{"label":"Abr","value":330},{"label":"Mai","value":351},{"label":"Jun","value":336},{"label":"Jul","value":403},{"label":"Ago","value":292},{"label":"Set","value":330},{"label":"Out","value":366},{"label":"Nov","value":261},{"label":"Dez","value":398}];
const MX = 560;
