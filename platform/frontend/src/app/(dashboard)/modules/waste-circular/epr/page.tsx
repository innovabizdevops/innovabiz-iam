...
const PAGE = "EPR Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.499","t":"+1.3%","d":"up"},{"l":"NC Abertas","v":"1.593","t":"+7.8%","d":"up"},{"l":"Conformidade (%)","v":"89.0%","t":"+16.8%","d":"up"},{"l":"CAPAs Pendentes","v":"8.871","t":"+16.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.207","99.6%","3.470","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.359","77.2%","4.709","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.094","71.3%","2.136","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.273","92.6%","2.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.165","90.1%","2.397","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":846},{"label":"Mar","value":711},{"label":"Abr","value":767},{"label":"Mai","value":704},{"label":"Jun","value":553},{"label":"Jul","value":864},{"label":"Ago","value":581},{"label":"Set","value":722},{"label":"Out","value":852},{"label":"Nov","value":772},{"label":"Dez","value":613}];
const MX = 864;
