...
const PAGE = "Sorting Facility";
const KPIS = [{"l":"Total Waste Circular","v":"133","t":"+11.8%","d":"up"},{"l":"Sorting Facility Ativos","v":"7.182","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"84","t":"-2.4%","d":"down"}];
const COLS = ["ID","Sorting Facility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Circular #001","Waste Circular #002","355","4.121","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Circular #002","Waste Circular #003","3.606","7.857","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Circular #003","Waste Circular #004","2.253","8.179","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Circular #004","Waste Circular #005","8.077","5.218","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Circular #005","Waste Circular #001","6.033","7.454","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":649},{"label":"Mar","value":646},{"label":"Abr","value":673},{"label":"Mai","value":809},{"label":"Jun","value":680},{"label":"Jul","value":666},{"label":"Ago","value":612},{"label":"Set","value":895},{"label":"Out","value":873},{"label":"Nov","value":710},{"label":"Dez","value":746}];
const MX = 930;
