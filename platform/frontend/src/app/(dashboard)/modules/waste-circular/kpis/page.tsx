...
const PAGE = "Circular KPIs";
const KPIS = [{"l":"Total Waste Circular","v":"8.561","t":"+2.6%","d":"up"},{"l":"Circular KPIs Ativos","v":"2.338","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"76.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+12.8%","d":"up"}];
const COLS = ["ID","Circular KPIs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Circular #001","Waste Circular #002","6.495","1.812","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Circular #002","Waste Circular #003","3.461","7.388","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Circular #003","Waste Circular #004","8.741","4.367","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Circular #004","Waste Circular #005","3.304","7.619","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Circular #005","Waste Circular #001","266","3.425","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":604},{"label":"Mar","value":355},{"label":"Abr","value":676},{"label":"Mai","value":430},{"label":"Jun","value":474},{"label":"Jul","value":323},{"label":"Ago","value":691},{"label":"Set","value":455},{"label":"Out","value":316},{"label":"Nov","value":631},{"label":"Dez","value":352}];
const MX = 691;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#854d0e'}}>ESG</span></h1>
                </div>
