...
const PAGE = "E-Waste Processing";
const KPIS = [{"l":"Total Waste Circular","v":"2.595","t":"+16.8%","d":"up"},{"l":"E Waste Processing Ativos","v":"3.802","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"78.5%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"61","t":"-0.3%","d":"down"}];
const COLS = ["ID","E Waste Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Circular #001","Waste Circular #002","2.288","2.310","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Circular #002","Waste Circular #003","8.459","553","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Circular #003","Waste Circular #004","3.888","357","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Circular #004","Waste Circular #005","6.386","3.866","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Circular #005","Waste Circular #001","3.726","8.201","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":924},{"label":"Mar","value":846},{"label":"Abr","value":836},{"label":"Mai","value":983},{"label":"Jun","value":757},{"label":"Jul","value":655},{"label":"Ago","value":799},{"label":"Set","value":746},{"label":"Out","value":954},{"label":"Nov","value":646},{"label":"Dez","value":768}];
const MX = 983;
