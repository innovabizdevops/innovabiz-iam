...
const KPIS = [{"l":"Total Waste Circular","v":"3.022","t":"+17.2%","d":"up"},{"l":"Collection Routes Ativos","v":"7.058","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"76","t":"+13.0%","d":"up"}];
const COLS = ["ID","Collection Routes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Circular #001","Waste Circular #002","8.894","7.599","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Circular #002","Waste Circular #003","8.560","2.289","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Circular #003","Waste Circular #004","3.237","6.244","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Circular #004","Waste Circular #005","5.815","1.588","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Circular #005","Waste Circular #001","6.720","5.163","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":471},{"label":"Mar","value":757},{"label":"Abr","value":655},{"label":"Mai","value":464},{"label":"Jun","value":731},{"label":"Jul","value":634},{"label":"Ago","value":518},{"label":"Set","value":644},{"label":"Out","value":575},{"label":"Nov","value":679},{"label":"Dez","value":652}];
const MX = 757;
