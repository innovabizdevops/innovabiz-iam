...
const PAGE = "Material Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"2.610","t":"+13.3%","d":"up"},{"l":"RTO Médio (h)","v":"103h","t":"+10.7%","d":"up"},{"l":"RPO Médio (h)","v":"124h","t":"-3.7%","d":"down"},{"l":"Testes DR (YTD)","v":"5.593","t":"+6.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","192h","106h","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","75h","194h","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","195h","148h","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","149h","145h","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","173h","44h","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":685},{"label":"Mar","value":603},{"label":"Abr","value":423},{"label":"Mai","value":352},{"label":"Jun","value":480},{"label":"Jul","value":526},{"label":"Ago","value":448},{"label":"Set","value":477},{"label":"Out","value":461},{"label":"Nov","value":400},{"label":"Dez","value":467}];
const MX = 726;
