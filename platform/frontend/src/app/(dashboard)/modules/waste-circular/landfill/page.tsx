...
const PAGE = "Landfill Monitor";
const KPIS = [{"l":"Total Waste Circular","v":"9.095","t":"+10.7%","d":"up"},{"l":"Landfill Monitor Ativos","v":"5.133","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"67.6%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Landfill Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Circular #001","Waste Circular #002","3.110","7.927","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Circular #002","Waste Circular #003","7.608","3.639","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Circular #003","Waste Circular #004","3.901","993","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Circular #004","Waste Circular #005","873","6.892","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Circular #005","Waste Circular #001","258","2.939","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":954},{"label":"Mar","value":890},{"label":"Abr","value":929},{"label":"Mai","value":916},{"label":"Jun","value":890},{"label":"Jul","value":705},{"label":"Ago","value":649},{"label":"Set","value":779},{"label":"Out","value":738},{"label":"Nov","value":614},{"label":"Dez","value":690}];
const MX = 954;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#854d0e'}}>IoT</span></h1>
                </div>
