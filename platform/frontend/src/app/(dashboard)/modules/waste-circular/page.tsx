...
export default function WasteCircularPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Waste Circular</h1><p className="text-sm text-muted-foreground">Waste Circular • iBOS Enterprise</p></div>
