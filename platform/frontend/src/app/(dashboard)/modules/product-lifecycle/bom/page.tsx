...
const PAGE = "Bill of Materials";
const KPIS = [{"l":"Produtos Ativos","v":"5.515","t":"-0.7%","d":"down"},{"l":"SKUs","v":"8.218","t":"+13.6%","d":"up"},{"l":"ECNs Pendentes","v":"8.823","t":"+17.9%","d":"up"},{"l":"Time-to-Market (dias)","v":"639","t":"+15.6%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","5.100","3.436","1.701","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","749","6.326","6.690","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","3.159","2.046","1.604","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","4.707","7.696","3.942","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","3.262","7.260","4.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":854},{"label":"Mar","value":794},{"label":"Abr","value":957},{"label":"Mai","value":747},{"label":"Jun","value":798},{"label":"Jul","value":964},{"label":"Ago","value":913},{"label":"Set","value":740},{"label":"Out","value":933},{"label":"Nov","value":909},{"label":"Dez","value":723}];
const MX = 964;
