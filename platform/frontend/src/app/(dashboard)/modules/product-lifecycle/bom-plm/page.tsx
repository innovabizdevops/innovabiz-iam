...
const PAGE = "BOM Management";
const KPIS = [{"l":"Produtos Ativos","v":"7.705","t":"+0.5%","d":"up"},{"l":"SKUs","v":"123","t":"+0.3%","d":"up"},{"l":"ECNs Pendentes","v":"5.977","t":"+13.8%","d":"up"},{"l":"Time-to-Market (dias)","v":"4.478","t":"-1.6%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","777","4.050","2.820","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","7.917","5.014","6.995","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","268","3.750","1.216","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","1.464","2.965","7.646","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","5.006","5.948","4.080","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":578},{"label":"Mar","value":660},{"label":"Abr","value":826},{"label":"Mai","value":641},{"label":"Jun","value":930},{"label":"Jul","value":895},{"label":"Ago","value":789},{"label":"Set","value":686},{"label":"Out","value":577},{"label":"Nov","value":567},{"label":"Dez","value":681}];
const MX = 930;
...
export default function BomPlmPage() {
    return (
