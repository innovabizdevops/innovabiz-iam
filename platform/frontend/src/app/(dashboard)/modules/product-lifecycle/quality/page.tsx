...
const PAGE = "Quality Mgmt";
const KPIS = [{"l":"Auditorias Realizadas","v":"702","t":"+14.0%","d":"up"},{"l":"NC Abertas","v":"3.679","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"85.0%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"7.032","t":"+7.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.230","77.9%","3.810","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.125","87.7%","1.710","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.843","71.3%","898","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","275","71.1%","3.254","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.973","98.4%","8.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1005},{"label":"Fev","value":869},{"label":"Mar","value":899},{"label":"Abr","value":965},{"label":"Mai","value":1032},{"label":"Jun","value":875},{"label":"Jul","value":907},{"label":"Ago","value":737},{"label":"Set","value":660},{"label":"Out","value":923},{"label":"Nov","value":721},{"label":"Dez","value":984}];
const MX = 1032;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>FMEA</span></h1>
                </div>
