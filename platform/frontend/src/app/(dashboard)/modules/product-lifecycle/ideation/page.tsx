...
const PAGE = "Ideation";
const KPIS = [{"l":"Ideias Submetidas","v":"906","t":"+6.7%","d":"up"},{"l":"Patentes (YTD)","v":"1.487","t":"+3.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.829","t":"+7.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€50.7M","t":"+5.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.451","87.8%","8.195","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.308","75.8%","726","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.344","83.7%","5.023","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.311","73.6%","270","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.097","71.0%","472","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1072},{"label":"Fev","value":1014},{"label":"Mar","value":1067},{"label":"Abr","value":952},{"label":"Mai","value":775},{"label":"Jun","value":786},{"label":"Jul","value":902},{"label":"Ago","value":745},{"label":"Set","value":837},{"label":"Out","value":835},{"label":"Nov","value":715},{"label":"Dez","value":810}];
const MX = 1072;
