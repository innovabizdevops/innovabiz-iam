...
const PAGE = "Change Control";
const KPIS = [{"l":"Produtos Ativos","v":"2.999","t":"+3.4%","d":"up"},{"l":"SKUs","v":"8.636","t":"+7.3%","d":"up"},{"l":"ECNs Pendentes","v":"5.736","t":"+5.2%","d":"up"},{"l":"Time-to-Market (dias)","v":"5.830","t":"+0.5%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","6.414","8.080","3.356","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","5.468","4.085","7.026","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","1.582","6.887","2.458","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","3.633","2.397","8.835","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","8.415","4.130","8.664","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":301},{"label":"Fev","value":509},{"label":"Mar","value":343},{"label":"Abr","value":575},{"label":"Mai","value":475},{"label":"Jun","value":363},{"label":"Jul","value":530},{"label":"Ago","value":455},{"label":"Set","value":444},{"label":"Out","value":666},{"label":"Nov","value":536},{"label":"Dez","value":431}];
const MX = 666;
