...
const PAGE = "Simulation &amp; CAE";
const KPIS = [{"l":"Twins Ativos","v":"2.867","t":"+2.2%","d":"up"},{"l":"Simulações/Dia","v":"4519","t":"+6.6%","d":"up"},{"l":"Precisão Modelo (%)","v":"69.4%","t":"+17.4%","d":"up"},{"l":"Latência Sync (ms)","v":"196ms","t":"+15.8%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","96.7%","2026-01-28","1.403","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","95.6%","2026-02-13","4.765","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","76.1%","2026-01-20","1.368","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","71.5%","2026-03-15","3.211","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","98.5%","2026-02-26","1.572","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":483},{"label":"Mar","value":456},{"label":"Abr","value":706},{"label":"Mai","value":700},{"label":"Jun","value":720},{"label":"Jul","value":443},{"label":"Ago","value":531},{"label":"Set","value":508},{"label":"Out","value":585},{"label":"Nov","value":360},{"label":"Dez","value":670}];
const MX = 720;
