...
const PAGE = "Retire";
const KPIS = [{"l":"Produtos Ativos","v":"2.119","t":"+16.7%","d":"up"},{"l":"SKUs","v":"3.868","t":"+1.1%","d":"up"},{"l":"ECNs Pendentes","v":"4.447","t":"-4.8%","d":"down"},{"l":"Time-to-Market (dias)","v":"8.954","t":"+2.8%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","6.744","5.762","722","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","5.352","7.397","4.121","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","6.950","2.726","2.853","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","3.772","7.519","4.834","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","5.766","7.973","333","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":467},{"label":"Mar","value":438},{"label":"Abr","value":525},{"label":"Mai","value":378},{"label":"Jun","value":480},{"label":"Jul","value":310},{"label":"Ago","value":274},{"label":"Set","value":491},{"label":"Out","value":549},{"label":"Nov","value":245},{"label":"Dez","value":416}];
const MX = 603;
