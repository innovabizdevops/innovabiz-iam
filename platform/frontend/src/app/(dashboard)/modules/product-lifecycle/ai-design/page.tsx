...
const ACCENT = "#6366f1";
const MODULE = "Product Lifecycle";
const PAGE = "AI Design Analysis";
const KPIS = [{"l":"Formulários Ativos","v":"6.408","t":"+9.8%","d":"up"},{"l":"Submissões/Dia","v":"3571","t":"+7.4%","d":"up"},{"l":"Documentos Gerados","v":"4.920","t":"+14.0%","d":"up"},{"l":"Templates","v":"3.582","t":"+3.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.184","2026-02-03","6.654","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.024","2026-02-03","7.073","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.909","2026-01-09","2.503","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.847","2026-01-28","323","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.745","2026-01-11","2.086","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":655},{"label":"Mar","value":948},{"label":"Abr","value":687},{"label":"Mai","value":952},{"label":"Jun","value":617},{"label":"Jul","value":850},{"label":"Ago","value":939},{"label":"Set","value":634},{"label":"Out","value":681},{"label":"Nov","value":961},{"label":"Dez","value":822}];
const MX = 961;
