...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.979","t":"+13.0%","d":"up"},{"l":"Submissões/Dia","v":"3370","t":"+14.3%","d":"up"},{"l":"Documentos Gerados","v":"6.109","t":"+10.6%","d":"up"},{"l":"Templates","v":"3.493","t":"+15.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.503","2026-01-21","6.376","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.937","2026-01-03","5.426","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.191","2026-01-07","3.454","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.873","2026-03-09","4.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","446","2026-02-01","4.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":824},{"label":"Mar","value":673},{"label":"Abr","value":777},{"label":"Mai","value":593},{"label":"Jun","value":790},{"label":"Jul","value":674},{"label":"Ago","value":910},{"label":"Set","value":736},{"label":"Out","value":725},{"label":"Nov","value":916},{"label":"Dez","value":895}];
const MX = 916;
