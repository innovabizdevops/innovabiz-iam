...
const KPIS = [{"l":"Produtos Ativos","v":"5.047","t":"+16.4%","d":"up"},{"l":"SKUs","v":"9.019","t":"-5.0%","d":"down"},{"l":"ECNs Pendentes","v":"3.246","t":"+8.6%","d":"up"},{"l":"Time-to-Market (dias)","v":"4.899","t":"-4.2%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","1.854","3.737","3.814","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","8.575","5.812","6.032","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","9.064","2.260","5.646","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","8.909","4.495","8.597","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","4.036","8.520","2.721","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":764},{"label":"Mar","value":874},{"label":"Abr","value":605},{"label":"Mai","value":706},{"label":"Jun","value":665},{"label":"Jul","value":686},{"label":"Ago","value":729},{"label":"Set","value":650},{"label":"Out","value":631},{"label":"Nov","value":737},{"label":"Dez","value":796}];
const MX = 874;
