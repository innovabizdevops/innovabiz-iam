...
const PAGE = "Launch";
const KPIS = [{"l":"Produtos Ativos","v":"6.665","t":"+6.3%","d":"up"},{"l":"SKUs","v":"8.013","t":"-2.9%","d":"down"},{"l":"ECNs Pendentes","v":"2.832","t":"+9.7%","d":"up"},{"l":"Time-to-Market (dias)","v":"3.548","t":"+11.8%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","3.434","5.939","475","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","2.019","3.798","7.589","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","4.389","7.891","4.937","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","9.069","3.360","8.770","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","5.128","3.775","5.793","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":619},{"label":"Mar","value":320},{"label":"Abr","value":633},{"label":"Mai","value":606},{"label":"Jun","value":362},{"label":"Jul","value":305},{"label":"Ago","value":669},{"label":"Set","value":507},{"label":"Out","value":315},{"label":"Nov","value":598},{"label":"Dez","value":395}];
const MX = 669;
