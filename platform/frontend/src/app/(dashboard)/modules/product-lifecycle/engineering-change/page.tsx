...
const PAGE = "Engineering Change";
const KPIS = [{"l":"Produtos Ativos","v":"3.420","t":"+14.0%","d":"up"},{"l":"SKUs","v":"4.353","t":"-4.7%","d":"down"},{"l":"ECNs Pendentes","v":"2.440","t":"-5.3%","d":"down"},{"l":"Time-to-Market (dias)","v":"948","t":"-2.7%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","6.522","7.624","4.634","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","1.319","4.346","8.543","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","4.181","1.400","4.799","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","8.395","8.548","6.509","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","7.399","6.488","4.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":662},{"label":"Mar","value":657},{"label":"Abr","value":477},{"label":"Mai","value":579},{"label":"Jun","value":782},{"label":"Jul","value":396},{"label":"Ago","value":659},{"label":"Set","value":539},{"label":"Out","value":454},{"label":"Nov","value":733},{"label":"Dez","value":436}];
const MX = 782;
