...
export default function VmsPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vms Platform</h1><p className="text-sm text-muted-foreground">Vms Platform • iBOS Enterprise</p></div>
