...
const PAGE = "Export";
const KPIS = [{"l":"Formulários Ativos","v":"5.467","t":"+17.6%","d":"up"},{"l":"Submissões/Dia","v":"3291","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"2.188","t":"+12.7%","d":"up"},{"l":"Templates","v":"2.745","t":"+3.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.843","2026-01-20","7.203","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.369","2026-02-18","6.652","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.236","2026-03-27","5.939","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.484","2026-01-15","1.711","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.895","2026-03-17","3.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":610},{"label":"Mar","value":491},{"label":"Abr","value":445},{"label":"Mai","value":347},{"label":"Jun","value":618},{"label":"Jul","value":391},{"label":"Ago","value":666},{"label":"Set","value":703},{"label":"Out","value":583},{"label":"Nov","value":607},{"label":"Dez","value":652}];
const MX = 703;
