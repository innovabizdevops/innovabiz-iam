...
const PAGE = "Record";
const KPIS = [{"l":"Formulários Ativos","v":"3.078","t":"+12.2%","d":"up"},{"l":"Submissões/Dia","v":"223","t":"+0.4%","d":"up"},{"l":"Documentos Gerados","v":"5.824","t":"+2.0%","d":"up"},{"l":"Templates","v":"5.644","t":"+16.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.979","2026-02-08","3.867","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.653","2026-02-13","8.647","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.455","2026-02-21","5.362","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.609","2026-01-17","6.730","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.467","2026-01-16","6.197","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":707},{"label":"Mar","value":704},{"label":"Abr","value":942},{"label":"Mai","value":953},{"label":"Jun","value":941},{"label":"Jul","value":868},{"label":"Ago","value":592},{"label":"Set","value":792},{"label":"Out","value":683},{"label":"Nov","value":737},{"label":"Dez","value":913}];
const MX = 953;
