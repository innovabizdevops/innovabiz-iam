...
const PAGE = "Playback";
const KPIS = [{"l":"Formulários Ativos","v":"5.075","t":"+9.5%","d":"up"},{"l":"Submissões/Dia","v":"5018","t":"-3.7%","d":"down"},{"l":"Documentos Gerados","v":"877","t":"-2.9%","d":"down"},{"l":"Templates","v":"7.677","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.933","2026-02-15","6.988","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.826","2026-02-01","7.731","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","227","2026-03-12","3.216","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.546","2026-01-28","2.452","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.988","2026-03-03","7.421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":943},{"label":"Mar","value":852},{"label":"Abr","value":876},{"label":"Mai","value":665},{"label":"Jun","value":805},{"label":"Jul","value":853},{"label":"Ago","value":671},{"label":"Set","value":932},{"label":"Out","value":952},{"label":"Nov","value":880},{"label":"Dez","value":697}];
const MX = 952;
