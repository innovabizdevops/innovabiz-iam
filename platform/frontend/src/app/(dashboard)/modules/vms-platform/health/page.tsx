...
const ACCENT = "#6366f1";
const MODULE = "Video Mgmt System";
const PAGE = "Health";
const KPIS = [{"l":"Formulários Ativos","v":"3.557","t":"+2.3%","d":"up"},{"l":"Submissões/Dia","v":"2998","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"7.490","t":"+7.2%","d":"up"},{"l":"Templates","v":"1.522","t":"+3.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.670","2026-02-18","468","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.353","2026-02-15","4.934","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.564","2026-01-03","6.258","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.256","2026-03-21","2.860","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.611","2026-03-27","6.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":474},{"label":"Mar","value":407},{"label":"Abr","value":670},{"label":"Mai","value":395},{"label":"Jun","value":410},{"label":"Jul","value":385},{"label":"Ago","value":703},{"label":"Set","value":387},{"label":"Out","value":456},{"label":"Nov","value":508},{"label":"Dez","value":528}];
const MX = 703;
