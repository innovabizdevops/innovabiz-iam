...
const PAGE = "Camera";
const KPIS = [{"l":"Formulários Ativos","v":"8.484","t":"+8.8%","d":"up"},{"l":"Submissões/Dia","v":"946","t":"-2.4%","d":"down"},{"l":"Documentos Gerados","v":"3.065","t":"+10.7%","d":"up"},{"l":"Templates","v":"4.823","t":"+15.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.047","2026-02-28","8.228","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.973","2026-01-16","1.861","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.320","2026-01-21","4.541","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.523","2026-03-05","2.725","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.850","2026-03-07","4.318","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":569},{"label":"Mar","value":652},{"label":"Abr","value":764},{"label":"Mai","value":553},{"label":"Jun","value":783},{"label":"Jul","value":676},{"label":"Ago","value":606},{"label":"Set","value":538},{"label":"Out","value":511},{"label":"Nov","value":554},{"label":"Dez","value":533}];
const MX = 783;
