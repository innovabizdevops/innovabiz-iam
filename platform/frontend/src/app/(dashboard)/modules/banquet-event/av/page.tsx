...
const PAGE = "AV Setup";
const KPIS = [{"l":"Total Banquet Event","v":"9.037","t":"+10.6%","d":"up"},{"l":"AV Setup Ativos","v":"6.767","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"57","t":"-0.2%","d":"down"}];
const COLS = ["ID","AV Setup","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Banquet Event #001","Banquet Event #002","8.686","7.550","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Banquet Event #002","Banquet Event #003","588","6.185","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Banquet Event #003","Banquet Event #004","4.704","7.242","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Banquet Event #004","Banquet Event #005","7.552","8.818","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Banquet Event #005","Banquet Event #001","2.330","3.227","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":575},{"label":"Mar","value":589},{"label":"Abr","value":651},{"label":"Mai","value":660},{"label":"Jun","value":664},{"label":"Jul","value":533},{"label":"Ago","value":525},{"label":"Set","value":462},{"label":"Out","value":469},{"label":"Nov","value":616},{"label":"Dez","value":386}];
const MX = 693;
