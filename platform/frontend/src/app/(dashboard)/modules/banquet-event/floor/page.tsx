...
const ACCENT = "#ec4899";
const MODULE = "Banquet & Events";
const PAGE = "Floor Plan";
const KPIS = [{"l":"Total Banquet Event","v":"4.360","t":"+3.3%","d":"up"},{"l":"Floor Plan Ativos","v":"9.090","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"87","t":"+8.7%","d":"up"}];
const COLS = ["ID","Floor Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Banquet Event #001","Banquet Event #002","3.078","5.330","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Banquet Event #002","Banquet Event #003","8.183","6.826","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Banquet Event #003","Banquet Event #004","6.908","8.943","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Banquet Event #004","Banquet Event #005","3.437","838","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Banquet Event #005","Banquet Event #001","7.468","5.058","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":775},{"label":"Mar","value":602},{"label":"Abr","value":695},{"label":"Mai","value":874},{"label":"Jun","value":753},{"label":"Jul","value":886},{"label":"Ago","value":585},{"label":"Set","value":654},{"label":"Out","value":729},{"label":"Nov","value":590},{"label":"Dez","value":554}];
const MX = 886;
