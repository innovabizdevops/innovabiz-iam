...
const PAGE = "BEO Builder";
const KPIS = [{"l":"Total Banquet Event","v":"596","t":"+15.4%","d":"up"},{"l":"BEO Builder Ativos","v":"5.234","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"90","t":"+6.7%","d":"up"}];
const COLS = ["ID","BEO Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Banquet Event #001","Banquet Event #002","8.602","7.268","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Banquet Event #002","Banquet Event #003","1.232","792","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Banquet Event #003","Banquet Event #004","1.847","7.343","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Banquet Event #004","Banquet Event #005","1.032","4.005","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Banquet Event #005","Banquet Event #001","5.522","3.785","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":554},{"label":"Mar","value":799},{"label":"Abr","value":444},{"label":"Mai","value":475},{"label":"Jun","value":632},{"label":"Jul","value":429},{"label":"Ago","value":493},{"label":"Set","value":451},{"label":"Out","value":456},{"label":"Nov","value":684},{"label":"Dez","value":682}];
const MX = 799;
