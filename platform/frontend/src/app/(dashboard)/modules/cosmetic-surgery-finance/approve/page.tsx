...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.533","t":"+13.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.5%","t":"+4.0%","d":"up"},{"l":"Tempo Médio (h)","v":"190h","t":"+2.5%","d":"up"},{"l":"Rejeitadas (%)","v":"93.0%","t":"-0.4%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.824","€ 41828.22","2.591","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.194","€ 27420.61","6.292","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.271","€ 33775.32","4.249","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.930","€ 23432.24","1.712","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.966","€ 42760.58","7.440","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":687},{"label":"Mar","value":858},{"label":"Abr","value":526},{"label":"Mai","value":750},{"label":"Jun","value":884},{"label":"Jul","value":852},{"label":"Ago","value":668},{"label":"Set","value":771},{"label":"Out","value":528},{"label":"Nov","value":527},{"label":"Dez","value":783}];
const MX = 884;
