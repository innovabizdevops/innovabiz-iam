...
const PAGE = "Apply";
const KPIS = [{"l":"Total Cosmetic Surgery Finance","v":"7.144","t":"+2.6%","d":"up"},{"l":"Apply Ativos","v":"2.109","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"83","t":"-1.1%","d":"down"}];
const COLS = ["ID","Apply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Surgery Finance #001","Cosmetic Surgery Finance #002","9.095","2.249","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Surgery Finance #002","Cosmetic Surgery Finance #003","3.231","3.104","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Surgery Finance #003","Cosmetic Surgery Finance #004","5.709","3.411","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Surgery Finance #004","Cosmetic Surgery Finance #005","970","964","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Surgery Finance #005","Cosmetic Surgery Finance #001","548","362","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":497},{"label":"Mar","value":452},{"label":"Abr","value":677},{"label":"Mai","value":444},{"label":"Jun","value":411},{"label":"Jul","value":543},{"label":"Ago","value":477},{"label":"Set","value":565},{"label":"Out","value":678},{"label":"Nov","value":720},{"label":"Dez","value":753}];
const MX = 753;
