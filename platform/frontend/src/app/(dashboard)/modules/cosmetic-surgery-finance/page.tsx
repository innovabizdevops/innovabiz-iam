...
/* ═══ Cosmetic Finance — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "5031", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3252", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€27K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1511121131", cells: ["COS-4131", "Cosmetic Finance Item 1", "24/12/2026", "€21 231"], status: "active" as const },
    { id: "1511124702", cells: ["COS-7702", "Cosmetic Finance Item 2", "11/7/2026", "€24 802"], status: "pending" as const },
    { id: "1511128273", cells: ["COS-2273", "Cosmetic Finance Item 3", "26/2/2026", "€28 373"], status: "completed" as const },
    { id: "1511131844", cells: ["COS-5844", "Cosmetic Finance Item 4", "13/9/2026", "€31 944"], status: "warning" as const },
    { id: "1511135415", cells: ["COS-9415", "Cosmetic Finance Item 5", "28/4/2026", "€35 515"], status: "active" as const },
];
...
export default function CosmeticFinancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cosmetic Finance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cosmetic Finance</p>
                    </div>
                </div>
