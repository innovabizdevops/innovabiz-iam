...
const ACCENT = "#831843";
const MODULE = "Cosmetic Finance";
const PAGE = "Disburse";
const KPIS = [{"l":"Total Cosmetic Surgery Finance","v":"3.537","t":"-3.7%","d":"down"},{"l":"Disburse Ativos","v":"8.293","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"88.0%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+18.0%","d":"up"}];
const COLS = ["ID","Disburse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmetic Surgery Finance #001","Cosmetic Surgery Finance #002","5.463","8.772","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmetic Surgery Finance #002","Cosmetic Surgery Finance #003","6.855","1.370","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmetic Surgery Finance #003","Cosmetic Surgery Finance #004","3.318","1.142","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmetic Surgery Finance #004","Cosmetic Surgery Finance #005","5.430","7.020","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmetic Surgery Finance #005","Cosmetic Surgery Finance #001","5.848","4.596","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":805},{"label":"Mar","value":759},{"label":"Abr","value":732},{"label":"Mai","value":765},{"label":"Jun","value":714},{"label":"Jul","value":844},{"label":"Ago","value":651},{"label":"Set","value":870},{"label":"Out","value":879},{"label":"Nov","value":645},{"label":"Dez","value":838}];
const MX = 879;
