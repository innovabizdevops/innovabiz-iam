...
const PAGE = "Distribuição";
const KPIS = [{"l":"Ativos Registados","v":"5.747","t":"-3.4%","d":"down"},{"l":"Valor Total (€M)","v":"€3.2M","t":"-2.6%","d":"down"},{"l":"Depreciação Anual (€)","v":"€70367","t":"+16.7%","d":"up"},{"l":"Ativos em Garantia","v":"3.109","t":"+3.0%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 45905.96","1.897","€ 42230.74","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 3290.40","4.653","€ 31788.54","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 25793.69","3.125","€ 1838.33","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 35016.27","2.526","€ 18919.75","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 45566.53","6.580","€ 16398.15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":882},{"label":"Mar","value":1087},{"label":"Abr","value":729},{"label":"Mai","value":994},{"label":"Jun","value":773},{"label":"Jul","value":1008},{"label":"Ago","value":864},{"label":"Set","value":847},{"label":"Out","value":1041},{"label":"Nov","value":701},{"label":"Dez","value":848}];
const MX = 1087;
