...
const PAGE = "Fund Admin";
const KPIS = [{"l":"Ativos Registados","v":"8.818","t":"+1.5%","d":"up"},{"l":"Valor Total (€M)","v":"€11.2M","t":"+15.7%","d":"up"},{"l":"Depreciação Anual (€)","v":"€65362","t":"+15.3%","d":"up"},{"l":"Ativos em Garantia","v":"5.586","t":"+6.6%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 21949.00","6.018","€ 3231.36","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 44082.14","6.725","€ 4219.95","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 27068.10","2.417","€ 644.11","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 14016.86","6.462","€ 361.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 49787.80","3.078","€ 19613.67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":748},{"label":"Mar","value":668},{"label":"Abr","value":598},{"label":"Mai","value":732},{"label":"Jun","value":862},{"label":"Jul","value":847},{"label":"Ago","value":644},{"label":"Set","value":731},{"label":"Out","value":673},{"label":"Nov","value":651},{"label":"Dez","value":589}];
const MX = 882;
