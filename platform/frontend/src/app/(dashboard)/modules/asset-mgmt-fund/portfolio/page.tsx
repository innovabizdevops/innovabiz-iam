...
const KPIS = [{"l":"Ativos Registados","v":"2.514","t":"+8.6%","d":"up"},{"l":"Valor Total (€M)","v":"€16.1M","t":"+1.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€12101","t":"+0.3%","d":"up"},{"l":"Ativos em Garantia","v":"7.292","t":"+13.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 32819.84","1.685","€ 35539.57","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 8316.96","2.566","€ 1938.48","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 29918.92","2.321","€ 47000.16","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 45954.49","7.045","€ 49043.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 26483.15","2.639","€ 6589.44","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":871},{"label":"Mar","value":937},{"label":"Abr","value":750},{"label":"Mai","value":719},{"label":"Jun","value":918},{"label":"Jul","value":1037},{"label":"Ago","value":1057},{"label":"Set","value":1035},{"label":"Out","value":902},{"label":"Nov","value":833},{"label":"Dez","value":770}];
const MX = 1057;
