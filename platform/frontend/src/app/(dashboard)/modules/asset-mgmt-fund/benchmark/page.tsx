...
const KPIS = [{"l":"Ativos Registados","v":"3.149","t":"-5.8%","d":"down"},{"l":"Valor Total (€M)","v":"€19.2M","t":"-4.8%","d":"down"},{"l":"Depreciação Anual (€)","v":"€31882","t":"+13.3%","d":"up"},{"l":"Ativos em Garantia","v":"3.948","t":"+13.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 34808.57","6.928","€ 8474.25","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 48520.00","6.000","€ 9067.24","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 41784.39","4.835","€ 41687.21","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 11444.52","5.919","€ 26529.06","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 40639.62","7.171","€ 28079.21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":472},{"label":"Mar","value":667},{"label":"Abr","value":405},{"label":"Mai","value":595},{"label":"Jun","value":505},{"label":"Jul","value":555},{"label":"Ago","value":481},{"label":"Set","value":752},{"label":"Out","value":428},{"label":"Nov","value":702},{"label":"Dez","value":430}];
const MX = 752;
