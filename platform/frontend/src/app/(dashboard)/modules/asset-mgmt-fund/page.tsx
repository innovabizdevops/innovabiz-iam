...
export default function AssetMgmtFundPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Asset Mgmt Fund</h1><p className="text-sm text-muted-foreground">Asset Mgmt Fund • iBOS Enterprise</p></div>
