...
const KPIS = [{"l":"Formulários Ativos","v":"359","t":"+1.1%","d":"up"},{"l":"Submissões/Dia","v":"649","t":"+4.9%","d":"up"},{"l":"Documentos Gerados","v":"2.686","t":"+10.7%","d":"up"},{"l":"Templates","v":"131","t":"+4.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","839","2026-01-12","4.823","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.761","2026-01-10","3.138","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.519","2026-01-06","5.981","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.063","2026-02-27","6.601","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.569","2026-03-23","6.243","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":487},{"label":"Mar","value":490},{"label":"Abr","value":596},{"label":"Mai","value":771},{"label":"Jun","value":631},{"label":"Jul","value":532},{"label":"Ago","value":379},{"label":"Set","value":718},{"label":"Out","value":478},{"label":"Nov","value":611},{"label":"Dez","value":654}];
const MX = 771;
