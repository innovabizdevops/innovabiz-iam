...
/* ═══ Perfume & Cosmetics — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "5185", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "226", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€28K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "876937185", cells: ["PER-5185", "Perfume & Cosmetics Item 1", "6/10/2026", "€37 285"], status: "active" as const },
    { id: "876940756", cells: ["PER-8756", "Perfume & Cosmetics Item 2", "21/5/2026", "€40 856"], status: "pending" as const },
    { id: "876944327", cells: ["PER-3327", "Perfume & Cosmetics Item 3", "8/12/2026", "€44 427"], status: "completed" as const },
    { id: "876947898", cells: ["PER-6898", "Perfume & Cosmetics Item 4", "23/7/2026", "€47 998"], status: "warning" as const },
    { id: "876951469", cells: ["PER-1469", "Perfume & Cosmetics Item 5", "10/2/2026", "€1569"], status: "active" as const },
];
...
export default function PerfumeCosmeticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Perfume & Cosmetics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Perfume & Cosmetics</p>
                    </div>
                </div>
