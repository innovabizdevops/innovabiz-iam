...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Highway Bridge","v":"3.591","t":"+16.5%","d":"up"},{"l":"Inspect Ativos","v":"1.383","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"67.1%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"57","t":"+2.2%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Highway Bridge #001","Highway Bridge #002","8.785","805","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Highway Bridge #002","Highway Bridge #003","3.530","858","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Highway Bridge #003","Highway Bridge #004","7.821","8.913","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Highway Bridge #004","Highway Bridge #005","6.395","3.750","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Highway Bridge #005","Highway Bridge #001","3.230","4.987","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":252},{"label":"Fev","value":343},{"label":"Mar","value":324},{"label":"Abr","value":353},{"label":"Mai","value":404},{"label":"Jun","value":543},{"label":"Jul","value":270},{"label":"Ago","value":329},{"label":"Set","value":447},{"label":"Out","value":372},{"label":"Nov","value":280},{"label":"Dez","value":541}];
const MX = 543;
