...
export default function HighwayBridgePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Highway Bridge</h1><p className="text-sm text-muted-foreground">Highway Bridge • iBOS Enterprise</p></div>
