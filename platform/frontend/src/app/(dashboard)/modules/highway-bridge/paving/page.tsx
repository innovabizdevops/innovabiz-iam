...
const ACCENT = "#6366f1";
const MODULE = "Highway & Bridge";
const PAGE = "Paving";
const KPIS = [{"l":"Total Highway Bridge","v":"9.014","t":"+12.6%","d":"up"},{"l":"Paving Ativos","v":"3.769","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"85","t":"+4.8%","d":"up"}];
const COLS = ["ID","Paving","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Highway Bridge #001","Highway Bridge #002","7.212","2.411","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Highway Bridge #002","Highway Bridge #003","2.511","5.790","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Highway Bridge #003","Highway Bridge #004","1.713","1.245","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Highway Bridge #004","Highway Bridge #005","6.953","3.443","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Highway Bridge #005","Highway Bridge #001","4.605","4.693","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":834},{"label":"Mar","value":639},{"label":"Abr","value":893},{"label":"Mai","value":670},{"label":"Jun","value":531},{"label":"Jul","value":899},{"label":"Ago","value":801},{"label":"Set","value":689},{"label":"Out","value":821},{"label":"Nov","value":588},{"label":"Dez","value":900}];
const MX = 900;
