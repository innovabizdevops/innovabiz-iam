...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.468","t":"-3.1%","d":"down"},{"l":"Submissões/Dia","v":"3688","t":"+3.2%","d":"up"},{"l":"Documentos Gerados","v":"3.708","t":"+9.3%","d":"up"},{"l":"Templates","v":"6.124","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.710","2026-01-08","5.051","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.282","2026-03-22","6.145","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.447","2026-02-20","4.177","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.789","2026-02-27","2.840","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.392","2026-03-07","6.803","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":641},{"label":"Mar","value":798},{"label":"Abr","value":534},{"label":"Mai","value":809},{"label":"Jun","value":621},{"label":"Jul","value":672},{"label":"Ago","value":642},{"label":"Set","value":786},{"label":"Out","value":831},{"label":"Nov","value":768},{"label":"Dez","value":458}];
const MX = 831;
