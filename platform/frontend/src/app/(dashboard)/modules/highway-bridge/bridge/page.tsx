...
const PAGE = "Bridge";
const KPIS = [{"l":"Total Highway Bridge","v":"7.021","t":"+6.4%","d":"up"},{"l":"Bridge Ativos","v":"8.156","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"66.1%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+15.9%","d":"up"}];
const COLS = ["ID","Bridge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Highway Bridge #001","Highway Bridge #002","3.671","3.472","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Highway Bridge #002","Highway Bridge #003","1.567","2.171","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Highway Bridge #003","Highway Bridge #004","6.245","6.592","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Highway Bridge #004","Highway Bridge #005","2.226","8.581","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Highway Bridge #005","Highway Bridge #001","7.202","5.111","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":817},{"label":"Mar","value":822},{"label":"Abr","value":662},{"label":"Mai","value":562},{"label":"Jun","value":738},{"label":"Jul","value":574},{"label":"Ago","value":902},{"label":"Set","value":692},{"label":"Out","value":806},{"label":"Nov","value":519},{"label":"Dez","value":606}];
const MX = 902;
