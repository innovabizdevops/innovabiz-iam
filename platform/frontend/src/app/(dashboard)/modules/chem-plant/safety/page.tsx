...
const PAGE = "Safety";
const KPIS = [{"l":"Total Chem Plant","v":"7.588","t":"+9.8%","d":"up"},{"l":"Safety Ativos","v":"3.920","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"82","t":"-3.6%","d":"down"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chem Plant #001","Chem Plant #002","7.092","6.350","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Chem Plant #002","Chem Plant #003","8.482","5.548","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Chem Plant #003","Chem Plant #004","2.291","4.348","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Chem Plant #004","Chem Plant #005","3.247","7.157","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chem Plant #005","Chem Plant #001","4.062","1.284","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":794},{"label":"Mar","value":932},{"label":"Abr","value":997},{"label":"Mai","value":792},{"label":"Jun","value":998},{"label":"Jul","value":775},{"label":"Ago","value":777},{"label":"Set","value":1041},{"label":"Out","value":707},{"label":"Nov","value":1037},{"label":"Dez","value":754}];
const MX = 1041;
