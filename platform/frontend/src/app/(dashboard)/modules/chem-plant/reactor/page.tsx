...
const PAGE = "Reactor";
const KPIS = [{"l":"Total Chem Plant","v":"3.622","t":"+3.9%","d":"up"},{"l":"Reactor Ativos","v":"8.140","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+12.2%","d":"up"}];
const COLS = ["ID","Reactor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chem Plant #001","Chem Plant #002","1.745","117","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Chem Plant #002","Chem Plant #003","1.280","4.035","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Chem Plant #003","Chem Plant #004","1.569","4.134","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Chem Plant #004","Chem Plant #005","860","6.407","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chem Plant #005","Chem Plant #001","8.933","2.387","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":558},{"label":"Mar","value":460},{"label":"Abr","value":708},{"label":"Mai","value":695},{"label":"Jun","value":745},{"label":"Jul","value":394},{"label":"Ago","value":737},{"label":"Set","value":407},{"label":"Out","value":453},{"label":"Nov","value":703},{"label":"Dez","value":479}];
const MX = 745;
