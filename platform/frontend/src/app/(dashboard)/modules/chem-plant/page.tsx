...
export default function ChemPlantPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Chem Plant</h1><p className="text-sm text-muted-foreground">Chem Plant • iBOS Enterprise</p></div>
