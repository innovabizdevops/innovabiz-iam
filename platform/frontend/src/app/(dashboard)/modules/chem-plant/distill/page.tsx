...
const KPIS = [{"l":"Total Chem Plant","v":"6.972","t":"+3.1%","d":"up"},{"l":"Distillation Ativos","v":"6.352","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"89.4%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"95","t":"+3.8%","d":"up"}];
const COLS = ["ID","Distillation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chem Plant #001","Chem Plant #002","3.567","4.249","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Chem Plant #002","Chem Plant #003","8.948","1.546","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Chem Plant #003","Chem Plant #004","7.067","1.519","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Chem Plant #004","Chem Plant #005","1.413","7.119","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chem Plant #005","Chem Plant #001","8.141","1.816","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":531},{"label":"Mar","value":622},{"label":"Abr","value":567},{"label":"Mai","value":624},{"label":"Jun","value":603},{"label":"Jul","value":387},{"label":"Ago","value":285},{"label":"Set","value":371},{"label":"Out","value":341},{"label":"Nov","value":476},{"label":"Dez","value":423}];
const MX = 624;
