...
const ACCENT = "#6366f1";
const MODULE = "Chemical Plant";
const PAGE = "REACH";
const KPIS = [{"l":"Total Chem Plant","v":"2.692","t":"+8.9%","d":"up"},{"l":"REACH Ativos","v":"1.648","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+6.7%","d":"up"}];
const COLS = ["ID","REACH","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chem Plant #001","Chem Plant #002","3.292","752","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Chem Plant #002","Chem Plant #003","650","3.377","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Chem Plant #003","Chem Plant #004","2.062","6.633","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Chem Plant #004","Chem Plant #005","5.919","2.128","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chem Plant #005","Chem Plant #001","8.362","2.560","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1009},{"label":"Fev","value":699},{"label":"Mar","value":854},{"label":"Abr","value":800},{"label":"Mai","value":820},{"label":"Jun","value":984},{"label":"Jul","value":1046},{"label":"Ago","value":730},{"label":"Set","value":688},{"label":"Out","value":796},{"label":"Nov","value":891},{"label":"Dez","value":711}];
const MX = 1046;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>REACH</span></h1>
                </div>
