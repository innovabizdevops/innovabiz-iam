...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.798","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"4.405","t":"-3.2%","d":"down"},{"l":"Conformidade (%)","v":"65.8%","t":"+17.7%","d":"up"},{"l":"CAPAs Pendentes","v":"1.395","t":"+16.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","893","77.9%","3.118","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.279","76.0%","6.089","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.506","80.7%","3.164","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.027","77.0%","4.530","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.772","85.2%","8.138","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":970},{"label":"Fev","value":659},{"label":"Mar","value":782},{"label":"Abr","value":684},{"label":"Mai","value":980},{"label":"Jun","value":612},{"label":"Jul","value":752},{"label":"Ago","value":958},{"label":"Set","value":763},{"label":"Out","value":871},{"label":"Nov","value":662},{"label":"Dez","value":616}];
const MX = 980;
