...
const KPIS = [{"l":"Formulários Ativos","v":"8.196","t":"+6.4%","d":"up"},{"l":"Submissões/Dia","v":"1327","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"2.703","t":"+12.4%","d":"up"},{"l":"Templates","v":"5.016","t":"+16.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.474","2026-03-24","8.441","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.443","2026-02-15","8.396","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","484","2026-03-14","7.189","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.125","2026-02-25","5.891","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","936","2026-01-28","846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":832},{"label":"Mar","value":709},{"label":"Abr","value":511},{"label":"Mai","value":633},{"label":"Jun","value":751},{"label":"Jul","value":873},{"label":"Ago","value":717},{"label":"Set","value":530},{"label":"Out","value":592},{"label":"Nov","value":658},{"label":"Dez","value":847}];
const MX = 873;
