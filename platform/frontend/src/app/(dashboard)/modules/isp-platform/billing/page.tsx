...
const PAGE = "Billing";
const KPIS = [{"l":"Formulários Ativos","v":"8.992","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"2519","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"426","t":"+7.0%","d":"up"},{"l":"Templates","v":"4.943","t":"+4.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","938","2026-03-25","932","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.582","2026-02-28","8.975","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.151","2026-03-28","9.094","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.014","2026-02-26","5.384","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.707","2026-01-20","8.043","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":742},{"label":"Mar","value":563},{"label":"Abr","value":366},{"label":"Mai","value":376},{"label":"Jun","value":642},{"label":"Jul","value":718},{"label":"Ago","value":690},{"label":"Set","value":550},{"label":"Out","value":565},{"label":"Nov","value":717},{"label":"Dez","value":366}];
const MX = 742;
