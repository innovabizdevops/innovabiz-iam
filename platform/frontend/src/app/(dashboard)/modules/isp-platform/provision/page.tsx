...
const KPIS = [{"l":"Formulários Ativos","v":"7.982","t":"+16.9%","d":"up"},{"l":"Submissões/Dia","v":"482","t":"+17.0%","d":"up"},{"l":"Documentos Gerados","v":"3.857","t":"-2.7%","d":"down"},{"l":"Templates","v":"4.993","t":"+2.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.720","2026-02-23","6.400","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.666","2026-03-08","4.914","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.947","2026-01-27","3.564","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.530","2026-01-23","7.263","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.502","2026-01-22","6.838","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":282},{"label":"Mar","value":252},{"label":"Abr","value":571},{"label":"Mai","value":451},{"label":"Jun","value":531},{"label":"Jul","value":290},{"label":"Ago","value":473},{"label":"Set","value":362},{"label":"Out","value":470},{"label":"Nov","value":567},{"label":"Dez","value":320}];
const MX = 571;
