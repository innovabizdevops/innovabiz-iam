...
const ACCENT = "#9a3412";
const MODULE = "ISP Platform";
const PAGE = "Subscriber";
const KPIS = [{"l":"Formulários Ativos","v":"3.297","t":"+5.7%","d":"up"},{"l":"Submissões/Dia","v":"3210","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"151","t":"-0.6%","d":"down"},{"l":"Templates","v":"1.731","t":"+9.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.646","2026-02-03","7.950","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.565","2026-01-12","5.146","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","505","2026-01-12","1.318","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.634","2026-01-04","8.831","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.513","2026-01-20","3.264","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":929},{"label":"Mar","value":824},{"label":"Abr","value":767},{"label":"Mai","value":722},{"label":"Jun","value":631},{"label":"Jul","value":658},{"label":"Ago","value":637},{"label":"Set","value":805},{"label":"Out","value":665},{"label":"Nov","value":922},{"label":"Dez","value":654}];
const MX = 929;
