...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"8.061","t":"-4.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"69.1%","t":"-1.6%","d":"down"},{"l":"MTTR (h)","v":"193h","t":"+3.9%","d":"up"},{"l":"Satisfação (%)","v":"71.0%","t":"+7.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.647","452","3.853","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.849","1.258","6.092","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.758","7.128","405","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.633","8.629","4.193","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","661","5.865","3.487","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":557},{"label":"Mar","value":352},{"label":"Abr","value":712},{"label":"Mai","value":352},{"label":"Jun","value":468},{"label":"Jul","value":566},{"label":"Ago","value":638},{"label":"Set","value":488},{"label":"Out","value":596},{"label":"Nov","value":649},{"label":"Dez","value":357}];
const MX = 712;
