...
export default function IspPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Isp Platform</h1><p className="text-sm text-muted-foreground">Isp Platform • iBOS Enterprise</p></div>
            </div>
