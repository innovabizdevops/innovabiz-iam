...
const KPIS = [
    { label: "Total Registos", value: "436", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4424", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€431K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "477031836", cells: ["VET-5836", "Veterinary Management Item 1", "9/1/2026", "€31 936"], status: "active" as const },
    { id: "477035407", cells: ["VET-9407", "Veterinary Management Item 2", "24/8/2026", "€35 507"], status: "pending" as const },
    { id: "477038978", cells: ["VET-3978", "Veterinary Management Item 3", "11/3/2026", "€39 078"], status: "completed" as const },
    { id: "477042549", cells: ["VET-7549", "Veterinary Management Item 4", "26/10/2026", "€42 649"], status: "warning" as const },
    { id: "477046120", cells: ["VET-2120", "Veterinary Management Item 5", "13/5/2026", "€46 220"], status: "active" as const },
];
...
export default function VeterinaryManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Veterinary Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Veterinary Management</p>
                    </div>
                </div>
