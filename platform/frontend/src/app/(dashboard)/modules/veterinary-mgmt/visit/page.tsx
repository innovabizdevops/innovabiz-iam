...
const PAGE = "Visit";
const KPIS = [{"l":"Total Veterinary Mgmt","v":"2.325","t":"+14.7%","d":"up"},{"l":"Visit Ativos","v":"6.404","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"74.4%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+15.8%","d":"up"}];
const COLS = ["ID","Visit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veterinary Mgmt #001","Veterinary Mgmt #002","5.975","4.611","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Veterinary Mgmt #002","Veterinary Mgmt #003","5.258","2.968","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Veterinary Mgmt #003","Veterinary Mgmt #004","4.398","8.602","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Veterinary Mgmt #004","Veterinary Mgmt #005","8.357","4.964","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veterinary Mgmt #005","Veterinary Mgmt #001","6.080","3.651","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":575},{"label":"Mar","value":471},{"label":"Abr","value":536},{"label":"Mai","value":634},{"label":"Jun","value":661},{"label":"Jul","value":548},{"label":"Ago","value":544},{"label":"Set","value":516},{"label":"Out","value":661},{"label":"Nov","value":548},{"label":"Dez","value":658}];
const MX = 661;
