...
const ACCENT = "#65a30d";
const MODULE = "Veterinary Management";
const PAGE = "Prescription";
const KPIS = [{"l":"Total Veterinary Mgmt","v":"5.533","t":"+1.2%","d":"up"},{"l":"Prescription Ativos","v":"7.846","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"88.1%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"75","t":"-2.7%","d":"down"}];
const COLS = ["ID","Prescription","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veterinary Mgmt #001","Veterinary Mgmt #002","6.247","7.827","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Veterinary Mgmt #002","Veterinary Mgmt #003","5.775","2.664","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Veterinary Mgmt #003","Veterinary Mgmt #004","6.217","8.953","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Veterinary Mgmt #004","Veterinary Mgmt #005","7.981","3.227","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veterinary Mgmt #005","Veterinary Mgmt #001","8.297","6.248","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":367},{"label":"Fev","value":742},{"label":"Mar","value":547},{"label":"Abr","value":378},{"label":"Mai","value":670},{"label":"Jun","value":440},{"label":"Jul","value":630},{"label":"Ago","value":651},{"label":"Set","value":662},{"label":"Out","value":701},{"label":"Nov","value":449},{"label":"Dez","value":565}];
const MX = 742;
