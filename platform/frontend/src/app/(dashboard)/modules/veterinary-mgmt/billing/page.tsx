...
const PAGE = "Billing";
const KPIS = [{"l":"Total Veterinary Mgmt","v":"1.797","t":"+6.2%","d":"up"},{"l":"Billing Ativos","v":"2.077","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"85","t":"-3.7%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veterinary Mgmt #001","Veterinary Mgmt #002","1.090","6.984","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Veterinary Mgmt #002","Veterinary Mgmt #003","7.402","5.143","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Veterinary Mgmt #003","Veterinary Mgmt #004","8.881","3.785","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Veterinary Mgmt #004","Veterinary Mgmt #005","4.764","501","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veterinary Mgmt #005","Veterinary Mgmt #001","1.642","2.211","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":523},{"label":"Mar","value":343},{"label":"Abr","value":734},{"label":"Mai","value":517},{"label":"Jun","value":576},{"label":"Jul","value":357},{"label":"Ago","value":438},{"label":"Set","value":616},{"label":"Out","value":700},{"label":"Nov","value":373},{"label":"Dez","value":573}];
const MX = 734;
