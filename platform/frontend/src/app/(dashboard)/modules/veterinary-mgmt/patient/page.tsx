...
const PAGE = "Patient";
const KPIS = [{"l":"Total Veterinary Mgmt","v":"7.988","t":"-2.7%","d":"down"},{"l":"Patient Ativos","v":"3.876","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"66","t":"+6.2%","d":"up"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veterinary Mgmt #001","Veterinary Mgmt #002","1.108","6.320","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Veterinary Mgmt #002","Veterinary Mgmt #003","5.128","974","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Veterinary Mgmt #003","Veterinary Mgmt #004","1.744","5.640","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Veterinary Mgmt #004","Veterinary Mgmt #005","3.805","3.620","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veterinary Mgmt #005","Veterinary Mgmt #001","1.065","8.322","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1057},{"label":"Fev","value":689},{"label":"Mar","value":1023},{"label":"Abr","value":772},{"label":"Mai","value":758},{"label":"Jun","value":859},{"label":"Jul","value":1019},{"label":"Ago","value":795},{"label":"Set","value":698},{"label":"Out","value":859},{"label":"Nov","value":895},{"label":"Dez","value":950}];
const MX = 1057;
