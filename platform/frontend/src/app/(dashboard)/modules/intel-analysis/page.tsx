...
export default function IntelAnalysisPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Intel Analysis</h1><p className="text-sm text-muted-foreground">Intel Analysis • iBOS Enterprise</p></div>
