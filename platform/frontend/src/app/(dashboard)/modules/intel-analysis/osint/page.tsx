...
const ACCENT = "#0e7490";
const MODULE = "Intelligence Analysis";
const PAGE = "OSINT";
const KPIS = [{"l":"Dashboards Ativos","v":"5.989","t":"+0.1%","d":"up"},{"l":"Queries/Dia","v":"2647","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"5.053","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.471","t":"+6.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","669","2026-03-11","4.222","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3043","2026-02-08","8.489","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3273","2026-03-23","3.280","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1059","2026-03-10","2.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3987","2026-02-18","3.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":315},{"label":"Fev","value":642},{"label":"Mar","value":440},{"label":"Abr","value":436},{"label":"Mai","value":337},{"label":"Jun","value":483},{"label":"Jul","value":448},{"label":"Ago","value":253},{"label":"Set","value":451},{"label":"Out","value":509},{"label":"Nov","value":512},{"label":"Dez","value":540}];
const MX = 642;
