...
const PAGE = "Product Distrib";
const KPIS = [{"l":"Dashboards Ativos","v":"4.039","t":"+7.2%","d":"up"},{"l":"Queries/Dia","v":"3838","t":"+11.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.257","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"666","t":"+2.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1071","2026-02-13","4.995","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1743","2026-03-17","141","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4731","2026-02-04","2.731","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4637","2026-03-24","4.244","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1546","2026-02-11","7.558","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":1029},{"label":"Mar","value":686},{"label":"Abr","value":848},{"label":"Mai","value":985},{"label":"Jun","value":776},{"label":"Jul","value":897},{"label":"Ago","value":952},{"label":"Set","value":1020},{"label":"Out","value":828},{"label":"Nov","value":764},{"label":"Dez","value":974}];
const MX = 1029;
