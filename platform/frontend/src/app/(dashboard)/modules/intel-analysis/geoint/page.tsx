...
const PAGE = "GEOINT";
const KPIS = [{"l":"Dashboards Ativos","v":"8.888","t":"+4.7%","d":"up"},{"l":"Queries/Dia","v":"5099","t":"+5.0%","d":"up"},{"l":"Dados Processados (GB)","v":"9.017","t":"+7.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.658","t":"+0.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2990","2026-02-01","2.512","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1167","2026-02-05","2.963","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3564","2026-03-20","939","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","893","2026-01-14","6.675","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1737","2026-01-22","1.830","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":390},{"label":"Mar","value":720},{"label":"Abr","value":687},{"label":"Mai","value":385},{"label":"Jun","value":702},{"label":"Jul","value":485},{"label":"Ago","value":599},{"label":"Set","value":563},{"label":"Out","value":564},{"label":"Nov","value":678},{"label":"Dez","value":573}];
const MX = 720;
