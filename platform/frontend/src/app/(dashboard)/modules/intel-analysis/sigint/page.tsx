...
const PAGE = "SIGINT";
const KPIS = [{"l":"Dashboards Ativos","v":"5.143","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"1864","t":"+0.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.641","t":"+7.8%","d":"up"},{"l":"Utilizadores Analytics","v":"5.266","t":"-2.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2981","2026-01-17","3.362","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","194","2026-03-12","8.770","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2202","2026-03-13","5.647","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","736","2026-03-21","8.664","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4849","2026-01-11","1.544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":392},{"label":"Mar","value":374},{"label":"Abr","value":388},{"label":"Mai","value":549},{"label":"Jun","value":560},{"label":"Jul","value":323},{"label":"Ago","value":382},{"label":"Set","value":338},{"label":"Out","value":448},{"label":"Nov","value":439},{"label":"Dez","value":666}];
const MX = 666;
