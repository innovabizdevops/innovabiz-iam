...
const PAGE = "HUMINT";
const KPIS = [{"l":"Dashboards Ativos","v":"4.843","t":"+15.3%","d":"up"},{"l":"Queries/Dia","v":"3558","t":"-1.3%","d":"down"},{"l":"Dados Processados (GB)","v":"718","t":"-2.6%","d":"down"},{"l":"Utilizadores Analytics","v":"7.981","t":"+12.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4498","2026-03-17","7.460","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2702","2026-03-20","7.510","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4827","2026-01-01","4.635","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","662","2026-02-24","1.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3427","2026-02-01","6.022","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":375},{"label":"Mar","value":466},{"label":"Abr","value":498},{"label":"Mai","value":354},{"label":"Jun","value":558},{"label":"Jul","value":614},{"label":"Ago","value":469},{"label":"Set","value":572},{"label":"Out","value":553},{"label":"Nov","value":479},{"label":"Dez","value":342}];
const MX = 614;
