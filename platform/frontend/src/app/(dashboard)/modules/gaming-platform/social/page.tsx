...
const PAGE = "Social";
const KPIS = [{"l":"Formulários Ativos","v":"3.218","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"4903","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"5.543","t":"-2.1%","d":"down"},{"l":"Templates","v":"5.004","t":"+9.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.665","2026-01-04","1.763","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","167","2026-02-23","6.722","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","144","2026-01-13","8.570","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.324","2026-01-06","7.707","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.083","2026-02-05","2.230","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":878},{"label":"Mar","value":521},{"label":"Abr","value":744},{"label":"Mai","value":527},{"label":"Jun","value":866},{"label":"Jul","value":868},{"label":"Ago","value":588},{"label":"Set","value":808},{"label":"Out","value":831},{"label":"Nov","value":806},{"label":"Dez","value":889}];
const MX = 889;
