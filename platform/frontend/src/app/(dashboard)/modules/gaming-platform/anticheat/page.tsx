...
const PAGE = "Anti-Cheat";
const KPIS = [{"l":"Formulários Ativos","v":"151","t":"-1.7%","d":"down"},{"l":"Submissões/Dia","v":"4377","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"5.986","t":"-2.2%","d":"down"},{"l":"Templates","v":"2.902","t":"-3.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.863","2026-03-13","3.917","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.390","2026-03-25","3.071","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.298","2026-03-25","184","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.191","2026-01-12","5.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.479","2026-03-09","2.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":748},{"label":"Mar","value":916},{"label":"Abr","value":973},{"label":"Mai","value":868},{"label":"Jun","value":781},{"label":"Jul","value":731},{"label":"Ago","value":693},{"label":"Set","value":982},{"label":"Out","value":784},{"label":"Nov","value":983},{"label":"Dez","value":983}];
const MX = 983;
