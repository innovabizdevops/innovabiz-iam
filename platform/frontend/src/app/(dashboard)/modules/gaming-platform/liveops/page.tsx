...
const PAGE = "Live Ops";
const KPIS = [{"l":"Formulários Ativos","v":"697","t":"-4.4%","d":"down"},{"l":"Submissões/Dia","v":"4228","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"4.902","t":"-4.8%","d":"down"},{"l":"Templates","v":"7.500","t":"+15.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.727","2026-01-02","4.673","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.724","2026-02-24","4.394","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.024","2026-01-26","2.820","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.148","2026-03-21","1.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.238","2026-03-15","5.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":629},{"label":"Mar","value":854},{"label":"Abr","value":714},{"label":"Mai","value":636},{"label":"Jun","value":795},{"label":"Jul","value":685},{"label":"Ago","value":592},{"label":"Set","value":518},{"label":"Out","value":585},{"label":"Nov","value":579},{"label":"Dez","value":846}];
const MX = 854;
