...
const PAGE = "Economy";
const KPIS = [{"l":"Formulários Ativos","v":"5.893","t":"+3.3%","d":"up"},{"l":"Submissões/Dia","v":"1227","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"5.345","t":"+6.1%","d":"up"},{"l":"Templates","v":"3.588","t":"+3.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.832","2026-01-04","4.804","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.679","2026-02-28","6.745","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.441","2026-01-02","6.443","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.572","2026-03-16","6.746","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.611","2026-03-11","7.321","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":775},{"label":"Mar","value":742},{"label":"Abr","value":620},{"label":"Mai","value":835},{"label":"Jun","value":676},{"label":"Jul","value":653},{"label":"Ago","value":627},{"label":"Set","value":792},{"label":"Out","value":477},{"label":"Nov","value":551},{"label":"Dez","value":506}];
const MX = 835;
