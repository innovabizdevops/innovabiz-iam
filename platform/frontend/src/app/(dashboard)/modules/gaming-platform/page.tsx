...
/* ═══ Gaming Platform Deep — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "2184", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2014", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€130K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "813336584", cells: ["GAM-7584", "Gaming Platform Deep Item 1", "5/9/2026", "€36 684"], status: "active" as const },
    { id: "813340155", cells: ["GAM-2155", "Gaming Platform Deep Item 2", "20/4/2026", "€40 255"], status: "pending" as const },
    { id: "813343726", cells: ["GAM-5726", "Gaming Platform Deep Item 3", "7/11/2026", "€43 826"], status: "completed" as const },
    { id: "813347297", cells: ["GAM-9297", "Gaming Platform Deep Item 4", "22/6/2026", "€47 397"], status: "warning" as const },
    { id: "813350868", cells: ["GAM-3868", "Gaming Platform Deep Item 5", "9/1/2026", "€968"], status: "active" as const },
];
...
export default function GamingPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Gaming Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Gaming Platform Deep</p>
                    </div>
                </div>
