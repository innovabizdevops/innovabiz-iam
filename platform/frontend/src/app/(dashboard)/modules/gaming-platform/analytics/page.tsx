...
const ACCENT = "#6d28d9";
const MODULE = "Gaming Platform Deep";
const PAGE = "Analytics";
const KPIS = [{"l":"Formulários Ativos","v":"2.827","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"527","t":"+15.6%","d":"up"},{"l":"Documentos Gerados","v":"4.532","t":"+5.9%","d":"up"},{"l":"Templates","v":"2.543","t":"+4.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.575","2026-03-15","201","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.502","2026-01-20","1.286","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.818","2026-03-01","3.848","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.563","2026-03-07","2.634","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.901","2026-01-24","6.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":727},{"label":"Mar","value":344},{"label":"Abr","value":377},{"label":"Mai","value":456},{"label":"Jun","value":557},{"label":"Jul","value":707},{"label":"Ago","value":654},{"label":"Set","value":481},{"label":"Out","value":430},{"label":"Nov","value":561},{"label":"Dez","value":568}];
const MX = 727;
