...
const PAGE = "Obligation Track";
const KPIS = [{"l":"Dashboards Ativos","v":"4.779","t":"+0.4%","d":"up"},{"l":"Queries/Dia","v":"4027","t":"+5.5%","d":"up"},{"l":"Dados Processados (GB)","v":"761","t":"+12.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.781","t":"+12.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3194","2026-01-24","8.369","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","419","2026-01-22","8.383","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2399","2026-02-21","5.875","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1290","2026-01-14","7.234","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1553","2026-03-18","1.689","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":643},{"label":"Mar","value":550},{"label":"Abr","value":582},{"label":"Mai","value":620},{"label":"Jun","value":691},{"label":"Jul","value":737},{"label":"Ago","value":628},{"label":"Set","value":832},{"label":"Out","value":694},{"label":"Nov","value":560},{"label":"Dez","value":545}];
const MX = 832;
