...
const PAGE = "Comparison";
const KPIS = [{"l":"Auditorias Realizadas","v":"751","t":"+1.7%","d":"up"},{"l":"NC Abertas","v":"8.350","t":"+14.8%","d":"up"},{"l":"Conformidade (%)","v":"94.6%","t":"+3.9%","d":"up"},{"l":"CAPAs Pendentes","v":"4.346","t":"-1.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.410","84.5%","8.585","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.399","78.3%","8.310","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.161","83.2%","8.223","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.624","71.8%","8.220","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.382","95.4%","3.715","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":970},{"label":"Fev","value":843},{"label":"Mar","value":915},{"label":"Abr","value":784},{"label":"Mai","value":883},{"label":"Jun","value":665},{"label":"Jul","value":710},{"label":"Ago","value":884},{"label":"Set","value":932},{"label":"Out","value":771},{"label":"Nov","value":703},{"label":"Dez","value":946}];
const MX = 970;
