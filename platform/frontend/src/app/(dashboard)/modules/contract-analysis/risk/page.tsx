...
const PAGE = "Risk Clause";
const KPIS = [{"l":"Riscos Identificados","v":"3.464","t":"+7.2%","d":"up"},{"l":"Mitigações Ativas","v":"8.240","t":"+13.2%","d":"up"},{"l":"Score Risco Geral","v":"64","t":"+16.8%","d":"up"},{"l":"Incidentes YTD","v":"8.251","t":"+14.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.812","6.416","348","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.444","3.085","6.612","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.918","8.597","3.398","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.637","1.976","7.265","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.874","7.444","8.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":234},{"label":"Fev","value":593},{"label":"Mar","value":495},{"label":"Abr","value":271},{"label":"Mai","value":516},{"label":"Jun","value":596},{"label":"Jul","value":523},{"label":"Ago","value":552},{"label":"Set","value":305},{"label":"Out","value":304},{"label":"Nov","value":253},{"label":"Dez","value":309}];
const MX = 596;
