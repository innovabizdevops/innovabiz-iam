...
const PAGE = "Playbook";
const KPIS = [{"l":"Dashboards Ativos","v":"5.798","t":"+5.9%","d":"up"},{"l":"Queries/Dia","v":"4305","t":"-4.2%","d":"down"},{"l":"Dados Processados (GB)","v":"2.775","t":"+12.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.483","t":"-4.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4268","2026-01-17","7.181","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","343","2026-02-28","8.186","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","974","2026-02-12","8.392","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3146","2026-02-27","6.523","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","487","2026-01-23","8.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":735},{"label":"Mar","value":811},{"label":"Abr","value":929},{"label":"Mai","value":662},{"label":"Jun","value":591},{"label":"Jul","value":564},{"label":"Ago","value":918},{"label":"Set","value":826},{"label":"Out","value":574},{"label":"Nov","value":946},{"label":"Dez","value":826}];
const MX = 946;
