...
const ACCENT = "#059669";
const MODULE = "Contract Analysis";
const PAGE = "AI Extract";
const KPIS = [{"l":"Dashboards Ativos","v":"723","t":"-1.3%","d":"down"},{"l":"Queries/Dia","v":"650","t":"+4.2%","d":"up"},{"l":"Dados Processados (GB)","v":"2.813","t":"+16.4%","d":"up"},{"l":"Utilizadores Analytics","v":"735","t":"+2.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1641","2026-02-08","8.342","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","389","2026-02-05","4.398","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3935","2026-01-19","3.766","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1147","2026-03-10","7.252","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2555","2026-03-07","7.847","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":596},{"label":"Mar","value":681},{"label":"Abr","value":560},{"label":"Mai","value":554},{"label":"Jun","value":772},{"label":"Jul","value":744},{"label":"Ago","value":585},{"label":"Set","value":608},{"label":"Out","value":491},{"label":"Nov","value":467},{"label":"Dez","value":463}];
const MX = 772;
