...
/* ═══ Sustainability Mgmt (ESG) — Dashboard ═══ */

const ACCENT = "#22c55e";

const KPIS = [
    { label: "Total Registos", value: "4726", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1506", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€378K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1179688626", cells: ["SUS-5626", "Sustainability Mgmt (ESG) Item 1", "19/7/2026", "€38 726"], status: "active" as const },
    { id: "1179692197", cells: ["SUS-9197", "Sustainability Mgmt (ESG) Item 2", "6/2/2026", "€42 297"], status: "pending" as const },
    { id: "1179695768", cells: ["SUS-3768", "Sustainability Mgmt (ESG) Item 3", "21/9/2026", "€45 868"], status: "completed" as const },
    { id: "1179699339", cells: ["SUS-7339", "Sustainability Mgmt (ESG) Item 4", "8/4/2026", "€49 439"], status: "warning" as const },
    { id: "1179702910", cells: ["SUS-1910", "Sustainability Mgmt (ESG) Item 5", "23/11/2026", "€3010"], status: "active" as const },
];
...
export default function SustainabilityMgmtEsgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sustainability Mgmt (ESG)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sustainability Mgmt (ESG)</p>
                    </div>
                </div>
