...
const ACCENT = "#22c55e";
const MODULE = "Sustainability Mgmt (ESG)";
const PAGE = "Waste";
const KPIS = [{"l":"Total Sustainability Mgmt","v":"8.199","t":"-5.1%","d":"down"},{"l":"Waste Ativos","v":"5.959","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.5%","d":"up"}];
const COLS = ["ID","Waste","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sustainability Mgmt #001","Sustainability Mgmt #002","3.582","8.310","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Sustainability Mgmt #002","Sustainability Mgmt #003","7.254","2.041","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Sustainability Mgmt #003","Sustainability Mgmt #004","2.303","6.735","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Sustainability Mgmt #004","Sustainability Mgmt #005","3.768","7.494","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sustainability Mgmt #005","Sustainability Mgmt #001","2.241","7.383","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":265},{"label":"Mar","value":383},{"label":"Abr","value":516},{"label":"Mai","value":505},{"label":"Jun","value":505},{"label":"Jul","value":341},{"label":"Ago","value":252},{"label":"Set","value":247},{"label":"Out","value":404},{"label":"Nov","value":278},{"label":"Dez","value":360}];
const MX = 516;
