...
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.497","t":"+12.3%","d":"up"},{"l":"RTO Médio (h)","v":"35h","t":"+4.1%","d":"up"},{"l":"RPO Médio (h)","v":"144h","t":"+9.9%","d":"up"},{"l":"Testes DR (YTD)","v":"3.761","t":"+12.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","144h","133h","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","192h","120h","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","161h","111h","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","83h","19h","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","131h","122h","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":842},{"label":"Mar","value":985},{"label":"Abr","value":968},{"label":"Mai","value":1005},{"label":"Jun","value":878},{"label":"Jul","value":981},{"label":"Ago","value":972},{"label":"Set","value":948},{"label":"Out","value":694},{"label":"Nov","value":820},{"label":"Dez","value":663}];
const MX = 1005;
