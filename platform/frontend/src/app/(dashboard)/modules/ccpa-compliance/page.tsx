...
/* ═══ CCPA/CPRA Compliance — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "1510", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3798", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€192K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "316643010", cells: ["CCP-6010", "CCPA/CPRA Compliance Item 1", "27/7/2026", "€43 110"], status: "active" as const },
    { id: "316646581", cells: ["CCP-9581", "CCPA/CPRA Compliance Item 2", "14/2/2026", "€46 681"], status: "pending" as const },
    { id: "316650152", cells: ["CCP-4152", "CCPA/CPRA Compliance Item 3", "1/9/2026", "€252"], status: "completed" as const },
    { id: "316653723", cells: ["CCP-7723", "CCPA/CPRA Compliance Item 4", "16/4/2026", "€3823"], status: "warning" as const },
    { id: "316657294", cells: ["CCP-2294", "CCPA/CPRA Compliance Item 5", "3/11/2026", "€7394"], status: "active" as const },
];
...
export default function CcpacpraCompliancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CCPA/CPRA Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CCPA/CPRA Compliance</p>
                    </div>
                </div>
