...
const PAGE = "Notice";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.793","t":"+16.4%","d":"up"},{"l":"NC Abertas","v":"6.476","t":"+4.9%","d":"up"},{"l":"Conformidade (%)","v":"74.4%","t":"+10.6%","d":"up"},{"l":"CAPAs Pendentes","v":"5.474","t":"+5.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.602","90.2%","1.327","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","175","87.7%","4.141","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.464","81.1%","4.007","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.385","88.0%","2.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","789","72.1%","5.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":537},{"label":"Mar","value":818},{"label":"Abr","value":495},{"label":"Mai","value":780},{"label":"Jun","value":614},{"label":"Jul","value":824},{"label":"Ago","value":730},{"label":"Set","value":790},{"label":"Out","value":491},{"label":"Nov","value":826},{"label":"Dez","value":805}];
const MX = 826;
