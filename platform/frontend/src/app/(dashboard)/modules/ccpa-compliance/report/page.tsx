...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.068","t":"-5.6%","d":"down"},{"l":"NC Abertas","v":"9.073","t":"-3.5%","d":"down"},{"l":"Conformidade (%)","v":"69.6%","t":"+10.7%","d":"up"},{"l":"CAPAs Pendentes","v":"4.236","t":"+8.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.318","96.0%","7.034","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.255","99.5%","2.904","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.938","96.8%","3.168","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.074","99.7%","4.478","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.027","80.6%","8.451","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":803},{"label":"Mar","value":885},{"label":"Abr","value":566},{"label":"Mai","value":597},{"label":"Jun","value":571},{"label":"Jul","value":813},{"label":"Ago","value":933},{"label":"Set","value":686},{"label":"Out","value":927},{"label":"Nov","value":660},{"label":"Dez","value":649}];
const MX = 933;
