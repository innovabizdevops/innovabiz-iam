...
const PAGE = "Delete";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.001","t":"+10.1%","d":"up"},{"l":"NC Abertas","v":"6.951","t":"-1.7%","d":"down"},{"l":"Conformidade (%)","v":"67.7%","t":"+12.6%","d":"up"},{"l":"CAPAs Pendentes","v":"985","t":"+7.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.616","89.1%","6.468","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.505","75.2%","2.313","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.762","77.7%","3.385","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.396","82.7%","2.436","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.913","88.9%","4.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":613},{"label":"Mar","value":424},{"label":"Abr","value":528},{"label":"Mai","value":575},{"label":"Jun","value":733},{"label":"Jul","value":674},{"label":"Ago","value":543},{"label":"Set","value":367},{"label":"Out","value":434},{"label":"Nov","value":717},{"label":"Dez","value":711}];
const MX = 733;
