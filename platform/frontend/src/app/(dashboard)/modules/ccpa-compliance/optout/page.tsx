...
const ACCENT = "#dc2626";
const MODULE = "CCPA/CPRA Compliance";
const PAGE = "Opt-Out";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.665","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"4.010","t":"+7.4%","d":"up"},{"l":"Conformidade (%)","v":"94.2%","t":"+9.8%","d":"up"},{"l":"CAPAs Pendentes","v":"3.841","t":"+17.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.744","84.0%","2.687","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.350","91.7%","7.216","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.393","92.2%","7.792","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.307","72.6%","1.466","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.035","96.4%","2.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":673},{"label":"Mar","value":800},{"label":"Abr","value":676},{"label":"Mai","value":677},{"label":"Jun","value":691},{"label":"Jul","value":747},{"label":"Ago","value":875},{"label":"Set","value":763},{"label":"Out","value":661},{"label":"Nov","value":1035},{"label":"Dez","value":883}];
const MX = 1035;
