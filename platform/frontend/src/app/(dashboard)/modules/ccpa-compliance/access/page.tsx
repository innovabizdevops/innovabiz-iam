...
const PAGE = "Access";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.212","t":"+4.0%","d":"up"},{"l":"NC Abertas","v":"8.079","t":"+10.8%","d":"up"},{"l":"Conformidade (%)","v":"78.9%","t":"+11.9%","d":"up"},{"l":"CAPAs Pendentes","v":"756","t":"+1.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.019","80.6%","484","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.750","98.2%","8.765","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.138","85.1%","2.126","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.314","96.4%","5.040","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.931","75.4%","7.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":780},{"label":"Mar","value":626},{"label":"Abr","value":787},{"label":"Mai","value":668},{"label":"Jun","value":692},{"label":"Jul","value":833},{"label":"Ago","value":572},{"label":"Set","value":835},{"label":"Out","value":807},{"label":"Nov","value":830},{"label":"Dez","value":835}];
const MX = 835;
