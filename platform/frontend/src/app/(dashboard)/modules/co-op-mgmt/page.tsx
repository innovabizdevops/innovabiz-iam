...
/* ═══ Cooperative Mgmt — Dashboard ═══ */

const ACCENT = "#ea580c";

const KPIS = [
    { label: "Total Registos", value: "241", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2669", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€212K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "847915341", cells: ["CO-8341", "Cooperative Mgmt Item 1", "22/10/2026", "€15 441"], status: "active" as const },
    { id: "847918912", cells: ["CO-2912", "Cooperative Mgmt Item 2", "9/5/2026", "€19 012"], status: "pending" as const },
    { id: "847922483", cells: ["CO-6483", "Cooperative Mgmt Item 3", "24/12/2026", "€22 583"], status: "completed" as const },
    { id: "847926054", cells: ["CO-1054", "Cooperative Mgmt Item 4", "11/7/2026", "€26 154"], status: "warning" as const },
    { id: "847929625", cells: ["CO-4625", "Cooperative Mgmt Item 5", "26/2/2026", "€29 725"], status: "active" as const },
];
...
export default function CooperativeMgmtPage() {
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cooperative Mgmt</p>
                    </div>
                </div>
