...
const ACCENT = "#ea580c";
const MODULE = "Cooperative Mgmt";
const PAGE = "Finance";
const KPIS = [{"l":"Total Co Op Mgmt","v":"2.251","t":"+6.7%","d":"up"},{"l":"Finance Ativos","v":"3.874","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"90","t":"+2.9%","d":"up"}];
const COLS = ["ID","Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Op Mgmt #001","Co Op Mgmt #002","702","1.866","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Co Op Mgmt #002","Co Op Mgmt #003","3.894","4.391","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Op Mgmt #003","Co Op Mgmt #004","2.919","1.437","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Co Op Mgmt #004","Co Op Mgmt #005","5.521","7.206","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Op Mgmt #005","Co Op Mgmt #001","5.865","5.564","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":662},{"label":"Mar","value":532},{"label":"Abr","value":668},{"label":"Mai","value":434},{"label":"Jun","value":389},{"label":"Jul","value":630},{"label":"Ago","value":636},{"label":"Set","value":694},{"label":"Out","value":625},{"label":"Nov","value":626},{"label":"Dez","value":596}];
const MX = 694;
