...
const PAGE = "Vote";
const KPIS = [{"l":"Total Co Op Mgmt","v":"1.893","t":"+15.5%","d":"up"},{"l":"Vote Ativos","v":"4.391","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"67.2%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.7%","d":"up"}];
const COLS = ["ID","Vote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Op Mgmt #001","Co Op Mgmt #002","2.298","2.516","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Co Op Mgmt #002","Co Op Mgmt #003","1.767","1.162","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Op Mgmt #003","Co Op Mgmt #004","3.816","2.208","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Co Op Mgmt #004","Co Op Mgmt #005","6.585","1.311","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Op Mgmt #005","Co Op Mgmt #001","1.951","3.222","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":595},{"label":"Mar","value":509},{"label":"Abr","value":739},{"label":"Mai","value":535},{"label":"Jun","value":598},{"label":"Jul","value":540},{"label":"Ago","value":611},{"label":"Set","value":733},{"label":"Out","value":544},{"label":"Nov","value":774},{"label":"Dez","value":604}];
const MX = 774;
