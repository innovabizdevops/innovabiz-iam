...
const PAGE = "Member";
const KPIS = [{"l":"Total Co Op Mgmt","v":"454","t":"-2.3%","d":"down"},{"l":"Member Ativos","v":"7.980","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+10.6%","d":"up"}];
const COLS = ["ID","Member","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Op Mgmt #001","Co Op Mgmt #002","2.499","7.436","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Co Op Mgmt #002","Co Op Mgmt #003","3.768","5.797","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Op Mgmt #003","Co Op Mgmt #004","5.154","6.032","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Co Op Mgmt #004","Co Op Mgmt #005","4.232","514","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Op Mgmt #005","Co Op Mgmt #001","8.139","4.052","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":569},{"label":"Mar","value":516},{"label":"Abr","value":428},{"label":"Mai","value":661},{"label":"Jun","value":506},{"label":"Jul","value":532},{"label":"Ago","value":489},{"label":"Set","value":529},{"label":"Out","value":544},{"label":"Nov","value":533},{"label":"Dez","value":493}];
const MX = 707;
