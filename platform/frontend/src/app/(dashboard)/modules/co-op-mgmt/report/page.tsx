...
const PAGE = "Report";
const KPIS = [{"l":"Total Co Op Mgmt","v":"5.320","t":"+17.1%","d":"up"},{"l":"Report Ativos","v":"7.249","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+14.5%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Op Mgmt #001","Co Op Mgmt #002","9.055","1.998","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Co Op Mgmt #002","Co Op Mgmt #003","2.672","165","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Op Mgmt #003","Co Op Mgmt #004","5.969","7.396","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Co Op Mgmt #004","Co Op Mgmt #005","3.252","2.924","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Op Mgmt #005","Co Op Mgmt #001","5.550","7.908","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":721},{"label":"Mar","value":891},{"label":"Abr","value":649},{"label":"Mai","value":612},{"label":"Jun","value":880},{"label":"Jul","value":713},{"label":"Ago","value":913},{"label":"Set","value":851},{"label":"Out","value":848},{"label":"Nov","value":651},{"label":"Dez","value":804}];
const MX = 913;
