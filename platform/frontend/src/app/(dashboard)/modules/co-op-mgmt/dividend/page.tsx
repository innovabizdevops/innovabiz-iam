...
const PAGE = "Dividend";
const KPIS = [{"l":"Total Co Op Mgmt","v":"8.422","t":"+5.8%","d":"up"},{"l":"Dividend Ativos","v":"2.341","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"66","t":"+5.5%","d":"up"}];
const COLS = ["ID","Dividend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Co Op Mgmt #001","Co Op Mgmt #002","9.063","6.471","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Co Op Mgmt #002","Co Op Mgmt #003","3.003","2.219","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Co Op Mgmt #003","Co Op Mgmt #004","5.797","4.764","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Co Op Mgmt #004","Co Op Mgmt #005","1.948","2.579","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Co Op Mgmt #005","Co Op Mgmt #001","3.917","8.283","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":500},{"label":"Mar","value":625},{"label":"Abr","value":556},{"label":"Mai","value":488},{"label":"Jun","value":511},{"label":"Jul","value":442},{"label":"Ago","value":548},{"label":"Set","value":346},{"label":"Out","value":511},{"label":"Nov","value":685},{"label":"Dez","value":474}];
const MX = 687;
