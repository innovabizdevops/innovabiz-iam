...
/* ═══ Smart Agri Hub — Crop Plan ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3589", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "399", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1558", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1990421131", cells: ["SMA-9131", "Crop Plan Item 1", "28/8/2026", "€21 231"], status: "active" as const },
    { id: "1990424702", cells: ["SMA-3702", "Crop Plan Item 2", "15/3/2026", "€24 802"], status: "pending" as const },
    { id: "1990428273", cells: ["SMA-7273", "Crop Plan Item 3", "2/10/2026", "€28 373"], status: "completed" as const },
    { id: "1990431844", cells: ["SMA-1844", "Crop Plan Item 4", "17/5/2026", "€31 944"], status: "warning" as const },
    { id: "1990435415", cells: ["SMA-5415", "Crop Plan Item 5", "4/12/2026", "€35 515"], status: "active" as const },
];
...
export default function SmartAgriHubCropPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crop Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Crop Plan</p>
                    </div>
                </div>
