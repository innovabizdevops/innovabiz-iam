...
/* ═══ Smart Agri Hub — Agri Robot ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4635", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "447", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3222", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "539486763", cells: ["SMA-9763", "Agri Robot Item 1", "12/4/2026", "€36 863"], status: "active" as const },
    { id: "539490334", cells: ["SMA-4334", "Agri Robot Item 2", "27/11/2026", "€40 434"], status: "pending" as const },
    { id: "539493905", cells: ["SMA-7905", "Agri Robot Item 3", "14/6/2026", "€44 005"], status: "completed" as const },
    { id: "539497476", cells: ["SMA-2476", "Agri Robot Item 4", "1/1/2026", "€47 576"], status: "warning" as const },
    { id: "539501047", cells: ["SMA-6047", "Agri Robot Item 5", "16/8/2026", "€1147"], status: "active" as const },
];
...
export default function SmartAgriHubAgriRobotPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agri Robot</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Agri Robot</p>
                    </div>
                </div>
