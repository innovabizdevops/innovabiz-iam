...
/* ═══ Smart Agri Hub — Fishpond Mgmt ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4772", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "372", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3816", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1098375024", cells: ["SMA-7024", "Fishpond Mgmt Item 1", "13/1/2026", "€25 124"], status: "active" as const },
    { id: "1098378595", cells: ["SMA-1595", "Fishpond Mgmt Item 2", "28/8/2026", "€28 695"], status: "pending" as const },
    { id: "1098382166", cells: ["SMA-5166", "Fishpond Mgmt Item 3", "15/3/2026", "€32 266"], status: "completed" as const },
    { id: "1098385737", cells: ["SMA-8737", "Fishpond Mgmt Item 4", "2/10/2026", "€35 837"], status: "warning" as const },
    { id: "1098389308", cells: ["SMA-3308", "Fishpond Mgmt Item 5", "17/5/2026", "€39 408"], status: "active" as const },
];
...
export default function SmartAgriHubFishpondMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fishpond Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Fishpond Mgmt</p>
                    </div>
                </div>
