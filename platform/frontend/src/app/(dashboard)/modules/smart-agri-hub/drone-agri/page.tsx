...
/* ═══ Smart Agri Hub — Drone Agri ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "2674", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "395", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "728", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1615226391", cells: ["SMA-6391", "Drone Agri Item 1", "24/4/2026", "€26 491"], status: "active" as const },
    { id: "1615229962", cells: ["SMA-9962", "Drone Agri Item 2", "11/11/2026", "€30 062"], status: "pending" as const },
    { id: "1615233533", cells: ["SMA-4533", "Drone Agri Item 3", "26/6/2026", "€33 633"], status: "completed" as const },
    { id: "1615237104", cells: ["SMA-8104", "Drone Agri Item 4", "13/1/2026", "€37 204"], status: "warning" as const },
    { id: "1615240675", cells: ["SMA-2675", "Drone Agri Item 5", "28/8/2026", "€40 775"], status: "active" as const },
];
...
export default function SmartAgriHubDroneAgriPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drone Agri</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Drone Agri</p>
                    </div>
                </div>
