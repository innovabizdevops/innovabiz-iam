...
/* ═══ Smart Agri Hub — Greenhouse Control ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4541", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "470", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1629", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "871983362", cells: ["SMA-1362", "Greenhouse Control Item 1", "27/3/2026", "€33 462"], status: "active" as const },
    { id: "871986933", cells: ["SMA-4933", "Greenhouse Control Item 2", "14/10/2026", "€37 033"], status: "pending" as const },
    { id: "871990504", cells: ["SMA-8504", "Greenhouse Control Item 3", "1/5/2026", "€40 604"], status: "completed" as const },
    { id: "871994075", cells: ["SMA-3075", "Greenhouse Control Item 4", "16/12/2026", "€44 175"], status: "warning" as const },
    { id: "871997646", cells: ["SMA-6646", "Greenhouse Control Item 5", "3/7/2026", "€47 746"], status: "active" as const },
];
...
export default function SmartAgriHubGreenhouseControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Greenhouse Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Greenhouse Control</p>
                    </div>
                </div>
