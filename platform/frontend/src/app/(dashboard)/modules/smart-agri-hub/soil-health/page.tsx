...
/* ═══ Smart Agri Hub — Soil Health ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "2414", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "27", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1938", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "288148263", cells: ["SMA-5263", "Soil Health Item 1", "12/4/2026", "€48 363"], status: "active" as const },
    { id: "288151834", cells: ["SMA-8834", "Soil Health Item 2", "27/11/2026", "€1934"], status: "pending" as const },
    { id: "288155405", cells: ["SMA-3405", "Soil Health Item 3", "14/6/2026", "€5505"], status: "completed" as const },
    { id: "288158976", cells: ["SMA-6976", "Soil Health Item 4", "1/1/2026", "€9076"], status: "warning" as const },
    { id: "288162547", cells: ["SMA-1547", "Soil Health Item 5", "16/8/2026", "€12 647"], status: "active" as const },
];
...
export default function SmartAgriHubSoilHealthPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Soil Health</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Soil Health</p>
                    </div>
                </div>
