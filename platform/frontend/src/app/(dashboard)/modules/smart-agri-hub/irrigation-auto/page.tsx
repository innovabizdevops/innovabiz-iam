...
/* ═══ Smart Agri Hub — Irrigation Auto ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4579", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "433", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3875", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1255963709", cells: ["SMA-5709", "Irrigation Auto Item 1", "22/6/2026", "€13 809"], status: "active" as const },
    { id: "1255967280", cells: ["SMA-9280", "Irrigation Auto Item 2", "9/1/2026", "€17 380"], status: "pending" as const },
    { id: "1255970851", cells: ["SMA-3851", "Irrigation Auto Item 3", "24/8/2026", "€20 951"], status: "completed" as const },
    { id: "1255974422", cells: ["SMA-7422", "Irrigation Auto Item 4", "11/3/2026", "€24 522"], status: "warning" as const },
    { id: "1255977993", cells: ["SMA-1993", "Irrigation Auto Item 5", "26/10/2026", "€28 093"], status: "active" as const },
];
...
export default function SmartAgriHubIrrigationAutoPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Irrigation Auto</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Irrigation Auto</p>
                    </div>
                </div>
