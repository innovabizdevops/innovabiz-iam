...
/* ═══ Smart Agri Hub — Farm Management Sys ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "3162", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "222", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "295", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "97%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "350605770", cells: ["SMA-2770", "Farm Management Sys Item 1", "19/7/2026", "€5870"], status: "active" as const },
    { id: "350609341", cells: ["SMA-6341", "Farm Management Sys Item 2", "6/2/2026", "€9441"], status: "pending" as const },
    { id: "350612912", cells: ["SMA-9912", "Farm Management Sys Item 3", "21/9/2026", "€13 012"], status: "completed" as const },
    { id: "350616483", cells: ["SMA-4483", "Farm Management Sys Item 4", "8/4/2026", "€16 583"], status: "warning" as const },
    { id: "350620054", cells: ["SMA-8054", "Farm Management Sys Item 5", "23/11/2026", "€20 154"], status: "active" as const },
];
...
export default function SmartAgriHubFarmManagementSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Farm Management Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Farm Management Sys</p>
                    </div>
                </div>
