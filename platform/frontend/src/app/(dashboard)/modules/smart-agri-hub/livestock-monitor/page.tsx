...
/* ═══ Smart Agri Hub — Livestock Monitor ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "2371", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "196", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3093", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1433957536", cells: ["SMA-6536", "Livestock Monitor Item 1", "5/5/2026", "€7636"], status: "active" as const },
    { id: "1433961107", cells: ["SMA-1107", "Livestock Monitor Item 2", "20/12/2026", "€11 207"], status: "pending" as const },
    { id: "1433964678", cells: ["SMA-4678", "Livestock Monitor Item 3", "7/7/2026", "€14 778"], status: "completed" as const },
    { id: "1433968249", cells: ["SMA-8249", "Livestock Monitor Item 4", "22/2/2026", "€18 349"], status: "warning" as const },
    { id: "1433971820", cells: ["SMA-2820", "Livestock Monitor Item 5", "9/9/2026", "€21 920"], status: "active" as const },
];
...
export default function SmartAgriHubLivestockMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Livestock Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Livestock Monitor</p>
                    </div>
                </div>
