...
/* ═══ Smart Agri Hub — Agri Erp ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total", value: "4861", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "216", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1751", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1591608676", cells: ["SMA-4676", "Agri Erp Item 1", "1/5/2026", "€8776"], status: "active" as const },
    { id: "1591612247", cells: ["SMA-8247", "Agri Erp Item 2", "16/12/2026", "€12 347"], status: "pending" as const },
    { id: "1591615818", cells: ["SMA-2818", "Agri Erp Item 3", "3/7/2026", "€15 918"], status: "completed" as const },
    { id: "1591619389", cells: ["SMA-6389", "Agri Erp Item 4", "18/2/2026", "€19 489"], status: "warning" as const },
    { id: "1591622960", cells: ["SMA-9960", "Agri Erp Item 5", "5/9/2026", "€23 060"], status: "active" as const },
];
...
export default function SmartAgriHubAgriErpPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agri Erp</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart Agri Hub • Agri Erp</p>
                    </div>
                </div>
