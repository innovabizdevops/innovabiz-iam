...
const PAGE = "Patient";
const KPIS = [{"l":"Dispositivos Online","v":"1.242","t":"+0.7%","d":"up"},{"l":"Dados/Min (MB)","v":"5.457","t":"-3.4%","d":"down"},{"l":"Alertas Ativos","v":"8.559","t":"+4.1%","d":"up"},{"l":"Uptime (%)","v":"65.5%","t":"+15.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","413","8.485","1.075","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","418","5.359","5.273","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.180","7.019","4.882","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.931","7.491","1.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.100","1.272","6.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":605},{"label":"Mar","value":650},{"label":"Abr","value":740},{"label":"Mai","value":637},{"label":"Jun","value":849},{"label":"Jul","value":591},{"label":"Ago","value":932},{"label":"Set","value":857},{"label":"Out","value":710},{"label":"Nov","value":761},{"label":"Dez","value":762}];
const MX = 932;
