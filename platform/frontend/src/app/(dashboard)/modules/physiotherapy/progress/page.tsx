...
const PAGE = "Progress";
const KPIS = [{"l":"Dispositivos Online","v":"8.052","t":"+1.9%","d":"up"},{"l":"Dados/Min (MB)","v":"7.770","t":"+3.0%","d":"up"},{"l":"Alertas Ativos","v":"1.688","t":"+5.9%","d":"up"},{"l":"Uptime (%)","v":"85.4%","t":"+14.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.940","724","9.086","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.391","4.672","4.886","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.673","3.850","5.786","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.783","5.876","1.808","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.185","8.534","2.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":477},{"label":"Mar","value":600},{"label":"Abr","value":315},{"label":"Mai","value":436},{"label":"Jun","value":281},{"label":"Jul","value":285},{"label":"Ago","value":594},{"label":"Set","value":328},{"label":"Out","value":406},{"label":"Nov","value":385},{"label":"Dez","value":524}];
const MX = 600;
