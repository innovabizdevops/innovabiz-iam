...
const ACCENT = "#dc2626";
const MODULE = "Physiotherapy";
const PAGE = "Assessment";
const KPIS = [{"l":"Dispositivos Online","v":"6.498","t":"-2.3%","d":"down"},{"l":"Dados/Min (MB)","v":"4.741","t":"+9.1%","d":"up"},{"l":"Alertas Ativos","v":"5.313","t":"+17.5%","d":"up"},{"l":"Uptime (%)","v":"91.6%","t":"+9.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.820","3.094","7.898","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.963","6.125","8.477","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.183","5.996","1.810","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.470","5.005","5.272","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.600","5.562","5.232","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":557},{"label":"Mar","value":392},{"label":"Abr","value":669},{"label":"Mai","value":494},{"label":"Jun","value":675},{"label":"Jul","value":586},{"label":"Ago","value":607},{"label":"Set","value":664},{"label":"Out","value":357},{"label":"Nov","value":516},{"label":"Dez","value":481}];
const MX = 675;
