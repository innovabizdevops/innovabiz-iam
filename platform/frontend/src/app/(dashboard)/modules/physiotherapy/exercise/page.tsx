...
const PAGE = "Exercise";
const KPIS = [{"l":"Dispositivos Online","v":"8.844","t":"+0.5%","d":"up"},{"l":"Dados/Min (MB)","v":"7.752","t":"-1.5%","d":"down"},{"l":"Alertas Ativos","v":"6.726","t":"-4.7%","d":"down"},{"l":"Uptime (%)","v":"67.3%","t":"+16.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.360","2.285","7.577","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.562","9.022","7.944","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","671","1.777","8.957","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.019","1.863","2.496","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.931","5.821","5.303","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":376},{"label":"Mar","value":447},{"label":"Abr","value":327},{"label":"Mai","value":316},{"label":"Jun","value":575},{"label":"Jul","value":532},{"label":"Ago","value":430},{"label":"Set","value":431},{"label":"Out","value":425},{"label":"Nov","value":638},{"label":"Dez","value":466}];
const MX = 638;
