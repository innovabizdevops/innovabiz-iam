...
const KPIS = [
    { label: "Total Registos", value: "8032", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2865", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€21K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "873791832", cells: ["PHY-9832", "Physiotherapy Item 1", "5/1/2026", "€41 932"], status: "active" as const },
    { id: "873795403", cells: ["PHY-4403", "Physiotherapy Item 2", "20/8/2026", "€45 503"], status: "pending" as const },
    { id: "873798974", cells: ["PHY-7974", "Physiotherapy Item 3", "7/3/2026", "€49 074"], status: "completed" as const },
    { id: "873802545", cells: ["PHY-2545", "Physiotherapy Item 4", "22/10/2026", "€2645"], status: "warning" as const },
    { id: "873806116", cells: ["PHY-6116", "Physiotherapy Item 5", "9/5/2026", "€6216"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Physiotherapy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Physiotherapy</p>
                    </div>
                </div>
