...
const PAGE = "Billing";
const KPIS = [{"l":"Dispositivos Online","v":"6.520","t":"+8.6%","d":"up"},{"l":"Dados/Min (MB)","v":"1.205","t":"-4.1%","d":"down"},{"l":"Alertas Ativos","v":"5.218","t":"+2.0%","d":"up"},{"l":"Uptime (%)","v":"82.2%","t":"+5.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.715","4.557","3.280","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.085","6.074","5.390","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.267","2.202","1.390","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","956","824","7.682","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.881","8.911","6.256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":623},{"label":"Mar","value":883},{"label":"Abr","value":571},{"label":"Mai","value":497},{"label":"Jun","value":622},{"label":"Jul","value":577},{"label":"Ago","value":508},{"label":"Set","value":626},{"label":"Out","value":679},{"label":"Nov","value":613},{"label":"Dez","value":871}];
const MX = 883;
