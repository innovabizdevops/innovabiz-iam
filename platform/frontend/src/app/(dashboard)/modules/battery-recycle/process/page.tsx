...
const ACCENT = "#065f46";
const MODULE = "Battery Recycling";
const PAGE = "Process";
const KPIS = [{"l":"Total Battery Recycle","v":"8.975","t":"+0.2%","d":"up"},{"l":"Process Ativos","v":"6.508","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"72.5%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.9%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Recycle #001","Battery Recycle #002","5.795","242","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Recycle #002","Battery Recycle #003","1.654","3.461","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Recycle #003","Battery Recycle #004","7.972","3.289","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Recycle #004","Battery Recycle #005","1.668","2.324","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Recycle #005","Battery Recycle #001","3.976","3.393","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":484},{"label":"Mar","value":606},{"label":"Abr","value":519},{"label":"Mai","value":400},{"label":"Jun","value":600},{"label":"Jul","value":309},{"label":"Ago","value":584},{"label":"Set","value":384},{"label":"Out","value":568},{"label":"Nov","value":269},{"label":"Dez","value":295}];
const MX = 606;
