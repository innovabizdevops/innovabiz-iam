...
const PAGE = "Recover";
const KPIS = [{"l":"Total Battery Recycle","v":"6.992","t":"-4.9%","d":"down"},{"l":"Recover Ativos","v":"4.516","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"68","t":"+16.9%","d":"up"}];
const COLS = ["ID","Recover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Recycle #001","Battery Recycle #002","1.944","8.169","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Recycle #002","Battery Recycle #003","1.505","8.713","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Recycle #003","Battery Recycle #004","4.575","5.661","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Recycle #004","Battery Recycle #005","7.714","2.765","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Recycle #005","Battery Recycle #001","4.256","597","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":693},{"label":"Mar","value":651},{"label":"Abr","value":843},{"label":"Mai","value":610},{"label":"Jun","value":842},{"label":"Jul","value":668},{"label":"Ago","value":705},{"label":"Set","value":720},{"label":"Out","value":868},{"label":"Nov","value":775},{"label":"Dez","value":827}];
const MX = 868;
