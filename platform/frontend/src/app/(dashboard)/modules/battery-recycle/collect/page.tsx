...
const PAGE = "Collect";
const KPIS = [{"l":"Total Battery Recycle","v":"8.313","t":"+7.1%","d":"up"},{"l":"Collect Ativos","v":"4.482","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"81.0%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"85","t":"+10.2%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Recycle #001","Battery Recycle #002","6.851","7.450","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Recycle #002","Battery Recycle #003","7.560","4.260","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Recycle #003","Battery Recycle #004","4.297","1.574","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Recycle #004","Battery Recycle #005","4.682","6.662","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Recycle #005","Battery Recycle #001","3.220","1.036","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":698},{"label":"Mar","value":490},{"label":"Abr","value":559},{"label":"Mai","value":568},{"label":"Jun","value":585},{"label":"Jul","value":613},{"label":"Ago","value":544},{"label":"Set","value":663},{"label":"Out","value":674},{"label":"Nov","value":672},{"label":"Dez","value":551}];
const MX = 728;
