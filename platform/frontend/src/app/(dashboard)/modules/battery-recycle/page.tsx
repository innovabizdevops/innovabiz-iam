...
const KPIS = [
    { label: "Total Registos", value: "9050", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1555", trend: "-20%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1532717050", cells: ["BAT-9050", "Battery Recycling Item 1", "19/11/2026", "€17 150"], status: "active" as const },
    { id: "1532720621", cells: ["BAT-3621", "Battery Recycling Item 2", "6/6/2026", "€20 721"], status: "pending" as const },
    { id: "1532724192", cells: ["BAT-7192", "Battery Recycling Item 3", "21/1/2026", "€24 292"], status: "completed" as const },
    { id: "1532727763", cells: ["BAT-1763", "Battery Recycling Item 4", "8/8/2026", "€27 863"], status: "warning" as const },
    { id: "1532731334", cells: ["BAT-5334", "Battery Recycling Item 5", "23/3/2026", "€31 434"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Battery Recycling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Battery Recycling</p>
                    </div>
                </div>
