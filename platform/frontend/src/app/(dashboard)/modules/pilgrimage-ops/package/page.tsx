...
const ACCENT = "#6d28d9";
const MODULE = "Pilgrimage Operations";
const PAGE = "Package";
const KPIS = [{"l":"Total Pilgrimage Ops","v":"483","t":"+11.8%","d":"up"},{"l":"Package Ativos","v":"4.331","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"65.0%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+2.2%","d":"up"}];
const COLS = ["ID","Package","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pilgrimage Ops #001","Pilgrimage Ops #002","1.867","8.265","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pilgrimage Ops #002","Pilgrimage Ops #003","6.377","2.773","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Pilgrimage Ops #003","Pilgrimage Ops #004","8.435","1.288","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Pilgrimage Ops #004","Pilgrimage Ops #005","6.469","4.492","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pilgrimage Ops #005","Pilgrimage Ops #001","8.277","2.261","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":480},{"label":"Mar","value":636},{"label":"Abr","value":875},{"label":"Mai","value":725},{"label":"Jun","value":822},{"label":"Jul","value":522},{"label":"Ago","value":854},{"label":"Set","value":600},{"label":"Out","value":766},{"label":"Nov","value":498},{"label":"Dez","value":779}];
const MX = 875;
