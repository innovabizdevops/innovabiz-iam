...
const PAGE = "Guide";
const KPIS = [{"l":"Artigos Publicados","v":"3.961","t":"+16.4%","d":"up"},{"l":"Views/Semana","v":"1577","t":"+0.8%","d":"up"},{"l":"Feedback Útil (%)","v":"88.6%","t":"+7.1%","d":"up"},{"l":"Artigos Desatualizados","v":"1.704","t":"+12.1%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","6.853","90.0%","177","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","2.854","99.1%","7.674","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.536","92.6%","4.289","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.323","80.5%","6.831","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.141","96.6%","5.560","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":615},{"label":"Mar","value":849},{"label":"Abr","value":628},{"label":"Mai","value":917},{"label":"Jun","value":622},{"label":"Jul","value":677},{"label":"Ago","value":620},{"label":"Set","value":642},{"label":"Out","value":787},{"label":"Nov","value":713},{"label":"Dez","value":763}];
const MX = 917;
