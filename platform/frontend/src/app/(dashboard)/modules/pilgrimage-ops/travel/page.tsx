...
const PAGE = "Travel";
const KPIS = [{"l":"Total Pilgrimage Ops","v":"8.701","t":"+3.5%","d":"up"},{"l":"Travel Ativos","v":"3.559","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"81.1%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"80","t":"+5.4%","d":"up"}];
const COLS = ["ID","Travel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pilgrimage Ops #001","Pilgrimage Ops #002","3.138","1.124","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pilgrimage Ops #002","Pilgrimage Ops #003","7.067","2.211","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Pilgrimage Ops #003","Pilgrimage Ops #004","6.877","4.863","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Pilgrimage Ops #004","Pilgrimage Ops #005","2.031","2.716","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pilgrimage Ops #005","Pilgrimage Ops #001","868","7.068","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":614},{"label":"Mar","value":400},{"label":"Abr","value":677},{"label":"Mai","value":545},{"label":"Jun","value":461},{"label":"Jul","value":530},{"label":"Ago","value":428},{"label":"Set","value":729},{"label":"Out","value":669},{"label":"Nov","value":595},{"label":"Dez","value":684}];
const MX = 735;
