...
const PAGE = "Safety";
const KPIS = [{"l":"Total Pilgrimage Ops","v":"4.961","t":"+15.8%","d":"up"},{"l":"Safety Ativos","v":"7.287","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"94","t":"-5.3%","d":"down"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pilgrimage Ops #001","Pilgrimage Ops #002","3.465","8.969","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pilgrimage Ops #002","Pilgrimage Ops #003","2.268","6.624","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Pilgrimage Ops #003","Pilgrimage Ops #004","8.236","2.932","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Pilgrimage Ops #004","Pilgrimage Ops #005","4.969","2.000","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pilgrimage Ops #005","Pilgrimage Ops #001","318","7.643","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":1026},{"label":"Mar","value":937},{"label":"Abr","value":838},{"label":"Mai","value":910},{"label":"Jun","value":1016},{"label":"Jul","value":829},{"label":"Ago","value":1034},{"label":"Set","value":710},{"label":"Out","value":710},{"label":"Nov","value":942},{"label":"Dez","value":989}];
const MX = 1034;
