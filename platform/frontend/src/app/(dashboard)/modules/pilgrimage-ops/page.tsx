...
/* ═══ Pilgrimage Operations — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "5077", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "597", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€445K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "47307177", cells: ["PIL-4177", "Pilgrimage Operations Item 1", "2/10/2026", "€7277"], status: "active" as const },
    { id: "47310748", cells: ["PIL-7748", "Pilgrimage Operations Item 2", "17/5/2026", "€10 848"], status: "pending" as const },
    { id: "47314319", cells: ["PIL-2319", "Pilgrimage Operations Item 3", "4/12/2026", "€14 419"], status: "completed" as const },
    { id: "47317890", cells: ["PIL-5890", "Pilgrimage Operations Item 4", "19/7/2026", "€17 990"], status: "warning" as const },
    { id: "47321461", cells: ["PIL-9461", "Pilgrimage Operations Item 5", "6/2/2026", "€21 561"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pilgrimage Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pilgrimage Operations</p>
                    </div>
                </div>
