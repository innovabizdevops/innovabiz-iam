...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€32.5M","t":"-3.7%","d":"down"},{"l":"MRR (€)","v":"€9235","t":"+12.8%","d":"up"},{"l":"Churn (%)","v":"72.5%","t":"-1.8%","d":"down"},{"l":"ARPU (€)","v":"€54120","t":"+14.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27322.79","1.421","€ 8889.48","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 30281.25","3.477","€ 42445.52","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 48670.34","5.876","€ 41720.12","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13791.35","786","€ 17622.39","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 48945.93","2.038","€ 18426.57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":695},{"label":"Mar","value":592},{"label":"Abr","value":820},{"label":"Mai","value":542},{"label":"Jun","value":838},{"label":"Jul","value":620},{"label":"Ago","value":668},{"label":"Set","value":875},{"label":"Out","value":604},{"label":"Nov","value":795},{"label":"Dez","value":632}];
const MX = 875;
