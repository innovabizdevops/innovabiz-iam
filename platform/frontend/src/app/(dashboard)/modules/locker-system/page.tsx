...
/* ═══ Smart Locker System — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "1739", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "635", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€372K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "458757739", cells: ["LOC-1739", "Smart Locker System Item 1", "28/8/2026", "€7839"], status: "active" as const },
    { id: "458761310", cells: ["LOC-5310", "Smart Locker System Item 2", "15/3/2026", "€11 410"], status: "pending" as const },
    { id: "458764881", cells: ["LOC-8881", "Smart Locker System Item 3", "2/10/2026", "€14 981"], status: "completed" as const },
    { id: "458768452", cells: ["LOC-3452", "Smart Locker System Item 4", "17/5/2026", "€18 552"], status: "warning" as const },
    { id: "458772023", cells: ["LOC-7023", "Smart Locker System Item 5", "4/12/2026", "€22 123"], status: "active" as const },
];
...
export default function SmartLockerSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Locker System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Smart Locker System</p>
                    </div>
                </div>
