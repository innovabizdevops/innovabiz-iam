...
const PAGE = "Color";
const KPIS = [{"l":"Total Digital Print","v":"699","t":"-3.4%","d":"down"},{"l":"Color Ativos","v":"5.832","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"62","t":"+10.0%","d":"up"}];
const COLS = ["ID","Color","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Print #001","Digital Print #002","427","5.922","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Print #002","Digital Print #003","6.437","5.617","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Print #003","Digital Print #004","6.857","6.618","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Print #004","Digital Print #005","4.890","7.379","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Print #005","Digital Print #001","7.541","2.574","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":777},{"label":"Mar","value":669},{"label":"Abr","value":1019},{"label":"Mai","value":934},{"label":"Jun","value":770},{"label":"Jul","value":766},{"label":"Ago","value":769},{"label":"Set","value":913},{"label":"Out","value":969},{"label":"Nov","value":886},{"label":"Dez","value":679}];
const MX = 1019;
