...
const PAGE = "Output";
const KPIS = [{"l":"Total Digital Print","v":"7.699","t":"+5.9%","d":"up"},{"l":"Output Ativos","v":"1.386","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"67","t":"-4.3%","d":"down"}];
const COLS = ["ID","Output","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Print #001","Digital Print #002","504","5.858","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Print #002","Digital Print #003","8.632","694","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Print #003","Digital Print #004","4.422","727","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Print #004","Digital Print #005","3.533","294","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Print #005","Digital Print #001","942","2.462","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":472},{"label":"Mar","value":634},{"label":"Abr","value":573},{"label":"Mai","value":443},{"label":"Jun","value":736},{"label":"Jul","value":590},{"label":"Ago","value":497},{"label":"Set","value":554},{"label":"Out","value":617},{"label":"Nov","value":757},{"label":"Dez","value":468}];
const MX = 757;
