...
const PAGE = "Web-to-Print";
const KPIS = [{"l":"Total Digital Print","v":"4.404","t":"+7.8%","d":"up"},{"l":"Web To Print Ativos","v":"9.043","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"66","t":"+1.9%","d":"up"}];
const COLS = ["ID","Web To Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Print #001","Digital Print #002","7.576","8.636","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Print #002","Digital Print #003","834","2.726","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Print #003","Digital Print #004","4.272","5.666","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Print #004","Digital Print #005","4.102","8.583","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Print #005","Digital Print #001","5.106","1.132","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":708},{"label":"Mar","value":822},{"label":"Abr","value":668},{"label":"Mai","value":723},{"label":"Jun","value":709},{"label":"Jul","value":685},{"label":"Ago","value":681},{"label":"Set","value":757},{"label":"Out","value":454},{"label":"Nov","value":657},{"label":"Dez","value":729}];
const MX = 822;
