...
const ACCENT = "#6366f1";
const MODULE = "Digital Printing";
const PAGE = "Wide Format";
const KPIS = [{"l":"Formulários Ativos","v":"2.416","t":"+1.6%","d":"up"},{"l":"Submissões/Dia","v":"2899","t":"-2.4%","d":"down"},{"l":"Documentos Gerados","v":"816","t":"+14.6%","d":"up"},{"l":"Templates","v":"8.581","t":"+3.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.084","2026-01-18","6.864","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.242","2026-02-26","7.063","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.820","2026-01-06","6.537","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","564","2026-03-20","9.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.398","2026-02-07","3.127","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":495},{"label":"Mar","value":584},{"label":"Abr","value":483},{"label":"Mai","value":679},{"label":"Jun","value":444},{"label":"Jul","value":492},{"label":"Ago","value":702},{"label":"Set","value":419},{"label":"Out","value":502},{"label":"Nov","value":626},{"label":"Dez","value":607}];
const MX = 702;
