...
const PAGE = "Variable";
const KPIS = [{"l":"Total Digital Print","v":"5.882","t":"-0.3%","d":"down"},{"l":"Variable Ativos","v":"862","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+11.2%","d":"up"}];
const COLS = ["ID","Variable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Print #001","Digital Print #002","4.159","4.031","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Print #002","Digital Print #003","8.759","1.504","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Print #003","Digital Print #004","1.589","6.044","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Print #004","Digital Print #005","697","4.256","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Print #005","Digital Print #001","1.859","5.415","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":501},{"label":"Mar","value":369},{"label":"Abr","value":427},{"label":"Mai","value":456},{"label":"Jun","value":507},{"label":"Jul","value":508},{"label":"Ago","value":291},{"label":"Set","value":343},{"label":"Out","value":627},{"label":"Nov","value":447},{"label":"Dez","value":527}];
const MX = 627;
