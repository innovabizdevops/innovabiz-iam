...
const PAGE = "Defect Tracker";
const KPIS = [{"l":"Total Test Mgmt","v":"5.276","t":"+15.5%","d":"up"},{"l":"Defect Tracker Ativos","v":"7.241","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"68","t":"+17.2%","d":"up"}];
const COLS = ["ID","Defect Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","7.798","2.797","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","4.184","5.819","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","2.355","3.842","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","3.027","6.677","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","9.010","828","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":212},{"label":"Fev","value":478},{"label":"Mar","value":455},{"label":"Abr","value":326},{"label":"Mai","value":237},{"label":"Jun","value":389},{"label":"Jul","value":214},{"label":"Ago","value":404},{"label":"Set","value":315},{"label":"Out","value":346},{"label":"Nov","value":383},{"label":"Dez","value":512}];
const MX = 512;
