...
const PAGE = "Load Testing";
const KPIS = [{"l":"Total Test Mgmt","v":"7.294","t":"-5.7%","d":"down"},{"l":"Load Testing Ativos","v":"5.060","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+11.5%","d":"up"}];
const COLS = ["ID","Load Testing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","5.972","8.853","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","8.179","5.781","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","8.412","4.857","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","166","577","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","7.778","6.855","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":644},{"label":"Mar","value":923},{"label":"Abr","value":861},{"label":"Mai","value":902},{"label":"Jun","value":611},{"label":"Jul","value":667},{"label":"Ago","value":763},{"label":"Set","value":758},{"label":"Out","value":819},{"label":"Nov","value":621},{"label":"Dez","value":604}];
const MX = 923;
