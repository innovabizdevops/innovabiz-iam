...
const PAGE = "Test Cases";
const KPIS = [{"l":"Total Test Mgmt","v":"8.931","t":"+2.8%","d":"up"},{"l":"Test Cases Ativos","v":"4.467","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.8%","d":"up"}];
const COLS = ["ID","Test Cases","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","3.829","5.631","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","7.259","1.617","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","6.078","3.042","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","1.311","1.652","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","7.093","8.102","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":664},{"label":"Mar","value":450},{"label":"Abr","value":427},{"label":"Mai","value":304},{"label":"Jun","value":650},{"label":"Jul","value":405},{"label":"Ago","value":416},{"label":"Set","value":600},{"label":"Out","value":658},{"label":"Nov","value":494},{"label":"Dez","value":419}];
const MX = 664;
