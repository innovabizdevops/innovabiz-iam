...
const PAGE = "Automation Framework";
const KPIS = [{"l":"Total Test Mgmt","v":"4.379","t":"+6.3%","d":"up"},{"l":"Automation Framework Ativos","v":"7.394","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"70","t":"-1.7%","d":"down"}];
const COLS = ["ID","Automation Framework","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","8.042","3.157","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","7.845","5.713","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","8.070","7.199","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","4.180","5.530","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","2.264","6.930","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":635},{"label":"Mar","value":400},{"label":"Abr","value":394},{"label":"Mai","value":446},{"label":"Jun","value":736},{"label":"Jul","value":463},{"label":"Ago","value":505},{"label":"Set","value":718},{"label":"Out","value":485},{"label":"Nov","value":551},{"label":"Dez","value":508}];
const MX = 736;
