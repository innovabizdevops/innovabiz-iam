...
const ACCENT = "#dc2626";
const MODULE = "Test Management";
const PAGE = "Coverage Report";
const KPIS = [{"l":"Total Test Mgmt","v":"5.504","t":"-5.8%","d":"down"},{"l":"Coverage Report Ativos","v":"4.870","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"87.6%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"87","t":"+17.8%","d":"up"}];
const COLS = ["ID","Coverage Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","109","8.792","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","2.576","6.350","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","7.085","1.262","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","4.314","7.157","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","8.449","8.000","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":490},{"label":"Mar","value":550},{"label":"Abr","value":731},{"label":"Mai","value":726},{"label":"Jun","value":537},{"label":"Jul","value":714},{"label":"Ago","value":743},{"label":"Set","value":490},{"label":"Out","value":726},{"label":"Nov","value":519},{"label":"Dez","value":497}];
const MX = 743;
