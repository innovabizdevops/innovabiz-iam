...
const PAGE = "AI Test Gen";
const KPIS = [{"l":"Total Test Mgmt","v":"8.868","t":"+1.7%","d":"up"},{"l":"AI Test Gen Ativos","v":"5.816","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"90","t":"-4.2%","d":"down"}];
const COLS = ["ID","AI Test Gen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","6.020","3.983","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","9.059","1.999","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","619","4.404","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","8.531","4.865","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","4.854","3.175","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":935},{"label":"Mar","value":766},{"label":"Abr","value":834},{"label":"Mai","value":691},{"label":"Jun","value":760},{"label":"Jul","value":906},{"label":"Ago","value":544},{"label":"Set","value":604},{"label":"Out","value":870},{"label":"Nov","value":552},{"label":"Dez","value":711}];
const MX = 935;
