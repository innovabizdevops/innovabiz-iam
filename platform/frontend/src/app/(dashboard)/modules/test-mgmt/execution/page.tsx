...
const PAGE = "Test Execution";
const KPIS = [{"l":"Total Test Mgmt","v":"7.305","t":"+15.4%","d":"up"},{"l":"Test Execution Ativos","v":"5.609","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"61","t":"+17.3%","d":"up"}];
const COLS = ["ID","Test Execution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","5.381","7.713","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","5.960","7.439","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","1.683","3.358","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","8.872","6.307","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","7.836","3.891","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":751},{"label":"Mar","value":462},{"label":"Abr","value":819},{"label":"Mai","value":432},{"label":"Jun","value":817},{"label":"Jul","value":647},{"label":"Ago","value":709},{"label":"Set","value":748},{"label":"Out","value":443},{"label":"Nov","value":545},{"label":"Dez","value":764}];
const MX = 819;
