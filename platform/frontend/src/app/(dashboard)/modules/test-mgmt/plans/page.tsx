...
const PAGE = "Test Plans";
const KPIS = [{"l":"Total Test Mgmt","v":"5.751","t":"+2.6%","d":"up"},{"l":"Test Plans Ativos","v":"298","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"95.0%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+17.9%","d":"up"}];
const COLS = ["ID","Test Plans","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Mgmt #001","Test Mgmt #002","144","1.287","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Test Mgmt #002","Test Mgmt #003","1.247","7.143","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Mgmt #003","Test Mgmt #004","3.791","5.106","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Test Mgmt #004","Test Mgmt #005","8.615","8.181","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Mgmt #005","Test Mgmt #001","7.744","1.714","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":562},{"label":"Mar","value":508},{"label":"Abr","value":579},{"label":"Mai","value":867},{"label":"Jun","value":867},{"label":"Jul","value":708},{"label":"Ago","value":560},{"label":"Set","value":645},{"label":"Out","value":851},{"label":"Nov","value":634},{"label":"Dez","value":651}];
const MX = 867;
