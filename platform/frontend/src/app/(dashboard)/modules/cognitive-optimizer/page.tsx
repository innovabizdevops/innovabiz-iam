...
/* ═══ Cognitive Cost Optimizer — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "1269", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4709", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€281K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "402356969", cells: ["COG-3969", "Cognitive Cost Optimizer Item 1", "22/6/2026", "€7069"], status: "active" as const },
    { id: "402360540", cells: ["COG-7540", "Cognitive Cost Optimizer Item 2", "9/1/2026", "€10 640"], status: "pending" as const },
    { id: "402364111", cells: ["COG-2111", "Cognitive Cost Optimizer Item 3", "24/8/2026", "€14 211"], status: "completed" as const },
    { id: "402367682", cells: ["COG-5682", "Cognitive Cost Optimizer Item 4", "11/3/2026", "€17 782"], status: "warning" as const },
    { id: "402371253", cells: ["COG-9253", "Cognitive Cost Optimizer Item 5", "26/10/2026", "€21 353"], status: "active" as const },
];
...
export default function CognitiveCostOptimizerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Cost Optimizer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Cost Optimizer</p>
                    </div>
                </div>
