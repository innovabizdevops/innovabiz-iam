...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"4.335","t":"+10.4%","d":"up"},{"l":"Queries/Dia","v":"4440","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.767","t":"+0.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.063","t":"+10.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2240","2026-01-13","6.423","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","937","2026-03-21","611","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3155","2026-03-27","5.589","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1309","2026-01-12","3.513","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1901","2026-03-19","1.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":522},{"label":"Mar","value":294},{"label":"Abr","value":540},{"label":"Mai","value":423},{"label":"Jun","value":380},{"label":"Jul","value":243},{"label":"Ago","value":393},{"label":"Set","value":577},{"label":"Out","value":351},{"label":"Nov","value":294},{"label":"Dez","value":377}];
const MX = 577;
