...
const ACCENT = "#312e81";
const MODULE = "Cognitive Cost Optimizer";
const PAGE = "Recommend";
const KPIS = [{"l":"Total Cognitive Optimizer","v":"2.464","t":"+10.7%","d":"up"},{"l":"Recommend Ativos","v":"6.622","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"66.4%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"93","t":"+16.8%","d":"up"}];
const COLS = ["ID","Recommend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cognitive Optimizer #001","Cognitive Optimizer #002","5.479","4.425","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Cognitive Optimizer #002","Cognitive Optimizer #003","3.949","289","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Cognitive Optimizer #003","Cognitive Optimizer #004","5.990","1.392","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cognitive Optimizer #004","Cognitive Optimizer #005","6.127","7.321","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cognitive Optimizer #005","Cognitive Optimizer #001","7.117","6.130","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":755},{"label":"Mar","value":913},{"label":"Abr","value":898},{"label":"Mai","value":874},{"label":"Jun","value":966},{"label":"Jul","value":689},{"label":"Ago","value":977},{"label":"Set","value":961},{"label":"Out","value":1030},{"label":"Nov","value":691},{"label":"Dez","value":914}];
const MX = 1030;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#312e81'}}>AI</span></h1>
                </div>
