...
const ACCENT = "#6366f1";
const MODULE = "Judiciary System";
const PAGE = "E-Filing";
const KPIS = [{"l":"Total Judiciary Sys","v":"3.482","t":"-3.8%","d":"down"},{"l":"E Filing Ativos","v":"3.984","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"76","t":"+14.1%","d":"up"}];
const COLS = ["ID","E Filing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Judiciary Sys #001","Judiciary Sys #002","8.201","6.015","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Judiciary Sys #002","Judiciary Sys #003","6.611","6.053","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Judiciary Sys #003","Judiciary Sys #004","6.677","2.422","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Judiciary Sys #004","Judiciary Sys #005","4.312","4.745","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Judiciary Sys #005","Judiciary Sys #001","7.203","1.660","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":573},{"label":"Mar","value":681},{"label":"Abr","value":918},{"label":"Mai","value":904},{"label":"Jun","value":784},{"label":"Jul","value":730},{"label":"Ago","value":703},{"label":"Set","value":608},{"label":"Out","value":843},{"label":"Nov","value":706},{"label":"Dez","value":854}];
const MX = 918;
