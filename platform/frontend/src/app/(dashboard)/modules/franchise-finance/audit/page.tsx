...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.711","t":"-5.1%","d":"down"},{"l":"NC Abertas","v":"7.520","t":"+17.6%","d":"up"},{"l":"Conformidade (%)","v":"85.7%","t":"+2.3%","d":"up"},{"l":"CAPAs Pendentes","v":"1.614","t":"-0.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.562","98.4%","2.509","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.417","70.1%","4.080","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.703","90.0%","8.863","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","694","96.8%","2.678","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.334","85.0%","1.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":590},{"label":"Mar","value":646},{"label":"Abr","value":870},{"label":"Mai","value":836},{"label":"Jun","value":530},{"label":"Jul","value":503},{"label":"Ago","value":539},{"label":"Set","value":835},{"label":"Out","value":843},{"label":"Nov","value":809},{"label":"Dez","value":702}];
const MX = 870;
