...
/* ═══ Franchise Finance — Dashboard ═══ */

const ACCENT = "#3b82f6";

const KPIS = [
    { label: "Total Registos", value: "2523", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1122", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€191K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2117117423", cells: ["FRA-3423", "Franchise Finance Item 1", "16/12/2026", "€17 523"], status: "active" as const },
    { id: "2117120994", cells: ["FRA-6994", "Franchise Finance Item 2", "3/7/2026", "€21 094"], status: "pending" as const },
    { id: "2117124565", cells: ["FRA-1565", "Franchise Finance Item 3", "18/2/2026", "€24 665"], status: "completed" as const },
    { id: "2117128136", cells: ["FRA-5136", "Franchise Finance Item 4", "5/9/2026", "€28 236"], status: "warning" as const },
    { id: "2117131707", cells: ["FRA-8707", "Franchise Finance Item 5", "20/4/2026", "€31 807"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Finance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Finance</p>
                    </div>
                </div>
