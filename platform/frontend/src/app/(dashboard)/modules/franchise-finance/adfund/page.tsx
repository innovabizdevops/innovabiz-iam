...
const ACCENT = "#3b82f6";
const MODULE = "Franchise Finance";
const PAGE = "Ad Fund";
const KPIS = [{"l":"Total Franchise Finance","v":"8.817","t":"+11.6%","d":"up"},{"l":"Ad Fund Ativos","v":"3.915","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"75.7%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+15.9%","d":"up"}];
const COLS = ["ID","Ad Fund","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Franchise Finance #001","Franchise Finance #002","602","4.265","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Franchise Finance #002","Franchise Finance #003","7.221","4.367","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Franchise Finance #003","Franchise Finance #004","962","3.378","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Franchise Finance #004","Franchise Finance #005","8.197","6.065","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Franchise Finance #005","Franchise Finance #001","4.886","6.903","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":808},{"label":"Mar","value":934},{"label":"Abr","value":761},{"label":"Mai","value":774},{"label":"Jun","value":702},{"label":"Jul","value":952},{"label":"Ago","value":782},{"label":"Set","value":912},{"label":"Out","value":841},{"label":"Nov","value":882},{"label":"Dez","value":742}];
const MX = 952;
...
export default function AdfundPage() {
    return (
