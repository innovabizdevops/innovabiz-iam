...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Modular Fabric";
const PAGE = "Depend";
const KPIS = [{"l":"Total Multi Modular","v":"2.777","t":"+10.6%","d":"up"},{"l":"Depend Ativos","v":"1.621","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"68","t":"+11.5%","d":"up"}];
const COLS = ["ID","Depend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Modular #001","Multi Modular #002","6.888","4.337","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Modular #002","Multi Modular #003","3.785","1.751","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Modular #003","Multi Modular #004","722","7.809","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Modular #004","Multi Modular #005","5.826","6.901","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Modular #005","Multi Modular #001","5.729","6.403","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":726},{"label":"Mar","value":836},{"label":"Abr","value":868},{"label":"Mai","value":645},{"label":"Jun","value":621},{"label":"Jul","value":782},{"label":"Ago","value":550},{"label":"Set","value":530},{"label":"Out","value":850},{"label":"Nov","value":541},{"label":"Dez","value":769}];
const MX = 868;
...
export default function DependPage() {
    return (
