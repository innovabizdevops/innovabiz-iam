...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"783","t":"-0.6%","d":"down"},{"l":"Submissões/Dia","v":"3611","t":"+1.3%","d":"up"},{"l":"Documentos Gerados","v":"2.230","t":"+6.0%","d":"up"},{"l":"Templates","v":"6.472","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.384","2026-02-19","7.317","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.707","2026-01-18","7.238","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.361","2026-03-19","6.217","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.843","2026-01-11","1.348","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.312","2026-01-13","6.272","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":605},{"label":"Mar","value":943},{"label":"Abr","value":755},{"label":"Mai","value":843},{"label":"Jun","value":733},{"label":"Jul","value":897},{"label":"Ago","value":648},{"label":"Set","value":656},{"label":"Out","value":857},{"label":"Nov","value":655},{"label":"Dez","value":914}];
const MX = 943;
