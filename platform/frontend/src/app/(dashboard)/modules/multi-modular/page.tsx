...
/* ═══ Multi-Modular Fabric — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "9291", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3467", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€168K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1130797091", cells: ["MUL-2091", "Multi-Modular Fabric Item 1", "12/12/2026", "€47 191"], status: "active" as const },
    { id: "1130800662", cells: ["MUL-5662", "Multi-Modular Fabric Item 2", "27/7/2026", "€762"], status: "pending" as const },
    { id: "1130804233", cells: ["MUL-9233", "Multi-Modular Fabric Item 3", "14/2/2026", "€4333"], status: "completed" as const },
    { id: "1130807804", cells: ["MUL-3804", "Multi-Modular Fabric Item 4", "1/9/2026", "€7904"], status: "warning" as const },
    { id: "1130811375", cells: ["MUL-7375", "Multi-Modular Fabric Item 5", "16/4/2026", "€11 475"], status: "active" as const },
];
...
export default function MultimodularFabricPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Modular Fabric</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Modular Fabric</p>
                    </div>
                </div>
