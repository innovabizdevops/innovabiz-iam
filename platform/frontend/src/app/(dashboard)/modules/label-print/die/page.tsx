...
const PAGE = "Die Cut";
const KPIS = [{"l":"Total Label Print","v":"4.954","t":"-3.9%","d":"down"},{"l":"Die Cut Ativos","v":"8.127","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"70","t":"+15.8%","d":"up"}];
const COLS = ["ID","Die Cut","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Label Print #001","Label Print #002","5.548","6.045","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Label Print #002","Label Print #003","8.778","7.569","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Label Print #003","Label Print #004","5.428","6.165","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Label Print #004","Label Print #005","2.629","7.088","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Label Print #005","Label Print #001","1.997","6.865","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":518},{"label":"Mar","value":600},{"label":"Abr","value":563},{"label":"Mai","value":580},{"label":"Jun","value":672},{"label":"Jul","value":496},{"label":"Ago","value":401},{"label":"Set","value":592},{"label":"Out","value":623},{"label":"Nov","value":499},{"label":"Dez","value":656}];
const MX = 672;
