...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Label Print","v":"4.365","t":"+7.8%","d":"up"},{"l":"Inspect Ativos","v":"5.296","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"66","t":"+16.6%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Label Print #001","Label Print #002","4.232","8.989","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Label Print #002","Label Print #003","7.735","2.046","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Label Print #003","Label Print #004","1.668","6.672","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Label Print #004","Label Print #005","7.842","6.668","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Label Print #005","Label Print #001","8.083","1.349","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":993},{"label":"Fev","value":873},{"label":"Mar","value":830},{"label":"Abr","value":767},{"label":"Mai","value":772},{"label":"Jun","value":848},{"label":"Jul","value":710},{"label":"Ago","value":653},{"label":"Set","value":801},{"label":"Out","value":639},{"label":"Nov","value":909},{"label":"Dez","value":800}];
const MX = 993;
