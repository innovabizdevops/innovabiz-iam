...
const PAGE = "Apply";
const KPIS = [{"l":"Total Label Print","v":"3.790","t":"-3.6%","d":"down"},{"l":"Apply Ativos","v":"429","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"76","t":"-0.2%","d":"down"}];
const COLS = ["ID","Apply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Label Print #001","Label Print #002","8.691","8.791","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Label Print #002","Label Print #003","2.627","3.844","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Label Print #003","Label Print #004","2.463","3.284","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Label Print #004","Label Print #005","8.564","4.705","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Label Print #005","Label Print #001","2.866","990","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":247},{"label":"Fev","value":498},{"label":"Mar","value":490},{"label":"Abr","value":555},{"label":"Mai","value":282},{"label":"Jun","value":288},{"label":"Jul","value":401},{"label":"Ago","value":539},{"label":"Set","value":252},{"label":"Out","value":261},{"label":"Nov","value":252},{"label":"Dez","value":244}];
const MX = 555;
