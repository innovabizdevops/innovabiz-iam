...
const PAGE = "Variable";
const KPIS = [{"l":"Total Label Print","v":"1.809","t":"+0.4%","d":"up"},{"l":"Variable Ativos","v":"7.315","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"75","t":"+2.4%","d":"up"}];
const COLS = ["ID","Variable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Label Print #001","Label Print #002","2.918","1.765","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Label Print #002","Label Print #003","5.553","1.575","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Label Print #003","Label Print #004","2.723","4.184","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Label Print #004","Label Print #005","2.623","4.445","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Label Print #005","Label Print #001","4.542","103","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":605},{"label":"Mar","value":747},{"label":"Abr","value":549},{"label":"Mai","value":660},{"label":"Jun","value":669},{"label":"Jul","value":829},{"label":"Ago","value":699},{"label":"Set","value":840},{"label":"Out","value":622},{"label":"Nov","value":526},{"label":"Dez","value":779}];
const MX = 840;
