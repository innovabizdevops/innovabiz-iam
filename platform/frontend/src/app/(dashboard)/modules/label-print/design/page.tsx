...
const ACCENT = "#6366f1";
const MODULE = "Label Printing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.325","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"1449","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"2.264","t":"+1.4%","d":"up"},{"l":"Templates","v":"7.127","t":"+4.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.739","2026-03-19","2.183","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.867","2026-01-27","1.288","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.709","2026-02-25","7.182","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.973","2026-02-24","7.895","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.985","2026-02-13","8.812","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":364},{"label":"Mar","value":567},{"label":"Abr","value":526},{"label":"Mai","value":568},{"label":"Jun","value":511},{"label":"Jul","value":619},{"label":"Ago","value":438},{"label":"Set","value":471},{"label":"Out","value":389},{"label":"Nov","value":463},{"label":"Dez","value":666}];
const MX = 666;
