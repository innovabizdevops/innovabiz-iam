...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.541","t":"+11.8%","d":"up"},{"l":"NC Abertas","v":"3.454","t":"+8.9%","d":"up"},{"l":"Conformidade (%)","v":"89.4%","t":"-4.2%","d":"down"},{"l":"CAPAs Pendentes","v":"2.434","t":"+4.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.708","93.8%","8.308","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.141","87.4%","3.252","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.730","81.1%","4.270","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.021","86.5%","7.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.539","87.4%","2.825","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":840},{"label":"Mar","value":689},{"label":"Abr","value":704},{"label":"Mai","value":497},{"label":"Jun","value":837},{"label":"Jul","value":560},{"label":"Ago","value":484},{"label":"Set","value":755},{"label":"Out","value":785},{"label":"Nov","value":819},{"label":"Dez","value":592}];
const MX = 840;
