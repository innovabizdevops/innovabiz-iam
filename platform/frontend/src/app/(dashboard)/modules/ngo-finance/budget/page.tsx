...
const PAGE = "Budget";
const KPIS = [{"l":"Total Ngo Finance","v":"7.417","t":"+2.1%","d":"up"},{"l":"Budget Ativos","v":"€82250","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"60","t":"-0.5%","d":"down"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ngo Finance #001","€ 43061.54","1.906","8.967","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Ngo Finance #002","€ 2622.18","4.418","5.911","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Ngo Finance #003","€ 6413.04","7.529","5.835","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ngo Finance #004","€ 17541.13","4.561","5.533","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ngo Finance #005","€ 26723.82","1.486","5.019","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":704},{"label":"Mar","value":421},{"label":"Abr","value":737},{"label":"Mai","value":630},{"label":"Jun","value":423},{"label":"Jul","value":753},{"label":"Ago","value":400},{"label":"Set","value":469},{"label":"Out","value":410},{"label":"Nov","value":369},{"label":"Dez","value":566}];
const MX = 753;
