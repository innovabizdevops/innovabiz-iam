...
const PAGE = "Fund Account";
const KPIS = [{"l":"Total Ngo Finance","v":"7.011","t":"+10.4%","d":"up"},{"l":"Fund Account Ativos","v":"4.935","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"78.7%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"85","t":"+3.2%","d":"up"}];
const COLS = ["ID","Fund Account","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ngo Finance #001","Ngo Finance #002","8.748","1.027","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ngo Finance #002","Ngo Finance #003","6.663","2.735","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ngo Finance #003","Ngo Finance #004","5.406","167","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Ngo Finance #004","Ngo Finance #005","1.310","7.298","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ngo Finance #005","Ngo Finance #001","2.742","1.236","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":635},{"label":"Mar","value":666},{"label":"Abr","value":614},{"label":"Mai","value":808},{"label":"Jun","value":672},{"label":"Jul","value":972},{"label":"Ago","value":883},{"label":"Set","value":977},{"label":"Out","value":872},{"label":"Nov","value":629},{"label":"Dez","value":913}];
const MX = 977;
