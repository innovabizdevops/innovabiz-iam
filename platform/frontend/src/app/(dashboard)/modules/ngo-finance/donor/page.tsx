...
const ACCENT = "#6366f1";
const MODULE = "NGO Finance";
const PAGE = "Report Donor";
const KPIS = [{"l":"Total Ngo Finance","v":"6.577","t":"-5.9%","d":"down"},{"l":"Report Donor Ativos","v":"5.841","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"87","t":"-3.6%","d":"down"}];
const COLS = ["ID","Report Donor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ngo Finance #001","Ngo Finance #002","3.000","4.772","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Ngo Finance #002","Ngo Finance #003","601","6.927","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Ngo Finance #003","Ngo Finance #004","6.387","892","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Ngo Finance #004","Ngo Finance #005","1.135","2.047","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ngo Finance #005","Ngo Finance #001","3.716","4.389","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":531},{"label":"Mar","value":554},{"label":"Abr","value":654},{"label":"Mai","value":817},{"label":"Jun","value":817},{"label":"Jul","value":749},{"label":"Ago","value":677},{"label":"Set","value":609},{"label":"Out","value":683},{"label":"Nov","value":806},{"label":"Dez","value":662}];
const MX = 817;
