...
const KPIS = [{"l":"Total Dealer Mgmt","v":"3.024","t":"+17.2%","d":"up"},{"l":"Allocation Ativos","v":"2.027","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-2.5%","d":"down"}];
const COLS = ["ID","Allocation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dealer Mgmt #001","Dealer Mgmt #002","989","530","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Dealer Mgmt #002","Dealer Mgmt #003","1.370","1.393","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Dealer Mgmt #003","Dealer Mgmt #004","645","3.406","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Dealer Mgmt #004","Dealer Mgmt #005","6.005","2.964","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dealer Mgmt #005","Dealer Mgmt #001","1.862","2.683","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":367},{"label":"Mar","value":326},{"label":"Abr","value":422},{"label":"Mai","value":377},{"label":"Jun","value":581},{"label":"Jul","value":257},{"label":"Ago","value":326},{"label":"Set","value":446},{"label":"Out","value":579},{"label":"Nov","value":302},{"label":"Dez","value":217}];
const MX = 581;
