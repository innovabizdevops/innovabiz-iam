...
const PAGE = "Training";
const KPIS = [{"l":"Total Dealer Mgmt","v":"8.308","t":"+2.8%","d":"up"},{"l":"Training Ativos","v":"2.060","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"86","t":"+14.0%","d":"up"}];
const COLS = ["ID","Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dealer Mgmt #001","Dealer Mgmt #002","1.962","4.490","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Dealer Mgmt #002","Dealer Mgmt #003","3.119","3.638","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Dealer Mgmt #003","Dealer Mgmt #004","3.643","903","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Dealer Mgmt #004","Dealer Mgmt #005","8.917","7.650","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dealer Mgmt #005","Dealer Mgmt #001","1.183","5.597","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":934},{"label":"Mar","value":705},{"label":"Abr","value":819},{"label":"Mai","value":1011},{"label":"Jun","value":684},{"label":"Jul","value":858},{"label":"Ago","value":940},{"label":"Set","value":940},{"label":"Out","value":988},{"label":"Nov","value":919},{"label":"Dez","value":968}];
const MX = 1011;
