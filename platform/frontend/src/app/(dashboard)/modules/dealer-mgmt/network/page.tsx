...
const KPIS = [{"l":"Total Dealer Mgmt","v":"455","t":"+5.1%","d":"up"},{"l":"Network Map Ativos","v":"1.156","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"78.1%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"77","t":"+10.2%","d":"up"}];
const COLS = ["ID","Network Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dealer Mgmt #001","Dealer Mgmt #002","3.849","5.736","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Dealer Mgmt #002","Dealer Mgmt #003","3.148","1.106","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Dealer Mgmt #003","Dealer Mgmt #004","5.112","1.074","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Dealer Mgmt #004","Dealer Mgmt #005","1.743","3.094","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dealer Mgmt #005","Dealer Mgmt #001","6.772","3.704","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":712},{"label":"Mar","value":652},{"label":"Abr","value":786},{"label":"Mai","value":806},{"label":"Jun","value":982},{"label":"Jul","value":971},{"label":"Ago","value":972},{"label":"Set","value":670},{"label":"Out","value":940},{"label":"Nov","value":733},{"label":"Dez","value":974}];
const MX = 982;
