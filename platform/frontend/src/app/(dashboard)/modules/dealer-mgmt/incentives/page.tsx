...
const ACCENT = "#87a9cf";
const MODULE = "Dealer Management";
const PAGE = "Incentive Pgm";
const KPIS = [{"l":"Vendas YTD (€)","v":"€8591","t":"-0.7%","d":"down"},{"l":"Pipeline (€)","v":"€38746","t":"+10.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"81.3%","t":"+16.0%","d":"up"},{"l":"Win Rate (%)","v":"75.8%","t":"-2.6%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 33501.37","€ 31214.19","€ 643.36","79.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 202.59","€ 35784.77","€ 28224.70","73.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 40825.56","€ 3361.77","€ 22638.75","89.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 48807.36","€ 10776.15","€ 12772.33","91.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 8546.82","€ 29873.69","€ 18180.36","78.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":962},{"label":"Mar","value":740},{"label":"Abr","value":944},{"label":"Mai","value":626},{"label":"Jun","value":911},{"label":"Jul","value":896},{"label":"Ago","value":822},{"label":"Set","value":779},{"label":"Out","value":842},{"label":"Nov","value":618},{"label":"Dez","value":645}];
const MX = 962;
