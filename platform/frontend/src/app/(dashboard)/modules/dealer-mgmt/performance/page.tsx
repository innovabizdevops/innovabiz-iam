...
const KPIS = [{"l":"Formulários Ativos","v":"3.249","t":"+1.5%","d":"up"},{"l":"Submissões/Dia","v":"4965","t":"+9.3%","d":"up"},{"l":"Documentos Gerados","v":"9.044","t":"+6.0%","d":"up"},{"l":"Templates","v":"6.646","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.846","2026-03-11","8.809","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.174","2026-03-10","2.084","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.177","2026-03-18","4.706","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.723","2026-01-19","3.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","678","2026-01-19","4.432","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":737},{"label":"Mar","value":763},{"label":"Abr","value":559},{"label":"Mai","value":698},{"label":"Jun","value":465},{"label":"Jul","value":576},{"label":"Ago","value":507},{"label":"Set","value":477},{"label":"Out","value":769},{"label":"Nov","value":604},{"label":"Dez","value":620}];
const MX = 769;
