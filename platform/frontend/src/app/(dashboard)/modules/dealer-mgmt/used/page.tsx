...
const PAGE = "Used Vehicle";
const KPIS = [{"l":"Total Dealer Mgmt","v":"8.713","t":"+9.0%","d":"up"},{"l":"Used Vehicle Ativos","v":"8.344","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"84","t":"+2.7%","d":"up"}];
const COLS = ["ID","Used Vehicle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dealer Mgmt #001","Dealer Mgmt #002","6.932","2.299","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Dealer Mgmt #002","Dealer Mgmt #003","7.196","3.468","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Dealer Mgmt #003","Dealer Mgmt #004","2.467","2.981","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Dealer Mgmt #004","Dealer Mgmt #005","1.235","2.533","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dealer Mgmt #005","Dealer Mgmt #001","1.144","3.999","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":676},{"label":"Mar","value":739},{"label":"Abr","value":459},{"label":"Mai","value":577},{"label":"Jun","value":566},{"label":"Jul","value":775},{"label":"Ago","value":475},{"label":"Set","value":449},{"label":"Out","value":585},{"label":"Nov","value":704},{"label":"Dez","value":782}];
const MX = 798;
