...
const KPIS = [{"l":"Tickets Abertos","v":"5.091","t":"-5.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"78.9%","t":"+6.5%","d":"up"},{"l":"MTTR (h)","v":"188h","t":"+8.1%","d":"up"},{"l":"Satisfação (%)","v":"86.5%","t":"+10.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.021","4.825","2.398","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.286","2.856","3.046","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.437","8.165","6.350","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.166","6.270","5.121","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.961","8.879","6.521","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":437},{"label":"Mar","value":674},{"label":"Abr","value":536},{"label":"Mai","value":423},{"label":"Jun","value":530},{"label":"Jul","value":368},{"label":"Ago","value":505},{"label":"Set","value":532},{"label":"Out","value":656},{"label":"Nov","value":551},{"label":"Dez","value":526}];
const MX = 674;
