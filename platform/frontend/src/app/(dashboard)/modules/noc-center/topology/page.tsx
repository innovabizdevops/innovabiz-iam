...
const PAGE = "Topology Map";
const KPIS = [{"l":"Total Noc Center","v":"8.697","t":"+11.6%","d":"up"},{"l":"Topology Map Ativos","v":"4.236","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"75","t":"+5.8%","d":"up"}];
const COLS = ["ID","Topology Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Noc Center #001","Noc Center #002","6.610","3.565","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Noc Center #002","Noc Center #003","1.718","6.488","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Noc Center #003","Noc Center #004","8.579","8.244","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Noc Center #004","Noc Center #005","3.260","5.004","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Noc Center #005","Noc Center #001","741","2.369","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":496},{"label":"Mar","value":703},{"label":"Abr","value":312},{"label":"Mai","value":400},{"label":"Jun","value":661},{"label":"Jul","value":494},{"label":"Ago","value":389},{"label":"Set","value":551},{"label":"Out","value":606},{"label":"Nov","value":702},{"label":"Dez","value":703}];
const MX = 703;
