...
export default function NocCenterPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Noc Center</h1><p className="text-sm text-muted-foreground">Noc Center • iBOS Enterprise</p></div>
