...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"3.464","t":"-5.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"86.8%","t":"+11.7%","d":"up"},{"l":"MTTR (h)","v":"93h","t":"+1.9%","d":"up"},{"l":"Satisfação (%)","v":"81.6%","t":"-1.8%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.140","2.489","6.092","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.513","2.114","3.697","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.356","2.941","5.392","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.618","5.210","7.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","815","5.121","3.151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":667},{"label":"Mar","value":630},{"label":"Abr","value":834},{"label":"Mai","value":556},{"label":"Jun","value":643},{"label":"Jul","value":624},{"label":"Ago","value":597},{"label":"Set","value":807},{"label":"Out","value":880},{"label":"Nov","value":754},{"label":"Dez","value":647}];
const MX = 880;
