...
const PAGE = "Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"3.337","t":"+16.4%","d":"up"},{"l":"Queries/Dia","v":"3251","t":"+4.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.936","t":"+14.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.705","t":"+16.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1857","2026-02-16","2.233","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","532","2026-01-18","8.758","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4478","2026-03-01","8.595","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4391","2026-03-14","2.302","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1402","2026-03-19","8.922","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":919},{"label":"Mar","value":930},{"label":"Abr","value":825},{"label":"Mai","value":1062},{"label":"Jun","value":900},{"label":"Jul","value":942},{"label":"Ago","value":795},{"label":"Set","value":918},{"label":"Out","value":852},{"label":"Nov","value":1061},{"label":"Dez","value":705}];
const MX = 1062;
