...
const KPIS = [{"l":"Notificações Enviadas","v":"307","t":"+0.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"86.3%","t":"+11.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"93.4%","t":"+13.6%","d":"up"},{"l":"Escalações","v":"8.935","t":"-2.0%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.052","76.9%","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","3.180","70.7%","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.691","88.8%","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.803","97.0%","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","3.436","77.4%","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":858},{"label":"Mar","value":1007},{"label":"Abr","value":792},{"label":"Mai","value":655},{"label":"Jun","value":884},{"label":"Jul","value":688},{"label":"Ago","value":817},{"label":"Set","value":965},{"label":"Out","value":761},{"label":"Nov","value":835},{"label":"Dez","value":708}];
const MX = 1007;
