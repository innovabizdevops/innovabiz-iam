...
const KPIS = [{"l":"Total Plant Maint Sap","v":"8.314","t":"+8.7%","d":"up"},{"l":"Completion Ativos","v":"3.491","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"57","t":"-0.9%","d":"down"}];
const COLS = ["ID","Completion","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plant Maint Sap #001","Plant Maint Sap #002","4.096","4.815","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Plant Maint Sap #002","Plant Maint Sap #003","4.306","6.961","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Plant Maint Sap #003","Plant Maint Sap #004","9.041","7.796","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Plant Maint Sap #004","Plant Maint Sap #005","7.139","6.498","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plant Maint Sap #005","Plant Maint Sap #001","640","5.597","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":990},{"label":"Mar","value":720},{"label":"Abr","value":728},{"label":"Mai","value":896},{"label":"Jun","value":825},{"label":"Jul","value":766},{"label":"Ago","value":851},{"label":"Set","value":864},{"label":"Out","value":1055},{"label":"Nov","value":673},{"label":"Dez","value":752}];
const MX = 1055;
