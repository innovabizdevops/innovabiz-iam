...
const KPIS = [{"l":"eNPS","v":"93","t":"-1.2%","d":"down"},{"l":"Engagement (%)","v":"83.2%","t":"+12.0%","d":"up"},{"l":"Turnover (%)","v":"91.4%","t":"+11.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.683","t":"+6.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.593","2026-03-08","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","682","2026-03-07","82","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.668","2026-02-14","84","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.535","2026-01-23","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.271","2026-02-19","82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":738},{"label":"Mar","value":987},{"label":"Abr","value":833},{"label":"Mai","value":974},{"label":"Jun","value":688},{"label":"Jul","value":976},{"label":"Ago","value":987},{"label":"Set","value":865},{"label":"Out","value":773},{"label":"Nov","value":951},{"label":"Dez","value":852}];
const MX = 987;
