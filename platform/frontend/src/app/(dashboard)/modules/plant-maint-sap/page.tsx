...
/* ═══ Plant Maintenance (SAP PM) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "165", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "331", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€258K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1417749365", cells: ["PLA-7365", "Plant Maintenance (SAP PM) Item 1", "26/6/2026", "€49 465"], status: "active" as const },
    { id: "1417752936", cells: ["PLA-1936", "Plant Maintenance (SAP PM) Item 2", "13/1/2026", "€3036"], status: "pending" as const },
    { id: "1417756507", cells: ["PLA-5507", "Plant Maintenance (SAP PM) Item 3", "28/8/2026", "€6607"], status: "completed" as const },
    { id: "1417760078", cells: ["PLA-9078", "Plant Maintenance (SAP PM) Item 4", "15/3/2026", "€10 178"], status: "warning" as const },
    { id: "1417763649", cells: ["PLA-3649", "Plant Maintenance (SAP PM) Item 5", "2/10/2026", "€13 749"], status: "active" as const },
];
...
export default function PlantMaintenanceSapPmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Plant Maintenance (SAP PM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Plant Maintenance (SAP PM)</p>
                    </div>
                </div>
