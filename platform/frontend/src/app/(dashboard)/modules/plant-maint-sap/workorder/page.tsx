...
const ACCENT = "#0070f3";
const MODULE = "Plant Maintenance (SAP PM)";
const PAGE = "Work Order";
const KPIS = [{"l":"Total Plant Maint Sap","v":"3.900","t":"+11.7%","d":"up"},{"l":"Work Order Ativos","v":"4.984","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"79.9%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"66","t":"+7.2%","d":"up"}];
const COLS = ["ID","Work Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plant Maint Sap #001","Plant Maint Sap #002","8.019","6.231","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Plant Maint Sap #002","Plant Maint Sap #003","1.599","3.104","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Plant Maint Sap #003","Plant Maint Sap #004","7.708","3.732","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Plant Maint Sap #004","Plant Maint Sap #005","5.511","1.569","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plant Maint Sap #005","Plant Maint Sap #001","7.367","2.903","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":894},{"label":"Mar","value":981},{"label":"Abr","value":1064},{"label":"Mai","value":801},{"label":"Jun","value":876},{"label":"Jul","value":923},{"label":"Ago","value":800},{"label":"Set","value":871},{"label":"Out","value":849},{"label":"Nov","value":744},{"label":"Dez","value":1056}];
const MX = 1064;
