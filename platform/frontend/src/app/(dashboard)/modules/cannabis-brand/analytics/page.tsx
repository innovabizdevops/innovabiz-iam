...
const KPIS = [{"l":"Dashboards Ativos","v":"3.790","t":"+13.5%","d":"up"},{"l":"Queries/Dia","v":"2852","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.079","t":"+9.1%","d":"up"},{"l":"Utilizadores Analytics","v":"1.177","t":"+17.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4260","2026-03-27","6.791","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4317","2026-02-21","1.026","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","130","2026-01-19","877","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3378","2026-01-27","6.463","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2977","2026-01-04","551","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":713},{"label":"Mar","value":436},{"label":"Abr","value":613},{"label":"Mai","value":692},{"label":"Jun","value":541},{"label":"Jul","value":557},{"label":"Ago","value":577},{"label":"Set","value":586},{"label":"Out","value":809},{"label":"Nov","value":694},{"label":"Dez","value":624}];
const MX = 809;
