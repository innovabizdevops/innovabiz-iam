...
const KPIS = [{"l":"Total Cannabis Brand","v":"8.900","t":"+16.0%","d":"up"},{"l":"Wholesale Ativos","v":"3.773","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"83","t":"+1.5%","d":"up"}];
const COLS = ["ID","Wholesale","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Brand #001","Cannabis Brand #002","4.164","2.972","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Brand #002","Cannabis Brand #003","7.657","4.836","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Brand #003","Cannabis Brand #004","5.612","1.043","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Brand #004","Cannabis Brand #005","5.261","8.342","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Brand #005","Cannabis Brand #001","8.299","5.512","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":700},{"label":"Mar","value":554},{"label":"Abr","value":486},{"label":"Mai","value":503},{"label":"Jun","value":626},{"label":"Jul","value":609},{"label":"Ago","value":593},{"label":"Set","value":345},{"label":"Out","value":607},{"label":"Nov","value":436},{"label":"Dez","value":665}];
const MX = 700;
