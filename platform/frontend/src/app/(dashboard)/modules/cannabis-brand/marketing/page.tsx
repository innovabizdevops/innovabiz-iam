...
const ACCENT = "#15803d";
const MODULE = "Cannabis Brand Mgmt";
const PAGE = "Marketing";
const KPIS = [{"l":"Total Cannabis Brand","v":"5.524","t":"-0.8%","d":"down"},{"l":"Marketing Ativos","v":"4.048","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"72.8%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.5%","d":"up"}];
const COLS = ["ID","Marketing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Brand #001","Cannabis Brand #002","7.293","5.457","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Brand #002","Cannabis Brand #003","8.538","7.857","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Brand #003","Cannabis Brand #004","5.429","5.196","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Brand #004","Cannabis Brand #005","6.196","7.408","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Brand #005","Cannabis Brand #001","1.435","2.110","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":950},{"label":"Mar","value":886},{"label":"Abr","value":979},{"label":"Mai","value":800},{"label":"Jun","value":699},{"label":"Jul","value":965},{"label":"Ago","value":968},{"label":"Set","value":920},{"label":"Out","value":825},{"label":"Nov","value":976},{"label":"Dez","value":1062}];
const MX = 1062;
