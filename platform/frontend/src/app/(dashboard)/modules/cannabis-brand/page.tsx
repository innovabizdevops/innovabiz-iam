...
/* ═══ Cannabis Brand Mgmt — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "6582", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "293", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€274K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "958276982", cells: ["CAN-2982", "Cannabis Brand Mgmt Item 1", "27/3/2026", "€27 082"], status: "active" as const },
    { id: "958280553", cells: ["CAN-6553", "Cannabis Brand Mgmt Item 2", "14/10/2026", "€30 653"], status: "pending" as const },
    { id: "958284124", cells: ["CAN-1124", "Cannabis Brand Mgmt Item 3", "1/5/2026", "€34 224"], status: "completed" as const },
    { id: "958287695", cells: ["CAN-4695", "Cannabis Brand Mgmt Item 4", "16/12/2026", "€37 795"], status: "warning" as const },
    { id: "958291266", cells: ["CAN-8266", "Cannabis Brand Mgmt Item 5", "3/7/2026", "€41 366"], status: "active" as const },
];
...
export default function CannabisBrandMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Brand Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Brand Mgmt</p>
                    </div>
                </div>
