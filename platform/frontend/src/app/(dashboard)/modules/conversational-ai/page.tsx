...
/* ═══ Conversational AI Platform — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "802", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "832", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€41K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1487762802", cells: ["CON-9802", "Conversational AI Platform Item 1", "23/7/2026", "€12 902"], status: "active" as const },
    { id: "1487766373", cells: ["CON-4373", "Conversational AI Platform Item 2", "10/2/2026", "€16 473"], status: "pending" as const },
    { id: "1487769944", cells: ["CON-7944", "Conversational AI Platform Item 3", "25/9/2026", "€20 044"], status: "completed" as const },
    { id: "1487773515", cells: ["CON-2515", "Conversational AI Platform Item 4", "12/4/2026", "€23 615"], status: "warning" as const },
    { id: "1487777086", cells: ["CON-6086", "Conversational AI Platform Item 5", "27/11/2026", "€27 186"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conversational AI Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Conversational AI Platform</p>
                    </div>
                </div>
