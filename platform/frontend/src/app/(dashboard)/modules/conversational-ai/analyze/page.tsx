...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"7.817","t":"+11.5%","d":"up"},{"l":"Queries/Dia","v":"3323","t":"+10.7%","d":"up"},{"l":"Dados Processados (GB)","v":"981","t":"+14.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.729","t":"+16.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2714","2026-02-26","308","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","999","2026-02-26","2.830","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2290","2026-01-13","6.141","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3776","2026-01-01","7.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2962","2026-02-19","4.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":929},{"label":"Mar","value":834},{"label":"Abr","value":795},{"label":"Mai","value":834},{"label":"Jun","value":974},{"label":"Jul","value":993},{"label":"Ago","value":668},{"label":"Set","value":921},{"label":"Out","value":1005},{"label":"Nov","value":705},{"label":"Dez","value":995}];
const MX = 1005;
