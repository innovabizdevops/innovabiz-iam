...
const ACCENT = "#8b5cf6";
const MODULE = "Conversational AI Platform";
const PAGE = "Handoff";
const KPIS = [{"l":"Total Conversational Ai","v":"8.916","t":"-3.0%","d":"down"},{"l":"Handoff Ativos","v":"8.385","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"78","t":"+15.1%","d":"up"}];
const COLS = ["ID","Handoff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Conversational Ai #001","Conversational Ai #002","8.734","5.988","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Conversational Ai #002","Conversational Ai #003","5.852","3.336","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Conversational Ai #003","Conversational Ai #004","4.480","1.275","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Conversational Ai #004","Conversational Ai #005","2.838","1.000","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Conversational Ai #005","Conversational Ai #001","1.764","4.575","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":348},{"label":"Mar","value":510},{"label":"Abr","value":351},{"label":"Mai","value":269},{"label":"Jun","value":331},{"label":"Jul","value":405},{"label":"Ago","value":503},{"label":"Set","value":348},{"label":"Out","value":477},{"label":"Nov","value":447},{"label":"Dez","value":418}];
const MX = 510;
