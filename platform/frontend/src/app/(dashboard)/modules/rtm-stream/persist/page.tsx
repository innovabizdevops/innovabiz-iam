...
const PAGE = "Persist";
const KPIS = [{"l":"Total Rtm Stream","v":"4.137","t":"+6.1%","d":"up"},{"l":"Persist Ativos","v":"7.913","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"67","t":"+2.7%","d":"up"}];
const COLS = ["ID","Persist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rtm Stream #001","Rtm Stream #002","8.500","7.985","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Rtm Stream #002","Rtm Stream #003","2.850","6.305","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Rtm Stream #003","Rtm Stream #004","892","7.339","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Rtm Stream #004","Rtm Stream #005","5.982","2.623","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rtm Stream #005","Rtm Stream #001","6.491","6.272","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":686},{"label":"Mar","value":991},{"label":"Abr","value":877},{"label":"Mai","value":691},{"label":"Jun","value":945},{"label":"Jul","value":733},{"label":"Ago","value":767},{"label":"Set","value":758},{"label":"Out","value":745},{"label":"Nov","value":814},{"label":"Dez","value":672}];
const MX = 991;
