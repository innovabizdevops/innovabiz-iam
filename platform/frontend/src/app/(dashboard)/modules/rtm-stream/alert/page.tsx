...
const ACCENT = "#dc2626";
const MODULE = "RTM Stream Processing";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"6.031","t":"-4.7%","d":"down"},{"l":"Taxa Entrega (%)","v":"71.5%","t":"+4.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"66.9%","t":"+15.6%","d":"up"},{"l":"Escalações","v":"4.425","t":"-4.7%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.445","79.4%","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.289","78.4%","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.768","73.6%","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.370","91.6%","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.169","80.8%","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":545},{"label":"Mar","value":565},{"label":"Abr","value":500},{"label":"Mai","value":717},{"label":"Jun","value":610},{"label":"Jul","value":723},{"label":"Ago","value":591},{"label":"Set","value":837},{"label":"Out","value":807},{"label":"Nov","value":850},{"label":"Dez","value":542}];
const MX = 850;
