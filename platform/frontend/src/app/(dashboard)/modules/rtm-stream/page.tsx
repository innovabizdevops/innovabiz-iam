...
/* ═══ RTM Stream Processing — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "7869", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "403", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€99K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1799154569", cells: ["RTM-1569", "RTM Stream Processing Item 1", "10/6/2026", "€4669"], status: "active" as const },
    { id: "1799158140", cells: ["RTM-5140", "RTM Stream Processing Item 2", "25/1/2026", "€8240"], status: "pending" as const },
    { id: "1799161711", cells: ["RTM-8711", "RTM Stream Processing Item 3", "12/8/2026", "€11 811"], status: "completed" as const },
    { id: "1799165282", cells: ["RTM-3282", "RTM Stream Processing Item 4", "27/3/2026", "€15 382"], status: "warning" as const },
    { id: "1799168853", cells: ["RTM-6853", "RTM Stream Processing Item 5", "14/10/2026", "€18 953"], status: "active" as const },
];
...
export default function RtmStreamProcessingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RTM Stream Processing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RTM Stream Processing</p>
                    </div>
                </div>
