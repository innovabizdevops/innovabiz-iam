...
/* ═══ EVO Self-Improvement Engine — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "6605", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3218", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€400K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2063354605", cells: ["EVO-6605", "EVO Self-Improvement Engine Item 1", "26/2/2026", "€4705"], status: "active" as const },
    { id: "2063358176", cells: ["EVO-1176", "EVO Self-Improvement Engine Item 2", "13/9/2026", "€8276"], status: "pending" as const },
    { id: "2063361747", cells: ["EVO-4747", "EVO Self-Improvement Engine Item 3", "28/4/2026", "€11 847"], status: "completed" as const },
    { id: "2063365318", cells: ["EVO-8318", "EVO Self-Improvement Engine Item 4", "15/11/2026", "€15 418"], status: "warning" as const },
    { id: "2063368889", cells: ["EVO-2889", "EVO Self-Improvement Engine Item 5", "2/6/2026", "€18 989"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 65 }, { label: "Fev", value: 74 }, { label: "Mar", value: 83 }, { label: "Abr", value: 92 }, { label: "Mai", value: 21 }, { label: "Jun", value: 30 }];
...
export default function EvoSelfimprovementEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EVO Self-Improvement Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EVO Self-Improvement Engine</p>
                    </div>
                </div>
