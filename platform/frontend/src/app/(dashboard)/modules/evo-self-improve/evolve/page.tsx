...
const PAGE = "Evolve";
const KPIS = [{"l":"Projetos Melhoria","v":"8.015","t":"+12.2%","d":"up"},{"l":"Savings (€)","v":"€85548","t":"+14.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.7%","t":"+6.3%","d":"up"},{"l":"Ciclos PDCA","v":"5.157","t":"+13.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.038","€ 28520.59","1.344","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.197","€ 48174.61","5.516","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.996","€ 36635.36","5.833","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.916","€ 45269.39","8.991","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.799","€ 41111.96","1.763","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":697},{"label":"Mar","value":523},{"label":"Abr","value":440},{"label":"Mai","value":707},{"label":"Jun","value":392},{"label":"Jul","value":500},{"label":"Ago","value":654},{"label":"Set","value":608},{"label":"Out","value":375},{"label":"Nov","value":579},{"label":"Dez","value":390}];
const MX = 707;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>EVO</span></h1>
                </div>
