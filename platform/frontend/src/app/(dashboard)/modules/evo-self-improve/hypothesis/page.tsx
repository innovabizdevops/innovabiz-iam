...
const KPIS = [{"l":"Projetos Melhoria","v":"3.692","t":"+10.0%","d":"up"},{"l":"Savings (€)","v":"€88003","t":"+5.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.8%","t":"+16.6%","d":"up"},{"l":"Ciclos PDCA","v":"3.733","t":"+7.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","574","€ 39070.47","7.331","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.284","€ 38287.03","4.572","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.364","€ 24685.89","818","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.019","€ 11937.85","6.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.465","€ 49417.63","2.736","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":845},{"label":"Mar","value":626},{"label":"Abr","value":901},{"label":"Mai","value":591},{"label":"Jun","value":939},{"label":"Jul","value":720},{"label":"Ago","value":785},{"label":"Set","value":930},{"label":"Out","value":629},{"label":"Nov","value":816},{"label":"Dez","value":910}];
const MX = 939;
