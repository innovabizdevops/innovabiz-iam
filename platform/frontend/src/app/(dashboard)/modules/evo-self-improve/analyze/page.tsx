...
const ACCENT = "#059669";
const MODULE = "EVO Self-Improvement Engine";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"4.065","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"917","t":"+12.2%","d":"up"},{"l":"Dados Processados (GB)","v":"1.951","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"670","t":"+3.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4594","2026-02-08","3.228","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4792","2026-03-14","6.351","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2383","2026-02-19","858","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","397","2026-02-18","3.394","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1356","2026-03-20","8.692","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":628},{"label":"Mar","value":734},{"label":"Abr","value":492},{"label":"Mai","value":760},{"label":"Jun","value":570},{"label":"Jul","value":450},{"label":"Ago","value":645},{"label":"Set","value":827},{"label":"Out","value":601},{"label":"Nov","value":510},{"label":"Dez","value":552}];
const MX = 827;
