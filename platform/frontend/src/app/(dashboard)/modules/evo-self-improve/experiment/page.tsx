...
const KPIS = [{"l":"Projetos Melhoria","v":"4.062","t":"+4.4%","d":"up"},{"l":"Savings (€)","v":"€32863","t":"+18.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.9%","t":"+6.9%","d":"up"},{"l":"Ciclos PDCA","v":"5.608","t":"+2.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.416","€ 26600.72","7.774","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.698","€ 36144.80","7.289","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.783","€ 15739.37","8.163","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.730","€ 4435.51","1.150","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.085","€ 41033.04","1.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":815},{"label":"Mar","value":638},{"label":"Abr","value":935},{"label":"Mai","value":761},{"label":"Jun","value":869},{"label":"Jul","value":739},{"label":"Ago","value":954},{"label":"Set","value":864},{"label":"Out","value":1018},{"label":"Nov","value":1017},{"label":"Dez","value":858}];
const MX = 1018;
