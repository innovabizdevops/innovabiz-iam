...
const PAGE = "Metric";
const KPIS = [{"l":"Projetos Melhoria","v":"1.475","t":"-5.0%","d":"down"},{"l":"Savings (€)","v":"€12154","t":"+14.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.1%","t":"-4.0%","d":"down"},{"l":"Ciclos PDCA","v":"8.597","t":"+4.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.465","€ 22367.31","7.242","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.117","€ 24746.90","8.404","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.641","€ 6791.82","5.236","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.267","€ 12562.21","3.147","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.309","€ 46888.78","4.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":501},{"label":"Mar","value":724},{"label":"Abr","value":507},{"label":"Mai","value":785},{"label":"Jun","value":665},{"label":"Jul","value":728},{"label":"Ago","value":512},{"label":"Set","value":462},{"label":"Out","value":499},{"label":"Nov","value":611},{"label":"Dez","value":521}];
const MX = 785;
