...
const ACCENT = "#6366f1";
const MODULE = "Smelting & Refining";
const PAGE = "Electrolysis";
const KPIS = [{"l":"Total Smelting Refine","v":"8.612","t":"-4.2%","d":"down"},{"l":"Electrolysis Ativos","v":"973","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"79.2%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"90","t":"-0.5%","d":"down"}];
const COLS = ["ID","Electrolysis","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smelting Refine #001","Smelting Refine #002","2.593","4.315","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Smelting Refine #002","Smelting Refine #003","4.636","2.119","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Smelting Refine #003","Smelting Refine #004","3.200","4.201","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Smelting Refine #004","Smelting Refine #005","225","7.595","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smelting Refine #005","Smelting Refine #001","7.434","4.627","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":1034},{"label":"Mar","value":1008},{"label":"Abr","value":897},{"label":"Mai","value":762},{"label":"Jun","value":694},{"label":"Jul","value":1033},{"label":"Ago","value":749},{"label":"Set","value":1027},{"label":"Out","value":742},{"label":"Nov","value":670},{"label":"Dez","value":776}];
const MX = 1034;
