...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.409","t":"-5.2%","d":"down"},{"l":"NC Abertas","v":"2.083","t":"+17.6%","d":"up"},{"l":"Conformidade (%)","v":"90.3%","t":"+1.9%","d":"up"},{"l":"CAPAs Pendentes","v":"3.713","t":"+7.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","259","88.7%","5.833","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","458","78.9%","5.027","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.976","73.4%","5.045","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.265","97.5%","519","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.277","79.2%","3.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":621},{"label":"Mar","value":400},{"label":"Abr","value":686},{"label":"Mai","value":504},{"label":"Jun","value":465},{"label":"Jul","value":489},{"label":"Ago","value":724},{"label":"Set","value":371},{"label":"Out","value":634},{"label":"Nov","value":513},{"label":"Dez","value":578}];
const MX = 724;
