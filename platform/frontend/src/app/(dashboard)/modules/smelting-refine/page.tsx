...
export default function SmeltingRefinePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Smelting Refine</h1><p className="text-sm text-muted-foreground">Smelting Refine • iBOS Enterprise</p></div>
