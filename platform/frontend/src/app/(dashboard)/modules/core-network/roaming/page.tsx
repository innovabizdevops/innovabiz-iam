...
const PAGE = "Roaming";
const KPIS = [{"l":"Total Core Network","v":"3.605","t":"-1.5%","d":"down"},{"l":"Roaming Ativos","v":"5.334","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"93.7%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"81","t":"+6.2%","d":"up"}];
const COLS = ["ID","Roaming","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Network #001","Core Network #002","1.440","5.360","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Core Network #002","Core Network #003","4.398","7.040","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Network #003","Core Network #004","1.550","5.279","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Core Network #004","Core Network #005","8.886","4.104","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Network #005","Core Network #001","2.402","3.278","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":630},{"label":"Mar","value":462},{"label":"Abr","value":610},{"label":"Mai","value":712},{"label":"Jun","value":593},{"label":"Jul","value":505},{"label":"Ago","value":756},{"label":"Set","value":607},{"label":"Out","value":558},{"label":"Nov","value":688},{"label":"Dez","value":622}];
const MX = 756;
