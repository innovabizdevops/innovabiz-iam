...
const PAGE = "Edge MEC";
const KPIS = [{"l":"Total Core Network","v":"2.632","t":"+16.2%","d":"up"},{"l":"Edge MEC Ativos","v":"677","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"86.7%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.7%","d":"up"}];
const COLS = ["ID","Edge MEC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Network #001","Core Network #002","5.363","2.564","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Core Network #002","Core Network #003","3.326","1.394","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Network #003","Core Network #004","3.376","2.677","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Core Network #004","Core Network #005","5.792","7.477","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Network #005","Core Network #001","2.788","5.952","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":510},{"label":"Mar","value":675},{"label":"Abr","value":548},{"label":"Mai","value":705},{"label":"Jun","value":586},{"label":"Jul","value":665},{"label":"Ago","value":684},{"label":"Set","value":745},{"label":"Out","value":682},{"label":"Nov","value":585},{"label":"Dez","value":607}];
const MX = 745;
...
export default function EdgeMecPage() {
    return (
