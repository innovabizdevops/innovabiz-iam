...
const PAGE = "Policy Control";
const KPIS = [{"l":"Total Core Network","v":"1.381","t":"+6.5%","d":"up"},{"l":"Policy Control Ativos","v":"1.460","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"76","t":"+10.4%","d":"up"}];
const COLS = ["ID","Policy Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Network #001","Core Network #002","3.922","2.534","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Core Network #002","Core Network #003","8.287","4.080","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Network #003","Core Network #004","1.911","214","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Core Network #004","Core Network #005","8.562","6.345","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Network #005","Core Network #001","1.061","1.032","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":769},{"label":"Mar","value":940},{"label":"Abr","value":911},{"label":"Mai","value":780},{"label":"Jun","value":610},{"label":"Jul","value":891},{"label":"Ago","value":930},{"label":"Set","value":894},{"label":"Out","value":772},{"label":"Nov","value":902},{"label":"Dez","value":596}];
const MX = 940;
