...
const ACCENT = "#6366f1";
const MODULE = "Core Network Ops";
const PAGE = "Network Slice AI";
const KPIS = [{"l":"Total Core Network","v":"8.511","t":"+15.2%","d":"up"},{"l":"Network Slice AI Ativos","v":"5.695","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+7.7%","d":"up"}];
const COLS = ["ID","Network Slice AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Network #001","Core Network #002","3.078","4.242","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Core Network #002","Core Network #003","1.197","217","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Network #003","Core Network #004","5.953","5.807","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Core Network #004","Core Network #005","334","7.580","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Network #005","Core Network #001","7.229","3.976","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":572},{"label":"Mar","value":638},{"label":"Abr","value":833},{"label":"Mai","value":775},{"label":"Jun","value":611},{"label":"Jul","value":694},{"label":"Ago","value":769},{"label":"Set","value":892},{"label":"Out","value":619},{"label":"Nov","value":698},{"label":"Dez","value":741}];
const MX = 892;
...
export default function SliceAiPage() {
    return (
