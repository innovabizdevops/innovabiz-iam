...
const PAGE = "Subscriber DB";
const KPIS = [{"l":"Total Core Network","v":"5.031","t":"+12.8%","d":"up"},{"l":"Subscriber DB Ativos","v":"7.090","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"72","t":"+17.0%","d":"up"}];
const COLS = ["ID","Subscriber DB","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Network #001","Core Network #002","1.829","8.043","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Core Network #002","Core Network #003","4.232","5.220","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Network #003","Core Network #004","3.378","207","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Core Network #004","Core Network #005","2.472","4.054","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Network #005","Core Network #001","7.655","4.329","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":270},{"label":"Fev","value":360},{"label":"Mar","value":495},{"label":"Abr","value":337},{"label":"Mai","value":443},{"label":"Jun","value":256},{"label":"Jul","value":440},{"label":"Ago","value":641},{"label":"Set","value":350},{"label":"Out","value":360},{"label":"Nov","value":619},{"label":"Dez","value":497}];
const MX = 641;
