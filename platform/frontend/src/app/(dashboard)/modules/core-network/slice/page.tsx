...
const PAGE = "Network Slice";
const KPIS = [{"l":"Total Core Network","v":"2.478","t":"+16.7%","d":"up"},{"l":"Network Slice Ativos","v":"4.769","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"84","t":"-1.2%","d":"down"}];
const COLS = ["ID","Network Slice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Network #001","Core Network #002","3.483","2.661","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Core Network #002","Core Network #003","9.047","2.850","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Network #003","Core Network #004","6.685","8.688","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Core Network #004","Core Network #005","142","167","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Network #005","Core Network #001","8.831","2.025","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":748},{"label":"Mar","value":619},{"label":"Abr","value":743},{"label":"Mai","value":681},{"label":"Jun","value":586},{"label":"Jul","value":517},{"label":"Ago","value":705},{"label":"Set","value":630},{"label":"Out","value":687},{"label":"Nov","value":438},{"label":"Dez","value":406}];
const MX = 748;
