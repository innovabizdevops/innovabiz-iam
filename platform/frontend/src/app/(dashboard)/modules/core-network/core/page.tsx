...
const PAGE = "EPC/5GC";
const KPIS = [{"l":"Total Core Network","v":"6.678","t":"-4.7%","d":"down"},{"l":"EPC/5GC Ativos","v":"5.322","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"80.0%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"85","t":"+15.3%","d":"up"}];
const COLS = ["ID","EPC/5GC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Core Network #001","Core Network #002","2.354","5.725","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Core Network #002","Core Network #003","1.624","8.970","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Core Network #003","Core Network #004","533","8.080","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Core Network #004","Core Network #005","2.147","2.775","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Core Network #005","Core Network #001","6.289","2.626","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":561},{"label":"Mar","value":630},{"label":"Abr","value":684},{"label":"Mai","value":719},{"label":"Jun","value":877},{"label":"Jul","value":607},{"label":"Ago","value":755},{"label":"Set","value":553},{"label":"Out","value":511},{"label":"Nov","value":864},{"label":"Dez","value":699}];
const MX = 877;
