...
/* ═══ AIX Intelligent Automation — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "8180", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "296", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€64K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1393591480", cells: ["AIX-5480", "AIX Intelligent Automation Item 1", "9/5/2026", "€41 580"], status: "active" as const },
    { id: "1393595051", cells: ["AIX-9051", "AIX Intelligent Automation Item 2", "24/12/2026", "€45 151"], status: "pending" as const },
    { id: "1393598622", cells: ["AIX-3622", "AIX Intelligent Automation Item 3", "11/7/2026", "€48 722"], status: "completed" as const },
    { id: "1393602193", cells: ["AIX-7193", "AIX Intelligent Automation Item 4", "26/2/2026", "€2293"], status: "warning" as const },
    { id: "1393605764", cells: ["AIX-1764", "AIX Intelligent Automation Item 5", "13/9/2026", "€5864"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 60 }, { label: "Fev", value: 69 }, { label: "Mar", value: 78 }, { label: "Abr", value: 87 }, { label: "Mai", value: 96 }, { label: "Jun", value: 25 }];
...
export default function AixIntelligentAutomationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AIX Intelligent Automation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AIX Intelligent Automation</p>
                    </div>
                </div>
