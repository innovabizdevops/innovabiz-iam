...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.951","t":"+5.7%","d":"up"},{"l":"Submissões/Dia","v":"387","t":"+10.1%","d":"up"},{"l":"Documentos Gerados","v":"7.574","t":"+6.8%","d":"up"},{"l":"Templates","v":"6.494","t":"-3.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.319","2026-01-17","7.248","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.584","2026-03-18","4.774","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.744","2026-02-18","3.866","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.162","2026-02-27","8.999","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.477","2026-02-16","3.592","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":473},{"label":"Mar","value":636},{"label":"Abr","value":625},{"label":"Mai","value":642},{"label":"Jun","value":689},{"label":"Jul","value":483},{"label":"Ago","value":496},{"label":"Set","value":504},{"label":"Out","value":754},{"label":"Nov","value":574},{"label":"Dez","value":551}];
const MX = 754;
