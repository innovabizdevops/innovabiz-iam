...
const ACCENT = "#4f46e5";
const MODULE = "AX Orchestration Engine";
const PAGE = "Task Router";
const KPIS = [{"l":"Total Ax Orchestrator","v":"3.954","t":"+10.3%","d":"up"},{"l":"Task Router Ativos","v":"265","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.4%","d":"up"}];
const COLS = ["ID","Task Router","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Orchestrator #001","Ax Orchestrator #002","4.941","8.022","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Orchestrator #002","Ax Orchestrator #003","3.317","7.930","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Orchestrator #003","Ax Orchestrator #004","4.460","7.065","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Orchestrator #004","Ax Orchestrator #005","6.954","176","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Orchestrator #005","Ax Orchestrator #001","3.578","7.081","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":626},{"label":"Mar","value":505},{"label":"Abr","value":473},{"label":"Mai","value":477},{"label":"Jun","value":360},{"label":"Jul","value":496},{"label":"Ago","value":587},{"label":"Set","value":486},{"label":"Out","value":476},{"label":"Nov","value":727},{"label":"Dez","value":470}];
const MX = 727;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>AI</span></h1>
                </div>
