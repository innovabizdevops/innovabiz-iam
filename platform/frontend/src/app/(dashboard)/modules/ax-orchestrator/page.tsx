...
/* ═══ AX Orchestration Engine — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "6101", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1612", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€123K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "864137401", cells: ["AX-3401", "AX Orchestration Engine Item 1", "2/2/2026", "€37 501"], status: "active" as const },
    { id: "864140972", cells: ["AX-6972", "AX Orchestration Engine Item 2", "17/9/2026", "€41 072"], status: "pending" as const },
    { id: "864144543", cells: ["AX-1543", "AX Orchestration Engine Item 3", "4/4/2026", "€44 643"], status: "completed" as const },
    { id: "864148114", cells: ["AX-5114", "AX Orchestration Engine Item 4", "19/11/2026", "€48 214"], status: "warning" as const },
    { id: "864151685", cells: ["AX-8685", "AX Orchestration Engine Item 5", "6/6/2026", "€1785"], status: "active" as const },
];
...
export default function AxOrchestrationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Orchestration Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Orchestration Engine</p>
                    </div>
                </div>
