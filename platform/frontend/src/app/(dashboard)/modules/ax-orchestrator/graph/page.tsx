...
const PAGE = "Agent Graph";
const KPIS = [{"l":"Total Ax Orchestrator","v":"5.317","t":"+14.2%","d":"up"},{"l":"Agent Graph Ativos","v":"700","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"58","t":"+5.0%","d":"up"}];
const COLS = ["ID","Agent Graph","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Orchestrator #001","Ax Orchestrator #002","7.508","6.295","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Orchestrator #002","Ax Orchestrator #003","8.024","8.188","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Orchestrator #003","Ax Orchestrator #004","7.806","5.810","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Orchestrator #004","Ax Orchestrator #005","5.473","733","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Orchestrator #005","Ax Orchestrator #001","3.052","2.339","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":1001},{"label":"Mar","value":912},{"label":"Abr","value":819},{"label":"Mai","value":1034},{"label":"Jun","value":718},{"label":"Jul","value":909},{"label":"Ago","value":952},{"label":"Set","value":1031},{"label":"Out","value":717},{"label":"Nov","value":765},{"label":"Dez","value":1045}];
const MX = 1045;
