...
const PAGE = "Escalate";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.244","t":"+14.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.1%","t":"+4.1%","d":"up"},{"l":"Tempo Médio (h)","v":"160h","t":"+16.8%","d":"up"},{"l":"Rejeitadas (%)","v":"66.4%","t":"+0.7%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","6.397","€ 43778.15","7.443","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.324","€ 47841.18","1.551","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","3.386","€ 33658.62","8.562","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.236","€ 38558.68","5.602","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.584","€ 14239.68","6.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":514},{"label":"Mar","value":490},{"label":"Abr","value":495},{"label":"Mai","value":738},{"label":"Jun","value":472},{"label":"Jul","value":492},{"label":"Ago","value":801},{"label":"Set","value":729},{"label":"Out","value":552},{"label":"Nov","value":702},{"label":"Dez","value":819}];
const MX = 819;
