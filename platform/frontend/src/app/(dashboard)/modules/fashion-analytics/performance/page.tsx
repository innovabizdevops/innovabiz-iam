...
const KPIS = [{"l":"Formulários Ativos","v":"5.295","t":"+3.0%","d":"up"},{"l":"Submissões/Dia","v":"3704","t":"+1.2%","d":"up"},{"l":"Documentos Gerados","v":"5.862","t":"-2.2%","d":"down"},{"l":"Templates","v":"4.285","t":"+16.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.381","2026-02-03","4.576","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.542","2026-03-20","4.494","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.365","2026-03-21","4.030","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.309","2026-01-01","2.465","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.581","2026-01-11","7.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":256},{"label":"Mar","value":280},{"label":"Abr","value":453},{"label":"Mai","value":355},{"label":"Jun","value":309},{"label":"Jul","value":462},{"label":"Ago","value":344},{"label":"Set","value":528},{"label":"Out","value":539},{"label":"Nov","value":586},{"label":"Dez","value":354}];
const MX = 586;
