...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€3497","t":"+8.9%","d":"up"},{"l":"Pipeline (€)","v":"€19161","t":"+11.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"71.4%","t":"+11.4%","d":"up"},{"l":"Win Rate (%)","v":"89.1%","t":"-4.1%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 11603.08","€ 34571.50","€ 37582.02","83.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 14116.53","€ 39059.85","€ 46998.83","99.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 18373.84","€ 17634.57","€ 5327.11","84.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 27262.89","€ 19020.14","€ 38600.76","90.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 9716.79","€ 12307.11","€ 44842.69","75.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":622},{"label":"Mar","value":344},{"label":"Abr","value":490},{"label":"Mai","value":443},{"label":"Jun","value":359},{"label":"Jul","value":453},{"label":"Ago","value":457},{"label":"Set","value":318},{"label":"Out","value":324},{"label":"Nov","value":365},{"label":"Dez","value":362}];
const MX = 622;
