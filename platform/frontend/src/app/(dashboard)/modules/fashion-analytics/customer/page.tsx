...
const ACCENT = "#be185d";
const MODULE = "Fashion Analytics Deep";
const PAGE = "Customer";
const KPIS = [{"l":"Dashboards Ativos","v":"2.539","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"1987","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.403","t":"+5.1%","d":"up"},{"l":"Utilizadores Analytics","v":"894","t":"+16.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1901","2026-03-09","1.968","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2107","2026-02-26","1.830","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","226","2026-03-03","1.906","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1004","2026-01-26","8.218","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3188","2026-01-07","5.746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":771},{"label":"Mar","value":535},{"label":"Abr","value":884},{"label":"Mai","value":837},{"label":"Jun","value":584},{"label":"Jul","value":575},{"label":"Ago","value":772},{"label":"Set","value":642},{"label":"Out","value":780},{"label":"Nov","value":890},{"label":"Dez","value":687}];
const MX = 890;
