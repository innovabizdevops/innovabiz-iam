...
/* ═══ Fashion Analytics Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "1460", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "379", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€383K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "119137960", cells: ["FAS-5960", "Fashion Analytics Deep Item 1", "5/5/2026", "€38 060"], status: "active" as const },
    { id: "119141531", cells: ["FAS-9531", "Fashion Analytics Deep Item 2", "20/12/2026", "€41 631"], status: "pending" as const },
    { id: "119145102", cells: ["FAS-4102", "Fashion Analytics Deep Item 3", "7/7/2026", "€45 202"], status: "completed" as const },
    { id: "119148673", cells: ["FAS-7673", "Fashion Analytics Deep Item 4", "22/2/2026", "€48 773"], status: "warning" as const },
    { id: "119152244", cells: ["FAS-2244", "Fashion Analytics Deep Item 5", "9/9/2026", "€2344"], status: "active" as const },
];
...
export default function FashionAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion Analytics Deep</p>
                    </div>
                </div>
