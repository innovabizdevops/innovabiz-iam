...
const KPIS = [{"l":"Dashboards Ativos","v":"1.158","t":"+2.9%","d":"up"},{"l":"Queries/Dia","v":"2188","t":"+7.2%","d":"up"},{"l":"Dados Processados (GB)","v":"215","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"6.582","t":"-1.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4568","2026-02-14","3.298","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2118","2026-02-06","1.790","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3952","2026-01-24","3.621","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1585","2026-02-26","3.462","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","364","2026-03-12","8.263","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":847},{"label":"Mar","value":802},{"label":"Abr","value":579},{"label":"Mai","value":756},{"label":"Jun","value":853},{"label":"Jul","value":852},{"label":"Ago","value":575},{"label":"Set","value":554},{"label":"Out","value":581},{"label":"Nov","value":490},{"label":"Dez","value":778}];
const MX = 853;
