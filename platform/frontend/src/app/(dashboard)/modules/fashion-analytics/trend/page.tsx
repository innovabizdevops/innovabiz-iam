...
const PAGE = "Trend";
const KPIS = [{"l":"Dashboards Ativos","v":"3.955","t":"+16.6%","d":"up"},{"l":"Queries/Dia","v":"2462","t":"-2.2%","d":"down"},{"l":"Dados Processados (GB)","v":"8.753","t":"+3.8%","d":"up"},{"l":"Utilizadores Analytics","v":"3.681","t":"+5.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4489","2026-03-09","5.598","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3979","2026-03-25","2.775","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1371","2026-01-13","8.722","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2615","2026-02-05","3.360","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1260","2026-03-28","3.156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":748},{"label":"Mar","value":793},{"label":"Abr","value":538},{"label":"Mai","value":637},{"label":"Jun","value":784},{"label":"Jul","value":487},{"label":"Ago","value":479},{"label":"Set","value":650},{"label":"Out","value":624},{"label":"Nov","value":507},{"label":"Dez","value":660}];
const MX = 793;
