...
const KPIS = [{"l":"Configurações","v":"2.010","t":"+16.5%","d":"up"},{"l":"Últimas Alterações","v":"1.615","t":"-0.2%","d":"down"},{"l":"Ambientes","v":"5.030","t":"+11.0%","d":"up"},{"l":"Versão Config","v":"6.855","t":"+9.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 37690.68","7.966","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 28695.96","8.089","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 14737.94","4.308","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 1808.70","6.275","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 18314.41","1.145","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":706},{"label":"Mar","value":1041},{"label":"Abr","value":784},{"label":"Mai","value":957},{"label":"Jun","value":1069},{"label":"Jul","value":871},{"label":"Ago","value":863},{"label":"Set","value":965},{"label":"Out","value":691},{"label":"Nov","value":683},{"label":"Dez","value":783}];
const MX = 1069;
