...
const PAGE = "Quote";
const KPIS = [{"l":"Configurações","v":"8.989","t":"+18.0%","d":"up"},{"l":"Últimas Alterações","v":"4.100","t":"+13.3%","d":"up"},{"l":"Ambientes","v":"1.635","t":"+5.6%","d":"up"},{"l":"Versão Config","v":"4.831","t":"+11.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 34256.83","3.682","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 2868.62","4.883","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 26640.81","4.741","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 8510.40","3.057","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 1818.95","7.327","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":567},{"label":"Mar","value":641},{"label":"Abr","value":691},{"label":"Mai","value":437},{"label":"Jun","value":697},{"label":"Jul","value":621},{"label":"Ago","value":716},{"label":"Set","value":437},{"label":"Out","value":647},{"label":"Nov","value":665},{"label":"Dez","value":734}];
const MX = 734;
