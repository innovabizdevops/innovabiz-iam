...
/* ═══ Configure-Price-Quote (CPQ) — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "9696", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4770", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€392K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "413245496", cells: ["CON-2496", "Configure-Price-Quote (CPQ) Item 1", "21/9/2026", "€45 596"], status: "active" as const },
    { id: "413249067", cells: ["CON-6067", "Configure-Price-Quote (CPQ) Item 2", "8/4/2026", "€49 167"], status: "pending" as const },
    { id: "413252638", cells: ["CON-9638", "Configure-Price-Quote (CPQ) Item 3", "23/11/2026", "€2738"], status: "completed" as const },
    { id: "413256209", cells: ["CON-4209", "Configure-Price-Quote (CPQ) Item 4", "10/6/2026", "€6309"], status: "warning" as const },
    { id: "413259780", cells: ["CON-7780", "Configure-Price-Quote (CPQ) Item 5", "25/1/2026", "€9880"], status: "active" as const },
];
...
export default function ConfigurepricequoteCpqPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Configure-Price-Quote (CPQ)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Configure-Price-Quote (CPQ)</p>
                    </div>
                </div>
