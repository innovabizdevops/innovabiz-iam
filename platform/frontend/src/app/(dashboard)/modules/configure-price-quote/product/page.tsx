...
const PAGE = "Product";
const KPIS = [{"l":"Configurações","v":"2.061","t":"+4.5%","d":"up"},{"l":"Últimas Alterações","v":"5.267","t":"+11.0%","d":"up"},{"l":"Ambientes","v":"3.296","t":"-1.1%","d":"down"},{"l":"Versão Config","v":"5.209","t":"+17.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 3413.25","3.591","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 970.89","2.336","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 43052.92","2.305","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 42228.16","5.605","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 42448.50","3.860","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":504},{"label":"Mar","value":399},{"label":"Abr","value":326},{"label":"Mai","value":232},{"label":"Jun","value":529},{"label":"Jul","value":471},{"label":"Ago","value":477},{"label":"Set","value":374},{"label":"Out","value":518},{"label":"Nov","value":529},{"label":"Dez","value":500}];
const MX = 529;
