...
const ACCENT = "#6366f1";
const MODULE = "Configure-Price-Quote (CPQ)";
const PAGE = "Approve";
const KPIS = [{"l":"Configurações","v":"3.626","t":"-5.5%","d":"down"},{"l":"Últimas Alterações","v":"4.758","t":"+11.2%","d":"up"},{"l":"Ambientes","v":"3.868","t":"+12.3%","d":"up"},{"l":"Versão Config","v":"5.415","t":"+14.3%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 47878.10","7.308","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 33781.91","4.407","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 46667.83","5.447","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 49982.39","3.746","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 17871.90","6.767","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":608},{"label":"Mar","value":588},{"label":"Abr","value":610},{"label":"Mai","value":602},{"label":"Jun","value":659},{"label":"Jul","value":594},{"label":"Ago","value":789},{"label":"Set","value":605},{"label":"Out","value":619},{"label":"Nov","value":672},{"label":"Dez","value":788}];
const MX = 789;
