...
const PAGE = "Price";
const KPIS = [{"l":"Configurações","v":"4.710","t":"+6.4%","d":"up"},{"l":"Últimas Alterações","v":"1.718","t":"-1.6%","d":"down"},{"l":"Ambientes","v":"301","t":"+15.7%","d":"up"},{"l":"Versão Config","v":"5.418","t":"+5.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 18963.78","1.895","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 8737.58","6.767","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 38381.74","6.647","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 40960.79","2.799","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 6737.49","2.946","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":235},{"label":"Fev","value":621},{"label":"Mar","value":475},{"label":"Abr","value":410},{"label":"Mai","value":592},{"label":"Jun","value":569},{"label":"Jul","value":425},{"label":"Ago","value":275},{"label":"Set","value":349},{"label":"Out","value":275},{"label":"Nov","value":576},{"label":"Dez","value":581}];
const MX = 621;
