...
const PAGE = "Concept";
const KPIS = [{"l":"Formulários Ativos","v":"1.413","t":"-5.9%","d":"down"},{"l":"Submissões/Dia","v":"1442","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"4.708","t":"+11.5%","d":"up"},{"l":"Templates","v":"8.857","t":"-2.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.941","2026-03-23","7.515","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.458","2026-03-15","1.254","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.077","2026-03-12","6.098","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.525","2026-03-01","3.758","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.066","2026-03-10","8.352","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":425},{"label":"Mar","value":770},{"label":"Abr","value":655},{"label":"Mai","value":417},{"label":"Jun","value":421},{"label":"Jul","value":773},{"label":"Ago","value":525},{"label":"Set","value":685},{"label":"Out","value":623},{"label":"Nov","value":440},{"label":"Dez","value":760}];
const MX = 773;
