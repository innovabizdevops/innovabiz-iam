...
/* ═══ Packaging Design Studio — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "6167", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1153", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€333K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "597777967", cells: ["PAC-7967", "Packaging Design Studio Item 1", "4/8/2026", "€28 067"], status: "active" as const },
    { id: "597781538", cells: ["PAC-2538", "Packaging Design Studio Item 2", "19/3/2026", "€31 638"], status: "pending" as const },
    { id: "597785109", cells: ["PAC-6109", "Packaging Design Studio Item 3", "6/10/2026", "€35 209"], status: "completed" as const },
    { id: "597788680", cells: ["PAC-9680", "Packaging Design Studio Item 4", "21/5/2026", "€38 780"], status: "warning" as const },
    { id: "597792251", cells: ["PAC-4251", "Packaging Design Studio Item 5", "8/12/2026", "€42 351"], status: "active" as const },
];
...
export default function PackagingDesignStudioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Packaging Design Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Packaging Design Studio</p>
                    </div>
                </div>
