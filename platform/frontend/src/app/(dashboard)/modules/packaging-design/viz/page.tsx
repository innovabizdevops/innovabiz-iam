...
const ACCENT = "#92400e";
const MODULE = "Packaging Design Studio";
const PAGE = "3D Viz";
const KPIS = [{"l":"Formulários Ativos","v":"3.599","t":"+5.3%","d":"up"},{"l":"Submissões/Dia","v":"3531","t":"+2.5%","d":"up"},{"l":"Documentos Gerados","v":"5.728","t":"+10.4%","d":"up"},{"l":"Templates","v":"951","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.035","2026-03-25","4.946","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.683","2026-01-03","4.019","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.413","2026-03-08","2.071","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.037","2026-02-15","333","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.542","2026-02-06","8.327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":415},{"label":"Mar","value":553},{"label":"Abr","value":548},{"label":"Mai","value":545},{"label":"Jun","value":537},{"label":"Jul","value":476},{"label":"Ago","value":559},{"label":"Set","value":570},{"label":"Out","value":520},{"label":"Nov","value":601},{"label":"Dez","value":371}];
const MX = 641;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#92400e'}}>3D</span></h1>
                </div>
