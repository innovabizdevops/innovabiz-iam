...
const KPIS = [{"l":"Formulários Ativos","v":"4.114","t":"+8.7%","d":"up"},{"l":"Submissões/Dia","v":"4503","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"3.233","t":"+6.9%","d":"up"},{"l":"Templates","v":"7.337","t":"+7.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.981","2026-03-19","5.770","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.823","2026-03-05","7.316","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.443","2026-03-09","4.699","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","250","2026-03-02","4.618","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.733","2026-01-28","1.937","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":825},{"label":"Mar","value":831},{"label":"Abr","value":661},{"label":"Mai","value":859},{"label":"Jun","value":680},{"label":"Jul","value":969},{"label":"Ago","value":770},{"label":"Set","value":932},{"label":"Out","value":984},{"label":"Nov","value":847},{"label":"Dez","value":707}];
const MX = 984;
