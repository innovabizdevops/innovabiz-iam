...
const PAGE = "Deliver";
const KPIS = [{"l":"Formulários Ativos","v":"7.098","t":"-3.4%","d":"down"},{"l":"Submissões/Dia","v":"3568","t":"+15.1%","d":"up"},{"l":"Documentos Gerados","v":"6.417","t":"-4.7%","d":"down"},{"l":"Templates","v":"1.130","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.542","2026-01-23","4.082","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.327","2026-02-04","4.767","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","565","2026-01-21","5.822","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.199","2026-02-11","1.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.995","2026-02-22","8.626","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":776},{"label":"Mar","value":943},{"label":"Abr","value":909},{"label":"Mai","value":875},{"label":"Jun","value":857},{"label":"Jul","value":858},{"label":"Ago","value":943},{"label":"Set","value":725},{"label":"Out","value":1091},{"label":"Nov","value":1025},{"label":"Dez","value":884}];
const MX = 1091;
