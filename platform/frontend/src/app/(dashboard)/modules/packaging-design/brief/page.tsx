...
const PAGE = "Brief";
const KPIS = [{"l":"Formulários Ativos","v":"3.442","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"199","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"474","t":"+3.6%","d":"up"},{"l":"Templates","v":"556","t":"+-0.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","736","2026-01-12","5.195","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.050","2026-02-22","226","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.852","2026-01-11","1.476","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.965","2026-02-01","7.943","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","886","2026-03-09","3.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":911},{"label":"Mar","value":880},{"label":"Abr","value":874},{"label":"Mai","value":1045},{"label":"Jun","value":756},{"label":"Jul","value":1006},{"label":"Ago","value":806},{"label":"Set","value":834},{"label":"Out","value":792},{"label":"Nov","value":872},{"label":"Dez","value":851}];
const MX = 1045;
