...
const KPIS = [{"l":"Tickets Abertos","v":"454","t":"+12.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.4%","t":"-3.7%","d":"down"},{"l":"MTTR (h)","v":"187h","t":"+16.1%","d":"up"},{"l":"Satisfação (%)","v":"88.2%","t":"-1.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.066","3.731","1.501","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.499","8.841","663","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.910","485","1.330","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.020","6.655","4.284","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.896","7.686","478","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":726},{"label":"Mar","value":720},{"label":"Abr","value":897},{"label":"Mai","value":990},{"label":"Jun","value":665},{"label":"Jul","value":878},{"label":"Ago","value":909},{"label":"Set","value":1006},{"label":"Out","value":662},{"label":"Nov","value":822},{"label":"Dez","value":712}];
const MX = 1006;
