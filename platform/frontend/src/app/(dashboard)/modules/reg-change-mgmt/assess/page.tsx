...
const PAGE = "Assess";
const KPIS = [{"l":"Tickets Abertos","v":"7.042","t":"+2.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.5%","t":"+15.9%","d":"up"},{"l":"MTTR (h)","v":"40h","t":"-2.1%","d":"down"},{"l":"Satisfação (%)","v":"85.0%","t":"-3.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.322","3.154","8.796","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.863","2.313","7.913","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.766","7.637","3.346","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.503","766","4.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.764","407","2.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":907},{"label":"Mar","value":740},{"label":"Abr","value":725},{"label":"Mai","value":723},{"label":"Jun","value":745},{"label":"Jul","value":908},{"label":"Ago","value":1035},{"label":"Set","value":640},{"label":"Out","value":815},{"label":"Nov","value":798},{"label":"Dez","value":906}];
const MX = 1035;
