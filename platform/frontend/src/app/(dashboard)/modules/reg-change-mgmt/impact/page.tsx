...
const PAGE = "Impact";
const KPIS = [{"l":"Tickets Abertos","v":"1.828","t":"-2.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"83.2%","t":"+2.1%","d":"up"},{"l":"MTTR (h)","v":"159h","t":"+11.9%","d":"up"},{"l":"Satisfação (%)","v":"66.0%","t":"+5.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.923","329","2.662","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.814","5.947","5.060","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.276","4.403","7.709","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","482","3.913","5.373","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.611","4.519","3.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":515},{"label":"Mar","value":520},{"label":"Abr","value":435},{"label":"Mai","value":497},{"label":"Jun","value":669},{"label":"Jul","value":296},{"label":"Ago","value":587},{"label":"Set","value":372},{"label":"Out","value":342},{"label":"Nov","value":556},{"label":"Dez","value":666}];
const MX = 669;
