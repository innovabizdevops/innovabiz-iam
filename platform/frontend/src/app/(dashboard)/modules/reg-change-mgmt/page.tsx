...
/* ═══ Regulatory Change Mgmt — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "6792", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4089", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€326K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1870770092", cells: ["REG-4092", "Regulatory Change Mgmt Item 1", "17/9/2026", "€20 192"], status: "active" as const },
    { id: "1870773663", cells: ["REG-7663", "Regulatory Change Mgmt Item 2", "4/4/2026", "€23 763"], status: "pending" as const },
    { id: "1870777234", cells: ["REG-2234", "Regulatory Change Mgmt Item 3", "19/11/2026", "€27 334"], status: "completed" as const },
    { id: "1870780805", cells: ["REG-5805", "Regulatory Change Mgmt Item 4", "6/6/2026", "€30 905"], status: "warning" as const },
    { id: "1870784376", cells: ["REG-9376", "Regulatory Change Mgmt Item 5", "21/1/2026", "€34 476"], status: "active" as const },
];
...
export default function RegulatoryChangeMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regulatory Change Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Regulatory Change Mgmt</p>
                    </div>
                </div>
