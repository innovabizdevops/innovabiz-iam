...
const PAGE = "Verify";
const KPIS = [{"l":"Tickets Abertos","v":"6.707","t":"+12.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"78.1%","t":"-2.4%","d":"down"},{"l":"MTTR (h)","v":"128h","t":"+7.5%","d":"up"},{"l":"Satisfação (%)","v":"87.1%","t":"+3.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.337","4.246","4.545","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.134","4.482","5.126","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","411","4.122","8.573","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.017","5.417","4.167","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.039","2.587","797","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":645},{"label":"Mar","value":356},{"label":"Abr","value":538},{"label":"Mai","value":543},{"label":"Jun","value":491},{"label":"Jul","value":614},{"label":"Ago","value":561},{"label":"Set","value":583},{"label":"Out","value":700},{"label":"Nov","value":714},{"label":"Dez","value":490}];
const MX = 714;
