...
const ACCENT = "#dc2626";
const MODULE = "Regulatory Change Mgmt";
const PAGE = "Horizon Scan";
const KPIS = [{"l":"Tickets Abertos","v":"6.977","t":"+4.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.8%","t":"-4.7%","d":"down"},{"l":"MTTR (h)","v":"177h","t":"-5.8%","d":"down"},{"l":"Satisfação (%)","v":"83.2%","t":"-5.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.744","294","2.063","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.485","8.430","7.531","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.763","8.530","1.375","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","883","3.741","5.983","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.502","7.758","3.687","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":715},{"label":"Mar","value":1060},{"label":"Abr","value":966},{"label":"Mai","value":983},{"label":"Jun","value":958},{"label":"Jul","value":701},{"label":"Ago","value":814},{"label":"Set","value":876},{"label":"Out","value":861},{"label":"Nov","value":1033},{"label":"Dez","value":861}];
const MX = 1060;
