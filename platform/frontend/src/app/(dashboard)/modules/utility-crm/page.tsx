...
export default function UtilityCrmPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Utility Crm</h1><p className="text-sm text-muted-foreground">Utility Crm • iBOS Enterprise</p></div>
