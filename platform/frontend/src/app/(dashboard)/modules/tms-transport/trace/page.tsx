...
const KPIS = [{"l":"Atletas Registados","v":"3.694","t":"+17.5%","d":"up"},{"l":"Treinos/Semana","v":"2850","t":"+8.7%","d":"up"},{"l":"Competições","v":"9.074","t":"+14.6%","d":"up"},{"l":"Performance Score","v":"70","t":"+8.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.379","3.370","1.783","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.791","7.512","3.271","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.380","9.034","6.385","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.706","5.366","1.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.711","4.551","3.368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":763},{"label":"Mar","value":721},{"label":"Abr","value":683},{"label":"Mai","value":711},{"label":"Jun","value":627},{"label":"Jul","value":671},{"label":"Ago","value":746},{"label":"Set","value":748},{"label":"Out","value":887},{"label":"Nov","value":872},{"label":"Dez","value":732}];
const MX = 887;
