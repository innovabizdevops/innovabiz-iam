...
const PAGE = "Freight Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.581","t":"+13.8%","d":"up"},{"l":"NC Abertas","v":"4.430","t":"+4.7%","d":"up"},{"l":"Conformidade (%)","v":"79.4%","t":"+9.9%","d":"up"},{"l":"CAPAs Pendentes","v":"7.834","t":"+7.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.325","72.9%","3.208","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.519","86.7%","6.908","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.566","85.9%","6.944","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.295","83.9%","7.325","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.323","97.2%","7.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":606},{"label":"Mar","value":837},{"label":"Abr","value":585},{"label":"Mai","value":552},{"label":"Jun","value":822},{"label":"Jul","value":845},{"label":"Ago","value":586},{"label":"Set","value":816},{"label":"Out","value":879},{"label":"Nov","value":686},{"label":"Dez","value":696}];
const MX = 879;
