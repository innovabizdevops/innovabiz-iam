...
const PAGE = "Consolidation AI";
const KPIS = [{"l":"Atletas Registados","v":"3.351","t":"+0.4%","d":"up"},{"l":"Treinos/Semana","v":"2473","t":"+3.8%","d":"up"},{"l":"Competições","v":"1.435","t":"+1.0%","d":"up"},{"l":"Performance Score","v":"66","t":"+0.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","346","2.278","1.561","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.104","7.993","3.996","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.040","7.660","7.504","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.198","5.995","3.272","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.884","4.908","421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":396},{"label":"Mar","value":320},{"label":"Abr","value":468},{"label":"Mai","value":391},{"label":"Jun","value":512},{"label":"Jul","value":605},{"label":"Ago","value":576},{"label":"Set","value":581},{"label":"Out","value":315},{"label":"Nov","value":482},{"label":"Dez","value":462}];
const MX = 605;
