...
const KPIS = [{"l":"Dashboards Ativos","v":"7.895","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"1621","t":"+9.7%","d":"up"},{"l":"Dados Processados (GB)","v":"4.086","t":"+14.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.710","t":"-5.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1759","2026-03-01","4.564","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3439","2026-01-05","2.094","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4057","2026-03-26","521","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","525","2026-02-14","745","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3119","2026-02-22","6.946","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1084},{"label":"Fev","value":769},{"label":"Mar","value":1002},{"label":"Abr","value":997},{"label":"Mai","value":797},{"label":"Jun","value":850},{"label":"Jul","value":1017},{"label":"Ago","value":827},{"label":"Set","value":768},{"label":"Out","value":1061},{"label":"Nov","value":938},{"label":"Dez","value":719}];
const MX = 1084;
