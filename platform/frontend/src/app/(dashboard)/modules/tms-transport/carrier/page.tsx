...
const PAGE = "Carrier Select";
const KPIS = [{"l":"ARR (€M)","v":"€45.8M","t":"+3.5%","d":"up"},{"l":"MRR (€)","v":"€79424","t":"-0.5%","d":"down"},{"l":"Churn (%)","v":"73.5%","t":"+12.5%","d":"up"},{"l":"ARPU (€)","v":"€19946","t":"-4.4%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30594.72","7.860","€ 33745.44","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48141.45","1.854","€ 18656.87","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 48064.24","8.329","€ 28839.48","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49293.22","5.605","€ 36477.98","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 20560.76","6.751","€ 26241.09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":719},{"label":"Mar","value":580},{"label":"Abr","value":779},{"label":"Mai","value":835},{"label":"Jun","value":631},{"label":"Jul","value":652},{"label":"Ago","value":797},{"label":"Set","value":819},{"label":"Out","value":645},{"label":"Nov","value":523},{"label":"Dez","value":550}];
const MX = 835;
