...
const ACCENT = "#1e40af";
const MODULE = "TMS Transport";
const PAGE = "Carbon Footprint";
const KPIS = [{"l":"Atletas Registados","v":"7.426","t":"+14.9%","d":"up"},{"l":"Treinos/Semana","v":"3752","t":"-5.5%","d":"down"},{"l":"Competições","v":"8.333","t":"+2.0%","d":"up"},{"l":"Performance Score","v":"91","t":"+14.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.494","2.710","5.908","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.602","1.968","5.298","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.418","4.998","7.687","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.899","3.449","8.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.349","6.929","5.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":294},{"label":"Mar","value":341},{"label":"Abr","value":524},{"label":"Mai","value":487},{"label":"Jun","value":325},{"label":"Jul","value":610},{"label":"Ago","value":307},{"label":"Set","value":358},{"label":"Out","value":433},{"label":"Nov","value":310},{"label":"Dez","value":279}];
const MX = 627;
