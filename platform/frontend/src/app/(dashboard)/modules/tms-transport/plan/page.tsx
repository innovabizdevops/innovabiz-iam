...
const PAGE = "Shipment Plan";
const KPIS = [{"l":"Atletas Registados","v":"4.231","t":"+5.5%","d":"up"},{"l":"Treinos/Semana","v":"3556","t":"+3.8%","d":"up"},{"l":"Competições","v":"7.908","t":"+15.3%","d":"up"},{"l":"Performance Score","v":"72","t":"+1.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.515","4.536","8.209","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","816","2.765","1.269","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.043","2.453","4.611","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.592","8.832","2.576","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.838","5.379","7.405","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1082},{"label":"Fev","value":788},{"label":"Mar","value":1052},{"label":"Abr","value":980},{"label":"Mai","value":1038},{"label":"Jun","value":1056},{"label":"Jul","value":707},{"label":"Ago","value":786},{"label":"Set","value":952},{"label":"Out","value":1050},{"label":"Nov","value":952},{"label":"Dez","value":693}];
const MX = 1082;
