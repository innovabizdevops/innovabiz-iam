...
const PAGE = "Stream";
const KPIS = [{"l":"Dashboards Ativos","v":"5.114","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"4897","t":"+4.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.390","t":"+16.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.192","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3856","2026-03-13","5.639","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3394","2026-03-16","528","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1680","2026-02-17","1.710","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4943","2026-02-28","8.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3203","2026-01-28","560","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":397},{"label":"Mar","value":453},{"label":"Abr","value":451},{"label":"Mai","value":318},{"label":"Jun","value":475},{"label":"Jul","value":636},{"label":"Ago","value":634},{"label":"Set","value":459},{"label":"Out","value":584},{"label":"Nov","value":653},{"label":"Dez","value":517}];
const MX = 653;
