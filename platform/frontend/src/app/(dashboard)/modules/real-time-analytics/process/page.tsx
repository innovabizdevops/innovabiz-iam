...
const PAGE = "Process";
const KPIS = [{"l":"Dashboards Ativos","v":"8.017","t":"+7.9%","d":"up"},{"l":"Queries/Dia","v":"2758","t":"+9.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.444","t":"+4.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.455","t":"-3.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1030","2026-02-15","2.737","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","730","2026-01-25","6.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1867","2026-03-28","5.405","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3894","2026-03-16","2.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","176","2026-03-10","7.442","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":535},{"label":"Mar","value":567},{"label":"Abr","value":644},{"label":"Mai","value":780},{"label":"Jun","value":622},{"label":"Jul","value":519},{"label":"Ago","value":681},{"label":"Set","value":639},{"label":"Out","value":800},{"label":"Nov","value":576},{"label":"Dez","value":643}];
const MX = 800;
