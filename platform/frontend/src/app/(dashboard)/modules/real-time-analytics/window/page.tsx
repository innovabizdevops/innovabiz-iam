...
const PAGE = "Window";
const KPIS = [{"l":"Dashboards Ativos","v":"1.428","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"1773","t":"-5.9%","d":"down"},{"l":"Dados Processados (GB)","v":"8.757","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"6.980","t":"+4.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","252","2026-03-24","6.731","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4677","2026-03-04","5.952","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1257","2026-02-08","6.841","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3116","2026-02-05","7.957","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","612","2026-01-18","2.479","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":522},{"label":"Mar","value":614},{"label":"Abr","value":360},{"label":"Mai","value":376},{"label":"Jun","value":452},{"label":"Jul","value":604},{"label":"Ago","value":341},{"label":"Set","value":682},{"label":"Out","value":589},{"label":"Nov","value":341},{"label":"Dez","value":426}];
const MX = 682;
