...
/* ═══ Real-Time Analytics Engine — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "5236", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4425", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€417K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2094756036", cells: ["REA-7036", "Real-Time Analytics Engine Item 1", "17/1/2026", "€6136"], status: "active" as const },
    { id: "2094759607", cells: ["REA-1607", "Real-Time Analytics Engine Item 2", "4/8/2026", "€9707"], status: "pending" as const },
    { id: "2094763178", cells: ["REA-5178", "Real-Time Analytics Engine Item 3", "19/3/2026", "€13 278"], status: "completed" as const },
    { id: "2094766749", cells: ["REA-8749", "Real-Time Analytics Engine Item 4", "6/10/2026", "€16 849"], status: "warning" as const },
    { id: "2094770320", cells: ["REA-3320", "Real-Time Analytics Engine Item 5", "21/5/2026", "€20 420"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 56 }, { label: "Fev", value: 65 }, { label: "Mar", value: 74 }, { label: "Abr", value: 83 }, { label: "Mai", value: 92 }, { label: "Jun", value: 21 }];
...
export default function RealtimeAnalyticsEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Real-Time Analytics Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Real-Time Analytics Engine</p>
                    </div>
                </div>
