...
const KPIS = [{"l":"Dashboards Ativos","v":"8.327","t":"+7.6%","d":"up"},{"l":"Queries/Dia","v":"432","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"1.352","t":"-1.0%","d":"down"},{"l":"Utilizadores Analytics","v":"415","t":"+11.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","752","2026-02-11","1.331","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1328","2026-02-26","3.937","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3819","2026-03-10","8.880","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","499","2026-03-23","6.040","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2898","2026-03-09","431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":854},{"label":"Mar","value":1022},{"label":"Abr","value":701},{"label":"Mai","value":797},{"label":"Jun","value":790},{"label":"Jul","value":970},{"label":"Ago","value":1009},{"label":"Set","value":769},{"label":"Out","value":746},{"label":"Nov","value":775},{"label":"Dez","value":753}];
const MX = 1022;
