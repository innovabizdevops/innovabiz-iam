...
const ACCENT = "#4338ca";
const MODULE = "Real-Time Analytics Engine";
const PAGE = "Alert";
const KPIS = [{"l":"Dashboards Ativos","v":"5.305","t":"+17.9%","d":"up"},{"l":"Queries/Dia","v":"3088","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"6.189","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"4.295","t":"-4.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1634","2026-03-28","8.862","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3105","2026-03-17","8.386","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4618","2026-01-06","6.806","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4631","2026-02-10","6.061","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1685","2026-01-19","4.996","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":958},{"label":"Mar","value":732},{"label":"Abr","value":783},{"label":"Mai","value":736},{"label":"Jun","value":897},{"label":"Jul","value":1017},{"label":"Ago","value":1007},{"label":"Set","value":843},{"label":"Out","value":861},{"label":"Nov","value":757},{"label":"Dez","value":940}];
const MX = 1017;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>RTM</span></h1>
                </div>
