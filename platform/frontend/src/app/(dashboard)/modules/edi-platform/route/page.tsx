...
const PAGE = "Route";
const KPIS = [{"l":"Formulários Ativos","v":"2.462","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"3184","t":"+8.7%","d":"up"},{"l":"Documentos Gerados","v":"5.581","t":"-3.9%","d":"down"},{"l":"Templates","v":"4.623","t":"+8.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.932","2026-01-24","6.647","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.884","2026-02-14","4.720","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.259","2026-02-07","1.040","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.064","2026-01-10","7.168","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.085","2026-03-07","3.732","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":830},{"label":"Mar","value":929},{"label":"Abr","value":727},{"label":"Mai","value":887},{"label":"Jun","value":810},{"label":"Jul","value":868},{"label":"Ago","value":706},{"label":"Set","value":740},{"label":"Out","value":819},{"label":"Nov","value":648},{"label":"Dez","value":910}];
const MX = 929;
