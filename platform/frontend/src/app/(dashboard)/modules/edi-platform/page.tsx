...
/* ═══ EDI Platform Deep — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "2683", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2969", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€351K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1013693283", cells: ["EDI-6283", "EDI Platform Deep Item 1", "16/4/2026", "€43 383"], status: "active" as const },
    { id: "1013696854", cells: ["EDI-9854", "EDI Platform Deep Item 2", "3/11/2026", "€46 954"], status: "pending" as const },
    { id: "1013700425", cells: ["EDI-4425", "EDI Platform Deep Item 3", "18/6/2026", "€525"], status: "completed" as const },
    { id: "1013703996", cells: ["EDI-7996", "EDI Platform Deep Item 4", "5/1/2026", "€4096"], status: "warning" as const },
    { id: "1013707567", cells: ["EDI-2567", "EDI Platform Deep Item 5", "20/8/2026", "€7667"], status: "active" as const },
];
...
export default function EdiPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDI Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDI Platform Deep</p>
                    </div>
                </div>
