...
const PAGE = "Validate";
const KPIS = [{"l":"Formulários Ativos","v":"133","t":"+1.1%","d":"up"},{"l":"Submissões/Dia","v":"3112","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"4.459","t":"+13.3%","d":"up"},{"l":"Templates","v":"7.736","t":"+15.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.618","2026-02-04","904","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.760","2026-01-13","4.288","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.990","2026-03-09","4.799","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.522","2026-01-16","6.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.952","2026-03-08","8.632","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":620},{"label":"Mar","value":779},{"label":"Abr","value":651},{"label":"Mai","value":485},{"label":"Jun","value":586},{"label":"Jul","value":644},{"label":"Ago","value":864},{"label":"Set","value":795},{"label":"Out","value":515},{"label":"Nov","value":541},{"label":"Dez","value":504}];
const MX = 864;
