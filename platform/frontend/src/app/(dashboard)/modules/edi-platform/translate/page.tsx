...
const KPIS = [{"l":"Tickets Abertos","v":"447","t":"+8.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"90.8%","t":"+14.6%","d":"up"},{"l":"MTTR (h)","v":"66h","t":"+2.8%","d":"up"},{"l":"Satisfação (%)","v":"92.1%","t":"-4.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.867","5.787","6.395","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.089","6.733","1.313","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.809","7.520","7.074","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.098","5.973","8.122","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.363","781","1.931","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":643},{"label":"Mar","value":554},{"label":"Abr","value":509},{"label":"Mai","value":539},{"label":"Jun","value":327},{"label":"Jul","value":659},{"label":"Ago","value":373},{"label":"Set","value":560},{"label":"Out","value":634},{"label":"Nov","value":327},{"label":"Dez","value":433}];
const MX = 659;
