...
const ACCENT = "#0d9488";
const MODULE = "EDI Platform Deep";
const PAGE = "Comply";
const KPIS = [{"l":"Formulários Ativos","v":"3.698","t":"-2.1%","d":"down"},{"l":"Submissões/Dia","v":"4855","t":"+3.2%","d":"up"},{"l":"Documentos Gerados","v":"4.571","t":"-3.5%","d":"down"},{"l":"Templates","v":"2.000","t":"-1.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.899","2026-02-07","7.029","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","866","2026-01-23","8.302","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.547","2026-03-12","4.974","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.714","2026-02-25","5.746","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","312","2026-01-24","5.461","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":683},{"label":"Mar","value":558},{"label":"Abr","value":601},{"label":"Mai","value":842},{"label":"Jun","value":718},{"label":"Jul","value":660},{"label":"Ago","value":707},{"label":"Set","value":952},{"label":"Out","value":760},{"label":"Nov","value":936},{"label":"Dez","value":634}];
const MX = 952;
