...
const PAGE = "Monitor";
const KPIS = [{"l":"Formulários Ativos","v":"1.419","t":"+9.5%","d":"up"},{"l":"Submissões/Dia","v":"138","t":"+9.0%","d":"up"},{"l":"Documentos Gerados","v":"2.426","t":"+16.9%","d":"up"},{"l":"Templates","v":"5.195","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.257","2026-02-19","5.203","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.031","2026-01-02","8.826","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.605","2026-03-01","4.694","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.441","2026-02-18","2.539","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.839","2026-02-07","8.312","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":517},{"label":"Mar","value":390},{"label":"Abr","value":618},{"label":"Mai","value":686},{"label":"Jun","value":726},{"label":"Jul","value":688},{"label":"Ago","value":744},{"label":"Set","value":366},{"label":"Out","value":507},{"label":"Nov","value":437},{"label":"Dez","value":518}];
const MX = 744;
