...
const ACCENT = "#155e75";
const MODULE = "Data Architecture (TOGAF)";
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.324","t":"-3.7%","d":"down"},{"l":"NC Abertas","v":"8.794","t":"+7.9%","d":"up"},{"l":"Conformidade (%)","v":"93.9%","t":"+4.9%","d":"up"},{"l":"CAPAs Pendentes","v":"4.146","t":"+7.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.950","89.9%","3.201","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.816","81.4%","3.672","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.346","80.5%","2.959","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.148","95.2%","3.552","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.573","89.8%","1.877","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":858},{"label":"Mar","value":886},{"label":"Abr","value":707},{"label":"Mai","value":916},{"label":"Jun","value":865},{"label":"Jul","value":666},{"label":"Ago","value":972},{"label":"Set","value":871},{"label":"Out","value":618},{"label":"Nov","value":692},{"label":"Dez","value":657}];
const MX = 972;
