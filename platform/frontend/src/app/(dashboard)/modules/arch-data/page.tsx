...
/* ═══ Data Architecture (TOGAF) — Dashboard ═══ */

const ACCENT = "#155e75";

const KPIS = [
    { label: "Total Registos", value: "1544", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4484", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€371K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1033947544", cells: ["ARC-1544", "Data Architecture (TOGAF) Item 1", "1/5/2026", "€47 644"], status: "active" as const },
    { id: "1033951115", cells: ["ARC-5115", "Data Architecture (TOGAF) Item 2", "16/12/2026", "€1215"], status: "pending" as const },
    { id: "1033954686", cells: ["ARC-8686", "Data Architecture (TOGAF) Item 3", "3/7/2026", "€4786"], status: "completed" as const },
    { id: "1033958257", cells: ["ARC-3257", "Data Architecture (TOGAF) Item 4", "18/2/2026", "€8357"], status: "warning" as const },
    { id: "1033961828", cells: ["ARC-6828", "Data Architecture (TOGAF) Item 5", "5/9/2026", "€11 928"], status: "active" as const },
];
...
export default function DataArchitectureTogafPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Architecture (TOGAF)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Architecture (TOGAF)</p>
                    </div>
                </div>
