...
const PAGE = "CompStat";
const KPIS = [{"l":"Dashboards Ativos","v":"3.208","t":"+8.0%","d":"up"},{"l":"Queries/Dia","v":"3106","t":"-4.2%","d":"down"},{"l":"Dados Processados (GB)","v":"6.897","t":"+7.5%","d":"up"},{"l":"Utilizadores Analytics","v":"6.157","t":"+12.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4334","2026-01-22","4.497","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4821","2026-02-15","9.014","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3318","2026-03-21","8.308","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","359","2026-01-03","8.786","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2728","2026-03-07","9.085","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":655},{"label":"Mar","value":397},{"label":"Abr","value":481},{"label":"Mai","value":710},{"label":"Jun","value":646},{"label":"Jul","value":727},{"label":"Ago","value":747},{"label":"Set","value":475},{"label":"Out","value":723},{"label":"Nov","value":584},{"label":"Dez","value":444}];
const MX = 747;
...
export default function CompstatPage() {
    return (
