...
const PAGE = "Hotspot";
const KPIS = [{"l":"Dashboards Ativos","v":"1.830","t":"+1.2%","d":"up"},{"l":"Queries/Dia","v":"1234","t":"-3.9%","d":"down"},{"l":"Dados Processados (GB)","v":"8.040","t":"-0.1%","d":"down"},{"l":"Utilizadores Analytics","v":"8.502","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1812","2026-02-16","855","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1331","2026-01-28","939","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1388","2026-01-17","5.689","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1522","2026-01-25","8.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","666","2026-03-10","2.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":759},{"label":"Mar","value":604},{"label":"Abr","value":580},{"label":"Mai","value":526},{"label":"Jun","value":785},{"label":"Jul","value":699},{"label":"Ago","value":510},{"label":"Set","value":702},{"label":"Out","value":577},{"label":"Nov","value":561},{"label":"Dez","value":613}];
const MX = 785;
