...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"8.709","t":"+14.8%","d":"up"},{"l":"Queries/Dia","v":"4308","t":"-2.8%","d":"down"},{"l":"Dados Processados (GB)","v":"6.889","t":"-0.6%","d":"down"},{"l":"Utilizadores Analytics","v":"6.620","t":"-0.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2014","2026-02-08","1.237","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2679","2026-02-02","4.410","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","842","2026-02-26","8.330","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2858","2026-03-01","3.270","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2101","2026-01-21","974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":1018},{"label":"Mar","value":841},{"label":"Abr","value":860},{"label":"Mai","value":960},{"label":"Jun","value":778},{"label":"Jul","value":963},{"label":"Ago","value":642},{"label":"Set","value":636},{"label":"Out","value":643},{"label":"Nov","value":840},{"label":"Dez","value":769}];
const MX = 1018;
