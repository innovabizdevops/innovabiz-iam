...
const ACCENT = "#6366f1";
const MODULE = "Crime Analysis";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"5.755","t":"-1.2%","d":"down"},{"l":"Queries/Dia","v":"3281","t":"+4.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.062","t":"+5.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.519","t":"+6.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","237","2026-01-22","362","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2900","2026-01-03","6.830","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2271","2026-03-08","6.753","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","553","2026-01-03","5.340","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1168","2026-03-17","825","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":615},{"label":"Mar","value":441},{"label":"Abr","value":298},{"label":"Mai","value":436},{"label":"Jun","value":289},{"label":"Jul","value":501},{"label":"Ago","value":506},{"label":"Set","value":275},{"label":"Out","value":367},{"label":"Nov","value":319},{"label":"Dez","value":250}];
const MX = 615;
