...
const PAGE = "Pattern";
const KPIS = [{"l":"Dashboards Ativos","v":"3.897","t":"+1.4%","d":"up"},{"l":"Queries/Dia","v":"3542","t":"+1.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.609","t":"-1.2%","d":"down"},{"l":"Utilizadores Analytics","v":"2.591","t":"+13.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2740","2026-03-06","7.313","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3578","2026-02-06","1.900","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2060","2026-03-08","8.736","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4745","2026-01-11","6.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","165","2026-01-24","1.938","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1003},{"label":"Fev","value":741},{"label":"Mar","value":745},{"label":"Abr","value":962},{"label":"Mai","value":873},{"label":"Jun","value":695},{"label":"Jul","value":824},{"label":"Ago","value":795},{"label":"Set","value":838},{"label":"Out","value":964},{"label":"Nov","value":893},{"label":"Dez","value":912}];
const MX = 1003;
