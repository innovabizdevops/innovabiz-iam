...
const ACCENT = "#0e7490";
const MODULE = "DC Cooling Systems";
const PAGE = "AI Optimize";
const KPIS = [{"l":"Total Dc Cooling","v":"2.312","t":"-3.0%","d":"down"},{"l":"AI Optimize Ativos","v":"3.023","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"62","t":"+4.9%","d":"up"}];
const COLS = ["ID","AI Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dc Cooling #001","Dc Cooling #002","7.057","2.676","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Dc Cooling #002","Dc Cooling #003","4.658","8.836","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Dc Cooling #003","Dc Cooling #004","112","6.974","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Dc Cooling #004","Dc Cooling #005","1.619","3.952","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dc Cooling #005","Dc Cooling #001","682","869","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":632},{"label":"Mar","value":690},{"label":"Abr","value":746},{"label":"Mai","value":822},{"label":"Jun","value":679},{"label":"Jul","value":741},{"label":"Ago","value":559},{"label":"Set","value":474},{"label":"Out","value":745},{"label":"Nov","value":545},{"label":"Dez","value":795}];
const MX = 822;
...
export default function AiCoolPage() {
    return (
