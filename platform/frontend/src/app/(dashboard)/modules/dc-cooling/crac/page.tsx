...
const PAGE = "CRAC/CRAH";
const KPIS = [{"l":"Total Dc Cooling","v":"8.800","t":"+5.8%","d":"up"},{"l":"CRAC/CRAH Ativos","v":"6.293","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"77.0%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"69","t":"-5.9%","d":"down"}];
const COLS = ["ID","CRAC/CRAH","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dc Cooling #001","Dc Cooling #002","4.364","2.195","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Dc Cooling #002","Dc Cooling #003","3.512","8.060","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Dc Cooling #003","Dc Cooling #004","8.336","805","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Dc Cooling #004","Dc Cooling #005","4.955","6.205","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dc Cooling #005","Dc Cooling #001","374","4.013","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":667},{"label":"Mar","value":728},{"label":"Abr","value":609},{"label":"Mai","value":642},{"label":"Jun","value":649},{"label":"Jul","value":697},{"label":"Ago","value":766},{"label":"Set","value":556},{"label":"Out","value":703},{"label":"Nov","value":907},{"label":"Dez","value":784}];
const MX = 907;
