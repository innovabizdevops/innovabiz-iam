...
export default function DcCoolingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Dc Cooling</h1><p className="text-sm text-muted-foreground">Dc Cooling • iBOS Enterprise</p></div>
