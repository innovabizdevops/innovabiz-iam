...
const KPIS = [{"l":"Total Dc Cooling","v":"8.455","t":"+8.1%","d":"up"},{"l":"Efficiency Ativos","v":"2.748","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"62","t":"+6.8%","d":"up"}];
const COLS = ["ID","Efficiency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dc Cooling #001","Dc Cooling #002","1.527","3.977","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Dc Cooling #002","Dc Cooling #003","3.367","8.461","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Dc Cooling #003","Dc Cooling #004","8.574","1.339","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Dc Cooling #004","Dc Cooling #005","4.668","2.150","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dc Cooling #005","Dc Cooling #001","859","7.112","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":512},{"label":"Mar","value":501},{"label":"Abr","value":708},{"label":"Mai","value":673},{"label":"Jun","value":618},{"label":"Jul","value":448},{"label":"Ago","value":618},{"label":"Set","value":539},{"label":"Out","value":788},{"label":"Nov","value":570},{"label":"Dez","value":541}];
const MX = 788;
