...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Agent SDK";
const PAGE = "Function Call";
const KPIS = [{"l":"Total Genai Agent Sdk","v":"8.960","t":"+7.6%","d":"up"},{"l":"Function Call Ativos","v":"880","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"56","t":"+1.4%","d":"up"}];
const COLS = ["ID","Function Call","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Agent Sdk #001","Genai Agent Sdk #002","8.623","8.475","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Agent Sdk #002","Genai Agent Sdk #003","8.876","2.723","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Agent Sdk #003","Genai Agent Sdk #004","8.912","9.049","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Agent Sdk #004","Genai Agent Sdk #005","1.748","2.583","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Agent Sdk #005","Genai Agent Sdk #001","913","5.132","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":453},{"label":"Mar","value":777},{"label":"Abr","value":679},{"label":"Mai","value":465},{"label":"Jun","value":454},{"label":"Jul","value":558},{"label":"Ago","value":797},{"label":"Set","value":524},{"label":"Out","value":477},{"label":"Nov","value":703},{"label":"Dez","value":700}];
const MX = 797;
