...
const PAGE = "Tool API";
const KPIS = [{"l":"Total Genai Agent Sdk","v":"7.552","t":"+0.4%","d":"up"},{"l":"Tool API Ativos","v":"605","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"64","t":"-5.5%","d":"down"}];
const COLS = ["ID","Tool API","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Agent Sdk #001","Genai Agent Sdk #002","8.803","7.352","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Agent Sdk #002","Genai Agent Sdk #003","5.315","7.908","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Agent Sdk #003","Genai Agent Sdk #004","8.977","2.867","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Agent Sdk #004","Genai Agent Sdk #005","1.743","5.277","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Agent Sdk #005","Genai Agent Sdk #001","2.670","2.244","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":399},{"label":"Mar","value":356},{"label":"Abr","value":586},{"label":"Mai","value":657},{"label":"Jun","value":719},{"label":"Jul","value":715},{"label":"Ago","value":503},{"label":"Set","value":622},{"label":"Out","value":721},{"label":"Nov","value":645},{"label":"Dez","value":498}];
const MX = 721;
