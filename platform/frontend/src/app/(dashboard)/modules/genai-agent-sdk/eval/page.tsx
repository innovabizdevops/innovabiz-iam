...
const PAGE = "Eval SDK";
const KPIS = [{"l":"Total Genai Agent Sdk","v":"7.354","t":"+11.6%","d":"up"},{"l":"Eval SDK Ativos","v":"2.203","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"60","t":"+7.0%","d":"up"}];
const COLS = ["ID","Eval SDK","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Agent Sdk #001","Genai Agent Sdk #002","8.444","2.509","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Agent Sdk #002","Genai Agent Sdk #003","8.461","2.930","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Agent Sdk #003","Genai Agent Sdk #004","6.453","2.560","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Agent Sdk #004","Genai Agent Sdk #005","2.776","5.674","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Agent Sdk #005","Genai Agent Sdk #001","7.326","8.595","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":761},{"label":"Mar","value":696},{"label":"Abr","value":483},{"label":"Mai","value":688},{"label":"Jun","value":734},{"label":"Jul","value":514},{"label":"Ago","value":546},{"label":"Set","value":482},{"label":"Out","value":794},{"label":"Nov","value":629},{"label":"Dez","value":498}];
const MX = 794;
