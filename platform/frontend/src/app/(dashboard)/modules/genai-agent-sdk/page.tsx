...
/* ═══ GenAI Agent SDK — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "1352", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2341", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€143K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "324008452", cells: ["GEN-9452", "GenAI Agent SDK Item 1", "13/5/2026", "€8552"], status: "active" as const },
    { id: "324012023", cells: ["GEN-4023", "GenAI Agent SDK Item 2", "28/12/2026", "€12 123"], status: "pending" as const },
    { id: "324015594", cells: ["GEN-7594", "GenAI Agent SDK Item 3", "15/7/2026", "€15 694"], status: "completed" as const },
    { id: "324019165", cells: ["GEN-2165", "GenAI Agent SDK Item 4", "2/2/2026", "€19 265"], status: "warning" as const },
    { id: "324022736", cells: ["GEN-5736", "GenAI Agent SDK Item 5", "17/9/2026", "€22 836"], status: "active" as const },
];
...
export default function GenaiAgentSdkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Agent SDK</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Agent SDK</p>
                    </div>
                </div>
