...
const ACCENT = "#1e40af";
const MODULE = "Open Banking";
const PAGE = "Variable Recurring";
const KPIS = [{"l":"Total Open Banking","v":"5.500","t":"-2.2%","d":"down"},{"l":"Variable Recurring Ativos","v":"123","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"70","t":"-5.1%","d":"down"}];
const COLS = ["ID","Variable Recurring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Open Banking #001","Open Banking #002","3.020","9.048","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Open Banking #002","Open Banking #003","4.914","5.700","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Open Banking #003","Open Banking #004","8.619","3.157","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Open Banking #004","Open Banking #005","1.227","4.748","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Open Banking #005","Open Banking #001","1.374","4.364","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":311},{"label":"Fev","value":261},{"label":"Mar","value":524},{"label":"Abr","value":359},{"label":"Mai","value":484},{"label":"Jun","value":408},{"label":"Jul","value":384},{"label":"Ago","value":313},{"label":"Set","value":447},{"label":"Out","value":442},{"label":"Nov","value":388},{"label":"Dez","value":545}];
const MX = 545;
