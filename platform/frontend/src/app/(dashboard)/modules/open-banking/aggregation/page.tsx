...
const PAGE = "Account Aggr";
const KPIS = [{"l":"Total Open Banking","v":"8.343","t":"-1.9%","d":"down"},{"l":"Account Aggr Ativos","v":"6.282","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"57","t":"-3.4%","d":"down"}];
const COLS = ["ID","Account Aggr","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Open Banking #001","Open Banking #002","851","5.407","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Open Banking #002","Open Banking #003","644","5.588","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Open Banking #003","Open Banking #004","3.622","5.397","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Open Banking #004","Open Banking #005","4.450","7.848","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Open Banking #005","Open Banking #001","1.719","4.794","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":868},{"label":"Mar","value":892},{"label":"Abr","value":987},{"label":"Mai","value":915},{"label":"Jun","value":1023},{"label":"Jul","value":688},{"label":"Ago","value":981},{"label":"Set","value":952},{"label":"Out","value":995},{"label":"Nov","value":1058},{"label":"Dez","value":864}];
const MX = 1058;
