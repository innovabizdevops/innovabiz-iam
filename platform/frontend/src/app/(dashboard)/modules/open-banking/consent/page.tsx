...
const KPIS = [{"l":"Total Open Banking","v":"7.375","t":"-1.1%","d":"down"},{"l":"Consent Mgmt Ativos","v":"1.363","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"88","t":"+12.6%","d":"up"}];
const COLS = ["ID","Consent Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Open Banking #001","Open Banking #002","2.572","1.326","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Open Banking #002","Open Banking #003","1.618","1.478","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Open Banking #003","Open Banking #004","3.439","565","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Open Banking #004","Open Banking #005","3.053","193","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Open Banking #005","Open Banking #001","1.375","282","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":753},{"label":"Mar","value":702},{"label":"Abr","value":752},{"label":"Mai","value":766},{"label":"Jun","value":878},{"label":"Jul","value":747},{"label":"Ago","value":790},{"label":"Set","value":950},{"label":"Out","value":938},{"label":"Nov","value":850},{"label":"Dez","value":704}];
const MX = 950;
