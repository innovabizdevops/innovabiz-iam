...
const PAGE = "CDN Deliver";
const KPIS = [{"l":"Formulários Ativos","v":"2.096","t":"+11.5%","d":"up"},{"l":"Submissões/Dia","v":"3079","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"8.426","t":"+11.4%","d":"up"},{"l":"Templates","v":"3.186","t":"-2.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.673","2026-02-27","769","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.438","2026-01-27","6.915","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.023","2026-02-06","1.302","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.605","2026-01-09","4.512","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.266","2026-03-26","7.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":499},{"label":"Mar","value":293},{"label":"Abr","value":321},{"label":"Mai","value":562},{"label":"Jun","value":572},{"label":"Jul","value":410},{"label":"Ago","value":544},{"label":"Set","value":365},{"label":"Out","value":276},{"label":"Nov","value":273},{"label":"Dez","value":289}];
const MX = 572;
