...
const PAGE = "Asset Upload";
const KPIS = [{"l":"Formulários Ativos","v":"7.185","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"4719","t":"-1.6%","d":"down"},{"l":"Documentos Gerados","v":"5.136","t":"-2.6%","d":"down"},{"l":"Templates","v":"7.380","t":"-0.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.029","2026-03-16","1.901","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.105","2026-02-13","4.640","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.624","2026-01-02","2.720","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","490","2026-03-22","2.146","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","167","2026-01-18","3.248","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":416},{"label":"Mar","value":646},{"label":"Abr","value":718},{"label":"Mai","value":736},{"label":"Jun","value":554},{"label":"Jul","value":667},{"label":"Ago","value":469},{"label":"Set","value":448},{"label":"Out","value":545},{"label":"Nov","value":749},{"label":"Dez","value":624}];
const MX = 749;
