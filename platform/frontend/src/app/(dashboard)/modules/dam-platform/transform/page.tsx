...
const KPIS = [{"l":"Formulários Ativos","v":"9.014","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"998","t":"+3.7%","d":"up"},{"l":"Documentos Gerados","v":"8.685","t":"+9.0%","d":"up"},{"l":"Templates","v":"7.018","t":"-4.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","374","2026-01-26","3.878","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.847","2026-02-21","3.016","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.979","2026-02-05","842","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","466","2026-01-19","1.740","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.073","2026-03-26","8.784","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":516},{"label":"Mar","value":657},{"label":"Abr","value":624},{"label":"Mai","value":427},{"label":"Jun","value":513},{"label":"Jul","value":471},{"label":"Ago","value":438},{"label":"Set","value":670},{"label":"Out","value":438},{"label":"Nov","value":466},{"label":"Dez","value":423}];
const MX = 670;
