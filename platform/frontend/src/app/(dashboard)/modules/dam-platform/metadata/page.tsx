...
const ACCENT = "#4338ca";
const MODULE = "DAM Platform";
const PAGE = "Metadata Tag";
const KPIS = [{"l":"Formulários Ativos","v":"4.636","t":"+9.5%","d":"up"},{"l":"Submissões/Dia","v":"2198","t":"+16.6%","d":"up"},{"l":"Documentos Gerados","v":"5.815","t":"-5.3%","d":"down"},{"l":"Templates","v":"3.505","t":"+9.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","877","2026-01-20","8.164","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.168","2026-01-08","1.408","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.277","2026-01-11","981","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","858","2026-03-28","7.949","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.833","2026-02-17","8.996","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":467},{"label":"Mar","value":712},{"label":"Abr","value":698},{"label":"Mai","value":612},{"label":"Jun","value":564},{"label":"Jul","value":755},{"label":"Ago","value":459},{"label":"Set","value":620},{"label":"Out","value":798},{"label":"Nov","value":679},{"label":"Dez","value":569}];
const MX = 798;
