...
const PAGE = "Usage Rights";
const KPIS = [{"l":"Formulários Ativos","v":"6.230","t":"+12.0%","d":"up"},{"l":"Submissões/Dia","v":"3893","t":"+12.1%","d":"up"},{"l":"Documentos Gerados","v":"8.398","t":"+16.0%","d":"up"},{"l":"Templates","v":"1.800","t":"-2.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.210","2026-03-17","8.244","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.937","2026-03-02","8.602","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.915","2026-03-01","5.643","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.842","2026-03-14","5.536","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.027","2026-03-03","7.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":578},{"label":"Mar","value":475},{"label":"Abr","value":625},{"label":"Mai","value":440},{"label":"Jun","value":688},{"label":"Jul","value":604},{"label":"Ago","value":484},{"label":"Set","value":685},{"label":"Out","value":322},{"label":"Nov","value":707},{"label":"Dez","value":503}];
const MX = 707;
