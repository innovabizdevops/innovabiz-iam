...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"231","t":"+12.7%","d":"up"},{"l":"Mitigações Ativas","v":"8.012","t":"+6.1%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+5.0%","d":"up"},{"l":"Incidentes YTD","v":"4.028","t":"+12.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","355","433","4.839","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.203","3.168","4.500","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.577","1.165","4.652","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.182","225","2.265","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.733","5.254","6.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":463},{"label":"Mar","value":459},{"label":"Abr","value":586},{"label":"Mai","value":680},{"label":"Jun","value":528},{"label":"Jul","value":636},{"label":"Ago","value":454},{"label":"Set","value":810},{"label":"Out","value":502},{"label":"Nov","value":675},{"label":"Dez","value":522}];
const MX = 810;
