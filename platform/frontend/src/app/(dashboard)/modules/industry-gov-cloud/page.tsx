...
/* ═══ Government Cloud — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "4502", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4650", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€451K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "191321902", cells: ["IND-9902", "Government Cloud Item 1", "3/11/2026", "€22 002"], status: "active" as const },
    { id: "191325473", cells: ["IND-4473", "Government Cloud Item 2", "18/6/2026", "€25 573"], status: "pending" as const },
    { id: "191329044", cells: ["IND-8044", "Government Cloud Item 3", "5/1/2026", "€29 144"], status: "completed" as const },
    { id: "191332615", cells: ["IND-2615", "Government Cloud Item 4", "20/8/2026", "€32 715"], status: "warning" as const },
    { id: "191336186", cells: ["IND-6186", "Government Cloud Item 5", "7/3/2026", "€36 286"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Government Cloud</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Government Cloud</p>
                    </div>
                </div>
