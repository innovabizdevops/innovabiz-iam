...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.859","t":"+3.0%","d":"up"},{"l":"NC Abertas","v":"4.050","t":"-5.5%","d":"down"},{"l":"Conformidade (%)","v":"67.0%","t":"+1.4%","d":"up"},{"l":"CAPAs Pendentes","v":"8.868","t":"+3.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.157","88.1%","3.687","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.962","94.4%","5.429","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.235","82.4%","5.391","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.323","87.3%","7.285","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.146","100.0%","4.304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":832},{"label":"Mar","value":822},{"label":"Abr","value":680},{"label":"Mai","value":805},{"label":"Jun","value":754},{"label":"Jul","value":590},{"label":"Ago","value":586},{"label":"Set","value":894},{"label":"Out","value":776},{"label":"Nov","value":798},{"label":"Dez","value":832}];
const MX = 894;
