...
const ACCENT = "#00a1e0";
const MODULE = "Government Cloud";
const PAGE = "Constituent";
const KPIS = [{"l":"Total Industry Gov Cloud","v":"4.739","t":"+17.4%","d":"up"},{"l":"Constituent Ativos","v":"3.607","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"93.5%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"71","t":"-0.7%","d":"down"}];
const COLS = ["ID","Constituent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Gov Cloud #001","Industry Gov Cloud #002","252","1.603","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Gov Cloud #002","Industry Gov Cloud #003","2.671","175","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Gov Cloud #003","Industry Gov Cloud #004","6.582","2.375","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Gov Cloud #004","Industry Gov Cloud #005","7.057","3.303","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Gov Cloud #005","Industry Gov Cloud #001","407","4.718","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":503},{"label":"Mar","value":469},{"label":"Abr","value":528},{"label":"Mai","value":404},{"label":"Jun","value":615},{"label":"Jul","value":689},{"label":"Ago","value":610},{"label":"Set","value":554},{"label":"Out","value":405},{"label":"Nov","value":486},{"label":"Dez","value":418}];
const MX = 689;
