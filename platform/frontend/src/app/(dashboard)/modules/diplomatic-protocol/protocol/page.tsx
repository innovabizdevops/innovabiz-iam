...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"2.750","t":"+9.3%","d":"up"},{"l":"Chamadas/Hora","v":"1908","t":"+15.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.6%","t":"+11.5%","d":"up"},{"l":"Latência Média (ms)","v":"51ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.021","3.035","81.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.708","252","94.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.724","481","86.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.641","4.601","71.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.605","5.416","91.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":473},{"label":"Mar","value":642},{"label":"Abr","value":624},{"label":"Mai","value":364},{"label":"Jun","value":313},{"label":"Jul","value":553},{"label":"Ago","value":588},{"label":"Set","value":317},{"label":"Out","value":465},{"label":"Nov","value":532},{"label":"Dez","value":606}];
const MX = 642;
