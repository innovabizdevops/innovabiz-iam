...
const PAGE = "Visit";
const KPIS = [{"l":"Integrações Ativas","v":"5.914","t":"+15.3%","d":"up"},{"l":"Chamadas/Hora","v":"1182","t":"+9.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.3%","t":"+17.0%","d":"up"},{"l":"Latência Média (ms)","v":"58ms","t":"+5.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.279","1.895","84.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.618","4.495","78.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.051","4.506","76.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.682","7.523","88.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.504","5.789","83.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":510},{"label":"Mar","value":562},{"label":"Abr","value":735},{"label":"Mai","value":492},{"label":"Jun","value":741},{"label":"Jul","value":666},{"label":"Ago","value":666},{"label":"Set","value":418},{"label":"Out","value":429},{"label":"Nov","value":526},{"label":"Dez","value":763}];
const MX = 763;
