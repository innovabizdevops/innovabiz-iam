...
const PAGE = "Ceremony";
const KPIS = [{"l":"Integrações Ativas","v":"2.046","t":"-1.4%","d":"down"},{"l":"Chamadas/Hora","v":"284","t":"+13.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.8%","t":"+14.4%","d":"up"},{"l":"Latência Média (ms)","v":"130ms","t":"-0.1%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.421","7.654","78.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.727","5.256","87.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.865","1.892","78.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.705","7.543","84.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.902","3.966","70.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":793},{"label":"Mar","value":1030},{"label":"Abr","value":784},{"label":"Mai","value":876},{"label":"Jun","value":688},{"label":"Jul","value":828},{"label":"Ago","value":1082},{"label":"Set","value":698},{"label":"Out","value":975},{"label":"Nov","value":1074},{"label":"Dez","value":922}];
const MX = 1082;
