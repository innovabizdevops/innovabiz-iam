...
const ACCENT = "#7c3aed";
const MODULE = "Diplomatic Protocol";
const PAGE = "Report";
const KPIS = [{"l":"Integrações Ativas","v":"2.109","t":"-0.6%","d":"down"},{"l":"Chamadas/Hora","v":"3934","t":"+16.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.1%","t":"-1.9%","d":"down"},{"l":"Latência Média (ms)","v":"116ms","t":"-4.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.815","5.881","74.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.838","8.000","87.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.073","430","90.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.294","5.002","91.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","9.083","7.570","89.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":940},{"label":"Mar","value":619},{"label":"Abr","value":860},{"label":"Mai","value":858},{"label":"Jun","value":616},{"label":"Jul","value":579},{"label":"Ago","value":599},{"label":"Set","value":566},{"label":"Out","value":627},{"label":"Nov","value":675},{"label":"Dez","value":575}];
const MX = 940;
