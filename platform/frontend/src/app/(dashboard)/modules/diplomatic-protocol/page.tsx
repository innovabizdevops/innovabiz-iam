...
/* ═══ Diplomatic Protocol — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "812", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3189", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€50K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1170042112", cells: ["DIP-7112", "Diplomatic Protocol Item 1", "9/5/2026", "€42 212"], status: "active" as const },
    { id: "1170045683", cells: ["DIP-1683", "Diplomatic Protocol Item 2", "24/12/2026", "€45 783"], status: "pending" as const },
    { id: "1170049254", cells: ["DIP-5254", "Diplomatic Protocol Item 3", "11/7/2026", "€49 354"], status: "completed" as const },
    { id: "1170052825", cells: ["DIP-8825", "Diplomatic Protocol Item 4", "26/2/2026", "€2925"], status: "warning" as const },
    { id: "1170056396", cells: ["DIP-3396", "Diplomatic Protocol Item 5", "13/9/2026", "€6496"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Diplomatic Protocol</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Diplomatic Protocol</p>
                    </div>
                </div>
