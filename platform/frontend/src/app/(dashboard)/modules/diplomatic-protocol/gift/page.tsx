...
const PAGE = "Gift";
const KPIS = [{"l":"Integrações Ativas","v":"3.554","t":"+9.9%","d":"up"},{"l":"Chamadas/Hora","v":"4123","t":"+2.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.4%","t":"-5.2%","d":"down"},{"l":"Latência Média (ms)","v":"95ms","t":"-4.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.148","5.336","91.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.481","4.013","98.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","566","5.046","81.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.422","2.639","93.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.181","327","92.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":811},{"label":"Mar","value":1074},{"label":"Abr","value":929},{"label":"Mai","value":797},{"label":"Jun","value":805},{"label":"Jul","value":756},{"label":"Ago","value":981},{"label":"Set","value":885},{"label":"Out","value":876},{"label":"Nov","value":784},{"label":"Dez","value":859}];
const MX = 1074;
