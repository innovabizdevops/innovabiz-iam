...
const PAGE = "Bind";
const KPIS = [{"l":"Total Underwriting Eng","v":"4.848","t":"+2.6%","d":"up"},{"l":"Bind Ativos","v":"7.035","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"75.4%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"73","t":"+9.4%","d":"up"}];
const COLS = ["ID","Bind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting Eng #001","Underwriting Eng #002","7.551","1.996","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting Eng #002","Underwriting Eng #003","5.320","4.658","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting Eng #003","Underwriting Eng #004","5.788","4.716","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting Eng #004","Underwriting Eng #005","7.406","8.654","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting Eng #005","Underwriting Eng #001","5.880","8.359","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":472},{"label":"Mar","value":550},{"label":"Abr","value":723},{"label":"Mai","value":782},{"label":"Jun","value":792},{"label":"Jul","value":695},{"label":"Ago","value":620},{"label":"Set","value":710},{"label":"Out","value":729},{"label":"Nov","value":741},{"label":"Dez","value":696}];
const MX = 792;
