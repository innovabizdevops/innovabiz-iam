...
const PAGE = "Quote";
const KPIS = [{"l":"Total Underwriting Eng","v":"3.351","t":"-4.1%","d":"down"},{"l":"Quote Ativos","v":"8.560","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+11.8%","d":"up"}];
const COLS = ["ID","Quote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting Eng #001","Underwriting Eng #002","449","7.684","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting Eng #002","Underwriting Eng #003","3.963","3.694","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting Eng #003","Underwriting Eng #004","2.324","3.339","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting Eng #004","Underwriting Eng #005","8.372","5.331","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting Eng #005","Underwriting Eng #001","1.285","7.869","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":803},{"label":"Mar","value":693},{"label":"Abr","value":890},{"label":"Mai","value":920},{"label":"Jun","value":896},{"label":"Jul","value":677},{"label":"Ago","value":728},{"label":"Set","value":962},{"label":"Out","value":1022},{"label":"Nov","value":950},{"label":"Dez","value":751}];
const MX = 1022;
