...
const PAGE = "Risk Score";
const KPIS = [{"l":"Riscos Identificados","v":"8.401","t":"+2.2%","d":"up"},{"l":"Mitigações Ativas","v":"6.623","t":"+3.7%","d":"up"},{"l":"Score Risco Geral","v":"59","t":"+10.6%","d":"up"},{"l":"Incidentes YTD","v":"7.773","t":"+2.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.700","6.074","7.968","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.737","5.936","3.788","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.642","2.623","6.352","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.287","5.138","3.603","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.676","5.555","4.604","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":228},{"label":"Mar","value":330},{"label":"Abr","value":421},{"label":"Mai","value":242},{"label":"Jun","value":494},{"label":"Jul","value":476},{"label":"Ago","value":357},{"label":"Set","value":532},{"label":"Out","value":216},{"label":"Nov","value":268},{"label":"Dez","value":463}];
const MX = 532;
