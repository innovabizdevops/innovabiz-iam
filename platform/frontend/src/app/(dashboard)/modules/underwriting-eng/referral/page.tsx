...
const PAGE = "Referral";
const KPIS = [{"l":"Total Underwriting Eng","v":"6.077","t":"+3.1%","d":"up"},{"l":"Referral Ativos","v":"5.232","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"78","t":"+13.8%","d":"up"}];
const COLS = ["ID","Referral","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting Eng #001","Underwriting Eng #002","6.158","7.156","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting Eng #002","Underwriting Eng #003","1.094","8.627","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting Eng #003","Underwriting Eng #004","6.016","7.047","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting Eng #004","Underwriting Eng #005","7.134","5.551","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting Eng #005","Underwriting Eng #001","2.683","2.530","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":685},{"label":"Mar","value":597},{"label":"Abr","value":778},{"label":"Mai","value":916},{"label":"Jun","value":716},{"label":"Jul","value":901},{"label":"Ago","value":813},{"label":"Set","value":904},{"label":"Out","value":823},{"label":"Nov","value":948},{"label":"Dez","value":810}];
const MX = 950;
