...
/* ═══ Laboratory Mgmt (LIMS) Deep — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "5919", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4015", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€364K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2100498719", cells: ["LAB-7719", "Laboratory Mgmt (LIMS) Deep Item 1", "12/12/2026", "€48 819"], status: "active" as const },
    { id: "2100502290", cells: ["LAB-2290", "Laboratory Mgmt (LIMS) Deep Item 2", "27/7/2026", "€2390"], status: "pending" as const },
    { id: "2100505861", cells: ["LAB-5861", "Laboratory Mgmt (LIMS) Deep Item 3", "14/2/2026", "€5961"], status: "completed" as const },
    { id: "2100509432", cells: ["LAB-9432", "Laboratory Mgmt (LIMS) Deep Item 4", "1/9/2026", "€9532"], status: "warning" as const },
    { id: "2100513003", cells: ["LAB-4003", "Laboratory Mgmt (LIMS) Deep Item 5", "16/4/2026", "€13 103"], status: "active" as const },
];
...
export default function LaboratoryMgmtLimsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laboratory Mgmt (LIMS) Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laboratory Mgmt (LIMS) Deep</p>
                    </div>
                </div>
