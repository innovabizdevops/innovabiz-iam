...
const ACCENT = "#9333ea";
const MODULE = "Laboratory Mgmt (LIMS) Deep";
const PAGE = "Comply";
const KPIS = [{"l":"Total Lab Mgmt Deep","v":"1.751","t":"-3.9%","d":"down"},{"l":"Comply Ativos","v":"3.306","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"91.7%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+4.4%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lab Mgmt Deep #001","Lab Mgmt Deep #002","3.307","8.061","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Lab Mgmt Deep #002","Lab Mgmt Deep #003","8.428","2.164","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Lab Mgmt Deep #003","Lab Mgmt Deep #004","2.188","762","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Lab Mgmt Deep #004","Lab Mgmt Deep #005","3.562","6.738","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lab Mgmt Deep #005","Lab Mgmt Deep #001","1.537","2.933","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":671},{"label":"Mar","value":632},{"label":"Abr","value":830},{"label":"Mai","value":850},{"label":"Jun","value":893},{"label":"Jul","value":619},{"label":"Ago","value":629},{"label":"Set","value":728},{"label":"Out","value":693},{"label":"Nov","value":833},{"label":"Dez","value":755}];
const MX = 893;
