...
const PAGE = "QC";
const KPIS = [{"l":"Total Lab Lis","v":"3.335","t":"+0.2%","d":"up"},{"l":"QC Ativos","v":"2.354","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+4.9%","d":"up"}];
const COLS = ["ID","QC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lab Lis #001","Lab Lis #002","8.267","7.636","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Lab Lis #002","Lab Lis #003","6.088","3.514","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Lab Lis #003","Lab Lis #004","1.532","995","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Lab Lis #004","Lab Lis #005","4.304","5.989","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lab Lis #005","Lab Lis #001","1.615","7.680","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":491},{"label":"Mar","value":667},{"label":"Abr","value":640},{"label":"Mai","value":410},{"label":"Jun","value":329},{"label":"Jul","value":596},{"label":"Ago","value":401},{"label":"Set","value":615},{"label":"Out","value":526},{"label":"Nov","value":655},{"label":"Dez","value":598}];
const MX = 667;
