...
const PAGE = "Microbiology";
const KPIS = [{"l":"Total Lab Lis","v":"6.468","t":"+16.7%","d":"up"},{"l":"Microbiology Ativos","v":"7.319","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+4.4%","d":"up"}];
const COLS = ["ID","Microbiology","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lab Lis #001","Lab Lis #002","4.574","1.995","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Lab Lis #002","Lab Lis #003","2.300","3.202","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Lab Lis #003","Lab Lis #004","446","4.932","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Lab Lis #004","Lab Lis #005","7.971","1.591","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lab Lis #005","Lab Lis #001","2.351","7.354","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":228},{"label":"Mar","value":440},{"label":"Abr","value":333},{"label":"Mai","value":458},{"label":"Jun","value":311},{"label":"Jul","value":514},{"label":"Ago","value":319},{"label":"Set","value":477},{"label":"Out","value":588},{"label":"Nov","value":301},{"label":"Dez","value":520}];
const MX = 588;
