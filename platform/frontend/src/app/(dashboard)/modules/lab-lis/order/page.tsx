...
const ACCENT = "#6366f1";
const MODULE = "Lab Information";
const PAGE = "Order Entry";
const KPIS = [{"l":"Total Lab Lis","v":"4.578","t":"+7.5%","d":"up"},{"l":"Order Entry Ativos","v":"3.249","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"84.7%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"66","t":"+15.6%","d":"up"}];
const COLS = ["ID","Order Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lab Lis #001","Lab Lis #002","7.803","3.002","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Lab Lis #002","Lab Lis #003","5.215","7.695","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Lab Lis #003","Lab Lis #004","6.864","3.862","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Lab Lis #004","Lab Lis #005","7.141","4.691","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lab Lis #005","Lab Lis #001","6.695","3.309","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":510},{"label":"Mar","value":680},{"label":"Abr","value":353},{"label":"Mai","value":420},{"label":"Jun","value":325},{"label":"Jul","value":578},{"label":"Ago","value":466},{"label":"Set","value":409},{"label":"Out","value":420},{"label":"Nov","value":442},{"label":"Dez","value":422}];
const MX = 680;
