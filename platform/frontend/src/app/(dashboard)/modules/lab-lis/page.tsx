...
export default function LabLisPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lab Lis</h1><p className="text-sm text-muted-foreground">Lab Lis • iBOS Enterprise</p></div>
