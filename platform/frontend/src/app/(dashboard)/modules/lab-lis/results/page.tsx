...
const PAGE = "Results";
const KPIS = [{"l":"Total Lab Lis","v":"3.563","t":"+9.0%","d":"up"},{"l":"Results Ativos","v":"6.243","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+6.1%","d":"up"}];
const COLS = ["ID","Results","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lab Lis #001","Lab Lis #002","8.761","4.306","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Lab Lis #002","Lab Lis #003","255","8.566","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Lab Lis #003","Lab Lis #004","6.346","1.595","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Lab Lis #004","Lab Lis #005","4.984","785","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lab Lis #005","Lab Lis #001","2.184","8.945","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":936},{"label":"Mar","value":818},{"label":"Abr","value":943},{"label":"Mai","value":775},{"label":"Jun","value":819},{"label":"Jul","value":872},{"label":"Ago","value":740},{"label":"Set","value":854},{"label":"Out","value":592},{"label":"Nov","value":880},{"label":"Dez","value":838}];
const MX = 943;
