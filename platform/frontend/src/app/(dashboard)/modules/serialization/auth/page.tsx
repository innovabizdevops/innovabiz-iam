...
const KPIS = [{"l":"Utilizadores Ativos","v":"6.822","t":"+3.0%","d":"up"},{"l":"Sessões/Dia","v":"4875","t":"+12.5%","d":"up"},{"l":"MFA Adoção (%)","v":"66.6%","t":"+10.3%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.027","t":"+8.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.920","7.648","6.591","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.486","2.881","6.409","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.786","2.481","933","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.249","3.259","2.776","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.176","8.080","7.919","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":719},{"label":"Mar","value":666},{"label":"Abr","value":878},{"label":"Mai","value":560},{"label":"Jun","value":625},{"label":"Jul","value":597},{"label":"Ago","value":682},{"label":"Set","value":560},{"label":"Out","value":742},{"label":"Nov","value":685},{"label":"Dez","value":677}];
const MX = 878;
