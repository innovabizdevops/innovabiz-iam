...
const PAGE = "Recall";
const KPIS = [{"l":"Total Serialization","v":"2.153","t":"+1.9%","d":"up"},{"l":"Recall Ativos","v":"7.162","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"78.2%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"81","t":"+1.7%","d":"up"}];
const COLS = ["ID","Recall","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serialization #001","Serialization #002","784","1.813","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Serialization #002","Serialization #003","8.701","7.924","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Serialization #003","Serialization #004","6.437","6.490","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Serialization #004","Serialization #005","3.367","5.172","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serialization #005","Serialization #001","5.799","2.198","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":773},{"label":"Mar","value":730},{"label":"Abr","value":878},{"label":"Mai","value":500},{"label":"Jun","value":776},{"label":"Jul","value":790},{"label":"Ago","value":854},{"label":"Set","value":546},{"label":"Out","value":602},{"label":"Nov","value":652},{"label":"Dez","value":858}];
const MX = 878;
