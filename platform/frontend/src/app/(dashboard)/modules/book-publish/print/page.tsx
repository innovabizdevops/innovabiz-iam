...
const PAGE = "Print";
const KPIS = [{"l":"Total Book Publish","v":"7.531","t":"+3.4%","d":"up"},{"l":"Print Ativos","v":"5.474","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"62","t":"-2.4%","d":"down"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Book Publish #001","Book Publish #002","5.349","5.671","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Book Publish #002","Book Publish #003","304","5.160","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Book Publish #003","Book Publish #004","4.200","7.676","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Book Publish #004","Book Publish #005","6.962","7.643","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Book Publish #005","Book Publish #001","4.747","7.167","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":650},{"label":"Mar","value":516},{"label":"Abr","value":612},{"label":"Mai","value":485},{"label":"Jun","value":546},{"label":"Jul","value":411},{"label":"Ago","value":403},{"label":"Set","value":485},{"label":"Out","value":466},{"label":"Nov","value":523},{"label":"Dez","value":452}];
const MX = 650;
