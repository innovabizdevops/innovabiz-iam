...
const KPIS = [{"l":"Total Book Publish","v":"5.262","t":"+17.1%","d":"up"},{"l":"Manuscript Ativos","v":"6.416","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"84.0%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"76","t":"+16.4%","d":"up"}];
const COLS = ["ID","Manuscript","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Book Publish #001","Book Publish #002","8.860","4.171","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Book Publish #002","Book Publish #003","113","3.249","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Book Publish #003","Book Publish #004","3.223","1.875","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Book Publish #004","Book Publish #005","8.768","4.189","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Book Publish #005","Book Publish #001","1.531","9.079","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":581},{"label":"Mar","value":877},{"label":"Abr","value":653},{"label":"Mai","value":799},{"label":"Jun","value":538},{"label":"Jul","value":548},{"label":"Ago","value":593},{"label":"Set","value":691},{"label":"Out","value":783},{"label":"Nov","value":877},{"label":"Dez","value":802}];
const MX = 877;
