...
const KPIS = [{"l":"Total Book Publish","v":"6.221","t":"+2.7%","d":"up"},{"l":"Distribute Ativos","v":"2.951","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"94","t":"+13.9%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Book Publish #001","Book Publish #002","2.782","1.175","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Book Publish #002","Book Publish #003","6.838","4.711","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Book Publish #003","Book Publish #004","353","1.396","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Book Publish #004","Book Publish #005","3.724","1.639","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Book Publish #005","Book Publish #001","6.220","5.122","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":412},{"label":"Mar","value":725},{"label":"Abr","value":743},{"label":"Mai","value":747},{"label":"Jun","value":487},{"label":"Jul","value":795},{"label":"Ago","value":761},{"label":"Set","value":495},{"label":"Out","value":497},{"label":"Nov","value":756},{"label":"Dez","value":715}];
const MX = 795;
