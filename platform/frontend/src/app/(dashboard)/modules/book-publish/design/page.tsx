...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.994","t":"+1.9%","d":"up"},{"l":"Submissões/Dia","v":"3512","t":"+5.2%","d":"up"},{"l":"Documentos Gerados","v":"6.957","t":"+5.7%","d":"up"},{"l":"Templates","v":"798","t":"+12.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.775","2026-02-14","4.455","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","781","2026-03-03","1.367","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.803","2026-01-08","4.547","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.054","2026-01-06","8.104","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.173","2026-01-10","3.974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":710},{"label":"Mar","value":586},{"label":"Abr","value":648},{"label":"Mai","value":690},{"label":"Jun","value":772},{"label":"Jul","value":800},{"label":"Ago","value":543},{"label":"Set","value":899},{"label":"Out","value":728},{"label":"Nov","value":807},{"label":"Dez","value":906}];
const MX = 906;
