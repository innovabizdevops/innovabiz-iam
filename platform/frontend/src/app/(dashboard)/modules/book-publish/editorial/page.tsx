...
const KPIS = [{"l":"Integrações Ativas","v":"5.898","t":"+7.0%","d":"up"},{"l":"Chamadas/Hora","v":"3085","t":"+6.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.9%","t":"+16.9%","d":"up"},{"l":"Latência Média (ms)","v":"181ms","t":"+2.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.163","2.239","87.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.399","8.859","100.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.396","813","72.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.041","2.096","76.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.458","7.874","78.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":893},{"label":"Mar","value":929},{"label":"Abr","value":609},{"label":"Mai","value":805},{"label":"Jun","value":894},{"label":"Jul","value":643},{"label":"Ago","value":719},{"label":"Set","value":717},{"label":"Out","value":631},{"label":"Nov","value":559},{"label":"Dez","value":598}];
const MX = 929;
