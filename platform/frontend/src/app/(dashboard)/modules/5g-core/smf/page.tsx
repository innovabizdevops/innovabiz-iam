...
const PAGE = "SMF";
const KPIS = [{"l":"Total 5g Core","v":"3.618","t":"-5.9%","d":"down"},{"l":"SMF Ativos","v":"1.932","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"90","t":"-4.2%","d":"down"}];
const COLS = ["ID","SMF","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["5g Core #001","5g Core #002","5.722","449","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["5g Core #002","5g Core #003","4.859","7.337","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["5g Core #003","5g Core #004","5.737","5.957","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["5g Core #004","5g Core #005","2.624","8.158","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["5g Core #005","5g Core #001","5.304","6.088","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":816},{"label":"Mar","value":999},{"label":"Abr","value":740},{"label":"Mai","value":661},{"label":"Jun","value":1023},{"label":"Jul","value":973},{"label":"Ago","value":662},{"label":"Set","value":871},{"label":"Out","value":1038},{"label":"Nov","value":951},{"label":"Dez","value":884}];
const MX = 1038;
...
export default function SmfPage() {
    return (
