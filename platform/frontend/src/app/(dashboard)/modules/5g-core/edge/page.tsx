...
const PAGE = "Edge";
const KPIS = [{"l":"Total 5g Core","v":"432","t":"-5.2%","d":"down"},{"l":"Edge Ativos","v":"8.879","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"77.7%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"61","t":"+9.1%","d":"up"}];
const COLS = ["ID","Edge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["5g Core #001","5g Core #002","8.343","8.538","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["5g Core #002","5g Core #003","8.359","2.737","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["5g Core #003","5g Core #004","4.275","1.814","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["5g Core #004","5g Core #005","3.885","5.988","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["5g Core #005","5g Core #001","523","1.985","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":470},{"label":"Mar","value":574},{"label":"Abr","value":790},{"label":"Mai","value":617},{"label":"Jun","value":720},{"label":"Jul","value":519},{"label":"Ago","value":843},{"label":"Set","value":838},{"label":"Out","value":657},{"label":"Nov","value":759},{"label":"Dez","value":675}];
const MX = 843;
