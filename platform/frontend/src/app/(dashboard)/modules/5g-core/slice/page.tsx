...
const ACCENT = "#c2410c";
const MODULE = "5G Core Network";
const PAGE = "Slice";
const KPIS = [{"l":"Total 5g Core","v":"2.980","t":"+17.1%","d":"up"},{"l":"Slice Ativos","v":"6.561","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"69","t":"+1.1%","d":"up"}];
const COLS = ["ID","Slice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["5g Core #001","5g Core #002","5.290","1.540","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["5g Core #002","5g Core #003","1.630","5.835","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["5g Core #003","5g Core #004","7.036","688","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["5g Core #004","5g Core #005","4.120","2.442","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["5g Core #005","5g Core #001","7.843","7.204","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":451},{"label":"Mar","value":468},{"label":"Abr","value":466},{"label":"Mai","value":336},{"label":"Jun","value":561},{"label":"Jul","value":357},{"label":"Ago","value":456},{"label":"Set","value":245},{"label":"Out","value":410},{"label":"Nov","value":540},{"label":"Dez","value":338}];
const MX = 561;
