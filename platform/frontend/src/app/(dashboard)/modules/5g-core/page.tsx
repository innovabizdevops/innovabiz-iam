...
export default function P5gCorePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">5g Core</h1><p className="text-sm text-muted-foreground">5g Core • iBOS Enterprise</p></div>
            </div>
