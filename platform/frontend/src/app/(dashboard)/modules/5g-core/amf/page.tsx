...
const PAGE = "AMF";
const KPIS = [{"l":"Total 5g Core","v":"1.093","t":"+5.8%","d":"up"},{"l":"AMF Ativos","v":"4.897","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"85.7%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"78","t":"+13.3%","d":"up"}];
const COLS = ["ID","AMF","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["5g Core #001","5g Core #002","102","5.140","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["5g Core #002","5g Core #003","3.278","474","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["5g Core #003","5g Core #004","8.912","1.685","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["5g Core #004","5g Core #005","6.401","7.261","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["5g Core #005","5g Core #001","1.918","8.649","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":653},{"label":"Mar","value":1003},{"label":"Abr","value":674},{"label":"Mai","value":956},{"label":"Jun","value":654},{"label":"Jul","value":854},{"label":"Ago","value":841},{"label":"Set","value":694},{"label":"Out","value":940},{"label":"Nov","value":652},{"label":"Dez","value":823}];
const MX = 1003;
