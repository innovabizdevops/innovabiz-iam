...
const PAGE = "UPF";
const KPIS = [{"l":"Total 5g Core","v":"766","t":"+1.8%","d":"up"},{"l":"UPF Ativos","v":"5.850","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"80","t":"+9.9%","d":"up"}];
const COLS = ["ID","UPF","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["5g Core #001","5g Core #002","4.935","2.739","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["5g Core #002","5g Core #003","2.861","595","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["5g Core #003","5g Core #004","7.350","4.269","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["5g Core #004","5g Core #005","3.157","4.070","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["5g Core #005","5g Core #001","9.055","2.196","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":932},{"label":"Mar","value":615},{"label":"Abr","value":883},{"label":"Mai","value":779},{"label":"Jun","value":869},{"label":"Jul","value":688},{"label":"Ago","value":692},{"label":"Set","value":907},{"label":"Out","value":932},{"label":"Nov","value":810},{"label":"Dez","value":587}];
const MX = 932;
