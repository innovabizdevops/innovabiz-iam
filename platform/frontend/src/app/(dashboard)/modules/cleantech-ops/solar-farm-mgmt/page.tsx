...
/* ═══ CleanTech Ops — Solar Farm Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4542", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "305", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "920", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1279000797", cells: ["CLE-2797", "Solar Farm Mgmt Item 1", "26/10/2026", "€897"], status: "active" as const },
    { id: "1279004368", cells: ["CLE-6368", "Solar Farm Mgmt Item 2", "13/5/2026", "€4468"], status: "pending" as const },
    { id: "1279007939", cells: ["CLE-9939", "Solar Farm Mgmt Item 3", "28/12/2026", "€8039"], status: "completed" as const },
    { id: "1279011510", cells: ["CLE-4510", "Solar Farm Mgmt Item 4", "15/7/2026", "€11 610"], status: "warning" as const },
    { id: "1279015081", cells: ["CLE-8081", "Solar Farm Mgmt Item 5", "2/2/2026", "€15 181"], status: "active" as const },
];
...
export default function CleantechOpsSolarFarmMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Solar Farm Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Solar Farm Mgmt</p>
                    </div>
                </div>
