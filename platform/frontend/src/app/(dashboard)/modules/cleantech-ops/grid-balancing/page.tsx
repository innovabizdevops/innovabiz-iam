...
/* ═══ CleanTech Ops — Grid Balancing ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "580", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "188", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "759", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "664147176", cells: ["CLE-2176", "Grid Balancing Item 1", "1/1/2026", "€47 276"], status: "active" as const },
    { id: "664150747", cells: ["CLE-5747", "Grid Balancing Item 2", "16/8/2026", "€847"], status: "pending" as const },
    { id: "664154318", cells: ["CLE-9318", "Grid Balancing Item 3", "3/3/2026", "€4418"], status: "completed" as const },
    { id: "664157889", cells: ["CLE-3889", "Grid Balancing Item 4", "18/10/2026", "€7989"], status: "warning" as const },
    { id: "664161460", cells: ["CLE-7460", "Grid Balancing Item 5", "5/5/2026", "€11 560"], status: "active" as const },
];
...
export default function CleantechOpsGridBalancingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grid Balancing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Grid Balancing</p>
                    </div>
                </div>
