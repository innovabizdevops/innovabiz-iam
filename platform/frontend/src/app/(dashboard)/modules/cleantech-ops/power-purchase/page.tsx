...
/* ═══ CleanTech Ops — Power Purchase ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4631", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "335", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1227", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "294521179", cells: ["CLE-6179", "Power Purchase Item 1", "16/8/2026", "€21 279"], status: "active" as const },
    { id: "294524750", cells: ["CLE-9750", "Power Purchase Item 2", "3/3/2026", "€24 850"], status: "pending" as const },
    { id: "294528321", cells: ["CLE-4321", "Power Purchase Item 3", "18/10/2026", "€28 421"], status: "completed" as const },
    { id: "294531892", cells: ["CLE-7892", "Power Purchase Item 4", "5/5/2026", "€31 992"], status: "warning" as const },
    { id: "294535463", cells: ["CLE-2463", "Power Purchase Item 5", "20/12/2026", "€35 563"], status: "active" as const },
];
...
export default function CleantechOpsPowerPurchasePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Power Purchase</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Power Purchase</p>
                    </div>
                </div>
