...
/* ═══ CleanTech Ops — Ev Fleet Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "374", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "301", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "423", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "76%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "984221049", cells: ["CLE-9049", "Ev Fleet Mgmt Item 1", "22/10/2026", "€21 149"], status: "active" as const },
    { id: "984224620", cells: ["CLE-3620", "Ev Fleet Mgmt Item 2", "9/5/2026", "€24 720"], status: "pending" as const },
    { id: "984228191", cells: ["CLE-7191", "Ev Fleet Mgmt Item 3", "24/12/2026", "€28 291"], status: "completed" as const },
    { id: "984231762", cells: ["CLE-1762", "Ev Fleet Mgmt Item 4", "11/7/2026", "€31 862"], status: "warning" as const },
    { id: "984235333", cells: ["CLE-5333", "Ev Fleet Mgmt Item 5", "26/2/2026", "€35 433"], status: "active" as const },
];
...
export default function CleantechOpsEvFleetMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ev Fleet Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Ev Fleet Mgmt</p>
                    </div>
                </div>
