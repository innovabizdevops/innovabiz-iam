...
/* ═══ CleanTech Ops — Smart Microgrid ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1680", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "42", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2115", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1655377238", cells: ["CLE-8238", "Smart Microgrid Item 1", "19/3/2026", "€27 338"], status: "active" as const },
    { id: "1655380809", cells: ["CLE-2809", "Smart Microgrid Item 2", "6/10/2026", "€30 909"], status: "pending" as const },
    { id: "1655384380", cells: ["CLE-6380", "Smart Microgrid Item 3", "21/5/2026", "€34 480"], status: "completed" as const },
    { id: "1655387951", cells: ["CLE-9951", "Smart Microgrid Item 4", "8/12/2026", "€38 051"], status: "warning" as const },
    { id: "1655391522", cells: ["CLE-4522", "Smart Microgrid Item 5", "23/7/2026", "€41 622"], status: "active" as const },
];
...
export default function CleantechOpsSmartMicrogridPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Microgrid</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Smart Microgrid</p>
                    </div>
                </div>
