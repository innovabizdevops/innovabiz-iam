...
/* ═══ CleanTech Ops — Battery Storage ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2486", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "213", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2882", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "365822049", cells: ["CLE-9049", "Battery Storage Item 1", "6/10/2026", "€22 149"], status: "active" as const },
    { id: "365825620", cells: ["CLE-3620", "Battery Storage Item 2", "21/5/2026", "€25 720"], status: "pending" as const },
    { id: "365829191", cells: ["CLE-7191", "Battery Storage Item 3", "8/12/2026", "€29 291"], status: "completed" as const },
    { id: "365832762", cells: ["CLE-1762", "Battery Storage Item 4", "23/7/2026", "€32 862"], status: "warning" as const },
    { id: "365836333", cells: ["CLE-5333", "Battery Storage Item 5", "10/2/2026", "€36 433"], status: "active" as const },
];
...
export default function CleantechOpsBatteryStoragePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Battery Storage</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Battery Storage</p>
                    </div>
                </div>
