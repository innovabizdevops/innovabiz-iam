...
/* ═══ CleanTech Ops — Renewable Forecast ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4465", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "369", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1278", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "74%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2123265277", cells: ["CLE-4277", "Renewable Forecast Item 1", "22/2/2026", "€15 377"], status: "active" as const },
    { id: "2123268848", cells: ["CLE-7848", "Renewable Forecast Item 2", "9/9/2026", "€18 948"], status: "pending" as const },
    { id: "2123272419", cells: ["CLE-2419", "Renewable Forecast Item 3", "24/4/2026", "€22 519"], status: "completed" as const },
    { id: "2123275990", cells: ["CLE-5990", "Renewable Forecast Item 4", "11/11/2026", "€26 090"], status: "warning" as const },
    { id: "2123279561", cells: ["CLE-9561", "Renewable Forecast Item 5", "26/6/2026", "€29 661"], status: "active" as const },
];
...
export default function CleantechOpsRenewableForecastPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Renewable Forecast</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Renewable Forecast</p>
                    </div>
                </div>
