...
/* ═══ CleanTech Ops — Wind Farm Mgmt ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2573", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "392", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1055", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "71%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1477720804", cells: ["CLE-2804", "Wind Farm Mgmt Item 1", "1/5/2026", "€20 904"], status: "active" as const },
    { id: "1477724375", cells: ["CLE-6375", "Wind Farm Mgmt Item 2", "16/12/2026", "€24 475"], status: "pending" as const },
    { id: "1477727946", cells: ["CLE-9946", "Wind Farm Mgmt Item 3", "3/7/2026", "€28 046"], status: "completed" as const },
    { id: "1477731517", cells: ["CLE-4517", "Wind Farm Mgmt Item 4", "18/2/2026", "€31 617"], status: "warning" as const },
    { id: "1477735088", cells: ["CLE-8088", "Wind Farm Mgmt Item 5", "5/9/2026", "€35 188"], status: "active" as const },
];
...
export default function CleantechOpsWindFarmMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wind Farm Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Wind Farm Mgmt</p>
                    </div>
                </div>
