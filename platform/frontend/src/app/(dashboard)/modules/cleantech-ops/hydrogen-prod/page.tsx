...
/* ═══ CleanTech Ops — Hydrogen Prod ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4722", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "274", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "435", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "687542094", cells: ["CLE-6094", "Hydrogen Prod Item 1", "23/7/2026", "€42 194"], status: "active" as const },
    { id: "687545665", cells: ["CLE-9665", "Hydrogen Prod Item 2", "10/2/2026", "€45 765"], status: "pending" as const },
    { id: "687549236", cells: ["CLE-4236", "Hydrogen Prod Item 3", "25/9/2026", "€49 336"], status: "completed" as const },
    { id: "687552807", cells: ["CLE-7807", "Hydrogen Prod Item 4", "12/4/2026", "€2907"], status: "warning" as const },
    { id: "687556378", cells: ["CLE-2378", "Hydrogen Prod Item 5", "27/11/2026", "€6478"], status: "active" as const },
];
...
export default function CleantechOpsHydrogenProdPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hydrogen Prod</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Hydrogen Prod</p>
                    </div>
                </div>
