...
/* ═══ CleanTech Ops — Energy Trade Platform ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2048", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "322", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "288", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "93%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1515710366", cells: ["CLE-3366", "Energy Trade Platform Item 1", "3/3/2026", "€10 466"], status: "active" as const },
    { id: "1515713937", cells: ["CLE-6937", "Energy Trade Platform Item 2", "18/10/2026", "€14 037"], status: "pending" as const },
    { id: "1515717508", cells: ["CLE-1508", "Energy Trade Platform Item 3", "5/5/2026", "€17 608"], status: "completed" as const },
    { id: "1515721079", cells: ["CLE-5079", "Energy Trade Platform Item 4", "20/12/2026", "€21 179"], status: "warning" as const },
    { id: "1515724650", cells: ["CLE-8650", "Energy Trade Platform Item 5", "7/7/2026", "€24 750"], status: "active" as const },
];
...
export default function CleantechOpsEnergyTradePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Trade Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">CleanTech Ops • Energy Trade Platform</p>
                    </div>
                </div>
