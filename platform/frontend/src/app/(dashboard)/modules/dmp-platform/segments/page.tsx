...
const ACCENT = "#7c3aed";
const MODULE = "DMP Platform";
const PAGE = "Segment Build";
const KPIS = [{"l":"Formulários Ativos","v":"6.911","t":"+2.4%","d":"up"},{"l":"Submissões/Dia","v":"4653","t":"+8.2%","d":"up"},{"l":"Documentos Gerados","v":"5.469","t":"+10.2%","d":"up"},{"l":"Templates","v":"2.796","t":"+8.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.611","2026-02-18","8.748","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.893","2026-01-23","5.011","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.154","2026-01-13","5.215","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","893","2026-01-03","5.787","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.314","2026-02-25","213","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":534},{"label":"Mar","value":462},{"label":"Abr","value":479},{"label":"Mai","value":365},{"label":"Jun","value":643},{"label":"Jul","value":475},{"label":"Ago","value":522},{"label":"Set","value":355},{"label":"Out","value":600},{"label":"Nov","value":402},{"label":"Dez","value":638}];
const MX = 666;
