...
const PAGE = "Lookalike";
const KPIS = [{"l":"Formulários Ativos","v":"611","t":"-5.1%","d":"down"},{"l":"Submissões/Dia","v":"2328","t":"+9.5%","d":"up"},{"l":"Documentos Gerados","v":"3.774","t":"+7.6%","d":"up"},{"l":"Templates","v":"5.057","t":"-1.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.137","2026-03-04","2.442","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.128","2026-02-07","978","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.135","2026-02-14","5.955","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.469","2026-01-09","545","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.220","2026-01-07","385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1031},{"label":"Fev","value":887},{"label":"Mar","value":734},{"label":"Abr","value":989},{"label":"Mai","value":1075},{"label":"Jun","value":759},{"label":"Jul","value":829},{"label":"Ago","value":1011},{"label":"Set","value":1078},{"label":"Out","value":732},{"label":"Nov","value":816},{"label":"Dez","value":704}];
const MX = 1078;
