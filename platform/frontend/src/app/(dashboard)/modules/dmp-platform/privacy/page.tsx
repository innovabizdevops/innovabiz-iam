...
const PAGE = "Privacy Comply";
const KPIS = [{"l":"Formulários Ativos","v":"5.005","t":"+4.2%","d":"up"},{"l":"Submissões/Dia","v":"4624","t":"+15.5%","d":"up"},{"l":"Documentos Gerados","v":"198","t":"+0.0%","d":"up"},{"l":"Templates","v":"8.488","t":"+14.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.168","2026-02-25","2.965","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.715","2026-03-11","3.171","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.347","2026-02-08","8.344","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.372","2026-02-27","8.606","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.853","2026-03-09","2.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":462},{"label":"Mar","value":674},{"label":"Abr","value":326},{"label":"Mai","value":519},{"label":"Jun","value":391},{"label":"Jul","value":689},{"label":"Ago","value":564},{"label":"Set","value":482},{"label":"Out","value":461},{"label":"Nov","value":688},{"label":"Dez","value":578}];
const MX = 689;
