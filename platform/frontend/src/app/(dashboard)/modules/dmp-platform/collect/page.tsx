...
const KPIS = [{"l":"Formulários Ativos","v":"529","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"200","t":"+1.2%","d":"up"},{"l":"Documentos Gerados","v":"6.525","t":"+4.3%","d":"up"},{"l":"Templates","v":"7.209","t":"+3.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.588","2026-01-28","5.445","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.092","2026-02-17","4.042","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.631","2026-01-06","5.260","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.609","2026-02-12","8.173","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","674","2026-03-02","6.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":324},{"label":"Mar","value":304},{"label":"Abr","value":338},{"label":"Mai","value":470},{"label":"Jun","value":524},{"label":"Jul","value":570},{"label":"Ago","value":607},{"label":"Set","value":515},{"label":"Out","value":456},{"label":"Nov","value":542},{"label":"Dez","value":421}];
const MX = 611;
