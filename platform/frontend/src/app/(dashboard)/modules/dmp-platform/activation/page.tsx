...
const KPIS = [{"l":"Formulários Ativos","v":"5.004","t":"+10.6%","d":"up"},{"l":"Submissões/Dia","v":"4850","t":"+17.8%","d":"up"},{"l":"Documentos Gerados","v":"6.078","t":"+8.2%","d":"up"},{"l":"Templates","v":"8.576","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.683","2026-01-23","7.762","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.475","2026-01-26","7.994","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.202","2026-03-05","4.316","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.197","2026-02-24","6.206","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.417","2026-01-12","6.635","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":756},{"label":"Mar","value":548},{"label":"Abr","value":902},{"label":"Mai","value":843},{"label":"Jun","value":637},{"label":"Jul","value":774},{"label":"Ago","value":704},{"label":"Set","value":849},{"label":"Out","value":718},{"label":"Nov","value":928},{"label":"Dez","value":654}];
const MX = 928;
