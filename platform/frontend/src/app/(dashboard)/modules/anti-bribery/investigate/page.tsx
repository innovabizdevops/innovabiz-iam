...
const ACCENT = "#dc2626";
const MODULE = "Anti-Bribery (ISO 37001)";
const PAGE = "Investigate";
const KPIS = [{"l":"Total Anti Bribery","v":"3.900","t":"-1.0%","d":"down"},{"l":"Investigate Ativos","v":"2.924","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"84","t":"+3.8%","d":"up"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Anti Bribery #001","Anti Bribery #002","2.525","1.228","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Anti Bribery #002","Anti Bribery #003","1.920","7.290","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Anti Bribery #003","Anti Bribery #004","8.243","7.263","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Anti Bribery #004","Anti Bribery #005","5.929","1.928","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Anti Bribery #005","Anti Bribery #001","5.189","383","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":669},{"label":"Mar","value":874},{"label":"Abr","value":746},{"label":"Mai","value":718},{"label":"Jun","value":760},{"label":"Jul","value":824},{"label":"Ago","value":607},{"label":"Set","value":902},{"label":"Out","value":711},{"label":"Nov","value":699},{"label":"Dez","value":916}];
const MX = 916;
