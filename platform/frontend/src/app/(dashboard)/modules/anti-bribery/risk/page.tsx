...
const KPIS = [{"l":"Riscos Identificados","v":"7.363","t":"+9.5%","d":"up"},{"l":"Mitigações Ativas","v":"7.887","t":"+4.3%","d":"up"},{"l":"Score Risco Geral","v":"76","t":"+15.4%","d":"up"},{"l":"Incidentes YTD","v":"1.533","t":"+9.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","236","8.490","5.271","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.811","7.388","3.430","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.887","1.197","5.347","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.654","4.435","175","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","600","5.750","7.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":445},{"label":"Mar","value":561},{"label":"Abr","value":430},{"label":"Mai","value":336},{"label":"Jun","value":576},{"label":"Jul","value":505},{"label":"Ago","value":580},{"label":"Set","value":401},{"label":"Out","value":382},{"label":"Nov","value":550},{"label":"Dez","value":558}];
const MX = 580;
