...
/* ═══ Anti-Bribery (ISO 37001) — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8229", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4661", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€385K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "152151329", cells: ["ANT-7329", "Anti-Bribery (ISO 37001) Item 1", "2/6/2026", "€1429"], status: "active" as const },
    { id: "152154900", cells: ["ANT-1900", "Anti-Bribery (ISO 37001) Item 2", "17/1/2026", "€5000"], status: "pending" as const },
    { id: "152158471", cells: ["ANT-5471", "Anti-Bribery (ISO 37001) Item 3", "4/8/2026", "€8571"], status: "completed" as const },
    { id: "152162042", cells: ["ANT-9042", "Anti-Bribery (ISO 37001) Item 4", "19/3/2026", "€12 142"], status: "warning" as const },
    { id: "152165613", cells: ["ANT-3613", "Anti-Bribery (ISO 37001) Item 5", "6/10/2026", "€15 713"], status: "active" as const },
];
...
export default function AntibriberyIso37001Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Anti-Bribery (ISO 37001)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Anti-Bribery (ISO 37001)</p>
                    </div>
                </div>
