...
const ACCENT = "#0e7490";
const MODULE = "Yacht Management";
const PAGE = "Fleet Register";
const KPIS = [{"l":"Total Yacht Mgmt","v":"183","t":"+2.1%","d":"up"},{"l":"Fleet Register Ativos","v":"6.111","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+3.9%","d":"up"}];
const COLS = ["ID","Fleet Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yacht Mgmt #001","Yacht Mgmt #002","6.234","7.449","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Yacht Mgmt #002","Yacht Mgmt #003","5.800","4.611","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Yacht Mgmt #003","Yacht Mgmt #004","7.057","6.717","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Yacht Mgmt #004","Yacht Mgmt #005","8.332","4.377","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yacht Mgmt #005","Yacht Mgmt #001","6.968","3.740","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":531},{"label":"Mar","value":732},{"label":"Abr","value":791},{"label":"Mai","value":818},{"label":"Jun","value":602},{"label":"Jul","value":535},{"label":"Ago","value":797},{"label":"Set","value":648},{"label":"Out","value":889},{"label":"Nov","value":889},{"label":"Dez","value":842}];
const MX = 889;
