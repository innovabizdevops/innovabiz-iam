...
const PAGE = "Charter Book";
const KPIS = [{"l":"Total Yacht Mgmt","v":"7.489","t":"-4.1%","d":"down"},{"l":"Charter Book Ativos","v":"7.025","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"59","t":"+16.9%","d":"up"}];
const COLS = ["ID","Charter Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yacht Mgmt #001","Yacht Mgmt #002","8.184","8.807","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Yacht Mgmt #002","Yacht Mgmt #003","1.955","3.011","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Yacht Mgmt #003","Yacht Mgmt #004","3.036","7.009","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Yacht Mgmt #004","Yacht Mgmt #005","4.600","1.873","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yacht Mgmt #005","Yacht Mgmt #001","2.868","3.895","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":867},{"label":"Mar","value":947},{"label":"Abr","value":668},{"label":"Mai","value":987},{"label":"Jun","value":1027},{"label":"Jul","value":838},{"label":"Ago","value":695},{"label":"Set","value":1034},{"label":"Out","value":806},{"label":"Nov","value":800},{"label":"Dez","value":820}];
const MX = 1034;
