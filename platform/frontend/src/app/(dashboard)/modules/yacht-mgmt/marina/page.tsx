...
const PAGE = "Marina";
const KPIS = [{"l":"Total Yacht Mgmt","v":"3.962","t":"+15.5%","d":"up"},{"l":"Marina Ativos","v":"838","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"79.9%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"82","t":"+4.0%","d":"up"}];
const COLS = ["ID","Marina","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yacht Mgmt #001","Yacht Mgmt #002","6.627","4.255","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Yacht Mgmt #002","Yacht Mgmt #003","4.272","2.747","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Yacht Mgmt #003","Yacht Mgmt #004","2.928","429","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Yacht Mgmt #004","Yacht Mgmt #005","5.704","4.910","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yacht Mgmt #005","Yacht Mgmt #001","2.942","4.500","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":501},{"label":"Mar","value":582},{"label":"Abr","value":721},{"label":"Mai","value":587},{"label":"Jun","value":550},{"label":"Jul","value":482},{"label":"Ago","value":638},{"label":"Set","value":530},{"label":"Out","value":614},{"label":"Nov","value":556},{"label":"Dez","value":537}];
const MX = 721;
