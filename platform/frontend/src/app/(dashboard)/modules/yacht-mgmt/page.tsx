...
export default function YachtMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Yacht Mgmt</h1><p className="text-sm text-muted-foreground">Yacht Mgmt • iBOS Enterprise</p></div>
