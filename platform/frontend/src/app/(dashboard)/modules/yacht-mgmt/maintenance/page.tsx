...
const KPIS = [{"l":"Total Yacht Mgmt","v":"8.698","t":"+11.8%","d":"up"},{"l":"Maintenance Ativos","v":"6.927","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"85.8%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"69","t":"-4.1%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yacht Mgmt #001","Yacht Mgmt #002","6.650","9.077","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Yacht Mgmt #002","Yacht Mgmt #003","2.517","1.002","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Yacht Mgmt #003","Yacht Mgmt #004","8.780","5.251","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Yacht Mgmt #004","Yacht Mgmt #005","4.984","2.609","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yacht Mgmt #005","Yacht Mgmt #001","4.798","6.998","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":726},{"label":"Mar","value":781},{"label":"Abr","value":538},{"label":"Mai","value":679},{"label":"Jun","value":620},{"label":"Jul","value":777},{"label":"Ago","value":864},{"label":"Set","value":877},{"label":"Out","value":589},{"label":"Nov","value":580},{"label":"Dez","value":686}];
const MX = 877;
