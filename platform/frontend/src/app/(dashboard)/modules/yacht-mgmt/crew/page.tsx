...
const PAGE = "Crew Mgmt";
const KPIS = [{"l":"Total Yacht Mgmt","v":"3.792","t":"+10.7%","d":"up"},{"l":"Crew Mgmt Ativos","v":"8.838","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"75.7%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"57","t":"+15.7%","d":"up"}];
const COLS = ["ID","Crew Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yacht Mgmt #001","Yacht Mgmt #002","4.531","6.680","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Yacht Mgmt #002","Yacht Mgmt #003","6.635","4.413","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Yacht Mgmt #003","Yacht Mgmt #004","1.664","1.672","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Yacht Mgmt #004","Yacht Mgmt #005","716","8.591","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yacht Mgmt #005","Yacht Mgmt #001","5.583","2.796","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":578},{"label":"Mar","value":570},{"label":"Abr","value":307},{"label":"Mai","value":346},{"label":"Jun","value":599},{"label":"Jul","value":583},{"label":"Ago","value":390},{"label":"Set","value":537},{"label":"Out","value":507},{"label":"Nov","value":407},{"label":"Dez","value":283}];
const MX = 599;
