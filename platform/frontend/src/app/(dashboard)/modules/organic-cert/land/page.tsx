...
const PAGE = "Land Records";
const KPIS = [{"l":"Total Organic Cert","v":"7.728","t":"+17.9%","d":"up"},{"l":"Land Records Ativos","v":"1.416","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"80","t":"+13.8%","d":"up"}];
const COLS = ["ID","Land Records","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Organic Cert #001","Organic Cert #002","3.192","6.481","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Organic Cert #002","Organic Cert #003","1.153","8.447","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Organic Cert #003","Organic Cert #004","1.789","6.056","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Organic Cert #004","Organic Cert #005","2.830","4.443","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Organic Cert #005","Organic Cert #001","5.966","5.657","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":784},{"label":"Mar","value":808},{"label":"Abr","value":541},{"label":"Mai","value":667},{"label":"Jun","value":829},{"label":"Jul","value":696},{"label":"Ago","value":577},{"label":"Set","value":804},{"label":"Out","value":702},{"label":"Nov","value":807},{"label":"Dez","value":693}];
const MX = 829;
