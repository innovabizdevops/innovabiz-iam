...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.158","t":"+6.5%","d":"up"},{"l":"NC Abertas","v":"8.155","t":"-5.1%","d":"down"},{"l":"Conformidade (%)","v":"76.3%","t":"+7.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.609","t":"+11.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.332","88.0%","3.519","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.150","91.7%","1.136","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.312","83.6%","1.861","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.248","97.9%","3.679","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","262","81.8%","4.046","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":256},{"label":"Fev","value":366},{"label":"Mar","value":244},{"label":"Abr","value":320},{"label":"Mai","value":500},{"label":"Jun","value":572},{"label":"Jul","value":501},{"label":"Ago","value":330},{"label":"Set","value":410},{"label":"Out","value":426},{"label":"Nov","value":336},{"label":"Dez","value":529}];
const MX = 572;
