...
export default function OrganicCertPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Organic Cert</h1><p className="text-sm text-muted-foreground">Organic Cert • iBOS Enterprise</p></div>
