...
const PAGE = "Cert Tracker";
const KPIS = [{"l":"Total Organic Cert","v":"3.858","t":"+5.9%","d":"up"},{"l":"Cert Tracker Ativos","v":"7.229","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"61","t":"+8.2%","d":"up"}];
const COLS = ["ID","Cert Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Organic Cert #001","Organic Cert #002","7.591","497","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Organic Cert #002","Organic Cert #003","8.730","2.056","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Organic Cert #003","Organic Cert #004","5.918","1.229","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Organic Cert #004","Organic Cert #005","8.228","8.155","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Organic Cert #005","Organic Cert #001","4.160","8.098","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":623},{"label":"Mar","value":884},{"label":"Abr","value":661},{"label":"Mai","value":926},{"label":"Jun","value":976},{"label":"Jul","value":954},{"label":"Ago","value":623},{"label":"Set","value":801},{"label":"Out","value":855},{"label":"Nov","value":916},{"label":"Dez","value":982}];
const MX = 982;
