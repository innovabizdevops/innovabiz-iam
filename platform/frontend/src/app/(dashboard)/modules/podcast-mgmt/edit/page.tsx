...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"6.027","t":"+3.8%","d":"up"},{"l":"Chamadas/Hora","v":"5017","t":"+15.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.2%","t":"+3.7%","d":"up"},{"l":"Latência Média (ms)","v":"156ms","t":"-0.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.008","7.667","98.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.833","2.230","77.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.399","8.236","89.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.894","5.619","74.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.067","8.491","70.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":631},{"label":"Mar","value":958},{"label":"Abr","value":658},{"label":"Mai","value":812},{"label":"Jun","value":655},{"label":"Jul","value":746},{"label":"Ago","value":698},{"label":"Set","value":977},{"label":"Out","value":808},{"label":"Nov","value":864},{"label":"Dez","value":974}];
const MX = 977;
