...
const ACCENT = "#6366f1";
const MODULE = "Podcast Mgmt";
const PAGE = "Ad Insert";
const KPIS = [{"l":"Total Podcast Mgmt","v":"4.062","t":"-0.2%","d":"down"},{"l":"Ad Insert Ativos","v":"7.033","t":"-4.0%","d":"down"},{"l":"Eficiência (%)","v":"91.1%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"80","t":"-2.8%","d":"down"}];
const COLS = ["ID","Ad Insert","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podcast Mgmt #001","Podcast Mgmt #002","186","8.202","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Podcast Mgmt #002","Podcast Mgmt #003","4.829","7.995","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Podcast Mgmt #003","Podcast Mgmt #004","2.803","3.728","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Podcast Mgmt #004","Podcast Mgmt #005","9.011","2.083","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podcast Mgmt #005","Podcast Mgmt #001","672","7.490","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":678},{"label":"Mar","value":667},{"label":"Abr","value":705},{"label":"Mai","value":755},{"label":"Jun","value":968},{"label":"Jul","value":821},{"label":"Ago","value":932},{"label":"Set","value":890},{"label":"Out","value":924},{"label":"Nov","value":1004},{"label":"Dez","value":785}];
const MX = 1004;
