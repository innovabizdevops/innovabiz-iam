...
const KPIS = [{"l":"Total Podcast Mgmt","v":"4.100","t":"+15.4%","d":"up"},{"l":"Distribute Ativos","v":"7.170","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"65.3%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+3.4%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podcast Mgmt #001","Podcast Mgmt #002","2.559","5.561","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Podcast Mgmt #002","Podcast Mgmt #003","6.949","1.431","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Podcast Mgmt #003","Podcast Mgmt #004","2.668","6.765","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Podcast Mgmt #004","Podcast Mgmt #005","4.236","4.135","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podcast Mgmt #005","Podcast Mgmt #001","4.633","4.706","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":653},{"label":"Mar","value":850},{"label":"Abr","value":646},{"label":"Mai","value":850},{"label":"Jun","value":853},{"label":"Jul","value":851},{"label":"Ago","value":905},{"label":"Set","value":906},{"label":"Out","value":696},{"label":"Nov","value":714},{"label":"Dez","value":903}];
const MX = 975;
