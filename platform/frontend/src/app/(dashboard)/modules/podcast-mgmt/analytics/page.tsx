...
const KPIS = [{"l":"Dashboards Ativos","v":"622","t":"+11.4%","d":"up"},{"l":"Queries/Dia","v":"1743","t":"+5.7%","d":"up"},{"l":"Dados Processados (GB)","v":"7.560","t":"+6.0%","d":"up"},{"l":"Utilizadores Analytics","v":"7.589","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3652","2026-02-12","1.499","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1204","2026-02-22","3.058","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4460","2026-01-12","6.643","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4418","2026-03-12","8.470","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4773","2026-01-24","7.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":662},{"label":"Mar","value":839},{"label":"Abr","value":631},{"label":"Mai","value":947},{"label":"Jun","value":827},{"label":"Jul","value":775},{"label":"Ago","value":600},{"label":"Set","value":838},{"label":"Out","value":730},{"label":"Nov","value":761},{"label":"Dez","value":743}];
const MX = 947;
