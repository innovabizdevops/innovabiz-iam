...
const PAGE = "Lesson";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.876","t":"+16.4%","d":"up"},{"l":"Sessões/Dia","v":"3659","t":"-1.9%","d":"down"},{"l":"MFA Adoção (%)","v":"82.4%","t":"+13.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.680","t":"+5.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.660","1.828","7.648","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.503","1.490","5.574","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.709","8.531","9.082","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.614","2.431","1.778","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.255","9.068","2.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":988},{"label":"Fev","value":896},{"label":"Mar","value":1055},{"label":"Abr","value":879},{"label":"Mai","value":1046},{"label":"Jun","value":969},{"label":"Jul","value":802},{"label":"Ago","value":967},{"label":"Set","value":899},{"label":"Out","value":930},{"label":"Nov","value":862},{"label":"Dez","value":947}];
const MX = 1055;
