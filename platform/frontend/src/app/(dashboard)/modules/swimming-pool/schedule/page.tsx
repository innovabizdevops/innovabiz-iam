...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Swimming Pool","v":"4.322","t":"+2.4%","d":"up"},{"l":"Schedule Ativos","v":"4.808","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+1.3%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Swimming Pool #001","Swimming Pool #002","5.337","2.438","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Swimming Pool #002","Swimming Pool #003","2.758","4.341","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Swimming Pool #003","Swimming Pool #004","907","5.925","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Swimming Pool #004","Swimming Pool #005","4.356","7.285","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Swimming Pool #005","Swimming Pool #001","5.872","7.568","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":446},{"label":"Mar","value":471},{"label":"Abr","value":450},{"label":"Mai","value":660},{"label":"Jun","value":541},{"label":"Jul","value":515},{"label":"Ago","value":615},{"label":"Set","value":707},{"label":"Out","value":662},{"label":"Nov","value":626},{"label":"Dez","value":394}];
const MX = 707;
