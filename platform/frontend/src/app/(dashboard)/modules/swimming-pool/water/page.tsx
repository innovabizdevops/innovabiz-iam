...
const ACCENT = "#16a34a";
const MODULE = "Swimming Pool Mgmt";
const PAGE = "Water Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.707","t":"+5.7%","d":"up"},{"l":"NC Abertas","v":"7.859","t":"+7.8%","d":"up"},{"l":"Conformidade (%)","v":"74.5%","t":"+2.0%","d":"up"},{"l":"CAPAs Pendentes","v":"8.169","t":"+10.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.570","97.7%","1.527","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.273","83.9%","1.752","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.447","86.9%","559","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.595","90.0%","9.013","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.991","93.2%","6.532","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":713},{"label":"Mar","value":662},{"label":"Abr","value":583},{"label":"Mai","value":453},{"label":"Jun","value":750},{"label":"Jul","value":551},{"label":"Ago","value":803},{"label":"Set","value":794},{"label":"Out","value":534},{"label":"Nov","value":718},{"label":"Dez","value":817}];
const MX = 817;
