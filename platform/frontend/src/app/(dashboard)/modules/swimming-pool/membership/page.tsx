...
const KPIS = [{"l":"Total Swimming Pool","v":"6.902","t":"-5.5%","d":"down"},{"l":"Membership Ativos","v":"4.107","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"65.9%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"56","t":"-1.7%","d":"down"}];
const COLS = ["ID","Membership","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Swimming Pool #001","Swimming Pool #002","3.575","7.725","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Swimming Pool #002","Swimming Pool #003","5.820","8.097","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Swimming Pool #003","Swimming Pool #004","8.136","5.018","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Swimming Pool #004","Swimming Pool #005","5.170","2.165","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Swimming Pool #005","Swimming Pool #001","6.723","453","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":666},{"label":"Mar","value":737},{"label":"Abr","value":878},{"label":"Mai","value":876},{"label":"Jun","value":715},{"label":"Jul","value":925},{"label":"Ago","value":764},{"label":"Set","value":536},{"label":"Out","value":567},{"label":"Nov","value":641},{"label":"Dez","value":723}];
const MX = 925;
