...
const PAGE = "Custody";
const KPIS = [{"l":"Riscos Identificados","v":"1.250","t":"+1.9%","d":"up"},{"l":"Mitigações Ativas","v":"5.099","t":"+6.8%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"+10.2%","d":"up"},{"l":"Incidentes YTD","v":"152","t":"+2.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.262","602","6.471","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.369","7.817","6.596","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.117","8.468","3.548","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.019","8.366","6.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.979","425","5.910","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":693},{"label":"Mar","value":385},{"label":"Abr","value":668},{"label":"Mai","value":607},{"label":"Jun","value":625},{"label":"Jul","value":637},{"label":"Ago","value":335},{"label":"Set","value":696},{"label":"Out","value":442},{"label":"Nov","value":407},{"label":"Dez","value":409}];
const MX = 696;
