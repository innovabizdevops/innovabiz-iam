...
export default function OilTerminalPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Oil Terminal</h1><p className="text-sm text-muted-foreground">Oil Terminal • iBOS Enterprise</p></div>
