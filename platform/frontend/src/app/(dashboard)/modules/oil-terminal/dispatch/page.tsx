...
const PAGE = "Dispatch";
const KPIS = [{"l":"Riscos Identificados","v":"5.310","t":"-2.9%","d":"down"},{"l":"Mitigações Ativas","v":"338","t":"-4.7%","d":"down"},{"l":"Score Risco Geral","v":"66","t":"-5.8%","d":"down"},{"l":"Incidentes YTD","v":"3.416","t":"+4.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.659","3.239","310","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","279","438","756","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.574","6.331","4.855","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","719","2.244","7.912","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","693","7.722","4.720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":1058},{"label":"Mar","value":821},{"label":"Abr","value":1056},{"label":"Mai","value":911},{"label":"Jun","value":945},{"label":"Jul","value":1037},{"label":"Ago","value":702},{"label":"Set","value":1068},{"label":"Out","value":926},{"label":"Nov","value":987},{"label":"Dez","value":711}];
const MX = 1068;
