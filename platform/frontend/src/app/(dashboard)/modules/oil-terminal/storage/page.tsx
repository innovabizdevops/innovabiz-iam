...
const ACCENT = "#6366f1";
const MODULE = "Oil Terminal";
const PAGE = "Storage";
const KPIS = [{"l":"Riscos Identificados","v":"7.140","t":"+1.4%","d":"up"},{"l":"Mitigações Ativas","v":"4.194","t":"-5.2%","d":"down"},{"l":"Score Risco Geral","v":"75","t":"+13.2%","d":"up"},{"l":"Incidentes YTD","v":"2.115","t":"+1.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.378","2.826","8.862","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.301","212","6.853","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","528","1.559","3.198","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.366","8.060","3.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.138","8.665","5.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":520},{"label":"Mar","value":449},{"label":"Abr","value":676},{"label":"Mai","value":557},{"label":"Jun","value":717},{"label":"Jul","value":540},{"label":"Ago","value":452},{"label":"Set","value":492},{"label":"Out","value":507},{"label":"Nov","value":658},{"label":"Dez","value":414}];
const MX = 717;
