...
const PAGE = "Receipt";
const KPIS = [{"l":"Riscos Identificados","v":"4.949","t":"+5.6%","d":"up"},{"l":"Mitigações Ativas","v":"5.187","t":"+10.1%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"-3.8%","d":"down"},{"l":"Incidentes YTD","v":"2.302","t":"+5.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.575","3.831","3.377","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.801","4.207","6.860","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.230","5.284","4.351","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","554","1.111","5.008","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.421","2.312","1.378","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":633},{"label":"Mar","value":611},{"label":"Abr","value":667},{"label":"Mai","value":330},{"label":"Jun","value":689},{"label":"Jul","value":462},{"label":"Ago","value":615},{"label":"Set","value":345},{"label":"Out","value":512},{"label":"Nov","value":516},{"label":"Dez","value":360}];
const MX = 689;
