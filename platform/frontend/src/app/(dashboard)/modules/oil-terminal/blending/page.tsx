...
const PAGE = "Blending";
const KPIS = [{"l":"Riscos Identificados","v":"8.353","t":"+1.7%","d":"up"},{"l":"Mitigações Ativas","v":"6.571","t":"-3.9%","d":"down"},{"l":"Score Risco Geral","v":"58","t":"+3.8%","d":"up"},{"l":"Incidentes YTD","v":"6.046","t":"+14.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.308","1.990","5.096","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.672","4.709","2.410","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.465","4.974","1.592","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.638","2.413","7.332","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.254","3.804","5.896","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1022},{"label":"Fev","value":1023},{"label":"Mar","value":792},{"label":"Abr","value":997},{"label":"Mai","value":1046},{"label":"Jun","value":983},{"label":"Jul","value":877},{"label":"Ago","value":974},{"label":"Set","value":825},{"label":"Out","value":737},{"label":"Nov","value":850},{"label":"Dez","value":1009}];
const MX = 1046;
