...
const KPIS = [{"l":"Total Reforestation","v":"3.139","t":"-5.3%","d":"down"},{"l":"Biodiversity Ativos","v":"3.135","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"60","t":"+16.8%","d":"up"}];
const COLS = ["ID","Biodiversity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reforestation #001","Reforestation #002","6.427","2.917","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Reforestation #002","Reforestation #003","4.256","4.554","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Reforestation #003","Reforestation #004","542","4.878","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Reforestation #004","Reforestation #005","7.777","247","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reforestation #005","Reforestation #001","6.512","9.059","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":375},{"label":"Mar","value":680},{"label":"Abr","value":475},{"label":"Mai","value":564},{"label":"Jun","value":604},{"label":"Jul","value":317},{"label":"Ago","value":589},{"label":"Set","value":370},{"label":"Out","value":637},{"label":"Nov","value":573},{"label":"Dez","value":561}];
const MX = 680;
