...
const PAGE = "Carbon Credit";
const KPIS = [{"l":"Integrações Ativas","v":"8.339","t":"-0.8%","d":"down"},{"l":"Chamadas/Hora","v":"1688","t":"-0.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"76.9%","t":"-3.3%","d":"down"},{"l":"Latência Média (ms)","v":"79ms","t":"+15.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.536","3.542","85.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","511","8.573","84.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.566","1.638","73.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.885","3.662","75.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.259","4.451","73.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":992},{"label":"Mar","value":1010},{"label":"Abr","value":994},{"label":"Mai","value":943},{"label":"Jun","value":798},{"label":"Jul","value":651},{"label":"Ago","value":931},{"label":"Set","value":869},{"label":"Out","value":817},{"label":"Nov","value":886},{"label":"Dez","value":714}];
const MX = 1010;
