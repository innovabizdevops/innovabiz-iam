...
const PAGE = "Exit";
const KPIS = [{"l":"Total Hire To Retire","v":"3.882","t":"+2.3%","d":"up"},{"l":"Exit Ativos","v":"5.697","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"81","t":"-4.2%","d":"down"}];
const COLS = ["ID","Exit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hire To Retire #001","Hire To Retire #002","4.326","2.692","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Hire To Retire #002","Hire To Retire #003","8.272","3.970","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Hire To Retire #003","Hire To Retire #004","9.079","7.898","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Hire To Retire #004","Hire To Retire #005","4.198","7.960","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hire To Retire #005","Hire To Retire #001","7.546","2.857","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":654},{"label":"Mar","value":622},{"label":"Abr","value":396},{"label":"Mai","value":479},{"label":"Jun","value":581},{"label":"Jul","value":591},{"label":"Ago","value":476},{"label":"Set","value":667},{"label":"Out","value":487},{"label":"Nov","value":760},{"label":"Dez","value":515}];
const MX = 760;
