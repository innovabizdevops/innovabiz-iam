...
const ACCENT = "#06b6d4";
const MODULE = "Hire-to-Retire E2E";
const PAGE = "Develop";
const KPIS = [{"l":"Total Hire To Retire","v":"1.800","t":"-2.5%","d":"down"},{"l":"Develop Ativos","v":"308","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"75","t":"-5.6%","d":"down"}];
const COLS = ["ID","Develop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hire To Retire #001","Hire To Retire #002","3.586","3.366","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Hire To Retire #002","Hire To Retire #003","334","3.667","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Hire To Retire #003","Hire To Retire #004","5.903","610","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Hire To Retire #004","Hire To Retire #005","6.374","8.569","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hire To Retire #005","Hire To Retire #001","3.398","3.552","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":517},{"label":"Mar","value":730},{"label":"Abr","value":837},{"label":"Mai","value":888},{"label":"Jun","value":887},{"label":"Jul","value":617},{"label":"Ago","value":843},{"label":"Set","value":708},{"label":"Out","value":553},{"label":"Nov","value":807},{"label":"Dez","value":816}];
const MX = 888;
