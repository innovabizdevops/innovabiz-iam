...
const PAGE = "Retain";
const KPIS = [{"l":"Total Hire To Retire","v":"4.669","t":"+5.4%","d":"up"},{"l":"Retain Ativos","v":"2.453","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"90.0%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+7.6%","d":"up"}];
const COLS = ["ID","Retain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hire To Retire #001","2026-03-05","7.551","2.529","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Hire To Retire #002","2026-03-11","3.877","1.591","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Hire To Retire #003","2026-02-10","8.301","8.730","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Hire To Retire #004","2026-01-15","3.158","4.829","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hire To Retire #005","2026-01-13","3.253","4.171","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":520},{"label":"Mar","value":270},{"label":"Abr","value":362},{"label":"Mai","value":620},{"label":"Jun","value":371},{"label":"Jul","value":393},{"label":"Ago","value":502},{"label":"Set","value":631},{"label":"Out","value":528},{"label":"Nov","value":434},{"label":"Dez","value":285}];
const MX = 631;
