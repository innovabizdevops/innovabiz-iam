...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"71","t":"-3.2%","d":"down"},{"l":"Engagement (%)","v":"82.3%","t":"+3.9%","d":"up"},{"l":"Turnover (%)","v":"80.3%","t":"+1.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"9.097","t":"-0.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.426","2026-02-28","78","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.061","2026-01-08","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.910","2026-02-16","93","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.491","2026-02-13","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.413","2026-02-22","80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":703},{"label":"Mar","value":869},{"label":"Abr","value":784},{"label":"Mai","value":696},{"label":"Jun","value":663},{"label":"Jul","value":773},{"label":"Ago","value":858},{"label":"Set","value":806},{"label":"Out","value":812},{"label":"Nov","value":657},{"label":"Dez","value":781}];
const MX = 967;
