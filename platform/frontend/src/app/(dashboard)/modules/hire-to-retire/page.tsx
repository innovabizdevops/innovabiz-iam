...
/* ═══ Hire-to-Retire E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "8743", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "742", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€220K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1755496443", cells: ["HIR-2443", "Hire-to-Retire E2E Item 1", "16/4/2026", "€46 543"], status: "active" as const },
    { id: "1755500014", cells: ["HIR-6014", "Hire-to-Retire E2E Item 2", "3/11/2026", "€114"], status: "pending" as const },
    { id: "1755503585", cells: ["HIR-9585", "Hire-to-Retire E2E Item 3", "18/6/2026", "€3685"], status: "completed" as const },
    { id: "1755507156", cells: ["HIR-4156", "Hire-to-Retire E2E Item 4", "5/1/2026", "€7256"], status: "warning" as const },
    { id: "1755510727", cells: ["HIR-7727", "Hire-to-Retire E2E Item 5", "20/8/2026", "€10 827"], status: "active" as const },
];
...
export default function HiretoretireE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hire-to-Retire E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hire-to-Retire E2E</p>
                    </div>
                </div>
