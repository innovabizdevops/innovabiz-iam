...
const KPIS = [{"l":"Dashboards Ativos","v":"2.728","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"3903","t":"+5.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.862","t":"+10.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.441","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3041","2026-03-09","4.072","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4484","2026-02-14","7.256","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1470","2026-03-19","7.830","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1160","2026-01-10","3.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1901","2026-03-23","3.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":669},{"label":"Mar","value":821},{"label":"Abr","value":791},{"label":"Mai","value":609},{"label":"Jun","value":524},{"label":"Jul","value":633},{"label":"Ago","value":810},{"label":"Set","value":552},{"label":"Out","value":703},{"label":"Nov","value":745},{"label":"Dez","value":744}];
const MX = 821;
