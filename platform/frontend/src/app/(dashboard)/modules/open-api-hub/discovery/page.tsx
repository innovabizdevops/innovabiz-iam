...
const KPIS = [{"l":"Integrações Ativas","v":"834","t":"-1.2%","d":"down"},{"l":"Chamadas/Hora","v":"4782","t":"+4.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.2%","t":"+17.8%","d":"up"},{"l":"Latência Média (ms)","v":"194ms","t":"-3.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","483","2.724","87.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.061","6.305","78.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.547","3.953","72.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.522","3.594","74.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","676","5.724","84.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":877},{"label":"Mar","value":748},{"label":"Abr","value":836},{"label":"Mai","value":718},{"label":"Jun","value":783},{"label":"Jul","value":807},{"label":"Ago","value":481},{"label":"Set","value":546},{"label":"Out","value":693},{"label":"Nov","value":634},{"label":"Dez","value":542}];
const MX = 877;
