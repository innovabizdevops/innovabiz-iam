...
const ACCENT = "#059669";
const MODULE = "Open API Hub";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.971","t":"+4.9%","d":"up"},{"l":"Queries/Dia","v":"554","t":"+17.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.529","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.859","t":"-1.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5007","2026-01-10","6.913","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1965","2026-02-21","5.335","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","614","2026-03-12","1.328","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3486","2026-03-10","7.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2993","2026-02-17","8.233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":711},{"label":"Mar","value":564},{"label":"Abr","value":720},{"label":"Mai","value":635},{"label":"Jun","value":757},{"label":"Jul","value":753},{"label":"Ago","value":569},{"label":"Set","value":575},{"label":"Out","value":620},{"label":"Nov","value":484},{"label":"Dez","value":836}];
const MX = 836;
