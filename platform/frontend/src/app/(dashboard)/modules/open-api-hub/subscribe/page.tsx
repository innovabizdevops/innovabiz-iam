...
const KPIS = [{"l":"Integrações Ativas","v":"4.862","t":"-2.9%","d":"down"},{"l":"Chamadas/Hora","v":"1863","t":"+15.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.0%","t":"+16.2%","d":"up"},{"l":"Latência Média (ms)","v":"199ms","t":"+7.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.123","4.629","80.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.538","677","85.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.069","5.465","90.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.795","3.600","90.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.159","7.789","81.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":533},{"label":"Mar","value":483},{"label":"Abr","value":743},{"label":"Mai","value":618},{"label":"Jun","value":413},{"label":"Jul","value":732},{"label":"Ago","value":670},{"label":"Set","value":618},{"label":"Out","value":578},{"label":"Nov","value":433},{"label":"Dez","value":513}];
const MX = 743;
