...
/* ═══ Open API Hub — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8814", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2260", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€354K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2002620314", cells: ["OPE-4314", "Open API Hub Item 1", "3/3/2026", "€20 414"], status: "active" as const },
    { id: "2002623885", cells: ["OPE-7885", "Open API Hub Item 2", "18/10/2026", "€23 985"], status: "pending" as const },
    { id: "2002627456", cells: ["OPE-2456", "Open API Hub Item 3", "5/5/2026", "€27 556"], status: "completed" as const },
    { id: "2002631027", cells: ["OPE-6027", "Open API Hub Item 4", "20/12/2026", "€31 127"], status: "warning" as const },
    { id: "2002634598", cells: ["OPE-9598", "Open API Hub Item 5", "7/7/2026", "€34 698"], status: "active" as const },
];
...
export default function OpenApiHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Open API Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Open API Hub</p>
                    </div>
                </div>
