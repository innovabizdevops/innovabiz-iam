...
const PAGE = "Sandbox";
const KPIS = [{"l":"Integrações Ativas","v":"8.548","t":"-3.4%","d":"down"},{"l":"Chamadas/Hora","v":"3287","t":"-4.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"70.5%","t":"+1.7%","d":"up"},{"l":"Latência Média (ms)","v":"61ms","t":"-0.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.487","8.542","78.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.029","3.389","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.465","7.813","85.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.145","6.992","83.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.957","3.861","89.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":900},{"label":"Mar","value":910},{"label":"Abr","value":764},{"label":"Mai","value":722},{"label":"Jun","value":710},{"label":"Jul","value":771},{"label":"Ago","value":664},{"label":"Set","value":824},{"label":"Out","value":662},{"label":"Nov","value":899},{"label":"Dez","value":685}];
const MX = 910;
