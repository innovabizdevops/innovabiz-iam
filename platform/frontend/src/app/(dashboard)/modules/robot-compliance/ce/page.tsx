...
const PAGE = "CE Mark";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.113","t":"-5.2%","d":"down"},{"l":"NC Abertas","v":"7.373","t":"-5.9%","d":"down"},{"l":"Conformidade (%)","v":"65.7%","t":"+6.6%","d":"up"},{"l":"CAPAs Pendentes","v":"7.035","t":"+0.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.176","85.6%","7.814","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.457","73.6%","1.472","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.622","81.4%","4.753","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.127","72.2%","4.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","991","71.5%","3.176","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":724},{"label":"Mar","value":602},{"label":"Abr","value":935},{"label":"Mai","value":763},{"label":"Jun","value":686},{"label":"Jul","value":792},{"label":"Ago","value":638},{"label":"Set","value":543},{"label":"Out","value":820},{"label":"Nov","value":903},{"label":"Dez","value":771}];
const MX = 935;
