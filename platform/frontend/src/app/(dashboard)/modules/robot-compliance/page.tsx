...
export default function RobotCompliancePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Robot Compliance</h1><p className="text-sm text-muted-foreground">Robot Compliance • iBOS Enterprise</p></div>
