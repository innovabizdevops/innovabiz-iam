...
const ACCENT = "#6366f1";
const MODULE = "Robot Compliance";
const PAGE = "ISO 10218";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.010","t":"-2.5%","d":"down"},{"l":"NC Abertas","v":"6.203","t":"+8.9%","d":"up"},{"l":"Conformidade (%)","v":"76.9%","t":"+9.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.954","t":"+4.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.148","97.6%","1.804","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.592","70.4%","1.667","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.013","93.4%","519","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.549","75.9%","2.716","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.489","92.3%","406","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":828},{"label":"Mar","value":608},{"label":"Abr","value":563},{"label":"Mai","value":797},{"label":"Jun","value":464},{"label":"Jul","value":615},{"label":"Ago","value":591},{"label":"Set","value":736},{"label":"Out","value":512},{"label":"Nov","value":558},{"label":"Dez","value":503}];
const MX = 828;
...
export default function Iso10218Page() {
    return (
