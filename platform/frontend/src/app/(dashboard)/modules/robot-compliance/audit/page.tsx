...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.539","t":"+1.2%","d":"up"},{"l":"NC Abertas","v":"6.486","t":"-4.7%","d":"down"},{"l":"Conformidade (%)","v":"82.8%","t":"+3.5%","d":"up"},{"l":"CAPAs Pendentes","v":"8.208","t":"+12.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.725","89.0%","2.754","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.774","89.4%","2.970","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.526","71.2%","819","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.991","94.1%","1.623","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.955","73.0%","7.398","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":412},{"label":"Mar","value":647},{"label":"Abr","value":589},{"label":"Mai","value":482},{"label":"Jun","value":436},{"label":"Jul","value":620},{"label":"Ago","value":614},{"label":"Set","value":655},{"label":"Out","value":668},{"label":"Nov","value":414},{"label":"Dez","value":535}];
const MX = 692;
