...
const PAGE = "Safety Std";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.215","t":"+3.4%","d":"up"},{"l":"NC Abertas","v":"6.357","t":"+4.3%","d":"up"},{"l":"Conformidade (%)","v":"73.9%","t":"+7.3%","d":"up"},{"l":"CAPAs Pendentes","v":"5.794","t":"+11.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.110","91.1%","4.150","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","517","99.1%","2.409","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.175","86.4%","7.535","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.729","82.8%","4.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.158","94.3%","851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":723},{"label":"Mar","value":416},{"label":"Abr","value":538},{"label":"Mai","value":604},{"label":"Jun","value":743},{"label":"Jul","value":559},{"label":"Ago","value":631},{"label":"Set","value":553},{"label":"Out","value":580},{"label":"Nov","value":603},{"label":"Dez","value":625}];
const MX = 743;
...
export default function SafetyStdPage() {
    return (
