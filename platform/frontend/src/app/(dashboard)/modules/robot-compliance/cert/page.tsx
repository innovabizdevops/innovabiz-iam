...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.268","t":"+8.0%","d":"up"},{"l":"NC Abertas","v":"3.192","t":"+14.5%","d":"up"},{"l":"Conformidade (%)","v":"73.5%","t":"-2.0%","d":"down"},{"l":"CAPAs Pendentes","v":"8.785","t":"+15.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.264","94.2%","5.746","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.862","79.3%","447","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.495","81.2%","1.712","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.730","73.3%","443","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.360","98.1%","216","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":739},{"label":"Mar","value":779},{"label":"Abr","value":872},{"label":"Mai","value":506},{"label":"Jun","value":819},{"label":"Jul","value":678},{"label":"Ago","value":595},{"label":"Set","value":857},{"label":"Out","value":743},{"label":"Nov","value":573},{"label":"Dez","value":700}];
const MX = 872;
