...
const PAGE = "Medical Fit";
const KPIS = [{"l":"Integrações Ativas","v":"2.495","t":"+9.4%","d":"up"},{"l":"Chamadas/Hora","v":"1807","t":"+0.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.0%","t":"+11.6%","d":"up"},{"l":"Latência Média (ms)","v":"171ms","t":"+3.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.471","1.370","83.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.432","7.418","92.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.285","3.506","94.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.325","6.325","95.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","367","2.731","72.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":412},{"label":"Mar","value":587},{"label":"Abr","value":389},{"label":"Mai","value":572},{"label":"Jun","value":657},{"label":"Jul","value":417},{"label":"Ago","value":524},{"label":"Set","value":504},{"label":"Out","value":423},{"label":"Nov","value":353},{"label":"Dez","value":322}];
const MX = 657;
