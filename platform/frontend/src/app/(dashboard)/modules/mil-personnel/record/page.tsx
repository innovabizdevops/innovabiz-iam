...
const ACCENT = "#059669";
const MODULE = "Military Personnel";
const PAGE = "Service Record";
const KPIS = [{"l":"Total Mil Personnel","v":"171","t":"+3.8%","d":"up"},{"l":"Service Record Ativos","v":"8.364","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"58","t":"-1.0%","d":"down"}];
const COLS = ["ID","Service Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mil Personnel #001","Mil Personnel #002","8.342","5.185","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Mil Personnel #002","Mil Personnel #003","8.536","6.834","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Mil Personnel #003","Mil Personnel #004","943","8.369","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Mil Personnel #004","Mil Personnel #005","8.506","6.334","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mil Personnel #005","Mil Personnel #001","2.587","5.686","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":674},{"label":"Mar","value":530},{"label":"Abr","value":700},{"label":"Mai","value":680},{"label":"Jun","value":619},{"label":"Jul","value":533},{"label":"Ago","value":700},{"label":"Set","value":460},{"label":"Out","value":337},{"label":"Nov","value":339},{"label":"Dez","value":524}];
const MX = 700;
