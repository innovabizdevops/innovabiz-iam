...
const PAGE = "AML/KYC Screening";
const KPIS = [{"l":"Total Fraud Detection","v":"4.031","t":"-0.3%","d":"down"},{"l":"AML/KYC Screening Ativos","v":"122","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"61","t":"+4.2%","d":"up"}];
const COLS = ["ID","AML/KYC Screening","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detection #001","Fraud Detection #002","890","4.260","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detection #002","Fraud Detection #003","3.744","5.119","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detection #003","Fraud Detection #004","1.372","6.926","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detection #004","Fraud Detection #005","4.558","4.461","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detection #005","Fraud Detection #001","4.091","6.212","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":1048},{"label":"Mar","value":746},{"label":"Abr","value":842},{"label":"Mai","value":984},{"label":"Jun","value":1030},{"label":"Jul","value":748},{"label":"Ago","value":811},{"label":"Set","value":1027},{"label":"Out","value":834},{"label":"Nov","value":1070},{"label":"Dez","value":876}];
const MX = 1070;
