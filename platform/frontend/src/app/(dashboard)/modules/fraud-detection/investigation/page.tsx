...
const PAGE = "Case Investigation";
const KPIS = [{"l":"Total Fraud Detection","v":"8.722","t":"+11.0%","d":"up"},{"l":"Case Investigation Ativos","v":"5.207","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"95","t":"+14.5%","d":"up"}];
const COLS = ["ID","Case Investigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detection #001","Fraud Detection #002","986","2.239","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detection #002","Fraud Detection #003","6.757","5.351","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detection #003","Fraud Detection #004","7.742","6.086","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detection #004","Fraud Detection #005","298","1.630","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detection #005","Fraud Detection #001","614","4.834","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":789},{"label":"Mar","value":644},{"label":"Abr","value":537},{"label":"Mai","value":624},{"label":"Jun","value":452},{"label":"Jul","value":410},{"label":"Ago","value":788},{"label":"Set","value":517},{"label":"Out","value":581},{"label":"Nov","value":480},{"label":"Dez","value":529}];
const MX = 789;
