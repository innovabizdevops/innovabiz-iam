...
const PAGE = "Identity Verification";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.229","t":"+3.9%","d":"up"},{"l":"Sessões/Dia","v":"2785","t":"+2.7%","d":"up"},{"l":"MFA Adoção (%)","v":"88.5%","t":"+12.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.844","t":"+5.0%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.543","4.469","292","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.672","5.365","8.023","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","350","714","6.588","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.444","8.722","8.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.683","4.912","8.311","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":329},{"label":"Mar","value":269},{"label":"Abr","value":369},{"label":"Mai","value":571},{"label":"Jun","value":558},{"label":"Jul","value":619},{"label":"Ago","value":469},{"label":"Set","value":560},{"label":"Out","value":235},{"label":"Nov","value":349},{"label":"Dez","value":600}];
const MX = 619;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>eIDAS</span></h1>
                </div>
