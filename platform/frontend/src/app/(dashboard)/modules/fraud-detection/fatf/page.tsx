...
const PAGE = "FATF Recommendations";
const KPIS = [{"l":"Total Fraud Detection","v":"693","t":"+15.2%","d":"up"},{"l":"FATF Recommendations Ativos","v":"2.915","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"93.7%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"56","t":"+8.6%","d":"up"}];
const COLS = ["ID","FATF Recommendations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detection #001","Fraud Detection #002","6.621","8.555","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detection #002","Fraud Detection #003","7.887","2.894","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detection #003","Fraud Detection #004","8.386","2.797","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detection #004","Fraud Detection #005","7.720","7.815","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detection #005","Fraud Detection #001","7.291","930","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":352},{"label":"Mar","value":659},{"label":"Abr","value":444},{"label":"Mai","value":466},{"label":"Jun","value":667},{"label":"Jul","value":562},{"label":"Ago","value":434},{"label":"Set","value":548},{"label":"Out","value":578},{"label":"Nov","value":500},{"label":"Dez","value":380}];
const MX = 683;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>FATF</span></h1>
                </div>
