...
const ACCENT = "#b91c1c";
const MODULE = "Fraud & Financial Crime";
const PAGE = "Transaction Monitoring AI";
const KPIS = [{"l":"Total Fraud Detection","v":"1.077","t":"+15.8%","d":"up"},{"l":"Transaction Monitoring AI Ativos","v":"5.812","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"58","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Transaction Monitoring AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detection #001","Fraud Detection #002","5.486","1.787","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detection #002","Fraud Detection #003","8.388","4.158","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detection #003","Fraud Detection #004","8.705","7.599","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detection #004","Fraud Detection #005","4.689","3.442","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detection #005","Fraud Detection #001","1.705","4.587","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":681},{"label":"Mar","value":690},{"label":"Abr","value":714},{"label":"Mai","value":672},{"label":"Jun","value":961},{"label":"Jul","value":680},{"label":"Ago","value":998},{"label":"Set","value":658},{"label":"Out","value":834},{"label":"Nov","value":680},{"label":"Dez","value":724}];
const MX = 998;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>AI</span></h1>
                </div>
