...
const PAGE = "Wolfsberg Principles";
const KPIS = [{"l":"Total Fraud Detection","v":"7.354","t":"+0.8%","d":"up"},{"l":"Wolfsberg Principles Ativos","v":"7.077","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"76","t":"+7.4%","d":"up"}];
const COLS = ["ID","Wolfsberg Principles","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detection #001","Fraud Detection #002","8.320","2.660","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detection #002","Fraud Detection #003","2.924","752","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detection #003","Fraud Detection #004","3.597","8.826","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detection #004","Fraud Detection #005","2.028","5.680","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detection #005","Fraud Detection #001","369","1.016","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":830},{"label":"Mar","value":788},{"label":"Abr","value":703},{"label":"Mai","value":746},{"label":"Jun","value":759},{"label":"Jul","value":952},{"label":"Ago","value":690},{"label":"Set","value":607},{"label":"Out","value":817},{"label":"Nov","value":919},{"label":"Dez","value":755}];
const MX = 952;
...
export default function WolfsbergPage() {
    return (
