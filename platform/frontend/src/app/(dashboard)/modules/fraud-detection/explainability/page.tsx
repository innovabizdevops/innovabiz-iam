...
const PAGE = "AI Model Explainability";
const KPIS = [{"l":"Total Fraud Detection","v":"3.233","t":"+4.8%","d":"up"},{"l":"AI Model Explainability Ativos","v":"2.900","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.6%","d":"up"}];
const COLS = ["ID","AI Model Explainability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fraud Detection #001","Fraud Detection #002","4.216","3.272","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Fraud Detection #002","Fraud Detection #003","1.289","8.626","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Fraud Detection #003","Fraud Detection #004","352","3.318","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Fraud Detection #004","Fraud Detection #005","7.068","3.260","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fraud Detection #005","Fraud Detection #001","162","8.998","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":712},{"label":"Mar","value":468},{"label":"Abr","value":510},{"label":"Mai","value":609},{"label":"Jun","value":563},{"label":"Jul","value":655},{"label":"Ago","value":569},{"label":"Set","value":770},{"label":"Out","value":781},{"label":"Nov","value":603},{"label":"Dez","value":633}];
const MX = 781;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b91c1c'}}>XAI</span></h1>
                </div>
