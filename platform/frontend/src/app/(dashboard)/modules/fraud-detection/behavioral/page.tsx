...
const PAGE = "Behavioral Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"847","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"2453","t":"+7.7%","d":"up"},{"l":"Dados Processados (GB)","v":"892","t":"+2.5%","d":"up"},{"l":"Utilizadores Analytics","v":"6.159","t":"-1.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4284","2026-03-14","8.987","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1715","2026-02-17","5.279","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2186","2026-01-27","4.103","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4327","2026-03-25","1.300","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1617","2026-01-22","6.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":365},{"label":"Mar","value":518},{"label":"Abr","value":639},{"label":"Mai","value":362},{"label":"Jun","value":691},{"label":"Jul","value":422},{"label":"Ago","value":397},{"label":"Set","value":336},{"label":"Out","value":380},{"label":"Nov","value":690},{"label":"Dez","value":329}];
const MX = 691;
