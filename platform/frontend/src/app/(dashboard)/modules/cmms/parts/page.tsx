...
const ACCENT = "#475569";
const MODULE = "CMMS Maintenance";
const PAGE = "Spare Parts";
const KPIS = [{"l":"Quartos Ocupados","v":"3.287","t":"+16.3%","d":"up"},{"l":"RevPAR (€)","v":"€79041","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"86.4%","t":"+14.3%","d":"up"},{"l":"Guest Satisfaction","v":"4.357","t":"-2.2%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.997","2026-03-17","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.105","2026-01-02","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.193","2026-03-02","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.837","2026-03-05","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","171","2026-03-20","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":535},{"label":"Mar","value":754},{"label":"Abr","value":686},{"label":"Mai","value":492},{"label":"Jun","value":734},{"label":"Jul","value":720},{"label":"Ago","value":712},{"label":"Set","value":687},{"label":"Out","value":657},{"label":"Nov","value":519},{"label":"Dez","value":751}];
const MX = 754;
