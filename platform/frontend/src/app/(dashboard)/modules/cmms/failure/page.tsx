...
const PAGE = "Failure Codes";
const KPIS = [{"l":"Total Cmms","v":"2.418","t":"+12.8%","d":"up"},{"l":"Failure Codes Ativos","v":"7.029","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+7.1%","d":"up"}];
const COLS = ["ID","Failure Codes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmms #001","Cmms #002","1.569","8.803","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Cmms #002","Cmms #003","923","7.902","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmms #003","Cmms #004","6.125","7.567","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cmms #004","Cmms #005","7.531","668","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmms #005","Cmms #001","3.069","1.983","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":344},{"label":"Mar","value":534},{"label":"Abr","value":308},{"label":"Mai","value":532},{"label":"Jun","value":346},{"label":"Jul","value":586},{"label":"Ago","value":405},{"label":"Set","value":608},{"label":"Out","value":621},{"label":"Nov","value":264},{"label":"Dez","value":636}];
const MX = 636;
