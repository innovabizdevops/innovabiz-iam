...
const PAGE = "PM Schedule";
const KPIS = [{"l":"Total Cmms","v":"1.116","t":"+1.9%","d":"up"},{"l":"PM Schedule Ativos","v":"5.053","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"73","t":"+10.8%","d":"up"}];
const COLS = ["ID","PM Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmms #001","Cmms #002","6.085","8.139","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Cmms #002","Cmms #003","8.026","7.500","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmms #003","Cmms #004","5.608","3.318","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Cmms #004","Cmms #005","3.585","509","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmms #005","Cmms #001","2.371","8.539","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":607},{"label":"Mar","value":613},{"label":"Abr","value":330},{"label":"Mai","value":311},{"label":"Jun","value":407},{"label":"Jul","value":581},{"label":"Ago","value":307},{"label":"Set","value":448},{"label":"Out","value":402},{"label":"Nov","value":544},{"label":"Dez","value":413}];
const MX = 613;
