...
const KPIS = [{"l":"Total Cmms","v":"7.579","t":"+6.4%","d":"up"},{"l":"Work Orders Ativos","v":"7.652","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"63","t":"-1.7%","d":"down"}];
const COLS = ["ID","Work Orders","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmms #001","Cmms #002","6.481","7.573","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cmms #002","Cmms #003","5.264","491","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmms #003","Cmms #004","5.203","3.325","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cmms #004","Cmms #005","2.752","3.060","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmms #005","Cmms #001","7.265","886","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":490},{"label":"Mar","value":471},{"label":"Abr","value":538},{"label":"Mai","value":490},{"label":"Jun","value":657},{"label":"Jul","value":601},{"label":"Ago","value":484},{"label":"Set","value":641},{"label":"Out","value":686},{"label":"Nov","value":752},{"label":"Dez","value":737}];
const MX = 752;
