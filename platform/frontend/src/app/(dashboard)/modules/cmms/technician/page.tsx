...
const PAGE = "Technician App";
const KPIS = [{"l":"Total Cmms","v":"5.442","t":"-5.3%","d":"down"},{"l":"Technician App Ativos","v":"2.375","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"92","t":"+7.2%","d":"up"}];
const COLS = ["ID","Technician App","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmms #001","Cmms #002","6.726","2.065","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Cmms #002","Cmms #003","1.704","7.021","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmms #003","Cmms #004","7.346","3.020","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Cmms #004","Cmms #005","3.019","3.997","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmms #005","Cmms #001","4.611","5.566","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":835},{"label":"Mar","value":728},{"label":"Abr","value":588},{"label":"Mai","value":507},{"label":"Jun","value":704},{"label":"Jul","value":767},{"label":"Ago","value":649},{"label":"Set","value":652},{"label":"Out","value":693},{"label":"Nov","value":564},{"label":"Dez","value":597}];
const MX = 835;
