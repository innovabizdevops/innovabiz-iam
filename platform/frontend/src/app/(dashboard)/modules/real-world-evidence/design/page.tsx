...
const PAGE = "Study Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.281","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"2962","t":"+16.0%","d":"up"},{"l":"Documentos Gerados","v":"2.615","t":"+14.7%","d":"up"},{"l":"Templates","v":"8.786","t":"+0.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.712","2026-03-14","2.450","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.671","2026-02-09","5.570","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.582","2026-01-13","7.636","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.700","2026-02-01","1.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.350","2026-03-18","5.287","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":537},{"label":"Mar","value":439},{"label":"Abr","value":571},{"label":"Mai","value":776},{"label":"Jun","value":605},{"label":"Jul","value":569},{"label":"Ago","value":509},{"label":"Set","value":577},{"label":"Out","value":502},{"label":"Nov","value":580},{"label":"Dez","value":563}];
const MX = 776;
