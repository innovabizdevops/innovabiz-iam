...
export default function RealWorldEvidencePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Real World Evidence</h1><p className="text-sm text-muted-foreground">Real World Evidence • iBOS Enterprise</p></div>
