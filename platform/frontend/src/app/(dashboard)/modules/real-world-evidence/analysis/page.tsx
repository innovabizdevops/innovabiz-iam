...
const ACCENT = "#6366f1";
const MODULE = "Real World Evidence";
const PAGE = "Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.027","t":"+17.2%","d":"up"},{"l":"Queries/Dia","v":"5090","t":"+5.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.034","t":"+8.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.951","t":"+10.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2624","2026-01-18","2.259","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3899","2026-03-20","4.668","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3383","2026-02-05","6.796","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","264","2026-03-02","8.611","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1485","2026-01-03","2.147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":997},{"label":"Mar","value":864},{"label":"Abr","value":779},{"label":"Mai","value":1044},{"label":"Jun","value":745},{"label":"Jul","value":746},{"label":"Ago","value":752},{"label":"Set","value":852},{"label":"Out","value":848},{"label":"Nov","value":994},{"label":"Dez","value":1058}];
const MX = 1058;
