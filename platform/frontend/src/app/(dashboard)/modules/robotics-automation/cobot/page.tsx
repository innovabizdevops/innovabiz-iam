...
const PAGE = "Cobot Safety";
const KPIS = [{"l":"Total Robotics Automation","v":"924","t":"+13.9%","d":"up"},{"l":"Cobot Safety Ativos","v":"8.734","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"94","t":"-3.1%","d":"down"}];
const COLS = ["ID","Cobot Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robotics Automation #001","Robotics Automation #002","3.811","2.958","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Robotics Automation #002","Robotics Automation #003","3.435","6.894","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Robotics Automation #003","Robotics Automation #004","1.173","7.892","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Robotics Automation #004","Robotics Automation #005","6.502","2.309","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robotics Automation #005","Robotics Automation #001","3.983","6.618","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":522},{"label":"Mar","value":445},{"label":"Abr","value":646},{"label":"Mai","value":508},{"label":"Jun","value":647},{"label":"Jul","value":666},{"label":"Ago","value":612},{"label":"Set","value":337},{"label":"Out","value":654},{"label":"Nov","value":645},{"label":"Dez","value":613}];
const MX = 666;
...
export default function CobotPage() {
    return (
