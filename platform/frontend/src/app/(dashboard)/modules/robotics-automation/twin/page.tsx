...
const PAGE = "Digital Twin Robot";
const KPIS = [{"l":"Twins Ativos","v":"901","t":"+0.8%","d":"up"},{"l":"Simulações/Dia","v":"1021","t":"+7.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"67.4%","t":"+15.1%","d":"up"},{"l":"Latência Sync (ms)","v":"142ms","t":"-0.1%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","70.2%","2026-01-20","8.297","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","89.2%","2026-02-12","2.577","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","82.5%","2026-02-25","8.223","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","76.6%","2026-03-16","5.761","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","72.9%","2026-01-05","4.886","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":876},{"label":"Mar","value":826},{"label":"Abr","value":1044},{"label":"Mai","value":758},{"label":"Jun","value":815},{"label":"Jul","value":725},{"label":"Ago","value":943},{"label":"Set","value":854},{"label":"Out","value":938},{"label":"Nov","value":727},{"label":"Dez","value":780}];
const MX = 1044;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>DT</span></h1>
                </div>
