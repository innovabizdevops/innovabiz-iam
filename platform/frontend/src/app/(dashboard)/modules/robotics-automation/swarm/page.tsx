...
const ACCENT = "#4338ca";
const MODULE = "Robotics & Automation";
const PAGE = "Swarm Intelligence";
const KPIS = [{"l":"Total Robotics Automation","v":"3.857","t":"+10.2%","d":"up"},{"l":"Swarm Intelligence Ativos","v":"2.339","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"79.3%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"74","t":"+3.1%","d":"up"}];
const COLS = ["ID","Swarm Intelligence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robotics Automation #001","Robotics Automation #002","8.617","5.237","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Robotics Automation #002","Robotics Automation #003","2.606","1.163","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Robotics Automation #003","Robotics Automation #004","7.354","2.350","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Robotics Automation #004","Robotics Automation #005","6.172","2.683","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robotics Automation #005","Robotics Automation #001","7.198","3.546","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":821},{"label":"Mar","value":712},{"label":"Abr","value":631},{"label":"Mai","value":652},{"label":"Jun","value":744},{"label":"Jul","value":611},{"label":"Ago","value":572},{"label":"Set","value":607},{"label":"Out","value":862},{"label":"Nov","value":654},{"label":"Dez","value":599}];
const MX = 862;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>AI</span></h1>
                </div>
