...
const PAGE = "Crowd Delivery";
const KPIS = [{"l":"Total Logtech","v":"463","t":"-3.4%","d":"down"},{"l":"Crowd Delivery Ativos","v":"9.035","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"89","t":"+1.3%","d":"up"}];
const COLS = ["ID","Crowd Delivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logtech #001","Logtech #002","8.696","6.736","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Logtech #002","Logtech #003","1.583","736","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Logtech #003","Logtech #004","4.915","7.075","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Logtech #004","Logtech #005","7.134","2.176","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logtech #005","Logtech #001","6.958","1.945","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":714},{"label":"Mar","value":887},{"label":"Abr","value":735},{"label":"Mai","value":808},{"label":"Jun","value":751},{"label":"Jul","value":674},{"label":"Ago","value":968},{"label":"Set","value":774},{"label":"Out","value":922},{"label":"Nov","value":984},{"label":"Dez","value":998}];
const MX = 998;
