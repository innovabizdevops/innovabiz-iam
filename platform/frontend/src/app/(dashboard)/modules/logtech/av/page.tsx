...
const KPIS = [{"l":"Total Logtech","v":"6.318","t":"+4.1%","d":"up"},{"l":"Autonomous Vehicles Ativos","v":"3.374","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+7.7%","d":"up"}];
const COLS = ["ID","Autonomous Vehicles","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logtech #001","Logtech #002","1.168","2.396","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Logtech #002","Logtech #003","8.895","2.481","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Logtech #003","Logtech #004","3.140","1.409","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Logtech #004","Logtech #005","818","7.515","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logtech #005","Logtech #001","3.562","5.237","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":518},{"label":"Mar","value":566},{"label":"Abr","value":461},{"label":"Mai","value":720},{"label":"Jun","value":594},{"label":"Jul","value":643},{"label":"Ago","value":504},{"label":"Set","value":430},{"label":"Out","value":600},{"label":"Nov","value":452},{"label":"Dez","value":631}];
const MX = 720;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0e7490'}}>AV</span></h1>
                </div>
