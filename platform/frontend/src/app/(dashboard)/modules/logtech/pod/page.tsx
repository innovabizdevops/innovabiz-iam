...
const KPIS = [{"l":"Total Logtech","v":"9.094","t":"+7.1%","d":"up"},{"l":"Proof Of Delivery Ativos","v":"3.733","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"73","t":"+5.1%","d":"up"}];
const COLS = ["ID","Proof Of Delivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logtech #001","Logtech #002","2.364","3.426","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Logtech #002","Logtech #003","4.457","6.207","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Logtech #003","Logtech #004","2.308","3.082","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Logtech #004","Logtech #005","7.957","6.891","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logtech #005","Logtech #001","2.939","6.219","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":623},{"label":"Mar","value":528},{"label":"Abr","value":496},{"label":"Mai","value":330},{"label":"Jun","value":405},{"label":"Jul","value":366},{"label":"Ago","value":588},{"label":"Set","value":518},{"label":"Out","value":542},{"label":"Nov","value":613},{"label":"Dez","value":431}];
const MX = 623;
