...
const PAGE = "Locker Network";
const KPIS = [{"l":"Total Logtech","v":"828","t":"+6.1%","d":"up"},{"l":"Locker Network Ativos","v":"2.825","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"92.0%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.4%","d":"up"}];
const COLS = ["ID","Locker Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logtech #001","Logtech #002","7.566","7.335","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Logtech #002","Logtech #003","3.411","6.326","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Logtech #003","Logtech #004","3.722","5.840","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Logtech #004","Logtech #005","4.637","5.431","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logtech #005","Logtech #001","3.708","348","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":344},{"label":"Mar","value":349},{"label":"Abr","value":660},{"label":"Mai","value":509},{"label":"Jun","value":397},{"label":"Jul","value":343},{"label":"Ago","value":485},{"label":"Set","value":381},{"label":"Out","value":676},{"label":"Nov","value":507},{"label":"Dez","value":556}];
const MX = 676;
