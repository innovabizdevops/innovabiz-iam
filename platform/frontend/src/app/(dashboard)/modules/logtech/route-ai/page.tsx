...
const KPIS = [{"l":"Total Logtech","v":"6.664","t":"+7.1%","d":"up"},{"l":"Route Optimization Ativos","v":"6.205","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"73.4%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+3.6%","d":"up"}];
const COLS = ["ID","Route Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logtech #001","Logtech #002","5.834","916","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Logtech #002","Logtech #003","4.710","1.047","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Logtech #003","Logtech #004","4.173","6.915","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Logtech #004","Logtech #005","8.434","758","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logtech #005","Logtech #001","2.095","5.848","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":296},{"label":"Fev","value":482},{"label":"Mar","value":534},{"label":"Abr","value":398},{"label":"Mai","value":526},{"label":"Jun","value":455},{"label":"Jul","value":323},{"label":"Ago","value":263},{"label":"Set","value":431},{"label":"Out","value":591},{"label":"Nov","value":488},{"label":"Dez","value":636}];
const MX = 636;
