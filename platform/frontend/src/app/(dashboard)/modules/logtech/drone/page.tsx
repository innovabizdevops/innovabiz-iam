...
const ACCENT = "#0e7490";
const MODULE = "LogTech & Last Mile";
const PAGE = "Drone Delivery";
const KPIS = [{"l":"Total Logtech","v":"5.798","t":"+5.7%","d":"up"},{"l":"Drone Delivery Ativos","v":"3.779","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"85.2%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"69","t":"+11.8%","d":"up"}];
const COLS = ["ID","Drone Delivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logtech #001","Logtech #002","3.577","5.080","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Logtech #002","Logtech #003","6.493","6.113","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Logtech #003","Logtech #004","7.695","2.675","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Logtech #004","Logtech #005","1.325","2.766","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logtech #005","Logtech #001","6.294","2.489","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":490},{"label":"Mar","value":485},{"label":"Abr","value":640},{"label":"Mai","value":386},{"label":"Jun","value":657},{"label":"Jul","value":409},{"label":"Ago","value":418},{"label":"Set","value":540},{"label":"Out","value":660},{"label":"Nov","value":707},{"label":"Dez","value":369}];
const MX = 707;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0e7490'}}>UAS</span></h1>
                </div>
