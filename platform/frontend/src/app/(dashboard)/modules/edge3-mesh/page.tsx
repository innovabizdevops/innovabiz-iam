...
/* ═══ EDGE3 Cognitive Mesh — Dashboard ═══ */

const ACCENT = "#0f766e";

const KPIS = [
    { label: "Total Registos", value: "2329", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "515", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€116K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1082428629", cells: ["EDG-8629", "EDGE3 Cognitive Mesh Item 1", "10/10/2026", "€28 729"], status: "active" as const },
    { id: "1082432200", cells: ["EDG-3200", "EDGE3 Cognitive Mesh Item 2", "25/5/2026", "€32 300"], status: "pending" as const },
    { id: "1082435771", cells: ["EDG-6771", "EDGE3 Cognitive Mesh Item 3", "12/12/2026", "€35 871"], status: "completed" as const },
    { id: "1082439342", cells: ["EDG-1342", "EDGE3 Cognitive Mesh Item 4", "27/7/2026", "€39 442"], status: "warning" as const },
    { id: "1082442913", cells: ["EDG-4913", "EDGE3 Cognitive Mesh Item 5", "14/2/2026", "€43 013"], status: "active" as const },
];
...
export default function Edge3CognitiveMeshPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDGE3 Cognitive Mesh</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDGE3 Cognitive Mesh</p>
                    </div>
                </div>
