...
const PAGE = "Heal";
const KPIS = [{"l":"Total Edge3 Mesh","v":"5.301","t":"+7.8%","d":"up"},{"l":"Heal Ativos","v":"4.112","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"95","t":"-5.5%","d":"down"}];
const COLS = ["ID","Heal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge3 Mesh #001","Edge3 Mesh #002","8.336","5.280","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Edge3 Mesh #002","Edge3 Mesh #003","7.726","1.185","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge3 Mesh #003","Edge3 Mesh #004","2.361","4.321","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Edge3 Mesh #004","Edge3 Mesh #005","5.585","3.008","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge3 Mesh #005","Edge3 Mesh #001","2.065","5.649","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":518},{"label":"Mar","value":455},{"label":"Abr","value":612},{"label":"Mai","value":471},{"label":"Jun","value":454},{"label":"Jul","value":353},{"label":"Ago","value":535},{"label":"Set","value":296},{"label":"Out","value":253},{"label":"Nov","value":544},{"label":"Dez","value":564}];
const MX = 612;
