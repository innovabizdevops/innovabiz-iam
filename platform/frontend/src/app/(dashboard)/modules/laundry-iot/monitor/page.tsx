...
const PAGE = "Monitor";
const KPIS = [{"l":"Dispositivos Online","v":"4.943","t":"+10.3%","d":"up"},{"l":"Dados/Min (MB)","v":"2.681","t":"-2.3%","d":"down"},{"l":"Alertas Ativos","v":"2.084","t":"+12.1%","d":"up"},{"l":"Uptime (%)","v":"90.9%","t":"-5.1%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.024","4.757","7.110","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","940","5.883","7.532","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.855","5.014","2.809","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.984","1.715","2.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.814","1.143","2.758","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":676},{"label":"Mar","value":908},{"label":"Abr","value":858},{"label":"Mai","value":871},{"label":"Jun","value":727},{"label":"Jul","value":634},{"label":"Ago","value":673},{"label":"Set","value":685},{"label":"Out","value":755},{"label":"Nov","value":628},{"label":"Dez","value":678}];
const MX = 908;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0e7490'}}>RTM</span></h1>
                </div>
