...
const PAGE = "Alert";
const KPIS = [{"l":"Dispositivos Online","v":"3.298","t":"+2.8%","d":"up"},{"l":"Dados/Min (MB)","v":"668","t":"+12.0%","d":"up"},{"l":"Alertas Ativos","v":"2.091","t":"+16.6%","d":"up"},{"l":"Uptime (%)","v":"70.8%","t":"+13.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.909","8.092","8.312","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.375","442","380","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","757","7.298","7.409","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.509","8.275","3.614","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","378","8.517","5.017","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":447},{"label":"Mar","value":638},{"label":"Abr","value":544},{"label":"Mai","value":312},{"label":"Jun","value":648},{"label":"Jul","value":357},{"label":"Ago","value":307},{"label":"Set","value":568},{"label":"Out","value":309},{"label":"Nov","value":554},{"label":"Dez","value":370}];
const MX = 648;
