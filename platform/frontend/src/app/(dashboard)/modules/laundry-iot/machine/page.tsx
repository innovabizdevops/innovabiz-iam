...
const ACCENT = "#0e7490";
const MODULE = "Laundry IoT Platform";
const PAGE = "Machine";
const KPIS = [{"l":"Dispositivos Online","v":"8.661","t":"+1.3%","d":"up"},{"l":"Dados/Min (MB)","v":"761","t":"-3.0%","d":"down"},{"l":"Alertas Ativos","v":"7.388","t":"-2.3%","d":"down"},{"l":"Uptime (%)","v":"81.8%","t":"-4.5%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.807","2.893","3.636","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.338","1.822","6.998","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.727","215","6.035","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","104","8.807","1.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.090","7.557","4.022","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":353},{"label":"Mar","value":742},{"label":"Abr","value":502},{"label":"Mai","value":477},{"label":"Jun","value":740},{"label":"Jul","value":524},{"label":"Ago","value":722},{"label":"Set","value":630},{"label":"Out","value":417},{"label":"Nov","value":634},{"label":"Dez","value":625}];
const MX = 742;
