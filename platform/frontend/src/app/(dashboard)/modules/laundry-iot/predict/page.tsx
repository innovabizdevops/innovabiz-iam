...
const PAGE = "Predict";
const KPIS = [{"l":"Dispositivos Online","v":"5.955","t":"+15.2%","d":"up"},{"l":"Dados/Min (MB)","v":"8.019","t":"+10.8%","d":"up"},{"l":"Alertas Ativos","v":"5.454","t":"+11.7%","d":"up"},{"l":"Uptime (%)","v":"91.9%","t":"-2.7%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","751","2.607","1.697","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.920","6.457","3.482","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.382","7.999","3.782","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.447","2.308","4.022","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.586","397","7.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":475},{"label":"Mar","value":540},{"label":"Abr","value":725},{"label":"Mai","value":863},{"label":"Jun","value":521},{"label":"Jul","value":716},{"label":"Ago","value":779},{"label":"Set","value":538},{"label":"Out","value":497},{"label":"Nov","value":734},{"label":"Dez","value":755}];
const MX = 863;
