...
const PAGE = "Energy";
const KPIS = [{"l":"Dispositivos Online","v":"7.854","t":"+2.5%","d":"up"},{"l":"Dados/Min (MB)","v":"6.426","t":"+6.0%","d":"up"},{"l":"Alertas Ativos","v":"143","t":"+11.2%","d":"up"},{"l":"Uptime (%)","v":"82.7%","t":"+7.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.944","3.368","2.249","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.394","2.864","571","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.839","2.084","7.598","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.028","8.172","8.173","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.575","5.147","1.800","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":432},{"label":"Mar","value":437},{"label":"Abr","value":494},{"label":"Mai","value":661},{"label":"Jun","value":732},{"label":"Jul","value":544},{"label":"Ago","value":768},{"label":"Set","value":454},{"label":"Out","value":576},{"label":"Nov","value":702},{"label":"Dez","value":604}];
const MX = 768;
