...
/* ═══ Laundry IoT Platform — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "8605", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1392", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€322K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2008292805", cells: ["LAU-6805", "Laundry IoT Platform Item 1", "2/10/2026", "€42 905"], status: "active" as const },
    { id: "2008296376", cells: ["LAU-1376", "Laundry IoT Platform Item 2", "17/5/2026", "€46 476"], status: "pending" as const },
    { id: "2008299947", cells: ["LAU-4947", "Laundry IoT Platform Item 3", "4/12/2026", "€50 047"], status: "completed" as const },
    { id: "2008303518", cells: ["LAU-8518", "Laundry IoT Platform Item 4", "19/7/2026", "€3618"], status: "warning" as const },
    { id: "2008307089", cells: ["LAU-3089", "Laundry IoT Platform Item 5", "6/2/2026", "€7189"], status: "active" as const },
];
...
export default function LaundryIotPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laundry IoT Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laundry IoT Platform</p>
                    </div>
                </div>
