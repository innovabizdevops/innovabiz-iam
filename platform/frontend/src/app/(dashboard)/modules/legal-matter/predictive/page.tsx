...
const ACCENT = "#78350f";
const MODULE = "Matter Management";
const PAGE = "Predictive AI";
const KPIS = [{"l":"Integrações Ativas","v":"703","t":"+14.2%","d":"up"},{"l":"Chamadas/Hora","v":"4614","t":"-2.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.2%","t":"-2.2%","d":"down"},{"l":"Latência Média (ms)","v":"30ms","t":"-2.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","549","7.763","70.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.976","3.391","79.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.976","8.173","94.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.211","2.113","94.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.098","5.619","77.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":752},{"label":"Mar","value":519},{"label":"Abr","value":777},{"label":"Mai","value":514},{"label":"Jun","value":525},{"label":"Jul","value":567},{"label":"Ago","value":718},{"label":"Set","value":595},{"label":"Out","value":424},{"label":"Nov","value":796},{"label":"Dez","value":508}];
const MX = 796;
