...
const PAGE = "Knowledge Mgmt";
const KPIS = [{"l":"Artigos Publicados","v":"3.815","t":"+0.1%","d":"up"},{"l":"Views/Semana","v":"2536","t":"+1.6%","d":"up"},{"l":"Feedback Útil (%)","v":"85.1%","t":"+10.1%","d":"up"},{"l":"Artigos Desatualizados","v":"7.032","t":"+7.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","422","80.3%","4.200","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","1.040","81.9%","1.927","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","8.172","97.4%","2.491","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.013","91.4%","2.968","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","1.667","73.1%","4.009","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":939},{"label":"Mar","value":953},{"label":"Abr","value":807},{"label":"Mai","value":830},{"label":"Jun","value":826},{"label":"Jul","value":966},{"label":"Ago","value":730},{"label":"Set","value":999},{"label":"Out","value":665},{"label":"Nov","value":679},{"label":"Dez","value":915}];
const MX = 999;
