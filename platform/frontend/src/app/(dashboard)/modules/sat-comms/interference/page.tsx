...
const KPIS = [{"l":"Total Sat Comms","v":"8.760","t":"+2.6%","d":"up"},{"l":"Interference Ativos","v":"5.032","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"63","t":"-3.8%","d":"down"}];
const COLS = ["ID","Interference","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comms #001","Sat Comms #002","6.040","5.536","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comms #002","Sat Comms #003","8.989","1.076","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comms #003","Sat Comms #004","1.571","1.940","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comms #004","Sat Comms #005","3.993","4.200","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comms #005","Sat Comms #001","6.318","7.790","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":704},{"label":"Mar","value":514},{"label":"Abr","value":336},{"label":"Mai","value":410},{"label":"Jun","value":605},{"label":"Jul","value":595},{"label":"Ago","value":514},{"label":"Set","value":492},{"label":"Out","value":621},{"label":"Nov","value":613},{"label":"Dez","value":574}];
const MX = 704;
