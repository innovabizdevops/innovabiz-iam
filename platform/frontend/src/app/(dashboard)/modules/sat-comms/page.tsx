...
export default function SatCommsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sat Comms</h1><p className="text-sm text-muted-foreground">Sat Comms • iBOS Enterprise</p></div>
