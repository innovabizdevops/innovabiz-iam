...
const PAGE = "Gateway";
const KPIS = [{"l":"Integrações Ativas","v":"6.058","t":"+8.2%","d":"up"},{"l":"Chamadas/Hora","v":"561","t":"-3.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"68.0%","t":"+15.1%","d":"up"},{"l":"Latência Média (ms)","v":"34ms","t":"+17.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","911","1.713","79.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","380","6.391","74.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.019","2.019","76.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.747","4.074","77.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.805","3.392","81.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":540},{"label":"Mar","value":734},{"label":"Abr","value":599},{"label":"Mai","value":543},{"label":"Jun","value":551},{"label":"Jul","value":612},{"label":"Ago","value":745},{"label":"Set","value":510},{"label":"Out","value":449},{"label":"Nov","value":467},{"label":"Dez","value":395}];
const MX = 745;
