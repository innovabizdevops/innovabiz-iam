...
const ACCENT = "#dc2626";
const MODULE = "Satellite Communications";
const PAGE = "Transponder";
const KPIS = [{"l":"Total Sat Comms","v":"5.566","t":"+7.9%","d":"up"},{"l":"Transponder Ativos","v":"3.560","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"69","t":"-5.4%","d":"down"}];
const COLS = ["ID","Transponder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comms #001","Sat Comms #002","3.792","6.045","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comms #002","Sat Comms #003","576","3.669","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comms #003","Sat Comms #004","4.465","6.231","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comms #004","Sat Comms #005","6.189","2.217","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comms #005","Sat Comms #001","3.009","1.376","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":636},{"label":"Mar","value":635},{"label":"Abr","value":482},{"label":"Mai","value":283},{"label":"Jun","value":499},{"label":"Jul","value":277},{"label":"Ago","value":389},{"label":"Set","value":366},{"label":"Out","value":531},{"label":"Nov","value":486},{"label":"Dez","value":614}];
const MX = 636;
