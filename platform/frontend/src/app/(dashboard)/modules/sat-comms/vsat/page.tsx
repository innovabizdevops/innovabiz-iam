...
const PAGE = "VSAT Mgmt";
const KPIS = [{"l":"Total Sat Comms","v":"9.080","t":"+3.5%","d":"up"},{"l":"VSAT Mgmt Ativos","v":"1.124","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"71","t":"-2.9%","d":"down"}];
const COLS = ["ID","VSAT Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comms #001","Sat Comms #002","5.673","6.621","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comms #002","Sat Comms #003","5.953","3.741","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comms #003","Sat Comms #004","1.003","7.931","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comms #004","Sat Comms #005","7.213","8.759","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comms #005","Sat Comms #001","2.534","7.450","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":488},{"label":"Mar","value":450},{"label":"Abr","value":396},{"label":"Mai","value":522},{"label":"Jun","value":309},{"label":"Jul","value":502},{"label":"Ago","value":536},{"label":"Set","value":615},{"label":"Out","value":356},{"label":"Nov","value":476},{"label":"Dez","value":495}];
const MX = 640;
