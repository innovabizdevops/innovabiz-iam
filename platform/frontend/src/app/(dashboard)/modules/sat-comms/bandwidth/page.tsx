...
const KPIS = [{"l":"Total Sat Comms","v":"8.488","t":"+1.6%","d":"up"},{"l":"Bandwidth Ativos","v":"6.888","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"60","t":"-2.7%","d":"down"}];
const COLS = ["ID","Bandwidth","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Comms #001","Sat Comms #002","3.613","8.987","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Comms #002","Sat Comms #003","8.847","3.126","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Comms #003","Sat Comms #004","3.692","516","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Comms #004","Sat Comms #005","7.661","3.545","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Comms #005","Sat Comms #001","1.286","5.045","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":393},{"label":"Fev","value":656},{"label":"Mar","value":644},{"label":"Abr","value":554},{"label":"Mai","value":647},{"label":"Jun","value":503},{"label":"Jul","value":555},{"label":"Ago","value":600},{"label":"Set","value":412},{"label":"Out","value":360},{"label":"Nov","value":483},{"label":"Dez","value":615}];
const MX = 656;
