...
const ACCENT = "#6366f1";
const MODULE = "Marketplace Services";
const PAGE = "Marketplace Hub";
const KPIS = [{"l":"Pedidos/Dia","v":"2757","t":"+10.3%","d":"up"},{"l":"GMV (€)","v":"€95645","t":"-5.3%","d":"down"},{"l":"Conversão (%)","v":"71.3%","t":"+8.7%","d":"up"},{"l":"AOV (€)","v":"€83180","t":"+16.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43101.53","8.493","1.571","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2944.79","2.500","5.304","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 15029.54","8.578","5.097","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 3016.87","6.728","1.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 1793.99","5.272","1.710","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":641},{"label":"Mar","value":542},{"label":"Abr","value":536},{"label":"Mai","value":405},{"label":"Jun","value":689},{"label":"Jul","value":571},{"label":"Ago","value":648},{"label":"Set","value":337},{"label":"Out","value":668},{"label":"Nov","value":338},{"label":"Dez","value":314}];
const MX = 689;
