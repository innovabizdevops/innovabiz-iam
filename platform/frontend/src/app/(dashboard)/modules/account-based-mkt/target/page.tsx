...
const ACCENT = "#6366f1";
const MODULE = "Account-Based Marketing";
const PAGE = "Target";
const KPIS = [{"l":"Total Account Based Mkt","v":"8.725","t":"+9.8%","d":"up"},{"l":"Target Ativos","v":"4.075","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"94","t":"+5.5%","d":"up"}];
const COLS = ["ID","Target","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Account Based Mkt #001","Account Based Mkt #002","3.579","3.674","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Account Based Mkt #002","Account Based Mkt #003","3.387","351","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Account Based Mkt #003","Account Based Mkt #004","1.431","5.741","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Account Based Mkt #004","Account Based Mkt #005","8.282","1.837","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Account Based Mkt #005","Account Based Mkt #001","1.056","2.065","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":487},{"label":"Mar","value":532},{"label":"Abr","value":509},{"label":"Mai","value":531},{"label":"Jun","value":654},{"label":"Jul","value":602},{"label":"Ago","value":554},{"label":"Set","value":629},{"label":"Out","value":351},{"label":"Nov","value":349},{"label":"Dez","value":358}];
const MX = 654;
