...
const PAGE = "Align Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€20780","t":"+7.0%","d":"up"},{"l":"Pipeline (€)","v":"€16386","t":"-0.3%","d":"down"},{"l":"Atingimento Quota (%)","v":"71.9%","t":"+16.6%","d":"up"},{"l":"Win Rate (%)","v":"78.7%","t":"+3.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 42630.35","€ 1590.75","€ 4931.09","72.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 30184.21","€ 48048.59","€ 32704.26","94.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 33506.67","€ 6549.12","€ 35529.08","79.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 28912.16","€ 25796.93","€ 37012.79","86.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 3687.22","€ 44932.06","€ 14345.20","98.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":542},{"label":"Mar","value":839},{"label":"Abr","value":599},{"label":"Mai","value":800},{"label":"Jun","value":663},{"label":"Jul","value":792},{"label":"Ago","value":762},{"label":"Set","value":718},{"label":"Out","value":637},{"label":"Nov","value":629},{"label":"Dez","value":562}];
const MX = 839;
