...
export default function AccountBasedMktPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Account Based Mkt</h1><p className="text-sm text-muted-foreground">Account Based Mkt • iBOS Enterprise</p></div>
