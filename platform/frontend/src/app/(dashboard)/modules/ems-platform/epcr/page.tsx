...
const PAGE = "ePCR";
const KPIS = [{"l":"Formulários Ativos","v":"3.942","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"1975","t":"+11.5%","d":"up"},{"l":"Documentos Gerados","v":"5.227","t":"+13.1%","d":"up"},{"l":"Templates","v":"1.368","t":"+4.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.415","2026-01-27","7.900","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.392","2026-01-07","542","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.154","2026-01-10","4.304","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.613","2026-01-13","7.646","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.851","2026-03-04","2.041","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":465},{"label":"Mar","value":695},{"label":"Abr","value":622},{"label":"Mai","value":625},{"label":"Jun","value":596},{"label":"Jul","value":693},{"label":"Ago","value":502},{"label":"Set","value":770},{"label":"Out","value":674},{"label":"Nov","value":661},{"label":"Dez","value":599}];
const MX = 770;
