...
const ACCENT = "#6366f1";
const MODULE = "EMS Platform";
const PAGE = "Protocol";
const KPIS = [{"l":"Formulários Ativos","v":"633","t":"-3.5%","d":"down"},{"l":"Submissões/Dia","v":"4691","t":"-4.0%","d":"down"},{"l":"Documentos Gerados","v":"6.712","t":"+4.2%","d":"up"},{"l":"Templates","v":"450","t":"+16.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.206","2026-03-13","6.484","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","476","2026-03-22","4.272","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.166","2026-01-16","3.480","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.305","2026-02-04","1.375","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.476","2026-02-02","4.673","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":234},{"label":"Fev","value":510},{"label":"Mar","value":596},{"label":"Abr","value":395},{"label":"Mai","value":336},{"label":"Jun","value":208},{"label":"Jul","value":585},{"label":"Ago","value":326},{"label":"Set","value":438},{"label":"Out","value":349},{"label":"Nov","value":452},{"label":"Dez","value":366}];
const MX = 596;
