...
const PAGE = "Dispatch";
const KPIS = [{"l":"Formulários Ativos","v":"583","t":"-1.2%","d":"down"},{"l":"Submissões/Dia","v":"601","t":"+14.9%","d":"up"},{"l":"Documentos Gerados","v":"3.730","t":"+16.3%","d":"up"},{"l":"Templates","v":"811","t":"+10.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.749","2026-03-18","6.639","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.744","2026-01-24","6.483","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.901","2026-02-17","7.401","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.209","2026-03-19","2.173","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.516","2026-03-24","8.341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":296},{"label":"Mar","value":552},{"label":"Abr","value":471},{"label":"Mai","value":441},{"label":"Jun","value":509},{"label":"Jul","value":345},{"label":"Ago","value":497},{"label":"Set","value":382},{"label":"Out","value":233},{"label":"Nov","value":448},{"label":"Dez","value":392}];
const MX = 552;
