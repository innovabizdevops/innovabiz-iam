...
const PAGE = "Billing";
const KPIS = [{"l":"Formulários Ativos","v":"7.530","t":"+1.3%","d":"up"},{"l":"Submissões/Dia","v":"1079","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"1.654","t":"+4.7%","d":"up"},{"l":"Templates","v":"2.103","t":"+5.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.859","2026-02-26","7.031","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.673","2026-03-09","7.060","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","270","2026-01-03","898","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.241","2026-02-25","2.363","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.711","2026-01-25","6.566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":746},{"label":"Mar","value":596},{"label":"Abr","value":763},{"label":"Mai","value":662},{"label":"Jun","value":600},{"label":"Jul","value":831},{"label":"Ago","value":649},{"label":"Set","value":740},{"label":"Out","value":706},{"label":"Nov","value":433},{"label":"Dez","value":567}];
const MX = 831;
