...
const ACCENT = "#6366f1";
const MODULE = "Workflow Automation";
const PAGE = "CMMN Case Mgmt";
const KPIS = [{"l":"Total Workflow Automation","v":"7.813","t":"+10.9%","d":"up"},{"l":"CMMN Case Mgmt Ativos","v":"2.845","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"81","t":"-0.5%","d":"down"}];
const COLS = ["ID","CMMN Case Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Workflow Automation #001","Workflow Automation #002","2.500","977","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Workflow Automation #002","Workflow Automation #003","1.462","293","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Workflow Automation #003","Workflow Automation #004","802","7.915","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Workflow Automation #004","Workflow Automation #005","7.843","4.119","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Workflow Automation #005","Workflow Automation #001","7.827","3.519","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":758},{"label":"Mar","value":714},{"label":"Abr","value":869},{"label":"Mai","value":728},{"label":"Jun","value":1005},{"label":"Jul","value":744},{"label":"Ago","value":896},{"label":"Set","value":800},{"label":"Out","value":717},{"label":"Nov","value":906},{"label":"Dez","value":779}];
const MX = 1005;
...
export default function CmmnPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>CMMN</span></h1>
                </div>
