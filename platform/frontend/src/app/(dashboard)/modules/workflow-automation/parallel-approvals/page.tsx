...
const PAGE = "Parallel Approvals";
const KPIS = [{"l":"Aprovações Pendentes","v":"2.516","t":"+-0.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.6%","t":"-2.4%","d":"down"},{"l":"Tempo Médio (h)","v":"159h","t":"-1.3%","d":"down"},{"l":"Rejeitadas (%)","v":"76.6%","t":"+4.9%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.660","€ 34561.51","1.264","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.412","€ 3243.55","9.000","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.975","€ 39531.26","1.472","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","427","€ 46320.57","7.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.577","€ 4317.96","7.024","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":382},{"label":"Mar","value":298},{"label":"Abr","value":590},{"label":"Mai","value":508},{"label":"Jun","value":573},{"label":"Jul","value":269},{"label":"Ago","value":256},{"label":"Set","value":484},{"label":"Out","value":540},{"label":"Nov","value":389},{"label":"Dez","value":299}];
const MX = 605;
...
export default function ParallelApprovalsPage() {
    return (
