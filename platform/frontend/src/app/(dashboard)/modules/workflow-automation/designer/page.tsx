...
const PAGE = "Workflow Designer";
const KPIS = [{"l":"Formulários Ativos","v":"4.315","t":"+10.5%","d":"up"},{"l":"Submissões/Dia","v":"2348","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"1.765","t":"+6.3%","d":"up"},{"l":"Templates","v":"6.907","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.291","2026-02-25","336","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","586","2026-02-20","3.174","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.254","2026-01-19","3.929","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.970","2026-02-17","7.711","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.273","2026-01-25","7.451","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":628},{"label":"Mar","value":627},{"label":"Abr","value":430},{"label":"Mai","value":618},{"label":"Jun","value":527},{"label":"Jul","value":610},{"label":"Ago","value":418},{"label":"Set","value":498},{"label":"Out","value":355},{"label":"Nov","value":335},{"label":"Dez","value":272}];
const MX = 656;
