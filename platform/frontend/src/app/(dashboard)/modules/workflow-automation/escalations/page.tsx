...
const KPIS = [{"l":"Notificações Enviadas","v":"4.704","t":"+2.9%","d":"up"},{"l":"Taxa Entrega (%)","v":"88.2%","t":"+0.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"74.1%","t":"+1.0%","d":"up"},{"l":"Escalações","v":"6.137","t":"+14.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.564","95.8%","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.631","91.3%","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.183","91.2%","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.129","83.5%","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.829","98.4%","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":349},{"label":"Mar","value":328},{"label":"Abr","value":698},{"label":"Mai","value":686},{"label":"Jun","value":650},{"label":"Jul","value":595},{"label":"Ago","value":566},{"label":"Set","value":359},{"label":"Out","value":672},{"label":"Nov","value":598},{"label":"Dez","value":625}];
const MX = 698;
