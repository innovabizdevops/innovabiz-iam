...
const KPIS = [{"l":"Aprovações Pendentes","v":"1.689","t":"-4.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"78.3%","t":"+14.9%","d":"up"},{"l":"Tempo Médio (h)","v":"183h","t":"+11.1%","d":"up"},{"l":"Rejeitadas (%)","v":"91.0%","t":"+11.1%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.772","€ 32632.98","3.421","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.008","€ 40884.59","5.242","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","6.177","€ 26733.03","3.231","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","2.108","€ 28071.11","3.919","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","4.665","€ 34698.02","5.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":437},{"label":"Mar","value":593},{"label":"Abr","value":652},{"label":"Mai","value":636},{"label":"Jun","value":657},{"label":"Jul","value":523},{"label":"Ago","value":743},{"label":"Set","value":605},{"label":"Out","value":409},{"label":"Nov","value":402},{"label":"Dez","value":701}];
const MX = 743;
