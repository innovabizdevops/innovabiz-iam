...
const PAGE = "BPMN 2.0 Engine";
const KPIS = [{"l":"Diagramas Criados","v":"6.013","t":"+13.7%","d":"up"},{"l":"Templates","v":"8.727","t":"+2.2%","d":"up"},{"l":"Colaboradores","v":"1.625","t":"-3.3%","d":"down"},{"l":"Comentários/Semana","v":"136","t":"-1.1%","d":"down"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","2.118","2026-02-24","6.671","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","553","2026-01-22","2.192","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","8.986","2026-01-21","3.302","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","1.529","2026-02-13","1.574","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","1.162","2026-02-20","5.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1046},{"label":"Fev","value":869},{"label":"Mar","value":1001},{"label":"Abr","value":830},{"label":"Mai","value":732},{"label":"Jun","value":861},{"label":"Jul","value":710},{"label":"Ago","value":1045},{"label":"Set","value":801},{"label":"Out","value":888},{"label":"Nov","value":859},{"label":"Dez","value":996}];
const MX = 1046;
...
export default function BpmnEnginePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>BPMN</span></h1>
                </div>
