...
const PAGE = "Approval Matrix";
const KPIS = [{"l":"Aprovações Pendentes","v":"2.800","t":"+11.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.4%","t":"-2.1%","d":"down"},{"l":"Tempo Médio (h)","v":"112h","t":"-5.0%","d":"down"},{"l":"Rejeitadas (%)","v":"79.1%","t":"+14.7%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.946","€ 47774.61","5.731","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.000","€ 24411.73","5.657","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","5.354","€ 33435.12","4.697","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.554","€ 34316.79","5.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.419","€ 9233.18","3.532","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":506},{"label":"Mar","value":481},{"label":"Abr","value":820},{"label":"Mai","value":525},{"label":"Jun","value":686},{"label":"Jul","value":687},{"label":"Ago","value":516},{"label":"Set","value":495},{"label":"Out","value":859},{"label":"Nov","value":762},{"label":"Dez","value":493}];
const MX = 859;
...
export default function ApprovalMatrixWorkflowPage() {
    return (
