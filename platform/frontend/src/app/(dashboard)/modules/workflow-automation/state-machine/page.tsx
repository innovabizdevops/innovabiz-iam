...
const PAGE = "State Machine Editor";
const KPIS = [{"l":"Integrações Ativas","v":"4.808","t":"+4.9%","d":"up"},{"l":"Chamadas/Hora","v":"1957","t":"+16.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.7%","t":"+7.4%","d":"up"},{"l":"Latência Média (ms)","v":"71ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.322","1.610","96.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.894","7.422","90.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.530","7.033","91.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.500","3.036","82.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.673","1.378","84.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":505},{"label":"Mar","value":628},{"label":"Abr","value":551},{"label":"Mai","value":373},{"label":"Jun","value":313},{"label":"Jul","value":553},{"label":"Ago","value":400},{"label":"Set","value":581},{"label":"Out","value":291},{"label":"Nov","value":273},{"label":"Dez","value":381}];
const MX = 628;
