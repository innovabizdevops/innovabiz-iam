...
const KPIS = [{"l":"Aprovações Pendentes","v":"1.368","t":"+3.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.0%","t":"+6.7%","d":"up"},{"l":"Tempo Médio (h)","v":"49h","t":"+4.2%","d":"up"},{"l":"Rejeitadas (%)","v":"79.9%","t":"+17.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","5.400","€ 43218.71","1.670","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.835","€ 15007.11","5.412","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","2.501","€ 718.03","3.855","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.366","€ 44542.21","1.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.562","€ 41996.23","3.730","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":879},{"label":"Mar","value":933},{"label":"Abr","value":588},{"label":"Mai","value":942},{"label":"Jun","value":592},{"label":"Jul","value":959},{"label":"Ago","value":796},{"label":"Set","value":847},{"label":"Out","value":934},{"label":"Nov","value":713},{"label":"Dez","value":801}];
const MX = 959;
