...
const PAGE = "Document Understanding AI";
const KPIS = [{"l":"Formulários Ativos","v":"3.784","t":"+2.0%","d":"up"},{"l":"Submissões/Dia","v":"3352","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"4.923","t":"+3.8%","d":"up"},{"l":"Templates","v":"9.035","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.751","2026-02-11","973","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.573","2026-03-10","3.078","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.928","2026-01-18","6.690","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.331","2026-01-13","4.025","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.475","2026-03-26","7.513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":931},{"label":"Mar","value":906},{"label":"Abr","value":561},{"label":"Mai","value":818},{"label":"Jun","value":536},{"label":"Jul","value":558},{"label":"Ago","value":761},{"label":"Set","value":767},{"label":"Out","value":752},{"label":"Nov","value":553},{"label":"Dez","value":727}];
const MX = 931;
