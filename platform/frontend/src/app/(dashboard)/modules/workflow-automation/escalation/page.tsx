...
const KPIS = [{"l":"Notificações Enviadas","v":"8.838","t":"+11.6%","d":"up"},{"l":"Taxa Entrega (%)","v":"87.1%","t":"+4.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"91.5%","t":"+2.9%","d":"up"},{"l":"Escalações","v":"211","t":"+3.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.441","74.3%","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.761","79.8%","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.596","92.7%","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.292","95.9%","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.154","86.6%","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":425},{"label":"Mar","value":223},{"label":"Abr","value":227},{"label":"Mai","value":384},{"label":"Jun","value":310},{"label":"Jul","value":205},{"label":"Ago","value":351},{"label":"Set","value":426},{"label":"Out","value":472},{"label":"Nov","value":431},{"label":"Dez","value":236}];
const MX = 596;
