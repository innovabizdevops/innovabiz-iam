...
const PAGE = "Chatbot Integration";
const KPIS = [{"l":"Integrações Ativas","v":"3.606","t":"+9.8%","d":"up"},{"l":"Chamadas/Hora","v":"4022","t":"+0.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.9%","t":"+1.0%","d":"up"},{"l":"Latência Média (ms)","v":"55ms","t":"+3.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.482","652","99.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.637","7.983","71.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.752","260","89.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.116","1.126","78.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","897","395","90.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":1015},{"label":"Mar","value":1077},{"label":"Abr","value":947},{"label":"Mai","value":683},{"label":"Jun","value":994},{"label":"Jul","value":917},{"label":"Ago","value":1029},{"label":"Set","value":1036},{"label":"Out","value":707},{"label":"Nov","value":891},{"label":"Dez","value":959}];
const MX = 1077;
