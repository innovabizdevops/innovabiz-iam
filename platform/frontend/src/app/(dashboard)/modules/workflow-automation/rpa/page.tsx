...
const PAGE = "RPA Integration";
const KPIS = [{"l":"Integrações Ativas","v":"200","t":"-4.0%","d":"down"},{"l":"Chamadas/Hora","v":"3821","t":"+1.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.4%","t":"+6.2%","d":"up"},{"l":"Latência Média (ms)","v":"187ms","t":"+10.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.460","1.079","73.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.246","4.585","93.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.206","8.740","75.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.526","7.363","88.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.044","649","71.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":571},{"label":"Mar","value":518},{"label":"Abr","value":549},{"label":"Mai","value":690},{"label":"Jun","value":779},{"label":"Jul","value":767},{"label":"Ago","value":600},{"label":"Set","value":703},{"label":"Out","value":752},{"label":"Nov","value":719},{"label":"Dez","value":788}];
const MX = 788;
