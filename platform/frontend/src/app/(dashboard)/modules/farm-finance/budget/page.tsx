...
const PAGE = "Budget";
const KPIS = [{"l":"Total Farm Finance","v":"1.001","t":"-1.9%","d":"down"},{"l":"Budget Ativos","v":"€85420","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+17.2%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Finance #001","€ 20274.54","5.851","257","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Finance #002","€ 46026.05","3.783","2.302","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Finance #003","€ 21771.54","5.941","5.841","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Finance #004","€ 46284.81","8.133","7.486","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Finance #005","€ 36252.08","5.522","7.890","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":393},{"label":"Mar","value":408},{"label":"Abr","value":534},{"label":"Mai","value":451},{"label":"Jun","value":661},{"label":"Jul","value":419},{"label":"Ago","value":428},{"label":"Set","value":656},{"label":"Out","value":426},{"label":"Nov","value":494},{"label":"Dez","value":597}];
const MX = 675;
