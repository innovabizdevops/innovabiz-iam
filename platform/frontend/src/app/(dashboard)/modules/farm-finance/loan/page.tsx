...
const PAGE = "Loan";
const KPIS = [{"l":"Total Farm Finance","v":"5.000","t":"+2.4%","d":"up"},{"l":"Loan Ativos","v":"5.875","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.3%","d":"up"}];
const COLS = ["ID","Loan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Finance #001","Farm Finance #002","2.251","8.933","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Finance #002","Farm Finance #003","1.441","3.705","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Finance #003","Farm Finance #004","6.843","4.415","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Finance #004","Farm Finance #005","7.608","2.296","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Finance #005","Farm Finance #001","1.549","526","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":989},{"label":"Mar","value":1071},{"label":"Abr","value":954},{"label":"Mai","value":744},{"label":"Jun","value":915},{"label":"Jul","value":747},{"label":"Ago","value":691},{"label":"Set","value":919},{"label":"Out","value":971},{"label":"Nov","value":929},{"label":"Dez","value":810}];
const MX = 1071;
