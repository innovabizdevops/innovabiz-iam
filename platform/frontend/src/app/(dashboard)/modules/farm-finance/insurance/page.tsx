...
const ACCENT = "#6366f1";
const MODULE = "Farm Finance";
const PAGE = "Insurance";
const KPIS = [{"l":"Total Farm Finance","v":"3.394","t":"-0.3%","d":"down"},{"l":"Insurance Ativos","v":"8.358","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"59","t":"-1.2%","d":"down"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Finance #001","Farm Finance #002","4.685","1.454","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Finance #002","Farm Finance #003","5.485","6.689","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Finance #003","Farm Finance #004","7.934","1.964","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Finance #004","Farm Finance #005","8.246","479","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Finance #005","Farm Finance #001","7.319","7.378","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":369},{"label":"Mar","value":572},{"label":"Abr","value":491},{"label":"Mai","value":585},{"label":"Jun","value":535},{"label":"Jul","value":600},{"label":"Ago","value":494},{"label":"Set","value":300},{"label":"Out","value":483},{"label":"Nov","value":575},{"label":"Dez","value":289}];
const MX = 600;
