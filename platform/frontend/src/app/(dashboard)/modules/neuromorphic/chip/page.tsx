...
const ACCENT = "#dc2626";
const MODULE = "Neuromorphic Computing";
const PAGE = "Chip Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.790","t":"+2.9%","d":"up"},{"l":"Submissões/Dia","v":"899","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"2.739","t":"+5.4%","d":"up"},{"l":"Templates","v":"8.796","t":"+13.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.034","2026-01-20","6.950","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","280","2026-02-17","6.234","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.052","2026-02-05","4.257","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.743","2026-01-15","2.016","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","544","2026-01-02","6.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":683},{"label":"Mar","value":781},{"label":"Abr","value":564},{"label":"Mai","value":526},{"label":"Jun","value":534},{"label":"Jul","value":582},{"label":"Ago","value":631},{"label":"Set","value":529},{"label":"Out","value":480},{"label":"Nov","value":653},{"label":"Dez","value":569}];
const MX = 781;
