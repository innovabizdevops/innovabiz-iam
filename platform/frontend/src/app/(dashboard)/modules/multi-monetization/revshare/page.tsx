...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Monetization Engine";
const PAGE = "Revenue Share";
const KPIS = [{"l":"ARR (€M)","v":"€17.3M","t":"-3.9%","d":"down"},{"l":"MRR (€)","v":"€97285","t":"+2.3%","d":"up"},{"l":"Churn (%)","v":"79.1%","t":"-1.6%","d":"down"},{"l":"ARPU (€)","v":"€22473","t":"+11.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18636.36","3.195","€ 36121.34","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4606.61","7.366","€ 38533.44","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46630.46","3.531","€ 16655.67","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 39406.97","910","€ 26986.24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42960.99","4.927","€ 6148.82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":584},{"label":"Mar","value":611},{"label":"Abr","value":325},{"label":"Mai","value":668},{"label":"Jun","value":577},{"label":"Jul","value":527},{"label":"Ago","value":641},{"label":"Set","value":345},{"label":"Out","value":604},{"label":"Nov","value":470},{"label":"Dez","value":624}];
const MX = 668;
