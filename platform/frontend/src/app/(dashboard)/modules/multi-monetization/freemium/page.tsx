...
const PAGE = "Freemium";
const KPIS = [{"l":"ARR (€M)","v":"€10.7M","t":"-3.5%","d":"down"},{"l":"MRR (€)","v":"€47503","t":"+9.8%","d":"up"},{"l":"Churn (%)","v":"76.6%","t":"+-0.0%","d":"up"},{"l":"ARPU (€)","v":"€85342","t":"+12.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26166.91","4.176","€ 21859.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 16240.05","2.585","€ 27418.68","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 34217.47","7.611","€ 30529.48","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1064.10","6.192","€ 42313.98","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 15773.12","7.301","€ 26508.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":1001},{"label":"Mar","value":907},{"label":"Abr","value":989},{"label":"Mai","value":860},{"label":"Jun","value":950},{"label":"Jul","value":920},{"label":"Ago","value":716},{"label":"Set","value":656},{"label":"Out","value":788},{"label":"Nov","value":970},{"label":"Dez","value":853}];
const MX = 1001;
