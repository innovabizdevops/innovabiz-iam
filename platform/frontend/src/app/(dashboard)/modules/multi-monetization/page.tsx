...
/* ═══ Multi-Monetization Engine — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "952", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2676", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€361K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1831085052", cells: ["MUL-9052", "Multi-Monetization Engine Item 1", "21/1/2026", "€35 152"], status: "active" as const },
    { id: "1831088623", cells: ["MUL-3623", "Multi-Monetization Engine Item 2", "8/8/2026", "€38 723"], status: "pending" as const },
    { id: "1831092194", cells: ["MUL-7194", "Multi-Monetization Engine Item 3", "23/3/2026", "€42 294"], status: "completed" as const },
    { id: "1831095765", cells: ["MUL-1765", "Multi-Monetization Engine Item 4", "10/10/2026", "€45 865"], status: "warning" as const },
    { id: "1831099336", cells: ["MUL-5336", "Multi-Monetization Engine Item 5", "25/5/2026", "€49 436"], status: "active" as const },
];
...
export default function MultimonetizationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Monetization Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Monetization Engine</p>
                    </div>
                </div>
