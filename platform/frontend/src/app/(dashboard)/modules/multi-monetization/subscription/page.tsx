...
const KPIS = [{"l":"ARR (€M)","v":"€28.9M","t":"+16.7%","d":"up"},{"l":"MRR (€)","v":"€47184","t":"+2.1%","d":"up"},{"l":"Churn (%)","v":"92.2%","t":"-2.9%","d":"down"},{"l":"ARPU (€)","v":"€98212","t":"+5.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2463.87","7.546","€ 16234.12","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 48493.86","7.215","€ 40110.63","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40208.16","8.470","€ 26399.31","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45635.75","6.380","€ 22959.59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1307.43","1.757","€ 31243.37","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":656},{"label":"Mar","value":464},{"label":"Abr","value":669},{"label":"Mai","value":352},{"label":"Jun","value":342},{"label":"Jul","value":472},{"label":"Ago","value":660},{"label":"Set","value":461},{"label":"Out","value":567},{"label":"Nov","value":486},{"label":"Dez","value":638}];
const MX = 669;
