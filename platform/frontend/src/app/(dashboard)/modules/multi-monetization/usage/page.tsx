...
const PAGE = "Usage";
const KPIS = [{"l":"ARR (€M)","v":"€43.2M","t":"-6.0%","d":"down"},{"l":"MRR (€)","v":"€1697","t":"+13.2%","d":"up"},{"l":"Churn (%)","v":"74.2%","t":"+14.9%","d":"up"},{"l":"ARPU (€)","v":"€65216","t":"+5.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32796.20","4.787","€ 25810.15","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17282.24","7.410","€ 24436.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 35613.84","2.363","€ 49931.47","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7600.97","515","€ 21114.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 27977.10","4.738","€ 3885.41","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":645},{"label":"Mar","value":454},{"label":"Abr","value":624},{"label":"Mai","value":457},{"label":"Jun","value":599},{"label":"Jul","value":709},{"label":"Ago","value":337},{"label":"Set","value":640},{"label":"Out","value":550},{"label":"Nov","value":603},{"label":"Dez","value":601}];
const MX = 709;
