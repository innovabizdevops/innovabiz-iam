...
/* ═══ Equestrian Management — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "996", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1143", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€140K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1471041896", cells: ["EQU-1896", "Equestrian Management Item 1", "17/9/2026", "€41 996"], status: "active" as const },
    { id: "1471045467", cells: ["EQU-5467", "Equestrian Management Item 2", "4/4/2026", "€45 567"], status: "pending" as const },
    { id: "1471049038", cells: ["EQU-9038", "Equestrian Management Item 3", "19/11/2026", "€49 138"], status: "completed" as const },
    { id: "1471052609", cells: ["EQU-3609", "Equestrian Management Item 4", "6/6/2026", "€2709"], status: "warning" as const },
    { id: "1471056180", cells: ["EQU-7180", "Equestrian Management Item 5", "21/1/2026", "€6280"], status: "active" as const },
];
...
export default function EquestrianManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Equestrian Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Equestrian Management</p>
                    </div>
                </div>
