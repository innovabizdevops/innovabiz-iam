...
const ACCENT = "#b91c1c";
const MODULE = "Equestrian Management";
const PAGE = "Stable";
const KPIS = [{"l":"Total Equestrian","v":"5.946","t":"-0.7%","d":"down"},{"l":"Stable Ativos","v":"503","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"58","t":"+6.8%","d":"up"}];
const COLS = ["ID","Stable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Equestrian #001","Equestrian #002","1.095","3.379","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Equestrian #002","Equestrian #003","3.407","1.182","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Equestrian #003","Equestrian #004","1.798","2.780","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Equestrian #004","Equestrian #005","7.051","5.366","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Equestrian #005","Equestrian #001","4.599","8.867","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":503},{"label":"Mar","value":643},{"label":"Abr","value":384},{"label":"Mai","value":343},{"label":"Jun","value":453},{"label":"Jul","value":469},{"label":"Ago","value":456},{"label":"Set","value":445},{"label":"Out","value":338},{"label":"Nov","value":620},{"label":"Dez","value":400}];
const MX = 643;
