...
const PAGE = "Horse";
const KPIS = [{"l":"Total Equestrian","v":"6.021","t":"+14.6%","d":"up"},{"l":"Horse Ativos","v":"8.604","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"60","t":"+6.3%","d":"up"}];
const COLS = ["ID","Horse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Equestrian #001","Equestrian #002","1.800","5.098","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Equestrian #002","Equestrian #003","4.822","8.656","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Equestrian #003","Equestrian #004","358","1.380","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Equestrian #004","Equestrian #005","1.540","6.791","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Equestrian #005","Equestrian #001","1.485","6.223","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":957},{"label":"Mar","value":601},{"label":"Abr","value":595},{"label":"Mai","value":781},{"label":"Jun","value":860},{"label":"Jul","value":611},{"label":"Ago","value":704},{"label":"Set","value":720},{"label":"Out","value":733},{"label":"Nov","value":566},{"label":"Dez","value":910}];
const MX = 957;
