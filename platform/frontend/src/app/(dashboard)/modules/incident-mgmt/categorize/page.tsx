...
const KPIS = [{"l":"Tickets Abertos","v":"4.303","t":"+2.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"74.5%","t":"-1.7%","d":"down"},{"l":"MTTR (h)","v":"149h","t":"+12.6%","d":"up"},{"l":"Satisfação (%)","v":"84.3%","t":"+13.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.261","5.106","4.220","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.256","2.775","3.816","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.663","6.754","1.261","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.677","6.519","6.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.069","7.346","7.742","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":585},{"label":"Mar","value":784},{"label":"Abr","value":942},{"label":"Mai","value":590},{"label":"Jun","value":815},{"label":"Jul","value":581},{"label":"Ago","value":701},{"label":"Set","value":732},{"label":"Out","value":749},{"label":"Nov","value":670},{"label":"Dez","value":913}];
const MX = 942;
