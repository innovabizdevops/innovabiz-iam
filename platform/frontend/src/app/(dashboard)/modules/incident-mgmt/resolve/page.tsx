...
const PAGE = "Resolve";
const KPIS = [{"l":"Tickets Abertos","v":"2.493","t":"+3.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.2%","t":"+6.1%","d":"up"},{"l":"MTTR (h)","v":"34h","t":"+5.4%","d":"up"},{"l":"Satisfação (%)","v":"88.3%","t":"+10.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.991","8.280","5.771","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","742","8.943","2.602","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.714","468","6.474","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.178","717","5.017","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","886","3.119","3.075","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1019},{"label":"Fev","value":1006},{"label":"Mar","value":808},{"label":"Abr","value":726},{"label":"Mai","value":1006},{"label":"Jun","value":703},{"label":"Jul","value":1034},{"label":"Ago","value":888},{"label":"Set","value":890},{"label":"Out","value":861},{"label":"Nov","value":981},{"label":"Dez","value":1026}];
const MX = 1034;
