...
const ACCENT = "#94a3b8";
const MODULE = "Incident Management (ITIL)";
const PAGE = "Detect";
const KPIS = [{"l":"Tickets Abertos","v":"5.335","t":"+15.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.4%","t":"+17.2%","d":"up"},{"l":"MTTR (h)","v":"158h","t":"+8.9%","d":"up"},{"l":"Satisfação (%)","v":"76.1%","t":"+1.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.353","3.880","1.879","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.365","3.075","8.761","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.531","2.456","1.221","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.366","6.382","4.145","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.983","6.320","5.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":301},{"label":"Mar","value":616},{"label":"Abr","value":581},{"label":"Mai","value":422},{"label":"Jun","value":512},{"label":"Jul","value":443},{"label":"Ago","value":412},{"label":"Set","value":560},{"label":"Out","value":537},{"label":"Nov","value":590},{"label":"Dez","value":647}];
const MX = 647;
