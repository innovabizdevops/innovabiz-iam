...
/* ═══ Incident Management (ITIL) — Dashboard ═══ */

const ACCENT = "#94a3b8";

const KPIS = [
    { label: "Total Registos", value: "6997", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3621", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€436K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1251297597", cells: ["INC-1597", "Incident Management (ITIL) Item 1", "26/10/2026", "€47 697"], status: "active" as const },
    { id: "1251301168", cells: ["INC-5168", "Incident Management (ITIL) Item 2", "13/5/2026", "€1268"], status: "pending" as const },
    { id: "1251304739", cells: ["INC-8739", "Incident Management (ITIL) Item 3", "28/12/2026", "€4839"], status: "completed" as const },
    { id: "1251308310", cells: ["INC-3310", "Incident Management (ITIL) Item 4", "15/7/2026", "€8410"], status: "warning" as const },
    { id: "1251311881", cells: ["INC-6881", "Incident Management (ITIL) Item 5", "2/2/2026", "€11 981"], status: "active" as const },
];
...
export default function IncidentManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Incident Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Incident Management (ITIL)</p>
                    </div>
                </div>
