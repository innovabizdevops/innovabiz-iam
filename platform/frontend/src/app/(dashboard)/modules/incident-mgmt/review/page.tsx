...
const PAGE = "Review";
const KPIS = [{"l":"Tickets Abertos","v":"1.566","t":"-5.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"93.0%","t":"+12.1%","d":"up"},{"l":"MTTR (h)","v":"61h","t":"-5.9%","d":"down"},{"l":"Satisfação (%)","v":"76.5%","t":"+6.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.713","3.840","2.976","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.792","8.582","6.672","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","9.096","4.424","4.446","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.056","7.590","7.938","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.434","2.499","7.131","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":486},{"label":"Mar","value":560},{"label":"Abr","value":449},{"label":"Mai","value":375},{"label":"Jun","value":503},{"label":"Jul","value":287},{"label":"Ago","value":344},{"label":"Set","value":472},{"label":"Out","value":294},{"label":"Nov","value":461},{"label":"Dez","value":591}];
const MX = 591;
