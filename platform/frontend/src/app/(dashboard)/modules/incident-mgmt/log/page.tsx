...
const PAGE = "Log";
const KPIS = [{"l":"Tickets Abertos","v":"3.712","t":"+17.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.9%","t":"+14.8%","d":"up"},{"l":"MTTR (h)","v":"20h","t":"+12.7%","d":"up"},{"l":"Satisfação (%)","v":"81.5%","t":"+16.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.577","6.427","8.852","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","267","8.517","1.960","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.696","555","762","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.544","2.588","1.965","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.891","3.617","360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":522},{"label":"Mar","value":684},{"label":"Abr","value":730},{"label":"Mai","value":485},{"label":"Jun","value":432},{"label":"Jul","value":675},{"label":"Ago","value":769},{"label":"Set","value":525},{"label":"Out","value":473},{"label":"Nov","value":720},{"label":"Dez","value":571}];
const MX = 769;
