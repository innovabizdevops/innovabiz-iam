...
const PAGE = "Fan";
const KPIS = [{"l":"Formulários Ativos","v":"6.632","t":"+16.4%","d":"up"},{"l":"Submissões/Dia","v":"1309","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"1.635","t":"+10.9%","d":"up"},{"l":"Templates","v":"2.555","t":"+10.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.206","2026-03-23","4.911","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.632","2026-02-10","6.381","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.465","2026-01-12","1.363","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.669","2026-03-06","1.207","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.514","2026-02-28","5.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":689},{"label":"Mar","value":582},{"label":"Abr","value":615},{"label":"Mai","value":740},{"label":"Jun","value":667},{"label":"Jul","value":928},{"label":"Ago","value":640},{"label":"Set","value":572},{"label":"Out","value":588},{"label":"Nov","value":765},{"label":"Dez","value":807}];
const MX = 928;
