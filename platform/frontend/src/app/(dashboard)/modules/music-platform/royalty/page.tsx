...
const PAGE = "Royalty";
const KPIS = [{"l":"Formulários Ativos","v":"5.347","t":"-1.5%","d":"down"},{"l":"Submissões/Dia","v":"3245","t":"+0.8%","d":"up"},{"l":"Documentos Gerados","v":"1.889","t":"-0.6%","d":"down"},{"l":"Templates","v":"3.134","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","788","2026-02-20","6.136","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.964","2026-02-05","6.489","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.085","2026-01-28","2.359","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.766","2026-03-27","195","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","877","2026-02-13","7.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":958},{"label":"Mar","value":872},{"label":"Abr","value":636},{"label":"Mai","value":716},{"label":"Jun","value":971},{"label":"Jul","value":719},{"label":"Ago","value":758},{"label":"Set","value":748},{"label":"Out","value":747},{"label":"Nov","value":832},{"label":"Dez","value":596}];
const MX = 971;
