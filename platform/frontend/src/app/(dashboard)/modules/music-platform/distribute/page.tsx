...
const ACCENT = "#6d28d9";
const MODULE = "Music Industry Platform";
const PAGE = "Distribute";
const KPIS = [{"l":"Formulários Ativos","v":"5.459","t":"+8.8%","d":"up"},{"l":"Submissões/Dia","v":"705","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"1.469","t":"+10.2%","d":"up"},{"l":"Templates","v":"8.000","t":"+4.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.675","2026-02-13","5.548","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.460","2026-02-22","8.788","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.204","2026-03-21","8.473","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.897","2026-02-22","6.766","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.576","2026-02-03","2.749","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":901},{"label":"Mar","value":618},{"label":"Abr","value":908},{"label":"Mai","value":880},{"label":"Jun","value":625},{"label":"Jul","value":750},{"label":"Ago","value":836},{"label":"Set","value":633},{"label":"Out","value":673},{"label":"Nov","value":888},{"label":"Dez","value":854}];
const MX = 908;
