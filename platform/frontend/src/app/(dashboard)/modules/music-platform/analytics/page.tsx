...
const KPIS = [{"l":"Formulários Ativos","v":"5.743","t":"-1.9%","d":"down"},{"l":"Submissões/Dia","v":"1294","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"6.095","t":"-4.5%","d":"down"},{"l":"Templates","v":"6.423","t":"-3.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.147","2026-02-04","1.985","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.084","2026-01-18","2.121","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.601","2026-01-14","5.437","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.308","2026-02-09","8.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.325","2026-02-06","1.533","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":485},{"label":"Mar","value":464},{"label":"Abr","value":779},{"label":"Mai","value":827},{"label":"Jun","value":479},{"label":"Jul","value":620},{"label":"Ago","value":489},{"label":"Set","value":567},{"label":"Out","value":662},{"label":"Nov","value":582},{"label":"Dez","value":656}];
const MX = 827;
