...
/* ═══ Music Industry Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "8290", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4694", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€338K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "627777090", cells: ["MUS-1090", "Music Industry Platform Item 1", "11/7/2026", "€27 190"], status: "active" as const },
    { id: "627780661", cells: ["MUS-4661", "Music Industry Platform Item 2", "26/2/2026", "€30 761"], status: "pending" as const },
    { id: "627784232", cells: ["MUS-8232", "Music Industry Platform Item 3", "13/9/2026", "€34 332"], status: "completed" as const },
    { id: "627787803", cells: ["MUS-2803", "Music Industry Platform Item 4", "28/4/2026", "€37 903"], status: "warning" as const },
    { id: "627791374", cells: ["MUS-6374", "Music Industry Platform Item 5", "15/11/2026", "€41 474"], status: "active" as const },
];
...
export default function MusicIndustryPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Music Industry Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Music Industry Platform</p>
                    </div>
                </div>
