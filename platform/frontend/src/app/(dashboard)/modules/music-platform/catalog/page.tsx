...
const PAGE = "Catalog";
const KPIS = [{"l":"Formulários Ativos","v":"3.938","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"4055","t":"-1.3%","d":"down"},{"l":"Documentos Gerados","v":"1.459","t":"-0.6%","d":"down"},{"l":"Templates","v":"1.334","t":"+10.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.660","2026-03-11","3.922","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.035","2026-03-08","2.538","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.226","2026-02-14","146","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.265","2026-03-10","1.840","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.437","2026-03-12","171","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":670},{"label":"Mar","value":391},{"label":"Abr","value":518},{"label":"Mai","value":580},{"label":"Jun","value":558},{"label":"Jul","value":682},{"label":"Ago","value":695},{"label":"Set","value":541},{"label":"Out","value":426},{"label":"Nov","value":575},{"label":"Dez","value":443}];
const MX = 695;
