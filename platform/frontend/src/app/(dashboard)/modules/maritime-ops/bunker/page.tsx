...
const PAGE = "Bunker";
const KPIS = [{"l":"Total Maritime Ops","v":"119","t":"+17.4%","d":"up"},{"l":"Bunker Ativos","v":"720","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"62","t":"+13.5%","d":"up"}];
const COLS = ["ID","Bunker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Ops #001","Maritime Ops #002","133","2.387","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Ops #002","Maritime Ops #003","265","6.707","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Ops #003","Maritime Ops #004","5.395","2.765","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Ops #004","Maritime Ops #005","614","227","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Ops #005","Maritime Ops #001","3.336","2.850","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":439},{"label":"Mar","value":776},{"label":"Abr","value":492},{"label":"Mai","value":444},{"label":"Jun","value":478},{"label":"Jul","value":455},{"label":"Ago","value":400},{"label":"Set","value":793},{"label":"Out","value":504},{"label":"Nov","value":567},{"label":"Dez","value":470}];
const MX = 793;
