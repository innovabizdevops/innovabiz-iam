...
/* ═══ Maritime Operations Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "9432", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3168", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€83K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1116551132", cells: ["MAR-3132", "Maritime Operations Platform Item 1", "5/9/2026", "€1232"], status: "active" as const },
    { id: "1116554703", cells: ["MAR-6703", "Maritime Operations Platform Item 2", "20/4/2026", "€4803"], status: "pending" as const },
    { id: "1116558274", cells: ["MAR-1274", "Maritime Operations Platform Item 3", "7/11/2026", "€8374"], status: "completed" as const },
    { id: "1116561845", cells: ["MAR-4845", "Maritime Operations Platform Item 4", "22/6/2026", "€11 945"], status: "warning" as const },
    { id: "1116565416", cells: ["MAR-8416", "Maritime Operations Platform Item 5", "9/1/2026", "€15 516"], status: "active" as const },
];
...
export default function MaritimeOperationsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maritime Operations Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Maritime Operations Platform</p>
                    </div>
                </div>
