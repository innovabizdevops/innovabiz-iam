...
const PAGE = "Crew";
const KPIS = [{"l":"Total Maritime Ops","v":"1.080","t":"-2.5%","d":"down"},{"l":"Crew Ativos","v":"5.074","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"65.0%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+17.7%","d":"up"}];
const COLS = ["ID","Crew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Ops #001","Maritime Ops #002","2.438","210","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Ops #002","Maritime Ops #003","9.018","4.498","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Ops #003","Maritime Ops #004","6.397","2.996","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Ops #004","Maritime Ops #005","8.845","8.023","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Ops #005","Maritime Ops #001","3.863","8.769","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":812},{"label":"Mar","value":753},{"label":"Abr","value":882},{"label":"Mai","value":849},{"label":"Jun","value":844},{"label":"Jul","value":672},{"label":"Ago","value":943},{"label":"Set","value":1044},{"label":"Out","value":671},{"label":"Nov","value":775},{"label":"Dez","value":985}];
const MX = 1044;
