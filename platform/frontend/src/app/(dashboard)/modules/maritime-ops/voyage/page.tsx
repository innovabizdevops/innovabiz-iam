...
const ACCENT = "#1e3a5f";
const MODULE = "Maritime Operations Platform";
const PAGE = "Voyage";
const KPIS = [{"l":"Total Maritime Ops","v":"5.629","t":"+1.0%","d":"up"},{"l":"Voyage Ativos","v":"6.107","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"68.9%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+0.6%","d":"up"}];
const COLS = ["ID","Voyage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Maritime Ops #001","Maritime Ops #002","2.057","3.009","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Maritime Ops #002","Maritime Ops #003","8.905","3.097","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Maritime Ops #003","Maritime Ops #004","8.317","7.987","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Maritime Ops #004","Maritime Ops #005","3.326","6.772","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Maritime Ops #005","Maritime Ops #001","5.848","7.837","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":626},{"label":"Mar","value":611},{"label":"Abr","value":804},{"label":"Mai","value":716},{"label":"Jun","value":639},{"label":"Jul","value":531},{"label":"Ago","value":606},{"label":"Set","value":769},{"label":"Out","value":453},{"label":"Nov","value":476},{"label":"Dez","value":675}];
const MX = 804;
