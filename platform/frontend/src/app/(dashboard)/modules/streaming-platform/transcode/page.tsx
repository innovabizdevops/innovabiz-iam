...
const PAGE = "Transcode";
const KPIS = [{"l":"Formulários Ativos","v":"8.946","t":"+12.7%","d":"up"},{"l":"Submissões/Dia","v":"3066","t":"+3.3%","d":"up"},{"l":"Documentos Gerados","v":"1.625","t":"+13.6%","d":"up"},{"l":"Templates","v":"5.638","t":"+9.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.872","2026-03-01","8.186","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","238","2026-01-09","8.096","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.628","2026-02-10","5.752","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.413","2026-02-23","7.060","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.150","2026-01-07","7.616","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":519},{"label":"Mar","value":670},{"label":"Abr","value":818},{"label":"Mai","value":765},{"label":"Jun","value":471},{"label":"Jul","value":665},{"label":"Ago","value":712},{"label":"Set","value":447},{"label":"Out","value":483},{"label":"Nov","value":439},{"label":"Dez","value":556}];
const MX = 818;
