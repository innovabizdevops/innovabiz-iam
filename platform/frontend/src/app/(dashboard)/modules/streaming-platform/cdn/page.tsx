...
const PAGE = "CDN";
const KPIS = [{"l":"Formulários Ativos","v":"3.331","t":"+7.2%","d":"up"},{"l":"Submissões/Dia","v":"2244","t":"+3.7%","d":"up"},{"l":"Documentos Gerados","v":"4.713","t":"+12.7%","d":"up"},{"l":"Templates","v":"6.967","t":"+0.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.169","2026-01-27","4.342","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.045","2026-01-24","3.297","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.489","2026-01-03","3.552","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.069","2026-02-22","3.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.121","2026-01-28","4.147","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":472},{"label":"Mar","value":540},{"label":"Abr","value":366},{"label":"Mai","value":524},{"label":"Jun","value":428},{"label":"Jul","value":690},{"label":"Ago","value":339},{"label":"Set","value":393},{"label":"Out","value":635},{"label":"Nov","value":432},{"label":"Dez","value":671}];
const MX = 690;
