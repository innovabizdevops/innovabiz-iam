...
const PAGE = "Catalog";
const KPIS = [{"l":"Formulários Ativos","v":"1.290","t":"-3.9%","d":"down"},{"l":"Submissões/Dia","v":"1271","t":"+7.8%","d":"up"},{"l":"Documentos Gerados","v":"2.817","t":"+12.6%","d":"up"},{"l":"Templates","v":"5.523","t":"+8.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.210","2026-01-23","3.157","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.893","2026-03-01","1.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.086","2026-02-01","2.971","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.929","2026-03-02","8.360","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.030","2026-01-21","3.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":802},{"label":"Mar","value":1038},{"label":"Abr","value":895},{"label":"Mai","value":738},{"label":"Jun","value":851},{"label":"Jul","value":843},{"label":"Ago","value":923},{"label":"Set","value":887},{"label":"Out","value":664},{"label":"Nov","value":848},{"label":"Dez","value":943}];
const MX = 1038;
