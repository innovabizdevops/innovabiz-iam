...
const ACCENT = "#6366f1";
const MODULE = "Streaming Platform";
const PAGE = "Recommend";
const KPIS = [{"l":"Formulários Ativos","v":"5.936","t":"+-0.0%","d":"up"},{"l":"Submissões/Dia","v":"4767","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"985","t":"+17.5%","d":"up"},{"l":"Templates","v":"9.030","t":"-0.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.879","2026-02-19","4.687","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.596","2026-01-17","3.350","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.033","2026-01-01","6.997","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","473","2026-02-18","4.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.183","2026-03-02","6.554","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":725},{"label":"Mar","value":608},{"label":"Abr","value":713},{"label":"Mai","value":942},{"label":"Jun","value":748},{"label":"Jul","value":726},{"label":"Ago","value":934},{"label":"Set","value":761},{"label":"Out","value":620},{"label":"Nov","value":980},{"label":"Dez","value":744}];
const MX = 980;
