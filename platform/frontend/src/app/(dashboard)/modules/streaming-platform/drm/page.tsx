...
const PAGE = "DRM";
const KPIS = [{"l":"Formulários Ativos","v":"319","t":"+1.5%","d":"up"},{"l":"Submissões/Dia","v":"4319","t":"+1.9%","d":"up"},{"l":"Documentos Gerados","v":"971","t":"-2.4%","d":"down"},{"l":"Templates","v":"7.712","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.203","2026-03-24","3.671","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.764","2026-01-12","7.697","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.622","2026-03-09","5.388","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.074","2026-03-25","710","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.048","2026-03-15","7.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":495},{"label":"Mar","value":712},{"label":"Abr","value":875},{"label":"Mai","value":595},{"label":"Jun","value":660},{"label":"Jul","value":766},{"label":"Ago","value":659},{"label":"Set","value":875},{"label":"Out","value":574},{"label":"Nov","value":860},{"label":"Dez","value":872}];
const MX = 875;
