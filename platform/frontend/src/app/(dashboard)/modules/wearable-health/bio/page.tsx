...
const PAGE = "Bio Data";
const KPIS = [{"l":"Total Wearable Health","v":"495","t":"+11.8%","d":"up"},{"l":"Bio Data Ativos","v":"2.446","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.1%","d":"up"}];
const COLS = ["ID","Bio Data","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wearable Health #001","2026-01-21","1.389","6.493","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Wearable Health #002","2026-01-18","959","1.934","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Wearable Health #003","2026-02-08","5.343","6.676","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Wearable Health #004","2026-01-14","5.534","7.344","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wearable Health #005","2026-03-13","4.628","3.190","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":584},{"label":"Mar","value":655},{"label":"Abr","value":561},{"label":"Mai","value":650},{"label":"Jun","value":822},{"label":"Jul","value":665},{"label":"Ago","value":914},{"label":"Set","value":602},{"label":"Out","value":745},{"label":"Nov","value":566},{"label":"Dez","value":897}];
const MX = 914;
