...
const ACCENT = "#6366f1";
const MODULE = "Wearable Health";
const PAGE = "Insights";
const KPIS = [{"l":"Total Wearable Health","v":"5.585","t":"+4.2%","d":"up"},{"l":"Insights Ativos","v":"4.593","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"81","t":"+12.3%","d":"up"}];
const COLS = ["ID","Insights","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wearable Health #001","Wearable Health #002","6.188","4.568","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Wearable Health #002","Wearable Health #003","3.230","3.614","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Wearable Health #003","Wearable Health #004","6.254","3.284","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Wearable Health #004","Wearable Health #005","6.696","1.436","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wearable Health #005","Wearable Health #001","2.480","5.263","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":815},{"label":"Mar","value":887},{"label":"Abr","value":722},{"label":"Mai","value":679},{"label":"Jun","value":881},{"label":"Jul","value":856},{"label":"Ago","value":756},{"label":"Set","value":694},{"label":"Out","value":907},{"label":"Nov","value":748},{"label":"Dez","value":542}];
const MX = 907;
