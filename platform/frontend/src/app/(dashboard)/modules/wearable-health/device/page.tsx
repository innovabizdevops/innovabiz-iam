...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"583","t":"+13.1%","d":"up"},{"l":"Dados/Min (MB)","v":"8.938","t":"+12.7%","d":"up"},{"l":"Alertas Ativos","v":"3.149","t":"-0.4%","d":"down"},{"l":"Uptime (%)","v":"93.6%","t":"-3.6%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.330","5.165","6.266","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.582","7.144","5.877","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.298","1.143","332","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.930","1.882","6.183","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.678","4.813","7.455","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":583},{"label":"Mar","value":510},{"label":"Abr","value":560},{"label":"Mai","value":425},{"label":"Jun","value":607},{"label":"Jul","value":493},{"label":"Ago","value":453},{"label":"Set","value":591},{"label":"Out","value":489},{"label":"Nov","value":386},{"label":"Dez","value":360}];
const MX = 607;
