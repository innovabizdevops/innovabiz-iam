...
export default function WearableHealthPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Wearable Health</h1><p className="text-sm text-muted-foreground">Wearable Health • iBOS Enterprise</p></div>
