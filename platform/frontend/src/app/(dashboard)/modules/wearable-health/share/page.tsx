...
const PAGE = "Share";
const KPIS = [{"l":"Total Wearable Health","v":"2.821","t":"-3.3%","d":"down"},{"l":"Share Ativos","v":"5.808","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"61","t":"+3.9%","d":"up"}];
const COLS = ["ID","Share","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wearable Health #001","Wearable Health #002","4.495","1.031","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Wearable Health #002","Wearable Health #003","6.877","3.384","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Wearable Health #003","Wearable Health #004","3.249","3.193","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Wearable Health #004","Wearable Health #005","6.010","8.059","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wearable Health #005","Wearable Health #001","5.744","1.782","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":571},{"label":"Mar","value":446},{"label":"Abr","value":704},{"label":"Mai","value":487},{"label":"Jun","value":684},{"label":"Jul","value":630},{"label":"Ago","value":452},{"label":"Set","value":324},{"label":"Out","value":400},{"label":"Nov","value":431},{"label":"Dez","value":364}];
const MX = 704;
