...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.618","t":"+6.8%","d":"up"},{"l":"Taxa Entrega (%)","v":"84.1%","t":"+7.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"72.1%","t":"+3.1%","d":"up"},{"l":"Escalações","v":"5.039","t":"-3.6%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.528","92.3%","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.900","71.7%","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.450","80.9%","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","839","87.0%","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.391","92.5%","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":642},{"label":"Mar","value":773},{"label":"Abr","value":551},{"label":"Mai","value":552},{"label":"Jun","value":701},{"label":"Jul","value":920},{"label":"Ago","value":781},{"label":"Set","value":902},{"label":"Out","value":823},{"label":"Nov","value":913},{"label":"Dez","value":594}];
const MX = 920;
