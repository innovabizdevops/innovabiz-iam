...
const ACCENT = "#b45309";
const MODULE = "Border Control";
const PAGE = "Biometric Match";
const KPIS = [{"l":"Atletas Registados","v":"3.424","t":"+2.3%","d":"up"},{"l":"Treinos/Semana","v":"1570","t":"+17.1%","d":"up"},{"l":"Competições","v":"5.168","t":"+15.9%","d":"up"},{"l":"Performance Score","v":"75","t":"+4.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.697","2.386","7.763","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.320","1.965","3.926","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.272","2.651","2.430","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.763","2.078","8.810","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.449","2.891","2.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":658},{"label":"Mar","value":582},{"label":"Abr","value":275},{"label":"Mai","value":432},{"label":"Jun","value":468},{"label":"Jul","value":358},{"label":"Ago","value":658},{"label":"Set","value":427},{"label":"Out","value":576},{"label":"Nov","value":438},{"label":"Dez","value":486}];
const MX = 658;
