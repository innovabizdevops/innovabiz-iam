...
const KPIS = [{"l":"Total Border Control","v":"5.075","t":"+8.4%","d":"up"},{"l":"Watchlist Ativos","v":"1.042","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"92","t":"-5.7%","d":"down"}];
const COLS = ["ID","Watchlist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Border Control #001","Border Control #002","6.002","2.939","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Border Control #002","Border Control #003","8.812","794","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Border Control #003","Border Control #004","5.699","7.522","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Border Control #004","Border Control #005","723","2.039","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Border Control #005","Border Control #001","4.018","4.137","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":633},{"label":"Mar","value":726},{"label":"Abr","value":564},{"label":"Mai","value":501},{"label":"Jun","value":547},{"label":"Jul","value":745},{"label":"Ago","value":477},{"label":"Set","value":610},{"label":"Out","value":588},{"label":"Nov","value":537},{"label":"Dez","value":702}];
const MX = 745;
