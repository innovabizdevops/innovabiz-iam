...
const PAGE = "Passport Scan";
const KPIS = [{"l":"Atletas Registados","v":"3.323","t":"+0.7%","d":"up"},{"l":"Treinos/Semana","v":"3380","t":"+6.5%","d":"up"},{"l":"Competições","v":"4.271","t":"+16.3%","d":"up"},{"l":"Performance Score","v":"90","t":"+5.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.604","2.586","8.312","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.548","7.501","1.294","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.194","8.354","2.462","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.473","4.767","5.169","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.120","3.515","1.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":733},{"label":"Mar","value":617},{"label":"Abr","value":650},{"label":"Mai","value":897},{"label":"Jun","value":853},{"label":"Jul","value":921},{"label":"Ago","value":769},{"label":"Set","value":569},{"label":"Out","value":640},{"label":"Nov","value":765},{"label":"Dez","value":657}];
const MX = 921;
