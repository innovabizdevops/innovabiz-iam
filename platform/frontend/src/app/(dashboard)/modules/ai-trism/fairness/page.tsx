...
const PAGE = "Fairness Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"6.621","t":"+17.5%","d":"up"},{"l":"Reuniões/Semana","v":"1988","t":"+7.0%","d":"up"},{"l":"Mensagens/Dia","v":"4877","t":"-1.8%","d":"down"},{"l":"Ficheiros Partilhados","v":"1.692","t":"-2.2%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.779","3692","3.180","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.418","4704","1.501","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","817","1162","8.089","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.171","3078","6.101","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","840","3770","3.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":470},{"label":"Mar","value":271},{"label":"Abr","value":523},{"label":"Mai","value":447},{"label":"Jun","value":383},{"label":"Jul","value":397},{"label":"Ago","value":342},{"label":"Set","value":588},{"label":"Out","value":569},{"label":"Nov","value":585},{"label":"Dez","value":629}];
const MX = 629;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>Chart</span></h1>
                </div>
