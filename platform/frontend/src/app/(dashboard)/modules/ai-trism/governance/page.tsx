...
const PAGE = "Model Governance";
const KPIS = [{"l":"Riscos Identificados","v":"8.081","t":"-4.0%","d":"down"},{"l":"Mitigações Ativas","v":"2.403","t":"+11.4%","d":"up"},{"l":"Score Risco Geral","v":"55","t":"+0.8%","d":"up"},{"l":"Incidentes YTD","v":"2.442","t":"+11.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.878","251","6.934","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.545","7.451","7.245","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","939","6.588","3.606","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.624","3.725","2.823","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.995","6.090","5.067","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":648},{"label":"Mar","value":771},{"label":"Abr","value":671},{"label":"Mai","value":713},{"label":"Jun","value":520},{"label":"Jul","value":519},{"label":"Ago","value":736},{"label":"Set","value":776},{"label":"Out","value":637},{"label":"Nov","value":687},{"label":"Dez","value":560}];
const MX = 776;
