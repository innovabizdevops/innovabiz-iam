...
const PAGE = "Model Risk Score";
const KPIS = [{"l":"Riscos Identificados","v":"3.356","t":"+10.6%","d":"up"},{"l":"Mitigações Ativas","v":"5.150","t":"-2.8%","d":"down"},{"l":"Score Risco Geral","v":"85","t":"+17.5%","d":"up"},{"l":"Incidentes YTD","v":"7.161","t":"+16.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.937","7.936","8.259","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.383","263","5.420","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.308","6.924","3.342","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.285","5.160","5.672","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.835","616","3.615","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":420},{"label":"Mar","value":374},{"label":"Abr","value":357},{"label":"Mai","value":481},{"label":"Jun","value":277},{"label":"Jul","value":533},{"label":"Ago","value":528},{"label":"Set","value":547},{"label":"Out","value":418},{"label":"Nov","value":288},{"label":"Dez","value":478}];
const MX = 582;
