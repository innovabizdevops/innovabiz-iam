...
const ACCENT = "#059669";
const MODULE = "AI TRiSM (Trust/Risk/Security)";
const PAGE = "Bias Detection";
const KPIS = [{"l":"BCP Plans Ativos","v":"2.665","t":"+13.0%","d":"up"},{"l":"RTO Médio (h)","v":"34h","t":"-1.0%","d":"down"},{"l":"RPO Médio (h)","v":"54h","t":"+2.7%","d":"up"},{"l":"Testes DR (YTD)","v":"3.840","t":"+8.4%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","10h","199h","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","125h","206h","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","72h","178h","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","145h","152h","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","163h","92h","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":898},{"label":"Mar","value":930},{"label":"Abr","value":852},{"label":"Mai","value":698},{"label":"Jun","value":616},{"label":"Jul","value":792},{"label":"Ago","value":654},{"label":"Set","value":726},{"label":"Out","value":867},{"label":"Nov","value":839},{"label":"Dez","value":816}];
const MX = 930;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>XAI</span></h1>
                </div>
