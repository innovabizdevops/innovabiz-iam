...
export default function AiTrismPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ai Trism</h1><p className="text-sm text-muted-foreground">Ai Trism • iBOS Enterprise</p></div>
