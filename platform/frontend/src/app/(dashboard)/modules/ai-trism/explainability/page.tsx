...
const KPIS = [{"l":"Total Ai Trism","v":"5.899","t":"+1.4%","d":"up"},{"l":"Explainability Ativos","v":"1.576","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"86.1%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"82","t":"-6.0%","d":"down"}];
const COLS = ["ID","Explainability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Trism #001","Ai Trism #002","759","6.790","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Trism #002","Ai Trism #003","2.281","5.819","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Trism #003","Ai Trism #004","1.662","7.720","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Trism #004","Ai Trism #005","714","3.312","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Trism #005","Ai Trism #001","6.349","3.812","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":751},{"label":"Mar","value":856},{"label":"Abr","value":929},{"label":"Mai","value":753},{"label":"Jun","value":880},{"label":"Jul","value":718},{"label":"Ago","value":666},{"label":"Set","value":569},{"label":"Out","value":571},{"label":"Nov","value":751},{"label":"Dez","value":577}];
const MX = 929;
