...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.477","t":"+14.9%","d":"up"},{"l":"NC Abertas","v":"7.791","t":"+2.9%","d":"up"},{"l":"Conformidade (%)","v":"77.1%","t":"+11.4%","d":"up"},{"l":"CAPAs Pendentes","v":"8.371","t":"+16.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.655","71.6%","2.445","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.504","83.6%","4.610","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.598","76.6%","7.808","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","672","70.8%","3.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.317","87.2%","4.416","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":539},{"label":"Mar","value":436},{"label":"Abr","value":437},{"label":"Mai","value":793},{"label":"Jun","value":469},{"label":"Jul","value":735},{"label":"Ago","value":413},{"label":"Set","value":440},{"label":"Out","value":598},{"label":"Nov","value":491},{"label":"Dez","value":533}];
const MX = 793;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>EU</span></h1>
                </div>
