...
const PAGE = "AI Audit Trail";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.279","t":"+14.2%","d":"up"},{"l":"NC Abertas","v":"3.106","t":"+5.0%","d":"up"},{"l":"Conformidade (%)","v":"90.9%","t":"+10.7%","d":"up"},{"l":"CAPAs Pendentes","v":"5.596","t":"+8.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.301","80.5%","259","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.718","82.5%","3.272","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.201","77.6%","5.663","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.272","87.3%","6.734","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.896","71.7%","5.754","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":646},{"label":"Mar","value":709},{"label":"Abr","value":843},{"label":"Mai","value":960},{"label":"Jun","value":855},{"label":"Jul","value":900},{"label":"Ago","value":932},{"label":"Set","value":941},{"label":"Out","value":968},{"label":"Nov","value":706},{"label":"Dez","value":946}];
const MX = 968;
