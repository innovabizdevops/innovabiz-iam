...
const PAGE = "Gross";
const KPIS = [{"l":"Total Pathology Mgmt","v":"4.519","t":"+16.0%","d":"up"},{"l":"Gross Ativos","v":"4.820","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.7%","d":"down"}];
const COLS = ["ID","Gross","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pathology Mgmt #001","Pathology Mgmt #002","7.819","2.736","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Pathology Mgmt #002","Pathology Mgmt #003","1.435","4.009","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Pathology Mgmt #003","Pathology Mgmt #004","2.464","5.717","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Pathology Mgmt #004","Pathology Mgmt #005","4.012","689","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pathology Mgmt #005","Pathology Mgmt #001","7.925","4.995","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":515},{"label":"Mar","value":693},{"label":"Abr","value":557},{"label":"Mai","value":839},{"label":"Jun","value":824},{"label":"Jul","value":799},{"label":"Ago","value":605},{"label":"Set","value":566},{"label":"Out","value":545},{"label":"Nov","value":691},{"label":"Dez","value":735}];
const MX = 839;
...
export default function GrossPage() {
    return (
