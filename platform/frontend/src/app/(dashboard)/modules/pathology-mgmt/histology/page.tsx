...
const ACCENT = "#6366f1";
const MODULE = "Pathology";
const PAGE = "Histology";
const KPIS = [{"l":"Total Pathology Mgmt","v":"1.604","t":"+1.0%","d":"up"},{"l":"Histology Ativos","v":"3.883","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"71.5%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"94","t":"+14.5%","d":"up"}];
const COLS = ["ID","Histology","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pathology Mgmt #001","Pathology Mgmt #002","7.949","8.564","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pathology Mgmt #002","Pathology Mgmt #003","2.587","2.925","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Pathology Mgmt #003","Pathology Mgmt #004","5.725","1.136","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Pathology Mgmt #004","Pathology Mgmt #005","4.128","1.732","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pathology Mgmt #005","Pathology Mgmt #001","8.133","1.963","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":613},{"label":"Mar","value":818},{"label":"Abr","value":526},{"label":"Mai","value":596},{"label":"Jun","value":617},{"label":"Jul","value":616},{"label":"Ago","value":488},{"label":"Set","value":653},{"label":"Out","value":503},{"label":"Nov","value":579},{"label":"Dez","value":726}];
const MX = 818;
