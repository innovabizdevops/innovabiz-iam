...
/* ═══ Energy & Utilities Cloud — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "6950", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1088", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€348K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1237378150", cells: ["IND-5150", "Energy & Utilities Cloud Item 1", "23/11/2026", "€28 250"], status: "active" as const },
    { id: "1237381721", cells: ["IND-8721", "Energy & Utilities Cloud Item 2", "10/6/2026", "€31 821"], status: "pending" as const },
    { id: "1237385292", cells: ["IND-3292", "Energy & Utilities Cloud Item 3", "25/1/2026", "€35 392"], status: "completed" as const },
    { id: "1237388863", cells: ["IND-6863", "Energy & Utilities Cloud Item 4", "12/8/2026", "€38 963"], status: "warning" as const },
    { id: "1237392434", cells: ["IND-1434", "Energy & Utilities Cloud Item 5", "27/3/2026", "€42 534"], status: "active" as const },
];
...
export default function EnergyUtilitiesCloudPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy & Utilities Cloud</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Energy & Utilities Cloud</p>
                    </div>
                </div>
