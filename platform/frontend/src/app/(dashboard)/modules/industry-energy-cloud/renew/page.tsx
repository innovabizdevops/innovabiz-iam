...
const PAGE = "Renew";
const KPIS = [{"l":"Total Industry Energy Cloud","v":"6.233","t":"-0.4%","d":"down"},{"l":"Renew Ativos","v":"7.808","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+7.4%","d":"up"}];
const COLS = ["ID","Renew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Energy Cloud #001","Industry Energy Cloud #002","1.458","6.932","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Energy Cloud #002","Industry Energy Cloud #003","513","7.729","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Energy Cloud #003","Industry Energy Cloud #004","5.436","1.877","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Energy Cloud #004","Industry Energy Cloud #005","1.120","5.403","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Energy Cloud #005","Industry Energy Cloud #001","8.215","8.196","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":916},{"label":"Mar","value":674},{"label":"Abr","value":939},{"label":"Mai","value":990},{"label":"Jun","value":705},{"label":"Jul","value":788},{"label":"Ago","value":742},{"label":"Set","value":928},{"label":"Out","value":999},{"label":"Nov","value":934},{"label":"Dez","value":966}];
const MX = 999;
