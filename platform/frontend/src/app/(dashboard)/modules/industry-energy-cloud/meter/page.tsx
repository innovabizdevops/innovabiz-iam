...
const ACCENT = "#00a1e0";
const MODULE = "Energy & Utilities Cloud";
const PAGE = "Meter";
const KPIS = [{"l":"Total Industry Energy Cloud","v":"7.453","t":"-2.1%","d":"down"},{"l":"Meter Ativos","v":"4.835","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"60","t":"+4.9%","d":"up"}];
const COLS = ["ID","Meter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Energy Cloud #001","Industry Energy Cloud #002","8.981","969","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Energy Cloud #002","Industry Energy Cloud #003","4.163","3.499","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Energy Cloud #003","Industry Energy Cloud #004","9.042","1.245","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Energy Cloud #004","Industry Energy Cloud #005","2.654","1.873","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Energy Cloud #005","Industry Energy Cloud #001","6.537","8.650","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":610},{"label":"Mar","value":482},{"label":"Abr","value":654},{"label":"Mai","value":599},{"label":"Jun","value":517},{"label":"Jul","value":464},{"label":"Ago","value":454},{"label":"Set","value":692},{"label":"Out","value":432},{"label":"Nov","value":650},{"label":"Dez","value":587}];
const MX = 692;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#00a1e0'}}>IoT</span></h1>
                </div>
