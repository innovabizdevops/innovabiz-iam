...
const KPIS = [{"l":"Tickets Abertos","v":"6.503","t":"+10.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.1%","t":"+16.7%","d":"up"},{"l":"MTTR (h)","v":"131h","t":"+6.6%","d":"up"},{"l":"Satisfação (%)","v":"85.5%","t":"+12.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.627","3.338","969","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.091","7.176","5.051","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.276","163","2.014","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.274","3.530","5.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.500","3.641","6.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":644},{"label":"Mar","value":808},{"label":"Abr","value":557},{"label":"Mai","value":814},{"label":"Jun","value":821},{"label":"Jul","value":761},{"label":"Ago","value":477},{"label":"Set","value":766},{"label":"Out","value":779},{"label":"Nov","value":775},{"label":"Dez","value":678}];
const MX = 821;
