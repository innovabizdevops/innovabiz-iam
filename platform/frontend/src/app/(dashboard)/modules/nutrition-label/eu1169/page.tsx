...
const ACCENT = "#4338ca";
const MODULE = "Nutrition Labeling";
const PAGE = "EU 1169";
const KPIS = [{"l":"Total Nutrition Label","v":"7.034","t":"+16.1%","d":"up"},{"l":"EU 1169 Ativos","v":"1.646","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"66.3%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"78","t":"+14.8%","d":"up"}];
const COLS = ["ID","EU 1169","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nutrition Label #001","Nutrition Label #002","4.122","6.848","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Nutrition Label #002","Nutrition Label #003","3.811","4.344","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Nutrition Label #003","Nutrition Label #004","7.614","5.092","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Nutrition Label #004","Nutrition Label #005","7.796","5.957","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nutrition Label #005","Nutrition Label #001","7.104","8.599","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":248},{"label":"Fev","value":281},{"label":"Mar","value":519},{"label":"Abr","value":215},{"label":"Mai","value":582},{"label":"Jun","value":415},{"label":"Jul","value":584},{"label":"Ago","value":372},{"label":"Set","value":525},{"label":"Out","value":259},{"label":"Nov","value":232},{"label":"Dez","value":371}];
const MX = 584;
...
export default function Eu1169Page() {
    return (
