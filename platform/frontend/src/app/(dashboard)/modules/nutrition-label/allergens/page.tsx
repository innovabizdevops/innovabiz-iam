...
const PAGE = "Allergen Declare";
const KPIS = [{"l":"Total Nutrition Label","v":"7.865","t":"+3.9%","d":"up"},{"l":"Allergen Declare Ativos","v":"5.676","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.0%","d":"down"}];
const COLS = ["ID","Allergen Declare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nutrition Label #001","Nutrition Label #002","620","704","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Nutrition Label #002","Nutrition Label #003","7.918","523","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Nutrition Label #003","Nutrition Label #004","6.652","7.767","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Nutrition Label #004","Nutrition Label #005","6.044","2.413","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nutrition Label #005","Nutrition Label #001","677","2.616","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":821},{"label":"Mar","value":677},{"label":"Abr","value":852},{"label":"Mai","value":769},{"label":"Jun","value":675},{"label":"Jul","value":602},{"label":"Ago","value":516},{"label":"Set","value":794},{"label":"Out","value":601},{"label":"Nov","value":774},{"label":"Dez","value":674}];
const MX = 852;
