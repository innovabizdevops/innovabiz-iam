...
const PAGE = "Dwell";
const KPIS = [{"l":"Dashboards Ativos","v":"2.483","t":"+5.6%","d":"up"},{"l":"Queries/Dia","v":"507","t":"+12.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.000","t":"+9.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.049","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3450","2026-03-06","6.567","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3475","2026-02-26","3.904","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1163","2026-01-07","8.363","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1464","2026-01-11","1.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2103","2026-02-04","1.818","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":792},{"label":"Mar","value":869},{"label":"Abr","value":647},{"label":"Mai","value":688},{"label":"Jun","value":711},{"label":"Jul","value":749},{"label":"Ago","value":745},{"label":"Set","value":592},{"label":"Out","value":567},{"label":"Nov","value":882},{"label":"Dez","value":757}];
const MX = 882;
