...
const ACCENT = "#6366f1";
const MODULE = "Logistics Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"1.239","t":"+6.3%","d":"up"},{"l":"Queries/Dia","v":"4538","t":"+12.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.411","t":"+1.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.392","t":"+15.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4166","2026-03-23","6.462","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","633","2026-01-21","131","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3798","2026-02-13","4.360","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1919","2026-03-22","2.479","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4043","2026-03-28","152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":782},{"label":"Mar","value":955},{"label":"Abr","value":682},{"label":"Mai","value":856},{"label":"Jun","value":681},{"label":"Jul","value":885},{"label":"Ago","value":778},{"label":"Set","value":664},{"label":"Out","value":758},{"label":"Nov","value":698},{"label":"Dez","value":775}];
const MX = 955;
