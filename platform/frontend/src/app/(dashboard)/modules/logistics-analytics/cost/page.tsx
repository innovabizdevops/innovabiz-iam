...
const PAGE = "Cost/Mile";
const KPIS = [{"l":"Dashboards Ativos","v":"8.372","t":"+16.3%","d":"up"},{"l":"Queries/Dia","v":"2529","t":"+-0.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.581","t":"-4.3%","d":"down"},{"l":"Utilizadores Analytics","v":"7.967","t":"+14.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","145","2026-01-22","1.809","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1904","2026-03-12","4.931","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1267","2026-02-27","5.978","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5034","2026-01-18","7.112","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","440","2026-03-11","2.561","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":753},{"label":"Mar","value":496},{"label":"Abr","value":634},{"label":"Mai","value":685},{"label":"Jun","value":515},{"label":"Jul","value":587},{"label":"Ago","value":632},{"label":"Set","value":574},{"label":"Out","value":540},{"label":"Nov","value":429},{"label":"Dez","value":675}];
const MX = 753;
