...
const PAGE = "Carbon";
const KPIS = [{"l":"Dashboards Ativos","v":"3.547","t":"+9.3%","d":"up"},{"l":"Queries/Dia","v":"4642","t":"+15.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.982","t":"+4.6%","d":"up"},{"l":"Utilizadores Analytics","v":"4.634","t":"+5.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","114","2026-02-01","2.947","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3171","2026-02-03","5.029","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4315","2026-02-07","6.125","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2309","2026-02-24","477","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3203","2026-01-16","2.429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":612},{"label":"Mar","value":730},{"label":"Abr","value":578},{"label":"Mai","value":888},{"label":"Jun","value":823},{"label":"Jul","value":720},{"label":"Ago","value":604},{"label":"Set","value":835},{"label":"Out","value":909},{"label":"Nov","value":845},{"label":"Dez","value":933}];
const MX = 933;
