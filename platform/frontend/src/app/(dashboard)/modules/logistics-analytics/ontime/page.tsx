...
const PAGE = "On-Time";
const KPIS = [{"l":"Dashboards Ativos","v":"5.925","t":"+17.0%","d":"up"},{"l":"Queries/Dia","v":"3811","t":"-3.4%","d":"down"},{"l":"Dados Processados (GB)","v":"5.359","t":"+13.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.376","t":"+13.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2385","2026-03-02","4.115","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3132","2026-02-07","1.439","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","686","2026-03-10","5.572","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2679","2026-01-21","8.116","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4642","2026-01-10","5.783","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":398},{"label":"Mar","value":719},{"label":"Abr","value":671},{"label":"Mai","value":625},{"label":"Jun","value":334},{"label":"Jul","value":461},{"label":"Ago","value":585},{"label":"Set","value":716},{"label":"Out","value":400},{"label":"Nov","value":350},{"label":"Dez","value":513}];
const MX = 719;
