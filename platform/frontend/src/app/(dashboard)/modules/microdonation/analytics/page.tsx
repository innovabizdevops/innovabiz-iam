...
const KPIS = [{"l":"Dashboards Ativos","v":"8.882","t":"+8.6%","d":"up"},{"l":"Queries/Dia","v":"905","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.942","t":"-5.7%","d":"down"},{"l":"Utilizadores Analytics","v":"4.938","t":"+2.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","980","2026-03-01","3.931","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4453","2026-02-07","6.168","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3947","2026-03-28","5.834","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3676","2026-01-08","3.072","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1326","2026-02-04","7.033","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":497},{"label":"Mar","value":388},{"label":"Abr","value":593},{"label":"Mai","value":308},{"label":"Jun","value":679},{"label":"Jul","value":686},{"label":"Ago","value":540},{"label":"Set","value":529},{"label":"Out","value":460},{"label":"Nov","value":546},{"label":"Dez","value":510}];
const MX = 686;
