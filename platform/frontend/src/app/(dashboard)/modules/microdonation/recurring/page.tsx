...
const ACCENT = "#6366f1";
const MODULE = "Microdonation";
const PAGE = "Recurring";
const KPIS = [{"l":"Total Microdonation","v":"7.059","t":"-2.5%","d":"down"},{"l":"Recurring Ativos","v":"4.804","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"81","t":"-4.0%","d":"down"}];
const COLS = ["ID","Recurring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Microdonation #001","Microdonation #002","6.125","3.852","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Microdonation #002","Microdonation #003","9.080","2.604","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Microdonation #003","Microdonation #004","6.887","6.641","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Microdonation #004","Microdonation #005","1.377","3.154","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Microdonation #005","Microdonation #001","6.240","956","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":577},{"label":"Mar","value":929},{"label":"Abr","value":754},{"label":"Mai","value":823},{"label":"Jun","value":683},{"label":"Jul","value":917},{"label":"Ago","value":784},{"label":"Set","value":943},{"label":"Out","value":596},{"label":"Nov","value":676},{"label":"Dez","value":712}];
const MX = 943;
