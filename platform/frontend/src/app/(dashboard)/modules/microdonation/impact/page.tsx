...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"5.839","t":"+7.8%","d":"up"},{"l":"Beneficiários","v":"4.490","t":"-0.5%","d":"down"},{"l":"Investimento CSR (€)","v":"€42379","t":"+6.6%","d":"up"},{"l":"Score Impacto","v":"90","t":"+1.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.224","€ 14183.78","996","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.969","€ 5935.32","6.274","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.862","€ 11680.89","3.753","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.613","€ 45531.10","2.924","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.236","€ 18089.75","3.942","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":709},{"label":"Mar","value":908},{"label":"Abr","value":921},{"label":"Mai","value":687},{"label":"Jun","value":712},{"label":"Jul","value":780},{"label":"Ago","value":832},{"label":"Set","value":1005},{"label":"Out","value":975},{"label":"Nov","value":978},{"label":"Dez","value":1024}];
const MX = 1024;
