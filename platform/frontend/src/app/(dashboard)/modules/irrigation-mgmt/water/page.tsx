...
const PAGE = "Water Use";
const KPIS = [{"l":"Total Irrigation Mgmt","v":"491","t":"-1.6%","d":"down"},{"l":"Water Use Ativos","v":"7.363","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"73.5%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"61","t":"+12.9%","d":"up"}];
const COLS = ["ID","Water Use","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Irrigation Mgmt #001","Irrigation Mgmt #002","2.392","7.976","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Irrigation Mgmt #002","Irrigation Mgmt #003","8.125","8.136","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Irrigation Mgmt #003","Irrigation Mgmt #004","2.135","2.690","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Irrigation Mgmt #004","Irrigation Mgmt #005","2.874","2.253","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Irrigation Mgmt #005","Irrigation Mgmt #001","2.883","6.518","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":428},{"label":"Mar","value":566},{"label":"Abr","value":554},{"label":"Mai","value":400},{"label":"Jun","value":517},{"label":"Jul","value":442},{"label":"Ago","value":745},{"label":"Set","value":717},{"label":"Out","value":644},{"label":"Nov","value":686},{"label":"Dez","value":673}];
const MX = 745;
