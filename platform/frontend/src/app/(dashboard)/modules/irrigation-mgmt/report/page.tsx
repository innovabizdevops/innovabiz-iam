...
const PAGE = "Report";
const KPIS = [{"l":"Total Irrigation Mgmt","v":"2.087","t":"+10.9%","d":"up"},{"l":"Report Ativos","v":"3.991","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"89.4%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"60","t":"+13.5%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Irrigation Mgmt #001","Irrigation Mgmt #002","7.074","6.568","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Irrigation Mgmt #002","Irrigation Mgmt #003","6.557","6.240","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Irrigation Mgmt #003","Irrigation Mgmt #004","7.923","6.788","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Irrigation Mgmt #004","Irrigation Mgmt #005","4.166","5.045","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Irrigation Mgmt #005","Irrigation Mgmt #001","8.727","8.651","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":686},{"label":"Mar","value":623},{"label":"Abr","value":700},{"label":"Mai","value":658},{"label":"Jun","value":560},{"label":"Jul","value":647},{"label":"Ago","value":729},{"label":"Set","value":622},{"label":"Out","value":647},{"label":"Nov","value":861},{"label":"Dez","value":545}];
const MX = 864;
