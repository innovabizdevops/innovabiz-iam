...
const PAGE = "Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"1.862","t":"+9.6%","d":"up"},{"l":"Dados/Min (MB)","v":"4.303","t":"+15.0%","d":"up"},{"l":"Alertas Ativos","v":"5.828","t":"+14.7%","d":"up"},{"l":"Uptime (%)","v":"87.4%","t":"-3.9%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.954","7.795","4.886","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.474","4.258","2.637","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","949","4.730","1.085","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","902","6.432","4.711","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.051","8.298","5.903","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":529},{"label":"Mar","value":474},{"label":"Abr","value":674},{"label":"Mai","value":716},{"label":"Jun","value":559},{"label":"Jul","value":412},{"label":"Ago","value":647},{"label":"Set","value":500},{"label":"Out","value":415},{"label":"Nov","value":406},{"label":"Dez","value":554}];
const MX = 716;
