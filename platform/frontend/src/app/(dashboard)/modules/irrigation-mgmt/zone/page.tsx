...
const PAGE = "Zone";
const KPIS = [{"l":"Total Irrigation Mgmt","v":"1.009","t":"+13.9%","d":"up"},{"l":"Zone Ativos","v":"3.409","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"77.2%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"57","t":"+15.8%","d":"up"}];
const COLS = ["ID","Zone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Irrigation Mgmt #001","Irrigation Mgmt #002","1.383","3.834","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Irrigation Mgmt #002","Irrigation Mgmt #003","6.106","238","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Irrigation Mgmt #003","Irrigation Mgmt #004","5.264","3.875","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Irrigation Mgmt #004","Irrigation Mgmt #005","1.201","8.833","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Irrigation Mgmt #005","Irrigation Mgmt #001","7.856","1.438","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":942},{"label":"Mar","value":704},{"label":"Abr","value":916},{"label":"Mai","value":827},{"label":"Jun","value":703},{"label":"Jul","value":812},{"label":"Ago","value":817},{"label":"Set","value":966},{"label":"Out","value":845},{"label":"Nov","value":953},{"label":"Dez","value":895}];
const MX = 966;
