...
export default function IrrigationMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Irrigation Mgmt</h1><p className="text-sm text-muted-foreground">Irrigation Mgmt • iBOS Enterprise</p></div>
