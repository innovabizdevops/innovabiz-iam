...
const ACCENT = "#6366f1";
const MODULE = "Irrigation Management";
const PAGE = "Schedule";
const KPIS = [{"l":"Total Irrigation Mgmt","v":"3.753","t":"+13.1%","d":"up"},{"l":"Schedule Ativos","v":"1.503","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"77","t":"+12.4%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Irrigation Mgmt #001","Irrigation Mgmt #002","5.186","3.751","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Irrigation Mgmt #002","Irrigation Mgmt #003","6.248","758","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Irrigation Mgmt #003","Irrigation Mgmt #004","7.429","4.568","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Irrigation Mgmt #004","Irrigation Mgmt #005","6.745","6.742","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Irrigation Mgmt #005","Irrigation Mgmt #001","6.630","7.276","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":296},{"label":"Fev","value":322},{"label":"Mar","value":539},{"label":"Abr","value":581},{"label":"Mai","value":272},{"label":"Jun","value":609},{"label":"Jul","value":385},{"label":"Ago","value":519},{"label":"Set","value":428},{"label":"Out","value":391},{"label":"Nov","value":523},{"label":"Dez","value":491}];
const MX = 609;
