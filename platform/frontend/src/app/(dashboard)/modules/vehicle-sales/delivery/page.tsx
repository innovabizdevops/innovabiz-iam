...
const PAGE = "Delivery";
const KPIS = [{"l":"Vendas YTD (€)","v":"€13663","t":"-0.5%","d":"down"},{"l":"Pipeline (€)","v":"€44538","t":"+13.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"81.4%","t":"+12.2%","d":"up"},{"l":"Win Rate (%)","v":"83.9%","t":"+11.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7524.28","€ 43924.56","€ 34635.26","86.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 49568.82","€ 49523.29","€ 26010.23","88.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 41549.95","€ 12221.25","€ 11519.10","71.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 22780.91","€ 42857.88","€ 28365.98","94.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 25611.57","€ 11001.66","€ 14203.72","98.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":649},{"label":"Mar","value":629},{"label":"Abr","value":336},{"label":"Mai","value":405},{"label":"Jun","value":446},{"label":"Jul","value":704},{"label":"Ago","value":715},{"label":"Set","value":416},{"label":"Out","value":454},{"label":"Nov","value":457},{"label":"Dez","value":662}];
const MX = 715;
