...
const ACCENT = "#6366f1";
const MODULE = "Vehicle Sales";
const PAGE = "Trade-In";
const KPIS = [{"l":"Vendas YTD (€)","v":"€95894","t":"+1.2%","d":"up"},{"l":"Pipeline (€)","v":"€87332","t":"-0.3%","d":"down"},{"l":"Atingimento Quota (%)","v":"69.4%","t":"-0.6%","d":"down"},{"l":"Win Rate (%)","v":"92.4%","t":"+15.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 33574.21","€ 10106.51","€ 4564.67","73.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 33080.57","€ 981.15","€ 14656.46","93.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 16118.90","€ 41705.84","€ 31665.40","80.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 22177.17","€ 34271.27","€ 32332.43","92.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 38635.21","€ 43111.56","€ 34872.54","73.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":1017},{"label":"Fev","value":811},{"label":"Mar","value":878},{"label":"Abr","value":992},{"label":"Mai","value":702},{"label":"Jun","value":707},{"label":"Jul","value":784},{"label":"Ago","value":682},{"label":"Set","value":760},{"label":"Out","value":835},{"label":"Nov","value":650},{"label":"Dez","value":1027}];
const MX = 1027;
