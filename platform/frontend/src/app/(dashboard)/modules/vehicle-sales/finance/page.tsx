...
const PAGE = "Finance";
const KPIS = [{"l":"Vendas YTD (€)","v":"€79990","t":"+8.3%","d":"up"},{"l":"Pipeline (€)","v":"€39927","t":"-0.1%","d":"down"},{"l":"Atingimento Quota (%)","v":"66.1%","t":"+4.8%","d":"up"},{"l":"Win Rate (%)","v":"84.6%","t":"+10.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 44428.49","€ 36168.62","€ 33389.25","87.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 29615.76","€ 21943.32","€ 44479.61","72.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 35103.46","€ 31290.56","€ 35071.71","76.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 25030.18","€ 24798.80","€ 44020.33","98.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 32886.25","€ 31176.91","€ 30917.12","94.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":717},{"label":"Mar","value":759},{"label":"Abr","value":591},{"label":"Mai","value":671},{"label":"Jun","value":928},{"label":"Jul","value":943},{"label":"Ago","value":695},{"label":"Set","value":883},{"label":"Out","value":721},{"label":"Nov","value":691},{"label":"Dez","value":566}];
const MX = 943;
