...
const KPIS = [{"l":"Vendas YTD (€)","v":"€59035","t":"+11.9%","d":"up"},{"l":"Pipeline (€)","v":"€91829","t":"+4.7%","d":"up"},{"l":"Atingimento Quota (%)","v":"65.2%","t":"-0.3%","d":"down"},{"l":"Win Rate (%)","v":"71.4%","t":"+9.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 41285.71","€ 21005.26","€ 38149.29","73.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 49197.97","€ 39028.90","€ 1884.00","73.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 25025.60","€ 33122.10","€ 26821.29","83.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 25260.63","€ 35294.21","€ 31582.33","81.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 28327.82","€ 2130.41","€ 40050.15","86.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":332},{"label":"Mar","value":351},{"label":"Abr","value":434},{"label":"Mai","value":417},{"label":"Jun","value":299},{"label":"Jul","value":419},{"label":"Ago","value":498},{"label":"Set","value":310},{"label":"Out","value":452},{"label":"Nov","value":520},{"label":"Dez","value":441}];
const MX = 677;
