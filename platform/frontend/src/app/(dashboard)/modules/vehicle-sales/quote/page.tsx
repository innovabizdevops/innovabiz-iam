...
const PAGE = "Quote";
const KPIS = [{"l":"Vendas YTD (€)","v":"€17627","t":"-3.4%","d":"down"},{"l":"Pipeline (€)","v":"€90655","t":"+3.1%","d":"up"},{"l":"Atingimento Quota (%)","v":"74.4%","t":"-5.7%","d":"down"},{"l":"Win Rate (%)","v":"90.0%","t":"-0.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7060.54","€ 11607.50","€ 41161.86","78.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 5870.38","€ 7613.41","€ 9406.91","91.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 30276.99","€ 36017.42","€ 7501.10","93.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 12037.38","€ 49534.39","€ 48471.55","95.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 15521.26","€ 48465.97","€ 48027.67","70.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":687},{"label":"Mar","value":783},{"label":"Abr","value":780},{"label":"Mai","value":467},{"label":"Jun","value":594},{"label":"Jul","value":659},{"label":"Ago","value":504},{"label":"Set","value":585},{"label":"Out","value":515},{"label":"Nov","value":628},{"label":"Dez","value":487}];
const MX = 783;
