...
const ACCENT = "#475569";
const MODULE = "Parcel Tracking";
const PAGE = "Customer Notify";
const KPIS = [{"l":"Notificações Enviadas","v":"398","t":"+0.3%","d":"up"},{"l":"Taxa Entrega (%)","v":"68.8%","t":"+6.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"76.6%","t":"+10.9%","d":"up"},{"l":"Escalações","v":"4.034","t":"+14.5%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.740","80.0%","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.622","83.9%","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.032","80.4%","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.140","92.1%","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.127","89.1%","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1003},{"label":"Fev","value":962},{"label":"Mar","value":951},{"label":"Abr","value":750},{"label":"Mai","value":973},{"label":"Jun","value":1034},{"label":"Jul","value":769},{"label":"Ago","value":804},{"label":"Set","value":850},{"label":"Out","value":977},{"label":"Nov","value":655},{"label":"Dez","value":684}];
const MX = 1034;
