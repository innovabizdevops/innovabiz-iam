...
const PAGE = "RTO/RPO Track";
const KPIS = [{"l":"Total Bcm Plan","v":"3.350","t":"+12.4%","d":"up"},{"l":"RTO/RPO Track Ativos","v":"6.786","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"61","t":"+6.9%","d":"up"}];
const COLS = ["ID","RTO/RPO Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bcm Plan #001","Bcm Plan #002","5.611","7.937","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Bcm Plan #002","Bcm Plan #003","8.690","1.739","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Bcm Plan #003","Bcm Plan #004","2.998","2.740","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Bcm Plan #004","Bcm Plan #005","5.532","8.725","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bcm Plan #005","Bcm Plan #001","8.024","807","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":882},{"label":"Mar","value":766},{"label":"Abr","value":858},{"label":"Mai","value":766},{"label":"Jun","value":757},{"label":"Jul","value":662},{"label":"Ago","value":828},{"label":"Set","value":772},{"label":"Out","value":584},{"label":"Nov","value":571},{"label":"Dez","value":649}];
const MX = 882;
