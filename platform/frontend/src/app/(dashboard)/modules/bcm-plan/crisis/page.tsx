...
const KPIS = [{"l":"Total Bcm Plan","v":"6.655","t":"+4.8%","d":"up"},{"l":"Crisis Comm Ativos","v":"5.587","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"86","t":"+17.9%","d":"up"}];
const COLS = ["ID","Crisis Comm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bcm Plan #001","Bcm Plan #002","7.383","2.519","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Bcm Plan #002","Bcm Plan #003","757","3.654","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Bcm Plan #003","Bcm Plan #004","5.983","1.338","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Bcm Plan #004","Bcm Plan #005","851","6.120","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bcm Plan #005","Bcm Plan #001","4.012","2.657","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":609},{"label":"Mar","value":497},{"label":"Abr","value":636},{"label":"Mai","value":865},{"label":"Jun","value":877},{"label":"Jul","value":611},{"label":"Ago","value":738},{"label":"Set","value":763},{"label":"Out","value":681},{"label":"Nov","value":487},{"label":"Dez","value":493}];
const MX = 877;
