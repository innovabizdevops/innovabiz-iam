...
export default function BcmPlanPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Bcm Plan</h1><p className="text-sm text-muted-foreground">Bcm Plan • iBOS Enterprise</p></div>
