...
const ACCENT = "#ec4899";
const MODULE = "BCM & Continuity";
const PAGE = "BIA Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.095","t":"+12.0%","d":"up"},{"l":"Queries/Dia","v":"5086","t":"+2.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.135","t":"+7.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.722","t":"+6.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4007","2026-01-09","2.302","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4980","2026-01-16","1.691","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2141","2026-03-01","4.572","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4880","2026-01-04","8.612","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","324","2026-02-21","2.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":970},{"label":"Mar","value":931},{"label":"Abr","value":973},{"label":"Mai","value":608},{"label":"Jun","value":605},{"label":"Jul","value":966},{"label":"Ago","value":944},{"label":"Set","value":711},{"label":"Out","value":628},{"label":"Nov","value":949},{"label":"Dez","value":935}];
const MX = 973;
