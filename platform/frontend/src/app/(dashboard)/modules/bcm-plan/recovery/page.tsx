...
const PAGE = "Recovery Plans";
const KPIS = [{"l":"BCP Plans Ativos","v":"5.764","t":"+1.7%","d":"up"},{"l":"RTO Médio (h)","v":"109h","t":"+5.3%","d":"up"},{"l":"RPO Médio (h)","v":"47h","t":"+9.3%","d":"up"},{"l":"Testes DR (YTD)","v":"7.093","t":"-1.6%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","90h","134h","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","31h","174h","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","54h","160h","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","103h","175h","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","149h","24h","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":866},{"label":"Mar","value":894},{"label":"Abr","value":840},{"label":"Mai","value":529},{"label":"Jun","value":689},{"label":"Jul","value":754},{"label":"Ago","value":690},{"label":"Set","value":611},{"label":"Out","value":538},{"label":"Nov","value":769},{"label":"Dez","value":746}];
const MX = 894;
