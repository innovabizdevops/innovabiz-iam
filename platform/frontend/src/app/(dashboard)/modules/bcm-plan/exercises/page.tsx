...
const PAGE = "Test Exercises";
const KPIS = [{"l":"Total Bcm Plan","v":"1.524","t":"+1.3%","d":"up"},{"l":"Test Exercises Ativos","v":"9.083","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"85","t":"+11.4%","d":"up"}];
const COLS = ["ID","Test Exercises","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bcm Plan #001","Bcm Plan #002","8.185","3.921","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Bcm Plan #002","Bcm Plan #003","6.718","8.299","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Bcm Plan #003","Bcm Plan #004","1.003","1.595","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Bcm Plan #004","Bcm Plan #005","3.628","2.469","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bcm Plan #005","Bcm Plan #001","2.272","7.385","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":640},{"label":"Mar","value":682},{"label":"Abr","value":376},{"label":"Mai","value":493},{"label":"Jun","value":421},{"label":"Jul","value":746},{"label":"Ago","value":371},{"label":"Set","value":695},{"label":"Out","value":694},{"label":"Nov","value":441},{"label":"Dez","value":654}];
const MX = 746;
