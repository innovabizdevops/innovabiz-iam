...
const KPIS = [{"l":"Dashboards Ativos","v":"7.222","t":"+15.2%","d":"up"},{"l":"Queries/Dia","v":"2769","t":"-3.5%","d":"down"},{"l":"Dados Processados (GB)","v":"4.981","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"3.978","t":"+16.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2858","2026-03-11","5.828","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2402","2026-01-27","5.331","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4566","2026-03-03","3.371","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4677","2026-03-10","267","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4051","2026-01-26","5.752","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":700},{"label":"Mar","value":801},{"label":"Abr","value":604},{"label":"Mai","value":886},{"label":"Jun","value":663},{"label":"Jul","value":893},{"label":"Ago","value":643},{"label":"Set","value":708},{"label":"Out","value":614},{"label":"Nov","value":870},{"label":"Dez","value":688}];
const MX = 893;
