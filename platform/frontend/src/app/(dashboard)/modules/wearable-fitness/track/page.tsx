...
const PAGE = "Track";
const KPIS = [{"l":"Atletas Registados","v":"936","t":"+13.4%","d":"up"},{"l":"Treinos/Semana","v":"2730","t":"+13.0%","d":"up"},{"l":"Competições","v":"8.114","t":"-5.9%","d":"down"},{"l":"Performance Score","v":"87","t":"+1.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.124","4.334","3.504","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.372","6.508","2.179","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.248","3.418","4.373","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","372","4.934","7.416","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.450","7.770","1.454","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":855},{"label":"Mar","value":731},{"label":"Abr","value":811},{"label":"Mai","value":787},{"label":"Jun","value":793},{"label":"Jul","value":753},{"label":"Ago","value":677},{"label":"Set","value":830},{"label":"Out","value":934},{"label":"Nov","value":709},{"label":"Dez","value":871}];
const MX = 934;
