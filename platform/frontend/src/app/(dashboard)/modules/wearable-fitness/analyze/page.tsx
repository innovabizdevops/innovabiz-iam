...
const ACCENT = "#b91c1c";
const MODULE = "Wearable Fitness Integration";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"1.622","t":"+6.2%","d":"up"},{"l":"Queries/Dia","v":"1980","t":"-1.3%","d":"down"},{"l":"Dados Processados (GB)","v":"2.748","t":"-2.1%","d":"down"},{"l":"Utilizadores Analytics","v":"971","t":"-0.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3486","2026-02-08","4.405","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3808","2026-01-20","3.793","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3303","2026-01-23","7.122","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","898","2026-03-28","6.724","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4213","2026-03-16","2.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":395},{"label":"Mar","value":589},{"label":"Abr","value":530},{"label":"Mai","value":510},{"label":"Jun","value":566},{"label":"Jul","value":712},{"label":"Ago","value":476},{"label":"Set","value":446},{"label":"Out","value":586},{"label":"Nov","value":570},{"label":"Dez","value":478}];
const MX = 712;
