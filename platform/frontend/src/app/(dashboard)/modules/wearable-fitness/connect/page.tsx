...
const PAGE = "Connect";
const KPIS = [{"l":"Atletas Registados","v":"1.060","t":"+17.1%","d":"up"},{"l":"Treinos/Semana","v":"660","t":"-2.6%","d":"down"},{"l":"Competições","v":"5.324","t":"+7.2%","d":"up"},{"l":"Performance Score","v":"70","t":"+12.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.974","4.239","3.327","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.167","5.452","1.191","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.807","2.267","6.068","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.223","5.027","4.488","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.652","5.482","8.154","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":634},{"label":"Mar","value":797},{"label":"Abr","value":955},{"label":"Mai","value":685},{"label":"Jun","value":636},{"label":"Jul","value":689},{"label":"Ago","value":901},{"label":"Set","value":692},{"label":"Out","value":896},{"label":"Nov","value":912},{"label":"Dez","value":970}];
const MX = 970;
