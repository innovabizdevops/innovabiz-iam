...
const PAGE = "Report";
const KPIS = [{"l":"Atletas Registados","v":"247","t":"+6.9%","d":"up"},{"l":"Treinos/Semana","v":"920","t":"+16.7%","d":"up"},{"l":"Competições","v":"3.056","t":"+4.0%","d":"up"},{"l":"Performance Score","v":"66","t":"-5.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","152","1.488","6.328","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.408","1.891","4.262","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.844","8.493","3.569","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.030","7.627","3.867","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","623","7.956","1.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":766},{"label":"Mar","value":805},{"label":"Abr","value":857},{"label":"Mai","value":700},{"label":"Jun","value":813},{"label":"Jul","value":900},{"label":"Ago","value":816},{"label":"Set","value":660},{"label":"Out","value":938},{"label":"Nov","value":1019},{"label":"Dez","value":991}];
const MX = 1019;
