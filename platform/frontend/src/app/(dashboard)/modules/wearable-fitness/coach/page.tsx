...
const PAGE = "Coach";
const KPIS = [{"l":"Atletas Registados","v":"2.548","t":"-2.9%","d":"down"},{"l":"Treinos/Semana","v":"3016","t":"+17.9%","d":"up"},{"l":"Competições","v":"6.187","t":"+2.3%","d":"up"},{"l":"Performance Score","v":"61","t":"+15.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.443","2.824","3.104","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.480","9.002","2.251","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.921","6.597","1.261","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","9.035","4.561","2.280","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.924","1.001","654","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":649},{"label":"Mar","value":862},{"label":"Abr","value":828},{"label":"Mai","value":666},{"label":"Jun","value":632},{"label":"Jul","value":855},{"label":"Ago","value":843},{"label":"Set","value":760},{"label":"Out","value":884},{"label":"Nov","value":725},{"label":"Dez","value":751}];
const MX = 884;
