...
/* ═══ Wearable Fitness Integration — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "7897", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4766", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€422K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "948229797", cells: ["WEA-8797", "Wearable Fitness Integration Item 1", "26/10/2026", "€29 897"], status: "active" as const },
    { id: "948233368", cells: ["WEA-3368", "Wearable Fitness Integration Item 2", "13/5/2026", "€33 468"], status: "pending" as const },
    { id: "948236939", cells: ["WEA-6939", "Wearable Fitness Integration Item 3", "28/12/2026", "€37 039"], status: "completed" as const },
    { id: "948240510", cells: ["WEA-1510", "Wearable Fitness Integration Item 4", "15/7/2026", "€40 610"], status: "warning" as const },
    { id: "948244081", cells: ["WEA-5081", "Wearable Fitness Integration Item 5", "2/2/2026", "€44 181"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 57 }, { label: "Fev", value: 66 }, { label: "Mar", value: 75 }, { label: "Abr", value: 84 }, { label: "Mai", value: 93 }, { label: "Jun", value: 22 }];
...
export default function WearableFitnessIntegrationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wearable Fitness Integration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wearable Fitness Integration</p>
                    </div>
                </div>
