...
const PAGE = "Energy";
const KPIS = [{"l":"Total Campus Mgmt","v":"8.885","t":"+12.3%","d":"up"},{"l":"Energy Ativos","v":"4.826","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"77.0%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+16.2%","d":"up"}];
const COLS = ["ID","Energy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campus Mgmt #001","Campus Mgmt #002","7.017","379","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Campus Mgmt #002","Campus Mgmt #003","5.810","8.452","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Campus Mgmt #003","Campus Mgmt #004","590","7.828","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Campus Mgmt #004","Campus Mgmt #005","4.247","7.922","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campus Mgmt #005","Campus Mgmt #001","6.034","7.048","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":397},{"label":"Mar","value":651},{"label":"Abr","value":362},{"label":"Mai","value":347},{"label":"Jun","value":506},{"label":"Jul","value":661},{"label":"Ago","value":380},{"label":"Set","value":677},{"label":"Out","value":611},{"label":"Nov","value":366},{"label":"Dez","value":574}];
const MX = 677;
