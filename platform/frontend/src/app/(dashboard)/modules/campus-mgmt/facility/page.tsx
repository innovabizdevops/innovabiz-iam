...
const ACCENT = "#6366f1";
const MODULE = "Campus Management";
const PAGE = "Facility";
const KPIS = [{"l":"Total Campus Mgmt","v":"7.780","t":"-4.0%","d":"down"},{"l":"Facility Ativos","v":"409","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+10.0%","d":"up"}];
const COLS = ["ID","Facility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campus Mgmt #001","Campus Mgmt #002","5.475","7.937","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Campus Mgmt #002","Campus Mgmt #003","1.834","1.413","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Campus Mgmt #003","Campus Mgmt #004","8.630","8.176","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Campus Mgmt #004","Campus Mgmt #005","7.066","1.768","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campus Mgmt #005","Campus Mgmt #001","3.971","5.872","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":499},{"label":"Mar","value":355},{"label":"Abr","value":566},{"label":"Mai","value":418},{"label":"Jun","value":619},{"label":"Jul","value":378},{"label":"Ago","value":477},{"label":"Set","value":437},{"label":"Out","value":498},{"label":"Nov","value":659},{"label":"Dez","value":418}];
const MX = 659;
