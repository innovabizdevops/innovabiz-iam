...
const PAGE = "Parking";
const KPIS = [{"l":"Total Campus Mgmt","v":"8.149","t":"+9.3%","d":"up"},{"l":"Parking Ativos","v":"6.002","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+17.3%","d":"up"}];
const COLS = ["ID","Parking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campus Mgmt #001","Campus Mgmt #002","4.110","5.337","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Campus Mgmt #002","Campus Mgmt #003","3.824","8.603","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Campus Mgmt #003","Campus Mgmt #004","4.869","3.399","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Campus Mgmt #004","Campus Mgmt #005","3.106","3.247","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campus Mgmt #005","Campus Mgmt #001","4.153","545","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":604},{"label":"Mar","value":456},{"label":"Abr","value":456},{"label":"Mai","value":474},{"label":"Jun","value":634},{"label":"Jul","value":540},{"label":"Ago","value":576},{"label":"Set","value":438},{"label":"Out","value":468},{"label":"Nov","value":647},{"label":"Dez","value":807}];
const MX = 807;
