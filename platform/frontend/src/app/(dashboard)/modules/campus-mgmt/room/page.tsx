...
const PAGE = "Room";
const KPIS = [{"l":"Total Campus Mgmt","v":"4.461","t":"+4.9%","d":"up"},{"l":"Room Ativos","v":"3.756","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"60","t":"+15.3%","d":"up"}];
const COLS = ["ID","Room","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Campus Mgmt #001","Campus Mgmt #002","2.713","5.106","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Campus Mgmt #002","Campus Mgmt #003","2.669","3.219","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Campus Mgmt #003","Campus Mgmt #004","8.516","3.880","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Campus Mgmt #004","Campus Mgmt #005","5.818","1.175","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Campus Mgmt #005","Campus Mgmt #001","3.786","711","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":969},{"label":"Mar","value":742},{"label":"Abr","value":936},{"label":"Mai","value":838},{"label":"Jun","value":947},{"label":"Jul","value":584},{"label":"Ago","value":744},{"label":"Set","value":743},{"label":"Out","value":931},{"label":"Nov","value":849},{"label":"Dez","value":821}];
const MX = 969;
