...
const ACCENT = "#7c3aed";
const MODULE = "Route Optimizer";
const PAGE = "Traffic AI";
const KPIS = [{"l":"Total Route Optimizer","v":"3.144","t":"-0.5%","d":"down"},{"l":"Traffic AI Ativos","v":"1.607","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"81.9%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"70","t":"+9.7%","d":"up"}];
const COLS = ["ID","Traffic AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Optimizer #001","Route Optimizer #002","6.443","8.769","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Route Optimizer #002","Route Optimizer #003","8.917","663","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Optimizer #003","Route Optimizer #004","4.071","6.305","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Route Optimizer #004","Route Optimizer #005","5.438","2.477","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Optimizer #005","Route Optimizer #001","8.059","4.170","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":410},{"label":"Mar","value":404},{"label":"Abr","value":566},{"label":"Mai","value":375},{"label":"Jun","value":488},{"label":"Jul","value":640},{"label":"Ago","value":397},{"label":"Set","value":721},{"label":"Out","value":713},{"label":"Nov","value":392},{"label":"Dez","value":651}];
const MX = 721;
