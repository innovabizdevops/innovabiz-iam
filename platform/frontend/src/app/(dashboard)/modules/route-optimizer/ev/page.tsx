...
const PAGE = "EV Range";
const KPIS = [{"l":"Total Route Optimizer","v":"5.251","t":"+0.9%","d":"up"},{"l":"EV Range Ativos","v":"3.484","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+8.6%","d":"up"}];
const COLS = ["ID","EV Range","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Optimizer #001","Route Optimizer #002","2.555","3.563","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Route Optimizer #002","Route Optimizer #003","1.436","8.578","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Optimizer #003","Route Optimizer #004","7.304","8.426","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Route Optimizer #004","Route Optimizer #005","4.711","1.656","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Optimizer #005","Route Optimizer #001","5.334","8.444","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":644},{"label":"Mar","value":372},{"label":"Abr","value":594},{"label":"Mai","value":608},{"label":"Jun","value":546},{"label":"Jul","value":515},{"label":"Ago","value":490},{"label":"Set","value":482},{"label":"Out","value":290},{"label":"Nov","value":333},{"label":"Dez","value":424}];
const MX = 644;
