...
const PAGE = "Time Windows";
const KPIS = [{"l":"Total Route Optimizer","v":"3.359","t":"+10.7%","d":"up"},{"l":"Time Windows Ativos","v":"491","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"76","t":"+14.1%","d":"up"}];
const COLS = ["ID","Time Windows","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Optimizer #001","Route Optimizer #002","860","2.587","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Route Optimizer #002","Route Optimizer #003","1.564","7.060","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Optimizer #003","Route Optimizer #004","4.991","516","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Route Optimizer #004","Route Optimizer #005","8.078","3.876","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Optimizer #005","Route Optimizer #001","445","115","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":773},{"label":"Mar","value":932},{"label":"Abr","value":697},{"label":"Mai","value":836},{"label":"Jun","value":663},{"label":"Jul","value":1013},{"label":"Ago","value":700},{"label":"Set","value":760},{"label":"Out","value":926},{"label":"Nov","value":721},{"label":"Dez","value":980}];
const MX = 1013;
