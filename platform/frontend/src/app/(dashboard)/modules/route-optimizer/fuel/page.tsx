...
const PAGE = "Fuel Optimize";
const KPIS = [{"l":"Total Route Optimizer","v":"1.402","t":"-0.5%","d":"down"},{"l":"Fuel Optimize Ativos","v":"3.444","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"94","t":"+16.1%","d":"up"}];
const COLS = ["ID","Fuel Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Optimizer #001","Route Optimizer #002","3.567","9.077","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Route Optimizer #002","Route Optimizer #003","4.500","4.250","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Optimizer #003","Route Optimizer #004","4.622","7.588","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Route Optimizer #004","Route Optimizer #005","7.237","802","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Optimizer #005","Route Optimizer #001","996","7.704","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":894},{"label":"Mar","value":620},{"label":"Abr","value":908},{"label":"Mai","value":838},{"label":"Jun","value":719},{"label":"Jul","value":753},{"label":"Ago","value":946},{"label":"Set","value":791},{"label":"Out","value":628},{"label":"Nov","value":727},{"label":"Dez","value":896}];
const MX = 946;
