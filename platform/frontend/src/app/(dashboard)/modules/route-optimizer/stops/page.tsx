...
const PAGE = "Multi-Stop";
const KPIS = [{"l":"Total Route Optimizer","v":"6.922","t":"-5.7%","d":"down"},{"l":"Multi Stop Ativos","v":"7.579","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"73.5%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"75","t":"+12.9%","d":"up"}];
const COLS = ["ID","Multi Stop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Optimizer #001","Route Optimizer #002","295","2.438","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Route Optimizer #002","Route Optimizer #003","1.206","1.689","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Optimizer #003","Route Optimizer #004","273","7.903","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Route Optimizer #004","Route Optimizer #005","660","8.649","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Optimizer #005","Route Optimizer #001","1.191","5.156","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":704},{"label":"Mar","value":808},{"label":"Abr","value":963},{"label":"Mai","value":710},{"label":"Jun","value":1039},{"label":"Jul","value":712},{"label":"Ago","value":856},{"label":"Set","value":1068},{"label":"Out","value":802},{"label":"Nov","value":746},{"label":"Dez","value":845}];
const MX = 1068;
