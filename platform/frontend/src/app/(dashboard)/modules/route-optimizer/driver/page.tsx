...
const PAGE = "Driver Assign";
const KPIS = [{"l":"Total Route Optimizer","v":"4.494","t":"+6.5%","d":"up"},{"l":"Driver Assign Ativos","v":"1.827","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"61","t":"+3.1%","d":"up"}];
const COLS = ["ID","Driver Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Route Optimizer #001","Route Optimizer #002","8.353","1.417","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Route Optimizer #002","Route Optimizer #003","7.726","7.910","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Route Optimizer #003","Route Optimizer #004","5.042","3.935","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Route Optimizer #004","Route Optimizer #005","2.763","8.349","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Route Optimizer #005","Route Optimizer #001","8.388","1.052","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":773},{"label":"Mar","value":631},{"label":"Abr","value":604},{"label":"Mai","value":623},{"label":"Jun","value":679},{"label":"Jul","value":741},{"label":"Ago","value":940},{"label":"Set","value":667},{"label":"Out","value":857},{"label":"Nov","value":894},{"label":"Dez","value":643}];
const MX = 940;
