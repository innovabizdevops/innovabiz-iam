...
const KPIS = [{"l":"Projetos Sociais","v":"2.714","t":"-5.1%","d":"down"},{"l":"Beneficiários","v":"3.408","t":"-5.2%","d":"down"},{"l":"Investimento CSR (€)","v":"€80385","t":"+11.0%","d":"up"},{"l":"Score Impacto","v":"86","t":"+14.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.083","€ 30733.87","229","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.857","€ 1851.11","7.601","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.701","€ 4029.03","8.529","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.000","€ 7825.75","6.458","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","290","€ 16813.09","8.960","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":845},{"label":"Mar","value":870},{"label":"Abr","value":972},{"label":"Mai","value":854},{"label":"Jun","value":938},{"label":"Jul","value":876},{"label":"Ago","value":854},{"label":"Set","value":654},{"label":"Out","value":906},{"label":"Nov","value":939},{"label":"Dez","value":719}];
const MX = 972;
