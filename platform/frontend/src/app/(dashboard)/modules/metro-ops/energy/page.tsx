...
const PAGE = "Energy";
const KPIS = [{"l":"Veículos Operação","v":"7.219","t":"+16.3%","d":"up"},{"l":"Viagens/Dia","v":"4429","t":"+13.5%","d":"up"},{"l":"Pontualidade (%)","v":"81.2%","t":"+8.8%","d":"up"},{"l":"Passageiros/Dia","v":"3890","t":"+10.5%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-10","2026-01-06","6.201","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-04","2026-01-10","5.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-12","2026-02-26","518","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-23","2026-01-12","6.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-01","2026-03-15","2.463","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":798},{"label":"Mar","value":969},{"label":"Abr","value":990},{"label":"Mai","value":1011},{"label":"Jun","value":851},{"label":"Jul","value":1014},{"label":"Ago","value":831},{"label":"Set","value":807},{"label":"Out","value":825},{"label":"Nov","value":1053},{"label":"Dez","value":871}];
const MX = 1053;
