...
const ACCENT = "#0369a1";
const MODULE = "Metro Operations";
const PAGE = "Passenger";
const KPIS = [{"l":"Veículos Operação","v":"8.718","t":"+12.2%","d":"up"},{"l":"Viagens/Dia","v":"2495","t":"-0.3%","d":"down"},{"l":"Pontualidade (%)","v":"93.8%","t":"+17.3%","d":"up"},{"l":"Passageiros/Dia","v":"4107","t":"-1.0%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-20","2026-01-15","7.003","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-07","2026-03-26","346","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-20","2026-01-17","2.561","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-14","2026-02-13","7.965","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-04","2026-02-07","2.645","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":655},{"label":"Mar","value":811},{"label":"Abr","value":942},{"label":"Mai","value":724},{"label":"Jun","value":844},{"label":"Jul","value":902},{"label":"Ago","value":831},{"label":"Set","value":755},{"label":"Out","value":704},{"label":"Nov","value":733},{"label":"Dez","value":877}];
const MX = 942;
