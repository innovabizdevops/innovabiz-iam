...
const PAGE = "Station";
const KPIS = [{"l":"Veículos Operação","v":"1.556","t":"-4.5%","d":"down"},{"l":"Viagens/Dia","v":"4820","t":"+1.6%","d":"up"},{"l":"Pontualidade (%)","v":"69.4%","t":"-4.8%","d":"down"},{"l":"Passageiros/Dia","v":"2106","t":"+13.4%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-25","2026-03-08","2.656","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-11","2026-02-01","242","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-04","2026-03-12","5.795","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-03","2026-03-02","1.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-27","2026-01-27","8.905","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":752},{"label":"Mar","value":868},{"label":"Abr","value":818},{"label":"Mai","value":1028},{"label":"Jun","value":685},{"label":"Jul","value":979},{"label":"Ago","value":948},{"label":"Set","value":1049},{"label":"Out","value":780},{"label":"Nov","value":1022},{"label":"Dez","value":765}];
const MX = 1049;
