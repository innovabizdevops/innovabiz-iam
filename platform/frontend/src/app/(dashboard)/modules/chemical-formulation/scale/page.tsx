...
const ACCENT = "#6366f1";
const MODULE = "Chemical Formulation";
const PAGE = "Scale Up";
const KPIS = [{"l":"Formulários Ativos","v":"6.193","t":"+15.5%","d":"up"},{"l":"Submissões/Dia","v":"2692","t":"+14.8%","d":"up"},{"l":"Documentos Gerados","v":"5.226","t":"-0.6%","d":"down"},{"l":"Templates","v":"4.101","t":"+0.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.602","2026-03-23","5.022","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.371","2026-02-15","1.268","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.327","2026-01-10","4.946","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.351","2026-03-28","4.795","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.260","2026-03-09","8.317","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":315},{"label":"Fev","value":354},{"label":"Mar","value":518},{"label":"Abr","value":702},{"label":"Mai","value":542},{"label":"Jun","value":694},{"label":"Jul","value":644},{"label":"Ago","value":450},{"label":"Set","value":507},{"label":"Out","value":473},{"label":"Nov","value":475},{"label":"Dez","value":388}];
const MX = 702;
