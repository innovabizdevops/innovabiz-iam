...
const PAGE = "Approve";
const KPIS = [{"l":"Formulários Ativos","v":"5.188","t":"+16.4%","d":"up"},{"l":"Submissões/Dia","v":"1977","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"3.314","t":"+6.9%","d":"up"},{"l":"Templates","v":"5.920","t":"-1.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.982","2026-02-23","261","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","989","2026-03-28","7.355","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","178","2026-01-23","5.473","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.705","2026-02-21","7.887","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.135","2026-03-07","1.111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":273},{"label":"Fev","value":523},{"label":"Mar","value":350},{"label":"Abr","value":398},{"label":"Mai","value":515},{"label":"Jun","value":476},{"label":"Jul","value":323},{"label":"Ago","value":338},{"label":"Set","value":342},{"label":"Out","value":374},{"label":"Nov","value":578},{"label":"Dez","value":478}];
const MX = 578;
