...
const PAGE = "Test";
const KPIS = [{"l":"Formulários Ativos","v":"4.111","t":"-1.6%","d":"down"},{"l":"Submissões/Dia","v":"5071","t":"+17.9%","d":"up"},{"l":"Documentos Gerados","v":"9.087","t":"+6.2%","d":"up"},{"l":"Templates","v":"8.262","t":"+1.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","352","2026-02-26","5.182","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.657","2026-03-14","9.015","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.642","2026-03-13","4.214","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.619","2026-03-14","4.200","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.846","2026-03-16","5.618","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":462},{"label":"Mar","value":525},{"label":"Abr","value":265},{"label":"Mai","value":358},{"label":"Jun","value":558},{"label":"Jul","value":290},{"label":"Ago","value":374},{"label":"Set","value":633},{"label":"Out","value":437},{"label":"Nov","value":551},{"label":"Dez","value":560}];
const MX = 633;
