...
const PAGE = "Recipe";
const KPIS = [{"l":"Formulários Ativos","v":"2.566","t":"+2.3%","d":"up"},{"l":"Submissões/Dia","v":"2650","t":"+16.0%","d":"up"},{"l":"Documentos Gerados","v":"1.015","t":"+13.3%","d":"up"},{"l":"Templates","v":"3.377","t":"-1.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.547","2026-03-12","3.645","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.530","2026-02-17","7.744","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.555","2026-02-24","3.074","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.973","2026-01-04","5.624","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.732","2026-03-04","7.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":836},{"label":"Mar","value":732},{"label":"Abr","value":795},{"label":"Mai","value":926},{"label":"Jun","value":1013},{"label":"Jul","value":709},{"label":"Ago","value":795},{"label":"Set","value":650},{"label":"Out","value":712},{"label":"Nov","value":796},{"label":"Dez","value":956}];
const MX = 1013;
