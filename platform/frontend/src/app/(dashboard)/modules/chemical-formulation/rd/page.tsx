...
const PAGE = "R&amp;D";
const KPIS = [{"l":"Formulários Ativos","v":"837","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"241","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"3.241","t":"+3.8%","d":"up"},{"l":"Templates","v":"3.738","t":"+13.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.310","2026-02-12","142","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.404","2026-02-27","5.397","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.775","2026-03-17","1.273","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.139","2026-01-04","6.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.162","2026-03-09","7.294","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":863},{"label":"Mar","value":994},{"label":"Abr","value":835},{"label":"Mai","value":970},{"label":"Jun","value":920},{"label":"Jul","value":981},{"label":"Ago","value":867},{"label":"Set","value":825},{"label":"Out","value":730},{"label":"Nov","value":743},{"label":"Dez","value":976}];
const MX = 994;
