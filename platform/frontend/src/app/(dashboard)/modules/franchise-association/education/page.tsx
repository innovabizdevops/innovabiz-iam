...
const KPIS = [{"l":"Utilizadores Ativos","v":"8.249","t":"+11.6%","d":"up"},{"l":"Sessões/Dia","v":"3495","t":"+13.7%","d":"up"},{"l":"MFA Adoção (%)","v":"91.7%","t":"+15.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.487","t":"+14.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.841","1.610","3.346","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.506","8.689","3.777","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.452","1.678","573","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.488","8.619","4.816","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","691","5.538","633","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":532},{"label":"Mar","value":604},{"label":"Abr","value":463},{"label":"Mai","value":435},{"label":"Jun","value":588},{"label":"Jul","value":488},{"label":"Ago","value":391},{"label":"Set","value":513},{"label":"Out","value":517},{"label":"Nov","value":404},{"label":"Dez","value":493}];
const MX = 604;
