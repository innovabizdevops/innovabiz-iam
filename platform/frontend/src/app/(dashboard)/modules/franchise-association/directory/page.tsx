...
const KPIS = [{"l":"Utilizadores Ativos","v":"1.716","t":"+9.4%","d":"up"},{"l":"Sessões/Dia","v":"3863","t":"+0.3%","d":"up"},{"l":"MFA Adoção (%)","v":"93.2%","t":"+11.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.722","t":"+14.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.773","5.350","8.104","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.949","4.809","6.498","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.341","5.502","7.689","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.467","5.439","2.636","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.036","4.537","8.060","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":483},{"label":"Mar","value":319},{"label":"Abr","value":438},{"label":"Mai","value":371},{"label":"Jun","value":321},{"label":"Jul","value":267},{"label":"Ago","value":266},{"label":"Set","value":548},{"label":"Out","value":439},{"label":"Nov","value":268},{"label":"Dez","value":437}];
const MX = 548;
