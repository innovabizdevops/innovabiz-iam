...
const PAGE = "Event";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.138","t":"+10.5%","d":"up"},{"l":"Sessões/Dia","v":"141","t":"+11.6%","d":"up"},{"l":"MFA Adoção (%)","v":"72.7%","t":"-5.1%","d":"down"},{"l":"Tentativas Bloqueadas","v":"7.725","t":"+5.0%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.219","1.857","5.892","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.437","6.846","2.577","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.224","950","6.449","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.754","625","2.497","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.523","5.582","3.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":678},{"label":"Mar","value":834},{"label":"Abr","value":775},{"label":"Mai","value":865},{"label":"Jun","value":783},{"label":"Jul","value":893},{"label":"Ago","value":849},{"label":"Set","value":804},{"label":"Out","value":561},{"label":"Nov","value":837},{"label":"Dez","value":875}];
const MX = 893;
