...
/* ═══ Franchise Association — Dashboard ═══ */

const ACCENT = "#60a5fa";

const KPIS = [
    { label: "Total Registos", value: "6228", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1061", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€192K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "528606728", cells: ["FRA-1728", "Franchise Association Item 1", "21/9/2026", "€6828"], status: "active" as const },
    { id: "528610299", cells: ["FRA-5299", "Franchise Association Item 2", "8/4/2026", "€10 399"], status: "pending" as const },
    { id: "528613870", cells: ["FRA-8870", "Franchise Association Item 3", "23/11/2026", "€13 970"], status: "completed" as const },
    { id: "528617441", cells: ["FRA-3441", "Franchise Association Item 4", "10/6/2026", "€17 541"], status: "warning" as const },
    { id: "528621012", cells: ["FRA-7012", "Franchise Association Item 5", "25/1/2026", "€21 112"], status: "active" as const },
];
...
export default function FranchiseAssociationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Association</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Association</p>
                    </div>
                </div>
