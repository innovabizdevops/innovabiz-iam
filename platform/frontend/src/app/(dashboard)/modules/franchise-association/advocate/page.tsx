...
const ACCENT = "#60a5fa";
const MODULE = "Franchise Association";
const PAGE = "Advocate";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.468","t":"+6.8%","d":"up"},{"l":"Sessões/Dia","v":"4457","t":"+14.3%","d":"up"},{"l":"MFA Adoção (%)","v":"94.2%","t":"+14.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.999","t":"+9.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.209","7.002","4.480","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.230","4.544","7.561","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.184","4.362","5.123","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.708","2.275","6.105","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.842","168","3.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":499},{"label":"Mar","value":550},{"label":"Abr","value":720},{"label":"Mai","value":612},{"label":"Jun","value":706},{"label":"Jul","value":762},{"label":"Ago","value":573},{"label":"Set","value":377},{"label":"Out","value":418},{"label":"Nov","value":368},{"label":"Dez","value":563}];
const MX = 762;
