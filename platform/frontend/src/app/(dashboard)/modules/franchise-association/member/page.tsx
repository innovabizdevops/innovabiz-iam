...
const PAGE = "Member";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.385","t":"+6.3%","d":"up"},{"l":"Sessões/Dia","v":"3806","t":"+13.7%","d":"up"},{"l":"MFA Adoção (%)","v":"94.4%","t":"+10.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"289","t":"+8.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","784","4.114","9.039","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.088","8.172","8.087","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.007","2.241","3.002","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.209","4.866","4.329","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.748","7.133","2.276","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":357},{"label":"Mar","value":386},{"label":"Abr","value":600},{"label":"Mai","value":497},{"label":"Jun","value":348},{"label":"Jul","value":349},{"label":"Ago","value":645},{"label":"Set","value":500},{"label":"Out","value":533},{"label":"Nov","value":338},{"label":"Dez","value":568}];
const MX = 645;
