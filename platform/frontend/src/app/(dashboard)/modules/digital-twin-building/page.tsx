...
/* ═══ Digital Twin (Building) — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "3237", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2648", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€26K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1934057237", cells: ["DIG-3237", "Digital Twin (Building) Item 1", "22/6/2026", "€7337"], status: "active" as const },
    { id: "1934060808", cells: ["DIG-6808", "Digital Twin (Building) Item 2", "9/1/2026", "€10 908"], status: "pending" as const },
    { id: "1934064379", cells: ["DIG-1379", "Digital Twin (Building) Item 3", "24/8/2026", "€14 479"], status: "completed" as const },
    { id: "1934067950", cells: ["DIG-4950", "Digital Twin (Building) Item 4", "11/3/2026", "€18 050"], status: "warning" as const },
    { id: "1934071521", cells: ["DIG-8521", "Digital Twin (Building) Item 5", "26/10/2026", "€21 621"], status: "active" as const },
];
...
export default function DigitalTwinBuildingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Twin (Building)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Twin (Building)</p>
                    </div>
                </div>
