...
const ACCENT = "#0369a1";
const MODULE = "Digital Twin (Building)";
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"1.035","t":"-0.5%","d":"down"},{"l":"Simulações/Dia","v":"569","t":"+11.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"87.5%","t":"+0.1%","d":"up"},{"l":"Latência Sync (ms)","v":"51ms","t":"+9.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","80.5%","2026-02-25","8.739","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","99.4%","2026-02-24","8.998","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","70.3%","2026-03-06","8.553","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","96.2%","2026-01-10","969","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","94.8%","2026-01-28","3.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":466},{"label":"Mar","value":520},{"label":"Abr","value":706},{"label":"Mai","value":651},{"label":"Jun","value":714},{"label":"Jul","value":467},{"label":"Ago","value":560},{"label":"Set","value":738},{"label":"Out","value":455},{"label":"Nov","value":418},{"label":"Dez","value":715}];
const MX = 738;
