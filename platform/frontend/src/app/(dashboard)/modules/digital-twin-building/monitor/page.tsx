...
const PAGE = "Monitor";
const KPIS = [{"l":"Twins Ativos","v":"368","t":"+16.9%","d":"up"},{"l":"Simulações/Dia","v":"3320","t":"-0.4%","d":"down"},{"l":"Precisão Modelo (%)","v":"80.3%","t":"+14.1%","d":"up"},{"l":"Latência Sync (ms)","v":"160ms","t":"-4.1%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","71.3%","2026-03-09","5.671","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","97.3%","2026-02-13","1.760","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","77.6%","2026-01-10","1.627","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","99.5%","2026-02-15","8.936","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","99.8%","2026-03-28","738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":807},{"label":"Mar","value":650},{"label":"Abr","value":669},{"label":"Mai","value":832},{"label":"Jun","value":807},{"label":"Jul","value":602},{"label":"Ago","value":671},{"label":"Set","value":537},{"label":"Out","value":699},{"label":"Nov","value":600},{"label":"Dez","value":563}];
const MX = 832;
