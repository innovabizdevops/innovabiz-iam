...
const PAGE = "Model";
const KPIS = [{"l":"Twins Ativos","v":"6.441","t":"+16.0%","d":"up"},{"l":"Simulações/Dia","v":"1369","t":"+6.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"88.9%","t":"-0.5%","d":"down"},{"l":"Latência Sync (ms)","v":"48ms","t":"+14.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","86.3%","2026-03-17","4.518","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","78.5%","2026-01-08","2.012","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","83.2%","2026-02-02","3.991","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","99.4%","2026-03-01","621","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","78.7%","2026-02-08","1.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":536},{"label":"Mar","value":489},{"label":"Abr","value":726},{"label":"Mai","value":593},{"label":"Jun","value":564},{"label":"Jul","value":624},{"label":"Ago","value":779},{"label":"Set","value":812},{"label":"Out","value":879},{"label":"Nov","value":639},{"label":"Dez","value":587}];
const MX = 879;
