...
const PAGE = "Predict";
const KPIS = [{"l":"Twins Ativos","v":"6.339","t":"+2.7%","d":"up"},{"l":"Simulações/Dia","v":"4210","t":"+0.2%","d":"up"},{"l":"Precisão Modelo (%)","v":"84.2%","t":"+2.1%","d":"up"},{"l":"Latência Sync (ms)","v":"128ms","t":"+7.7%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","89.0%","2026-03-18","4.843","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","84.0%","2026-03-10","1.778","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","96.8%","2026-01-13","4.936","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","89.8%","2026-01-26","4.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","99.4%","2026-03-16","459","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":545},{"label":"Mar","value":638},{"label":"Abr","value":519},{"label":"Mai","value":291},{"label":"Jun","value":454},{"label":"Jul","value":497},{"label":"Ago","value":398},{"label":"Set","value":611},{"label":"Out","value":492},{"label":"Nov","value":634},{"label":"Dez","value":582}];
const MX = 638;
