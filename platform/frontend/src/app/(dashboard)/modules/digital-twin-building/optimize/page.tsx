...
const PAGE = "Optimize";
const KPIS = [{"l":"Twins Ativos","v":"7.181","t":"+16.9%","d":"up"},{"l":"Simulações/Dia","v":"3661","t":"+4.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"69.2%","t":"-4.3%","d":"down"},{"l":"Latência Sync (ms)","v":"42ms","t":"+14.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","84.8%","2026-02-21","7.973","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","86.9%","2026-03-06","4.354","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","85.5%","2026-02-09","866","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","74.0%","2026-03-05","3.992","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","98.0%","2026-02-24","2.245","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":798},{"label":"Mar","value":659},{"label":"Abr","value":719},{"label":"Mai","value":735},{"label":"Jun","value":874},{"label":"Jul","value":719},{"label":"Ago","value":635},{"label":"Set","value":783},{"label":"Out","value":801},{"label":"Nov","value":684},{"label":"Dez","value":800}];
const MX = 904;
