...
const PAGE = "Punch-Out Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"6.245","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"3220","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.543","t":"+7.7%","d":"up"},{"l":"Utilizadores Analytics","v":"2.332","t":"+10.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1713","2026-03-22","131","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4443","2026-01-08","8.966","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4551","2026-01-17","1.681","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3341","2026-02-12","2.411","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1441","2026-01-08","2.772","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":384},{"label":"Mar","value":626},{"label":"Abr","value":443},{"label":"Mai","value":648},{"label":"Jun","value":636},{"label":"Jul","value":632},{"label":"Ago","value":575},{"label":"Set","value":493},{"label":"Out","value":411},{"label":"Nov","value":719},{"label":"Dez","value":576}];
const MX = 719;
