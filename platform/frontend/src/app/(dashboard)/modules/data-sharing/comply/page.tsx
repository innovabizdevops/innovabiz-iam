...
const ACCENT = "#1e3a5f";
const MODULE = "Data Sharing Platform";
const PAGE = "Comply";
const KPIS = [{"l":"Dashboards Ativos","v":"4.123","t":"+13.4%","d":"up"},{"l":"Queries/Dia","v":"1198","t":"-1.6%","d":"down"},{"l":"Dados Processados (GB)","v":"1.820","t":"+16.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.678","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1915","2026-01-22","2.664","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4303","2026-01-11","9.095","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2270","2026-01-07","2.587","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1564","2026-02-13","5.615","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3610","2026-03-18","3.233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":486},{"label":"Mar","value":803},{"label":"Abr","value":660},{"label":"Mai","value":629},{"label":"Jun","value":738},{"label":"Jul","value":816},{"label":"Ago","value":483},{"label":"Set","value":850},{"label":"Out","value":751},{"label":"Nov","value":668},{"label":"Dez","value":758}];
const MX = 850;
