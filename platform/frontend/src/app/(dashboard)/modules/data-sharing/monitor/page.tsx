...
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"1.843","t":"+12.9%","d":"up"},{"l":"Queries/Dia","v":"400","t":"+14.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.514","t":"-4.9%","d":"down"},{"l":"Utilizadores Analytics","v":"199","t":"+6.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3382","2026-01-18","6.882","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2429","2026-02-08","5.293","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2521","2026-02-01","5.126","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3595","2026-03-09","2.708","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4446","2026-02-09","4.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":552},{"label":"Mar","value":592},{"label":"Abr","value":500},{"label":"Mai","value":714},{"label":"Jun","value":892},{"label":"Jul","value":786},{"label":"Ago","value":776},{"label":"Set","value":592},{"label":"Out","value":516},{"label":"Nov","value":723},{"label":"Dez","value":769}];
const MX = 892;
