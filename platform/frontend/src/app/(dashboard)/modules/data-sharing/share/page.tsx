...
const PAGE = "Share";
const KPIS = [{"l":"Dashboards Ativos","v":"7.668","t":"+11.6%","d":"up"},{"l":"Queries/Dia","v":"2266","t":"-4.9%","d":"down"},{"l":"Dados Processados (GB)","v":"4.034","t":"-3.0%","d":"down"},{"l":"Utilizadores Analytics","v":"5.008","t":"+8.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3446","2026-03-23","7.414","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1955","2026-02-09","7.959","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","903","2026-02-21","738","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3741","2026-02-11","2.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4967","2026-02-12","5.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":641},{"label":"Mar","value":721},{"label":"Abr","value":475},{"label":"Mai","value":446},{"label":"Jun","value":763},{"label":"Jul","value":433},{"label":"Ago","value":780},{"label":"Set","value":449},{"label":"Out","value":572},{"label":"Nov","value":609},{"label":"Dez","value":702}];
const MX = 780;
