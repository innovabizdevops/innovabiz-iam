...
const PAGE = "Prepare";
const KPIS = [{"l":"Dashboards Ativos","v":"1.828","t":"+15.2%","d":"up"},{"l":"Queries/Dia","v":"1966","t":"+5.9%","d":"up"},{"l":"Dados Processados (GB)","v":"847","t":"+5.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.598","t":"+8.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2608","2026-03-06","7.696","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2388","2026-03-02","2.796","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3111","2026-03-28","8.013","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4459","2026-02-26","1.398","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2672","2026-02-19","284","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":362},{"label":"Mar","value":463},{"label":"Abr","value":420},{"label":"Mai","value":612},{"label":"Jun","value":255},{"label":"Jul","value":331},{"label":"Ago","value":441},{"label":"Set","value":569},{"label":"Out","value":320},{"label":"Nov","value":370},{"label":"Dez","value":516}];
const MX = 612;
