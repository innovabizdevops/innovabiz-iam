...
const PAGE = "Agree";
const KPIS = [{"l":"Dashboards Ativos","v":"3.987","t":"-1.9%","d":"down"},{"l":"Queries/Dia","v":"1641","t":"-5.8%","d":"down"},{"l":"Dados Processados (GB)","v":"993","t":"+12.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.086","t":"-4.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1056","2026-01-27","3.198","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3733","2026-03-25","1.918","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4804","2026-03-08","8.221","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","762","2026-02-24","8.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4112","2026-02-18","2.268","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":706},{"label":"Mar","value":732},{"label":"Abr","value":743},{"label":"Mai","value":551},{"label":"Jun","value":897},{"label":"Jul","value":842},{"label":"Ago","value":560},{"label":"Set","value":838},{"label":"Out","value":770},{"label":"Nov","value":635},{"label":"Dez","value":589}];
const MX = 897;
