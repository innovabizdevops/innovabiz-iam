...
/* ═══ Data Sharing Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8140", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "634", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€241K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1999590240", cells: ["DAT-7240", "Data Sharing Platform Item 1", "5/1/2026", "€40 340"], status: "active" as const },
    { id: "1999593811", cells: ["DAT-1811", "Data Sharing Platform Item 2", "20/8/2026", "€43 911"], status: "pending" as const },
    { id: "1999597382", cells: ["DAT-5382", "Data Sharing Platform Item 3", "7/3/2026", "€47 482"], status: "completed" as const },
    { id: "1999600953", cells: ["DAT-8953", "Data Sharing Platform Item 4", "22/10/2026", "€1053"], status: "warning" as const },
    { id: "1999604524", cells: ["DAT-3524", "Data Sharing Platform Item 5", "9/5/2026", "€4624"], status: "active" as const },
];
...
export default function DataSharingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Sharing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Sharing Platform</p>
                    </div>
                </div>
