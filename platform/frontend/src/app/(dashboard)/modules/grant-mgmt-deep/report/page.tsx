...
const PAGE = "Report";
const KPIS = [{"l":"Total Grant Mgmt Deep","v":"4.417","t":"+12.9%","d":"up"},{"l":"Report Ativos","v":"7.671","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+1.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Mgmt Deep #001","Grant Mgmt Deep #002","101","1.134","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Mgmt Deep #002","Grant Mgmt Deep #003","7.255","8.943","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Mgmt Deep #003","Grant Mgmt Deep #004","8.700","1.136","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Mgmt Deep #004","Grant Mgmt Deep #005","4.147","5.027","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Mgmt Deep #005","Grant Mgmt Deep #001","8.572","7.560","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1038},{"label":"Fev","value":872},{"label":"Mar","value":867},{"label":"Abr","value":913},{"label":"Mai","value":727},{"label":"Jun","value":1001},{"label":"Jul","value":774},{"label":"Ago","value":834},{"label":"Set","value":863},{"label":"Out","value":910},{"label":"Nov","value":690},{"label":"Dez","value":728}];
const MX = 1038;
