...
const ACCENT = "#9333ea";
const MODULE = "Grant Management Deep";
const PAGE = "Find";
const KPIS = [{"l":"Total Grant Mgmt Deep","v":"8.475","t":"+15.4%","d":"up"},{"l":"Find Ativos","v":"2.348","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"94","t":"+10.8%","d":"up"}];
const COLS = ["ID","Find","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Mgmt Deep #001","Grant Mgmt Deep #002","5.847","245","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Mgmt Deep #002","Grant Mgmt Deep #003","5.685","1.018","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Mgmt Deep #003","Grant Mgmt Deep #004","7.661","195","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Mgmt Deep #004","Grant Mgmt Deep #005","2.196","8.449","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Mgmt Deep #005","Grant Mgmt Deep #001","4.436","2.863","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":561},{"label":"Mar","value":606},{"label":"Abr","value":638},{"label":"Mai","value":862},{"label":"Jun","value":509},{"label":"Jul","value":531},{"label":"Ago","value":748},{"label":"Set","value":849},{"label":"Out","value":591},{"label":"Nov","value":564},{"label":"Dez","value":684}];
const MX = 862;
