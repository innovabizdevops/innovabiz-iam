...
/* ═══ Grant Management Deep — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "7794", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1744", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€99K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1824379694", cells: ["GRA-8694", "Grant Management Deep Item 1", "19/3/2026", "€29 794"], status: "active" as const },
    { id: "1824383265", cells: ["GRA-3265", "Grant Management Deep Item 2", "6/10/2026", "€33 365"], status: "pending" as const },
    { id: "1824386836", cells: ["GRA-6836", "Grant Management Deep Item 3", "21/5/2026", "€36 936"], status: "completed" as const },
    { id: "1824390407", cells: ["GRA-1407", "Grant Management Deep Item 4", "8/12/2026", "€40 507"], status: "warning" as const },
    { id: "1824393978", cells: ["GRA-4978", "Grant Management Deep Item 5", "23/7/2026", "€44 078"], status: "active" as const },
];
...
export default function GrantManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grant Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Grant Management Deep</p>
                    </div>
                </div>
