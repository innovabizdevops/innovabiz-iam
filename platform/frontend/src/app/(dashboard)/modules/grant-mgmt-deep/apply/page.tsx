...
const PAGE = "Apply";
const KPIS = [{"l":"Total Grant Mgmt Deep","v":"7.046","t":"+12.9%","d":"up"},{"l":"Apply Ativos","v":"4.800","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"91.5%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"70","t":"+5.2%","d":"up"}];
const COLS = ["ID","Apply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Mgmt Deep #001","Grant Mgmt Deep #002","956","4.664","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Mgmt Deep #002","Grant Mgmt Deep #003","5.722","6.340","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Mgmt Deep #003","Grant Mgmt Deep #004","2.637","3.210","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Mgmt Deep #004","Grant Mgmt Deep #005","2.823","8.171","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Mgmt Deep #005","Grant Mgmt Deep #001","2.045","2.301","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":796},{"label":"Mar","value":764},{"label":"Abr","value":1019},{"label":"Mai","value":1070},{"label":"Jun","value":707},{"label":"Jul","value":1074},{"label":"Ago","value":930},{"label":"Set","value":703},{"label":"Out","value":709},{"label":"Nov","value":1044},{"label":"Dez","value":820}];
const MX = 1074;
