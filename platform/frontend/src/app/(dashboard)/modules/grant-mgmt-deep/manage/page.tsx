...
const PAGE = "Manage";
const KPIS = [{"l":"Total Grant Mgmt Deep","v":"6.115","t":"+15.7%","d":"up"},{"l":"Manage Ativos","v":"5.152","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.1%","d":"up"}];
const COLS = ["ID","Manage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grant Mgmt Deep #001","Grant Mgmt Deep #002","5.826","2.390","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Grant Mgmt Deep #002","Grant Mgmt Deep #003","734","1.612","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Grant Mgmt Deep #003","Grant Mgmt Deep #004","5.316","5.227","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Grant Mgmt Deep #004","Grant Mgmt Deep #005","8.873","4.681","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grant Mgmt Deep #005","Grant Mgmt Deep #001","3.594","3.421","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":923},{"label":"Mar","value":605},{"label":"Abr","value":767},{"label":"Mai","value":585},{"label":"Jun","value":871},{"label":"Jul","value":536},{"label":"Ago","value":594},{"label":"Set","value":595},{"label":"Out","value":742},{"label":"Nov","value":858},{"label":"Dez","value":710}];
const MX = 923;
