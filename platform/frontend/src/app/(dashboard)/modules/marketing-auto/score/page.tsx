...
const ACCENT = "#6366f1";
const MODULE = "Marketing Automation";
const PAGE = "Lead Score";
const KPIS = [{"l":"Total Marketing Auto","v":"2.094","t":"+5.8%","d":"up"},{"l":"Lead Score Ativos","v":"77","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"87.2%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.0%","d":"up"}];
const COLS = ["ID","Lead Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Auto #001","88.3%","2.956","1.244","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Auto #002","80.7%","6.080","4.588","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Auto #003","78.8%","517","4.274","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Auto #004","73.2%","4.322","5.067","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Auto #005","94.3%","3.388","7.859","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":692},{"label":"Mar","value":709},{"label":"Abr","value":811},{"label":"Mai","value":949},{"label":"Jun","value":753},{"label":"Jul","value":856},{"label":"Ago","value":740},{"label":"Set","value":1026},{"label":"Out","value":894},{"label":"Nov","value":885},{"label":"Dez","value":1079}];
const MX = 1079;
