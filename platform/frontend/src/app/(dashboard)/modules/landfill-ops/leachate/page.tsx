...
const PAGE = "Leachate";
const KPIS = [{"l":"Teams Ativos","v":"3.007","t":"+13.7%","d":"up"},{"l":"Reuniões/Semana","v":"3870","t":"+3.3%","d":"up"},{"l":"Mensagens/Dia","v":"2325","t":"+5.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.946","t":"+14.1%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.329","812","1.176","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.369","1199","7.694","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.706","754","8.639","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.833","2918","4.267","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.982","356","1.255","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":537},{"label":"Mar","value":715},{"label":"Abr","value":496},{"label":"Mai","value":614},{"label":"Jun","value":716},{"label":"Jul","value":773},{"label":"Ago","value":604},{"label":"Set","value":479},{"label":"Out","value":494},{"label":"Nov","value":447},{"label":"Dez","value":777}];
const MX = 777;
...
export default function LeachatePage() {
    return (
