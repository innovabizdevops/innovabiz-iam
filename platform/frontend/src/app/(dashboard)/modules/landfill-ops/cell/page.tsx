...
const PAGE = "Cell Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.387","t":"+4.2%","d":"up"},{"l":"Submissões/Dia","v":"2964","t":"+8.6%","d":"up"},{"l":"Documentos Gerados","v":"4.695","t":"+12.3%","d":"up"},{"l":"Templates","v":"7.239","t":"+9.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.912","2026-01-16","5.274","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","353","2026-02-10","945","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.140","2026-03-15","1.747","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","9.040","2026-01-09","2.705","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.600","2026-03-25","5.296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1044},{"label":"Fev","value":822},{"label":"Mar","value":909},{"label":"Abr","value":1070},{"label":"Mai","value":1067},{"label":"Jun","value":910},{"label":"Jul","value":861},{"label":"Ago","value":753},{"label":"Set","value":673},{"label":"Out","value":887},{"label":"Nov","value":734},{"label":"Dez","value":900}];
const MX = 1070;
