...
export default function LandfillOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Landfill Ops</h1><p className="text-sm text-muted-foreground">Landfill Ops • iBOS Enterprise</p></div>
