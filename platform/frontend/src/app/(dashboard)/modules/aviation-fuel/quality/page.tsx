...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.382","t":"-2.5%","d":"down"},{"l":"NC Abertas","v":"4.957","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"75.7%","t":"+2.8%","d":"up"},{"l":"CAPAs Pendentes","v":"3.437","t":"+1.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.768","93.2%","8.842","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.127","99.7%","8.853","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.353","78.5%","3.554","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.378","78.8%","2.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.971","83.7%","494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1039},{"label":"Fev","value":1007},{"label":"Mar","value":903},{"label":"Abr","value":855},{"label":"Mai","value":985},{"label":"Jun","value":859},{"label":"Jul","value":841},{"label":"Ago","value":756},{"label":"Set","value":814},{"label":"Out","value":773},{"label":"Nov","value":749},{"label":"Dez","value":952}];
const MX = 1039;
