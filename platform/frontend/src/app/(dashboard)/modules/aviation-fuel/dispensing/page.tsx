...
const PAGE = "Dispensing";
const KPIS = [{"l":"Total Aviation Fuel","v":"1.646","t":"-2.7%","d":"down"},{"l":"Dispensing Ativos","v":"4.800","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"67","t":"+9.4%","d":"up"}];
const COLS = ["ID","Dispensing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Fuel #001","Aviation Fuel #002","435","4.283","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Fuel #002","Aviation Fuel #003","918","5.954","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Fuel #003","Aviation Fuel #004","2.409","4.401","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Fuel #004","Aviation Fuel #005","2.791","6.805","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Fuel #005","Aviation Fuel #001","556","7.995","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":613},{"label":"Mar","value":667},{"label":"Abr","value":726},{"label":"Mai","value":680},{"label":"Jun","value":845},{"label":"Jul","value":798},{"label":"Ago","value":553},{"label":"Set","value":536},{"label":"Out","value":566},{"label":"Nov","value":612},{"label":"Dez","value":836}];
const MX = 845;
