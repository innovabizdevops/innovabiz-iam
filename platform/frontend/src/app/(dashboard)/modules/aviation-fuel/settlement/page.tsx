...
const KPIS = [{"l":"Total Aviation Fuel","v":"4.876","t":"+9.9%","d":"up"},{"l":"Settlement Ativos","v":"6.304","t":"+12.6%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"72","t":"+16.5%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Fuel #001","Aviation Fuel #002","7.947","3.849","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Fuel #002","Aviation Fuel #003","6.341","200","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Fuel #003","Aviation Fuel #004","1.626","2.184","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Fuel #004","Aviation Fuel #005","1.014","8.433","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Fuel #005","Aviation Fuel #001","7.932","6.166","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":826},{"label":"Mar","value":904},{"label":"Abr","value":996},{"label":"Mai","value":817},{"label":"Jun","value":731},{"label":"Jul","value":781},{"label":"Ago","value":965},{"label":"Set","value":717},{"label":"Out","value":1031},{"label":"Nov","value":858},{"label":"Dez","value":976}];
const MX = 1031;
