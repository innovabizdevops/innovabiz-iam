...
const PAGE = "Storage";
const KPIS = [{"l":"Total Aviation Fuel","v":"2.387","t":"-6.0%","d":"down"},{"l":"Storage Ativos","v":"3.010","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"73.8%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+3.9%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Fuel #001","Aviation Fuel #002","799","111","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Fuel #002","Aviation Fuel #003","583","3.902","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Fuel #003","Aviation Fuel #004","158","2.692","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Fuel #004","Aviation Fuel #005","8.491","1.734","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Fuel #005","Aviation Fuel #001","737","8.625","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":939},{"label":"Fev","value":806},{"label":"Mar","value":716},{"label":"Abr","value":793},{"label":"Mai","value":760},{"label":"Jun","value":854},{"label":"Jul","value":948},{"label":"Ago","value":1036},{"label":"Set","value":1072},{"label":"Out","value":762},{"label":"Nov","value":1037},{"label":"Dez","value":858}];
const MX = 1072;
