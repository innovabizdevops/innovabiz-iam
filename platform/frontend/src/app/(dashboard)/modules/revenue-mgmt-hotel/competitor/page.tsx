...
const PAGE = "Competitor Rate";
const KPIS = [{"l":"ARR (€M)","v":"€33.8M","t":"-0.4%","d":"down"},{"l":"MRR (€)","v":"€86890","t":"-1.3%","d":"down"},{"l":"Churn (%)","v":"82.5%","t":"+9.2%","d":"up"},{"l":"ARPU (€)","v":"€53734","t":"+10.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 38578.39","7.738","€ 5556.88","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 49863.72","5.303","€ 19821.15","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23440.22","8.655","€ 15652.78","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49422.78","1.574","€ 36386.90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16623.31","5.009","€ 27962.21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":966},{"label":"Mar","value":897},{"label":"Abr","value":908},{"label":"Mai","value":907},{"label":"Jun","value":591},{"label":"Jul","value":603},{"label":"Ago","value":741},{"label":"Set","value":938},{"label":"Out","value":728},{"label":"Nov","value":911},{"label":"Dez","value":939}];
const MX = 966;
