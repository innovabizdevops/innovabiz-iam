...
const KPIS = [{"l":"ARR (€M)","v":"€9.5M","t":"+16.4%","d":"up"},{"l":"MRR (€)","v":"€87851","t":"+6.6%","d":"up"},{"l":"Churn (%)","v":"88.8%","t":"+0.8%","d":"up"},{"l":"ARPU (€)","v":"€36596","t":"+0.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7804.78","5.949","€ 46640.27","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 20754.47","6.285","€ 5393.43","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 33662.64","3.747","€ 35414.07","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47690.59","7.313","€ 40180.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8782.79","4.346","€ 14723.52","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":250},{"label":"Mar","value":222},{"label":"Abr","value":365},{"label":"Mai","value":326},{"label":"Jun","value":493},{"label":"Jul","value":565},{"label":"Ago","value":258},{"label":"Set","value":237},{"label":"Out","value":539},{"label":"Nov","value":509},{"label":"Dez","value":380}];
const MX = 565;
