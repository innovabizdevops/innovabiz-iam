...
const PAGE = "RevPAR Track";
const KPIS = [{"l":"ARR (€M)","v":"€16.0M","t":"-5.0%","d":"down"},{"l":"MRR (€)","v":"€35721","t":"+8.2%","d":"up"},{"l":"Churn (%)","v":"86.5%","t":"+6.4%","d":"up"},{"l":"ARPU (€)","v":"€1694","t":"+5.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 8435.93","7.547","€ 38316.57","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 12755.94","7.868","€ 48853.49","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 43818.20","3.864","€ 31597.82","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 21106.74","7.338","€ 112.06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5477.16","3.589","€ 1628.43","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":578},{"label":"Mar","value":353},{"label":"Abr","value":473},{"label":"Mai","value":522},{"label":"Jun","value":654},{"label":"Jul","value":583},{"label":"Ago","value":670},{"label":"Set","value":633},{"label":"Out","value":406},{"label":"Nov","value":620},{"label":"Dez","value":631}];
const MX = 670;
