...
export default function RevenueMgmtHotelPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Revenue Mgmt Hotel</h1><p className="text-sm text-muted-foreground">Revenue Mgmt Hotel • iBOS Enterprise</p></div>
