...
const ACCENT = "#dc2626";
const MODULE = "Revenue Management";
const PAGE = "Demand Forecast";
const KPIS = [{"l":"ARR (€M)","v":"€29.6M","t":"+14.7%","d":"up"},{"l":"MRR (€)","v":"€77987","t":"+14.1%","d":"up"},{"l":"Churn (%)","v":"71.9%","t":"+15.1%","d":"up"},{"l":"ARPU (€)","v":"€29949","t":"+5.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 48473.17","7.440","€ 23307.90","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9826.18","461","€ 6617.15","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17988.55","4.747","€ 21556.55","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 23956.74","7.017","€ 24087.46","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 22668.67","3.360","€ 22673.14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":684},{"label":"Mar","value":751},{"label":"Abr","value":583},{"label":"Mai","value":789},{"label":"Jun","value":660},{"label":"Jul","value":648},{"label":"Ago","value":812},{"label":"Set","value":760},{"label":"Out","value":528},{"label":"Nov","value":478},{"label":"Dez","value":475}];
const MX = 812;
