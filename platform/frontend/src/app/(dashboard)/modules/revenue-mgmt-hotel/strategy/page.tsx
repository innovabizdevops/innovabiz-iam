...
const KPIS = [{"l":"ARR (€M)","v":"€1.0M","t":"+11.0%","d":"up"},{"l":"MRR (€)","v":"€60979","t":"+8.3%","d":"up"},{"l":"Churn (%)","v":"85.4%","t":"+0.6%","d":"up"},{"l":"ARPU (€)","v":"€37568","t":"+14.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7406.71","6.448","€ 5575.15","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 3117.11","5.052","€ 35822.81","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25582.51","6.676","€ 3300.71","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 29317.37","3.027","€ 24899.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16641.97","6.278","€ 35030.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":972},{"label":"Fev","value":907},{"label":"Mar","value":640},{"label":"Abr","value":956},{"label":"Mai","value":736},{"label":"Jun","value":788},{"label":"Jul","value":662},{"label":"Ago","value":611},{"label":"Set","value":962},{"label":"Out","value":946},{"label":"Nov","value":681},{"label":"Dez","value":856}];
const MX = 972;
