...
const PAGE = "KPI";
const KPIS = [{"l":"Teams Ativos","v":"3.176","t":"+12.3%","d":"up"},{"l":"Reuniões/Semana","v":"1064","t":"-4.8%","d":"down"},{"l":"Mensagens/Dia","v":"2397","t":"+1.3%","d":"up"},{"l":"Ficheiros Partilhados","v":"9.056","t":"-4.7%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.962","4235","5.326","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.128","107","4.631","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.550","394","322","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.187","4460","2.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.952","1074","7.618","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":904},{"label":"Mar","value":745},{"label":"Abr","value":872},{"label":"Mai","value":697},{"label":"Jun","value":774},{"label":"Jul","value":787},{"label":"Ago","value":908},{"label":"Set","value":1015},{"label":"Out","value":958},{"label":"Nov","value":956},{"label":"Dez","value":683}];
const MX = 1015;
