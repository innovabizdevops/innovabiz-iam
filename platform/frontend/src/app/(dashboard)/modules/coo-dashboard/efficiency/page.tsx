...
const KPIS = [{"l":"Teams Ativos","v":"5.621","t":"-5.2%","d":"down"},{"l":"Reuniões/Semana","v":"2505","t":"+8.0%","d":"up"},{"l":"Mensagens/Dia","v":"2344","t":"-3.8%","d":"down"},{"l":"Ficheiros Partilhados","v":"7.642","t":"+14.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.711","2469","8.149","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.436","293","7.040","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.209","273","4.801","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","542","3757","5.554","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.648","1897","7.280","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":649},{"label":"Mar","value":726},{"label":"Abr","value":882},{"label":"Mai","value":737},{"label":"Jun","value":708},{"label":"Jul","value":609},{"label":"Ago","value":876},{"label":"Set","value":913},{"label":"Out","value":990},{"label":"Nov","value":597},{"label":"Dez","value":750}];
const MX = 990;
