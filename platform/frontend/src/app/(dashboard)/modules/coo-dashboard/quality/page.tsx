...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.456","t":"-5.6%","d":"down"},{"l":"NC Abertas","v":"4.716","t":"-4.8%","d":"down"},{"l":"Conformidade (%)","v":"66.4%","t":"+5.0%","d":"up"},{"l":"CAPAs Pendentes","v":"6.197","t":"+16.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.309","89.8%","9.091","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.947","87.1%","8.393","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.133","81.0%","7.660","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","421","71.4%","8.633","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.768","86.3%","3.511","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":389},{"label":"Mar","value":617},{"label":"Abr","value":493},{"label":"Mai","value":527},{"label":"Jun","value":277},{"label":"Jul","value":615},{"label":"Ago","value":312},{"label":"Set","value":249},{"label":"Out","value":327},{"label":"Nov","value":536},{"label":"Dez","value":467}];
const MX = 617;
