...
const ACCENT = "#1e293b";
const MODULE = "COO Dashboard";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"6.781","t":"+8.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"65.8%","t":"-2.5%","d":"down"},{"l":"Taxa Abertura (%)","v":"67.5%","t":"+0.0%","d":"up"},{"l":"Escalações","v":"6.342","t":"+12.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.785","94.5%","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","903","92.5%","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.740","98.0%","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.020","77.3%","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","7.870","95.4%","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":809},{"label":"Mar","value":907},{"label":"Abr","value":704},{"label":"Mai","value":818},{"label":"Jun","value":615},{"label":"Jul","value":899},{"label":"Ago","value":733},{"label":"Set","value":678},{"label":"Out","value":620},{"label":"Nov","value":674},{"label":"Dez","value":903}];
const MX = 907;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e293b'}}>RTM</span></h1>
                </div>
