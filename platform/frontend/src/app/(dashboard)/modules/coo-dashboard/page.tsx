...
/* ═══ COO Dashboard — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "6945", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2351", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€90K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1501232945", cells: ["COO-6945", "COO Dashboard Item 1", "10/6/2026", "€33 045"], status: "active" as const },
    { id: "1501236516", cells: ["COO-1516", "COO Dashboard Item 2", "25/1/2026", "€36 616"], status: "pending" as const },
    { id: "1501240087", cells: ["COO-5087", "COO Dashboard Item 3", "12/8/2026", "€40 187"], status: "completed" as const },
    { id: "1501243658", cells: ["COO-8658", "COO Dashboard Item 4", "27/3/2026", "€43 758"], status: "warning" as const },
    { id: "1501247229", cells: ["COO-3229", "COO Dashboard Item 5", "14/10/2026", "€47 329"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COO Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COO Dashboard</p>
                    </div>
                </div>
