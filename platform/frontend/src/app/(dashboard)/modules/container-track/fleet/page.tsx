...
const PAGE = "Fleet View";
const KPIS = [{"l":"Total Container Track","v":"3.105","t":"+9.4%","d":"up"},{"l":"Fleet View Ativos","v":"2.555","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"62","t":"+15.9%","d":"up"}];
const COLS = ["ID","Fleet View","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Track #001","Container Track #002","1.825","7.134","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Container Track #002","Container Track #003","4.435","4.043","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Track #003","Container Track #004","7.432","2.138","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Container Track #004","Container Track #005","2.291","8.718","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Track #005","Container Track #001","2.621","1.467","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":865},{"label":"Mar","value":929},{"label":"Abr","value":966},{"label":"Mai","value":965},{"label":"Jun","value":912},{"label":"Jul","value":706},{"label":"Ago","value":953},{"label":"Set","value":905},{"label":"Out","value":869},{"label":"Nov","value":905},{"label":"Dez","value":802}];
const MX = 966;
