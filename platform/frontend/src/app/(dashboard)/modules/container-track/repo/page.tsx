...
const PAGE = "Repo Mgmt";
const KPIS = [{"l":"Total Container Track","v":"8.246","t":"+8.7%","d":"up"},{"l":"Repo Mgmt Ativos","v":"3.690","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"71.7%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"69","t":"-2.1%","d":"down"}];
const COLS = ["ID","Repo Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Track #001","Container Track #002","8.943","2.741","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Container Track #002","Container Track #003","6.343","1.028","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Track #003","Container Track #004","7.464","4.173","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Container Track #004","Container Track #005","409","3.009","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Track #005","Container Track #001","4.019","8.772","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":670},{"label":"Mar","value":838},{"label":"Abr","value":559},{"label":"Mai","value":700},{"label":"Jun","value":566},{"label":"Jul","value":614},{"label":"Ago","value":903},{"label":"Set","value":943},{"label":"Out","value":874},{"label":"Nov","value":605},{"label":"Dez","value":940}];
const MX = 943;
