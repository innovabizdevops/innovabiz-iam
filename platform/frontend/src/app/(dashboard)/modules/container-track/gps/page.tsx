...
const ACCENT = "#b45309";
const MODULE = "Container Tracking";
const PAGE = "GPS Track";
const KPIS = [{"l":"Total Container Track","v":"1.742","t":"-5.8%","d":"down"},{"l":"GPS Track Ativos","v":"7.064","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"94.1%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"91","t":"-4.9%","d":"down"}];
const COLS = ["ID","GPS Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Track #001","Container Track #002","7.014","2.170","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Container Track #002","Container Track #003","5.233","5.819","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Track #003","Container Track #004","2.297","3.914","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Container Track #004","Container Track #005","6.815","9.025","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Track #005","Container Track #001","5.605","1.202","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":849},{"label":"Mar","value":693},{"label":"Abr","value":694},{"label":"Mai","value":831},{"label":"Jun","value":779},{"label":"Jul","value":603},{"label":"Ago","value":580},{"label":"Set","value":703},{"label":"Out","value":920},{"label":"Nov","value":883},{"label":"Dez","value":801}];
const MX = 920;
