...
const KPIS = [{"l":"Total Container Track","v":"4.442","t":"-4.6%","d":"down"},{"l":"Condition Ativos","v":"6.163","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"70","t":"+6.2%","d":"up"}];
const COLS = ["ID","Condition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Container Track #001","Container Track #002","4.936","5.907","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Container Track #002","Container Track #003","7.514","1.649","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Container Track #003","Container Track #004","7.012","7.636","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Container Track #004","Container Track #005","2.446","1.286","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Container Track #005","Container Track #001","8.646","4.036","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":744},{"label":"Mar","value":710},{"label":"Abr","value":1024},{"label":"Mai","value":891},{"label":"Jun","value":711},{"label":"Jul","value":951},{"label":"Ago","value":831},{"label":"Set","value":937},{"label":"Out","value":795},{"label":"Nov","value":848},{"label":"Dez","value":914}];
const MX = 1024;
