...
const ACCENT = "#6366f1";
const MODULE = "Embedded Finance";
const PAGE = "API";
const KPIS = [{"l":"Dashboards Ativos","v":"935","t":"+15.3%","d":"up"},{"l":"Queries/Dia","v":"3089","t":"+13.6%","d":"up"},{"l":"Dados Processados (GB)","v":"7.644","t":"+11.8%","d":"up"},{"l":"Utilizadores Analytics","v":"1.727","t":"+15.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4163","2026-02-14","3.031","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2774","2026-02-27","738","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2537","2026-02-15","1.963","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1934","2026-03-02","3.539","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","425","2026-02-21","735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":335},{"label":"Mar","value":536},{"label":"Abr","value":252},{"label":"Mai","value":379},{"label":"Jun","value":588},{"label":"Jul","value":272},{"label":"Ago","value":446},{"label":"Set","value":256},{"label":"Out","value":437},{"label":"Nov","value":404},{"label":"Dez","value":257}];
const MX = 633;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>API</span></h1>
                </div>
