...
const PAGE = "Lending";
const KPIS = [{"l":"Dashboards Ativos","v":"2.039","t":"+16.8%","d":"up"},{"l":"Queries/Dia","v":"1928","t":"-3.5%","d":"down"},{"l":"Dados Processados (GB)","v":"3.138","t":"+3.5%","d":"up"},{"l":"Utilizadores Analytics","v":"506","t":"+0.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2290","2026-03-20","5.539","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2436","2026-02-05","2.262","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2471","2026-02-10","2.261","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2012","2026-01-12","5.668","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2208","2026-01-01","5.141","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1047},{"label":"Fev","value":1035},{"label":"Mar","value":1013},{"label":"Abr","value":670},{"label":"Mai","value":892},{"label":"Jun","value":940},{"label":"Jul","value":1003},{"label":"Ago","value":847},{"label":"Set","value":1015},{"label":"Out","value":1032},{"label":"Nov","value":651},{"label":"Dez","value":734}];
const MX = 1047;
