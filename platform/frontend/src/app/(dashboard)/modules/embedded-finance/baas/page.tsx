...
const PAGE = "BaaS";
const KPIS = [{"l":"Dashboards Ativos","v":"6.051","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"4866","t":"+3.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.769","t":"+2.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.559","t":"+8.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3265","2026-02-20","621","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4639","2026-03-10","8.449","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2645","2026-01-21","4.354","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","654","2026-01-05","1.714","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1992","2026-02-27","649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":415},{"label":"Mar","value":250},{"label":"Abr","value":417},{"label":"Mai","value":472},{"label":"Jun","value":554},{"label":"Jul","value":604},{"label":"Ago","value":503},{"label":"Set","value":397},{"label":"Out","value":568},{"label":"Nov","value":540},{"label":"Dez","value":410}];
const MX = 604;
