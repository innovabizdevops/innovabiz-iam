...
const PAGE = "Payment";
const KPIS = [{"l":"Dashboards Ativos","v":"5.945","t":"+14.6%","d":"up"},{"l":"Queries/Dia","v":"4109","t":"+7.5%","d":"up"},{"l":"Dados Processados (GB)","v":"4.809","t":"+2.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.396","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4133","2026-01-25","2.025","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","717","2026-03-03","9.057","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2678","2026-01-05","3.777","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3566","2026-02-17","4.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4602","2026-03-23","366","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":541},{"label":"Mar","value":826},{"label":"Abr","value":550},{"label":"Mai","value":893},{"label":"Jun","value":652},{"label":"Jul","value":784},{"label":"Ago","value":803},{"label":"Set","value":647},{"label":"Out","value":564},{"label":"Nov","value":525},{"label":"Dez","value":591}];
const MX = 893;
