...
const KPIS = [{"l":"Dashboards Ativos","v":"7.879","t":"+16.2%","d":"up"},{"l":"Queries/Dia","v":"515","t":"+15.4%","d":"up"},{"l":"Dados Processados (GB)","v":"3.075","t":"-4.1%","d":"down"},{"l":"Utilizadores Analytics","v":"4.483","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2197","2026-02-10","5.137","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1078","2026-01-07","229","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3005","2026-02-16","7.315","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3570","2026-02-14","7.903","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1264","2026-01-05","738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":499},{"label":"Mar","value":540},{"label":"Abr","value":723},{"label":"Mai","value":595},{"label":"Jun","value":661},{"label":"Jul","value":490},{"label":"Ago","value":495},{"label":"Set","value":647},{"label":"Out","value":689},{"label":"Nov","value":706},{"label":"Dez","value":543}];
const MX = 723;
