...
const PAGE = "Compliance AML";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.952","t":"-3.6%","d":"down"},{"l":"NC Abertas","v":"6.948","t":"-0.8%","d":"down"},{"l":"Conformidade (%)","v":"90.7%","t":"+13.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.235","t":"+1.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","481","98.7%","2.496","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.696","95.6%","5.403","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.247","91.1%","2.945","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","217","98.6%","8.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.378","93.6%","4.526","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":626},{"label":"Mar","value":713},{"label":"Abr","value":516},{"label":"Mai","value":753},{"label":"Jun","value":545},{"label":"Jul","value":802},{"label":"Ago","value":736},{"label":"Set","value":595},{"label":"Out","value":603},{"label":"Nov","value":565},{"label":"Dez","value":769}];
const MX = 802;
