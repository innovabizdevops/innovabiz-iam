...
const PAGE = "Limites &amp; Alertas";
const KPIS = [{"l":"Notificações Enviadas","v":"218","t":"-3.1%","d":"down"},{"l":"Taxa Entrega (%)","v":"90.0%","t":"+0.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"94.2%","t":"+4.6%","d":"up"},{"l":"Escalações","v":"7.843","t":"+16.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.753","83.3%","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.606","79.5%","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.285","82.9%","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.254","93.1%","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.398","77.0%","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":244},{"label":"Fev","value":472},{"label":"Mar","value":582},{"label":"Abr","value":541},{"label":"Mai","value":567},{"label":"Jun","value":295},{"label":"Jul","value":255},{"label":"Ago","value":247},{"label":"Set","value":274},{"label":"Out","value":430},{"label":"Nov","value":320},{"label":"Dez","value":630}];
const MX = 630;
