...
const PAGE = "Compra/Venda";
const KPIS = [{"l":"Vendas YTD (€)","v":"€45290","t":"+7.0%","d":"up"},{"l":"Pipeline (€)","v":"€54142","t":"+17.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.3%","t":"+5.6%","d":"up"},{"l":"Win Rate (%)","v":"72.7%","t":"+7.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7423.35","€ 39925.17","€ 16942.59","87.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 15021.66","€ 37561.10","€ 31593.89","98.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 4522.82","€ 16615.98","€ 24750.21","81.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 27004.66","€ 4775.22","€ 10325.70","73.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31332.83","€ 19898.00","€ 31610.06","78.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":663},{"label":"Mar","value":674},{"label":"Abr","value":527},{"label":"Mai","value":716},{"label":"Jun","value":331},{"label":"Jul","value":469},{"label":"Ago","value":464},{"label":"Set","value":329},{"label":"Out","value":698},{"label":"Nov","value":387},{"label":"Dez","value":711}];
const MX = 716;
