...
const PAGE = "Gestão Caixa";
const KPIS = [{"l":"Total Casa Cambio","v":"5.926","t":"-4.6%","d":"down"},{"l":"GestãO Caixa Ativos","v":"3.183","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"82","t":"+6.0%","d":"up"}];
const COLS = ["ID","GestãO Caixa","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casa Cambio #001","Casa Cambio #002","6.360","7.042","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Casa Cambio #002","Casa Cambio #003","3.592","3.574","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Casa Cambio #003","Casa Cambio #004","6.259","1.909","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Casa Cambio #004","Casa Cambio #005","746","5.029","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casa Cambio #005","Casa Cambio #001","3.783","5.329","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":619},{"label":"Mar","value":695},{"label":"Abr","value":402},{"label":"Mai","value":675},{"label":"Jun","value":488},{"label":"Jul","value":517},{"label":"Ago","value":684},{"label":"Set","value":462},{"label":"Out","value":620},{"label":"Nov","value":590},{"label":"Dez","value":395}];
const MX = 695;
