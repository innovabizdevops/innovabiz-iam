...
const PAGE = "Multi-Moeda";
const KPIS = [{"l":"Total Casa Cambio","v":"7.809","t":"+6.9%","d":"up"},{"l":"Multi Moeda Ativos","v":"6.486","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"70.7%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+13.9%","d":"up"}];
const COLS = ["ID","Multi Moeda","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casa Cambio #001","Casa Cambio #002","5.374","7.698","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Casa Cambio #002","Casa Cambio #003","5.600","5.490","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Casa Cambio #003","Casa Cambio #004","1.630","3.611","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Casa Cambio #004","Casa Cambio #005","5.315","2.709","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casa Cambio #005","Casa Cambio #001","8.427","4.255","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":596},{"label":"Mar","value":904},{"label":"Abr","value":886},{"label":"Mai","value":632},{"label":"Jun","value":711},{"label":"Jul","value":668},{"label":"Ago","value":749},{"label":"Set","value":558},{"label":"Out","value":785},{"label":"Nov","value":563},{"label":"Dez","value":626}];
const MX = 904;
