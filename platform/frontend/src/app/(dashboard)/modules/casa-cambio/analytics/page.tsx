...
const KPIS = [{"l":"Dashboards Ativos","v":"6.576","t":"+11.0%","d":"up"},{"l":"Queries/Dia","v":"846","t":"+1.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.503","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.701","t":"+4.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1555","2026-02-27","5.089","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1403","2026-01-06","1.584","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4699","2026-01-06","4.157","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3567","2026-02-21","8.323","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4047","2026-03-06","6.453","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":592},{"label":"Mar","value":862},{"label":"Abr","value":665},{"label":"Mai","value":825},{"label":"Jun","value":886},{"label":"Jul","value":868},{"label":"Ago","value":678},{"label":"Set","value":676},{"label":"Out","value":626},{"label":"Nov","value":733},{"label":"Dez","value":550}];
const MX = 886;
