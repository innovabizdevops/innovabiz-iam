...
const ACCENT = "#d97706";
const MODULE = "Casas de Câmbio";
const PAGE = "Taxas Tempo Real";
const KPIS = [{"l":"Total Casa Cambio","v":"6.438","t":"+9.2%","d":"up"},{"l":"Taxas Tempo Real Ativos","v":"2.065","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"68.0%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"94","t":"+9.1%","d":"up"}];
const COLS = ["ID","Taxas Tempo Real","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casa Cambio #001","78.8%","8.009","8.382","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Casa Cambio #002","82.5%","1.473","6.603","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Casa Cambio #003","86.9%","2.316","3.715","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Casa Cambio #004","76.5%","8.402","6.089","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casa Cambio #005","74.5%","1.416","3.711","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":751},{"label":"Mar","value":614},{"label":"Abr","value":678},{"label":"Mai","value":723},{"label":"Jun","value":680},{"label":"Jul","value":744},{"label":"Ago","value":951},{"label":"Set","value":821},{"label":"Out","value":688},{"label":"Nov","value":688},{"label":"Dez","value":810}];
const MX = 951;
