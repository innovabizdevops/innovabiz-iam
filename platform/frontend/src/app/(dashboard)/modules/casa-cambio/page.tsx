...
export default function CasaCambioPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Casa Cambio</h1><p className="text-sm text-muted-foreground">Casa Cambio • iBOS Enterprise</p></div>
