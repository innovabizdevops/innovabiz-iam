...
const PAGE = "Relatórios BNA";
const KPIS = [{"l":"Total Casa Cambio","v":"8.691","t":"-3.9%","d":"down"},{"l":"RelatóRios BNA Ativos","v":"8.868","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"73","t":"+0.5%","d":"up"}];
const COLS = ["ID","RelatóRios BNA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casa Cambio #001","Casa Cambio #002","7.934","5.181","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Casa Cambio #002","Casa Cambio #003","4.072","4.403","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Casa Cambio #003","Casa Cambio #004","4.447","3.019","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Casa Cambio #004","Casa Cambio #005","5.480","5.723","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casa Cambio #005","Casa Cambio #001","4.863","6.406","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":976},{"label":"Fev","value":839},{"label":"Mar","value":855},{"label":"Abr","value":996},{"label":"Mai","value":645},{"label":"Jun","value":906},{"label":"Jul","value":817},{"label":"Ago","value":821},{"label":"Set","value":840},{"label":"Out","value":787},{"label":"Nov","value":814},{"label":"Dez","value":704}];
const MX = 996;
