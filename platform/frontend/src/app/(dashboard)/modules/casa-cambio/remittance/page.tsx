...
const PAGE = "Remessas";
const KPIS = [{"l":"Total Casa Cambio","v":"2.552","t":"-5.4%","d":"down"},{"l":"Remessas Ativos","v":"8.170","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+0.5%","d":"up"}];
const COLS = ["ID","Remessas","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Casa Cambio #001","Casa Cambio #002","4.211","7.177","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Casa Cambio #002","Casa Cambio #003","8.152","3.033","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Casa Cambio #003","Casa Cambio #004","3.340","778","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Casa Cambio #004","Casa Cambio #005","5.616","8.667","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Casa Cambio #005","Casa Cambio #001","1.853","6.139","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":347},{"label":"Mar","value":468},{"label":"Abr","value":596},{"label":"Mai","value":398},{"label":"Jun","value":559},{"label":"Jul","value":459},{"label":"Ago","value":339},{"label":"Set","value":524},{"label":"Out","value":649},{"label":"Nov","value":304},{"label":"Dez","value":591}];
const MX = 649;
