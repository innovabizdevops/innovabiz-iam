...
const KPIS = [{"l":"Formulários Ativos","v":"3.939","t":"+1.4%","d":"up"},{"l":"Submissões/Dia","v":"585","t":"+16.9%","d":"up"},{"l":"Documentos Gerados","v":"2.334","t":"-1.1%","d":"down"},{"l":"Templates","v":"9.095","t":"+11.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.682","2026-01-01","7.542","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.004","2026-01-21","8.998","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.569","2026-02-08","3.174","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.350","2026-02-04","2.508","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.073","2026-01-26","296","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":676},{"label":"Mar","value":653},{"label":"Abr","value":653},{"label":"Mai","value":666},{"label":"Jun","value":490},{"label":"Jul","value":639},{"label":"Ago","value":574},{"label":"Set","value":711},{"label":"Out","value":548},{"label":"Nov","value":559},{"label":"Dez","value":627}];
const MX = 711;
