...
const PAGE = "Event Broker";
const KPIS = [{"l":"Formulários Ativos","v":"653","t":"+5.5%","d":"up"},{"l":"Submissões/Dia","v":"3109","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"8.064","t":"+13.2%","d":"up"},{"l":"Templates","v":"8.654","t":"+9.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.147","2026-01-17","2.253","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","393","2026-03-01","3.220","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.606","2026-01-21","1.340","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.139","2026-02-18","1.933","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.179","2026-02-23","3.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":978},{"label":"Mar","value":683},{"label":"Abr","value":1043},{"label":"Mai","value":915},{"label":"Jun","value":1063},{"label":"Jul","value":893},{"label":"Ago","value":793},{"label":"Set","value":1015},{"label":"Out","value":695},{"label":"Nov","value":921},{"label":"Dez","value":751}];
const MX = 1063;
