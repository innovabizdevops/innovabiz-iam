...
const ACCENT = "#7c3aed";
const MODULE = "Integration Platform";
const PAGE = "API Analytics";
const KPIS = [{"l":"Formulários Ativos","v":"4.132","t":"+12.4%","d":"up"},{"l":"Submissões/Dia","v":"2277","t":"+6.6%","d":"up"},{"l":"Documentos Gerados","v":"4.559","t":"+16.4%","d":"up"},{"l":"Templates","v":"4.218","t":"-4.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.626","2026-01-07","4.710","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.184","2026-01-17","7.091","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.633","2026-03-07","6.178","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.581","2026-02-23","591","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.358","2026-03-19","1.287","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":640},{"label":"Mar","value":451},{"label":"Abr","value":713},{"label":"Mai","value":590},{"label":"Jun","value":441},{"label":"Jul","value":607},{"label":"Ago","value":434},{"label":"Set","value":428},{"label":"Out","value":746},{"label":"Nov","value":588},{"label":"Dez","value":737}];
const MX = 746;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>Chart</span></h1>
                </div>
