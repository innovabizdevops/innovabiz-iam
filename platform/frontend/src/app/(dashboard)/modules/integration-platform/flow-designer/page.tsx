...
const KPIS = [{"l":"Formulários Ativos","v":"8.057","t":"+6.8%","d":"up"},{"l":"Submissões/Dia","v":"4617","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"7.060","t":"+13.0%","d":"up"},{"l":"Templates","v":"6.350","t":"+0.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.479","2026-02-03","7.138","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.003","2026-01-23","6.396","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.204","2026-01-20","2.232","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","584","2026-01-06","7.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.185","2026-03-11","2.061","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":571},{"label":"Mar","value":353},{"label":"Abr","value":677},{"label":"Mai","value":327},{"label":"Jun","value":700},{"label":"Jul","value":372},{"label":"Ago","value":446},{"label":"Set","value":608},{"label":"Out","value":486},{"label":"Nov","value":505},{"label":"Dez","value":629}];
const MX = 700;
