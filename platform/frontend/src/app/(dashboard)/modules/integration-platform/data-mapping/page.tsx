...
const KPIS = [{"l":"Formulários Ativos","v":"283","t":"+3.0%","d":"up"},{"l":"Submissões/Dia","v":"5097","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"4.481","t":"+8.2%","d":"up"},{"l":"Templates","v":"1.265","t":"-6.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.981","2026-03-10","4.052","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.026","2026-01-12","4.198","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.725","2026-01-25","1.595","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","567","2026-02-11","5.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.813","2026-02-26","5.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":384},{"label":"Mar","value":506},{"label":"Abr","value":603},{"label":"Mai","value":376},{"label":"Jun","value":623},{"label":"Jul","value":524},{"label":"Ago","value":301},{"label":"Set","value":462},{"label":"Out","value":474},{"label":"Nov","value":463},{"label":"Dez","value":653}];
const MX = 653;
