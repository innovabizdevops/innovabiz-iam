...
const PAGE = "Rate Limiting";
const KPIS = [{"l":"Formulários Ativos","v":"5.486","t":"+8.8%","d":"up"},{"l":"Submissões/Dia","v":"1884","t":"+7.8%","d":"up"},{"l":"Documentos Gerados","v":"2.294","t":"-4.5%","d":"down"},{"l":"Templates","v":"576","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.154","2026-01-27","2.639","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.989","2026-02-16","7.030","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.840","2026-03-25","609","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.310","2026-01-13","2.522","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.034","2026-02-05","2.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":824},{"label":"Mar","value":964},{"label":"Abr","value":747},{"label":"Mai","value":699},{"label":"Jun","value":917},{"label":"Jul","value":850},{"label":"Ago","value":695},{"label":"Set","value":652},{"label":"Out","value":979},{"label":"Nov","value":737},{"label":"Dez","value":627}];
const MX = 979;
