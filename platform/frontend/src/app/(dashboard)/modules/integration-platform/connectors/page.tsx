...
const PAGE = "Connector Hub";
const KPIS = [{"l":"Formulários Ativos","v":"3.859","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"3126","t":"-4.7%","d":"down"},{"l":"Documentos Gerados","v":"745","t":"+1.1%","d":"up"},{"l":"Templates","v":"2.412","t":"+7.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.216","2026-03-08","5.801","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.040","2026-02-28","8.038","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.543","2026-01-15","3.175","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.220","2026-03-08","5.087","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.694","2026-02-14","3.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":775},{"label":"Mar","value":756},{"label":"Abr","value":647},{"label":"Mai","value":821},{"label":"Jun","value":604},{"label":"Jul","value":507},{"label":"Ago","value":571},{"label":"Set","value":802},{"label":"Out","value":803},{"label":"Nov","value":856},{"label":"Dez","value":484}];
const MX = 856;
