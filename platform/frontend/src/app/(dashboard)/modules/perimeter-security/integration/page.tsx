...
const KPIS = [{"l":"Integrações Ativas","v":"5.605","t":"+9.8%","d":"up"},{"l":"Chamadas/Hora","v":"3011","t":"+17.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.5%","t":"+7.8%","d":"up"},{"l":"Latência Média (ms)","v":"88ms","t":"+9.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.265","5.618","71.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.748","2.813","85.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.250","3.533","77.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.119","4.521","76.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","9.045","406","95.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":708},{"label":"Mar","value":529},{"label":"Abr","value":838},{"label":"Mai","value":829},{"label":"Jun","value":710},{"label":"Jul","value":683},{"label":"Ago","value":796},{"label":"Set","value":633},{"label":"Out","value":604},{"label":"Nov","value":841},{"label":"Dez","value":747}];
const MX = 841;
