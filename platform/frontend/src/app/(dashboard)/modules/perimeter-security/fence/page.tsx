...
const ACCENT = "#6366f1";
const MODULE = "Perimeter Security";
const PAGE = "Fence";
const KPIS = [{"l":"Total Perimeter Security","v":"3.683","t":"+11.9%","d":"up"},{"l":"Fence Ativos","v":"869","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"75","t":"+17.4%","d":"up"}];
const COLS = ["ID","Fence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Perimeter Security #001","Perimeter Security #002","7.937","5.709","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Perimeter Security #002","Perimeter Security #003","3.955","4.952","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Perimeter Security #003","Perimeter Security #004","4.845","1.556","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Perimeter Security #004","Perimeter Security #005","5.213","4.119","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Perimeter Security #005","Perimeter Security #001","3.248","778","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":437},{"label":"Mar","value":270},{"label":"Abr","value":570},{"label":"Mai","value":438},{"label":"Jun","value":282},{"label":"Jul","value":573},{"label":"Ago","value":596},{"label":"Set","value":361},{"label":"Out","value":271},{"label":"Nov","value":307},{"label":"Dez","value":539}];
const MX = 596;
