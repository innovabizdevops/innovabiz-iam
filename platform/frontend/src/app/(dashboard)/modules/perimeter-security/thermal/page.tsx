...
const PAGE = "Thermal";
const KPIS = [{"l":"Riscos Identificados","v":"6.089","t":"-3.9%","d":"down"},{"l":"Mitigações Ativas","v":"4.324","t":"+3.4%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+14.0%","d":"up"},{"l":"Incidentes YTD","v":"717","t":"+9.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.710","5.297","5.316","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.058","8.143","5.572","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.074","9.009","7.343","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.317","5.742","7.460","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.606","6.899","5.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":914},{"label":"Mar","value":799},{"label":"Abr","value":947},{"label":"Mai","value":871},{"label":"Jun","value":889},{"label":"Jul","value":915},{"label":"Ago","value":862},{"label":"Set","value":875},{"label":"Out","value":953},{"label":"Nov","value":741},{"label":"Dez","value":942}];
const MX = 953;
