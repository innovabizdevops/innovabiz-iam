...
const PAGE = "Lighting";
const KPIS = [{"l":"Total Perimeter Security","v":"3.521","t":"+7.3%","d":"up"},{"l":"Lighting Ativos","v":"1.413","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"75","t":"-1.7%","d":"down"}];
const COLS = ["ID","Lighting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Perimeter Security #001","Perimeter Security #002","3.995","8.565","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Perimeter Security #002","Perimeter Security #003","5.148","8.777","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Perimeter Security #003","Perimeter Security #004","6.832","3.521","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Perimeter Security #004","Perimeter Security #005","6.987","8.471","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Perimeter Security #005","Perimeter Security #001","5.605","5.976","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":678},{"label":"Mar","value":882},{"label":"Abr","value":761},{"label":"Mai","value":869},{"label":"Jun","value":1006},{"label":"Jul","value":1020},{"label":"Ago","value":853},{"label":"Set","value":792},{"label":"Out","value":725},{"label":"Nov","value":761},{"label":"Dez","value":800}];
const MX = 1020;
