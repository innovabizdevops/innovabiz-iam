...
/* ═══ Craft Marketplace — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "6975", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1525", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€480K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2072433275", cells: ["CRA-4275", "Craft Marketplace Item 1", "4/12/2026", "€33 375"], status: "active" as const },
    { id: "2072436846", cells: ["CRA-7846", "Craft Marketplace Item 2", "19/7/2026", "€36 946"], status: "pending" as const },
    { id: "2072440417", cells: ["CRA-2417", "Craft Marketplace Item 3", "6/2/2026", "€40 517"], status: "completed" as const },
    { id: "2072443988", cells: ["CRA-5988", "Craft Marketplace Item 4", "21/9/2026", "€44 088"], status: "warning" as const },
    { id: "2072447559", cells: ["CRA-9559", "Craft Marketplace Item 5", "8/4/2026", "€47 659"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Craft Marketplace</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Craft Marketplace</p>
                    </div>
                </div>
