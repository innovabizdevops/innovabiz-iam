...
const ACCENT = "#7c3aed";
const MODULE = "Craft Marketplace";
const PAGE = "List";
const KPIS = [{"l":"Pedidos/Dia","v":"356","t":"+10.7%","d":"up"},{"l":"GMV (€)","v":"€10053","t":"-1.4%","d":"down"},{"l":"Conversão (%)","v":"93.1%","t":"+4.5%","d":"up"},{"l":"AOV (€)","v":"€92584","t":"-3.7%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 3631.86","4.624","4.286","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 3631.21","8.855","1.337","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 26666.78","8.083","7.911","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20540.52","5.872","4.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 37464.25","6.132","8.595","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":468},{"label":"Mar","value":502},{"label":"Abr","value":633},{"label":"Mai","value":653},{"label":"Jun","value":591},{"label":"Jul","value":810},{"label":"Ago","value":542},{"label":"Set","value":772},{"label":"Out","value":814},{"label":"Nov","value":748},{"label":"Dez","value":787}];
const MX = 814;
