...
export default function TextileQualityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Textile Quality</h1><p className="text-sm text-muted-foreground">Textile Quality • iBOS Enterprise</p></div>
