...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.371","t":"-5.0%","d":"down"},{"l":"NC Abertas","v":"2.488","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"69.6%","t":"+8.4%","d":"up"},{"l":"CAPAs Pendentes","v":"7.061","t":"-2.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.800","81.6%","2.393","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.012","78.4%","6.203","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.305","98.6%","8.478","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.480","97.3%","3.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.221","86.2%","3.121","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":658},{"label":"Mar","value":939},{"label":"Abr","value":861},{"label":"Mai","value":711},{"label":"Jun","value":866},{"label":"Jul","value":992},{"label":"Ago","value":1035},{"label":"Set","value":670},{"label":"Out","value":931},{"label":"Nov","value":666},{"label":"Dez","value":978}];
const MX = 1035;
