...
const PAGE = "Perform";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.782","t":"+13.9%","d":"up"},{"l":"NC Abertas","v":"5.623","t":"+15.1%","d":"up"},{"l":"Conformidade (%)","v":"87.3%","t":"+10.1%","d":"up"},{"l":"CAPAs Pendentes","v":"210","t":"-5.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.130","99.2%","804","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","566","90.0%","7.851","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.900","92.7%","8.575","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","707","89.2%","4.828","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.964","72.3%","605","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":936},{"label":"Mar","value":695},{"label":"Abr","value":784},{"label":"Mai","value":842},{"label":"Jun","value":802},{"label":"Jul","value":889},{"label":"Ago","value":629},{"label":"Set","value":778},{"label":"Out","value":874},{"label":"Nov","value":831},{"label":"Dez","value":631}];
const MX = 936;
