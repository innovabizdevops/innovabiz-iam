...
const PAGE = "Fiber Test";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.965","t":"+9.5%","d":"up"},{"l":"NC Abertas","v":"5.972","t":"+6.8%","d":"up"},{"l":"Conformidade (%)","v":"93.6%","t":"+15.2%","d":"up"},{"l":"CAPAs Pendentes","v":"2.973","t":"+7.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","961","91.2%","2.978","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.413","79.4%","7.720","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","823","100.0%","2.602","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.666","78.8%","4.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.089","78.9%","1.667","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":456},{"label":"Mar","value":552},{"label":"Abr","value":501},{"label":"Mai","value":531},{"label":"Jun","value":610},{"label":"Jul","value":350},{"label":"Ago","value":286},{"label":"Set","value":265},{"label":"Out","value":553},{"label":"Nov","value":499},{"label":"Dez","value":381}];
const MX = 610;
