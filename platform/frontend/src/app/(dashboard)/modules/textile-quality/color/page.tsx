...
const PAGE = "Color";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.864","t":"+6.5%","d":"up"},{"l":"NC Abertas","v":"8.020","t":"+10.3%","d":"up"},{"l":"Conformidade (%)","v":"80.9%","t":"-0.3%","d":"down"},{"l":"CAPAs Pendentes","v":"2.398","t":"-1.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.021","73.0%","2.266","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.653","94.6%","8.491","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.484","94.6%","5.549","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.613","91.8%","6.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.977","70.3%","2.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":417},{"label":"Mar","value":677},{"label":"Abr","value":749},{"label":"Mai","value":753},{"label":"Jun","value":556},{"label":"Jul","value":741},{"label":"Ago","value":383},{"label":"Set","value":425},{"label":"Out","value":498},{"label":"Nov","value":748},{"label":"Dez","value":705}];
const MX = 753;
