...
const ACCENT = "#6366f1";
const MODULE = "Textile Quality";
const PAGE = "Fabric Test";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.259","t":"+17.1%","d":"up"},{"l":"NC Abertas","v":"7.236","t":"+-0.0%","d":"up"},{"l":"Conformidade (%)","v":"82.4%","t":"+14.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.602","t":"+14.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.492","88.9%","3.021","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.893","98.6%","2.917","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.251","72.2%","2.166","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.757","89.5%","2.920","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.140","98.4%","615","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":508},{"label":"Mar","value":783},{"label":"Abr","value":633},{"label":"Mai","value":606},{"label":"Jun","value":567},{"label":"Jul","value":434},{"label":"Ago","value":648},{"label":"Set","value":674},{"label":"Out","value":637},{"label":"Nov","value":567},{"label":"Dez","value":505}];
const MX = 783;
