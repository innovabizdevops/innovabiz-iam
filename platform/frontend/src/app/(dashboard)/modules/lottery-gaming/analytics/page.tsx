...
const ACCENT = "#f59e0b";
const MODULE = "Lottery & Gaming";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.895","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"2319","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"332","t":"-3.0%","d":"down"},{"l":"Utilizadores Analytics","v":"7.567","t":"+5.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5057","2026-02-11","4.521","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","299","2026-03-04","3.568","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4380","2026-02-07","946","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2628","2026-02-04","3.178","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4196","2026-03-19","6.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":517},{"label":"Mar","value":726},{"label":"Abr","value":811},{"label":"Mai","value":776},{"label":"Jun","value":806},{"label":"Jul","value":717},{"label":"Ago","value":653},{"label":"Set","value":606},{"label":"Out","value":641},{"label":"Nov","value":833},{"label":"Dez","value":789}];
const MX = 833;
