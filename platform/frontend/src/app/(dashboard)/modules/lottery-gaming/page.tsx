...
/* ═══ Lottery & Gaming — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "2114", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4303", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€192K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1658420314", cells: ["LOT-9314", "Lottery & Gaming Item 1", "27/11/2026", "€20 414"], status: "active" as const },
    { id: "1658423885", cells: ["LOT-3885", "Lottery & Gaming Item 2", "14/6/2026", "€23 985"], status: "pending" as const },
    { id: "1658427456", cells: ["LOT-7456", "Lottery & Gaming Item 3", "1/1/2026", "€27 556"], status: "completed" as const },
    { id: "1658431027", cells: ["LOT-2027", "Lottery & Gaming Item 4", "16/8/2026", "€31 127"], status: "warning" as const },
    { id: "1658434598", cells: ["LOT-5598", "Lottery & Gaming Item 5", "3/3/2026", "€34 698"], status: "active" as const },
];
...
export default function LotteryGamingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Lottery & Gaming</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Lottery & Gaming</p>
                    </div>
                </div>
