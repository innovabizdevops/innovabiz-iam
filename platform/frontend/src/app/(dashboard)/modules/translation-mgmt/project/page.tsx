...
const PAGE = "Project Create";
const KPIS = [{"l":"Tickets Abertos","v":"1.169","t":"+14.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.4%","t":"+17.1%","d":"up"},{"l":"MTTR (h)","v":"107h","t":"+2.6%","d":"up"},{"l":"Satisfação (%)","v":"75.6%","t":"+5.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","516","2.633","7.686","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","131","7.020","5.077","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.421","8.230","6.992","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.774","3.930","5.625","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.161","4.733","4.965","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":468},{"label":"Mar","value":721},{"label":"Abr","value":715},{"label":"Mai","value":700},{"label":"Jun","value":645},{"label":"Jul","value":369},{"label":"Ago","value":348},{"label":"Set","value":475},{"label":"Out","value":622},{"label":"Nov","value":440},{"label":"Dez","value":597}];
const MX = 721;
