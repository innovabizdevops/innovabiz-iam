...
const PAGE = "TM Memory";
const KPIS = [{"l":"Tickets Abertos","v":"2.653","t":"+4.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.3%","t":"-0.9%","d":"down"},{"l":"MTTR (h)","v":"50h","t":"+2.4%","d":"up"},{"l":"Satisfação (%)","v":"80.9%","t":"+14.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.163","2.079","7.123","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.386","5.528","6.841","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.750","2.928","2.700","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.728","7.589","6.599","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.162","6.262","7.558","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":359},{"label":"Mar","value":586},{"label":"Abr","value":399},{"label":"Mai","value":545},{"label":"Jun","value":443},{"label":"Jul","value":557},{"label":"Ago","value":580},{"label":"Set","value":630},{"label":"Out","value":371},{"label":"Nov","value":495},{"label":"Dez","value":563}];
const MX = 630;
