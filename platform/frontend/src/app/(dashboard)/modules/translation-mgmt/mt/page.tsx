...
const ACCENT = "#ec4899";
const MODULE = "Translation Management";
const PAGE = "MT Engine";
const KPIS = [{"l":"Tickets Abertos","v":"7.657","t":"-0.2%","d":"down"},{"l":"SLA Cumprido (%)","v":"66.1%","t":"+8.5%","d":"up"},{"l":"MTTR (h)","v":"90h","t":"+7.5%","d":"up"},{"l":"Satisfação (%)","v":"85.5%","t":"+0.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.254","6.888","217","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.023","2.811","2.292","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","522","7.409","4.259","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.379","7.720","5.685","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.960","3.404","6.459","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":461},{"label":"Mar","value":735},{"label":"Abr","value":418},{"label":"Mai","value":555},{"label":"Jun","value":367},{"label":"Jul","value":725},{"label":"Ago","value":500},{"label":"Set","value":561},{"label":"Out","value":653},{"label":"Nov","value":698},{"label":"Dez","value":465}];
const MX = 735;
