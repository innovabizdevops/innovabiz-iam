...
const PAGE = "QA Check";
const KPIS = [{"l":"Tickets Abertos","v":"4.837","t":"+13.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.6%","t":"+2.9%","d":"up"},{"l":"MTTR (h)","v":"194h","t":"+16.4%","d":"up"},{"l":"Satisfação (%)","v":"70.5%","t":"-5.8%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.949","5.217","3.622","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.994","7.049","7.305","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.891","8.406","5.554","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","787","2.837","6.445","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.723","8.619","3.893","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":722},{"label":"Mar","value":771},{"label":"Abr","value":844},{"label":"Mai","value":832},{"label":"Jun","value":483},{"label":"Jul","value":717},{"label":"Ago","value":874},{"label":"Set","value":529},{"label":"Out","value":689},{"label":"Nov","value":837},{"label":"Dez","value":735}];
const MX = 874;
