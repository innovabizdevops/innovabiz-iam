...
/* ═══ Connected Vehicle Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "5575", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3008", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€85K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "173463375", cells: ["CON-7375", "Connected Vehicle Platform Item 1", "16/4/2026", "€13 475"], status: "active" as const },
    { id: "173466946", cells: ["CON-1946", "Connected Vehicle Platform Item 2", "3/11/2026", "€17 046"], status: "pending" as const },
    { id: "173470517", cells: ["CON-5517", "Connected Vehicle Platform Item 3", "18/6/2026", "€20 617"], status: "completed" as const },
    { id: "173474088", cells: ["CON-9088", "Connected Vehicle Platform Item 4", "5/1/2026", "€24 188"], status: "warning" as const },
    { id: "173477659", cells: ["CON-3659", "Connected Vehicle Platform Item 5", "20/8/2026", "€27 759"], status: "active" as const },
];
...
export default function ConnectedVehiclePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Connected Vehicle Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Connected Vehicle Platform</p>
                    </div>
                </div>
