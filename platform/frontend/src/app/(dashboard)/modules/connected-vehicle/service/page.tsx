...
const PAGE = "Service";
const KPIS = [{"l":"Total Connected Vehicle","v":"4.199","t":"+7.0%","d":"up"},{"l":"Service Ativos","v":"3.888","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.1%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Connected Vehicle #001","Connected Vehicle #002","4.471","2.599","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Connected Vehicle #002","Connected Vehicle #003","6.378","3.883","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Connected Vehicle #003","Connected Vehicle #004","6.085","7.341","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Connected Vehicle #004","Connected Vehicle #005","8.466","3.314","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Connected Vehicle #005","Connected Vehicle #001","7.221","978","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":933},{"label":"Mar","value":960},{"label":"Abr","value":1042},{"label":"Mai","value":1051},{"label":"Jun","value":1044},{"label":"Jul","value":701},{"label":"Ago","value":946},{"label":"Set","value":1044},{"label":"Out","value":680},{"label":"Nov","value":879},{"label":"Dez","value":998}];
const MX = 1051;
