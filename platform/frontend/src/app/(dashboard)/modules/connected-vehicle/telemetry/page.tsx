...
const ACCENT = "#1e3a5f";
const MODULE = "Connected Vehicle Platform";
const PAGE = "Telemetry";
const KPIS = [{"l":"Total Connected Vehicle","v":"2.418","t":"+0.9%","d":"up"},{"l":"Telemetry Ativos","v":"4.420","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"81","t":"+7.4%","d":"up"}];
const COLS = ["ID","Telemetry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Connected Vehicle #001","Connected Vehicle #002","7.804","8.038","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Connected Vehicle #002","Connected Vehicle #003","8.863","1.689","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Connected Vehicle #003","Connected Vehicle #004","3.176","7.101","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Connected Vehicle #004","Connected Vehicle #005","1.214","7.764","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Connected Vehicle #005","Connected Vehicle #001","5.234","1.561","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":823},{"label":"Mar","value":990},{"label":"Abr","value":664},{"label":"Mai","value":799},{"label":"Jun","value":925},{"label":"Jul","value":917},{"label":"Ago","value":674},{"label":"Set","value":909},{"label":"Out","value":976},{"label":"Nov","value":904},{"label":"Dez","value":852}];
const MX = 990;
