...
const PAGE = "Data";
const KPIS = [{"l":"Total Connected Vehicle","v":"1.050","t":"-3.6%","d":"down"},{"l":"Data Ativos","v":"8.119","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"88.3%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"83","t":"+9.7%","d":"up"}];
const COLS = ["ID","Data","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Connected Vehicle #001","2026-02-04","1.841","8.623","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Connected Vehicle #002","2026-02-03","8.775","2.125","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Connected Vehicle #003","2026-03-16","6.021","3.780","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Connected Vehicle #004","2026-01-14","8.977","5.674","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Connected Vehicle #005","2026-03-19","7.118","4.014","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":516},{"label":"Mar","value":470},{"label":"Abr","value":689},{"label":"Mai","value":325},{"label":"Jun","value":424},{"label":"Jul","value":473},{"label":"Ago","value":490},{"label":"Set","value":337},{"label":"Out","value":504},{"label":"Nov","value":672},{"label":"Dez","value":354}];
const MX = 689;
