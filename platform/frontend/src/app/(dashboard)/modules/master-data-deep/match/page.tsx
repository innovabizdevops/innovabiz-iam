...
const ACCENT = "#1e3a5f";
const MODULE = "Master Data Management Deep";
const PAGE = "Match";
const KPIS = [{"l":"Dashboards Ativos","v":"8.829","t":"+0.9%","d":"up"},{"l":"Queries/Dia","v":"4874","t":"-3.9%","d":"down"},{"l":"Dados Processados (GB)","v":"5.274","t":"+11.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.808","t":"+0.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5084","2026-03-26","8.045","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1171","2026-01-12","3.671","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3867","2026-03-02","2.555","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3053","2026-02-03","1.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2245","2026-03-24","2.181","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":833},{"label":"Mar","value":586},{"label":"Abr","value":592},{"label":"Mai","value":597},{"label":"Jun","value":707},{"label":"Jul","value":761},{"label":"Ago","value":804},{"label":"Set","value":576},{"label":"Out","value":573},{"label":"Nov","value":584},{"label":"Dez","value":733}];
const MX = 833;
