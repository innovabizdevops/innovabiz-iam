...
const PAGE = "Steward";
const KPIS = [{"l":"Dashboards Ativos","v":"2.629","t":"+1.1%","d":"up"},{"l":"Queries/Dia","v":"445","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.098","t":"+15.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.978","t":"+6.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4591","2026-01-12","5.529","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4223","2026-02-17","6.407","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1174","2026-02-06","1.408","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1276","2026-01-03","6.027","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1413","2026-03-08","5.288","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":843},{"label":"Mar","value":829},{"label":"Abr","value":670},{"label":"Mai","value":661},{"label":"Jun","value":618},{"label":"Jul","value":890},{"label":"Ago","value":876},{"label":"Set","value":695},{"label":"Out","value":758},{"label":"Nov","value":853},{"label":"Dez","value":675}];
const MX = 890;
