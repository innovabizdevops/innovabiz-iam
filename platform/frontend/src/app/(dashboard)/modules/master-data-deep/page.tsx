...
/* ═══ Master Data Management Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "6059", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4394", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€489K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1733802859", cells: ["MAS-7859", "Master Data Management Deep Item 1", "20/8/2026", "€2959"], status: "active" as const },
    { id: "1733806430", cells: ["MAS-2430", "Master Data Management Deep Item 2", "7/3/2026", "€6530"], status: "pending" as const },
    { id: "1733810001", cells: ["MAS-6001", "Master Data Management Deep Item 3", "22/10/2026", "€10 101"], status: "completed" as const },
    { id: "1733813572", cells: ["MAS-9572", "Master Data Management Deep Item 4", "9/5/2026", "€13 672"], status: "warning" as const },
    { id: "1733817143", cells: ["MAS-4143", "Master Data Management Deep Item 5", "24/12/2026", "€17 243"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 79 }, { label: "Fev", value: 88 }, { label: "Mar", value: 97 }, { label: "Abr", value: 26 }, { label: "Mai", value: 35 }, { label: "Jun", value: 44 }];
...
export default function MasterDataManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Master Data Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Master Data Management Deep</p>
                    </div>
                </div>
