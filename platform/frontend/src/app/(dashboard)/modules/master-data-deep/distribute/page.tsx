...
const KPIS = [{"l":"Dashboards Ativos","v":"2.444","t":"+16.4%","d":"up"},{"l":"Queries/Dia","v":"2926","t":"-2.1%","d":"down"},{"l":"Dados Processados (GB)","v":"2.894","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"6.340","t":"-5.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","251","2026-01-13","2.555","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","951","2026-02-05","2.671","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3011","2026-02-23","7.643","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2025","2026-02-24","3.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4005","2026-03-08","2.520","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":514},{"label":"Mar","value":577},{"label":"Abr","value":527},{"label":"Mai","value":793},{"label":"Jun","value":496},{"label":"Jul","value":596},{"label":"Ago","value":724},{"label":"Set","value":618},{"label":"Out","value":537},{"label":"Nov","value":550},{"label":"Dez","value":460}];
const MX = 793;
