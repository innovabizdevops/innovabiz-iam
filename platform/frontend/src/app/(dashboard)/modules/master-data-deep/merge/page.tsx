...
const PAGE = "Merge";
const KPIS = [{"l":"Dashboards Ativos","v":"2.188","t":"-3.5%","d":"down"},{"l":"Queries/Dia","v":"2882","t":"+12.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.044","t":"+16.1%","d":"up"},{"l":"Utilizadores Analytics","v":"5.597","t":"+3.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","180","2026-01-25","6.066","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","746","2026-02-27","6.431","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4528","2026-01-20","403","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3684","2026-02-12","4.254","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3478","2026-02-24","5.300","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":628},{"label":"Mar","value":495},{"label":"Abr","value":754},{"label":"Mai","value":447},{"label":"Jun","value":487},{"label":"Jul","value":630},{"label":"Ago","value":650},{"label":"Set","value":702},{"label":"Out","value":445},{"label":"Nov","value":563},{"label":"Dez","value":539}];
const MX = 754;
