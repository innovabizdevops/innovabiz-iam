...
const PAGE = "Model";
const KPIS = [{"l":"Dashboards Ativos","v":"7.707","t":"+6.7%","d":"up"},{"l":"Queries/Dia","v":"1217","t":"-0.8%","d":"down"},{"l":"Dados Processados (GB)","v":"117","t":"+10.1%","d":"up"},{"l":"Utilizadores Analytics","v":"6.732","t":"+17.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3454","2026-01-01","5.022","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4130","2026-02-07","3.385","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1778","2026-02-21","1.703","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","298","2026-03-08","6.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3511","2026-02-20","4.820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":564},{"label":"Mar","value":417},{"label":"Abr","value":469},{"label":"Mai","value":367},{"label":"Jun","value":418},{"label":"Jul","value":561},{"label":"Ago","value":444},{"label":"Set","value":308},{"label":"Out","value":559},{"label":"Nov","value":291},{"label":"Dez","value":645}];
const MX = 645;
