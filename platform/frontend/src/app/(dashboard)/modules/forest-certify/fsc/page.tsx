...
const PAGE = "FSC Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.882","t":"+13.4%","d":"up"},{"l":"NC Abertas","v":"4.321","t":"-2.8%","d":"down"},{"l":"Conformidade (%)","v":"68.4%","t":"-2.7%","d":"down"},{"l":"CAPAs Pendentes","v":"6.595","t":"+0.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.967","80.0%","614","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.995","72.8%","963","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.451","74.0%","819","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.309","89.1%","473","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.148","81.5%","737","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":473},{"label":"Mar","value":480},{"label":"Abr","value":614},{"label":"Mai","value":406},{"label":"Jun","value":400},{"label":"Jul","value":463},{"label":"Ago","value":534},{"label":"Set","value":645},{"label":"Out","value":564},{"label":"Nov","value":504},{"label":"Dez","value":538}];
const MX = 672;
