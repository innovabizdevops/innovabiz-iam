...
export default function ForestCertifyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Forest Certify</h1><p className="text-sm text-muted-foreground">Forest Certify • iBOS Enterprise</p></div>
