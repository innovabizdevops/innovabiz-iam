...
const PAGE = "SFI Track";
const KPIS = [{"l":"Total Forest Certify","v":"4.856","t":"-2.0%","d":"down"},{"l":"SFI Track Ativos","v":"7.117","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"76.1%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+9.5%","d":"up"}];
const COLS = ["ID","SFI Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Certify #001","Forest Certify #002","7.467","6.302","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Certify #002","Forest Certify #003","3.235","7.510","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Certify #003","Forest Certify #004","2.726","7.291","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Certify #004","Forest Certify #005","1.330","819","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Certify #005","Forest Certify #001","7.014","2.875","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1023},{"label":"Fev","value":784},{"label":"Mar","value":850},{"label":"Abr","value":945},{"label":"Mai","value":688},{"label":"Jun","value":768},{"label":"Jul","value":817},{"label":"Ago","value":666},{"label":"Set","value":855},{"label":"Out","value":761},{"label":"Nov","value":877},{"label":"Dez","value":1014}];
const MX = 1023;
