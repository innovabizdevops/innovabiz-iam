...
const PAGE = "Community Cert";
const KPIS = [{"l":"Projetos Sociais","v":"2.763","t":"-5.9%","d":"down"},{"l":"Beneficiários","v":"2.836","t":"+9.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€46344","t":"+3.9%","d":"up"},{"l":"Score Impacto","v":"74","t":"+12.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","477","€ 30030.41","2.843","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.507","€ 48454.74","8.043","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.740","€ 31858.52","1.615","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","1.756","€ 16506.09","1.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.165","€ 12702.44","5.986","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":445},{"label":"Mar","value":755},{"label":"Abr","value":530},{"label":"Mai","value":640},{"label":"Jun","value":503},{"label":"Jul","value":764},{"label":"Ago","value":696},{"label":"Set","value":670},{"label":"Out","value":529},{"label":"Nov","value":448},{"label":"Dez","value":626}];
const MX = 764;
