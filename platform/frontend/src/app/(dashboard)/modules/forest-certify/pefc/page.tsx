...
const PAGE = "PEFC Comply";
const KPIS = [{"l":"Total Forest Certify","v":"1.970","t":"+12.0%","d":"up"},{"l":"PEFC Comply Ativos","v":"3.942","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+2.0%","d":"up"}];
const COLS = ["ID","PEFC Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Forest Certify #001","Forest Certify #002","2.938","4.756","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Forest Certify #002","Forest Certify #003","6.701","5.340","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Forest Certify #003","Forest Certify #004","265","2.004","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Forest Certify #004","Forest Certify #005","4.133","7.309","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Forest Certify #005","Forest Certify #001","3.273","6.465","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1023},{"label":"Fev","value":1028},{"label":"Mar","value":766},{"label":"Abr","value":714},{"label":"Mai","value":700},{"label":"Jun","value":816},{"label":"Jul","value":907},{"label":"Ago","value":714},{"label":"Set","value":957},{"label":"Out","value":852},{"label":"Nov","value":906},{"label":"Dez","value":673}];
const MX = 1028;
...
export default function PefcPage() {
    return (
