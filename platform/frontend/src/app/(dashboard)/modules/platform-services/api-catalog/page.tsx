...
const KPIS = [{"l":"Formulários Ativos","v":"4.080","t":"+3.7%","d":"up"},{"l":"Submissões/Dia","v":"3862","t":"+5.7%","d":"up"},{"l":"Documentos Gerados","v":"8.495","t":"+5.8%","d":"up"},{"l":"Templates","v":"6.659","t":"+14.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","829","2026-01-28","315","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.466","2026-03-28","1.655","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.656","2026-02-05","1.367","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.581","2026-01-27","5.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.632","2026-03-16","7.794","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":541},{"label":"Mar","value":480},{"label":"Abr","value":545},{"label":"Mai","value":364},{"label":"Jun","value":469},{"label":"Jul","value":446},{"label":"Ago","value":325},{"label":"Set","value":635},{"label":"Out","value":608},{"label":"Nov","value":376},{"label":"Dez","value":367}];
const MX = 635;
