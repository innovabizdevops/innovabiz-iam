...
const PAGE = "Feature Flag Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"7.427","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"5039","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"9.000","t":"+1.8%","d":"up"},{"l":"Templates","v":"4.779","t":"+0.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.349","2026-02-15","3.247","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.732","2026-03-09","1.410","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.806","2026-01-06","8.126","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","983","2026-01-18","7.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.487","2026-03-13","6.321","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":685},{"label":"Mar","value":581},{"label":"Abr","value":786},{"label":"Mai","value":742},{"label":"Jun","value":594},{"label":"Jul","value":567},{"label":"Ago","value":510},{"label":"Set","value":856},{"label":"Out","value":826},{"label":"Nov","value":846},{"label":"Dez","value":550}];
const MX = 856;
