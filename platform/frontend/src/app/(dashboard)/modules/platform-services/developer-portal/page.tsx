...
const PAGE = "Developer Portal";
const KPIS = [{"l":"Formulários Ativos","v":"2.231","t":"+13.3%","d":"up"},{"l":"Submissões/Dia","v":"1523","t":"+16.4%","d":"up"},{"l":"Documentos Gerados","v":"6.201","t":"+6.6%","d":"up"},{"l":"Templates","v":"4.413","t":"+8.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.319","2026-03-14","602","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.402","2026-01-23","710","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.952","2026-01-28","8.470","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","833","2026-01-06","1.017","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.102","2026-02-21","4.929","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":885},{"label":"Mar","value":871},{"label":"Abr","value":856},{"label":"Mai","value":544},{"label":"Jun","value":669},{"label":"Jul","value":876},{"label":"Ago","value":905},{"label":"Set","value":857},{"label":"Out","value":743},{"label":"Nov","value":593},{"label":"Dez","value":586}];
const MX = 905;
