...
const KPIS = [{"l":"Formulários Ativos","v":"400","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"2678","t":"+9.3%","d":"up"},{"l":"Documentos Gerados","v":"8.054","t":"+17.8%","d":"up"},{"l":"Templates","v":"1.205","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.041","2026-01-21","8.326","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.326","2026-01-17","475","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.309","2026-02-22","5.110","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.597","2026-02-20","5.149","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.804","2026-02-03","9.094","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":714},{"label":"Mar","value":922},{"label":"Abr","value":746},{"label":"Mai","value":891},{"label":"Jun","value":791},{"label":"Jul","value":723},{"label":"Ago","value":867},{"label":"Set","value":902},{"label":"Out","value":944},{"label":"Nov","value":972},{"label":"Dez","value":711}];
const MX = 972;
