...
const ACCENT = "#6366f1";
const MODULE = "Platform Services";
const PAGE = "Platform Engineering";
const KPIS = [{"l":"Formulários Ativos","v":"5.973","t":"+17.7%","d":"up"},{"l":"Submissões/Dia","v":"3639","t":"+5.5%","d":"up"},{"l":"Documentos Gerados","v":"5.899","t":"+10.2%","d":"up"},{"l":"Templates","v":"4.041","t":"+17.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.723","2026-01-23","8.820","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.116","2026-03-04","3.008","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.558","2026-03-03","7.398","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.042","2026-03-01","1.717","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.969","2026-01-10","7.945","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":859},{"label":"Mar","value":623},{"label":"Abr","value":529},{"label":"Mai","value":714},{"label":"Jun","value":787},{"label":"Jul","value":552},{"label":"Ago","value":835},{"label":"Set","value":882},{"label":"Out","value":848},{"label":"Nov","value":547},{"label":"Dez","value":795}];
const MX = 882;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Gartner</span></h1>
                </div>
