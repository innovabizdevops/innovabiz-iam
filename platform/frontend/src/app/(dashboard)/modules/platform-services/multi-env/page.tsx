...
const PAGE = "Multi-Env Deployer";
const KPIS = [{"l":"Formulários Ativos","v":"8.174","t":"+13.5%","d":"up"},{"l":"Submissões/Dia","v":"4004","t":"+16.0%","d":"up"},{"l":"Documentos Gerados","v":"8.294","t":"+8.2%","d":"up"},{"l":"Templates","v":"3.135","t":"+13.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.285","2026-03-16","3.982","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.497","2026-02-07","8.781","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.547","2026-01-08","8.689","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.550","2026-03-17","7.913","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.458","2026-01-07","6.846","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":726},{"label":"Mar","value":746},{"label":"Abr","value":431},{"label":"Mai","value":467},{"label":"Jun","value":545},{"label":"Jul","value":627},{"label":"Ago","value":682},{"label":"Set","value":707},{"label":"Out","value":721},{"label":"Nov","value":465},{"label":"Dez","value":610}];
const MX = 746;
...
export default function MultiEnvPage() {
    return (
