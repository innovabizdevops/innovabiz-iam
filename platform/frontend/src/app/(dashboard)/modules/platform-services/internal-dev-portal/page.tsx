...
const PAGE = "Internal Dev Portal";
const KPIS = [{"l":"Formulários Ativos","v":"2.444","t":"+8.6%","d":"up"},{"l":"Submissões/Dia","v":"4883","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"656","t":"+4.7%","d":"up"},{"l":"Templates","v":"768","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.591","2026-02-16","3.800","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.266","2026-01-13","3.980","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.240","2026-03-23","8.240","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.576","2026-01-19","5.998","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.054","2026-03-28","3.256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":329},{"label":"Mar","value":393},{"label":"Abr","value":364},{"label":"Mai","value":366},{"label":"Jun","value":412},{"label":"Jul","value":393},{"label":"Ago","value":582},{"label":"Set","value":253},{"label":"Out","value":359},{"label":"Nov","value":387},{"label":"Dez","value":397}];
const MX = 582;
...
export default function InternalDevPortalPage() {
    return (
