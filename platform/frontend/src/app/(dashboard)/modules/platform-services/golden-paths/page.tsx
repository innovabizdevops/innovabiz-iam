...
const PAGE = "Golden Paths";
const KPIS = [{"l":"Formulários Ativos","v":"3.334","t":"-0.7%","d":"down"},{"l":"Submissões/Dia","v":"2467","t":"-2.5%","d":"down"},{"l":"Documentos Gerados","v":"3.075","t":"-4.5%","d":"down"},{"l":"Templates","v":"5.178","t":"-3.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.944","2026-03-03","1.973","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.310","2026-03-16","1.018","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.494","2026-03-05","5.065","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.838","2026-02-23","7.719","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.029","2026-01-04","1.267","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":668},{"label":"Mar","value":651},{"label":"Abr","value":823},{"label":"Mai","value":889},{"label":"Jun","value":653},{"label":"Jul","value":678},{"label":"Ago","value":836},{"label":"Set","value":991},{"label":"Out","value":1032},{"label":"Nov","value":723},{"label":"Dez","value":753}];
const MX = 1032;
