...
const PAGE = "Blue-Green Deployments";
const KPIS = [{"l":"Formulários Ativos","v":"3.010","t":"+0.3%","d":"up"},{"l":"Submissões/Dia","v":"5092","t":"+17.0%","d":"up"},{"l":"Documentos Gerados","v":"8.320","t":"+5.2%","d":"up"},{"l":"Templates","v":"8.458","t":"-0.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","603","2026-03-06","3.877","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","447","2026-02-06","6.416","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.194","2026-01-21","8.235","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.316","2026-02-12","2.740","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.429","2026-02-03","1.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":843},{"label":"Mar","value":1034},{"label":"Abr","value":966},{"label":"Mai","value":913},{"label":"Jun","value":663},{"label":"Jul","value":903},{"label":"Ago","value":888},{"label":"Set","value":872},{"label":"Out","value":722},{"label":"Nov","value":932},{"label":"Dez","value":875}];
const MX = 1034;
