...
/* ═══ Estate Settlement — Dashboard ═══ */

const ACCENT = "#0f172a";

const KPIS = [
    { label: "Total Registos", value: "5087", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1058", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€449K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1961650387", cells: ["EST-2387", "Estate Settlement Item 1", "12/8/2026", "€487"], status: "active" as const },
    { id: "1961653958", cells: ["EST-5958", "Estate Settlement Item 2", "27/3/2026", "€4058"], status: "pending" as const },
    { id: "1961657529", cells: ["EST-9529", "Estate Settlement Item 3", "14/10/2026", "€7629"], status: "completed" as const },
    { id: "1961661100", cells: ["EST-4100", "Estate Settlement Item 4", "1/5/2026", "€11 200"], status: "warning" as const },
    { id: "1961664671", cells: ["EST-7671", "Estate Settlement Item 5", "16/12/2026", "€14 771"], status: "active" as const },
];
...
export default function EstateSettlementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Estate Settlement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Estate Settlement</p>
                    </div>
                </div>
