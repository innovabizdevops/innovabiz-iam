...
const KPIS = [{"l":"Notificações Enviadas","v":"7.535","t":"-0.1%","d":"down"},{"l":"Taxa Entrega (%)","v":"67.1%","t":"-2.0%","d":"down"},{"l":"Taxa Abertura (%)","v":"92.4%","t":"-4.6%","d":"down"},{"l":"Escalações","v":"4.707","t":"+13.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.725","80.6%","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.245","76.8%","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","1.653","76.9%","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.371","82.1%","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.127","71.9%","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":960},{"label":"Mar","value":600},{"label":"Abr","value":935},{"label":"Mai","value":853},{"label":"Jun","value":840},{"label":"Jul","value":933},{"label":"Ago","value":718},{"label":"Set","value":672},{"label":"Out","value":870},{"label":"Nov","value":617},{"label":"Dez","value":961}];
const MX = 961;
