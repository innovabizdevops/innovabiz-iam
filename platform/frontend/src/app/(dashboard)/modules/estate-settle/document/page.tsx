...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"3.003","t":"-4.7%","d":"down"},{"l":"Submissões/Dia","v":"4238","t":"+15.0%","d":"up"},{"l":"Documentos Gerados","v":"238","t":"+6.9%","d":"up"},{"l":"Templates","v":"6.168","t":"-2.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.751","2026-01-05","6.851","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","835","2026-02-28","3.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","616","2026-01-03","1.510","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.318","2026-01-26","3.424","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.284","2026-01-01","2.717","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":403},{"label":"Mar","value":532},{"label":"Abr","value":476},{"label":"Mai","value":529},{"label":"Jun","value":634},{"label":"Jul","value":501},{"label":"Ago","value":378},{"label":"Set","value":452},{"label":"Out","value":689},{"label":"Nov","value":558},{"label":"Dez","value":701}];
const MX = 701;
