...
const ACCENT = "#0f172a";
const MODULE = "Estate Settlement";
const PAGE = "Distribute";
const KPIS = [{"l":"Total Estate Settle","v":"3.591","t":"+8.4%","d":"up"},{"l":"Distribute Ativos","v":"945","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+6.3%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Estate Settle #001","Estate Settle #002","1.510","6.840","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Estate Settle #002","Estate Settle #003","3.525","5.971","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Estate Settle #003","Estate Settle #004","4.614","5.998","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Estate Settle #004","Estate Settle #005","8.745","4.231","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Estate Settle #005","Estate Settle #001","5.441","6.806","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":970},{"label":"Mar","value":1059},{"label":"Abr","value":730},{"label":"Mai","value":1056},{"label":"Jun","value":866},{"label":"Jul","value":702},{"label":"Ago","value":875},{"label":"Set","value":730},{"label":"Out","value":941},{"label":"Nov","value":1013},{"label":"Dez","value":979}];
const MX = 1059;
