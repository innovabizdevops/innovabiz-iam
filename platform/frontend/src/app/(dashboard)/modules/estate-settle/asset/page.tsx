...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"911","t":"+1.5%","d":"up"},{"l":"Valor Total (€M)","v":"€12.7M","t":"-0.3%","d":"down"},{"l":"Depreciação Anual (€)","v":"€18990","t":"+11.6%","d":"up"},{"l":"Ativos em Garantia","v":"2.754","t":"-4.9%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 11331.28","6.837","€ 45736.85","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 11913.20","7.151","€ 7111.31","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 47573.35","8.333","€ 1948.12","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 1517.89","2.309","€ 28646.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 22989.55","1.887","€ 32141.27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":467},{"label":"Mar","value":698},{"label":"Abr","value":641},{"label":"Mai","value":443},{"label":"Jun","value":613},{"label":"Jul","value":392},{"label":"Ago","value":626},{"label":"Set","value":561},{"label":"Out","value":562},{"label":"Nov","value":384},{"label":"Dez","value":596}];
const MX = 699;
