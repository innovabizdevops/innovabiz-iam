...
const KPIS = [{"l":"Projetos Sociais","v":"7.175","t":"-3.9%","d":"down"},{"l":"Beneficiários","v":"7.734","t":"+12.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€58073","t":"-2.8%","d":"down"},{"l":"Score Impacto","v":"90","t":"+12.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.808","€ 905.10","8.460","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.165","€ 9654.14","724","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.437","€ 12522.66","2.149","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","9.022","€ 4994.79","4.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","330","€ 6136.54","2.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":838},{"label":"Mar","value":680},{"label":"Abr","value":634},{"label":"Mai","value":1002},{"label":"Jun","value":874},{"label":"Jul","value":931},{"label":"Ago","value":642},{"label":"Set","value":930},{"label":"Out","value":892},{"label":"Nov","value":739},{"label":"Dez","value":1016}];
const MX = 1016;
