...
const PAGE = "SROI Calc";
const KPIS = [{"l":"Projetos Sociais","v":"3.457","t":"+13.7%","d":"up"},{"l":"Beneficiários","v":"4.499","t":"+9.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€95783","t":"-5.8%","d":"down"},{"l":"Score Impacto","v":"77","t":"-3.7%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.560","€ 46008.52","894","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.416","€ 18248.39","6.214","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.648","€ 5136.33","6.116","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.625","€ 2539.30","6.143","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","881","€ 20433.59","3.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1071},{"label":"Fev","value":749},{"label":"Mar","value":907},{"label":"Abr","value":761},{"label":"Mai","value":941},{"label":"Jun","value":916},{"label":"Jul","value":813},{"label":"Ago","value":728},{"label":"Set","value":1015},{"label":"Out","value":1036},{"label":"Nov","value":966},{"label":"Dez","value":766}];
const MX = 1071;
