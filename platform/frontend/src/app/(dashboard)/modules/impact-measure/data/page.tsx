...
const PAGE = "Data Collect";
const KPIS = [{"l":"Projetos Sociais","v":"2.500","t":"+12.6%","d":"up"},{"l":"Beneficiários","v":"3.684","t":"+13.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€93370","t":"+2.1%","d":"up"},{"l":"Score Impacto","v":"73","t":"-5.6%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.833","€ 6371.00","4.280","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.541","€ 23284.56","3.451","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.385","€ 9500.74","3.768","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.195","€ 13897.50","652","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.715","€ 17883.12","1.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":556},{"label":"Mar","value":531},{"label":"Abr","value":563},{"label":"Mai","value":710},{"label":"Jun","value":734},{"label":"Jul","value":717},{"label":"Ago","value":403},{"label":"Set","value":647},{"label":"Out","value":723},{"label":"Nov","value":469},{"label":"Dez","value":770}];
const MX = 770;
