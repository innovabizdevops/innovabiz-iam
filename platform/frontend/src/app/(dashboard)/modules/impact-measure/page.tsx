...
export default function ImpactMeasurePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Impact Measure</h1><p className="text-sm text-muted-foreground">Impact Measure • iBOS Enterprise</p></div>
