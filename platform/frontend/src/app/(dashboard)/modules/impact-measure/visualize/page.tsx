...
const ACCENT = "#dc2626";
const MODULE = "Impact Measurement";
const PAGE = "Visualization";
const KPIS = [{"l":"Dashboards Ativos","v":"3.721","t":"+12.5%","d":"up"},{"l":"Queries/Dia","v":"1170","t":"+16.4%","d":"up"},{"l":"Dados Processados (GB)","v":"7.431","t":"+11.9%","d":"up"},{"l":"Utilizadores Analytics","v":"5.958","t":"+16.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3596","2026-01-25","6.441","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","387","2026-03-10","5.237","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","521","2026-02-16","166","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2004","2026-02-02","3.138","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3919","2026-02-08","7.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":688},{"label":"Mar","value":877},{"label":"Abr","value":777},{"label":"Mai","value":929},{"label":"Jun","value":823},{"label":"Jul","value":767},{"label":"Ago","value":1060},{"label":"Set","value":946},{"label":"Out","value":1045},{"label":"Nov","value":972},{"label":"Dez","value":791}];
const MX = 1060;
