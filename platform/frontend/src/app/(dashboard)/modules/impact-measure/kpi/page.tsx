...
const PAGE = "KPI Framework";
const KPIS = [{"l":"Projetos Sociais","v":"7.925","t":"+17.0%","d":"up"},{"l":"Beneficiários","v":"2.246","t":"-3.8%","d":"down"},{"l":"Investimento CSR (€)","v":"€68617","t":"+7.9%","d":"up"},{"l":"Score Impacto","v":"69","t":"+13.9%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.514","€ 6961.26","3.054","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.455","€ 21056.55","2.448","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.454","€ 21732.27","7.268","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.691","€ 48040.30","9.038","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.523","€ 5260.30","7.054","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":728},{"label":"Mar","value":669},{"label":"Abr","value":671},{"label":"Mai","value":564},{"label":"Jun","value":922},{"label":"Jul","value":661},{"label":"Ago","value":571},{"label":"Set","value":840},{"label":"Out","value":552},{"label":"Nov","value":909},{"label":"Dez","value":801}];
const MX = 922;
