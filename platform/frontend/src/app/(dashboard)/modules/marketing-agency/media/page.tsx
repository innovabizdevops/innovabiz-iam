...
const PAGE = "Media Plan";
const KPIS = [{"l":"Integrações Ativas","v":"168","t":"+6.4%","d":"up"},{"l":"Chamadas/Hora","v":"1666","t":"+5.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.5%","t":"+15.7%","d":"up"},{"l":"Latência Média (ms)","v":"118ms","t":"+15.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.781","1.161","97.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.363","4.720","75.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.758","927","85.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.400","1.903","98.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.283","1.899","75.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":746},{"label":"Mar","value":738},{"label":"Abr","value":829},{"label":"Mai","value":877},{"label":"Jun","value":700},{"label":"Jul","value":835},{"label":"Ago","value":662},{"label":"Set","value":761},{"label":"Out","value":693},{"label":"Nov","value":829},{"label":"Dez","value":564}];
const MX = 877;
