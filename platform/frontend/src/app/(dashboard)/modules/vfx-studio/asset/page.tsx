...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"1.513","t":"+13.8%","d":"up"},{"l":"Valor Total (€M)","v":"€17.3M","t":"+13.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€74874","t":"+17.0%","d":"up"},{"l":"Ativos em Garantia","v":"5.206","t":"-0.8%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 26112.79","1.127","€ 13172.44","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 2221.64","7.402","€ 13391.62","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 13630.26","2.365","€ 12711.95","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 7628.54","6.183","€ 47442.49","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 19968.03","8.963","€ 39283.30","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":603},{"label":"Mar","value":681},{"label":"Abr","value":333},{"label":"Mai","value":343},{"label":"Jun","value":624},{"label":"Jul","value":469},{"label":"Ago","value":329},{"label":"Set","value":578},{"label":"Out","value":419},{"label":"Nov","value":582},{"label":"Dez","value":544}];
const MX = 681;
