...
const PAGE = "Deliver";
const KPIS = [{"l":"Total Vfx Studio","v":"1.374","t":"+11.6%","d":"up"},{"l":"Deliver Ativos","v":"4.242","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.4%","d":"down"}];
const COLS = ["ID","Deliver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vfx Studio #001","Vfx Studio #002","1.050","6.521","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Vfx Studio #002","Vfx Studio #003","4.248","8.210","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Vfx Studio #003","Vfx Studio #004","5.013","7.168","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Vfx Studio #004","Vfx Studio #005","2.338","2.182","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vfx Studio #005","Vfx Studio #001","7.130","6.109","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":565},{"label":"Mar","value":529},{"label":"Abr","value":478},{"label":"Mai","value":649},{"label":"Jun","value":504},{"label":"Jul","value":513},{"label":"Ago","value":613},{"label":"Set","value":786},{"label":"Out","value":527},{"label":"Nov","value":624},{"label":"Dez","value":794}];
const MX = 803;
