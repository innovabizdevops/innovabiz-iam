...
const PAGE = "Pipeline";
const KPIS = [{"l":"Total Vfx Studio","v":"2.797","t":"+9.1%","d":"up"},{"l":"Pipeline Ativos","v":"7.155","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"75","t":"+9.0%","d":"up"}];
const COLS = ["ID","Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vfx Studio #001","Vfx Studio #002","8.727","2.944","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Vfx Studio #002","Vfx Studio #003","6.143","8.290","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Vfx Studio #003","Vfx Studio #004","5.862","5.457","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Vfx Studio #004","Vfx Studio #005","2.103","4.376","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vfx Studio #005","Vfx Studio #001","3.472","3.931","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":358},{"label":"Mar","value":671},{"label":"Abr","value":725},{"label":"Mai","value":589},{"label":"Jun","value":501},{"label":"Jul","value":501},{"label":"Ago","value":605},{"label":"Set","value":456},{"label":"Out","value":669},{"label":"Nov","value":510},{"label":"Dez","value":598}];
const MX = 725;
