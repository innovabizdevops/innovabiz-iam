...
const ACCENT = "#6366f1";
const MODULE = "VFX Studio";
const PAGE = "Render Farm";
const KPIS = [{"l":"Total Vfx Studio","v":"8.846","t":"+0.7%","d":"up"},{"l":"Render Farm Ativos","v":"5.449","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"67.7%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"67","t":"+3.4%","d":"up"}];
const COLS = ["ID","Render Farm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vfx Studio #001","Vfx Studio #002","8.934","7.638","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Vfx Studio #002","Vfx Studio #003","2.751","7.665","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Vfx Studio #003","Vfx Studio #004","3.035","8.544","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Vfx Studio #004","Vfx Studio #005","2.233","2.264","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vfx Studio #005","Vfx Studio #001","6.134","5.723","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":628},{"label":"Mar","value":370},{"label":"Abr","value":659},{"label":"Mai","value":585},{"label":"Jun","value":434},{"label":"Jul","value":408},{"label":"Ago","value":663},{"label":"Set","value":437},{"label":"Out","value":411},{"label":"Nov","value":380},{"label":"Dez","value":495}];
const MX = 663;
