...
const PAGE = "Fault Inject";
const KPIS = [{"l":"Total Chaos Eng","v":"633","t":"+17.3%","d":"up"},{"l":"Fault Inject Ativos","v":"3.683","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"87.2%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"58","t":"+4.8%","d":"up"}];
const COLS = ["ID","Fault Inject","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chaos Eng #001","Chaos Eng #002","2.831","3.824","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Chaos Eng #002","Chaos Eng #003","8.652","6.190","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Chaos Eng #003","Chaos Eng #004","8.819","4.174","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Chaos Eng #004","Chaos Eng #005","2.068","433","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chaos Eng #005","Chaos Eng #001","7.467","706","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":981},{"label":"Mar","value":920},{"label":"Abr","value":636},{"label":"Mai","value":664},{"label":"Jun","value":639},{"label":"Jul","value":907},{"label":"Ago","value":731},{"label":"Set","value":608},{"label":"Out","value":632},{"label":"Nov","value":893},{"label":"Dez","value":770}];
const MX = 981;
