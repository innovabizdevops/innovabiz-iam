...
export default function ChaosEngPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Chaos Eng</h1><p className="text-sm text-muted-foreground">Chaos Eng • iBOS Enterprise</p></div>
