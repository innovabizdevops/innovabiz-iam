...
const KPIS = [{"l":"Total Chaos Eng","v":"1.455","t":"+7.2%","d":"up"},{"l":"Resilience Score Ativos","v":"78","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"92.2%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.2%","d":"up"}];
const COLS = ["ID","Resilience Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chaos Eng #001","82.3%","932","1.261","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Chaos Eng #002","99.5%","7.538","8.818","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Chaos Eng #003","90.1%","639","7.957","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Chaos Eng #004","95.1%","2.679","3.827","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chaos Eng #005","84.1%","4.681","1.325","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1040},{"label":"Fev","value":933},{"label":"Mar","value":845},{"label":"Abr","value":879},{"label":"Mai","value":1033},{"label":"Jun","value":898},{"label":"Jul","value":910},{"label":"Ago","value":745},{"label":"Set","value":856},{"label":"Out","value":843},{"label":"Nov","value":687},{"label":"Dez","value":897}];
const MX = 1040;
