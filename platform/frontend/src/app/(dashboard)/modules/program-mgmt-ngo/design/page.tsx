...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.310","t":"-4.0%","d":"down"},{"l":"Submissões/Dia","v":"4310","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"7.841","t":"+10.0%","d":"up"},{"l":"Templates","v":"419","t":"+7.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.018","2026-02-08","1.763","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.829","2026-01-05","6.043","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.185","2026-03-08","3.774","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.976","2026-02-07","5.160","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.544","2026-01-24","135","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":640},{"label":"Mar","value":441},{"label":"Abr","value":348},{"label":"Mai","value":352},{"label":"Jun","value":495},{"label":"Jul","value":600},{"label":"Ago","value":376},{"label":"Set","value":627},{"label":"Out","value":384},{"label":"Nov","value":436},{"label":"Dez","value":635}];
const MX = 640;
