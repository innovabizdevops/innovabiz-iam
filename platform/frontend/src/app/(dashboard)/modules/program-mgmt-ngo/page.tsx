...
export default function ProgramMgmtNgoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Program Mgmt Ngo</h1><p className="text-sm text-muted-foreground">Program Mgmt Ngo • iBOS Enterprise</p></div>
