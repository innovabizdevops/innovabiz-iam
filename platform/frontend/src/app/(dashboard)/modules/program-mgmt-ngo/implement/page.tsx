...
const ACCENT = "#6366f1";
const MODULE = "Program Management";
const PAGE = "Implement";
const KPIS = [{"l":"Total Program Mgmt Ngo","v":"5.105","t":"+8.1%","d":"up"},{"l":"Implement Ativos","v":"4.433","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"78","t":"+7.5%","d":"up"}];
const COLS = ["ID","Implement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Program Mgmt Ngo #001","Program Mgmt Ngo #002","2.432","8.667","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Program Mgmt Ngo #002","Program Mgmt Ngo #003","2.376","2.114","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Program Mgmt Ngo #003","Program Mgmt Ngo #004","1.333","5.703","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Program Mgmt Ngo #004","Program Mgmt Ngo #005","3.049","7.907","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Program Mgmt Ngo #005","Program Mgmt Ngo #001","8.022","2.981","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":787},{"label":"Mar","value":968},{"label":"Abr","value":961},{"label":"Mai","value":1011},{"label":"Jun","value":735},{"label":"Jul","value":855},{"label":"Ago","value":708},{"label":"Set","value":998},{"label":"Out","value":958},{"label":"Nov","value":891},{"label":"Dez","value":686}];
const MX = 1011;
