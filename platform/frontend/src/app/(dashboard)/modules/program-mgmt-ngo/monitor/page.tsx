...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Program Mgmt Ngo","v":"3.200","t":"+12.2%","d":"up"},{"l":"Monitor Ativos","v":"3.037","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+0.2%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Program Mgmt Ngo #001","Program Mgmt Ngo #002","1.497","8.206","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Program Mgmt Ngo #002","Program Mgmt Ngo #003","6.532","510","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Program Mgmt Ngo #003","Program Mgmt Ngo #004","7.855","7.062","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Program Mgmt Ngo #004","Program Mgmt Ngo #005","707","3.179","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Program Mgmt Ngo #005","Program Mgmt Ngo #001","1.313","6.112","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":603},{"label":"Mar","value":990},{"label":"Abr","value":677},{"label":"Mai","value":833},{"label":"Jun","value":865},{"label":"Jul","value":614},{"label":"Ago","value":760},{"label":"Set","value":955},{"label":"Out","value":691},{"label":"Nov","value":891},{"label":"Dez","value":742}];
const MX = 990;
