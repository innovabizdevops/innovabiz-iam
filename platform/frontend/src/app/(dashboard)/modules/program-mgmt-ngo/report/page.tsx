...
const PAGE = "Report";
const KPIS = [{"l":"Total Program Mgmt Ngo","v":"4.917","t":"+13.5%","d":"up"},{"l":"Report Ativos","v":"4.167","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"62","t":"+5.7%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Program Mgmt Ngo #001","Program Mgmt Ngo #002","1.374","1.620","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Program Mgmt Ngo #002","Program Mgmt Ngo #003","167","2.435","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Program Mgmt Ngo #003","Program Mgmt Ngo #004","7.213","7.356","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Program Mgmt Ngo #004","Program Mgmt Ngo #005","7.563","7.188","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Program Mgmt Ngo #005","Program Mgmt Ngo #001","7.174","9.042","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":805},{"label":"Mar","value":621},{"label":"Abr","value":502},{"label":"Mai","value":662},{"label":"Jun","value":807},{"label":"Jul","value":477},{"label":"Ago","value":765},{"label":"Set","value":819},{"label":"Out","value":657},{"label":"Nov","value":742},{"label":"Dez","value":675}];
const MX = 819;
