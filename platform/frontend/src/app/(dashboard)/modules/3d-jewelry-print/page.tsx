...
/* ═══ Jewelry 3D Printing — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "6925", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "160", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€462K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "315707925", cells: ["3D-6925", "Jewelry 3D Printing Item 1", "2/10/2026", "€8025"], status: "active" as const },
    { id: "315711496", cells: ["3D-1496", "Jewelry 3D Printing Item 2", "17/5/2026", "€11 596"], status: "pending" as const },
    { id: "315715067", cells: ["3D-5067", "Jewelry 3D Printing Item 3", "4/12/2026", "€15 167"], status: "completed" as const },
    { id: "315718638", cells: ["3D-8638", "Jewelry 3D Printing Item 4", "19/7/2026", "€18 738"], status: "warning" as const },
    { id: "315722209", cells: ["3D-3209", "Jewelry 3D Printing Item 5", "6/2/2026", "€22 309"], status: "active" as const },
];
...
export default function Jewelry3dPrintingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Jewelry 3D Printing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Jewelry 3D Printing</p>
                    </div>
                </div>
