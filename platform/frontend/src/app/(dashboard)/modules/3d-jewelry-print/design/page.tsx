...
const ACCENT = "#4338ca";
const MODULE = "Jewelry 3D Printing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.910","t":"+7.9%","d":"up"},{"l":"Submissões/Dia","v":"601","t":"-3.2%","d":"down"},{"l":"Documentos Gerados","v":"2.299","t":"+13.2%","d":"up"},{"l":"Templates","v":"1.599","t":"+7.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","808","2026-02-20","8.565","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.855","2026-01-13","7.623","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.431","2026-03-16","3.743","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.112","2026-01-12","5.419","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.517","2026-03-15","8.677","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":469},{"label":"Mar","value":545},{"label":"Abr","value":257},{"label":"Mai","value":372},{"label":"Jun","value":650},{"label":"Jul","value":485},{"label":"Ago","value":439},{"label":"Set","value":489},{"label":"Out","value":491},{"label":"Nov","value":479},{"label":"Dez","value":491}];
const MX = 650;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>3D</span></h1>
                </div>
