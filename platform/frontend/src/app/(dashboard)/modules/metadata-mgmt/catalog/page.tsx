...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"1.447","t":"+9.4%","d":"up"},{"l":"Queries/Dia","v":"4459","t":"+14.8%","d":"up"},{"l":"Dados Processados (GB)","v":"603","t":"+2.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.881","t":"+6.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2197","2026-02-01","1.920","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1099","2026-01-02","6.138","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2233","2026-01-03","7.734","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","559","2026-02-17","3.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","172","2026-02-17","6.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":599},{"label":"Mar","value":768},{"label":"Abr","value":671},{"label":"Mai","value":588},{"label":"Jun","value":749},{"label":"Jul","value":438},{"label":"Ago","value":611},{"label":"Set","value":672},{"label":"Out","value":549},{"label":"Nov","value":632},{"label":"Dez","value":471}];
const MX = 768;
