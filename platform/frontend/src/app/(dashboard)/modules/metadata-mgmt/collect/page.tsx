...
const PAGE = "Collect";
const KPIS = [{"l":"Dashboards Ativos","v":"7.488","t":"-4.2%","d":"down"},{"l":"Queries/Dia","v":"4114","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.215","t":"+12.4%","d":"up"},{"l":"Utilizadores Analytics","v":"795","t":"+18.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4820","2026-01-11","461","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4297","2026-03-28","4.837","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1930","2026-01-25","2.343","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3007","2026-03-20","1.521","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1193","2026-02-05","5.638","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":808},{"label":"Mar","value":854},{"label":"Abr","value":752},{"label":"Mai","value":673},{"label":"Jun","value":983},{"label":"Jul","value":635},{"label":"Ago","value":679},{"label":"Set","value":873},{"label":"Out","value":684},{"label":"Nov","value":831},{"label":"Dez","value":905}];
const MX = 983;
