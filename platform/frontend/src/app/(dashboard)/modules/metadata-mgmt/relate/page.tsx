...
const PAGE = "Relate";
const KPIS = [{"l":"Dashboards Ativos","v":"7.738","t":"+14.1%","d":"up"},{"l":"Queries/Dia","v":"1137","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"3.380","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.794","t":"+10.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3100","2026-01-05","6.524","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","618","2026-03-10","9.069","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3087","2026-02-08","3.592","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4753","2026-02-23","3.851","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","911","2026-01-19","410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":866},{"label":"Mar","value":720},{"label":"Abr","value":756},{"label":"Mai","value":757},{"label":"Jun","value":501},{"label":"Jul","value":482},{"label":"Ago","value":627},{"label":"Set","value":850},{"label":"Out","value":562},{"label":"Nov","value":683},{"label":"Dez","value":620}];
const MX = 866;
