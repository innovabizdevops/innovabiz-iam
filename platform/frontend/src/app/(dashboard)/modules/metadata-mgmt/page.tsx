...
/* ═══ Metadata Management Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "9746", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4299", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€318K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "797484346", cells: ["MET-4346", "Metadata Management Deep Item 1", "23/11/2026", "€34 446"], status: "active" as const },
    { id: "797487917", cells: ["MET-7917", "Metadata Management Deep Item 2", "10/6/2026", "€38 017"], status: "pending" as const },
    { id: "797491488", cells: ["MET-2488", "Metadata Management Deep Item 3", "25/1/2026", "€41 588"], status: "completed" as const },
    { id: "797495059", cells: ["MET-6059", "Metadata Management Deep Item 4", "12/8/2026", "€45 159"], status: "warning" as const },
    { id: "797498630", cells: ["MET-9630", "Metadata Management Deep Item 5", "27/3/2026", "€48 730"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 46 }, { label: "Fev", value: 55 }, { label: "Mar", value: 64 }, { label: "Abr", value: 73 }, { label: "Mai", value: 82 }, { label: "Jun", value: 91 }];
...
export default function MetadataManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metadata Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Metadata Management Deep</p>
                    </div>
                </div>
