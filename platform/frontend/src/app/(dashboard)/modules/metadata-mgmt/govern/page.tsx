...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"4.137","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"3760","t":"-2.8%","d":"down"},{"l":"Dados Processados (GB)","v":"5.122","t":"+0.5%","d":"up"},{"l":"Utilizadores Analytics","v":"270","t":"+6.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","992","2026-01-08","4.563","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4282","2026-02-26","4.256","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","689","2026-01-14","4.838","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","354","2026-03-05","120","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4525","2026-01-23","3.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":737},{"label":"Mar","value":616},{"label":"Abr","value":512},{"label":"Mai","value":410},{"label":"Jun","value":600},{"label":"Jul","value":622},{"label":"Ago","value":402},{"label":"Set","value":527},{"label":"Out","value":405},{"label":"Nov","value":678},{"label":"Dez","value":746}];
const MX = 746;
