...
const ACCENT = "#1e3a5f";
const MODULE = "Metadata Management Deep";
const PAGE = "Search";
const KPIS = [{"l":"Dashboards Ativos","v":"1.481","t":"+6.7%","d":"up"},{"l":"Queries/Dia","v":"5046","t":"+12.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.370","t":"+11.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.464","t":"+9.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3926","2026-02-17","6.119","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3690","2026-01-08","576","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","885","2026-02-11","6.565","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3935","2026-03-08","1.465","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2668","2026-03-10","4.675","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":569},{"label":"Mar","value":489},{"label":"Abr","value":481},{"label":"Mai","value":523},{"label":"Jun","value":581},{"label":"Jul","value":800},{"label":"Ago","value":735},{"label":"Set","value":641},{"label":"Out","value":538},{"label":"Nov","value":737},{"label":"Dez","value":623}];
const MX = 800;
