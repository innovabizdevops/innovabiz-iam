...
const PAGE = "Interceptors";
const KPIS = [{"l":"Integrações Ativas","v":"1.054","t":"+12.9%","d":"up"},{"l":"Chamadas/Hora","v":"4703","t":"+15.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.6%","t":"-0.8%","d":"down"},{"l":"Latência Média (ms)","v":"100ms","t":"+9.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","862","4.425","75.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.110","3.058","92.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.646","7.800","98.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.329","3.222","77.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.092","2.013","79.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":954},{"label":"Mar","value":661},{"label":"Abr","value":838},{"label":"Mai","value":783},{"label":"Jun","value":758},{"label":"Jul","value":957},{"label":"Ago","value":895},{"label":"Set","value":849},{"label":"Out","value":829},{"label":"Nov","value":593},{"label":"Dez","value":798}];
const MX = 957;
