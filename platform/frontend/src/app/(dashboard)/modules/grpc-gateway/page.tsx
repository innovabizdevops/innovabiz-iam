...
export default function GrpcGatewayPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Grpc Gateway</h1><p className="text-sm text-muted-foreground">Grpc Gateway • iBOS Enterprise</p></div>
