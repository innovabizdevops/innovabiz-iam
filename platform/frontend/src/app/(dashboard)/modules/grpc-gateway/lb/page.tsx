...
const PAGE = "Load Balancer";
const KPIS = [{"l":"Integrações Ativas","v":"2.254","t":"+9.9%","d":"up"},{"l":"Chamadas/Hora","v":"1756","t":"+16.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.4%","t":"+17.1%","d":"up"},{"l":"Latência Média (ms)","v":"67ms","t":"+15.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.674","7.377","71.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.930","5.448","90.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.872","1.673","94.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.730","2.644","95.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.556","5.465","84.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":665},{"label":"Mar","value":476},{"label":"Abr","value":833},{"label":"Mai","value":463},{"label":"Jun","value":449},{"label":"Jul","value":752},{"label":"Ago","value":718},{"label":"Set","value":572},{"label":"Out","value":575},{"label":"Nov","value":452},{"label":"Dez","value":808}];
const MX = 833;
