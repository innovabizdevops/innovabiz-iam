...
const ACCENT = "#059669";
const MODULE = "gRPC Gateway";
const PAGE = "Service Map";
const KPIS = [{"l":"Integrações Ativas","v":"3.353","t":"+13.1%","d":"up"},{"l":"Chamadas/Hora","v":"2232","t":"-3.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.3%","t":"-2.9%","d":"down"},{"l":"Latência Média (ms)","v":"17ms","t":"+14.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.230","5.448","84.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.192","6.085","77.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.679","6.333","80.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.019","3.565","96.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.382","2.179","77.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":636},{"label":"Mar","value":936},{"label":"Abr","value":922},{"label":"Mai","value":963},{"label":"Jun","value":858},{"label":"Jul","value":652},{"label":"Ago","value":748},{"label":"Set","value":896},{"label":"Out","value":676},{"label":"Nov","value":939},{"label":"Dez","value":848}];
const MX = 963;
