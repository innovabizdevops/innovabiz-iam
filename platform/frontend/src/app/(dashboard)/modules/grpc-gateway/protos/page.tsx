...
const PAGE = "Proto Registry";
const KPIS = [{"l":"Integrações Ativas","v":"8.623","t":"+7.5%","d":"up"},{"l":"Chamadas/Hora","v":"3837","t":"+17.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.2%","t":"+15.8%","d":"up"},{"l":"Latência Média (ms)","v":"41ms","t":"+7.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.227","8.256","76.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.748","1.448","89.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.637","6.278","96.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.541","3.642","79.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.121","1.674","73.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":791},{"label":"Mar","value":961},{"label":"Abr","value":676},{"label":"Mai","value":784},{"label":"Jun","value":788},{"label":"Jul","value":568},{"label":"Ago","value":804},{"label":"Set","value":659},{"label":"Out","value":717},{"label":"Nov","value":777},{"label":"Dez","value":570}];
const MX = 961;
