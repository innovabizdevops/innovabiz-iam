...
const PAGE = "Reflection";
const KPIS = [{"l":"Integrações Ativas","v":"2.037","t":"+4.0%","d":"up"},{"l":"Chamadas/Hora","v":"2961","t":"+6.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.8%","t":"+9.3%","d":"up"},{"l":"Latência Média (ms)","v":"117ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.642","2.712","78.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.777","5.676","77.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.984","1.108","88.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.797","1.122","74.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","724","8.996","86.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":497},{"label":"Mar","value":359},{"label":"Abr","value":288},{"label":"Mai","value":519},{"label":"Jun","value":221},{"label":"Jul","value":515},{"label":"Ago","value":319},{"label":"Set","value":372},{"label":"Out","value":264},{"label":"Nov","value":464},{"label":"Dez","value":527}];
const MX = 608;
