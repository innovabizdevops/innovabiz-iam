...
const PAGE = "Productivity";
const KPIS = [{"l":"Dashboards Ativos","v":"2.453","t":"+9.0%","d":"up"},{"l":"Queries/Dia","v":"1746","t":"+10.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.727","t":"+3.0%","d":"up"},{"l":"Utilizadores Analytics","v":"838","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","880","2026-02-02","5.524","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4998","2026-02-20","3.706","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4547","2026-01-07","2.807","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2967","2026-01-21","8.491","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3709","2026-03-02","7.929","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":797},{"label":"Mar","value":725},{"label":"Abr","value":773},{"label":"Mai","value":619},{"label":"Jun","value":508},{"label":"Jul","value":886},{"label":"Ago","value":746},{"label":"Set","value":857},{"label":"Out","value":822},{"label":"Nov","value":686},{"label":"Dez","value":635}];
const MX = 886;
