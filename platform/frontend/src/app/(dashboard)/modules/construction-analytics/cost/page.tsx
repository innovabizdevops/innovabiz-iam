...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"4.989","t":"-3.8%","d":"down"},{"l":"Queries/Dia","v":"2307","t":"+15.7%","d":"up"},{"l":"Dados Processados (GB)","v":"1.102","t":"-4.4%","d":"down"},{"l":"Utilizadores Analytics","v":"505","t":"+8.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4716","2026-02-27","4.589","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","630","2026-03-04","1.619","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4962","2026-01-23","2.585","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","282","2026-03-23","7.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5094","2026-02-26","8.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":697},{"label":"Mar","value":727},{"label":"Abr","value":870},{"label":"Mai","value":929},{"label":"Jun","value":1053},{"label":"Jul","value":982},{"label":"Ago","value":702},{"label":"Set","value":979},{"label":"Out","value":823},{"label":"Nov","value":829},{"label":"Dez","value":809}];
const MX = 1053;
