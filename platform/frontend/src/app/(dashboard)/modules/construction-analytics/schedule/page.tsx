...
const PAGE = "Schedule";
const KPIS = [{"l":"Dashboards Ativos","v":"4.956","t":"-4.0%","d":"down"},{"l":"Queries/Dia","v":"1171","t":"+4.3%","d":"up"},{"l":"Dados Processados (GB)","v":"5.547","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"2.098","t":"+14.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1863","2026-02-25","4.187","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4712","2026-02-08","5.317","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4502","2026-03-10","2.899","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3774","2026-01-03","2.756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4655","2026-01-09","5.909","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":577},{"label":"Mar","value":304},{"label":"Abr","value":533},{"label":"Mai","value":585},{"label":"Jun","value":587},{"label":"Jul","value":534},{"label":"Ago","value":600},{"label":"Set","value":372},{"label":"Out","value":616},{"label":"Nov","value":408},{"label":"Dez","value":520}];
const MX = 623;
