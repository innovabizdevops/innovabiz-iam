...
const PAGE = "Safety";
const KPIS = [{"l":"Dashboards Ativos","v":"3.181","t":"+14.3%","d":"up"},{"l":"Queries/Dia","v":"4440","t":"+14.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.597","t":"+15.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.015","t":"-2.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3026","2026-03-16","1.635","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1013","2026-02-14","2.954","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2208","2026-02-11","7.855","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2862","2026-03-25","6.398","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4657","2026-02-06","1.288","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":352},{"label":"Mar","value":597},{"label":"Abr","value":556},{"label":"Mai","value":335},{"label":"Jun","value":441},{"label":"Jul","value":492},{"label":"Ago","value":358},{"label":"Set","value":470},{"label":"Out","value":620},{"label":"Nov","value":568},{"label":"Dez","value":611}];
const MX = 620;
