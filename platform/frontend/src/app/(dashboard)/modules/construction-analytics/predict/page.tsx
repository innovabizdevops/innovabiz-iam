...
const ACCENT = "#6366f1";
const MODULE = "Construction Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"8.168","t":"+1.3%","d":"up"},{"l":"Queries/Dia","v":"3732","t":"+10.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.257","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"600","t":"-5.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1177","2026-02-03","3.548","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2869","2026-01-27","7.034","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2158","2026-03-17","7.759","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4463","2026-03-11","2.138","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3156","2026-03-23","3.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":553},{"label":"Mar","value":552},{"label":"Abr","value":546},{"label":"Mai","value":261},{"label":"Jun","value":288},{"label":"Jul","value":252},{"label":"Ago","value":516},{"label":"Set","value":563},{"label":"Out","value":603},{"label":"Nov","value":420},{"label":"Dez","value":445}];
const MX = 603;
