...
const ACCENT = "#06b6d4";
const MODULE = "Scheduler & Calendar Engine";
const PAGE = "Availability";
const KPIS = [{"l":"Total Scheduler Engine","v":"206","t":"+9.2%","d":"up"},{"l":"Availability Ativos","v":"4.524","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+1.2%","d":"up"}];
const COLS = ["ID","Availability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scheduler Engine #001","Scheduler Engine #002","8.033","4.132","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Scheduler Engine #002","Scheduler Engine #003","7.348","1.789","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Scheduler Engine #003","Scheduler Engine #004","6.192","2.074","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Scheduler Engine #004","Scheduler Engine #005","5.467","7.122","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scheduler Engine #005","Scheduler Engine #001","1.515","7.487","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":985},{"label":"Mar","value":690},{"label":"Abr","value":954},{"label":"Mai","value":762},{"label":"Jun","value":718},{"label":"Jul","value":694},{"label":"Ago","value":887},{"label":"Set","value":847},{"label":"Out","value":979},{"label":"Nov","value":690},{"label":"Dez","value":858}];
const MX = 985;
