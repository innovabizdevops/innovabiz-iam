...
const KPIS = [{"l":"Total Scheduler Engine","v":"7.152","t":"+12.5%","d":"up"},{"l":"Recurring Ativos","v":"1.273","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.7%","d":"up"}];
const COLS = ["ID","Recurring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scheduler Engine #001","Scheduler Engine #002","1.108","1.116","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Scheduler Engine #002","Scheduler Engine #003","7.956","5.104","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Scheduler Engine #003","Scheduler Engine #004","8.816","6.995","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Scheduler Engine #004","Scheduler Engine #005","577","8.801","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scheduler Engine #005","Scheduler Engine #001","964","4.689","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":540},{"label":"Mar","value":764},{"label":"Abr","value":585},{"label":"Mai","value":786},{"label":"Jun","value":773},{"label":"Jul","value":717},{"label":"Ago","value":543},{"label":"Set","value":587},{"label":"Out","value":596},{"label":"Nov","value":679},{"label":"Dez","value":405}];
const MX = 786;
