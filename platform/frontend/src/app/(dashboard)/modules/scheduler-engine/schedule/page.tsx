...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Scheduler Engine","v":"5.389","t":"+4.2%","d":"up"},{"l":"Schedule Ativos","v":"3.918","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"77","t":"+0.5%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scheduler Engine #001","Scheduler Engine #002","8.490","5.286","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Scheduler Engine #002","Scheduler Engine #003","3.863","3.440","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Scheduler Engine #003","Scheduler Engine #004","4.209","3.424","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Scheduler Engine #004","Scheduler Engine #005","3.083","8.619","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scheduler Engine #005","Scheduler Engine #001","7.548","3.254","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":399},{"label":"Mar","value":483},{"label":"Abr","value":574},{"label":"Mai","value":378},{"label":"Jun","value":413},{"label":"Jul","value":372},{"label":"Ago","value":473},{"label":"Set","value":644},{"label":"Out","value":559},{"label":"Nov","value":457},{"label":"Dez","value":466}];
const MX = 644;
