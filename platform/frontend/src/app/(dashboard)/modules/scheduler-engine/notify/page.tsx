...
const PAGE = "Notify";
const KPIS = [{"l":"Notificações Enviadas","v":"2.232","t":"+15.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"66.0%","t":"+16.7%","d":"up"},{"l":"Taxa Abertura (%)","v":"89.7%","t":"+1.7%","d":"up"},{"l":"Escalações","v":"3.001","t":"+3.1%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.353","75.4%","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","901","95.7%","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.699","82.0%","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.939","84.7%","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.752","97.1%","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":777},{"label":"Mar","value":474},{"label":"Abr","value":408},{"label":"Mai","value":663},{"label":"Jun","value":519},{"label":"Jul","value":511},{"label":"Ago","value":656},{"label":"Set","value":774},{"label":"Out","value":674},{"label":"Nov","value":619},{"label":"Dez","value":462}];
const MX = 777;
