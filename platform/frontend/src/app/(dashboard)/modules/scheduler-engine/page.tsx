...
/* ═══ Scheduler & Calendar Engine — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "7631", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "880", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€67K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "3927931", cells: ["SCH-4931", "Scheduler & Calendar Engine Item 1", "8/8/2026", "€28 031"], status: "active" as const },
    { id: "3931502", cells: ["SCH-8502", "Scheduler & Calendar Engine Item 2", "23/3/2026", "€31 602"], status: "pending" as const },
    { id: "3935073", cells: ["SCH-3073", "Scheduler & Calendar Engine Item 3", "10/10/2026", "€35 173"], status: "completed" as const },
    { id: "3938644", cells: ["SCH-6644", "Scheduler & Calendar Engine Item 4", "25/5/2026", "€38 744"], status: "warning" as const },
    { id: "3942215", cells: ["SCH-1215", "Scheduler & Calendar Engine Item 5", "12/12/2026", "€42 315"], status: "active" as const },
];
...
export default function SchedulerCalendarEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Scheduler & Calendar Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Scheduler & Calendar Engine</p>
                    </div>
                </div>
