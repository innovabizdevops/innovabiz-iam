...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"2.841","t":"+16.8%","d":"up"},{"l":"Viagens/Dia","v":"4466","t":"+11.3%","d":"up"},{"l":"Pontualidade (%)","v":"85.7%","t":"+0.2%","d":"up"},{"l":"Passageiros/Dia","v":"3922","t":"+8.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-16","2026-03-04","7.775","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-23","2026-03-05","2.804","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-25","2026-01-08","6.155","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-12","2026-03-27","2.377","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-19","2026-01-16","8.279","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":963},{"label":"Mar","value":901},{"label":"Abr","value":776},{"label":"Mai","value":689},{"label":"Jun","value":999},{"label":"Jul","value":792},{"label":"Ago","value":950},{"label":"Set","value":972},{"label":"Out","value":757},{"label":"Nov","value":732},{"label":"Dez","value":841}];
const MX = 999;
