...
const ACCENT = "#6366f1";
const MODULE = "Fire Department";
const PAGE = "Personnel";
const KPIS = [{"l":"Total Fire Department","v":"6.342","t":"+14.9%","d":"up"},{"l":"Personnel Ativos","v":"6.659","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"86.7%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"93","t":"-5.9%","d":"down"}];
const COLS = ["ID","Personnel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fire Department #001","Fire Department #002","6.028","2.215","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Fire Department #002","Fire Department #003","4.178","6.454","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Fire Department #003","Fire Department #004","2.540","8.212","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Fire Department #004","Fire Department #005","3.630","8.523","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fire Department #005","Fire Department #001","2.836","4.009","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":824},{"label":"Mar","value":654},{"label":"Abr","value":907},{"label":"Mai","value":781},{"label":"Jun","value":650},{"label":"Jul","value":1001},{"label":"Ago","value":676},{"label":"Set","value":888},{"label":"Out","value":883},{"label":"Nov","value":785},{"label":"Dez","value":679}];
const MX = 1001;
