...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"4.424","t":"-2.0%","d":"down"},{"l":"SLA Cumprido (%)","v":"68.9%","t":"+12.1%","d":"up"},{"l":"MTTR (h)","v":"158h","t":"+11.2%","d":"up"},{"l":"Satisfação (%)","v":"86.9%","t":"+12.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.530","1.637","1.119","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","563","6.545","1.710","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.713","3.874","5.221","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.978","8.804","8.658","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.445","1.966","3.190","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":549},{"label":"Mar","value":462},{"label":"Abr","value":719},{"label":"Mai","value":764},{"label":"Jun","value":768},{"label":"Jul","value":481},{"label":"Ago","value":766},{"label":"Set","value":448},{"label":"Out","value":434},{"label":"Nov","value":717},{"label":"Dez","value":725}];
const MX = 768;
