...
const KPIS = [{"l":"Total Waf Mgmt","v":"2.510","t":"-0.4%","d":"down"},{"l":"Rate Limiting Ativos","v":"5.666","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"85","t":"+9.9%","d":"up"}];
const COLS = ["ID","Rate Limiting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waf Mgmt #001","Waf Mgmt #002","5.020","6.423","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Waf Mgmt #002","Waf Mgmt #003","2.752","5.861","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Waf Mgmt #003","Waf Mgmt #004","7.355","3.782","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Waf Mgmt #004","Waf Mgmt #005","7.552","5.413","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waf Mgmt #005","Waf Mgmt #001","4.809","4.852","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":796},{"label":"Mar","value":577},{"label":"Abr","value":524},{"label":"Mai","value":789},{"label":"Jun","value":739},{"label":"Jul","value":629},{"label":"Ago","value":766},{"label":"Set","value":523},{"label":"Out","value":734},{"label":"Nov","value":823},{"label":"Dez","value":613}];
const MX = 832;
