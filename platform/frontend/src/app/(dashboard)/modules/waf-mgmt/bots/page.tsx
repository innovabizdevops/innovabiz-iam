...
const PAGE = "Bot Protection";
const KPIS = [{"l":"Total Waf Mgmt","v":"8.447","t":"+17.4%","d":"up"},{"l":"Bot Protection Ativos","v":"3.245","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"90","t":"+16.7%","d":"up"}];
const COLS = ["ID","Bot Protection","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waf Mgmt #001","Waf Mgmt #002","4.192","276","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Waf Mgmt #002","Waf Mgmt #003","1.068","776","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Waf Mgmt #003","Waf Mgmt #004","6.734","1.988","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Waf Mgmt #004","Waf Mgmt #005","6.590","6.728","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waf Mgmt #005","Waf Mgmt #001","998","2.366","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":467},{"label":"Mar","value":344},{"label":"Abr","value":319},{"label":"Mai","value":228},{"label":"Jun","value":559},{"label":"Jul","value":236},{"label":"Ago","value":351},{"label":"Set","value":360},{"label":"Out","value":235},{"label":"Nov","value":468},{"label":"Dez","value":455}];
const MX = 559;
