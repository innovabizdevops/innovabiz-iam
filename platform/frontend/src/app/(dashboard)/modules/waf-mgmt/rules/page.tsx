...
const PAGE = "Rule Sets";
const KPIS = [{"l":"Total Waf Mgmt","v":"5.004","t":"+7.3%","d":"up"},{"l":"Rule Sets Ativos","v":"1.126","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"61","t":"-0.3%","d":"down"}];
const COLS = ["ID","Rule Sets","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waf Mgmt #001","Waf Mgmt #002","3.028","2.547","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Waf Mgmt #002","Waf Mgmt #003","2.447","383","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Waf Mgmt #003","Waf Mgmt #004","854","5.528","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Waf Mgmt #004","Waf Mgmt #005","5.463","3.694","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waf Mgmt #005","Waf Mgmt #001","867","1.779","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":872},{"label":"Mar","value":757},{"label":"Abr","value":936},{"label":"Mai","value":752},{"label":"Jun","value":633},{"label":"Jul","value":783},{"label":"Ago","value":630},{"label":"Set","value":602},{"label":"Out","value":580},{"label":"Nov","value":653},{"label":"Dez","value":970}];
const MX = 970;
