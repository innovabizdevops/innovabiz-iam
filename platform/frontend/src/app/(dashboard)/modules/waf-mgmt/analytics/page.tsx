...
const ACCENT = "#059669";
const MODULE = "WAF Management";
const PAGE = "Attack Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.896","t":"+15.6%","d":"up"},{"l":"Queries/Dia","v":"1187","t":"-5.9%","d":"down"},{"l":"Dados Processados (GB)","v":"8.074","t":"+9.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.936","t":"+14.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4237","2026-02-07","2.994","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2745","2026-02-21","6.191","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4896","2026-02-26","4.718","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3234","2026-02-18","4.155","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4613","2026-02-17","3.414","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":729},{"label":"Mar","value":835},{"label":"Abr","value":783},{"label":"Mai","value":920},{"label":"Jun","value":746},{"label":"Jul","value":871},{"label":"Ago","value":737},{"label":"Set","value":835},{"label":"Out","value":780},{"label":"Nov","value":696},{"label":"Dez","value":955}];
const MX = 955;
