...
const PAGE = "IP Reputation";
const KPIS = [{"l":"Total Waf Mgmt","v":"2.423","t":"-1.0%","d":"down"},{"l":"IP Reputation Ativos","v":"8.275","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"69","t":"-3.9%","d":"down"}];
const COLS = ["ID","IP Reputation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waf Mgmt #001","Waf Mgmt #002","3.794","2.988","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Waf Mgmt #002","Waf Mgmt #003","7.156","7.187","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Waf Mgmt #003","Waf Mgmt #004","3.703","2.096","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Waf Mgmt #004","Waf Mgmt #005","5.092","2.033","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waf Mgmt #005","Waf Mgmt #001","5.328","6.812","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":482},{"label":"Mar","value":653},{"label":"Abr","value":656},{"label":"Mai","value":696},{"label":"Jun","value":414},{"label":"Jul","value":506},{"label":"Ago","value":583},{"label":"Set","value":451},{"label":"Out","value":723},{"label":"Nov","value":514},{"label":"Dez","value":739}];
const MX = 739;
