...
const PAGE = "DDoS Protect";
const KPIS = [{"l":"Total Waf Mgmt","v":"941","t":"+13.7%","d":"up"},{"l":"DDoS Protect Ativos","v":"6.289","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"74","t":"+6.4%","d":"up"}];
const COLS = ["ID","DDoS Protect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waf Mgmt #001","Waf Mgmt #002","9.035","2.188","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Waf Mgmt #002","Waf Mgmt #003","2.362","2.213","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Waf Mgmt #003","Waf Mgmt #004","7.304","4.194","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Waf Mgmt #004","Waf Mgmt #005","8.387","4.595","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waf Mgmt #005","Waf Mgmt #001","627","2.107","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":280},{"label":"Mar","value":307},{"label":"Abr","value":492},{"label":"Mai","value":485},{"label":"Jun","value":439},{"label":"Jul","value":343},{"label":"Ago","value":613},{"label":"Set","value":630},{"label":"Out","value":437},{"label":"Nov","value":653},{"label":"Dez","value":294}];
const MX = 653;
