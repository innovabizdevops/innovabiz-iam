...
const PAGE = "Geo Blocking";
const KPIS = [{"l":"Total Waf Mgmt","v":"5.094","t":"-0.2%","d":"down"},{"l":"Geo Blocking Ativos","v":"7.155","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+7.1%","d":"up"}];
const COLS = ["ID","Geo Blocking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waf Mgmt #001","Waf Mgmt #002","3.917","3.210","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Waf Mgmt #002","Waf Mgmt #003","6.863","4.235","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Waf Mgmt #003","Waf Mgmt #004","5.414","8.884","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Waf Mgmt #004","Waf Mgmt #005","5.925","4.441","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waf Mgmt #005","Waf Mgmt #001","3.224","6.969","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":608},{"label":"Mar","value":623},{"label":"Abr","value":650},{"label":"Mai","value":931},{"label":"Jun","value":657},{"label":"Jul","value":636},{"label":"Ago","value":636},{"label":"Set","value":909},{"label":"Out","value":563},{"label":"Nov","value":862},{"label":"Dez","value":854}];
const MX = 931;
