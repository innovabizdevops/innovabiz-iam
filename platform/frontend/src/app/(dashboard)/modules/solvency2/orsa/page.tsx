...
const PAGE = "ORSA";
const KPIS = [{"l":"Total Solvency2","v":"8.240","t":"-1.9%","d":"down"},{"l":"ORSA Ativos","v":"7.037","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.5%","d":"up"}];
const COLS = ["ID","ORSA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solvency2 #001","Solvency2 #002","4.391","5.466","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Solvency2 #002","Solvency2 #003","1.646","4.070","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Solvency2 #003","Solvency2 #004","9.039","1.074","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Solvency2 #004","Solvency2 #005","3.258","6.456","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solvency2 #005","Solvency2 #001","8.485","5.693","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":555},{"label":"Mar","value":675},{"label":"Abr","value":524},{"label":"Mai","value":720},{"label":"Jun","value":792},{"label":"Jul","value":723},{"label":"Ago","value":594},{"label":"Set","value":782},{"label":"Out","value":713},{"label":"Nov","value":648},{"label":"Dez","value":756}];
const MX = 792;
...
export default function OrsaPage() {
    return (
