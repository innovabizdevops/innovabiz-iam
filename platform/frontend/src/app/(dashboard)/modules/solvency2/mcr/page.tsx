...
const PAGE = "MCR";
const KPIS = [{"l":"Total Solvency2","v":"1.885","t":"+13.8%","d":"up"},{"l":"MCR Ativos","v":"3.776","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"70","t":"+8.1%","d":"up"}];
const COLS = ["ID","MCR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solvency2 #001","Solvency2 #002","786","8.225","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Solvency2 #002","Solvency2 #003","6.278","1.747","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Solvency2 #003","Solvency2 #004","6.842","2.644","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Solvency2 #004","Solvency2 #005","6.182","7.705","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solvency2 #005","Solvency2 #001","6.406","4.982","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1027},{"label":"Fev","value":743},{"label":"Mar","value":848},{"label":"Abr","value":751},{"label":"Mai","value":844},{"label":"Jun","value":794},{"label":"Jul","value":979},{"label":"Ago","value":981},{"label":"Set","value":696},{"label":"Out","value":970},{"label":"Nov","value":1024},{"label":"Dez","value":715}];
const MX = 1027;
