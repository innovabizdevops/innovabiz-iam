...
/* ═══ Solvency II — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "3884", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2719", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€184K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1052898484", cells: ["SOL-7484", "Solvency II Item 1", "9/5/2026", "€48 584"], status: "active" as const },
    { id: "1052902055", cells: ["SOL-2055", "Solvency II Item 2", "24/12/2026", "€2155"], status: "pending" as const },
    { id: "1052905626", cells: ["SOL-5626", "Solvency II Item 3", "11/7/2026", "€5726"], status: "completed" as const },
    { id: "1052909197", cells: ["SOL-9197", "Solvency II Item 4", "26/2/2026", "€9297"], status: "warning" as const },
    { id: "1052912768", cells: ["SOL-3768", "Solvency II Item 5", "13/9/2026", "€12 868"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Solvency II</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Solvency II</p>
                    </div>
                </div>
