...
const PAGE = "SCR";
const KPIS = [{"l":"Total Solvency2","v":"4.521","t":"-0.1%","d":"down"},{"l":"SCR Ativos","v":"3.100","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+2.0%","d":"up"}];
const COLS = ["ID","SCR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solvency2 #001","Solvency2 #002","750","2.948","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Solvency2 #002","Solvency2 #003","5.654","183","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Solvency2 #003","Solvency2 #004","6.862","3.865","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Solvency2 #004","Solvency2 #005","8.547","2.367","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solvency2 #005","Solvency2 #001","1.259","4.270","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":637},{"label":"Mar","value":673},{"label":"Abr","value":493},{"label":"Mai","value":442},{"label":"Jun","value":671},{"label":"Jul","value":394},{"label":"Ago","value":469},{"label":"Set","value":594},{"label":"Out","value":597},{"label":"Nov","value":462},{"label":"Dez","value":393}];
const MX = 673;
