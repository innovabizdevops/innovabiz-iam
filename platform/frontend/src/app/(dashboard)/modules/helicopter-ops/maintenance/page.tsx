...
const ACCENT = "#6366f1";
const MODULE = "Helicopter Operations";
const PAGE = "Maintenance";
const KPIS = [{"l":"Total Helicopter Ops","v":"2.706","t":"-2.4%","d":"down"},{"l":"Maintenance Ativos","v":"5.489","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"59","t":"+15.5%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Helicopter Ops #001","Helicopter Ops #002","8.447","5.776","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Helicopter Ops #002","Helicopter Ops #003","3.688","1.410","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Helicopter Ops #003","Helicopter Ops #004","6.631","5.663","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Helicopter Ops #004","Helicopter Ops #005","7.970","3.451","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Helicopter Ops #005","Helicopter Ops #001","4.627","645","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":958},{"label":"Mar","value":691},{"label":"Abr","value":694},{"label":"Mai","value":692},{"label":"Jun","value":853},{"label":"Jul","value":952},{"label":"Ago","value":723},{"label":"Set","value":736},{"label":"Out","value":950},{"label":"Nov","value":755},{"label":"Dez","value":901}];
const MX = 958;
