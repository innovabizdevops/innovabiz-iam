...
const ACCENT = "#0c4a6e";
const MODULE = "Towing Service";
const PAGE = "GPS";
const KPIS = [{"l":"Total Tow Service","v":"7.874","t":"+5.3%","d":"up"},{"l":"GPS Ativos","v":"555","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+14.7%","d":"up"}];
const COLS = ["ID","GPS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tow Service #001","Tow Service #002","2.251","3.586","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Tow Service #002","Tow Service #003","1.650","2.523","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Tow Service #003","Tow Service #004","5.595","4.402","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Tow Service #004","Tow Service #005","2.101","6.274","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tow Service #005","Tow Service #001","1.976","3.205","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":476},{"label":"Mar","value":648},{"label":"Abr","value":771},{"label":"Mai","value":435},{"label":"Jun","value":542},{"label":"Jul","value":452},{"label":"Ago","value":647},{"label":"Set","value":584},{"label":"Out","value":763},{"label":"Nov","value":598},{"label":"Dez","value":433}];
const MX = 771;
