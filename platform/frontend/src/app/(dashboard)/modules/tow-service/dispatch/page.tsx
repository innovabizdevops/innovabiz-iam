...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"486","t":"+14.4%","d":"up"},{"l":"Viagens/Dia","v":"1974","t":"+11.1%","d":"up"},{"l":"Pontualidade (%)","v":"74.5%","t":"+10.0%","d":"up"},{"l":"Passageiros/Dia","v":"4917","t":"-0.8%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-03","2026-01-10","6.174","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-28","2026-01-19","4.058","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-20","2026-02-05","6.728","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-08","2026-02-22","3.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-21","2026-02-11","7.249","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":528},{"label":"Mar","value":450},{"label":"Abr","value":619},{"label":"Mai","value":265},{"label":"Jun","value":513},{"label":"Jul","value":460},{"label":"Ago","value":335},{"label":"Set","value":490},{"label":"Out","value":369},{"label":"Nov","value":387},{"label":"Dez","value":438}];
const MX = 619;
