...
const ACCENT = "#7c3aed";
const MODULE = "Smart Contract Audit";
const PAGE = "Code Review";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.270","t":"-0.4%","d":"down"},{"l":"NC Abertas","v":"7.340","t":"+16.3%","d":"up"},{"l":"Conformidade (%)","v":"76.7%","t":"+0.5%","d":"up"},{"l":"CAPAs Pendentes","v":"603","t":"-2.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.388","80.3%","5.260","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.207","87.9%","121","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.490","99.7%","7.491","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.431","87.3%","8.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.410","97.3%","3.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":921},{"label":"Fev","value":665},{"label":"Mar","value":761},{"label":"Abr","value":771},{"label":"Mai","value":673},{"label":"Jun","value":551},{"label":"Jul","value":678},{"label":"Ago","value":773},{"label":"Set","value":837},{"label":"Out","value":705},{"label":"Nov","value":690},{"label":"Dez","value":858}];
const MX = 921;
