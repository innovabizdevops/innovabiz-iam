...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.644","t":"+4.8%","d":"up"},{"l":"NC Abertas","v":"1.856","t":"-0.6%","d":"down"},{"l":"Conformidade (%)","v":"88.5%","t":"+0.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.084","t":"+14.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.147","77.9%","4.812","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.498","93.0%","3.067","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.121","87.0%","8.450","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.446","81.1%","7.616","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.825","71.6%","1.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":579},{"label":"Mar","value":281},{"label":"Abr","value":426},{"label":"Mai","value":495},{"label":"Jun","value":440},{"label":"Jul","value":476},{"label":"Ago","value":580},{"label":"Set","value":227},{"label":"Out","value":347},{"label":"Nov","value":341},{"label":"Dez","value":421}];
const MX = 580;
