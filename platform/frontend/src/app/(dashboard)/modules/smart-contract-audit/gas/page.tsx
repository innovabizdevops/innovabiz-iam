...
const PAGE = "Gas Optimize";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.448","t":"+-0.0%","d":"up"},{"l":"NC Abertas","v":"7.122","t":"+0.9%","d":"up"},{"l":"Conformidade (%)","v":"82.0%","t":"-4.2%","d":"down"},{"l":"CAPAs Pendentes","v":"3.970","t":"+16.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.804","97.9%","3.342","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.373","81.9%","5.867","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.912","78.6%","8.652","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.968","78.6%","8.267","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.203","75.2%","894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":939},{"label":"Mar","value":875},{"label":"Abr","value":723},{"label":"Mai","value":737},{"label":"Jun","value":920},{"label":"Jul","value":804},{"label":"Ago","value":818},{"label":"Set","value":858},{"label":"Out","value":981},{"label":"Nov","value":794},{"label":"Dez","value":806}];
const MX = 981;
