...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.979","t":"-5.8%","d":"down"},{"l":"NC Abertas","v":"5.543","t":"+11.4%","d":"up"},{"l":"Conformidade (%)","v":"65.2%","t":"+6.1%","d":"up"},{"l":"CAPAs Pendentes","v":"5.939","t":"+15.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","271","78.1%","4.845","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.328","88.2%","7.550","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.291","89.5%","7.117","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.092","91.7%","2.882","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.593","81.8%","8.567","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":497},{"label":"Mar","value":553},{"label":"Abr","value":617},{"label":"Mai","value":528},{"label":"Jun","value":450},{"label":"Jul","value":424},{"label":"Ago","value":411},{"label":"Set","value":508},{"label":"Out","value":640},{"label":"Nov","value":517},{"label":"Dez","value":596}];
const MX = 640;
