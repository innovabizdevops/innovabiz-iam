...
const ACCENT = "#6366f1";
const MODULE = "Vehicle Design";
const PAGE = "CAD";
const KPIS = [{"l":"Formulários Ativos","v":"5.665","t":"+14.7%","d":"up"},{"l":"Submissões/Dia","v":"1858","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"6.499","t":"+6.5%","d":"up"},{"l":"Templates","v":"5.384","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.374","2026-02-23","2.068","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.675","2026-01-11","890","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.329","2026-02-12","6.045","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.786","2026-01-14","5.287","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.880","2026-02-04","6.720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":760},{"label":"Mar","value":627},{"label":"Abr","value":484},{"label":"Mai","value":509},{"label":"Jun","value":780},{"label":"Jul","value":498},{"label":"Ago","value":630},{"label":"Set","value":510},{"label":"Out","value":638},{"label":"Nov","value":682},{"label":"Dez","value":603}];
const MX = 780;
