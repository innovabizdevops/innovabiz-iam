...
export default function VehicleDesignPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vehicle Design</h1><p className="text-sm text-muted-foreground">Vehicle Design • iBOS Enterprise</p></div>
