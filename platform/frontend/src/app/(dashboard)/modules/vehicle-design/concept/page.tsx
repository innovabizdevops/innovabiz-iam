...
const PAGE = "Concept";
const KPIS = [{"l":"Formulários Ativos","v":"2.124","t":"+6.2%","d":"up"},{"l":"Submissões/Dia","v":"3223","t":"-2.8%","d":"down"},{"l":"Documentos Gerados","v":"2.853","t":"+12.7%","d":"up"},{"l":"Templates","v":"5.018","t":"+16.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","786","2026-03-03","3.438","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.159","2026-01-26","8.880","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.875","2026-02-09","7.208","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.690","2026-02-28","7.697","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.170","2026-01-28","2.091","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":820},{"label":"Mar","value":629},{"label":"Abr","value":586},{"label":"Mai","value":596},{"label":"Jun","value":652},{"label":"Jul","value":641},{"label":"Ago","value":684},{"label":"Set","value":590},{"label":"Out","value":628},{"label":"Nov","value":726},{"label":"Dez","value":626}];
const MX = 820;
