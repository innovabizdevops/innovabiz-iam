...
const KPIS = [{"l":"Formulários Ativos","v":"3.417","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"3320","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"2.628","t":"+15.7%","d":"up"},{"l":"Templates","v":"1.189","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.289","2026-01-26","4.912","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.938","2026-02-23","6.568","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.610","2026-01-02","2.674","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.883","2026-02-04","793","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.808","2026-02-01","4.368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":699},{"label":"Mar","value":621},{"label":"Abr","value":719},{"label":"Mai","value":505},{"label":"Jun","value":663},{"label":"Jul","value":702},{"label":"Ago","value":603},{"label":"Set","value":841},{"label":"Out","value":514},{"label":"Nov","value":704},{"label":"Dez","value":665}];
const MX = 841;
