...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"4.164","t":"+0.6%","d":"up"},{"l":"Simulações/Dia","v":"2710","t":"+15.1%","d":"up"},{"l":"Precisão Modelo (%)","v":"90.0%","t":"+5.7%","d":"up"},{"l":"Latência Sync (ms)","v":"157ms","t":"+1.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","78.2%","2026-02-20","6.066","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","79.0%","2026-02-26","8.157","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","77.3%","2026-02-01","3.099","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","83.3%","2026-01-21","706","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","71.7%","2026-03-20","6.963","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":535},{"label":"Mar","value":330},{"label":"Abr","value":368},{"label":"Mai","value":432},{"label":"Jun","value":459},{"label":"Jul","value":609},{"label":"Ago","value":449},{"label":"Set","value":536},{"label":"Out","value":675},{"label":"Nov","value":598},{"label":"Dez","value":410}];
const MX = 675;
