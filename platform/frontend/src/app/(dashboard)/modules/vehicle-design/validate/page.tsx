...
const PAGE = "Validate";
const KPIS = [{"l":"Formulários Ativos","v":"5.819","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"4585","t":"+2.7%","d":"up"},{"l":"Documentos Gerados","v":"745","t":"+9.5%","d":"up"},{"l":"Templates","v":"440","t":"+8.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.609","2026-03-17","424","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.383","2026-01-20","8.706","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.844","2026-03-09","1.892","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.897","2026-03-22","6.511","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.025","2026-03-15","7.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":487},{"label":"Mar","value":498},{"label":"Abr","value":585},{"label":"Mai","value":609},{"label":"Jun","value":665},{"label":"Jul","value":492},{"label":"Ago","value":633},{"label":"Set","value":495},{"label":"Out","value":640},{"label":"Nov","value":605},{"label":"Dez","value":440}];
const MX = 665;
