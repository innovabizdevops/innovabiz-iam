...
const KPIS = [{"l":"Total Video Production","v":"1.499","t":"+6.0%","d":"up"},{"l":"Distribution Ativos","v":"7.003","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"75","t":"-2.7%","d":"down"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Video Production #001","Video Production #002","207","3.418","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Video Production #002","Video Production #003","6.682","7.392","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Video Production #003","Video Production #004","6.667","4.586","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Video Production #004","Video Production #005","5.545","6.969","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Video Production #005","Video Production #001","7.024","2.474","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":781},{"label":"Mar","value":606},{"label":"Abr","value":838},{"label":"Mai","value":590},{"label":"Jun","value":698},{"label":"Jul","value":587},{"label":"Ago","value":710},{"label":"Set","value":865},{"label":"Out","value":702},{"label":"Nov","value":790},{"label":"Dez","value":552}];
const MX = 875;
