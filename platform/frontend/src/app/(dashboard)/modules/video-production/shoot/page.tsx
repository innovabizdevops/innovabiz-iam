...
const PAGE = "Shoot Schedule";
const KPIS = [{"l":"Total Video Production","v":"7.854","t":"-1.2%","d":"down"},{"l":"Shoot Schedule Ativos","v":"8.716","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"67","t":"+1.4%","d":"up"}];
const COLS = ["ID","Shoot Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Video Production #001","Video Production #002","8.120","5.345","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Video Production #002","Video Production #003","5.578","1.659","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Video Production #003","Video Production #004","6.334","1.720","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Video Production #004","Video Production #005","6.938","7.314","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Video Production #005","Video Production #001","3.886","5.226","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":710},{"label":"Mar","value":619},{"label":"Abr","value":457},{"label":"Mai","value":675},{"label":"Jun","value":607},{"label":"Jul","value":791},{"label":"Ago","value":602},{"label":"Set","value":457},{"label":"Out","value":797},{"label":"Nov","value":692},{"label":"Dez","value":496}];
const MX = 797;
