...
const PAGE = "Present";
const KPIS = [{"l":"Formulários Ativos","v":"8.058","t":"+4.6%","d":"up"},{"l":"Submissões/Dia","v":"3640","t":"+14.5%","d":"up"},{"l":"Documentos Gerados","v":"5.044","t":"+14.8%","d":"up"},{"l":"Templates","v":"5.279","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.397","2026-03-05","5.279","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.983","2026-02-08","938","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.720","2026-03-28","7.056","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.462","2026-03-10","6.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.629","2026-03-26","5.561","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":408},{"label":"Mar","value":544},{"label":"Abr","value":592},{"label":"Mai","value":493},{"label":"Jun","value":568},{"label":"Jul","value":306},{"label":"Ago","value":212},{"label":"Set","value":464},{"label":"Out","value":538},{"label":"Nov","value":242},{"label":"Dez","value":465}];
const MX = 592;
