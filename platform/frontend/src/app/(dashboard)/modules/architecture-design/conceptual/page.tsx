...
const PAGE = "Conceptual";
const KPIS = [{"l":"Formulários Ativos","v":"2.825","t":"-2.7%","d":"down"},{"l":"Submissões/Dia","v":"1963","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"3.953","t":"+1.3%","d":"up"},{"l":"Templates","v":"6.013","t":"+4.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.481","2026-03-18","6.150","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.624","2026-03-10","5.275","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.752","2026-02-10","6.023","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.311","2026-01-24","1.783","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.304","2026-01-10","473","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":803},{"label":"Mar","value":862},{"label":"Abr","value":800},{"label":"Mai","value":754},{"label":"Jun","value":794},{"label":"Jul","value":577},{"label":"Ago","value":568},{"label":"Set","value":695},{"label":"Out","value":832},{"label":"Nov","value":627},{"label":"Dez","value":893}];
const MX = 893;
