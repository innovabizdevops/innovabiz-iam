...
const PAGE = "Detail";
const KPIS = [{"l":"Formulários Ativos","v":"4.955","t":"+3.5%","d":"up"},{"l":"Submissões/Dia","v":"3376","t":"+7.6%","d":"up"},{"l":"Documentos Gerados","v":"3.812","t":"+7.6%","d":"up"},{"l":"Templates","v":"3.967","t":"+17.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.126","2026-01-09","6.707","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.370","2026-03-27","2.266","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.923","2026-02-07","4.499","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.134","2026-03-10","1.105","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.339","2026-02-27","3.595","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":908},{"label":"Mar","value":943},{"label":"Abr","value":692},{"label":"Mai","value":623},{"label":"Jun","value":971},{"label":"Jul","value":902},{"label":"Ago","value":726},{"label":"Set","value":744},{"label":"Out","value":786},{"label":"Nov","value":666},{"label":"Dez","value":928}];
const MX = 971;
