...
const ACCENT = "#78350f";
const MODULE = "Architecture Design Platform";
const PAGE = "Render";
const KPIS = [{"l":"Formulários Ativos","v":"1.670","t":"+8.9%","d":"up"},{"l":"Submissões/Dia","v":"2768","t":"+4.8%","d":"up"},{"l":"Documentos Gerados","v":"8.792","t":"+8.3%","d":"up"},{"l":"Templates","v":"6.289","t":"+4.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.316","2026-03-21","2.919","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.912","2026-01-20","1.288","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.478","2026-03-03","4.554","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.580","2026-01-15","8.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.942","2026-03-15","7.976","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":964},{"label":"Mar","value":879},{"label":"Abr","value":658},{"label":"Mai","value":723},{"label":"Jun","value":676},{"label":"Jul","value":899},{"label":"Ago","value":805},{"label":"Set","value":839},{"label":"Out","value":842},{"label":"Nov","value":774},{"label":"Dez","value":890}];
const MX = 964;
