...
const PAGE = "Schematic";
const KPIS = [{"l":"Formulários Ativos","v":"2.991","t":"+9.0%","d":"up"},{"l":"Submissões/Dia","v":"2828","t":"-2.9%","d":"down"},{"l":"Documentos Gerados","v":"4.012","t":"-1.9%","d":"down"},{"l":"Templates","v":"5.337","t":"+5.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.053","2026-01-09","1.185","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.494","2026-01-10","7.964","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.249","2026-01-03","7.218","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.789","2026-01-07","6.597","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.634","2026-01-10","8.729","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":541},{"label":"Mar","value":847},{"label":"Abr","value":613},{"label":"Mai","value":820},{"label":"Jun","value":739},{"label":"Jul","value":879},{"label":"Ago","value":863},{"label":"Set","value":690},{"label":"Out","value":526},{"label":"Nov","value":851},{"label":"Dez","value":624}];
const MX = 879;
