...
/* ═══ Architecture Design Platform — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "5647", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3314", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€325K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2112497247", cells: ["ARC-9247", "Architecture Design Platform Item 1", "8/4/2026", "€47 347"], status: "active" as const },
    { id: "2112500818", cells: ["ARC-3818", "Architecture Design Platform Item 2", "23/11/2026", "€918"], status: "pending" as const },
    { id: "2112504389", cells: ["ARC-7389", "Architecture Design Platform Item 3", "10/6/2026", "€4489"], status: "completed" as const },
    { id: "2112507960", cells: ["ARC-1960", "Architecture Design Platform Item 4", "25/1/2026", "€8060"], status: "warning" as const },
    { id: "2112511531", cells: ["ARC-5531", "Architecture Design Platform Item 5", "12/8/2026", "€11 631"], status: "active" as const },
];
...
export default function ArchitectureDesignPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Architecture Design Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Architecture Design Platform</p>
                    </div>
                </div>
