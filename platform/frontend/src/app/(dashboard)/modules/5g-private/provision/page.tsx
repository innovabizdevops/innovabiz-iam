...
const KPIS = [{"l":"Total 5g Private","v":"4.341","t":"-0.1%","d":"down"},{"l":"Provision Ativos","v":"5.912","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"86","t":"-1.1%","d":"down"}];
const COLS = ["ID","Provision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["5g Private #001","5g Private #002","1.656","2.988","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["5g Private #002","5g Private #003","7.920","5.385","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["5g Private #003","5g Private #004","4.547","4.287","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["5g Private #004","5g Private #005","2.432","3.081","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["5g Private #005","5g Private #001","462","2.701","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":949},{"label":"Mar","value":877},{"label":"Abr","value":1068},{"label":"Mai","value":1053},{"label":"Jun","value":857},{"label":"Jul","value":697},{"label":"Ago","value":918},{"label":"Set","value":1001},{"label":"Out","value":755},{"label":"Nov","value":906},{"label":"Dez","value":827}];
const MX = 1068;
