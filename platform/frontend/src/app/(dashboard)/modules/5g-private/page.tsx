...
/* ═══ 5G & Private Network — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "573", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4850", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€129K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1166557073", cells: ["5G-5073", "5G & Private Network Item 1", "18/6/2026", "€7173"], status: "active" as const },
    { id: "1166560644", cells: ["5G-8644", "5G & Private Network Item 2", "5/1/2026", "€10 744"], status: "pending" as const },
    { id: "1166564215", cells: ["5G-3215", "5G & Private Network Item 3", "20/8/2026", "€14 315"], status: "completed" as const },
    { id: "1166567786", cells: ["5G-6786", "5G & Private Network Item 4", "7/3/2026", "€17 886"], status: "warning" as const },
    { id: "1166571357", cells: ["5G-1357", "5G & Private Network Item 5", "22/10/2026", "€21 457"], status: "active" as const },
];
...
export default function P5gPrivateNetworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">5G & Private Network</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 5G & Private Network</p>
                    </div>
                </div>
