...
const PAGE = "Edge";
const KPIS = [{"l":"Total 5g Private","v":"238","t":"+5.7%","d":"up"},{"l":"Edge Ativos","v":"1.122","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"86","t":"-3.3%","d":"down"}];
const COLS = ["ID","Edge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["5g Private #001","5g Private #002","8.659","2.577","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["5g Private #002","5g Private #003","5.478","4.982","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["5g Private #003","5g Private #004","6.213","8.819","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["5g Private #004","5g Private #005","8.625","4.941","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["5g Private #005","5g Private #001","7.808","7.674","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":514},{"label":"Mar","value":578},{"label":"Abr","value":703},{"label":"Mai","value":624},{"label":"Jun","value":658},{"label":"Jul","value":639},{"label":"Ago","value":529},{"label":"Set","value":534},{"label":"Out","value":590},{"label":"Nov","value":664},{"label":"Dez","value":539}];
const MX = 703;
