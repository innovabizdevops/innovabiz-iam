...
const ACCENT = "#4f46e5";
const MODULE = "AIX Trust & Responsible AI";
const PAGE = "Accountability";
const KPIS = [{"l":"Total Aix Trust","v":"3.120","t":"+9.7%","d":"up"},{"l":"Accountability Ativos","v":"6.055","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"63","t":"+7.0%","d":"up"}];
const COLS = ["ID","Accountability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aix Trust #001","Aix Trust #002","1.987","3.631","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Aix Trust #002","Aix Trust #003","1.701","5.423","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aix Trust #003","Aix Trust #004","692","5.135","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Aix Trust #004","Aix Trust #005","4.870","5.909","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aix Trust #005","Aix Trust #001","6.273","815","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":827},{"label":"Mar","value":676},{"label":"Abr","value":629},{"label":"Mai","value":841},{"label":"Jun","value":974},{"label":"Jul","value":653},{"label":"Ago","value":824},{"label":"Set","value":810},{"label":"Out","value":664},{"label":"Nov","value":630},{"label":"Dez","value":663}];
const MX = 974;
