...
const PAGE = "Fairness";
const KPIS = [{"l":"Total Aix Trust","v":"5.983","t":"-0.8%","d":"down"},{"l":"Fairness Ativos","v":"8.495","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"81.9%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"93","t":"+3.7%","d":"up"}];
const COLS = ["ID","Fairness","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aix Trust #001","Aix Trust #002","1.050","4.688","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Aix Trust #002","Aix Trust #003","4.497","8.360","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Aix Trust #003","Aix Trust #004","3.381","2.626","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Aix Trust #004","Aix Trust #005","7.617","4.325","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aix Trust #005","Aix Trust #001","2.378","1.163","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":686},{"label":"Mar","value":514},{"label":"Abr","value":660},{"label":"Mai","value":556},{"label":"Jun","value":322},{"label":"Jul","value":661},{"label":"Ago","value":407},{"label":"Set","value":449},{"label":"Out","value":414},{"label":"Nov","value":515},{"label":"Dez","value":655}];
const MX = 686;
