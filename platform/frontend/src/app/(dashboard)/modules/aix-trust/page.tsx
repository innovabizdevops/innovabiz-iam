...
/* ═══ AIX Trust & Responsible AI — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "5638", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3482", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€381K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1745811138", cells: ["AIX-1138", "AIX Trust & Responsible AI Item 1", "23/7/2026", "€11 238"], status: "active" as const },
    { id: "1745814709", cells: ["AIX-4709", "AIX Trust & Responsible AI Item 2", "10/2/2026", "€14 809"], status: "pending" as const },
    { id: "1745818280", cells: ["AIX-8280", "AIX Trust & Responsible AI Item 3", "25/9/2026", "€18 380"], status: "completed" as const },
    { id: "1745821851", cells: ["AIX-2851", "AIX Trust & Responsible AI Item 4", "12/4/2026", "€21 951"], status: "warning" as const },
    { id: "1745825422", cells: ["AIX-6422", "AIX Trust & Responsible AI Item 5", "27/11/2026", "€25 522"], status: "active" as const },
];
...
export default function AixTrustResponsibleAiPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AIX Trust & Responsible AI</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AIX Trust & Responsible AI</p>
                    </div>
                </div>
