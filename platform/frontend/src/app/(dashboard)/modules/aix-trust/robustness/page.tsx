...
const PAGE = "Robustness";
const KPIS = [{"l":"Total Aix Trust","v":"1.175","t":"-5.2%","d":"down"},{"l":"Robustness Ativos","v":"5.701","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"70","t":"+6.0%","d":"up"}];
const COLS = ["ID","Robustness","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aix Trust #001","Aix Trust #002","7.540","2.817","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Aix Trust #002","Aix Trust #003","1.805","5.638","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aix Trust #003","Aix Trust #004","8.521","6.758","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Aix Trust #004","Aix Trust #005","2.502","6.950","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aix Trust #005","Aix Trust #001","8.626","3.344","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":846},{"label":"Mar","value":806},{"label":"Abr","value":610},{"label":"Mai","value":882},{"label":"Jun","value":683},{"label":"Jul","value":846},{"label":"Ago","value":955},{"label":"Set","value":633},{"label":"Out","value":636},{"label":"Nov","value":940},{"label":"Dez","value":776}];
const MX = 955;
