...
const KPIS = [{"l":"Quartos Ocupados","v":"1.586","t":"+14.3%","d":"up"},{"l":"RevPAR (€)","v":"€59089","t":"+9.2%","d":"up"},{"l":"Ocupação (%)","v":"81.9%","t":"-5.4%","d":"down"},{"l":"Guest Satisfaction","v":"1.002","t":"+17.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.327","2026-03-24","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","167","2026-02-07","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","236","2026-02-17","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.242","2026-02-22","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.922","2026-01-17","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":669},{"label":"Mar","value":547},{"label":"Abr","value":375},{"label":"Mai","value":650},{"label":"Jun","value":451},{"label":"Jul","value":728},{"label":"Ago","value":544},{"label":"Set","value":749},{"label":"Out","value":729},{"label":"Nov","value":583},{"label":"Dez","value":726}];
const MX = 749;
