...
const ACCENT = "#d97706";
const MODULE = "Public Housing";
const PAGE = "Wait List";
const KPIS = [{"l":"Total Public Housing","v":"2.631","t":"-2.9%","d":"down"},{"l":"Wait List Ativos","v":"6.578","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"68","t":"-0.2%","d":"down"}];
const COLS = ["ID","Wait List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Housing #001","Public Housing #002","6.403","8.502","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Public Housing #002","Public Housing #003","5.327","2.634","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Housing #003","Public Housing #004","1.173","4.750","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Public Housing #004","Public Housing #005","3.916","7.675","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Housing #005","Public Housing #001","1.635","8.774","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":628},{"label":"Mar","value":659},{"label":"Abr","value":825},{"label":"Mai","value":895},{"label":"Jun","value":803},{"label":"Jul","value":846},{"label":"Ago","value":1013},{"label":"Set","value":943},{"label":"Out","value":1000},{"label":"Nov","value":695},{"label":"Dez","value":943}];
const MX = 1013;
