...
const KPIS = [{"l":"Total Public Housing","v":"2.460","t":"+7.0%","d":"up"},{"l":"Maintenance Ativos","v":"4.942","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"75","t":"+6.4%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Housing #001","Public Housing #002","1.068","4.237","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Public Housing #002","Public Housing #003","740","564","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Housing #003","Public Housing #004","5.037","978","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Public Housing #004","Public Housing #005","5.133","7.245","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Housing #005","Public Housing #001","8.018","7.962","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":674},{"label":"Mar","value":712},{"label":"Abr","value":534},{"label":"Mai","value":682},{"label":"Jun","value":645},{"label":"Jul","value":398},{"label":"Ago","value":567},{"label":"Set","value":630},{"label":"Out","value":655},{"label":"Nov","value":502},{"label":"Dez","value":484}];
const MX = 712;
