...
const PAGE = "Tenant";
const KPIS = [{"l":"Configurações","v":"5.025","t":"-4.3%","d":"down"},{"l":"Últimas Alterações","v":"4.454","t":"-1.4%","d":"down"},{"l":"Ambientes","v":"4.867","t":"-1.5%","d":"down"},{"l":"Versão Config","v":"3.249","t":"+5.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 23900.80","8.259","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 32827.50","4.377","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 20989.35","4.315","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 24929.71","8.637","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 11100.98","4.785","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":633},{"label":"Mar","value":651},{"label":"Abr","value":696},{"label":"Mai","value":373},{"label":"Jun","value":471},{"label":"Jul","value":670},{"label":"Ago","value":504},{"label":"Set","value":358},{"label":"Out","value":452},{"label":"Nov","value":395},{"label":"Dez","value":434}];
const MX = 696;
