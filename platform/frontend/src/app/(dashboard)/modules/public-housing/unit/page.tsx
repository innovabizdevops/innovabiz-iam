...
const PAGE = "Unit";
const KPIS = [{"l":"Total Public Housing","v":"424","t":"+0.6%","d":"up"},{"l":"Unit Ativos","v":"3.771","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"68","t":"-5.9%","d":"down"}];
const COLS = ["ID","Unit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Housing #001","Public Housing #002","2.557","3.844","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Public Housing #002","Public Housing #003","3.340","3.032","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Housing #003","Public Housing #004","4.310","1.719","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Public Housing #004","Public Housing #005","1.763","5.732","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Housing #005","Public Housing #001","4.197","7.082","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":338},{"label":"Mar","value":694},{"label":"Abr","value":335},{"label":"Mai","value":512},{"label":"Jun","value":502},{"label":"Jul","value":383},{"label":"Ago","value":331},{"label":"Set","value":354},{"label":"Out","value":490},{"label":"Nov","value":558},{"label":"Dez","value":500}];
const MX = 694;
