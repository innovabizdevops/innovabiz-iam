...
const KPIS = [
    { label: "Total Registos", value: "7332", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "656", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€499K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1612915232", cells: ["PUB-8232", "Public Housing Item 1", "13/9/2026", "€15 332"], status: "active" as const },
    { id: "1612918803", cells: ["PUB-2803", "Public Housing Item 2", "28/4/2026", "€18 903"], status: "pending" as const },
    { id: "1612922374", cells: ["PUB-6374", "Public Housing Item 3", "15/11/2026", "€22 474"], status: "completed" as const },
    { id: "1612925945", cells: ["PUB-9945", "Public Housing Item 4", "2/6/2026", "€26 045"], status: "warning" as const },
    { id: "1612929516", cells: ["PUB-4516", "Public Housing Item 5", "17/1/2026", "€29 616"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Public Housing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Public Housing</p>
                    </div>
                </div>
