...
const PAGE = "Category";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.636","t":"+2.1%","d":"up"},{"l":"Contratos (€M)","v":"€26.3M","t":"+3.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"83.4%","t":"+16.1%","d":"up"},{"l":"Score Médio","v":"85","t":"+3.8%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","82.3%","€ 36682.85","7.038","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","99.1%","€ 8588.21","7.884","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","98.2%","€ 47114.43","9.089","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","88.9%","€ 18226.17","3.301","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","77.2%","€ 41517.85","8.370","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":582},{"label":"Mar","value":620},{"label":"Abr","value":905},{"label":"Mai","value":718},{"label":"Jun","value":593},{"label":"Jul","value":634},{"label":"Ago","value":660},{"label":"Set","value":760},{"label":"Out","value":733},{"label":"Nov","value":750},{"label":"Dez","value":521}];
const MX = 905;
