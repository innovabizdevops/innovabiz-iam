...
const ACCENT = "#78350f";
const MODULE = "Strategic Sourcing Deep";
const PAGE = "Optimize";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.500","t":"-5.0%","d":"down"},{"l":"Contratos (€M)","v":"€41.9M","t":"-3.7%","d":"down"},{"l":"On-Time Delivery (%)","v":"78.7%","t":"-0.7%","d":"down"},{"l":"Score Médio","v":"78","t":"+3.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","72.3%","€ 1883.56","1.087","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","84.5%","€ 31109.02","4.788","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","82.5%","€ 18031.07","2.779","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","94.7%","€ 16017.04","2.000","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","79.9%","€ 19183.02","1.390","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":514},{"label":"Mar","value":717},{"label":"Abr","value":589},{"label":"Mai","value":579},{"label":"Jun","value":786},{"label":"Jul","value":731},{"label":"Ago","value":696},{"label":"Set","value":470},{"label":"Out","value":806},{"label":"Nov","value":671},{"label":"Dez","value":681}];
const MX = 806;
