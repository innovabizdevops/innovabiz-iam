...
/* ═══ Strategic Sourcing Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3780", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4233", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€438K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2053194380", cells: ["STR-7380", "Strategic Sourcing Deep Item 1", "21/9/2026", "€44 480"], status: "active" as const },
    { id: "2053197951", cells: ["STR-1951", "Strategic Sourcing Deep Item 2", "8/4/2026", "€48 051"], status: "pending" as const },
    { id: "2053201522", cells: ["STR-5522", "Strategic Sourcing Deep Item 3", "23/11/2026", "€1622"], status: "completed" as const },
    { id: "2053205093", cells: ["STR-9093", "Strategic Sourcing Deep Item 4", "10/6/2026", "€5193"], status: "warning" as const },
    { id: "2053208664", cells: ["STR-3664", "Strategic Sourcing Deep Item 5", "25/1/2026", "€8764"], status: "active" as const },
];
...
export default function StrategicSourcingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Strategic Sourcing Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Strategic Sourcing Deep</p>
                    </div>
                </div>
