...
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"7.165","t":"+16.2%","d":"up"},{"l":"Valor Total (€M)","v":"€23.5M","t":"+9.6%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.476","t":"-1.5%","d":"down"},{"l":"Obrigações Pendentes","v":"4.438","t":"-4.6%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 44712.00","2026-02-22","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 15892.65","2026-01-19","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 45288.17","2026-01-28","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 9567.61","2026-02-24","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 14079.66","2026-02-15","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":851},{"label":"Mar","value":634},{"label":"Abr","value":883},{"label":"Mai","value":566},{"label":"Jun","value":666},{"label":"Jul","value":650},{"label":"Ago","value":840},{"label":"Set","value":713},{"label":"Out","value":530},{"label":"Nov","value":636},{"label":"Dez","value":623}];
const MX = 883;
