...
const KPIS = [{"l":"Fornecedores Ativos","v":"5.839","t":"+11.1%","d":"up"},{"l":"Contratos (€M)","v":"€13.3M","t":"-6.0%","d":"down"},{"l":"On-Time Delivery (%)","v":"74.1%","t":"-0.9%","d":"down"},{"l":"Score Médio","v":"85","t":"+17.8%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","70.7%","€ 45135.48","1.337","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","80.7%","€ 5268.15","6.034","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","70.4%","€ 38390.68","8.476","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","99.5%","€ 6307.28","4.988","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","83.8%","€ 38671.50","6.520","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":829},{"label":"Mar","value":477},{"label":"Abr","value":573},{"label":"Mai","value":677},{"label":"Jun","value":597},{"label":"Jul","value":794},{"label":"Ago","value":778},{"label":"Set","value":760},{"label":"Out","value":549},{"label":"Nov","value":690},{"label":"Dez","value":621}];
const MX = 829;
