...
const PAGE = "Supplier";
const KPIS = [{"l":"Fornecedores Ativos","v":"8.121","t":"+15.8%","d":"up"},{"l":"Contratos (€M)","v":"€30.4M","t":"+9.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"77.4%","t":"+14.6%","d":"up"},{"l":"Score Médio","v":"76","t":"+11.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","82.0%","€ 36011.64","3.853","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","76.0%","€ 44133.93","7.021","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.4%","€ 48817.34","1.900","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","90.4%","€ 45968.44","2.918","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","90.9%","€ 20515.72","6.361","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":315},{"label":"Mar","value":360},{"label":"Abr","value":460},{"label":"Mai","value":451},{"label":"Jun","value":506},{"label":"Jul","value":575},{"label":"Ago","value":540},{"label":"Set","value":385},{"label":"Out","value":409},{"label":"Nov","value":639},{"label":"Dez","value":483}];
const MX = 639;
