...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"6.989","t":"-1.3%","d":"down"},{"l":"Taxa Entrega (%)","v":"87.1%","t":"-4.9%","d":"down"},{"l":"Taxa Abertura (%)","v":"91.4%","t":"+9.8%","d":"up"},{"l":"Escalações","v":"7.538","t":"+12.7%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.125","98.5%","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.062","81.0%","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.937","94.5%","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.022","71.3%","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.315","83.7%","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":581},{"label":"Mar","value":523},{"label":"Abr","value":514},{"label":"Mai","value":670},{"label":"Jun","value":409},{"label":"Jul","value":545},{"label":"Ago","value":352},{"label":"Set","value":558},{"label":"Out","value":313},{"label":"Nov","value":307},{"label":"Dez","value":619}];
const MX = 670;
