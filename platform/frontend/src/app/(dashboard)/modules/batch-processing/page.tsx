...
/* ═══ Batch Processing Engine — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "1455", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4337", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€417K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "353134355", cells: ["BAT-2355", "Batch Processing Engine Item 1", "8/12/2026", "€34 455"], status: "active" as const },
    { id: "353137926", cells: ["BAT-5926", "Batch Processing Engine Item 2", "23/7/2026", "€38 026"], status: "pending" as const },
    { id: "353141497", cells: ["BAT-9497", "Batch Processing Engine Item 3", "10/2/2026", "€41 597"], status: "completed" as const },
    { id: "353145068", cells: ["BAT-4068", "Batch Processing Engine Item 4", "25/9/2026", "€45 168"], status: "warning" as const },
    { id: "353148639", cells: ["BAT-7639", "Batch Processing Engine Item 5", "12/4/2026", "€48 739"], status: "active" as const },
];
...
export default function BatchProcessingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Batch Processing Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Batch Processing Engine</p>
                    </div>
                </div>
