...
const PAGE = "Car Mgmt";
const KPIS = [{"l":"Veículos Operação","v":"8.967","t":"-0.9%","d":"down"},{"l":"Viagens/Dia","v":"2094","t":"-1.8%","d":"down"},{"l":"Pontualidade (%)","v":"70.6%","t":"+13.0%","d":"up"},{"l":"Passageiros/Dia","v":"3316","t":"+4.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-02","2026-01-23","5.357","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-22","2026-01-23","4.614","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-22","2026-03-28","2.132","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-22","2026-02-20","7.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-13","2026-03-13","2.113","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":596},{"label":"Mar","value":768},{"label":"Abr","value":717},{"label":"Mai","value":616},{"label":"Jun","value":708},{"label":"Jul","value":727},{"label":"Ago","value":726},{"label":"Set","value":688},{"label":"Out","value":842},{"label":"Nov","value":966},{"label":"Dez","value":839}];
const MX = 967;
