...
const ACCENT = "#075985";
const MODULE = "Freight Railway";
const PAGE = "Shipment";
const KPIS = [{"l":"Veículos Operação","v":"3.862","t":"+10.8%","d":"up"},{"l":"Viagens/Dia","v":"1578","t":"+16.6%","d":"up"},{"l":"Pontualidade (%)","v":"75.9%","t":"+11.7%","d":"up"},{"l":"Passageiros/Dia","v":"1623","t":"+8.2%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-01","2026-03-05","5.117","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-25","2026-03-09","8.109","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-26","2026-03-22","4.187","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-02","2026-03-15","2.788","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-02","2026-03-02","6.839","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":294},{"label":"Mar","value":466},{"label":"Abr","value":492},{"label":"Mai","value":394},{"label":"Jun","value":358},{"label":"Jul","value":282},{"label":"Ago","value":459},{"label":"Set","value":504},{"label":"Out","value":458},{"label":"Nov","value":592},{"label":"Dez","value":299}];
const MX = 592;
