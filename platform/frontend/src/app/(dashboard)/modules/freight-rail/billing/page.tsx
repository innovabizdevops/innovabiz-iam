...
const PAGE = "Billing";
const KPIS = [{"l":"Veículos Operação","v":"4.135","t":"+11.1%","d":"up"},{"l":"Viagens/Dia","v":"3749","t":"+18.0%","d":"up"},{"l":"Pontualidade (%)","v":"67.4%","t":"+17.2%","d":"up"},{"l":"Passageiros/Dia","v":"4490","t":"+5.3%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-14","2026-01-19","123","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-28","2026-02-13","1.042","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-10","2026-02-28","4.048","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-17","2026-03-04","3.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-09","2026-03-02","1.726","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":628},{"label":"Mar","value":665},{"label":"Abr","value":770},{"label":"Mai","value":958},{"label":"Jun","value":875},{"label":"Jul","value":698},{"label":"Ago","value":926},{"label":"Set","value":673},{"label":"Out","value":838},{"label":"Nov","value":613},{"label":"Dez","value":789}];
const MX = 958;
