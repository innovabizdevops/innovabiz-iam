...
export default function FreightRailPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Freight Rail</h1><p className="text-sm text-muted-foreground">Freight Rail • iBOS Enterprise</p></div>
            </div>
