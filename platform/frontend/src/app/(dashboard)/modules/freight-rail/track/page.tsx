...
const PAGE = "Track";
const KPIS = [{"l":"Veículos Operação","v":"6.337","t":"+14.9%","d":"up"},{"l":"Viagens/Dia","v":"1709","t":"-1.6%","d":"down"},{"l":"Pontualidade (%)","v":"65.4%","t":"-5.0%","d":"down"},{"l":"Passageiros/Dia","v":"4909","t":"+14.1%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-27","2026-03-28","3.846","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-17","2026-02-10","1.566","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-27","2026-02-01","8.683","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-11","2026-01-20","3.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-16","2026-03-21","6.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":856},{"label":"Mar","value":649},{"label":"Abr","value":677},{"label":"Mai","value":815},{"label":"Jun","value":648},{"label":"Jul","value":559},{"label":"Ago","value":720},{"label":"Set","value":850},{"label":"Out","value":828},{"label":"Nov","value":721},{"label":"Dez","value":552}];
const MX = 856;
