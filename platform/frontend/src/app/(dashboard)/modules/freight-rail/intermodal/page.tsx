...
const KPIS = [{"l":"Riscos Identificados","v":"6.151","t":"+5.9%","d":"up"},{"l":"Mitigações Ativas","v":"8.689","t":"+14.2%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"+9.3%","d":"up"},{"l":"Incidentes YTD","v":"459","t":"+4.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","706","1.967","5.431","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.686","1.449","1.513","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","357","3.246","1.358","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.299","1.307","4.211","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.075","4.318","9.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":727},{"label":"Mar","value":836},{"label":"Abr","value":806},{"label":"Mai","value":991},{"label":"Jun","value":912},{"label":"Jul","value":1002},{"label":"Ago","value":784},{"label":"Set","value":924},{"label":"Out","value":871},{"label":"Nov","value":777},{"label":"Dez","value":932}];
const MX = 1002;
