...
const PAGE = "ELINT";
const KPIS = [{"l":"Total Ew Systems","v":"7.710","t":"+6.5%","d":"up"},{"l":"ELINT Ativos","v":"2.250","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"88.1%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"81","t":"-3.7%","d":"down"}];
const COLS = ["ID","ELINT","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ew Systems #001","Ew Systems #002","3.741","184","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ew Systems #002","Ew Systems #003","4.769","7.751","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Ew Systems #003","Ew Systems #004","144","5.429","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ew Systems #004","Ew Systems #005","3.429","8.712","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ew Systems #005","Ew Systems #001","233","3.914","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":701},{"label":"Mar","value":876},{"label":"Abr","value":807},{"label":"Mai","value":666},{"label":"Jun","value":512},{"label":"Jul","value":753},{"label":"Ago","value":788},{"label":"Set","value":800},{"label":"Out","value":873},{"label":"Nov","value":762},{"label":"Dez","value":778}];
const MX = 876;
...
export default function ElintPage() {
    return (
