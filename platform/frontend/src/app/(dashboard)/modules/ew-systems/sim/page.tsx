...
const ACCENT = "#6366f1";
const MODULE = "EW Systems";
const PAGE = "Simulation";
const KPIS = [{"l":"Twins Ativos","v":"7.403","t":"+14.3%","d":"up"},{"l":"Simulações/Dia","v":"2062","t":"+8.9%","d":"up"},{"l":"Precisão Modelo (%)","v":"91.6%","t":"+14.7%","d":"up"},{"l":"Latência Sync (ms)","v":"199ms","t":"+3.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","96.9%","2026-03-12","672","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","75.6%","2026-01-18","4.164","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","87.8%","2026-03-14","8.603","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","99.3%","2026-01-13","8.501","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","75.6%","2026-01-23","4.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":557},{"label":"Mar","value":770},{"label":"Abr","value":588},{"label":"Mai","value":490},{"label":"Jun","value":580},{"label":"Jul","value":449},{"label":"Ago","value":509},{"label":"Set","value":762},{"label":"Out","value":500},{"label":"Nov","value":543},{"label":"Dez","value":538}];
const MX = 770;
