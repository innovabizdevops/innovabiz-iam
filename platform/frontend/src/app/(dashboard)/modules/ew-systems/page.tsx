...
export default function EwSystemsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ew Systems</h1><p className="text-sm text-muted-foreground">Ew Systems • iBOS Enterprise</p></div>
