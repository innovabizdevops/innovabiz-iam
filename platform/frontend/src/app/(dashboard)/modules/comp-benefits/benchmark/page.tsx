...
const KPIS = [{"l":"Total Comp Benefits","v":"5.683","t":"+15.6%","d":"up"},{"l":"Benchmark Ativos","v":"4.143","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"82.6%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"87","t":"-0.6%","d":"down"}];
const COLS = ["ID","Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comp Benefits #001","Comp Benefits #002","4.810","135","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Comp Benefits #002","Comp Benefits #003","7.031","4.398","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Comp Benefits #003","Comp Benefits #004","3.158","4.574","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Comp Benefits #004","Comp Benefits #005","3.710","1.369","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comp Benefits #005","Comp Benefits #001","4.201","7.164","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":857},{"label":"Mar","value":767},{"label":"Abr","value":687},{"label":"Mai","value":663},{"label":"Jun","value":696},{"label":"Jul","value":967},{"label":"Ago","value":862},{"label":"Set","value":1029},{"label":"Out","value":1011},{"label":"Nov","value":774},{"label":"Dez","value":733}];
const MX = 1029;
