...
const ACCENT = "#6366f1";
const MODULE = "Compensation & Benefits";
const PAGE = "Total Rewards";
const KPIS = [{"l":"Total Comp Benefits","v":"4.896","t":"+16.2%","d":"up"},{"l":"Total Rewards Ativos","v":"1.947","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"63","t":"+0.6%","d":"up"}];
const COLS = ["ID","Total Rewards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comp Benefits #001","Comp Benefits #002","2.417","727","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Comp Benefits #002","Comp Benefits #003","2.714","4.129","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Comp Benefits #003","Comp Benefits #004","5.417","1.477","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Comp Benefits #004","Comp Benefits #005","8.386","7.903","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comp Benefits #005","Comp Benefits #001","6.965","245","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":657},{"label":"Mar","value":695},{"label":"Abr","value":474},{"label":"Mai","value":415},{"label":"Jun","value":543},{"label":"Jul","value":671},{"label":"Ago","value":599},{"label":"Set","value":530},{"label":"Out","value":688},{"label":"Nov","value":548},{"label":"Dez","value":759}];
const MX = 759;
