...
export default function CompBenefitsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Comp Benefits</h1><p className="text-sm text-muted-foreground">Comp Benefits • iBOS Enterprise</p></div>
