...
/* ═══ Insurance Rating Engine — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "9659", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4513", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "825273559", cells: ["INS-1559", "Insurance Rating Engine Item 1", "20/8/2026", "€23 659"], status: "active" as const },
    { id: "825277130", cells: ["INS-5130", "Insurance Rating Engine Item 2", "7/3/2026", "€27 230"], status: "pending" as const },
    { id: "825280701", cells: ["INS-8701", "Insurance Rating Engine Item 3", "22/10/2026", "€30 801"], status: "completed" as const },
    { id: "825284272", cells: ["INS-3272", "Insurance Rating Engine Item 4", "9/5/2026", "€34 372"], status: "warning" as const },
    { id: "825287843", cells: ["INS-6843", "Insurance Rating Engine Item 5", "24/12/2026", "€37 943"], status: "active" as const },
];
...
export default function InsuranceRatingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insurance Rating Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Insurance Rating Engine</p>
                    </div>
                </div>
