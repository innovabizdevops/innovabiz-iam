...
const PAGE = "Test";
const KPIS = [{"l":"Surveys Ativos","v":"1.240","t":"+14.7%","d":"up"},{"l":"Respostas/Semana","v":"4074","t":"-3.8%","d":"down"},{"l":"NPS Médio","v":"93","t":"+3.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"88.7%","t":"+8.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","4.301","72","75.5%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.609","83","76.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","2.849","77","78.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","815","72","70.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","782","87","95.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":915},{"label":"Mar","value":945},{"label":"Abr","value":929},{"label":"Mai","value":770},{"label":"Jun","value":824},{"label":"Jul","value":634},{"label":"Ago","value":736},{"label":"Set","value":690},{"label":"Out","value":609},{"label":"Nov","value":608},{"label":"Dez","value":696}];
const MX = 945;
