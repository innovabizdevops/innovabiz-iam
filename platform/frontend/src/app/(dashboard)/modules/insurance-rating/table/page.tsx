...
const PAGE = "Table";
const KPIS = [{"l":"Surveys Ativos","v":"2.840","t":"+10.5%","d":"up"},{"l":"Respostas/Semana","v":"4004","t":"-5.2%","d":"down"},{"l":"NPS Médio","v":"78","t":"-4.5%","d":"down"},{"l":"Taxa Resposta (%)","v":"78.2%","t":"-1.9%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.458","73","85.1%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.953","63","80.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","463","70","73.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.780","69","87.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","9.068","83","90.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":559},{"label":"Mar","value":668},{"label":"Abr","value":346},{"label":"Mai","value":488},{"label":"Jun","value":307},{"label":"Jul","value":556},{"label":"Ago","value":523},{"label":"Set","value":525},{"label":"Out","value":362},{"label":"Nov","value":516},{"label":"Dez","value":310}];
const MX = 668;
