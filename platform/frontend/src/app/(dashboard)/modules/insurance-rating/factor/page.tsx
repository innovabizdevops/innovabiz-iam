...
const PAGE = "Factor";
const KPIS = [{"l":"Surveys Ativos","v":"7.390","t":"+8.7%","d":"up"},{"l":"Respostas/Semana","v":"840","t":"-1.1%","d":"down"},{"l":"NPS Médio","v":"66","t":"+13.1%","d":"up"},{"l":"Taxa Resposta (%)","v":"75.4%","t":"+7.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.555","68","95.6%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","7.507","80","92.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","5.593","88","71.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","2.264","84","91.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","275","73","80.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":968},{"label":"Mar","value":980},{"label":"Abr","value":759},{"label":"Mai","value":915},{"label":"Jun","value":1051},{"label":"Jul","value":718},{"label":"Ago","value":756},{"label":"Set","value":1084},{"label":"Out","value":729},{"label":"Nov","value":760},{"label":"Dez","value":707}];
const MX = 1084;
