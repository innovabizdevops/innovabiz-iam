...
const ACCENT = "#92400e";
const MODULE = "Insurance Rating Engine";
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"2.496","t":"+4.5%","d":"up"},{"l":"Submissões/Dia","v":"3680","t":"+8.1%","d":"up"},{"l":"Documentos Gerados","v":"5.806","t":"-2.4%","d":"down"},{"l":"Templates","v":"3.803","t":"+14.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.818","2026-02-28","4.483","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.715","2026-01-28","8.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.018","2026-01-01","3.066","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.466","2026-01-11","9.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.150","2026-02-10","5.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":544},{"label":"Mar","value":589},{"label":"Abr","value":434},{"label":"Mai","value":508},{"label":"Jun","value":552},{"label":"Jul","value":567},{"label":"Ago","value":537},{"label":"Set","value":323},{"label":"Out","value":620},{"label":"Nov","value":601},{"label":"Dez","value":367}];
const MX = 634;
