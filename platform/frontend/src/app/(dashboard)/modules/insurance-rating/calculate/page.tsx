...
const KPIS = [{"l":"Surveys Ativos","v":"4.521","t":"+11.5%","d":"up"},{"l":"Respostas/Semana","v":"678","t":"+16.8%","d":"up"},{"l":"NPS Médio","v":"58","t":"+17.4%","d":"up"},{"l":"Taxa Resposta (%)","v":"67.0%","t":"+17.9%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.195","91","90.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","4.634","94","93.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","5.800","70","92.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.968","58","83.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","556","87","91.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":999},{"label":"Fev","value":997},{"label":"Mar","value":890},{"label":"Abr","value":666},{"label":"Mai","value":813},{"label":"Jun","value":834},{"label":"Jul","value":612},{"label":"Ago","value":686},{"label":"Set","value":938},{"label":"Out","value":963},{"label":"Nov","value":729},{"label":"Dez","value":769}];
const MX = 999;
