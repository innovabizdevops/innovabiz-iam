...
const ACCENT = "#1d4ed8";
const MODULE = "Staffing Agency";
const PAGE = "Matching AI";
const KPIS = [{"l":"Atletas Registados","v":"8.780","t":"+8.8%","d":"up"},{"l":"Treinos/Semana","v":"1918","t":"-1.8%","d":"down"},{"l":"Competições","v":"3.352","t":"+11.0%","d":"up"},{"l":"Performance Score","v":"73","t":"+0.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.774","2.584","7.100","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.119","3.791","866","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.171","8.298","3.615","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.407","7.296","6.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.831","6.475","2.513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":720},{"label":"Mar","value":461},{"label":"Abr","value":729},{"label":"Mai","value":401},{"label":"Jun","value":430},{"label":"Jul","value":536},{"label":"Ago","value":517},{"label":"Set","value":555},{"label":"Out","value":486},{"label":"Nov","value":521},{"label":"Dez","value":711}];
const MX = 729;
