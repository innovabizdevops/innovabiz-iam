...
const KPIS = [{"l":"Teams Ativos","v":"6.396","t":"+17.2%","d":"up"},{"l":"Reuniões/Semana","v":"154","t":"+17.9%","d":"up"},{"l":"Mensagens/Dia","v":"1250","t":"+17.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.840","t":"-4.6%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.864","2665","3.652","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.167","1668","2.027","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.150","5025","2.830","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.006","3916","4.820","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.471","3225","1.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":342},{"label":"Mar","value":453},{"label":"Abr","value":298},{"label":"Mai","value":590},{"label":"Jun","value":430},{"label":"Jul","value":534},{"label":"Ago","value":408},{"label":"Set","value":620},{"label":"Out","value":369},{"label":"Nov","value":527},{"label":"Dez","value":648}];
const MX = 648;
