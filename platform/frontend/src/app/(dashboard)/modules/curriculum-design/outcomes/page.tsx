...
const PAGE = "Outcomes";
const KPIS = [{"l":"Formulários Ativos","v":"1.280","t":"+3.4%","d":"up"},{"l":"Submissões/Dia","v":"2150","t":"+1.5%","d":"up"},{"l":"Documentos Gerados","v":"7.925","t":"+0.5%","d":"up"},{"l":"Templates","v":"4.509","t":"+1.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.995","2026-02-14","8.073","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.099","2026-02-25","3.293","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.374","2026-03-21","8.557","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.818","2026-03-22","652","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.035","2026-02-16","9.066","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":781},{"label":"Mar","value":611},{"label":"Abr","value":707},{"label":"Mai","value":658},{"label":"Jun","value":592},{"label":"Jul","value":855},{"label":"Ago","value":704},{"label":"Set","value":807},{"label":"Out","value":590},{"label":"Nov","value":909},{"label":"Dez","value":799}];
const MX = 909;
