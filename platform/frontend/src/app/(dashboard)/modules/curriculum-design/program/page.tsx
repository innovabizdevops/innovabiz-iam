...
const ACCENT = "#6366f1";
const MODULE = "Curriculum Design";
const PAGE = "Program";
const KPIS = [{"l":"Formulários Ativos","v":"5.348","t":"+3.8%","d":"up"},{"l":"Submissões/Dia","v":"2625","t":"-2.7%","d":"down"},{"l":"Documentos Gerados","v":"1.635","t":"+16.5%","d":"up"},{"l":"Templates","v":"5.971","t":"-3.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.997","2026-01-07","8.236","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.664","2026-01-19","3.982","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.795","2026-02-27","6.520","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.081","2026-01-07","2.639","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.022","2026-02-20","5.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":472},{"label":"Mar","value":575},{"label":"Abr","value":718},{"label":"Mai","value":735},{"label":"Jun","value":643},{"label":"Jul","value":466},{"label":"Ago","value":519},{"label":"Set","value":547},{"label":"Out","value":541},{"label":"Nov","value":626},{"label":"Dez","value":505}];
const MX = 735;
