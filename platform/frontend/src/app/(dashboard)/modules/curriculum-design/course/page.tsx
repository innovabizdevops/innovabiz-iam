...
const PAGE = "Course";
const KPIS = [{"l":"Formulários Ativos","v":"8.159","t":"+1.3%","d":"up"},{"l":"Submissões/Dia","v":"2986","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"969","t":"-5.6%","d":"down"},{"l":"Templates","v":"6.664","t":"+13.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.348","2026-03-26","442","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.012","2026-01-17","1.089","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.027","2026-01-26","3.775","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.586","2026-02-26","7.752","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.852","2026-03-06","6.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":623},{"label":"Mar","value":472},{"label":"Abr","value":385},{"label":"Mai","value":649},{"label":"Jun","value":553},{"label":"Jul","value":554},{"label":"Ago","value":455},{"label":"Set","value":475},{"label":"Out","value":306},{"label":"Nov","value":550},{"label":"Dez","value":514}];
const MX = 649;
