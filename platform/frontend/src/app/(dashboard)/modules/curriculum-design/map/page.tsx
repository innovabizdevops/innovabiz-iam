...
const PAGE = "Map";
const KPIS = [{"l":"Formulários Ativos","v":"3.228","t":"+17.0%","d":"up"},{"l":"Submissões/Dia","v":"3249","t":"+14.2%","d":"up"},{"l":"Documentos Gerados","v":"171","t":"+3.5%","d":"up"},{"l":"Templates","v":"2.941","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.273","2026-02-02","4.117","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.978","2026-02-21","5.388","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.817","2026-02-09","8.847","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.175","2026-02-22","8.127","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.173","2026-02-03","1.097","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":447},{"label":"Mar","value":359},{"label":"Abr","value":537},{"label":"Mai","value":350},{"label":"Jun","value":524},{"label":"Jul","value":435},{"label":"Ago","value":323},{"label":"Set","value":502},{"label":"Out","value":595},{"label":"Nov","value":689},{"label":"Dez","value":680}];
const MX = 689;
