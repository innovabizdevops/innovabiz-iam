...
const KPIS = [{"l":"Formulários Ativos","v":"413","t":"-5.1%","d":"down"},{"l":"Submissões/Dia","v":"3575","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"2.799","t":"+7.4%","d":"up"},{"l":"Templates","v":"417","t":"+17.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.164","2026-03-16","5.613","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.764","2026-02-23","6.441","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.456","2026-01-13","2.947","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.881","2026-02-19","7.499","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.564","2026-01-22","301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":1055},{"label":"Mar","value":1076},{"label":"Abr","value":880},{"label":"Mai","value":989},{"label":"Jun","value":915},{"label":"Jul","value":864},{"label":"Ago","value":1007},{"label":"Set","value":787},{"label":"Out","value":960},{"label":"Nov","value":908},{"label":"Dez","value":727}];
const MX = 1076;
