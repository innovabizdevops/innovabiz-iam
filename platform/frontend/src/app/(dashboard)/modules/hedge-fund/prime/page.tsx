...
const PAGE = "Prime Broker";
const KPIS = [{"l":"Total Hedge Fund","v":"2.859","t":"+15.4%","d":"up"},{"l":"Prime Broker Ativos","v":"8.496","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"57","t":"-2.6%","d":"down"}];
const COLS = ["ID","Prime Broker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hedge Fund #001","Hedge Fund #002","8.652","4.563","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Hedge Fund #002","Hedge Fund #003","2.162","6.624","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Hedge Fund #003","Hedge Fund #004","1.339","8.523","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Hedge Fund #004","Hedge Fund #005","5.663","2.893","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hedge Fund #005","Hedge Fund #001","163","6.844","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":566},{"label":"Mar","value":799},{"label":"Abr","value":733},{"label":"Mai","value":635},{"label":"Jun","value":477},{"label":"Jul","value":530},{"label":"Ago","value":563},{"label":"Set","value":830},{"label":"Out","value":470},{"label":"Nov","value":583},{"label":"Dez","value":526}];
const MX = 830;
