...
const PAGE = "Strategy";
const KPIS = [{"l":"Total Hedge Fund","v":"7.595","t":"+1.5%","d":"up"},{"l":"Strategy Ativos","v":"8.743","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.2%","d":"up"}];
const COLS = ["ID","Strategy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hedge Fund #001","Hedge Fund #002","2.301","7.875","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Hedge Fund #002","Hedge Fund #003","6.813","2.501","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Hedge Fund #003","Hedge Fund #004","4.292","1.885","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Hedge Fund #004","Hedge Fund #005","255","4.131","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hedge Fund #005","Hedge Fund #001","5.933","5.722","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":664},{"label":"Mar","value":831},{"label":"Abr","value":546},{"label":"Mai","value":769},{"label":"Jun","value":718},{"label":"Jul","value":867},{"label":"Ago","value":716},{"label":"Set","value":550},{"label":"Out","value":779},{"label":"Nov","value":794},{"label":"Dez","value":892}];
const MX = 892;
