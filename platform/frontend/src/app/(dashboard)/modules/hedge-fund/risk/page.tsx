...
const ACCENT = "#6366f1";
const MODULE = "Hedge Fund Ops";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"7.909","t":"+5.2%","d":"up"},{"l":"Mitigações Ativas","v":"6.634","t":"-1.9%","d":"down"},{"l":"Score Risco Geral","v":"60","t":"+17.5%","d":"up"},{"l":"Incidentes YTD","v":"5.734","t":"+5.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.733","404","2.032","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.458","7.700","5.354","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.526","5.859","1.657","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.862","1.307","846","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.845","2.696","5.274","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1035},{"label":"Fev","value":1029},{"label":"Mar","value":770},{"label":"Abr","value":938},{"label":"Mai","value":763},{"label":"Jun","value":793},{"label":"Jul","value":945},{"label":"Ago","value":997},{"label":"Set","value":969},{"label":"Out","value":773},{"label":"Nov","value":902},{"label":"Dez","value":1012}];
const MX = 1035;
