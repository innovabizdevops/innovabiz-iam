...
const PAGE = "NAV";
const KPIS = [{"l":"Total Hedge Fund","v":"3.371","t":"+8.3%","d":"up"},{"l":"NAV Ativos","v":"5.445","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"60","t":"-3.9%","d":"down"}];
const COLS = ["ID","NAV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hedge Fund #001","Hedge Fund #002","383","1.959","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Hedge Fund #002","Hedge Fund #003","915","8.233","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Hedge Fund #003","Hedge Fund #004","1.026","3.990","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Hedge Fund #004","Hedge Fund #005","7.230","4.192","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hedge Fund #005","Hedge Fund #001","1.128","8.494","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":811},{"label":"Mar","value":579},{"label":"Abr","value":640},{"label":"Mai","value":815},{"label":"Jun","value":728},{"label":"Jul","value":646},{"label":"Ago","value":826},{"label":"Set","value":471},{"label":"Out","value":689},{"label":"Nov","value":582},{"label":"Dez","value":492}];
const MX = 826;
