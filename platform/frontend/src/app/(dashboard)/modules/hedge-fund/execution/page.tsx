...
const KPIS = [{"l":"Total Hedge Fund","v":"6.952","t":"-2.1%","d":"down"},{"l":"Execution Ativos","v":"8.543","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+10.6%","d":"up"}];
const COLS = ["ID","Execution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hedge Fund #001","Hedge Fund #002","5.156","4.091","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Hedge Fund #002","Hedge Fund #003","2.153","422","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Hedge Fund #003","Hedge Fund #004","198","7.297","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Hedge Fund #004","Hedge Fund #005","1.694","468","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hedge Fund #005","Hedge Fund #001","6.275","290","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":620},{"label":"Mar","value":639},{"label":"Abr","value":581},{"label":"Mai","value":451},{"label":"Jun","value":793},{"label":"Jul","value":803},{"label":"Ago","value":725},{"label":"Set","value":662},{"label":"Out","value":464},{"label":"Nov","value":759},{"label":"Dez","value":801}];
const MX = 803;
