...
const ACCENT = "#1e3a5f";
const MODULE = "Military HR & Personnel";
const PAGE = "Deploy";
const KPIS = [{"l":"Total Military Hr","v":"1.267","t":"+12.5%","d":"up"},{"l":"Deploy Ativos","v":"5.443","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+13.4%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Military Hr #001","Military Hr #002","2.074","1.640","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Military Hr #002","Military Hr #003","5.570","5.999","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Military Hr #003","Military Hr #004","2.164","1.816","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Military Hr #004","Military Hr #005","4.899","2.466","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Military Hr #005","Military Hr #001","4.966","5.087","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":711},{"label":"Mar","value":1042},{"label":"Abr","value":1001},{"label":"Mai","value":876},{"label":"Jun","value":749},{"label":"Jul","value":1007},{"label":"Ago","value":991},{"label":"Set","value":711},{"label":"Out","value":1076},{"label":"Nov","value":790},{"label":"Dez","value":1065}];
const MX = 1076;
