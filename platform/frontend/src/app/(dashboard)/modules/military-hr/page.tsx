...
/* ═══ Military HR & Personnel — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8937", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4770", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€292K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "300978737", cells: ["MIL-1737", "Military HR & Personnel Item 1", "18/6/2026", "€28 837"], status: "active" as const },
    { id: "300982308", cells: ["MIL-5308", "Military HR & Personnel Item 2", "5/1/2026", "€32 408"], status: "pending" as const },
    { id: "300985879", cells: ["MIL-8879", "Military HR & Personnel Item 3", "20/8/2026", "€35 979"], status: "completed" as const },
    { id: "300989450", cells: ["MIL-3450", "Military HR & Personnel Item 4", "7/3/2026", "€39 550"], status: "warning" as const },
    { id: "300993021", cells: ["MIL-7021", "Military HR & Personnel Item 5", "22/10/2026", "€43 121"], status: "active" as const },
];
...
export default function MilitaryHrPersonnelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Military HR & Personnel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Military HR & Personnel</p>
                    </div>
                </div>
