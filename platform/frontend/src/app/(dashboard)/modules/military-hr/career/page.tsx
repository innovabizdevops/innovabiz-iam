...
const PAGE = "Career";
const KPIS = [{"l":"Total Military Hr","v":"4.561","t":"+12.8%","d":"up"},{"l":"Career Ativos","v":"520","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"56","t":"+0.4%","d":"up"}];
const COLS = ["ID","Career","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Military Hr #001","Military Hr #002","1.331","136","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Military Hr #002","Military Hr #003","2.974","6.285","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Military Hr #003","Military Hr #004","6.525","1.881","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Military Hr #004","Military Hr #005","8.456","5.837","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Military Hr #005","Military Hr #001","300","1.898","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":345},{"label":"Mar","value":496},{"label":"Abr","value":502},{"label":"Mai","value":491},{"label":"Jun","value":564},{"label":"Jul","value":386},{"label":"Ago","value":520},{"label":"Set","value":359},{"label":"Out","value":342},{"label":"Nov","value":534},{"label":"Dez","value":383}];
const MX = 564;
