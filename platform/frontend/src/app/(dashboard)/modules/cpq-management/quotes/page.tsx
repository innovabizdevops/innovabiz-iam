...
const PAGE = "Quotes";
const KPIS = [{"l":"Projetos Melhoria","v":"3.022","t":"+16.1%","d":"up"},{"l":"Savings (€)","v":"€65067","t":"-2.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"92.3%","t":"+0.3%","d":"up"},{"l":"Ciclos PDCA","v":"3.353","t":"+5.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.358","€ 552.91","5.528","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.404","€ 14503.46","7.486","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.108","€ 28895.02","8.719","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.157","€ 25034.08","1.130","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.669","€ 34009.54","8.417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":485},{"label":"Mar","value":564},{"label":"Abr","value":792},{"label":"Mai","value":479},{"label":"Jun","value":617},{"label":"Jul","value":634},{"label":"Ago","value":634},{"label":"Set","value":724},{"label":"Out","value":741},{"label":"Nov","value":817},{"label":"Dez","value":685}];
const MX = 817;
