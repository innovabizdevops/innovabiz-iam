...
const ACCENT = "#6366f1";
const MODULE = "Cpq Management";
const PAGE = "AI Recommend";
const KPIS = [{"l":"Projetos Melhoria","v":"2.527","t":"+15.5%","d":"up"},{"l":"Savings (€)","v":"€81765","t":"+11.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.5%","t":"-1.8%","d":"down"},{"l":"Ciclos PDCA","v":"4.157","t":"-5.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.695","€ 32044.42","5.110","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.504","€ 44110.85","1.769","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.266","€ 37812.42","133","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.142","€ 15799.81","1.429","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.116","€ 1751.59","209","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":464},{"label":"Mar","value":345},{"label":"Abr","value":355},{"label":"Mai","value":568},{"label":"Jun","value":382},{"label":"Jul","value":415},{"label":"Ago","value":578},{"label":"Set","value":423},{"label":"Out","value":594},{"label":"Nov","value":691},{"label":"Dez","value":331}];
const MX = 691;
