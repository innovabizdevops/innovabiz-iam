...
const PAGE = "Pricing Rules";
const KPIS = [{"l":"ARR (€M)","v":"€2.4M","t":"+15.4%","d":"up"},{"l":"MRR (€)","v":"€33655","t":"+10.5%","d":"up"},{"l":"Churn (%)","v":"73.3%","t":"+3.2%","d":"up"},{"l":"ARPU (€)","v":"€39261","t":"+8.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26213.57","4.011","€ 24853.87","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 12084.39","6.697","€ 6525.48","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42366.66","4.973","€ 46828.54","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7161.19","4.639","€ 34482.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 43340.86","3.237","€ 1624.45","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":414},{"label":"Mar","value":472},{"label":"Abr","value":379},{"label":"Mai","value":354},{"label":"Jun","value":536},{"label":"Jul","value":359},{"label":"Ago","value":373},{"label":"Set","value":540},{"label":"Out","value":386},{"label":"Nov","value":369},{"label":"Dez","value":279}];
const MX = 540;
