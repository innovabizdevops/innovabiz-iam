...
const PAGE = "Configurator";
const KPIS = [{"l":"Projetos Melhoria","v":"4.948","t":"+3.5%","d":"up"},{"l":"Savings (€)","v":"€48471","t":"+12.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"86.2%","t":"+4.8%","d":"up"},{"l":"Ciclos PDCA","v":"2.776","t":"+7.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.045","€ 4169.42","3.906","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","825","€ 23747.61","4.277","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.084","€ 47405.14","2.013","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.977","€ 45764.31","3.752","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.670","€ 40111.30","3.225","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":457},{"label":"Mar","value":605},{"label":"Abr","value":305},{"label":"Mai","value":503},{"label":"Jun","value":353},{"label":"Jul","value":443},{"label":"Ago","value":580},{"label":"Set","value":514},{"label":"Out","value":311},{"label":"Nov","value":569},{"label":"Dez","value":505}];
const MX = 605;
