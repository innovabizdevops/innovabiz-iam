...
export default function CpqManagementPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cpq Management</h1><p className="text-sm text-muted-foreground">Cpq Management • iBOS Enterprise</p></div>
