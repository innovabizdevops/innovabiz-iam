...
const ACCENT = "#0284c7";
const MODULE = "Transport Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.719","t":"+0.1%","d":"up"},{"l":"Queries/Dia","v":"1885","t":"+0.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.684","t":"-1.8%","d":"down"},{"l":"Utilizadores Analytics","v":"8.419","t":"-0.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2322","2026-03-06","5.623","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4258","2026-02-03","3.537","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3845","2026-03-05","7.146","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2449","2026-01-19","4.892","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2100","2026-03-11","7.842","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":622},{"label":"Mar","value":424},{"label":"Abr","value":422},{"label":"Mai","value":714},{"label":"Jun","value":536},{"label":"Jul","value":617},{"label":"Ago","value":417},{"label":"Set","value":354},{"label":"Out","value":489},{"label":"Nov","value":329},{"label":"Dez","value":699}];
const MX = 714;
