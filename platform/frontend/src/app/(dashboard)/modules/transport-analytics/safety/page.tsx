...
const PAGE = "Safety";
const KPIS = [{"l":"Dashboards Ativos","v":"6.200","t":"-1.8%","d":"down"},{"l":"Queries/Dia","v":"1935","t":"+8.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.708","t":"+8.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.850","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2961","2026-02-27","7.296","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4111","2026-03-26","7.007","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3482","2026-01-12","8.254","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","877","2026-02-26","7.427","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3391","2026-02-28","7.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":1004},{"label":"Mar","value":871},{"label":"Abr","value":929},{"label":"Mai","value":798},{"label":"Jun","value":867},{"label":"Jul","value":668},{"label":"Ago","value":664},{"label":"Set","value":725},{"label":"Out","value":638},{"label":"Nov","value":955},{"label":"Dez","value":854}];
const MX = 1004;
