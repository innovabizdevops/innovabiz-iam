...
const PAGE = "On-Time";
const KPIS = [{"l":"Dashboards Ativos","v":"582","t":"+12.4%","d":"up"},{"l":"Queries/Dia","v":"4184","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.379","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"1.370","t":"-3.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4406","2026-03-03","7.714","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","707","2026-01-13","2.810","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4850","2026-03-22","1.484","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2144","2026-02-07","785","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3225","2026-01-26","3.935","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":787},{"label":"Mar","value":660},{"label":"Abr","value":622},{"label":"Mai","value":526},{"label":"Jun","value":632},{"label":"Jul","value":731},{"label":"Ago","value":790},{"label":"Set","value":567},{"label":"Out","value":539},{"label":"Nov","value":673},{"label":"Dez","value":721}];
const MX = 854;
