...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€13.8M","t":"-1.7%","d":"down"},{"l":"MRR (€)","v":"€55813","t":"+9.9%","d":"up"},{"l":"Churn (%)","v":"93.9%","t":"+6.2%","d":"up"},{"l":"ARPU (€)","v":"€59737","t":"+10.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 29763.01","8.291","€ 16670.58","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 30825.37","714","€ 42908.01","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18101.35","7.226","€ 27693.46","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46644.41","107","€ 24988.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13556.47","1.093","€ 32599.53","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1038},{"label":"Fev","value":1044},{"label":"Mar","value":766},{"label":"Abr","value":818},{"label":"Mai","value":1006},{"label":"Jun","value":994},{"label":"Jul","value":799},{"label":"Ago","value":953},{"label":"Set","value":698},{"label":"Out","value":939},{"label":"Nov","value":850},{"label":"Dez","value":787}];
const MX = 1044;
