...
const ACCENT = "#78350f";
const MODULE = "Sustainable Procurement";
const PAGE = "Score";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.259","t":"+17.2%","d":"up"},{"l":"Contratos (€M)","v":"€24.5M","t":"-3.3%","d":"down"},{"l":"On-Time Delivery (%)","v":"77.7%","t":"+16.8%","d":"up"},{"l":"Score Médio","v":"66","t":"+10.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","85.5%","€ 45188.86","3.377","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","86.6%","€ 9852.75","8.065","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","83.3%","€ 24362.59","2.837","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","80.4%","€ 34450.62","2.000","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","76.3%","€ 28945.99","1.684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":576},{"label":"Mar","value":376},{"label":"Abr","value":394},{"label":"Mai","value":524},{"label":"Jun","value":652},{"label":"Jul","value":692},{"label":"Ago","value":390},{"label":"Set","value":626},{"label":"Out","value":587},{"label":"Nov","value":365},{"label":"Dez","value":526}];
const MX = 692;
