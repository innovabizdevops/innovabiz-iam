...
const PAGE = "Improve";
const KPIS = [{"l":"Projetos Melhoria","v":"8.096","t":"-3.7%","d":"down"},{"l":"Savings (€)","v":"€43647","t":"-0.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"90.9%","t":"-1.7%","d":"down"},{"l":"Ciclos PDCA","v":"3.162","t":"+6.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.838","€ 13255.50","3.812","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.090","€ 35564.44","520","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.385","€ 3026.16","6.288","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.517","€ 1100.87","4.402","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.019","€ 16880.42","849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":459},{"label":"Mar","value":518},{"label":"Abr","value":526},{"label":"Mai","value":573},{"label":"Jun","value":306},{"label":"Jul","value":629},{"label":"Ago","value":675},{"label":"Set","value":466},{"label":"Out","value":478},{"label":"Nov","value":308},{"label":"Dez","value":477}];
const MX = 675;
