...
const PAGE = "Criteria";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.740","t":"+7.1%","d":"up"},{"l":"Contratos (€M)","v":"€26.7M","t":"-2.9%","d":"down"},{"l":"On-Time Delivery (%)","v":"86.6%","t":"+12.0%","d":"up"},{"l":"Score Médio","v":"77","t":"-2.1%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.5%","€ 48875.57","7.343","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","93.5%","€ 44781.52","5.264","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","75.1%","€ 44028.01","3.392","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","91.1%","€ 46719.52","3.120","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","82.1%","€ 45932.23","7.190","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":802},{"label":"Mar","value":457},{"label":"Abr","value":487},{"label":"Mai","value":585},{"label":"Jun","value":807},{"label":"Jul","value":839},{"label":"Ago","value":720},{"label":"Set","value":827},{"label":"Out","value":603},{"label":"Nov","value":833},{"label":"Dez","value":659}];
const MX = 839;
