...
const KPIS = [
    { label: "Total Registos", value: "1029", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4348", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€449K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "557469929", cells: ["SUS-1929", "Sustainable Procurement Item 1", "10/6/2026", "€20 029"], status: "active" as const },
    { id: "557473500", cells: ["SUS-5500", "Sustainable Procurement Item 2", "25/1/2026", "€23 600"], status: "pending" as const },
    { id: "557477071", cells: ["SUS-9071", "Sustainable Procurement Item 3", "12/8/2026", "€27 171"], status: "completed" as const },
    { id: "557480642", cells: ["SUS-3642", "Sustainable Procurement Item 4", "27/3/2026", "€30 742"], status: "warning" as const },
    { id: "557484213", cells: ["SUS-7213", "Sustainable Procurement Item 5", "14/10/2026", "€34 313"], status: "active" as const },
];
...
export default function SustainableProcurementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sustainable Procurement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sustainable Procurement</p>
                    </div>
                </div>
