...
const PAGE = "Evaluate";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.092","t":"+0.2%","d":"up"},{"l":"Contratos (€M)","v":"€7.5M","t":"+13.9%","d":"up"},{"l":"On-Time Delivery (%)","v":"71.0%","t":"+5.6%","d":"up"},{"l":"Score Médio","v":"58","t":"+17.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","84.6%","€ 3864.02","349","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","97.6%","€ 47639.79","4.497","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","84.3%","€ 40629.42","6.489","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","76.1%","€ 11789.47","6.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","94.6%","€ 19120.41","3.273","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":602},{"label":"Mar","value":539},{"label":"Abr","value":708},{"label":"Mai","value":783},{"label":"Jun","value":612},{"label":"Jul","value":579},{"label":"Ago","value":485},{"label":"Set","value":829},{"label":"Out","value":552},{"label":"Nov","value":671},{"label":"Dez","value":621}];
const MX = 829;
