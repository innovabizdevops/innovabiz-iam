...
const PAGE = "Report";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.426","t":"+0.1%","d":"up"},{"l":"Contratos (€M)","v":"€34.9M","t":"-0.8%","d":"down"},{"l":"On-Time Delivery (%)","v":"83.0%","t":"+9.7%","d":"up"},{"l":"Score Médio","v":"81","t":"+16.8%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","70.6%","€ 27355.69","1.257","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","81.9%","€ 8733.90","1.449","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.8%","€ 21154.28","4.100","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.8%","€ 22287.75","5.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","80.8%","€ 42628.22","8.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":921},{"label":"Mar","value":926},{"label":"Abr","value":670},{"label":"Mai","value":873},{"label":"Jun","value":920},{"label":"Jul","value":707},{"label":"Ago","value":807},{"label":"Set","value":935},{"label":"Out","value":818},{"label":"Nov","value":833},{"label":"Dez","value":849}];
const MX = 961;
