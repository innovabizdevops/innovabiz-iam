...
const PAGE = "Headcount Dashboard";
const KPIS = [{"l":"eNPS","v":"93","t":"+15.9%","d":"up"},{"l":"Engagement (%)","v":"74.9%","t":"+10.3%","d":"up"},{"l":"Turnover (%)","v":"86.4%","t":"+14.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.414","t":"-0.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.782","2026-03-03","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.437","2026-02-11","64","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.668","2026-01-18","55","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.284","2026-03-14","90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.403","2026-02-26","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":957},{"label":"Mar","value":827},{"label":"Abr","value":911},{"label":"Mai","value":587},{"label":"Jun","value":638},{"label":"Jul","value":741},{"label":"Ago","value":608},{"label":"Set","value":814},{"label":"Out","value":942},{"label":"Nov","value":712},{"label":"Dez","value":931}];
const MX = 957;
...
export default function HeadcountChartPage() {
    return (
