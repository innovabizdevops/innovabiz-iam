...
const PAGE = "Compensation Planning";
const KPIS = [{"l":"eNPS","v":"73","t":"+12.2%","d":"up"},{"l":"Engagement (%)","v":"69.9%","t":"-0.7%","d":"down"},{"l":"Turnover (%)","v":"85.5%","t":"+10.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"637","t":"-3.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","290","2026-02-22","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.070","2026-03-07","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.405","2026-03-09","88","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.049","2026-02-11","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.586","2026-02-19","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":828},{"label":"Mar","value":664},{"label":"Abr","value":610},{"label":"Mai","value":916},{"label":"Jun","value":539},{"label":"Jul","value":902},{"label":"Ago","value":571},{"label":"Set","value":748},{"label":"Out","value":780},{"label":"Nov","value":558},{"label":"Dez","value":555}];
const MX = 916;
