...
const PAGE = "Performance Goals";
const KPIS = [{"l":"eNPS","v":"85","t":"+4.2%","d":"up"},{"l":"Engagement (%)","v":"70.5%","t":"-5.2%","d":"down"},{"l":"Turnover (%)","v":"70.8%","t":"+16.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.668","t":"+8.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.506","2026-03-27","77","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.969","2026-02-15","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.660","2026-01-20","73","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.535","2026-03-20","79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.815","2026-03-01","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":433},{"label":"Mar","value":724},{"label":"Abr","value":604},{"label":"Mai","value":556},{"label":"Jun","value":495},{"label":"Jul","value":498},{"label":"Ago","value":431},{"label":"Set","value":694},{"label":"Out","value":650},{"label":"Nov","value":619},{"label":"Dez","value":617}];
const MX = 724;
