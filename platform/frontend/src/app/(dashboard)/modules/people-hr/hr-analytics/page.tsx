...
const PAGE = "HR Analytics AI";
const KPIS = [{"l":"eNPS","v":"69","t":"-1.8%","d":"down"},{"l":"Engagement (%)","v":"88.8%","t":"-0.7%","d":"down"},{"l":"Turnover (%)","v":"87.1%","t":"+5.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.583","t":"+8.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","181","2026-01-04","63","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.254","2026-03-15","94","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.146","2026-03-28","86","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.592","2026-03-05","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","740","2026-03-06","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":820},{"label":"Mar","value":796},{"label":"Abr","value":1064},{"label":"Mai","value":790},{"label":"Jun","value":815},{"label":"Jul","value":851},{"label":"Ago","value":699},{"label":"Set","value":812},{"label":"Out","value":709},{"label":"Nov","value":793},{"label":"Dez","value":909}];
const MX = 1064;
