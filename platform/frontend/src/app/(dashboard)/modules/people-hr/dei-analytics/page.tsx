...
const PAGE = "DEI Analytics";
const KPIS = [{"l":"eNPS","v":"91","t":"-5.5%","d":"down"},{"l":"Engagement (%)","v":"82.3%","t":"+3.8%","d":"up"},{"l":"Turnover (%)","v":"90.1%","t":"-2.9%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.667","t":"+9.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.348","2026-03-04","61","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.948","2026-03-02","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.405","2026-03-17","72","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.070","2026-03-04","75","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.806","2026-03-07","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":573},{"label":"Mar","value":686},{"label":"Abr","value":610},{"label":"Mai","value":874},{"label":"Jun","value":755},{"label":"Jul","value":577},{"label":"Ago","value":549},{"label":"Set","value":909},{"label":"Out","value":904},{"label":"Nov","value":534},{"label":"Dez","value":795}];
const MX = 909;
