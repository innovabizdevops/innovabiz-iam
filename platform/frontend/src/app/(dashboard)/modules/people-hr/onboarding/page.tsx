...
const PAGE = "Employee Onboarding";
const KPIS = [{"l":"eNPS","v":"67","t":"+17.1%","d":"up"},{"l":"Engagement (%)","v":"90.9%","t":"+10.2%","d":"up"},{"l":"Turnover (%)","v":"66.9%","t":"+13.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.346","t":"+0.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.383","2026-03-24","82","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.285","2026-02-27","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.350","2026-03-23","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.018","2026-02-05","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","515","2026-02-12","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":671},{"label":"Mar","value":754},{"label":"Abr","value":517},{"label":"Mai","value":441},{"label":"Jun","value":713},{"label":"Jul","value":447},{"label":"Ago","value":564},{"label":"Set","value":568},{"label":"Out","value":378},{"label":"Nov","value":760},{"label":"Dez","value":453}];
const MX = 760;
