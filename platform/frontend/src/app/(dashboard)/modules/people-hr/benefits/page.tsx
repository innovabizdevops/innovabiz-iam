...
const PAGE = "Benefits Administration";
const KPIS = [{"l":"eNPS","v":"69","t":"+14.1%","d":"up"},{"l":"Engagement (%)","v":"86.3%","t":"+3.5%","d":"up"},{"l":"Turnover (%)","v":"76.9%","t":"-1.1%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"6.297","t":"-5.4%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.660","2026-03-15","90","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.032","2026-02-03","83","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.005","2026-02-18","62","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.024","2026-02-23","79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.958","2026-03-17","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":309},{"label":"Mar","value":474},{"label":"Abr","value":427},{"label":"Mai","value":504},{"label":"Jun","value":571},{"label":"Jul","value":624},{"label":"Ago","value":488},{"label":"Set","value":457},{"label":"Out","value":372},{"label":"Nov","value":426},{"label":"Dez","value":593}];
const MX = 624;
