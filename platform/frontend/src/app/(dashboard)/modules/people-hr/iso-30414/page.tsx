...
const PAGE = "ISO 30414 HR Reporting";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.411","t":"+10.7%","d":"up"},{"l":"NC Abertas","v":"7.168","t":"+14.4%","d":"up"},{"l":"Conformidade (%)","v":"79.5%","t":"+16.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.746","t":"-4.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.232","77.9%","3.766","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.643","86.1%","6.790","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.761","97.1%","3.899","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.059","88.1%","1.813","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.848","71.8%","8.381","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":661},{"label":"Mar","value":822},{"label":"Abr","value":562},{"label":"Mai","value":918},{"label":"Jun","value":606},{"label":"Jul","value":772},{"label":"Ago","value":847},{"label":"Set","value":815},{"label":"Out","value":555},{"label":"Nov","value":561},{"label":"Dez","value":704}];
const MX = 918;
...
export default function Iso30414Page() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>ISO</span></h1>
                </div>
