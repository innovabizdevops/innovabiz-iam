...
const PAGE = "SHRM Competencies";
const KPIS = [{"l":"eNPS","v":"92","t":"+9.7%","d":"up"},{"l":"Engagement (%)","v":"82.4%","t":"+12.5%","d":"up"},{"l":"Turnover (%)","v":"86.4%","t":"+16.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.183","t":"+14.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.503","2026-03-02","71","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.014","2026-02-03","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.841","2026-03-16","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.467","2026-01-17","93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.213","2026-03-20","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":551},{"label":"Mar","value":506},{"label":"Abr","value":417},{"label":"Mai","value":801},{"label":"Jun","value":750},{"label":"Jul","value":478},{"label":"Ago","value":444},{"label":"Set","value":613},{"label":"Out","value":478},{"label":"Nov","value":436},{"label":"Dez","value":624}];
const MX = 801;
...
export default function ShrmPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>SHRM</span></h1>
                </div>
