...
const PAGE = "Employee Self-Service";
const KPIS = [{"l":"eNPS","v":"93","t":"-0.6%","d":"down"},{"l":"Engagement (%)","v":"75.7%","t":"+6.9%","d":"up"},{"l":"Turnover (%)","v":"72.5%","t":"+6.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.776","t":"+14.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","505","2026-01-01","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.030","2026-02-22","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.755","2026-01-13","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","705","2026-02-22","68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.611","2026-01-26","69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":263},{"label":"Fev","value":596},{"label":"Mar","value":403},{"label":"Abr","value":314},{"label":"Mai","value":397},{"label":"Jun","value":320},{"label":"Jul","value":328},{"label":"Ago","value":537},{"label":"Set","value":327},{"label":"Out","value":649},{"label":"Nov","value":469},{"label":"Dez","value":642}];
const MX = 649;
