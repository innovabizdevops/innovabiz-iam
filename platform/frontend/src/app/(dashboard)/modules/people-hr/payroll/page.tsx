...
const PAGE = "Payroll Integration";
const KPIS = [{"l":"eNPS","v":"91","t":"+12.5%","d":"up"},{"l":"Engagement (%)","v":"72.5%","t":"+3.2%","d":"up"},{"l":"Turnover (%)","v":"68.8%","t":"+8.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.778","t":"-0.1%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.947","2026-01-09","77","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.026","2026-02-07","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.806","2026-01-27","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.290","2026-02-09","90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.263","2026-02-09","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":972},{"label":"Fev","value":677},{"label":"Mar","value":796},{"label":"Abr","value":909},{"label":"Mai","value":771},{"label":"Jun","value":693},{"label":"Jul","value":916},{"label":"Ago","value":987},{"label":"Set","value":782},{"label":"Out","value":702},{"label":"Nov","value":931},{"label":"Dez","value":714}];
const MX = 987;
