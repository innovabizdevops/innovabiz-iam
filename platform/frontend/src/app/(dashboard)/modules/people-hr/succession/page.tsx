...
const KPIS = [{"l":"eNPS","v":"78","t":"-0.9%","d":"down"},{"l":"Engagement (%)","v":"94.3%","t":"+4.3%","d":"up"},{"l":"Turnover (%)","v":"90.4%","t":"-0.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.319","t":"+15.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","831","2026-02-11","68","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.422","2026-01-12","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.900","2026-02-24","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.067","2026-02-28","87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.633","2026-01-10","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":510},{"label":"Mar","value":688},{"label":"Abr","value":424},{"label":"Mai","value":457},{"label":"Jun","value":563},{"label":"Jul","value":711},{"label":"Ago","value":611},{"label":"Set","value":359},{"label":"Out","value":526},{"label":"Nov","value":396},{"label":"Dez","value":563}];
const MX = 711;
