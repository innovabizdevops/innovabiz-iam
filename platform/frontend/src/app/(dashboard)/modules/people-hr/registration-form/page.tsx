...
const PAGE = "Employee Registration";
const KPIS = [{"l":"eNPS","v":"78","t":"-2.5%","d":"down"},{"l":"Engagement (%)","v":"75.2%","t":"+5.4%","d":"up"},{"l":"Turnover (%)","v":"75.4%","t":"+2.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.193","t":"+9.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.169","2026-01-18","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.931","2026-03-07","86","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.233","2026-02-08","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.352","2026-01-27","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","134","2026-01-06","56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":435},{"label":"Mar","value":557},{"label":"Abr","value":392},{"label":"Mai","value":637},{"label":"Jun","value":678},{"label":"Jul","value":542},{"label":"Ago","value":571},{"label":"Set","value":349},{"label":"Out","value":502},{"label":"Nov","value":334},{"label":"Dez","value":533}];
const MX = 678;
