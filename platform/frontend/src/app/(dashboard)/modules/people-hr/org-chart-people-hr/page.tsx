...
const ACCENT = "#ec4899";
const MODULE = "People & HR";
const PAGE = "Org Chart Interactive";
const KPIS = [{"l":"eNPS","v":"79","t":"+16.8%","d":"up"},{"l":"Engagement (%)","v":"78.5%","t":"+15.7%","d":"up"},{"l":"Turnover (%)","v":"75.9%","t":"+12.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.878","t":"+5.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.586","2026-01-01","72","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.550","2026-01-28","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.646","2026-02-07","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","783","2026-03-20","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.411","2026-03-22","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":571},{"label":"Mar","value":542},{"label":"Abr","value":631},{"label":"Mai","value":636},{"label":"Jun","value":284},{"label":"Jul","value":326},{"label":"Ago","value":605},{"label":"Set","value":635},{"label":"Out","value":522},{"label":"Nov","value":438},{"label":"Dez","value":527}];
const MX = 643;
...
export default function OrgChartPeopleHrPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>Diagram</span></h1>
                </div>
