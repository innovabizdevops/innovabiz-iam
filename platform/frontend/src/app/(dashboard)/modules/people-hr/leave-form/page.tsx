...
const PAGE = "Leave Request Form";
const KPIS = [{"l":"eNPS","v":"92","t":"+9.5%","d":"up"},{"l":"Engagement (%)","v":"94.7%","t":"+7.4%","d":"up"},{"l":"Turnover (%)","v":"90.8%","t":"+15.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.924","t":"+4.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.639","2026-02-10","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.774","2026-02-23","83","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.991","2026-02-10","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.753","2026-03-26","63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.335","2026-01-11","75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":303},{"label":"Fev","value":421},{"label":"Mar","value":509},{"label":"Abr","value":324},{"label":"Mai","value":597},{"label":"Jun","value":348},{"label":"Jul","value":569},{"label":"Ago","value":366},{"label":"Set","value":363},{"label":"Out","value":345},{"label":"Nov","value":448},{"label":"Dez","value":469}];
const MX = 597;
