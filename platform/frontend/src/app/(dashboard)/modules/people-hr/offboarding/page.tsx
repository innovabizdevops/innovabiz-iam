...
const PAGE = "Offboarding Process";
const KPIS = [{"l":"eNPS","v":"65","t":"+8.9%","d":"up"},{"l":"Engagement (%)","v":"76.2%","t":"+5.4%","d":"up"},{"l":"Turnover (%)","v":"75.8%","t":"-1.0%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.791","t":"+10.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.979","2026-01-13","66","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.484","2026-01-03","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.597","2026-01-04","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","173","2026-03-11","82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.635","2026-01-14","60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":708},{"label":"Mar","value":578},{"label":"Abr","value":636},{"label":"Mai","value":607},{"label":"Jun","value":593},{"label":"Jul","value":718},{"label":"Ago","value":524},{"label":"Set","value":654},{"label":"Out","value":573},{"label":"Nov","value":705},{"label":"Dez","value":846}];
const MX = 846;
