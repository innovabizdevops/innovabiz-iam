...
const KPIS = [{"l":"eNPS","v":"76","t":"-1.5%","d":"down"},{"l":"Engagement (%)","v":"72.1%","t":"+3.0%","d":"up"},{"l":"Turnover (%)","v":"74.5%","t":"-3.3%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.097","t":"+9.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.181","2026-01-22","94","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.110","2026-02-11","66","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.105","2026-01-19","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.105","2026-02-24","88","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.152","2026-01-14","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":818},{"label":"Mar","value":961},{"label":"Abr","value":847},{"label":"Mai","value":827},{"label":"Jun","value":721},{"label":"Jul","value":819},{"label":"Ago","value":714},{"label":"Set","value":962},{"label":"Out","value":892},{"label":"Nov","value":955},{"label":"Dez","value":862}];
const MX = 963;
