...
const PAGE = "Kitchen";
const KPIS = [{"l":"Quartos Ocupados","v":"8.430","t":"-1.7%","d":"down"},{"l":"RevPAR (€)","v":"€61613","t":"+12.2%","d":"up"},{"l":"Ocupação (%)","v":"74.4%","t":"+11.4%","d":"up"},{"l":"Guest Satisfaction","v":"1.323","t":"+12.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.733","2026-03-20","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.274","2026-02-08","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.659","2026-02-01","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.668","2026-02-22","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.852","2026-02-01","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":526},{"label":"Mar","value":584},{"label":"Abr","value":534},{"label":"Mai","value":423},{"label":"Jun","value":329},{"label":"Jul","value":505},{"label":"Ago","value":292},{"label":"Set","value":599},{"label":"Out","value":561},{"label":"Nov","value":621},{"label":"Dez","value":308}];
const MX = 621;
