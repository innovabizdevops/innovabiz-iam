...
const PAGE = "Table";
const KPIS = [{"l":"Quartos Ocupados","v":"6.975","t":"-5.5%","d":"down"},{"l":"RevPAR (€)","v":"€39352","t":"+6.9%","d":"up"},{"l":"Ocupação (%)","v":"85.2%","t":"+12.5%","d":"up"},{"l":"Guest Satisfaction","v":"1.468","t":"+13.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","835","2026-02-25","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.276","2026-02-24","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.702","2026-03-13","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.044","2026-02-15","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.430","2026-02-12","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":580},{"label":"Mar","value":535},{"label":"Abr","value":284},{"label":"Mai","value":643},{"label":"Jun","value":531},{"label":"Jul","value":583},{"label":"Ago","value":416},{"label":"Set","value":386},{"label":"Out","value":365},{"label":"Nov","value":527},{"label":"Dez","value":322}];
const MX = 643;
