...
const PAGE = "Pay";
const KPIS = [{"l":"Quartos Ocupados","v":"1.799","t":"+1.7%","d":"up"},{"l":"RevPAR (€)","v":"€36607","t":"+8.6%","d":"up"},{"l":"Ocupação (%)","v":"74.7%","t":"-2.2%","d":"down"},{"l":"Guest Satisfaction","v":"4.712","t":"+13.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.155","2026-03-02","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.661","2026-02-02","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.888","2026-02-01","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.213","2026-03-21","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.743","2026-02-12","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":638},{"label":"Mar","value":349},{"label":"Abr","value":626},{"label":"Mai","value":413},{"label":"Jun","value":521},{"label":"Jul","value":454},{"label":"Ago","value":655},{"label":"Set","value":701},{"label":"Out","value":691},{"label":"Nov","value":656},{"label":"Dez","value":547}];
const MX = 701;
