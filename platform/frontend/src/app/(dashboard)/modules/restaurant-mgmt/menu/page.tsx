...
const ACCENT = "#c2410c";
const MODULE = "Restaurant Management";
const PAGE = "Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"8.798","t":"+2.5%","d":"up"},{"l":"RevPAR (€)","v":"€21335","t":"+3.5%","d":"up"},{"l":"Ocupação (%)","v":"66.0%","t":"+8.6%","d":"up"},{"l":"Guest Satisfaction","v":"1.627","t":"-2.7%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.528","2026-01-01","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.580","2026-01-23","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.497","2026-01-13","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.664","2026-01-06","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.458","2026-03-20","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":310},{"label":"Fev","value":273},{"label":"Mar","value":572},{"label":"Abr","value":389},{"label":"Mai","value":250},{"label":"Jun","value":275},{"label":"Jul","value":571},{"label":"Ago","value":556},{"label":"Set","value":223},{"label":"Out","value":246},{"label":"Nov","value":404},{"label":"Dez","value":296}];
const MX = 572;
