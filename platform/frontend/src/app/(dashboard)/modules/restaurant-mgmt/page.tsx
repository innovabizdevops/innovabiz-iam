...
const KPIS = [
    { label: "Total Registos", value: "124", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "509", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€137K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "66409224", cells: ["RES-8224", "Restaurant Management Item 1", "1/1/2026", "€9324"], status: "active" as const },
    { id: "66412795", cells: ["RES-2795", "Restaurant Management Item 2", "16/8/2026", "€12 895"], status: "pending" as const },
    { id: "66416366", cells: ["RES-6366", "Restaurant Management Item 3", "3/3/2026", "€16 466"], status: "completed" as const },
    { id: "66419937", cells: ["RES-9937", "Restaurant Management Item 4", "18/10/2026", "€20 037"], status: "warning" as const },
    { id: "66423508", cells: ["RES-4508", "Restaurant Management Item 5", "5/5/2026", "€23 608"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Restaurant Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Restaurant Management</p>
                    </div>
                </div>
