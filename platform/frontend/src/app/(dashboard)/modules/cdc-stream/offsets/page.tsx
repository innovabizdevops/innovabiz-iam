...
const PAGE = "Offset Tracking";
const KPIS = [{"l":"Total Cdc Stream","v":"7.007","t":"+11.1%","d":"up"},{"l":"Offset Tracking Ativos","v":"6.230","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"91","t":"-4.7%","d":"down"}];
const COLS = ["ID","Offset Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdc Stream #001","Cdc Stream #002","3.182","548","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cdc Stream #002","Cdc Stream #003","4.636","2.745","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdc Stream #003","Cdc Stream #004","8.614","5.203","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cdc Stream #004","Cdc Stream #005","3.243","1.437","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdc Stream #005","Cdc Stream #001","616","3.972","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":279},{"label":"Fev","value":331},{"label":"Mar","value":628},{"label":"Abr","value":516},{"label":"Mai","value":413},{"label":"Jun","value":467},{"label":"Jul","value":459},{"label":"Ago","value":274},{"label":"Set","value":603},{"label":"Out","value":578},{"label":"Nov","value":322},{"label":"Dez","value":402}];
const MX = 628;
