...
const PAGE = "Change Capture";
const KPIS = [{"l":"Total Cdc Stream","v":"7.295","t":"-2.0%","d":"down"},{"l":"Change Capture Ativos","v":"5.710","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"68.7%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+1.6%","d":"up"}];
const COLS = ["ID","Change Capture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdc Stream #001","Cdc Stream #002","3.902","2.621","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Cdc Stream #002","Cdc Stream #003","6.458","3.308","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdc Stream #003","Cdc Stream #004","8.527","3.190","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Cdc Stream #004","Cdc Stream #005","2.113","156","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdc Stream #005","Cdc Stream #001","6.010","1.458","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":410},{"label":"Mar","value":419},{"label":"Abr","value":525},{"label":"Mai","value":480},{"label":"Jun","value":289},{"label":"Jul","value":325},{"label":"Ago","value":650},{"label":"Set","value":649},{"label":"Out","value":466},{"label":"Nov","value":525},{"label":"Dez","value":435}];
const MX = 650;
