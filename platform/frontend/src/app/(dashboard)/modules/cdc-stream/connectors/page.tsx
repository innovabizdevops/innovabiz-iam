...
const PAGE = "Connector Mgmt";
const KPIS = [{"l":"Integrações Ativas","v":"1.140","t":"+7.1%","d":"up"},{"l":"Chamadas/Hora","v":"1916","t":"+5.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.6%","t":"+1.7%","d":"up"},{"l":"Latência Média (ms)","v":"97ms","t":"+5.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.647","5.147","88.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.402","6.400","70.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.054","7.748","70.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","9.051","7.715","90.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.721","1.583","79.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":695},{"label":"Mar","value":453},{"label":"Abr","value":690},{"label":"Mai","value":632},{"label":"Jun","value":661},{"label":"Jul","value":445},{"label":"Ago","value":719},{"label":"Set","value":492},{"label":"Out","value":737},{"label":"Nov","value":579},{"label":"Dez","value":390}];
const MX = 737;
