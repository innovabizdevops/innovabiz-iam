...
export default function CdcStreamPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cdc Stream</h1><p className="text-sm text-muted-foreground">Cdc Stream • iBOS Enterprise</p></div>
