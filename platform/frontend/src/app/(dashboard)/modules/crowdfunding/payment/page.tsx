...
const PAGE = "Payment";
const KPIS = [{"l":"Total Crowdfunding","v":"2.665","t":"+6.2%","d":"up"},{"l":"Payment Ativos","v":"9.013","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"82","t":"+15.2%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crowdfunding #001","Crowdfunding #002","8.565","4.573","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Crowdfunding #002","Crowdfunding #003","4.394","7.138","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Crowdfunding #003","Crowdfunding #004","368","573","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Crowdfunding #004","Crowdfunding #005","8.405","6.690","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crowdfunding #005","Crowdfunding #001","3.193","3.307","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":812},{"label":"Mar","value":920},{"label":"Abr","value":699},{"label":"Mai","value":804},{"label":"Jun","value":796},{"label":"Jul","value":910},{"label":"Ago","value":867},{"label":"Set","value":698},{"label":"Out","value":927},{"label":"Nov","value":627},{"label":"Dez","value":692}];
const MX = 927;
