...
const PAGE = "Campaign";
const KPIS = [{"l":"Total Crowdfunding","v":"8.928","t":"+4.8%","d":"up"},{"l":"Campaign Ativos","v":"8.559","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"61","t":"-0.5%","d":"down"}];
const COLS = ["ID","Campaign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crowdfunding #001","Crowdfunding #002","5.386","5.808","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Crowdfunding #002","Crowdfunding #003","5.425","8.543","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Crowdfunding #003","Crowdfunding #004","692","1.364","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Crowdfunding #004","Crowdfunding #005","4.727","2.281","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crowdfunding #005","Crowdfunding #001","8.912","4.131","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":670},{"label":"Mar","value":515},{"label":"Abr","value":511},{"label":"Mai","value":758},{"label":"Jun","value":708},{"label":"Jul","value":791},{"label":"Ago","value":779},{"label":"Set","value":590},{"label":"Out","value":715},{"label":"Nov","value":774},{"label":"Dez","value":595}];
const MX = 791;
