...
const ACCENT = "#6366f1";
const MODULE = "Crowdfunding Platform";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"6.970","t":"-0.9%","d":"down"},{"l":"Queries/Dia","v":"4732","t":"+11.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.000","t":"+5.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.647","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1173","2026-02-24","3.484","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4965","2026-02-21","8.514","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4946","2026-03-01","2.087","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1802","2026-03-05","3.168","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","735","2026-01-17","6.578","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":968},{"label":"Mar","value":869},{"label":"Abr","value":704},{"label":"Mai","value":792},{"label":"Jun","value":958},{"label":"Jul","value":918},{"label":"Ago","value":720},{"label":"Set","value":658},{"label":"Out","value":855},{"label":"Nov","value":842},{"label":"Dez","value":720}];
const MX = 968;
