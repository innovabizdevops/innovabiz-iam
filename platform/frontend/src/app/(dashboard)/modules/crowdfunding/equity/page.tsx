...
const PAGE = "Equity";
const KPIS = [{"l":"Total Crowdfunding","v":"7.739","t":"+14.6%","d":"up"},{"l":"Equity Ativos","v":"625","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"59","t":"-5.9%","d":"down"}];
const COLS = ["ID","Equity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crowdfunding #001","Crowdfunding #002","7.054","3.456","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Crowdfunding #002","Crowdfunding #003","5.712","4.505","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Crowdfunding #003","Crowdfunding #004","4.779","8.059","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Crowdfunding #004","Crowdfunding #005","2.122","6.295","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crowdfunding #005","Crowdfunding #001","2.399","8.368","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":345},{"label":"Fev","value":309},{"label":"Mar","value":477},{"label":"Abr","value":442},{"label":"Mai","value":640},{"label":"Jun","value":623},{"label":"Jul","value":598},{"label":"Ago","value":388},{"label":"Set","value":679},{"label":"Out","value":366},{"label":"Nov","value":515},{"label":"Dez","value":300}];
const MX = 679;
