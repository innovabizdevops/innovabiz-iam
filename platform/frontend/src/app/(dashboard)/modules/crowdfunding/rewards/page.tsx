...
const PAGE = "Rewards";
const KPIS = [{"l":"Total Crowdfunding","v":"6.267","t":"+16.1%","d":"up"},{"l":"Rewards Ativos","v":"4.437","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"68.7%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"74","t":"+7.2%","d":"up"}];
const COLS = ["ID","Rewards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crowdfunding #001","Crowdfunding #002","1.007","2.897","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Crowdfunding #002","Crowdfunding #003","1.987","3.809","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Crowdfunding #003","Crowdfunding #004","3.995","5.199","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Crowdfunding #004","Crowdfunding #005","1.146","887","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crowdfunding #005","Crowdfunding #001","303","8.123","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":645},{"label":"Mar","value":421},{"label":"Abr","value":440},{"label":"Mai","value":504},{"label":"Jun","value":570},{"label":"Jul","value":318},{"label":"Ago","value":514},{"label":"Set","value":576},{"label":"Out","value":497},{"label":"Nov","value":592},{"label":"Dez","value":392}];
const MX = 645;
