...
const KPIS = [{"l":"Total Trade Finance","v":"4.215","t":"+11.1%","d":"up"},{"l":"Factoring Ativos","v":"1.346","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"88","t":"+8.3%","d":"up"}];
const COLS = ["ID","Factoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Finance #001","Trade Finance #002","1.667","3.228","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Finance #002","Trade Finance #003","4.098","2.359","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Finance #003","Trade Finance #004","3.350","427","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Finance #004","Trade Finance #005","7.013","3.485","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Finance #005","Trade Finance #001","6.796","4.194","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":613},{"label":"Mar","value":623},{"label":"Abr","value":710},{"label":"Mai","value":828},{"label":"Jun","value":679},{"label":"Jul","value":924},{"label":"Ago","value":767},{"label":"Set","value":811},{"label":"Out","value":771},{"label":"Nov","value":929},{"label":"Dez","value":647}];
const MX = 929;
