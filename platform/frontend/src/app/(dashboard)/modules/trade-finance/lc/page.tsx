...
const PAGE = "Letter of Credit";
const KPIS = [{"l":"Integrações Ativas","v":"1.376","t":"-5.9%","d":"down"},{"l":"Chamadas/Hora","v":"2785","t":"+3.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.6%","t":"+3.6%","d":"up"},{"l":"Latência Média (ms)","v":"63ms","t":"-4.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.450","6.081","82.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.481","403","81.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.301","7.100","81.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.932","2.089","72.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.354","3.273","94.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":763},{"label":"Mar","value":894},{"label":"Abr","value":908},{"label":"Mai","value":829},{"label":"Jun","value":989},{"label":"Jul","value":848},{"label":"Ago","value":681},{"label":"Set","value":776},{"label":"Out","value":898},{"label":"Nov","value":838},{"label":"Dez","value":730}];
const MX = 989;
