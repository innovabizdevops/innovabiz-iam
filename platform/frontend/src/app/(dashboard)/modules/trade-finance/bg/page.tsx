...
const PAGE = "BG Guarantee";
const KPIS = [{"l":"Total Trade Finance","v":"3.582","t":"-1.8%","d":"down"},{"l":"BG Guarantee Ativos","v":"8.989","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+2.2%","d":"up"}];
const COLS = ["ID","BG Guarantee","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Finance #001","Trade Finance #002","5.094","1.956","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Finance #002","Trade Finance #003","6.876","1.132","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Finance #003","Trade Finance #004","6.690","2.495","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Finance #004","Trade Finance #005","1.757","4.368","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Finance #005","Trade Finance #001","7.266","6.088","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":1057},{"label":"Mar","value":710},{"label":"Abr","value":922},{"label":"Mai","value":900},{"label":"Jun","value":798},{"label":"Jul","value":744},{"label":"Ago","value":973},{"label":"Set","value":1076},{"label":"Out","value":1045},{"label":"Nov","value":807},{"label":"Dez","value":691}];
const MX = 1076;
