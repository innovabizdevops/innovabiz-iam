...
const ACCENT = "#059669";
const MODULE = "Trade Finance";
const PAGE = "Forfaiting";
const KPIS = [{"l":"Total Trade Finance","v":"4.057","t":"+2.3%","d":"up"},{"l":"Forfaiting Ativos","v":"7.506","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"68.0%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+4.2%","d":"up"}];
const COLS = ["ID","Forfaiting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Finance #001","Trade Finance #002","288","8.913","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Finance #002","Trade Finance #003","158","704","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Finance #003","Trade Finance #004","610","7.490","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Finance #004","Trade Finance #005","4.419","297","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Finance #005","Trade Finance #001","6.523","1.989","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":1026},{"label":"Mar","value":720},{"label":"Abr","value":894},{"label":"Mai","value":1068},{"label":"Jun","value":792},{"label":"Jul","value":873},{"label":"Ago","value":881},{"label":"Set","value":1023},{"label":"Out","value":1000},{"label":"Nov","value":739},{"label":"Dez","value":771}];
const MX = 1068;
