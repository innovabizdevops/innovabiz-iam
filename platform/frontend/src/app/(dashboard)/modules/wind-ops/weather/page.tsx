...
const PAGE = "Weather";
const KPIS = [{"l":"Total Wind Ops","v":"3.830","t":"+4.9%","d":"up"},{"l":"Weather Ativos","v":"222","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.2%","d":"up"}];
const COLS = ["ID","Weather","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wind Ops #001","Wind Ops #002","4.165","7.687","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Wind Ops #002","Wind Ops #003","5.464","415","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Wind Ops #003","Wind Ops #004","8.818","922","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Wind Ops #004","Wind Ops #005","4.547","6.197","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wind Ops #005","Wind Ops #001","5.858","6.241","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":600},{"label":"Mar","value":554},{"label":"Abr","value":825},{"label":"Mai","value":807},{"label":"Jun","value":502},{"label":"Jul","value":722},{"label":"Ago","value":539},{"label":"Set","value":628},{"label":"Out","value":860},{"label":"Nov","value":746},{"label":"Dez","value":627}];
const MX = 869;
