...
const PAGE = "Turbine";
const KPIS = [{"l":"Total Wind Ops","v":"8.990","t":"+10.6%","d":"up"},{"l":"Turbine Ativos","v":"638","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"63","t":"-4.4%","d":"down"}];
const COLS = ["ID","Turbine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wind Ops #001","Wind Ops #002","2.636","4.777","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Wind Ops #002","Wind Ops #003","2.602","7.572","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Wind Ops #003","Wind Ops #004","2.003","6.891","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Wind Ops #004","Wind Ops #005","6.694","4.946","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wind Ops #005","Wind Ops #001","6.043","6.443","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":922},{"label":"Mar","value":882},{"label":"Abr","value":786},{"label":"Mai","value":946},{"label":"Jun","value":812},{"label":"Jul","value":991},{"label":"Ago","value":631},{"label":"Set","value":631},{"label":"Out","value":838},{"label":"Nov","value":864},{"label":"Dez","value":883}];
const MX = 991;
