...
const KPIS = [{"l":"Formulários Ativos","v":"2.692","t":"+10.3%","d":"up"},{"l":"Submissões/Dia","v":"3036","t":"+4.8%","d":"up"},{"l":"Documentos Gerados","v":"4.831","t":"+0.6%","d":"up"},{"l":"Templates","v":"527","t":"+8.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.579","2026-01-25","1.620","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.121","2026-02-14","7.122","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.925","2026-02-22","1.396","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.171","2026-01-25","5.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.573","2026-01-02","172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":406},{"label":"Mar","value":465},{"label":"Abr","value":576},{"label":"Mai","value":612},{"label":"Jun","value":466},{"label":"Jul","value":485},{"label":"Ago","value":598},{"label":"Set","value":403},{"label":"Out","value":433},{"label":"Nov","value":614},{"label":"Dez","value":627}];
const MX = 627;
