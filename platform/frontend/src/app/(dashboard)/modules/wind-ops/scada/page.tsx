...
const PAGE = "SCADA";
const KPIS = [{"l":"Dispositivos Online","v":"1.485","t":"+7.7%","d":"up"},{"l":"Dados/Min (MB)","v":"243","t":"-5.1%","d":"down"},{"l":"Alertas Ativos","v":"1.928","t":"+16.2%","d":"up"},{"l":"Uptime (%)","v":"75.2%","t":"-1.4%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.711","3.557","6.410","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","9.027","7.802","1.650","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.600","4.369","5.013","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.025","3.051","8.985","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.547","7.887","1.609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":775},{"label":"Mar","value":571},{"label":"Abr","value":786},{"label":"Mai","value":606},{"label":"Jun","value":881},{"label":"Jul","value":820},{"label":"Ago","value":599},{"label":"Set","value":685},{"label":"Out","value":759},{"label":"Nov","value":591},{"label":"Dez","value":596}];
const MX = 881;
