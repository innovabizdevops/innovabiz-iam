...
const ACCENT = "#6366f1";
const MODULE = "Wind Operations";
const PAGE = "Maintenance";
const KPIS = [{"l":"Total Wind Ops","v":"1.547","t":"-0.3%","d":"down"},{"l":"Maintenance Ativos","v":"286","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"86","t":"+1.0%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wind Ops #001","Wind Ops #002","1.128","7.251","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Wind Ops #002","Wind Ops #003","5.447","2.539","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Wind Ops #003","Wind Ops #004","960","3.634","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Wind Ops #004","Wind Ops #005","4.196","5.887","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wind Ops #005","Wind Ops #001","5.270","5.456","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":224},{"label":"Mar","value":514},{"label":"Abr","value":278},{"label":"Mai","value":519},{"label":"Jun","value":249},{"label":"Jul","value":278},{"label":"Ago","value":506},{"label":"Set","value":566},{"label":"Out","value":527},{"label":"Nov","value":314},{"label":"Dez","value":576}];
const MX = 576;
