...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.674","t":"+17.4%","d":"up"},{"l":"Submissões/Dia","v":"3455","t":"+13.3%","d":"up"},{"l":"Documentos Gerados","v":"2.430","t":"-2.8%","d":"down"},{"l":"Templates","v":"5.775","t":"+12.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.537","2026-01-05","6.381","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.232","2026-01-05","1.338","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.368","2026-02-11","7.897","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.614","2026-03-27","2.221","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.420","2026-03-07","4.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1018},{"label":"Fev","value":762},{"label":"Mar","value":981},{"label":"Abr","value":735},{"label":"Mai","value":873},{"label":"Jun","value":868},{"label":"Jul","value":801},{"label":"Ago","value":890},{"label":"Set","value":838},{"label":"Out","value":866},{"label":"Nov","value":746},{"label":"Dez","value":794}];
const MX = 1018;
