...
const PAGE = "Client";
const KPIS = [{"l":"Total Landscaping Svc","v":"8.011","t":"+2.2%","d":"up"},{"l":"Client Ativos","v":"4.955","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+17.2%","d":"up"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Landscaping Svc #001","Landscaping Svc #002","8.967","1.059","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Landscaping Svc #002","Landscaping Svc #003","5.758","8.368","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Landscaping Svc #003","Landscaping Svc #004","4.911","2.216","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Landscaping Svc #004","Landscaping Svc #005","5.612","1.486","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Landscaping Svc #005","Landscaping Svc #001","2.222","3.881","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":269},{"label":"Mar","value":605},{"label":"Abr","value":399},{"label":"Mai","value":463},{"label":"Jun","value":582},{"label":"Jul","value":442},{"label":"Ago","value":293},{"label":"Set","value":298},{"label":"Out","value":311},{"label":"Nov","value":356},{"label":"Dez","value":548}];
const MX = 605;
