...
const PAGE = "Crew";
const KPIS = [{"l":"Total Landscaping Svc","v":"7.681","t":"+1.4%","d":"up"},{"l":"Crew Ativos","v":"4.748","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+14.4%","d":"up"}];
const COLS = ["ID","Crew","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Landscaping Svc #001","Landscaping Svc #002","7.844","3.000","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Landscaping Svc #002","Landscaping Svc #003","3.822","1.723","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Landscaping Svc #003","Landscaping Svc #004","2.957","4.064","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Landscaping Svc #004","Landscaping Svc #005","8.822","8.205","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Landscaping Svc #005","Landscaping Svc #001","3.015","6.718","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":713},{"label":"Mar","value":347},{"label":"Abr","value":413},{"label":"Mai","value":564},{"label":"Jun","value":343},{"label":"Jul","value":503},{"label":"Ago","value":405},{"label":"Set","value":497},{"label":"Out","value":347},{"label":"Nov","value":637},{"label":"Dez","value":469}];
const MX = 713;
