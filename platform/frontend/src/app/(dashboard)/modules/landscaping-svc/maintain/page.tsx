...
const ACCENT = "#6366f1";
const MODULE = "Landscaping Services";
const PAGE = "Maintain";
const KPIS = [{"l":"Total Landscaping Svc","v":"5.173","t":"+14.9%","d":"up"},{"l":"Maintain Ativos","v":"8.861","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"64","t":"+14.4%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Landscaping Svc #001","Landscaping Svc #002","8.293","2.591","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Landscaping Svc #002","Landscaping Svc #003","6.883","2.555","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Landscaping Svc #003","Landscaping Svc #004","7.227","8.420","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Landscaping Svc #004","Landscaping Svc #005","1.668","3.224","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Landscaping Svc #005","Landscaping Svc #001","7.835","4.422","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":766},{"label":"Mar","value":754},{"label":"Abr","value":859},{"label":"Mai","value":946},{"label":"Jun","value":962},{"label":"Jul","value":777},{"label":"Ago","value":905},{"label":"Set","value":699},{"label":"Out","value":936},{"label":"Nov","value":663},{"label":"Dez","value":863}];
const MX = 963;
