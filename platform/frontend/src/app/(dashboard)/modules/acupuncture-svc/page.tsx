...
/* ═══ Acupuncture Clinic — Dashboard ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total Registos", value: "9339", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2044", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€178K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "431916539", cells: ["ACU-7539", "Acupuncture Clinic Item 1", "20/12/2026", "€16 639"], status: "active" as const },
    { id: "431920110", cells: ["ACU-2110", "Acupuncture Clinic Item 2", "7/7/2026", "€20 210"], status: "pending" as const },
    { id: "431923681", cells: ["ACU-5681", "Acupuncture Clinic Item 3", "22/2/2026", "€23 781"], status: "completed" as const },
    { id: "431927252", cells: ["ACU-9252", "Acupuncture Clinic Item 4", "9/9/2026", "€27 352"], status: "warning" as const },
    { id: "431930823", cells: ["ACU-3823", "Acupuncture Clinic Item 5", "24/4/2026", "€30 923"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Acupuncture Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Acupuncture Clinic</p>
                    </div>
                </div>
