...
const PAGE = "Herbal";
const KPIS = [{"l":"Total Acupuncture Svc","v":"275","t":"+8.8%","d":"up"},{"l":"Herbal Ativos","v":"7.191","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+9.8%","d":"up"}];
const COLS = ["ID","Herbal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acupuncture Svc #001","Acupuncture Svc #002","4.546","3.985","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Acupuncture Svc #002","Acupuncture Svc #003","7.384","7.812","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Acupuncture Svc #003","Acupuncture Svc #004","481","8.846","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Acupuncture Svc #004","Acupuncture Svc #005","3.245","7.811","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acupuncture Svc #005","Acupuncture Svc #001","5.240","7.202","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":456},{"label":"Mar","value":468},{"label":"Abr","value":440},{"label":"Mai","value":331},{"label":"Jun","value":529},{"label":"Jul","value":559},{"label":"Ago","value":578},{"label":"Set","value":325},{"label":"Out","value":390},{"label":"Nov","value":491},{"label":"Dez","value":453}];
const MX = 578;
