...
const PAGE = "Session";
const KPIS = [{"l":"Total Acupuncture Svc","v":"2.451","t":"+14.8%","d":"up"},{"l":"Session Ativos","v":"6.776","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+6.3%","d":"up"}];
const COLS = ["ID","Session","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acupuncture Svc #001","Acupuncture Svc #002","3.248","8.906","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Acupuncture Svc #002","Acupuncture Svc #003","462","6.156","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Acupuncture Svc #003","Acupuncture Svc #004","4.525","2.074","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Acupuncture Svc #004","Acupuncture Svc #005","9.014","1.035","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acupuncture Svc #005","Acupuncture Svc #001","3.629","4.372","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":749},{"label":"Mar","value":674},{"label":"Abr","value":773},{"label":"Mai","value":523},{"label":"Jun","value":489},{"label":"Jul","value":711},{"label":"Ago","value":591},{"label":"Set","value":463},{"label":"Out","value":411},{"label":"Nov","value":784},{"label":"Dez","value":500}];
const MX = 784;
