...
const PAGE = "Patient";
const KPIS = [{"l":"Total Acupuncture Svc","v":"7.418","t":"+1.4%","d":"up"},{"l":"Patient Ativos","v":"999","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"90","t":"-1.4%","d":"down"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acupuncture Svc #001","Acupuncture Svc #002","5.217","5.185","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Acupuncture Svc #002","Acupuncture Svc #003","7.229","7.125","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Acupuncture Svc #003","Acupuncture Svc #004","6.104","6.545","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Acupuncture Svc #004","Acupuncture Svc #005","7.918","3.449","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acupuncture Svc #005","Acupuncture Svc #001","1.284","1.782","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":609},{"label":"Mar","value":788},{"label":"Abr","value":580},{"label":"Mai","value":747},{"label":"Jun","value":437},{"label":"Jul","value":587},{"label":"Ago","value":516},{"label":"Set","value":739},{"label":"Out","value":787},{"label":"Nov","value":622},{"label":"Dez","value":525}];
const MX = 788;
