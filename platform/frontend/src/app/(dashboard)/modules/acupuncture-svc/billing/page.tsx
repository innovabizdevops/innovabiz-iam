...
const PAGE = "Billing";
const KPIS = [{"l":"Total Acupuncture Svc","v":"5.397","t":"-4.3%","d":"down"},{"l":"Billing Ativos","v":"3.838","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"79.4%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+1.3%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acupuncture Svc #001","Acupuncture Svc #002","3.685","8.807","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Acupuncture Svc #002","Acupuncture Svc #003","1.614","1.155","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Acupuncture Svc #003","Acupuncture Svc #004","8.484","1.233","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Acupuncture Svc #004","Acupuncture Svc #005","7.908","6.316","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acupuncture Svc #005","Acupuncture Svc #001","5.808","2.942","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":534},{"label":"Mar","value":528},{"label":"Abr","value":581},{"label":"Mai","value":377},{"label":"Jun","value":414},{"label":"Jul","value":689},{"label":"Ago","value":540},{"label":"Set","value":368},{"label":"Out","value":464},{"label":"Nov","value":662},{"label":"Dez","value":452}];
const MX = 689;
