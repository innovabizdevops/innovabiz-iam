...
const ACCENT = "#16a34a";
const MODULE = "Acupuncture Clinic";
const PAGE = "Point Map";
const KPIS = [{"l":"Total Acupuncture Svc","v":"3.850","t":"+13.5%","d":"up"},{"l":"Point Map Ativos","v":"2.872","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"67","t":"+2.6%","d":"up"}];
const COLS = ["ID","Point Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Acupuncture Svc #001","Acupuncture Svc #002","6.021","7.669","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Acupuncture Svc #002","Acupuncture Svc #003","5.105","6.694","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Acupuncture Svc #003","Acupuncture Svc #004","4.533","8.475","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Acupuncture Svc #004","Acupuncture Svc #005","4.872","7.991","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Acupuncture Svc #005","Acupuncture Svc #001","7.057","6.572","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":610},{"label":"Mar","value":928},{"label":"Abr","value":837},{"label":"Mai","value":841},{"label":"Jun","value":594},{"label":"Jul","value":682},{"label":"Ago","value":853},{"label":"Set","value":842},{"label":"Out","value":821},{"label":"Nov","value":802},{"label":"Dez","value":704}];
const MX = 945;
