...
/* ═══ GenAI Copilot Builder — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "6926", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3083", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€296K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1912310626", cells: ["GEN-9626", "GenAI Copilot Builder Item 1", "3/11/2026", "€10 726"], status: "active" as const },
    { id: "1912314197", cells: ["GEN-4197", "GenAI Copilot Builder Item 2", "18/6/2026", "€14 297"], status: "pending" as const },
    { id: "1912317768", cells: ["GEN-7768", "GenAI Copilot Builder Item 3", "5/1/2026", "€17 868"], status: "completed" as const },
    { id: "1912321339", cells: ["GEN-2339", "GenAI Copilot Builder Item 4", "20/8/2026", "€21 439"], status: "warning" as const },
    { id: "1912324910", cells: ["GEN-5910", "GenAI Copilot Builder Item 5", "7/3/2026", "€25 010"], status: "active" as const },
];
...
export default function GenaiCopilotBuilderPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Copilot Builder</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Copilot Builder</p>
                    </div>
                </div>
