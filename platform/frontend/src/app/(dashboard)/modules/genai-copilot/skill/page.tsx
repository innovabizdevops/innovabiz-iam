...
const ACCENT = "#8b5cf6";
const MODULE = "GenAI Copilot Builder";
const PAGE = "Skill";
const KPIS = [{"l":"Total Genai Copilot","v":"5.647","t":"+15.7%","d":"up"},{"l":"Skill Ativos","v":"3.804","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.0%","d":"up"}];
const COLS = ["ID","Skill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Copilot #001","Genai Copilot #002","1.355","1.733","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Copilot #002","Genai Copilot #003","5.014","7.902","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Copilot #003","Genai Copilot #004","7.814","3.749","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Copilot #004","Genai Copilot #005","6.699","8.816","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Copilot #005","Genai Copilot #001","7.605","5.655","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":435},{"label":"Mar","value":608},{"label":"Abr","value":462},{"label":"Mai","value":555},{"label":"Jun","value":470},{"label":"Jul","value":748},{"label":"Ago","value":536},{"label":"Set","value":470},{"label":"Out","value":513},{"label":"Nov","value":461},{"label":"Dez","value":706}];
const MX = 748;
