...
const KPIS = [{"l":"Artigos Publicados","v":"5.713","t":"-2.2%","d":"down"},{"l":"Views/Semana","v":"1985","t":"+6.0%","d":"up"},{"l":"Feedback Útil (%)","v":"79.4%","t":"+2.2%","d":"up"},{"l":"Artigos Desatualizados","v":"3.514","t":"+9.4%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","1.591","75.7%","4.827","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","7.408","96.0%","1.250","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.748","91.1%","2.106","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.103","89.6%","8.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","5.347","97.1%","6.915","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":362},{"label":"Mar","value":582},{"label":"Abr","value":416},{"label":"Mai","value":510},{"label":"Jun","value":600},{"label":"Jul","value":401},{"label":"Ago","value":388},{"label":"Set","value":718},{"label":"Out","value":528},{"label":"Nov","value":509},{"label":"Dez","value":674}];
const MX = 718;
