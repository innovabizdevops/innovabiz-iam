...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Genai Copilot","v":"9.038","t":"+14.2%","d":"up"},{"l":"Deploy Ativos","v":"5.620","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"56","t":"+1.6%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Copilot #001","Genai Copilot #002","7.660","6.956","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Copilot #002","Genai Copilot #003","4.729","2.882","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Copilot #003","Genai Copilot #004","8.846","7.896","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Copilot #004","Genai Copilot #005","4.407","3.647","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Copilot #005","Genai Copilot #001","7.106","1.904","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":943},{"label":"Mar","value":715},{"label":"Abr","value":825},{"label":"Mai","value":913},{"label":"Jun","value":799},{"label":"Jul","value":1070},{"label":"Ago","value":678},{"label":"Set","value":741},{"label":"Out","value":910},{"label":"Nov","value":770},{"label":"Dez","value":730}];
const MX = 1070;
