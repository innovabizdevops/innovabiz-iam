...
const KPIS = [{"l":"Total Energy Mgmt","v":"7.141","t":"-0.8%","d":"down"},{"l":"Consumption Ativos","v":"5.715","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"75","t":"+16.5%","d":"up"}];
const COLS = ["ID","Consumption","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt #001","Energy Mgmt #002","3.775","5.496","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt #002","Energy Mgmt #003","917","4.277","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt #003","Energy Mgmt #004","3.485","3.907","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt #004","Energy Mgmt #005","6.449","147","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt #005","Energy Mgmt #001","5.782","1.026","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":727},{"label":"Mar","value":553},{"label":"Abr","value":409},{"label":"Mai","value":626},{"label":"Jun","value":629},{"label":"Jul","value":453},{"label":"Ago","value":594},{"label":"Set","value":647},{"label":"Out","value":687},{"label":"Nov","value":462},{"label":"Dez","value":468}];
const MX = 794;
