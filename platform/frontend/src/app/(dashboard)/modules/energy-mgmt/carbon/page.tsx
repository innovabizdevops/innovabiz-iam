...
const PAGE = "Carbon Track";
const KPIS = [{"l":"Total Energy Mgmt","v":"1.584","t":"+7.6%","d":"up"},{"l":"Carbon Track Ativos","v":"4.875","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"66.7%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"71","t":"+3.5%","d":"up"}];
const COLS = ["ID","Carbon Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt #001","Energy Mgmt #002","7.953","5.415","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt #002","Energy Mgmt #003","4.773","1.943","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt #003","Energy Mgmt #004","1.326","2.668","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt #004","Energy Mgmt #005","6.227","198","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt #005","Energy Mgmt #001","5.221","6.834","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":751},{"label":"Mar","value":975},{"label":"Abr","value":852},{"label":"Mai","value":1050},{"label":"Jun","value":1061},{"label":"Jul","value":1062},{"label":"Ago","value":778},{"label":"Set","value":756},{"label":"Out","value":1002},{"label":"Nov","value":815},{"label":"Dez","value":853}];
const MX = 1062;
