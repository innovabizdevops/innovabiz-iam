...
const PAGE = "ISO 50001";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.448","t":"-2.8%","d":"down"},{"l":"NC Abertas","v":"6.896","t":"+5.3%","d":"up"},{"l":"Conformidade (%)","v":"66.5%","t":"+12.0%","d":"up"},{"l":"CAPAs Pendentes","v":"8.900","t":"-5.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.704","99.4%","139","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.315","70.3%","6.427","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.253","85.1%","6.579","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.232","86.6%","7.002","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","105","75.1%","8.432","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":770},{"label":"Mar","value":431},{"label":"Abr","value":635},{"label":"Mai","value":595},{"label":"Jun","value":757},{"label":"Jul","value":596},{"label":"Ago","value":739},{"label":"Set","value":702},{"label":"Out","value":498},{"label":"Nov","value":518},{"label":"Dez","value":540}];
const MX = 770;
