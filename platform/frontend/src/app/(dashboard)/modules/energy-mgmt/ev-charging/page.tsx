...
const KPIS = [{"l":"Total Energy Mgmt","v":"7.583","t":"+4.0%","d":"up"},{"l":"EV Charging Ativos","v":"9.020","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"77.0%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+0.3%","d":"up"}];
const COLS = ["ID","EV Charging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt #001","Energy Mgmt #002","224","1.211","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt #002","Energy Mgmt #003","5.195","8.399","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt #003","Energy Mgmt #004","1.046","4.994","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt #004","Energy Mgmt #005","2.195","5.180","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt #005","Energy Mgmt #001","1.634","290","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":549},{"label":"Mar","value":906},{"label":"Abr","value":531},{"label":"Mai","value":730},{"label":"Jun","value":551},{"label":"Jul","value":731},{"label":"Ago","value":725},{"label":"Set","value":680},{"label":"Out","value":643},{"label":"Nov","value":793},{"label":"Dez","value":803}];
const MX = 906;
