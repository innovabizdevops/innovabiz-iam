...
const PAGE = "Peak Shaving";
const KPIS = [{"l":"Total Energy Mgmt","v":"4.516","t":"+9.5%","d":"up"},{"l":"Peak Shaving Ativos","v":"6.812","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"93","t":"+13.1%","d":"up"}];
const COLS = ["ID","Peak Shaving","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt #001","Energy Mgmt #002","8.924","7.858","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt #002","Energy Mgmt #003","5.298","2.608","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt #003","Energy Mgmt #004","6.192","4.593","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt #004","Energy Mgmt #005","3.435","4.919","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt #005","Energy Mgmt #001","4.944","8.021","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":750},{"label":"Mar","value":864},{"label":"Abr","value":788},{"label":"Mai","value":631},{"label":"Jun","value":827},{"label":"Jul","value":742},{"label":"Ago","value":708},{"label":"Set","value":926},{"label":"Out","value":772},{"label":"Nov","value":868},{"label":"Dez","value":718}];
const MX = 926;
