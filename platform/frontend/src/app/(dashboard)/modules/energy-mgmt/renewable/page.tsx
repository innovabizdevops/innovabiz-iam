...
const PAGE = "Renewable Mix";
const KPIS = [{"l":"Total Energy Mgmt","v":"8.208","t":"-5.4%","d":"down"},{"l":"Renewable Mix Ativos","v":"4.399","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+14.9%","d":"up"}];
const COLS = ["ID","Renewable Mix","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt #001","Energy Mgmt #002","199","6.173","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt #002","Energy Mgmt #003","8.218","4.807","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt #003","Energy Mgmt #004","2.502","6.719","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt #004","Energy Mgmt #005","740","6.724","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt #005","Energy Mgmt #001","6.306","3.101","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":871},{"label":"Mar","value":727},{"label":"Abr","value":869},{"label":"Mai","value":757},{"label":"Jun","value":865},{"label":"Jul","value":969},{"label":"Ago","value":729},{"label":"Set","value":922},{"label":"Out","value":976},{"label":"Nov","value":624},{"label":"Dez","value":686}];
const MX = 976;
