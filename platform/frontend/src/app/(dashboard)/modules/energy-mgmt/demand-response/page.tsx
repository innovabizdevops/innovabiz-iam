...
const KPIS = [{"l":"Total Energy Mgmt","v":"8.275","t":"+9.0%","d":"up"},{"l":"Demand Response Ativos","v":"5.803","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.8%","d":"down"}];
const COLS = ["ID","Demand Response","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Mgmt #001","Energy Mgmt #002","1.895","887","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Mgmt #002","Energy Mgmt #003","7.350","2.936","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Mgmt #003","Energy Mgmt #004","2.287","3.675","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Mgmt #004","Energy Mgmt #005","3.479","1.898","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Mgmt #005","Energy Mgmt #001","1.129","6.875","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":751},{"label":"Mar","value":413},{"label":"Abr","value":477},{"label":"Mai","value":551},{"label":"Jun","value":599},{"label":"Jul","value":447},{"label":"Ago","value":588},{"label":"Set","value":720},{"label":"Out","value":504},{"label":"Nov","value":550},{"label":"Dez","value":620}];
const MX = 751;
