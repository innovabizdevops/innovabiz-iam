...
const PAGE = "Recycling Rates";
const KPIS = [{"l":"Total Waste Recycling","v":"6.360","t":"+8.4%","d":"up"},{"l":"Recycling Rates Ativos","v":"5.336","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"83","t":"+2.1%","d":"up"}];
const COLS = ["ID","Recycling Rates","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Recycling #001","Waste Recycling #002","1.201","7.952","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Recycling #002","Waste Recycling #003","1.007","2.341","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Recycling #003","Waste Recycling #004","1.269","1.855","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Recycling #004","Waste Recycling #005","2.462","3.236","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Recycling #005","Waste Recycling #001","3.901","3.729","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":872},{"label":"Mar","value":727},{"label":"Abr","value":877},{"label":"Mai","value":1093},{"label":"Jun","value":1049},{"label":"Jul","value":909},{"label":"Ago","value":846},{"label":"Set","value":775},{"label":"Out","value":1001},{"label":"Nov","value":905},{"label":"Dez","value":807}];
const MX = 1093;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>Chart</span></h1>
                </div>
