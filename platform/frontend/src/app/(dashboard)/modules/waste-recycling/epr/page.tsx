...
const PAGE = "EPR Management";
const KPIS = [{"l":"Projetos Melhoria","v":"7.833","t":"+6.4%","d":"up"},{"l":"Savings (€)","v":"€88167","t":"+14.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.5%","t":"+7.5%","d":"up"},{"l":"Ciclos PDCA","v":"2.682","t":"+2.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.273","€ 840.05","1.756","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.358","€ 42811.84","6.882","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.554","€ 41457.61","4.429","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.695","€ 21040.01","7.630","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.964","€ 31928.86","1.939","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":766},{"label":"Mar","value":656},{"label":"Abr","value":689},{"label":"Mai","value":752},{"label":"Jun","value":394},{"label":"Jul","value":614},{"label":"Ago","value":635},{"label":"Set","value":675},{"label":"Out","value":620},{"label":"Nov","value":465},{"label":"Dez","value":726}];
const MX = 766;
