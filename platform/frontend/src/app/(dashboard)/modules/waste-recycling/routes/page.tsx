...
const PAGE = "Collection Routes";
const KPIS = [{"l":"Total Waste Recycling","v":"337","t":"-4.0%","d":"down"},{"l":"Collection Routes Ativos","v":"7.189","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"89.2%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"61","t":"-6.0%","d":"down"}];
const COLS = ["ID","Collection Routes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Recycling #001","Waste Recycling #002","2.277","5.014","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Recycling #002","Waste Recycling #003","4.312","181","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Recycling #003","Waste Recycling #004","7.292","8.488","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Recycling #004","Waste Recycling #005","3.511","7.054","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Recycling #005","Waste Recycling #001","3.953","7.337","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":708},{"label":"Mar","value":854},{"label":"Abr","value":684},{"label":"Mai","value":956},{"label":"Jun","value":909},{"label":"Jul","value":835},{"label":"Ago","value":659},{"label":"Set","value":927},{"label":"Out","value":906},{"label":"Nov","value":742},{"label":"Dez","value":776}];
const MX = 956;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>GIS</span></h1>
                </div>
