...
const PAGE = "Hazardous Waste";
const KPIS = [{"l":"Total Waste Recycling","v":"6.057","t":"+13.7%","d":"up"},{"l":"Hazardous Waste Ativos","v":"1.392","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"85","t":"+8.6%","d":"up"}];
const COLS = ["ID","Hazardous Waste","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Recycling #001","Waste Recycling #002","8.616","4.141","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Recycling #002","Waste Recycling #003","1.354","3.506","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Recycling #003","Waste Recycling #004","281","1.461","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Recycling #004","Waste Recycling #005","2.625","2.821","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Recycling #005","Waste Recycling #001","8.650","1.863","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":262},{"label":"Mar","value":299},{"label":"Abr","value":367},{"label":"Mai","value":617},{"label":"Jun","value":419},{"label":"Jul","value":468},{"label":"Ago","value":540},{"label":"Set","value":244},{"label":"Out","value":303},{"label":"Nov","value":515},{"label":"Dez","value":365}];
const MX = 617;
