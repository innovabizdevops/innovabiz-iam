...
const ACCENT = "#15803d";
const MODULE = "Waste & Recycling";
const PAGE = "Circular Economy KPIs";
const KPIS = [{"l":"Total Waste Recycling","v":"5.300","t":"-1.8%","d":"down"},{"l":"Circular Economy KPIs Ativos","v":"8.456","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+8.2%","d":"up"}];
const COLS = ["ID","Circular Economy KPIs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Recycling #001","Waste Recycling #002","3.321","280","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Recycling #002","Waste Recycling #003","1.172","4.137","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Recycling #003","Waste Recycling #004","705","8.069","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Recycling #004","Waste Recycling #005","646","8.288","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Recycling #005","Waste Recycling #001","657","1.682","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":545},{"label":"Mar","value":465},{"label":"Abr","value":275},{"label":"Mai","value":592},{"label":"Jun","value":462},{"label":"Jul","value":470},{"label":"Ago","value":257},{"label":"Set","value":563},{"label":"Out","value":571},{"label":"Nov","value":312},{"label":"Dez","value":606}];
const MX = 606;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>ESG</span></h1>
                </div>
