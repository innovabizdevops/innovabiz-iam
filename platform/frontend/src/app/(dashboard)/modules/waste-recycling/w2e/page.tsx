...
const PAGE = "Waste-to-Energy";
const KPIS = [{"l":"Total Waste Recycling","v":"2.059","t":"-0.2%","d":"down"},{"l":"Waste To Energy Ativos","v":"4.707","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+2.8%","d":"up"}];
const COLS = ["ID","Waste To Energy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Recycling #001","Waste Recycling #002","6.214","3.696","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Recycling #002","Waste Recycling #003","5.018","6.616","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Recycling #003","Waste Recycling #004","1.999","1.677","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Recycling #004","Waste Recycling #005","1.452","7.142","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Recycling #005","Waste Recycling #001","3.344","8.927","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":430},{"label":"Mar","value":514},{"label":"Abr","value":651},{"label":"Mai","value":572},{"label":"Jun","value":599},{"label":"Jul","value":556},{"label":"Ago","value":715},{"label":"Set","value":488},{"label":"Out","value":549},{"label":"Nov","value":513},{"label":"Dez","value":542}];
const MX = 715;
...
export default function W2ePage() {
    return (
