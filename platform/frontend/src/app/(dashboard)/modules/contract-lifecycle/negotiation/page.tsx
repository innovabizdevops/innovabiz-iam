...
const PAGE = "Negotiation";
const KPIS = [{"l":"Contratos Ativos","v":"4.803","t":"+8.1%","d":"up"},{"l":"Valor Total (€M)","v":"€28.2M","t":"+10.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"2.843","t":"-5.8%","d":"down"},{"l":"Obrigações Pendentes","v":"827","t":"-2.1%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 37483.85","2026-01-28","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 8172.98","2026-03-25","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 25846.28","2026-02-04","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 22023.47","2026-02-08","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 17846.90","2026-03-26","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":669},{"label":"Mar","value":936},{"label":"Abr","value":722},{"label":"Mai","value":716},{"label":"Jun","value":583},{"label":"Jul","value":688},{"label":"Ago","value":557},{"label":"Set","value":934},{"label":"Out","value":549},{"label":"Nov","value":820},{"label":"Dez","value":734}];
const MX = 936;
