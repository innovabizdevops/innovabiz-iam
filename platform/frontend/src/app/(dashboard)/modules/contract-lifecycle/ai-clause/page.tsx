...
const ACCENT = "#65a30d";
const MODULE = "Contract Lifecycle";
const PAGE = "AI Clause Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.096","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"3556","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"7.525","t":"+0.8%","d":"up"},{"l":"Utilizadores Analytics","v":"3.855","t":"-3.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1365","2026-03-25","3.848","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3888","2026-02-12","3.443","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2946","2026-02-07","2.967","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4624","2026-02-08","6.960","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1159","2026-02-01","8.003","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":852},{"label":"Mar","value":629},{"label":"Abr","value":829},{"label":"Mai","value":842},{"label":"Jun","value":621},{"label":"Jul","value":786},{"label":"Ago","value":700},{"label":"Set","value":564},{"label":"Out","value":546},{"label":"Nov","value":824},{"label":"Dez","value":880}];
const MX = 880;
...
export default function AiClausePage() {
    return (
