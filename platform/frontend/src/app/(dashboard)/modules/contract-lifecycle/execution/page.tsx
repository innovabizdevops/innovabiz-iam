...
const KPIS = [{"l":"Contratos Ativos","v":"7.801","t":"+4.9%","d":"up"},{"l":"Valor Total (€M)","v":"€15.0M","t":"+10.8%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.337","t":"+7.4%","d":"up"},{"l":"Obrigações Pendentes","v":"2.273","t":"-5.9%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 9288.01","2026-01-26","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 12324.36","2026-02-19","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 12121.93","2026-02-24","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 17978.91","2026-03-19","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 8408.02","2026-02-12","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":478},{"label":"Mar","value":813},{"label":"Abr","value":560},{"label":"Mai","value":430},{"label":"Jun","value":593},{"label":"Jul","value":819},{"label":"Ago","value":484},{"label":"Set","value":581},{"label":"Out","value":451},{"label":"Nov","value":738},{"label":"Dez","value":793}];
const MX = 819;
