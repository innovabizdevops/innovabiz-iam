...
const PAGE = "Obligation Tracking";
const KPIS = [{"l":"Contratos Ativos","v":"5.891","t":"-0.9%","d":"down"},{"l":"Valor Total (€M)","v":"€26.6M","t":"+12.4%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.418","t":"-1.1%","d":"down"},{"l":"Obrigações Pendentes","v":"4.415","t":"+6.0%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 8719.08","2026-03-23","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 20001.68","2026-02-06","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 44154.78","2026-01-02","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 18293.41","2026-03-11","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 34453.26","2026-03-14","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":612},{"label":"Mar","value":628},{"label":"Abr","value":567},{"label":"Mai","value":435},{"label":"Jun","value":494},{"label":"Jul","value":591},{"label":"Ago","value":472},{"label":"Set","value":440},{"label":"Out","value":333},{"label":"Nov","value":365},{"label":"Dez","value":504}];
const MX = 628;
