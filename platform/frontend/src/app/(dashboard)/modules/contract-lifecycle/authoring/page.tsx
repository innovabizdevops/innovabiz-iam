...
const PAGE = "Authoring";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.322","t":"-1.7%","d":"down"},{"l":"Sessões/Dia","v":"561","t":"+3.8%","d":"up"},{"l":"MFA Adoção (%)","v":"81.3%","t":"+13.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.905","t":"-5.2%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.924","7.275","6.112","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.483","9.042","1.558","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.626","4.929","1.344","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.317","6.672","8.323","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.088","458","7.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":633},{"label":"Mar","value":557},{"label":"Abr","value":654},{"label":"Mai","value":599},{"label":"Jun","value":566},{"label":"Jul","value":564},{"label":"Ago","value":752},{"label":"Set","value":663},{"label":"Out","value":707},{"label":"Nov","value":445},{"label":"Dez","value":497}];
const MX = 752;
