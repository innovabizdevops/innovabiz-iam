...
const PAGE = "Auto-Renewal AI";
const KPIS = [{"l":"Contratos Ativos","v":"8.204","t":"+8.5%","d":"up"},{"l":"Valor Total (€M)","v":"€17.7M","t":"-5.6%","d":"down"},{"l":"Renovações Próx. 30d","v":"7.073","t":"-3.9%","d":"down"},{"l":"Obrigações Pendentes","v":"2.635","t":"+6.6%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 46478.39","2026-01-17","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 22624.43","2026-02-21","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 27160.04","2026-01-07","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 34880.90","2026-01-16","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 38523.35","2026-01-03","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":697},{"label":"Mar","value":532},{"label":"Abr","value":594},{"label":"Mai","value":890},{"label":"Jun","value":657},{"label":"Jul","value":821},{"label":"Ago","value":765},{"label":"Set","value":775},{"label":"Out","value":584},{"label":"Nov","value":820},{"label":"Dez","value":758}];
const MX = 890;
