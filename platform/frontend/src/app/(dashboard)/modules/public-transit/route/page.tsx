...
const KPIS = [{"l":"Total Public Transit","v":"8.200","t":"-5.6%","d":"down"},{"l":"Route Plan Ativos","v":"6.951","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"85","t":"-0.8%","d":"down"}];
const COLS = ["ID","Route Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Transit #001","Public Transit #002","7.393","5.464","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Public Transit #002","Public Transit #003","4.259","7.803","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Transit #003","Public Transit #004","4.947","4.751","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Public Transit #004","Public Transit #005","2.307","4.438","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Transit #005","Public Transit #001","8.536","1.436","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":796},{"label":"Mar","value":694},{"label":"Abr","value":556},{"label":"Mai","value":814},{"label":"Jun","value":733},{"label":"Jul","value":705},{"label":"Ago","value":586},{"label":"Set","value":802},{"label":"Out","value":668},{"label":"Nov","value":560},{"label":"Dez","value":679}];
const MX = 814;
