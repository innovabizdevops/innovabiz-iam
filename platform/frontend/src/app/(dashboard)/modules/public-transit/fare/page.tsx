...
const PAGE = "Fare System";
const KPIS = [{"l":"Total Public Transit","v":"5.746","t":"-0.6%","d":"down"},{"l":"Fare System Ativos","v":"6.561","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"88","t":"-3.5%","d":"down"}];
const COLS = ["ID","Fare System","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Transit #001","Public Transit #002","5.769","7.436","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Public Transit #002","Public Transit #003","3.843","1.178","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Transit #003","Public Transit #004","3.138","4.856","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Public Transit #004","Public Transit #005","2.544","1.177","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Transit #005","Public Transit #001","5.276","1.753","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":470},{"label":"Mar","value":694},{"label":"Abr","value":604},{"label":"Mai","value":666},{"label":"Jun","value":467},{"label":"Jul","value":615},{"label":"Ago","value":621},{"label":"Set","value":391},{"label":"Out","value":644},{"label":"Nov","value":513},{"label":"Dez","value":609}];
const MX = 694;
