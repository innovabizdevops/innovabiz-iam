...
const ACCENT = "#1e40af";
const MODULE = "Public Transit";
const PAGE = "Schedule Mgmt";
const KPIS = [{"l":"Total Public Transit","v":"2.875","t":"+2.5%","d":"up"},{"l":"Schedule Mgmt Ativos","v":"6.533","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+7.3%","d":"up"}];
const COLS = ["ID","Schedule Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Transit #001","Public Transit #002","1.078","3.270","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Public Transit #002","Public Transit #003","3.914","2.826","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Transit #003","Public Transit #004","8.964","7.568","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Public Transit #004","Public Transit #005","1.335","4.320","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Transit #005","Public Transit #001","2.733","6.673","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":1028},{"label":"Mar","value":735},{"label":"Abr","value":1017},{"label":"Mai","value":988},{"label":"Jun","value":696},{"label":"Jul","value":666},{"label":"Ago","value":760},{"label":"Set","value":673},{"label":"Out","value":930},{"label":"Nov","value":715},{"label":"Dez","value":953}];
const MX = 1028;
