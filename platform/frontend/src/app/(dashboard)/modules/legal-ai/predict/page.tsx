...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"6.027","t":"+5.0%","d":"up"},{"l":"Chamadas/Hora","v":"1532","t":"-2.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.5%","t":"+9.3%","d":"up"},{"l":"Latência Média (ms)","v":"110ms","t":"+14.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.446","6.970","89.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.325","983","95.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.096","6.742","74.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.184","4.245","91.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.886","2.124","86.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":589},{"label":"Mar","value":447},{"label":"Abr","value":268},{"label":"Mai","value":605},{"label":"Jun","value":540},{"label":"Jul","value":345},{"label":"Ago","value":531},{"label":"Set","value":252},{"label":"Out","value":273},{"label":"Nov","value":306},{"label":"Dez","value":488}];
const MX = 605;
