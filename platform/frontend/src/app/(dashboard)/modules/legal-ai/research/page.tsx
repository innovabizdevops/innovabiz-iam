...
const ACCENT = "#dc2626";
const MODULE = "Legal AI Platform";
const PAGE = "Research AI";
const KPIS = [{"l":"Ideias Submetidas","v":"591","t":"+0.5%","d":"up"},{"l":"Patentes (YTD)","v":"792","t":"+16.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"704","t":"+6.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€12.8M","t":"+5.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.338","91.3%","119","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.344","95.8%","8.232","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.297","85.0%","4.518","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.107","82.9%","3.395","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.583","77.4%","3.997","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":917},{"label":"Mar","value":728},{"label":"Abr","value":813},{"label":"Mai","value":943},{"label":"Jun","value":756},{"label":"Jul","value":905},{"label":"Ago","value":679},{"label":"Set","value":738},{"label":"Out","value":743},{"label":"Nov","value":949},{"label":"Dez","value":987}];
const MX = 1012;
