...
const PAGE = "Assess";
const KPIS = [{"l":"Total Disability Service","v":"1.783","t":"+6.9%","d":"up"},{"l":"Assess Ativos","v":"7.794","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"87.2%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"55","t":"+3.4%","d":"up"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Service #001","Disability Service #002","183","7.862","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Service #002","Disability Service #003","447","6.581","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Service #003","Disability Service #004","2.821","7.898","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Service #004","Disability Service #005","1.243","4.627","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Service #005","Disability Service #001","6.194","5.643","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":286},{"label":"Fev","value":209},{"label":"Mar","value":267},{"label":"Abr","value":446},{"label":"Mai","value":395},{"label":"Jun","value":228},{"label":"Jul","value":536},{"label":"Ago","value":572},{"label":"Set","value":442},{"label":"Out","value":481},{"label":"Nov","value":511},{"label":"Dez","value":414}];
const MX = 572;
