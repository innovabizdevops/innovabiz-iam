...
const PAGE = "Service";
const KPIS = [{"l":"Total Disability Service","v":"3.943","t":"+14.4%","d":"up"},{"l":"Service Ativos","v":"8.270","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+8.6%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Service #001","Disability Service #002","3.542","4.017","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Service #002","Disability Service #003","1.197","6.589","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Service #003","Disability Service #004","5.501","5.911","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Service #004","Disability Service #005","4.390","7.917","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Service #005","Disability Service #001","5.804","8.399","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":711},{"label":"Mar","value":784},{"label":"Abr","value":753},{"label":"Mai","value":707},{"label":"Jun","value":491},{"label":"Jul","value":471},{"label":"Ago","value":765},{"label":"Set","value":721},{"label":"Out","value":502},{"label":"Nov","value":477},{"label":"Dez","value":727}];
const MX = 784;
