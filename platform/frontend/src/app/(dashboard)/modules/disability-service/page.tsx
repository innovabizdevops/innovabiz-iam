...
const KPIS = [
    { label: "Total Registos", value: "9747", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2349", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€272K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "432728747", cells: ["DIS-9747", "Disability Services Item 1", "4/12/2026", "€28 847"], status: "active" as const },
    { id: "432732318", cells: ["DIS-4318", "Disability Services Item 2", "19/7/2026", "€32 418"], status: "pending" as const },
    { id: "432735889", cells: ["DIS-7889", "Disability Services Item 3", "6/2/2026", "€35 989"], status: "completed" as const },
    { id: "432739460", cells: ["DIS-2460", "Disability Services Item 4", "21/9/2026", "€39 560"], status: "warning" as const },
    { id: "432743031", cells: ["DIS-6031", "Disability Services Item 5", "8/4/2026", "€43 131"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Disability Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Disability Services</p>
                    </div>
                </div>
