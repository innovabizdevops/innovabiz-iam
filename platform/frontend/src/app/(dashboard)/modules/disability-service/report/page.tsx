...
const PAGE = "Report";
const KPIS = [{"l":"Total Disability Service","v":"591","t":"+5.6%","d":"up"},{"l":"Report Ativos","v":"6.162","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"66","t":"-5.6%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Service #001","Disability Service #002","8.401","5.829","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Service #002","Disability Service #003","8.712","8.784","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Service #003","Disability Service #004","6.520","7.247","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Service #004","Disability Service #005","125","7.564","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Service #005","Disability Service #001","2.937","3.749","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":718},{"label":"Mar","value":806},{"label":"Abr","value":733},{"label":"Mai","value":572},{"label":"Jun","value":539},{"label":"Jul","value":761},{"label":"Ago","value":567},{"label":"Set","value":517},{"label":"Out","value":690},{"label":"Nov","value":541},{"label":"Dez","value":537}];
const MX = 806;
