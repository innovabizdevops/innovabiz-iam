...
const ACCENT = "#6366f1";
const MODULE = "Disability Services";
const PAGE = "Equipment";
const KPIS = [{"l":"Total Disability Service","v":"949","t":"+11.2%","d":"up"},{"l":"Equipment Ativos","v":"2.113","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+7.2%","d":"up"}];
const COLS = ["ID","Equipment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Service #001","Disability Service #002","2.243","1.512","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Service #002","Disability Service #003","6.882","8.388","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Service #003","Disability Service #004","5.039","4.765","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Service #004","Disability Service #005","2.003","8.145","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Service #005","Disability Service #001","6.723","4.510","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":541},{"label":"Mar","value":398},{"label":"Abr","value":656},{"label":"Mai","value":576},{"label":"Jun","value":519},{"label":"Jul","value":512},{"label":"Ago","value":396},{"label":"Set","value":778},{"label":"Out","value":411},{"label":"Nov","value":784},{"label":"Dez","value":530}];
const MX = 784;
