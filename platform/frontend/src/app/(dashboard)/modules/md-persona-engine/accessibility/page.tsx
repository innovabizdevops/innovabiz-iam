...
const KPIS = [{"l":"Perfis Unificados","v":"7.793","t":"+1.8%","d":"up"},{"l":"Segmentos Ativos","v":"4.174","t":"-3.1%","d":"down"},{"l":"NPS Score","v":"78","t":"+12.2%","d":"up"},{"l":"Churn Previsto (%)","v":"78.9%","t":"+8.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.838","€ 27185.47","79.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","211","€ 30873.06","78.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.944","€ 4591.37","99.9%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.445","€ 16637.65","78.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.383","€ 5018.59","73.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":780},{"label":"Mar","value":885},{"label":"Abr","value":814},{"label":"Mai","value":884},{"label":"Jun","value":736},{"label":"Jul","value":656},{"label":"Ago","value":934},{"label":"Set","value":813},{"label":"Out","value":706},{"label":"Nov","value":881},{"label":"Dez","value":790}];
const MX = 934;
