...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Persona Engine";
const PAGE = "Personalize";
const KPIS = [{"l":"Perfis Unificados","v":"8.778","t":"+14.9%","d":"up"},{"l":"Segmentos Ativos","v":"1.045","t":"+9.1%","d":"up"},{"l":"NPS Score","v":"80","t":"+17.3%","d":"up"},{"l":"Churn Previsto (%)","v":"70.9%","t":"+16.4%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.428","€ 42519.29","86.5%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.159","€ 45383.30","88.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","252","€ 21740.35","90.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.122","€ 2283.34","70.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","7.754","€ 43176.15","72.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":618},{"label":"Mar","value":834},{"label":"Abr","value":917},{"label":"Mai","value":706},{"label":"Jun","value":569},{"label":"Jul","value":625},{"label":"Ago","value":741},{"label":"Set","value":898},{"label":"Out","value":610},{"label":"Nov","value":659},{"label":"Dez","value":911}];
const MX = 917;
