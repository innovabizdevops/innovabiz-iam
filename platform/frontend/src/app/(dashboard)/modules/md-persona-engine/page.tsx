...
/* ═══ MD: Multi-Persona Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "4672", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4454", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€80K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1882301472", cells: ["MD-6472", "MD: Multi-Persona Engine Item 1", "17/1/2026", "€1572"], status: "active" as const },
    { id: "1882305043", cells: ["MD-1043", "MD: Multi-Persona Engine Item 2", "4/8/2026", "€5143"], status: "pending" as const },
    { id: "1882308614", cells: ["MD-4614", "MD: Multi-Persona Engine Item 3", "19/3/2026", "€8714"], status: "completed" as const },
    { id: "1882312185", cells: ["MD-8185", "MD: Multi-Persona Engine Item 4", "6/10/2026", "€12 285"], status: "warning" as const },
    { id: "1882315756", cells: ["MD-2756", "MD: Multi-Persona Engine Item 5", "21/5/2026", "€15 856"], status: "active" as const },
];
...
export default function MdMultipersonaEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Persona Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Persona Engine</p>
                    </div>
                </div>
