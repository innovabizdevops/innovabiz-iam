...
const PAGE = "Client";
const KPIS = [{"l":"Total Pr Agency","v":"6.139","t":"+6.7%","d":"up"},{"l":"Client Ativos","v":"576","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"77","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pr Agency #001","Pr Agency #002","591","4.945","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pr Agency #002","Pr Agency #003","8.244","2.448","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Pr Agency #003","Pr Agency #004","3.326","3.890","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pr Agency #004","Pr Agency #005","7.595","3.321","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pr Agency #005","Pr Agency #001","273","2.101","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":544},{"label":"Mar","value":526},{"label":"Abr","value":596},{"label":"Mai","value":452},{"label":"Jun","value":500},{"label":"Jul","value":460},{"label":"Ago","value":339},{"label":"Set","value":449},{"label":"Out","value":394},{"label":"Nov","value":406},{"label":"Dez","value":573}];
const MX = 596;
