...
const KPIS = [{"l":"Total Pr Agency","v":"5.156","t":"+14.6%","d":"up"},{"l":"Placement Ativos","v":"1.457","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"62","t":"+16.5%","d":"up"}];
const COLS = ["ID","Placement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pr Agency #001","Pr Agency #002","8.226","7.245","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pr Agency #002","Pr Agency #003","1.116","2.299","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Pr Agency #003","Pr Agency #004","1.205","8.943","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Pr Agency #004","Pr Agency #005","2.061","8.725","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pr Agency #005","Pr Agency #001","7.209","3.959","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":567},{"label":"Mar","value":923},{"label":"Abr","value":869},{"label":"Mai","value":834},{"label":"Jun","value":635},{"label":"Jul","value":759},{"label":"Ago","value":841},{"label":"Set","value":740},{"label":"Out","value":798},{"label":"Nov","value":772},{"label":"Dez","value":893}];
const MX = 923;
