...
const ACCENT = "#6366f1";
const MODULE = "PR Agency";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Pr Agency","v":"1.668","t":"+3.3%","d":"up"},{"l":"Monitor Ativos","v":"2.926","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"76","t":"-0.5%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pr Agency #001","Pr Agency #002","5.556","2.976","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Pr Agency #002","Pr Agency #003","5.872","7.548","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Pr Agency #003","Pr Agency #004","917","5.257","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Pr Agency #004","Pr Agency #005","5.676","6.228","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pr Agency #005","Pr Agency #001","8.911","3.429","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":793},{"label":"Mar","value":538},{"label":"Abr","value":856},{"label":"Mai","value":636},{"label":"Jun","value":854},{"label":"Jul","value":641},{"label":"Ago","value":515},{"label":"Set","value":526},{"label":"Out","value":527},{"label":"Nov","value":516},{"label":"Dez","value":856}];
const MX = 856;
