...
const ACCENT = "#6366f1";
const MODULE = "Population Health";
const PAGE = "Risk Strat";
const KPIS = [{"l":"Riscos Identificados","v":"1.447","t":"+17.9%","d":"up"},{"l":"Mitigações Ativas","v":"817","t":"-3.2%","d":"down"},{"l":"Score Risco Geral","v":"94","t":"+17.0%","d":"up"},{"l":"Incidentes YTD","v":"8.483","t":"+14.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.004","376","2.909","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","390","3.895","3.864","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.509","7.504","537","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.735","6.140","1.790","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.793","8.139","1.239","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":540},{"label":"Mar","value":521},{"label":"Abr","value":729},{"label":"Mai","value":446},{"label":"Jun","value":738},{"label":"Jul","value":505},{"label":"Ago","value":731},{"label":"Set","value":815},{"label":"Out","value":773},{"label":"Nov","value":497},{"label":"Dez","value":481}];
const MX = 815;
