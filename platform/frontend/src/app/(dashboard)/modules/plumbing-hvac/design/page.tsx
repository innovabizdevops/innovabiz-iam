...
const ACCENT = "#6366f1";
const MODULE = "Plumbing & HVAC";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.735","t":"-6.0%","d":"down"},{"l":"Submissões/Dia","v":"4126","t":"-2.4%","d":"down"},{"l":"Documentos Gerados","v":"8.854","t":"+15.8%","d":"up"},{"l":"Templates","v":"4.914","t":"+13.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.997","2026-02-15","3.950","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.982","2026-01-13","4.915","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.749","2026-01-22","8.046","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.449","2026-02-12","7.208","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.973","2026-02-21","4.855","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":508},{"label":"Mar","value":724},{"label":"Abr","value":563},{"label":"Mai","value":813},{"label":"Jun","value":671},{"label":"Jul","value":518},{"label":"Ago","value":791},{"label":"Set","value":628},{"label":"Out","value":504},{"label":"Nov","value":515},{"label":"Dez","value":825}];
const MX = 825;
