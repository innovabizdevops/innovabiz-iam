...
const ACCENT = "#f43f5e";
const MODULE = "Design System Manager";
const PAGE = "Component";
const KPIS = [{"l":"Formulários Ativos","v":"7.594","t":"+4.1%","d":"up"},{"l":"Submissões/Dia","v":"3167","t":"+2.1%","d":"up"},{"l":"Documentos Gerados","v":"5.510","t":"+1.0%","d":"up"},{"l":"Templates","v":"7.179","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.935","2026-01-25","2.728","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.180","2026-03-02","8.298","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.424","2026-02-11","2.223","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.721","2026-03-03","6.088","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.418","2026-03-08","8.973","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":546},{"label":"Mar","value":594},{"label":"Abr","value":700},{"label":"Mai","value":788},{"label":"Jun","value":712},{"label":"Jul","value":614},{"label":"Ago","value":624},{"label":"Set","value":708},{"label":"Out","value":828},{"label":"Nov","value":554},{"label":"Dez","value":610}];
const MX = 828;
