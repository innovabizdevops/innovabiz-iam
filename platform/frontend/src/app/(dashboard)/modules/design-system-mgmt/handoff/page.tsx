...
const PAGE = "Handoff";
const KPIS = [{"l":"Formulários Ativos","v":"6.445","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"3879","t":"+12.2%","d":"up"},{"l":"Documentos Gerados","v":"4.575","t":"+1.2%","d":"up"},{"l":"Templates","v":"3.822","t":"+12.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.346","2026-03-11","6.025","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","755","2026-01-22","2.070","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.600","2026-01-04","5.389","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.885","2026-01-17","4.353","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.317","2026-02-13","352","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":224},{"label":"Fev","value":387},{"label":"Mar","value":327},{"label":"Abr","value":382},{"label":"Mai","value":536},{"label":"Jun","value":430},{"label":"Jul","value":577},{"label":"Ago","value":574},{"label":"Set","value":421},{"label":"Out","value":398},{"label":"Nov","value":261},{"label":"Dez","value":259}];
const MX = 577;
