...
/* ═══ Design System Manager — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "893", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2696", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€328K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "195030793", cells: ["DES-1793", "Design System Manager Item 1", "14/2/2026", "€30 893"], status: "active" as const },
    { id: "195034364", cells: ["DES-5364", "Design System Manager Item 2", "1/9/2026", "€34 464"], status: "pending" as const },
    { id: "195037935", cells: ["DES-8935", "Design System Manager Item 3", "16/4/2026", "€38 035"], status: "completed" as const },
    { id: "195041506", cells: ["DES-3506", "Design System Manager Item 4", "3/11/2026", "€41 606"], status: "warning" as const },
    { id: "195045077", cells: ["DES-7077", "Design System Manager Item 5", "18/6/2026", "€45 177"], status: "active" as const },
];
...
export default function DesignSystemManagerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Design System Manager</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Design System Manager</p>
                    </div>
                </div>
