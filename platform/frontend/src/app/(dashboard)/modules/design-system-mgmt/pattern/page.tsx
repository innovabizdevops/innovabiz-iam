...
const PAGE = "Pattern";
const KPIS = [{"l":"Formulários Ativos","v":"472","t":"+9.5%","d":"up"},{"l":"Submissões/Dia","v":"3953","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"7.592","t":"+3.5%","d":"up"},{"l":"Templates","v":"4.932","t":"+9.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.564","2026-03-16","5.366","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.721","2026-03-18","7.827","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.477","2026-03-13","2.257","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.535","2026-03-26","2.555","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.938","2026-01-11","3.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":636},{"label":"Mar","value":489},{"label":"Abr","value":605},{"label":"Mai","value":729},{"label":"Jun","value":527},{"label":"Jul","value":622},{"label":"Ago","value":709},{"label":"Set","value":546},{"label":"Out","value":743},{"label":"Nov","value":718},{"label":"Dez","value":638}];
const MX = 743;
