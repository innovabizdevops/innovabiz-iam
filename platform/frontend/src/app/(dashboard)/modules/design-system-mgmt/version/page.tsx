...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"5.640","t":"+7.5%","d":"up"},{"l":"Submissões/Dia","v":"1938","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"6.241","t":"+5.0%","d":"up"},{"l":"Templates","v":"6.548","t":"+0.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.163","2026-03-04","3.485","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.652","2026-03-04","8.082","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.962","2026-02-08","7.905","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.049","2026-01-12","248","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.346","2026-02-12","8.739","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":260},{"label":"Mar","value":458},{"label":"Abr","value":404},{"label":"Mai","value":513},{"label":"Jun","value":414},{"label":"Jul","value":346},{"label":"Ago","value":485},{"label":"Set","value":479},{"label":"Out","value":320},{"label":"Nov","value":621},{"label":"Dez","value":499}];
const MX = 621;
