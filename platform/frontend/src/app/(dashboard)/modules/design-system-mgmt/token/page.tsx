...
const PAGE = "Token";
const KPIS = [{"l":"Formulários Ativos","v":"7.249","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"866","t":"-4.1%","d":"down"},{"l":"Documentos Gerados","v":"2.356","t":"+15.0%","d":"up"},{"l":"Templates","v":"5.841","t":"+15.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.778","2026-01-10","7.924","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.170","2026-02-25","2.294","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","718","2026-01-03","873","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.148","2026-01-21","5.483","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.351","2026-03-22","3.520","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":843},{"label":"Mar","value":676},{"label":"Abr","value":573},{"label":"Mai","value":810},{"label":"Jun","value":682},{"label":"Jul","value":695},{"label":"Ago","value":517},{"label":"Set","value":760},{"label":"Out","value":749},{"label":"Nov","value":838},{"label":"Dez","value":566}];
const MX = 882;
