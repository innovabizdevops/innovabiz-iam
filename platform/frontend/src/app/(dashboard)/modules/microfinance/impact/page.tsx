...
const PAGE = "Impact Invest";
const KPIS = [{"l":"Projetos Sociais","v":"4.836","t":"+7.1%","d":"up"},{"l":"Beneficiários","v":"5.717","t":"+17.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€94067","t":"+16.1%","d":"up"},{"l":"Score Impacto","v":"94","t":"+4.9%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.577","€ 16171.61","4.517","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.453","€ 42590.30","3.419","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.298","€ 2629.01","8.365","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.549","€ 5535.00","5.720","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","380","€ 46285.26","5.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":641},{"label":"Mar","value":890},{"label":"Abr","value":580},{"label":"Mai","value":941},{"label":"Jun","value":826},{"label":"Jul","value":904},{"label":"Ago","value":603},{"label":"Set","value":734},{"label":"Out","value":565},{"label":"Nov","value":596},{"label":"Dez","value":860}];
const MX = 941;
