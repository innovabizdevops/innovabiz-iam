...
const PAGE = "Savings";
const KPIS = [{"l":"Total Microfinance","v":"8.807","t":"+11.3%","d":"up"},{"l":"Savings Ativos","v":"€30324","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"75.2%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+0.7%","d":"up"}];
const COLS = ["ID","Savings","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Microfinance #001","€ 19505.49","4.534","8.561","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Microfinance #002","€ 33339.68","2.925","2.100","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Microfinance #003","€ 11749.46","5.298","3.281","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Microfinance #004","€ 21993.66","3.112","2.821","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Microfinance #005","€ 41745.64","824","2.108","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":840},{"label":"Mar","value":772},{"label":"Abr","value":874},{"label":"Mai","value":815},{"label":"Jun","value":866},{"label":"Jul","value":880},{"label":"Ago","value":980},{"label":"Set","value":854},{"label":"Out","value":913},{"label":"Nov","value":1050},{"label":"Dez","value":817}];
const MX = 1050;
