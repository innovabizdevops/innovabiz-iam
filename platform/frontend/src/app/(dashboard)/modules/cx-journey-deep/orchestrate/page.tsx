...
const ACCENT = "#be185d";
const MODULE = "CX Journey Orchestration Deep";
const PAGE = "Orchestrate";
const KPIS = [{"l":"Perfis Unificados","v":"4.527","t":"-3.6%","d":"down"},{"l":"Segmentos Ativos","v":"4.171","t":"+16.1%","d":"up"},{"l":"NPS Score","v":"76","t":"+10.2%","d":"up"},{"l":"Churn Previsto (%)","v":"77.5%","t":"+0.4%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","5.264","€ 31833.93","86.1%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","5.198","€ 30461.60","97.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.354","€ 39439.13","88.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.394","€ 675.00","72.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.443","€ 46172.51","96.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":720},{"label":"Mar","value":767},{"label":"Abr","value":1012},{"label":"Mai","value":977},{"label":"Jun","value":901},{"label":"Jul","value":714},{"label":"Ago","value":705},{"label":"Set","value":1091},{"label":"Out","value":740},{"label":"Nov","value":1035},{"label":"Dez","value":739}];
const MX = 1091;
