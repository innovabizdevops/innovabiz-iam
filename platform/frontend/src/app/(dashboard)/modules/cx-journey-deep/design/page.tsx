...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.252","t":"+12.1%","d":"up"},{"l":"Submissões/Dia","v":"123","t":"+10.2%","d":"up"},{"l":"Documentos Gerados","v":"7.439","t":"-4.8%","d":"down"},{"l":"Templates","v":"7.694","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.653","2026-03-19","6.366","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.898","2026-02-03","4.733","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.825","2026-03-24","7.747","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.819","2026-03-16","4.957","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.066","2026-03-03","5.061","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":481},{"label":"Mar","value":404},{"label":"Abr","value":290},{"label":"Mai","value":311},{"label":"Jun","value":253},{"label":"Jul","value":544},{"label":"Ago","value":596},{"label":"Set","value":499},{"label":"Out","value":475},{"label":"Nov","value":437},{"label":"Dez","value":400}];
const MX = 596;
