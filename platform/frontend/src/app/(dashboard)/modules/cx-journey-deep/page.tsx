...
/* ═══ CX Journey Orchestration Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "5644", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "205", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€199K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1161750744", cells: ["CX-4744", "CX Journey Orchestration Deep Item 1", "1/1/2026", "€844"], status: "active" as const },
    { id: "1161754315", cells: ["CX-8315", "CX Journey Orchestration Deep Item 2", "16/8/2026", "€4415"], status: "pending" as const },
    { id: "1161757886", cells: ["CX-2886", "CX Journey Orchestration Deep Item 3", "3/3/2026", "€7986"], status: "completed" as const },
    { id: "1161761457", cells: ["CX-6457", "CX Journey Orchestration Deep Item 4", "18/10/2026", "€11 557"], status: "warning" as const },
    { id: "1161765028", cells: ["CX-1028", "CX Journey Orchestration Deep Item 5", "5/5/2026", "€15 128"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 44 }, { label: "Fev", value: 53 }, { label: "Mar", value: 62 }, { label: "Abr", value: 71 }, { label: "Mai", value: 80 }, { label: "Jun", value: 89 }];
...
export default function CxJourneyOrchestrationDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CX Journey Orchestration Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CX Journey Orchestration Deep</p>
                    </div>
                </div>
