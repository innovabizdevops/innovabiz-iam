...
const KPIS = [{"l":"Dashboards Ativos","v":"5.135","t":"+13.3%","d":"up"},{"l":"Queries/Dia","v":"1403","t":"-4.7%","d":"down"},{"l":"Dados Processados (GB)","v":"7.231","t":"+8.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.427","t":"-1.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4426","2026-01-21","5.978","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","714","2026-01-28","4.554","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2911","2026-02-24","7.367","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4378","2026-03-10","2.696","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4356","2026-01-05","2.288","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":686},{"label":"Mar","value":661},{"label":"Abr","value":838},{"label":"Mai","value":672},{"label":"Jun","value":853},{"label":"Jul","value":842},{"label":"Ago","value":615},{"label":"Set","value":721},{"label":"Out","value":656},{"label":"Nov","value":518},{"label":"Dez","value":837}];
const MX = 853;
