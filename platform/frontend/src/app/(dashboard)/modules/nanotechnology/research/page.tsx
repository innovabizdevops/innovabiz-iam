...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"8.709","t":"+8.3%","d":"up"},{"l":"Patentes (YTD)","v":"1.618","t":"+0.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.682","t":"-4.1%","d":"down"},{"l":"Budget I&D (€M)","v":"€43.9M","t":"+17.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.666","85.9%","7.841","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.478","78.2%","3.219","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","5.070","76.1%","7.092","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.679","88.6%","1.614","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.338","71.9%","7.830","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":745},{"label":"Mar","value":665},{"label":"Abr","value":663},{"label":"Mai","value":701},{"label":"Jun","value":658},{"label":"Jul","value":567},{"label":"Ago","value":719},{"label":"Set","value":788},{"label":"Out","value":783},{"label":"Nov","value":605},{"label":"Dez","value":805}];
const MX = 805;
