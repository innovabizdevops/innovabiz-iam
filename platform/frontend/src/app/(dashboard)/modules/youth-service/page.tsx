...
const KPIS = [
    { label: "Total Registos", value: "362", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1018", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€368K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1206107362", cells: ["YOU-9362", "Youth Services Item 1", "27/11/2026", "€7462"], status: "active" as const },
    { id: "1206110933", cells: ["YOU-3933", "Youth Services Item 2", "14/6/2026", "€11 033"], status: "pending" as const },
    { id: "1206114504", cells: ["YOU-7504", "Youth Services Item 3", "1/1/2026", "€14 604"], status: "completed" as const },
    { id: "1206118075", cells: ["YOU-2075", "Youth Services Item 4", "16/8/2026", "€18 175"], status: "warning" as const },
    { id: "1206121646", cells: ["YOU-5646", "Youth Services Item 5", "3/3/2026", "€21 746"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Youth Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Youth Services</p>
                    </div>
                </div>
