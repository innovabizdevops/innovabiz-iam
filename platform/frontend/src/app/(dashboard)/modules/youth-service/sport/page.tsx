...
const PAGE = "Sport";
const KPIS = [{"l":"Atletas Registados","v":"2.565","t":"+17.8%","d":"up"},{"l":"Treinos/Semana","v":"620","t":"+7.9%","d":"up"},{"l":"Competições","v":"2.899","t":"+3.4%","d":"up"},{"l":"Performance Score","v":"57","t":"+11.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.238","4.653","8.720","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","539","4.544","292","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.581","7.073","8.624","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.354","8.617","8.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.059","6.391","2.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":254},{"label":"Mar","value":273},{"label":"Abr","value":445},{"label":"Mai","value":316},{"label":"Jun","value":308},{"label":"Jul","value":281},{"label":"Ago","value":462},{"label":"Set","value":556},{"label":"Out","value":373},{"label":"Nov","value":378},{"label":"Dez","value":276}];
const MX = 556;
