...
const PAGE = "Proof of Delivery";
const KPIS = [{"l":"Total Logistics Hub","v":"2.169","t":"+17.9%","d":"up"},{"l":"Proof Of Delivery Ativos","v":"4.465","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"70","t":"+9.9%","d":"up"}];
const COLS = ["ID","Proof Of Delivery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logistics Hub #001","Logistics Hub #002","1.077","610","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Logistics Hub #002","Logistics Hub #003","5.862","1.862","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Logistics Hub #003","Logistics Hub #004","2.393","3.485","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Logistics Hub #004","Logistics Hub #005","2.905","8.903","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logistics Hub #005","Logistics Hub #001","5.528","7.085","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":314},{"label":"Fev","value":524},{"label":"Mar","value":296},{"label":"Abr","value":550},{"label":"Mai","value":243},{"label":"Jun","value":330},{"label":"Jul","value":333},{"label":"Ago","value":445},{"label":"Set","value":524},{"label":"Out","value":552},{"label":"Nov","value":469},{"label":"Dez","value":472}];
const MX = 552;
