...
const PAGE = "3PL Management";
const KPIS = [{"l":"Projetos Melhoria","v":"1.392","t":"-5.1%","d":"down"},{"l":"Savings (€)","v":"€56839","t":"+6.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.2%","t":"+3.2%","d":"up"},{"l":"Ciclos PDCA","v":"7.405","t":"+8.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.045","€ 2628.84","8.082","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.087","€ 21901.45","6.799","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.933","€ 15395.47","4.345","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.270","€ 48131.12","5.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.568","€ 34744.77","7.469","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":551},{"label":"Mar","value":687},{"label":"Abr","value":564},{"label":"Mai","value":892},{"label":"Jun","value":542},{"label":"Jul","value":597},{"label":"Ago","value":793},{"label":"Set","value":538},{"label":"Out","value":766},{"label":"Nov","value":867},{"label":"Dez","value":747}];
const MX = 892;
...
export default function 3plPage() {
    return (
