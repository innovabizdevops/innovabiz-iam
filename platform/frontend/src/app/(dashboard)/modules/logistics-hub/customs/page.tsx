...
const PAGE = "Customs &amp; Trade";
const KPIS = [{"l":"Total Logistics Hub","v":"2.566","t":"-4.9%","d":"down"},{"l":"Customs & Trade Ativos","v":"€47907","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+6.5%","d":"up"}];
const COLS = ["ID","Customs & Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logistics Hub #001","€ 32820.05","3.274","5.880","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Logistics Hub #002","€ 27096.35","4.287","7.842","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Logistics Hub #003","€ 42697.88","4.504","3.544","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Logistics Hub #004","€ 28694.43","6.145","3.330","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logistics Hub #005","€ 13846.19","8.663","7.548","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":929},{"label":"Mar","value":892},{"label":"Abr","value":868},{"label":"Mai","value":727},{"label":"Jun","value":1044},{"label":"Jul","value":1028},{"label":"Ago","value":898},{"label":"Set","value":1066},{"label":"Out","value":986},{"label":"Nov","value":886},{"label":"Dez","value":827}];
const MX = 1066;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>HS</span></h1>
                </div>
