...
const PAGE = "Last-Mile Tracking";
const KPIS = [{"l":"Total Logistics Hub","v":"8.271","t":"+8.6%","d":"up"},{"l":"Last Mile Tracking Ativos","v":"201","t":"+3.3%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+17.2%","d":"up"}];
const COLS = ["ID","Last Mile Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logistics Hub #001","Logistics Hub #002","5.953","2.968","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Logistics Hub #002","Logistics Hub #003","1.918","137","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Logistics Hub #003","Logistics Hub #004","8.898","5.917","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Logistics Hub #004","Logistics Hub #005","2.053","2.532","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logistics Hub #005","Logistics Hub #001","4.505","8.896","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":366},{"label":"Mar","value":252},{"label":"Abr","value":615},{"label":"Mai","value":292},{"label":"Jun","value":505},{"label":"Jul","value":314},{"label":"Ago","value":458},{"label":"Set","value":268},{"label":"Out","value":258},{"label":"Nov","value":381},{"label":"Dez","value":388}];
const MX = 615;
