...
const ACCENT = "#b45309";
const MODULE = "Logistics Hub";
const PAGE = "Load Optimization AI";
const KPIS = [{"l":"Total Logistics Hub","v":"3.045","t":"+11.3%","d":"up"},{"l":"Load Optimization AI Ativos","v":"4.724","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"86.9%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.3%","d":"up"}];
const COLS = ["ID","Load Optimization AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logistics Hub #001","Logistics Hub #002","4.176","1.926","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Logistics Hub #002","Logistics Hub #003","5.879","8.620","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Logistics Hub #003","Logistics Hub #004","3.274","2.752","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Logistics Hub #004","Logistics Hub #005","717","256","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logistics Hub #005","Logistics Hub #001","5.332","7.918","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":989},{"label":"Mar","value":606},{"label":"Abr","value":975},{"label":"Mai","value":826},{"label":"Jun","value":772},{"label":"Jul","value":599},{"label":"Ago","value":923},{"label":"Set","value":667},{"label":"Out","value":846},{"label":"Nov","value":876},{"label":"Dez","value":644}];
const MX = 989;
