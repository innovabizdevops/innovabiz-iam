...
const PAGE = "Delivery SLA";
const KPIS = [{"l":"Tickets Abertos","v":"1.373","t":"+16.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.0%","t":"-5.8%","d":"down"},{"l":"MTTR (h)","v":"108h","t":"+2.7%","d":"up"},{"l":"Satisfação (%)","v":"90.3%","t":"-3.0%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.560","5.292","5.465","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.489","6.514","2.752","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.253","4.574","3.445","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.286","4.782","7.823","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.793","8.440","4.661","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":647},{"label":"Mar","value":619},{"label":"Abr","value":656},{"label":"Mai","value":769},{"label":"Jun","value":947},{"label":"Jul","value":947},{"label":"Ago","value":875},{"label":"Set","value":721},{"label":"Out","value":871},{"label":"Nov","value":738},{"label":"Dez","value":942}];
const MX = 947;
