...
const KPIS = [{"l":"Total Logistics Hub","v":"5.909","t":"-2.1%","d":"down"},{"l":"Cross Docking Ativos","v":"4.477","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"72","t":"+12.5%","d":"up"}];
const COLS = ["ID","Cross Docking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Logistics Hub #001","Logistics Hub #002","3.398","3.306","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Logistics Hub #002","Logistics Hub #003","3.113","525","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Logistics Hub #003","Logistics Hub #004","3.111","1.393","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Logistics Hub #004","Logistics Hub #005","7.807","7.497","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Logistics Hub #005","Logistics Hub #001","7.355","3.780","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":543},{"label":"Mar","value":749},{"label":"Abr","value":885},{"label":"Mai","value":766},{"label":"Jun","value":663},{"label":"Jul","value":772},{"label":"Ago","value":614},{"label":"Set","value":664},{"label":"Out","value":574},{"label":"Nov","value":703},{"label":"Dez","value":865}];
const MX = 885;
