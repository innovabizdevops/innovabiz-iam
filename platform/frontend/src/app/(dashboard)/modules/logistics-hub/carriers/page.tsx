...
const PAGE = "Carrier Management";
const KPIS = [{"l":"ARR (€M)","v":"€37.7M","t":"+4.0%","d":"up"},{"l":"MRR (€)","v":"€27737","t":"+9.2%","d":"up"},{"l":"Churn (%)","v":"86.2%","t":"-5.1%","d":"down"},{"l":"ARPU (€)","v":"€4562","t":"-2.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 35103.30","5.193","€ 26213.53","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 31207.58","5.562","€ 12533.04","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40604.55","5.587","€ 33430.63","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 35919.24","7.211","€ 39486.78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29372.24","2.429","€ 19425.80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":794},{"label":"Mar","value":831},{"label":"Abr","value":865},{"label":"Mai","value":745},{"label":"Jun","value":700},{"label":"Jul","value":736},{"label":"Ago","value":540},{"label":"Set","value":629},{"label":"Out","value":862},{"label":"Nov","value":872},{"label":"Dez","value":667}];
const MX = 872;
