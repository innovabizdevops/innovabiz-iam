...
/* ═══ DC Management — Rack Layout ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2124", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "173", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1798", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1373069545", cells: ["DC-3545", "Rack Layout Item 1", "2/2/2026", "€19 645"], status: "active" as const },
    { id: "1373073116", cells: ["DC-7116", "Rack Layout Item 2", "17/9/2026", "€23 216"], status: "pending" as const },
    { id: "1373076687", cells: ["DC-1687", "Rack Layout Item 3", "4/4/2026", "€26 787"], status: "completed" as const },
    { id: "1373080258", cells: ["DC-5258", "Rack Layout Item 4", "19/11/2026", "€30 358"], status: "warning" as const },
    { id: "1373083829", cells: ["DC-8829", "Rack Layout Item 5", "6/6/2026", "€33 929"], status: "active" as const },
];
...
export default function DcManagementRackLayoutPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rack Layout</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Rack Layout</p>
                    </div>
                </div>
