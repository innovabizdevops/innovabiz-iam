...
/* ═══ DC Management — Incident Response ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1719", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "433", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3069", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1411109037", cells: ["DC-9037", "Incident Response Item 1", "10/10/2026", "€9137"], status: "active" as const },
    { id: "1411112608", cells: ["DC-3608", "Incident Response Item 2", "25/5/2026", "€12 708"], status: "pending" as const },
    { id: "1411116179", cells: ["DC-7179", "Incident Response Item 3", "12/12/2026", "€16 279"], status: "completed" as const },
    { id: "1411119750", cells: ["DC-1750", "Incident Response Item 4", "27/7/2026", "€19 850"], status: "warning" as const },
    { id: "1411123321", cells: ["DC-5321", "Incident Response Item 5", "14/2/2026", "€23 421"], status: "active" as const },
];
...
export default function DcManagementIncidentResponsePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Incident Response</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Incident Response</p>
                    </div>
                </div>
