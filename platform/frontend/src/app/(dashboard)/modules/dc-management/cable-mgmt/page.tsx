...
/* ═══ DC Management — Cable Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1642", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "388", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3336", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1698173952", cells: ["DC-9952", "Cable Mgmt Item 1", "21/1/2026", "€24 052"], status: "active" as const },
    { id: "1698177523", cells: ["DC-4523", "Cable Mgmt Item 2", "8/8/2026", "€27 623"], status: "pending" as const },
    { id: "1698181094", cells: ["DC-8094", "Cable Mgmt Item 3", "23/3/2026", "€31 194"], status: "completed" as const },
    { id: "1698184665", cells: ["DC-2665", "Cable Mgmt Item 4", "10/10/2026", "€34 765"], status: "warning" as const },
    { id: "1698188236", cells: ["DC-6236", "Cable Mgmt Item 5", "25/5/2026", "€38 336"], status: "active" as const },
];
...
export default function DcManagementCableMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cable Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Cable Mgmt</p>
                    </div>
                </div>
