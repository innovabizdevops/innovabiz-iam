...
const KPIS = [
    { label: "Total", value: "1196", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "182", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2492", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2124228322", cells: ["DC-4322", "Environmental Item 1", "7/11/2026", "€28 422"], status: "active" as const },
    { id: "2124231893", cells: ["DC-7893", "Environmental Item 2", "22/6/2026", "€31 993"], status: "pending" as const },
    { id: "2124235464", cells: ["DC-2464", "Environmental Item 3", "9/1/2026", "€35 564"], status: "completed" as const },
    { id: "2124239035", cells: ["DC-6035", "Environmental Item 4", "24/8/2026", "€39 135"], status: "warning" as const },
    { id: "2124242606", cells: ["DC-9606", "Environmental Item 5", "11/3/2026", "€42 706"], status: "active" as const },
];
...
export default function DcManagementEnvironmentalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Environmental</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Environmental</p>
                    </div>
                </div>
