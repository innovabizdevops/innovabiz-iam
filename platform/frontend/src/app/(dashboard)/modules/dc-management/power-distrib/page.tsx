...
/* ═══ DC Management — Power Distrib ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "121", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "358", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3618", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "949941554", cells: ["DC-1554", "Power Distrib Item 1", "3/3/2026", "€41 654"], status: "active" as const },
    { id: "949945125", cells: ["DC-5125", "Power Distrib Item 2", "18/10/2026", "€45 225"], status: "pending" as const },
    { id: "949948696", cells: ["DC-8696", "Power Distrib Item 3", "5/5/2026", "€48 796"], status: "completed" as const },
    { id: "949952267", cells: ["DC-3267", "Power Distrib Item 4", "20/12/2026", "€2367"], status: "warning" as const },
    { id: "949955838", cells: ["DC-6838", "Power Distrib Item 5", "7/7/2026", "€5938"], status: "active" as const },
];
...
export default function DcManagementPowerDistribPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Power Distrib</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Power Distrib</p>
                    </div>
                </div>
