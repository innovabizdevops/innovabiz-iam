...
/* ═══ DC Management — Floor Plan ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2693", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "475", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2563", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "773362695", cells: ["DC-2695", "Floor Plan Item 1", "8/4/2026", "€12 795"], status: "active" as const },
    { id: "773366266", cells: ["DC-6266", "Floor Plan Item 2", "23/11/2026", "€16 366"], status: "pending" as const },
    { id: "773369837", cells: ["DC-9837", "Floor Plan Item 3", "10/6/2026", "€19 937"], status: "completed" as const },
    { id: "773373408", cells: ["DC-4408", "Floor Plan Item 4", "25/1/2026", "€23 508"], status: "warning" as const },
    { id: "773376979", cells: ["DC-7979", "Floor Plan Item 5", "12/8/2026", "€27 079"], status: "active" as const },
];
...
export default function DcManagementFloorPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Floor Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Floor Plan</p>
                    </div>
                </div>
