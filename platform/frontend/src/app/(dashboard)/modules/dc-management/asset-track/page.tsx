...
/* ═══ DC Management — Asset Track ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "212", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "213", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1923", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "589416865", cells: ["DC-7865", "Asset Track Item 1", "10/2/2026", "€16 965"], status: "active" as const },
    { id: "589420436", cells: ["DC-2436", "Asset Track Item 2", "25/9/2026", "€20 536"], status: "pending" as const },
    { id: "589424007", cells: ["DC-6007", "Asset Track Item 3", "12/4/2026", "€24 107"], status: "completed" as const },
    { id: "589427578", cells: ["DC-9578", "Asset Track Item 4", "27/11/2026", "€27 678"], status: "warning" as const },
    { id: "589431149", cells: ["DC-4149", "Asset Track Item 5", "14/6/2026", "€31 249"], status: "active" as const },
];
...
export default function DcManagementAssetTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Asset Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Asset Track</p>
                    </div>
                </div>
