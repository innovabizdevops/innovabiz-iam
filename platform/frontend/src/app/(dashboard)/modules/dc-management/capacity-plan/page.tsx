...
/* ═══ DC Management — Capacity Plan ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4495", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "247", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3048", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1285939283", cells: ["DC-2283", "Capacity Plan Item 1", "28/12/2026", "€39 383"], status: "active" as const },
    { id: "1285942854", cells: ["DC-5854", "Capacity Plan Item 2", "15/7/2026", "€42 954"], status: "pending" as const },
    { id: "1285946425", cells: ["DC-9425", "Capacity Plan Item 3", "2/2/2026", "€46 525"], status: "completed" as const },
    { id: "1285949996", cells: ["DC-3996", "Capacity Plan Item 4", "17/9/2026", "€50 096"], status: "warning" as const },
    { id: "1285953567", cells: ["DC-7567", "Capacity Plan Item 5", "4/4/2026", "€3667"], status: "active" as const },
];
...
export default function DcManagementCapacityPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capacity Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Capacity Plan</p>
                    </div>
                </div>
