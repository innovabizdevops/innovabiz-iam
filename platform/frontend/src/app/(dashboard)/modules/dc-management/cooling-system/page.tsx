...
/* ═══ DC Management — Cooling System ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1147", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "18", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "787", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "12329102", cells: ["DC-9102", "Cooling System Item 1", "3/3/2026", "€29 202"], status: "active" as const },
    { id: "12332673", cells: ["DC-3673", "Cooling System Item 2", "18/10/2026", "€32 773"], status: "pending" as const },
    { id: "12336244", cells: ["DC-7244", "Cooling System Item 3", "5/5/2026", "€36 344"], status: "completed" as const },
    { id: "12339815", cells: ["DC-1815", "Cooling System Item 4", "20/12/2026", "€39 915"], status: "warning" as const },
    { id: "12343386", cells: ["DC-5386", "Cooling System Item 5", "7/7/2026", "€43 486"], status: "active" as const },
];
...
export default function DcManagementCoolingSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cooling System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Cooling System</p>
                    </div>
                </div>
