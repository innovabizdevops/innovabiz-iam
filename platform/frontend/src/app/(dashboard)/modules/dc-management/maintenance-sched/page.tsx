...
/* ═══ DC Management — Maintenance Sched ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "883", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "98", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "405", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "95%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1223110318", cells: ["DC-2318", "Maintenance Sched Item 1", "11/11/2026", "€10 418"], status: "active" as const },
    { id: "1223113889", cells: ["DC-5889", "Maintenance Sched Item 2", "26/6/2026", "€13 989"], status: "pending" as const },
    { id: "1223117460", cells: ["DC-9460", "Maintenance Sched Item 3", "13/1/2026", "€17 560"], status: "completed" as const },
    { id: "1223121031", cells: ["DC-4031", "Maintenance Sched Item 4", "28/8/2026", "€21 131"], status: "warning" as const },
    { id: "1223124602", cells: ["DC-7602", "Maintenance Sched Item 5", "15/3/2026", "€24 702"], status: "active" as const },
];
...
export default function DcManagementMaintenanceSchedPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maintenance Sched</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">DC Management • Maintenance Sched</p>
                    </div>
                </div>
