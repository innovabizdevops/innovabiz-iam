...
const PAGE = "Regulatory Pack";
const KPIS = [{"l":"Total Industry Cloud","v":"502","t":"-0.5%","d":"down"},{"l":"Regulatory Pack Ativos","v":"1.131","t":"-4.0%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"87","t":"+5.8%","d":"up"}];
const COLS = ["ID","Regulatory Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Cloud #001","Industry Cloud #002","8.589","3.327","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Cloud #002","Industry Cloud #003","5.276","1.031","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Cloud #003","Industry Cloud #004","3.882","8.869","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Cloud #004","Industry Cloud #005","7.258","7.134","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Cloud #005","Industry Cloud #001","8.009","246","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":508},{"label":"Mar","value":690},{"label":"Abr","value":704},{"label":"Mai","value":577},{"label":"Jun","value":630},{"label":"Jul","value":537},{"label":"Ago","value":718},{"label":"Set","value":471},{"label":"Out","value":576},{"label":"Nov","value":415},{"label":"Dez","value":493}];
const MX = 718;
