...
const PAGE = "Vertical Templates";
const KPIS = [{"l":"Formulários Ativos","v":"7.044","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"276","t":"+8.1%","d":"up"},{"l":"Documentos Gerados","v":"5.882","t":"+9.9%","d":"up"},{"l":"Templates","v":"3.221","t":"-5.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.133","2026-01-21","3.473","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","522","2026-03-17","4.315","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.184","2026-03-27","4.715","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","723","2026-02-24","147","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.800","2026-02-14","903","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":688},{"label":"Mar","value":661},{"label":"Abr","value":425},{"label":"Mai","value":422},{"label":"Jun","value":450},{"label":"Jul","value":597},{"label":"Ago","value":381},{"label":"Set","value":504},{"label":"Out","value":329},{"label":"Nov","value":437},{"label":"Dez","value":492}];
const MX = 688;
