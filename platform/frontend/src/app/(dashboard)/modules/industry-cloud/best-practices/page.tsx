...
const PAGE = "Best Practices";
const KPIS = [{"l":"Total Industry Cloud","v":"7.679","t":"+8.6%","d":"up"},{"l":"Best Practices Ativos","v":"8.419","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"65","t":"-4.8%","d":"down"}];
const COLS = ["ID","Best Practices","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Cloud #001","Industry Cloud #002","5.627","5.565","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Cloud #002","Industry Cloud #003","5.763","2.722","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Cloud #003","Industry Cloud #004","7.155","164","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Cloud #004","Industry Cloud #005","5.923","4.959","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Cloud #005","Industry Cloud #001","701","8.578","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":705},{"label":"Mar","value":778},{"label":"Abr","value":739},{"label":"Mai","value":873},{"label":"Jun","value":782},{"label":"Jul","value":585},{"label":"Ago","value":650},{"label":"Set","value":870},{"label":"Out","value":741},{"label":"Nov","value":798},{"label":"Dez","value":789}];
const MX = 873;
