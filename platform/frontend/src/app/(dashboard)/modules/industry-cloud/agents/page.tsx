...
const ACCENT = "#0891b2";
const MODULE = "Industry Cloud";
const PAGE = "Industry Agents";
const KPIS = [{"l":"Total Industry Cloud","v":"2.401","t":"+6.2%","d":"up"},{"l":"Industry Agents Ativos","v":"4.994","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"63","t":"+16.4%","d":"up"}];
const COLS = ["ID","Industry Agents","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Cloud #001","Industry Cloud #002","8.976","3.881","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Cloud #002","Industry Cloud #003","2.687","4.238","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Cloud #003","Industry Cloud #004","2.707","3.362","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Cloud #004","Industry Cloud #005","7.368","1.997","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Cloud #005","Industry Cloud #001","1.012","502","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":243},{"label":"Fev","value":604},{"label":"Mar","value":549},{"label":"Abr","value":575},{"label":"Mai","value":614},{"label":"Jun","value":534},{"label":"Jul","value":580},{"label":"Ago","value":414},{"label":"Set","value":302},{"label":"Out","value":299},{"label":"Nov","value":628},{"label":"Dez","value":280}];
const MX = 628;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Agent</span></h1>
                </div>
