...
const KPIS = [{"l":"Dashboards Ativos","v":"451","t":"+15.7%","d":"up"},{"l":"Queries/Dia","v":"5090","t":"+4.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.770","t":"-1.5%","d":"down"},{"l":"Utilizadores Analytics","v":"7.707","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3286","2026-02-09","1.664","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4188","2026-01-12","115","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","915","2026-03-21","821","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4220","2026-03-20","1.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1735","2026-02-24","7.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":562},{"label":"Mar","value":588},{"label":"Abr","value":562},{"label":"Mai","value":851},{"label":"Jun","value":870},{"label":"Jul","value":700},{"label":"Ago","value":608},{"label":"Set","value":742},{"label":"Out","value":876},{"label":"Nov","value":825},{"label":"Dez","value":638}];
const MX = 876;
