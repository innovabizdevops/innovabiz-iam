...
const PAGE = "Offer Management";
const KPIS = [{"l":"Projetos Melhoria","v":"6.193","t":"+3.5%","d":"up"},{"l":"Savings (€)","v":"€31708","t":"-2.3%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"70.4%","t":"+3.6%","d":"up"},{"l":"Ciclos PDCA","v":"4.771","t":"+13.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.113","€ 45946.88","3.349","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.643","€ 20106.40","6.827","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.902","€ 25341.14","6.979","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.228","€ 44134.19","1.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.531","€ 31555.47","7.721","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":596},{"label":"Mar","value":713},{"label":"Abr","value":560},{"label":"Mai","value":551},{"label":"Jun","value":728},{"label":"Jul","value":633},{"label":"Ago","value":545},{"label":"Set","value":646},{"label":"Out","value":789},{"label":"Nov","value":556},{"label":"Dez","value":732}];
const MX = 789;
