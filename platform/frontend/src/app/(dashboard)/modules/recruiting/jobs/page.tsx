...
const PAGE = "Job Board";
const KPIS = [{"l":"Teams Ativos","v":"608","t":"+11.9%","d":"up"},{"l":"Reuniões/Semana","v":"2310","t":"+9.7%","d":"up"},{"l":"Mensagens/Dia","v":"2246","t":"+3.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.495","t":"-5.7%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.647","3621","6.792","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.342","3378","3.862","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","406","3350","3.665","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","357","4107","3.337","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.247","3501","4.309","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":711},{"label":"Mar","value":362},{"label":"Abr","value":566},{"label":"Mai","value":391},{"label":"Jun","value":696},{"label":"Jul","value":658},{"label":"Ago","value":417},{"label":"Set","value":392},{"label":"Out","value":488},{"label":"Nov","value":461},{"label":"Dez","value":462}];
const MX = 711;
