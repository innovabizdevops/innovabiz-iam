...
const ACCENT = "#059669";
const MODULE = "Recruiting & ATS";
const PAGE = "Resume Parser AI";
const KPIS = [{"l":"Total Recruiting","v":"1.186","t":"-2.5%","d":"down"},{"l":"Resume Parser AI Ativos","v":"3.541","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"62","t":"-0.5%","d":"down"}];
const COLS = ["ID","Resume Parser AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recruiting #001","Recruiting #002","7.490","1.276","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Recruiting #002","Recruiting #003","2.333","2.926","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Recruiting #003","Recruiting #004","2.184","7.713","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Recruiting #004","Recruiting #005","5.824","8.911","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recruiting #005","Recruiting #001","6.108","6.222","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":443},{"label":"Mar","value":466},{"label":"Abr","value":382},{"label":"Mai","value":591},{"label":"Jun","value":287},{"label":"Jul","value":447},{"label":"Ago","value":305},{"label":"Set","value":451},{"label":"Out","value":425},{"label":"Nov","value":343},{"label":"Dez","value":665}];
const MX = 665;
