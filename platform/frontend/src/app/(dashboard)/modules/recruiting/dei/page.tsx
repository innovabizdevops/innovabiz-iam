...
const KPIS = [{"l":"Dashboards Ativos","v":"7.519","t":"-0.4%","d":"down"},{"l":"Queries/Dia","v":"545","t":"+6.7%","d":"up"},{"l":"Dados Processados (GB)","v":"4.059","t":"+9.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.725","t":"+1.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4308","2026-01-14","1.110","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2420","2026-02-01","7.686","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4178","2026-02-16","3.725","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2161","2026-02-21","7.418","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","387","2026-02-19","7.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":702},{"label":"Mar","value":955},{"label":"Abr","value":633},{"label":"Mai","value":866},{"label":"Jun","value":910},{"label":"Jul","value":934},{"label":"Ago","value":993},{"label":"Set","value":784},{"label":"Out","value":838},{"label":"Nov","value":897},{"label":"Dez","value":862}];
const MX = 993;
