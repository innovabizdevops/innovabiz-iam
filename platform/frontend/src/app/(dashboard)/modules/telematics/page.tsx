...
/* ═══ Telematics Platform — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "114", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3204", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€379K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "602840714", cells: ["TEL-3714", "Telematics Platform Item 1", "15/3/2026", "€40 814"], status: "active" as const },
    { id: "602844285", cells: ["TEL-7285", "Telematics Platform Item 2", "2/10/2026", "€44 385"], status: "pending" as const },
    { id: "602847856", cells: ["TEL-1856", "Telematics Platform Item 3", "17/5/2026", "€47 956"], status: "completed" as const },
    { id: "602851427", cells: ["TEL-5427", "Telematics Platform Item 4", "4/12/2026", "€1527"], status: "warning" as const },
    { id: "602854998", cells: ["TEL-8998", "Telematics Platform Item 5", "19/7/2026", "€5098"], status: "active" as const },
];
...
export default function TelematicsPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Telematics Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Telematics Platform</p>
                    </div>
                </div>
