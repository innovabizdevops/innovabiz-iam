...
const PAGE = "Score";
const KPIS = [{"l":"Total Telematics","v":"8.023","t":"+7.3%","d":"up"},{"l":"Score Ativos","v":"85","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"61","t":"-2.0%","d":"down"}];
const COLS = ["ID","Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telematics #001","77.3%","6.134","540","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Telematics #002","78.8%","5.913","3.857","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Telematics #003","81.4%","7.741","3.875","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Telematics #004","86.7%","2.053","1.248","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telematics #005","81.1%","3.539","6.577","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":592},{"label":"Mar","value":499},{"label":"Abr","value":410},{"label":"Mai","value":438},{"label":"Jun","value":600},{"label":"Jul","value":567},{"label":"Ago","value":703},{"label":"Set","value":751},{"label":"Out","value":527},{"label":"Nov","value":564},{"label":"Dez","value":707}];
const MX = 751;
