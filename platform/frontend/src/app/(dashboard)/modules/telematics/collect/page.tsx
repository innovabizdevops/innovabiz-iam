...
const ACCENT = "#92400e";
const MODULE = "Telematics Platform";
const PAGE = "Collect";
const KPIS = [{"l":"Total Telematics","v":"965","t":"+11.4%","d":"up"},{"l":"Collect Ativos","v":"4.700","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"64","t":"-2.8%","d":"down"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telematics #001","Telematics #002","3.313","3.639","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Telematics #002","Telematics #003","3.839","3.759","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Telematics #003","Telematics #004","1.295","4.334","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Telematics #004","Telematics #005","7.965","3.705","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telematics #005","Telematics #001","2.540","1.964","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":698},{"label":"Mar","value":573},{"label":"Abr","value":553},{"label":"Mai","value":528},{"label":"Jun","value":696},{"label":"Jul","value":746},{"label":"Ago","value":602},{"label":"Set","value":552},{"label":"Out","value":779},{"label":"Nov","value":721},{"label":"Dez","value":768}];
const MX = 779;
