...
const PAGE = "Clinical Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"4.095","t":"+7.0%","d":"up"},{"l":"Reuniões/Semana","v":"2851","t":"+16.1%","d":"up"},{"l":"Mensagens/Dia","v":"1767","t":"-2.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"6.114","t":"+15.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.094","3744","2.199","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.371","495","703","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.877","3446","6.681","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.234","3663","5.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.948","2061","427","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":814},{"label":"Mar","value":910},{"label":"Abr","value":792},{"label":"Mai","value":880},{"label":"Jun","value":910},{"label":"Jul","value":779},{"label":"Ago","value":598},{"label":"Set","value":910},{"label":"Out","value":803},{"label":"Nov","value":690},{"label":"Dez","value":710}];
const MX = 910;
