...
const PAGE = "Population Health";
const KPIS = [{"l":"Total Healthcare","v":"3.146","t":"+13.4%","d":"up"},{"l":"Population Health Ativos","v":"3.399","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"77.4%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"80","t":"+5.9%","d":"up"}];
const COLS = ["ID","Population Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare #001","Healthcare #002","8.399","5.832","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare #002","Healthcare #003","8.266","7.079","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare #003","Healthcare #004","7.135","4.078","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare #004","Healthcare #005","8.865","3.473","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare #005","Healthcare #001","7.431","5.772","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":403},{"label":"Mar","value":614},{"label":"Abr","value":429},{"label":"Mai","value":405},{"label":"Jun","value":376},{"label":"Jul","value":623},{"label":"Ago","value":419},{"label":"Set","value":460},{"label":"Out","value":409},{"label":"Nov","value":401},{"label":"Dez","value":485}];
const MX = 623;
