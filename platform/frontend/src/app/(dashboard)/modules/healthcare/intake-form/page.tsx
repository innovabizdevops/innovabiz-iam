...
const PAGE = "Patient Intake Form";
const KPIS = [{"l":"Formulários Ativos","v":"1.393","t":"+8.8%","d":"up"},{"l":"Submissões/Dia","v":"3088","t":"+4.5%","d":"up"},{"l":"Documentos Gerados","v":"7.682","t":"-5.0%","d":"down"},{"l":"Templates","v":"4.245","t":"-2.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.004","2026-01-25","6.848","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.856","2026-01-16","1.913","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.498","2026-02-16","159","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.340","2026-03-16","5.023","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.528","2026-01-27","3.244","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":504},{"label":"Mar","value":631},{"label":"Abr","value":798},{"label":"Mai","value":475},{"label":"Jun","value":759},{"label":"Jul","value":555},{"label":"Ago","value":456},{"label":"Set","value":416},{"label":"Out","value":509},{"label":"Nov","value":596},{"label":"Dez","value":794}];
const MX = 798;
