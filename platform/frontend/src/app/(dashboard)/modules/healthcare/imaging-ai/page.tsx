...
const PAGE = "Medical Imaging AI";
const KPIS = [{"l":"Integrações Ativas","v":"2.150","t":"+5.2%","d":"up"},{"l":"Chamadas/Hora","v":"4115","t":"-0.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"85.7%","t":"+0.6%","d":"up"},{"l":"Latência Média (ms)","v":"83ms","t":"-3.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.132","1.556","98.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.810","1.963","80.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.273","8.363","73.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.153","7.079","84.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.182","3.140","73.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":363},{"label":"Mar","value":618},{"label":"Abr","value":623},{"label":"Mai","value":497},{"label":"Jun","value":696},{"label":"Jul","value":500},{"label":"Ago","value":473},{"label":"Set","value":446},{"label":"Out","value":452},{"label":"Nov","value":406},{"label":"Dez","value":449}];
const MX = 696;
