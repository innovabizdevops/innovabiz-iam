...
const ACCENT = "#ec4899";
const MODULE = "Healthcare CRM";
const PAGE = "Care Plan Flow";
const KPIS = [{"l":"Total Healthcare","v":"4.835","t":"+4.8%","d":"up"},{"l":"Care Plan Flow Ativos","v":"7.625","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"67.5%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.7%","d":"up"}];
const COLS = ["ID","Care Plan Flow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Healthcare #001","Healthcare #002","6.358","1.024","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Healthcare #002","Healthcare #003","8.173","8.695","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Healthcare #003","Healthcare #004","8.813","6.853","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Healthcare #004","Healthcare #005","8.361","5.478","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Healthcare #005","Healthcare #001","3.158","4.312","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":707},{"label":"Mar","value":874},{"label":"Abr","value":997},{"label":"Mai","value":796},{"label":"Jun","value":938},{"label":"Jul","value":879},{"label":"Ago","value":684},{"label":"Set","value":629},{"label":"Out","value":755},{"label":"Nov","value":891},{"label":"Dez","value":714}];
const MX = 997;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>HL7</span></h1>
                </div>
