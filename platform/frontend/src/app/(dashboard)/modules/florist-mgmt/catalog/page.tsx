...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.633","t":"+16.6%","d":"up"},{"l":"Queries/Dia","v":"2751","t":"+0.1%","d":"up"},{"l":"Dados Processados (GB)","v":"6.630","t":"+11.7%","d":"up"},{"l":"Utilizadores Analytics","v":"3.690","t":"+9.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2497","2026-02-23","1.321","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4449","2026-03-26","7.488","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2015","2026-02-12","5.568","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2599","2026-01-02","8.982","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","207","2026-02-26","7.360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":428},{"label":"Mar","value":557},{"label":"Abr","value":715},{"label":"Mai","value":666},{"label":"Jun","value":586},{"label":"Jul","value":614},{"label":"Ago","value":733},{"label":"Set","value":427},{"label":"Out","value":499},{"label":"Nov","value":666},{"label":"Dez","value":470}];
const MX = 733;
