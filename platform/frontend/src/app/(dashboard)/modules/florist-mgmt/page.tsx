...
const KPIS = [
    { label: "Total Registos", value: "2060", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3553", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€266K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "688200460", cells: ["FLO-7460", "Florist Management Item 1", "25/5/2026", "€560"], status: "active" as const },
    { id: "688204031", cells: ["FLO-2031", "Florist Management Item 2", "12/12/2026", "€4131"], status: "pending" as const },
    { id: "688207602", cells: ["FLO-5602", "Florist Management Item 3", "27/7/2026", "€7702"], status: "completed" as const },
    { id: "688211173", cells: ["FLO-9173", "Florist Management Item 4", "14/2/2026", "€11 273"], status: "warning" as const },
    { id: "688214744", cells: ["FLO-3744", "Florist Management Item 5", "1/9/2026", "€14 844"], status: "active" as const },
];
...
export default function FloristManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Florist Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Florist Management</p>
                    </div>
                </div>
