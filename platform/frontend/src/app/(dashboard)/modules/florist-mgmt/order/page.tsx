...
const PAGE = "Order";
const KPIS = [{"l":"Total Florist Mgmt","v":"5.277","t":"+17.1%","d":"up"},{"l":"Order Ativos","v":"5.517","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"82","t":"+16.2%","d":"up"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Florist Mgmt #001","Florist Mgmt #002","1.647","1.100","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Florist Mgmt #002","Florist Mgmt #003","4.197","2.322","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Florist Mgmt #003","Florist Mgmt #004","2.407","8.234","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Florist Mgmt #004","Florist Mgmt #005","662","3.328","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Florist Mgmt #005","Florist Mgmt #001","8.958","8.796","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":570},{"label":"Mar","value":795},{"label":"Abr","value":921},{"label":"Mai","value":878},{"label":"Jun","value":800},{"label":"Jul","value":730},{"label":"Ago","value":884},{"label":"Set","value":802},{"label":"Out","value":573},{"label":"Nov","value":840},{"label":"Dez","value":744}];
const MX = 921;
