...
const PAGE = "Event";
const KPIS = [{"l":"Total Florist Mgmt","v":"1.870","t":"+9.1%","d":"up"},{"l":"Event Ativos","v":"1.441","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"56","t":"+15.4%","d":"up"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Florist Mgmt #001","Florist Mgmt #002","8.852","3.951","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Florist Mgmt #002","Florist Mgmt #003","1.878","6.235","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Florist Mgmt #003","Florist Mgmt #004","7.249","8.598","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Florist Mgmt #004","Florist Mgmt #005","4.226","2.643","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Florist Mgmt #005","Florist Mgmt #001","7.296","7.056","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":531},{"label":"Mar","value":637},{"label":"Abr","value":629},{"label":"Mai","value":431},{"label":"Jun","value":458},{"label":"Jul","value":504},{"label":"Ago","value":688},{"label":"Set","value":575},{"label":"Out","value":534},{"label":"Nov","value":584},{"label":"Dez","value":616}];
const MX = 688;
