...
const ACCENT = "#16a34a";
const MODULE = "Florist Management";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.597","t":"+10.2%","d":"up"},{"l":"Submissões/Dia","v":"2777","t":"+13.7%","d":"up"},{"l":"Documentos Gerados","v":"6.546","t":"+6.3%","d":"up"},{"l":"Templates","v":"3.275","t":"+10.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.192","2026-03-06","6.952","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.732","2026-02-06","3.856","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.837","2026-03-05","9.013","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.335","2026-02-24","2.604","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.683","2026-01-01","8.820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":422},{"label":"Mar","value":488},{"label":"Abr","value":644},{"label":"Mai","value":470},{"label":"Jun","value":658},{"label":"Jul","value":579},{"label":"Ago","value":685},{"label":"Set","value":622},{"label":"Out","value":486},{"label":"Nov","value":485},{"label":"Dez","value":506}];
const MX = 692;
