...
const ACCENT = "#0891b2";
const MODULE = "Security Architecture (TOGAF)";
const PAGE = "Data Protect";
const KPIS = [{"l":"Total Arch Security","v":"5.137","t":"-1.7%","d":"down"},{"l":"Data Protect Ativos","v":"3.086","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"75.4%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.1%","d":"down"}];
const COLS = ["ID","Data Protect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Security #001","2026-03-16","7.178","3.093","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Security #002","2026-01-23","5.008","3.903","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Security #003","2026-03-06","3.867","6.480","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Security #004","2026-02-09","5.077","5.757","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Security #005","2026-03-01","8.002","8.775","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":572},{"label":"Mar","value":755},{"label":"Abr","value":427},{"label":"Mai","value":530},{"label":"Jun","value":644},{"label":"Jul","value":725},{"label":"Ago","value":523},{"label":"Set","value":562},{"label":"Out","value":609},{"label":"Nov","value":370},{"label":"Dez","value":365}];
const MX = 755;
