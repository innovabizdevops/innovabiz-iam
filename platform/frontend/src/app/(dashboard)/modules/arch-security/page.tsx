...
/* ═══ Security Architecture (TOGAF) — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "2970", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "664", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€202K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "7190270", cells: ["ARC-9270", "Security Architecture (TOGAF) Item 1", "11/3/2026", "€40 370"], status: "active" as const },
    { id: "7193841", cells: ["ARC-3841", "Security Architecture (TOGAF) Item 2", "26/10/2026", "€43 941"], status: "pending" as const },
    { id: "7197412", cells: ["ARC-7412", "Security Architecture (TOGAF) Item 3", "13/5/2026", "€47 512"], status: "completed" as const },
    { id: "7200983", cells: ["ARC-1983", "Security Architecture (TOGAF) Item 4", "28/12/2026", "€1083"], status: "warning" as const },
    { id: "7204554", cells: ["ARC-5554", "Security Architecture (TOGAF) Item 5", "15/7/2026", "€4654"], status: "active" as const },
];
...
export default function SecurityArchitectureTogafPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Security Architecture (TOGAF)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Security Architecture (TOGAF)</p>
                    </div>
                </div>
