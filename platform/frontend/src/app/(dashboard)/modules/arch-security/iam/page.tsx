...
const PAGE = "IAM";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.797","t":"-3.8%","d":"down"},{"l":"Sessões/Dia","v":"1046","t":"+9.5%","d":"up"},{"l":"MFA Adoção (%)","v":"79.3%","t":"+0.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"516","t":"+4.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","943","4.773","8.308","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.354","4.540","3.471","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.551","4.666","8.988","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.420","7.791","4.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.868","2.417","6.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":466},{"label":"Mar","value":494},{"label":"Abr","value":797},{"label":"Mai","value":515},{"label":"Jun","value":683},{"label":"Jul","value":766},{"label":"Ago","value":428},{"label":"Set","value":558},{"label":"Out","value":423},{"label":"Nov","value":610},{"label":"Dez","value":494}];
const MX = 797;
