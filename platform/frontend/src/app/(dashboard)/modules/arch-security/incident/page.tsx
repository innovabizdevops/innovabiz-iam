...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"6.048","t":"+17.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.4%","t":"-5.7%","d":"down"},{"l":"MTTR (h)","v":"126h","t":"+10.1%","d":"up"},{"l":"Satisfação (%)","v":"78.8%","t":"-0.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.894","4.453","1.114","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.865","7.023","2.479","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.000","5.392","2.184","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.766","1.100","964","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.814","2.137","5.066","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":653},{"label":"Mar","value":729},{"label":"Abr","value":984},{"label":"Mai","value":934},{"label":"Jun","value":742},{"label":"Jul","value":898},{"label":"Ago","value":645},{"label":"Set","value":783},{"label":"Out","value":877},{"label":"Nov","value":662},{"label":"Dez","value":711}];
const MX = 984;
