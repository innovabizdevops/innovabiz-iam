...
const ACCENT = "#06b6d4";
const MODULE = "Dashboard Builder";
const PAGE = "Real-Time";
const KPIS = [{"l":"Dashboards Ativos","v":"962","t":"+1.1%","d":"up"},{"l":"Queries/Dia","v":"2756","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"1.529","t":"+11.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.065","t":"+-0.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2602","2026-03-01","367","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4499","2026-03-20","4.880","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","542","2026-02-07","7.036","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1106","2026-03-17","1.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3877","2026-02-10","4.247","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":808},{"label":"Mar","value":727},{"label":"Abr","value":921},{"label":"Mai","value":938},{"label":"Jun","value":812},{"label":"Jul","value":785},{"label":"Ago","value":801},{"label":"Set","value":627},{"label":"Out","value":782},{"label":"Nov","value":632},{"label":"Dez","value":817}];
const MX = 938;
