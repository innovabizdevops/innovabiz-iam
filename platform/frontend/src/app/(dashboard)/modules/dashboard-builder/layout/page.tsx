...
const PAGE = "Layout";
const KPIS = [{"l":"Dashboards Ativos","v":"3.887","t":"+5.7%","d":"up"},{"l":"Queries/Dia","v":"3818","t":"+4.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.764","t":"-1.5%","d":"down"},{"l":"Utilizadores Analytics","v":"3.350","t":"-0.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","955","2026-01-26","266","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","979","2026-03-09","1.961","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4734","2026-01-25","2.073","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","828","2026-01-07","1.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1695","2026-01-23","6.208","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":564},{"label":"Mar","value":666},{"label":"Abr","value":543},{"label":"Mai","value":454},{"label":"Jun","value":608},{"label":"Jul","value":755},{"label":"Ago","value":721},{"label":"Set","value":417},{"label":"Out","value":477},{"label":"Nov","value":571},{"label":"Dez","value":727}];
const MX = 755;
