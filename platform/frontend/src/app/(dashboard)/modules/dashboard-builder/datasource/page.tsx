...
const KPIS = [{"l":"Dashboards Ativos","v":"3.155","t":"+9.4%","d":"up"},{"l":"Queries/Dia","v":"4235","t":"-2.3%","d":"down"},{"l":"Dados Processados (GB)","v":"675","t":"+3.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.953","t":"+9.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1803","2026-03-08","3.166","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3074","2026-01-06","7.231","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4149","2026-02-04","7.836","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2219","2026-03-22","187","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1413","2026-03-14","353","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":347},{"label":"Mar","value":494},{"label":"Abr","value":352},{"label":"Mai","value":343},{"label":"Jun","value":369},{"label":"Jul","value":347},{"label":"Ago","value":637},{"label":"Set","value":371},{"label":"Out","value":292},{"label":"Nov","value":497},{"label":"Dez","value":518}];
const MX = 637;
