...
const KPIS = [
    { label: "Total Registos", value: "2369", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4619", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€124K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "768410569", cells: ["DAS-9569", "Dashboard Builder Item 1", "18/2/2026", "€10 669"], status: "active" as const },
    { id: "768414140", cells: ["DAS-4140", "Dashboard Builder Item 2", "5/9/2026", "€14 240"], status: "pending" as const },
    { id: "768417711", cells: ["DAS-7711", "Dashboard Builder Item 3", "20/4/2026", "€17 811"], status: "completed" as const },
    { id: "768421282", cells: ["DAS-2282", "Dashboard Builder Item 4", "7/11/2026", "€21 382"], status: "warning" as const },
    { id: "768424853", cells: ["DAS-5853", "Dashboard Builder Item 5", "22/6/2026", "€24 953"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dashboard Builder</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dashboard Builder</p>
                    </div>
                </div>
