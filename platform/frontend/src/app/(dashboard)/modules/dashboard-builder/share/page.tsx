...
const PAGE = "Share";
const KPIS = [{"l":"Dashboards Ativos","v":"7.390","t":"+14.4%","d":"up"},{"l":"Queries/Dia","v":"905","t":"+13.0%","d":"up"},{"l":"Dados Processados (GB)","v":"869","t":"+11.2%","d":"up"},{"l":"Utilizadores Analytics","v":"1.197","t":"+8.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1128","2026-02-28","4.768","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2855","2026-02-07","3.745","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1875","2026-03-21","2.077","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1014","2026-02-20","6.178","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2003","2026-01-02","1.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":706},{"label":"Mar","value":616},{"label":"Abr","value":614},{"label":"Mai","value":749},{"label":"Jun","value":668},{"label":"Jul","value":462},{"label":"Ago","value":459},{"label":"Set","value":604},{"label":"Out","value":511},{"label":"Nov","value":468},{"label":"Dez","value":516}];
const MX = 749;
