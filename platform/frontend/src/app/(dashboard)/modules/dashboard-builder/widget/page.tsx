...
const PAGE = "Widget";
const KPIS = [{"l":"Dashboards Ativos","v":"5.048","t":"+11.4%","d":"up"},{"l":"Queries/Dia","v":"492","t":"+8.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.360","t":"+1.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.363","t":"+5.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2731","2026-02-17","5.746","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","471","2026-01-08","8.138","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2145","2026-01-27","6.834","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2276","2026-02-22","6.730","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1489","2026-01-22","7.152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":855},{"label":"Mar","value":840},{"label":"Abr","value":847},{"label":"Mai","value":760},{"label":"Jun","value":641},{"label":"Jul","value":541},{"label":"Ago","value":632},{"label":"Set","value":533},{"label":"Out","value":769},{"label":"Nov","value":791},{"label":"Dez","value":862}];
const MX = 862;
