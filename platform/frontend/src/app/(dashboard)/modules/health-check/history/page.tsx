...
const PAGE = "History";
const KPIS = [{"l":"Total Health Check","v":"8.635","t":"+8.6%","d":"up"},{"l":"History Ativos","v":"6.039","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"59","t":"+11.4%","d":"up"}];
const COLS = ["ID","History","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Check #001","Health Check #002","6.491","5.701","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Health Check #002","Health Check #003","7.400","5.233","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Check #003","Health Check #004","6.194","750","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Health Check #004","Health Check #005","7.263","5.687","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Check #005","Health Check #001","493","778","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":749},{"label":"Mar","value":660},{"label":"Abr","value":480},{"label":"Mai","value":552},{"label":"Jun","value":452},{"label":"Jul","value":666},{"label":"Ago","value":619},{"label":"Set","value":395},{"label":"Out","value":381},{"label":"Nov","value":673},{"label":"Dez","value":418}];
const MX = 749;
