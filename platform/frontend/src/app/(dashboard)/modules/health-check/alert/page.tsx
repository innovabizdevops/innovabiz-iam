...
const ACCENT = "#059669";
const MODULE = "System Health Check";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"7.841","t":"+17.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"71.5%","t":"+4.2%","d":"up"},{"l":"Taxa Abertura (%)","v":"78.0%","t":"-3.9%","d":"down"},{"l":"Escalações","v":"2.747","t":"-0.6%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","993","72.1%","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.853","75.0%","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.650","70.5%","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","568","83.9%","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.270","93.4%","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":700},{"label":"Mar","value":620},{"label":"Abr","value":608},{"label":"Mai","value":641},{"label":"Jun","value":522},{"label":"Jul","value":537},{"label":"Ago","value":681},{"label":"Set","value":630},{"label":"Out","value":788},{"label":"Nov","value":600},{"label":"Dez","value":811}];
const MX = 840;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>RTM</span></h1>
                </div>
