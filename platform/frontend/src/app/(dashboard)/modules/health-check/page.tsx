...
const KPIS = [
    { label: "Total Registos", value: "462", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1312", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€71K", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1619660162", cells: ["HEA-3162", "System Health Check Item 1", "23/3/2026", "€10 262"], status: "active" as const },
    { id: "1619663733", cells: ["HEA-6733", "System Health Check Item 2", "10/10/2026", "€13 833"], status: "pending" as const },
    { id: "1619667304", cells: ["HEA-1304", "System Health Check Item 3", "25/5/2026", "€17 404"], status: "completed" as const },
    { id: "1619670875", cells: ["HEA-4875", "System Health Check Item 4", "12/12/2026", "€20 975"], status: "warning" as const },
    { id: "1619674446", cells: ["HEA-8446", "System Health Check Item 5", "27/7/2026", "€24 546"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">System Health Check</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • System Health Check</p>
                    </div>
                </div>
