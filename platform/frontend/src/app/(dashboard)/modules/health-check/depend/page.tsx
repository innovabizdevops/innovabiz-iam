...
const PAGE = "Depend";
const KPIS = [{"l":"Total Health Check","v":"5.676","t":"+16.8%","d":"up"},{"l":"Depend Ativos","v":"6.357","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"60","t":"+9.0%","d":"up"}];
const COLS = ["ID","Depend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Check #001","Health Check #002","655","1.466","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Health Check #002","Health Check #003","3.030","7.782","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Check #003","Health Check #004","2.852","1.517","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Health Check #004","Health Check #005","4.954","3.598","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Check #005","Health Check #001","8.081","4.345","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":676},{"label":"Mar","value":351},{"label":"Abr","value":568},{"label":"Mai","value":640},{"label":"Jun","value":334},{"label":"Jul","value":680},{"label":"Ago","value":413},{"label":"Set","value":551},{"label":"Out","value":361},{"label":"Nov","value":638},{"label":"Dez","value":646}];
const MX = 680;
