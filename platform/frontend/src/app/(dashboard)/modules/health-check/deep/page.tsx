...
const PAGE = "Deep";
const KPIS = [{"l":"Total Health Check","v":"3.464","t":"-3.6%","d":"down"},{"l":"Deep Ativos","v":"6.725","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"70","t":"-1.6%","d":"down"}];
const COLS = ["ID","Deep","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Check #001","Health Check #002","7.169","1.557","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Health Check #002","Health Check #003","8.825","7.808","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Check #003","Health Check #004","6.024","1.129","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Health Check #004","Health Check #005","8.694","2.890","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Check #005","Health Check #001","1.217","6.432","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":496},{"label":"Mar","value":625},{"label":"Abr","value":512},{"label":"Mai","value":520},{"label":"Jun","value":687},{"label":"Jul","value":643},{"label":"Ago","value":596},{"label":"Set","value":576},{"label":"Out","value":694},{"label":"Nov","value":707},{"label":"Dez","value":611}];
const MX = 707;
