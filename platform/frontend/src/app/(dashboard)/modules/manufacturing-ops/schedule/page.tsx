...
const ACCENT = "#047857";
const MODULE = "Manufacturing Ops (APQC 4.4)";
const PAGE = "Schedule";
const KPIS = [{"l":"Total Manufacturing Ops","v":"377","t":"-0.2%","d":"down"},{"l":"Schedule Ativos","v":"7.682","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+1.8%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Manufacturing Ops #001","Manufacturing Ops #002","7.529","8.962","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Manufacturing Ops #002","Manufacturing Ops #003","7.210","2.379","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Manufacturing Ops #003","Manufacturing Ops #004","842","8.880","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Manufacturing Ops #004","Manufacturing Ops #005","3.594","6.665","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Manufacturing Ops #005","Manufacturing Ops #001","8.416","5.288","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":249},{"label":"Fev","value":436},{"label":"Mar","value":574},{"label":"Abr","value":327},{"label":"Mai","value":503},{"label":"Jun","value":629},{"label":"Jul","value":517},{"label":"Ago","value":275},{"label":"Set","value":313},{"label":"Out","value":356},{"label":"Nov","value":320},{"label":"Dez","value":299}];
const MX = 629;
