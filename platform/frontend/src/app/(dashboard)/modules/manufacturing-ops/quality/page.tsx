...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.942","t":"-1.4%","d":"down"},{"l":"NC Abertas","v":"5.674","t":"+15.7%","d":"up"},{"l":"Conformidade (%)","v":"72.1%","t":"-3.9%","d":"down"},{"l":"CAPAs Pendentes","v":"2.245","t":"+1.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.513","84.7%","8.024","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.645","84.3%","3.746","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","850","95.6%","4.015","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.006","83.1%","2.015","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.625","92.6%","4.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":561},{"label":"Mar","value":576},{"label":"Abr","value":666},{"label":"Mai","value":784},{"label":"Jun","value":608},{"label":"Jul","value":735},{"label":"Ago","value":694},{"label":"Set","value":804},{"label":"Out","value":825},{"label":"Nov","value":886},{"label":"Dez","value":734}];
const MX = 886;
