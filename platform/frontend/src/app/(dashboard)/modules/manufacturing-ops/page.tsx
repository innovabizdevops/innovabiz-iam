...
/* ═══ Manufacturing Ops (APQC 4.4) — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "414", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4029", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€167K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1411631414", cells: ["MAN-9414", "Manufacturing Ops (APQC 4.4) Item 1", "19/3/2026", "€31 514"], status: "active" as const },
    { id: "1411634985", cells: ["MAN-3985", "Manufacturing Ops (APQC 4.4) Item 2", "6/10/2026", "€35 085"], status: "pending" as const },
    { id: "1411638556", cells: ["MAN-7556", "Manufacturing Ops (APQC 4.4) Item 3", "21/5/2026", "€38 656"], status: "completed" as const },
    { id: "1411642127", cells: ["MAN-2127", "Manufacturing Ops (APQC 4.4) Item 4", "8/12/2026", "€42 227"], status: "warning" as const },
    { id: "1411645698", cells: ["MAN-5698", "Manufacturing Ops (APQC 4.4) Item 5", "23/7/2026", "€45 798"], status: "active" as const },
];
...
export default function ManufacturingOpsApqc44Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Manufacturing Ops (APQC 4.4)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Manufacturing Ops (APQC 4.4)</p>
                    </div>
                </div>
