...
const ACCENT = "#6366f1";
const MODULE = "Agriculture Services";
const PAGE = "Precision Farming";
const KPIS = [{"l":"Total Agriculture Services","v":"3.302","t":"+10.9%","d":"up"},{"l":"Precision Farming Ativos","v":"2.377","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"69.4%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+11.6%","d":"up"}];
const COLS = ["ID","Precision Farming","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agriculture Services #001","Agriculture Services #002","8.454","7.114","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Agriculture Services #002","Agriculture Services #003","3.773","409","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Agriculture Services #003","Agriculture Services #004","3.626","7.103","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Agriculture Services #004","Agriculture Services #005","8.914","1.076","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agriculture Services #005","Agriculture Services #001","4.452","237","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":544},{"label":"Mar","value":495},{"label":"Abr","value":497},{"label":"Mai","value":370},{"label":"Jun","value":280},{"label":"Jul","value":598},{"label":"Ago","value":316},{"label":"Set","value":644},{"label":"Out","value":429},{"label":"Nov","value":568},{"label":"Dez","value":586}];
const MX = 644;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>IoT</span></h1>
                </div>
