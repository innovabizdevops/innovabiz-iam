...
const PAGE = "Weather AI";
const KPIS = [{"l":"Total Agriculture Services","v":"5.667","t":"+8.7%","d":"up"},{"l":"Weather AI Ativos","v":"7.097","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"77.2%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"56","t":"+8.6%","d":"up"}];
const COLS = ["ID","Weather AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agriculture Services #001","Agriculture Services #002","2.001","4.227","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Agriculture Services #002","Agriculture Services #003","3.110","4.432","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Agriculture Services #003","Agriculture Services #004","2.069","2.431","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Agriculture Services #004","Agriculture Services #005","2.923","3.463","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agriculture Services #005","Agriculture Services #001","2.103","8.937","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":796},{"label":"Mar","value":868},{"label":"Abr","value":886},{"label":"Mai","value":616},{"label":"Jun","value":634},{"label":"Jul","value":628},{"label":"Ago","value":695},{"label":"Set","value":811},{"label":"Out","value":718},{"label":"Nov","value":556},{"label":"Dez","value":800}];
const MX = 886;
