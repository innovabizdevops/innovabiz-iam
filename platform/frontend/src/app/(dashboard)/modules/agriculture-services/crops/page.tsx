...
const PAGE = "Crop Management";
const KPIS = [{"l":"Projetos Melhoria","v":"536","t":"+12.3%","d":"up"},{"l":"Savings (€)","v":"€34550","t":"+3.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.0%","t":"+1.8%","d":"up"},{"l":"Ciclos PDCA","v":"5.664","t":"+2.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.026","€ 20742.73","4.702","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.988","€ 13859.75","2.091","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.742","€ 34113.42","1.292","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.407","€ 39748.49","3.658","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.835","€ 12658.37","8.236","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":957},{"label":"Mar","value":631},{"label":"Abr","value":786},{"label":"Mai","value":700},{"label":"Jun","value":715},{"label":"Jul","value":832},{"label":"Ago","value":952},{"label":"Set","value":840},{"label":"Out","value":867},{"label":"Nov","value":889},{"label":"Dez","value":724}];
const MX = 957;
