...
const PAGE = "Supply Chain";
const KPIS = [{"l":"Total Agriculture Services","v":"5.028","t":"-2.4%","d":"down"},{"l":"Supply Chain Ativos","v":"8.776","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"59","t":"-3.3%","d":"down"}];
const COLS = ["ID","Supply Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agriculture Services #001","Agriculture Services #002","2.689","5.052","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Agriculture Services #002","Agriculture Services #003","2.274","3.440","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Agriculture Services #003","Agriculture Services #004","3.627","1.724","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Agriculture Services #004","Agriculture Services #005","8.333","3.969","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agriculture Services #005","Agriculture Services #001","8.047","5.347","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":483},{"label":"Mar","value":579},{"label":"Abr","value":692},{"label":"Mai","value":691},{"label":"Jun","value":450},{"label":"Jul","value":634},{"label":"Ago","value":684},{"label":"Set","value":525},{"label":"Out","value":653},{"label":"Nov","value":734},{"label":"Dez","value":736}];
const MX = 739;
