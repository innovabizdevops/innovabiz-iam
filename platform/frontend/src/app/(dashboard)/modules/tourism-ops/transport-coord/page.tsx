...
/* ═══ Tourism Ops — Transport Coord ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "883", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "147", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "79", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1447120831", cells: ["TOU-2831", "Transport Coord Item 1", "24/8/2026", "€20 931"], status: "active" as const },
    { id: "1447124402", cells: ["TOU-6402", "Transport Coord Item 2", "11/3/2026", "€24 502"], status: "pending" as const },
    { id: "1447127973", cells: ["TOU-9973", "Transport Coord Item 3", "26/10/2026", "€28 073"], status: "completed" as const },
    { id: "1447131544", cells: ["TOU-4544", "Transport Coord Item 4", "13/5/2026", "€31 644"], status: "warning" as const },
    { id: "1447135115", cells: ["TOU-8115", "Transport Coord Item 5", "28/12/2026", "€35 215"], status: "active" as const },
];
...
export default function TourismOpsTransportCoordPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Transport Coord</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Transport Coord</p>
                    </div>
                </div>
