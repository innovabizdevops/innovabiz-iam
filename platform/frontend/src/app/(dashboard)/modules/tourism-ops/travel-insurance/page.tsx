...
/* ═══ Tourism Ops — Travel Insurance ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3948", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "229", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2642", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "773478513", cells: ["TOU-1513", "Travel Insurance Item 1", "18/10/2026", "€28 613"], status: "active" as const },
    { id: "773482084", cells: ["TOU-5084", "Travel Insurance Item 2", "5/5/2026", "€32 184"], status: "pending" as const },
    { id: "773485655", cells: ["TOU-8655", "Travel Insurance Item 3", "20/12/2026", "€35 755"], status: "completed" as const },
    { id: "773489226", cells: ["TOU-3226", "Travel Insurance Item 4", "7/7/2026", "€39 326"], status: "warning" as const },
    { id: "773492797", cells: ["TOU-6797", "Travel Insurance Item 5", "22/2/2026", "€42 897"], status: "active" as const },
];
...
export default function TourismOpsTravelInsurancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Travel Insurance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Travel Insurance</p>
                    </div>
                </div>
