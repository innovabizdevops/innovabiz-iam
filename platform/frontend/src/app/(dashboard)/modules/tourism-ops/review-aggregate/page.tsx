...
/* ═══ Tourism Ops — Review Aggregate ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1476", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "304", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1684", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1320783340", cells: ["TOU-7340", "Review Aggregate Item 1", "17/5/2026", "€33 440"], status: "active" as const },
    { id: "1320786911", cells: ["TOU-1911", "Review Aggregate Item 2", "4/12/2026", "€37 011"], status: "pending" as const },
    { id: "1320790482", cells: ["TOU-5482", "Review Aggregate Item 3", "19/7/2026", "€40 582"], status: "completed" as const },
    { id: "1320794053", cells: ["TOU-9053", "Review Aggregate Item 4", "6/2/2026", "€44 153"], status: "warning" as const },
    { id: "1320797624", cells: ["TOU-3624", "Review Aggregate Item 5", "21/9/2026", "€47 724"], status: "active" as const },
];
...
export default function TourismOpsReviewAggregatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Review Aggregate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Review Aggregate</p>
                    </div>
                </div>
