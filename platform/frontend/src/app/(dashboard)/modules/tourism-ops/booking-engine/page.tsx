...
/* ═══ Tourism Ops — Booking Engine ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1898", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "478", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1588", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1546841466", cells: ["TOU-3466", "Booking Engine Item 1", "3/7/2026", "€41 566"], status: "active" as const },
    { id: "1546845037", cells: ["TOU-7037", "Booking Engine Item 2", "18/2/2026", "€45 137"], status: "pending" as const },
    { id: "1546848608", cells: ["TOU-1608", "Booking Engine Item 3", "5/9/2026", "€48 708"], status: "completed" as const },
    { id: "1546852179", cells: ["TOU-5179", "Booking Engine Item 4", "20/4/2026", "€2279"], status: "warning" as const },
    { id: "1546855750", cells: ["TOU-8750", "Booking Engine Item 5", "7/11/2026", "€5850"], status: "active" as const },
];
...
export default function TourismOpsBookingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Booking Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Booking Engine</p>
                    </div>
                </div>
