...
/* ═══ Tourism Ops — Visa Assist ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1802", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "223", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "922", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "139634155", cells: ["TOU-9155", "Visa Assist Item 1", "4/8/2026", "€34 255"], status: "active" as const },
    { id: "139637726", cells: ["TOU-3726", "Visa Assist Item 2", "19/3/2026", "€37 826"], status: "pending" as const },
    { id: "139641297", cells: ["TOU-7297", "Visa Assist Item 3", "6/10/2026", "€41 397"], status: "completed" as const },
    { id: "139644868", cells: ["TOU-1868", "Visa Assist Item 4", "21/5/2026", "€44 968"], status: "warning" as const },
    { id: "139648439", cells: ["TOU-5439", "Visa Assist Item 5", "8/12/2026", "€48 539"], status: "active" as const },
];
...
export default function TourismOpsVisaAssistPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Visa Assist</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Visa Assist</p>
                    </div>
                </div>
