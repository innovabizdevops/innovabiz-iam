...
/* ═══ Tourism Ops — Group Tour ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3214", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "378", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2751", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "969803894", cells: ["TOU-9894", "Group Tour Item 1", "11/3/2026", "€3994"], status: "active" as const },
    { id: "969807465", cells: ["TOU-4465", "Group Tour Item 2", "26/10/2026", "€7565"], status: "pending" as const },
    { id: "969811036", cells: ["TOU-8036", "Group Tour Item 3", "13/5/2026", "€11 136"], status: "completed" as const },
    { id: "969814607", cells: ["TOU-2607", "Group Tour Item 4", "28/12/2026", "€14 707"], status: "warning" as const },
    { id: "969818178", cells: ["TOU-6178", "Group Tour Item 5", "15/7/2026", "€18 278"], status: "active" as const },
];
...
export default function TourismOpsGroupTourPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Group Tour</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Group Tour</p>
                    </div>
                </div>
