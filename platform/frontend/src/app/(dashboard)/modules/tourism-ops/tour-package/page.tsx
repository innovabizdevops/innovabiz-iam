...
/* ═══ Tourism Ops — Tour Package ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3775", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "431", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2786", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "721332251", cells: ["TOU-1251", "Tour Package Item 1", "4/12/2026", "€32 351"], status: "active" as const },
    { id: "721335822", cells: ["TOU-4822", "Tour Package Item 2", "19/7/2026", "€35 922"], status: "pending" as const },
    { id: "721339393", cells: ["TOU-8393", "Tour Package Item 3", "6/2/2026", "€39 493"], status: "completed" as const },
    { id: "721342964", cells: ["TOU-2964", "Tour Package Item 4", "21/9/2026", "€43 064"], status: "warning" as const },
    { id: "721346535", cells: ["TOU-6535", "Tour Package Item 5", "8/4/2026", "€46 635"], status: "active" as const },
];
...
export default function TourismOpsTourPackagePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tour Package</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Tour Package</p>
                    </div>
                </div>
