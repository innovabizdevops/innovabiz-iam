...
/* ═══ Tourism Ops — Guide Dispatch ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1123", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "409", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "291", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1774183493", cells: ["TOU-5493", "Guide Dispatch Item 1", "6/6/2026", "€33 593"], status: "active" as const },
    { id: "1774187064", cells: ["TOU-9064", "Guide Dispatch Item 2", "21/1/2026", "€37 164"], status: "pending" as const },
    { id: "1774190635", cells: ["TOU-3635", "Guide Dispatch Item 3", "8/8/2026", "€40 735"], status: "completed" as const },
    { id: "1774194206", cells: ["TOU-7206", "Guide Dispatch Item 4", "23/3/2026", "€44 306"], status: "warning" as const },
    { id: "1774197777", cells: ["TOU-1777", "Guide Dispatch Item 5", "10/10/2026", "€47 877"], status: "active" as const },
];
...
export default function TourismOpsGuideDispatchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Guide Dispatch</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Guide Dispatch</p>
                    </div>
                </div>
