...
/* ═══ Tourism Ops — Attraction Mgmt ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "3057", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "289", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3090", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1844168477", cells: ["TOU-6477", "Attraction Mgmt Item 1", "26/6/2026", "€18 577"], status: "active" as const },
    { id: "1844172048", cells: ["TOU-1048", "Attraction Mgmt Item 2", "13/1/2026", "€22 148"], status: "pending" as const },
    { id: "1844175619", cells: ["TOU-4619", "Attraction Mgmt Item 3", "28/8/2026", "€25 719"], status: "completed" as const },
    { id: "1844179190", cells: ["TOU-8190", "Attraction Mgmt Item 4", "15/3/2026", "€29 290"], status: "warning" as const },
    { id: "1844182761", cells: ["TOU-2761", "Attraction Mgmt Item 5", "2/10/2026", "€32 861"], status: "active" as const },
];
...
export default function TourismOpsAttractionMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Attraction Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Attraction Mgmt</p>
                    </div>
                </div>
