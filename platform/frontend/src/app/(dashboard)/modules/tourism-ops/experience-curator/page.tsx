...
/* ═══ Tourism Ops — Experience Curator ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total", value: "1777", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "17", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3863", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "82%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1214409405", cells: ["TOU-4405", "Experience Curator Item 1", "14/10/2026", "€9505"], status: "active" as const },
    { id: "1214412976", cells: ["TOU-7976", "Experience Curator Item 2", "1/5/2026", "€13 076"], status: "pending" as const },
    { id: "1214416547", cells: ["TOU-2547", "Experience Curator Item 3", "16/12/2026", "€16 647"], status: "completed" as const },
    { id: "1214420118", cells: ["TOU-6118", "Experience Curator Item 4", "3/7/2026", "€20 218"], status: "warning" as const },
    { id: "1214423689", cells: ["TOU-9689", "Experience Curator Item 5", "18/2/2026", "€23 789"], status: "active" as const },
];
...
export default function TourismOpsExperienceCuratorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Experience Curator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Tourism Ops • Experience Curator</p>
                    </div>
                </div>
