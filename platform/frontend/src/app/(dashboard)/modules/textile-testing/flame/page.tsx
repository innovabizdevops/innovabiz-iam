...
const ACCENT = "#6366f1";
const MODULE = "Textile Testing Lab";
const PAGE = "Flammability";
const KPIS = [{"l":"Total Textile Testing","v":"3.979","t":"-5.8%","d":"down"},{"l":"Flammability Ativos","v":"1.046","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.0%","d":"up"}];
const COLS = ["ID","Flammability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Textile Testing #001","Textile Testing #002","1.996","3.360","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Textile Testing #002","Textile Testing #003","3.525","4.015","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Textile Testing #003","Textile Testing #004","7.348","3.294","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Textile Testing #004","Textile Testing #005","3.288","544","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Textile Testing #005","Textile Testing #001","7.286","1.228","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":280},{"label":"Mar","value":517},{"label":"Abr","value":279},{"label":"Mai","value":270},{"label":"Jun","value":462},{"label":"Jul","value":384},{"label":"Ago","value":519},{"label":"Set","value":574},{"label":"Out","value":400},{"label":"Nov","value":404},{"label":"Dez","value":273}];
const MX = 574;
