...
export default function TextileTestingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Textile Testing</h1><p className="text-sm text-muted-foreground">Textile Testing • iBOS Enterprise</p></div>
