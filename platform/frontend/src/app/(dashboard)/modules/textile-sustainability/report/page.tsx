...
const ACCENT = "#6366f1";
const MODULE = "Textile Sustainability";
const PAGE = "Report";
const KPIS = [{"l":"Total Textile Sustainability","v":"8.075","t":"+11.9%","d":"up"},{"l":"Report Ativos","v":"9.087","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"85","t":"-3.6%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Textile Sustainability #001","Textile Sustainability #002","1.924","1.921","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Textile Sustainability #002","Textile Sustainability #003","3.382","6.998","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Textile Sustainability #003","Textile Sustainability #004","150","1.423","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Textile Sustainability #004","Textile Sustainability #005","646","1.134","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Textile Sustainability #005","Textile Sustainability #001","3.323","3.152","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":389},{"label":"Mar","value":343},{"label":"Abr","value":643},{"label":"Mai","value":378},{"label":"Jun","value":507},{"label":"Jul","value":595},{"label":"Ago","value":679},{"label":"Set","value":585},{"label":"Out","value":510},{"label":"Nov","value":369},{"label":"Dez","value":429}];
const MX = 679;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ESG</span></h1>
                </div>
