...
const PAGE = "Forum Mgmt";
const KPIS = [{"l":"Projetos Sociais","v":"5.002","t":"+14.0%","d":"up"},{"l":"Beneficiários","v":"589","t":"+14.3%","d":"up"},{"l":"Investimento CSR (€)","v":"€25283","t":"+2.1%","d":"up"},{"l":"Score Impacto","v":"92","t":"+8.7%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.483","€ 25186.64","249","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.041","€ 48577.28","5.038","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","2.530","€ 21981.96","6.982","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.082","€ 27295.72","4.756","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.645","€ 5413.03","285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":583},{"label":"Mar","value":700},{"label":"Abr","value":702},{"label":"Mai","value":713},{"label":"Jun","value":445},{"label":"Jul","value":387},{"label":"Ago","value":620},{"label":"Set","value":685},{"label":"Out","value":379},{"label":"Nov","value":651},{"label":"Dez","value":702}];
const MX = 713;
