...
const ACCENT = "#b45309";
const MODULE = "Game Community";
const PAGE = "Discord Bot";
const KPIS = [{"l":"Projetos Sociais","v":"5.714","t":"+4.0%","d":"up"},{"l":"Beneficiários","v":"4.483","t":"+2.5%","d":"up"},{"l":"Investimento CSR (€)","v":"€68999","t":"+3.3%","d":"up"},{"l":"Score Impacto","v":"79","t":"+16.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.645","€ 37426.14","7.643","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.123","€ 34520.22","7.383","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.272","€ 16951.18","7.460","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.505","€ 8150.87","5.926","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.921","€ 38442.26","6.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":618},{"label":"Mar","value":547},{"label":"Abr","value":750},{"label":"Mai","value":640},{"label":"Jun","value":759},{"label":"Jul","value":436},{"label":"Ago","value":515},{"label":"Set","value":520},{"label":"Out","value":602},{"label":"Nov","value":521},{"label":"Dez","value":785}];
const MX = 785;
