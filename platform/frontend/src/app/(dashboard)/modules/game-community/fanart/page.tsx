...
const PAGE = "Fan Art";
const KPIS = [{"l":"Projetos Sociais","v":"7.864","t":"+-0.0%","d":"up"},{"l":"Beneficiários","v":"6.042","t":"-1.8%","d":"down"},{"l":"Investimento CSR (€)","v":"€85154","t":"+14.5%","d":"up"},{"l":"Score Impacto","v":"60","t":"+8.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.791","€ 40886.32","4.743","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.605","€ 30993.39","2.253","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.187","€ 34491.52","8.878","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.258","€ 20622.14","6.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.902","€ 7971.89","8.163","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":471},{"label":"Mar","value":468},{"label":"Abr","value":388},{"label":"Mai","value":602},{"label":"Jun","value":347},{"label":"Jul","value":464},{"label":"Ago","value":526},{"label":"Set","value":436},{"label":"Out","value":553},{"label":"Nov","value":479},{"label":"Dez","value":417}];
const MX = 602;
