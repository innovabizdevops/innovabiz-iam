...
const PAGE = "Patch Notes";
const KPIS = [{"l":"Projetos Sociais","v":"339","t":"-5.6%","d":"down"},{"l":"Beneficiários","v":"3.648","t":"+6.6%","d":"up"},{"l":"Investimento CSR (€)","v":"€64449","t":"+4.0%","d":"up"},{"l":"Score Impacto","v":"92","t":"+10.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.305","€ 12499.74","487","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.925","€ 36626.30","7.078","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.047","€ 44391.89","5.494","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.655","€ 40492.97","8.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.238","€ 4271.65","3.701","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":425},{"label":"Mar","value":626},{"label":"Abr","value":518},{"label":"Mai","value":741},{"label":"Jun","value":663},{"label":"Jul","value":788},{"label":"Ago","value":784},{"label":"Set","value":512},{"label":"Out","value":424},{"label":"Nov","value":611},{"label":"Dez","value":472}];
const MX = 788;
