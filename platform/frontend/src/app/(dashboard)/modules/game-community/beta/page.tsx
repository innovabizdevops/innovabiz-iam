...
const PAGE = "Beta Access";
const KPIS = [{"l":"Projetos Sociais","v":"9.034","t":"+15.2%","d":"up"},{"l":"Beneficiários","v":"2.271","t":"+8.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€46438","t":"+5.5%","d":"up"},{"l":"Score Impacto","v":"73","t":"+8.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.870","€ 39743.89","3.147","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.095","€ 47626.27","136","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.671","€ 13151.27","801","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.259","€ 7048.21","5.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","717","€ 35014.00","5.831","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":776},{"label":"Mar","value":836},{"label":"Abr","value":888},{"label":"Mai","value":1007},{"label":"Jun","value":905},{"label":"Jul","value":817},{"label":"Ago","value":724},{"label":"Set","value":1026},{"label":"Out","value":740},{"label":"Nov","value":1056},{"label":"Dez","value":931}];
const MX = 1056;
