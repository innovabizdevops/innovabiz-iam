...
const PAGE = "Patient";
const KPIS = [{"l":"Total Alternative Med","v":"2.209","t":"+5.5%","d":"up"},{"l":"Patient Ativos","v":"6.473","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+12.6%","d":"up"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alternative Med #001","Alternative Med #002","5.593","8.717","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Alternative Med #002","Alternative Med #003","2.429","7.759","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Alternative Med #003","Alternative Med #004","824","3.450","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Alternative Med #004","Alternative Med #005","9.074","6.409","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alternative Med #005","Alternative Med #001","1.518","7.001","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":724},{"label":"Mar","value":785},{"label":"Abr","value":960},{"label":"Mai","value":655},{"label":"Jun","value":805},{"label":"Jul","value":785},{"label":"Ago","value":714},{"label":"Set","value":707},{"label":"Out","value":980},{"label":"Nov","value":954},{"label":"Dez","value":904}];
const MX = 980;
