...
const PAGE = "Herbal";
const KPIS = [{"l":"Total Alternative Med","v":"6.291","t":"-1.9%","d":"down"},{"l":"Herbal Ativos","v":"3.955","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"85.5%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"80","t":"+14.9%","d":"up"}];
const COLS = ["ID","Herbal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alternative Med #001","Alternative Med #002","6.815","5.846","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Alternative Med #002","Alternative Med #003","4.256","3.997","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Alternative Med #003","Alternative Med #004","3.165","1.883","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Alternative Med #004","Alternative Med #005","3.332","7.068","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alternative Med #005","Alternative Med #001","5.950","6.743","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":814},{"label":"Mar","value":699},{"label":"Abr","value":683},{"label":"Mai","value":556},{"label":"Jun","value":657},{"label":"Jul","value":531},{"label":"Ago","value":524},{"label":"Set","value":730},{"label":"Out","value":868},{"label":"Nov","value":643},{"label":"Dez","value":717}];
const MX = 868;
