...
const ACCENT = "#6366f1";
const MODULE = "Alternative Medicine";
const PAGE = "Chiropractic";
const KPIS = [{"l":"Total Alternative Med","v":"2.687","t":"+8.3%","d":"up"},{"l":"Chiropractic Ativos","v":"4.883","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"81","t":"+4.3%","d":"up"}];
const COLS = ["ID","Chiropractic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alternative Med #001","Alternative Med #002","2.284","3.025","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Alternative Med #002","Alternative Med #003","1.585","3.560","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Alternative Med #003","Alternative Med #004","3.218","1.124","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Alternative Med #004","Alternative Med #005","5.960","7.319","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alternative Med #005","Alternative Med #001","532","8.154","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":835},{"label":"Mar","value":694},{"label":"Abr","value":816},{"label":"Mai","value":763},{"label":"Jun","value":856},{"label":"Jul","value":743},{"label":"Ago","value":717},{"label":"Set","value":575},{"label":"Out","value":501},{"label":"Nov","value":785},{"label":"Dez","value":651}];
const MX = 856;
