...
export default function AlternativeMedPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Alternative Med</h1><p className="text-sm text-muted-foreground">Alternative Med • iBOS Enterprise</p></div>
