...
const PAGE = "Acupuncture";
const KPIS = [{"l":"Total Alternative Med","v":"8.205","t":"-3.2%","d":"down"},{"l":"Acupuncture Ativos","v":"5.732","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"65","t":"+13.2%","d":"up"}];
const COLS = ["ID","Acupuncture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alternative Med #001","Alternative Med #002","5.148","5.311","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Alternative Med #002","Alternative Med #003","8.332","1.247","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Alternative Med #003","Alternative Med #004","6.458","6.247","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Alternative Med #004","Alternative Med #005","7.297","926","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alternative Med #005","Alternative Med #001","2.808","6.995","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":724},{"label":"Mar","value":947},{"label":"Abr","value":872},{"label":"Mai","value":900},{"label":"Jun","value":832},{"label":"Jul","value":771},{"label":"Ago","value":622},{"label":"Set","value":641},{"label":"Out","value":782},{"label":"Nov","value":644},{"label":"Dez","value":812}];
const MX = 947;
