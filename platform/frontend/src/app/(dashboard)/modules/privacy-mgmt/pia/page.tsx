...
const ACCENT = "#6366f1";
const MODULE = "Privacy Management";
const PAGE = "PIA";
const KPIS = [{"l":"Total Privacy Mgmt","v":"5.220","t":"+14.4%","d":"up"},{"l":"PIA Ativos","v":"6.476","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.9%","d":"down"}];
const COLS = ["ID","PIA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privacy Mgmt #001","Privacy Mgmt #002","4.792","1.746","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Privacy Mgmt #002","Privacy Mgmt #003","8.915","5.389","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Privacy Mgmt #003","Privacy Mgmt #004","2.392","5.676","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Privacy Mgmt #004","Privacy Mgmt #005","4.598","2.140","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privacy Mgmt #005","Privacy Mgmt #001","2.475","8.500","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":531},{"label":"Mar","value":708},{"label":"Abr","value":597},{"label":"Mai","value":664},{"label":"Jun","value":861},{"label":"Jul","value":558},{"label":"Ago","value":807},{"label":"Set","value":629},{"label":"Out","value":589},{"label":"Nov","value":781},{"label":"Dez","value":809}];
const MX = 861;
