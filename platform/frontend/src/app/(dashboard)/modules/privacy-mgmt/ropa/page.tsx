...
const PAGE = "ROPA";
const KPIS = [{"l":"Total Privacy Mgmt","v":"3.249","t":"+4.1%","d":"up"},{"l":"ROPA Ativos","v":"8.049","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"83","t":"+2.5%","d":"up"}];
const COLS = ["ID","ROPA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privacy Mgmt #001","Privacy Mgmt #002","1.678","7.572","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Privacy Mgmt #002","Privacy Mgmt #003","7.515","3.698","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Privacy Mgmt #003","Privacy Mgmt #004","9.084","3.035","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Privacy Mgmt #004","Privacy Mgmt #005","5.953","1.275","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privacy Mgmt #005","Privacy Mgmt #001","1.091","7.905","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":698},{"label":"Mar","value":915},{"label":"Abr","value":890},{"label":"Mai","value":1045},{"label":"Jun","value":936},{"label":"Jul","value":867},{"label":"Ago","value":751},{"label":"Set","value":1032},{"label":"Out","value":1060},{"label":"Nov","value":798},{"label":"Dez","value":696}];
const MX = 1060;
