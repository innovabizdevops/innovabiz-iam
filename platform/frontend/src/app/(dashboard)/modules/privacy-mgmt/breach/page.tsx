...
const PAGE = "Breach";
const KPIS = [{"l":"Total Privacy Mgmt","v":"801","t":"-1.7%","d":"down"},{"l":"Breach Ativos","v":"5.744","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+9.9%","d":"up"}];
const COLS = ["ID","Breach","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privacy Mgmt #001","Privacy Mgmt #002","6.000","923","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Privacy Mgmt #002","Privacy Mgmt #003","894","1.156","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Privacy Mgmt #003","Privacy Mgmt #004","5.276","1.136","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Privacy Mgmt #004","Privacy Mgmt #005","1.143","2.742","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privacy Mgmt #005","Privacy Mgmt #001","2.176","2.558","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":304},{"label":"Fev","value":464},{"label":"Mar","value":509},{"label":"Abr","value":596},{"label":"Mai","value":507},{"label":"Jun","value":461},{"label":"Jul","value":546},{"label":"Ago","value":475},{"label":"Set","value":378},{"label":"Out","value":370},{"label":"Nov","value":516},{"label":"Dez","value":551}];
const MX = 596;
