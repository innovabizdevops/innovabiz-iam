...
const PAGE = "DSAR";
const KPIS = [{"l":"Total Privacy Mgmt","v":"6.926","t":"-0.9%","d":"down"},{"l":"DSAR Ativos","v":"2.710","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"76","t":"+13.8%","d":"up"}];
const COLS = ["ID","DSAR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privacy Mgmt #001","Privacy Mgmt #002","822","6.990","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Privacy Mgmt #002","Privacy Mgmt #003","6.960","1.464","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Privacy Mgmt #003","Privacy Mgmt #004","1.487","8.608","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Privacy Mgmt #004","Privacy Mgmt #005","7.716","7.827","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privacy Mgmt #005","Privacy Mgmt #001","7.492","1.032","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":548},{"label":"Mar","value":569},{"label":"Abr","value":434},{"label":"Mai","value":760},{"label":"Jun","value":375},{"label":"Jul","value":501},{"label":"Ago","value":498},{"label":"Set","value":578},{"label":"Out","value":447},{"label":"Nov","value":754},{"label":"Dez","value":508}];
const MX = 760;
