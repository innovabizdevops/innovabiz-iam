...
const ACCENT = "#06b6d4";
const MODULE = "Lead-to-Cash E2E";
const PAGE = "Collect";
const KPIS = [{"l":"Total Lead To Cash","v":"6.914","t":"+7.4%","d":"up"},{"l":"Collect Ativos","v":"7.210","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+13.1%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lead To Cash #001","Lead To Cash #002","8.320","4.049","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Lead To Cash #002","Lead To Cash #003","3.080","2.168","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Lead To Cash #003","Lead To Cash #004","1.077","2.678","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Lead To Cash #004","Lead To Cash #005","1.135","7.496","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lead To Cash #005","Lead To Cash #001","8.240","5.611","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":761},{"label":"Mar","value":444},{"label":"Abr","value":461},{"label":"Mai","value":499},{"label":"Jun","value":476},{"label":"Jul","value":817},{"label":"Ago","value":787},{"label":"Set","value":563},{"label":"Out","value":811},{"label":"Nov","value":560},{"label":"Dez","value":708}];
const MX = 817;
