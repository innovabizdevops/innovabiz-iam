...
/* ═══ Lead-to-Cash E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "6123", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "700", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€308K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1545108923", cells: ["LEA-7923", "Lead-to-Cash E2E Item 1", "16/12/2026", "€9023"], status: "active" as const },
    { id: "1545112494", cells: ["LEA-2494", "Lead-to-Cash E2E Item 2", "3/7/2026", "€12 594"], status: "pending" as const },
    { id: "1545116065", cells: ["LEA-6065", "Lead-to-Cash E2E Item 3", "18/2/2026", "€16 165"], status: "completed" as const },
    { id: "1545119636", cells: ["LEA-9636", "Lead-to-Cash E2E Item 4", "5/9/2026", "€19 736"], status: "warning" as const },
    { id: "1545123207", cells: ["LEA-4207", "Lead-to-Cash E2E Item 5", "20/4/2026", "€23 307"], status: "active" as const },
];
...
export default function LeadtocashE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Lead-to-Cash E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Lead-to-Cash E2E</p>
                    </div>
                </div>
