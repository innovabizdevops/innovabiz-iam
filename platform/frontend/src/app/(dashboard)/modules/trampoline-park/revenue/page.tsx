...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€29.0M","t":"+6.4%","d":"up"},{"l":"MRR (€)","v":"€36934","t":"-1.3%","d":"down"},{"l":"Churn (%)","v":"93.2%","t":"+10.5%","d":"up"},{"l":"ARPU (€)","v":"€95775","t":"-5.4%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 15284.28","2.457","€ 17980.30","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 26661.12","4.878","€ 7177.30","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32361.11","8.854","€ 21280.77","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 18415.15","7.139","€ 45231.54","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35380.26","7.205","€ 24544.06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":645},{"label":"Mar","value":837},{"label":"Abr","value":663},{"label":"Mai","value":585},{"label":"Jun","value":689},{"label":"Jul","value":886},{"label":"Ago","value":827},{"label":"Set","value":589},{"label":"Out","value":966},{"label":"Nov","value":831},{"label":"Dez","value":851}];
const MX = 966;
