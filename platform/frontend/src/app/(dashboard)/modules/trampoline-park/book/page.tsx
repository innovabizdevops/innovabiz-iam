...
const PAGE = "Book";
const KPIS = [{"l":"Veículos Operação","v":"873","t":"-4.2%","d":"down"},{"l":"Viagens/Dia","v":"1168","t":"+16.8%","d":"up"},{"l":"Pontualidade (%)","v":"75.0%","t":"+14.8%","d":"up"},{"l":"Passageiros/Dia","v":"2930","t":"+3.9%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-19","2026-02-27","8.638","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-04","2026-02-08","7.237","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-03","2026-03-12","3.770","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-08","2026-03-21","4.599","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-21","2026-01-23","2.602","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":501},{"label":"Mar","value":648},{"label":"Abr","value":571},{"label":"Mai","value":483},{"label":"Jun","value":276},{"label":"Jul","value":470},{"label":"Ago","value":608},{"label":"Set","value":359},{"label":"Out","value":402},{"label":"Nov","value":478},{"label":"Dez","value":489}];
const MX = 648;
