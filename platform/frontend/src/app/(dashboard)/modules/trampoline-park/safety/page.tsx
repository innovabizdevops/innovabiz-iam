...
const ACCENT = "#f97316";
const MODULE = "Trampoline Park";
const PAGE = "Safety";
const KPIS = [{"l":"Veículos Operação","v":"9.034","t":"+3.9%","d":"up"},{"l":"Viagens/Dia","v":"1265","t":"-3.4%","d":"down"},{"l":"Pontualidade (%)","v":"94.4%","t":"+1.7%","d":"up"},{"l":"Passageiros/Dia","v":"1768","t":"-5.6%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-17","2026-02-27","8.491","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-14","2026-02-09","6.680","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-06","2026-03-15","4.213","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-17","2026-03-28","5.988","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-12","2026-03-02","7.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":747},{"label":"Mar","value":485},{"label":"Abr","value":468},{"label":"Mai","value":536},{"label":"Jun","value":382},{"label":"Jul","value":416},{"label":"Ago","value":625},{"label":"Set","value":396},{"label":"Out","value":453},{"label":"Nov","value":376},{"label":"Dez","value":713}];
const MX = 747;
