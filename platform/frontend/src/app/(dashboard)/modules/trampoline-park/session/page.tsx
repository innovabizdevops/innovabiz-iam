...
const PAGE = "Session";
const KPIS = [{"l":"Veículos Operação","v":"4.539","t":"-4.0%","d":"down"},{"l":"Viagens/Dia","v":"2109","t":"+12.0%","d":"up"},{"l":"Pontualidade (%)","v":"86.6%","t":"-4.3%","d":"down"},{"l":"Passageiros/Dia","v":"2625","t":"+8.9%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-17","2026-03-14","3.069","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-22","2026-03-07","3.663","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-27","2026-03-25","5.520","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-22","2026-02-19","5.391","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-24","2026-02-15","4.740","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":867},{"label":"Mar","value":671},{"label":"Abr","value":970},{"label":"Mai","value":955},{"label":"Jun","value":661},{"label":"Jul","value":1043},{"label":"Ago","value":958},{"label":"Set","value":987},{"label":"Out","value":764},{"label":"Nov","value":771},{"label":"Dez","value":673}];
const MX = 1043;
