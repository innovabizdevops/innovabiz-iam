...
const PAGE = "Party";
const KPIS = [{"l":"Veículos Operação","v":"1.798","t":"+12.0%","d":"up"},{"l":"Viagens/Dia","v":"786","t":"+5.3%","d":"up"},{"l":"Pontualidade (%)","v":"88.0%","t":"+6.9%","d":"up"},{"l":"Passageiros/Dia","v":"4546","t":"+8.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-25","2026-03-26","4.793","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-20","2026-03-10","4.945","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-22","2026-02-23","6.124","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-21","2026-03-18","7.718","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-23","2026-03-16","5.875","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":830},{"label":"Mar","value":915},{"label":"Abr","value":727},{"label":"Mai","value":724},{"label":"Jun","value":946},{"label":"Jul","value":864},{"label":"Ago","value":988},{"label":"Set","value":1005},{"label":"Out","value":1011},{"label":"Nov","value":962},{"label":"Dez","value":798}];
const MX = 1011;
