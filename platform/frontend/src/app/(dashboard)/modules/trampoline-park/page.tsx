...
/* ═══ Trampoline Park — Dashboard ═══ */

const ACCENT = "#f97316";

const KPIS = [
    { label: "Total Registos", value: "1073", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4545", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€182K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1317007873", cells: ["TRA-2873", "Trampoline Park Item 1", "14/2/2026", "€7973"], status: "active" as const },
    { id: "1317011444", cells: ["TRA-6444", "Trampoline Park Item 2", "1/9/2026", "€11 544"], status: "pending" as const },
    { id: "1317015015", cells: ["TRA-1015", "Trampoline Park Item 3", "16/4/2026", "€15 115"], status: "completed" as const },
    { id: "1317018586", cells: ["TRA-4586", "Trampoline Park Item 4", "3/11/2026", "€18 686"], status: "warning" as const },
    { id: "1317022157", cells: ["TRA-8157", "Trampoline Park Item 5", "18/6/2026", "€22 257"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trampoline Park</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Trampoline Park</p>
                    </div>
                </div>
