...
const KPIS = [{"l":"Riscos Identificados","v":"1.285","t":"-0.6%","d":"down"},{"l":"Mitigações Ativas","v":"8.971","t":"+15.7%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+9.0%","d":"up"},{"l":"Incidentes YTD","v":"6.520","t":"+16.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.153","5.091","1.276","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.750","2.074","6.285","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.639","8.868","4.031","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.123","8.710","3.497","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.423","675","4.249","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":596},{"label":"Mar","value":580},{"label":"Abr","value":580},{"label":"Mai","value":553},{"label":"Jun","value":554},{"label":"Jul","value":552},{"label":"Ago","value":741},{"label":"Set","value":467},{"label":"Out","value":710},{"label":"Nov","value":510},{"label":"Dez","value":603}];
const MX = 741;
