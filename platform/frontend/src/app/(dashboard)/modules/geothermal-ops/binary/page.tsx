...
const ACCENT = "#6366f1";
const MODULE = "Geothermal Ops";
const PAGE = "Binary Cycle";
const KPIS = [{"l":"Riscos Identificados","v":"7.546","t":"-2.0%","d":"down"},{"l":"Mitigações Ativas","v":"6.322","t":"+4.8%","d":"up"},{"l":"Score Risco Geral","v":"70","t":"-4.6%","d":"down"},{"l":"Incidentes YTD","v":"1.399","t":"+0.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","981","2.271","7.839","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.535","2.402","6.740","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.844","6.743","4.222","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.110","1.917","8.059","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.737","2.301","8.650","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":707},{"label":"Mar","value":579},{"label":"Abr","value":821},{"label":"Mai","value":527},{"label":"Jun","value":771},{"label":"Jul","value":747},{"label":"Ago","value":718},{"label":"Set","value":802},{"label":"Out","value":852},{"label":"Nov","value":632},{"label":"Dez","value":821}];
const MX = 852;
