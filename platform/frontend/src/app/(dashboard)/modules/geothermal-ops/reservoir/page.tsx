...
const KPIS = [{"l":"Riscos Identificados","v":"8.636","t":"-6.0%","d":"down"},{"l":"Mitigações Ativas","v":"2.622","t":"+8.4%","d":"up"},{"l":"Score Risco Geral","v":"70","t":"+8.3%","d":"up"},{"l":"Incidentes YTD","v":"4.471","t":"+6.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.341","2.995","2.102","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.019","3.864","3.987","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.503","5.219","3.012","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.279","1.236","488","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.685","595","985","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":437},{"label":"Mar","value":224},{"label":"Abr","value":550},{"label":"Mai","value":230},{"label":"Jun","value":436},{"label":"Jul","value":270},{"label":"Ago","value":303},{"label":"Set","value":292},{"label":"Out","value":327},{"label":"Nov","value":455},{"label":"Dez","value":598}];
const MX = 598;
