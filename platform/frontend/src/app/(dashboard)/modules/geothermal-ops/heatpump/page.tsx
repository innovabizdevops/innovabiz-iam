...
const PAGE = "Heat Pump";
const KPIS = [{"l":"Riscos Identificados","v":"8.018","t":"+8.5%","d":"up"},{"l":"Mitigações Ativas","v":"3.780","t":"+3.9%","d":"up"},{"l":"Score Risco Geral","v":"83","t":"+14.5%","d":"up"},{"l":"Incidentes YTD","v":"7.557","t":"+1.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.689","7.067","2.290","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.975","3.963","7.259","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.655","7.179","4.963","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.602","3.882","2.038","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.611","309","8.762","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":428},{"label":"Mar","value":642},{"label":"Abr","value":710},{"label":"Mai","value":446},{"label":"Jun","value":464},{"label":"Jul","value":528},{"label":"Ago","value":524},{"label":"Set","value":681},{"label":"Out","value":656},{"label":"Nov","value":617},{"label":"Dez","value":605}];
const MX = 710;
