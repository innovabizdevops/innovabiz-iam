...
const PAGE = "Emission";
const KPIS = [{"l":"Riscos Identificados","v":"3.246","t":"+11.8%","d":"up"},{"l":"Mitigações Ativas","v":"466","t":"+3.7%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"+13.6%","d":"up"},{"l":"Incidentes YTD","v":"103","t":"+15.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","441","5.359","5.560","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.521","7.561","6.674","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.683","1.859","6.368","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","223","7.928","2.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.958","5.499","6.855","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":289},{"label":"Mar","value":592},{"label":"Abr","value":332},{"label":"Mai","value":331},{"label":"Jun","value":495},{"label":"Jul","value":583},{"label":"Ago","value":425},{"label":"Set","value":530},{"label":"Out","value":395},{"label":"Nov","value":484},{"label":"Dez","value":258}];
const MX = 592;
