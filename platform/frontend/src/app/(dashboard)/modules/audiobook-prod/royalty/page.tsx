...
const ACCENT = "#0e7490";
const MODULE = "Audiobook Production";
const PAGE = "Royalty Split";
const KPIS = [{"l":"Total Audiobook Prod","v":"2.077","t":"+15.2%","d":"up"},{"l":"Royalty Split Ativos","v":"9.061","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.9%","d":"up"}];
const COLS = ["ID","Royalty Split","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiobook Prod #001","Audiobook Prod #002","709","2.429","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Audiobook Prod #002","Audiobook Prod #003","7.331","8.966","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiobook Prod #003","Audiobook Prod #004","6.978","5.261","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Audiobook Prod #004","Audiobook Prod #005","486","3.620","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiobook Prod #005","Audiobook Prod #001","2.657","702","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":735},{"label":"Mar","value":652},{"label":"Abr","value":545},{"label":"Mai","value":611},{"label":"Jun","value":717},{"label":"Jul","value":625},{"label":"Ago","value":574},{"label":"Set","value":645},{"label":"Out","value":427},{"label":"Nov","value":429},{"label":"Dez","value":681}];
const MX = 735;
