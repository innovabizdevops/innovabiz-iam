...
const PAGE = "Post-Prod";
const KPIS = [{"l":"Pedidos/Dia","v":"3010","t":"+15.3%","d":"up"},{"l":"GMV (€)","v":"€25114","t":"+5.7%","d":"up"},{"l":"Conversão (%)","v":"90.4%","t":"+2.1%","d":"up"},{"l":"AOV (€)","v":"€76643","t":"-1.0%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 45381.51","3.025","313","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 46430.69","2.375","6.144","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 41419.58","2.922","898","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 29398.49","3.178","2.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 35273.97","7.030","3.914","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":352},{"label":"Mar","value":495},{"label":"Abr","value":700},{"label":"Mai","value":388},{"label":"Jun","value":415},{"label":"Jul","value":527},{"label":"Ago","value":453},{"label":"Set","value":679},{"label":"Out","value":492},{"label":"Nov","value":394},{"label":"Dez","value":633}];
const MX = 700;
