...
const KPIS = [{"l":"Total Audiobook Prod","v":"4.028","t":"+4.9%","d":"up"},{"l":"Recording Ativos","v":"4.080","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+7.3%","d":"up"}];
const COLS = ["ID","Recording","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiobook Prod #001","Audiobook Prod #002","5.605","1.841","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Audiobook Prod #002","Audiobook Prod #003","2.589","2.960","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiobook Prod #003","Audiobook Prod #004","6.669","3.085","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Audiobook Prod #004","Audiobook Prod #005","4.833","1.318","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiobook Prod #005","Audiobook Prod #001","456","6.812","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":850},{"label":"Mar","value":983},{"label":"Abr","value":741},{"label":"Mai","value":797},{"label":"Jun","value":692},{"label":"Jul","value":1001},{"label":"Ago","value":718},{"label":"Set","value":890},{"label":"Out","value":904},{"label":"Nov","value":829},{"label":"Dez","value":873}];
const MX = 1001;
