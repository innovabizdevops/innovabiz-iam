...
const PAGE = "Narrator Cast";
const KPIS = [{"l":"ARR (€M)","v":"€20.4M","t":"-0.9%","d":"down"},{"l":"MRR (€)","v":"€40332","t":"-2.8%","d":"down"},{"l":"Churn (%)","v":"66.7%","t":"+16.9%","d":"up"},{"l":"ARPU (€)","v":"€60743","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 34510.75","6.409","€ 14920.57","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 21680.69","2.404","€ 19193.19","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7432.50","5.797","€ 36066.82","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13367.22","3.520","€ 11415.02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 22889.12","5.356","€ 23692.95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":266},{"label":"Fev","value":497},{"label":"Mar","value":454},{"label":"Abr","value":482},{"label":"Mai","value":620},{"label":"Jun","value":349},{"label":"Jul","value":559},{"label":"Ago","value":423},{"label":"Set","value":373},{"label":"Out","value":639},{"label":"Nov","value":495},{"label":"Dez","value":482}];
const MX = 639;
