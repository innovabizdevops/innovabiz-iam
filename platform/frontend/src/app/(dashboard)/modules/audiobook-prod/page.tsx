...
export default function AudiobookProdPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Audiobook Prod</h1><p className="text-sm text-muted-foreground">Audiobook Prod • iBOS Enterprise</p></div>
