...
const KPIS = [{"l":"Total Audiobook Prod","v":"6.984","t":"+7.0%","d":"up"},{"l":"Distribution Ativos","v":"4.881","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.9%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Audiobook Prod #001","Audiobook Prod #002","1.071","6.727","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Audiobook Prod #002","Audiobook Prod #003","1.364","290","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Audiobook Prod #003","Audiobook Prod #004","3.081","3.528","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Audiobook Prod #004","Audiobook Prod #005","7.169","8.713","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Audiobook Prod #005","Audiobook Prod #001","5.266","5.373","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":974},{"label":"Mar","value":839},{"label":"Abr","value":891},{"label":"Mai","value":953},{"label":"Jun","value":917},{"label":"Jul","value":675},{"label":"Ago","value":670},{"label":"Set","value":679},{"label":"Out","value":603},{"label":"Nov","value":823},{"label":"Dez","value":636}];
const MX = 974;
