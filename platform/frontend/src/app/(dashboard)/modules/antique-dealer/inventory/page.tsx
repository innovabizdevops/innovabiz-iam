...
const KPIS = [{"l":"Total Antique Dealer","v":"6.724","t":"+4.6%","d":"up"},{"l":"Inventory Ativos","v":"1.890","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"75","t":"+0.2%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Antique Dealer #001","Antique Dealer #002","7.319","3.303","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Antique Dealer #002","Antique Dealer #003","5.930","2.305","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Antique Dealer #003","Antique Dealer #004","1.115","6.640","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Antique Dealer #004","Antique Dealer #005","6.617","4.687","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Antique Dealer #005","Antique Dealer #001","4.131","3.512","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":613},{"label":"Mar","value":871},{"label":"Abr","value":729},{"label":"Mai","value":920},{"label":"Jun","value":845},{"label":"Jul","value":771},{"label":"Ago","value":933},{"label":"Set","value":623},{"label":"Out","value":729},{"label":"Nov","value":775},{"label":"Dez","value":800}];
const MX = 933;
