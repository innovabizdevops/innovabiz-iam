...
/* ═══ Antique Dealer — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "6150", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4301", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€189K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1146861650", cells: ["ANT-1650", "Antique Dealer Item 1", "19/3/2026", "€11 750"], status: "active" as const },
    { id: "1146865221", cells: ["ANT-5221", "Antique Dealer Item 2", "6/10/2026", "€15 321"], status: "pending" as const },
    { id: "1146868792", cells: ["ANT-8792", "Antique Dealer Item 3", "21/5/2026", "€18 892"], status: "completed" as const },
    { id: "1146872363", cells: ["ANT-3363", "Antique Dealer Item 4", "8/12/2026", "€22 463"], status: "warning" as const },
    { id: "1146875934", cells: ["ANT-6934", "Antique Dealer Item 5", "23/7/2026", "€26 034"], status: "active" as const },
];
...
export default function AntiqueDealerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Antique Dealer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Antique Dealer</p>
                    </div>
                </div>
