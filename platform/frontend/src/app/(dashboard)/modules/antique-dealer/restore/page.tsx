...
const ACCENT = "#d97706";
const MODULE = "Antique Dealer";
const PAGE = "Restore";
const KPIS = [{"l":"Pedidos/Dia","v":"713","t":"-3.5%","d":"down"},{"l":"GMV (€)","v":"€77829","t":"+15.2%","d":"up"},{"l":"Conversão (%)","v":"82.8%","t":"-5.8%","d":"down"},{"l":"AOV (€)","v":"€52855","t":"-1.3%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 4420.16","7.066","5.609","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 11581.41","8.543","7.733","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 28482.95","8.033","3.767","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 35871.29","8.871","3.106","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 23005.83","7.494","1.320","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":542},{"label":"Mar","value":235},{"label":"Abr","value":389},{"label":"Mai","value":302},{"label":"Jun","value":286},{"label":"Jul","value":536},{"label":"Ago","value":437},{"label":"Set","value":506},{"label":"Out","value":212},{"label":"Nov","value":367},{"label":"Dez","value":469}];
const MX = 542;
