...
const PAGE = "Appraise";
const KPIS = [{"l":"Total Antique Dealer","v":"6.424","t":"-5.1%","d":"down"},{"l":"Appraise Ativos","v":"1.483","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"74.8%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.1%","d":"up"}];
const COLS = ["ID","Appraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Antique Dealer #001","Antique Dealer #002","889","1.016","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Antique Dealer #002","Antique Dealer #003","1.298","5.735","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Antique Dealer #003","Antique Dealer #004","6.995","8.845","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Antique Dealer #004","Antique Dealer #005","8.670","8.842","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Antique Dealer #005","Antique Dealer #001","2.454","766","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":773},{"label":"Mar","value":677},{"label":"Abr","value":560},{"label":"Mai","value":612},{"label":"Jun","value":736},{"label":"Jul","value":545},{"label":"Ago","value":502},{"label":"Set","value":581},{"label":"Out","value":563},{"label":"Nov","value":529},{"label":"Dez","value":581}];
const MX = 773;
