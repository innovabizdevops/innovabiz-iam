...
const KPIS = [{"l":"Total Antique Dealer","v":"1.066","t":"+10.9%","d":"up"},{"l":"Provenance Ativos","v":"4.393","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"92.4%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"56","t":"+6.9%","d":"up"}];
const COLS = ["ID","Provenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Antique Dealer #001","Antique Dealer #002","2.142","8.366","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Antique Dealer #002","Antique Dealer #003","8.720","1.785","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Antique Dealer #003","Antique Dealer #004","7.147","1.256","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Antique Dealer #004","Antique Dealer #005","4.872","2.326","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Antique Dealer #005","Antique Dealer #001","802","1.066","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":737},{"label":"Mar","value":1037},{"label":"Abr","value":889},{"label":"Mai","value":913},{"label":"Jun","value":654},{"label":"Jul","value":971},{"label":"Ago","value":701},{"label":"Set","value":738},{"label":"Out","value":1011},{"label":"Nov","value":818},{"label":"Dez","value":671}];
const MX = 1037;
