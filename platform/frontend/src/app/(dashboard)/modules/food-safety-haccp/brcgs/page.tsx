...
const PAGE = "BRCGS Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.557","t":"+1.8%","d":"up"},{"l":"NC Abertas","v":"2.116","t":"-1.5%","d":"down"},{"l":"Conformidade (%)","v":"91.9%","t":"-2.1%","d":"down"},{"l":"CAPAs Pendentes","v":"8.845","t":"-1.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.959","72.6%","7.350","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.811","83.4%","1.260","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.615","97.3%","5.817","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.663","85.0%","5.973","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.423","71.1%","1.250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":800},{"label":"Mar","value":711},{"label":"Abr","value":525},{"label":"Mai","value":622},{"label":"Jun","value":552},{"label":"Jul","value":786},{"label":"Ago","value":709},{"label":"Set","value":701},{"label":"Out","value":587},{"label":"Nov","value":637},{"label":"Dez","value":795}];
const MX = 815;
