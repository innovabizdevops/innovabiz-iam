...
const KPIS = [{"l":"Total Food Safety Haccp","v":"6.103","t":"-0.9%","d":"down"},{"l":"Verification Ativos","v":"5.681","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"57","t":"+9.0%","d":"up"}];
const COLS = ["ID","Verification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Safety Haccp #001","Food Safety Haccp #002","5.367","7.161","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Food Safety Haccp #002","Food Safety Haccp #003","8.754","6.671","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Safety Haccp #003","Food Safety Haccp #004","2.836","2.701","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Food Safety Haccp #004","Food Safety Haccp #005","7.420","5.862","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Safety Haccp #005","Food Safety Haccp #001","2.027","5.259","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":931},{"label":"Mar","value":990},{"label":"Abr","value":959},{"label":"Mai","value":695},{"label":"Jun","value":842},{"label":"Jul","value":1021},{"label":"Ago","value":889},{"label":"Set","value":937},{"label":"Out","value":913},{"label":"Nov","value":673},{"label":"Dez","value":720}];
const MX = 1021;
