...
const ACCENT = "#dc2626";
const MODULE = "Food Safety HACCP";
const PAGE = "CCP Monitor";
const KPIS = [{"l":"Total Food Safety Haccp","v":"4.534","t":"-3.3%","d":"down"},{"l":"CCP Monitor Ativos","v":"6.125","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"67.8%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"81","t":"-0.8%","d":"down"}];
const COLS = ["ID","CCP Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Safety Haccp #001","Food Safety Haccp #002","1.014","8.020","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Food Safety Haccp #002","Food Safety Haccp #003","8.391","7.397","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Safety Haccp #003","Food Safety Haccp #004","7.427","3.276","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Food Safety Haccp #004","Food Safety Haccp #005","3.430","3.856","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Safety Haccp #005","Food Safety Haccp #001","7.806","2.798","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":705},{"label":"Mar","value":794},{"label":"Abr","value":715},{"label":"Mai","value":757},{"label":"Jun","value":752},{"label":"Jul","value":841},{"label":"Ago","value":733},{"label":"Set","value":767},{"label":"Out","value":793},{"label":"Nov","value":879},{"label":"Dez","value":662}];
const MX = 879;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>IoT</span></h1>
                </div>
