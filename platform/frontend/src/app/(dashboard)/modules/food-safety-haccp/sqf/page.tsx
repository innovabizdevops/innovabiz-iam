...
const PAGE = "SQF Comply";
const KPIS = [{"l":"Total Food Safety Haccp","v":"2.484","t":"+5.1%","d":"up"},{"l":"SQF Comply Ativos","v":"288","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"67.3%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"74","t":"+13.0%","d":"up"}];
const COLS = ["ID","SQF Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Safety Haccp #001","Food Safety Haccp #002","217","469","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Food Safety Haccp #002","Food Safety Haccp #003","6.492","4.805","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Safety Haccp #003","Food Safety Haccp #004","8.697","6.239","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Food Safety Haccp #004","Food Safety Haccp #005","6.583","7.958","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Safety Haccp #005","Food Safety Haccp #001","6.854","6.896","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":687},{"label":"Mar","value":911},{"label":"Abr","value":743},{"label":"Mai","value":773},{"label":"Jun","value":780},{"label":"Jul","value":528},{"label":"Ago","value":539},{"label":"Set","value":841},{"label":"Out","value":895},{"label":"Nov","value":540},{"label":"Dez","value":643}];
const MX = 911;
...
export default function SqfPage() {
    return (
