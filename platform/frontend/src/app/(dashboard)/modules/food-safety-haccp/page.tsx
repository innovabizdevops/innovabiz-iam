...
export default function FoodSafetyHaccpPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Food Safety Haccp</h1><p className="text-sm text-muted-foreground">Food Safety Haccp • iBOS Enterprise</p></div>
