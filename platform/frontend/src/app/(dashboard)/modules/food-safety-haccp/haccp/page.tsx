...
const PAGE = "HACCP Plan";
const KPIS = [{"l":"Total Food Safety Haccp","v":"6.456","t":"+15.4%","d":"up"},{"l":"HACCP Plan Ativos","v":"1.288","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"79","t":"-0.8%","d":"down"}];
const COLS = ["ID","HACCP Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Safety Haccp #001","Food Safety Haccp #002","1.562","7.902","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Food Safety Haccp #002","Food Safety Haccp #003","2.751","306","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Safety Haccp #003","Food Safety Haccp #004","6.415","5.344","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Food Safety Haccp #004","Food Safety Haccp #005","4.786","7.122","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Safety Haccp #005","Food Safety Haccp #001","8.598","1.533","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":546},{"label":"Mar","value":452},{"label":"Abr","value":514},{"label":"Mai","value":526},{"label":"Jun","value":391},{"label":"Jul","value":463},{"label":"Ago","value":288},{"label":"Set","value":640},{"label":"Out","value":525},{"label":"Nov","value":324},{"label":"Dez","value":575}];
const MX = 640;
