...
const PAGE = "Cast";
const KPIS = [{"l":"Total Pump Valve Mfg","v":"7.387","t":"+11.8%","d":"up"},{"l":"Cast Ativos","v":"3.801","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"93","t":"+16.9%","d":"up"}];
const COLS = ["ID","Cast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pump Valve Mfg #001","Pump Valve Mfg #002","2.552","1.796","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Pump Valve Mfg #002","Pump Valve Mfg #003","4.071","7.344","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pump Valve Mfg #003","Pump Valve Mfg #004","6.039","2.813","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Pump Valve Mfg #004","Pump Valve Mfg #005","7.018","2.290","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pump Valve Mfg #005","Pump Valve Mfg #001","5.460","4.719","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":902},{"label":"Mar","value":704},{"label":"Abr","value":784},{"label":"Mai","value":717},{"label":"Jun","value":808},{"label":"Jul","value":721},{"label":"Ago","value":754},{"label":"Set","value":1020},{"label":"Out","value":941},{"label":"Nov","value":743},{"label":"Dez","value":985}];
const MX = 1020;
