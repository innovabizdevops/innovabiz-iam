...
/* ═══ Pump & Valve Mfg — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "473", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "704", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€265K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "882466573", cells: ["PUM-8573", "Pump & Valve Mfg Item 1", "10/2/2026", "€16 673"], status: "active" as const },
    { id: "882470144", cells: ["PUM-3144", "Pump & Valve Mfg Item 2", "25/9/2026", "€20 244"], status: "pending" as const },
    { id: "882473715", cells: ["PUM-6715", "Pump & Valve Mfg Item 3", "12/4/2026", "€23 815"], status: "completed" as const },
    { id: "882477286", cells: ["PUM-1286", "Pump & Valve Mfg Item 4", "27/11/2026", "€27 386"], status: "warning" as const },
    { id: "882480857", cells: ["PUM-4857", "Pump & Valve Mfg Item 5", "14/6/2026", "€30 957"], status: "active" as const },
];
...
export default function PumpValveMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pump & Valve Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pump & Valve Mfg</p>
                    </div>
                </div>
