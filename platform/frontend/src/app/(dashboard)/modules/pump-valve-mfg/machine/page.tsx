...
const ACCENT = "#b45309";
const MODULE = "Pump & Valve Mfg";
const PAGE = "Machine";
const KPIS = [{"l":"Total Pump Valve Mfg","v":"6.264","t":"+12.9%","d":"up"},{"l":"Machine Ativos","v":"4.302","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"70","t":"-4.4%","d":"down"}];
const COLS = ["ID","Machine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pump Valve Mfg #001","Pump Valve Mfg #002","1.148","5.384","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pump Valve Mfg #002","Pump Valve Mfg #003","2.400","4.831","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Pump Valve Mfg #003","Pump Valve Mfg #004","2.182","220","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Pump Valve Mfg #004","Pump Valve Mfg #005","5.021","7.757","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pump Valve Mfg #005","Pump Valve Mfg #001","4.464","2.974","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":649},{"label":"Mar","value":624},{"label":"Abr","value":354},{"label":"Mai","value":561},{"label":"Jun","value":343},{"label":"Jul","value":344},{"label":"Ago","value":279},{"label":"Set","value":350},{"label":"Out","value":642},{"label":"Nov","value":491},{"label":"Dez","value":572}];
const MX = 649;
