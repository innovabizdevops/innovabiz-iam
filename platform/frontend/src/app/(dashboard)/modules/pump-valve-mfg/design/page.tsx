...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.147","t":"+11.4%","d":"up"},{"l":"Submissões/Dia","v":"637","t":"+10.8%","d":"up"},{"l":"Documentos Gerados","v":"123","t":"+5.9%","d":"up"},{"l":"Templates","v":"1.336","t":"+6.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.908","2026-03-05","626","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.176","2026-01-02","7.747","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.775","2026-03-23","5.803","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.671","2026-03-12","105","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.516","2026-02-08","7.311","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":458},{"label":"Mar","value":679},{"label":"Abr","value":458},{"label":"Mai","value":332},{"label":"Jun","value":440},{"label":"Jul","value":352},{"label":"Ago","value":689},{"label":"Set","value":612},{"label":"Out","value":568},{"label":"Nov","value":388},{"label":"Dez","value":640}];
const MX = 689;
