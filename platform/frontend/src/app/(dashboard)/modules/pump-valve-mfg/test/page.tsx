...
const PAGE = "Test";
const KPIS = [{"l":"Total Pump Valve Mfg","v":"8.626","t":"+6.6%","d":"up"},{"l":"Test Ativos","v":"2.984","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"91.5%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"68","t":"+15.7%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pump Valve Mfg #001","Pump Valve Mfg #002","7.653","8.782","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Pump Valve Mfg #002","Pump Valve Mfg #003","8.483","5.768","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Pump Valve Mfg #003","Pump Valve Mfg #004","3.846","5.368","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Pump Valve Mfg #004","Pump Valve Mfg #005","3.439","6.784","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pump Valve Mfg #005","Pump Valve Mfg #001","8.875","2.229","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":744},{"label":"Mar","value":836},{"label":"Abr","value":765},{"label":"Mai","value":845},{"label":"Jun","value":1057},{"label":"Jul","value":698},{"label":"Ago","value":807},{"label":"Set","value":796},{"label":"Out","value":708},{"label":"Nov","value":803},{"label":"Dez","value":883}];
const MX = 1057;
