...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.850","t":"-0.5%","d":"down"},{"l":"NC Abertas","v":"9.012","t":"-1.7%","d":"down"},{"l":"Conformidade (%)","v":"74.1%","t":"+1.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.594","t":"+16.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.977","79.5%","2.251","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.201","71.4%","3.474","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.815","80.0%","7.694","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.688","93.7%","7.273","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.739","88.7%","659","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":901},{"label":"Mar","value":709},{"label":"Abr","value":1026},{"label":"Mai","value":734},{"label":"Jun","value":996},{"label":"Jul","value":946},{"label":"Ago","value":925},{"label":"Set","value":913},{"label":"Out","value":947},{"label":"Nov","value":798},{"label":"Dez","value":689}];
const MX = 1026;
