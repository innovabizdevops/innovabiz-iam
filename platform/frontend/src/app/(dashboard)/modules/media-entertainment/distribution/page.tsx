...
const KPIS = [{"l":"Integrações Ativas","v":"322","t":"-5.6%","d":"down"},{"l":"Chamadas/Hora","v":"4817","t":"+6.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.8%","t":"-1.4%","d":"down"},{"l":"Latência Média (ms)","v":"103ms","t":"+3.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.221","4.609","83.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.039","6.319","95.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","9.000","4.531","71.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.114","7.852","74.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.585","2.290","87.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":564},{"label":"Mar","value":454},{"label":"Abr","value":241},{"label":"Mai","value":252},{"label":"Jun","value":482},{"label":"Jul","value":511},{"label":"Ago","value":231},{"label":"Set","value":229},{"label":"Out","value":527},{"label":"Nov","value":421},{"label":"Dez","value":395}];
const MX = 564;
