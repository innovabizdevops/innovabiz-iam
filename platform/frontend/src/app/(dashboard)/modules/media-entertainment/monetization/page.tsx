...
const KPIS = [{"l":"ARR (€M)","v":"€32.5M","t":"-1.7%","d":"down"},{"l":"MRR (€)","v":"€75473","t":"+4.2%","d":"up"},{"l":"Churn (%)","v":"80.5%","t":"+4.4%","d":"up"},{"l":"ARPU (€)","v":"€61984","t":"+13.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 23392.54","8.820","€ 31540.38","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 32879.37","7.896","€ 48291.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 22145.16","1.987","€ 9164.52","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 35047.88","3.515","€ 46205.96","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11806.09","8.481","€ 10016.89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":369},{"label":"Mar","value":524},{"label":"Abr","value":537},{"label":"Mai","value":272},{"label":"Jun","value":588},{"label":"Jul","value":565},{"label":"Ago","value":436},{"label":"Set","value":353},{"label":"Out","value":496},{"label":"Nov","value":479},{"label":"Dez","value":553}];
const MX = 588;
