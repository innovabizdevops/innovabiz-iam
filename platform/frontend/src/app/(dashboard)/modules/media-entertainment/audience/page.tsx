...
const ACCENT = "#a21caf";
const MODULE = "Media & Entertainment";
const PAGE = "Audience Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.027","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"3467","t":"+14.0%","d":"up"},{"l":"Dados Processados (GB)","v":"629","t":"+14.4%","d":"up"},{"l":"Utilizadores Analytics","v":"2.914","t":"+5.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4244","2026-02-12","4.682","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1712","2026-01-10","2.411","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1003","2026-01-27","6.949","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","651","2026-02-08","2.725","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2185","2026-03-22","8.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":835},{"label":"Mar","value":611},{"label":"Abr","value":881},{"label":"Mai","value":863},{"label":"Jun","value":918},{"label":"Jul","value":840},{"label":"Ago","value":791},{"label":"Set","value":653},{"label":"Out","value":603},{"label":"Nov","value":921},{"label":"Dez","value":713}];
const MX = 921;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a21caf'}}>AI</span></h1>
                </div>
