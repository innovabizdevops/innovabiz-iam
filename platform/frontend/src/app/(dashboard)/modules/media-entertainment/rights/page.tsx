...
const KPIS = [{"l":"Integrações Ativas","v":"3.801","t":"+0.7%","d":"up"},{"l":"Chamadas/Hora","v":"2552","t":"+13.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.3%","t":"+6.8%","d":"up"},{"l":"Latência Média (ms)","v":"115ms","t":"+3.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.512","705","72.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.574","9.018","89.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.241","8.619","99.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.961","1.427","93.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.083","4.436","99.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":455},{"label":"Mar","value":592},{"label":"Abr","value":673},{"label":"Mai","value":697},{"label":"Jun","value":557},{"label":"Jul","value":730},{"label":"Ago","value":384},{"label":"Set","value":756},{"label":"Out","value":716},{"label":"Nov","value":439},{"label":"Dez","value":460}];
const MX = 756;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a21caf'}}>DRM</span></h1>
                </div>
