...
const PAGE = "Content Studio";
const KPIS = [{"l":"Integrações Ativas","v":"817","t":"-0.6%","d":"down"},{"l":"Chamadas/Hora","v":"4495","t":"+3.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.3%","t":"+6.9%","d":"up"},{"l":"Latência Média (ms)","v":"53ms","t":"-2.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.110","4.526","92.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.116","4.717","80.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.583","4.352","89.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.393","3.860","86.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.328","6.291","88.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":670},{"label":"Mar","value":597},{"label":"Abr","value":490},{"label":"Mai","value":525},{"label":"Jun","value":500},{"label":"Jul","value":687},{"label":"Ago","value":478},{"label":"Set","value":421},{"label":"Out","value":437},{"label":"Nov","value":408},{"label":"Dez","value":419}];
const MX = 701;
