...
const KPIS = [{"l":"Integrações Ativas","v":"8.563","t":"+1.8%","d":"up"},{"l":"Chamadas/Hora","v":"3523","t":"-0.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"74.2%","t":"+2.1%","d":"up"},{"l":"Latência Média (ms)","v":"148ms","t":"+4.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.229","4.695","89.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.076","401","81.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.416","6.714","70.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.643","5.482","84.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.728","3.001","96.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":454},{"label":"Mar","value":335},{"label":"Abr","value":602},{"label":"Mai","value":583},{"label":"Jun","value":546},{"label":"Jul","value":618},{"label":"Ago","value":434},{"label":"Set","value":614},{"label":"Out","value":376},{"label":"Nov","value":575},{"label":"Dez","value":349}];
const MX = 618;
