...
const PAGE = "Trade Finance";
const KPIS = [{"l":"Total Financial Services","v":"7.988","t":"+1.1%","d":"up"},{"l":"Trade Finance Ativos","v":"1.517","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"85","t":"+2.1%","d":"up"}];
const COLS = ["ID","Trade Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","5.681","6.156","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","6.280","7.141","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","3.174","1.350","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","1.886","2.945","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","6.023","6.233","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":685},{"label":"Mar","value":739},{"label":"Abr","value":839},{"label":"Mai","value":820},{"label":"Jun","value":681},{"label":"Jul","value":767},{"label":"Ago","value":671},{"label":"Set","value":914},{"label":"Out","value":1004},{"label":"Nov","value":1006},{"label":"Dez","value":847}];
const MX = 1006;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>BIAN</span></h1>
                </div>
