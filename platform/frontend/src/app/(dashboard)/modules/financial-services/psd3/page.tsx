...
const PAGE = "PSD3 Readiness";
const KPIS = [{"l":"Total Financial Services","v":"368","t":"+10.5%","d":"up"},{"l":"PSD3 Readiness Ativos","v":"2.965","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"88.5%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+15.2%","d":"up"}];
const COLS = ["ID","PSD3 Readiness","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","8.129","1.437","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","7.740","7.910","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","2.035","1.256","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","2.703","3.323","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","7.958","8.165","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":670},{"label":"Mar","value":692},{"label":"Abr","value":773},{"label":"Mai","value":634},{"label":"Jun","value":766},{"label":"Jul","value":756},{"label":"Ago","value":889},{"label":"Set","value":729},{"label":"Out","value":863},{"label":"Nov","value":886},{"label":"Dez","value":761}];
const MX = 889;
...
export default function Psd3Page() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>EU</span></h1>
                </div>
