...
const PAGE = "KYC/AML Flow";
const KPIS = [{"l":"Total Financial Services","v":"652","t":"+3.2%","d":"up"},{"l":"KYC/AML Flow Ativos","v":"2.230","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"81","t":"-5.3%","d":"down"}];
const COLS = ["ID","KYC/AML Flow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","5.525","8.479","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","1.776","6.157","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","6.258","5.622","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","8.550","6.212","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","5.140","6.030","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":495},{"label":"Mar","value":728},{"label":"Abr","value":793},{"label":"Mai","value":807},{"label":"Jun","value":564},{"label":"Jul","value":476},{"label":"Ago","value":605},{"label":"Set","value":563},{"label":"Out","value":779},{"label":"Nov","value":726},{"label":"Dez","value":473}];
const MX = 807;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>FATF</span></h1>
                </div>
