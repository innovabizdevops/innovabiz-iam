...
const PAGE = "Open Banking";
const KPIS = [{"l":"Total Financial Services","v":"1.806","t":"+4.5%","d":"up"},{"l":"Open Banking Ativos","v":"8.728","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"59","t":"+12.8%","d":"up"}];
const COLS = ["ID","Open Banking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","2.619","8.321","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","7.846","1.359","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","1.709","958","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","1.902","2.803","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","1.526","2.290","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":908},{"label":"Mar","value":676},{"label":"Abr","value":729},{"label":"Mai","value":722},{"label":"Jun","value":807},{"label":"Jul","value":599},{"label":"Ago","value":744},{"label":"Set","value":831},{"label":"Out","value":638},{"label":"Nov","value":730},{"label":"Dez","value":726}];
const MX = 908;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>API</span></h1>
                </div>
