...
const PAGE = "Lending Platform";
const KPIS = [{"l":"Formulários Ativos","v":"8.655","t":"-3.8%","d":"down"},{"l":"Submissões/Dia","v":"2553","t":"+17.7%","d":"up"},{"l":"Documentos Gerados","v":"3.996","t":"+16.8%","d":"up"},{"l":"Templates","v":"6.860","t":"+10.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.799","2026-03-09","6.711","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.145","2026-03-07","3.140","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.000","2026-03-10","7.002","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.937","2026-01-27","8.882","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","273","2026-03-03","4.409","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":698},{"label":"Mar","value":698},{"label":"Abr","value":542},{"label":"Mai","value":841},{"label":"Jun","value":696},{"label":"Jul","value":791},{"label":"Ago","value":465},{"label":"Set","value":525},{"label":"Out","value":577},{"label":"Nov","value":643},{"label":"Dez","value":764}];
const MX = 853;
