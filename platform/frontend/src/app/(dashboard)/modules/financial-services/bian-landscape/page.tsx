...
const PAGE = "BIAN Service Landscape";
const KPIS = [{"l":"BCP Plans Ativos","v":"5.446","t":"+12.2%","d":"up"},{"l":"RTO Médio (h)","v":"41h","t":"+16.3%","d":"up"},{"l":"RPO Médio (h)","v":"178h","t":"-1.3%","d":"down"},{"l":"Testes DR (YTD)","v":"7.701","t":"-1.8%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","194h","87h","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","77h","39h","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","180h","171h","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","145h","147h","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","37h","66h","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":828},{"label":"Mar","value":532},{"label":"Abr","value":773},{"label":"Mai","value":904},{"label":"Jun","value":561},{"label":"Jul","value":564},{"label":"Ago","value":675},{"label":"Set","value":881},{"label":"Out","value":636},{"label":"Nov","value":900},{"label":"Dez","value":885}];
const MX = 904;
...
export default function BianLandscapePage() {
    return (
