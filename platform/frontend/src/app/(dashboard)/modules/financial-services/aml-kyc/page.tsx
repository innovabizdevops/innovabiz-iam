...
const PAGE = "AML/KYC AI";
const KPIS = [{"l":"Total Financial Services","v":"943","t":"-1.5%","d":"down"},{"l":"AML/KYC AI Ativos","v":"8.618","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"89.9%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"80","t":"+16.6%","d":"up"}];
const COLS = ["ID","AML/KYC AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","649","5.877","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","6.141","3.227","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","9.057","8.129","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","2.098","309","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","5.320","4.243","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":604},{"label":"Mar","value":880},{"label":"Abr","value":522},{"label":"Mai","value":693},{"label":"Jun","value":535},{"label":"Jul","value":861},{"label":"Ago","value":857},{"label":"Set","value":878},{"label":"Out","value":732},{"label":"Nov","value":524},{"label":"Dez","value":864}];
const MX = 880;
