...
const PAGE = "Core Banking";
const KPIS = [{"l":"Total Financial Services","v":"5.851","t":"+3.4%","d":"up"},{"l":"Core Banking Ativos","v":"6.869","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"92.7%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"70","t":"+16.8%","d":"up"}];
const COLS = ["ID","Core Banking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","2.987","5.970","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","3.921","3.328","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","1.386","6.003","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","2.673","6.782","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","2.693","222","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":439},{"label":"Mar","value":449},{"label":"Abr","value":403},{"label":"Mai","value":446},{"label":"Jun","value":519},{"label":"Jul","value":545},{"label":"Ago","value":440},{"label":"Set","value":611},{"label":"Out","value":440},{"label":"Nov","value":602},{"label":"Dez","value":391}];
const MX = 611;
