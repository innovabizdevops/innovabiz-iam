...
const PAGE = "Banking &amp; Lending";
const KPIS = [{"l":"Total Financial Services","v":"8.924","t":"+15.7%","d":"up"},{"l":"Banking & Lending Ativos","v":"8.555","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"66.3%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"56","t":"-3.2%","d":"down"}];
const COLS = ["ID","Banking & Lending","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","5.586","4.537","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","644","1.191","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","7.100","5.659","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","1.223","9.039","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","3.829","705","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":378},{"label":"Mar","value":642},{"label":"Abr","value":560},{"label":"Mai","value":652},{"label":"Jun","value":659},{"label":"Jul","value":659},{"label":"Ago","value":571},{"label":"Set","value":713},{"label":"Out","value":673},{"label":"Nov","value":443},{"label":"Dez","value":505}];
const MX = 713;
