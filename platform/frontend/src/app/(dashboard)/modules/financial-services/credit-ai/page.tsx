...
const PAGE = "Credit Scoring AI";
const KPIS = [{"l":"Integrações Ativas","v":"3.890","t":"+2.6%","d":"up"},{"l":"Chamadas/Hora","v":"4143","t":"+7.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.4%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"46ms","t":"+7.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.716","7.956","81.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.900","1.049","79.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.732","8.813","90.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.295","3.348","72.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.415","5.682","83.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":496},{"label":"Mar","value":594},{"label":"Abr","value":682},{"label":"Mai","value":600},{"label":"Jun","value":494},{"label":"Jul","value":471},{"label":"Ago","value":446},{"label":"Set","value":448},{"label":"Out","value":442},{"label":"Nov","value":366},{"label":"Dez","value":401}];
const MX = 682;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>ML</span></h1>
                </div>
