...
const PAGE = "Insurance Platform";
const KPIS = [{"l":"Formulários Ativos","v":"7.940","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"1879","t":"+5.0%","d":"up"},{"l":"Documentos Gerados","v":"2.723","t":"+9.7%","d":"up"},{"l":"Templates","v":"7.900","t":"+5.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.406","2026-02-11","5.137","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.532","2026-03-17","6.009","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","478","2026-03-25","2.960","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.662","2026-01-27","2.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.361","2026-03-24","6.111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":611},{"label":"Mar","value":796},{"label":"Abr","value":579},{"label":"Mai","value":503},{"label":"Jun","value":700},{"label":"Jul","value":891},{"label":"Ago","value":594},{"label":"Set","value":860},{"label":"Out","value":756},{"label":"Nov","value":831},{"label":"Dez","value":887}];
const MX = 891;
