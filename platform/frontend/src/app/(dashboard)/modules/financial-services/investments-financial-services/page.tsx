...
const PAGE = "Wealth Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.789","t":"+4.3%","d":"up"},{"l":"Savings (€)","v":"€97184","t":"+9.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.7%","t":"-2.3%","d":"down"},{"l":"Ciclos PDCA","v":"8.917","t":"-5.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.485","€ 39951.98","482","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.126","€ 23341.49","2.594","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.011","€ 45739.94","7.725","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.561","€ 34990.53","6.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.113","€ 977.73","4.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":673},{"label":"Mar","value":387},{"label":"Abr","value":677},{"label":"Mai","value":612},{"label":"Jun","value":347},{"label":"Jul","value":597},{"label":"Ago","value":670},{"label":"Set","value":585},{"label":"Out","value":427},{"label":"Nov","value":410},{"label":"Dez","value":549}];
const MX = 677;
...
export default function InvestmentsFinancialServicesPage() {
    return (
