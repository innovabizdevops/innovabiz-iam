...
const PAGE = "Basel III Reporting";
const KPIS = [{"l":"Total Financial Services","v":"2.080","t":"+0.8%","d":"up"},{"l":"Basel III Reporting Ativos","v":"1.206","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"58","t":"+8.2%","d":"up"}];
const COLS = ["ID","Basel III Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","2.217","2.334","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","793","5.691","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","1.798","3.819","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","7.952","4.805","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","6.930","446","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":664},{"label":"Mar","value":653},{"label":"Abr","value":539},{"label":"Mai","value":520},{"label":"Jun","value":599},{"label":"Jul","value":568},{"label":"Ago","value":564},{"label":"Set","value":604},{"label":"Out","value":662},{"label":"Nov","value":534},{"label":"Dez","value":550}];
const MX = 664;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>Basel</span></h1>
                </div>
