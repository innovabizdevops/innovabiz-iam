...
const PAGE = "Account Opening Form";
const KPIS = [{"l":"Formulários Ativos","v":"5.683","t":"+12.9%","d":"up"},{"l":"Submissões/Dia","v":"708","t":"+8.5%","d":"up"},{"l":"Documentos Gerados","v":"7.594","t":"+8.9%","d":"up"},{"l":"Templates","v":"5.922","t":"+10.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.135","2026-02-17","608","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.966","2026-02-09","7.437","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.557","2026-01-03","1.870","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.152","2026-02-23","1.493","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","211","2026-01-10","509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":790},{"label":"Mar","value":867},{"label":"Abr","value":696},{"label":"Mai","value":920},{"label":"Jun","value":840},{"label":"Jul","value":963},{"label":"Ago","value":689},{"label":"Set","value":795},{"label":"Out","value":712},{"label":"Nov","value":955},{"label":"Dez","value":812}];
const MX = 963;
