...
const PAGE = "ISO 20022 Messaging";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.753","t":"-3.9%","d":"down"},{"l":"NC Abertas","v":"442","t":"+12.6%","d":"up"},{"l":"Conformidade (%)","v":"93.2%","t":"+17.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.871","t":"-5.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","867","73.2%","7.536","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.565","92.0%","2.257","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.166","94.0%","5.270","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.433","79.5%","350","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.266","92.3%","1.588","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":364},{"label":"Fev","value":568},{"label":"Mar","value":517},{"label":"Abr","value":443},{"label":"Mai","value":548},{"label":"Jun","value":389},{"label":"Jul","value":648},{"label":"Ago","value":434},{"label":"Set","value":557},{"label":"Out","value":503},{"label":"Nov","value":568},{"label":"Dez","value":382}];
const MX = 648;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>ISO</span></h1>
                </div>
