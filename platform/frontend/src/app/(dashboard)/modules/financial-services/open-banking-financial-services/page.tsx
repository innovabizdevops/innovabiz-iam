...
const ACCENT = "#0f766e";
const MODULE = "Financial Services Cloud";
const PAGE = "Open Banking PSD2";
const KPIS = [{"l":"Total Financial Services","v":"5.127","t":"+11.7%","d":"up"},{"l":"Open Banking PSD2 Ativos","v":"6.827","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+16.6%","d":"up"}];
const COLS = ["ID","Open Banking PSD2","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","7.060","3.813","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","3.601","5.756","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","8.816","6.476","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","1.876","1.037","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","3.761","3.700","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":747},{"label":"Mar","value":483},{"label":"Abr","value":637},{"label":"Mai","value":779},{"label":"Jun","value":570},{"label":"Jul","value":607},{"label":"Ago","value":468},{"label":"Set","value":464},{"label":"Out","value":545},{"label":"Nov","value":674},{"label":"Dez","value":629}];
const MX = 779;
...
export default function OpenBankingFinancialServicesPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>PSD2</span></h1>
                </div>
