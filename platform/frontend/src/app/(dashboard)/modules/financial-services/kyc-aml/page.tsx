...
const PAGE = "KYC/AML";
const KPIS = [{"l":"Total Financial Services","v":"6.200","t":"+10.4%","d":"up"},{"l":"KYC/AML Ativos","v":"573","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"76","t":"-1.1%","d":"down"}];
const COLS = ["ID","KYC/AML","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","928","8.592","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","5.867","8.707","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","2.507","7.787","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","2.398","3.577","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","470","6.724","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":338},{"label":"Mar","value":469},{"label":"Abr","value":481},{"label":"Mai","value":395},{"label":"Jun","value":495},{"label":"Jul","value":592},{"label":"Ago","value":419},{"label":"Set","value":658},{"label":"Out","value":444},{"label":"Nov","value":508},{"label":"Dez","value":405}];
const MX = 658;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>Compliance</span></h1>
                </div>
