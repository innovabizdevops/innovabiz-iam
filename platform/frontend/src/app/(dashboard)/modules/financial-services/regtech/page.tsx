...
const PAGE = "RegTech";
const KPIS = [{"l":"Total Financial Services","v":"5.188","t":"+3.7%","d":"up"},{"l":"RegTech Ativos","v":"8.613","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+4.4%","d":"up"}];
const COLS = ["ID","RegTech","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Financial Services #001","Financial Services #002","7.685","1.923","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Financial Services #002","Financial Services #003","2.179","8.078","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Financial Services #003","Financial Services #004","1.209","1.978","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Financial Services #004","Financial Services #005","134","7.196","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Financial Services #005","Financial Services #001","7.964","6.217","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":857},{"label":"Mar","value":637},{"label":"Abr","value":790},{"label":"Mai","value":788},{"label":"Jun","value":709},{"label":"Jul","value":768},{"label":"Ago","value":613},{"label":"Set","value":750},{"label":"Out","value":738},{"label":"Nov","value":613},{"label":"Dez","value":747}];
const MX = 906;
