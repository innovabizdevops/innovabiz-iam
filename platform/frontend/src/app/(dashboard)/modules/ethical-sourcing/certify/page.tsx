...
const PAGE = "Certify";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.481","t":"-6.0%","d":"down"},{"l":"Contratos (€M)","v":"€40.7M","t":"-3.9%","d":"down"},{"l":"On-Time Delivery (%)","v":"84.2%","t":"+11.7%","d":"up"},{"l":"Score Médio","v":"85","t":"+3.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","91.6%","€ 33339.04","8.461","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","77.5%","€ 8002.80","4.980","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.2%","€ 43606.14","6.003","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","77.9%","€ 3492.86","3.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","73.8%","€ 39012.16","284","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":798},{"label":"Mar","value":761},{"label":"Abr","value":485},{"label":"Mai","value":808},{"label":"Jun","value":526},{"label":"Jul","value":640},{"label":"Ago","value":758},{"label":"Set","value":515},{"label":"Out","value":644},{"label":"Nov","value":721},{"label":"Dez","value":643}];
const MX = 808;
