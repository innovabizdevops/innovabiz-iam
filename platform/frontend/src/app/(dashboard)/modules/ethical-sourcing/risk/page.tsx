...
const ACCENT = "#166534";
const MODULE = "Ethical Sourcing Platform";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"2.397","t":"+2.7%","d":"up"},{"l":"Mitigações Ativas","v":"6.230","t":"+8.6%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+13.0%","d":"up"},{"l":"Incidentes YTD","v":"4.053","t":"+17.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.783","8.170","5.600","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.949","8.069","3.051","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","155","2.171","6.679","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.012","7.163","4.198","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.483","1.682","6.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":676},{"label":"Mar","value":633},{"label":"Abr","value":475},{"label":"Mai","value":505},{"label":"Jun","value":433},{"label":"Jul","value":681},{"label":"Ago","value":796},{"label":"Set","value":442},{"label":"Out","value":718},{"label":"Nov","value":641},{"label":"Dez","value":449}];
const MX = 796;
