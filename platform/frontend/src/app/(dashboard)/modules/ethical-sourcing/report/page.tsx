...
const PAGE = "Report";
const KPIS = [{"l":"Fornecedores Ativos","v":"497","t":"-4.4%","d":"down"},{"l":"Contratos (€M)","v":"€27.9M","t":"+15.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"79.5%","t":"-3.3%","d":"down"},{"l":"Score Médio","v":"85","t":"+9.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","91.8%","€ 4908.16","3.368","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","75.4%","€ 31970.69","2.060","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","90.0%","€ 42240.60","752","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","99.0%","€ 5114.99","6.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","73.4%","€ 11548.35","2.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":602},{"label":"Mar","value":588},{"label":"Abr","value":858},{"label":"Mai","value":696},{"label":"Jun","value":667},{"label":"Jul","value":526},{"label":"Ago","value":685},{"label":"Set","value":759},{"label":"Out","value":676},{"label":"Nov","value":562},{"label":"Dez","value":592}];
const MX = 858;
