...
const PAGE = "Trace";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.395","t":"+0.0%","d":"up"},{"l":"Contratos (€M)","v":"€5.0M","t":"+7.9%","d":"up"},{"l":"On-Time Delivery (%)","v":"67.7%","t":"+2.3%","d":"up"},{"l":"Score Médio","v":"75","t":"+13.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","97.4%","€ 11686.83","7.651","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","89.9%","€ 6943.21","7.165","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","77.0%","€ 30127.06","6.359","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","88.4%","€ 13318.36","897","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","74.3%","€ 23752.79","1.117","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":443},{"label":"Mar","value":524},{"label":"Abr","value":662},{"label":"Mai","value":518},{"label":"Jun","value":646},{"label":"Jul","value":709},{"label":"Ago","value":604},{"label":"Set","value":385},{"label":"Out","value":713},{"label":"Nov","value":536},{"label":"Dez","value":545}];
const MX = 715;
