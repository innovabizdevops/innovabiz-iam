...
/* ═══ Ethical Sourcing Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "8458", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "865", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€86K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "164724558", cells: ["ETH-7558", "Ethical Sourcing Platform Item 1", "27/7/2026", "€24 658"], status: "active" as const },
    { id: "164728129", cells: ["ETH-2129", "Ethical Sourcing Platform Item 2", "14/2/2026", "€28 229"], status: "pending" as const },
    { id: "164731700", cells: ["ETH-5700", "Ethical Sourcing Platform Item 3", "1/9/2026", "€31 800"], status: "completed" as const },
    { id: "164735271", cells: ["ETH-9271", "Ethical Sourcing Platform Item 4", "16/4/2026", "€35 371"], status: "warning" as const },
    { id: "164738842", cells: ["ETH-3842", "Ethical Sourcing Platform Item 5", "3/11/2026", "€38 942"], status: "active" as const },
];
...
export default function EthicalSourcingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ethical Sourcing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Ethical Sourcing Platform</p>
                    </div>
                </div>
