...
const PAGE = "Seal";
const KPIS = [{"l":"Total Packaging Line","v":"3.521","t":"+7.5%","d":"up"},{"l":"Seal Ativos","v":"1.794","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"84","t":"-5.9%","d":"down"}];
const COLS = ["ID","Seal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Line #001","Packaging Line #002","5.122","6.176","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Line #002","Packaging Line #003","7.444","1.932","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Line #003","Packaging Line #004","3.544","8.849","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Line #004","Packaging Line #005","1.580","5.588","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Line #005","Packaging Line #001","3.430","3.744","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":527},{"label":"Mar","value":696},{"label":"Abr","value":695},{"label":"Mai","value":632},{"label":"Jun","value":635},{"label":"Jul","value":654},{"label":"Ago","value":674},{"label":"Set","value":877},{"label":"Out","value":674},{"label":"Nov","value":639},{"label":"Dez","value":738}];
const MX = 877;
