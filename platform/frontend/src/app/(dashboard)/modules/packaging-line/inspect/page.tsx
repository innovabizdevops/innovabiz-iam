...
const ACCENT = "#6366f1";
const MODULE = "Packaging Line";
const PAGE = "Inspect";
const KPIS = [{"l":"Total Packaging Line","v":"7.650","t":"+5.9%","d":"up"},{"l":"Inspect Ativos","v":"5.561","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.9%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Line #001","Packaging Line #002","6.447","4.407","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Line #002","Packaging Line #003","956","8.741","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Line #003","Packaging Line #004","1.156","1.574","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Line #004","Packaging Line #005","4.134","3.391","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Line #005","Packaging Line #001","594","8.373","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":696},{"label":"Mar","value":643},{"label":"Abr","value":521},{"label":"Mai","value":653},{"label":"Jun","value":765},{"label":"Jul","value":773},{"label":"Ago","value":691},{"label":"Set","value":906},{"label":"Out","value":801},{"label":"Nov","value":661},{"label":"Dez","value":548}];
const MX = 906;
