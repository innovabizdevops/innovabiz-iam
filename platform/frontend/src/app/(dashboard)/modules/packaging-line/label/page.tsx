...
const PAGE = "Label";
const KPIS = [{"l":"Total Packaging Line","v":"1.154","t":"-4.6%","d":"down"},{"l":"Label Ativos","v":"2.588","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"73.9%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"67","t":"+18.0%","d":"up"}];
const COLS = ["ID","Label","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Line #001","Packaging Line #002","6.386","8.506","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Line #002","Packaging Line #003","5.637","2.821","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Line #003","Packaging Line #004","5.089","8.417","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Line #004","Packaging Line #005","2.336","4.607","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Line #005","Packaging Line #001","7.994","7.385","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":724},{"label":"Mar","value":642},{"label":"Abr","value":939},{"label":"Mai","value":782},{"label":"Jun","value":652},{"label":"Jul","value":768},{"label":"Ago","value":679},{"label":"Set","value":984},{"label":"Out","value":953},{"label":"Nov","value":807},{"label":"Dez","value":875}];
const MX = 984;
