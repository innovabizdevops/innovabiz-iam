...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.152","t":"+9.2%","d":"up"},{"l":"Submissões/Dia","v":"4380","t":"-0.8%","d":"down"},{"l":"Documentos Gerados","v":"5.636","t":"+14.4%","d":"up"},{"l":"Templates","v":"4.807","t":"-4.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.611","2026-02-16","3.125","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.783","2026-02-04","4.356","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.348","2026-01-24","4.768","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.327","2026-02-16","4.023","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.094","2026-01-17","8.587","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":243},{"label":"Fev","value":478},{"label":"Mar","value":528},{"label":"Abr","value":561},{"label":"Mai","value":445},{"label":"Jun","value":565},{"label":"Jul","value":436},{"label":"Ago","value":320},{"label":"Set","value":491},{"label":"Out","value":422},{"label":"Nov","value":559},{"label":"Dez","value":364}];
const MX = 565;
