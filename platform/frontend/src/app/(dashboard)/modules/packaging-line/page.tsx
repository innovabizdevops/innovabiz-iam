...
export default function PackagingLinePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Packaging Line</h1><p className="text-sm text-muted-foreground">Packaging Line • iBOS Enterprise</p></div>
