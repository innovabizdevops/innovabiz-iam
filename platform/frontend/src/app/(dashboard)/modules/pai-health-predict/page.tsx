...
/* ═══ P-AI Health Prediction — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "7548", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3252", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€160K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "338379548", cells: ["PAI-7548", "P-AI Health Prediction Item 1", "25/9/2026", "€29 648"], status: "active" as const },
    { id: "338383119", cells: ["PAI-2119", "P-AI Health Prediction Item 2", "12/4/2026", "€33 219"], status: "pending" as const },
    { id: "338386690", cells: ["PAI-5690", "P-AI Health Prediction Item 3", "27/11/2026", "€36 790"], status: "completed" as const },
    { id: "338390261", cells: ["PAI-9261", "P-AI Health Prediction Item 4", "14/6/2026", "€40 361"], status: "warning" as const },
    { id: "338393832", cells: ["PAI-3832", "P-AI Health Prediction Item 5", "1/1/2026", "€43 932"], status: "active" as const },
];
...
export default function PaiHealthPredictionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Health Prediction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Health Prediction</p>
                    </div>
                </div>
