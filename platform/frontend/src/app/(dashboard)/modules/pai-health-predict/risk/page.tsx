...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Health Prediction";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.846","t":"+9.4%","d":"up"},{"l":"Mitigações Ativas","v":"5.796","t":"+15.8%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"+4.2%","d":"up"},{"l":"Incidentes YTD","v":"8.302","t":"+0.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.085","1.628","6.275","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.270","8.615","7.341","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.932","573","2.688","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.919","1.171","2.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.464","2.018","7.163","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":752},{"label":"Mar","value":718},{"label":"Abr","value":766},{"label":"Mai","value":565},{"label":"Jun","value":768},{"label":"Jul","value":498},{"label":"Ago","value":843},{"label":"Set","value":840},{"label":"Out","value":523},{"label":"Nov","value":637},{"label":"Dez","value":626}];
const MX = 843;
