...
const PAGE = "Model";
const KPIS = [{"l":"Integrações Ativas","v":"1.154","t":"+5.9%","d":"up"},{"l":"Chamadas/Hora","v":"599","t":"+5.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.7%","t":"+13.8%","d":"up"},{"l":"Latência Média (ms)","v":"172ms","t":"+14.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.265","8.610","83.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.906","5.516","77.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.395","8.118","90.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.039","2.478","86.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.235","1.629","73.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":937},{"label":"Mar","value":701},{"label":"Abr","value":752},{"label":"Mai","value":891},{"label":"Jun","value":813},{"label":"Jul","value":775},{"label":"Ago","value":881},{"label":"Set","value":655},{"label":"Out","value":950},{"label":"Nov","value":1039},{"label":"Dez","value":719}];
const MX = 1039;
