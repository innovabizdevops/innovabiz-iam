...
const PAGE = "Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"8.758","t":"+0.7%","d":"up"},{"l":"Chamadas/Hora","v":"2363","t":"-0.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"72.8%","t":"+2.3%","d":"up"},{"l":"Latência Média (ms)","v":"137ms","t":"+13.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.122","8.312","84.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.948","8.115","98.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.798","1.677","89.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.849","1.128","84.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.095","8.228","90.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":883},{"label":"Mar","value":907},{"label":"Abr","value":894},{"label":"Mai","value":627},{"label":"Jun","value":978},{"label":"Jul","value":761},{"label":"Ago","value":688},{"label":"Set","value":841},{"label":"Out","value":985},{"label":"Nov","value":708},{"label":"Dez","value":827}];
const MX = 985;
