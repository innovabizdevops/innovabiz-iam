...
const PAGE = "Intervene";
const KPIS = [{"l":"Integrações Ativas","v":"6.108","t":"+3.7%","d":"up"},{"l":"Chamadas/Hora","v":"3528","t":"+3.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.5%","t":"+16.2%","d":"up"},{"l":"Latência Média (ms)","v":"20ms","t":"-2.1%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","670","8.844","75.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.403","8.130","70.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.463","7.424","82.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.598","5.510","94.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.766","116","95.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":757},{"label":"Mar","value":789},{"label":"Abr","value":907},{"label":"Mai","value":867},{"label":"Jun","value":848},{"label":"Jul","value":882},{"label":"Ago","value":987},{"label":"Set","value":667},{"label":"Out","value":822},{"label":"Nov","value":635},{"label":"Dez","value":679}];
const MX = 987;
