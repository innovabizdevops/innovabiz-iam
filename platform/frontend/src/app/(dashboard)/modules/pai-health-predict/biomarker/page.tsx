...
const KPIS = [{"l":"Integrações Ativas","v":"5.322","t":"+16.0%","d":"up"},{"l":"Chamadas/Hora","v":"297","t":"-1.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.6%","t":"+13.5%","d":"up"},{"l":"Latência Média (ms)","v":"112ms","t":"-0.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.922","5.857","90.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.448","3.867","93.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.286","8.421","77.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.355","4.216","75.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.251","1.253","94.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":1023},{"label":"Mar","value":895},{"label":"Abr","value":730},{"label":"Mai","value":772},{"label":"Jun","value":964},{"label":"Jul","value":726},{"label":"Ago","value":946},{"label":"Set","value":746},{"label":"Out","value":1084},{"label":"Nov","value":844},{"label":"Dez","value":738}];
const MX = 1084;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0c4a6e'}}>IoT</span></h1>
                </div>
