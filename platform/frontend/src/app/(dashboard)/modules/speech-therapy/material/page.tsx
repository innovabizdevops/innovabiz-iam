...
const PAGE = "Material";
const KPIS = [{"l":"Total Speech Therapy","v":"5.539","t":"+5.5%","d":"up"},{"l":"Material Ativos","v":"5.608","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"87.2%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"58","t":"-5.9%","d":"down"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Speech Therapy #001","Speech Therapy #002","7.023","3.222","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Speech Therapy #002","Speech Therapy #003","2.167","4.524","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Speech Therapy #003","Speech Therapy #004","1.862","7.862","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Speech Therapy #004","Speech Therapy #005","7.441","7.239","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Speech Therapy #005","Speech Therapy #001","5.010","6.307","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":985},{"label":"Mar","value":1020},{"label":"Abr","value":886},{"label":"Mai","value":758},{"label":"Jun","value":999},{"label":"Jul","value":675},{"label":"Ago","value":741},{"label":"Set","value":781},{"label":"Out","value":964},{"label":"Nov","value":805},{"label":"Dez","value":784}];
const MX = 1020;
