...
const PAGE = "Client";
const KPIS = [{"l":"Total Speech Therapy","v":"211","t":"+3.5%","d":"up"},{"l":"Client Ativos","v":"2.102","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+3.2%","d":"up"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Speech Therapy #001","Speech Therapy #002","1.160","6.190","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Speech Therapy #002","Speech Therapy #003","7.782","8.920","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Speech Therapy #003","Speech Therapy #004","3.395","7.125","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Speech Therapy #004","Speech Therapy #005","5.115","7.119","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Speech Therapy #005","Speech Therapy #001","8.210","1.565","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":429},{"label":"Fev","value":298},{"label":"Mar","value":432},{"label":"Abr","value":262},{"label":"Mai","value":398},{"label":"Jun","value":460},{"label":"Jul","value":532},{"label":"Ago","value":319},{"label":"Set","value":541},{"label":"Out","value":597},{"label":"Nov","value":615},{"label":"Dez","value":417}];
const MX = 615;
