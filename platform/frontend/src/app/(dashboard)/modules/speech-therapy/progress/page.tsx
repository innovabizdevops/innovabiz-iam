...
const PAGE = "Progress";
const KPIS = [{"l":"Total Speech Therapy","v":"6.312","t":"-1.3%","d":"down"},{"l":"Progress Ativos","v":"8.603","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+6.4%","d":"up"}];
const COLS = ["ID","Progress","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Speech Therapy #001","Speech Therapy #002","5.246","6.150","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Speech Therapy #002","Speech Therapy #003","6.382","7.293","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Speech Therapy #003","Speech Therapy #004","2.921","5.887","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Speech Therapy #004","Speech Therapy #005","4.433","8.116","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Speech Therapy #005","Speech Therapy #001","2.635","6.942","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":817},{"label":"Mar","value":873},{"label":"Abr","value":549},{"label":"Mai","value":743},{"label":"Jun","value":779},{"label":"Jul","value":559},{"label":"Ago","value":522},{"label":"Set","value":526},{"label":"Out","value":894},{"label":"Nov","value":581},{"label":"Dez","value":581}];
const MX = 894;
