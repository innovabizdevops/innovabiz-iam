...
const ACCENT = "#7c3aed";
const MODULE = "Speech Therapy";
const PAGE = "Assessment";
const KPIS = [{"l":"Total Speech Therapy","v":"3.821","t":"-1.9%","d":"down"},{"l":"Assessment Ativos","v":"3.522","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"66.7%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"61","t":"-5.9%","d":"down"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Speech Therapy #001","Speech Therapy #002","3.183","6.205","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Speech Therapy #002","Speech Therapy #003","7.178","3.429","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Speech Therapy #003","Speech Therapy #004","6.178","8.997","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Speech Therapy #004","Speech Therapy #005","8.641","2.414","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Speech Therapy #005","Speech Therapy #001","8.373","2.455","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":942},{"label":"Mar","value":882},{"label":"Abr","value":1079},{"label":"Mai","value":1066},{"label":"Jun","value":994},{"label":"Jul","value":746},{"label":"Ago","value":1047},{"label":"Set","value":839},{"label":"Out","value":803},{"label":"Nov","value":1014},{"label":"Dez","value":814}];
const MX = 1079;
