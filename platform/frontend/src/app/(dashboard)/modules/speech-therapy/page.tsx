...
const KPIS = [
    { label: "Total Registos", value: "2623", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4046", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€218K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "471876123", cells: ["SPE-7123", "Speech Therapy Item 1", "20/4/2026", "€26 223"], status: "active" as const },
    { id: "471879694", cells: ["SPE-1694", "Speech Therapy Item 2", "7/11/2026", "€29 794"], status: "pending" as const },
    { id: "471883265", cells: ["SPE-5265", "Speech Therapy Item 3", "22/6/2026", "€33 365"], status: "completed" as const },
    { id: "471886836", cells: ["SPE-8836", "Speech Therapy Item 4", "9/1/2026", "€36 936"], status: "warning" as const },
    { id: "471890407", cells: ["SPE-3407", "Speech Therapy Item 5", "24/8/2026", "€40 507"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Speech Therapy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Speech Therapy</p>
                    </div>
                </div>
