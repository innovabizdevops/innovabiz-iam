...
const PAGE = "Session";
const KPIS = [{"l":"Total Speech Therapy","v":"5.116","t":"+8.0%","d":"up"},{"l":"Session Ativos","v":"2.229","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"80.0%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"94","t":"-2.2%","d":"down"}];
const COLS = ["ID","Session","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Speech Therapy #001","Speech Therapy #002","8.597","4.224","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Speech Therapy #002","Speech Therapy #003","5.509","7.609","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Speech Therapy #003","Speech Therapy #004","2.179","4.529","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Speech Therapy #004","Speech Therapy #005","3.100","6.064","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Speech Therapy #005","Speech Therapy #001","3.890","2.525","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":968},{"label":"Mar","value":950},{"label":"Abr","value":849},{"label":"Mai","value":855},{"label":"Jun","value":1060},{"label":"Jul","value":764},{"label":"Ago","value":857},{"label":"Set","value":865},{"label":"Out","value":986},{"label":"Nov","value":848},{"label":"Dez","value":684}];
const MX = 1060;
