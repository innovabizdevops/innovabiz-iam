...
const ACCENT = "#059669";
const MODULE = "RAN Management";
const PAGE = "KPI Monitor";
const KPIS = [{"l":"Total Ran Mgmt","v":"2.326","t":"+2.5%","d":"up"},{"l":"KPI Monitor Ativos","v":"8.728","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"65.3%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"91","t":"+13.8%","d":"up"}];
const COLS = ["ID","KPI Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ran Mgmt #001","Ran Mgmt #002","3.754","7.534","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Ran Mgmt #002","Ran Mgmt #003","7.283","8.767","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ran Mgmt #003","Ran Mgmt #004","2.351","1.244","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Ran Mgmt #004","Ran Mgmt #005","9.061","4.843","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ran Mgmt #005","Ran Mgmt #001","4.694","4.977","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":269},{"label":"Fev","value":510},{"label":"Mar","value":607},{"label":"Abr","value":561},{"label":"Mai","value":566},{"label":"Jun","value":240},{"label":"Jul","value":420},{"label":"Ago","value":440},{"label":"Set","value":233},{"label":"Out","value":305},{"label":"Nov","value":352},{"label":"Dez","value":513}];
const MX = 607;
