...
const PAGE = "gNodeB 5G";
const KPIS = [{"l":"Total Ran Mgmt","v":"313","t":"-4.6%","d":"down"},{"l":"GNodeB 5G Ativos","v":"1.805","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+9.6%","d":"up"}];
const COLS = ["ID","GNodeB 5G","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ran Mgmt #001","Ran Mgmt #002","3.288","3.763","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Ran Mgmt #002","Ran Mgmt #003","914","5.589","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ran Mgmt #003","Ran Mgmt #004","1.557","745","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Ran Mgmt #004","Ran Mgmt #005","7.530","1.877","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ran Mgmt #005","Ran Mgmt #001","5.844","5.774","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":609},{"label":"Mar","value":580},{"label":"Abr","value":387},{"label":"Mai","value":452},{"label":"Jun","value":736},{"label":"Jul","value":617},{"label":"Ago","value":475},{"label":"Set","value":524},{"label":"Out","value":467},{"label":"Nov","value":665},{"label":"Dez","value":537}];
const MX = 736;
...
export default function GnodebPage() {
    return (
