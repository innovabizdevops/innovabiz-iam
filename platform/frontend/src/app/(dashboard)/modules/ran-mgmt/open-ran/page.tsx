...
const PAGE = "Open RAN";
const KPIS = [{"l":"Total Ran Mgmt","v":"482","t":"+4.1%","d":"up"},{"l":"Open RAN Ativos","v":"7.464","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+10.3%","d":"up"}];
const COLS = ["ID","Open RAN","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ran Mgmt #001","Ran Mgmt #002","5.841","2.867","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ran Mgmt #002","Ran Mgmt #003","1.531","5.410","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ran Mgmt #003","Ran Mgmt #004","8.755","2.628","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Ran Mgmt #004","Ran Mgmt #005","247","2.780","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ran Mgmt #005","Ran Mgmt #001","819","1.450","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":931},{"label":"Mar","value":927},{"label":"Abr","value":870},{"label":"Mai","value":826},{"label":"Jun","value":910},{"label":"Jul","value":914},{"label":"Ago","value":606},{"label":"Set","value":748},{"label":"Out","value":799},{"label":"Nov","value":543},{"label":"Dez","value":644}];
const MX = 931;
...
export default function OpenRanPage() {
    return (
