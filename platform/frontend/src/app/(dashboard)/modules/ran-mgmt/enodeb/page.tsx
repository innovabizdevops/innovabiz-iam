...
const PAGE = "eNodeB Config";
const KPIS = [{"l":"Configurações","v":"6.913","t":"+9.9%","d":"up"},{"l":"Últimas Alterações","v":"3.508","t":"-1.1%","d":"down"},{"l":"Ambientes","v":"5.527","t":"-4.1%","d":"down"},{"l":"Versão Config","v":"4.307","t":"+5.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 17773.97","8.488","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 32338.65","8.706","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 6422.96","3.346","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 42217.41","3.401","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 151.32","7.322","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":282},{"label":"Fev","value":582},{"label":"Mar","value":532},{"label":"Abr","value":400},{"label":"Mai","value":262},{"label":"Jun","value":247},{"label":"Jul","value":320},{"label":"Ago","value":364},{"label":"Set","value":361},{"label":"Out","value":534},{"label":"Nov","value":244},{"label":"Dez","value":360}];
const MX = 582;
...
export default function EnodebPage() {
    return (
