...
const ACCENT = "#6366f1";
const MODULE = "Industrial Gases";
const PAGE = "Production";
const KPIS = [{"l":"Total Gas Industrial","v":"7.956","t":"+8.9%","d":"up"},{"l":"Production Ativos","v":"3.256","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"57","t":"+12.9%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Industrial #001","Gas Industrial #002","6.359","6.692","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Industrial #002","Gas Industrial #003","8.689","1.907","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Industrial #003","Gas Industrial #004","4.619","5.959","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Industrial #004","Gas Industrial #005","2.965","5.365","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Industrial #005","Gas Industrial #001","5.299","6.499","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":492},{"label":"Mar","value":687},{"label":"Abr","value":417},{"label":"Mai","value":487},{"label":"Jun","value":654},{"label":"Jul","value":740},{"label":"Ago","value":647},{"label":"Set","value":415},{"label":"Out","value":376},{"label":"Nov","value":684},{"label":"Dez","value":591}];
const MX = 740;
