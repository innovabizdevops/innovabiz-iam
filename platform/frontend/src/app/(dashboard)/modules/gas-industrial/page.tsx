...
export default function GasIndustrialPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Gas Industrial</h1><p className="text-sm text-muted-foreground">Gas Industrial • iBOS Enterprise</p></div>
