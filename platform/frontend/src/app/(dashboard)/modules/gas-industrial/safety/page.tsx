...
const PAGE = "Safety";
const KPIS = [{"l":"Total Gas Industrial","v":"8.869","t":"+4.9%","d":"up"},{"l":"Safety Ativos","v":"8.174","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"90.3%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.2%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Industrial #001","Gas Industrial #002","7.715","4.081","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Industrial #002","Gas Industrial #003","3.095","7.935","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Industrial #003","Gas Industrial #004","211","6.085","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Industrial #004","Gas Industrial #005","4.026","2.316","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Industrial #005","Gas Industrial #001","594","3.029","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":619},{"label":"Mar","value":597},{"label":"Abr","value":680},{"label":"Mai","value":476},{"label":"Jun","value":456},{"label":"Jul","value":772},{"label":"Ago","value":538},{"label":"Set","value":543},{"label":"Out","value":488},{"label":"Nov","value":628},{"label":"Dez","value":412}];
const MX = 772;
