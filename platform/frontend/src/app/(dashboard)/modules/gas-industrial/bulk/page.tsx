...
const PAGE = "Bulk";
const KPIS = [{"l":"Total Gas Industrial","v":"748","t":"+11.7%","d":"up"},{"l":"Bulk Ativos","v":"4.977","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"60","t":"+6.1%","d":"up"}];
const COLS = ["ID","Bulk","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Industrial #001","Gas Industrial #002","4.177","3.494","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Industrial #002","Gas Industrial #003","3.476","8.947","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Industrial #003","Gas Industrial #004","1.122","3.825","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Industrial #004","Gas Industrial #005","8.236","1.643","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Industrial #005","Gas Industrial #001","5.647","4.967","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":649},{"label":"Mar","value":626},{"label":"Abr","value":745},{"label":"Mai","value":499},{"label":"Jun","value":815},{"label":"Jul","value":601},{"label":"Ago","value":524},{"label":"Set","value":600},{"label":"Out","value":833},{"label":"Nov","value":644},{"label":"Dez","value":774}];
const MX = 833;
