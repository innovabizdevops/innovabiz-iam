...
const PAGE = "Cylinder";
const KPIS = [{"l":"Total Gas Industrial","v":"7.823","t":"+13.4%","d":"up"},{"l":"Cylinder Ativos","v":"5.218","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"56","t":"+12.3%","d":"up"}];
const COLS = ["ID","Cylinder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Industrial #001","Gas Industrial #002","6.177","2.549","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Industrial #002","Gas Industrial #003","8.114","3.470","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Industrial #003","Gas Industrial #004","2.575","2.823","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Industrial #004","Gas Industrial #005","1.295","7.046","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Industrial #005","Gas Industrial #001","1.083","2.181","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":413},{"label":"Mar","value":551},{"label":"Abr","value":490},{"label":"Mai","value":468},{"label":"Jun","value":574},{"label":"Jul","value":526},{"label":"Ago","value":551},{"label":"Set","value":411},{"label":"Out","value":509},{"label":"Nov","value":614},{"label":"Dez","value":418}];
const MX = 614;
