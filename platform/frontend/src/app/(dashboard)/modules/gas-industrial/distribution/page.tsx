...
const KPIS = [{"l":"Total Gas Industrial","v":"4.680","t":"-4.8%","d":"down"},{"l":"Distribution Ativos","v":"1.577","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"79.0%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+5.1%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Industrial #001","Gas Industrial #002","6.198","1.989","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Industrial #002","Gas Industrial #003","5.803","4.264","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Industrial #003","Gas Industrial #004","2.609","7.141","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Industrial #004","Gas Industrial #005","8.242","3.659","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Industrial #005","Gas Industrial #001","8.707","904","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":650},{"label":"Mar","value":842},{"label":"Abr","value":654},{"label":"Mai","value":842},{"label":"Jun","value":733},{"label":"Jul","value":755},{"label":"Ago","value":575},{"label":"Set","value":676},{"label":"Out","value":757},{"label":"Nov","value":772},{"label":"Dez","value":624}];
const MX = 842;
