...
const PAGE = "Price Adequacy";
const KPIS = [{"l":"ARR (€M)","v":"€8.6M","t":"+11.2%","d":"up"},{"l":"MRR (€)","v":"€14193","t":"+13.9%","d":"up"},{"l":"Churn (%)","v":"66.7%","t":"-1.0%","d":"down"},{"l":"ARPU (€)","v":"€76207","t":"-0.3%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45244.72","2.556","€ 15437.20","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 43986.63","1.451","€ 7157.40","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 3327.41","2.333","€ 23406.37","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 25970.23","4.234","€ 19121.63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 22917.31","2.301","€ 29729.30","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":799},{"label":"Mar","value":495},{"label":"Abr","value":712},{"label":"Mai","value":562},{"label":"Jun","value":459},{"label":"Jul","value":672},{"label":"Ago","value":504},{"label":"Set","value":704},{"label":"Out","value":683},{"label":"Nov","value":532},{"label":"Dez","value":704}];
const MX = 799;
