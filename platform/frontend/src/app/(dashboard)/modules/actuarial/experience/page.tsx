...
const PAGE = "Experience Study";
const KPIS = [{"l":"Perfis Unificados","v":"6.502","t":"+7.1%","d":"up"},{"l":"Segmentos Ativos","v":"1.616","t":"+4.0%","d":"up"},{"l":"NPS Score","v":"60","t":"+16.4%","d":"up"},{"l":"Churn Previsto (%)","v":"92.0%","t":"+5.9%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.419","€ 19913.68","75.0%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.623","€ 28440.14","84.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","4.704","€ 33790.23","97.8%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.653","€ 39176.59","72.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.680","€ 514.06","88.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":805},{"label":"Mar","value":783},{"label":"Abr","value":834},{"label":"Mai","value":941},{"label":"Jun","value":785},{"label":"Jul","value":790},{"label":"Ago","value":602},{"label":"Set","value":763},{"label":"Out","value":682},{"label":"Nov","value":942},{"label":"Dez","value":928}];
const MX = 942;
