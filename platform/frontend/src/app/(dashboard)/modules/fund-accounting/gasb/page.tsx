...
const ACCENT = "#475569";
const MODULE = "Fund Accounting";
const PAGE = "GASB Reports";
const KPIS = [{"l":"Total Fund Accounting","v":"2.452","t":"-2.4%","d":"down"},{"l":"GASB Reports Ativos","v":"6.382","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"82.9%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"82","t":"+3.7%","d":"up"}];
const COLS = ["ID","GASB Reports","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fund Accounting #001","Fund Accounting #002","2.689","792","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Fund Accounting #002","Fund Accounting #003","4.928","1.403","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Fund Accounting #003","Fund Accounting #004","5.366","6.145","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Fund Accounting #004","Fund Accounting #005","2.070","5.916","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fund Accounting #005","Fund Accounting #001","2.686","6.633","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":785},{"label":"Mar","value":582},{"label":"Abr","value":420},{"label":"Mai","value":780},{"label":"Jun","value":774},{"label":"Jul","value":624},{"label":"Ago","value":437},{"label":"Set","value":543},{"label":"Out","value":497},{"label":"Nov","value":631},{"label":"Dez","value":440}];
const MX = 785;
...
export default function GasbPage() {
    return (
