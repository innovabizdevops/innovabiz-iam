...
const PAGE = "Function Mgmt";
const KPIS = [{"l":"Total Serverless Ops","v":"3.915","t":"+1.4%","d":"up"},{"l":"Function Mgmt Ativos","v":"462","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+3.1%","d":"up"}];
const COLS = ["ID","Function Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serverless Ops #001","Serverless Ops #002","2.071","6.926","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Serverless Ops #002","Serverless Ops #003","4.691","820","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Serverless Ops #003","Serverless Ops #004","4.457","7.006","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Serverless Ops #004","Serverless Ops #005","1.465","7.465","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serverless Ops #005","Serverless Ops #001","3.749","1.992","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":425},{"label":"Mar","value":550},{"label":"Abr","value":644},{"label":"Mai","value":575},{"label":"Jun","value":592},{"label":"Jul","value":386},{"label":"Ago","value":398},{"label":"Set","value":464},{"label":"Out","value":630},{"label":"Nov","value":412},{"label":"Dez","value":418}];
const MX = 644;
