...
const KPIS = [{"l":"Total Serverless Ops","v":"5.336","t":"+15.1%","d":"up"},{"l":"Event Source Ativos","v":"3.617","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"72","t":"+17.8%","d":"up"}];
const COLS = ["ID","Event Source","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serverless Ops #001","Serverless Ops #002","4.480","3.544","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Serverless Ops #002","Serverless Ops #003","5.383","3.362","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Serverless Ops #003","Serverless Ops #004","8.999","5.446","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Serverless Ops #004","Serverless Ops #005","4.837","887","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serverless Ops #005","Serverless Ops #001","3.568","4.284","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":484},{"label":"Mar","value":409},{"label":"Abr","value":631},{"label":"Mai","value":518},{"label":"Jun","value":678},{"label":"Jul","value":642},{"label":"Ago","value":657},{"label":"Set","value":672},{"label":"Out","value":407},{"label":"Nov","value":664},{"label":"Dez","value":731}];
const MX = 782;
