...
const PAGE = "Cold Start";
const KPIS = [{"l":"Total Serverless Ops","v":"3.700","t":"+8.0%","d":"up"},{"l":"Cold Start Ativos","v":"320","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"67.0%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"84","t":"+8.3%","d":"up"}];
const COLS = ["ID","Cold Start","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serverless Ops #001","Serverless Ops #002","7.203","5.097","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Serverless Ops #002","Serverless Ops #003","8.506","3.482","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Serverless Ops #003","Serverless Ops #004","9.022","5.593","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Serverless Ops #004","Serverless Ops #005","3.465","4.023","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serverless Ops #005","Serverless Ops #001","291","8.808","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":585},{"label":"Mar","value":431},{"label":"Abr","value":730},{"label":"Mai","value":693},{"label":"Jun","value":646},{"label":"Jul","value":493},{"label":"Ago","value":463},{"label":"Set","value":638},{"label":"Out","value":395},{"label":"Nov","value":542},{"label":"Dez","value":526}];
const MX = 730;
