...
const ACCENT = "#4338ca";
const MODULE = "Serverless Operations";
const PAGE = "Cost Track";
const KPIS = [{"l":"Total Serverless Ops","v":"3.011","t":"+11.7%","d":"up"},{"l":"Cost Track Ativos","v":"5.031","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"79.8%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"93","t":"+5.4%","d":"up"}];
const COLS = ["ID","Cost Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serverless Ops #001","Serverless Ops #002","6.029","5.998","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Serverless Ops #002","Serverless Ops #003","1.069","5.101","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Serverless Ops #003","Serverless Ops #004","1.396","7.495","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Serverless Ops #004","Serverless Ops #005","1.495","7.254","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serverless Ops #005","Serverless Ops #001","6.994","3.372","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":841},{"label":"Mar","value":903},{"label":"Abr","value":664},{"label":"Mai","value":756},{"label":"Jun","value":846},{"label":"Jul","value":597},{"label":"Ago","value":665},{"label":"Set","value":720},{"label":"Out","value":943},{"label":"Nov","value":551},{"label":"Dez","value":810}];
const MX = 943;
