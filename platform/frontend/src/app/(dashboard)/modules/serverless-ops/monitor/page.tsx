...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Serverless Ops","v":"4.494","t":"-1.1%","d":"down"},{"l":"Monitor Ativos","v":"287","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+13.0%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Serverless Ops #001","Serverless Ops #002","1.996","5.948","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Serverless Ops #002","Serverless Ops #003","963","2.736","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Serverless Ops #003","Serverless Ops #004","7.514","5.739","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Serverless Ops #004","Serverless Ops #005","6.362","604","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Serverless Ops #005","Serverless Ops #001","125","863","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":672},{"label":"Mar","value":713},{"label":"Abr","value":772},{"label":"Mai","value":553},{"label":"Jun","value":764},{"label":"Jul","value":684},{"label":"Ago","value":639},{"label":"Set","value":527},{"label":"Out","value":715},{"label":"Nov","value":560},{"label":"Dez","value":588}];
const MX = 772;
