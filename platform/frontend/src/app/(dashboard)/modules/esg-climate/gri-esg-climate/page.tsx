...
const ACCENT = "#16a34a";
const MODULE = "ESG & Climate Cloud";
const PAGE = "GRI Standards";
const KPIS = [{"l":"Total Esg Climate","v":"3.005","t":"+11.2%","d":"up"},{"l":"GRI Standards Ativos","v":"2.631","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.9%","d":"up"}];
const COLS = ["ID","GRI Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","2.544","3.103","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","7.881","2.548","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","1.065","5.511","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","5.693","6.049","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","2.186","7.674","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":351},{"label":"Mar","value":403},{"label":"Abr","value":526},{"label":"Mai","value":640},{"label":"Jun","value":407},{"label":"Jul","value":529},{"label":"Ago","value":504},{"label":"Set","value":412},{"label":"Out","value":564},{"label":"Nov","value":614},{"label":"Dez","value":681}];
const MX = 681;
...
export default function GriEsgClimatePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>GRI</span></h1>
                </div>
