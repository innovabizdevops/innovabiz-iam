...
const PAGE = "ESG Ratings";
const KPIS = [{"l":"Surveys Ativos","v":"6.617","t":"+16.2%","d":"up"},{"l":"Respostas/Semana","v":"4411","t":"+15.9%","d":"up"},{"l":"NPS Médio","v":"73","t":"+9.2%","d":"up"},{"l":"Taxa Resposta (%)","v":"93.2%","t":"+15.3%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.954","89","84.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.635","79","74.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","857","88","98.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","5.856","68","94.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.446","69","78.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":259},{"label":"Mar","value":353},{"label":"Abr","value":548},{"label":"Mai","value":294},{"label":"Jun","value":605},{"label":"Jul","value":372},{"label":"Ago","value":343},{"label":"Set","value":526},{"label":"Out","value":538},{"label":"Nov","value":474},{"label":"Dez","value":618}];
const MX = 618;
