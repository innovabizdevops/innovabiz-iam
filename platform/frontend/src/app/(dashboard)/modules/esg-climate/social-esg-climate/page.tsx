...
const KPIS = [{"l":"Projetos Sociais","v":"2.881","t":"+14.1%","d":"up"},{"l":"Beneficiários","v":"9.064","t":"+4.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€9216","t":"+11.8%","d":"up"},{"l":"Score Impacto","v":"83","t":"-5.7%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.987","€ 22542.76","104","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.672","€ 41041.64","2.963","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","371","€ 45457.17","8.105","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","188","€ 2197.49","3.620","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.445","€ 31268.41","2.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":770},{"label":"Mar","value":657},{"label":"Abr","value":907},{"label":"Mai","value":825},{"label":"Jun","value":623},{"label":"Jul","value":763},{"label":"Ago","value":731},{"label":"Set","value":830},{"label":"Out","value":717},{"label":"Nov","value":855},{"label":"Dez","value":698}];
const MX = 907;
...
export default function SocialEsgClimatePage() {
    return (
