...
const PAGE = "Waste &amp; Circular";
const KPIS = [{"l":"Total Esg Climate","v":"3.280","t":"+4.4%","d":"up"},{"l":"Waste & Circular Ativos","v":"2.497","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"84","t":"+1.2%","d":"up"}];
const COLS = ["ID","Waste & Circular","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","1.286","9.092","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","5.605","2.843","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","2.546","5.526","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","3.218","5.629","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","7.486","9.039","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":422},{"label":"Mar","value":508},{"label":"Abr","value":276},{"label":"Mai","value":509},{"label":"Jun","value":260},{"label":"Jul","value":280},{"label":"Ago","value":477},{"label":"Set","value":614},{"label":"Out","value":329},{"label":"Nov","value":255},{"label":"Dez","value":558}];
const MX = 614;
