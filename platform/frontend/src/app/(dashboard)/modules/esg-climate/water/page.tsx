...
const PAGE = "Water Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.507","t":"-5.7%","d":"down"},{"l":"Savings (€)","v":"€41377","t":"+14.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.3%","t":"+18.0%","d":"up"},{"l":"Ciclos PDCA","v":"2.186","t":"-4.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.358","€ 16937.53","1.314","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.262","€ 22097.90","4.663","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.056","€ 32235.70","3.288","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.317","€ 10690.63","1.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.913","€ 24349.36","5.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":663},{"label":"Mar","value":546},{"label":"Abr","value":529},{"label":"Mai","value":759},{"label":"Jun","value":691},{"label":"Jul","value":385},{"label":"Ago","value":368},{"label":"Set","value":571},{"label":"Out","value":411},{"label":"Nov","value":757},{"label":"Dez","value":567}];
const MX = 759;
