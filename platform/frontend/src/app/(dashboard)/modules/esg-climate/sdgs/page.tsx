...
const KPIS = [{"l":"Total Esg Climate","v":"1.673","t":"+8.9%","d":"up"},{"l":"SDGs Tracker Ativos","v":"940","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"67.8%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"90","t":"-2.5%","d":"down"}];
const COLS = ["ID","SDGs Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","2.565","1.066","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","3.338","5.225","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","8.166","5.913","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","2.579","5.947","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","3.699","2.198","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":820},{"label":"Mar","value":564},{"label":"Abr","value":537},{"label":"Mai","value":576},{"label":"Jun","value":732},{"label":"Jul","value":676},{"label":"Ago","value":909},{"label":"Set","value":820},{"label":"Out","value":849},{"label":"Nov","value":852},{"label":"Dez","value":583}];
const MX = 909;
