...
const PAGE = "UN SDGs Tracking";
const KPIS = [{"l":"Total Esg Climate","v":"5.064","t":"+14.1%","d":"up"},{"l":"UN SDGs Tracking Ativos","v":"7.174","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"71.1%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"65","t":"-1.9%","d":"down"}];
const COLS = ["ID","UN SDGs Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","8.971","238","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","1.038","3.585","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","9.004","7.230","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","6.569","5.794","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","4.234","8.122","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":877},{"label":"Mar","value":659},{"label":"Abr","value":928},{"label":"Mai","value":838},{"label":"Jun","value":787},{"label":"Jul","value":663},{"label":"Ago","value":803},{"label":"Set","value":581},{"label":"Out","value":742},{"label":"Nov","value":902},{"label":"Dez","value":957}];
const MX = 957;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>UN</span></h1>
                </div>
