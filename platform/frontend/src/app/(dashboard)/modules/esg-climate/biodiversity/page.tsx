...
const PAGE = "Biodiversity";
const KPIS = [{"l":"Total Esg Climate","v":"562","t":"+12.5%","d":"up"},{"l":"Biodiversity Ativos","v":"7.913","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"73","t":"+7.0%","d":"up"}];
const COLS = ["ID","Biodiversity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","5.846","3.258","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","600","3.396","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","8.071","893","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","5.852","6.576","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","3.344","6.366","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":634},{"label":"Mar","value":423},{"label":"Abr","value":554},{"label":"Mai","value":499},{"label":"Jun","value":695},{"label":"Jul","value":411},{"label":"Ago","value":718},{"label":"Set","value":460},{"label":"Out","value":639},{"label":"Nov","value":608},{"label":"Dez","value":356}];
const MX = 718;
