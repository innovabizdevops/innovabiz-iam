...
const PAGE = "TCFD Reporting";
const KPIS = [{"l":"Total Esg Climate","v":"3.172","t":"+14.4%","d":"up"},{"l":"TCFD Reporting Ativos","v":"4.471","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"70.8%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"81","t":"-4.0%","d":"down"}];
const COLS = ["ID","TCFD Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","6.101","5.737","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","8.659","2.276","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","7.048","5.183","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","7.101","7.703","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","1.789","6.619","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":544},{"label":"Mar","value":563},{"label":"Abr","value":272},{"label":"Mai","value":250},{"label":"Jun","value":352},{"label":"Jul","value":486},{"label":"Ago","value":608},{"label":"Set","value":342},{"label":"Out","value":525},{"label":"Nov","value":271},{"label":"Dez","value":404}];
const MX = 608;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>TCFD</span></h1>
                </div>
