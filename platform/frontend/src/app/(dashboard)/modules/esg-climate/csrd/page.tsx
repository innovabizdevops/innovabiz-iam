...
const PAGE = "CSRD Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.188","t":"-3.3%","d":"down"},{"l":"NC Abertas","v":"1.486","t":"+9.2%","d":"up"},{"l":"Conformidade (%)","v":"73.6%","t":"-2.5%","d":"down"},{"l":"CAPAs Pendentes","v":"5.801","t":"+15.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.908","74.9%","7.449","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.018","78.8%","3.877","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.759","86.1%","3.076","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.985","79.0%","6.582","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","176","86.8%","7.725","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":628},{"label":"Mar","value":742},{"label":"Abr","value":685},{"label":"Mai","value":808},{"label":"Jun","value":587},{"label":"Jul","value":765},{"label":"Ago","value":499},{"label":"Set","value":479},{"label":"Out","value":666},{"label":"Nov","value":560},{"label":"Dez","value":665}];
const MX = 808;
