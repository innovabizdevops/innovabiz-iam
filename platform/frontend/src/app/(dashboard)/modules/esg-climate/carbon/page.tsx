...
const KPIS = [{"l":"Total Esg Climate","v":"4.479","t":"+3.8%","d":"up"},{"l":"Carbon Accounting Ativos","v":"6.657","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"82.0%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+1.5%","d":"up"}];
const COLS = ["ID","Carbon Accounting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","1.474","7.027","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","4.278","7.164","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","8.745","2.380","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","7.234","4.273","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","8.809","7.833","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":471},{"label":"Mar","value":648},{"label":"Abr","value":766},{"label":"Mai","value":612},{"label":"Jun","value":424},{"label":"Jul","value":396},{"label":"Ago","value":674},{"label":"Set","value":627},{"label":"Out","value":789},{"label":"Nov","value":443},{"label":"Dez","value":784}];
const MX = 789;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>GHG</span></h1>
                </div>
