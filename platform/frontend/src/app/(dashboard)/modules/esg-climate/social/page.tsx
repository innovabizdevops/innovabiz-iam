...
const PAGE = "Social &amp; Governance";
const KPIS = [{"l":"Riscos Identificados","v":"4.047","t":"-5.6%","d":"down"},{"l":"Mitigações Ativas","v":"2.617","t":"+7.4%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+9.8%","d":"up"},{"l":"Incidentes YTD","v":"8.457","t":"-0.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.508","714","6.934","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","352","587","5.995","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.198","5.187","4.135","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.775","7.353","3.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.040","3.979","7.627","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":584},{"label":"Mar","value":932},{"label":"Abr","value":793},{"label":"Mai","value":927},{"label":"Jun","value":605},{"label":"Jul","value":813},{"label":"Ago","value":785},{"label":"Set","value":803},{"label":"Out","value":557},{"label":"Nov","value":567},{"label":"Dez","value":692}];
const MX = 932;
