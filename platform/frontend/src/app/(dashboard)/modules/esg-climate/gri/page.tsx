...
const PAGE = "GRI Reporting";
const KPIS = [{"l":"Total Esg Climate","v":"1.467","t":"+0.3%","d":"up"},{"l":"GRI Reporting Ativos","v":"7.331","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"77","t":"-1.2%","d":"down"}];
const COLS = ["ID","GRI Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","160","1.399","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","5.507","4.810","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","430","8.672","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","3.654","7.570","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","8.290","6.135","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":790},{"label":"Mar","value":557},{"label":"Abr","value":662},{"label":"Mai","value":832},{"label":"Jun","value":535},{"label":"Jul","value":517},{"label":"Ago","value":892},{"label":"Set","value":754},{"label":"Out","value":578},{"label":"Nov","value":711},{"label":"Dez","value":905}];
const MX = 905;
