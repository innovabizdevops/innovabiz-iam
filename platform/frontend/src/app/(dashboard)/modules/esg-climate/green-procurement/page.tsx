...
const PAGE = "Green Procurement";
const KPIS = [{"l":"Fornecedores Ativos","v":"562","t":"-1.2%","d":"down"},{"l":"Contratos (€M)","v":"€37.2M","t":"+3.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"70.8%","t":"+1.8%","d":"up"},{"l":"Score Médio","v":"60","t":"-2.5%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","84.9%","€ 37937.90","5.037","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","77.6%","€ 25109.28","3.286","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","86.4%","€ 45872.39","1.622","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","90.4%","€ 42485.85","4.375","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","71.9%","€ 26821.41","6.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":406},{"label":"Mar","value":624},{"label":"Abr","value":317},{"label":"Mai","value":427},{"label":"Jun","value":464},{"label":"Jul","value":376},{"label":"Ago","value":438},{"label":"Set","value":340},{"label":"Out","value":638},{"label":"Nov","value":423},{"label":"Dez","value":572}];
const MX = 638;
...
export default function GreenProcurementPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>New</span></h1>
                </div>
