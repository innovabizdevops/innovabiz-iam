...
const PAGE = "Environmental";
const KPIS = [{"l":"Total Esg Climate","v":"7.462","t":"-2.7%","d":"down"},{"l":"Environmental Ativos","v":"7.964","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"63","t":"-2.6%","d":"down"}];
const COLS = ["ID","Environmental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","4.112","4.702","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","8.045","4.503","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","234","2.953","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","3.100","3.173","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","9.050","5.370","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":639},{"label":"Mar","value":674},{"label":"Abr","value":894},{"label":"Mai","value":748},{"label":"Jun","value":768},{"label":"Jul","value":779},{"label":"Ago","value":916},{"label":"Set","value":845},{"label":"Out","value":654},{"label":"Nov","value":794},{"label":"Dez","value":770}];
const MX = 922;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>ESG</span></h1>
                </div>
