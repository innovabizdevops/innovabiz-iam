...
const KPIS = [{"l":"Total Esg Climate","v":"3.031","t":"-3.8%","d":"down"},{"l":"Circular Economy Ativos","v":"6.312","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"69","t":"+7.1%","d":"up"}];
const COLS = ["ID","Circular Economy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","5.671","1.783","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","4.602","7.636","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","4.172","265","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","2.529","8.575","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","6.940","7.543","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":841},{"label":"Mar","value":833},{"label":"Abr","value":921},{"label":"Mai","value":807},{"label":"Jun","value":857},{"label":"Jul","value":767},{"label":"Ago","value":733},{"label":"Set","value":900},{"label":"Out","value":731},{"label":"Nov","value":926},{"label":"Dez","value":1012}];
const MX = 1012;
