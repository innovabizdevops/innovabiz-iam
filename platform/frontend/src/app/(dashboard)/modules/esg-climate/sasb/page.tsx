...
const PAGE = "SASB Standards";
const KPIS = [{"l":"Total Esg Climate","v":"177","t":"-2.4%","d":"down"},{"l":"SASB Standards Ativos","v":"909","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"68.8%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+4.7%","d":"up"}];
const COLS = ["ID","SASB Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","4.460","7.469","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","1.057","2.961","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","6.189","1.188","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","7.809","1.429","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","6.028","4.831","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":984},{"label":"Mar","value":948},{"label":"Abr","value":710},{"label":"Mai","value":643},{"label":"Jun","value":924},{"label":"Jul","value":600},{"label":"Ago","value":920},{"label":"Set","value":793},{"label":"Out","value":740},{"label":"Nov","value":749},{"label":"Dez","value":991}];
const MX = 991;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>SASB</span></h1>
                </div>
