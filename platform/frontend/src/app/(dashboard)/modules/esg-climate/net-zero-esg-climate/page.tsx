...
const PAGE = "Net Zero Tracker";
const KPIS = [{"l":"Total Esg Climate","v":"7.935","t":"-1.3%","d":"down"},{"l":"Net Zero Tracker Ativos","v":"7.399","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"76","t":"+11.0%","d":"up"}];
const COLS = ["ID","Net Zero Tracker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","6.761","1.434","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","6.292","8.016","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","5.252","1.675","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","496","5.970","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","1.464","398","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":607},{"label":"Mar","value":567},{"label":"Abr","value":390},{"label":"Mai","value":356},{"label":"Jun","value":282},{"label":"Jul","value":347},{"label":"Ago","value":629},{"label":"Set","value":490},{"label":"Out","value":291},{"label":"Nov","value":376},{"label":"Dez","value":287}];
const MX = 629;
...
export default function NetZeroEsgClimatePage() {
    return (
