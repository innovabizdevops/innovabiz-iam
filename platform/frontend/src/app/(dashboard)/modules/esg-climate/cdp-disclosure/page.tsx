...
const PAGE = "CDP Disclosure";
const KPIS = [{"l":"Perfis Unificados","v":"2.720","t":"+17.6%","d":"up"},{"l":"Segmentos Ativos","v":"5.610","t":"+5.6%","d":"up"},{"l":"NPS Score","v":"88","t":"+0.8%","d":"up"},{"l":"Churn Previsto (%)","v":"79.8%","t":"+3.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","401","€ 33041.78","80.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.075","€ 17564.93","91.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","838","€ 48110.84","71.9%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","729","€ 14877.91","79.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","3.473","€ 1127.89","71.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":987},{"label":"Mar","value":862},{"label":"Abr","value":933},{"label":"Mai","value":780},{"label":"Jun","value":777},{"label":"Jul","value":871},{"label":"Ago","value":871},{"label":"Set","value":815},{"label":"Out","value":723},{"label":"Nov","value":951},{"label":"Dez","value":785}];
const MX = 987;
...
export default function CdpDisclosurePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>CDP</span></h1>
                </div>
