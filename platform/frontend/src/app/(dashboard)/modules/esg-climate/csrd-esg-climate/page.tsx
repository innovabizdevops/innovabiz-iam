...
const KPIS = [{"l":"Total Esg Climate","v":"6.060","t":"-4.9%","d":"down"},{"l":"CSRD Reporting Ativos","v":"1.670","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+17.1%","d":"up"}];
const COLS = ["ID","CSRD Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Climate #001","Esg Climate #002","1.647","5.441","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Climate #002","Esg Climate #003","8.172","2.996","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Climate #003","Esg Climate #004","6.313","3.707","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Climate #004","Esg Climate #005","5.852","7.755","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Climate #005","Esg Climate #001","4.293","7.559","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":583},{"label":"Mar","value":846},{"label":"Abr","value":586},{"label":"Mai","value":835},{"label":"Jun","value":573},{"label":"Jul","value":479},{"label":"Ago","value":710},{"label":"Set","value":683},{"label":"Out","value":815},{"label":"Nov","value":646},{"label":"Dez","value":851}];
const MX = 855;
...
export default function CsrdEsgClimatePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#16a34a'}}>EU</span></h1>
                </div>
