...
const PAGE = "Margin";
const KPIS = [{"l":"ARR (€M)","v":"€27.9M","t":"+2.9%","d":"up"},{"l":"MRR (€)","v":"€81809","t":"-4.1%","d":"down"},{"l":"Churn (%)","v":"68.3%","t":"+11.8%","d":"up"},{"l":"ARPU (€)","v":"€88305","t":"+15.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13023.18","5.467","€ 36629.63","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 35073.00","1.608","€ 32377.78","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40061.26","4.038","€ 12083.95","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49419.18","2.439","€ 14226.27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 26280.20","6.013","€ 36370.78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":607},{"label":"Mar","value":519},{"label":"Abr","value":510},{"label":"Mai","value":877},{"label":"Jun","value":509},{"label":"Jul","value":521},{"label":"Ago","value":787},{"label":"Set","value":556},{"label":"Out","value":546},{"label":"Nov","value":495},{"label":"Dez","value":602}];
const MX = 877;
