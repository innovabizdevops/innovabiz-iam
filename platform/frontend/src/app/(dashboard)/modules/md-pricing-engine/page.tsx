...
/* ═══ MD: Multi-Pricing Engine Deep — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "6922", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2020", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€338K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "569128122", cells: ["MD-5122", "MD: Multi-Pricing Engine Deep Item 1", "11/7/2026", "€28 222"], status: "active" as const },
    { id: "569131693", cells: ["MD-8693", "MD: Multi-Pricing Engine Deep Item 2", "26/2/2026", "€31 793"], status: "pending" as const },
    { id: "569135264", cells: ["MD-3264", "MD: Multi-Pricing Engine Deep Item 3", "13/9/2026", "€35 364"], status: "completed" as const },
    { id: "569138835", cells: ["MD-6835", "MD: Multi-Pricing Engine Deep Item 4", "28/4/2026", "€38 935"], status: "warning" as const },
    { id: "569142406", cells: ["MD-1406", "MD: Multi-Pricing Engine Deep Item 5", "15/11/2026", "€42 506"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 62 }, { label: "Fev", value: 71 }, { label: "Mar", value: 80 }, { label: "Abr", value: 89 }, { label: "Mai", value: 98 }, { label: "Jun", value: 27 }];
...
export default function MdMultipricingEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Pricing Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Pricing Engine Deep</p>
                    </div>
                </div>
