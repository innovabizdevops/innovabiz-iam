...
const PAGE = "Volume";
const KPIS = [{"l":"ARR (€M)","v":"€16.9M","t":"+12.9%","d":"up"},{"l":"MRR (€)","v":"€20249","t":"+2.0%","d":"up"},{"l":"Churn (%)","v":"71.6%","t":"-5.2%","d":"down"},{"l":"ARPU (€)","v":"€91769","t":"+7.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 21153.26","1.125","€ 8445.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44917.42","2.329","€ 17318.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12267.77","160","€ 16700.94","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 19138.40","4.572","€ 8286.01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31074.45","8.596","€ 15006.24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":616},{"label":"Mar","value":549},{"label":"Abr","value":688},{"label":"Mai","value":673},{"label":"Jun","value":829},{"label":"Jul","value":529},{"label":"Ago","value":659},{"label":"Set","value":607},{"label":"Out","value":814},{"label":"Nov","value":552},{"label":"Dez","value":560}];
const MX = 829;
