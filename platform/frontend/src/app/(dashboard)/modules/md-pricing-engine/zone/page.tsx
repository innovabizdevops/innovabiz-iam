...
const PAGE = "Zone";
const KPIS = [{"l":"ARR (€M)","v":"€45.2M","t":"+14.4%","d":"up"},{"l":"MRR (€)","v":"€68307","t":"+1.5%","d":"up"},{"l":"Churn (%)","v":"92.3%","t":"+1.8%","d":"up"},{"l":"ARPU (€)","v":"€11654","t":"+8.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 24285.37","4.074","€ 9496.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8967.55","8.781","€ 5016.03","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44942.37","8.276","€ 21018.87","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5342.40","1.858","€ 18888.51","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 2938.45","8.357","€ 31224.75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":374},{"label":"Mar","value":438},{"label":"Abr","value":411},{"label":"Mai","value":269},{"label":"Jun","value":287},{"label":"Jul","value":509},{"label":"Ago","value":333},{"label":"Set","value":460},{"label":"Out","value":451},{"label":"Nov","value":539},{"label":"Dez","value":529}];
const MX = 539;
