...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Pricing Engine Deep";
const PAGE = "Dynamic";
const KPIS = [{"l":"ARR (€M)","v":"€25.4M","t":"+2.5%","d":"up"},{"l":"MRR (€)","v":"€19150","t":"+10.7%","d":"up"},{"l":"Churn (%)","v":"82.1%","t":"+8.1%","d":"up"},{"l":"ARPU (€)","v":"€68229","t":"+9.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 22326.34","6.912","€ 42845.28","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 34408.13","5.058","€ 13727.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44023.77","1.848","€ 41452.73","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3867.39","5.310","€ 16401.98","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16175.44","3.666","€ 48220.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":861},{"label":"Mar","value":727},{"label":"Abr","value":751},{"label":"Mai","value":747},{"label":"Jun","value":858},{"label":"Jul","value":842},{"label":"Ago","value":1050},{"label":"Set","value":945},{"label":"Out","value":944},{"label":"Nov","value":941},{"label":"Dez","value":762}];
const MX = 1050;
