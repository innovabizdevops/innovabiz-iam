...
const PAGE = "Tier";
const KPIS = [{"l":"ARR (€M)","v":"€37.7M","t":"-1.3%","d":"down"},{"l":"MRR (€)","v":"€68456","t":"+0.5%","d":"up"},{"l":"Churn (%)","v":"93.0%","t":"+14.3%","d":"up"},{"l":"ARPU (€)","v":"€92727","t":"-3.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45754.43","2.677","€ 35242.57","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33030.93","5.922","€ 16620.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1495.94","4.958","€ 10672.25","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31388.58","8.082","€ 23285.11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5358.66","1.534","€ 4490.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":551},{"label":"Mar","value":745},{"label":"Abr","value":847},{"label":"Mai","value":832},{"label":"Jun","value":667},{"label":"Jul","value":801},{"label":"Ago","value":733},{"label":"Set","value":791},{"label":"Out","value":751},{"label":"Nov","value":523},{"label":"Dez","value":868}];
const MX = 868;
