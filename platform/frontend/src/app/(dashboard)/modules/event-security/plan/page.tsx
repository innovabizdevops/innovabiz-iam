...
const PAGE = "Plan";
const KPIS = [{"l":"Eventos Planeados","v":"4.717","t":"-3.5%","d":"down"},{"l":"Participantes","v":"8.100","t":"+10.5%","d":"up"},{"l":"NPS Evento","v":"64","t":"+7.6%","d":"up"},{"l":"Receita (€)","v":"€98867","t":"+15.9%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-04","8.969","3.180","€ 38217.98","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-06","2.452","4.603","€ 40652.88","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-16","7.699","9.000","€ 25230.48","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-22","9.047","6.126","€ 39296.38","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-11","1.630","1.611","€ 22550.02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":357},{"label":"Mar","value":407},{"label":"Abr","value":678},{"label":"Mai","value":635},{"label":"Jun","value":555},{"label":"Jul","value":682},{"label":"Ago","value":667},{"label":"Set","value":430},{"label":"Out","value":724},{"label":"Nov","value":496},{"label":"Dez","value":559}];
const MX = 724;
