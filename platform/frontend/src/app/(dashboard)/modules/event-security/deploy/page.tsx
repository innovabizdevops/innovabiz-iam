...
const PAGE = "Deploy";
const KPIS = [{"l":"Eventos Planeados","v":"1.926","t":"-5.7%","d":"down"},{"l":"Participantes","v":"6.920","t":"-0.1%","d":"down"},{"l":"NPS Evento","v":"62","t":"+15.9%","d":"up"},{"l":"Receita (€)","v":"€17669","t":"+14.8%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-22","4.971","8.394","€ 31875.31","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-27","8.477","2.514","€ 42596.83","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-21","7.915","2.290","€ 8241.55","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-20","2.303","8.857","€ 8559.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-10","8.354","998","€ 24740.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":382},{"label":"Mar","value":403},{"label":"Abr","value":259},{"label":"Mai","value":611},{"label":"Jun","value":568},{"label":"Jul","value":368},{"label":"Ago","value":395},{"label":"Set","value":340},{"label":"Out","value":419},{"label":"Nov","value":603},{"label":"Dez","value":415}];
const MX = 611;
