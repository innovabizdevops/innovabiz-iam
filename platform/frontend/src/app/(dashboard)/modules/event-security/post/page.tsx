...
const ACCENT = "#6366f1";
const MODULE = "Event Security";
const PAGE = "Post-Event";
const KPIS = [{"l":"Pedidos/Dia","v":"4649","t":"+14.7%","d":"up"},{"l":"GMV (€)","v":"€51712","t":"-2.5%","d":"down"},{"l":"Conversão (%)","v":"66.2%","t":"+3.6%","d":"up"},{"l":"AOV (€)","v":"€76986","t":"+11.9%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 45482.22","4.618","6.460","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20172.74","4.555","6.511","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 45495.85","3.996","5.747","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 24920.15","6.617","7.849","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 44074.82","5.821","7.047","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":532},{"label":"Mar","value":548},{"label":"Abr","value":512},{"label":"Mai","value":301},{"label":"Jun","value":537},{"label":"Jul","value":450},{"label":"Ago","value":507},{"label":"Set","value":592},{"label":"Out","value":454},{"label":"Nov","value":463},{"label":"Dez","value":474}];
const MX = 592;
