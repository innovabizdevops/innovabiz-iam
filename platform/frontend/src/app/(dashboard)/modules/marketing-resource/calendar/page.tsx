...
const ACCENT = "#6366f1";
const MODULE = "Marketing Resource Mgmt";
const PAGE = "Calendar";
const KPIS = [{"l":"Total Marketing Resource","v":"2.904","t":"-0.1%","d":"down"},{"l":"Calendar Ativos","v":"8.251","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"73.5%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"78","t":"-3.7%","d":"down"}];
const COLS = ["ID","Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Resource #001","Marketing Resource #002","6.073","3.516","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Resource #002","Marketing Resource #003","287","4.440","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Resource #003","Marketing Resource #004","2.642","4.738","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Resource #004","Marketing Resource #005","7.811","5.694","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Resource #005","Marketing Resource #001","8.688","2.449","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":323},{"label":"Fev","value":393},{"label":"Mar","value":423},{"label":"Abr","value":632},{"label":"Mai","value":297},{"label":"Jun","value":443},{"label":"Jul","value":551},{"label":"Ago","value":369},{"label":"Set","value":358},{"label":"Out","value":291},{"label":"Nov","value":441},{"label":"Dez","value":386}];
const MX = 632;
