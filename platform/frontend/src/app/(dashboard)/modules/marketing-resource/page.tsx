...
export default function MarketingResourcePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Marketing Resource</h1><p className="text-sm text-muted-foreground">Marketing Resource • iBOS Enterprise</p></div>
