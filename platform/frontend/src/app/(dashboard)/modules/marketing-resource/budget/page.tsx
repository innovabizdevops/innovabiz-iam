...
const PAGE = "Budget";
const KPIS = [{"l":"Total Marketing Resource","v":"608","t":"+7.1%","d":"up"},{"l":"Budget Ativos","v":"€64035","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+8.6%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Resource #001","€ 14730.06","1.508","8.016","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Resource #002","€ 26349.75","5.246","5.618","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Resource #003","€ 28077.37","4.817","8.292","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Resource #004","€ 23286.61","5.586","3.025","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Resource #005","€ 4852.34","2.837","7.446","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":718},{"label":"Mar","value":619},{"label":"Abr","value":798},{"label":"Mai","value":466},{"label":"Jun","value":543},{"label":"Jul","value":516},{"label":"Ago","value":739},{"label":"Set","value":779},{"label":"Out","value":713},{"label":"Nov","value":621},{"label":"Dez","value":515}];
const MX = 798;
