...
/* ═══ Platform Ops — Capacity Plan Plat ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "1441", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "201", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1242", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "92%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1521119125", cells: ["PLA-3125", "Capacity Plan Plat Item 1", "2/2/2026", "€19 225"], status: "active" as const },
    { id: "1521122696", cells: ["PLA-6696", "Capacity Plan Plat Item 2", "17/9/2026", "€22 796"], status: "pending" as const },
    { id: "1521126267", cells: ["PLA-1267", "Capacity Plan Plat Item 3", "4/4/2026", "€26 367"], status: "completed" as const },
    { id: "1521129838", cells: ["PLA-4838", "Capacity Plan Plat Item 4", "19/11/2026", "€29 938"], status: "warning" as const },
    { id: "1521133409", cells: ["PLA-8409", "Capacity Plan Plat Item 5", "6/6/2026", "€33 509"], status: "active" as const },
];
...
export default function PlatformOpsCapacityPlanPlatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capacity Plan Plat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Capacity Plan Plat</p>
                    </div>
                </div>
