...
/* ═══ Platform Ops — Usage Metering ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "2752", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "343", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1474", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "684964947", cells: ["PLA-2947", "Usage Metering Item 1", "24/4/2026", "€15 047"], status: "active" as const },
    { id: "684968518", cells: ["PLA-6518", "Usage Metering Item 2", "11/11/2026", "€18 618"], status: "pending" as const },
    { id: "684972089", cells: ["PLA-1089", "Usage Metering Item 3", "26/6/2026", "€22 189"], status: "completed" as const },
    { id: "684975660", cells: ["PLA-4660", "Usage Metering Item 4", "13/1/2026", "€25 760"], status: "warning" as const },
    { id: "684979231", cells: ["PLA-8231", "Usage Metering Item 5", "28/8/2026", "€29 331"], status: "active" as const },
];
...
export default function PlatformOpsUsageMeteringPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Usage Metering</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Usage Metering</p>
                    </div>
                </div>
