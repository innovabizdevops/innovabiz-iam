...
/* ═══ Platform Ops — Tenant Mgmt Plat ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "4472", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "417", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1086", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "86%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2077863469", cells: ["PLA-7469", "Tenant Mgmt Plat Item 1", "18/2/2026", "€13 569"], status: "active" as const },
    { id: "2077867040", cells: ["PLA-2040", "Tenant Mgmt Plat Item 2", "5/9/2026", "€17 140"], status: "pending" as const },
    { id: "2077870611", cells: ["PLA-5611", "Tenant Mgmt Plat Item 3", "20/4/2026", "€20 711"], status: "completed" as const },
    { id: "2077874182", cells: ["PLA-9182", "Tenant Mgmt Plat Item 4", "7/11/2026", "€24 282"], status: "warning" as const },
    { id: "2077877753", cells: ["PLA-3753", "Tenant Mgmt Plat Item 5", "22/6/2026", "€27 853"], status: "active" as const },
];
...
export default function PlatformOpsTenantMgmtPlatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tenant Mgmt Plat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Tenant Mgmt Plat</p>
                    </div>
                </div>
