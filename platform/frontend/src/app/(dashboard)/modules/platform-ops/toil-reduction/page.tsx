...
/* ═══ Platform Ops — Toil Reduction ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "2580", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "490", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1899", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "145278406", cells: ["PLA-1406", "Toil Reduction Item 1", "15/11/2026", "€28 506"], status: "active" as const },
    { id: "145281977", cells: ["PLA-4977", "Toil Reduction Item 2", "2/6/2026", "€32 077"], status: "pending" as const },
    { id: "145285548", cells: ["PLA-8548", "Toil Reduction Item 3", "17/1/2026", "€35 648"], status: "completed" as const },
    { id: "145289119", cells: ["PLA-3119", "Toil Reduction Item 4", "4/8/2026", "€39 219"], status: "warning" as const },
    { id: "145292690", cells: ["PLA-6690", "Toil Reduction Item 5", "19/3/2026", "€42 790"], status: "active" as const },
];
...
export default function PlatformOpsToilReductionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Toil Reduction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Toil Reduction</p>
                    </div>
                </div>
