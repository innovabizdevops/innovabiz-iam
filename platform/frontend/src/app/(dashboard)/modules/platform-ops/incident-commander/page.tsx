...
/* ═══ Platform Ops — Incident Commander ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "1864", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "5", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "248", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1489325825", cells: ["PLA-6825", "Incident Commander Item 1", "2/6/2026", "€25 925"], status: "active" as const },
    { id: "1489329396", cells: ["PLA-1396", "Incident Commander Item 2", "17/1/2026", "€29 496"], status: "pending" as const },
    { id: "1489332967", cells: ["PLA-4967", "Incident Commander Item 3", "4/8/2026", "€33 067"], status: "completed" as const },
    { id: "1489336538", cells: ["PLA-8538", "Incident Commander Item 4", "19/3/2026", "€36 638"], status: "warning" as const },
    { id: "1489340109", cells: ["PLA-3109", "Incident Commander Item 5", "6/10/2026", "€40 209"], status: "active" as const },
];
...
export default function PlatformOpsIncidentCommanderPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Incident Commander</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Incident Commander</p>
                    </div>
                </div>
