...
/* ═══ Platform Ops — Feature Flag ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "3673", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "233", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "638", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "245547029", cells: ["PLA-1029", "Feature Flag Item 1", "22/6/2026", "€47 129"], status: "active" as const },
    { id: "245550600", cells: ["PLA-4600", "Feature Flag Item 2", "9/1/2026", "€700"], status: "pending" as const },
    { id: "245554171", cells: ["PLA-8171", "Feature Flag Item 3", "24/8/2026", "€4271"], status: "completed" as const },
    { id: "245557742", cells: ["PLA-2742", "Feature Flag Item 4", "11/3/2026", "€7842"], status: "warning" as const },
    { id: "245561313", cells: ["PLA-6313", "Feature Flag Item 5", "26/10/2026", "€11 413"], status: "active" as const },
];
...
export default function PlatformOpsFeatureFlagPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Feature Flag</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Feature Flag</p>
                    </div>
                </div>
