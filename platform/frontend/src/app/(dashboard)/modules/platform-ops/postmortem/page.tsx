...
/* ═══ Platform Ops — Postmortem ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "4127", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "51", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2080", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "842570143", cells: ["PLA-9143", "Postmortem Item 1", "24/8/2026", "€20 243"], status: "active" as const },
    { id: "842573714", cells: ["PLA-3714", "Postmortem Item 2", "11/3/2026", "€23 814"], status: "pending" as const },
    { id: "842577285", cells: ["PLA-7285", "Postmortem Item 3", "26/10/2026", "€27 385"], status: "completed" as const },
    { id: "842580856", cells: ["PLA-1856", "Postmortem Item 4", "13/5/2026", "€30 956"], status: "warning" as const },
    { id: "842584427", cells: ["PLA-5427", "Postmortem Item 5", "28/12/2026", "€34 527"], status: "active" as const },
];
...
export default function PlatformOpsPostmortemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Postmortem</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Postmortem</p>
                    </div>
                </div>
