...
/* ═══ Platform Ops — Billing Plat ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "2757", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "333", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "995", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1416957769", cells: ["PLA-7769", "Billing Plat Item 1", "18/2/2026", "€7869"], status: "active" as const },
    { id: "1416961340", cells: ["PLA-2340", "Billing Plat Item 2", "5/9/2026", "€11 440"], status: "pending" as const },
    { id: "1416964911", cells: ["PLA-5911", "Billing Plat Item 3", "20/4/2026", "€15 011"], status: "completed" as const },
    { id: "1416968482", cells: ["PLA-9482", "Billing Plat Item 4", "7/11/2026", "€18 582"], status: "warning" as const },
    { id: "1416972053", cells: ["PLA-4053", "Billing Plat Item 5", "22/6/2026", "€22 153"], status: "active" as const },
];
...
export default function PlatformOpsBillingPlatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Billing Plat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Billing Plat</p>
                    </div>
                </div>
