...
/* ═══ Platform Ops — Canary Deploy ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "2767", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "234", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "76", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "711523654", cells: ["PLA-2654", "Canary Deploy Item 1", "3/11/2026", "€23 754"], status: "active" as const },
    { id: "711527225", cells: ["PLA-6225", "Canary Deploy Item 2", "18/6/2026", "€27 325"], status: "pending" as const },
    { id: "711530796", cells: ["PLA-9796", "Canary Deploy Item 3", "5/1/2026", "€30 896"], status: "completed" as const },
    { id: "711534367", cells: ["PLA-4367", "Canary Deploy Item 4", "20/8/2026", "€34 467"], status: "warning" as const },
    { id: "711537938", cells: ["PLA-7938", "Canary Deploy Item 5", "7/3/2026", "€38 038"], status: "active" as const },
];
...
export default function PlatformOpsCanaryDeployPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Canary Deploy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Canary Deploy</p>
                    </div>
                </div>
