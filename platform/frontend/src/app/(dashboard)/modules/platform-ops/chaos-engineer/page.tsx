...
/* ═══ Platform Ops — Chaos Engineer ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total", value: "1105", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "136", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "370", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1077067620", cells: ["PLA-2620", "Chaos Engineer Item 1", "21/1/2026", "€17 720"], status: "active" as const },
    { id: "1077071191", cells: ["PLA-6191", "Chaos Engineer Item 2", "8/8/2026", "€21 291"], status: "pending" as const },
    { id: "1077074762", cells: ["PLA-9762", "Chaos Engineer Item 3", "23/3/2026", "€24 862"], status: "completed" as const },
    { id: "1077078333", cells: ["PLA-4333", "Chaos Engineer Item 4", "10/10/2026", "€28 433"], status: "warning" as const },
    { id: "1077081904", cells: ["PLA-7904", "Chaos Engineer Item 5", "25/5/2026", "€32 004"], status: "active" as const },
];
...
export default function PlatformOpsChaosEngineerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Chaos Engineer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Platform Ops • Chaos Engineer</p>
                    </div>
                </div>
