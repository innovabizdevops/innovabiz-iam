...
const PAGE = "Chat";
const KPIS = [{"l":"Teams Ativos","v":"2.395","t":"+14.5%","d":"up"},{"l":"Reuniões/Semana","v":"4727","t":"+5.7%","d":"up"},{"l":"Mensagens/Dia","v":"392","t":"+0.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"9.047","t":"+8.1%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.606","2709","1.237","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.649","2281","920","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.665","473","4.231","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.020","2141","5.147","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.872","3050","6.686","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":843},{"label":"Mar","value":903},{"label":"Abr","value":743},{"label":"Mai","value":562},{"label":"Jun","value":577},{"label":"Jul","value":638},{"label":"Ago","value":738},{"label":"Set","value":605},{"label":"Out","value":603},{"label":"Nov","value":592},{"label":"Dez","value":733}];
const MX = 903;
