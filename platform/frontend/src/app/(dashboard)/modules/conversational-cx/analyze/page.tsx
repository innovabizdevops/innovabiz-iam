...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"5.487","t":"+17.7%","d":"up"},{"l":"Queries/Dia","v":"452","t":"-1.2%","d":"down"},{"l":"Dados Processados (GB)","v":"6.693","t":"+5.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.806","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1655","2026-02-10","2.241","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1571","2026-01-05","4.933","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","708","2026-01-02","3.249","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4402","2026-02-25","1.632","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1606","2026-03-27","8.925","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":1057},{"label":"Mar","value":1043},{"label":"Abr","value":855},{"label":"Mai","value":748},{"label":"Jun","value":772},{"label":"Jul","value":762},{"label":"Ago","value":909},{"label":"Set","value":1079},{"label":"Out","value":876},{"label":"Nov","value":958},{"label":"Dez","value":912}];
const MX = 1079;
