...
/* ═══ Conversational CX — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "2423", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "985", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€299K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1880903323", cells: ["CON-3323", "Conversational CX Item 1", "20/8/2026", "€3423"], status: "active" as const },
    { id: "1880906894", cells: ["CON-6894", "Conversational CX Item 2", "7/3/2026", "€6994"], status: "pending" as const },
    { id: "1880910465", cells: ["CON-1465", "Conversational CX Item 3", "22/10/2026", "€10 565"], status: "completed" as const },
    { id: "1880914036", cells: ["CON-5036", "Conversational CX Item 4", "9/5/2026", "€14 136"], status: "warning" as const },
    { id: "1880917607", cells: ["CON-8607", "Conversational CX Item 5", "24/12/2026", "€17 707"], status: "active" as const },
];
...
export default function ConversationalCxPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conversational CX</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Conversational CX</p>
                    </div>
                </div>
