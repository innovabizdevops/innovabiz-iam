...
const ACCENT = "#f43f5e";
const MODULE = "Conversational CX";
const PAGE = "Voice";
const KPIS = [{"l":"Total Conversational Cx","v":"4.637","t":"+4.1%","d":"up"},{"l":"Voice Ativos","v":"6.398","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"86.3%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"58","t":"+8.1%","d":"up"}];
const COLS = ["ID","Voice","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Conversational Cx #001","Conversational Cx #002","8.918","4.475","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Conversational Cx #002","Conversational Cx #003","6.800","849","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Conversational Cx #003","Conversational Cx #004","673","8.976","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Conversational Cx #004","Conversational Cx #005","2.584","8.837","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Conversational Cx #005","Conversational Cx #001","3.311","8.831","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":669},{"label":"Mar","value":570},{"label":"Abr","value":603},{"label":"Mai","value":636},{"label":"Jun","value":291},{"label":"Jul","value":540},{"label":"Ago","value":449},{"label":"Set","value":327},{"label":"Out","value":400},{"label":"Nov","value":340},{"label":"Dez","value":650}];
const MX = 669;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f43f5e'}}>AI</span></h1>
                </div>
