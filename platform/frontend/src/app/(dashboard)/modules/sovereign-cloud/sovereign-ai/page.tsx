...
const PAGE = "Sovereign AI";
const KPIS = [{"l":"Total Sovereign Cloud","v":"254","t":"-0.7%","d":"down"},{"l":"Sovereign AI Ativos","v":"6.821","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"67","t":"+6.2%","d":"up"}];
const COLS = ["ID","Sovereign AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sovereign Cloud #001","Sovereign Cloud #002","1.148","2.119","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Sovereign Cloud #002","Sovereign Cloud #003","7.735","4.509","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sovereign Cloud #003","Sovereign Cloud #004","3.268","7.594","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Sovereign Cloud #004","Sovereign Cloud #005","6.968","5.994","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sovereign Cloud #005","Sovereign Cloud #001","4.345","5.216","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":810},{"label":"Mar","value":778},{"label":"Abr","value":813},{"label":"Mai","value":741},{"label":"Jun","value":831},{"label":"Jul","value":789},{"label":"Ago","value":1004},{"label":"Set","value":1012},{"label":"Out","value":709},{"label":"Nov","value":694},{"label":"Dez","value":1070}];
const MX = 1070;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>AI</span></h1>
                </div>
