...
const ACCENT = "#0f766e";
const MODULE = "Sovereign Cloud & Data";
const PAGE = "Encryption &amp; HSM";
const KPIS = [{"l":"Total Sovereign Cloud","v":"4.570","t":"+3.6%","d":"up"},{"l":"Encryption & HSM Ativos","v":"2.018","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"87","t":"-2.2%","d":"down"}];
const COLS = ["ID","Encryption & HSM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sovereign Cloud #001","Sovereign Cloud #002","4.657","5.923","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Sovereign Cloud #002","Sovereign Cloud #003","6.030","8.898","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Sovereign Cloud #003","Sovereign Cloud #004","3.896","8.660","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Sovereign Cloud #004","Sovereign Cloud #005","5.226","6.919","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sovereign Cloud #005","Sovereign Cloud #001","8.021","7.330","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":550},{"label":"Mar","value":851},{"label":"Abr","value":666},{"label":"Mai","value":799},{"label":"Jun","value":845},{"label":"Jul","value":607},{"label":"Ago","value":618},{"label":"Set","value":598},{"label":"Out","value":766},{"label":"Nov","value":634},{"label":"Dez","value":498}];
const MX = 886;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>HSM</span></h1>
                </div>
