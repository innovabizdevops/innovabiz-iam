...
const PAGE = "Local Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.005","t":"-4.0%","d":"down"},{"l":"NC Abertas","v":"5.647","t":"+14.2%","d":"up"},{"l":"Conformidade (%)","v":"85.2%","t":"+15.0%","d":"up"},{"l":"CAPAs Pendentes","v":"436","t":"+11.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.084","76.7%","3.771","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.529","75.2%","4.090","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.859","73.8%","2.111","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.040","85.5%","2.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.604","95.5%","6.178","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":873},{"label":"Mar","value":837},{"label":"Abr","value":840},{"label":"Mai","value":696},{"label":"Jun","value":852},{"label":"Jul","value":797},{"label":"Ago","value":633},{"label":"Set","value":639},{"label":"Out","value":701},{"label":"Nov","value":863},{"label":"Dez","value":614}];
const MX = 873;
