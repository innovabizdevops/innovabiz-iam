...
const PAGE = "Sovereign Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.214","t":"+1.3%","d":"up"},{"l":"Sessões/Dia","v":"3658","t":"+14.6%","d":"up"},{"l":"MFA Adoção (%)","v":"85.7%","t":"+2.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.630","t":"-5.0%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.719","3.199","4.386","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.493","5.044","2.749","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","763","3.011","2.965","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.076","2.131","3.082","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.879","3.034","5.895","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":722},{"label":"Mar","value":700},{"label":"Abr","value":1005},{"label":"Mai","value":978},{"label":"Jun","value":791},{"label":"Jul","value":1011},{"label":"Ago","value":874},{"label":"Set","value":665},{"label":"Out","value":742},{"label":"Nov","value":1025},{"label":"Dez","value":942}];
const MX = 1025;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0f766e'}}>eIDAS</span></h1>
                </div>
