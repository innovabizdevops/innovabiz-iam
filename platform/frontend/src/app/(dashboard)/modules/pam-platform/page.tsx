...
/* ═══ Privileged Access Mgmt — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "9975", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4553", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "68141675", cells: ["PAM-3675", "Privileged Access Mgmt Item 1", "8/12/2026", "€41 775"], status: "active" as const },
    { id: "68145246", cells: ["PAM-7246", "Privileged Access Mgmt Item 2", "23/7/2026", "€45 346"], status: "pending" as const },
    { id: "68148817", cells: ["PAM-1817", "Privileged Access Mgmt Item 3", "10/2/2026", "€48 917"], status: "completed" as const },
    { id: "68152388", cells: ["PAM-5388", "Privileged Access Mgmt Item 4", "25/9/2026", "€2488"], status: "warning" as const },
    { id: "68155959", cells: ["PAM-8959", "Privileged Access Mgmt Item 5", "12/4/2026", "€6059"], status: "active" as const },
];
...
export default function PrivilegedAccessMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Privileged Access Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Privileged Access Mgmt</p>
                    </div>
                </div>
