...
const ACCENT = "#7f1d1d";
const MODULE = "Privileged Access Mgmt";
const PAGE = "Elevate";
const KPIS = [{"l":"Formulários Ativos","v":"3.508","t":"+0.0%","d":"up"},{"l":"Submissões/Dia","v":"2721","t":"+11.1%","d":"up"},{"l":"Documentos Gerados","v":"8.242","t":"+2.2%","d":"up"},{"l":"Templates","v":"2.624","t":"-0.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","922","2026-02-08","6.540","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.434","2026-02-12","4.240","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","443","2026-02-07","4.788","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.546","2026-03-01","5.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.110","2026-02-03","3.273","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":373},{"label":"Mar","value":294},{"label":"Abr","value":369},{"label":"Mai","value":424},{"label":"Jun","value":536},{"label":"Jul","value":418},{"label":"Ago","value":435},{"label":"Set","value":504},{"label":"Out","value":398},{"label":"Nov","value":560},{"label":"Dez","value":324}];
const MX = 596;
