...
const PAGE = "Vault";
const KPIS = [{"l":"Formulários Ativos","v":"4.565","t":"+11.6%","d":"up"},{"l":"Submissões/Dia","v":"3949","t":"+13.5%","d":"up"},{"l":"Documentos Gerados","v":"7.272","t":"+13.6%","d":"up"},{"l":"Templates","v":"6.059","t":"+5.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","364","2026-01-09","5.500","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.803","2026-02-22","2.524","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.859","2026-02-19","5.330","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.846","2026-03-08","7.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.005","2026-03-25","915","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":341},{"label":"Mar","value":362},{"label":"Abr","value":470},{"label":"Mai","value":555},{"label":"Jun","value":685},{"label":"Jul","value":563},{"label":"Ago","value":653},{"label":"Set","value":424},{"label":"Out","value":713},{"label":"Nov","value":602},{"label":"Dez","value":678}];
const MX = 713;
