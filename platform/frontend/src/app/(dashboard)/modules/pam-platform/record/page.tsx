...
const PAGE = "Record";
const KPIS = [{"l":"Formulários Ativos","v":"181","t":"+10.6%","d":"up"},{"l":"Submissões/Dia","v":"678","t":"+13.3%","d":"up"},{"l":"Documentos Gerados","v":"3.132","t":"+12.5%","d":"up"},{"l":"Templates","v":"1.407","t":"+5.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","606","2026-01-18","981","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.078","2026-03-19","2.705","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.196","2026-02-10","6.109","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.974","2026-01-12","5.128","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.239","2026-02-04","1.316","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":628},{"label":"Mar","value":583},{"label":"Abr","value":364},{"label":"Mai","value":520},{"label":"Jun","value":532},{"label":"Jul","value":376},{"label":"Ago","value":436},{"label":"Set","value":507},{"label":"Out","value":667},{"label":"Nov","value":422},{"label":"Dez","value":388}];
const MX = 667;
