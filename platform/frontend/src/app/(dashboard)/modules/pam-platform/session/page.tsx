...
const PAGE = "Session";
const KPIS = [{"l":"Formulários Ativos","v":"975","t":"+11.8%","d":"up"},{"l":"Submissões/Dia","v":"2506","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"3.007","t":"+9.7%","d":"up"},{"l":"Templates","v":"1.295","t":"-3.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.416","2026-01-01","1.385","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.446","2026-01-04","5.112","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.927","2026-03-22","700","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","164","2026-03-13","631","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.047","2026-03-08","8.452","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":293},{"label":"Fev","value":491},{"label":"Mar","value":323},{"label":"Abr","value":482},{"label":"Mai","value":447},{"label":"Jun","value":355},{"label":"Jul","value":395},{"label":"Ago","value":608},{"label":"Set","value":443},{"label":"Out","value":228},{"label":"Nov","value":424},{"label":"Dez","value":430}];
const MX = 608;
