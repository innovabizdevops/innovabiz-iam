...
const PAGE = "Data Stories AI";
const KPIS = [{"l":"Dashboards Ativos","v":"7.967","t":"-4.1%","d":"down"},{"l":"Queries/Dia","v":"347","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"7.160","t":"+17.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.552","t":"+9.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2210","2026-03-25","8.762","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3371","2026-01-16","7.292","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2496","2026-03-16","8.853","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4544","2026-02-04","4.980","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1388","2026-02-18","4.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":393},{"label":"Mar","value":408},{"label":"Abr","value":688},{"label":"Mai","value":652},{"label":"Jun","value":460},{"label":"Jul","value":574},{"label":"Ago","value":693},{"label":"Set","value":366},{"label":"Out","value":655},{"label":"Nov","value":338},{"label":"Dez","value":676}];
const MX = 693;
