...
const ACCENT = "#7c3aed";
const MODULE = "Data Visualization & BI";
const PAGE = "Sankey Diagrams";
const KPIS = [{"l":"Dashboards Ativos","v":"5.218","t":"+7.1%","d":"up"},{"l":"Queries/Dia","v":"655","t":"-0.8%","d":"down"},{"l":"Dados Processados (GB)","v":"2.220","t":"+10.8%","d":"up"},{"l":"Utilizadores Analytics","v":"271","t":"+10.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4295","2026-01-14","7.515","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2005","2026-03-20","7.612","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1251","2026-03-21","425","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4802","2026-01-27","4.014","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4494","2026-01-26","3.080","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":352},{"label":"Mar","value":541},{"label":"Abr","value":264},{"label":"Mai","value":556},{"label":"Jun","value":306},{"label":"Jul","value":600},{"label":"Ago","value":641},{"label":"Set","value":364},{"label":"Out","value":354},{"label":"Nov","value":429},{"label":"Dez","value":287}];
const MX = 641;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>Diagram</span></h1>
                </div>
