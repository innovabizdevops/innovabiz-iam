...
const PAGE = "Chart Templates";
const KPIS = [{"l":"Formulários Ativos","v":"7.065","t":"+13.4%","d":"up"},{"l":"Submissões/Dia","v":"3323","t":"+14.3%","d":"up"},{"l":"Documentos Gerados","v":"8.582","t":"+5.4%","d":"up"},{"l":"Templates","v":"2.924","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.200","2026-01-03","1.228","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.538","2026-02-27","706","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.504","2026-01-13","5.664","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.954","2026-01-14","6.767","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.711","2026-01-23","2.571","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":765},{"label":"Mar","value":492},{"label":"Abr","value":609},{"label":"Mai","value":832},{"label":"Jun","value":637},{"label":"Jul","value":459},{"label":"Ago","value":508},{"label":"Set","value":689},{"label":"Out","value":476},{"label":"Nov","value":635},{"label":"Dez","value":805}];
const MX = 832;
