...
const KPIS = [{"l":"Dashboards Ativos","v":"6.275","t":"+17.4%","d":"up"},{"l":"Queries/Dia","v":"1496","t":"-1.0%","d":"down"},{"l":"Dados Processados (GB)","v":"6.429","t":"+17.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.270","t":"+8.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3943","2026-02-21","346","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2271","2026-03-15","8.454","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4034","2026-01-26","7.480","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1269","2026-02-24","5.077","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2138","2026-01-12","4.378","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":808},{"label":"Mar","value":551},{"label":"Abr","value":836},{"label":"Mai","value":878},{"label":"Jun","value":573},{"label":"Jul","value":676},{"label":"Ago","value":669},{"label":"Set","value":606},{"label":"Out","value":688},{"label":"Nov","value":823},{"label":"Dez","value":558}];
const MX = 912;
