...
const PAGE = "Treemap View";
const KPIS = [{"l":"Dashboards Ativos","v":"2.076","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"4419","t":"+16.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.362","t":"-1.1%","d":"down"},{"l":"Utilizadores Analytics","v":"8.922","t":"-3.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4068","2026-03-06","1.032","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2399","2026-02-06","7.461","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4717","2026-03-18","6.528","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1259","2026-02-01","4.279","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","419","2026-03-01","6.127","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":536},{"label":"Mar","value":636},{"label":"Abr","value":397},{"label":"Mai","value":277},{"label":"Jun","value":521},{"label":"Jul","value":632},{"label":"Ago","value":632},{"label":"Set","value":278},{"label":"Out","value":381},{"label":"Nov","value":631},{"label":"Dez","value":563}];
const MX = 636;
