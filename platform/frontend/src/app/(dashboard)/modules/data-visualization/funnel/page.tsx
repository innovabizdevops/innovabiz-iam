...
const PAGE = "Funnel Charts";
const KPIS = [{"l":"Dashboards Ativos","v":"5.003","t":"-4.5%","d":"down"},{"l":"Queries/Dia","v":"311","t":"+9.4%","d":"up"},{"l":"Dados Processados (GB)","v":"3.695","t":"+6.5%","d":"up"},{"l":"Utilizadores Analytics","v":"6.483","t":"-1.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3442","2026-03-17","8.896","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2233","2026-02-22","3.936","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4490","2026-03-22","1.309","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4139","2026-02-21","6.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1482","2026-01-17","8.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":846},{"label":"Mar","value":576},{"label":"Abr","value":562},{"label":"Mai","value":840},{"label":"Jun","value":830},{"label":"Jul","value":499},{"label":"Ago","value":823},{"label":"Set","value":621},{"label":"Out","value":485},{"label":"Nov","value":631},{"label":"Dez","value":497}];
const MX = 846;
