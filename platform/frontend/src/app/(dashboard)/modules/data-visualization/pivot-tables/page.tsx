...
const PAGE = "Pivot Tables";
const KPIS = [{"l":"Dashboards Ativos","v":"7.053","t":"+8.6%","d":"up"},{"l":"Queries/Dia","v":"1958","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.646","t":"+0.6%","d":"up"},{"l":"Utilizadores Analytics","v":"5.898","t":"+10.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2613","2026-03-17","7.113","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3486","2026-01-20","2.095","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2835","2026-01-12","2.080","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3164","2026-03-08","6.581","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2195","2026-03-25","8.599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":632},{"label":"Mar","value":682},{"label":"Abr","value":840},{"label":"Mai","value":638},{"label":"Jun","value":670},{"label":"Jul","value":511},{"label":"Ago","value":752},{"label":"Set","value":789},{"label":"Out","value":756},{"label":"Nov","value":613},{"label":"Dez","value":657}];
const MX = 840;
