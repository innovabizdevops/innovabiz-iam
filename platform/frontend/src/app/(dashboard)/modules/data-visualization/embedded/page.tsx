...
const KPIS = [{"l":"Dashboards Ativos","v":"7.393","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"2473","t":"+4.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.385","t":"+9.5%","d":"up"},{"l":"Utilizadores Analytics","v":"7.169","t":"-5.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","935","2026-02-26","5.356","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","163","2026-02-13","7.909","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2170","2026-01-03","719","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2796","2026-02-11","8.573","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","245","2026-01-17","6.233","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":465},{"label":"Mar","value":333},{"label":"Abr","value":374},{"label":"Mai","value":643},{"label":"Jun","value":471},{"label":"Jul","value":607},{"label":"Ago","value":446},{"label":"Set","value":609},{"label":"Out","value":527},{"label":"Nov","value":499},{"label":"Dez","value":578}];
const MX = 643;
