...
const PAGE = "Heatmaps &amp; Geo Charts";
const KPIS = [{"l":"Dashboards Ativos","v":"6.310","t":"+3.5%","d":"up"},{"l":"Queries/Dia","v":"4709","t":"+1.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.177","t":"+1.5%","d":"up"},{"l":"Utilizadores Analytics","v":"6.161","t":"+8.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4436","2026-03-26","2.189","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1511","2026-02-04","8.099","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4013","2026-02-05","5.347","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4831","2026-01-19","7.528","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3485","2026-02-02","7.749","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":887},{"label":"Mar","value":911},{"label":"Abr","value":957},{"label":"Mai","value":793},{"label":"Jun","value":1037},{"label":"Jul","value":777},{"label":"Ago","value":736},{"label":"Set","value":822},{"label":"Out","value":981},{"label":"Nov","value":652},{"label":"Dez","value":969}];
const MX = 1037;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>GIS</span></h1>
                </div>
