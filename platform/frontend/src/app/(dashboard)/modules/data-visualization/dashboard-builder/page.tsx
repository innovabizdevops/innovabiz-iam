...
const PAGE = "Dashboard Builder";
const KPIS = [{"l":"Dashboards Ativos","v":"840","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"2658","t":"+16.5%","d":"up"},{"l":"Dados Processados (GB)","v":"4.861","t":"+5.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.993","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2557","2026-03-28","6.261","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3557","2026-03-08","8.542","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3289","2026-03-11","7.208","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3329","2026-02-03","7.522","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","282","2026-01-16","9.073","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":964},{"label":"Mar","value":915},{"label":"Abr","value":984},{"label":"Mai","value":955},{"label":"Jun","value":944},{"label":"Jul","value":714},{"label":"Ago","value":629},{"label":"Set","value":616},{"label":"Out","value":915},{"label":"Nov","value":802},{"label":"Dez","value":743}];
const MX = 984;
