...
const PAGE = "Chart Studio";
const KPIS = [{"l":"Dashboards Ativos","v":"8.597","t":"+5.2%","d":"up"},{"l":"Queries/Dia","v":"3463","t":"+5.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.125","t":"+1.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.444","t":"+8.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3565","2026-03-06","7.652","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2827","2026-03-27","5.158","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3530","2026-01-01","496","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1596","2026-02-16","6.258","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2989","2026-02-26","8.319","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":762},{"label":"Mar","value":616},{"label":"Abr","value":676},{"label":"Mai","value":893},{"label":"Jun","value":693},{"label":"Jul","value":743},{"label":"Ago","value":761},{"label":"Set","value":634},{"label":"Out","value":944},{"label":"Nov","value":688},{"label":"Dez","value":868}];
const MX = 944;
