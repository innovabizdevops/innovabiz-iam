...
const PAGE = "Real-Time Dashboards";
const KPIS = [{"l":"Dashboards Ativos","v":"5.461","t":"+3.7%","d":"up"},{"l":"Queries/Dia","v":"1638","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"8.277","t":"+8.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.390","t":"+16.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","281","2026-01-08","3.922","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","538","2026-02-22","7.299","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1590","2026-01-20","1.766","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2495","2026-02-15","841","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3432","2026-03-19","1.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":676},{"label":"Mar","value":791},{"label":"Abr","value":621},{"label":"Mai","value":737},{"label":"Jun","value":736},{"label":"Jul","value":972},{"label":"Ago","value":805},{"label":"Set","value":826},{"label":"Out","value":808},{"label":"Nov","value":790},{"label":"Dez","value":834}];
const MX = 972;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>RTM</span></h1>
                </div>
