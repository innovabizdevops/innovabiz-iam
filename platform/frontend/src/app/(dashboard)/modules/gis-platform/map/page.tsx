...
const PAGE = "Map";
const KPIS = [{"l":"Formulários Ativos","v":"6.521","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"5060","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"2.656","t":"+6.0%","d":"up"},{"l":"Templates","v":"3.438","t":"+16.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.522","2026-03-12","3.151","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.080","2026-03-26","7.912","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.571","2026-01-13","1.209","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.921","2026-01-03","6.139","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.405","2026-01-08","5.047","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":698},{"label":"Mar","value":342},{"label":"Abr","value":641},{"label":"Mai","value":346},{"label":"Jun","value":605},{"label":"Jul","value":700},{"label":"Ago","value":392},{"label":"Set","value":354},{"label":"Out","value":551},{"label":"Nov","value":387},{"label":"Dez","value":718}];
const MX = 718;
