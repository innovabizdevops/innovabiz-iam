...
const ACCENT = "#0369a1";
const MODULE = "GIS Platform Deep";
const PAGE = "Analyze";
const KPIS = [{"l":"Formulários Ativos","v":"6.258","t":"+16.8%","d":"up"},{"l":"Submissões/Dia","v":"2221","t":"-4.9%","d":"down"},{"l":"Documentos Gerados","v":"5.106","t":"+13.5%","d":"up"},{"l":"Templates","v":"6.097","t":"+14.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.649","2026-01-03","704","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.297","2026-03-19","2.089","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.238","2026-02-01","5.628","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.862","2026-01-14","2.832","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.205","2026-01-13","4.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":1027},{"label":"Mar","value":909},{"label":"Abr","value":1038},{"label":"Mai","value":913},{"label":"Jun","value":1033},{"label":"Jul","value":674},{"label":"Ago","value":975},{"label":"Set","value":892},{"label":"Out","value":1067},{"label":"Nov","value":704},{"label":"Dez","value":705}];
const MX = 1067;
