...
const PAGE = "Route";
const KPIS = [{"l":"Formulários Ativos","v":"3.380","t":"+10.2%","d":"up"},{"l":"Submissões/Dia","v":"1798","t":"+16.3%","d":"up"},{"l":"Documentos Gerados","v":"6.461","t":"+13.9%","d":"up"},{"l":"Templates","v":"3.595","t":"+5.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.562","2026-03-02","4.822","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.509","2026-01-12","1.196","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.575","2026-02-28","4.044","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.300","2026-01-04","1.102","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.012","2026-03-19","3.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":372},{"label":"Mar","value":673},{"label":"Abr","value":649},{"label":"Mai","value":452},{"label":"Jun","value":666},{"label":"Jul","value":691},{"label":"Ago","value":717},{"label":"Set","value":413},{"label":"Out","value":599},{"label":"Nov","value":558},{"label":"Dez","value":529}];
const MX = 717;
