...
const PAGE = "Integrate";
const KPIS = [{"l":"Formulários Ativos","v":"8.430","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"4713","t":"-1.0%","d":"down"},{"l":"Documentos Gerados","v":"8.009","t":"+0.8%","d":"up"},{"l":"Templates","v":"7.411","t":"+0.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.096","2026-03-12","3.925","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","802","2026-01-20","8.490","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.134","2026-03-22","8.921","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.117","2026-01-20","2.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.436","2026-01-15","6.610","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":886},{"label":"Mar","value":877},{"label":"Abr","value":846},{"label":"Mai","value":806},{"label":"Jun","value":904},{"label":"Jul","value":581},{"label":"Ago","value":855},{"label":"Set","value":753},{"label":"Out","value":923},{"label":"Nov","value":586},{"label":"Dez","value":860}];
const MX = 923;
