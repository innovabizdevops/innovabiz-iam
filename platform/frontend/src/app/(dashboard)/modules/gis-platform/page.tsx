...
/* ═══ GIS Platform Deep — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "4846", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1638", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "468641046", cells: ["GIS-3046", "GIS Platform Deep Item 1", "7/7/2026", "€41 146"], status: "active" as const },
    { id: "468644617", cells: ["GIS-6617", "GIS Platform Deep Item 2", "22/2/2026", "€44 717"], status: "pending" as const },
    { id: "468648188", cells: ["GIS-1188", "GIS Platform Deep Item 3", "9/9/2026", "€48 288"], status: "completed" as const },
    { id: "468651759", cells: ["GIS-4759", "GIS Platform Deep Item 4", "24/4/2026", "€1859"], status: "warning" as const },
    { id: "468655330", cells: ["GIS-8330", "GIS Platform Deep Item 5", "11/11/2026", "€5430"], status: "active" as const },
];
...
export default function GisPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GIS Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GIS Platform Deep</p>
                    </div>
                </div>
