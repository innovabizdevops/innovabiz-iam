...
const PAGE = "Layer";
const KPIS = [{"l":"Formulários Ativos","v":"8.617","t":"+5.2%","d":"up"},{"l":"Submissões/Dia","v":"2959","t":"+14.3%","d":"up"},{"l":"Documentos Gerados","v":"7.473","t":"-3.5%","d":"down"},{"l":"Templates","v":"6.607","t":"+11.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.317","2026-02-12","8.935","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.467","2026-02-21","523","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.381","2026-02-02","3.031","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.367","2026-01-28","8.093","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.976","2026-02-28","4.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":886},{"label":"Mar","value":717},{"label":"Abr","value":693},{"label":"Mai","value":886},{"label":"Jun","value":766},{"label":"Jul","value":672},{"label":"Ago","value":804},{"label":"Set","value":833},{"label":"Out","value":596},{"label":"Nov","value":670},{"label":"Dez","value":901}];
const MX = 901;
