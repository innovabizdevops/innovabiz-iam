...
const PAGE = "Exam";
const KPIS = [{"l":"Riscos Identificados","v":"8.506","t":"+15.9%","d":"up"},{"l":"Mitigações Ativas","v":"2.105","t":"-4.5%","d":"down"},{"l":"Score Risco Geral","v":"79","t":"+6.3%","d":"up"},{"l":"Incidentes YTD","v":"226","t":"+16.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.138","4.265","6.212","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.207","3.645","6.774","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.657","2.123","6.182","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.765","4.395","2.734","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.506","250","2.405","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":608},{"label":"Mar","value":518},{"label":"Abr","value":411},{"label":"Mai","value":696},{"label":"Jun","value":643},{"label":"Jul","value":554},{"label":"Ago","value":532},{"label":"Set","value":369},{"label":"Out","value":348},{"label":"Nov","value":398},{"label":"Dez","value":414}];
const MX = 696;
