...
/* ═══ Dermatology Services — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "3549", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2997", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€208K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1923712049", cells: ["DER-8049", "Dermatology Services Item 1", "22/6/2026", "€12 149"], status: "active" as const },
    { id: "1923715620", cells: ["DER-2620", "Dermatology Services Item 2", "9/1/2026", "€15 720"], status: "pending" as const },
    { id: "1923719191", cells: ["DER-6191", "Dermatology Services Item 3", "24/8/2026", "€19 291"], status: "completed" as const },
    { id: "1923722762", cells: ["DER-9762", "Dermatology Services Item 4", "11/3/2026", "€22 862"], status: "warning" as const },
    { id: "1923726333", cells: ["DER-4333", "Dermatology Services Item 5", "26/10/2026", "€26 433"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dermatology Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dermatology Services</p>
                    </div>
                </div>
