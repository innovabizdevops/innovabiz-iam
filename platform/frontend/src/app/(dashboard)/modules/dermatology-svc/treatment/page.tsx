...
const KPIS = [{"l":"Riscos Identificados","v":"1.687","t":"+3.2%","d":"up"},{"l":"Mitigações Ativas","v":"5.389","t":"+10.9%","d":"up"},{"l":"Score Risco Geral","v":"70","t":"+12.4%","d":"up"},{"l":"Incidentes YTD","v":"7.216","t":"+8.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.795","6.333","4.893","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.869","1.390","5.108","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.373","5.789","7.434","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.358","5.272","2.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.643","7.302","4.553","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":624},{"label":"Mar","value":607},{"label":"Abr","value":363},{"label":"Mai","value":469},{"label":"Jun","value":329},{"label":"Jul","value":524},{"label":"Ago","value":657},{"label":"Set","value":536},{"label":"Out","value":697},{"label":"Nov","value":305},{"label":"Dez","value":473}];
const MX = 697;
