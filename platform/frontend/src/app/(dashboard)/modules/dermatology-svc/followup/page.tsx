...
const ACCENT = "#ec4899";
const MODULE = "Dermatology Services";
const PAGE = "Follow-Up";
const KPIS = [{"l":"Riscos Identificados","v":"4.945","t":"+0.5%","d":"up"},{"l":"Mitigações Ativas","v":"4.384","t":"+7.0%","d":"up"},{"l":"Score Risco Geral","v":"83","t":"-2.6%","d":"down"},{"l":"Incidentes YTD","v":"7.088","t":"+1.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.164","5.828","7.744","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.622","5.975","6.992","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.439","5.911","9.007","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.145","3.334","639","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.763","1.869","6.201","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":645},{"label":"Mar","value":835},{"label":"Abr","value":629},{"label":"Mai","value":694},{"label":"Jun","value":762},{"label":"Jul","value":620},{"label":"Ago","value":685},{"label":"Set","value":902},{"label":"Out","value":568},{"label":"Nov","value":769},{"label":"Dez","value":699}];
const MX = 902;
