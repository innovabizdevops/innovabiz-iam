...
const PAGE = "Cosmetic";
const KPIS = [{"l":"Riscos Identificados","v":"3.876","t":"+0.3%","d":"up"},{"l":"Mitigações Ativas","v":"2.503","t":"+11.2%","d":"up"},{"l":"Score Risco Geral","v":"87","t":"+6.5%","d":"up"},{"l":"Incidentes YTD","v":"3.392","t":"+10.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","554","911","784","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.219","3.241","8.677","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.647","835","2.695","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.019","6.794","7.617","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.525","428","481","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":555},{"label":"Mar","value":854},{"label":"Abr","value":743},{"label":"Mai","value":828},{"label":"Jun","value":526},{"label":"Jul","value":797},{"label":"Ago","value":856},{"label":"Set","value":512},{"label":"Out","value":654},{"label":"Nov","value":514},{"label":"Dez","value":710}];
const MX = 856;
