...
const PAGE = "Patient";
const KPIS = [{"l":"Riscos Identificados","v":"6.173","t":"+10.2%","d":"up"},{"l":"Mitigações Ativas","v":"6.632","t":"+7.0%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"+2.6%","d":"up"},{"l":"Incidentes YTD","v":"829","t":"+17.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","9.055","4.675","2.658","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.773","5.101","1.328","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.475","5.878","7.326","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.688","4.348","4.339","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.036","8.673","1.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":577},{"label":"Mar","value":459},{"label":"Abr","value":397},{"label":"Mai","value":368},{"label":"Jun","value":365},{"label":"Jul","value":552},{"label":"Ago","value":614},{"label":"Set","value":554},{"label":"Out","value":461},{"label":"Nov","value":555},{"label":"Dez","value":557}];
const MX = 614;
