...
/* ═══ Mine Operations — Haulage Fleet ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "2258", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "362", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "229", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "419322742", cells: ["MIN-4742", "Haulage Fleet Item 1", "7/11/2026", "€22 842"], status: "active" as const },
    { id: "419326313", cells: ["MIN-8313", "Haulage Fleet Item 2", "22/6/2026", "€26 413"], status: "pending" as const },
    { id: "419329884", cells: ["MIN-2884", "Haulage Fleet Item 3", "9/1/2026", "€29 984"], status: "completed" as const },
    { id: "419333455", cells: ["MIN-6455", "Haulage Fleet Item 4", "24/8/2026", "€33 555"], status: "warning" as const },
    { id: "419337026", cells: ["MIN-1026", "Haulage Fleet Item 5", "11/3/2026", "€37 126"], status: "active" as const },
];
...
export default function MineOperationsHaulageFleetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Haulage Fleet</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Haulage Fleet</p>
                    </div>
                </div>
