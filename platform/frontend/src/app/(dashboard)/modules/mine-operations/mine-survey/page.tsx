...
/* ═══ Mine Operations — Mine Survey ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "4638", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "340", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2918", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "707695136", cells: ["MIN-8136", "Mine Survey Item 1", "9/9/2026", "€45 236"], status: "active" as const },
    { id: "707698707", cells: ["MIN-2707", "Mine Survey Item 2", "24/4/2026", "€48 807"], status: "pending" as const },
    { id: "707702278", cells: ["MIN-6278", "Mine Survey Item 3", "11/11/2026", "€2378"], status: "completed" as const },
    { id: "707705849", cells: ["MIN-9849", "Mine Survey Item 4", "26/6/2026", "€5949"], status: "warning" as const },
    { id: "707709420", cells: ["MIN-4420", "Mine Survey Item 5", "13/1/2026", "€9520"], status: "active" as const },
];
...
export default function MineOperationsMineSurveyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mine Survey</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Mine Survey</p>
                    </div>
                </div>
