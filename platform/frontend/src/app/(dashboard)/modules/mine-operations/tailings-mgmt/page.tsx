...
/* ═══ Mine Operations — Tailings Mgmt ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "1127", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "283", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3668", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1157685127", cells: ["MIN-7127", "Tailings Mgmt Item 1", "12/8/2026", "€35 227"], status: "active" as const },
    { id: "1157688698", cells: ["MIN-1698", "Tailings Mgmt Item 2", "27/3/2026", "€38 798"], status: "pending" as const },
    { id: "1157692269", cells: ["MIN-5269", "Tailings Mgmt Item 3", "14/10/2026", "€42 369"], status: "completed" as const },
    { id: "1157695840", cells: ["MIN-8840", "Tailings Mgmt Item 4", "1/5/2026", "€45 940"], status: "warning" as const },
    { id: "1157699411", cells: ["MIN-3411", "Tailings Mgmt Item 5", "16/12/2026", "€49 511"], status: "active" as const },
];
...
export default function MineOperationsTailingsMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tailings Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Tailings Mgmt</p>
                    </div>
                </div>
