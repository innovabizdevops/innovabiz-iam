...
/* ═══ Mine Operations — Ventilation Sys ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "4053", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "471", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3492", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1856093987", cells: ["MIN-6987", "Ventilation Sys Item 1", "28/12/2026", "€44 087"], status: "active" as const },
    { id: "1856097558", cells: ["MIN-1558", "Ventilation Sys Item 2", "15/7/2026", "€47 658"], status: "pending" as const },
    { id: "1856101129", cells: ["MIN-5129", "Ventilation Sys Item 3", "2/2/2026", "€1229"], status: "completed" as const },
    { id: "1856104700", cells: ["MIN-8700", "Ventilation Sys Item 4", "17/9/2026", "€4800"], status: "warning" as const },
    { id: "1856108271", cells: ["MIN-3271", "Ventilation Sys Item 5", "4/4/2026", "€8371"], status: "active" as const },
];
...
export default function MineOperationsVentilationSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ventilation Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Ventilation Sys</p>
                    </div>
                </div>
