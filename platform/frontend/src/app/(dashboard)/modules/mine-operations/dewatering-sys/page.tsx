...
/* ═══ Mine Operations — Dewatering Sys ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "2915", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "132", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "707", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2077104800", cells: ["MIN-4800", "Dewatering Sys Item 1", "9/9/2026", "€4900"], status: "active" as const },
    { id: "2077108371", cells: ["MIN-8371", "Dewatering Sys Item 2", "24/4/2026", "€8471"], status: "pending" as const },
    { id: "2077111942", cells: ["MIN-2942", "Dewatering Sys Item 3", "11/11/2026", "€12 042"], status: "completed" as const },
    { id: "2077115513", cells: ["MIN-6513", "Dewatering Sys Item 4", "26/6/2026", "€15 613"], status: "warning" as const },
    { id: "2077119084", cells: ["MIN-1084", "Dewatering Sys Item 5", "13/1/2026", "€19 184"], status: "active" as const },
];
...
export default function MineOperationsDewateringSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dewatering Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Dewatering Sys</p>
                    </div>
                </div>
