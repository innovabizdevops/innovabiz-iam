...
/* ═══ Mine Operations — Pit Design ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "593", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "154", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "885", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1393191254", cells: ["MIN-1254", "Pit Design Item 1", "15/3/2026", "€41 354"], status: "active" as const },
    { id: "1393194825", cells: ["MIN-4825", "Pit Design Item 2", "2/10/2026", "€44 925"], status: "pending" as const },
    { id: "1393198396", cells: ["MIN-8396", "Pit Design Item 3", "17/5/2026", "€48 496"], status: "completed" as const },
    { id: "1393201967", cells: ["MIN-2967", "Pit Design Item 4", "4/12/2026", "€2067"], status: "warning" as const },
    { id: "1393205538", cells: ["MIN-6538", "Pit Design Item 5", "19/7/2026", "€5638"], status: "active" as const },
];
...
export default function MineOperationsPitDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pit Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Pit Design</p>
                    </div>
                </div>
