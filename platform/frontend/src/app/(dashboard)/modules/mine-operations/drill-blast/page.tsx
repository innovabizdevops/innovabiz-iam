...
/* ═══ Mine Operations — Drill Blast ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "4468", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "360", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3922", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "787739636", cells: ["MIN-6636", "Drill Blast Item 1", "13/9/2026", "€39 736"], status: "active" as const },
    { id: "787743207", cells: ["MIN-1207", "Drill Blast Item 2", "28/4/2026", "€43 307"], status: "pending" as const },
    { id: "787746778", cells: ["MIN-4778", "Drill Blast Item 3", "15/11/2026", "€46 878"], status: "completed" as const },
    { id: "787750349", cells: ["MIN-8349", "Drill Blast Item 4", "2/6/2026", "€449"], status: "warning" as const },
    { id: "787753920", cells: ["MIN-2920", "Drill Blast Item 5", "17/1/2026", "€4020"], status: "active" as const },
];
...
export default function MineOperationsDrillBlastPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drill Blast</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Drill Blast</p>
                    </div>
                </div>
