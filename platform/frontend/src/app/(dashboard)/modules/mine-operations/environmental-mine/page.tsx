...
/* ═══ Mine Operations — Environmental Mine ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "1807", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "264", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "564", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "85%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "47525508", cells: ["MIN-6508", "Environmental Mine Item 1", "17/1/2026", "€25 608"], status: "active" as const },
    { id: "47529079", cells: ["MIN-1079", "Environmental Mine Item 2", "4/8/2026", "€29 179"], status: "pending" as const },
    { id: "47532650", cells: ["MIN-4650", "Environmental Mine Item 3", "19/3/2026", "€32 750"], status: "completed" as const },
    { id: "47536221", cells: ["MIN-8221", "Environmental Mine Item 4", "6/10/2026", "€36 321"], status: "warning" as const },
    { id: "47539792", cells: ["MIN-2792", "Environmental Mine Item 5", "21/5/2026", "€39 892"], status: "active" as const },
];
...
export default function MineOperationsEnvironmentalMinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Environmental Mine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Environmental Mine</p>
                    </div>
                </div>
