...
/* ═══ Mine Operations — Ore Processing ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "2064", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "220", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1822", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1644269992", cells: ["MIN-6992", "Ore Processing Item 1", "9/5/2026", "€20 092"], status: "active" as const },
    { id: "1644273563", cells: ["MIN-1563", "Ore Processing Item 2", "24/12/2026", "€23 663"], status: "pending" as const },
    { id: "1644277134", cells: ["MIN-5134", "Ore Processing Item 3", "11/7/2026", "€27 234"], status: "completed" as const },
    { id: "1644280705", cells: ["MIN-8705", "Ore Processing Item 4", "26/2/2026", "€30 805"], status: "warning" as const },
    { id: "1644284276", cells: ["MIN-3276", "Ore Processing Item 5", "13/9/2026", "€34 376"], status: "active" as const },
];
...
export default function MineOperationsOreProcessingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ore Processing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Ore Processing</p>
                    </div>
                </div>
