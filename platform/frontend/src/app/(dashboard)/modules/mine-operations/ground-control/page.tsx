...
/* ═══ Mine Operations — Ground Control ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total", value: "1260", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "367", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2804", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "911439563", cells: ["MIN-1563", "Ground Control Item 1", "28/12/2026", "€39 663"], status: "active" as const },
    { id: "911443134", cells: ["MIN-5134", "Ground Control Item 2", "15/7/2026", "€43 234"], status: "pending" as const },
    { id: "911446705", cells: ["MIN-8705", "Ground Control Item 3", "2/2/2026", "€46 805"], status: "completed" as const },
    { id: "911450276", cells: ["MIN-3276", "Ground Control Item 4", "17/9/2026", "€376"], status: "warning" as const },
    { id: "911453847", cells: ["MIN-6847", "Ground Control Item 5", "4/4/2026", "€3947"], status: "active" as const },
];
...
export default function MineOperationsGroundControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ground Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Mine Operations • Ground Control</p>
                    </div>
                </div>
