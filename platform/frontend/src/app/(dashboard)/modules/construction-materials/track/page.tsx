...
const ACCENT = "#78350f";
const MODULE = "Construction Materials Mgmt";
const PAGE = "Track";
const KPIS = [{"l":"Total Construction Materials","v":"3.246","t":"+1.1%","d":"up"},{"l":"Track Ativos","v":"4.296","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"76","t":"-5.2%","d":"down"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Materials #001","Construction Materials #002","3.289","2.619","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Materials #002","Construction Materials #003","579","1.480","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Materials #003","Construction Materials #004","311","3.398","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Materials #004","Construction Materials #005","7.082","8.250","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Materials #005","Construction Materials #001","2.506","2.985","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":455},{"label":"Mar","value":590},{"label":"Abr","value":491},{"label":"Mai","value":612},{"label":"Jun","value":582},{"label":"Jul","value":375},{"label":"Ago","value":432},{"label":"Set","value":741},{"label":"Out","value":456},{"label":"Nov","value":462},{"label":"Dez","value":438}];
const MX = 741;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78350f'}}>RTM</span></h1>
                </div>
