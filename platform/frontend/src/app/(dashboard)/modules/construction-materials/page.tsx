...
/* ═══ Construction Materials Mgmt — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "2815", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4274", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€138K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "804328215", cells: ["CON-8215", "Construction Materials Mgmt Item 1", "20/4/2026", "€28 315"], status: "active" as const },
    { id: "804331786", cells: ["CON-2786", "Construction Materials Mgmt Item 2", "7/11/2026", "€31 886"], status: "pending" as const },
    { id: "804335357", cells: ["CON-6357", "Construction Materials Mgmt Item 3", "22/6/2026", "€35 457"], status: "completed" as const },
    { id: "804338928", cells: ["CON-9928", "Construction Materials Mgmt Item 4", "9/1/2026", "€39 028"], status: "warning" as const },
    { id: "804342499", cells: ["CON-4499", "Construction Materials Mgmt Item 5", "24/8/2026", "€42 599"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 75 }, { label: "Fev", value: 84 }, { label: "Mar", value: 93 }, { label: "Abr", value: 22 }, { label: "Mai", value: 31 }, { label: "Jun", value: 40 }];
...
export default function ConstructionMaterialsMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Construction Materials Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Construction Materials Mgmt</p>
                    </div>
                </div>
