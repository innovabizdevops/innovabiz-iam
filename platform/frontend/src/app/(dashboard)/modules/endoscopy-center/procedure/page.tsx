...
const KPIS = [{"l":"Total Endoscopy Center","v":"5.725","t":"-5.1%","d":"down"},{"l":"Procedure Ativos","v":"6.448","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"83","t":"+12.4%","d":"up"}];
const COLS = ["ID","Procedure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endoscopy Center #001","Endoscopy Center #002","3.449","8.345","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Endoscopy Center #002","Endoscopy Center #003","9.083","7.506","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Endoscopy Center #003","Endoscopy Center #004","285","3.136","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Endoscopy Center #004","Endoscopy Center #005","8.702","8.484","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endoscopy Center #005","Endoscopy Center #001","370","8.536","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":503},{"label":"Mar","value":591},{"label":"Abr","value":499},{"label":"Mai","value":477},{"label":"Jun","value":271},{"label":"Jul","value":406},{"label":"Ago","value":572},{"label":"Set","value":510},{"label":"Out","value":245},{"label":"Nov","value":288},{"label":"Dez","value":330}];
const MX = 591;
