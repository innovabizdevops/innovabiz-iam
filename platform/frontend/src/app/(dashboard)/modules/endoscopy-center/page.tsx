...
/* ═══ Endoscopy Center — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "4869", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4201", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€448K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1104518069", cells: ["END-3069", "Endoscopy Center Item 1", "26/6/2026", "€18 169"], status: "active" as const },
    { id: "1104521640", cells: ["END-6640", "Endoscopy Center Item 2", "13/1/2026", "€21 740"], status: "pending" as const },
    { id: "1104525211", cells: ["END-1211", "Endoscopy Center Item 3", "28/8/2026", "€25 311"], status: "completed" as const },
    { id: "1104528782", cells: ["END-4782", "Endoscopy Center Item 4", "15/3/2026", "€28 882"], status: "warning" as const },
    { id: "1104532353", cells: ["END-8353", "Endoscopy Center Item 5", "2/10/2026", "€32 453"], status: "active" as const },
];
...
export default function EndoscopyCenterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Endoscopy Center</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Endoscopy Center</p>
                    </div>
                </div>
