...
const PAGE = "Patient";
const KPIS = [{"l":"Total Endoscopy Center","v":"2.754","t":"+8.0%","d":"up"},{"l":"Patient Ativos","v":"522","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"85","t":"-3.2%","d":"down"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endoscopy Center #001","Endoscopy Center #002","5.510","6.197","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Endoscopy Center #002","Endoscopy Center #003","7.551","7.712","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Endoscopy Center #003","Endoscopy Center #004","7.575","4.931","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Endoscopy Center #004","Endoscopy Center #005","8.838","1.291","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endoscopy Center #005","Endoscopy Center #001","3.960","4.288","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":247},{"label":"Fev","value":277},{"label":"Mar","value":220},{"label":"Abr","value":585},{"label":"Mai","value":441},{"label":"Jun","value":560},{"label":"Jul","value":246},{"label":"Ago","value":469},{"label":"Set","value":577},{"label":"Out","value":465},{"label":"Nov","value":248},{"label":"Dez","value":389}];
const MX = 585;
