...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Endoscopy Center","v":"2.188","t":"+2.0%","d":"up"},{"l":"Schedule Ativos","v":"3.063","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+2.3%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endoscopy Center #001","Endoscopy Center #002","8.440","1.370","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Endoscopy Center #002","Endoscopy Center #003","3.449","8.135","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Endoscopy Center #003","Endoscopy Center #004","275","4.414","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Endoscopy Center #004","Endoscopy Center #005","7.287","8.213","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endoscopy Center #005","Endoscopy Center #001","944","4.757","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":533},{"label":"Mar","value":674},{"label":"Abr","value":562},{"label":"Mai","value":587},{"label":"Jun","value":655},{"label":"Jul","value":653},{"label":"Ago","value":524},{"label":"Set","value":483},{"label":"Out","value":612},{"label":"Nov","value":466},{"label":"Dez","value":803}];
const MX = 803;
