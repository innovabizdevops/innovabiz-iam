...
const PAGE = "Team Assign";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.685","t":"-3.7%","d":"down"},{"l":"NC Abertas","v":"4.735","t":"+3.0%","d":"up"},{"l":"Conformidade (%)","v":"83.4%","t":"+13.0%","d":"up"},{"l":"CAPAs Pendentes","v":"4.640","t":"+2.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.402","81.3%","2.979","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.226","87.6%","5.516","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.388","86.3%","1.274","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.789","84.9%","5.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.797","89.6%","2.613","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":357},{"label":"Mar","value":496},{"label":"Abr","value":363},{"label":"Mai","value":719},{"label":"Jun","value":706},{"label":"Jul","value":660},{"label":"Ago","value":593},{"label":"Set","value":729},{"label":"Out","value":458},{"label":"Nov","value":526},{"label":"Dez","value":526}];
const MX = 729;
