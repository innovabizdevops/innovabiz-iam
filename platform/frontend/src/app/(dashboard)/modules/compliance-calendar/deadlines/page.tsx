...
const PAGE = "Deadlines";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.690","t":"+1.1%","d":"up"},{"l":"NC Abertas","v":"5.717","t":"-5.3%","d":"down"},{"l":"Conformidade (%)","v":"67.7%","t":"+3.4%","d":"up"},{"l":"CAPAs Pendentes","v":"3.719","t":"+9.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.350","96.0%","8.043","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","930","72.3%","2.448","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.354","94.4%","4.693","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.278","75.1%","1.764","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.243","99.1%","6.235","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":800},{"label":"Mar","value":1081},{"label":"Abr","value":768},{"label":"Mai","value":807},{"label":"Jun","value":856},{"label":"Jul","value":996},{"label":"Ago","value":955},{"label":"Set","value":1035},{"label":"Out","value":933},{"label":"Nov","value":881},{"label":"Dez","value":903}];
const MX = 1081;
