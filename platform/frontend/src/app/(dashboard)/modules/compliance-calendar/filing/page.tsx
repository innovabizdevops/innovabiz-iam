...
const ACCENT = "#b45309";
const MODULE = "Compliance Calendar";
const PAGE = "Filing Status";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.123","t":"-3.6%","d":"down"},{"l":"NC Abertas","v":"1.227","t":"+17.8%","d":"up"},{"l":"Conformidade (%)","v":"72.1%","t":"+9.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.458","t":"+5.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.521","81.4%","4.870","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.767","87.4%","7.393","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.550","80.7%","1.427","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.752","90.4%","837","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.660","74.4%","1.066","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":723},{"label":"Mar","value":665},{"label":"Abr","value":910},{"label":"Mai","value":645},{"label":"Jun","value":739},{"label":"Jul","value":930},{"label":"Ago","value":749},{"label":"Set","value":679},{"label":"Out","value":933},{"label":"Nov","value":777},{"label":"Dez","value":859}];
const MX = 933;
