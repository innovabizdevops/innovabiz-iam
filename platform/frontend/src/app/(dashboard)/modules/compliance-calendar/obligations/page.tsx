...
const PAGE = "Obligations";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.617","t":"-4.8%","d":"down"},{"l":"NC Abertas","v":"8.772","t":"+4.8%","d":"up"},{"l":"Conformidade (%)","v":"79.0%","t":"+8.5%","d":"up"},{"l":"CAPAs Pendentes","v":"9.098","t":"+4.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.641","78.7%","2.597","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.072","93.5%","2.456","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.555","76.3%","3.895","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.715","93.5%","5.721","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.842","71.7%","675","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":913},{"label":"Mar","value":752},{"label":"Abr","value":714},{"label":"Mai","value":575},{"label":"Jun","value":628},{"label":"Jul","value":561},{"label":"Ago","value":710},{"label":"Set","value":929},{"label":"Out","value":876},{"label":"Nov","value":881},{"label":"Dez","value":888}];
const MX = 929;
