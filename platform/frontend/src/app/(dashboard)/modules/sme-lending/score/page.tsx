...
const ACCENT = "#15803d";
const MODULE = "SME Lending";
const PAGE = "Credit Score";
const KPIS = [{"l":"Integrações Ativas","v":"8.717","t":"+8.8%","d":"up"},{"l":"Chamadas/Hora","v":"2933","t":"-1.0%","d":"down"},{"l":"Taxa Sucesso (%)","v":"65.0%","t":"+14.6%","d":"up"},{"l":"Latência Média (ms)","v":"33ms","t":"+10.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.738","5.367","85.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.379","8.921","94.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.009","4.351","99.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.842","3.557","98.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.784","3.996","83.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":372},{"label":"Mar","value":361},{"label":"Abr","value":525},{"label":"Mai","value":496},{"label":"Jun","value":669},{"label":"Jul","value":594},{"label":"Ago","value":514},{"label":"Set","value":695},{"label":"Out","value":455},{"label":"Nov","value":459},{"label":"Dez","value":587}];
const MX = 695;
