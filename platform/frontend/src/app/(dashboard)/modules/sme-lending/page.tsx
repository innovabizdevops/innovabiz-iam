...
/* ═══ SME Lending — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "5396", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "89", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€169K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "194579896", cells: ["SME-9896", "SME Lending Item 1", "1/5/2026", "€29 996"], status: "active" as const },
    { id: "194583467", cells: ["SME-4467", "SME Lending Item 2", "16/12/2026", "€33 567"], status: "pending" as const },
    { id: "194587038", cells: ["SME-8038", "SME Lending Item 3", "3/7/2026", "€37 138"], status: "completed" as const },
    { id: "194590609", cells: ["SME-2609", "SME Lending Item 4", "18/2/2026", "€40 709"], status: "warning" as const },
    { id: "194594180", cells: ["SME-6180", "SME Lending Item 5", "5/9/2026", "€44 280"], status: "active" as const },
];
...
export default function SmeLendingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SME Lending</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SME Lending</p>
                    </div>
                </div>
