...
/* ═══ Companion Diagnostics — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "9394", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "109", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€32K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "763101294", cells: ["COM-1294", "Companion Diagnostics Item 1", "19/7/2026", "€1394"], status: "active" as const },
    { id: "763104865", cells: ["COM-4865", "Companion Diagnostics Item 2", "6/2/2026", "€4965"], status: "pending" as const },
    { id: "763108436", cells: ["COM-8436", "Companion Diagnostics Item 3", "21/9/2026", "€8536"], status: "completed" as const },
    { id: "763112007", cells: ["COM-3007", "Companion Diagnostics Item 4", "8/4/2026", "€12 107"], status: "warning" as const },
    { id: "763115578", cells: ["COM-6578", "Companion Diagnostics Item 5", "23/11/2026", "€15 678"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Companion Diagnostics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Companion Diagnostics</p>
                    </div>
                </div>
