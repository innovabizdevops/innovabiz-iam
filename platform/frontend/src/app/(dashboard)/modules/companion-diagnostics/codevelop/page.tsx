...
const ACCENT = "#9333ea";
const MODULE = "Companion Diagnostics";
const PAGE = "Co-Develop";
const KPIS = [{"l":"Total Companion Diagnostics","v":"5.500","t":"+12.4%","d":"up"},{"l":"Co Develop Ativos","v":"8.707","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"56","t":"-4.8%","d":"down"}];
const COLS = ["ID","Co Develop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Companion Diagnostics #001","Companion Diagnostics #002","1.924","2.332","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Companion Diagnostics #002","Companion Diagnostics #003","861","1.854","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Companion Diagnostics #003","Companion Diagnostics #004","481","8.986","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Companion Diagnostics #004","Companion Diagnostics #005","7.887","1.677","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Companion Diagnostics #005","Companion Diagnostics #001","6.849","5.358","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":754},{"label":"Mar","value":522},{"label":"Abr","value":629},{"label":"Mai","value":589},{"label":"Jun","value":593},{"label":"Jul","value":480},{"label":"Ago","value":704},{"label":"Set","value":641},{"label":"Out","value":476},{"label":"Nov","value":791},{"label":"Dez","value":752}];
const MX = 791;
...
export default function CodevelopPage() {
    return (
