...
const PAGE = "Engage";
const KPIS = [{"l":"Integrações Ativas","v":"7.642","t":"+17.7%","d":"up"},{"l":"Chamadas/Hora","v":"3607","t":"+10.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.0%","t":"+3.3%","d":"up"},{"l":"Latência Média (ms)","v":"53ms","t":"+2.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.902","559","99.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.329","8.991","98.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.770","5.184","91.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.071","6.788","96.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.155","5.115","80.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":935},{"label":"Fev","value":707},{"label":"Mar","value":998},{"label":"Abr","value":917},{"label":"Mai","value":737},{"label":"Jun","value":1040},{"label":"Jul","value":761},{"label":"Ago","value":854},{"label":"Set","value":911},{"label":"Out","value":802},{"label":"Nov","value":715},{"label":"Dez","value":721}];
const MX = 1040;
