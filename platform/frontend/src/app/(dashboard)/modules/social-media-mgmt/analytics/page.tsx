...
const KPIS = [{"l":"Dashboards Ativos","v":"4.767","t":"+8.2%","d":"up"},{"l":"Queries/Dia","v":"1961","t":"+12.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.597","t":"+10.2%","d":"up"},{"l":"Utilizadores Analytics","v":"1.621","t":"-3.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4178","2026-01-17","7.199","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3964","2026-03-07","4.159","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1310","2026-03-09","6.202","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1149","2026-01-28","2.876","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3618","2026-01-20","3.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":705},{"label":"Mar","value":685},{"label":"Abr","value":420},{"label":"Mai","value":793},{"label":"Jun","value":492},{"label":"Jul","value":470},{"label":"Ago","value":660},{"label":"Set","value":634},{"label":"Out","value":645},{"label":"Nov","value":440},{"label":"Dez","value":522}];
const MX = 793;
