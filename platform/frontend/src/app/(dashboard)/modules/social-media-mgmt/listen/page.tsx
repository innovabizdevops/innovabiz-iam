...
const ACCENT = "#6366f1";
const MODULE = "Social Media Mgmt";
const PAGE = "Listen";
const KPIS = [{"l":"Integrações Ativas","v":"5.234","t":"+0.1%","d":"up"},{"l":"Chamadas/Hora","v":"1523","t":"+3.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.2%","t":"+2.7%","d":"up"},{"l":"Latência Média (ms)","v":"56ms","t":"-0.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.834","2.546","96.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.516","1.059","73.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.307","8.705","70.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.544","8.297","94.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.098","3.384","77.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":854},{"label":"Mar","value":828},{"label":"Abr","value":644},{"label":"Mai","value":721},{"label":"Jun","value":924},{"label":"Jul","value":952},{"label":"Ago","value":870},{"label":"Set","value":576},{"label":"Out","value":817},{"label":"Nov","value":739},{"label":"Dez","value":894}];
const MX = 952;
