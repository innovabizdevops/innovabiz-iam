...
const PAGE = "Schedule";
const KPIS = [{"l":"Integrações Ativas","v":"7.650","t":"+17.6%","d":"up"},{"l":"Chamadas/Hora","v":"1915","t":"+6.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.2%","t":"+8.0%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"-1.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.309","3.660","75.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.485","6.194","76.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.138","308","89.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.647","4.406","75.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.446","8.871","73.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":893},{"label":"Mar","value":621},{"label":"Abr","value":528},{"label":"Mai","value":719},{"label":"Jun","value":585},{"label":"Jul","value":633},{"label":"Ago","value":613},{"label":"Set","value":543},{"label":"Out","value":873},{"label":"Nov","value":840},{"label":"Dez","value":858}];
const MX = 893;
