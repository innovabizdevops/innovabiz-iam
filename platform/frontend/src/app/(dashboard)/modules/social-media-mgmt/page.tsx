...
export default function SocialMediaMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Social Media Mgmt</h1><p className="text-sm text-muted-foreground">Social Media Mgmt • iBOS Enterprise</p></div>
