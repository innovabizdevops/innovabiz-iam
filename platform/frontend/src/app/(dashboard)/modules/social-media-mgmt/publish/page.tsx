...
const PAGE = "Publish";
const KPIS = [{"l":"Integrações Ativas","v":"2.782","t":"-1.0%","d":"down"},{"l":"Chamadas/Hora","v":"4703","t":"+2.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.7%","t":"-1.3%","d":"down"},{"l":"Latência Média (ms)","v":"195ms","t":"+15.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.813","4.356","91.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.075","1.324","78.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.010","5.070","86.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.983","7.324","99.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.248","3.617","78.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":448},{"label":"Fev","value":517},{"label":"Mar","value":667},{"label":"Abr","value":642},{"label":"Mai","value":304},{"label":"Jun","value":382},{"label":"Jul","value":418},{"label":"Ago","value":565},{"label":"Set","value":330},{"label":"Out","value":480},{"label":"Nov","value":471},{"label":"Dez","value":329}];
const MX = 667;
