...
const PAGE = "Training Paths";
const KPIS = [{"l":"Vendas YTD (€)","v":"€18116","t":"+9.6%","d":"up"},{"l":"Pipeline (€)","v":"€46916","t":"-1.3%","d":"down"},{"l":"Atingimento Quota (%)","v":"79.7%","t":"+11.6%","d":"up"},{"l":"Win Rate (%)","v":"73.5%","t":"+6.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 32505.55","€ 16551.21","€ 16197.70","88.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 15139.13","€ 48997.36","€ 10715.13","87.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 919.41","€ 23588.62","€ 22759.02","74.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 47861.50","€ 24732.87","€ 2575.25","73.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 35032.28","€ 7346.27","€ 44594.79","96.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":375},{"label":"Mar","value":452},{"label":"Abr","value":541},{"label":"Mai","value":614},{"label":"Jun","value":451},{"label":"Jul","value":271},{"label":"Ago","value":254},{"label":"Set","value":556},{"label":"Out","value":512},{"label":"Nov","value":494},{"label":"Dez","value":313}];
const MX = 614;
