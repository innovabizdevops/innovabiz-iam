...
const PAGE = "Playbooks";
const KPIS = [{"l":"Vendas YTD (€)","v":"€59161","t":"+11.6%","d":"up"},{"l":"Pipeline (€)","v":"€18048","t":"+15.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"78.9%","t":"+14.0%","d":"up"},{"l":"Win Rate (%)","v":"94.0%","t":"+11.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 15114.00","€ 5536.38","€ 22010.84","86.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 42112.63","€ 37038.81","€ 37854.80","94.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 46588.21","€ 13705.73","€ 40460.39","78.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 7465.87","€ 43891.15","€ 40855.22","71.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 21109.59","€ 44698.06","€ 20843.96","70.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":979},{"label":"Mar","value":597},{"label":"Abr","value":871},{"label":"Mai","value":840},{"label":"Jun","value":872},{"label":"Jul","value":713},{"label":"Ago","value":596},{"label":"Set","value":881},{"label":"Out","value":902},{"label":"Nov","value":848},{"label":"Dez","value":849}];
const MX = 979;
