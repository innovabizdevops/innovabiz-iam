...
const KPIS = [{"l":"Vendas YTD (€)","v":"€25275","t":"-0.1%","d":"down"},{"l":"Pipeline (€)","v":"€45551","t":"+8.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"68.3%","t":"-5.2%","d":"down"},{"l":"Win Rate (%)","v":"80.0%","t":"+4.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 8165.75","€ 6960.44","€ 825.46","94.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 9423.18","€ 7826.60","€ 23531.10","97.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 38943.37","€ 38987.67","€ 11984.27","74.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 29271.24","€ 23999.45","€ 7397.09","87.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 6691.85","€ 48952.42","€ 40271.96","92.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":877},{"label":"Mar","value":693},{"label":"Abr","value":711},{"label":"Mai","value":673},{"label":"Jun","value":970},{"label":"Jul","value":769},{"label":"Ago","value":712},{"label":"Set","value":724},{"label":"Out","value":885},{"label":"Nov","value":655},{"label":"Dez","value":853}];
const MX = 970;
