...
const ACCENT = "#ec4899";
const MODULE = "Sales Enablement";
const PAGE = "Coaching AI";
const KPIS = [{"l":"Vendas YTD (€)","v":"€46771","t":"-4.9%","d":"down"},{"l":"Pipeline (€)","v":"€53775","t":"+16.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"67.1%","t":"+15.9%","d":"up"},{"l":"Win Rate (%)","v":"80.9%","t":"+15.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 11355.54","€ 47877.11","€ 7568.82","72.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 23569.25","€ 15988.16","€ 48565.48","87.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 26804.95","€ 10486.88","€ 40314.45","73.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 3765.40","€ 40543.81","€ 25046.47","87.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 4966.34","€ 46524.86","€ 30479.60","73.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":881},{"label":"Mar","value":788},{"label":"Abr","value":612},{"label":"Mai","value":525},{"label":"Jun","value":607},{"label":"Jul","value":625},{"label":"Ago","value":846},{"label":"Set","value":697},{"label":"Out","value":501},{"label":"Nov","value":587},{"label":"Dez","value":683}];
const MX = 881;
