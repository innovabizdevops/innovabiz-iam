...
const PAGE = "Battle Cards";
const KPIS = [{"l":"Vendas YTD (€)","v":"€94249","t":"+17.1%","d":"up"},{"l":"Pipeline (€)","v":"€61428","t":"-2.4%","d":"down"},{"l":"Atingimento Quota (%)","v":"91.2%","t":"+4.9%","d":"up"},{"l":"Win Rate (%)","v":"70.6%","t":"+14.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 34687.18","€ 47224.91","€ 3713.46","91.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 11429.31","€ 28415.57","€ 43930.19","87.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22288.45","€ 42718.34","€ 29495.62","93.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 39400.31","€ 14898.80","€ 44324.47","98.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 5203.59","€ 1965.37","€ 22091.49","96.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":727},{"label":"Mar","value":530},{"label":"Abr","value":735},{"label":"Mai","value":766},{"label":"Jun","value":834},{"label":"Jul","value":533},{"label":"Ago","value":710},{"label":"Set","value":656},{"label":"Out","value":798},{"label":"Nov","value":881},{"label":"Dez","value":537}];
const MX = 881;
