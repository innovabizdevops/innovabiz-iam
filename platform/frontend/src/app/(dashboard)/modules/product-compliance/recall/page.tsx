...
const PAGE = "Recall";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.208","t":"+2.6%","d":"up"},{"l":"NC Abertas","v":"5.244","t":"+14.0%","d":"up"},{"l":"Conformidade (%)","v":"85.8%","t":"-4.1%","d":"down"},{"l":"CAPAs Pendentes","v":"4.704","t":"+5.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.685","85.0%","4.161","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.406","82.6%","2.322","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.549","70.8%","4.538","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.857","86.2%","2.137","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.957","73.8%","3.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":448},{"label":"Mar","value":689},{"label":"Abr","value":611},{"label":"Mai","value":527},{"label":"Jun","value":589},{"label":"Jul","value":471},{"label":"Ago","value":517},{"label":"Set","value":610},{"label":"Out","value":630},{"label":"Nov","value":627},{"label":"Dez","value":537}];
const MX = 689;
