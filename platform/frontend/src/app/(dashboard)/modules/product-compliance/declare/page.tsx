...
const PAGE = "Declare";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.660","t":"-4.8%","d":"down"},{"l":"NC Abertas","v":"1.434","t":"+0.9%","d":"up"},{"l":"Conformidade (%)","v":"75.2%","t":"+14.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.410","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.949","95.2%","3.064","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.714","72.2%","8.341","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","612","73.6%","1.555","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.202","80.7%","3.058","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.879","98.1%","2.634","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":865},{"label":"Mar","value":726},{"label":"Abr","value":734},{"label":"Mai","value":671},{"label":"Jun","value":628},{"label":"Jul","value":927},{"label":"Ago","value":738},{"label":"Set","value":572},{"label":"Out","value":949},{"label":"Nov","value":599},{"label":"Dez","value":756}];
const MX = 949;
