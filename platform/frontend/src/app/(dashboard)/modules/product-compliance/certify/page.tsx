...
const ACCENT = "#c74634";
const MODULE = "Product Compliance & Safety";
const PAGE = "Certify";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.472","t":"+6.8%","d":"up"},{"l":"NC Abertas","v":"1.340","t":"+8.1%","d":"up"},{"l":"Conformidade (%)","v":"94.0%","t":"+6.4%","d":"up"},{"l":"CAPAs Pendentes","v":"5.443","t":"+0.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.270","75.9%","5.522","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.960","83.9%","4.332","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.300","94.9%","3.886","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.565","74.5%","1.539","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.183","78.9%","6.140","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":672},{"label":"Mar","value":838},{"label":"Abr","value":774},{"label":"Mai","value":663},{"label":"Jun","value":656},{"label":"Jul","value":715},{"label":"Ago","value":707},{"label":"Set","value":888},{"label":"Out","value":812},{"label":"Nov","value":593},{"label":"Dez","value":722}];
const MX = 888;
