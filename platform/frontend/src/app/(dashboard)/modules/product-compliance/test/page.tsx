...
const PAGE = "Test";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.532","t":"+7.6%","d":"up"},{"l":"NC Abertas","v":"5.990","t":"+4.6%","d":"up"},{"l":"Conformidade (%)","v":"74.6%","t":"+8.7%","d":"up"},{"l":"CAPAs Pendentes","v":"4.225","t":"+15.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.334","84.4%","5.349","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.204","81.6%","4.155","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.089","92.5%","6.582","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.427","82.3%","4.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.013","90.9%","753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":401},{"label":"Mar","value":340},{"label":"Abr","value":392},{"label":"Mai","value":659},{"label":"Jun","value":535},{"label":"Jul","value":696},{"label":"Ago","value":588},{"label":"Set","value":477},{"label":"Out","value":521},{"label":"Nov","value":465},{"label":"Dez","value":533}];
const MX = 696;
