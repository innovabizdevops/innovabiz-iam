...
/* ═══ Product Compliance & Safety — Dashboard ═══ */

const ACCENT = "#c74634";

const KPIS = [
    { label: "Total Registos", value: "3748", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "102", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€126K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-6%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "261918048", cells: ["PRO-1048", "Product Compliance & Safety Item 1", "1/1/2026", "€18 148"], status: "active" as const },
    { id: "261921619", cells: ["PRO-4619", "Product Compliance & Safety Item 2", "16/8/2026", "€21 719"], status: "pending" as const },
    { id: "261925190", cells: ["PRO-8190", "Product Compliance & Safety Item 3", "3/3/2026", "€25 290"], status: "completed" as const },
    { id: "261928761", cells: ["PRO-2761", "Product Compliance & Safety Item 4", "18/10/2026", "€28 861"], status: "warning" as const },
    { id: "261932332", cells: ["PRO-6332", "Product Compliance & Safety Item 5", "5/5/2026", "€32 432"], status: "active" as const },
];
...
export default function ProductComplianceSafetyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Compliance & Safety</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Product Compliance & Safety</p>
                    </div>
                </div>
