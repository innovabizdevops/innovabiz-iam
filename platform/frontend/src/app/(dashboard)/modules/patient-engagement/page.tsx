...
/* ═══ Patient Engagement Platform — Dashboard ═══ */

const ACCENT = "#9f1239";

const KPIS = [
    { label: "Total Registos", value: "9482", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2223", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€295K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1849230382", cells: ["PAT-1382", "Patient Engagement Platform Item 1", "7/11/2026", "€30 482"], status: "active" as const },
    { id: "1849233953", cells: ["PAT-4953", "Patient Engagement Platform Item 2", "22/6/2026", "€34 053"], status: "pending" as const },
    { id: "1849237524", cells: ["PAT-8524", "Patient Engagement Platform Item 3", "9/1/2026", "€37 624"], status: "completed" as const },
    { id: "1849241095", cells: ["PAT-3095", "Patient Engagement Platform Item 4", "24/8/2026", "€41 195"], status: "warning" as const },
    { id: "1849244666", cells: ["PAT-6666", "Patient Engagement Platform Item 5", "11/3/2026", "€44 766"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 82 }, { label: "Fev", value: 91 }, { label: "Mar", value: 20 }, { label: "Abr", value: 29 }, { label: "Mai", value: 38 }, { label: "Jun", value: 47 }];
...
export default function PatientEngagementPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Patient Engagement Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Patient Engagement Platform</p>
                    </div>
                </div>
