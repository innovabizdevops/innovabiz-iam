...
const KPIS = [{"l":"eNPS","v":"70","t":"+7.1%","d":"up"},{"l":"Engagement (%)","v":"78.0%","t":"-0.3%","d":"down"},{"l":"Turnover (%)","v":"83.4%","t":"+3.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.718","t":"+7.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.238","2026-01-24","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.328","2026-03-17","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.585","2026-03-02","63","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.869","2026-03-06","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.064","2026-01-12","55","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":884},{"label":"Mar","value":652},{"label":"Abr","value":881},{"label":"Mai","value":964},{"label":"Jun","value":627},{"label":"Jul","value":944},{"label":"Ago","value":882},{"label":"Set","value":893},{"label":"Out","value":684},{"label":"Nov","value":709},{"label":"Dez","value":898}];
const MX = 964;
