...
const PAGE = "Portal";
const KPIS = [{"l":"eNPS","v":"57","t":"+16.4%","d":"up"},{"l":"Engagement (%)","v":"82.5%","t":"+14.5%","d":"up"},{"l":"Turnover (%)","v":"84.7%","t":"+9.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.920","t":"-6.0%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.760","2026-01-14","93","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.881","2026-01-26","64","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.636","2026-03-06","92","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","457","2026-01-18","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.715","2026-02-13","82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":773},{"label":"Mar","value":775},{"label":"Abr","value":730},{"label":"Mai","value":825},{"label":"Jun","value":638},{"label":"Jul","value":884},{"label":"Ago","value":873},{"label":"Set","value":859},{"label":"Out","value":811},{"label":"Nov","value":539},{"label":"Dez","value":519}];
const MX = 884;
