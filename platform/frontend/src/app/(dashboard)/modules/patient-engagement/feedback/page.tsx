...
const ACCENT = "#9f1239";
const MODULE = "Patient Engagement Platform";
const PAGE = "Feedback";
const KPIS = [{"l":"eNPS","v":"85","t":"-3.5%","d":"down"},{"l":"Engagement (%)","v":"73.5%","t":"+5.3%","d":"up"},{"l":"Turnover (%)","v":"83.1%","t":"-5.6%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"655","t":"-3.9%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.149","2026-02-22","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.309","2026-01-03","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.625","2026-02-13","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.074","2026-01-24","70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.557","2026-03-16","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":325},{"label":"Mar","value":254},{"label":"Abr","value":575},{"label":"Mai","value":272},{"label":"Jun","value":244},{"label":"Jul","value":379},{"label":"Ago","value":460},{"label":"Set","value":306},{"label":"Out","value":431},{"label":"Nov","value":509},{"label":"Dez","value":268}];
const MX = 575;
