...
const PAGE = "Message";
const KPIS = [{"l":"eNPS","v":"57","t":"+5.3%","d":"up"},{"l":"Engagement (%)","v":"76.9%","t":"+17.1%","d":"up"},{"l":"Turnover (%)","v":"93.9%","t":"+7.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.549","t":"-0.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.028","2026-03-12","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.479","2026-03-17","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","914","2026-01-18","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.001","2026-03-01","61","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.858","2026-01-02","83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":858},{"label":"Mar","value":731},{"label":"Abr","value":540},{"label":"Mai","value":799},{"label":"Jun","value":731},{"label":"Jul","value":856},{"label":"Ago","value":831},{"label":"Set","value":641},{"label":"Out","value":858},{"label":"Nov","value":601},{"label":"Dez","value":656}];
const MX = 858;
