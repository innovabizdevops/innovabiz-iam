...
const KPIS = [{"l":"eNPS","v":"76","t":"+16.9%","d":"up"},{"l":"Engagement (%)","v":"82.3%","t":"+6.0%","d":"up"},{"l":"Turnover (%)","v":"74.3%","t":"+4.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.640","t":"+10.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.724","2026-03-10","78","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.001","2026-01-20","64","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.920","2026-03-02","79","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.522","2026-02-09","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.755","2026-03-28","73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":711},{"label":"Mar","value":442},{"label":"Abr","value":689},{"label":"Mai","value":488},{"label":"Jun","value":639},{"label":"Jul","value":567},{"label":"Ago","value":630},{"label":"Set","value":656},{"label":"Out","value":668},{"label":"Nov","value":751},{"label":"Dez","value":571}];
const MX = 751;
