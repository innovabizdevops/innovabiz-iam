...
const KPIS = [{"l":"Total Swarm Intel","v":"364","t":"-0.4%","d":"down"},{"l":"Task Alloc Ativos","v":"504","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+3.5%","d":"up"}];
const COLS = ["ID","Task Alloc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Swarm Intel #001","Swarm Intel #002","8.603","6.582","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Swarm Intel #002","Swarm Intel #003","4.486","433","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Swarm Intel #003","Swarm Intel #004","1.147","381","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Swarm Intel #004","Swarm Intel #005","2.461","1.366","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Swarm Intel #005","Swarm Intel #001","2.303","405","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":570},{"label":"Mar","value":514},{"label":"Abr","value":490},{"label":"Mai","value":710},{"label":"Jun","value":596},{"label":"Jul","value":621},{"label":"Ago","value":648},{"label":"Set","value":735},{"label":"Out","value":546},{"label":"Nov","value":726},{"label":"Dez","value":504}];
const MX = 735;
...
export default function AllocPage() {
    return (
