...
const PAGE = "Capture";
const KPIS = [{"l":"Total Content Services","v":"5.596","t":"+12.2%","d":"up"},{"l":"Capture Ativos","v":"301","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"78","t":"+6.6%","d":"up"}];
const COLS = ["ID","Capture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Services #001","Content Services #002","6.914","4.705","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Content Services #002","Content Services #003","6.951","4.573","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Services #003","Content Services #004","4.952","2.167","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Content Services #004","Content Services #005","6.980","7.486","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Services #005","Content Services #001","4.667","724","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":488},{"label":"Mar","value":589},{"label":"Abr","value":477},{"label":"Mai","value":554},{"label":"Jun","value":606},{"label":"Jul","value":458},{"label":"Ago","value":466},{"label":"Set","value":714},{"label":"Out","value":589},{"label":"Nov","value":731},{"label":"Dez","value":492}];
const MX = 733;
