...
const PAGE = "Retain";
const KPIS = [{"l":"Total Content Services","v":"2.445","t":"-3.0%","d":"down"},{"l":"Retain Ativos","v":"3.991","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"60","t":"+6.4%","d":"up"}];
const COLS = ["ID","Retain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Services #001","2026-02-19","5.970","310","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Content Services #002","2026-02-23","3.301","4.094","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Services #003","2026-03-01","5.255","8.617","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Content Services #004","2026-03-28","7.456","8.458","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Services #005","2026-02-17","8.465","937","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":578},{"label":"Mar","value":566},{"label":"Abr","value":743},{"label":"Mai","value":610},{"label":"Jun","value":561},{"label":"Jul","value":787},{"label":"Ago","value":634},{"label":"Set","value":634},{"label":"Out","value":551},{"label":"Nov","value":808},{"label":"Dez","value":775}];
const MX = 808;
