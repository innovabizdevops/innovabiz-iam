...
const ACCENT = "#6366f1";
const MODULE = "Content Services Platform";
const PAGE = "Process";
const KPIS = [{"l":"Total Content Services","v":"4.635","t":"+11.5%","d":"up"},{"l":"Process Ativos","v":"6.712","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"78","t":"+17.8%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Services #001","Content Services #002","6.627","2.641","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Content Services #002","Content Services #003","517","1.253","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Services #003","Content Services #004","2.960","1.086","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Content Services #004","Content Services #005","8.904","112","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Services #005","Content Services #001","170","1.878","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":434},{"label":"Mar","value":652},{"label":"Abr","value":687},{"label":"Mai","value":316},{"label":"Jun","value":669},{"label":"Jul","value":411},{"label":"Ago","value":366},{"label":"Set","value":463},{"label":"Out","value":435},{"label":"Nov","value":368},{"label":"Dez","value":357}];
const MX = 687;
