...
/* ═══ Content Services Platform — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "2621", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2265", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€205K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2095476121", cells: ["CON-7121", "Content Services Platform Item 1", "26/2/2026", "€26 221"], status: "active" as const },
    { id: "2095479692", cells: ["CON-1692", "Content Services Platform Item 2", "13/9/2026", "€29 792"], status: "pending" as const },
    { id: "2095483263", cells: ["CON-5263", "Content Services Platform Item 3", "28/4/2026", "€33 363"], status: "completed" as const },
    { id: "2095486834", cells: ["CON-8834", "Content Services Platform Item 4", "15/11/2026", "€36 934"], status: "warning" as const },
    { id: "2095490405", cells: ["CON-3405", "Content Services Platform Item 5", "2/6/2026", "€40 505"], status: "active" as const },
];
...
export default function ContentServicesPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Content Services Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Content Services Platform</p>
                    </div>
                </div>
