...
const KPIS = [{"l":"Total Content Services","v":"1.155","t":"+17.8%","d":"up"},{"l":"Distribute Ativos","v":"3.559","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"86.8%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"73","t":"+10.8%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Services #001","Content Services #002","721","4.211","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Content Services #002","Content Services #003","4.648","8.653","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Services #003","Content Services #004","7.739","2.429","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Content Services #004","Content Services #005","6.992","8.860","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Services #005","Content Services #001","5.359","7.933","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":930},{"label":"Mar","value":977},{"label":"Abr","value":872},{"label":"Mai","value":920},{"label":"Jun","value":1001},{"label":"Jul","value":796},{"label":"Ago","value":681},{"label":"Set","value":1021},{"label":"Out","value":863},{"label":"Nov","value":819},{"label":"Dez","value":866}];
const MX = 1021;
