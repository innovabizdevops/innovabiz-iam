...
const PAGE = "Manage";
const KPIS = [{"l":"Total Content Services","v":"2.891","t":"+8.6%","d":"up"},{"l":"Manage Ativos","v":"3.909","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"77.9%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+16.7%","d":"up"}];
const COLS = ["ID","Manage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Content Services #001","Content Services #002","3.851","7.100","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Content Services #002","Content Services #003","262","2.775","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Content Services #003","Content Services #004","4.865","1.652","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Content Services #004","Content Services #005","1.791","7.104","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Content Services #005","Content Services #001","3.470","5.131","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":325},{"label":"Mar","value":359},{"label":"Abr","value":283},{"label":"Mai","value":472},{"label":"Jun","value":364},{"label":"Jul","value":480},{"label":"Ago","value":508},{"label":"Set","value":322},{"label":"Out","value":595},{"label":"Nov","value":560},{"label":"Dez","value":341}];
const MX = 595;
