...
/* ═══ Jewelry Manufacturing — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "6094", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4586", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "431784594", cells: ["JEW-1594", "Jewelry Manufacturing Item 1", "11/7/2026", "€34 694"], status: "active" as const },
    { id: "431788165", cells: ["JEW-5165", "Jewelry Manufacturing Item 2", "26/2/2026", "€38 265"], status: "pending" as const },
    { id: "431791736", cells: ["JEW-8736", "Jewelry Manufacturing Item 3", "13/9/2026", "€41 836"], status: "completed" as const },
    { id: "431795307", cells: ["JEW-3307", "Jewelry Manufacturing Item 4", "28/4/2026", "€45 407"], status: "warning" as const },
    { id: "431798878", cells: ["JEW-6878", "Jewelry Manufacturing Item 5", "15/11/2026", "€48 978"], status: "active" as const },
];
...
export default function JewelryManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Jewelry Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Jewelry Manufacturing</p>
                    </div>
                </div>
