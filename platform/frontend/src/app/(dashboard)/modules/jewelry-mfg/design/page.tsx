...
const ACCENT = "#d97706";
const MODULE = "Jewelry Manufacturing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.462","t":"+2.3%","d":"up"},{"l":"Submissões/Dia","v":"3186","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"8.130","t":"+10.1%","d":"up"},{"l":"Templates","v":"7.800","t":"-1.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.895","2026-02-01","3.306","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.894","2026-01-15","1.566","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.779","2026-03-11","6.131","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.642","2026-02-12","5.493","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","899","2026-01-13","8.043","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":705},{"label":"Mar","value":847},{"label":"Abr","value":779},{"label":"Mai","value":744},{"label":"Jun","value":794},{"label":"Jul","value":706},{"label":"Ago","value":816},{"label":"Set","value":670},{"label":"Out","value":869},{"label":"Nov","value":800},{"label":"Dez","value":846}];
const MX = 869;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#d97706'}}>3D</span></h1>
                </div>
