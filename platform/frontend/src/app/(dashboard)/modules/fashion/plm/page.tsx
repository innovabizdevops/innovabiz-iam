...
const PAGE = "PLM Fashion";
const KPIS = [{"l":"Produtos Ativos","v":"3.274","t":"-5.6%","d":"down"},{"l":"SKUs","v":"496","t":"+2.7%","d":"up"},{"l":"ECNs Pendentes","v":"1.785","t":"-0.9%","d":"down"},{"l":"Time-to-Market (dias)","v":"480","t":"+5.4%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","4.061","8.350","2.534","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","8.204","3.309","6.817","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","848","6.588","505","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","6.606","1.025","6.871","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","5.316","6.745","1.724","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":580},{"label":"Mar","value":555},{"label":"Abr","value":751},{"label":"Mai","value":546},{"label":"Jun","value":723},{"label":"Jul","value":569},{"label":"Ago","value":635},{"label":"Set","value":733},{"label":"Out","value":519},{"label":"Nov","value":764},{"label":"Dez","value":820}];
const MX = 820;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>PLM</span></h1>
                </div>
