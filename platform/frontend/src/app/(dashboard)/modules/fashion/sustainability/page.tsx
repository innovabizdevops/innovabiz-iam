...
const KPIS = [{"l":"Total Fashion","v":"1.030","t":"+10.8%","d":"up"},{"l":"Sustainability Score Ativos","v":"66","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+11.4%","d":"up"}];
const COLS = ["ID","Sustainability Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion #001","88.1%","5.393","4.937","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion #002","73.9%","701","3.963","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion #003","85.2%","3.997","8.883","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion #004","89.4%","7.051","6.234","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion #005","78.9%","1.556","3.739","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":876},{"label":"Mar","value":1051},{"label":"Abr","value":931},{"label":"Mai","value":914},{"label":"Jun","value":711},{"label":"Jul","value":1042},{"label":"Ago","value":660},{"label":"Set","value":876},{"label":"Out","value":955},{"label":"Nov","value":888},{"label":"Dez","value":818}];
const MX = 1051;
