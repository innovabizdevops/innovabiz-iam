...
const PAGE = "Clienteling CRM";
const KPIS = [{"l":"Total Fashion","v":"4.798","t":"-1.2%","d":"down"},{"l":"Clienteling CRM Ativos","v":"7.562","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"62","t":"+11.8%","d":"up"}];
const COLS = ["ID","Clienteling CRM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion #001","Fashion #002","6.523","2.211","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion #002","Fashion #003","3.708","890","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion #003","Fashion #004","4.522","6.571","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion #004","Fashion #005","7.970","292","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion #005","Fashion #001","189","5.468","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":576},{"label":"Mar","value":326},{"label":"Abr","value":593},{"label":"Mai","value":435},{"label":"Jun","value":303},{"label":"Jul","value":618},{"label":"Ago","value":410},{"label":"Set","value":442},{"label":"Out","value":502},{"label":"Nov","value":573},{"label":"Dez","value":320}];
const MX = 618;
