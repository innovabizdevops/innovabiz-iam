...
const PAGE = "Size &amp; Fit AI";
const KPIS = [{"l":"Total Fashion","v":"7.709","t":"-0.1%","d":"down"},{"l":"Size & Fit AI Ativos","v":"6.142","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+5.5%","d":"up"}];
const COLS = ["ID","Size & Fit AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion #001","Fashion #002","8.203","8.375","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion #002","Fashion #003","2.148","6.282","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion #003","Fashion #004","8.820","6.416","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion #004","Fashion #005","1.484","3.510","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion #005","Fashion #001","2.538","2.483","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":624},{"label":"Mar","value":692},{"label":"Abr","value":588},{"label":"Mai","value":716},{"label":"Jun","value":724},{"label":"Jul","value":816},{"label":"Ago","value":631},{"label":"Set","value":675},{"label":"Out","value":621},{"label":"Nov","value":725},{"label":"Dez","value":722}];
const MX = 903;
