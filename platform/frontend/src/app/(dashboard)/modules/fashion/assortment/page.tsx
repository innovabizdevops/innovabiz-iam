...
const ACCENT = "#6366f1";
const MODULE = "Fashion";
const PAGE = "Assortment Planning";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.599","t":"+1.5%","d":"up"},{"l":"Sessões/Dia","v":"1039","t":"-0.2%","d":"down"},{"l":"MFA Adoção (%)","v":"79.6%","t":"+11.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"7.648","t":"+17.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.686","4.174","7.145","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.049","8.919","2.287","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.956","791","4.079","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.166","3.050","5.320","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.401","1.356","5.599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":910},{"label":"Mar","value":933},{"label":"Abr","value":797},{"label":"Mai","value":1031},{"label":"Jun","value":776},{"label":"Jul","value":1004},{"label":"Ago","value":954},{"label":"Set","value":787},{"label":"Out","value":732},{"label":"Nov","value":693},{"label":"Dez","value":904}];
const MX = 1031;
