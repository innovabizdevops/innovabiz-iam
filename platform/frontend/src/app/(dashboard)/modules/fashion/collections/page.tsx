...
const PAGE = "Collection Mgmt";
const KPIS = [{"l":"Total Fashion","v":"3.792","t":"+12.1%","d":"up"},{"l":"Collection Mgmt Ativos","v":"8.930","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"81","t":"-0.9%","d":"down"}];
const COLS = ["ID","Collection Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion #001","Fashion #002","8.813","1.339","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion #002","Fashion #003","7.052","7.751","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion #003","Fashion #004","1.678","2.495","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion #004","Fashion #005","1.300","8.147","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion #005","Fashion #001","7.996","4.381","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":321},{"label":"Mar","value":302},{"label":"Abr","value":237},{"label":"Mai","value":247},{"label":"Jun","value":312},{"label":"Jul","value":506},{"label":"Ago","value":308},{"label":"Set","value":381},{"label":"Out","value":506},{"label":"Nov","value":367},{"label":"Dez","value":332}];
const MX = 516;
