...
const PAGE = "Virtual Try-On AI";
const KPIS = [{"l":"Total Fashion","v":"4.985","t":"+2.3%","d":"up"},{"l":"Virtual Try On AI Ativos","v":"6.340","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"83.7%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"64","t":"+1.9%","d":"up"}];
const COLS = ["ID","Virtual Try On AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion #001","Fashion #002","8.947","5.380","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion #002","Fashion #003","6.293","2.621","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion #003","Fashion #004","5.964","2.810","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion #004","Fashion #005","6.775","8.577","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion #005","Fashion #001","3.268","1.576","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":766},{"label":"Mar","value":1046},{"label":"Abr","value":704},{"label":"Mai","value":1008},{"label":"Jun","value":830},{"label":"Jul","value":665},{"label":"Ago","value":903},{"label":"Set","value":796},{"label":"Out","value":920},{"label":"Nov","value":738},{"label":"Dez","value":992}];
const MX = 1046;
