...
const ACCENT = "#6366f1";
const MODULE = "Sports Merchandise";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"910","t":"+11.2%","d":"up"},{"l":"Submissões/Dia","v":"1996","t":"+0.3%","d":"up"},{"l":"Documentos Gerados","v":"7.750","t":"+4.2%","d":"up"},{"l":"Templates","v":"4.388","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.205","2026-03-18","5.346","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.396","2026-01-05","1.324","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.622","2026-03-06","7.250","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.713","2026-03-06","2.552","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.417","2026-02-08","2.491","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":692},{"label":"Mar","value":453},{"label":"Abr","value":737},{"label":"Mai","value":468},{"label":"Jun","value":695},{"label":"Jul","value":833},{"label":"Ago","value":808},{"label":"Set","value":653},{"label":"Out","value":664},{"label":"Nov","value":699},{"label":"Dez","value":702}];
const MX = 833;
