...
const KPIS = [{"l":"Atletas Registados","v":"7.042","t":"+15.8%","d":"up"},{"l":"Treinos/Semana","v":"296","t":"+4.4%","d":"up"},{"l":"Competições","v":"736","t":"+2.2%","d":"up"},{"l":"Performance Score","v":"75","t":"+2.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.033","3.592","5.793","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.244","1.730","1.081","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.513","8.681","7.130","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.622","7.167","2.209","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.668","3.318","2.349","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":325},{"label":"Mar","value":316},{"label":"Abr","value":332},{"label":"Mai","value":608},{"label":"Jun","value":629},{"label":"Jul","value":422},{"label":"Ago","value":233},{"label":"Set","value":294},{"label":"Out","value":364},{"label":"Nov","value":282},{"label":"Dez","value":599}];
const MX = 629;
