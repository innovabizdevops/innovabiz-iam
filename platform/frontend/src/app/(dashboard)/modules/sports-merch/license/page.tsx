...
const PAGE = "License";
const KPIS = [{"l":"Atletas Registados","v":"1.540","t":"+17.8%","d":"up"},{"l":"Treinos/Semana","v":"901","t":"+16.0%","d":"up"},{"l":"Competições","v":"3.098","t":"+5.4%","d":"up"},{"l":"Performance Score","v":"78","t":"+9.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.351","3.437","7.406","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.319","5.539","6.633","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.312","2.835","3.281","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.076","1.753","7.673","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.688","7.118","4.336","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":646},{"label":"Mar","value":460},{"label":"Abr","value":523},{"label":"Mai","value":419},{"label":"Jun","value":662},{"label":"Jul","value":366},{"label":"Ago","value":409},{"label":"Set","value":343},{"label":"Out","value":645},{"label":"Nov","value":587},{"label":"Dez","value":673}];
const MX = 673;
