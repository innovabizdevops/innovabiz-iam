...
const PAGE = "xG Model AI";
const KPIS = [{"l":"Dashboards Ativos","v":"7.040","t":"+17.0%","d":"up"},{"l":"Queries/Dia","v":"861","t":"-0.2%","d":"down"},{"l":"Dados Processados (GB)","v":"4.578","t":"+10.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.987","t":"+15.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3243","2026-03-16","4.383","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4909","2026-03-27","984","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4297","2026-01-04","5.235","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3656","2026-01-03","2.451","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5028","2026-03-20","5.106","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":325},{"label":"Fev","value":554},{"label":"Mar","value":596},{"label":"Abr","value":409},{"label":"Mai","value":396},{"label":"Jun","value":532},{"label":"Jul","value":647},{"label":"Ago","value":362},{"label":"Set","value":557},{"label":"Out","value":616},{"label":"Nov","value":658},{"label":"Dez","value":443}];
const MX = 658;
