...
const KPIS = [{"l":"Dashboards Ativos","v":"1.179","t":"+17.3%","d":"up"},{"l":"Queries/Dia","v":"4501","t":"+13.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.715","t":"+0.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.987","t":"+15.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3977","2026-01-06","7.403","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","989","2026-03-05","7.425","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3373","2026-02-10","3.499","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2571","2026-01-21","946","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4918","2026-01-19","6.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":516},{"label":"Mar","value":781},{"label":"Abr","value":530},{"label":"Mai","value":705},{"label":"Jun","value":736},{"label":"Jul","value":716},{"label":"Ago","value":630},{"label":"Set","value":574},{"label":"Out","value":725},{"label":"Nov","value":854},{"label":"Dez","value":767}];
const MX = 854;
