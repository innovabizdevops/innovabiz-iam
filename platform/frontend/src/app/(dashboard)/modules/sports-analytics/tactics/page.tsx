...
const PAGE = "Tactical Board";
const KPIS = [{"l":"Dashboards Ativos","v":"8.215","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"4683","t":"-4.6%","d":"down"},{"l":"Dados Processados (GB)","v":"797","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.968","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","590","2026-01-16","2.843","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","928","2026-02-26","4.568","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4038","2026-01-07","7.385","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3261","2026-01-14","6.008","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1441","2026-01-01","5.551","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":699},{"label":"Mar","value":564},{"label":"Abr","value":583},{"label":"Mai","value":593},{"label":"Jun","value":603},{"label":"Jul","value":793},{"label":"Ago","value":707},{"label":"Set","value":609},{"label":"Out","value":795},{"label":"Nov","value":568},{"label":"Dez","value":528}];
const MX = 817;
