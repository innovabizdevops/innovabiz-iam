...
const ACCENT = "#0e7490";
const MODULE = "Sports Analytics";
const PAGE = "Injury Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"4.529","t":"+6.5%","d":"up"},{"l":"Queries/Dia","v":"4544","t":"+0.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.527","t":"+16.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.808","t":"+16.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","518","2026-03-25","7.929","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3048","2026-02-20","1.490","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1482","2026-03-21","4.956","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2773","2026-03-06","1.201","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3385","2026-03-21","4.782","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":667},{"label":"Mar","value":682},{"label":"Abr","value":672},{"label":"Mai","value":782},{"label":"Jun","value":389},{"label":"Jul","value":657},{"label":"Ago","value":547},{"label":"Set","value":554},{"label":"Out","value":546},{"label":"Nov","value":516},{"label":"Dez","value":584}];
const MX = 782;
