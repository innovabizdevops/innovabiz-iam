...
const PAGE = "Player Metric";
const KPIS = [{"l":"Dashboards Ativos","v":"3.445","t":"+10.0%","d":"up"},{"l":"Queries/Dia","v":"1248","t":"+17.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.987","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"395","t":"-0.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4199","2026-03-14","3.485","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2825","2026-02-03","2.465","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","777","2026-01-02","5.837","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1048","2026-01-24","2.531","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3295","2026-01-06","7.225","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":927},{"label":"Mar","value":769},{"label":"Abr","value":705},{"label":"Mai","value":812},{"label":"Jun","value":782},{"label":"Jul","value":900},{"label":"Ago","value":684},{"label":"Set","value":836},{"label":"Out","value":690},{"label":"Nov","value":948},{"label":"Dez","value":640}];
const MX = 948;
