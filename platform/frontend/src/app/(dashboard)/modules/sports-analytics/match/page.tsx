...
const PAGE = "Match Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.701","t":"+12.2%","d":"up"},{"l":"Queries/Dia","v":"439","t":"+10.4%","d":"up"},{"l":"Dados Processados (GB)","v":"7.553","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.189","t":"-4.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3068","2026-03-01","9.014","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3335","2026-02-07","8.273","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1263","2026-01-13","4.732","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4187","2026-02-02","4.994","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4227","2026-01-21","4.225","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":1018},{"label":"Mar","value":930},{"label":"Abr","value":942},{"label":"Mai","value":702},{"label":"Jun","value":678},{"label":"Jul","value":834},{"label":"Ago","value":992},{"label":"Set","value":925},{"label":"Out","value":722},{"label":"Nov","value":695},{"label":"Dez","value":774}];
const MX = 1018;
