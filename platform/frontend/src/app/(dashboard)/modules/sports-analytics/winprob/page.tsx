...
const PAGE = "Win Probability";
const KPIS = [{"l":"Dashboards Ativos","v":"1.240","t":"+4.7%","d":"up"},{"l":"Queries/Dia","v":"649","t":"-4.7%","d":"down"},{"l":"Dados Processados (GB)","v":"3.559","t":"+4.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.923","t":"+2.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","933","2026-02-14","5.023","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1026","2026-03-19","7.719","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3787","2026-01-07","5.442","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3925","2026-02-17","1.304","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2956","2026-01-27","2.309","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":280},{"label":"Fev","value":434},{"label":"Mar","value":482},{"label":"Abr","value":355},{"label":"Mai","value":239},{"label":"Jun","value":456},{"label":"Jul","value":270},{"label":"Ago","value":439},{"label":"Set","value":294},{"label":"Out","value":497},{"label":"Nov","value":466},{"label":"Dez","value":256}];
const MX = 497;
