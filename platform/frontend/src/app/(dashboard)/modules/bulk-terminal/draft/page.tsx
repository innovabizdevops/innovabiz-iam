...
const PAGE = "Draft Survey";
const KPIS = [{"l":"Riscos Identificados","v":"5.422","t":"+3.5%","d":"up"},{"l":"Mitigações Ativas","v":"395","t":"+14.3%","d":"up"},{"l":"Score Risco Geral","v":"62","t":"+12.6%","d":"up"},{"l":"Incidentes YTD","v":"1.415","t":"+7.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.203","4.795","2.098","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.149","1.901","4.685","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.463","9.099","7.028","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.136","5.299","5.396","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.752","4.782","3.629","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":493},{"label":"Mar","value":485},{"label":"Abr","value":611},{"label":"Mai","value":740},{"label":"Jun","value":640},{"label":"Jul","value":749},{"label":"Ago","value":411},{"label":"Set","value":436},{"label":"Out","value":561},{"label":"Nov","value":573},{"label":"Dez","value":453}];
const MX = 756;
