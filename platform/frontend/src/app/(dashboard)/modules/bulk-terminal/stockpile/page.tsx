...
const ACCENT = "#475569";
const MODULE = "Bulk Terminal";
const PAGE = "Stockpile Mon";
const KPIS = [{"l":"Riscos Identificados","v":"7.289","t":"+4.6%","d":"up"},{"l":"Mitigações Ativas","v":"2.568","t":"+5.6%","d":"up"},{"l":"Score Risco Geral","v":"75","t":"-5.3%","d":"down"},{"l":"Incidentes YTD","v":"5.510","t":"+9.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.699","3.885","7.530","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.223","7.817","4.220","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.611","8.554","2.226","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.020","6.482","420","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.376","1.868","8.091","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":563},{"label":"Mar","value":498},{"label":"Abr","value":477},{"label":"Mai","value":621},{"label":"Jun","value":280},{"label":"Jul","value":625},{"label":"Ago","value":510},{"label":"Set","value":520},{"label":"Out","value":646},{"label":"Nov","value":348},{"label":"Dez","value":430}];
const MX = 646;
