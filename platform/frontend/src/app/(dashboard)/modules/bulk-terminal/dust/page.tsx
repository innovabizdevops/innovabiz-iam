...
const PAGE = "Dust Control";
const KPIS = [{"l":"Riscos Identificados","v":"8.448","t":"-4.6%","d":"down"},{"l":"Mitigações Ativas","v":"4.756","t":"+1.7%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"+14.4%","d":"up"},{"l":"Incidentes YTD","v":"2.448","t":"+3.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","805","8.059","3.852","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.332","7.864","2.014","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.880","7.155","2.927","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.229","3.532","2.706","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.835","2.442","2.616","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":561},{"label":"Mar","value":279},{"label":"Abr","value":551},{"label":"Mai","value":582},{"label":"Jun","value":459},{"label":"Jul","value":336},{"label":"Ago","value":347},{"label":"Set","value":322},{"label":"Out","value":461},{"label":"Nov","value":355},{"label":"Dez","value":303}];
const MX = 582;
