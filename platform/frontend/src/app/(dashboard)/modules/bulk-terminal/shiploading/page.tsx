...
const PAGE = "Shiploading";
const KPIS = [{"l":"Riscos Identificados","v":"9.069","t":"-1.3%","d":"down"},{"l":"Mitigações Ativas","v":"1.187","t":"+10.0%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"-5.7%","d":"down"},{"l":"Incidentes YTD","v":"8.278","t":"-0.4%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.872","8.838","4.191","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.730","3.914","8.451","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.536","2.415","1.503","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.373","2.302","7.071","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.251","2.091","1.921","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":646},{"label":"Mar","value":749},{"label":"Abr","value":521},{"label":"Mai","value":777},{"label":"Jun","value":736},{"label":"Jul","value":801},{"label":"Ago","value":863},{"label":"Set","value":669},{"label":"Out","value":791},{"label":"Nov","value":782},{"label":"Dez","value":576}];
const MX = 863;
...
export default function ShiploadingPage() {
    return (
