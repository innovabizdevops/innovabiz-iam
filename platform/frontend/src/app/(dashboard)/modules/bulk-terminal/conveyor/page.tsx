...
const PAGE = "Conveyor";
const KPIS = [{"l":"Riscos Identificados","v":"6.509","t":"-3.0%","d":"down"},{"l":"Mitigações Ativas","v":"6.698","t":"+1.3%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"+16.0%","d":"up"},{"l":"Incidentes YTD","v":"4.619","t":"+10.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.417","4.982","2.370","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.279","1.897","6.117","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.688","8.455","6.191","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.943","295","8.851","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.389","6.101","5.493","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":778},{"label":"Mar","value":602},{"label":"Abr","value":566},{"label":"Mai","value":688},{"label":"Jun","value":710},{"label":"Jul","value":682},{"label":"Ago","value":887},{"label":"Set","value":618},{"label":"Out","value":615},{"label":"Nov","value":896},{"label":"Dez","value":607}];
const MX = 896;
