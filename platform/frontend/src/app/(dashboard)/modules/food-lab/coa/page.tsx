...
const PAGE = "COA Issue";
const KPIS = [{"l":"Total Food Lab","v":"2.102","t":"+5.3%","d":"up"},{"l":"COA Issue Ativos","v":"190","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"71","t":"+15.0%","d":"up"}];
const COLS = ["ID","COA Issue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Lab #001","Food Lab #002","5.620","6.251","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Food Lab #002","Food Lab #003","8.116","5.335","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Lab #003","Food Lab #004","5.839","3.585","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Food Lab #004","Food Lab #005","7.422","3.290","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Lab #005","Food Lab #001","5.035","1.687","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":545},{"label":"Mar","value":437},{"label":"Abr","value":570},{"label":"Mai","value":644},{"label":"Jun","value":563},{"label":"Jul","value":601},{"label":"Ago","value":530},{"label":"Set","value":686},{"label":"Out","value":464},{"label":"Nov","value":443},{"label":"Dez","value":515}];
const MX = 686;
