...
const PAGE = "Sensory Panel";
const KPIS = [{"l":"Dispositivos Online","v":"299","t":"+1.4%","d":"up"},{"l":"Dados/Min (MB)","v":"8.376","t":"+12.6%","d":"up"},{"l":"Alertas Ativos","v":"3.435","t":"-0.8%","d":"down"},{"l":"Uptime (%)","v":"78.9%","t":"+6.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.155","2.138","4.510","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.681","8.809","5.811","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.086","1.769","6.611","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","9.033","982","4.124","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.611","7.697","5.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":732},{"label":"Mar","value":1000},{"label":"Abr","value":745},{"label":"Mai","value":790},{"label":"Jun","value":625},{"label":"Jul","value":799},{"label":"Ago","value":681},{"label":"Set","value":778},{"label":"Out","value":837},{"label":"Nov","value":959},{"label":"Dez","value":1006}];
const MX = 1006;
