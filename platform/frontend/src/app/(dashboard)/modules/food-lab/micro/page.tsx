...
const ACCENT = "#ec4899";
const MODULE = "Food Laboratory";
const PAGE = "Micro Testing";
const KPIS = [{"l":"Total Food Lab","v":"3.215","t":"+8.0%","d":"up"},{"l":"Micro Testing Ativos","v":"5.013","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"56","t":"+1.6%","d":"up"}];
const COLS = ["ID","Micro Testing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Lab #001","Food Lab #002","2.461","4.265","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Food Lab #002","Food Lab #003","3.922","173","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Lab #003","Food Lab #004","5.919","2.121","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Food Lab #004","Food Lab #005","1.954","8.759","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Lab #005","Food Lab #001","828","4.855","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":382},{"label":"Mar","value":629},{"label":"Abr","value":448},{"label":"Mai","value":437},{"label":"Jun","value":530},{"label":"Jul","value":411},{"label":"Ago","value":385},{"label":"Set","value":689},{"label":"Out","value":598},{"label":"Nov","value":573},{"label":"Dez","value":519}];
const MX = 689;
