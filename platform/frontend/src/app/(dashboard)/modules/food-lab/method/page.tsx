...
const PAGE = "Method Valid";
const KPIS = [{"l":"Total Food Lab","v":"1.882","t":"-1.0%","d":"down"},{"l":"Method Valid Ativos","v":"139","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"68.1%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+3.4%","d":"up"}];
const COLS = ["ID","Method Valid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Lab #001","Food Lab #002","2.776","6.526","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Food Lab #002","Food Lab #003","7.419","5.418","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Lab #003","Food Lab #004","1.234","4.885","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Food Lab #004","Food Lab #005","445","6.941","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Lab #005","Food Lab #001","3.991","1.510","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":893},{"label":"Mar","value":900},{"label":"Abr","value":1029},{"label":"Mai","value":673},{"label":"Jun","value":815},{"label":"Jul","value":1033},{"label":"Ago","value":1024},{"label":"Set","value":903},{"label":"Out","value":933},{"label":"Nov","value":812},{"label":"Dez","value":991}];
const MX = 1033;
