...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.881","t":"+7.1%","d":"up"},{"l":"NC Abertas","v":"3.992","t":"-2.8%","d":"down"},{"l":"Conformidade (%)","v":"89.6%","t":"-0.3%","d":"down"},{"l":"CAPAs Pendentes","v":"6.652","t":"+12.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.823","91.5%","4.419","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","332","75.3%","7.376","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.656","70.9%","4.275","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.727","87.8%","8.162","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.765","89.1%","4.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":741},{"label":"Mar","value":547},{"label":"Abr","value":575},{"label":"Mai","value":773},{"label":"Jun","value":493},{"label":"Jul","value":757},{"label":"Ago","value":478},{"label":"Set","value":612},{"label":"Out","value":422},{"label":"Nov","value":516},{"label":"Dez","value":676}];
const MX = 773;
