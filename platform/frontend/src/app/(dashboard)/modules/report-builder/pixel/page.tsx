...
const ACCENT = "#4338ca";
const MODULE = "Report Builder";
const PAGE = "Pixel-Perfect";
const KPIS = [{"l":"Formulários Ativos","v":"7.389","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"2494","t":"-5.1%","d":"down"},{"l":"Documentos Gerados","v":"3.835","t":"+4.8%","d":"up"},{"l":"Templates","v":"3.423","t":"-4.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.061","2026-01-13","1.788","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.169","2026-01-27","3.501","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.755","2026-02-28","8.929","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.604","2026-03-23","380","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.429","2026-01-12","7.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":854},{"label":"Mar","value":875},{"label":"Abr","value":715},{"label":"Mai","value":1003},{"label":"Jun","value":723},{"label":"Jul","value":858},{"label":"Ago","value":782},{"label":"Set","value":787},{"label":"Out","value":669},{"label":"Nov","value":656},{"label":"Dez","value":688}];
const MX = 1003;
