...
const PAGE = "Burst Delivery";
const KPIS = [{"l":"Formulários Ativos","v":"4.888","t":"-3.0%","d":"down"},{"l":"Submissões/Dia","v":"4071","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"3.957","t":"+14.5%","d":"up"},{"l":"Templates","v":"728","t":"+12.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.622","2026-01-10","7.398","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.332","2026-01-16","4.417","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.694","2026-02-11","2.500","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.333","2026-02-04","2.275","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.514","2026-03-05","8.205","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":665},{"label":"Mar","value":508},{"label":"Abr","value":618},{"label":"Mai","value":765},{"label":"Jun","value":581},{"label":"Jul","value":683},{"label":"Ago","value":705},{"label":"Set","value":502},{"label":"Out","value":590},{"label":"Nov","value":610},{"label":"Dez","value":839}];
const MX = 839;
