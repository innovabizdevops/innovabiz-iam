...
const KPIS = [{"l":"eNPS","v":"73","t":"+2.8%","d":"up"},{"l":"Engagement (%)","v":"79.3%","t":"+0.9%","d":"up"},{"l":"Turnover (%)","v":"65.7%","t":"+10.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.537","t":"-5.5%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.120","2026-03-25","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.920","2026-03-05","68","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.292","2026-03-01","86","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.674","2026-02-06","77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.152","2026-01-17","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":648},{"label":"Mar","value":973},{"label":"Abr","value":934},{"label":"Mai","value":686},{"label":"Jun","value":859},{"label":"Jul","value":900},{"label":"Ago","value":738},{"label":"Set","value":857},{"label":"Out","value":722},{"label":"Nov","value":839},{"label":"Dez","value":831}];
const MX = 973;
