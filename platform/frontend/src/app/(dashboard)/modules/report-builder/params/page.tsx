...
const KPIS = [{"l":"Formulários Ativos","v":"6.176","t":"+5.4%","d":"up"},{"l":"Submissões/Dia","v":"3956","t":"+3.3%","d":"up"},{"l":"Documentos Gerados","v":"3.826","t":"+4.4%","d":"up"},{"l":"Templates","v":"5.138","t":"+4.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.537","2026-03-11","6.385","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.978","2026-01-21","6.170","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.509","2026-01-20","1.624","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","885","2026-03-11","1.443","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.103","2026-01-11","8.737","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":574},{"label":"Mar","value":636},{"label":"Abr","value":458},{"label":"Mai","value":557},{"label":"Jun","value":618},{"label":"Jul","value":445},{"label":"Ago","value":601},{"label":"Set","value":429},{"label":"Out","value":381},{"label":"Nov","value":470},{"label":"Dez","value":555}];
const MX = 636;
