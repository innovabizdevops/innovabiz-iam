...
const KPIS = [{"l":"Formulários Ativos","v":"376","t":"+17.3%","d":"up"},{"l":"Submissões/Dia","v":"4866","t":"-2.8%","d":"down"},{"l":"Documentos Gerados","v":"609","t":"+11.0%","d":"up"},{"l":"Templates","v":"4.632","t":"-0.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.336","2026-03-13","6.984","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.466","2026-02-24","895","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.775","2026-01-19","8.413","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.868","2026-01-16","2.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.025","2026-01-02","1.552","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":464},{"label":"Mar","value":239},{"label":"Abr","value":485},{"label":"Mai","value":574},{"label":"Jun","value":514},{"label":"Jul","value":475},{"label":"Ago","value":625},{"label":"Set","value":437},{"label":"Out","value":372},{"label":"Nov","value":232},{"label":"Dez","value":234}];
const MX = 625;
