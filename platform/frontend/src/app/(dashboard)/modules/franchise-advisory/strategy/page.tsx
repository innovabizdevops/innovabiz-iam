...
const PAGE = "Strategy";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.080","t":"+7.2%","d":"up"},{"l":"NC Abertas","v":"7.900","t":"+10.9%","d":"up"},{"l":"Conformidade (%)","v":"70.9%","t":"-1.4%","d":"down"},{"l":"CAPAs Pendentes","v":"4.183","t":"-1.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","252","77.5%","4.915","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.349","76.6%","3.074","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.489","88.8%","700","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.318","88.4%","2.946","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.701","92.5%","1.884","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":616},{"label":"Mar","value":598},{"label":"Abr","value":698},{"label":"Mai","value":437},{"label":"Jun","value":514},{"label":"Jul","value":503},{"label":"Ago","value":506},{"label":"Set","value":641},{"label":"Out","value":691},{"label":"Nov","value":577},{"label":"Dez","value":397}];
const MX = 698;
