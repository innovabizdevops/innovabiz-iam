...
const ACCENT = "#3b82f6";
const MODULE = "Franchise Advisory";
const PAGE = "Implement";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.849","t":"+8.3%","d":"up"},{"l":"NC Abertas","v":"1.896","t":"+2.2%","d":"up"},{"l":"Conformidade (%)","v":"76.6%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"8.363","t":"+15.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.286","76.5%","8.454","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.570","87.2%","411","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.442","93.3%","1.558","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.459","76.0%","5.490","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.942","76.5%","5.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":896},{"label":"Mar","value":909},{"label":"Abr","value":905},{"label":"Mai","value":717},{"label":"Jun","value":822},{"label":"Jul","value":825},{"label":"Ago","value":1052},{"label":"Set","value":959},{"label":"Out","value":990},{"label":"Nov","value":675},{"label":"Dez","value":807}];
const MX = 1052;
