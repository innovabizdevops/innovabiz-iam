...
/* ═══ Franchise Advisory — Dashboard ═══ */

const ACCENT = "#3b82f6";

const KPIS = [
    { label: "Total Registos", value: "6968", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3192", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€500K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1677670768", cells: ["FRA-8768", "Franchise Advisory Item 1", "5/5/2026", "€20 868"], status: "active" as const },
    { id: "1677674339", cells: ["FRA-3339", "Franchise Advisory Item 2", "20/12/2026", "€24 439"], status: "pending" as const },
    { id: "1677677910", cells: ["FRA-6910", "Franchise Advisory Item 3", "7/7/2026", "€28 010"], status: "completed" as const },
    { id: "1677681481", cells: ["FRA-1481", "Franchise Advisory Item 4", "22/2/2026", "€31 581"], status: "warning" as const },
    { id: "1677685052", cells: ["FRA-5052", "Franchise Advisory Item 5", "9/9/2026", "€35 152"], status: "active" as const },
];
...
export default function FranchiseAdvisoryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Advisory</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Advisory</p>
                    </div>
                </div>
