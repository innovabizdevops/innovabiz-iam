...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.607","t":"+5.8%","d":"up"},{"l":"NC Abertas","v":"8.214","t":"-2.9%","d":"down"},{"l":"Conformidade (%)","v":"71.1%","t":"+12.8%","d":"up"},{"l":"CAPAs Pendentes","v":"5.528","t":"+4.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.586","77.0%","2.863","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.879","84.0%","5.992","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.444","96.9%","2.086","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.577","99.5%","5.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.024","77.9%","1.833","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":712},{"label":"Mar","value":461},{"label":"Abr","value":509},{"label":"Mai","value":545},{"label":"Jun","value":459},{"label":"Jul","value":594},{"label":"Ago","value":506},{"label":"Set","value":574},{"label":"Out","value":530},{"label":"Nov","value":531},{"label":"Dez","value":704}];
const MX = 712;
