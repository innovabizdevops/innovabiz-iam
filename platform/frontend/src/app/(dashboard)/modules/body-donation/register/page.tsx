...
const PAGE = "Register";
const KPIS = [{"l":"Total Body Donation","v":"1.426","t":"+2.7%","d":"up"},{"l":"Register Ativos","v":"7.649","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"92.3%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.9%","d":"down"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Donation #001","Body Donation #002","4.070","1.937","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Body Donation #002","Body Donation #003","8.597","1.987","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Donation #003","Body Donation #004","5.425","4.633","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Body Donation #004","Body Donation #005","5.437","6.692","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Donation #005","Body Donation #001","7.354","4.953","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":540},{"label":"Mar","value":798},{"label":"Abr","value":684},{"label":"Mai","value":609},{"label":"Jun","value":928},{"label":"Jul","value":587},{"label":"Ago","value":798},{"label":"Set","value":556},{"label":"Out","value":612},{"label":"Nov","value":711},{"label":"Dez","value":565}];
const MX = 928;
