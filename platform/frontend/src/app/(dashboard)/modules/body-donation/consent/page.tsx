...
const ACCENT = "#475569";
const MODULE = "Body Donation Program";
const PAGE = "Consent";
const KPIS = [{"l":"Total Body Donation","v":"2.896","t":"+16.5%","d":"up"},{"l":"Consent Ativos","v":"109","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"88","t":"-0.6%","d":"down"}];
const COLS = ["ID","Consent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Donation #001","Body Donation #002","1.259","8.313","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Body Donation #002","Body Donation #003","1.203","1.068","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Donation #003","Body Donation #004","1.523","6.358","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Body Donation #004","Body Donation #005","3.757","3.099","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Donation #005","Body Donation #001","6.939","3.783","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":927},{"label":"Mar","value":988},{"label":"Abr","value":1049},{"label":"Mai","value":658},{"label":"Jun","value":716},{"label":"Jul","value":845},{"label":"Ago","value":993},{"label":"Set","value":757},{"label":"Out","value":872},{"label":"Nov","value":832},{"label":"Dez","value":952}];
const MX = 1049;
