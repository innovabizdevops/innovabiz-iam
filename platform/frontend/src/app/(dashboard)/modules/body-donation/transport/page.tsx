...
const KPIS = [{"l":"Atletas Registados","v":"943","t":"+8.5%","d":"up"},{"l":"Treinos/Semana","v":"2712","t":"-3.1%","d":"down"},{"l":"Competições","v":"4.188","t":"-0.2%","d":"down"},{"l":"Performance Score","v":"64","t":"-4.4%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.287","3.844","4.181","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.899","4.056","6.265","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.349","5.378","7.929","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","224","3.357","9.062","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.017","5.830","1.115","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":382},{"label":"Mar","value":522},{"label":"Abr","value":555},{"label":"Mai","value":402},{"label":"Jun","value":658},{"label":"Jul","value":569},{"label":"Ago","value":669},{"label":"Set","value":538},{"label":"Out","value":632},{"label":"Nov","value":303},{"label":"Dez","value":641}];
const MX = 669;
