...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"1.124","t":"+0.8%","d":"up"},{"l":"Patentes (YTD)","v":"819","t":"+6.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.258","t":"+12.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€37.4M","t":"+16.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.447","89.3%","4.941","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.313","75.5%","3.201","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.785","81.4%","6.982","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","633","71.4%","4.815","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.848","88.9%","8.645","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":523},{"label":"Mar","value":634},{"label":"Abr","value":533},{"label":"Mai","value":711},{"label":"Jun","value":778},{"label":"Jul","value":752},{"label":"Ago","value":791},{"label":"Set","value":725},{"label":"Out","value":607},{"label":"Nov","value":751},{"label":"Dez","value":652}];
const MX = 791;
