...
const PAGE = "Return";
const KPIS = [{"l":"Total Body Donation","v":"5.783","t":"+6.6%","d":"up"},{"l":"Return Ativos","v":"7.311","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"55","t":"-4.3%","d":"down"}];
const COLS = ["ID","Return","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Donation #001","Body Donation #002","6.707","7.343","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Body Donation #002","Body Donation #003","7.769","2.116","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Donation #003","Body Donation #004","4.600","8.980","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Body Donation #004","Body Donation #005","728","431","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Donation #005","Body Donation #001","1.965","2.507","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":748},{"label":"Mar","value":886},{"label":"Abr","value":1076},{"label":"Mai","value":873},{"label":"Jun","value":1091},{"label":"Jul","value":1052},{"label":"Ago","value":1086},{"label":"Set","value":935},{"label":"Out","value":920},{"label":"Nov","value":1060},{"label":"Dez","value":1069}];
const MX = 1091;
