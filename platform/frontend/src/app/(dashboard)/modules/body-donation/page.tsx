...
/* ═══ Body Donation Program — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "1340", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4444", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€47K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1425234940", cells: ["BOD-4940", "Body Donation Program Item 1", "25/5/2026", "€35 040"], status: "active" as const },
    { id: "1425238511", cells: ["BOD-8511", "Body Donation Program Item 2", "12/12/2026", "€38 611"], status: "pending" as const },
    { id: "1425242082", cells: ["BOD-3082", "Body Donation Program Item 3", "27/7/2026", "€42 182"], status: "completed" as const },
    { id: "1425245653", cells: ["BOD-6653", "Body Donation Program Item 4", "14/2/2026", "€45 753"], status: "warning" as const },
    { id: "1425249224", cells: ["BOD-1224", "Body Donation Program Item 5", "1/9/2026", "€49 324"], status: "active" as const },
];
...
export default function BodyDonationProgramPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Body Donation Program</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Body Donation Program</p>
                    </div>
                </div>
