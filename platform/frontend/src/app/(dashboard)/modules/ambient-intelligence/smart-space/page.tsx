...
const PAGE = "Smart Space Config";
const KPIS = [{"l":"Configurações","v":"7.068","t":"+1.0%","d":"up"},{"l":"Últimas Alterações","v":"932","t":"+6.2%","d":"up"},{"l":"Ambientes","v":"5.454","t":"+5.0%","d":"up"},{"l":"Versão Config","v":"8.764","t":"+8.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 1495.01","5.258","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 34258.61","866","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 49796.03","9.020","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 34295.37","123","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 23016.27","8.170","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":777},{"label":"Mar","value":785},{"label":"Abr","value":845},{"label":"Mai","value":848},{"label":"Jun","value":976},{"label":"Jul","value":1030},{"label":"Ago","value":1031},{"label":"Set","value":896},{"label":"Out","value":638},{"label":"Nov","value":778},{"label":"Dez","value":762}];
const MX = 1031;
...
export default function SmartSpacePage() {
    return (
