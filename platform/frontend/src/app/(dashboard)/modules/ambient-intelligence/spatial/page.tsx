...
const KPIS = [{"l":"Dashboards Ativos","v":"8.573","t":"+17.4%","d":"up"},{"l":"Queries/Dia","v":"3408","t":"+12.9%","d":"up"},{"l":"Dados Processados (GB)","v":"190","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"8.943","t":"+11.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5011","2026-02-17","8.384","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4190","2026-01-13","2.651","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2320","2026-01-01","996","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1858","2026-01-18","307","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3758","2026-01-10","6.837","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":566},{"label":"Mar","value":614},{"label":"Abr","value":521},{"label":"Mai","value":388},{"label":"Jun","value":450},{"label":"Jul","value":465},{"label":"Ago","value":718},{"label":"Set","value":564},{"label":"Out","value":734},{"label":"Nov","value":456},{"label":"Dez","value":561}];
const MX = 734;
