...
const PAGE = "Occupancy Sensing";
const KPIS = [{"l":"Total Ambient Intelligence","v":"4.842","t":"+16.4%","d":"up"},{"l":"Occupancy Sensing Ativos","v":"1.414","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+9.3%","d":"up"}];
const COLS = ["ID","Occupancy Sensing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ambient Intelligence #001","Ambient Intelligence #002","4.865","7.461","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ambient Intelligence #002","Ambient Intelligence #003","7.813","7.987","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Ambient Intelligence #003","Ambient Intelligence #004","8.890","7.310","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Ambient Intelligence #004","Ambient Intelligence #005","2.633","8.457","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ambient Intelligence #005","Ambient Intelligence #001","3.112","901","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":393},{"label":"Mar","value":398},{"label":"Abr","value":469},{"label":"Mai","value":557},{"label":"Jun","value":427},{"label":"Jul","value":499},{"label":"Ago","value":422},{"label":"Set","value":368},{"label":"Out","value":711},{"label":"Nov","value":657},{"label":"Dez","value":394}];
const MX = 711;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>IoT</span></h1>
                </div>
