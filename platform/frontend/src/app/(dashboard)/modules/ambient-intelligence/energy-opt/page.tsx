...
const ACCENT = "#059669";
const MODULE = "Ambient Intelligence";
const PAGE = "Energy Optimization";
const KPIS = [{"l":"Total Ambient Intelligence","v":"2.782","t":"-0.3%","d":"down"},{"l":"Energy Optimization Ativos","v":"4.947","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"69","t":"-1.1%","d":"down"}];
const COLS = ["ID","Energy Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ambient Intelligence #001","Ambient Intelligence #002","3.736","4.089","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ambient Intelligence #002","Ambient Intelligence #003","982","5.053","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ambient Intelligence #003","Ambient Intelligence #004","3.425","8.415","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Ambient Intelligence #004","Ambient Intelligence #005","1.465","6.543","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ambient Intelligence #005","Ambient Intelligence #001","4.815","3.881","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":952},{"label":"Fev","value":634},{"label":"Mar","value":714},{"label":"Abr","value":884},{"label":"Mai","value":701},{"label":"Jun","value":925},{"label":"Jul","value":718},{"label":"Ago","value":611},{"label":"Set","value":788},{"label":"Out","value":941},{"label":"Nov","value":843},{"label":"Dez","value":670}];
const MX = 952;
...
export default function EnergyOptPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>AI</span></h1>
                </div>
