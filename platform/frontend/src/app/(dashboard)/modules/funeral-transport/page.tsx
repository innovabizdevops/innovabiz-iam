...
/* ═══ Funeral Transport — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "1862", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1096", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€248K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "772073062", cells: ["FUN-9062", "Funeral Transport Item 1", "27/11/2026", "€23 162"], status: "active" as const },
    { id: "772076633", cells: ["FUN-3633", "Funeral Transport Item 2", "14/6/2026", "€26 733"], status: "pending" as const },
    { id: "772080204", cells: ["FUN-7204", "Funeral Transport Item 3", "1/1/2026", "€30 304"], status: "completed" as const },
    { id: "772083775", cells: ["FUN-1775", "Funeral Transport Item 4", "16/8/2026", "€33 875"], status: "warning" as const },
    { id: "772087346", cells: ["FUN-5346", "Funeral Transport Item 5", "3/3/2026", "€37 446"], status: "active" as const },
];
...
export default function FuneralTransportPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Funeral Transport</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Funeral Transport</p>
                    </div>
                </div>
