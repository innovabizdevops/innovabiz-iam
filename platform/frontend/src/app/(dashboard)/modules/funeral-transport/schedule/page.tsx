...
const PAGE = "Schedule";
const KPIS = [{"l":"Atletas Registados","v":"6.974","t":"+13.2%","d":"up"},{"l":"Treinos/Semana","v":"2934","t":"+5.5%","d":"up"},{"l":"Competições","v":"5.055","t":"+8.4%","d":"up"},{"l":"Performance Score","v":"84","t":"+3.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.306","4.486","6.594","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.895","3.100","5.952","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.855","2.157","8.852","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.307","3.861","8.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.077","7.420","7.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":954},{"label":"Mar","value":1026},{"label":"Abr","value":880},{"label":"Mai","value":817},{"label":"Jun","value":819},{"label":"Jul","value":662},{"label":"Ago","value":640},{"label":"Set","value":869},{"label":"Out","value":949},{"label":"Nov","value":925},{"label":"Dez","value":651}];
const MX = 1026;
