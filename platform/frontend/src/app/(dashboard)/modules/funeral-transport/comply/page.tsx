...
const PAGE = "Comply";
const KPIS = [{"l":"Atletas Registados","v":"2.491","t":"+17.2%","d":"up"},{"l":"Treinos/Semana","v":"2844","t":"+9.2%","d":"up"},{"l":"Competições","v":"2.799","t":"-2.7%","d":"down"},{"l":"Performance Score","v":"79","t":"+10.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.695","3.378","6.017","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.356","4.905","7.624","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.945","4.836","5.735","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.955","1.503","1.701","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.612","5.204","2.165","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":462},{"label":"Mar","value":375},{"label":"Abr","value":416},{"label":"Mai","value":530},{"label":"Jun","value":486},{"label":"Jul","value":637},{"label":"Ago","value":415},{"label":"Set","value":396},{"label":"Out","value":463},{"label":"Nov","value":304},{"label":"Dez","value":272}];
const MX = 637;
