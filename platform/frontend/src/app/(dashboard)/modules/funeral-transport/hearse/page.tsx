...
const ACCENT = "#1e293b";
const MODULE = "Funeral Transport";
const PAGE = "Hearse";
const KPIS = [{"l":"Atletas Registados","v":"4.908","t":"+-0.0%","d":"up"},{"l":"Treinos/Semana","v":"2062","t":"+0.3%","d":"up"},{"l":"Competições","v":"7.944","t":"-1.0%","d":"down"},{"l":"Performance Score","v":"67","t":"+3.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.856","1.790","266","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","133","7.039","6.131","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.003","4.403","2.985","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.439","4.454","6.974","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.711","1.634","6.561","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":894},{"label":"Mar","value":956},{"label":"Abr","value":1041},{"label":"Mai","value":889},{"label":"Jun","value":873},{"label":"Jul","value":1056},{"label":"Ago","value":962},{"label":"Set","value":685},{"label":"Out","value":788},{"label":"Nov","value":984},{"label":"Dez","value":915}];
const MX = 1056;
...
export default function HearsePage() {
    return (
