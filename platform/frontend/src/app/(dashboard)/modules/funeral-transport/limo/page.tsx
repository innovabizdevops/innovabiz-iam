...
const PAGE = "Limo";
const KPIS = [{"l":"Atletas Registados","v":"4.235","t":"+17.1%","d":"up"},{"l":"Treinos/Semana","v":"581","t":"+10.0%","d":"up"},{"l":"Competições","v":"497","t":"+8.9%","d":"up"},{"l":"Performance Score","v":"73","t":"+9.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.616","1.464","726","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.845","7.975","1.686","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.614","1.168","4.274","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.105","8.732","3.716","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.287","7.463","4.600","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":727},{"label":"Mar","value":751},{"label":"Abr","value":847},{"label":"Mai","value":755},{"label":"Jun","value":708},{"label":"Jul","value":834},{"label":"Ago","value":592},{"label":"Set","value":608},{"label":"Out","value":859},{"label":"Nov","value":655},{"label":"Dez","value":855}];
const MX = 859;
