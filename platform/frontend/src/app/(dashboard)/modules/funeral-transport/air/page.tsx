...
const PAGE = "Air Ship";
const KPIS = [{"l":"Atletas Registados","v":"7.336","t":"+7.4%","d":"up"},{"l":"Treinos/Semana","v":"1403","t":"+7.9%","d":"up"},{"l":"Competições","v":"3.679","t":"-0.3%","d":"down"},{"l":"Performance Score","v":"85","t":"+1.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.127","3.655","6.866","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.408","4.583","1.518","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.818","2.344","3.804","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","148","2.647","7.689","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.674","5.321","4.389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":463},{"label":"Mar","value":284},{"label":"Abr","value":523},{"label":"Mai","value":510},{"label":"Jun","value":570},{"label":"Jul","value":294},{"label":"Ago","value":325},{"label":"Set","value":320},{"label":"Out","value":493},{"label":"Nov","value":458},{"label":"Dez","value":641}];
const MX = 641;
