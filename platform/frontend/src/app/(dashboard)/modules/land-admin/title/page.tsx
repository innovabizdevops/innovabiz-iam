...
const PAGE = "Title";
const KPIS = [{"l":"Total Land Admin","v":"5.739","t":"+0.5%","d":"up"},{"l":"Title Ativos","v":"7.074","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"70.8%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+12.6%","d":"up"}];
const COLS = ["ID","Title","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Land Admin #001","Land Admin #002","206","4.738","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Land Admin #002","Land Admin #003","9.087","748","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Land Admin #003","Land Admin #004","386","5.315","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Land Admin #004","Land Admin #005","5.632","4.947","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Land Admin #005","Land Admin #001","648","4.228","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":903},{"label":"Mar","value":781},{"label":"Abr","value":855},{"label":"Mai","value":1037},{"label":"Jun","value":939},{"label":"Jul","value":981},{"label":"Ago","value":703},{"label":"Set","value":757},{"label":"Out","value":940},{"label":"Nov","value":1071},{"label":"Dez","value":933}];
const MX = 1071;
