...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"5.589","t":"+0.2%","d":"up"},{"l":"Respostas/Semana","v":"4285","t":"+9.8%","d":"up"},{"l":"NPS Médio","v":"81","t":"-2.5%","d":"down"},{"l":"Taxa Resposta (%)","v":"89.7%","t":"+14.6%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","967","73","80.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","5.251","88","86.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.357","60","70.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.784","70","85.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.367","89","87.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":645},{"label":"Mar","value":511},{"label":"Abr","value":649},{"label":"Mai","value":474},{"label":"Jun","value":406},{"label":"Jul","value":453},{"label":"Ago","value":466},{"label":"Set","value":415},{"label":"Out","value":628},{"label":"Nov","value":527},{"label":"Dez","value":766}];
const MX = 772;
