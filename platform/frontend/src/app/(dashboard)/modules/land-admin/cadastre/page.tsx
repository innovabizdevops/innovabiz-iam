...
const ACCENT = "#5a7a9f";
const MODULE = "Land Administration";
const PAGE = "Cadastre";
const KPIS = [{"l":"Total Land Admin","v":"1.466","t":"+15.5%","d":"up"},{"l":"Cadastre Ativos","v":"632","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+16.5%","d":"up"}];
const COLS = ["ID","Cadastre","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Land Admin #001","Land Admin #002","7.542","5.870","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Land Admin #002","Land Admin #003","7.329","4.465","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Land Admin #003","Land Admin #004","5.612","813","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Land Admin #004","Land Admin #005","7.791","7.475","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Land Admin #005","Land Admin #001","1.920","1.088","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":835},{"label":"Mar","value":763},{"label":"Abr","value":814},{"label":"Mai","value":871},{"label":"Jun","value":558},{"label":"Jul","value":735},{"label":"Ago","value":772},{"label":"Set","value":690},{"label":"Out","value":530},{"label":"Nov","value":768},{"label":"Dez","value":890}];
const MX = 890;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#5a7a9f'}}>GIS</span></h1>
                </div>
