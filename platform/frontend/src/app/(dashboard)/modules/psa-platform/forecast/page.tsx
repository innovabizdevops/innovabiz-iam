...
const KPIS = [{"l":"ARR (€M)","v":"€7.3M","t":"+12.1%","d":"up"},{"l":"MRR (€)","v":"€77644","t":"-0.5%","d":"down"},{"l":"Churn (%)","v":"79.2%","t":"-5.7%","d":"down"},{"l":"ARPU (€)","v":"€65080","t":"+15.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 10587.59","8.428","€ 23517.95","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11404.42","8.592","€ 15124.63","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25257.07","342","€ 18480.57","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 21226.53","1.386","€ 21115.96","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46192.91","8.068","€ 38160.57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":763},{"label":"Mar","value":980},{"label":"Abr","value":984},{"label":"Mai","value":811},{"label":"Jun","value":893},{"label":"Jul","value":628},{"label":"Ago","value":741},{"label":"Set","value":889},{"label":"Out","value":683},{"label":"Nov","value":955},{"label":"Dez","value":730}];
const MX = 984;
