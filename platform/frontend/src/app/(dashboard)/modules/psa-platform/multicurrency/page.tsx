...
const KPIS = [{"l":"Formulários Ativos","v":"7.549","t":"+13.2%","d":"up"},{"l":"Submissões/Dia","v":"4405","t":"+9.9%","d":"up"},{"l":"Documentos Gerados","v":"3.942","t":"+15.6%","d":"up"},{"l":"Templates","v":"2.954","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.564","2026-01-13","8.371","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.152","2026-03-03","8.773","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.372","2026-01-12","7.873","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.845","2026-01-11","5.667","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.589","2026-02-12","2.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":472},{"label":"Mar","value":597},{"label":"Abr","value":296},{"label":"Mai","value":265},{"label":"Jun","value":236},{"label":"Jul","value":431},{"label":"Ago","value":498},{"label":"Set","value":563},{"label":"Out","value":546},{"label":"Nov","value":396},{"label":"Dez","value":596}];
const MX = 597;
