...
const PAGE = "Project Hub";
const KPIS = [{"l":"Formulários Ativos","v":"4.302","t":"+14.9%","d":"up"},{"l":"Submissões/Dia","v":"3745","t":"+15.8%","d":"up"},{"l":"Documentos Gerados","v":"7.540","t":"+13.9%","d":"up"},{"l":"Templates","v":"8.654","t":"+7.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.531","2026-01-21","1.311","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","574","2026-01-02","3.515","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.057","2026-03-05","7.950","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.908","2026-02-11","4.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.248","2026-01-28","2.853","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":332},{"label":"Mar","value":644},{"label":"Abr","value":355},{"label":"Mai","value":458},{"label":"Jun","value":387},{"label":"Jul","value":312},{"label":"Ago","value":661},{"label":"Set","value":429},{"label":"Out","value":452},{"label":"Nov","value":453},{"label":"Dez","value":478}];
const MX = 661;
