...
const ACCENT = "#1e40af";
const MODULE = "PSA Platform";
const PAGE = "Partner Co-Deliver";
const KPIS = [{"l":"Formulários Ativos","v":"8.977","t":"+17.6%","d":"up"},{"l":"Submissões/Dia","v":"2042","t":"+15.1%","d":"up"},{"l":"Documentos Gerados","v":"8.356","t":"+5.7%","d":"up"},{"l":"Templates","v":"7.728","t":"+13.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","942","2026-01-01","6.938","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.413","2026-03-07","7.045","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.048","2026-02-15","6.849","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.494","2026-03-27","2.715","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.539","2026-01-14","6.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":528},{"label":"Mar","value":796},{"label":"Abr","value":780},{"label":"Mai","value":574},{"label":"Jun","value":917},{"label":"Jul","value":665},{"label":"Ago","value":850},{"label":"Set","value":575},{"label":"Out","value":656},{"label":"Nov","value":687},{"label":"Dez","value":654}];
const MX = 917;
