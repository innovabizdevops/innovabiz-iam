...
const PAGE = "Backlog";
const KPIS = [{"l":"Formulários Ativos","v":"9.042","t":"+16.2%","d":"up"},{"l":"Submissões/Dia","v":"2459","t":"+11.3%","d":"up"},{"l":"Documentos Gerados","v":"3.807","t":"+2.8%","d":"up"},{"l":"Templates","v":"6.952","t":"-1.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.861","2026-03-19","3.239","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.310","2026-02-13","3.415","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.483","2026-02-22","2.593","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.477","2026-01-28","6.561","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.412","2026-03-14","613","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":606},{"label":"Mar","value":530},{"label":"Abr","value":411},{"label":"Mai","value":477},{"label":"Jun","value":558},{"label":"Jul","value":421},{"label":"Ago","value":706},{"label":"Set","value":751},{"label":"Out","value":599},{"label":"Nov","value":506},{"label":"Dez","value":764}];
const MX = 764;
