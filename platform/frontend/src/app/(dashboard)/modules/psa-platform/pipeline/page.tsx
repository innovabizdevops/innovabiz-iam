...
const PAGE = "Pipeline";
const KPIS = [{"l":"Formulários Ativos","v":"8.123","t":"+13.6%","d":"up"},{"l":"Submissões/Dia","v":"2970","t":"+5.4%","d":"up"},{"l":"Documentos Gerados","v":"5.292","t":"-2.9%","d":"down"},{"l":"Templates","v":"1.009","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.970","2026-03-08","3.951","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.884","2026-03-03","5.856","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.846","2026-01-21","5.173","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.993","2026-02-13","1.995","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.011","2026-01-15","2.751","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":840},{"label":"Mar","value":621},{"label":"Abr","value":593},{"label":"Mai","value":626},{"label":"Jun","value":551},{"label":"Jul","value":778},{"label":"Ago","value":529},{"label":"Set","value":701},{"label":"Out","value":483},{"label":"Nov","value":754},{"label":"Dez","value":831}];
const MX = 840;
