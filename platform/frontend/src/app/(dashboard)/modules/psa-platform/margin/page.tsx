...
const PAGE = "Margin Track";
const KPIS = [{"l":"ARR (€M)","v":"€15.1M","t":"+1.9%","d":"up"},{"l":"MRR (€)","v":"€3124","t":"-5.9%","d":"down"},{"l":"Churn (%)","v":"74.2%","t":"-3.3%","d":"down"},{"l":"ARPU (€)","v":"€48715","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45909.79","6.898","€ 1130.58","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 1268.03","4.546","€ 21178.32","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 34235.47","953","€ 5153.55","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16318.04","6.200","€ 11779.79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42513.30","3.840","€ 7818.30","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":312},{"label":"Mar","value":399},{"label":"Abr","value":381},{"label":"Mai","value":269},{"label":"Jun","value":491},{"label":"Jul","value":468},{"label":"Ago","value":286},{"label":"Set","value":437},{"label":"Out","value":329},{"label":"Nov","value":590},{"label":"Dez","value":452}];
const MX = 590;
