...
const KPIS = [
    { label: "Total Registos", value: "4983", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1545", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€109K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1448553083", cells: ["PET-4083", "Pet Sitting Item 1", "20/12/2026", "€3183"], status: "active" as const },
    { id: "1448556654", cells: ["PET-7654", "Pet Sitting Item 2", "7/7/2026", "€6754"], status: "pending" as const },
    { id: "1448560225", cells: ["PET-2225", "Pet Sitting Item 3", "22/2/2026", "€10 325"], status: "completed" as const },
    { id: "1448563796", cells: ["PET-5796", "Pet Sitting Item 4", "9/9/2026", "€13 896"], status: "warning" as const },
    { id: "1448567367", cells: ["PET-9367", "Pet Sitting Item 5", "24/4/2026", "€17 467"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Sitting</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Sitting</p>
                    </div>
                </div>
