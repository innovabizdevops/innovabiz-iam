...
const ACCENT = "#f97316";
const MODULE = "Pet Sitting";
const PAGE = "Photo";
const KPIS = [{"l":"Total Pet Sitting","v":"4.108","t":"+11.3%","d":"up"},{"l":"Photo Ativos","v":"5.457","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"86.3%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+12.5%","d":"up"}];
const COLS = ["ID","Photo","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Sitting #001","Pet Sitting #002","7.261","2.108","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Sitting #002","Pet Sitting #003","5.264","7.808","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Sitting #003","Pet Sitting #004","3.967","5.929","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Sitting #004","Pet Sitting #005","5.529","7.629","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Sitting #005","Pet Sitting #001","6.102","795","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":583},{"label":"Mar","value":575},{"label":"Abr","value":762},{"label":"Mai","value":569},{"label":"Jun","value":945},{"label":"Jul","value":753},{"label":"Ago","value":759},{"label":"Set","value":619},{"label":"Out","value":682},{"label":"Nov","value":851},{"label":"Dez","value":796}];
const MX = 945;
