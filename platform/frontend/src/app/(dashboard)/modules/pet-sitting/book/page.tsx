...
const PAGE = "Book";
const KPIS = [{"l":"Total Pet Sitting","v":"5.311","t":"+9.1%","d":"up"},{"l":"Book Ativos","v":"7.323","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+7.5%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Sitting #001","Pet Sitting #002","8.005","4.215","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Sitting #002","Pet Sitting #003","7.950","9.017","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Sitting #003","Pet Sitting #004","2.855","1.663","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Sitting #004","Pet Sitting #005","4.340","1.424","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Sitting #005","Pet Sitting #001","5.540","2.580","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":401},{"label":"Mar","value":585},{"label":"Abr","value":320},{"label":"Mai","value":675},{"label":"Jun","value":508},{"label":"Jul","value":459},{"label":"Ago","value":386},{"label":"Set","value":349},{"label":"Out","value":340},{"label":"Nov","value":613},{"label":"Dez","value":500}];
const MX = 675;
