...
const PAGE = "Visit";
const KPIS = [{"l":"Total Pet Sitting","v":"140","t":"+6.9%","d":"up"},{"l":"Visit Ativos","v":"7.327","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+6.4%","d":"up"}];
const COLS = ["ID","Visit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Sitting #001","Pet Sitting #002","2.281","6.204","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Sitting #002","Pet Sitting #003","6.567","8.174","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Sitting #003","Pet Sitting #004","216","1.619","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Sitting #004","Pet Sitting #005","2.415","7.230","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Sitting #005","Pet Sitting #001","8.383","4.654","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":583},{"label":"Mar","value":910},{"label":"Abr","value":861},{"label":"Mai","value":700},{"label":"Jun","value":574},{"label":"Jul","value":822},{"label":"Ago","value":865},{"label":"Set","value":721},{"label":"Out","value":552},{"label":"Nov","value":859},{"label":"Dez","value":882}];
const MX = 910;
