...
const PAGE = "Sitter";
const KPIS = [{"l":"Total Pet Sitting","v":"1.217","t":"+7.5%","d":"up"},{"l":"Sitter Ativos","v":"4.393","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+3.4%","d":"up"}];
const COLS = ["ID","Sitter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Sitting #001","Pet Sitting #002","6.190","7.476","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Sitting #002","Pet Sitting #003","812","5.732","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Sitting #003","Pet Sitting #004","4.908","710","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Sitting #004","Pet Sitting #005","748","7.539","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Sitting #005","Pet Sitting #001","3.395","5.463","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":467},{"label":"Mar","value":520},{"label":"Abr","value":499},{"label":"Mai","value":738},{"label":"Jun","value":579},{"label":"Jul","value":568},{"label":"Ago","value":802},{"label":"Set","value":570},{"label":"Out","value":612},{"label":"Nov","value":801},{"label":"Dez","value":775}];
const MX = 838;
