...
const PAGE = "Payment";
const KPIS = [{"l":"Total Pet Sitting","v":"3.601","t":"+16.6%","d":"up"},{"l":"Payment Ativos","v":"1.647","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"95","t":"+2.0%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Sitting #001","Pet Sitting #002","5.537","821","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Sitting #002","Pet Sitting #003","5.380","2.541","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Sitting #003","Pet Sitting #004","2.061","3.238","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Sitting #004","Pet Sitting #005","1.605","3.069","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Sitting #005","Pet Sitting #001","2.954","5.212","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":594},{"label":"Mar","value":696},{"label":"Abr","value":923},{"label":"Mai","value":858},{"label":"Jun","value":806},{"label":"Jul","value":843},{"label":"Ago","value":699},{"label":"Set","value":763},{"label":"Out","value":765},{"label":"Nov","value":875},{"label":"Dez","value":593}];
const MX = 923;
