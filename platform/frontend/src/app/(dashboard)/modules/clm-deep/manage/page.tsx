...
const PAGE = "Manage";
const KPIS = [{"l":"Contratos Ativos","v":"4.553","t":"+6.0%","d":"up"},{"l":"Valor Total (€M)","v":"€47.5M","t":"+10.3%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.620","t":"-3.3%","d":"down"},{"l":"Obrigações Pendentes","v":"3.548","t":"+2.9%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 41311.75","2026-01-08","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 40294.89","2026-02-06","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 12799.68","2026-03-11","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 27922.75","2026-02-08","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 27211.29","2026-01-27","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":724},{"label":"Mar","value":902},{"label":"Abr","value":878},{"label":"Mai","value":991},{"label":"Jun","value":755},{"label":"Jul","value":718},{"label":"Ago","value":761},{"label":"Set","value":944},{"label":"Out","value":1011},{"label":"Nov","value":785},{"label":"Dez","value":914}];
const MX = 1011;
