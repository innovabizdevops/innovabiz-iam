...
const ACCENT = "#4c1d95";
const MODULE = "Contract Lifecycle Deep";
const PAGE = "Author";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.440","t":"-5.0%","d":"down"},{"l":"Sessões/Dia","v":"2633","t":"+10.9%","d":"up"},{"l":"MFA Adoção (%)","v":"82.0%","t":"+1.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.639","t":"+8.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.956","8.004","598","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","789","6.732","3.863","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.404","3.307","1.253","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.668","7.990","3.438","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.087","5.261","246","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1009},{"label":"Fev","value":733},{"label":"Mar","value":913},{"label":"Abr","value":719},{"label":"Mai","value":918},{"label":"Jun","value":743},{"label":"Jul","value":982},{"label":"Ago","value":948},{"label":"Set","value":761},{"label":"Out","value":839},{"label":"Nov","value":656},{"label":"Dez","value":829}];
const MX = 1009;
