...
const KPIS = [{"l":"Contratos Ativos","v":"1.169","t":"+17.3%","d":"up"},{"l":"Valor Total (€M)","v":"€1.0M","t":"+1.8%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.452","t":"+0.0%","d":"up"},{"l":"Obrigações Pendentes","v":"2.161","t":"+13.9%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 21651.43","2026-02-16","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 37489.68","2026-03-07","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 30759.78","2026-01-18","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 30036.57","2026-03-07","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 22964.75","2026-02-24","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":735},{"label":"Mar","value":400},{"label":"Abr","value":368},{"label":"Mai","value":587},{"label":"Jun","value":620},{"label":"Jul","value":377},{"label":"Ago","value":719},{"label":"Set","value":535},{"label":"Out","value":619},{"label":"Nov","value":608},{"label":"Dez","value":498}];
const MX = 735;
