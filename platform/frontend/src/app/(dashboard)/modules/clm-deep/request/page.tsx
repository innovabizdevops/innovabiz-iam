...
const PAGE = "Request";
const KPIS = [{"l":"Contratos Ativos","v":"3.816","t":"+5.7%","d":"up"},{"l":"Valor Total (€M)","v":"€47.6M","t":"-4.8%","d":"down"},{"l":"Renovações Próx. 30d","v":"2.364","t":"-5.1%","d":"down"},{"l":"Obrigações Pendentes","v":"180","t":"+16.6%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 8165.92","2026-01-28","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 30797.68","2026-02-16","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 22935.81","2026-03-01","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 22706.02","2026-01-27","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 46109.76","2026-01-24","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":906},{"label":"Mar","value":941},{"label":"Abr","value":692},{"label":"Mai","value":1003},{"label":"Jun","value":948},{"label":"Jul","value":985},{"label":"Ago","value":999},{"label":"Set","value":766},{"label":"Out","value":962},{"label":"Nov","value":765},{"label":"Dez","value":976}];
const MX = 1003;
