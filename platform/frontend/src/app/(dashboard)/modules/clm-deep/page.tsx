...
/* ═══ Contract Lifecycle Deep — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "7000", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4479", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€49K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1910508900", cells: ["CLM-7900", "Contract Lifecycle Deep Item 1", "21/1/2026", "€9000"], status: "active" as const },
    { id: "1910512471", cells: ["CLM-2471", "Contract Lifecycle Deep Item 2", "8/8/2026", "€12 571"], status: "pending" as const },
    { id: "1910516042", cells: ["CLM-6042", "Contract Lifecycle Deep Item 3", "23/3/2026", "€16 142"], status: "completed" as const },
    { id: "1910519613", cells: ["CLM-9613", "Contract Lifecycle Deep Item 4", "10/10/2026", "€19 713"], status: "warning" as const },
    { id: "1910523184", cells: ["CLM-4184", "Contract Lifecycle Deep Item 5", "25/5/2026", "€23 284"], status: "active" as const },
];
...
export default function ContractLifecycleDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contract Lifecycle Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Contract Lifecycle Deep</p>
                    </div>
                </div>
