...
const PAGE = "PIP Tracking";
const KPIS = [{"l":"Formulários Ativos","v":"2.556","t":"-4.9%","d":"down"},{"l":"Submissões/Dia","v":"1076","t":"+5.1%","d":"up"},{"l":"Documentos Gerados","v":"3.379","t":"-5.2%","d":"down"},{"l":"Templates","v":"4.306","t":"+11.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.834","2026-03-07","3.877","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.512","2026-01-09","756","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.293","2026-03-01","7.575","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","607","2026-02-13","3.429","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.786","2026-02-23","4.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":735},{"label":"Mar","value":681},{"label":"Abr","value":570},{"label":"Mai","value":661},{"label":"Jun","value":936},{"label":"Jul","value":618},{"label":"Ago","value":920},{"label":"Set","value":827},{"label":"Out","value":899},{"label":"Nov","value":920},{"label":"Dez","value":635}];
const MX = 945;
