...
const PAGE = "Goal Setting";
const KPIS = [{"l":"Formulários Ativos","v":"4.424","t":"-2.6%","d":"down"},{"l":"Submissões/Dia","v":"2234","t":"-3.2%","d":"down"},{"l":"Documentos Gerados","v":"7.954","t":"+5.1%","d":"up"},{"l":"Templates","v":"2.955","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.920","2026-03-22","3.509","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","132","2026-02-14","1.787","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.359","2026-02-25","1.039","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.016","2026-03-08","6.927","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.008","2026-02-16","2.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":462},{"label":"Mar","value":412},{"label":"Abr","value":595},{"label":"Mai","value":387},{"label":"Jun","value":682},{"label":"Jul","value":382},{"label":"Ago","value":709},{"label":"Set","value":630},{"label":"Out","value":390},{"label":"Nov","value":352},{"label":"Dez","value":427}];
const MX = 709;
