...
const PAGE = "Peer Recognition";
const KPIS = [{"l":"Formulários Ativos","v":"4.061","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"2287","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"2.019","t":"+5.4%","d":"up"},{"l":"Templates","v":"1.581","t":"-1.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.870","2026-02-12","7.891","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.617","2026-03-26","993","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.324","2026-02-14","470","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.940","2026-03-24","4.090","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.082","2026-03-17","2.807","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":814},{"label":"Mar","value":793},{"label":"Abr","value":884},{"label":"Mai","value":917},{"label":"Jun","value":971},{"label":"Jul","value":721},{"label":"Ago","value":847},{"label":"Set","value":778},{"label":"Out","value":863},{"label":"Nov","value":953},{"label":"Dez","value":654}];
const MX = 971;
