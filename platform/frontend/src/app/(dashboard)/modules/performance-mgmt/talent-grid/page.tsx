...
const PAGE = "Talent Grid";
const KPIS = [{"l":"Formulários Ativos","v":"6.203","t":"-3.8%","d":"down"},{"l":"Submissões/Dia","v":"1902","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"2.448","t":"+4.1%","d":"up"},{"l":"Templates","v":"5.129","t":"+15.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.842","2026-01-09","1.438","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.876","2026-02-16","493","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.536","2026-02-18","7.182","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.425","2026-03-22","7.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.801","2026-03-16","2.895","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":504},{"label":"Mar","value":658},{"label":"Abr","value":376},{"label":"Mai","value":577},{"label":"Jun","value":342},{"label":"Jul","value":683},{"label":"Ago","value":616},{"label":"Set","value":594},{"label":"Out","value":542},{"label":"Nov","value":572},{"label":"Dez","value":602}];
const MX = 683;
