...
const KPIS = [{"l":"Formulários Ativos","v":"3.074","t":"+8.1%","d":"up"},{"l":"Submissões/Dia","v":"3580","t":"+5.7%","d":"up"},{"l":"Documentos Gerados","v":"4.654","t":"+9.8%","d":"up"},{"l":"Templates","v":"5.429","t":"+17.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.197","2026-01-26","6.719","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.698","2026-02-10","3.994","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.679","2026-02-26","4.318","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.485","2026-02-11","5.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","714","2026-02-16","4.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":247},{"label":"Mar","value":539},{"label":"Abr","value":310},{"label":"Mai","value":592},{"label":"Jun","value":478},{"label":"Jul","value":481},{"label":"Ago","value":271},{"label":"Set","value":594},{"label":"Out","value":265},{"label":"Nov","value":439},{"label":"Dez","value":237}];
const MX = 594;
