...
const PAGE = "Continuous Feedback";
const KPIS = [{"l":"Formulários Ativos","v":"2.134","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"3590","t":"+17.8%","d":"up"},{"l":"Documentos Gerados","v":"6.586","t":"+17.4%","d":"up"},{"l":"Templates","v":"8.760","t":"+6.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.239","2026-03-06","5.452","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.193","2026-03-23","3.096","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.135","2026-02-05","7.274","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.606","2026-01-06","4.735","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.190","2026-02-06","4.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":414},{"label":"Mar","value":357},{"label":"Abr","value":635},{"label":"Mai","value":451},{"label":"Jun","value":397},{"label":"Jul","value":548},{"label":"Ago","value":381},{"label":"Set","value":406},{"label":"Out","value":373},{"label":"Nov","value":509},{"label":"Dez","value":534}];
const MX = 635;
