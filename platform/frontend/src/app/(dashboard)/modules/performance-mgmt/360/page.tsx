...
const ACCENT = "#1e3a5f";
const MODULE = "Performance Management";
const PAGE = "360 Feedback";
const KPIS = [{"l":"Formulários Ativos","v":"6.019","t":"+1.9%","d":"up"},{"l":"Submissões/Dia","v":"3071","t":"+2.9%","d":"up"},{"l":"Documentos Gerados","v":"7.292","t":"+6.2%","d":"up"},{"l":"Templates","v":"6.437","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","650","2026-03-20","2.913","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.081","2026-03-28","3.551","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.841","2026-01-25","5.144","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.484","2026-03-07","7.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.280","2026-01-28","1.022","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":553},{"label":"Mar","value":888},{"label":"Abr","value":838},{"label":"Mai","value":764},{"label":"Jun","value":591},{"label":"Jul","value":555},{"label":"Ago","value":730},{"label":"Set","value":743},{"label":"Out","value":525},{"label":"Nov","value":772},{"label":"Dez","value":860}];
const MX = 888;
...
export default function 360Page() {
    return (
