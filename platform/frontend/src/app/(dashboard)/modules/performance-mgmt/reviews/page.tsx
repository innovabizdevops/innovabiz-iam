...
const PAGE = "Review Cycles";
const KPIS = [{"l":"Formulários Ativos","v":"8.411","t":"-3.5%","d":"down"},{"l":"Submissões/Dia","v":"2818","t":"+3.6%","d":"up"},{"l":"Documentos Gerados","v":"4.159","t":"+17.0%","d":"up"},{"l":"Templates","v":"2.128","t":"+12.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.753","2026-02-25","5.167","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.585","2026-01-28","640","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.347","2026-01-03","6.844","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.460","2026-03-28","8.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.971","2026-03-01","8.621","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":640},{"label":"Mar","value":419},{"label":"Abr","value":395},{"label":"Mai","value":504},{"label":"Jun","value":486},{"label":"Jul","value":376},{"label":"Ago","value":508},{"label":"Set","value":507},{"label":"Out","value":617},{"label":"Nov","value":348},{"label":"Dez","value":254}];
const MX = 640;
