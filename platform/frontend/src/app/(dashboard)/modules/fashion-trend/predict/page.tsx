...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"5.672","t":"+3.1%","d":"up"},{"l":"Chamadas/Hora","v":"3841","t":"+6.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.8%","t":"+6.4%","d":"up"},{"l":"Latência Média (ms)","v":"64ms","t":"+13.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.517","7.553","98.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.700","2.272","84.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.490","2.965","92.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.827","1.119","84.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.045","1.340","83.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":502},{"label":"Mar","value":620},{"label":"Abr","value":571},{"label":"Mai","value":367},{"label":"Jun","value":453},{"label":"Jul","value":622},{"label":"Ago","value":511},{"label":"Set","value":422},{"label":"Out","value":570},{"label":"Nov","value":649},{"label":"Dez","value":370}];
const MX = 649;
