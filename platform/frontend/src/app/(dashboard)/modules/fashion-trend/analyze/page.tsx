...
const ACCENT = "#be185d";
const MODULE = "Fashion Trend Intelligence";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"7.233","t":"+0.7%","d":"up"},{"l":"Queries/Dia","v":"2959","t":"+14.8%","d":"up"},{"l":"Dados Processados (GB)","v":"5.025","t":"+3.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.213","t":"+2.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1397","2026-02-23","5.843","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4627","2026-01-12","2.405","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1646","2026-02-19","1.280","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","770","2026-02-09","2.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","607","2026-02-09","4.607","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":613},{"label":"Mar","value":405},{"label":"Abr","value":404},{"label":"Mai","value":549},{"label":"Jun","value":519},{"label":"Jul","value":409},{"label":"Ago","value":625},{"label":"Set","value":620},{"label":"Out","value":638},{"label":"Nov","value":636},{"label":"Dez","value":704}];
const MX = 704;
