...
const KPIS = [
    { label: "Total Registos", value: "691", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1112", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€64K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "941292591", cells: ["FAS-1591", "Fashion Trend Intelligence Item 1", "16/4/2026", "€42 691"], status: "active" as const },
    { id: "941296162", cells: ["FAS-5162", "Fashion Trend Intelligence Item 2", "3/11/2026", "€46 262"], status: "pending" as const },
    { id: "941299733", cells: ["FAS-8733", "Fashion Trend Intelligence Item 3", "18/6/2026", "€49 833"], status: "completed" as const },
    { id: "941303304", cells: ["FAS-3304", "Fashion Trend Intelligence Item 4", "5/1/2026", "€3404"], status: "warning" as const },
    { id: "941306875", cells: ["FAS-6875", "Fashion Trend Intelligence Item 5", "20/8/2026", "€6975"], status: "active" as const },
];
...
export default function FashionTrendIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion Trend Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion Trend Intelligence</p>
                    </div>
                </div>
