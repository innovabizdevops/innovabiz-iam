...
export default function WarehouseMgmtDeepPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Warehouse Mgmt Deep</h1><p className="text-sm text-muted-foreground">Warehouse Mgmt Deep • iBOS Enterprise</p></div>
