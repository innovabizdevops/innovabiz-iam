...
const ACCENT = "#6366f1";
const MODULE = "Warehouse Mgmt Deep";
const PAGE = "Wave";
const KPIS = [{"l":"Total Warehouse Mgmt Deep","v":"367","t":"+11.9%","d":"up"},{"l":"Wave Ativos","v":"5.388","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"87.0%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"71","t":"+16.2%","d":"up"}];
const COLS = ["ID","Wave","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Mgmt Deep #001","Warehouse Mgmt Deep #002","5.793","5.055","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Mgmt Deep #002","Warehouse Mgmt Deep #003","2.123","4.775","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Mgmt Deep #003","Warehouse Mgmt Deep #004","416","5.545","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Mgmt Deep #004","Warehouse Mgmt Deep #005","2.455","4.143","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Mgmt Deep #005","Warehouse Mgmt Deep #001","3.440","5.958","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":316},{"label":"Mar","value":350},{"label":"Abr","value":315},{"label":"Mai","value":335},{"label":"Jun","value":462},{"label":"Jul","value":415},{"label":"Ago","value":599},{"label":"Set","value":472},{"label":"Out","value":274},{"label":"Nov","value":497},{"label":"Dez","value":498}];
const MX = 599;
