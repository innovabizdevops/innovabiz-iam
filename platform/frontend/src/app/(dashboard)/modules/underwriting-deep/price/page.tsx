...
const ACCENT = "#92400e";
const MODULE = "Underwriting Deep";
const PAGE = "Price";
const KPIS = [{"l":"Total Underwriting Deep","v":"4.511","t":"+5.1%","d":"up"},{"l":"Price Ativos","v":"3.075","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"68","t":"+6.5%","d":"up"}];
const COLS = ["ID","Price","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting Deep #001","Underwriting Deep #002","2.178","4.791","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting Deep #002","Underwriting Deep #003","5.957","6.049","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting Deep #003","Underwriting Deep #004","6.606","7.662","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting Deep #004","Underwriting Deep #005","1.383","4.169","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting Deep #005","Underwriting Deep #001","4.327","4.276","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":1068},{"label":"Mar","value":937},{"label":"Abr","value":1033},{"label":"Mai","value":865},{"label":"Jun","value":925},{"label":"Jul","value":898},{"label":"Ago","value":888},{"label":"Set","value":968},{"label":"Out","value":1003},{"label":"Nov","value":1029},{"label":"Dez","value":862}];
const MX = 1068;
