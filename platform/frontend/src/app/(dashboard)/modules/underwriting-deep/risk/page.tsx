...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"4.543","t":"+4.2%","d":"up"},{"l":"Mitigações Ativas","v":"8.711","t":"+16.1%","d":"up"},{"l":"Score Risco Geral","v":"75","t":"+12.6%","d":"up"},{"l":"Incidentes YTD","v":"937","t":"+7.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.984","1.884","4.982","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.804","4.084","6.695","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.046","1.232","1.772","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.729","3.353","1.973","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","306","647","8.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":393},{"label":"Mar","value":619},{"label":"Abr","value":368},{"label":"Mai","value":522},{"label":"Jun","value":584},{"label":"Jul","value":373},{"label":"Ago","value":435},{"label":"Set","value":407},{"label":"Out","value":343},{"label":"Nov","value":451},{"label":"Dez","value":446}];
const MX = 619;
