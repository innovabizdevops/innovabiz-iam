...
const PAGE = "Refer";
const KPIS = [{"l":"Total Underwriting Deep","v":"811","t":"-4.2%","d":"down"},{"l":"Refer Ativos","v":"5.632","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"61","t":"+7.0%","d":"up"}];
const COLS = ["ID","Refer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting Deep #001","Underwriting Deep #002","4.460","6.738","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting Deep #002","Underwriting Deep #003","1.461","1.395","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting Deep #003","Underwriting Deep #004","890","5.503","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting Deep #004","Underwriting Deep #005","3.837","7.049","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting Deep #005","Underwriting Deep #001","4.174","3.211","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1045},{"label":"Fev","value":982},{"label":"Mar","value":774},{"label":"Abr","value":846},{"label":"Mai","value":801},{"label":"Jun","value":894},{"label":"Jul","value":923},{"label":"Ago","value":905},{"label":"Set","value":875},{"label":"Out","value":683},{"label":"Nov","value":763},{"label":"Dez","value":661}];
const MX = 1045;
