...
/* ═══ Underwriting Deep — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "8288", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1260", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€180K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "279960388", cells: ["UND-7388", "Underwriting Deep Item 1", "9/5/2026", "€10 488"], status: "active" as const },
    { id: "279963959", cells: ["UND-1959", "Underwriting Deep Item 2", "24/12/2026", "€14 059"], status: "pending" as const },
    { id: "279967530", cells: ["UND-5530", "Underwriting Deep Item 3", "11/7/2026", "€17 630"], status: "completed" as const },
    { id: "279971101", cells: ["UND-9101", "Underwriting Deep Item 4", "26/2/2026", "€21 201"], status: "warning" as const },
    { id: "279974672", cells: ["UND-3672", "Underwriting Deep Item 5", "13/9/2026", "€24 772"], status: "active" as const },
];
...
export default function UnderwritingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Underwriting Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Underwriting Deep</p>
                    </div>
                </div>
