...
const PAGE = "Bind";
const KPIS = [{"l":"Total Underwriting Deep","v":"1.318","t":"+5.6%","d":"up"},{"l":"Bind Ativos","v":"2.432","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"82","t":"+10.0%","d":"up"}];
const COLS = ["ID","Bind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Underwriting Deep #001","Underwriting Deep #002","1.522","7.593","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Underwriting Deep #002","Underwriting Deep #003","7.515","5.779","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Underwriting Deep #003","Underwriting Deep #004","6.201","7.604","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Underwriting Deep #004","Underwriting Deep #005","7.529","6.472","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Underwriting Deep #005","Underwriting Deep #001","1.277","6.407","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":656},{"label":"Mar","value":356},{"label":"Abr","value":619},{"label":"Mai","value":543},{"label":"Jun","value":651},{"label":"Jul","value":359},{"label":"Ago","value":633},{"label":"Set","value":601},{"label":"Out","value":703},{"label":"Nov","value":486},{"label":"Dez","value":467}];
const MX = 703;
