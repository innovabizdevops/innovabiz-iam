...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Foundation Models";
const PAGE = "Fine-Tune Studio";
const KPIS = [{"l":"Total Genai Foundation","v":"5.419","t":"+18.0%","d":"up"},{"l":"Fine Tune Studio Ativos","v":"5.497","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"83","t":"-1.2%","d":"down"}];
const COLS = ["ID","Fine Tune Studio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Foundation #001","Genai Foundation #002","8.282","3.200","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Foundation #002","Genai Foundation #003","3.564","5.989","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Foundation #003","Genai Foundation #004","5.203","6.771","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Foundation #004","Genai Foundation #005","4.988","2.669","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Foundation #005","Genai Foundation #001","6.415","5.729","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":806},{"label":"Mar","value":663},{"label":"Abr","value":822},{"label":"Mai","value":792},{"label":"Jun","value":740},{"label":"Jul","value":807},{"label":"Ago","value":821},{"label":"Set","value":816},{"label":"Out","value":953},{"label":"Nov","value":956},{"label":"Dez","value":886}];
const MX = 956;
