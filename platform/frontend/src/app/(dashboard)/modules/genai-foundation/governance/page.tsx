...
const KPIS = [{"l":"Riscos Identificados","v":"7.998","t":"+9.8%","d":"up"},{"l":"Mitigações Ativas","v":"6.243","t":"+7.3%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"8.094","t":"+2.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.652","6.452","8.344","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.305","8.337","4.718","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.631","597","438","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","689","2.119","6.301","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.596","4.737","688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":740},{"label":"Mar","value":760},{"label":"Abr","value":612},{"label":"Mai","value":890},{"label":"Jun","value":930},{"label":"Jul","value":572},{"label":"Ago","value":783},{"label":"Set","value":748},{"label":"Out","value":868},{"label":"Nov","value":670},{"label":"Dez","value":766}];
const MX = 930;
