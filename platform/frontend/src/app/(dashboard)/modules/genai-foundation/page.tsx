...
/* ═══ GenAI Foundation Models — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "7447", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2387", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€29K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1967384847", cells: ["GEN-3847", "GenAI Foundation Models Item 1", "16/4/2026", "€34 947"], status: "active" as const },
    { id: "1967388418", cells: ["GEN-7418", "GenAI Foundation Models Item 2", "3/11/2026", "€38 518"], status: "pending" as const },
    { id: "1967391989", cells: ["GEN-1989", "GenAI Foundation Models Item 3", "18/6/2026", "€42 089"], status: "completed" as const },
    { id: "1967395560", cells: ["GEN-5560", "GenAI Foundation Models Item 4", "5/1/2026", "€45 660"], status: "warning" as const },
    { id: "1967399131", cells: ["GEN-9131", "GenAI Foundation Models Item 5", "20/8/2026", "€49 231"], status: "active" as const },
];
...
export default function GenaiFoundationModelsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Foundation Models</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Foundation Models</p>
                    </div>
                </div>
