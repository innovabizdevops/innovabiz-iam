...
const ACCENT = "#b45309";
const MODULE = "Veterinary & Animal Health";
const PAGE = "Appointment Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"8.092","t":"+3.0%","d":"up"},{"l":"RevPAR (€)","v":"€17840","t":"-0.3%","d":"down"},{"l":"Ocupação (%)","v":"86.4%","t":"+16.6%","d":"up"},{"l":"Guest Satisfaction","v":"4.680","t":"+8.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.519","2026-01-16","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.432","2026-01-23","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.482","2026-02-03","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.880","2026-01-05","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.188","2026-01-06","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":789},{"label":"Mar","value":670},{"label":"Abr","value":698},{"label":"Mai","value":477},{"label":"Jun","value":527},{"label":"Jul","value":555},{"label":"Ago","value":734},{"label":"Set","value":657},{"label":"Out","value":745},{"label":"Nov","value":750},{"label":"Dez","value":556}];
const MX = 789;
