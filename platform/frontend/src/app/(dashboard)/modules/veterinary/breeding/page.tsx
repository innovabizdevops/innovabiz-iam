...
const PAGE = "Breeding Registry";
const KPIS = [{"l":"Integrações Ativas","v":"6.445","t":"-2.3%","d":"down"},{"l":"Chamadas/Hora","v":"1023","t":"+12.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.1%","t":"+7.5%","d":"up"},{"l":"Latência Média (ms)","v":"38ms","t":"+2.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.708","1.625","89.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","168","2.891","98.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.603","8.814","89.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.550","780","75.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.443","5.551","89.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":461},{"label":"Mar","value":420},{"label":"Abr","value":804},{"label":"Mai","value":811},{"label":"Jun","value":533},{"label":"Jul","value":426},{"label":"Ago","value":503},{"label":"Set","value":481},{"label":"Out","value":620},{"label":"Nov","value":781},{"label":"Dez","value":734}];
const MX = 811;
