...
const PAGE = "Telemedicine Vet";
const KPIS = [{"l":"Integrações Ativas","v":"3.605","t":"+1.6%","d":"up"},{"l":"Chamadas/Hora","v":"2012","t":"+10.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.9%","t":"+6.0%","d":"up"},{"l":"Latência Média (ms)","v":"129ms","t":"+13.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.191","943","75.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.934","6.150","79.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.258","4.160","94.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.919","5.969","92.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.135","8.924","88.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":336},{"label":"Mar","value":464},{"label":"Abr","value":534},{"label":"Mai","value":614},{"label":"Jun","value":514},{"label":"Jul","value":413},{"label":"Ago","value":666},{"label":"Set","value":316},{"label":"Out","value":453},{"label":"Nov","value":639},{"label":"Dez","value":413}];
const MX = 666;
