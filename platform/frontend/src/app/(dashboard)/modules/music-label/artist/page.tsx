...
const PAGE = "Artist";
const KPIS = [{"l":"Total Music Label","v":"5.981","t":"+16.6%","d":"up"},{"l":"Artist Ativos","v":"3.626","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"68","t":"+8.2%","d":"up"}];
const COLS = ["ID","Artist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Music Label #001","Music Label #002","4.613","1.141","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Music Label #002","Music Label #003","5.599","2.650","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Music Label #003","Music Label #004","5.265","702","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Music Label #004","Music Label #005","8.292","6.130","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Music Label #005","Music Label #001","3.492","4.534","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":598},{"label":"Mar","value":612},{"label":"Abr","value":634},{"label":"Mai","value":608},{"label":"Jun","value":416},{"label":"Jul","value":330},{"label":"Ago","value":504},{"label":"Set","value":514},{"label":"Out","value":542},{"label":"Nov","value":429},{"label":"Dez","value":292}];
const MX = 671;
