...
const KPIS = [{"l":"Total Music Label","v":"5.876","t":"+9.5%","d":"up"},{"l":"Distribution Ativos","v":"808","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"72","t":"+5.3%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Music Label #001","Music Label #002","3.060","7.242","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Music Label #002","Music Label #003","1.662","4.068","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Music Label #003","Music Label #004","6.127","2.625","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Music Label #004","Music Label #005","4.178","3.965","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Music Label #005","Music Label #001","4.154","2.671","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":940},{"label":"Mar","value":800},{"label":"Abr","value":621},{"label":"Mai","value":676},{"label":"Jun","value":673},{"label":"Jul","value":924},{"label":"Ago","value":732},{"label":"Set","value":881},{"label":"Out","value":931},{"label":"Nov","value":657},{"label":"Dez","value":780}];
const MX = 940;
