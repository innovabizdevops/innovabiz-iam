...
const ACCENT = "#6366f1";
const MODULE = "Music Label";
const PAGE = "Marketing";
const KPIS = [{"l":"Total Music Label","v":"1.006","t":"-5.1%","d":"down"},{"l":"Marketing Ativos","v":"2.693","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"72.9%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"62","t":"+8.3%","d":"up"}];
const COLS = ["ID","Marketing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Music Label #001","Music Label #002","1.096","7.736","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Music Label #002","Music Label #003","2.608","5.016","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Music Label #003","Music Label #004","6.232","9.007","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Music Label #004","Music Label #005","8.629","7.647","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Music Label #005","Music Label #001","5.247","6.161","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":534},{"label":"Mar","value":603},{"label":"Abr","value":635},{"label":"Mai","value":803},{"label":"Jun","value":634},{"label":"Jul","value":801},{"label":"Ago","value":820},{"label":"Set","value":763},{"label":"Out","value":770},{"label":"Nov","value":886},{"label":"Dez","value":530}];
const MX = 916;
