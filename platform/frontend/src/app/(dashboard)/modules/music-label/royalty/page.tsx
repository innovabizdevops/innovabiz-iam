...
const PAGE = "Royalty";
const KPIS = [{"l":"Total Music Label","v":"3.643","t":"+7.4%","d":"up"},{"l":"Royalty Ativos","v":"5.526","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"68.3%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"57","t":"+17.2%","d":"up"}];
const COLS = ["ID","Royalty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Music Label #001","Music Label #002","6.856","8.209","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Music Label #002","Music Label #003","5.271","185","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Music Label #003","Music Label #004","6.362","8.089","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Music Label #004","Music Label #005","8.152","843","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Music Label #005","Music Label #001","8.361","2.714","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":620},{"label":"Mar","value":420},{"label":"Abr","value":534},{"label":"Mai","value":647},{"label":"Jun","value":422},{"label":"Jul","value":362},{"label":"Ago","value":439},{"label":"Set","value":602},{"label":"Out","value":358},{"label":"Nov","value":695},{"label":"Dez","value":463}];
const MX = 700;
