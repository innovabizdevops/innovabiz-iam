...
const ACCENT = "#6366f1";
const MODULE = "Bank Compliance";
const PAGE = "Regulatory";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.003","t":"+3.0%","d":"up"},{"l":"NC Abertas","v":"6.344","t":"+7.9%","d":"up"},{"l":"Conformidade (%)","v":"86.4%","t":"+13.2%","d":"up"},{"l":"CAPAs Pendentes","v":"6.518","t":"+6.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.474","76.6%","5.428","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.782","78.0%","1.063","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.841","85.1%","5.995","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.506","83.0%","3.918","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.135","87.4%","4.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":589},{"label":"Mar","value":519},{"label":"Abr","value":531},{"label":"Mai","value":376},{"label":"Jun","value":471},{"label":"Jul","value":378},{"label":"Ago","value":413},{"label":"Set","value":614},{"label":"Out","value":339},{"label":"Nov","value":266},{"label":"Dez","value":571}];
const MX = 614;
