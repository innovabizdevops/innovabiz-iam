...
const PAGE = "Incident";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.981","t":"+4.2%","d":"up"},{"l":"NC Abertas","v":"931","t":"+15.1%","d":"up"},{"l":"Conformidade (%)","v":"65.8%","t":"-3.7%","d":"down"},{"l":"CAPAs Pendentes","v":"6.722","t":"+14.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.395","92.1%","8.829","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.031","89.9%","6.819","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","106","98.4%","2.823","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.465","97.3%","7.110","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.669","82.9%","665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":697},{"label":"Mar","value":684},{"label":"Abr","value":601},{"label":"Mai","value":633},{"label":"Jun","value":780},{"label":"Jul","value":815},{"label":"Ago","value":549},{"label":"Set","value":530},{"label":"Out","value":689},{"label":"Nov","value":677},{"label":"Dez","value":675}];
const MX = 815;
