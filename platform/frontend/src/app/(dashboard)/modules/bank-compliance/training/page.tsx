...
const PAGE = "Training";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.795","t":"+11.3%","d":"up"},{"l":"NC Abertas","v":"4.403","t":"-1.8%","d":"down"},{"l":"Conformidade (%)","v":"83.7%","t":"+14.6%","d":"up"},{"l":"CAPAs Pendentes","v":"3.949","t":"+11.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.186","82.2%","5.598","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","338","77.5%","2.235","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.248","95.2%","9.031","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.675","73.7%","8.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.826","85.9%","4.858","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":631},{"label":"Mar","value":323},{"label":"Abr","value":343},{"label":"Mai","value":320},{"label":"Jun","value":506},{"label":"Jul","value":579},{"label":"Ago","value":504},{"label":"Set","value":561},{"label":"Out","value":509},{"label":"Nov","value":287},{"label":"Dez","value":338}];
const MX = 631;
