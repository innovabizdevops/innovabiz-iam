...
const PAGE = "Convert";
const KPIS = [{"l":"Total Nonwoven Mfg","v":"4.033","t":"+12.5%","d":"up"},{"l":"Convert Ativos","v":"5.405","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"94.9%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"78","t":"-1.6%","d":"down"}];
const COLS = ["ID","Convert","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonwoven Mfg #001","Nonwoven Mfg #002","7.400","126","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Nonwoven Mfg #002","Nonwoven Mfg #003","2.443","3.080","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonwoven Mfg #003","Nonwoven Mfg #004","1.434","787","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Nonwoven Mfg #004","Nonwoven Mfg #005","2.376","7.108","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonwoven Mfg #005","Nonwoven Mfg #001","7.580","3.708","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":706},{"label":"Mar","value":778},{"label":"Abr","value":822},{"label":"Mai","value":692},{"label":"Jun","value":1019},{"label":"Jul","value":647},{"label":"Ago","value":890},{"label":"Set","value":1021},{"label":"Out","value":790},{"label":"Nov","value":734},{"label":"Dez","value":803}];
const MX = 1021;
