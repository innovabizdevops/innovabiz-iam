...
const ACCENT = "#6366f1";
const MODULE = "Nonwoven Manufacturing";
const PAGE = "Meltblown";
const KPIS = [{"l":"Total Nonwoven Mfg","v":"6.749","t":"-2.5%","d":"down"},{"l":"Meltblown Ativos","v":"7.178","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+10.6%","d":"up"}];
const COLS = ["ID","Meltblown","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonwoven Mfg #001","Nonwoven Mfg #002","1.647","4.631","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Nonwoven Mfg #002","Nonwoven Mfg #003","747","3.790","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonwoven Mfg #003","Nonwoven Mfg #004","6.808","454","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Nonwoven Mfg #004","Nonwoven Mfg #005","3.447","3.535","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonwoven Mfg #005","Nonwoven Mfg #001","2.142","5.097","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":646},{"label":"Mar","value":845},{"label":"Abr","value":623},{"label":"Mai","value":632},{"label":"Jun","value":741},{"label":"Jul","value":776},{"label":"Ago","value":566},{"label":"Set","value":769},{"label":"Out","value":690},{"label":"Nov","value":787},{"label":"Dez","value":850}];
const MX = 859;
...
export default function MeltblownPage() {
    return (
