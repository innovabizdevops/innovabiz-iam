...
const PAGE = "Spunbond";
const KPIS = [{"l":"Total Nonwoven Mfg","v":"8.156","t":"+7.9%","d":"up"},{"l":"Spunbond Ativos","v":"7.264","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"66","t":"+13.6%","d":"up"}];
const COLS = ["ID","Spunbond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonwoven Mfg #001","Nonwoven Mfg #002","5.028","6.043","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Nonwoven Mfg #002","Nonwoven Mfg #003","5.544","7.587","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonwoven Mfg #003","Nonwoven Mfg #004","7.592","2.492","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Nonwoven Mfg #004","Nonwoven Mfg #005","7.375","2.549","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonwoven Mfg #005","Nonwoven Mfg #001","7.459","129","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":539},{"label":"Mar","value":620},{"label":"Abr","value":611},{"label":"Mai","value":814},{"label":"Jun","value":660},{"label":"Jul","value":583},{"label":"Ago","value":494},{"label":"Set","value":720},{"label":"Out","value":787},{"label":"Nov","value":435},{"label":"Dez","value":565}];
const MX = 814;
...
export default function SpunbondPage() {
    return (
