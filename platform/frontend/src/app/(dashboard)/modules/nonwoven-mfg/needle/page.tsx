...
const PAGE = "Needle";
const KPIS = [{"l":"Total Nonwoven Mfg","v":"4.802","t":"-2.5%","d":"down"},{"l":"Needle Ativos","v":"4.123","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"92","t":"+2.0%","d":"up"}];
const COLS = ["ID","Needle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nonwoven Mfg #001","Nonwoven Mfg #002","4.246","577","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Nonwoven Mfg #002","Nonwoven Mfg #003","1.278","7.253","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Nonwoven Mfg #003","Nonwoven Mfg #004","7.380","8.612","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Nonwoven Mfg #004","Nonwoven Mfg #005","901","7.120","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nonwoven Mfg #005","Nonwoven Mfg #001","4.526","8.124","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":404},{"label":"Mar","value":400},{"label":"Abr","value":659},{"label":"Mai","value":676},{"label":"Jun","value":719},{"label":"Jul","value":669},{"label":"Ago","value":501},{"label":"Set","value":703},{"label":"Out","value":490},{"label":"Nov","value":400},{"label":"Dez","value":505}];
const MX = 719;
