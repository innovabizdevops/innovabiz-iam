...
const KPIS = [{"l":"Dispositivos Online","v":"3.754","t":"+14.8%","d":"up"},{"l":"Dados/Min (MB)","v":"3.745","t":"+1.9%","d":"up"},{"l":"Alertas Ativos","v":"1.774","t":"+9.8%","d":"up"},{"l":"Uptime (%)","v":"86.4%","t":"+11.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.213","6.805","349","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","803","1.772","312","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.146","2.957","5.078","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.866","8.453","6.796","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.725","5.727","2.100","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":307},{"label":"Mar","value":412},{"label":"Abr","value":449},{"label":"Mai","value":336},{"label":"Jun","value":285},{"label":"Jul","value":246},{"label":"Ago","value":477},{"label":"Set","value":576},{"label":"Out","value":545},{"label":"Nov","value":279},{"label":"Dez","value":272}];
const MX = 576;
