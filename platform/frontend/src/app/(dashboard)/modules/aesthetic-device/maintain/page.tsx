...
const PAGE = "Maintain";
const KPIS = [{"l":"Dispositivos Online","v":"3.456","t":"+0.1%","d":"up"},{"l":"Dados/Min (MB)","v":"7.001","t":"-3.0%","d":"down"},{"l":"Alertas Ativos","v":"1.560","t":"+6.4%","d":"up"},{"l":"Uptime (%)","v":"81.9%","t":"+4.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","105","7.138","791","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.518","2.526","5.048","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.408","6.319","6.787","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.545","1.003","5.474","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.186","3.072","3.758","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":839},{"label":"Mar","value":786},{"label":"Abr","value":882},{"label":"Mai","value":741},{"label":"Jun","value":1039},{"label":"Jul","value":1005},{"label":"Ago","value":759},{"label":"Set","value":1019},{"label":"Out","value":840},{"label":"Nov","value":760},{"label":"Dez","value":764}];
const MX = 1039;
