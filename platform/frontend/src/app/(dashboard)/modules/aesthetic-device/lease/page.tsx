...
const ACCENT = "#be185d";
const MODULE = "Aesthetic Device Mgmt";
const PAGE = "Lease";
const KPIS = [{"l":"Dispositivos Online","v":"8.825","t":"+8.8%","d":"up"},{"l":"Dados/Min (MB)","v":"8.068","t":"+7.7%","d":"up"},{"l":"Alertas Ativos","v":"4.855","t":"-3.4%","d":"down"},{"l":"Uptime (%)","v":"78.0%","t":"-0.8%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.590","8.971","203","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.985","3.065","4.288","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.030","7.159","3.544","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.474","4.155","4.712","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.483","8.085","8.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":358},{"label":"Mar","value":292},{"label":"Abr","value":477},{"label":"Mai","value":475},{"label":"Jun","value":470},{"label":"Jul","value":299},{"label":"Ago","value":242},{"label":"Set","value":252},{"label":"Out","value":532},{"label":"Nov","value":232},{"label":"Dez","value":400}];
const MX = 611;
