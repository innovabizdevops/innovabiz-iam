...
/* ═══ Aesthetic Device Mgmt — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "8498", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4550", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€64K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "823490398", cells: ["AES-9398", "Aesthetic Device Mgmt Item 1", "11/11/2026", "€40 498"], status: "active" as const },
    { id: "823493969", cells: ["AES-3969", "Aesthetic Device Mgmt Item 2", "26/6/2026", "€44 069"], status: "pending" as const },
    { id: "823497540", cells: ["AES-7540", "Aesthetic Device Mgmt Item 3", "13/1/2026", "€47 640"], status: "completed" as const },
    { id: "823501111", cells: ["AES-2111", "Aesthetic Device Mgmt Item 4", "28/8/2026", "€1211"], status: "warning" as const },
    { id: "823504682", cells: ["AES-5682", "Aesthetic Device Mgmt Item 5", "15/3/2026", "€4782"], status: "active" as const },
];
...
export default function AestheticDeviceMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aesthetic Device Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aesthetic Device Mgmt</p>
                    </div>
                </div>
