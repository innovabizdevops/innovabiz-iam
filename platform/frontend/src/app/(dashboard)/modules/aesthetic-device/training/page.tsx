...
const PAGE = "Training";
const KPIS = [{"l":"Dispositivos Online","v":"754","t":"+7.3%","d":"up"},{"l":"Dados/Min (MB)","v":"158","t":"+10.2%","d":"up"},{"l":"Alertas Ativos","v":"2.729","t":"+11.2%","d":"up"},{"l":"Uptime (%)","v":"72.2%","t":"+7.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.142","1.403","6.162","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.700","8.626","3.366","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.516","3.138","6.194","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.924","6.171","7.063","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.402","1.862","5.152","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":753},{"label":"Mar","value":729},{"label":"Abr","value":962},{"label":"Mai","value":847},{"label":"Jun","value":591},{"label":"Jul","value":606},{"label":"Ago","value":775},{"label":"Set","value":781},{"label":"Out","value":632},{"label":"Nov","value":624},{"label":"Dez","value":680}];
const MX = 962;
