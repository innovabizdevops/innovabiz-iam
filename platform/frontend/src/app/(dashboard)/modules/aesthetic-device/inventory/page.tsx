...
const KPIS = [{"l":"Dispositivos Online","v":"341","t":"+15.8%","d":"up"},{"l":"Dados/Min (MB)","v":"6.704","t":"+2.3%","d":"up"},{"l":"Alertas Ativos","v":"7.097","t":"+6.6%","d":"up"},{"l":"Uptime (%)","v":"85.9%","t":"+9.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","796","4.037","5.768","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.157","1.322","5.800","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.233","3.476","6.341","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.626","7.444","8.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.772","5.970","1.127","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":349},{"label":"Mar","value":445},{"label":"Abr","value":443},{"label":"Mai","value":549},{"label":"Jun","value":309},{"label":"Jul","value":466},{"label":"Ago","value":256},{"label":"Set","value":237},{"label":"Out","value":542},{"label":"Nov","value":362},{"label":"Dez","value":267}];
const MX = 549;
