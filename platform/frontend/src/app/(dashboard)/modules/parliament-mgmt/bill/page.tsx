...
const PAGE = "Bill";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.538","t":"+7.2%","d":"up"},{"l":"Sessões/Dia","v":"2713","t":"+1.0%","d":"up"},{"l":"MFA Adoção (%)","v":"83.6%","t":"+9.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.049","t":"+9.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.922","7.697","2.294","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.636","7.312","3.858","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.085","4.610","7.615","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.256","4.602","5.201","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","822","7.850","5.159","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":539},{"label":"Mar","value":392},{"label":"Abr","value":475},{"label":"Mai","value":589},{"label":"Jun","value":470},{"label":"Jul","value":381},{"label":"Ago","value":521},{"label":"Set","value":603},{"label":"Out","value":523},{"label":"Nov","value":656},{"label":"Dez","value":353}];
const MX = 656;
