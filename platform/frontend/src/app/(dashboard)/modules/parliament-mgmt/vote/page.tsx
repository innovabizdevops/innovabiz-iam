...
const PAGE = "Vote";
const KPIS = [{"l":"Utilizadores Ativos","v":"9.055","t":"+4.0%","d":"up"},{"l":"Sessões/Dia","v":"829","t":"+6.0%","d":"up"},{"l":"MFA Adoção (%)","v":"75.4%","t":"+10.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.839","t":"+1.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.320","8.824","8.516","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.327","1.304","4.651","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.070","3.448","4.122","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.103","1.068","7.776","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.940","1.293","2.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":844},{"label":"Mar","value":662},{"label":"Abr","value":460},{"label":"Mai","value":564},{"label":"Jun","value":590},{"label":"Jul","value":734},{"label":"Ago","value":765},{"label":"Set","value":639},{"label":"Out","value":572},{"label":"Nov","value":766},{"label":"Dez","value":723}];
const MX = 844;
