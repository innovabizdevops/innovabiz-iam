...
const KPIS = [{"l":"Utilizadores Ativos","v":"2.471","t":"-3.8%","d":"down"},{"l":"Sessões/Dia","v":"4724","t":"+8.1%","d":"up"},{"l":"MFA Adoção (%)","v":"92.3%","t":"+4.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.500","t":"-4.5%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.497","7.735","7.911","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.255","4.192","6.965","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.346","4.774","7.174","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.507","2.248","6.662","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.953","4.158","9.053","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":579},{"label":"Mar","value":552},{"label":"Abr","value":727},{"label":"Mai","value":583},{"label":"Jun","value":574},{"label":"Jul","value":696},{"label":"Ago","value":717},{"label":"Set","value":728},{"label":"Out","value":460},{"label":"Nov","value":549},{"label":"Dez","value":786}];
const MX = 786;
