...
const ACCENT = "#87a9cf";
const MODULE = "Parliament Management";
const PAGE = "Session";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.195","t":"+7.9%","d":"up"},{"l":"Sessões/Dia","v":"3329","t":"-2.9%","d":"down"},{"l":"MFA Adoção (%)","v":"77.9%","t":"+3.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.832","t":"-2.3%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.021","3.304","6.115","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.577","6.949","266","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.915","3.955","5.622","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.713","2.109","989","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.932","1.848","1.404","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":841},{"label":"Mar","value":663},{"label":"Abr","value":574},{"label":"Mai","value":521},{"label":"Jun","value":664},{"label":"Jul","value":636},{"label":"Ago","value":625},{"label":"Set","value":683},{"label":"Out","value":602},{"label":"Nov","value":586},{"label":"Dez","value":651}];
const MX = 841;
