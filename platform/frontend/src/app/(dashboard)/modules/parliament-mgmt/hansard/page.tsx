...
const PAGE = "Hansard";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.395","t":"+12.8%","d":"up"},{"l":"Sessões/Dia","v":"2967","t":"+13.5%","d":"up"},{"l":"MFA Adoção (%)","v":"78.3%","t":"+0.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.326","t":"+10.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.559","8.263","7.216","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.883","4.580","6.440","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.715","4.254","7.897","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.517","4.705","7.926","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.833","9.057","2.414","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":952},{"label":"Fev","value":911},{"label":"Mar","value":661},{"label":"Abr","value":920},{"label":"Mai","value":912},{"label":"Jun","value":873},{"label":"Jul","value":669},{"label":"Ago","value":824},{"label":"Set","value":716},{"label":"Out","value":975},{"label":"Nov","value":711},{"label":"Dez","value":716}];
const MX = 975;
