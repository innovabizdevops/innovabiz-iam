...
const PAGE = "Splice Mgmt";
const KPIS = [{"l":"Total Telecom Fiber","v":"8.489","t":"+5.2%","d":"up"},{"l":"Splice Mgmt Ativos","v":"365","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"95","t":"-4.8%","d":"down"}];
const COLS = ["ID","Splice Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fiber #001","Telecom Fiber #002","5.322","8.850","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fiber #002","Telecom Fiber #003","4.439","2.653","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fiber #003","Telecom Fiber #004","7.001","5.734","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fiber #004","Telecom Fiber #005","2.440","6.418","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fiber #005","Telecom Fiber #001","9.083","181","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":547},{"label":"Mar","value":628},{"label":"Abr","value":632},{"label":"Mai","value":766},{"label":"Jun","value":376},{"label":"Jul","value":467},{"label":"Ago","value":564},{"label":"Set","value":593},{"label":"Out","value":762},{"label":"Nov","value":755},{"label":"Dez","value":665}];
const MX = 766;
