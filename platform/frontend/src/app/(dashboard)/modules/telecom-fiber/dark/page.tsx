...
const ACCENT = "#4338ca";
const MODULE = "Telecom Fiber";
const PAGE = "Dark Fiber";
const KPIS = [{"l":"Total Telecom Fiber","v":"3.150","t":"+4.7%","d":"up"},{"l":"Dark Fiber Ativos","v":"7.839","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"72.4%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"87","t":"+6.9%","d":"up"}];
const COLS = ["ID","Dark Fiber","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fiber #001","Telecom Fiber #002","6.094","136","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fiber #002","Telecom Fiber #003","2.139","4.644","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fiber #003","Telecom Fiber #004","5.908","4.756","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fiber #004","Telecom Fiber #005","3.936","5.355","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fiber #005","Telecom Fiber #001","704","1.308","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":704},{"label":"Mar","value":558},{"label":"Abr","value":595},{"label":"Mai","value":610},{"label":"Jun","value":849},{"label":"Jul","value":678},{"label":"Ago","value":624},{"label":"Set","value":814},{"label":"Out","value":813},{"label":"Nov","value":784},{"label":"Dez","value":661}];
const MX = 882;
