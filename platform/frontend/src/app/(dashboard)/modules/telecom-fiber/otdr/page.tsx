...
const PAGE = "OTDR Testing";
const KPIS = [{"l":"Total Telecom Fiber","v":"5.738","t":"+8.8%","d":"up"},{"l":"OTDR Testing Ativos","v":"2.820","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"87.2%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+1.3%","d":"up"}];
const COLS = ["ID","OTDR Testing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fiber #001","Telecom Fiber #002","2.128","7.244","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fiber #002","Telecom Fiber #003","350","369","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fiber #003","Telecom Fiber #004","528","4.711","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fiber #004","Telecom Fiber #005","968","3.098","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fiber #005","Telecom Fiber #001","1.815","3.303","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":699},{"label":"Mar","value":672},{"label":"Abr","value":457},{"label":"Mai","value":775},{"label":"Jun","value":718},{"label":"Jul","value":664},{"label":"Ago","value":487},{"label":"Set","value":833},{"label":"Out","value":720},{"label":"Nov","value":746},{"label":"Dez","value":522}];
const MX = 833;
