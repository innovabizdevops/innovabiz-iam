...
const PAGE = "Fiber Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.380","t":"+6.9%","d":"up"},{"l":"Submissões/Dia","v":"4303","t":"-1.7%","d":"down"},{"l":"Documentos Gerados","v":"8.142","t":"+12.2%","d":"up"},{"l":"Templates","v":"6.952","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","120","2026-01-20","1.375","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.185","2026-01-18","5.718","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.715","2026-01-01","7.377","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.335","2026-02-14","1.447","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.494","2026-01-28","5.279","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":606},{"label":"Mar","value":630},{"label":"Abr","value":899},{"label":"Mai","value":692},{"label":"Jun","value":794},{"label":"Jul","value":897},{"label":"Ago","value":678},{"label":"Set","value":835},{"label":"Out","value":716},{"label":"Nov","value":935},{"label":"Dez","value":677}];
const MX = 935;
