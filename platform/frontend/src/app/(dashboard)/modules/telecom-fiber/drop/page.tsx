...
const PAGE = "Customer Drop";
const KPIS = [{"l":"Total Telecom Fiber","v":"4.290","t":"+10.2%","d":"up"},{"l":"Customer Drop Ativos","v":"€19466","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"75","t":"+8.5%","d":"up"}];
const COLS = ["ID","Customer Drop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Fiber #001","€ 49639.09","413","2.647","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Fiber #002","€ 42946.84","8.550","1.800","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Fiber #003","€ 21177.93","2.103","5.668","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Fiber #004","€ 11269.31","2.279","8.915","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Fiber #005","€ 46166.75","754","9.032","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":826},{"label":"Mar","value":896},{"label":"Abr","value":815},{"label":"Mai","value":600},{"label":"Jun","value":526},{"label":"Jul","value":729},{"label":"Ago","value":740},{"label":"Set","value":845},{"label":"Out","value":727},{"label":"Nov","value":778},{"label":"Dez","value":553}];
const MX = 896;
