...
export default function TelecomFiberPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Telecom Fiber</h1><p className="text-sm text-muted-foreground">Telecom Fiber • iBOS Enterprise</p></div>
