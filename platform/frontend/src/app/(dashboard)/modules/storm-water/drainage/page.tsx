...
const PAGE = "Drainage";
const KPIS = [{"l":"Total Storm Water","v":"3.122","t":"+8.1%","d":"up"},{"l":"Drainage Ativos","v":"1.812","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"91.6%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"71","t":"+6.1%","d":"up"}];
const COLS = ["ID","Drainage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storm Water #001","Storm Water #002","8.142","4.468","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Storm Water #002","Storm Water #003","2.862","5.761","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Storm Water #003","Storm Water #004","7.242","7.745","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Storm Water #004","Storm Water #005","5.163","4.101","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storm Water #005","Storm Water #001","7.853","2.620","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":928},{"label":"Mar","value":799},{"label":"Abr","value":735},{"label":"Mai","value":811},{"label":"Jun","value":853},{"label":"Jul","value":821},{"label":"Ago","value":577},{"label":"Set","value":647},{"label":"Out","value":663},{"label":"Nov","value":612},{"label":"Dez","value":630}];
const MX = 930;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#164e63'}}>GIS</span></h1>
                </div>
