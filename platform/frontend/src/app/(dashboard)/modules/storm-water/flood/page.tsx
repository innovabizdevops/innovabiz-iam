...
const ACCENT = "#164e63";
const MODULE = "Storm Water Mgmt";
const PAGE = "Flood Model";
const KPIS = [{"l":"Total Storm Water","v":"5.872","t":"+11.6%","d":"up"},{"l":"Flood Model Ativos","v":"1.775","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"58","t":"+13.9%","d":"up"}];
const COLS = ["ID","Flood Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storm Water #001","Storm Water #002","4.840","5.646","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Storm Water #002","Storm Water #003","727","2.481","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Storm Water #003","Storm Water #004","2.662","4.591","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Storm Water #004","Storm Water #005","6.016","5.587","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storm Water #005","Storm Water #001","4.173","5.344","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":836},{"label":"Mar","value":721},{"label":"Abr","value":853},{"label":"Mai","value":825},{"label":"Jun","value":758},{"label":"Jul","value":838},{"label":"Ago","value":601},{"label":"Set","value":826},{"label":"Out","value":841},{"label":"Nov","value":873},{"label":"Dez","value":561}];
const MX = 873;
