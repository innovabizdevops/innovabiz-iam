...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"7.690","t":"+3.9%","d":"up"},{"l":"Mitigações Ativas","v":"1.017","t":"+13.2%","d":"up"},{"l":"Score Risco Geral","v":"80","t":"+6.2%","d":"up"},{"l":"Incidentes YTD","v":"7.933","t":"-2.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.099","8.451","8.273","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.382","3.244","326","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.683","2.529","8.148","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.899","8.246","6.598","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.592","3.134","204","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":325},{"label":"Mar","value":343},{"label":"Abr","value":372},{"label":"Mai","value":346},{"label":"Jun","value":394},{"label":"Jul","value":401},{"label":"Ago","value":315},{"label":"Set","value":348},{"label":"Out","value":338},{"label":"Nov","value":539},{"label":"Dez","value":216}];
const MX = 539;
