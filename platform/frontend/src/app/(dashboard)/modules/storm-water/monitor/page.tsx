...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Storm Water","v":"2.836","t":"+3.6%","d":"up"},{"l":"Monitor Ativos","v":"8.291","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"79.2%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"95","t":"-2.6%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storm Water #001","Storm Water #002","8.911","8.341","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Storm Water #002","Storm Water #003","4.095","5.157","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Storm Water #003","Storm Water #004","8.985","6.128","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Storm Water #004","Storm Water #005","398","5.564","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storm Water #005","Storm Water #001","5.398","3.577","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":478},{"label":"Mar","value":526},{"label":"Abr","value":594},{"label":"Mai","value":612},{"label":"Jun","value":279},{"label":"Jul","value":351},{"label":"Ago","value":357},{"label":"Set","value":433},{"label":"Out","value":282},{"label":"Nov","value":338},{"label":"Dez","value":293}];
const MX = 612;
