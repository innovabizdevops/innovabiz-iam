...
const KPIS = [{"l":"Total Storm Water","v":"2.304","t":"+17.6%","d":"up"},{"l":"Green Infra Ativos","v":"2.322","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+4.2%","d":"up"}];
const COLS = ["ID","Green Infra","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Storm Water #001","Storm Water #002","1.353","3.309","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Storm Water #002","Storm Water #003","4.302","3.819","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Storm Water #003","Storm Water #004","7.576","6.413","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Storm Water #004","Storm Water #005","2.530","8.656","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Storm Water #005","Storm Water #001","8.811","190","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":599},{"label":"Mar","value":607},{"label":"Abr","value":707},{"label":"Mai","value":794},{"label":"Jun","value":960},{"label":"Jul","value":916},{"label":"Ago","value":665},{"label":"Set","value":942},{"label":"Out","value":699},{"label":"Nov","value":615},{"label":"Dez","value":620}];
const MX = 960;
