...
const PAGE = "Cloud";
const KPIS = [{"l":"Formulários Ativos","v":"1.989","t":"+9.2%","d":"up"},{"l":"Submissões/Dia","v":"4894","t":"-3.3%","d":"down"},{"l":"Documentos Gerados","v":"6.704","t":"+2.5%","d":"up"},{"l":"Templates","v":"4.174","t":"+2.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.229","2026-02-24","5.723","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.372","2026-03-04","1.564","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.822","2026-03-05","5.896","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","744","2026-03-02","6.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","686","2026-01-26","6.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":369},{"label":"Mar","value":389},{"label":"Abr","value":640},{"label":"Mai","value":428},{"label":"Jun","value":287},{"label":"Jul","value":408},{"label":"Ago","value":541},{"label":"Set","value":654},{"label":"Out","value":462},{"label":"Nov","value":363},{"label":"Dez","value":277}];
const MX = 654;
