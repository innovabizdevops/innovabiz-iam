...
const PAGE = "Email";
const KPIS = [{"l":"Formulários Ativos","v":"7.747","t":"-4.1%","d":"down"},{"l":"Submissões/Dia","v":"1029","t":"+6.7%","d":"up"},{"l":"Documentos Gerados","v":"3.579","t":"+3.6%","d":"up"},{"l":"Templates","v":"6.897","t":"-4.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.563","2026-01-21","8.809","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.474","2026-03-03","4.490","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.116","2026-01-15","7.857","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.742","2026-01-16","7.882","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.777","2026-01-22","6.350","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":860},{"label":"Mar","value":598},{"label":"Abr","value":591},{"label":"Mai","value":543},{"label":"Jun","value":620},{"label":"Jul","value":826},{"label":"Ago","value":808},{"label":"Set","value":739},{"label":"Out","value":716},{"label":"Nov","value":890},{"label":"Dez","value":666}];
const MX = 890;
