...
const PAGE = "Endpoint";
const KPIS = [{"l":"Formulários Ativos","v":"2.344","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"712","t":"+13.6%","d":"up"},{"l":"Documentos Gerados","v":"6.324","t":"+3.0%","d":"up"},{"l":"Templates","v":"6.033","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.188","2026-03-04","5.764","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.750","2026-01-05","1.371","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","538","2026-02-04","4.130","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.099","2026-03-25","2.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","592","2026-03-02","6.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":1053},{"label":"Mar","value":676},{"label":"Abr","value":849},{"label":"Mai","value":662},{"label":"Jun","value":1002},{"label":"Jul","value":1038},{"label":"Ago","value":698},{"label":"Set","value":826},{"label":"Out","value":929},{"label":"Nov","value":736},{"label":"Dez","value":883}];
const MX = 1053;
