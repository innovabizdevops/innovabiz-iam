...
/* ═══ XDR Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "139", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "299", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€37K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "466507839", cells: ["XDR-2839", "XDR Platform Item 1", "8/4/2026", "€7939"], status: "active" as const },
    { id: "466511410", cells: ["XDR-6410", "XDR Platform Item 2", "23/11/2026", "€11 510"], status: "pending" as const },
    { id: "466514981", cells: ["XDR-9981", "XDR Platform Item 3", "10/6/2026", "€15 081"], status: "completed" as const },
    { id: "466518552", cells: ["XDR-4552", "XDR Platform Item 4", "25/1/2026", "€18 652"], status: "warning" as const },
    { id: "466522123", cells: ["XDR-8123", "XDR Platform Item 5", "12/8/2026", "€22 223"], status: "active" as const },
];
...
export default function XdrPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">XDR Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • XDR Platform</p>
                    </div>
                </div>
