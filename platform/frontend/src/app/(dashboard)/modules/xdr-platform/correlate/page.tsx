...
const ACCENT = "#7f1d1d";
const MODULE = "XDR Platform";
const PAGE = "Correlate";
const KPIS = [{"l":"Formulários Ativos","v":"2.757","t":"-0.1%","d":"down"},{"l":"Submissões/Dia","v":"2710","t":"+3.0%","d":"up"},{"l":"Documentos Gerados","v":"8.517","t":"-5.6%","d":"down"},{"l":"Templates","v":"2.293","t":"+4.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.285","2026-01-13","4.783","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.030","2026-02-04","132","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.551","2026-02-18","4.426","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.642","2026-02-17","2.221","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.356","2026-01-23","3.242","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":394},{"label":"Mar","value":563},{"label":"Abr","value":437},{"label":"Mai","value":599},{"label":"Jun","value":304},{"label":"Jul","value":228},{"label":"Ago","value":616},{"label":"Set","value":554},{"label":"Out","value":397},{"label":"Nov","value":310},{"label":"Dez","value":510}];
const MX = 616;
