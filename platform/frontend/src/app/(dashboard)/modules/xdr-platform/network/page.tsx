...
const PAGE = "Network";
const KPIS = [{"l":"Formulários Ativos","v":"4.378","t":"+17.2%","d":"up"},{"l":"Submissões/Dia","v":"1377","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"7.080","t":"-4.3%","d":"down"},{"l":"Templates","v":"2.379","t":"+16.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.485","2026-01-01","2.927","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","256","2026-02-10","4.581","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.174","2026-03-13","1.314","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","386","2026-02-14","5.228","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.183","2026-03-09","1.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":277},{"label":"Mar","value":459},{"label":"Abr","value":333},{"label":"Mai","value":258},{"label":"Jun","value":447},{"label":"Jul","value":594},{"label":"Ago","value":464},{"label":"Set","value":543},{"label":"Out","value":630},{"label":"Nov","value":577},{"label":"Dez","value":611}];
const MX = 630;
