...
/* ═══ Digital Marketing Platform — Dashboard ═══ */

const ACCENT = "#3b82f6";

const KPIS = [
    { label: "Total Registos", value: "4584", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1130", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€125K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1854185384", cells: ["DIG-6384", "Digital Marketing Platform Item 1", "17/9/2026", "€35 484"], status: "active" as const },
    { id: "1854188955", cells: ["DIG-9955", "Digital Marketing Platform Item 2", "4/4/2026", "€39 055"], status: "pending" as const },
    { id: "1854192526", cells: ["DIG-4526", "Digital Marketing Platform Item 3", "19/11/2026", "€42 626"], status: "completed" as const },
    { id: "1854196097", cells: ["DIG-8097", "Digital Marketing Platform Item 4", "6/6/2026", "€46 197"], status: "warning" as const },
    { id: "1854199668", cells: ["DIG-2668", "Digital Marketing Platform Item 5", "21/1/2026", "€49 768"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Marketing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Digital Marketing Platform</p>
                    </div>
                </div>
