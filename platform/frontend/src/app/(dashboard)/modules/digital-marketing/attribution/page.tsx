...
const ACCENT = "#3b82f6";
const MODULE = "Digital Marketing Platform";
const PAGE = "Attribution";
const KPIS = [{"l":"Total Digital Marketing","v":"153","t":"+0.8%","d":"up"},{"l":"Attribution Ativos","v":"1.378","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"94","t":"+3.8%","d":"up"}];
const COLS = ["ID","Attribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Marketing #001","Digital Marketing #002","1.634","226","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Marketing #002","Digital Marketing #003","1.960","3.570","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Marketing #003","Digital Marketing #004","4.124","7.041","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Marketing #004","Digital Marketing #005","3.474","3.488","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Marketing #005","Digital Marketing #001","560","5.632","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":781},{"label":"Mar","value":758},{"label":"Abr","value":565},{"label":"Mai","value":728},{"label":"Jun","value":610},{"label":"Jul","value":509},{"label":"Ago","value":597},{"label":"Set","value":499},{"label":"Out","value":706},{"label":"Nov","value":627},{"label":"Dez","value":734}];
const MX = 856;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#3b82f6'}}>AI</span></h1>
                </div>
