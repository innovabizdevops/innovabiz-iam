...
const PAGE = "Marginal Analysis";
const KPIS = [{"l":"ARR (€M)","v":"€17.8M","t":"+17.7%","d":"up"},{"l":"MRR (€)","v":"€97958","t":"+1.5%","d":"up"},{"l":"Churn (%)","v":"91.1%","t":"+11.7%","d":"up"},{"l":"ARPU (€)","v":"€37648","t":"+12.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33149.50","5.249","€ 27939.54","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 7943.84","2.853","€ 28123.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26825.87","4.174","€ 48293.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1032.88","7.093","€ 124.29","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8180.39","7.335","€ 5013.47","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":950},{"label":"Mar","value":796},{"label":"Abr","value":877},{"label":"Mai","value":764},{"label":"Jun","value":776},{"label":"Jul","value":761},{"label":"Ago","value":685},{"label":"Set","value":822},{"label":"Out","value":765},{"label":"Nov","value":598},{"label":"Dez","value":765}];
const MX = 950;
