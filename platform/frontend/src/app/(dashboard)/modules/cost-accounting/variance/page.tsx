...
const KPIS = [{"l":"Dashboards Ativos","v":"6.365","t":"+15.3%","d":"up"},{"l":"Queries/Dia","v":"2826","t":"+2.3%","d":"up"},{"l":"Dados Processados (GB)","v":"311","t":"+16.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.812","t":"+2.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4535","2026-03-19","2.348","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1495","2026-01-21","1.379","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","403","2026-02-26","791","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2686","2026-03-05","8.667","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","298","2026-02-19","2.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":907},{"label":"Mar","value":615},{"label":"Abr","value":671},{"label":"Mai","value":865},{"label":"Jun","value":741},{"label":"Jul","value":602},{"label":"Ago","value":675},{"label":"Set","value":568},{"label":"Out","value":680},{"label":"Nov","value":812},{"label":"Dez","value":854}];
const MX = 907;
