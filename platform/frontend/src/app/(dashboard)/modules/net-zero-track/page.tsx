...
export default function NetZeroTrackPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Net Zero Track</h1><p className="text-sm text-muted-foreground">Net Zero Track • iBOS Enterprise</p></div>
