...
const PAGE = "Progress Board";
const KPIS = [{"l":"Teams Ativos","v":"8.325","t":"+14.0%","d":"up"},{"l":"Reuniões/Semana","v":"3815","t":"+12.5%","d":"up"},{"l":"Mensagens/Dia","v":"4345","t":"+11.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"200","t":"+11.1%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.042","2334","8.932","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.340","3029","6.958","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","992","115","7.586","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.795","918","2.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.620","3746","8.126","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":704},{"label":"Mar","value":332},{"label":"Abr","value":471},{"label":"Mai","value":447},{"label":"Jun","value":363},{"label":"Jul","value":430},{"label":"Ago","value":324},{"label":"Set","value":703},{"label":"Out","value":637},{"label":"Nov","value":716},{"label":"Dez","value":362}];
const MX = 716;
