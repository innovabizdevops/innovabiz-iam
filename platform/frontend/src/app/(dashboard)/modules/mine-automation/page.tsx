...
export default function MineAutomationPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mine Automation</h1><p className="text-sm text-muted-foreground">Mine Automation • iBOS Enterprise</p></div>
