...
const ACCENT = "#6366f1";
const MODULE = "Mine Automation";
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"688","t":"+6.4%","d":"up"},{"l":"Viagens/Dia","v":"827","t":"+4.2%","d":"up"},{"l":"Pontualidade (%)","v":"77.6%","t":"+1.7%","d":"up"},{"l":"Passageiros/Dia","v":"647","t":"-1.7%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-10","2026-01-18","628","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-07","2026-03-14","1.177","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-22","2026-01-24","238","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-22","2026-03-22","4.891","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-04","2026-02-05","5.159","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":460},{"label":"Mar","value":667},{"label":"Abr","value":674},{"label":"Mai","value":416},{"label":"Jun","value":347},{"label":"Jul","value":452},{"label":"Ago","value":462},{"label":"Set","value":500},{"label":"Out","value":711},{"label":"Nov","value":642},{"label":"Dez","value":568}];
const MX = 711;
