...
const PAGE = "Budget Cycle";
const KPIS = [{"l":"Total Public Finance","v":"5.734","t":"+15.1%","d":"up"},{"l":"Budget Cycle Ativos","v":"€81248","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"92.9%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.7%","d":"up"}];
const COLS = ["ID","Budget Cycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Finance #001","€ 36381.64","8.709","3.890","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Public Finance #002","€ 8046.61","101","8.260","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Finance #003","€ 40161.30","2.566","4.009","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Public Finance #004","€ 20858.68","6.759","1.007","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Finance #005","€ 22895.41","8.184","4.918","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":794},{"label":"Mar","value":756},{"label":"Abr","value":730},{"label":"Mai","value":800},{"label":"Jun","value":721},{"label":"Jul","value":601},{"label":"Ago","value":542},{"label":"Set","value":585},{"label":"Out","value":750},{"label":"Nov","value":560},{"label":"Dez","value":674}];
const MX = 800;
