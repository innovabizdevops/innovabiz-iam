...
const ACCENT = "#b45309";
const MODULE = "Public Finance";
const PAGE = "CAFR Report";
const KPIS = [{"l":"Total Public Finance","v":"1.438","t":"-1.1%","d":"down"},{"l":"CAFR Report Ativos","v":"475","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"64","t":"+9.7%","d":"up"}];
const COLS = ["ID","CAFR Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Finance #001","Public Finance #002","6.905","4.980","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Public Finance #002","Public Finance #003","1.639","6.909","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Finance #003","Public Finance #004","8.453","4.283","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Public Finance #004","Public Finance #005","790","247","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Finance #005","Public Finance #001","6.121","3.799","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":723},{"label":"Mar","value":762},{"label":"Abr","value":592},{"label":"Mai","value":765},{"label":"Jun","value":436},{"label":"Jul","value":661},{"label":"Ago","value":766},{"label":"Set","value":753},{"label":"Out","value":454},{"label":"Nov","value":463},{"label":"Dez","value":736}];
const MX = 766;
...
export default function CafrPage() {
    return (
