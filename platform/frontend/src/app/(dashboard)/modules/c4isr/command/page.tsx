...
const PAGE = "Command";
const KPIS = [{"l":"Total C4isr","v":"111","t":"+13.9%","d":"up"},{"l":"Command Ativos","v":"260","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"90.3%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"72","t":"-5.1%","d":"down"}];
const COLS = ["ID","Command","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["C4isr #001","C4isr #002","7.682","7.227","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["C4isr #002","C4isr #003","5.436","3.914","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["C4isr #003","C4isr #004","8.426","8.340","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["C4isr #004","C4isr #005","8.039","3.245","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["C4isr #005","C4isr #001","7.375","2.173","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":589},{"label":"Mar","value":644},{"label":"Abr","value":575},{"label":"Mai","value":424},{"label":"Jun","value":595},{"label":"Jul","value":442},{"label":"Ago","value":522},{"label":"Set","value":662},{"label":"Out","value":659},{"label":"Nov","value":794},{"label":"Dez","value":533}];
const MX = 794;
