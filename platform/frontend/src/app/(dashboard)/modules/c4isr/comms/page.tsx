...
const PAGE = "Comms";
const KPIS = [{"l":"Total C4isr","v":"904","t":"+16.2%","d":"up"},{"l":"Comms Ativos","v":"3.517","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"68.2%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"86","t":"+3.9%","d":"up"}];
const COLS = ["ID","Comms","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["C4isr #001","C4isr #002","4.989","4.852","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["C4isr #002","C4isr #003","226","1.857","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["C4isr #003","C4isr #004","7.652","5.362","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["C4isr #004","C4isr #005","1.701","5.374","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["C4isr #005","C4isr #001","4.331","6.024","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":795},{"label":"Mar","value":779},{"label":"Abr","value":762},{"label":"Mai","value":573},{"label":"Jun","value":659},{"label":"Jul","value":764},{"label":"Ago","value":822},{"label":"Set","value":835},{"label":"Out","value":886},{"label":"Nov","value":677},{"label":"Dez","value":598}];
const MX = 886;
