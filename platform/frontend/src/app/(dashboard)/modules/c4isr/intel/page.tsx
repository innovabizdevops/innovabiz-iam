...
const ACCENT = "#6366f1";
const MODULE = "C4ISR Systems";
const PAGE = "Intel";
const KPIS = [{"l":"Total C4isr","v":"3.828","t":"+16.2%","d":"up"},{"l":"Intel Ativos","v":"2.983","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"77","t":"-5.8%","d":"down"}];
const COLS = ["ID","Intel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["C4isr #001","C4isr #002","8.503","7.346","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["C4isr #002","C4isr #003","8.061","8.818","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["C4isr #003","C4isr #004","3.622","3.070","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["C4isr #004","C4isr #005","8.363","7.438","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["C4isr #005","C4isr #001","3.235","5.520","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":782},{"label":"Mar","value":928},{"label":"Abr","value":741},{"label":"Mai","value":783},{"label":"Jun","value":963},{"label":"Jul","value":655},{"label":"Ago","value":981},{"label":"Set","value":955},{"label":"Out","value":987},{"label":"Nov","value":966},{"label":"Dez","value":625}];
const MX = 987;
