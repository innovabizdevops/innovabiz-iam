...
const PAGE = "Control";
const KPIS = [{"l":"Total C4isr","v":"8.388","t":"-2.5%","d":"down"},{"l":"Control Ativos","v":"4.108","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"76.2%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"95","t":"+16.2%","d":"up"}];
const COLS = ["ID","Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["C4isr #001","C4isr #002","8.238","223","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["C4isr #002","C4isr #003","2.653","2.299","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["C4isr #003","C4isr #004","7.461","2.911","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["C4isr #004","C4isr #005","4.500","4.121","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["C4isr #005","C4isr #001","880","4.678","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":641},{"label":"Mar","value":613},{"label":"Abr","value":561},{"label":"Mai","value":428},{"label":"Jun","value":581},{"label":"Jul","value":442},{"label":"Ago","value":394},{"label":"Set","value":615},{"label":"Out","value":604},{"label":"Nov","value":572},{"label":"Dez","value":674}];
const MX = 686;
