...
const PAGE = "Recon";
const KPIS = [{"l":"Total C4isr","v":"6.130","t":"+11.7%","d":"up"},{"l":"Recon Ativos","v":"3.323","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"65.3%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"86","t":"+6.0%","d":"up"}];
const COLS = ["ID","Recon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["C4isr #001","C4isr #002","7.344","4.141","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["C4isr #002","C4isr #003","8.811","6.049","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["C4isr #003","C4isr #004","1.630","5.275","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["C4isr #004","C4isr #005","8.696","4.694","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["C4isr #005","C4isr #001","3.946","7.453","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":816},{"label":"Mar","value":529},{"label":"Abr","value":875},{"label":"Mai","value":645},{"label":"Jun","value":711},{"label":"Jul","value":750},{"label":"Ago","value":567},{"label":"Set","value":576},{"label":"Out","value":788},{"label":"Nov","value":698},{"label":"Dez","value":603}];
const MX = 890;
