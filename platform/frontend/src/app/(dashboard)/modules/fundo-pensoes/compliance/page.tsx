...
const PAGE = "Compliance ISP";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.441","t":"+13.6%","d":"up"},{"l":"NC Abertas","v":"4.061","t":"+17.4%","d":"up"},{"l":"Conformidade (%)","v":"73.2%","t":"-5.5%","d":"down"},{"l":"CAPAs Pendentes","v":"127","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.680","88.9%","140","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.701","91.3%","937","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.428","71.1%","8.234","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.576","98.4%","3.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.500","70.6%","206","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":643},{"label":"Mar","value":725},{"label":"Abr","value":467},{"label":"Mai","value":554},{"label":"Jun","value":461},{"label":"Jul","value":706},{"label":"Ago","value":795},{"label":"Set","value":455},{"label":"Out","value":506},{"label":"Nov","value":680},{"label":"Dez","value":667}];
const MX = 795;
