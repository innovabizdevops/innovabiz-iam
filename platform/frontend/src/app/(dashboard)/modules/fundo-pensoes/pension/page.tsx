...
const PAGE = "Reforma/Pensão";
const KPIS = [{"l":"Formulários Ativos","v":"8.239","t":"-2.1%","d":"down"},{"l":"Submissões/Dia","v":"2054","t":"-3.3%","d":"down"},{"l":"Documentos Gerados","v":"8.691","t":"+9.1%","d":"up"},{"l":"Templates","v":"228","t":"+13.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.814","2026-03-08","8.952","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.438","2026-02-04","7.110","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.331","2026-01-22","4.125","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.577","2026-02-10","1.495","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.879","2026-02-15","1.812","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":718},{"label":"Mar","value":782},{"label":"Abr","value":511},{"label":"Mai","value":829},{"label":"Jun","value":458},{"label":"Jul","value":811},{"label":"Ago","value":656},{"label":"Set","value":553},{"label":"Out","value":676},{"label":"Nov","value":547},{"label":"Dez","value":525}];
const MX = 829;
