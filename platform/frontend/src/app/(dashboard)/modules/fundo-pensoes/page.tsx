...
export default function FundoPensoesPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Fundo Pensoes</h1><p className="text-sm text-muted-foreground">Fundo Pensoes • iBOS Enterprise</p></div>
