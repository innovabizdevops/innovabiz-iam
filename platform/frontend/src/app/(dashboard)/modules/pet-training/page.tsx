...
const KPIS = [
    { label: "Total Registos", value: "661", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4533", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€269K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2123431761", cells: ["PET-8761", "Pet Training Item 1", "18/10/2026", "€31 861"], status: "active" as const },
    { id: "2123435332", cells: ["PET-3332", "Pet Training Item 2", "5/5/2026", "€35 432"], status: "pending" as const },
    { id: "2123438903", cells: ["PET-6903", "Pet Training Item 3", "20/12/2026", "€39 003"], status: "completed" as const },
    { id: "2123442474", cells: ["PET-1474", "Pet Training Item 4", "7/7/2026", "€42 574"], status: "warning" as const },
    { id: "2123446045", cells: ["PET-5045", "Pet Training Item 5", "22/2/2026", "€46 145"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Training</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Training</p>
                    </div>
                </div>
