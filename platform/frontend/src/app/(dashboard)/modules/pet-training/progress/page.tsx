...
const ACCENT = "#ea580c";
const MODULE = "Pet Training";
const PAGE = "Progress";
const KPIS = [{"l":"Total Pet Training","v":"2.117","t":"+6.6%","d":"up"},{"l":"Progress Ativos","v":"6.543","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"82.3%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+9.1%","d":"up"}];
const COLS = ["ID","Progress","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Training #001","Pet Training #002","4.825","7.719","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Training #002","Pet Training #003","4.220","8.368","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Training #003","Pet Training #004","2.861","3.571","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Training #004","Pet Training #005","4.937","2.199","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Training #005","Pet Training #001","5.471","3.182","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":528},{"label":"Mar","value":506},{"label":"Abr","value":400},{"label":"Mai","value":666},{"label":"Jun","value":440},{"label":"Jul","value":487},{"label":"Ago","value":504},{"label":"Set","value":702},{"label":"Out","value":502},{"label":"Nov","value":577},{"label":"Dez","value":364}];
const MX = 702;
