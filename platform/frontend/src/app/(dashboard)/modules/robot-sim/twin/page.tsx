...
const ACCENT = "#6366f1";
const MODULE = "Robot Simulation";
const PAGE = "Digital Twin";
const KPIS = [{"l":"Twins Ativos","v":"4.770","t":"+11.5%","d":"up"},{"l":"Simulações/Dia","v":"2738","t":"+9.1%","d":"up"},{"l":"Precisão Modelo (%)","v":"68.2%","t":"+0.9%","d":"up"},{"l":"Latência Sync (ms)","v":"86ms","t":"+8.9%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","89.3%","2026-03-28","1.709","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.7%","2026-01-01","8.838","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.9%","2026-02-20","8.251","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","79.9%","2026-02-11","2.098","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","84.5%","2026-02-18","7.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":399},{"label":"Mar","value":446},{"label":"Abr","value":365},{"label":"Mai","value":712},{"label":"Jun","value":375},{"label":"Jul","value":669},{"label":"Ago","value":379},{"label":"Set","value":453},{"label":"Out","value":382},{"label":"Nov","value":702},{"label":"Dez","value":739}];
const MX = 739;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>DT</span></h1>
                </div>
