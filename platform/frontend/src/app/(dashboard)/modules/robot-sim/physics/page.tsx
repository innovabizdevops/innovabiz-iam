...
const PAGE = "Physics";
const KPIS = [{"l":"Total Robot Sim","v":"1.283","t":"+10.6%","d":"up"},{"l":"Physics Ativos","v":"6.783","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"71.9%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"78","t":"+12.6%","d":"up"}];
const COLS = ["ID","Physics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Robot Sim #001","Robot Sim #002","297","1.803","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Robot Sim #002","Robot Sim #003","7.857","2.661","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Robot Sim #003","Robot Sim #004","1.987","1.793","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Robot Sim #004","Robot Sim #005","6.603","843","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Robot Sim #005","Robot Sim #001","3.553","7.743","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":554},{"label":"Mar","value":435},{"label":"Abr","value":497},{"label":"Mai","value":517},{"label":"Jun","value":804},{"label":"Jul","value":558},{"label":"Ago","value":611},{"label":"Set","value":563},{"label":"Out","value":479},{"label":"Nov","value":656},{"label":"Dez","value":663}];
const MX = 804;
