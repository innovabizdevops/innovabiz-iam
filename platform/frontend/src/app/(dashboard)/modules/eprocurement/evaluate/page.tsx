...
const PAGE = "Bid Evaluate";
const KPIS = [{"l":"Fornecedores Ativos","v":"8.886","t":"+0.6%","d":"up"},{"l":"Contratos (€M)","v":"€14.4M","t":"+14.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"69.4%","t":"+14.9%","d":"up"},{"l":"Score Médio","v":"70","t":"+15.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","88.2%","€ 47533.81","3.861","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","96.4%","€ 29613.40","3.051","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","95.8%","€ 22395.34","822","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","91.4%","€ 40579.95","4.006","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","75.1%","€ 28238.00","8.889","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":696},{"label":"Mar","value":997},{"label":"Abr","value":956},{"label":"Mai","value":957},{"label":"Jun","value":709},{"label":"Jul","value":878},{"label":"Ago","value":639},{"label":"Set","value":944},{"label":"Out","value":620},{"label":"Nov","value":786},{"label":"Dez","value":926}];
const MX = 997;
