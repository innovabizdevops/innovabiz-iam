...
const PAGE = "Vendor Registry";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.858","t":"-2.3%","d":"down"},{"l":"Contratos (€M)","v":"€40.0M","t":"+13.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"80.8%","t":"+18.0%","d":"up"},{"l":"Score Médio","v":"90","t":"+14.4%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","97.4%","€ 47924.03","2.308","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","88.8%","€ 22829.12","4.522","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","70.4%","€ 5774.61","3.682","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","98.0%","€ 44528.49","7.497","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","86.1%","€ 49050.93","5.367","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":301},{"label":"Fev","value":649},{"label":"Mar","value":513},{"label":"Abr","value":539},{"label":"Mai","value":309},{"label":"Jun","value":339},{"label":"Jul","value":583},{"label":"Ago","value":460},{"label":"Set","value":646},{"label":"Out","value":443},{"label":"Nov","value":656},{"label":"Dez","value":594}];
const MX = 656;
