...
const ACCENT = "#7c3aed";
const MODULE = "E-Procurement";
const PAGE = "Contract Mgmt";
const KPIS = [{"l":"Contratos Ativos","v":"2.190","t":"+17.7%","d":"up"},{"l":"Valor Total (€M)","v":"€15.7M","t":"+9.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.615","t":"+9.4%","d":"up"},{"l":"Obrigações Pendentes","v":"2.299","t":"+7.3%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 14867.29","2026-01-03","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 41101.56","2026-01-12","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 38603.12","2026-03-25","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 14347.37","2026-01-09","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 14111.20","2026-03-09","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1076},{"label":"Fev","value":894},{"label":"Mar","value":953},{"label":"Abr","value":1044},{"label":"Mai","value":959},{"label":"Jun","value":748},{"label":"Jul","value":699},{"label":"Ago","value":835},{"label":"Set","value":862},{"label":"Out","value":915},{"label":"Nov","value":1071},{"label":"Dez","value":725}];
const MX = 1076;
