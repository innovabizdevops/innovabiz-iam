...
const PAGE = "Tender Publish";
const KPIS = [{"l":"Fornecedores Ativos","v":"5.524","t":"-3.2%","d":"down"},{"l":"Contratos (€M)","v":"€14.9M","t":"-2.0%","d":"down"},{"l":"On-Time Delivery (%)","v":"92.2%","t":"-2.9%","d":"down"},{"l":"Score Médio","v":"79","t":"+17.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","75.2%","€ 6777.87","6.589","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","89.1%","€ 38182.66","3.245","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.4%","€ 25035.65","1.290","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","78.2%","€ 27200.36","7.706","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","71.1%","€ 5884.77","5.070","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":618},{"label":"Mar","value":888},{"label":"Abr","value":526},{"label":"Mai","value":896},{"label":"Jun","value":802},{"label":"Jul","value":517},{"label":"Ago","value":667},{"label":"Set","value":815},{"label":"Out","value":821},{"label":"Nov","value":595},{"label":"Dez","value":792}];
const MX = 896;
