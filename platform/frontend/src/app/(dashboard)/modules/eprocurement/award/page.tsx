...
const KPIS = [{"l":"Fornecedores Ativos","v":"1.845","t":"+15.4%","d":"up"},{"l":"Contratos (€M)","v":"€1.2M","t":"+15.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"94.1%","t":"+15.7%","d":"up"},{"l":"Score Médio","v":"77","t":"+9.8%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","88.3%","€ 31241.93","6.560","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","88.5%","€ 15860.54","3.006","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","74.1%","€ 26236.79","9.055","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","97.1%","€ 10372.34","8.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","98.0%","€ 49542.07","6.801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":528},{"label":"Mar","value":433},{"label":"Abr","value":439},{"label":"Mai","value":356},{"label":"Jun","value":303},{"label":"Jul","value":347},{"label":"Ago","value":643},{"label":"Set","value":456},{"label":"Out","value":367},{"label":"Nov","value":425},{"label":"Dez","value":472}];
const MX = 643;
