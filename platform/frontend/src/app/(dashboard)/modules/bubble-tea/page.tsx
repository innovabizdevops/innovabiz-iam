...
/* ═══ Bubble Tea Chain — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "9854", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2917", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€399K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "842262154", cells: ["BUB-7154", "Bubble Tea Chain Item 1", "7/11/2026", "€12 254"], status: "active" as const },
    { id: "842265725", cells: ["BUB-1725", "Bubble Tea Chain Item 2", "22/6/2026", "€15 825"], status: "pending" as const },
    { id: "842269296", cells: ["BUB-5296", "Bubble Tea Chain Item 3", "9/1/2026", "€19 396"], status: "completed" as const },
    { id: "842272867", cells: ["BUB-8867", "Bubble Tea Chain Item 4", "24/8/2026", "€22 967"], status: "warning" as const },
    { id: "842276438", cells: ["BUB-3438", "Bubble Tea Chain Item 5", "11/3/2026", "€26 538"], status: "active" as const },
];
...
export default function BubbleTeaChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bubble Tea Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Bubble Tea Chain</p>
                    </div>
                </div>
