...
const PAGE = "Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"182","t":"+7.4%","d":"up"},{"l":"RevPAR (€)","v":"€39689","t":"+0.0%","d":"up"},{"l":"Ocupação (%)","v":"71.4%","t":"+11.9%","d":"up"},{"l":"Guest Satisfaction","v":"7.110","t":"+13.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.114","2026-03-08","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.310","2026-01-18","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.846","2026-02-22","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.097","2026-02-04","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.507","2026-01-25","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":705},{"label":"Mar","value":707},{"label":"Abr","value":916},{"label":"Mai","value":603},{"label":"Jun","value":557},{"label":"Jul","value":638},{"label":"Ago","value":761},{"label":"Set","value":650},{"label":"Out","value":531},{"label":"Nov","value":783},{"label":"Dez","value":837}];
const MX = 916;
