...
const ACCENT = "#7c3aed";
const MODULE = "Bubble Tea Chain";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.768","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"2411","t":"+17.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.192","t":"+8.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.641","t":"+15.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1724","2026-01-26","7.940","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4522","2026-01-10","3.330","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4656","2026-03-10","5.424","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","697","2026-01-10","4.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1808","2026-03-02","8.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":870},{"label":"Mar","value":730},{"label":"Abr","value":727},{"label":"Mai","value":678},{"label":"Jun","value":827},{"label":"Jul","value":690},{"label":"Ago","value":847},{"label":"Set","value":519},{"label":"Out","value":591},{"label":"Nov","value":718},{"label":"Dez","value":604}];
const MX = 870;
