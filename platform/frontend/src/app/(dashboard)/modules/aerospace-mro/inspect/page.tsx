...
const ACCENT = "#1e3a5f";
const MODULE = "Aerospace MRO Platform";
const PAGE = "Inspect";
const KPIS = [{"l":"Quartos Ocupados","v":"4.529","t":"+15.1%","d":"up"},{"l":"RevPAR (€)","v":"€20896","t":"-1.6%","d":"down"},{"l":"Ocupação (%)","v":"84.0%","t":"-4.1%","d":"down"},{"l":"Guest Satisfaction","v":"8.799","t":"+3.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.323","2026-03-07","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","9.060","2026-01-19","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.394","2026-02-15","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.282","2026-01-27","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.991","2026-01-03","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":487},{"label":"Mar","value":830},{"label":"Abr","value":856},{"label":"Mai","value":788},{"label":"Jun","value":624},{"label":"Jul","value":522},{"label":"Ago","value":762},{"label":"Set","value":547},{"label":"Out","value":743},{"label":"Nov","value":645},{"label":"Dez","value":546}];
const MX = 856;
