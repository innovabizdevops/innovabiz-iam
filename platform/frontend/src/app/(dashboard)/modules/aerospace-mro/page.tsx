...
/* ═══ Aerospace MRO Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "5645", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "63", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€114K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1165750345", cells: ["AER-8345", "Aerospace MRO Platform Item 1", "26/2/2026", "€445"], status: "active" as const },
    { id: "1165753916", cells: ["AER-2916", "Aerospace MRO Platform Item 2", "13/9/2026", "€4016"], status: "pending" as const },
    { id: "1165757487", cells: ["AER-6487", "Aerospace MRO Platform Item 3", "28/4/2026", "€7587"], status: "completed" as const },
    { id: "1165761058", cells: ["AER-1058", "Aerospace MRO Platform Item 4", "15/11/2026", "€11 158"], status: "warning" as const },
    { id: "1165764629", cells: ["AER-4629", "Aerospace MRO Platform Item 5", "2/6/2026", "€14 729"], status: "active" as const },
];
...
export default function AerospaceMroPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aerospace MRO Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Aerospace MRO Platform</p>
                    </div>
                </div>
