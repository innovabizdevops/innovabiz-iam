...
const PAGE = "Resource";
const KPIS = [{"l":"Total Consulting Mgmt","v":"2.734","t":"+10.6%","d":"up"},{"l":"Resource Ativos","v":"572","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"58","t":"+7.2%","d":"up"}];
const COLS = ["ID","Resource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consulting Mgmt #001","Consulting Mgmt #002","6.361","8.853","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Consulting Mgmt #002","Consulting Mgmt #003","2.052","956","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Consulting Mgmt #003","Consulting Mgmt #004","5.148","4.561","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Consulting Mgmt #004","Consulting Mgmt #005","2.133","8.555","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consulting Mgmt #005","Consulting Mgmt #001","5.750","5.191","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":798},{"label":"Mar","value":618},{"label":"Abr","value":491},{"label":"Mai","value":747},{"label":"Jun","value":509},{"label":"Jul","value":518},{"label":"Ago","value":610},{"label":"Set","value":680},{"label":"Out","value":596},{"label":"Nov","value":734},{"label":"Dez","value":718}];
const MX = 846;
