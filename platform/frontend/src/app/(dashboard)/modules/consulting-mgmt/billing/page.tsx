...
const PAGE = "Billing";
const KPIS = [{"l":"Total Consulting Mgmt","v":"7.326","t":"+11.7%","d":"up"},{"l":"Billing Ativos","v":"5.616","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"67","t":"+11.2%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consulting Mgmt #001","Consulting Mgmt #002","3.742","309","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Consulting Mgmt #002","Consulting Mgmt #003","3.031","8.838","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Consulting Mgmt #003","Consulting Mgmt #004","8.255","4.001","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Consulting Mgmt #004","Consulting Mgmt #005","856","6.539","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consulting Mgmt #005","Consulting Mgmt #001","6.561","3.159","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":558},{"label":"Mar","value":556},{"label":"Abr","value":343},{"label":"Mai","value":605},{"label":"Jun","value":548},{"label":"Jul","value":610},{"label":"Ago","value":629},{"label":"Set","value":333},{"label":"Out","value":540},{"label":"Nov","value":504},{"label":"Dez","value":533}];
const MX = 629;
