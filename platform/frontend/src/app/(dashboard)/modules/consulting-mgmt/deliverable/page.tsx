...
const ACCENT = "#6366f1";
const MODULE = "Consulting Firm";
const PAGE = "Deliverable";
const KPIS = [{"l":"Total Consulting Mgmt","v":"4.501","t":"+14.3%","d":"up"},{"l":"Deliverable Ativos","v":"6.500","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"88.8%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"80","t":"+17.9%","d":"up"}];
const COLS = ["ID","Deliverable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consulting Mgmt #001","Consulting Mgmt #002","3.621","8.615","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Consulting Mgmt #002","Consulting Mgmt #003","4.509","8.227","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Consulting Mgmt #003","Consulting Mgmt #004","2.248","2.299","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Consulting Mgmt #004","Consulting Mgmt #005","6.451","5.060","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consulting Mgmt #005","Consulting Mgmt #001","4.542","8.144","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":649},{"label":"Mar","value":526},{"label":"Abr","value":438},{"label":"Mai","value":558},{"label":"Jun","value":572},{"label":"Jul","value":607},{"label":"Ago","value":337},{"label":"Set","value":336},{"label":"Out","value":420},{"label":"Nov","value":639},{"label":"Dez","value":323}];
const MX = 649;
