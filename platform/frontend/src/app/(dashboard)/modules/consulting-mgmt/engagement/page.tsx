...
const KPIS = [{"l":"eNPS","v":"74","t":"-1.9%","d":"down"},{"l":"Engagement (%)","v":"85.0%","t":"-1.9%","d":"down"},{"l":"Turnover (%)","v":"88.1%","t":"-3.3%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"8.036","t":"+2.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.989","2026-03-08","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.320","2026-01-01","87","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.633","2026-02-15","60","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.231","2026-02-15","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.217","2026-01-09","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":564},{"label":"Mar","value":470},{"label":"Abr","value":281},{"label":"Mai","value":300},{"label":"Jun","value":416},{"label":"Jul","value":262},{"label":"Ago","value":286},{"label":"Set","value":593},{"label":"Out","value":412},{"label":"Nov","value":455},{"label":"Dez","value":601}];
const MX = 601;
