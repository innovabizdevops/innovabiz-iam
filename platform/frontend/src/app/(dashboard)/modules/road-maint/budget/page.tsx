...
const PAGE = "Budget";
const KPIS = [{"l":"Total Road Maint","v":"4.634","t":"-0.3%","d":"down"},{"l":"Budget Ativos","v":"€62199","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"93.2%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+16.3%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Road Maint #001","€ 31787.51","5.100","4.845","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Road Maint #002","€ 27366.86","7.039","5.063","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Road Maint #003","€ 8548.88","8.884","7.725","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Road Maint #004","€ 24167.63","7.115","5.053","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Road Maint #005","€ 31850.03","708","3.262","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":649},{"label":"Mar","value":357},{"label":"Abr","value":381},{"label":"Mai","value":639},{"label":"Jun","value":384},{"label":"Jul","value":358},{"label":"Ago","value":569},{"label":"Set","value":610},{"label":"Out","value":665},{"label":"Nov","value":514},{"label":"Dez","value":598}];
const MX = 677;
