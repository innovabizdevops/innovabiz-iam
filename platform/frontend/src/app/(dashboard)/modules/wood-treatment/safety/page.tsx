...
const ACCENT = "#166534";
const MODULE = "Wood Treatment";
const PAGE = "Safety";
const KPIS = [{"l":"Total Wood Treatment","v":"7.243","t":"+6.5%","d":"up"},{"l":"Safety Ativos","v":"4.115","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"72.0%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"70","t":"+2.1%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wood Treatment #001","Wood Treatment #002","3.669","7.997","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Wood Treatment #002","Wood Treatment #003","2.579","3.071","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Wood Treatment #003","Wood Treatment #004","4.795","8.841","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Wood Treatment #004","Wood Treatment #005","5.938","912","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wood Treatment #005","Wood Treatment #001","7.019","5.713","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":729},{"label":"Mar","value":688},{"label":"Abr","value":665},{"label":"Mai","value":621},{"label":"Jun","value":604},{"label":"Jul","value":741},{"label":"Ago","value":664},{"label":"Set","value":742},{"label":"Out","value":920},{"label":"Nov","value":606},{"label":"Dez","value":669}];
const MX = 920;
