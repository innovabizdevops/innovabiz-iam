...
const PAGE = "Pressure";
const KPIS = [{"l":"Total Wood Treatment","v":"1.792","t":"+2.1%","d":"up"},{"l":"Pressure Ativos","v":"6.103","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"68","t":"-0.1%","d":"down"}];
const COLS = ["ID","Pressure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wood Treatment #001","Wood Treatment #002","2.988","7.190","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Wood Treatment #002","Wood Treatment #003","4.285","5.716","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Wood Treatment #003","Wood Treatment #004","6.153","1.692","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Wood Treatment #004","Wood Treatment #005","6.586","3.442","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wood Treatment #005","Wood Treatment #001","8.071","5.965","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":672},{"label":"Mar","value":665},{"label":"Abr","value":725},{"label":"Mai","value":655},{"label":"Jun","value":798},{"label":"Jul","value":774},{"label":"Ago","value":651},{"label":"Set","value":878},{"label":"Out","value":854},{"label":"Nov","value":906},{"label":"Dez","value":896}];
const MX = 906;
