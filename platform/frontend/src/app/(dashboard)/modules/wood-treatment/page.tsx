...
/* ═══ Wood Treatment — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1135", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3135", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€64K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "960924735", cells: ["WOO-4735", "Wood Treatment Item 1", "16/4/2026", "€24 835"], status: "active" as const },
    { id: "960928306", cells: ["WOO-8306", "Wood Treatment Item 2", "3/11/2026", "€28 406"], status: "pending" as const },
    { id: "960931877", cells: ["WOO-2877", "Wood Treatment Item 3", "18/6/2026", "€31 977"], status: "completed" as const },
    { id: "960935448", cells: ["WOO-6448", "Wood Treatment Item 4", "5/1/2026", "€35 548"], status: "warning" as const },
    { id: "960939019", cells: ["WOO-1019", "Wood Treatment Item 5", "20/8/2026", "€39 119"], status: "active" as const },
];
...
export default function WoodTreatmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wood Treatment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wood Treatment</p>
                    </div>
                </div>
