...
const PAGE = "Thermal";
const KPIS = [{"l":"Riscos Identificados","v":"3.335","t":"-4.2%","d":"down"},{"l":"Mitigações Ativas","v":"5.681","t":"+17.9%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"-4.8%","d":"down"},{"l":"Incidentes YTD","v":"987","t":"-3.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.281","2.363","8.585","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.009","5.589","8.907","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.885","7.168","1.399","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.379","5.502","7.628","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.429","4.828","7.143","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":638},{"label":"Mar","value":436},{"label":"Abr","value":600},{"label":"Mai","value":720},{"label":"Jun","value":578},{"label":"Jul","value":459},{"label":"Ago","value":489},{"label":"Set","value":527},{"label":"Out","value":648},{"label":"Nov","value":496},{"label":"Dez","value":468}];
const MX = 720;
