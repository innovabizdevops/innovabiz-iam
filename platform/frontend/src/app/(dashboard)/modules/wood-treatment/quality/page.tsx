...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.939","t":"+2.2%","d":"up"},{"l":"NC Abertas","v":"286","t":"+3.4%","d":"up"},{"l":"Conformidade (%)","v":"92.0%","t":"+15.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.943","t":"+3.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.148","86.2%","2.399","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.526","81.6%","6.567","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","290","98.3%","3.608","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.216","86.1%","3.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.445","97.3%","5.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":283},{"label":"Fev","value":610},{"label":"Mar","value":363},{"label":"Abr","value":607},{"label":"Mai","value":470},{"label":"Jun","value":260},{"label":"Jul","value":544},{"label":"Ago","value":488},{"label":"Set","value":459},{"label":"Out","value":345},{"label":"Nov","value":369},{"label":"Dez","value":535}];
const MX = 610;
