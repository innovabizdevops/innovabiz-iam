...
const PAGE = "Chemical";
const KPIS = [{"l":"Total Wood Treatment","v":"8.937","t":"+5.6%","d":"up"},{"l":"Chemical Ativos","v":"7.168","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"61","t":"+0.4%","d":"up"}];
const COLS = ["ID","Chemical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wood Treatment #001","Wood Treatment #002","4.381","6.093","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Wood Treatment #002","Wood Treatment #003","7.674","6.895","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Wood Treatment #003","Wood Treatment #004","3.424","5.029","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Wood Treatment #004","Wood Treatment #005","3.210","4.704","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wood Treatment #005","Wood Treatment #001","7.392","6.675","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":848},{"label":"Mar","value":708},{"label":"Abr","value":703},{"label":"Mai","value":667},{"label":"Jun","value":1029},{"label":"Jul","value":671},{"label":"Ago","value":845},{"label":"Set","value":739},{"label":"Out","value":713},{"label":"Nov","value":696},{"label":"Dez","value":865}];
const MX = 1029;
