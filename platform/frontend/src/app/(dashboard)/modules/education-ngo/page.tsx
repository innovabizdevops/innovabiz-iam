...
/* ═══ Education NGO Platform — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "6780", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1776", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€125K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1459939880", cells: ["EDU-5880", "Education NGO Platform Item 1", "1/9/2026", "€39 980"], status: "active" as const },
    { id: "1459943451", cells: ["EDU-9451", "Education NGO Platform Item 2", "16/4/2026", "€43 551"], status: "pending" as const },
    { id: "1459947022", cells: ["EDU-4022", "Education NGO Platform Item 3", "3/11/2026", "€47 122"], status: "completed" as const },
    { id: "1459950593", cells: ["EDU-7593", "Education NGO Platform Item 4", "18/6/2026", "€693"], status: "warning" as const },
    { id: "1459954164", cells: ["EDU-2164", "Education NGO Platform Item 5", "5/1/2026", "€4264"], status: "active" as const },
];
...
export default function EducationNgoPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Education NGO Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Education NGO Platform</p>
                    </div>
                </div>
