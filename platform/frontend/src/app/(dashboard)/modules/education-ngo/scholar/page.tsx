...
const ACCENT = "#9333ea";
const MODULE = "Education NGO Platform";
const PAGE = "Scholar";
const KPIS = [{"l":"Total Education Ngo","v":"7.393","t":"+3.5%","d":"up"},{"l":"Scholar Ativos","v":"3.189","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"88.0%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"85","t":"-4.6%","d":"down"}];
const COLS = ["ID","Scholar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Ngo #001","Education Ngo #002","3.018","7.912","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Education Ngo #002","Education Ngo #003","7.703","5.297","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Ngo #003","Education Ngo #004","3.111","2.346","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Education Ngo #004","Education Ngo #005","316","3.521","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Ngo #005","Education Ngo #001","7.322","4.436","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":979},{"label":"Mar","value":802},{"label":"Abr","value":1039},{"label":"Mai","value":1049},{"label":"Jun","value":818},{"label":"Jul","value":821},{"label":"Ago","value":1020},{"label":"Set","value":820},{"label":"Out","value":796},{"label":"Nov","value":1005},{"label":"Dez","value":789}];
const MX = 1049;
