...
const PAGE = "Outcome";
const KPIS = [{"l":"Total Education Ngo","v":"8.605","t":"+16.1%","d":"up"},{"l":"Outcome Ativos","v":"7.012","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"93","t":"+2.4%","d":"up"}];
const COLS = ["ID","Outcome","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Ngo #001","Education Ngo #002","395","6.012","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Education Ngo #002","Education Ngo #003","2.257","3.329","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Ngo #003","Education Ngo #004","5.106","4.355","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Education Ngo #004","Education Ngo #005","2.780","1.021","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Ngo #005","Education Ngo #001","1.732","2.485","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":313},{"label":"Fev","value":507},{"label":"Mar","value":530},{"label":"Abr","value":243},{"label":"Mai","value":283},{"label":"Jun","value":333},{"label":"Jul","value":596},{"label":"Ago","value":326},{"label":"Set","value":352},{"label":"Out","value":558},{"label":"Nov","value":340},{"label":"Dez","value":298}];
const MX = 596;
