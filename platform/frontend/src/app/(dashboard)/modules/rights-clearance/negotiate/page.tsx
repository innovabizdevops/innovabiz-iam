...
const ACCENT = "#6366f1";
const MODULE = "Rights Clearance";
const PAGE = "Negotiate";
const KPIS = [{"l":"Total Rights Clearance","v":"7.656","t":"+10.0%","d":"up"},{"l":"Negotiate Ativos","v":"1.547","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"87","t":"-1.6%","d":"down"}];
const COLS = ["ID","Negotiate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rights Clearance #001","Rights Clearance #002","7.738","8.832","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Rights Clearance #002","Rights Clearance #003","3.236","387","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Rights Clearance #003","Rights Clearance #004","8.987","2.587","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Rights Clearance #004","Rights Clearance #005","7.664","5.304","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rights Clearance #005","Rights Clearance #001","7.311","8.965","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":534},{"label":"Mar","value":532},{"label":"Abr","value":689},{"label":"Mai","value":518},{"label":"Jun","value":800},{"label":"Jul","value":545},{"label":"Ago","value":707},{"label":"Set","value":747},{"label":"Out","value":814},{"label":"Nov","value":757},{"label":"Dez","value":806}];
const MX = 814;
