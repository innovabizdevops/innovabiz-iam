...
const PAGE = "License";
const KPIS = [{"l":"Total Rights Clearance","v":"6.966","t":"+12.8%","d":"up"},{"l":"License Ativos","v":"3.792","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"70","t":"+9.9%","d":"up"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rights Clearance #001","Rights Clearance #002","8.418","7.838","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Rights Clearance #002","Rights Clearance #003","8.597","7.046","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Rights Clearance #003","Rights Clearance #004","701","3.809","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Rights Clearance #004","Rights Clearance #005","788","4.154","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rights Clearance #005","Rights Clearance #001","7.129","880","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":794},{"label":"Mar","value":516},{"label":"Abr","value":861},{"label":"Mai","value":832},{"label":"Jun","value":676},{"label":"Jul","value":775},{"label":"Ago","value":856},{"label":"Set","value":697},{"label":"Out","value":545},{"label":"Nov","value":620},{"label":"Dez","value":714}];
const MX = 861;
