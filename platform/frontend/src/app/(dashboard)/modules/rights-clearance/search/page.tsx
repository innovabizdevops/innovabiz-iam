...
const PAGE = "Search";
const KPIS = [{"l":"Total Rights Clearance","v":"1.450","t":"+5.8%","d":"up"},{"l":"Search Ativos","v":"8.025","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"86","t":"-0.4%","d":"down"}];
const COLS = ["ID","Search","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rights Clearance #001","Rights Clearance #002","373","3.896","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Rights Clearance #002","Rights Clearance #003","3.338","2.219","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Rights Clearance #003","Rights Clearance #004","7.433","4.068","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Rights Clearance #004","Rights Clearance #005","3.879","6.069","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rights Clearance #005","Rights Clearance #001","4.744","6.056","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":804},{"label":"Mar","value":1001},{"label":"Abr","value":932},{"label":"Mai","value":781},{"label":"Jun","value":861},{"label":"Jul","value":876},{"label":"Ago","value":848},{"label":"Set","value":916},{"label":"Out","value":933},{"label":"Nov","value":656},{"label":"Dez","value":863}];
const MX = 1001;
