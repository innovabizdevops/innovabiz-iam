...
const PAGE = "Privacy";
const KPIS = [{"l":"Teams Ativos","v":"9.022","t":"-1.7%","d":"down"},{"l":"Reuniões/Semana","v":"3803","t":"+2.4%","d":"up"},{"l":"Mensagens/Dia","v":"170","t":"+6.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.272","t":"+4.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.041","4505","8.600","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.637","2967","3.024","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.922","5097","4.425","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.967","1731","6.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.582","233","734","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":286},{"label":"Mar","value":387},{"label":"Abr","value":316},{"label":"Mai","value":602},{"label":"Jun","value":330},{"label":"Jul","value":309},{"label":"Ago","value":406},{"label":"Set","value":604},{"label":"Out","value":622},{"label":"Nov","value":366},{"label":"Dez","value":451}];
const MX = 622;
