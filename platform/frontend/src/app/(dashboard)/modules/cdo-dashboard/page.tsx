...
/* ═══ CDO Data Dashboard — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "8052", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1248", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€286K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1849951652", cells: ["CDO-2652", "CDO Data Dashboard Item 1", "25/9/2026", "€1752"], status: "active" as const },
    { id: "1849955223", cells: ["CDO-6223", "CDO Data Dashboard Item 2", "12/4/2026", "€5323"], status: "pending" as const },
    { id: "1849958794", cells: ["CDO-9794", "CDO Data Dashboard Item 3", "27/11/2026", "€8894"], status: "completed" as const },
    { id: "1849962365", cells: ["CDO-4365", "CDO Data Dashboard Item 4", "14/6/2026", "€12 465"], status: "warning" as const },
    { id: "1849965936", cells: ["CDO-7936", "CDO Data Dashboard Item 5", "1/1/2026", "€16 036"], status: "active" as const },
];
...
export default function CdoDataDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CDO Data Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CDO Data Dashboard</p>
                    </div>
                </div>
