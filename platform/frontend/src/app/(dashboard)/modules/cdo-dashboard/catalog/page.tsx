...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"1.807","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"730","t":"+13.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.388","t":"+10.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.388","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2963","2026-03-17","7.458","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2282","2026-03-19","1.958","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2457","2026-02-07","6.311","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2855","2026-03-01","6.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3192","2026-01-05","4.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":734},{"label":"Mar","value":843},{"label":"Abr","value":867},{"label":"Mai","value":928},{"label":"Jun","value":776},{"label":"Jul","value":770},{"label":"Ago","value":708},{"label":"Set","value":859},{"label":"Out","value":1045},{"label":"Nov","value":668},{"label":"Dez","value":841}];
const MX = 1045;
