...
const ACCENT = "#1e293b";
const MODULE = "CDO Data Dashboard";
const PAGE = "Value";
const KPIS = [{"l":"Teams Ativos","v":"9.013","t":"+8.4%","d":"up"},{"l":"Reuniões/Semana","v":"3643","t":"-2.7%","d":"down"},{"l":"Mensagens/Dia","v":"448","t":"+5.8%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.571","t":"-2.9%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.939","3902","3.520","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.752","1466","985","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.172","4224","3.669","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.398","4972","1.834","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.557","107","7.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":769},{"label":"Mar","value":432},{"label":"Abr","value":518},{"label":"Mai","value":649},{"label":"Jun","value":592},{"label":"Jul","value":400},{"label":"Ago","value":755},{"label":"Set","value":760},{"label":"Out","value":795},{"label":"Nov","value":749},{"label":"Dez","value":507}];
const MX = 795;
