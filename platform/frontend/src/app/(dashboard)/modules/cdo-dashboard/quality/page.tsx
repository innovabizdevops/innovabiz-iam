...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.755","t":"+16.1%","d":"up"},{"l":"NC Abertas","v":"898","t":"+1.7%","d":"up"},{"l":"Conformidade (%)","v":"67.6%","t":"-3.7%","d":"down"},{"l":"CAPAs Pendentes","v":"3.154","t":"-3.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","9.052","95.8%","8.739","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.959","74.8%","5.759","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.186","71.3%","1.449","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.521","98.0%","1.071","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.596","81.6%","4.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":574},{"label":"Mar","value":570},{"label":"Abr","value":558},{"label":"Mai","value":830},{"label":"Jun","value":726},{"label":"Jul","value":779},{"label":"Ago","value":623},{"label":"Set","value":847},{"label":"Out","value":698},{"label":"Nov","value":624},{"label":"Dez","value":631}];
const MX = 847;
