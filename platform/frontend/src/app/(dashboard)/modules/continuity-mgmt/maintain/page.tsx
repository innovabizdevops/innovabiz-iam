...
const ACCENT = "#475569";
const MODULE = "IT Continuity (ISO 22301)";
const PAGE = "Maintain";
const KPIS = [{"l":"Total Continuity Mgmt","v":"6.202","t":"+3.0%","d":"up"},{"l":"Maintain Ativos","v":"4.062","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"74.8%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"83","t":"+14.3%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Continuity Mgmt #001","Continuity Mgmt #002","5.062","5.525","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Continuity Mgmt #002","Continuity Mgmt #003","4.482","1.879","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Continuity Mgmt #003","Continuity Mgmt #004","3.149","8.274","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Continuity Mgmt #004","Continuity Mgmt #005","3.940","8.133","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Continuity Mgmt #005","Continuity Mgmt #001","3.063","4.979","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":429},{"label":"Mar","value":526},{"label":"Abr","value":544},{"label":"Mai","value":579},{"label":"Jun","value":275},{"label":"Jul","value":255},{"label":"Ago","value":531},{"label":"Set","value":279},{"label":"Out","value":613},{"label":"Nov","value":399},{"label":"Dez","value":357}];
const MX = 613;
