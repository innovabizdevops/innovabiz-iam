...
/* ═══ IT Continuity (ISO 22301) — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "3251", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "793", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€67K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1962193051", cells: ["CON-5051", "IT Continuity (ISO 22301) Item 1", "8/8/2026", "€43 151"], status: "active" as const },
    { id: "1962196622", cells: ["CON-8622", "IT Continuity (ISO 22301) Item 2", "23/3/2026", "€46 722"], status: "pending" as const },
    { id: "1962200193", cells: ["CON-3193", "IT Continuity (ISO 22301) Item 3", "10/10/2026", "€293"], status: "completed" as const },
    { id: "1962203764", cells: ["CON-6764", "IT Continuity (ISO 22301) Item 4", "25/5/2026", "€3864"], status: "warning" as const },
    { id: "1962207335", cells: ["CON-1335", "IT Continuity (ISO 22301) Item 5", "12/12/2026", "€7435"], status: "active" as const },
];
...
export default function ItContinuityIso22301Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IT Continuity (ISO 22301)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IT Continuity (ISO 22301)</p>
                    </div>
                </div>
