...
const PAGE = "BIA";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.164","t":"+1.8%","d":"up"},{"l":"RTO Médio (h)","v":"31h","t":"-1.9%","d":"down"},{"l":"RPO Médio (h)","v":"135h","t":"-1.8%","d":"down"},{"l":"Testes DR (YTD)","v":"6.003","t":"+7.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","50h","203h","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","34h","141h","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","141h","68h","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","14h","156h","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","70h","42h","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":681},{"label":"Mar","value":551},{"label":"Abr","value":345},{"label":"Mai","value":387},{"label":"Jun","value":679},{"label":"Jul","value":353},{"label":"Ago","value":447},{"label":"Set","value":723},{"label":"Out","value":671},{"label":"Nov","value":727},{"label":"Dez","value":486}];
const MX = 727;
