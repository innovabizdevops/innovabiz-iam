...
const PAGE = "Metering &amp; AMI";
const KPIS = [{"l":"Total Utilities","v":"2.895","t":"+2.2%","d":"up"},{"l":"Metering & AMI Ativos","v":"3.510","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.9%","d":"up"}];
const COLS = ["ID","Metering & AMI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utilities #001","Utilities #002","2.108","5.628","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Utilities #002","Utilities #003","6.283","8.766","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Utilities #003","Utilities #004","5.346","2.304","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Utilities #004","Utilities #005","2.760","5.050","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utilities #005","Utilities #001","8.451","1.955","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":488},{"label":"Mar","value":570},{"label":"Abr","value":360},{"label":"Mai","value":435},{"label":"Jun","value":563},{"label":"Jul","value":648},{"label":"Ago","value":566},{"label":"Set","value":343},{"label":"Out","value":444},{"label":"Nov","value":644},{"label":"Dez","value":571}];
const MX = 648;
