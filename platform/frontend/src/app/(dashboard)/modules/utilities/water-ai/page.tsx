...
const ACCENT = "#0369a1";
const MODULE = "Utilities Management";
const PAGE = "Water Network AI";
const KPIS = [{"l":"Total Utilities","v":"6.476","t":"-4.8%","d":"down"},{"l":"Water Network AI Ativos","v":"3.274","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"74.1%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"93","t":"+2.4%","d":"up"}];
const COLS = ["ID","Water Network AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utilities #001","Utilities #002","7.367","8.007","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Utilities #002","Utilities #003","6.523","3.437","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Utilities #003","Utilities #004","1.213","2.425","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Utilities #004","Utilities #005","4.147","2.917","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utilities #005","Utilities #001","7.491","598","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":642},{"label":"Mar","value":859},{"label":"Abr","value":768},{"label":"Mai","value":725},{"label":"Jun","value":988},{"label":"Jul","value":824},{"label":"Ago","value":677},{"label":"Set","value":988},{"label":"Out","value":610},{"label":"Nov","value":766},{"label":"Dez","value":652}];
const MX = 988;
