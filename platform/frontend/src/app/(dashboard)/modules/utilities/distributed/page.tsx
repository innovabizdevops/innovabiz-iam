...
const PAGE = "Distributed Energy";
const KPIS = [{"l":"Total Utilities","v":"7.603","t":"+0.7%","d":"up"},{"l":"Distributed Energy Ativos","v":"1.524","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.3%","d":"up"}];
const COLS = ["ID","Distributed Energy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utilities #001","Utilities #002","1.251","4.793","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Utilities #002","Utilities #003","1.716","5.543","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Utilities #003","Utilities #004","2.967","3.306","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Utilities #004","Utilities #005","572","5.809","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utilities #005","Utilities #001","3.721","5.933","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":579},{"label":"Mar","value":640},{"label":"Abr","value":774},{"label":"Mai","value":759},{"label":"Jun","value":650},{"label":"Jul","value":774},{"label":"Ago","value":700},{"label":"Set","value":493},{"label":"Out","value":393},{"label":"Nov","value":608},{"label":"Dez","value":661}];
const MX = 774;
