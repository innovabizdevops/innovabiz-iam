...
const PAGE = "Asset Inspection";
const KPIS = [{"l":"Auditorias Realizadas","v":"386","t":"+16.6%","d":"up"},{"l":"NC Abertas","v":"6.124","t":"+14.4%","d":"up"},{"l":"Conformidade (%)","v":"74.7%","t":"+5.1%","d":"up"},{"l":"CAPAs Pendentes","v":"9.026","t":"+6.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","406","80.8%","7.498","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.332","92.0%","3.657","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.666","77.2%","2.080","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.220","82.4%","7.748","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","931","93.9%","5.618","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":707},{"label":"Mar","value":980},{"label":"Abr","value":859},{"label":"Mai","value":715},{"label":"Jun","value":1024},{"label":"Jul","value":857},{"label":"Ago","value":861},{"label":"Set","value":1049},{"label":"Out","value":722},{"label":"Nov","value":943},{"label":"Dez","value":916}];
const MX = 1049;
