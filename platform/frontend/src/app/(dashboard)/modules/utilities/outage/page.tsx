...
const KPIS = [{"l":"Projetos Melhoria","v":"7.846","t":"+16.4%","d":"up"},{"l":"Savings (€)","v":"€55370","t":"+6.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.7%","t":"+2.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.618","t":"-3.2%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.931","€ 19202.17","8.654","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.637","€ 26232.95","1.167","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.157","€ 24714.43","686","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.054","€ 48533.28","6.120","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.262","€ 40388.18","2.994","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":316},{"label":"Mar","value":299},{"label":"Abr","value":465},{"label":"Mai","value":252},{"label":"Jun","value":477},{"label":"Jul","value":281},{"label":"Ago","value":544},{"label":"Set","value":453},{"label":"Out","value":300},{"label":"Nov","value":260},{"label":"Dez","value":550}];
const MX = 550;
