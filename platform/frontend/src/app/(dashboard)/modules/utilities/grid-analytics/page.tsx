...
const PAGE = "Grid Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.480","t":"+12.9%","d":"up"},{"l":"Queries/Dia","v":"4726","t":"-5.2%","d":"down"},{"l":"Dados Processados (GB)","v":"368","t":"-4.3%","d":"down"},{"l":"Utilizadores Analytics","v":"4.695","t":"+13.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4015","2026-03-22","7.744","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","728","2026-01-25","212","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2565","2026-02-21","2.737","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1421","2026-03-04","5.192","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3025","2026-01-27","5.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":789},{"label":"Mar","value":718},{"label":"Abr","value":691},{"label":"Mai","value":935},{"label":"Jun","value":803},{"label":"Jul","value":742},{"label":"Ago","value":731},{"label":"Set","value":688},{"label":"Out","value":777},{"label":"Nov","value":605},{"label":"Dez","value":824}];
const MX = 935;
