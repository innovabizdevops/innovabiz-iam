...
const PAGE = "Policy Template Form";
const KPIS = [{"l":"Riscos Identificados","v":"7.947","t":"+1.7%","d":"up"},{"l":"Mitigações Ativas","v":"7.294","t":"+7.7%","d":"up"},{"l":"Score Risco Geral","v":"95","t":"-0.9%","d":"down"},{"l":"Incidentes YTD","v":"2.828","t":"+8.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.390","7.339","3.745","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.816","7.959","228","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.132","2.008","5.691","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.064","5.593","5.332","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.732","4.307","3.320","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":286},{"label":"Fev","value":367},{"label":"Mar","value":538},{"label":"Abr","value":480},{"label":"Mai","value":359},{"label":"Jun","value":409},{"label":"Jul","value":503},{"label":"Ago","value":257},{"label":"Set","value":297},{"label":"Out","value":570},{"label":"Nov","value":399},{"label":"Dez","value":604}];
const MX = 604;
