...
const PAGE = "Compliance Calendar";
const KPIS = [{"l":"Riscos Identificados","v":"135","t":"+4.2%","d":"up"},{"l":"Mitigações Ativas","v":"7.847","t":"-6.0%","d":"down"},{"l":"Score Risco Geral","v":"84","t":"-6.0%","d":"down"},{"l":"Incidentes YTD","v":"7.575","t":"+15.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.780","4.615","2.182","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.405","3.900","1.623","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.534","8.682","6.197","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.935","4.824","7.965","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.185","4.294","8.396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":279},{"label":"Fev","value":339},{"label":"Mar","value":616},{"label":"Abr","value":549},{"label":"Mai","value":501},{"label":"Jun","value":226},{"label":"Jul","value":591},{"label":"Ago","value":565},{"label":"Set","value":511},{"label":"Out","value":302},{"label":"Nov","value":509},{"label":"Dez","value":230}];
const MX = 616;
