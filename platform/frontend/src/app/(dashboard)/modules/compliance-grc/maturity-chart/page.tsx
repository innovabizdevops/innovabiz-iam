...
const ACCENT = "#dc2626";
const MODULE = "Compliance & GRC";
const PAGE = "Maturity Spider Chart";
const KPIS = [{"l":"Riscos Identificados","v":"6.291","t":"+7.3%","d":"up"},{"l":"Mitigações Ativas","v":"711","t":"-5.8%","d":"down"},{"l":"Score Risco Geral","v":"58","t":"-1.8%","d":"down"},{"l":"Incidentes YTD","v":"6.850","t":"+12.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.581","7.950","3.484","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.074","5.301","5.658","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.002","4.175","3.103","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","734","5.627","552","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.222","1.839","7.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":775},{"label":"Mar","value":719},{"label":"Abr","value":527},{"label":"Mai","value":557},{"label":"Jun","value":728},{"label":"Jul","value":632},{"label":"Ago","value":551},{"label":"Set","value":670},{"label":"Out","value":498},{"label":"Nov","value":684},{"label":"Dez","value":424}];
const MX = 795;
...
export default function MaturityChartPage() {
    return (
