...
const ACCENT = "#6d28d9";
const MODULE = "Composable Architecture";
const PAGE = "API Composition";
const KPIS = [{"l":"Pedidos/Dia","v":"3778","t":"+0.1%","d":"up"},{"l":"GMV (€)","v":"€96080","t":"-1.9%","d":"down"},{"l":"Conversão (%)","v":"84.9%","t":"+12.3%","d":"up"},{"l":"AOV (€)","v":"€29162","t":"-5.5%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43776.34","3.422","1.872","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 44626.00","7.353","2.220","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 46365.19","3.890","6.349","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20565.28","1.501","2.687","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 4676.65","2.495","8.812","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":675},{"label":"Mar","value":557},{"label":"Abr","value":295},{"label":"Mai","value":401},{"label":"Jun","value":519},{"label":"Jul","value":384},{"label":"Ago","value":417},{"label":"Set","value":484},{"label":"Out","value":395},{"label":"Nov","value":629},{"label":"Dez","value":539}];
const MX = 675;
...
export default function ApiCompPage() {
    return (
