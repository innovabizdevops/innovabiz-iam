...
export default function ComposableArchPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Composable Arch</h1><p className="text-sm text-muted-foreground">Composable Arch • iBOS Enterprise</p></div>
