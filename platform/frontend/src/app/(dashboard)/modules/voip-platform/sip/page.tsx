...
const PAGE = "SIP";
const KPIS = [{"l":"Formulários Ativos","v":"2.865","t":"-0.3%","d":"down"},{"l":"Submissões/Dia","v":"4813","t":"+2.0%","d":"up"},{"l":"Documentos Gerados","v":"6.447","t":"+14.7%","d":"up"},{"l":"Templates","v":"5.234","t":"-1.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.981","2026-01-27","5.313","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.594","2026-01-22","2.372","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.396","2026-01-12","2.179","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.159","2026-02-04","8.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.869","2026-02-15","9.032","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":405},{"label":"Mar","value":552},{"label":"Abr","value":323},{"label":"Mai","value":482},{"label":"Jun","value":433},{"label":"Jul","value":462},{"label":"Ago","value":379},{"label":"Set","value":417},{"label":"Out","value":450},{"label":"Nov","value":592},{"label":"Dez","value":424}];
const MX = 592;
