...
const PAGE = "PBX";
const KPIS = [{"l":"Formulários Ativos","v":"6.287","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"4550","t":"+4.1%","d":"up"},{"l":"Documentos Gerados","v":"1.112","t":"+15.5%","d":"up"},{"l":"Templates","v":"2.413","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.896","2026-01-12","2.684","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.894","2026-03-05","8.308","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.080","2026-01-10","2.155","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.361","2026-03-25","841","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.951","2026-01-08","5.672","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":725},{"label":"Mar","value":767},{"label":"Abr","value":654},{"label":"Mai","value":588},{"label":"Jun","value":552},{"label":"Jul","value":861},{"label":"Ago","value":571},{"label":"Set","value":510},{"label":"Out","value":589},{"label":"Nov","value":518},{"label":"Dez","value":506}];
const MX = 861;
