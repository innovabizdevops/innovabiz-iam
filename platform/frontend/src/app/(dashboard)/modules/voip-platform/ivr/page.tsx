...
const ACCENT = "#fdba74";
const MODULE = "VoIP Platform";
const PAGE = "IVR";
const KPIS = [{"l":"Formulários Ativos","v":"8.051","t":"-5.3%","d":"down"},{"l":"Submissões/Dia","v":"2277","t":"-3.1%","d":"down"},{"l":"Documentos Gerados","v":"7.244","t":"+7.4%","d":"up"},{"l":"Templates","v":"6.074","t":"+2.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.817","2026-01-19","1.013","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.367","2026-03-27","5.157","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.468","2026-02-20","7.461","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.275","2026-03-15","1.055","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.787","2026-01-05","3.151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":698},{"label":"Mar","value":473},{"label":"Abr","value":532},{"label":"Mai","value":812},{"label":"Jun","value":786},{"label":"Jul","value":533},{"label":"Ago","value":488},{"label":"Set","value":515},{"label":"Out","value":789},{"label":"Nov","value":642},{"label":"Dez","value":482}];
const MX = 812;
