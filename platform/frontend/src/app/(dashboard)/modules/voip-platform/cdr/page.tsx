...
const PAGE = "CDR";
const KPIS = [{"l":"Formulários Ativos","v":"8.300","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"2397","t":"-2.4%","d":"down"},{"l":"Documentos Gerados","v":"1.062","t":"-0.4%","d":"down"},{"l":"Templates","v":"2.763","t":"+2.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","849","2026-03-26","2.205","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.100","2026-01-01","6.748","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.194","2026-02-10","2.086","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.288","2026-01-07","890","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.645","2026-03-06","8.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":964},{"label":"Mar","value":802},{"label":"Abr","value":737},{"label":"Mai","value":900},{"label":"Jun","value":917},{"label":"Jul","value":990},{"label":"Ago","value":905},{"label":"Set","value":963},{"label":"Out","value":703},{"label":"Nov","value":927},{"label":"Dez","value":1078}];
const MX = 1078;
