...
const KPIS = [{"l":"Formulários Ativos","v":"7.941","t":"-2.9%","d":"down"},{"l":"Submissões/Dia","v":"2055","t":"+12.0%","d":"up"},{"l":"Documentos Gerados","v":"7.519","t":"+8.5%","d":"up"},{"l":"Templates","v":"3.261","t":"+7.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.643","2026-02-08","2.313","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.502","2026-03-17","3.792","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.149","2026-01-09","1.566","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.140","2026-03-05","8.375","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.938","2026-01-05","111","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":1074},{"label":"Mar","value":967},{"label":"Abr","value":977},{"label":"Mai","value":749},{"label":"Jun","value":883},{"label":"Jul","value":820},{"label":"Ago","value":785},{"label":"Set","value":718},{"label":"Out","value":943},{"label":"Nov","value":899},{"label":"Dez","value":1064}];
const MX = 1074;
