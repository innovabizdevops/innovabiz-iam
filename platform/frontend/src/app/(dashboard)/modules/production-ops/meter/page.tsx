...
const ACCENT = "#6366f1";
const MODULE = "Production Operations";
const PAGE = "Metering";
const KPIS = [{"l":"Total Production Ops","v":"1.905","t":"+15.9%","d":"up"},{"l":"Metering Ativos","v":"8.606","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+17.2%","d":"up"}];
const COLS = ["ID","Metering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Production Ops #001","Production Ops #002","1.271","8.283","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Production Ops #002","Production Ops #003","7.209","5.089","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Production Ops #003","Production Ops #004","5.213","1.407","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Production Ops #004","Production Ops #005","7.726","2.608","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Production Ops #005","Production Ops #001","4.808","1.131","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":871},{"label":"Mar","value":541},{"label":"Abr","value":548},{"label":"Mai","value":698},{"label":"Jun","value":857},{"label":"Jul","value":604},{"label":"Ago","value":784},{"label":"Set","value":664},{"label":"Out","value":733},{"label":"Nov","value":887},{"label":"Dez","value":865}];
const MX = 887;
