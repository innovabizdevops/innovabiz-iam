...
const PAGE = "Artificial Lift";
const KPIS = [{"l":"Total Production Ops","v":"238","t":"+11.7%","d":"up"},{"l":"Artificial Lift Ativos","v":"6.920","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"94.8%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+16.3%","d":"up"}];
const COLS = ["ID","Artificial Lift","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Production Ops #001","Production Ops #002","2.929","5.674","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Production Ops #002","Production Ops #003","498","678","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Production Ops #003","Production Ops #004","2.276","3.264","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Production Ops #004","Production Ops #005","1.208","6.550","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Production Ops #005","Production Ops #001","3.538","8.749","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":457},{"label":"Mar","value":462},{"label":"Abr","value":753},{"label":"Mai","value":774},{"label":"Jun","value":453},{"label":"Jul","value":581},{"label":"Ago","value":713},{"label":"Set","value":447},{"label":"Out","value":616},{"label":"Nov","value":721},{"label":"Dez","value":773}];
const MX = 774;
