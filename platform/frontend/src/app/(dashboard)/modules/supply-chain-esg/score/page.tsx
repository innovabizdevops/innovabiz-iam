...
const PAGE = "Supplier Score";
const KPIS = [{"l":"Total Supply Chain Esg","v":"7.638","t":"+9.4%","d":"up"},{"l":"Supplier Score Ativos","v":"92","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"83","t":"+13.9%","d":"up"}];
const COLS = ["ID","Supplier Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain Esg #001","88.0%","4.141","2.760","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain Esg #002","88.0%","1.029","2.257","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain Esg #003","72.7%","3.971","1.975","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain Esg #004","76.7%","6.075","6.776","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain Esg #005","70.2%","7.753","2.254","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":740},{"label":"Mar","value":708},{"label":"Abr","value":692},{"label":"Mai","value":537},{"label":"Jun","value":541},{"label":"Jul","value":452},{"label":"Ago","value":644},{"label":"Set","value":545},{"label":"Out","value":529},{"label":"Nov","value":738},{"label":"Dez","value":710}];
const MX = 740;
