...
const ACCENT = "#7c3aed";
const MODULE = "Supply Chain ESG";
const PAGE = "Conflict Mineral";
const KPIS = [{"l":"Total Supply Chain Esg","v":"1.721","t":"-1.6%","d":"down"},{"l":"Conflict Mineral Ativos","v":"7.222","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"93.8%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"79","t":"-3.6%","d":"down"}];
const COLS = ["ID","Conflict Mineral","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Chain Esg #001","Supply Chain Esg #002","6.441","5.241","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Chain Esg #002","Supply Chain Esg #003","3.062","7.651","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Chain Esg #003","Supply Chain Esg #004","3.712","3.749","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Chain Esg #004","Supply Chain Esg #005","641","7.812","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Chain Esg #005","Supply Chain Esg #001","7.673","686","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":767},{"label":"Mar","value":564},{"label":"Abr","value":629},{"label":"Mai","value":713},{"label":"Jun","value":711},{"label":"Jul","value":561},{"label":"Ago","value":527},{"label":"Set","value":834},{"label":"Out","value":517},{"label":"Nov","value":565},{"label":"Dez","value":766}];
const MX = 834;
