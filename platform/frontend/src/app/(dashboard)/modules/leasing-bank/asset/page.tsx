...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"247","t":"-0.6%","d":"down"},{"l":"Valor Total (€M)","v":"€48.8M","t":"-4.1%","d":"down"},{"l":"Depreciação Anual (€)","v":"€86494","t":"+1.2%","d":"up"},{"l":"Ativos em Garantia","v":"480","t":"+14.9%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 34058.75","4.713","€ 29129.99","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 18615.97","635","€ 15314.17","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 669.45","6.336","€ 26022.44","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 30118.42","7.288","€ 17772.10","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 34987.77","7.208","€ 49851.05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":642},{"label":"Mar","value":495},{"label":"Abr","value":401},{"label":"Mai","value":753},{"label":"Jun","value":734},{"label":"Jul","value":669},{"label":"Ago","value":765},{"label":"Set","value":494},{"label":"Out","value":677},{"label":"Nov","value":712},{"label":"Dez","value":434}];
const MX = 765;
