...
const ACCENT = "#6366f1";
const MODULE = "Leasing Services";
const PAGE = "Origination";
const KPIS = [{"l":"Total Leasing Bank","v":"7.876","t":"-0.3%","d":"down"},{"l":"Origination Ativos","v":"3.741","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.1%","d":"up"}];
const COLS = ["ID","Origination","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leasing Bank #001","Leasing Bank #002","1.023","8.764","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Leasing Bank #002","Leasing Bank #003","2.131","5.616","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Leasing Bank #003","Leasing Bank #004","2.833","4.458","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Leasing Bank #004","Leasing Bank #005","3.374","691","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leasing Bank #005","Leasing Bank #001","3.042","5.180","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":461},{"label":"Mar","value":771},{"label":"Abr","value":447},{"label":"Mai","value":659},{"label":"Jun","value":527},{"label":"Jul","value":473},{"label":"Ago","value":750},{"label":"Set","value":601},{"label":"Out","value":774},{"label":"Nov","value":479},{"label":"Dez","value":735}];
const MX = 774;
