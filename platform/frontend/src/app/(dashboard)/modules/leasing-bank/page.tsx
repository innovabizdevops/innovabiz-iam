...
export default function LeasingBankPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Leasing Bank</h1><p className="text-sm text-muted-foreground">Leasing Bank • iBOS Enterprise</p></div>
