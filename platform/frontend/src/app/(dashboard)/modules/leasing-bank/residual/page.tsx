...
const PAGE = "Residual";
const KPIS = [{"l":"Total Leasing Bank","v":"9.077","t":"+6.5%","d":"up"},{"l":"Residual Ativos","v":"8.544","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"58","t":"-1.2%","d":"down"}];
const COLS = ["ID","Residual","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leasing Bank #001","Leasing Bank #002","2.069","7.984","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Leasing Bank #002","Leasing Bank #003","679","5.259","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Leasing Bank #003","Leasing Bank #004","2.673","3.938","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Leasing Bank #004","Leasing Bank #005","5.653","838","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leasing Bank #005","Leasing Bank #001","5.498","4.512","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":472},{"label":"Mar","value":425},{"label":"Abr","value":311},{"label":"Mai","value":477},{"label":"Jun","value":575},{"label":"Jul","value":647},{"label":"Ago","value":411},{"label":"Set","value":307},{"label":"Out","value":340},{"label":"Nov","value":395},{"label":"Dez","value":590}];
const MX = 647;
