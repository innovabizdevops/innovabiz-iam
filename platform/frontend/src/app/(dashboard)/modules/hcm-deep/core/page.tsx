...
const PAGE = "Core HR";
const KPIS = [{"l":"eNPS","v":"83","t":"+12.8%","d":"up"},{"l":"Engagement (%)","v":"91.1%","t":"-6.0%","d":"down"},{"l":"Turnover (%)","v":"80.3%","t":"+2.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"690","t":"+2.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.374","2026-03-16","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","350","2026-02-06","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.564","2026-02-13","65","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.420","2026-03-11","63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.795","2026-03-09","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":623},{"label":"Mar","value":640},{"label":"Abr","value":377},{"label":"Mai","value":399},{"label":"Jun","value":441},{"label":"Jul","value":624},{"label":"Ago","value":611},{"label":"Set","value":528},{"label":"Out","value":521},{"label":"Nov","value":328},{"label":"Dez","value":373}];
const MX = 640;
