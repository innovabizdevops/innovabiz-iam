...
const PAGE = "Succession";
const KPIS = [{"l":"eNPS","v":"74","t":"+15.1%","d":"up"},{"l":"Engagement (%)","v":"71.5%","t":"+14.4%","d":"up"},{"l":"Turnover (%)","v":"92.9%","t":"+3.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.623","t":"+0.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.550","2026-02-06","79","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.840","2026-01-13","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.372","2026-01-09","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.545","2026-01-12","92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.689","2026-01-19","92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":665},{"label":"Mar","value":646},{"label":"Abr","value":273},{"label":"Mai","value":555},{"label":"Jun","value":356},{"label":"Jul","value":564},{"label":"Ago","value":352},{"label":"Set","value":367},{"label":"Out","value":510},{"label":"Nov","value":548},{"label":"Dez","value":345}];
const MX = 665;
