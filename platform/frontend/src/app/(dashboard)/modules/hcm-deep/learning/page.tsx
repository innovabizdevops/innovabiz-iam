...
const PAGE = "Learning";
const KPIS = [{"l":"eNPS","v":"59","t":"+15.2%","d":"up"},{"l":"Engagement (%)","v":"80.3%","t":"+5.4%","d":"up"},{"l":"Turnover (%)","v":"84.6%","t":"+13.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.704","t":"+2.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.363","2026-01-13","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.976","2026-02-18","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.527","2026-01-24","90","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.722","2026-01-02","77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","856","2026-01-20","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":550},{"label":"Mar","value":602},{"label":"Abr","value":486},{"label":"Mai","value":434},{"label":"Jun","value":732},{"label":"Jul","value":584},{"label":"Ago","value":518},{"label":"Set","value":700},{"label":"Out","value":820},{"label":"Nov","value":512},{"label":"Dez","value":782}];
const MX = 820;
