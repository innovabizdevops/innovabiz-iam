...
/* ═══ HCM Deep (SAP SuccessFactors) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "8154", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3188", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€83K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1895788754", cells: ["HCM-2754", "HCM Deep (SAP SuccessFactors) Item 1", "7/3/2026", "€38 854"], status: "active" as const },
    { id: "1895792325", cells: ["HCM-6325", "HCM Deep (SAP SuccessFactors) Item 2", "22/10/2026", "€42 425"], status: "pending" as const },
    { id: "1895795896", cells: ["HCM-9896", "HCM Deep (SAP SuccessFactors) Item 3", "9/5/2026", "€45 996"], status: "completed" as const },
    { id: "1895799467", cells: ["HCM-4467", "HCM Deep (SAP SuccessFactors) Item 4", "24/12/2026", "€49 567"], status: "warning" as const },
    { id: "1895803038", cells: ["HCM-8038", "HCM Deep (SAP SuccessFactors) Item 5", "11/7/2026", "€3138"], status: "active" as const },
];
...
export default function HcmDeepSapSuccessfactorsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HCM Deep (SAP SuccessFactors)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HCM Deep (SAP SuccessFactors)</p>
                    </div>
                </div>
