...
const ACCENT = "#0070f3";
const MODULE = "HCM Deep (SAP SuccessFactors)";
const PAGE = "Compensation";
const KPIS = [{"l":"eNPS","v":"81","t":"+9.7%","d":"up"},{"l":"Engagement (%)","v":"88.6%","t":"+5.2%","d":"up"},{"l":"Turnover (%)","v":"86.4%","t":"+17.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.849","t":"+11.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.298","2026-03-03","57","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.122","2026-01-19","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.264","2026-01-08","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.530","2026-01-23","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.815","2026-03-19","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":451},{"label":"Mar","value":546},{"label":"Abr","value":624},{"label":"Mai","value":256},{"label":"Jun","value":511},{"label":"Jul","value":447},{"label":"Ago","value":596},{"label":"Set","value":390},{"label":"Out","value":282},{"label":"Nov","value":522},{"label":"Dez","value":279}];
const MX = 624;
