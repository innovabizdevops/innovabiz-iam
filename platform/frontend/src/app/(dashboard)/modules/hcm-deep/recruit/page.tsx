...
const PAGE = "Recruit";
const KPIS = [{"l":"eNPS","v":"57","t":"+7.8%","d":"up"},{"l":"Engagement (%)","v":"86.0%","t":"+5.5%","d":"up"},{"l":"Turnover (%)","v":"80.6%","t":"+13.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.826","t":"+8.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.701","2026-03-01","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.741","2026-01-27","84","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.876","2026-03-25","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.518","2026-02-22","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.151","2026-01-13","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":229},{"label":"Mar","value":535},{"label":"Abr","value":361},{"label":"Mai","value":585},{"label":"Jun","value":604},{"label":"Jul","value":317},{"label":"Ago","value":349},{"label":"Set","value":247},{"label":"Out","value":396},{"label":"Nov","value":625},{"label":"Dez","value":376}];
const MX = 625;
