...
const ACCENT = "#b45309";
const MODULE = "Win/Loss Analysis";
const PAGE = "Analysis Board";
const KPIS = [{"l":"Dashboards Ativos","v":"4.375","t":"+11.8%","d":"up"},{"l":"Queries/Dia","v":"3869","t":"+6.4%","d":"up"},{"l":"Dados Processados (GB)","v":"4.533","t":"+15.4%","d":"up"},{"l":"Utilizadores Analytics","v":"904","t":"-0.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3315","2026-02-02","1.041","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1649","2026-01-24","542","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3575","2026-03-14","3.864","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4689","2026-02-27","1.808","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","371","2026-03-01","8.928","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":492},{"label":"Mar","value":684},{"label":"Abr","value":438},{"label":"Mai","value":688},{"label":"Jun","value":572},{"label":"Jul","value":655},{"label":"Ago","value":327},{"label":"Set","value":417},{"label":"Out","value":419},{"label":"Nov","value":616},{"label":"Dez","value":610}];
const MX = 688;
