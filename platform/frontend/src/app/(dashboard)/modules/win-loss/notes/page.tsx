...
const KPIS = [{"l":"Total Win Loss","v":"1.546","t":"+10.6%","d":"up"},{"l":"Interview Notes Ativos","v":"1.670","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"92","t":"+16.2%","d":"up"}];
const COLS = ["ID","Interview Notes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Win Loss #001","Win Loss #002","3.430","6.710","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Win Loss #002","Win Loss #003","6.294","5.083","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Win Loss #003","Win Loss #004","5.575","429","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Win Loss #004","Win Loss #005","5.763","3.166","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Win Loss #005","Win Loss #001","6.047","1.840","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":777},{"label":"Mar","value":818},{"label":"Abr","value":940},{"label":"Mai","value":712},{"label":"Jun","value":800},{"label":"Jul","value":898},{"label":"Ago","value":917},{"label":"Set","value":813},{"label":"Out","value":811},{"label":"Nov","value":659},{"label":"Dez","value":930}];
const MX = 940;
