...
const KPIS = [{"l":"Total Win Loss","v":"4.669","t":"+13.6%","d":"up"},{"l":"Competitor Intel Ativos","v":"4.135","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"74.0%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"62","t":"+1.9%","d":"up"}];
const COLS = ["ID","Competitor Intel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Win Loss #001","Win Loss #002","1.756","6.720","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Win Loss #002","Win Loss #003","1.344","4.249","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Win Loss #003","Win Loss #004","3.515","7.071","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Win Loss #004","Win Loss #005","1.878","2.709","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Win Loss #005","Win Loss #001","2.825","3.991","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":842},{"label":"Mar","value":899},{"label":"Abr","value":1003},{"label":"Mai","value":817},{"label":"Jun","value":1022},{"label":"Jul","value":730},{"label":"Ago","value":840},{"label":"Set","value":753},{"label":"Out","value":1037},{"label":"Nov","value":982},{"label":"Dez","value":884}];
const MX = 1037;
