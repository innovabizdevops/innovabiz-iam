...
const PAGE = "Trend Patterns";
const KPIS = [{"l":"Total Win Loss","v":"2.306","t":"-4.0%","d":"down"},{"l":"Trend Patterns Ativos","v":"161","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+16.2%","d":"up"}];
const COLS = ["ID","Trend Patterns","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Win Loss #001","Win Loss #002","2.267","4.105","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Win Loss #002","Win Loss #003","214","400","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Win Loss #003","Win Loss #004","8.490","4.983","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Win Loss #004","Win Loss #005","7.184","7.400","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Win Loss #005","Win Loss #001","6.011","4.844","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1002},{"label":"Fev","value":909},{"label":"Mar","value":699},{"label":"Abr","value":723},{"label":"Mai","value":796},{"label":"Jun","value":917},{"label":"Jul","value":830},{"label":"Ago","value":781},{"label":"Set","value":630},{"label":"Out","value":679},{"label":"Nov","value":976},{"label":"Dez","value":852}];
const MX = 1002;
