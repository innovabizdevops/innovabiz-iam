...
const KPIS = [{"l":"Total Win Loss","v":"6.012","t":"+0.4%","d":"up"},{"l":"Action Items Ativos","v":"6.111","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"86.7%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"93","t":"-4.7%","d":"down"}];
const COLS = ["ID","Action Items","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Win Loss #001","Win Loss #002","6.783","8.354","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Win Loss #002","Win Loss #003","636","5.698","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Win Loss #003","Win Loss #004","8.974","815","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Win Loss #004","Win Loss #005","2.956","3.164","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Win Loss #005","Win Loss #001","638","3.759","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":663},{"label":"Mar","value":460},{"label":"Abr","value":642},{"label":"Mai","value":697},{"label":"Jun","value":753},{"label":"Jul","value":533},{"label":"Ago","value":743},{"label":"Set","value":675},{"label":"Out","value":490},{"label":"Nov","value":592},{"label":"Dez","value":562}];
const MX = 753;
