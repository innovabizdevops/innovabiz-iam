...
const PAGE = "Impact Monitor";
const KPIS = [{"l":"Projetos Sociais","v":"615","t":"+3.6%","d":"up"},{"l":"Beneficiários","v":"2.615","t":"-0.4%","d":"down"},{"l":"Investimento CSR (€)","v":"€65528","t":"+3.7%","d":"up"},{"l":"Score Impacto","v":"71","t":"+11.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.672","€ 34757.94","1.305","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.242","€ 36124.91","8.119","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.581","€ 4886.58","978","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.883","€ 32069.49","4.007","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.736","€ 2830.39","5.010","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":965},{"label":"Mar","value":806},{"label":"Abr","value":765},{"label":"Mai","value":807},{"label":"Jun","value":839},{"label":"Jul","value":1003},{"label":"Ago","value":771},{"label":"Set","value":679},{"label":"Out","value":951},{"label":"Nov","value":769},{"label":"Dez","value":873}];
const MX = 1003;
