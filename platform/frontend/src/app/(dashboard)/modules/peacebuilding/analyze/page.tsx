...
const PAGE = "Conflict Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"4.029","t":"-4.6%","d":"down"},{"l":"Queries/Dia","v":"4724","t":"+9.8%","d":"up"},{"l":"Dados Processados (GB)","v":"1.570","t":"+9.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.796","t":"+13.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3668","2026-01-16","3.494","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2983","2026-01-21","2.736","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3933","2026-01-15","6.983","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3464","2026-03-24","7.194","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4631","2026-01-28","8.272","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":364},{"label":"Mar","value":563},{"label":"Abr","value":454},{"label":"Mai","value":236},{"label":"Jun","value":269},{"label":"Jul","value":610},{"label":"Ago","value":498},{"label":"Set","value":245},{"label":"Out","value":412},{"label":"Nov","value":455},{"label":"Dez","value":306}];
const MX = 610;
