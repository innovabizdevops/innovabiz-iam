...
const ACCENT = "#78350f";
const MODULE = "Peacebuilding";
const PAGE = "Dialogue Track";
const KPIS = [{"l":"Total Peacebuilding","v":"5.957","t":"+15.6%","d":"up"},{"l":"Dialogue Track Ativos","v":"8.218","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+0.9%","d":"up"}];
const COLS = ["ID","Dialogue Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Peacebuilding #001","Peacebuilding #002","1.873","1.904","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Peacebuilding #002","Peacebuilding #003","5.329","1.490","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Peacebuilding #003","Peacebuilding #004","8.691","2.122","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Peacebuilding #004","Peacebuilding #005","6.735","6.426","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Peacebuilding #005","Peacebuilding #001","545","3.364","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":654},{"label":"Mar","value":714},{"label":"Abr","value":672},{"label":"Mai","value":731},{"label":"Jun","value":707},{"label":"Jul","value":735},{"label":"Ago","value":703},{"label":"Set","value":619},{"label":"Out","value":964},{"label":"Nov","value":681},{"label":"Dez","value":676}];
const MX = 964;
