...
const PAGE = "Econ Reintegrate";
const KPIS = [{"l":"Integrações Ativas","v":"4.068","t":"+5.8%","d":"up"},{"l":"Chamadas/Hora","v":"3489","t":"+14.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.4%","t":"+15.7%","d":"up"},{"l":"Latência Média (ms)","v":"125ms","t":"+14.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.715","7.222","83.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.045","4.795","96.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.760","8.764","79.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.647","1.812","85.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.088","2.710","76.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":591},{"label":"Mar","value":457},{"label":"Abr","value":573},{"label":"Mai","value":841},{"label":"Jun","value":515},{"label":"Jul","value":594},{"label":"Ago","value":509},{"label":"Set","value":561},{"label":"Out","value":591},{"label":"Nov","value":607},{"label":"Dez","value":536}];
const MX = 841;
...
export default function ReintegratePage() {
    return (
