...
const KPIS = [{"l":"Total Peacebuilding","v":"271","t":"-5.0%","d":"down"},{"l":"Reconcile Ativos","v":"8.499","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"89.8%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+7.5%","d":"up"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Peacebuilding #001","Peacebuilding #002","1.710","982","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Peacebuilding #002","Peacebuilding #003","1.028","8.387","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Peacebuilding #003","Peacebuilding #004","8.426","1.392","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Peacebuilding #004","Peacebuilding #005","7.360","5.370","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Peacebuilding #005","Peacebuilding #001","5.287","4.606","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":795},{"label":"Mar","value":582},{"label":"Abr","value":668},{"label":"Mai","value":584},{"label":"Jun","value":891},{"label":"Jul","value":563},{"label":"Ago","value":643},{"label":"Set","value":697},{"label":"Out","value":852},{"label":"Nov","value":833},{"label":"Dez","value":655}];
const MX = 891;
