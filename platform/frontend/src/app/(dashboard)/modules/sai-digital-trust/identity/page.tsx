...
const PAGE = "Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.097","t":"+9.3%","d":"up"},{"l":"Sessões/Dia","v":"2884","t":"+0.4%","d":"up"},{"l":"MFA Adoção (%)","v":"81.4%","t":"-4.3%","d":"down"},{"l":"Tentativas Bloqueadas","v":"958","t":"+14.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.000","8.633","5.550","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.198","2.674","5.861","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.287","5.639","1.763","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.130","8.317","3.633","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.909","7.986","7.915","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":612},{"label":"Mar","value":605},{"label":"Abr","value":523},{"label":"Mai","value":416},{"label":"Jun","value":441},{"label":"Jul","value":586},{"label":"Ago","value":464},{"label":"Set","value":521},{"label":"Out","value":532},{"label":"Nov","value":413},{"label":"Dez","value":674}];
const MX = 796;
