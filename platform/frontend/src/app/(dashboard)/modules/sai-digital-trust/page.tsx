...
/* ═══ S-AI Digital Trust Score — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "9372", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3633", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€336K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "248736872", cells: ["SAI-4872", "S-AI Digital Trust Score Item 1", "21/9/2026", "€36 972"], status: "active" as const },
    { id: "248740443", cells: ["SAI-8443", "S-AI Digital Trust Score Item 2", "8/4/2026", "€40 543"], status: "pending" as const },
    { id: "248744014", cells: ["SAI-3014", "S-AI Digital Trust Score Item 3", "23/11/2026", "€44 114"], status: "completed" as const },
    { id: "248747585", cells: ["SAI-6585", "S-AI Digital Trust Score Item 4", "10/6/2026", "€47 685"], status: "warning" as const },
    { id: "248751156", cells: ["SAI-1156", "S-AI Digital Trust Score Item 5", "25/1/2026", "€1256"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 92 }, { label: "Fev", value: 21 }, { label: "Mar", value: 30 }, { label: "Abr", value: 39 }, { label: "Mai", value: 48 }, { label: "Jun", value: 57 }];
...
export default function SaiDigitalTrustScorePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Digital Trust Score</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Digital Trust Score</p>
                    </div>
                </div>
