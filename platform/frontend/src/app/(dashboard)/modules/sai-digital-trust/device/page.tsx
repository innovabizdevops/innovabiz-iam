...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"1.847","t":"-0.1%","d":"down"},{"l":"Dados/Min (MB)","v":"7.083","t":"+2.6%","d":"up"},{"l":"Alertas Ativos","v":"3.307","t":"+5.8%","d":"up"},{"l":"Uptime (%)","v":"71.4%","t":"+2.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.558","3.448","200","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","211","630","4.074","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.204","3.316","1.034","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.403","5.097","946","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.832","3.658","6.322","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":863},{"label":"Mar","value":915},{"label":"Abr","value":683},{"label":"Mai","value":892},{"label":"Jun","value":590},{"label":"Jul","value":605},{"label":"Ago","value":785},{"label":"Set","value":909},{"label":"Out","value":852},{"label":"Nov","value":873},{"label":"Dez","value":746}];
const MX = 915;
