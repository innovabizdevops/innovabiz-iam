...
const PAGE = "Context";
const KPIS = [{"l":"Total Sai Digital Trust","v":"5.905","t":"+17.8%","d":"up"},{"l":"Context Ativos","v":"8.346","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+7.2%","d":"up"}];
const COLS = ["ID","Context","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Digital Trust #001","Sai Digital Trust #002","7.277","138","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Digital Trust #002","Sai Digital Trust #003","363","5.583","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Digital Trust #003","Sai Digital Trust #004","8.279","5.394","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Digital Trust #004","Sai Digital Trust #005","4.174","1.503","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Digital Trust #005","Sai Digital Trust #001","3.435","7.790","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":525},{"label":"Mar","value":663},{"label":"Abr","value":829},{"label":"Mai","value":551},{"label":"Jun","value":583},{"label":"Jul","value":852},{"label":"Ago","value":711},{"label":"Set","value":572},{"label":"Out","value":834},{"label":"Nov","value":844},{"label":"Dez","value":750}];
const MX = 852;
