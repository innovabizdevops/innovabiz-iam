...
const PAGE = "History";
const KPIS = [{"l":"Dispositivos Online","v":"872","t":"+5.5%","d":"up"},{"l":"Dados/Min (MB)","v":"2.939","t":"+16.4%","d":"up"},{"l":"Alertas Ativos","v":"3.910","t":"-3.2%","d":"down"},{"l":"Uptime (%)","v":"65.9%","t":"+0.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.266","4.030","8.442","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.025","961","4.776","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.745","4.041","5.734","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.087","1.016","6.257","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","9.062","1.007","2.956","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":631},{"label":"Mar","value":389},{"label":"Abr","value":710},{"label":"Mai","value":684},{"label":"Jun","value":724},{"label":"Jul","value":433},{"label":"Ago","value":686},{"label":"Set","value":414},{"label":"Out","value":690},{"label":"Nov","value":611},{"label":"Dez","value":565}];
const MX = 724;
