...
const ACCENT = "#6366f1";
const MODULE = "SCADA Control";
const PAGE = "Monitor";
const KPIS = [{"l":"Dispositivos Online","v":"8.319","t":"-4.1%","d":"down"},{"l":"Dados/Min (MB)","v":"5.125","t":"+4.8%","d":"up"},{"l":"Alertas Ativos","v":"6.035","t":"-4.8%","d":"down"},{"l":"Uptime (%)","v":"94.1%","t":"+0.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.464","7.490","5.362","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.713","6.409","3.956","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.688","5.440","5.767","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.904","4.047","469","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.429","414","8.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":274},{"label":"Fev","value":354},{"label":"Mar","value":295},{"label":"Abr","value":325},{"label":"Mai","value":432},{"label":"Jun","value":452},{"label":"Jul","value":410},{"label":"Ago","value":547},{"label":"Set","value":584},{"label":"Out","value":238},{"label":"Nov","value":428},{"label":"Dez","value":292}];
const MX = 584;
