...
const PAGE = "Trending";
const KPIS = [{"l":"Dispositivos Online","v":"7.955","t":"-5.8%","d":"down"},{"l":"Dados/Min (MB)","v":"9.009","t":"+9.2%","d":"up"},{"l":"Alertas Ativos","v":"8.959","t":"+8.5%","d":"up"},{"l":"Uptime (%)","v":"89.0%","t":"+13.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.094","8.601","968","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.092","5.021","3.292","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.387","1.348","1.865","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.916","8.620","237","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.375","1.826","4.401","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":445},{"label":"Mar","value":339},{"label":"Abr","value":448},{"label":"Mai","value":342},{"label":"Jun","value":408},{"label":"Jul","value":259},{"label":"Ago","value":497},{"label":"Set","value":451},{"label":"Out","value":488},{"label":"Nov","value":289},{"label":"Dez","value":595}];
const MX = 595;
