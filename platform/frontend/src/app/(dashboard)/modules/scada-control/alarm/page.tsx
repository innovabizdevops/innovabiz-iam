...
const PAGE = "Alarm";
const KPIS = [{"l":"Dispositivos Online","v":"5.663","t":"+7.7%","d":"up"},{"l":"Dados/Min (MB)","v":"1.796","t":"+8.4%","d":"up"},{"l":"Alertas Ativos","v":"3.833","t":"-5.7%","d":"down"},{"l":"Uptime (%)","v":"84.0%","t":"-1.7%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.615","4.341","6.429","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.378","5.660","1.410","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.050","2.063","144","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.825","4.055","3.576","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.082","6.225","7.591","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":450},{"label":"Mar","value":473},{"label":"Abr","value":437},{"label":"Mai","value":539},{"label":"Jun","value":485},{"label":"Jul","value":640},{"label":"Ago","value":597},{"label":"Set","value":607},{"label":"Out","value":355},{"label":"Nov","value":600},{"label":"Dez","value":602}];
const MX = 640;
