...
const PAGE = "Control";
const KPIS = [{"l":"Dispositivos Online","v":"4.266","t":"+12.3%","d":"up"},{"l":"Dados/Min (MB)","v":"9.051","t":"+6.2%","d":"up"},{"l":"Alertas Ativos","v":"1.003","t":"+12.7%","d":"up"},{"l":"Uptime (%)","v":"71.2%","t":"+0.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.151","6.462","5.908","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.007","5.213","2.366","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.957","3.501","3.083","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.456","2.546","2.472","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","755","8.557","3.395","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":921},{"label":"Mar","value":746},{"label":"Abr","value":790},{"label":"Mai","value":761},{"label":"Jun","value":749},{"label":"Jul","value":869},{"label":"Ago","value":611},{"label":"Set","value":899},{"label":"Out","value":887},{"label":"Nov","value":936},{"label":"Dez","value":817}];
const MX = 936;
