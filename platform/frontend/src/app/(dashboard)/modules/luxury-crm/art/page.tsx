...
const ACCENT = "#78350f";
const MODULE = "Luxury CRM";
const PAGE = "Art Concierge";
const KPIS = [{"l":"Quartos Ocupados","v":"716","t":"+2.1%","d":"up"},{"l":"RevPAR (€)","v":"€33565","t":"+0.4%","d":"up"},{"l":"Ocupação (%)","v":"80.3%","t":"+14.2%","d":"up"},{"l":"Guest Satisfaction","v":"5.471","t":"+2.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.690","2026-02-16","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.785","2026-03-23","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.404","2026-01-14","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.438","2026-03-06","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.025","2026-03-15","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":481},{"label":"Mar","value":474},{"label":"Abr","value":338},{"label":"Mai","value":335},{"label":"Jun","value":402},{"label":"Jul","value":560},{"label":"Ago","value":586},{"label":"Set","value":699},{"label":"Out","value":490},{"label":"Nov","value":366},{"label":"Dez","value":666}];
const MX = 699;
