...
const PAGE = "UHNW Profile";
const KPIS = [{"l":"Perfis Unificados","v":"5.485","t":"+15.5%","d":"up"},{"l":"Segmentos Ativos","v":"5.070","t":"-5.3%","d":"down"},{"l":"NPS Score","v":"80","t":"+1.6%","d":"up"},{"l":"Churn Previsto (%)","v":"73.9%","t":"-4.5%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.939","€ 3774.66","72.8%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.936","€ 46195.01","76.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","4.632","€ 5101.57","83.4%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.771","€ 20719.23","92.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","3.570","€ 6236.52","83.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":521},{"label":"Mar","value":618},{"label":"Abr","value":781},{"label":"Mai","value":736},{"label":"Jun","value":760},{"label":"Jul","value":515},{"label":"Ago","value":817},{"label":"Set","value":564},{"label":"Out","value":563},{"label":"Nov","value":527},{"label":"Dez","value":480}];
const MX = 817;
...
export default function UhnwPage() {
    return (
