...
export default function LuxuryCrmPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Luxury Crm</h1><p className="text-sm text-muted-foreground">Luxury Crm • iBOS Enterprise</p></div>
