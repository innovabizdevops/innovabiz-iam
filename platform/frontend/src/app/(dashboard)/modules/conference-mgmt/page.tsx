...
const KPIS = [
    ...
    { label: "Ativos", value: "3584", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€173K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1654335175", cells: ["CON-1175", "Conference Management Item 1", "4/8/2026", "€35 275"], status: "active" as const },
    { id: "1654338746", cells: ["CON-4746", "Conference Management Item 2", "19/3/2026", "€38 846"], status: "pending" as const },
    { id: "1654342317", cells: ["CON-8317", "Conference Management Item 3", "6/10/2026", "€42 417"], status: "completed" as const },
    { id: "1654345888", cells: ["CON-2888", "Conference Management Item 4", "21/5/2026", "€45 988"], status: "warning" as const },
    { id: "1654349459", cells: ["CON-6459", "Conference Management Item 5", "8/12/2026", "€49 559"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conference Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Conference Management</p>
                    </div>
                </div>
