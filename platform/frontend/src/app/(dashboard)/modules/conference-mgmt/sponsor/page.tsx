...
const PAGE = "Sponsor";
const KPIS = [{"l":"Eventos Planeados","v":"6.048","t":"+7.5%","d":"up"},{"l":"Participantes","v":"5.132","t":"+15.1%","d":"up"},{"l":"NPS Evento","v":"60","t":"+17.3%","d":"up"},{"l":"Receita (€)","v":"€66760","t":"+16.0%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-27","3.334","735","€ 8483.21","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-09","3.954","1.992","€ 17225.90","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-26","8.320","8.124","€ 28129.10","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-26","7.804","4.600","€ 16553.83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-10","4.163","8.827","€ 24093.47","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":778},{"label":"Mar","value":602},{"label":"Abr","value":594},{"label":"Mai","value":546},{"label":"Jun","value":729},{"label":"Jul","value":788},{"label":"Ago","value":546},{"label":"Set","value":780},{"label":"Out","value":710},{"label":"Nov","value":737},{"label":"Dez","value":829}];
const MX = 829;
