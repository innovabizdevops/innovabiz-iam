...
const KPIS = [{"l":"Dashboards Ativos","v":"1.016","t":"+6.9%","d":"up"},{"l":"Queries/Dia","v":"4466","t":"+11.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.094","t":"+3.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.543","t":"-4.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4112","2026-03-04","5.183","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3845","2026-02-27","2.338","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3853","2026-01-03","1.426","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","910","2026-01-20","815","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","664","2026-02-08","2.602","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":435},{"label":"Mar","value":393},{"label":"Abr","value":617},{"label":"Mai","value":434},{"label":"Jun","value":576},{"label":"Jul","value":423},{"label":"Ago","value":443},{"label":"Set","value":658},{"label":"Out","value":556},{"label":"Nov","value":337},{"label":"Dez","value":653}];
const MX = 658;
