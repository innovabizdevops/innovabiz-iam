...
const ACCENT = "#ec4899";
const MODULE = "Conference Management";
const PAGE = "Program";
const KPIS = [{"l":"Total Conference Mgmt","v":"7.414","t":"+13.3%","d":"up"},{"l":"Program Ativos","v":"9.003","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+8.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+11.6%","d":"up"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Conference Mgmt #001","Conference Mgmt #002","5.052","2.075","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Conference Mgmt #002","Conference Mgmt #003","1.321","2.430","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Conference Mgmt #003","Conference Mgmt #004","2.024","7.554","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Conference Mgmt #004","Conference Mgmt #005","3.339","7.150","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Conference Mgmt #005","Conference Mgmt #001","5.170","1.684","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":844},{"label":"Mar","value":909},{"label":"Abr","value":933},{"label":"Mai","value":706},{"label":"Jun","value":754},{"label":"Jul","value":692},{"label":"Ago","value":950},{"label":"Set","value":725},{"label":"Out","value":865},{"label":"Nov","value":995},{"label":"Dez","value":802}];
const MX = 995;
