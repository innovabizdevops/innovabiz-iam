...
export default function FoodSafetyAiPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Food Safety Ai</h1><p className="text-sm text-muted-foreground">Food Safety Ai • iBOS Enterprise</p></div>
