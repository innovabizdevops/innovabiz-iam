...
/* ═══ Fashion Wholesale / B2B — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "1156", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2245", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€58K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "957093456", cells: ["FAS-7456", "Fashion Wholesale / B2B Item 1", "5/1/2026", "€43 556"], status: "active" as const },
    { id: "957097027", cells: ["FAS-2027", "Fashion Wholesale / B2B Item 2", "20/8/2026", "€47 127"], status: "pending" as const },
    { id: "957100598", cells: ["FAS-5598", "Fashion Wholesale / B2B Item 3", "7/3/2026", "€698"], status: "completed" as const },
    { id: "957104169", cells: ["FAS-9169", "Fashion Wholesale / B2B Item 4", "22/10/2026", "€4269"], status: "warning" as const },
    { id: "957107740", cells: ["FAS-3740", "Fashion Wholesale / B2B Item 5", "9/5/2026", "€7840"], status: "active" as const },
];
...
export default function FashionWholesaleB2bPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion Wholesale / B2B</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion Wholesale / B2B</p>
                    </div>
                </div>
