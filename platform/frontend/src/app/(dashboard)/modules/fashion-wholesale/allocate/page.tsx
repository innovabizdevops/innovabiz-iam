...
const ACCENT = "#be185d";
const MODULE = "Fashion Wholesale / B2B";
const PAGE = "Allocate";
const KPIS = [{"l":"Total Fashion Wholesale","v":"8.951","t":"+11.6%","d":"up"},{"l":"Allocate Ativos","v":"6.514","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+14.5%","d":"up"}];
const COLS = ["ID","Allocate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fashion Wholesale #001","Fashion Wholesale #002","6.044","8.890","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Fashion Wholesale #002","Fashion Wholesale #003","252","523","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Fashion Wholesale #003","Fashion Wholesale #004","6.396","7.239","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Fashion Wholesale #004","Fashion Wholesale #005","7.290","4.145","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fashion Wholesale #005","Fashion Wholesale #001","4.210","4.803","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":952},{"label":"Fev","value":776},{"label":"Mar","value":1024},{"label":"Abr","value":891},{"label":"Mai","value":677},{"label":"Jun","value":1020},{"label":"Jul","value":946},{"label":"Ago","value":915},{"label":"Set","value":715},{"label":"Out","value":835},{"label":"Nov","value":822},{"label":"Dez","value":980}];
const MX = 1024;
