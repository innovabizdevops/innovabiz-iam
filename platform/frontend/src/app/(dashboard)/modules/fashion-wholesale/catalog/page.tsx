...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"2.110","t":"+13.1%","d":"up"},{"l":"Queries/Dia","v":"776","t":"+6.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.047","t":"-0.9%","d":"down"},{"l":"Utilizadores Analytics","v":"1.198","t":"+17.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1308","2026-03-26","3.668","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2754","2026-02-10","5.573","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4247","2026-02-26","8.683","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1538","2026-01-15","6.351","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","576","2026-03-10","3.087","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":398},{"label":"Mar","value":358},{"label":"Abr","value":395},{"label":"Mai","value":541},{"label":"Jun","value":363},{"label":"Jul","value":571},{"label":"Ago","value":445},{"label":"Set","value":303},{"label":"Out","value":652},{"label":"Nov","value":442},{"label":"Dez","value":563}];
const MX = 652;
