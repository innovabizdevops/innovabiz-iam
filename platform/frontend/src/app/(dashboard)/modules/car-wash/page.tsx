...
/* ═══ Car Wash Mgmt — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "3327", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1247", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€471K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1286082527", cells: ["CAR-1527", "Car Wash Mgmt Item 1", "24/12/2026", "€32 627"], status: "active" as const },
    { id: "1286086098", cells: ["CAR-5098", "Car Wash Mgmt Item 2", "11/7/2026", "€36 198"], status: "pending" as const },
    { id: "1286089669", cells: ["CAR-8669", "Car Wash Mgmt Item 3", "26/2/2026", "€39 769"], status: "completed" as const },
    { id: "1286093240", cells: ["CAR-3240", "Car Wash Mgmt Item 4", "13/9/2026", "€43 340"], status: "warning" as const },
    { id: "1286096811", cells: ["CAR-6811", "Car Wash Mgmt Item 5", "28/4/2026", "€46 911"], status: "active" as const },
];
...
export default function CarWashMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Car Wash Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Car Wash Mgmt</p>
                    </div>
                </div>
