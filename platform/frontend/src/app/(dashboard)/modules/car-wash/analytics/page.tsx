...
const ACCENT = "#059669";
const MODULE = "Car Wash Mgmt";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.454","t":"+7.7%","d":"up"},{"l":"Queries/Dia","v":"5025","t":"+15.0%","d":"up"},{"l":"Dados Processados (GB)","v":"2.972","t":"+2.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.802","t":"+11.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","152","2026-01-26","2.896","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1140","2026-02-15","8.752","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3482","2026-02-26","8.052","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5050","2026-02-24","2.400","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2968","2026-03-22","7.261","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":370},{"label":"Mar","value":699},{"label":"Abr","value":416},{"label":"Mai","value":664},{"label":"Jun","value":712},{"label":"Jul","value":557},{"label":"Ago","value":453},{"label":"Set","value":650},{"label":"Out","value":712},{"label":"Nov","value":727},{"label":"Dez","value":554}];
const MX = 727;
