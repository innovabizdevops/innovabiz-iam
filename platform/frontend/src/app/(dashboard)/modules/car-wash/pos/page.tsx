...
const PAGE = "POS";
const KPIS = [{"l":"Pedidos/Dia","v":"1951","t":"-5.0%","d":"down"},{"l":"GMV (€)","v":"€33648","t":"+13.8%","d":"up"},{"l":"Conversão (%)","v":"66.0%","t":"+10.0%","d":"up"},{"l":"AOV (€)","v":"€29398","t":"-4.7%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 44500.64","1.216","8.213","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 24719.62","6.200","272","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 30797.52","1.140","5.822","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 39722.12","7.435","5.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 26291.43","3.511","3.679","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1025},{"label":"Fev","value":798},{"label":"Mar","value":1083},{"label":"Abr","value":1030},{"label":"Mai","value":1071},{"label":"Jun","value":872},{"label":"Jul","value":736},{"label":"Ago","value":841},{"label":"Set","value":1062},{"label":"Out","value":766},{"label":"Nov","value":986},{"label":"Dez","value":747}];
const MX = 1083;
