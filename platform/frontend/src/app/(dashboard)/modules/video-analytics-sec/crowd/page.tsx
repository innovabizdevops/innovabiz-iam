...
const PAGE = "Crowd";
const KPIS = [{"l":"Dashboards Ativos","v":"4.117","t":"+14.6%","d":"up"},{"l":"Queries/Dia","v":"936","t":"-3.7%","d":"down"},{"l":"Dados Processados (GB)","v":"5.695","t":"+4.7%","d":"up"},{"l":"Utilizadores Analytics","v":"1.702","t":"+15.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4770","2026-03-01","6.592","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2859","2026-02-11","4.397","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4722","2026-01-28","299","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2467","2026-03-24","1.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4026","2026-02-13","6.720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":778},{"label":"Mar","value":870},{"label":"Abr","value":549},{"label":"Mai","value":567},{"label":"Jun","value":521},{"label":"Jul","value":877},{"label":"Ago","value":850},{"label":"Set","value":634},{"label":"Out","value":817},{"label":"Nov","value":839},{"label":"Dez","value":607}];
const MX = 877;
