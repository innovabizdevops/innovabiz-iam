...
const ACCENT = "#6366f1";
const MODULE = "Video Analytics";
const PAGE = "Object Detect";
const KPIS = [{"l":"Dashboards Ativos","v":"4.706","t":"+14.9%","d":"up"},{"l":"Queries/Dia","v":"1020","t":"+8.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.516","t":"+12.3%","d":"up"},{"l":"Utilizadores Analytics","v":"3.720","t":"+12.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2404","2026-01-11","123","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2080","2026-01-15","5.950","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","810","2026-01-07","824","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1241","2026-03-11","3.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2333","2026-02-10","6.120","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":633},{"label":"Mar","value":487},{"label":"Abr","value":692},{"label":"Mai","value":545},{"label":"Jun","value":710},{"label":"Jul","value":510},{"label":"Ago","value":628},{"label":"Set","value":714},{"label":"Out","value":724},{"label":"Nov","value":410},{"label":"Dez","value":382}];
const MX = 724;
