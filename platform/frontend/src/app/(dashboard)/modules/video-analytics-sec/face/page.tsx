...
const PAGE = "Face";
const KPIS = [{"l":"Dashboards Ativos","v":"969","t":"-1.5%","d":"down"},{"l":"Queries/Dia","v":"951","t":"-0.4%","d":"down"},{"l":"Dados Processados (GB)","v":"8.203","t":"-0.5%","d":"down"},{"l":"Utilizadores Analytics","v":"7.776","t":"+17.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","248","2026-02-28","4.738","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1978","2026-01-12","7.869","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2844","2026-03-10","6.336","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2015","2026-01-08","4.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1989","2026-02-10","3.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":634},{"label":"Mar","value":741},{"label":"Abr","value":770},{"label":"Mai","value":716},{"label":"Jun","value":728},{"label":"Jul","value":534},{"label":"Ago","value":716},{"label":"Set","value":815},{"label":"Out","value":598},{"label":"Nov","value":449},{"label":"Dez","value":572}];
const MX = 815;
