...
export default function VideoAnalyticsSecPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Video Analytics Sec</h1><p className="text-sm text-muted-foreground">Video Analytics Sec • iBOS Enterprise</p></div>
