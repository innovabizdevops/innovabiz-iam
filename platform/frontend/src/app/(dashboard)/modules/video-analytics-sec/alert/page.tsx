...
const PAGE = "Alert";
const KPIS = [{"l":"Dashboards Ativos","v":"7.701","t":"+4.5%","d":"up"},{"l":"Queries/Dia","v":"968","t":"+14.6%","d":"up"},{"l":"Dados Processados (GB)","v":"7.545","t":"+6.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.724","t":"+12.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","312","2026-01-18","3.330","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3821","2026-02-25","4.058","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4883","2026-02-08","6.359","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","705","2026-03-22","8.754","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1305","2026-01-20","1.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":821},{"label":"Mar","value":736},{"label":"Abr","value":813},{"label":"Mai","value":982},{"label":"Jun","value":946},{"label":"Jul","value":980},{"label":"Ago","value":701},{"label":"Set","value":1051},{"label":"Out","value":769},{"label":"Nov","value":698},{"label":"Dez","value":747}];
const MX = 1051;
