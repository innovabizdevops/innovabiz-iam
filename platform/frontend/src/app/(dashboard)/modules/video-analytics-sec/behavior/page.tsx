...
const PAGE = "Behavior";
const KPIS = [{"l":"Dashboards Ativos","v":"7.860","t":"+9.2%","d":"up"},{"l":"Queries/Dia","v":"1049","t":"-0.1%","d":"down"},{"l":"Dados Processados (GB)","v":"1.988","t":"-1.4%","d":"down"},{"l":"Utilizadores Analytics","v":"5.828","t":"+15.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3713","2026-03-19","2.449","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1337","2026-02-26","1.723","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1339","2026-03-24","8.421","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4125","2026-01-28","557","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","607","2026-01-21","2.364","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":539},{"label":"Mar","value":314},{"label":"Abr","value":376},{"label":"Mai","value":587},{"label":"Jun","value":585},{"label":"Jul","value":610},{"label":"Ago","value":408},{"label":"Set","value":549},{"label":"Out","value":601},{"label":"Nov","value":580},{"label":"Dez","value":531}];
const MX = 610;
