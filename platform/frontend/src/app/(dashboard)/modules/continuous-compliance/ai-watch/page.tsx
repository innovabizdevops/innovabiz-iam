...
const PAGE = "Regulatory AI Watch";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.543","t":"+6.0%","d":"up"},{"l":"NC Abertas","v":"3.465","t":"+4.5%","d":"up"},{"l":"Conformidade (%)","v":"88.5%","t":"+13.7%","d":"up"},{"l":"CAPAs Pendentes","v":"4.506","t":"+7.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","935","90.2%","4.457","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.860","81.3%","4.807","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.261","79.0%","6.206","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.753","81.3%","7.468","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.934","97.3%","4.419","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":233},{"label":"Fev","value":570},{"label":"Mar","value":221},{"label":"Abr","value":262},{"label":"Mai","value":390},{"label":"Jun","value":385},{"label":"Jul","value":486},{"label":"Ago","value":498},{"label":"Set","value":540},{"label":"Out","value":564},{"label":"Nov","value":357},{"label":"Dez","value":514}];
const MX = 570;
