...
const ACCENT = "#166534";
const MODULE = "Continuous Compliance";
const PAGE = "Audit Readiness AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.198","t":"+10.8%","d":"up"},{"l":"NC Abertas","v":"4.273","t":"+10.4%","d":"up"},{"l":"Conformidade (%)","v":"88.6%","t":"+0.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.587","t":"+5.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.522","87.7%","7.922","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.997","85.3%","4.962","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.273","85.3%","7.933","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.842","91.6%","6.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.904","79.5%","4.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":752},{"label":"Mar","value":666},{"label":"Abr","value":612},{"label":"Mai","value":467},{"label":"Jun","value":492},{"label":"Jul","value":759},{"label":"Ago","value":756},{"label":"Set","value":560},{"label":"Out","value":719},{"label":"Nov","value":543},{"label":"Dez","value":731}];
const MX = 759;
