...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.251","t":"-4.0%","d":"down"},{"l":"NC Abertas","v":"3.457","t":"-3.8%","d":"down"},{"l":"Conformidade (%)","v":"76.8%","t":"-0.7%","d":"down"},{"l":"CAPAs Pendentes","v":"4.062","t":"-1.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.660","82.4%","8.401","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.502","95.0%","4.317","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.479","85.5%","5.749","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.150","74.5%","6.088","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.267","79.2%","6.522","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":654},{"label":"Mar","value":600},{"label":"Abr","value":649},{"label":"Mai","value":690},{"label":"Jun","value":619},{"label":"Jul","value":698},{"label":"Ago","value":626},{"label":"Set","value":422},{"label":"Out","value":704},{"label":"Nov","value":608},{"label":"Dez","value":509}];
const MX = 704;
