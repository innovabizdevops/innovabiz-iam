...
const PAGE = "Control Automation";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.407","t":"+5.6%","d":"up"},{"l":"NC Abertas","v":"8.800","t":"-3.5%","d":"down"},{"l":"Conformidade (%)","v":"93.6%","t":"+11.6%","d":"up"},{"l":"CAPAs Pendentes","v":"8.088","t":"+4.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.645","70.5%","2.064","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.554","71.2%","6.408","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.795","97.3%","4.212","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.656","84.9%","4.062","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.239","77.7%","1.637","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":530},{"label":"Mar","value":340},{"label":"Abr","value":440},{"label":"Mai","value":481},{"label":"Jun","value":359},{"label":"Jul","value":650},{"label":"Ago","value":399},{"label":"Set","value":673},{"label":"Out","value":510},{"label":"Nov","value":678},{"label":"Dez","value":547}];
const MX = 678;
