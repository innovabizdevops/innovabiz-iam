...
const PAGE = "Regulation Tracker";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.013","t":"+9.8%","d":"up"},{"l":"NC Abertas","v":"6.169","t":"+14.2%","d":"up"},{"l":"Conformidade (%)","v":"83.7%","t":"+10.1%","d":"up"},{"l":"CAPAs Pendentes","v":"915","t":"+6.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.034","75.0%","8.143","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.891","77.0%","626","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.715","96.7%","4.994","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.382","80.6%","1.543","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.015","82.8%","225","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":416},{"label":"Mar","value":506},{"label":"Abr","value":472},{"label":"Mai","value":662},{"label":"Jun","value":578},{"label":"Jul","value":579},{"label":"Ago","value":722},{"label":"Set","value":555},{"label":"Out","value":409},{"label":"Nov","value":723},{"label":"Dez","value":547}];
const MX = 723;
