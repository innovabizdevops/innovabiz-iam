...
const PAGE = "Policy-as-Code";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.851","t":"+2.6%","d":"up"},{"l":"NC Abertas","v":"9.026","t":"+12.1%","d":"up"},{"l":"Conformidade (%)","v":"85.4%","t":"+9.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.582","t":"+16.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.442","92.3%","7.733","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.059","83.1%","4.499","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.485","73.7%","7.572","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.184","99.1%","9.053","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.213","70.2%","832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":1067},{"label":"Mar","value":959},{"label":"Abr","value":1045},{"label":"Mai","value":1017},{"label":"Jun","value":685},{"label":"Jul","value":745},{"label":"Ago","value":925},{"label":"Set","value":832},{"label":"Out","value":990},{"label":"Nov","value":1007},{"label":"Dez","value":1044}];
const MX = 1067;
...
export default function PolicyCodePage() {
    return (
