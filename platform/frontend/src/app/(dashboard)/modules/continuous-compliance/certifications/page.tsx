...
const PAGE = "Certification Mgmt";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.097","t":"+8.4%","d":"up"},{"l":"NC Abertas","v":"1.049","t":"+8.2%","d":"up"},{"l":"Conformidade (%)","v":"80.3%","t":"+14.1%","d":"up"},{"l":"CAPAs Pendentes","v":"1.589","t":"+7.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.511","72.6%","5.967","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.183","83.2%","2.557","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.995","75.9%","1.802","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.958","86.9%","4.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.533","71.7%","6.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":534},{"label":"Mar","value":704},{"label":"Abr","value":586},{"label":"Mai","value":643},{"label":"Jun","value":733},{"label":"Jul","value":469},{"label":"Ago","value":857},{"label":"Set","value":585},{"label":"Out","value":491},{"label":"Nov","value":536},{"label":"Dez","value":528}];
const MX = 857;
