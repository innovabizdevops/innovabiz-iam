...
const PAGE = "Evidence Collection";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.170","t":"-2.1%","d":"down"},{"l":"NC Abertas","v":"4.129","t":"+7.3%","d":"up"},{"l":"Conformidade (%)","v":"78.5%","t":"+17.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.651","t":"+15.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.786","82.0%","270","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.101","84.3%","8.678","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.804","86.4%","5.534","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","871","92.1%","8.283","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.738","79.5%","5.824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":527},{"label":"Mar","value":747},{"label":"Abr","value":704},{"label":"Mai","value":525},{"label":"Jun","value":802},{"label":"Jul","value":762},{"label":"Ago","value":455},{"label":"Set","value":609},{"label":"Out","value":788},{"label":"Nov","value":602},{"label":"Dez","value":549}];
const MX = 812;
