...
const PAGE = "Digital Signature Doc";
const KPIS = [{"l":"Documentos Total","v":"847K","d":"+8.2%","u":true},{"l":"Digitalizados (%)","v":"94.3%","d":"+2.1%","u":true},{"l":"Pendentes Aprovação","v":"1,247","d":"-3.4%","u":false},{"l":"Compliance (%)","v":"98.1%","d":"+0.5%","u":true}];
const COLS = ["Documento","Categoria","Versão","Autor","Data","Estado"];
const ROWS = [
  { id: "001", c: ["Digital Signature Doc-001", "Digital Signature Doc Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Digital Signature Doc-002", "Digital Signature Doc Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Digital Signature Doc-003", "Digital Signature Doc Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Digital Signature Doc-004", "Digital Signature Doc Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Digital Signature Doc-005", "Digital Signature Doc Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Digital Signature Doc", ts: "Há 2min", a: "Sistema" },
...
export default function DigitalSignatureDocPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Document Mgmt — iBOS Enterprise</p>
        </div>
