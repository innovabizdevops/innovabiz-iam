...
const ROWS = [
  { id: "001", c: ["Workflow Approval-001", "Workflow Approval Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Workflow Approval-002", "Workflow Approval Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Workflow Approval-003", "Workflow Approval Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Workflow Approval-004", "Workflow Approval Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Workflow Approval-005", "Workflow Approval Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Workflow Approval", ts: "Há 2min", a: "Sistema" },
