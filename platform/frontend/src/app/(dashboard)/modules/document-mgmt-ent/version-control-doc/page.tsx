...
const PAGE = "Version Control Doc";
...
const ROWS = [
  { id: "001", c: ["Version Control Doc-001", "Version Control Doc Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Version Control Doc-002", "Version Control Doc Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Version Control Doc-003", "Version Control Doc Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Version Control Doc-004", "Version Control Doc Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Version Control Doc-005", "Version Control Doc Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Version Control Doc", ts: "Há 2min", a: "Sistema" },
...
export default function VersionControlDocPage() {
  return (
