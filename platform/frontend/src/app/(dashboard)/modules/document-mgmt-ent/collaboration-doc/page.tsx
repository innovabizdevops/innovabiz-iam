...
const ROWS = [
  { id: "001", c: ["Collaboration Doc-001", "Collaboration Doc Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Collaboration Doc-002", "Collaboration Doc Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Collaboration Doc-003", "Collaboration Doc Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Collaboration Doc-004", "Collaboration Doc Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Collaboration Doc-005", "Collaboration Doc Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Collaboration Doc", ts: "Há 2min", a: "Sistema" },
...
export default function CollaborationDocPage() {
  return (
