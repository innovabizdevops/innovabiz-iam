...
const ROWS = [
  { id: "001", c: ["Doc Classify-001", "Doc Classify Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Doc Classify-002", "Doc Classify Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Doc Classify-003", "Doc Classify Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Doc Classify-004", "Doc Classify Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Doc Classify-005", "Doc Classify Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Doc Classify", ts: "Há 2min", a: "Sistema" },
...
export default function DocClassifyPage() {
  return (
