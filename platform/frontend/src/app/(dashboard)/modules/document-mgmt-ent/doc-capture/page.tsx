...
const ROWS = [
  { id: "001", c: ["Doc Capture-001", "Doc Capture Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Doc Capture-002", "Doc Capture Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Doc Capture-003", "Doc Capture Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Doc Capture-004", "Doc Capture Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Doc Capture-005", "Doc Capture Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Doc Capture", ts: "Há 2min", a: "Sistema" },
...
export default function DocCapturePage() {
  return (
