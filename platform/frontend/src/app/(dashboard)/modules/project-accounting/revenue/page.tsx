...
const PAGE = "Revenue Booking";
const KPIS = [{"l":"ARR (€M)","v":"€22.8M","t":"+14.0%","d":"up"},{"l":"MRR (€)","v":"€13406","t":"+17.4%","d":"up"},{"l":"Churn (%)","v":"69.2%","t":"-0.6%","d":"down"},{"l":"ARPU (€)","v":"€90843","t":"+17.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 41818.10","7.105","€ 47521.54","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14140.31","7.017","€ 25729.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 15228.01","3.812","€ 3450.64","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 873.70","6.259","€ 30148.00","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 33899.97","7.964","€ 49837.92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":840},{"label":"Mar","value":716},{"label":"Abr","value":875},{"label":"Mai","value":714},{"label":"Jun","value":661},{"label":"Jul","value":824},{"label":"Ago","value":804},{"label":"Set","value":719},{"label":"Out","value":872},{"label":"Nov","value":883},{"label":"Dez","value":712}];
const MX = 883;
