...
const ACCENT = "#ec4899";
const MODULE = "Project Accounting";
const PAGE = "Billing Milestones";
const KPIS = [{"l":"Total Project Accounting","v":"3.492","t":"-0.9%","d":"down"},{"l":"Billing Milestones Ativos","v":"3.611","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"55","t":"-3.1%","d":"down"}];
const COLS = ["ID","Billing Milestones","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Project Accounting #001","Project Accounting #002","8.119","3.093","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Project Accounting #002","Project Accounting #003","3.369","7.672","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Project Accounting #003","Project Accounting #004","7.993","3.552","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Project Accounting #004","Project Accounting #005","3.462","6.891","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Project Accounting #005","Project Accounting #001","6.145","8.124","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":968},{"label":"Fev","value":822},{"label":"Mar","value":1027},{"label":"Abr","value":880},{"label":"Mai","value":930},{"label":"Jun","value":741},{"label":"Jul","value":823},{"label":"Ago","value":880},{"label":"Set","value":746},{"label":"Out","value":750},{"label":"Nov","value":983},{"label":"Dez","value":809}];
const MX = 1027;
