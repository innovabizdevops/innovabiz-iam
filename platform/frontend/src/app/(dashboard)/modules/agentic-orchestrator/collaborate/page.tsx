...
const KPIS = [{"l":"Teams Ativos","v":"1.645","t":"+0.0%","d":"up"},{"l":"Reuniões/Semana","v":"3430","t":"+9.5%","d":"up"},{"l":"Mensagens/Dia","v":"2120","t":"+5.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"226","t":"+8.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.452","1648","6.831","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.066","3950","1.565","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.716","2807","1.231","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.604","3043","3.093","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.073","1665","2.761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":628},{"label":"Mar","value":410},{"label":"Abr","value":523},{"label":"Mai","value":372},{"label":"Jun","value":511},{"label":"Jul","value":564},{"label":"Ago","value":594},{"label":"Set","value":705},{"label":"Out","value":726},{"label":"Nov","value":675},{"label":"Dez","value":602}];
const MX = 726;
