...
/* ═══ Agentic AI Orchestrator — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "2753", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1993", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€73K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1674003553", cells: ["AGE-4553", "Agentic AI Orchestrator Item 1", "6/2/2026", "€3653"], status: "active" as const },
    { id: "1674007124", cells: ["AGE-8124", "Agentic AI Orchestrator Item 2", "21/9/2026", "€7224"], status: "pending" as const },
    { id: "1674010695", cells: ["AGE-2695", "Agentic AI Orchestrator Item 3", "8/4/2026", "€10 795"], status: "completed" as const },
    { id: "1674014266", cells: ["AGE-6266", "Agentic AI Orchestrator Item 4", "23/11/2026", "€14 366"], status: "warning" as const },
    { id: "1674017837", cells: ["AGE-9837", "Agentic AI Orchestrator Item 5", "10/6/2026", "€17 937"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agentic AI Orchestrator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Agentic AI Orchestrator</p>
                    </div>
                </div>
