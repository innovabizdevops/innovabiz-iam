...
const ACCENT = "#6366f1";
const MODULE = "Agentic AI Orchestrator";
const PAGE = "Evaluate";
const KPIS = [{"l":"Total Agentic Orchestrator","v":"5.709","t":"-2.9%","d":"down"},{"l":"Evaluate Ativos","v":"2.003","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"64","t":"+8.7%","d":"up"}];
const COLS = ["ID","Evaluate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agentic Orchestrator #001","Agentic Orchestrator #002","5.136","1.142","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Agentic Orchestrator #002","Agentic Orchestrator #003","5.369","8.545","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Agentic Orchestrator #003","Agentic Orchestrator #004","8.516","8.992","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Agentic Orchestrator #004","Agentic Orchestrator #005","4.381","2.017","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agentic Orchestrator #005","Agentic Orchestrator #001","5.042","7.114","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":954},{"label":"Mar","value":878},{"label":"Abr","value":727},{"label":"Mai","value":690},{"label":"Jun","value":963},{"label":"Jul","value":605},{"label":"Ago","value":920},{"label":"Set","value":825},{"label":"Out","value":965},{"label":"Nov","value":678},{"label":"Dez","value":748}];
const MX = 965;
