...
const ACCENT = "#dc2626";
const MODULE = "Drug Safety Database";
const PAGE = "Aggregate Report";
const KPIS = [{"l":"Total Drug Safety","v":"7.429","t":"+3.7%","d":"up"},{"l":"Aggregate Report Ativos","v":"7.214","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+3.2%","d":"up"}];
const COLS = ["ID","Aggregate Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Safety #001","Drug Safety #002","3.431","2.599","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Safety #002","Drug Safety #003","4.022","5.681","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Safety #003","Drug Safety #004","8.904","1.292","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Safety #004","Drug Safety #005","3.549","9.044","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Safety #005","Drug Safety #001","866","5.256","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":454},{"label":"Mar","value":553},{"label":"Abr","value":365},{"label":"Mai","value":252},{"label":"Jun","value":449},{"label":"Jul","value":565},{"label":"Ago","value":391},{"label":"Set","value":515},{"label":"Out","value":569},{"label":"Nov","value":609},{"label":"Dez","value":253}];
const MX = 609;
