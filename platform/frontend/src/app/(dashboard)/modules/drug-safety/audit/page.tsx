...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.639","t":"-0.7%","d":"down"},{"l":"NC Abertas","v":"4.106","t":"+8.8%","d":"up"},{"l":"Conformidade (%)","v":"75.9%","t":"+16.3%","d":"up"},{"l":"CAPAs Pendentes","v":"979","t":"+4.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.012","78.5%","4.709","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.743","99.6%","4.525","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.523","79.5%","5.821","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.065","97.9%","6.486","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.011","88.8%","1.643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":780},{"label":"Mar","value":715},{"label":"Abr","value":601},{"label":"Mai","value":783},{"label":"Jun","value":899},{"label":"Jul","value":618},{"label":"Ago","value":620},{"label":"Set","value":603},{"label":"Out","value":721},{"label":"Nov","value":889},{"label":"Dez","value":903}];
const MX = 903;
