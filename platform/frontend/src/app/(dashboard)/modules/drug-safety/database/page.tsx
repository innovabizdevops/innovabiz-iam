...
const PAGE = "AE Database";
const KPIS = [{"l":"Total Drug Safety","v":"4.153","t":"+7.1%","d":"up"},{"l":"AE Database Ativos","v":"6.199","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"93","t":"+13.1%","d":"up"}];
const COLS = ["ID","AE Database","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Safety #001","2026-03-20","6.957","5.159","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Safety #002","2026-03-20","6.088","7.085","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Safety #003","2026-01-06","6.451","4.906","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Safety #004","2026-03-24","2.421","2.281","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Safety #005","2026-02-28","8.547","4.412","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":252},{"label":"Mar","value":590},{"label":"Abr","value":605},{"label":"Mai","value":616},{"label":"Jun","value":563},{"label":"Jul","value":375},{"label":"Ago","value":575},{"label":"Set","value":256},{"label":"Out","value":613},{"label":"Nov","value":432},{"label":"Dez","value":462}];
const MX = 616;
