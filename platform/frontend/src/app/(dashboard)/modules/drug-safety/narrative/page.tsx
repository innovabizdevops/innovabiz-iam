...
const KPIS = [{"l":"ARR (€M)","v":"€45.3M","t":"+4.3%","d":"up"},{"l":"MRR (€)","v":"€57373","t":"+16.8%","d":"up"},{"l":"Churn (%)","v":"78.8%","t":"+5.6%","d":"up"},{"l":"ARPU (€)","v":"€11096","t":"+16.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13636.55","1.087","€ 400.87","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 1574.36","534","€ 35528.18","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 14305.60","292","€ 6910.04","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47569.15","6.757","€ 18865.33","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24933.34","8.172","€ 36206.31","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":601},{"label":"Mar","value":493},{"label":"Abr","value":715},{"label":"Mai","value":678},{"label":"Jun","value":558},{"label":"Jul","value":541},{"label":"Ago","value":562},{"label":"Set","value":549},{"label":"Out","value":663},{"label":"Nov","value":500},{"label":"Dez","value":560}];
const MX = 715;
