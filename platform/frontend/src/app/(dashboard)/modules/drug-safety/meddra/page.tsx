...
const PAGE = "MedDRA Code";
const KPIS = [{"l":"Total Drug Safety","v":"5.010","t":"-0.7%","d":"down"},{"l":"MedDRA Code Ativos","v":"7.700","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"84.6%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"64","t":"-4.3%","d":"down"}];
const COLS = ["ID","MedDRA Code","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Safety #001","Drug Safety #002","8.757","1.993","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Safety #002","Drug Safety #003","3.375","8.198","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Safety #003","Drug Safety #004","6.064","8.813","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Safety #004","Drug Safety #005","8.264","7.637","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Safety #005","Drug Safety #001","2.174","5.787","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":677},{"label":"Mar","value":718},{"label":"Abr","value":672},{"label":"Mai","value":570},{"label":"Jun","value":603},{"label":"Jul","value":505},{"label":"Ago","value":820},{"label":"Set","value":573},{"label":"Out","value":826},{"label":"Nov","value":614},{"label":"Dez","value":793}];
const MX = 826;
