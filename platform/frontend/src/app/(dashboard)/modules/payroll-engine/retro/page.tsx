...
const PAGE = "Retro Pay";
const KPIS = [{"l":"Total Payroll Engine","v":"9.084","t":"+8.6%","d":"up"},{"l":"Retro Pay Ativos","v":"7.029","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"68","t":"+4.4%","d":"up"}];
const COLS = ["ID","Retro Pay","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Engine #001","Payroll Engine #002","6.239","1.062","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Engine #002","Payroll Engine #003","4.381","6.657","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Engine #003","Payroll Engine #004","5.041","6.650","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Engine #004","Payroll Engine #005","7.470","4.784","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Engine #005","Payroll Engine #001","675","5.823","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":552},{"label":"Mar","value":647},{"label":"Abr","value":373},{"label":"Mai","value":306},{"label":"Jun","value":335},{"label":"Jul","value":525},{"label":"Ago","value":286},{"label":"Set","value":367},{"label":"Out","value":286},{"label":"Nov","value":277},{"label":"Dez","value":407}];
const MX = 647;
