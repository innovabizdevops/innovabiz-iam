...
const KPIS = [{"l":"Total Payroll Engine","v":"7.979","t":"+15.8%","d":"up"},{"l":"Benefits Admin Ativos","v":"3.557","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"88.5%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"94","t":"-5.6%","d":"down"}];
const COLS = ["ID","Benefits Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Engine #001","Payroll Engine #002","1.384","7.832","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Engine #002","Payroll Engine #003","4.272","3.710","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Engine #003","Payroll Engine #004","6.257","3.476","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Engine #004","Payroll Engine #005","4.677","2.640","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Engine #005","Payroll Engine #001","7.667","7.399","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":780},{"label":"Mar","value":902},{"label":"Abr","value":728},{"label":"Mai","value":776},{"label":"Jun","value":734},{"label":"Jul","value":935},{"label":"Ago","value":857},{"label":"Set","value":741},{"label":"Out","value":893},{"label":"Nov","value":985},{"label":"Dez","value":696}];
const MX = 985;
