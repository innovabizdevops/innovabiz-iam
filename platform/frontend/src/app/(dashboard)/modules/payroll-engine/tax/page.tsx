...
const PAGE = "Tax Calculation";
const KPIS = [{"l":"Total Payroll Engine","v":"3.027","t":"+3.9%","d":"up"},{"l":"Tax Calculation Ativos","v":"6.641","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.5%","d":"down"}];
const COLS = ["ID","Tax Calculation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Engine #001","Payroll Engine #002","340","3.177","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Engine #002","Payroll Engine #003","1.786","7.269","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Engine #003","Payroll Engine #004","7.675","2.710","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Engine #004","Payroll Engine #005","8.634","1.655","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Engine #005","Payroll Engine #001","1.599","1.476","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":750},{"label":"Mar","value":502},{"label":"Abr","value":734},{"label":"Mai","value":396},{"label":"Jun","value":496},{"label":"Jul","value":596},{"label":"Ago","value":757},{"label":"Set","value":479},{"label":"Out","value":594},{"label":"Nov","value":419},{"label":"Dez","value":528}];
const MX = 757;
