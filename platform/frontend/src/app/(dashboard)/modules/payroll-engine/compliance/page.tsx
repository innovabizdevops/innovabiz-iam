...
const PAGE = "Compliance Filing";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.654","t":"+1.0%","d":"up"},{"l":"NC Abertas","v":"1.900","t":"+0.7%","d":"up"},{"l":"Conformidade (%)","v":"66.2%","t":"+17.5%","d":"up"},{"l":"CAPAs Pendentes","v":"3.297","t":"+10.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.828","90.1%","8.806","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.352","93.8%","3.949","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","417","93.1%","415","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.020","93.1%","8.604","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.656","84.3%","5.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":896},{"label":"Mar","value":999},{"label":"Abr","value":657},{"label":"Mai","value":725},{"label":"Jun","value":806},{"label":"Jul","value":661},{"label":"Ago","value":639},{"label":"Set","value":746},{"label":"Out","value":878},{"label":"Nov","value":744},{"label":"Dez","value":684}];
const MX = 999;
