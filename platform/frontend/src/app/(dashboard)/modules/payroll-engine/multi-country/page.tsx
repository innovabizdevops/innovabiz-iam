...
const ACCENT = "#0e7490";
const MODULE = "Payroll Engine";
const PAGE = "Multi-Country";
const KPIS = [{"l":"Total Payroll Engine","v":"5.934","t":"+14.7%","d":"up"},{"l":"Multi Country Ativos","v":"6.998","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"80","t":"+16.3%","d":"up"}];
const COLS = ["ID","Multi Country","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Engine #001","Payroll Engine #002","2.264","6.286","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Engine #002","Payroll Engine #003","1.187","4.958","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Engine #003","Payroll Engine #004","7.212","5.333","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Engine #004","Payroll Engine #005","6.495","2.777","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Engine #005","Payroll Engine #001","7.732","8.456","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":533},{"label":"Mar","value":656},{"label":"Abr","value":539},{"label":"Mai","value":405},{"label":"Jun","value":364},{"label":"Jul","value":451},{"label":"Ago","value":445},{"label":"Set","value":536},{"label":"Out","value":368},{"label":"Nov","value":654},{"label":"Dez","value":521}];
const MX = 656;
