...
const PAGE = "Garnishments";
const KPIS = [{"l":"Total Payroll Engine","v":"4.665","t":"+15.6%","d":"up"},{"l":"Garnishments Ativos","v":"3.849","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"68.6%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"59","t":"+7.8%","d":"up"}];
const COLS = ["ID","Garnishments","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll Engine #001","Payroll Engine #002","7.850","5.496","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll Engine #002","Payroll Engine #003","6.197","7.370","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll Engine #003","Payroll Engine #004","5.229","3.520","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll Engine #004","Payroll Engine #005","8.411","3.529","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll Engine #005","Payroll Engine #001","2.110","627","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":600},{"label":"Mar","value":648},{"label":"Abr","value":459},{"label":"Mai","value":775},{"label":"Jun","value":616},{"label":"Jul","value":505},{"label":"Ago","value":474},{"label":"Set","value":781},{"label":"Out","value":614},{"label":"Nov","value":594},{"label":"Dez","value":661}];
const MX = 781;
