...
/* ═══ Laboratory Information System — Dashboard ═══ */

const ACCENT = "#9f1239";

const KPIS = [
    { label: "Total Registos", value: "9475", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3234", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€226K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "135876975", cells: ["LAB-4975", "Laboratory Information System Item 1", "4/4/2026", "€27 075"], status: "active" as const },
    { id: "135880546", cells: ["LAB-8546", "Laboratory Information System Item 2", "19/11/2026", "€30 646"], status: "pending" as const },
    { id: "135884117", cells: ["LAB-3117", "Laboratory Information System Item 3", "6/6/2026", "€34 217"], status: "completed" as const },
    { id: "135887688", cells: ["LAB-6688", "Laboratory Information System Item 4", "21/1/2026", "€37 788"], status: "warning" as const },
    { id: "135891259", cells: ["LAB-1259", "Laboratory Information System Item 5", "8/8/2026", "€41 359"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 35 }, { label: "Fev", value: 44 }, { label: "Mar", value: 53 }, { label: "Abr", value: 62 }, { label: "Mai", value: 71 }, { label: "Jun", value: 80 }];
...
export default function LaboratoryInformationSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laboratory Information System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laboratory Information System</p>
                    </div>
                </div>
