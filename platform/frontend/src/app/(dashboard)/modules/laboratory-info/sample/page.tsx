...
const PAGE = "Sample";
const KPIS = [{"l":"Total Laboratory Info","v":"3.760","t":"-5.4%","d":"down"},{"l":"Sample Ativos","v":"806","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"75.6%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.5%","d":"up"}];
const COLS = ["ID","Sample","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laboratory Info #001","Laboratory Info #002","303","5.943","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Laboratory Info #002","Laboratory Info #003","3.727","3.416","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Laboratory Info #003","Laboratory Info #004","2.508","3.937","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Laboratory Info #004","Laboratory Info #005","6.247","5.264","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laboratory Info #005","Laboratory Info #001","1.548","5.384","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":787},{"label":"Mar","value":477},{"label":"Abr","value":648},{"label":"Mai","value":662},{"label":"Jun","value":406},{"label":"Jul","value":629},{"label":"Ago","value":681},{"label":"Set","value":550},{"label":"Out","value":466},{"label":"Nov","value":587},{"label":"Dez","value":432}];
const MX = 787;
