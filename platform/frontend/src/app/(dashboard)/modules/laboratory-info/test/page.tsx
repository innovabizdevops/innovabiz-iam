...
const PAGE = "Test";
const KPIS = [{"l":"Total Laboratory Info","v":"8.578","t":"+1.2%","d":"up"},{"l":"Test Ativos","v":"3.903","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"66","t":"+13.0%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laboratory Info #001","Laboratory Info #002","7.455","3.131","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Laboratory Info #002","Laboratory Info #003","3.285","559","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Laboratory Info #003","Laboratory Info #004","2.065","4.983","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Laboratory Info #004","Laboratory Info #005","1.010","8.610","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laboratory Info #005","Laboratory Info #001","8.718","4.415","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":498},{"label":"Mar","value":658},{"label":"Abr","value":535},{"label":"Mai","value":798},{"label":"Jun","value":611},{"label":"Jul","value":462},{"label":"Ago","value":497},{"label":"Set","value":446},{"label":"Out","value":570},{"label":"Nov","value":634},{"label":"Dez","value":667}];
const MX = 798;
