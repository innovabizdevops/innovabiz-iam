...
/* ═══ Essential Oil Production — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "5078", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3702", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€396K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "401539078", cells: ["ESS-5078", "Essential Oil Production Item 1", "11/11/2026", "€39 178"], status: "active" as const },
    { id: "401542649", cells: ["ESS-8649", "Essential Oil Production Item 2", "26/6/2026", "€42 749"], status: "pending" as const },
    { id: "401546220", cells: ["ESS-3220", "Essential Oil Production Item 3", "13/1/2026", "€46 320"], status: "completed" as const },
    { id: "401549791", cells: ["ESS-6791", "Essential Oil Production Item 4", "28/8/2026", "€49 891"], status: "warning" as const },
    { id: "401553362", cells: ["ESS-1362", "Essential Oil Production Item 5", "15/3/2026", "€3462"], status: "active" as const },
];
...
export default function EssentialOilProductionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Essential Oil Production</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Essential Oil Production</p>
                    </div>
                </div>
