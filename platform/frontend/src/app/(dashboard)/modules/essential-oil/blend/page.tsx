...
const PAGE = "Blend";
const KPIS = [{"l":"Total Essential Oil","v":"500","t":"+12.1%","d":"up"},{"l":"Blend Ativos","v":"2.124","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"83","t":"+3.9%","d":"up"}];
const COLS = ["ID","Blend","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Essential Oil #001","Essential Oil #002","5.414","4.944","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Essential Oil #002","Essential Oil #003","3.621","2.419","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Essential Oil #003","Essential Oil #004","6.715","4.983","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Essential Oil #004","Essential Oil #005","584","7.000","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Essential Oil #005","Essential Oil #001","3.447","6.049","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":839},{"label":"Mar","value":695},{"label":"Abr","value":778},{"label":"Mai","value":702},{"label":"Jun","value":683},{"label":"Jul","value":550},{"label":"Ago","value":501},{"label":"Set","value":483},{"label":"Out","value":793},{"label":"Nov","value":618},{"label":"Dez","value":564}];
const MX = 839;
