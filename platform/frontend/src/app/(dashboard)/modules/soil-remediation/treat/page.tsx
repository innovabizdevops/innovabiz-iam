...
const PAGE = "Treat";
const KPIS = [{"l":"Integrações Ativas","v":"6.724","t":"-2.3%","d":"down"},{"l":"Chamadas/Hora","v":"3155","t":"+4.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.1%","t":"-4.9%","d":"down"},{"l":"Latência Média (ms)","v":"34ms","t":"+6.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.570","5.236","71.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.883","6.300","71.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.177","7.886","77.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","225","1.580","96.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.649","102","85.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":601},{"label":"Mar","value":779},{"label":"Abr","value":635},{"label":"Mai","value":582},{"label":"Jun","value":845},{"label":"Jul","value":899},{"label":"Ago","value":923},{"label":"Set","value":741},{"label":"Out","value":734},{"label":"Nov","value":597},{"label":"Dez","value":857}];
const MX = 923;
