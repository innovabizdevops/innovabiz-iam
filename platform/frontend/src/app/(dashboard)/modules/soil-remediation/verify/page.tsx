...
const ACCENT = "#6366f1";
const MODULE = "Soil Remediation";
const PAGE = "Verify";
const KPIS = [{"l":"Integrações Ativas","v":"6.076","t":"+11.4%","d":"up"},{"l":"Chamadas/Hora","v":"2212","t":"+8.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.9%","t":"-0.3%","d":"down"},{"l":"Latência Média (ms)","v":"142ms","t":"+11.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","918","6.847","90.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.426","8.025","85.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.456","3.290","72.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.159","5.247","87.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.631","1.525","82.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":779},{"label":"Mar","value":677},{"label":"Abr","value":646},{"label":"Mai","value":589},{"label":"Jun","value":811},{"label":"Jul","value":922},{"label":"Ago","value":575},{"label":"Set","value":728},{"label":"Out","value":776},{"label":"Nov","value":796},{"label":"Dez","value":917}];
const MX = 922;
