...
const PAGE = "Excavate";
const KPIS = [{"l":"Integrações Ativas","v":"1.383","t":"+10.6%","d":"up"},{"l":"Chamadas/Hora","v":"3567","t":"-3.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"90.0%","t":"-2.5%","d":"down"},{"l":"Latência Média (ms)","v":"63ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.608","8.190","70.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.358","1.869","77.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.757","5.861","97.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","829","1.229","95.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.753","8.783","73.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":1061},{"label":"Mar","value":756},{"label":"Abr","value":974},{"label":"Mai","value":903},{"label":"Jun","value":795},{"label":"Jul","value":939},{"label":"Ago","value":898},{"label":"Set","value":846},{"label":"Out","value":917},{"label":"Nov","value":894},{"label":"Dez","value":944}];
const MX = 1061;
