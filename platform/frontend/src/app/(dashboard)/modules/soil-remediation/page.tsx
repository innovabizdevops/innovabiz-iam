...
export default function SoilRemediationPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Soil Remediation</h1><p className="text-sm text-muted-foreground">Soil Remediation • iBOS Enterprise</p></div>
