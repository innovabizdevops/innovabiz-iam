...
const PAGE = "Assess";
const KPIS = [{"l":"Integrações Ativas","v":"5.672","t":"+15.6%","d":"up"},{"l":"Chamadas/Hora","v":"3577","t":"+14.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.1%","t":"+11.0%","d":"up"},{"l":"Latência Média (ms)","v":"132ms","t":"+11.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.800","4.891","89.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.412","8.167","71.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.465","8.081","83.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.535","5.929","95.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.979","8.805","96.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":755},{"label":"Mar","value":919},{"label":"Abr","value":853},{"label":"Mai","value":815},{"label":"Jun","value":635},{"label":"Jul","value":686},{"label":"Ago","value":592},{"label":"Set","value":755},{"label":"Out","value":677},{"label":"Nov","value":803},{"label":"Dez","value":618}];
const MX = 919;
