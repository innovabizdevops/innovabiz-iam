...
const PAGE = "Plan";
const KPIS = [{"l":"Integrações Ativas","v":"5.739","t":"+6.3%","d":"up"},{"l":"Chamadas/Hora","v":"4256","t":"-2.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"76.9%","t":"+10.7%","d":"up"},{"l":"Latência Média (ms)","v":"81ms","t":"+0.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.717","3.457","72.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.679","3.457","96.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.551","4.642","83.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.244","6.620","86.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.902","2.797","78.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":788},{"label":"Mar","value":778},{"label":"Abr","value":830},{"label":"Mai","value":968},{"label":"Jun","value":871},{"label":"Jul","value":963},{"label":"Ago","value":725},{"label":"Set","value":1037},{"label":"Out","value":713},{"label":"Nov","value":1078},{"label":"Dez","value":970}];
const MX = 1078;
