...
export default function OpenEcosystemsOpenEcosystemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Open Ecosystems Open Ecosystem</h1><p className="text-sm text-muted-foreground">Open Ecosystems Open Ecosystem • iBOS Enterprise</p></div>
