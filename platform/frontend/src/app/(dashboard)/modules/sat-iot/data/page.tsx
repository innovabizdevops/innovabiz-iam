...
const PAGE = "Data Platform";
const KPIS = [{"l":"Dispositivos Online","v":"3.582","t":"+2.8%","d":"up"},{"l":"Dados/Min (MB)","v":"2.121","t":"+11.9%","d":"up"},{"l":"Alertas Ativos","v":"1.176","t":"+9.2%","d":"up"},{"l":"Uptime (%)","v":"66.2%","t":"+17.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.207","5.598","7.099","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.225","1.062","8.958","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.076","6.570","8.900","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.875","5.139","4.795","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.328","8.522","9.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":593},{"label":"Mar","value":662},{"label":"Abr","value":725},{"label":"Mai","value":739},{"label":"Jun","value":602},{"label":"Jul","value":827},{"label":"Ago","value":536},{"label":"Set","value":443},{"label":"Out","value":687},{"label":"Nov","value":804},{"label":"Dez","value":716}];
const MX = 827;
