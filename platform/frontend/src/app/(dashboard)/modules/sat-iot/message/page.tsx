...
const ACCENT = "#ec4899";
const MODULE = "Satellite IoT";
const PAGE = "Message Route";
const KPIS = [{"l":"Dispositivos Online","v":"5.388","t":"+8.3%","d":"up"},{"l":"Dados/Min (MB)","v":"4.201","t":"+15.0%","d":"up"},{"l":"Alertas Ativos","v":"255","t":"-5.7%","d":"down"},{"l":"Uptime (%)","v":"75.8%","t":"+10.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.752","2.812","7.984","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.888","5.916","4.930","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.233","1.704","3.638","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.032","7.407","2.420","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.299","7.867","5.245","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":708},{"label":"Mar","value":582},{"label":"Abr","value":838},{"label":"Mai","value":680},{"label":"Jun","value":841},{"label":"Jul","value":902},{"label":"Ago","value":788},{"label":"Set","value":678},{"label":"Out","value":560},{"label":"Nov","value":722},{"label":"Dez","value":817}];
const MX = 902;
