...
const KPIS = [{"l":"Dispositivos Online","v":"4.942","t":"+12.0%","d":"up"},{"l":"Dados/Min (MB)","v":"1.107","t":"+10.4%","d":"up"},{"l":"Alertas Ativos","v":"2.108","t":"-3.1%","d":"down"},{"l":"Uptime (%)","v":"75.8%","t":"+14.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.468","7.005","6.978","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.465","304","4.790","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.284","1.032","7.705","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.223","2.845","3.681","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.419","320","8.043","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":417},{"label":"Mar","value":488},{"label":"Abr","value":437},{"label":"Mai","value":642},{"label":"Jun","value":709},{"label":"Jul","value":751},{"label":"Ago","value":652},{"label":"Set","value":571},{"label":"Out","value":401},{"label":"Nov","value":507},{"label":"Dez","value":478}];
const MX = 751;
