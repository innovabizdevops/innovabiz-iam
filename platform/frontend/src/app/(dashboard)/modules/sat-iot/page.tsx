...
export default function SatIotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sat Iot</h1><p className="text-sm text-muted-foreground">Sat Iot • iBOS Enterprise</p></div>
