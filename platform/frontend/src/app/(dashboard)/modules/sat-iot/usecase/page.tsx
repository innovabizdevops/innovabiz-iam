...
const PAGE = "Use Case";
const KPIS = [{"l":"Dispositivos Online","v":"2.202","t":"+17.9%","d":"up"},{"l":"Dados/Min (MB)","v":"5.102","t":"+11.3%","d":"up"},{"l":"Alertas Ativos","v":"9.087","t":"+8.2%","d":"up"},{"l":"Uptime (%)","v":"75.6%","t":"+8.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.308","1.065","6.017","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.711","8.912","4.526","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.844","3.618","8.778","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.183","6.198","5.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.390","821","5.070","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":562},{"label":"Mar","value":682},{"label":"Abr","value":627},{"label":"Mai","value":460},{"label":"Jun","value":619},{"label":"Jul","value":713},{"label":"Ago","value":728},{"label":"Set","value":420},{"label":"Out","value":679},{"label":"Nov","value":683},{"label":"Dez","value":560}];
const MX = 728;
