...
const KPIS = [{"l":"Dispositivos Online","v":"4.750","t":"+12.8%","d":"up"},{"l":"Dados/Min (MB)","v":"4.880","t":"+1.3%","d":"up"},{"l":"Alertas Ativos","v":"2.402","t":"+0.9%","d":"up"},{"l":"Uptime (%)","v":"76.6%","t":"-4.8%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","321","2.923","8.431","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.659","1.651","6.536","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.199","6.389","6.339","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.410","8.855","1.673","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.164","6.028","4.341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":889},{"label":"Mar","value":703},{"label":"Abr","value":681},{"label":"Mai","value":724},{"label":"Jun","value":1049},{"label":"Jul","value":1035},{"label":"Ago","value":979},{"label":"Set","value":948},{"label":"Out","value":997},{"label":"Nov","value":1056},{"label":"Dez","value":861}];
const MX = 1056;
