...
const ACCENT = "#15803d";
const MODULE = "Cannabis Dispensary";
const PAGE = "Patient";
const KPIS = [{"l":"Total Cannabis Dispensary","v":"5.624","t":"-0.4%","d":"down"},{"l":"Patient Ativos","v":"2.021","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"70.9%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"88","t":"-5.9%","d":"down"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Dispensary #001","Cannabis Dispensary #002","2.410","3.681","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Dispensary #002","Cannabis Dispensary #003","3.872","2.025","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Dispensary #003","Cannabis Dispensary #004","8.269","2.842","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Dispensary #004","Cannabis Dispensary #005","5.347","7.119","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Dispensary #005","Cannabis Dispensary #001","6.568","3.609","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":581},{"label":"Mar","value":746},{"label":"Abr","value":564},{"label":"Mai","value":616},{"label":"Jun","value":373},{"label":"Jul","value":393},{"label":"Ago","value":378},{"label":"Set","value":414},{"label":"Out","value":403},{"label":"Nov","value":373},{"label":"Dez","value":521}];
const MX = 764;
