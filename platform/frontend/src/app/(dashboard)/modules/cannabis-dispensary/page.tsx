...
/* ═══ Cannabis Dispensary — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "527", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3635", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€349K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "497851627", cells: ["CAN-8627", "Cannabis Dispensary Item 1", "8/8/2026", "€1727"], status: "active" as const },
    { id: "497855198", cells: ["CAN-3198", "Cannabis Dispensary Item 2", "23/3/2026", "€5298"], status: "pending" as const },
    { id: "497858769", cells: ["CAN-6769", "Cannabis Dispensary Item 3", "10/10/2026", "€8869"], status: "completed" as const },
    { id: "497862340", cells: ["CAN-1340", "Cannabis Dispensary Item 4", "25/5/2026", "€12 440"], status: "warning" as const },
    { id: "497865911", cells: ["CAN-4911", "Cannabis Dispensary Item 5", "12/12/2026", "€16 011"], status: "active" as const },
];
...
export default function CannabisDispensaryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Dispensary</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Dispensary</p>
                    </div>
                </div>
