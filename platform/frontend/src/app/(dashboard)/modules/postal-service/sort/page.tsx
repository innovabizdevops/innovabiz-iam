...
const ACCENT = "#1e293b";
const MODULE = "Postal Service";
const PAGE = "Sort";
const KPIS = [{"l":"Pedidos/Dia","v":"1904","t":"+4.4%","d":"up"},{"l":"GMV (€)","v":"€15302","t":"+6.7%","d":"up"},{"l":"Conversão (%)","v":"72.0%","t":"+5.9%","d":"up"},{"l":"AOV (€)","v":"€18831","t":"-4.2%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 18080.96","4.351","3.045","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20100.05","544","533","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 15752.38","520","6.319","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20722.76","3.578","3.007","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 19824.99","5.372","563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":1044},{"label":"Mar","value":998},{"label":"Abr","value":1067},{"label":"Mai","value":800},{"label":"Jun","value":982},{"label":"Jul","value":1080},{"label":"Ago","value":800},{"label":"Set","value":1063},{"label":"Out","value":845},{"label":"Nov","value":729},{"label":"Dez","value":810}];
const MX = 1080;
