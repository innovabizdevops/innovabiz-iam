...
/* ═══ Postal Service — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "8982", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3578", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€266K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1245260582", cells: ["POS-3582", "Postal Service Item 1", "7/3/2026", "€10 682"], status: "active" as const },
    { id: "1245264153", cells: ["POS-7153", "Postal Service Item 2", "22/10/2026", "€14 253"], status: "pending" as const },
    { id: "1245267724", cells: ["POS-1724", "Postal Service Item 3", "9/5/2026", "€17 824"], status: "completed" as const },
    { id: "1245271295", cells: ["POS-5295", "Postal Service Item 4", "24/12/2026", "€21 395"], status: "warning" as const },
    { id: "1245274866", cells: ["POS-8866", "Postal Service Item 5", "11/7/2026", "€24 966"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Postal Service</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Postal Service</p>
                    </div>
                </div>
