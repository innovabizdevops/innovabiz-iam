...
/* ═══ Rubber Ops — Tire Building ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "769", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "472", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "851", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "88996276", cells: ["RUB-5276", "Tire Building Item 1", "13/5/2026", "€46 376"], status: "active" as const },
    { id: "88999847", cells: ["RUB-8847", "Tire Building Item 2", "28/12/2026", "€49 947"], status: "pending" as const },
    { id: "89003418", cells: ["RUB-3418", "Tire Building Item 3", "15/7/2026", "€3518"], status: "completed" as const },
    { id: "89006989", cells: ["RUB-6989", "Tire Building Item 4", "2/2/2026", "€7089"], status: "warning" as const },
    { id: "89010560", cells: ["RUB-1560", "Tire Building Item 5", "17/9/2026", "€10 660"], status: "active" as const },
];
...
export default function RubberOpsTireBuildingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tire Building</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Tire Building</p>
                    </div>
                </div>
