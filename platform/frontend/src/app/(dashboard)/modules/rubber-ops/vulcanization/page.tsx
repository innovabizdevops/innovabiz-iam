...
/* ═══ Rubber Ops — Vulcanization ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "3150", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "123", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2538", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "93292279", cells: ["RUB-8279", "Vulcanization Item 1", "4/8/2026", "€42 379"], status: "active" as const },
    { id: "93295850", cells: ["RUB-2850", "Vulcanization Item 2", "19/3/2026", "€45 950"], status: "pending" as const },
    { id: "93299421", cells: ["RUB-6421", "Vulcanization Item 3", "6/10/2026", "€49 521"], status: "completed" as const },
    { id: "93302992", cells: ["RUB-9992", "Vulcanization Item 4", "21/5/2026", "€3092"], status: "warning" as const },
    { id: "93306563", cells: ["RUB-4563", "Vulcanization Item 5", "8/12/2026", "€6663"], status: "active" as const },
];
...
export default function RubberOpsVulcanizationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vulcanization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Vulcanization</p>
                    </div>
                </div>
