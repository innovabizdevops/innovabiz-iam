...
/* ═══ Rubber Ops — Extrusion Rubber ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4047", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "373", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3599", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "378550065", cells: ["RUB-2065", "Extrusion Rubber Item 1", "6/10/2026", "€165"], status: "active" as const },
    { id: "378553636", cells: ["RUB-5636", "Extrusion Rubber Item 2", "21/5/2026", "€3736"], status: "pending" as const },
    { id: "378557207", cells: ["RUB-9207", "Extrusion Rubber Item 3", "8/12/2026", "€7307"], status: "completed" as const },
    { id: "378560778", cells: ["RUB-3778", "Extrusion Rubber Item 4", "23/7/2026", "€10 878"], status: "warning" as const },
    { id: "378564349", cells: ["RUB-7349", "Extrusion Rubber Item 5", "10/2/2026", "€14 449"], status: "active" as const },
];
...
export default function RubberOpsExtrusionRubberPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Extrusion Rubber</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Extrusion Rubber</p>
                    </div>
                </div>
