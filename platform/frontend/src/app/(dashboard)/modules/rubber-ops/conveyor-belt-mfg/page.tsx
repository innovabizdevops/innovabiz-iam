...
/* ═══ Rubber Ops — Conveyor Belt Mfg ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4684", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "74", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3596", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1061266486", cells: ["RUB-5486", "Conveyor Belt Mfg Item 1", "15/11/2026", "€16 586"], status: "active" as const },
    { id: "1061270057", cells: ["RUB-9057", "Conveyor Belt Mfg Item 2", "2/6/2026", "€20 157"], status: "pending" as const },
    { id: "1061273628", cells: ["RUB-3628", "Conveyor Belt Mfg Item 3", "17/1/2026", "€23 728"], status: "completed" as const },
    { id: "1061277199", cells: ["RUB-7199", "Conveyor Belt Mfg Item 4", "4/8/2026", "€27 299"], status: "warning" as const },
    { id: "1061280770", cells: ["RUB-1770", "Conveyor Belt Mfg Item 5", "19/3/2026", "€30 870"], status: "active" as const },
];
...
export default function RubberOpsConveyorBeltMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conveyor Belt Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Conveyor Belt Mfg</p>
                    </div>
                </div>
