...
/* ═══ Rubber Ops — Calendering ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "3823", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "164", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2485", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "227142384", cells: ["RUB-1384", "Calendering Item 1", "1/1/2026", "€42 484"], status: "active" as const },
    { id: "227145955", cells: ["RUB-4955", "Calendering Item 2", "16/8/2026", "€46 055"], status: "pending" as const },
    { id: "227149526", cells: ["RUB-8526", "Calendering Item 3", "3/3/2026", "€49 626"], status: "completed" as const },
    { id: "227153097", cells: ["RUB-3097", "Calendering Item 4", "18/10/2026", "€3197"], status: "warning" as const },
    { id: "227156668", cells: ["RUB-6668", "Calendering Item 5", "5/5/2026", "€6768"], status: "active" as const },
];
...
export default function RubberOpsCalenderingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Calendering</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Calendering</p>
                    </div>
                </div>
