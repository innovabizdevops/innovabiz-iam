...
/* ═══ Rubber Ops — Seals Gaskets ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "896", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "260", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3923", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2055141552", cells: ["RUB-1552", "Seals Gaskets Item 1", "17/1/2026", "€41 652"], status: "active" as const },
    { id: "2055145123", cells: ["RUB-5123", "Seals Gaskets Item 2", "4/8/2026", "€45 223"], status: "pending" as const },
    { id: "2055148694", cells: ["RUB-8694", "Seals Gaskets Item 3", "19/3/2026", "€48 794"], status: "completed" as const },
    { id: "2055152265", cells: ["RUB-3265", "Seals Gaskets Item 4", "6/10/2026", "€2365"], status: "warning" as const },
    { id: "2055155836", cells: ["RUB-6836", "Seals Gaskets Item 5", "21/5/2026", "€5936"], status: "active" as const },
];
...
export default function RubberOpsSealsGasketsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Seals Gaskets</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Seals Gaskets</p>
                    </div>
                </div>
