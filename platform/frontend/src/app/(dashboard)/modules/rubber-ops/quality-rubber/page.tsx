...
/* ═══ Rubber Ops — Quality Rubber ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4482", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "251", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "307", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1188296727", cells: ["RUB-9727", "Quality Rubber Item 1", "24/4/2026", "€46 827"], status: "active" as const },
    { id: "1188300298", cells: ["RUB-4298", "Quality Rubber Item 2", "11/11/2026", "€398"], status: "pending" as const },
    { id: "1188303869", cells: ["RUB-7869", "Quality Rubber Item 3", "26/6/2026", "€3969"], status: "completed" as const },
    { id: "1188307440", cells: ["RUB-2440", "Quality Rubber Item 4", "13/1/2026", "€7540"], status: "warning" as const },
    { id: "1188311011", cells: ["RUB-6011", "Quality Rubber Item 5", "28/8/2026", "€11 111"], status: "active" as const },
];
...
export default function RubberOpsQualityRubberPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Rubber</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Quality Rubber</p>
                    </div>
                </div>
