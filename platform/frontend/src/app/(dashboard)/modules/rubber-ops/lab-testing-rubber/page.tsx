...
/* ═══ Rubber Ops — Lab Testing Rubber ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "3106", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "383", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1240", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "70%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "396774603", cells: ["RUB-1603", "Lab Testing Rubber Item 1", "16/4/2026", "€24 703"], status: "active" as const },
    { id: "396778174", cells: ["RUB-5174", "Lab Testing Rubber Item 2", "3/11/2026", "€28 274"], status: "pending" as const },
    { id: "396781745", cells: ["RUB-8745", "Lab Testing Rubber Item 3", "18/6/2026", "€31 845"], status: "completed" as const },
    { id: "396785316", cells: ["RUB-3316", "Lab Testing Rubber Item 4", "5/1/2026", "€35 416"], status: "warning" as const },
    { id: "396788887", cells: ["RUB-6887", "Lab Testing Rubber Item 5", "20/8/2026", "€38 987"], status: "active" as const },
];
...
export default function RubberOpsLabTestingRubberPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Lab Testing Rubber</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Lab Testing Rubber</p>
                    </div>
                </div>
