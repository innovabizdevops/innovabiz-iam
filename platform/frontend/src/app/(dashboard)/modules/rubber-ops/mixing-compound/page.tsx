...
/* ═══ Rubber Ops — Mixing Compound ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4139", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "231", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "648", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "551082035", cells: ["RUB-4035", "Mixing Compound Item 1", "8/12/2026", "€32 135"], status: "active" as const },
    { id: "551085606", cells: ["RUB-7606", "Mixing Compound Item 2", "23/7/2026", "€35 706"], status: "pending" as const },
    { id: "551089177", cells: ["RUB-2177", "Mixing Compound Item 3", "10/2/2026", "€39 277"], status: "completed" as const },
    { id: "551092748", cells: ["RUB-5748", "Mixing Compound Item 4", "25/9/2026", "€42 848"], status: "warning" as const },
    { id: "551096319", cells: ["RUB-9319", "Mixing Compound Item 5", "12/4/2026", "€46 419"], status: "active" as const },
];
...
export default function RubberOpsMixingCompoundPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mixing Compound</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Mixing Compound</p>
                    </div>
                </div>
