...
/* ═══ Rubber Ops — Molding Rubber ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "370", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "308", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3331", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2135982656", cells: ["RUB-4656", "Molding Rubber Item 1", "25/9/2026", "€32 756"], status: "active" as const },
    { id: "2135986227", cells: ["RUB-8227", "Molding Rubber Item 2", "12/4/2026", "€36 327"], status: "pending" as const },
    { id: "2135989798", cells: ["RUB-2798", "Molding Rubber Item 3", "27/11/2026", "€39 898"], status: "completed" as const },
    { id: "2135993369", cells: ["RUB-6369", "Molding Rubber Item 4", "14/6/2026", "€43 469"], status: "warning" as const },
    { id: "2135996940", cells: ["RUB-9940", "Molding Rubber Item 5", "1/1/2026", "€47 040"], status: "active" as const },
];
...
export default function RubberOpsMoldingRubberPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Molding Rubber</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Rubber Ops • Molding Rubber</p>
                    </div>
                </div>
