...
/* ═══ ESG Reporting Deep — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "5038", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4532", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€369K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1688281638", cells: ["ESG-8638", "ESG Reporting Deep Item 1", "23/7/2026", "€31 738"], status: "active" as const },
    { id: "1688285209", cells: ["ESG-3209", "ESG Reporting Deep Item 2", "10/2/2026", "€35 309"], status: "pending" as const },
    { id: "1688288780", cells: ["ESG-6780", "ESG Reporting Deep Item 3", "25/9/2026", "€38 880"], status: "completed" as const },
    { id: "1688292351", cells: ["ESG-1351", "ESG Reporting Deep Item 4", "12/4/2026", "€42 451"], status: "warning" as const },
    { id: "1688295922", cells: ["ESG-4922", "ESG Reporting Deep Item 5", "27/11/2026", "€46 022"], status: "active" as const },
];
...
export default function EsgReportingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">ESG Reporting Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • ESG Reporting Deep</p>
                    </div>
                </div>
