...
const ACCENT = "#166534";
const MODULE = "ESG Reporting Deep";
const PAGE = "ESRS";
const KPIS = [{"l":"Total Esg Reporting Deep","v":"3.210","t":"-4.3%","d":"down"},{"l":"ESRS Ativos","v":"3.032","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"67.5%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"63","t":"+16.5%","d":"up"}];
const COLS = ["ID","ESRS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Esg Reporting Deep #001","Esg Reporting Deep #002","2.178","6.979","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Esg Reporting Deep #002","Esg Reporting Deep #003","1.647","1.357","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Esg Reporting Deep #003","Esg Reporting Deep #004","8.049","3.220","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Esg Reporting Deep #004","Esg Reporting Deep #005","2.385","4.582","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Esg Reporting Deep #005","Esg Reporting Deep #001","1.718","7.520","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":875},{"label":"Mar","value":692},{"label":"Abr","value":742},{"label":"Mai","value":633},{"label":"Jun","value":884},{"label":"Jul","value":780},{"label":"Ago","value":665},{"label":"Set","value":698},{"label":"Out","value":851},{"label":"Nov","value":798},{"label":"Dez","value":871}];
const MX = 884;
...
export default function EsrsPage() {
    return (
