...
const ACCENT = "#6366f1";
const MODULE = "Rail Freight";
const PAGE = "Carload";
const KPIS = [{"l":"Veículos Operação","v":"5.699","t":"+14.2%","d":"up"},{"l":"Viagens/Dia","v":"564","t":"-4.5%","d":"down"},{"l":"Pontualidade (%)","v":"90.3%","t":"+16.0%","d":"up"},{"l":"Passageiros/Dia","v":"3729","t":"+2.2%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-25","2026-03-05","6.688","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-01","2026-02-13","4.242","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-26","2026-01-22","150","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-28","2026-02-19","4.446","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-01","2026-01-10","1.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":356},{"label":"Mar","value":432},{"label":"Abr","value":440},{"label":"Mai","value":606},{"label":"Jun","value":576},{"label":"Jul","value":551},{"label":"Ago","value":705},{"label":"Set","value":440},{"label":"Out","value":425},{"label":"Nov","value":365},{"label":"Dez","value":615}];
const MX = 705;
...
export default function CarloadPage() {
    return (
