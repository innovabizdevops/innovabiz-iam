...
const PAGE = "Billing";
const KPIS = [{"l":"Veículos Operação","v":"4.744","t":"+17.2%","d":"up"},{"l":"Viagens/Dia","v":"4361","t":"+13.5%","d":"up"},{"l":"Pontualidade (%)","v":"85.7%","t":"+10.4%","d":"up"},{"l":"Passageiros/Dia","v":"1943","t":"-4.1%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-25","2026-01-26","1.077","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-03","2026-01-22","8.866","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-02","2026-03-16","8.146","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-24","2026-02-05","2.693","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-28","2026-03-11","2.578","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":474},{"label":"Mar","value":451},{"label":"Abr","value":306},{"label":"Mai","value":579},{"label":"Jun","value":398},{"label":"Jul","value":407},{"label":"Ago","value":392},{"label":"Set","value":621},{"label":"Out","value":433},{"label":"Nov","value":290},{"label":"Dez","value":489}];
const MX = 621;
