...
const PAGE = "Yard Ops";
const KPIS = [{"l":"Veículos Operação","v":"9.098","t":"-3.4%","d":"down"},{"l":"Viagens/Dia","v":"562","t":"+6.3%","d":"up"},{"l":"Pontualidade (%)","v":"75.7%","t":"+14.7%","d":"up"},{"l":"Passageiros/Dia","v":"4691","t":"+6.2%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-26","2026-02-10","1.851","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-25","2026-03-09","3.943","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-09","2026-02-12","2.039","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-18","2026-02-14","6.557","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-08","2026-03-01","5.403","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":276},{"label":"Mar","value":346},{"label":"Abr","value":407},{"label":"Mai","value":415},{"label":"Jun","value":636},{"label":"Jul","value":502},{"label":"Ago","value":549},{"label":"Set","value":447},{"label":"Out","value":374},{"label":"Nov","value":355},{"label":"Dez","value":295}];
const MX = 636;
