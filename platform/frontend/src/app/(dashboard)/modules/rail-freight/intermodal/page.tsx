...
const KPIS = [{"l":"Riscos Identificados","v":"3.405","t":"+10.7%","d":"up"},{"l":"Mitigações Ativas","v":"773","t":"-4.9%","d":"down"},{"l":"Score Risco Geral","v":"67","t":"+4.3%","d":"up"},{"l":"Incidentes YTD","v":"8.699","t":"+2.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.502","3.635","8.377","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.038","5.492","3.971","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.684","5.671","5.862","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.340","995","8.918","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.286","608","6.722","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":353},{"label":"Mar","value":269},{"label":"Abr","value":564},{"label":"Mai","value":437},{"label":"Jun","value":526},{"label":"Jul","value":512},{"label":"Ago","value":509},{"label":"Set","value":447},{"label":"Out","value":453},{"label":"Nov","value":263},{"label":"Dez","value":473}];
const MX = 564;
