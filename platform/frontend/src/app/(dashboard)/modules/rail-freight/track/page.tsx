...
const PAGE = "Track";
const KPIS = [{"l":"Veículos Operação","v":"5.461","t":"+3.8%","d":"up"},{"l":"Viagens/Dia","v":"1229","t":"+5.0%","d":"up"},{"l":"Pontualidade (%)","v":"85.1%","t":"-1.8%","d":"down"},{"l":"Passageiros/Dia","v":"4634","t":"+3.8%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-05","2026-02-03","7.296","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-17","2026-01-04","2.023","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-12","2026-02-09","1.848","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-27","2026-01-13","4.680","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-10","2026-02-27","7.138","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":663},{"label":"Mar","value":437},{"label":"Abr","value":710},{"label":"Mai","value":490},{"label":"Jun","value":362},{"label":"Jul","value":563},{"label":"Ago","value":405},{"label":"Set","value":336},{"label":"Out","value":584},{"label":"Nov","value":355},{"label":"Dez","value":512}];
const MX = 710;
