...
const PAGE = "Pattern";
const KPIS = [{"l":"Total Knitting Mill","v":"4.045","t":"+17.3%","d":"up"},{"l":"Pattern Ativos","v":"597","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+8.3%","d":"up"},{"l":"Score Performance","v":"64","t":"+-0.0%","d":"up"}];
const COLS = ["ID","Pattern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Knitting Mill #001","Knitting Mill #002","3.297","6.130","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Knitting Mill #002","Knitting Mill #003","5.429","6.097","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Knitting Mill #003","Knitting Mill #004","2.236","2.345","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Knitting Mill #004","Knitting Mill #005","6.507","6.276","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Knitting Mill #005","Knitting Mill #001","2.997","7.408","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":586},{"label":"Mar","value":521},{"label":"Abr","value":447},{"label":"Mai","value":618},{"label":"Jun","value":296},{"label":"Jul","value":573},{"label":"Ago","value":392},{"label":"Set","value":323},{"label":"Out","value":546},{"label":"Nov","value":639},{"label":"Dez","value":318}];
const MX = 639;
