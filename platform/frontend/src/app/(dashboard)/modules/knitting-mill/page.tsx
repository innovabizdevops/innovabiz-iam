...
export default function KnittingMillPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Knitting Mill</h1><p className="text-sm text-muted-foreground">Knitting Mill • iBOS Enterprise</p></div>
