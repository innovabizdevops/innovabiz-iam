...
const PAGE = "Gauge";
const KPIS = [{"l":"Total Knitting Mill","v":"1.599","t":"+15.7%","d":"up"},{"l":"Gauge Ativos","v":"8.064","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"66","t":"-3.0%","d":"down"}];
const COLS = ["ID","Gauge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Knitting Mill #001","Knitting Mill #002","8.515","6.691","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Knitting Mill #002","Knitting Mill #003","8.878","3.009","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Knitting Mill #003","Knitting Mill #004","7.552","1.465","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Knitting Mill #004","Knitting Mill #005","4.396","1.552","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Knitting Mill #005","Knitting Mill #001","2.056","2.556","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":612},{"label":"Mar","value":437},{"label":"Abr","value":678},{"label":"Mai","value":583},{"label":"Jun","value":516},{"label":"Jul","value":492},{"label":"Ago","value":362},{"label":"Set","value":747},{"label":"Out","value":367},{"label":"Nov","value":748},{"label":"Dez","value":589}];
const MX = 748;
