...
const ACCENT = "#6366f1";
const MODULE = "Knitting Mill";
const PAGE = "Production";
const KPIS = [{"l":"Total Knitting Mill","v":"4.411","t":"+17.8%","d":"up"},{"l":"Production Ativos","v":"4.890","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"77","t":"+2.8%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Knitting Mill #001","Knitting Mill #002","3.473","2.532","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Knitting Mill #002","Knitting Mill #003","411","2.987","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Knitting Mill #003","Knitting Mill #004","1.417","1.208","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Knitting Mill #004","Knitting Mill #005","2.009","8.814","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Knitting Mill #005","Knitting Mill #001","3.282","4.811","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":555},{"label":"Mar","value":544},{"label":"Abr","value":669},{"label":"Mai","value":755},{"label":"Jun","value":702},{"label":"Jul","value":741},{"label":"Ago","value":546},{"label":"Set","value":802},{"label":"Out","value":576},{"label":"Nov","value":666},{"label":"Dez","value":834}];
const MX = 834;
