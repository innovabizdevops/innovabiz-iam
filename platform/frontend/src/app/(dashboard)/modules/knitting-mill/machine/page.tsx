...
const PAGE = "Machine";
const KPIS = [{"l":"Total Knitting Mill","v":"7.681","t":"-0.5%","d":"down"},{"l":"Machine Ativos","v":"8.726","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"81.7%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+15.4%","d":"up"}];
const COLS = ["ID","Machine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Knitting Mill #001","Knitting Mill #002","5.306","682","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Knitting Mill #002","Knitting Mill #003","5.298","7.296","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Knitting Mill #003","Knitting Mill #004","3.009","2.442","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Knitting Mill #004","Knitting Mill #005","1.509","5.670","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Knitting Mill #005","Knitting Mill #001","5.236","581","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":792},{"label":"Mar","value":751},{"label":"Abr","value":943},{"label":"Mai","value":735},{"label":"Jun","value":746},{"label":"Jul","value":661},{"label":"Ago","value":775},{"label":"Set","value":724},{"label":"Out","value":737},{"label":"Nov","value":866},{"label":"Dez","value":916}];
const MX = 983;
