...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.865","t":"+9.5%","d":"up"},{"l":"NC Abertas","v":"3.941","t":"+6.8%","d":"up"},{"l":"Conformidade (%)","v":"68.4%","t":"+14.5%","d":"up"},{"l":"CAPAs Pendentes","v":"1.326","t":"+12.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.666","78.8%","6.392","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.875","77.2%","5.961","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.799","93.6%","3.062","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.771","85.9%","3.425","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.124","73.0%","675","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":220},{"label":"Fev","value":229},{"label":"Mar","value":613},{"label":"Abr","value":231},{"label":"Mai","value":276},{"label":"Jun","value":451},{"label":"Jul","value":398},{"label":"Ago","value":377},{"label":"Set","value":579},{"label":"Out","value":590},{"label":"Nov","value":587},{"label":"Dez","value":357}];
const MX = 613;
