...
const PAGE = "Agent Marketplace";
const KPIS = [{"l":"Pedidos/Dia","v":"1467","t":"+5.4%","d":"up"},{"l":"GMV (€)","v":"€31376","t":"+0.8%","d":"up"},{"l":"Conversão (%)","v":"89.7%","t":"+8.4%","d":"up"},{"l":"AOV (€)","v":"€20358","t":"+13.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 45207.27","1.047","5.711","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 43699.13","8.627","6.334","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 12033.04","1.535","7.164","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 47762.90","3.484","8.013","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 10273.54","7.252","2.190","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":970},{"label":"Mar","value":666},{"label":"Abr","value":967},{"label":"Mai","value":931},{"label":"Jun","value":960},{"label":"Jul","value":714},{"label":"Ago","value":901},{"label":"Set","value":787},{"label":"Out","value":853},{"label":"Nov","value":704},{"label":"Dez","value":645}];
const MX = 970;
