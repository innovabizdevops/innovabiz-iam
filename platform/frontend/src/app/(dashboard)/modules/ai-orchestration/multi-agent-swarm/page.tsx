...
const ACCENT = "#a855f7";
const MODULE = "AI Orchestration";
const PAGE = "Multi-Agent Swarm";
const KPIS = [{"l":"Total Ai Orchestration","v":"6.060","t":"+7.5%","d":"up"},{"l":"Multi Agent Swarm Ativos","v":"5.220","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"83.3%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"81","t":"-4.1%","d":"down"}];
const COLS = ["ID","Multi Agent Swarm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Orchestration #001","Ai Orchestration #002","2.808","7.531","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Orchestration #002","Ai Orchestration #003","2.838","6.035","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Orchestration #003","Ai Orchestration #004","1.178","8.287","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Orchestration #004","Ai Orchestration #005","564","8.263","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Orchestration #005","Ai Orchestration #001","4.866","7.772","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":425},{"label":"Mar","value":512},{"label":"Abr","value":397},{"label":"Mai","value":714},{"label":"Jun","value":471},{"label":"Jul","value":711},{"label":"Ago","value":562},{"label":"Set","value":402},{"label":"Out","value":498},{"label":"Nov","value":478},{"label":"Dez","value":509}];
const MX = 714;
...
export default function MultiAgentSwarmPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a855f7'}}>Swarm</span></h1>
                </div>
