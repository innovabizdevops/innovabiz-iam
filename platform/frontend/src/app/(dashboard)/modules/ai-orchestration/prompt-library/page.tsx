...
const PAGE = "Prompt Library";
const KPIS = [{"l":"Total Ai Orchestration","v":"1.627","t":"+17.8%","d":"up"},{"l":"Prompt Library Ativos","v":"7.608","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"80","t":"+11.6%","d":"up"}];
const COLS = ["ID","Prompt Library","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Orchestration #001","Ai Orchestration #002","7.780","1.716","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Orchestration #002","Ai Orchestration #003","2.679","5.294","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Orchestration #003","Ai Orchestration #004","5.780","8.275","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Orchestration #004","Ai Orchestration #005","2.619","8.820","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Orchestration #005","Ai Orchestration #001","382","7.313","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":282},{"label":"Mar","value":333},{"label":"Abr","value":476},{"label":"Mai","value":250},{"label":"Jun","value":621},{"label":"Jul","value":476},{"label":"Ago","value":584},{"label":"Set","value":305},{"label":"Out","value":275},{"label":"Nov","value":244},{"label":"Dez","value":264}];
const MX = 621;
