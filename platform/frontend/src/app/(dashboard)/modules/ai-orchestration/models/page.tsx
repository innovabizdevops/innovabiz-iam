...
const PAGE = "Models";
const KPIS = [{"l":"Total Ai Orchestration","v":"4.150","t":"+17.7%","d":"up"},{"l":"Models Ativos","v":"2.741","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+7.9%","d":"up"}];
const COLS = ["ID","Models","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Orchestration #001","Ai Orchestration #002","4.136","3.285","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Orchestration #002","Ai Orchestration #003","4.946","8.781","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Orchestration #003","Ai Orchestration #004","8.590","4.864","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Orchestration #004","Ai Orchestration #005","5.839","2.575","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Orchestration #005","Ai Orchestration #001","5.744","2.620","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":374},{"label":"Mar","value":406},{"label":"Abr","value":421},{"label":"Mai","value":547},{"label":"Jun","value":464},{"label":"Jul","value":393},{"label":"Ago","value":320},{"label":"Set","value":279},{"label":"Out","value":461},{"label":"Nov","value":343},{"label":"Dez","value":420}];
const MX = 547;
