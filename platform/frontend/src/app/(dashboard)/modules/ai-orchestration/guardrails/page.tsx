...
const PAGE = "AI Guardrails";
const KPIS = [{"l":"Veículos Operação","v":"2.204","t":"+6.2%","d":"up"},{"l":"Viagens/Dia","v":"4088","t":"+14.7%","d":"up"},{"l":"Pontualidade (%)","v":"82.5%","t":"+7.0%","d":"up"},{"l":"Passageiros/Dia","v":"2079","t":"+11.3%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-05","2026-02-08","2.560","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-14","2026-02-09","6.442","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-20","2026-03-23","5.734","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-01","2026-03-08","2.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-05","2026-02-21","7.937","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":426},{"label":"Mar","value":704},{"label":"Abr","value":569},{"label":"Mai","value":678},{"label":"Jun","value":630},{"label":"Jul","value":464},{"label":"Ago","value":626},{"label":"Set","value":601},{"label":"Out","value":530},{"label":"Nov","value":774},{"label":"Dez","value":608}];
const MX = 774;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a855f7'}}>XAI</span></h1>
                </div>
