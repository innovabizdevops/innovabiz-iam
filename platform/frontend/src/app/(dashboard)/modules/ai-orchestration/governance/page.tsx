...
const PAGE = "AI Governance";
const KPIS = [{"l":"Riscos Identificados","v":"6.502","t":"+8.4%","d":"up"},{"l":"Mitigações Ativas","v":"538","t":"+1.2%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+2.7%","d":"up"},{"l":"Incidentes YTD","v":"8.423","t":"+4.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.691","4.482","4.066","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.522","5.311","2.424","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.112","6.609","2.697","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.380","749","5.964","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.134","5.160","3.507","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":818},{"label":"Mar","value":573},{"label":"Abr","value":455},{"label":"Mai","value":643},{"label":"Jun","value":665},{"label":"Jul","value":726},{"label":"Ago","value":622},{"label":"Set","value":439},{"label":"Out","value":719},{"label":"Nov","value":492},{"label":"Dez","value":674}];
const MX = 818;
