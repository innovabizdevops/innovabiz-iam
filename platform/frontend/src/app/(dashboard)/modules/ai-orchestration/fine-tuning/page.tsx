...
const PAGE = "Fine-Tuning";
const KPIS = [{"l":"Total Ai Orchestration","v":"4.629","t":"-0.1%","d":"down"},{"l":"Fine Tuning Ativos","v":"1.096","t":"-1.3%","d":"down"},{"l":"Eficiência (%)","v":"80.2%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"91","t":"+7.3%","d":"up"}];
const COLS = ["ID","Fine Tuning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Orchestration #001","Ai Orchestration #002","5.442","2.084","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Orchestration #002","Ai Orchestration #003","2.286","1.219","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Orchestration #003","Ai Orchestration #004","3.993","1.517","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Orchestration #004","Ai Orchestration #005","6.711","1.530","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Orchestration #005","Ai Orchestration #001","4.326","6.021","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":953},{"label":"Mar","value":895},{"label":"Abr","value":717},{"label":"Mai","value":703},{"label":"Jun","value":799},{"label":"Jul","value":847},{"label":"Ago","value":622},{"label":"Set","value":567},{"label":"Out","value":693},{"label":"Nov","value":867},{"label":"Dez","value":797}];
const MX = 953;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a855f7'}}>New</span></h1>
                </div>
