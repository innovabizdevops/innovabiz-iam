...
const PAGE = "Prompt Studio";
const KPIS = [{"l":"Total Ai Orchestration","v":"5.352","t":"+11.9%","d":"up"},{"l":"Prompt Studio Ativos","v":"1.395","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+2.6%","d":"up"}];
const COLS = ["ID","Prompt Studio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Orchestration #001","Ai Orchestration #002","5.060","6.320","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Orchestration #002","Ai Orchestration #003","5.342","7.560","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Orchestration #003","Ai Orchestration #004","5.154","4.089","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Orchestration #004","Ai Orchestration #005","2.950","7.055","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Orchestration #005","Ai Orchestration #001","2.148","2.705","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":917},{"label":"Mar","value":665},{"label":"Abr","value":987},{"label":"Mai","value":878},{"label":"Jun","value":915},{"label":"Jul","value":780},{"label":"Ago","value":867},{"label":"Set","value":800},{"label":"Out","value":666},{"label":"Nov","value":668},{"label":"Dez","value":997}];
const MX = 997;
