...
const PAGE = "Vector DB";
const KPIS = [{"l":"Ideias Submetidas","v":"2.991","t":"+2.9%","d":"up"},{"l":"Patentes (YTD)","v":"5.736","t":"+7.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.223","t":"+15.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€8.9M","t":"-4.4%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.899","89.3%","5.865","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","352","86.7%","5.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.607","87.4%","6.154","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.312","87.6%","5.269","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.495","98.5%","4.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":908},{"label":"Mar","value":995},{"label":"Abr","value":680},{"label":"Mai","value":887},{"label":"Jun","value":942},{"label":"Jul","value":652},{"label":"Ago","value":870},{"label":"Set","value":798},{"label":"Out","value":706},{"label":"Nov","value":932},{"label":"Dez","value":779}];
const MX = 995;
