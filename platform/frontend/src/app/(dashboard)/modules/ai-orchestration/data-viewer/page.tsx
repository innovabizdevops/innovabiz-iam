...
const PAGE = "Data Viewer";
const KPIS = [{"l":"Dashboards Ativos","v":"837","t":"+9.4%","d":"up"},{"l":"Queries/Dia","v":"3866","t":"+0.2%","d":"up"},{"l":"Dados Processados (GB)","v":"4.788","t":"-3.2%","d":"down"},{"l":"Utilizadores Analytics","v":"3.535","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5086","2026-01-05","7.311","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3875","2026-03-22","615","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3018","2026-02-23","5.573","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1300","2026-02-25","5.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3095","2026-01-28","1.876","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":772},{"label":"Mar","value":985},{"label":"Abr","value":932},{"label":"Mai","value":823},{"label":"Jun","value":849},{"label":"Jul","value":675},{"label":"Ago","value":986},{"label":"Set","value":1027},{"label":"Out","value":721},{"label":"Nov","value":943},{"label":"Dez","value":739}];
const MX = 1027;
