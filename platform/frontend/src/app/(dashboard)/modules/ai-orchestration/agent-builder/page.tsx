...
const PAGE = "Agent Builder";
const KPIS = [{"l":"Total Ai Orchestration","v":"5.977","t":"+17.6%","d":"up"},{"l":"Agent Builder Ativos","v":"4.071","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"86","t":"+4.8%","d":"up"}];
const COLS = ["ID","Agent Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Orchestration #001","Ai Orchestration #002","4.473","3.670","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Orchestration #002","Ai Orchestration #003","7.586","1.223","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Orchestration #003","Ai Orchestration #004","2.427","3.667","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Orchestration #004","Ai Orchestration #005","5.844","903","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Orchestration #005","Ai Orchestration #001","5.033","5.630","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":849},{"label":"Mar","value":933},{"label":"Abr","value":863},{"label":"Mai","value":752},{"label":"Jun","value":963},{"label":"Jul","value":693},{"label":"Ago","value":823},{"label":"Set","value":781},{"label":"Out","value":774},{"label":"Nov","value":1016},{"label":"Dez","value":677}];
const MX = 1016;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a855f7'}}>Agentic</span></h1>
                </div>
