...
const KPIS = [{"l":"Teams Ativos","v":"9.064","t":"+0.0%","d":"up"},{"l":"Reuniões/Semana","v":"2023","t":"+17.4%","d":"up"},{"l":"Mensagens/Dia","v":"2379","t":"+2.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.903","t":"-5.4%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.151","3813","8.850","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","116","138","6.215","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.428","2703","4.239","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","7.419","3083","7.753","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","348","2310","7.807","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":940},{"label":"Mar","value":743},{"label":"Abr","value":830},{"label":"Mai","value":688},{"label":"Jun","value":705},{"label":"Jul","value":679},{"label":"Ago","value":713},{"label":"Set","value":675},{"label":"Out","value":861},{"label":"Nov","value":1008},{"label":"Dez","value":826}];
const MX = 1008;
