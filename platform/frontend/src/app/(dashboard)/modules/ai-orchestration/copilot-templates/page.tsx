...
const PAGE = "Copilot Templates";
const KPIS = [{"l":"Formulários Ativos","v":"7.416","t":"-2.0%","d":"down"},{"l":"Submissões/Dia","v":"916","t":"-2.7%","d":"down"},{"l":"Documentos Gerados","v":"608","t":"-5.5%","d":"down"},{"l":"Templates","v":"4.700","t":"+6.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.539","2026-03-12","3.456","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","283","2026-03-05","3.364","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.204","2026-03-26","7.109","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.588","2026-01-01","2.826","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","273","2026-02-09","6.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":963},{"label":"Mar","value":699},{"label":"Abr","value":948},{"label":"Mai","value":912},{"label":"Jun","value":672},{"label":"Jul","value":721},{"label":"Ago","value":832},{"label":"Set","value":758},{"label":"Out","value":669},{"label":"Nov","value":609},{"label":"Dez","value":619}];
const MX = 963;
...
export default function CopilotTemplatesPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a855f7'}}>GenAI</span></h1>
                </div>
