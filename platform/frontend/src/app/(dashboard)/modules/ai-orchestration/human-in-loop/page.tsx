...
const PAGE = "Human-in-the-Loop";
const KPIS = [{"l":"Total Ai Orchestration","v":"3.630","t":"+14.9%","d":"up"},{"l":"Human In The Loop Ativos","v":"664","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"89","t":"-4.1%","d":"down"}];
const COLS = ["ID","Human In The Loop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Orchestration #001","Ai Orchestration #002","5.265","8.810","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Orchestration #002","Ai Orchestration #003","1.212","5.037","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Orchestration #003","Ai Orchestration #004","2.873","5.907","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Orchestration #004","Ai Orchestration #005","2.812","4.293","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Orchestration #005","Ai Orchestration #001","5.846","4.771","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":329},{"label":"Mar","value":570},{"label":"Abr","value":623},{"label":"Mai","value":560},{"label":"Jun","value":392},{"label":"Jul","value":373},{"label":"Ago","value":572},{"label":"Set","value":336},{"label":"Out","value":364},{"label":"Nov","value":475},{"label":"Dez","value":429}];
const MX = 623;
