...
/* ═══ Legal Entity Management — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "2838", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "327", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€254K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "652254338", cells: ["LEG-7338", "Legal Entity Management Item 1", "23/3/2026", "€4438"], status: "active" as const },
    { id: "652257909", cells: ["LEG-1909", "Legal Entity Management Item 2", "10/10/2026", "€8009"], status: "pending" as const },
    { id: "652261480", cells: ["LEG-5480", "Legal Entity Management Item 3", "25/5/2026", "€11 580"], status: "completed" as const },
    { id: "652265051", cells: ["LEG-9051", "Legal Entity Management Item 4", "12/12/2026", "€15 151"], status: "warning" as const },
    { id: "652268622", cells: ["LEG-3622", "Legal Entity Management Item 5", "27/7/2026", "€18 722"], status: "active" as const },
];
...
export default function LegalEntityManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Legal Entity Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Legal Entity Management</p>
                    </div>
                </div>
