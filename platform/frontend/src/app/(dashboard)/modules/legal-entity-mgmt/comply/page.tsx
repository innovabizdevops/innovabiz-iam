...
const PAGE = "Comply";
const KPIS = [{"l":"Total Legal Entity Mgmt","v":"3.293","t":"+2.3%","d":"up"},{"l":"Comply Ativos","v":"8.091","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"72","t":"+17.4%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Entity Mgmt #001","Legal Entity Mgmt #002","2.978","2.307","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Entity Mgmt #002","Legal Entity Mgmt #003","7.394","808","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Entity Mgmt #003","Legal Entity Mgmt #004","4.539","6.890","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Entity Mgmt #004","Legal Entity Mgmt #005","2.890","1.009","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Entity Mgmt #005","Legal Entity Mgmt #001","8.419","6.497","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":560},{"label":"Mar","value":829},{"label":"Abr","value":771},{"label":"Mai","value":820},{"label":"Jun","value":685},{"label":"Jul","value":559},{"label":"Ago","value":685},{"label":"Set","value":822},{"label":"Out","value":877},{"label":"Nov","value":605},{"label":"Dez","value":682}];
const MX = 878;
