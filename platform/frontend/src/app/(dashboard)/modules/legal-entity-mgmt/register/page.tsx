...
const PAGE = "Register";
const KPIS = [{"l":"Total Legal Entity Mgmt","v":"8.088","t":"-5.4%","d":"down"},{"l":"Register Ativos","v":"5.066","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"64","t":"+2.5%","d":"up"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Entity Mgmt #001","Legal Entity Mgmt #002","1.812","3.229","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Entity Mgmt #002","Legal Entity Mgmt #003","1.682","8.929","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Entity Mgmt #003","Legal Entity Mgmt #004","6.911","734","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Entity Mgmt #004","Legal Entity Mgmt #005","8.920","5.301","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Entity Mgmt #005","Legal Entity Mgmt #001","5.346","2.407","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":750},{"label":"Mar","value":516},{"label":"Abr","value":472},{"label":"Mai","value":718},{"label":"Jun","value":747},{"label":"Jul","value":532},{"label":"Ago","value":461},{"label":"Set","value":504},{"label":"Out","value":841},{"label":"Nov","value":667},{"label":"Dez","value":830}];
const MX = 841;
