...
const PAGE = "Report";
const KPIS = [{"l":"Total Legal Entity Mgmt","v":"381","t":"+17.0%","d":"up"},{"l":"Report Ativos","v":"3.643","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"90.7%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"72","t":"-0.4%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Entity Mgmt #001","Legal Entity Mgmt #002","9.007","5.649","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Entity Mgmt #002","Legal Entity Mgmt #003","5.011","7.340","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Entity Mgmt #003","Legal Entity Mgmt #004","580","2.096","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Entity Mgmt #004","Legal Entity Mgmt #005","2.444","6.586","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Entity Mgmt #005","Legal Entity Mgmt #001","5.877","4.027","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":273},{"label":"Fev","value":616},{"label":"Mar","value":297},{"label":"Abr","value":580},{"label":"Mai","value":453},{"label":"Jun","value":572},{"label":"Jul","value":401},{"label":"Ago","value":524},{"label":"Set","value":525},{"label":"Out","value":550},{"label":"Nov","value":420},{"label":"Dez","value":396}];
const MX = 616;
