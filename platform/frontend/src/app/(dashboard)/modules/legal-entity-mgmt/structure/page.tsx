...
const ACCENT = "#4c1d95";
const MODULE = "Legal Entity Management";
const PAGE = "Structure";
const KPIS = [{"l":"Total Legal Entity Mgmt","v":"8.652","t":"+0.6%","d":"up"},{"l":"Structure Ativos","v":"6.793","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.6%","d":"up"}];
const COLS = ["ID","Structure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Entity Mgmt #001","Legal Entity Mgmt #002","1.228","9.005","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Entity Mgmt #002","Legal Entity Mgmt #003","4.777","6.532","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Entity Mgmt #003","Legal Entity Mgmt #004","4.395","6.613","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Entity Mgmt #004","Legal Entity Mgmt #005","1.669","922","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Entity Mgmt #005","Legal Entity Mgmt #001","7.103","5.263","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":746},{"label":"Mar","value":445},{"label":"Abr","value":806},{"label":"Mai","value":805},{"label":"Jun","value":480},{"label":"Jul","value":779},{"label":"Ago","value":527},{"label":"Set","value":695},{"label":"Out","value":752},{"label":"Nov","value":700},{"label":"Dez","value":692}];
const MX = 806;
