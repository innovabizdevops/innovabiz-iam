...
const PAGE = "Dissolve";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.088","t":"-5.9%","d":"down"},{"l":"Sessões/Dia","v":"3500","t":"+15.3%","d":"up"},{"l":"MFA Adoção (%)","v":"67.0%","t":"-4.2%","d":"down"},{"l":"Tentativas Bloqueadas","v":"6.298","t":"+4.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.759","2.492","8.125","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.964","4.237","2.190","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","668","3.203","6.257","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.090","5.902","8.574","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.430","4.957","4.587","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":288},{"label":"Mar","value":477},{"label":"Abr","value":460},{"label":"Mai","value":453},{"label":"Jun","value":605},{"label":"Jul","value":279},{"label":"Ago","value":455},{"label":"Set","value":245},{"label":"Out","value":269},{"label":"Nov","value":223},{"label":"Dez","value":328}];
const MX = 605;
