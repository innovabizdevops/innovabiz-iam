...
const ACCENT = "#881337";
const MODULE = "Influencer Management";
const PAGE = "Campaign Brief";
const KPIS = [{"l":"Total Influencer Mgmt","v":"6.234","t":"-3.2%","d":"down"},{"l":"Campaign Brief Ativos","v":"5.004","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"72.2%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+13.0%","d":"up"}];
const COLS = ["ID","Campaign Brief","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Influencer Mgmt #001","Influencer Mgmt #002","6.587","7.109","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Influencer Mgmt #002","Influencer Mgmt #003","7.226","3.470","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Influencer Mgmt #003","Influencer Mgmt #004","2.910","5.243","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Influencer Mgmt #004","Influencer Mgmt #005","6.517","1.671","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Influencer Mgmt #005","Influencer Mgmt #001","448","7.820","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":833},{"label":"Mar","value":646},{"label":"Abr","value":789},{"label":"Mai","value":835},{"label":"Jun","value":657},{"label":"Jul","value":727},{"label":"Ago","value":1003},{"label":"Set","value":789},{"label":"Out","value":691},{"label":"Nov","value":696},{"label":"Dez","value":905}];
const MX = 1003;
