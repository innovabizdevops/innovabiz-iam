...
const PAGE = "Payment";
const KPIS = [{"l":"Total Influencer Mgmt","v":"6.815","t":"-1.4%","d":"down"},{"l":"Payment Ativos","v":"7.080","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+14.9%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Influencer Mgmt #001","Influencer Mgmt #002","363","2.378","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Influencer Mgmt #002","Influencer Mgmt #003","8.989","3.175","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Influencer Mgmt #003","Influencer Mgmt #004","7.594","5.005","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Influencer Mgmt #004","Influencer Mgmt #005","412","6.193","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Influencer Mgmt #005","Influencer Mgmt #001","8.823","5.767","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":851},{"label":"Mar","value":646},{"label":"Abr","value":706},{"label":"Mai","value":824},{"label":"Jun","value":662},{"label":"Jul","value":544},{"label":"Ago","value":668},{"label":"Set","value":557},{"label":"Out","value":675},{"label":"Nov","value":740},{"label":"Dez","value":888}];
const MX = 888;
