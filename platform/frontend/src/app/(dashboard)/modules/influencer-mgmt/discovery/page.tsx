...
const KPIS = [{"l":"Total Influencer Mgmt","v":"9.021","t":"-5.8%","d":"down"},{"l":"Discovery Ativos","v":"5.796","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"67","t":"+14.5%","d":"up"}];
const COLS = ["ID","Discovery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Influencer Mgmt #001","Influencer Mgmt #002","3.493","8.353","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Influencer Mgmt #002","Influencer Mgmt #003","8.878","2.328","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Influencer Mgmt #003","Influencer Mgmt #004","1.976","3.476","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Influencer Mgmt #004","Influencer Mgmt #005","4.753","3.901","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Influencer Mgmt #005","Influencer Mgmt #001","5.992","2.804","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":687},{"label":"Mar","value":403},{"label":"Abr","value":469},{"label":"Mai","value":715},{"label":"Jun","value":418},{"label":"Jul","value":627},{"label":"Ago","value":506},{"label":"Set","value":554},{"label":"Out","value":666},{"label":"Nov","value":592},{"label":"Dez","value":735}];
const MX = 735;
