...
const PAGE = "ROI Tracking";
const KPIS = [{"l":"Total Influencer Mgmt","v":"261","t":"+6.3%","d":"up"},{"l":"ROI Tracking Ativos","v":"4.862","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+4.6%","d":"up"}];
const COLS = ["ID","ROI Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Influencer Mgmt #001","Influencer Mgmt #002","7.059","7.957","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Influencer Mgmt #002","Influencer Mgmt #003","4.004","8.306","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Influencer Mgmt #003","Influencer Mgmt #004","4.070","2.319","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Influencer Mgmt #004","Influencer Mgmt #005","1.672","2.817","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Influencer Mgmt #005","Influencer Mgmt #001","2.492","3.259","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":572},{"label":"Mar","value":555},{"label":"Abr","value":454},{"label":"Mai","value":408},{"label":"Jun","value":497},{"label":"Jul","value":501},{"label":"Ago","value":670},{"label":"Set","value":790},{"label":"Out","value":571},{"label":"Nov","value":676},{"label":"Dez","value":458}];
const MX = 790;
