...
const PAGE = "Content Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"3.075","t":"+3.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"76.8%","t":"+4.4%","d":"up"},{"l":"Tempo Médio (h)","v":"133h","t":"+17.9%","d":"up"},{"l":"Rejeitadas (%)","v":"70.4%","t":"+0.4%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.164","€ 23942.66","3.404","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.049","€ 36202.51","8.790","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.187","€ 4721.10","6.464","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","2.660","€ 17351.20","2.651","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","5.296","€ 13833.90","4.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":1001},{"label":"Mar","value":825},{"label":"Abr","value":825},{"label":"Mai","value":957},{"label":"Jun","value":906},{"label":"Jul","value":945},{"label":"Ago","value":794},{"label":"Set","value":922},{"label":"Out","value":633},{"label":"Nov","value":992},{"label":"Dez","value":857}];
const MX = 1001;
