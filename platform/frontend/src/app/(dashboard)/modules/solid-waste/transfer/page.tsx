...
const PAGE = "Transfer Station";
const KPIS = [{"l":"Total Solid Waste","v":"1.624","t":"+2.8%","d":"up"},{"l":"Transfer Station Ativos","v":"761","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"74.3%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"83","t":"-3.3%","d":"down"}];
const COLS = ["ID","Transfer Station","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solid Waste #001","Solid Waste #002","2.464","3.281","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Solid Waste #002","Solid Waste #003","1.914","2.447","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Solid Waste #003","Solid Waste #004","1.285","2.878","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Solid Waste #004","Solid Waste #005","7.300","6.017","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solid Waste #005","Solid Waste #001","3.088","1.765","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":842},{"label":"Mar","value":551},{"label":"Abr","value":837},{"label":"Mai","value":669},{"label":"Jun","value":786},{"label":"Jul","value":526},{"label":"Ago","value":866},{"label":"Set","value":722},{"label":"Out","value":889},{"label":"Nov","value":893},{"label":"Dez","value":684}];
const MX = 893;
