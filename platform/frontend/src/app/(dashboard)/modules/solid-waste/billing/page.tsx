...
const PAGE = "Billing";
const KPIS = [{"l":"Total Solid Waste","v":"8.267","t":"+17.4%","d":"up"},{"l":"Billing Ativos","v":"6.001","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"88.8%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"69","t":"+12.5%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solid Waste #001","Solid Waste #002","2.167","4.279","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Solid Waste #002","Solid Waste #003","5.844","2.388","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Solid Waste #003","Solid Waste #004","182","2.265","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Solid Waste #004","Solid Waste #005","5.491","8.183","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solid Waste #005","Solid Waste #001","5.694","7.571","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":744},{"label":"Mar","value":441},{"label":"Abr","value":437},{"label":"Mai","value":473},{"label":"Jun","value":516},{"label":"Jul","value":502},{"label":"Ago","value":733},{"label":"Set","value":663},{"label":"Out","value":418},{"label":"Nov","value":780},{"label":"Dez","value":565}];
const MX = 780;
