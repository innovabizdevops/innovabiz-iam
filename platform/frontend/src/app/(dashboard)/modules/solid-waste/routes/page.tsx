...
const PAGE = "Collection Route";
const KPIS = [{"l":"Total Solid Waste","v":"4.679","t":"+10.4%","d":"up"},{"l":"Collection Route Ativos","v":"3.428","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"74.4%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"73","t":"+14.6%","d":"up"}];
const COLS = ["ID","Collection Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solid Waste #001","Solid Waste #002","8.003","7.553","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Solid Waste #002","Solid Waste #003","1.883","5.874","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Solid Waste #003","Solid Waste #004","7.076","8.471","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Solid Waste #004","Solid Waste #005","2.277","5.635","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solid Waste #005","Solid Waste #001","6.877","7.448","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":911},{"label":"Mar","value":668},{"label":"Abr","value":564},{"label":"Mai","value":723},{"label":"Jun","value":888},{"label":"Jul","value":751},{"label":"Ago","value":614},{"label":"Set","value":574},{"label":"Out","value":825},{"label":"Nov","value":745},{"label":"Dez","value":646}];
const MX = 911;
