...
const KPIS = [{"l":"Total Solid Waste","v":"462","t":"-1.9%","d":"down"},{"l":"Waste To Energy Ativos","v":"4.514","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.0%","d":"down"}];
const COLS = ["ID","Waste To Energy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solid Waste #001","Solid Waste #002","6.494","7.702","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Solid Waste #002","Solid Waste #003","1.994","2.982","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Solid Waste #003","Solid Waste #004","5.070","1.504","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Solid Waste #004","Solid Waste #005","4.756","4.950","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solid Waste #005","Solid Waste #001","5.556","6.355","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":690},{"label":"Mar","value":679},{"label":"Abr","value":574},{"label":"Mai","value":610},{"label":"Jun","value":524},{"label":"Jul","value":568},{"label":"Ago","value":504},{"label":"Set","value":384},{"label":"Out","value":305},{"label":"Nov","value":506},{"label":"Dez","value":689}];
const MX = 690;
