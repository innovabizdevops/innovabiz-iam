...
const ACCENT = "#b45309";
const MODULE = "Solid Waste Mgmt";
const PAGE = "Landfill Monitor";
const KPIS = [{"l":"Total Solid Waste","v":"4.963","t":"+0.1%","d":"up"},{"l":"Landfill Monitor Ativos","v":"7.196","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"75","t":"+1.2%","d":"up"}];
const COLS = ["ID","Landfill Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Solid Waste #001","Solid Waste #002","1.920","2.975","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Solid Waste #002","Solid Waste #003","4.154","8.900","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Solid Waste #003","Solid Waste #004","803","1.261","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Solid Waste #004","Solid Waste #005","4.445","1.493","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Solid Waste #005","Solid Waste #001","5.298","5.119","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":610},{"label":"Mar","value":402},{"label":"Abr","value":320},{"label":"Mai","value":511},{"label":"Jun","value":302},{"label":"Jul","value":490},{"label":"Ago","value":329},{"label":"Set","value":634},{"label":"Out","value":558},{"label":"Nov","value":634},{"label":"Dez","value":409}];
const MX = 634;
