...
export default function CrisprPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Crispr Platform</h1><p className="text-sm text-muted-foreground">Crispr Platform • iBOS Enterprise</p></div>
