...
const PAGE = "Ethics";
const KPIS = [{"l":"Formulários Ativos","v":"815","t":"-0.9%","d":"down"},{"l":"Submissões/Dia","v":"3631","t":"+0.2%","d":"up"},{"l":"Documentos Gerados","v":"5.967","t":"+1.3%","d":"up"},{"l":"Templates","v":"687","t":"+17.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.162","2026-01-12","6.214","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.803","2026-03-25","3.992","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.092","2026-01-06","8.992","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.240","2026-02-16","822","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.062","2026-01-16","6.935","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":612},{"label":"Mar","value":335},{"label":"Abr","value":485},{"label":"Mai","value":542},{"label":"Jun","value":375},{"label":"Jul","value":501},{"label":"Ago","value":448},{"label":"Set","value":679},{"label":"Out","value":549},{"label":"Nov","value":514},{"label":"Dez","value":605}];
const MX = 679;
