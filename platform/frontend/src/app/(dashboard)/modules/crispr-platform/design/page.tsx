...
const ACCENT = "#6366f1";
const MODULE = "CRISPR Platform";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"282","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"1520","t":"+3.2%","d":"up"},{"l":"Documentos Gerados","v":"4.096","t":"+11.5%","d":"up"},{"l":"Templates","v":"2.672","t":"-2.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","908","2026-01-01","1.827","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.896","2026-01-03","8.092","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.722","2026-02-18","2.734","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.896","2026-01-27","2.175","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.934","2026-01-19","2.550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":636},{"label":"Mar","value":407},{"label":"Abr","value":689},{"label":"Mai","value":659},{"label":"Jun","value":718},{"label":"Jul","value":397},{"label":"Ago","value":560},{"label":"Set","value":523},{"label":"Out","value":693},{"label":"Nov","value":632},{"label":"Dez","value":531}];
const MX = 718;
