...
const PAGE = "Delivery";
const KPIS = [{"l":"Formulários Ativos","v":"1.287","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"327","t":"+9.3%","d":"up"},{"l":"Documentos Gerados","v":"1.925","t":"-5.6%","d":"down"},{"l":"Templates","v":"5.440","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.957","2026-03-08","476","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","346","2026-03-17","6.618","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.879","2026-02-13","6.847","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.130","2026-03-11","7.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.161","2026-03-17","3.117","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":703},{"label":"Mar","value":635},{"label":"Abr","value":705},{"label":"Mai","value":409},{"label":"Jun","value":714},{"label":"Jul","value":727},{"label":"Ago","value":407},{"label":"Set","value":592},{"label":"Out","value":371},{"label":"Nov","value":359},{"label":"Dez","value":353}];
const MX = 727;
