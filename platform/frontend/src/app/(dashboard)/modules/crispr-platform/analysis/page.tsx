...
const PAGE = "Analysis";
const KPIS = [{"l":"Formulários Ativos","v":"6.957","t":"+16.4%","d":"up"},{"l":"Submissões/Dia","v":"1756","t":"+6.8%","d":"up"},{"l":"Documentos Gerados","v":"2.134","t":"+5.5%","d":"up"},{"l":"Templates","v":"1.659","t":"+15.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.990","2026-02-05","3.081","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.705","2026-02-21","2.504","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.349","2026-02-19","8.388","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","9.024","2026-01-14","919","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.979","2026-03-28","9.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":496},{"label":"Mar","value":373},{"label":"Abr","value":383},{"label":"Mai","value":440},{"label":"Jun","value":476},{"label":"Jul","value":505},{"label":"Ago","value":648},{"label":"Set","value":500},{"label":"Out","value":686},{"label":"Nov","value":676},{"label":"Dez","value":679}];
const MX = 686;
