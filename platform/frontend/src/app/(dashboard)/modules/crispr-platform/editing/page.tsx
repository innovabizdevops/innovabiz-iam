...
const PAGE = "Editing";
const KPIS = [{"l":"Formulários Ativos","v":"7.810","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"1661","t":"+10.2%","d":"up"},{"l":"Documentos Gerados","v":"1.367","t":"+14.4%","d":"up"},{"l":"Templates","v":"8.346","t":"-2.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.015","2026-01-19","1.693","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.360","2026-02-14","5.716","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.839","2026-03-17","403","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.033","2026-03-09","2.267","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.259","2026-01-28","1.250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":617},{"label":"Mar","value":508},{"label":"Abr","value":506},{"label":"Mai","value":437},{"label":"Jun","value":342},{"label":"Jul","value":623},{"label":"Ago","value":465},{"label":"Set","value":481},{"label":"Out","value":369},{"label":"Nov","value":619},{"label":"Dez","value":510}];
const MX = 732;
