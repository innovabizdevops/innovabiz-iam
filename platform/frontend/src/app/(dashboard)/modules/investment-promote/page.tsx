...
/* ═══ Investment Promotion — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "2097", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1002", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€392K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1860964397", cells: ["INV-8397", "Investment Promotion Item 1", "6/6/2026", "€14 497"], status: "active" as const },
    { id: "1860967968", cells: ["INV-2968", "Investment Promotion Item 2", "21/1/2026", "€18 068"], status: "pending" as const },
    { id: "1860971539", cells: ["INV-6539", "Investment Promotion Item 3", "8/8/2026", "€21 639"], status: "completed" as const },
    { id: "1860975110", cells: ["INV-1110", "Investment Promotion Item 4", "23/3/2026", "€25 210"], status: "warning" as const },
    { id: "1860978681", cells: ["INV-4681", "Investment Promotion Item 5", "10/10/2026", "€28 781"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Investment Promotion</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Investment Promotion</p>
                    </div>
                </div>
