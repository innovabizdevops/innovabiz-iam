...
const KPIS = [{"l":"Vendas YTD (€)","v":"€69372","t":"+4.4%","d":"up"},{"l":"Pipeline (€)","v":"€44868","t":"+12.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"91.2%","t":"+0.3%","d":"up"},{"l":"Win Rate (%)","v":"86.8%","t":"-1.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7156.26","€ 40076.87","€ 14272.75","72.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 2542.05","€ 2077.51","€ 11350.28","84.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 34607.78","€ 48225.26","€ 16920.10","97.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 31130.82","€ 4998.15","€ 35534.50","98.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 28701.91","€ 17743.50","€ 33698.96","85.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":290},{"label":"Mar","value":479},{"label":"Abr","value":304},{"label":"Mai","value":543},{"label":"Jun","value":332},{"label":"Jul","value":582},{"label":"Ago","value":462},{"label":"Set","value":450},{"label":"Out","value":402},{"label":"Nov","value":598},{"label":"Dez","value":520}];
const MX = 598;
