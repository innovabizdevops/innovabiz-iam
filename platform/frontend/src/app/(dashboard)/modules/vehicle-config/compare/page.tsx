...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.977","t":"-3.3%","d":"down"},{"l":"NC Abertas","v":"4.651","t":"+1.4%","d":"up"},{"l":"Conformidade (%)","v":"89.4%","t":"+17.6%","d":"up"},{"l":"CAPAs Pendentes","v":"8.255","t":"+8.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.970","96.8%","4.727","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.008","73.8%","6.618","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.613","72.0%","6.637","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.585","94.5%","1.955","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.188","93.5%","4.930","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":892},{"label":"Mar","value":846},{"label":"Abr","value":771},{"label":"Mai","value":849},{"label":"Jun","value":902},{"label":"Jul","value":747},{"label":"Ago","value":1003},{"label":"Set","value":914},{"label":"Out","value":688},{"label":"Nov","value":1028},{"label":"Dez","value":838}];
const MX = 1028;
