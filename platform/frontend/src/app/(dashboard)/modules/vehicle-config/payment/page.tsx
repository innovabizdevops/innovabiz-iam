...
const PAGE = "Payment Calc";
const KPIS = [{"l":"Configurações","v":"2.606","t":"+11.8%","d":"up"},{"l":"Últimas Alterações","v":"1.386","t":"+6.2%","d":"up"},{"l":"Ambientes","v":"5.665","t":"+15.1%","d":"up"},{"l":"Versão Config","v":"8.166","t":"+8.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 19675.80","4.878","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 3252.95","8.409","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 49971.94","4.793","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 7250.58","691","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 32519.05","4.190","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":501},{"label":"Mar","value":655},{"label":"Abr","value":360},{"label":"Mai","value":414},{"label":"Jun","value":522},{"label":"Jul","value":355},{"label":"Ago","value":579},{"label":"Set","value":603},{"label":"Out","value":457},{"label":"Nov","value":405},{"label":"Dez","value":393}];
const MX = 655;
