...
const PAGE = "Paint Studio";
const KPIS = [{"l":"Configurações","v":"6.826","t":"-3.9%","d":"down"},{"l":"Últimas Alterações","v":"3.625","t":"+10.2%","d":"up"},{"l":"Ambientes","v":"3.646","t":"+4.8%","d":"up"},{"l":"Versão Config","v":"1.655","t":"+6.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 18881.61","6.532","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 19576.84","7.579","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 47997.26","1.928","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 40582.83","4.914","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 30964.88","4.745","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":861},{"label":"Mar","value":641},{"label":"Abr","value":631},{"label":"Mai","value":802},{"label":"Jun","value":744},{"label":"Jul","value":839},{"label":"Ago","value":844},{"label":"Set","value":886},{"label":"Out","value":885},{"label":"Nov","value":850},{"label":"Dez","value":808}];
const MX = 886;
