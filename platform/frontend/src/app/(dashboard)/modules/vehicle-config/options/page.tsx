...
const PAGE = "Option Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€26.8M","t":"-0.3%","d":"down"},{"l":"MRR (€)","v":"€79138","t":"+16.6%","d":"up"},{"l":"Churn (%)","v":"75.2%","t":"+2.2%","d":"up"},{"l":"ARPU (€)","v":"€71263","t":"+2.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 19032.15","6.795","€ 8777.21","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6813.56","7.265","€ 4422.94","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9695.07","7.036","€ 45861.78","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 22409.32","7.058","€ 7354.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 46775.81","1.632","€ 220.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":584},{"label":"Mar","value":846},{"label":"Abr","value":870},{"label":"Mai","value":661},{"label":"Jun","value":773},{"label":"Jul","value":900},{"label":"Ago","value":916},{"label":"Set","value":530},{"label":"Out","value":845},{"label":"Nov","value":695},{"label":"Dez","value":680}];
const MX = 916;
