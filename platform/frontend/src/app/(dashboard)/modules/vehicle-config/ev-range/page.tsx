...
const PAGE = "EV Range Sim";
const KPIS = [{"l":"Configurações","v":"3.235","t":"-4.2%","d":"down"},{"l":"Últimas Alterações","v":"3.484","t":"+4.3%","d":"up"},{"l":"Ambientes","v":"8.238","t":"+17.7%","d":"up"},{"l":"Versão Config","v":"6.619","t":"+4.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 33300.40","1.695","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 10521.16","7.841","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 6864.35","5.217","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 4236.34","6.741","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 20780.48","7.386","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":851},{"label":"Mar","value":965},{"label":"Abr","value":961},{"label":"Mai","value":764},{"label":"Jun","value":647},{"label":"Jul","value":863},{"label":"Ago","value":846},{"label":"Set","value":1021},{"label":"Out","value":823},{"label":"Nov","value":645},{"label":"Dez","value":927}];
const MX = 1021;
