...
const ACCENT = "#1e40af";
const MODULE = "Vehicle Configurator";
const PAGE = "3D Preview";
const KPIS = [{"l":"Configurações","v":"5.756","t":"-5.2%","d":"down"},{"l":"Últimas Alterações","v":"4.441","t":"+1.4%","d":"up"},{"l":"Ambientes","v":"5.838","t":"+5.3%","d":"up"},{"l":"Versão Config","v":"7.676","t":"+10.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 42232.99","1.023","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 3968.63","8.993","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 42671.07","1.420","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 20061.54","2.969","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 40080.19","5.604","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":824},{"label":"Mar","value":1000},{"label":"Abr","value":928},{"label":"Mai","value":811},{"label":"Jun","value":1009},{"label":"Jul","value":845},{"label":"Ago","value":849},{"label":"Set","value":830},{"label":"Out","value":994},{"label":"Nov","value":925},{"label":"Dez","value":1024}];
const MX = 1028;
