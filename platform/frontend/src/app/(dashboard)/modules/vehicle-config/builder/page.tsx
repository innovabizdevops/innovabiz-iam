...
const PAGE = "Model Builder";
const KPIS = [{"l":"Configurações","v":"2.925","t":"-2.8%","d":"down"},{"l":"Últimas Alterações","v":"8.009","t":"+3.0%","d":"up"},{"l":"Ambientes","v":"3.415","t":"+4.2%","d":"up"},{"l":"Versão Config","v":"199","t":"+3.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 16990.71","7.996","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 39751.13","1.390","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 30760.87","303","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 8956.20","4.433","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 7359.34","802","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":436},{"label":"Mar","value":546},{"label":"Abr","value":380},{"label":"Mai","value":426},{"label":"Jun","value":413},{"label":"Jul","value":449},{"label":"Ago","value":625},{"label":"Set","value":466},{"label":"Out","value":586},{"label":"Nov","value":668},{"label":"Dez","value":423}];
const MX = 668;
