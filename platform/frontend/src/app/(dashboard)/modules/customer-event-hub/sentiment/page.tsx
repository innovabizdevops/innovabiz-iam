...
const KPIS = [{"l":"Dashboards Ativos","v":"5.378","t":"+6.3%","d":"up"},{"l":"Queries/Dia","v":"376","t":"+6.4%","d":"up"},{"l":"Dados Processados (GB)","v":"3.324","t":"+0.2%","d":"up"},{"l":"Utilizadores Analytics","v":"6.987","t":"+11.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2117","2026-01-04","3.805","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","280","2026-03-09","1.344","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","979","2026-03-14","4.416","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3748","2026-01-01","8.469","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2327","2026-03-24","609","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":624},{"label":"Mar","value":883},{"label":"Abr","value":835},{"label":"Mai","value":661},{"label":"Jun","value":642},{"label":"Jul","value":533},{"label":"Ago","value":821},{"label":"Set","value":556},{"label":"Out","value":680},{"label":"Nov","value":837},{"label":"Dez","value":900}];
const MX = 900;
