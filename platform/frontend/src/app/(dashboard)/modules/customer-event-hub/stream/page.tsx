...
const PAGE = "Event Stream";
const KPIS = [{"l":"Eventos Planeados","v":"748","t":"-3.5%","d":"down"},{"l":"Participantes","v":"2.042","t":"+3.1%","d":"up"},{"l":"NPS Evento","v":"84","t":"+7.6%","d":"up"},{"l":"Receita (€)","v":"€64185","t":"+15.4%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-23","2.476","8.016","€ 49091.08","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-06","8.806","8.904","€ 1545.57","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-25","324","5.584","€ 43258.70","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-11","3.341","8.585","€ 11045.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-01","4.464","2.204","€ 41258.20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":559},{"label":"Mar","value":610},{"label":"Abr","value":619},{"label":"Mai","value":871},{"label":"Jun","value":831},{"label":"Jul","value":494},{"label":"Ago","value":526},{"label":"Set","value":518},{"label":"Out","value":711},{"label":"Nov","value":752},{"label":"Dez","value":866}];
const MX = 871;
