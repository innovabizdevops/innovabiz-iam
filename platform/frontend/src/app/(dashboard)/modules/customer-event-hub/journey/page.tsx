...
const ACCENT = "#be185d";
const MODULE = "Customer Event Hub";
const PAGE = "Journey Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.913","t":"-0.3%","d":"down"},{"l":"Queries/Dia","v":"1399","t":"-3.0%","d":"down"},{"l":"Dados Processados (GB)","v":"7.277","t":"+2.9%","d":"up"},{"l":"Utilizadores Analytics","v":"936","t":"-4.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1327","2026-03-01","4.547","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5063","2026-01-12","8.618","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1838","2026-03-08","8.748","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1396","2026-02-04","1.330","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2101","2026-02-15","4.761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":291},{"label":"Fev","value":428},{"label":"Mar","value":421},{"label":"Abr","value":581},{"label":"Mai","value":570},{"label":"Jun","value":572},{"label":"Jul","value":581},{"label":"Ago","value":276},{"label":"Set","value":232},{"label":"Out","value":460},{"label":"Nov","value":230},{"label":"Dez","value":422}];
const MX = 581;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>CX</span></h1>
                </div>
