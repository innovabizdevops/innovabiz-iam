...
const PAGE = "Churn Predictor";
const KPIS = [{"l":"ARR (€M)","v":"€10.6M","t":"+3.2%","d":"up"},{"l":"MRR (€)","v":"€95584","t":"+5.4%","d":"up"},{"l":"Churn (%)","v":"77.5%","t":"+5.5%","d":"up"},{"l":"ARPU (€)","v":"€49321","t":"+9.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 31488.39","852","€ 39377.27","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44931.27","6.923","€ 21297.33","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2508.00","541","€ 32479.09","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 48067.53","975","€ 24326.41","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4177.40","8.146","€ 2973.80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":882},{"label":"Mar","value":911},{"label":"Abr","value":913},{"label":"Mai","value":839},{"label":"Jun","value":797},{"label":"Jul","value":832},{"label":"Ago","value":934},{"label":"Set","value":762},{"label":"Out","value":796},{"label":"Nov","value":660},{"label":"Dez","value":689}];
const MX = 934;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#be185d'}}>ML</span></h1>
                </div>
