...
const KPIS = [{"l":"Eventos Planeados","v":"8.466","t":"+15.8%","d":"up"},{"l":"Participantes","v":"1.138","t":"+11.7%","d":"up"},{"l":"NPS Evento","v":"77","t":"+15.5%","d":"up"},{"l":"Receita (€)","v":"€60223","t":"+14.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-06","1.184","6.028","€ 39947.31","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-18","6.657","2.059","€ 24346.10","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-04","5.829","2.844","€ 42187.85","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-16","5.014","6.503","€ 14549.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-16","8.177","4.328","€ 45575.97","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":701},{"label":"Mar","value":620},{"label":"Abr","value":517},{"label":"Mai","value":727},{"label":"Jun","value":671},{"label":"Jul","value":640},{"label":"Ago","value":624},{"label":"Set","value":489},{"label":"Out","value":530},{"label":"Nov","value":673},{"label":"Dez","value":358}];
const MX = 727;
