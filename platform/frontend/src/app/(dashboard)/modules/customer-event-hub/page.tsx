...
export default function CustomerEventHubPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Customer Event Hub</h1><p className="text-sm text-muted-foreground">Customer Event Hub • iBOS Enterprise</p></div>
