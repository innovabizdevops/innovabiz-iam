...
const PAGE = "Touchpoint Map";
const KPIS = [{"l":"Eventos Planeados","v":"3.943","t":"+15.3%","d":"up"},{"l":"Participantes","v":"3.951","t":"+5.5%","d":"up"},{"l":"NPS Evento","v":"69","t":"+10.7%","d":"up"},{"l":"Receita (€)","v":"€35269","t":"+11.8%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-18","7.818","7.588","€ 32762.14","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-25","7.815","4.416","€ 31250.37","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-04","7.352","1.766","€ 33243.45","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-21","8.555","3.032","€ 21186.57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-09","1.642","1.269","€ 12703.55","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":1038},{"label":"Mar","value":1006},{"label":"Abr","value":932},{"label":"Mai","value":703},{"label":"Jun","value":1025},{"label":"Jul","value":1016},{"label":"Ago","value":839},{"label":"Set","value":1043},{"label":"Out","value":1006},{"label":"Nov","value":710},{"label":"Dez","value":699}];
const MX = 1043;
