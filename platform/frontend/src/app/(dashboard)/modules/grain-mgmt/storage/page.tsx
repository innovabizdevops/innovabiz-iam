...
const ACCENT = "#6366f1";
const MODULE = "Grain Management";
const PAGE = "Storage";
const KPIS = [{"l":"Total Grain Mgmt","v":"872","t":"+13.9%","d":"up"},{"l":"Storage Ativos","v":"2.412","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"69","t":"+6.2%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Mgmt #001","Grain Mgmt #002","5.295","7.196","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Mgmt #002","Grain Mgmt #003","6.069","5.969","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Mgmt #003","Grain Mgmt #004","6.884","5.376","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Mgmt #004","Grain Mgmt #005","4.953","3.859","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Mgmt #005","Grain Mgmt #001","1.146","1.048","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":792},{"label":"Mar","value":534},{"label":"Abr","value":523},{"label":"Mai","value":843},{"label":"Jun","value":828},{"label":"Jul","value":630},{"label":"Ago","value":575},{"label":"Set","value":610},{"label":"Out","value":540},{"label":"Nov","value":882},{"label":"Dez","value":877}];
const MX = 882;
