...
const KPIS = [{"l":"Total Grain Mgmt","v":"8.698","t":"-6.0%","d":"down"},{"l":"Logistics Ativos","v":"7.302","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"61","t":"+2.6%","d":"up"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Mgmt #001","Grain Mgmt #002","1.804","6.494","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Mgmt #002","Grain Mgmt #003","3.128","5.865","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Mgmt #003","Grain Mgmt #004","5.596","7.671","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Mgmt #004","Grain Mgmt #005","8.944","6.034","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Mgmt #005","Grain Mgmt #001","8.996","7.685","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":680},{"label":"Mar","value":868},{"label":"Abr","value":781},{"label":"Mai","value":652},{"label":"Jun","value":812},{"label":"Jul","value":806},{"label":"Ago","value":656},{"label":"Set","value":830},{"label":"Out","value":550},{"label":"Nov","value":872},{"label":"Dez","value":859}];
const MX = 872;
