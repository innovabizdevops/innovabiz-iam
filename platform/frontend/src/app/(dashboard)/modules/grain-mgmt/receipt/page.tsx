...
const PAGE = "Receipt";
const KPIS = [{"l":"Total Grain Mgmt","v":"6.429","t":"-5.7%","d":"down"},{"l":"Receipt Ativos","v":"7.688","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"81","t":"-2.2%","d":"down"}];
const COLS = ["ID","Receipt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Mgmt #001","Grain Mgmt #002","7.432","6.497","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Mgmt #002","Grain Mgmt #003","7.783","7.849","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Mgmt #003","Grain Mgmt #004","5.994","7.904","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Mgmt #004","Grain Mgmt #005","3.889","5.439","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Mgmt #005","Grain Mgmt #001","8.265","6.905","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":401},{"label":"Mar","value":363},{"label":"Abr","value":630},{"label":"Mai","value":360},{"label":"Jun","value":553},{"label":"Jul","value":399},{"label":"Ago","value":373},{"label":"Set","value":627},{"label":"Out","value":564},{"label":"Nov","value":309},{"label":"Dez","value":505}];
const MX = 630;
