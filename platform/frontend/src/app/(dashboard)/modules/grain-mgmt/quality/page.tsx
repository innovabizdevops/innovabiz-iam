...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.983","t":"+1.1%","d":"up"},{"l":"NC Abertas","v":"2.152","t":"+11.7%","d":"up"},{"l":"Conformidade (%)","v":"90.3%","t":"+13.4%","d":"up"},{"l":"CAPAs Pendentes","v":"3.255","t":"-5.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.746","74.8%","4.822","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.624","81.2%","4.266","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.147","75.8%","7.512","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.192","97.2%","758","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","493","75.4%","3.325","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":656},{"label":"Mar","value":611},{"label":"Abr","value":692},{"label":"Mai","value":481},{"label":"Jun","value":603},{"label":"Jul","value":709},{"label":"Ago","value":774},{"label":"Set","value":695},{"label":"Out","value":857},{"label":"Nov","value":712},{"label":"Dez","value":835}];
const MX = 857;
