...
const PAGE = "Trading";
const KPIS = [{"l":"Total Grain Mgmt","v":"5.216","t":"+12.4%","d":"up"},{"l":"Trading Ativos","v":"8.920","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"56","t":"-0.8%","d":"down"}];
const COLS = ["ID","Trading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grain Mgmt #001","Grain Mgmt #002","3.770","1.645","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Grain Mgmt #002","Grain Mgmt #003","8.675","1.072","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Grain Mgmt #003","Grain Mgmt #004","1.275","4.072","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Grain Mgmt #004","Grain Mgmt #005","971","5.830","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grain Mgmt #005","Grain Mgmt #001","4.593","4.322","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":722},{"label":"Mar","value":538},{"label":"Abr","value":568},{"label":"Mai","value":564},{"label":"Jun","value":878},{"label":"Jul","value":628},{"label":"Ago","value":789},{"label":"Set","value":895},{"label":"Out","value":703},{"label":"Nov","value":544},{"label":"Dez","value":790}];
const MX = 895;
