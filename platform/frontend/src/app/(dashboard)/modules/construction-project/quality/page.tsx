...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.954","t":"+16.8%","d":"up"},{"l":"NC Abertas","v":"6.438","t":"+2.4%","d":"up"},{"l":"Conformidade (%)","v":"84.2%","t":"+14.6%","d":"up"},{"l":"CAPAs Pendentes","v":"4.689","t":"+1.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.907","85.3%","6.007","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.604","82.8%","6.891","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.690","70.2%","5.729","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","979","98.5%","6.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.606","78.9%","7.354","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":968},{"label":"Fev","value":1029},{"label":"Mar","value":796},{"label":"Abr","value":985},{"label":"Mai","value":1021},{"label":"Jun","value":779},{"label":"Jul","value":791},{"label":"Ago","value":781},{"label":"Set","value":1037},{"label":"Out","value":811},{"label":"Nov","value":711},{"label":"Dez","value":912}];
const MX = 1037;
