...
/* ═══ Construction Project Mgmt — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "8508", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "681", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€70K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1628211908", cells: ["CON-4908", "Construction Project Mgmt Item 1", "9/9/2026", "€12 008"], status: "active" as const },
    { id: "1628215479", cells: ["CON-8479", "Construction Project Mgmt Item 2", "24/4/2026", "€15 579"], status: "pending" as const },
    { id: "1628219050", cells: ["CON-3050", "Construction Project Mgmt Item 3", "11/11/2026", "€19 150"], status: "completed" as const },
    { id: "1628222621", cells: ["CON-6621", "Construction Project Mgmt Item 4", "26/6/2026", "€22 721"], status: "warning" as const },
    { id: "1628226192", cells: ["CON-1192", "Construction Project Mgmt Item 5", "13/1/2026", "€26 292"], status: "active" as const },
];
...
export default function ConstructionProjectMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Construction Project Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Construction Project Mgmt</p>
                    </div>
                </div>
