...
const ACCENT = "#78350f";
const MODULE = "Construction Project Mgmt";
const PAGE = "Schedule";
const KPIS = [{"l":"Total Construction Project","v":"5.630","t":"-4.7%","d":"down"},{"l":"Schedule Ativos","v":"1.722","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"67","t":"+14.0%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Construction Project #001","Construction Project #002","5.007","6.673","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Construction Project #002","Construction Project #003","4.570","1.481","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Construction Project #003","Construction Project #004","4.056","8.156","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Construction Project #004","Construction Project #005","1.085","3.945","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Construction Project #005","Construction Project #001","6.502","3.118","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":628},{"label":"Mar","value":726},{"label":"Abr","value":764},{"label":"Mai","value":708},{"label":"Jun","value":511},{"label":"Jul","value":525},{"label":"Ago","value":479},{"label":"Set","value":599},{"label":"Out","value":710},{"label":"Nov","value":630},{"label":"Dez","value":637}];
const MX = 764;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78350f'}}>AI</span></h1>
                </div>
