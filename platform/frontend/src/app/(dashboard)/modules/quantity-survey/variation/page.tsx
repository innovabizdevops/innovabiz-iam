...
const KPIS = [{"l":"Surveys Ativos","v":"4.437","t":"+2.7%","d":"up"},{"l":"Respostas/Semana","v":"3699","t":"+0.2%","d":"up"},{"l":"NPS Médio","v":"83","t":"+16.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"87.8%","t":"+12.2%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.637","74","88.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.173","77","85.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","7.394","93","90.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.842","60","88.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","7.954","58","70.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":544},{"label":"Mar","value":420},{"label":"Abr","value":431},{"label":"Mai","value":334},{"label":"Jun","value":460},{"label":"Jul","value":316},{"label":"Ago","value":683},{"label":"Set","value":468},{"label":"Out","value":480},{"label":"Nov","value":693},{"label":"Dez","value":701}];
const MX = 701;
