...
const PAGE = "BOQ";
const KPIS = [{"l":"Surveys Ativos","v":"7.093","t":"+16.6%","d":"up"},{"l":"Respostas/Semana","v":"4116","t":"+6.9%","d":"up"},{"l":"NPS Médio","v":"90","t":"-5.7%","d":"down"},{"l":"Taxa Resposta (%)","v":"72.3%","t":"+9.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.984","60","85.1%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","4.770","76","88.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","8.131","77","77.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","4.008","90","71.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","1.208","82","71.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":515},{"label":"Mar","value":689},{"label":"Abr","value":660},{"label":"Mai","value":359},{"label":"Jun","value":440},{"label":"Jul","value":474},{"label":"Ago","value":497},{"label":"Set","value":563},{"label":"Out","value":619},{"label":"Nov","value":624},{"label":"Dez","value":350}];
const MX = 689;
