...
const ACCENT = "#6366f1";
const MODULE = "Quantity Surveying";
const PAGE = "Cost Plan";
const KPIS = [{"l":"Surveys Ativos","v":"5.923","t":"+15.5%","d":"up"},{"l":"Respostas/Semana","v":"4368","t":"+5.8%","d":"up"},{"l":"NPS Médio","v":"84","t":"+5.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"70.6%","t":"-1.0%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.671","71","84.8%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","154","69","87.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","2.922","82","72.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","8.090","73","71.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.156","74","85.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":951},{"label":"Mar","value":721},{"label":"Abr","value":780},{"label":"Mai","value":892},{"label":"Jun","value":982},{"label":"Jul","value":1012},{"label":"Ago","value":764},{"label":"Set","value":674},{"label":"Out","value":872},{"label":"Nov","value":724},{"label":"Dez","value":880}];
const MX = 1012;
