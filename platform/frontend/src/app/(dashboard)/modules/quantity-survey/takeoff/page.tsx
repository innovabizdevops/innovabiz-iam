...
const PAGE = "Takeoff";
const KPIS = [{"l":"Surveys Ativos","v":"8.104","t":"+7.5%","d":"up"},{"l":"Respostas/Semana","v":"2166","t":"-4.4%","d":"down"},{"l":"NPS Médio","v":"68","t":"+10.0%","d":"up"},{"l":"Taxa Resposta (%)","v":"80.5%","t":"-1.8%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","7.981","75","94.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","3.045","84","75.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","709","61","71.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.605","80","89.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.029","73","70.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":750},{"label":"Mar","value":968},{"label":"Abr","value":795},{"label":"Mai","value":979},{"label":"Jun","value":1010},{"label":"Jul","value":803},{"label":"Ago","value":827},{"label":"Set","value":979},{"label":"Out","value":677},{"label":"Nov","value":680},{"label":"Dez","value":973}];
const MX = 1010;
