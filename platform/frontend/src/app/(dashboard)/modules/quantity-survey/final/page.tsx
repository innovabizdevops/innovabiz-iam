...
const PAGE = "Final Acct";
const KPIS = [{"l":"Surveys Ativos","v":"544","t":"+11.7%","d":"up"},{"l":"Respostas/Semana","v":"2280","t":"+5.1%","d":"up"},{"l":"NPS Médio","v":"72","t":"+0.0%","d":"up"},{"l":"Taxa Resposta (%)","v":"73.5%","t":"+1.6%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","2.965","90","71.4%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.857","63","70.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.398","72","80.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.930","87","87.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","5.810","92","82.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":710},{"label":"Mar","value":685},{"label":"Abr","value":768},{"label":"Mai","value":720},{"label":"Jun","value":957},{"label":"Jul","value":792},{"label":"Ago","value":624},{"label":"Set","value":780},{"label":"Out","value":665},{"label":"Nov","value":901},{"label":"Dez","value":798}];
const MX = 957;
