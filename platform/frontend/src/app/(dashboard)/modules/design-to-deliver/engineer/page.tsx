...
const PAGE = "Engineer";
const KPIS = [{"l":"Formulários Ativos","v":"2.766","t":"+6.8%","d":"up"},{"l":"Submissões/Dia","v":"4391","t":"+11.9%","d":"up"},{"l":"Documentos Gerados","v":"3.725","t":"+3.7%","d":"up"},{"l":"Templates","v":"4.350","t":"+13.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","934","2026-02-05","2.885","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.433","2026-02-05","1.458","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.439","2026-01-17","7.710","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.649","2026-02-12","449","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.130","2026-03-01","7.098","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":855},{"label":"Mar","value":780},{"label":"Abr","value":578},{"label":"Mai","value":846},{"label":"Jun","value":927},{"label":"Jul","value":744},{"label":"Ago","value":557},{"label":"Set","value":714},{"label":"Out","value":846},{"label":"Nov","value":597},{"label":"Dez","value":612}];
const MX = 927;
