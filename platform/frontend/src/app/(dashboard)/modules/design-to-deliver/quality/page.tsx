...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.129","t":"+11.6%","d":"up"},{"l":"NC Abertas","v":"8.628","t":"+8.2%","d":"up"},{"l":"Conformidade (%)","v":"80.5%","t":"+6.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.909","t":"+5.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.923","91.1%","2.791","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.380","79.3%","5.936","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.334","96.3%","407","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.419","84.3%","421","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","607","72.8%","3.025","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":922},{"label":"Fev","value":1047},{"label":"Mar","value":895},{"label":"Abr","value":1034},{"label":"Mai","value":885},{"label":"Jun","value":711},{"label":"Jul","value":1058},{"label":"Ago","value":1070},{"label":"Set","value":795},{"label":"Out","value":1003},{"label":"Nov","value":918},{"label":"Dez","value":898}];
const MX = 1070;
