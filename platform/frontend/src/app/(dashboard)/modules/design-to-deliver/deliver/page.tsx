...
const PAGE = "Deliver";
const KPIS = [{"l":"Formulários Ativos","v":"5.810","t":"+2.3%","d":"up"},{"l":"Submissões/Dia","v":"716","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"6.497","t":"+6.8%","d":"up"},{"l":"Templates","v":"8.354","t":"+16.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.338","2026-02-16","7.748","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.880","2026-03-09","4.273","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.285","2026-03-28","5.141","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.703","2026-01-14","4.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.299","2026-01-17","8.193","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":702},{"label":"Mar","value":949},{"label":"Abr","value":850},{"label":"Mai","value":660},{"label":"Jun","value":987},{"label":"Jul","value":704},{"label":"Ago","value":848},{"label":"Set","value":832},{"label":"Out","value":904},{"label":"Nov","value":755},{"label":"Dez","value":975}];
const MX = 987;
