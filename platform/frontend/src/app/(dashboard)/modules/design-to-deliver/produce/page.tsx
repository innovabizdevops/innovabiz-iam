...
const PAGE = "Produce";
const KPIS = [{"l":"Formulários Ativos","v":"3.783","t":"+10.8%","d":"up"},{"l":"Submissões/Dia","v":"3793","t":"+10.8%","d":"up"},{"l":"Documentos Gerados","v":"847","t":"+15.2%","d":"up"},{"l":"Templates","v":"8.847","t":"+3.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.938","2026-03-28","9.025","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","745","2026-03-16","6.330","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.696","2026-03-10","8.093","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.664","2026-01-10","5.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.356","2026-01-15","3.782","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":934},{"label":"Mar","value":811},{"label":"Abr","value":639},{"label":"Mai","value":737},{"label":"Jun","value":883},{"label":"Jul","value":713},{"label":"Ago","value":1023},{"label":"Set","value":942},{"label":"Out","value":848},{"label":"Nov","value":660},{"label":"Dez","value":953}];
const MX = 1023;
