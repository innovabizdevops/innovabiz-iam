...
/* ═══ Design-to-Deliver E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "4267", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "421", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€379K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "376481367", cells: ["DES-3367", "Design-to-Deliver E2E Item 1", "4/4/2026", "€31 467"], status: "active" as const },
    { id: "376484938", cells: ["DES-6938", "Design-to-Deliver E2E Item 2", "19/11/2026", "€35 038"], status: "pending" as const },
    { id: "376488509", cells: ["DES-1509", "Design-to-Deliver E2E Item 3", "6/6/2026", "€38 609"], status: "completed" as const },
    { id: "376492080", cells: ["DES-5080", "Design-to-Deliver E2E Item 4", "21/1/2026", "€42 180"], status: "warning" as const },
    { id: "376495651", cells: ["DES-8651", "Design-to-Deliver E2E Item 5", "8/8/2026", "€45 751"], status: "active" as const },
];
...
export default function DesigntodeliverE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Design-to-Deliver E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Design-to-Deliver E2E</p>
                    </div>
                </div>
