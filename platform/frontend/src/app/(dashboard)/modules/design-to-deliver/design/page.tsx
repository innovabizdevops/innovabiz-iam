...
const ACCENT = "#06b6d4";
const MODULE = "Design-to-Deliver E2E";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.635","t":"+0.7%","d":"up"},{"l":"Submissões/Dia","v":"196","t":"+10.2%","d":"up"},{"l":"Documentos Gerados","v":"1.360","t":"-2.0%","d":"down"},{"l":"Templates","v":"6.889","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.348","2026-02-27","1.265","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.088","2026-01-22","2.062","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.448","2026-02-22","7.684","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.052","2026-03-10","3.507","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","847","2026-02-04","1.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":308},{"label":"Mar","value":517},{"label":"Abr","value":379},{"label":"Mai","value":332},{"label":"Jun","value":539},{"label":"Jul","value":627},{"label":"Ago","value":604},{"label":"Set","value":572},{"label":"Out","value":351},{"label":"Nov","value":603},{"label":"Dez","value":535}];
const MX = 627;
