...
const PAGE = "Options";
const KPIS = [{"l":"Configurações","v":"7.542","t":"+13.6%","d":"up"},{"l":"Últimas Alterações","v":"3.731","t":"-0.6%","d":"down"},{"l":"Ambientes","v":"661","t":"+13.9%","d":"up"},{"l":"Versão Config","v":"8.242","t":"+8.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 39968.16","4.545","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 48798.80","2.317","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 20192.89","2.528","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 42827.04","7.347","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 27676.22","9.031","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":619},{"label":"Mar","value":301},{"label":"Abr","value":472},{"label":"Mai","value":405},{"label":"Jun","value":318},{"label":"Jul","value":542},{"label":"Ago","value":429},{"label":"Set","value":564},{"label":"Out","value":428},{"label":"Nov","value":540},{"label":"Dez","value":383}];
const MX = 619;
