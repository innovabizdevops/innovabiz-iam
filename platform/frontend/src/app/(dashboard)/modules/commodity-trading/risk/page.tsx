...
const ACCENT = "#d97706";
const MODULE = "Commodity Trading";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"290","t":"+7.6%","d":"up"},{"l":"Mitigações Ativas","v":"2.370","t":"-2.0%","d":"down"},{"l":"Score Risco Geral","v":"78","t":"+12.8%","d":"up"},{"l":"Incidentes YTD","v":"1.209","t":"+14.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","759","7.117","1.540","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.648","4.679","439","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.268","1.165","8.251","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.254","4.550","1.768","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.496","1.741","6.933","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":405},{"label":"Mar","value":372},{"label":"Abr","value":723},{"label":"Mai","value":452},{"label":"Jun","value":399},{"label":"Jul","value":595},{"label":"Ago","value":750},{"label":"Set","value":559},{"label":"Out","value":394},{"label":"Nov","value":740},{"label":"Dez","value":466}];
const MX = 750;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#d97706'}}>AI</span></h1>
                </div>
