...
const KPIS = [
    { label: "Total Registos", value: "2604", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2482", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€154K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1568914904", cells: ["COM-8904", "Commodity Trading Item 1", "5/9/2026", "€15 004"], status: "active" as const },
    { id: "1568918475", cells: ["COM-3475", "Commodity Trading Item 2", "20/4/2026", "€18 575"], status: "pending" as const },
    { id: "1568922046", cells: ["COM-7046", "Commodity Trading Item 3", "7/11/2026", "€22 146"], status: "completed" as const },
    { id: "1568925617", cells: ["COM-1617", "Commodity Trading Item 4", "22/6/2026", "€25 717"], status: "warning" as const },
    { id: "1568929188", cells: ["COM-5188", "Commodity Trading Item 5", "9/1/2026", "€29 288"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commodity Trading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Commodity Trading</p>
                    </div>
                </div>
