...
const KPIS = [{"l":"Total Commodity Trading","v":"1.232","t":"+9.2%","d":"up"},{"l":"Logistics Ativos","v":"7.430","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"85","t":"+11.9%","d":"up"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Commodity Trading #001","Commodity Trading #002","4.119","7.807","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Commodity Trading #002","Commodity Trading #003","3.325","8.066","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Commodity Trading #003","Commodity Trading #004","8.794","8.622","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Commodity Trading #004","Commodity Trading #005","6.092","1.196","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Commodity Trading #005","Commodity Trading #001","3.813","1.990","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":683},{"label":"Mar","value":511},{"label":"Abr","value":516},{"label":"Mai","value":768},{"label":"Jun","value":535},{"label":"Jul","value":453},{"label":"Ago","value":553},{"label":"Set","value":523},{"label":"Out","value":519},{"label":"Nov","value":653},{"label":"Dez","value":572}];
const MX = 768;
