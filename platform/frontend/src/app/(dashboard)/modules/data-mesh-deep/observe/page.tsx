...
const PAGE = "Observe";
const KPIS = [{"l":"Dashboards Ativos","v":"5.464","t":"-0.9%","d":"down"},{"l":"Queries/Dia","v":"2822","t":"+5.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.443","t":"+13.6%","d":"up"},{"l":"Utilizadores Analytics","v":"9.042","t":"+10.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1276","2026-03-14","7.839","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4821","2026-03-07","7.981","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2524","2026-03-22","7.643","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","490","2026-03-17","4.938","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","508","2026-01-09","8.955","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":707},{"label":"Mar","value":747},{"label":"Abr","value":831},{"label":"Mai","value":687},{"label":"Jun","value":582},{"label":"Jul","value":639},{"label":"Ago","value":640},{"label":"Set","value":456},{"label":"Out","value":755},{"label":"Nov","value":546},{"label":"Dez","value":530}];
const MX = 831;
