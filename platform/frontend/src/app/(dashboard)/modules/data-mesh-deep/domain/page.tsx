...
const PAGE = "Domain";
const KPIS = [{"l":"Dashboards Ativos","v":"4.883","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"3640","t":"+8.3%","d":"up"},{"l":"Dados Processados (GB)","v":"111","t":"+12.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.020","t":"-4.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4844","2026-02-09","2.283","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4524","2026-03-27","5.221","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1853","2026-02-12","3.358","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1217","2026-03-12","6.773","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1362","2026-01-02","7.410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":820},{"label":"Mar","value":693},{"label":"Abr","value":1029},{"label":"Mai","value":975},{"label":"Jun","value":744},{"label":"Jul","value":935},{"label":"Ago","value":876},{"label":"Set","value":891},{"label":"Out","value":675},{"label":"Nov","value":663},{"label":"Dez","value":829}];
const MX = 1029;
