...
const PAGE = "Product";
const KPIS = [{"l":"Dashboards Ativos","v":"8.956","t":"+8.8%","d":"up"},{"l":"Queries/Dia","v":"2188","t":"+0.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.303","t":"+16.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.501","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4742","2026-03-12","9.000","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","371","2026-01-17","4.475","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","443","2026-01-12","2.876","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4681","2026-02-21","8.590","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3522","2026-03-14","6.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":551},{"label":"Mar","value":478},{"label":"Abr","value":602},{"label":"Mai","value":489},{"label":"Jun","value":459},{"label":"Jul","value":528},{"label":"Ago","value":724},{"label":"Set","value":454},{"label":"Out","value":779},{"label":"Nov","value":526},{"label":"Dez","value":550}];
const MX = 779;
