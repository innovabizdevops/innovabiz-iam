...
const ACCENT = "#1e3a5f";
const MODULE = "Data Mesh Deep";
const PAGE = "Self-Serve";
const KPIS = [{"l":"Dashboards Ativos","v":"5.403","t":"+13.0%","d":"up"},{"l":"Queries/Dia","v":"3606","t":"+17.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.652","t":"+11.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.109","t":"+14.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1636","2026-02-21","1.100","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3349","2026-02-08","4.486","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4516","2026-02-22","7.242","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4763","2026-03-21","1.833","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3650","2026-02-26","1.816","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":700},{"label":"Mar","value":934},{"label":"Abr","value":938},{"label":"Mai","value":876},{"label":"Jun","value":932},{"label":"Jul","value":602},{"label":"Ago","value":798},{"label":"Set","value":560},{"label":"Out","value":794},{"label":"Nov","value":851},{"label":"Dez","value":779}];
const MX = 938;
