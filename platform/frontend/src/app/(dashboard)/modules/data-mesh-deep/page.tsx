...
/* ═══ Data Mesh Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8796", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "820", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1963079696", cells: ["DAT-9696", "Data Mesh Deep Item 1", "5/9/2026", "€29 796"], status: "active" as const },
    { id: "1963083267", cells: ["DAT-4267", "Data Mesh Deep Item 2", "20/4/2026", "€33 367"], status: "pending" as const },
    { id: "1963086838", cells: ["DAT-7838", "Data Mesh Deep Item 3", "7/11/2026", "€36 938"], status: "completed" as const },
    { id: "1963090409", cells: ["DAT-2409", "Data Mesh Deep Item 4", "22/6/2026", "€40 509"], status: "warning" as const },
    { id: "1963093980", cells: ["DAT-5980", "Data Mesh Deep Item 5", "9/1/2026", "€44 080"], status: "active" as const },
];
...
export default function DataMeshDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Mesh Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Mesh Deep</p>
                    </div>
                </div>
