...
const PAGE = "Govern";
const KPIS = [{"l":"Dashboards Ativos","v":"5.527","t":"+1.9%","d":"up"},{"l":"Queries/Dia","v":"1323","t":"+13.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.475","t":"+0.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.179","t":"+0.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4595","2026-03-06","519","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","281","2026-02-18","9.016","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3372","2026-02-03","8.958","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","844","2026-01-21","1.129","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3508","2026-02-23","4.286","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":829},{"label":"Mar","value":643},{"label":"Abr","value":815},{"label":"Mai","value":901},{"label":"Jun","value":665},{"label":"Jul","value":889},{"label":"Ago","value":819},{"label":"Set","value":887},{"label":"Out","value":682},{"label":"Nov","value":721},{"label":"Dez","value":910}];
const MX = 910;
