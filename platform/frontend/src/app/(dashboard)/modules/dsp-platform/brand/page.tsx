...
const PAGE = "Brand Safety";
const KPIS = [{"l":"Formulários Ativos","v":"4.672","t":"-2.9%","d":"down"},{"l":"Submissões/Dia","v":"4914","t":"+6.9%","d":"up"},{"l":"Documentos Gerados","v":"4.479","t":"+10.0%","d":"up"},{"l":"Templates","v":"8.967","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.843","2026-01-11","2.934","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.781","2026-03-10","8.452","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.946","2026-01-05","8.685","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.723","2026-01-10","3.715","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.905","2026-01-03","9.047","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":597},{"label":"Mar","value":341},{"label":"Abr","value":405},{"label":"Mai","value":389},{"label":"Jun","value":555},{"label":"Jul","value":619},{"label":"Ago","value":582},{"label":"Set","value":522},{"label":"Out","value":315},{"label":"Nov","value":249},{"label":"Dez","value":558}];
const MX = 619;
