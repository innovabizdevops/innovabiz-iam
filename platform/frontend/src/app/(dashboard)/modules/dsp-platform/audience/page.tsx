...
const PAGE = "Audience Seg";
const KPIS = [{"l":"Formulários Ativos","v":"155","t":"+17.8%","d":"up"},{"l":"Submissões/Dia","v":"3211","t":"+2.8%","d":"up"},{"l":"Documentos Gerados","v":"3.701","t":"+12.3%","d":"up"},{"l":"Templates","v":"5.606","t":"+10.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.789","2026-03-18","8.391","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.641","2026-03-19","8.231","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.317","2026-03-19","8.229","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.373","2026-03-14","5.747","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.604","2026-02-04","5.513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":702},{"label":"Mar","value":947},{"label":"Abr","value":786},{"label":"Mai","value":751},{"label":"Jun","value":675},{"label":"Jul","value":827},{"label":"Ago","value":976},{"label":"Set","value":951},{"label":"Out","value":970},{"label":"Nov","value":865},{"label":"Dez","value":915}];
const MX = 976;
