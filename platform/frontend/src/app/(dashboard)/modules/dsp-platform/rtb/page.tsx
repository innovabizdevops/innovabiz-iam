...
const PAGE = "RTB Engine";
const KPIS = [{"l":"Formulários Ativos","v":"5.607","t":"-3.5%","d":"down"},{"l":"Submissões/Dia","v":"737","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"5.972","t":"+7.1%","d":"up"},{"l":"Templates","v":"1.067","t":"-0.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.006","2026-01-20","3.472","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.984","2026-03-03","3.513","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","130","2026-03-18","2.162","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.299","2026-01-23","3.343","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.544","2026-03-14","7.282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":584},{"label":"Mar","value":965},{"label":"Abr","value":670},{"label":"Mai","value":602},{"label":"Jun","value":813},{"label":"Jul","value":726},{"label":"Ago","value":768},{"label":"Set","value":853},{"label":"Out","value":657},{"label":"Nov","value":828},{"label":"Dez","value":572}];
const MX = 965;
