...
const ACCENT = "#1e40af";
const MODULE = "DSP Platform";
const PAGE = "Bid Strategy";
const KPIS = [{"l":"Formulários Ativos","v":"2.251","t":"+14.7%","d":"up"},{"l":"Submissões/Dia","v":"4045","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"365","t":"-5.4%","d":"down"},{"l":"Templates","v":"1.665","t":"+11.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.327","2026-01-05","1.887","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.342","2026-01-24","1.043","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.472","2026-03-01","6.407","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.328","2026-01-24","2.873","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.931","2026-02-18","7.356","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":651},{"label":"Mar","value":336},{"label":"Abr","value":366},{"label":"Mai","value":652},{"label":"Jun","value":382},{"label":"Jul","value":541},{"label":"Ago","value":285},{"label":"Set","value":646},{"label":"Out","value":309},{"label":"Nov","value":426},{"label":"Dez","value":422}];
const MX = 652;
