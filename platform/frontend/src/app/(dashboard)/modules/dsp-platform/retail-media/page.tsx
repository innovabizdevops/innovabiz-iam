...
const PAGE = "Retail Media";
const KPIS = [{"l":"Pedidos/Dia","v":"1984","t":"-3.1%","d":"down"},{"l":"GMV (€)","v":"€57871","t":"+0.0%","d":"up"},{"l":"Conversão (%)","v":"71.4%","t":"-1.4%","d":"down"},{"l":"AOV (€)","v":"€82645","t":"+5.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 36333.25","8.818","7.613","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 43857.05","6.519","1.524","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33887.09","287","4.611","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17859.86","8.680","7.515","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 24470.34","1.589","1.956","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":571},{"label":"Mar","value":504},{"label":"Abr","value":458},{"label":"Mai","value":481},{"label":"Jun","value":640},{"label":"Jul","value":624},{"label":"Ago","value":789},{"label":"Set","value":760},{"label":"Out","value":807},{"label":"Nov","value":553},{"label":"Dez","value":805}];
const MX = 807;
