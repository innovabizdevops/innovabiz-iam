...
const PAGE = "CTV Buying";
const KPIS = [{"l":"Formulários Ativos","v":"5.039","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"279","t":"+2.6%","d":"up"},{"l":"Documentos Gerados","v":"6.998","t":"+6.8%","d":"up"},{"l":"Templates","v":"4.256","t":"+6.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.921","2026-03-24","7.748","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.134","2026-03-20","6.239","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.296","2026-02-06","3.206","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.522","2026-02-07","5.090","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.256","2026-02-20","4.833","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":953},{"label":"Mar","value":665},{"label":"Abr","value":605},{"label":"Mai","value":898},{"label":"Jun","value":715},{"label":"Jul","value":785},{"label":"Ago","value":791},{"label":"Set","value":854},{"label":"Out","value":938},{"label":"Nov","value":838},{"label":"Dez","value":950}];
const MX = 953;
