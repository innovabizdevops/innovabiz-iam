...
const PAGE = "Pacing";
const KPIS = [{"l":"Formulários Ativos","v":"5.379","t":"+5.1%","d":"up"},{"l":"Submissões/Dia","v":"3638","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"8.631","t":"+7.5%","d":"up"},{"l":"Templates","v":"2.162","t":"+16.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.357","2026-02-11","1.622","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.320","2026-02-12","727","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.522","2026-01-15","2.831","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.938","2026-03-03","7.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.170","2026-03-13","6.967","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":853},{"label":"Mar","value":762},{"label":"Abr","value":911},{"label":"Mai","value":602},{"label":"Jun","value":679},{"label":"Jul","value":835},{"label":"Ago","value":899},{"label":"Set","value":595},{"label":"Out","value":803},{"label":"Nov","value":854},{"label":"Dez","value":898}];
const MX = 911;
