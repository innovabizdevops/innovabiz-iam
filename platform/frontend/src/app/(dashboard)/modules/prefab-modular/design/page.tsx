...
const ACCENT = "#6366f1";
const MODULE = "Prefab & Modular";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.997","t":"+11.5%","d":"up"},{"l":"Submissões/Dia","v":"650","t":"-4.9%","d":"down"},{"l":"Documentos Gerados","v":"3.226","t":"+5.8%","d":"up"},{"l":"Templates","v":"8.675","t":"-0.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.329","2026-01-24","8.988","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.608","2026-03-15","954","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.502","2026-03-08","3.535","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.488","2026-01-09","8.171","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.806","2026-01-25","7.110","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":1000},{"label":"Mar","value":746},{"label":"Abr","value":911},{"label":"Mai","value":912},{"label":"Jun","value":881},{"label":"Jul","value":819},{"label":"Ago","value":1011},{"label":"Set","value":866},{"label":"Out","value":721},{"label":"Nov","value":822},{"label":"Dez","value":764}];
const MX = 1011;
