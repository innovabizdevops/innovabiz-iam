...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.645","t":"+1.6%","d":"up"},{"l":"NC Abertas","v":"6.102","t":"+11.3%","d":"up"},{"l":"Conformidade (%)","v":"88.5%","t":"+13.1%","d":"up"},{"l":"CAPAs Pendentes","v":"8.349","t":"-5.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","262","70.6%","2.777","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.753","90.4%","8.268","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.803","80.3%","3.764","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.351","88.8%","2.817","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.956","71.1%","7.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":959},{"label":"Mar","value":1013},{"label":"Abr","value":776},{"label":"Mai","value":916},{"label":"Jun","value":970},{"label":"Jul","value":731},{"label":"Ago","value":815},{"label":"Set","value":949},{"label":"Out","value":1006},{"label":"Nov","value":1075},{"label":"Dez","value":1021}];
const MX = 1075;
