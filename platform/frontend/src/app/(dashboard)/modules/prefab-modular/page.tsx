...
export default function PrefabModularPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Prefab Modular</h1><p className="text-sm text-muted-foreground">Prefab Modular • iBOS Enterprise</p></div>
