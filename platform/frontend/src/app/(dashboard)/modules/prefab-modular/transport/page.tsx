...
const KPIS = [{"l":"Atletas Registados","v":"4.889","t":"+16.4%","d":"up"},{"l":"Treinos/Semana","v":"3453","t":"+9.8%","d":"up"},{"l":"Competições","v":"4.702","t":"+15.8%","d":"up"},{"l":"Performance Score","v":"86","t":"+9.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.111","5.797","2.619","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.353","8.004","2.412","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.158","2.744","2.805","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.379","6.365","662","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.298","8.470","7.323","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":664},{"label":"Mar","value":475},{"label":"Abr","value":539},{"label":"Mai","value":667},{"label":"Jun","value":532},{"label":"Jul","value":430},{"label":"Ago","value":342},{"label":"Set","value":441},{"label":"Out","value":483},{"label":"Nov","value":534},{"label":"Dez","value":721}];
const MX = 721;
