...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"4.695","t":"+17.7%","d":"up"},{"l":"Dados/Min (MB)","v":"7.623","t":"-4.7%","d":"down"},{"l":"Alertas Ativos","v":"6.163","t":"+2.8%","d":"up"},{"l":"Uptime (%)","v":"91.8%","t":"+7.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.981","1.744","1.083","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.817","5.843","7.131","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.736","5.665","3.973","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.284","1.184","6.046","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.669","7.702","9.078","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":683},{"label":"Mar","value":887},{"label":"Abr","value":976},{"label":"Mai","value":939},{"label":"Jun","value":858},{"label":"Jul","value":802},{"label":"Ago","value":720},{"label":"Set","value":1033},{"label":"Out","value":663},{"label":"Nov","value":959},{"label":"Dez","value":967}];
const MX = 1033;
