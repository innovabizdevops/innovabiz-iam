...
const ACCENT = "#be185d";
const MODULE = "Beauty Tech Platform";
const PAGE = "Skin Scan";
const KPIS = [{"l":"Total Beauty Tech","v":"8.396","t":"+2.2%","d":"up"},{"l":"Skin Scan Ativos","v":"515","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"89","t":"+0.0%","d":"up"}];
const COLS = ["ID","Skin Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beauty Tech #001","Beauty Tech #002","4.277","6.930","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Beauty Tech #002","Beauty Tech #003","2.696","6.989","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Beauty Tech #003","Beauty Tech #004","6.186","6.879","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Beauty Tech #004","Beauty Tech #005","1.253","4.123","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beauty Tech #005","Beauty Tech #001","4.284","8.456","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":702},{"label":"Mar","value":932},{"label":"Abr","value":736},{"label":"Mai","value":660},{"label":"Jun","value":945},{"label":"Jul","value":660},{"label":"Ago","value":803},{"label":"Set","value":683},{"label":"Out","value":678},{"label":"Nov","value":699},{"label":"Dez","value":778}];
const MX = 945;
