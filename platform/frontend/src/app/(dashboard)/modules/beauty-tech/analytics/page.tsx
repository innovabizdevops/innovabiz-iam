...
const KPIS = [{"l":"Dashboards Ativos","v":"189","t":"+6.8%","d":"up"},{"l":"Queries/Dia","v":"3024","t":"+7.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.821","t":"+10.7%","d":"up"},{"l":"Utilizadores Analytics","v":"1.389","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1083","2026-02-20","599","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4818","2026-01-06","457","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2262","2026-02-03","4.318","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2966","2026-03-11","2.692","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2155","2026-02-27","5.387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":552},{"label":"Mar","value":834},{"label":"Abr","value":686},{"label":"Mai","value":582},{"label":"Jun","value":663},{"label":"Jul","value":637},{"label":"Ago","value":454},{"label":"Set","value":521},{"label":"Out","value":676},{"label":"Nov","value":517},{"label":"Dez","value":807}];
const MX = 834;
