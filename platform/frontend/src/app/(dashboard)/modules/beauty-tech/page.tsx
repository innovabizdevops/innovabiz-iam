...
/* ═══ Beauty Tech Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "2290", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2915", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€444K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "47284590", cells: ["BEA-8590", "Beauty Tech Platform Item 1", "11/7/2026", "€34 690"], status: "active" as const },
    { id: "47288161", cells: ["BEA-3161", "Beauty Tech Platform Item 2", "26/2/2026", "€38 261"], status: "pending" as const },
    { id: "47291732", cells: ["BEA-6732", "Beauty Tech Platform Item 3", "13/9/2026", "€41 832"], status: "completed" as const },
    { id: "47295303", cells: ["BEA-1303", "Beauty Tech Platform Item 4", "28/4/2026", "€45 403"], status: "warning" as const },
    { id: "47298874", cells: ["BEA-4874", "Beauty Tech Platform Item 5", "15/11/2026", "€48 974"], status: "active" as const },
];
...
export default function BeautyTechPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Beauty Tech Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Beauty Tech Platform</p>
                    </div>
                </div>
