...
const ACCENT = "#9d174d";
const MODULE = "Disability Employment";
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"1.657","t":"-2.2%","d":"down"},{"l":"Treinos/Semana","v":"3733","t":"-0.4%","d":"down"},{"l":"Competições","v":"2.791","t":"+2.9%","d":"up"},{"l":"Performance Score","v":"79","t":"+9.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.837","7.450","1.627","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.402","4.354","4.910","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","482","5.674","579","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.988","3.516","2.217","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.987","3.478","2.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":941},{"label":"Mar","value":963},{"label":"Abr","value":708},{"label":"Mai","value":976},{"label":"Jun","value":813},{"label":"Jul","value":876},{"label":"Ago","value":762},{"label":"Set","value":791},{"label":"Out","value":896},{"label":"Nov","value":663},{"label":"Dez","value":874}];
const MX = 976;
