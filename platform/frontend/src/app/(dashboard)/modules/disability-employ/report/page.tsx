...
const PAGE = "Report";
const KPIS = [{"l":"Total Disability Employ","v":"7.856","t":"+6.0%","d":"up"},{"l":"Report Ativos","v":"2.672","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"69","t":"+13.9%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Employ #001","Disability Employ #002","8.457","5.283","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Employ #002","Disability Employ #003","2.957","3.333","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Employ #003","Disability Employ #004","364","7.062","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Employ #004","Disability Employ #005","2.998","2.895","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Employ #005","Disability Employ #001","7.423","7.205","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":402},{"label":"Mar","value":585},{"label":"Abr","value":640},{"label":"Mai","value":568},{"label":"Jun","value":459},{"label":"Jul","value":464},{"label":"Ago","value":638},{"label":"Set","value":550},{"label":"Out","value":463},{"label":"Nov","value":763},{"label":"Dez","value":563}];
const MX = 763;
