...
/* ═══ Disability Employment — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "8250", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3620", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€339K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1020846650", cells: ["DIS-4650", "Disability Employment Item 1", "27/3/2026", "€46 750"], status: "active" as const },
    { id: "1020850221", cells: ["DIS-8221", "Disability Employment Item 2", "14/10/2026", "€321"], status: "pending" as const },
    { id: "1020853792", cells: ["DIS-2792", "Disability Employment Item 3", "1/5/2026", "€3892"], status: "completed" as const },
    { id: "1020857363", cells: ["DIS-6363", "Disability Employment Item 4", "16/12/2026", "€7463"], status: "warning" as const },
    { id: "1020860934", cells: ["DIS-9934", "Disability Employment Item 5", "3/7/2026", "€11 034"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Disability Employment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Disability Employment</p>
                    </div>
                </div>
