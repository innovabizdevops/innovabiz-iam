...
const PAGE = "Assess";
const KPIS = [{"l":"Total Disability Employ","v":"5.954","t":"+5.3%","d":"up"},{"l":"Assess Ativos","v":"3.644","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"83.5%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"57","t":"+16.7%","d":"up"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Employ #001","Disability Employ #002","453","8.701","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Employ #002","Disability Employ #003","1.337","7.718","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Employ #003","Disability Employ #004","4.154","6.525","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Employ #004","Disability Employ #005","3.468","4.956","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Employ #005","Disability Employ #001","935","4.296","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":320},{"label":"Mar","value":460},{"label":"Abr","value":366},{"label":"Mai","value":508},{"label":"Jun","value":246},{"label":"Jul","value":226},{"label":"Ago","value":439},{"label":"Set","value":415},{"label":"Out","value":292},{"label":"Nov","value":459},{"label":"Dez","value":322}];
const MX = 508;
