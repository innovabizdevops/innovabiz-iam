...
const PAGE = "Employer";
const KPIS = [{"l":"Total Disability Employ","v":"322","t":"+15.6%","d":"up"},{"l":"Employer Ativos","v":"101","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"73","t":"+4.7%","d":"up"}];
const COLS = ["ID","Employer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Disability Employ #001","Disability Employ #002","7.380","2.824","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Disability Employ #002","Disability Employ #003","5.547","2.394","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Disability Employ #003","Disability Employ #004","1.920","8.939","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Disability Employ #004","Disability Employ #005","9.043","6.724","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Disability Employ #005","Disability Employ #001","3.807","4.555","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":792},{"label":"Mar","value":771},{"label":"Abr","value":885},{"label":"Mai","value":930},{"label":"Jun","value":690},{"label":"Jul","value":824},{"label":"Ago","value":807},{"label":"Set","value":570},{"label":"Out","value":717},{"label":"Nov","value":656},{"label":"Dez","value":657}];
const MX = 930;
