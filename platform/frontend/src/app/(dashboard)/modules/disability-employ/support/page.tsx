...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"8.986","t":"-5.8%","d":"down"},{"l":"SLA Cumprido (%)","v":"68.0%","t":"+0.9%","d":"up"},{"l":"MTTR (h)","v":"50h","t":"+2.5%","d":"up"},{"l":"Satisfação (%)","v":"67.5%","t":"-5.5%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.473","2.578","5.645","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.859","5.529","2.000","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.666","7.129","5.761","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.898","3.973","3.412","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.082","5.322","6.393","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":716},{"label":"Mar","value":683},{"label":"Abr","value":659},{"label":"Mai","value":692},{"label":"Jun","value":913},{"label":"Jul","value":967},{"label":"Ago","value":786},{"label":"Set","value":838},{"label":"Out","value":916},{"label":"Nov","value":780},{"label":"Dez","value":966}];
const MX = 967;
