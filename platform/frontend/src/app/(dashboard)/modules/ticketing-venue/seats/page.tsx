...
const PAGE = "Seat Map";
const KPIS = [{"l":"Tickets Abertos","v":"2.779","t":"+7.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.5%","t":"-3.0%","d":"down"},{"l":"MTTR (h)","v":"118h","t":"+8.3%","d":"up"},{"l":"Satisfação (%)","v":"85.6%","t":"+8.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.872","338","7.718","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.312","8.967","3.903","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","518","7.356","298","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.442","7.971","7.996","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","703","5.125","2.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":1001},{"label":"Mar","value":1017},{"label":"Abr","value":854},{"label":"Mai","value":785},{"label":"Jun","value":905},{"label":"Jul","value":983},{"label":"Ago","value":712},{"label":"Set","value":997},{"label":"Out","value":887},{"label":"Nov","value":799},{"label":"Dez","value":748}];
const MX = 1017;
