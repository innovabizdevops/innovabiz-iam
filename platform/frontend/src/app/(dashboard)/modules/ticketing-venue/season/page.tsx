...
const PAGE = "Season Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"3.666","t":"+14.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.6%","t":"+9.3%","d":"up"},{"l":"MTTR (h)","v":"163h","t":"+17.0%","d":"up"},{"l":"Satisfação (%)","v":"74.6%","t":"-0.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.493","221","2.338","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","318","2.784","7.392","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.069","4.679","7.153","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.303","6.201","2.421","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.114","2.917","1.059","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":555},{"label":"Mar","value":822},{"label":"Abr","value":776},{"label":"Mai","value":680},{"label":"Jun","value":810},{"label":"Jul","value":535},{"label":"Ago","value":507},{"label":"Set","value":515},{"label":"Out","value":492},{"label":"Nov","value":752},{"label":"Dez","value":690}];
const MX = 822;
