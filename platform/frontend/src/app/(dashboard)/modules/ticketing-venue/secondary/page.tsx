...
const PAGE = "Secondary Mkt";
const KPIS = [{"l":"Tickets Abertos","v":"5.315","t":"-3.8%","d":"down"},{"l":"SLA Cumprido (%)","v":"91.9%","t":"+2.5%","d":"up"},{"l":"MTTR (h)","v":"117h","t":"+13.2%","d":"up"},{"l":"Satisfação (%)","v":"85.3%","t":"-1.1%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.134","4.468","6.924","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.834","4.958","5.344","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.615","2.421","4.932","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","902","6.821","4.917","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.572","1.212","1.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":618},{"label":"Mar","value":491},{"label":"Abr","value":328},{"label":"Mai","value":417},{"label":"Jun","value":495},{"label":"Jul","value":488},{"label":"Ago","value":352},{"label":"Set","value":436},{"label":"Out","value":669},{"label":"Nov","value":345},{"label":"Dez","value":494}];
const MX = 684;
