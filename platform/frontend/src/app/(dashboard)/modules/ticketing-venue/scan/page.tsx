...
const PAGE = "Scan Entry";
const KPIS = [{"l":"Tickets Abertos","v":"3.905","t":"+13.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.4%","t":"+1.9%","d":"up"},{"l":"MTTR (h)","v":"15h","t":"+15.0%","d":"up"},{"l":"Satisfação (%)","v":"73.7%","t":"+12.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.166","6.317","754","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.644","9.065","2.646","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.716","8.944","7.198","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","181","2.267","2.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","247","1.225","6.196","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":457},{"label":"Mar","value":590},{"label":"Abr","value":377},{"label":"Mai","value":497},{"label":"Jun","value":563},{"label":"Jul","value":597},{"label":"Ago","value":443},{"label":"Set","value":591},{"label":"Out","value":513},{"label":"Nov","value":487},{"label":"Dez","value":431}];
const MX = 597;
