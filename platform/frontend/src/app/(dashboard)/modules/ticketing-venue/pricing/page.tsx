...
const ACCENT = "#7c2d12";
const MODULE = "Venue Ticketing";
const PAGE = "Dynamic Price";
const KPIS = [{"l":"Tickets Abertos","v":"5.993","t":"+11.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.8%","t":"+7.5%","d":"up"},{"l":"MTTR (h)","v":"73h","t":"+1.0%","d":"up"},{"l":"Satisfação (%)","v":"92.8%","t":"+7.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.741","7.632","4.097","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.315","2.123","1.412","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.113","7.457","2.929","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.010","6.637","3.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.233","5.976","8.618","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":434},{"label":"Mar","value":674},{"label":"Abr","value":717},{"label":"Mai","value":409},{"label":"Jun","value":555},{"label":"Jul","value":484},{"label":"Ago","value":510},{"label":"Set","value":471},{"label":"Out","value":603},{"label":"Nov","value":416},{"label":"Dez","value":746}];
const MX = 746;
