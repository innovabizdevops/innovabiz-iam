...
export default function TicketingVenuePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ticketing Venue</h1><p className="text-sm text-muted-foreground">Ticketing Venue • iBOS Enterprise</p></div>
