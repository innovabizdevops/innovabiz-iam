...
const PAGE = "Source";
const KPIS = [{"l":"Utilizadores Ativos","v":"903","t":"-0.9%","d":"down"},{"l":"Sessões/Dia","v":"1604","t":"+6.1%","d":"up"},{"l":"MFA Adoção (%)","v":"66.6%","t":"+10.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.908","t":"+1.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","4.118","8.650","4.963","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.470","5.930","6.890","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.103","8.425","2.365","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.527","8.199","7.941","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.721","5.181","193","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":359},{"label":"Fev","value":618},{"label":"Mar","value":512},{"label":"Abr","value":449},{"label":"Mai","value":363},{"label":"Jun","value":398},{"label":"Jul","value":487},{"label":"Ago","value":372},{"label":"Set","value":383},{"label":"Out","value":500},{"label":"Nov","value":322},{"label":"Dez","value":659}];
const MX = 659;
