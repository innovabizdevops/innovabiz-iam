...
const KPIS = [{"l":"Utilizadores Ativos","v":"3.410","t":"-1.8%","d":"down"},{"l":"Sessões/Dia","v":"1346","t":"+13.2%","d":"up"},{"l":"MFA Adoção (%)","v":"71.8%","t":"+14.4%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.900","t":"+9.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.680","6.678","4.580","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.918","8.692","4.287","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","894","4.751","6.788","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.988","8.992","6.582","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.421","509","7.746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":705},{"label":"Mar","value":692},{"label":"Abr","value":378},{"label":"Mai","value":534},{"label":"Jun","value":406},{"label":"Jul","value":687},{"label":"Ago","value":375},{"label":"Set","value":486},{"label":"Out","value":628},{"label":"Nov","value":661},{"label":"Dez","value":608}];
const MX = 705;
