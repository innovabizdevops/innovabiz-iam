...
const ACCENT = "#b45309";
const MODULE = "Diamond Trading";
const PAGE = "Kimberley";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.727","t":"-2.2%","d":"down"},{"l":"Sessões/Dia","v":"3940","t":"+13.7%","d":"up"},{"l":"MFA Adoção (%)","v":"75.3%","t":"+12.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"363","t":"+2.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.064","305","799","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.552","4.153","5.382","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.683","4.225","8.762","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.438","2.513","5.282","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.404","7.736","2.654","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":325},{"label":"Fev","value":533},{"label":"Mar","value":716},{"label":"Abr","value":644},{"label":"Mai","value":516},{"label":"Jun","value":506},{"label":"Jul","value":531},{"label":"Ago","value":691},{"label":"Set","value":434},{"label":"Out","value":371},{"label":"Nov","value":419},{"label":"Dez","value":485}];
const MX = 716;
