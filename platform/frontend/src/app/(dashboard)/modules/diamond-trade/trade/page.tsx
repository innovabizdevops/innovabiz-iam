...
const PAGE = "Trade";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.283","t":"+14.9%","d":"up"},{"l":"Sessões/Dia","v":"2799","t":"+17.2%","d":"up"},{"l":"MFA Adoção (%)","v":"87.9%","t":"+3.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"888","t":"+4.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.065","8.620","5.283","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.852","4.607","2.344","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.985","5.528","1.948","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.384","7.048","1.968","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.899","5.094","8.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":603},{"label":"Mar","value":487},{"label":"Abr","value":459},{"label":"Mai","value":687},{"label":"Jun","value":743},{"label":"Jul","value":475},{"label":"Ago","value":581},{"label":"Set","value":475},{"label":"Out","value":466},{"label":"Nov","value":675},{"label":"Dez","value":424}];
const MX = 743;
