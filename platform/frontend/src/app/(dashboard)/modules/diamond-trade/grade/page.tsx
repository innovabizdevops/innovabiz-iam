...
const PAGE = "Grade";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.816","t":"+7.8%","d":"up"},{"l":"Sessões/Dia","v":"1701","t":"+9.3%","d":"up"},{"l":"MFA Adoção (%)","v":"66.1%","t":"+6.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.179","t":"+7.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.919","2.640","5.593","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.849","8.474","6.457","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.939","1.699","3.350","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.826","1.338","2.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.125","8.224","6.410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":731},{"label":"Mar","value":869},{"label":"Abr","value":589},{"label":"Mai","value":492},{"label":"Jun","value":720},{"label":"Jul","value":732},{"label":"Ago","value":622},{"label":"Set","value":528},{"label":"Out","value":628},{"label":"Nov","value":580},{"label":"Dez","value":801}];
const MX = 869;
