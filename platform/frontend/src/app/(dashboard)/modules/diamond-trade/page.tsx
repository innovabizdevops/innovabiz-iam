...
/* ═══ Diamond Trading — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "5546", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "704", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€383K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "268473646", cells: ["DIA-4646", "Diamond Trading Item 1", "15/11/2026", "€23 746"], status: "active" as const },
    { id: "268477217", cells: ["DIA-8217", "Diamond Trading Item 2", "2/6/2026", "€27 317"], status: "pending" as const },
    { id: "268480788", cells: ["DIA-2788", "Diamond Trading Item 3", "17/1/2026", "€30 888"], status: "completed" as const },
    { id: "268484359", cells: ["DIA-6359", "Diamond Trading Item 4", "4/8/2026", "€34 459"], status: "warning" as const },
    { id: "268487930", cells: ["DIA-9930", "Diamond Trading Item 5", "19/3/2026", "€38 030"], status: "active" as const },
];
...
export default function DiamondTradingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Diamond Trading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Diamond Trading</p>
                    </div>
                </div>
