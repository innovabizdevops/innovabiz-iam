...
const PAGE = "Bid Process";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.465","t":"+9.6%","d":"up"},{"l":"Contratos (€M)","v":"€31.1M","t":"+17.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"85.8%","t":"+11.1%","d":"up"},{"l":"Score Médio","v":"82","t":"-0.4%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","78.4%","€ 9094.79","2.662","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","88.4%","€ 1266.11","8.315","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","84.9%","€ 19467.53","1.880","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","96.4%","€ 25106.45","4.239","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","99.1%","€ 9411.36","6.911","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":689},{"label":"Mar","value":713},{"label":"Abr","value":708},{"label":"Mai","value":638},{"label":"Jun","value":514},{"label":"Jul","value":616},{"label":"Ago","value":782},{"label":"Set","value":490},{"label":"Out","value":695},{"label":"Nov","value":598},{"label":"Dez","value":540}];
const MX = 782;
