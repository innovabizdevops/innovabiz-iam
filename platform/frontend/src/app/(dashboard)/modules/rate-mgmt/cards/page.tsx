...
const PAGE = "Rate Cards";
const KPIS = [{"l":"Total Rate Mgmt","v":"5.011","t":"+10.1%","d":"up"},{"l":"Rate Cards Ativos","v":"7.360","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"90","t":"+13.5%","d":"up"}];
const COLS = ["ID","Rate Cards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rate Mgmt #001","Rate Mgmt #002","7.817","852","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Rate Mgmt #002","Rate Mgmt #003","5.401","3.179","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Rate Mgmt #003","Rate Mgmt #004","622","4.041","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Rate Mgmt #004","Rate Mgmt #005","5.861","8.460","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rate Mgmt #005","Rate Mgmt #001","8.963","5.892","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":796},{"label":"Mar","value":574},{"label":"Abr","value":816},{"label":"Mai","value":676},{"label":"Jun","value":964},{"label":"Jul","value":844},{"label":"Ago","value":712},{"label":"Set","value":927},{"label":"Out","value":658},{"label":"Nov","value":885},{"label":"Dez","value":893}];
const MX = 964;
