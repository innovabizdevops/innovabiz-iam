...
const PAGE = "Contract Rates";
const KPIS = [{"l":"Contratos Ativos","v":"1.022","t":"+14.3%","d":"up"},{"l":"Valor Total (€M)","v":"€32.9M","t":"+0.0%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.396","t":"-4.9%","d":"down"},{"l":"Obrigações Pendentes","v":"5.576","t":"+9.5%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 9635.80","2026-01-24","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 22826.24","2026-03-21","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 17932.62","2026-03-15","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 13357.52","2026-03-01","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 16996.88","2026-02-09","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":345},{"label":"Mar","value":667},{"label":"Abr","value":610},{"label":"Mai","value":501},{"label":"Jun","value":490},{"label":"Jul","value":472},{"label":"Ago","value":384},{"label":"Set","value":617},{"label":"Out","value":396},{"label":"Nov","value":588},{"label":"Dez","value":469}];
const MX = 667;
