...
const KPIS = [{"l":"Total Rate Mgmt","v":"4.429","t":"+6.6%","d":"up"},{"l":"Benchmark Ativos","v":"2.604","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"63","t":"+15.9%","d":"up"}];
const COLS = ["ID","Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rate Mgmt #001","Rate Mgmt #002","8.987","1.864","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Rate Mgmt #002","Rate Mgmt #003","3.433","3.960","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Rate Mgmt #003","Rate Mgmt #004","1.259","5.636","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Rate Mgmt #004","Rate Mgmt #005","241","3.084","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rate Mgmt #005","Rate Mgmt #001","8.063","4.797","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":647},{"label":"Mar","value":733},{"label":"Abr","value":769},{"label":"Mai","value":703},{"label":"Jun","value":687},{"label":"Jul","value":668},{"label":"Ago","value":763},{"label":"Set","value":664},{"label":"Out","value":445},{"label":"Nov","value":706},{"label":"Dez","value":684}];
const MX = 769;
