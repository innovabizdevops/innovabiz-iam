...
const ACCENT = "#0e7490";
const MODULE = "Rate Management";
const PAGE = "Accessorial";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.104","t":"+14.2%","d":"up"},{"l":"Sessões/Dia","v":"163","t":"+0.3%","d":"up"},{"l":"MFA Adoção (%)","v":"89.2%","t":"+14.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.883","t":"-2.4%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.971","7.544","2.983","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.148","4.143","4.050","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.728","2.214","3.340","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.675","5.596","1.121","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.669","3.466","5.589","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":522},{"label":"Mar","value":357},{"label":"Abr","value":433},{"label":"Mai","value":350},{"label":"Jun","value":479},{"label":"Jul","value":632},{"label":"Ago","value":360},{"label":"Set","value":389},{"label":"Out","value":657},{"label":"Nov","value":553},{"label":"Dez","value":512}];
const MX = 657;
...
export default function AccessorialPage() {
    return (
