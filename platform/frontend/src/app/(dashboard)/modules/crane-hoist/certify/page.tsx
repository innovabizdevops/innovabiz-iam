...
const PAGE = "Certify";
const KPIS = [{"l":"Total Crane Hoist","v":"5.699","t":"-5.2%","d":"down"},{"l":"Certify Ativos","v":"3.210","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"72","t":"+16.1%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crane Hoist #001","Crane Hoist #002","4.185","2.508","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Crane Hoist #002","Crane Hoist #003","6.904","7.267","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Crane Hoist #003","Crane Hoist #004","4.052","4.054","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Crane Hoist #004","Crane Hoist #005","6.825","4.960","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crane Hoist #005","Crane Hoist #001","3.541","4.170","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":425},{"label":"Mar","value":588},{"label":"Abr","value":398},{"label":"Mai","value":550},{"label":"Jun","value":685},{"label":"Jul","value":654},{"label":"Ago","value":340},{"label":"Set","value":565},{"label":"Out","value":443},{"label":"Nov","value":382},{"label":"Dez","value":656}];
const MX = 685;
