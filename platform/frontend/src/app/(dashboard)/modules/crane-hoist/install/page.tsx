...
const PAGE = "Install";
const KPIS = [{"l":"Total Crane Hoist","v":"7.723","t":"-0.4%","d":"down"},{"l":"Install Ativos","v":"3.115","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"85","t":"-4.4%","d":"down"}];
const COLS = ["ID","Install","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crane Hoist #001","Crane Hoist #002","4.841","7.627","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Crane Hoist #002","Crane Hoist #003","2.574","6.065","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Crane Hoist #003","Crane Hoist #004","5.748","8.225","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Crane Hoist #004","Crane Hoist #005","2.506","8.940","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crane Hoist #005","Crane Hoist #001","7.658","3.169","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":601},{"label":"Mar","value":629},{"label":"Abr","value":871},{"label":"Mai","value":606},{"label":"Jun","value":726},{"label":"Jul","value":721},{"label":"Ago","value":961},{"label":"Set","value":609},{"label":"Out","value":870},{"label":"Nov","value":764},{"label":"Dez","value":983}];
const MX = 983;
