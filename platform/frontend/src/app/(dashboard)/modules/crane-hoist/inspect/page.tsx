...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Crane Hoist","v":"2.401","t":"+4.0%","d":"up"},{"l":"Inspect Ativos","v":"4.962","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"87.6%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.5%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crane Hoist #001","Crane Hoist #002","4.037","877","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Crane Hoist #002","Crane Hoist #003","7.803","3.492","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Crane Hoist #003","Crane Hoist #004","8.336","529","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Crane Hoist #004","Crane Hoist #005","882","5.860","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crane Hoist #005","Crane Hoist #001","6.622","6.311","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":365},{"label":"Mar","value":682},{"label":"Abr","value":717},{"label":"Mai","value":434},{"label":"Jun","value":637},{"label":"Jul","value":607},{"label":"Ago","value":331},{"label":"Set","value":683},{"label":"Out","value":436},{"label":"Nov","value":532},{"label":"Dez","value":490}];
const MX = 717;
