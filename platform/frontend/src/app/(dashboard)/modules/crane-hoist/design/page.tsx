...
const ACCENT = "#dc2626";
const MODULE = "Crane & Hoist";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"9.087","t":"+11.9%","d":"up"},{"l":"Submissões/Dia","v":"1270","t":"-5.1%","d":"down"},{"l":"Documentos Gerados","v":"7.003","t":"+12.1%","d":"up"},{"l":"Templates","v":"9.012","t":"+8.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.494","2026-01-11","3.000","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","691","2026-01-09","6.071","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.672","2026-03-05","1.430","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.539","2026-02-22","3.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.082","2026-03-22","7.823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":449},{"label":"Mar","value":773},{"label":"Abr","value":751},{"label":"Mai","value":684},{"label":"Jun","value":806},{"label":"Jul","value":701},{"label":"Ago","value":628},{"label":"Set","value":801},{"label":"Out","value":464},{"label":"Nov","value":593},{"label":"Dez","value":599}];
const MX = 806;
