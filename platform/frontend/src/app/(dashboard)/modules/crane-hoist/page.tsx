...
/* ═══ Crane & Hoist — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "2254", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4263", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€186K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1031710854", cells: ["CRA-5854", "Crane & Hoist Item 1", "7/7/2026", "€10 954"], status: "active" as const },
    { id: "1031714425", cells: ["CRA-9425", "Crane & Hoist Item 2", "22/2/2026", "€14 525"], status: "pending" as const },
    { id: "1031717996", cells: ["CRA-3996", "Crane & Hoist Item 3", "9/9/2026", "€18 096"], status: "completed" as const },
    { id: "1031721567", cells: ["CRA-7567", "Crane & Hoist Item 4", "24/4/2026", "€21 667"], status: "warning" as const },
    { id: "1031725138", cells: ["CRA-2138", "Crane & Hoist Item 5", "11/11/2026", "€25 238"], status: "active" as const },
];
...
export default function CraneHoistPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crane & Hoist</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Crane & Hoist</p>
                    </div>
                </div>
