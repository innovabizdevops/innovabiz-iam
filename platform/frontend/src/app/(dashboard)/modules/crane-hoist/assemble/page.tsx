...
const PAGE = "Assemble";
const KPIS = [{"l":"Total Crane Hoist","v":"6.824","t":"-5.1%","d":"down"},{"l":"Assemble Ativos","v":"4.882","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"65.8%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"69","t":"+5.3%","d":"up"}];
const COLS = ["ID","Assemble","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crane Hoist #001","Crane Hoist #002","1.826","9.031","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Crane Hoist #002","Crane Hoist #003","2.604","6.362","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Crane Hoist #003","Crane Hoist #004","2.061","5.058","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Crane Hoist #004","Crane Hoist #005","8.108","3.496","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crane Hoist #005","Crane Hoist #001","807","7.524","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":586},{"label":"Mar","value":649},{"label":"Abr","value":784},{"label":"Mai","value":759},{"label":"Jun","value":824},{"label":"Jul","value":799},{"label":"Ago","value":554},{"label":"Set","value":491},{"label":"Out","value":659},{"label":"Nov","value":660},{"label":"Dez","value":537}];
const MX = 824;
