...
const KPIS = [{"l":"Formulários Ativos","v":"2.640","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"4761","t":"+6.6%","d":"up"},{"l":"Documentos Gerados","v":"3.749","t":"+0.1%","d":"up"},{"l":"Templates","v":"7.284","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.490","2026-02-28","6.562","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.294","2026-03-21","2.905","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.396","2026-03-03","8.013","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.609","2026-02-03","5.069","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.450","2026-01-10","6.159","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":536},{"label":"Mar","value":374},{"label":"Abr","value":595},{"label":"Mai","value":604},{"label":"Jun","value":416},{"label":"Jul","value":503},{"label":"Ago","value":595},{"label":"Set","value":244},{"label":"Out","value":362},{"label":"Nov","value":451},{"label":"Dez","value":387}];
const MX = 604;
