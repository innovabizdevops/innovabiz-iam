...
const KPIS = [{"l":"Projetos Sociais","v":"1.146","t":"-2.8%","d":"down"},{"l":"Beneficiários","v":"7.740","t":"+5.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€15661","t":"+9.8%","d":"up"},{"l":"Score Impacto","v":"84","t":"+0.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.640","€ 25603.92","1.376","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","4.326","€ 24977.29","2.864","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.707","€ 22902.14","7.746","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.884","€ 39027.92","8.484","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.412","€ 40465.02","4.385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":735},{"label":"Mar","value":566},{"label":"Abr","value":880},{"label":"Mai","value":919},{"label":"Jun","value":696},{"label":"Jul","value":607},{"label":"Ago","value":590},{"label":"Set","value":609},{"label":"Out","value":811},{"label":"Nov","value":923},{"label":"Dez","value":545}];
const MX = 923;
