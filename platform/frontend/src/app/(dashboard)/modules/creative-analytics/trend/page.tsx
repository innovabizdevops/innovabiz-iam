...
const PAGE = "Trend";
const KPIS = [{"l":"Dashboards Ativos","v":"8.373","t":"-4.7%","d":"down"},{"l":"Queries/Dia","v":"2173","t":"+3.5%","d":"up"},{"l":"Dados Processados (GB)","v":"336","t":"+0.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.270","t":"+13.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3091","2026-02-19","1.901","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2450","2026-01-22","8.496","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3589","2026-03-27","5.661","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3717","2026-02-08","1.838","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","285","2026-03-25","8.298","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":609},{"label":"Mar","value":544},{"label":"Abr","value":367},{"label":"Mai","value":433},{"label":"Jun","value":439},{"label":"Jul","value":593},{"label":"Ago","value":454},{"label":"Set","value":500},{"label":"Out","value":418},{"label":"Nov","value":663},{"label":"Dez","value":526}];
const MX = 663;
