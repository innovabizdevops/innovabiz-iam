...
const ACCENT = "#4c1d95";
const MODULE = "Creative Industries Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"5.396","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"3913","t":"+13.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.786","t":"+2.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.126","t":"+4.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","851","2026-03-23","6.573","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1614","2026-02-24","187","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3955","2026-02-07","593","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","531","2026-03-21","3.306","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","576","2026-02-27","5.193","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":616},{"label":"Mar","value":577},{"label":"Abr","value":703},{"label":"Mai","value":468},{"label":"Jun","value":678},{"label":"Jul","value":555},{"label":"Ago","value":432},{"label":"Set","value":423},{"label":"Out","value":734},{"label":"Nov","value":663},{"label":"Dez","value":436}];
const MX = 734;
