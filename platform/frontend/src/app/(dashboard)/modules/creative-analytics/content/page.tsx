...
const PAGE = "Content";
const KPIS = [{"l":"Dashboards Ativos","v":"4.933","t":"+13.0%","d":"up"},{"l":"Queries/Dia","v":"4892","t":"+10.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.471","t":"+0.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.000","t":"-3.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4586","2026-02-17","5.854","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3225","2026-02-05","7.907","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","956","2026-01-12","6.984","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2565","2026-02-13","1.078","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4359","2026-01-24","2.253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":789},{"label":"Mar","value":881},{"label":"Abr","value":611},{"label":"Mai","value":665},{"label":"Jun","value":661},{"label":"Jul","value":845},{"label":"Ago","value":650},{"label":"Set","value":729},{"label":"Out","value":690},{"label":"Nov","value":727},{"label":"Dez","value":897}];
const MX = 897;
