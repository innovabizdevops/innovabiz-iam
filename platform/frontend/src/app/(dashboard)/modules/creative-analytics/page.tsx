...
/* ═══ Creative Industries Analytics — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "8877", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3064", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€191K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1847408177", cells: ["CRE-6177", "Creative Industries Analytics Item 1", "14/6/2026", "€8277"], status: "active" as const },
    { id: "1847411748", cells: ["CRE-9748", "Creative Industries Analytics Item 2", "1/1/2026", "€11 848"], status: "pending" as const },
    { id: "1847415319", cells: ["CRE-4319", "Creative Industries Analytics Item 3", "16/8/2026", "€15 419"], status: "completed" as const },
    { id: "1847418890", cells: ["CRE-7890", "Creative Industries Analytics Item 4", "3/3/2026", "€18 990"], status: "warning" as const },
    { id: "1847422461", cells: ["CRE-2461", "Creative Industries Analytics Item 5", "18/10/2026", "€22 561"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 37 }, { label: "Fev", value: 46 }, { label: "Mar", value: 55 }, { label: "Abr", value: 64 }, { label: "Mai", value: 73 }, { label: "Jun", value: 82 }];
...
export default function CreativeIndustriesAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Creative Industries Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Creative Industries Analytics</p>
                    </div>
                </div>
