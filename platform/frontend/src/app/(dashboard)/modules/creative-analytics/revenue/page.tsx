...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€22.1M","t":"-1.2%","d":"down"},{"l":"MRR (€)","v":"€93851","t":"+18.0%","d":"up"},{"l":"Churn (%)","v":"86.6%","t":"+15.1%","d":"up"},{"l":"ARPU (€)","v":"€3331","t":"-0.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 12903.81","2.712","€ 39860.25","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 21262.63","5.286","€ 35665.50","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2861.24","6.757","€ 13464.58","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 48283.35","213","€ 46921.11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 7436.46","6.856","€ 28226.28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":883},{"label":"Mar","value":742},{"label":"Abr","value":583},{"label":"Mai","value":778},{"label":"Jun","value":713},{"label":"Jul","value":797},{"label":"Ago","value":559},{"label":"Set","value":635},{"label":"Out","value":769},{"label":"Nov","value":860},{"label":"Dez","value":605}];
const MX = 936;
