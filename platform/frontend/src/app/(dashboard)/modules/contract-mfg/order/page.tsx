...
const ACCENT = "#6366f1";
const MODULE = "Contract Manufacturing";
const PAGE = "Order";
const KPIS = [{"l":"Contratos Ativos","v":"3.216","t":"-5.0%","d":"down"},{"l":"Valor Total (€M)","v":"€43.1M","t":"-5.0%","d":"down"},{"l":"Renovações Próx. 30d","v":"4.733","t":"+14.0%","d":"up"},{"l":"Obrigações Pendentes","v":"8.768","t":"+16.5%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 32418.42","2026-02-17","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 20249.63","2026-01-27","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 7376.22","2026-01-09","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 14312.72","2026-01-17","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 34497.57","2026-03-21","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":472},{"label":"Mar","value":679},{"label":"Abr","value":758},{"label":"Mai","value":769},{"label":"Jun","value":673},{"label":"Jul","value":726},{"label":"Ago","value":655},{"label":"Set","value":476},{"label":"Out","value":694},{"label":"Nov","value":801},{"label":"Dez","value":800}];
const MX = 801;
