...
const PAGE = "Partner";
const KPIS = [{"l":"Contratos Ativos","v":"4.603","t":"+14.2%","d":"up"},{"l":"Valor Total (€M)","v":"€47.0M","t":"+5.9%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.732","t":"+15.0%","d":"up"},{"l":"Obrigações Pendentes","v":"110","t":"+8.7%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 17231.79","2026-01-22","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 42483.94","2026-01-23","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 43303.31","2026-01-02","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 2092.76","2026-01-16","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 16167.74","2026-03-10","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":782},{"label":"Mar","value":1054},{"label":"Abr","value":695},{"label":"Mai","value":801},{"label":"Jun","value":749},{"label":"Jul","value":906},{"label":"Ago","value":1086},{"label":"Set","value":975},{"label":"Out","value":703},{"label":"Nov","value":849},{"label":"Dez","value":777}];
const MX = 1086;
