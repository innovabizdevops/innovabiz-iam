...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.460","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"7.317","t":"-5.6%","d":"down"},{"l":"Conformidade (%)","v":"89.9%","t":"+1.2%","d":"up"},{"l":"CAPAs Pendentes","v":"319","t":"+11.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.529","87.3%","3.164","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.789","77.6%","1.097","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","696","82.2%","4.798","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.717","97.0%","6.467","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.573","72.1%","716","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":559},{"label":"Mar","value":373},{"label":"Abr","value":643},{"label":"Mai","value":564},{"label":"Jun","value":506},{"label":"Jul","value":512},{"label":"Ago","value":594},{"label":"Set","value":355},{"label":"Out","value":533},{"label":"Nov","value":607},{"label":"Dez","value":612}];
const MX = 643;
