...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.648","t":"-2.3%","d":"down"},{"l":"NC Abertas","v":"5.058","t":"-4.2%","d":"down"},{"l":"Conformidade (%)","v":"71.5%","t":"-4.6%","d":"down"},{"l":"CAPAs Pendentes","v":"5.218","t":"-2.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","171","85.9%","6.914","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.797","79.8%","6.072","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.663","87.6%","3.374","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.808","82.9%","8.339","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.980","95.4%","669","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":669},{"label":"Mar","value":826},{"label":"Abr","value":720},{"label":"Mai","value":878},{"label":"Jun","value":814},{"label":"Jul","value":630},{"label":"Ago","value":731},{"label":"Set","value":816},{"label":"Out","value":568},{"label":"Nov","value":603},{"label":"Dez","value":512}];
const MX = 878;
