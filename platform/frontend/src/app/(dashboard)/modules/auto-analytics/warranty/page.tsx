...
const PAGE = "Warranty";
const KPIS = [{"l":"ARR (€M)","v":"€1.7M","t":"+15.2%","d":"up"},{"l":"MRR (€)","v":"€70597","t":"+17.7%","d":"up"},{"l":"Churn (%)","v":"88.5%","t":"-0.7%","d":"down"},{"l":"ARPU (€)","v":"€42392","t":"+13.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 16545.14","7.486","€ 44863.28","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 26158.09","6.091","€ 27743.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37370.03","4.323","€ 49594.98","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7193.09","660","€ 34978.51","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 788.60","1.474","€ 46439.53","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":788},{"label":"Mar","value":772},{"label":"Abr","value":743},{"label":"Mai","value":610},{"label":"Jun","value":583},{"label":"Jul","value":739},{"label":"Ago","value":966},{"label":"Set","value":719},{"label":"Out","value":915},{"label":"Nov","value":834},{"label":"Dez","value":943}];
const MX = 966;
