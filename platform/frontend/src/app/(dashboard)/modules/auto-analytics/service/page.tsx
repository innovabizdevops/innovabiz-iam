...
const PAGE = "Service";
const KPIS = [{"l":"Dashboards Ativos","v":"1.562","t":"-3.2%","d":"down"},{"l":"Queries/Dia","v":"3085","t":"+9.7%","d":"up"},{"l":"Dados Processados (GB)","v":"2.049","t":"+14.5%","d":"up"},{"l":"Utilizadores Analytics","v":"6.180","t":"+13.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","571","2026-03-11","2.581","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3041","2026-02-17","2.699","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2514","2026-02-25","8.890","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2334","2026-03-16","3.850","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","423","2026-03-24","6.460","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":592},{"label":"Mar","value":568},{"label":"Abr","value":654},{"label":"Mai","value":870},{"label":"Jun","value":808},{"label":"Jul","value":864},{"label":"Ago","value":581},{"label":"Set","value":528},{"label":"Out","value":658},{"label":"Nov","value":738},{"label":"Dez","value":863}];
const MX = 870;
