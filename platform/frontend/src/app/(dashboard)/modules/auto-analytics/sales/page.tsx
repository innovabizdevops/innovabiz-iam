...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€75583","t":"+2.7%","d":"up"},{"l":"Pipeline (€)","v":"€48189","t":"+7.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"92.6%","t":"+7.2%","d":"up"},{"l":"Win Rate (%)","v":"80.9%","t":"+0.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 32525.82","€ 17275.83","€ 41909.75","93.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 47950.71","€ 18931.82","€ 40377.63","95.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 18454.53","€ 42860.48","€ 18933.82","72.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 10750.48","€ 639.44","€ 7686.86","94.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 5367.02","€ 458.87","€ 1931.83","78.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":428},{"label":"Mar","value":489},{"label":"Abr","value":723},{"label":"Mai","value":407},{"label":"Jun","value":386},{"label":"Jul","value":648},{"label":"Ago","value":439},{"label":"Set","value":363},{"label":"Out","value":454},{"label":"Nov","value":722},{"label":"Dez","value":705}];
const MX = 723;
