...
const ACCENT = "#6366f1";
const MODULE = "Automotive Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"8.735","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"4839","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.622","t":"-0.2%","d":"down"},{"l":"Utilizadores Analytics","v":"3.105","t":"+2.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4603","2026-01-25","6.310","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","293","2026-03-11","7.487","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4553","2026-03-13","3.255","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3758","2026-03-23","3.233","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1722","2026-01-21","4.947","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":837},{"label":"Mar","value":744},{"label":"Abr","value":758},{"label":"Mai","value":672},{"label":"Jun","value":774},{"label":"Jul","value":971},{"label":"Ago","value":1051},{"label":"Set","value":679},{"label":"Out","value":934},{"label":"Nov","value":670},{"label":"Dez","value":956}];
const MX = 1051;
