...
/* ═══ Packaging Machinery — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "7249", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "511", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€284K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1662236949", cells: ["PAC-9949", "Packaging Machinery Item 1", "10/10/2026", "€37 049"], status: "active" as const },
    { id: "1662240520", cells: ["PAC-4520", "Packaging Machinery Item 2", "25/5/2026", "€40 620"], status: "pending" as const },
    { id: "1662244091", cells: ["PAC-8091", "Packaging Machinery Item 3", "12/12/2026", "€44 191"], status: "completed" as const },
    { id: "1662247662", cells: ["PAC-2662", "Packaging Machinery Item 4", "27/7/2026", "€47 762"], status: "warning" as const },
    { id: "1662251233", cells: ["PAC-6233", "Packaging Machinery Item 5", "14/2/2026", "€1333"], status: "active" as const },
];
...
export default function PackagingMachineryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Packaging Machinery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Packaging Machinery</p>
                    </div>
                </div>
