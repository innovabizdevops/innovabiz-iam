...
const ACCENT = "#713f12";
const MODULE = "Packaging Machinery";
const PAGE = "Palletize";
const KPIS = [{"l":"Total Packaging Machinery","v":"8.520","t":"+16.1%","d":"up"},{"l":"Palletize Ativos","v":"8.231","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.7%","d":"up"}];
const COLS = ["ID","Palletize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Machinery #001","Packaging Machinery #002","1.379","5.294","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Machinery #002","Packaging Machinery #003","6.519","8.325","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Machinery #003","Packaging Machinery #004","5.828","342","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Machinery #004","Packaging Machinery #005","3.646","7.073","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Machinery #005","Packaging Machinery #001","8.976","2.343","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":695},{"label":"Mar","value":721},{"label":"Abr","value":861},{"label":"Mai","value":693},{"label":"Jun","value":785},{"label":"Jul","value":668},{"label":"Ago","value":664},{"label":"Set","value":687},{"label":"Out","value":858},{"label":"Nov","value":831},{"label":"Dez","value":664}];
const MX = 861;
