...
const PAGE = "Activity";
const KPIS = [{"l":"Teams Ativos","v":"7.459","t":"-5.2%","d":"down"},{"l":"Reuniões/Semana","v":"1722","t":"+10.5%","d":"up"},{"l":"Mensagens/Dia","v":"2022","t":"+2.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.053","t":"-4.6%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.791","3947","2.808","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","588","2450","6.780","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.316","4579","5.886","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.506","681","5.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.370","3179","1.514","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":863},{"label":"Mar","value":698},{"label":"Abr","value":683},{"label":"Mai","value":857},{"label":"Jun","value":718},{"label":"Jul","value":844},{"label":"Ago","value":513},{"label":"Set","value":670},{"label":"Out","value":623},{"label":"Nov","value":637},{"label":"Dez","value":811}];
const MX = 863;
