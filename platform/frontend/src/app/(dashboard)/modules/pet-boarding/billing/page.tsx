...
const PAGE = "Billing";
const KPIS = [{"l":"Teams Ativos","v":"6.922","t":"+11.6%","d":"up"},{"l":"Reuniões/Semana","v":"3119","t":"-3.9%","d":"down"},{"l":"Mensagens/Dia","v":"4998","t":"-5.6%","d":"down"},{"l":"Ficheiros Partilhados","v":"3.974","t":"-3.5%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.342","1183","6.570","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.969","1412","308","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","5.586","2114","4.847","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.045","3009","1.071","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.911","3912","8.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":485},{"label":"Mar","value":587},{"label":"Abr","value":509},{"label":"Mai","value":638},{"label":"Jun","value":583},{"label":"Jul","value":732},{"label":"Ago","value":554},{"label":"Set","value":454},{"label":"Out","value":387},{"label":"Nov","value":562},{"label":"Dez","value":365}];
const MX = 732;
