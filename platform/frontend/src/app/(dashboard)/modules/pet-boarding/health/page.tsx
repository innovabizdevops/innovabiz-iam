...
const PAGE = "Health";
const KPIS = [{"l":"Teams Ativos","v":"1.803","t":"+5.0%","d":"up"},{"l":"Reuniões/Semana","v":"421","t":"+14.6%","d":"up"},{"l":"Mensagens/Dia","v":"383","t":"+8.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.746","t":"+9.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","827","766","4.708","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.047","4331","1.628","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.072","1861","3.140","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.764","3317","1.167","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.124","1721","379","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":674},{"label":"Mar","value":577},{"label":"Abr","value":514},{"label":"Mai","value":764},{"label":"Jun","value":594},{"label":"Jul","value":455},{"label":"Ago","value":424},{"label":"Set","value":601},{"label":"Out","value":725},{"label":"Nov","value":767},{"label":"Dez","value":544}];
const MX = 767;
