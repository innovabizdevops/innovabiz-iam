...
const ACCENT = "#fb923c";
const MODULE = "Pet Boarding";
const PAGE = "Check-In";
const KPIS = [{"l":"Teams Ativos","v":"1.009","t":"-4.3%","d":"down"},{"l":"Reuniões/Semana","v":"4707","t":"-2.1%","d":"down"},{"l":"Mensagens/Dia","v":"3022","t":"+10.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.313","t":"+15.7%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.850","359","5.161","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","6.552","2211","1.077","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.603","3269","1.952","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.023","2447","1.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","770","1600","7.818","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":409},{"label":"Fev","value":593},{"label":"Mar","value":665},{"label":"Abr","value":460},{"label":"Mai","value":710},{"label":"Jun","value":743},{"label":"Jul","value":685},{"label":"Ago","value":612},{"label":"Set","value":542},{"label":"Out","value":687},{"label":"Nov","value":510},{"label":"Dez","value":574}];
const MX = 743;
