...
const ACCENT = "#0e7490";
const MODULE = "Podcast Studio";
const PAGE = "Distribution";
const KPIS = [{"l":"Total Podcast Studio","v":"5.377","t":"+8.3%","d":"up"},{"l":"Distribution Ativos","v":"8.824","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"87","t":"+12.2%","d":"up"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podcast Studio #001","Podcast Studio #002","1.407","6.770","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Podcast Studio #002","Podcast Studio #003","2.678","7.392","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Podcast Studio #003","Podcast Studio #004","3.758","254","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Podcast Studio #004","Podcast Studio #005","4.232","7.670","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podcast Studio #005","Podcast Studio #001","2.672","1.859","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":761},{"label":"Mar","value":530},{"label":"Abr","value":650},{"label":"Mai","value":493},{"label":"Jun","value":578},{"label":"Jul","value":536},{"label":"Ago","value":480},{"label":"Set","value":502},{"label":"Out","value":791},{"label":"Nov","value":565},{"label":"Dez","value":537}];
const MX = 791;
