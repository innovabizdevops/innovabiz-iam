...
const KPIS = [{"l":"Total Podcast Studio","v":"245","t":"-2.1%","d":"down"},{"l":"Recording Ativos","v":"5.164","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"84.6%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"63","t":"+3.8%","d":"up"}];
const COLS = ["ID","Recording","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podcast Studio #001","Podcast Studio #002","237","7.796","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Podcast Studio #002","Podcast Studio #003","6.175","8.494","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Podcast Studio #003","Podcast Studio #004","8.709","2.548","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Podcast Studio #004","Podcast Studio #005","8.716","2.995","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podcast Studio #005","Podcast Studio #001","6.134","2.141","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":848},{"label":"Mar","value":862},{"label":"Abr","value":890},{"label":"Mai","value":1006},{"label":"Jun","value":988},{"label":"Jul","value":711},{"label":"Ago","value":817},{"label":"Set","value":1020},{"label":"Out","value":634},{"label":"Nov","value":1012},{"label":"Dez","value":1001}];
const MX = 1020;
