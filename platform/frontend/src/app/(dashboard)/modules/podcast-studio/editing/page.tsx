...
const PAGE = "Editing Suite";
const KPIS = [{"l":"Integrações Ativas","v":"7.559","t":"+4.8%","d":"up"},{"l":"Chamadas/Hora","v":"3338","t":"-4.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"85.1%","t":"+3.6%","d":"up"},{"l":"Latência Média (ms)","v":"47ms","t":"+7.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.056","5.994","82.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","803","2.887","88.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.444","8.168","96.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.034","5.177","87.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.303","5.440","97.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":435},{"label":"Mar","value":202},{"label":"Abr","value":386},{"label":"Mai","value":377},{"label":"Jun","value":397},{"label":"Jul","value":572},{"label":"Ago","value":359},{"label":"Set","value":429},{"label":"Out","value":394},{"label":"Nov","value":304},{"label":"Dez","value":411}];
const MX = 572;
