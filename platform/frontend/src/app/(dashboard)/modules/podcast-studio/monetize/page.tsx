...
const KPIS = [{"l":"ARR (€M)","v":"€38.4M","t":"+5.5%","d":"up"},{"l":"MRR (€)","v":"€10856","t":"-0.8%","d":"down"},{"l":"Churn (%)","v":"81.0%","t":"+4.0%","d":"up"},{"l":"ARPU (€)","v":"€26411","t":"+5.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 34683.05","4.569","€ 13583.96","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41784.87","4.382","€ 22455.49","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 47785.33","8.526","€ 2075.42","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 47696.01","8.022","€ 6015.99","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 33522.10","7.708","€ 44795.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":920},{"label":"Mar","value":694},{"label":"Abr","value":867},{"label":"Mai","value":733},{"label":"Jun","value":1046},{"label":"Jul","value":909},{"label":"Ago","value":711},{"label":"Set","value":939},{"label":"Out","value":757},{"label":"Nov","value":691},{"label":"Dez","value":693}];
const MX = 1046;
