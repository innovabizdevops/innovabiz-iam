...
const KPIS = [{"l":"Dashboards Ativos","v":"1.035","t":"+13.1%","d":"up"},{"l":"Queries/Dia","v":"1733","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"2.943","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.470","t":"+17.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2789","2026-03-15","6.058","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1085","2026-02-23","1.376","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1500","2026-01-03","7.066","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2077","2026-03-17","5.565","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1534","2026-03-03","1.751","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":638},{"label":"Mar","value":613},{"label":"Abr","value":878},{"label":"Mai","value":718},{"label":"Jun","value":560},{"label":"Jul","value":724},{"label":"Ago","value":866},{"label":"Set","value":865},{"label":"Out","value":543},{"label":"Nov","value":589},{"label":"Dez","value":836}];
const MX = 878;
