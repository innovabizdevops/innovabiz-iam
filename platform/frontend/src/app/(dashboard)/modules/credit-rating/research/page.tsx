...
const PAGE = "Research";
const KPIS = [{"l":"Integrações Ativas","v":"8.139","t":"+12.9%","d":"up"},{"l":"Chamadas/Hora","v":"751","t":"+8.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.8%","t":"-5.0%","d":"down"},{"l":"Latência Média (ms)","v":"57ms","t":"+10.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","347","3.695","71.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.106","8.221","74.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","412","493","71.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.395","4.000","71.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.718","3.823","97.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":522},{"label":"Mar","value":689},{"label":"Abr","value":638},{"label":"Mai","value":753},{"label":"Jun","value":435},{"label":"Jul","value":449},{"label":"Ago","value":780},{"label":"Set","value":458},{"label":"Out","value":516},{"label":"Nov","value":781},{"label":"Dez","value":681}];
const MX = 781;
