...
const KPIS = [{"l":"Integrações Ativas","v":"8.374","t":"+12.1%","d":"up"},{"l":"Chamadas/Hora","v":"5029","t":"+1.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.4%","t":"+16.6%","d":"up"},{"l":"Latência Média (ms)","v":"99ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","940","5.022","96.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.540","2.976","78.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.341","277","90.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.471","6.555","82.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.937","4.093","94.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":608},{"label":"Mar","value":645},{"label":"Abr","value":302},{"label":"Mai","value":458},{"label":"Jun","value":360},{"label":"Jul","value":550},{"label":"Ago","value":516},{"label":"Set","value":607},{"label":"Out","value":488},{"label":"Nov","value":474},{"label":"Dez","value":581}];
const MX = 645;
