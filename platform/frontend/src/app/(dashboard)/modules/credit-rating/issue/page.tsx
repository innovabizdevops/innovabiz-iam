...
const ACCENT = "#1e40af";
const MODULE = "Agência Rating";
const PAGE = "Issue Rating";
const KPIS = [{"l":"Integrações Ativas","v":"6.939","t":"+10.2%","d":"up"},{"l":"Chamadas/Hora","v":"1166","t":"+3.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.2%","t":"+5.2%","d":"up"},{"l":"Latência Média (ms)","v":"97ms","t":"+3.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","315","796","97.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.552","7.018","83.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.267","4.922","84.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.335","1.958","74.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.717","6.259","71.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":536},{"label":"Mar","value":739},{"label":"Abr","value":690},{"label":"Mai","value":537},{"label":"Jun","value":585},{"label":"Jul","value":626},{"label":"Ago","value":555},{"label":"Set","value":879},{"label":"Out","value":866},{"label":"Nov","value":580},{"label":"Dez","value":876}];
const MX = 879;
