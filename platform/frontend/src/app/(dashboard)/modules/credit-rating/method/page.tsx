...
const KPIS = [{"l":"Integrações Ativas","v":"5.044","t":"+6.7%","d":"up"},{"l":"Chamadas/Hora","v":"4655","t":"+15.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.1%","t":"+8.6%","d":"up"},{"l":"Latência Média (ms)","v":"149ms","t":"+12.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","426","7.847","81.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.018","8.780","86.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.720","313","91.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.458","4.668","76.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.274","5.061","77.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":372},{"label":"Mar","value":674},{"label":"Abr","value":516},{"label":"Mai","value":652},{"label":"Jun","value":379},{"label":"Jul","value":663},{"label":"Ago","value":658},{"label":"Set","value":677},{"label":"Out","value":513},{"label":"Nov","value":537},{"label":"Dez","value":458}];
const MX = 677;
