...
/* ═══ Agência Rating — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "5044", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2307", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€172K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1296528744", cells: ["CRE-7744", "Agência Rating Item 1", "1/1/2026", "€28 844"], status: "active" as const },
    { id: "1296532315", cells: ["CRE-2315", "Agência Rating Item 2", "16/8/2026", "€32 415"], status: "pending" as const },
    { id: "1296535886", cells: ["CRE-5886", "Agência Rating Item 3", "3/3/2026", "€35 986"], status: "completed" as const },
    { id: "1296539457", cells: ["CRE-9457", "Agência Rating Item 4", "18/10/2026", "€39 557"], status: "warning" as const },
    { id: "1296543028", cells: ["CRE-4028", "Agência Rating Item 5", "5/5/2026", "€43 128"], status: "active" as const },
];
...
export default function AgnciaRatingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agência Rating</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Agência Rating</p>
                    </div>
                </div>
