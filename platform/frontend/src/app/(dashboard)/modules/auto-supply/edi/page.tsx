...
const PAGE = "EDI";
const KPIS = [{"l":"Integrações Ativas","v":"4.531","t":"+6.1%","d":"up"},{"l":"Chamadas/Hora","v":"4835","t":"+17.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.5%","t":"-3.1%","d":"down"},{"l":"Latência Média (ms)","v":"46ms","t":"+9.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","374","1.123","92.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.911","7.811","84.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.114","7.234","71.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","519","4.068","70.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.964","6.569","78.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":974},{"label":"Mar","value":766},{"label":"Abr","value":687},{"label":"Mai","value":892},{"label":"Jun","value":900},{"label":"Jul","value":770},{"label":"Ago","value":695},{"label":"Set","value":836},{"label":"Out","value":726},{"label":"Nov","value":693},{"label":"Dez","value":966}];
const MX = 974;
