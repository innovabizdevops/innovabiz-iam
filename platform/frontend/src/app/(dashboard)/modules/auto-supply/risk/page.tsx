...
const ACCENT = "#6366f1";
const MODULE = "Auto Supply Chain";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"1.471","t":"+2.9%","d":"up"},{"l":"Mitigações Ativas","v":"2.121","t":"+15.9%","d":"up"},{"l":"Score Risco Geral","v":"57","t":"+16.6%","d":"up"},{"l":"Incidentes YTD","v":"6.050","t":"+15.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.476","2.156","3.991","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.158","2.891","6.007","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.073","446","714","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.392","142","8.835","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.296","6.240","7.327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":720},{"label":"Mar","value":843},{"label":"Abr","value":476},{"label":"Mai","value":516},{"label":"Jun","value":490},{"label":"Jul","value":501},{"label":"Ago","value":486},{"label":"Set","value":634},{"label":"Out","value":645},{"label":"Nov","value":824},{"label":"Dez","value":509}];
const MX = 843;
