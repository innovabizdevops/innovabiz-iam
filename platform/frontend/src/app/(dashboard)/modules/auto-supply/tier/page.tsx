...
const PAGE = "Tier Mgmt";
const KPIS = [{"l":"ARR (€M)","v":"€21.2M","t":"+10.1%","d":"up"},{"l":"MRR (€)","v":"€98519","t":"-5.2%","d":"down"},{"l":"Churn (%)","v":"77.2%","t":"+11.7%","d":"up"},{"l":"ARPU (€)","v":"€28415","t":"+1.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28959.13","5.939","€ 46462.11","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 31330.66","963","€ 48147.36","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9864.86","7.346","€ 44782.02","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 30394.55","144","€ 44538.95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45911.81","6.480","€ 10242.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":512},{"label":"Mar","value":558},{"label":"Abr","value":600},{"label":"Mai","value":535},{"label":"Jun","value":540},{"label":"Jul","value":492},{"label":"Ago","value":586},{"label":"Set","value":520},{"label":"Out","value":661},{"label":"Nov","value":540},{"label":"Dez","value":465}];
const MX = 661;
