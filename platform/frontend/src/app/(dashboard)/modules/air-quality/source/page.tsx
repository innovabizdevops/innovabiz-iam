...
const PAGE = "Source Track";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.166","t":"+10.3%","d":"up"},{"l":"NC Abertas","v":"5.455","t":"+6.8%","d":"up"},{"l":"Conformidade (%)","v":"81.9%","t":"+16.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.490","t":"+7.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.638","99.4%","8.731","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","530","79.9%","3.531","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.582","91.7%","2.786","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","690","89.8%","3.589","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.958","81.7%","7.060","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":492},{"label":"Mar","value":406},{"label":"Abr","value":314},{"label":"Mai","value":497},{"label":"Jun","value":612},{"label":"Jul","value":669},{"label":"Ago","value":338},{"label":"Set","value":677},{"label":"Out","value":357},{"label":"Nov","value":491},{"label":"Dez","value":579}];
const MX = 696;
