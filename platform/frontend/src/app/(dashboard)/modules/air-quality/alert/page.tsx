...
const PAGE = "Health Alert";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.073","t":"-2.9%","d":"down"},{"l":"NC Abertas","v":"6.547","t":"+6.2%","d":"up"},{"l":"Conformidade (%)","v":"66.8%","t":"+10.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.043","t":"+16.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.635","85.1%","1.918","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.988","92.8%","478","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.670","96.8%","8.072","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.234","82.2%","3.702","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.336","70.6%","7.972","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":859},{"label":"Mar","value":633},{"label":"Abr","value":678},{"label":"Mai","value":478},{"label":"Jun","value":785},{"label":"Jul","value":469},{"label":"Ago","value":538},{"label":"Set","value":769},{"label":"Out","value":592},{"label":"Nov","value":524},{"label":"Dez","value":537}];
const MX = 859;
