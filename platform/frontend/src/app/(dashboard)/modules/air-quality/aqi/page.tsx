...
const PAGE = "AQI Dashboard";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.724","t":"+15.5%","d":"up"},{"l":"NC Abertas","v":"5.428","t":"+4.7%","d":"up"},{"l":"Conformidade (%)","v":"81.2%","t":"+13.6%","d":"up"},{"l":"CAPAs Pendentes","v":"8.149","t":"+12.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.167","72.9%","2.874","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.063","83.4%","667","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.928","90.6%","5.711","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.891","83.1%","4.871","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","392","70.9%","864","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":649},{"label":"Mar","value":977},{"label":"Abr","value":618},{"label":"Mai","value":616},{"label":"Jun","value":624},{"label":"Jul","value":591},{"label":"Ago","value":941},{"label":"Set","value":968},{"label":"Out","value":766},{"label":"Nov","value":778},{"label":"Dez","value":645}];
const MX = 977;
