...
const ACCENT = "#86efac";
const MODULE = "Air Quality Monitor";
const PAGE = "Sensor Network";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.522","t":"+16.8%","d":"up"},{"l":"NC Abertas","v":"2.263","t":"-4.7%","d":"down"},{"l":"Conformidade (%)","v":"75.4%","t":"+1.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.920","t":"+11.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.224","86.5%","7.328","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.885","76.3%","6.672","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.163","92.6%","670","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.104","95.9%","152","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.526","84.3%","6.823","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":800},{"label":"Mar","value":582},{"label":"Abr","value":788},{"label":"Mai","value":483},{"label":"Jun","value":461},{"label":"Jul","value":466},{"label":"Ago","value":751},{"label":"Set","value":756},{"label":"Out","value":635},{"label":"Nov","value":746},{"label":"Dez","value":825}];
const MX = 825;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#86efac'}}>IoT</span></h1>
                </div>
