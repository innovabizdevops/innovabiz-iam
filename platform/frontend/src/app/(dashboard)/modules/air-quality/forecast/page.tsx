...
const PAGE = "Forecast";
const KPIS = [{"l":"Auditorias Realizadas","v":"620","t":"+10.7%","d":"up"},{"l":"NC Abertas","v":"6.818","t":"+3.2%","d":"up"},{"l":"Conformidade (%)","v":"89.8%","t":"+4.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.047","t":"+9.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.272","86.3%","7.010","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.314","93.2%","6.242","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.948","86.3%","8.735","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.770","78.4%","6.528","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.845","96.7%","8.441","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":917},{"label":"Mar","value":910},{"label":"Abr","value":661},{"label":"Mai","value":605},{"label":"Jun","value":910},{"label":"Jul","value":944},{"label":"Ago","value":910},{"label":"Set","value":844},{"label":"Out","value":662},{"label":"Nov","value":937},{"label":"Dez","value":886}];
const MX = 944;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#86efac'}}>AI</span></h1>
                </div>
