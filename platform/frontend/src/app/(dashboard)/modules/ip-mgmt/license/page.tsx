...
const PAGE = "License";
const KPIS = [{"l":"Total Ip Mgmt","v":"4.997","t":"+0.9%","d":"up"},{"l":"License Ativos","v":"6.392","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"57","t":"+2.6%","d":"up"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ip Mgmt #001","Ip Mgmt #002","3.976","6.678","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Ip Mgmt #002","Ip Mgmt #003","8.174","5.343","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Ip Mgmt #003","Ip Mgmt #004","827","149","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ip Mgmt #004","Ip Mgmt #005","4.165","2.151","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ip Mgmt #005","Ip Mgmt #001","4.123","5.543","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":496},{"label":"Mar","value":351},{"label":"Abr","value":484},{"label":"Mai","value":508},{"label":"Jun","value":330},{"label":"Jul","value":568},{"label":"Ago","value":605},{"label":"Set","value":321},{"label":"Out","value":541},{"label":"Nov","value":618},{"label":"Dez","value":381}];
const MX = 618;
