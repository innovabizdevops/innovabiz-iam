...
const KPIS = [{"l":"Total Ip Mgmt","v":"3.039","t":"+13.0%","d":"up"},{"l":"Copyright Ativos","v":"6.986","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+16.2%","d":"up"}];
const COLS = ["ID","Copyright","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ip Mgmt #001","Ip Mgmt #002","5.765","2.581","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Ip Mgmt #002","Ip Mgmt #003","7.518","5.156","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ip Mgmt #003","Ip Mgmt #004","1.034","1.566","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Ip Mgmt #004","Ip Mgmt #005","4.113","4.215","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ip Mgmt #005","Ip Mgmt #001","2.991","5.491","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":626},{"label":"Mar","value":703},{"label":"Abr","value":618},{"label":"Mai","value":762},{"label":"Jun","value":678},{"label":"Jul","value":561},{"label":"Ago","value":634},{"label":"Set","value":714},{"label":"Out","value":710},{"label":"Nov","value":567},{"label":"Dez","value":799}];
const MX = 799;
