...
const ACCENT = "#6366f1";
const MODULE = "IP Management";
const PAGE = "Patent";
const KPIS = [{"l":"Ideias Submetidas","v":"6.151","t":"+8.5%","d":"up"},{"l":"Patentes (YTD)","v":"2.239","t":"-1.9%","d":"down"},{"l":"Projetos Innovation Lab","v":"4.212","t":"+12.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€18.0M","t":"+0.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","231","87.5%","8.961","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.296","77.0%","294","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.168","84.7%","8.656","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.500","84.2%","4.599","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.199","80.7%","5.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":366},{"label":"Mar","value":366},{"label":"Abr","value":297},{"label":"Mai","value":313},{"label":"Jun","value":339},{"label":"Jul","value":653},{"label":"Ago","value":623},{"label":"Set","value":425},{"label":"Out","value":586},{"label":"Nov","value":435},{"label":"Dez","value":666}];
const MX = 666;
