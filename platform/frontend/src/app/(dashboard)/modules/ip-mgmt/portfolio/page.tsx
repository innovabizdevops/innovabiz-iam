...
const KPIS = [{"l":"Total Ip Mgmt","v":"4.705","t":"-1.8%","d":"down"},{"l":"Portfolio Ativos","v":"5.209","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+5.7%","d":"up"}];
const COLS = ["ID","Portfolio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ip Mgmt #001","Ip Mgmt #002","7.146","8.003","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ip Mgmt #002","Ip Mgmt #003","2.965","8.202","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Ip Mgmt #003","Ip Mgmt #004","6.810","5.281","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Ip Mgmt #004","Ip Mgmt #005","502","5.283","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ip Mgmt #005","Ip Mgmt #001","7.867","8.884","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":518},{"label":"Mar","value":425},{"label":"Abr","value":566},{"label":"Mai","value":550},{"label":"Jun","value":469},{"label":"Jul","value":445},{"label":"Ago","value":573},{"label":"Set","value":419},{"label":"Out","value":537},{"label":"Nov","value":602},{"label":"Dez","value":343}];
const MX = 619;
