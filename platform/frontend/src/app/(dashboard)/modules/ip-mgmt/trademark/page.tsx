...
const KPIS = [{"l":"Total Ip Mgmt","v":"7.267","t":"+3.2%","d":"up"},{"l":"Trademark Ativos","v":"3.539","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"62","t":"+2.1%","d":"up"}];
const COLS = ["ID","Trademark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ip Mgmt #001","Ip Mgmt #002","5.701","5.296","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Ip Mgmt #002","Ip Mgmt #003","1.534","2.602","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Ip Mgmt #003","Ip Mgmt #004","628","7.122","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Ip Mgmt #004","Ip Mgmt #005","8.307","8.340","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ip Mgmt #005","Ip Mgmt #001","2.852","8.449","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":459},{"label":"Mar","value":816},{"label":"Abr","value":649},{"label":"Mai","value":570},{"label":"Jun","value":737},{"label":"Jul","value":733},{"label":"Ago","value":540},{"label":"Set","value":437},{"label":"Out","value":808},{"label":"Nov","value":780},{"label":"Dez","value":571}];
const MX = 816;
