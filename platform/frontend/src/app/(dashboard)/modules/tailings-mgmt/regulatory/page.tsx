...
const KPIS = [{"l":"Total Tailings Mgmt","v":"4.015","t":"+12.2%","d":"up"},{"l":"Regulatory Ativos","v":"3.256","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+16.2%","d":"up"}];
const COLS = ["ID","Regulatory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tailings Mgmt #001","Tailings Mgmt #002","3.490","7.576","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Tailings Mgmt #002","Tailings Mgmt #003","3.620","8.002","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Tailings Mgmt #003","Tailings Mgmt #004","8.429","5.261","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Tailings Mgmt #004","Tailings Mgmt #005","1.476","7.259","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tailings Mgmt #005","Tailings Mgmt #001","8.307","516","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":434},{"label":"Mar","value":522},{"label":"Abr","value":591},{"label":"Mai","value":723},{"label":"Jun","value":553},{"label":"Jul","value":530},{"label":"Ago","value":662},{"label":"Set","value":668},{"label":"Out","value":725},{"label":"Nov","value":457},{"label":"Dez","value":574}];
const MX = 725;
