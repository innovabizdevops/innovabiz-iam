...
const ACCENT = "#a16207";
const MODULE = "Tailings Management";
const PAGE = "Rehab Plan";
const KPIS = [{"l":"Total Tailings Mgmt","v":"7.877","t":"-5.4%","d":"down"},{"l":"Rehab Plan Ativos","v":"2.534","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"70.7%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+10.5%","d":"up"}];
const COLS = ["ID","Rehab Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tailings Mgmt #001","Tailings Mgmt #002","7.250","7.047","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Tailings Mgmt #002","Tailings Mgmt #003","2.158","7.007","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Tailings Mgmt #003","Tailings Mgmt #004","464","133","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Tailings Mgmt #004","Tailings Mgmt #005","5.009","8.276","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tailings Mgmt #005","Tailings Mgmt #001","7.970","940","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":495},{"label":"Mar","value":560},{"label":"Abr","value":413},{"label":"Mai","value":429},{"label":"Jun","value":419},{"label":"Jul","value":557},{"label":"Ago","value":524},{"label":"Set","value":404},{"label":"Out","value":653},{"label":"Nov","value":728},{"label":"Dez","value":472}];
const MX = 746;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a16207'}}>ESG</span></h1>
                </div>
