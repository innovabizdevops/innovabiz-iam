...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.986","t":"+8.9%","d":"up"},{"l":"NC Abertas","v":"3.010","t":"+16.9%","d":"up"},{"l":"Conformidade (%)","v":"83.5%","t":"+2.5%","d":"up"},{"l":"CAPAs Pendentes","v":"2.655","t":"-4.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.711","76.0%","4.987","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.758","92.4%","1.212","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.342","83.0%","3.867","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.504","82.7%","7.832","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.659","70.0%","9.044","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":1029},{"label":"Mar","value":897},{"label":"Abr","value":697},{"label":"Mai","value":703},{"label":"Jun","value":765},{"label":"Jul","value":720},{"label":"Ago","value":945},{"label":"Set","value":899},{"label":"Out","value":897},{"label":"Nov","value":718},{"label":"Dez","value":915}];
const MX = 1029;
