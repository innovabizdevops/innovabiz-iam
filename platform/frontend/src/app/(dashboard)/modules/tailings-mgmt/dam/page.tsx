...
const PAGE = "Dam Monitor";
const KPIS = [{"l":"Total Tailings Mgmt","v":"4.680","t":"+14.9%","d":"up"},{"l":"Dam Monitor Ativos","v":"326","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"83","t":"+7.6%","d":"up"}];
const COLS = ["ID","Dam Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tailings Mgmt #001","Tailings Mgmt #002","5.811","2.126","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Tailings Mgmt #002","Tailings Mgmt #003","8.319","6.617","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Tailings Mgmt #003","Tailings Mgmt #004","1.982","7.726","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Tailings Mgmt #004","Tailings Mgmt #005","4.970","1.399","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tailings Mgmt #005","Tailings Mgmt #001","8.698","2.248","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":759},{"label":"Mar","value":711},{"label":"Abr","value":912},{"label":"Mai","value":586},{"label":"Jun","value":695},{"label":"Jul","value":917},{"label":"Ago","value":854},{"label":"Set","value":818},{"label":"Out","value":782},{"label":"Nov","value":549},{"label":"Dez","value":792}];
const MX = 917;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#a16207'}}>IoT</span></h1>
                </div>
