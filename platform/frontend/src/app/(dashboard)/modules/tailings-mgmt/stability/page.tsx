...
const KPIS = [{"l":"Total Tailings Mgmt","v":"3.470","t":"+1.8%","d":"up"},{"l":"Stability Ativos","v":"4.877","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"60","t":"+17.0%","d":"up"}];
const COLS = ["ID","Stability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tailings Mgmt #001","Tailings Mgmt #002","8.381","8.851","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Tailings Mgmt #002","Tailings Mgmt #003","5.230","6.914","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Tailings Mgmt #003","Tailings Mgmt #004","1.489","4.560","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Tailings Mgmt #004","Tailings Mgmt #005","6.392","8.380","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tailings Mgmt #005","Tailings Mgmt #001","1.299","5.817","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":337},{"label":"Mar","value":392},{"label":"Abr","value":316},{"label":"Mai","value":435},{"label":"Jun","value":584},{"label":"Jul","value":494},{"label":"Ago","value":626},{"label":"Set","value":388},{"label":"Out","value":291},{"label":"Nov","value":586},{"label":"Dez","value":538}];
const MX = 626;
