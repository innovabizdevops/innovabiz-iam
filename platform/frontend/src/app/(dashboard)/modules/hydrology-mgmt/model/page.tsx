...
const ACCENT = "#164e63";
const MODULE = "Hydrology Management";
const PAGE = "Model";
const KPIS = [{"l":"Total Hydrology Mgmt","v":"5.248","t":"+15.1%","d":"up"},{"l":"Model Ativos","v":"8.882","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"80","t":"+9.9%","d":"up"}];
const COLS = ["ID","Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrology Mgmt #001","Hydrology Mgmt #002","4.590","5.501","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrology Mgmt #002","Hydrology Mgmt #003","1.990","5.038","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrology Mgmt #003","Hydrology Mgmt #004","4.703","3.923","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrology Mgmt #004","Hydrology Mgmt #005","1.703","2.140","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrology Mgmt #005","Hydrology Mgmt #001","3.337","7.537","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":689},{"label":"Mar","value":733},{"label":"Abr","value":879},{"label":"Mai","value":686},{"label":"Jun","value":858},{"label":"Jul","value":971},{"label":"Ago","value":658},{"label":"Set","value":936},{"label":"Out","value":871},{"label":"Nov","value":692},{"label":"Dez","value":703}];
const MX = 996;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#164e63'}}>AI</span></h1>
                </div>
