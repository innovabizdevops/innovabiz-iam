...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"7.737","t":"-4.6%","d":"down"},{"l":"Patentes (YTD)","v":"5.261","t":"+18.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"800","t":"+2.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€23.9M","t":"+5.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.961","95.8%","8.180","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.379","76.2%","6.363","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.478","85.5%","3.075","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.985","85.8%","1.461","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.833","90.8%","1.216","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":755},{"label":"Mar","value":474},{"label":"Abr","value":711},{"label":"Mai","value":607},{"label":"Jun","value":708},{"label":"Jul","value":778},{"label":"Ago","value":614},{"label":"Set","value":510},{"label":"Out","value":415},{"label":"Nov","value":537},{"label":"Dez","value":443}];
const MX = 778;
