...
const PAGE = "Gauge";
const KPIS = [{"l":"Total Hydrology Mgmt","v":"1.828","t":"-1.8%","d":"down"},{"l":"Gauge Ativos","v":"8.377","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"81","t":"+4.3%","d":"up"}];
const COLS = ["ID","Gauge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrology Mgmt #001","Hydrology Mgmt #002","1.033","2.529","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrology Mgmt #002","Hydrology Mgmt #003","5.814","441","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrology Mgmt #003","Hydrology Mgmt #004","5.399","3.203","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrology Mgmt #004","Hydrology Mgmt #005","6.487","7.524","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrology Mgmt #005","Hydrology Mgmt #001","3.701","491","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":410},{"label":"Mar","value":557},{"label":"Abr","value":336},{"label":"Mai","value":656},{"label":"Jun","value":350},{"label":"Jul","value":620},{"label":"Ago","value":402},{"label":"Set","value":316},{"label":"Out","value":352},{"label":"Nov","value":610},{"label":"Dez","value":422}];
const MX = 656;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#164e63'}}>IoT</span></h1>
                </div>
