...
const PAGE = "Report";
const KPIS = [{"l":"Total Hydrology Mgmt","v":"3.549","t":"+14.9%","d":"up"},{"l":"Report Ativos","v":"6.247","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"80.0%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"89","t":"+16.9%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrology Mgmt #001","Hydrology Mgmt #002","6.361","8.863","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrology Mgmt #002","Hydrology Mgmt #003","8.658","4.731","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrology Mgmt #003","Hydrology Mgmt #004","4.237","2.782","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrology Mgmt #004","Hydrology Mgmt #005","1.998","2.892","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrology Mgmt #005","Hydrology Mgmt #001","838","4.727","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":683},{"label":"Mar","value":391},{"label":"Abr","value":369},{"label":"Mai","value":592},{"label":"Jun","value":673},{"label":"Jul","value":674},{"label":"Ago","value":372},{"label":"Set","value":672},{"label":"Out","value":428},{"label":"Nov","value":602},{"label":"Dez","value":590}];
const MX = 683;
