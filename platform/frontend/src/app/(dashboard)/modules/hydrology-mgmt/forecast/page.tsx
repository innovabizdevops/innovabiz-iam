...
const PAGE = "Forecast";
const KPIS = [{"l":"Total Hydrology Mgmt","v":"3.465","t":"+7.5%","d":"up"},{"l":"Forecast Ativos","v":"4.303","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"60","t":"-1.1%","d":"down"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hydrology Mgmt #001","Hydrology Mgmt #002","6.565","929","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Hydrology Mgmt #002","Hydrology Mgmt #003","6.785","6.046","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Hydrology Mgmt #003","Hydrology Mgmt #004","8.991","1.897","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Hydrology Mgmt #004","Hydrology Mgmt #005","6.135","5.498","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hydrology Mgmt #005","Hydrology Mgmt #001","4.064","2.764","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":713},{"label":"Mar","value":981},{"label":"Abr","value":966},{"label":"Mai","value":731},{"label":"Jun","value":680},{"label":"Jul","value":768},{"label":"Ago","value":793},{"label":"Set","value":653},{"label":"Out","value":924},{"label":"Nov","value":942},{"label":"Dez","value":920}];
const MX = 981;
