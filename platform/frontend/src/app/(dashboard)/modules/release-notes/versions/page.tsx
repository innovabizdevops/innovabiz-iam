...
const ACCENT = "#059669";
const MODULE = "Release & Changelog";
const PAGE = "Version History";
const KPIS = [{"l":"Formulários Ativos","v":"3.026","t":"+10.6%","d":"up"},{"l":"Submissões/Dia","v":"3915","t":"+3.9%","d":"up"},{"l":"Documentos Gerados","v":"8.118","t":"+9.0%","d":"up"},{"l":"Templates","v":"8.770","t":"+2.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.341","2026-01-23","7.868","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.532","2026-02-14","3.135","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.087","2026-02-20","998","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.277","2026-01-08","426","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.080","2026-03-11","726","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":511},{"label":"Mar","value":609},{"label":"Abr","value":290},{"label":"Mai","value":562},{"label":"Jun","value":427},{"label":"Jul","value":562},{"label":"Ago","value":486},{"label":"Set","value":448},{"label":"Out","value":529},{"label":"Nov","value":551},{"label":"Dez","value":284}];
const MX = 609;
