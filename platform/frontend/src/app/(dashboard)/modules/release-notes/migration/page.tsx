...
const PAGE = "Migration Guides";
const KPIS = [{"l":"Artigos Publicados","v":"3.880","t":"+15.8%","d":"up"},{"l":"Views/Semana","v":"2979","t":"+14.6%","d":"up"},{"l":"Feedback Útil (%)","v":"89.9%","t":"+0.7%","d":"up"},{"l":"Artigos Desatualizados","v":"4.198","t":"+3.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","2.508","93.8%","6.299","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","8.446","81.2%","3.290","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.140","84.9%","8.359","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.461","87.8%","637","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","8.950","79.7%","3.794","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":565},{"label":"Mar","value":678},{"label":"Abr","value":602},{"label":"Mai","value":732},{"label":"Jun","value":557},{"label":"Jul","value":415},{"label":"Ago","value":469},{"label":"Set","value":484},{"label":"Out","value":578},{"label":"Nov","value":513},{"label":"Dez","value":624}];
const MX = 734;
