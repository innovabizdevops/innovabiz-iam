...
const PAGE = "API Changelog";
const KPIS = [{"l":"Integrações Ativas","v":"3.086","t":"+9.7%","d":"up"},{"l":"Chamadas/Hora","v":"710","t":"-5.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"86.6%","t":"+15.8%","d":"up"},{"l":"Latência Média (ms)","v":"58ms","t":"+7.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.887","4.900","74.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","924","1.058","93.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.522","5.809","96.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.457","4.805","94.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.048","4.839","99.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":1017},{"label":"Mar","value":707},{"label":"Abr","value":684},{"label":"Mai","value":694},{"label":"Jun","value":683},{"label":"Jul","value":894},{"label":"Ago","value":792},{"label":"Set","value":1017},{"label":"Out","value":964},{"label":"Nov","value":882},{"label":"Dez","value":789}];
const MX = 1017;
