...
const PAGE = "Deprecation Alerts";
const KPIS = [{"l":"Notificações Enviadas","v":"7.835","t":"+2.9%","d":"up"},{"l":"Taxa Entrega (%)","v":"66.3%","t":"-2.9%","d":"down"},{"l":"Taxa Abertura (%)","v":"83.9%","t":"+0.9%","d":"up"},{"l":"Escalações","v":"1.939","t":"+1.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.682","91.3%","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.802","88.6%","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.301","72.3%","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.855","91.2%","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","3.784","71.1%","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":735},{"label":"Mar","value":759},{"label":"Abr","value":814},{"label":"Mai","value":582},{"label":"Jun","value":532},{"label":"Jul","value":878},{"label":"Ago","value":534},{"label":"Set","value":893},{"label":"Out","value":836},{"label":"Nov","value":846},{"label":"Dez","value":687}];
const MX = 893;
