...
const ACCENT = "#1e293b";
const MODULE = "Retail Loss Prevention";
const PAGE = "Investigate";
const KPIS = [{"l":"Total Loss Prevention","v":"260","t":"+16.9%","d":"up"},{"l":"Investigate Ativos","v":"5.857","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"88.0%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"84","t":"+5.3%","d":"up"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Loss Prevention #001","Loss Prevention #002","8.620","8.008","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Loss Prevention #002","Loss Prevention #003","8.187","2.647","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Loss Prevention #003","Loss Prevention #004","5.142","4.737","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Loss Prevention #004","Loss Prevention #005","4.089","6.557","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Loss Prevention #005","Loss Prevention #001","1.647","9.058","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":545},{"label":"Mar","value":383},{"label":"Abr","value":552},{"label":"Mai","value":295},{"label":"Jun","value":591},{"label":"Jul","value":526},{"label":"Ago","value":615},{"label":"Set","value":568},{"label":"Out","value":563},{"label":"Nov","value":433},{"label":"Dez","value":576}];
const MX = 615;
