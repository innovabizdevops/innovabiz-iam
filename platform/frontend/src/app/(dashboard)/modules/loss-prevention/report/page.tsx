...
const PAGE = "Report";
const KPIS = [{"l":"Total Loss Prevention","v":"6.519","t":"+15.5%","d":"up"},{"l":"Report Ativos","v":"2.571","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"78.2%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"71","t":"-4.4%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Loss Prevention #001","Loss Prevention #002","7.771","4.155","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Loss Prevention #002","Loss Prevention #003","5.692","8.044","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Loss Prevention #003","Loss Prevention #004","6.638","3.439","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Loss Prevention #004","Loss Prevention #005","976","2.402","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Loss Prevention #005","Loss Prevention #001","8.830","6.904","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":341},{"label":"Mar","value":465},{"label":"Abr","value":574},{"label":"Mai","value":538},{"label":"Jun","value":295},{"label":"Jul","value":317},{"label":"Ago","value":365},{"label":"Set","value":311},{"label":"Out","value":290},{"label":"Nov","value":298},{"label":"Dez","value":524}];
const MX = 574;
