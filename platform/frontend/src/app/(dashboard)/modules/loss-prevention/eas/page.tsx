...
const PAGE = "EAS";
const KPIS = [{"l":"Total Loss Prevention","v":"5.667","t":"-5.3%","d":"down"},{"l":"EAS Ativos","v":"9.028","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"74","t":"-5.9%","d":"down"}];
const COLS = ["ID","EAS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Loss Prevention #001","Loss Prevention #002","7.194","1.872","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Loss Prevention #002","Loss Prevention #003","2.176","8.355","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Loss Prevention #003","Loss Prevention #004","4.867","5.854","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Loss Prevention #004","Loss Prevention #005","3.954","5.860","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Loss Prevention #005","Loss Prevention #001","2.094","8.138","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":310},{"label":"Fev","value":440},{"label":"Mar","value":475},{"label":"Abr","value":482},{"label":"Mai","value":301},{"label":"Jun","value":587},{"label":"Jul","value":507},{"label":"Ago","value":600},{"label":"Set","value":427},{"label":"Out","value":396},{"label":"Nov","value":307},{"label":"Dez","value":421}];
const MX = 600;
