...
const PAGE = "CCTV";
const KPIS = [{"l":"Total Loss Prevention","v":"3.756","t":"+2.5%","d":"up"},{"l":"CCTV Ativos","v":"8.821","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"65","t":"+5.0%","d":"up"}];
const COLS = ["ID","CCTV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Loss Prevention #001","Loss Prevention #002","6.886","3.961","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Loss Prevention #002","Loss Prevention #003","4.321","8.501","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Loss Prevention #003","Loss Prevention #004","2.186","588","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Loss Prevention #004","Loss Prevention #005","6.247","8.564","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Loss Prevention #005","Loss Prevention #001","173","4.014","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":603},{"label":"Mar","value":711},{"label":"Abr","value":604},{"label":"Mai","value":582},{"label":"Jun","value":893},{"label":"Jul","value":611},{"label":"Ago","value":837},{"label":"Set","value":676},{"label":"Out","value":547},{"label":"Nov","value":585},{"label":"Dez","value":740}];
const MX = 910;
