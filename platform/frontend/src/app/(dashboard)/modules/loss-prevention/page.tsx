...
/* ═══ Retail Loss Prevention — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "1735", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4175", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€209K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "334116735", cells: ["LOS-1735", "Retail Loss Prevention Item 1", "16/4/2026", "€16 835"], status: "active" as const },
    { id: "334120306", cells: ["LOS-5306", "Retail Loss Prevention Item 2", "3/11/2026", "€20 406"], status: "pending" as const },
    { id: "334123877", cells: ["LOS-8877", "Retail Loss Prevention Item 3", "18/6/2026", "€23 977"], status: "completed" as const },
    { id: "334127448", cells: ["LOS-3448", "Retail Loss Prevention Item 4", "5/1/2026", "€27 548"], status: "warning" as const },
    { id: "334131019", cells: ["LOS-7019", "Retail Loss Prevention Item 5", "20/8/2026", "€31 119"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Retail Loss Prevention</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Retail Loss Prevention</p>
                    </div>
                </div>
