...
const PAGE = "PPM Dashboard";
const KPIS = [{"l":"Projetos Melhoria","v":"4.689","t":"-1.1%","d":"down"},{"l":"Savings (€)","v":"€29446","t":"-4.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.1%","t":"+3.8%","d":"up"},{"l":"Ciclos PDCA","v":"6.295","t":"+0.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","761","€ 46212.19","4.070","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.560","€ 49360.30","8.597","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.504","€ 21173.71","3.558","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.051","€ 38768.32","2.858","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","701","€ 18213.35","5.257","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":210},{"label":"Mar","value":363},{"label":"Abr","value":214},{"label":"Mai","value":210},{"label":"Jun","value":604},{"label":"Jul","value":264},{"label":"Ago","value":331},{"label":"Set","value":313},{"label":"Out","value":388},{"label":"Nov","value":444},{"label":"Dez","value":330}];
const MX = 604;
