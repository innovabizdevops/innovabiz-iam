...
const PAGE = "Timesheet Entry";
const KPIS = [{"l":"Projetos Melhoria","v":"4.983","t":"-0.5%","d":"down"},{"l":"Savings (€)","v":"€99260","t":"+14.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.8%","t":"+8.2%","d":"up"},{"l":"Ciclos PDCA","v":"1.407","t":"+2.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.275","€ 16997.40","1.991","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.264","€ 34962.61","2.347","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.001","€ 13453.14","2.596","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.367","€ 43933.22","1.090","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.167","€ 22213.77","3.749","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":862},{"label":"Mar","value":653},{"label":"Abr","value":655},{"label":"Mai","value":533},{"label":"Jun","value":634},{"label":"Jul","value":769},{"label":"Ago","value":564},{"label":"Set","value":731},{"label":"Out","value":508},{"label":"Nov","value":671},{"label":"Dez","value":708}];
const MX = 862;
