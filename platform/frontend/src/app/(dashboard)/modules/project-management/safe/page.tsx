...
const PAGE = "SAFe Agile";
const KPIS = [{"l":"Projetos Melhoria","v":"7.113","t":"+8.6%","d":"up"},{"l":"Savings (€)","v":"€19145","t":"+12.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.4%","t":"+2.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.576","t":"-3.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.479","€ 2010.19","2.040","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","298","€ 38150.76","8.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.783","€ 22136.12","7.209","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.140","€ 5654.19","5.422","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.693","€ 16180.56","7.005","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":530},{"label":"Mar","value":481},{"label":"Abr","value":437},{"label":"Mai","value":659},{"label":"Jun","value":508},{"label":"Jul","value":484},{"label":"Ago","value":332},{"label":"Set","value":287},{"label":"Out","value":470},{"label":"Nov","value":564},{"label":"Dez","value":600}];
const MX = 659;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>SAFe</span></h1>
                </div>
