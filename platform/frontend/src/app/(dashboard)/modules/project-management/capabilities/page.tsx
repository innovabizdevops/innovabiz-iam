...
const KPIS = [{"l":"Auditorias Realizadas","v":"691","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"7.400","t":"-2.0%","d":"down"},{"l":"Conformidade (%)","v":"81.9%","t":"+11.5%","d":"up"},{"l":"CAPAs Pendentes","v":"2.950","t":"+1.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.174","74.8%","6.290","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.255","83.5%","7.263","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.595","89.2%","1.441","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.348","90.3%","5.173","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.995","91.8%","3.675","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":607},{"label":"Mar","value":626},{"label":"Abr","value":603},{"label":"Mai","value":436},{"label":"Jun","value":789},{"label":"Jul","value":540},{"label":"Ago","value":530},{"label":"Set","value":455},{"label":"Out","value":528},{"label":"Nov","value":413},{"label":"Dez","value":456}];
const MX = 789;
