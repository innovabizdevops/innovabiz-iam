...
const PAGE = "Project Charter Form";
const KPIS = [{"l":"Formulários Ativos","v":"8.084","t":"+0.3%","d":"up"},{"l":"Submissões/Dia","v":"2515","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"7.024","t":"+14.8%","d":"up"},{"l":"Templates","v":"8.851","t":"+14.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.180","2026-02-24","4.480","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.160","2026-03-23","7.951","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.180","2026-03-16","7.942","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.377","2026-02-14","5.469","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.229","2026-03-06","1.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":489},{"label":"Mar","value":714},{"label":"Abr","value":761},{"label":"Mai","value":713},{"label":"Jun","value":622},{"label":"Jul","value":464},{"label":"Ago","value":582},{"label":"Set","value":525},{"label":"Out","value":750},{"label":"Nov","value":661},{"label":"Dez","value":702}];
const MX = 842;
...
export default function CharterFormPage() {
    return (
