...
const PAGE = "RACI Matrix";
const KPIS = [{"l":"Projetos Melhoria","v":"8.222","t":"+6.7%","d":"up"},{"l":"Savings (€)","v":"€10319","t":"+15.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"86.5%","t":"+0.1%","d":"up"},{"l":"Ciclos PDCA","v":"7.968","t":"+5.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.558","€ 24234.72","2.836","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.005","€ 11796.13","2.821","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.553","€ 37107.82","4.688","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.221","€ 25260.83","6.461","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.864","€ 3787.28","1.729","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":814},{"label":"Mar","value":994},{"label":"Abr","value":918},{"label":"Mai","value":785},{"label":"Jun","value":913},{"label":"Jul","value":812},{"label":"Ago","value":859},{"label":"Set","value":825},{"label":"Out","value":910},{"label":"Nov","value":952},{"label":"Dez","value":724}];
const MX = 994;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Matrix</span></h1>
                </div>
