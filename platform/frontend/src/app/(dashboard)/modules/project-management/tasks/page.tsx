...
const PAGE = "Tasks";
const KPIS = [{"l":"Projetos Melhoria","v":"7.134","t":"+0.3%","d":"up"},{"l":"Savings (€)","v":"€44226","t":"-0.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.4%","t":"-4.0%","d":"down"},{"l":"Ciclos PDCA","v":"1.909","t":"+3.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.957","€ 40152.84","3.611","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.168","€ 31200.29","1.674","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.481","€ 15407.60","8.745","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.970","€ 3276.05","4.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.443","€ 42901.98","8.127","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":526},{"label":"Mar","value":365},{"label":"Abr","value":313},{"label":"Mai","value":288},{"label":"Jun","value":433},{"label":"Jul","value":303},{"label":"Ago","value":234},{"label":"Set","value":357},{"label":"Out","value":391},{"label":"Nov","value":588},{"label":"Dez","value":334}];
const MX = 588;
