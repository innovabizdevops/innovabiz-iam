...
const PAGE = "Milestone Tracking";
const KPIS = [{"l":"Projetos Melhoria","v":"2.174","t":"+6.3%","d":"up"},{"l":"Savings (€)","v":"€89974","t":"+3.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.0%","t":"+10.7%","d":"up"},{"l":"Ciclos PDCA","v":"8.084","t":"+15.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.351","€ 35389.51","6.475","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.183","€ 6943.38","2.926","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.350","€ 29303.90","4.891","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.020","€ 45647.07","1.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.536","€ 11543.31","7.723","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":871},{"label":"Mar","value":999},{"label":"Abr","value":812},{"label":"Mai","value":890},{"label":"Jun","value":966},{"label":"Jul","value":722},{"label":"Ago","value":979},{"label":"Set","value":986},{"label":"Out","value":720},{"label":"Nov","value":720},{"label":"Dez","value":782}];
const MX = 999;
