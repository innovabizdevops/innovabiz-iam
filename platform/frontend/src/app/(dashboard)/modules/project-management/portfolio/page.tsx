...
const KPIS = [{"l":"Projetos Melhoria","v":"2.078","t":"+3.8%","d":"up"},{"l":"Savings (€)","v":"€23645","t":"+8.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.5%","t":"+5.5%","d":"up"},{"l":"Ciclos PDCA","v":"5.179","t":"+9.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.763","€ 31612.81","319","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.327","€ 46573.54","7.734","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.352","€ 46395.24","7.260","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.760","€ 27748.18","2.392","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.089","€ 16923.71","7.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":415},{"label":"Mar","value":598},{"label":"Abr","value":549},{"label":"Mai","value":385},{"label":"Jun","value":624},{"label":"Jul","value":639},{"label":"Ago","value":414},{"label":"Set","value":326},{"label":"Out","value":569},{"label":"Nov","value":542},{"label":"Dez","value":481}];
const MX = 639;
