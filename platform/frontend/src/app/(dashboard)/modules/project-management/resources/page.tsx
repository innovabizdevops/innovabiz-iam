...
const KPIS = [{"l":"Projetos Melhoria","v":"2.930","t":"+9.6%","d":"up"},{"l":"Savings (€)","v":"€24658","t":"+12.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.7%","t":"+15.8%","d":"up"},{"l":"Ciclos PDCA","v":"4.845","t":"+7.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.641","€ 30826.10","2.021","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.259","€ 4511.99","272","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.840","€ 34560.55","5.797","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","666","€ 8165.15","8.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.151","€ 38460.54","7.357","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":607},{"label":"Mar","value":532},{"label":"Abr","value":261},{"label":"Mai","value":526},{"label":"Jun","value":373},{"label":"Jul","value":362},{"label":"Ago","value":278},{"label":"Set","value":519},{"label":"Out","value":407},{"label":"Nov","value":444},{"label":"Dez","value":250}];
const MX = 607;
