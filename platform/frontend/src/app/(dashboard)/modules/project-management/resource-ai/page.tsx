...
const PAGE = "Resource Optimization AI";
const KPIS = [{"l":"Projetos Melhoria","v":"3.010","t":"+2.0%","d":"up"},{"l":"Savings (€)","v":"€70889","t":"+17.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.0%","t":"+16.8%","d":"up"},{"l":"Ciclos PDCA","v":"4.365","t":"+10.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.832","€ 38536.15","4.663","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.504","€ 3717.95","1.146","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.870","€ 12830.61","4.949","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.643","€ 22168.26","8.698","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.207","€ 2053.47","3.521","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":932},{"label":"Mar","value":822},{"label":"Abr","value":995},{"label":"Mai","value":867},{"label":"Jun","value":739},{"label":"Jul","value":934},{"label":"Ago","value":961},{"label":"Set","value":841},{"label":"Out","value":680},{"label":"Nov","value":1054},{"label":"Dez","value":904}];
const MX = 1054;
...
export default function ResourceAiPage() {
    return (
