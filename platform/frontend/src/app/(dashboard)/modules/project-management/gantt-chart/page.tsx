...
const PAGE = "Gantt Chart View";
const KPIS = [{"l":"Projetos Melhoria","v":"8.965","t":"+10.8%","d":"up"},{"l":"Savings (€)","v":"€83289","t":"+3.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.1%","t":"+6.3%","d":"up"},{"l":"Ciclos PDCA","v":"2.512","t":"-4.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.042","€ 12636.35","8.866","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.836","€ 23664.37","4.015","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.719","€ 9170.96","5.245","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.097","€ 42794.15","9.059","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.490","€ 22193.77","1.164","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":665},{"label":"Mar","value":552},{"label":"Abr","value":897},{"label":"Mai","value":673},{"label":"Jun","value":652},{"label":"Jul","value":772},{"label":"Ago","value":783},{"label":"Set","value":866},{"label":"Out","value":558},{"label":"Nov","value":695},{"label":"Dez","value":566}];
const MX = 897;
