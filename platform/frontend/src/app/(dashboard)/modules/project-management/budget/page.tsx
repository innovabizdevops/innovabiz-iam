...
const PAGE = "Budget Tracking";
const KPIS = [{"l":"Projetos Melhoria","v":"5.581","t":"+10.5%","d":"up"},{"l":"Savings (€)","v":"€31212","t":"-0.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"82.4%","t":"+0.6%","d":"up"},{"l":"Ciclos PDCA","v":"2.882","t":"-3.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.293","€ 29724.37","1.370","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.664","€ 26855.41","9.013","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.571","€ 37079.64","5.110","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.419","€ 34837.12","6.838","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.111","€ 42693.85","7.863","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":222},{"label":"Fev","value":523},{"label":"Mar","value":470},{"label":"Abr","value":291},{"label":"Mai","value":331},{"label":"Jun","value":293},{"label":"Jul","value":205},{"label":"Ago","value":412},{"label":"Set","value":481},{"label":"Out","value":554},{"label":"Nov","value":592},{"label":"Dez","value":287}];
const MX = 592;
