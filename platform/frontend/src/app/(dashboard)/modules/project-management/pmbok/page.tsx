...
const PAGE = "PMBOK Guide";
const KPIS = [{"l":"Projetos Melhoria","v":"2.074","t":"+13.3%","d":"up"},{"l":"Savings (€)","v":"€18329","t":"-4.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"81.1%","t":"+13.9%","d":"up"},{"l":"Ciclos PDCA","v":"5.749","t":"+14.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.555","€ 28106.06","4.303","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.041","€ 35954.64","1.939","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.082","€ 35443.94","554","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.913","€ 26517.79","5.963","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.753","€ 21023.13","3.248","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":820},{"label":"Mar","value":791},{"label":"Abr","value":1063},{"label":"Mai","value":774},{"label":"Jun","value":1035},{"label":"Jul","value":690},{"label":"Ago","value":788},{"label":"Set","value":693},{"label":"Out","value":687},{"label":"Nov","value":943},{"label":"Dez","value":1026}];
const MX = 1063;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>PMI</span></h1>
                </div>
