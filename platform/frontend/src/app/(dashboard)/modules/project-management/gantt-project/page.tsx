...
const KPIS = [{"l":"Projetos Melhoria","v":"6.926","t":"+12.2%","d":"up"},{"l":"Savings (€)","v":"€95169","t":"+9.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.9%","t":"+17.9%","d":"up"},{"l":"Ciclos PDCA","v":"1.302","t":"+13.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.622","€ 18211.73","8.062","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","788","€ 23127.41","4.123","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.347","€ 7802.42","5.702","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.729","€ 39500.08","1.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.359","€ 18194.71","7.536","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":855},{"label":"Mar","value":911},{"label":"Abr","value":781},{"label":"Mai","value":674},{"label":"Jun","value":516},{"label":"Jul","value":592},{"label":"Ago","value":899},{"label":"Set","value":792},{"label":"Out","value":836},{"label":"Nov","value":695},{"label":"Dez","value":671}];
const MX = 911;
