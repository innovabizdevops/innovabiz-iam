...
const PAGE = "PRINCE2 Framework";
const KPIS = [{"l":"Projetos Melhoria","v":"1.057","t":"+4.3%","d":"up"},{"l":"Savings (€)","v":"€98927","t":"+14.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.1%","t":"+13.0%","d":"up"},{"l":"Ciclos PDCA","v":"3.239","t":"+11.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","707","€ 2480.26","3.815","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.640","€ 5114.38","6.296","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.156","€ 49398.66","7.992","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.309","€ 23827.89","1.534","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.106","€ 29372.87","7.624","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":737},{"label":"Mar","value":634},{"label":"Abr","value":438},{"label":"Mai","value":661},{"label":"Jun","value":668},{"label":"Jul","value":503},{"label":"Ago","value":747},{"label":"Set","value":659},{"label":"Out","value":752},{"label":"Nov","value":675},{"label":"Dez","value":664}];
const MX = 752;
...
export default function Prince2Page() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>PRINCE2</span></h1>
                </div>
