...
const PAGE = "AI Planning";
const KPIS = [{"l":"Projetos Melhoria","v":"5.867","t":"+6.8%","d":"up"},{"l":"Savings (€)","v":"€91572","t":"+4.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.8%","t":"+2.3%","d":"up"},{"l":"Ciclos PDCA","v":"1.797","t":"-1.8%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.874","€ 1508.51","1.387","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.145","€ 47230.68","301","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.601","€ 19375.00","2.154","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.610","€ 50032.46","154","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.475","€ 8637.22","5.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":749},{"label":"Mar","value":429},{"label":"Abr","value":768},{"label":"Mai","value":707},{"label":"Jun","value":666},{"label":"Jul","value":690},{"label":"Ago","value":377},{"label":"Set","value":503},{"label":"Out","value":768},{"label":"Nov","value":414},{"label":"Dez","value":692}];
const MX = 768;
