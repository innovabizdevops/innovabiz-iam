...
const PAGE = "Agile Boards";
const KPIS = [{"l":"Projetos Melhoria","v":"1.318","t":"+1.2%","d":"up"},{"l":"Savings (€)","v":"€43824","t":"-0.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"67.1%","t":"+9.9%","d":"up"},{"l":"Ciclos PDCA","v":"604","t":"+13.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.659","€ 17666.63","1.743","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.426","€ 170.69","9.011","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.069","€ 14206.41","4.425","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.917","€ 6237.92","6.448","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.596","€ 24274.74","475","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":643},{"label":"Mar","value":503},{"label":"Abr","value":455},{"label":"Mai","value":597},{"label":"Jun","value":574},{"label":"Jul","value":337},{"label":"Ago","value":438},{"label":"Set","value":574},{"label":"Out","value":576},{"label":"Nov","value":641},{"label":"Dez","value":636}];
const MX = 643;
