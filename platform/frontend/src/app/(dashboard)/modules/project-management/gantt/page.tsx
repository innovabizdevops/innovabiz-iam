...
const PAGE = "Gantt";
const KPIS = [{"l":"Projetos Melhoria","v":"1.933","t":"+1.9%","d":"up"},{"l":"Savings (€)","v":"€74822","t":"-1.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"88.8%","t":"-0.1%","d":"down"},{"l":"Ciclos PDCA","v":"7.848","t":"+13.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.478","€ 16876.70","3.706","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.734","€ 47723.14","7.085","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.715","€ 25732.54","4.281","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.819","€ 25340.26","1.654","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.453","€ 12110.71","6.562","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":558},{"label":"Mar","value":832},{"label":"Abr","value":862},{"label":"Mai","value":639},{"label":"Jun","value":758},{"label":"Jul","value":568},{"label":"Ago","value":538},{"label":"Set","value":514},{"label":"Out","value":838},{"label":"Nov","value":596},{"label":"Dez","value":800}];
const MX = 862;
