...
const PAGE = "Burn Down Chart";
const KPIS = [{"l":"Projetos Melhoria","v":"3.859","t":"+3.5%","d":"up"},{"l":"Savings (€)","v":"€71752","t":"-4.3%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"81.3%","t":"-4.6%","d":"down"},{"l":"Ciclos PDCA","v":"659","t":"-3.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","378","€ 48664.04","252","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.738","€ 46524.03","6.491","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.145","€ 9933.17","8.256","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.866","€ 17099.94","2.093","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.490","€ 43861.91","5.245","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":538},{"label":"Mar","value":549},{"label":"Abr","value":666},{"label":"Mai","value":341},{"label":"Jun","value":576},{"label":"Jul","value":446},{"label":"Ago","value":480},{"label":"Set","value":706},{"label":"Out","value":497},{"label":"Nov","value":460},{"label":"Dez","value":655}];
const MX = 706;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Agile</span></h1>
                </div>
