...
const PAGE = "Projects";
const KPIS = [{"l":"Projetos Melhoria","v":"6.006","t":"+13.0%","d":"up"},{"l":"Savings (€)","v":"€45403","t":"+16.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.3%","t":"-3.7%","d":"down"},{"l":"Ciclos PDCA","v":"3.497","t":"+8.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.869","€ 8975.00","2.206","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.219","€ 34442.49","1.569","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.248","€ 49872.36","5.393","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.058","€ 23915.79","4.724","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.794","€ 49911.62","3.814","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":323},{"label":"Fev","value":429},{"label":"Mar","value":379},{"label":"Abr","value":306},{"label":"Mai","value":519},{"label":"Jun","value":663},{"label":"Jul","value":598},{"label":"Ago","value":430},{"label":"Set","value":300},{"label":"Out","value":616},{"label":"Nov","value":442},{"label":"Dez","value":433}];
const MX = 663;
