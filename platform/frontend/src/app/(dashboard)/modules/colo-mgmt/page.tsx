...
export default function ColoMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Colo Mgmt</h1><p className="text-sm text-muted-foreground">Colo Mgmt • iBOS Enterprise</p></div>
