...
const PAGE = "Billing";
const KPIS = [{"l":"Total Colo Mgmt","v":"909","t":"+15.3%","d":"up"},{"l":"Billing Ativos","v":"6.359","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"62","t":"+6.4%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Colo Mgmt #001","Colo Mgmt #002","1.707","4.043","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Colo Mgmt #002","Colo Mgmt #003","1.112","6.987","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Colo Mgmt #003","Colo Mgmt #004","612","8.436","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Colo Mgmt #004","Colo Mgmt #005","7.137","6.907","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Colo Mgmt #005","Colo Mgmt #001","1.032","1.368","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":324},{"label":"Mar","value":645},{"label":"Abr","value":432},{"label":"Mai","value":692},{"label":"Jun","value":406},{"label":"Jul","value":423},{"label":"Ago","value":492},{"label":"Set","value":469},{"label":"Out","value":475},{"label":"Nov","value":425},{"label":"Dez","value":508}];
const MX = 692;
