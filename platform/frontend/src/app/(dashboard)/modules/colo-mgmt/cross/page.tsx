...
const PAGE = "Cross-Connect";
const KPIS = [{"l":"Total Colo Mgmt","v":"6.758","t":"+2.3%","d":"up"},{"l":"Cross Connect Ativos","v":"6.086","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"77","t":"+1.9%","d":"up"}];
const COLS = ["ID","Cross Connect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Colo Mgmt #001","Colo Mgmt #002","5.673","2.381","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Colo Mgmt #002","Colo Mgmt #003","5.700","250","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Colo Mgmt #003","Colo Mgmt #004","1.380","3.329","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Colo Mgmt #004","Colo Mgmt #005","1.601","2.724","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Colo Mgmt #005","Colo Mgmt #001","689","8.136","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":472},{"label":"Mar","value":426},{"label":"Abr","value":528},{"label":"Mai","value":580},{"label":"Jun","value":446},{"label":"Jul","value":591},{"label":"Ago","value":442},{"label":"Set","value":476},{"label":"Out","value":498},{"label":"Nov","value":289},{"label":"Dez","value":563}];
const MX = 591;
