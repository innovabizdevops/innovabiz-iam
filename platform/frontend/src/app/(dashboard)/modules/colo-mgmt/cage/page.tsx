...
const ACCENT = "#059669";
const MODULE = "Colocation Management";
const PAGE = "Cage &amp; Cabinet";
const KPIS = [{"l":"Total Colo Mgmt","v":"7.899","t":"+16.9%","d":"up"},{"l":"Cage & Cabinet Ativos","v":"1.066","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"84","t":"-5.5%","d":"down"}];
const COLS = ["ID","Cage & Cabinet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Colo Mgmt #001","Colo Mgmt #002","3.603","1.564","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Colo Mgmt #002","Colo Mgmt #003","1.861","894","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Colo Mgmt #003","Colo Mgmt #004","5.796","7.389","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Colo Mgmt #004","Colo Mgmt #005","3.063","6.113","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Colo Mgmt #005","Colo Mgmt #001","1.888","810","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":874},{"label":"Mar","value":663},{"label":"Abr","value":676},{"label":"Mai","value":717},{"label":"Jun","value":893},{"label":"Jul","value":739},{"label":"Ago","value":556},{"label":"Set","value":597},{"label":"Out","value":523},{"label":"Nov","value":591},{"label":"Dez","value":525}];
const MX = 893;
