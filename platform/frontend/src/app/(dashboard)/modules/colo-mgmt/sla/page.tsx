...
const PAGE = "SLA Report";
const KPIS = [{"l":"Tickets Abertos","v":"4.250","t":"+14.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.0%","t":"+9.8%","d":"up"},{"l":"MTTR (h)","v":"46h","t":"-4.0%","d":"down"},{"l":"Satisfação (%)","v":"70.8%","t":"+5.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.278","8.769","509","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.899","6.497","354","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.627","3.300","2.611","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.773","4.348","5.050","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.373","6.697","3.165","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":601},{"label":"Mar","value":244},{"label":"Abr","value":570},{"label":"Mai","value":273},{"label":"Jun","value":246},{"label":"Jul","value":460},{"label":"Ago","value":220},{"label":"Set","value":267},{"label":"Out","value":323},{"label":"Nov","value":496},{"label":"Dez","value":282}];
const MX = 601;
