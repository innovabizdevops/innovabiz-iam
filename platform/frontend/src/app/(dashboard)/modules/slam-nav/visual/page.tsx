...
const PAGE = "Visual SLAM";
const KPIS = [{"l":"Tickets Abertos","v":"2.150","t":"-2.6%","d":"down"},{"l":"SLA Cumprido (%)","v":"65.9%","t":"-0.6%","d":"down"},{"l":"MTTR (h)","v":"139h","t":"+0.7%","d":"up"},{"l":"Satisfação (%)","v":"82.2%","t":"+12.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.283","2.511","5.221","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.731","8.745","5.408","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.852","850","5.691","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","593","6.384","6.786","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.553","6.213","4.898","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":526},{"label":"Mar","value":557},{"label":"Abr","value":486},{"label":"Mai","value":487},{"label":"Jun","value":442},{"label":"Jul","value":440},{"label":"Ago","value":427},{"label":"Set","value":332},{"label":"Out","value":604},{"label":"Nov","value":533},{"label":"Dez","value":500}];
const MX = 656;
