...
const PAGE = "LiDAR SLAM";
const KPIS = [{"l":"Tickets Abertos","v":"7.927","t":"+15.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.5%","t":"+17.9%","d":"up"},{"l":"MTTR (h)","v":"69h","t":"+4.9%","d":"up"},{"l":"Satisfação (%)","v":"90.5%","t":"+12.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.195","2.167","8.533","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.512","7.511","1.775","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","299","6.360","6.120","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.006","8.087","7.782","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.046","1.278","501","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":229},{"label":"Fev","value":220},{"label":"Mar","value":310},{"label":"Abr","value":301},{"label":"Mai","value":563},{"label":"Jun","value":274},{"label":"Jul","value":364},{"label":"Ago","value":321},{"label":"Set","value":518},{"label":"Out","value":465},{"label":"Nov","value":240},{"label":"Dez","value":485}];
const MX = 563;
