...
const KPIS = [{"l":"Tickets Abertos","v":"861","t":"+2.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.2%","t":"+3.9%","d":"up"},{"l":"MTTR (h)","v":"161h","t":"-2.3%","d":"down"},{"l":"Satisfação (%)","v":"84.2%","t":"+5.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.401","359","1.088","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.864","6.725","3.995","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.900","8.411","7.729","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.387","554","3.100","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.652","4.853","8.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":748},{"label":"Mar","value":470},{"label":"Abr","value":495},{"label":"Mai","value":806},{"label":"Jun","value":584},{"label":"Jul","value":601},{"label":"Ago","value":629},{"label":"Set","value":613},{"label":"Out","value":533},{"label":"Nov","value":744},{"label":"Dez","value":671}];
const MX = 806;
