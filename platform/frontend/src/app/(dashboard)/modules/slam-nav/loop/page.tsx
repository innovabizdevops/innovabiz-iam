...
const PAGE = "Loop Closure";
const KPIS = [{"l":"Tickets Abertos","v":"6.940","t":"+9.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.1%","t":"+8.2%","d":"up"},{"l":"MTTR (h)","v":"20h","t":"+12.6%","d":"up"},{"l":"Satisfação (%)","v":"86.7%","t":"+8.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.469","7.515","3.822","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.006","2.944","5.393","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.399","3.061","4.756","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.581","5.514","4.753","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.537","6.551","8.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":524},{"label":"Mar","value":398},{"label":"Abr","value":594},{"label":"Mai","value":421},{"label":"Jun","value":340},{"label":"Jul","value":513},{"label":"Ago","value":402},{"label":"Set","value":458},{"label":"Out","value":378},{"label":"Nov","value":449},{"label":"Dez","value":431}];
const MX = 641;
