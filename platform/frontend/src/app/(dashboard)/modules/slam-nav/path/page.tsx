...
const ACCENT = "#6366f1";
const MODULE = "SLAM Navigation";
const PAGE = "Path Plan";
const KPIS = [{"l":"Tickets Abertos","v":"4.163","t":"+14.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.0%","t":"+6.7%","d":"up"},{"l":"MTTR (h)","v":"56h","t":"-2.3%","d":"down"},{"l":"Satisfação (%)","v":"78.7%","t":"-4.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.738","121","8.972","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.764","1.887","1.665","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.048","7.956","1.707","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.234","3.360","1.855","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.684","4.031","7.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":501},{"label":"Mar","value":339},{"label":"Abr","value":497},{"label":"Mai","value":386},{"label":"Jun","value":370},{"label":"Jul","value":287},{"label":"Ago","value":576},{"label":"Set","value":273},{"label":"Out","value":238},{"label":"Nov","value":394},{"label":"Dez","value":377}];
const MX = 576;
