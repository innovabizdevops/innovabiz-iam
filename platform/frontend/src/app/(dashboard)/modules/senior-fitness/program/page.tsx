...
const PAGE = "Program";
const KPIS = [{"l":"Atletas Registados","v":"667","t":"+13.5%","d":"up"},{"l":"Treinos/Semana","v":"406","t":"+4.9%","d":"up"},{"l":"Competições","v":"5.854","t":"+1.6%","d":"up"},{"l":"Performance Score","v":"72","t":"+1.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.806","7.991","3.446","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.983","5.825","8.331","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.229","1.410","3.023","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","236","6.768","1.214","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.388","8.827","4.719","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":828},{"label":"Mar","value":933},{"label":"Abr","value":826},{"label":"Mai","value":879},{"label":"Jun","value":1014},{"label":"Jul","value":802},{"label":"Ago","value":954},{"label":"Set","value":714},{"label":"Out","value":799},{"label":"Nov","value":869},{"label":"Dez","value":1047}];
const MX = 1047;
