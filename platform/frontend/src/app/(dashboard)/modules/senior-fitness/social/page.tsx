...
const ACCENT = "#6366f1";
const MODULE = "Senior Fitness";
const PAGE = "Social";
const KPIS = [{"l":"Atletas Registados","v":"6.134","t":"-3.9%","d":"down"},{"l":"Treinos/Semana","v":"2422","t":"+2.3%","d":"up"},{"l":"Competições","v":"9.044","t":"-3.9%","d":"down"},{"l":"Performance Score","v":"83","t":"-2.8%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.802","2.241","8.180","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.455","3.220","5.735","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","331","1.264","2.384","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.220","444","6.680","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.962","8.521","7.827","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":674},{"label":"Mar","value":700},{"label":"Abr","value":669},{"label":"Mai","value":674},{"label":"Jun","value":531},{"label":"Jul","value":733},{"label":"Ago","value":650},{"label":"Set","value":516},{"label":"Out","value":548},{"label":"Nov","value":696},{"label":"Dez","value":723}];
const MX = 733;
