...
const KPIS = [{"l":"Atletas Registados","v":"5.141","t":"-2.7%","d":"down"},{"l":"Treinos/Semana","v":"1749","t":"-1.5%","d":"down"},{"l":"Competições","v":"8.031","t":"+0.1%","d":"up"},{"l":"Performance Score","v":"80","t":"+3.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.487","6.357","5.395","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.588","8.473","4.281","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.866","2.505","3.074","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","378","8.638","2.093","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.429","3.004","2.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":672},{"label":"Mar","value":717},{"label":"Abr","value":500},{"label":"Mai","value":631},{"label":"Jun","value":562},{"label":"Jul","value":536},{"label":"Ago","value":754},{"label":"Set","value":703},{"label":"Out","value":668},{"label":"Nov","value":626},{"label":"Dez","value":544}];
const MX = 754;
