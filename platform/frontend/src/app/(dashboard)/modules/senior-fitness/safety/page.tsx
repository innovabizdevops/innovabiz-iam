...
const PAGE = "Safety";
const KPIS = [{"l":"Atletas Registados","v":"7.773","t":"+2.9%","d":"up"},{"l":"Treinos/Semana","v":"1663","t":"+13.1%","d":"up"},{"l":"Competições","v":"8.377","t":"-2.4%","d":"down"},{"l":"Performance Score","v":"83","t":"-5.4%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.881","2.026","942","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.839","699","3.516","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.363","4.860","1.771","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.250","5.197","1.437","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.580","1.593","7.819","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":614},{"label":"Mar","value":664},{"label":"Abr","value":632},{"label":"Mai","value":874},{"label":"Jun","value":703},{"label":"Jul","value":750},{"label":"Ago","value":661},{"label":"Set","value":891},{"label":"Out","value":818},{"label":"Nov","value":779},{"label":"Dez","value":676}];
const MX = 891;
