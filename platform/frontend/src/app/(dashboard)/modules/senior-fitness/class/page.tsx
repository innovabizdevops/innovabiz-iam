...
const PAGE = "Class";
const KPIS = [{"l":"Atletas Registados","v":"6.283","t":"-5.9%","d":"down"},{"l":"Treinos/Semana","v":"1796","t":"+16.3%","d":"up"},{"l":"Competições","v":"7.046","t":"+1.6%","d":"up"},{"l":"Performance Score","v":"94","t":"+14.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.080","8.587","303","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.397","6.235","6.516","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.091","6.483","1.984","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","9.037","358","4.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","984","8.665","7.015","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":502},{"label":"Mar","value":384},{"label":"Abr","value":347},{"label":"Mai","value":630},{"label":"Jun","value":705},{"label":"Jul","value":473},{"label":"Ago","value":450},{"label":"Set","value":623},{"label":"Out","value":585},{"label":"Nov","value":418},{"label":"Dez","value":328}];
const MX = 705;
