...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€36.1M","t":"-1.0%","d":"down"},{"l":"MRR (€)","v":"€8199","t":"+1.9%","d":"up"},{"l":"Churn (%)","v":"80.4%","t":"+0.4%","d":"up"},{"l":"ARPU (€)","v":"€76760","t":"-3.3%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27106.22","3.264","€ 32255.70","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22032.50","1.972","€ 14556.79","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38898.80","7.603","€ 10584.85","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13988.56","7.875","€ 39584.63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42304.32","4.096","€ 2766.95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":986},{"label":"Fev","value":923},{"label":"Mar","value":866},{"label":"Abr","value":861},{"label":"Mai","value":643},{"label":"Jun","value":668},{"label":"Jul","value":792},{"label":"Ago","value":670},{"label":"Set","value":634},{"label":"Out","value":819},{"label":"Nov","value":715},{"label":"Dez","value":718}];
const MX = 986;
