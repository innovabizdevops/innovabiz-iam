...
const PAGE = "Guest";
const KPIS = [{"l":"Total Vacation Rental","v":"6.389","t":"+5.1%","d":"up"},{"l":"Guest Ativos","v":"6.577","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"74.0%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"72","t":"+2.0%","d":"up"}];
const COLS = ["ID","Guest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vacation Rental #001","Vacation Rental #002","6.692","5.978","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Vacation Rental #002","Vacation Rental #003","4.847","3.876","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Vacation Rental #003","Vacation Rental #004","8.227","8.115","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Vacation Rental #004","Vacation Rental #005","9.077","2.282","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vacation Rental #005","Vacation Rental #001","528","510","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":808},{"label":"Mar","value":660},{"label":"Abr","value":748},{"label":"Mai","value":663},{"label":"Jun","value":611},{"label":"Jul","value":771},{"label":"Ago","value":672},{"label":"Set","value":768},{"label":"Out","value":716},{"label":"Nov","value":767},{"label":"Dez","value":884}];
const MX = 884;
