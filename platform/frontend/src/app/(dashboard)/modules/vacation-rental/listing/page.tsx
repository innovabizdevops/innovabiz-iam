...
const ACCENT = "#6366f1";
const MODULE = "Vacation Rental";
const PAGE = "Listing";
const KPIS = [{"l":"Total Vacation Rental","v":"4.637","t":"+17.3%","d":"up"},{"l":"Listing Ativos","v":"1.983","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"92","t":"+5.2%","d":"up"}];
const COLS = ["ID","Listing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vacation Rental #001","Vacation Rental #002","2.970","3.235","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Vacation Rental #002","Vacation Rental #003","8.961","2.658","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Vacation Rental #003","Vacation Rental #004","7.666","5.764","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Vacation Rental #004","Vacation Rental #005","3.404","7.376","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vacation Rental #005","Vacation Rental #001","6.237","439","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":687},{"label":"Mar","value":670},{"label":"Abr","value":810},{"label":"Mai","value":550},{"label":"Jun","value":593},{"label":"Jul","value":704},{"label":"Ago","value":625},{"label":"Set","value":861},{"label":"Out","value":653},{"label":"Nov","value":725},{"label":"Dez","value":542}];
const MX = 861;
