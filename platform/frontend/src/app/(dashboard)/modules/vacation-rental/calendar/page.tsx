...
const PAGE = "Calendar";
const KPIS = [{"l":"Total Vacation Rental","v":"7.605","t":"-5.1%","d":"down"},{"l":"Calendar Ativos","v":"8.142","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+15.8%","d":"up"}];
const COLS = ["ID","Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vacation Rental #001","Vacation Rental #002","6.200","126","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Vacation Rental #002","Vacation Rental #003","5.703","7.724","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Vacation Rental #003","Vacation Rental #004","2.839","4.351","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Vacation Rental #004","Vacation Rental #005","4.233","895","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vacation Rental #005","Vacation Rental #001","4.494","2.169","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":282},{"label":"Fev","value":246},{"label":"Mar","value":565},{"label":"Abr","value":544},{"label":"Mai","value":560},{"label":"Jun","value":404},{"label":"Jul","value":270},{"label":"Ago","value":354},{"label":"Set","value":414},{"label":"Out","value":566},{"label":"Nov","value":583},{"label":"Dez","value":553}];
const MX = 583;
