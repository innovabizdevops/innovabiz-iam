...
const PAGE = "Cleaning";
const KPIS = [{"l":"Projetos Melhoria","v":"3.050","t":"+0.2%","d":"up"},{"l":"Savings (€)","v":"€81581","t":"+4.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.5%","t":"+2.7%","d":"up"},{"l":"Ciclos PDCA","v":"3.105","t":"+9.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.314","€ 12171.30","4.919","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.373","€ 15926.27","4.945","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.001","€ 7952.61","5.651","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.759","€ 41014.74","1.321","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.196","€ 9374.07","8.403","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":453},{"label":"Mar","value":363},{"label":"Abr","value":511},{"label":"Mai","value":695},{"label":"Jun","value":314},{"label":"Jul","value":641},{"label":"Ago","value":578},{"label":"Set","value":449},{"label":"Out","value":566},{"label":"Nov","value":360},{"label":"Dez","value":671}];
const MX = 695;
