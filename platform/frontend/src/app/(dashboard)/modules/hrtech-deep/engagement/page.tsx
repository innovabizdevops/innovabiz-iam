...
const KPIS = [{"l":"eNPS","v":"71","t":"-0.2%","d":"down"},{"l":"Engagement (%)","v":"79.3%","t":"+4.6%","d":"up"},{"l":"Turnover (%)","v":"85.1%","t":"+11.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.385","t":"-5.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.714","2026-03-22","62","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.167","2026-03-21","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.291","2026-01-11","66","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.732","2026-02-28","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.844","2026-01-28","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":464},{"label":"Mar","value":487},{"label":"Abr","value":673},{"label":"Mai","value":670},{"label":"Jun","value":597},{"label":"Jul","value":702},{"label":"Ago","value":405},{"label":"Set","value":552},{"label":"Out","value":458},{"label":"Nov","value":696},{"label":"Dez","value":472}];
const MX = 702;
