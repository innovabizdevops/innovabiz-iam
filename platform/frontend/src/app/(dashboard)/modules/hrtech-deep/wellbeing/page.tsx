...
const KPIS = [{"l":"eNPS","v":"63","t":"-4.0%","d":"down"},{"l":"Engagement (%)","v":"90.3%","t":"+17.3%","d":"up"},{"l":"Turnover (%)","v":"72.8%","t":"+15.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.026","t":"+7.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.621","2026-02-09","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.387","2026-03-20","85","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.029","2026-01-10","61","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.398","2026-02-25","82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.011","2026-01-13","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":769},{"label":"Mar","value":925},{"label":"Abr","value":922},{"label":"Mai","value":632},{"label":"Jun","value":861},{"label":"Jul","value":910},{"label":"Ago","value":846},{"label":"Set","value":692},{"label":"Out","value":716},{"label":"Nov","value":781},{"label":"Dez","value":978}];
const MX = 978;
