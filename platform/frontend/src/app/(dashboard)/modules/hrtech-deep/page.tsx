...
/* ═══ HRTech Deep (Gartner) — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "3244", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4197", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€20K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1322979744", cells: ["HRT-7744", "HRTech Deep (Gartner) Item 1", "17/1/2026", "€29 844"], status: "active" as const },
    { id: "1322983315", cells: ["HRT-2315", "HRTech Deep (Gartner) Item 2", "4/8/2026", "€33 415"], status: "pending" as const },
    { id: "1322986886", cells: ["HRT-5886", "HRTech Deep (Gartner) Item 3", "19/3/2026", "€36 986"], status: "completed" as const },
    { id: "1322990457", cells: ["HRT-9457", "HRTech Deep (Gartner) Item 4", "6/10/2026", "€40 557"], status: "warning" as const },
    { id: "1322994028", cells: ["HRT-4028", "HRTech Deep (Gartner) Item 5", "21/5/2026", "€44 128"], status: "active" as const },
];
...
export default function HrtechDeepGartnerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HRTech Deep (Gartner)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HRTech Deep (Gartner)</p>
                    </div>
                </div>
