...
const ACCENT = "#7c3aed";
const MODULE = "HRTech Deep (Gartner)";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.246","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"1567","t":"-5.1%","d":"down"},{"l":"Dados Processados (GB)","v":"721","t":"-5.4%","d":"down"},{"l":"Utilizadores Analytics","v":"7.378","t":"+9.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4880","2026-03-17","3.094","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2764","2026-02-11","3.874","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2611","2026-01-13","3.916","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","379","2026-03-20","2.010","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1933","2026-01-13","350","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":596},{"label":"Mar","value":718},{"label":"Abr","value":580},{"label":"Mai","value":638},{"label":"Jun","value":557},{"label":"Jul","value":427},{"label":"Ago","value":430},{"label":"Set","value":631},{"label":"Out","value":588},{"label":"Nov","value":482},{"label":"Dez","value":609}];
const MX = 718;
