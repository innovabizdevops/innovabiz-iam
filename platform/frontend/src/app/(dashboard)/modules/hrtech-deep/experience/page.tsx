...
const KPIS = [{"l":"Perfis Unificados","v":"4.348","t":"-5.7%","d":"down"},{"l":"Segmentos Ativos","v":"3.129","t":"-0.8%","d":"down"},{"l":"NPS Score","v":"88","t":"+11.8%","d":"up"},{"l":"Churn Previsto (%)","v":"73.6%","t":"+4.2%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.541","€ 40183.10","85.9%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.851","€ 19857.47","99.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.229","€ 40969.15","97.6%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.515","€ 1890.07","77.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","6.188","€ 14043.07","72.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":530},{"label":"Mar","value":623},{"label":"Abr","value":682},{"label":"Mai","value":362},{"label":"Jun","value":378},{"label":"Jul","value":615},{"label":"Ago","value":362},{"label":"Set","value":494},{"label":"Out","value":560},{"label":"Nov","value":509},{"label":"Dez","value":485}];
const MX = 682;
