...
const KPIS = [{"l":"ARR (€M)","v":"€25.5M","t":"+1.5%","d":"up"},{"l":"MRR (€)","v":"€24453","t":"+17.6%","d":"up"},{"l":"Churn (%)","v":"77.4%","t":"+17.3%","d":"up"},{"l":"ARPU (€)","v":"€82459","t":"+5.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 31337.37","3.018","€ 9325.33","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22697.86","8.865","€ 27255.70","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 16204.10","3.670","€ 2860.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4569.06","2.927","€ 30881.65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35831.60","6.571","€ 9958.50","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":957},{"label":"Mar","value":718},{"label":"Abr","value":942},{"label":"Mai","value":581},{"label":"Jun","value":631},{"label":"Jul","value":880},{"label":"Ago","value":675},{"label":"Set","value":626},{"label":"Out","value":827},{"label":"Nov","value":960},{"label":"Dez","value":830}];
const MX = 966;
