...
const ACCENT = "#b45309";
const MODULE = "Tax Engine";
const PAGE = "Digital Tax SAF-T";
const KPIS = [{"l":"Total Tax Engine","v":"2.305","t":"+17.5%","d":"up"},{"l":"Digital Tax SAF T Ativos","v":"4.381","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"86.0%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"68","t":"+12.8%","d":"up"}];
const COLS = ["ID","Digital Tax SAF T","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Engine #001","Tax Engine #002","5.493","1.760","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Engine #002","Tax Engine #003","6.268","8.665","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Engine #003","Tax Engine #004","3.344","4.553","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Engine #004","Tax Engine #005","2.551","1.848","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Engine #005","Tax Engine #001","7.627","7.716","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":850},{"label":"Mar","value":651},{"label":"Abr","value":947},{"label":"Mai","value":571},{"label":"Jun","value":603},{"label":"Jul","value":700},{"label":"Ago","value":939},{"label":"Set","value":762},{"label":"Out","value":778},{"label":"Nov","value":959},{"label":"Dez","value":951}];
const MX = 959;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>SAF-T</span></h1>
                </div>
