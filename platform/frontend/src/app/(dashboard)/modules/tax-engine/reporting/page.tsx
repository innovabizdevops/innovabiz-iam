...
const KPIS = [{"l":"Total Tax Engine","v":"3.633","t":"+9.9%","d":"up"},{"l":"Tax Reporting Ativos","v":"6.455","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"84","t":"+1.7%","d":"up"}];
const COLS = ["ID","Tax Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Engine #001","Tax Engine #002","7.780","7.956","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Engine #002","Tax Engine #003","8.997","4.485","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Engine #003","Tax Engine #004","8.803","5.175","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Engine #004","Tax Engine #005","2.000","359","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Engine #005","Tax Engine #001","6.334","268","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":1006},{"label":"Mar","value":871},{"label":"Abr","value":629},{"label":"Mai","value":927},{"label":"Jun","value":828},{"label":"Jul","value":785},{"label":"Ago","value":800},{"label":"Set","value":893},{"label":"Out","value":934},{"label":"Nov","value":822},{"label":"Dez","value":715}];
const MX = 1006;
