...
const ACCENT = "#6d28d9";
const MODULE = "Religious Media";
const PAGE = "Broadcast";
const KPIS = [{"l":"Integrações Ativas","v":"6.661","t":"-0.7%","d":"down"},{"l":"Chamadas/Hora","v":"1168","t":"+2.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.7%","t":"+14.0%","d":"up"},{"l":"Latência Média (ms)","v":"13ms","t":"+2.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.206","890","85.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.299","6.283","81.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.759","520","90.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.727","5.511","81.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.968","3.353","77.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":814},{"label":"Mar","value":1002},{"label":"Abr","value":727},{"label":"Mai","value":865},{"label":"Jun","value":768},{"label":"Jul","value":623},{"label":"Ago","value":726},{"label":"Set","value":687},{"label":"Out","value":794},{"label":"Nov","value":958},{"label":"Dez","value":984}];
const MX = 1002;
