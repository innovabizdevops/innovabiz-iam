...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€13.0M","t":"+3.1%","d":"up"},{"l":"MRR (€)","v":"€96325","t":"-3.5%","d":"down"},{"l":"Churn (%)","v":"94.4%","t":"+13.1%","d":"up"},{"l":"ARPU (€)","v":"€2566","t":"-5.7%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 43244.97","5.707","€ 19662.14","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 39494.57","6.093","€ 47140.38","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42259.98","7.271","€ 6743.39","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 8992.53","4.057","€ 12953.04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37490.97","2.380","€ 14770.56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":426},{"label":"Mar","value":366},{"label":"Abr","value":475},{"label":"Mai","value":426},{"label":"Jun","value":378},{"label":"Jul","value":418},{"label":"Ago","value":433},{"label":"Set","value":571},{"label":"Out","value":535},{"label":"Nov","value":649},{"label":"Dez","value":640}];
const MX = 649;
