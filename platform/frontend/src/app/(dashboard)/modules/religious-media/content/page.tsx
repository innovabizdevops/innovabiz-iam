...
const PAGE = "Content";
const KPIS = [{"l":"Integrações Ativas","v":"3.650","t":"+16.4%","d":"up"},{"l":"Chamadas/Hora","v":"3551","t":"-1.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"67.1%","t":"+0.9%","d":"up"},{"l":"Latência Média (ms)","v":"119ms","t":"+13.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.319","2.193","80.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.732","5.690","78.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.165","6.017","78.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.278","7.559","80.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.980","2.714","72.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":650},{"label":"Mar","value":744},{"label":"Abr","value":715},{"label":"Mai","value":812},{"label":"Jun","value":701},{"label":"Jul","value":768},{"label":"Ago","value":930},{"label":"Set","value":715},{"label":"Out","value":788},{"label":"Nov","value":722},{"label":"Dez","value":1016}];
const MX = 1016;
