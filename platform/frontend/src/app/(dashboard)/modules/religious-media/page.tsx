...
/* ═══ Religious Media — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "1381", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4328", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€455K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "64410681", cells: ["REL-7681", "Religious Media Item 1", "14/10/2026", "€10 781"], status: "active" as const },
    { id: "64414252", cells: ["REL-2252", "Religious Media Item 2", "1/5/2026", "€14 352"], status: "pending" as const },
    { id: "64417823", cells: ["REL-5823", "Religious Media Item 3", "16/12/2026", "€17 923"], status: "completed" as const },
    { id: "64421394", cells: ["REL-9394", "Religious Media Item 4", "3/7/2026", "€21 494"], status: "warning" as const },
    { id: "64424965", cells: ["REL-3965", "Religious Media Item 5", "18/2/2026", "€25 065"], status: "active" as const },
];
...
export default function ReligiousMediaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Religious Media</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Religious Media</p>
                    </div>
                </div>
