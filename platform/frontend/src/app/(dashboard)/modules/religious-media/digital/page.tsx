...
const PAGE = "Digital";
const KPIS = [{"l":"Integrações Ativas","v":"8.430","t":"+1.5%","d":"up"},{"l":"Chamadas/Hora","v":"2653","t":"-4.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"77.3%","t":"+13.2%","d":"up"},{"l":"Latência Média (ms)","v":"181ms","t":"+15.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.861","8.199","88.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.754","5.066","80.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","145","7.577","94.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.250","5.383","75.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.430","5.954","88.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":591},{"label":"Mar","value":443},{"label":"Abr","value":553},{"label":"Mai","value":417},{"label":"Jun","value":697},{"label":"Jul","value":563},{"label":"Ago","value":430},{"label":"Set","value":629},{"label":"Out","value":574},{"label":"Nov","value":517},{"label":"Dez","value":791}];
const MX = 791;
