...
const KPIS = [{"l":"Integrações Ativas","v":"814","t":"+14.2%","d":"up"},{"l":"Chamadas/Hora","v":"762","t":"+5.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.8%","t":"+8.3%","d":"up"},{"l":"Latência Média (ms)","v":"15ms","t":"-4.1%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.870","5.425","96.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.808","685","90.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.162","7.685","71.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","332","5.894","90.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","518","5.418","87.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":630},{"label":"Mar","value":652},{"label":"Abr","value":360},{"label":"Mai","value":367},{"label":"Jun","value":420},{"label":"Jul","value":453},{"label":"Ago","value":482},{"label":"Set","value":301},{"label":"Out","value":661},{"label":"Nov","value":474},{"label":"Dez","value":637}];
const MX = 661;
