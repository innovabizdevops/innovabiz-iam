...
const PAGE = "Thermal";
const KPIS = [{"l":"Riscos Identificados","v":"8.364","t":"+12.0%","d":"up"},{"l":"Mitigações Ativas","v":"1.942","t":"+9.4%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"+12.5%","d":"up"},{"l":"Incidentes YTD","v":"8.883","t":"+4.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","818","7.172","8.749","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.381","1.008","7.121","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.283","3.583","1.975","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.994","702","8.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.007","3.891","3.720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":596},{"label":"Mar","value":552},{"label":"Abr","value":711},{"label":"Mai","value":460},{"label":"Jun","value":595},{"label":"Jul","value":617},{"label":"Ago","value":513},{"label":"Set","value":552},{"label":"Out","value":723},{"label":"Nov","value":609},{"label":"Dez","value":463}];
const MX = 723;
