...
const ACCENT = "#6366f1";
const MODULE = "Battery Storage";
const PAGE = "BMS";
const KPIS = [{"l":"Total Battery Storage","v":"6.085","t":"-3.4%","d":"down"},{"l":"BMS Ativos","v":"3.845","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"91.6%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"87","t":"+14.4%","d":"up"}];
const COLS = ["ID","BMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Battery Storage #001","Battery Storage #002","3.592","3.440","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Battery Storage #002","Battery Storage #003","4.009","1.079","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Battery Storage #003","Battery Storage #004","2.871","7.241","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Battery Storage #004","Battery Storage #005","1.841","6.669","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Battery Storage #005","Battery Storage #001","2.021","8.576","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":545},{"label":"Mar","value":286},{"label":"Abr","value":570},{"label":"Mai","value":441},{"label":"Jun","value":605},{"label":"Jul","value":594},{"label":"Ago","value":396},{"label":"Set","value":316},{"label":"Out","value":486},{"label":"Nov","value":476},{"label":"Dez","value":390}];
const MX = 605;
