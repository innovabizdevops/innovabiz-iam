...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.275","t":"+4.5%","d":"up"},{"l":"Submissões/Dia","v":"4667","t":"+16.6%","d":"up"},{"l":"Documentos Gerados","v":"5.122","t":"+14.7%","d":"up"},{"l":"Templates","v":"561","t":"-1.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.974","2026-02-05","8.574","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.807","2026-02-03","8.015","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","604","2026-01-13","5.456","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.787","2026-02-18","7.928","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.535","2026-02-14","1.213","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":441},{"label":"Mar","value":478},{"label":"Abr","value":540},{"label":"Mai","value":418},{"label":"Jun","value":548},{"label":"Jul","value":425},{"label":"Ago","value":505},{"label":"Set","value":531},{"label":"Out","value":394},{"label":"Nov","value":517},{"label":"Dez","value":443}];
const MX = 563;
