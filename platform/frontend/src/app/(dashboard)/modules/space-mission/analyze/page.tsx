...
const ACCENT = "#1e3a5f";
const MODULE = "Space Mission Management";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"4.019","t":"+11.3%","d":"up"},{"l":"Queries/Dia","v":"4215","t":"+2.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.487","t":"-3.2%","d":"down"},{"l":"Utilizadores Analytics","v":"4.977","t":"+5.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3056","2026-02-15","7.883","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4721","2026-03-15","9.014","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3312","2026-01-17","1.228","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3251","2026-01-18","7.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4646","2026-03-16","6.274","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":382},{"label":"Mar","value":581},{"label":"Abr","value":435},{"label":"Mai","value":394},{"label":"Jun","value":329},{"label":"Jul","value":328},{"label":"Ago","value":329},{"label":"Set","value":513},{"label":"Out","value":289},{"label":"Nov","value":296},{"label":"Dez","value":569}];
const MX = 581;
