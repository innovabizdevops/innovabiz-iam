...
/* ═══ Space Mission Management — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "1232", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1766", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€265K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "964340332", cells: ["SPA-9332", "Space Mission Management Item 1", "5/5/2026", "€40 432"], status: "active" as const },
    { id: "964343903", cells: ["SPA-3903", "Space Mission Management Item 2", "20/12/2026", "€44 003"], status: "pending" as const },
    { id: "964347474", cells: ["SPA-7474", "Space Mission Management Item 3", "7/7/2026", "€47 574"], status: "completed" as const },
    { id: "964351045", cells: ["SPA-2045", "Space Mission Management Item 4", "22/2/2026", "€1145"], status: "warning" as const },
    { id: "964354616", cells: ["SPA-5616", "Space Mission Management Item 5", "9/9/2026", "€4716"], status: "active" as const },
];
...
export default function SpaceMissionManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Space Mission Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Space Mission Management</p>
                    </div>
                </div>
