...
const PAGE = "Plan";
const KPIS = [{"l":"Quartos Ocupados","v":"7.006","t":"+16.6%","d":"up"},{"l":"RevPAR (€)","v":"€15565","t":"+15.2%","d":"up"},{"l":"Ocupação (%)","v":"90.7%","t":"+11.9%","d":"up"},{"l":"Guest Satisfaction","v":"8.798","t":"+16.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.914","2026-02-18","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.118","2026-01-16","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.547","2026-02-11","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.428","2026-02-20","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.408","2026-02-02","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":762},{"label":"Mar","value":929},{"label":"Abr","value":668},{"label":"Mai","value":599},{"label":"Jun","value":701},{"label":"Jul","value":610},{"label":"Ago","value":858},{"label":"Set","value":689},{"label":"Out","value":782},{"label":"Nov","value":862},{"label":"Dez","value":925}];
const MX = 929;
