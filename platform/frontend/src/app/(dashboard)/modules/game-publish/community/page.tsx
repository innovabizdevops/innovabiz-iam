...
const ACCENT = "#6366f1";
const MODULE = "Game Publishing";
const PAGE = "Community";
const KPIS = [{"l":"Projetos Sociais","v":"6.277","t":"+1.2%","d":"up"},{"l":"Beneficiários","v":"8.428","t":"+15.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€71491","t":"+11.3%","d":"up"},{"l":"Score Impacto","v":"67","t":"+17.7%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","3.634","€ 22396.59","8.315","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.531","€ 31046.84","2.124","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.477","€ 34386.32","262","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.003","€ 28917.90","923","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.715","€ 29820.84","6.365","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":653},{"label":"Mar","value":734},{"label":"Abr","value":385},{"label":"Mai","value":433},{"label":"Jun","value":606},{"label":"Jul","value":492},{"label":"Ago","value":531},{"label":"Set","value":654},{"label":"Out","value":751},{"label":"Nov","value":489},{"label":"Dez","value":725}];
const MX = 751;
