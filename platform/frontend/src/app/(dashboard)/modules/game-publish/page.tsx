...
export default function GamePublishPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Game Publish</h1><p className="text-sm text-muted-foreground">Game Publish • iBOS Enterprise</p></div>
