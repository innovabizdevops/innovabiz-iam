...
const PAGE = "QA Test";
const KPIS = [{"l":"Total Game Publish","v":"1.180","t":"+12.4%","d":"up"},{"l":"QA Test Ativos","v":"3.236","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"75","t":"+3.3%","d":"up"}];
const COLS = ["ID","QA Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Publish #001","Game Publish #002","6.584","2.719","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Game Publish #002","Game Publish #003","371","2.548","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Publish #003","Game Publish #004","374","8.103","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Game Publish #004","Game Publish #005","5.237","1.991","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Publish #005","Game Publish #001","3.334","5.227","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":329},{"label":"Fev","value":442},{"label":"Mar","value":547},{"label":"Abr","value":451},{"label":"Mai","value":345},{"label":"Jun","value":668},{"label":"Jul","value":416},{"label":"Ago","value":353},{"label":"Set","value":657},{"label":"Out","value":455},{"label":"Nov","value":349},{"label":"Dez","value":499}];
const MX = 668;
