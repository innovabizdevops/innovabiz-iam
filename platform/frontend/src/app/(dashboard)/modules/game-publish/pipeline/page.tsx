...
const PAGE = "Pipeline";
const KPIS = [{"l":"Total Game Publish","v":"1.621","t":"+14.5%","d":"up"},{"l":"Pipeline Ativos","v":"4.673","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"75","t":"+12.6%","d":"up"}];
const COLS = ["ID","Pipeline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Publish #001","Game Publish #002","2.385","5.659","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Game Publish #002","Game Publish #003","8.085","8.525","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Publish #003","Game Publish #004","8.806","5.405","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Game Publish #004","Game Publish #005","2.121","7.817","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Publish #005","Game Publish #001","208","3.481","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":721},{"label":"Mar","value":862},{"label":"Abr","value":1043},{"label":"Mai","value":677},{"label":"Jun","value":857},{"label":"Jul","value":811},{"label":"Ago","value":669},{"label":"Set","value":952},{"label":"Out","value":825},{"label":"Nov","value":1058},{"label":"Dez","value":924}];
const MX = 1058;
