...
const PAGE = "Monetize";
const KPIS = [{"l":"ARR (€M)","v":"€2.7M","t":"+11.7%","d":"up"},{"l":"MRR (€)","v":"€5152","t":"-0.7%","d":"down"},{"l":"Churn (%)","v":"88.1%","t":"-0.1%","d":"down"},{"l":"ARPU (€)","v":"€57899","t":"+0.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 14495.10","5.748","€ 40612.53","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 29062.38","720","€ 4462.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17583.89","2.135","€ 8490.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 32553.27","1.695","€ 38780.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8410.08","1.631","€ 5232.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":836},{"label":"Mar","value":850},{"label":"Abr","value":792},{"label":"Mai","value":519},{"label":"Jun","value":625},{"label":"Jul","value":656},{"label":"Ago","value":750},{"label":"Set","value":780},{"label":"Out","value":788},{"label":"Nov","value":487},{"label":"Dez","value":826}];
const MX = 850;
