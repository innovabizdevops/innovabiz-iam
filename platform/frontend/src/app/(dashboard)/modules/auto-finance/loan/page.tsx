...
const PAGE = "Loan";
const KPIS = [{"l":"Total Auto Finance","v":"6.050","t":"-2.6%","d":"down"},{"l":"Loan Ativos","v":"1.720","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+4.0%","d":"up"}];
const COLS = ["ID","Loan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Finance #001","Auto Finance #002","7.027","1.862","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Finance #002","Auto Finance #003","6.664","7.691","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Finance #003","Auto Finance #004","9.097","3.413","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Finance #004","Auto Finance #005","1.588","2.157","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Finance #005","Auto Finance #001","6.248","5.745","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":645},{"label":"Mar","value":689},{"label":"Abr","value":940},{"label":"Mai","value":720},{"label":"Jun","value":924},{"label":"Jul","value":554},{"label":"Ago","value":707},{"label":"Set","value":550},{"label":"Out","value":754},{"label":"Nov","value":777},{"label":"Dez","value":594}];
const MX = 940;
