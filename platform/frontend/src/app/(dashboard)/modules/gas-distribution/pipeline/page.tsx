...
const PAGE = "Pipeline Map";
const KPIS = [{"l":"Total Gas Distribution","v":"3.872","t":"+5.2%","d":"up"},{"l":"Pipeline Map Ativos","v":"769","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"78","t":"-0.2%","d":"down"}];
const COLS = ["ID","Pipeline Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Distribution #001","Gas Distribution #002","7.184","8.728","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Distribution #002","Gas Distribution #003","4.812","4.335","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Distribution #003","Gas Distribution #004","5.491","718","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Distribution #004","Gas Distribution #005","7.357","1.840","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Distribution #005","Gas Distribution #001","2.597","8.874","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":286},{"label":"Fev","value":258},{"label":"Mar","value":295},{"label":"Abr","value":623},{"label":"Mai","value":307},{"label":"Jun","value":380},{"label":"Jul","value":316},{"label":"Ago","value":340},{"label":"Set","value":260},{"label":"Out","value":394},{"label":"Nov","value":355},{"label":"Dez","value":403}];
const MX = 623;
