...
const PAGE = "Billing";
const KPIS = [{"l":"Total Gas Distribution","v":"1.406","t":"+3.8%","d":"up"},{"l":"Billing Ativos","v":"4.980","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"81","t":"-2.5%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Distribution #001","Gas Distribution #002","8.490","6.354","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Distribution #002","Gas Distribution #003","3.611","6.250","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Distribution #003","Gas Distribution #004","2.591","8.494","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Distribution #004","Gas Distribution #005","319","1.924","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Distribution #005","Gas Distribution #001","961","3.333","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":771},{"label":"Mar","value":693},{"label":"Abr","value":632},{"label":"Mai","value":750},{"label":"Jun","value":698},{"label":"Jul","value":582},{"label":"Ago","value":764},{"label":"Set","value":426},{"label":"Out","value":514},{"label":"Nov","value":501},{"label":"Dez","value":619}];
const MX = 771;
