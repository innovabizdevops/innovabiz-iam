...
const PAGE = "Pressure Mon";
const KPIS = [{"l":"Total Gas Distribution","v":"2.764","t":"-5.3%","d":"down"},{"l":"Pressure Mon Ativos","v":"363","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"92.9%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"72","t":"-1.2%","d":"down"}];
const COLS = ["ID","Pressure Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gas Distribution #001","Gas Distribution #002","5.384","5.191","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Gas Distribution #002","Gas Distribution #003","4.590","4.374","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Gas Distribution #003","Gas Distribution #004","4.498","7.426","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Gas Distribution #004","Gas Distribution #005","5.201","7.510","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gas Distribution #005","Gas Distribution #001","882","287","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":772},{"label":"Mar","value":692},{"label":"Abr","value":786},{"label":"Mai","value":551},{"label":"Jun","value":675},{"label":"Jul","value":510},{"label":"Ago","value":542},{"label":"Set","value":550},{"label":"Out","value":891},{"label":"Nov","value":706},{"label":"Dez","value":523}];
const MX = 891;
