...
const PAGE = "Leak Survey";
const KPIS = [{"l":"Surveys Ativos","v":"558","t":"+5.3%","d":"up"},{"l":"Respostas/Semana","v":"2044","t":"+15.5%","d":"up"},{"l":"NPS Médio","v":"67","t":"-0.6%","d":"down"},{"l":"Taxa Resposta (%)","v":"88.1%","t":"+13.1%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","8.783","86","90.7%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.233","86","85.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","296","68","90.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","1.743","65","92.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","2.847","74","96.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":921},{"label":"Fev","value":943},{"label":"Mar","value":704},{"label":"Abr","value":945},{"label":"Mai","value":713},{"label":"Jun","value":628},{"label":"Jul","value":897},{"label":"Ago","value":872},{"label":"Set","value":618},{"label":"Out","value":695},{"label":"Nov","value":617},{"label":"Dez","value":631}];
const MX = 945;
