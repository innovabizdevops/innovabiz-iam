...
const PAGE = "Satellite Tracking";
const KPIS = [{"l":"Quartos Ocupados","v":"8.490","t":"+1.4%","d":"up"},{"l":"RevPAR (€)","v":"€68244","t":"+14.0%","d":"up"},{"l":"Ocupação (%)","v":"80.8%","t":"+9.2%","d":"up"},{"l":"Guest Satisfaction","v":"6.089","t":"-5.4%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.218","2026-03-10","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","141","2026-01-17","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.093","2026-02-20","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.123","2026-03-14","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.082","2026-03-04","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":838},{"label":"Mar","value":557},{"label":"Abr","value":553},{"label":"Mai","value":714},{"label":"Jun","value":484},{"label":"Jul","value":594},{"label":"Ago","value":615},{"label":"Set","value":721},{"label":"Out","value":545},{"label":"Nov","value":780},{"label":"Dez","value":635}];
const MX = 838;
