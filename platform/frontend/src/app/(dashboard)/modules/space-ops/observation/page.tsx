...
const PAGE = "Earth Observation";
const KPIS = [{"l":"Quartos Ocupados","v":"8.608","t":"+0.9%","d":"up"},{"l":"RevPAR (€)","v":"€44914","t":"-1.0%","d":"down"},{"l":"Ocupação (%)","v":"89.3%","t":"-0.2%","d":"down"},{"l":"Guest Satisfaction","v":"3.375","t":"+3.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.561","2026-03-03","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.506","2026-03-10","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.454","2026-03-17","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.240","2026-03-11","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.505","2026-03-09","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":611},{"label":"Mar","value":515},{"label":"Abr","value":696},{"label":"Mai","value":485},{"label":"Jun","value":415},{"label":"Jul","value":743},{"label":"Ago","value":461},{"label":"Set","value":552},{"label":"Out","value":777},{"label":"Nov","value":743},{"label":"Dez","value":606}];
const MX = 777;
