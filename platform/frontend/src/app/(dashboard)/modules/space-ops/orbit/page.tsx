...
const ACCENT = "#4338ca";
const MODULE = "Space & Satellite";
const PAGE = "Orbit Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"165","t":"+2.2%","d":"up"},{"l":"Queries/Dia","v":"3998","t":"+14.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.375","t":"-0.5%","d":"down"},{"l":"Utilizadores Analytics","v":"7.958","t":"+0.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4634","2026-02-01","1.401","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","497","2026-01-22","5.569","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1419","2026-01-08","8.839","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1791","2026-02-23","7.818","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3211","2026-01-23","4.212","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":749},{"label":"Mar","value":719},{"label":"Abr","value":990},{"label":"Mai","value":816},{"label":"Jun","value":804},{"label":"Jul","value":754},{"label":"Ago","value":628},{"label":"Set","value":986},{"label":"Out","value":979},{"label":"Nov","value":826},{"label":"Dez","value":656}];
const MX = 990;
