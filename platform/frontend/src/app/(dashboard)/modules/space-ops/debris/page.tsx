...
const PAGE = "Space Debris";
const KPIS = [{"l":"Quartos Ocupados","v":"139","t":"+1.9%","d":"up"},{"l":"RevPAR (€)","v":"€77332","t":"+11.7%","d":"up"},{"l":"Ocupação (%)","v":"74.6%","t":"+7.2%","d":"up"},{"l":"Guest Satisfaction","v":"7.950","t":"-1.9%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","945","2026-03-20","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.391","2026-03-25","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.446","2026-03-06","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.868","2026-01-05","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.596","2026-01-27","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":806},{"label":"Mar","value":819},{"label":"Abr","value":785},{"label":"Mai","value":717},{"label":"Jun","value":682},{"label":"Jul","value":834},{"label":"Ago","value":742},{"label":"Set","value":699},{"label":"Out","value":786},{"label":"Nov","value":823},{"label":"Dez","value":753}];
const MX = 834;
