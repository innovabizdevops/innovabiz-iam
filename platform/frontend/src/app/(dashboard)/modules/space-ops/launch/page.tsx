...
const PAGE = "Launch Services";
const KPIS = [{"l":"Quartos Ocupados","v":"1.866","t":"+4.6%","d":"up"},{"l":"RevPAR (€)","v":"€3386","t":"-2.6%","d":"down"},{"l":"Ocupação (%)","v":"67.7%","t":"-3.3%","d":"down"},{"l":"Guest Satisfaction","v":"7.162","t":"+5.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.418","2026-01-27","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.435","2026-01-02","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.962","2026-01-27","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.281","2026-01-22","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.032","2026-01-05","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":487},{"label":"Mar","value":623},{"label":"Abr","value":535},{"label":"Mai","value":536},{"label":"Jun","value":246},{"label":"Jul","value":515},{"label":"Ago","value":378},{"label":"Set","value":558},{"label":"Out","value":567},{"label":"Nov","value":476},{"label":"Dez","value":328}];
const MX = 623;
