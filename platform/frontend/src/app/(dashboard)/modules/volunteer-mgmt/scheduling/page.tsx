...
const KPIS = [{"l":"eNPS","v":"62","t":"+6.2%","d":"up"},{"l":"Engagement (%)","v":"83.0%","t":"+10.5%","d":"up"},{"l":"Turnover (%)","v":"79.3%","t":"+10.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.972","t":"-5.5%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.399","2026-03-18","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.947","2026-03-27","84","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.380","2026-03-04","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.316","2026-01-15","94","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.212","2026-01-19","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":557},{"label":"Mar","value":560},{"label":"Abr","value":485},{"label":"Mai","value":709},{"label":"Jun","value":520},{"label":"Jul","value":724},{"label":"Ago","value":776},{"label":"Set","value":598},{"label":"Out","value":651},{"label":"Nov","value":711},{"label":"Dez","value":546}];
const MX = 776;
