...
const PAGE = "Check-In";
const KPIS = [{"l":"Projetos Sociais","v":"4.732","t":"+5.0%","d":"up"},{"l":"Beneficiários","v":"8.577","t":"+1.6%","d":"up"},{"l":"Investimento CSR (€)","v":"€44883","t":"+1.2%","d":"up"},{"l":"Score Impacto","v":"58","t":"+17.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.980","€ 11932.27","7.212","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","426","€ 22416.70","6.642","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","539","€ 19082.45","703","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","793","€ 44700.84","4.736","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.977","€ 5640.68","2.955","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1032},{"label":"Fev","value":1033},{"label":"Mar","value":1034},{"label":"Abr","value":715},{"label":"Mai","value":1032},{"label":"Jun","value":1033},{"label":"Jul","value":1053},{"label":"Ago","value":1037},{"label":"Set","value":957},{"label":"Out","value":856},{"label":"Nov","value":746},{"label":"Dez","value":976}];
const MX = 1053;
