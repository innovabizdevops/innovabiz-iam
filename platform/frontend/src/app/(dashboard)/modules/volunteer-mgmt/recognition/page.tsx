...
const KPIS = [{"l":"Projetos Sociais","v":"150","t":"+8.9%","d":"up"},{"l":"Beneficiários","v":"4.610","t":"+9.0%","d":"up"},{"l":"Investimento CSR (€)","v":"€99142","t":"+2.7%","d":"up"},{"l":"Score Impacto","v":"61","t":"+4.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.742","€ 22512.21","7.807","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.397","€ 33581.89","5.017","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.127","€ 6575.67","353","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.298","€ 33687.33","3.642","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.970","€ 22483.79","285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":542},{"label":"Mar","value":856},{"label":"Abr","value":679},{"label":"Mai","value":855},{"label":"Jun","value":889},{"label":"Jul","value":543},{"label":"Ago","value":865},{"label":"Set","value":681},{"label":"Out","value":617},{"label":"Nov","value":882},{"label":"Dez","value":720}];
const MX = 889;
