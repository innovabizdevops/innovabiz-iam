...
const ACCENT = "#dc2626";
const MODULE = "Volunteer Management";
const PAGE = "Hours Track";
const KPIS = [{"l":"Projetos Sociais","v":"5.420","t":"+12.1%","d":"up"},{"l":"Beneficiários","v":"3.654","t":"-3.6%","d":"down"},{"l":"Investimento CSR (€)","v":"€79289","t":"+10.0%","d":"up"},{"l":"Score Impacto","v":"55","t":"-3.5%","d":"down"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.880","€ 37126.13","4.034","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.412","€ 27527.21","1.582","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.657","€ 26488.32","5.716","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.572","€ 22644.82","380","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.297","€ 42977.97","2.140","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":427},{"label":"Fev","value":517},{"label":"Mar","value":295},{"label":"Abr","value":512},{"label":"Mai","value":295},{"label":"Jun","value":482},{"label":"Jul","value":460},{"label":"Ago","value":331},{"label":"Set","value":499},{"label":"Out","value":494},{"label":"Nov","value":432},{"label":"Dez","value":335}];
const MX = 517;
