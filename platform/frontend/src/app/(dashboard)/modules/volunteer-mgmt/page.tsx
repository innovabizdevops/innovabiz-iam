...
export default function VolunteerMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Volunteer Mgmt</h1><p className="text-sm text-muted-foreground">Volunteer Mgmt • iBOS Enterprise</p></div>
