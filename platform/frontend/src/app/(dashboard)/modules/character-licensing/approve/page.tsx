...
const PAGE = "Approve";
const KPIS = [{"l":"Aprovações Pendentes","v":"1.296","t":"+11.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.1%","t":"+7.2%","d":"up"},{"l":"Tempo Médio (h)","v":"19h","t":"+15.7%","d":"up"},{"l":"Rejeitadas (%)","v":"85.6%","t":"+10.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.058","€ 32576.63","1.368","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.471","€ 387.33","6.091","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.181","€ 18214.53","5.964","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.684","€ 28724.08","785","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","897","€ 44817.44","5.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":312},{"label":"Mar","value":402},{"label":"Abr","value":696},{"label":"Mai","value":677},{"label":"Jun","value":421},{"label":"Jul","value":403},{"label":"Ago","value":425},{"label":"Set","value":466},{"label":"Out","value":550},{"label":"Nov","value":683},{"label":"Dez","value":477}];
const MX = 696;
