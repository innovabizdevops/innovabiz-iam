...
/* ═══ Character Licensing — Dashboard ═══ */

const ACCENT = "#bfdbfe";

const KPIS = [
    { label: "Total Registos", value: "7359", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2414", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€175K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1008965759", cells: ["CHA-3759", "Character Licensing Item 1", "12/12/2026", "€15 859"], status: "active" as const },
    { id: "1008969330", cells: ["CHA-7330", "Character Licensing Item 2", "27/7/2026", "€19 430"], status: "pending" as const },
    { id: "1008972901", cells: ["CHA-1901", "Character Licensing Item 3", "14/2/2026", "€23 001"], status: "completed" as const },
    { id: "1008976472", cells: ["CHA-5472", "Character Licensing Item 4", "1/9/2026", "€26 572"], status: "warning" as const },
    { id: "1008980043", cells: ["CHA-9043", "Character Licensing Item 5", "16/4/2026", "€30 143"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Character Licensing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Character Licensing</p>
                    </div>
                </div>
