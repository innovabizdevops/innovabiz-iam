...
/* ═══ Green Burial — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "7874", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4877", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€266K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1613123674", cells: ["GRE-9674", "Green Burial Item 1", "23/11/2026", "€23 774"], status: "active" as const },
    { id: "1613127245", cells: ["GRE-4245", "Green Burial Item 2", "10/6/2026", "€27 345"], status: "pending" as const },
    { id: "1613130816", cells: ["GRE-7816", "Green Burial Item 3", "25/1/2026", "€30 916"], status: "completed" as const },
    { id: "1613134387", cells: ["GRE-2387", "Green Burial Item 4", "12/8/2026", "€34 487"], status: "warning" as const },
    { id: "1613137958", cells: ["GRE-5958", "Green Burial Item 5", "27/3/2026", "€38 058"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Green Burial</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Green Burial</p>
                    </div>
                </div>
