...
/* ═══ Food Manufacturing Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "8330", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1292", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€385K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "256101430", cells: ["FOO-7430", "Food Manufacturing Platform Item 1", "19/11/2026", "€1530"], status: "active" as const },
    { id: "256105001", cells: ["FOO-2001", "Food Manufacturing Platform Item 2", "6/6/2026", "€5101"], status: "pending" as const },
    { id: "256108572", cells: ["FOO-5572", "Food Manufacturing Platform Item 3", "21/1/2026", "€8672"], status: "completed" as const },
    { id: "256112143", cells: ["FOO-9143", "Food Manufacturing Platform Item 4", "8/8/2026", "€12 243"], status: "warning" as const },
    { id: "256115714", cells: ["FOO-3714", "Food Manufacturing Platform Item 5", "23/3/2026", "€15 814"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 90 }, { label: "Fev", value: 99 }, { label: "Mar", value: 28 }, { label: "Abr", value: 37 }, { label: "Mai", value: 46 }, { label: "Jun", value: 55 }];
...
export default function FoodManufacturingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Manufacturing Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Food Manufacturing Platform</p>
                    </div>
                </div>
