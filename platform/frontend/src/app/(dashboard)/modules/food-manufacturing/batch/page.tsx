...
const ACCENT = "#166534";
const MODULE = "Food Manufacturing Platform";
const PAGE = "Batch";
const KPIS = [{"l":"Total Food Manufacturing","v":"1.562","t":"-0.5%","d":"down"},{"l":"Batch Ativos","v":"6.526","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"76.0%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+11.4%","d":"up"}];
const COLS = ["ID","Batch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Manufacturing #001","Food Manufacturing #002","8.733","321","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Food Manufacturing #002","Food Manufacturing #003","427","5.940","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Manufacturing #003","Food Manufacturing #004","6.528","4.719","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Food Manufacturing #004","Food Manufacturing #005","5.490","1.682","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Manufacturing #005","Food Manufacturing #001","3.074","1.189","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":720},{"label":"Mar","value":902},{"label":"Abr","value":655},{"label":"Mai","value":736},{"label":"Jun","value":655},{"label":"Jul","value":649},{"label":"Ago","value":860},{"label":"Set","value":849},{"label":"Out","value":886},{"label":"Nov","value":707},{"label":"Dez","value":894}];
const MX = 902;
