...
const PAGE = "Software Load";
const KPIS = [{"l":"Total Avionics Mgmt","v":"2.742","t":"+8.2%","d":"up"},{"l":"Software Load Ativos","v":"5.443","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"80","t":"-3.6%","d":"down"}];
const COLS = ["ID","Software Load","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Avionics Mgmt #001","Avionics Mgmt #002","6.566","1.577","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Avionics Mgmt #002","Avionics Mgmt #003","7.536","4.515","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Avionics Mgmt #003","Avionics Mgmt #004","3.237","2.568","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Avionics Mgmt #004","Avionics Mgmt #005","6.628","3.099","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Avionics Mgmt #005","Avionics Mgmt #001","5.342","4.560","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":762},{"label":"Mar","value":804},{"label":"Abr","value":947},{"label":"Mai","value":965},{"label":"Jun","value":671},{"label":"Jul","value":710},{"label":"Ago","value":990},{"label":"Set","value":971},{"label":"Out","value":916},{"label":"Nov","value":916},{"label":"Dez","value":977}];
const MX = 990;
