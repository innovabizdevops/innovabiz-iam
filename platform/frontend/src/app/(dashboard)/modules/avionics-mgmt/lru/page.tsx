...
const PAGE = "LRU Track";
const KPIS = [{"l":"Total Avionics Mgmt","v":"3.833","t":"+14.4%","d":"up"},{"l":"LRU Track Ativos","v":"8.257","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"76","t":"+10.1%","d":"up"}];
const COLS = ["ID","LRU Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Avionics Mgmt #001","Avionics Mgmt #002","4.363","1.909","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Avionics Mgmt #002","Avionics Mgmt #003","8.701","2.193","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Avionics Mgmt #003","Avionics Mgmt #004","5.637","1.809","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Avionics Mgmt #004","Avionics Mgmt #005","8.988","1.384","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Avionics Mgmt #005","Avionics Mgmt #001","1.469","7.078","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":399},{"label":"Fev","value":414},{"label":"Mar","value":514},{"label":"Abr","value":310},{"label":"Mai","value":311},{"label":"Jun","value":547},{"label":"Jul","value":363},{"label":"Ago","value":378},{"label":"Set","value":335},{"label":"Out","value":545},{"label":"Nov","value":354},{"label":"Dez","value":455}];
const MX = 547;
