...
const ACCENT = "#38bdf8";
const MODULE = "Avionics Management";
const PAGE = "Config Mgmt";
const KPIS = [{"l":"Configurações","v":"3.167","t":"+8.7%","d":"up"},{"l":"Últimas Alterações","v":"3.645","t":"-5.9%","d":"down"},{"l":"Ambientes","v":"7.855","t":"+2.7%","d":"up"},{"l":"Versão Config","v":"1.767","t":"+9.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 1077.17","2.559","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 29281.71","1.130","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 19982.62","7.845","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 37638.06","3.340","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 39483.39","3.340","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":676},{"label":"Mar","value":869},{"label":"Abr","value":777},{"label":"Mai","value":786},{"label":"Jun","value":597},{"label":"Jul","value":735},{"label":"Ago","value":618},{"label":"Set","value":743},{"label":"Out","value":546},{"label":"Nov","value":685},{"label":"Dez","value":649}];
const MX = 878;
