...
const PAGE = "Test Bench";
const KPIS = [{"l":"Total Avionics Mgmt","v":"3.125","t":"+8.5%","d":"up"},{"l":"Test Bench Ativos","v":"8.614","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"67.2%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"78","t":"+13.2%","d":"up"}];
const COLS = ["ID","Test Bench","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Avionics Mgmt #001","Avionics Mgmt #002","7.647","4.687","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Avionics Mgmt #002","Avionics Mgmt #003","3.324","6.004","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Avionics Mgmt #003","Avionics Mgmt #004","7.129","6.950","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Avionics Mgmt #004","Avionics Mgmt #005","709","4.343","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Avionics Mgmt #005","Avionics Mgmt #001","7.880","3.212","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":672},{"label":"Mar","value":813},{"label":"Abr","value":711},{"label":"Mai","value":942},{"label":"Jun","value":661},{"label":"Jul","value":1038},{"label":"Ago","value":1047},{"label":"Set","value":669},{"label":"Out","value":943},{"label":"Nov","value":722},{"label":"Dez","value":714}];
const MX = 1047;
