...
const KPIS = [{"l":"Total Avionics Mgmt","v":"1.127","t":"+6.9%","d":"up"},{"l":"Modification Ativos","v":"8.631","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+8.6%","d":"up"}];
const COLS = ["ID","Modification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Avionics Mgmt #001","Avionics Mgmt #002","4.707","1.943","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Avionics Mgmt #002","Avionics Mgmt #003","7.888","557","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Avionics Mgmt #003","Avionics Mgmt #004","8.469","4.857","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Avionics Mgmt #004","Avionics Mgmt #005","2.076","7.234","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Avionics Mgmt #005","Avionics Mgmt #001","1.149","5.896","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":524},{"label":"Mar","value":794},{"label":"Abr","value":531},{"label":"Mai","value":772},{"label":"Jun","value":420},{"label":"Jul","value":653},{"label":"Ago","value":631},{"label":"Set","value":528},{"label":"Out","value":795},{"label":"Nov","value":501},{"label":"Dez","value":795}];
const MX = 795;
