...
const PAGE = "Formation";
const KPIS = [{"l":"Formulários Ativos","v":"3.103","t":"+0.7%","d":"up"},{"l":"Submissões/Dia","v":"3484","t":"+12.7%","d":"up"},{"l":"Documentos Gerados","v":"2.707","t":"-3.1%","d":"down"},{"l":"Templates","v":"3.362","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.719","2026-01-25","1.941","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.608","2026-01-25","8.597","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.765","2026-03-04","2.084","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.403","2026-03-06","5.548","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.224","2026-03-17","7.485","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":826},{"label":"Mar","value":758},{"label":"Abr","value":805},{"label":"Mai","value":727},{"label":"Jun","value":781},{"label":"Jul","value":816},{"label":"Ago","value":691},{"label":"Set","value":691},{"label":"Out","value":822},{"label":"Nov","value":681},{"label":"Dez","value":541}];
const MX = 826;
