...
const PAGE = "Mesh Network";
const KPIS = [{"l":"Total Drone Swarm","v":"4.871","t":"+13.3%","d":"up"},{"l":"Mesh Network Ativos","v":"6.176","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"70.1%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"71","t":"-4.6%","d":"down"}];
const COLS = ["ID","Mesh Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Swarm #001","Drone Swarm #002","2.965","3.286","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Swarm #002","Drone Swarm #003","4.927","4.815","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Swarm #003","Drone Swarm #004","5.023","395","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Swarm #004","Drone Swarm #005","4.294","599","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Swarm #005","Drone Swarm #001","5.277","5.807","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":652},{"label":"Mar","value":685},{"label":"Abr","value":616},{"label":"Mai","value":307},{"label":"Jun","value":690},{"label":"Jul","value":380},{"label":"Ago","value":573},{"label":"Set","value":486},{"label":"Out","value":522},{"label":"Nov","value":608},{"label":"Dez","value":563}];
const MX = 690;
