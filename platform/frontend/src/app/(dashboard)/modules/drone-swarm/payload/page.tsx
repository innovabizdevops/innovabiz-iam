...
const PAGE = "Payload Drop";
const KPIS = [{"l":"Total Drone Swarm","v":"4.221","t":"-3.2%","d":"down"},{"l":"Payload Drop Ativos","v":"6.046","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"67","t":"+10.5%","d":"up"}];
const COLS = ["ID","Payload Drop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Swarm #001","Drone Swarm #002","3.038","1.185","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Swarm #002","Drone Swarm #003","5.401","5.699","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Swarm #003","Drone Swarm #004","2.240","7.437","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Swarm #004","Drone Swarm #005","4.361","5.842","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Swarm #005","Drone Swarm #001","4.384","1.322","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":726},{"label":"Mar","value":826},{"label":"Abr","value":688},{"label":"Mai","value":892},{"label":"Jun","value":817},{"label":"Jul","value":773},{"label":"Ago","value":901},{"label":"Set","value":609},{"label":"Out","value":855},{"label":"Nov","value":636},{"label":"Dez","value":640}];
const MX = 901;
