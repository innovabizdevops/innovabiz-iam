...
const ACCENT = "#6366f1";
const MODULE = "Drone Swarm";
const PAGE = "Swarm AI";
const KPIS = [{"l":"Total Drone Swarm","v":"2.801","t":"+3.2%","d":"up"},{"l":"Swarm AI Ativos","v":"8.420","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"87","t":"-3.7%","d":"down"}];
const COLS = ["ID","Swarm AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Swarm #001","Drone Swarm #002","1.980","3.644","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Swarm #002","Drone Swarm #003","3.332","3.978","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Swarm #003","Drone Swarm #004","9.022","528","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Swarm #004","Drone Swarm #005","2.803","7.882","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Swarm #005","Drone Swarm #001","5.505","9.024","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":770},{"label":"Mar","value":604},{"label":"Abr","value":718},{"label":"Mai","value":576},{"label":"Jun","value":605},{"label":"Jul","value":804},{"label":"Ago","value":814},{"label":"Set","value":589},{"label":"Out","value":799},{"label":"Nov","value":603},{"label":"Dez","value":623}];
const MX = 814;
