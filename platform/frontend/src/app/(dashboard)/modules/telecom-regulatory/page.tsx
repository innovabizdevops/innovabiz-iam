...
export default function TelecomRegulatoryPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Telecom Regulatory</h1><p className="text-sm text-muted-foreground">Telecom Regulatory • iBOS Enterprise</p></div>
            </div>
