...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Semantic Search";
const PAGE = "Embed";
const KPIS = [{"l":"Dashboards Ativos","v":"3.353","t":"+16.2%","d":"up"},{"l":"Queries/Dia","v":"220","t":"+13.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.245","t":"-3.9%","d":"down"},{"l":"Utilizadores Analytics","v":"338","t":"-2.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2739","2026-01-24","8.368","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","733","2026-03-12","8.126","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3173","2026-03-08","1.248","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4767","2026-02-11","4.154","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4777","2026-01-07","1.876","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":476},{"label":"Mar","value":422},{"label":"Abr","value":563},{"label":"Mai","value":718},{"label":"Jun","value":749},{"label":"Jul","value":508},{"label":"Ago","value":579},{"label":"Set","value":746},{"label":"Out","value":562},{"label":"Nov","value":697},{"label":"Dez","value":492}];
const MX = 749;
