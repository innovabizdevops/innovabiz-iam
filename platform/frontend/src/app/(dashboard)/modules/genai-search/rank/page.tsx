...
const PAGE = "Rank";
const KPIS = [{"l":"Total Genai Search","v":"5.616","t":"+0.7%","d":"up"},{"l":"Rank Ativos","v":"6.707","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"81.8%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"70","t":"+12.4%","d":"up"}];
const COLS = ["ID","Rank","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Search #001","Genai Search #002","2.797","7.305","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Search #002","Genai Search #003","5.352","8.691","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Search #003","Genai Search #004","8.039","9.067","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Search #004","Genai Search #005","1.447","1.317","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Search #005","Genai Search #001","7.927","7.259","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1020},{"label":"Fev","value":979},{"label":"Mar","value":862},{"label":"Abr","value":856},{"label":"Mai","value":831},{"label":"Jun","value":1050},{"label":"Jul","value":830},{"label":"Ago","value":828},{"label":"Set","value":853},{"label":"Out","value":1030},{"label":"Nov","value":925},{"label":"Dez","value":1013}];
const MX = 1050;
