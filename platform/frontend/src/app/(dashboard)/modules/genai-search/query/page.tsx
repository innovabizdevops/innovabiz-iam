...
const PAGE = "Query";
const KPIS = [{"l":"Total Genai Search","v":"8.982","t":"+13.1%","d":"up"},{"l":"Query Ativos","v":"7.200","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"94.0%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"70","t":"-2.7%","d":"down"}];
const COLS = ["ID","Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Search #001","Genai Search #002","2.284","2.478","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Search #002","Genai Search #003","4.029","7.539","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Search #003","Genai Search #004","6.139","1.929","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Search #004","Genai Search #005","9.056","8.660","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Search #005","Genai Search #001","6.178","5.177","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":406},{"label":"Mar","value":443},{"label":"Abr","value":599},{"label":"Mai","value":498},{"label":"Jun","value":626},{"label":"Jul","value":645},{"label":"Ago","value":566},{"label":"Set","value":387},{"label":"Out","value":466},{"label":"Nov","value":370},{"label":"Dez","value":329}];
const MX = 645;
