...
/* ═══ GenAI Semantic Search — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "6852", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3912", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€183K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1897054652", cells: ["GEN-8652", "GenAI Semantic Search Item 1", "25/9/2026", "€4752"], status: "active" as const },
    { id: "1897058223", cells: ["GEN-3223", "GenAI Semantic Search Item 2", "12/4/2026", "€8323"], status: "pending" as const },
    { id: "1897061794", cells: ["GEN-6794", "GenAI Semantic Search Item 3", "27/11/2026", "€11 894"], status: "completed" as const },
    { id: "1897065365", cells: ["GEN-1365", "GenAI Semantic Search Item 4", "14/6/2026", "€15 465"], status: "warning" as const },
    { id: "1897068936", cells: ["GEN-4936", "GenAI Semantic Search Item 5", "1/1/2026", "€19 036"], status: "active" as const },
];
...
export default function GenaiSemanticSearchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Semantic Search</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Semantic Search</p>
                    </div>
                </div>
