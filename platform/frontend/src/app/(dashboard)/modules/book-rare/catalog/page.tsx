...
const ACCENT = "#92400e";
const MODULE = "Rare Book Dealer";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"1.926","t":"-2.1%","d":"down"},{"l":"Queries/Dia","v":"4604","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"6.491","t":"+14.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.552","t":"+9.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1836","2026-03-26","8.666","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3073","2026-02-12","6.617","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","354","2026-02-16","2.574","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","526","2026-03-16","135","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1036","2026-01-22","4.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":802},{"label":"Mar","value":486},{"label":"Abr","value":498},{"label":"Mai","value":554},{"label":"Jun","value":638},{"label":"Jul","value":721},{"label":"Ago","value":466},{"label":"Set","value":553},{"label":"Out","value":518},{"label":"Nov","value":551},{"label":"Dez","value":549}];
const MX = 802;
