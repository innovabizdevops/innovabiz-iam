...
const PAGE = "Conserve";
const KPIS = [{"l":"Total Book Rare","v":"8.756","t":"+16.1%","d":"up"},{"l":"Conserve Ativos","v":"4.265","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"73","t":"+9.4%","d":"up"}];
const COLS = ["ID","Conserve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Book Rare #001","Book Rare #002","8.859","4.374","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Book Rare #002","Book Rare #003","1.800","1.086","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Book Rare #003","Book Rare #004","688","6.521","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Book Rare #004","Book Rare #005","7.423","6.489","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Book Rare #005","Book Rare #001","4.211","5.923","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":601},{"label":"Mar","value":535},{"label":"Abr","value":602},{"label":"Mai","value":745},{"label":"Jun","value":698},{"label":"Jul","value":793},{"label":"Ago","value":525},{"label":"Set","value":538},{"label":"Out","value":511},{"label":"Nov","value":764},{"label":"Dez","value":709}];
const MX = 793;
...
export default function ConservePage() {
    return (
