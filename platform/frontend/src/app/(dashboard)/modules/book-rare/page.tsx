...
/* ═══ Rare Book Dealer — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "2153", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "677", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€117K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1297119853", cells: ["BOO-4853", "Rare Book Dealer Item 1", "2/2/2026", "€19 953"], status: "active" as const },
    { id: "1297123424", cells: ["BOO-8424", "Rare Book Dealer Item 2", "17/9/2026", "€23 524"], status: "pending" as const },
    { id: "1297126995", cells: ["BOO-2995", "Rare Book Dealer Item 3", "4/4/2026", "€27 095"], status: "completed" as const },
    { id: "1297130566", cells: ["BOO-6566", "Rare Book Dealer Item 4", "19/11/2026", "€30 666"], status: "warning" as const },
    { id: "1297134137", cells: ["BOO-1137", "Rare Book Dealer Item 5", "6/6/2026", "€34 237"], status: "active" as const },
];
...
export default function RareBookDealerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rare Book Dealer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Rare Book Dealer</p>
                    </div>
                </div>
