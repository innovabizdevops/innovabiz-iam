...
const ACCENT = "#dc2626";
const MODULE = "PSD2 & Open Banking";
const PAGE = "TPP";
const KPIS = [{"l":"Total Psd2 Openbanking","v":"4.099","t":"+12.7%","d":"up"},{"l":"TPP Ativos","v":"6.047","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"86","t":"+3.2%","d":"up"}];
const COLS = ["ID","TPP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Psd2 Openbanking #001","Psd2 Openbanking #002","1.917","578","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Psd2 Openbanking #002","Psd2 Openbanking #003","493","2.699","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Psd2 Openbanking #003","Psd2 Openbanking #004","6.141","1.213","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Psd2 Openbanking #004","Psd2 Openbanking #005","1.426","4.074","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Psd2 Openbanking #005","Psd2 Openbanking #001","8.815","6.722","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":570},{"label":"Mar","value":571},{"label":"Abr","value":800},{"label":"Mai","value":574},{"label":"Jun","value":899},{"label":"Jul","value":834},{"label":"Ago","value":647},{"label":"Set","value":591},{"label":"Out","value":891},{"label":"Nov","value":576},{"label":"Dez","value":619}];
const MX = 903;
