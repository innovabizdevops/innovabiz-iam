...
/* ═══ PSD2 & Open Banking — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8057", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1790", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€279K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1109392057", cells: ["PSD-8057", "PSD2 & Open Banking Item 1", "26/2/2026", "€42 157"], status: "active" as const },
    { id: "1109395628", cells: ["PSD-2628", "PSD2 & Open Banking Item 2", "13/9/2026", "€45 728"], status: "pending" as const },
    { id: "1109399199", cells: ["PSD-6199", "PSD2 & Open Banking Item 3", "28/4/2026", "€49 299"], status: "completed" as const },
    { id: "1109402770", cells: ["PSD-9770", "PSD2 & Open Banking Item 4", "15/11/2026", "€2870"], status: "warning" as const },
    { id: "1109406341", cells: ["PSD-4341", "PSD2 & Open Banking Item 5", "2/6/2026", "€6441"], status: "active" as const },
];
...
export default function Psd2OpenBankingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">PSD2 & Open Banking</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • PSD2 & Open Banking</p>
                    </div>
                </div>
