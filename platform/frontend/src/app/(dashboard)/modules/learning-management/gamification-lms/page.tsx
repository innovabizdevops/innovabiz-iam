...
const KPIS = [{"l":"Projetos Melhoria","v":"5.248","t":"+0.3%","d":"up"},{"l":"Savings (€)","v":"€54397","t":"+1.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.4%","t":"+9.3%","d":"up"},{"l":"Ciclos PDCA","v":"8.014","t":"+0.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.883","€ 49220.71","5.086","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.334","€ 6929.71","6.959","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.032","€ 27233.13","437","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.162","€ 40201.45","3.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.298","€ 33166.26","3.321","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":472},{"label":"Mar","value":501},{"label":"Abr","value":555},{"label":"Mai","value":593},{"label":"Jun","value":674},{"label":"Jul","value":596},{"label":"Ago","value":538},{"label":"Set","value":473},{"label":"Out","value":453},{"label":"Nov","value":500},{"label":"Dez","value":753}];
const MX = 753;
...
export default function GamificationLmsPage() {
    return (
