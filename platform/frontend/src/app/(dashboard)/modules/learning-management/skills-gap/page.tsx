...
const PAGE = "Skills Gap Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"3.720","t":"+9.1%","d":"up"},{"l":"Queries/Dia","v":"1343","t":"+9.9%","d":"up"},{"l":"Dados Processados (GB)","v":"8.632","t":"+2.6%","d":"up"},{"l":"Utilizadores Analytics","v":"113","t":"-3.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1744","2026-02-20","1.177","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3774","2026-01-13","2.886","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4082","2026-03-18","5.132","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3447","2026-01-11","498","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2232","2026-03-19","8.961","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":911},{"label":"Mar","value":849},{"label":"Abr","value":684},{"label":"Mai","value":730},{"label":"Jun","value":620},{"label":"Jul","value":873},{"label":"Ago","value":860},{"label":"Set","value":923},{"label":"Out","value":830},{"label":"Nov","value":818},{"label":"Dez","value":880}];
const MX = 923;
