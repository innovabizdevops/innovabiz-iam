...
const ACCENT = "#6366f1";
const MODULE = "Learning Management";
const PAGE = "Learning Path Diagram";
const KPIS = [{"l":"Diagramas Criados","v":"6.080","t":"+1.3%","d":"up"},{"l":"Templates","v":"4.197","t":"+14.3%","d":"up"},{"l":"Colaboradores","v":"1.376","t":"+9.3%","d":"up"},{"l":"Comentários/Semana","v":"2013","t":"-1.0%","d":"down"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","5.855","2026-01-27","7.845","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","3.044","2026-02-15","1.973","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","1.227","2026-01-15","6.441","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","1.246","2026-03-06","8.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","2.241","2026-01-19","3.606","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":698},{"label":"Mar","value":584},{"label":"Abr","value":901},{"label":"Mai","value":572},{"label":"Jun","value":733},{"label":"Jul","value":921},{"label":"Ago","value":859},{"label":"Set","value":765},{"label":"Out","value":873},{"label":"Nov","value":944},{"label":"Dez","value":678}];
const MX = 944;
...
export default function PathDiagramPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Diagram</span></h1>
                </div>
