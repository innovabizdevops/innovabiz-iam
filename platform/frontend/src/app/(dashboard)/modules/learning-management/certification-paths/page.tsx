...
const PAGE = "Certification Paths";
const KPIS = [{"l":"Projetos Melhoria","v":"5.154","t":"-2.8%","d":"down"},{"l":"Savings (€)","v":"€9760","t":"+17.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.3%","t":"+3.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.184","t":"+1.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.855","€ 39529.89","5.441","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.110","€ 35136.22","3.118","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.969","€ 20257.94","6.554","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.567","€ 28869.06","340","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.035","€ 13025.83","713","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":299},{"label":"Fev","value":606},{"label":"Mar","value":392},{"label":"Abr","value":417},{"label":"Mai","value":401},{"label":"Jun","value":326},{"label":"Jul","value":531},{"label":"Ago","value":643},{"label":"Set","value":678},{"label":"Out","value":368},{"label":"Nov","value":458},{"label":"Dez","value":410}];
const MX = 678;
