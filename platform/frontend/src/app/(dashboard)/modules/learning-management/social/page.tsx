...
const PAGE = "Social Learning";
const KPIS = [{"l":"Projetos Melhoria","v":"2.150","t":"+0.8%","d":"up"},{"l":"Savings (€)","v":"€69113","t":"+17.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.7%","t":"+17.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.334","t":"-4.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.896","€ 14534.75","6.827","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.286","€ 50077.47","4.285","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.516","€ 14550.47","3.645","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.196","€ 33008.82","1.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.095","€ 41467.37","7.817","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":933},{"label":"Mar","value":815},{"label":"Abr","value":606},{"label":"Mai","value":673},{"label":"Jun","value":921},{"label":"Jul","value":896},{"label":"Ago","value":727},{"label":"Set","value":906},{"label":"Out","value":797},{"label":"Nov","value":899},{"label":"Dez","value":681}];
const MX = 933;
