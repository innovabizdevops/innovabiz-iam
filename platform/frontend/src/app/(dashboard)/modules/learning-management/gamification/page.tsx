...
const KPIS = [{"l":"Projetos Melhoria","v":"7.295","t":"+9.9%","d":"up"},{"l":"Savings (€)","v":"€7916","t":"+11.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.2%","t":"+9.6%","d":"up"},{"l":"Ciclos PDCA","v":"8.042","t":"+5.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.763","€ 41899.78","5.390","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.839","€ 26409.80","3.546","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.771","€ 20667.08","8.783","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.732","€ 10971.60","3.954","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.232","€ 42674.61","1.347","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":776},{"label":"Mar","value":936},{"label":"Abr","value":731},{"label":"Mai","value":910},{"label":"Jun","value":754},{"label":"Jul","value":935},{"label":"Ago","value":714},{"label":"Set","value":976},{"label":"Out","value":863},{"label":"Nov","value":833},{"label":"Dez","value":961}];
const MX = 976;
