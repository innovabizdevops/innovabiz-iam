...
const PAGE = "cmi5 / xAPI";
const KPIS = [{"l":"Projetos Melhoria","v":"5.543","t":"+10.3%","d":"up"},{"l":"Savings (€)","v":"€36025","t":"+2.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.9%","t":"+10.2%","d":"up"},{"l":"Ciclos PDCA","v":"4.184","t":"-4.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.873","€ 38133.56","5.731","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.307","€ 46139.70","6.043","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.116","€ 35342.85","7.507","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.124","€ 46431.55","8.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.439","€ 10479.38","6.844","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":829},{"label":"Mar","value":863},{"label":"Abr","value":933},{"label":"Mai","value":668},{"label":"Jun","value":718},{"label":"Jul","value":887},{"label":"Ago","value":620},{"label":"Set","value":587},{"label":"Out","value":611},{"label":"Nov","value":909},{"label":"Dez","value":957}];
const MX = 957;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>xAPI</span></h1>
                </div>
