...
const KPIS = [{"l":"Dashboards Ativos","v":"7.297","t":"+17.4%","d":"up"},{"l":"Queries/Dia","v":"3604","t":"+17.7%","d":"up"},{"l":"Dados Processados (GB)","v":"2.237","t":"+16.6%","d":"up"},{"l":"Utilizadores Analytics","v":"3.700","t":"+2.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4664","2026-01-06","5.499","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3935","2026-03-17","2.580","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2520","2026-01-03","953","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","284","2026-03-06","8.807","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4914","2026-03-22","9.065","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":712},{"label":"Mar","value":870},{"label":"Abr","value":1043},{"label":"Mai","value":916},{"label":"Jun","value":776},{"label":"Jul","value":900},{"label":"Ago","value":910},{"label":"Set","value":894},{"label":"Out","value":771},{"label":"Nov","value":1071},{"label":"Dez","value":989}];
const MX = 1071;
