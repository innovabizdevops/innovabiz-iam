...
const PAGE = "Micro-Learning";
const KPIS = [{"l":"Projetos Melhoria","v":"3.731","t":"+14.5%","d":"up"},{"l":"Savings (€)","v":"€87961","t":"+4.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.6%","t":"-4.1%","d":"down"},{"l":"Ciclos PDCA","v":"6.269","t":"+16.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.300","€ 46947.50","7.021","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","692","€ 564.87","8.109","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.908","€ 36988.22","1.300","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.709","€ 7033.37","469","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.948","€ 48638.26","3.597","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":905},{"label":"Mar","value":910},{"label":"Abr","value":688},{"label":"Mai","value":794},{"label":"Jun","value":723},{"label":"Jul","value":770},{"label":"Ago","value":756},{"label":"Set","value":821},{"label":"Out","value":703},{"label":"Nov","value":682},{"label":"Dez","value":824}];
const MX = 910;
