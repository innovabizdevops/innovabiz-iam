...
const PAGE = "AI Tutor";
const KPIS = [{"l":"Projetos Melhoria","v":"3.648","t":"+7.2%","d":"up"},{"l":"Savings (€)","v":"€20377","t":"+0.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.6%","t":"+13.4%","d":"up"},{"l":"Ciclos PDCA","v":"4.509","t":"+3.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","372","€ 46761.55","5.484","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.164","€ 40541.28","1.147","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.172","€ 10740.28","7.427","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.616","€ 25157.54","7.996","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.843","€ 34961.89","5.954","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":822},{"label":"Mar","value":816},{"label":"Abr","value":725},{"label":"Mai","value":808},{"label":"Jun","value":700},{"label":"Jul","value":947},{"label":"Ago","value":898},{"label":"Set","value":607},{"label":"Out","value":876},{"label":"Nov","value":833},{"label":"Dez","value":913}];
const MX = 947;
