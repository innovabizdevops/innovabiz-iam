...
const KPIS = [{"l":"Projetos Melhoria","v":"7.326","t":"+9.9%","d":"up"},{"l":"Savings (€)","v":"€69171","t":"+13.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.2%","t":"+12.6%","d":"up"},{"l":"Ciclos PDCA","v":"5.455","t":"+17.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","700","€ 28187.68","3.947","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","109","€ 4100.68","1.549","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.671","€ 42238.25","5.345","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.628","€ 2363.19","1.733","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.836","€ 8869.86","7.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":415},{"label":"Mar","value":610},{"label":"Abr","value":380},{"label":"Mai","value":506},{"label":"Jun","value":665},{"label":"Jul","value":576},{"label":"Ago","value":589},{"label":"Set","value":547},{"label":"Out","value":544},{"label":"Nov","value":517},{"label":"Dez","value":644}];
const MX = 702;
