...
const KPIS = [{"l":"Projetos Melhoria","v":"8.364","t":"+10.2%","d":"up"},{"l":"Savings (€)","v":"€66203","t":"+8.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"85.4%","t":"+8.2%","d":"up"},{"l":"Ciclos PDCA","v":"3.512","t":"-3.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.572","€ 37444.68","480","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.010","€ 42332.61","873","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.743","€ 32107.69","3.074","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.234","€ 6561.09","662","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.746","€ 15681.14","2.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":609},{"label":"Mar","value":516},{"label":"Abr","value":595},{"label":"Mai","value":787},{"label":"Jun","value":781},{"label":"Jul","value":714},{"label":"Ago","value":651},{"label":"Set","value":647},{"label":"Out","value":610},{"label":"Nov","value":813},{"label":"Dez","value":647}];
const MX = 813;
