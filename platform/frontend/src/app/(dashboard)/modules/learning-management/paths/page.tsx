...
const PAGE = "Learning Paths";
const KPIS = [{"l":"Projetos Melhoria","v":"7.198","t":"-5.1%","d":"down"},{"l":"Savings (€)","v":"€85810","t":"+5.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.7%","t":"+15.5%","d":"up"},{"l":"Ciclos PDCA","v":"344","t":"+3.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","665","€ 34690.34","4.181","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","368","€ 936.89","2.501","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.641","€ 19511.68","5.647","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.109","€ 34077.12","4.958","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.390","€ 32165.53","980","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":654},{"label":"Mar","value":391},{"label":"Abr","value":583},{"label":"Mai","value":382},{"label":"Jun","value":623},{"label":"Jul","value":481},{"label":"Ago","value":539},{"label":"Set","value":617},{"label":"Out","value":713},{"label":"Nov","value":626},{"label":"Dez","value":598}];
const MX = 713;
