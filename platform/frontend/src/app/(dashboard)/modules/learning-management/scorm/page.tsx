...
const PAGE = "SCORM Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.964","t":"+7.3%","d":"up"},{"l":"NC Abertas","v":"6.531","t":"+6.6%","d":"up"},{"l":"Conformidade (%)","v":"90.1%","t":"+12.9%","d":"up"},{"l":"CAPAs Pendentes","v":"1.002","t":"+16.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.111","88.6%","7.599","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.019","80.4%","3.835","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.435","91.2%","6.790","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.271","85.2%","8.869","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.447","79.0%","1.454","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":761},{"label":"Mar","value":821},{"label":"Abr","value":561},{"label":"Mai","value":572},{"label":"Jun","value":553},{"label":"Jul","value":492},{"label":"Ago","value":847},{"label":"Set","value":876},{"label":"Out","value":741},{"label":"Nov","value":571},{"label":"Dez","value":884}];
const MX = 884;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>SCORM</span></h1>
                </div>
