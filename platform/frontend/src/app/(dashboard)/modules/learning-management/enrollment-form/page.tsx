...
const PAGE = "Course Enrollment Form";
const KPIS = [{"l":"Formulários Ativos","v":"8.228","t":"+15.3%","d":"up"},{"l":"Submissões/Dia","v":"4612","t":"+9.9%","d":"up"},{"l":"Documentos Gerados","v":"5.998","t":"+10.6%","d":"up"},{"l":"Templates","v":"2.057","t":"+16.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.387","2026-02-01","4.269","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.542","2026-03-19","2.906","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.315","2026-03-23","6.217","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.954","2026-02-01","3.569","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.026","2026-03-24","3.253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":487},{"label":"Mar","value":454},{"label":"Abr","value":779},{"label":"Mai","value":556},{"label":"Jun","value":767},{"label":"Jul","value":713},{"label":"Ago","value":440},{"label":"Set","value":715},{"label":"Out","value":583},{"label":"Nov","value":505},{"label":"Dez","value":505}];
const MX = 779;
