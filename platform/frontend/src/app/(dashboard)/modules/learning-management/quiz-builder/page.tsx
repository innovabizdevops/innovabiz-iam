...
const PAGE = "Quiz Builder";
const KPIS = [{"l":"Projetos Melhoria","v":"5.867","t":"+16.2%","d":"up"},{"l":"Savings (€)","v":"€46695","t":"+12.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.1%","t":"+0.5%","d":"up"},{"l":"Ciclos PDCA","v":"8.485","t":"+15.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.398","€ 46714.53","5.715","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.880","€ 44446.57","5.276","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.321","€ 11024.71","8.028","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.223","€ 48537.60","6.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.706","€ 44900.56","1.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":939},{"label":"Mar","value":734},{"label":"Abr","value":737},{"label":"Mai","value":793},{"label":"Jun","value":884},{"label":"Jul","value":1033},{"label":"Ago","value":823},{"label":"Set","value":944},{"label":"Out","value":862},{"label":"Nov","value":929},{"label":"Dez","value":887}];
const MX = 1033;
