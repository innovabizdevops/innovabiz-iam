...
const PAGE = "Partner Portal";
const KPIS = [{"l":"Formulários Ativos","v":"8.424","t":"+9.3%","d":"up"},{"l":"Submissões/Dia","v":"2715","t":"-3.9%","d":"down"},{"l":"Documentos Gerados","v":"4.322","t":"-1.0%","d":"down"},{"l":"Templates","v":"1.787","t":"-4.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.674","2026-02-28","2.644","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.662","2026-01-24","1.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.971","2026-02-21","500","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.426","2026-01-11","8.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.130","2026-03-15","7.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":776},{"label":"Mar","value":779},{"label":"Abr","value":437},{"label":"Mai","value":577},{"label":"Jun","value":596},{"label":"Jul","value":733},{"label":"Ago","value":585},{"label":"Set","value":794},{"label":"Out","value":804},{"label":"Nov","value":555},{"label":"Dez","value":462}];
const MX = 811;
