...
export default function MvnoPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mvno Platform</h1><p className="text-sm text-muted-foreground">Mvno Platform • iBOS Enterprise</p></div>
