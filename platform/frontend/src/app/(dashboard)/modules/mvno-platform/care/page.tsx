...
const KPIS = [{"l":"Formulários Ativos","v":"9.014","t":"+10.9%","d":"up"},{"l":"Submissões/Dia","v":"2287","t":"+0.4%","d":"up"},{"l":"Documentos Gerados","v":"3.800","t":"+16.1%","d":"up"},{"l":"Templates","v":"7.956","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.140","2026-01-24","4.776","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.567","2026-03-07","8.894","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.109","2026-03-08","3.847","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.194","2026-03-18","7.551","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","766","2026-03-07","4.253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":372},{"label":"Mar","value":602},{"label":"Abr","value":304},{"label":"Mai","value":582},{"label":"Jun","value":282},{"label":"Jul","value":307},{"label":"Ago","value":622},{"label":"Set","value":350},{"label":"Out","value":468},{"label":"Nov","value":327},{"label":"Dez","value":576}];
const MX = 622;
