...
const KPIS = [{"l":"Formulários Ativos","v":"2.948","t":"-2.6%","d":"down"},{"l":"Submissões/Dia","v":"1393","t":"+0.5%","d":"up"},{"l":"Documentos Gerados","v":"3.185","t":"+2.5%","d":"up"},{"l":"Templates","v":"1.275","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.463","2026-02-24","4.678","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.377","2026-03-16","7.314","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.309","2026-03-22","7.447","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.831","2026-01-01","1.631","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.342","2026-03-16","1.992","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":539},{"label":"Mar","value":584},{"label":"Abr","value":613},{"label":"Mai","value":758},{"label":"Jun","value":680},{"label":"Jul","value":763},{"label":"Ago","value":513},{"label":"Set","value":770},{"label":"Out","value":599},{"label":"Nov","value":804},{"label":"Dez","value":766}];
const MX = 804;
