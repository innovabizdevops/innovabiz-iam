...
const ACCENT = "#7e22ce";
const MODULE = "MVNO Platform";
const PAGE = "Brand Mgmt";
const KPIS = [{"l":"Formulários Ativos","v":"7.920","t":"+14.6%","d":"up"},{"l":"Submissões/Dia","v":"4616","t":"+15.2%","d":"up"},{"l":"Documentos Gerados","v":"2.810","t":"+5.3%","d":"up"},{"l":"Templates","v":"4.722","t":"+2.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.420","2026-03-07","2.355","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.147","2026-02-17","2.629","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.728","2026-03-22","3.806","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.086","2026-02-25","7.860","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.527","2026-03-04","8.234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":398},{"label":"Mar","value":497},{"label":"Abr","value":498},{"label":"Mai","value":512},{"label":"Jun","value":577},{"label":"Jul","value":367},{"label":"Ago","value":451},{"label":"Set","value":390},{"label":"Out","value":554},{"label":"Nov","value":656},{"label":"Dez","value":413}];
const MX = 656;
