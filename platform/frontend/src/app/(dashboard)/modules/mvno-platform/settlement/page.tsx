...
const KPIS = [{"l":"Formulários Ativos","v":"451","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"1539","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"7.547","t":"-2.7%","d":"down"},{"l":"Templates","v":"101","t":"-3.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.432","2026-03-20","1.456","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.593","2026-02-25","4.770","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.392","2026-01-23","4.135","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.119","2026-02-28","723","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.318","2026-02-21","5.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":839},{"label":"Mar","value":769},{"label":"Abr","value":513},{"label":"Mai","value":803},{"label":"Jun","value":709},{"label":"Jul","value":854},{"label":"Ago","value":668},{"label":"Set","value":587},{"label":"Out","value":730},{"label":"Nov","value":521},{"label":"Dez","value":851}];
const MX = 854;
