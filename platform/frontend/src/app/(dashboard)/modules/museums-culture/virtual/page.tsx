...
const PAGE = "Virtual Gallery";
const KPIS = [{"l":"Total Museums Culture","v":"1.463","t":"+4.9%","d":"up"},{"l":"Virtual Gallery Ativos","v":"6.221","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"78","t":"+5.7%","d":"up"}];
const COLS = ["ID","Virtual Gallery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museums Culture #001","Museums Culture #002","5.290","3.736","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Museums Culture #002","Museums Culture #003","8.370","6.585","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Museums Culture #003","Museums Culture #004","5.188","4.818","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Museums Culture #004","Museums Culture #005","7.409","6.303","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museums Culture #005","Museums Culture #001","4.058","5.208","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":717},{"label":"Mar","value":772},{"label":"Abr","value":747},{"label":"Mai","value":521},{"label":"Jun","value":636},{"label":"Jul","value":582},{"label":"Ago","value":764},{"label":"Set","value":614},{"label":"Out","value":507},{"label":"Nov","value":510},{"label":"Dez","value":790}];
const MX = 790;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9f1239'}}>XR</span></h1>
                </div>
