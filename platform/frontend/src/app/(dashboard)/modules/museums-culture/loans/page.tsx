...
const PAGE = "Loan Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.909","t":"+12.7%","d":"up"},{"l":"Savings (€)","v":"€54810","t":"+3.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.3%","t":"+13.3%","d":"up"},{"l":"Ciclos PDCA","v":"4.444","t":"+0.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.626","€ 45376.33","7.727","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.306","€ 4063.08","7.808","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.081","€ 8199.28","7.836","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","462","€ 48077.21","2.998","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.429","€ 18345.96","7.513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":784},{"label":"Mar","value":808},{"label":"Abr","value":525},{"label":"Mai","value":567},{"label":"Jun","value":580},{"label":"Jul","value":509},{"label":"Ago","value":788},{"label":"Set","value":520},{"label":"Out","value":670},{"label":"Nov","value":770},{"label":"Dez","value":664}];
const MX = 856;
