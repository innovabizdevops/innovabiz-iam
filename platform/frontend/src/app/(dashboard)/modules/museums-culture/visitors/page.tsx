...
const PAGE = "Visitor Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.215","t":"-1.4%","d":"down"},{"l":"Queries/Dia","v":"1294","t":"+0.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.133","t":"+17.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.774","t":"-0.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3710","2026-01-28","4.212","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","569","2026-03-26","7.775","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4664","2026-01-17","1.438","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4537","2026-02-15","4.774","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","337","2026-03-27","5.650","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":479},{"label":"Mar","value":348},{"label":"Abr","value":566},{"label":"Mai","value":638},{"label":"Jun","value":438},{"label":"Jul","value":595},{"label":"Ago","value":626},{"label":"Set","value":625},{"label":"Out","value":542},{"label":"Nov","value":446},{"label":"Dez","value":598}];
const MX = 638;
