...
const ACCENT = "#9f1239";
const MODULE = "Museums & Cultural";
const PAGE = "Provenance Chain";
const KPIS = [{"l":"Total Museums Culture","v":"5.984","t":"+8.3%","d":"up"},{"l":"Provenance Chain Ativos","v":"6.416","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+4.2%","d":"up"}];
const COLS = ["ID","Provenance Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Museums Culture #001","Museums Culture #002","6.169","6.073","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Museums Culture #002","Museums Culture #003","3.914","2.149","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Museums Culture #003","Museums Culture #004","3.101","5.623","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Museums Culture #004","Museums Culture #005","620","4.410","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Museums Culture #005","Museums Culture #001","4.916","8.699","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":754},{"label":"Mar","value":914},{"label":"Abr","value":761},{"label":"Mai","value":693},{"label":"Jun","value":1022},{"label":"Jul","value":790},{"label":"Ago","value":1042},{"label":"Set","value":704},{"label":"Out","value":978},{"label":"Nov","value":668},{"label":"Dez","value":839}];
const MX = 1042;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9f1239'}}>Chain</span></h1>
                </div>
