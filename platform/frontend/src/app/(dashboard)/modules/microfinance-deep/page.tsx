...
/* ═══ Microfinance Deep — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "5710", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3157", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€235K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-18%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "58930410", cells: ["MIC-8410", "Microfinance Deep Item 1", "15/7/2026", "€30 510"], status: "active" as const },
    { id: "58933981", cells: ["MIC-2981", "Microfinance Deep Item 2", "2/2/2026", "€34 081"], status: "pending" as const },
    { id: "58937552", cells: ["MIC-6552", "Microfinance Deep Item 3", "17/9/2026", "€37 652"], status: "completed" as const },
    { id: "58941123", cells: ["MIC-1123", "Microfinance Deep Item 4", "4/4/2026", "€41 223"], status: "warning" as const },
    { id: "58944694", cells: ["MIC-4694", "Microfinance Deep Item 5", "19/11/2026", "€44 794"], status: "active" as const },
];
...
export default function MicrofinanceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Microfinance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Microfinance Deep</p>
                    </div>
                </div>
