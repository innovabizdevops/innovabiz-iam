...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"1.019","t":"-1.4%","d":"down"},{"l":"Beneficiários","v":"3.115","t":"-5.6%","d":"down"},{"l":"Investimento CSR (€)","v":"€36187","t":"+9.7%","d":"up"},{"l":"Score Impacto","v":"77","t":"+17.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","290","€ 21563.09","3.712","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.602","€ 27785.04","469","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.865","€ 45526.61","4.647","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","9.084","€ 4857.82","4.868","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.531","€ 16428.42","6.276","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":637},{"label":"Mar","value":347},{"label":"Abr","value":369},{"label":"Mai","value":425},{"label":"Jun","value":297},{"label":"Jul","value":629},{"label":"Ago","value":605},{"label":"Set","value":658},{"label":"Out","value":402},{"label":"Nov","value":361},{"label":"Dez","value":438}];
const MX = 658;
