...
const PAGE = "Savings";
const KPIS = [{"l":"Total Microfinance Deep","v":"1.815","t":"+2.2%","d":"up"},{"l":"Savings Ativos","v":"€62290","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"90.1%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"74","t":"+11.4%","d":"up"}];
const COLS = ["ID","Savings","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Microfinance Deep #001","€ 22721.70","8.375","3.543","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Microfinance Deep #002","€ 26460.89","3.802","1.848","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Microfinance Deep #003","€ 29535.29","467","5.374","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Microfinance Deep #004","€ 49352.13","1.127","1.050","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Microfinance Deep #005","€ 38873.49","6.377","5.043","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":631},{"label":"Mar","value":536},{"label":"Abr","value":568},{"label":"Mai","value":714},{"label":"Jun","value":416},{"label":"Jul","value":381},{"label":"Ago","value":484},{"label":"Set","value":602},{"label":"Out","value":417},{"label":"Nov","value":655},{"label":"Dez","value":689}];
const MX = 714;
