...
const ACCENT = "#831843";
const MODULE = "Microfinance Deep";
const PAGE = "Client";
const KPIS = [{"l":"Total Microfinance Deep","v":"1.063","t":"+9.5%","d":"up"},{"l":"Client Ativos","v":"1.442","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"73.6%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"82","t":"-5.9%","d":"down"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Microfinance Deep #001","Microfinance Deep #002","7.796","8.384","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Microfinance Deep #002","Microfinance Deep #003","5.038","1.514","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Microfinance Deep #003","Microfinance Deep #004","4.121","969","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Microfinance Deep #004","Microfinance Deep #005","3.404","2.549","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Microfinance Deep #005","Microfinance Deep #001","1.188","2.331","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":546},{"label":"Mar","value":811},{"label":"Abr","value":813},{"label":"Mai","value":804},{"label":"Jun","value":785},{"label":"Jul","value":835},{"label":"Ago","value":862},{"label":"Set","value":737},{"label":"Out","value":844},{"label":"Nov","value":557},{"label":"Dez","value":661}];
const MX = 862;
