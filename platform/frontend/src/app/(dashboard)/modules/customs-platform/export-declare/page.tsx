...
const ROWS = [
  { id: "001", c: ["Export Declare-001", "Export Declare Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Export Declare-002", "Export Declare Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Export Declare-003", "Export Declare Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Export Declare-004", "Export Declare Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Export Declare-005", "Export Declare Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Export Declare", ts: "Há 2min", a: "Sistema" },
...
export default function ExportDeclarePage() {
  return (
