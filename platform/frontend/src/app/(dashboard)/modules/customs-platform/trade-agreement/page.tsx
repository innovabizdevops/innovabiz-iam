...
const ROWS = [
  { id: "001", c: ["Trade Agreement-001", "Trade Agreement Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Trade Agreement-002", "Trade Agreement Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Trade Agreement-003", "Trade Agreement Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Trade Agreement-004", "Trade Agreement Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Trade Agreement-005", "Trade Agreement Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Trade Agreement", ts: "Há 2min", a: "Sistema" },
...
export default function TradeAgreementPage() {
  return (
