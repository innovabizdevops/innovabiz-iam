...
const ROWS = [
  { id: "001", c: ["Bonded Warehouse-001", "Bonded Warehouse Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Bonded Warehouse-002", "Bonded Warehouse Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Bonded Warehouse-003", "Bonded Warehouse Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Bonded Warehouse-004", "Bonded Warehouse Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Bonded Warehouse-005", "Bonded Warehouse Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Bonded Warehouse", ts: "Há 2min", a: "Sistema" },
