...
const ROWS = [
  { id: "001", c: ["Duty Drawback-001", "Duty Drawback Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Duty Drawback-002", "Duty Drawback Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Duty Drawback-003", "Duty Drawback Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Duty Drawback-004", "Duty Drawback Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Duty Drawback-005", "Duty Drawback Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Duty Drawback", ts: "Há 2min", a: "Sistema" },
...
export default function DutyDrawbackPage() {
  return (
