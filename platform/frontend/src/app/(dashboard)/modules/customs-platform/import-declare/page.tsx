...
const ROWS = [
  { id: "001", c: ["Import Declare-001", "Import Declare Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Import Declare-002", "Import Declare Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Import Declare-003", "Import Declare Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Import Declare-004", "Import Declare Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Import Declare-005", "Import Declare Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Import Declare", ts: "Há 2min", a: "Sistema" },
...
export default function ImportDeclarePage() {
  return (
