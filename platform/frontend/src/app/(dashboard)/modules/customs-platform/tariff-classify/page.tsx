...
const ROWS = [
  { id: "001", c: ["Tariff Classify-001", "Tariff Classify Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Tariff Classify-002", "Tariff Classify Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Tariff Classify-003", "Tariff Classify Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Tariff Classify-004", "Tariff Classify Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Tariff Classify-005", "Tariff Classify Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Tariff Classify", ts: "Há 2min", a: "Sistema" },
...
export default function TariffClassifyPage() {
  return (
