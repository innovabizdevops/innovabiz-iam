...
const ROWS = [
  { id: "001", c: ["Free Trade Zone-001", "Free Trade Zone Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Free Trade Zone-002", "Free Trade Zone Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Free Trade Zone-003", "Free Trade Zone Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Free Trade Zone-004", "Free Trade Zone Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Free Trade Zone-005", "Free Trade Zone Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Free Trade Zone", ts: "Há 2min", a: "Sistema" },
...
export default function FreeTradeZonePage() {
  return (
