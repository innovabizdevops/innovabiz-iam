...
const ROWS = [
  { id: "001", c: ["Aeo Program-001", "Aeo Program Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Aeo Program-002", "Aeo Program Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Aeo Program-003", "Aeo Program Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Aeo Program-004", "Aeo Program Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Aeo Program-005", "Aeo Program Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Aeo Program", ts: "Há 2min", a: "Sistema" },
...
export default function AeoProgramPage() {
  return (
