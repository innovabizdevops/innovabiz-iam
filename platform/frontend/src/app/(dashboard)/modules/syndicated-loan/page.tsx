...
export default function SyndicatedLoanPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Syndicated Loan</h1><p className="text-sm text-muted-foreground">Syndicated Loan • iBOS Enterprise</p></div>
