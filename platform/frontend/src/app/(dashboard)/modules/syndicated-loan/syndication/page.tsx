...
const ACCENT = "#1e40af";
const MODULE = "Syndicated Loans";
const PAGE = "Syndication";
const KPIS = [{"l":"Total Syndicated Loan","v":"1.218","t":"-0.1%","d":"down"},{"l":"Syndication Ativos","v":"7.602","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"80.3%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"83","t":"+9.3%","d":"up"}];
const COLS = ["ID","Syndication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Syndicated Loan #001","Syndicated Loan #002","7.129","1.260","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Syndicated Loan #002","Syndicated Loan #003","4.298","8.057","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Syndicated Loan #003","Syndicated Loan #004","8.681","4.482","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Syndicated Loan #004","Syndicated Loan #005","1.238","8.467","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Syndicated Loan #005","Syndicated Loan #001","8.470","4.391","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":835},{"label":"Mar","value":735},{"label":"Abr","value":789},{"label":"Mai","value":933},{"label":"Jun","value":893},{"label":"Jul","value":740},{"label":"Ago","value":705},{"label":"Set","value":781},{"label":"Out","value":618},{"label":"Nov","value":858},{"label":"Dez","value":772}];
const MX = 933;
