...
const PAGE = "Sec Trading";
const KPIS = [{"l":"Total Syndicated Loan","v":"164","t":"+10.3%","d":"up"},{"l":"Sec Trading Ativos","v":"8.246","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"89.1%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"76","t":"+4.0%","d":"up"}];
const COLS = ["ID","Sec Trading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Syndicated Loan #001","Syndicated Loan #002","5.844","3.220","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Syndicated Loan #002","Syndicated Loan #003","4.732","5.796","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Syndicated Loan #003","Syndicated Loan #004","4.961","3.174","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Syndicated Loan #004","Syndicated Loan #005","8.139","5.827","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Syndicated Loan #005","Syndicated Loan #001","2.992","5.426","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":526},{"label":"Mar","value":727},{"label":"Abr","value":535},{"label":"Mai","value":523},{"label":"Jun","value":492},{"label":"Jul","value":646},{"label":"Ago","value":591},{"label":"Set","value":732},{"label":"Out","value":782},{"label":"Nov","value":783},{"label":"Dez","value":644}];
const MX = 783;
