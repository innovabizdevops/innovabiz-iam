...
const PAGE = "Agent Admin";
const KPIS = [{"l":"Total Syndicated Loan","v":"2.320","t":"+5.1%","d":"up"},{"l":"Agent Admin Ativos","v":"6.573","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+13.3%","d":"up"}];
const COLS = ["ID","Agent Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Syndicated Loan #001","Syndicated Loan #002","2.324","2.686","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Syndicated Loan #002","Syndicated Loan #003","886","4.835","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Syndicated Loan #003","Syndicated Loan #004","5.358","7.861","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Syndicated Loan #004","Syndicated Loan #005","5.069","1.669","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Syndicated Loan #005","Syndicated Loan #001","7.390","7.600","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":851},{"label":"Mar","value":651},{"label":"Abr","value":737},{"label":"Mai","value":675},{"label":"Jun","value":634},{"label":"Jul","value":841},{"label":"Ago","value":664},{"label":"Set","value":766},{"label":"Out","value":548},{"label":"Nov","value":803},{"label":"Dez","value":517}];
const MX = 851;
