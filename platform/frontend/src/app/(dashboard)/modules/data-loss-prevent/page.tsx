...
/* ═══ DLP Platform Deep — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "1352", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4119", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€113K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "276003352", cells: ["DAT-1352", "DLP Platform Deep Item 1", "17/5/2026", "€3452"], status: "active" as const },
    { id: "276006923", cells: ["DAT-4923", "DLP Platform Deep Item 2", "4/12/2026", "€7023"], status: "pending" as const },
    { id: "276010494", cells: ["DAT-8494", "DLP Platform Deep Item 3", "19/7/2026", "€10 594"], status: "completed" as const },
    { id: "276014065", cells: ["DAT-3065", "DLP Platform Deep Item 4", "6/2/2026", "€14 165"], status: "warning" as const },
    { id: "276017636", cells: ["DAT-6636", "DLP Platform Deep Item 5", "21/9/2026", "€17 736"], status: "active" as const },
];
...
export default function DlpPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">DLP Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • DLP Platform Deep</p>
                    </div>
                </div>
