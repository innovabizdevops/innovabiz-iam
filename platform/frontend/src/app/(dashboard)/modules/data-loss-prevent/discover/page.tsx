...
const PAGE = "Discover";
const KPIS = [{"l":"Dashboards Ativos","v":"2.948","t":"+7.4%","d":"up"},{"l":"Queries/Dia","v":"4892","t":"+1.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.524","t":"+1.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.994","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1643","2026-01-04","7.560","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4977","2026-02-22","2.032","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1916","2026-03-01","4.892","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4850","2026-02-20","1.038","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2169","2026-02-16","7.951","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":735},{"label":"Mar","value":812},{"label":"Abr","value":585},{"label":"Mai","value":655},{"label":"Jun","value":806},{"label":"Jul","value":649},{"label":"Ago","value":491},{"label":"Set","value":847},{"label":"Out","value":781},{"label":"Nov","value":780},{"label":"Dez","value":803}];
const MX = 847;
