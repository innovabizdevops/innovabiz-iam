...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"220","t":"+2.4%","d":"up"},{"l":"Queries/Dia","v":"3919","t":"+2.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.099","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"2.745","t":"+5.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4635","2026-01-10","3.481","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5031","2026-03-04","5.214","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4468","2026-01-16","1.244","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4277","2026-02-27","1.121","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","702","2026-01-06","5.348","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":1064},{"label":"Mar","value":873},{"label":"Abr","value":954},{"label":"Mai","value":756},{"label":"Jun","value":693},{"label":"Jul","value":729},{"label":"Ago","value":720},{"label":"Set","value":837},{"label":"Out","value":860},{"label":"Nov","value":1011},{"label":"Dez","value":822}];
const MX = 1064;
