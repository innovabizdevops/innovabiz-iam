...
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"1.299","t":"+1.8%","d":"up"},{"l":"Queries/Dia","v":"3904","t":"+16.0%","d":"up"},{"l":"Dados Processados (GB)","v":"4.786","t":"+1.0%","d":"up"},{"l":"Utilizadores Analytics","v":"619","t":"+11.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5022","2026-01-27","1.001","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","183","2026-01-14","2.709","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1584","2026-02-13","7.342","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4721","2026-02-20","2.682","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2040","2026-01-10","4.723","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":632},{"label":"Mar","value":618},{"label":"Abr","value":376},{"label":"Mai","value":402},{"label":"Jun","value":611},{"label":"Jul","value":514},{"label":"Ago","value":624},{"label":"Set","value":615},{"label":"Out","value":363},{"label":"Nov","value":335},{"label":"Dez","value":487}];
const MX = 632;
