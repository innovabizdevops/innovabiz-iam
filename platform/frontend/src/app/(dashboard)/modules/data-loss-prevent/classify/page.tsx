...
const ACCENT = "#7f1d1d";
const MODULE = "DLP Platform Deep";
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"4.912","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"820","t":"-4.8%","d":"down"},{"l":"Dados Processados (GB)","v":"4.412","t":"+14.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.260","t":"+12.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3966","2026-03-04","1.485","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1199","2026-02-26","6.837","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1967","2026-03-11","3.780","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3693","2026-02-25","3.815","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2411","2026-01-17","6.752","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":699},{"label":"Mar","value":484},{"label":"Abr","value":606},{"label":"Mai","value":621},{"label":"Jun","value":518},{"label":"Jul","value":690},{"label":"Ago","value":673},{"label":"Set","value":581},{"label":"Out","value":539},{"label":"Nov","value":541},{"label":"Dez","value":506}];
const MX = 699;
