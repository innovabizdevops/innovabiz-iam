...
const PAGE = "Prevent";
const KPIS = [{"l":"Dashboards Ativos","v":"595","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"3281","t":"+4.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.416","t":"-5.7%","d":"down"},{"l":"Utilizadores Analytics","v":"340","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4768","2026-03-05","6.553","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3993","2026-03-06","8.630","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2319","2026-01-27","2.335","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","757","2026-01-07","7.170","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3267","2026-01-06","8.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":570},{"label":"Mar","value":666},{"label":"Abr","value":568},{"label":"Mai","value":585},{"label":"Jun","value":463},{"label":"Jul","value":428},{"label":"Ago","value":419},{"label":"Set","value":523},{"label":"Out","value":539},{"label":"Nov","value":537},{"label":"Dez","value":564}];
const MX = 666;
