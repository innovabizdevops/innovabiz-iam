...
const PAGE = "Route-to-Market";
const KPIS = [{"l":"Total Consumer Goods","v":"3.182","t":"-4.6%","d":"down"},{"l":"Route To Market Ativos","v":"5.617","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"64","t":"-3.4%","d":"down"}];
const COLS = ["ID","Route To Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consumer Goods #001","Consumer Goods #002","1.511","2.890","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Consumer Goods #002","Consumer Goods #003","7.545","8.228","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Consumer Goods #003","Consumer Goods #004","3.661","4.471","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Consumer Goods #004","Consumer Goods #005","4.649","775","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consumer Goods #005","Consumer Goods #001","5.854","5.638","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1019},{"label":"Fev","value":666},{"label":"Mar","value":949},{"label":"Abr","value":667},{"label":"Mai","value":729},{"label":"Jun","value":979},{"label":"Jul","value":833},{"label":"Ago","value":769},{"label":"Set","value":906},{"label":"Out","value":841},{"label":"Nov","value":933},{"label":"Dez","value":792}];
const MX = 1019;
...
export default function RouteToMarketPage() {
    return (
