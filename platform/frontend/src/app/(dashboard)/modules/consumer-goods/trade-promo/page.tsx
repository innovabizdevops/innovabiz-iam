...
const PAGE = "Trade Promotion Mgmt";
const KPIS = [{"l":"Total Consumer Goods","v":"1.440","t":"+15.8%","d":"up"},{"l":"Trade Promotion Mgmt Ativos","v":"6.697","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.4%","d":"up"}];
const COLS = ["ID","Trade Promotion Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consumer Goods #001","Consumer Goods #002","4.835","8.312","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Consumer Goods #002","Consumer Goods #003","7.095","8.325","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Consumer Goods #003","Consumer Goods #004","3.317","342","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Consumer Goods #004","Consumer Goods #005","4.312","1.539","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consumer Goods #005","Consumer Goods #001","4.037","2.568","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":426},{"label":"Mar","value":722},{"label":"Abr","value":404},{"label":"Mai","value":555},{"label":"Jun","value":581},{"label":"Jul","value":346},{"label":"Ago","value":626},{"label":"Set","value":430},{"label":"Out","value":672},{"label":"Nov","value":461},{"label":"Dez","value":730}];
const MX = 730;
