...
const PAGE = "New Product Introduction";
const KPIS = [{"l":"Total Consumer Goods","v":"8.848","t":"+16.0%","d":"up"},{"l":"New Product Introduction Ativos","v":"4.734","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"55","t":"+16.5%","d":"up"}];
const COLS = ["ID","New Product Introduction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consumer Goods #001","Consumer Goods #002","1.413","1.472","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Consumer Goods #002","Consumer Goods #003","2.786","2.303","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Consumer Goods #003","Consumer Goods #004","4.171","4.751","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Consumer Goods #004","Consumer Goods #005","7.744","3.661","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consumer Goods #005","Consumer Goods #001","1.066","3.433","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":593},{"label":"Mar","value":451},{"label":"Abr","value":580},{"label":"Mai","value":365},{"label":"Jun","value":334},{"label":"Jul","value":610},{"label":"Ago","value":452},{"label":"Set","value":602},{"label":"Out","value":281},{"label":"Nov","value":560},{"label":"Dez","value":378}];
const MX = 610;
