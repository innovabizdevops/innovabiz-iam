...
const ACCENT = "#ea580c";
const MODULE = "Consumer Goods";
const PAGE = "Shelf Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"2.052","t":"+6.2%","d":"up"},{"l":"Queries/Dia","v":"215","t":"-4.6%","d":"down"},{"l":"Dados Processados (GB)","v":"8.340","t":"+6.2%","d":"up"},{"l":"Utilizadores Analytics","v":"4.119","t":"+10.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2922","2026-02-17","3.515","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1928","2026-02-15","4.110","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3720","2026-01-23","3.065","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4177","2026-01-08","6.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4667","2026-02-20","132","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":495},{"label":"Mar","value":485},{"label":"Abr","value":781},{"label":"Mai","value":634},{"label":"Jun","value":660},{"label":"Jul","value":781},{"label":"Ago","value":750},{"label":"Set","value":510},{"label":"Out","value":694},{"label":"Nov","value":778},{"label":"Dez","value":681}];
const MX = 781;
