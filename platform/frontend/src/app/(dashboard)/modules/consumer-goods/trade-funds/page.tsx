...
const PAGE = "Trade Fund Mgmt";
const KPIS = [{"l":"Total Consumer Goods","v":"8.989","t":"-2.0%","d":"down"},{"l":"Trade Fund Mgmt Ativos","v":"2.729","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+0.4%","d":"up"}];
const COLS = ["ID","Trade Fund Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Consumer Goods #001","Consumer Goods #002","9.079","7.468","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Consumer Goods #002","Consumer Goods #003","6.294","2.133","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Consumer Goods #003","Consumer Goods #004","9.060","4.167","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Consumer Goods #004","Consumer Goods #005","7.700","7.639","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Consumer Goods #005","Consumer Goods #001","5.274","1.642","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1009},{"label":"Fev","value":1011},{"label":"Mar","value":977},{"label":"Abr","value":715},{"label":"Mai","value":782},{"label":"Jun","value":971},{"label":"Jul","value":904},{"label":"Ago","value":670},{"label":"Set","value":699},{"label":"Out","value":1052},{"label":"Nov","value":661},{"label":"Dez","value":771}];
const MX = 1052;
...
export default function TradeFundsPage() {
    return (
