...
const PAGE = "DSD (Direct Store)";
const KPIS = [{"l":"Pedidos/Dia","v":"4583","t":"+15.5%","d":"up"},{"l":"GMV (€)","v":"€61229","t":"-0.6%","d":"down"},{"l":"Conversão (%)","v":"88.9%","t":"+5.3%","d":"up"},{"l":"AOV (€)","v":"€14633","t":"+2.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 8012.01","3.762","4.684","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 30962.71","4.869","1.106","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33522.61","7.796","758","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 30441.93","4.313","215","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 32293.33","6.809","4.566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":942},{"label":"Fev","value":811},{"label":"Mar","value":1022},{"label":"Abr","value":720},{"label":"Mai","value":944},{"label":"Jun","value":921},{"label":"Jul","value":985},{"label":"Ago","value":940},{"label":"Set","value":953},{"label":"Out","value":788},{"label":"Nov","value":836},{"label":"Dez","value":840}];
const MX = 1022;
