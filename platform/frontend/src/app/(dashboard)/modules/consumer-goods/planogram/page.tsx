...
const PAGE = "Planogram Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.653","t":"-4.6%","d":"down"},{"l":"NC Abertas","v":"7.071","t":"+13.9%","d":"up"},{"l":"Conformidade (%)","v":"67.4%","t":"+5.5%","d":"up"},{"l":"CAPAs Pendentes","v":"8.933","t":"+3.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","138","96.1%","3.910","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.338","72.5%","2.750","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.866","84.3%","1.945","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.977","79.8%","7.789","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.176","73.3%","1.555","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":820},{"label":"Mar","value":873},{"label":"Abr","value":771},{"label":"Mai","value":618},{"label":"Jun","value":894},{"label":"Jul","value":615},{"label":"Ago","value":641},{"label":"Set","value":951},{"label":"Out","value":801},{"label":"Nov","value":840},{"label":"Dez","value":857}];
const MX = 951;
