...
const ACCENT = "#dc2626";
const MODULE = "Privileged Access Mgmt (PAM)";
const PAGE = "Session";
const KPIS = [{"l":"Total Privileged Access","v":"1.697","t":"-5.1%","d":"down"},{"l":"Session Ativos","v":"6.728","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"73.8%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"73","t":"+13.3%","d":"up"}];
const COLS = ["ID","Session","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privileged Access #001","Privileged Access #002","7.499","1.051","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Privileged Access #002","Privileged Access #003","7.750","377","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Privileged Access #003","Privileged Access #004","3.668","3.862","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Privileged Access #004","Privileged Access #005","3.768","6.504","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privileged Access #005","Privileged Access #001","7.588","2.147","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":585},{"label":"Mar","value":529},{"label":"Abr","value":683},{"label":"Mai","value":852},{"label":"Jun","value":785},{"label":"Jul","value":871},{"label":"Ago","value":911},{"label":"Set","value":792},{"label":"Out","value":834},{"label":"Nov","value":918},{"label":"Dez","value":802}];
const MX = 918;
