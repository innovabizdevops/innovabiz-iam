...
/* ═══ Privileged Access Mgmt (PAM) — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "2839", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2462", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€249K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "418079739", cells: ["PRI-3739", "Privileged Access Mgmt (PAM) Item 1", "8/4/2026", "€29 839"], status: "active" as const },
    { id: "418083310", cells: ["PRI-7310", "Privileged Access Mgmt (PAM) Item 2", "23/11/2026", "€33 410"], status: "pending" as const },
    { id: "418086881", cells: ["PRI-1881", "Privileged Access Mgmt (PAM) Item 3", "10/6/2026", "€36 981"], status: "completed" as const },
    { id: "418090452", cells: ["PRI-5452", "Privileged Access Mgmt (PAM) Item 4", "25/1/2026", "€40 552"], status: "warning" as const },
    { id: "418094023", cells: ["PRI-9023", "Privileged Access Mgmt (PAM) Item 5", "12/8/2026", "€44 123"], status: "active" as const },
];
...
export default function PrivilegedAccessMgmtPamPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Privileged Access Mgmt (PAM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Privileged Access Mgmt (PAM)</p>
                    </div>
                </div>
