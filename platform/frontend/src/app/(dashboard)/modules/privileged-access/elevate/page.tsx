...
const PAGE = "Elevate";
const KPIS = [{"l":"Total Privileged Access","v":"2.978","t":"-4.1%","d":"down"},{"l":"Elevate Ativos","v":"2.566","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"74","t":"+4.2%","d":"up"}];
const COLS = ["ID","Elevate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privileged Access #001","Privileged Access #002","2.017","6.333","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Privileged Access #002","Privileged Access #003","4.684","3.359","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Privileged Access #003","Privileged Access #004","6.462","7.378","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Privileged Access #004","Privileged Access #005","3.788","9.004","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privileged Access #005","Privileged Access #001","3.057","3.339","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":535},{"label":"Mar","value":770},{"label":"Abr","value":778},{"label":"Mai","value":397},{"label":"Jun","value":594},{"label":"Jul","value":525},{"label":"Ago","value":552},{"label":"Set","value":429},{"label":"Out","value":506},{"label":"Nov","value":564},{"label":"Dez","value":465}];
const MX = 778;
