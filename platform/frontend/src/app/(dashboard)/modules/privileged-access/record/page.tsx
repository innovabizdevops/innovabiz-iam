...
const PAGE = "Record";
const KPIS = [{"l":"Total Privileged Access","v":"5.658","t":"+5.2%","d":"up"},{"l":"Record Ativos","v":"2.311","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"78.0%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+4.4%","d":"up"}];
const COLS = ["ID","Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privileged Access #001","Privileged Access #002","1.843","3.421","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Privileged Access #002","Privileged Access #003","6.591","9.037","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Privileged Access #003","Privileged Access #004","2.832","5.242","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Privileged Access #004","Privileged Access #005","7.047","4.337","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privileged Access #005","Privileged Access #001","1.522","3.117","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":770},{"label":"Mar","value":429},{"label":"Abr","value":803},{"label":"Mai","value":492},{"label":"Jun","value":562},{"label":"Jul","value":680},{"label":"Ago","value":594},{"label":"Set","value":455},{"label":"Out","value":719},{"label":"Nov","value":689},{"label":"Dez","value":435}];
const MX = 803;
