...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.595","t":"+14.1%","d":"up"},{"l":"NC Abertas","v":"913","t":"+11.9%","d":"up"},{"l":"Conformidade (%)","v":"78.2%","t":"+8.5%","d":"up"},{"l":"CAPAs Pendentes","v":"4.097","t":"-0.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.734","76.7%","4.002","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.278","78.3%","6.225","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","9.006","71.7%","6.053","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","892","83.0%","3.314","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.867","94.4%","6.643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":623},{"label":"Mar","value":616},{"label":"Abr","value":751},{"label":"Mai","value":679},{"label":"Jun","value":409},{"label":"Jul","value":648},{"label":"Ago","value":767},{"label":"Set","value":418},{"label":"Out","value":535},{"label":"Nov","value":458},{"label":"Dez","value":650}];
const MX = 767;
