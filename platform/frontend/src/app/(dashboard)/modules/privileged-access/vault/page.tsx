...
const PAGE = "Vault";
const KPIS = [{"l":"Total Privileged Access","v":"5.541","t":"+0.9%","d":"up"},{"l":"Vault Ativos","v":"1.392","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+0.4%","d":"up"}];
const COLS = ["ID","Vault","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Privileged Access #001","Privileged Access #002","8.730","4.577","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Privileged Access #002","Privileged Access #003","3.612","8.963","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Privileged Access #003","Privileged Access #004","1.986","6.992","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Privileged Access #004","Privileged Access #005","2.568","8.880","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Privileged Access #005","Privileged Access #001","1.787","2.082","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1029},{"label":"Fev","value":738},{"label":"Mar","value":741},{"label":"Abr","value":939},{"label":"Mai","value":967},{"label":"Jun","value":921},{"label":"Jul","value":904},{"label":"Ago","value":837},{"label":"Set","value":675},{"label":"Out","value":973},{"label":"Nov","value":1062},{"label":"Dez","value":939}];
const MX = 1062;
