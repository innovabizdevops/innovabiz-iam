...
const PAGE = "Radiation";
const KPIS = [{"l":"Total Oncology Mgmt","v":"1.493","t":"-1.2%","d":"down"},{"l":"Radiation Ativos","v":"7.220","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"69.3%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+12.0%","d":"up"}];
const COLS = ["ID","Radiation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oncology Mgmt #001","Oncology Mgmt #002","7.799","8.359","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Oncology Mgmt #002","Oncology Mgmt #003","7.101","9.031","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Oncology Mgmt #003","Oncology Mgmt #004","4.467","6.347","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Oncology Mgmt #004","Oncology Mgmt #005","1.052","1.173","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oncology Mgmt #005","Oncology Mgmt #001","1.886","2.244","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":874},{"label":"Mar","value":570},{"label":"Abr","value":862},{"label":"Mai","value":622},{"label":"Jun","value":724},{"label":"Jul","value":627},{"label":"Ago","value":681},{"label":"Set","value":576},{"label":"Out","value":505},{"label":"Nov","value":713},{"label":"Dez","value":573}];
const MX = 874;
