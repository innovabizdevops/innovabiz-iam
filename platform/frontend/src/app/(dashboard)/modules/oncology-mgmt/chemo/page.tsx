...
const PAGE = "Chemotherapy";
const KPIS = [{"l":"Total Oncology Mgmt","v":"8.637","t":"+17.3%","d":"up"},{"l":"Chemotherapy Ativos","v":"1.394","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"67.5%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"67","t":"+16.9%","d":"up"}];
const COLS = ["ID","Chemotherapy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oncology Mgmt #001","Oncology Mgmt #002","5.438","8.969","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Oncology Mgmt #002","Oncology Mgmt #003","1.775","640","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Oncology Mgmt #003","Oncology Mgmt #004","4.713","5.556","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Oncology Mgmt #004","Oncology Mgmt #005","5.458","2.878","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oncology Mgmt #005","Oncology Mgmt #001","4.787","407","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":536},{"label":"Mar","value":341},{"label":"Abr","value":351},{"label":"Mai","value":537},{"label":"Jun","value":594},{"label":"Jul","value":640},{"label":"Ago","value":327},{"label":"Set","value":402},{"label":"Out","value":382},{"label":"Nov","value":516},{"label":"Dez","value":596}];
const MX = 640;
