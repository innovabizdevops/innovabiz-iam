...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"2.190","t":"+13.9%","d":"up"},{"l":"Chamadas/Hora","v":"1299","t":"+13.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.0%","t":"+3.5%","d":"up"},{"l":"Latência Média (ms)","v":"173ms","t":"+11.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.710","7.845","86.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","587","2.464","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.818","2.444","89.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.583","4.443","90.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.034","6.651","77.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":662},{"label":"Mar","value":646},{"label":"Abr","value":658},{"label":"Mai","value":844},{"label":"Jun","value":686},{"label":"Jul","value":764},{"label":"Ago","value":791},{"label":"Set","value":727},{"label":"Out","value":622},{"label":"Nov","value":496},{"label":"Dez","value":498}];
const MX = 864;
