...
const ACCENT = "#6366f1";
const MODULE = "Oncology Management";
const PAGE = "Genomics";
const KPIS = [{"l":"Total Oncology Mgmt","v":"7.515","t":"-3.4%","d":"down"},{"l":"Genomics Ativos","v":"7.509","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"61","t":"-2.5%","d":"down"}];
const COLS = ["ID","Genomics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oncology Mgmt #001","Oncology Mgmt #002","2.805","1.129","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Oncology Mgmt #002","Oncology Mgmt #003","3.179","5.834","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Oncology Mgmt #003","Oncology Mgmt #004","1.900","2.664","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Oncology Mgmt #004","Oncology Mgmt #005","5.476","6.791","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oncology Mgmt #005","Oncology Mgmt #001","1.616","2.164","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":491},{"label":"Mar","value":791},{"label":"Abr","value":477},{"label":"Mai","value":498},{"label":"Jun","value":768},{"label":"Jul","value":538},{"label":"Ago","value":445},{"label":"Set","value":600},{"label":"Out","value":539},{"label":"Nov","value":553},{"label":"Dez","value":509}];
const MX = 791;
