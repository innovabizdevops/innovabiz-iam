...
const PAGE = "Registry";
const KPIS = [{"l":"Total Oncology Mgmt","v":"5.397","t":"+16.1%","d":"up"},{"l":"Registry Ativos","v":"6.246","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+11.1%","d":"up"}];
const COLS = ["ID","Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oncology Mgmt #001","Oncology Mgmt #002","7.986","3.337","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Oncology Mgmt #002","Oncology Mgmt #003","3.877","2.281","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Oncology Mgmt #003","Oncology Mgmt #004","6.575","6.900","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Oncology Mgmt #004","Oncology Mgmt #005","805","6.086","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oncology Mgmt #005","Oncology Mgmt #001","4.095","341","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":607},{"label":"Mar","value":760},{"label":"Abr","value":735},{"label":"Mai","value":925},{"label":"Jun","value":757},{"label":"Jul","value":757},{"label":"Ago","value":669},{"label":"Set","value":823},{"label":"Out","value":758},{"label":"Nov","value":857},{"label":"Dez","value":563}];
const MX = 925;
