...
const PAGE = "Policy Rules";
const KPIS = [{"l":"Total Dlp","v":"2.494","t":"+12.4%","d":"up"},{"l":"Policy Rules Ativos","v":"3.333","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+0.4%","d":"up"}];
const COLS = ["ID","Policy Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dlp #001","Dlp #002","845","8.874","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Dlp #002","Dlp #003","1.936","5.697","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Dlp #003","Dlp #004","4.149","607","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Dlp #004","Dlp #005","5.322","3.006","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dlp #005","Dlp #001","3.248","8.635","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":761},{"label":"Mar","value":869},{"label":"Abr","value":685},{"label":"Mai","value":742},{"label":"Jun","value":814},{"label":"Jul","value":647},{"label":"Ago","value":726},{"label":"Set","value":694},{"label":"Out","value":855},{"label":"Nov","value":768},{"label":"Dez","value":900}];
const MX = 900;
