...
const PAGE = "Email DLP";
const KPIS = [{"l":"Total Dlp","v":"309","t":"-5.5%","d":"down"},{"l":"Email DLP Ativos","v":"7.626","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"63","t":"+1.4%","d":"up"}];
const COLS = ["ID","Email DLP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dlp #001","Dlp #002","6.630","2.661","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Dlp #002","Dlp #003","8.036","7.535","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Dlp #003","Dlp #004","3.162","4.189","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Dlp #004","Dlp #005","7.555","2.904","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dlp #005","Dlp #001","8.440","624","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":534},{"label":"Mar","value":706},{"label":"Abr","value":613},{"label":"Mai","value":516},{"label":"Jun","value":674},{"label":"Jul","value":622},{"label":"Ago","value":451},{"label":"Set","value":756},{"label":"Out","value":487},{"label":"Nov","value":534},{"label":"Dez","value":440}];
const MX = 756;
