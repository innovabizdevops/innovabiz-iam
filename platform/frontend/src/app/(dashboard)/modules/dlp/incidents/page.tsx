...
const KPIS = [{"l":"Tickets Abertos","v":"4.956","t":"+1.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.1%","t":"+16.7%","d":"up"},{"l":"MTTR (h)","v":"55h","t":"+8.3%","d":"up"},{"l":"Satisfação (%)","v":"77.6%","t":"+8.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.048","5.006","316","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.388","7.018","3.016","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.652","343","222","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.426","7.134","8.113","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.516","6.638","5.785","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":472},{"label":"Fev","value":388},{"label":"Mar","value":606},{"label":"Abr","value":392},{"label":"Mai","value":570},{"label":"Jun","value":439},{"label":"Jul","value":706},{"label":"Ago","value":677},{"label":"Set","value":598},{"label":"Out","value":394},{"label":"Nov","value":505},{"label":"Dez","value":515}];
const MX = 706;
