...
const PAGE = "Cloud DLP";
const KPIS = [{"l":"Total Dlp","v":"6.772","t":"+1.2%","d":"up"},{"l":"Cloud DLP Ativos","v":"1.925","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"84.2%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"88","t":"-0.1%","d":"down"}];
const COLS = ["ID","Cloud DLP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dlp #001","Dlp #002","8.887","1.821","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Dlp #002","Dlp #003","5.054","1.077","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Dlp #003","Dlp #004","6.392","415","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Dlp #004","Dlp #005","1.536","2.521","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dlp #005","Dlp #001","8.959","4.919","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":694},{"label":"Mar","value":866},{"label":"Abr","value":695},{"label":"Mai","value":745},{"label":"Jun","value":840},{"label":"Jul","value":881},{"label":"Ago","value":725},{"label":"Set","value":593},{"label":"Out","value":620},{"label":"Nov","value":538},{"label":"Dez","value":601}];
const MX = 881;
