...
const ACCENT = "#b45309";
const MODULE = "Data Loss Prevention";
const PAGE = "Watermarking";
const KPIS = [{"l":"Riscos Identificados","v":"3.700","t":"-4.1%","d":"down"},{"l":"Mitigações Ativas","v":"1.564","t":"+15.0%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"-4.7%","d":"down"},{"l":"Incidentes YTD","v":"3.709","t":"-0.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.699","8.619","3.426","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.531","6.037","8.119","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.761","2.637","9.081","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","816","6.761","4.493","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.598","1.467","5.666","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":652},{"label":"Mar","value":657},{"label":"Abr","value":554},{"label":"Mai","value":459},{"label":"Jun","value":681},{"label":"Jul","value":627},{"label":"Ago","value":540},{"label":"Set","value":451},{"label":"Out","value":604},{"label":"Nov","value":473},{"label":"Dez","value":685}];
const MX = 685;
