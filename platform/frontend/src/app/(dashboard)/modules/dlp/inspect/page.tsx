...
const PAGE = "Content Inspect";
const KPIS = [{"l":"Total Dlp","v":"7.609","t":"+11.6%","d":"up"},{"l":"Content Inspect Ativos","v":"8.563","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"66","t":"+2.3%","d":"up"}];
const COLS = ["ID","Content Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dlp #001","Dlp #002","4.721","2.040","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Dlp #002","Dlp #003","7.217","328","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Dlp #003","Dlp #004","4.003","5.923","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Dlp #004","Dlp #005","5.550","1.645","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dlp #005","Dlp #001","6.215","4.149","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":511},{"label":"Mar","value":599},{"label":"Abr","value":571},{"label":"Mai","value":656},{"label":"Jun","value":474},{"label":"Jul","value":623},{"label":"Ago","value":532},{"label":"Set","value":722},{"label":"Out","value":392},{"label":"Nov","value":596},{"label":"Dez","value":687}];
const MX = 722;
