...
const PAGE = "Endpoint DLP";
const KPIS = [{"l":"Total Dlp","v":"4.336","t":"+0.8%","d":"up"},{"l":"Endpoint DLP Ativos","v":"2.242","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"70.2%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.7%","d":"up"}];
const COLS = ["ID","Endpoint DLP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dlp #001","Dlp #002","6.130","7.117","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Dlp #002","Dlp #003","5.390","1.586","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Dlp #003","Dlp #004","303","1.788","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Dlp #004","Dlp #005","3.222","3.339","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dlp #005","Dlp #001","6.570","4.818","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":590},{"label":"Mar","value":376},{"label":"Abr","value":389},{"label":"Mai","value":640},{"label":"Jun","value":634},{"label":"Jul","value":534},{"label":"Ago","value":497},{"label":"Set","value":576},{"label":"Out","value":496},{"label":"Nov","value":619},{"label":"Dez","value":493}];
const MX = 640;
