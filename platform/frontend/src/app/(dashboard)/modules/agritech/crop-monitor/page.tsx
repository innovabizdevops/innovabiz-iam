...
const PAGE = "Crop Monitoring";
const KPIS = [{"l":"Total Agritech","v":"8.596","t":"+1.4%","d":"up"},{"l":"Crop Monitoring Ativos","v":"6.715","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"83","t":"+4.0%","d":"up"}];
const COLS = ["ID","Crop Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agritech #001","Agritech #002","6.463","4.880","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Agritech #002","Agritech #003","4.212","8.113","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Agritech #003","Agritech #004","1.066","2.518","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Agritech #004","Agritech #005","4.410","5.971","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agritech #005","Agritech #001","7.423","4.855","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":590},{"label":"Mar","value":910},{"label":"Abr","value":828},{"label":"Mai","value":720},{"label":"Jun","value":824},{"label":"Jul","value":542},{"label":"Ago","value":665},{"label":"Set","value":901},{"label":"Out","value":599},{"label":"Nov","value":746},{"label":"Dez","value":838}];
const MX = 910;
