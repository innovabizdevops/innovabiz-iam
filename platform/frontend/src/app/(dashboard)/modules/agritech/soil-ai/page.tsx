...
const ACCENT = "#65a30d";
const MODULE = "AgriTech & Food Security";
const PAGE = "Soil Analysis AI";
const KPIS = [{"l":"Dashboards Ativos","v":"441","t":"+5.5%","d":"up"},{"l":"Queries/Dia","v":"3751","t":"+2.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.040","t":"-5.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.392","t":"+7.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4214","2026-02-10","6.099","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3961","2026-01-07","2.557","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3216","2026-03-17","9.045","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","606","2026-01-02","7.921","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3935","2026-02-01","4.145","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":568},{"label":"Mar","value":665},{"label":"Abr","value":577},{"label":"Mai","value":438},{"label":"Jun","value":497},{"label":"Jul","value":823},{"label":"Ago","value":748},{"label":"Set","value":609},{"label":"Out","value":516},{"label":"Nov","value":709},{"label":"Dez","value":723}];
const MX = 823;
...
export default function SoilAiPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#65a30d'}}>AI</span></h1>
                </div>
