...
const PAGE = "Drone Monitoring";
const KPIS = [{"l":"Total Agritech","v":"251","t":"-1.1%","d":"down"},{"l":"Drone Monitoring Ativos","v":"8.283","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+4.4%","d":"up"}];
const COLS = ["ID","Drone Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agritech #001","Agritech #002","7.602","1.053","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Agritech #002","Agritech #003","5.724","4.302","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Agritech #003","Agritech #004","7.829","1.370","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Agritech #004","Agritech #005","645","8.452","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agritech #005","Agritech #001","5.084","8.850","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":434},{"label":"Mar","value":618},{"label":"Abr","value":378},{"label":"Mai","value":608},{"label":"Jun","value":605},{"label":"Jul","value":256},{"label":"Ago","value":595},{"label":"Set","value":322},{"label":"Out","value":375},{"label":"Nov","value":449},{"label":"Dez","value":583}];
const MX = 618;
