...
const PAGE = "Supply Chain Trace";
const KPIS = [{"l":"Total Agritech","v":"9.070","t":"-0.7%","d":"down"},{"l":"Supply Chain Trace Ativos","v":"6.345","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+8.9%","d":"up"}];
const COLS = ["ID","Supply Chain Trace","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agritech #001","Agritech #002","394","7.963","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Agritech #002","Agritech #003","5.543","4.909","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Agritech #003","Agritech #004","4.237","6.823","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Agritech #004","Agritech #005","3.094","4.800","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agritech #005","Agritech #001","2.259","3.830","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":590},{"label":"Mar","value":287},{"label":"Abr","value":273},{"label":"Mai","value":514},{"label":"Jun","value":526},{"label":"Jul","value":488},{"label":"Ago","value":546},{"label":"Set","value":609},{"label":"Out","value":235},{"label":"Nov","value":550},{"label":"Dez","value":454}];
const MX = 609;
