...
const PAGE = "Capacity";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.258","t":"+16.2%","d":"up"},{"l":"NC Abertas","v":"8.894","t":"-4.2%","d":"down"},{"l":"Conformidade (%)","v":"74.3%","t":"+9.7%","d":"up"},{"l":"CAPAs Pendentes","v":"7.705","t":"+7.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.279","85.6%","795","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.439","70.5%","6.916","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.214","74.5%","8.698","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.180","73.6%","7.020","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.802","72.7%","4.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":261},{"label":"Fev","value":287},{"label":"Mar","value":439},{"label":"Abr","value":529},{"label":"Mai","value":583},{"label":"Jun","value":603},{"label":"Jul","value":485},{"label":"Ago","value":383},{"label":"Set","value":282},{"label":"Out","value":614},{"label":"Nov","value":613},{"label":"Dez","value":242}];
const MX = 614;
