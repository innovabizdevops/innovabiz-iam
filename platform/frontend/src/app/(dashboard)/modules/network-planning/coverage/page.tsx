...
const ACCENT = "#c2410c";
const MODULE = "Network Planning";
const PAGE = "Coverage";
const KPIS = [{"l":"Total Network Planning","v":"8.868","t":"+8.7%","d":"up"},{"l":"Coverage Ativos","v":"1.805","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"67.7%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"63","t":"+9.8%","d":"up"}];
const COLS = ["ID","Coverage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Network Planning #001","Network Planning #002","3.565","7.846","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Network Planning #002","Network Planning #003","5.138","9.013","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Planning #003","Network Planning #004","3.512","4.241","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Network Planning #004","Network Planning #005","2.959","3.568","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Network Planning #005","Network Planning #001","3.975","2.064","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":705},{"label":"Mar","value":554},{"label":"Abr","value":885},{"label":"Mai","value":621},{"label":"Jun","value":749},{"label":"Jul","value":673},{"label":"Ago","value":532},{"label":"Set","value":861},{"label":"Out","value":833},{"label":"Nov","value":588},{"label":"Dez","value":723}];
const MX = 885;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c2410c'}}>GIS</span></h1>
                </div>
