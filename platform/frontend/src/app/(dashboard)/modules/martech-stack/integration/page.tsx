...
const PAGE = "Integration Map";
const KPIS = [{"l":"Integrações Ativas","v":"4.104","t":"-1.5%","d":"down"},{"l":"Chamadas/Hora","v":"1041","t":"+15.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.6%","t":"+3.4%","d":"up"},{"l":"Latência Média (ms)","v":"156ms","t":"+12.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","639","710","72.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.938","1.099","94.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.459","5.923","73.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.538","471","72.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.645","7.194","95.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":625},{"label":"Mar","value":381},{"label":"Abr","value":649},{"label":"Mai","value":360},{"label":"Jun","value":615},{"label":"Jul","value":301},{"label":"Ago","value":570},{"label":"Set","value":597},{"label":"Out","value":512},{"label":"Nov","value":283},{"label":"Dez","value":356}];
const MX = 649;
