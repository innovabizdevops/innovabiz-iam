...
const PAGE = "Vendor Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.569","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"5043","t":"-5.8%","d":"down"},{"l":"Dados Processados (GB)","v":"8.119","t":"+2.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.996","t":"+4.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","455","2026-03-16","3.072","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4042","2026-01-02","5.971","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4709","2026-01-24","7.459","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3686","2026-02-18","843","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1134","2026-01-13","5.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":594},{"label":"Mar","value":586},{"label":"Abr","value":722},{"label":"Mai","value":550},{"label":"Jun","value":563},{"label":"Jul","value":544},{"label":"Ago","value":661},{"label":"Set","value":526},{"label":"Out","value":674},{"label":"Nov","value":713},{"label":"Dez","value":659}];
const MX = 722;
