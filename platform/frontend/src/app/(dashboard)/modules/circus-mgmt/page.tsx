...
/* ═══ Circus Management — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "2556", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2429", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€65K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+14%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2099416256", cells: ["CIR-5256", "Circus Management Item 1", "1/9/2026", "€16 356"], status: "active" as const },
    { id: "2099419827", cells: ["CIR-8827", "Circus Management Item 2", "16/4/2026", "€19 927"], status: "pending" as const },
    { id: "2099423398", cells: ["CIR-3398", "Circus Management Item 3", "3/11/2026", "€23 498"], status: "completed" as const },
    { id: "2099426969", cells: ["CIR-6969", "Circus Management Item 4", "18/6/2026", "€27 069"], status: "warning" as const },
    { id: "2099430540", cells: ["CIR-1540", "Circus Management Item 5", "5/1/2026", "€30 640"], status: "active" as const },
];
...
export default function CircusManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Circus Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Circus Management</p>
                    </div>
                </div>
