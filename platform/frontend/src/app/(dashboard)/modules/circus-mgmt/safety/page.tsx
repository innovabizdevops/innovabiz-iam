...
const PAGE = "Safety";
const KPIS = [{"l":"Total Circus Mgmt","v":"2.927","t":"+5.9%","d":"up"},{"l":"Safety Ativos","v":"4.635","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"65.9%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"71","t":"+17.4%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Circus Mgmt #001","Circus Mgmt #002","4.457","6.625","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Circus Mgmt #002","Circus Mgmt #003","984","6.168","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Circus Mgmt #003","Circus Mgmt #004","581","2.834","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Circus Mgmt #004","Circus Mgmt #005","6.856","8.743","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Circus Mgmt #005","Circus Mgmt #001","7.486","7.325","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":726},{"label":"Mar","value":656},{"label":"Abr","value":621},{"label":"Mai","value":629},{"label":"Jun","value":529},{"label":"Jul","value":380},{"label":"Ago","value":437},{"label":"Set","value":342},{"label":"Out","value":615},{"label":"Nov","value":512},{"label":"Dez","value":621}];
const MX = 726;
