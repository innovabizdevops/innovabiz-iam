...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"384","t":"-5.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"78.1%","t":"+13.3%","d":"up"},{"l":"MTTR (h)","v":"203h","t":"+4.0%","d":"up"},{"l":"Satisfação (%)","v":"68.5%","t":"-3.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","812","6.626","3.448","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.124","5.785","1.920","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.628","6.762","352","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.193","7.109","6.019","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.916","6.538","4.484","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":349},{"label":"Mar","value":416},{"label":"Abr","value":662},{"label":"Mai","value":646},{"label":"Jun","value":450},{"label":"Jul","value":611},{"label":"Ago","value":614},{"label":"Set","value":650},{"label":"Out","value":448},{"label":"Nov","value":719},{"label":"Dez","value":526}];
const MX = 719;
