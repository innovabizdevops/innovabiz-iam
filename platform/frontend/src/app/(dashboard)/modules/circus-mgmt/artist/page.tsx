...
const PAGE = "Artist";
const KPIS = [{"l":"Total Circus Mgmt","v":"2.788","t":"+2.8%","d":"up"},{"l":"Artist Ativos","v":"7.479","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"92","t":"-4.9%","d":"down"}];
const COLS = ["ID","Artist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Circus Mgmt #001","Circus Mgmt #002","806","1.747","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Circus Mgmt #002","Circus Mgmt #003","6.652","8.646","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Circus Mgmt #003","Circus Mgmt #004","426","405","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Circus Mgmt #004","Circus Mgmt #005","7.333","8.824","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Circus Mgmt #005","Circus Mgmt #001","1.102","2.391","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":727},{"label":"Mar","value":681},{"label":"Abr","value":645},{"label":"Mai","value":604},{"label":"Jun","value":643},{"label":"Jul","value":669},{"label":"Ago","value":587},{"label":"Set","value":568},{"label":"Out","value":621},{"label":"Nov","value":850},{"label":"Dez","value":582}];
const MX = 850;
