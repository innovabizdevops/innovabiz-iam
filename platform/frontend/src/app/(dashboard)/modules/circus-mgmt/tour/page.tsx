...
const PAGE = "Tour";
const KPIS = [{"l":"Total Circus Mgmt","v":"3.554","t":"+16.8%","d":"up"},{"l":"Tour Ativos","v":"8.658","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"86.7%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"67","t":"-2.7%","d":"down"}];
const COLS = ["ID","Tour","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Circus Mgmt #001","Circus Mgmt #002","1.660","7.377","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Circus Mgmt #002","Circus Mgmt #003","6.356","2.856","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Circus Mgmt #003","Circus Mgmt #004","826","9.050","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Circus Mgmt #004","Circus Mgmt #005","4.082","1.773","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Circus Mgmt #005","Circus Mgmt #001","6.098","936","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":767},{"label":"Mar","value":637},{"label":"Abr","value":468},{"label":"Mai","value":739},{"label":"Jun","value":706},{"label":"Jul","value":490},{"label":"Ago","value":706},{"label":"Set","value":463},{"label":"Out","value":500},{"label":"Nov","value":760},{"label":"Dez","value":718}];
const MX = 767;
