...
const ACCENT = "#dc2626";
const MODULE = "Circus Management";
const PAGE = "Venue";
const KPIS = [{"l":"Total Circus Mgmt","v":"3.401","t":"+16.6%","d":"up"},{"l":"Venue Ativos","v":"5.039","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"88","t":"+12.3%","d":"up"}];
const COLS = ["ID","Venue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Circus Mgmt #001","Circus Mgmt #002","1.480","6.682","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Circus Mgmt #002","Circus Mgmt #003","7.016","3.810","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Circus Mgmt #003","Circus Mgmt #004","5.982","6.868","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Circus Mgmt #004","Circus Mgmt #005","1.296","7.580","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Circus Mgmt #005","Circus Mgmt #001","2.497","1.549","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":618},{"label":"Mar","value":822},{"label":"Abr","value":798},{"label":"Mai","value":672},{"label":"Jun","value":828},{"label":"Jul","value":787},{"label":"Ago","value":573},{"label":"Set","value":822},{"label":"Out","value":796},{"label":"Nov","value":627},{"label":"Dez","value":950}];
const MX = 950;
