...
const PAGE = "Customer";
const KPIS = [{"l":"Total Utility Billing","v":"1.432","t":"+17.4%","d":"up"},{"l":"Customer Ativos","v":"€47098","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"76.6%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"79","t":"+4.7%","d":"up"}];
const COLS = ["ID","Customer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utility Billing #001","€ 20088.72","1.591","3.065","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Utility Billing #002","€ 12040.95","798","6.663","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Utility Billing #003","€ 33107.40","5.069","4.772","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Utility Billing #004","€ 33702.83","1.208","978","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utility Billing #005","€ 47352.28","5.382","4.561","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":772},{"label":"Mar","value":589},{"label":"Abr","value":643},{"label":"Mai","value":662},{"label":"Jun","value":721},{"label":"Jul","value":847},{"label":"Ago","value":708},{"label":"Set","value":780},{"label":"Out","value":680},{"label":"Nov","value":584},{"label":"Dez","value":835}];
const MX = 847;
