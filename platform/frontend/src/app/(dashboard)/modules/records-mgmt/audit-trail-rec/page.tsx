...
const ROWS = [
  { id: "001", c: ["Audit Trail Rec-001", "Audit Trail Rec Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Audit Trail Rec-002", "Audit Trail Rec Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Audit Trail Rec-003", "Audit Trail Rec Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Audit Trail Rec-004", "Audit Trail Rec Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Audit Trail Rec-005", "Audit Trail Rec Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Audit Trail Rec", ts: "Há 2min", a: "Sistema" },
...
export default function AuditTrailRecPage() {
  return (
