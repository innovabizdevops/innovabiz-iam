...
const ROWS = [
  { id: "001", c: ["Record Declare-001", "Record Declare Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Record Declare-002", "Record Declare Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Record Declare-003", "Record Declare Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Record Declare-004", "Record Declare Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Record Declare-005", "Record Declare Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Record Declare", ts: "Há 2min", a: "Sistema" },
...
export default function RecordDeclarePage() {
  return (
