...
const ROWS = [
  { id: "001", c: ["Archive Transfer-001", "Archive Transfer Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Archive Transfer-002", "Archive Transfer Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Archive Transfer-003", "Archive Transfer Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Archive Transfer-004", "Archive Transfer Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Archive Transfer-005", "Archive Transfer Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Archive Transfer", ts: "Há 2min", a: "Sistema" },
...
export default function ArchiveTransferPage() {
  return (
