...
const ROWS = [
  { id: "001", c: ["Retention Schedule-001", "Retention Schedule Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Retention Schedule-002", "Retention Schedule Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Retention Schedule-003", "Retention Schedule Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Retention Schedule-004", "Retention Schedule Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Retention Schedule-005", "Retention Schedule Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Retention Schedule", ts: "Há 2min", a: "Sistema" },
