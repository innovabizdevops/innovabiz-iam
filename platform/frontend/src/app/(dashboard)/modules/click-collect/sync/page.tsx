...
const PAGE = "Order Sync";
const KPIS = [{"l":"Integrações Ativas","v":"7.326","t":"+13.8%","d":"up"},{"l":"Chamadas/Hora","v":"4617","t":"+1.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"69.8%","t":"+16.8%","d":"up"},{"l":"Latência Média (ms)","v":"187ms","t":"+14.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.124","5.496","98.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.864","8.580","91.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.608","520","91.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.725","8.229","89.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.643","5.987","93.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":561},{"label":"Mar","value":636},{"label":"Abr","value":704},{"label":"Mai","value":755},{"label":"Jun","value":396},{"label":"Jul","value":436},{"label":"Ago","value":674},{"label":"Set","value":390},{"label":"Out","value":511},{"label":"Nov","value":413},{"label":"Dez","value":677}];
const MX = 755;
