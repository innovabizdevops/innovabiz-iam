...
const PAGE = "Notify Ready";
const KPIS = [{"l":"Notificações Enviadas","v":"643","t":"+0.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"89.5%","t":"+8.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"71.9%","t":"+5.5%","d":"up"},{"l":"Escalações","v":"5.702","t":"+0.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.690","76.6%","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.272","99.9%","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.956","71.3%","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.611","90.2%","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.597","76.5%","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":520},{"label":"Mar","value":836},{"label":"Abr","value":521},{"label":"Mai","value":795},{"label":"Jun","value":647},{"label":"Jul","value":702},{"label":"Ago","value":495},{"label":"Set","value":842},{"label":"Out","value":810},{"label":"Nov","value":466},{"label":"Dez","value":476}];
const MX = 842;
