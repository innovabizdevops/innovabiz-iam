...
const PAGE = "Returns";
const KPIS = [{"l":"Total Click Collect","v":"5.112","t":"+11.4%","d":"up"},{"l":"Returns Ativos","v":"3.736","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"86","t":"-0.4%","d":"down"}];
const COLS = ["ID","Returns","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Click Collect #001","Click Collect #002","3.785","5.208","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Click Collect #002","Click Collect #003","4.984","5.385","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Click Collect #003","Click Collect #004","4.660","8.678","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Click Collect #004","Click Collect #005","2.229","1.173","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Click Collect #005","Click Collect #001","5.968","6.043","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":857},{"label":"Mar","value":741},{"label":"Abr","value":831},{"label":"Mai","value":831},{"label":"Jun","value":812},{"label":"Jul","value":789},{"label":"Ago","value":803},{"label":"Set","value":921},{"label":"Out","value":922},{"label":"Nov","value":921},{"label":"Dez","value":704}];
const MX = 922;
