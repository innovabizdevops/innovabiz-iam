...
const PAGE = "Curbside";
const KPIS = [{"l":"Total Click Collect","v":"5.832","t":"+11.7%","d":"up"},{"l":"Curbside Ativos","v":"5.406","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"82","t":"+15.7%","d":"up"}];
const COLS = ["ID","Curbside","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Click Collect #001","Click Collect #002","5.267","7.000","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Click Collect #002","Click Collect #003","5.125","5.347","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Click Collect #003","Click Collect #004","5.179","7.496","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Click Collect #004","Click Collect #005","4.747","5.424","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Click Collect #005","Click Collect #001","2.534","1.285","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":976},{"label":"Fev","value":922},{"label":"Mar","value":834},{"label":"Abr","value":793},{"label":"Mai","value":1032},{"label":"Jun","value":912},{"label":"Jul","value":992},{"label":"Ago","value":1044},{"label":"Set","value":1034},{"label":"Out","value":1043},{"label":"Nov","value":944},{"label":"Dez","value":778}];
const MX = 1044;
