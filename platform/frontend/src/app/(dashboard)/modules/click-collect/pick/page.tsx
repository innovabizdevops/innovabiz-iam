...
const ACCENT = "#7c3aed";
const MODULE = "Click & Collect";
const PAGE = "Pick Process";
const KPIS = [{"l":"Total Click Collect","v":"6.743","t":"+6.8%","d":"up"},{"l":"Pick Process Ativos","v":"7.762","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"83","t":"+10.5%","d":"up"}];
const COLS = ["ID","Pick Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Click Collect #001","Click Collect #002","5.824","4.017","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Click Collect #002","Click Collect #003","3.108","5.069","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Click Collect #003","Click Collect #004","7.194","4.655","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Click Collect #004","Click Collect #005","1.052","1.276","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Click Collect #005","Click Collect #001","2.142","783","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":835},{"label":"Mar","value":752},{"label":"Abr","value":935},{"label":"Mai","value":780},{"label":"Jun","value":872},{"label":"Jul","value":993},{"label":"Ago","value":945},{"label":"Set","value":764},{"label":"Out","value":921},{"label":"Nov","value":1012},{"label":"Dez","value":1016}];
const MX = 1016;
