...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"3.756","t":"+2.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.5%","t":"+10.4%","d":"up"},{"l":"MTTR (h)","v":"209h","t":"+4.6%","d":"up"},{"l":"Satisfação (%)","v":"78.7%","t":"+11.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.204","6.389","6.506","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.588","6.825","6.672","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.669","2.589","7.989","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.979","658","7.401","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.584","4.684","8.250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":520},{"label":"Mar","value":293},{"label":"Abr","value":255},{"label":"Mai","value":512},{"label":"Jun","value":498},{"label":"Jul","value":369},{"label":"Ago","value":414},{"label":"Set","value":466},{"label":"Out","value":429},{"label":"Nov","value":535},{"label":"Dez","value":403}];
const MX = 535;
