...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.927","t":"-2.0%","d":"down"},{"l":"Submissões/Dia","v":"121","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"3.162","t":"+3.3%","d":"up"},{"l":"Templates","v":"941","t":"+2.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.878","2026-01-16","334","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.721","2026-01-08","3.552","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.575","2026-02-08","2.790","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.676","2026-03-19","2.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.347","2026-03-26","3.725","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":449},{"label":"Mar","value":748},{"label":"Abr","value":496},{"label":"Mai","value":709},{"label":"Jun","value":671},{"label":"Jul","value":389},{"label":"Ago","value":560},{"label":"Set","value":478},{"label":"Out","value":558},{"label":"Nov","value":610},{"label":"Dez","value":693}];
const MX = 760;
