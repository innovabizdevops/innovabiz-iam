...
/* ═══ Haunted Attraction — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "7906", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3690", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€40K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1022370906", cells: ["HAU-7906", "Haunted Attraction Item 1", "19/7/2026", "€21 006"], status: "active" as const },
    { id: "1022374477", cells: ["HAU-2477", "Haunted Attraction Item 2", "6/2/2026", "€24 577"], status: "pending" as const },
    { id: "1022378048", cells: ["HAU-6048", "Haunted Attraction Item 3", "21/9/2026", "€28 148"], status: "completed" as const },
    { id: "1022381619", cells: ["HAU-9619", "Haunted Attraction Item 4", "8/4/2026", "€31 719"], status: "warning" as const },
    { id: "1022385190", cells: ["HAU-4190", "Haunted Attraction Item 5", "23/11/2026", "€35 290"], status: "active" as const },
];
...
export default function HauntedAttractionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Haunted Attraction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Haunted Attraction</p>
                    </div>
                </div>
