...
export default function SupplyVisibilityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Supply Visibility</h1><p className="text-sm text-muted-foreground">Supply Visibility • iBOS Enterprise</p></div>
