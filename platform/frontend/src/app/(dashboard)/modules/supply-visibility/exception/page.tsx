...
const ACCENT = "#6366f1";
const MODULE = "Supply Visibility";
const PAGE = "Exception";
const KPIS = [{"l":"Total Supply Visibility","v":"3.543","t":"-3.3%","d":"down"},{"l":"Exception Ativos","v":"5.247","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+3.1%","d":"up"},{"l":"Score Performance","v":"83","t":"-0.2%","d":"down"}];
const COLS = ["ID","Exception","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Visibility #001","Supply Visibility #002","6.929","2.428","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Visibility #002","Supply Visibility #003","2.890","7.569","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Visibility #003","Supply Visibility #004","8.932","7.149","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Visibility #004","Supply Visibility #005","2.180","6.128","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Visibility #005","Supply Visibility #001","2.624","3.527","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":875},{"label":"Mar","value":896},{"label":"Abr","value":799},{"label":"Mai","value":826},{"label":"Jun","value":845},{"label":"Jul","value":704},{"label":"Ago","value":753},{"label":"Set","value":825},{"label":"Out","value":722},{"label":"Nov","value":651},{"label":"Dez","value":564}];
const MX = 896;
