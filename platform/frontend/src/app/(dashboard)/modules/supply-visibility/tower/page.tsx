...
const PAGE = "Control Tower";
const KPIS = [{"l":"Total Supply Visibility","v":"6.799","t":"-3.9%","d":"down"},{"l":"Control Tower Ativos","v":"6.354","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+10.5%","d":"up"}];
const COLS = ["ID","Control Tower","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Supply Visibility #001","Supply Visibility #002","1.001","5.443","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Supply Visibility #002","Supply Visibility #003","3.764","476","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Supply Visibility #003","Supply Visibility #004","3.571","6.619","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Supply Visibility #004","Supply Visibility #005","5.122","2.245","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Supply Visibility #005","Supply Visibility #001","2.688","2.366","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":478},{"label":"Mar","value":466},{"label":"Abr","value":477},{"label":"Mai","value":711},{"label":"Jun","value":395},{"label":"Jul","value":693},{"label":"Ago","value":438},{"label":"Set","value":549},{"label":"Out","value":474},{"label":"Nov","value":563},{"label":"Dez","value":534}];
const MX = 711;
