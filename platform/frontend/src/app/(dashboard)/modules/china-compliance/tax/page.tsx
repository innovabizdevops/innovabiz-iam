...
const ACCENT = "#14532d";
const MODULE = "China Compliance Hub";
const PAGE = "Tax";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.173","t":"+11.8%","d":"up"},{"l":"NC Abertas","v":"7.771","t":"+17.0%","d":"up"},{"l":"Conformidade (%)","v":"81.2%","t":"+14.9%","d":"up"},{"l":"CAPAs Pendentes","v":"6.316","t":"+3.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.760","99.0%","8.931","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.291","70.0%","7.856","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.852","97.1%","1.042","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.399","85.6%","4.888","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.849","73.2%","2.711","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":272},{"label":"Fev","value":333},{"label":"Mar","value":578},{"label":"Abr","value":348},{"label":"Mai","value":525},{"label":"Jun","value":347},{"label":"Jul","value":498},{"label":"Ago","value":431},{"label":"Set","value":526},{"label":"Out","value":475},{"label":"Nov","value":547},{"label":"Dez","value":337}];
const MX = 578;
