...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.104","t":"+12.6%","d":"up"},{"l":"NC Abertas","v":"1.435","t":"+12.0%","d":"up"},{"l":"Conformidade (%)","v":"65.8%","t":"-2.4%","d":"down"},{"l":"CAPAs Pendentes","v":"520","t":"-3.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.589","70.1%","8.269","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","429","75.4%","1.567","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.474","95.1%","4.238","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.425","91.0%","3.593","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.618","87.9%","6.825","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":335},{"label":"Mar","value":507},{"label":"Abr","value":539},{"label":"Mai","value":557},{"label":"Jun","value":485},{"label":"Jul","value":252},{"label":"Ago","value":522},{"label":"Set","value":576},{"label":"Out","value":497},{"label":"Nov","value":508},{"label":"Dez","value":477}];
const MX = 576;
