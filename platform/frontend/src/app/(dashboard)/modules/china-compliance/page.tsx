...
/* ═══ China Compliance Hub — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "2720", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1490", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€292K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1933363720", cells: ["CHI-2720", "China Compliance Hub Item 1", "9/5/2026", "€13 820"], status: "active" as const },
    { id: "1933367291", cells: ["CHI-6291", "China Compliance Hub Item 2", "24/12/2026", "€17 391"], status: "pending" as const },
    { id: "1933370862", cells: ["CHI-9862", "China Compliance Hub Item 3", "11/7/2026", "€20 962"], status: "completed" as const },
    { id: "1933374433", cells: ["CHI-4433", "China Compliance Hub Item 4", "26/2/2026", "€24 533"], status: "warning" as const },
    { id: "1933378004", cells: ["CHI-8004", "China Compliance Hub Item 5", "13/9/2026", "€28 104"], status: "active" as const },
];
...
export default function ChinaComplianceHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">China Compliance Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • China Compliance Hub</p>
                    </div>
                </div>
