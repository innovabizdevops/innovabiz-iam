...
const KPIS = [{"l":"Total Tool Die Mgmt","v":"8.596","t":"+15.3%","d":"up"},{"l":"Maintenance Ativos","v":"4.685","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.6%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tool Die Mgmt #001","Tool Die Mgmt #002","7.402","6.491","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Tool Die Mgmt #002","Tool Die Mgmt #003","7.604","4.270","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Tool Die Mgmt #003","Tool Die Mgmt #004","5.445","9.070","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Tool Die Mgmt #004","Tool Die Mgmt #005","403","8.908","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tool Die Mgmt #005","Tool Die Mgmt #001","2.205","2.738","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":834},{"label":"Mar","value":1009},{"label":"Abr","value":1051},{"label":"Mai","value":759},{"label":"Jun","value":761},{"label":"Jul","value":746},{"label":"Ago","value":1039},{"label":"Set","value":948},{"label":"Out","value":1031},{"label":"Nov","value":989},{"label":"Dez","value":866}];
const MX = 1051;
