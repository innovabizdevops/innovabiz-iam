...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.783","t":"+9.3%","d":"up"},{"l":"Submissões/Dia","v":"4859","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"5.755","t":"+14.1%","d":"up"},{"l":"Templates","v":"1.443","t":"+17.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.811","2026-01-14","6.334","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","287","2026-02-21","3.618","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","539","2026-02-10","302","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.244","2026-02-15","8.997","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.940","2026-02-27","4.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":792},{"label":"Mar","value":830},{"label":"Abr","value":703},{"label":"Mai","value":492},{"label":"Jun","value":607},{"label":"Jul","value":702},{"label":"Ago","value":811},{"label":"Set","value":673},{"label":"Out","value":842},{"label":"Nov","value":699},{"label":"Dez","value":591}];
const MX = 842;
