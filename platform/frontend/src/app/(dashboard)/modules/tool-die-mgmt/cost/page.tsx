...
const PAGE = "Cost";
const KPIS = [{"l":"Total Tool Die Mgmt","v":"6.861","t":"+14.2%","d":"up"},{"l":"Cost Ativos","v":"8.440","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"90","t":"+11.0%","d":"up"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tool Die Mgmt #001","Tool Die Mgmt #002","4.568","6.776","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Tool Die Mgmt #002","Tool Die Mgmt #003","1.805","6.750","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Tool Die Mgmt #003","Tool Die Mgmt #004","9.085","2.287","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Tool Die Mgmt #004","Tool Die Mgmt #005","6.690","1.998","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tool Die Mgmt #005","Tool Die Mgmt #001","4.469","3.071","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":290},{"label":"Mar","value":620},{"label":"Abr","value":290},{"label":"Mai","value":549},{"label":"Jun","value":284},{"label":"Jul","value":454},{"label":"Ago","value":321},{"label":"Set","value":506},{"label":"Out","value":366},{"label":"Nov","value":276},{"label":"Dez","value":595}];
const MX = 620;
