...
const KPIS = [{"l":"Total Tool Die Mgmt","v":"5.074","t":"+12.2%","d":"up"},{"l":"Inventory Ativos","v":"8.240","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"81","t":"+10.5%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tool Die Mgmt #001","Tool Die Mgmt #002","1.044","3.595","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Tool Die Mgmt #002","Tool Die Mgmt #003","8.686","710","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Tool Die Mgmt #003","Tool Die Mgmt #004","1.585","5.508","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Tool Die Mgmt #004","Tool Die Mgmt #005","5.285","6.342","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tool Die Mgmt #005","Tool Die Mgmt #001","8.076","5.894","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":856},{"label":"Mar","value":703},{"label":"Abr","value":720},{"label":"Mai","value":886},{"label":"Jun","value":745},{"label":"Jul","value":954},{"label":"Ago","value":755},{"label":"Set","value":716},{"label":"Out","value":872},{"label":"Nov","value":990},{"label":"Dez","value":1077}];
const MX = 1077;
