...
const ACCENT = "#6366f1";
const MODULE = "Tool & Die Mgmt";
const PAGE = "Track";
const KPIS = [{"l":"Total Tool Die Mgmt","v":"8.237","t":"+15.4%","d":"up"},{"l":"Track Ativos","v":"4.238","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"77","t":"+10.0%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tool Die Mgmt #001","Tool Die Mgmt #002","4.886","628","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Tool Die Mgmt #002","Tool Die Mgmt #003","3.366","3.466","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Tool Die Mgmt #003","Tool Die Mgmt #004","449","5.653","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Tool Die Mgmt #004","Tool Die Mgmt #005","4.935","607","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tool Die Mgmt #005","Tool Die Mgmt #001","1.214","6.253","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":378},{"label":"Mar","value":497},{"label":"Abr","value":388},{"label":"Mai","value":655},{"label":"Jun","value":693},{"label":"Jul","value":377},{"label":"Ago","value":638},{"label":"Set","value":575},{"label":"Out","value":626},{"label":"Nov","value":659},{"label":"Dez","value":471}];
const MX = 693;
