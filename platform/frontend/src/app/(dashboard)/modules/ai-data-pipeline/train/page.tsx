...
const PAGE = "Train";
const KPIS = [{"l":"Dashboards Ativos","v":"8.672","t":"+13.0%","d":"up"},{"l":"Queries/Dia","v":"480","t":"+3.1%","d":"up"},{"l":"Dados Processados (GB)","v":"4.601","t":"+15.3%","d":"up"},{"l":"Utilizadores Analytics","v":"423","t":"+3.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2258","2026-02-17","777","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3673","2026-02-06","6.072","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1201","2026-03-21","5.175","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","917","2026-02-13","5.035","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1485","2026-02-24","2.228","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":302},{"label":"Mar","value":397},{"label":"Abr","value":324},{"label":"Mai","value":642},{"label":"Jun","value":401},{"label":"Jul","value":410},{"label":"Ago","value":432},{"label":"Set","value":611},{"label":"Out","value":652},{"label":"Nov","value":343},{"label":"Dez","value":432}];
const MX = 652;
