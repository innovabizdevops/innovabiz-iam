...
const KPIS = [{"l":"Formulários Ativos","v":"7.454","t":"+8.1%","d":"up"},{"l":"Submissões/Dia","v":"919","t":"+8.8%","d":"up"},{"l":"Documentos Gerados","v":"5.501","t":"-1.5%","d":"down"},{"l":"Templates","v":"5.677","t":"-1.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.413","2026-02-28","3.965","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.625","2026-02-25","7.497","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.642","2026-03-02","3.681","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.693","2026-02-19","2.996","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.762","2026-02-25","1.579","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":276},{"label":"Mar","value":493},{"label":"Abr","value":342},{"label":"Mai","value":241},{"label":"Jun","value":327},{"label":"Jul","value":472},{"label":"Ago","value":291},{"label":"Set","value":412},{"label":"Out","value":618},{"label":"Nov","value":280},{"label":"Dez","value":356}];
const MX = 618;
