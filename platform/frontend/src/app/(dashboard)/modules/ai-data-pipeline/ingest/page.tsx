...
const PAGE = "Ingest";
const KPIS = [{"l":"Dashboards Ativos","v":"5.290","t":"+9.2%","d":"up"},{"l":"Queries/Dia","v":"5058","t":"+13.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.142","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"3.326","t":"+0.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1638","2026-02-07","8.970","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1748","2026-02-27","681","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3031","2026-02-25","1.240","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","794","2026-02-26","4.082","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5070","2026-03-28","2.713","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":912},{"label":"Mar","value":902},{"label":"Abr","value":909},{"label":"Mai","value":865},{"label":"Jun","value":823},{"label":"Jul","value":982},{"label":"Ago","value":767},{"label":"Set","value":669},{"label":"Out","value":951},{"label":"Nov","value":700},{"label":"Dez","value":893}];
const MX = 982;
