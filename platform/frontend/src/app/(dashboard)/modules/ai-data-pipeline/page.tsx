...
const KPIS = [
    { label: "Total Registos", value: "9271", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1840", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€417K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1488167271", cells: ["AI-9271", "AI Data Pipeline Item 1", "4/4/2026", "€17 371"], status: "active" as const },
    { id: "1488170842", cells: ["AI-3842", "AI Data Pipeline Item 2", "19/11/2026", "€20 942"], status: "pending" as const },
    { id: "1488174413", cells: ["AI-7413", "AI Data Pipeline Item 3", "6/6/2026", "€24 513"], status: "completed" as const },
    { id: "1488177984", cells: ["AI-1984", "AI Data Pipeline Item 4", "21/1/2026", "€28 084"], status: "warning" as const },
    { id: "1488181555", cells: ["AI-5555", "AI Data Pipeline Item 5", "8/8/2026", "€31 655"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Data Pipeline</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Data Pipeline</p>
                    </div>
                </div>
