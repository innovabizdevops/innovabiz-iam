...
const ACCENT = "#6366f1";
const MODULE = "AI Data Pipeline";
const PAGE = "Serve";
const KPIS = [{"l":"Dashboards Ativos","v":"4.475","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"3393","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"7.630","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"2.593","t":"-2.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2683","2026-01-20","6.093","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","102","2026-02-03","2.488","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4158","2026-03-28","2.617","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2699","2026-01-28","832","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4105","2026-03-17","1.119","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":960},{"label":"Mar","value":972},{"label":"Abr","value":1001},{"label":"Mai","value":998},{"label":"Jun","value":688},{"label":"Jul","value":909},{"label":"Ago","value":729},{"label":"Set","value":727},{"label":"Out","value":883},{"label":"Nov","value":624},{"label":"Dez","value":862}];
const MX = 1001;
