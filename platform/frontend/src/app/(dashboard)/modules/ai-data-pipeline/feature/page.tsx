...
const PAGE = "Feature";
const KPIS = [{"l":"Dashboards Ativos","v":"361","t":"+16.3%","d":"up"},{"l":"Queries/Dia","v":"2422","t":"-6.0%","d":"down"},{"l":"Dados Processados (GB)","v":"2.668","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.071","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1581","2026-03-19","7.230","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3700","2026-01-19","1.363","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1008","2026-02-02","4.807","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4637","2026-01-25","3.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4223","2026-01-05","4.112","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":716},{"label":"Mar","value":462},{"label":"Abr","value":355},{"label":"Mai","value":577},{"label":"Jun","value":628},{"label":"Jul","value":547},{"label":"Ago","value":720},{"label":"Set","value":717},{"label":"Out","value":560},{"label":"Nov","value":368},{"label":"Dez","value":411}];
const MX = 729;
