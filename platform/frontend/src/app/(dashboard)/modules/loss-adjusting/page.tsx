...
export default function LossAdjustingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Loss Adjusting</h1><p className="text-sm text-muted-foreground">Loss Adjusting • iBOS Enterprise</p></div>
