...
/* ═══ Text Analytics / Text Mining — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "1103", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1345", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€294K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1155271603", cells: ["TEX-5603", "Text Analytics / Text Mining Item 1", "4/8/2026", "€21 703"], status: "active" as const },
    { id: "1155275174", cells: ["TEX-9174", "Text Analytics / Text Mining Item 2", "19/3/2026", "€25 274"], status: "pending" as const },
    { id: "1155278745", cells: ["TEX-3745", "Text Analytics / Text Mining Item 3", "6/10/2026", "€28 845"], status: "completed" as const },
    { id: "1155282316", cells: ["TEX-7316", "Text Analytics / Text Mining Item 4", "21/5/2026", "€32 416"], status: "warning" as const },
    { id: "1155285887", cells: ["TEX-1887", "Text Analytics / Text Mining Item 5", "8/12/2026", "€35 987"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 23 }, { label: "Fev", value: 32 }, { label: "Mar", value: 41 }, { label: "Abr", value: 50 }, { label: "Mai", value: 59 }, { label: "Jun", value: 68 }];
...
export default function TextAnalyticsTextMiningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Text Analytics / Text Mining</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Text Analytics / Text Mining</p>
                    </div>
                </div>
