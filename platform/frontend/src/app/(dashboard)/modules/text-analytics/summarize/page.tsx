...
const KPIS = [{"l":"Dashboards Ativos","v":"7.166","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"885","t":"+1.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.592","t":"+9.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.231","t":"+13.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3156","2026-03-16","7.335","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4361","2026-01-12","7.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1513","2026-02-05","2.414","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4874","2026-02-13","1.942","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1435","2026-03-14","3.835","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":501},{"label":"Mar","value":633},{"label":"Abr","value":673},{"label":"Mai","value":603},{"label":"Jun","value":486},{"label":"Jul","value":398},{"label":"Ago","value":612},{"label":"Set","value":463},{"label":"Out","value":720},{"label":"Nov","value":430},{"label":"Dez","value":697}];
const MX = 720;
