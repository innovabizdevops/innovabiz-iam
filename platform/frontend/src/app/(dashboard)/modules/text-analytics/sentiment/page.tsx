...
const KPIS = [{"l":"Dashboards Ativos","v":"848","t":"+11.3%","d":"up"},{"l":"Queries/Dia","v":"4515","t":"+17.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.434","t":"-1.8%","d":"down"},{"l":"Utilizadores Analytics","v":"4.075","t":"+7.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4470","2026-02-28","7.138","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2455","2026-03-23","1.661","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3345","2026-03-23","5.719","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3994","2026-03-06","6.013","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5077","2026-03-23","6.429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":849},{"label":"Mar","value":812},{"label":"Abr","value":1056},{"label":"Mai","value":878},{"label":"Jun","value":907},{"label":"Jul","value":755},{"label":"Ago","value":1046},{"label":"Set","value":732},{"label":"Out","value":946},{"label":"Nov","value":916},{"label":"Dez","value":734}];
const MX = 1056;
