...
const PAGE = "Extract";
const KPIS = [{"l":"Dashboards Ativos","v":"6.288","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"4718","t":"-5.8%","d":"down"},{"l":"Dados Processados (GB)","v":"3.248","t":"+10.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.255","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1515","2026-01-05","8.106","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5039","2026-03-28","2.640","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4431","2026-01-12","4.433","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4000","2026-02-06","4.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3733","2026-03-13","5.700","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":558},{"label":"Mar","value":413},{"label":"Abr","value":407},{"label":"Mai","value":391},{"label":"Jun","value":604},{"label":"Jul","value":443},{"label":"Ago","value":581},{"label":"Set","value":410},{"label":"Out","value":314},{"label":"Nov","value":539},{"label":"Dez","value":597}];
const MX = 604;
