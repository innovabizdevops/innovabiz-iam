...
const ACCENT = "#4338ca";
const MODULE = "Text Analytics / Text Mining";
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"7.054","t":"-4.7%","d":"down"},{"l":"Queries/Dia","v":"1474","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"8.242","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"6.700","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2775","2026-02-01","8.729","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1461","2026-03-13","8.339","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1804","2026-01-22","6.657","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","739","2026-01-26","7.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1539","2026-03-13","6.779","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":564},{"label":"Mar","value":424},{"label":"Abr","value":617},{"label":"Mai","value":489},{"label":"Jun","value":436},{"label":"Jul","value":586},{"label":"Ago","value":453},{"label":"Set","value":598},{"label":"Out","value":387},{"label":"Nov","value":481},{"label":"Dez","value":360}];
const MX = 617;
