...
const PAGE = "Topic";
const KPIS = [{"l":"Dashboards Ativos","v":"5.008","t":"+13.5%","d":"up"},{"l":"Queries/Dia","v":"1577","t":"+1.2%","d":"up"},{"l":"Dados Processados (GB)","v":"155","t":"-2.1%","d":"down"},{"l":"Utilizadores Analytics","v":"3.399","t":"-1.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2995","2026-01-03","6.178","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3943","2026-01-08","1.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3198","2026-03-08","3.039","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3405","2026-01-03","8.694","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1951","2026-01-23","5.037","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":720},{"label":"Mar","value":499},{"label":"Abr","value":524},{"label":"Mai","value":645},{"label":"Jun","value":719},{"label":"Jul","value":531},{"label":"Ago","value":714},{"label":"Set","value":566},{"label":"Out","value":717},{"label":"Nov","value":633},{"label":"Dez","value":607}];
const MX = 830;
