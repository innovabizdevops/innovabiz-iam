...
const PAGE = "Patent";
const KPIS = [{"l":"Dashboards Ativos","v":"2.933","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"4151","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"244","t":"+0.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.547","t":"+0.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1355","2026-02-09","5.341","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","160","2026-02-05","722","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4292","2026-01-16","532","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4507","2026-02-24","6.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2357","2026-03-02","3.454","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":531},{"label":"Mar","value":552},{"label":"Abr","value":537},{"label":"Mai","value":649},{"label":"Jun","value":501},{"label":"Jul","value":474},{"label":"Ago","value":513},{"label":"Set","value":541},{"label":"Out","value":704},{"label":"Nov","value":641},{"label":"Dez","value":618}];
const MX = 704;
