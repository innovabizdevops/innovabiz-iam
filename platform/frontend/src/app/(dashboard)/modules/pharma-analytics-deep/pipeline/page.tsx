...
const PAGE = "Pipeline";
const KPIS = [{"l":"Dashboards Ativos","v":"5.939","t":"+2.8%","d":"up"},{"l":"Queries/Dia","v":"202","t":"-1.9%","d":"down"},{"l":"Dados Processados (GB)","v":"8.740","t":"+1.4%","d":"up"},{"l":"Utilizadores Analytics","v":"2.997","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3169","2026-02-10","3.169","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3786","2026-03-18","3.044","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3558","2026-02-15","4.874","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2592","2026-01-21","797","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2738","2026-02-08","576","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":652},{"label":"Mar","value":607},{"label":"Abr","value":606},{"label":"Mai","value":522},{"label":"Jun","value":571},{"label":"Jul","value":624},{"label":"Ago","value":730},{"label":"Set","value":732},{"label":"Out","value":587},{"label":"Nov","value":860},{"label":"Dez","value":734}];
const MX = 860;
