...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"5.029","t":"-0.4%","d":"down"},{"l":"Queries/Dia","v":"3558","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.193","t":"-0.9%","d":"down"},{"l":"Utilizadores Analytics","v":"5.384","t":"+16.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1406","2026-01-20","6.019","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1035","2026-02-14","8.216","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1012","2026-01-24","5.850","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1817","2026-02-21","1.669","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4756","2026-03-06","709","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":664},{"label":"Mar","value":629},{"label":"Abr","value":568},{"label":"Mai","value":400},{"label":"Jun","value":320},{"label":"Jul","value":408},{"label":"Ago","value":636},{"label":"Set","value":510},{"label":"Out","value":451},{"label":"Nov","value":675},{"label":"Dez","value":530}];
const MX = 675;
