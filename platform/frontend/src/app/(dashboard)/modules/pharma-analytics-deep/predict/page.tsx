...
const ACCENT = "#5b21b6";
const MODULE = "Pharma Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"6.030","t":"+5.4%","d":"up"},{"l":"Queries/Dia","v":"2239","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"4.427","t":"+7.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.693","t":"+11.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4911","2026-01-26","1.339","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3581","2026-02-16","5.923","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","113","2026-01-20","8.299","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3996","2026-02-22","5.630","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2962","2026-02-20","4.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":623},{"label":"Mar","value":842},{"label":"Abr","value":945},{"label":"Mai","value":633},{"label":"Jun","value":573},{"label":"Jul","value":909},{"label":"Ago","value":796},{"label":"Set","value":798},{"label":"Out","value":603},{"label":"Nov","value":826},{"label":"Dez","value":852}];
const MX = 945;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#5b21b6'}}>AI</span></h1>
                </div>
