...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.325","t":"-4.7%","d":"down"},{"l":"NC Abertas","v":"6.505","t":"+8.1%","d":"up"},{"l":"Conformidade (%)","v":"86.7%","t":"-0.8%","d":"down"},{"l":"CAPAs Pendentes","v":"7.575","t":"-5.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.029","78.2%","7.607","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.626","85.0%","2.386","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","806","80.7%","7.306","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.142","94.5%","2.687","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.110","70.9%","5.782","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":991},{"label":"Mar","value":682},{"label":"Abr","value":999},{"label":"Mai","value":711},{"label":"Jun","value":1034},{"label":"Jul","value":675},{"label":"Ago","value":802},{"label":"Set","value":669},{"label":"Out","value":782},{"label":"Nov","value":1011},{"label":"Dez","value":775}];
const MX = 1034;
