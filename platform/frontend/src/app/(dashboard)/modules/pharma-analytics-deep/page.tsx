...
const KPIS = [
    { label: "Total Registos", value: "7458", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2942", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€298K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1736645558", cells: ["PHA-6558", "Pharma Analytics Item 1", "19/3/2026", "€45 658"], status: "active" as const },
    { id: "1736649129", cells: ["PHA-1129", "Pharma Analytics Item 2", "6/10/2026", "€49 229"], status: "pending" as const },
    { id: "1736652700", cells: ["PHA-4700", "Pharma Analytics Item 3", "21/5/2026", "€2800"], status: "completed" as const },
    { id: "1736656271", cells: ["PHA-8271", "Pharma Analytics Item 4", "8/12/2026", "€6371"], status: "warning" as const },
    { id: "1736659842", cells: ["PHA-2842", "Pharma Analytics Item 5", "23/7/2026", "€9942"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Analytics</p>
                    </div>
                </div>
