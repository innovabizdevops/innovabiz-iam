...
const PAGE = "Contractor";
const KPIS = [{"l":"Contratos Ativos","v":"7.021","t":"+12.3%","d":"up"},{"l":"Valor Total (€M)","v":"€28.9M","t":"+4.7%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.913","t":"+11.5%","d":"up"},{"l":"Obrigações Pendentes","v":"3.653","t":"+5.5%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 39748.97","2026-02-25","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 28298.14","2026-02-05","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 17440.14","2026-02-18","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 47936.33","2026-01-02","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 15129.10","2026-03-04","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":673},{"label":"Mar","value":694},{"label":"Abr","value":434},{"label":"Mai","value":375},{"label":"Jun","value":405},{"label":"Jul","value":527},{"label":"Ago","value":371},{"label":"Set","value":562},{"label":"Out","value":489},{"label":"Nov","value":676},{"label":"Dez","value":388}];
const MX = 694;
