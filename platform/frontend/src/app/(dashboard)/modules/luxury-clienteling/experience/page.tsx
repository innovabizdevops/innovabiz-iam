...
const KPIS = [{"l":"Perfis Unificados","v":"6.580","t":"-0.5%","d":"down"},{"l":"Segmentos Ativos","v":"7.622","t":"+5.8%","d":"up"},{"l":"NPS Score","v":"56","t":"+7.1%","d":"up"},{"l":"Churn Previsto (%)","v":"78.0%","t":"+16.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","3.901","€ 32401.65","93.0%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.794","€ 2319.07","86.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","2.637","€ 28222.16","85.6%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.351","€ 20768.80","80.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","810","€ 20018.48","99.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":684},{"label":"Mar","value":744},{"label":"Abr","value":720},{"label":"Mai","value":550},{"label":"Jun","value":811},{"label":"Jul","value":554},{"label":"Ago","value":592},{"label":"Set","value":716},{"label":"Out","value":649},{"label":"Nov","value":828},{"label":"Dez","value":835}];
const MX = 835;
