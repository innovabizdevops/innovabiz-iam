...
/* ═══ Luxury Clienteling — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "7335", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2853", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€154K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1373958935", cells: ["LUX-1935", "Luxury Clienteling Item 1", "28/12/2026", "€9035"], status: "active" as const },
    { id: "1373962506", cells: ["LUX-5506", "Luxury Clienteling Item 2", "15/7/2026", "€12 606"], status: "pending" as const },
    { id: "1373966077", cells: ["LUX-9077", "Luxury Clienteling Item 3", "2/2/2026", "€16 177"], status: "completed" as const },
    { id: "1373969648", cells: ["LUX-3648", "Luxury Clienteling Item 4", "17/9/2026", "€19 748"], status: "warning" as const },
    { id: "1373973219", cells: ["LUX-7219", "Luxury Clienteling Item 5", "4/4/2026", "€23 319"], status: "active" as const },
];
...
export default function LuxuryClientelingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Luxury Clienteling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Luxury Clienteling</p>
                    </div>
                </div>
