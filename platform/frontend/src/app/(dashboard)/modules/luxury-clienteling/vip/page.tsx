...
const ACCENT = "#be185d";
const MODULE = "Luxury Clienteling";
const PAGE = "VIP";
const KPIS = [{"l":"Total Luxury Clienteling","v":"3.671","t":"+17.1%","d":"up"},{"l":"VIP Ativos","v":"3.365","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"74.1%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"86","t":"-1.9%","d":"down"}];
const COLS = ["ID","VIP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Luxury Clienteling #001","Luxury Clienteling #002","2.653","5.671","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Luxury Clienteling #002","Luxury Clienteling #003","3.222","7.426","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Luxury Clienteling #003","Luxury Clienteling #004","7.421","5.264","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Luxury Clienteling #004","Luxury Clienteling #005","6.129","582","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Luxury Clienteling #005","Luxury Clienteling #001","8.245","4.750","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":821},{"label":"Mar","value":640},{"label":"Abr","value":862},{"label":"Mai","value":603},{"label":"Jun","value":652},{"label":"Jul","value":634},{"label":"Ago","value":824},{"label":"Set","value":577},{"label":"Out","value":672},{"label":"Nov","value":670},{"label":"Dez","value":713}];
const MX = 862;
