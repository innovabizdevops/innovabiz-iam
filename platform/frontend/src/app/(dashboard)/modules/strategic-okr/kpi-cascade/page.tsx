...
const PAGE = "KPI Cascade";
const KPIS = [{"l":"Total Strategic Okr","v":"2.848","t":"-3.6%","d":"down"},{"l":"KPI Cascade Ativos","v":"3.841","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"+7.9%","d":"up"},{"l":"Score Performance","v":"84","t":"+0.8%","d":"up"}];
const COLS = ["ID","KPI Cascade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategic Okr #001","Strategic Okr #002","3.541","5.830","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Strategic Okr #002","Strategic Okr #003","2.422","4.721","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategic Okr #003","Strategic Okr #004","4.722","6.570","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Strategic Okr #004","Strategic Okr #005","2.589","5.617","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategic Okr #005","Strategic Okr #001","8.524","2.091","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":601},{"label":"Mar","value":494},{"label":"Abr","value":712},{"label":"Mai","value":587},{"label":"Jun","value":631},{"label":"Jul","value":463},{"label":"Ago","value":754},{"label":"Set","value":572},{"label":"Out","value":492},{"label":"Nov","value":679},{"label":"Dez","value":530}];
const MX = 805;
...
export default function KpiCascadePage() {
    return (
