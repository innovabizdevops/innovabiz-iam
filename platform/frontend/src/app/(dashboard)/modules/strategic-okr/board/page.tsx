...
const PAGE = "Board Reporting";
const KPIS = [{"l":"Teams Ativos","v":"5.507","t":"+10.5%","d":"up"},{"l":"Reuniões/Semana","v":"2501","t":"+13.8%","d":"up"},{"l":"Mensagens/Dia","v":"3422","t":"-0.8%","d":"down"},{"l":"Ficheiros Partilhados","v":"7.328","t":"+12.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.170","4773","4.945","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.775","830","5.805","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","9.029","3533","4.348","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","241","5013","7.510","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.834","4430","7.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":704},{"label":"Mar","value":403},{"label":"Abr","value":373},{"label":"Mai","value":506},{"label":"Jun","value":529},{"label":"Jul","value":539},{"label":"Ago","value":381},{"label":"Set","value":615},{"label":"Out","value":556},{"label":"Nov","value":439},{"label":"Dez","value":537}];
const MX = 704;
