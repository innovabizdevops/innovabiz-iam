...
const PAGE = "Strategy Map";
const KPIS = [{"l":"Total Strategic Okr","v":"6.327","t":"+5.4%","d":"up"},{"l":"Strategy Map Ativos","v":"2.023","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"66.4%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"76","t":"-5.8%","d":"down"}];
const COLS = ["ID","Strategy Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategic Okr #001","Strategic Okr #002","3.587","1.861","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Strategic Okr #002","Strategic Okr #003","4.713","5.489","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategic Okr #003","Strategic Okr #004","3.197","1.430","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Strategic Okr #004","Strategic Okr #005","1.155","4.018","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategic Okr #005","Strategic Okr #001","7.790","5.039","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":410},{"label":"Mar","value":658},{"label":"Abr","value":524},{"label":"Mai","value":410},{"label":"Jun","value":476},{"label":"Jul","value":453},{"label":"Ago","value":362},{"label":"Set","value":496},{"label":"Out","value":542},{"label":"Nov","value":340},{"label":"Dez","value":406}];
const MX = 658;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>BSC</span></h1>
                </div>
