...
const KPIS = [{"l":"Total Strategic Okr","v":"3.268","t":"+10.2%","d":"up"},{"l":"Balanced Scorecard Ativos","v":"93","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"63","t":"-1.8%","d":"down"}];
const COLS = ["ID","Balanced Scorecard","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategic Okr #001","77.8%","2.741","1.072","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Strategic Okr #002","81.9%","4.241","3.616","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategic Okr #003","80.9%","6.726","4.456","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Strategic Okr #004","86.2%","841","9.075","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategic Okr #005","83.3%","6.596","9.012","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":599},{"label":"Mar","value":912},{"label":"Abr","value":715},{"label":"Mai","value":656},{"label":"Jun","value":841},{"label":"Jul","value":825},{"label":"Ago","value":570},{"label":"Set","value":576},{"label":"Out","value":598},{"label":"Nov","value":778},{"label":"Dez","value":804}];
const MX = 912;
