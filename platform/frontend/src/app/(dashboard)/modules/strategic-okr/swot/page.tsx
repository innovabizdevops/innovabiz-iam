...
const PAGE = "SWOT Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"8.982","t":"+11.4%","d":"up"},{"l":"Queries/Dia","v":"1755","t":"+6.5%","d":"up"},{"l":"Dados Processados (GB)","v":"7.903","t":"+10.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.649","t":"+1.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4223","2026-02-10","7.416","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3868","2026-03-25","8.596","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1236","2026-03-14","3.391","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4714","2026-02-21","5.247","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1376","2026-02-28","5.320","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1076},{"label":"Fev","value":772},{"label":"Mar","value":773},{"label":"Abr","value":875},{"label":"Mai","value":697},{"label":"Jun","value":1026},{"label":"Jul","value":751},{"label":"Ago","value":718},{"label":"Set","value":782},{"label":"Out","value":973},{"label":"Nov","value":901},{"label":"Dez","value":882}];
const MX = 1076;
