...
const ACCENT = "#0891b2";
const MODULE = "Strategy & OKR";
const PAGE = "Progress Heatmap";
const KPIS = [{"l":"Total Strategic Okr","v":"2.436","t":"+2.3%","d":"up"},{"l":"Progress Heatmap Ativos","v":"8.081","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"88","t":"-3.9%","d":"down"}];
const COLS = ["ID","Progress Heatmap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Strategic Okr #001","Strategic Okr #002","2.995","7.510","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Strategic Okr #002","Strategic Okr #003","8.458","7.493","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Strategic Okr #003","Strategic Okr #004","1.443","7.302","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Strategic Okr #004","Strategic Okr #005","652","1.170","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Strategic Okr #005","Strategic Okr #001","6.440","7.035","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":307},{"label":"Mar","value":650},{"label":"Abr","value":340},{"label":"Mai","value":577},{"label":"Jun","value":651},{"label":"Jul","value":572},{"label":"Ago","value":588},{"label":"Set","value":584},{"label":"Out","value":660},{"label":"Nov","value":515},{"label":"Dez","value":454}];
const MX = 660;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Chart</span></h1>
                </div>
