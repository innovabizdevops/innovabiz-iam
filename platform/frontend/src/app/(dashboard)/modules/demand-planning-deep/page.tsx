...
/* ═══ Demand Planning Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "6027", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2160", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€91K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "277067327", cells: ["DEM-3327", "Demand Planning Deep Item 1", "20/12/2026", "€17 427"], status: "active" as const },
    { id: "277070898", cells: ["DEM-6898", "Demand Planning Deep Item 2", "7/7/2026", "€20 998"], status: "pending" as const },
    { id: "277074469", cells: ["DEM-1469", "Demand Planning Deep Item 3", "22/2/2026", "€24 569"], status: "completed" as const },
    { id: "277078040", cells: ["DEM-5040", "Demand Planning Deep Item 4", "9/9/2026", "€28 140"], status: "warning" as const },
    { id: "277081611", cells: ["DEM-8611", "Demand Planning Deep Item 5", "24/4/2026", "€31 711"], status: "active" as const },
];
...
export default function DemandPlanningDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Demand Planning Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Demand Planning Deep</p>
                    </div>
                </div>
