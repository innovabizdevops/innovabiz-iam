...
const PAGE = "Measure";
const KPIS = [{"l":"Total Demand Planning Deep","v":"3.917","t":"+1.6%","d":"up"},{"l":"Measure Ativos","v":"8.948","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"72.4%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.5%","d":"up"}];
const COLS = ["ID","Measure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Planning Deep #001","Demand Planning Deep #002","2.989","6.425","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Planning Deep #002","Demand Planning Deep #003","366","7.977","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Planning Deep #003","Demand Planning Deep #004","1.014","5.074","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Planning Deep #004","Demand Planning Deep #005","6.656","1.283","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Planning Deep #005","Demand Planning Deep #001","819","3.016","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":851},{"label":"Mar","value":876},{"label":"Abr","value":799},{"label":"Mai","value":772},{"label":"Jun","value":850},{"label":"Jul","value":590},{"label":"Ago","value":845},{"label":"Set","value":734},{"label":"Out","value":932},{"label":"Nov","value":780},{"label":"Dez","value":626}];
const MX = 932;
