...
const ACCENT = "#1e3a5f";
const MODULE = "Demand Planning Deep";
const PAGE = "Forecast";
const KPIS = [{"l":"Total Demand Planning Deep","v":"4.575","t":"+5.4%","d":"up"},{"l":"Forecast Ativos","v":"7.517","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"73","t":"-4.1%","d":"down"}];
const COLS = ["ID","Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Planning Deep #001","Demand Planning Deep #002","2.401","2.640","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Planning Deep #002","Demand Planning Deep #003","8.681","2.558","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Planning Deep #003","Demand Planning Deep #004","7.584","2.290","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Planning Deep #004","Demand Planning Deep #005","7.466","488","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Planning Deep #005","Demand Planning Deep #001","3.143","7.575","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":533},{"label":"Mar","value":530},{"label":"Abr","value":369},{"label":"Mai","value":465},{"label":"Jun","value":649},{"label":"Jul","value":652},{"label":"Ago","value":538},{"label":"Set","value":646},{"label":"Out","value":319},{"label":"Nov","value":329},{"label":"Dez","value":367}];
const MX = 652;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>AI</span></h1>
                </div>
