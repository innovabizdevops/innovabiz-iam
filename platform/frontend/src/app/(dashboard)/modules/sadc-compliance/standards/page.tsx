...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.721","t":"-1.4%","d":"down"},{"l":"NC Abertas","v":"4.295","t":"+4.3%","d":"up"},{"l":"Conformidade (%)","v":"83.8%","t":"+5.9%","d":"up"},{"l":"CAPAs Pendentes","v":"4.455","t":"-3.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.175","85.6%","8.489","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","855","79.9%","608","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","939","94.6%","2.962","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.696","87.5%","7.948","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.346","94.2%","8.879","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":672},{"label":"Mar","value":539},{"label":"Abr","value":842},{"label":"Mai","value":573},{"label":"Jun","value":570},{"label":"Jul","value":646},{"label":"Ago","value":654},{"label":"Set","value":786},{"label":"Out","value":618},{"label":"Nov","value":805},{"label":"Dez","value":588}];
const MX = 842;
