...
/* ═══ SADC Compliance Hub — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "4490", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1976", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€453K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "891657790", cells: ["SAD-1790", "SADC Compliance Hub Item 1", "3/11/2026", "€7890"], status: "active" as const },
    { id: "891661361", cells: ["SAD-5361", "SADC Compliance Hub Item 2", "18/6/2026", "€11 461"], status: "pending" as const },
    { id: "891664932", cells: ["SAD-8932", "SADC Compliance Hub Item 3", "5/1/2026", "€15 032"], status: "completed" as const },
    { id: "891668503", cells: ["SAD-3503", "SADC Compliance Hub Item 4", "20/8/2026", "€18 603"], status: "warning" as const },
    { id: "891672074", cells: ["SAD-7074", "SADC Compliance Hub Item 5", "7/3/2026", "€22 174"], status: "active" as const },
];
...
export default function SadcComplianceHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SADC Compliance Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SADC Compliance Hub</p>
                    </div>
                </div>
