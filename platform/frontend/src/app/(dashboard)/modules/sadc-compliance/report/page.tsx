...
const ACCENT = "#14532d";
const MODULE = "SADC Compliance Hub";
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.418","t":"+16.3%","d":"up"},{"l":"NC Abertas","v":"1.060","t":"-4.8%","d":"down"},{"l":"Conformidade (%)","v":"81.3%","t":"-4.1%","d":"down"},{"l":"CAPAs Pendentes","v":"5.865","t":"+15.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.614","94.8%","697","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.773","89.3%","8.387","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.351","80.0%","3.864","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.785","96.0%","3.305","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.096","83.5%","6.148","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":736},{"label":"Mar","value":871},{"label":"Abr","value":811},{"label":"Mai","value":635},{"label":"Jun","value":648},{"label":"Jul","value":850},{"label":"Ago","value":785},{"label":"Set","value":752},{"label":"Out","value":968},{"label":"Nov","value":976},{"label":"Dez","value":646}];
const MX = 976;
