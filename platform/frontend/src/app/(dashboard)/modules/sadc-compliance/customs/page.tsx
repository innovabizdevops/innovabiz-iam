...
const PAGE = "Customs";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.697","t":"-4.0%","d":"down"},{"l":"NC Abertas","v":"6.062","t":"-0.5%","d":"down"},{"l":"Conformidade (%)","v":"83.6%","t":"+10.0%","d":"up"},{"l":"CAPAs Pendentes","v":"361","t":"-0.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","477","78.1%","6.241","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.669","96.0%","8.535","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.788","74.2%","907","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.018","85.4%","7.752","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.610","84.9%","7.495","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":403},{"label":"Mar","value":280},{"label":"Abr","value":362},{"label":"Mai","value":637},{"label":"Jun","value":329},{"label":"Jul","value":555},{"label":"Ago","value":475},{"label":"Set","value":606},{"label":"Out","value":359},{"label":"Nov","value":406},{"label":"Dez","value":423}];
const MX = 637;
