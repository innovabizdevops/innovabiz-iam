...
const PAGE = "Trade";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.058","t":"+9.3%","d":"up"},{"l":"NC Abertas","v":"1.078","t":"+1.7%","d":"up"},{"l":"Conformidade (%)","v":"83.7%","t":"+9.4%","d":"up"},{"l":"CAPAs Pendentes","v":"3.064","t":"+15.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.197","91.9%","3.395","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","173","95.1%","6.965","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.919","74.3%","5.654","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.680","92.6%","7.607","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.311","83.7%","151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":613},{"label":"Mar","value":573},{"label":"Abr","value":494},{"label":"Mai","value":627},{"label":"Jun","value":389},{"label":"Jul","value":515},{"label":"Ago","value":549},{"label":"Set","value":481},{"label":"Out","value":622},{"label":"Nov","value":280},{"label":"Dez","value":597}];
const MX = 627;
