...
const PAGE = "Origin";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.229","t":"+12.4%","d":"up"},{"l":"NC Abertas","v":"6.246","t":"+13.0%","d":"up"},{"l":"Conformidade (%)","v":"65.9%","t":"+13.0%","d":"up"},{"l":"CAPAs Pendentes","v":"5.728","t":"+6.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.680","93.1%","5.456","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.948","86.0%","6.765","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.664","99.3%","2.667","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.271","97.3%","1.606","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.848","97.6%","3.480","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1009},{"label":"Fev","value":815},{"label":"Mar","value":827},{"label":"Abr","value":708},{"label":"Mai","value":1034},{"label":"Jun","value":938},{"label":"Jul","value":985},{"label":"Ago","value":845},{"label":"Set","value":673},{"label":"Out","value":825},{"label":"Nov","value":1034},{"label":"Dez","value":963}];
const MX = 1034;
