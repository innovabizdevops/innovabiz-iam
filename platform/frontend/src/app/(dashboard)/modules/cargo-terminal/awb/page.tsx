...
const PAGE = "AWB Process";
const KPIS = [{"l":"Riscos Identificados","v":"7.913","t":"+4.7%","d":"up"},{"l":"Mitigações Ativas","v":"6.292","t":"+12.2%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"+8.2%","d":"up"},{"l":"Incidentes YTD","v":"8.971","t":"+10.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.932","2.642","5.736","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.602","5.109","6.842","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.288","892","5.828","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","682","4.310","7.312","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.913","3.690","1.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":788},{"label":"Mar","value":902},{"label":"Abr","value":608},{"label":"Mai","value":875},{"label":"Jun","value":606},{"label":"Jul","value":734},{"label":"Ago","value":612},{"label":"Set","value":654},{"label":"Out","value":618},{"label":"Nov","value":878},{"label":"Dez","value":555}];
const MX = 902;
