...
const PAGE = "ULD Build";
const KPIS = [{"l":"Riscos Identificados","v":"8.053","t":"+7.4%","d":"up"},{"l":"Mitigações Ativas","v":"1.944","t":"+8.3%","d":"up"},{"l":"Score Risco Geral","v":"75","t":"+15.7%","d":"up"},{"l":"Incidentes YTD","v":"3.470","t":"-1.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","364","6.016","6.826","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.187","1.264","3.384","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","986","4.001","1.532","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.784","5.133","6.214","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.374","3.304","6.283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":811},{"label":"Mar","value":1021},{"label":"Abr","value":890},{"label":"Mai","value":894},{"label":"Jun","value":778},{"label":"Jul","value":827},{"label":"Ago","value":1004},{"label":"Set","value":969},{"label":"Out","value":918},{"label":"Nov","value":971},{"label":"Dez","value":989}];
const MX = 1021;
