...
const PAGE = "Customs Clear";
const KPIS = [{"l":"Riscos Identificados","v":"8.401","t":"+13.2%","d":"up"},{"l":"Mitigações Ativas","v":"4.708","t":"+6.1%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"+3.7%","d":"up"},{"l":"Incidentes YTD","v":"7.082","t":"+14.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.138","4.720","1.730","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.337","9.098","4.986","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.699","7.356","1.795","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.997","3.994","7.862","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.505","4.117","4.659","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":475},{"label":"Mar","value":348},{"label":"Abr","value":349},{"label":"Mai","value":390},{"label":"Jun","value":466},{"label":"Jul","value":680},{"label":"Ago","value":474},{"label":"Set","value":583},{"label":"Out","value":367},{"label":"Nov","value":433},{"label":"Dez","value":464}];
const MX = 680;
