...
const ACCENT = "#7c3aed";
const MODULE = "Cargo Terminal";
const PAGE = "Cool Chain";
const KPIS = [{"l":"Riscos Identificados","v":"3.315","t":"+4.1%","d":"up"},{"l":"Mitigações Ativas","v":"2.785","t":"+9.3%","d":"up"},{"l":"Score Risco Geral","v":"84","t":"+13.5%","d":"up"},{"l":"Incidentes YTD","v":"5.579","t":"+2.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","710","6.527","4.797","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.445","1.487","924","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.184","7.113","7.860","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","249","8.149","964","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.125","5.136","7.283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":925},{"label":"Mar","value":911},{"label":"Abr","value":919},{"label":"Mai","value":861},{"label":"Jun","value":634},{"label":"Jul","value":817},{"label":"Ago","value":549},{"label":"Set","value":756},{"label":"Out","value":906},{"label":"Nov","value":570},{"label":"Dez","value":803}];
const MX = 925;
