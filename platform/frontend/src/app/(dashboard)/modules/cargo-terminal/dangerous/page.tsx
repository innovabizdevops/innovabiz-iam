...
const PAGE = "DG Handling";
const KPIS = [{"l":"Riscos Identificados","v":"588","t":"-1.8%","d":"down"},{"l":"Mitigações Ativas","v":"6.688","t":"+5.3%","d":"up"},{"l":"Score Risco Geral","v":"57","t":"-3.8%","d":"down"},{"l":"Incidentes YTD","v":"5.421","t":"+0.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.427","391","5.977","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","849","6.591","7.874","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.106","8.115","8.782","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.363","2.693","6.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.818","8.160","7.468","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":529},{"label":"Mar","value":848},{"label":"Abr","value":550},{"label":"Mai","value":643},{"label":"Jun","value":713},{"label":"Jul","value":725},{"label":"Ago","value":831},{"label":"Set","value":818},{"label":"Out","value":571},{"label":"Nov","value":867},{"label":"Dez","value":683}];
const MX = 867;
