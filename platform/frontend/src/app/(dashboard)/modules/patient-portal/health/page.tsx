...
const ACCENT = "#ec4899";
const MODULE = "Patient Portal";
const PAGE = "My Health";
const KPIS = [{"l":"Páginas Publicadas","v":"3.577","t":"-4.4%","d":"down"},{"l":"Visitantes/Dia","v":"1330","t":"+16.3%","d":"up"},{"l":"Conversão (%)","v":"65.0%","t":"+11.3%","d":"up"},{"l":"Performance Score","v":"62","t":"+16.7%","d":"up"}];
const COLS = ["Página","URL","Views/Dia","Bounce (%)","Conversão (%)","Estado"];
const ROWS = [{"id":"r0","cells":["/home","/products","743","87.0%","87.5%","Ativo"],"status":"active"},{"id":"r1","cells":["/products","/pricing","2330","83.5%","91.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["/pricing","/about","281","71.9%","72.3%","Concluído"],"status":"done"},{"id":"r3","cells":["/about","/contact","2493","72.8%","71.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["/contact","/home","2666","70.9%","87.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":308},{"label":"Mar","value":323},{"label":"Abr","value":592},{"label":"Mai","value":619},{"label":"Jun","value":254},{"label":"Jul","value":302},{"label":"Ago","value":267},{"label":"Set","value":617},{"label":"Out","value":399},{"label":"Nov","value":297},{"label":"Dez","value":419}];
const MX = 619;
