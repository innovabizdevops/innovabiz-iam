...
const PAGE = "Track";
const KPIS = [{"l":"Riscos Identificados","v":"1.070","t":"+4.9%","d":"up"},{"l":"Mitigações Ativas","v":"6.027","t":"-4.8%","d":"down"},{"l":"Score Risco Geral","v":"67","t":"+4.0%","d":"up"},{"l":"Incidentes YTD","v":"3.092","t":"+4.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.102","4.161","962","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.177","2.959","7.643","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.118","6.956","8.291","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.346","5.623","2.395","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.653","4.090","8.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1049},{"label":"Fev","value":687},{"label":"Mar","value":965},{"label":"Abr","value":957},{"label":"Mai","value":1020},{"label":"Jun","value":678},{"label":"Jul","value":755},{"label":"Ago","value":890},{"label":"Set","value":747},{"label":"Out","value":915},{"label":"Nov","value":723},{"label":"Dez","value":1063}];
const MX = 1063;
