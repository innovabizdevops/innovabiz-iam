...
const PAGE = "Inspect";
const KPIS = [{"l":"Riscos Identificados","v":"5.033","t":"-2.2%","d":"down"},{"l":"Mitigações Ativas","v":"5.151","t":"+6.8%","d":"up"},{"l":"Score Risco Geral","v":"57","t":"+17.6%","d":"up"},{"l":"Incidentes YTD","v":"4.617","t":"-3.0%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.803","4.951","5.190","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","315","6.287","7.011","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.459","5.670","5.206","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.582","2.774","8.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.487","5.331","1.710","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":550},{"label":"Mar","value":690},{"label":"Abr","value":643},{"label":"Mai","value":720},{"label":"Jun","value":695},{"label":"Jul","value":581},{"label":"Ago","value":764},{"label":"Set","value":814},{"label":"Out","value":560},{"label":"Nov","value":671},{"label":"Dez","value":696}];
const MX = 814;
