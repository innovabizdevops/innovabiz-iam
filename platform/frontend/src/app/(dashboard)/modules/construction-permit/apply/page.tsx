...
const ACCENT = "#78350f";
const MODULE = "Construction Permit Mgmt";
const PAGE = "Apply";
const KPIS = [{"l":"Riscos Identificados","v":"5.379","t":"-2.1%","d":"down"},{"l":"Mitigações Ativas","v":"7.000","t":"+12.4%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+10.8%","d":"up"},{"l":"Incidentes YTD","v":"4.824","t":"+17.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.946","1.268","4.479","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.661","7.529","4.487","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.469","3.723","3.713","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","727","4.023","8.070","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.779","5.169","8.225","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1025},{"label":"Fev","value":924},{"label":"Mar","value":856},{"label":"Abr","value":726},{"label":"Mai","value":937},{"label":"Jun","value":711},{"label":"Jul","value":805},{"label":"Ago","value":969},{"label":"Set","value":1031},{"label":"Out","value":877},{"label":"Nov","value":696},{"label":"Dez","value":908}];
const MX = 1031;
