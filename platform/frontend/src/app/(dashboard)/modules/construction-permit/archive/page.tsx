...
const PAGE = "Archive";
const KPIS = [{"l":"Riscos Identificados","v":"8.104","t":"+3.3%","d":"up"},{"l":"Mitigações Ativas","v":"7.095","t":"-1.1%","d":"down"},{"l":"Score Risco Geral","v":"57","t":"+4.3%","d":"up"},{"l":"Incidentes YTD","v":"5.150","t":"+1.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.089","2.101","5.220","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.792","742","5.452","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.653","3.907","1.843","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.575","1.265","2.039","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.502","755","5.738","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":862},{"label":"Mar","value":761},{"label":"Abr","value":671},{"label":"Mai","value":512},{"label":"Jun","value":673},{"label":"Jul","value":824},{"label":"Ago","value":718},{"label":"Set","value":656},{"label":"Out","value":619},{"label":"Nov","value":755},{"label":"Dez","value":705}];
const MX = 862;
