...
/* ═══ Construction Permit Mgmt — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "6554", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4493", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2120408254", cells: ["CON-9254", "Construction Permit Mgmt Item 1", "7/11/2026", "€8354"], status: "active" as const },
    { id: "2120411825", cells: ["CON-3825", "Construction Permit Mgmt Item 2", "22/6/2026", "€11 925"], status: "pending" as const },
    { id: "2120415396", cells: ["CON-7396", "Construction Permit Mgmt Item 3", "9/1/2026", "€15 496"], status: "completed" as const },
    { id: "2120418967", cells: ["CON-1967", "Construction Permit Mgmt Item 4", "24/8/2026", "€19 067"], status: "warning" as const },
    { id: "2120422538", cells: ["CON-5538", "Construction Permit Mgmt Item 5", "11/3/2026", "€22 638"], status: "active" as const },
];
...
export default function ConstructionPermitMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Construction Permit Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Construction Permit Mgmt</p>
                    </div>
                </div>
