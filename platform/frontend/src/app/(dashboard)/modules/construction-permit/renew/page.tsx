...
const PAGE = "Renew";
const KPIS = [{"l":"Riscos Identificados","v":"5.237","t":"+9.4%","d":"up"},{"l":"Mitigações Ativas","v":"7.805","t":"+0.7%","d":"up"},{"l":"Score Risco Geral","v":"71","t":"+7.4%","d":"up"},{"l":"Incidentes YTD","v":"8.969","t":"+10.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","120","4.546","8.777","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.866","6.842","5.672","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.828","944","5.098","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.365","2.779","3.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","982","6.731","368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":690},{"label":"Mar","value":1021},{"label":"Abr","value":782},{"label":"Mai","value":718},{"label":"Jun","value":842},{"label":"Jul","value":924},{"label":"Ago","value":677},{"label":"Set","value":644},{"label":"Out","value":823},{"label":"Nov","value":885},{"label":"Dez","value":740}];
const MX = 1021;
