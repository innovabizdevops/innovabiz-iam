...
const KPIS = [{"l":"Pedidos/Dia","v":"1993","t":"+3.9%","d":"up"},{"l":"GMV (€)","v":"€53432","t":"+5.4%","d":"up"},{"l":"Conversão (%)","v":"85.8%","t":"+15.0%","d":"up"},{"l":"AOV (€)","v":"€46497","t":"+4.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 17309.62","8.073","2.843","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 24435.35","6.028","7.758","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 17800.55","6.594","2.529","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 36433.55","4.331","1.969","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 36409.87","8.802","2.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":792},{"label":"Mar","value":796},{"label":"Abr","value":776},{"label":"Mai","value":870},{"label":"Jun","value":906},{"label":"Jul","value":905},{"label":"Ago","value":712},{"label":"Set","value":893},{"label":"Out","value":858},{"label":"Nov","value":824},{"label":"Dez","value":589}];
const MX = 906;
...
export default function B2bEdiPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>New</span></h1>
                </div>
