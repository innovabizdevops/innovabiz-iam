...
const PAGE = "Webhook Manager";
const KPIS = [{"l":"Integrações Ativas","v":"4.848","t":"+14.1%","d":"up"},{"l":"Chamadas/Hora","v":"3154","t":"+7.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.0%","t":"+2.6%","d":"up"},{"l":"Latência Média (ms)","v":"33ms","t":"-1.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.188","7.708","88.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.362","663","88.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.535","7.159","89.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.707","6.864","83.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","121","1.193","86.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":478},{"label":"Mar","value":375},{"label":"Abr","value":651},{"label":"Mai","value":545},{"label":"Jun","value":655},{"label":"Jul","value":479},{"label":"Ago","value":468},{"label":"Set","value":603},{"label":"Out","value":604},{"label":"Nov","value":665},{"label":"Dez","value":668}];
const MX = 668;
