...
const PAGE = "ETL / ELT Pipelines";
const KPIS = [{"l":"Dashboards Ativos","v":"8.259","t":"+15.0%","d":"up"},{"l":"Queries/Dia","v":"2497","t":"-4.8%","d":"down"},{"l":"Dados Processados (GB)","v":"1.902","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"1.366","t":"+13.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2665","2026-03-13","224","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","328","2026-02-18","5.386","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4254","2026-02-10","4.792","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1674","2026-03-10","7.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3187","2026-02-11","1.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1020},{"label":"Fev","value":699},{"label":"Mar","value":686},{"label":"Abr","value":920},{"label":"Mai","value":918},{"label":"Jun","value":985},{"label":"Jul","value":792},{"label":"Ago","value":700},{"label":"Set","value":671},{"label":"Out","value":841},{"label":"Nov","value":877},{"label":"Dez","value":1002}];
const MX = 1020;
