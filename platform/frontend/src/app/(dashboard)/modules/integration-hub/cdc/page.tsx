...
const PAGE = "Data Replication CDC";
const KPIS = [{"l":"Integrações Ativas","v":"639","t":"+4.4%","d":"up"},{"l":"Chamadas/Hora","v":"534","t":"+16.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.6%","t":"-5.1%","d":"down"},{"l":"Latência Média (ms)","v":"164ms","t":"+2.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.000","1.328","80.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","938","5.140","76.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.094","8.841","82.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.996","6.774","81.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.175","1.046","76.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":550},{"label":"Mar","value":476},{"label":"Abr","value":481},{"label":"Mai","value":320},{"label":"Jun","value":642},{"label":"Jul","value":534},{"label":"Ago","value":619},{"label":"Set","value":440},{"label":"Out","value":651},{"label":"Nov","value":432},{"label":"Dez","value":521}];
const MX = 651;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>CDC</span></h1>
                </div>
