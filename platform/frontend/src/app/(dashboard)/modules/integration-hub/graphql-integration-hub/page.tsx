...
const KPIS = [{"l":"Integrações Ativas","v":"6.464","t":"+6.6%","d":"up"},{"l":"Chamadas/Hora","v":"1502","t":"-0.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"85.9%","t":"+2.6%","d":"up"},{"l":"Latência Média (ms)","v":"89ms","t":"+4.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.951","5.428","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.625","5.734","96.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.201","648","83.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.845","8.448","80.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.672","8.399","95.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":731},{"label":"Mar","value":930},{"label":"Abr","value":705},{"label":"Mai","value":927},{"label":"Jun","value":630},{"label":"Jul","value":737},{"label":"Ago","value":774},{"label":"Set","value":798},{"label":"Out","value":937},{"label":"Nov","value":715},{"label":"Dez","value":990}];
const MX = 990;
...
export default function GraphqlIntegrationHubPage() {
    return (
