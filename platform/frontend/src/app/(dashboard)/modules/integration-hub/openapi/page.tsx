...
const PAGE = "OpenAPI / Swagger";
const KPIS = [{"l":"Integrações Ativas","v":"3.072","t":"+16.3%","d":"up"},{"l":"Chamadas/Hora","v":"4299","t":"+15.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.4%","t":"+0.2%","d":"up"},{"l":"Latência Média (ms)","v":"59ms","t":"-3.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.959","3.488","80.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.578","5.100","98.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.482","5.406","96.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.519","8.894","95.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.509","9.021","76.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":458},{"label":"Mar","value":643},{"label":"Abr","value":602},{"label":"Mai","value":399},{"label":"Jun","value":561},{"label":"Jul","value":618},{"label":"Ago","value":638},{"label":"Set","value":616},{"label":"Out","value":714},{"label":"Nov","value":489},{"label":"Dez","value":437}];
const MX = 714;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>OpenAPI</span></h1>
                </div>
