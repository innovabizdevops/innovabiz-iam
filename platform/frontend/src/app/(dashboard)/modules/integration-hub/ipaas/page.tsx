...
const PAGE = "iPaaS Studio";
const KPIS = [{"l":"Integrações Ativas","v":"7.466","t":"+1.3%","d":"up"},{"l":"Chamadas/Hora","v":"4237","t":"-2.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"89.7%","t":"+12.7%","d":"up"},{"l":"Latência Média (ms)","v":"181ms","t":"+17.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.969","869","88.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.877","3.473","92.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.609","517","86.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","9.097","2.596","72.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","566","5.651","74.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":605},{"label":"Mar","value":281},{"label":"Abr","value":305},{"label":"Mai","value":532},{"label":"Jun","value":380},{"label":"Jul","value":607},{"label":"Ago","value":597},{"label":"Set","value":515},{"label":"Out","value":388},{"label":"Nov","value":504},{"label":"Dez","value":406}];
const MX = 607;
