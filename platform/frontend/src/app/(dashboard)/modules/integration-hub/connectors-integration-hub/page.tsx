...
const PAGE = "Connector Store";
const KPIS = [{"l":"Pedidos/Dia","v":"638","t":"+17.9%","d":"up"},{"l":"GMV (€)","v":"€18251","t":"+12.9%","d":"up"},{"l":"Conversão (%)","v":"93.7%","t":"-5.6%","d":"down"},{"l":"AOV (€)","v":"€94473","t":"+4.4%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 45204.94","5.594","8.620","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 16202.26","6.394","201","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 40726.67","3.900","2.544","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 29760.74","6.840","4.712","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 47228.50","5.236","2.426","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":430},{"label":"Mar","value":438},{"label":"Abr","value":579},{"label":"Mai","value":482},{"label":"Jun","value":420},{"label":"Jul","value":480},{"label":"Ago","value":659},{"label":"Set","value":284},{"label":"Out","value":343},{"label":"Nov","value":509},{"label":"Dez","value":411}];
const MX = 659;
...
export default function ConnectorsIntegrationHubPage() {
    return (
