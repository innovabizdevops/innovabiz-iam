...
const KPIS = [{"l":"Integrações Ativas","v":"8.095","t":"+14.9%","d":"up"},{"l":"Chamadas/Hora","v":"4530","t":"+9.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.5%","t":"+4.1%","d":"up"},{"l":"Latência Média (ms)","v":"129ms","t":"-2.7%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.927","6.420","83.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.800","6.892","86.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.981","5.851","85.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.245","6.000","99.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.585","7.729","76.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":801},{"label":"Mar","value":612},{"label":"Abr","value":831},{"label":"Mai","value":584},{"label":"Jun","value":765},{"label":"Jul","value":742},{"label":"Ago","value":678},{"label":"Set","value":804},{"label":"Out","value":930},{"label":"Nov","value":801},{"label":"Dez","value":633}];
const MX = 930;
