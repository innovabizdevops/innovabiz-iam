...
const PAGE = "CloudEvents Spec";
const KPIS = [{"l":"Integrações Ativas","v":"6.758","t":"-0.7%","d":"down"},{"l":"Chamadas/Hora","v":"980","t":"+11.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.7%","t":"+1.3%","d":"up"},{"l":"Latência Média (ms)","v":"195ms","t":"-0.1%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.633","6.883","78.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.395","5.903","79.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.870","5.442","78.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.630","4.353","72.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.644","226","71.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":423},{"label":"Mar","value":284},{"label":"Abr","value":513},{"label":"Mai","value":549},{"label":"Jun","value":233},{"label":"Jul","value":482},{"label":"Ago","value":371},{"label":"Set","value":564},{"label":"Out","value":408},{"label":"Nov","value":286},{"label":"Dez","value":496}];
const MX = 564;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>CNCF</span></h1>
                </div>
