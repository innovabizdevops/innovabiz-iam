...
const PAGE = "Event Bus Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"3.797","t":"+3.7%","d":"up"},{"l":"Chamadas/Hora","v":"824","t":"+13.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.3%","t":"+2.3%","d":"up"},{"l":"Latência Média (ms)","v":"93ms","t":"+4.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.938","2.436","73.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.840","1.893","80.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.876","734","85.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.829","5.542","71.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.296","6.928","98.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":565},{"label":"Mar","value":572},{"label":"Abr","value":827},{"label":"Mai","value":740},{"label":"Jun","value":857},{"label":"Jul","value":665},{"label":"Ago","value":673},{"label":"Set","value":657},{"label":"Out","value":636},{"label":"Nov","value":784},{"label":"Dez","value":864}];
const MX = 864;
