...
const PAGE = "API Marketplace";
const KPIS = [{"l":"Pedidos/Dia","v":"627","t":"+3.0%","d":"up"},{"l":"GMV (€)","v":"€49122","t":"+0.6%","d":"up"},{"l":"Conversão (%)","v":"83.0%","t":"-2.8%","d":"down"},{"l":"AOV (€)","v":"€56141","t":"+3.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 48886.59","2.507","3.117","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 13579.34","4.727","1.865","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 20171.82","7.333","2.098","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 39108.00","2.416","3.342","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 47569.47","7.726","8.751","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":401},{"label":"Mar","value":451},{"label":"Abr","value":340},{"label":"Mai","value":232},{"label":"Jun","value":496},{"label":"Jul","value":437},{"label":"Ago","value":296},{"label":"Set","value":332},{"label":"Out","value":399},{"label":"Nov","value":435},{"label":"Dez","value":243}];
const MX = 496;
