...
const PAGE = "AsyncAPI Standard";
const KPIS = [{"l":"Integrações Ativas","v":"2.352","t":"+14.6%","d":"up"},{"l":"Chamadas/Hora","v":"2379","t":"+13.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.6%","t":"+6.8%","d":"up"},{"l":"Latência Média (ms)","v":"122ms","t":"+14.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.972","5.221","78.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.445","5.322","74.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.657","3.250","95.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.886","2.418","79.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.196","607","87.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":1026},{"label":"Mar","value":726},{"label":"Abr","value":920},{"label":"Mai","value":826},{"label":"Jun","value":1080},{"label":"Jul","value":710},{"label":"Ago","value":989},{"label":"Set","value":1046},{"label":"Out","value":721},{"label":"Nov","value":782},{"label":"Dez","value":700}];
const MX = 1080;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>AsyncAPI</span></h1>
                </div>
