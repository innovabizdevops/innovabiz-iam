...
const PAGE = "Error Handling";
const KPIS = [{"l":"Integrações Ativas","v":"4.839","t":"+8.8%","d":"up"},{"l":"Chamadas/Hora","v":"291","t":"+4.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.3%","t":"+7.1%","d":"up"},{"l":"Latência Média (ms)","v":"159ms","t":"-5.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.900","5.035","72.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.149","8.861","76.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.132","5.030","72.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.102","1.797","90.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.147","1.742","92.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":884},{"label":"Mar","value":621},{"label":"Abr","value":750},{"label":"Mai","value":792},{"label":"Jun","value":791},{"label":"Jul","value":709},{"label":"Ago","value":674},{"label":"Set","value":962},{"label":"Out","value":782},{"label":"Nov","value":845},{"label":"Dez","value":784}];
const MX = 962;
