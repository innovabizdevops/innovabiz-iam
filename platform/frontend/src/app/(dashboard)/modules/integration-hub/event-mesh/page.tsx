...
const PAGE = "Event Mesh";
const KPIS = [{"l":"Integrações Ativas","v":"6.900","t":"+12.6%","d":"up"},{"l":"Chamadas/Hora","v":"161","t":"+10.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.3%","t":"+0.0%","d":"up"},{"l":"Latência Média (ms)","v":"76ms","t":"+14.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.736","7.719","95.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","9.058","8.245","84.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.588","3.632","86.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.715","5.251","85.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.901","4.042","84.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":564},{"label":"Mar","value":660},{"label":"Abr","value":825},{"label":"Mai","value":756},{"label":"Jun","value":724},{"label":"Jul","value":636},{"label":"Ago","value":743},{"label":"Set","value":880},{"label":"Out","value":905},{"label":"Nov","value":572},{"label":"Dez","value":579}];
const MX = 905;
