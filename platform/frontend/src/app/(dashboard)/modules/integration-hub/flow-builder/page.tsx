...
const PAGE = "Flow Builder";
const KPIS = [{"l":"Integrações Ativas","v":"4.335","t":"+14.2%","d":"up"},{"l":"Chamadas/Hora","v":"2290","t":"+11.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.0%","t":"-1.7%","d":"down"},{"l":"Latência Média (ms)","v":"30ms","t":"+17.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.929","1.417","90.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.684","8.586","94.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.219","7.619","85.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.953","7.543","96.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.497","1.684","90.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":642},{"label":"Mar","value":692},{"label":"Abr","value":903},{"label":"Mai","value":618},{"label":"Jun","value":893},{"label":"Jul","value":645},{"label":"Ago","value":844},{"label":"Set","value":637},{"label":"Out","value":716},{"label":"Nov","value":888},{"label":"Dez","value":958}];
const MX = 958;
