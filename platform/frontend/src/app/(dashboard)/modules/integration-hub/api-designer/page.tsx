...
const PAGE = "API Designer";
const KPIS = [{"l":"Formulários Ativos","v":"6.044","t":"+15.1%","d":"up"},{"l":"Submissões/Dia","v":"1452","t":"+2.0%","d":"up"},{"l":"Documentos Gerados","v":"6.757","t":"-0.1%","d":"down"},{"l":"Templates","v":"5.514","t":"+9.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.806","2026-01-20","7.959","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.223","2026-02-11","3.469","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.942","2026-02-16","8.620","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.291","2026-03-25","6.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.167","2026-02-11","3.256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":808},{"label":"Mar","value":681},{"label":"Abr","value":701},{"label":"Mai","value":608},{"label":"Jun","value":697},{"label":"Jul","value":725},{"label":"Ago","value":622},{"label":"Set","value":709},{"label":"Out","value":797},{"label":"Nov","value":728},{"label":"Dez","value":800}];
const MX = 808;
