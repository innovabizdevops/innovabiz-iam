...
const PAGE = "Change Data Capture";
const KPIS = [{"l":"Integrações Ativas","v":"7.618","t":"+16.5%","d":"up"},{"l":"Chamadas/Hora","v":"3752","t":"-1.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"68.2%","t":"-0.7%","d":"down"},{"l":"Latência Média (ms)","v":"108ms","t":"+15.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.287","7.994","91.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.130","2.885","73.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","545","4.965","95.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.974","3.755","79.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.745","990","98.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":1030},{"label":"Mar","value":942},{"label":"Abr","value":901},{"label":"Mai","value":858},{"label":"Jun","value":1077},{"label":"Jul","value":974},{"label":"Ago","value":699},{"label":"Set","value":869},{"label":"Out","value":718},{"label":"Nov","value":756},{"label":"Dez","value":848}];
const MX = 1077;
...
export default function CdcIntegrationHubPage() {
    return (
