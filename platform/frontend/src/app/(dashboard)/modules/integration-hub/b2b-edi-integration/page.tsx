...
const ACCENT = "#4f46e5";
const MODULE = "Integration Hub (iPaaS)";
const PAGE = "B2B/EDI Gateway";
const KPIS = [{"l":"Pedidos/Dia","v":"1650","t":"+13.1%","d":"up"},{"l":"GMV (€)","v":"€53034","t":"+1.3%","d":"up"},{"l":"Conversão (%)","v":"80.5%","t":"+1.0%","d":"up"},{"l":"AOV (€)","v":"€18715","t":"+2.8%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 41043.75","8.566","3.054","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 39129.25","3.825","7.008","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33901.59","1.170","340","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 24554.27","1.172","5.430","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 40241.92","4.388","5.086","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":697},{"label":"Mar","value":534},{"label":"Abr","value":464},{"label":"Mai","value":763},{"label":"Jun","value":492},{"label":"Jul","value":532},{"label":"Ago","value":603},{"label":"Set","value":599},{"label":"Out","value":795},{"label":"Nov","value":619},{"label":"Dez","value":552}];
const MX = 833;
...
export default function B2bEdiIntegrationPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>EDI</span></h1>
                </div>
