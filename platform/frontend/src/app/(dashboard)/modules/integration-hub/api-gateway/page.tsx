...
const KPIS = [{"l":"Integrações Ativas","v":"7.190","t":"+6.7%","d":"up"},{"l":"Chamadas/Hora","v":"232","t":"-1.0%","d":"down"},{"l":"Taxa Sucesso (%)","v":"88.4%","t":"-5.2%","d":"down"},{"l":"Latência Média (ms)","v":"96ms","t":"-3.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.684","4.329","72.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.024","2.106","83.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.344","2.838","80.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.049","8.537","90.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.030","949","92.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":800},{"label":"Mar","value":770},{"label":"Abr","value":971},{"label":"Mai","value":703},{"label":"Jun","value":992},{"label":"Jul","value":1014},{"label":"Ago","value":932},{"label":"Set","value":1032},{"label":"Out","value":755},{"label":"Nov","value":818},{"label":"Dez","value":824}];
const MX = 1032;
