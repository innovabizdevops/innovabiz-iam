...
const KPIS = [{"l":"Dashboards Ativos","v":"8.992","t":"+14.1%","d":"up"},{"l":"Queries/Dia","v":"3694","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"8.608","t":"+1.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.858","t":"+10.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2484","2026-01-18","6.944","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","245","2026-03-28","5.969","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3852","2026-02-17","1.329","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4336","2026-03-20","6.877","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2990","2026-03-11","2.517","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":699},{"label":"Mar","value":608},{"label":"Abr","value":470},{"label":"Mai","value":611},{"label":"Jun","value":595},{"label":"Jul","value":721},{"label":"Ago","value":659},{"label":"Set","value":741},{"label":"Out","value":573},{"label":"Nov","value":480},{"label":"Dez","value":525}];
const MX = 741;
