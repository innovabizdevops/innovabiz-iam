...
const PAGE = "ETL Pipelines";
const KPIS = [{"l":"Dashboards Ativos","v":"8.417","t":"+14.6%","d":"up"},{"l":"Queries/Dia","v":"3886","t":"-4.7%","d":"down"},{"l":"Dados Processados (GB)","v":"8.831","t":"+15.4%","d":"up"},{"l":"Utilizadores Analytics","v":"7.683","t":"+10.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1767","2026-01-04","8.572","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2091","2026-02-06","2.039","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2147","2026-03-27","2.723","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4242","2026-02-09","7.351","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2056","2026-03-17","5.716","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":324},{"label":"Fev","value":359},{"label":"Mar","value":409},{"label":"Abr","value":422},{"label":"Mai","value":360},{"label":"Jun","value":678},{"label":"Jul","value":384},{"label":"Ago","value":407},{"label":"Set","value":473},{"label":"Out","value":443},{"label":"Nov","value":525},{"label":"Dez","value":431}];
const MX = 678;
