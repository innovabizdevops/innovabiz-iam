...
const PAGE = "gRPC Services";
const KPIS = [{"l":"Integrações Ativas","v":"6.898","t":"+0.7%","d":"up"},{"l":"Chamadas/Hora","v":"1086","t":"+13.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.9%","t":"+7.6%","d":"up"},{"l":"Latência Média (ms)","v":"112ms","t":"+7.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.827","7.182","74.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.173","3.663","74.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.399","806","90.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","263","193","87.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","152","5.603","91.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":1060},{"label":"Mar","value":741},{"label":"Abr","value":840},{"label":"Mai","value":1011},{"label":"Jun","value":986},{"label":"Jul","value":675},{"label":"Ago","value":996},{"label":"Set","value":709},{"label":"Out","value":952},{"label":"Nov","value":904},{"label":"Dez","value":1040}];
const MX = 1060;
