...
const PAGE = "GraphQL Gateway";
const KPIS = [{"l":"Integrações Ativas","v":"5.341","t":"+16.2%","d":"up"},{"l":"Chamadas/Hora","v":"1158","t":"+1.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.9%","t":"-3.1%","d":"down"},{"l":"Latência Média (ms)","v":"161ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.884","6.317","95.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.287","519","70.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","795","3.299","95.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.372","3.604","93.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.345","2.103","86.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":515},{"label":"Mar","value":704},{"label":"Abr","value":693},{"label":"Mai","value":528},{"label":"Jun","value":492},{"label":"Jul","value":826},{"label":"Ago","value":543},{"label":"Set","value":762},{"label":"Out","value":458},{"label":"Nov","value":519},{"label":"Dez","value":526}];
const MX = 826;
