...
const KPIS = [{"l":"Total Message Queue","v":"6.721","t":"-3.4%","d":"down"},{"l":"Throughput Ativos","v":"879","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+8.1%","d":"up"}];
const COLS = ["ID","Throughput","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Queue #001","Message Queue #002","8.348","946","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Message Queue #002","Message Queue #003","2.656","8.423","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Queue #003","Message Queue #004","5.271","7.516","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Message Queue #004","Message Queue #005","6.621","2.607","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Queue #005","Message Queue #001","3.152","4.428","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":708},{"label":"Mar","value":658},{"label":"Abr","value":678},{"label":"Mai","value":507},{"label":"Jun","value":691},{"label":"Jul","value":689},{"label":"Ago","value":633},{"label":"Set","value":379},{"label":"Out","value":506},{"label":"Nov","value":387},{"label":"Dez","value":429}];
const MX = 708;
