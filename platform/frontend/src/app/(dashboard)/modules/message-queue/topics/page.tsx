...
const PAGE = "Topics";
const KPIS = [{"l":"Total Message Queue","v":"5.659","t":"+16.0%","d":"up"},{"l":"Topics Ativos","v":"8.434","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"84","t":"+16.4%","d":"up"}];
const COLS = ["ID","Topics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Queue #001","Message Queue #002","4.248","7.958","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Message Queue #002","Message Queue #003","3.472","6.788","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Queue #003","Message Queue #004","2.256","6.798","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Message Queue #004","Message Queue #005","7.162","8.887","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Queue #005","Message Queue #001","2.951","5.323","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":471},{"label":"Mar","value":601},{"label":"Abr","value":449},{"label":"Mai","value":741},{"label":"Jun","value":599},{"label":"Jul","value":389},{"label":"Ago","value":470},{"label":"Set","value":354},{"label":"Out","value":356},{"label":"Nov","value":500},{"label":"Dez","value":366}];
const MX = 741;
