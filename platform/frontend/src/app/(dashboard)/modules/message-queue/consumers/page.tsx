...
const ACCENT = "#b45309";
const MODULE = "Message Queue";
const PAGE = "Consumer Groups";
const KPIS = [{"l":"Total Message Queue","v":"378","t":"+14.8%","d":"up"},{"l":"Consumer Groups Ativos","v":"7.362","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"88.2%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+14.9%","d":"up"}];
const COLS = ["ID","Consumer Groups","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Queue #001","Message Queue #002","3.882","7.123","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Message Queue #002","Message Queue #003","6.612","6.954","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Queue #003","Message Queue #004","133","9.052","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Message Queue #004","Message Queue #005","5.407","8.027","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Queue #005","Message Queue #001","1.273","4.955","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":549},{"label":"Mar","value":751},{"label":"Abr","value":542},{"label":"Mai","value":451},{"label":"Jun","value":519},{"label":"Jul","value":408},{"label":"Ago","value":700},{"label":"Set","value":410},{"label":"Out","value":508},{"label":"Nov","value":604},{"label":"Dez","value":561}];
const MX = 751;
