...
const PAGE = "Dead Letter";
const KPIS = [{"l":"Total Message Queue","v":"3.648","t":"+8.5%","d":"up"},{"l":"Dead Letter Ativos","v":"1.472","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+12.4%","d":"up"}];
const COLS = ["ID","Dead Letter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Message Queue #001","Message Queue #002","682","1.693","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Message Queue #002","Message Queue #003","8.493","6.078","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Message Queue #003","Message Queue #004","3.428","3.144","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Message Queue #004","Message Queue #005","709","7.698","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Message Queue #005","Message Queue #001","8.672","5.987","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":571},{"label":"Mar","value":483},{"label":"Abr","value":539},{"label":"Mai","value":436},{"label":"Jun","value":728},{"label":"Jul","value":481},{"label":"Ago","value":681},{"label":"Set","value":753},{"label":"Out","value":387},{"label":"Nov","value":489},{"label":"Dez","value":559}];
const MX = 753;
