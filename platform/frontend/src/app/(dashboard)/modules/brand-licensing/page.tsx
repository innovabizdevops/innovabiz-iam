...
/* ═══ Brand Licensing — Dashboard ═══ */

const ACCENT = "#93c5fd";

const KPIS = [
    { label: "Total Registos", value: "6535", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "180", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€62K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "998055135", cells: ["BRA-1135", "Brand Licensing Item 1", "8/4/2026", "€5235"], status: "active" as const },
    { id: "998058706", cells: ["BRA-4706", "Brand Licensing Item 2", "23/11/2026", "€8806"], status: "pending" as const },
    { id: "998062277", cells: ["BRA-8277", "Brand Licensing Item 3", "10/6/2026", "€12 377"], status: "completed" as const },
    { id: "998065848", cells: ["BRA-2848", "Brand Licensing Item 4", "25/1/2026", "€15 948"], status: "warning" as const },
    { id: "998069419", cells: ["BRA-6419", "Brand Licensing Item 5", "12/8/2026", "€19 519"], status: "active" as const },
];
...
export default function BrandLicensingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brand Licensing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Brand Licensing</p>
                    </div>
                </div>
