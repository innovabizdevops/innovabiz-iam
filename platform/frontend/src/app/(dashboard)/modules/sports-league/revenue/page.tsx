...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€15.9M","t":"+7.5%","d":"up"},{"l":"MRR (€)","v":"€12307","t":"+16.0%","d":"up"},{"l":"Churn (%)","v":"81.4%","t":"+10.6%","d":"up"},{"l":"ARPU (€)","v":"€10285","t":"+3.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 43560.15","7.598","€ 42284.86","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38964.66","6.725","€ 37408.66","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42929.27","6.746","€ 10548.62","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 10966.09","5.792","€ 23919.60","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 39287.16","6.671","€ 15073.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":395},{"label":"Mar","value":339},{"label":"Abr","value":245},{"label":"Mai","value":592},{"label":"Jun","value":567},{"label":"Jul","value":258},{"label":"Ago","value":506},{"label":"Set","value":348},{"label":"Out","value":511},{"label":"Nov","value":353},{"label":"Dez","value":326}];
const MX = 592;
