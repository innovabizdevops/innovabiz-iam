...
const PAGE = "Standing";
const KPIS = [{"l":"Atletas Registados","v":"2.770","t":"+9.9%","d":"up"},{"l":"Treinos/Semana","v":"3132","t":"+1.3%","d":"up"},{"l":"Competições","v":"2.052","t":"+7.0%","d":"up"},{"l":"Performance Score","v":"56","t":"+13.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.918","6.526","4.780","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.323","4.248","8.939","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.136","1.532","6.964","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.040","5.355","4.560","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.964","5.232","7.831","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":848},{"label":"Mar","value":665},{"label":"Abr","value":779},{"label":"Mai","value":756},{"label":"Jun","value":1027},{"label":"Jul","value":937},{"label":"Ago","value":869},{"label":"Set","value":998},{"label":"Out","value":1015},{"label":"Nov","value":847},{"label":"Dez","value":652}];
const MX = 1027;
