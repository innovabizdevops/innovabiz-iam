...
const PAGE = "Schedule";
const KPIS = [{"l":"Atletas Registados","v":"4.456","t":"+9.2%","d":"up"},{"l":"Treinos/Semana","v":"3805","t":"+14.2%","d":"up"},{"l":"Competições","v":"7.146","t":"-3.6%","d":"down"},{"l":"Performance Score","v":"90","t":"-4.9%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.831","4.207","6.254","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.123","2.859","2.914","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.469","6.776","2.429","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.861","1.541","4.417","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","834","5.660","116","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":778},{"label":"Mar","value":819},{"label":"Abr","value":669},{"label":"Mai","value":655},{"label":"Jun","value":810},{"label":"Jul","value":823},{"label":"Ago","value":805},{"label":"Set","value":676},{"label":"Out","value":779},{"label":"Nov","value":669},{"label":"Dez","value":559}];
const MX = 823;
