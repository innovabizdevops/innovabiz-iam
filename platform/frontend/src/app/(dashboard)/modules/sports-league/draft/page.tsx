...
const PAGE = "Draft";
const KPIS = [{"l":"Atletas Registados","v":"6.173","t":"+2.0%","d":"up"},{"l":"Treinos/Semana","v":"1259","t":"+17.1%","d":"up"},{"l":"Competições","v":"1.852","t":"+6.9%","d":"up"},{"l":"Performance Score","v":"80","t":"+2.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.022","6.085","1.819","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.223","2.633","1.771","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.434","4.277","3.983","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.422","5.719","474","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.931","1.195","7.120","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":306},{"label":"Fev","value":622},{"label":"Mar","value":570},{"label":"Abr","value":295},{"label":"Mai","value":301},{"label":"Jun","value":389},{"label":"Jul","value":269},{"label":"Ago","value":508},{"label":"Set","value":402},{"label":"Out","value":346},{"label":"Nov","value":397},{"label":"Dez","value":258}];
const MX = 622;
