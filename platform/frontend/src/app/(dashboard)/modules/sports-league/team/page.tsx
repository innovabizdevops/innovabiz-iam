...
const ACCENT = "#15803d";
const MODULE = "Sports League Mgmt";
const PAGE = "Team";
const KPIS = [{"l":"Teams Ativos","v":"7.713","t":"+3.8%","d":"up"},{"l":"Reuniões/Semana","v":"1556","t":"+13.6%","d":"up"},{"l":"Mensagens/Dia","v":"4205","t":"-3.4%","d":"down"},{"l":"Ficheiros Partilhados","v":"1.471","t":"+16.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.821","1259","2.822","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.190","2832","1.925","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","4.260","4096","912","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.531","4382","5.796","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.692","1981","3.234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":921},{"label":"Mar","value":858},{"label":"Abr","value":897},{"label":"Mai","value":727},{"label":"Jun","value":881},{"label":"Jul","value":883},{"label":"Ago","value":689},{"label":"Set","value":966},{"label":"Out","value":991},{"label":"Nov","value":752},{"label":"Dez","value":701}];
const MX = 991;
