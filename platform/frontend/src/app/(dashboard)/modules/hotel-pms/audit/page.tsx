...
const PAGE = "Night Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.458","t":"+16.0%","d":"up"},{"l":"NC Abertas","v":"7.774","t":"-5.7%","d":"down"},{"l":"Conformidade (%)","v":"65.1%","t":"+4.0%","d":"up"},{"l":"CAPAs Pendentes","v":"1.409","t":"+3.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.251","70.6%","6.185","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.698","84.2%","9.055","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.423","85.2%","2.630","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.833","74.6%","6.186","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.470","84.2%","9.027","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":934},{"label":"Mar","value":832},{"label":"Abr","value":578},{"label":"Mai","value":740},{"label":"Jun","value":896},{"label":"Jul","value":624},{"label":"Ago","value":769},{"label":"Set","value":732},{"label":"Out","value":846},{"label":"Nov","value":550},{"label":"Dez","value":621}];
const MX = 934;
