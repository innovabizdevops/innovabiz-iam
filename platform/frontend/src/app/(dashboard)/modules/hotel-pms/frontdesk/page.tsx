...
const ACCENT = "#6366f1";
const MODULE = "Hotel PMS";
const PAGE = "Front Desk";
const KPIS = [{"l":"Quartos Ocupados","v":"3.098","t":"+17.1%","d":"up"},{"l":"RevPAR (€)","v":"€74720","t":"+10.5%","d":"up"},{"l":"Ocupação (%)","v":"94.4%","t":"+4.6%","d":"up"},{"l":"Guest Satisfaction","v":"3.657","t":"-5.9%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.999","2026-01-02","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.067","2026-03-28","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.950","2026-03-12","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.950","2026-01-26","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.671","2026-02-23","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":901},{"label":"Mar","value":683},{"label":"Abr","value":955},{"label":"Mai","value":727},{"label":"Jun","value":875},{"label":"Jul","value":658},{"label":"Ago","value":926},{"label":"Set","value":903},{"label":"Out","value":698},{"label":"Nov","value":942},{"label":"Dez","value":806}];
const MX = 955;
