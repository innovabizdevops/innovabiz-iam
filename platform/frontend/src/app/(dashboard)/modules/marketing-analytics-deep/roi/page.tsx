...
const PAGE = "ROI";
const KPIS = [{"l":"Dashboards Ativos","v":"7.789","t":"-0.9%","d":"down"},{"l":"Queries/Dia","v":"2824","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"708","t":"+13.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.278","t":"+14.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4932","2026-02-27","5.747","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4120","2026-03-17","3.377","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4997","2026-01-14","1.630","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4520","2026-02-08","6.239","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1197","2026-03-23","5.428","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":624},{"label":"Mar","value":913},{"label":"Abr","value":835},{"label":"Mai","value":753},{"label":"Jun","value":840},{"label":"Jul","value":685},{"label":"Ago","value":840},{"label":"Set","value":825},{"label":"Out","value":932},{"label":"Nov","value":630},{"label":"Dez","value":776}];
const MX = 932;
