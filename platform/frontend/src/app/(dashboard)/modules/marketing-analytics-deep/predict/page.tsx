...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.996","t":"+0.7%","d":"up"},{"l":"Queries/Dia","v":"325","t":"+6.0%","d":"up"},{"l":"Dados Processados (GB)","v":"2.841","t":"+12.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.668","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3318","2026-02-25","1.439","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3182","2026-01-25","2.643","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2841","2026-01-28","7.677","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4038","2026-02-14","437","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1188","2026-03-20","2.711","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":646},{"label":"Mar","value":922},{"label":"Abr","value":1014},{"label":"Mai","value":795},{"label":"Jun","value":629},{"label":"Jul","value":697},{"label":"Ago","value":661},{"label":"Set","value":962},{"label":"Out","value":747},{"label":"Nov","value":656},{"label":"Dez","value":886}];
const MX = 1014;
