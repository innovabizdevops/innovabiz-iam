...
/* ═══ Marketing Analytics Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "6485", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1467", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€161K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1722408385", cells: ["MAR-7385", "Marketing Analytics Deep Item 1", "6/2/2026", "€8485"], status: "active" as const },
    { id: "1722411956", cells: ["MAR-1956", "Marketing Analytics Deep Item 2", "21/9/2026", "€12 056"], status: "pending" as const },
    { id: "1722415527", cells: ["MAR-5527", "Marketing Analytics Deep Item 3", "8/4/2026", "€15 627"], status: "completed" as const },
    { id: "1722419098", cells: ["MAR-9098", "Marketing Analytics Deep Item 4", "23/11/2026", "€19 198"], status: "warning" as const },
    { id: "1722422669", cells: ["MAR-3669", "Marketing Analytics Deep Item 5", "10/6/2026", "€22 769"], status: "active" as const },
];
...
export default function MarketingAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marketing Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marketing Analytics Deep</p>
                    </div>
                </div>
