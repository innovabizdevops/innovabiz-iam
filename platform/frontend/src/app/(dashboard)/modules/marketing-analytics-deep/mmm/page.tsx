...
const PAGE = "Mix Model";
const KPIS = [{"l":"Dashboards Ativos","v":"4.430","t":"-5.7%","d":"down"},{"l":"Queries/Dia","v":"3065","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"9.007","t":"+2.6%","d":"up"},{"l":"Utilizadores Analytics","v":"8.005","t":"-3.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4848","2026-01-21","684","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3722","2026-02-25","6.992","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","264","2026-03-01","7.186","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","481","2026-03-21","3.085","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3499","2026-01-27","1.818","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":907},{"label":"Mar","value":769},{"label":"Abr","value":966},{"label":"Mai","value":646},{"label":"Jun","value":692},{"label":"Jul","value":939},{"label":"Ago","value":779},{"label":"Set","value":845},{"label":"Out","value":691},{"label":"Nov","value":879},{"label":"Dez","value":806}];
const MX = 966;
