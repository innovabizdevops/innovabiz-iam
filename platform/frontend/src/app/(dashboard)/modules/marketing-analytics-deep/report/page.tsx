...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"1.896","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"2962","t":"+15.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.530","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.946","t":"+6.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1711","2026-01-21","6.000","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3695","2026-03-11","1.933","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3261","2026-02-12","348","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3250","2026-02-07","8.322","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1201","2026-01-12","8.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":929},{"label":"Mar","value":617},{"label":"Abr","value":716},{"label":"Mai","value":798},{"label":"Jun","value":758},{"label":"Jul","value":806},{"label":"Ago","value":809},{"label":"Set","value":613},{"label":"Out","value":863},{"label":"Nov","value":891},{"label":"Dez","value":983}];
const MX = 983;
