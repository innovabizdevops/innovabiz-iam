...
const ACCENT = "#be185d";
const MODULE = "Marketing Analytics Deep";
const PAGE = "Attribution";
const KPIS = [{"l":"Dashboards Ativos","v":"7.484","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"737","t":"-2.0%","d":"down"},{"l":"Dados Processados (GB)","v":"4.225","t":"+15.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.615","t":"+5.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3455","2026-03-06","8.101","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4595","2026-03-06","1.106","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1958","2026-03-05","4.649","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2919","2026-01-04","956","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4013","2026-03-13","600","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":786},{"label":"Mar","value":1012},{"label":"Abr","value":854},{"label":"Mai","value":841},{"label":"Jun","value":811},{"label":"Jul","value":880},{"label":"Ago","value":676},{"label":"Set","value":707},{"label":"Out","value":712},{"label":"Nov","value":707},{"label":"Dez","value":1015}];
const MX = 1015;
