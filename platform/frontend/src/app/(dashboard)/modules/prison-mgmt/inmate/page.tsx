...
const PAGE = "Inmate";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.046","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"7.902","t":"+2.6%","d":"up"},{"l":"Conformidade (%)","v":"93.2%","t":"+15.9%","d":"up"},{"l":"CAPAs Pendentes","v":"8.275","t":"+5.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.438","75.6%","960","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.809","83.9%","146","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.949","83.6%","308","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.337","96.8%","7.904","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.952","82.3%","6.436","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":245},{"label":"Fev","value":562},{"label":"Mar","value":499},{"label":"Abr","value":596},{"label":"Mai","value":429},{"label":"Jun","value":364},{"label":"Jul","value":340},{"label":"Ago","value":433},{"label":"Set","value":343},{"label":"Out","value":245},{"label":"Nov","value":237},{"label":"Dez","value":616}];
const MX = 616;
