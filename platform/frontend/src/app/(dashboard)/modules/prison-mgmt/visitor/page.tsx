...
const PAGE = "Visitor";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.450","t":"+17.9%","d":"up"},{"l":"NC Abertas","v":"598","t":"-5.5%","d":"down"},{"l":"Conformidade (%)","v":"70.5%","t":"+16.9%","d":"up"},{"l":"CAPAs Pendentes","v":"3.125","t":"+10.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","288","93.2%","4.300","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.909","80.1%","2.918","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.906","78.2%","4.304","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.570","85.8%","3.656","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.099","100.0%","9.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":966},{"label":"Mar","value":603},{"label":"Abr","value":718},{"label":"Mai","value":872},{"label":"Jun","value":971},{"label":"Jul","value":593},{"label":"Ago","value":638},{"label":"Set","value":690},{"label":"Out","value":637},{"label":"Nov","value":671},{"label":"Dez","value":919}];
const MX = 971;
