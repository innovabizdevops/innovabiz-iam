...
const ACCENT = "#6366f1";
const MODULE = "Prison Management";
const PAGE = "Programs";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.280","t":"+0.7%","d":"up"},{"l":"NC Abertas","v":"8.679","t":"+8.0%","d":"up"},{"l":"Conformidade (%)","v":"90.4%","t":"-1.0%","d":"down"},{"l":"CAPAs Pendentes","v":"474","t":"-2.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.027","93.7%","2.741","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.812","91.3%","3.453","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.715","94.6%","4.241","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.578","91.9%","4.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.797","73.1%","5.185","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":308},{"label":"Mar","value":362},{"label":"Abr","value":593},{"label":"Mai","value":701},{"label":"Jun","value":396},{"label":"Jul","value":345},{"label":"Ago","value":544},{"label":"Set","value":461},{"label":"Out","value":575},{"label":"Nov","value":314},{"label":"Dez","value":556}];
const MX = 701;
