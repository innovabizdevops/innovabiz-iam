...
const PAGE = "Security";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.542","t":"+0.7%","d":"up"},{"l":"NC Abertas","v":"950","t":"+13.3%","d":"up"},{"l":"Conformidade (%)","v":"84.5%","t":"+5.3%","d":"up"},{"l":"CAPAs Pendentes","v":"657","t":"+2.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.449","82.8%","8.777","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.211","90.7%","1.303","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.812","73.8%","1.959","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.907","90.0%","7.021","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.270","98.6%","4.820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":976},{"label":"Fev","value":895},{"label":"Mar","value":782},{"label":"Abr","value":863},{"label":"Mai","value":940},{"label":"Jun","value":758},{"label":"Jul","value":863},{"label":"Ago","value":729},{"label":"Set","value":679},{"label":"Out","value":858},{"label":"Nov","value":773},{"label":"Dez","value":803}];
const MX = 976;
