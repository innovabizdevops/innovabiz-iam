...
const PAGE = "STT";
const KPIS = [{"l":"Formulários Ativos","v":"1.103","t":"+9.5%","d":"up"},{"l":"Submissões/Dia","v":"3873","t":"+7.8%","d":"up"},{"l":"Documentos Gerados","v":"4.852","t":"+10.1%","d":"up"},{"l":"Templates","v":"6.817","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.124","2026-03-05","3.988","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.465","2026-02-16","1.238","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.269","2026-01-23","5.026","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.392","2026-03-11","5.588","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.319","2026-02-07","7.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":1006},{"label":"Mar","value":881},{"label":"Abr","value":820},{"label":"Mai","value":1049},{"label":"Jun","value":857},{"label":"Jul","value":1040},{"label":"Ago","value":1041},{"label":"Set","value":953},{"label":"Out","value":957},{"label":"Nov","value":893},{"label":"Dez","value":1086}];
const MX = 1086;
