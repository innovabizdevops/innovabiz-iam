...
const KPIS = [{"l":"Formulários Ativos","v":"2.640","t":"+1.2%","d":"up"},{"l":"Submissões/Dia","v":"2167","t":"-2.3%","d":"down"},{"l":"Documentos Gerados","v":"3.879","t":"-2.9%","d":"down"},{"l":"Templates","v":"317","t":"+17.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.011","2026-02-18","6.338","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.012","2026-02-15","6.314","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.157","2026-02-05","2.956","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.131","2026-01-06","4.765","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.390","2026-03-18","8.876","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":750},{"label":"Mar","value":388},{"label":"Abr","value":406},{"label":"Mai","value":369},{"label":"Jun","value":632},{"label":"Jul","value":487},{"label":"Ago","value":623},{"label":"Set","value":474},{"label":"Out","value":511},{"label":"Nov","value":747},{"label":"Dez","value":525}];
const MX = 750;
