...
const ACCENT = "#6366f1";
const MODULE = "Voice Platform";
const PAGE = "Assistant";
const KPIS = [{"l":"Formulários Ativos","v":"3.742","t":"+6.7%","d":"up"},{"l":"Submissões/Dia","v":"1830","t":"+11.0%","d":"up"},{"l":"Documentos Gerados","v":"6.900","t":"+7.2%","d":"up"},{"l":"Templates","v":"1.971","t":"+14.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.757","2026-02-26","3.436","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.750","2026-01-03","7.679","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.526","2026-01-21","7.403","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.560","2026-02-22","8.719","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.848","2026-03-28","1.153","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":746},{"label":"Mar","value":457},{"label":"Abr","value":676},{"label":"Mai","value":401},{"label":"Jun","value":765},{"label":"Jul","value":506},{"label":"Ago","value":508},{"label":"Set","value":445},{"label":"Out","value":399},{"label":"Nov","value":696},{"label":"Dez","value":533}];
const MX = 765;
