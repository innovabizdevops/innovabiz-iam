...
const PAGE = "IVR";
const KPIS = [{"l":"Formulários Ativos","v":"2.092","t":"+6.2%","d":"up"},{"l":"Submissões/Dia","v":"179","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"6.558","t":"-5.7%","d":"down"},{"l":"Templates","v":"6.938","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.050","2026-01-03","6.114","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.006","2026-02-23","159","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.413","2026-02-09","1.568","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.149","2026-01-22","4.495","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.423","2026-01-03","8.406","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":447},{"label":"Mar","value":267},{"label":"Abr","value":556},{"label":"Mai","value":505},{"label":"Jun","value":328},{"label":"Jul","value":515},{"label":"Ago","value":227},{"label":"Set","value":567},{"label":"Out","value":601},{"label":"Nov","value":315},{"label":"Dez","value":309}];
const MX = 601;
