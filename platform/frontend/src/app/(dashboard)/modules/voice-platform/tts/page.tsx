...
const PAGE = "TTS";
const KPIS = [{"l":"Formulários Ativos","v":"2.544","t":"+5.5%","d":"up"},{"l":"Submissões/Dia","v":"3845","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"7.101","t":"+16.9%","d":"up"},{"l":"Templates","v":"8.473","t":"+8.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.270","2026-02-26","4.948","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.413","2026-03-16","5.868","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.586","2026-02-08","623","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.958","2026-02-23","4.519","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","335","2026-02-07","4.810","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":474},{"label":"Mar","value":665},{"label":"Abr","value":387},{"label":"Mai","value":497},{"label":"Jun","value":343},{"label":"Jul","value":587},{"label":"Ago","value":622},{"label":"Set","value":541},{"label":"Out","value":546},{"label":"Nov","value":701},{"label":"Dez","value":586}];
const MX = 701;
