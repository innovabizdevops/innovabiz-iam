...
const KPIS = [
    { label: "Total Registos", value: "2100", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2607", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€352K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "258867200", cells: ["WED-1200", "Wedding Planner Item 1", "5/9/2026", "€17 300"], status: "active" as const },
    { id: "258870771", cells: ["WED-4771", "Wedding Planner Item 2", "20/4/2026", "€20 871"], status: "pending" as const },
    { id: "258874342", cells: ["WED-8342", "Wedding Planner Item 3", "7/11/2026", "€24 442"], status: "completed" as const },
    { id: "258877913", cells: ["WED-2913", "Wedding Planner Item 4", "22/6/2026", "€28 013"], status: "warning" as const },
    { id: "258881484", cells: ["WED-6484", "Wedding Planner Item 5", "9/1/2026", "€31 584"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding Planner</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding Planner</p>
                    </div>
                </div>
