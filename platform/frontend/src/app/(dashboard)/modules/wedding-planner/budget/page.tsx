...
const PAGE = "Budget";
const KPIS = [{"l":"Total Wedding Planner","v":"420","t":"+16.9%","d":"up"},{"l":"Budget Ativos","v":"€89722","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"90","t":"+11.2%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Planner #001","€ 23106.67","4.587","3.856","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Planner #002","€ 13826.97","3.244","1.960","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Planner #003","€ 3113.60","1.083","7.034","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Planner #004","€ 11971.07","7.225","2.956","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Planner #005","€ 41105.71","2.571","4.895","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":560},{"label":"Mar","value":625},{"label":"Abr","value":836},{"label":"Mai","value":502},{"label":"Jun","value":611},{"label":"Jul","value":455},{"label":"Ago","value":443},{"label":"Set","value":580},{"label":"Out","value":619},{"label":"Nov","value":441},{"label":"Dez","value":605}];
const MX = 836;
