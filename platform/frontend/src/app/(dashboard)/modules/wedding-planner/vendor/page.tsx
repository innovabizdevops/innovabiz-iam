...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.321","t":"-3.8%","d":"down"},{"l":"Contratos (€M)","v":"€7.8M","t":"+7.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"94.7%","t":"+14.0%","d":"up"},{"l":"Score Médio","v":"92","t":"-2.1%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","80.5%","€ 41495.89","417","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","87.0%","€ 10696.04","1.855","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","78.0%","€ 9300.46","7.505","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","80.1%","€ 18971.01","3.639","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","84.7%","€ 16273.13","790","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":659},{"label":"Mar","value":860},{"label":"Abr","value":955},{"label":"Mai","value":675},{"label":"Jun","value":934},{"label":"Jul","value":873},{"label":"Ago","value":608},{"label":"Set","value":670},{"label":"Out","value":674},{"label":"Nov","value":883},{"label":"Dez","value":616}];
const MX = 955;
