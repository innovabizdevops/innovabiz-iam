...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€16.9M","t":"+9.3%","d":"up"},{"l":"MRR (€)","v":"€8563","t":"+3.1%","d":"up"},{"l":"Churn (%)","v":"71.0%","t":"-3.6%","d":"down"},{"l":"ARPU (€)","v":"€17927","t":"-3.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45261.57","915","€ 16521.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38160.08","6.571","€ 9436.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28581.97","2.906","€ 15377.66","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31716.79","7.639","€ 12921.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 15832.69","4.578","€ 45704.97","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":394},{"label":"Mar","value":517},{"label":"Abr","value":477},{"label":"Mai","value":325},{"label":"Jun","value":679},{"label":"Jul","value":411},{"label":"Ago","value":572},{"label":"Set","value":308},{"label":"Out","value":642},{"label":"Nov","value":327},{"label":"Dez","value":608}];
const MX = 679;
