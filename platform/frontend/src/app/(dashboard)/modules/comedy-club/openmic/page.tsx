...
const PAGE = "Open Mic";
const KPIS = [{"l":"Total Comedy Club","v":"3.568","t":"+6.7%","d":"up"},{"l":"Open Mic Ativos","v":"7.492","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+3.5%","d":"up"}];
const COLS = ["ID","Open Mic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comedy Club #001","Comedy Club #002","1.691","4.421","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Comedy Club #002","Comedy Club #003","1.741","7.140","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Comedy Club #003","Comedy Club #004","1.776","8.039","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Comedy Club #004","Comedy Club #005","7.859","2.680","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comedy Club #005","Comedy Club #001","806","8.064","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":497},{"label":"Mar","value":610},{"label":"Abr","value":588},{"label":"Mai","value":810},{"label":"Jun","value":828},{"label":"Jul","value":842},{"label":"Ago","value":610},{"label":"Set","value":549},{"label":"Out","value":804},{"label":"Nov","value":810},{"label":"Dez","value":658}];
const MX = 842;
