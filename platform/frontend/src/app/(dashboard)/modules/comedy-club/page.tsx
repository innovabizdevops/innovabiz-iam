...
const KPIS = [
    ...
    { label: "Ativos", value: "2577", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€329K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "17194031", cells: ["COM-5031", "Comedy Club Item 1", "16/12/2026", "€44 131"], status: "active" as const },
    { id: "17197602", cells: ["COM-8602", "Comedy Club Item 2", "3/7/2026", "€47 702"], status: "pending" as const },
    { id: "17201173", cells: ["COM-3173", "Comedy Club Item 3", "18/2/2026", "€1273"], status: "completed" as const },
    { id: "17204744", cells: ["COM-6744", "Comedy Club Item 4", "5/9/2026", "€4844"], status: "warning" as const },
    { id: "17208315", cells: ["COM-1315", "Comedy Club Item 5", "20/4/2026", "€8415"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Comedy Club</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Comedy Club</p>
                    </div>
                </div>
