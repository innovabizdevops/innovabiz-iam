...
const ACCENT = "#4c1d95";
const MODULE = "Comedy Club";
const PAGE = "FnB";
const KPIS = [{"l":"Total Comedy Club","v":"3.429","t":"+11.7%","d":"up"},{"l":"FnB Ativos","v":"8.931","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+3.1%","d":"up"}];
const COLS = ["ID","FnB","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comedy Club #001","Comedy Club #002","3.917","8.792","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Comedy Club #002","Comedy Club #003","5.688","1.499","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Comedy Club #003","Comedy Club #004","2.146","1.269","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Comedy Club #004","Comedy Club #005","6.084","3.237","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comedy Club #005","Comedy Club #001","1.169","5.813","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":801},{"label":"Mar","value":458},{"label":"Abr","value":742},{"label":"Mai","value":608},{"label":"Jun","value":718},{"label":"Jul","value":417},{"label":"Ago","value":461},{"label":"Set","value":723},{"label":"Out","value":499},{"label":"Nov","value":410},{"label":"Dez","value":630}];
const MX = 801;
