...
const PAGE = "Book";
const KPIS = [{"l":"Total Comedy Club","v":"1.246","t":"+3.7%","d":"up"},{"l":"Book Ativos","v":"489","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"94","t":"-1.9%","d":"down"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comedy Club #001","Comedy Club #002","3.139","700","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Comedy Club #002","Comedy Club #003","7.503","8.052","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Comedy Club #003","Comedy Club #004","5.116","3.957","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Comedy Club #004","Comedy Club #005","636","3.103","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comedy Club #005","Comedy Club #001","5.605","4.914","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":617},{"label":"Mar","value":660},{"label":"Abr","value":555},{"label":"Mai","value":583},{"label":"Jun","value":670},{"label":"Jul","value":694},{"label":"Ago","value":404},{"label":"Set","value":569},{"label":"Out","value":637},{"label":"Nov","value":525},{"label":"Dez","value":525}];
const MX = 694;
