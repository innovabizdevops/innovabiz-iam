...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"5.161","t":"+2.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.7%","t":"+0.7%","d":"up"},{"l":"MTTR (h)","v":"163h","t":"-1.5%","d":"down"},{"l":"Satisfação (%)","v":"68.8%","t":"-2.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","699","3.958","8.065","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.228","1.390","1.667","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","986","2.442","8.184","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.888","4.728","1.677","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.539","7.348","6.091","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":662},{"label":"Mar","value":487},{"label":"Abr","value":514},{"label":"Mai","value":684},{"label":"Jun","value":379},{"label":"Jul","value":373},{"label":"Ago","value":380},{"label":"Set","value":453},{"label":"Out","value":483},{"label":"Nov","value":426},{"label":"Dez","value":501}];
const MX = 684;
