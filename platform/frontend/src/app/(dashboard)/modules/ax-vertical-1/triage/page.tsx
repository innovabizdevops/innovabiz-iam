...
const PAGE = "Triage";
const KPIS = [{"l":"Total Ax Vertical 1","v":"3.496","t":"+3.9%","d":"up"},{"l":"Triage Ativos","v":"1.311","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"59","t":"-3.3%","d":"down"}];
const COLS = ["ID","Triage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 1 #001","Ax Vertical 1 #002","4.482","3.659","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 1 #002","Ax Vertical 1 #003","1.557","6.714","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 1 #003","Ax Vertical 1 #004","416","3.580","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 1 #004","Ax Vertical 1 #005","9.090","6.305","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 1 #005","Ax Vertical 1 #001","4.384","4.643","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":679},{"label":"Mar","value":315},{"label":"Abr","value":294},{"label":"Mai","value":316},{"label":"Jun","value":296},{"label":"Jul","value":425},{"label":"Ago","value":528},{"label":"Set","value":506},{"label":"Out","value":587},{"label":"Nov","value":375},{"label":"Dez","value":657}];
const MX = 679;
