...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"476","t":"-0.4%","d":"down"},{"l":"Patentes (YTD)","v":"4.115","t":"+10.2%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.338","t":"+10.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€46.0M","t":"+9.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.476","82.7%","6.169","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.102","98.2%","6.144","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.002","92.9%","8.486","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.181","84.3%","7.467","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.326","85.0%","9.062","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":682},{"label":"Mar","value":378},{"label":"Abr","value":755},{"label":"Mai","value":464},{"label":"Jun","value":663},{"label":"Jul","value":404},{"label":"Ago","value":477},{"label":"Set","value":474},{"label":"Out","value":390},{"label":"Nov","value":528},{"label":"Dez","value":404}];
const MX = 755;
