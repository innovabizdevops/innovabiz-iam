...
const ACCENT = "#4f46e5";
const MODULE = "AX Healthcare Agent Hub";
const PAGE = "Diagnosis";
const KPIS = [{"l":"Total Ax Vertical 1","v":"5.494","t":"+10.8%","d":"up"},{"l":"Diagnosis Ativos","v":"6.023","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+17.1%","d":"up"}];
const COLS = ["ID","Diagnosis","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 1 #001","Ax Vertical 1 #002","4.478","241","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 1 #002","Ax Vertical 1 #003","8.453","2.688","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 1 #003","Ax Vertical 1 #004","995","1.317","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 1 #004","Ax Vertical 1 #005","4.678","465","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 1 #005","Ax Vertical 1 #001","2.046","1.478","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":772},{"label":"Mar","value":626},{"label":"Abr","value":651},{"label":"Mai","value":720},{"label":"Jun","value":732},{"label":"Jul","value":899},{"label":"Ago","value":792},{"label":"Set","value":961},{"label":"Out","value":893},{"label":"Nov","value":720},{"label":"Dez","value":974}];
const MX = 974;
