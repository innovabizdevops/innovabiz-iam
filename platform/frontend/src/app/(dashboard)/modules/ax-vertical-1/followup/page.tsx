...
const KPIS = [{"l":"Total Ax Vertical 1","v":"5.756","t":"-3.6%","d":"down"},{"l":"Follow Up Ativos","v":"3.942","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"61","t":"+11.1%","d":"up"}];
const COLS = ["ID","Follow Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 1 #001","Ax Vertical 1 #002","3.978","1.169","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 1 #002","Ax Vertical 1 #003","1.031","3.172","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 1 #003","Ax Vertical 1 #004","3.403","7.601","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 1 #004","Ax Vertical 1 #005","3.276","7.802","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 1 #005","Ax Vertical 1 #001","7.281","2.766","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":771},{"label":"Mar","value":961},{"label":"Abr","value":998},{"label":"Mai","value":683},{"label":"Jun","value":996},{"label":"Jul","value":722},{"label":"Ago","value":724},{"label":"Set","value":813},{"label":"Out","value":788},{"label":"Nov","value":772},{"label":"Dez","value":738}];
const MX = 998;
