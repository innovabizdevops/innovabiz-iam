...
/* ═══ AX Healthcare Agent Hub — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "1165", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4200", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€184K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "570241065", cells: ["AX-2065", "AX Healthcare Agent Hub Item 1", "10/10/2026", "€41 165"], status: "active" as const },
    { id: "570244636", cells: ["AX-5636", "AX Healthcare Agent Hub Item 2", "25/5/2026", "€44 736"], status: "pending" as const },
    { id: "570248207", cells: ["AX-9207", "AX Healthcare Agent Hub Item 3", "12/12/2026", "€48 307"], status: "completed" as const },
    { id: "570251778", cells: ["AX-3778", "AX Healthcare Agent Hub Item 4", "27/7/2026", "€1878"], status: "warning" as const },
    { id: "570255349", cells: ["AX-7349", "AX Healthcare Agent Hub Item 5", "14/2/2026", "€5449"], status: "active" as const },
];
...
export default function AxHealthcareAgentHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AX Healthcare Agent Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AX Healthcare Agent Hub</p>
                    </div>
                </div>
