...
const KPIS = [{"l":"Total Ax Vertical 1","v":"8.023","t":"+8.5%","d":"up"},{"l":"Treatment Ativos","v":"4.996","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"80","t":"+4.8%","d":"up"}];
const COLS = ["ID","Treatment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ax Vertical 1 #001","Ax Vertical 1 #002","1.952","2.879","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Ax Vertical 1 #002","Ax Vertical 1 #003","5.826","6.335","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Ax Vertical 1 #003","Ax Vertical 1 #004","7.806","6.125","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ax Vertical 1 #004","Ax Vertical 1 #005","5.160","8.869","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ax Vertical 1 #005","Ax Vertical 1 #001","4.855","2.115","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":596},{"label":"Mar","value":613},{"label":"Abr","value":621},{"label":"Mai","value":617},{"label":"Jun","value":418},{"label":"Jul","value":717},{"label":"Ago","value":644},{"label":"Set","value":503},{"label":"Out","value":519},{"label":"Nov","value":669},{"label":"Dez","value":502}];
const MX = 717;
