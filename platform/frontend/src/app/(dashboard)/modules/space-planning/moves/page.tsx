...
const PAGE = "Move Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"7.616","t":"+17.7%","d":"up"},{"l":"RevPAR (€)","v":"€19503","t":"-3.8%","d":"down"},{"l":"Ocupação (%)","v":"69.3%","t":"+11.4%","d":"up"},{"l":"Guest Satisfaction","v":"6.499","t":"-0.6%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.093","2026-03-05","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.832","2026-03-17","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.711","2026-01-08","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.782","2026-03-24","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","135","2026-03-24","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":433},{"label":"Mar","value":654},{"label":"Abr","value":622},{"label":"Mai","value":631},{"label":"Jun","value":532},{"label":"Jul","value":455},{"label":"Ago","value":647},{"label":"Set","value":623},{"label":"Out","value":549},{"label":"Nov","value":557},{"label":"Dez","value":778}];
const MX = 778;
