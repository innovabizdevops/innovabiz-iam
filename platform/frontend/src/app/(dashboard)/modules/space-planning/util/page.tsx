...
const ACCENT = "#7c3aed";
const MODULE = "Space Planning";
const PAGE = "Utilization";
const KPIS = [{"l":"Quartos Ocupados","v":"2.744","t":"+7.2%","d":"up"},{"l":"RevPAR (€)","v":"€47636","t":"+12.8%","d":"up"},{"l":"Ocupação (%)","v":"76.7%","t":"+12.9%","d":"up"},{"l":"Guest Satisfaction","v":"8.479","t":"-2.8%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.145","2026-01-23","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.852","2026-03-16","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.330","2026-01-08","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.056","2026-02-17","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.405","2026-03-11","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":759},{"label":"Mar","value":911},{"label":"Abr","value":767},{"label":"Mai","value":809},{"label":"Jun","value":916},{"label":"Jul","value":681},{"label":"Ago","value":868},{"label":"Set","value":740},{"label":"Out","value":881},{"label":"Nov","value":727},{"label":"Dez","value":758}];
const MX = 958;
