...
const PAGE = "Hot Desk";
const KPIS = [{"l":"Quartos Ocupados","v":"1.711","t":"+15.9%","d":"up"},{"l":"RevPAR (€)","v":"€62698","t":"-3.6%","d":"down"},{"l":"Ocupação (%)","v":"86.6%","t":"+11.3%","d":"up"},{"l":"Guest Satisfaction","v":"385","t":"+15.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.371","2026-03-23","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.122","2026-02-19","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.625","2026-02-12","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.139","2026-02-23","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.056","2026-03-27","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":700},{"label":"Mar","value":1008},{"label":"Abr","value":967},{"label":"Mai","value":985},{"label":"Jun","value":769},{"label":"Jul","value":710},{"label":"Ago","value":862},{"label":"Set","value":1009},{"label":"Out","value":774},{"label":"Nov","value":856},{"label":"Dez","value":802}];
const MX = 1009;
