...
const PAGE = "Stack Plan";
const KPIS = [{"l":"Quartos Ocupados","v":"7.547","t":"+2.7%","d":"up"},{"l":"RevPAR (€)","v":"€4914","t":"+11.4%","d":"up"},{"l":"Ocupação (%)","v":"85.7%","t":"+17.3%","d":"up"},{"l":"Guest Satisfaction","v":"7.177","t":"+5.8%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.612","2026-03-24","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.510","2026-02-03","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.214","2026-01-26","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.018","2026-02-15","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.492","2026-01-13","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":822},{"label":"Mar","value":460},{"label":"Abr","value":831},{"label":"Mai","value":733},{"label":"Jun","value":752},{"label":"Jul","value":637},{"label":"Ago","value":710},{"label":"Set","value":754},{"label":"Out","value":513},{"label":"Nov","value":768},{"label":"Dez","value":681}];
const MX = 831;
