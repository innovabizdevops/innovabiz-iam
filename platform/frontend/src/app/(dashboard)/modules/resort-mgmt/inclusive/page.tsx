...
const ACCENT = "#6366f1";
const MODULE = "Resort Management";
const PAGE = "All-Inclusive";
const KPIS = [{"l":"Quartos Ocupados","v":"2.968","t":"-1.7%","d":"down"},{"l":"RevPAR (€)","v":"€6723","t":"+17.3%","d":"up"},{"l":"Ocupação (%)","v":"70.6%","t":"-5.9%","d":"down"},{"l":"Guest Satisfaction","v":"3.258","t":"+7.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.231","2026-01-27","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.935","2026-01-21","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.122","2026-02-02","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.508","2026-01-11","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","559","2026-03-02","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":859},{"label":"Mar","value":691},{"label":"Abr","value":634},{"label":"Mai","value":914},{"label":"Jun","value":923},{"label":"Jul","value":675},{"label":"Ago","value":626},{"label":"Set","value":710},{"label":"Out","value":886},{"label":"Nov","value":840},{"label":"Dez","value":722}];
const MX = 943;
