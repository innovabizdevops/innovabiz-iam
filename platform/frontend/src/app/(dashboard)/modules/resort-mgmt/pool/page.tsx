...
const PAGE = "Pool";
const KPIS = [{"l":"Quartos Ocupados","v":"3.615","t":"+5.6%","d":"up"},{"l":"RevPAR (€)","v":"€96908","t":"+1.7%","d":"up"},{"l":"Ocupação (%)","v":"70.8%","t":"-3.8%","d":"down"},{"l":"Guest Satisfaction","v":"626","t":"+15.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.054","2026-02-10","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.559","2026-02-15","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.289","2026-01-09","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.989","2026-01-25","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.456","2026-01-15","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":798},{"label":"Mar","value":976},{"label":"Abr","value":717},{"label":"Mai","value":789},{"label":"Jun","value":1009},{"label":"Jul","value":793},{"label":"Ago","value":816},{"label":"Set","value":772},{"label":"Out","value":977},{"label":"Nov","value":663},{"label":"Dez","value":929}];
const MX = 1009;
