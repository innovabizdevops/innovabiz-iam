...
const ACCENT = "#312e81";
const MODULE = "Shared Lab Space";
const PAGE = "Safety";
const KPIS = [{"l":"Total Shared Lab","v":"921","t":"-3.1%","d":"down"},{"l":"Safety Ativos","v":"7.153","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"78.7%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"70","t":"+14.3%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Lab #001","Shared Lab #002","7.188","6.171","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Lab #002","Shared Lab #003","3.497","8.457","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Lab #003","Shared Lab #004","5.338","3.218","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Lab #004","Shared Lab #005","1.766","3.925","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Lab #005","Shared Lab #001","8.374","6.422","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":381},{"label":"Mar","value":432},{"label":"Abr","value":657},{"label":"Mai","value":409},{"label":"Jun","value":560},{"label":"Jul","value":607},{"label":"Ago","value":582},{"label":"Set","value":366},{"label":"Out","value":612},{"label":"Nov","value":420},{"label":"Dez","value":411}];
const MX = 688;
