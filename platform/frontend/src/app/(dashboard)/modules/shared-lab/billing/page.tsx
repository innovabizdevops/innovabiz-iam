...
const PAGE = "Billing";
const KPIS = [{"l":"Total Shared Lab","v":"1.416","t":"+8.4%","d":"up"},{"l":"Billing Ativos","v":"399","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"78","t":"+13.5%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Shared Lab #001","Shared Lab #002","2.367","2.936","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Shared Lab #002","Shared Lab #003","4.592","7.795","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Shared Lab #003","Shared Lab #004","3.975","628","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Shared Lab #004","Shared Lab #005","3.481","6.128","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Shared Lab #005","Shared Lab #001","1.822","9.087","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":778},{"label":"Mar","value":531},{"label":"Abr","value":669},{"label":"Mai","value":547},{"label":"Jun","value":734},{"label":"Jul","value":561},{"label":"Ago","value":627},{"label":"Set","value":591},{"label":"Out","value":772},{"label":"Nov","value":699},{"label":"Dez","value":499}];
const MX = 778;
