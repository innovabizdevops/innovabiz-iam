...
/* ═══ Shared Lab Space — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "6572", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2055", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€40K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2128753972", cells: ["SHA-2972", "Shared Lab Space Item 1", "17/5/2026", "€4072"], status: "active" as const },
    { id: "2128757543", cells: ["SHA-6543", "Shared Lab Space Item 2", "4/12/2026", "€7643"], status: "pending" as const },
    { id: "2128761114", cells: ["SHA-1114", "Shared Lab Space Item 3", "19/7/2026", "€11 214"], status: "completed" as const },
    { id: "2128764685", cells: ["SHA-4685", "Shared Lab Space Item 4", "6/2/2026", "€14 785"], status: "warning" as const },
    { id: "2128768256", cells: ["SHA-8256", "Shared Lab Space Item 5", "21/9/2026", "€18 356"], status: "active" as const },
];
...
export default function SharedLabSpacePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shared Lab Space</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Shared Lab Space</p>
                    </div>
                </div>
