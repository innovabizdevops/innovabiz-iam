...
const KPIS = [{"l":"Total Ev Charging","v":"1.238","t":"-3.8%","d":"down"},{"l":"Load Balance Ativos","v":"3.060","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"90","t":"+16.4%","d":"up"}];
const COLS = ["ID","Load Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging #001","Ev Charging #002","7.305","8.881","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging #002","Ev Charging #003","5.820","4.831","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging #003","Ev Charging #004","882","7.708","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging #004","Ev Charging #005","8.739","5.742","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging #005","Ev Charging #001","3.962","5.789","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":742},{"label":"Mar","value":684},{"label":"Abr","value":746},{"label":"Mai","value":425},{"label":"Jun","value":658},{"label":"Jul","value":520},{"label":"Ago","value":520},{"label":"Set","value":666},{"label":"Out","value":671},{"label":"Nov","value":635},{"label":"Dez","value":412}];
const MX = 778;
