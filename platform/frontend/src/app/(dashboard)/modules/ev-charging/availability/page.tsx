...
const ACCENT = "#059669";
const MODULE = "EV Charging Network";
const PAGE = "Availability";
const KPIS = [{"l":"Total Ev Charging","v":"4.032","t":"-1.2%","d":"down"},{"l":"Availability Ativos","v":"3.295","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"66","t":"-0.1%","d":"down"}];
const COLS = ["ID","Availability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging #001","Ev Charging #002","9.026","6.154","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging #002","Ev Charging #003","7.192","4.923","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging #003","Ev Charging #004","3.358","1.245","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging #004","Ev Charging #005","7.616","3.119","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging #005","Ev Charging #001","1.104","4.102","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":502},{"label":"Mar","value":722},{"label":"Abr","value":733},{"label":"Mai","value":626},{"label":"Jun","value":642},{"label":"Jul","value":718},{"label":"Ago","value":473},{"label":"Set","value":404},{"label":"Out","value":803},{"label":"Nov","value":625},{"label":"Dez","value":603}];
const MX = 803;
