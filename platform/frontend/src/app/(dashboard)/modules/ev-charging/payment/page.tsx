...
const PAGE = "Payment";
const KPIS = [{"l":"Total Ev Charging","v":"7.965","t":"+9.9%","d":"up"},{"l":"Payment Ativos","v":"7.271","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"80","t":"+16.5%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging #001","Ev Charging #002","1.648","6.905","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging #002","Ev Charging #003","4.292","8.794","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging #003","Ev Charging #004","5.080","6.806","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging #004","Ev Charging #005","1.798","3.242","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging #005","Ev Charging #001","2.307","5.101","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":747},{"label":"Mar","value":826},{"label":"Abr","value":768},{"label":"Mai","value":668},{"label":"Jun","value":825},{"label":"Jul","value":995},{"label":"Ago","value":829},{"label":"Set","value":962},{"label":"Out","value":773},{"label":"Nov","value":870},{"label":"Dez","value":923}];
const MX = 995;
