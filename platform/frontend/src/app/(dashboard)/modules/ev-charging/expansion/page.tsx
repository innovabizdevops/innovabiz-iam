...
const KPIS = [{"l":"Total Ev Charging","v":"2.025","t":"-4.9%","d":"down"},{"l":"Expansion Plan Ativos","v":"7.135","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"95","t":"+17.5%","d":"up"}];
const COLS = ["ID","Expansion Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging #001","Ev Charging #002","5.294","6.999","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging #002","Ev Charging #003","2.556","6.523","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging #003","Ev Charging #004","1.782","5.233","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging #004","Ev Charging #005","7.325","6.713","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging #005","Ev Charging #001","3.522","6.484","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":1015},{"label":"Mar","value":705},{"label":"Abr","value":835},{"label":"Mai","value":712},{"label":"Jun","value":707},{"label":"Jul","value":886},{"label":"Ago","value":690},{"label":"Set","value":903},{"label":"Out","value":1024},{"label":"Nov","value":948},{"label":"Dez","value":823}];
const MX = 1024;
