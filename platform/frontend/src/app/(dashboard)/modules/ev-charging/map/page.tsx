...
const PAGE = "Station Map";
const KPIS = [{"l":"Total Ev Charging","v":"8.750","t":"+2.8%","d":"up"},{"l":"Station Map Ativos","v":"6.151","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"81.3%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"83","t":"+3.7%","d":"up"}];
const COLS = ["ID","Station Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ev Charging #001","Ev Charging #002","2.364","8.071","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Ev Charging #002","Ev Charging #003","7.864","4.430","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ev Charging #003","Ev Charging #004","308","5.120","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Ev Charging #004","Ev Charging #005","2.959","639","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ev Charging #005","Ev Charging #001","8.381","381","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":853},{"label":"Mar","value":694},{"label":"Abr","value":829},{"label":"Mai","value":735},{"label":"Jun","value":719},{"label":"Jul","value":748},{"label":"Ago","value":611},{"label":"Set","value":605},{"label":"Out","value":769},{"label":"Nov","value":572},{"label":"Dez","value":861}];
const MX = 861;
