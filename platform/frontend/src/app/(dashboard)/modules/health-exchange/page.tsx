...
export default function HealthExchangePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Health Exchange</h1><p className="text-sm text-muted-foreground">Health Exchange • iBOS Enterprise</p></div>
