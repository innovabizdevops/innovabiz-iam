...
const ACCENT = "#6366f1";
const MODULE = "Health Info Exchange";
const PAGE = "FHIR";
const KPIS = [{"l":"Total Health Exchange","v":"3.398","t":"+11.2%","d":"up"},{"l":"FHIR Ativos","v":"2.624","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"83.2%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+8.0%","d":"up"}];
const COLS = ["ID","FHIR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Exchange #001","Health Exchange #002","2.156","7.513","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Health Exchange #002","Health Exchange #003","4.222","7.087","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Exchange #003","Health Exchange #004","8.236","4.737","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Health Exchange #004","Health Exchange #005","3.874","2.396","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Exchange #005","Health Exchange #001","8.028","2.439","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":543},{"label":"Mar","value":575},{"label":"Abr","value":630},{"label":"Mai","value":624},{"label":"Jun","value":295},{"label":"Jul","value":465},{"label":"Ago","value":453},{"label":"Set","value":616},{"label":"Out","value":289},{"label":"Nov","value":479},{"label":"Dez","value":414}];
const MX = 630;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>FHIR</span></h1>
                </div>
