...
const PAGE = "Query";
const KPIS = [{"l":"Total Health Exchange","v":"8.426","t":"+3.7%","d":"up"},{"l":"Query Ativos","v":"334","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"92","t":"-2.4%","d":"down"}];
const COLS = ["ID","Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Exchange #001","Health Exchange #002","5.680","4.749","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Health Exchange #002","Health Exchange #003","5.406","8.383","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Exchange #003","Health Exchange #004","5.329","783","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Health Exchange #004","Health Exchange #005","4.893","8.558","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Exchange #005","Health Exchange #001","521","4.578","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":781},{"label":"Mar","value":959},{"label":"Abr","value":752},{"label":"Mai","value":891},{"label":"Jun","value":680},{"label":"Jul","value":694},{"label":"Ago","value":562},{"label":"Set","value":752},{"label":"Out","value":567},{"label":"Nov","value":577},{"label":"Dez","value":948}];
const MX = 959;
