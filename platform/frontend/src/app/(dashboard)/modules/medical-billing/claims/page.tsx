...
const PAGE = "Claims Submit";
const KPIS = [{"l":"Integrações Ativas","v":"7.252","t":"+3.7%","d":"up"},{"l":"Chamadas/Hora","v":"4755","t":"+3.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.3%","t":"+17.5%","d":"up"},{"l":"Latência Média (ms)","v":"164ms","t":"+10.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.961","2.243","96.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.675","8.518","84.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.487","891","71.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.486","2.526","98.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.113","8.781","95.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":685},{"label":"Mar","value":659},{"label":"Abr","value":502},{"label":"Mai","value":472},{"label":"Jun","value":486},{"label":"Jul","value":564},{"label":"Ago","value":688},{"label":"Set","value":408},{"label":"Out","value":630},{"label":"Nov","value":394},{"label":"Dez","value":388}];
const MX = 688;
