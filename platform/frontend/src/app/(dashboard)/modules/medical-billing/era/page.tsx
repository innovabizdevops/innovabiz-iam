...
const PAGE = "ERA Process";
const KPIS = [{"l":"Integrações Ativas","v":"8.186","t":"-1.5%","d":"down"},{"l":"Chamadas/Hora","v":"1863","t":"+8.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.5%","t":"+16.9%","d":"up"},{"l":"Latência Média (ms)","v":"126ms","t":"+2.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.124","4.882","93.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.761","6.652","90.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.097","6.502","87.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","557","4.633","97.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.852","6.106","75.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":412},{"label":"Mar","value":613},{"label":"Abr","value":464},{"label":"Mai","value":310},{"label":"Jun","value":584},{"label":"Jul","value":551},{"label":"Ago","value":405},{"label":"Set","value":615},{"label":"Out","value":328},{"label":"Nov","value":252},{"label":"Dez","value":444}];
const MX = 615;
