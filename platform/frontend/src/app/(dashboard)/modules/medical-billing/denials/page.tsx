...
const ACCENT = "#475569";
const MODULE = "Medical Billing";
const PAGE = "Denial Mgmt";
const KPIS = [{"l":"Integrações Ativas","v":"4.745","t":"+16.5%","d":"up"},{"l":"Chamadas/Hora","v":"859","t":"+2.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.3%","t":"-4.8%","d":"down"},{"l":"Latência Média (ms)","v":"139ms","t":"+13.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.107","6.025","79.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.582","1.554","88.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.769","6.533","92.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.303","175","83.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.030","8.725","92.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":707},{"label":"Mar","value":854},{"label":"Abr","value":664},{"label":"Mai","value":583},{"label":"Jun","value":706},{"label":"Jul","value":689},{"label":"Ago","value":832},{"label":"Set","value":802},{"label":"Out","value":713},{"label":"Nov","value":930},{"label":"Dez","value":545}];
const MX = 930;
