...
const PAGE = "Patient Balance";
const KPIS = [{"l":"Integrações Ativas","v":"566","t":"+4.9%","d":"up"},{"l":"Chamadas/Hora","v":"1639","t":"-2.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"71.6%","t":"+16.3%","d":"up"},{"l":"Latência Média (ms)","v":"189ms","t":"+5.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.745","2.288","74.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.221","544","81.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.266","4.182","80.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.917","6.477","99.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.619","3.539","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":870},{"label":"Fev","value":709},{"label":"Mar","value":769},{"label":"Abr","value":982},{"label":"Mai","value":847},{"label":"Jun","value":981},{"label":"Jul","value":785},{"label":"Ago","value":881},{"label":"Set","value":851},{"label":"Out","value":720},{"label":"Nov","value":797},{"label":"Dez","value":916}];
const MX = 982;
