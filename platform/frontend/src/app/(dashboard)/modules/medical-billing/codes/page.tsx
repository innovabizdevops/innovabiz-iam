...
const PAGE = "Code Lookup";
const KPIS = [{"l":"Integrações Ativas","v":"3.433","t":"+11.4%","d":"up"},{"l":"Chamadas/Hora","v":"980","t":"-0.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.9%","t":"+11.8%","d":"up"},{"l":"Latência Média (ms)","v":"44ms","t":"+7.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.072","8.489","92.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.333","3.062","97.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.164","6.468","74.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.279","6.566","82.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.317","6.885","95.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":719},{"label":"Mar","value":720},{"label":"Abr","value":949},{"label":"Mai","value":687},{"label":"Jun","value":772},{"label":"Jul","value":874},{"label":"Ago","value":740},{"label":"Set","value":667},{"label":"Out","value":816},{"label":"Nov","value":925},{"label":"Dez","value":831}];
const MX = 966;
