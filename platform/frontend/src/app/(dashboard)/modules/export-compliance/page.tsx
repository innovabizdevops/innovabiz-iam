...
/* ═══ Export Compliance Deep — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "9755", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2096", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€315K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2127668155", cells: ["EXP-6155", "Export Compliance Deep Item 1", "12/8/2026", "€18 255"], status: "active" as const },
    { id: "2127671726", cells: ["EXP-9726", "Export Compliance Deep Item 2", "27/3/2026", "€21 826"], status: "pending" as const },
    { id: "2127675297", cells: ["EXP-4297", "Export Compliance Deep Item 3", "14/10/2026", "€25 397"], status: "completed" as const },
    { id: "2127678868", cells: ["EXP-7868", "Export Compliance Deep Item 4", "1/5/2026", "€28 968"], status: "warning" as const },
    { id: "2127682439", cells: ["EXP-2439", "Export Compliance Deep Item 5", "16/12/2026", "€32 539"], status: "active" as const },
];
...
export default function ExportComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Export Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Export Compliance Deep</p>
                    </div>
                </div>
