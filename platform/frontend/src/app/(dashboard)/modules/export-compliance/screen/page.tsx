...
const ACCENT = "#dc2626";
const MODULE = "Export Compliance Deep";
const PAGE = "Screen";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.636","t":"+10.4%","d":"up"},{"l":"NC Abertas","v":"3.583","t":"-3.3%","d":"down"},{"l":"Conformidade (%)","v":"72.6%","t":"+15.7%","d":"up"},{"l":"CAPAs Pendentes","v":"1.648","t":"+17.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.314","97.6%","7.192","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.157","82.1%","8.622","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.697","84.0%","6.059","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.958","75.4%","3.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.721","70.5%","7.165","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":887},{"label":"Mar","value":871},{"label":"Abr","value":830},{"label":"Mai","value":708},{"label":"Jun","value":895},{"label":"Jul","value":632},{"label":"Ago","value":572},{"label":"Set","value":897},{"label":"Out","value":604},{"label":"Nov","value":610},{"label":"Dez","value":847}];
const MX = 897;
