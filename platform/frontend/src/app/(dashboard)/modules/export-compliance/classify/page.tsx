...
const PAGE = "Classify";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.330","t":"+2.4%","d":"up"},{"l":"NC Abertas","v":"5.809","t":"-2.7%","d":"down"},{"l":"Conformidade (%)","v":"81.8%","t":"+7.4%","d":"up"},{"l":"CAPAs Pendentes","v":"8.709","t":"+4.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.428","78.9%","4.270","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.570","76.7%","3.430","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.532","76.5%","5.313","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.674","92.9%","2.314","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.277","95.7%","114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":861},{"label":"Mar","value":919},{"label":"Abr","value":874},{"label":"Mai","value":939},{"label":"Jun","value":589},{"label":"Jul","value":667},{"label":"Ago","value":580},{"label":"Set","value":832},{"label":"Out","value":870},{"label":"Nov","value":803},{"label":"Dez","value":690}];
const MX = 939;
