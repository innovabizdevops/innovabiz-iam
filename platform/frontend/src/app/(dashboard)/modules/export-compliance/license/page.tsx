...
const PAGE = "License";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.014","t":"+3.9%","d":"up"},{"l":"NC Abertas","v":"3.384","t":"+14.7%","d":"up"},{"l":"Conformidade (%)","v":"65.7%","t":"+17.8%","d":"up"},{"l":"CAPAs Pendentes","v":"5.976","t":"+5.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.301","91.6%","1.682","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.853","96.2%","265","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.387","98.8%","1.901","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.944","75.0%","1.513","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.980","97.9%","1.155","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":590},{"label":"Mar","value":574},{"label":"Abr","value":637},{"label":"Mai","value":620},{"label":"Jun","value":302},{"label":"Jul","value":315},{"label":"Ago","value":520},{"label":"Set","value":436},{"label":"Out","value":549},{"label":"Nov","value":584},{"label":"Dez","value":443}];
const MX = 637;
