...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.515","t":"+16.3%","d":"up"},{"l":"NC Abertas","v":"2.479","t":"+6.9%","d":"up"},{"l":"Conformidade (%)","v":"74.6%","t":"-4.6%","d":"down"},{"l":"CAPAs Pendentes","v":"5.782","t":"+4.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.359","93.4%","2.133","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.165","75.9%","4.026","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.456","92.5%","1.552","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.516","91.2%","6.294","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.267","99.6%","291","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":464},{"label":"Mar","value":560},{"label":"Abr","value":555},{"label":"Mai","value":249},{"label":"Jun","value":454},{"label":"Jul","value":588},{"label":"Ago","value":499},{"label":"Set","value":569},{"label":"Out","value":537},{"label":"Nov","value":361},{"label":"Dez","value":567}];
const MX = 588;
