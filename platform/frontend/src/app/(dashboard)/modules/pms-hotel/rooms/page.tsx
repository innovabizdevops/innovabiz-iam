...
const PAGE = "Room Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"7.134","t":"+9.8%","d":"up"},{"l":"RevPAR (€)","v":"€24763","t":"+14.5%","d":"up"},{"l":"Ocupação (%)","v":"67.2%","t":"+17.5%","d":"up"},{"l":"Guest Satisfaction","v":"1.905","t":"+6.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.117","2026-03-18","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.234","2026-03-11","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.907","2026-01-25","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.188","2026-01-19","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.038","2026-01-12","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":670},{"label":"Mar","value":641},{"label":"Abr","value":728},{"label":"Mai","value":763},{"label":"Jun","value":585},{"label":"Jul","value":810},{"label":"Ago","value":686},{"label":"Set","value":504},{"label":"Out","value":652},{"label":"Nov","value":542},{"label":"Dez","value":432}];
const MX = 810;
