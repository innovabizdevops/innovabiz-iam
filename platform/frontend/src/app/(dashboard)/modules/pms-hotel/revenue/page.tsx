...
const PAGE = "Revenue Strategy";
const KPIS = [{"l":"ARR (€M)","v":"€21.4M","t":"+0.4%","d":"up"},{"l":"MRR (€)","v":"€55987","t":"+2.6%","d":"up"},{"l":"Churn (%)","v":"66.5%","t":"+8.9%","d":"up"},{"l":"ARPU (€)","v":"€20903","t":"-1.4%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42115.38","8.709","€ 35470.62","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 20445.60","6.875","€ 13469.44","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9537.20","4.080","€ 9396.87","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13412.48","4.798","€ 34833.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29322.60","1.677","€ 15026.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":493},{"label":"Mar","value":505},{"label":"Abr","value":545},{"label":"Mai","value":464},{"label":"Jun","value":555},{"label":"Jul","value":471},{"label":"Ago","value":539},{"label":"Set","value":774},{"label":"Out","value":764},{"label":"Nov","value":517},{"label":"Dez","value":506}];
const MX = 774;
