...
const KPIS = [{"l":"Quartos Ocupados","v":"5.903","t":"+15.5%","d":"up"},{"l":"RevPAR (€)","v":"€74950","t":"+8.6%","d":"up"},{"l":"Ocupação (%)","v":"77.4%","t":"-5.4%","d":"down"},{"l":"Guest Satisfaction","v":"8.668","t":"+2.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.246","2026-03-05","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.245","2026-02-07","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.650","2026-01-16","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.401","2026-02-22","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.168","2026-01-15","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":844},{"label":"Mar","value":896},{"label":"Abr","value":717},{"label":"Mai","value":934},{"label":"Jun","value":835},{"label":"Jul","value":624},{"label":"Ago","value":721},{"label":"Set","value":686},{"label":"Out","value":935},{"label":"Nov","value":703},{"label":"Dez","value":762}];
const MX = 935;
