...
const ACCENT = "#1e40af";
const MODULE = "PMS Hotel";
const PAGE = "Guest AI";
const KPIS = [{"l":"Quartos Ocupados","v":"4.945","t":"+9.2%","d":"up"},{"l":"RevPAR (€)","v":"€69014","t":"+14.4%","d":"up"},{"l":"Ocupação (%)","v":"80.6%","t":"+4.3%","d":"up"},{"l":"Guest Satisfaction","v":"7.449","t":"+4.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.622","2026-01-02","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.418","2026-03-10","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","425","2026-01-27","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.541","2026-01-06","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","524","2026-01-07","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":551},{"label":"Mar","value":469},{"label":"Abr","value":555},{"label":"Mai","value":548},{"label":"Jun","value":628},{"label":"Jul","value":380},{"label":"Ago","value":480},{"label":"Set","value":501},{"label":"Out","value":611},{"label":"Nov","value":445},{"label":"Dez","value":500}];
const MX = 638;
