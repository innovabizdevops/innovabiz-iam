...
const KPIS = [{"l":"Total Edtech Ai","v":"3.355","t":"+13.4%","d":"up"},{"l":"Assessment Ativos","v":"4.386","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"89.1%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"73","t":"-3.0%","d":"down"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edtech Ai #001","Edtech Ai #002","3.818","444","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Edtech Ai #002","Edtech Ai #003","3.267","583","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Edtech Ai #003","Edtech Ai #004","7.026","2.263","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Edtech Ai #004","Edtech Ai #005","107","5.575","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edtech Ai #005","Edtech Ai #001","4.258","9.057","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":374},{"label":"Mar","value":393},{"label":"Abr","value":527},{"label":"Mai","value":362},{"label":"Jun","value":536},{"label":"Jul","value":516},{"label":"Ago","value":413},{"label":"Set","value":410},{"label":"Out","value":544},{"label":"Nov","value":445},{"label":"Dez","value":292}];
const MX = 544;
