...
const KPIS = [{"l":"Dashboards Ativos","v":"1.507","t":"+13.6%","d":"up"},{"l":"Queries/Dia","v":"793","t":"+5.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.377","t":"-2.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.473","t":"+9.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2666","2026-03-16","7.241","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1649","2026-03-02","1.511","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4043","2026-03-27","6.401","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","247","2026-03-06","5.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2384","2026-03-21","2.956","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":505},{"label":"Mar","value":753},{"label":"Abr","value":594},{"label":"Mai","value":526},{"label":"Jun","value":467},{"label":"Jul","value":487},{"label":"Ago","value":664},{"label":"Set","value":400},{"label":"Out","value":642},{"label":"Nov","value":425},{"label":"Dez","value":458}];
const MX = 753;
