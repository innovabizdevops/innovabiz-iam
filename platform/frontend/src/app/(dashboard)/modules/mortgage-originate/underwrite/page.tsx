...
const ACCENT = "#6366f1";
const MODULE = "Mortgage Origination";
const PAGE = "Underwrite";
const KPIS = [{"l":"Total Mortgage Originate","v":"2.157","t":"+7.4%","d":"up"},{"l":"Underwrite Ativos","v":"5.847","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"65.9%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"85","t":"+5.9%","d":"up"}];
const COLS = ["ID","Underwrite","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mortgage Originate #001","Mortgage Originate #002","4.172","952","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Mortgage Originate #002","Mortgage Originate #003","4.241","4.809","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Mortgage Originate #003","Mortgage Originate #004","7.781","6.420","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mortgage Originate #004","Mortgage Originate #005","1.257","4.505","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mortgage Originate #005","Mortgage Originate #001","233","2.157","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":435},{"label":"Mar","value":458},{"label":"Abr","value":424},{"label":"Mai","value":389},{"label":"Jun","value":651},{"label":"Jul","value":465},{"label":"Ago","value":575},{"label":"Set","value":460},{"label":"Out","value":490},{"label":"Nov","value":359},{"label":"Dez","value":405}];
const MX = 674;
