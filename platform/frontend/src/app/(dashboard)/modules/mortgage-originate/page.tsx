...
export default function MortgageOriginatePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mortgage Originate</h1><p className="text-sm text-muted-foreground">Mortgage Originate • iBOS Enterprise</p></div>
