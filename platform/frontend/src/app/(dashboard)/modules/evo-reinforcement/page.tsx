...
/* ═══ EVO Reinforcement Learning — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "4483", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2914", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€452K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "532802583", cells: ["EVO-3583", "EVO Reinforcement Learning Item 1", "20/4/2026", "€2683"], status: "active" as const },
    { id: "532806154", cells: ["EVO-7154", "EVO Reinforcement Learning Item 2", "7/11/2026", "€6254"], status: "pending" as const },
    { id: "532809725", cells: ["EVO-1725", "EVO Reinforcement Learning Item 3", "22/6/2026", "€9825"], status: "completed" as const },
    { id: "532813296", cells: ["EVO-5296", "EVO Reinforcement Learning Item 4", "9/1/2026", "€13 396"], status: "warning" as const },
    { id: "532816867", cells: ["EVO-8867", "EVO Reinforcement Learning Item 5", "24/8/2026", "€16 967"], status: "active" as const },
];
...
export default function EvoReinforcementLearningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EVO Reinforcement Learning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EVO Reinforcement Learning</p>
                    </div>
                </div>
