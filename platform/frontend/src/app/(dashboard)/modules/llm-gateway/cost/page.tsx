...
const PAGE = "Cost";
const KPIS = [{"l":"Integrações Ativas","v":"1.012","t":"+17.2%","d":"up"},{"l":"Chamadas/Hora","v":"790","t":"+11.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.2%","t":"+14.9%","d":"up"},{"l":"Latência Média (ms)","v":"182ms","t":"+18.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.302","1.021","87.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.561","8.718","84.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.766","3.335","83.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.898","6.304","77.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.554","4.855","93.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":360},{"label":"Mar","value":312},{"label":"Abr","value":613},{"label":"Mai","value":409},{"label":"Jun","value":337},{"label":"Jul","value":536},{"label":"Ago","value":609},{"label":"Set","value":346},{"label":"Out","value":525},{"label":"Nov","value":516},{"label":"Dez","value":667}];
const MX = 667;
