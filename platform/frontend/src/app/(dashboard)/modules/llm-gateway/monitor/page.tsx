...
const ACCENT = "#7c3aed";
const MODULE = "LLM Gateway & Router";
const PAGE = "Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"5.218","t":"+3.0%","d":"up"},{"l":"Chamadas/Hora","v":"873","t":"+12.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.2%","t":"+13.1%","d":"up"},{"l":"Latência Média (ms)","v":"42ms","t":"+9.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.462","1.472","86.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.106","2.815","77.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.627","2.304","83.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.092","1.550","92.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.787","1.658","87.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":716},{"label":"Mar","value":499},{"label":"Abr","value":613},{"label":"Mai","value":642},{"label":"Jun","value":454},{"label":"Jul","value":658},{"label":"Ago","value":564},{"label":"Set","value":437},{"label":"Out","value":550},{"label":"Nov","value":749},{"label":"Dez","value":703}];
const MX = 806;
