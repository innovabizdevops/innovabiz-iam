...
/* ═══ LLM Gateway & Router — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "8967", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "671", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€309K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1002344267", cells: ["LLM-6267", "LLM Gateway & Router Item 1", "16/12/2026", "€44 367"], status: "active" as const },
    { id: "1002347838", cells: ["LLM-9838", "LLM Gateway & Router Item 2", "3/7/2026", "€47 938"], status: "pending" as const },
    { id: "1002351409", cells: ["LLM-4409", "LLM Gateway & Router Item 3", "18/2/2026", "€1509"], status: "completed" as const },
    { id: "1002354980", cells: ["LLM-7980", "LLM Gateway & Router Item 4", "5/9/2026", "€5080"], status: "warning" as const },
    { id: "1002358551", cells: ["LLM-2551", "LLM Gateway & Router Item 5", "20/4/2026", "€8651"], status: "active" as const },
];
...
export default function LlmGatewayRouterPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">LLM Gateway & Router</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • LLM Gateway & Router</p>
                    </div>
                </div>
