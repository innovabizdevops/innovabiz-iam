...
const PAGE = "Cache";
const KPIS = [{"l":"Integrações Ativas","v":"8.804","t":"+7.8%","d":"up"},{"l":"Chamadas/Hora","v":"3736","t":"+7.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.9%","t":"-0.8%","d":"down"},{"l":"Latência Média (ms)","v":"147ms","t":"+17.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","698","7.662","91.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","744","6.217","82.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.716","2.588","85.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.548","4.258","91.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.003","2.978","98.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":380},{"label":"Mar","value":704},{"label":"Abr","value":669},{"label":"Mai","value":360},{"label":"Jun","value":444},{"label":"Jul","value":502},{"label":"Ago","value":595},{"label":"Set","value":737},{"label":"Out","value":721},{"label":"Nov","value":417},{"label":"Dez","value":732}];
const MX = 737;
