...
const PAGE = "Fallback";
const KPIS = [{"l":"Integrações Ativas","v":"3.801","t":"+17.0%","d":"up"},{"l":"Chamadas/Hora","v":"360","t":"+9.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"69.8%","t":"-4.8%","d":"down"},{"l":"Latência Média (ms)","v":"68ms","t":"+13.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.877","8.425","87.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.509","5.659","72.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.564","4.474","78.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.217","9.001","78.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.768","3.613","81.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":390},{"label":"Mar","value":637},{"label":"Abr","value":681},{"label":"Mai","value":647},{"label":"Jun","value":593},{"label":"Jul","value":756},{"label":"Ago","value":581},{"label":"Set","value":530},{"label":"Out","value":505},{"label":"Nov","value":630},{"label":"Dez","value":391}];
const MX = 756;
