...
const PAGE = "Route";
const KPIS = [{"l":"Integrações Ativas","v":"6.657","t":"+6.1%","d":"up"},{"l":"Chamadas/Hora","v":"2583","t":"+2.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.1%","t":"+13.6%","d":"up"},{"l":"Latência Média (ms)","v":"72ms","t":"-4.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.537","5.601","71.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.841","6.539","92.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.087","2.908","72.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.657","2.360","72.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.470","832","71.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":796},{"label":"Mar","value":536},{"label":"Abr","value":573},{"label":"Mai","value":609},{"label":"Jun","value":872},{"label":"Jul","value":690},{"label":"Ago","value":702},{"label":"Set","value":824},{"label":"Out","value":791},{"label":"Nov","value":506},{"label":"Dez","value":764}];
const MX = 872;
