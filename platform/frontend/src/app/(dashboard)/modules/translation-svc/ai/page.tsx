...
const ACCENT = "#93c5fd";
const MODULE = "Translation Services";
const PAGE = "AI Trans";
const KPIS = [{"l":"Tickets Abertos","v":"8.343","t":"-1.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"65.2%","t":"+3.8%","d":"up"},{"l":"MTTR (h)","v":"203h","t":"+2.8%","d":"up"},{"l":"Satisfação (%)","v":"81.9%","t":"-3.7%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.035","2.853","7.998","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.414","3.093","4.325","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.582","6.141","4.395","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.319","7.862","1.418","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.902","4.337","2.908","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":647},{"label":"Mar","value":652},{"label":"Abr","value":875},{"label":"Mai","value":713},{"label":"Jun","value":885},{"label":"Jul","value":585},{"label":"Ago","value":962},{"label":"Set","value":668},{"label":"Out","value":623},{"label":"Nov","value":944},{"label":"Dez","value":789}];
const MX = 962;
