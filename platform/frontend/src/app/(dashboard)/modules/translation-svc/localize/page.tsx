...
const PAGE = "Localize";
const KPIS = [{"l":"Tickets Abertos","v":"2.222","t":"+12.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.7%","t":"+8.3%","d":"up"},{"l":"MTTR (h)","v":"209h","t":"+10.5%","d":"up"},{"l":"Satisfação (%)","v":"81.9%","t":"+6.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.857","3.091","3.949","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.448","7.904","2.290","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","327","3.297","1.283","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.378","5.338","7.204","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.812","8.747","4.914","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":508},{"label":"Mar","value":394},{"label":"Abr","value":441},{"label":"Mai","value":600},{"label":"Jun","value":338},{"label":"Jul","value":492},{"label":"Ago","value":584},{"label":"Set","value":386},{"label":"Out","value":440},{"label":"Nov","value":465},{"label":"Dez","value":386}];
const MX = 600;
