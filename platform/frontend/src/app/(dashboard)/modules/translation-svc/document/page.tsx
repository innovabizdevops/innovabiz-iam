...
const PAGE = "Document";
const KPIS = [{"l":"Tickets Abertos","v":"3.316","t":"-2.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"87.3%","t":"-1.4%","d":"down"},{"l":"MTTR (h)","v":"171h","t":"+12.6%","d":"up"},{"l":"Satisfação (%)","v":"81.8%","t":"+11.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.334","3.633","3.741","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.778","9.065","2.971","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.744","4.509","4.044","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.865","1.496","4.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.470","1.600","9.037","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":881},{"label":"Mar","value":853},{"label":"Abr","value":761},{"label":"Mai","value":883},{"label":"Jun","value":575},{"label":"Jul","value":844},{"label":"Ago","value":784},{"label":"Set","value":862},{"label":"Out","value":769},{"label":"Nov","value":525},{"label":"Dez","value":909}];
const MX = 909;
