...
const PAGE = "Interpret";
const KPIS = [{"l":"Tickets Abertos","v":"3.728","t":"+11.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.5%","t":"+15.4%","d":"up"},{"l":"MTTR (h)","v":"107h","t":"+11.9%","d":"up"},{"l":"Satisfação (%)","v":"80.2%","t":"+11.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.023","3.513","4.331","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.193","4.945","6.190","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.314","5.231","2.120","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.164","8.611","439","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.852","4.186","8.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":431},{"label":"Mar","value":459},{"label":"Abr","value":453},{"label":"Mai","value":532},{"label":"Jun","value":641},{"label":"Jul","value":665},{"label":"Ago","value":444},{"label":"Set","value":288},{"label":"Out","value":401},{"label":"Nov","value":406},{"label":"Dez","value":678}];
const MX = 678;
