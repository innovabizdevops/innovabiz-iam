...
export default function TranslationSvcPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Translation Svc</h1><p className="text-sm text-muted-foreground">Translation Svc • iBOS</p></div>
