...
const KPIS = [{"l":"Dashboards Ativos","v":"3.230","t":"+3.9%","d":"up"},{"l":"Queries/Dia","v":"442","t":"-4.7%","d":"down"},{"l":"Dados Processados (GB)","v":"2.703","t":"-0.7%","d":"down"},{"l":"Utilizadores Analytics","v":"698","t":"+15.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2449","2026-02-05","1.468","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2795","2026-02-28","7.897","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3375","2026-02-28","6.730","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1789","2026-03-15","4.465","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4543","2026-02-02","2.022","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":944},{"label":"Mar","value":758},{"label":"Abr","value":938},{"label":"Mai","value":956},{"label":"Jun","value":755},{"label":"Jul","value":743},{"label":"Ago","value":804},{"label":"Set","value":901},{"label":"Out","value":930},{"label":"Nov","value":597},{"label":"Dez","value":853}];
const MX = 956;
