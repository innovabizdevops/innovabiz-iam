...
export default function MarineEnginePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Marine Engine</h1><p className="text-sm text-muted-foreground">Marine Engine • iBOS Enterprise</p></div>
