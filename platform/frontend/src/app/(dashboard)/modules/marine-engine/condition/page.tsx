...
const ACCENT = "#ec4899";
const MODULE = "Marine Engineering";
const PAGE = "Condition Mon";
const KPIS = [{"l":"Total Marine Engine","v":"6.815","t":"+8.1%","d":"up"},{"l":"Condition Mon Ativos","v":"4.683","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"94","t":"-1.0%","d":"down"}];
const COLS = ["ID","Condition Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marine Engine #001","Marine Engine #002","1.451","2.876","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Marine Engine #002","Marine Engine #003","6.660","3.252","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Marine Engine #003","Marine Engine #004","2.305","3.034","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Marine Engine #004","Marine Engine #005","857","6.091","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marine Engine #005","Marine Engine #001","5.306","808","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":515},{"label":"Mar","value":280},{"label":"Abr","value":501},{"label":"Mai","value":344},{"label":"Jun","value":361},{"label":"Jul","value":319},{"label":"Ago","value":525},{"label":"Set","value":267},{"label":"Out","value":365},{"label":"Nov","value":621},{"label":"Dez","value":338}];
const MX = 627;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>IoT</span></h1>
                </div>
