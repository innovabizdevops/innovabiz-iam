...
const PAGE = "PMS Track";
const KPIS = [{"l":"Quartos Ocupados","v":"6.746","t":"-3.4%","d":"down"},{"l":"RevPAR (€)","v":"€84857","t":"+8.5%","d":"up"},{"l":"Ocupação (%)","v":"87.5%","t":"+2.8%","d":"up"},{"l":"Guest Satisfaction","v":"8.991","t":"+14.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.380","2026-03-15","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.467","2026-03-28","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.812","2026-03-10","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.927","2026-01-22","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.583","2026-01-06","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":672},{"label":"Mar","value":614},{"label":"Abr","value":853},{"label":"Mai","value":837},{"label":"Jun","value":799},{"label":"Jul","value":624},{"label":"Ago","value":988},{"label":"Set","value":872},{"label":"Out","value":649},{"label":"Nov","value":735},{"label":"Dez","value":974}];
const MX = 988;
