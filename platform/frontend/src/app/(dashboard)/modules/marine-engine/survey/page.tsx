...
const PAGE = "Class Survey";
const KPIS = [{"l":"Surveys Ativos","v":"7.073","t":"+9.1%","d":"up"},{"l":"Respostas/Semana","v":"4044","t":"+2.8%","d":"up"},{"l":"NPS Médio","v":"58","t":"+15.5%","d":"up"},{"l":"Taxa Resposta (%)","v":"92.1%","t":"+11.0%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","6.453","76","80.9%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","4.631","63","99.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","3.167","71","82.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","813","62","76.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","1.570","89","75.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":364},{"label":"Fev","value":332},{"label":"Mar","value":664},{"label":"Abr","value":484},{"label":"Mai","value":652},{"label":"Jun","value":442},{"label":"Jul","value":459},{"label":"Ago","value":616},{"label":"Set","value":633},{"label":"Out","value":674},{"label":"Nov","value":367},{"label":"Dez","value":394}];
const MX = 674;
