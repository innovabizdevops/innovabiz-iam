...
const ACCENT = "#6366f1";
const MODULE = "Property Valuation";
const PAGE = "AVM";
const KPIS = [{"l":"Total Property Valuation","v":"7.857","t":"-2.9%","d":"down"},{"l":"AVM Ativos","v":"2.211","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"84.7%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"69","t":"+5.4%","d":"up"}];
const COLS = ["ID","AVM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Property Valuation #001","Property Valuation #002","7.995","7.869","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Property Valuation #002","Property Valuation #003","2.503","4.614","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Property Valuation #003","Property Valuation #004","5.525","2.140","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Property Valuation #004","Property Valuation #005","7.830","1.994","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Property Valuation #005","Property Valuation #001","6.511","3.492","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":563},{"label":"Mar","value":668},{"label":"Abr","value":554},{"label":"Mai","value":580},{"label":"Jun","value":661},{"label":"Jul","value":586},{"label":"Ago","value":438},{"label":"Set","value":451},{"label":"Out","value":585},{"label":"Nov","value":642},{"label":"Dez","value":496}];
const MX = 668;
