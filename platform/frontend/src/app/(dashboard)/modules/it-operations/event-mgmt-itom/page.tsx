...
const PAGE = "Event Management";
const KPIS = [{"l":"Eventos Planeados","v":"2.442","t":"+0.0%","d":"up"},{"l":"Participantes","v":"4.026","t":"+15.9%","d":"up"},{"l":"NPS Evento","v":"75","t":"+12.0%","d":"up"},{"l":"Receita (€)","v":"€53870","t":"+16.7%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-25","6.919","5.636","€ 12862.77","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-14","6.863","2.344","€ 27957.44","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-14","586","5.976","€ 33575.69","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-04","6.788","3.602","€ 22081.45","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-17","4.149","7.393","€ 35901.33","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":359},{"label":"Mar","value":646},{"label":"Abr","value":521},{"label":"Mai","value":421},{"label":"Jun","value":431},{"label":"Jul","value":378},{"label":"Ago","value":484},{"label":"Set","value":713},{"label":"Out","value":613},{"label":"Nov","value":531},{"label":"Dez","value":424}];
const MX = 713;
...
export default function EventMgmtItomPage() {
    return (
