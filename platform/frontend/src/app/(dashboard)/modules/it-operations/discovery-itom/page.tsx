...
const KPIS = [{"l":"Total It Operations","v":"3.458","t":"-5.9%","d":"down"},{"l":"Discovery Ativos","v":"8.427","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"92","t":"-3.8%","d":"down"}];
const COLS = ["ID","Discovery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["It Operations #001","It Operations #002","1.049","9.089","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["It Operations #002","It Operations #003","4.345","8.871","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["It Operations #003","It Operations #004","6.420","5.384","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["It Operations #004","It Operations #005","5.825","5.741","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["It Operations #005","It Operations #001","271","7.438","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":731},{"label":"Mar","value":766},{"label":"Abr","value":855},{"label":"Mai","value":584},{"label":"Jun","value":686},{"label":"Jul","value":563},{"label":"Ago","value":796},{"label":"Set","value":502},{"label":"Out","value":551},{"label":"Nov","value":588},{"label":"Dez","value":615}];
const MX = 855;
...
export default function DiscoveryItomPage() {
    return (
