...
const PAGE = "CMDB";
const KPIS = [{"l":"Ativos Registados","v":"4.080","t":"+10.5%","d":"up"},{"l":"Valor Total (€M)","v":"€25.5M","t":"+15.7%","d":"up"},{"l":"Depreciação Anual (€)","v":"€2470","t":"-3.0%","d":"down"},{"l":"Ativos em Garantia","v":"4.694","t":"-3.4%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 4297.83","6.575","€ 13245.92","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 38060.80","256","€ 9980.92","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 31207.91","6.390","€ 28548.61","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 49504.40","3.891","€ 13910.27","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 33515.26","1.600","€ 5655.35","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":439},{"label":"Mar","value":370},{"label":"Abr","value":288},{"label":"Mai","value":571},{"label":"Jun","value":273},{"label":"Jul","value":247},{"label":"Ago","value":320},{"label":"Set","value":395},{"label":"Out","value":302},{"label":"Nov","value":274},{"label":"Dez","value":312}];
const MX = 571;
