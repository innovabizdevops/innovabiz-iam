...
const PAGE = "Health Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"9.100","t":"+9.3%","d":"up"},{"l":"Reuniões/Semana","v":"2142","t":"+13.6%","d":"up"},{"l":"Mensagens/Dia","v":"1939","t":"-3.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"1.901","t":"+13.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.313","4328","664","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.472","1635","3.455","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.635","1666","1.862","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.790","1934","4.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.620","4111","2.947","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":445},{"label":"Mar","value":607},{"label":"Abr","value":629},{"label":"Mai","value":340},{"label":"Jun","value":415},{"label":"Jul","value":442},{"label":"Ago","value":430},{"label":"Set","value":680},{"label":"Out","value":593},{"label":"Nov","value":539},{"label":"Dez","value":592}];
const MX = 680;
