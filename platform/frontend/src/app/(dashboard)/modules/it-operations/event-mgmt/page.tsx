...
const PAGE = "Operations &amp; AIOps";
const KPIS = [{"l":"Eventos Planeados","v":"315","t":"+9.4%","d":"up"},{"l":"Participantes","v":"4.102","t":"+3.4%","d":"up"},{"l":"NPS Evento","v":"72","t":"-5.8%","d":"down"},{"l":"Receita (€)","v":"€67495","t":"+11.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-21","2.944","2.951","€ 36944.23","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-23","1.592","8.328","€ 36530.65","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-26","812","6.739","€ 21255.30","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-28","1.309","7.894","€ 26750.95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-01","135","2.251","€ 11183.79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":741},{"label":"Mar","value":832},{"label":"Abr","value":883},{"label":"Mai","value":781},{"label":"Jun","value":712},{"label":"Jul","value":687},{"label":"Ago","value":698},{"label":"Set","value":916},{"label":"Out","value":677},{"label":"Nov","value":953},{"label":"Dez","value":785}];
const MX = 953;
