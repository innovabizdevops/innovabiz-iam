...
const ACCENT = "#6366f1";
const MODULE = "It Operations";
const PAGE = "Service Mapping";
const KPIS = [{"l":"Total It Operations","v":"7.997","t":"+3.8%","d":"up"},{"l":"Service Mapping Ativos","v":"5.729","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"65","t":"-0.3%","d":"down"}];
const COLS = ["ID","Service Mapping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["It Operations #001","It Operations #002","6.629","7.606","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["It Operations #002","It Operations #003","6.135","2.407","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["It Operations #003","It Operations #004","5.187","2.218","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["It Operations #004","It Operations #005","5.481","1.398","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["It Operations #005","It Operations #001","2.206","2.546","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":776},{"label":"Mar","value":638},{"label":"Abr","value":428},{"label":"Mai","value":628},{"label":"Jun","value":766},{"label":"Jul","value":425},{"label":"Ago","value":619},{"label":"Set","value":470},{"label":"Out","value":484},{"label":"Nov","value":622},{"label":"Dez","value":604}];
const MX = 776;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ITIL</span></h1>
                </div>
