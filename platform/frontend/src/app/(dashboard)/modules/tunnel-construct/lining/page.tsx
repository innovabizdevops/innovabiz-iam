...
const PAGE = "Lining";
const KPIS = [{"l":"Total Tunnel Construct","v":"1.056","t":"+3.4%","d":"up"},{"l":"Lining Ativos","v":"6.138","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"81","t":"-1.3%","d":"down"}];
const COLS = ["ID","Lining","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tunnel Construct #001","Tunnel Construct #002","4.818","7.433","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Tunnel Construct #002","Tunnel Construct #003","318","8.485","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Tunnel Construct #003","Tunnel Construct #004","1.277","7.434","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Tunnel Construct #004","Tunnel Construct #005","6.108","8.359","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tunnel Construct #005","Tunnel Construct #001","8.512","8.223","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":490},{"label":"Mar","value":524},{"label":"Abr","value":539},{"label":"Mai","value":635},{"label":"Jun","value":372},{"label":"Jul","value":569},{"label":"Ago","value":438},{"label":"Set","value":617},{"label":"Out","value":338},{"label":"Nov","value":492},{"label":"Dez","value":321}];
const MX = 635;
