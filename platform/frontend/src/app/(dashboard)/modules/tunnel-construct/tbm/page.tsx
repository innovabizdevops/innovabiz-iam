...
const PAGE = "TBM";
const KPIS = [{"l":"Total Tunnel Construct","v":"2.577","t":"-3.4%","d":"down"},{"l":"TBM Ativos","v":"3.967","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"56","t":"-2.1%","d":"down"}];
const COLS = ["ID","TBM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tunnel Construct #001","Tunnel Construct #002","6.518","422","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Tunnel Construct #002","Tunnel Construct #003","2.213","4.587","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Tunnel Construct #003","Tunnel Construct #004","7.540","6.886","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Tunnel Construct #004","Tunnel Construct #005","1.658","4.139","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tunnel Construct #005","Tunnel Construct #001","7.960","5.929","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":758},{"label":"Mar","value":733},{"label":"Abr","value":786},{"label":"Mai","value":546},{"label":"Jun","value":719},{"label":"Jul","value":909},{"label":"Ago","value":707},{"label":"Set","value":748},{"label":"Out","value":818},{"label":"Nov","value":868},{"label":"Dez","value":674}];
const MX = 909;
