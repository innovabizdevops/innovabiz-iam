...
export default function TunnelConstructPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Tunnel Construct</h1><p className="text-sm text-muted-foreground">Tunnel Construct • iBOS Enterprise</p></div>
