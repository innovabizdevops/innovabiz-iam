...
const PAGE = "Waste Collection Routes";
const KPIS = [{"l":"Total Water Waste","v":"8.011","t":"+3.7%","d":"up"},{"l":"Waste Collection Routes Ativos","v":"7.726","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"62","t":"-0.4%","d":"down"}];
const COLS = ["ID","Waste Collection Routes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Waste #001","Water Waste #002","570","2.441","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Water Waste #002","Water Waste #003","1.603","1.915","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Waste #003","Water Waste #004","4.203","5.466","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Water Waste #004","Water Waste #005","8.976","9.046","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Waste #005","Water Waste #001","4.794","4.903","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":573},{"label":"Mar","value":670},{"label":"Abr","value":482},{"label":"Mai","value":561},{"label":"Jun","value":843},{"label":"Jul","value":782},{"label":"Ago","value":781},{"label":"Set","value":877},{"label":"Out","value":794},{"label":"Nov","value":833},{"label":"Dez","value":814}];
const MX = 877;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0284c7'}}>AI</span></h1>
                </div>
