...
const PAGE = "Billing &amp; Metering";
const KPIS = [{"l":"Total Water Waste","v":"8.172","t":"+4.7%","d":"up"},{"l":"Billing & Metering Ativos","v":"997","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"75.5%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+14.6%","d":"up"}];
const COLS = ["ID","Billing & Metering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Waste #001","Water Waste #002","8.526","3.068","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Water Waste #002","Water Waste #003","1.424","6.107","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Waste #003","Water Waste #004","7.670","3.445","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Water Waste #004","Water Waste #005","2.895","9.071","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Waste #005","Water Waste #001","174","5.927","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":817},{"label":"Mar","value":447},{"label":"Abr","value":652},{"label":"Mai","value":551},{"label":"Jun","value":620},{"label":"Jul","value":781},{"label":"Ago","value":753},{"label":"Set","value":638},{"label":"Out","value":577},{"label":"Nov","value":728},{"label":"Dez","value":507}];
const MX = 817;
