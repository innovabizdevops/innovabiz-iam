...
const PAGE = "Water Treatment SCADA";
const KPIS = [{"l":"Dispositivos Online","v":"7.925","t":"+7.3%","d":"up"},{"l":"Dados/Min (MB)","v":"2.172","t":"+18.0%","d":"up"},{"l":"Alertas Ativos","v":"8.289","t":"+3.5%","d":"up"},{"l":"Uptime (%)","v":"92.7%","t":"+13.4%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.697","6.360","4.171","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.524","1.989","813","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.298","3.124","8.512","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","163","6.517","1.838","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.053","6.579","8.072","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":329},{"label":"Mar","value":652},{"label":"Abr","value":661},{"label":"Mai","value":302},{"label":"Jun","value":599},{"label":"Jul","value":336},{"label":"Ago","value":322},{"label":"Set","value":388},{"label":"Out","value":598},{"label":"Nov","value":376},{"label":"Dez","value":469}];
const MX = 661;
