...
const PAGE = "Regulatory Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.853","t":"+9.5%","d":"up"},{"l":"NC Abertas","v":"5.172","t":"+6.1%","d":"up"},{"l":"Conformidade (%)","v":"72.9%","t":"-1.6%","d":"down"},{"l":"CAPAs Pendentes","v":"8.406","t":"+7.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","899","97.2%","6.720","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","349","70.5%","6.628","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.904","83.8%","2.863","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.765","75.2%","3.541","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.429","95.3%","7.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":549},{"label":"Mar","value":612},{"label":"Abr","value":435},{"label":"Mai","value":359},{"label":"Jun","value":607},{"label":"Jul","value":436},{"label":"Ago","value":515},{"label":"Set","value":427},{"label":"Out","value":472},{"label":"Nov","value":526},{"label":"Dez","value":564}];
const MX = 612;
