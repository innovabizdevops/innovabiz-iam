...
const PAGE = "Water Quality IoT";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.280","t":"-5.9%","d":"down"},{"l":"NC Abertas","v":"1.338","t":"-2.9%","d":"down"},{"l":"Conformidade (%)","v":"93.9%","t":"-6.0%","d":"down"},{"l":"CAPAs Pendentes","v":"5.622","t":"+10.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.271","74.5%","2.465","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.681","98.6%","4.620","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","671","70.0%","8.956","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.485","71.0%","6.931","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.455","93.0%","256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":921},{"label":"Mar","value":686},{"label":"Abr","value":1008},{"label":"Mai","value":782},{"label":"Jun","value":1002},{"label":"Jul","value":1054},{"label":"Ago","value":736},{"label":"Set","value":1033},{"label":"Out","value":1018},{"label":"Nov","value":762},{"label":"Dez","value":973}];
const MX = 1054;
