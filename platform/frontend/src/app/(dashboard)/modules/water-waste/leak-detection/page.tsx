...
const PAGE = "Leak Detection AI";
const KPIS = [{"l":"Total Water Waste","v":"6.586","t":"+9.1%","d":"up"},{"l":"Leak Detection AI Ativos","v":"5.615","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+10.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+8.5%","d":"up"}];
const COLS = ["ID","Leak Detection AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Waste #001","Water Waste #002","6.867","2.928","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Water Waste #002","Water Waste #003","2.771","3.107","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Waste #003","Water Waste #004","3.094","7.235","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Water Waste #004","Water Waste #005","3.097","3.622","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Waste #005","Water Waste #001","2.956","5.309","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":775},{"label":"Mar","value":468},{"label":"Abr","value":388},{"label":"Mai","value":571},{"label":"Jun","value":455},{"label":"Jul","value":599},{"label":"Ago","value":411},{"label":"Set","value":454},{"label":"Out","value":602},{"label":"Nov","value":524},{"label":"Dez","value":751}];
const MX = 775;
