...
const ACCENT = "#0284c7";
const MODULE = "Water & Waste Management";
const PAGE = "Recycling Operations";
const KPIS = [{"l":"Total Water Waste","v":"3.500","t":"+9.3%","d":"up"},{"l":"Recycling Operations Ativos","v":"5.219","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"68.5%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+0.8%","d":"up"}];
const COLS = ["ID","Recycling Operations","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Waste #001","Water Waste #002","1.586","3.840","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Water Waste #002","Water Waste #003","1.618","5.066","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Waste #003","Water Waste #004","5.296","8.696","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Water Waste #004","Water Waste #005","7.812","4.426","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Waste #005","Water Waste #001","4.933","1.779","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":1021},{"label":"Mar","value":1000},{"label":"Abr","value":895},{"label":"Mai","value":792},{"label":"Jun","value":721},{"label":"Jul","value":723},{"label":"Ago","value":920},{"label":"Set","value":1003},{"label":"Out","value":1004},{"label":"Nov","value":994},{"label":"Dez","value":702}];
const MX = 1021;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0284c7'}}>ESG</span></h1>
                </div>
