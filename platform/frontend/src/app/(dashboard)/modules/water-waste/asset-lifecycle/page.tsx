...
const PAGE = "Asset Lifecycle";
const KPIS = [{"l":"Ativos Registados","v":"2.490","t":"-0.3%","d":"down"},{"l":"Valor Total (€M)","v":"€33.1M","t":"+10.8%","d":"up"},{"l":"Depreciação Anual (€)","v":"€48245","t":"+15.1%","d":"up"},{"l":"Ativos em Garantia","v":"5.836","t":"+13.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 1297.77","5.352","€ 14064.74","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 4226.75","4.964","€ 27875.81","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 15991.33","2.933","€ 10477.85","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 36429.61","1.328","€ 10859.77","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 17121.83","916","€ 22653.44","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":457},{"label":"Mar","value":649},{"label":"Abr","value":632},{"label":"Mai","value":354},{"label":"Jun","value":568},{"label":"Jul","value":384},{"label":"Ago","value":602},{"label":"Set","value":691},{"label":"Out","value":491},{"label":"Nov","value":606},{"label":"Dez","value":547}];
const MX = 691;
