...
const PAGE = "Media";
const KPIS = [{"l":"Integrações Ativas","v":"5.105","t":"+11.3%","d":"up"},{"l":"Chamadas/Hora","v":"4782","t":"+11.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.7%","t":"+15.3%","d":"up"},{"l":"Latência Média (ms)","v":"45ms","t":"+7.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.781","7.639","84.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.951","6.498","74.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.677","1.275","98.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.979","5.502","72.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.819","2.885","89.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":393},{"label":"Mar","value":370},{"label":"Abr","value":398},{"label":"Mai","value":360},{"label":"Jun","value":512},{"label":"Jul","value":437},{"label":"Ago","value":462},{"label":"Set","value":650},{"label":"Out","value":502},{"label":"Nov","value":654},{"label":"Dez","value":365}];
const MX = 718;
