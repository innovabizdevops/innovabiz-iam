...
const KPIS = [{"l":"Projetos Sociais","v":"2.559","t":"+3.2%","d":"up"},{"l":"Beneficiários","v":"7.764","t":"+13.9%","d":"up"},{"l":"Investimento CSR (€)","v":"€31961","t":"+11.3%","d":"up"},{"l":"Score Impacto","v":"71","t":"+10.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.476","€ 8136.83","5.782","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.228","€ 22511.23","2.752","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","3.327","€ 43740.88","924","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.544","€ 42184.01","6.285","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","1.671","€ 25489.40","7.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":501},{"label":"Mar","value":597},{"label":"Abr","value":550},{"label":"Mai","value":577},{"label":"Jun","value":654},{"label":"Jul","value":506},{"label":"Ago","value":562},{"label":"Set","value":497},{"label":"Out","value":427},{"label":"Nov","value":684},{"label":"Dez","value":384}];
const MX = 729;
