...
/* ═══ External Relationships (APQC 11) — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "3510", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4180", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€473K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "203963210", cells: ["EXT-6210", "External Relationships (APQC 11) Item 1", "11/3/2026", "€13 310"], status: "active" as const },
    { id: "203966781", cells: ["EXT-9781", "External Relationships (APQC 11) Item 2", "26/10/2026", "€16 881"], status: "pending" as const },
    { id: "203970352", cells: ["EXT-4352", "External Relationships (APQC 11) Item 3", "13/5/2026", "€20 452"], status: "completed" as const },
    { id: "203973923", cells: ["EXT-7923", "External Relationships (APQC 11) Item 4", "28/12/2026", "€24 023"], status: "warning" as const },
    { id: "203977494", cells: ["EXT-2494", "External Relationships (APQC 11) Item 5", "15/7/2026", "€27 594"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 30 }, { label: "Fev", value: 39 }, { label: "Mar", value: 48 }, { label: "Abr", value: 57 }, { label: "Mai", value: 66 }, { label: "Jun", value: 75 }];
...
export default function ExternalRelationshipsApqc11Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">External Relationships (APQC 11)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • External Relationships (APQC 11)</p>
                    </div>
                </div>
