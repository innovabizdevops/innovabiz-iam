...
/* ═══ Marine Technology — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "7089", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3829", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€79K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1626685889", cells: ["MAR-8889", "Marine Technology Item 1", "18/6/2026", "€35 989"], status: "active" as const },
    { id: "1626689460", cells: ["MAR-3460", "Marine Technology Item 2", "5/1/2026", "€39 560"], status: "pending" as const },
    { id: "1626693031", cells: ["MAR-7031", "Marine Technology Item 3", "20/8/2026", "€43 131"], status: "completed" as const },
    { id: "1626696602", cells: ["MAR-1602", "Marine Technology Item 4", "7/3/2026", "€46 702"], status: "warning" as const },
    { id: "1626700173", cells: ["MAR-5173", "Marine Technology Item 5", "22/10/2026", "€273"], status: "active" as const },
];
...
export default function MarineTechnologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marine Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marine Technology</p>
                    </div>
                </div>
