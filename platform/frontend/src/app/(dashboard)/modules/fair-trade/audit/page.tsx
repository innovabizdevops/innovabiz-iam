...
const KPIS = [{"l":"Auditorias Realizadas","v":"224","t":"-3.7%","d":"down"},{"l":"NC Abertas","v":"6.537","t":"-2.6%","d":"down"},{"l":"Conformidade (%)","v":"84.1%","t":"+3.3%","d":"up"},{"l":"CAPAs Pendentes","v":"3.573","t":"+5.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.911","76.0%","210","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.507","83.4%","2.065","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","634","88.7%","1.393","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.914","96.2%","2.433","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.003","73.5%","4.462","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":479},{"label":"Mar","value":414},{"label":"Abr","value":701},{"label":"Mai","value":744},{"label":"Jun","value":449},{"label":"Jul","value":553},{"label":"Ago","value":485},{"label":"Set","value":507},{"label":"Out","value":548},{"label":"Nov","value":400},{"label":"Dez","value":518}];
const MX = 744;
