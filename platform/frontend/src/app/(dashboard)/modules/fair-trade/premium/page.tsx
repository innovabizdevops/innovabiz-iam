...
const ACCENT = "#b45309";
const MODULE = "Fair Trade Platform";
const PAGE = "Premium Mgmt";
const KPIS = [{"l":"Projetos Sociais","v":"8.540","t":"-5.0%","d":"down"},{"l":"Beneficiários","v":"5.599","t":"-4.7%","d":"down"},{"l":"Investimento CSR (€)","v":"€92885","t":"+5.3%","d":"up"},{"l":"Score Impacto","v":"91","t":"+9.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","7.905","€ 48721.78","3.498","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.372","€ 49472.59","6.378","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.164","€ 40506.10","6.644","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.040","€ 50067.11","2.687","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.345","€ 21610.66","8.509","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":742},{"label":"Mar","value":664},{"label":"Abr","value":656},{"label":"Mai","value":687},{"label":"Jun","value":440},{"label":"Jul","value":570},{"label":"Ago","value":406},{"label":"Set","value":423},{"label":"Out","value":485},{"label":"Nov","value":733},{"label":"Dez","value":546}];
const MX = 742;
