...
const PAGE = "Producer Group";
const KPIS = [{"l":"Projetos Sociais","v":"4.902","t":"+9.3%","d":"up"},{"l":"Beneficiários","v":"6.077","t":"+5.3%","d":"up"},{"l":"Investimento CSR (€)","v":"€31676","t":"+0.6%","d":"up"},{"l":"Score Impacto","v":"87","t":"+17.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.027","€ 633.39","6.249","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.662","€ 2358.02","5.586","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","801","€ 31957.97","5.989","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.981","€ 46375.70","7.691","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.212","€ 28989.29","4.631","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":622},{"label":"Mar","value":564},{"label":"Abr","value":282},{"label":"Mai","value":309},{"label":"Jun","value":434},{"label":"Jul","value":392},{"label":"Ago","value":484},{"label":"Set","value":339},{"label":"Out","value":584},{"label":"Nov","value":364},{"label":"Dez","value":509}];
const MX = 622;
