...
const PAGE = "Cert Track";
const KPIS = [{"l":"Projetos Sociais","v":"8.496","t":"-4.4%","d":"down"},{"l":"Beneficiários","v":"2.985","t":"+13.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€98335","t":"+15.7%","d":"up"},{"l":"Score Impacto","v":"77","t":"+14.7%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.662","€ 27252.84","4.256","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","496","€ 6086.09","8.177","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.151","€ 1657.63","8.748","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.473","€ 23076.53","4.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.620","€ 24978.11","7.011","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":544},{"label":"Mar","value":545},{"label":"Abr","value":501},{"label":"Mai","value":781},{"label":"Jun","value":467},{"label":"Jul","value":602},{"label":"Ago","value":804},{"label":"Set","value":836},{"label":"Out","value":813},{"label":"Nov","value":782},{"label":"Dez","value":763}];
const MX = 859;
