...
/* ═══ Insurance Core Ops — Commission Calc ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "433", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "320", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1008", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1312209996", cells: ["INS-1996", "Commission Calc Item 1", "21/1/2026", "€10 096"], status: "active" as const },
    { id: "1312213567", cells: ["INS-5567", "Commission Calc Item 2", "8/8/2026", "€13 667"], status: "pending" as const },
    { id: "1312217138", cells: ["INS-9138", "Commission Calc Item 3", "23/3/2026", "€17 238"], status: "completed" as const },
    { id: "1312220709", cells: ["INS-3709", "Commission Calc Item 4", "10/10/2026", "€20 809"], status: "warning" as const },
    { id: "1312224280", cells: ["INS-7280", "Commission Calc Item 5", "25/5/2026", "€24 380"], status: "active" as const },
];
...
export default function InsuranceCoreOpsCommissionCalcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commission Calc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Commission Calc</p>
                    </div>
                </div>
