...
/* ═══ Insurance Core Ops — Billing Collect ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "171", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "213", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "221", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1391422577", cells: ["INS-5577", "Billing Collect Item 1", "14/6/2026", "€22 677"], status: "active" as const },
    { id: "1391426148", cells: ["INS-9148", "Billing Collect Item 2", "1/1/2026", "€26 248"], status: "pending" as const },
    { id: "1391429719", cells: ["INS-3719", "Billing Collect Item 3", "16/8/2026", "€29 819"], status: "completed" as const },
    { id: "1391433290", cells: ["INS-7290", "Billing Collect Item 4", "3/3/2026", "€33 390"], status: "warning" as const },
    { id: "1391436861", cells: ["INS-1861", "Billing Collect Item 5", "18/10/2026", "€36 961"], status: "active" as const },
];
...
export default function InsuranceCoreOpsBillingCollectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Billing Collect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Billing Collect</p>
                    </div>
                </div>
