...
/* ═══ Insurance Core Ops — Underwriting Engine ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "380", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "108", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1297", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "77%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "725233960", cells: ["INS-5960", "Underwriting Engine Item 1", "25/5/2026", "€34 060"], status: "active" as const },
    { id: "725237531", cells: ["INS-9531", "Underwriting Engine Item 2", "12/12/2026", "€37 631"], status: "pending" as const },
    { id: "725241102", cells: ["INS-4102", "Underwriting Engine Item 3", "27/7/2026", "€41 202"], status: "completed" as const },
    { id: "725244673", cells: ["INS-7673", "Underwriting Engine Item 4", "14/2/2026", "€44 773"], status: "warning" as const },
    { id: "725248244", cells: ["INS-2244", "Underwriting Engine Item 5", "1/9/2026", "€48 344"], status: "active" as const },
];
...
export default function InsuranceCoreOpsUnderwritingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Underwriting Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Underwriting Engine</p>
                    </div>
                </div>
