...
/* ═══ Insurance Core Ops — Claims Process ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "2424", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "360", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1685", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1177749892", cells: ["INS-1892", "Claims Process Item 1", "5/5/2026", "€49 992"], status: "active" as const },
    { id: "1177753463", cells: ["INS-5463", "Claims Process Item 2", "20/12/2026", "€3563"], status: "pending" as const },
    { id: "1177757034", cells: ["INS-9034", "Claims Process Item 3", "7/7/2026", "€7134"], status: "completed" as const },
    { id: "1177760605", cells: ["INS-3605", "Claims Process Item 4", "22/2/2026", "€10 705"], status: "warning" as const },
    { id: "1177764176", cells: ["INS-7176", "Claims Process Item 5", "9/9/2026", "€14 276"], status: "active" as const },
];
...
export default function InsuranceCoreOpsClaimsProcessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Claims Process</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Claims Process</p>
                    </div>
                </div>
