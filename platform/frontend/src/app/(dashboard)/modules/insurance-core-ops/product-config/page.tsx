...
/* ═══ Insurance Core Ops — Product Config ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "4059", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "11", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "219", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2064688311", cells: ["INS-8311", "Product Config Item 1", "8/4/2026", "€38 411"], status: "active" as const },
    { id: "2064691882", cells: ["INS-2882", "Product Config Item 2", "23/11/2026", "€41 982"], status: "pending" as const },
    { id: "2064695453", cells: ["INS-6453", "Product Config Item 3", "10/6/2026", "€45 553"], status: "completed" as const },
    { id: "2064699024", cells: ["INS-1024", "Product Config Item 4", "25/1/2026", "€49 124"], status: "warning" as const },
    { id: "2064702595", cells: ["INS-4595", "Product Config Item 5", "12/8/2026", "€2695"], status: "active" as const },
];
...
export default function InsuranceCoreOpsProductConfigPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Config</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Product Config</p>
                    </div>
                </div>
