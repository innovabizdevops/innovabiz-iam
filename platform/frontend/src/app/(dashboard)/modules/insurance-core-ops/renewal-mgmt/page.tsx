...
/* ═══ Insurance Core Ops — Renewal Mgmt ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "3728", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "293", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1181", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1102602849", cells: ["INS-4849", "Renewal Mgmt Item 1", "6/10/2026", "€2949"], status: "active" as const },
    { id: "1102606420", cells: ["INS-8420", "Renewal Mgmt Item 2", "21/5/2026", "€6520"], status: "pending" as const },
    { id: "1102609991", cells: ["INS-2991", "Renewal Mgmt Item 3", "8/12/2026", "€10 091"], status: "completed" as const },
    { id: "1102613562", cells: ["INS-6562", "Renewal Mgmt Item 4", "23/7/2026", "€13 662"], status: "warning" as const },
    { id: "1102617133", cells: ["INS-1133", "Renewal Mgmt Item 5", "10/2/2026", "€17 233"], status: "active" as const },
];
...
export default function InsuranceCoreOpsRenewalMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Renewal Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Renewal Mgmt</p>
                    </div>
                </div>
