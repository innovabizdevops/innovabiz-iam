...
/* ═══ Insurance Core Ops — Policy Admin ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "99", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "379", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "927", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1081833431", cells: ["INS-7431", "Policy Admin Item 1", "8/12/2026", "€33 531"], status: "active" as const },
    { id: "1081837002", cells: ["INS-2002", "Policy Admin Item 2", "23/7/2026", "€37 102"], status: "pending" as const },
    { id: "1081840573", cells: ["INS-5573", "Policy Admin Item 3", "10/2/2026", "€40 673"], status: "completed" as const },
    { id: "1081844144", cells: ["INS-9144", "Policy Admin Item 4", "25/9/2026", "€44 244"], status: "warning" as const },
    { id: "1081847715", cells: ["INS-3715", "Policy Admin Item 5", "12/4/2026", "€47 815"], status: "active" as const },
];
...
export default function InsuranceCoreOpsPolicyAdminPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Policy Admin</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Policy Admin</p>
                    </div>
                </div>
