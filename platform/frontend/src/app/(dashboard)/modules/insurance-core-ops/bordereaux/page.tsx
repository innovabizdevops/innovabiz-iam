...
/* ═══ Insurance Core Ops — Bordereaux ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "3099", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "213", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2312", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "994380033", cells: ["INS-7033", "Bordereaux Item 1", "18/10/2026", "€30 133"], status: "active" as const },
    { id: "994383604", cells: ["INS-1604", "Bordereaux Item 2", "5/5/2026", "€33 704"], status: "pending" as const },
    { id: "994387175", cells: ["INS-5175", "Bordereaux Item 3", "20/12/2026", "€37 275"], status: "completed" as const },
    { id: "994390746", cells: ["INS-8746", "Bordereaux Item 4", "7/7/2026", "€40 846"], status: "warning" as const },
    { id: "994394317", cells: ["INS-3317", "Bordereaux Item 5", "22/2/2026", "€44 417"], status: "active" as const },
];
...
export default function InsuranceCoreOpsBordereauxPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bordereaux</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Bordereaux</p>
                    </div>
                </div>
