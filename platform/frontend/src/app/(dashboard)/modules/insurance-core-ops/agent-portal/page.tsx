...
/* ═══ Insurance Core Ops — Agent Portal ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "878", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "433", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "892", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "866251549", cells: ["INS-2549", "Agent Portal Item 1", "10/2/2026", "€1649"], status: "active" as const },
    { id: "866255120", cells: ["INS-6120", "Agent Portal Item 2", "25/9/2026", "€5220"], status: "pending" as const },
    { id: "866258691", cells: ["INS-9691", "Agent Portal Item 3", "12/4/2026", "€8791"], status: "completed" as const },
    { id: "866262262", cells: ["INS-4262", "Agent Portal Item 4", "27/11/2026", "€12 362"], status: "warning" as const },
    { id: "866265833", cells: ["INS-7833", "Agent Portal Item 5", "14/6/2026", "€15 933"], status: "active" as const },
];
...
export default function InsuranceCoreOpsAgentPortalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agent Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Agent Portal</p>
                    </div>
                </div>
