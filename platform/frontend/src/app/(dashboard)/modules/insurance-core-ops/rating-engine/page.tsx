...
/* ═══ Insurance Core Ops — Rating Engine ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total", value: "4854", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "389", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "597", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2012177", cells: ["INS-6177", "Rating Engine Item 1", "14/6/2026", "€12 277"], status: "active" as const },
    { id: "2015748", cells: ["INS-9748", "Rating Engine Item 2", "1/1/2026", "€15 848"], status: "pending" as const },
    { id: "2019319", cells: ["INS-4319", "Rating Engine Item 3", "16/8/2026", "€19 419"], status: "completed" as const },
    { id: "2022890", cells: ["INS-7890", "Rating Engine Item 4", "3/3/2026", "€22 990"], status: "warning" as const },
    { id: "2026461", cells: ["INS-2461", "Rating Engine Item 5", "18/10/2026", "€26 561"], status: "active" as const },
];
...
export default function InsuranceCoreOpsRatingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rating Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Insurance Core Ops • Rating Engine</p>
                    </div>
                </div>
