...
const ROWS = [
  { id: "001", c: ["Parking Mgmt Ws-001", "Parking Mgmt Ws Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Parking Mgmt Ws-002", "Parking Mgmt Ws Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Parking Mgmt Ws-003", "Parking Mgmt Ws Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Parking Mgmt Ws-004", "Parking Mgmt Ws Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Parking Mgmt Ws-005", "Parking Mgmt Ws Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Parking Mgmt Ws", ts: "Há 2min", a: "Sistema" },
...
export default function ParkingMgmtWsPage() {
  return (
