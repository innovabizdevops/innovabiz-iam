...
const ROWS = [
  { id: "001", c: ["Quiet Zone-001", "Quiet Zone Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Quiet Zone-002", "Quiet Zone Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Quiet Zone-003", "Quiet Zone Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Quiet Zone-004", "Quiet Zone Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Quiet Zone-005", "Quiet Zone Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Quiet Zone", ts: "Há 2min", a: "Sistema" },
...
export default function QuietZonePage() {
  return (
