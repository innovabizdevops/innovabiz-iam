...
const PAGE = "Environmental Comfort";
const KPIS = [{"l":"Espaços Geridos (m²)","v":"45,200","d":"+3.2%","u":true},{"l":"Ocupação (%)","v":"78.3%","d":"+5.1%","u":true},{"l":"Manutenções/Mês","v":"342","d":"-2.4%","u":false},{"l":"Satisfação (%)","v":"91.2%","d":"+1.8%","u":true}];
const COLS = ["Espaço","Edifício","Andar","Capacidade","Ocupação","Estado"];
const ROWS = [
  { id: "001", c: ["Environmental Comfort-001", "Environmental Comfort Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Environmental Comfort-002", "Environmental Comfort Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Environmental Comfort-003", "Environmental Comfort Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Environmental Comfort-004", "Environmental Comfort Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Environmental Comfort-005", "Environmental Comfort Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Environmental Comfort", ts: "Há 2min", a: "Sistema" },
...
export default function EnvironmentalComfortPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Smart Workspace — iBOS Enterprise</p>
        </div>
