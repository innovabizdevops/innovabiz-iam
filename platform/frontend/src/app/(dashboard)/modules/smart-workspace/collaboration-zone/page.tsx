...
const ROWS = [
  { id: "001", c: ["Collaboration Zone-001", "Collaboration Zone Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Collaboration Zone-002", "Collaboration Zone Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Collaboration Zone-003", "Collaboration Zone Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Collaboration Zone-004", "Collaboration Zone Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Collaboration Zone-005", "Collaboration Zone Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Collaboration Zone", ts: "Há 2min", a: "Sistema" },
