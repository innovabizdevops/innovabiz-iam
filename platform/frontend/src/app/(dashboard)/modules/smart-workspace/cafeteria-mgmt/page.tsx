...
const ROWS = [
  { id: "001", c: ["Cafeteria Mgmt-001", "Cafeteria Mgmt Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Cafeteria Mgmt-002", "Cafeteria Mgmt Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Cafeteria Mgmt-003", "Cafeteria Mgmt Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Cafeteria Mgmt-004", "Cafeteria Mgmt Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Cafeteria Mgmt-005", "Cafeteria Mgmt Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Cafeteria Mgmt", ts: "Há 2min", a: "Sistema" },
...
export default function CafeteriaMgmtPage() {
  return (
