...
export default function TidalEnergyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Tidal Energy</h1><p className="text-sm text-muted-foreground">Tidal Energy • iBOS Enterprise</p></div>
