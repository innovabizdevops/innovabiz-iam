...
const PAGE = "Mooring";
const KPIS = [{"l":"Total Tidal Energy","v":"4.353","t":"+6.7%","d":"up"},{"l":"Mooring Ativos","v":"5.425","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"59","t":"+1.3%","d":"up"}];
const COLS = ["ID","Mooring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tidal Energy #001","Tidal Energy #002","6.436","6.695","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Tidal Energy #002","Tidal Energy #003","4.495","5.585","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Tidal Energy #003","Tidal Energy #004","202","6.709","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Tidal Energy #004","Tidal Energy #005","7.315","981","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tidal Energy #005","Tidal Energy #001","336","1.207","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":476},{"label":"Mar","value":409},{"label":"Abr","value":628},{"label":"Mai","value":386},{"label":"Jun","value":553},{"label":"Jul","value":637},{"label":"Ago","value":642},{"label":"Set","value":410},{"label":"Out","value":647},{"label":"Nov","value":592},{"label":"Dez","value":288}];
const MX = 647;
