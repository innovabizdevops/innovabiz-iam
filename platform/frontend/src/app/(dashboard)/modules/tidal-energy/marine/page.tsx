...
const ACCENT = "#6366f1";
const MODULE = "Tidal Energy";
const PAGE = "Marine Bio";
const KPIS = [{"l":"Total Tidal Energy","v":"4.779","t":"+3.6%","d":"up"},{"l":"Marine Bio Ativos","v":"8.626","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"93","t":"+16.7%","d":"up"}];
const COLS = ["ID","Marine Bio","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tidal Energy #001","Tidal Energy #002","6.974","931","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Tidal Energy #002","Tidal Energy #003","2.551","7.330","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Tidal Energy #003","Tidal Energy #004","1.774","7.002","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Tidal Energy #004","Tidal Energy #005","3.855","3.363","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tidal Energy #005","Tidal Energy #001","3.802","5.434","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":701},{"label":"Mar","value":603},{"label":"Abr","value":509},{"label":"Mai","value":436},{"label":"Jun","value":439},{"label":"Jul","value":576},{"label":"Ago","value":562},{"label":"Set","value":517},{"label":"Out","value":490},{"label":"Nov","value":353},{"label":"Dez","value":549}];
const MX = 701;
