...
const PAGE = "Turbine Array";
const KPIS = [{"l":"ARR (€M)","v":"€32.9M","t":"+5.0%","d":"up"},{"l":"MRR (€)","v":"€23916","t":"+11.9%","d":"up"},{"l":"Churn (%)","v":"90.6%","t":"-1.7%","d":"down"},{"l":"ARPU (€)","v":"€27931","t":"-5.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33536.91","8.043","€ 17375.81","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19889.95","5.952","€ 33395.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 49341.09","1.412","€ 40264.98","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46832.37","3.373","€ 15123.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 30417.06","765","€ 47989.71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":534},{"label":"Mar","value":589},{"label":"Abr","value":365},{"label":"Mai","value":423},{"label":"Jun","value":325},{"label":"Jul","value":359},{"label":"Ago","value":439},{"label":"Set","value":362},{"label":"Out","value":271},{"label":"Nov","value":570},{"label":"Dez","value":306}];
const MX = 589;
