...
const ACCENT = "#6366f1";
const MODULE = "Luxury & Fashion";
const PAGE = "Authentication";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.867","t":"-2.0%","d":"down"},{"l":"Sessões/Dia","v":"1175","t":"-3.8%","d":"down"},{"l":"MFA Adoção (%)","v":"88.1%","t":"+14.0%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.927","t":"+9.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.272","7.570","6.774","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.387","8.312","6.276","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.539","6.963","7.796","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","980","3.744","5.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.198","2.404","4.410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":591},{"label":"Mar","value":525},{"label":"Abr","value":826},{"label":"Mai","value":636},{"label":"Jun","value":637},{"label":"Jul","value":709},{"label":"Ago","value":686},{"label":"Set","value":689},{"label":"Out","value":521},{"label":"Nov","value":791},{"label":"Dez","value":877}];
const MX = 877;
