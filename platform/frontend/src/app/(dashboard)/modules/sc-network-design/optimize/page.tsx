...
const ACCENT = "#78350f";
const MODULE = "Supply Network Design";
const PAGE = "Optimize";
const KPIS = [{"l":"Formulários Ativos","v":"2.892","t":"+13.5%","d":"up"},{"l":"Submissões/Dia","v":"2749","t":"-0.1%","d":"down"},{"l":"Documentos Gerados","v":"2.178","t":"+9.1%","d":"up"},{"l":"Templates","v":"6.433","t":"+6.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.061","2026-03-02","2.596","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","786","2026-03-01","8.422","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.529","2026-03-19","7.031","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.279","2026-01-05","4.095","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.037","2026-01-03","3.582","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":1024},{"label":"Mar","value":701},{"label":"Abr","value":943},{"label":"Mai","value":867},{"label":"Jun","value":934},{"label":"Jul","value":1019},{"label":"Ago","value":657},{"label":"Set","value":651},{"label":"Out","value":847},{"label":"Nov","value":644},{"label":"Dez","value":825}];
const MX = 1024;
