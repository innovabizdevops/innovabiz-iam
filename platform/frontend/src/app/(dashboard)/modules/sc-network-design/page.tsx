...
/* ═══ Supply Network Design — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3675", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2401", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€315K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2074944575", cells: ["SC-4575", "Supply Network Design Item 1", "12/12/2026", "€44 675"], status: "active" as const },
    { id: "2074948146", cells: ["SC-8146", "Supply Network Design Item 2", "27/7/2026", "€48 246"], status: "pending" as const },
    { id: "2074951717", cells: ["SC-2717", "Supply Network Design Item 3", "14/2/2026", "€1817"], status: "completed" as const },
    { id: "2074955288", cells: ["SC-6288", "Supply Network Design Item 4", "1/9/2026", "€5388"], status: "warning" as const },
    { id: "2074958859", cells: ["SC-9859", "Supply Network Design Item 5", "16/4/2026", "€8959"], status: "active" as const },
];
...
export default function SupplyNetworkDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supply Network Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supply Network Design</p>
                    </div>
                </div>
