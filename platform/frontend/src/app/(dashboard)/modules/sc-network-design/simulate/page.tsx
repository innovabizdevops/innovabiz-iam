...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"5.310","t":"-5.3%","d":"down"},{"l":"Simulações/Dia","v":"213","t":"+1.5%","d":"up"},{"l":"Precisão Modelo (%)","v":"69.7%","t":"+10.1%","d":"up"},{"l":"Latência Sync (ms)","v":"43ms","t":"+14.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","81.4%","2026-03-21","3.521","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.5%","2026-01-23","3.320","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","76.0%","2026-03-12","6.709","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","76.3%","2026-03-03","379","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","70.2%","2026-01-09","6.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":658},{"label":"Mar","value":397},{"label":"Abr","value":544},{"label":"Mai","value":420},{"label":"Jun","value":602},{"label":"Jul","value":393},{"label":"Ago","value":381},{"label":"Set","value":415},{"label":"Out","value":395},{"label":"Nov","value":727},{"label":"Dez","value":467}];
const MX = 734;
