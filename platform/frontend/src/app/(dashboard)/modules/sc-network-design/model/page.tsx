...
const PAGE = "Model";
const KPIS = [{"l":"Formulários Ativos","v":"5.077","t":"+3.0%","d":"up"},{"l":"Submissões/Dia","v":"3147","t":"+8.8%","d":"up"},{"l":"Documentos Gerados","v":"8.964","t":"+16.5%","d":"up"},{"l":"Templates","v":"7.186","t":"+11.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.101","2026-02-01","1.937","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.769","2026-02-21","4.284","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.912","2026-01-12","8.031","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.824","2026-02-11","8.594","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.499","2026-02-07","7.231","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":992},{"label":"Fev","value":898},{"label":"Mar","value":732},{"label":"Abr","value":937},{"label":"Mai","value":869},{"label":"Jun","value":1020},{"label":"Jul","value":752},{"label":"Ago","value":875},{"label":"Set","value":787},{"label":"Out","value":874},{"label":"Nov","value":853},{"label":"Dez","value":689}];
const MX = 1020;
