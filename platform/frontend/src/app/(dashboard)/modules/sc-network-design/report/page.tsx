...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"7.056","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"3933","t":"+2.6%","d":"up"},{"l":"Documentos Gerados","v":"6.729","t":"+6.4%","d":"up"},{"l":"Templates","v":"8.003","t":"-0.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.401","2026-03-13","890","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.093","2026-03-25","2.839","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.541","2026-03-12","7.361","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.249","2026-03-13","8.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","937","2026-03-27","7.513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":695},{"label":"Mar","value":703},{"label":"Abr","value":912},{"label":"Mai","value":958},{"label":"Jun","value":779},{"label":"Jul","value":973},{"label":"Ago","value":776},{"label":"Set","value":959},{"label":"Out","value":712},{"label":"Nov","value":633},{"label":"Dez","value":627}];
const MX = 973;
