...
const PAGE = "Greenfield";
const KPIS = [{"l":"Formulários Ativos","v":"1.939","t":"+12.5%","d":"up"},{"l":"Submissões/Dia","v":"4470","t":"+11.4%","d":"up"},{"l":"Documentos Gerados","v":"5.044","t":"+17.6%","d":"up"},{"l":"Templates","v":"1.698","t":"+11.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.777","2026-02-20","7.814","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.138","2026-02-12","4.232","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.860","2026-03-22","2.901","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.525","2026-01-02","7.508","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.989","2026-02-04","3.467","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":356},{"label":"Mar","value":340},{"label":"Abr","value":581},{"label":"Mai","value":443},{"label":"Jun","value":499},{"label":"Jul","value":590},{"label":"Ago","value":509},{"label":"Set","value":686},{"label":"Out","value":389},{"label":"Nov","value":433},{"label":"Dez","value":359}];
const MX = 686;
