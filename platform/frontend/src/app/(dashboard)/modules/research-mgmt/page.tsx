...
const KPIS = [
    { label: "Total Registos", value: "8234", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1132", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€286K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1237577434", cells: ["RES-6434", "Research Management Item 1", "3/11/2026", "€27 534"], status: "active" as const },
    { id: "1237581005", cells: ["RES-1005", "Research Management Item 2", "18/6/2026", "€31 105"], status: "pending" as const },
    { id: "1237584576", cells: ["RES-4576", "Research Management Item 3", "5/1/2026", "€34 676"], status: "completed" as const },
    { id: "1237588147", cells: ["RES-8147", "Research Management Item 4", "20/8/2026", "€38 247"], status: "warning" as const },
    { id: "1237591718", cells: ["RES-2718", "Research Management Item 5", "7/3/2026", "€41 818"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Research Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Research Management</p>
                    </div>
                </div>
