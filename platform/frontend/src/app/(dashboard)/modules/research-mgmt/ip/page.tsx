...
const ACCENT = "#7c2d12";
const MODULE = "Research Management";
const PAGE = "IP";
const KPIS = [{"l":"Ideias Submetidas","v":"5.567","t":"+16.9%","d":"up"},{"l":"Patentes (YTD)","v":"8.194","t":"+3.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.242","t":"+10.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€39.1M","t":"+17.0%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.900","99.7%","3.425","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.140","72.8%","3.626","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.351","83.4%","6.676","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.577","78.0%","1.046","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.720","98.2%","5.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":461},{"label":"Mar","value":424},{"label":"Abr","value":538},{"label":"Mai","value":658},{"label":"Jun","value":462},{"label":"Jul","value":464},{"label":"Ago","value":546},{"label":"Set","value":569},{"label":"Out","value":695},{"label":"Nov","value":610},{"label":"Dez","value":493}];
const MX = 748;
