...
const PAGE = "Fund";
const KPIS = [{"l":"Ideias Submetidas","v":"7.674","t":"+4.2%","d":"up"},{"l":"Patentes (YTD)","v":"1.277","t":"-3.1%","d":"down"},{"l":"Projetos Innovation Lab","v":"7.660","t":"-2.4%","d":"down"},{"l":"Budget I&D (€M)","v":"€4.9M","t":"+16.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.761","95.2%","3.500","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.085","91.4%","8.068","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.742","78.8%","266","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.409","77.7%","7.574","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.216","94.6%","515","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":561},{"label":"Mar","value":339},{"label":"Abr","value":577},{"label":"Mai","value":638},{"label":"Jun","value":532},{"label":"Jul","value":510},{"label":"Ago","value":625},{"label":"Set","value":567},{"label":"Out","value":465},{"label":"Nov","value":323},{"label":"Dez","value":360}];
const MX = 646;
