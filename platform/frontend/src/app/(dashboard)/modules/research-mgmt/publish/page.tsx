...
const PAGE = "Publish";
const KPIS = [{"l":"Ideias Submetidas","v":"294","t":"-0.1%","d":"down"},{"l":"Patentes (YTD)","v":"5.184","t":"+0.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.920","t":"+14.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€17.8M","t":"-1.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.194","93.4%","2.740","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.769","82.2%","2.562","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.107","81.3%","7.676","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.678","93.0%","3.665","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","665","82.7%","1.201","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":544},{"label":"Mar","value":513},{"label":"Abr","value":351},{"label":"Mai","value":266},{"label":"Jun","value":511},{"label":"Jul","value":402},{"label":"Ago","value":515},{"label":"Set","value":409},{"label":"Out","value":324},{"label":"Nov","value":371},{"label":"Dez","value":509}];
const MX = 544;
