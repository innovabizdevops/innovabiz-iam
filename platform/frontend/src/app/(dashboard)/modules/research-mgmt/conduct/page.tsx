...
const PAGE = "Conduct";
const KPIS = [{"l":"Ideias Submetidas","v":"5.440","t":"+9.6%","d":"up"},{"l":"Patentes (YTD)","v":"717","t":"+7.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"517","t":"+10.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€6.5M","t":"-1.8%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.951","84.6%","1.935","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.162","92.2%","3.987","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.648","74.4%","5.704","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.959","98.1%","3.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.869","83.5%","3.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":399},{"label":"Mar","value":517},{"label":"Abr","value":695},{"label":"Mai","value":329},{"label":"Jun","value":440},{"label":"Jul","value":410},{"label":"Ago","value":594},{"label":"Set","value":689},{"label":"Out","value":376},{"label":"Nov","value":672},{"label":"Dez","value":418}];
const MX = 695;
