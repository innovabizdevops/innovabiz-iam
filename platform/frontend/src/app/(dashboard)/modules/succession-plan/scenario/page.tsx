...
const PAGE = "Scenario";
const KPIS = [{"l":"eNPS","v":"74","t":"+8.1%","d":"up"},{"l":"Engagement (%)","v":"85.0%","t":"+13.9%","d":"up"},{"l":"Turnover (%)","v":"79.4%","t":"+17.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.096","t":"-2.9%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","705","2026-03-20","55","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.646","2026-02-17","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.662","2026-01-10","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.863","2026-01-17","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.181","2026-01-04","75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":950},{"label":"Mar","value":717},{"label":"Abr","value":709},{"label":"Mai","value":688},{"label":"Jun","value":737},{"label":"Jul","value":641},{"label":"Ago","value":912},{"label":"Set","value":861},{"label":"Out","value":677},{"label":"Nov","value":838},{"label":"Dez","value":1001}];
const MX = 1001;
