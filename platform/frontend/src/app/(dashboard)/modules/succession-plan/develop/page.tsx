...
const KPIS = [{"l":"eNPS","v":"85","t":"+4.5%","d":"up"},{"l":"Engagement (%)","v":"89.6%","t":"-5.7%","d":"down"},{"l":"Turnover (%)","v":"66.8%","t":"+14.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.011","t":"-5.0%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.459","2026-02-26","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.347","2026-01-25","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.136","2026-03-28","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","626","2026-02-11","68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.977","2026-01-27","74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":885},{"label":"Fev","value":1025},{"label":"Mar","value":995},{"label":"Abr","value":1062},{"label":"Mai","value":1065},{"label":"Jun","value":980},{"label":"Jul","value":902},{"label":"Ago","value":740},{"label":"Set","value":837},{"label":"Out","value":803},{"label":"Nov","value":865},{"label":"Dez","value":1038}];
const MX = 1065;
