...
const PAGE = "Report";
const KPIS = [{"l":"eNPS","v":"84","t":"-1.7%","d":"down"},{"l":"Engagement (%)","v":"70.3%","t":"+6.1%","d":"up"},{"l":"Turnover (%)","v":"94.7%","t":"+6.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.287","t":"+15.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.065","2026-03-21","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.486","2026-02-17","92","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.399","2026-03-27","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.250","2026-02-14","58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.502","2026-03-13","60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":649},{"label":"Mar","value":547},{"label":"Abr","value":605},{"label":"Mai","value":451},{"label":"Jun","value":387},{"label":"Jul","value":535},{"label":"Ago","value":613},{"label":"Set","value":743},{"label":"Out","value":387},{"label":"Nov","value":375},{"label":"Dez","value":411}];
const MX = 743;
