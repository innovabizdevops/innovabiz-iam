...
const KPIS = [{"l":"eNPS","v":"57","t":"+12.8%","d":"up"},{"l":"Engagement (%)","v":"75.4%","t":"+16.9%","d":"up"},{"l":"Turnover (%)","v":"77.9%","t":"-2.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"2.524","t":"-2.9%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.651","2026-02-01","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","611","2026-01-12","89","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.223","2026-01-04","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.681","2026-01-25","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.370","2026-01-16","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":683},{"label":"Mar","value":445},{"label":"Abr","value":461},{"label":"Mai","value":756},{"label":"Jun","value":710},{"label":"Jul","value":463},{"label":"Ago","value":382},{"label":"Set","value":465},{"label":"Out","value":597},{"label":"Nov","value":753},{"label":"Dez","value":693}];
const MX = 756;
