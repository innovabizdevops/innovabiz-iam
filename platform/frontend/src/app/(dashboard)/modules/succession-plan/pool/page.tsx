...
const ACCENT = "#6366f1";
const MODULE = "Succession Planning";
const PAGE = "Talent Pool";
const KPIS = [{"l":"eNPS","v":"60","t":"-1.7%","d":"down"},{"l":"Engagement (%)","v":"92.8%","t":"+1.3%","d":"up"},{"l":"Turnover (%)","v":"85.2%","t":"+14.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.651","t":"+9.4%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.972","2026-01-20","75","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.257","2026-03-05","62","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.458","2026-03-24","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.428","2026-01-05","71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.548","2026-03-26","67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":653},{"label":"Mar","value":804},{"label":"Abr","value":699},{"label":"Mai","value":1030},{"label":"Jun","value":841},{"label":"Jul","value":662},{"label":"Ago","value":1024},{"label":"Set","value":886},{"label":"Out","value":926},{"label":"Nov","value":711},{"label":"Dez","value":1019}];
const MX = 1030;
