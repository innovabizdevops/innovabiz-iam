...
const PAGE = "Reserve Estimate";
const KPIS = [{"l":"Total Mine Planning","v":"4.632","t":"+6.7%","d":"up"},{"l":"Reserve Estimate Ativos","v":"7.643","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"83.3%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"69","t":"-5.9%","d":"down"}];
const COLS = ["ID","Reserve Estimate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Planning #001","Mine Planning #002","1.821","5.054","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Planning #002","Mine Planning #003","3.584","6.411","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Planning #003","Mine Planning #004","2.147","8.173","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Planning #004","Mine Planning #005","5.546","5.320","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Planning #005","Mine Planning #001","9.026","2.177","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":796},{"label":"Mar","value":561},{"label":"Abr","value":586},{"label":"Mai","value":788},{"label":"Jun","value":817},{"label":"Jul","value":719},{"label":"Ago","value":440},{"label":"Set","value":790},{"label":"Out","value":604},{"label":"Nov","value":751},{"label":"Dez","value":476}];
const MX = 817;
