...
const PAGE = "Survey GPS";
const KPIS = [{"l":"Surveys Ativos","v":"8.065","t":"+4.9%","d":"up"},{"l":"Respostas/Semana","v":"1400","t":"+11.4%","d":"up"},{"l":"NPS Médio","v":"78","t":"+7.2%","d":"up"},{"l":"Taxa Resposta (%)","v":"71.5%","t":"-0.2%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.324","83","77.8%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","1.220","86","76.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.695","67","78.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.244","61","77.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","2.201","61","84.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":911},{"label":"Mar","value":591},{"label":"Abr","value":703},{"label":"Mai","value":899},{"label":"Jun","value":667},{"label":"Jul","value":877},{"label":"Ago","value":884},{"label":"Set","value":562},{"label":"Out","value":728},{"label":"Nov","value":861},{"label":"Dez","value":934}];
const MX = 934;
