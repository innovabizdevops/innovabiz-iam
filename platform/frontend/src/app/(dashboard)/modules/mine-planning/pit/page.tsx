...
const PAGE = "Pit Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.720","t":"+17.5%","d":"up"},{"l":"Submissões/Dia","v":"3391","t":"+7.0%","d":"up"},{"l":"Documentos Gerados","v":"8.210","t":"+4.8%","d":"up"},{"l":"Templates","v":"7.795","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.751","2026-01-25","6.792","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.005","2026-02-16","5.925","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.160","2026-02-26","7.208","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.641","2026-02-26","1.520","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.046","2026-01-21","8.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":917},{"label":"Mar","value":1012},{"label":"Abr","value":691},{"label":"Mai","value":989},{"label":"Jun","value":1031},{"label":"Jul","value":666},{"label":"Ago","value":700},{"label":"Set","value":771},{"label":"Out","value":996},{"label":"Nov","value":924},{"label":"Dez","value":769}];
const MX = 1031;
