...
const ACCENT = "#38bdf8";
const MODULE = "Road Management";
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"3.745","t":"+14.2%","d":"up"},{"l":"Valor Total (€M)","v":"€5.9M","t":"+10.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€93581","t":"-2.6%","d":"down"},{"l":"Ativos em Garantia","v":"2.123","t":"+1.1%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 18345.97","7.035","€ 2922.64","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 48251.27","1.307","€ 8652.26","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 8948.63","8.769","€ 27313.39","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 902.48","685","€ 28959.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 41323.72","2.205","€ 4385.96","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":734},{"label":"Mar","value":390},{"label":"Abr","value":561},{"label":"Mai","value":611},{"label":"Jun","value":459},{"label":"Jul","value":424},{"label":"Ago","value":395},{"label":"Set","value":405},{"label":"Out","value":616},{"label":"Nov","value":473},{"label":"Dez","value":775}];
const MX = 775;
