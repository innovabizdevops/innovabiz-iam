...
export default function VrEnterprisePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vr Enterprise</h1><p className="text-sm text-muted-foreground">Vr Enterprise • iBOS Enterprise</p></div>
