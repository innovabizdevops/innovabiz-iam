...
const PAGE = "VR Showroom";
const KPIS = [{"l":"Total Vr Enterprise","v":"214","t":"+8.9%","d":"up"},{"l":"VR Showroom Ativos","v":"5.185","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"82.1%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"69","t":"+8.3%","d":"up"}];
const COLS = ["ID","VR Showroom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vr Enterprise #001","Vr Enterprise #002","8.775","5.572","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Vr Enterprise #002","Vr Enterprise #003","2.017","5.105","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Vr Enterprise #003","Vr Enterprise #004","194","2.879","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Vr Enterprise #004","Vr Enterprise #005","3.235","3.466","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vr Enterprise #005","Vr Enterprise #001","6.082","3.210","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":500},{"label":"Mar","value":401},{"label":"Abr","value":408},{"label":"Mai","value":485},{"label":"Jun","value":648},{"label":"Jul","value":593},{"label":"Ago","value":534},{"label":"Set","value":451},{"label":"Out","value":383},{"label":"Nov","value":382},{"label":"Dez","value":384}];
const MX = 648;
