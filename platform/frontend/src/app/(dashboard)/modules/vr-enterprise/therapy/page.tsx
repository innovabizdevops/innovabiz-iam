...
const PAGE = "VR Therapy";
const KPIS = [{"l":"Total Vr Enterprise","v":"1.447","t":"-5.5%","d":"down"},{"l":"VR Therapy Ativos","v":"4.854","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"72.9%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"95","t":"+3.5%","d":"up"}];
const COLS = ["ID","VR Therapy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vr Enterprise #001","Vr Enterprise #002","3.497","7.801","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Vr Enterprise #002","Vr Enterprise #003","3.871","8.074","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Vr Enterprise #003","Vr Enterprise #004","6.573","2.372","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Vr Enterprise #004","Vr Enterprise #005","3.010","3.307","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vr Enterprise #005","Vr Enterprise #001","3.096","3.433","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":693},{"label":"Mar","value":932},{"label":"Abr","value":707},{"label":"Mai","value":1073},{"label":"Jun","value":716},{"label":"Jul","value":782},{"label":"Ago","value":795},{"label":"Set","value":720},{"label":"Out","value":905},{"label":"Nov","value":926},{"label":"Dez","value":849}];
const MX = 1073;
