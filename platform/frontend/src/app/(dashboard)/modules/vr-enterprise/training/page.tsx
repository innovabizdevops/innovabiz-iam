...
const ACCENT = "#059669";
const MODULE = "VR Enterprise";
const PAGE = "VR Training";
const KPIS = [{"l":"Total Vr Enterprise","v":"7.450","t":"+2.9%","d":"up"},{"l":"VR Training Ativos","v":"5.821","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"70.0%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.6%","d":"down"}];
const COLS = ["ID","VR Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vr Enterprise #001","Vr Enterprise #002","5.819","5.323","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Vr Enterprise #002","Vr Enterprise #003","4.208","1.107","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Vr Enterprise #003","Vr Enterprise #004","685","1.847","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Vr Enterprise #004","Vr Enterprise #005","1.035","2.010","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vr Enterprise #005","Vr Enterprise #001","2.419","2.861","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1051},{"label":"Fev","value":914},{"label":"Mar","value":860},{"label":"Abr","value":957},{"label":"Mai","value":672},{"label":"Jun","value":1029},{"label":"Jul","value":744},{"label":"Ago","value":930},{"label":"Set","value":698},{"label":"Out","value":953},{"label":"Nov","value":920},{"label":"Dez","value":893}];
const MX = 1051;
