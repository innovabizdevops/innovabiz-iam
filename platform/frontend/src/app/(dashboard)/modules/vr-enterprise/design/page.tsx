...
const PAGE = "VR Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.207","t":"+4.5%","d":"up"},{"l":"Submissões/Dia","v":"3843","t":"+7.9%","d":"up"},{"l":"Documentos Gerados","v":"7.147","t":"+8.9%","d":"up"},{"l":"Templates","v":"1.553","t":"+13.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.288","2026-03-10","9.077","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.544","2026-01-14","187","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.580","2026-01-01","4.108","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.964","2026-03-12","2.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.896","2026-01-16","7.695","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":639},{"label":"Mar","value":335},{"label":"Abr","value":649},{"label":"Mai","value":357},{"label":"Jun","value":532},{"label":"Jul","value":612},{"label":"Ago","value":302},{"label":"Set","value":626},{"label":"Out","value":571},{"label":"Nov","value":564},{"label":"Dez","value":598}];
const MX = 649;
