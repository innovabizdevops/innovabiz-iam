...
const PAGE = "VR Meeting";
const KPIS = [{"l":"Teams Ativos","v":"4.472","t":"+4.5%","d":"up"},{"l":"Reuniões/Semana","v":"1738","t":"+1.2%","d":"up"},{"l":"Mensagens/Dia","v":"313","t":"+13.6%","d":"up"},{"l":"Ficheiros Partilhados","v":"1.800","t":"+17.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.523","2111","6.014","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.383","1196","8.111","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.107","1605","6.256","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.895","2336","1.572","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.888","3061","4.324","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":588},{"label":"Mar","value":806},{"label":"Abr","value":632},{"label":"Mai","value":678},{"label":"Jun","value":479},{"label":"Jul","value":491},{"label":"Ago","value":522},{"label":"Set","value":668},{"label":"Out","value":698},{"label":"Nov","value":716},{"label":"Dez","value":716}];
const MX = 806;
