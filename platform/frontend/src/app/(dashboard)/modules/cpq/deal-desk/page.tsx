...
const KPIS = [{"l":"Total Cpq","v":"2.828","t":"+2.3%","d":"up"},{"l":"Deal Desk Ativos","v":"2.105","t":"+15.0%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"81","t":"-2.3%","d":"down"}];
const COLS = ["ID","Deal Desk","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cpq #001","Cpq #002","5.846","3.831","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Cpq #002","Cpq #003","3.963","1.761","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cpq #003","Cpq #004","4.452","2.999","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Cpq #004","Cpq #005","1.463","8.636","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cpq #005","Cpq #001","5.897","5.171","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":278},{"label":"Mar","value":390},{"label":"Abr","value":282},{"label":"Mai","value":362},{"label":"Jun","value":295},{"label":"Jul","value":592},{"label":"Ago","value":436},{"label":"Set","value":274},{"label":"Out","value":401},{"label":"Nov","value":518},{"label":"Dez","value":357}];
const MX = 592;
