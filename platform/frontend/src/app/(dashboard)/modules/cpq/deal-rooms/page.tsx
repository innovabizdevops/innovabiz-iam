...
const ACCENT = "#0d9488";
const MODULE = "CPQ";
const PAGE = "Deal Rooms";
const KPIS = [{"l":"Total Cpq","v":"2.402","t":"+6.6%","d":"up"},{"l":"Deal Rooms Ativos","v":"8.952","t":"+10.6%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"57","t":"+5.5%","d":"up"}];
const COLS = ["ID","Deal Rooms","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cpq #001","Cpq #002","2.587","1.968","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Cpq #002","Cpq #003","8.414","4.973","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cpq #003","Cpq #004","936","1.625","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cpq #004","Cpq #005","4.306","1.400","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cpq #005","Cpq #001","8.542","941","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":593},{"label":"Mar","value":746},{"label":"Abr","value":626},{"label":"Mai","value":870},{"label":"Jun","value":824},{"label":"Jul","value":644},{"label":"Ago","value":494},{"label":"Set","value":569},{"label":"Out","value":616},{"label":"Nov","value":644},{"label":"Dez","value":705}];
const MX = 870;
