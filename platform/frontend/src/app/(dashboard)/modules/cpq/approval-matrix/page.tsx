...
const KPIS = [{"l":"Aprovações Pendentes","v":"1.959","t":"+17.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"88.9%","t":"-5.8%","d":"down"},{"l":"Tempo Médio (h)","v":"48h","t":"+10.6%","d":"up"},{"l":"Rejeitadas (%)","v":"75.8%","t":"+11.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","2.949","€ 1646.46","8.433","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","3.528","€ 45597.46","4.415","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","241","€ 43029.85","2.534","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","892","€ 1989.45","5.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","382","€ 15957.55","7.128","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":809},{"label":"Mar","value":999},{"label":"Abr","value":756},{"label":"Mai","value":814},{"label":"Jun","value":889},{"label":"Jul","value":708},{"label":"Ago","value":962},{"label":"Set","value":793},{"label":"Out","value":705},{"label":"Nov","value":801},{"label":"Dez","value":691}];
const MX = 999;
