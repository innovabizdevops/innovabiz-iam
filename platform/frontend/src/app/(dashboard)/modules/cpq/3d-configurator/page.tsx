...
const ACCENT = "#0d9488";
const MODULE = "CPQ";
const PAGE = "3D Configurator";
const KPIS = [{"l":"Configurações","v":"4.214","t":"+13.1%","d":"up"},{"l":"Últimas Alterações","v":"5.309","t":"-5.8%","d":"down"},{"l":"Ambientes","v":"5.834","t":"+9.1%","d":"up"},{"l":"Versão Config","v":"6.087","t":"+10.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 2454.75","3.871","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 38530.82","640","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 31568.75","6.064","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 16742.08","1.831","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 11362.64","1.314","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":496},{"label":"Fev","value":409},{"label":"Mar","value":595},{"label":"Abr","value":400},{"label":"Mai","value":620},{"label":"Jun","value":595},{"label":"Jul","value":473},{"label":"Ago","value":517},{"label":"Set","value":380},{"label":"Out","value":673},{"label":"Nov","value":588},{"label":"Dez","value":304}];
const MX = 673;
...
export default function 3dConfiguratorPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>3D</span></h1>
                </div>
