...
const ACCENT = "#0d9488";
const MODULE = "CPQ";
const PAGE = "Approval Workflows";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.891","t":"+3.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.6%","t":"+11.1%","d":"up"},{"l":"Tempo Médio (h)","v":"16h","t":"+17.7%","d":"up"},{"l":"Rejeitadas (%)","v":"77.6%","t":"+3.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.861","€ 48784.65","3.911","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","2.734","€ 25345.78","7.029","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","7.131","€ 8135.95","3.303","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.400","€ 37233.21","7.598","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","1.203","€ 40973.39","3.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":447},{"label":"Mar","value":261},{"label":"Abr","value":332},{"label":"Mai","value":610},{"label":"Jun","value":328},{"label":"Jul","value":598},{"label":"Ago","value":356},{"label":"Set","value":274},{"label":"Out","value":577},{"label":"Nov","value":434},{"label":"Dez","value":587}];
const MX = 610;
