...
const KPIS = [{"l":"Aprovações Pendentes","v":"3.204","t":"-2.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"79.8%","t":"-1.7%","d":"down"},{"l":"Tempo Médio (h)","v":"141h","t":"+7.6%","d":"up"},{"l":"Rejeitadas (%)","v":"75.9%","t":"-3.7%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.293","€ 8292.57","535","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.233","€ 47716.01","4.698","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.742","€ 34209.20","7.642","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.361","€ 38313.71","4.191","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.202","€ 9452.29","404","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":916},{"label":"Mar","value":876},{"label":"Abr","value":847},{"label":"Mai","value":661},{"label":"Jun","value":819},{"label":"Jul","value":638},{"label":"Ago","value":564},{"label":"Set","value":930},{"label":"Out","value":632},{"label":"Nov","value":841},{"label":"Dez","value":900}];
const MX = 930;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0d9488'}}>Flow</span></h1>
                </div>
