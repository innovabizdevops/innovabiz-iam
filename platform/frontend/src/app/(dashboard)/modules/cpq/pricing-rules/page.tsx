...
const ACCENT = "#0d9488";
const MODULE = "CPQ";
const PAGE = "Pricing Rules Form";
const KPIS = [{"l":"ARR (€M)","v":"€3.8M","t":"+7.7%","d":"up"},{"l":"MRR (€)","v":"€99365","t":"+3.0%","d":"up"},{"l":"Churn (%)","v":"88.3%","t":"+6.2%","d":"up"},{"l":"ARPU (€)","v":"€4769","t":"+13.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 42962.67","7.611","€ 20417.74","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 17509.80","1.487","€ 5038.19","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12291.32","8.299","€ 35375.04","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1255.75","1.739","€ 49724.45","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49346.20","6.215","€ 3013.17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":857},{"label":"Mar","value":680},{"label":"Abr","value":489},{"label":"Mai","value":488},{"label":"Jun","value":775},{"label":"Jul","value":804},{"label":"Ago","value":488},{"label":"Set","value":817},{"label":"Out","value":653},{"label":"Nov","value":711},{"label":"Dez","value":774}];
const MX = 857;
