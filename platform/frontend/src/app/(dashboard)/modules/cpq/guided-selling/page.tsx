...
const KPIS = [{"l":"Artigos Publicados","v":"2.185","t":"-5.0%","d":"down"},{"l":"Views/Semana","v":"3103","t":"+3.4%","d":"up"},{"l":"Feedback Útil (%)","v":"83.0%","t":"+13.7%","d":"up"},{"l":"Artigos Desatualizados","v":"586","t":"+5.4%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.370","77.1%","2.706","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","375","70.5%","5.261","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","6.345","71.8%","8.294","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.691","88.5%","3.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.553","77.0%","8.164","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":606},{"label":"Mar","value":318},{"label":"Abr","value":339},{"label":"Mai","value":302},{"label":"Jun","value":533},{"label":"Jul","value":618},{"label":"Ago","value":546},{"label":"Set","value":380},{"label":"Out","value":289},{"label":"Nov","value":517},{"label":"Dez","value":268}];
const MX = 618;
