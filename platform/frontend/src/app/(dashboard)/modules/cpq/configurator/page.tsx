...
const KPIS = [{"l":"Configurações","v":"1.478","t":"+0.5%","d":"up"},{"l":"Últimas Alterações","v":"1.260","t":"+6.8%","d":"up"},{"l":"Ambientes","v":"4.441","t":"-2.2%","d":"down"},{"l":"Versão Config","v":"8.531","t":"+8.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 834.65","4.067","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 28444.50","7.146","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 47949.37","4.701","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 3375.43","6.875","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 2962.40","8.810","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":621},{"label":"Mar","value":580},{"label":"Abr","value":578},{"label":"Mai","value":708},{"label":"Jun","value":473},{"label":"Jul","value":381},{"label":"Ago","value":689},{"label":"Set","value":394},{"label":"Out","value":419},{"label":"Nov","value":524},{"label":"Dez","value":606}];
const MX = 708;
