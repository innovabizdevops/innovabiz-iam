...
const ACCENT = "#6366f1";
const MODULE = "Factoring & Invoice";
const PAGE = "Verification";
const KPIS = [{"l":"Total Factoring Mgmt","v":"6.592","t":"+12.8%","d":"up"},{"l":"Verification Ativos","v":"2.701","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"80","t":"-5.5%","d":"down"}];
const COLS = ["ID","Verification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Factoring Mgmt #001","Factoring Mgmt #002","3.068","1.515","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Factoring Mgmt #002","Factoring Mgmt #003","1.807","5.280","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Factoring Mgmt #003","Factoring Mgmt #004","4.219","7.611","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Factoring Mgmt #004","Factoring Mgmt #005","2.921","4.516","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Factoring Mgmt #005","Factoring Mgmt #001","357","1.606","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":724},{"label":"Mar","value":740},{"label":"Abr","value":621},{"label":"Mai","value":659},{"label":"Jun","value":761},{"label":"Jul","value":575},{"label":"Ago","value":814},{"label":"Set","value":826},{"label":"Out","value":869},{"label":"Nov","value":552},{"label":"Dez","value":806}];
const MX = 869;
