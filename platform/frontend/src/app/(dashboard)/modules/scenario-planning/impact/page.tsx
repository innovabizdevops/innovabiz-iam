...
const PAGE = "Impact Assessment";
const KPIS = [{"l":"Projetos Sociais","v":"3.866","t":"+16.4%","d":"up"},{"l":"Beneficiários","v":"7.226","t":"+3.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€87423","t":"-4.9%","d":"down"},{"l":"Score Impacto","v":"92","t":"+7.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.058","€ 611.38","3.372","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.472","€ 22426.01","313","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.016","€ 24237.72","3.451","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","559","€ 11315.37","6.242","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.036","€ 23718.64","7.905","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":792},{"label":"Mar","value":899},{"label":"Abr","value":705},{"label":"Mai","value":784},{"label":"Jun","value":691},{"label":"Jul","value":1007},{"label":"Ago","value":780},{"label":"Set","value":793},{"label":"Out","value":740},{"label":"Nov","value":681},{"label":"Dez","value":750}];
const MX = 1007;
