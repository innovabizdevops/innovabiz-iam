...
const PAGE = "Sensitivity Matrix";
const KPIS = [{"l":"Total Scenario Planning","v":"4.179","t":"+12.3%","d":"up"},{"l":"Sensitivity Matrix Ativos","v":"4.728","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+2.2%","d":"up"}];
const COLS = ["ID","Sensitivity Matrix","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scenario Planning #001","Scenario Planning #002","3.593","3.494","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Scenario Planning #002","Scenario Planning #003","3.685","5.437","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Scenario Planning #003","Scenario Planning #004","7.445","1.666","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Scenario Planning #004","Scenario Planning #005","6.793","7.616","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scenario Planning #005","Scenario Planning #001","6.812","3.823","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":657},{"label":"Mar","value":859},{"label":"Abr","value":791},{"label":"Mai","value":632},{"label":"Jun","value":735},{"label":"Jul","value":647},{"label":"Ago","value":720},{"label":"Set","value":747},{"label":"Out","value":738},{"label":"Nov","value":835},{"label":"Dez","value":766}];
const MX = 859;
