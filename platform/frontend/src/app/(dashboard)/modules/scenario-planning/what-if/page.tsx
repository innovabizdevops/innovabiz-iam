...
const PAGE = "What-If Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"7.516","t":"+13.6%","d":"up"},{"l":"Queries/Dia","v":"1858","t":"+10.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.872","t":"+5.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.425","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","446","2026-02-17","4.481","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3121","2026-01-14","212","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3885","2026-02-14","231","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2810","2026-02-19","8.685","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3935","2026-03-12","4.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":795},{"label":"Mar","value":740},{"label":"Abr","value":760},{"label":"Mai","value":570},{"label":"Jun","value":757},{"label":"Jul","value":499},{"label":"Ago","value":850},{"label":"Set","value":831},{"label":"Out","value":734},{"label":"Nov","value":559},{"label":"Dez","value":621}];
const MX = 850;
