...
const ACCENT = "#0891b2";
const MODULE = "Scenario Planning";
const PAGE = "Monte Carlo Sim";
const KPIS = [{"l":"Total Scenario Planning","v":"1.546","t":"+0.4%","d":"up"},{"l":"Monte Carlo Sim Ativos","v":"1.547","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"72","t":"+9.5%","d":"up"}];
const COLS = ["ID","Monte Carlo Sim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scenario Planning #001","Scenario Planning #002","2.026","8.296","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Scenario Planning #002","Scenario Planning #003","4.862","4.062","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Scenario Planning #003","Scenario Planning #004","3.110","4.649","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Scenario Planning #004","Scenario Planning #005","5.699","4.359","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scenario Planning #005","Scenario Planning #001","2.228","446","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":492},{"label":"Mar","value":376},{"label":"Abr","value":416},{"label":"Mai","value":396},{"label":"Jun","value":662},{"label":"Jul","value":374},{"label":"Ago","value":494},{"label":"Set","value":459},{"label":"Out","value":367},{"label":"Nov","value":532},{"label":"Dez","value":385}];
const MX = 662;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Sim</span></h1>
                </div>
