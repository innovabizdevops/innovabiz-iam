...
const PAGE = "Decision Trees";
const KPIS = [{"l":"Aprovações Pendentes","v":"2.597","t":"+8.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.5%","t":"-0.5%","d":"down"},{"l":"Tempo Médio (h)","v":"137h","t":"+0.5%","d":"up"},{"l":"Rejeitadas (%)","v":"77.9%","t":"+18.0%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","4.502","€ 19560.25","8.414","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.523","€ 39403.78","924","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","5.635","€ 29730.95","6.911","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","3.216","€ 23381.36","2.272","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.974","€ 23473.36","9.071","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":247},{"label":"Fev","value":625},{"label":"Mar","value":446},{"label":"Abr","value":596},{"label":"Mai","value":465},{"label":"Jun","value":264},{"label":"Jul","value":449},{"label":"Ago","value":361},{"label":"Set","value":415},{"label":"Out","value":457},{"label":"Nov","value":493},{"label":"Dez","value":380}];
const MX = 625;
