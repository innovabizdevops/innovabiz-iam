...
const PAGE = "Scenario Builder";
const KPIS = [{"l":"Total Scenario Planning","v":"1.100","t":"+5.6%","d":"up"},{"l":"Scenario Builder Ativos","v":"3.934","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"62","t":"+3.6%","d":"up"}];
const COLS = ["ID","Scenario Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Scenario Planning #001","Scenario Planning #002","5.960","6.624","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Scenario Planning #002","Scenario Planning #003","4.761","6.435","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Scenario Planning #003","Scenario Planning #004","1.053","2.795","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Scenario Planning #004","Scenario Planning #005","3.287","6.119","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Scenario Planning #005","Scenario Planning #001","5.243","3.905","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":716},{"label":"Mar","value":636},{"label":"Abr","value":547},{"label":"Mai","value":439},{"label":"Jun","value":604},{"label":"Jul","value":624},{"label":"Ago","value":784},{"label":"Set","value":506},{"label":"Out","value":709},{"label":"Nov","value":745},{"label":"Dez","value":737}];
const MX = 784;
