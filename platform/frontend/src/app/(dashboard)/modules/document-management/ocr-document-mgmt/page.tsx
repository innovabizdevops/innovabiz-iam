...
export default function OcrDocumentMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ocr Document Mgmt</h1><p className="text-sm text-muted-foreground">Document Management • iBOS Enterprise</p></div>
