...
const PAGE = "SOC";
const KPIS = [{"l":"Ideias Submetidas","v":"7.064","t":"-1.5%","d":"down"},{"l":"Patentes (YTD)","v":"5.474","t":"+17.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.609","t":"+0.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€42.8M","t":"+8.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.727","75.8%","4.401","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.426","87.5%","5.872","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.569","80.6%","6.654","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.105","83.6%","4.394","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.779","78.1%","6.278","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":422},{"label":"Mar","value":358},{"label":"Abr","value":498},{"label":"Mai","value":421},{"label":"Jun","value":680},{"label":"Jul","value":470},{"label":"Ago","value":628},{"label":"Set","value":397},{"label":"Out","value":490},{"label":"Nov","value":466},{"label":"Dez","value":463}];
const MX = 680;
