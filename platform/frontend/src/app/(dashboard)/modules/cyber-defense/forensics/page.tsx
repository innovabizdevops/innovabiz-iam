...
const KPIS = [{"l":"Ideias Submetidas","v":"4.404","t":"+6.8%","d":"up"},{"l":"Patentes (YTD)","v":"3.899","t":"+1.2%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.340","t":"+7.0%","d":"up"},{"l":"Budget I&D (€M)","v":"€24.8M","t":"+0.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.952","86.5%","1.483","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.877","97.4%","734","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.183","87.1%","6.541","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.981","74.5%","543","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.438","94.4%","2.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":575},{"label":"Mar","value":699},{"label":"Abr","value":431},{"label":"Mai","value":697},{"label":"Jun","value":635},{"label":"Jul","value":330},{"label":"Ago","value":338},{"label":"Set","value":345},{"label":"Out","value":717},{"label":"Nov","value":706},{"label":"Dez","value":564}];
const MX = 717;
