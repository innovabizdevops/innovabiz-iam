...
const PAGE = "Red Team";
const KPIS = [{"l":"Ideias Submetidas","v":"4.561","t":"+4.3%","d":"up"},{"l":"Patentes (YTD)","v":"4.056","t":"-2.3%","d":"down"},{"l":"Projetos Innovation Lab","v":"8.031","t":"+14.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€1.7M","t":"+0.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","347","72.9%","1.588","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.816","87.0%","1.592","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.664","71.5%","8.823","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.693","99.6%","324","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.513","85.3%","8.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":982},{"label":"Mar","value":1002},{"label":"Abr","value":1001},{"label":"Mai","value":687},{"label":"Jun","value":921},{"label":"Jul","value":689},{"label":"Ago","value":824},{"label":"Set","value":842},{"label":"Out","value":993},{"label":"Nov","value":855},{"label":"Dez","value":844}];
const MX = 1002;
