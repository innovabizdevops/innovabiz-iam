...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"3.044","t":"+15.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"83.4%","t":"-1.5%","d":"down"},{"l":"MTTR (h)","v":"196h","t":"+5.2%","d":"up"},{"l":"Satisfação (%)","v":"76.2%","t":"+12.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.895","7.191","8.527","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.427","7.199","4.753","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.692","7.939","1.861","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.245","4.904","4.877","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.604","5.722","8.933","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":526},{"label":"Mar","value":557},{"label":"Abr","value":624},{"label":"Mai","value":456},{"label":"Jun","value":784},{"label":"Jul","value":747},{"label":"Ago","value":725},{"label":"Set","value":480},{"label":"Out","value":523},{"label":"Nov","value":419},{"label":"Dez","value":522}];
const MX = 784;
