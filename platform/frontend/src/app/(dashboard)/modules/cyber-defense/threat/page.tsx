...
const ACCENT = "#6366f1";
const MODULE = "Cyber Defense";
const PAGE = "Threat Intel";
const KPIS = [{"l":"Ideias Submetidas","v":"658","t":"-2.6%","d":"down"},{"l":"Patentes (YTD)","v":"6.924","t":"+7.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.158","t":"+0.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€8.4M","t":"+17.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.352","81.5%","1.552","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.536","92.5%","1.634","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.378","71.3%","1.590","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.561","78.1%","2.357","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.047","80.6%","4.264","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":552},{"label":"Mar","value":347},{"label":"Abr","value":646},{"label":"Mai","value":354},{"label":"Jun","value":491},{"label":"Jul","value":626},{"label":"Ago","value":456},{"label":"Set","value":526},{"label":"Out","value":494},{"label":"Nov","value":602},{"label":"Dez","value":548}];
const MX = 646;
