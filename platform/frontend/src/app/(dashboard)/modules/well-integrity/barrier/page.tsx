...
const PAGE = "Barrier";
const KPIS = [{"l":"ARR (€M)","v":"€41.0M","t":"-5.4%","d":"down"},{"l":"MRR (€)","v":"€57908","t":"-5.2%","d":"down"},{"l":"Churn (%)","v":"93.2%","t":"+17.2%","d":"up"},{"l":"ARPU (€)","v":"€21106","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 16991.81","8.156","€ 49154.55","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 46431.11","3.563","€ 26618.26","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26063.69","2.812","€ 23675.91","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 17372.98","7.015","€ 8558.45","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29945.50","7.452","€ 6766.91","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":796},{"label":"Mar","value":955},{"label":"Abr","value":787},{"label":"Mai","value":838},{"label":"Jun","value":795},{"label":"Jul","value":712},{"label":"Ago","value":649},{"label":"Set","value":939},{"label":"Out","value":691},{"label":"Nov","value":701},{"label":"Dez","value":773}];
const MX = 955;
