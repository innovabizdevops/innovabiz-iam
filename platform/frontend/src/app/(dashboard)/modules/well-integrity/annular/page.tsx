...
const PAGE = "Annular";
const KPIS = [{"l":"Total Well Integrity","v":"5.773","t":"+12.0%","d":"up"},{"l":"Annular Ativos","v":"3.633","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"87.4%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"89","t":"+12.7%","d":"up"}];
const COLS = ["ID","Annular","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Well Integrity #001","Well Integrity #002","4.412","3.843","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Well Integrity #002","Well Integrity #003","9.054","4.935","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Well Integrity #003","Well Integrity #004","6.898","837","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Well Integrity #004","Well Integrity #005","2.632","7.915","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Well Integrity #005","Well Integrity #001","7.171","4.109","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":849},{"label":"Mar","value":897},{"label":"Abr","value":922},{"label":"Mai","value":691},{"label":"Jun","value":811},{"label":"Jul","value":641},{"label":"Ago","value":694},{"label":"Set","value":826},{"label":"Out","value":785},{"label":"Nov","value":860},{"label":"Dez","value":706}];
const MX = 922;
...
export default function AnnularPage() {
    return (
