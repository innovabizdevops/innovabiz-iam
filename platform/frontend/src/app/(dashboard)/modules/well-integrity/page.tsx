...
export default function WellIntegrityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Well Integrity</h1><p className="text-sm text-muted-foreground">Well Integrity • iBOS Enterprise</p></div>
