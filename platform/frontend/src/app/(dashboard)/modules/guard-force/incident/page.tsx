...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"7.462","t":"-1.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"67.3%","t":"+9.9%","d":"up"},{"l":"MTTR (h)","v":"132h","t":"+16.6%","d":"up"},{"l":"Satisfação (%)","v":"69.8%","t":"+10.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.360","4.413","5.815","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.515","2.359","8.508","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.359","3.151","5.510","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","170","4.864","3.272","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.851","5.755","8.450","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":483},{"label":"Mar","value":719},{"label":"Abr","value":746},{"label":"Mai","value":631},{"label":"Jun","value":581},{"label":"Jul","value":603},{"label":"Ago","value":741},{"label":"Set","value":562},{"label":"Out","value":424},{"label":"Nov","value":634},{"label":"Dez","value":667}];
const MX = 746;
