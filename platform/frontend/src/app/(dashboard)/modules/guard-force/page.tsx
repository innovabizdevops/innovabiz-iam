...
/* ═══ Guard Force Mgmt — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "8034", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1976", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€418K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1657357034", cells: ["GUA-8034", "Guard Force Mgmt Item 1", "19/3/2026", "€7134"], status: "active" as const },
    { id: "1657360605", cells: ["GUA-2605", "Guard Force Mgmt Item 2", "6/10/2026", "€10 705"], status: "pending" as const },
    { id: "1657364176", cells: ["GUA-6176", "Guard Force Mgmt Item 3", "21/5/2026", "€14 276"], status: "completed" as const },
    { id: "1657367747", cells: ["GUA-9747", "Guard Force Mgmt Item 4", "8/12/2026", "€17 847"], status: "warning" as const },
    { id: "1657371318", cells: ["GUA-4318", "Guard Force Mgmt Item 5", "23/7/2026", "€21 418"], status: "active" as const },
];
...
export default function GuardForceMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Guard Force Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Guard Force Mgmt</p>
                    </div>
                </div>
