...
const PAGE = "Officer";
const KPIS = [{"l":"Total Guard Force","v":"941","t":"+0.8%","d":"up"},{"l":"Officer Ativos","v":"3.659","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+14.0%","d":"up"}];
const COLS = ["ID","Officer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guard Force #001","Guard Force #002","2.861","780","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Guard Force #002","Guard Force #003","3.779","3.478","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Guard Force #003","Guard Force #004","5.380","8.181","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Guard Force #004","Guard Force #005","1.450","4.801","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guard Force #005","Guard Force #001","2.092","7.462","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":298},{"label":"Mar","value":343},{"label":"Abr","value":399},{"label":"Mai","value":565},{"label":"Jun","value":516},{"label":"Jul","value":486},{"label":"Ago","value":543},{"label":"Set","value":211},{"label":"Out","value":395},{"label":"Nov","value":367},{"label":"Dez","value":546}];
const MX = 596;
