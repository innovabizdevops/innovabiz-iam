...
const PAGE = "Billing";
const KPIS = [{"l":"Total Guard Force","v":"187","t":"+13.5%","d":"up"},{"l":"Billing Ativos","v":"8.695","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"70.7%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"74","t":"+3.2%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guard Force #001","Guard Force #002","8.803","8.909","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Guard Force #002","Guard Force #003","1.777","3.256","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Guard Force #003","Guard Force #004","4.770","9.100","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Guard Force #004","Guard Force #005","2.924","4.758","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guard Force #005","Guard Force #001","999","9.083","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":948},{"label":"Mar","value":955},{"label":"Abr","value":949},{"label":"Mai","value":793},{"label":"Jun","value":773},{"label":"Jul","value":624},{"label":"Ago","value":706},{"label":"Set","value":784},{"label":"Out","value":809},{"label":"Nov","value":928},{"label":"Dez","value":824}];
const MX = 955;
