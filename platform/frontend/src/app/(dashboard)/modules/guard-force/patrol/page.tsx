...
const ACCENT = "#1e293b";
const MODULE = "Guard Force Mgmt";
const PAGE = "Patrol";
const KPIS = [{"l":"Total Guard Force","v":"6.331","t":"-3.5%","d":"down"},{"l":"Patrol Ativos","v":"1.157","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"87","t":"+9.2%","d":"up"}];
const COLS = ["ID","Patrol","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guard Force #001","Guard Force #002","1.913","5.053","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Guard Force #002","Guard Force #003","1.239","4.416","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Guard Force #003","Guard Force #004","1.496","7.225","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Guard Force #004","Guard Force #005","6.965","6.865","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guard Force #005","Guard Force #001","5.861","6.811","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":413},{"label":"Mar","value":487},{"label":"Abr","value":404},{"label":"Mai","value":715},{"label":"Jun","value":733},{"label":"Jul","value":562},{"label":"Ago","value":386},{"label":"Set","value":374},{"label":"Out","value":750},{"label":"Nov","value":597},{"label":"Dez","value":383}];
const MX = 750;
