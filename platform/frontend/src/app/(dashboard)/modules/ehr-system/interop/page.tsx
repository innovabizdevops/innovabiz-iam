...
const ACCENT = "#6366f1";
const MODULE = "EHR System";
const PAGE = "Interop";
const KPIS = [{"l":"Total Ehr System","v":"5.719","t":"+13.2%","d":"up"},{"l":"Interop Ativos","v":"3.936","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+16.3%","d":"up"}];
const COLS = ["ID","Interop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ehr System #001","Ehr System #002","5.746","6.200","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Ehr System #002","Ehr System #003","5.564","3.659","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Ehr System #003","Ehr System #004","8.149","4.710","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ehr System #004","Ehr System #005","1.085","6.876","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ehr System #005","Ehr System #001","4.483","5.359","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":594},{"label":"Mar","value":541},{"label":"Abr","value":575},{"label":"Mai","value":577},{"label":"Jun","value":691},{"label":"Jul","value":682},{"label":"Ago","value":483},{"label":"Set","value":404},{"label":"Out","value":500},{"label":"Nov","value":590},{"label":"Dez","value":468}];
const MX = 691;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>HL7</span></h1>
                </div>
