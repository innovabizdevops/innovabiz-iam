...
export default function EhrSystemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ehr System</h1><p className="text-sm text-muted-foreground">Ehr System • iBOS Enterprise</p></div>
