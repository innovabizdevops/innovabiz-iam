...
const PAGE = "Fuel Procurement";
const KPIS = [{"l":"Fornecedores Ativos","v":"739","t":"-2.8%","d":"down"},{"l":"Contratos (€M)","v":"€29.7M","t":"+8.9%","d":"up"},{"l":"On-Time Delivery (%)","v":"84.2%","t":"+2.7%","d":"up"},{"l":"Score Médio","v":"81","t":"+10.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","95.9%","€ 2746.03","5.279","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","92.9%","€ 7547.05","636","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","72.7%","€ 2483.75","9.074","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","78.7%","€ 44906.91","1.040","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","71.5%","€ 1790.58","7.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":858},{"label":"Mar","value":826},{"label":"Abr","value":694},{"label":"Mai","value":723},{"label":"Jun","value":1081},{"label":"Jul","value":907},{"label":"Ago","value":850},{"label":"Set","value":825},{"label":"Out","value":779},{"label":"Nov","value":908},{"label":"Dez","value":1057}];
const MX = 1081;
