...
const KPIS = [{"l":"Total Power Plant","v":"6.316","t":"+2.8%","d":"up"},{"l":"Outage Mgmt Ativos","v":"3.523","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"74","t":"-4.3%","d":"down"}];
const COLS = ["ID","Outage Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Power Plant #001","Power Plant #002","1.264","5.641","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Power Plant #002","Power Plant #003","1.623","8.946","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Power Plant #003","Power Plant #004","3.420","7.647","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Power Plant #004","Power Plant #005","221","1.089","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Power Plant #005","Power Plant #001","4.194","732","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":620},{"label":"Mar","value":809},{"label":"Abr","value":909},{"label":"Mai","value":801},{"label":"Jun","value":832},{"label":"Jul","value":845},{"label":"Ago","value":815},{"label":"Set","value":909},{"label":"Out","value":888},{"label":"Nov","value":604},{"label":"Dez","value":831}];
const MX = 909;
