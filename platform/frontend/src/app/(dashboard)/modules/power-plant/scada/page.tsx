...
const PAGE = "SCADA Link";
const KPIS = [{"l":"Dispositivos Online","v":"5.168","t":"+5.7%","d":"up"},{"l":"Dados/Min (MB)","v":"4.393","t":"+10.7%","d":"up"},{"l":"Alertas Ativos","v":"2.373","t":"+0.1%","d":"up"},{"l":"Uptime (%)","v":"65.0%","t":"-0.1%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.024","1.052","5.601","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.913","8.433","8.124","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","637","6.008","6.773","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.297","4.930","596","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.066","2.993","3.744","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":896},{"label":"Mar","value":742},{"label":"Abr","value":626},{"label":"Mai","value":743},{"label":"Jun","value":924},{"label":"Jul","value":901},{"label":"Ago","value":716},{"label":"Set","value":602},{"label":"Out","value":864},{"label":"Nov","value":841},{"label":"Dez","value":719}];
const MX = 924;
