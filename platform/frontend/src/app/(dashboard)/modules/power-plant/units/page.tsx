...
const PAGE = "Unit Control";
const KPIS = [{"l":"Total Power Plant","v":"325","t":"-1.6%","d":"down"},{"l":"Unit Control Ativos","v":"3.885","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"91","t":"+15.4%","d":"up"}];
const COLS = ["ID","Unit Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Power Plant #001","Power Plant #002","8.756","7.054","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Power Plant #002","Power Plant #003","7.166","786","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Power Plant #003","Power Plant #004","6.497","2.550","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Power Plant #004","Power Plant #005","2.215","4.961","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Power Plant #005","Power Plant #001","3.972","7.017","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":351},{"label":"Mar","value":556},{"label":"Abr","value":567},{"label":"Mai","value":528},{"label":"Jun","value":578},{"label":"Jul","value":507},{"label":"Ago","value":677},{"label":"Set","value":506},{"label":"Out","value":532},{"label":"Nov","value":577},{"label":"Dez","value":551}];
const MX = 677;
