...
const PAGE = "Dispatch Sched";
const KPIS = [{"l":"Veículos Operação","v":"4.038","t":"+2.3%","d":"up"},{"l":"Viagens/Dia","v":"4044","t":"+11.9%","d":"up"},{"l":"Pontualidade (%)","v":"79.6%","t":"+12.5%","d":"up"},{"l":"Passageiros/Dia","v":"4125","t":"+17.5%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-27","2026-02-17","5.486","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-20","2026-01-18","2.766","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-04","2026-03-07","7.928","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-18","2026-01-15","1.394","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-07","2026-01-18","1.927","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":424},{"label":"Mar","value":672},{"label":"Abr","value":559},{"label":"Mai","value":729},{"label":"Jun","value":561},{"label":"Jul","value":408},{"label":"Ago","value":393},{"label":"Set","value":499},{"label":"Out","value":733},{"label":"Nov","value":733},{"label":"Dez","value":637}];
const MX = 733;
