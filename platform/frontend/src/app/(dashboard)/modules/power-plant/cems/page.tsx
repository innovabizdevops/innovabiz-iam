...
const ACCENT = "#dc2626";
const MODULE = "Power Plant Ops";
const PAGE = "Emissions CEMS";
const KPIS = [{"l":"Total Power Plant","v":"6.597","t":"+9.8%","d":"up"},{"l":"Emissions CEMS Ativos","v":"969","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"56","t":"+12.7%","d":"up"}];
const COLS = ["ID","Emissions CEMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Power Plant #001","Power Plant #002","3.980","2.050","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Power Plant #002","Power Plant #003","3.868","2.895","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Power Plant #003","Power Plant #004","1.787","5.152","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Power Plant #004","Power Plant #005","2.272","6.665","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Power Plant #005","Power Plant #001","2.850","2.830","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":789},{"label":"Mar","value":800},{"label":"Abr","value":732},{"label":"Mai","value":713},{"label":"Jun","value":485},{"label":"Jul","value":640},{"label":"Ago","value":622},{"label":"Set","value":780},{"label":"Out","value":627},{"label":"Nov","value":665},{"label":"Dez","value":492}];
const MX = 800;
