...
const PAGE = "Heat Rate";
const KPIS = [{"l":"Total Power Plant","v":"7.349","t":"+7.8%","d":"up"},{"l":"Heat Rate Ativos","v":"305","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.5%","d":"up"}];
const COLS = ["ID","Heat Rate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Power Plant #001","Power Plant #002","2.294","4.191","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Power Plant #002","Power Plant #003","6.933","4.979","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Power Plant #003","Power Plant #004","6.045","4.414","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Power Plant #004","Power Plant #005","5.574","8.576","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Power Plant #005","Power Plant #001","6.494","3.698","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":461},{"label":"Mar","value":676},{"label":"Abr","value":785},{"label":"Mai","value":648},{"label":"Jun","value":813},{"label":"Jul","value":594},{"label":"Ago","value":818},{"label":"Set","value":616},{"label":"Out","value":665},{"label":"Nov","value":640},{"label":"Dez","value":771}];
const MX = 818;
...
export default function HeatratePage() {
    return (
