...
/* ═══ Glass & Ceramics — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "2600", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3287", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€61K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1674567700", cells: ["GLA-1700", "Glass & Ceramics Item 1", "9/5/2026", "€17 800"], status: "active" as const },
    { id: "1674571271", cells: ["GLA-5271", "Glass & Ceramics Item 2", "24/12/2026", "€21 371"], status: "pending" as const },
    { id: "1674574842", cells: ["GLA-8842", "Glass & Ceramics Item 3", "11/7/2026", "€24 942"], status: "completed" as const },
    { id: "1674578413", cells: ["GLA-3413", "Glass & Ceramics Item 4", "26/2/2026", "€28 513"], status: "warning" as const },
    { id: "1674581984", cells: ["GLA-6984", "Glass & Ceramics Item 5", "13/9/2026", "€32 084"], status: "active" as const },
];
...
export default function GlassCeramicsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Glass & Ceramics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Glass & Ceramics</p>
                    </div>
                </div>
