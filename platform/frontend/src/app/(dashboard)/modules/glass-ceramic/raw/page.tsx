...
const PAGE = "Raw";
const KPIS = [{"l":"Total Glass Ceramic","v":"2.389","t":"-0.2%","d":"down"},{"l":"Raw Ativos","v":"2.295","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"88","t":"-3.4%","d":"down"}];
const COLS = ["ID","Raw","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Glass Ceramic #001","Glass Ceramic #002","3.197","5.328","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Glass Ceramic #002","Glass Ceramic #003","109","6.833","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Glass Ceramic #003","Glass Ceramic #004","2.920","4.811","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Glass Ceramic #004","Glass Ceramic #005","1.602","8.941","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Glass Ceramic #005","Glass Ceramic #001","2.879","5.926","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":674},{"label":"Mar","value":569},{"label":"Abr","value":482},{"label":"Mai","value":545},{"label":"Jun","value":676},{"label":"Jul","value":432},{"label":"Ago","value":500},{"label":"Set","value":482},{"label":"Out","value":745},{"label":"Nov","value":515},{"label":"Dez","value":664}];
const MX = 745;
