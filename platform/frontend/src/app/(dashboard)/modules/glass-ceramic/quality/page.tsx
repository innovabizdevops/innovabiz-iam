...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.684","t":"-2.3%","d":"down"},{"l":"NC Abertas","v":"4.762","t":"+9.1%","d":"up"},{"l":"Conformidade (%)","v":"66.8%","t":"+13.2%","d":"up"},{"l":"CAPAs Pendentes","v":"8.530","t":"+2.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.508","85.0%","6.377","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.564","97.5%","7.223","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","260","80.8%","8.310","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.225","98.4%","7.903","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.326","89.2%","6.389","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":810},{"label":"Mar","value":698},{"label":"Abr","value":603},{"label":"Mai","value":749},{"label":"Jun","value":794},{"label":"Jul","value":643},{"label":"Ago","value":779},{"label":"Set","value":752},{"label":"Out","value":646},{"label":"Nov","value":607},{"label":"Dez","value":461}];
const MX = 810;
