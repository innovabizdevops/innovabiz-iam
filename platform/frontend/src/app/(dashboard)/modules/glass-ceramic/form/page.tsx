...
const PAGE = "Form";
const KPIS = [{"l":"Formulários Ativos","v":"6.706","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"1433","t":"+9.9%","d":"up"},{"l":"Documentos Gerados","v":"2.076","t":"+14.5%","d":"up"},{"l":"Templates","v":"8.772","t":"+5.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.281","2026-01-16","3.522","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.267","2026-01-19","3.992","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.779","2026-03-28","1.241","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.267","2026-03-05","4.869","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.295","2026-03-06","4.693","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":963},{"label":"Mar","value":864},{"label":"Abr","value":885},{"label":"Mai","value":655},{"label":"Jun","value":877},{"label":"Jul","value":603},{"label":"Ago","value":780},{"label":"Set","value":636},{"label":"Out","value":844},{"label":"Nov","value":863},{"label":"Dez","value":752}];
const MX = 963;
