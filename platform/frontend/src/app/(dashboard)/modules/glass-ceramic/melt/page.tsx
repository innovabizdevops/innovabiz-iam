...
const PAGE = "Melt";
const KPIS = [{"l":"Total Glass Ceramic","v":"7.605","t":"+5.8%","d":"up"},{"l":"Melt Ativos","v":"882","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"71","t":"+15.7%","d":"up"}];
const COLS = ["ID","Melt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Glass Ceramic #001","Glass Ceramic #002","3.732","3.778","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Glass Ceramic #002","Glass Ceramic #003","8.861","4.107","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Glass Ceramic #003","Glass Ceramic #004","6.277","1.939","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Glass Ceramic #004","Glass Ceramic #005","2.895","2.135","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Glass Ceramic #005","Glass Ceramic #001","7.049","6.605","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":248},{"label":"Fev","value":257},{"label":"Mar","value":544},{"label":"Abr","value":289},{"label":"Mai","value":608},{"label":"Jun","value":396},{"label":"Jul","value":571},{"label":"Ago","value":276},{"label":"Set","value":424},{"label":"Out","value":302},{"label":"Nov","value":528},{"label":"Dez","value":487}];
const MX = 608;
