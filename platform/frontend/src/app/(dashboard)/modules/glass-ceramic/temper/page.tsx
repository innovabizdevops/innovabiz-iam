...
const ACCENT = "#0891b2";
const MODULE = "Glass & Ceramics";
const PAGE = "Temper";
const KPIS = [{"l":"Total Glass Ceramic","v":"1.767","t":"+5.7%","d":"up"},{"l":"Temper Ativos","v":"755","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"68.6%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.4%","d":"up"}];
const COLS = ["ID","Temper","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Glass Ceramic #001","Glass Ceramic #002","1.686","8.315","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Glass Ceramic #002","Glass Ceramic #003","3.597","2.350","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Glass Ceramic #003","Glass Ceramic #004","1.744","6.193","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Glass Ceramic #004","Glass Ceramic #005","8.638","5.070","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Glass Ceramic #005","Glass Ceramic #001","878","4.757","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":391},{"label":"Fev","value":571},{"label":"Mar","value":672},{"label":"Abr","value":432},{"label":"Mai","value":335},{"label":"Jun","value":677},{"label":"Jul","value":571},{"label":"Ago","value":617},{"label":"Set","value":414},{"label":"Out","value":600},{"label":"Nov","value":320},{"label":"Dez","value":603}];
const MX = 677;
