...
const ROWS = [
  { id: "001", c: ["Assessment Engine-001", "Assessment Engine Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Assessment Engine-002", "Assessment Engine Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Assessment Engine-003", "Assessment Engine Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Assessment Engine-004", "Assessment Engine Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Assessment Engine-005", "Assessment Engine Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Assessment Engine", ts: "Há 2min", a: "Sistema" },
