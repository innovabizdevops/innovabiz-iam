...
const PAGE = "Compliance Risk Tax";
...
const ROWS = [
  { id: "001", c: ["Compliance Risk Tax-001", "Compliance Risk Tax Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Compliance Risk Tax-002", "Compliance Risk Tax Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Compliance Risk Tax-003", "Compliance Risk Tax Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Compliance Risk Tax-004", "Compliance Risk Tax Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Compliance Risk Tax-005", "Compliance Risk Tax Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Compliance Risk Tax", ts: "Há 2min", a: "Sistema" },
...
export default function ComplianceRiskTaxPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Revenue Authority — iBOS Enterprise</p>
        </div>
