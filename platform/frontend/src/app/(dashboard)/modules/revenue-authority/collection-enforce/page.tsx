...
const ROWS = [
  { id: "001", c: ["Collection Enforce-001", "Collection Enforce Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Collection Enforce-002", "Collection Enforce Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Collection Enforce-003", "Collection Enforce Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Collection Enforce-004", "Collection Enforce Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Collection Enforce-005", "Collection Enforce Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Collection Enforce", ts: "Há 2min", a: "Sistema" },
...
export default function CollectionEnforcePage() {
  return (
