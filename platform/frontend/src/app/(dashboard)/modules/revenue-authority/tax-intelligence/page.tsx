...
const ROWS = [
  { id: "001", c: ["Tax Intelligence-001", "Tax Intelligence Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Tax Intelligence-002", "Tax Intelligence Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Tax Intelligence-003", "Tax Intelligence Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Tax Intelligence-004", "Tax Intelligence Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Tax Intelligence-005", "Tax Intelligence Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Tax Intelligence", ts: "Há 2min", a: "Sistema" },
