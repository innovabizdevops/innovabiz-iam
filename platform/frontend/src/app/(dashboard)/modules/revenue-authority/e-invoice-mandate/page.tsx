...
const ROWS = [
  { id: "001", c: ["E Invoice Mandate-001", "E Invoice Mandate Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["E Invoice Mandate-002", "E Invoice Mandate Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["E Invoice Mandate-003", "E Invoice Mandate Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["E Invoice Mandate-004", "E Invoice Mandate Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["E Invoice Mandate-005", "E Invoice Mandate Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em E Invoice Mandate", ts: "Há 2min", a: "Sistema" },
...
export default function EInvoiceMandatePage() {
  return (
