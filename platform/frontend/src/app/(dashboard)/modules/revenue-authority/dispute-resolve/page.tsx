...
const ROWS = [
  { id: "001", c: ["Dispute Resolve-001", "Dispute Resolve Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Dispute Resolve-002", "Dispute Resolve Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Dispute Resolve-003", "Dispute Resolve Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Dispute Resolve-004", "Dispute Resolve Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Dispute Resolve-005", "Dispute Resolve Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Dispute Resolve", ts: "Há 2min", a: "Sistema" },
