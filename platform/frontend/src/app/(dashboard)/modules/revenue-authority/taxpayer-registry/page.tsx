...
const ROWS = [
  { id: "001", c: ["Taxpayer Registry-001", "Taxpayer Registry Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Taxpayer Registry-002", "Taxpayer Registry Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Taxpayer Registry-003", "Taxpayer Registry Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Taxpayer Registry-004", "Taxpayer Registry Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Taxpayer Registry-005", "Taxpayer Registry Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Taxpayer Registry", ts: "Há 2min", a: "Sistema" },
...
export default function TaxpayerRegistryPage() {
  return (
