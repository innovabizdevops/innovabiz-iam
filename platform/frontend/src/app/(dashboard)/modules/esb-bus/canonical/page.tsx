...
const PAGE = "Canonical Model";
const KPIS = [{"l":"Integrações Ativas","v":"6.936","t":"+1.1%","d":"up"},{"l":"Chamadas/Hora","v":"1792","t":"+17.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.5%","t":"+18.0%","d":"up"},{"l":"Latência Média (ms)","v":"86ms","t":"-1.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.926","5.816","71.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.227","3.115","77.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.456","1.402","79.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","557","7.770","85.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.823","3.517","74.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":618},{"label":"Mar","value":440},{"label":"Abr","value":737},{"label":"Mai","value":473},{"label":"Jun","value":642},{"label":"Jul","value":639},{"label":"Ago","value":698},{"label":"Set","value":659},{"label":"Out","value":775},{"label":"Nov","value":617},{"label":"Dez","value":624}];
const MX = 775;
