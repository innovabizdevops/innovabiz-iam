...
const KPIS = [{"l":"Integrações Ativas","v":"7.917","t":"+4.8%","d":"up"},{"l":"Chamadas/Hora","v":"3819","t":"+1.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.8%","t":"+15.1%","d":"up"},{"l":"Latência Média (ms)","v":"153ms","t":"+9.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.142","8.033","79.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.715","6.096","73.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.324","4.620","71.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.034","2.250","72.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","107","1.519","85.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":251},{"label":"Fev","value":263},{"label":"Mar","value":286},{"label":"Abr","value":514},{"label":"Mai","value":305},{"label":"Jun","value":402},{"label":"Jul","value":271},{"label":"Ago","value":608},{"label":"Set","value":256},{"label":"Out","value":254},{"label":"Nov","value":472},{"label":"Dez","value":316}];
const MX = 608;
