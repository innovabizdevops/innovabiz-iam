...
const PAGE = "Error Queue";
const KPIS = [{"l":"Integrações Ativas","v":"6.693","t":"+11.2%","d":"up"},{"l":"Chamadas/Hora","v":"266","t":"+8.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.1%","t":"-2.1%","d":"down"},{"l":"Latência Média (ms)","v":"188ms","t":"+16.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.892","1.228","85.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.651","7.423","97.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.621","4.059","80.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.221","1.104","95.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.003","8.089","92.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":555},{"label":"Mar","value":415},{"label":"Abr","value":457},{"label":"Mai","value":596},{"label":"Jun","value":532},{"label":"Jul","value":548},{"label":"Ago","value":750},{"label":"Set","value":540},{"label":"Out","value":674},{"label":"Nov","value":688},{"label":"Dez","value":602}];
const MX = 759;
