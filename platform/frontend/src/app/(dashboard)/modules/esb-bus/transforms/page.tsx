...
const ACCENT = "#0e7490";
const MODULE = "Enterprise Service Bus";
const PAGE = "Transformations";
const KPIS = [{"l":"Formulários Ativos","v":"3.830","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"5039","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"2.806","t":"+11.6%","d":"up"},{"l":"Templates","v":"6.905","t":"-4.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.062","2026-03-25","8.121","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.121","2026-03-07","5.174","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.024","2026-02-27","3.746","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.606","2026-01-20","5.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.269","2026-03-25","8.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":665},{"label":"Mar","value":877},{"label":"Abr","value":901},{"label":"Mai","value":672},{"label":"Jun","value":611},{"label":"Jul","value":669},{"label":"Ago","value":576},{"label":"Set","value":759},{"label":"Out","value":705},{"label":"Nov","value":645},{"label":"Dez","value":868}];
const MX = 938;
