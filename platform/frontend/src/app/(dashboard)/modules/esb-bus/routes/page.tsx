...
const PAGE = "Message Routes";
const KPIS = [{"l":"Integrações Ativas","v":"7.991","t":"+14.0%","d":"up"},{"l":"Chamadas/Hora","v":"3788","t":"-1.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.9%","t":"+5.3%","d":"up"},{"l":"Latência Média (ms)","v":"159ms","t":"+16.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.027","6.616","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.773","4.405","74.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.754","4.572","86.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","366","8.915","92.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.688","8.403","95.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":478},{"label":"Mar","value":573},{"label":"Abr","value":562},{"label":"Mai","value":619},{"label":"Jun","value":387},{"label":"Jul","value":576},{"label":"Ago","value":411},{"label":"Set","value":383},{"label":"Out","value":468},{"label":"Nov","value":603},{"label":"Dez","value":414}];
const MX = 619;
