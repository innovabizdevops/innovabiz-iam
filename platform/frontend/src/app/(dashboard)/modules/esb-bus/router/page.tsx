...
const PAGE = "Content Router";
const KPIS = [{"l":"Integrações Ativas","v":"5.701","t":"+5.6%","d":"up"},{"l":"Chamadas/Hora","v":"2670","t":"-2.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"86.5%","t":"+14.3%","d":"up"},{"l":"Latência Média (ms)","v":"151ms","t":"+8.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.630","2.789","78.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.677","2.001","76.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.505","2.593","85.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.960","756","84.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.993","940","91.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":705},{"label":"Mar","value":516},{"label":"Abr","value":391},{"label":"Mai","value":640},{"label":"Jun","value":687},{"label":"Jul","value":466},{"label":"Ago","value":683},{"label":"Set","value":429},{"label":"Out","value":716},{"label":"Nov","value":505},{"label":"Dez","value":467}];
const MX = 716;
