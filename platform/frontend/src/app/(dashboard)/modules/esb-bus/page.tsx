...
export default function EsbBusPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Esb Bus</h1><p className="text-sm text-muted-foreground">Esb Bus • iBOS Enterprise</p></div>
