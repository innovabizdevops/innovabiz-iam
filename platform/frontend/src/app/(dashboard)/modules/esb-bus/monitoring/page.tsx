...
const KPIS = [{"l":"Integrações Ativas","v":"6.652","t":"+9.0%","d":"up"},{"l":"Chamadas/Hora","v":"4035","t":"+3.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.7%","t":"-2.5%","d":"down"},{"l":"Latência Média (ms)","v":"158ms","t":"-3.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.931","2.748","82.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.634","5.746","73.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.446","2.345","86.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","684","2.291","79.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","870","176","90.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":869},{"label":"Mar","value":794},{"label":"Abr","value":698},{"label":"Mai","value":591},{"label":"Jun","value":736},{"label":"Jul","value":823},{"label":"Ago","value":671},{"label":"Set","value":768},{"label":"Out","value":625},{"label":"Nov","value":824},{"label":"Dez","value":553}];
const MX = 875;
