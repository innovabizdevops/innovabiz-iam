...
const PAGE = "Q&amp;A";
const KPIS = [{"l":"Formulários Ativos","v":"8.279","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"2604","t":"-4.0%","d":"down"},{"l":"Documentos Gerados","v":"6.121","t":"+7.3%","d":"up"},{"l":"Templates","v":"5.720","t":"+13.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.100","2026-01-14","3.915","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.072","2026-02-02","7.739","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.333","2026-01-05","709","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.460","2026-03-14","8.056","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.129","2026-03-25","4.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":326},{"label":"Mar","value":416},{"label":"Abr","value":411},{"label":"Mai","value":551},{"label":"Jun","value":580},{"label":"Jul","value":440},{"label":"Ago","value":535},{"label":"Set","value":352},{"label":"Out","value":460},{"label":"Nov","value":452},{"label":"Dez","value":414}];
const MX = 580;
