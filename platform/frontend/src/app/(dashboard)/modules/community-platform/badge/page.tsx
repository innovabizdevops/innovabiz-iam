...
const PAGE = "Badge";
const KPIS = [{"l":"Formulários Ativos","v":"659","t":"+12.5%","d":"up"},{"l":"Submissões/Dia","v":"3032","t":"+15.9%","d":"up"},{"l":"Documentos Gerados","v":"7.709","t":"+6.9%","d":"up"},{"l":"Templates","v":"7.052","t":"+14.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.444","2026-02-03","2.504","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.017","2026-01-15","4.190","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.820","2026-02-19","6.601","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.021","2026-02-07","3.621","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","138","2026-01-28","6.212","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":607},{"label":"Mar","value":916},{"label":"Abr","value":962},{"label":"Mai","value":723},{"label":"Jun","value":612},{"label":"Jul","value":914},{"label":"Ago","value":859},{"label":"Set","value":869},{"label":"Out","value":696},{"label":"Nov","value":826},{"label":"Dez","value":593}];
const MX = 962;
