...
const PAGE = "Idea";
const KPIS = [{"l":"Formulários Ativos","v":"1.107","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"1822","t":"+11.1%","d":"up"},{"l":"Documentos Gerados","v":"6.341","t":"+10.9%","d":"up"},{"l":"Templates","v":"6.938","t":"+10.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.379","2026-03-24","5.654","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.103","2026-01-10","5.464","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.966","2026-02-18","2.444","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.974","2026-03-08","8.072","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.802","2026-02-16","8.331","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":716},{"label":"Mar","value":998},{"label":"Abr","value":1033},{"label":"Mai","value":1025},{"label":"Jun","value":740},{"label":"Jul","value":1030},{"label":"Ago","value":800},{"label":"Set","value":987},{"label":"Out","value":747},{"label":"Nov","value":787},{"label":"Dez","value":864}];
const MX = 1033;
