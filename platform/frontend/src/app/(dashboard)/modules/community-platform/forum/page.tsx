...
const PAGE = "Forum";
const KPIS = [{"l":"Formulários Ativos","v":"7.384","t":"+2.0%","d":"up"},{"l":"Submissões/Dia","v":"1655","t":"+3.1%","d":"up"},{"l":"Documentos Gerados","v":"4.193","t":"+12.2%","d":"up"},{"l":"Templates","v":"4.663","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.441","2026-03-06","3.141","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.522","2026-03-16","8.274","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.376","2026-03-20","5.342","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.874","2026-03-28","5.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.155","2026-02-05","8.661","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":412},{"label":"Mar","value":313},{"label":"Abr","value":643},{"label":"Mai","value":496},{"label":"Jun","value":628},{"label":"Jul","value":497},{"label":"Ago","value":412},{"label":"Set","value":532},{"label":"Out","value":406},{"label":"Nov","value":471},{"label":"Dez","value":430}];
const MX = 643;
