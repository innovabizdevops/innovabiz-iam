...
/* ═══ Community Platform Deep — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8062", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "267", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€401K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1014193662", cells: ["COM-2662", "Community Platform Deep Item 1", "7/7/2026", "€43 762"], status: "active" as const },
    { id: "1014197233", cells: ["COM-6233", "Community Platform Deep Item 2", "22/2/2026", "€47 333"], status: "pending" as const },
    { id: "1014200804", cells: ["COM-9804", "Community Platform Deep Item 3", "9/9/2026", "€904"], status: "completed" as const },
    { id: "1014204375", cells: ["COM-4375", "Community Platform Deep Item 4", "24/4/2026", "€4475"], status: "warning" as const },
    { id: "1014207946", cells: ["COM-7946", "Community Platform Deep Item 5", "11/11/2026", "€8046"], status: "active" as const },
];
...
export default function CommunityPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Community Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Community Platform Deep</p>
                    </div>
                </div>
