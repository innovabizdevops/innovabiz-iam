...
const ACCENT = "#059669";
const MODULE = "Community Platform Deep";
const PAGE = "Moderate";
const KPIS = [{"l":"Formulários Ativos","v":"429","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"1155","t":"+7.2%","d":"up"},{"l":"Documentos Gerados","v":"8.026","t":"+15.4%","d":"up"},{"l":"Templates","v":"4.007","t":"+3.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","994","2026-02-15","7.723","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.215","2026-01-04","2.394","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","785","2026-03-14","3.716","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.926","2026-02-26","461","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","932","2026-03-23","8.667","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":481},{"label":"Mar","value":305},{"label":"Abr","value":442},{"label":"Mai","value":600},{"label":"Jun","value":345},{"label":"Jul","value":540},{"label":"Ago","value":493},{"label":"Set","value":412},{"label":"Out","value":613},{"label":"Nov","value":534},{"label":"Dez","value":583}];
const MX = 613;
