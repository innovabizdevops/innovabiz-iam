...
/* ═══ Food Quality — Supplier Audit Food ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4582", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "362", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2958", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "81%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1193711174", cells: ["FOO-6174", "Supplier Audit Food Item 1", "27/3/2026", "€11 274"], status: "active" as const },
    { id: "1193714745", cells: ["FOO-9745", "Supplier Audit Food Item 2", "14/10/2026", "€14 845"], status: "pending" as const },
    { id: "1193718316", cells: ["FOO-4316", "Supplier Audit Food Item 3", "1/5/2026", "€18 416"], status: "completed" as const },
    { id: "1193721887", cells: ["FOO-7887", "Supplier Audit Food Item 4", "16/12/2026", "€21 987"], status: "warning" as const },
    { id: "1193725458", cells: ["FOO-2458", "Supplier Audit Food Item 5", "3/7/2026", "€25 558"], status: "active" as const },
];
...
export default function FoodQualitySupplierAuditFoodPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supplier Audit Food</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Supplier Audit Food</p>
                    </div>
                </div>
