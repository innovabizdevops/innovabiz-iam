...
/* ═══ Food Quality — Cold Chain Monitor ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1438", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "200", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3730", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "91%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1446414084", cells: ["FOO-7084", "Cold Chain Monitor Item 1", "25/1/2026", "€14 184"], status: "active" as const },
    { id: "1446417655", cells: ["FOO-1655", "Cold Chain Monitor Item 2", "12/8/2026", "€17 755"], status: "pending" as const },
    { id: "1446421226", cells: ["FOO-5226", "Cold Chain Monitor Item 3", "27/3/2026", "€21 326"], status: "completed" as const },
    { id: "1446424797", cells: ["FOO-8797", "Cold Chain Monitor Item 4", "14/10/2026", "€24 897"], status: "warning" as const },
    { id: "1446428368", cells: ["FOO-3368", "Cold Chain Monitor Item 5", "1/5/2026", "€28 468"], status: "active" as const },
];
...
export default function FoodQualityColdChainMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cold Chain Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Cold Chain Monitor</p>
                    </div>
                </div>
