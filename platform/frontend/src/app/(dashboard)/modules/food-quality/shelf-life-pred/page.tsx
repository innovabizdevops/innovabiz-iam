...
/* ═══ Food Quality — Shelf Life Pred ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "785", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "418", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2445", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "238037774", cells: ["FOO-6774", "Shelf Life Pred Item 1", "3/3/2026", "€37 874"], status: "active" as const },
    { id: "238041345", cells: ["FOO-1345", "Shelf Life Pred Item 2", "18/10/2026", "€41 445"], status: "pending" as const },
    { id: "238044916", cells: ["FOO-4916", "Shelf Life Pred Item 3", "5/5/2026", "€45 016"], status: "completed" as const },
    { id: "238048487", cells: ["FOO-8487", "Shelf Life Pred Item 4", "20/12/2026", "€48 587"], status: "warning" as const },
    { id: "238052058", cells: ["FOO-3058", "Shelf Life Pred Item 5", "7/7/2026", "€2158"], status: "active" as const },
];
...
export default function FoodQualityShelfLifePredPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Shelf Life Pred</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Shelf Life Pred</p>
                    </div>
                </div>
