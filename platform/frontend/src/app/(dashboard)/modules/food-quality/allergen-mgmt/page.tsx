...
/* ═══ Food Quality — Allergen Mgmt ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4146", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "278", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "166", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "559091490", cells: ["FOO-3490", "Allergen Mgmt Item 1", "7/7/2026", "€41 590"], status: "active" as const },
    { id: "559095061", cells: ["FOO-7061", "Allergen Mgmt Item 2", "22/2/2026", "€45 161"], status: "pending" as const },
    { id: "559098632", cells: ["FOO-1632", "Allergen Mgmt Item 3", "9/9/2026", "€48 732"], status: "completed" as const },
    { id: "559102203", cells: ["FOO-5203", "Allergen Mgmt Item 4", "24/4/2026", "€2303"], status: "warning" as const },
    { id: "559105774", cells: ["FOO-8774", "Allergen Mgmt Item 5", "11/11/2026", "€5874"], status: "active" as const },
];
...
export default function FoodQualityAllergenMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Allergen Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Allergen Mgmt</p>
                    </div>
                </div>
