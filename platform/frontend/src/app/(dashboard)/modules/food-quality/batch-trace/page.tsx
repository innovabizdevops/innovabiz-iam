...
/* ═══ Food Quality — Batch Trace ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1057", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "70", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2135", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "882240738", cells: ["FOO-7738", "Batch Trace Item 1", "23/7/2026", "€40 838"], status: "active" as const },
    { id: "882244309", cells: ["FOO-2309", "Batch Trace Item 2", "10/2/2026", "€44 409"], status: "pending" as const },
    { id: "882247880", cells: ["FOO-5880", "Batch Trace Item 3", "25/9/2026", "€47 980"], status: "completed" as const },
    { id: "882251451", cells: ["FOO-9451", "Batch Trace Item 4", "12/4/2026", "€1551"], status: "warning" as const },
    { id: "882255022", cells: ["FOO-4022", "Batch Trace Item 5", "27/11/2026", "€5122"], status: "active" as const },
];
...
export default function FoodQualityBatchTracePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Batch Trace</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Batch Trace</p>
                    </div>
                </div>
