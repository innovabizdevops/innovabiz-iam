...
/* ═══ Food Quality — Haccp Digital ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4144", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "102", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1500", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1600927410", cells: ["FOO-8410", "Haccp Digital Item 1", "27/7/2026", "€27 510"], status: "active" as const },
    { id: "1600930981", cells: ["FOO-2981", "Haccp Digital Item 2", "14/2/2026", "€31 081"], status: "pending" as const },
    { id: "1600934552", cells: ["FOO-6552", "Haccp Digital Item 3", "1/9/2026", "€34 652"], status: "completed" as const },
    { id: "1600938123", cells: ["FOO-1123", "Haccp Digital Item 4", "16/4/2026", "€38 223"], status: "warning" as const },
    { id: "1600941694", cells: ["FOO-4694", "Haccp Digital Item 5", "3/11/2026", "€41 794"], status: "active" as const },
];
...
export default function FoodQualityHaccpDigitalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Haccp Digital</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Haccp Digital</p>
                    </div>
                </div>
