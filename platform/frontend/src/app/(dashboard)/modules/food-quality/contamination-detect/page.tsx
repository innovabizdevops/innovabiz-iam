...
/* ═══ Food Quality — Contamination Detect ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "2977", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "294", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1034", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "89%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "948310642", cells: ["FOO-8642", "Contamination Detect Item 1", "7/11/2026", "€10 742"], status: "active" as const },
    { id: "948314213", cells: ["FOO-3213", "Contamination Detect Item 2", "22/6/2026", "€14 313"], status: "pending" as const },
    { id: "948317784", cells: ["FOO-6784", "Contamination Detect Item 3", "9/1/2026", "€17 884"], status: "completed" as const },
    { id: "948321355", cells: ["FOO-1355", "Contamination Detect Item 4", "24/8/2026", "€21 455"], status: "warning" as const },
    { id: "948324926", cells: ["FOO-4926", "Contamination Detect Item 5", "11/3/2026", "€25 026"], status: "active" as const },
];
...
export default function FoodQualityContaminationDetectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Contamination Detect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Contamination Detect</p>
                    </div>
                </div>
