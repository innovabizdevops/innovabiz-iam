...
/* ═══ Food Quality — Recall Mgmt ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3968", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "241", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2649", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "32186189", cells: ["FOO-3189", "Recall Mgmt Item 1", "22/6/2026", "€36 289"], status: "active" as const },
    { id: "32189760", cells: ["FOO-6760", "Recall Mgmt Item 2", "9/1/2026", "€39 860"], status: "pending" as const },
    { id: "32193331", cells: ["FOO-1331", "Recall Mgmt Item 3", "24/8/2026", "€43 431"], status: "completed" as const },
    { id: "32196902", cells: ["FOO-4902", "Recall Mgmt Item 4", "11/3/2026", "€47 002"], status: "warning" as const },
    { id: "32200473", cells: ["FOO-8473", "Recall Mgmt Item 5", "26/10/2026", "€573"], status: "active" as const },
];
...
export default function FoodQualityRecallMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Recall Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Recall Mgmt</p>
                    </div>
                </div>
