...
/* ═══ Food Quality — Nutrition Label ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "372", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "131", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "152", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "643241711", cells: ["FOO-3711", "Nutrition Label Item 1", "8/12/2026", "€41 811"], status: "active" as const },
    { id: "643245282", cells: ["FOO-7282", "Nutrition Label Item 2", "23/7/2026", "€45 382"], status: "pending" as const },
    { id: "643248853", cells: ["FOO-1853", "Nutrition Label Item 3", "10/2/2026", "€48 953"], status: "completed" as const },
    { id: "643252424", cells: ["FOO-5424", "Nutrition Label Item 4", "25/9/2026", "€2524"], status: "warning" as const },
    { id: "643255995", cells: ["FOO-8995", "Nutrition Label Item 5", "12/4/2026", "€6095"], status: "active" as const },
];
...
export default function FoodQualityNutritionLabelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Nutrition Label</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Nutrition Label</p>
                    </div>
                </div>
