...
/* ═══ Food Quality — Sensory Eval ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "4165", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "58", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1594", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1030797190", cells: ["FOO-1190", "Sensory Eval Item 1", "11/11/2026", "€47 290"], status: "active" as const },
    { id: "1030800761", cells: ["FOO-4761", "Sensory Eval Item 2", "26/6/2026", "€861"], status: "pending" as const },
    { id: "1030804332", cells: ["FOO-8332", "Sensory Eval Item 3", "13/1/2026", "€4432"], status: "completed" as const },
    { id: "1030807903", cells: ["FOO-2903", "Sensory Eval Item 4", "28/8/2026", "€8003"], status: "warning" as const },
    { id: "1030811474", cells: ["FOO-6474", "Sensory Eval Item 5", "15/3/2026", "€11 574"], status: "active" as const },
];
...
export default function FoodQualitySensoryEvalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sensory Eval</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Food Quality • Sensory Eval</p>
                    </div>
                </div>
