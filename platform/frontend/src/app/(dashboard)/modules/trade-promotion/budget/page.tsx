...
const PAGE = "Budget";
const KPIS = [{"l":"Total Trade Promotion","v":"8.967","t":"+5.5%","d":"up"},{"l":"Budget Ativos","v":"€13230","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-5.7%","d":"down"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Promotion #001","€ 7906.86","8.796","795","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Promotion #002","€ 25816.30","6.754","3.729","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Promotion #003","€ 23673.24","7.848","7.549","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Promotion #004","€ 18744.31","2.947","7.537","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Promotion #005","€ 40878.20","5.480","1.699","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":338},{"label":"Mar","value":474},{"label":"Abr","value":304},{"label":"Mai","value":514},{"label":"Jun","value":324},{"label":"Jul","value":262},{"label":"Ago","value":576},{"label":"Set","value":584},{"label":"Out","value":558},{"label":"Nov","value":371},{"label":"Dez","value":446}];
const MX = 584;
