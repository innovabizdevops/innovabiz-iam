...
export default function TradePromotionPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Trade Promotion</h1><p className="text-sm text-muted-foreground">Trade Promotion • iBOS Enterprise</p></div>
