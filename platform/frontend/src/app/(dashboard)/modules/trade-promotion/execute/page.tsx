...
const PAGE = "Execute";
const KPIS = [{"l":"Total Trade Promotion","v":"7.902","t":"-2.0%","d":"down"},{"l":"Execute Ativos","v":"8.272","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"85","t":"+13.5%","d":"up"}];
const COLS = ["ID","Execute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Trade Promotion #001","Trade Promotion #002","6.408","1.816","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Trade Promotion #002","Trade Promotion #003","3.008","1.249","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Trade Promotion #003","Trade Promotion #004","4.727","1.521","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Trade Promotion #004","Trade Promotion #005","8.173","8.805","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Trade Promotion #005","Trade Promotion #001","2.214","5.238","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":795},{"label":"Mar","value":832},{"label":"Abr","value":757},{"label":"Mai","value":747},{"label":"Jun","value":705},{"label":"Jul","value":659},{"label":"Ago","value":764},{"label":"Set","value":577},{"label":"Out","value":751},{"label":"Nov","value":817},{"label":"Dez","value":598}];
const MX = 832;
