...
const PAGE = "Track";
const KPIS = [{"l":"Total Beneficiary Mgmt","v":"7.954","t":"+3.2%","d":"up"},{"l":"Track Ativos","v":"5.533","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"73","t":"+13.5%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beneficiary Mgmt #001","Beneficiary Mgmt #002","5.570","1.299","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Beneficiary Mgmt #002","Beneficiary Mgmt #003","8.663","5.964","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Beneficiary Mgmt #003","Beneficiary Mgmt #004","6.832","1.766","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Beneficiary Mgmt #004","Beneficiary Mgmt #005","8.716","3.524","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beneficiary Mgmt #005","Beneficiary Mgmt #001","287","6.675","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":664},{"label":"Mar","value":754},{"label":"Abr","value":999},{"label":"Mai","value":1011},{"label":"Jun","value":740},{"label":"Jul","value":802},{"label":"Ago","value":971},{"label":"Set","value":714},{"label":"Out","value":934},{"label":"Nov","value":980},{"label":"Dez","value":824}];
const MX = 1011;
