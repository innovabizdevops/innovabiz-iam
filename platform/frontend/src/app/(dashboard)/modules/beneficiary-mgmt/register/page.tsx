...
const PAGE = "Register";
const KPIS = [{"l":"Total Beneficiary Mgmt","v":"3.753","t":"+16.1%","d":"up"},{"l":"Register Ativos","v":"7.940","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+10.2%","d":"up"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beneficiary Mgmt #001","Beneficiary Mgmt #002","8.799","6.993","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Beneficiary Mgmt #002","Beneficiary Mgmt #003","3.548","7.499","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Beneficiary Mgmt #003","Beneficiary Mgmt #004","3.068","6.121","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Beneficiary Mgmt #004","Beneficiary Mgmt #005","8.311","6.307","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beneficiary Mgmt #005","Beneficiary Mgmt #001","5.533","4.204","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":572},{"label":"Mar","value":456},{"label":"Abr","value":418},{"label":"Mai","value":347},{"label":"Jun","value":338},{"label":"Jul","value":474},{"label":"Ago","value":343},{"label":"Set","value":279},{"label":"Out","value":247},{"label":"Nov","value":293},{"label":"Dez","value":413}];
const MX = 572;
