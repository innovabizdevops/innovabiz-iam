...
const PAGE = "Needs";
const KPIS = [{"l":"Total Beneficiary Mgmt","v":"3.926","t":"-4.3%","d":"down"},{"l":"Needs Ativos","v":"811","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"-2.8%","d":"down"},{"l":"Score Performance","v":"61","t":"+17.5%","d":"up"}];
const COLS = ["ID","Needs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beneficiary Mgmt #001","Beneficiary Mgmt #002","6.699","7.487","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Beneficiary Mgmt #002","Beneficiary Mgmt #003","6.915","3.113","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Beneficiary Mgmt #003","Beneficiary Mgmt #004","3.077","6.632","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Beneficiary Mgmt #004","Beneficiary Mgmt #005","6.847","1.333","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beneficiary Mgmt #005","Beneficiary Mgmt #001","8.046","5.258","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":725},{"label":"Mar","value":445},{"label":"Abr","value":732},{"label":"Mai","value":624},{"label":"Jun","value":793},{"label":"Jul","value":635},{"label":"Ago","value":814},{"label":"Set","value":537},{"label":"Out","value":638},{"label":"Nov","value":619},{"label":"Dez","value":813}];
const MX = 814;
