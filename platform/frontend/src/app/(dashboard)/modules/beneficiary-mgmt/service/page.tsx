...
const ACCENT = "#6366f1";
const MODULE = "Beneficiary Mgmt";
const PAGE = "Service";
const KPIS = [{"l":"Total Beneficiary Mgmt","v":"6.824","t":"+2.7%","d":"up"},{"l":"Service Ativos","v":"4.623","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"85.9%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"76","t":"+2.0%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beneficiary Mgmt #001","Beneficiary Mgmt #002","8.215","1.247","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Beneficiary Mgmt #002","Beneficiary Mgmt #003","3.122","4.849","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Beneficiary Mgmt #003","Beneficiary Mgmt #004","6.352","6.878","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Beneficiary Mgmt #004","Beneficiary Mgmt #005","6.865","741","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beneficiary Mgmt #005","Beneficiary Mgmt #001","2.108","9.000","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":512},{"label":"Mar","value":641},{"label":"Abr","value":442},{"label":"Mai","value":455},{"label":"Jun","value":720},{"label":"Jul","value":758},{"label":"Ago","value":596},{"label":"Set","value":419},{"label":"Out","value":602},{"label":"Nov","value":671},{"label":"Dez","value":642}];
const MX = 758;
