...
const PAGE = "Privacy";
const KPIS = [{"l":"Total Beneficiary Mgmt","v":"384","t":"+4.5%","d":"up"},{"l":"Privacy Ativos","v":"2.736","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"70","t":"+12.3%","d":"up"}];
const COLS = ["ID","Privacy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Beneficiary Mgmt #001","Beneficiary Mgmt #002","978","2.629","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Beneficiary Mgmt #002","Beneficiary Mgmt #003","3.837","3.006","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Beneficiary Mgmt #003","Beneficiary Mgmt #004","5.494","6.713","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Beneficiary Mgmt #004","Beneficiary Mgmt #005","6.594","6.248","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Beneficiary Mgmt #005","Beneficiary Mgmt #001","5.258","8.205","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":1064},{"label":"Mar","value":1063},{"label":"Abr","value":1053},{"label":"Mai","value":1000},{"label":"Jun","value":829},{"label":"Jul","value":790},{"label":"Ago","value":756},{"label":"Set","value":969},{"label":"Out","value":863},{"label":"Nov","value":965},{"label":"Dez","value":883}];
const MX = 1064;
