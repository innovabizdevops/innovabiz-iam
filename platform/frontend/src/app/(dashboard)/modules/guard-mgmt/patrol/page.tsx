...
const ACCENT = "#6366f1";
const MODULE = "Guard Management";
const PAGE = "Patrol";
const KPIS = [{"l":"Total Guard Mgmt","v":"4.019","t":"-2.6%","d":"down"},{"l":"Patrol Ativos","v":"2.544","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+8.3%","d":"up"}];
const COLS = ["ID","Patrol","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guard Mgmt #001","Guard Mgmt #002","6.506","8.008","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Guard Mgmt #002","Guard Mgmt #003","8.750","8.026","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Guard Mgmt #003","Guard Mgmt #004","7.169","4.157","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Guard Mgmt #004","Guard Mgmt #005","1.094","6.625","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guard Mgmt #005","Guard Mgmt #001","532","5.896","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":910},{"label":"Fev","value":642},{"label":"Mar","value":837},{"label":"Abr","value":837},{"label":"Mai","value":962},{"label":"Jun","value":822},{"label":"Jul","value":999},{"label":"Ago","value":618},{"label":"Set","value":807},{"label":"Out","value":727},{"label":"Nov","value":622},{"label":"Dez","value":652}];
const MX = 999;
