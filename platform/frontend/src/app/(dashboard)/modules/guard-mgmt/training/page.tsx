...
const PAGE = "Training";
const KPIS = [{"l":"Total Guard Mgmt","v":"4.658","t":"+2.8%","d":"up"},{"l":"Training Ativos","v":"3.233","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"65","t":"+10.2%","d":"up"}];
const COLS = ["ID","Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guard Mgmt #001","Guard Mgmt #002","8.710","2.576","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Guard Mgmt #002","Guard Mgmt #003","4.393","4.734","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Guard Mgmt #003","Guard Mgmt #004","5.964","6.362","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Guard Mgmt #004","Guard Mgmt #005","2.398","8.999","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guard Mgmt #005","Guard Mgmt #001","3.760","1.414","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":532},{"label":"Mar","value":266},{"label":"Abr","value":603},{"label":"Mai","value":397},{"label":"Jun","value":296},{"label":"Jul","value":253},{"label":"Ago","value":441},{"label":"Set","value":518},{"label":"Out","value":578},{"label":"Nov","value":493},{"label":"Dez","value":637}];
const MX = 637;
