...
const PAGE = "Billing";
const KPIS = [{"l":"Total Guard Mgmt","v":"2.339","t":"-2.1%","d":"down"},{"l":"Billing Ativos","v":"7.844","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"90.0%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"73","t":"+12.0%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guard Mgmt #001","Guard Mgmt #002","6.594","3.582","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Guard Mgmt #002","Guard Mgmt #003","353","992","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Guard Mgmt #003","Guard Mgmt #004","5.744","5.748","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Guard Mgmt #004","Guard Mgmt #005","967","2.466","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guard Mgmt #005","Guard Mgmt #001","4.154","5.364","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":445},{"label":"Mar","value":396},{"label":"Abr","value":693},{"label":"Mai","value":610},{"label":"Jun","value":313},{"label":"Jul","value":381},{"label":"Ago","value":538},{"label":"Set","value":661},{"label":"Out","value":445},{"label":"Nov","value":561},{"label":"Dez","value":410}];
const MX = 693;
