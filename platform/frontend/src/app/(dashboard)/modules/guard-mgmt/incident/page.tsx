...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"3.865","t":"+10.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.0%","t":"+14.1%","d":"up"},{"l":"MTTR (h)","v":"130h","t":"+2.4%","d":"up"},{"l":"Satisfação (%)","v":"67.8%","t":"+10.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.564","1.949","4.088","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.249","6.309","731","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.483","1.022","7.379","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.435","2.829","2.283","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.921","1.466","4.928","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":273},{"label":"Mar","value":249},{"label":"Abr","value":535},{"label":"Mai","value":313},{"label":"Jun","value":356},{"label":"Jul","value":409},{"label":"Ago","value":269},{"label":"Set","value":563},{"label":"Out","value":573},{"label":"Nov","value":631},{"label":"Dez","value":403}];
const MX = 631;
