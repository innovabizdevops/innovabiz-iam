...
const PAGE = "Roster";
const KPIS = [{"l":"Total Guard Mgmt","v":"6.873","t":"+1.3%","d":"up"},{"l":"Roster Ativos","v":"7.337","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"91.9%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"72","t":"-2.2%","d":"down"}];
const COLS = ["ID","Roster","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Guard Mgmt #001","Guard Mgmt #002","5.985","3.421","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Guard Mgmt #002","Guard Mgmt #003","5.493","6.776","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Guard Mgmt #003","Guard Mgmt #004","4.946","4.848","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Guard Mgmt #004","Guard Mgmt #005","816","1.285","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Guard Mgmt #005","Guard Mgmt #001","8.640","2.903","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":685},{"label":"Mar","value":516},{"label":"Abr","value":556},{"label":"Mai","value":671},{"label":"Jun","value":417},{"label":"Jul","value":441},{"label":"Ago","value":508},{"label":"Set","value":762},{"label":"Out","value":647},{"label":"Nov","value":550},{"label":"Dez","value":501}];
const MX = 762;
