...
const PAGE = "Corporate";
const KPIS = [{"l":"Ideias Submetidas","v":"737","t":"+6.6%","d":"up"},{"l":"Patentes (YTD)","v":"432","t":"+17.7%","d":"up"},{"l":"Projetos Innovation Lab","v":"9.059","t":"+16.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€21.5M","t":"+0.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.225","78.1%","9.068","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","787","99.2%","8.444","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.785","99.7%","4.057","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.010","98.0%","7.477","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","931","70.0%","6.136","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":741},{"label":"Mar","value":955},{"label":"Abr","value":815},{"label":"Mai","value":847},{"label":"Jun","value":1044},{"label":"Jul","value":710},{"label":"Ago","value":833},{"label":"Set","value":699},{"label":"Out","value":1047},{"label":"Nov","value":935},{"label":"Dez","value":959}];
const MX = 1047;
