...
const PAGE = "Innovation Labs";
const KPIS = [{"l":"Ideias Submetidas","v":"803","t":"+6.7%","d":"up"},{"l":"Patentes (YTD)","v":"2.082","t":"+15.2%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.213","t":"+3.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€37.6M","t":"+0.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.086","79.5%","3.692","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.153","82.7%","1.153","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.835","93.1%","2.073","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.827","72.1%","3.392","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.426","82.1%","7.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":673},{"label":"Mar","value":530},{"label":"Abr","value":515},{"label":"Mai","value":451},{"label":"Jun","value":498},{"label":"Jul","value":693},{"label":"Ago","value":466},{"label":"Set","value":734},{"label":"Out","value":698},{"label":"Nov","value":500},{"label":"Dez","value":742}];
const MX = 772;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#3730a3'}}>New</span></h1>
                </div>
