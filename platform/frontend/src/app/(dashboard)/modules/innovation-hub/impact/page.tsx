...
const PAGE = "Impact";
const KPIS = [{"l":"Ideias Submetidas","v":"718","t":"+5.0%","d":"up"},{"l":"Patentes (YTD)","v":"466","t":"+3.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"9.022","t":"-3.4%","d":"down"},{"l":"Budget I&D (€M)","v":"€22.2M","t":"+0.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","666","89.3%","8.535","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.277","85.9%","1.188","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.229","92.1%","225","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.998","93.5%","3.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.488","99.0%","4.554","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":426},{"label":"Mar","value":550},{"label":"Abr","value":469},{"label":"Mai","value":475},{"label":"Jun","value":640},{"label":"Jul","value":325},{"label":"Ago","value":690},{"label":"Set","value":402},{"label":"Out","value":650},{"label":"Nov","value":655},{"label":"Dez","value":313}];
const MX = 690;
