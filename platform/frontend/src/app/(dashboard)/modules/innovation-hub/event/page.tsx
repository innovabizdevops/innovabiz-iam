...
const PAGE = "Event";
const KPIS = [{"l":"Ideias Submetidas","v":"4.273","t":"+8.8%","d":"up"},{"l":"Patentes (YTD)","v":"4.867","t":"+3.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.468","t":"+9.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€49.4M","t":"+14.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.546","97.9%","4.474","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.500","81.9%","6.854","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.429","85.7%","7.797","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.907","77.7%","3.143","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.020","76.2%","3.960","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":848},{"label":"Mar","value":628},{"label":"Abr","value":850},{"label":"Mai","value":625},{"label":"Jun","value":640},{"label":"Jul","value":709},{"label":"Ago","value":737},{"label":"Set","value":668},{"label":"Out","value":841},{"label":"Nov","value":947},{"label":"Dez","value":622}];
const MX = 947;
