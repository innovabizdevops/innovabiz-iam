...
const PAGE = "Program";
const KPIS = [{"l":"Ideias Submetidas","v":"150","t":"+10.4%","d":"up"},{"l":"Patentes (YTD)","v":"4.361","t":"+13.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.569","t":"-2.4%","d":"down"},{"l":"Budget I&D (€M)","v":"€20.5M","t":"+2.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.709","83.4%","7.948","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","783","83.4%","8.920","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.249","92.5%","1.705","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","9.057","71.3%","2.645","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.337","72.7%","6.736","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":583},{"label":"Mar","value":555},{"label":"Abr","value":681},{"label":"Mai","value":928},{"label":"Jun","value":594},{"label":"Jul","value":655},{"label":"Ago","value":778},{"label":"Set","value":907},{"label":"Out","value":861},{"label":"Nov","value":924},{"label":"Dez","value":619}];
const MX = 928;
