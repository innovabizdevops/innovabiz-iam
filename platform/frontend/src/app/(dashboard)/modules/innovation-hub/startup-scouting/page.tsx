...
const ACCENT = "#3730a3";
const MODULE = "Innovation Hub";
const PAGE = "Startup Scouting AI";
const KPIS = [{"l":"Ideias Submetidas","v":"3.062","t":"+4.1%","d":"up"},{"l":"Patentes (YTD)","v":"5.332","t":"+6.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.750","t":"+8.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€6.3M","t":"+0.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.629","84.8%","2.099","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.125","82.4%","5.959","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.105","96.6%","8.340","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.200","79.1%","3.396","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.872","89.8%","1.635","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":766},{"label":"Mar","value":865},{"label":"Abr","value":883},{"label":"Mai","value":657},{"label":"Jun","value":547},{"label":"Jul","value":621},{"label":"Ago","value":774},{"label":"Set","value":554},{"label":"Out","value":607},{"label":"Nov","value":546},{"label":"Dez","value":592}];
const MX = 883;
...
export default function StartupScoutingPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#3730a3'}}>AI</span></h1>
                </div>
