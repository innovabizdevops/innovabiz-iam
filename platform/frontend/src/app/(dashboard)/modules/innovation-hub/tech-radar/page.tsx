...
const PAGE = "Technology Radar";
const KPIS = [{"l":"Ideias Submetidas","v":"3.842","t":"+16.8%","d":"up"},{"l":"Patentes (YTD)","v":"3.154","t":"+2.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.180","t":"+7.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€5.3M","t":"+0.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.165","72.3%","3.032","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.809","80.1%","4.811","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.076","76.3%","7.773","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","821","98.8%","7.867","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.964","88.4%","4.692","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":927},{"label":"Mar","value":972},{"label":"Abr","value":1015},{"label":"Mai","value":982},{"label":"Jun","value":1001},{"label":"Jul","value":912},{"label":"Ago","value":960},{"label":"Set","value":950},{"label":"Out","value":655},{"label":"Nov","value":708},{"label":"Dez","value":946}];
const MX = 1015;
