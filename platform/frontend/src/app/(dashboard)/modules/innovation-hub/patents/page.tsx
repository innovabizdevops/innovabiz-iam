...
const PAGE = "Patent Tracker";
const KPIS = [{"l":"Ideias Submetidas","v":"1.879","t":"+17.1%","d":"up"},{"l":"Patentes (YTD)","v":"792","t":"+4.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.434","t":"-3.4%","d":"down"},{"l":"Budget I&D (€M)","v":"€28.5M","t":"-2.8%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.481","86.5%","8.643","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.180","70.5%","7.077","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.996","93.6%","8.312","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.407","93.2%","7.711","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.954","74.4%","9.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":530},{"label":"Mar","value":668},{"label":"Abr","value":602},{"label":"Mai","value":551},{"label":"Jun","value":712},{"label":"Jul","value":737},{"label":"Ago","value":663},{"label":"Set","value":575},{"label":"Out","value":575},{"label":"Nov","value":372},{"label":"Dez","value":733}];
const MX = 737;
