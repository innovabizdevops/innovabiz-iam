...
const PAGE = "Hackathon Manager";
const KPIS = [{"l":"Ideias Submetidas","v":"3.796","t":"+11.2%","d":"up"},{"l":"Patentes (YTD)","v":"5.516","t":"+3.5%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.857","t":"-5.5%","d":"down"},{"l":"Budget I&D (€M)","v":"€39.6M","t":"+8.2%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.889","99.0%","436","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","839","82.1%","7.714","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","259","80.4%","6.934","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.684","94.5%","1.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","847","94.2%","3.507","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":725},{"label":"Mar","value":865},{"label":"Abr","value":702},{"label":"Mai","value":726},{"label":"Jun","value":765},{"label":"Jul","value":674},{"label":"Ago","value":854},{"label":"Set","value":933},{"label":"Out","value":806},{"label":"Nov","value":885},{"label":"Dez","value":617}];
const MX = 933;
