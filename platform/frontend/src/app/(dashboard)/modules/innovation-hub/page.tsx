...
const KPIS = [
    { label: "Total Registos", value: "7116", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4258", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€96K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "218846516", cells: ["INN-3516", "Innovation Hub Item 1", "1/9/2026", "€46 616"], status: "active" as const },
    { id: "218850087", cells: ["INN-7087", "Innovation Hub Item 2", "16/4/2026", "€187"], status: "pending" as const },
    { id: "218853658", cells: ["INN-1658", "Innovation Hub Item 3", "3/11/2026", "€3758"], status: "completed" as const },
    { id: "218857229", cells: ["INN-5229", "Innovation Hub Item 4", "18/6/2026", "€7329"], status: "warning" as const },
    { id: "218860800", cells: ["INN-8800", "Innovation Hub Item 5", "5/1/2026", "€10 900"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Innovation Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Innovation Hub</p>
                    </div>
                </div>
