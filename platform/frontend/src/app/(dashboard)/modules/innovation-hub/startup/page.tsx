...
const PAGE = "Startup";
const KPIS = [{"l":"Ideias Submetidas","v":"8.395","t":"-0.4%","d":"down"},{"l":"Patentes (YTD)","v":"810","t":"+4.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.078","t":"+2.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€23.4M","t":"+9.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.371","72.5%","7.902","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","814","77.2%","7.680","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.241","81.9%","7.197","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","319","70.3%","6.164","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","870","70.9%","6.684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":587},{"label":"Mar","value":818},{"label":"Abr","value":975},{"label":"Mai","value":707},{"label":"Jun","value":864},{"label":"Jul","value":939},{"label":"Ago","value":734},{"label":"Set","value":590},{"label":"Out","value":787},{"label":"Nov","value":840},{"label":"Dez","value":619}];
const MX = 975;
