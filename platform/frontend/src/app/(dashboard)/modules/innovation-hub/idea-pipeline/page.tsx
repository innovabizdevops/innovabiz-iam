...
const PAGE = "Idea Pipeline";
const KPIS = [{"l":"Ideias Submetidas","v":"4.451","t":"+2.0%","d":"up"},{"l":"Patentes (YTD)","v":"2.355","t":"+11.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.427","t":"+12.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€31.3M","t":"+13.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.308","73.9%","347","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.517","72.4%","1.406","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.569","82.5%","2.582","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.676","79.3%","4.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.424","81.2%","1.869","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":684},{"label":"Mar","value":840},{"label":"Abr","value":904},{"label":"Mai","value":971},{"label":"Jun","value":676},{"label":"Jul","value":618},{"label":"Ago","value":619},{"label":"Set","value":778},{"label":"Out","value":620},{"label":"Nov","value":780},{"label":"Dez","value":824}];
const MX = 971;
