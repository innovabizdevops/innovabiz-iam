...
const PAGE = "Insight";
const KPIS = [{"l":"Dashboards Ativos","v":"343","t":"+9.0%","d":"up"},{"l":"Queries/Dia","v":"360","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.693","t":"+8.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.850","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2538","2026-02-04","7.599","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4035","2026-01-19","4.853","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3595","2026-03-14","5.405","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1189","2026-02-23","8.201","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4048","2026-03-26","2.583","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":926},{"label":"Fev","value":658},{"label":"Mar","value":718},{"label":"Abr","value":815},{"label":"Mai","value":783},{"label":"Jun","value":963},{"label":"Jul","value":1011},{"label":"Ago","value":931},{"label":"Set","value":790},{"label":"Out","value":915},{"label":"Nov","value":904},{"label":"Dez","value":708}];
const MX = 1011;
