...
const PAGE = "Unify";
const KPIS = [{"l":"Dashboards Ativos","v":"2.075","t":"+2.9%","d":"up"},{"l":"Queries/Dia","v":"3128","t":"-2.0%","d":"down"},{"l":"Dados Processados (GB)","v":"161","t":"+16.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.019","t":"+8.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","711","2026-01-27","7.055","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1533","2026-01-08","6.051","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3607","2026-01-08","4.321","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3803","2026-02-14","3.301","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1781","2026-03-01","7.628","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":316},{"label":"Fev","value":486},{"label":"Mar","value":496},{"label":"Abr","value":281},{"label":"Mai","value":482},{"label":"Jun","value":567},{"label":"Jul","value":507},{"label":"Ago","value":435},{"label":"Set","value":629},{"label":"Out","value":634},{"label":"Nov","value":422},{"label":"Dez","value":423}];
const MX = 634;
