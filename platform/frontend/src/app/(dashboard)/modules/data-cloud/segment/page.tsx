...
const ACCENT = "#00a1e0";
const MODULE = "Data Cloud (CDP)";
const PAGE = "Segment";
const KPIS = [{"l":"Dashboards Ativos","v":"6.039","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"3259","t":"+2.6%","d":"up"},{"l":"Dados Processados (GB)","v":"8.923","t":"+16.4%","d":"up"},{"l":"Utilizadores Analytics","v":"6.030","t":"+1.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1403","2026-02-20","5.372","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2501","2026-03-20","5.000","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2556","2026-03-21","2.507","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1766","2026-03-19","3.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","653","2026-03-05","1.983","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":688},{"label":"Mar","value":396},{"label":"Abr","value":424},{"label":"Mai","value":372},{"label":"Jun","value":567},{"label":"Jul","value":326},{"label":"Ago","value":631},{"label":"Set","value":607},{"label":"Out","value":648},{"label":"Nov","value":408},{"label":"Dez","value":403}];
const MX = 688;
