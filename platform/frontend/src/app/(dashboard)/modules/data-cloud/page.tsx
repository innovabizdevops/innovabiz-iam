...
/* ═══ Data Cloud (CDP) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "7323", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "567", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€365K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "41310023", cells: ["DAT-1023", "Data Cloud (CDP) Item 1", "28/12/2026", "€10 123"], status: "active" as const },
    { id: "41313594", cells: ["DAT-4594", "Data Cloud (CDP) Item 2", "15/7/2026", "€13 694"], status: "pending" as const },
    { id: "41317165", cells: ["DAT-8165", "Data Cloud (CDP) Item 3", "2/2/2026", "€17 265"], status: "completed" as const },
    { id: "41320736", cells: ["DAT-2736", "Data Cloud (CDP) Item 4", "17/9/2026", "€20 836"], status: "warning" as const },
    { id: "41324307", cells: ["DAT-6307", "Data Cloud (CDP) Item 5", "4/4/2026", "€24 407"], status: "active" as const },
];
...
export default function DataCloudCdpPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Cloud (CDP)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Cloud (CDP)</p>
                    </div>
                </div>
