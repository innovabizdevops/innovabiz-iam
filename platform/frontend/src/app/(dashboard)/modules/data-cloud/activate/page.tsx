...
const PAGE = "Activate";
const KPIS = [{"l":"Dashboards Ativos","v":"6.148","t":"+12.6%","d":"up"},{"l":"Queries/Dia","v":"540","t":"+6.5%","d":"up"},{"l":"Dados Processados (GB)","v":"7.203","t":"+13.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.758","t":"+4.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3948","2026-03-13","4.226","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1610","2026-02-08","3.351","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","787","2026-03-20","6.764","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1772","2026-03-16","8.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3890","2026-01-16","234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":629},{"label":"Mar","value":765},{"label":"Abr","value":784},{"label":"Mai","value":695},{"label":"Jun","value":522},{"label":"Jul","value":737},{"label":"Ago","value":536},{"label":"Set","value":832},{"label":"Out","value":789},{"label":"Nov","value":586},{"label":"Dez","value":823}];
const MX = 832;
