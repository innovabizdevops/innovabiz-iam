...
const PAGE = "Ingest";
const KPIS = [{"l":"Dashboards Ativos","v":"6.392","t":"+7.6%","d":"up"},{"l":"Queries/Dia","v":"179","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.115","t":"+13.8%","d":"up"},{"l":"Utilizadores Analytics","v":"934","t":"+4.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","488","2026-03-01","6.889","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","597","2026-02-24","6.049","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1820","2026-02-20","718","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4492","2026-02-11","1.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3465","2026-02-11","4.608","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":476},{"label":"Mar","value":852},{"label":"Abr","value":786},{"label":"Mai","value":715},{"label":"Jun","value":553},{"label":"Jul","value":627},{"label":"Ago","value":729},{"label":"Set","value":556},{"label":"Out","value":707},{"label":"Nov","value":480},{"label":"Dez","value":514}];
const MX = 852;
