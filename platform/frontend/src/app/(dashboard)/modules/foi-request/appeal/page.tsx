...
const PAGE = "Appeal Mgmt";
const KPIS = [{"l":"Total Foi Request","v":"2.094","t":"+13.6%","d":"up"},{"l":"Appeal Mgmt Ativos","v":"2.496","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"64","t":"-1.6%","d":"down"}];
const COLS = ["ID","Appeal Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foi Request #001","Foi Request #002","491","8.148","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Foi Request #002","Foi Request #003","7.482","2.128","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Foi Request #003","Foi Request #004","8.968","2.509","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Foi Request #004","Foi Request #005","2.985","7.742","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foi Request #005","Foi Request #001","6.173","4.955","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":366},{"label":"Mar","value":503},{"label":"Abr","value":599},{"label":"Mai","value":468},{"label":"Jun","value":623},{"label":"Jul","value":338},{"label":"Ago","value":560},{"label":"Set","value":396},{"label":"Out","value":647},{"label":"Nov","value":624},{"label":"Dez","value":343}];
const MX = 655;
