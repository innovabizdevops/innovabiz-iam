...
const PAGE = "Redaction";
const KPIS = [{"l":"Total Foi Request","v":"4.820","t":"+17.7%","d":"up"},{"l":"Redaction Ativos","v":"2.969","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"89","t":"+9.5%","d":"up"}];
const COLS = ["ID","Redaction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foi Request #001","Foi Request #002","5.352","1.642","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Foi Request #002","Foi Request #003","4.608","6.986","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Foi Request #003","Foi Request #004","252","8.393","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Foi Request #004","Foi Request #005","8.333","6.028","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foi Request #005","Foi Request #001","6.053","8.448","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":885},{"label":"Mar","value":832},{"label":"Abr","value":619},{"label":"Mai","value":579},{"label":"Jun","value":808},{"label":"Jul","value":620},{"label":"Ago","value":953},{"label":"Set","value":800},{"label":"Out","value":689},{"label":"Nov","value":791},{"label":"Dez","value":765}];
const MX = 953;
