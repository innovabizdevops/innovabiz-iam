...
const ACCENT = "#7c3aed";
const MODULE = "FOI Request";
const PAGE = "Response Track";
const KPIS = [{"l":"Total Foi Request","v":"838","t":"-1.2%","d":"down"},{"l":"Response Track Ativos","v":"1.074","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"88.5%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+11.1%","d":"up"}];
const COLS = ["ID","Response Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foi Request #001","Foi Request #002","3.817","1.195","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Foi Request #002","Foi Request #003","5.080","5.216","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Foi Request #003","Foi Request #004","4.335","6.920","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Foi Request #004","Foi Request #005","2.637","2.514","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foi Request #005","Foi Request #001","2.472","6.547","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":355},{"label":"Mar","value":586},{"label":"Abr","value":749},{"label":"Mai","value":541},{"label":"Jun","value":404},{"label":"Jul","value":447},{"label":"Ago","value":489},{"label":"Set","value":619},{"label":"Out","value":542},{"label":"Nov","value":628},{"label":"Dez","value":613}];
const MX = 749;
