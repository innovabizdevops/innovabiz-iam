...
const KPIS = [{"l":"Total Foi Request","v":"2.594","t":"+2.1%","d":"up"},{"l":"Publication Ativos","v":"1.040","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"86","t":"-5.0%","d":"down"}];
const COLS = ["ID","Publication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Foi Request #001","Foi Request #002","7.263","2.239","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Foi Request #002","Foi Request #003","6.645","6.417","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Foi Request #003","Foi Request #004","4.977","5.567","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Foi Request #004","Foi Request #005","6.487","3.500","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Foi Request #005","Foi Request #001","287","1.327","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":669},{"label":"Mar","value":426},{"label":"Abr","value":389},{"label":"Mai","value":657},{"label":"Jun","value":654},{"label":"Jul","value":525},{"label":"Ago","value":680},{"label":"Set","value":504},{"label":"Out","value":703},{"label":"Nov","value":605},{"label":"Dez","value":382}];
const MX = 703;
