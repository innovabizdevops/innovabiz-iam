...
const KPIS = [{"l":"Integrações Ativas","v":"2.072","t":"+14.4%","d":"up"},{"l":"Chamadas/Hora","v":"2052","t":"+13.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.9%","t":"+3.4%","d":"up"},{"l":"Latência Média (ms)","v":"125ms","t":"+2.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.757","5.376","81.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.401","3.773","82.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.919","1.807","82.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.901","7.929","98.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.817","6.308","79.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":959},{"label":"Mar","value":929},{"label":"Abr","value":708},{"label":"Mai","value":645},{"label":"Jun","value":961},{"label":"Jul","value":772},{"label":"Ago","value":957},{"label":"Set","value":844},{"label":"Out","value":628},{"label":"Nov","value":711},{"label":"Dez","value":581}];
const MX = 961;
