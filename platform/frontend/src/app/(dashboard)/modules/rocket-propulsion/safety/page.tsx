...
const ACCENT = "#6366f1";
const MODULE = "Rocket Propulsion";
const PAGE = "Safety";
const KPIS = [{"l":"Total Rocket Propulsion","v":"7.872","t":"+13.2%","d":"up"},{"l":"Safety Ativos","v":"7.885","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.0%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rocket Propulsion #001","Rocket Propulsion #002","7.433","6.323","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Rocket Propulsion #002","Rocket Propulsion #003","7.361","1.389","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Rocket Propulsion #003","Rocket Propulsion #004","8.116","8.927","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Rocket Propulsion #004","Rocket Propulsion #005","5.139","8.507","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rocket Propulsion #005","Rocket Propulsion #001","2.869","6.639","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":786},{"label":"Mar","value":603},{"label":"Abr","value":657},{"label":"Mai","value":657},{"label":"Jun","value":817},{"label":"Jul","value":739},{"label":"Ago","value":698},{"label":"Set","value":573},{"label":"Out","value":514},{"label":"Nov","value":440},{"label":"Dez","value":467}];
const MX = 817;
