...
export default function RocketPropulsionPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Rocket Propulsion</h1><p className="text-sm text-muted-foreground">Rocket Propulsion • iBOS Enterprise</p></div>
