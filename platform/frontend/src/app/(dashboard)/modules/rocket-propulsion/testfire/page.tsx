...
const PAGE = "Test Fire";
const KPIS = [{"l":"Total Rocket Propulsion","v":"249","t":"+12.4%","d":"up"},{"l":"Test Fire Ativos","v":"8.584","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+10.5%","d":"up"}];
const COLS = ["ID","Test Fire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rocket Propulsion #001","Rocket Propulsion #002","5.723","2.404","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Rocket Propulsion #002","Rocket Propulsion #003","5.190","4.953","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Rocket Propulsion #003","Rocket Propulsion #004","8.812","909","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Rocket Propulsion #004","Rocket Propulsion #005","9.060","3.633","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rocket Propulsion #005","Rocket Propulsion #001","4.290","954","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":495},{"label":"Mar","value":621},{"label":"Abr","value":462},{"label":"Mai","value":420},{"label":"Jun","value":424},{"label":"Jul","value":591},{"label":"Ago","value":642},{"label":"Set","value":277},{"label":"Out","value":282},{"label":"Nov","value":395},{"label":"Dez","value":404}];
const MX = 642;
