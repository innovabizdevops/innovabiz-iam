...
const PAGE = "Engine";
const KPIS = [{"l":"Total Rocket Propulsion","v":"3.694","t":"+17.0%","d":"up"},{"l":"Engine Ativos","v":"990","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"84","t":"-3.8%","d":"down"}];
const COLS = ["ID","Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rocket Propulsion #001","Rocket Propulsion #002","8.431","8.367","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Rocket Propulsion #002","Rocket Propulsion #003","3.577","8.458","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Rocket Propulsion #003","Rocket Propulsion #004","6.761","7.550","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Rocket Propulsion #004","Rocket Propulsion #005","1.366","8.282","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rocket Propulsion #005","Rocket Propulsion #001","2.204","1.680","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":1001},{"label":"Mar","value":743},{"label":"Abr","value":831},{"label":"Mai","value":802},{"label":"Jun","value":680},{"label":"Jul","value":661},{"label":"Ago","value":927},{"label":"Set","value":790},{"label":"Out","value":730},{"label":"Nov","value":922},{"label":"Dez","value":780}];
const MX = 1001;
