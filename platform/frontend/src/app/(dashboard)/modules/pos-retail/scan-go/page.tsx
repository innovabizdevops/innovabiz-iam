...
const PAGE = "Scan &amp; Go";
const KPIS = [{"l":"Pedidos/Dia","v":"3727","t":"+10.8%","d":"up"},{"l":"GMV (€)","v":"€72372","t":"+5.5%","d":"up"},{"l":"Conversão (%)","v":"88.5%","t":"+6.1%","d":"up"},{"l":"AOV (€)","v":"€57894","t":"+16.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 42442.62","153","855","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 7421.34","6.376","1.429","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 15828.94","1.902","1.759","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20011.27","2.695","2.486","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 7050.12","3.119","2.845","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":844},{"label":"Mar","value":748},{"label":"Abr","value":489},{"label":"Mai","value":627},{"label":"Jun","value":738},{"label":"Jul","value":791},{"label":"Ago","value":539},{"label":"Set","value":679},{"label":"Out","value":724},{"label":"Nov","value":586},{"label":"Dez","value":794}];
const MX = 844;
