...
const PAGE = "Gift Wrap";
const KPIS = [{"l":"Pedidos/Dia","v":"715","t":"-1.0%","d":"down"},{"l":"GMV (€)","v":"€83101","t":"+5.9%","d":"up"},{"l":"Conversão (%)","v":"85.3%","t":"+0.5%","d":"up"},{"l":"AOV (€)","v":"€11186","t":"+2.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 17513.00","6.562","5.980","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 6339.12","538","8.500","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 49476.86","2.196","3.031","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 39301.72","2.832","4.600","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 26901.47","7.558","7.497","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":328},{"label":"Mar","value":481},{"label":"Abr","value":415},{"label":"Mai","value":590},{"label":"Jun","value":206},{"label":"Jul","value":406},{"label":"Ago","value":348},{"label":"Set","value":467},{"label":"Out","value":402},{"label":"Nov","value":273},{"label":"Dez","value":552}];
const MX = 590;
