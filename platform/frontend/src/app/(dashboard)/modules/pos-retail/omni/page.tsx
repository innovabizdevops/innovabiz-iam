...
const ACCENT = "#059669";
const MODULE = "POS Retail";
const PAGE = "Omni-Channel";
const KPIS = [{"l":"Pedidos/Dia","v":"4822","t":"-1.7%","d":"down"},{"l":"GMV (€)","v":"€82999","t":"+17.7%","d":"up"},{"l":"Conversão (%)","v":"73.3%","t":"+16.9%","d":"up"},{"l":"AOV (€)","v":"€7528","t":"+4.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 48723.74","4.566","707","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 31890.37","5.614","3.436","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33549.47","3.458","1.655","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 10121.32","3.003","4.274","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 42084.41","3.861","3.025","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":290},{"label":"Mar","value":352},{"label":"Abr","value":366},{"label":"Mai","value":583},{"label":"Jun","value":316},{"label":"Jul","value":265},{"label":"Ago","value":262},{"label":"Set","value":272},{"label":"Out","value":633},{"label":"Nov","value":490},{"label":"Dez","value":457}];
const MX = 633;
