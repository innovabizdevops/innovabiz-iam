...
const KPIS = [{"l":"Tickets Abertos","v":"7.723","t":"+6.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.9%","t":"+14.2%","d":"up"},{"l":"MTTR (h)","v":"172h","t":"-5.6%","d":"down"},{"l":"Satisfação (%)","v":"79.7%","t":"+6.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.456","7.160","3.004","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.748","2.338","5.231","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.215","3.763","2.505","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.487","3.930","8.139","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.789","2.771","4.094","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":477},{"label":"Mar","value":555},{"label":"Abr","value":448},{"label":"Mai","value":549},{"label":"Jun","value":465},{"label":"Jul","value":639},{"label":"Ago","value":413},{"label":"Set","value":715},{"label":"Out","value":659},{"label":"Nov","value":586},{"label":"Dez","value":588}];
const MX = 715;
