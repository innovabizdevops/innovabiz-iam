...
export default function LandWarfarePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Land Warfare</h1><p className="text-sm text-muted-foreground">Land Warfare • iBOS Enterprise</p></div>
