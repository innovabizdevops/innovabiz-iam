...
const PAGE = "Mineral Processing";
const KPIS = [{"l":"Total Mining Ops","v":"1.500","t":"+0.6%","d":"up"},{"l":"Mineral Processing Ativos","v":"8.193","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"89","t":"-1.9%","d":"down"}];
const COLS = ["ID","Mineral Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining Ops #001","Mining Ops #002","3.306","1.491","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Mining Ops #002","Mining Ops #003","3.212","2.306","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining Ops #003","Mining Ops #004","7.513","726","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mining Ops #004","Mining Ops #005","4.194","2.603","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining Ops #005","Mining Ops #001","3.605","8.447","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":563},{"label":"Mar","value":492},{"label":"Abr","value":432},{"label":"Mai","value":759},{"label":"Jun","value":554},{"label":"Jul","value":659},{"label":"Ago","value":577},{"label":"Set","value":472},{"label":"Out","value":742},{"label":"Nov","value":631},{"label":"Dez","value":518}];
const MX = 759;
