...
const PAGE = "Equipment Telemetry";
const KPIS = [{"l":"Total Mining Ops","v":"8.730","t":"+17.1%","d":"up"},{"l":"Equipment Telemetry Ativos","v":"1.409","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.7%","d":"up"}];
const COLS = ["ID","Equipment Telemetry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining Ops #001","Mining Ops #002","663","1.957","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mining Ops #002","Mining Ops #003","1.323","7.724","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining Ops #003","Mining Ops #004","3.010","7.667","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Mining Ops #004","Mining Ops #005","1.716","1.635","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining Ops #005","Mining Ops #001","2.306","3.509","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":631},{"label":"Mar","value":485},{"label":"Abr","value":585},{"label":"Mai","value":638},{"label":"Jun","value":654},{"label":"Jul","value":699},{"label":"Ago","value":800},{"label":"Set","value":529},{"label":"Out","value":832},{"label":"Nov","value":484},{"label":"Dez","value":654}];
const MX = 832;
