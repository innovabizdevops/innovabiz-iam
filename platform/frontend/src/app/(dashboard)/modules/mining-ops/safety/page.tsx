...
const PAGE = "Safety &amp; Permits";
const KPIS = [{"l":"Riscos Identificados","v":"4.542","t":"+16.9%","d":"up"},{"l":"Mitigações Ativas","v":"5.602","t":"+13.2%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+5.9%","d":"up"},{"l":"Incidentes YTD","v":"6.349","t":"+5.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.614","1.349","7.242","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.800","1.314","5.132","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.743","4.775","6.463","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.917","6.874","4.532","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.673","5.091","7.787","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":958},{"label":"Mar","value":1030},{"label":"Abr","value":884},{"label":"Mai","value":716},{"label":"Jun","value":1041},{"label":"Jul","value":847},{"label":"Ago","value":727},{"label":"Set","value":987},{"label":"Out","value":754},{"label":"Nov","value":747},{"label":"Dez","value":834}];
const MX = 1041;
