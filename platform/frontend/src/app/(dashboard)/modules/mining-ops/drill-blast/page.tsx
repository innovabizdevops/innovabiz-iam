...
const PAGE = "Drill &amp; Blast";
const KPIS = [{"l":"Total Mining Ops","v":"2.426","t":"-1.5%","d":"down"},{"l":"Drill & Blast Ativos","v":"1.570","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"77","t":"-1.5%","d":"down"}];
const COLS = ["ID","Drill & Blast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining Ops #001","Mining Ops #002","1.388","5.774","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Mining Ops #002","Mining Ops #003","5.831","6.178","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining Ops #003","Mining Ops #004","6.066","3.524","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mining Ops #004","Mining Ops #005","2.106","4.832","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining Ops #005","Mining Ops #001","7.709","4.366","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":485},{"label":"Mar","value":674},{"label":"Abr","value":362},{"label":"Mai","value":629},{"label":"Jun","value":601},{"label":"Jul","value":502},{"label":"Ago","value":476},{"label":"Set","value":499},{"label":"Out","value":729},{"label":"Nov","value":523},{"label":"Dez","value":733}];
const MX = 733;
...
export default function DrillBlastPage() {
    return (
