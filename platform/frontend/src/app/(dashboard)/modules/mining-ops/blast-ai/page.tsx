...
const PAGE = "Blast Optimization";
const KPIS = [{"l":"Total Mining Ops","v":"4.379","t":"+6.9%","d":"up"},{"l":"Blast Optimization Ativos","v":"8.853","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+0.3%","d":"up"}];
const COLS = ["ID","Blast Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining Ops #001","Mining Ops #002","7.173","3.202","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Mining Ops #002","Mining Ops #003","5.822","5.497","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining Ops #003","Mining Ops #004","2.511","3.081","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mining Ops #004","Mining Ops #005","5.442","1.050","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining Ops #005","Mining Ops #001","1.463","3.011","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":281},{"label":"Mar","value":608},{"label":"Abr","value":494},{"label":"Mai","value":351},{"label":"Jun","value":385},{"label":"Jul","value":243},{"label":"Ago","value":490},{"label":"Set","value":516},{"label":"Out","value":513},{"label":"Nov","value":418},{"label":"Dez","value":603}];
const MX = 608;
...
export default function BlastAiPage() {
    return (
