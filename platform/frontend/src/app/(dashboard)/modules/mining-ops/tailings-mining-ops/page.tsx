...
const ACCENT = "#78350f";
const MODULE = "Mining Operations";
const PAGE = "Tailings Mgmt";
const KPIS = [{"l":"Total Mining Ops","v":"847","t":"+14.5%","d":"up"},{"l":"Tailings Mgmt Ativos","v":"6.408","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.5%","d":"up"}];
const COLS = ["ID","Tailings Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining Ops #001","Mining Ops #002","3.371","2.742","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Mining Ops #002","Mining Ops #003","9.018","6.080","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining Ops #003","Mining Ops #004","583","1.717","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mining Ops #004","Mining Ops #005","4.805","5.891","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining Ops #005","Mining Ops #001","4.711","4.782","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":617},{"label":"Mar","value":672},{"label":"Abr","value":909},{"label":"Mai","value":864},{"label":"Jun","value":874},{"label":"Jul","value":700},{"label":"Ago","value":721},{"label":"Set","value":704},{"label":"Out","value":703},{"label":"Nov","value":900},{"label":"Dez","value":696}];
const MX = 909;
...
export default function TailingsMiningOpsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78350f'}}>ESG</span></h1>
                </div>
