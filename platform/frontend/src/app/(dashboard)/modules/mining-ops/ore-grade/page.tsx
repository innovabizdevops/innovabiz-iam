...
const PAGE = "Ore Grade Control";
const KPIS = [{"l":"Total Mining Ops","v":"6.468","t":"-5.2%","d":"down"},{"l":"Ore Grade Control Ativos","v":"6.789","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"75","t":"+9.2%","d":"up"}];
const COLS = ["ID","Ore Grade Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mining Ops #001","Mining Ops #002","5.440","3.668","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Mining Ops #002","Mining Ops #003","6.716","3.492","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Mining Ops #003","Mining Ops #004","6.663","3.109","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Mining Ops #004","Mining Ops #005","2.749","4.806","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mining Ops #005","Mining Ops #001","5.438","231","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":532},{"label":"Mar","value":583},{"label":"Abr","value":640},{"label":"Mai","value":724},{"label":"Jun","value":721},{"label":"Jul","value":549},{"label":"Ago","value":857},{"label":"Set","value":833},{"label":"Out","value":734},{"label":"Nov","value":788},{"label":"Dez","value":691}];
const MX = 857;
...
export default function OreGradePage() {
    return (
