...
const PAGE = "Tailings Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.895","t":"-2.6%","d":"down"},{"l":"Savings (€)","v":"€30308","t":"+15.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.3%","t":"-4.0%","d":"down"},{"l":"Ciclos PDCA","v":"2.089","t":"+14.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.749","€ 16135.41","7.761","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.054","€ 10341.83","9.095","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.790","€ 25728.30","4.934","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.416","€ 34463.48","476","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.502","€ 12040.19","3.478","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":759},{"label":"Mar","value":769},{"label":"Abr","value":667},{"label":"Mai","value":804},{"label":"Jun","value":810},{"label":"Jul","value":484},{"label":"Ago","value":646},{"label":"Set","value":740},{"label":"Out","value":677},{"label":"Nov","value":561},{"label":"Dez","value":643}];
const MX = 810;
