...
const ACCENT = "#0891b2";
const MODULE = "IoT Platform";
const PAGE = "Security OTA";
const KPIS = [{"l":"Dispositivos Online","v":"6.512","t":"-4.8%","d":"down"},{"l":"Dados/Min (MB)","v":"1.315","t":"+0.4%","d":"up"},{"l":"Alertas Ativos","v":"869","t":"+3.4%","d":"up"},{"l":"Uptime (%)","v":"80.9%","t":"+5.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","582","565","7.001","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.464","7.731","6.359","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.600","4.791","8.960","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.655","6.290","8.085","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.881","2.930","8.135","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":684},{"label":"Mar","value":625},{"label":"Abr","value":454},{"label":"Mai","value":458},{"label":"Jun","value":613},{"label":"Jul","value":628},{"label":"Ago","value":690},{"label":"Set","value":706},{"label":"Out","value":391},{"label":"Nov","value":684},{"label":"Dez","value":495}];
const MX = 706;
...
export default function SecurityOtaPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Zero Trust</span></h1>
                </div>
