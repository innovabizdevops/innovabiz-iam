...
const PAGE = "Device Twins";
const KPIS = [{"l":"Dispositivos Online","v":"5.271","t":"-2.8%","d":"down"},{"l":"Dados/Min (MB)","v":"6.880","t":"+12.3%","d":"up"},{"l":"Alertas Ativos","v":"9.073","t":"+14.7%","d":"up"},{"l":"Uptime (%)","v":"69.5%","t":"+17.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.646","7.525","5.520","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.546","2.985","509","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.721","7.209","2.511","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.291","9.015","3.041","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.588","6.980","4.729","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":547},{"label":"Mar","value":497},{"label":"Abr","value":608},{"label":"Mai","value":585},{"label":"Jun","value":804},{"label":"Jul","value":799},{"label":"Ago","value":515},{"label":"Set","value":826},{"label":"Out","value":842},{"label":"Nov","value":746},{"label":"Dez","value":505}];
const MX = 842;
