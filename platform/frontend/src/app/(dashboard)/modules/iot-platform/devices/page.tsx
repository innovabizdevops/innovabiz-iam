...
const PAGE = "Device Management";
const KPIS = [{"l":"Dispositivos Online","v":"2.848","t":"+16.2%","d":"up"},{"l":"Dados/Min (MB)","v":"658","t":"-4.1%","d":"down"},{"l":"Alertas Ativos","v":"2.444","t":"+2.5%","d":"up"},{"l":"Uptime (%)","v":"66.0%","t":"+6.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.285","5.800","3.118","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.054","2.707","2.517","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.960","3.761","6.278","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.392","1.588","7.364","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.199","7.891","3.945","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":604},{"label":"Mar","value":561},{"label":"Abr","value":487},{"label":"Mai","value":364},{"label":"Jun","value":600},{"label":"Jul","value":500},{"label":"Ago","value":580},{"label":"Set","value":349},{"label":"Out","value":650},{"label":"Nov","value":489},{"label":"Dez","value":369}];
const MX = 650;
