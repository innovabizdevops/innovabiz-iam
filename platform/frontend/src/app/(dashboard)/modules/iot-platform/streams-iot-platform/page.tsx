...
const KPIS = [{"l":"Dispositivos Online","v":"7.307","t":"+13.9%","d":"up"},{"l":"Dados/Min (MB)","v":"6.112","t":"+2.9%","d":"up"},{"l":"Alertas Ativos","v":"5.066","t":"+15.5%","d":"up"},{"l":"Uptime (%)","v":"83.7%","t":"+16.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.505","4.165","8.293","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.162","188","8.631","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.200","6.550","3.429","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.950","2.582","918","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.659","1.536","1.219","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":413},{"label":"Mar","value":421},{"label":"Abr","value":700},{"label":"Mai","value":490},{"label":"Jun","value":595},{"label":"Jul","value":448},{"label":"Ago","value":451},{"label":"Set","value":388},{"label":"Out","value":599},{"label":"Nov","value":551},{"label":"Dez","value":555}];
const MX = 700;
...
export default function StreamsIotPlatformPage() {
    return (
