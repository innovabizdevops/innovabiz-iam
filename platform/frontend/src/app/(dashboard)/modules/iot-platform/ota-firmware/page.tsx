...
const PAGE = "OTA Firmware Update";
const KPIS = [{"l":"Dispositivos Online","v":"812","t":"+6.2%","d":"up"},{"l":"Dados/Min (MB)","v":"2.237","t":"+11.9%","d":"up"},{"l":"Alertas Ativos","v":"1.662","t":"+5.2%","d":"up"},{"l":"Uptime (%)","v":"71.3%","t":"+10.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.123","3.522","3.808","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.263","4.865","9.030","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.599","1.925","3.762","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.011","7.995","6.521","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.326","5.879","2.788","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":525},{"label":"Mar","value":547},{"label":"Abr","value":778},{"label":"Mai","value":882},{"label":"Jun","value":551},{"label":"Jul","value":751},{"label":"Ago","value":733},{"label":"Set","value":741},{"label":"Out","value":655},{"label":"Nov","value":510},{"label":"Dez","value":748}];
const MX = 882;
