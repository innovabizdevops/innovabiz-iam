...
const PAGE = "IoT Analytics";
const KPIS = [{"l":"Dispositivos Online","v":"5.697","t":"+15.5%","d":"up"},{"l":"Dados/Min (MB)","v":"340","t":"+10.3%","d":"up"},{"l":"Alertas Ativos","v":"6.599","t":"+12.3%","d":"up"},{"l":"Uptime (%)","v":"90.0%","t":"+6.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.386","2.449","5.329","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.468","1.428","3.180","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.283","2.227","4.623","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.387","5.799","7.196","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.473","1.314","7.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":796},{"label":"Mar","value":810},{"label":"Abr","value":709},{"label":"Mai","value":940},{"label":"Jun","value":858},{"label":"Jul","value":704},{"label":"Ago","value":688},{"label":"Set","value":816},{"label":"Out","value":964},{"label":"Nov","value":724},{"label":"Dez","value":960}];
const MX = 964;
