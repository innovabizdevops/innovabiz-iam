...
const PAGE = "Matter Protocol";
const KPIS = [{"l":"Dispositivos Online","v":"3.953","t":"+14.5%","d":"up"},{"l":"Dados/Min (MB)","v":"1.476","t":"-4.9%","d":"down"},{"l":"Alertas Ativos","v":"1.939","t":"-3.5%","d":"down"},{"l":"Uptime (%)","v":"72.2%","t":"+16.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.572","6.670","2.238","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.946","2.778","1.653","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","280","8.937","5.075","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.778","8.289","3.123","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.575","8.565","8.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":275},{"label":"Fev","value":368},{"label":"Mar","value":499},{"label":"Abr","value":257},{"label":"Mai","value":594},{"label":"Jun","value":365},{"label":"Jul","value":350},{"label":"Ago","value":614},{"label":"Set","value":412},{"label":"Out","value":591},{"label":"Nov","value":450},{"label":"Dez","value":560}];
const MX = 614;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>Matter</span></h1>
                </div>
