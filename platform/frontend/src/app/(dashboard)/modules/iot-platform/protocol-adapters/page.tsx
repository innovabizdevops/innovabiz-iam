...
const PAGE = "Protocol Adapters";
const KPIS = [{"l":"Dispositivos Online","v":"5.719","t":"+15.3%","d":"up"},{"l":"Dados/Min (MB)","v":"5.633","t":"+16.7%","d":"up"},{"l":"Alertas Ativos","v":"7.014","t":"-2.0%","d":"down"},{"l":"Uptime (%)","v":"76.2%","t":"+14.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","617","8.422","1.639","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.831","9.060","5.765","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.368","7.743","7.717","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.600","2.444","2.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","704","7.229","2.282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":457},{"label":"Mar","value":229},{"label":"Abr","value":486},{"label":"Mai","value":270},{"label":"Jun","value":567},{"label":"Jul","value":375},{"label":"Ago","value":252},{"label":"Set","value":494},{"label":"Out","value":226},{"label":"Nov","value":534},{"label":"Dez","value":270}];
const MX = 567;
...
export default function ProtocolAdaptersPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>MQTT</span></h1>
                </div>
