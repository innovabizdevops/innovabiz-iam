...
const KPIS = [{"l":"Dispositivos Online","v":"9.087","t":"+1.8%","d":"up"},{"l":"Dados/Min (MB)","v":"8.370","t":"-5.5%","d":"down"},{"l":"Alertas Ativos","v":"3.052","t":"+13.3%","d":"up"},{"l":"Uptime (%)","v":"94.0%","t":"+1.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","901","7.486","7.902","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.122","4.286","293","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.284","7.842","8.673","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.629","4.121","7.826","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.593","7.474","3.705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":479},{"label":"Mar","value":558},{"label":"Abr","value":659},{"label":"Mai","value":480},{"label":"Jun","value":537},{"label":"Jul","value":658},{"label":"Ago","value":342},{"label":"Set","value":652},{"label":"Out","value":620},{"label":"Nov","value":357},{"label":"Dez","value":487}];
const MX = 659;
