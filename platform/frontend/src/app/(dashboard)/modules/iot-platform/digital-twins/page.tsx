...
const PAGE = "Digital Twins";
const KPIS = [{"l":"Dispositivos Online","v":"2.686","t":"+0.0%","d":"up"},{"l":"Dados/Min (MB)","v":"8.225","t":"+6.2%","d":"up"},{"l":"Alertas Ativos","v":"3.957","t":"-5.6%","d":"down"},{"l":"Uptime (%)","v":"84.9%","t":"+6.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.158","1.038","3.769","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.506","4.768","2.819","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.806","4.308","6.139","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.764","6.180","7.728","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.310","439","5.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":689},{"label":"Mar","value":406},{"label":"Abr","value":773},{"label":"Mai","value":512},{"label":"Jun","value":674},{"label":"Jul","value":562},{"label":"Ago","value":736},{"label":"Set","value":777},{"label":"Out","value":476},{"label":"Nov","value":550},{"label":"Dez","value":764}];
const MX = 777;
