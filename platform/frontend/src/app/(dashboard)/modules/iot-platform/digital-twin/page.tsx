...
const PAGE = "Digital Twin Builder";
const KPIS = [{"l":"Dispositivos Online","v":"761","t":"+1.2%","d":"up"},{"l":"Dados/Min (MB)","v":"2.266","t":"+13.6%","d":"up"},{"l":"Alertas Ativos","v":"7.047","t":"+0.6%","d":"up"},{"l":"Uptime (%)","v":"84.2%","t":"+3.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.579","6.342","5.874","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.004","6.751","8.947","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.059","7.125","6.707","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","751","6.819","6.549","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.267","8.021","4.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":614},{"label":"Fev","value":762},{"label":"Mar","value":607},{"label":"Abr","value":615},{"label":"Mai","value":511},{"label":"Jun","value":824},{"label":"Jul","value":668},{"label":"Ago","value":724},{"label":"Set","value":812},{"label":"Out","value":552},{"label":"Nov","value":656},{"label":"Dez","value":868}];
const MX = 868;
