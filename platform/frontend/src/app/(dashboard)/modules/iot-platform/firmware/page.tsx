...
const PAGE = "Firmware OTA";
const KPIS = [{"l":"Dispositivos Online","v":"8.421","t":"+2.3%","d":"up"},{"l":"Dados/Min (MB)","v":"155","t":"+8.2%","d":"up"},{"l":"Alertas Ativos","v":"4.184","t":"+2.8%","d":"up"},{"l":"Uptime (%)","v":"75.4%","t":"+15.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.066","2.101","2.064","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.260","4.084","8.503","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.930","275","6.631","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.196","5.186","1.532","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.778","2.516","1.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":688},{"label":"Mar","value":660},{"label":"Abr","value":804},{"label":"Mai","value":591},{"label":"Jun","value":644},{"label":"Jul","value":528},{"label":"Ago","value":838},{"label":"Set","value":520},{"label":"Out","value":512},{"label":"Nov","value":618},{"label":"Dez","value":816}];
const MX = 838;
