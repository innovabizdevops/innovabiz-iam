...
const PAGE = "OPC-UA (Industry)";
const KPIS = [{"l":"Dispositivos Online","v":"9.042","t":"+8.4%","d":"up"},{"l":"Dados/Min (MB)","v":"4.319","t":"-2.7%","d":"down"},{"l":"Alertas Ativos","v":"7.122","t":"-1.2%","d":"down"},{"l":"Uptime (%)","v":"68.5%","t":"+16.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.306","6.278","9.007","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.934","1.735","1.807","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.035","1.273","110","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.124","8.141","4.525","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.269","3.172","3.878","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":593},{"label":"Mar","value":244},{"label":"Abr","value":479},{"label":"Mai","value":277},{"label":"Jun","value":326},{"label":"Jul","value":521},{"label":"Ago","value":466},{"label":"Set","value":611},{"label":"Out","value":578},{"label":"Nov","value":602},{"label":"Dez","value":297}];
const MX = 611;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>OPC</span></h1>
                </div>
