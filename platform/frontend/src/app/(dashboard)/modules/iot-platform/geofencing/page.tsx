...
const PAGE = "Geofencing Rules";
const KPIS = [{"l":"Dispositivos Online","v":"3.454","t":"+7.2%","d":"up"},{"l":"Dados/Min (MB)","v":"4.832","t":"-2.9%","d":"down"},{"l":"Alertas Ativos","v":"3.250","t":"+5.4%","d":"up"},{"l":"Uptime (%)","v":"93.0%","t":"+12.6%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","822","3.636","3.863","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","120","3.844","3.328","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.760","5.244","1.158","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","9.060","2.579","1.189","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.150","6.190","4.853","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":333},{"label":"Fev","value":333},{"label":"Mar","value":470},{"label":"Abr","value":467},{"label":"Mai","value":359},{"label":"Jun","value":520},{"label":"Jul","value":480},{"label":"Ago","value":596},{"label":"Set","value":448},{"label":"Out","value":523},{"label":"Nov","value":555},{"label":"Dez","value":472}];
const MX = 596;
