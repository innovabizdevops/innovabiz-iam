...
const PAGE = "Anomaly Detection";
const KPIS = [{"l":"Dispositivos Online","v":"533","t":"+17.6%","d":"up"},{"l":"Dados/Min (MB)","v":"5.324","t":"+4.7%","d":"up"},{"l":"Alertas Ativos","v":"2.553","t":"+14.9%","d":"up"},{"l":"Uptime (%)","v":"93.9%","t":"-3.9%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.728","8.972","3.473","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.489","751","5.811","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.347","7.687","1.377","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.647","4.367","8.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","230","6.486","7.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":531},{"label":"Mar","value":748},{"label":"Abr","value":755},{"label":"Mai","value":604},{"label":"Jun","value":690},{"label":"Jul","value":571},{"label":"Ago","value":701},{"label":"Set","value":712},{"label":"Out","value":660},{"label":"Nov","value":503},{"label":"Dez","value":396}];
const MX = 755;
