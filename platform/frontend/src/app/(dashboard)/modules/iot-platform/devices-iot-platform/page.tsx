...
const KPIS = [{"l":"Dispositivos Online","v":"6.969","t":"-3.7%","d":"down"},{"l":"Dados/Min (MB)","v":"4.221","t":"+3.1%","d":"up"},{"l":"Alertas Ativos","v":"644","t":"+3.6%","d":"up"},{"l":"Uptime (%)","v":"69.7%","t":"+6.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","331","7.602","6.972","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.979","8.202","1.123","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.927","2.998","5.124","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.551","4.877","8.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.609","6.422","4.964","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1013},{"label":"Fev","value":854},{"label":"Mar","value":903},{"label":"Abr","value":691},{"label":"Mai","value":775},{"label":"Jun","value":967},{"label":"Jul","value":1026},{"label":"Ago","value":866},{"label":"Set","value":821},{"label":"Out","value":913},{"label":"Nov","value":734},{"label":"Dez","value":771}];
const MX = 1026;
...
export default function DevicesIotPlatformPage() {
    return (
