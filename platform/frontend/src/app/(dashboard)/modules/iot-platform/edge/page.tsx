...
const PAGE = "Edge Computing";
const KPIS = [{"l":"Dispositivos Online","v":"6.296","t":"+9.3%","d":"up"},{"l":"Dados/Min (MB)","v":"5.803","t":"+13.6%","d":"up"},{"l":"Alertas Ativos","v":"3.850","t":"-5.5%","d":"down"},{"l":"Uptime (%)","v":"73.3%","t":"+8.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.212","2.540","7.703","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.922","8.886","866","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.901","1.985","9.002","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.553","1.779","3.060","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.182","4.061","8.764","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":415},{"label":"Fev","value":343},{"label":"Mar","value":488},{"label":"Abr","value":527},{"label":"Mai","value":400},{"label":"Jun","value":579},{"label":"Jul","value":431},{"label":"Ago","value":334},{"label":"Set","value":411},{"label":"Out","value":534},{"label":"Nov","value":662},{"label":"Dez","value":533}];
const MX = 662;
