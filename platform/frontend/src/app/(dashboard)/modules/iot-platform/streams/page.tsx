...
const PAGE = "Data &amp; Intelligence";
const KPIS = [{"l":"Dispositivos Online","v":"1.186","t":"-3.0%","d":"down"},{"l":"Dados/Min (MB)","v":"2.460","t":"-5.7%","d":"down"},{"l":"Alertas Ativos","v":"6.816","t":"+16.0%","d":"up"},{"l":"Uptime (%)","v":"76.5%","t":"+10.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.138","4.011","1.866","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.631","6.806","4.654","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.073","7.464","7.905","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.850","2.566","3.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.441","8.888","538","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":800},{"label":"Mar","value":769},{"label":"Abr","value":766},{"label":"Mai","value":780},{"label":"Jun","value":722},{"label":"Jul","value":769},{"label":"Ago","value":852},{"label":"Set","value":541},{"label":"Out","value":802},{"label":"Nov","value":882},{"label":"Dez","value":654}];
const MX = 882;
