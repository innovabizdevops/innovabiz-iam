...
const PAGE = "Device Provisioning";
const KPIS = [{"l":"Dispositivos Online","v":"7.336","t":"+3.0%","d":"up"},{"l":"Dados/Min (MB)","v":"3.857","t":"+11.1%","d":"up"},{"l":"Alertas Ativos","v":"2.049","t":"-3.2%","d":"down"},{"l":"Uptime (%)","v":"69.8%","t":"+17.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.442","8.811","6.143","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","531","5.564","1.517","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.183","4.990","8.811","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.245","3.529","4.772","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.889","437","6.546","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":727},{"label":"Mar","value":754},{"label":"Abr","value":978},{"label":"Mai","value":947},{"label":"Jun","value":993},{"label":"Jul","value":741},{"label":"Ago","value":759},{"label":"Set","value":770},{"label":"Out","value":711},{"label":"Nov","value":992},{"label":"Dez","value":715}];
const MX = 993;
...
export default function ProvisioningIotPlatformPage() {
    return (
