...
const PAGE = "Geo-Analytics";
const KPIS = [{"l":"Dispositivos Online","v":"6.392","t":"+2.4%","d":"up"},{"l":"Dados/Min (MB)","v":"6.848","t":"+0.3%","d":"up"},{"l":"Alertas Ativos","v":"8.276","t":"+0.6%","d":"up"},{"l":"Uptime (%)","v":"82.2%","t":"+7.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","912","5.419","880","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.031","1.402","2.237","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","779","6.422","5.487","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.883","4.189","151","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.824","3.247","3.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":904},{"label":"Mar","value":743},{"label":"Abr","value":764},{"label":"Mai","value":814},{"label":"Jun","value":927},{"label":"Jul","value":917},{"label":"Ago","value":781},{"label":"Set","value":901},{"label":"Out","value":758},{"label":"Nov","value":675},{"label":"Dez","value":754}];
const MX = 927;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>GIS</span></h1>
                </div>
