...
const PAGE = "Fleet Provisioning";
const KPIS = [{"l":"Dispositivos Online","v":"1.458","t":"+0.5%","d":"up"},{"l":"Dados/Min (MB)","v":"5.640","t":"-0.7%","d":"down"},{"l":"Alertas Ativos","v":"954","t":"-2.7%","d":"down"},{"l":"Uptime (%)","v":"88.6%","t":"-4.8%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.786","7.895","1.384","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.633","8.382","2.864","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.326","2.734","2.626","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.487","2.836","1.674","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.165","1.843","5.872","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":704},{"label":"Mar","value":397},{"label":"Abr","value":695},{"label":"Mai","value":571},{"label":"Jun","value":380},{"label":"Jul","value":495},{"label":"Ago","value":379},{"label":"Set","value":568},{"label":"Out","value":683},{"label":"Nov","value":705},{"label":"Dez","value":577}];
const MX = 705;
