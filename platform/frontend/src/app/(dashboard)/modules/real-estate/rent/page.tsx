...
const PAGE = "Rent &amp; Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€24.8M","t":"+13.9%","d":"up"},{"l":"MRR (€)","v":"€63168","t":"+16.3%","d":"up"},{"l":"Churn (%)","v":"93.7%","t":"+1.6%","d":"up"},{"l":"ARPU (€)","v":"€87226","t":"+12.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49460.78","1.214","€ 357.38","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 9094.43","3.241","€ 208.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 36970.05","4.190","€ 25467.60","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7470.67","7.549","€ 48094.70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 6558.22","1.159","€ 49077.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":569},{"label":"Mar","value":887},{"label":"Abr","value":777},{"label":"Mai","value":553},{"label":"Jun","value":656},{"label":"Jul","value":748},{"label":"Ago","value":823},{"label":"Set","value":689},{"label":"Out","value":749},{"label":"Nov","value":645},{"label":"Dez","value":616}];
const MX = 887;
