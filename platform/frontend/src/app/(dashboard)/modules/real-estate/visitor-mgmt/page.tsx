...
const PAGE = "Visitor Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.894","t":"+4.6%","d":"up"},{"l":"Savings (€)","v":"€52431","t":"-0.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"88.3%","t":"+14.4%","d":"up"},{"l":"Ciclos PDCA","v":"1.209","t":"+6.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.024","€ 23878.27","319","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.868","€ 28201.15","4.903","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.280","€ 41415.46","5.360","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.595","€ 6641.52","6.442","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.423","€ 3066.08","9.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":943},{"label":"Mar","value":925},{"label":"Abr","value":924},{"label":"Mai","value":664},{"label":"Jun","value":825},{"label":"Jul","value":714},{"label":"Ago","value":658},{"label":"Set","value":827},{"label":"Out","value":941},{"label":"Nov","value":1004},{"label":"Dez","value":872}];
const MX = 1004;
