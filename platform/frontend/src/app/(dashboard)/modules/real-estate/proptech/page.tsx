...
const PAGE = "PropTech Analytics AI";
const KPIS = [{"l":"Dashboards Ativos","v":"3.636","t":"+15.1%","d":"up"},{"l":"Queries/Dia","v":"961","t":"+6.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.958","t":"+1.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.088","t":"+3.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2945","2026-01-20","8.535","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1711","2026-03-03","3.094","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4957","2026-02-12","1.250","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2991","2026-03-12","8.316","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","459","2026-03-23","761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":594},{"label":"Mar","value":772},{"label":"Abr","value":712},{"label":"Mai","value":670},{"label":"Jun","value":515},{"label":"Jul","value":644},{"label":"Ago","value":549},{"label":"Set","value":663},{"label":"Out","value":527},{"label":"Nov","value":705},{"label":"Dez","value":415}];
const MX = 772;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>AI</span></h1>
                </div>
