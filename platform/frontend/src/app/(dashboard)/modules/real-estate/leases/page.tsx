...
const PAGE = "Leases &amp; Contracts";
const KPIS = [{"l":"Contratos Ativos","v":"5.723","t":"-2.5%","d":"down"},{"l":"Valor Total (€M)","v":"€43.1M","t":"-3.8%","d":"down"},{"l":"Renovações Próx. 30d","v":"3.293","t":"+8.8%","d":"up"},{"l":"Obrigações Pendentes","v":"3.153","t":"+8.9%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 14486.53","2026-02-08","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 21809.46","2026-01-16","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 5259.87","2026-02-02","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 22616.52","2026-01-07","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 31755.55","2026-02-21","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":911},{"label":"Mar","value":828},{"label":"Abr","value":647},{"label":"Mai","value":770},{"label":"Jun","value":641},{"label":"Jul","value":896},{"label":"Ago","value":889},{"label":"Set","value":1007},{"label":"Out","value":895},{"label":"Nov","value":847},{"label":"Dez","value":733}];
const MX = 1007;
