...
const PAGE = "Space Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"7.580","t":"-4.8%","d":"down"},{"l":"RevPAR (€)","v":"€42230","t":"+15.8%","d":"up"},{"l":"Ocupação (%)","v":"87.2%","t":"+10.7%","d":"up"},{"l":"Guest Satisfaction","v":"199","t":"-1.2%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.524","2026-01-27","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.805","2026-02-06","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.182","2026-02-25","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.614","2026-02-12","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.188","2026-03-17","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":812},{"label":"Mar","value":554},{"label":"Abr","value":691},{"label":"Mai","value":646},{"label":"Jun","value":637},{"label":"Jul","value":782},{"label":"Ago","value":755},{"label":"Set","value":509},{"label":"Out","value":568},{"label":"Nov","value":832},{"label":"Dez","value":699}];
const MX = 832;
