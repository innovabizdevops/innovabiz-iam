...
const PAGE = "Property Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.288","t":"+9.1%","d":"up"},{"l":"Savings (€)","v":"€83740","t":"+2.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.3%","t":"+10.4%","d":"up"},{"l":"Ciclos PDCA","v":"3.448","t":"+14.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.979","€ 6326.79","5.906","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.134","€ 18690.79","5.001","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.871","€ 14830.28","251","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.966","€ 36723.99","4.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.858","€ 40310.94","2.385","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":591},{"label":"Mar","value":535},{"label":"Abr","value":741},{"label":"Mai","value":675},{"label":"Jun","value":459},{"label":"Jul","value":517},{"label":"Ago","value":617},{"label":"Set","value":814},{"label":"Out","value":755},{"label":"Nov","value":567},{"label":"Dez","value":648}];
const MX = 814;
