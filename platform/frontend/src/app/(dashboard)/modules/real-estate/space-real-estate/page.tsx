...
const PAGE = "Space Management";
const KPIS = [{"l":"Projetos Melhoria","v":"4.744","t":"-2.4%","d":"down"},{"l":"Savings (€)","v":"€18499","t":"+9.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.6%","t":"+9.3%","d":"up"},{"l":"Ciclos PDCA","v":"844","t":"+13.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","182","€ 24120.28","8.386","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.926","€ 40605.91","8.650","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.039","€ 48330.01","6.685","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.128","€ 44205.63","2.085","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.607","€ 11064.52","8.978","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":830},{"label":"Mar","value":553},{"label":"Abr","value":895},{"label":"Mai","value":662},{"label":"Jun","value":578},{"label":"Jul","value":929},{"label":"Ago","value":755},{"label":"Set","value":803},{"label":"Out","value":910},{"label":"Nov","value":945},{"label":"Dez","value":929}];
const MX = 945;
...
export default function SpaceRealEstatePage() {
    return (
