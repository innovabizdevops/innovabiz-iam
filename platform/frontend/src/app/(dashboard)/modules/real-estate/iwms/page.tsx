...
const PAGE = "IWMS";
const KPIS = [{"l":"Total Real Estate","v":"2.498","t":"+15.9%","d":"up"},{"l":"IWMS Ativos","v":"3.183","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+8.7%","d":"up"}];
const COLS = ["ID","IWMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Real Estate #001","Real Estate #002","7.513","6.472","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Real Estate #002","Real Estate #003","7.517","8.865","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Real Estate #003","Real Estate #004","2.194","4.405","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Real Estate #004","Real Estate #005","4.547","9.055","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Real Estate #005","Real Estate #001","3.451","475","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":688},{"label":"Mar","value":652},{"label":"Abr","value":621},{"label":"Mai","value":832},{"label":"Jun","value":704},{"label":"Jul","value":591},{"label":"Ago","value":944},{"label":"Set","value":901},{"label":"Out","value":589},{"label":"Nov","value":753},{"label":"Dez","value":892}];
const MX = 944;
...
export default function IwmsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>New</span></h1>
                </div>
