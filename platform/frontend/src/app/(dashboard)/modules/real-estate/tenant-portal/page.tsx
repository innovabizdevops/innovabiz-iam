...
const PAGE = "Tenant Portal";
const KPIS = [{"l":"Páginas Publicadas","v":"5.109","t":"-0.9%","d":"down"},{"l":"Visitantes/Dia","v":"1197","t":"-2.4%","d":"down"},{"l":"Conversão (%)","v":"72.1%","t":"+16.5%","d":"up"},{"l":"Performance Score","v":"94","t":"+6.9%","d":"up"}];
const COLS = ["Página","URL","Views/Dia","Bounce (%)","Conversão (%)","Estado"];
const ROWS = [{"id":"r0","cells":["/home","/products","3751","98.2%","73.6%","Ativo"],"status":"active"},{"id":"r1","cells":["/products","/pricing","4688","98.2%","80.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["/pricing","/about","1163","86.1%","84.0%","Concluído"],"status":"done"},{"id":"r3","cells":["/about","/contact","4713","95.2%","79.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["/contact","/home","3750","87.2%","73.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":335},{"label":"Fev","value":383},{"label":"Mar","value":562},{"label":"Abr","value":584},{"label":"Mai","value":527},{"label":"Jun","value":513},{"label":"Jul","value":518},{"label":"Ago","value":447},{"label":"Set","value":515},{"label":"Out","value":263},{"label":"Nov","value":243},{"label":"Dez","value":257}];
const MX = 584;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>CX</span></h1>
                </div>
