...
const PAGE = "Facilities &amp; Maintenance";
const KPIS = [{"l":"Quartos Ocupados","v":"6.980","t":"+5.4%","d":"up"},{"l":"RevPAR (€)","v":"€56099","t":"+9.4%","d":"up"},{"l":"Ocupação (%)","v":"67.9%","t":"-0.5%","d":"down"},{"l":"Guest Satisfaction","v":"3.301","t":"+11.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.114","2026-02-21","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.499","2026-01-24","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.880","2026-01-14","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.783","2026-01-21","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.755","2026-02-22","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":946},{"label":"Mar","value":963},{"label":"Abr","value":745},{"label":"Mai","value":977},{"label":"Jun","value":813},{"label":"Jul","value":956},{"label":"Ago","value":842},{"label":"Set","value":808},{"label":"Out","value":711},{"label":"Nov","value":946},{"label":"Dez","value":835}];
const MX = 977;
