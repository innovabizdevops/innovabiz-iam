...
const PAGE = "Property Form";
const KPIS = [{"l":"Formulários Ativos","v":"4.194","t":"+9.5%","d":"up"},{"l":"Submissões/Dia","v":"2289","t":"-5.9%","d":"down"},{"l":"Documentos Gerados","v":"5.903","t":"-2.5%","d":"down"},{"l":"Templates","v":"8.129","t":"+4.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","362","2026-01-06","977","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.357","2026-02-13","2.997","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.095","2026-03-14","7.298","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.574","2026-03-11","3.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.689","2026-03-07","6.736","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":699},{"label":"Mar","value":859},{"label":"Abr","value":562},{"label":"Mai","value":668},{"label":"Jun","value":746},{"label":"Jul","value":814},{"label":"Ago","value":588},{"label":"Set","value":593},{"label":"Out","value":553},{"label":"Nov","value":551},{"label":"Dez","value":795}];
const MX = 859;
