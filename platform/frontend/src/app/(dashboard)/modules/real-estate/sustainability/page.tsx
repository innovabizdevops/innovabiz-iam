...
const ACCENT = "#78716c";
const MODULE = "Real Estate & Facilities";
const PAGE = "Sustainability Reporting";
const KPIS = [{"l":"Total Real Estate","v":"6.232","t":"-4.3%","d":"down"},{"l":"Sustainability Reporting Ativos","v":"981","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"72","t":"+13.4%","d":"up"}];
const COLS = ["ID","Sustainability Reporting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Real Estate #001","Real Estate #002","1.937","5.324","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Real Estate #002","Real Estate #003","5.651","973","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Real Estate #003","Real Estate #004","2.978","2.551","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Real Estate #004","Real Estate #005","8.987","8.552","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Real Estate #005","Real Estate #001","2.487","2.875","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":727},{"label":"Mar","value":1001},{"label":"Abr","value":971},{"label":"Mai","value":838},{"label":"Jun","value":988},{"label":"Jul","value":798},{"label":"Ago","value":944},{"label":"Set","value":862},{"label":"Out","value":698},{"label":"Nov","value":684},{"label":"Dez","value":857}];
const MX = 1001;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>ESG</span></h1>
                </div>
