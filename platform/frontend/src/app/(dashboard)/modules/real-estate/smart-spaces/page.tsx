...
const PAGE = "Smart Spaces IoT";
const KPIS = [{"l":"Dispositivos Online","v":"3.015","t":"+8.5%","d":"up"},{"l":"Dados/Min (MB)","v":"3.263","t":"+14.1%","d":"up"},{"l":"Alertas Ativos","v":"5.003","t":"+12.7%","d":"up"},{"l":"Uptime (%)","v":"79.8%","t":"-1.4%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.109","5.384","5.656","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.527","7.604","8.443","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.190","2.867","658","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.818","6.215","3.609","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","5.008","6.019","8.873","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":543},{"label":"Mar","value":256},{"label":"Abr","value":211},{"label":"Mai","value":347},{"label":"Jun","value":341},{"label":"Jul","value":266},{"label":"Ago","value":304},{"label":"Set","value":249},{"label":"Out","value":365},{"label":"Nov","value":326},{"label":"Dez","value":235}];
const MX = 585;
