...
const PAGE = "Virtual Tours 3D";
const KPIS = [{"l":"Total Real Estate","v":"1.157","t":"+2.7%","d":"up"},{"l":"Virtual Tours 3D Ativos","v":"585","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.5%","d":"up"}];
const COLS = ["ID","Virtual Tours 3D","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Real Estate #001","Real Estate #002","8.061","8.569","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Real Estate #002","Real Estate #003","7.225","1.756","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Real Estate #003","Real Estate #004","1.379","5.851","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Real Estate #004","Real Estate #005","6.629","5.623","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Real Estate #005","Real Estate #001","7.825","7.389","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":527},{"label":"Mar","value":684},{"label":"Abr","value":473},{"label":"Mai","value":523},{"label":"Jun","value":463},{"label":"Jul","value":541},{"label":"Ago","value":495},{"label":"Set","value":731},{"label":"Out","value":551},{"label":"Nov","value":794},{"label":"Dez","value":687}];
const MX = 794;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#78716c'}}>3D</span></h1>
                </div>
