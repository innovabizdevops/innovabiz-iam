...
const PAGE = "Move Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.024","t":"+7.1%","d":"up"},{"l":"Savings (€)","v":"€10339","t":"+7.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.7%","t":"+5.5%","d":"up"},{"l":"Ciclos PDCA","v":"325","t":"+15.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.551","€ 48440.04","2.932","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.176","€ 19258.33","3.811","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.149","€ 21972.63","5.357","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.259","€ 5394.47","6.824","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.042","€ 30285.25","8.603","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":829},{"label":"Mar","value":715},{"label":"Abr","value":785},{"label":"Mai","value":547},{"label":"Jun","value":585},{"label":"Jul","value":825},{"label":"Ago","value":829},{"label":"Set","value":552},{"label":"Out","value":662},{"label":"Nov","value":807},{"label":"Dez","value":849}];
const MX = 849;
...
export default function MoveMgmtPage() {
    return (
