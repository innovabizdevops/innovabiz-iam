...
const PAGE = "Compliance Train";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.760","t":"-2.3%","d":"down"},{"l":"NC Abertas","v":"1.281","t":"+5.8%","d":"up"},{"l":"Conformidade (%)","v":"88.5%","t":"+15.2%","d":"up"},{"l":"CAPAs Pendentes","v":"3.496","t":"+3.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.800","99.3%","1.672","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.279","78.9%","8.658","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.223","75.7%","8.843","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.107","89.9%","7.877","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.587","86.6%","1.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":488},{"label":"Mar","value":761},{"label":"Abr","value":796},{"label":"Mai","value":827},{"label":"Jun","value":709},{"label":"Jul","value":529},{"label":"Ago","value":711},{"label":"Set","value":815},{"label":"Out","value":541},{"label":"Nov","value":874},{"label":"Dez","value":802}];
const MX = 874;
