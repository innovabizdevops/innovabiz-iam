...
export default function LmsLearningPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lms Learning</h1><p className="text-sm text-muted-foreground">Lms Learning • iBOS Enterprise</p></div>
