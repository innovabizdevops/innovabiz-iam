...
const KPIS = [{"l":"Utilizadores Ativos","v":"5.871","t":"+1.5%","d":"up"},{"l":"Sessões/Dia","v":"2424","t":"-1.4%","d":"down"},{"l":"MFA Adoção (%)","v":"67.4%","t":"+7.6%","d":"up"},{"l":"Tentativas Bloqueadas","v":"111","t":"+4.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.832","385","3.463","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","497","6.881","1.900","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.823","3.810","1.588","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","9.097","3.295","8.810","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.918","4.173","132","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":693},{"label":"Mar","value":408},{"label":"Abr","value":514},{"label":"Mai","value":683},{"label":"Jun","value":587},{"label":"Jul","value":568},{"label":"Ago","value":383},{"label":"Set","value":344},{"label":"Out","value":377},{"label":"Nov","value":571},{"label":"Dez","value":576}];
const MX = 693;
