...
const ACCENT = "#4338ca";
const MODULE = "Learning & LMS";
const PAGE = "Course Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"6.849","t":"+8.2%","d":"up"},{"l":"Queries/Dia","v":"2399","t":"+12.2%","d":"up"},{"l":"Dados Processados (GB)","v":"638","t":"+6.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.843","t":"-4.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3375","2026-03-12","8.250","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4599","2026-03-10","8.710","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2032","2026-01-04","6.600","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4184","2026-03-24","616","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1743","2026-03-18","7.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":648},{"label":"Mar","value":672},{"label":"Abr","value":676},{"label":"Mai","value":370},{"label":"Jun","value":613},{"label":"Jul","value":728},{"label":"Ago","value":553},{"label":"Set","value":438},{"label":"Out","value":525},{"label":"Nov","value":444},{"label":"Dez","value":646}];
const MX = 728;
