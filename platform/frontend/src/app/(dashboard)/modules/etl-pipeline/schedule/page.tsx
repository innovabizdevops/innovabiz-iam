...
const PAGE = "Schedule Manager";
const KPIS = [{"l":"Dashboards Ativos","v":"5.612","t":"+8.3%","d":"up"},{"l":"Queries/Dia","v":"506","t":"+6.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.890","t":"-5.2%","d":"down"},{"l":"Utilizadores Analytics","v":"7.042","t":"+17.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2939","2026-01-18","8.049","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1045","2026-02-27","2.702","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1403","2026-01-21","6.433","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4790","2026-01-12","4.937","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2840","2026-02-12","1.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":479},{"label":"Mar","value":581},{"label":"Abr","value":470},{"label":"Mai","value":450},{"label":"Jun","value":524},{"label":"Jul","value":403},{"label":"Ago","value":492},{"label":"Set","value":538},{"label":"Out","value":728},{"label":"Nov","value":521},{"label":"Dez","value":768}];
const MX = 768;
