...
const KPIS = [{"l":"Formulários Ativos","v":"6.073","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"4016","t":"+1.3%","d":"up"},{"l":"Documentos Gerados","v":"8.625","t":"+14.7%","d":"up"},{"l":"Templates","v":"2.279","t":"-2.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.087","2026-01-14","8.773","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.076","2026-03-10","870","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.911","2026-02-02","6.462","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.574","2026-01-03","1.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.197","2026-01-20","784","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":583},{"label":"Mar","value":766},{"label":"Abr","value":832},{"label":"Mai","value":597},{"label":"Jun","value":731},{"label":"Jul","value":836},{"label":"Ago","value":697},{"label":"Set","value":735},{"label":"Out","value":496},{"label":"Nov","value":780},{"label":"Dez","value":571}];
const MX = 836;
