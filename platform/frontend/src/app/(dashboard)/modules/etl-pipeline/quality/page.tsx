...
const PAGE = "Data Quality Rules";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.411","t":"-5.3%","d":"down"},{"l":"NC Abertas","v":"2.955","t":"+9.7%","d":"up"},{"l":"Conformidade (%)","v":"74.2%","t":"-2.2%","d":"down"},{"l":"CAPAs Pendentes","v":"7.267","t":"-5.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.140","99.0%","242","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.771","95.2%","1.713","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.938","91.0%","5.734","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.634","87.2%","6.164","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.954","76.6%","3.253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":905},{"label":"Mar","value":663},{"label":"Abr","value":672},{"label":"Mai","value":970},{"label":"Jun","value":737},{"label":"Jul","value":1047},{"label":"Ago","value":735},{"label":"Set","value":749},{"label":"Out","value":1004},{"label":"Nov","value":775},{"label":"Dez","value":962}];
const MX = 1047;
