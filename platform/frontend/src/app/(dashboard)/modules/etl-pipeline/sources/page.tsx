...
const KPIS = [{"l":"Dashboards Ativos","v":"7.594","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"3266","t":"-4.2%","d":"down"},{"l":"Dados Processados (GB)","v":"1.068","t":"-1.5%","d":"down"},{"l":"Utilizadores Analytics","v":"2.310","t":"+5.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4605","2026-03-28","7.288","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3359","2026-02-03","1.787","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1172","2026-02-18","8.055","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3837","2026-01-06","2.688","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3217","2026-01-09","8.275","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":467},{"label":"Mar","value":617},{"label":"Abr","value":571},{"label":"Mai","value":751},{"label":"Jun","value":618},{"label":"Jul","value":502},{"label":"Ago","value":546},{"label":"Set","value":576},{"label":"Out","value":637},{"label":"Nov","value":715},{"label":"Dez","value":479}];
const MX = 751;
