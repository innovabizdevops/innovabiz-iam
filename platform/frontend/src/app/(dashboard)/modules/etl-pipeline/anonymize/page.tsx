...
const ACCENT = "#059669";
const MODULE = "ETL & Data Pipeline";
const PAGE = "Data Anonymization";
const KPIS = [{"l":"Dashboards Ativos","v":"388","t":"+9.2%","d":"up"},{"l":"Queries/Dia","v":"2829","t":"-1.8%","d":"down"},{"l":"Dados Processados (GB)","v":"8.115","t":"+16.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.224","t":"+15.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4285","2026-01-18","7.312","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2861","2026-02-13","2.309","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3268","2026-01-04","8.434","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1777","2026-03-26","7.859","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2497","2026-01-13","3.622","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":850},{"label":"Mar","value":755},{"label":"Abr","value":754},{"label":"Mai","value":603},{"label":"Jun","value":822},{"label":"Jul","value":844},{"label":"Ago","value":862},{"label":"Set","value":761},{"label":"Out","value":620},{"label":"Nov","value":558},{"label":"Dez","value":567}];
const MX = 872;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>GDPR</span></h1>
                </div>
