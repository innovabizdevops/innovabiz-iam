...
const PAGE = "Lineage Tracker";
const KPIS = [{"l":"Dashboards Ativos","v":"157","t":"+15.6%","d":"up"},{"l":"Queries/Dia","v":"3750","t":"+15.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.194","t":"+2.8%","d":"up"},{"l":"Utilizadores Analytics","v":"2.093","t":"+5.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3209","2026-03-05","7.260","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","756","2026-03-27","3.439","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3904","2026-03-27","4.195","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4741","2026-03-18","3.198","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1692","2026-01-25","8.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":576},{"label":"Mar","value":868},{"label":"Abr","value":508},{"label":"Mai","value":857},{"label":"Jun","value":791},{"label":"Jul","value":732},{"label":"Ago","value":874},{"label":"Set","value":588},{"label":"Out","value":740},{"label":"Nov","value":774},{"label":"Dez","value":802}];
const MX = 874;
