...
const PAGE = "Real-Time Streaming";
const KPIS = [{"l":"Dashboards Ativos","v":"6.970","t":"+15.4%","d":"up"},{"l":"Queries/Dia","v":"3259","t":"+2.3%","d":"up"},{"l":"Dados Processados (GB)","v":"6.783","t":"+15.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.989","t":"+4.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4944","2026-01-19","1.063","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3587","2026-01-23","3.504","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1800","2026-01-25","4.383","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1326","2026-03-18","5.391","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1456","2026-02-17","4.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":922},{"label":"Mar","value":763},{"label":"Abr","value":712},{"label":"Mai","value":645},{"label":"Jun","value":641},{"label":"Jul","value":954},{"label":"Ago","value":901},{"label":"Set","value":877},{"label":"Out","value":837},{"label":"Nov","value":727},{"label":"Dez","value":855}];
const MX = 973;
