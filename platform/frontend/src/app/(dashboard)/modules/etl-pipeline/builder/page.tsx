...
const PAGE = "Pipeline Builder";
const KPIS = [{"l":"Dashboards Ativos","v":"867","t":"+4.5%","d":"up"},{"l":"Queries/Dia","v":"2044","t":"+6.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.321","t":"+7.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.260","t":"+4.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3846","2026-02-19","3.391","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2820","2026-03-24","7.527","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2185","2026-01-02","6.192","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3490","2026-03-24","8.373","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3465","2026-01-19","855","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":291},{"label":"Fev","value":626},{"label":"Mar","value":364},{"label":"Abr","value":667},{"label":"Mai","value":345},{"label":"Jun","value":660},{"label":"Jul","value":647},{"label":"Ago","value":359},{"label":"Set","value":297},{"label":"Out","value":598},{"label":"Nov","value":406},{"label":"Dez","value":380}];
const MX = 667;
