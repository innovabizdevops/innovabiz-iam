...
export default function StreamingPlatPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Streaming Plat</h1><p className="text-sm text-muted-foreground">Streaming Plat • iBOS Enterprise</p></div>
