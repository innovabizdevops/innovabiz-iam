...
const KPIS = [{"l":"Dashboards Ativos","v":"8.056","t":"+5.8%","d":"up"},{"l":"Queries/Dia","v":"2891","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"5.312","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"3.414","t":"-6.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3502","2026-03-22","8.276","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1219","2026-02-19","8.052","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3522","2026-01-28","4.537","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2096","2026-01-21","8.518","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3106","2026-03-07","5.131","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1079},{"label":"Fev","value":763},{"label":"Mar","value":801},{"label":"Abr","value":1021},{"label":"Mai","value":723},{"label":"Jun","value":758},{"label":"Jul","value":1022},{"label":"Ago","value":770},{"label":"Set","value":789},{"label":"Out","value":825},{"label":"Nov","value":732},{"label":"Dez","value":797}];
const MX = 1079;
