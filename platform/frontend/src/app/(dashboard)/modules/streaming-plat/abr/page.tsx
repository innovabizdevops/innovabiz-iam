...
const PAGE = "Quality ABR";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.226","t":"+17.9%","d":"up"},{"l":"NC Abertas","v":"4.787","t":"+14.6%","d":"up"},{"l":"Conformidade (%)","v":"83.6%","t":"+17.5%","d":"up"},{"l":"CAPAs Pendentes","v":"1.843","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.471","85.6%","8.713","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.187","80.0%","8.638","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.036","95.8%","7.483","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.015","79.4%","6.973","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.709","79.3%","6.178","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":646},{"label":"Mar","value":761},{"label":"Abr","value":712},{"label":"Mai","value":594},{"label":"Jun","value":675},{"label":"Jul","value":943},{"label":"Ago","value":594},{"label":"Set","value":936},{"label":"Out","value":860},{"label":"Nov","value":731},{"label":"Dez","value":797}];
const MX = 943;
