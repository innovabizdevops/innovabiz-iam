...
const PAGE = "Download Offline";
const KPIS = [{"l":"Total Streaming Plat","v":"7.792","t":"+17.9%","d":"up"},{"l":"Download Offline Ativos","v":"4.561","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"83","t":"-3.0%","d":"down"}];
const COLS = ["ID","Download Offline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Streaming Plat #001","Streaming Plat #002","8.433","6.910","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Streaming Plat #002","Streaming Plat #003","5.418","6.104","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Streaming Plat #003","Streaming Plat #004","4.253","2.148","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Streaming Plat #004","Streaming Plat #005","8.069","6.520","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Streaming Plat #005","Streaming Plat #001","3.963","7.266","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":627},{"label":"Mar","value":910},{"label":"Abr","value":989},{"label":"Mai","value":658},{"label":"Jun","value":1007},{"label":"Jul","value":922},{"label":"Ago","value":1010},{"label":"Set","value":1017},{"label":"Out","value":967},{"label":"Nov","value":1021},{"label":"Dez","value":975}];
const MX = 1021;
