...
const KPIS = [{"l":"Total Streaming Plat","v":"2.484","t":"+5.2%","d":"up"},{"l":"Live Events Ativos","v":"2.648","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"66.2%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+17.6%","d":"up"}];
const COLS = ["ID","Live Events","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Streaming Plat #001","Streaming Plat #002","2.302","8.081","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Streaming Plat #002","Streaming Plat #003","6.842","7.814","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Streaming Plat #003","Streaming Plat #004","5.580","2.355","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Streaming Plat #004","Streaming Plat #005","6.358","5.266","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Streaming Plat #005","Streaming Plat #001","7.443","7.599","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":678},{"label":"Mar","value":804},{"label":"Abr","value":511},{"label":"Mai","value":872},{"label":"Jun","value":643},{"label":"Jul","value":522},{"label":"Ago","value":845},{"label":"Set","value":531},{"label":"Out","value":695},{"label":"Nov","value":774},{"label":"Dez","value":528}];
const MX = 872;
