...
const PAGE = "DRM Protect";
const KPIS = [{"l":"Total Streaming Plat","v":"3.746","t":"+13.7%","d":"up"},{"l":"DRM Protect Ativos","v":"7.812","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"70","t":"-5.8%","d":"down"}];
const COLS = ["ID","DRM Protect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Streaming Plat #001","Streaming Plat #002","2.622","7.945","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Streaming Plat #002","Streaming Plat #003","7.063","6.284","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Streaming Plat #003","Streaming Plat #004","404","8.024","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Streaming Plat #004","Streaming Plat #005","9.082","4.951","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Streaming Plat #005","Streaming Plat #001","5.383","2.517","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":874},{"label":"Mar","value":765},{"label":"Abr","value":601},{"label":"Mai","value":648},{"label":"Jun","value":624},{"label":"Jul","value":742},{"label":"Ago","value":535},{"label":"Set","value":499},{"label":"Out","value":656},{"label":"Nov","value":862},{"label":"Dez","value":738}];
const MX = 874;
