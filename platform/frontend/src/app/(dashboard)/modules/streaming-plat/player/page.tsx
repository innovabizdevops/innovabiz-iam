...
const PAGE = "Player Config";
const KPIS = [{"l":"Configurações","v":"5.626","t":"+11.1%","d":"up"},{"l":"Últimas Alterações","v":"4.375","t":"+16.3%","d":"up"},{"l":"Ambientes","v":"5.464","t":"+8.9%","d":"up"},{"l":"Versão Config","v":"8.443","t":"+11.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 30854.92","726","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 19938.72","8.925","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 20365.63","968","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 802.55","2.162","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 33823.44","1.510","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":473},{"label":"Mar","value":719},{"label":"Abr","value":394},{"label":"Mai","value":402},{"label":"Jun","value":444},{"label":"Jul","value":558},{"label":"Ago","value":667},{"label":"Set","value":485},{"label":"Out","value":583},{"label":"Nov","value":488},{"label":"Dez","value":444}];
const MX = 719;
