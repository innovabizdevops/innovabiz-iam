...
const PAGE = "Offset Market";
const KPIS = [{"l":"Total Carbon Trading","v":"7.296","t":"+0.2%","d":"up"},{"l":"Offset Market Ativos","v":"3.122","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.9%","d":"up"}];
const COLS = ["ID","Offset Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Trading #001","Carbon Trading #002","2.884","3.592","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Trading #002","Carbon Trading #003","617","1.744","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Trading #003","Carbon Trading #004","8.693","4.109","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Trading #004","Carbon Trading #005","7.931","5.891","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Trading #005","Carbon Trading #001","4.853","7.285","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":761},{"label":"Mar","value":678},{"label":"Abr","value":704},{"label":"Mai","value":816},{"label":"Jun","value":908},{"label":"Jul","value":927},{"label":"Ago","value":857},{"label":"Set","value":672},{"label":"Out","value":731},{"label":"Nov","value":785},{"label":"Dez","value":729}];
const MX = 927;
