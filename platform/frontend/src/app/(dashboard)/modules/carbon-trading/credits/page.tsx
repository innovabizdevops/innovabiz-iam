...
const ACCENT = "#059669";
const MODULE = "Carbon Trading";
const PAGE = "Credit Portfolio";
const KPIS = [{"l":"Integrações Ativas","v":"3.984","t":"+6.0%","d":"up"},{"l":"Chamadas/Hora","v":"3248","t":"-0.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"75.4%","t":"+3.9%","d":"up"},{"l":"Latência Média (ms)","v":"22ms","t":"+16.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.134","6.921","87.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.667","7.024","87.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.258","2.192","96.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.535","540","76.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.983","1.393","77.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":495},{"label":"Mar","value":467},{"label":"Abr","value":433},{"label":"Mai","value":579},{"label":"Jun","value":433},{"label":"Jul","value":332},{"label":"Ago","value":615},{"label":"Set","value":521},{"label":"Out","value":385},{"label":"Nov","value":621},{"label":"Dez","value":435}];
const MX = 621;
