...
const KPIS = [{"l":"Total Carbon Trading","v":"6.207","t":"+3.0%","d":"up"},{"l":"Registry Link Ativos","v":"4.900","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+5.5%","d":"up"}];
const COLS = ["ID","Registry Link","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Trading #001","Carbon Trading #002","8.480","2.559","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Trading #002","Carbon Trading #003","7.708","9.042","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Trading #003","Carbon Trading #004","4.242","6.329","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Trading #004","Carbon Trading #005","8.684","4.030","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Trading #005","Carbon Trading #001","8.678","5.321","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":775},{"label":"Mar","value":655},{"label":"Abr","value":470},{"label":"Mai","value":697},{"label":"Jun","value":600},{"label":"Jul","value":706},{"label":"Ago","value":710},{"label":"Set","value":446},{"label":"Out","value":502},{"label":"Nov","value":477},{"label":"Dez","value":764}];
const MX = 775;
