...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"7.952","t":"-1.8%","d":"down"},{"l":"Queries/Dia","v":"3483","t":"+5.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.836","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"5.506","t":"+3.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1879","2026-01-12","134","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","737","2026-02-04","7.084","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","917","2026-01-17","6.630","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3342","2026-03-27","2.967","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3791","2026-01-17","8.312","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":788},{"label":"Mar","value":458},{"label":"Abr","value":712},{"label":"Mai","value":524},{"label":"Jun","value":796},{"label":"Jul","value":587},{"label":"Ago","value":613},{"label":"Set","value":705},{"label":"Out","value":662},{"label":"Nov","value":483},{"label":"Dez","value":592}];
const MX = 796;
