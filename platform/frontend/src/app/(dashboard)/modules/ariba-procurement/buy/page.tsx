...
const PAGE = "Buy";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.406","t":"+6.4%","d":"up"},{"l":"Contratos (€M)","v":"€6.5M","t":"+5.7%","d":"up"},{"l":"On-Time Delivery (%)","v":"75.4%","t":"+3.1%","d":"up"},{"l":"Score Médio","v":"69","t":"-5.2%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","81.5%","€ 33733.25","1.838","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","74.1%","€ 17362.10","1.958","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","95.8%","€ 5294.48","5.670","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","81.9%","€ 49068.36","3.455","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","89.6%","€ 23478.97","3.472","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":658},{"label":"Mar","value":744},{"label":"Abr","value":491},{"label":"Mai","value":532},{"label":"Jun","value":654},{"label":"Jul","value":696},{"label":"Ago","value":670},{"label":"Set","value":772},{"label":"Out","value":703},{"label":"Nov","value":807},{"label":"Dez","value":638}];
const MX = 807;
