...
const PAGE = "Invoice";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.527","t":"-5.0%","d":"down"},{"l":"Contratos (€M)","v":"€18.9M","t":"-5.9%","d":"down"},{"l":"On-Time Delivery (%)","v":"88.0%","t":"+10.9%","d":"up"},{"l":"Score Médio","v":"86","t":"+2.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","94.8%","€ 40948.39","3.744","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","71.0%","€ 29963.52","4.532","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","87.3%","€ 23584.98","4.007","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","75.7%","€ 2695.47","3.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","92.6%","€ 26818.43","2.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":392},{"label":"Mar","value":669},{"label":"Abr","value":639},{"label":"Mai","value":610},{"label":"Jun","value":751},{"label":"Jul","value":432},{"label":"Ago","value":590},{"label":"Set","value":446},{"label":"Out","value":436},{"label":"Nov","value":443},{"label":"Dez","value":527}];
const MX = 751;
