...
const PAGE = "Source";
const KPIS = [{"l":"Fornecedores Ativos","v":"192","t":"+2.7%","d":"up"},{"l":"Contratos (€M)","v":"€39.9M","t":"-3.1%","d":"down"},{"l":"On-Time Delivery (%)","v":"76.8%","t":"+13.5%","d":"up"},{"l":"Score Médio","v":"83","t":"+5.2%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","83.5%","€ 12604.16","3.256","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","70.8%","€ 16372.01","2.140","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","96.7%","€ 34732.15","5.058","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","89.3%","€ 19186.84","3.233","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","92.5%","€ 12991.36","1.602","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":770},{"label":"Mar","value":553},{"label":"Abr","value":757},{"label":"Mai","value":757},{"label":"Jun","value":745},{"label":"Jul","value":696},{"label":"Ago","value":713},{"label":"Set","value":612},{"label":"Out","value":586},{"label":"Nov","value":574},{"label":"Dez","value":743}];
const MX = 770;
