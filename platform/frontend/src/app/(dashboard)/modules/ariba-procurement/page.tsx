...
/* ═══ Procurement Network (SAP Ariba) — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "2907", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4052", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€106K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "794834207", cells: ["ARI-9207", "Procurement Network (SAP Ariba) Item 1", "28/12/2026", "€34 307"], status: "active" as const },
    { id: "794837778", cells: ["ARI-3778", "Procurement Network (SAP Ariba) Item 2", "15/7/2026", "€37 878"], status: "pending" as const },
    { id: "794841349", cells: ["ARI-7349", "Procurement Network (SAP Ariba) Item 3", "2/2/2026", "€41 449"], status: "completed" as const },
    { id: "794844920", cells: ["ARI-1920", "Procurement Network (SAP Ariba) Item 4", "17/9/2026", "€45 020"], status: "warning" as const },
    { id: "794848491", cells: ["ARI-5491", "Procurement Network (SAP Ariba) Item 5", "4/4/2026", "€48 591"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 67 }, { label: "Fev", value: 76 }, { label: "Mar", value: 85 }, { label: "Abr", value: 94 }, { label: "Mai", value: 23 }, { label: "Jun", value: 32 }];
...
export default function ProcurementNetworkSapAribaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Procurement Network (SAP Ariba)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Procurement Network (SAP Ariba)</p>
                    </div>
                </div>
