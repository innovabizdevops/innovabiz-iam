...
const ACCENT = "#0070f3";
const MODULE = "Procurement Network (SAP Ariba)";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"5.576","t":"+17.0%","d":"up"},{"l":"Valor Total (€M)","v":"€36.5M","t":"-2.0%","d":"down"},{"l":"Renovações Próx. 30d","v":"6.574","t":"-5.0%","d":"down"},{"l":"Obrigações Pendentes","v":"2.391","t":"+13.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 42749.51","2026-02-19","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 6367.99","2026-03-14","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 13944.41","2026-03-22","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 5958.83","2026-03-21","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 48882.04","2026-01-19","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":817},{"label":"Mar","value":660},{"label":"Abr","value":529},{"label":"Mai","value":524},{"label":"Jun","value":881},{"label":"Jul","value":780},{"label":"Ago","value":825},{"label":"Set","value":805},{"label":"Out","value":749},{"label":"Nov","value":706},{"label":"Dez","value":760}];
const MX = 881;
