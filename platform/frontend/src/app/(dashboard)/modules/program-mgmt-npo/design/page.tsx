...
const PAGE = "Program Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.161","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"3826","t":"-1.6%","d":"down"},{"l":"Documentos Gerados","v":"3.107","t":"+6.7%","d":"up"},{"l":"Templates","v":"682","t":"-4.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","491","2026-01-23","5.847","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.374","2026-03-09","8.820","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.113","2026-01-22","2.458","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.677","2026-02-12","4.420","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.382","2026-02-25","650","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":663},{"label":"Mar","value":899},{"label":"Abr","value":815},{"label":"Mai","value":882},{"label":"Jun","value":916},{"label":"Jul","value":813},{"label":"Ago","value":683},{"label":"Set","value":796},{"label":"Out","value":855},{"label":"Nov","value":827},{"label":"Dez","value":807}];
const MX = 916;
