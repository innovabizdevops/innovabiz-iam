...
const PAGE = "Outcome Mgmt";
const KPIS = [{"l":"Total Program Mgmt Npo","v":"8.307","t":"+12.5%","d":"up"},{"l":"Outcome Mgmt Ativos","v":"6.889","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+10.7%","d":"up"}];
const COLS = ["ID","Outcome Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Program Mgmt Npo #001","Program Mgmt Npo #002","2.359","8.872","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Program Mgmt Npo #002","Program Mgmt Npo #003","2.681","6.241","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Program Mgmt Npo #003","Program Mgmt Npo #004","2.142","6.666","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Program Mgmt Npo #004","Program Mgmt Npo #005","2.724","8.903","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Program Mgmt Npo #005","Program Mgmt Npo #001","470","4.365","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":370},{"label":"Mar","value":601},{"label":"Abr","value":600},{"label":"Mai","value":504},{"label":"Jun","value":532},{"label":"Jul","value":453},{"label":"Ago","value":419},{"label":"Set","value":487},{"label":"Out","value":432},{"label":"Nov","value":427},{"label":"Dez","value":330}];
const MX = 601;
