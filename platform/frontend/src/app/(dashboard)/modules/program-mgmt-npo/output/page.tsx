...
const PAGE = "Output Track";
const KPIS = [{"l":"Total Program Mgmt Npo","v":"3.411","t":"+12.0%","d":"up"},{"l":"Output Track Ativos","v":"3.244","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"89.1%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+14.5%","d":"up"}];
const COLS = ["ID","Output Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Program Mgmt Npo #001","Program Mgmt Npo #002","1.585","6.643","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Program Mgmt Npo #002","Program Mgmt Npo #003","7.868","847","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Program Mgmt Npo #003","Program Mgmt Npo #004","8.254","8.866","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Program Mgmt Npo #004","Program Mgmt Npo #005","7.708","5.776","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Program Mgmt Npo #005","Program Mgmt Npo #001","1.867","2.711","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":242},{"label":"Mar","value":430},{"label":"Abr","value":306},{"label":"Mai","value":235},{"label":"Jun","value":413},{"label":"Jul","value":458},{"label":"Ago","value":355},{"label":"Set","value":205},{"label":"Out","value":336},{"label":"Nov","value":521},{"label":"Dez","value":305}];
const MX = 521;
