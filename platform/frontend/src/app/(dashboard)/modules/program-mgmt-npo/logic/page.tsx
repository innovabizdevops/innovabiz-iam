...
const ACCENT = "#b45309";
const MODULE = "Program Management NPO";
const PAGE = "Logic Model";
const KPIS = [{"l":"Total Program Mgmt Npo","v":"2.462","t":"-3.1%","d":"down"},{"l":"Logic Model Ativos","v":"1.529","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"67","t":"+3.8%","d":"up"}];
const COLS = ["ID","Logic Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Program Mgmt Npo #001","Program Mgmt Npo #002","4.601","6.518","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Program Mgmt Npo #002","Program Mgmt Npo #003","5.726","3.271","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Program Mgmt Npo #003","Program Mgmt Npo #004","7.867","6.712","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Program Mgmt Npo #004","Program Mgmt Npo #005","1.405","6.487","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Program Mgmt Npo #005","Program Mgmt Npo #001","334","7.946","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":329},{"label":"Mar","value":455},{"label":"Abr","value":446},{"label":"Mai","value":411},{"label":"Jun","value":495},{"label":"Jul","value":684},{"label":"Ago","value":374},{"label":"Set","value":340},{"label":"Out","value":553},{"label":"Nov","value":341},{"label":"Dez","value":682}];
const MX = 684;
