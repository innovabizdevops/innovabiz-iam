...
export default function ProgramMgmtNpoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Program Mgmt Npo</h1><p className="text-sm text-muted-foreground">Program Mgmt Npo • iBOS Enterprise</p></div>
