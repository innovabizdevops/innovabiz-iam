...
const ACCENT = "#fb923c";
const MODULE = "Animal Genetics";
const PAGE = "Genotype";
const KPIS = [{"l":"Total Animal Genetics","v":"1.020","t":"+13.8%","d":"up"},{"l":"Genotype Ativos","v":"3.890","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"84.2%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"73","t":"-2.8%","d":"down"}];
const COLS = ["ID","Genotype","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Genetics #001","Animal Genetics #002","1.963","6.105","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Genetics #002","Animal Genetics #003","5.070","7.866","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Genetics #003","Animal Genetics #004","7.362","414","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Genetics #004","Animal Genetics #005","2.462","3.740","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Genetics #005","Animal Genetics #001","7.971","1.425","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":518},{"label":"Mar","value":475},{"label":"Abr","value":391},{"label":"Mai","value":659},{"label":"Jun","value":451},{"label":"Jul","value":578},{"label":"Ago","value":726},{"label":"Set","value":563},{"label":"Out","value":419},{"label":"Nov","value":356},{"label":"Dez","value":639}];
const MX = 726;
