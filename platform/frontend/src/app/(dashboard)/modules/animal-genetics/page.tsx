...
/* ═══ Animal Genetics — Dashboard ═══ */

const ACCENT = "#fb923c";

const KPIS = [
    { label: "Total Registos", value: "5674", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2091", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€329K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "905350674", cells: ["ANI-5674", "Animal Genetics Item 1", "19/7/2026", "€774"], status: "active" as const },
    { id: "905354245", cells: ["ANI-9245", "Animal Genetics Item 2", "6/2/2026", "€4345"], status: "pending" as const },
    { id: "905357816", cells: ["ANI-3816", "Animal Genetics Item 3", "21/9/2026", "€7916"], status: "completed" as const },
    { id: "905361387", cells: ["ANI-7387", "Animal Genetics Item 4", "8/4/2026", "€11 487"], status: "warning" as const },
    { id: "905364958", cells: ["ANI-1958", "Animal Genetics Item 5", "23/11/2026", "€15 058"], status: "active" as const },
];
...
export default function AnimalGeneticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Animal Genetics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Animal Genetics</p>
                    </div>
                </div>
