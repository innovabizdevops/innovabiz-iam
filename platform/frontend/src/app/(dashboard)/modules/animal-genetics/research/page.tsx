...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"6.280","t":"-4.5%","d":"down"},{"l":"Patentes (YTD)","v":"2.003","t":"+14.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"221","t":"+2.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€26.0M","t":"+13.0%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.222","90.7%","7.056","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","4.414","76.2%","7.924","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.944","80.3%","8.311","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","1.042","83.7%","4.546","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.961","96.2%","8.413","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":812},{"label":"Mar","value":666},{"label":"Abr","value":633},{"label":"Mai","value":585},{"label":"Jun","value":812},{"label":"Jul","value":835},{"label":"Ago","value":578},{"label":"Set","value":584},{"label":"Out","value":625},{"label":"Nov","value":862},{"label":"Dez","value":529}];
const MX = 865;
