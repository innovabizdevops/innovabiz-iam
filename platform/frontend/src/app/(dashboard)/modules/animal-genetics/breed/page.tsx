...
const PAGE = "Breed";
const KPIS = [{"l":"Total Animal Genetics","v":"2.744","t":"-4.2%","d":"down"},{"l":"Breed Ativos","v":"7.805","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"68.0%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"71","t":"+6.3%","d":"up"}];
const COLS = ["ID","Breed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Genetics #001","Animal Genetics #002","6.681","4.010","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Genetics #002","Animal Genetics #003","7.778","4.978","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Genetics #003","Animal Genetics #004","8.451","8.693","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Genetics #004","Animal Genetics #005","1.367","3.710","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Genetics #005","Animal Genetics #001","865","7.301","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":548},{"label":"Mar","value":505},{"label":"Abr","value":671},{"label":"Mai","value":442},{"label":"Jun","value":381},{"label":"Jul","value":675},{"label":"Ago","value":616},{"label":"Set","value":689},{"label":"Out","value":624},{"label":"Nov","value":656},{"label":"Dez","value":411}];
const MX = 689;
