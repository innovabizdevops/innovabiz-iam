...
const PAGE = "Bond";
const KPIS = [{"l":"Total Customs Broker","v":"€84778","t":"+16.4%","d":"up"},{"l":"Bond Ativos","v":"1.307","t":"+17.3%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"67","t":"-3.9%","d":"down"}];
const COLS = ["ID","Bond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Broker #001","Customs Broker #002","6.442","3.762","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Broker #002","Customs Broker #003","6.276","1.989","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Broker #003","Customs Broker #004","1.665","7.333","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Broker #004","Customs Broker #005","8.428","8.342","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Broker #005","Customs Broker #001","7.887","4.306","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":505},{"label":"Mar","value":484},{"label":"Abr","value":292},{"label":"Mai","value":539},{"label":"Jun","value":326},{"label":"Jul","value":557},{"label":"Ago","value":260},{"label":"Set","value":536},{"label":"Out","value":273},{"label":"Nov","value":299},{"label":"Dez","value":311}];
const MX = 568;
