...
const PAGE = "Entry";
const KPIS = [{"l":"Total Customs Broker","v":"€23285","t":"+6.0%","d":"up"},{"l":"Entry Ativos","v":"2.882","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"62","t":"+0.8%","d":"up"}];
const COLS = ["ID","Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Broker #001","Customs Broker #002","3.996","5.100","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Broker #002","Customs Broker #003","7.897","5.778","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Broker #003","Customs Broker #004","1.361","6.180","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Broker #004","Customs Broker #005","595","5.082","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Broker #005","Customs Broker #001","2.079","420","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":970},{"label":"Mar","value":835},{"label":"Abr","value":711},{"label":"Mai","value":806},{"label":"Jun","value":802},{"label":"Jul","value":909},{"label":"Ago","value":792},{"label":"Set","value":840},{"label":"Out","value":974},{"label":"Nov","value":903},{"label":"Dez","value":665}];
const MX = 974;
