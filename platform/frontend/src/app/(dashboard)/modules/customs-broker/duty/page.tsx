...
const PAGE = "Duty";
const KPIS = [{"l":"Total Customs Broker","v":"€30180","t":"-5.6%","d":"down"},{"l":"Duty Ativos","v":"7.998","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+1.8%","d":"up"}];
const COLS = ["ID","Duty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Broker #001","Customs Broker #002","3.336","5.766","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Broker #002","Customs Broker #003","6.349","5.152","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Broker #003","Customs Broker #004","2.964","6.007","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Broker #004","Customs Broker #005","3.792","4.812","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Broker #005","Customs Broker #001","8.998","4.910","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":761},{"label":"Mar","value":711},{"label":"Abr","value":786},{"label":"Mai","value":572},{"label":"Jun","value":443},{"label":"Jul","value":621},{"label":"Ago","value":540},{"label":"Set","value":569},{"label":"Out","value":684},{"label":"Nov","value":768},{"label":"Dez","value":737}];
const MX = 786;
