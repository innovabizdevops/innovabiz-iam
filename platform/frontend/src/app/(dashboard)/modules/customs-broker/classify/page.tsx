...
const ACCENT = "#6366f1";
const MODULE = "Customs Brokerage";
const PAGE = "Classify";
const KPIS = [{"l":"Total Customs Broker","v":"€21487","t":"+4.1%","d":"up"},{"l":"Classify Ativos","v":"8.376","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"89.1%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"74","t":"+7.5%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Broker #001","Customs Broker #002","4.093","8.049","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Broker #002","Customs Broker #003","8.658","5.419","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Broker #003","Customs Broker #004","5.402","6.472","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Broker #004","Customs Broker #005","1.312","1.797","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Broker #005","Customs Broker #001","4.984","5.588","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":902},{"label":"Mar","value":987},{"label":"Abr","value":955},{"label":"Mai","value":948},{"label":"Jun","value":916},{"label":"Jul","value":990},{"label":"Ago","value":766},{"label":"Set","value":987},{"label":"Out","value":645},{"label":"Nov","value":905},{"label":"Dez","value":797}];
const MX = 990;
