...
const PAGE = "Client";
const KPIS = [{"l":"Total Customs Broker","v":"€96006","t":"+3.4%","d":"up"},{"l":"Client Ativos","v":"6.232","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-1.9%","d":"down"}];
const COLS = ["ID","Client","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Broker #001","Customs Broker #002","2.853","6.197","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Broker #002","Customs Broker #003","7.497","1.338","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Broker #003","Customs Broker #004","2.848","6.218","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Broker #004","Customs Broker #005","763","801","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Broker #005","Customs Broker #001","2.603","7.422","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":452},{"label":"Mar","value":649},{"label":"Abr","value":413},{"label":"Mai","value":389},{"label":"Jun","value":599},{"label":"Jul","value":459},{"label":"Ago","value":595},{"label":"Set","value":678},{"label":"Out","value":634},{"label":"Nov","value":469},{"label":"Dez","value":629}];
const MX = 678;
