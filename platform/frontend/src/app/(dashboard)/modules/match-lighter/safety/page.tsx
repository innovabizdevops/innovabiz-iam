...
const PAGE = "Safety";
const KPIS = [{"l":"Atletas Registados","v":"5.987","t":"-4.2%","d":"down"},{"l":"Treinos/Semana","v":"4071","t":"+13.0%","d":"up"},{"l":"Competições","v":"818","t":"+1.3%","d":"up"},{"l":"Performance Score","v":"75","t":"-5.5%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.085","4.738","5.420","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.357","1.127","1.255","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.607","815","3.642","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","323","3.032","120","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","680","4.202","6.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":333},{"label":"Mar","value":470},{"label":"Abr","value":471},{"label":"Mai","value":456},{"label":"Jun","value":531},{"label":"Jul","value":474},{"label":"Ago","value":295},{"label":"Set","value":400},{"label":"Out","value":555},{"label":"Nov","value":556},{"label":"Dez","value":478}];
const MX = 593;
