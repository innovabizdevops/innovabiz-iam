...
const PAGE = "Ship";
const KPIS = [{"l":"Atletas Registados","v":"5.222","t":"-2.6%","d":"down"},{"l":"Treinos/Semana","v":"4723","t":"+2.5%","d":"up"},{"l":"Competições","v":"4.130","t":"-3.0%","d":"down"},{"l":"Performance Score","v":"81","t":"-4.4%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.959","3.232","1.987","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","176","713","1.556","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.395","2.941","4.177","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.639","295","4.904","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.881","2.079","815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":816},{"label":"Mar","value":768},{"label":"Abr","value":1013},{"label":"Mai","value":838},{"label":"Jun","value":923},{"label":"Jul","value":831},{"label":"Ago","value":1007},{"label":"Set","value":1007},{"label":"Out","value":707},{"label":"Nov","value":984},{"label":"Dez","value":739}];
const MX = 1013;
