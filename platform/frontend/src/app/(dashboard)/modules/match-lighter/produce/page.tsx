...
const ACCENT = "#f97316";
const MODULE = "Match & Lighter Mfg";
const PAGE = "Produce";
const KPIS = [{"l":"Atletas Registados","v":"2.200","t":"+9.8%","d":"up"},{"l":"Treinos/Semana","v":"3604","t":"-3.0%","d":"down"},{"l":"Competições","v":"6.853","t":"+14.8%","d":"up"},{"l":"Performance Score","v":"91","t":"+14.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.107","8.402","1.316","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.058","6.594","3.892","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.698","1.779","3.708","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.966","1.012","3.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.107","6.700","892","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":650},{"label":"Mar","value":543},{"label":"Abr","value":803},{"label":"Mai","value":545},{"label":"Jun","value":766},{"label":"Jul","value":509},{"label":"Ago","value":708},{"label":"Set","value":534},{"label":"Out","value":625},{"label":"Nov","value":667},{"label":"Dez","value":528}];
const MX = 803;
