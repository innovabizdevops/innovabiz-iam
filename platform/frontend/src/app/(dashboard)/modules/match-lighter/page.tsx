...
/* ═══ Match & Lighter Mfg — Dashboard ═══ */

const ACCENT = "#f97316";

const KPIS = [
    { label: "Total Registos", value: "6818", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3265", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€102K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "40002718", cells: ["MAT-7718", "Match & Lighter Mfg Item 1", "15/11/2026", "€2818"], status: "active" as const },
    { id: "40006289", cells: ["MAT-2289", "Match & Lighter Mfg Item 2", "2/6/2026", "€6389"], status: "pending" as const },
    { id: "40009860", cells: ["MAT-5860", "Match & Lighter Mfg Item 3", "17/1/2026", "€9960"], status: "completed" as const },
    { id: "40013431", cells: ["MAT-9431", "Match & Lighter Mfg Item 4", "4/8/2026", "€13 531"], status: "warning" as const },
    { id: "40017002", cells: ["MAT-4002", "Match & Lighter Mfg Item 5", "19/3/2026", "€17 102"], status: "active" as const },
];
...
export default function MatchLighterMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Match & Lighter Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Match & Lighter Mfg</p>
                    </div>
                </div>
