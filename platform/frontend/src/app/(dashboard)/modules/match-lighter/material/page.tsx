...
const PAGE = "Material";
const KPIS = [{"l":"Atletas Registados","v":"3.952","t":"+16.9%","d":"up"},{"l":"Treinos/Semana","v":"4075","t":"+7.2%","d":"up"},{"l":"Competições","v":"1.998","t":"-5.4%","d":"down"},{"l":"Performance Score","v":"86","t":"+4.9%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.827","2.492","5.283","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.435","5.154","609","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.291","2.481","1.038","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.408","2.891","1.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.855","5.484","6.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":269},{"label":"Mar","value":624},{"label":"Abr","value":592},{"label":"Mai","value":278},{"label":"Jun","value":552},{"label":"Jul","value":591},{"label":"Ago","value":507},{"label":"Set","value":336},{"label":"Out","value":434},{"label":"Nov","value":448},{"label":"Dez","value":313}];
const MX = 624;
