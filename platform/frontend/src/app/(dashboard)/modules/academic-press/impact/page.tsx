...
const PAGE = "Impact Factor";
const KPIS = [{"l":"Projetos Sociais","v":"4.145","t":"+2.6%","d":"up"},{"l":"Beneficiários","v":"1.841","t":"+10.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€17335","t":"-0.2%","d":"down"},{"l":"Score Impacto","v":"58","t":"+3.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.865","€ 45582.06","8.205","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.515","€ 42203.99","5.733","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.321","€ 23088.62","1.970","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.730","€ 37225.50","710","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.451","€ 2913.93","6.475","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":543},{"label":"Mar","value":455},{"label":"Abr","value":650},{"label":"Mai","value":523},{"label":"Jun","value":667},{"label":"Jul","value":500},{"label":"Ago","value":506},{"label":"Set","value":741},{"label":"Out","value":770},{"label":"Nov","value":551},{"label":"Dez","value":593}];
const MX = 770;
