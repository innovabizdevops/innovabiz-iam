...
const PAGE = "Series Mgmt";
const KPIS = [{"l":"Total Academic Press","v":"6.195","t":"+5.5%","d":"up"},{"l":"Series Mgmt Ativos","v":"3.284","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"93.0%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+5.0%","d":"up"}];
const COLS = ["ID","Series Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Academic Press #001","Academic Press #002","206","3.821","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Academic Press #002","Academic Press #003","3.509","2.921","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Academic Press #003","Academic Press #004","494","3.288","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Academic Press #004","Academic Press #005","6.374","6.732","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Academic Press #005","Academic Press #001","7.735","8.073","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":893},{"label":"Mar","value":848},{"label":"Abr","value":615},{"label":"Mai","value":618},{"label":"Jun","value":725},{"label":"Jul","value":798},{"label":"Ago","value":661},{"label":"Set","value":715},{"label":"Out","value":676},{"label":"Nov","value":759},{"label":"Dez","value":674}];
const MX = 896;
