...
const ACCENT = "#78350f";
const MODULE = "Academic Press";
const PAGE = "Reviewer Pool";
const KPIS = [{"l":"Total Academic Press","v":"3.752","t":"+6.4%","d":"up"},{"l":"Reviewer Pool Ativos","v":"2.076","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"89.1%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"83","t":"+4.7%","d":"up"}];
const COLS = ["ID","Reviewer Pool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Academic Press #001","Academic Press #002","1.158","6.573","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Academic Press #002","Academic Press #003","4.436","913","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Academic Press #003","Academic Press #004","906","8.555","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Academic Press #004","Academic Press #005","143","8.257","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Academic Press #005","Academic Press #001","5.935","8.644","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":449},{"label":"Mar","value":462},{"label":"Abr","value":401},{"label":"Mai","value":608},{"label":"Jun","value":410},{"label":"Jul","value":544},{"label":"Ago","value":311},{"label":"Set","value":427},{"label":"Out","value":322},{"label":"Nov","value":428},{"label":"Dez","value":475}];
const MX = 608;
