...
const KPIS = [{"l":"Total Academic Press","v":"1.973","t":"+5.9%","d":"up"},{"l":"Publication Ativos","v":"7.637","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"91","t":"+14.2%","d":"up"}];
const COLS = ["ID","Publication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Academic Press #001","Academic Press #002","3.025","2.347","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Academic Press #002","Academic Press #003","3.299","775","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Academic Press #003","Academic Press #004","8.089","5.834","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Academic Press #004","Academic Press #005","1.187","8.478","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Academic Press #005","Academic Press #001","1.184","6.379","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":1079},{"label":"Mar","value":854},{"label":"Abr","value":946},{"label":"Mai","value":781},{"label":"Jun","value":1047},{"label":"Jul","value":836},{"label":"Ago","value":755},{"label":"Set","value":777},{"label":"Out","value":883},{"label":"Nov","value":958},{"label":"Dez","value":859}];
const MX = 1079;
