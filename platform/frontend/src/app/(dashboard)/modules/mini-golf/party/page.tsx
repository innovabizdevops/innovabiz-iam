...
const PAGE = "Party";
const KPIS = [{"l":"Total Mini Golf","v":"3.778","t":"+9.3%","d":"up"},{"l":"Party Ativos","v":"361","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"86.1%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"95","t":"+4.8%","d":"up"}];
const COLS = ["ID","Party","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mini Golf #001","Mini Golf #002","6.936","2.042","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Mini Golf #002","Mini Golf #003","4.849","4.556","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Mini Golf #003","Mini Golf #004","7.196","3.200","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Mini Golf #004","Mini Golf #005","4.899","5.087","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mini Golf #005","Mini Golf #001","4.950","6.088","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":335},{"label":"Mar","value":359},{"label":"Abr","value":579},{"label":"Mai","value":478},{"label":"Jun","value":342},{"label":"Jul","value":342},{"label":"Ago","value":514},{"label":"Set","value":496},{"label":"Out","value":611},{"label":"Nov","value":597},{"label":"Dez","value":264}];
const MX = 611;
