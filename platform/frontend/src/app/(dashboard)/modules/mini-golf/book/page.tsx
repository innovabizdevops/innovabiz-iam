...
const PAGE = "Book";
const KPIS = [{"l":"Total Mini Golf","v":"8.398","t":"+4.5%","d":"up"},{"l":"Book Ativos","v":"1.308","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"82.9%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"84","t":"+5.3%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mini Golf #001","Mini Golf #002","1.155","7.346","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Mini Golf #002","Mini Golf #003","6.062","6.022","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Mini Golf #003","Mini Golf #004","8.025","7.473","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Mini Golf #004","Mini Golf #005","7.634","480","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mini Golf #005","Mini Golf #001","7.453","3.451","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":339},{"label":"Mar","value":602},{"label":"Abr","value":502},{"label":"Mai","value":327},{"label":"Jun","value":320},{"label":"Jul","value":477},{"label":"Ago","value":542},{"label":"Set","value":634},{"label":"Out","value":459},{"label":"Nov","value":435},{"label":"Dez","value":583}];
const MX = 634;
