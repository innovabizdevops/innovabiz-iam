...
/* ═══ Mini Golf Entertainment — Dashboard ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total Registos", value: "347", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3059", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€228K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "835144447", cells: ["MIN-8447", "Mini Golf Entertainment Item 1", "12/8/2026", "€44 547"], status: "active" as const },
    { id: "835148018", cells: ["MIN-3018", "Mini Golf Entertainment Item 2", "27/3/2026", "€48 118"], status: "pending" as const },
    { id: "835151589", cells: ["MIN-6589", "Mini Golf Entertainment Item 3", "14/10/2026", "€1689"], status: "completed" as const },
    { id: "835155160", cells: ["MIN-1160", "Mini Golf Entertainment Item 4", "1/5/2026", "€5260"], status: "warning" as const },
    { id: "835158731", cells: ["MIN-4731", "Mini Golf Entertainment Item 5", "16/12/2026", "€8831"], status: "active" as const },
];
...
export default function MiniGolfEntertainmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mini Golf Entertainment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mini Golf Entertainment</p>
                    </div>
                </div>
