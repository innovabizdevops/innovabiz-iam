...
const PAGE = "FnB";
const KPIS = [{"l":"Total Mini Golf","v":"8.717","t":"-1.0%","d":"down"},{"l":"FnB Ativos","v":"4.451","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"87","t":"+7.6%","d":"up"}];
const COLS = ["ID","FnB","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mini Golf #001","Mini Golf #002","1.714","2.329","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Mini Golf #002","Mini Golf #003","2.169","830","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Mini Golf #003","Mini Golf #004","8.368","1.884","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mini Golf #004","Mini Golf #005","6.040","1.730","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mini Golf #005","Mini Golf #001","2.230","7.627","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":535},{"label":"Mar","value":483},{"label":"Abr","value":637},{"label":"Mai","value":644},{"label":"Jun","value":701},{"label":"Jul","value":495},{"label":"Ago","value":645},{"label":"Set","value":669},{"label":"Out","value":324},{"label":"Nov","value":709},{"label":"Dez","value":335}];
const MX = 709;
