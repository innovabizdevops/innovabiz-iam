...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€32.7M","t":"+12.1%","d":"up"},{"l":"MRR (€)","v":"€23982","t":"+0.0%","d":"up"},{"l":"Churn (%)","v":"88.3%","t":"+7.1%","d":"up"},{"l":"ARPU (€)","v":"€91175","t":"+14.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2247.26","7.234","€ 845.06","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 18407.56","7.324","€ 1060.41","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46589.78","1.261","€ 22687.91","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7013.74","2.747","€ 38608.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35923.03","2.759","€ 43288.85","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":453},{"label":"Mar","value":410},{"label":"Abr","value":403},{"label":"Mai","value":627},{"label":"Jun","value":571},{"label":"Jul","value":669},{"label":"Ago","value":363},{"label":"Set","value":552},{"label":"Out","value":387},{"label":"Nov","value":656},{"label":"Dez","value":547}];
const MX = 669;
