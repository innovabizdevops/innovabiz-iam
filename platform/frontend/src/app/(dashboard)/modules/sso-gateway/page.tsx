...
export default function SsoGatewayPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sso Gateway</h1><p className="text-sm text-muted-foreground">Sso Gateway • iBOS Enterprise</p></div>
