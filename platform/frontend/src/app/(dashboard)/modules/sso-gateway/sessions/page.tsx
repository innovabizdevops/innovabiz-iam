...
const KPIS = [{"l":"Utilizadores Ativos","v":"6.162","t":"+6.1%","d":"up"},{"l":"Sessões/Dia","v":"4627","t":"+1.6%","d":"up"},{"l":"MFA Adoção (%)","v":"81.3%","t":"+6.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.206","t":"+17.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.583","5.816","2.905","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.850","2.289","8.657","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.330","1.664","5.519","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.400","6.063","1.697","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.551","2.747","4.398","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":948},{"label":"Mar","value":778},{"label":"Abr","value":945},{"label":"Mai","value":695},{"label":"Jun","value":968},{"label":"Jul","value":1029},{"label":"Ago","value":976},{"label":"Set","value":1083},{"label":"Out","value":756},{"label":"Nov","value":803},{"label":"Dez","value":1080}];
const MX = 1083;
