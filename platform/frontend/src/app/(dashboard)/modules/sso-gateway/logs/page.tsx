...
const PAGE = "Access Logs";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.122","t":"+13.0%","d":"up"},{"l":"Sessões/Dia","v":"1561","t":"+5.5%","d":"up"},{"l":"MFA Adoção (%)","v":"84.7%","t":"+2.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"1.589","t":"+3.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","243","1.830","1.132","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","979","5.801","6.279","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","9.053","1.362","725","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","983","2.289","2.286","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.359","8.508","6.257","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":454},{"label":"Mar","value":625},{"label":"Abr","value":348},{"label":"Mai","value":427},{"label":"Jun","value":386},{"label":"Jul","value":636},{"label":"Ago","value":409},{"label":"Set","value":380},{"label":"Out","value":449},{"label":"Nov","value":372},{"label":"Dez","value":710}];
const MX = 710;
