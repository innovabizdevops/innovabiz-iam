...
const PAGE = "SAML Config";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.787","t":"+13.1%","d":"up"},{"l":"Sessões/Dia","v":"4530","t":"+15.9%","d":"up"},{"l":"MFA Adoção (%)","v":"90.0%","t":"+7.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.055","t":"+1.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.348","6.052","3.632","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.338","2.554","7.784","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.201","8.428","597","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","7.888","4.130","6.197","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.871","8.519","2.236","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":480},{"label":"Mar","value":828},{"label":"Abr","value":675},{"label":"Mai","value":457},{"label":"Jun","value":728},{"label":"Jul","value":771},{"label":"Ago","value":703},{"label":"Set","value":683},{"label":"Out","value":477},{"label":"Nov","value":478},{"label":"Dez","value":650}];
const MX = 828;
