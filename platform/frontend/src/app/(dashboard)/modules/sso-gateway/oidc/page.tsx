...
const ACCENT = "#059669";
const MODULE = "SSO Gateway";
const PAGE = "OIDC Config";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.547","t":"-0.6%","d":"down"},{"l":"Sessões/Dia","v":"3205","t":"+1.5%","d":"up"},{"l":"MFA Adoção (%)","v":"94.3%","t":"-3.5%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.490","t":"+14.8%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.248","1.884","3.986","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.352","8.643","1.328","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.259","2.002","7.037","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","241","2.285","1.864","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.863","3.183","7.615","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":238},{"label":"Fev","value":600},{"label":"Mar","value":292},{"label":"Abr","value":581},{"label":"Mai","value":339},{"label":"Jun","value":343},{"label":"Jul","value":312},{"label":"Ago","value":438},{"label":"Set","value":210},{"label":"Out","value":543},{"label":"Nov","value":344},{"label":"Dez","value":223}];
const MX = 600;
