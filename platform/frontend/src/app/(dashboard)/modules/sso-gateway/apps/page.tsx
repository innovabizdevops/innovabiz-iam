...
const PAGE = "App Catalog";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.439","t":"+4.7%","d":"up"},{"l":"Sessões/Dia","v":"4516","t":"+1.4%","d":"up"},{"l":"MFA Adoção (%)","v":"71.3%","t":"+10.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.806","t":"+10.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.557","3.073","682","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.794","7.101","5.944","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.034","8.667","5.766","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.244","8.070","8.330","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.287","4.811","3.102","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":831},{"label":"Mar","value":524},{"label":"Abr","value":599},{"label":"Mai","value":751},{"label":"Jun","value":687},{"label":"Jul","value":781},{"label":"Ago","value":775},{"label":"Set","value":448},{"label":"Out","value":806},{"label":"Nov","value":648},{"label":"Dez","value":608}];
const MX = 831;
