...
const KPIS = [{"l":"Total Cloud Migrate","v":"5.184","t":"+11.5%","d":"up"},{"l":"Validation Ativos","v":"127","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"74.9%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"59","t":"+15.1%","d":"up"}];
const COLS = ["ID","Validation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migrate #001","Cloud Migrate #002","5.330","8.381","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migrate #002","Cloud Migrate #003","7.411","1.548","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migrate #003","Cloud Migrate #004","5.282","6.315","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migrate #004","Cloud Migrate #005","1.376","7.382","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migrate #005","Cloud Migrate #001","7.121","6.726","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":652},{"label":"Mar","value":801},{"label":"Abr","value":783},{"label":"Mai","value":1021},{"label":"Jun","value":868},{"label":"Jul","value":962},{"label":"Ago","value":1043},{"label":"Set","value":766},{"label":"Out","value":918},{"label":"Nov","value":888},{"label":"Dez","value":803}];
const MX = 1043;
