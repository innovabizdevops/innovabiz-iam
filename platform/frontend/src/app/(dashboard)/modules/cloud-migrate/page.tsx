...
export default function CloudMigratePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cloud Migrate</h1><p className="text-sm text-muted-foreground">Cloud Migrate • iBOS Enterprise</p></div>
