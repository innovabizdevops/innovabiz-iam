...
const KPIS = [{"l":"Total Cloud Migrate","v":"1.359","t":"+4.6%","d":"up"},{"l":"Assessment Ativos","v":"6.693","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"91","t":"+15.9%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migrate #001","Cloud Migrate #002","7.833","1.186","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migrate #002","Cloud Migrate #003","3.257","2.066","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migrate #003","Cloud Migrate #004","1.880","747","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migrate #004","Cloud Migrate #005","7.589","849","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migrate #005","Cloud Migrate #001","8.221","6.725","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":948},{"label":"Fev","value":646},{"label":"Mar","value":706},{"label":"Abr","value":690},{"label":"Mai","value":694},{"label":"Jun","value":793},{"label":"Jul","value":910},{"label":"Ago","value":817},{"label":"Set","value":841},{"label":"Out","value":586},{"label":"Nov","value":748},{"label":"Dez","value":893}];
const MX = 948;
