...
const PAGE = "Wave Plan";
const KPIS = [{"l":"Total Cloud Migrate","v":"6.776","t":"-4.1%","d":"down"},{"l":"Wave Plan Ativos","v":"698","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"66.7%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+0.5%","d":"up"}];
const COLS = ["ID","Wave Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migrate #001","Cloud Migrate #002","3.422","5.667","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migrate #002","Cloud Migrate #003","493","8.843","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migrate #003","Cloud Migrate #004","4.994","1.381","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migrate #004","Cloud Migrate #005","296","5.136","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migrate #005","Cloud Migrate #001","7.780","5.880","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":597},{"label":"Mar","value":328},{"label":"Abr","value":398},{"label":"Mai","value":663},{"label":"Jun","value":484},{"label":"Jul","value":483},{"label":"Ago","value":511},{"label":"Set","value":570},{"label":"Out","value":435},{"label":"Nov","value":332},{"label":"Dez","value":468}];
const MX = 663;
