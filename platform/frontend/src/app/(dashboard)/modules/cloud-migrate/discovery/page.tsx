...
const ACCENT = "#0e7490";
const MODULE = "Cloud Migration";
const PAGE = "Discovery";
const KPIS = [{"l":"Total Cloud Migrate","v":"5.252","t":"-0.1%","d":"down"},{"l":"Discovery Ativos","v":"6.070","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"69","t":"-3.3%","d":"down"}];
const COLS = ["ID","Discovery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cloud Migrate #001","Cloud Migrate #002","1.673","7.776","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cloud Migrate #002","Cloud Migrate #003","2.021","8.732","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Cloud Migrate #003","Cloud Migrate #004","1.256","393","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Cloud Migrate #004","Cloud Migrate #005","4.101","5.927","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cloud Migrate #005","Cloud Migrate #001","1.038","4.369","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":588},{"label":"Mar","value":250},{"label":"Abr","value":388},{"label":"Mai","value":322},{"label":"Jun","value":554},{"label":"Jul","value":286},{"label":"Ago","value":243},{"label":"Set","value":290},{"label":"Out","value":502},{"label":"Nov","value":292},{"label":"Dez","value":454}];
const MX = 617;
