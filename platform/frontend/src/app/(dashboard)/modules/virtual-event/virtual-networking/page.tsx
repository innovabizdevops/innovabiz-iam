...
const ROWS = [
  { id: "001", c: ["Virtual Networking-001", "Virtual Networking Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Virtual Networking-002", "Virtual Networking Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Virtual Networking-003", "Virtual Networking Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Virtual Networking-004", "Virtual Networking Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Virtual Networking-005", "Virtual Networking Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Virtual Networking", ts: "Há 2min", a: "Sistema" },
...
export default function VirtualNetworkingPage() {
  return (
