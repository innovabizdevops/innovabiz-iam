...
const ROWS = [
  { id: "001", c: ["On Demand Library-001", "On Demand Library Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["On Demand Library-002", "On Demand Library Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["On Demand Library-003", "On Demand Library Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["On Demand Library-004", "On Demand Library Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["On Demand Library-005", "On Demand Library Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em On Demand Library", ts: "Há 2min", a: "Sistema" },
...
export default function OnDemandLibraryPage() {
  return (
