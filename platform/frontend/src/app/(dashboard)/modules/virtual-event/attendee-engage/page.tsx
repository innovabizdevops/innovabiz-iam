...
const ROWS = [
  { id: "001", c: ["Attendee Engage-001", "Attendee Engage Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Attendee Engage-002", "Attendee Engage Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Attendee Engage-003", "Attendee Engage Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Attendee Engage-004", "Attendee Engage Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Attendee Engage-005", "Attendee Engage Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Attendee Engage", ts: "Há 2min", a: "Sistema" },
...
export default function AttendeeEngagePage() {
  return (
