...
const ROWS = [
  { id: "001", c: ["Hybrid Event-001", "Hybrid Event Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Hybrid Event-002", "Hybrid Event Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Hybrid Event-003", "Hybrid Event Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Hybrid Event-004", "Hybrid Event Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Hybrid Event-005", "Hybrid Event Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Hybrid Event", ts: "Há 2min", a: "Sistema" },
...
export default function HybridEventPage() {
  return (
