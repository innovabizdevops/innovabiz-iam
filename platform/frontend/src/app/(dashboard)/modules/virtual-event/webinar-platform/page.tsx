...
const ROWS = [
  { id: "001", c: ["Webinar Platform-001", "Webinar Platform Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Webinar Platform-002", "Webinar Platform Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Webinar Platform-003", "Webinar Platform Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Webinar Platform-004", "Webinar Platform Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Webinar Platform-005", "Webinar Platform Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Webinar Platform", ts: "Há 2min", a: "Sistema" },
...
export default function WebinarPlatformPage() {
  return (
