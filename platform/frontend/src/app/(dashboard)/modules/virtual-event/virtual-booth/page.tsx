...
const ROWS = [
  { id: "001", c: ["Virtual Booth-001", "Virtual Booth Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Virtual Booth-002", "Virtual Booth Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Virtual Booth-003", "Virtual Booth Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Virtual Booth-004", "Virtual Booth Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Virtual Booth-005", "Virtual Booth Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Virtual Booth", ts: "Há 2min", a: "Sistema" },
