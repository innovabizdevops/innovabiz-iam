...
const PAGE = "Pack";
const KPIS = [{"l":"Total Candle Mfg","v":"6.725","t":"+15.4%","d":"up"},{"l":"Pack Ativos","v":"1.329","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"92.2%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+16.1%","d":"up"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Candle Mfg #001","Candle Mfg #002","1.413","5.330","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Candle Mfg #002","Candle Mfg #003","5.822","3.771","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Candle Mfg #003","Candle Mfg #004","2.905","906","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Candle Mfg #004","Candle Mfg #005","6.197","173","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Candle Mfg #005","Candle Mfg #001","5.669","7.645","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":869},{"label":"Mar","value":740},{"label":"Abr","value":889},{"label":"Mai","value":609},{"label":"Jun","value":659},{"label":"Jul","value":690},{"label":"Ago","value":916},{"label":"Set","value":762},{"label":"Out","value":654},{"label":"Nov","value":785},{"label":"Dez","value":568}];
const MX = 916;
