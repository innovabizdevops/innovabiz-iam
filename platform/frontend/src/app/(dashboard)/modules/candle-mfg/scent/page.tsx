...
const PAGE = "Scent";
const KPIS = [{"l":"Total Candle Mfg","v":"2.484","t":"+8.4%","d":"up"},{"l":"Scent Ativos","v":"6.490","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+17.7%","d":"up"}];
const COLS = ["ID","Scent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Candle Mfg #001","Candle Mfg #002","5.652","1.720","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Candle Mfg #002","Candle Mfg #003","5.803","193","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Candle Mfg #003","Candle Mfg #004","300","4.200","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Candle Mfg #004","Candle Mfg #005","8.326","7.539","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Candle Mfg #005","Candle Mfg #001","594","898","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":778},{"label":"Mar","value":935},{"label":"Abr","value":814},{"label":"Mai","value":820},{"label":"Jun","value":887},{"label":"Jul","value":862},{"label":"Ago","value":1010},{"label":"Set","value":948},{"label":"Out","value":1039},{"label":"Nov","value":861},{"label":"Dez","value":849}];
const MX = 1039;
