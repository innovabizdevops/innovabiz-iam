...
const PAGE = "Wax";
const KPIS = [{"l":"Total Candle Mfg","v":"6.770","t":"-3.0%","d":"down"},{"l":"Wax Ativos","v":"8.369","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"60","t":"+0.1%","d":"up"}];
const COLS = ["ID","Wax","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Candle Mfg #001","Candle Mfg #002","7.346","5.987","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Candle Mfg #002","Candle Mfg #003","1.154","6.247","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Candle Mfg #003","Candle Mfg #004","6.361","7.002","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Candle Mfg #004","Candle Mfg #005","4.913","7.334","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Candle Mfg #005","Candle Mfg #001","4.215","6.775","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":845},{"label":"Mar","value":823},{"label":"Abr","value":728},{"label":"Mai","value":604},{"label":"Jun","value":814},{"label":"Jul","value":552},{"label":"Ago","value":735},{"label":"Set","value":739},{"label":"Out","value":587},{"label":"Nov","value":540},{"label":"Dez","value":702}];
const MX = 845;
