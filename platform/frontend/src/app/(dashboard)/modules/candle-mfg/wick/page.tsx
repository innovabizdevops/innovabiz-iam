...
const ACCENT = "#fbbf24";
const MODULE = "Candle Manufacturing";
const PAGE = "Wick";
const KPIS = [{"l":"Total Candle Mfg","v":"8.865","t":"+2.8%","d":"up"},{"l":"Wick Ativos","v":"3.566","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+13.2%","d":"up"}];
const COLS = ["ID","Wick","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Candle Mfg #001","Candle Mfg #002","237","5.054","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Candle Mfg #002","Candle Mfg #003","7.603","4.795","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Candle Mfg #003","Candle Mfg #004","2.165","4.044","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Candle Mfg #004","Candle Mfg #005","5.749","1.734","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Candle Mfg #005","Candle Mfg #001","8.500","4.224","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":882},{"label":"Mar","value":711},{"label":"Abr","value":960},{"label":"Mai","value":911},{"label":"Jun","value":609},{"label":"Jul","value":733},{"label":"Ago","value":745},{"label":"Set","value":892},{"label":"Out","value":945},{"label":"Nov","value":859},{"label":"Dez","value":778}];
const MX = 960;
