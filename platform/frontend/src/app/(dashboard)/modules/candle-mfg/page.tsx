...
/* ═══ Candle Manufacturing — Dashboard ═══ */

const ACCENT = "#fbbf24";

const KPIS = [
    { label: "Total Registos", value: "7509", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2970", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€59K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2076265109", cells: ["CAN-2109", "Candle Manufacturing Item 1", "10/6/2026", "€15 209"], status: "active" as const },
    { id: "2076268680", cells: ["CAN-5680", "Candle Manufacturing Item 2", "25/1/2026", "€18 780"], status: "pending" as const },
    { id: "2076272251", cells: ["CAN-9251", "Candle Manufacturing Item 3", "12/8/2026", "€22 351"], status: "completed" as const },
    { id: "2076275822", cells: ["CAN-3822", "Candle Manufacturing Item 4", "27/3/2026", "€25 922"], status: "warning" as const },
    { id: "2076279393", cells: ["CAN-7393", "Candle Manufacturing Item 5", "14/10/2026", "€29 493"], status: "active" as const },
];
...
export default function CandleManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Candle Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Candle Manufacturing</p>
                    </div>
                </div>
