...
/* ═══ Industrial Packaging — Dashboard ═══ */

const ACCENT = "#a16207";

const KPIS = [
    { label: "Total Registos", value: "8424", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2702", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€64K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "535855724", cells: ["IND-5724", "Industrial Packaging Item 1", "13/9/2026", "€5824"], status: "active" as const },
    { id: "535859295", cells: ["IND-9295", "Industrial Packaging Item 2", "28/4/2026", "€9395"], status: "pending" as const },
    { id: "535862866", cells: ["IND-3866", "Industrial Packaging Item 3", "15/11/2026", "€12 966"], status: "completed" as const },
    { id: "535866437", cells: ["IND-7437", "Industrial Packaging Item 4", "2/6/2026", "€16 537"], status: "warning" as const },
    { id: "535870008", cells: ["IND-2008", "Industrial Packaging Item 5", "17/1/2026", "€20 108"], status: "active" as const },
];
...
export default function IndustrialPackagingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Industrial Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Industrial Packaging</p>
                    </div>
                </div>
