...
const ACCENT = "#a16207";
const MODULE = "Industrial Packaging";
const PAGE = "Strap";
const KPIS = [{"l":"Total Industrial Pack","v":"6.471","t":"+9.5%","d":"up"},{"l":"Strap Ativos","v":"5.961","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"57","t":"+3.9%","d":"up"}];
const COLS = ["ID","Strap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industrial Pack #001","Industrial Pack #002","6.182","7.573","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Industrial Pack #002","Industrial Pack #003","6.816","1.214","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Industrial Pack #003","Industrial Pack #004","3.234","3.138","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Industrial Pack #004","Industrial Pack #005","4.689","4.892","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industrial Pack #005","Industrial Pack #001","6.147","2.901","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":921},{"label":"Mar","value":975},{"label":"Abr","value":906},{"label":"Mai","value":849},{"label":"Jun","value":1021},{"label":"Jul","value":886},{"label":"Ago","value":773},{"label":"Set","value":834},{"label":"Out","value":720},{"label":"Nov","value":914},{"label":"Dez","value":778}];
const MX = 1021;
...
export default function StrapPage() {
    return (
