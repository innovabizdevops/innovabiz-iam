...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.692","t":"+12.0%","d":"up"},{"l":"NC Abertas","v":"7.812","t":"+17.3%","d":"up"},{"l":"Conformidade (%)","v":"67.9%","t":"-5.8%","d":"down"},{"l":"CAPAs Pendentes","v":"1.566","t":"-4.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.135","73.3%","4.009","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.204","78.7%","4.172","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.285","82.1%","7.017","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.453","100.0%","5.206","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.459","93.0%","1.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":448},{"label":"Mar","value":417},{"label":"Abr","value":473},{"label":"Mai","value":301},{"label":"Jun","value":476},{"label":"Jul","value":399},{"label":"Ago","value":416},{"label":"Set","value":465},{"label":"Out","value":358},{"label":"Nov","value":418},{"label":"Dez","value":486}];
const MX = 553;
