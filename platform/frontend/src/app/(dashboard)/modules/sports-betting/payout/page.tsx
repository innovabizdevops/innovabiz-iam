...
const PAGE = "Payout";
const KPIS = [{"l":"Atletas Registados","v":"8.178","t":"+5.0%","d":"up"},{"l":"Treinos/Semana","v":"1756","t":"+10.6%","d":"up"},{"l":"Competições","v":"7.185","t":"+8.9%","d":"up"},{"l":"Performance Score","v":"75","t":"+12.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.832","4.155","3.713","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.110","336","4.364","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.201","6.418","2.015","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.707","8.895","2.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","630","3.726","3.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":560},{"label":"Mar","value":708},{"label":"Abr","value":690},{"label":"Mai","value":758},{"label":"Jun","value":670},{"label":"Jul","value":690},{"label":"Ago","value":787},{"label":"Set","value":785},{"label":"Out","value":700},{"label":"Nov","value":753},{"label":"Dez","value":820}];
const MX = 832;
