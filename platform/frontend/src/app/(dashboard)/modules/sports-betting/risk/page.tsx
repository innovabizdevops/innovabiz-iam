...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"8.651","t":"+12.6%","d":"up"},{"l":"Mitigações Ativas","v":"6.138","t":"+9.9%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"+12.1%","d":"up"},{"l":"Incidentes YTD","v":"5.787","t":"+11.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.783","8.195","270","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.347","5.618","6.430","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.912","1.868","1.807","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.153","2.488","7.924","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","381","4.865","6.448","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":348},{"label":"Mar","value":511},{"label":"Abr","value":489},{"label":"Mai","value":555},{"label":"Jun","value":519},{"label":"Jul","value":505},{"label":"Ago","value":670},{"label":"Set","value":585},{"label":"Out","value":586},{"label":"Nov","value":588},{"label":"Dez","value":613}];
const MX = 670;
