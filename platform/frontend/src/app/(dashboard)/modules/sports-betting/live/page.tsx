...
const PAGE = "Live Bet";
const KPIS = [{"l":"Atletas Registados","v":"1.524","t":"+13.7%","d":"up"},{"l":"Treinos/Semana","v":"1817","t":"+9.1%","d":"up"},{"l":"Competições","v":"6.030","t":"+15.5%","d":"up"},{"l":"Performance Score","v":"90","t":"+9.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.307","5.790","7.443","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.226","5.132","3.046","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.767","3.230","7.404","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.385","6.691","7.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.544","7.906","695","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":733},{"label":"Mar","value":821},{"label":"Abr","value":909},{"label":"Mai","value":672},{"label":"Jun","value":907},{"label":"Jul","value":815},{"label":"Ago","value":631},{"label":"Set","value":653},{"label":"Out","value":792},{"label":"Nov","value":732},{"label":"Dez","value":607}];
const MX = 954;
