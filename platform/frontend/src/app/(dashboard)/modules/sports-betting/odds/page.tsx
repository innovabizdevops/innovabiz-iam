...
const ACCENT = "#6366f1";
const MODULE = "Sports Betting";
const PAGE = "Odds Engine";
const KPIS = [{"l":"Atletas Registados","v":"1.091","t":"+11.2%","d":"up"},{"l":"Treinos/Semana","v":"2181","t":"+16.3%","d":"up"},{"l":"Competições","v":"7.066","t":"-6.0%","d":"down"},{"l":"Performance Score","v":"85","t":"+17.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.206","639","4.310","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","497","5.316","5.687","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.328","2.189","5.541","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.952","4.412","6.530","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.832","317","5.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":639},{"label":"Mar","value":489},{"label":"Abr","value":621},{"label":"Mai","value":549},{"label":"Jun","value":486},{"label":"Jul","value":500},{"label":"Ago","value":580},{"label":"Set","value":542},{"label":"Out","value":300},{"label":"Nov","value":302},{"label":"Dez","value":520}];
const MX = 659;
