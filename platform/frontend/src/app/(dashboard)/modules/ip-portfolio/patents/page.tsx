...
const PAGE = "Patent Track";
const KPIS = [{"l":"Ideias Submetidas","v":"1.453","t":"-5.5%","d":"down"},{"l":"Patentes (YTD)","v":"7.747","t":"-1.3%","d":"down"},{"l":"Projetos Innovation Lab","v":"1.659","t":"+7.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€44.0M","t":"-1.6%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.098","97.8%","1.248","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.851","95.4%","7.058","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","694","87.1%","2.088","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.580","88.6%","834","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.897","99.4%","2.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":656},{"label":"Mar","value":703},{"label":"Abr","value":622},{"label":"Mai","value":733},{"label":"Jun","value":696},{"label":"Jul","value":806},{"label":"Ago","value":651},{"label":"Set","value":826},{"label":"Out","value":621},{"label":"Nov","value":863},{"label":"Dez","value":856}];
const MX = 863;
