...
const ACCENT = "#7c3aed";
const MODULE = "IP Portfolio";
const PAGE = "Renewal Dates";
const KPIS = [{"l":"Contratos Ativos","v":"1.544","t":"-5.9%","d":"down"},{"l":"Valor Total (€M)","v":"€23.7M","t":"+5.5%","d":"up"},{"l":"Renovações Próx. 30d","v":"3.383","t":"-1.5%","d":"down"},{"l":"Obrigações Pendentes","v":"7.989","t":"+5.5%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 34096.34","2026-01-03","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 35118.28","2026-03-21","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 34411.37","2026-01-13","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 17100.11","2026-03-04","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 28807.97","2026-01-09","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":770},{"label":"Mar","value":784},{"label":"Abr","value":651},{"label":"Mai","value":525},{"label":"Jun","value":727},{"label":"Jul","value":492},{"label":"Ago","value":849},{"label":"Set","value":776},{"label":"Out","value":699},{"label":"Nov","value":639},{"label":"Dez","value":634}];
const MX = 849;
