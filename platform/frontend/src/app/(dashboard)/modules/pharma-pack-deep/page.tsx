...
/* ═══ Pharma Packaging Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "4499", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3280", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€320K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "874748599", cells: ["PHA-3599", "Pharma Packaging Deep Item 1", "12/8/2026", "€48 699"], status: "active" as const },
    { id: "874752170", cells: ["PHA-7170", "Pharma Packaging Deep Item 2", "27/3/2026", "€2270"], status: "pending" as const },
    { id: "874755741", cells: ["PHA-1741", "Pharma Packaging Deep Item 3", "14/10/2026", "€5841"], status: "completed" as const },
    { id: "874759312", cells: ["PHA-5312", "Pharma Packaging Deep Item 4", "1/5/2026", "€9412"], status: "warning" as const },
    { id: "874762883", cells: ["PHA-8883", "Pharma Packaging Deep Item 5", "16/12/2026", "€12 983"], status: "active" as const },
];
...
export default function PharmaPackagingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Packaging Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Packaging Deep</p>
                    </div>
                </div>
