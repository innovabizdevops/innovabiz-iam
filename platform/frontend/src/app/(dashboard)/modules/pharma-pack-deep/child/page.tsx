...
const ACCENT = "#78350f";
const MODULE = "Pharma Packaging Deep";
const PAGE = "Child Safe";
const KPIS = [{"l":"Total Pharma Pack Deep","v":"2.480","t":"-5.2%","d":"down"},{"l":"Child Safe Ativos","v":"870","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"93.0%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"90","t":"+14.0%","d":"up"}];
const COLS = ["ID","Child Safe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Pack Deep #001","Pharma Pack Deep #002","5.041","2.590","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Pack Deep #002","Pharma Pack Deep #003","4.638","3.700","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Pack Deep #003","Pharma Pack Deep #004","5.305","733","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Pack Deep #004","Pharma Pack Deep #005","1.834","4.191","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Pack Deep #005","Pharma Pack Deep #001","6.279","3.745","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":504},{"label":"Mar","value":499},{"label":"Abr","value":603},{"label":"Mai","value":451},{"label":"Jun","value":519},{"label":"Jul","value":519},{"label":"Ago","value":444},{"label":"Set","value":347},{"label":"Out","value":461},{"label":"Nov","value":516},{"label":"Dez","value":677}];
const MX = 677;
