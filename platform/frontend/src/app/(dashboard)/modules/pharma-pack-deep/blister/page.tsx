...
const PAGE = "Blister";
const KPIS = [{"l":"Total Pharma Pack Deep","v":"2.604","t":"+6.3%","d":"up"},{"l":"Blister Ativos","v":"3.890","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"83.3%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+16.8%","d":"up"}];
const COLS = ["ID","Blister","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Pack Deep #001","Pharma Pack Deep #002","525","327","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Pack Deep #002","Pharma Pack Deep #003","3.221","1.417","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Pack Deep #003","Pharma Pack Deep #004","3.065","8.404","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Pack Deep #004","Pharma Pack Deep #005","8.689","553","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Pack Deep #005","Pharma Pack Deep #001","130","3.601","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":832},{"label":"Mar","value":845},{"label":"Abr","value":722},{"label":"Mai","value":839},{"label":"Jun","value":975},{"label":"Jul","value":997},{"label":"Ago","value":797},{"label":"Set","value":1028},{"label":"Out","value":657},{"label":"Nov","value":684},{"label":"Dez","value":688}];
const MX = 1028;
...
export default function BlisterPage() {
    return (
