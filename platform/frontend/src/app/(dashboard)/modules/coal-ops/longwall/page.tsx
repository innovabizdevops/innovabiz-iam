...
const ACCENT = "#6366f1";
const MODULE = "Coal Operations";
const PAGE = "Longwall";
const KPIS = [{"l":"Total Coal Ops","v":"3.875","t":"+0.2%","d":"up"},{"l":"Longwall Ativos","v":"581","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"65.2%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+1.0%","d":"up"}];
const COLS = ["ID","Longwall","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coal Ops #001","Coal Ops #002","4.985","5.001","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Coal Ops #002","Coal Ops #003","4.972","4.951","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Coal Ops #003","Coal Ops #004","4.384","3.910","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Coal Ops #004","Coal Ops #005","3.693","611","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coal Ops #005","Coal Ops #001","434","4.685","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":845},{"label":"Mar","value":981},{"label":"Abr","value":983},{"label":"Mai","value":646},{"label":"Jun","value":975},{"label":"Jul","value":823},{"label":"Ago","value":673},{"label":"Set","value":764},{"label":"Out","value":850},{"label":"Nov","value":600},{"label":"Dez","value":979}];
const MX = 983;
...
export default function LongwallPage() {
    return (
