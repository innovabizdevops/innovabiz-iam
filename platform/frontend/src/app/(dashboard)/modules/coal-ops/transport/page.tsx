...
const KPIS = [{"l":"Atletas Registados","v":"5.546","t":"-4.6%","d":"down"},{"l":"Treinos/Semana","v":"410","t":"+0.3%","d":"up"},{"l":"Competições","v":"5.778","t":"-5.2%","d":"down"},{"l":"Performance Score","v":"93","t":"+13.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.169","1.113","712","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.760","856","8.594","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.491","8.907","8.155","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.827","4.433","1.620","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.557","4.374","1.933","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":312},{"label":"Fev","value":546},{"label":"Mar","value":420},{"label":"Abr","value":514},{"label":"Mai","value":629},{"label":"Jun","value":422},{"label":"Jul","value":402},{"label":"Ago","value":640},{"label":"Set","value":659},{"label":"Out","value":686},{"label":"Nov","value":541},{"label":"Dez","value":681}];
const MX = 686;
