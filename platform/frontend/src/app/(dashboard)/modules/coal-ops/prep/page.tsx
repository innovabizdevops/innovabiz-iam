...
const PAGE = "Prep Plant";
const KPIS = [{"l":"Total Coal Ops","v":"3.315","t":"-3.6%","d":"down"},{"l":"Prep Plant Ativos","v":"8.476","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"81","t":"+13.0%","d":"up"}];
const COLS = ["ID","Prep Plant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coal Ops #001","Coal Ops #002","5.118","5.251","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Coal Ops #002","Coal Ops #003","7.929","1.335","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Coal Ops #003","Coal Ops #004","4.740","4.847","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Coal Ops #004","Coal Ops #005","7.580","8.500","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coal Ops #005","Coal Ops #001","3.392","7.811","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":500},{"label":"Mar","value":255},{"label":"Abr","value":230},{"label":"Mai","value":444},{"label":"Jun","value":435},{"label":"Jul","value":523},{"label":"Ago","value":572},{"label":"Set","value":283},{"label":"Out","value":391},{"label":"Nov","value":392},{"label":"Dez","value":359}];
const MX = 572;
