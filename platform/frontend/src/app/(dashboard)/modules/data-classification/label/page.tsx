...
const PAGE = "Label";
const KPIS = [{"l":"Dashboards Ativos","v":"7.771","t":"+4.8%","d":"up"},{"l":"Queries/Dia","v":"965","t":"+7.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.808","t":"+1.4%","d":"up"},{"l":"Utilizadores Analytics","v":"6.677","t":"-4.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4466","2026-02-14","4.822","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3848","2026-01-17","3.855","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","927","2026-01-08","3.447","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4344","2026-03-11","8.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1821","2026-01-05","926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":592},{"label":"Mar","value":681},{"label":"Abr","value":459},{"label":"Mai","value":532},{"label":"Jun","value":460},{"label":"Jul","value":373},{"label":"Ago","value":349},{"label":"Set","value":607},{"label":"Out","value":634},{"label":"Nov","value":396},{"label":"Dez","value":658}];
const MX = 681;
