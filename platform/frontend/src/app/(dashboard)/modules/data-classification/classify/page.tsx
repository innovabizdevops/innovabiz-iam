...
const ACCENT = "#dc2626";
const MODULE = "Data Classification";
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"4.531","t":"+4.3%","d":"up"},{"l":"Queries/Dia","v":"3573","t":"-5.7%","d":"down"},{"l":"Dados Processados (GB)","v":"4.689","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"6.606","t":"+6.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2073","2026-03-01","443","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3936","2026-01-26","887","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","881","2026-02-21","5.918","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4500","2026-03-17","8.497","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3105","2026-02-03","670","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":678},{"label":"Mar","value":504},{"label":"Abr","value":582},{"label":"Mai","value":562},{"label":"Jun","value":727},{"label":"Jul","value":464},{"label":"Ago","value":671},{"label":"Set","value":728},{"label":"Out","value":394},{"label":"Nov","value":395},{"label":"Dez","value":464}];
const MX = 728;
