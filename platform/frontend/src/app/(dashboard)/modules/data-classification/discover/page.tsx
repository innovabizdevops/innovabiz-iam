...
const PAGE = "Discover";
const KPIS = [{"l":"Dashboards Ativos","v":"6.516","t":"+7.5%","d":"up"},{"l":"Queries/Dia","v":"2370","t":"+12.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.016","t":"+5.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.602","t":"+16.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4514","2026-02-12","2.313","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1617","2026-03-23","2.054","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3554","2026-02-09","341","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1473","2026-03-06","1.707","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3614","2026-03-09","7.750","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":485},{"label":"Mar","value":382},{"label":"Abr","value":286},{"label":"Mai","value":577},{"label":"Jun","value":602},{"label":"Jul","value":343},{"label":"Ago","value":333},{"label":"Set","value":528},{"label":"Out","value":357},{"label":"Nov","value":548},{"label":"Dez","value":401}];
const MX = 602;
