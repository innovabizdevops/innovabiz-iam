...
const PAGE = "Protect";
const KPIS = [{"l":"Dashboards Ativos","v":"2.094","t":"+4.7%","d":"up"},{"l":"Queries/Dia","v":"1220","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"4.852","t":"+12.7%","d":"up"},{"l":"Utilizadores Analytics","v":"3.139","t":"+1.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1391","2026-02-26","8.779","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4216","2026-03-25","2.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2207","2026-03-20","1.986","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1514","2026-03-17","1.808","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1202","2026-01-13","2.540","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":700},{"label":"Mar","value":619},{"label":"Abr","value":607},{"label":"Mai","value":416},{"label":"Jun","value":524},{"label":"Jul","value":613},{"label":"Ago","value":734},{"label":"Set","value":777},{"label":"Out","value":515},{"label":"Nov","value":736},{"label":"Dez","value":740}];
const MX = 777;
