...
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"7.182","t":"+7.8%","d":"up"},{"l":"Queries/Dia","v":"1272","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.222","t":"+7.6%","d":"up"},{"l":"Utilizadores Analytics","v":"456","t":"+4.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","457","2026-02-12","5.463","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2207","2026-02-09","5.081","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3750","2026-02-12","8.154","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2714","2026-03-01","2.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4006","2026-03-06","5.090","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":883},{"label":"Mar","value":903},{"label":"Abr","value":796},{"label":"Mai","value":895},{"label":"Jun","value":850},{"label":"Jul","value":583},{"label":"Ago","value":617},{"label":"Set","value":809},{"label":"Out","value":725},{"label":"Nov","value":601},{"label":"Dez","value":766}];
const MX = 903;
