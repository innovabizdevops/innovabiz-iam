...
const KPIS = [
    { label: "Total Registos", value: "5208", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1118", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€435K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1816110608", cells: ["DAT-1608", "Data Classification Item 1", "5/9/2026", "€10 708"], status: "active" as const },
    { id: "1816114179", cells: ["DAT-5179", "Data Classification Item 2", "20/4/2026", "€14 279"], status: "pending" as const },
    { id: "1816117750", cells: ["DAT-8750", "Data Classification Item 3", "7/11/2026", "€17 850"], status: "completed" as const },
    { id: "1816121321", cells: ["DAT-3321", "Data Classification Item 4", "22/6/2026", "€21 421"], status: "warning" as const },
    { id: "1816124892", cells: ["DAT-6892", "Data Classification Item 5", "9/1/2026", "€24 992"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Classification</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Classification</p>
                    </div>
                </div>
