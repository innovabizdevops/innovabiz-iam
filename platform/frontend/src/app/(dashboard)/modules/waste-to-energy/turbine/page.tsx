...
const PAGE = "Turbine";
const KPIS = [{"l":"Total Waste To Energy","v":"6.381","t":"-2.2%","d":"down"},{"l":"Turbine Ativos","v":"4.949","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"83.2%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"83","t":"+14.8%","d":"up"}];
const COLS = ["ID","Turbine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste To Energy #001","Waste To Energy #002","7.145","3.473","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Waste To Energy #002","Waste To Energy #003","3.980","3.801","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste To Energy #003","Waste To Energy #004","1.542","6.337","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Waste To Energy #004","Waste To Energy #005","8.584","4.462","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste To Energy #005","Waste To Energy #001","7.841","7.151","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":644},{"label":"Mar","value":462},{"label":"Abr","value":384},{"label":"Mai","value":533},{"label":"Jun","value":567},{"label":"Jul","value":680},{"label":"Ago","value":410},{"label":"Set","value":401},{"label":"Out","value":771},{"label":"Nov","value":518},{"label":"Dez","value":459}];
const MX = 771;
