...
const PAGE = "Emission";
const KPIS = [{"l":"Total Waste To Energy","v":"3.340","t":"+17.1%","d":"up"},{"l":"Emission Ativos","v":"3.685","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"75","t":"-4.2%","d":"down"}];
const COLS = ["ID","Emission","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste To Energy #001","Waste To Energy #002","6.206","2.979","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Waste To Energy #002","Waste To Energy #003","1.479","3.301","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste To Energy #003","Waste To Energy #004","6.395","3.340","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Waste To Energy #004","Waste To Energy #005","3.195","5.956","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste To Energy #005","Waste To Energy #001","3.004","630","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":755},{"label":"Mar","value":839},{"label":"Abr","value":957},{"label":"Mai","value":974},{"label":"Jun","value":649},{"label":"Jul","value":813},{"label":"Ago","value":753},{"label":"Set","value":802},{"label":"Out","value":669},{"label":"Nov","value":632},{"label":"Dez","value":913}];
const MX = 974;
