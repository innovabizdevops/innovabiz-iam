...
const ACCENT = "#6366f1";
const MODULE = "Waste to Energy";
const PAGE = "Incineration";
const KPIS = [{"l":"Total Waste To Energy","v":"6.321","t":"-2.1%","d":"down"},{"l":"Incineration Ativos","v":"7.062","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"75.7%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"59","t":"-5.5%","d":"down"}];
const COLS = ["ID","Incineration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste To Energy #001","Waste To Energy #002","666","3.983","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Waste To Energy #002","Waste To Energy #003","1.152","8.455","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste To Energy #003","Waste To Energy #004","2.405","1.998","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Waste To Energy #004","Waste To Energy #005","7.528","6.698","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste To Energy #005","Waste To Energy #001","1.232","2.301","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":767},{"label":"Mar","value":849},{"label":"Abr","value":650},{"label":"Mai","value":791},{"label":"Jun","value":993},{"label":"Jul","value":658},{"label":"Ago","value":992},{"label":"Set","value":667},{"label":"Out","value":896},{"label":"Nov","value":760},{"label":"Dez","value":694}];
const MX = 993;
