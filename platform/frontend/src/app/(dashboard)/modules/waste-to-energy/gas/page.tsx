...
const PAGE = "Gas Capture";
const KPIS = [{"l":"Total Waste To Energy","v":"4.704","t":"+8.8%","d":"up"},{"l":"Gas Capture Ativos","v":"3.402","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+17.3%","d":"up"}];
const COLS = ["ID","Gas Capture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste To Energy #001","Waste To Energy #002","7.722","1.152","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Waste To Energy #002","Waste To Energy #003","1.039","202","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste To Energy #003","Waste To Energy #004","7.397","5.651","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Waste To Energy #004","Waste To Energy #005","8.332","5.860","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste To Energy #005","Waste To Energy #001","4.120","8.530","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":794},{"label":"Mar","value":749},{"label":"Abr","value":678},{"label":"Mai","value":700},{"label":"Jun","value":962},{"label":"Jul","value":962},{"label":"Ago","value":630},{"label":"Set","value":867},{"label":"Out","value":996},{"label":"Nov","value":1005},{"label":"Dez","value":703}];
const MX = 1005;
