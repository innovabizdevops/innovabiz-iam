...
const PAGE = "Residue";
const KPIS = [{"l":"Total Waste To Energy","v":"2.370","t":"+14.1%","d":"up"},{"l":"Residue Ativos","v":"6.128","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.5%","d":"down"}];
const COLS = ["ID","Residue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste To Energy #001","Waste To Energy #002","6.797","3.515","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Waste To Energy #002","Waste To Energy #003","6.480","7.750","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste To Energy #003","Waste To Energy #004","3.269","3.946","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Waste To Energy #004","Waste To Energy #005","3.838","4.446","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste To Energy #005","Waste To Energy #001","8.565","8.624","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":953},{"label":"Fev","value":870},{"label":"Mar","value":1063},{"label":"Abr","value":745},{"label":"Mai","value":687},{"label":"Jun","value":696},{"label":"Jul","value":1025},{"label":"Ago","value":861},{"label":"Set","value":991},{"label":"Out","value":911},{"label":"Nov","value":1025},{"label":"Dez","value":975}];
const MX = 1063;
