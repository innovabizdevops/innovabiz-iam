...
const PAGE = "Project";
const KPIS = [{"l":"Total It Services","v":"469","t":"+0.9%","d":"up"},{"l":"Project Ativos","v":"716","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+10.7%","d":"up"}];
const COLS = ["ID","Project","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["It Services #001","It Services #002","5.871","8.419","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["It Services #002","It Services #003","4.803","7.761","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["It Services #003","It Services #004","1.149","2.470","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["It Services #004","It Services #005","6.637","6.614","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["It Services #005","It Services #001","8.199","2.043","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":431},{"label":"Mar","value":511},{"label":"Abr","value":684},{"label":"Mai","value":606},{"label":"Jun","value":454},{"label":"Jul","value":639},{"label":"Ago","value":656},{"label":"Set","value":413},{"label":"Out","value":618},{"label":"Nov","value":412},{"label":"Dez","value":471}];
const MX = 684;
