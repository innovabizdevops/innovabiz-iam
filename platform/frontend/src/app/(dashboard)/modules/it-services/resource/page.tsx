...
const PAGE = "Resource";
const KPIS = [{"l":"Total It Services","v":"5.172","t":"+6.7%","d":"up"},{"l":"Resource Ativos","v":"3.574","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"73.2%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"74","t":"-2.8%","d":"down"}];
const COLS = ["ID","Resource","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["It Services #001","It Services #002","6.511","8.346","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["It Services #002","It Services #003","6.354","206","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["It Services #003","It Services #004","6.364","7.810","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["It Services #004","It Services #005","3.055","1.416","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["It Services #005","It Services #001","8.801","1.735","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":674},{"label":"Mar","value":571},{"label":"Abr","value":682},{"label":"Mai","value":394},{"label":"Jun","value":696},{"label":"Jul","value":511},{"label":"Ago","value":724},{"label":"Set","value":743},{"label":"Out","value":726},{"label":"Nov","value":745},{"label":"Dez","value":559}];
const MX = 745;
