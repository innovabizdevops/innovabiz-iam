...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"4.018","t":"+12.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.4%","t":"+9.9%","d":"up"},{"l":"MTTR (h)","v":"31h","t":"+15.4%","d":"up"},{"l":"Satisfação (%)","v":"92.9%","t":"+1.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.891","3.751","3.407","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.524","1.607","6.137","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.957","2.453","343","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.710","6.225","4.358","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","411","4.667","6.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":394},{"label":"Mar","value":445},{"label":"Abr","value":343},{"label":"Mai","value":592},{"label":"Jun","value":580},{"label":"Jul","value":579},{"label":"Ago","value":536},{"label":"Set","value":389},{"label":"Out","value":713},{"label":"Nov","value":532},{"label":"Dez","value":393}];
const MX = 713;
