...
const ACCENT = "#6366f1";
const MODULE = "IT Services Firm";
const PAGE = "Billing";
const KPIS = [{"l":"Total It Services","v":"887","t":"+15.3%","d":"up"},{"l":"Billing Ativos","v":"1.307","t":"+1.6%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"59","t":"+9.7%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["It Services #001","It Services #002","3.282","6.545","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["It Services #002","It Services #003","1.858","3.103","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["It Services #003","It Services #004","7.642","1.568","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["It Services #004","It Services #005","3.113","4.766","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["It Services #005","It Services #001","6.348","6.816","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":660},{"label":"Mar","value":803},{"label":"Abr","value":854},{"label":"Mai","value":752},{"label":"Jun","value":745},{"label":"Jul","value":659},{"label":"Ago","value":822},{"label":"Set","value":884},{"label":"Out","value":659},{"label":"Nov","value":739},{"label":"Dez","value":862}];
const MX = 884;
