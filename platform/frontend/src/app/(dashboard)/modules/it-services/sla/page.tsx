...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"2.763","t":"-4.8%","d":"down"},{"l":"SLA Cumprido (%)","v":"76.6%","t":"+0.1%","d":"up"},{"l":"MTTR (h)","v":"25h","t":"+13.7%","d":"up"},{"l":"Satisfação (%)","v":"92.0%","t":"+11.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.013","7.886","6.130","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.029","8.233","486","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.498","2.408","2.774","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","852","3.930","7.785","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.791","7.999","653","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":617},{"label":"Mar","value":765},{"label":"Abr","value":695},{"label":"Mai","value":683},{"label":"Jun","value":783},{"label":"Jul","value":801},{"label":"Ago","value":759},{"label":"Set","value":679},{"label":"Out","value":829},{"label":"Nov","value":825},{"label":"Dez","value":580}];
const MX = 829;
