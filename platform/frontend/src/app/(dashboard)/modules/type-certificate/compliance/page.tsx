...
const PAGE = "Compliance Map";
const KPIS = [{"l":"Auditorias Realizadas","v":"536","t":"-3.7%","d":"down"},{"l":"NC Abertas","v":"9.007","t":"+7.5%","d":"up"},{"l":"Conformidade (%)","v":"75.7%","t":"-5.7%","d":"down"},{"l":"CAPAs Pendentes","v":"2.395","t":"+15.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.597","82.4%","3.020","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","941","93.4%","619","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.475","92.1%","2.483","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","9.024","75.5%","921","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","117","92.0%","3.828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":897},{"label":"Fev","value":522},{"label":"Mar","value":907},{"label":"Abr","value":768},{"label":"Mai","value":650},{"label":"Jun","value":733},{"label":"Jul","value":677},{"label":"Ago","value":661},{"label":"Set","value":587},{"label":"Out","value":715},{"label":"Nov","value":529},{"label":"Dez","value":778}];
const MX = 907;
