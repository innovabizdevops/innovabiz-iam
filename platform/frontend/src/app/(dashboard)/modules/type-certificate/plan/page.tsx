...
const ACCENT = "#0e7490";
const MODULE = "Type Certificate";
const PAGE = "Certification Plan";
const KPIS = [{"l":"Total Type Certificate","v":"3.415","t":"+9.8%","d":"up"},{"l":"Certification Plan Ativos","v":"1.787","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"75","t":"+13.3%","d":"up"}];
const COLS = ["ID","Certification Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Type Certificate #001","Type Certificate #002","4.101","4.355","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Type Certificate #002","Type Certificate #003","5.387","6.876","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Type Certificate #003","Type Certificate #004","2.981","4.499","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Type Certificate #004","Type Certificate #005","2.237","6.359","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Type Certificate #005","Type Certificate #001","2.710","6.746","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":672},{"label":"Mar","value":551},{"label":"Abr","value":368},{"label":"Mai","value":631},{"label":"Jun","value":684},{"label":"Jul","value":706},{"label":"Ago","value":615},{"label":"Set","value":393},{"label":"Out","value":504},{"label":"Nov","value":537},{"label":"Dez","value":557}];
const MX = 706;
