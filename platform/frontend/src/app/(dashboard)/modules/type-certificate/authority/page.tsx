...
const PAGE = "EASA/FAA";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.506","t":"+11.2%","d":"up"},{"l":"Sessões/Dia","v":"4581","t":"+10.7%","d":"up"},{"l":"MFA Adoção (%)","v":"71.0%","t":"+12.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.730","t":"+7.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","8.279","2.346","3.430","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.910","7.634","6.094","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.915","7.788","1.820","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.604","7.676","4.803","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","294","5.736","8.917","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":536},{"label":"Mar","value":695},{"label":"Abr","value":359},{"label":"Mai","value":583},{"label":"Jun","value":572},{"label":"Jul","value":454},{"label":"Ago","value":521},{"label":"Set","value":388},{"label":"Out","value":522},{"label":"Nov","value":588},{"label":"Dez","value":437}];
const MX = 699;
