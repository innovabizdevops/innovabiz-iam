...
const PAGE = "Test Evidence";
const KPIS = [{"l":"Total Type Certificate","v":"4.954","t":"+7.2%","d":"up"},{"l":"Test Evidence Ativos","v":"6.302","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"77.0%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"78","t":"+11.1%","d":"up"}];
const COLS = ["ID","Test Evidence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Type Certificate #001","Type Certificate #002","9.059","8.479","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Type Certificate #002","Type Certificate #003","1.038","4.757","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Type Certificate #003","Type Certificate #004","2.233","5.128","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Type Certificate #004","Type Certificate #005","2.301","5.688","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Type Certificate #005","Type Certificate #001","1.863","1.119","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":901},{"label":"Mar","value":743},{"label":"Abr","value":874},{"label":"Mai","value":870},{"label":"Jun","value":831},{"label":"Jul","value":746},{"label":"Ago","value":988},{"label":"Set","value":858},{"label":"Out","value":897},{"label":"Nov","value":639},{"label":"Dez","value":959}];
const MX = 988;
