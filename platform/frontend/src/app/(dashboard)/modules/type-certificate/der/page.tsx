...
const PAGE = "DER Review";
const KPIS = [{"l":"Total Type Certificate","v":"1.238","t":"+10.5%","d":"up"},{"l":"DER Review Ativos","v":"4.917","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"75.6%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+3.4%","d":"up"}];
const COLS = ["ID","DER Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Type Certificate #001","Type Certificate #002","2.106","452","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Type Certificate #002","Type Certificate #003","2.703","5.310","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Type Certificate #003","Type Certificate #004","7.868","893","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Type Certificate #004","Type Certificate #005","3.101","3.902","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Type Certificate #005","Type Certificate #001","1.266","154","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":826},{"label":"Mar","value":630},{"label":"Abr","value":745},{"label":"Mai","value":795},{"label":"Jun","value":602},{"label":"Jul","value":774},{"label":"Ago","value":831},{"label":"Set","value":725},{"label":"Out","value":641},{"label":"Nov","value":914},{"label":"Dez","value":796}];
const MX = 914;
