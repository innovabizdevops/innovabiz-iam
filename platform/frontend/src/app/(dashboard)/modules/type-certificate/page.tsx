...
export default function TypeCertificatePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Type Certificate</h1><p className="text-sm text-muted-foreground">Type Certificate • iBOS Enterprise</p></div>
