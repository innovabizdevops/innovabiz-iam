...
const PAGE = "Trend";
const KPIS = [{"l":"Dashboards Ativos","v":"854","t":"+4.2%","d":"up"},{"l":"Queries/Dia","v":"219","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.039","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"5.094","t":"-0.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3147","2026-03-24","7.074","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4539","2026-01-26","6.202","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2013","2026-01-28","8.395","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2415","2026-01-24","2.583","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2063","2026-01-11","6.607","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":626},{"label":"Mar","value":776},{"label":"Abr","value":848},{"label":"Mai","value":752},{"label":"Jun","value":696},{"label":"Jul","value":533},{"label":"Ago","value":528},{"label":"Set","value":858},{"label":"Out","value":521},{"label":"Nov","value":808},{"label":"Dez","value":631}];
const MX = 858;
