...
const ACCENT = "#6366f1";
const MODULE = "Environmental Analytics";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"7.033","t":"+9.6%","d":"up"},{"l":"Mitigações Ativas","v":"3.648","t":"+16.9%","d":"up"},{"l":"Score Risco Geral","v":"62","t":"+3.6%","d":"up"},{"l":"Incidentes YTD","v":"6.531","t":"+12.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.104","7.306","8.153","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.497","4.320","486","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.901","8.178","8.840","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.660","649","5.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.709","826","6.093","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":579},{"label":"Mar","value":769},{"label":"Abr","value":824},{"label":"Mai","value":541},{"label":"Jun","value":796},{"label":"Jul","value":862},{"label":"Ago","value":792},{"label":"Set","value":644},{"label":"Out","value":656},{"label":"Nov","value":736},{"label":"Dez","value":707}];
const MX = 862;
