...
const PAGE = "Emission";
const KPIS = [{"l":"Dashboards Ativos","v":"7.094","t":"+17.6%","d":"up"},{"l":"Queries/Dia","v":"3462","t":"-4.9%","d":"down"},{"l":"Dados Processados (GB)","v":"2.735","t":"-1.4%","d":"down"},{"l":"Utilizadores Analytics","v":"7.142","t":"+13.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1681","2026-03-05","2.041","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3660","2026-02-23","6.671","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","151","2026-01-16","702","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3272","2026-03-09","6.486","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2910","2026-03-08","1.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":742},{"label":"Mar","value":664},{"label":"Abr","value":965},{"label":"Mai","value":718},{"label":"Jun","value":961},{"label":"Jul","value":918},{"label":"Ago","value":727},{"label":"Set","value":889},{"label":"Out","value":695},{"label":"Nov","value":969},{"label":"Dez","value":787}];
const MX = 969;
