...
const KPIS = [{"l":"Auditorias Realizadas","v":"907","t":"-0.9%","d":"down"},{"l":"NC Abertas","v":"1.339","t":"+-0.0%","d":"up"},{"l":"Conformidade (%)","v":"70.1%","t":"+9.9%","d":"up"},{"l":"CAPAs Pendentes","v":"5.794","t":"+2.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","947","78.0%","163","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.944","97.4%","8.736","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.732","76.5%","6.180","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.411","98.8%","1.927","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.662","71.5%","8.331","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1025},{"label":"Fev","value":836},{"label":"Mar","value":734},{"label":"Abr","value":976},{"label":"Mai","value":779},{"label":"Jun","value":686},{"label":"Jul","value":857},{"label":"Ago","value":913},{"label":"Set","value":869},{"label":"Out","value":1020},{"label":"Nov","value":1078},{"label":"Dez","value":815}];
const MX = 1078;
