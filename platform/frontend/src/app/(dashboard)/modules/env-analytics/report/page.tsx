...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"5.658","t":"+9.4%","d":"up"},{"l":"Queries/Dia","v":"4389","t":"+15.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.319","t":"-1.2%","d":"down"},{"l":"Utilizadores Analytics","v":"3.820","t":"+13.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2425","2026-03-10","643","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4986","2026-03-02","585","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2019","2026-01-27","5.017","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2756","2026-03-03","1.523","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2558","2026-03-08","778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":840},{"label":"Mar","value":697},{"label":"Abr","value":657},{"label":"Mai","value":779},{"label":"Jun","value":748},{"label":"Jul","value":1010},{"label":"Ago","value":1028},{"label":"Set","value":975},{"label":"Out","value":882},{"label":"Nov","value":813},{"label":"Dez","value":715}];
const MX = 1028;
