...
const PAGE = "Evolve";
const KPIS = [{"l":"Total Cosmos Orchestrator","v":"676","t":"+3.8%","d":"up"},{"l":"Evolve Ativos","v":"6.344","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"90","t":"-5.9%","d":"down"}];
const COLS = ["ID","Evolve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Orchestrator #001","Cosmos Orchestrator #002","3.148","1.438","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Orchestrator #002","Cosmos Orchestrator #003","265","6.224","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Orchestrator #003","Cosmos Orchestrator #004","5.642","3.953","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Orchestrator #004","Cosmos Orchestrator #005","5.454","7.614","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Orchestrator #005","Cosmos Orchestrator #001","4.292","6.305","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":548},{"label":"Mar","value":787},{"label":"Abr","value":874},{"label":"Mai","value":656},{"label":"Jun","value":799},{"label":"Jul","value":809},{"label":"Ago","value":694},{"label":"Set","value":760},{"label":"Out","value":666},{"label":"Nov","value":793},{"label":"Dez","value":839}];
const MX = 874;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e1b4b'}}>EVO</span></h1>
                </div>
