...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Macro-Orchestrator";
const PAGE = "Coordinate";
const KPIS = [{"l":"Total Cosmos Orchestrator","v":"7.684","t":"+2.4%","d":"up"},{"l":"Coordinate Ativos","v":"5.564","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"80","t":"-4.9%","d":"down"}];
const COLS = ["ID","Coordinate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Orchestrator #001","Cosmos Orchestrator #002","7.860","6.267","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Orchestrator #002","Cosmos Orchestrator #003","7.780","3.733","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Orchestrator #003","Cosmos Orchestrator #004","4.395","4.988","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Orchestrator #004","Cosmos Orchestrator #005","3.455","962","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Orchestrator #005","Cosmos Orchestrator #001","5.926","6.507","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":692},{"label":"Mar","value":886},{"label":"Abr","value":763},{"label":"Mai","value":955},{"label":"Jun","value":812},{"label":"Jul","value":958},{"label":"Ago","value":804},{"label":"Set","value":920},{"label":"Out","value":1069},{"label":"Nov","value":1055},{"label":"Dez","value":839}];
const MX = 1069;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e1b4b'}}>AI</span></h1>
                </div>
