...
/* ═══ COSMOS Macro-Orchestrator — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "1004", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3633", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€479K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "143996404", cells: ["COS-6404", "COSMOS Macro-Orchestrator Item 1", "21/5/2026", "€46 504"], status: "active" as const },
    { id: "143999975", cells: ["COS-9975", "COSMOS Macro-Orchestrator Item 2", "8/12/2026", "€50 075"], status: "pending" as const },
    { id: "144003546", cells: ["COS-4546", "COSMOS Macro-Orchestrator Item 3", "23/7/2026", "€3646"], status: "completed" as const },
    { id: "144007117", cells: ["COS-8117", "COSMOS Macro-Orchestrator Item 4", "10/2/2026", "€7217"], status: "warning" as const },
    { id: "144010688", cells: ["COS-2688", "COSMOS Macro-Orchestrator Item 5", "25/9/2026", "€10 788"], status: "active" as const },
];
...
export default function CosmosMacroorchestratorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Macro-Orchestrator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Macro-Orchestrator</p>
                    </div>
                </div>
