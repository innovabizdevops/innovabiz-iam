...
const PAGE = "Balance";
const KPIS = [{"l":"Total Cosmos Orchestrator","v":"845","t":"-0.4%","d":"down"},{"l":"Balance Ativos","v":"4.710","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"80","t":"+9.1%","d":"up"}];
const COLS = ["ID","Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Orchestrator #001","Cosmos Orchestrator #002","5.601","4.278","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Orchestrator #002","Cosmos Orchestrator #003","6.551","4.664","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Orchestrator #003","Cosmos Orchestrator #004","5.215","7.465","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Orchestrator #004","Cosmos Orchestrator #005","5.528","8.613","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Orchestrator #005","Cosmos Orchestrator #001","7.432","7.615","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":445},{"label":"Mar","value":528},{"label":"Abr","value":647},{"label":"Mai","value":698},{"label":"Jun","value":652},{"label":"Jul","value":707},{"label":"Ago","value":625},{"label":"Set","value":315},{"label":"Out","value":602},{"label":"Nov","value":390},{"label":"Dez","value":561}];
const MX = 707;
