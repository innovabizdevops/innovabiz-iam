...
const PAGE = "System Map";
const KPIS = [{"l":"Total Cosmos Orchestrator","v":"1.098","t":"+7.3%","d":"up"},{"l":"System Map Ativos","v":"5.034","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+15.3%","d":"up"}];
const COLS = ["ID","System Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Orchestrator #001","Cosmos Orchestrator #002","753","7.969","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Orchestrator #002","Cosmos Orchestrator #003","6.296","8.160","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Orchestrator #003","Cosmos Orchestrator #004","3.538","3.995","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Orchestrator #004","Cosmos Orchestrator #005","5.464","8.822","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Orchestrator #005","Cosmos Orchestrator #001","3.903","1.939","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1023},{"label":"Fev","value":708},{"label":"Mar","value":854},{"label":"Abr","value":693},{"label":"Mai","value":651},{"label":"Jun","value":670},{"label":"Jul","value":1008},{"label":"Ago","value":853},{"label":"Set","value":805},{"label":"Out","value":708},{"label":"Nov","value":850},{"label":"Dez","value":961}];
const MX = 1023;
