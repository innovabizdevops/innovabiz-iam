...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.218","t":"-3.9%","d":"down"},{"l":"NC Abertas","v":"3.521","t":"+6.4%","d":"up"},{"l":"Conformidade (%)","v":"70.7%","t":"-1.3%","d":"down"},{"l":"CAPAs Pendentes","v":"6.645","t":"+0.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.083","85.1%","272","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.272","79.4%","7.861","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.311","88.6%","2.139","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.981","71.6%","174","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.451","79.3%","5.905","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":476},{"label":"Fev","value":551},{"label":"Mar","value":645},{"label":"Abr","value":484},{"label":"Mai","value":795},{"label":"Jun","value":540},{"label":"Jul","value":701},{"label":"Ago","value":707},{"label":"Set","value":453},{"label":"Out","value":701},{"label":"Nov","value":569},{"label":"Dez","value":483}];
const MX = 795;
