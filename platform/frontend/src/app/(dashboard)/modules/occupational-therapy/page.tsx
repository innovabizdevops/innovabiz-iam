...
const KPIS = [
    { label: "Total Registos", value: "3029", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "347", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€17K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1871558329", cells: ["OCC-9329", "Occupational Therapy Item 1", "26/2/2026", "€8429"], status: "active" as const },
    { id: "1871561900", cells: ["OCC-3900", "Occupational Therapy Item 2", "13/9/2026", "€12 000"], status: "pending" as const },
    { id: "1871565471", cells: ["OCC-7471", "Occupational Therapy Item 3", "28/4/2026", "€15 571"], status: "completed" as const },
    { id: "1871569042", cells: ["OCC-2042", "Occupational Therapy Item 4", "15/11/2026", "€19 142"], status: "warning" as const },
    { id: "1871572613", cells: ["OCC-5613", "Occupational Therapy Item 5", "2/6/2026", "€22 713"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Occupational Therapy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Occupational Therapy</p>
                    </div>
                </div>
