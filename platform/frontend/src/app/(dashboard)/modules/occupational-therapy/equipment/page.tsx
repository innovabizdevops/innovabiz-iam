...
const KPIS = [{"l":"Incidentes (YTD)","v":"4.645","t":"+0.2%","d":"up"},{"l":"LTIR","v":"1.157","t":"+9.1%","d":"up"},{"l":"Formações HSE","v":"1.059","t":"+8.4%","d":"up"},{"l":"Inspeções Realizadas","v":"2.186","t":"+7.1%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","4.000","5.691","5.443","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","1.199","4.652","1.212","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","5.978","2.999","1.190","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","2.483","462","6.062","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","6.266","9.027","7.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":781},{"label":"Mar","value":557},{"label":"Abr","value":466},{"label":"Mai","value":442},{"label":"Jun","value":722},{"label":"Jul","value":625},{"label":"Ago","value":398},{"label":"Set","value":439},{"label":"Out","value":665},{"label":"Nov","value":620},{"label":"Dez","value":772}];
const MX = 781;
