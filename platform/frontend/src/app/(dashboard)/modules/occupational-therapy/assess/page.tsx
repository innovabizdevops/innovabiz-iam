...
const PAGE = "Assess";
const KPIS = [{"l":"Incidentes (YTD)","v":"2.378","t":"-3.4%","d":"down"},{"l":"LTIR","v":"3.592","t":"+17.1%","d":"up"},{"l":"Formações HSE","v":"6.379","t":"+9.4%","d":"up"},{"l":"Inspeções Realizadas","v":"4.326","t":"+10.8%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","1.358","8.258","8.409","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","7.827","8.342","6.657","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","2.874","4.028","3.177","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","5.570","8.617","8.787","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","6.750","2.871","7.860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":677},{"label":"Mar","value":621},{"label":"Abr","value":612},{"label":"Mai","value":628},{"label":"Jun","value":721},{"label":"Jul","value":536},{"label":"Ago","value":726},{"label":"Set","value":504},{"label":"Out","value":502},{"label":"Nov","value":686},{"label":"Dez","value":757}];
const MX = 757;
