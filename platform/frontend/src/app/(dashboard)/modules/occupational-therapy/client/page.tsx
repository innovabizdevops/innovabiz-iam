...
const PAGE = "Client";
const KPIS = [{"l":"Incidentes (YTD)","v":"3.245","t":"+7.2%","d":"up"},{"l":"LTIR","v":"2.088","t":"+14.9%","d":"up"},{"l":"Formações HSE","v":"7.523","t":"-2.4%","d":"down"},{"l":"Inspeções Realizadas","v":"286","t":"-1.0%","d":"down"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","4.549","285","3.353","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","6.490","3.892","4.722","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","8.180","6.296","9.030","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","1.512","1.099","4.967","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","2.960","5.828","8.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":761},{"label":"Mar","value":762},{"label":"Abr","value":723},{"label":"Mai","value":643},{"label":"Jun","value":1021},{"label":"Jul","value":670},{"label":"Ago","value":824},{"label":"Set","value":866},{"label":"Out","value":1004},{"label":"Nov","value":640},{"label":"Dez","value":801}];
const MX = 1021;
