...
const ACCENT = "#059669";
const MODULE = "Occupational Therapy";
const PAGE = "Intervention";
const KPIS = [{"l":"Incidentes (YTD)","v":"1.684","t":"+9.4%","d":"up"},{"l":"LTIR","v":"8.002","t":"+16.1%","d":"up"},{"l":"Formações HSE","v":"3.861","t":"+8.3%","d":"up"},{"l":"Inspeções Realizadas","v":"6.868","t":"-5.7%","d":"down"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","2.357","1.011","3.570","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","603","1.790","4.072","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","298","929","4.753","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","3.568","1.190","6.322","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","1.213","5.684","4.767","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":488},{"label":"Mar","value":461},{"label":"Abr","value":410},{"label":"Mai","value":589},{"label":"Jun","value":287},{"label":"Jul","value":263},{"label":"Ago","value":410},{"label":"Set","value":520},{"label":"Out","value":417},{"label":"Nov","value":361},{"label":"Dez","value":587}];
const MX = 589;
