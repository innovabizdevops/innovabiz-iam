...
const ACCENT = "#4338ca";
const MODULE = "Geospatial Analytics";
const PAGE = "Territory";
const KPIS = [{"l":"Vendas YTD (€)","v":"€15595","t":"+14.6%","d":"up"},{"l":"Pipeline (€)","v":"€42722","t":"+9.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"80.5%","t":"+9.9%","d":"up"},{"l":"Win Rate (%)","v":"83.7%","t":"+8.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 24889.09","€ 22238.80","€ 15146.93","80.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 49837.74","€ 29665.91","€ 43148.51","95.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 23788.16","€ 45217.84","€ 30145.32","95.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 18079.42","€ 6668.16","€ 27254.28","73.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 8405.06","€ 10100.48","€ 46428.73","92.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":823},{"label":"Fev","value":962},{"label":"Mar","value":684},{"label":"Abr","value":929},{"label":"Mai","value":939},{"label":"Jun","value":937},{"label":"Jul","value":799},{"label":"Ago","value":815},{"label":"Set","value":909},{"label":"Out","value":1000},{"label":"Nov","value":996},{"label":"Dez","value":819}];
const MX = 1000;
