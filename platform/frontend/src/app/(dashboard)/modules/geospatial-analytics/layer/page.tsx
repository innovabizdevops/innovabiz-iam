...
const PAGE = "Layer";
const KPIS = [{"l":"Dashboards Ativos","v":"5.498","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"2310","t":"+0.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.279","t":"-3.6%","d":"down"},{"l":"Utilizadores Analytics","v":"1.201","t":"-3.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4627","2026-01-01","881","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","875","2026-03-26","4.928","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3248","2026-02-01","3.451","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1016","2026-02-14","8.933","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2689","2026-03-23","4.748","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":678},{"label":"Mar","value":611},{"label":"Abr","value":833},{"label":"Mai","value":629},{"label":"Jun","value":701},{"label":"Jul","value":906},{"label":"Ago","value":986},{"label":"Set","value":712},{"label":"Out","value":831},{"label":"Nov","value":732},{"label":"Dez","value":900}];
const MX = 986;
