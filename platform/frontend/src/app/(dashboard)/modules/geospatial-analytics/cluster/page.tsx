...
const PAGE = "Cluster";
const KPIS = [{"l":"Dashboards Ativos","v":"4.816","t":"+4.4%","d":"up"},{"l":"Queries/Dia","v":"557","t":"+0.7%","d":"up"},{"l":"Dados Processados (GB)","v":"901","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"1.741","t":"+0.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4176","2026-02-23","2.328","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4762","2026-01-18","8.216","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","439","2026-02-12","2.877","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1538","2026-02-28","1.193","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2522","2026-03-12","3.312","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":898},{"label":"Mar","value":674},{"label":"Abr","value":878},{"label":"Mai","value":1005},{"label":"Jun","value":845},{"label":"Jul","value":674},{"label":"Ago","value":707},{"label":"Set","value":1005},{"label":"Out","value":814},{"label":"Nov","value":870},{"label":"Dez","value":773}];
const MX = 1005;
