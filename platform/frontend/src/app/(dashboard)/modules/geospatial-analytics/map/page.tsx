...
const PAGE = "Map";
const KPIS = [{"l":"Dashboards Ativos","v":"5.432","t":"-5.2%","d":"down"},{"l":"Queries/Dia","v":"1902","t":"+15.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.397","t":"-2.0%","d":"down"},{"l":"Utilizadores Analytics","v":"793","t":"-2.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","828","2026-02-16","3.725","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","948","2026-02-16","7.798","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3676","2026-01-08","1.425","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3293","2026-03-28","4.018","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1480","2026-02-04","8.390","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":880},{"label":"Mar","value":669},{"label":"Abr","value":812},{"label":"Mai","value":576},{"label":"Jun","value":835},{"label":"Jul","value":545},{"label":"Ago","value":596},{"label":"Set","value":533},{"label":"Out","value":543},{"label":"Nov","value":809},{"label":"Dez","value":594}];
const MX = 880;
